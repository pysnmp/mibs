...
# Produced by pysmi-1.1.8 at Thu Jan  5 13:28:48 2023
...
Integer32, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, enterprises, TimeTicks, IpAddress, NotificationType, NotificationType, MibIdentifier, ObjectIdentity, Bits, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "enterprises", "TimeTicks", "IpAddress", "NotificationType", "NotificationType", "MibIdentifier", "ObjectIdentity", "Bits", "iso", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", e1t1ChannelNr=e1t1ChannelNr, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanNumber=vlanNumber, licenseUpdateStatus=licenseUpdateStatus, sysDateAndTime=sysDateAndTime, localIpMask=localIpMask, product=product, modemCountTime=modemCountTime, modemACMmodulationMin=modemACMmodulationMin, vlanEntry=vlanEntry, radioDuplexShift=radioDuplexShift, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterLow=ethRXByteCounterLow, e1t1StatEntry=e1t1StatEntry, ethTXMulticasts=ethTXMulticasts, modemRadialMSE=modemRadialMSE, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemModulation=modemModulation, writeConfig=writeConfig, ipRadioStat=ipRadioStat, ethGFPCHECErrors=ethGFPCHECErrors, licenseMask=licenseMask, radioRxFrequency=radioRxFrequency, ethRXPauseFrames=ethRXPauseFrames, ipRadioMgmt=ipRadioMgmt, modemSymbolRateTx=modemSymbolRateTx, modemEthernetCapacity=modemEthernetCapacity, ethRXControlFrames=ethRXControlFrames, radioTxPower=radioTxPower, localIp=localIp, radioRxLevel=radioRxLevel, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXPauseFrames=ethTXPauseFrames, tehnika=tehnika, ethQOSTXDropped=ethQOSTXDropped, ethRXDvEvent=ethRXDvEvent, e1t1AIS=e1t1AIS, modemE1T1ChannelMask=modemE1T1ChannelMask, hostname=hostname, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethGFPDelineationErrors=ethGFPDelineationErrors, loopback_tributary_mask=loopback_tributary_mask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXByteCounterHi=ethTXByteCounterHi, modemACMengine=modemACMengine, ethRXDones=ethRXDones, ethRXBroadcasts=ethRXBroadcasts, ethTXMaxCollisions=ethTXMaxCollisions, modemRowStatus=modemRowStatus, restartcpu=restartcpu, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemUptime=modemUptime, ethTXBroadcasts=ethTXBroadcasts, description=description, ethGFPDropedFrames=ethGFPDropedFrames, modemInternalAGCgain=modemInternalAGCgain, atpcEnabled=atpcEnabled, radioSide=radioSide, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemTotalBlockNumber=modemTotalBlockNumber, modemStandard=modemStandard, sysTemperature=sysTemperature, ethRXTruncatedFrames=ethRXTruncatedFrames, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXGiants=ethTXGiants, vlanTable=vlanTable, ethRXUnsupOpcodes=ethRXUnsupOpcodes, modemErroredBlock=modemErroredBlock, ethRXByteCounterHi=ethRXByteCounterHi, ethTXUnderruns=ethTXUnderruns, ethRXCRCErrors=ethRXCRCErrors, vlanFid=vlanFid, e1t1LOS=e1t1LOS, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXControlFrames=ethTXControlFrames, vlanPortType=vlanPortType, safip=safip, modemIndex=modemIndex, vlansEnabled=vlansEnabled, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXLateCollisions=ethTXLateCollisions, ethRXLongEvents=ethRXLongEvents, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemACMmodulationMax=modemACMmodulationMax, atpcIndex=atpcIndex, modemErroredSecond=modemErroredSecond, e1t1StatTable=e1t1StatTable, loopbacks=loopbacks, modemEntry=modemEntry, radioIndex=radioIndex, modemSymbolRateRx=modemSymbolRateRx, ipRadioStatEth=ipRadioStatEth, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemGeneralStatus=modemGeneralStatus, license=license, ethQOSTXFrames=ethQOSTXFrames, modemAcqStatus=modemAcqStatus, ethRXCodeErrors=ethRXCodeErrors, remoteIp=remoteIp, modemLastAcqError=modemLastAcqError, ethTXCollisions=ethTXCollisions, radioTxMute=radioTxMute, modemACMethernetCapacity=modemACMethernetCapacity, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanCfgStat=vlanCfgStat, vlanPortmap=vlanPortmap, modemErroredSecondRatio=modemErroredSecondRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXDones=ethTXDones, microwaveRadio=microwaveRadio, modemTotalCapacity=modemTotalCapacity, ipRadioCfg=ipRadioCfg, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioTable=radioTable, ethRXDribleNibbles=ethRXDribleNibbles, modemCarrierOffset=modemCarrierOffset, aTPCEntry=aTPCEntry, modemStatistics=modemStatistics, modemUnavailtime=modemUnavailtime, ethTXCRCErrors=ethTXCRCErrors, pointToPoint=pointToPoint, ethTXByteCounterLow=ethTXByteCounterLow, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ipRadio=ipRadio, radioGenStatus=radioGenStatus, ethTXBackpresEvents=ethTXBackpresEvents, radioTxFrequency=radioTxFrequency, vlanRowStatus=vlanRowStatus, ethTXVlanTags=ethTXVlanTags, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMtotalCapacity=modemACMtotalCapacity, modemBandwith=modemBandwith, ethGFPFCSErrors=ethGFPFCSErrors, modemTable=modemTable, radioEntry=radioEntry, radioLoopback=radioLoopback, saf=saf, ethRXMulticasts=ethRXMulticasts, aTPCTable=aTPCTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames)
