...
# Produced by pysmi-1.1.3 at Sun Nov 28 16:26:41 2021
...
Bits, NotificationType, Gauge32, iso, NotificationType, ModuleIdentity, Integer32, ObjectIdentity, Unsigned32, enterprises, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Gauge32", "iso", "NotificationType", "ModuleIdentity", "Integer32", "ObjectIdentity", "Unsigned32", "enterprises", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemErroredSecondRatio=modemErroredSecondRatio, modemACMtotalCapacity=modemACMtotalCapacity, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTotalCapacity=modemTotalCapacity, aTPCTable=aTPCTable, e1t1StatEntry=e1t1StatEntry, modemUptime=modemUptime, ethTXBroadcasts=ethTXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemTotalBlockNumber=modemTotalBlockNumber, modemRowStatus=modemRowStatus, ethTXBackpresEvents=ethTXBackpresEvents, ethTXMulticasts=ethTXMulticasts, ipRadioCfgNetwork=ipRadioCfgNetwork, description=description, modemSymbolRateRx=modemSymbolRateRx, sysTemperature=sysTemperature, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanPortType=vlanPortType, sysDateAndTime=sysDateAndTime, ethRXControlFrames=ethRXControlFrames, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPFCSErrors=ethGFPFCSErrors, licenseUpdateStatus=licenseUpdateStatus, saf=saf, ipRadioCfgGeneral=ipRadioCfgGeneral, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, e1t1ChannelNr=e1t1ChannelNr, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioTxFrequency=radioTxFrequency, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcEnabled=atpcEnabled, ethTXVlanTags=ethTXVlanTags, modemE1T1ChannelMask=modemE1T1ChannelMask, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXDvEvent=ethRXDvEvent, ethRXTruncatedFrames=ethRXTruncatedFrames, modemAcqStatus=modemAcqStatus, vlanNumber=vlanNumber, ethRXCRCErrors=ethRXCRCErrors, modemStatistics=modemStatistics, radioLoopback=radioLoopback, ethTXControlFrames=ethTXControlFrames, ethTXMaxCollisions=ethTXMaxCollisions, ipRadioCfg=ipRadioCfg, restartcpu=restartcpu, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXGiants=ethTXGiants, modemIndex=modemIndex, remoteIp=remoteIp, ethGFPCHECErrors=ethGFPCHECErrors, e1t1StatTable=e1t1StatTable, modemInternalAGCgain=modemInternalAGCgain, modemCarrierOffset=modemCarrierOffset, localIpMask=localIpMask, loopback_tributary_mask=loopback_tributary_mask, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXDones=ethTXDones, product=product, hostname=hostname, ethRXDribleNibbles=ethRXDribleNibbles, modemLastAcqError=modemLastAcqError, loopbacks=loopbacks, modemUnavailtime=modemUnavailtime, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanPortmap=vlanPortmap, ethRXLongEvents=ethRXLongEvents, ipRadioStat=ipRadioStat, radioTxMute=radioTxMute, safip=safip, ethQOSTXFrames=ethQOSTXFrames, aTPCEntry=aTPCEntry, ethRXBroadcasts=ethRXBroadcasts, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTable=radioTable, modemEthernetCapacity=modemEthernetCapacity, vlanFid=vlanFid, atpcIndex=atpcIndex, localIp=localIp, ethRXPauseFrames=ethRXPauseFrames, vlanCfgStat=vlanCfgStat, vlanEntry=vlanEntry, ethRXDones=ethRXDones, radioGenStatus=radioGenStatus, radioTxPower=radioTxPower, modemLDPCdecoderStress=modemLDPCdecoderStress, modemRadialMSE=modemRadialMSE, e1t1AIS=e1t1AIS, ipRadio=ipRadio, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemStandard=modemStandard, modemBandwith=modemBandwith, modemErroredBlock=modemErroredBlock, radioRxFrequency=radioRxFrequency, radioSide=radioSide, modemSymbolRateTx=modemSymbolRateTx, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemEntry=modemEntry, license=license, ethTXCRCErrors=ethTXCRCErrors, modemGeneralStatus=modemGeneralStatus, tehnika=tehnika, modemErroredSecond=modemErroredSecond, ipRadioStatEth=ipRadioStatEth, radioEntry=radioEntry, ethGFPDropedFrames=ethGFPDropedFrames, ethTXCollisions=ethTXCollisions, vlansEnabled=vlansEnabled, radioDuplexShift=radioDuplexShift, microwaveRadio=microwaveRadio, modemACMmodulationMax=modemACMmodulationMax, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioIndex=radioIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, pointToPoint=pointToPoint, modemE1T1Channels=modemE1T1Channels, ethTXPauseFrames=ethTXPauseFrames, modemACMmodulationMin=modemACMmodulationMin, vlanTable=vlanTable, vlanRowStatus=vlanRowStatus, ethTXUnderruns=ethTXUnderruns, modemModulation=modemModulation, ethRXMulticasts=ethRXMulticasts, modemCountTime=modemCountTime, ipRadioMgmt=ipRadioMgmt, ethTXByteCounterHi=ethTXByteCounterHi, ethRXByteCounterLow=ethRXByteCounterLow, writeConfig=writeConfig, ethRXCodeErrors=ethRXCodeErrors, e1t1LOS=e1t1LOS, radioRxLevel=radioRxLevel, modemTable=modemTable, modemACMengine=modemACMengine, ethGFPDelineationErrors=ethGFPDelineationErrors, licenseMask=licenseMask)
