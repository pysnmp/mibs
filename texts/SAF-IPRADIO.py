...
# Produced by pysmi-1.1.12 at Wed May 29 08:15:37 2024
...
Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Unsigned32, Integer32, Bits, Counter32, NotificationType, ObjectIdentity, MibIdentifier, enterprises, ModuleIdentity, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Unsigned32", "Integer32", "Bits", "Counter32", "NotificationType", "ObjectIdentity", "MibIdentifier", "enterprises", "ModuleIdentity", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", description=description, restartcpu=restartcpu, remoteIp=remoteIp, ethGFPDelineationErrors=ethGFPDelineationErrors, license=license, ipRadioCfgGeneral=ipRadioCfgGeneral, radioLoopback=radioLoopback, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ipRadioStatEth=ipRadioStatEth, modemSymbolRateTx=modemSymbolRateTx, modemTotalBlockNumber=modemTotalBlockNumber, atpcIndex=atpcIndex, modemACMmodulationMin=modemACMmodulationMin, vlanNumber=vlanNumber, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemAcqStatus=modemAcqStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPCHECErrors=ethGFPCHECErrors, modemGeneralStatus=modemGeneralStatus, ipRadio=ipRadio, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXVlanTags=ethTXVlanTags, radioIndex=radioIndex, modemErroredSecondRatio=modemErroredSecondRatio, radioSide=radioSide, writeConfig=writeConfig, ethRXByteCounterHi=ethRXByteCounterHi, localIpMask=localIpMask, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPDropedFrames=ethGFPDropedFrames, ethRXDribleNibbles=ethRXDribleNibbles, ethTXLateCollisions=ethTXLateCollisions, radioTxPower=radioTxPower, e1t1LOS=e1t1LOS, radioTxMute=radioTxMute, modemModulation=modemModulation, pointToPoint=pointToPoint, ethRXDones=ethRXDones, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioGenStatus=radioGenStatus, vlanRowStatus=vlanRowStatus, ethRXCodeErrors=ethRXCodeErrors, ethTXBackpresEvents=ethTXBackpresEvents, ethTXMaxCollisions=ethTXMaxCollisions, ethTXControlFrames=ethTXControlFrames, e1t1StatTable=e1t1StatTable, modemErroredSecond=modemErroredSecond, modemE1T1Channels=modemE1T1Channels, modemRadialMSE=modemRadialMSE, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemStatistics=modemStatistics, modemCarrierOffset=modemCarrierOffset, vlanPortmap=vlanPortmap, radioEntry=radioEntry, e1t1ChannelNr=e1t1ChannelNr, ethRXMulticasts=ethRXMulticasts, ethTXByteCounterLow=ethTXByteCounterLow, ethTXPauseFrames=ethTXPauseFrames, product=product, ethRXCRCErrors=ethRXCRCErrors, ethRXByteCounterLow=ethRXByteCounterLow, radioRxLevel=radioRxLevel, modemErroredBlock=modemErroredBlock, aTPCTable=aTPCTable, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcEnabled=atpcEnabled, safip=safip, modemLastAcqError=modemLastAcqError, ipRadioMgmt=ipRadioMgmt, licenseUpdateStatus=licenseUpdateStatus, radioRxFrequency=radioRxFrequency, vlanCfgStat=vlanCfgStat, licenseMask=licenseMask, ipRadioCfg=ipRadioCfg, modemRowStatus=modemRowStatus, ethQOSRXQ2Frames=ethQOSRXQ2Frames, e1t1StatEntry=e1t1StatEntry, modemTotalCapacity=modemTotalCapacity, modemCountTime=modemCountTime, ipRadioStat=ipRadioStat, modemACMethernetCapacity=modemACMethernetCapacity, vlanEntry=vlanEntry, ethRXControlFrames=ethRXControlFrames, modemACMengine=modemACMengine, sysDateAndTime=sysDateAndTime, modemEthernetCapacity=modemEthernetCapacity, vlanTable=vlanTable, vlansEnabled=vlansEnabled, ethTXMulticasts=ethTXMulticasts, ethTXByteCounterHi=ethTXByteCounterHi, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, e1t1AIS=e1t1AIS, localIp=localIp, ethQOSTXDropped=ethQOSTXDropped, ethRXLongEvents=ethRXLongEvents, hostname=hostname, modemEntry=modemEntry, modemUptime=modemUptime, ethTXCRCErrors=ethTXCRCErrors, ethRXBroadcasts=ethRXBroadcasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemUnavailtime=modemUnavailtime, modemStandard=modemStandard, aTPCEntry=aTPCEntry, loopback_tributary_mask=loopback_tributary_mask, modemIndex=modemIndex, saf=saf, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemInternalAGCgain=modemInternalAGCgain, microwaveRadio=microwaveRadio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXPauseFrames=ethRXPauseFrames, ethTXUnderruns=ethTXUnderruns, ethTXDones=ethTXDones, modemTable=modemTable, vlanPortType=vlanPortType, ethTXGiants=ethTXGiants, radioTxFrequency=radioTxFrequency, vlanFid=vlanFid, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXDvEvent=ethRXDvEvent, tehnika=tehnika, ethTXExcessiveDefers=ethTXExcessiveDefers, radioDuplexShift=radioDuplexShift, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemACMtotalCapacity=modemACMtotalCapacity, modemACMmodulationMax=modemACMmodulationMax, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXBroadcasts=ethTXBroadcasts, loopbacks=loopbacks, radioTable=radioTable, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSTXFrames=ethQOSTXFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, sysTemperature=sysTemperature, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXCollisions=ethTXCollisions, modemSymbolRateRx=modemSymbolRateRx, modemBandwith=modemBandwith, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXPrevPktDropped=ethRXPrevPktDropped)
