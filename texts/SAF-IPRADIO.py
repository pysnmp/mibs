...
# Produced by pysmi-1.1.10 at Fri Nov 10 09:28:45 2023
...
MibIdentifier, ObjectIdentity, Gauge32, Bits, Counter32, Integer32, Unsigned32, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, enterprises, Counter64, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "Gauge32", "Bits", "Counter32", "Integer32", "Unsigned32", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "enterprises", "Counter64", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemUnavailtime=modemUnavailtime, description=description, vlanPortmap=vlanPortmap, ipRadioCfgNetwork=ipRadioCfgNetwork, atpcIndex=atpcIndex, aTPCTable=aTPCTable, license=license, ethGFPDropedFrames=ethGFPDropedFrames, writeConfig=writeConfig, radioTxMute=radioTxMute, ethTXGiants=ethTXGiants, ethTXVlanTags=ethTXVlanTags, ethTXBackpresEvents=ethTXBackpresEvents, radioRxFrequency=radioRxFrequency, modemACMethernetCapacity=modemACMethernetCapacity, ethQOSTXDropped=ethQOSTXDropped, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1ChannelMask=modemE1T1ChannelMask, ethGFPCHECErrors=ethGFPCHECErrors, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, pointToPoint=pointToPoint, modemCarrierOffset=modemCarrierOffset, radioLoopback=radioLoopback, ethTXByteCounterLow=ethTXByteCounterLow, modemSymbolRateRx=modemSymbolRateRx, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXExcessiveDefers=ethTXExcessiveDefers, modemLastAcqError=modemLastAcqError, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, radioTxFrequency=radioTxFrequency, radioIndex=radioIndex, modemSymbolRateTx=modemSymbolRateTx, radioTxPower=radioTxPower, ethTXByteCounterHi=ethTXByteCounterHi, localIpMask=localIpMask, modemModulation=modemModulation, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEntry=modemEntry, ethRXMulticasts=ethRXMulticasts, modemACMmodulationMax=modemACMmodulationMax, radioGenStatus=radioGenStatus, ethRXControlFrames=ethRXControlFrames, licenseMask=licenseMask, modemAcqStatus=modemAcqStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, radioEntry=radioEntry, vlanTable=vlanTable, ethTXDones=ethTXDones, ethRXByteCounterLow=ethRXByteCounterLow, sysTemperature=sysTemperature, product=product, ethRXDvEvent=ethRXDvEvent, aTPCEntry=aTPCEntry, modemACMtotalCapacity=modemACMtotalCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemRowStatus=modemRowStatus, e1t1StatTable=e1t1StatTable, ethRXCRCErrors=ethRXCRCErrors, modemE1T1Channels=modemE1T1Channels, safip=safip, hostname=hostname, modemACMmodulationMin=modemACMmodulationMin, ipRadioStat=ipRadioStat, ethRXDones=ethRXDones, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXPauseFrames=ethTXPauseFrames, ethRXDribleNibbles=ethRXDribleNibbles, modemIndex=modemIndex, loopbacks=loopbacks, modemTable=modemTable, modemGeneralStatus=modemGeneralStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, tehnika=tehnika, vlansEnabled=vlansEnabled, modemUptime=modemUptime, vlanNumber=vlanNumber, ethRXCodeErrors=ethRXCodeErrors, ipRadioStatEth=ipRadioStatEth, modemStandard=modemStandard, vlanFid=vlanFid, modemErroredBlock=modemErroredBlock, localIp=localIp, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioDuplexShift=radioDuplexShift, vlanEntry=vlanEntry, ethTXMaxCollisions=ethTXMaxCollisions, remoteIp=remoteIp, ethRXLongEvents=ethRXLongEvents, ethGFPFCSErrors=ethGFPFCSErrors, modemErroredSecondRatio=modemErroredSecondRatio, modemEthernetCapacity=modemEthernetCapacity, modemInternalAGCgain=modemInternalAGCgain, vlanRowStatus=vlanRowStatus, radioSide=radioSide, ethTXMulticasts=ethTXMulticasts, ethTXControlFrames=ethTXControlFrames, licenseUpdateStatus=licenseUpdateStatus, ipRadioMgmt=ipRadioMgmt, ipRadio=ipRadio, modemBandwith=modemBandwith, ethRXBroadcasts=ethRXBroadcasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, e1t1StatEntry=e1t1StatEntry, e1t1LOS=e1t1LOS, modemACMengine=modemACMengine, sysDateAndTime=sysDateAndTime, ethRXByteCounterHi=ethRXByteCounterHi, restartcpu=restartcpu, ethTXLengthCheckErrors=ethTXLengthCheckErrors, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanCfgStat=vlanCfgStat, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemRadialMSE=modemRadialMSE, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXPrevPktDropped=ethRXPrevPktDropped, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, e1t1AIS=e1t1AIS, ipRadioCfg=ipRadioCfg, radioTable=radioTable, vlanPortType=vlanPortType, modemErroredSecond=modemErroredSecond, atpcEnabled=atpcEnabled, ethTXCollisions=ethTXCollisions, ethTXUnderruns=ethTXUnderruns, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXPauseFrames=ethRXPauseFrames, e1t1ChannelNr=e1t1ChannelNr, microwaveRadio=microwaveRadio, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemTotalBlockNumber=modemTotalBlockNumber, modemStatistics=modemStatistics, modemTotalCapacity=modemTotalCapacity, radioRxLevel=radioRxLevel, ethQOSTXFrames=ethQOSTXFrames, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCRCErrors=ethTXCRCErrors, ethTXLateCollisions=ethTXLateCollisions, saf=saf, loopback_tributary_mask=loopback_tributary_mask, modemCountTime=modemCountTime)
