...
mibBuilder.exportSymbols("SAF-IPRADIO", ethGFPCHECErrors=ethGFPCHECErrors, remoteIp=remoteIp, ethTXCollisions=ethTXCollisions, licenseUpdateStatus=licenseUpdateStatus, description=description, ethRXDvEvent=ethRXDvEvent, ethTXMulticasts=ethTXMulticasts, ethTXControlFrames=ethTXControlFrames, ethQOSTXFrames=ethQOSTXFrames, ethQOSTXDropped=ethQOSTXDropped, modemErroredBlock=modemErroredBlock, ethRXLongEvents=ethRXLongEvents, modemBandwith=modemBandwith, vlanPortType=vlanPortType, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, sysDateAndTime=sysDateAndTime, ipRadioCfgGeneral=ipRadioCfgGeneral, e1t1StatTable=e1t1StatTable, radioTable=radioTable, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXByteCounterLow=ethRXByteCounterLow, modemInternalAGCgain=modemInternalAGCgain, radioGenStatus=radioGenStatus, vlanNumber=vlanNumber, modemLastAcqError=modemLastAcqError, atpcEnabled=atpcEnabled, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemRowStatus=modemRowStatus, ethRXDones=ethRXDones, licenseMask=licenseMask, ethTXDones=ethTXDones, writeConfig=writeConfig, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemErroredSecondRatio=modemErroredSecondRatio, ethTXByteCounterLow=ethTXByteCounterLow, modemGeneralStatus=modemGeneralStatus, modemACMengine=modemACMengine, ipRadioCfg=ipRadioCfg, safip=safip, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ipRadioStatEth=ipRadioStatEth, modemACMmodulationMax=modemACMmodulationMax, modemTotalBlockNumber=modemTotalBlockNumber, ethTXExcessiveDefers=ethTXExcessiveDefers, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanTable=vlanTable, radioTxMute=radioTxMute, modemSymbolRateTx=modemSymbolRateTx, ethTXByteCounterHi=ethTXByteCounterHi, vlanCfgStat=vlanCfgStat, ethTXCRCErrors=ethTXCRCErrors, license=license, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, aTPCTable=aTPCTable, modemEthernetCapacity=modemEthernetCapacity, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXGiants=ethTXGiants, ethRXMulticasts=ethRXMulticasts, modemEntry=modemEntry, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, pointToPoint=pointToPoint, e1t1LOS=e1t1LOS, modemLDPCdecoderStress=modemLDPCdecoderStress, microwaveRadio=microwaveRadio, saf=saf, vlanEntry=vlanEntry, modemIndex=modemIndex, ethRXControlFrames=ethRXControlFrames, vlanPortmap=vlanPortmap, ethTXVlanTags=ethTXVlanTags, radioTxFrequency=radioTxFrequency, ethRXPrevPktDropped=ethRXPrevPktDropped, product=product, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioLoopback=radioLoopback, tehnika=tehnika, restartcpu=restartcpu, ethGFPDropedFrames=ethGFPDropedFrames, radioTxPower=radioTxPower, radioDuplexShift=radioDuplexShift, modemUnavailtime=modemUnavailtime, ethRXTruncatedFrames=ethRXTruncatedFrames, modemModulation=modemModulation, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXDribleNibbles=ethRXDribleNibbles, modemErroredSecond=modemErroredSecond, e1t1StatEntry=e1t1StatEntry, ipRadio=ipRadio, modemACMmodulationMin=modemACMmodulationMin, modemACMethernetCapacity=modemACMethernetCapacity, radioSide=radioSide, ethTXPauseFrames=ethTXPauseFrames, vlanFid=vlanFid, radioIndex=radioIndex, e1t1ChannelNr=e1t1ChannelNr, modemCarrierOffset=modemCarrierOffset, ethTXBackpresEvents=ethTXBackpresEvents, modemACMtotalCapacity=modemACMtotalCapacity, ethRXCRCErrors=ethRXCRCErrors, modemRadialMSE=modemRadialMSE, modemCountTime=modemCountTime, ethRXBroadcasts=ethRXBroadcasts, loopbacks=loopbacks, e1t1AIS=e1t1AIS, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, sysTemperature=sysTemperature, ethGFPFCSErrors=ethGFPFCSErrors, ethTXLateCollisions=ethTXLateCollisions, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXMaxCollisions=ethTXMaxCollisions, modemUptime=modemUptime, modemTable=modemTable, ethTXBroadcasts=ethTXBroadcasts, hostname=hostname, modemSymbolRateRx=modemSymbolRateRx, modemTotalCapacity=modemTotalCapacity, vlanRowStatus=vlanRowStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcIndex=atpcIndex, modemE1T1Channels=modemE1T1Channels, localIp=localIp, localIpMask=localIpMask, modemStandard=modemStandard, ethRXByteCounterHi=ethRXByteCounterHi, radioRxFrequency=radioRxFrequency, loopback_tributary_mask=loopback_tributary_mask, atpcTxPowerCorrection=atpcTxPowerCorrection, ipRadioStat=ipRadioStat, radioEntry=radioEntry, ipRadioCfgNetwork=ipRadioCfgNetwork, radioRxLevel=radioRxLevel, ethTXUnderruns=ethTXUnderruns, aTPCEntry=aTPCEntry, ipRadioMgmt=ipRadioMgmt, ethRXPauseFrames=ethRXPauseFrames, modemAcqStatus=modemAcqStatus, modemStatistics=modemStatistics, ethRXCodeErrors=ethRXCodeErrors, vlansEnabled=vlansEnabled)
