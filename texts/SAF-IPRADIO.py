...
# Produced by pysmi-1.1.11 at Wed Dec  6 03:06:28 2023
...
IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Counter64, TimeTicks, NotificationType, ModuleIdentity, Counter32, Gauge32, Unsigned32, MibIdentifier, ObjectIdentity, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Counter64", "TimeTicks", "NotificationType", "ModuleIdentity", "Counter32", "Gauge32", "Unsigned32", "MibIdentifier", "ObjectIdentity", "iso", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemStandard=modemStandard, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanPortmap=vlanPortmap, modemStatistics=modemStatistics, localIp=localIp, ipRadioMgmt=ipRadioMgmt, modemModulation=modemModulation, vlanRowStatus=vlanRowStatus, ipRadio=ipRadio, ethRXPauseFrames=ethRXPauseFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, loopbacks=loopbacks, ethTXMulticasts=ethTXMulticasts, ethGFPFCSErrors=ethGFPFCSErrors, modemErroredSecond=modemErroredSecond, ethTXControlFrames=ethTXControlFrames, aTPCEntry=aTPCEntry, modemSymbolRateTx=modemSymbolRateTx, ethTXByteCounterLow=ethTXByteCounterLow, modemAcqStatus=modemAcqStatus, ethRXControlFrames=ethRXControlFrames, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXDribleNibbles=ethRXDribleNibbles, loopback_tributary_mask=loopback_tributary_mask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ipRadioStat=ipRadioStat, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemTable=modemTable, radioGenStatus=radioGenStatus, description=description, ethTXCRCErrors=ethTXCRCErrors, vlanEntry=vlanEntry, modemUptime=modemUptime, vlanTable=vlanTable, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethRXMulticasts=ethRXMulticasts, remoteIp=remoteIp, modemSymbolRateRx=modemSymbolRateRx, modemACMmodulationMin=modemACMmodulationMin, licenseUpdateStatus=licenseUpdateStatus, ethTXGiants=ethTXGiants, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, localIpMask=localIpMask, safip=safip, modemTotalBlockNumber=modemTotalBlockNumber, saf=saf, ethRXBroadcasts=ethRXBroadcasts, modemLastAcqError=modemLastAcqError, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, hostname=hostname, sysTemperature=sysTemperature, modemACMengine=modemACMengine, radioTxFrequency=radioTxFrequency, ethTXCollisions=ethTXCollisions, radioDuplexShift=radioDuplexShift, licenseMask=licenseMask, vlanFid=vlanFid, ethRXLongEvents=ethRXLongEvents, radioSide=radioSide, ethTXLateCollisions=ethTXLateCollisions, modemUnavailtime=modemUnavailtime, ipRadioCfgGeneral=ipRadioCfgGeneral, modemE1T1Channels=modemE1T1Channels, modemACMethernetCapacity=modemACMethernetCapacity, vlanNumber=vlanNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemBandwith=modemBandwith, ethTXByteCounterHi=ethTXByteCounterHi, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanPortType=vlanPortType, restartcpu=restartcpu, radioRxFrequency=radioRxFrequency, modemEthernetCapacity=modemEthernetCapacity, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioRxLevel=radioRxLevel, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1AIS=e1t1AIS, atpcIndex=atpcIndex, ethQOSTXFrames=ethQOSTXFrames, modemTotalCapacity=modemTotalCapacity, vlanCfgStat=vlanCfgStat, modemACMmodulationMax=modemACMmodulationMax, modemErroredSecondRatio=modemErroredSecondRatio, radioTxPower=radioTxPower, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXCRCErrors=ethRXCRCErrors, radioEntry=radioEntry, radioTxMute=radioTxMute, ethTXBackpresEvents=ethTXBackpresEvents, ethRXTruncatedFrames=ethRXTruncatedFrames, modemInternalAGCgain=modemInternalAGCgain, modemRowStatus=modemRowStatus, ethRXByteCounterHi=ethRXByteCounterHi, ethRXDvEvent=ethRXDvEvent, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXByteCounterLow=ethRXByteCounterLow, ethRXDones=ethRXDones, atpcEnabled=atpcEnabled, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDropedFrames=ethGFPDropedFrames, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1StatEntry=e1t1StatEntry, ethRXCodeErrors=ethRXCodeErrors, e1t1LOS=e1t1LOS, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemLDPCdecoderStress=modemLDPCdecoderStress, e1t1StatTable=e1t1StatTable, ipRadioCfg=ipRadioCfg, modemEntry=modemEntry, ethQOSTXDropped=ethQOSTXDropped, ethTXVlanTags=ethTXVlanTags, writeConfig=writeConfig, vlansEnabled=vlansEnabled, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXUnderruns=ethTXUnderruns, ethGFPCHECErrors=ethGFPCHECErrors, pointToPoint=pointToPoint, modemCarrierOffset=modemCarrierOffset, license=license, modemRadialMSE=modemRadialMSE, e1t1ChannelNr=e1t1ChannelNr, modemCountTime=modemCountTime, sysDateAndTime=sysDateAndTime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXPauseFrames=ethTXPauseFrames, product=product, modemErroredBlock=modemErroredBlock, tehnika=tehnika, modemACMtotalCapacity=modemACMtotalCapacity, ipRadioStatEth=ipRadioStatEth, aTPCTable=aTPCTable, ethTXDones=ethTXDones, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBroadcasts=ethTXBroadcasts, modemIndex=modemIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemGeneralStatus=modemGeneralStatus, microwaveRadio=microwaveRadio, radioTable=radioTable, radioLoopback=radioLoopback, radioIndex=radioIndex)
