...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:48:32 2021
...
Unsigned32, ModuleIdentity, enterprises, Gauge32, ObjectIdentity, IpAddress, NotificationType, MibIdentifier, Bits, TimeTicks, Counter32, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "enterprises", "Gauge32", "ObjectIdentity", "IpAddress", "NotificationType", "MibIdentifier", "Bits", "TimeTicks", "Counter32", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemACMtotalCapacity=modemACMtotalCapacity, ethTXPauseFrames=ethTXPauseFrames, sysDateAndTime=sysDateAndTime, ethRXMulticasts=ethRXMulticasts, radioTxPower=radioTxPower, modemACMmodulationMin=modemACMmodulationMin, modemRowStatus=modemRowStatus, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTxFrequency=radioTxFrequency, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemE1T1Channels=modemE1T1Channels, atpcEnabled=atpcEnabled, modemBackgroundBlockErrror=modemBackgroundBlockErrror, aTPCTable=aTPCTable, vlanPortType=vlanPortType, vlanTable=vlanTable, vlanPortmap=vlanPortmap, ethTXByteCounterLow=ethTXByteCounterLow, radioRxLevel=radioRxLevel, radioRxFrequency=radioRxFrequency, ethRXPrevPktDropped=ethRXPrevPktDropped, localIp=localIp, vlanCfgStat=vlanCfgStat, modemIndex=modemIndex, ethRXLongEvents=ethRXLongEvents, ethQOSRXQ1Frames=ethQOSRXQ1Frames, atpcIndex=atpcIndex, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemEthernetCapacity=modemEthernetCapacity, modemAcqStatus=modemAcqStatus, ethRXCRCErrors=ethRXCRCErrors, modemEntry=modemEntry, e1t1LOS=e1t1LOS, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXVlanTagsDetected=ethRXVlanTagsDetected, aTPCEntry=aTPCEntry, loopback_tributary_mask=loopback_tributary_mask, ethRXBroadcasts=ethRXBroadcasts, ethTXMulticasts=ethTXMulticasts, restartcpu=restartcpu, ipRadioCfg=ipRadioCfg, ethTXMaxCollisions=ethTXMaxCollisions, ethRXCodeErrors=ethRXCodeErrors, writeConfig=writeConfig, modemBandwith=modemBandwith, modemErroredBlock=modemErroredBlock, modemACMengine=modemACMengine, ethQOSTXFrames=ethQOSTXFrames, ethTXByteCounterHi=ethTXByteCounterHi, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemCarrierOffset=modemCarrierOffset, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioEntry=radioEntry, modemSymbolRateRx=modemSymbolRateRx, ipRadioMgmt=ipRadioMgmt, ethRXDones=ethRXDones, modemStandard=modemStandard, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemCountTime=modemCountTime, modemRadialMSE=modemRadialMSE, ethTXCollisions=ethTXCollisions, vlanNumber=vlanNumber, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, tehnika=tehnika, ipRadio=ipRadio, ethTXUnderruns=ethTXUnderruns, modemLDPCdecoderStress=modemLDPCdecoderStress, pointToPoint=pointToPoint, modemTotalCapacity=modemTotalCapacity, ethTXGiants=ethTXGiants, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfgGeneral=ipRadioCfgGeneral, modemInternalAGCgain=modemInternalAGCgain, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethGFPFCSErrors=ethGFPFCSErrors, ethQOSTXDropped=ethQOSTXDropped, safip=safip, modemLastAcqError=modemLastAcqError, ethRXDribleNibbles=ethRXDribleNibbles, description=description, licenseUpdateStatus=licenseUpdateStatus, modemACMethernetCapacity=modemACMethernetCapacity, radioSide=radioSide, e1t1ChannelNr=e1t1ChannelNr, ethTXCRCErrors=ethTXCRCErrors, radioTxMute=radioTxMute, ethRXPauseFrames=ethRXPauseFrames, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXVlanTags=ethTXVlanTags, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1StatTable=e1t1StatTable, ethTXBackpresEvents=ethTXBackpresEvents, radioTable=radioTable, ethTXControlFrames=ethTXControlFrames, modemGeneralStatus=modemGeneralStatus, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, product=product, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioStat=ipRadioStat, vlanFid=vlanFid, ethTXLateCollisions=ethTXLateCollisions, vlanEntry=vlanEntry, localIpMask=localIpMask, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXControlFrames=ethRXControlFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, vlansEnabled=vlansEnabled, modemUnavailtime=modemUnavailtime, ethTXDones=ethTXDones, radioGenStatus=radioGenStatus, licenseMask=licenseMask, modemTable=modemTable, sysTemperature=sysTemperature, ethRXDvEvent=ethRXDvEvent, loopbacks=loopbacks, e1t1StatEntry=e1t1StatEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, modemUptime=modemUptime, ipRadioCfgNetwork=ipRadioCfgNetwork, ipRadioStatEth=ipRadioStatEth, modemStatistics=modemStatistics, modemModulation=modemModulation, modemACMmodulationMax=modemACMmodulationMax, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, ethRXTruncatedFrames=ethRXTruncatedFrames, remoteIp=remoteIp, microwaveRadio=microwaveRadio, radioDuplexShift=radioDuplexShift, modemTotalBlockNumber=modemTotalBlockNumber, modemSymbolRateTx=modemSymbolRateTx, modemErroredSecond=modemErroredSecond, radioLoopback=radioLoopback, radioIndex=radioIndex, ethRXByteCounterHi=ethRXByteCounterHi, e1t1AIS=e1t1AIS, hostname=hostname, vlanRowStatus=vlanRowStatus, license=license, saf=saf, ethTXBroadcasts=ethTXBroadcasts, ethRXByteCounterLow=ethRXByteCounterLow)
