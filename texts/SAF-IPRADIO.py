...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:08:17 2022
...
Gauge32, iso, NotificationType, ObjectIdentity, TimeTicks, Integer32, MibIdentifier, Counter32, Unsigned32, enterprises, ModuleIdentity, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "NotificationType", "ObjectIdentity", "TimeTicks", "Integer32", "MibIdentifier", "Counter32", "Unsigned32", "enterprises", "ModuleIdentity", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, microwaveRadio=microwaveRadio, modemACMengine=modemACMengine, modemErroredSecond=modemErroredSecond, licenseUpdateStatus=licenseUpdateStatus, aTPCTable=aTPCTable, modemEthernetCapacity=modemEthernetCapacity, ethRXBroadcasts=ethRXBroadcasts, modemErroredBlock=modemErroredBlock, license=license, ethRXCRCErrors=ethRXCRCErrors, ethQOSTXFrames=ethQOSTXFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemInternalAGCgain=modemInternalAGCgain, e1t1StatTable=e1t1StatTable, ethGFPFCSErrors=ethGFPFCSErrors, radioTxFrequency=radioTxFrequency, vlanTable=vlanTable, vlansEnabled=vlansEnabled, radioTable=radioTable, ipRadio=ipRadio, writeConfig=writeConfig, ethTXCollisions=ethTXCollisions, modemSymbolRateTx=modemSymbolRateTx, modemACMmodulationMax=modemACMmodulationMax, modemACMtotalCapacity=modemACMtotalCapacity, modemSymbolRateRx=modemSymbolRateRx, saf=saf, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethGFPCHECErrors=ethGFPCHECErrors, radioGenStatus=radioGenStatus, modemUptime=modemUptime, modemGeneralStatus=modemGeneralStatus, vlanRowStatus=vlanRowStatus, ethRXControlFrames=ethRXControlFrames, ethTXGiants=ethTXGiants, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethRXByteCounterLow=ethRXByteCounterLow, ethQOSRXQ2Frames=ethQOSRXQ2Frames, safip=safip, sysTemperature=sysTemperature, radioRxLevel=radioRxLevel, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXBackpresEvents=ethTXBackpresEvents, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXByteCounterHi=ethTXByteCounterHi, ethTXUnderruns=ethTXUnderruns, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcTxPowerCorrection=atpcTxPowerCorrection, modemBandwith=modemBandwith, product=product, ipRadioStatEth=ipRadioStatEth, modemTable=modemTable, modemModulation=modemModulation, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXCRCErrors=ethTXCRCErrors, modemTotalCapacity=modemTotalCapacity, radioRxFrequency=radioRxFrequency, radioDuplexShift=radioDuplexShift, modemStandard=modemStandard, modemRadialMSE=modemRadialMSE, ethQOSRXQ1Frames=ethQOSRXQ1Frames, radioSide=radioSide, vlanNumber=vlanNumber, ipRadioStat=ipRadioStat, vlanPortType=vlanPortType, atpcIndex=atpcIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioLoopback=radioLoopback, ipRadioCfgGeneral=ipRadioCfgGeneral, ethTXMulticasts=ethTXMulticasts, modemCarrierOffset=modemCarrierOffset, vlanFid=vlanFid, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioEntry=radioEntry, localIpMask=localIpMask, ethTXLateCollisions=ethTXLateCollisions, radioIndex=radioIndex, ethRXUnsupOpcodes=ethRXUnsupOpcodes, licenseMask=licenseMask, ethTXControlFrames=ethTXControlFrames, remoteIp=remoteIp, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, radioTxPower=radioTxPower, ethTXMaxCollisions=ethTXMaxCollisions, vlanPortmap=vlanPortmap, ethRXDribleNibbles=ethRXDribleNibbles, ethRXByteCounterHi=ethRXByteCounterHi, loopbacks=loopbacks, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXDones=ethTXDones, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1Channels=modemE1T1Channels, modemStatistics=modemStatistics, e1t1ChannelNr=e1t1ChannelNr, ethRXPauseFrames=ethRXPauseFrames, vlanEntry=vlanEntry, ethGFPDropedFrames=ethGFPDropedFrames, modemACMethernetCapacity=modemACMethernetCapacity, modemErroredSecondRatio=modemErroredSecondRatio, modemEntry=modemEntry, ethRXDones=ethRXDones, modemAcqStatus=modemAcqStatus, e1t1StatEntry=e1t1StatEntry, restartcpu=restartcpu, ethRXDvEvent=ethRXDvEvent, sysDateAndTime=sysDateAndTime, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXVlanTags=ethTXVlanTags, ethRXLongEvents=ethRXLongEvents, description=description, modemCountTime=modemCountTime, modemIndex=modemIndex, hostname=hostname, e1t1LOS=e1t1LOS, vlanCfgStat=vlanCfgStat, modemLastAcqError=modemLastAcqError, tehnika=tehnika, ipRadioMgmt=ipRadioMgmt, pointToPoint=pointToPoint, modemRowStatus=modemRowStatus, loopback_tributary_mask=loopback_tributary_mask, modemUnavailtime=modemUnavailtime, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfg=ipRadioCfg, aTPCEntry=aTPCEntry, ethRXPrevPktDropped=ethRXPrevPktDropped, localIp=localIp, modemACMmodulationMin=modemACMmodulationMin, radioTxMute=radioTxMute, ethRXMulticasts=ethRXMulticasts, ethTXByteCounterLow=ethTXByteCounterLow, modemTotalBlockNumber=modemTotalBlockNumber, e1t1AIS=e1t1AIS, ethRXCodeErrors=ethRXCodeErrors, ethRXTruncatedFrames=ethRXTruncatedFrames, ethQOSTXDropped=ethQOSTXDropped, atpcEnabled=atpcEnabled, modemE1T1ChannelMask=modemE1T1ChannelMask)
