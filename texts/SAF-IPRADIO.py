...
# Produced by pysmi-1.1.12 at Fri Nov 22 12:00:15 2024
...
NotificationType, MibIdentifier, ModuleIdentity, iso, Counter64, Counter32, NotificationType, enterprises, TimeTicks, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "ModuleIdentity", "iso", "Counter64", "Counter32", "NotificationType", "enterprises", "TimeTicks", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXBroadcasts=ethTXBroadcasts, vlansEnabled=vlansEnabled, modemACMengine=modemACMengine, radioIndex=radioIndex, aTPCTable=aTPCTable, ethTXBackpresEvents=ethTXBackpresEvents, modemTable=modemTable, modemACMethernetCapacity=modemACMethernetCapacity, vlanCfgStat=vlanCfgStat, modemStandard=modemStandard, ipRadioCfg=ipRadioCfg, modemModulation=modemModulation, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXPauseFrames=ethTXPauseFrames, ethRXMulticasts=ethRXMulticasts, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemEthernetCapacity=modemEthernetCapacity, radioTable=radioTable, remoteIp=remoteIp, modemAcqStatus=modemAcqStatus, ethRXPauseFrames=ethRXPauseFrames, radioTxFrequency=radioTxFrequency, hostname=hostname, saf=saf, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethGFPDelineationErrors=ethGFPDelineationErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemE1T1ChannelMask=modemE1T1ChannelMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, vlanPortType=vlanPortType, ethTXCollisions=ethTXCollisions, ethGFPCHECErrors=ethGFPCHECErrors, modemE1T1Channels=modemE1T1Channels, radioRxLevel=radioRxLevel, aTPCEntry=aTPCEntry, ethTXExcessiveDefers=ethTXExcessiveDefers, ipRadio=ipRadio, ethTXControlFrames=ethTXControlFrames, ethQOSTXFrames=ethQOSTXFrames, ethTXMulticasts=ethTXMulticasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSeverelyErroredSecond=modemSeverelyErroredSecond, atpcIndex=atpcIndex, modemErroredBlock=modemErroredBlock, ipRadioCfgGeneral=ipRadioCfgGeneral, localIpMask=localIpMask, modemGeneralStatus=modemGeneralStatus, ethQOSTXDropped=ethQOSTXDropped, sysTemperature=sysTemperature, ethRXDvEvent=ethRXDvEvent, radioEntry=radioEntry, vlanTable=vlanTable, ethRXCRCErrors=ethRXCRCErrors, ethRXByteCounterHi=ethRXByteCounterHi, license=license, ethGFPFCSErrors=ethGFPFCSErrors, modemLastAcqError=modemLastAcqError, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemRowStatus=modemRowStatus, e1t1LOS=e1t1LOS, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanEntry=vlanEntry, atpcEnabled=atpcEnabled, ethQOSRXQ1Frames=ethQOSRXQ1Frames, sysDateAndTime=sysDateAndTime, modemStatistics=modemStatistics, loopback_tributary_mask=loopback_tributary_mask, ethTXLateCollisions=ethTXLateCollisions, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethTXGiants=ethTXGiants, vlanFid=vlanFid, modemACMmodulationMin=modemACMmodulationMin, e1t1StatEntry=e1t1StatEntry, writeConfig=writeConfig, safip=safip, atpcTxPowerCorrection=atpcTxPowerCorrection, microwaveRadio=microwaveRadio, modemIndex=modemIndex, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, product=product, radioGenStatus=radioGenStatus, radioTxMute=radioTxMute, licenseUpdateStatus=licenseUpdateStatus, ethRXLongEvents=ethRXLongEvents, ipRadioStat=ipRadioStat, e1t1ChannelNr=e1t1ChannelNr, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXDones=ethTXDones, modemUptime=modemUptime, modemUnavailtime=modemUnavailtime, ethRXTruncatedFrames=ethRXTruncatedFrames, loopbacks=loopbacks, modemCountTime=modemCountTime, ethGFPDropedFrames=ethGFPDropedFrames, pointToPoint=pointToPoint, modemRadialMSE=modemRadialMSE, modemACMtotalCapacity=modemACMtotalCapacity, ethTXByteCounterHi=ethTXByteCounterHi, e1t1AIS=e1t1AIS, modemErroredSecondRatio=modemErroredSecondRatio, radioDuplexShift=radioDuplexShift, modemInternalAGCgain=modemInternalAGCgain, ethTXUnderruns=ethTXUnderruns, tehnika=tehnika, ethTXMaxCollisions=ethTXMaxCollisions, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXByteCounterLow=ethTXByteCounterLow, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXBroadcasts=ethRXBroadcasts, ethRXCodeErrors=ethRXCodeErrors, ipRadioMgmt=ipRadioMgmt, ipRadioStatEth=ipRadioStatEth, modemBandwith=modemBandwith, ethRXDones=ethRXDones, modemCarrierOffset=modemCarrierOffset, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethRXByteCounterLow=ethRXByteCounterLow, radioSide=radioSide, modemEntry=modemEntry, ethRXDribleNibbles=ethRXDribleNibbles, modemSymbolRateRx=modemSymbolRateRx, vlanPortmap=vlanPortmap, vlanRowStatus=vlanRowStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethTXVlanTags=ethTXVlanTags, modemErroredSecond=modemErroredSecond, localIp=localIp, modemTotalCapacity=modemTotalCapacity, radioLoopback=radioLoopback, ethQOSRXQ2Frames=ethQOSRXQ2Frames, licenseMask=licenseMask, e1t1StatTable=e1t1StatTable, description=description, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanNumber=vlanNumber, ethTXCRCErrors=ethTXCRCErrors, modemSymbolRateTx=modemSymbolRateTx, restartcpu=restartcpu, modemACMmodulationMax=modemACMmodulationMax, radioTxPower=radioTxPower, radioRxFrequency=radioRxFrequency, ethRXControlFrames=ethRXControlFrames)
