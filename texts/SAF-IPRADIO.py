...
# Produced by pysmi-1.1.8 at Sat Jan 15 23:32:14 2022
...
Bits, enterprises, Integer32, ModuleIdentity, ObjectIdentity, Unsigned32, IpAddress, MibIdentifier, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Counter32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "enterprises", "Integer32", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "IpAddress", "MibIdentifier", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Counter32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("SAF-IPRADIO", radioTxFrequency=radioTxFrequency, ipRadioCfgNetwork=ipRadioCfgNetwork, modemModulation=modemModulation, localIpMask=localIpMask, ethRXByteCounterHi=ethRXByteCounterHi, modemRowStatus=modemRowStatus, product=product, pointToPoint=pointToPoint, ethGFPFCSErrors=ethGFPFCSErrors, ethTXUnderruns=ethTXUnderruns, radioTxMute=radioTxMute, modemLDPCdecoderStress=modemLDPCdecoderStress, ethTXLateCollisions=ethTXLateCollisions, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanPortType=vlanPortType, e1t1LOS=e1t1LOS, modemCountTime=modemCountTime, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethTXVlanTags=ethTXVlanTags, aTPCEntry=aTPCEntry, ethTXCollisions=ethTXCollisions, ethGFPCHECErrors=ethGFPCHECErrors, atpcIndex=atpcIndex, modemUnavailtime=modemUnavailtime, ethRXMulticasts=ethRXMulticasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXDribleNibbles=ethRXDribleNibbles, e1t1StatEntry=e1t1StatEntry, modemBandwith=modemBandwith, ipRadioStat=ipRadioStat, modemTotalCapacity=modemTotalCapacity, loopbacks=loopbacks, ethRXBroadcasts=ethRXBroadcasts, ethQOSTXFrames=ethQOSTXFrames, licenseUpdateStatus=licenseUpdateStatus, e1t1ChannelNr=e1t1ChannelNr, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemRadialMSE=modemRadialMSE, radioSide=radioSide, modemEntry=modemEntry, ethRXCRCErrors=ethRXCRCErrors, e1t1AIS=e1t1AIS, ethGFPDropedFrames=ethGFPDropedFrames, modemUptime=modemUptime, tehnika=tehnika, vlanRowStatus=vlanRowStatus, ethRXLongEvents=ethRXLongEvents, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlansEnabled=vlansEnabled, ipRadioStatEth=ipRadioStatEth, ethTXCRCErrors=ethTXCRCErrors, ethTXDones=ethTXDones, modemEthernetCapacity=modemEthernetCapacity, licenseMask=licenseMask, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXBackpresEvents=ethTXBackpresEvents, ipRadioMgmt=ipRadioMgmt, modemAcqStatus=modemAcqStatus, radioTxPower=radioTxPower, radioRxLevel=radioRxLevel, microwaveRadio=microwaveRadio, ethTXByteCounterHi=ethTXByteCounterHi, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXByteCounterLow=ethRXByteCounterLow, sysDateAndTime=sysDateAndTime, license=license, radioDuplexShift=radioDuplexShift, vlanTable=vlanTable, e1t1StatTable=e1t1StatTable, vlanCfgStat=vlanCfgStat, modemE1T1ChannelMask=modemE1T1ChannelMask, ethTXMulticasts=ethTXMulticasts, ipRadioCfgGeneral=ipRadioCfgGeneral, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanEntry=vlanEntry, ethTXByteCounterLow=ethTXByteCounterLow, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemLastAcqError=modemLastAcqError, modemACMengine=modemACMengine, ethRXDvEvent=ethRXDvEvent, loopback_tributary_mask=loopback_tributary_mask, vlanPortmap=vlanPortmap, modemInternalAGCgain=modemInternalAGCgain, vlanFid=vlanFid, modemACMmodulationMax=modemACMmodulationMax, radioIndex=radioIndex, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXControlFrames=ethRXControlFrames, modemStandard=modemStandard, modemACMethernetCapacity=modemACMethernetCapacity, radioGenStatus=radioGenStatus, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, hostname=hostname, radioEntry=radioEntry, modemCarrierOffset=modemCarrierOffset, radioRxFrequency=radioRxFrequency, ethRXPauseFrames=ethRXPauseFrames, modemACMtotalCapacity=modemACMtotalCapacity, modemTotalBlockNumber=modemTotalBlockNumber, ethTXPauseFrames=ethTXPauseFrames, ethTXMaxCollisions=ethTXMaxCollisions, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTable=radioTable, writeConfig=writeConfig, ethTXGiants=ethTXGiants, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemErroredSecond=modemErroredSecond, modemSymbolRateTx=modemSymbolRateTx, restartcpu=restartcpu, saf=saf, aTPCTable=aTPCTable, modemACMmodulationMin=modemACMmodulationMin, description=description, vlanNumber=vlanNumber, safip=safip, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemGeneralStatus=modemGeneralStatus, modemTable=modemTable, ethTXControlFrames=ethTXControlFrames, ethQOSTXDropped=ethQOSTXDropped, radioLoopback=radioLoopback, modemSymbolRateRx=modemSymbolRateRx, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemE1T1Channels=modemE1T1Channels, ethTXBroadcasts=ethTXBroadcasts, modemErroredSecondRatio=modemErroredSecondRatio, ipRadio=ipRadio, ethRXCodeErrors=ethRXCodeErrors, modemIndex=modemIndex, ethRXPrevPktDropped=ethRXPrevPktDropped, ethRXTruncatedFrames=ethRXTruncatedFrames, modemStatistics=modemStatistics, sysTemperature=sysTemperature, ethQOSRXQ2Frames=ethQOSRXQ2Frames, atpcEnabled=atpcEnabled, modemErroredBlock=modemErroredBlock, ethRXDones=ethRXDones, ethQOSRXQ1Frames=ethQOSRXQ1Frames, ethTXExcessiveDefers=ethTXExcessiveDefers, remoteIp=remoteIp, ipRadioCfg=ipRadioCfg, ethTXWireByteCounterHi=ethTXWireByteCounterHi, localIp=localIp)
