...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:45:21 2021
...
Counter64, ModuleIdentity, Integer32, Counter32, Unsigned32, TimeTicks, Gauge32, enterprises, Bits, ObjectIdentity, MibIdentifier, NotificationType, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Integer32", "Counter32", "Unsigned32", "TimeTicks", "Gauge32", "enterprises", "Bits", "ObjectIdentity", "MibIdentifier", "NotificationType", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("SAF-IPRADIO", licenseMask=licenseMask, modemTotalBlockNumber=modemTotalBlockNumber, modemCountTime=modemCountTime, licenseUpdateStatus=licenseUpdateStatus, ipRadioStatEth=ipRadioStatEth, ethTXPauseFrames=ethTXPauseFrames, remoteIp=remoteIp, modemBandwith=modemBandwith, ethQOSRXQ1Frames=ethQOSRXQ1Frames, hostname=hostname, ethTXGiants=ethTXGiants, ethRXCRCErrors=ethRXCRCErrors, vlanCfgStat=vlanCfgStat, radioSide=radioSide, radioGenStatus=radioGenStatus, modemEntry=modemEntry, ethTXLengthCheckErrors=ethTXLengthCheckErrors, vlanPortmap=vlanPortmap, vlanEntry=vlanEntry, radioTxPower=radioTxPower, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, modemLastAcqError=modemLastAcqError, aTPCEntry=aTPCEntry, saf=saf, radioTable=radioTable, modemErroredSecondRatio=modemErroredSecondRatio, ipRadioStat=ipRadioStat, writeConfig=writeConfig, radioRxLevel=radioRxLevel, vlanFid=vlanFid, modemStandard=modemStandard, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemIndex=modemIndex, modemAcqStatus=modemAcqStatus, ethQOSTXFrames=ethQOSTXFrames, ethTXByteCounterLow=ethTXByteCounterLow, vlanTable=vlanTable, e1t1LOS=e1t1LOS, radioTxMute=radioTxMute, modemGeneralStatus=modemGeneralStatus, ethRXByteCounterHi=ethRXByteCounterHi, modemACMengine=modemACMengine, restartcpu=restartcpu, modemACMtotalCapacity=modemACMtotalCapacity, modemACMmodulationMax=modemACMmodulationMax, modemInternalAGCgain=modemInternalAGCgain, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredSecond=modemErroredSecond, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXBackpresEvents=ethTXBackpresEvents, modemSymbolRateTx=modemSymbolRateTx, e1t1AIS=e1t1AIS, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemStatistics=modemStatistics, modemTable=modemTable, ethRXByteCounterLow=ethRXByteCounterLow, ethRXDribleNibbles=ethRXDribleNibbles, ipRadioCfg=ipRadioCfg, atpcTxPowerCorrection=atpcTxPowerCorrection, atpcIndex=atpcIndex, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXCollisions=ethTXCollisions, loopbacks=loopbacks, radioEntry=radioEntry, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemE1T1ChannelMask=modemE1T1ChannelMask, radioDuplexShift=radioDuplexShift, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXDones=ethTXDones, modemACMmodulationMin=modemACMmodulationMin, license=license, modemUnavailtime=modemUnavailtime, modemTotalCapacity=modemTotalCapacity, ethGFPFCSErrors=ethGFPFCSErrors, ethGFPDropedFrames=ethGFPDropedFrames, e1t1ChannelNr=e1t1ChannelNr, ethTXByteCounterHi=ethTXByteCounterHi, vlanPortType=vlanPortType, loopback_tributary_mask=loopback_tributary_mask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXDones=ethRXDones, description=description, ethTXMaxCollisions=ethTXMaxCollisions, localIpMask=localIpMask, vlansEnabled=vlansEnabled, ethRXPrevPktDropped=ethRXPrevPktDropped, modemACMethernetCapacity=modemACMethernetCapacity, ipRadioCfgGeneral=ipRadioCfgGeneral, ethGFPDelineationErrors=ethGFPDelineationErrors, pointToPoint=pointToPoint, localIp=localIp, vlanNumber=vlanNumber, ethTXCRCErrors=ethTXCRCErrors, ethQOSTXDropped=ethQOSTXDropped, ethRXBroadcasts=ethRXBroadcasts, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcEnabled=atpcEnabled, modemSymbolRateRx=modemSymbolRateRx, ethGFPCHECErrors=ethGFPCHECErrors, ethTXControlFrames=ethTXControlFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanRowStatus=vlanRowStatus, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXTruncatedFrames=ethRXTruncatedFrames, radioLoopback=radioLoopback, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, sysDateAndTime=sysDateAndTime, aTPCTable=aTPCTable, microwaveRadio=microwaveRadio, ipRadio=ipRadio, modemRowStatus=modemRowStatus, ethRXLongEvents=ethRXLongEvents, ipRadioMgmt=ipRadioMgmt, modemErroredBlock=modemErroredBlock, safip=safip, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXLateCollisions=ethTXLateCollisions, radioRxFrequency=radioRxFrequency, e1t1StatEntry=e1t1StatEntry, modemLDPCdecoderStress=modemLDPCdecoderStress, modemEthernetCapacity=modemEthernetCapacity, modemCarrierOffset=modemCarrierOffset, sysTemperature=sysTemperature, radioTxFrequency=radioTxFrequency, ethRXControlFrames=ethRXControlFrames, e1t1StatTable=e1t1StatTable, modemModulation=modemModulation, ethTXMulticasts=ethTXMulticasts, product=product, ethTXBroadcasts=ethTXBroadcasts, ethRXCodeErrors=ethRXCodeErrors, ethRXPauseFrames=ethRXPauseFrames, modemSeverelyErroredSecond=modemSeverelyErroredSecond, tehnika=tehnika, ethRXMulticasts=ethRXMulticasts, ethTXUnderruns=ethTXUnderruns, ethRXDvEvent=ethRXDvEvent, modemUptime=modemUptime, radioIndex=radioIndex, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXVlanTags=ethTXVlanTags, modemE1T1Channels=modemE1T1Channels, modemRadialMSE=modemRadialMSE)
