...
# Produced by pysmi-1.1.12 at Tue Jun  4 10:14:20 2024
...
NotificationType, Counter64, NotificationType, ObjectIdentity, iso, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Bits, ModuleIdentity, enterprises, Gauge32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "NotificationType", "ObjectIdentity", "iso", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Bits", "ModuleIdentity", "enterprises", "Gauge32", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", aTPCTable=aTPCTable, modemUptime=modemUptime, pointToPoint=pointToPoint, radioTxMute=radioTxMute, modemACMmodulationMin=modemACMmodulationMin, tehnika=tehnika, vlanPortmap=vlanPortmap, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioEntry=radioEntry, ipRadioCfgGeneral=ipRadioCfgGeneral, radioRxLevel=radioRxLevel, modemEntry=modemEntry, ethRXLongEvents=ethRXLongEvents, vlanNumber=vlanNumber, radioDuplexShift=radioDuplexShift, modemGeneralStatus=modemGeneralStatus, vlanFid=vlanFid, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, loopback_tributary_mask=loopback_tributary_mask, ethTXPauseFrames=ethTXPauseFrames, ethTXLateCollisions=ethTXLateCollisions, licenseMask=licenseMask, ethTXCRCErrors=ethTXCRCErrors, ipRadioCfg=ipRadioCfg, ethRXBroadcasts=ethRXBroadcasts, sysTemperature=sysTemperature, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSymbolRateRx=modemSymbolRateRx, ethRXTruncatedFrames=ethRXTruncatedFrames, ethTXGiants=ethTXGiants, ethGFPDelineationErrors=ethGFPDelineationErrors, modemE1T1Channels=modemE1T1Channels, modemRowStatus=modemRowStatus, product=product, sysDateAndTime=sysDateAndTime, modemBackgroundBlockErrror=modemBackgroundBlockErrror, vlanRowStatus=vlanRowStatus, modemAcqStatus=modemAcqStatus, ethTXVlanTags=ethTXVlanTags, description=description, modemIndex=modemIndex, modemTotalCapacity=modemTotalCapacity, modemUnavailtime=modemUnavailtime, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemACMtotalCapacity=modemACMtotalCapacity, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, modemStandard=modemStandard, ethRXDribleNibbles=ethRXDribleNibbles, restartcpu=restartcpu, ethRXControlFrames=ethRXControlFrames, modemTable=modemTable, hostname=hostname, ipRadioStatEth=ipRadioStatEth, modemErroredBlock=modemErroredBlock, ethTXCollisions=ethTXCollisions, ethTXMaxCollisions=ethTXMaxCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, e1t1LOS=e1t1LOS, radioRxFrequency=radioRxFrequency, modemSymbolRateTx=modemSymbolRateTx, aTPCEntry=aTPCEntry, ethTXUnderruns=ethTXUnderruns, modemCountTime=modemCountTime, remoteIp=remoteIp, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, localIpMask=localIpMask, license=license, ethTXDones=ethTXDones, e1t1ChannelNr=e1t1ChannelNr, ipRadioCfgNetwork=ipRadioCfgNetwork, modemTotalBlockNumber=modemTotalBlockNumber, ethRXByteCounterLow=ethRXByteCounterLow, radioTxFrequency=radioTxFrequency, ipRadioMgmt=ipRadioMgmt, ethRXDones=ethRXDones, ethTXByteCounterHi=ethTXByteCounterHi, vlansEnabled=vlansEnabled, licenseUpdateStatus=licenseUpdateStatus, modemBandwith=modemBandwith, radioIndex=radioIndex, modemRadialMSE=modemRadialMSE, radioTxPower=radioTxPower, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredSecond=modemErroredSecond, ethTXByteCounterLow=ethTXByteCounterLow, e1t1StatTable=e1t1StatTable, ethTXControlFrames=ethTXControlFrames, ethQOSTXFrames=ethQOSTXFrames, saf=saf, modemEthernetCapacity=modemEthernetCapacity, ethRXVlanTagsDetected=ethRXVlanTagsDetected, radioGenStatus=radioGenStatus, radioLoopback=radioLoopback, e1t1AIS=e1t1AIS, modemCarrierOffset=modemCarrierOffset, modemErroredSecondRatio=modemErroredSecondRatio, modemInternalAGCgain=modemInternalAGCgain, ethTXBackpresEvents=ethTXBackpresEvents, modemModulation=modemModulation, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXCodeErrors=ethRXCodeErrors, ethRXDvEvent=ethRXDvEvent, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemACMethernetCapacity=modemACMethernetCapacity, ethGFPDropedFrames=ethGFPDropedFrames, vlanTable=vlanTable, ethGFPFCSErrors=ethGFPFCSErrors, e1t1StatEntry=e1t1StatEntry, radioSide=radioSide, modemACMengine=modemACMengine, ethRXCRCErrors=ethRXCRCErrors, ethRXPrevPktDropped=ethRXPrevPktDropped, vlanCfgStat=vlanCfgStat, localIp=localIp, radioTable=radioTable, microwaveRadio=microwaveRadio, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemLastAcqError=modemLastAcqError, modemStatistics=modemStatistics, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemACMmodulationMax=modemACMmodulationMax, writeConfig=writeConfig, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXWireByteCounterHi=ethTXWireByteCounterHi, loopbacks=loopbacks, ethRXUnsupOpcodes=ethRXUnsupOpcodes, vlanEntry=vlanEntry, ethRXMulticasts=ethRXMulticasts, atpcIndex=atpcIndex, ethTXBroadcasts=ethTXBroadcasts, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemLDPCdecoderStress=modemLDPCdecoderStress, ipRadio=ipRadio, ipRadioStat=ipRadioStat, safip=safip, vlanPortType=vlanPortType, atpcEnabled=atpcEnabled, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXPauseFrames=ethRXPauseFrames, ethTXMulticasts=ethTXMulticasts)
