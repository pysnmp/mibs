...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:44:42 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, enterprises, Gauge32, Counter64, MibIdentifier, Counter32, IpAddress, Bits, ModuleIdentity, ObjectIdentity, NotificationType, NotificationType, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "enterprises", "Gauge32", "Counter64", "MibIdentifier", "Counter32", "IpAddress", "Bits", "ModuleIdentity", "ObjectIdentity", "NotificationType", "NotificationType", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", modemRadialMSE=modemRadialMSE, ethRXPauseFrames=ethRXPauseFrames, radioTxMute=radioTxMute, e1t1StatEntry=e1t1StatEntry, modemErroredSecondRatio=modemErroredSecondRatio, modemBandwith=modemBandwith, modemRowStatus=modemRowStatus, radioTable=radioTable, radioRxFrequency=radioRxFrequency, ethTXExcessiveDefers=ethTXExcessiveDefers, license=license, ethRXDvEvent=ethRXDvEvent, localIpMask=localIpMask, radioLoopback=radioLoopback, ethRXByteCounterLow=ethRXByteCounterLow, tehnika=tehnika, modemEntry=modemEntry, modemSeverelyErroredSecond=modemSeverelyErroredSecond, description=description, ethQOSTXFrames=ethQOSTXFrames, aTPCTable=aTPCTable, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethTXByteCounterLow=ethTXByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork, radioEntry=radioEntry, modemTable=modemTable, sysDateAndTime=sysDateAndTime, ethQOSTXDropped=ethQOSTXDropped, modemSymbolRateRx=modemSymbolRateRx, modemACMmodulationMin=modemACMmodulationMin, vlanTable=vlanTable, vlanPortType=vlanPortType, modemInternalAGCgain=modemInternalAGCgain, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemUnavailtime=modemUnavailtime, ethRXLongEvents=ethRXLongEvents, ethRXPrevPktDropped=ethRXPrevPktDropped, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXBackpresEvents=ethTXBackpresEvents, licenseUpdateStatus=licenseUpdateStatus, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlansEnabled=vlansEnabled, saf=saf, licenseMask=licenseMask, ethRXCodeErrors=ethRXCodeErrors, radioRxLevel=radioRxLevel, modemACMmodulationMax=modemACMmodulationMax, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXControlFrames=ethTXControlFrames, modemACMethernetCapacity=modemACMethernetCapacity, vlanNumber=vlanNumber, ethGFPCHECErrors=ethGFPCHECErrors, ethGFPDropedFrames=ethGFPDropedFrames, radioTxFrequency=radioTxFrequency, radioIndex=radioIndex, ethTXCollisions=ethTXCollisions, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, vlanPortmap=vlanPortmap, ipRadioStat=ipRadioStat, loopbacks=loopbacks, modemIndex=modemIndex, loopback_tributary_mask=loopback_tributary_mask, ethTXPauseFrames=ethTXPauseFrames, atpcEnabled=atpcEnabled, vlanCfgStat=vlanCfgStat, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxPower=radioTxPower, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemErroredSecond=modemErroredSecond, e1t1StatTable=e1t1StatTable, modemTotalBlockNumber=modemTotalBlockNumber, ethTXUnderruns=ethTXUnderruns, vlanFid=vlanFid, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXCRCErrors=ethRXCRCErrors, ethTXCRCErrors=ethTXCRCErrors, atpcIndex=atpcIndex, pointToPoint=pointToPoint, ipRadioCfg=ipRadioCfg, modemErroredBlock=modemErroredBlock, modemEthernetCapacity=modemEthernetCapacity, localIp=localIp, ethTXDones=ethTXDones, modemModulation=modemModulation, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, e1t1LOS=e1t1LOS, ethRXMulticasts=ethRXMulticasts, modemACMengine=modemACMengine, modemStatistics=modemStatistics, ethGFPFCSErrors=ethGFPFCSErrors, ipRadio=ipRadio, ipRadioStatEth=ipRadioStatEth, modemTotalCapacity=modemTotalCapacity, ethTXGiants=ethTXGiants, ethRXBroadcasts=ethRXBroadcasts, ipRadioMgmt=ipRadioMgmt, ethRXDribleNibbles=ethRXDribleNibbles, modemACMtotalCapacity=modemACMtotalCapacity, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXLateCollisions=ethTXLateCollisions, remoteIp=remoteIp, vlanRowStatus=vlanRowStatus, ethTXBroadcasts=ethTXBroadcasts, modemUptime=modemUptime, ethRXByteCounterHi=ethRXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, modemAcqStatus=modemAcqStatus, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemCountTime=modemCountTime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXByteCounterHi=ethTXByteCounterHi, ethRXControlFrames=ethRXControlFrames, modemE1T1Channels=modemE1T1Channels, radioGenStatus=radioGenStatus, ethRXTruncatedFrames=ethRXTruncatedFrames, atpcTxPowerCorrection=atpcTxPowerCorrection, ethRXUnsupOpcodes=ethRXUnsupOpcodes, sysTemperature=sysTemperature, ethRXDones=ethRXDones, modemStandard=modemStandard, writeConfig=writeConfig, e1t1AIS=e1t1AIS, safip=safip, product=product, radioSide=radioSide, e1t1ChannelNr=e1t1ChannelNr, restartcpu=restartcpu, radioDuplexShift=radioDuplexShift, microwaveRadio=microwaveRadio, aTPCEntry=aTPCEntry, modemGeneralStatus=modemGeneralStatus, modemE1T1ChannelMask=modemE1T1ChannelMask, hostname=hostname, ethTXVlanTags=ethTXVlanTags, ethTXMulticasts=ethTXMulticasts, modemCarrierOffset=modemCarrierOffset, modemSymbolRateTx=modemSymbolRateTx, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanEntry=vlanEntry, modemLastAcqError=modemLastAcqError)
