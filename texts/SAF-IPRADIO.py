...
# Produced by pysmi-1.1.12 at Tue May 21 07:00:53 2024
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethRXPauseFrames=ethRXPauseFrames, radioLoopback=radioLoopback, radioSide=radioSide, microwaveRadio=microwaveRadio, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXCRCErrors=ethRXCRCErrors, ethGFPDropedFrames=ethGFPDropedFrames, vlanTable=vlanTable, radioGenStatus=radioGenStatus, modemIndex=modemIndex, modemE1T1ChannelMask=modemE1T1ChannelMask, modemUnavailtime=modemUnavailtime, vlanFid=vlanFid, ethQOSRXQ1Frames=ethQOSRXQ1Frames, safip=safip, ethRXMulticasts=ethRXMulticasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, licenseMask=licenseMask, ethTXMaxCollisions=ethTXMaxCollisions, ethTXGiants=ethTXGiants, ethRXByteCounterLow=ethRXByteCounterLow, ethGFPCHECErrors=ethGFPCHECErrors, e1t1StatEntry=e1t1StatEntry, vlanEntry=vlanEntry, radioTxFrequency=radioTxFrequency, modemTotalCapacity=modemTotalCapacity, radioTxPower=radioTxPower, loopback_tributary_mask=loopback_tributary_mask, product=product, modemCarrierOffset=modemCarrierOffset, ethTXBackpresEvents=ethTXBackpresEvents, ethTXCollisions=ethTXCollisions, ethTXDones=ethTXDones, loopbacks=loopbacks, ethTXByteCounterHi=ethTXByteCounterHi, hostname=hostname, sysTemperature=sysTemperature, modemCountTime=modemCountTime, modemACMethernetCapacity=modemACMethernetCapacity, modemACMmodulationMax=modemACMmodulationMax, pointToPoint=pointToPoint, vlanPortmap=vlanPortmap, modemLDPCdecoderStress=modemLDPCdecoderStress, modemRowStatus=modemRowStatus, modemInternalAGCgain=modemInternalAGCgain, aTPCEntry=aTPCEntry, ethRXBroadcasts=ethRXBroadcasts, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXBroadcasts=ethTXBroadcasts, modemStatistics=modemStatistics, ethTXMulticasts=ethTXMulticasts, ipRadioCfgGeneral=ipRadioCfgGeneral, modemSymbolRateTx=modemSymbolRateTx, ipRadioStatEth=ipRadioStatEth, modemEntry=modemEntry, ethRXCodeErrors=ethRXCodeErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethRXPrevPktDropped=ethRXPrevPktDropped, modemBandwith=modemBandwith, ethRXLongEvents=ethRXLongEvents, atpcTxPowerCorrection=atpcTxPowerCorrection, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXPauseFrames=ethTXPauseFrames, ipRadioCfg=ipRadioCfg, modemErroredSecondRatio=modemErroredSecondRatio, restartcpu=restartcpu, ethTXCRCErrors=ethTXCRCErrors, ethGFPFCSErrors=ethGFPFCSErrors, remoteIp=remoteIp, e1t1StatTable=e1t1StatTable, license=license, localIpMask=localIpMask, radioIndex=radioIndex, ethRXDones=ethRXDones, modemLastAcqError=modemLastAcqError, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXControlFrames=ethTXControlFrames, e1t1AIS=e1t1AIS, modemEthernetCapacity=modemEthernetCapacity, radioRxLevel=radioRxLevel, sysDateAndTime=sysDateAndTime, radioEntry=radioEntry, licenseUpdateStatus=licenseUpdateStatus, saf=saf, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXControlFrames=ethRXControlFrames, modemErroredBlock=modemErroredBlock, modemModulation=modemModulation, ethTXByteCounterLow=ethTXByteCounterLow, ethTXLateCollisions=ethTXLateCollisions, modemAcqStatus=modemAcqStatus, atpcIndex=atpcIndex, modemTable=modemTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ipRadioStat=ipRadioStat, ethRXTruncatedFrames=ethRXTruncatedFrames, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ2Frames=ethQOSRXQ2Frames, radioTxMute=radioTxMute, modemE1T1Channels=modemE1T1Channels, ethTXVlanTags=ethTXVlanTags, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, modemACMengine=modemACMengine, modemGeneralStatus=modemGeneralStatus, ipRadioMgmt=ipRadioMgmt, modemSymbolRateRx=modemSymbolRateRx, modemRadialMSE=modemRadialMSE, ipRadio=ipRadio, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXUnsupOpcodes=ethRXUnsupOpcodes, tehnika=tehnika, radioRxFrequency=radioRxFrequency, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethRXVlanTagsDetected=ethRXVlanTagsDetected, localIp=localIp, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, vlanRowStatus=vlanRowStatus, vlansEnabled=vlansEnabled, ethRXByteCounterHi=ethRXByteCounterHi, ethQOSTXDropped=ethQOSTXDropped, aTPCTable=aTPCTable, modemTotalBlockNumber=modemTotalBlockNumber, modemACMtotalCapacity=modemACMtotalCapacity, modemStandard=modemStandard, ethTXUnderruns=ethTXUnderruns, atpcEnabled=atpcEnabled, writeConfig=writeConfig, modemErroredSecond=modemErroredSecond, vlanPortType=vlanPortType, e1t1LOS=e1t1LOS, description=description, ethTXExcessiveDefers=ethTXExcessiveDefers, ethRXDribleNibbles=ethRXDribleNibbles, e1t1ChannelNr=e1t1ChannelNr, radioDuplexShift=radioDuplexShift, vlanNumber=vlanNumber, modemUptime=modemUptime, ethQOSTXFrames=ethQOSTXFrames, vlanCfgStat=vlanCfgStat, modemACMmodulationMin=modemACMmodulationMin, radioTable=radioTable, ethRXDvEvent=ethRXDvEvent)
