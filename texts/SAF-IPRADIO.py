...
# Produced by pysmi-1.1.10 at Mon Feb 19 03:02:00 2024
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethTXPauseFrames=ethTXPauseFrames, radioDuplexShift=radioDuplexShift, tehnika=tehnika, radioIndex=radioIndex, ethTXMulticasts=ethTXMulticasts, modemACMmodulationMin=modemACMmodulationMin, modemIndex=modemIndex, ethRXDones=ethRXDones, sysDateAndTime=sysDateAndTime, radioGenStatus=radioGenStatus, atpcTxPowerCorrection=atpcTxPowerCorrection, modemRowStatus=modemRowStatus, ethRXControlFrames=ethRXControlFrames, e1t1AIS=e1t1AIS, ethRXMulticasts=ethRXMulticasts, radioTxPower=radioTxPower, modemACMethernetCapacity=modemACMethernetCapacity, modemSymbolRateRx=modemSymbolRateRx, license=license, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethRXTruncatedFrames=ethRXTruncatedFrames, ethRXByteCounterHi=ethRXByteCounterHi, ethTXLateCollisions=ethTXLateCollisions, modemLastAcqError=modemLastAcqError, modemACMtotalCapacity=modemACMtotalCapacity, radioLoopback=radioLoopback, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, e1t1StatEntry=e1t1StatEntry, modemSymbolRateTx=modemSymbolRateTx, sysTemperature=sysTemperature, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, atpcEnabled=atpcEnabled, modemStatistics=modemStatistics, licenseMask=licenseMask, radioEntry=radioEntry, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemTotalBlockNumber=modemTotalBlockNumber, ethRXDvEvent=ethRXDvEvent, pointToPoint=pointToPoint, ipRadioStat=ipRadioStat, vlanPortType=vlanPortType, ethRXDribleNibbles=ethRXDribleNibbles, ethGFPCHECErrors=ethGFPCHECErrors, modemErroredSecondRatio=modemErroredSecondRatio, hostname=hostname, radioTxMute=radioTxMute, modemEthernetCapacity=modemEthernetCapacity, radioTxFrequency=radioTxFrequency, licenseUpdateStatus=licenseUpdateStatus, loopbacks=loopbacks, vlanFid=vlanFid, ethQOSTXDropped=ethQOSTXDropped, ethQOSRXQ1Frames=ethQOSRXQ1Frames, microwaveRadio=microwaveRadio, modemACMmodulationMax=modemACMmodulationMax, saf=saf, ethTXByteCounterLow=ethTXByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, ethTXWireByteCounterLow=ethTXWireByteCounterLow, ethTXExcessiveDefers=ethTXExcessiveDefers, vlanCfgStat=vlanCfgStat, vlanPortmap=vlanPortmap, product=product, vlanEntry=vlanEntry, ethGFPDelineationErrors=ethGFPDelineationErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, modemErroredBlock=modemErroredBlock, modemStandard=modemStandard, ethRXLongEvents=ethRXLongEvents, modemE1T1Channels=modemE1T1Channels, ethTXControlFrames=ethTXControlFrames, modemAcqStatus=modemAcqStatus, ethGFPFCSErrors=ethGFPFCSErrors, radioRxFrequency=radioRxFrequency, localIpMask=localIpMask, localIp=localIp, restartcpu=restartcpu, modemCarrierOffset=modemCarrierOffset, modemModulation=modemModulation, writeConfig=writeConfig, aTPCEntry=aTPCEntry, modemTotalCapacity=modemTotalCapacity, ethQOSTXFrames=ethQOSTXFrames, ethTXUnderruns=ethTXUnderruns, safip=safip, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXLengthCheckErrors=ethTXLengthCheckErrors, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemInternalAGCgain=modemInternalAGCgain, vlanTable=vlanTable, e1t1LOS=e1t1LOS, ipRadio=ipRadio, ethTXCRCErrors=ethTXCRCErrors, modemUnavailtime=modemUnavailtime, ipRadioCfg=ipRadioCfg, ethRXPauseFrames=ethRXPauseFrames, remoteIp=remoteIp, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, atpcIndex=atpcIndex, loopback_tributary_mask=loopback_tributary_mask, ethRXPrevPktDropped=ethRXPrevPktDropped, description=description, modemErroredSecond=modemErroredSecond, ipRadioCfgGeneral=ipRadioCfgGeneral, modemGeneralStatus=modemGeneralStatus, ethTXDones=ethTXDones, modemRadialMSE=modemRadialMSE, radioTable=radioTable, modemACMengine=modemACMengine, vlansEnabled=vlansEnabled, modemCountTime=modemCountTime, modemUptime=modemUptime, aTPCTable=aTPCTable, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXBroadcasts=ethTXBroadcasts, modemLDPCdecoderStress=modemLDPCdecoderStress, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1StatTable=e1t1StatTable, ethTXVlanTags=ethTXVlanTags, modemTable=modemTable, ethTXCollisions=ethTXCollisions, ethRXCRCErrors=ethRXCRCErrors, modemEntry=modemEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXByteCounterLow=ethRXByteCounterLow, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXBroadcasts=ethRXBroadcasts, ethTXBackpresEvents=ethTXBackpresEvents, vlanRowStatus=vlanRowStatus, ipRadioStatEth=ipRadioStatEth, ethRXCodeErrors=ethRXCodeErrors, radioRxLevel=radioRxLevel, ipRadioMgmt=ipRadioMgmt, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, e1t1ChannelNr=e1t1ChannelNr, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXGiants=ethTXGiants, vlanNumber=vlanNumber, radioSide=radioSide, ethGFPDropedFrames=ethGFPDropedFrames, modemBandwith=modemBandwith)
