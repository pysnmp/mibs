...
enterprises, IpAddress, Integer32, iso, NotificationType, MibIdentifier, Counter32, Gauge32, NotificationType, Bits, ObjectIdentity, Counter64, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "Integer32", "iso", "NotificationType", "MibIdentifier", "Counter32", "Gauge32", "NotificationType", "Bits", "ObjectIdentity", "Counter64", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("SAF-IPRADIO", atpcEnabled=atpcEnabled, e1t1StatTable=e1t1StatTable, ipRadioMgmt=ipRadioMgmt, tehnika=tehnika, ethTXLateCollisions=ethTXLateCollisions, modemEntry=modemEntry, modemCarrierOffset=modemCarrierOffset, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPDropedFrames=ethGFPDropedFrames, ethTXExcessiveDefers=ethTXExcessiveDefers, atpcIndex=atpcIndex, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, ethTXPauseFrames=ethTXPauseFrames, modemTotalBlockNumber=modemTotalBlockNumber, ethTXCollisions=ethTXCollisions, e1t1AIS=e1t1AIS, modemRowStatus=modemRowStatus, ethRXPauseFrames=ethRXPauseFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, radioTxFrequency=radioTxFrequency, radioIndex=radioIndex, modemAcqStatus=modemAcqStatus, ethRXDvEvent=ethRXDvEvent, ethTXCRCErrors=ethTXCRCErrors, radioEntry=radioEntry, modemStatistics=modemStatistics, modemModulation=modemModulation, radioGenStatus=radioGenStatus, ethTXWireByteCounterHi=ethTXWireByteCounterHi, remoteIp=remoteIp, ethRXLongEvents=ethRXLongEvents, e1t1ChannelNr=e1t1ChannelNr, modemUptime=modemUptime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, radioRxFrequency=radioRxFrequency, ipRadioCfgGeneral=ipRadioCfgGeneral, safip=safip, ethRXByteCounterHi=ethRXByteCounterHi, e1t1StatEntry=e1t1StatEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, modemGeneralStatus=modemGeneralStatus, modemRadialMSE=modemRadialMSE, ethRXBroadcasts=ethRXBroadcasts, ethGFPDelineationErrors=ethGFPDelineationErrors, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, modemCountTime=modemCountTime, saf=saf, modemUnavailtime=modemUnavailtime, localIpMask=localIpMask, vlansEnabled=vlansEnabled, loopback_tributary_mask=loopback_tributary_mask, vlanRowStatus=vlanRowStatus, radioLoopback=radioLoopback, ethTXGiants=ethTXGiants, modemErroredSecondRatio=modemErroredSecondRatio, ethTXByteCounterLow=ethTXByteCounterLow, modemACMethernetCapacity=modemACMethernetCapacity, product=product, ethQOSTXDropped=ethQOSTXDropped, modemIndex=modemIndex, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, licenseMask=licenseMask, ethQOSRXQ2Frames=ethQOSRXQ2Frames, modemACMtotalCapacity=modemACMtotalCapacity, ethRXControlFrames=ethRXControlFrames, modemErroredBlock=modemErroredBlock, modemInternalAGCgain=modemInternalAGCgain, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethRXPrevPktDropped=ethRXPrevPktDropped, ethTXMulticasts=ethTXMulticasts, modemE1T1ChannelMask=modemE1T1ChannelMask, ethRXCodeErrors=ethRXCodeErrors, ethRXMulticasts=ethRXMulticasts, ethTXVlanTags=ethTXVlanTags, licenseUpdateStatus=licenseUpdateStatus, vlanPortType=vlanPortType, modemEthernetCapacity=modemEthernetCapacity, sysDateAndTime=sysDateAndTime, modemE1T1Channels=modemE1T1Channels, ethRXCRCErrors=ethRXCRCErrors, loopbacks=loopbacks, radioTxMute=radioTxMute, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanTable=vlanTable, restartcpu=restartcpu, ethQOSTXFrames=ethQOSTXFrames, ethRXByteCounterLow=ethRXByteCounterLow, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemSymbolRateRx=modemSymbolRateRx, ipRadioStat=ipRadioStat, ethTXDones=ethTXDones, license=license, modemACMmodulationMin=modemACMmodulationMin, ipRadioCfg=ipRadioCfg, vlanFid=vlanFid, ethRXDones=ethRXDones, ethRXDribleNibbles=ethRXDribleNibbles, localIp=localIp, vlanPortmap=vlanPortmap, ethTXWireByteCounterLow=ethTXWireByteCounterLow, e1t1LOS=e1t1LOS, description=description, modemLastAcqError=modemLastAcqError, pointToPoint=pointToPoint, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXLengthCheckErrors=ethTXLengthCheckErrors, radioTxPower=radioTxPower, ipRadio=ipRadio, ethTXControlFrames=ethTXControlFrames, modemBandwith=modemBandwith, radioRxLevel=radioRxLevel, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, modemErroredSecond=modemErroredSecond, aTPCEntry=aTPCEntry, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioCfgNetwork=ipRadioCfgNetwork, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, radioSide=radioSide, ethTXUnderruns=ethTXUnderruns, sysTemperature=sysTemperature, ipRadioStatEth=ipRadioStatEth, writeConfig=writeConfig, modemTable=modemTable, microwaveRadio=microwaveRadio, vlanNumber=vlanNumber, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, modemSymbolRateTx=modemSymbolRateTx, aTPCTable=aTPCTable, ethTXMaxCollisions=ethTXMaxCollisions, hostname=hostname, radioTable=radioTable, radioDuplexShift=radioDuplexShift, ethTXBackpresEvents=ethTXBackpresEvents, modemACMengine=modemACMengine, ethGFPFCSErrors=ethGFPFCSErrors, modemACMmodulationMax=modemACMmodulationMax, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemStandard=modemStandard, modemTotalCapacity=modemTotalCapacity, vlanCfgStat=vlanCfgStat, vlanEntry=vlanEntry)
