...
# Produced by pysmi-1.1.3 at Sun Nov 28 13:46:10 2021
...
NotificationType, Bits, Unsigned32, IpAddress, enterprises, MibIdentifier, ObjectIdentity, TimeTicks, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Counter32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Unsigned32", "IpAddress", "enterprises", "MibIdentifier", "ObjectIdentity", "TimeTicks", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Counter32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ipRadioCfgGeneral=ipRadioCfgGeneral, localIpMask=localIpMask, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, vlanPortType=vlanPortType, writeConfig=writeConfig, ethRXPauseFrames=ethRXPauseFrames, microwaveRadio=microwaveRadio, remoteIp=remoteIp, saf=saf, modemRadialMSE=modemRadialMSE, ethTXBroadcasts=ethTXBroadcasts, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioTable=radioTable, license=license, radioTxFrequency=radioTxFrequency, ipRadioMgmt=ipRadioMgmt, modemModulation=modemModulation, ethGFPCHECErrors=ethGFPCHECErrors, ipRadioStatEth=ipRadioStatEth, restartcpu=restartcpu, modemACMtotalCapacity=modemACMtotalCapacity, ethRXTruncatedFrames=ethRXTruncatedFrames, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioTxMute=radioTxMute, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethTXBackpresEvents=ethTXBackpresEvents, radioLoopback=radioLoopback, vlanEntry=vlanEntry, radioEntry=radioEntry, ethTXMulticasts=ethTXMulticasts, ethGFPFCSErrors=ethGFPFCSErrors, description=description, modemEntry=modemEntry, sysDateAndTime=sysDateAndTime, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethRXUnsupOpcodes=ethRXUnsupOpcodes, radioGenStatus=radioGenStatus, aTPCEntry=aTPCEntry, modemACMmodulationMin=modemACMmodulationMin, ethRXMulticasts=ethRXMulticasts, modemBandwith=modemBandwith, modemStatistics=modemStatistics, modemLastAcqError=modemLastAcqError, modemTotalBlockNumber=modemTotalBlockNumber, vlanRowStatus=vlanRowStatus, ethRXLongEvents=ethRXLongEvents, modemUptime=modemUptime, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ethTXPauseFrames=ethTXPauseFrames, radioRxLevel=radioRxLevel, e1t1StatEntry=e1t1StatEntry, tehnika=tehnika, modemErroredSecondRatio=modemErroredSecondRatio, modemACMengine=modemACMengine, modemE1T1ChannelMask=modemE1T1ChannelMask, vlanPortmap=vlanPortmap, radioTxPower=radioTxPower, safip=safip, modemSymbolRateRx=modemSymbolRateRx, loopback_tributary_mask=loopback_tributary_mask, ethGFPDelineationErrors=ethGFPDelineationErrors, vlansEnabled=vlansEnabled, ipRadio=ipRadio, vlanTable=vlanTable, radioSide=radioSide, modemE1T1Channels=modemE1T1Channels, ethRXDvEvent=ethRXDvEvent, ethRXBroadcasts=ethRXBroadcasts, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethRXCodeErrors=ethRXCodeErrors, ethTXCollisions=ethTXCollisions, ethTXVlanTags=ethTXVlanTags, modemACMethernetCapacity=modemACMethernetCapacity, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, modemEthernetCapacity=modemEthernetCapacity, ethRXPrevPktDropped=ethRXPrevPktDropped, modemIndex=modemIndex, modemSymbolRateTx=modemSymbolRateTx, licenseMask=licenseMask, ethGFPDropedFrames=ethGFPDropedFrames, modemLDPCdecoderStress=modemLDPCdecoderStress, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXByteCounterHi=ethTXByteCounterHi, modemGeneralStatus=modemGeneralStatus, ethRXDones=ethRXDones, loopbacks=loopbacks, ethTXMaxCollisions=ethTXMaxCollisions, ethRXByteCounterLow=ethRXByteCounterLow, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemTable=modemTable, ipRadioStat=ipRadioStat, vlanNumber=vlanNumber, pointToPoint=pointToPoint, modemUnavailtime=modemUnavailtime, ethTXLengthCheckErrors=ethTXLengthCheckErrors, atpcIndex=atpcIndex, ethTXExcessiveDefers=ethTXExcessiveDefers, modemRowStatus=modemRowStatus, ethTXUnderruns=ethTXUnderruns, ipRadioCfg=ipRadioCfg, ethTXGiants=ethTXGiants, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXLateCollisions=ethTXLateCollisions, product=product, modemCarrierOffset=modemCarrierOffset, modemAcqStatus=modemAcqStatus, ethTXDones=ethTXDones, ethTXByteCounterLow=ethTXByteCounterLow, ethRXByteCounterHi=ethRXByteCounterHi, aTPCTable=aTPCTable, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, e1t1LOS=e1t1LOS, modemCountTime=modemCountTime, e1t1AIS=e1t1AIS, modemStandard=modemStandard, localIp=localIp, modemInternalAGCgain=modemInternalAGCgain, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanFid=vlanFid, modemACMmodulationMax=modemACMmodulationMax, licenseUpdateStatus=licenseUpdateStatus, atpcEnabled=atpcEnabled, ethRXControlFrames=ethRXControlFrames, vlanCfgStat=vlanCfgStat, radioRxFrequency=radioRxFrequency, modemErroredBlock=modemErroredBlock, modemErroredSecond=modemErroredSecond, ipRadioCfgNetwork=ipRadioCfgNetwork, ethTXControlFrames=ethTXControlFrames, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, ethRXCRCErrors=ethRXCRCErrors, ethQOSTXFrames=ethQOSTXFrames, ethQOSTXDropped=ethQOSTXDropped, sysTemperature=sysTemperature, radioIndex=radioIndex, ethRXDribleNibbles=ethRXDribleNibbles, ethTXCRCErrors=ethTXCRCErrors, hostname=hostname, radioDuplexShift=radioDuplexShift, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, e1t1StatTable=e1t1StatTable, e1t1ChannelNr=e1t1ChannelNr)
