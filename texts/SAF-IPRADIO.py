...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:28:27 2022
...
TimeTicks, Bits, Counter64, NotificationType, IpAddress, Unsigned32, Integer32, iso, NotificationType, Counter32, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Counter64", "NotificationType", "IpAddress", "Unsigned32", "Integer32", "iso", "NotificationType", "Counter32", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("SAF-IPRADIO", vlanRowStatus=vlanRowStatus, ipRadioCfgGeneral=ipRadioCfgGeneral, license=license, ethTXCRCErrors=ethTXCRCErrors, modemTotalBlockNumber=modemTotalBlockNumber, loopback_tributary_mask=loopback_tributary_mask, restartcpu=restartcpu, modemUptime=modemUptime, ethTXDones=ethTXDones, ethTXLateCollisions=ethTXLateCollisions, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethTXVlanTags=ethTXVlanTags, vlanFid=vlanFid, e1t1ChannelNr=e1t1ChannelNr, modemTable=modemTable, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXMulticasts=ethTXMulticasts, radioLoopback=radioLoopback, ethRXLongEvents=ethRXLongEvents, radioSide=radioSide, vlanTable=vlanTable, e1t1AIS=e1t1AIS, ethRXPauseFrames=ethRXPauseFrames, e1t1StatEntry=e1t1StatEntry, modemBackgroundBlockErrror=modemBackgroundBlockErrror, ethTXBroadcasts=ethTXBroadcasts, modemSymbolRateRx=modemSymbolRateRx, modemCarrierOffset=modemCarrierOffset, ethTXByteCounterLow=ethTXByteCounterLow, modemUnavailtime=modemUnavailtime, ipRadioMgmt=ipRadioMgmt, modemSeverelyErroredSecond=modemSeverelyErroredSecond, ethTXPauseFrames=ethTXPauseFrames, ethQOSTXDropped=ethQOSTXDropped, ethRXByteCounterLow=ethRXByteCounterLow, modemACMmodulationMin=modemACMmodulationMin, sysDateAndTime=sysDateAndTime, vlanPortType=vlanPortType, radioTxPower=radioTxPower, ethRXDones=ethRXDones, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemACMengine=modemACMengine, vlanNumber=vlanNumber, ethTXCollisions=ethTXCollisions, modemRadialMSE=modemRadialMSE, aTPCEntry=aTPCEntry, ethRXTruncatedFrames=ethRXTruncatedFrames, aTPCTable=aTPCTable, vlanCfgStat=vlanCfgStat, modemIndex=modemIndex, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, ethGFPDropedFrames=ethGFPDropedFrames, modemErroredSecondRatio=modemErroredSecondRatio, modemInternalAGCgain=modemInternalAGCgain, radioTxMute=radioTxMute, ethRXCodeErrors=ethRXCodeErrors, ethRXDribleNibbles=ethRXDribleNibbles, description=description, modemTotalCapacity=modemTotalCapacity, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemCountTime=modemCountTime, ipRadioStat=ipRadioStat, modemACMmodulationMax=modemACMmodulationMax, localIp=localIp, loopbacks=loopbacks, e1t1LOS=e1t1LOS, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethQOSTXFrames=ethQOSTXFrames, ethTXWireByteCounterHi=ethTXWireByteCounterHi, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ethTXUnderruns=ethTXUnderruns, ethTXControlFrames=ethTXControlFrames, radioRxLevel=radioRxLevel, modemErroredBlock=modemErroredBlock, ethRXCRCErrors=ethRXCRCErrors, modemAcqStatus=modemAcqStatus, ethGFPCHECErrors=ethGFPCHECErrors, radioEntry=radioEntry, modemE1T1ChannelMask=modemE1T1ChannelMask, safip=safip, vlansEnabled=vlansEnabled, e1t1StatTable=e1t1StatTable, modemBandwith=modemBandwith, ethTXExcessiveDefers=ethTXExcessiveDefers, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, radioDuplexShift=radioDuplexShift, modemGeneralStatus=modemGeneralStatus, writeConfig=writeConfig, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, ethTXGiants=ethTXGiants, ethRXDvEvent=ethRXDvEvent, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, ipRadioStatEth=ipRadioStatEth, modemE1T1Channels=modemE1T1Channels, modemStatistics=modemStatistics, modemACMethernetCapacity=modemACMethernetCapacity, saf=saf, modemModulation=modemModulation, atpcIndex=atpcIndex, ethRXPrevPktDropped=ethRXPrevPktDropped, ipRadio=ipRadio, sysTemperature=sysTemperature, modemEntry=modemEntry, pointToPoint=pointToPoint, ethRXVlanTagsDetected=ethRXVlanTagsDetected, ethTXMaxCollisions=ethTXMaxCollisions, atpcEnabled=atpcEnabled, licenseMask=licenseMask, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, localIpMask=localIpMask, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, ethTXBackpresEvents=ethTXBackpresEvents, ethRXBroadcasts=ethRXBroadcasts, modemACMtotalCapacity=modemACMtotalCapacity, radioIndex=radioIndex, ipRadioCfgNetwork=ipRadioCfgNetwork, atpcTxPowerCorrection=atpcTxPowerCorrection, vlanPortmap=vlanPortmap, product=product, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanEntry=vlanEntry, ipRadioCfg=ipRadioCfg, ethRXControlFrames=ethRXControlFrames, radioRxFrequency=radioRxFrequency, ethTXByteCounterHi=ethTXByteCounterHi, ethGFPDelineationErrors=ethGFPDelineationErrors, radioTable=radioTable, hostname=hostname, modemRowStatus=modemRowStatus, modemErroredSecond=modemErroredSecond, modemLastAcqError=modemLastAcqError, radioTxFrequency=radioTxFrequency, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethGFPFCSErrors=ethGFPFCSErrors, tehnika=tehnika, modemStandard=modemStandard, modemEthernetCapacity=modemEthernetCapacity, radioGenStatus=radioGenStatus, modemSymbolRateTx=modemSymbolRateTx, remoteIp=remoteIp, microwaveRadio=microwaveRadio, ethRXByteCounterHi=ethRXByteCounterHi, licenseUpdateStatus=licenseUpdateStatus, ethRXMulticasts=ethRXMulticasts)
