...
# Produced by pysmi-1.1.8 at Thu Sep  7 10:22:40 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, NotificationType, Counter64, NotificationType, ModuleIdentity, MibIdentifier, IpAddress, enterprises, ObjectIdentity, Counter32, Integer32, Unsigned32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "NotificationType", "Counter64", "NotificationType", "ModuleIdentity", "MibIdentifier", "IpAddress", "enterprises", "ObjectIdentity", "Counter32", "Integer32", "Unsigned32", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("SAF-IPRADIO", ethGFPCHECErrors=ethGFPCHECErrors, aTPCEntry=aTPCEntry, vlansEnabled=vlansEnabled, ethTXPauseFrames=ethTXPauseFrames, vlanRowStatus=vlanRowStatus, e1t1LOS=e1t1LOS, loopback_tributary_mask=loopback_tributary_mask, ethRXUnsupOpcodes=ethRXUnsupOpcodes, ipRadioCfgGeneral=ipRadioCfgGeneral, ethRXCRCErrors=ethRXCRCErrors, aTPCTable=aTPCTable, restartcpu=restartcpu, ethRXPauseFrames=ethRXPauseFrames, ethRXByteCounterHi=ethRXByteCounterHi, ethTXMaxCollisions=ethTXMaxCollisions, ethTXExcessiveDefers=ethTXExcessiveDefers, ethTXVlanTags=ethTXVlanTags, modemACMethernetCapacity=modemACMethernetCapacity, modemIndex=modemIndex, ethTXWireByteCounterHi=ethTXWireByteCounterHi, modemTotalBlockNumber=modemTotalBlockNumber, ethRXVlanTagsDetected=ethRXVlanTagsDetected, modemE1T1Channels=modemE1T1Channels, ethRXByteCounterLow=ethRXByteCounterLow, ethTXByteCounterHi=ethTXByteCounterHi, modemTable=modemTable, ethRXMulticasts=ethRXMulticasts, localIpMask=localIpMask, ethQOSTXFrames=ethQOSTXFrames, modemCountTime=modemCountTime, ethRXFalseCarrierErrors=ethRXFalseCarrierErrors, microwaveRadio=microwaveRadio, safip=safip, license=license, licenseMask=licenseMask, vlanTable=vlanTable, modemSymbolRateRx=modemSymbolRateRx, modemAcqStatus=modemAcqStatus, ethTXBackpresEvents=ethTXBackpresEvents, modemSymbolRateTx=modemSymbolRateTx, ethQOSRXQ2Dropped=ethQOSRXQ2Dropped, radioTable=radioTable, ipRadioStatEth=ipRadioStatEth, radioIndex=radioIndex, ethTXNonExcessiveDefers=ethTXNonExcessiveDefers, ethTXLengthCheckErrors=ethTXLengthCheckErrors, ethTXBroadcasts=ethTXBroadcasts, ethQOSRXQ2Frames=ethQOSRXQ2Frames, ethGFPFCSErrors=ethGFPFCSErrors, radioGenStatus=radioGenStatus, atpcEnabled=atpcEnabled, modemACMengine=modemACMengine, tehnika=tehnika, modemLastAcqError=modemLastAcqError, ethGFPDelineationErrors=ethGFPDelineationErrors, ethTXGiants=ethTXGiants, ethRXDvEvent=ethRXDvEvent, modemACMtotalCapacity=modemACMtotalCapacity, ethTXCollisions=ethTXCollisions, vlanEntry=vlanEntry, modemSeverelyErroredSecondRatio=modemSeverelyErroredSecondRatio, atpcIndex=atpcIndex, ipRadioCfgNetwork=ipRadioCfgNetwork, sysTemperature=sysTemperature, ipRadioCfg=ipRadioCfg, writeConfig=writeConfig, ethTXByteCounterLow=ethTXByteCounterLow, saf=saf, ethRXLengthCheckerrorsErrors=ethRXLengthCheckerrorsErrors, e1t1StatEntry=e1t1StatEntry, vlanNumber=vlanNumber, ethTXControlFrames=ethTXControlFrames, modemACMmodulationMax=modemACMmodulationMax, modemModulation=modemModulation, ethRXControlFrames=ethRXControlFrames, modemACMmodulationMin=modemACMmodulationMin, modemTotalCapacity=modemTotalCapacity, ethTXMulticasts=ethTXMulticasts, modemSeverelyErroredSecond=modemSeverelyErroredSecond, modemUnavailtime=modemUnavailtime, ethQOSRXQ1Frames=ethQOSRXQ1Frames, modemRadialMSE=modemRadialMSE, modemEntry=modemEntry, e1t1AIS=e1t1AIS, ethRXBroadcasts=ethRXBroadcasts, modemGeneralStatus=modemGeneralStatus, ethRXCodeErrors=ethRXCodeErrors, radioRxLevel=radioRxLevel, ethRXOutOfRangeErrors=ethRXOutOfRangeErrors, modemBackgroundBlockErrror=modemBackgroundBlockErrror, radioDuplexShift=radioDuplexShift, modemErroredSecond=modemErroredSecond, ipRadioStat=ipRadioStat, ipRadio=ipRadio, modemStandard=modemStandard, vlanFid=vlanFid, localIp=localIp, product=product, ethRXTruncatedFrames=ethRXTruncatedFrames, e1t1ChannelNr=e1t1ChannelNr, pointToPoint=pointToPoint, modemBandwith=modemBandwith, modemRowStatus=modemRowStatus, ethRXDones=ethRXDones, modemErroredSecondRatio=modemErroredSecondRatio, modemUptime=modemUptime, ethRXDribleNibbles=ethRXDribleNibbles, radioSide=radioSide, ethTXUnderruns=ethTXUnderruns, ethTXCRCErrors=ethTXCRCErrors, ethQOSTXDropped=ethQOSTXDropped, radioLoopback=radioLoopback, ethTXLateCollisions=ethTXLateCollisions, modemInternalAGCgain=modemInternalAGCgain, e1t1StatTable=e1t1StatTable, radioEntry=radioEntry, modemEthernetCapacity=modemEthernetCapacity, description=description, ethRXLongEvents=ethRXLongEvents, modemE1T1ChannelMask=modemE1T1ChannelMask, sysDateAndTime=sysDateAndTime, vlanPortmap=vlanPortmap, radioTxPower=radioTxPower, radioRxFrequency=radioRxFrequency, ipRadioMgmt=ipRadioMgmt, modemErroredBlock=modemErroredBlock, remoteIp=remoteIp, hostname=hostname, radioTxFrequency=radioTxFrequency, atpcTxPowerCorrection=atpcTxPowerCorrection, ethTXDones=ethTXDones, radioTxMute=radioTxMute, licenseUpdateStatus=licenseUpdateStatus, modemStatistics=modemStatistics, modemCarrierOffset=modemCarrierOffset, ethQOSRXQ1Dropped=ethQOSRXQ1Dropped, vlanCfgStat=vlanCfgStat, ethGFPDropedFrames=ethGFPDropedFrames, ethTXWireByteCounterLow=ethTXWireByteCounterLow, modemBackgroundBlockErrorRatio=modemBackgroundBlockErrorRatio, ethRXPrevPktDropped=ethRXPrevPktDropped, modemLDPCdecoderStress=modemLDPCdecoderStress, vlanPortType=vlanPortType, loopbacks=loopbacks)
