...
mibBuilder.exportSymbols("F5-PLATFORM-STATS-MIB", coreTotal5secAvg=coreTotal5secAvg, fan_5_speed=fan_5_speed, diskInfoTable=diskInfoTable, diskWriteLatencyMs=diskWriteLatencyMs, fwUpdateStatus=fwUpdateStatus, platformFwTable=platformFwTable, platformFwVersionGroup=platformFwVersionGroup, diskReadIops=diskReadIops, platformFpgaGroup=platformFpgaGroup, tempMinimum=tempMinimum, diskInfoEntry=diskInfoEntry, platformConformance=platformConformance, memAvailable=memAvailable, tempMaximum=tempMaximum, fan_7_speed=fan_7_speed, diskVersion=diskVersion, cpuCoreStatsTable=cpuCoreStatsTable, coreTotal5minAvg=coreTotal5minAvg, cpuCoreStatsEntry=cpuCoreStatsEntry, diskWriteBytes=diskWriteBytes, fwEntry=fwEntry, fwVersion=fwVersion, cpuModelName=cpuModelName, platformFantrayGroup=platformFantrayGroup, diskSerialNo=diskSerialNo, String=String, platformCpuStatsTable=platformCpuStatsTable, fpgaEntry=fpgaEntry, temperatureStatsEntry=temperatureStatsEntry, cpuCurrent=cpuCurrent, memPlatformTotal=memPlatformTotal, f5PlatformStatsObjects=f5PlatformStatsObjects, fpgaVersion=fpgaVersion, cpuTotal5secAvg=cpuTotal5secAvg, cpuCoreCnt=cpuCoreCnt, fan_4_speed=fan_4_speed, diskWriteMerged=diskWriteMerged, coreTotal1minAvg=coreTotal1minAvg, cpuTotal5minAvg=cpuTotal5minAvg, fan_2_speed=fan_2_speed, cpuStepping=cpuStepping, diskType=diskType, fpgaTable=fpgaTable, memPlatformUsed=memPlatformUsed, tempCurrent=tempCurrent, platformMemoryStatsTable=platformMemoryStatsTable, diskUtilizationStatsEntry=diskUtilizationStatsEntry, platformCompliances=platformCompliances, fantrayStatsTable=fantrayStatsTable, diskSize=diskSize, tempAverage=tempAverage, cpuThreadCnt=cpuThreadCnt, coreName=coreName, fan_8_speed=fan_8_speed, fan_3_speed=fan_3_speed, platformCPUGroup=platformCPUGroup, diskTotalIops=diskTotalIops, fantrayStatsEntry=fantrayStatsEntry, diskModel=diskModel, cpuUtilizationStatsEntry=cpuUtilizationStatsEntry, cpuIndex=cpuIndex, fan_6_speed=fan_6_speed, PYSNMP_MODULE_ID=f5PlatformStats, cpuUtilizationStatsTable=cpuUtilizationStatsTable, fpgaIndex=fpgaIndex, diskPercentageUsed=diskPercentageUsed, cpuFreq=cpuFreq, fwName=fwName, fan_9_speed=fan_9_speed, configurable=configurable, memoryStatsEntry=memoryStatsEntry, platformDiskStatsTable=platformDiskStatsTable, diskReadMerged=diskReadMerged, platformCompliance=platformCompliance, cpuProcessorStatsEntry=cpuProcessorStatsEntry, diskReadLatencyMs=diskReadLatencyMs, cpuProcessorStatsTable=cpuProcessorStatsTable, diskReadBytes=diskReadBytes, cpuCacheSize=cpuCacheSize, diskUtilizationStatsTable=diskUtilizationStatsTable, diskName=diskName, platformFpgaTable=platformFpgaTable, cpuCore=cpuCore, memoryStatsTable=memoryStatsTable, f5PlatformStats=f5PlatformStats, fan_11_speed=fan_11_speed, diskVendor=diskVendor, platformFantrayTable=platformFantrayTable, coreCurrent=coreCurrent, platformMemGroup=platformMemGroup, platformDiskGroup=platformDiskGroup, fan_12_speed=fan_12_speed, cpuTotal1minAvg=cpuTotal1minAvg, platformTemperatureTable=platformTemperatureTable, temperatureStatsTable=temperatureStatsTable, platformTempGroup=platformTempGroup, index=index, platformGroups=platformGroups, fan_1_speed=fan_1_speed, memPercentageUsed=memPercentageUsed, PlatformStatsIndex=PlatformStatsIndex, memFree=memFree, fan_10_speed=fan_10_speed, coreIndex=coreIndex, fwTable=fwTable, diskWriteIops=diskWriteIops)
