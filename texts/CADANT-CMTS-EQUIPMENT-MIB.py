...
AdminState, PortId, FirmwareSource, UnknownState, PortDetectedMode, PicType, CardId, PortType, FlowControlMode, CardType, CardSubType, DiskVolumeUsageLevel, DuplexStatus, EqActionType, PrimaryState, SecondaryState, ShelfId, PortMode = mibBuilder.importSymbols("CADANT-TC", "AdminState", "PortId", "FirmwareSource", "UnknownState", "PortDetectedMode", "PicType", "CardId", "PortType", "FlowControlMode", "CardType", "CardSubType", "DiskVolumeUsageLevel", "DuplexStatus", "EqActionType", "PrimaryState", "SecondaryState", "ShelfId", "PortMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, Bits, Counter64, Counter32, iso, MibIdentifier, NotificationType, ModuleIdentity, Unsigned32, Gauge32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "Bits", "Counter64", "Counter32", "iso", "MibIdentifier", "NotificationType", "ModuleIdentity", "Unsigned32", "Gauge32", "ObjectIdentity", "IpAddress")
TimeStamp, DisplayString, DateAndTime, MacAddress, TruthValue, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "DateAndTime", "MacAddress", "TruthValue", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", TestTransactionId=TestTransactionId, cardPicDetected=cardPicDetected, cadEquipmentMibGroup=cadEquipmentMibGroup, cmIpAddress=cmIpAddress, auditCardId=auditCardId, auditLogOutput=auditLogOutput, cadEquipmentMibConformance=cadEquipmentMibConformance, portDetectedMode=portDetectedMode, portTxFlowControlDetected=portTxFlowControlDetected, auditTime=auditTime, cardLastBootVersion=cardLastBootVersion, cardTestResult=cardTestResult, TestResult=TestResult, auditDescription=auditDescription, cardPicSerialNum=cardPicSerialNum, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, errEventId=errEventId, shelfObjects=shelfObjects, portNumber=portNumber, cardShelfId=cardShelfId, shelfNumber=shelfNumber, cmVendor=cmVendor, portId=portId, diskVolumeId=diskVolumeId, auditId=auditId, errEvRecoveryEnabled=errEvRecoveryEnabled, portSecStateChange=portSecStateChange, fpgaErrorEventGroup=fpgaErrorEventGroup, systemClock=systemClock, portTxFlowControlMode=portTxFlowControlMode, portPrState=portPrState, cardCpuSpeed=cardCpuSpeed, portTrapInh=portTrapInh, TestId=TestId, cardCpuType=cardCpuType, portRxFlowControlMode=portRxFlowControlMode, portPrStateChange=portPrStateChange, shelfSwVersion=shelfSwVersion, verboseLevel=verboseLevel, portCardId=portCardId, portAction=portAction, equipmentAudit=equipmentAudit, equipmentDiagGroup=equipmentDiagGroup, trapSeverity=trapSeverity, cardAction=cardAction, cardFlashSize=cardFlashSize, cardTemperatureHighWarn=cardTemperatureHighWarn, portDplxStatus=portDplxStatus, cmResetNotification=cmResetNotification, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, auditEntry=auditEntry, TestCommand=TestCommand, cardFwVersion=cardFwVersion, cardTestSchedule=cardTestSchedule, portMaxDsPower=portMaxDsPower, cardTemperature=cardTemperature, cardPrStateChange=cardPrStateChange, diskVolumeEntry=diskVolumeEntry, portTable=portTable, cardTestTable=cardTestTable, diskVolumeCardId=diskVolumeCardId, equipmentError=equipmentError, cardTestType=cardTestType, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardLastChangeTime=cardLastChangeTime, portCurrDsPower=portCurrDsPower, cardDplxStatusChange=cardDplxStatusChange, cardCarrierHwVersion=cardCarrierHwVersion, systemGeneral=systemGeneral, PYSNMP_MODULE_ID=cadEquipmentMib, remainInDiagMode=remainInDiagMode, cardId=cardId, consoleOutput=consoleOutput, cardTestResultNotification=cardTestResultNotification, diskVolumeShelfId=diskVolumeShelfId, cardDetectedChange=cardDetectedChange, cardFpgaSource=cardFpgaSource, auditCommand=auditCommand, equipmentTraps=equipmentTraps, trapCounter=trapCounter, cardSubType=cardSubType, cardSubDetected=cardSubDetected, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardTestId=cardTestId, portShelfId=portShelfId, cardSecStateChange=cardSecStateChange, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTempNoReportNotification=cardTempNoReportNotification, cardShelfTestIndex=cardShelfTestIndex, diskVolumeTable=diskVolumeTable, auditName=auditName, portBgpId=portBgpId, cardSwVersion=cardSwVersion, diskVolumeDiskSize=diskVolumeDiskSize, cardEntry=cardEntry, systemGeneralGroup=systemGeneralGroup, cardName=cardName, errEvLoggingEnabled=errEvLoggingEnabled, cardCPLDVersion=cardCPLDVersion, cardHwVersion=cardHwVersion, diskVolumeTrapInh=diskVolumeTrapInh, cmResetStatus=cmResetStatus, equipmentAuditGroup=equipmentAuditGroup, cardTestResultDesc=cardTestResultDesc, cmUChannelID=cmUChannelID, portType=portType, cardSecState=cardSecState, portNumChans=portNumChans, cardTestIndex=cardTestIndex, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cmRegistrationNotification=cmRegistrationNotification, cardTemperatureHighError=cardTemperatureHighError, cardAdminState=cardAdminState, fpgaErrorEventTable=fpgaErrorEventTable, eqDiagConfig=eqDiagConfig, equipmentStateGroup=equipmentStateGroup, portSecState=portSecState, cardTestName=cardTestName, cardTestEntry=cardTestEntry, auditTotalFailedCount=auditTotalFailedCount, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, auditPassedCount=auditPassedCount, equipmentState=equipmentState, auditFailedCount=auditFailedCount, cardLastResetReason=cardLastResetReason, auditTable=auditTable, equipmentDiag=equipmentDiag, downstreamPowerLoss=downstreamPowerLoss, portLastChangeTime=portLastChangeTime, systemKey=systemKey, cmMacAddress=cmMacAddress, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeUsageLevel=diskVolumeUsageLevel, cmResetInfo=cmResetInfo, cardTestTime=cardTestTime, portCardSubType=portCardSubType, auditStatus=auditStatus, auditTotalPassedCount=auditTotalPassedCount, cmResetUpTime=cmResetUpTime, portDplxStatusChange=portDplxStatusChange, cardSpareGroupId=cardSpareGroupId, auditAutoScheduling=auditAutoScheduling, TestSchedule=TestSchedule, portMinDsPower=portMinDsPower, portAdminState=portAdminState, portMode=portMode, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardLastBootSource=cardLastBootSource, diskVolumeFileName=diskVolumeFileName, cardTempOverHeatNotification=cardTempOverHeatNotification, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeDriveId=diskVolumeDriveId, cardTestDescription=cardTestDescription, errEvLogLevel=errEvLogLevel, equipmentPortGroup=equipmentPortGroup, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeSize=diskVolumeSize, cardRamSize=cardRamSize, cardPrState=cardPrState, cardFwUpdateStatus=cardFwUpdateStatus, diskVolumeName=diskVolumeName, auditShelfId=auditShelfId, cadEquipmentMib=cadEquipmentMib, cardNumPorts=cardNumPorts, cmPrimarySID=cmPrimarySID, cardNumber=cardNumber, cmResetReason=cmResetReason, shelfName=shelfName, portEntry=portEntry, cardBootVersion=cardBootVersion, cardPicHwVersion=cardPicHwVersion, auditLogThrottle=auditLogThrottle, TestType=TestType, portMacIfIndex=portMacIfIndex, cardSerialNum=cardSerialNum, cardUpTime=cardUpTime, equipmentShelfGroup=equipmentShelfGroup, TestScheduleCommand=TestScheduleCommand, errEvRowStatus=errEvRowStatus, cardTrapInh=cardTrapInh, cardDetected=cardDetected, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cmDevice=cmDevice, cardTestTransId=cardTestTransId, cardCarrierSerialNum=cardCarrierSerialNum, diskVolumeNumber=diskVolumeNumber, cardSpareGroupMode=cardSpareGroupMode, portMacAddress=portMacAddress, portConnectorId=portConnectorId, cardType=cardType, auditCycleCount=auditCycleCount, cardBusSpeed=cardBusSpeed, fpgaErrorEventEntry=fpgaErrorEventEntry, cardTestScheduleCommand=cardTestScheduleCommand, equipmentTbl=equipmentTbl, cardTable=cardTable, cardDplxStatus=cardDplxStatus, diagTestId=diagTestId, portDescription=portDescription, cardTestCommand=cardTestCommand, auditResult=auditResult, diskDriveNumber=diskDriveNumber, equipmentCardTestGroup=equipmentCardTestGroup, cmResetClearNotification=cmResetClearNotification, diskVolumeGroup=diskVolumeGroup, portDocsIfIndex=portDocsIfIndex, equipmentCardGroup=equipmentCardGroup)
