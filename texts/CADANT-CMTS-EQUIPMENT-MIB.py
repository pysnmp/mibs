...
EqActionType, PicType, AdminState, PortId, CardType, PortType, CardSubType, PrimaryState, DiskVolumeUsageLevel, DuplexStatus, FirmwareSource, FlowControlMode, UnknownState, PortDetectedMode, CardId, SecondaryState, PortMode, ShelfId = mibBuilder.importSymbols("CADANT-TC", "EqActionType", "PicType", "AdminState", "PortId", "CardType", "PortType", "CardSubType", "PrimaryState", "DiskVolumeUsageLevel", "DuplexStatus", "FirmwareSource", "FlowControlMode", "UnknownState", "PortDetectedMode", "CardId", "SecondaryState", "PortMode", "ShelfId")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
Integer32, Unsigned32, Bits, TimeTicks, IpAddress, ObjectIdentity, Counter32, iso, Counter64, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Bits", "TimeTicks", "IpAddress", "ObjectIdentity", "Counter32", "iso", "Counter64", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity")
TextualConvention, TimeStamp, RowStatus, DateAndTime, DisplayString, TruthValue, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "RowStatus", "DateAndTime", "DisplayString", "TruthValue", "MacAddress")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", consoleOutput=consoleOutput, cardCarrierFwVersion=cardCarrierFwVersion, cmDevice=cmDevice, diskVolumeTable=diskVolumeTable, cardBusSpeed=cardBusSpeed, portShelfId=portShelfId, cardTemperatureHighWarn=cardTemperatureHighWarn, equipmentAuditGroup=equipmentAuditGroup, portRxFlowControlMode=portRxFlowControlMode, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portTrapInh=portTrapInh, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditResult=auditResult, portMinDsPower=portMinDsPower, cardName=cardName, auditDescription=auditDescription, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardTestTransId=cardTestTransId, cardCpuType=cardCpuType, portNumber=portNumber, portTxFlowControlDetected=portTxFlowControlDetected, cardTestResultNotification=cardTestResultNotification, portRxFlowControlDetected=portRxFlowControlDetected, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardAdminState=cardAdminState, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, auditTotalPassedCount=auditTotalPassedCount, cardTestDescription=cardTestDescription, trapSeverity=trapSeverity, diagTestId=diagTestId, remainInDiagMode=remainInDiagMode, portDetectedMode=portDetectedMode, cardPrState=cardPrState, cardSpareGroupId=cardSpareGroupId, diskVolumeUsageNotification=diskVolumeUsageNotification, systemClock=systemClock, cardId=cardId, cardCpuSpeed=cardCpuSpeed, cardPicDetected=cardPicDetected, PYSNMP_MODULE_ID=cadEquipmentMib, cardTestId=cardTestId, cmPrimarySID=cmPrimarySID, cardTemperature=cardTemperature, systemKey=systemKey, cardSwVersion=cardSwVersion, diskVolumeCardId=diskVolumeCardId, TestResult=TestResult, cardPicSerialNum=cardPicSerialNum, cardTestEntry=cardTestEntry, auditName=auditName, portNumChans=portNumChans, cardTempNoReportNotification=cardTempNoReportNotification, portPrStateChange=portPrStateChange, portType=portType, errEvLogLevel=errEvLogLevel, errEvRecoveryEnabled=errEvRecoveryEnabled, auditPassedCount=auditPassedCount, cardEntry=cardEntry, cardPrStateChange=cardPrStateChange, TestScheduleCommand=TestScheduleCommand, cardTestResultDesc=cardTestResultDesc, cardSecStateChange=cardSecStateChange, cardDplxStatus=cardDplxStatus, cardSpareGroupMode=cardSpareGroupMode, auditTotalFailedCount=auditTotalFailedCount, cmResetInfo=cmResetInfo, shelfObjects=shelfObjects, cardUpTime=cardUpTime, portCurrDsPower=portCurrDsPower, auditEntry=auditEntry, cmVendor=cmVendor, systemGeneral=systemGeneral, equipmentCardTestGroup=equipmentCardTestGroup, cardTestIndex=cardTestIndex, cmResetNotification=cmResetNotification, TestTransactionId=TestTransactionId, cardFpgaSource=cardFpgaSource, TestCommand=TestCommand, cardSerialNum=cardSerialNum, portAdminState=portAdminState, diskVolumeGroup=diskVolumeGroup, equipmentDiag=equipmentDiag, cardTestName=cardTestName, cardAction=cardAction, cardShelfId=cardShelfId, cardNumPorts=cardNumPorts, equipmentState=equipmentState, portMode=portMode, portPrState=portPrState, TestSchedule=TestSchedule, cardTestCommand=cardTestCommand, portLastChangeTime=portLastChangeTime, diskVolumeFileName=diskVolumeFileName, errEventId=errEventId, cardCPLDVersion=cardCPLDVersion, cardTemperatureHighError=cardTemperatureHighError, cmUChannelID=cmUChannelID, shelfName=shelfName, cardBootVersion=cardBootVersion, fpgaErrorEventEntry=fpgaErrorEventEntry, fpgaErrorEventTable=fpgaErrorEventTable, auditTime=auditTime, cardTable=cardTable, diskVolumeTrapInh=diskVolumeTrapInh, equipmentDiagGroup=equipmentDiagGroup, cadEquipmentMibConformance=cadEquipmentMibConformance, cardType=cardType, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardLastBootVersion=cardLastBootVersion, cardDetected=cardDetected, cmResetUpTime=cmResetUpTime, cardRamSize=cardRamSize, auditFailedCount=auditFailedCount, portDocsIfIndex=portDocsIfIndex, cardSecState=cardSecState, portConnectorId=portConnectorId, verboseLevel=verboseLevel, TestType=TestType, auditId=auditId, portSecStateChange=portSecStateChange, portMacAddress=portMacAddress, portTable=portTable, equipmentAudit=equipmentAudit, equipmentShelfGroup=equipmentShelfGroup, diskVolumeUsageLevel=diskVolumeUsageLevel, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, TestId=TestId, shelfNumber=shelfNumber, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeId=diskVolumeId, portDescription=portDescription, cardTestTable=cardTestTable, cardTempOverHeatNotification=cardTempOverHeatNotification, portDplxStatus=portDplxStatus, portCardSubType=portCardSubType, diskVolumeShelfId=diskVolumeShelfId, cardTestSchedule=cardTestSchedule, cardPicHwVersion=cardPicHwVersion, cardLastBootSource=cardLastBootSource, auditStatus=auditStatus, cardCarrierHwVersion=cardCarrierHwVersion, portCardId=portCardId, auditCardId=auditCardId, auditLogThrottle=auditLogThrottle, auditCycleCount=auditCycleCount, portMaxDsPower=portMaxDsPower, cardTestType=cardTestType, cardTrapInh=cardTrapInh, portAction=portAction, cadEquipmentMib=cadEquipmentMib, fpgaErrorEventGroup=fpgaErrorEventGroup, cardLastChangeTime=cardLastChangeTime, trapCounter=trapCounter, portSecState=portSecState, auditShelfId=auditShelfId, cardLastResetReason=cardLastResetReason, diskVolumeNumber=diskVolumeNumber, cardTestScheduleCommand=cardTestScheduleCommand, diskVolumeUsagePercentage=diskVolumeUsagePercentage, diskVolumeDiskSize=diskVolumeDiskSize, cardTestResult=cardTestResult, portMacIfIndex=portMacIfIndex, cmMacAddress=cmMacAddress, downstreamPowerLoss=downstreamPowerLoss, equipmentTraps=equipmentTraps, cardShelfTestIndex=cardShelfTestIndex, cardNumber=cardNumber, diskDriveNumber=diskDriveNumber, cardSubDetected=cardSubDetected, portEntry=portEntry, eqDiagConfig=eqDiagConfig, cardDplxStatusChange=cardDplxStatusChange, diskVolumeDriveId=diskVolumeDriveId, portTxFlowControlMode=portTxFlowControlMode, diskVolumeSize=diskVolumeSize, equipmentPortGroup=equipmentPortGroup, cmResetClearNotification=cmResetClearNotification, portDplxStatusChange=portDplxStatusChange, auditLogOutput=auditLogOutput, cadEquipmentMibGroup=cadEquipmentMibGroup, cardSubType=cardSubType, diskVolumeEntry=diskVolumeEntry, cardFwUpdateStatus=cardFwUpdateStatus, cardTestTime=cardTestTime, diskVolumeName=diskVolumeName, equipmentError=equipmentError, cmResetReason=cmResetReason, equipmentCardGroup=equipmentCardGroup, cmRegistrationNotification=cmRegistrationNotification, cardHwVersion=cardHwVersion, portBgpId=portBgpId, cmResetStatus=cmResetStatus, errEvRowStatus=errEvRowStatus, portId=portId, cardFlashSize=cardFlashSize, equipmentStateGroup=equipmentStateGroup, equipmentTbl=equipmentTbl, auditAutoScheduling=auditAutoScheduling, auditTable=auditTable, cmIpAddress=cmIpAddress, auditCommand=auditCommand, cardDetectedChange=cardDetectedChange, cardCarrierSerialNum=cardCarrierSerialNum, systemGeneralGroup=systemGeneralGroup, cardFwVersion=cardFwVersion, shelfSwVersion=shelfSwVersion)
