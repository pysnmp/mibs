...
EqActionType, PicType, PortMode, PrimaryState, FlowControlMode, DuplexStatus, PortType, CardSubType, UnknownState, AdminState, CardId, SecondaryState, DiskVolumeUsageLevel, CardType, FirmwareSource, ShelfId, PortDetectedMode, PortId = mibBuilder.importSymbols("CADANT-TC", "EqActionType", "PicType", "PortMode", "PrimaryState", "FlowControlMode", "DuplexStatus", "PortType", "CardSubType", "UnknownState", "AdminState", "CardId", "SecondaryState", "DiskVolumeUsageLevel", "CardType", "FirmwareSource", "ShelfId", "PortDetectedMode", "PortId")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
Integer32, NotificationType, IpAddress, Counter64, Unsigned32, ModuleIdentity, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, TimeTicks, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "IpAddress", "Counter64", "Unsigned32", "ModuleIdentity", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "TimeTicks", "iso", "MibIdentifier")
DisplayString, DateAndTime, RowStatus, TimeStamp, TruthValue, MacAddress, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "DateAndTime", "RowStatus", "TimeStamp", "TruthValue", "MacAddress", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portSecStateChange=portSecStateChange, auditStatus=auditStatus, portShelfId=portShelfId, portCardSubType=portCardSubType, cardType=cardType, TestId=TestId, equipmentAuditGroup=equipmentAuditGroup, cardUpTime=cardUpTime, fpgaErrorEventTable=fpgaErrorEventTable, TestSchedule=TestSchedule, equipmentDiagGroup=equipmentDiagGroup, cardSwVersion=cardSwVersion, cardTestName=cardTestName, errEvLogLevel=errEvLogLevel, cardNumPorts=cardNumPorts, cardFwVersion=cardFwVersion, cardTestDescription=cardTestDescription, portEntry=portEntry, equipmentCardGroup=equipmentCardGroup, portId=portId, TestCommand=TestCommand, fpgaErrorEventGroup=fpgaErrorEventGroup, remainInDiagMode=remainInDiagMode, cmIpAddress=cmIpAddress, portMacIfIndex=portMacIfIndex, cardSecState=cardSecState, cardFlashSize=cardFlashSize, diskVolumeNumber=diskVolumeNumber, auditFailedCount=auditFailedCount, cardTempNoReportNotification=cardTempNoReportNotification, verboseLevel=verboseLevel, auditLogOutput=auditLogOutput, portTrapInh=portTrapInh, diskVolumeTable=diskVolumeTable, cardName=cardName, diskVolumeSize=diskVolumeSize, cardTable=cardTable, cardPicSerialNum=cardPicSerialNum, portDescription=portDescription, cardSpareGroupId=cardSpareGroupId, cardCpuType=cardCpuType, diskVolumeShelfId=diskVolumeShelfId, trapCounter=trapCounter, cardNumber=cardNumber, cmMacAddress=cmMacAddress, portTable=portTable, auditLogThrottle=auditLogThrottle, TestScheduleCommand=TestScheduleCommand, portAdminState=portAdminState, auditResult=auditResult, portMacAddress=portMacAddress, equipmentState=equipmentState, portCardId=portCardId, shelfSwVersion=shelfSwVersion, diskVolumeUsageNotification=diskVolumeUsageNotification, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardDplxStatusChange=cardDplxStatusChange, cmRegistrationNotification=cmRegistrationNotification, portNumChans=portNumChans, cardTestId=cardTestId, shelfName=shelfName, cardLastBootVersion=cardLastBootVersion, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cadEquipmentMib=cadEquipmentMib, fpgaErrorEventEntry=fpgaErrorEventEntry, portMode=portMode, auditAutoScheduling=auditAutoScheduling, auditTotalPassedCount=auditTotalPassedCount, portDplxStatusChange=portDplxStatusChange, cardTempOverHeatNotification=cardTempOverHeatNotification, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, PYSNMP_MODULE_ID=cadEquipmentMib, cardTestEntry=cardTestEntry, portPrStateChange=portPrStateChange, cmPrimarySID=cmPrimarySID, cardEntry=cardEntry, cardFwUpdateStatus=cardFwUpdateStatus, cardAdminState=cardAdminState, auditTable=auditTable, cardCpuSpeed=cardCpuSpeed, portType=portType, equipmentAudit=equipmentAudit, cmVendor=cmVendor, diskVolumeGroup=diskVolumeGroup, shelfNumber=shelfNumber, cardTemperatureHighWarn=cardTemperatureHighWarn, portDocsIfIndex=portDocsIfIndex, auditCommand=auditCommand, cardSerialNum=cardSerialNum, cardSubDetected=cardSubDetected, portConnectorId=portConnectorId, portMinDsPower=portMinDsPower, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTestScheduleCommand=cardTestScheduleCommand, cardTestSchedule=cardTestSchedule, cardTestTime=cardTestTime, portTxFlowControlMode=portTxFlowControlMode, cardHwVersion=cardHwVersion, cardLastChangeTime=cardLastChangeTime, equipmentTraps=equipmentTraps, cardTestType=cardTestType, diskVolumeName=diskVolumeName, portDplxStatus=portDplxStatus, cardBusSpeed=cardBusSpeed, cadEquipmentMibConformance=cadEquipmentMibConformance, diskVolumeUsageLevel=diskVolumeUsageLevel, downstreamPowerLoss=downstreamPowerLoss, portCurrDsPower=portCurrDsPower, cardTestResultDesc=cardTestResultDesc, cmResetNotification=cmResetNotification, TestTransactionId=TestTransactionId, cmResetInfo=cmResetInfo, cardPrStateChange=cardPrStateChange, diskVolumeFileName=diskVolumeFileName, portRxFlowControlDetected=portRxFlowControlDetected, systemGeneralGroup=systemGeneralGroup, diskDriveNumber=diskDriveNumber, TestType=TestType, cardCarrierFwVersion=cardCarrierFwVersion, cmResetClearNotification=cmResetClearNotification, cardTestTransId=cardTestTransId, cardTemperature=cardTemperature, portDetectedMode=portDetectedMode, cardPicDetected=cardPicDetected, TestResult=TestResult, cardTrapInh=cardTrapInh, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, systemKey=systemKey, cardCarrierSerialNum=cardCarrierSerialNum, cardTestResultNotification=cardTestResultNotification, cardCarrierHwVersion=cardCarrierHwVersion, auditId=auditId, equipmentTbl=equipmentTbl, cmResetReason=cmResetReason, cardSpareGroupMode=cardSpareGroupMode, portMaxDsPower=portMaxDsPower, auditEntry=auditEntry, cardShelfId=cardShelfId, cardPicHwVersion=cardPicHwVersion, diskVolumeEntry=diskVolumeEntry, consoleOutput=consoleOutput, portRxFlowControlMode=portRxFlowControlMode, equipmentShelfGroup=equipmentShelfGroup, cadEquipmentMibCompliances=cadEquipmentMibCompliances, diagTestId=diagTestId, diskVolumeDiskSize=diskVolumeDiskSize, cardTestTable=cardTestTable, cardTestResult=cardTestResult, systemClock=systemClock, cardAction=cardAction, cardLastResetReason=cardLastResetReason, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, systemGeneral=systemGeneral, portTxFlowControlDetected=portTxFlowControlDetected, shelfObjects=shelfObjects, diskVolumeUsagePercentage=diskVolumeUsagePercentage, eqDiagConfig=eqDiagConfig, cmUChannelID=cmUChannelID, cardDetectedChange=cardDetectedChange, equipmentCardTestGroup=equipmentCardTestGroup, cardShelfTestIndex=cardShelfTestIndex, cardSubType=cardSubType, cardBootVersion=cardBootVersion, cmResetUpTime=cmResetUpTime, cardDplxStatus=cardDplxStatus, cardTestIndex=cardTestIndex, trapSeverity=trapSeverity, cardCPLDVersion=cardCPLDVersion, portBgpId=portBgpId, cardRamSize=cardRamSize, equipmentPortGroup=equipmentPortGroup, diskVolumeCardId=diskVolumeCardId, errEventId=errEventId, equipmentError=equipmentError, auditCycleCount=auditCycleCount, cardId=cardId, auditCardId=auditCardId, portAction=portAction, auditShelfId=auditShelfId, cardTemperatureHighError=cardTemperatureHighError, diskVolumeId=diskVolumeId, auditDescription=auditDescription, cmDevice=cmDevice, portNumber=portNumber, cardPrState=cardPrState, cardLastBootSource=cardLastBootSource, cardSecStateChange=cardSecStateChange, auditTotalFailedCount=auditTotalFailedCount, portSecState=portSecState, equipmentDiag=equipmentDiag, portLastChangeTime=portLastChangeTime, auditPassedCount=auditPassedCount, errEvRecoveryEnabled=errEvRecoveryEnabled, cardDetected=cardDetected, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTestCommand=cardTestCommand, diskVolumeDriveId=diskVolumeDriveId, cardFpgaSource=cardFpgaSource, auditName=auditName, auditTime=auditTime, portPrState=portPrState, errEvRowStatus=errEvRowStatus, cmResetStatus=cmResetStatus, diskVolumeTrapInh=diskVolumeTrapInh, cadEquipmentMibGroup=cadEquipmentMibGroup, equipmentStateGroup=equipmentStateGroup)
