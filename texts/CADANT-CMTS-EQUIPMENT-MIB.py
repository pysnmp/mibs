...
PortDetectedMode, FirmwareSource, CardSubType, CardId, PicType, PrimaryState, CardType, PortId, PortMode, PortType, ShelfId, AdminState, FlowControlMode, EqActionType, DuplexStatus, DiskVolumeUsageLevel, UnknownState, SecondaryState = mibBuilder.importSymbols("CADANT-TC", "PortDetectedMode", "FirmwareSource", "CardSubType", "CardId", "PicType", "PrimaryState", "CardType", "PortId", "PortMode", "PortType", "ShelfId", "AdminState", "FlowControlMode", "EqActionType", "DuplexStatus", "DiskVolumeUsageLevel", "UnknownState", "SecondaryState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
NotificationType, Integer32, TimeTicks, MibIdentifier, Bits, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, Gauge32, IpAddress, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "TimeTicks", "MibIdentifier", "Bits", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "Gauge32", "IpAddress", "ObjectIdentity", "iso")
DateAndTime, RowStatus, DisplayString, MacAddress, TimeStamp, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "RowStatus", "DisplayString", "MacAddress", "TimeStamp", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portDplxStatusChange=portDplxStatusChange, portDescription=portDescription, portTxFlowControlDetected=portTxFlowControlDetected, cmRegistrationNotification=cmRegistrationNotification, diskVolumeFileName=diskVolumeFileName, cardLastChangeTime=cardLastChangeTime, cardSubType=cardSubType, diskVolumeId=diskVolumeId, systemGeneralGroup=systemGeneralGroup, cardTrapInh=cardTrapInh, equipmentStateGroup=equipmentStateGroup, equipmentDiagGroup=equipmentDiagGroup, portLastChangeTime=portLastChangeTime, cardShelfTestIndex=cardShelfTestIndex, cardCpuType=cardCpuType, portTable=portTable, cadEquipmentMib=cadEquipmentMib, portDplxStatus=portDplxStatus, equipmentPortGroup=equipmentPortGroup, equipmentAudit=equipmentAudit, auditTime=auditTime, auditFailedCount=auditFailedCount, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardNumPorts=cardNumPorts, diskVolumeName=diskVolumeName, cardCarrierFwVersion=cardCarrierFwVersion, auditCardId=auditCardId, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeGroup=diskVolumeGroup, cardTemperatureHighWarn=cardTemperatureHighWarn, cardTemperature=cardTemperature, diskVolumeSize=diskVolumeSize, cardTestCommand=cardTestCommand, portRxFlowControlMode=portRxFlowControlMode, cardSpareGroupMode=cardSpareGroupMode, cardFwVersion=cardFwVersion, equipmentTbl=equipmentTbl, cardDplxStatus=cardDplxStatus, cardFwUpdateStatus=cardFwUpdateStatus, portSecState=portSecState, equipmentShelfGroup=equipmentShelfGroup, cmVendor=cmVendor, portDetectedMode=portDetectedMode, cardNumber=cardNumber, cardAdminState=cardAdminState, diskVolumeDiskSize=diskVolumeDiskSize, cardTable=cardTable, shelfName=shelfName, auditDescription=auditDescription, cardSwVersion=cardSwVersion, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeTable=diskVolumeTable, systemGeneral=systemGeneral, diskVolumeDriveId=diskVolumeDriveId, trapSeverity=trapSeverity, fpgaErrorEventGroup=fpgaErrorEventGroup, equipmentState=equipmentState, cardFlashSize=cardFlashSize, cardTestIndex=cardTestIndex, portCardId=portCardId, auditLogThrottle=auditLogThrottle, cardRamSize=cardRamSize, cardTemperatureHighError=cardTemperatureHighError, TestCommand=TestCommand, portShelfId=portShelfId, TestSchedule=TestSchedule, cardEntry=cardEntry, equipmentCardTestGroup=equipmentCardTestGroup, cardLastResetReason=cardLastResetReason, shelfObjects=shelfObjects, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, downstreamPowerLoss=downstreamPowerLoss, auditLogOutput=auditLogOutput, portType=portType, errEvLoggingEnabled=errEvLoggingEnabled, cmResetUpTime=cmResetUpTime, equipmentError=equipmentError, portCardSubType=portCardSubType, remainInDiagMode=remainInDiagMode, errEvLogLevel=errEvLogLevel, auditName=auditName, cardSecStateChange=cardSecStateChange, portBgpId=portBgpId, eqDiagConfig=eqDiagConfig, cmResetNotification=cmResetNotification, portId=portId, cardCpuSpeed=cardCpuSpeed, portNumber=portNumber, cardFpgaSource=cardFpgaSource, trapCounter=trapCounter, cardCPLDVersion=cardCPLDVersion, portMode=portMode, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, shelfNumber=shelfNumber, equipmentTraps=equipmentTraps, cardTestType=cardTestType, auditCycleCount=auditCycleCount, verboseLevel=verboseLevel, cardType=cardType, cardTestResultDesc=cardTestResultDesc, cardSerialNum=cardSerialNum, auditId=auditId, cmIpAddress=cmIpAddress, cardHwVersion=cardHwVersion, cardLastBootVersion=cardLastBootVersion, cardDetected=cardDetected, TestId=TestId, cardTestTable=cardTestTable, cardTestScheduleCommand=cardTestScheduleCommand, systemClock=systemClock, cardTestSchedule=cardTestSchedule, errEvRecoveryEnabled=errEvRecoveryEnabled, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, TestScheduleCommand=TestScheduleCommand, cardTestEntry=cardTestEntry, cardPicDetected=cardPicDetected, auditShelfId=auditShelfId, cardPicHwVersion=cardPicHwVersion, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cadEquipmentMibConformance=cadEquipmentMibConformance, portMacAddress=portMacAddress, diskVolumeShelfId=diskVolumeShelfId, diskDriveNumber=diskDriveNumber, cardUpTime=cardUpTime, portConnectorId=portConnectorId, portTxFlowControlMode=portTxFlowControlMode, equipmentAuditGroup=equipmentAuditGroup, portRxFlowControlDetected=portRxFlowControlDetected, errEventId=errEventId, cardAction=cardAction, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardDplxStatusChange=cardDplxStatusChange, errEvRowStatus=errEvRowStatus, cardTestTransId=cardTestTransId, systemKey=systemKey, auditCommand=auditCommand, cmMacAddress=cmMacAddress, cmPrimarySID=cmPrimarySID, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardTestId=cardTestId, fpgaErrorEventEntry=fpgaErrorEventEntry, cmResetInfo=cmResetInfo, cardPrState=cardPrState, diagTestId=diagTestId, auditAutoScheduling=auditAutoScheduling, cardCarrierSerialNum=cardCarrierSerialNum, cardSubDetected=cardSubDetected, cardTestTime=cardTestTime, auditStatus=auditStatus, portNumChans=portNumChans, auditPassedCount=auditPassedCount, cardTempOverHeatNotification=cardTempOverHeatNotification, portPrState=portPrState, auditTable=auditTable, portAdminState=portAdminState, auditResult=auditResult, cardBusSpeed=cardBusSpeed, portMacIfIndex=portMacIfIndex, cardName=cardName, cardLastBootSource=cardLastBootSource, cardPicSerialNum=cardPicSerialNum, cardSecState=cardSecState, auditTotalPassedCount=auditTotalPassedCount, cardTestName=cardTestName, cardTestDescription=cardTestDescription, portDocsIfIndex=portDocsIfIndex, portMaxDsPower=portMaxDsPower, cardTempNoReportNotification=cardTempNoReportNotification, cmDevice=cmDevice, cardBootVersion=cardBootVersion, equipmentDiag=equipmentDiag, diskVolumeNumber=diskVolumeNumber, portAction=portAction, cardDetectedChange=cardDetectedChange, TestResult=TestResult, auditTotalFailedCount=auditTotalFailedCount, cardId=cardId, fpgaErrorEventTable=fpgaErrorEventTable, cardTestResultNotification=cardTestResultNotification, portEntry=portEntry, diskVolumeCardId=diskVolumeCardId, diskVolumeTrapInh=diskVolumeTrapInh, portCurrDsPower=portCurrDsPower, cmResetClearNotification=cmResetClearNotification, cmResetReason=cmResetReason, portPrStateChange=portPrStateChange, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diskVolumeEntry=diskVolumeEntry, cmResetStatus=cmResetStatus, cardSpareGroupId=cardSpareGroupId, cmUChannelID=cmUChannelID, shelfSwVersion=shelfSwVersion, portTrapInh=portTrapInh, consoleOutput=consoleOutput, portMinDsPower=portMinDsPower, TestType=TestType, cardTestResult=cardTestResult, cardShelfId=cardShelfId, equipmentCardGroup=equipmentCardGroup, PYSNMP_MODULE_ID=cadEquipmentMib, portSecStateChange=portSecStateChange, TestTransactionId=TestTransactionId, auditEntry=auditEntry, cardPrStateChange=cardPrStateChange, cadEquipmentMibGroup=cadEquipmentMibGroup)
