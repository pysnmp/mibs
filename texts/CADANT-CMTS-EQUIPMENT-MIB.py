...
PortMode, CardId, FlowControlMode, AdminState, PortDetectedMode, PrimaryState, PortId, FirmwareSource, PicType, PortType, DiskVolumeUsageLevel, SecondaryState, DuplexStatus, ShelfId, UnknownState, CardSubType, CardType, EqActionType = mibBuilder.importSymbols("CADANT-TC", "PortMode", "CardId", "FlowControlMode", "AdminState", "PortDetectedMode", "PrimaryState", "PortId", "FirmwareSource", "PicType", "PortType", "DiskVolumeUsageLevel", "SecondaryState", "DuplexStatus", "ShelfId", "UnknownState", "CardSubType", "CardType", "EqActionType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
Gauge32, ModuleIdentity, ObjectIdentity, Integer32, Counter64, TimeTicks, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, IpAddress, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Integer32", "Counter64", "TimeTicks", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "IpAddress", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardBootVersion=cardBootVersion, TestScheduleCommand=TestScheduleCommand, portRxFlowControlMode=portRxFlowControlMode, diskVolumeEntry=diskVolumeEntry, portNumChans=portNumChans, fpgaErrorEventTable=fpgaErrorEventTable, auditTime=auditTime, fpgaErrorEventEntry=fpgaErrorEventEntry, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardEntry=cardEntry, diskDriveNumber=diskDriveNumber, diskVolumeId=diskVolumeId, equipmentPortGroup=equipmentPortGroup, auditCycleCount=auditCycleCount, errEvRowStatus=errEvRowStatus, systemKey=systemKey, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, verboseLevel=verboseLevel, systemGeneral=systemGeneral, cardTemperature=cardTemperature, cardSwVersion=cardSwVersion, portMaxDsPower=portMaxDsPower, portMode=portMode, auditFailedCount=auditFailedCount, cadEquipmentMibGroup=cadEquipmentMibGroup, cardNumber=cardNumber, cmResetNotification=cmResetNotification, cardName=cardName, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTestResultDesc=cardTestResultDesc, eqDiagConfig=eqDiagConfig, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditAutoScheduling=auditAutoScheduling, equipmentTraps=equipmentTraps, cardTestName=cardTestName, cardTestTime=cardTestTime, errEventId=errEventId, auditResult=auditResult, cmResetUpTime=cmResetUpTime, cardAction=cardAction, cardBusSpeed=cardBusSpeed, cardCarrierFwVersion=cardCarrierFwVersion, systemClock=systemClock, portDescription=portDescription, cardTestTable=cardTestTable, cardTestScheduleCommand=cardTestScheduleCommand, cardId=cardId, auditTotalFailedCount=auditTotalFailedCount, systemGeneralGroup=systemGeneralGroup, equipmentAudit=equipmentAudit, equipmentAuditGroup=equipmentAuditGroup, cardUpTime=cardUpTime, cardPrStateChange=cardPrStateChange, shelfSwVersion=shelfSwVersion, cardPicSerialNum=cardPicSerialNum, portDplxStatusChange=portDplxStatusChange, trapSeverity=trapSeverity, cardTestDescription=cardTestDescription, cardSubDetected=cardSubDetected, downstreamPowerLoss=downstreamPowerLoss, cardSecState=cardSecState, auditLogThrottle=auditLogThrottle, portTxFlowControlDetected=portTxFlowControlDetected, cardLastBootSource=cardLastBootSource, diskVolumeTrapInh=diskVolumeTrapInh, equipmentState=equipmentState, equipmentDiagGroup=equipmentDiagGroup, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portTable=portTable, portCardSubType=portCardSubType, diskVolumeTable=diskVolumeTable, cardTestType=cardTestType, TestType=TestType, cardFlashSize=cardFlashSize, cmResetReason=cmResetReason, portTxFlowControlMode=portTxFlowControlMode, cardTemperatureHighWarn=cardTemperatureHighWarn, cmVendor=cmVendor, portDetectedMode=portDetectedMode, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portPrStateChange=portPrStateChange, shelfNumber=shelfNumber, cardTestIndex=cardTestIndex, TestId=TestId, cardShelfId=cardShelfId, cardFwVersion=cardFwVersion, diskVolumeDiskSize=diskVolumeDiskSize, auditName=auditName, cardLastChangeTime=cardLastChangeTime, cardSubType=cardSubType, portPrState=portPrState, cardTestTransId=cardTestTransId, equipmentDiag=equipmentDiag, cardTestSchedule=cardTestSchedule, cmResetStatus=cmResetStatus, cardTrapInh=cardTrapInh, cmRegistrationNotification=cmRegistrationNotification, cadEquipmentMibConformance=cadEquipmentMibConformance, cardShelfTestIndex=cardShelfTestIndex, equipmentShelfGroup=equipmentShelfGroup, cmDevice=cmDevice, portCurrDsPower=portCurrDsPower, cardCarrierSerialNum=cardCarrierSerialNum, diskVolumeSize=diskVolumeSize, remainInDiagMode=remainInDiagMode, errEvLoggingEnabled=errEvLoggingEnabled, portDocsIfIndex=portDocsIfIndex, auditTable=auditTable, portSecStateChange=portSecStateChange, cardSerialNum=cardSerialNum, cardFpgaSource=cardFpgaSource, auditCommand=auditCommand, cmUChannelID=cmUChannelID, portNumber=portNumber, cardCpuSpeed=cardCpuSpeed, cardLastResetReason=cardLastResetReason, portRxFlowControlDetected=portRxFlowControlDetected, cardDetected=cardDetected, auditStatus=auditStatus, equipmentCardTestGroup=equipmentCardTestGroup, equipmentStateGroup=equipmentStateGroup, portConnectorId=portConnectorId, portMacIfIndex=portMacIfIndex, TestTransactionId=TestTransactionId, cardDetectedChange=cardDetectedChange, portEntry=portEntry, diskVolumeNumber=diskVolumeNumber, cardTestCommand=cardTestCommand, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeShelfId=diskVolumeShelfId, equipmentError=equipmentError, portDplxStatus=portDplxStatus, equipmentCardGroup=equipmentCardGroup, cardAdminState=cardAdminState, cmPrimarySID=cmPrimarySID, portCardId=portCardId, cardTestResult=cardTestResult, cardType=cardType, portType=portType, cardRamSize=cardRamSize, auditLogOutput=auditLogOutput, diagTestId=diagTestId, portLastChangeTime=portLastChangeTime, cardDplxStatus=cardDplxStatus, portShelfId=portShelfId, cardFwUpdateStatus=cardFwUpdateStatus, cardNumPorts=cardNumPorts, trapCounter=trapCounter, cardTempNoReportNotification=cardTempNoReportNotification, diskVolumeName=diskVolumeName, cardPicDetected=cardPicDetected, auditDescription=auditDescription, cardPrState=cardPrState, portMinDsPower=portMinDsPower, diskVolumeFileName=diskVolumeFileName, cardTestEntry=cardTestEntry, auditId=auditId, cardDplxStatusChange=cardDplxStatusChange, diskVolumeDriveId=diskVolumeDriveId, portBgpId=portBgpId, cardSecStateChange=cardSecStateChange, TestCommand=TestCommand, cmResetClearNotification=cmResetClearNotification, diskVolumeGroup=diskVolumeGroup, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, shelfName=shelfName, cardTestResultNotification=cardTestResultNotification, cadEquipmentMib=cadEquipmentMib, consoleOutput=consoleOutput, auditTotalPassedCount=auditTotalPassedCount, TestResult=TestResult, shelfObjects=shelfObjects, portMacAddress=portMacAddress, errEvRecoveryEnabled=errEvRecoveryEnabled, cardPicHwVersion=cardPicHwVersion, diskVolumeUsageLevel=diskVolumeUsageLevel, TestSchedule=TestSchedule, portAction=portAction, cardHwVersion=cardHwVersion, portId=portId, cmResetInfo=cmResetInfo, auditCardId=auditCardId, auditShelfId=auditShelfId, cardLastBootVersion=cardLastBootVersion, portAdminState=portAdminState, diskVolumeUsagePercentage=diskVolumeUsagePercentage, equipmentTbl=equipmentTbl, PYSNMP_MODULE_ID=cadEquipmentMib, cardCPLDVersion=cardCPLDVersion, cardCarrierHwVersion=cardCarrierHwVersion, portSecState=portSecState, cardSpareGroupId=cardSpareGroupId, fpgaErrorEventGroup=fpgaErrorEventGroup, cmMacAddress=cmMacAddress, errEvLogLevel=errEvLogLevel, cardTempOverHeatNotification=cardTempOverHeatNotification, auditPassedCount=auditPassedCount, auditEntry=auditEntry, cardTemperatureHighError=cardTemperatureHighError, portTrapInh=portTrapInh, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, diskVolumeCardId=diskVolumeCardId, cmIpAddress=cmIpAddress, cardTable=cardTable, cardTestId=cardTestId, cardSpareGroupMode=cardSpareGroupMode, cardCpuType=cardCpuType)
