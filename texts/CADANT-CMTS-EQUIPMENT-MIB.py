...
ShelfId, AdminState, FirmwareSource, CardSubType, PortDetectedMode, CardId, DiskVolumeUsageLevel, DuplexStatus, CardType, EqActionType, FlowControlMode, PortId, UnknownState, PrimaryState, PortType, SecondaryState, PortMode, PicType = mibBuilder.importSymbols("CADANT-TC", "ShelfId", "AdminState", "FirmwareSource", "CardSubType", "PortDetectedMode", "CardId", "DiskVolumeUsageLevel", "DuplexStatus", "CardType", "EqActionType", "FlowControlMode", "PortId", "UnknownState", "PrimaryState", "PortType", "SecondaryState", "PortMode", "PicType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
Integer32, ModuleIdentity, ObjectIdentity, Unsigned32, iso, Counter64, Gauge32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "iso", "Counter64", "Gauge32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Bits", "MibIdentifier")
MacAddress, TextualConvention, TimeStamp, DateAndTime, TruthValue, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TextualConvention", "TimeStamp", "DateAndTime", "TruthValue", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cmRegistrationNotification=cmRegistrationNotification, TestResult=TestResult, portMinDsPower=portMinDsPower, cardCpuSpeed=cardCpuSpeed, systemGeneralGroup=systemGeneralGroup, cardDplxStatus=cardDplxStatus, portType=portType, equipmentCardGroup=equipmentCardGroup, auditTime=auditTime, cardLastChangeTime=cardLastChangeTime, portMaxDsPower=portMaxDsPower, cardSwVersion=cardSwVersion, cardEntry=cardEntry, equipmentDiag=equipmentDiag, auditCardId=auditCardId, cardCpuType=cardCpuType, cmResetUpTime=cmResetUpTime, diagTestId=diagTestId, diskVolumeSize=diskVolumeSize, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, auditLogOutput=auditLogOutput, portMode=portMode, errEvRowStatus=errEvRowStatus, errEvLogLevel=errEvLogLevel, equipmentAudit=equipmentAudit, portSecStateChange=portSecStateChange, cadEquipmentMibGroup=cadEquipmentMibGroup, cardSecState=cardSecState, cardTestScheduleCommand=cardTestScheduleCommand, auditFailedCount=auditFailedCount, cardSpareGroupId=cardSpareGroupId, cardBusSpeed=cardBusSpeed, cardUpTime=cardUpTime, portTable=portTable, cardHwVersion=cardHwVersion, equipmentCardTestGroup=equipmentCardTestGroup, portNumber=portNumber, cardNumPorts=cardNumPorts, TestTransactionId=TestTransactionId, portId=portId, cardTestIndex=cardTestIndex, cardTrapInh=cardTrapInh, portDplxStatus=portDplxStatus, diskVolumeCardId=diskVolumeCardId, diskVolumeDriveId=diskVolumeDriveId, cardSubType=cardSubType, cardTestCommand=cardTestCommand, TestId=TestId, cardSubDetected=cardSubDetected, portRxFlowControlMode=portRxFlowControlMode, diskVolumeTable=diskVolumeTable, cmIpAddress=cmIpAddress, TestScheduleCommand=TestScheduleCommand, fpgaErrorEventEntry=fpgaErrorEventEntry, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeGroup=diskVolumeGroup, cardShelfTestIndex=cardShelfTestIndex, cardTestType=cardTestType, cardDetectedChange=cardDetectedChange, cardFpgaSource=cardFpgaSource, portBgpId=portBgpId, cardLastBootSource=cardLastBootSource, portNumChans=portNumChans, portDocsIfIndex=portDocsIfIndex, fpgaErrorEventGroup=fpgaErrorEventGroup, cardSpareGroupMode=cardSpareGroupMode, cardType=cardType, portShelfId=portShelfId, portMacAddress=portMacAddress, cadEquipmentMibConformance=cadEquipmentMibConformance, cmResetNotification=cmResetNotification, cardDplxStatusChange=cardDplxStatusChange, portSecState=portSecState, cardTestDescription=cardTestDescription, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, auditTotalFailedCount=auditTotalFailedCount, cardTempOverHeatNotification=cardTempOverHeatNotification, shelfObjects=shelfObjects, portCardSubType=portCardSubType, trapSeverity=trapSeverity, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeDiskSize=diskVolumeDiskSize, cmResetClearNotification=cmResetClearNotification, shelfSwVersion=shelfSwVersion, portDplxStatusChange=portDplxStatusChange, PYSNMP_MODULE_ID=cadEquipmentMib, cmPrimarySID=cmPrimarySID, equipmentPortGroup=equipmentPortGroup, diskVolumeUsageLevel=diskVolumeUsageLevel, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portDescription=portDescription, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditName=auditName, diskDriveNumber=diskDriveNumber, verboseLevel=verboseLevel, auditCycleCount=auditCycleCount, cardTestResultDesc=cardTestResultDesc, systemGeneral=systemGeneral, equipmentShelfGroup=equipmentShelfGroup, TestType=TestType, cardPrStateChange=cardPrStateChange, equipmentError=equipmentError, portPrStateChange=portPrStateChange, equipmentTbl=equipmentTbl, auditStatus=auditStatus, cardBootVersion=cardBootVersion, cardAction=cardAction, cardAdminState=cardAdminState, auditTable=auditTable, portDetectedMode=portDetectedMode, cmUChannelID=cmUChannelID, cardCPLDVersion=cardCPLDVersion, portAdminState=portAdminState, cardTemperatureHighError=cardTemperatureHighError, cmMacAddress=cmMacAddress, auditCommand=auditCommand, downstreamPowerLoss=downstreamPowerLoss, auditEntry=auditEntry, auditId=auditId, cardLastResetReason=cardLastResetReason, diskVolumeTrapInh=diskVolumeTrapInh, auditPassedCount=auditPassedCount, systemClock=systemClock, cadEquipmentMib=cadEquipmentMib, portAction=portAction, auditAutoScheduling=auditAutoScheduling, errEvRecoveryEnabled=errEvRecoveryEnabled, diskVolumeName=diskVolumeName, cmResetInfo=cmResetInfo, trapCounter=trapCounter, cardRamSize=cardRamSize, diskVolumeShelfId=diskVolumeShelfId, cardPicHwVersion=cardPicHwVersion, portLastChangeTime=portLastChangeTime, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditLogThrottle=auditLogThrottle, cmResetReason=cmResetReason, portTrapInh=portTrapInh, TestSchedule=TestSchedule, diskVolumeId=diskVolumeId, auditTotalPassedCount=auditTotalPassedCount, cmDevice=cmDevice, cardPicDetected=cardPicDetected, portCardId=portCardId, errEventId=errEventId, auditResult=auditResult, cardCarrierHwVersion=cardCarrierHwVersion, portPrState=portPrState, cardTempNoReportNotification=cardTempNoReportNotification, cardTestId=cardTestId, cardFwUpdateStatus=cardFwUpdateStatus, portTxFlowControlMode=portTxFlowControlMode, cardTestTransId=cardTestTransId, cardTestResultNotification=cardTestResultNotification, fpgaErrorEventTable=fpgaErrorEventTable, cardDetected=cardDetected, cardPicSerialNum=cardPicSerialNum, equipmentAuditGroup=equipmentAuditGroup, cardCarrierSerialNum=cardCarrierSerialNum, cardTestEntry=cardTestEntry, consoleOutput=consoleOutput, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diskVolumeUsageNotification=diskVolumeUsageNotification, auditShelfId=auditShelfId, cardPrState=cardPrState, cmVendor=cmVendor, shelfNumber=shelfNumber, cardCarrierFwVersion=cardCarrierFwVersion, portCurrDsPower=portCurrDsPower, cardTestTime=cardTestTime, cardNumber=cardNumber, diskVolumeNumber=diskVolumeNumber, cardShelfId=cardShelfId, eqDiagConfig=eqDiagConfig, cardTestName=cardTestName, portConnectorId=portConnectorId, auditDescription=auditDescription, cardFwVersion=cardFwVersion, cadEquipmentMibCompliance=cadEquipmentMibCompliance, equipmentDiagGroup=equipmentDiagGroup, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, equipmentTraps=equipmentTraps, cardTestSchedule=cardTestSchedule, cardId=cardId, cardTestTable=cardTestTable, systemKey=systemKey, TestCommand=TestCommand, cardSerialNum=cardSerialNum, cardTemperature=cardTemperature, cardTemperatureHighWarn=cardTemperatureHighWarn, cardSecStateChange=cardSecStateChange, equipmentState=equipmentState, cardTestResult=cardTestResult, cardFlashSize=cardFlashSize, diskVolumeEntry=diskVolumeEntry, cmResetStatus=cmResetStatus, portEntry=portEntry, equipmentStateGroup=equipmentStateGroup, remainInDiagMode=remainInDiagMode, portMacIfIndex=portMacIfIndex, shelfName=shelfName, cardTable=cardTable, cardLastBootVersion=cardLastBootVersion, cardName=cardName, diskVolumeFileName=diskVolumeFileName)
