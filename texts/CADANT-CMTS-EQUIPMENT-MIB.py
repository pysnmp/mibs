...
CardId, UnknownState, SecondaryState, FlowControlMode, DiskVolumeUsageLevel, CardSubType, PicType, PortMode, PortId, AdminState, FirmwareSource, PortDetectedMode, PortType, DuplexStatus, ShelfId, PrimaryState, CardType, EqActionType = mibBuilder.importSymbols("CADANT-TC", "CardId", "UnknownState", "SecondaryState", "FlowControlMode", "DiskVolumeUsageLevel", "CardSubType", "PicType", "PortMode", "PortId", "AdminState", "FirmwareSource", "PortDetectedMode", "PortType", "DuplexStatus", "ShelfId", "PrimaryState", "CardType", "EqActionType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
Counter64, NotificationType, TimeTicks, Counter32, Bits, ObjectIdentity, MibIdentifier, Unsigned32, Integer32, ModuleIdentity, IpAddress, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "TimeTicks", "Counter32", "Bits", "ObjectIdentity", "MibIdentifier", "Unsigned32", "Integer32", "ModuleIdentity", "IpAddress", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, TimeStamp, MacAddress, TruthValue, RowStatus, DisplayString, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "MacAddress", "TruthValue", "RowStatus", "DisplayString", "DateAndTime")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardLastResetReason=cardLastResetReason, equipmentState=equipmentState, portSecState=portSecState, portShelfId=portShelfId, cardTestCommand=cardTestCommand, auditTable=auditTable, auditPassedCount=auditPassedCount, cardTemperatureHighError=cardTemperatureHighError, cardNumPorts=cardNumPorts, cmResetStatus=cmResetStatus, verboseLevel=verboseLevel, cardId=cardId, fpgaErrorEventTable=fpgaErrorEventTable, cardSwVersion=cardSwVersion, cardDplxStatusChange=cardDplxStatusChange, cardCarrierSerialNum=cardCarrierSerialNum, diskVolumeNumber=diskVolumeNumber, diskVolumeTable=diskVolumeTable, auditAutoScheduling=auditAutoScheduling, fpgaErrorEventEntry=fpgaErrorEventEntry, cardTestName=cardTestName, auditFailedCount=auditFailedCount, portDetectedMode=portDetectedMode, equipmentAuditGroup=equipmentAuditGroup, auditCycleCount=auditCycleCount, portEntry=portEntry, diskVolumeUsageLevel=diskVolumeUsageLevel, cadEquipmentMib=cadEquipmentMib, equipmentAudit=equipmentAudit, auditTime=auditTime, diskVolumeId=diskVolumeId, cardCpuSpeed=cardCpuSpeed, downstreamPowerLoss=downstreamPowerLoss, cardUpTime=cardUpTime, PYSNMP_MODULE_ID=cadEquipmentMib, equipmentTraps=equipmentTraps, cardLastChangeTime=cardLastChangeTime, TestType=TestType, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardTestIndex=cardTestIndex, cmUChannelID=cmUChannelID, cardTestSchedule=cardTestSchedule, diskVolumeShelfId=diskVolumeShelfId, cadEquipmentMibCompliances=cadEquipmentMibCompliances, errEvRowStatus=errEvRowStatus, systemGeneralGroup=systemGeneralGroup, shelfSwVersion=shelfSwVersion, cadEquipmentMibGroup=cadEquipmentMibGroup, systemClock=systemClock, cardNumber=cardNumber, cardEntry=cardEntry, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardTempOverHeatNotification=cardTempOverHeatNotification, portTrapInh=portTrapInh, cmRegistrationNotification=cmRegistrationNotification, cardSerialNum=cardSerialNum, shelfName=shelfName, portNumber=portNumber, errEvLogLevel=errEvLogLevel, auditTotalFailedCount=auditTotalFailedCount, portMacAddress=portMacAddress, portCardSubType=portCardSubType, portMode=portMode, diskVolumeGroup=diskVolumeGroup, cardFpgaSource=cardFpgaSource, fpgaErrorEventGroup=fpgaErrorEventGroup, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, consoleOutput=consoleOutput, diagTestId=diagTestId, portTxFlowControlMode=portTxFlowControlMode, cardType=cardType, diskVolumeCardId=diskVolumeCardId, portTable=portTable, diskVolumeDiskSize=diskVolumeDiskSize, cmResetInfo=cmResetInfo, equipmentError=equipmentError, shelfNumber=shelfNumber, cardTestTable=cardTestTable, cardTestId=cardTestId, cardTempNoReportNotification=cardTempNoReportNotification, cardFwUpdateStatus=cardFwUpdateStatus, equipmentDiag=equipmentDiag, cardTestType=cardTestType, diskVolumeDriveId=diskVolumeDriveId, cardTestResultDesc=cardTestResultDesc, auditName=auditName, auditCardId=auditCardId, cardSecState=cardSecState, portConnectorId=portConnectorId, portDocsIfIndex=portDocsIfIndex, cardDetectedChange=cardDetectedChange, portId=portId, cardTestResultNotification=cardTestResultNotification, cardTestEntry=cardTestEntry, equipmentDiagGroup=equipmentDiagGroup, cardShelfId=cardShelfId, portPrState=portPrState, TestScheduleCommand=TestScheduleCommand, portBgpId=portBgpId, equipmentCardGroup=equipmentCardGroup, cardTestScheduleCommand=cardTestScheduleCommand, auditResult=auditResult, auditDescription=auditDescription, cardTestResult=cardTestResult, cmResetNotification=cmResetNotification, auditId=auditId, cardCarrierFwVersion=cardCarrierFwVersion, cmResetReason=cmResetReason, equipmentStateGroup=equipmentStateGroup, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardBusSpeed=cardBusSpeed, cardPrState=cardPrState, cardCarrierHwVersion=cardCarrierHwVersion, portTxFlowControlDetected=portTxFlowControlDetected, errEvRecoveryEnabled=errEvRecoveryEnabled, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, portAction=portAction, cardBootVersion=cardBootVersion, cardFlashSize=cardFlashSize, TestTransactionId=TestTransactionId, cardRamSize=cardRamSize, errEvLoggingEnabled=errEvLoggingEnabled, cardSubDetected=cardSubDetected, portCurrDsPower=portCurrDsPower, cardTemperatureHighWarn=cardTemperatureHighWarn, cmPrimarySID=cmPrimarySID, cardName=cardName, portRxFlowControlDetected=portRxFlowControlDetected, TestId=TestId, cardTable=cardTable, diskVolumeTrapInh=diskVolumeTrapInh, auditCommand=auditCommand, diskVolumeEntry=diskVolumeEntry, cmDevice=cmDevice, cardDetected=cardDetected, cardTemperature=cardTemperature, systemKey=systemKey, trapSeverity=trapSeverity, cardCPLDVersion=cardCPLDVersion, portRxFlowControlMode=portRxFlowControlMode, cardShelfTestIndex=cardShelfTestIndex, cardPrStateChange=cardPrStateChange, portDplxStatus=portDplxStatus, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardDplxStatus=cardDplxStatus, cmVendor=cmVendor, portSecStateChange=portSecStateChange, portCardId=portCardId, portLastChangeTime=portLastChangeTime, shelfObjects=shelfObjects, cardLastBootSource=cardLastBootSource, cardPicHwVersion=cardPicHwVersion, diskVolumeName=diskVolumeName, cmIpAddress=cmIpAddress, portDplxStatusChange=portDplxStatusChange, auditShelfId=auditShelfId, equipmentShelfGroup=equipmentShelfGroup, equipmentPortGroup=equipmentPortGroup, eqDiagConfig=eqDiagConfig, remainInDiagMode=remainInDiagMode, cardTestTransId=cardTestTransId, cardPicSerialNum=cardPicSerialNum, cmResetUpTime=cmResetUpTime, portPrStateChange=portPrStateChange, diskVolumeFileName=diskVolumeFileName, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardTestTime=cardTestTime, cardHwVersion=cardHwVersion, cardAdminState=cardAdminState, TestResult=TestResult, cardPicDetected=cardPicDetected, auditTotalPassedCount=auditTotalPassedCount, cardLastBootVersion=cardLastBootVersion, cardTestDescription=cardTestDescription, cmResetClearNotification=cmResetClearNotification, auditEntry=auditEntry, auditStatus=auditStatus, portDescription=portDescription, cardTrapInh=cardTrapInh, cardSecStateChange=cardSecStateChange, portMaxDsPower=portMaxDsPower, errEventId=errEventId, cmMacAddress=cmMacAddress, TestSchedule=TestSchedule, TestCommand=TestCommand, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cadEquipmentMibConformance=cadEquipmentMibConformance, diskVolumeSize=diskVolumeSize, cardSpareGroupId=cardSpareGroupId, cardSubType=cardSubType, equipmentTbl=equipmentTbl, auditLogThrottle=auditLogThrottle, cardAction=cardAction, diskDriveNumber=diskDriveNumber, portType=portType, portAdminState=portAdminState, cardSpareGroupMode=cardSpareGroupMode, cardCpuType=cardCpuType, equipmentCardTestGroup=equipmentCardTestGroup, portMacIfIndex=portMacIfIndex, diskVolumeUsageNotification=diskVolumeUsageNotification, trapCounter=trapCounter, auditLogOutput=auditLogOutput, systemGeneral=systemGeneral, portMinDsPower=portMinDsPower, cardFwVersion=cardFwVersion, portNumChans=portNumChans)
