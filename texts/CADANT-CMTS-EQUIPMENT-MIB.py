...
SecondaryState, PrimaryState, FlowControlMode, PicType, PortMode, DiskVolumeUsageLevel, PortType, EqActionType, UnknownState, CardId, CardSubType, DuplexStatus, PortId, FirmwareSource, ShelfId, CardType, AdminState, PortDetectedMode = mibBuilder.importSymbols("CADANT-TC", "SecondaryState", "PrimaryState", "FlowControlMode", "PicType", "PortMode", "DiskVolumeUsageLevel", "PortType", "EqActionType", "UnknownState", "CardId", "CardSubType", "DuplexStatus", "PortId", "FirmwareSource", "ShelfId", "CardType", "AdminState", "PortDetectedMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Counter64, Unsigned32, NotificationType, ModuleIdentity, MibIdentifier, ObjectIdentity, iso, TimeTicks, Bits, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Counter64", "Unsigned32", "NotificationType", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "iso", "TimeTicks", "Bits", "Integer32", "Counter32")
TimeStamp, DateAndTime, MacAddress, TruthValue, TextualConvention, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DateAndTime", "MacAddress", "TruthValue", "TextualConvention", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", diskVolumeCardId=diskVolumeCardId, cardFpgaSource=cardFpgaSource, cmPrimarySID=cmPrimarySID, errEventId=errEventId, cardSerialNum=cardSerialNum, auditId=auditId, auditDescription=auditDescription, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portSecState=portSecState, portConnectorId=portConnectorId, cardId=cardId, diskVolumeGroup=diskVolumeGroup, equipmentDiag=equipmentDiag, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, equipmentAudit=equipmentAudit, cmIpAddress=cmIpAddress, cardSubType=cardSubType, consoleOutput=consoleOutput, auditTime=auditTime, cardRamSize=cardRamSize, auditCommand=auditCommand, shelfNumber=shelfNumber, cardAdminState=cardAdminState, diskVolumeSize=diskVolumeSize, cadEquipmentMibGroup=cadEquipmentMibGroup, cmResetClearNotification=cmResetClearNotification, cardLastBootSource=cardLastBootSource, cardTestTransId=cardTestTransId, remainInDiagMode=remainInDiagMode, equipmentState=equipmentState, diskVolumeName=diskVolumeName, cardSecStateChange=cardSecStateChange, diskVolumeDriveId=diskVolumeDriveId, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTestEntry=cardTestEntry, diskVolumeUsageNotification=diskVolumeUsageNotification, cardHwVersion=cardHwVersion, TestId=TestId, cardBootVersion=cardBootVersion, cardTestResult=cardTestResult, cardTestResultDesc=cardTestResultDesc, diskVolumeTable=diskVolumeTable, equipmentDiagGroup=equipmentDiagGroup, diskVolumeEntry=diskVolumeEntry, portDplxStatusChange=portDplxStatusChange, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portAdminState=portAdminState, portShelfId=portShelfId, auditResult=auditResult, cardTrapInh=cardTrapInh, cardUpTime=cardUpTime, diskVolumeShelfId=diskVolumeShelfId, cardTestCommand=cardTestCommand, TestTransactionId=TestTransactionId, TestCommand=TestCommand, portTrapInh=portTrapInh, cardTestSchedule=cardTestSchedule, equipmentTraps=equipmentTraps, cardPrState=cardPrState, fpgaErrorEventGroup=fpgaErrorEventGroup, cardTemperature=cardTemperature, portDocsIfIndex=portDocsIfIndex, portMacIfIndex=portMacIfIndex, trapCounter=trapCounter, cardTemperatureHighError=cardTemperatureHighError, portRxFlowControlMode=portRxFlowControlMode, cardNumPorts=cardNumPorts, diskDriveNumber=diskDriveNumber, systemKey=systemKey, diskVolumeUsageLevel=diskVolumeUsageLevel, portMode=portMode, portCurrDsPower=portCurrDsPower, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTestDescription=cardTestDescription, auditLogThrottle=auditLogThrottle, cmMacAddress=cmMacAddress, cmUChannelID=cmUChannelID, auditLogOutput=auditLogOutput, portMaxDsPower=portMaxDsPower, cmResetInfo=cmResetInfo, cardCarrierFwVersion=cardCarrierFwVersion, auditCycleCount=auditCycleCount, shelfSwVersion=shelfSwVersion, cardFwVersion=cardFwVersion, verboseLevel=verboseLevel, errEvRowStatus=errEvRowStatus, auditTotalPassedCount=auditTotalPassedCount, cardDplxStatusChange=cardDplxStatusChange, portAction=portAction, equipmentError=equipmentError, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardPrStateChange=cardPrStateChange, cardPicDetected=cardPicDetected, cardPicHwVersion=cardPicHwVersion, cardShelfId=cardShelfId, cardTestId=cardTestId, errEvLoggingEnabled=errEvLoggingEnabled, portTxFlowControlDetected=portTxFlowControlDetected, cardNumber=cardNumber, cardSecState=cardSecState, portSecStateChange=portSecStateChange, cardSwVersion=cardSwVersion, cardType=cardType, portDescription=portDescription, cardDplxStatus=cardDplxStatus, cardTestTime=cardTestTime, portDetectedMode=portDetectedMode, diagTestId=diagTestId, cardSpareGroupId=cardSpareGroupId, equipmentTbl=equipmentTbl, cardFwUpdateStatus=cardFwUpdateStatus, cardDetected=cardDetected, equipmentShelfGroup=equipmentShelfGroup, portNumber=portNumber, portRxFlowControlDetected=portRxFlowControlDetected, cardDetectedChange=cardDetectedChange, cmVendor=cmVendor, portLastChangeTime=portLastChangeTime, fpgaErrorEventEntry=fpgaErrorEventEntry, equipmentAuditGroup=equipmentAuditGroup, systemGeneral=systemGeneral, auditStatus=auditStatus, cardTestName=cardTestName, portId=portId, cardCpuSpeed=cardCpuSpeed, auditFailedCount=auditFailedCount, portEntry=portEntry, cardLastBootVersion=cardLastBootVersion, trapSeverity=trapSeverity, diskVolumeDiskSize=diskVolumeDiskSize, auditTotalFailedCount=auditTotalFailedCount, equipmentPortGroup=equipmentPortGroup, cardLastResetReason=cardLastResetReason, auditPassedCount=auditPassedCount, downstreamPowerLoss=downstreamPowerLoss, cardTestScheduleCommand=cardTestScheduleCommand, portPrStateChange=portPrStateChange, cardSubDetected=cardSubDetected, cardShelfTestIndex=cardShelfTestIndex, auditAutoScheduling=auditAutoScheduling, cardCpuType=cardCpuType, cmResetNotification=cmResetNotification, cardAction=cardAction, fpgaErrorEventTable=fpgaErrorEventTable, shelfObjects=shelfObjects, cardTestIndex=cardTestIndex, cardPicSerialNum=cardPicSerialNum, TestSchedule=TestSchedule, portDplxStatus=portDplxStatus, TestResult=TestResult, cardTestTable=cardTestTable, auditEntry=auditEntry, equipmentStateGroup=equipmentStateGroup, equipmentCardGroup=equipmentCardGroup, systemClock=systemClock, portMacAddress=portMacAddress, cardName=cardName, portTable=portTable, portTxFlowControlMode=portTxFlowControlMode, portCardSubType=portCardSubType, cardLastChangeTime=cardLastChangeTime, cardCPLDVersion=cardCPLDVersion, shelfName=shelfName, cardTestType=cardTestType, cadEquipmentMib=cadEquipmentMib, cardFlashSize=cardFlashSize, errEvRecoveryEnabled=errEvRecoveryEnabled, cardSpareGroupMode=cardSpareGroupMode, equipmentCardTestGroup=equipmentCardTestGroup, diskVolumeId=diskVolumeId, portCardId=portCardId, cmDevice=cmDevice, portBgpId=portBgpId, cardTable=cardTable, cardEntry=cardEntry, diskVolumeNumber=diskVolumeNumber, eqDiagConfig=eqDiagConfig, diskVolumeUsagePercentage=diskVolumeUsagePercentage, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diskVolumeFileName=diskVolumeFileName, portNumChans=portNumChans, cardTempNoReportNotification=cardTempNoReportNotification, portMinDsPower=portMinDsPower, auditCardId=auditCardId, systemGeneralGroup=systemGeneralGroup, cmResetUpTime=cmResetUpTime, cardCarrierSerialNum=cardCarrierSerialNum, TestScheduleCommand=TestScheduleCommand, cardTempOverHeatNotification=cardTempOverHeatNotification, cardBusSpeed=cardBusSpeed, PYSNMP_MODULE_ID=cadEquipmentMib, portType=portType, cadEquipmentMibConformance=cadEquipmentMibConformance, cmRegistrationNotification=cmRegistrationNotification, portPrState=portPrState, cmResetStatus=cmResetStatus, auditName=auditName, diskVolumeTrapInh=diskVolumeTrapInh, auditShelfId=auditShelfId, TestType=TestType, cardCarrierHwVersion=cardCarrierHwVersion, cardTemperatureHighWarn=cardTemperatureHighWarn, auditTable=auditTable, errEvLogLevel=errEvLogLevel, cardTestResultNotification=cardTestResultNotification, cmResetReason=cmResetReason)
