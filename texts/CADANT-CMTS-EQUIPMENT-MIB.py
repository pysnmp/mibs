...
PortType, SecondaryState, CardSubType, PortMode, CardId, FirmwareSource, FlowControlMode, AdminState, DiskVolumeUsageLevel, PicType, PortDetectedMode, PortId, UnknownState, ShelfId, PrimaryState, CardType, DuplexStatus, EqActionType = mibBuilder.importSymbols("CADANT-TC", "PortType", "SecondaryState", "CardSubType", "PortMode", "CardId", "FirmwareSource", "FlowControlMode", "AdminState", "DiskVolumeUsageLevel", "PicType", "PortDetectedMode", "PortId", "UnknownState", "ShelfId", "PrimaryState", "CardType", "DuplexStatus", "EqActionType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
iso, IpAddress, Unsigned32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, TimeTicks, Counter32, NotificationType, Counter64, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Unsigned32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Counter32", "NotificationType", "Counter64", "Integer32", "Gauge32")
TextualConvention, MacAddress, DateAndTime, RowStatus, DisplayString, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "MacAddress", "DateAndTime", "RowStatus", "DisplayString", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardTemperature=cardTemperature, cardTestId=cardTestId, diskVolumeUsageLevel=diskVolumeUsageLevel, TestType=TestType, diskVolumeTrapInh=diskVolumeTrapInh, portAction=portAction, cardTempOverHeatNotification=cardTempOverHeatNotification, cardFwUpdateStatus=cardFwUpdateStatus, errEvRecoveryEnabled=errEvRecoveryEnabled, systemClock=systemClock, cmVendor=cmVendor, cardId=cardId, shelfObjects=shelfObjects, portId=portId, cardDplxStatusChange=cardDplxStatusChange, TestCommand=TestCommand, equipmentCardGroup=equipmentCardGroup, portMacIfIndex=portMacIfIndex, verboseLevel=verboseLevel, errEvLoggingEnabled=errEvLoggingEnabled, auditPassedCount=auditPassedCount, equipmentAudit=equipmentAudit, cardDetected=cardDetected, cardSpareGroupMode=cardSpareGroupMode, cardRamSize=cardRamSize, portTable=portTable, cardTestTransId=cardTestTransId, remainInDiagMode=remainInDiagMode, errEventId=errEventId, errEvLogLevel=errEvLogLevel, cardEntry=cardEntry, cardSwVersion=cardSwVersion, cardFlashSize=cardFlashSize, portMacAddress=portMacAddress, equipmentPortGroup=equipmentPortGroup, portBgpId=portBgpId, auditTable=auditTable, diskVolumeUsageNotification=diskVolumeUsageNotification, cardCpuType=cardCpuType, portNumChans=portNumChans, cardPicSerialNum=cardPicSerialNum, cardLastBootSource=cardLastBootSource, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cmResetReason=cmResetReason, cardSecState=cardSecState, cardShelfTestIndex=cardShelfTestIndex, systemGeneral=systemGeneral, diskVolumeSize=diskVolumeSize, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardTestName=cardTestName, downstreamPowerLoss=downstreamPowerLoss, auditTotalFailedCount=auditTotalFailedCount, portTxFlowControlDetected=portTxFlowControlDetected, portPrState=portPrState, cmUChannelID=cmUChannelID, cardName=cardName, cmDevice=cmDevice, diskVolumeUsagePercentage=diskVolumeUsagePercentage, diagTestId=diagTestId, cmMacAddress=cmMacAddress, cardSecStateChange=cardSecStateChange, portCurrDsPower=portCurrDsPower, cardTestTable=cardTestTable, cardTemperatureHighWarn=cardTemperatureHighWarn, auditTotalPassedCount=auditTotalPassedCount, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diskVolumeNumber=diskVolumeNumber, cardTestSchedule=cardTestSchedule, auditName=auditName, PYSNMP_MODULE_ID=cadEquipmentMib, cardTestDescription=cardTestDescription, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portConnectorId=portConnectorId, cardPicHwVersion=cardPicHwVersion, fpgaErrorEventGroup=fpgaErrorEventGroup, cardPrState=cardPrState, equipmentError=equipmentError, cardTestResult=cardTestResult, equipmentDiag=equipmentDiag, diskVolumeTable=diskVolumeTable, cmPrimarySID=cmPrimarySID, TestResult=TestResult, portAdminState=portAdminState, cardTrapInh=cardTrapInh, portEntry=portEntry, equipmentState=equipmentState, portTxFlowControlMode=portTxFlowControlMode, auditDescription=auditDescription, diskVolumeName=diskVolumeName, cardTestEntry=cardTestEntry, cardTemperatureHighError=cardTemperatureHighError, cardTestResultDesc=cardTestResultDesc, cardLastBootVersion=cardLastBootVersion, auditResult=auditResult, shelfName=shelfName, errEvRowStatus=errEvRowStatus, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeId=diskVolumeId, cardHwVersion=cardHwVersion, shelfNumber=shelfNumber, portSecStateChange=portSecStateChange, diskVolumeEntry=diskVolumeEntry, cardPicDetected=cardPicDetected, cardShelfId=cardShelfId, portDplxStatus=portDplxStatus, portMode=portMode, diskVolumeGroup=diskVolumeGroup, shelfSwVersion=shelfSwVersion, portDocsIfIndex=portDocsIfIndex, auditCycleCount=auditCycleCount, TestSchedule=TestSchedule, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cmIpAddress=cmIpAddress, portCardSubType=portCardSubType, TestId=TestId, diskVolumeShelfId=diskVolumeShelfId, cardTestScheduleCommand=cardTestScheduleCommand, cardNumber=cardNumber, cardLastResetReason=cardLastResetReason, cardCarrierSerialNum=cardCarrierSerialNum, auditCommand=auditCommand, cardDetectedChange=cardDetectedChange, portPrStateChange=portPrStateChange, equipmentDiagGroup=equipmentDiagGroup, equipmentAuditGroup=equipmentAuditGroup, cardSpareGroupId=cardSpareGroupId, portRxFlowControlDetected=portRxFlowControlDetected, equipmentTbl=equipmentTbl, diskVolumeCardId=diskVolumeCardId, cardTestTime=cardTestTime, cardTable=cardTable, cmResetInfo=cmResetInfo, cardDplxStatus=cardDplxStatus, auditLogOutput=auditLogOutput, equipmentCardTestGroup=equipmentCardTestGroup, auditId=auditId, auditLogThrottle=auditLogThrottle, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardCpuSpeed=cardCpuSpeed, cardSubType=cardSubType, trapSeverity=trapSeverity, portShelfId=portShelfId, cardSerialNum=cardSerialNum, cardFwVersion=cardFwVersion, cardUpTime=cardUpTime, diskVolumeDriveId=diskVolumeDriveId, cadEquipmentMibCompliance=cadEquipmentMibCompliance, TestScheduleCommand=TestScheduleCommand, auditCardId=auditCardId, systemGeneralGroup=systemGeneralGroup, cmRegistrationNotification=cmRegistrationNotification, cardTestIndex=cardTestIndex, trapCounter=trapCounter, cardLastChangeTime=cardLastChangeTime, cardSubDetected=cardSubDetected, portType=portType, cardCarrierFwVersion=cardCarrierFwVersion, portDescription=portDescription, cardFpgaSource=cardFpgaSource, cadEquipmentMibGroup=cadEquipmentMibGroup, portMinDsPower=portMinDsPower, cardPrStateChange=cardPrStateChange, auditEntry=auditEntry, cardTestType=cardTestType, cardType=cardType, diskVolumeFileName=diskVolumeFileName, eqDiagConfig=eqDiagConfig, auditStatus=auditStatus, portCardId=portCardId, systemKey=systemKey, equipmentShelfGroup=equipmentShelfGroup, auditTime=auditTime, equipmentTraps=equipmentTraps, cardAction=cardAction, cardAdminState=cardAdminState, portRxFlowControlMode=portRxFlowControlMode, portMaxDsPower=portMaxDsPower, fpgaErrorEventEntry=fpgaErrorEventEntry, cardNumPorts=cardNumPorts, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portDplxStatusChange=portDplxStatusChange, cardTestCommand=cardTestCommand, cmResetNotification=cmResetNotification, portTrapInh=portTrapInh, cmResetUpTime=cmResetUpTime, auditShelfId=auditShelfId, auditFailedCount=auditFailedCount, cmResetClearNotification=cmResetClearNotification, cadEquipmentMibConformance=cadEquipmentMibConformance, cardBusSpeed=cardBusSpeed, cardTempNoReportNotification=cardTempNoReportNotification, equipmentStateGroup=equipmentStateGroup, portNumber=portNumber, auditAutoScheduling=auditAutoScheduling, TestTransactionId=TestTransactionId, consoleOutput=consoleOutput, cardCPLDVersion=cardCPLDVersion, cmResetStatus=cmResetStatus, portDetectedMode=portDetectedMode, portSecState=portSecState, cardBootVersion=cardBootVersion, diskVolumeDiskSize=diskVolumeDiskSize, diskDriveNumber=diskDriveNumber, cardTestResultNotification=cardTestResultNotification, cadEquipmentMib=cadEquipmentMib, portLastChangeTime=portLastChangeTime, fpgaErrorEventTable=fpgaErrorEventTable)
