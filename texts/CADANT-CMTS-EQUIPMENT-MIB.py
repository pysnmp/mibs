...
PortId, PortDetectedMode, DiskVolumeUsageLevel, PortMode, ShelfId, AdminState, DuplexStatus, EqActionType, FlowControlMode, PrimaryState, UnknownState, CardType, CardSubType, FirmwareSource, SecondaryState, PicType, CardId, PortType = mibBuilder.importSymbols("CADANT-TC", "PortId", "PortDetectedMode", "DiskVolumeUsageLevel", "PortMode", "ShelfId", "AdminState", "DuplexStatus", "EqActionType", "FlowControlMode", "PrimaryState", "UnknownState", "CardType", "CardSubType", "FirmwareSource", "SecondaryState", "PicType", "CardId", "PortType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, Integer32, Counter32, TimeTicks, Bits, Gauge32, ModuleIdentity, Counter64, IpAddress, MibIdentifier, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "Integer32", "Counter32", "TimeTicks", "Bits", "Gauge32", "ModuleIdentity", "Counter64", "IpAddress", "MibIdentifier", "NotificationType", "ObjectIdentity")
DateAndTime, DisplayString, TruthValue, TimeStamp, RowStatus, MacAddress, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "TruthValue", "TimeStamp", "RowStatus", "MacAddress", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardSecStateChange=cardSecStateChange, portDplxStatusChange=portDplxStatusChange, cardUpTime=cardUpTime, portCardId=portCardId, portAdminState=portAdminState, portNumber=portNumber, systemGeneral=systemGeneral, errEvRowStatus=errEvRowStatus, cardCpuSpeed=cardCpuSpeed, portMinDsPower=portMinDsPower, cardTestEntry=cardTestEntry, diskVolumeTrapInh=diskVolumeTrapInh, cardSwVersion=cardSwVersion, equipmentError=equipmentError, TestTransactionId=TestTransactionId, cardTestId=cardTestId, equipmentCardTestGroup=equipmentCardTestGroup, cmResetStatus=cmResetStatus, cardPrState=cardPrState, shelfSwVersion=shelfSwVersion, TestId=TestId, diskVolumeGroup=diskVolumeGroup, fpgaErrorEventEntry=fpgaErrorEventEntry, systemClock=systemClock, portPrStateChange=portPrStateChange, portLastChangeTime=portLastChangeTime, cardEntry=cardEntry, cardTempNoReportNotification=cardTempNoReportNotification, cardTestIndex=cardTestIndex, portId=portId, cardAdminState=cardAdminState, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardFlashSize=cardFlashSize, auditShelfId=auditShelfId, cardDetectedChange=cardDetectedChange, diskVolumeUsageNotification=diskVolumeUsageNotification, cardDetected=cardDetected, diskVolumeTable=diskVolumeTable, cardTrapInh=cardTrapInh, auditResult=auditResult, cardPicDetected=cardPicDetected, portTable=portTable, portRxFlowControlMode=portRxFlowControlMode, portMaxDsPower=portMaxDsPower, cardLastBootSource=cardLastBootSource, cardFwVersion=cardFwVersion, portTrapInh=portTrapInh, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardTestType=cardTestType, cadEquipmentMib=cadEquipmentMib, cardNumPorts=cardNumPorts, equipmentStateGroup=equipmentStateGroup, cardPicSerialNum=cardPicSerialNum, diskVolumeDiskSize=diskVolumeDiskSize, cmDevice=cmDevice, cadEquipmentMibConformance=cadEquipmentMibConformance, fpgaErrorEventGroup=fpgaErrorEventGroup, diskVolumeId=diskVolumeId, equipmentCardGroup=equipmentCardGroup, cardSpareGroupMode=cardSpareGroupMode, cmRegistrationNotification=cmRegistrationNotification, TestResult=TestResult, trapSeverity=trapSeverity, cardCpuType=cardCpuType, cardDplxStatus=cardDplxStatus, portCardSubType=portCardSubType, cardShelfId=cardShelfId, portTxFlowControlDetected=portTxFlowControlDetected, portMode=portMode, auditLogOutput=auditLogOutput, TestCommand=TestCommand, TestSchedule=TestSchedule, auditLogThrottle=auditLogThrottle, cardLastBootVersion=cardLastBootVersion, auditTime=auditTime, errEvRecoveryEnabled=errEvRecoveryEnabled, portDplxStatus=portDplxStatus, diskDriveNumber=diskDriveNumber, cardAction=cardAction, trapCounter=trapCounter, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cmResetUpTime=cmResetUpTime, diagTestId=diagTestId, auditTotalFailedCount=auditTotalFailedCount, equipmentAuditGroup=equipmentAuditGroup, cardCarrierSerialNum=cardCarrierSerialNum, cardTestName=cardTestName, auditId=auditId, cardTempOverHeatNotification=cardTempOverHeatNotification, cardPrStateChange=cardPrStateChange, cardTable=cardTable, cardPicHwVersion=cardPicHwVersion, auditTotalPassedCount=auditTotalPassedCount, equipmentPortGroup=equipmentPortGroup, portMacAddress=portMacAddress, auditFailedCount=auditFailedCount, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portType=portType, portNumChans=portNumChans, TestScheduleCommand=TestScheduleCommand, cardName=cardName, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardTestResultDesc=cardTestResultDesc, cardCarrierFwVersion=cardCarrierFwVersion, auditCardId=auditCardId, diskVolumeSize=diskVolumeSize, systemKey=systemKey, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portTxFlowControlMode=portTxFlowControlMode, consoleOutput=consoleOutput, cardTestTransId=cardTestTransId, auditEntry=auditEntry, cmVendor=cmVendor, cardTemperatureHighWarn=cardTemperatureHighWarn, portEntry=portEntry, portDocsIfIndex=portDocsIfIndex, cardTestCommand=cardTestCommand, cardTestSchedule=cardTestSchedule, auditTable=auditTable, auditDescription=auditDescription, fpgaErrorEventTable=fpgaErrorEventTable, diskVolumeDriveId=diskVolumeDriveId, cmResetReason=cmResetReason, cardTestResultNotification=cardTestResultNotification, auditCycleCount=auditCycleCount, cardLastResetReason=cardLastResetReason, cmPrimarySID=cmPrimarySID, cardHwVersion=cardHwVersion, cardTestDescription=cardTestDescription, portRxFlowControlDetected=portRxFlowControlDetected, auditCommand=auditCommand, portDetectedMode=portDetectedMode, cmUChannelID=cmUChannelID, errEvLogLevel=errEvLogLevel, cardId=cardId, portBgpId=portBgpId, cardFpgaSource=cardFpgaSource, downstreamPowerLoss=downstreamPowerLoss, cardBusSpeed=cardBusSpeed, diskVolumeFileName=diskVolumeFileName, verboseLevel=verboseLevel, auditPassedCount=auditPassedCount, shelfNumber=shelfNumber, portSecState=portSecState, cardTemperature=cardTemperature, cardFwUpdateStatus=cardFwUpdateStatus, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditStatus=auditStatus, portPrState=portPrState, equipmentState=equipmentState, systemGeneralGroup=systemGeneralGroup, diskVolumeCardId=diskVolumeCardId, diskVolumeName=diskVolumeName, cardDplxStatusChange=cardDplxStatusChange, cmResetNotification=cmResetNotification, diskVolumeEntry=diskVolumeEntry, cardTestTime=cardTestTime, diskVolumeUsageLevel=diskVolumeUsageLevel, cmIpAddress=cmIpAddress, equipmentDiag=equipmentDiag, shelfName=shelfName, PYSNMP_MODULE_ID=cadEquipmentMib, cardBootVersion=cardBootVersion, TestType=TestType, portMacIfIndex=portMacIfIndex, cardTestScheduleCommand=cardTestScheduleCommand, cmResetClearNotification=cmResetClearNotification, cardCarrierHwVersion=cardCarrierHwVersion, eqDiagConfig=eqDiagConfig, cardSubDetected=cardSubDetected, portDescription=portDescription, diskVolumeShelfId=diskVolumeShelfId, cardTestTable=cardTestTable, cardSecState=cardSecState, portAction=portAction, cardShelfTestIndex=cardShelfTestIndex, equipmentAudit=equipmentAudit, errEventId=errEventId, errEvLoggingEnabled=errEvLoggingEnabled, equipmentDiagGroup=equipmentDiagGroup, cardSubType=cardSubType, cmMacAddress=cmMacAddress, cmResetInfo=cmResetInfo, cardNumber=cardNumber, cardSpareGroupId=cardSpareGroupId, equipmentTraps=equipmentTraps, equipmentTbl=equipmentTbl, portShelfId=portShelfId, cardLastChangeTime=cardLastChangeTime, cardType=cardType, cardTemperatureHighError=cardTemperatureHighError, diskVolumeNumber=diskVolumeNumber, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, equipmentShelfGroup=equipmentShelfGroup, portConnectorId=portConnectorId, shelfObjects=shelfObjects, auditName=auditName, auditAutoScheduling=auditAutoScheduling, remainInDiagMode=remainInDiagMode, cardRamSize=cardRamSize, cadEquipmentMibGroup=cadEquipmentMibGroup, cardTestResult=cardTestResult, cardCPLDVersion=cardCPLDVersion, portCurrDsPower=portCurrDsPower, portSecStateChange=portSecStateChange, cardSerialNum=cardSerialNum)
