...
PicType, AdminState, SecondaryState, PortMode, UnknownState, DiskVolumeUsageLevel, EqActionType, FirmwareSource, PortType, PrimaryState, CardSubType, CardId, PortDetectedMode, PortId, DuplexStatus, ShelfId, CardType, FlowControlMode = mibBuilder.importSymbols("CADANT-TC", "PicType", "AdminState", "SecondaryState", "PortMode", "UnknownState", "DiskVolumeUsageLevel", "EqActionType", "FirmwareSource", "PortType", "PrimaryState", "CardSubType", "CardId", "PortDetectedMode", "PortId", "DuplexStatus", "ShelfId", "CardType", "FlowControlMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
TimeTicks, Integer32, MibIdentifier, Bits, Counter32, IpAddress, iso, Gauge32, NotificationType, Unsigned32, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "MibIdentifier", "Bits", "Counter32", "IpAddress", "iso", "Gauge32", "NotificationType", "Unsigned32", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
RowStatus, TextualConvention, TruthValue, DateAndTime, MacAddress, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TruthValue", "DateAndTime", "MacAddress", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardLastBootVersion=cardLastBootVersion, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardDplxStatusChange=cardDplxStatusChange, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cmMacAddress=cmMacAddress, systemGeneralGroup=systemGeneralGroup, cardTable=cardTable, cardBootVersion=cardBootVersion, diskVolumeSize=diskVolumeSize, equipmentDiagGroup=equipmentDiagGroup, shelfObjects=shelfObjects, auditLogThrottle=auditLogThrottle, consoleOutput=consoleOutput, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditCardId=auditCardId, cardDetectedChange=cardDetectedChange, equipmentStateGroup=equipmentStateGroup, cardTemperatureHighError=cardTemperatureHighError, cmResetUpTime=cmResetUpTime, trapSeverity=trapSeverity, portType=portType, cardId=cardId, portTxFlowControlDetected=portTxFlowControlDetected, equipmentTbl=equipmentTbl, cmIpAddress=cmIpAddress, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portPrState=portPrState, auditEntry=auditEntry, portNumChans=portNumChans, shelfName=shelfName, cardAdminState=cardAdminState, errEvLogLevel=errEvLogLevel, downstreamPowerLoss=downstreamPowerLoss, remainInDiagMode=remainInDiagMode, cardLastBootSource=cardLastBootSource, cardSpareGroupMode=cardSpareGroupMode, equipmentDiag=equipmentDiag, TestId=TestId, cardLastResetReason=cardLastResetReason, cardFpgaSource=cardFpgaSource, equipmentShelfGroup=equipmentShelfGroup, cardAction=cardAction, cmResetInfo=cmResetInfo, cardTestSchedule=cardTestSchedule, cardSpareGroupId=cardSpareGroupId, cardTrapInh=cardTrapInh, errEvRecoveryEnabled=errEvRecoveryEnabled, shelfSwVersion=shelfSwVersion, equipmentCardTestGroup=equipmentCardTestGroup, equipmentCardGroup=equipmentCardGroup, portLastChangeTime=portLastChangeTime, cardCpuType=cardCpuType, auditShelfId=auditShelfId, portMacIfIndex=portMacIfIndex, cardSecStateChange=cardSecStateChange, auditDescription=auditDescription, cardFwUpdateStatus=cardFwUpdateStatus, fpgaErrorEventGroup=fpgaErrorEventGroup, TestSchedule=TestSchedule, cmRegistrationNotification=cmRegistrationNotification, auditPassedCount=auditPassedCount, equipmentTraps=equipmentTraps, cmResetReason=cmResetReason, PYSNMP_MODULE_ID=cadEquipmentMib, portMacAddress=portMacAddress, shelfNumber=shelfNumber, cardFwVersion=cardFwVersion, cardPrState=cardPrState, cmDevice=cmDevice, diskVolumeTrapInh=diskVolumeTrapInh, cardPicHwVersion=cardPicHwVersion, cardCpuSpeed=cardCpuSpeed, cardTestTransId=cardTestTransId, auditTable=auditTable, portNumber=portNumber, diskVolumeShelfId=diskVolumeShelfId, portDescription=portDescription, cardDetected=cardDetected, auditCommand=auditCommand, auditAutoScheduling=auditAutoScheduling, portPrStateChange=portPrStateChange, TestResult=TestResult, cardName=cardName, cardShelfId=cardShelfId, cardPicSerialNum=cardPicSerialNum, cardTempNoReportNotification=cardTempNoReportNotification, cardTempOverHeatNotification=cardTempOverHeatNotification, cmResetClearNotification=cmResetClearNotification, diskDriveNumber=diskDriveNumber, diskVolumeName=diskVolumeName, cardNumPorts=cardNumPorts, cmPrimarySID=cmPrimarySID, eqDiagConfig=eqDiagConfig, portRxFlowControlMode=portRxFlowControlMode, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cadEquipmentMibGroup=cadEquipmentMibGroup, cardSubDetected=cardSubDetected, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portId=portId, equipmentState=equipmentState, cardTestName=cardTestName, auditTotalPassedCount=auditTotalPassedCount, portTxFlowControlMode=portTxFlowControlMode, portConnectorId=portConnectorId, trapCounter=trapCounter, auditResult=auditResult, equipmentAuditGroup=equipmentAuditGroup, cardTestCommand=cardTestCommand, cardRamSize=cardRamSize, cardDplxStatus=cardDplxStatus, fpgaErrorEventTable=fpgaErrorEventTable, portEntry=portEntry, diskVolumeDriveId=diskVolumeDriveId, cardSerialNum=cardSerialNum, cardCarrierFwVersion=cardCarrierFwVersion, verboseLevel=verboseLevel, auditFailedCount=auditFailedCount, diskVolumeFileName=diskVolumeFileName, cardShelfTestIndex=cardShelfTestIndex, portSecStateChange=portSecStateChange, cardTestResultNotification=cardTestResultNotification, cardPicDetected=cardPicDetected, portCardSubType=portCardSubType, TestCommand=TestCommand, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeCardId=diskVolumeCardId, auditId=auditId, errEvLoggingEnabled=errEvLoggingEnabled, errEventId=errEventId, cardPrStateChange=cardPrStateChange, cardSubType=cardSubType, systemGeneral=systemGeneral, cardType=cardType, cardTestResultDesc=cardTestResultDesc, auditName=auditName, diskVolumeNumber=diskVolumeNumber, cardLastChangeTime=cardLastChangeTime, cardSwVersion=cardSwVersion, cardCarrierSerialNum=cardCarrierSerialNum, cardTestId=cardTestId, diskVolumeId=diskVolumeId, cardTemperature=cardTemperature, cardTestEntry=cardTestEntry, diskVolumeUsageNotification=diskVolumeUsageNotification, cmUChannelID=cmUChannelID, fpgaErrorEventEntry=fpgaErrorEventEntry, portDplxStatus=portDplxStatus, portDplxStatusChange=portDplxStatusChange, auditStatus=auditStatus, portAction=portAction, diskVolumeEntry=diskVolumeEntry, cardTestDescription=cardTestDescription, portTrapInh=portTrapInh, cardCarrierHwVersion=cardCarrierHwVersion, cardCPLDVersion=cardCPLDVersion, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portMode=portMode, auditTime=auditTime, cadEquipmentMibConformance=cadEquipmentMibConformance, portDetectedMode=portDetectedMode, equipmentAudit=equipmentAudit, cardHwVersion=cardHwVersion, cardSecState=cardSecState, diskVolumeTable=diskVolumeTable, cardTestTime=cardTestTime, cardTestType=cardTestType, diagTestId=diagTestId, diskVolumeDiskSize=diskVolumeDiskSize, cardTestResult=cardTestResult, cadEquipmentMib=cadEquipmentMib, cardUpTime=cardUpTime, portTable=portTable, cmVendor=cmVendor, cardTemperatureHighWarn=cardTemperatureHighWarn, auditLogOutput=auditLogOutput, auditCycleCount=auditCycleCount, portShelfId=portShelfId, cardTestIndex=cardTestIndex, diskVolumeGroup=diskVolumeGroup, portMaxDsPower=portMaxDsPower, cardEntry=cardEntry, TestType=TestType, TestTransactionId=TestTransactionId, TestScheduleCommand=TestScheduleCommand, cardTestScheduleCommand=cardTestScheduleCommand, equipmentError=equipmentError, auditTotalFailedCount=auditTotalFailedCount, systemKey=systemKey, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, equipmentPortGroup=equipmentPortGroup, portBgpId=portBgpId, cmResetStatus=cmResetStatus, portAdminState=portAdminState, portMinDsPower=portMinDsPower, cmResetNotification=cmResetNotification, systemClock=systemClock, portDocsIfIndex=portDocsIfIndex, cardTestTable=cardTestTable, portCardId=portCardId, portRxFlowControlDetected=portRxFlowControlDetected, cardBusSpeed=cardBusSpeed, cardFlashSize=cardFlashSize, errEvRowStatus=errEvRowStatus, portCurrDsPower=portCurrDsPower, cardNumber=cardNumber, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portSecState=portSecState)
