...
DiskVolumeUsageLevel, PortMode, PrimaryState, PortType, CardSubType, EqActionType, FlowControlMode, PortId, PortDetectedMode, FirmwareSource, ShelfId, UnknownState, SecondaryState, DuplexStatus, AdminState, CardId, CardType, PicType = mibBuilder.importSymbols("CADANT-TC", "DiskVolumeUsageLevel", "PortMode", "PrimaryState", "PortType", "CardSubType", "EqActionType", "FlowControlMode", "PortId", "PortDetectedMode", "FirmwareSource", "ShelfId", "UnknownState", "SecondaryState", "DuplexStatus", "AdminState", "CardId", "CardType", "PicType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
Counter64, Unsigned32, Gauge32, ObjectIdentity, Counter32, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, iso, ModuleIdentity, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "Gauge32", "ObjectIdentity", "Counter32", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "iso", "ModuleIdentity", "Integer32", "IpAddress")
TextualConvention, MacAddress, DateAndTime, TimeStamp, TruthValue, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "MacAddress", "DateAndTime", "TimeStamp", "TruthValue", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardPicSerialNum=cardPicSerialNum, portEntry=portEntry, trapSeverity=trapSeverity, portMode=portMode, cardBusSpeed=cardBusSpeed, cardTestIndex=cardTestIndex, cardSecStateChange=cardSecStateChange, TestCommand=TestCommand, portCardId=portCardId, cardTempNoReportNotification=cardTempNoReportNotification, cadEquipmentMib=cadEquipmentMib, cardDetected=cardDetected, cardPicDetected=cardPicDetected, portCurrDsPower=portCurrDsPower, fpgaErrorEventEntry=fpgaErrorEventEntry, portSecState=portSecState, cardBootVersion=cardBootVersion, cardCarrierHwVersion=cardCarrierHwVersion, auditPassedCount=auditPassedCount, portConnectorId=portConnectorId, portLastChangeTime=portLastChangeTime, portTable=portTable, portId=portId, cardTemperature=cardTemperature, auditFailedCount=auditFailedCount, equipmentError=equipmentError, errEventId=errEventId, cardNumber=cardNumber, equipmentPortGroup=equipmentPortGroup, diagTestId=diagTestId, cardTempOverHeatNotification=cardTempOverHeatNotification, cardPrState=cardPrState, diskVolumeShelfId=diskVolumeShelfId, cadEquipmentMibConformance=cadEquipmentMibConformance, auditLogThrottle=auditLogThrottle, trapCounter=trapCounter, cardTestCommand=cardTestCommand, portNumChans=portNumChans, diskDriveNumber=diskDriveNumber, equipmentDiagGroup=equipmentDiagGroup, cardFwVersion=cardFwVersion, cardTemperatureHighWarn=cardTemperatureHighWarn, cardUpTime=cardUpTime, portMaxDsPower=portMaxDsPower, auditCycleCount=auditCycleCount, portRxFlowControlMode=portRxFlowControlMode, cmResetInfo=cmResetInfo, errEvLogLevel=errEvLogLevel, shelfSwVersion=shelfSwVersion, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeDiskSize=diskVolumeDiskSize, shelfObjects=shelfObjects, shelfNumber=shelfNumber, cardTestId=cardTestId, cardTrapInh=cardTrapInh, cardFwUpdateStatus=cardFwUpdateStatus, cardEntry=cardEntry, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeEntry=diskVolumeEntry, systemKey=systemKey, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, TestSchedule=TestSchedule, auditId=auditId, cmIpAddress=cmIpAddress, auditTable=auditTable, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeId=diskVolumeId, cardRamSize=cardRamSize, cardTestResult=cardTestResult, equipmentDiag=equipmentDiag, cardSpareGroupId=cardSpareGroupId, auditLogOutput=auditLogOutput, equipmentCardTestGroup=equipmentCardTestGroup, cardAction=cardAction, eqDiagConfig=eqDiagConfig, portRxFlowControlDetected=portRxFlowControlDetected, portSecStateChange=portSecStateChange, auditResult=auditResult, cardTestTable=cardTestTable, diskVolumeDriveId=diskVolumeDriveId, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardDplxStatus=cardDplxStatus, cardDetectedChange=cardDetectedChange, cardTestDescription=cardTestDescription, cmUChannelID=cmUChannelID, cmMacAddress=cmMacAddress, cardCPLDVersion=cardCPLDVersion, portDocsIfIndex=portDocsIfIndex, cardSubType=cardSubType, verboseLevel=verboseLevel, cardTestTime=cardTestTime, cardTestTransId=cardTestTransId, portShelfId=portShelfId, cardCarrierFwVersion=cardCarrierFwVersion, cmResetClearNotification=cmResetClearNotification, cardTestSchedule=cardTestSchedule, cardTestName=cardTestName, diskVolumeUsageNotification=diskVolumeUsageNotification, portPrStateChange=portPrStateChange, cardTestResultNotification=cardTestResultNotification, diskVolumeFileName=diskVolumeFileName, auditDescription=auditDescription, cardTestScheduleCommand=cardTestScheduleCommand, equipmentTbl=equipmentTbl, cardSecState=cardSecState, shelfName=shelfName, cardType=cardType, TestTransactionId=TestTransactionId, cardAdminState=cardAdminState, cardPicHwVersion=cardPicHwVersion, cardShelfTestIndex=cardShelfTestIndex, cardTestType=cardTestType, cmResetNotification=cmResetNotification, cmPrimarySID=cmPrimarySID, portMinDsPower=portMinDsPower, cmResetUpTime=cmResetUpTime, auditStatus=auditStatus, equipmentStateGroup=equipmentStateGroup, diskVolumeCardId=diskVolumeCardId, portMacAddress=portMacAddress, cmDevice=cmDevice, diskVolumeUsagePercentage=diskVolumeUsagePercentage, systemClock=systemClock, fpgaErrorEventGroup=fpgaErrorEventGroup, cardSubDetected=cardSubDetected, portTxFlowControlMode=portTxFlowControlMode, cardFlashSize=cardFlashSize, TestId=TestId, cmRegistrationNotification=cmRegistrationNotification, cardTable=cardTable, portNumber=portNumber, portTrapInh=portTrapInh, auditTotalPassedCount=auditTotalPassedCount, cardPrStateChange=cardPrStateChange, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cmVendor=cmVendor, diskVolumeTable=diskVolumeTable, auditCardId=auditCardId, diskVolumeSize=diskVolumeSize, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, remainInDiagMode=remainInDiagMode, equipmentTraps=equipmentTraps, portDetectedMode=portDetectedMode, downstreamPowerLoss=downstreamPowerLoss, portCardSubType=portCardSubType, portBgpId=portBgpId, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditTime=auditTime, cardCarrierSerialNum=cardCarrierSerialNum, portDplxStatusChange=portDplxStatusChange, cardNumPorts=cardNumPorts, diskVolumeNumber=diskVolumeNumber, systemGeneral=systemGeneral, TestResult=TestResult, cardId=cardId, cadEquipmentMibGroup=cadEquipmentMibGroup, portDescription=portDescription, cardLastResetReason=cardLastResetReason, cardSwVersion=cardSwVersion, auditEntry=auditEntry, fpgaErrorEventTable=fpgaErrorEventTable, cardShelfId=cardShelfId, cadEquipmentMibCompliances=cadEquipmentMibCompliances, auditTotalFailedCount=auditTotalFailedCount, auditShelfId=auditShelfId, systemGeneralGroup=systemGeneralGroup, cardLastChangeTime=cardLastChangeTime, portType=portType, diskVolumeTrapInh=diskVolumeTrapInh, auditCommand=auditCommand, cardSpareGroupMode=cardSpareGroupMode, TestScheduleCommand=TestScheduleCommand, cardSerialNum=cardSerialNum, cardHwVersion=cardHwVersion, auditName=auditName, cardFpgaSource=cardFpgaSource, cardTestResultDesc=cardTestResultDesc, diskVolumeName=diskVolumeName, cmResetReason=cmResetReason, cardName=cardName, cardTemperatureHighError=cardTemperatureHighError, diskVolumeGroup=diskVolumeGroup, consoleOutput=consoleOutput, cardLastBootSource=cardLastBootSource, cardCpuSpeed=cardCpuSpeed, errEvRowStatus=errEvRowStatus, TestType=TestType, cardLastBootVersion=cardLastBootVersion, equipmentAuditGroup=equipmentAuditGroup, equipmentShelfGroup=equipmentShelfGroup, portAdminState=portAdminState, cardDplxStatusChange=cardDplxStatusChange, PYSNMP_MODULE_ID=cadEquipmentMib, cmResetStatus=cmResetStatus, portAction=portAction, cardCpuType=cardCpuType, equipmentAudit=equipmentAudit, cadEquipmentMibCompliance=cadEquipmentMibCompliance, equipmentState=equipmentState, portPrState=portPrState, errEvRecoveryEnabled=errEvRecoveryEnabled, equipmentCardGroup=equipmentCardGroup, auditAutoScheduling=auditAutoScheduling, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardTestEntry=cardTestEntry, portDplxStatus=portDplxStatus, portMacIfIndex=portMacIfIndex)
