...
ShelfId, CardId, DuplexStatus, PicType, PortId, FlowControlMode, SecondaryState, AdminState, FirmwareSource, DiskVolumeUsageLevel, PortDetectedMode, CardSubType, EqActionType, PrimaryState, CardType, UnknownState, PortType, PortMode = mibBuilder.importSymbols("CADANT-TC", "ShelfId", "CardId", "DuplexStatus", "PicType", "PortId", "FlowControlMode", "SecondaryState", "AdminState", "FirmwareSource", "DiskVolumeUsageLevel", "PortDetectedMode", "CardSubType", "EqActionType", "PrimaryState", "CardType", "UnknownState", "PortType", "PortMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
iso, ModuleIdentity, Bits, ObjectIdentity, TimeTicks, IpAddress, Counter64, NotificationType, Counter32, Gauge32, MibIdentifier, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Bits", "ObjectIdentity", "TimeTicks", "IpAddress", "Counter64", "NotificationType", "Counter32", "Gauge32", "MibIdentifier", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, MacAddress, TruthValue, DateAndTime, TextualConvention, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "MacAddress", "TruthValue", "DateAndTime", "TextualConvention", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", diskVolumeShelfId=diskVolumeShelfId, cmResetStatus=cmResetStatus, cmDevice=cmDevice, cardId=cardId, cardTestTable=cardTestTable, cmUChannelID=cmUChannelID, equipmentCardTestGroup=equipmentCardTestGroup, errEvRecoveryEnabled=errEvRecoveryEnabled, diskVolumeTable=diskVolumeTable, cardTestName=cardTestName, cardSerialNum=cardSerialNum, equipmentState=equipmentState, cardTestTime=cardTestTime, portNumChans=portNumChans, equipmentDiag=equipmentDiag, cardFwVersion=cardFwVersion, cardTempNoReportNotification=cardTempNoReportNotification, cardShelfId=cardShelfId, auditTime=auditTime, cmResetNotification=cmResetNotification, cardUpTime=cardUpTime, auditTotalFailedCount=auditTotalFailedCount, PYSNMP_MODULE_ID=cadEquipmentMib, portMaxDsPower=portMaxDsPower, shelfSwVersion=shelfSwVersion, cardFpgaSource=cardFpgaSource, equipmentAudit=equipmentAudit, TestResult=TestResult, auditDescription=auditDescription, cardTemperatureHighError=cardTemperatureHighError, TestId=TestId, diskVolumeId=diskVolumeId, auditTotalPassedCount=auditTotalPassedCount, cmResetReason=cmResetReason, cardFwUpdateStatus=cardFwUpdateStatus, cardPrState=cardPrState, cardBootVersion=cardBootVersion, auditLogThrottle=auditLogThrottle, cmVendor=cmVendor, verboseLevel=verboseLevel, auditEntry=auditEntry, cmResetClearNotification=cmResetClearNotification, cardDplxStatus=cardDplxStatus, fpgaErrorEventTable=fpgaErrorEventTable, errEvLogLevel=errEvLogLevel, diskVolumeCardId=diskVolumeCardId, cardCpuSpeed=cardCpuSpeed, cardPrStateChange=cardPrStateChange, portMode=portMode, cardAction=cardAction, diskDriveNumber=diskDriveNumber, cardAdminState=cardAdminState, cardCPLDVersion=cardCPLDVersion, portNumber=portNumber, TestTransactionId=TestTransactionId, portAdminState=portAdminState, TestSchedule=TestSchedule, portDplxStatus=portDplxStatus, portId=portId, portCardId=portCardId, cardCarrierSerialNum=cardCarrierSerialNum, diskVolumeName=diskVolumeName, trapCounter=trapCounter, cardTestDescription=cardTestDescription, cardTestSchedule=cardTestSchedule, fpgaErrorEventEntry=fpgaErrorEventEntry, systemGeneral=systemGeneral, cardLastResetReason=cardLastResetReason, auditStatus=auditStatus, portTrapInh=portTrapInh, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardTestTransId=cardTestTransId, auditCommand=auditCommand, errEvLoggingEnabled=errEvLoggingEnabled, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portRxFlowControlMode=portRxFlowControlMode, auditId=auditId, cardPicSerialNum=cardPicSerialNum, cardNumber=cardNumber, cardTemperature=cardTemperature, equipmentTbl=equipmentTbl, auditLogOutput=auditLogOutput, cadEquipmentMibConformance=cadEquipmentMibConformance, systemClock=systemClock, cardNumPorts=cardNumPorts, portCardSubType=portCardSubType, cardHwVersion=cardHwVersion, cardSubType=cardSubType, cmMacAddress=cmMacAddress, cardCarrierFwVersion=cardCarrierFwVersion, errEvRowStatus=errEvRowStatus, portPrStateChange=portPrStateChange, auditPassedCount=auditPassedCount, diskVolumeUsageLevel=diskVolumeUsageLevel, systemGeneralGroup=systemGeneralGroup, portTable=portTable, diskVolumeTrapInh=diskVolumeTrapInh, cardSpareGroupId=cardSpareGroupId, diskVolumeFileName=diskVolumeFileName, cardTestResult=cardTestResult, cardSubDetected=cardSubDetected, shelfNumber=shelfNumber, cardFlashSize=cardFlashSize, diagTestId=diagTestId, auditResult=auditResult, cardDplxStatusChange=cardDplxStatusChange, cadEquipmentMibCompliance=cadEquipmentMibCompliance, shelfName=shelfName, portTxFlowControlDetected=portTxFlowControlDetected, remainInDiagMode=remainInDiagMode, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portSecState=portSecState, TestType=TestType, cmIpAddress=cmIpAddress, cardTempOverHeatNotification=cardTempOverHeatNotification, cardTestId=cardTestId, portType=portType, cardPicDetected=cardPicDetected, cardTestScheduleCommand=cardTestScheduleCommand, cardTestResultDesc=cardTestResultDesc, portMinDsPower=portMinDsPower, diskVolumeDriveId=diskVolumeDriveId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardType=cardType, portDetectedMode=portDetectedMode, portDplxStatusChange=portDplxStatusChange, portMacAddress=portMacAddress, portConnectorId=portConnectorId, cardSecState=cardSecState, portRxFlowControlDetected=portRxFlowControlDetected, cardShelfTestIndex=cardShelfTestIndex, cmResetInfo=cmResetInfo, cardLastChangeTime=cardLastChangeTime, cmRegistrationNotification=cmRegistrationNotification, cardRamSize=cardRamSize, diskVolumeSize=diskVolumeSize, portAction=portAction, equipmentDiagGroup=equipmentDiagGroup, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portCurrDsPower=portCurrDsPower, portMacIfIndex=portMacIfIndex, cardTestIndex=cardTestIndex, cardTable=cardTable, fpgaErrorEventGroup=fpgaErrorEventGroup, shelfObjects=shelfObjects, consoleOutput=consoleOutput, cardEntry=cardEntry, portBgpId=portBgpId, portPrState=portPrState, auditAutoScheduling=auditAutoScheduling, portEntry=portEntry, diskVolumeUsagePercentage=diskVolumeUsagePercentage, equipmentStateGroup=equipmentStateGroup, auditCycleCount=auditCycleCount, cadEquipmentMib=cadEquipmentMib, portDocsIfIndex=portDocsIfIndex, auditName=auditName, equipmentCardGroup=equipmentCardGroup, portShelfId=portShelfId, cmPrimarySID=cmPrimarySID, equipmentError=equipmentError, equipmentShelfGroup=equipmentShelfGroup, equipmentTraps=equipmentTraps, TestScheduleCommand=TestScheduleCommand, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, equipmentPortGroup=equipmentPortGroup, portTxFlowControlMode=portTxFlowControlMode, equipmentAuditGroup=equipmentAuditGroup, auditCardId=auditCardId, cardTestType=cardTestType, cardTestResultNotification=cardTestResultNotification, eqDiagConfig=eqDiagConfig, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portDescription=portDescription, trapSeverity=trapSeverity, cardName=cardName, cadEquipmentMibGroup=cadEquipmentMibGroup, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeGroup=diskVolumeGroup, cardTestCommand=cardTestCommand, cardCpuType=cardCpuType, cardSpareGroupMode=cardSpareGroupMode, auditFailedCount=auditFailedCount, cardSecStateChange=cardSecStateChange, cardSwVersion=cardSwVersion, cardDetectedChange=cardDetectedChange, cardTrapInh=cardTrapInh, diskVolumeEntry=diskVolumeEntry, cardBusSpeed=cardBusSpeed, portSecStateChange=portSecStateChange, systemKey=systemKey, downstreamPowerLoss=downstreamPowerLoss, cardCarrierHwVersion=cardCarrierHwVersion, auditTable=auditTable, diskVolumeNumber=diskVolumeNumber, portLastChangeTime=portLastChangeTime, diskVolumeDiskSize=diskVolumeDiskSize, cmResetUpTime=cmResetUpTime, cardDetected=cardDetected, TestCommand=TestCommand, errEventId=errEventId, cardTemperatureHighWarn=cardTemperatureHighWarn, auditShelfId=auditShelfId, cardPicHwVersion=cardPicHwVersion, cardLastBootSource=cardLastBootSource, cardTestEntry=cardTestEntry, cardLastBootVersion=cardLastBootVersion)
