...
CardSubType, UnknownState, SecondaryState, CardId, DiskVolumeUsageLevel, DuplexStatus, PortMode, PortType, ShelfId, FirmwareSource, PrimaryState, AdminState, EqActionType, PicType, PortId, PortDetectedMode, CardType, FlowControlMode = mibBuilder.importSymbols("CADANT-TC", "CardSubType", "UnknownState", "SecondaryState", "CardId", "DiskVolumeUsageLevel", "DuplexStatus", "PortMode", "PortType", "ShelfId", "FirmwareSource", "PrimaryState", "AdminState", "EqActionType", "PicType", "PortId", "PortDetectedMode", "CardType", "FlowControlMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
NotificationType, Gauge32, IpAddress, Unsigned32, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Counter32, ObjectIdentity, ModuleIdentity, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "IpAddress", "Unsigned32", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Counter32", "ObjectIdentity", "ModuleIdentity", "iso", "Counter64")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", errEventId=errEventId, portPrStateChange=portPrStateChange, cardPrStateChange=cardPrStateChange, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, TestType=TestType, cardTable=cardTable, TestSchedule=TestSchedule, diskVolumeFileName=diskVolumeFileName, cadEquipmentMibConformance=cadEquipmentMibConformance, cardRamSize=cardRamSize, consoleOutput=consoleOutput, cardSubDetected=cardSubDetected, shelfName=shelfName, cardFlashSize=cardFlashSize, TestId=TestId, equipmentError=equipmentError, cardAction=cardAction, auditId=auditId, fpgaErrorEventEntry=fpgaErrorEventEntry, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardSecStateChange=cardSecStateChange, portMaxDsPower=portMaxDsPower, cmResetStatus=cmResetStatus, shelfNumber=shelfNumber, cardSpareGroupId=cardSpareGroupId, cardTrapInh=cardTrapInh, diskVolumeTrapInh=diskVolumeTrapInh, diagTestId=diagTestId, cardNumber=cardNumber, cardCpuSpeed=cardCpuSpeed, portDocsIfIndex=portDocsIfIndex, cardTestType=cardTestType, cmUChannelID=cmUChannelID, portShelfId=portShelfId, cardSubType=cardSubType, systemGeneral=systemGeneral, cardCarrierFwVersion=cardCarrierFwVersion, cardFwVersion=cardFwVersion, portTxFlowControlMode=portTxFlowControlMode, shelfSwVersion=shelfSwVersion, portDplxStatus=portDplxStatus, diskVolumeCardId=diskVolumeCardId, portMacAddress=portMacAddress, cardSerialNum=cardSerialNum, verboseLevel=verboseLevel, cadEquipmentMib=cadEquipmentMib, cardEntry=cardEntry, auditEntry=auditEntry, cardTestDescription=cardTestDescription, auditAutoScheduling=auditAutoScheduling, cardTempNoReportNotification=cardTempNoReportNotification, equipmentAuditGroup=equipmentAuditGroup, equipmentTbl=equipmentTbl, cardTestResult=cardTestResult, auditDescription=auditDescription, cardSwVersion=cardSwVersion, diskVolumeId=diskVolumeId, auditPassedCount=auditPassedCount, errEvLogLevel=errEvLogLevel, errEvRowStatus=errEvRowStatus, cardBootVersion=cardBootVersion, equipmentAudit=equipmentAudit, diskVolumeNumber=diskVolumeNumber, TestTransactionId=TestTransactionId, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portEntry=portEntry, cardPicSerialNum=cardPicSerialNum, diskVolumeUsageNotification=diskVolumeUsageNotification, fpgaErrorEventTable=fpgaErrorEventTable, cardTestSchedule=cardTestSchedule, cardTestScheduleCommand=cardTestScheduleCommand, cardUpTime=cardUpTime, auditShelfId=auditShelfId, portLastChangeTime=portLastChangeTime, cmIpAddress=cmIpAddress, errEvRecoveryEnabled=errEvRecoveryEnabled, cardTestTransId=cardTestTransId, eqDiagConfig=eqDiagConfig, trapSeverity=trapSeverity, auditTotalFailedCount=auditTotalFailedCount, systemGeneralGroup=systemGeneralGroup, cardName=cardName, cardFpgaSource=cardFpgaSource, diskVolumeEntry=diskVolumeEntry, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diskVolumeGroup=diskVolumeGroup, portDplxStatusChange=portDplxStatusChange, cmResetReason=cmResetReason, diskVolumeUsageLevel=diskVolumeUsageLevel, equipmentShelfGroup=equipmentShelfGroup, cardCarrierSerialNum=cardCarrierSerialNum, auditLogOutput=auditLogOutput, cardTemperature=cardTemperature, portAction=portAction, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeDiskSize=diskVolumeDiskSize, systemClock=systemClock, cardTestId=cardTestId, auditStatus=auditStatus, cardLastResetReason=cardLastResetReason, cardTestName=cardTestName, equipmentStateGroup=equipmentStateGroup, cardLastChangeTime=cardLastChangeTime, equipmentCardTestGroup=equipmentCardTestGroup, cardShelfTestIndex=cardShelfTestIndex, auditResult=auditResult, cardDplxStatusChange=cardDplxStatusChange, auditName=auditName, cardDetected=cardDetected, trapCounter=trapCounter, portNumChans=portNumChans, cmResetInfo=cmResetInfo, cardDetectedChange=cardDetectedChange, portPrState=portPrState, portType=portType, diskDriveNumber=diskDriveNumber, portDescription=portDescription, cmDevice=cmDevice, errEvLoggingEnabled=errEvLoggingEnabled, cardTestTime=cardTestTime, equipmentCardGroup=equipmentCardGroup, portMacIfIndex=portMacIfIndex, cardLastBootSource=cardLastBootSource, cardNumPorts=cardNumPorts, cardPicDetected=cardPicDetected, cardShelfId=cardShelfId, diskVolumeShelfId=diskVolumeShelfId, portCardId=portCardId, cmVendor=cmVendor, portBgpId=portBgpId, cardFwUpdateStatus=cardFwUpdateStatus, portNumber=portNumber, cadEquipmentMibCompliances=cadEquipmentMibCompliances, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portConnectorId=portConnectorId, cardDplxStatus=cardDplxStatus, auditFailedCount=auditFailedCount, auditLogThrottle=auditLogThrottle, equipmentPortGroup=equipmentPortGroup, cardPicHwVersion=cardPicHwVersion, TestCommand=TestCommand, cardTestResultNotification=cardTestResultNotification, auditTable=auditTable, portMode=portMode, cardId=cardId, cardPrState=cardPrState, shelfObjects=shelfObjects, cardCPLDVersion=cardCPLDVersion, cardCarrierHwVersion=cardCarrierHwVersion, cardTemperatureHighError=cardTemperatureHighError, cardTestCommand=cardTestCommand, diskVolumeSize=diskVolumeSize, cardTestIndex=cardTestIndex, downstreamPowerLoss=downstreamPowerLoss, diskVolumeName=diskVolumeName, portRxFlowControlMode=portRxFlowControlMode, portId=portId, cmResetUpTime=cmResetUpTime, portMinDsPower=portMinDsPower, cardAdminState=cardAdminState, cmResetClearNotification=cmResetClearNotification, cmResetNotification=cmResetNotification, cadEquipmentMibGroup=cadEquipmentMibGroup, systemKey=systemKey, cardTempOverHeatNotification=cardTempOverHeatNotification, auditCommand=auditCommand, remainInDiagMode=remainInDiagMode, cmMacAddress=cmMacAddress, portAdminState=portAdminState, equipmentDiagGroup=equipmentDiagGroup, cardTemperatureHighWarn=cardTemperatureHighWarn, portTrapInh=portTrapInh, TestScheduleCommand=TestScheduleCommand, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portTable=portTable, diskVolumeDriveId=diskVolumeDriveId, auditTime=auditTime, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditTotalPassedCount=auditTotalPassedCount, cardHwVersion=cardHwVersion, portCardSubType=portCardSubType, auditCycleCount=auditCycleCount, cardTestTable=cardTestTable, TestResult=TestResult, cardLastBootVersion=cardLastBootVersion, cardSecState=cardSecState, PYSNMP_MODULE_ID=cadEquipmentMib, cardType=cardType, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeTable=diskVolumeTable, cardSpareGroupMode=cardSpareGroupMode, portSecState=portSecState, cardTestEntry=cardTestEntry, portDetectedMode=portDetectedMode, cardTestResultDesc=cardTestResultDesc, equipmentDiag=equipmentDiag, cmPrimarySID=cmPrimarySID, cardBusSpeed=cardBusSpeed, fpgaErrorEventGroup=fpgaErrorEventGroup, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, auditCardId=auditCardId, portSecStateChange=portSecStateChange, cardCpuType=cardCpuType, portCurrDsPower=portCurrDsPower, cmRegistrationNotification=cmRegistrationNotification, equipmentState=equipmentState, equipmentTraps=equipmentTraps)
