...
PortId, PrimaryState, AdminState, SecondaryState, DiskVolumeUsageLevel, PortDetectedMode, ShelfId, UnknownState, PortMode, CardSubType, FlowControlMode, CardId, DuplexStatus, FirmwareSource, PicType, PortType, EqActionType, CardType = mibBuilder.importSymbols("CADANT-TC", "PortId", "PrimaryState", "AdminState", "SecondaryState", "DiskVolumeUsageLevel", "PortDetectedMode", "ShelfId", "UnknownState", "PortMode", "CardSubType", "FlowControlMode", "CardId", "DuplexStatus", "FirmwareSource", "PicType", "PortType", "EqActionType", "CardType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
iso, MibIdentifier, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, Bits, ModuleIdentity, Counter64, Integer32, TimeTicks, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "Bits", "ModuleIdentity", "Counter64", "Integer32", "TimeTicks", "Counter32", "IpAddress")
DateAndTime, RowStatus, TimeStamp, TruthValue, DisplayString, TextualConvention, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "RowStatus", "TimeStamp", "TruthValue", "DisplayString", "TextualConvention", "MacAddress")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portMacIfIndex=portMacIfIndex, auditTime=auditTime, cmResetClearNotification=cmResetClearNotification, cardTestTime=cardTestTime, cardUpTime=cardUpTime, cardBootVersion=cardBootVersion, cardCarrierHwVersion=cardCarrierHwVersion, cmDevice=cmDevice, trapCounter=trapCounter, portTxFlowControlMode=portTxFlowControlMode, portRxFlowControlMode=portRxFlowControlMode, equipmentStateGroup=equipmentStateGroup, diskVolumeTable=diskVolumeTable, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portId=portId, cmIpAddress=cmIpAddress, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeName=diskVolumeName, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, equipmentError=equipmentError, cardTempNoReportNotification=cardTempNoReportNotification, cardPicSerialNum=cardPicSerialNum, systemKey=systemKey, TestResult=TestResult, cardSpareGroupId=cardSpareGroupId, cardNumPorts=cardNumPorts, auditEntry=auditEntry, auditPassedCount=auditPassedCount, portTxFlowControlDetected=portTxFlowControlDetected, eqDiagConfig=eqDiagConfig, portConnectorId=portConnectorId, auditAutoScheduling=auditAutoScheduling, cardSubDetected=cardSubDetected, cardPicDetected=cardPicDetected, cardCarrierSerialNum=cardCarrierSerialNum, cardTestCommand=cardTestCommand, auditShelfId=auditShelfId, auditId=auditId, equipmentState=equipmentState, portMode=portMode, errEvLogLevel=errEvLogLevel, cardFwVersion=cardFwVersion, portNumber=portNumber, cardShelfTestIndex=cardShelfTestIndex, errEvLoggingEnabled=errEvLoggingEnabled, auditFailedCount=auditFailedCount, errEvRowStatus=errEvRowStatus, cardBusSpeed=cardBusSpeed, cmUChannelID=cmUChannelID, cardLastResetReason=cardLastResetReason, cardTestIndex=cardTestIndex, cardTestName=cardTestName, diskVolumeEntry=diskVolumeEntry, equipmentDiag=equipmentDiag, shelfSwVersion=shelfSwVersion, cardSpareGroupMode=cardSpareGroupMode, diskVolumeUsageLevel=diskVolumeUsageLevel, cardTestScheduleCommand=cardTestScheduleCommand, cmResetInfo=cmResetInfo, TestTransactionId=TestTransactionId, portAdminState=portAdminState, portTrapInh=portTrapInh, portEntry=portEntry, cardAction=cardAction, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, diskDriveNumber=diskDriveNumber, cardTestDescription=cardTestDescription, cmVendor=cmVendor, cardTable=cardTable, equipmentAuditGroup=equipmentAuditGroup, auditCommand=auditCommand, cardTestResultNotification=cardTestResultNotification, portNumChans=portNumChans, shelfName=shelfName, cardDplxStatus=cardDplxStatus, cardCPLDVersion=cardCPLDVersion, diskVolumeId=diskVolumeId, cardType=cardType, verboseLevel=verboseLevel, cardTestEntry=cardTestEntry, equipmentTraps=equipmentTraps, portPrStateChange=portPrStateChange, equipmentShelfGroup=equipmentShelfGroup, systemClock=systemClock, TestType=TestType, auditTotalFailedCount=auditTotalFailedCount, cardTemperature=cardTemperature, consoleOutput=consoleOutput, equipmentCardTestGroup=equipmentCardTestGroup, TestCommand=TestCommand, portBgpId=portBgpId, cadEquipmentMib=cadEquipmentMib, shelfObjects=shelfObjects, cardTemperatureHighWarn=cardTemperatureHighWarn, portCardId=portCardId, PYSNMP_MODULE_ID=cadEquipmentMib, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diagTestId=diagTestId, fpgaErrorEventEntry=fpgaErrorEventEntry, cardTestResult=cardTestResult, cardEntry=cardEntry, auditLogOutput=auditLogOutput, cardTestType=cardTestType, cardTrapInh=cardTrapInh, cadEquipmentMibGroup=cadEquipmentMibGroup, cardShelfId=cardShelfId, cardCpuType=cardCpuType, cardNumber=cardNumber, portCurrDsPower=portCurrDsPower, cardDplxStatusChange=cardDplxStatusChange, downstreamPowerLoss=downstreamPowerLoss, trapSeverity=trapSeverity, cmResetStatus=cmResetStatus, cardId=cardId, portDetectedMode=portDetectedMode, cardTestSchedule=cardTestSchedule, cardFwUpdateStatus=cardFwUpdateStatus, cardTestResultDesc=cardTestResultDesc, diskVolumeFileName=diskVolumeFileName, cardFlashSize=cardFlashSize, cardPrStateChange=cardPrStateChange, diskVolumeDriveId=diskVolumeDriveId, cardAdminState=cardAdminState, auditCardId=auditCardId, portTable=portTable, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTestTransId=cardTestTransId, systemGeneral=systemGeneral, portRxFlowControlDetected=portRxFlowControlDetected, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeShelfId=diskVolumeShelfId, cardTestTable=cardTestTable, cardLastChangeTime=cardLastChangeTime, TestId=TestId, portMaxDsPower=portMaxDsPower, portMacAddress=portMacAddress, equipmentAudit=equipmentAudit, TestScheduleCommand=TestScheduleCommand, portDocsIfIndex=portDocsIfIndex, auditCycleCount=auditCycleCount, auditTotalPassedCount=auditTotalPassedCount, errEvRecoveryEnabled=errEvRecoveryEnabled, equipmentCardGroup=equipmentCardGroup, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, portAction=portAction, cardTestId=cardTestId, cardPrState=cardPrState, auditDescription=auditDescription, cardSecStateChange=cardSecStateChange, portType=portType, diskVolumeDiskSize=diskVolumeDiskSize, equipmentTbl=equipmentTbl, fpgaErrorEventGroup=fpgaErrorEventGroup, cmResetReason=cmResetReason, portDplxStatus=portDplxStatus, cmResetNotification=cmResetNotification, cardLastBootVersion=cardLastBootVersion, equipmentPortGroup=equipmentPortGroup, portSecStateChange=portSecStateChange, cardTempOverHeatNotification=cardTempOverHeatNotification, cardSwVersion=cardSwVersion, cardDetected=cardDetected, systemGeneralGroup=systemGeneralGroup, cmRegistrationNotification=cmRegistrationNotification, cardLastBootSource=cardLastBootSource, auditName=auditName, shelfNumber=shelfNumber, cadEquipmentMibConformance=cadEquipmentMibConformance, equipmentDiagGroup=equipmentDiagGroup, diskVolumeNumber=diskVolumeNumber, diskVolumeGroup=diskVolumeGroup, cardTemperatureHighError=cardTemperatureHighError, portDescription=portDescription, portShelfId=portShelfId, cardSubType=cardSubType, cmMacAddress=cmMacAddress, TestSchedule=TestSchedule, cmResetUpTime=cmResetUpTime, portMinDsPower=portMinDsPower, cardName=cardName, cardSecState=cardSecState, portSecState=portSecState, diskVolumeSize=diskVolumeSize, auditTable=auditTable, portCardSubType=portCardSubType, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditResult=auditResult, cadEquipmentMibCompliances=cadEquipmentMibCompliances, diskVolumeUsageNotification=diskVolumeUsageNotification, auditStatus=auditStatus, portLastChangeTime=portLastChangeTime, auditLogThrottle=auditLogThrottle, cardCpuSpeed=cardCpuSpeed, diskVolumeCardId=diskVolumeCardId, portPrState=portPrState, remainInDiagMode=remainInDiagMode, fpgaErrorEventTable=fpgaErrorEventTable, cardRamSize=cardRamSize, errEventId=errEventId, cardDetectedChange=cardDetectedChange, portDplxStatusChange=portDplxStatusChange, diskVolumeTrapInh=diskVolumeTrapInh, cardHwVersion=cardHwVersion, cardFpgaSource=cardFpgaSource, cmPrimarySID=cmPrimarySID, cardSerialNum=cardSerialNum, cardPicHwVersion=cardPicHwVersion)
