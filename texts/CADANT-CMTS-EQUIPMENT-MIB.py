...
FlowControlMode, PrimaryState, DiskVolumeUsageLevel, CardId, DuplexStatus, UnknownState, AdminState, PortMode, FirmwareSource, ShelfId, SecondaryState, PortDetectedMode, PicType, PortId, CardType, CardSubType, EqActionType, PortType = mibBuilder.importSymbols("CADANT-TC", "FlowControlMode", "PrimaryState", "DiskVolumeUsageLevel", "CardId", "DuplexStatus", "UnknownState", "AdminState", "PortMode", "FirmwareSource", "ShelfId", "SecondaryState", "PortDetectedMode", "PicType", "PortId", "CardType", "CardSubType", "EqActionType", "PortType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
Integer32, TimeTicks, IpAddress, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, Counter64, Counter32, iso, ObjectIdentity, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "IpAddress", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "Counter64", "Counter32", "iso", "ObjectIdentity", "MibIdentifier", "NotificationType")
MacAddress, DateAndTime, TimeStamp, RowStatus, TruthValue, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "DateAndTime", "TimeStamp", "RowStatus", "TruthValue", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardPrState=cardPrState, cardTestDescription=cardTestDescription, portAction=portAction, cardTestIndex=cardTestIndex, cardDplxStatusChange=cardDplxStatusChange, cardSpareGroupMode=cardSpareGroupMode, auditTable=auditTable, TestId=TestId, cardDplxStatus=cardDplxStatus, portConnectorId=portConnectorId, portLastChangeTime=portLastChangeTime, portCardSubType=portCardSubType, cardPrStateChange=cardPrStateChange, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardType=cardType, cardTempOverHeatNotification=cardTempOverHeatNotification, auditShelfId=auditShelfId, auditDescription=auditDescription, portPrState=portPrState, cardTestName=cardTestName, cmUChannelID=cmUChannelID, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, shelfName=shelfName, auditFailedCount=auditFailedCount, cardCpuType=cardCpuType, cardShelfTestIndex=cardShelfTestIndex, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardPicSerialNum=cardPicSerialNum, cardDetected=cardDetected, remainInDiagMode=remainInDiagMode, equipmentAuditGroup=equipmentAuditGroup, cardCarrierFwVersion=cardCarrierFwVersion, cadEquipmentMibGroup=cadEquipmentMibGroup, auditCommand=auditCommand, cardCarrierHwVersion=cardCarrierHwVersion, cardFlashSize=cardFlashSize, portTrapInh=portTrapInh, auditResult=auditResult, cardUpTime=cardUpTime, equipmentError=equipmentError, consoleOutput=consoleOutput, cardFwVersion=cardFwVersion, portTable=portTable, portSecState=portSecState, errEvLogLevel=errEvLogLevel, cardAdminState=cardAdminState, equipmentDiagGroup=equipmentDiagGroup, cardName=cardName, cmIpAddress=cmIpAddress, cardLastResetReason=cardLastResetReason, eqDiagConfig=eqDiagConfig, cardBusSpeed=cardBusSpeed, trapSeverity=trapSeverity, cardEntry=cardEntry, cardHwVersion=cardHwVersion, TestTransactionId=TestTransactionId, diskVolumeTable=diskVolumeTable, cmResetUpTime=cmResetUpTime, cardTemperatureHighWarn=cardTemperatureHighWarn, portId=portId, auditCardId=auditCardId, cardPicDetected=cardPicDetected, equipmentStateGroup=equipmentStateGroup, diskVolumeShelfId=diskVolumeShelfId, fpgaErrorEventGroup=fpgaErrorEventGroup, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardTestSchedule=cardTestSchedule, cardSerialNum=cardSerialNum, equipmentTbl=equipmentTbl, systemKey=systemKey, cardRamSize=cardRamSize, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, auditTotalFailedCount=auditTotalFailedCount, fpgaErrorEventTable=fpgaErrorEventTable, cmVendor=cmVendor, auditEntry=auditEntry, cardTemperature=cardTemperature, cardNumPorts=cardNumPorts, cardCpuSpeed=cardCpuSpeed, shelfNumber=shelfNumber, diskVolumeTrapInh=diskVolumeTrapInh, diskVolumeId=diskVolumeId, shelfSwVersion=shelfSwVersion, cardCarrierSerialNum=cardCarrierSerialNum, diskVolumeEntry=diskVolumeEntry, portDplxStatus=portDplxStatus, equipmentShelfGroup=equipmentShelfGroup, downstreamPowerLoss=downstreamPowerLoss, portDplxStatusChange=portDplxStatusChange, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeSize=diskVolumeSize, auditTotalPassedCount=auditTotalPassedCount, portTxFlowControlDetected=portTxFlowControlDetected, portMacIfIndex=portMacIfIndex, auditStatus=auditStatus, diskVolumeName=diskVolumeName, portBgpId=portBgpId, cardSubDetected=cardSubDetected, cardTestTable=cardTestTable, cmDevice=cmDevice, auditCycleCount=auditCycleCount, equipmentAudit=equipmentAudit, TestSchedule=TestSchedule, portEntry=portEntry, portCardId=portCardId, cadEquipmentMibConformance=cadEquipmentMibConformance, diskVolumeDiskSize=diskVolumeDiskSize, portMaxDsPower=portMaxDsPower, cmResetInfo=cmResetInfo, systemGeneral=systemGeneral, diskVolumeUsageNotification=diskVolumeUsageNotification, cardSecState=cardSecState, fpgaErrorEventEntry=fpgaErrorEventEntry, portPrStateChange=portPrStateChange, cmResetClearNotification=cmResetClearNotification, TestCommand=TestCommand, auditPassedCount=auditPassedCount, verboseLevel=verboseLevel, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portDetectedMode=portDetectedMode, cmRegistrationNotification=cmRegistrationNotification, auditName=auditName, portRxFlowControlMode=portRxFlowControlMode, cardTestResultNotification=cardTestResultNotification, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardPicHwVersion=cardPicHwVersion, cardTestResult=cardTestResult, cardShelfId=cardShelfId, cardTestScheduleCommand=cardTestScheduleCommand, errEvRowStatus=errEvRowStatus, errEvRecoveryEnabled=errEvRecoveryEnabled, cadEquipmentMib=cadEquipmentMib, portNumChans=portNumChans, equipmentCardGroup=equipmentCardGroup, diskVolumeNumber=diskVolumeNumber, cardNumber=cardNumber, TestResult=TestResult, diskDriveNumber=diskDriveNumber, cardSpareGroupId=cardSpareGroupId, diskVolumeCardId=diskVolumeCardId, portShelfId=portShelfId, portNumber=portNumber, cardLastChangeTime=cardLastChangeTime, diskVolumeUsageLevel=diskVolumeUsageLevel, cardLastBootSource=cardLastBootSource, cardTestId=cardTestId, equipmentCardTestGroup=equipmentCardTestGroup, portTxFlowControlMode=portTxFlowControlMode, TestType=TestType, cardId=cardId, cardSecStateChange=cardSecStateChange, equipmentDiag=equipmentDiag, cardTestCommand=cardTestCommand, diskVolumeUsagePercentage=diskVolumeUsagePercentage, diskVolumeGroup=diskVolumeGroup, systemClock=systemClock, auditAutoScheduling=auditAutoScheduling, diagTestId=diagTestId, cmPrimarySID=cmPrimarySID, equipmentState=equipmentState, auditId=auditId, errEventId=errEventId, TestScheduleCommand=TestScheduleCommand, cardCPLDVersion=cardCPLDVersion, portMinDsPower=portMinDsPower, equipmentPortGroup=equipmentPortGroup, auditLogThrottle=auditLogThrottle, cardTestType=cardTestType, auditTime=auditTime, trapCounter=trapCounter, cardTemperatureHighError=cardTemperatureHighError, cardTempNoReportNotification=cardTempNoReportNotification, shelfObjects=shelfObjects, portType=portType, cmResetReason=cmResetReason, cardAction=cardAction, cardSwVersion=cardSwVersion, auditLogOutput=auditLogOutput, cardBootVersion=cardBootVersion, cardTestEntry=cardTestEntry, cardDetectedChange=cardDetectedChange, PYSNMP_MODULE_ID=cadEquipmentMib, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardFpgaSource=cardFpgaSource, portSecStateChange=portSecStateChange, cardFwUpdateStatus=cardFwUpdateStatus, portCurrDsPower=portCurrDsPower, diskVolumeDriveId=diskVolumeDriveId, portDescription=portDescription, cardTestTransId=cardTestTransId, equipmentTraps=equipmentTraps, portAdminState=portAdminState, cardLastBootVersion=cardLastBootVersion, portMacAddress=portMacAddress, cardSubType=cardSubType, diskVolumeFileName=diskVolumeFileName, portDocsIfIndex=portDocsIfIndex, cardTable=cardTable, cardTrapInh=cardTrapInh, cmMacAddress=cmMacAddress, cardTestTime=cardTestTime, cmResetNotification=cmResetNotification, portMode=portMode, errEvLoggingEnabled=errEvLoggingEnabled, systemGeneralGroup=systemGeneralGroup, cardTestResultDesc=cardTestResultDesc, cmResetStatus=cmResetStatus)
