...
CardSubType, UnknownState, ShelfId, PicType, PortDetectedMode, CardId, PrimaryState, PortId, SecondaryState, EqActionType, AdminState, DuplexStatus, FlowControlMode, PortMode, PortType, CardType, FirmwareSource, DiskVolumeUsageLevel = mibBuilder.importSymbols("CADANT-TC", "CardSubType", "UnknownState", "ShelfId", "PicType", "PortDetectedMode", "CardId", "PrimaryState", "PortId", "SecondaryState", "EqActionType", "AdminState", "DuplexStatus", "FlowControlMode", "PortMode", "PortType", "CardType", "FirmwareSource", "DiskVolumeUsageLevel")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
iso, Counter32, TimeTicks, Unsigned32, NotificationType, IpAddress, Bits, Counter64, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "TimeTicks", "Unsigned32", "NotificationType", "IpAddress", "Bits", "Counter64", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "ObjectIdentity")
TimeStamp, MacAddress, RowStatus, TruthValue, DateAndTime, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "MacAddress", "RowStatus", "TruthValue", "DateAndTime", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portDplxStatus=portDplxStatus, cardEntry=cardEntry, cardTestName=cardTestName, auditResult=auditResult, cardTable=cardTable, cardTempOverHeatNotification=cardTempOverHeatNotification, PYSNMP_MODULE_ID=cadEquipmentMib, diskVolumeNumber=diskVolumeNumber, cmVendor=cmVendor, cardTestSchedule=cardTestSchedule, cardPicHwVersion=cardPicHwVersion, cardNumPorts=cardNumPorts, diskVolumeTrapInh=diskVolumeTrapInh, cardPrStateChange=cardPrStateChange, systemClock=systemClock, portMacAddress=portMacAddress, shelfNumber=shelfNumber, portEntry=portEntry, auditFailedCount=auditFailedCount, equipmentCardTestGroup=equipmentCardTestGroup, cardTestIndex=cardTestIndex, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, shelfObjects=shelfObjects, equipmentDiag=equipmentDiag, cardTestId=cardTestId, cardTestDescription=cardTestDescription, auditTable=auditTable, diskVolumeDriveId=diskVolumeDriveId, cmIpAddress=cmIpAddress, equipmentStateGroup=equipmentStateGroup, equipmentPortGroup=equipmentPortGroup, portShelfId=portShelfId, errEventId=errEventId, portDocsIfIndex=portDocsIfIndex, TestCommand=TestCommand, remainInDiagMode=remainInDiagMode, cmMacAddress=cmMacAddress, cmResetStatus=cmResetStatus, cardAdminState=cardAdminState, cmResetReason=cmResetReason, cardSubType=cardSubType, cadEquipmentMib=cadEquipmentMib, cardTempNoReportNotification=cardTempNoReportNotification, portNumber=portNumber, auditTotalFailedCount=auditTotalFailedCount, TestResult=TestResult, trapSeverity=trapSeverity, portTxFlowControlMode=portTxFlowControlMode, cardLastChangeTime=cardLastChangeTime, cardHwVersion=cardHwVersion, cardBootVersion=cardBootVersion, equipmentTbl=equipmentTbl, diskVolumeTable=diskVolumeTable, auditCycleCount=auditCycleCount, cardCpuSpeed=cardCpuSpeed, cardFlashSize=cardFlashSize, portMode=portMode, portTxFlowControlDetected=portTxFlowControlDetected, portSecStateChange=portSecStateChange, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardLastBootVersion=cardLastBootVersion, cardTestResultDesc=cardTestResultDesc, errEvLoggingEnabled=errEvLoggingEnabled, cardSecState=cardSecState, fpgaErrorEventTable=fpgaErrorEventTable, cardShelfId=cardShelfId, cmResetUpTime=cmResetUpTime, shelfSwVersion=shelfSwVersion, portAction=portAction, portNumChans=portNumChans, shelfName=shelfName, errEvRowStatus=errEvRowStatus, cardPicDetected=cardPicDetected, auditPassedCount=auditPassedCount, portCurrDsPower=portCurrDsPower, cardPrState=cardPrState, diskVolumeId=diskVolumeId, auditCardId=auditCardId, auditTotalPassedCount=auditTotalPassedCount, diskVolumeFileName=diskVolumeFileName, diskVolumeEntry=diskVolumeEntry, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditStatus=auditStatus, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardFwVersion=cardFwVersion, TestSchedule=TestSchedule, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, equipmentAuditGroup=equipmentAuditGroup, cardType=cardType, cmResetNotification=cmResetNotification, auditShelfId=auditShelfId, TestId=TestId, systemGeneralGroup=systemGeneralGroup, portDescription=portDescription, cardLastResetReason=cardLastResetReason, portPrStateChange=portPrStateChange, auditDescription=auditDescription, portCardId=portCardId, cardTestTransId=cardTestTransId, cadEquipmentMibGroup=cadEquipmentMibGroup, cardUpTime=cardUpTime, portCardSubType=portCardSubType, cardPicSerialNum=cardPicSerialNum, diagTestId=diagTestId, TestScheduleCommand=TestScheduleCommand, cardCarrierFwVersion=cardCarrierFwVersion, portType=portType, equipmentCardGroup=equipmentCardGroup, auditId=auditId, portSecState=portSecState, cardSubDetected=cardSubDetected, cardSecStateChange=cardSecStateChange, portId=portId, portMinDsPower=portMinDsPower, auditTime=auditTime, auditLogOutput=auditLogOutput, eqDiagConfig=eqDiagConfig, cardTestCommand=cardTestCommand, cardTestResult=cardTestResult, cardSwVersion=cardSwVersion, auditAutoScheduling=auditAutoScheduling, cardTestType=cardTestType, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, diskDriveNumber=diskDriveNumber, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardTestScheduleCommand=cardTestScheduleCommand, cardId=cardId, cardSpareGroupId=cardSpareGroupId, cardDplxStatusChange=cardDplxStatusChange, portRxFlowControlMode=portRxFlowControlMode, diskVolumeUsageNotification=diskVolumeUsageNotification, cardNumber=cardNumber, TestType=TestType, portConnectorId=portConnectorId, auditName=auditName, verboseLevel=verboseLevel, portDplxStatusChange=portDplxStatusChange, cardSpareGroupMode=cardSpareGroupMode, cardTemperatureHighWarn=cardTemperatureHighWarn, cardSerialNum=cardSerialNum, cardTestTime=cardTestTime, diskVolumeUsageLevel=diskVolumeUsageLevel, cardCpuType=cardCpuType, cardDetected=cardDetected, portAdminState=portAdminState, diskVolumeShelfId=diskVolumeShelfId, diskVolumeDiskSize=diskVolumeDiskSize, diskVolumeGroup=diskVolumeGroup, cardAction=cardAction, systemKey=systemKey, cardTrapInh=cardTrapInh, cardTemperatureHighError=cardTemperatureHighError, equipmentShelfGroup=equipmentShelfGroup, cardBusSpeed=cardBusSpeed, diskVolumeSize=diskVolumeSize, portTable=portTable, cardTestTable=cardTestTable, auditCommand=auditCommand, consoleOutput=consoleOutput, portPrState=portPrState, auditEntry=auditEntry, portMacIfIndex=portMacIfIndex, cmUChannelID=cmUChannelID, fpgaErrorEventGroup=fpgaErrorEventGroup, cmDevice=cmDevice, cmPrimarySID=cmPrimarySID, cardDetectedChange=cardDetectedChange, portDetectedMode=portDetectedMode, systemGeneral=systemGeneral, portBgpId=portBgpId, downstreamPowerLoss=downstreamPowerLoss, cardRamSize=cardRamSize, trapCounter=trapCounter, cmRegistrationNotification=cmRegistrationNotification, cmResetInfo=cmResetInfo, equipmentDiagGroup=equipmentDiagGroup, errEvLogLevel=errEvLogLevel, cardCarrierSerialNum=cardCarrierSerialNum, equipmentError=equipmentError, equipmentAudit=equipmentAudit, cmResetClearNotification=cmResetClearNotification, cardLastBootSource=cardLastBootSource, auditLogThrottle=auditLogThrottle, cardCPLDVersion=cardCPLDVersion, portTrapInh=portTrapInh, TestTransactionId=TestTransactionId, portLastChangeTime=portLastChangeTime, cardDplxStatus=cardDplxStatus, equipmentState=equipmentState, cardName=cardName, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diskVolumeCardId=diskVolumeCardId, cadEquipmentMibConformance=cadEquipmentMibConformance, cardShelfTestIndex=cardShelfTestIndex, cardTemperature=cardTemperature, fpgaErrorEventEntry=fpgaErrorEventEntry, cardFwUpdateStatus=cardFwUpdateStatus, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, diskVolumeName=diskVolumeName, cardTestEntry=cardTestEntry, portMaxDsPower=portMaxDsPower, equipmentTraps=equipmentTraps, cardFpgaSource=cardFpgaSource, cardTestResultNotification=cardTestResultNotification, errEvRecoveryEnabled=errEvRecoveryEnabled, portRxFlowControlDetected=portRxFlowControlDetected)
