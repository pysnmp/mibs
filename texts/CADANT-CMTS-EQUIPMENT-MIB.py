...
EqActionType, PrimaryState, AdminState, DuplexStatus, PortDetectedMode, PortMode, PicType, ShelfId, SecondaryState, PortId, PortType, FirmwareSource, UnknownState, CardType, CardSubType, DiskVolumeUsageLevel, FlowControlMode, CardId = mibBuilder.importSymbols("CADANT-TC", "EqActionType", "PrimaryState", "AdminState", "DuplexStatus", "PortDetectedMode", "PortMode", "PicType", "ShelfId", "SecondaryState", "PortId", "PortType", "FirmwareSource", "UnknownState", "CardType", "CardSubType", "DiskVolumeUsageLevel", "FlowControlMode", "CardId")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
IpAddress, Bits, Integer32, Unsigned32, Gauge32, ObjectIdentity, MibIdentifier, ModuleIdentity, iso, TimeTicks, NotificationType, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "Integer32", "Unsigned32", "Gauge32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "iso", "TimeTicks", "NotificationType", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
DateAndTime, MacAddress, TruthValue, TimeStamp, TextualConvention, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "MacAddress", "TruthValue", "TimeStamp", "TextualConvention", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", errEvRowStatus=errEvRowStatus, downstreamPowerLoss=downstreamPowerLoss, portDplxStatus=portDplxStatus, portConnectorId=portConnectorId, cardName=cardName, cardTestScheduleCommand=cardTestScheduleCommand, TestTransactionId=TestTransactionId, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cmMacAddress=cmMacAddress, cadEquipmentMib=cadEquipmentMib, cardTestType=cardTestType, cardSubType=cardSubType, auditPassedCount=auditPassedCount, portRxFlowControlDetected=portRxFlowControlDetected, cmVendor=cmVendor, cardTemperature=cardTemperature, cmRegistrationNotification=cmRegistrationNotification, cardSecState=cardSecState, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditTotalPassedCount=auditTotalPassedCount, cardCarrierSerialNum=cardCarrierSerialNum, cmResetNotification=cmResetNotification, auditName=auditName, portMinDsPower=portMinDsPower, cardDetected=cardDetected, diskVolumeUsageLevel=diskVolumeUsageLevel, systemGeneral=systemGeneral, portPrState=portPrState, portDocsIfIndex=portDocsIfIndex, auditCycleCount=auditCycleCount, auditTotalFailedCount=auditTotalFailedCount, cardEntry=cardEntry, portCardId=portCardId, portDescription=portDescription, TestSchedule=TestSchedule, portRxFlowControlMode=portRxFlowControlMode, cardPicSerialNum=cardPicSerialNum, equipmentTraps=equipmentTraps, diskVolumeEntry=diskVolumeEntry, portNumber=portNumber, cardShelfId=cardShelfId, auditAutoScheduling=auditAutoScheduling, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardSecStateChange=cardSecStateChange, diskVolumeGroup=diskVolumeGroup, cardTestResultNotification=cardTestResultNotification, consoleOutput=consoleOutput, portAdminState=portAdminState, cardPicHwVersion=cardPicHwVersion, cardFpgaSource=cardFpgaSource, equipmentAudit=equipmentAudit, errEventId=errEventId, cardTempOverHeatNotification=cardTempOverHeatNotification, portMode=portMode, cardAction=cardAction, cardCpuType=cardCpuType, auditFailedCount=auditFailedCount, trapCounter=trapCounter, trapSeverity=trapSeverity, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portTrapInh=portTrapInh, diskVolumeNumber=diskVolumeNumber, portShelfId=portShelfId, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, diskVolumeName=diskVolumeName, eqDiagConfig=eqDiagConfig, cardFwVersion=cardFwVersion, cardHwVersion=cardHwVersion, equipmentState=equipmentState, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, shelfObjects=shelfObjects, diskVolumeFileName=diskVolumeFileName, equipmentAuditGroup=equipmentAuditGroup, portBgpId=portBgpId, TestCommand=TestCommand, cmResetInfo=cmResetInfo, cardTestResultDesc=cardTestResultDesc, shelfNumber=shelfNumber, equipmentShelfGroup=equipmentShelfGroup, cardType=cardType, portLastChangeTime=portLastChangeTime, cadEquipmentMibGroup=cadEquipmentMibGroup, cardSpareGroupMode=cardSpareGroupMode, cardTempNoReportNotification=cardTempNoReportNotification, cmResetReason=cmResetReason, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeDriveId=diskVolumeDriveId, equipmentDiag=equipmentDiag, portMaxDsPower=portMaxDsPower, auditTable=auditTable, cardFwUpdateStatus=cardFwUpdateStatus, auditId=auditId, auditCommand=auditCommand, cmResetClearNotification=cmResetClearNotification, cmResetUpTime=cmResetUpTime, auditDescription=auditDescription, cmResetStatus=cmResetStatus, equipmentDiagGroup=equipmentDiagGroup, cardPrState=cardPrState, shelfSwVersion=shelfSwVersion, cardFlashSize=cardFlashSize, remainInDiagMode=remainInDiagMode, TestResult=TestResult, cardCarrierFwVersion=cardCarrierFwVersion, fpgaErrorEventEntry=fpgaErrorEventEntry, auditLogOutput=auditLogOutput, auditResult=auditResult, auditStatus=auditStatus, cmUChannelID=cmUChannelID, portEntry=portEntry, cardNumPorts=cardNumPorts, cardTestSchedule=cardTestSchedule, cmDevice=cmDevice, auditEntry=auditEntry, cardTestIndex=cardTestIndex, equipmentError=equipmentError, portTable=portTable, cardTestTable=cardTestTable, cardDetectedChange=cardDetectedChange, portPrStateChange=portPrStateChange, portNumChans=portNumChans, shelfName=shelfName, systemGeneralGroup=systemGeneralGroup, cardTestDescription=cardTestDescription, portType=portType, TestType=TestType, cadEquipmentMibConformance=cadEquipmentMibConformance, equipmentTbl=equipmentTbl, TestScheduleCommand=TestScheduleCommand, verboseLevel=verboseLevel, cardSerialNum=cardSerialNum, diskDriveNumber=diskDriveNumber, cardTemperatureHighError=cardTemperatureHighError, cardRamSize=cardRamSize, diskVolumeId=diskVolumeId, diskVolumeDiskSize=diskVolumeDiskSize, cardTestResult=cardTestResult, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portId=portId, cardAdminState=cardAdminState, cardCPLDVersion=cardCPLDVersion, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardNumber=cardNumber, portTxFlowControlMode=portTxFlowControlMode, portMacAddress=portMacAddress, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardCpuSpeed=cardCpuSpeed, diskVolumeSize=diskVolumeSize, auditShelfId=auditShelfId, TestId=TestId, cardTrapInh=cardTrapInh, cmPrimarySID=cmPrimarySID, cardPrStateChange=cardPrStateChange, cardId=cardId, portMacIfIndex=portMacIfIndex, cardTestTransId=cardTestTransId, cardUpTime=cardUpTime, fpgaErrorEventGroup=fpgaErrorEventGroup, cardBusSpeed=cardBusSpeed, cardTestId=cardTestId, portDetectedMode=portDetectedMode, cardTestCommand=cardTestCommand, diskVolumeShelfId=diskVolumeShelfId, cardSwVersion=cardSwVersion, cardDplxStatusChange=cardDplxStatusChange, cardDplxStatus=cardDplxStatus, fpgaErrorEventTable=fpgaErrorEventTable, portSecState=portSecState, cardSubDetected=cardSubDetected, diagTestId=diagTestId, cardTestEntry=cardTestEntry, portDplxStatusChange=portDplxStatusChange, cardSpareGroupId=cardSpareGroupId, portAction=portAction, cardCarrierHwVersion=cardCarrierHwVersion, portCurrDsPower=portCurrDsPower, cmIpAddress=cmIpAddress, auditLogThrottle=auditLogThrottle, auditTime=auditTime, cardLastBootVersion=cardLastBootVersion, diskVolumeTrapInh=diskVolumeTrapInh, systemKey=systemKey, errEvLogLevel=errEvLogLevel, cardTestName=cardTestName, errEvLoggingEnabled=errEvLoggingEnabled, equipmentCardGroup=equipmentCardGroup, cardTestTime=cardTestTime, diskVolumeCardId=diskVolumeCardId, cardBootVersion=cardBootVersion, cardLastBootSource=cardLastBootSource, portSecStateChange=portSecStateChange, systemClock=systemClock, equipmentStateGroup=equipmentStateGroup, cardTable=cardTable, cardLastChangeTime=cardLastChangeTime, cardShelfTestIndex=cardShelfTestIndex, errEvRecoveryEnabled=errEvRecoveryEnabled, PYSNMP_MODULE_ID=cadEquipmentMib, equipmentCardTestGroup=equipmentCardTestGroup, cardTemperatureHighWarn=cardTemperatureHighWarn, equipmentPortGroup=equipmentPortGroup, diskVolumeTable=diskVolumeTable, auditCardId=auditCardId, portCardSubType=portCardSubType, cardPicDetected=cardPicDetected, cardLastResetReason=cardLastResetReason)
