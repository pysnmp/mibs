...
CardId, PortType, CardType, DiskVolumeUsageLevel, PrimaryState, SecondaryState, FirmwareSource, PicType, EqActionType, PortDetectedMode, FlowControlMode, AdminState, DuplexStatus, UnknownState, ShelfId, CardSubType, PortId, PortMode = mibBuilder.importSymbols("CADANT-TC", "CardId", "PortType", "CardType", "DiskVolumeUsageLevel", "PrimaryState", "SecondaryState", "FirmwareSource", "PicType", "EqActionType", "PortDetectedMode", "FlowControlMode", "AdminState", "DuplexStatus", "UnknownState", "ShelfId", "CardSubType", "PortId", "PortMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, IpAddress, Bits, Integer32, Gauge32, Unsigned32, MibIdentifier, ModuleIdentity, NotificationType, Counter64, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "IpAddress", "Bits", "Integer32", "Gauge32", "Unsigned32", "MibIdentifier", "ModuleIdentity", "NotificationType", "Counter64", "iso", "ObjectIdentity")
TruthValue, TimeStamp, RowStatus, DateAndTime, MacAddress, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "RowStatus", "DateAndTime", "MacAddress", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", diskVolumeUsageLevel=diskVolumeUsageLevel, auditCycleCount=auditCycleCount, cardTemperatureHighError=cardTemperatureHighError, auditTotalPassedCount=auditTotalPassedCount, portAdminState=portAdminState, auditLogOutput=auditLogOutput, cmIpAddress=cmIpAddress, errEvRowStatus=errEvRowStatus, systemClock=systemClock, shelfObjects=shelfObjects, portMacIfIndex=portMacIfIndex, portLastChangeTime=portLastChangeTime, cardFpgaSource=cardFpgaSource, cardDetectedChange=cardDetectedChange, PYSNMP_MODULE_ID=cadEquipmentMib, TestResult=TestResult, cardSubType=cardSubType, diskVolumeName=diskVolumeName, verboseLevel=verboseLevel, cardSecStateChange=cardSecStateChange, portCardId=portCardId, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeDiskSize=diskVolumeDiskSize, TestTransactionId=TestTransactionId, cardName=cardName, cardTemperatureHighWarn=cardTemperatureHighWarn, portDetectedMode=portDetectedMode, portType=portType, diskVolumeCardId=diskVolumeCardId, cmUChannelID=cmUChannelID, auditShelfId=auditShelfId, portDplxStatus=portDplxStatus, cmPrimarySID=cmPrimarySID, cardSecState=cardSecState, cardPicSerialNum=cardPicSerialNum, cardTestIndex=cardTestIndex, equipmentCardTestGroup=equipmentCardTestGroup, fpgaErrorEventGroup=fpgaErrorEventGroup, auditPassedCount=auditPassedCount, systemGeneral=systemGeneral, systemKey=systemKey, trapCounter=trapCounter, cardPrState=cardPrState, portSecState=portSecState, auditCommand=auditCommand, cardPrStateChange=cardPrStateChange, cardTestId=cardTestId, diagTestId=diagTestId, consoleOutput=consoleOutput, cardDplxStatusChange=cardDplxStatusChange, cardFwUpdateStatus=cardFwUpdateStatus, cardTestType=cardTestType, equipmentDiag=equipmentDiag, TestCommand=TestCommand, cardTempNoReportNotification=cardTempNoReportNotification, equipmentCardGroup=equipmentCardGroup, portEntry=portEntry, diskVolumeNumber=diskVolumeNumber, cardLastResetReason=cardLastResetReason, cardTestSchedule=cardTestSchedule, systemGeneralGroup=systemGeneralGroup, portTxFlowControlDetected=portTxFlowControlDetected, cadEquipmentMibConformance=cadEquipmentMibConformance, auditName=auditName, cmResetUpTime=cmResetUpTime, diskVolumeUsagePercentage=diskVolumeUsagePercentage, diskDriveNumber=diskDriveNumber, auditFailedCount=auditFailedCount, cardBootVersion=cardBootVersion, equipmentTraps=equipmentTraps, diskVolumeEntry=diskVolumeEntry, equipmentState=equipmentState, cardShelfTestIndex=cardShelfTestIndex, equipmentShelfGroup=equipmentShelfGroup, cardTestTable=cardTestTable, cardNumber=cardNumber, portSecStateChange=portSecStateChange, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portRxFlowControlDetected=portRxFlowControlDetected, cmResetNotification=cmResetNotification, cardSerialNum=cardSerialNum, shelfSwVersion=shelfSwVersion, diskVolumeTable=diskVolumeTable, trapSeverity=trapSeverity, cardTestCommand=cardTestCommand, TestSchedule=TestSchedule, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardTestResultNotification=cardTestResultNotification, cardType=cardType, shelfName=shelfName, cardPicHwVersion=cardPicHwVersion, cardCPLDVersion=cardCPLDVersion, diskVolumeGroup=diskVolumeGroup, cardTable=cardTable, portNumChans=portNumChans, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, remainInDiagMode=remainInDiagMode, auditTotalFailedCount=auditTotalFailedCount, cardCpuSpeed=cardCpuSpeed, diskVolumeId=diskVolumeId, shelfNumber=shelfNumber, TestType=TestType, cardRamSize=cardRamSize, cardAdminState=cardAdminState, cadEquipmentMib=cadEquipmentMib, cardTestName=cardTestName, cmDevice=cmDevice, equipmentAuditGroup=equipmentAuditGroup, cmVendor=cmVendor, TestScheduleCommand=TestScheduleCommand, diskVolumeDriveId=diskVolumeDriveId, cmResetClearNotification=cmResetClearNotification, auditTime=auditTime, cardHwVersion=cardHwVersion, cardTestEntry=cardTestEntry, cardSubDetected=cardSubDetected, portDocsIfIndex=portDocsIfIndex, cardTestTime=cardTestTime, cardTestResultDesc=cardTestResultDesc, equipmentAudit=equipmentAudit, cardTrapInh=cardTrapInh, auditEntry=auditEntry, errEvLoggingEnabled=errEvLoggingEnabled, portAction=portAction, cadEquipmentMibCompliance=cadEquipmentMibCompliance, TestId=TestId, portPrState=portPrState, cardFwVersion=cardFwVersion, auditStatus=auditStatus, cardAction=cardAction, portRxFlowControlMode=portRxFlowControlMode, cardTestTransId=cardTestTransId, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portMode=portMode, auditCardId=auditCardId, cardDplxStatus=cardDplxStatus, auditResult=auditResult, diskVolumeShelfId=diskVolumeShelfId, portCurrDsPower=portCurrDsPower, cardId=cardId, errEvRecoveryEnabled=errEvRecoveryEnabled, cardPicDetected=cardPicDetected, portId=portId, errEvLogLevel=errEvLogLevel, equipmentStateGroup=equipmentStateGroup, cardCarrierFwVersion=cardCarrierFwVersion, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardNumPorts=cardNumPorts, portDescription=portDescription, cmRegistrationNotification=cmRegistrationNotification, cardSwVersion=cardSwVersion, cardShelfId=cardShelfId, auditAutoScheduling=auditAutoScheduling, downstreamPowerLoss=downstreamPowerLoss, cmResetStatus=cmResetStatus, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, eqDiagConfig=eqDiagConfig, errEventId=errEventId, cmResetReason=cmResetReason, portMaxDsPower=portMaxDsPower, cardLastBootVersion=cardLastBootVersion, cardLastBootSource=cardLastBootSource, cardTestScheduleCommand=cardTestScheduleCommand, diskVolumeFileName=diskVolumeFileName, equipmentError=equipmentError, cardTestDescription=cardTestDescription, portPrStateChange=portPrStateChange, portCardSubType=portCardSubType, cardEntry=cardEntry, portTable=portTable, cardUpTime=cardUpTime, cardBusSpeed=cardBusSpeed, portNumber=portNumber, cmMacAddress=cmMacAddress, cardCarrierHwVersion=cardCarrierHwVersion, cardTemperature=cardTemperature, portTrapInh=portTrapInh, auditTable=auditTable, portBgpId=portBgpId, cardCarrierSerialNum=cardCarrierSerialNum, cardCpuType=cardCpuType, portConnectorId=portConnectorId, fpgaErrorEventEntry=fpgaErrorEventEntry, cardSpareGroupId=cardSpareGroupId, portShelfId=portShelfId, portDplxStatusChange=portDplxStatusChange, cardLastChangeTime=cardLastChangeTime, cardSpareGroupMode=cardSpareGroupMode, auditDescription=auditDescription, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, diskVolumeTrapInh=diskVolumeTrapInh, portMacAddress=portMacAddress, diskVolumeSize=diskVolumeSize, portMinDsPower=portMinDsPower, fpgaErrorEventTable=fpgaErrorEventTable, cadEquipmentMibGroup=cadEquipmentMibGroup, cardTempOverHeatNotification=cardTempOverHeatNotification, equipmentPortGroup=equipmentPortGroup, equipmentDiagGroup=equipmentDiagGroup, portTxFlowControlMode=portTxFlowControlMode, auditLogThrottle=auditLogThrottle, cardFlashSize=cardFlashSize, equipmentTbl=equipmentTbl, cardDetected=cardDetected, cmResetInfo=cmResetInfo, auditId=auditId, cardTestResult=cardTestResult)
