...
PortType, CardId, DiskVolumeUsageLevel, PortDetectedMode, FlowControlMode, PrimaryState, ShelfId, PortMode, CardType, PicType, AdminState, DuplexStatus, UnknownState, CardSubType, SecondaryState, PortId, EqActionType, FirmwareSource = mibBuilder.importSymbols("CADANT-TC", "PortType", "CardId", "DiskVolumeUsageLevel", "PortDetectedMode", "FlowControlMode", "PrimaryState", "ShelfId", "PortMode", "CardType", "PicType", "AdminState", "DuplexStatus", "UnknownState", "CardSubType", "SecondaryState", "PortId", "EqActionType", "FirmwareSource")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
IpAddress, ObjectIdentity, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, Gauge32, Integer32, TimeTicks, Unsigned32, Bits, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "Gauge32", "Integer32", "TimeTicks", "Unsigned32", "Bits", "NotificationType", "iso")
MacAddress, TextualConvention, DateAndTime, TruthValue, RowStatus, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TextualConvention", "DateAndTime", "TruthValue", "RowStatus", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cadEquipmentMibCompliances=cadEquipmentMibCompliances, cadEquipmentMib=cadEquipmentMib, cardNumber=cardNumber, portNumChans=portNumChans, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardTestTime=cardTestTime, downstreamPowerLoss=downstreamPowerLoss, portMacIfIndex=portMacIfIndex, cardEntry=cardEntry, auditStatus=auditStatus, cardNumPorts=cardNumPorts, diskVolumeNumber=diskVolumeNumber, cardId=cardId, cardCpuType=cardCpuType, cardTestTable=cardTestTable, TestSchedule=TestSchedule, portTable=portTable, cardSubType=cardSubType, PYSNMP_MODULE_ID=cadEquipmentMib, cardSpareGroupMode=cardSpareGroupMode, verboseLevel=verboseLevel, auditFailedCount=auditFailedCount, cardTestType=cardTestType, cardAction=cardAction, cardTestEntry=cardTestEntry, diskVolumeFileName=diskVolumeFileName, cardTrapInh=cardTrapInh, auditEntry=auditEntry, cardCpuSpeed=cardCpuSpeed, cardSerialNum=cardSerialNum, TestType=TestType, portDetectedMode=portDetectedMode, cadEquipmentMibCompliance=cadEquipmentMibCompliance, trapSeverity=trapSeverity, TestId=TestId, diskVolumeTable=diskVolumeTable, cardSecStateChange=cardSecStateChange, auditShelfId=auditShelfId, cmResetNotification=cmResetNotification, cmMacAddress=cmMacAddress, systemGeneralGroup=systemGeneralGroup, auditAutoScheduling=auditAutoScheduling, cardLastBootVersion=cardLastBootVersion, cardTempNoReportNotification=cardTempNoReportNotification, auditDescription=auditDescription, cardPrStateChange=cardPrStateChange, cardTempOverHeatNotification=cardTempOverHeatNotification, auditLogThrottle=auditLogThrottle, cardSecState=cardSecState, cmDevice=cmDevice, auditLogOutput=auditLogOutput, cardHwVersion=cardHwVersion, diagTestId=diagTestId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, equipmentCardTestGroup=equipmentCardTestGroup, cardPrState=cardPrState, cardTestIndex=cardTestIndex, portPrStateChange=portPrStateChange, auditId=auditId, portAdminState=portAdminState, errEvRowStatus=errEvRowStatus, portMode=portMode, fpgaErrorEventTable=fpgaErrorEventTable, cardDplxStatusChange=cardDplxStatusChange, shelfSwVersion=shelfSwVersion, cardPicDetected=cardPicDetected, portMaxDsPower=portMaxDsPower, portType=portType, cardTestId=cardTestId, systemGeneral=systemGeneral, auditTime=auditTime, diskVolumeEntry=diskVolumeEntry, cadEquipmentMibConformance=cadEquipmentMibConformance, cmUChannelID=cmUChannelID, cmResetReason=cmResetReason, equipmentDiagGroup=equipmentDiagGroup, trapCounter=trapCounter, cmResetStatus=cmResetStatus, portMinDsPower=portMinDsPower, remainInDiagMode=remainInDiagMode, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardDetected=cardDetected, cardFpgaSource=cardFpgaSource, cmRegistrationNotification=cmRegistrationNotification, auditResult=auditResult, cmResetInfo=cmResetInfo, cardSubDetected=cardSubDetected, consoleOutput=consoleOutput, equipmentShelfGroup=equipmentShelfGroup, diskVolumeName=diskVolumeName, diskVolumeSize=diskVolumeSize, cmResetUpTime=cmResetUpTime, cmIpAddress=cmIpAddress, portDplxStatusChange=portDplxStatusChange, portDplxStatus=portDplxStatus, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portRxFlowControlDetected=portRxFlowControlDetected, cmVendor=cmVendor, cardCarrierHwVersion=cardCarrierHwVersion, cardCarrierFwVersion=cardCarrierFwVersion, TestResult=TestResult, cardPicHwVersion=cardPicHwVersion, equipmentAudit=equipmentAudit, portAction=portAction, equipmentPortGroup=equipmentPortGroup, cmResetClearNotification=cmResetClearNotification, portId=portId, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portCardSubType=portCardSubType, cadEquipmentMibGroup=cadEquipmentMibGroup, cardCarrierSerialNum=cardCarrierSerialNum, systemClock=systemClock, cardLastChangeTime=cardLastChangeTime, equipmentState=equipmentState, cardTestName=cardTestName, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portRxFlowControlMode=portRxFlowControlMode, diskVolumeId=diskVolumeId, cardPicSerialNum=cardPicSerialNum, auditCardId=auditCardId, equipmentAuditGroup=equipmentAuditGroup, cardFwUpdateStatus=cardFwUpdateStatus, portCurrDsPower=portCurrDsPower, cardFwVersion=cardFwVersion, cardTestTransId=cardTestTransId, cardRamSize=cardRamSize, portLastChangeTime=portLastChangeTime, portDescription=portDescription, cardTestCommand=cardTestCommand, auditCommand=auditCommand, cmPrimarySID=cmPrimarySID, cardName=cardName, cardTestResult=cardTestResult, errEvLoggingEnabled=errEvLoggingEnabled, equipmentStateGroup=equipmentStateGroup, cardTestDescription=cardTestDescription, diskVolumeTrapInh=diskVolumeTrapInh, cardBootVersion=cardBootVersion, cardTestResultNotification=cardTestResultNotification, auditName=auditName, portTxFlowControlMode=portTxFlowControlMode, portCardId=portCardId, diskVolumeDriveId=diskVolumeDriveId, equipmentError=equipmentError, diskDriveNumber=diskDriveNumber, diskVolumeGroup=diskVolumeGroup, portConnectorId=portConnectorId, portEntry=portEntry, cardTestScheduleCommand=cardTestScheduleCommand, portNumber=portNumber, portBgpId=portBgpId, cardTestSchedule=cardTestSchedule, cardCPLDVersion=cardCPLDVersion, cardAdminState=cardAdminState, shelfNumber=shelfNumber, TestTransactionId=TestTransactionId, portMacAddress=portMacAddress, diskVolumeUsageLevel=diskVolumeUsageLevel, errEventId=errEventId, portTxFlowControlDetected=portTxFlowControlDetected, auditTable=auditTable, fpgaErrorEventGroup=fpgaErrorEventGroup, cardTemperatureHighError=cardTemperatureHighError, cardShelfId=cardShelfId, shelfName=shelfName, shelfObjects=shelfObjects, diskVolumeShelfId=diskVolumeShelfId, diskVolumeDiskSize=diskVolumeDiskSize, portDocsIfIndex=portDocsIfIndex, auditCycleCount=auditCycleCount, portPrState=portPrState, cardType=cardType, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, errEvLogLevel=errEvLogLevel, cardLastBootSource=cardLastBootSource, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeCardId=diskVolumeCardId, eqDiagConfig=eqDiagConfig, portSecState=portSecState, cardTestResultDesc=cardTestResultDesc, cardBusSpeed=cardBusSpeed, equipmentTbl=equipmentTbl, auditTotalPassedCount=auditTotalPassedCount, cardFlashSize=cardFlashSize, TestScheduleCommand=TestScheduleCommand, cardDetectedChange=cardDetectedChange, portTrapInh=portTrapInh, errEvRecoveryEnabled=errEvRecoveryEnabled, TestCommand=TestCommand, cardTemperatureHighWarn=cardTemperatureHighWarn, cardUpTime=cardUpTime, cardLastResetReason=cardLastResetReason, portShelfId=portShelfId, auditPassedCount=auditPassedCount, fpgaErrorEventEntry=fpgaErrorEventEntry, portSecStateChange=portSecStateChange, cardSpareGroupId=cardSpareGroupId, auditTotalFailedCount=auditTotalFailedCount, cardShelfTestIndex=cardShelfTestIndex, equipmentCardGroup=equipmentCardGroup, equipmentTraps=equipmentTraps, cardSwVersion=cardSwVersion, cardDplxStatus=cardDplxStatus, cardTable=cardTable, systemKey=systemKey, cardTemperature=cardTemperature, equipmentDiag=equipmentDiag)
