...
PortDetectedMode, PortMode, ShelfId, FlowControlMode, CardId, AdminState, FirmwareSource, EqActionType, UnknownState, CardType, SecondaryState, DuplexStatus, PrimaryState, PortId, CardSubType, PortType, DiskVolumeUsageLevel, PicType = mibBuilder.importSymbols("CADANT-TC", "PortDetectedMode", "PortMode", "ShelfId", "FlowControlMode", "CardId", "AdminState", "FirmwareSource", "EqActionType", "UnknownState", "CardType", "SecondaryState", "DuplexStatus", "PrimaryState", "PortId", "CardSubType", "PortType", "DiskVolumeUsageLevel", "PicType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
Bits, TimeTicks, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Gauge32, Unsigned32, Integer32, Counter64, MibIdentifier, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Gauge32", "Unsigned32", "Integer32", "Counter64", "MibIdentifier", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardFwVersion=cardFwVersion, portTxFlowControlMode=portTxFlowControlMode, errEvLogLevel=errEvLogLevel, cardTemperatureHighWarn=cardTemperatureHighWarn, portId=portId, portEntry=portEntry, portSecState=portSecState, cardShelfTestIndex=cardShelfTestIndex, diskVolumeTrapInh=diskVolumeTrapInh, cmResetUpTime=cmResetUpTime, cmIpAddress=cmIpAddress, auditTable=auditTable, cardTrapInh=cardTrapInh, cardFwUpdateStatus=cardFwUpdateStatus, errEvLoggingEnabled=errEvLoggingEnabled, auditTotalFailedCount=auditTotalFailedCount, portTrapInh=portTrapInh, cardTestTable=cardTestTable, cardShelfId=cardShelfId, portLastChangeTime=portLastChangeTime, cardSpareGroupMode=cardSpareGroupMode, cardUpTime=cardUpTime, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardCarrierFwVersion=cardCarrierFwVersion, cardTestEntry=cardTestEntry, cardTestTransId=cardTestTransId, auditLogThrottle=auditLogThrottle, equipmentCardTestGroup=equipmentCardTestGroup, diskVolumeId=diskVolumeId, cardType=cardType, cardCarrierSerialNum=cardCarrierSerialNum, cardCarrierHwVersion=cardCarrierHwVersion, cardSwVersion=cardSwVersion, portAction=portAction, equipmentCardGroup=equipmentCardGroup, shelfObjects=shelfObjects, TestSchedule=TestSchedule, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, equipmentAuditGroup=equipmentAuditGroup, cardCpuSpeed=cardCpuSpeed, portNumChans=portNumChans, equipmentError=equipmentError, cmResetInfo=cmResetInfo, auditDescription=auditDescription, portTxFlowControlDetected=portTxFlowControlDetected, auditAutoScheduling=auditAutoScheduling, cmResetReason=cmResetReason, diskVolumeDriveId=diskVolumeDriveId, eqDiagConfig=eqDiagConfig, cardTemperatureHighError=cardTemperatureHighError, cardLastChangeTime=cardLastChangeTime, TestResult=TestResult, cardBusSpeed=cardBusSpeed, equipmentPortGroup=equipmentPortGroup, portMinDsPower=portMinDsPower, portDplxStatusChange=portDplxStatusChange, TestType=TestType, portDplxStatus=portDplxStatus, equipmentState=equipmentState, cardTestId=cardTestId, shelfSwVersion=shelfSwVersion, diskVolumeUsageLevel=diskVolumeUsageLevel, auditCommand=auditCommand, portDetectedMode=portDetectedMode, cardLastBootVersion=cardLastBootVersion, cardPicHwVersion=cardPicHwVersion, cardSecStateChange=cardSecStateChange, auditName=auditName, diskVolumeGroup=diskVolumeGroup, diskVolumeFileName=diskVolumeFileName, portMode=portMode, auditCycleCount=auditCycleCount, shelfName=shelfName, cardFlashSize=cardFlashSize, PYSNMP_MODULE_ID=cadEquipmentMib, cmPrimarySID=cmPrimarySID, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, downstreamPowerLoss=downstreamPowerLoss, systemClock=systemClock, trapCounter=trapCounter, TestId=TestId, cardBootVersion=cardBootVersion, equipmentTbl=equipmentTbl, cardTempNoReportNotification=cardTempNoReportNotification, equipmentTraps=equipmentTraps, cardDplxStatus=cardDplxStatus, cmDevice=cmDevice, cardId=cardId, cardTempOverHeatNotification=cardTempOverHeatNotification, cardTestCommand=cardTestCommand, diagTestId=diagTestId, portMacIfIndex=portMacIfIndex, equipmentDiagGroup=equipmentDiagGroup, consoleOutput=consoleOutput, cadEquipmentMib=cadEquipmentMib, cardSerialNum=cardSerialNum, cardNumPorts=cardNumPorts, portShelfId=portShelfId, portType=portType, auditStatus=auditStatus, errEvRowStatus=errEvRowStatus, portNumber=portNumber, cmResetClearNotification=cmResetClearNotification, auditResult=auditResult, auditCardId=auditCardId, portAdminState=portAdminState, shelfNumber=shelfNumber, cardAdminState=cardAdminState, cardTestResult=cardTestResult, diskVolumeDiskSize=diskVolumeDiskSize, portDocsIfIndex=portDocsIfIndex, TestScheduleCommand=TestScheduleCommand, cardEntry=cardEntry, cardHwVersion=cardHwVersion, cmUChannelID=cmUChannelID, diskVolumeUsageNotification=diskVolumeUsageNotification, portPrState=portPrState, portCurrDsPower=portCurrDsPower, cardTestSchedule=cardTestSchedule, portCardSubType=portCardSubType, cardPicDetected=cardPicDetected, equipmentDiag=equipmentDiag, diskVolumeEntry=diskVolumeEntry, cardRamSize=cardRamSize, cardLastBootSource=cardLastBootSource, auditFailedCount=auditFailedCount, cardTestIndex=cardTestIndex, cardTestScheduleCommand=cardTestScheduleCommand, cardAction=cardAction, cmResetNotification=cmResetNotification, cardSubType=cardSubType, auditEntry=auditEntry, portDescription=portDescription, portConnectorId=portConnectorId, portTable=portTable, auditLogOutput=auditLogOutput, auditTotalPassedCount=auditTotalPassedCount, portRxFlowControlMode=portRxFlowControlMode, trapSeverity=trapSeverity, diskVolumeTable=diskVolumeTable, cardDplxStatusChange=cardDplxStatusChange, cardTable=cardTable, diskDriveNumber=diskDriveNumber, cardFpgaSource=cardFpgaSource, cardDetected=cardDetected, auditId=auditId, systemGeneral=systemGeneral, cardPicSerialNum=cardPicSerialNum, diskVolumeNumber=diskVolumeNumber, cardTestType=cardTestType, systemKey=systemKey, verboseLevel=verboseLevel, errEvRecoveryEnabled=errEvRecoveryEnabled, TestCommand=TestCommand, cardTestDescription=cardTestDescription, diskVolumeShelfId=diskVolumeShelfId, portSecStateChange=portSecStateChange, diskVolumeSize=diskVolumeSize, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, systemGeneralGroup=systemGeneralGroup, cardDetectedChange=cardDetectedChange, cmRegistrationNotification=cmRegistrationNotification, cardName=cardName, portPrStateChange=portPrStateChange, cardTestTime=cardTestTime, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portRxFlowControlDetected=portRxFlowControlDetected, fpgaErrorEventTable=fpgaErrorEventTable, cardCpuType=cardCpuType, cmVendor=cmVendor, errEventId=errEventId, cmMacAddress=cmMacAddress, cadEquipmentMibConformance=cadEquipmentMibConformance, cardNumber=cardNumber, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portCardId=portCardId, cardTestResultDesc=cardTestResultDesc, remainInDiagMode=remainInDiagMode, cardLastResetReason=cardLastResetReason, portMacAddress=portMacAddress, cardSpareGroupId=cardSpareGroupId, equipmentShelfGroup=equipmentShelfGroup, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, auditTime=auditTime, cardSubDetected=cardSubDetected, fpgaErrorEventEntry=fpgaErrorEventEntry, cardSecState=cardSecState, diskVolumeName=diskVolumeName, equipmentStateGroup=equipmentStateGroup, cardPrStateChange=cardPrStateChange, cardTestName=cardTestName, cardTestResultNotification=cardTestResultNotification, portBgpId=portBgpId, cardCPLDVersion=cardCPLDVersion, equipmentAudit=equipmentAudit, portMaxDsPower=portMaxDsPower, cmResetStatus=cmResetStatus, TestTransactionId=TestTransactionId, cardTemperature=cardTemperature, cadEquipmentMibGroup=cadEquipmentMibGroup, diskVolumeCardId=diskVolumeCardId, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, auditShelfId=auditShelfId, fpgaErrorEventGroup=fpgaErrorEventGroup, auditPassedCount=auditPassedCount, cardPrState=cardPrState, cadEquipmentMibCompliances=cadEquipmentMibCompliances)
