...
PrimaryState, PortId, CardId, FlowControlMode, AdminState, CardType, PicType, PortDetectedMode, PortType, CardSubType, PortMode, UnknownState, DuplexStatus, ShelfId, DiskVolumeUsageLevel, FirmwareSource, EqActionType, SecondaryState = mibBuilder.importSymbols("CADANT-TC", "PrimaryState", "PortId", "CardId", "FlowControlMode", "AdminState", "CardType", "PicType", "PortDetectedMode", "PortType", "CardSubType", "PortMode", "UnknownState", "DuplexStatus", "ShelfId", "DiskVolumeUsageLevel", "FirmwareSource", "EqActionType", "SecondaryState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
ObjectIdentity, IpAddress, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Integer32, Bits, Counter64, ModuleIdentity, Counter32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Integer32", "Bits", "Counter64", "ModuleIdentity", "Counter32", "TimeTicks", "iso")
TimeStamp, TextualConvention, DateAndTime, TruthValue, MacAddress, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "DateAndTime", "TruthValue", "MacAddress", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portMacIfIndex=portMacIfIndex, diskVolumeSize=diskVolumeSize, consoleOutput=consoleOutput, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardFwUpdateStatus=cardFwUpdateStatus, cardCpuSpeed=cardCpuSpeed, auditCardId=auditCardId, cardFpgaSource=cardFpgaSource, diskVolumeUsageLevel=diskVolumeUsageLevel, cardShelfId=cardShelfId, TestScheduleCommand=TestScheduleCommand, cardBusSpeed=cardBusSpeed, cardTestDescription=cardTestDescription, auditLogThrottle=auditLogThrottle, portDplxStatus=portDplxStatus, cardId=cardId, shelfSwVersion=shelfSwVersion, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardTestEntry=cardTestEntry, errEventId=errEventId, cmIpAddress=cmIpAddress, portTrapInh=portTrapInh, auditDescription=auditDescription, equipmentAuditGroup=equipmentAuditGroup, cardCarrierFwVersion=cardCarrierFwVersion, cardSecState=cardSecState, equipmentCardGroup=equipmentCardGroup, cardLastBootVersion=cardLastBootVersion, cmResetNotification=cmResetNotification, PYSNMP_MODULE_ID=cadEquipmentMib, cardBootVersion=cardBootVersion, portSecStateChange=portSecStateChange, auditTime=auditTime, portTable=portTable, auditTotalPassedCount=auditTotalPassedCount, cardLastChangeTime=cardLastChangeTime, shelfName=shelfName, TestSchedule=TestSchedule, cardPicSerialNum=cardPicSerialNum, cardTestResultDesc=cardTestResultDesc, auditLogOutput=auditLogOutput, downstreamPowerLoss=downstreamPowerLoss, portDplxStatusChange=portDplxStatusChange, cardTestName=cardTestName, auditFailedCount=auditFailedCount, portDescription=portDescription, cardTrapInh=cardTrapInh, cardTempNoReportNotification=cardTempNoReportNotification, TestResult=TestResult, TestId=TestId, cardNumPorts=cardNumPorts, equipmentDiag=equipmentDiag, cardTestResultNotification=cardTestResultNotification, portMacAddress=portMacAddress, cardRamSize=cardRamSize, cmResetReason=cmResetReason, diskVolumeId=diskVolumeId, remainInDiagMode=remainInDiagMode, cardCpuType=cardCpuType, portMinDsPower=portMinDsPower, cardSecStateChange=cardSecStateChange, diskVolumeTrapInh=diskVolumeTrapInh, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeUsageNotification=diskVolumeUsageNotification, portDocsIfIndex=portDocsIfIndex, auditTable=auditTable, cardTestResult=cardTestResult, diskVolumeDriveId=diskVolumeDriveId, auditEntry=auditEntry, diskVolumeName=diskVolumeName, cardLastResetReason=cardLastResetReason, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, diagTestId=diagTestId, cardShelfTestIndex=cardShelfTestIndex, equipmentShelfGroup=equipmentShelfGroup, equipmentPortGroup=equipmentPortGroup, trapCounter=trapCounter, diskVolumeNumber=diskVolumeNumber, equipmentAudit=equipmentAudit, portAction=portAction, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTestTime=cardTestTime, equipmentError=equipmentError, cardCPLDVersion=cardCPLDVersion, auditTotalFailedCount=auditTotalFailedCount, cardTemperature=cardTemperature, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeTable=diskVolumeTable, portLastChangeTime=portLastChangeTime, diskVolumeEntry=diskVolumeEntry, shelfObjects=shelfObjects, diskDriveNumber=diskDriveNumber, cardSerialNum=cardSerialNum, portCardSubType=portCardSubType, cardAction=cardAction, cmRegistrationNotification=cmRegistrationNotification, cardSpareGroupId=cardSpareGroupId, portNumber=portNumber, auditName=auditName, cardType=cardType, equipmentTbl=equipmentTbl, fpgaErrorEventTable=fpgaErrorEventTable, cmResetUpTime=cmResetUpTime, eqDiagConfig=eqDiagConfig, cadEquipmentMibConformance=cadEquipmentMibConformance, diskVolumeFileName=diskVolumeFileName, equipmentStateGroup=equipmentStateGroup, cmVendor=cmVendor, TestCommand=TestCommand, systemKey=systemKey, cardTemperatureHighWarn=cardTemperatureHighWarn, diskVolumeDiskSize=diskVolumeDiskSize, cardSwVersion=cardSwVersion, cardDetected=cardDetected, cmDevice=cmDevice, portCardId=portCardId, portAdminState=portAdminState, portDetectedMode=portDetectedMode, verboseLevel=verboseLevel, auditResult=auditResult, TestTransactionId=TestTransactionId, cardTestCommand=cardTestCommand, cmResetInfo=cmResetInfo, cardTable=cardTable, cardPrStateChange=cardPrStateChange, auditAutoScheduling=auditAutoScheduling, cmResetClearNotification=cmResetClearNotification, cardLastBootSource=cardLastBootSource, portNumChans=portNumChans, errEvLoggingEnabled=errEvLoggingEnabled, cardTemperatureHighError=cardTemperatureHighError, portPrStateChange=portPrStateChange, equipmentDiagGroup=equipmentDiagGroup, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardTestSchedule=cardTestSchedule, cardFwVersion=cardFwVersion, cmPrimarySID=cmPrimarySID, errEvRecoveryEnabled=errEvRecoveryEnabled, auditId=auditId, cardTestIndex=cardTestIndex, cadEquipmentMibGroup=cadEquipmentMibGroup, equipmentTraps=equipmentTraps, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, auditShelfId=auditShelfId, shelfNumber=shelfNumber, cardHwVersion=cardHwVersion, cmResetStatus=cmResetStatus, cardFlashSize=cardFlashSize, errEvLogLevel=errEvLogLevel, auditStatus=auditStatus, cardName=cardName, trapSeverity=trapSeverity, fpgaErrorEventEntry=fpgaErrorEventEntry, portTxFlowControlMode=portTxFlowControlMode, auditCycleCount=auditCycleCount, portType=portType, portShelfId=portShelfId, auditPassedCount=auditPassedCount, cardNumber=cardNumber, systemClock=systemClock, errEvRowStatus=errEvRowStatus, cardSubType=cardSubType, portMode=portMode, cardAdminState=cardAdminState, cardTestTransId=cardTestTransId, systemGeneralGroup=systemGeneralGroup, equipmentState=equipmentState, cardDplxStatusChange=cardDplxStatusChange, diskVolumeCardId=diskVolumeCardId, portRxFlowControlDetected=portRxFlowControlDetected, cardDetectedChange=cardDetectedChange, cardSpareGroupMode=cardSpareGroupMode, cardPrState=cardPrState, portId=portId, cardTestScheduleCommand=cardTestScheduleCommand, portSecState=portSecState, cmMacAddress=cmMacAddress, cardCarrierSerialNum=cardCarrierSerialNum, cardDplxStatus=cardDplxStatus, cardSubDetected=cardSubDetected, cardPicDetected=cardPicDetected, portEntry=portEntry, cardTestId=cardTestId, cadEquipmentMib=cadEquipmentMib, cardTestType=cardTestType, auditCommand=auditCommand, portBgpId=portBgpId, diskVolumeGroup=diskVolumeGroup, portPrState=portPrState, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portConnectorId=portConnectorId, cardPicHwVersion=cardPicHwVersion, diskVolumeShelfId=diskVolumeShelfId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardUpTime=cardUpTime, portMaxDsPower=portMaxDsPower, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, fpgaErrorEventGroup=fpgaErrorEventGroup, cardTestTable=cardTestTable, portCurrDsPower=portCurrDsPower, cardEntry=cardEntry, TestType=TestType, systemGeneral=systemGeneral, equipmentCardTestGroup=equipmentCardTestGroup, cmUChannelID=cmUChannelID, portRxFlowControlMode=portRxFlowControlMode)
