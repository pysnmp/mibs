...
PrimaryState, CardSubType, DiskVolumeUsageLevel, PortMode, ShelfId, PortDetectedMode, AdminState, CardId, DuplexStatus, EqActionType, FirmwareSource, FlowControlMode, PicType, PortId, CardType, PortType, SecondaryState, UnknownState = mibBuilder.importSymbols("CADANT-TC", "PrimaryState", "CardSubType", "DiskVolumeUsageLevel", "PortMode", "ShelfId", "PortDetectedMode", "AdminState", "CardId", "DuplexStatus", "EqActionType", "FirmwareSource", "FlowControlMode", "PicType", "PortId", "CardType", "PortType", "SecondaryState", "UnknownState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
Integer32, TimeTicks, Bits, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, IpAddress, Counter64, ModuleIdentity, Gauge32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "Bits", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "IpAddress", "Counter64", "ModuleIdentity", "Gauge32", "NotificationType", "iso")
DisplayString, TimeStamp, TextualConvention, DateAndTime, MacAddress, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TextualConvention", "DateAndTime", "MacAddress", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", diskDriveNumber=diskDriveNumber, systemClock=systemClock, portTrapInh=portTrapInh, equipmentShelfGroup=equipmentShelfGroup, errEventId=errEventId, eqDiagConfig=eqDiagConfig, cardCpuType=cardCpuType, cmResetClearNotification=cmResetClearNotification, portRxFlowControlMode=portRxFlowControlMode, cardRamSize=cardRamSize, remainInDiagMode=remainInDiagMode, cadEquipmentMibConformance=cadEquipmentMibConformance, equipmentPortGroup=equipmentPortGroup, shelfObjects=shelfObjects, auditTable=auditTable, errEvRowStatus=errEvRowStatus, cardFlashSize=cardFlashSize, cardLastResetReason=cardLastResetReason, portType=portType, cmPrimarySID=cmPrimarySID, cardSubDetected=cardSubDetected, equipmentTbl=equipmentTbl, cmIpAddress=cmIpAddress, equipmentState=equipmentState, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, portLastChangeTime=portLastChangeTime, cardSwVersion=cardSwVersion, TestId=TestId, cardTemperatureHighWarn=cardTemperatureHighWarn, cardTemperatureHighError=cardTemperatureHighError, portMode=portMode, diskVolumeTable=diskVolumeTable, diskVolumeDiskSize=diskVolumeDiskSize, cardTestCommand=cardTestCommand, auditFailedCount=auditFailedCount, equipmentCardTestGroup=equipmentCardTestGroup, cardAction=cardAction, cardId=cardId, portMacAddress=portMacAddress, equipmentError=equipmentError, trapSeverity=trapSeverity, auditTime=auditTime, portDetectedMode=portDetectedMode, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTestResult=cardTestResult, cardFwVersion=cardFwVersion, cardCPLDVersion=cardCPLDVersion, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diskVolumeCardId=diskVolumeCardId, diagTestId=diagTestId, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardBusSpeed=cardBusSpeed, cardTemperature=cardTemperature, diskVolumeTrapInh=diskVolumeTrapInh, cardLastBootVersion=cardLastBootVersion, cardTestSchedule=cardTestSchedule, cardDplxStatus=cardDplxStatus, diskVolumeName=diskVolumeName, diskVolumeSize=diskVolumeSize, auditEntry=auditEntry, cardCarrierSerialNum=cardCarrierSerialNum, diskVolumeUsageLevel=diskVolumeUsageLevel, auditTotalFailedCount=auditTotalFailedCount, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeDriveId=diskVolumeDriveId, equipmentDiag=equipmentDiag, cardTestDescription=cardTestDescription, cardTestScheduleCommand=cardTestScheduleCommand, cardHwVersion=cardHwVersion, diskVolumeUsageNotification=diskVolumeUsageNotification, cardSpareGroupMode=cardSpareGroupMode, portCardSubType=portCardSubType, auditCardId=auditCardId, TestType=TestType, trapCounter=trapCounter, cardTestEntry=cardTestEntry, cardNumber=cardNumber, cardPicHwVersion=cardPicHwVersion, auditLogThrottle=auditLogThrottle, consoleOutput=consoleOutput, cardCpuSpeed=cardCpuSpeed, portNumber=portNumber, auditAutoScheduling=auditAutoScheduling, cardDetected=cardDetected, cardTestName=cardTestName, cardUpTime=cardUpTime, portTable=portTable, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditCycleCount=auditCycleCount, cardDplxStatusChange=cardDplxStatusChange, verboseLevel=verboseLevel, auditPassedCount=auditPassedCount, portPrState=portPrState, PYSNMP_MODULE_ID=cadEquipmentMib, cardShelfTestIndex=cardShelfTestIndex, cadEquipmentMibGroup=cadEquipmentMibGroup, cardCarrierFwVersion=cardCarrierFwVersion, cmRegistrationNotification=cmRegistrationNotification, auditId=auditId, cardTestTransId=cardTestTransId, cardLastBootSource=cardLastBootSource, shelfNumber=shelfNumber, shelfName=shelfName, cardPicDetected=cardPicDetected, cardFwUpdateStatus=cardFwUpdateStatus, cmUChannelID=cmUChannelID, equipmentTraps=equipmentTraps, portAdminState=portAdminState, cardEntry=cardEntry, cardTestIndex=cardTestIndex, cardSpareGroupId=cardSpareGroupId, portTxFlowControlDetected=portTxFlowControlDetected, cardTestResultNotification=cardTestResultNotification, auditShelfId=auditShelfId, cadEquipmentMibCompliances=cadEquipmentMibCompliances, auditLogOutput=auditLogOutput, portCurrDsPower=portCurrDsPower, TestScheduleCommand=TestScheduleCommand, portMaxDsPower=portMaxDsPower, diskVolumeId=diskVolumeId, auditName=auditName, auditTotalPassedCount=auditTotalPassedCount, portPrStateChange=portPrStateChange, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardSecStateChange=cardSecStateChange, portDplxStatus=portDplxStatus, portAction=portAction, diskVolumeUsagePercentage=diskVolumeUsagePercentage, fpgaErrorEventEntry=fpgaErrorEventEntry, cmResetReason=cmResetReason, diskVolumeFileName=diskVolumeFileName, portShelfId=portShelfId, cmResetNotification=cmResetNotification, portCardId=portCardId, portSecState=portSecState, cardLastChangeTime=cardLastChangeTime, cmResetUpTime=cmResetUpTime, cardPicSerialNum=cardPicSerialNum, cardTempNoReportNotification=cardTempNoReportNotification, portDplxStatusChange=portDplxStatusChange, TestCommand=TestCommand, auditCommand=auditCommand, TestResult=TestResult, errEvLogLevel=errEvLogLevel, cardPrStateChange=cardPrStateChange, systemGeneralGroup=systemGeneralGroup, equipmentCardGroup=equipmentCardGroup, fpgaErrorEventGroup=fpgaErrorEventGroup, cardTestType=cardTestType, equipmentDiagGroup=equipmentDiagGroup, auditStatus=auditStatus, auditResult=auditResult, shelfSwVersion=shelfSwVersion, cardPrState=cardPrState, cardSerialNum=cardSerialNum, portTxFlowControlMode=portTxFlowControlMode, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, TestSchedule=TestSchedule, cardSecState=cardSecState, auditDescription=auditDescription, cardShelfId=cardShelfId, portId=portId, diskVolumeEntry=diskVolumeEntry, portRxFlowControlDetected=portRxFlowControlDetected, cardType=cardType, cardNumPorts=cardNumPorts, systemKey=systemKey, cardTable=cardTable, systemGeneral=systemGeneral, cardTestResultDesc=cardTestResultDesc, cardAdminState=cardAdminState, cmVendor=cmVendor, cardSubType=cardSubType, cmMacAddress=cmMacAddress, portMacIfIndex=portMacIfIndex, cardTestTable=cardTestTable, portDocsIfIndex=portDocsIfIndex, portDescription=portDescription, portSecStateChange=portSecStateChange, cmResetStatus=cmResetStatus, equipmentAudit=equipmentAudit, diskVolumeGroup=diskVolumeGroup, portNumChans=portNumChans, cardTrapInh=cardTrapInh, cadEquipmentMib=cadEquipmentMib, diskVolumeNumber=diskVolumeNumber, cmResetInfo=cmResetInfo, downstreamPowerLoss=downstreamPowerLoss, TestTransactionId=TestTransactionId, portBgpId=portBgpId, diskVolumeShelfId=diskVolumeShelfId, cardBootVersion=cardBootVersion, cmDevice=cmDevice, cardTestId=cardTestId, portMinDsPower=portMinDsPower, equipmentStateGroup=equipmentStateGroup, cardDetectedChange=cardDetectedChange, cardCarrierHwVersion=cardCarrierHwVersion, fpgaErrorEventTable=fpgaErrorEventTable, portConnectorId=portConnectorId, errEvRecoveryEnabled=errEvRecoveryEnabled, cardName=cardName, equipmentAuditGroup=equipmentAuditGroup, cardTestTime=cardTestTime, cardFpgaSource=cardFpgaSource, portEntry=portEntry)
