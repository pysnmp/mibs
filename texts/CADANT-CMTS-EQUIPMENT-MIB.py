...
FlowControlMode, PicType, AdminState, PrimaryState, UnknownState, CardId, ShelfId, DuplexStatus, PortType, PortDetectedMode, CardSubType, CardType, PortMode, SecondaryState, EqActionType, DiskVolumeUsageLevel, PortId, FirmwareSource = mibBuilder.importSymbols("CADANT-TC", "FlowControlMode", "PicType", "AdminState", "PrimaryState", "UnknownState", "CardId", "ShelfId", "DuplexStatus", "PortType", "PortDetectedMode", "CardSubType", "CardType", "PortMode", "SecondaryState", "EqActionType", "DiskVolumeUsageLevel", "PortId", "FirmwareSource")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
Counter32, Gauge32, ObjectIdentity, NotificationType, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Unsigned32, IpAddress, MibIdentifier, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ObjectIdentity", "NotificationType", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Unsigned32", "IpAddress", "MibIdentifier", "iso", "ModuleIdentity")
DateAndTime, DisplayString, TimeStamp, TruthValue, RowStatus, MacAddress, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "TimeStamp", "TruthValue", "RowStatus", "MacAddress", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portCurrDsPower=portCurrDsPower, trapCounter=trapCounter, diagTestId=diagTestId, portEntry=portEntry, auditAutoScheduling=auditAutoScheduling, portDetectedMode=portDetectedMode, portType=portType, cardSpareGroupMode=cardSpareGroupMode, auditCommand=auditCommand, portDplxStatus=portDplxStatus, cardTestScheduleCommand=cardTestScheduleCommand, equipmentTbl=equipmentTbl, cardFwVersion=cardFwVersion, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portNumber=portNumber, auditCycleCount=auditCycleCount, portMinDsPower=portMinDsPower, systemGeneralGroup=systemGeneralGroup, diskVolumeDiskSize=diskVolumeDiskSize, cardTestEntry=cardTestEntry, cardSerialNum=cardSerialNum, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditShelfId=auditShelfId, cardUpTime=cardUpTime, errEventId=errEventId, trapSeverity=trapSeverity, cardTestType=cardTestType, shelfObjects=shelfObjects, cardPicDetected=cardPicDetected, cardCPLDVersion=cardCPLDVersion, cardCarrierFwVersion=cardCarrierFwVersion, portPrStateChange=portPrStateChange, cardLastBootVersion=cardLastBootVersion, errEvLoggingEnabled=errEvLoggingEnabled, eqDiagConfig=eqDiagConfig, cardLastResetReason=cardLastResetReason, cardEntry=cardEntry, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardSubDetected=cardSubDetected, cardPicHwVersion=cardPicHwVersion, auditFailedCount=auditFailedCount, cardDplxStatusChange=cardDplxStatusChange, diskVolumeEntry=diskVolumeEntry, portId=portId, shelfName=shelfName, cardTestName=cardTestName, cmVendor=cmVendor, systemClock=systemClock, cardName=cardName, PYSNMP_MODULE_ID=cadEquipmentMib, cardShelfTestIndex=cardShelfTestIndex, cadEquipmentMib=cadEquipmentMib, portMacAddress=portMacAddress, auditTotalFailedCount=auditTotalFailedCount, cardSecState=cardSecState, diskVolumeShelfId=diskVolumeShelfId, cardTestTable=cardTestTable, cmPrimarySID=cmPrimarySID, portDocsIfIndex=portDocsIfIndex, errEvRowStatus=errEvRowStatus, portRxFlowControlDetected=portRxFlowControlDetected, equipmentState=equipmentState, cardNumPorts=cardNumPorts, TestTransactionId=TestTransactionId, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardType=cardType, auditStatus=auditStatus, cardDetected=cardDetected, auditCardId=auditCardId, cardCpuSpeed=cardCpuSpeed, portBgpId=portBgpId, diskVolumeNumber=diskVolumeNumber, portDescription=portDescription, diskVolumeSize=diskVolumeSize, cardTestResultNotification=cardTestResultNotification, cardTestResultDesc=cardTestResultDesc, diskDriveNumber=diskDriveNumber, portLastChangeTime=portLastChangeTime, cardCpuType=cardCpuType, fpgaErrorEventTable=fpgaErrorEventTable, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeDriveId=diskVolumeDriveId, errEvLogLevel=errEvLogLevel, portPrState=portPrState, auditEntry=auditEntry, portConnectorId=portConnectorId, cardTestDescription=cardTestDescription, cardTestResult=cardTestResult, portDplxStatusChange=portDplxStatusChange, auditDescription=auditDescription, portCardSubType=portCardSubType, cardAction=cardAction, cardFlashSize=cardFlashSize, equipmentCardTestGroup=equipmentCardTestGroup, cardSwVersion=cardSwVersion, cardFpgaSource=cardFpgaSource, portCardId=portCardId, cardRamSize=cardRamSize, portAdminState=portAdminState, cardCarrierSerialNum=cardCarrierSerialNum, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cmResetReason=cmResetReason, portAction=portAction, portShelfId=portShelfId, portSecState=portSecState, auditId=auditId, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeCardId=diskVolumeCardId, cardNumber=cardNumber, cmResetNotification=cmResetNotification, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, TestCommand=TestCommand, equipmentShelfGroup=equipmentShelfGroup, cardSecStateChange=cardSecStateChange, portTable=portTable, cardTestTransId=cardTestTransId, portTxFlowControlMode=portTxFlowControlMode, shelfSwVersion=shelfSwVersion, equipmentCardGroup=equipmentCardGroup, cardFwUpdateStatus=cardFwUpdateStatus, cmResetStatus=cmResetStatus, cardTemperatureHighWarn=cardTemperatureHighWarn, cardDetectedChange=cardDetectedChange, equipmentDiagGroup=equipmentDiagGroup, cardSubType=cardSubType, TestId=TestId, cardAdminState=cardAdminState, auditPassedCount=auditPassedCount, cmResetUpTime=cmResetUpTime, cardTemperatureHighError=cardTemperatureHighError, cmUChannelID=cmUChannelID, consoleOutput=consoleOutput, systemKey=systemKey, diskVolumeUsageLevel=diskVolumeUsageLevel, remainInDiagMode=remainInDiagMode, cmRegistrationNotification=cmRegistrationNotification, auditLogThrottle=auditLogThrottle, cmDevice=cmDevice, downstreamPowerLoss=downstreamPowerLoss, cmResetInfo=cmResetInfo, auditTime=auditTime, cardTempNoReportNotification=cardTempNoReportNotification, cardId=cardId, diskVolumeName=diskVolumeName, cardShelfId=cardShelfId, auditTotalPassedCount=auditTotalPassedCount, cardPrState=cardPrState, portMaxDsPower=portMaxDsPower, equipmentDiag=equipmentDiag, cardTestTime=cardTestTime, auditTable=auditTable, equipmentStateGroup=equipmentStateGroup, portMacIfIndex=portMacIfIndex, verboseLevel=verboseLevel, auditResult=auditResult, cadEquipmentMibConformance=cadEquipmentMibConformance, cmResetClearNotification=cmResetClearNotification, cardPrStateChange=cardPrStateChange, cardTestCommand=cardTestCommand, cardLastBootSource=cardLastBootSource, cmIpAddress=cmIpAddress, diskVolumeGroup=diskVolumeGroup, equipmentPortGroup=equipmentPortGroup, portTxFlowControlDetected=portTxFlowControlDetected, cardTable=cardTable, equipmentAuditGroup=equipmentAuditGroup, TestResult=TestResult, cardPicSerialNum=cardPicSerialNum, TestSchedule=TestSchedule, portTrapInh=portTrapInh, equipmentAudit=equipmentAudit, cardBootVersion=cardBootVersion, systemGeneral=systemGeneral, cardBusSpeed=cardBusSpeed, fpgaErrorEventGroup=fpgaErrorEventGroup, portRxFlowControlMode=portRxFlowControlMode, cadEquipmentMibGroup=cadEquipmentMibGroup, cardHwVersion=cardHwVersion, cardCarrierHwVersion=cardCarrierHwVersion, cardTrapInh=cardTrapInh, cardSpareGroupId=cardSpareGroupId, equipmentTraps=equipmentTraps, auditName=auditName, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, diskVolumeTrapInh=diskVolumeTrapInh, diskVolumeTable=diskVolumeTable, portMode=portMode, cardTemperature=cardTemperature, cardTestSchedule=cardTestSchedule, cmMacAddress=cmMacAddress, errEvRecoveryEnabled=errEvRecoveryEnabled, diskVolumeId=diskVolumeId, TestType=TestType, diskVolumeFileName=diskVolumeFileName, cardTestId=cardTestId, shelfNumber=shelfNumber, fpgaErrorEventEntry=fpgaErrorEventEntry, cardDplxStatus=cardDplxStatus, cardTestIndex=cardTestIndex, portSecStateChange=portSecStateChange, TestScheduleCommand=TestScheduleCommand, auditLogOutput=auditLogOutput, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portNumChans=portNumChans, cardLastChangeTime=cardLastChangeTime, equipmentError=equipmentError)
