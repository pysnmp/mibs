...
CardType, PortType, FlowControlMode, DiskVolumeUsageLevel, SecondaryState, EqActionType, ShelfId, DuplexStatus, PicType, AdminState, PortDetectedMode, UnknownState, PrimaryState, CardSubType, PortId, FirmwareSource, CardId, PortMode = mibBuilder.importSymbols("CADANT-TC", "CardType", "PortType", "FlowControlMode", "DiskVolumeUsageLevel", "SecondaryState", "EqActionType", "ShelfId", "DuplexStatus", "PicType", "AdminState", "PortDetectedMode", "UnknownState", "PrimaryState", "CardSubType", "PortId", "FirmwareSource", "CardId", "PortMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
TimeTicks, iso, NotificationType, Counter32, MibIdentifier, Gauge32, Bits, IpAddress, Unsigned32, Counter64, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "NotificationType", "Counter32", "MibIdentifier", "Gauge32", "Bits", "IpAddress", "Unsigned32", "Counter64", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
DateAndTime, MacAddress, RowStatus, TruthValue, TimeStamp, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "MacAddress", "RowStatus", "TruthValue", "TimeStamp", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardTestTransId=cardTestTransId, TestResult=TestResult, cardCpuSpeed=cardCpuSpeed, portTrapInh=portTrapInh, portId=portId, equipmentError=equipmentError, cardTemperatureHighError=cardTemperatureHighError, equipmentState=equipmentState, cardFpgaSource=cardFpgaSource, cardTestEntry=cardTestEntry, errEvLoggingEnabled=errEvLoggingEnabled, cardAction=cardAction, cardType=cardType, shelfNumber=shelfNumber, portCurrDsPower=portCurrDsPower, cmVendor=cmVendor, systemKey=systemKey, cmPrimarySID=cmPrimarySID, cardDetectedChange=cardDetectedChange, equipmentAuditGroup=equipmentAuditGroup, cardLastChangeTime=cardLastChangeTime, portShelfId=portShelfId, portTxFlowControlMode=portTxFlowControlMode, fpgaErrorEventTable=fpgaErrorEventTable, diskVolumeDriveId=diskVolumeDriveId, portDplxStatus=portDplxStatus, diskVolumeDiskSize=diskVolumeDiskSize, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, auditCommand=auditCommand, portMacAddress=portMacAddress, cardTestType=cardTestType, auditAutoScheduling=auditAutoScheduling, auditShelfId=auditShelfId, cardTempOverHeatNotification=cardTempOverHeatNotification, cardSwVersion=cardSwVersion, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, TestScheduleCommand=TestScheduleCommand, cardName=cardName, cardTable=cardTable, systemGeneral=systemGeneral, portMinDsPower=portMinDsPower, portDescription=portDescription, cmResetClearNotification=cmResetClearNotification, cardSerialNum=cardSerialNum, diskVolumeFileName=diskVolumeFileName, cardSecState=cardSecState, cardUpTime=cardUpTime, cadEquipmentMibCompliances=cadEquipmentMibCompliances, equipmentDiagGroup=equipmentDiagGroup, cardTestCommand=cardTestCommand, cardTestIndex=cardTestIndex, auditCycleCount=auditCycleCount, auditTable=auditTable, diskVolumeNumber=diskVolumeNumber, auditStatus=auditStatus, cardTestScheduleCommand=cardTestScheduleCommand, diskVolumeTrapInh=diskVolumeTrapInh, equipmentDiag=equipmentDiag, equipmentShelfGroup=equipmentShelfGroup, cardTestResult=cardTestResult, cadEquipmentMib=cadEquipmentMib, portTxFlowControlDetected=portTxFlowControlDetected, cardPicHwVersion=cardPicHwVersion, cmResetInfo=cmResetInfo, cardBusSpeed=cardBusSpeed, cardBootVersion=cardBootVersion, cardAdminState=cardAdminState, portNumber=portNumber, auditTotalPassedCount=auditTotalPassedCount, TestId=TestId, errEvRecoveryEnabled=errEvRecoveryEnabled, cardTestTime=cardTestTime, cardSubDetected=cardSubDetected, cmResetNotification=cmResetNotification, TestSchedule=TestSchedule, cardTestName=cardTestName, cardFlashSize=cardFlashSize, auditTotalFailedCount=auditTotalFailedCount, cardTemperature=cardTemperature, cadEquipmentMibGroup=cadEquipmentMibGroup, equipmentTbl=equipmentTbl, equipmentAudit=equipmentAudit, cardPicDetected=cardPicDetected, cardNumber=cardNumber, downstreamPowerLoss=downstreamPowerLoss, portLastChangeTime=portLastChangeTime, diskVolumeEntry=diskVolumeEntry, cardCarrierSerialNum=cardCarrierSerialNum, cardHwVersion=cardHwVersion, shelfSwVersion=shelfSwVersion, cardShelfTestIndex=cardShelfTestIndex, cardCarrierHwVersion=cardCarrierHwVersion, portCardId=portCardId, portPrState=portPrState, diskVolumeId=diskVolumeId, cardTestResultNotification=cardTestResultNotification, cmResetStatus=cmResetStatus, trapSeverity=trapSeverity, cardPicSerialNum=cardPicSerialNum, portRxFlowControlDetected=portRxFlowControlDetected, cmResetReason=cmResetReason, errEvRowStatus=errEvRowStatus, equipmentCardTestGroup=equipmentCardTestGroup, portRxFlowControlMode=portRxFlowControlMode, PYSNMP_MODULE_ID=cadEquipmentMib, cardSpareGroupMode=cardSpareGroupMode, portEntry=portEntry, cardLastBootVersion=cardLastBootVersion, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardNumPorts=cardNumPorts, equipmentStateGroup=equipmentStateGroup, equipmentCardGroup=equipmentCardGroup, cardLastResetReason=cardLastResetReason, cardEntry=cardEntry, portAdminState=portAdminState, trapCounter=trapCounter, consoleOutput=consoleOutput, cardCpuType=cardCpuType, portMaxDsPower=portMaxDsPower, portDocsIfIndex=portDocsIfIndex, diskDriveNumber=diskDriveNumber, cardFwVersion=cardFwVersion, errEventId=errEventId, cmMacAddress=cmMacAddress, auditPassedCount=auditPassedCount, fpgaErrorEventEntry=fpgaErrorEventEntry, diskVolumeGroup=diskVolumeGroup, cardPrStateChange=cardPrStateChange, cardTrapInh=cardTrapInh, cardSecStateChange=cardSecStateChange, auditEntry=auditEntry, portMode=portMode, cardFwUpdateStatus=cardFwUpdateStatus, cardTestDescription=cardTestDescription, systemGeneralGroup=systemGeneralGroup, equipmentPortGroup=equipmentPortGroup, diskVolumeSize=diskVolumeSize, shelfObjects=shelfObjects, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardPrState=cardPrState, cmUChannelID=cmUChannelID, portDetectedMode=portDetectedMode, cardTestSchedule=cardTestSchedule, cardDetected=cardDetected, cardTestResultDesc=cardTestResultDesc, cardCPLDVersion=cardCPLDVersion, cardTempNoReportNotification=cardTempNoReportNotification, portType=portType, cardId=cardId, systemClock=systemClock, portAction=portAction, cmRegistrationNotification=cmRegistrationNotification, cardLastBootSource=cardLastBootSource, cardSpareGroupId=cardSpareGroupId, auditLogThrottle=auditLogThrottle, eqDiagConfig=eqDiagConfig, TestType=TestType, auditFailedCount=auditFailedCount, portCardSubType=portCardSubType, remainInDiagMode=remainInDiagMode, portMacIfIndex=portMacIfIndex, cardDplxStatusChange=cardDplxStatusChange, auditName=auditName, diskVolumeTable=diskVolumeTable, diagTestId=diagTestId, TestCommand=TestCommand, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, equipmentTraps=equipmentTraps, portSecStateChange=portSecStateChange, cmDevice=cmDevice, auditResult=auditResult, cardDplxStatus=cardDplxStatus, auditTime=auditTime, shelfName=shelfName, cardSubType=cardSubType, diskVolumeName=diskVolumeName, cmResetUpTime=cmResetUpTime, fpgaErrorEventGroup=fpgaErrorEventGroup, cardTestId=cardTestId, cardTestTable=cardTestTable, diskVolumeShelfId=diskVolumeShelfId, auditLogOutput=auditLogOutput, cardRamSize=cardRamSize, portConnectorId=portConnectorId, auditCardId=auditCardId, portSecState=portSecState, verboseLevel=verboseLevel, TestTransactionId=TestTransactionId, cmIpAddress=cmIpAddress, portDplxStatusChange=portDplxStatusChange, auditDescription=auditDescription, cadEquipmentMibConformance=cadEquipmentMibConformance, portTable=portTable, cardShelfId=cardShelfId, cardCarrierFwVersion=cardCarrierFwVersion, portPrStateChange=portPrStateChange, errEvLogLevel=errEvLogLevel, portNumChans=portNumChans, diskVolumeCardId=diskVolumeCardId, portBgpId=portBgpId, auditId=auditId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardTemperatureHighWarn=cardTemperatureHighWarn, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeUsageLevel=diskVolumeUsageLevel)
