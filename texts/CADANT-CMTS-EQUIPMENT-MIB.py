...
PrimaryState, DuplexStatus, FlowControlMode, PortType, PortMode, CardType, UnknownState, ShelfId, CardId, CardSubType, DiskVolumeUsageLevel, FirmwareSource, PortDetectedMode, SecondaryState, PicType, AdminState, PortId, EqActionType = mibBuilder.importSymbols("CADANT-TC", "PrimaryState", "DuplexStatus", "FlowControlMode", "PortType", "PortMode", "CardType", "UnknownState", "ShelfId", "CardId", "CardSubType", "DiskVolumeUsageLevel", "FirmwareSource", "PortDetectedMode", "SecondaryState", "PicType", "AdminState", "PortId", "EqActionType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
Counter64, NotificationType, TimeTicks, Gauge32, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, Unsigned32, Integer32, Counter32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "TimeTicks", "Gauge32", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "Unsigned32", "Integer32", "Counter32", "ModuleIdentity", "MibIdentifier")
DisplayString, RowStatus, DateAndTime, TextualConvention, TimeStamp, TruthValue, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "DateAndTime", "TextualConvention", "TimeStamp", "TruthValue", "MacAddress")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", shelfSwVersion=shelfSwVersion, cmResetClearNotification=cmResetClearNotification, portType=portType, cardTestId=cardTestId, TestType=TestType, cardTestTransId=cardTestTransId, TestTransactionId=TestTransactionId, cardDplxStatus=cardDplxStatus, trapCounter=trapCounter, cardSecState=cardSecState, cardTable=cardTable, diskVolumeDiskSize=diskVolumeDiskSize, cardSecStateChange=cardSecStateChange, cardTestResult=cardTestResult, diskVolumeDriveId=diskVolumeDriveId, auditId=auditId, equipmentPortGroup=equipmentPortGroup, cardTestCommand=cardTestCommand, portCardId=portCardId, cadEquipmentMibConformance=cadEquipmentMibConformance, cardCarrierSerialNum=cardCarrierSerialNum, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardPicDetected=cardPicDetected, portNumber=portNumber, cardLastChangeTime=cardLastChangeTime, cardSpareGroupId=cardSpareGroupId, cardShelfId=cardShelfId, TestResult=TestResult, auditTotalFailedCount=auditTotalFailedCount, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portBgpId=portBgpId, equipmentState=equipmentState, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portTrapInh=portTrapInh, TestId=TestId, cardNumber=cardNumber, portMacIfIndex=portMacIfIndex, cardAdminState=cardAdminState, cmResetUpTime=cmResetUpTime, diskVolumeUsageLevel=diskVolumeUsageLevel, cardTestEntry=cardTestEntry, portAction=portAction, cardFwVersion=cardFwVersion, portMacAddress=portMacAddress, portAdminState=portAdminState, trapSeverity=trapSeverity, cardLastBootVersion=cardLastBootVersion, diskDriveNumber=diskDriveNumber, portShelfId=portShelfId, cardTestScheduleCommand=cardTestScheduleCommand, auditLogThrottle=auditLogThrottle, auditTotalPassedCount=auditTotalPassedCount, cmResetNotification=cmResetNotification, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cadEquipmentMibGroup=cadEquipmentMibGroup, equipmentStateGroup=equipmentStateGroup, cardTestTime=cardTestTime, auditStatus=auditStatus, cardSwVersion=cardSwVersion, cardTrapInh=cardTrapInh, cardSubDetected=cardSubDetected, equipmentAuditGroup=equipmentAuditGroup, portDetectedMode=portDetectedMode, cardFlashSize=cardFlashSize, equipmentTraps=equipmentTraps, TestScheduleCommand=TestScheduleCommand, cardName=cardName, portNumChans=portNumChans, auditLogOutput=auditLogOutput, auditShelfId=auditShelfId, auditResult=auditResult, errEventId=errEventId, PYSNMP_MODULE_ID=cadEquipmentMib, cardPrStateChange=cardPrStateChange, equipmentDiagGroup=equipmentDiagGroup, portDocsIfIndex=portDocsIfIndex, cardTemperatureHighError=cardTemperatureHighError, cardPicSerialNum=cardPicSerialNum, portDplxStatus=portDplxStatus, cardTestIndex=cardTestIndex, cardCarrierFwVersion=cardCarrierFwVersion, TestCommand=TestCommand, diskVolumeSize=diskVolumeSize, diskVolumeTable=diskVolumeTable, cardAction=cardAction, diskVolumeName=diskVolumeName, cmPrimarySID=cmPrimarySID, diskVolumeGroup=diskVolumeGroup, cardDetectedChange=cardDetectedChange, cardTestDescription=cardTestDescription, cardType=cardType, diskVolumeNumber=diskVolumeNumber, cardCpuType=cardCpuType, errEvRowStatus=errEvRowStatus, auditFailedCount=auditFailedCount, portMinDsPower=portMinDsPower, fpgaErrorEventEntry=fpgaErrorEventEntry, portRxFlowControlMode=portRxFlowControlMode, auditDescription=auditDescription, cardTestResultNotification=cardTestResultNotification, cardFpgaSource=cardFpgaSource, equipmentAudit=equipmentAudit, cardShelfTestIndex=cardShelfTestIndex, consoleOutput=consoleOutput, cmMacAddress=cmMacAddress, cmResetReason=cmResetReason, equipmentCardTestGroup=equipmentCardTestGroup, diskVolumeEntry=diskVolumeEntry, cardTestTable=cardTestTable, cmIpAddress=cmIpAddress, portSecStateChange=portSecStateChange, cardBusSpeed=cardBusSpeed, cmDevice=cmDevice, errEvLoggingEnabled=errEvLoggingEnabled, portSecState=portSecState, cardLastBootSource=cardLastBootSource, cmUChannelID=cmUChannelID, cardTempNoReportNotification=cardTempNoReportNotification, shelfName=shelfName, cmResetInfo=cmResetInfo, diskVolumeUsageNotification=diskVolumeUsageNotification, cardDetected=cardDetected, errEvLogLevel=errEvLogLevel, diskVolumeFileName=diskVolumeFileName, diagTestId=diagTestId, cardNumPorts=cardNumPorts, cardUpTime=cardUpTime, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditAutoScheduling=auditAutoScheduling, cardRamSize=cardRamSize, systemGeneralGroup=systemGeneralGroup, diskVolumeId=diskVolumeId, portPrState=portPrState, cmResetStatus=cmResetStatus, auditTime=auditTime, remainInDiagMode=remainInDiagMode, portMode=portMode, shelfNumber=shelfNumber, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, portCurrDsPower=portCurrDsPower, portCardSubType=portCardSubType, cardDplxStatusChange=cardDplxStatusChange, systemKey=systemKey, fpgaErrorEventTable=fpgaErrorEventTable, cardPrState=cardPrState, portTxFlowControlMode=portTxFlowControlMode, auditCycleCount=auditCycleCount, portRxFlowControlDetected=portRxFlowControlDetected, auditEntry=auditEntry, equipmentCardGroup=equipmentCardGroup, cardTestResultDesc=cardTestResultDesc, portConnectorId=portConnectorId, cardId=cardId, cardEntry=cardEntry, cardSpareGroupMode=cardSpareGroupMode, TestSchedule=TestSchedule, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, diskVolumeShelfId=diskVolumeShelfId, shelfObjects=shelfObjects, portLastChangeTime=portLastChangeTime, equipmentTbl=equipmentTbl, cardTemperature=cardTemperature, cardTemperatureHighWarn=cardTemperatureHighWarn, eqDiagConfig=eqDiagConfig, cardTestType=cardTestType, cmVendor=cmVendor, cmRegistrationNotification=cmRegistrationNotification, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cadEquipmentMib=cadEquipmentMib, fpgaErrorEventGroup=fpgaErrorEventGroup, cardTestSchedule=cardTestSchedule, cardPicHwVersion=cardPicHwVersion, cardTestName=cardTestName, portPrStateChange=portPrStateChange, cardFwUpdateStatus=cardFwUpdateStatus, diskVolumeCardId=diskVolumeCardId, equipmentDiag=equipmentDiag, diskVolumeTrapInh=diskVolumeTrapInh, portTable=portTable, cardCPLDVersion=cardCPLDVersion, auditPassedCount=auditPassedCount, cardBootVersion=cardBootVersion, portMaxDsPower=portMaxDsPower, cardTempOverHeatNotification=cardTempOverHeatNotification, portId=portId, cardSerialNum=cardSerialNum, portDplxStatusChange=portDplxStatusChange, auditName=auditName, verboseLevel=verboseLevel, cardLastResetReason=cardLastResetReason, portTxFlowControlDetected=portTxFlowControlDetected, equipmentShelfGroup=equipmentShelfGroup, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, systemClock=systemClock, cardCarrierHwVersion=cardCarrierHwVersion, auditCardId=auditCardId, downstreamPowerLoss=downstreamPowerLoss, equipmentError=equipmentError, auditTable=auditTable, cardHwVersion=cardHwVersion, cardCpuSpeed=cardCpuSpeed, systemGeneral=systemGeneral, errEvRecoveryEnabled=errEvRecoveryEnabled, auditCommand=auditCommand, portDescription=portDescription, portEntry=portEntry, cardSubType=cardSubType)
