...
PortMode, EqActionType, FirmwareSource, CardId, PicType, FlowControlMode, CardSubType, DuplexStatus, CardType, PortType, PortDetectedMode, PrimaryState, SecondaryState, UnknownState, ShelfId, AdminState, DiskVolumeUsageLevel, PortId = mibBuilder.importSymbols("CADANT-TC", "PortMode", "EqActionType", "FirmwareSource", "CardId", "PicType", "FlowControlMode", "CardSubType", "DuplexStatus", "CardType", "PortType", "PortDetectedMode", "PrimaryState", "SecondaryState", "UnknownState", "ShelfId", "AdminState", "DiskVolumeUsageLevel", "PortId")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, ModuleIdentity, TimeTicks, ObjectIdentity, NotificationType, Counter32, Unsigned32, Gauge32, Bits, MibIdentifier, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "NotificationType", "Counter32", "Unsigned32", "Gauge32", "Bits", "MibIdentifier", "IpAddress", "iso")
MacAddress, TextualConvention, TimeStamp, RowStatus, DisplayString, TruthValue, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TextualConvention", "TimeStamp", "RowStatus", "DisplayString", "TruthValue", "DateAndTime")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", errEvLogLevel=errEvLogLevel, cardRamSize=cardRamSize, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardSwVersion=cardSwVersion, cardPicSerialNum=cardPicSerialNum, auditTable=auditTable, auditId=auditId, shelfNumber=shelfNumber, portMacAddress=portMacAddress, equipmentError=equipmentError, cardCpuSpeed=cardCpuSpeed, equipmentCardGroup=equipmentCardGroup, cardTestEntry=cardTestEntry, portMaxDsPower=portMaxDsPower, auditEntry=auditEntry, errEvRowStatus=errEvRowStatus, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, consoleOutput=consoleOutput, PYSNMP_MODULE_ID=cadEquipmentMib, auditStatus=auditStatus, cardFwVersion=cardFwVersion, cardTestDescription=cardTestDescription, errEventId=errEventId, cardShelfTestIndex=cardShelfTestIndex, verboseLevel=verboseLevel, diskVolumeId=diskVolumeId, cardNumber=cardNumber, cardTable=cardTable, cardTemperatureHighError=cardTemperatureHighError, equipmentTraps=equipmentTraps, TestResult=TestResult, cardEntry=cardEntry, cardAction=cardAction, cardCarrierFwVersion=cardCarrierFwVersion, equipmentDiag=equipmentDiag, auditLogThrottle=auditLogThrottle, auditCardId=auditCardId, diskVolumeNumber=diskVolumeNumber, TestType=TestType, auditLogOutput=auditLogOutput, diskVolumeFileName=diskVolumeFileName, auditTime=auditTime, cardNumPorts=cardNumPorts, portPrState=portPrState, diskVolumeUsageLevel=diskVolumeUsageLevel, cardTestIndex=cardTestIndex, cardTestResult=cardTestResult, cmRegistrationNotification=cmRegistrationNotification, portId=portId, portTrapInh=portTrapInh, equipmentStateGroup=equipmentStateGroup, diskVolumeDiskSize=diskVolumeDiskSize, systemGeneralGroup=systemGeneralGroup, diskVolumeShelfId=diskVolumeShelfId, cardPicHwVersion=cardPicHwVersion, TestSchedule=TestSchedule, auditDescription=auditDescription, fpgaErrorEventEntry=fpgaErrorEventEntry, equipmentAuditGroup=equipmentAuditGroup, cmResetUpTime=cmResetUpTime, equipmentPortGroup=equipmentPortGroup, cmPrimarySID=cmPrimarySID, systemClock=systemClock, errEvLoggingEnabled=errEvLoggingEnabled, cardBusSpeed=cardBusSpeed, diskVolumeDriveId=diskVolumeDriveId, portMode=portMode, cardDetected=cardDetected, systemGeneral=systemGeneral, portNumber=portNumber, portPrStateChange=portPrStateChange, errEvRecoveryEnabled=errEvRecoveryEnabled, cardPrStateChange=cardPrStateChange, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardTestCommand=cardTestCommand, shelfObjects=shelfObjects, cardTempNoReportNotification=cardTempNoReportNotification, cadEquipmentMibGroup=cadEquipmentMibGroup, cardTestSchedule=cardTestSchedule, cardHwVersion=cardHwVersion, diskVolumeTrapInh=diskVolumeTrapInh, portCurrDsPower=portCurrDsPower, cardLastChangeTime=cardLastChangeTime, portMinDsPower=portMinDsPower, portTable=portTable, equipmentAudit=equipmentAudit, diskDriveNumber=diskDriveNumber, cardSpareGroupMode=cardSpareGroupMode, equipmentTbl=equipmentTbl, portDetectedMode=portDetectedMode, equipmentDiagGroup=equipmentDiagGroup, cmVendor=cmVendor, cardFwUpdateStatus=cardFwUpdateStatus, cardTrapInh=cardTrapInh, TestTransactionId=TestTransactionId, cardTestResultDesc=cardTestResultDesc, cardDplxStatusChange=cardDplxStatusChange, portShelfId=portShelfId, cardSubDetected=cardSubDetected, cardId=cardId, auditPassedCount=auditPassedCount, diskVolumeUsageNotification=diskVolumeUsageNotification, fpgaErrorEventGroup=fpgaErrorEventGroup, TestScheduleCommand=TestScheduleCommand, cardSpareGroupId=cardSpareGroupId, auditCommand=auditCommand, portDplxStatus=portDplxStatus, cmResetInfo=cmResetInfo, fpgaErrorEventTable=fpgaErrorEventTable, shelfName=shelfName, cardSerialNum=cardSerialNum, cardDetectedChange=cardDetectedChange, diagTestId=diagTestId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardAdminState=cardAdminState, auditCycleCount=auditCycleCount, cardTempOverHeatNotification=cardTempOverHeatNotification, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardTestTable=cardTestTable, portDocsIfIndex=portDocsIfIndex, portDescription=portDescription, auditAutoScheduling=auditAutoScheduling, cmDevice=cmDevice, cardTemperature=cardTemperature, cardCPLDVersion=cardCPLDVersion, portType=portType, portTxFlowControlDetected=portTxFlowControlDetected, cardTestTime=cardTestTime, equipmentState=equipmentState, cmResetStatus=cmResetStatus, diskVolumeCardId=diskVolumeCardId, auditTotalFailedCount=auditTotalFailedCount, cardFlashSize=cardFlashSize, cardTestName=cardTestName, trapCounter=trapCounter, cardCarrierHwVersion=cardCarrierHwVersion, cardName=cardName, portRxFlowControlMode=portRxFlowControlMode, cmResetNotification=cmResetNotification, cmResetClearNotification=cmResetClearNotification, diskVolumeSize=diskVolumeSize, cardType=cardType, cardCpuType=cardCpuType, portMacIfIndex=portMacIfIndex, portAdminState=portAdminState, equipmentShelfGroup=equipmentShelfGroup, portNumChans=portNumChans, TestId=TestId, cardTestTransId=cardTestTransId, portCardSubType=portCardSubType, auditResult=auditResult, diskVolumeName=diskVolumeName, portConnectorId=portConnectorId, cmResetReason=cmResetReason, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, TestCommand=TestCommand, diskVolumeTable=diskVolumeTable, cmIpAddress=cmIpAddress, portTxFlowControlMode=portTxFlowControlMode, auditName=auditName, cadEquipmentMibConformance=cadEquipmentMibConformance, downstreamPowerLoss=downstreamPowerLoss, cardUpTime=cardUpTime, portRxFlowControlDetected=portRxFlowControlDetected, cardTestType=cardTestType, portBgpId=portBgpId, cardTestId=cardTestId, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portLastChangeTime=portLastChangeTime, cardPrState=cardPrState, portEntry=portEntry, cmUChannelID=cmUChannelID, portCardId=portCardId, systemKey=systemKey, auditShelfId=auditShelfId, cardPicDetected=cardPicDetected, cardTestScheduleCommand=cardTestScheduleCommand, cadEquipmentMib=cadEquipmentMib, auditFailedCount=auditFailedCount, cardBootVersion=cardBootVersion, portSecStateChange=portSecStateChange, portSecState=portSecState, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardDplxStatus=cardDplxStatus, eqDiagConfig=eqDiagConfig, cardCarrierSerialNum=cardCarrierSerialNum, cardLastBootVersion=cardLastBootVersion, cardFpgaSource=cardFpgaSource, cardSecStateChange=cardSecStateChange, equipmentCardTestGroup=equipmentCardTestGroup, cardLastBootSource=cardLastBootSource, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cmMacAddress=cmMacAddress, diskVolumeGroup=diskVolumeGroup, portAction=portAction, cardSubType=cardSubType, diskVolumeEntry=diskVolumeEntry, cardSecState=cardSecState, cardLastResetReason=cardLastResetReason, cardTemperatureHighWarn=cardTemperatureHighWarn, cardShelfId=cardShelfId, auditTotalPassedCount=auditTotalPassedCount, trapSeverity=trapSeverity, shelfSwVersion=shelfSwVersion, cardTestResultNotification=cardTestResultNotification, remainInDiagMode=remainInDiagMode, portDplxStatusChange=portDplxStatusChange)
