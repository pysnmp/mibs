...
DiskVolumeUsageLevel, FirmwareSource, PortMode, CardId, PortType, PortId, ShelfId, PortDetectedMode, AdminState, UnknownState, CardType, FlowControlMode, PicType, PrimaryState, SecondaryState, EqActionType, CardSubType, DuplexStatus = mibBuilder.importSymbols("CADANT-TC", "DiskVolumeUsageLevel", "FirmwareSource", "PortMode", "CardId", "PortType", "PortId", "ShelfId", "PortDetectedMode", "AdminState", "UnknownState", "CardType", "FlowControlMode", "PicType", "PrimaryState", "SecondaryState", "EqActionType", "CardSubType", "DuplexStatus")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
Counter32, iso, Bits, IpAddress, ObjectIdentity, Counter64, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, NotificationType, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "Bits", "IpAddress", "ObjectIdentity", "Counter64", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "NotificationType", "MibIdentifier", "Gauge32")
DateAndTime, TimeStamp, MacAddress, DisplayString, RowStatus, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TimeStamp", "MacAddress", "DisplayString", "RowStatus", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cmDevice=cmDevice, portAction=portAction, equipmentStateGroup=equipmentStateGroup, diskVolumeDriveId=diskVolumeDriveId, diskVolumeShelfId=diskVolumeShelfId, cardDetectedChange=cardDetectedChange, auditLogOutput=auditLogOutput, portPrState=portPrState, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardBootVersion=cardBootVersion, eqDiagConfig=eqDiagConfig, cardFwVersion=cardFwVersion, cardDplxStatusChange=cardDplxStatusChange, auditFailedCount=auditFailedCount, cardLastBootSource=cardLastBootSource, auditDescription=auditDescription, cardName=cardName, diagTestId=diagTestId, systemKey=systemKey, cardPicHwVersion=cardPicHwVersion, trapCounter=trapCounter, consoleOutput=consoleOutput, errEvLogLevel=errEvLogLevel, portTrapInh=portTrapInh, TestType=TestType, diskVolumeTrapInh=diskVolumeTrapInh, cardTestType=cardTestType, cardShelfId=cardShelfId, shelfName=shelfName, diskVolumeNumber=diskVolumeNumber, equipmentCardTestGroup=equipmentCardTestGroup, equipmentState=equipmentState, cardSpareGroupId=cardSpareGroupId, cmVendor=cmVendor, cardTempOverHeatNotification=cardTempOverHeatNotification, portPrStateChange=portPrStateChange, fpgaErrorEventGroup=fpgaErrorEventGroup, equipmentTbl=equipmentTbl, cmResetInfo=cmResetInfo, equipmentTraps=equipmentTraps, portTxFlowControlDetected=portTxFlowControlDetected, cardTestScheduleCommand=cardTestScheduleCommand, portDetectedMode=portDetectedMode, cardTestResultDesc=cardTestResultDesc, TestId=TestId, TestScheduleCommand=TestScheduleCommand, cardAction=cardAction, equipmentAudit=equipmentAudit, cadEquipmentMibCompliances=cadEquipmentMibCompliances, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, systemGeneralGroup=systemGeneralGroup, auditCardId=auditCardId, cardPrState=cardPrState, auditTable=auditTable, cardAdminState=cardAdminState, shelfObjects=shelfObjects, portBgpId=portBgpId, diskVolumeTable=diskVolumeTable, cardFlashSize=cardFlashSize, cardTestDescription=cardTestDescription, TestTransactionId=TestTransactionId, diskVolumeName=diskVolumeName, shelfSwVersion=shelfSwVersion, portCardSubType=portCardSubType, TestResult=TestResult, cmResetClearNotification=cmResetClearNotification, systemClock=systemClock, portAdminState=portAdminState, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portType=portType, equipmentError=equipmentError, diskVolumeDiskSize=diskVolumeDiskSize, portLastChangeTime=portLastChangeTime, cadEquipmentMib=cadEquipmentMib, diskDriveNumber=diskDriveNumber, cardUpTime=cardUpTime, cardPicDetected=cardPicDetected, auditName=auditName, cardCpuSpeed=cardCpuSpeed, auditTotalFailedCount=auditTotalFailedCount, cmMacAddress=cmMacAddress, portEntry=portEntry, cardTestId=cardTestId, diskVolumeFileName=diskVolumeFileName, shelfNumber=shelfNumber, auditLogThrottle=auditLogThrottle, PYSNMP_MODULE_ID=cadEquipmentMib, cardCarrierSerialNum=cardCarrierSerialNum, portTable=portTable, portCurrDsPower=portCurrDsPower, auditPassedCount=auditPassedCount, portMinDsPower=portMinDsPower, cardSpareGroupMode=cardSpareGroupMode, cardHwVersion=cardHwVersion, portMacAddress=portMacAddress, verboseLevel=verboseLevel, portSecStateChange=portSecStateChange, downstreamPowerLoss=downstreamPowerLoss, cardDetected=cardDetected, diskVolumeGroup=diskVolumeGroup, portMode=portMode, cardCpuType=cardCpuType, auditEntry=auditEntry, cardTable=cardTable, cardEntry=cardEntry, cardRamSize=cardRamSize, portNumChans=portNumChans, portId=portId, equipmentDiag=equipmentDiag, auditTotalPassedCount=auditTotalPassedCount, errEvRowStatus=errEvRowStatus, cardSecStateChange=cardSecStateChange, portDplxStatusChange=portDplxStatusChange, auditAutoScheduling=auditAutoScheduling, cardTestTransId=cardTestTransId, cardTestCommand=cardTestCommand, diskVolumeId=diskVolumeId, cardTrapInh=cardTrapInh, auditCycleCount=auditCycleCount, cmIpAddress=cmIpAddress, cardSubType=cardSubType, portConnectorId=portConnectorId, portDplxStatus=portDplxStatus, equipmentPortGroup=equipmentPortGroup, equipmentAuditGroup=equipmentAuditGroup, portRxFlowControlMode=portRxFlowControlMode, portMaxDsPower=portMaxDsPower, portDescription=portDescription, cardLastChangeTime=cardLastChangeTime, errEvRecoveryEnabled=errEvRecoveryEnabled, cardSwVersion=cardSwVersion, portShelfId=portShelfId, cardTestEntry=cardTestEntry, cardTestTable=cardTestTable, portCardId=portCardId, cardSerialNum=cardSerialNum, cardTestSchedule=cardTestSchedule, auditStatus=auditStatus, cardTestResultNotification=cardTestResultNotification, portDocsIfIndex=portDocsIfIndex, fpgaErrorEventEntry=fpgaErrorEventEntry, systemGeneral=systemGeneral, equipmentShelfGroup=equipmentShelfGroup, cardTemperature=cardTemperature, cardCarrierFwVersion=cardCarrierFwVersion, portMacIfIndex=portMacIfIndex, equipmentCardGroup=equipmentCardGroup, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardTemperatureHighWarn=cardTemperatureHighWarn, cardFpgaSource=cardFpgaSource, cmPrimarySID=cmPrimarySID, diskVolumeEntry=diskVolumeEntry, errEventId=errEventId, cmRegistrationNotification=cmRegistrationNotification, cmResetUpTime=cmResetUpTime, cardTestTime=cardTestTime, cardPrStateChange=cardPrStateChange, cardLastResetReason=cardLastResetReason, cardTestIndex=cardTestIndex, auditCommand=auditCommand, cardLastBootVersion=cardLastBootVersion, cardCPLDVersion=cardCPLDVersion, cardTestName=cardTestName, cardTemperatureHighError=cardTemperatureHighError, auditId=auditId, trapSeverity=trapSeverity, diskVolumeSize=diskVolumeSize, cadEquipmentMibGroup=cadEquipmentMibGroup, equipmentDiagGroup=equipmentDiagGroup, cardNumber=cardNumber, auditTime=auditTime, portNumber=portNumber, cardSubDetected=cardSubDetected, cardSecState=cardSecState, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, auditShelfId=auditShelfId, cmResetStatus=cmResetStatus, cadEquipmentMibConformance=cadEquipmentMibConformance, cardType=cardType, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardShelfTestIndex=cardShelfTestIndex, auditResult=auditResult, portTxFlowControlMode=portTxFlowControlMode, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portSecState=portSecState, diskVolumeCardId=diskVolumeCardId, cardTestResult=cardTestResult, fpgaErrorEventTable=fpgaErrorEventTable, cmResetNotification=cmResetNotification, cardId=cardId, cmResetReason=cmResetReason, cardBusSpeed=cardBusSpeed, remainInDiagMode=remainInDiagMode, cardNumPorts=cardNumPorts, TestCommand=TestCommand, diskVolumeUsageLevel=diskVolumeUsageLevel, cardFwUpdateStatus=cardFwUpdateStatus, cardPicSerialNum=cardPicSerialNum, cmUChannelID=cmUChannelID, cardTempNoReportNotification=cardTempNoReportNotification, TestSchedule=TestSchedule, cardCarrierHwVersion=cardCarrierHwVersion, cardDplxStatus=cardDplxStatus, errEvLoggingEnabled=errEvLoggingEnabled)
