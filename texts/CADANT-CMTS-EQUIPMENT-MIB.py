...
AdminState, DiskVolumeUsageLevel, CardType, FlowControlMode, PortMode, SecondaryState, DuplexStatus, CardSubType, PrimaryState, UnknownState, PicType, CardId, PortType, ShelfId, EqActionType, PortDetectedMode, PortId, FirmwareSource = mibBuilder.importSymbols("CADANT-TC", "AdminState", "DiskVolumeUsageLevel", "CardType", "FlowControlMode", "PortMode", "SecondaryState", "DuplexStatus", "CardSubType", "PrimaryState", "UnknownState", "PicType", "CardId", "PortType", "ShelfId", "EqActionType", "PortDetectedMode", "PortId", "FirmwareSource")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, MibIdentifier, Counter32, IpAddress, iso, Gauge32, ObjectIdentity, Integer32, ModuleIdentity, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "MibIdentifier", "Counter32", "IpAddress", "iso", "Gauge32", "ObjectIdentity", "Integer32", "ModuleIdentity", "TimeTicks", "Unsigned32")
TextualConvention, DateAndTime, TruthValue, TimeStamp, RowStatus, MacAddress, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DateAndTime", "TruthValue", "TimeStamp", "RowStatus", "MacAddress", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", TestType=TestType, cmResetStatus=cmResetStatus, cardTemperature=cardTemperature, portDplxStatusChange=portDplxStatusChange, portSecState=portSecState, systemGeneral=systemGeneral, cardAdminState=cardAdminState, cardTemperatureHighError=cardTemperatureHighError, cardTestDescription=cardTestDescription, cardPicSerialNum=cardPicSerialNum, cmMacAddress=cmMacAddress, cardTestIndex=cardTestIndex, errEvRecoveryEnabled=errEvRecoveryEnabled, cardName=cardName, cardTestResultDesc=cardTestResultDesc, auditCardId=auditCardId, portMacAddress=portMacAddress, systemKey=systemKey, diskVolumeCardId=diskVolumeCardId, cardSwVersion=cardSwVersion, equipmentAuditGroup=equipmentAuditGroup, TestResult=TestResult, portDocsIfIndex=portDocsIfIndex, cardFlashSize=cardFlashSize, portMinDsPower=portMinDsPower, auditLogOutput=auditLogOutput, diskVolumeDriveId=diskVolumeDriveId, diskVolumeShelfId=diskVolumeShelfId, cmUChannelID=cmUChannelID, TestSchedule=TestSchedule, cardCPLDVersion=cardCPLDVersion, cardCpuSpeed=cardCpuSpeed, cmResetClearNotification=cmResetClearNotification, portMacIfIndex=portMacIfIndex, cadEquipmentMibCompliances=cadEquipmentMibCompliances, equipmentPortGroup=equipmentPortGroup, portTxFlowControlDetected=portTxFlowControlDetected, equipmentTbl=equipmentTbl, portLastChangeTime=portLastChangeTime, cardEntry=cardEntry, cardPicHwVersion=cardPicHwVersion, shelfSwVersion=shelfSwVersion, diskVolumeDiskSize=diskVolumeDiskSize, cardShelfTestIndex=cardShelfTestIndex, fpgaErrorEventTable=fpgaErrorEventTable, auditEntry=auditEntry, equipmentStateGroup=equipmentStateGroup, auditCommand=auditCommand, cardTempNoReportNotification=cardTempNoReportNotification, portId=portId, cardTable=cardTable, systemClock=systemClock, portMaxDsPower=portMaxDsPower, auditTotalFailedCount=auditTotalFailedCount, portBgpId=portBgpId, cmResetReason=cmResetReason, auditTotalPassedCount=auditTotalPassedCount, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeId=diskVolumeId, cardTestTransId=cardTestTransId, cardUpTime=cardUpTime, cardTestEntry=cardTestEntry, cardSecStateChange=cardSecStateChange, cardNumPorts=cardNumPorts, auditCycleCount=auditCycleCount, fpgaErrorEventEntry=fpgaErrorEventEntry, equipmentError=equipmentError, auditTable=auditTable, diskVolumeNumber=diskVolumeNumber, cardSerialNum=cardSerialNum, cardTestType=cardTestType, TestTransactionId=TestTransactionId, portShelfId=portShelfId, cardTestCommand=cardTestCommand, portCardId=portCardId, diagTestId=diagTestId, cardDetected=cardDetected, cmDevice=cmDevice, TestScheduleCommand=TestScheduleCommand, fpgaErrorEventGroup=fpgaErrorEventGroup, diskVolumeEntry=diskVolumeEntry, cadEquipmentMib=cadEquipmentMib, consoleOutput=consoleOutput, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeName=diskVolumeName, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTestTime=cardTestTime, equipmentState=equipmentState, equipmentCardTestGroup=equipmentCardTestGroup, portDetectedMode=portDetectedMode, verboseLevel=verboseLevel, cardSubType=cardSubType, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardCpuType=cardCpuType, cardDetectedChange=cardDetectedChange, equipmentAudit=equipmentAudit, cardAction=cardAction, downstreamPowerLoss=downstreamPowerLoss, auditTime=auditTime, shelfNumber=shelfNumber, cardTempOverHeatNotification=cardTempOverHeatNotification, diskDriveNumber=diskDriveNumber, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portNumber=portNumber, TestCommand=TestCommand, cardTestResult=cardTestResult, portAction=portAction, cardFwUpdateStatus=cardFwUpdateStatus, portTxFlowControlMode=portTxFlowControlMode, cardSecState=cardSecState, portPrState=portPrState, cardTestName=cardTestName, diskVolumeGroup=diskVolumeGroup, portTrapInh=portTrapInh, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, errEvRowStatus=errEvRowStatus, cardCarrierFwVersion=cardCarrierFwVersion, cardDplxStatusChange=cardDplxStatusChange, cardTemperatureHighWarn=cardTemperatureHighWarn, cardNumber=cardNumber, auditShelfId=auditShelfId, auditFailedCount=auditFailedCount, cardTestId=cardTestId, errEvLoggingEnabled=errEvLoggingEnabled, cmResetNotification=cmResetNotification, auditId=auditId, cardCarrierSerialNum=cardCarrierSerialNum, diskVolumeTrapInh=diskVolumeTrapInh, portRxFlowControlDetected=portRxFlowControlDetected, portNumChans=portNumChans, auditLogThrottle=auditLogThrottle, trapSeverity=trapSeverity, cardFpgaSource=cardFpgaSource, equipmentCardGroup=equipmentCardGroup, cardPrStateChange=cardPrStateChange, cardRamSize=cardRamSize, cmVendor=cmVendor, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, eqDiagConfig=eqDiagConfig, cardSpareGroupId=cardSpareGroupId, cardSpareGroupMode=cardSpareGroupMode, cmResetInfo=cmResetInfo, equipmentShelfGroup=equipmentShelfGroup, auditAutoScheduling=auditAutoScheduling, portCurrDsPower=portCurrDsPower, auditStatus=auditStatus, PYSNMP_MODULE_ID=cadEquipmentMib, cardTrapInh=cardTrapInh, systemGeneralGroup=systemGeneralGroup, cardTestScheduleCommand=cardTestScheduleCommand, diskVolumeUsageNotification=diskVolumeUsageNotification, portCardSubType=portCardSubType, shelfObjects=shelfObjects, cardLastBootVersion=cardLastBootVersion, portRxFlowControlMode=portRxFlowControlMode, errEventId=errEventId, portPrStateChange=portPrStateChange, portDescription=portDescription, cardTestSchedule=cardTestSchedule, cardDplxStatus=cardDplxStatus, portType=portType, auditResult=auditResult, cadEquipmentMibGroup=cadEquipmentMibGroup, cardBusSpeed=cardBusSpeed, trapCounter=trapCounter, cmRegistrationNotification=cmRegistrationNotification, cardPicDetected=cardPicDetected, portTable=portTable, portConnectorId=portConnectorId, cardSubDetected=cardSubDetected, cardLastBootSource=cardLastBootSource, cardTestResultNotification=cardTestResultNotification, remainInDiagMode=remainInDiagMode, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cmIpAddress=cmIpAddress, cardShelfId=cardShelfId, errEvLogLevel=errEvLogLevel, auditName=auditName, equipmentDiag=equipmentDiag, cardTestTable=cardTestTable, cmPrimarySID=cmPrimarySID, cardHwVersion=cardHwVersion, TestId=TestId, portMode=portMode, equipmentDiagGroup=equipmentDiagGroup, cardPrState=cardPrState, portDplxStatus=portDplxStatus, diskVolumeTable=diskVolumeTable, diskVolumeUsageLevel=diskVolumeUsageLevel, portAdminState=portAdminState, cmResetUpTime=cmResetUpTime, diskVolumeFileName=diskVolumeFileName, cardBootVersion=cardBootVersion, portEntry=portEntry, shelfName=shelfName, cadEquipmentMibConformance=cadEquipmentMibConformance, cardType=cardType, cardLastResetReason=cardLastResetReason, auditDescription=auditDescription, portSecStateChange=portSecStateChange, cardId=cardId, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditPassedCount=auditPassedCount, cardLastChangeTime=cardLastChangeTime, diskVolumeSize=diskVolumeSize, equipmentTraps=equipmentTraps, cardFwVersion=cardFwVersion)
