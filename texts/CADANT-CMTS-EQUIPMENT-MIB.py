...
DiskVolumeUsageLevel, SecondaryState, FlowControlMode, AdminState, PicType, DuplexStatus, PortMode, PortType, PortId, ShelfId, PrimaryState, CardId, EqActionType, FirmwareSource, UnknownState, CardType, PortDetectedMode, CardSubType = mibBuilder.importSymbols("CADANT-TC", "DiskVolumeUsageLevel", "SecondaryState", "FlowControlMode", "AdminState", "PicType", "DuplexStatus", "PortMode", "PortType", "PortId", "ShelfId", "PrimaryState", "CardId", "EqActionType", "FirmwareSource", "UnknownState", "CardType", "PortDetectedMode", "CardSubType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
ObjectIdentity, TimeTicks, iso, Unsigned32, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, MibIdentifier, Bits, NotificationType, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "iso", "Unsigned32", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "MibIdentifier", "Bits", "NotificationType", "Counter32", "Gauge32")
TruthValue, TextualConvention, DateAndTime, RowStatus, DisplayString, MacAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "DateAndTime", "RowStatus", "DisplayString", "MacAddress", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardCarrierHwVersion=cardCarrierHwVersion, cmIpAddress=cmIpAddress, cardCarrierFwVersion=cardCarrierFwVersion, equipmentState=equipmentState, cardFlashSize=cardFlashSize, equipmentCardTestGroup=equipmentCardTestGroup, cardSecStateChange=cardSecStateChange, shelfName=shelfName, portPrState=portPrState, cmVendor=cmVendor, fpgaErrorEventGroup=fpgaErrorEventGroup, cmResetClearNotification=cmResetClearNotification, portSecStateChange=portSecStateChange, cardSerialNum=cardSerialNum, remainInDiagMode=remainInDiagMode, errEvLogLevel=errEvLogLevel, consoleOutput=consoleOutput, cmDevice=cmDevice, fpgaErrorEventTable=fpgaErrorEventTable, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portNumber=portNumber, diskVolumeUsageLevel=diskVolumeUsageLevel, equipmentAuditGroup=equipmentAuditGroup, portSecState=portSecState, cardNumPorts=cardNumPorts, cardPicSerialNum=cardPicSerialNum, portMacAddress=portMacAddress, auditTime=auditTime, cardDplxStatusChange=cardDplxStatusChange, systemGeneralGroup=systemGeneralGroup, TestResult=TestResult, portDplxStatusChange=portDplxStatusChange, cardTable=cardTable, cardDetected=cardDetected, cardFwVersion=cardFwVersion, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cadEquipmentMibGroup=cadEquipmentMibGroup, portTrapInh=portTrapInh, portNumChans=portNumChans, equipmentAudit=equipmentAudit, auditFailedCount=auditFailedCount, equipmentPortGroup=equipmentPortGroup, portRxFlowControlDetected=portRxFlowControlDetected, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, equipmentTbl=equipmentTbl, cardSubType=cardSubType, diskVolumeEntry=diskVolumeEntry, cardName=cardName, cardFpgaSource=cardFpgaSource, cmResetNotification=cmResetNotification, portMode=portMode, cardBusSpeed=cardBusSpeed, PYSNMP_MODULE_ID=cadEquipmentMib, portMacIfIndex=portMacIfIndex, cadEquipmentMibConformance=cadEquipmentMibConformance, cardPrStateChange=cardPrStateChange, cardEntry=cardEntry, portTxFlowControlMode=portTxFlowControlMode, auditName=auditName, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardLastResetReason=cardLastResetReason, cardDplxStatus=cardDplxStatus, cardSpareGroupMode=cardSpareGroupMode, cardShelfId=cardShelfId, cardTestTime=cardTestTime, TestScheduleCommand=TestScheduleCommand, equipmentShelfGroup=equipmentShelfGroup, shelfSwVersion=shelfSwVersion, cardTestId=cardTestId, auditId=auditId, cadEquipmentMib=cadEquipmentMib, equipmentDiag=equipmentDiag, trapCounter=trapCounter, cardSwVersion=cardSwVersion, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardBootVersion=cardBootVersion, cardTemperature=cardTemperature, errEvRecoveryEnabled=errEvRecoveryEnabled, cardTestTransId=cardTestTransId, errEvLoggingEnabled=errEvLoggingEnabled, auditPassedCount=auditPassedCount, cardTempOverHeatNotification=cardTempOverHeatNotification, cardTemperatureHighWarn=cardTemperatureHighWarn, diskVolumeFileName=diskVolumeFileName, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditResult=auditResult, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditDescription=auditDescription, cmResetReason=cmResetReason, portCurrDsPower=portCurrDsPower, auditTable=auditTable, cardDetectedChange=cardDetectedChange, cardAction=cardAction, cardLastBootVersion=cardLastBootVersion, cmRegistrationNotification=cmRegistrationNotification, auditTotalFailedCount=auditTotalFailedCount, TestType=TestType, cardCPLDVersion=cardCPLDVersion, diskVolumeShelfId=diskVolumeShelfId, portDescription=portDescription, cardPicHwVersion=cardPicHwVersion, cardUpTime=cardUpTime, diskVolumeName=diskVolumeName, auditStatus=auditStatus, cardFwUpdateStatus=cardFwUpdateStatus, cardId=cardId, portCardSubType=portCardSubType, diskVolumeCardId=diskVolumeCardId, auditCardId=auditCardId, portTxFlowControlDetected=portTxFlowControlDetected, cmResetInfo=cmResetInfo, portCardId=portCardId, cardTestType=cardTestType, portId=portId, diskVolumeSize=diskVolumeSize, portDetectedMode=portDetectedMode, portRxFlowControlMode=portRxFlowControlMode, cmResetStatus=cmResetStatus, cardPrState=cardPrState, diskVolumeTrapInh=diskVolumeTrapInh, cardTestSchedule=cardTestSchedule, systemKey=systemKey, equipmentDiagGroup=equipmentDiagGroup, cardTestResult=cardTestResult, diskVolumeGroup=diskVolumeGroup, cardAdminState=cardAdminState, portAction=portAction, cardTestResultDesc=cardTestResultDesc, portShelfId=portShelfId, fpgaErrorEventEntry=fpgaErrorEventEntry, diskVolumeUsageNotification=diskVolumeUsageNotification, cardShelfTestIndex=cardShelfTestIndex, cmUChannelID=cmUChannelID, cardTempNoReportNotification=cardTempNoReportNotification, errEvRowStatus=errEvRowStatus, portLastChangeTime=portLastChangeTime, TestCommand=TestCommand, auditLogThrottle=auditLogThrottle, portDplxStatus=portDplxStatus, portAdminState=portAdminState, TestSchedule=TestSchedule, eqDiagConfig=eqDiagConfig, systemGeneral=systemGeneral, cardLastBootSource=cardLastBootSource, verboseLevel=verboseLevel, cardPicDetected=cardPicDetected, diskVolumeTable=diskVolumeTable, cardSubDetected=cardSubDetected, equipmentError=equipmentError, cardTestScheduleCommand=cardTestScheduleCommand, errEventId=errEventId, cardSecState=cardSecState, cardSpareGroupId=cardSpareGroupId, portType=portType, portBgpId=portBgpId, cardTestIndex=cardTestIndex, diskVolumeDiskSize=diskVolumeDiskSize, auditShelfId=auditShelfId, portTable=portTable, TestId=TestId, diagTestId=diagTestId, cardType=cardType, portPrStateChange=portPrStateChange, portDocsIfIndex=portDocsIfIndex, cardCpuSpeed=cardCpuSpeed, cardTestDescription=cardTestDescription, portConnectorId=portConnectorId, auditTotalPassedCount=auditTotalPassedCount, shelfNumber=shelfNumber, equipmentTraps=equipmentTraps, cardNumber=cardNumber, diskVolumeNumber=diskVolumeNumber, cardTestCommand=cardTestCommand, cmMacAddress=cmMacAddress, portMaxDsPower=portMaxDsPower, auditAutoScheduling=auditAutoScheduling, equipmentCardGroup=equipmentCardGroup, trapSeverity=trapSeverity, diskVolumeId=diskVolumeId, cardRamSize=cardRamSize, cardTestResultNotification=cardTestResultNotification, cmResetUpTime=cmResetUpTime, TestTransactionId=TestTransactionId, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardTestTable=cardTestTable, cardTrapInh=cardTrapInh, auditCommand=auditCommand, portEntry=portEntry, auditLogOutput=auditLogOutput, equipmentStateGroup=equipmentStateGroup, auditEntry=auditEntry, cardCarrierSerialNum=cardCarrierSerialNum, diskVolumeDriveId=diskVolumeDriveId, cardTestName=cardTestName, cardCpuType=cardCpuType, downstreamPowerLoss=downstreamPowerLoss, shelfObjects=shelfObjects, auditCycleCount=auditCycleCount, diskDriveNumber=diskDriveNumber, cardTestEntry=cardTestEntry, cardTemperatureHighError=cardTemperatureHighError, portMinDsPower=portMinDsPower, cmPrimarySID=cmPrimarySID, cardHwVersion=cardHwVersion, systemClock=systemClock, cardLastChangeTime=cardLastChangeTime)
