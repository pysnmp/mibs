...
CardSubType, DuplexStatus, PortDetectedMode, DiskVolumeUsageLevel, ShelfId, UnknownState, PicType, AdminState, CardType, EqActionType, FirmwareSource, FlowControlMode, SecondaryState, PrimaryState, PortId, PortMode, PortType, CardId = mibBuilder.importSymbols("CADANT-TC", "CardSubType", "DuplexStatus", "PortDetectedMode", "DiskVolumeUsageLevel", "ShelfId", "UnknownState", "PicType", "AdminState", "CardType", "EqActionType", "FirmwareSource", "FlowControlMode", "SecondaryState", "PrimaryState", "PortId", "PortMode", "PortType", "CardId")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
NotificationType, Counter32, TimeTicks, iso, Bits, ModuleIdentity, MibIdentifier, Counter64, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "TimeTicks", "iso", "Bits", "ModuleIdentity", "MibIdentifier", "Counter64", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Integer32")
DateAndTime, TimeStamp, MacAddress, TextualConvention, TruthValue, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TimeStamp", "MacAddress", "TextualConvention", "TruthValue", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", diskVolumeUsageNotification=diskVolumeUsageNotification, cardSubDetected=cardSubDetected, TestSchedule=TestSchedule, TestResult=TestResult, cmResetStatus=cmResetStatus, cardTestScheduleCommand=cardTestScheduleCommand, cardTestTime=cardTestTime, portRxFlowControlMode=portRxFlowControlMode, portMinDsPower=portMinDsPower, auditEntry=auditEntry, auditPassedCount=auditPassedCount, cardBootVersion=cardBootVersion, cmResetUpTime=cmResetUpTime, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cmPrimarySID=cmPrimarySID, portDplxStatus=portDplxStatus, cmResetReason=cmResetReason, diskVolumeDriveId=diskVolumeDriveId, portMaxDsPower=portMaxDsPower, diskVolumeUsagePercentage=diskVolumeUsagePercentage, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, equipmentAudit=equipmentAudit, portTxFlowControlDetected=portTxFlowControlDetected, cardTestName=cardTestName, cardTempOverHeatNotification=cardTempOverHeatNotification, equipmentAuditGroup=equipmentAuditGroup, cadEquipmentMibGroup=cadEquipmentMibGroup, portMacAddress=portMacAddress, cardLastChangeTime=cardLastChangeTime, portDescription=portDescription, errEvLoggingEnabled=errEvLoggingEnabled, equipmentTraps=equipmentTraps, portSecState=portSecState, TestScheduleCommand=TestScheduleCommand, cardHwVersion=cardHwVersion, auditLogThrottle=auditLogThrottle, cardLastResetReason=cardLastResetReason, errEventId=errEventId, auditTime=auditTime, portCurrDsPower=portCurrDsPower, auditAutoScheduling=auditAutoScheduling, equipmentShelfGroup=equipmentShelfGroup, diskVolumeTable=diskVolumeTable, cardPicDetected=cardPicDetected, cardSpareGroupId=cardSpareGroupId, cardSubType=cardSubType, portDetectedMode=portDetectedMode, cardCPLDVersion=cardCPLDVersion, equipmentCardTestGroup=equipmentCardTestGroup, TestCommand=TestCommand, portMode=portMode, portShelfId=portShelfId, diskVolumeCardId=diskVolumeCardId, cardId=cardId, cardDplxStatus=cardDplxStatus, cardSpareGroupMode=cardSpareGroupMode, cmMacAddress=cmMacAddress, shelfNumber=shelfNumber, cmResetInfo=cmResetInfo, fpgaErrorEventGroup=fpgaErrorEventGroup, systemGeneral=systemGeneral, cardPicHwVersion=cardPicHwVersion, cardFwUpdateStatus=cardFwUpdateStatus, diskVolumeFileName=diskVolumeFileName, equipmentCardGroup=equipmentCardGroup, portDocsIfIndex=portDocsIfIndex, systemClock=systemClock, portDplxStatusChange=portDplxStatusChange, portAction=portAction, cmVendor=cmVendor, cardAction=cardAction, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cmUChannelID=cmUChannelID, cardTestDescription=cardTestDescription, cadEquipmentMib=cadEquipmentMib, cardCpuSpeed=cardCpuSpeed, equipmentPortGroup=equipmentPortGroup, diskVolumeDiskSize=diskVolumeDiskSize, cardUpTime=cardUpTime, diskVolumeUsageLevel=diskVolumeUsageLevel, cardTemperatureHighError=cardTemperatureHighError, cardLastBootSource=cardLastBootSource, equipmentState=equipmentState, portAdminState=portAdminState, cardRamSize=cardRamSize, equipmentStateGroup=equipmentStateGroup, diskVolumeId=diskVolumeId, portPrStateChange=portPrStateChange, cardTestEntry=cardTestEntry, shelfName=shelfName, auditTotalPassedCount=auditTotalPassedCount, errEvLogLevel=errEvLogLevel, cardShelfTestIndex=cardShelfTestIndex, cardTestResultDesc=cardTestResultDesc, equipmentTbl=equipmentTbl, auditName=auditName, cardType=cardType, portCardId=portCardId, portNumChans=portNumChans, auditStatus=auditStatus, auditResult=auditResult, cmDevice=cmDevice, cardDetected=cardDetected, diskDriveNumber=diskDriveNumber, portEntry=portEntry, auditTable=auditTable, trapSeverity=trapSeverity, TestTransactionId=TestTransactionId, remainInDiagMode=remainInDiagMode, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardSerialNum=cardSerialNum, systemKey=systemKey, cardShelfId=cardShelfId, portPrState=portPrState, auditDescription=auditDescription, diskVolumeShelfId=diskVolumeShelfId, auditTotalFailedCount=auditTotalFailedCount, portType=portType, downstreamPowerLoss=downstreamPowerLoss, equipmentDiag=equipmentDiag, diagTestId=diagTestId, PYSNMP_MODULE_ID=cadEquipmentMib, cardTestSchedule=cardTestSchedule, cardName=cardName, portTrapInh=portTrapInh, cardPrStateChange=cardPrStateChange, cardTestResultNotification=cardTestResultNotification, cardTestTransId=cardTestTransId, cardEntry=cardEntry, cardFlashSize=cardFlashSize, auditLogOutput=auditLogOutput, equipmentError=equipmentError, shelfSwVersion=shelfSwVersion, portConnectorId=portConnectorId, cardFwVersion=cardFwVersion, cardNumPorts=cardNumPorts, diskVolumeSize=diskVolumeSize, portLastChangeTime=portLastChangeTime, portBgpId=portBgpId, cardTemperature=cardTemperature, cmRegistrationNotification=cmRegistrationNotification, cardSecState=cardSecState, consoleOutput=consoleOutput, portTxFlowControlMode=portTxFlowControlMode, cmResetNotification=cmResetNotification, systemGeneralGroup=systemGeneralGroup, auditCycleCount=auditCycleCount, diskVolumeTrapInh=diskVolumeTrapInh, diskVolumeNumber=diskVolumeNumber, cardTestCommand=cardTestCommand, equipmentDiagGroup=equipmentDiagGroup, diskVolumeGroup=diskVolumeGroup, cardAdminState=cardAdminState, cardCarrierSerialNum=cardCarrierSerialNum, portMacIfIndex=portMacIfIndex, cardTestId=cardTestId, cardSwVersion=cardSwVersion, cardCarrierHwVersion=cardCarrierHwVersion, cardPrState=cardPrState, cardTrapInh=cardTrapInh, cmIpAddress=cmIpAddress, cardTempNoReportNotification=cardTempNoReportNotification, cardTestResult=cardTestResult, TestType=TestType, portRxFlowControlDetected=portRxFlowControlDetected, fpgaErrorEventEntry=fpgaErrorEventEntry, shelfObjects=shelfObjects, cardTable=cardTable, auditCommand=auditCommand, cardBusSpeed=cardBusSpeed, errEvRowStatus=errEvRowStatus, portNumber=portNumber, errEvRecoveryEnabled=errEvRecoveryEnabled, portSecStateChange=portSecStateChange, diskVolumeEntry=diskVolumeEntry, eqDiagConfig=eqDiagConfig, cardLastBootVersion=cardLastBootVersion, cardCpuType=cardCpuType, verboseLevel=verboseLevel, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, trapCounter=trapCounter, TestId=TestId, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeName=diskVolumeName, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditShelfId=auditShelfId, cardFpgaSource=cardFpgaSource, fpgaErrorEventTable=fpgaErrorEventTable, cmResetClearNotification=cmResetClearNotification, cardSecStateChange=cardSecStateChange, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditCardId=auditCardId, cadEquipmentMibConformance=cadEquipmentMibConformance, cardTestIndex=cardTestIndex, portId=portId, cardNumber=cardNumber, cardTestTable=cardTestTable, cardTestType=cardTestType, auditId=auditId, auditFailedCount=auditFailedCount, cardPicSerialNum=cardPicSerialNum, portTable=portTable, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardDetectedChange=cardDetectedChange, portCardSubType=portCardSubType, cardDplxStatusChange=cardDplxStatusChange, cardTemperatureHighWarn=cardTemperatureHighWarn)
