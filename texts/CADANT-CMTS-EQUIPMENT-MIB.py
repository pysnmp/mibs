...
CardSubType, AdminState, DuplexStatus, PortDetectedMode, FlowControlMode, PicType, PortType, ShelfId, PortMode, UnknownState, PortId, CardId, SecondaryState, FirmwareSource, EqActionType, CardType, PrimaryState, DiskVolumeUsageLevel = mibBuilder.importSymbols("CADANT-TC", "CardSubType", "AdminState", "DuplexStatus", "PortDetectedMode", "FlowControlMode", "PicType", "PortType", "ShelfId", "PortMode", "UnknownState", "PortId", "CardId", "SecondaryState", "FirmwareSource", "EqActionType", "CardType", "PrimaryState", "DiskVolumeUsageLevel")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
Integer32, TimeTicks, Unsigned32, Counter32, Gauge32, iso, MibIdentifier, Counter64, IpAddress, ObjectIdentity, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "Unsigned32", "Counter32", "Gauge32", "iso", "MibIdentifier", "Counter64", "IpAddress", "ObjectIdentity", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
TruthValue, RowStatus, TimeStamp, DateAndTime, DisplayString, TextualConvention, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "TimeStamp", "DateAndTime", "DisplayString", "TextualConvention", "MacAddress")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", fpgaErrorEventEntry=fpgaErrorEventEntry, diskVolumeSize=diskVolumeSize, cmResetNotification=cmResetNotification, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeName=diskVolumeName, auditStatus=auditStatus, TestCommand=TestCommand, cardDetectedChange=cardDetectedChange, portDplxStatusChange=portDplxStatusChange, portBgpId=portBgpId, portRxFlowControlMode=portRxFlowControlMode, verboseLevel=verboseLevel, cmUChannelID=cmUChannelID, trapSeverity=trapSeverity, cardSwVersion=cardSwVersion, cardSpareGroupId=cardSpareGroupId, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diskVolumeDiskSize=diskVolumeDiskSize, cardSecState=cardSecState, portCardId=portCardId, auditId=auditId, cardAction=cardAction, cardAdminState=cardAdminState, shelfSwVersion=shelfSwVersion, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cmResetReason=cmResetReason, trapCounter=trapCounter, errEvLogLevel=errEvLogLevel, portNumChans=portNumChans, cardPrStateChange=cardPrStateChange, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portEntry=portEntry, equipmentCardTestGroup=equipmentCardTestGroup, TestScheduleCommand=TestScheduleCommand, cmResetUpTime=cmResetUpTime, portDetectedMode=portDetectedMode, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, equipmentDiagGroup=equipmentDiagGroup, cardCarrierSerialNum=cardCarrierSerialNum, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, diskVolumeId=diskVolumeId, auditDescription=auditDescription, cardTestIndex=cardTestIndex, auditResult=auditResult, cardTestName=cardTestName, PYSNMP_MODULE_ID=cadEquipmentMib, cardSpareGroupMode=cardSpareGroupMode, cardDetected=cardDetected, TestId=TestId, auditLogOutput=auditLogOutput, cardTestResult=cardTestResult, cardSubDetected=cardSubDetected, cardDplxStatusChange=cardDplxStatusChange, cardLastBootVersion=cardLastBootVersion, diskVolumeUsageNotification=diskVolumeUsageNotification, portMinDsPower=portMinDsPower, cardSerialNum=cardSerialNum, portAdminState=portAdminState, systemClock=systemClock, cardNumPorts=cardNumPorts, cardTestScheduleCommand=cardTestScheduleCommand, portPrStateChange=portPrStateChange, cardLastChangeTime=cardLastChangeTime, equipmentPortGroup=equipmentPortGroup, auditPassedCount=auditPassedCount, portMacIfIndex=portMacIfIndex, portId=portId, portTable=portTable, TestTransactionId=TestTransactionId, equipmentState=equipmentState, cardTestCommand=cardTestCommand, cardType=cardType, cardTestType=cardTestType, portDocsIfIndex=portDocsIfIndex, portNumber=portNumber, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portCardSubType=portCardSubType, auditTime=auditTime, diagTestId=diagTestId, equipmentAuditGroup=equipmentAuditGroup, equipmentCardGroup=equipmentCardGroup, cardCPLDVersion=cardCPLDVersion, shelfName=shelfName, diskVolumeFileName=diskVolumeFileName, cardPicDetected=cardPicDetected, portAction=portAction, cardShelfTestIndex=cardShelfTestIndex, cardTestSchedule=cardTestSchedule, diskVolumeTable=diskVolumeTable, errEvLoggingEnabled=errEvLoggingEnabled, cmRegistrationNotification=cmRegistrationNotification, portDescription=portDescription, cardLastResetReason=cardLastResetReason, auditCycleCount=auditCycleCount, cardTestEntry=cardTestEntry, auditFailedCount=auditFailedCount, errEvRecoveryEnabled=errEvRecoveryEnabled, diskVolumeUsageLevel=diskVolumeUsageLevel, auditTotalFailedCount=auditTotalFailedCount, fpgaErrorEventGroup=fpgaErrorEventGroup, auditCommand=auditCommand, cardFwUpdateStatus=cardFwUpdateStatus, downstreamPowerLoss=downstreamPowerLoss, cardCarrierHwVersion=cardCarrierHwVersion, portDplxStatus=portDplxStatus, cardTable=cardTable, consoleOutput=consoleOutput, cmVendor=cmVendor, shelfNumber=shelfNumber, diskVolumeEntry=diskVolumeEntry, TestSchedule=TestSchedule, cardTemperatureHighWarn=cardTemperatureHighWarn, cardTemperature=cardTemperature, equipmentStateGroup=equipmentStateGroup, cardLastBootSource=cardLastBootSource, diskVolumeNumber=diskVolumeNumber, auditLogThrottle=auditLogThrottle, cardUpTime=cardUpTime, portTxFlowControlDetected=portTxFlowControlDetected, cadEquipmentMibGroup=cadEquipmentMibGroup, cmResetStatus=cmResetStatus, auditName=auditName, cadEquipmentMibCompliances=cadEquipmentMibCompliances, auditAutoScheduling=auditAutoScheduling, cardPicSerialNum=cardPicSerialNum, cardTrapInh=cardTrapInh, portConnectorId=portConnectorId, cardPicHwVersion=cardPicHwVersion, auditShelfId=auditShelfId, cardRamSize=cardRamSize, cardCpuType=cardCpuType, cardId=cardId, portPrState=portPrState, portSecState=portSecState, portSecStateChange=portSecStateChange, diskVolumeCardId=diskVolumeCardId, cardTestResultNotification=cardTestResultNotification, cardTestTable=cardTestTable, cmResetInfo=cmResetInfo, diskVolumeShelfId=diskVolumeShelfId, cardFwVersion=cardFwVersion, fpgaErrorEventTable=fpgaErrorEventTable, systemKey=systemKey, cardTestId=cardTestId, systemGeneral=systemGeneral, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, portMaxDsPower=portMaxDsPower, cadEquipmentMibConformance=cadEquipmentMibConformance, cardTemperatureHighError=cardTemperatureHighError, cardFlashSize=cardFlashSize, cardTempOverHeatNotification=cardTempOverHeatNotification, cardSubType=cardSubType, cardHwVersion=cardHwVersion, diskVolumeTrapInh=diskVolumeTrapInh, equipmentTraps=equipmentTraps, cardCarrierFwVersion=cardCarrierFwVersion, cardTestDescription=cardTestDescription, cardPrState=cardPrState, cardSecStateChange=cardSecStateChange, portMode=portMode, diskVolumeGroup=diskVolumeGroup, cardFpgaSource=cardFpgaSource, portLastChangeTime=portLastChangeTime, portCurrDsPower=portCurrDsPower, cardTempNoReportNotification=cardTempNoReportNotification, cmMacAddress=cmMacAddress, remainInDiagMode=remainInDiagMode, portMacAddress=portMacAddress, auditCardId=auditCardId, equipmentTbl=equipmentTbl, shelfObjects=shelfObjects, cmResetClearNotification=cmResetClearNotification, cardTestTransId=cardTestTransId, cardBusSpeed=cardBusSpeed, eqDiagConfig=eqDiagConfig, cmPrimarySID=cmPrimarySID, cardName=cardName, portTrapInh=portTrapInh, cadEquipmentMib=cadEquipmentMib, cardCpuSpeed=cardCpuSpeed, equipmentShelfGroup=equipmentShelfGroup, portType=portType, equipmentError=equipmentError, cmIpAddress=cmIpAddress, diskDriveNumber=diskDriveNumber, diskVolumeDriveId=diskVolumeDriveId, cardDplxStatus=cardDplxStatus, equipmentDiag=equipmentDiag, cardTestResultDesc=cardTestResultDesc, equipmentAudit=equipmentAudit, auditTable=auditTable, cardNumber=cardNumber, cardShelfId=cardShelfId, TestType=TestType, cardEntry=cardEntry, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardBootVersion=cardBootVersion, TestResult=TestResult, portTxFlowControlMode=portTxFlowControlMode, cmDevice=cmDevice, auditTotalPassedCount=auditTotalPassedCount, cardTestTime=cardTestTime, errEvRowStatus=errEvRowStatus, errEventId=errEventId, portShelfId=portShelfId, auditEntry=auditEntry, systemGeneralGroup=systemGeneralGroup)
