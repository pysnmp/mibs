...
AdminState, DuplexStatus, EqActionType, FlowControlMode, PicType, CardId, PortType, SecondaryState, UnknownState, PrimaryState, CardSubType, DiskVolumeUsageLevel, CardType, PortId, FirmwareSource, PortDetectedMode, ShelfId, PortMode = mibBuilder.importSymbols("CADANT-TC", "AdminState", "DuplexStatus", "EqActionType", "FlowControlMode", "PicType", "CardId", "PortType", "SecondaryState", "UnknownState", "PrimaryState", "CardSubType", "DiskVolumeUsageLevel", "CardType", "PortId", "FirmwareSource", "PortDetectedMode", "ShelfId", "PortMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
MibIdentifier, Counter64, Gauge32, Unsigned32, iso, Bits, Counter32, ObjectIdentity, TimeTicks, NotificationType, ModuleIdentity, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Gauge32", "Unsigned32", "iso", "Bits", "Counter32", "ObjectIdentity", "TimeTicks", "NotificationType", "ModuleIdentity", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
DisplayString, TimeStamp, DateAndTime, RowStatus, MacAddress, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "DateAndTime", "RowStatus", "MacAddress", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", shelfSwVersion=shelfSwVersion, errEvRecoveryEnabled=errEvRecoveryEnabled, cardTemperature=cardTemperature, cardTempOverHeatNotification=cardTempOverHeatNotification, cardBootVersion=cardBootVersion, portPrState=portPrState, cardTestSchedule=cardTestSchedule, cmResetNotification=cmResetNotification, cardTestType=cardTestType, diskVolumeCardId=diskVolumeCardId, cardSubType=cardSubType, errEvLoggingEnabled=errEvLoggingEnabled, cardTempNoReportNotification=cardTempNoReportNotification, TestCommand=TestCommand, cardShelfId=cardShelfId, portCardId=portCardId, portAction=portAction, TestResult=TestResult, auditCardId=auditCardId, cardPrState=cardPrState, cardTestId=cardTestId, auditPassedCount=auditPassedCount, cardPicSerialNum=cardPicSerialNum, cardCarrierHwVersion=cardCarrierHwVersion, cardFwVersion=cardFwVersion, equipmentTbl=equipmentTbl, eqDiagConfig=eqDiagConfig, cardLastBootVersion=cardLastBootVersion, TestTransactionId=TestTransactionId, auditCommand=auditCommand, cardBusSpeed=cardBusSpeed, cardTestScheduleCommand=cardTestScheduleCommand, cardLastChangeTime=cardLastChangeTime, cmResetInfo=cmResetInfo, systemGeneral=systemGeneral, remainInDiagMode=remainInDiagMode, portTrapInh=portTrapInh, fpgaErrorEventTable=fpgaErrorEventTable, cardNumber=cardNumber, cardSwVersion=cardSwVersion, portShelfId=portShelfId, diskVolumeShelfId=diskVolumeShelfId, portDplxStatus=portDplxStatus, cardCpuSpeed=cardCpuSpeed, portType=portType, downstreamPowerLoss=downstreamPowerLoss, portTable=portTable, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diskVolumeId=diskVolumeId, cardTestResultDesc=cardTestResultDesc, diskVolumeEntry=diskVolumeEntry, portMode=portMode, portRxFlowControlDetected=portRxFlowControlDetected, cardTestTable=cardTestTable, equipmentDiagGroup=equipmentDiagGroup, equipmentCardTestGroup=equipmentCardTestGroup, cmIpAddress=cmIpAddress, portCardSubType=portCardSubType, cardId=cardId, cmDevice=cmDevice, portPrStateChange=portPrStateChange, TestSchedule=TestSchedule, cmResetStatus=cmResetStatus, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardDplxStatus=cardDplxStatus, errEvRowStatus=errEvRowStatus, diskVolumeDriveId=diskVolumeDriveId, diskDriveNumber=diskDriveNumber, fpgaErrorEventGroup=fpgaErrorEventGroup, cardPicHwVersion=cardPicHwVersion, cardTestTransId=cardTestTransId, cardTemperatureHighError=cardTemperatureHighError, PYSNMP_MODULE_ID=cadEquipmentMib, auditShelfId=auditShelfId, errEventId=errEventId, portDplxStatusChange=portDplxStatusChange, equipmentDiag=equipmentDiag, portDocsIfIndex=portDocsIfIndex, equipmentAuditGroup=equipmentAuditGroup, shelfNumber=shelfNumber, diagTestId=diagTestId, diskVolumeDiskSize=diskVolumeDiskSize, portDetectedMode=portDetectedMode, portNumber=portNumber, cardNumPorts=cardNumPorts, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardEntry=cardEntry, auditDescription=auditDescription, cardDetected=cardDetected, TestId=TestId, cardTemperatureHighWarn=cardTemperatureHighWarn, cadEquipmentMibConformance=cadEquipmentMibConformance, cardShelfTestIndex=cardShelfTestIndex, cardTestResult=cardTestResult, auditStatus=auditStatus, auditTotalFailedCount=auditTotalFailedCount, portRxFlowControlMode=portRxFlowControlMode, cardTestName=cardTestName, consoleOutput=consoleOutput, cadEquipmentMib=cadEquipmentMib, cardTestResultNotification=cardTestResultNotification, cardSecStateChange=cardSecStateChange, auditName=auditName, cardSerialNum=cardSerialNum, portLastChangeTime=portLastChangeTime, auditTime=auditTime, portId=portId, auditCycleCount=auditCycleCount, portMacAddress=portMacAddress, cardTestDescription=cardTestDescription, trapSeverity=trapSeverity, equipmentError=equipmentError, auditLogThrottle=auditLogThrottle, cmUChannelID=cmUChannelID, cardSecState=cardSecState, cardDplxStatusChange=cardDplxStatusChange, shelfName=shelfName, cardCarrierFwVersion=cardCarrierFwVersion, cardTestCommand=cardTestCommand, verboseLevel=verboseLevel, systemGeneralGroup=systemGeneralGroup, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeTrapInh=diskVolumeTrapInh, cadEquipmentMibGroup=cadEquipmentMibGroup, cardRamSize=cardRamSize, portEntry=portEntry, diskVolumeName=diskVolumeName, equipmentCardGroup=equipmentCardGroup, cardAction=cardAction, cmVendor=cmVendor, portSecStateChange=portSecStateChange, cardTrapInh=cardTrapInh, auditTotalPassedCount=auditTotalPassedCount, portAdminState=portAdminState, diskVolumeUsageNotification=diskVolumeUsageNotification, portTxFlowControlDetected=portTxFlowControlDetected, cardTestTime=cardTestTime, fpgaErrorEventEntry=fpgaErrorEventEntry, cardSpareGroupMode=cardSpareGroupMode, equipmentTraps=equipmentTraps, portMaxDsPower=portMaxDsPower, cardFpgaSource=cardFpgaSource, portConnectorId=portConnectorId, portCurrDsPower=portCurrDsPower, cardType=cardType, cardAdminState=cardAdminState, cmMacAddress=cmMacAddress, auditFailedCount=auditFailedCount, cardPicDetected=cardPicDetected, equipmentShelfGroup=equipmentShelfGroup, cardCPLDVersion=cardCPLDVersion, cardFlashSize=cardFlashSize, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cmRegistrationNotification=cmRegistrationNotification, cardCarrierSerialNum=cardCarrierSerialNum, portSecState=portSecState, shelfObjects=shelfObjects, cardSubDetected=cardSubDetected, cardTestIndex=cardTestIndex, cardSpareGroupId=cardSpareGroupId, equipmentAudit=equipmentAudit, cadEquipmentMibCompliances=cadEquipmentMibCompliances, diskVolumeGroup=diskVolumeGroup, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, diskVolumeTable=diskVolumeTable, systemKey=systemKey, diskVolumeNumber=diskVolumeNumber, cardUpTime=cardUpTime, auditTable=auditTable, systemClock=systemClock, portNumChans=portNumChans, auditEntry=auditEntry, cmResetReason=cmResetReason, equipmentStateGroup=equipmentStateGroup, cmResetClearNotification=cmResetClearNotification, cardDetectedChange=cardDetectedChange, cardLastResetReason=cardLastResetReason, diskVolumeUsagePercentage=diskVolumeUsagePercentage, TestType=TestType, auditLogOutput=auditLogOutput, auditAutoScheduling=auditAutoScheduling, diskVolumeFileName=diskVolumeFileName, cardCpuType=cardCpuType, auditId=auditId, trapCounter=trapCounter, cardLastBootSource=cardLastBootSource, portTxFlowControlMode=portTxFlowControlMode, cardName=cardName, cardPrStateChange=cardPrStateChange, cardTestEntry=cardTestEntry, cardTable=cardTable, cardFwUpdateStatus=cardFwUpdateStatus, cmPrimarySID=cmPrimarySID, portMacIfIndex=portMacIfIndex, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditResult=auditResult, equipmentPortGroup=equipmentPortGroup, portDescription=portDescription, diskVolumeSize=diskVolumeSize, TestScheduleCommand=TestScheduleCommand, cmResetUpTime=cmResetUpTime, equipmentState=equipmentState, errEvLogLevel=errEvLogLevel, portBgpId=portBgpId, portMinDsPower=portMinDsPower, cardHwVersion=cardHwVersion)
