...
PrimaryState, FirmwareSource, PortMode, EqActionType, PortDetectedMode, PicType, CardSubType, DuplexStatus, CardType, CardId, FlowControlMode, ShelfId, AdminState, PortType, PortId, UnknownState, DiskVolumeUsageLevel, SecondaryState = mibBuilder.importSymbols("CADANT-TC", "PrimaryState", "FirmwareSource", "PortMode", "EqActionType", "PortDetectedMode", "PicType", "CardSubType", "DuplexStatus", "CardType", "CardId", "FlowControlMode", "ShelfId", "AdminState", "PortType", "PortId", "UnknownState", "DiskVolumeUsageLevel", "SecondaryState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
Integer32, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, IpAddress, Counter64, Gauge32, iso, NotificationType, ObjectIdentity, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "IpAddress", "Counter64", "Gauge32", "iso", "NotificationType", "ObjectIdentity", "MibIdentifier", "TimeTicks")
TextualConvention, RowStatus, DateAndTime, TimeStamp, DisplayString, TruthValue, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "DateAndTime", "TimeStamp", "DisplayString", "TruthValue", "MacAddress")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", errEventId=errEventId, cardId=cardId, cardSubDetected=cardSubDetected, cardBootVersion=cardBootVersion, cardTestSchedule=cardTestSchedule, portPrStateChange=portPrStateChange, diskVolumeUsageLevel=diskVolumeUsageLevel, cmIpAddress=cmIpAddress, cardTrapInh=cardTrapInh, portSecState=portSecState, cardLastResetReason=cardLastResetReason, cardSecStateChange=cardSecStateChange, cardAdminState=cardAdminState, diskVolumeTrapInh=diskVolumeTrapInh, diskVolumeFileName=diskVolumeFileName, portDplxStatusChange=portDplxStatusChange, portConnectorId=portConnectorId, cardTestResultNotification=cardTestResultNotification, cardDetectedChange=cardDetectedChange, cardSpareGroupId=cardSpareGroupId, portEntry=portEntry, auditCardId=auditCardId, portCardSubType=portCardSubType, cmMacAddress=cmMacAddress, fpgaErrorEventGroup=fpgaErrorEventGroup, cardPicHwVersion=cardPicHwVersion, systemKey=systemKey, cardSubType=cardSubType, eqDiagConfig=eqDiagConfig, remainInDiagMode=remainInDiagMode, cardSerialNum=cardSerialNum, auditId=auditId, portMacAddress=portMacAddress, cardCarrierFwVersion=cardCarrierFwVersion, trapCounter=trapCounter, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardLastChangeTime=cardLastChangeTime, auditLogThrottle=auditLogThrottle, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardCpuSpeed=cardCpuSpeed, cardLastBootVersion=cardLastBootVersion, cardSecState=cardSecState, cmResetReason=cmResetReason, cardHwVersion=cardHwVersion, cardTestTime=cardTestTime, portTxFlowControlMode=portTxFlowControlMode, TestResult=TestResult, cardCpuType=cardCpuType, cardTestId=cardTestId, diskVolumeId=diskVolumeId, auditFailedCount=auditFailedCount, portDocsIfIndex=portDocsIfIndex, cardTestName=cardTestName, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, portTxFlowControlDetected=portTxFlowControlDetected, auditTable=auditTable, auditTotalFailedCount=auditTotalFailedCount, verboseLevel=verboseLevel, auditLogOutput=auditLogOutput, cardTemperatureHighWarn=cardTemperatureHighWarn, TestSchedule=TestSchedule, cmDevice=cmDevice, cmUChannelID=cmUChannelID, PYSNMP_MODULE_ID=cadEquipmentMib, equipmentShelfGroup=equipmentShelfGroup, equipmentStateGroup=equipmentStateGroup, cardTemperatureHighError=cardTemperatureHighError, cardNumPorts=cardNumPorts, cardTestType=cardTestType, equipmentState=equipmentState, shelfNumber=shelfNumber, errEvRowStatus=errEvRowStatus, cardTestTransId=cardTestTransId, cmVendor=cmVendor, diskVolumeCardId=diskVolumeCardId, auditEntry=auditEntry, diskVolumeNumber=diskVolumeNumber, cardNumber=cardNumber, cardBusSpeed=cardBusSpeed, equipmentPortGroup=equipmentPortGroup, cardTestDescription=cardTestDescription, cardCarrierSerialNum=cardCarrierSerialNum, cmResetUpTime=cmResetUpTime, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, auditCommand=auditCommand, cmRegistrationNotification=cmRegistrationNotification, cardTempOverHeatNotification=cardTempOverHeatNotification, cmResetInfo=cmResetInfo, equipmentTraps=equipmentTraps, cardType=cardType, cardTestEntry=cardTestEntry, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTemperature=cardTemperature, cadEquipmentMibGroup=cadEquipmentMibGroup, portId=portId, equipmentCardTestGroup=equipmentCardTestGroup, cardFwVersion=cardFwVersion, portDescription=portDescription, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTestScheduleCommand=cardTestScheduleCommand, errEvLogLevel=errEvLogLevel, trapSeverity=trapSeverity, portMaxDsPower=portMaxDsPower, portShelfId=portShelfId, portBgpId=portBgpId, cardSwVersion=cardSwVersion, portMacIfIndex=portMacIfIndex, cardUpTime=cardUpTime, downstreamPowerLoss=downstreamPowerLoss, cardFpgaSource=cardFpgaSource, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, shelfSwVersion=shelfSwVersion, diskDriveNumber=diskDriveNumber, TestTransactionId=TestTransactionId, portDplxStatus=portDplxStatus, cardTestTable=cardTestTable, portType=portType, cardAction=cardAction, cardPicSerialNum=cardPicSerialNum, cardPicDetected=cardPicDetected, auditCycleCount=auditCycleCount, cardTable=cardTable, auditTotalPassedCount=auditTotalPassedCount, portSecStateChange=portSecStateChange, diskVolumeEntry=diskVolumeEntry, portTable=portTable, diskVolumeTable=diskVolumeTable, cardPrState=cardPrState, portTrapInh=portTrapInh, portCurrDsPower=portCurrDsPower, portMinDsPower=portMinDsPower, auditShelfId=auditShelfId, auditDescription=auditDescription, diagTestId=diagTestId, cardTestResultDesc=cardTestResultDesc, portNumber=portNumber, portPrState=portPrState, diskVolumeGroup=diskVolumeGroup, cardSpareGroupMode=cardSpareGroupMode, consoleOutput=consoleOutput, cardDetected=cardDetected, auditName=auditName, cardTestCommand=cardTestCommand, portNumChans=portNumChans, TestScheduleCommand=TestScheduleCommand, cmResetClearNotification=cmResetClearNotification, cardEntry=cardEntry, cmPrimarySID=cmPrimarySID, equipmentDiag=equipmentDiag, auditResult=auditResult, cardName=cardName, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, equipmentError=equipmentError, portAdminState=portAdminState, cmResetNotification=cmResetNotification, cardPrStateChange=cardPrStateChange, cmResetStatus=cmResetStatus, portRxFlowControlDetected=portRxFlowControlDetected, cardShelfId=cardShelfId, cardCPLDVersion=cardCPLDVersion, shelfName=shelfName, systemGeneral=systemGeneral, equipmentDiagGroup=equipmentDiagGroup, cardRamSize=cardRamSize, portRxFlowControlMode=portRxFlowControlMode, fpgaErrorEventEntry=fpgaErrorEventEntry, portDetectedMode=portDetectedMode, cardTestIndex=cardTestIndex, TestId=TestId, TestCommand=TestCommand, auditStatus=auditStatus, systemClock=systemClock, portLastChangeTime=portLastChangeTime, diskVolumeSize=diskVolumeSize, equipmentAuditGroup=equipmentAuditGroup, equipmentAudit=equipmentAudit, auditTime=auditTime, cardTestResult=cardTestResult, auditAutoScheduling=auditAutoScheduling, auditPassedCount=auditPassedCount, fpgaErrorEventTable=fpgaErrorEventTable, diskVolumeDiskSize=diskVolumeDiskSize, portAction=portAction, portMode=portMode, cadEquipmentMibConformance=cadEquipmentMibConformance, cardTempNoReportNotification=cardTempNoReportNotification, TestType=TestType, diskVolumeShelfId=diskVolumeShelfId, cardShelfTestIndex=cardShelfTestIndex, equipmentCardGroup=equipmentCardGroup, equipmentTbl=equipmentTbl, cardLastBootSource=cardLastBootSource, diskVolumeDriveId=diskVolumeDriveId, cardDplxStatusChange=cardDplxStatusChange, cadEquipmentMib=cadEquipmentMib, errEvRecoveryEnabled=errEvRecoveryEnabled, cardFlashSize=cardFlashSize, portCardId=portCardId, shelfObjects=shelfObjects, systemGeneralGroup=systemGeneralGroup, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeName=diskVolumeName, cardCarrierHwVersion=cardCarrierHwVersion, cardFwUpdateStatus=cardFwUpdateStatus, errEvLoggingEnabled=errEvLoggingEnabled, cardDplxStatus=cardDplxStatus)
