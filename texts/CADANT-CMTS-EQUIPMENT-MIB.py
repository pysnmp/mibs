...
DuplexStatus, UnknownState, FlowControlMode, PortDetectedMode, PortMode, CardId, DiskVolumeUsageLevel, SecondaryState, AdminState, ShelfId, PrimaryState, EqActionType, PortId, CardSubType, PicType, FirmwareSource, PortType, CardType = mibBuilder.importSymbols("CADANT-TC", "DuplexStatus", "UnknownState", "FlowControlMode", "PortDetectedMode", "PortMode", "CardId", "DiskVolumeUsageLevel", "SecondaryState", "AdminState", "ShelfId", "PrimaryState", "EqActionType", "PortId", "CardSubType", "PicType", "FirmwareSource", "PortType", "CardType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
iso, TimeTicks, Unsigned32, Gauge32, MibIdentifier, Bits, NotificationType, IpAddress, Counter32, Integer32, ObjectIdentity, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Unsigned32", "Gauge32", "MibIdentifier", "Bits", "NotificationType", "IpAddress", "Counter32", "Integer32", "ObjectIdentity", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TimeStamp, RowStatus, MacAddress, DateAndTime, TruthValue, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "MacAddress", "DateAndTime", "TruthValue", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardPrState=cardPrState, cmResetReason=cmResetReason, trapSeverity=trapSeverity, auditEntry=auditEntry, trapCounter=trapCounter, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeEntry=diskVolumeEntry, cardTestResult=cardTestResult, cardTestTransId=cardTestTransId, cardTestEntry=cardTestEntry, cardFlashSize=cardFlashSize, cadEquipmentMibGroup=cadEquipmentMibGroup, diskVolumeUsageNotification=diskVolumeUsageNotification, portMacIfIndex=portMacIfIndex, cardTestTable=cardTestTable, cardRamSize=cardRamSize, auditCycleCount=auditCycleCount, portAdminState=portAdminState, portPrState=portPrState, auditFailedCount=auditFailedCount, equipmentPortGroup=equipmentPortGroup, auditId=auditId, auditLogOutput=auditLogOutput, portEntry=portEntry, remainInDiagMode=remainInDiagMode, cmResetClearNotification=cmResetClearNotification, portMode=portMode, cardId=cardId, cardSwVersion=cardSwVersion, cardTestResultNotification=cardTestResultNotification, TestCommand=TestCommand, cardType=cardType, cardUpTime=cardUpTime, systemClock=systemClock, cmPrimarySID=cmPrimarySID, cardTestId=cardTestId, portMinDsPower=portMinDsPower, cardHwVersion=cardHwVersion, auditTime=auditTime, portDplxStatus=portDplxStatus, portMaxDsPower=portMaxDsPower, equipmentStateGroup=equipmentStateGroup, cardLastResetReason=cardLastResetReason, cardAdminState=cardAdminState, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, fpgaErrorEventEntry=fpgaErrorEventEntry, cardPicSerialNum=cardPicSerialNum, cmVendor=cmVendor, diskVolumeCardId=diskVolumeCardId, cardBusSpeed=cardBusSpeed, portRxFlowControlMode=portRxFlowControlMode, cardSpareGroupId=cardSpareGroupId, consoleOutput=consoleOutput, cardTestName=cardTestName, auditTotalPassedCount=auditTotalPassedCount, cardTestSchedule=cardTestSchedule, portCardId=portCardId, cardCpuType=cardCpuType, cmRegistrationNotification=cmRegistrationNotification, cardTestType=cardTestType, cmResetUpTime=cmResetUpTime, cardShelfId=cardShelfId, cardEntry=cardEntry, cardTestCommand=cardTestCommand, portTable=portTable, portCardSubType=portCardSubType, cardTestTime=cardTestTime, portRxFlowControlDetected=portRxFlowControlDetected, verboseLevel=verboseLevel, cadEquipmentMib=cadEquipmentMib, auditPassedCount=auditPassedCount, errEvRecoveryEnabled=errEvRecoveryEnabled, portCurrDsPower=portCurrDsPower, cmUChannelID=cmUChannelID, diskVolumeSize=diskVolumeSize, cardTestResultDesc=cardTestResultDesc, auditLogThrottle=auditLogThrottle, cardTemperatureHighError=cardTemperatureHighError, portDplxStatusChange=portDplxStatusChange, diskVolumeNumber=diskVolumeNumber, shelfSwVersion=shelfSwVersion, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeTrapInh=diskVolumeTrapInh, cardCPLDVersion=cardCPLDVersion, equipmentState=equipmentState, portBgpId=portBgpId, portConnectorId=portConnectorId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardCpuSpeed=cardCpuSpeed, auditTotalFailedCount=auditTotalFailedCount, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardSecStateChange=cardSecStateChange, cardFpgaSource=cardFpgaSource, systemGeneral=systemGeneral, portMacAddress=portMacAddress, cardAction=cardAction, portShelfId=portShelfId, cardLastBootSource=cardLastBootSource, diskVolumeName=diskVolumeName, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardTempNoReportNotification=cardTempNoReportNotification, cardName=cardName, cardLastChangeTime=cardLastChangeTime, cardShelfTestIndex=cardShelfTestIndex, equipmentCardGroup=equipmentCardGroup, auditTable=auditTable, fpgaErrorEventGroup=fpgaErrorEventGroup, diskVolumeGroup=diskVolumeGroup, equipmentError=equipmentError, portId=portId, shelfNumber=shelfNumber, eqDiagConfig=eqDiagConfig, TestId=TestId, portDescription=portDescription, cardTestIndex=cardTestIndex, shelfObjects=shelfObjects, cadEquipmentMibConformance=cadEquipmentMibConformance, cmResetStatus=cmResetStatus, cardDetectedChange=cardDetectedChange, cardTestDescription=cardTestDescription, auditCommand=auditCommand, equipmentCardTestGroup=equipmentCardTestGroup, cardLastBootVersion=cardLastBootVersion, cardDplxStatusChange=cardDplxStatusChange, portNumber=portNumber, portSecStateChange=portSecStateChange, cardTable=cardTable, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, diskVolumeDiskSize=diskVolumeDiskSize, portType=portType, portNumChans=portNumChans, errEvRowStatus=errEvRowStatus, downstreamPowerLoss=downstreamPowerLoss, auditCardId=auditCardId, cardNumPorts=cardNumPorts, cardPrStateChange=cardPrStateChange, portLastChangeTime=portLastChangeTime, auditAutoScheduling=auditAutoScheduling, cmResetInfo=cmResetInfo, TestTransactionId=TestTransactionId, shelfName=shelfName, equipmentShelfGroup=equipmentShelfGroup, equipmentDiagGroup=equipmentDiagGroup, cardCarrierSerialNum=cardCarrierSerialNum, cardNumber=cardNumber, diskVolumeFileName=diskVolumeFileName, cmIpAddress=cmIpAddress, diskVolumeUsageLevel=diskVolumeUsageLevel, cardTrapInh=cardTrapInh, cardDplxStatus=cardDplxStatus, portDocsIfIndex=portDocsIfIndex, equipmentDiag=equipmentDiag, auditShelfId=auditShelfId, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, equipmentTraps=equipmentTraps, cardFwVersion=cardFwVersion, systemKey=systemKey, portDetectedMode=portDetectedMode, cmDevice=cmDevice, portTrapInh=portTrapInh, fpgaErrorEventTable=fpgaErrorEventTable, diskVolumeId=diskVolumeId, equipmentAuditGroup=equipmentAuditGroup, PYSNMP_MODULE_ID=cadEquipmentMib, errEvLogLevel=errEvLogLevel, diskDriveNumber=diskDriveNumber, cardBootVersion=cardBootVersion, equipmentTbl=equipmentTbl, cardSubType=cardSubType, errEventId=errEventId, cardSpareGroupMode=cardSpareGroupMode, TestType=TestType, systemGeneralGroup=systemGeneralGroup, cardFwUpdateStatus=cardFwUpdateStatus, TestSchedule=TestSchedule, cardSecState=cardSecState, auditName=auditName, auditStatus=auditStatus, equipmentAudit=equipmentAudit, cardTemperature=cardTemperature, auditDescription=auditDescription, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, TestScheduleCommand=TestScheduleCommand, cardDetected=cardDetected, portAction=portAction, diskVolumeTable=diskVolumeTable, cmMacAddress=cmMacAddress, diagTestId=diagTestId, cardTestScheduleCommand=cardTestScheduleCommand, cardSubDetected=cardSubDetected, diskVolumeDriveId=diskVolumeDriveId, TestResult=TestResult, cardTempOverHeatNotification=cardTempOverHeatNotification, cardPicHwVersion=cardPicHwVersion, cardCarrierHwVersion=cardCarrierHwVersion, portPrStateChange=portPrStateChange, cardTemperatureHighWarn=cardTemperatureHighWarn, portTxFlowControlMode=portTxFlowControlMode, auditResult=auditResult, errEvLoggingEnabled=errEvLoggingEnabled, cardPicDetected=cardPicDetected, diskVolumeShelfId=diskVolumeShelfId, cmResetNotification=cmResetNotification, cardSerialNum=cardSerialNum, portSecState=portSecState)
