...
SecondaryState, AdminState, CardType, PortMode, PortId, CardId, ShelfId, DuplexStatus, UnknownState, FirmwareSource, PortType, PrimaryState, PicType, CardSubType, PortDetectedMode, EqActionType, FlowControlMode, DiskVolumeUsageLevel = mibBuilder.importSymbols("CADANT-TC", "SecondaryState", "AdminState", "CardType", "PortMode", "PortId", "CardId", "ShelfId", "DuplexStatus", "UnknownState", "FirmwareSource", "PortType", "PrimaryState", "PicType", "CardSubType", "PortDetectedMode", "EqActionType", "FlowControlMode", "DiskVolumeUsageLevel")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Counter32, TimeTicks, IpAddress, Unsigned32, Bits, ModuleIdentity, Counter64, Gauge32, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Counter32", "TimeTicks", "IpAddress", "Unsigned32", "Bits", "ModuleIdentity", "Counter64", "Gauge32", "NotificationType", "Integer32")
DateAndTime, TextualConvention, DisplayString, MacAddress, TimeStamp, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "DisplayString", "MacAddress", "TimeStamp", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", auditEntry=auditEntry, cadEquipmentMib=cadEquipmentMib, cardTestSchedule=cardTestSchedule, portDescription=portDescription, cardPrStateChange=cardPrStateChange, portCurrDsPower=portCurrDsPower, cardSubDetected=cardSubDetected, diskVolumeCardId=diskVolumeCardId, cardTestTable=cardTestTable, cardTestDescription=cardTestDescription, TestId=TestId, TestType=TestType, portConnectorId=portConnectorId, portBgpId=portBgpId, auditCardId=auditCardId, cardLastChangeTime=cardLastChangeTime, cmDevice=cmDevice, cardTestName=cardTestName, auditFailedCount=auditFailedCount, cardType=cardType, cmPrimarySID=cmPrimarySID, equipmentPortGroup=equipmentPortGroup, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditName=auditName, consoleOutput=consoleOutput, portDplxStatusChange=portDplxStatusChange, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTempNoReportNotification=cardTempNoReportNotification, cardName=cardName, errEventId=errEventId, cardFwUpdateStatus=cardFwUpdateStatus, cardTestResult=cardTestResult, auditLogThrottle=auditLogThrottle, cmRegistrationNotification=cmRegistrationNotification, cardDplxStatus=cardDplxStatus, cardTemperature=cardTemperature, TestCommand=TestCommand, cardTestEntry=cardTestEntry, cardTrapInh=cardTrapInh, auditShelfId=auditShelfId, diskVolumeNumber=diskVolumeNumber, portMode=portMode, TestSchedule=TestSchedule, portSecStateChange=portSecStateChange, cardTestCommand=cardTestCommand, diskVolumeEntry=diskVolumeEntry, auditResult=auditResult, errEvRowStatus=errEvRowStatus, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardLastResetReason=cardLastResetReason, auditCommand=auditCommand, errEvLoggingEnabled=errEvLoggingEnabled, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diagTestId=diagTestId, cmResetUpTime=cmResetUpTime, cardTestId=cardTestId, fpgaErrorEventTable=fpgaErrorEventTable, TestScheduleCommand=TestScheduleCommand, cardSecState=cardSecState, portTrapInh=portTrapInh, equipmentTraps=equipmentTraps, portTxFlowControlMode=portTxFlowControlMode, cardId=cardId, cardTestType=cardTestType, cmMacAddress=cmMacAddress, cardCpuSpeed=cardCpuSpeed, diskVolumeDiskSize=diskVolumeDiskSize, auditId=auditId, portMacAddress=portMacAddress, portAction=portAction, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeGroup=diskVolumeGroup, TestTransactionId=TestTransactionId, cmIpAddress=cmIpAddress, cardFpgaSource=cardFpgaSource, equipmentError=equipmentError, PYSNMP_MODULE_ID=cadEquipmentMib, cardNumber=cardNumber, cardPicHwVersion=cardPicHwVersion, cardTestResultDesc=cardTestResultDesc, auditTime=auditTime, cardDplxStatusChange=cardDplxStatusChange, equipmentShelfGroup=equipmentShelfGroup, shelfObjects=shelfObjects, cmResetStatus=cmResetStatus, diskVolumeDriveId=diskVolumeDriveId, remainInDiagMode=remainInDiagMode, cardSpareGroupId=cardSpareGroupId, auditTable=auditTable, cmResetReason=cmResetReason, cmVendor=cmVendor, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portCardId=portCardId, cardHwVersion=cardHwVersion, cmResetNotification=cmResetNotification, cardPicDetected=cardPicDetected, systemKey=systemKey, portTxFlowControlDetected=portTxFlowControlDetected, cardRamSize=cardRamSize, downstreamPowerLoss=downstreamPowerLoss, errEvLogLevel=errEvLogLevel, equipmentCardGroup=equipmentCardGroup, equipmentCardTestGroup=equipmentCardTestGroup, cardAdminState=cardAdminState, cardDetectedChange=cardDetectedChange, diskVolumeName=diskVolumeName, trapCounter=trapCounter, diskVolumeSize=diskVolumeSize, auditLogOutput=auditLogOutput, cmUChannelID=cmUChannelID, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cmResetInfo=cmResetInfo, equipmentTbl=equipmentTbl, cardShelfTestIndex=cardShelfTestIndex, portType=portType, portEntry=portEntry, equipmentAuditGroup=equipmentAuditGroup, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portDocsIfIndex=portDocsIfIndex, diskVolumeId=diskVolumeId, auditDescription=auditDescription, cardCPLDVersion=cardCPLDVersion, cardPicSerialNum=cardPicSerialNum, portCardSubType=portCardSubType, eqDiagConfig=eqDiagConfig, cardTable=cardTable, cardLastBootVersion=cardLastBootVersion, cardTemperatureHighWarn=cardTemperatureHighWarn, auditTotalFailedCount=auditTotalFailedCount, errEvRecoveryEnabled=errEvRecoveryEnabled, cardTestResultNotification=cardTestResultNotification, portMaxDsPower=portMaxDsPower, cardPrState=cardPrState, diskVolumeFileName=diskVolumeFileName, portMinDsPower=portMinDsPower, portShelfId=portShelfId, cmResetClearNotification=cmResetClearNotification, cardTemperatureHighError=cardTemperatureHighError, equipmentAudit=equipmentAudit, cardNumPorts=cardNumPorts, diskVolumeTrapInh=diskVolumeTrapInh, auditAutoScheduling=auditAutoScheduling, portMacIfIndex=portMacIfIndex, cardFwVersion=cardFwVersion, fpgaErrorEventGroup=fpgaErrorEventGroup, portNumber=portNumber, portPrStateChange=portPrStateChange, cardBootVersion=cardBootVersion, cardCarrierSerialNum=cardCarrierSerialNum, cardTestScheduleCommand=cardTestScheduleCommand, diskVolumeShelfId=diskVolumeShelfId, portLastChangeTime=portLastChangeTime, cardEntry=cardEntry, portId=portId, diskVolumeTable=diskVolumeTable, cardTestTransId=cardTestTransId, fpgaErrorEventEntry=fpgaErrorEventEntry, cardShelfId=cardShelfId, diskVolumeUsageLevel=diskVolumeUsageLevel, TestResult=TestResult, verboseLevel=verboseLevel, cadEquipmentMibConformance=cadEquipmentMibConformance, cardLastBootSource=cardLastBootSource, cadEquipmentMibGroup=cadEquipmentMibGroup, shelfName=shelfName, portTable=portTable, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditPassedCount=auditPassedCount, equipmentDiagGroup=equipmentDiagGroup, cardCarrierFwVersion=cardCarrierFwVersion, portAdminState=portAdminState, cardSwVersion=cardSwVersion, cardSecStateChange=cardSecStateChange, cardFlashSize=cardFlashSize, cardDetected=cardDetected, cardSerialNum=cardSerialNum, auditStatus=auditStatus, cardTestTime=cardTestTime, portDplxStatus=portDplxStatus, auditCycleCount=auditCycleCount, cardSpareGroupMode=cardSpareGroupMode, cardAction=cardAction, systemGeneralGroup=systemGeneralGroup, shelfNumber=shelfNumber, systemClock=systemClock, cardBusSpeed=cardBusSpeed, cardTempOverHeatNotification=cardTempOverHeatNotification, shelfSwVersion=shelfSwVersion, equipmentState=equipmentState, cardUpTime=cardUpTime, portPrState=portPrState, equipmentStateGroup=equipmentStateGroup, cardCpuType=cardCpuType, cardTestIndex=cardTestIndex, systemGeneral=systemGeneral, trapSeverity=trapSeverity, equipmentDiag=equipmentDiag, portDetectedMode=portDetectedMode, portRxFlowControlMode=portRxFlowControlMode, auditTotalPassedCount=auditTotalPassedCount, cardSubType=cardSubType, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portSecState=portSecState, diskDriveNumber=diskDriveNumber, portNumChans=portNumChans)
