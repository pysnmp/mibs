...
PicType, SecondaryState, PortId, PrimaryState, DuplexStatus, CardType, AdminState, EqActionType, PortMode, UnknownState, FirmwareSource, FlowControlMode, CardSubType, CardId, PortDetectedMode, ShelfId, PortType, DiskVolumeUsageLevel = mibBuilder.importSymbols("CADANT-TC", "PicType", "SecondaryState", "PortId", "PrimaryState", "DuplexStatus", "CardType", "AdminState", "EqActionType", "PortMode", "UnknownState", "FirmwareSource", "FlowControlMode", "CardSubType", "CardId", "PortDetectedMode", "ShelfId", "PortType", "DiskVolumeUsageLevel")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
iso, TimeTicks, Bits, Counter64, Counter32, IpAddress, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, Unsigned32, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Bits", "Counter64", "Counter32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "Unsigned32", "Gauge32", "MibIdentifier")
TimeStamp, TruthValue, DisplayString, MacAddress, TextualConvention, RowStatus, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "DisplayString", "MacAddress", "TextualConvention", "RowStatus", "DateAndTime")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", auditTotalFailedCount=auditTotalFailedCount, remainInDiagMode=remainInDiagMode, cardHwVersion=cardHwVersion, portMacAddress=portMacAddress, portRxFlowControlMode=portRxFlowControlMode, portNumber=portNumber, auditLogOutput=auditLogOutput, diskVolumeName=diskVolumeName, auditCardId=auditCardId, auditName=auditName, cardCpuType=cardCpuType, portTrapInh=portTrapInh, shelfNumber=shelfNumber, portConnectorId=portConnectorId, auditShelfId=auditShelfId, cmResetStatus=cmResetStatus, cardTestDescription=cardTestDescription, auditCycleCount=auditCycleCount, cmResetClearNotification=cmResetClearNotification, cadEquipmentMibGroup=cadEquipmentMibGroup, shelfSwVersion=shelfSwVersion, equipmentCardGroup=equipmentCardGroup, auditId=auditId, TestSchedule=TestSchedule, cardFwUpdateStatus=cardFwUpdateStatus, diskVolumeTable=diskVolumeTable, auditFailedCount=auditFailedCount, cardAdminState=cardAdminState, errEvRecoveryEnabled=errEvRecoveryEnabled, cardShelfTestIndex=cardShelfTestIndex, equipmentState=equipmentState, portLastChangeTime=portLastChangeTime, cardBusSpeed=cardBusSpeed, cardPrState=cardPrState, cardLastBootVersion=cardLastBootVersion, cardTestSchedule=cardTestSchedule, auditPassedCount=auditPassedCount, portType=portType, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portTxFlowControlMode=portTxFlowControlMode, cardTestTime=cardTestTime, portBgpId=portBgpId, cmResetReason=cmResetReason, cardTable=cardTable, cardSubType=cardSubType, equipmentTraps=equipmentTraps, fpgaErrorEventEntry=fpgaErrorEventEntry, cardSecStateChange=cardSecStateChange, equipmentError=equipmentError, portMinDsPower=portMinDsPower, cardDplxStatusChange=cardDplxStatusChange, portTable=portTable, cmPrimarySID=cmPrimarySID, cardTrapInh=cardTrapInh, diskVolumeUsageLevel=diskVolumeUsageLevel, cardCarrierSerialNum=cardCarrierSerialNum, cardTemperatureHighWarn=cardTemperatureHighWarn, cardTestTransId=cardTestTransId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardId=cardId, cardLastResetReason=cardLastResetReason, auditDescription=auditDescription, portShelfId=portShelfId, TestScheduleCommand=TestScheduleCommand, cardNumPorts=cardNumPorts, diagTestId=diagTestId, cmResetUpTime=cmResetUpTime, errEvLoggingEnabled=errEvLoggingEnabled, cardTestResult=cardTestResult, auditTotalPassedCount=auditTotalPassedCount, cardTemperature=cardTemperature, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardDetectedChange=cardDetectedChange, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, equipmentTbl=equipmentTbl, verboseLevel=verboseLevel, auditLogThrottle=auditLogThrottle, equipmentCardTestGroup=equipmentCardTestGroup, cmVendor=cmVendor, cardTestEntry=cardTestEntry, portDetectedMode=portDetectedMode, diskVolumeSize=diskVolumeSize, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portMaxDsPower=portMaxDsPower, portSecStateChange=portSecStateChange, cardPicHwVersion=cardPicHwVersion, cardTestScheduleCommand=cardTestScheduleCommand, portTxFlowControlDetected=portTxFlowControlDetected, cmDevice=cmDevice, cardSpareGroupMode=cardSpareGroupMode, cardTestResultDesc=cardTestResultDesc, auditTable=auditTable, equipmentStateGroup=equipmentStateGroup, shelfObjects=shelfObjects, cadEquipmentMib=cadEquipmentMib, cardSecState=cardSecState, auditResult=auditResult, cardTestName=cardTestName, diskVolumeCardId=diskVolumeCardId, equipmentDiagGroup=equipmentDiagGroup, systemKey=systemKey, cmMacAddress=cmMacAddress, errEventId=errEventId, cardTestIndex=cardTestIndex, cardCarrierHwVersion=cardCarrierHwVersion, portPrStateChange=portPrStateChange, cardTempNoReportNotification=cardTempNoReportNotification, cardTestTable=cardTestTable, diskDriveNumber=diskDriveNumber, cardTestId=cardTestId, cadEquipmentMibConformance=cadEquipmentMibConformance, TestResult=TestResult, diskVolumeNumber=diskVolumeNumber, TestType=TestType, systemGeneralGroup=systemGeneralGroup, cardTemperatureHighError=cardTemperatureHighError, portEntry=portEntry, shelfName=shelfName, diskVolumeDriveId=diskVolumeDriveId, auditCommand=auditCommand, cardUpTime=cardUpTime, cmResetNotification=cmResetNotification, eqDiagConfig=eqDiagConfig, cardAction=cardAction, systemClock=systemClock, PYSNMP_MODULE_ID=cadEquipmentMib, TestTransactionId=TestTransactionId, cmIpAddress=cmIpAddress, portDplxStatusChange=portDplxStatusChange, cardPrStateChange=cardPrStateChange, diskVolumeDiskSize=diskVolumeDiskSize, cardTestCommand=cardTestCommand, consoleOutput=consoleOutput, cardRamSize=cardRamSize, portAction=portAction, cardPicSerialNum=cardPicSerialNum, cardDetected=cardDetected, diskVolumeFileName=diskVolumeFileName, systemGeneral=systemGeneral, cardCPLDVersion=cardCPLDVersion, cmResetInfo=cmResetInfo, diskVolumeId=diskVolumeId, cardFlashSize=cardFlashSize, portDescription=portDescription, equipmentAuditGroup=equipmentAuditGroup, fpgaErrorEventGroup=fpgaErrorEventGroup, portDocsIfIndex=portDocsIfIndex, portNumChans=portNumChans, diskVolumeTrapInh=diskVolumeTrapInh, cardFpgaSource=cardFpgaSource, cardFwVersion=cardFwVersion, cardTempOverHeatNotification=cardTempOverHeatNotification, cardLastChangeTime=cardLastChangeTime, cmUChannelID=cmUChannelID, cardEntry=cardEntry, diskVolumeShelfId=diskVolumeShelfId, trapCounter=trapCounter, auditEntry=auditEntry, cardSpareGroupId=cardSpareGroupId, portAdminState=portAdminState, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portPrState=portPrState, equipmentDiag=equipmentDiag, errEvRowStatus=errEvRowStatus, auditStatus=auditStatus, equipmentShelfGroup=equipmentShelfGroup, cardLastBootSource=cardLastBootSource, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeEntry=diskVolumeEntry, auditAutoScheduling=auditAutoScheduling, cardDplxStatus=cardDplxStatus, errEvLogLevel=errEvLogLevel, cardShelfId=cardShelfId, cmRegistrationNotification=cmRegistrationNotification, cardBootVersion=cardBootVersion, cardCarrierFwVersion=cardCarrierFwVersion, cardType=cardType, portCardId=portCardId, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, auditTime=auditTime, trapSeverity=trapSeverity, portCurrDsPower=portCurrDsPower, portSecState=portSecState, portDplxStatus=portDplxStatus, portCardSubType=portCardSubType, cardNumber=cardNumber, equipmentAudit=equipmentAudit, equipmentPortGroup=equipmentPortGroup, cardSubDetected=cardSubDetected, cardSwVersion=cardSwVersion, cardCpuSpeed=cardCpuSpeed, diskVolumeGroup=diskVolumeGroup, portMode=portMode, portId=portId, portMacIfIndex=portMacIfIndex, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardTestResultNotification=cardTestResultNotification, TestCommand=TestCommand, cardName=cardName, cardTestType=cardTestType, cardSerialNum=cardSerialNum, downstreamPowerLoss=downstreamPowerLoss, cardPicDetected=cardPicDetected, diskVolumeUsageNotification=diskVolumeUsageNotification, portRxFlowControlDetected=portRxFlowControlDetected, TestId=TestId, fpgaErrorEventTable=fpgaErrorEventTable)
