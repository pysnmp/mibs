...
CardType, PrimaryState, PicType, ShelfId, DiskVolumeUsageLevel, CardSubType, AdminState, DuplexStatus, PortDetectedMode, CardId, FlowControlMode, PortType, SecondaryState, UnknownState, EqActionType, PortId, FirmwareSource, PortMode = mibBuilder.importSymbols("CADANT-TC", "CardType", "PrimaryState", "PicType", "ShelfId", "DiskVolumeUsageLevel", "CardSubType", "AdminState", "DuplexStatus", "PortDetectedMode", "CardId", "FlowControlMode", "PortType", "SecondaryState", "UnknownState", "EqActionType", "PortId", "FirmwareSource", "PortMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
Unsigned32, NotificationType, TimeTicks, Counter64, ObjectIdentity, ModuleIdentity, Integer32, IpAddress, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "TimeTicks", "Counter64", "ObjectIdentity", "ModuleIdentity", "Integer32", "IpAddress", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "MibIdentifier")
DisplayString, DateAndTime, MacAddress, TextualConvention, TruthValue, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "DateAndTime", "MacAddress", "TextualConvention", "TruthValue", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portMinDsPower=portMinDsPower, systemGeneralGroup=systemGeneralGroup, cardCpuSpeed=cardCpuSpeed, equipmentError=equipmentError, cardTestTable=cardTestTable, cardPrState=cardPrState, systemGeneral=systemGeneral, cardRamSize=cardRamSize, cardTestEntry=cardTestEntry, portConnectorId=portConnectorId, cardUpTime=cardUpTime, cardDplxStatusChange=cardDplxStatusChange, cardType=cardType, TestType=TestType, cardTempOverHeatNotification=cardTempOverHeatNotification, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardName=cardName, auditLogThrottle=auditLogThrottle, cmResetInfo=cmResetInfo, auditTable=auditTable, cardCarrierHwVersion=cardCarrierHwVersion, cardTestResultNotification=cardTestResultNotification, cardSubType=cardSubType, cardLastBootVersion=cardLastBootVersion, fpgaErrorEventEntry=fpgaErrorEventEntry, auditTotalPassedCount=auditTotalPassedCount, cardCpuType=cardCpuType, portAction=portAction, auditCardId=auditCardId, cardSwVersion=cardSwVersion, trapCounter=trapCounter, cadEquipmentMib=cadEquipmentMib, auditCommand=auditCommand, cardCarrierSerialNum=cardCarrierSerialNum, cardSerialNum=cardSerialNum, shelfNumber=shelfNumber, cardDplxStatus=cardDplxStatus, diskVolumeSize=diskVolumeSize, portEntry=portEntry, portTable=portTable, portMacAddress=portMacAddress, portTxFlowControlDetected=portTxFlowControlDetected, auditName=auditName, cmResetReason=cmResetReason, cardTemperature=cardTemperature, portTxFlowControlMode=portTxFlowControlMode, cardPrStateChange=cardPrStateChange, cmResetNotification=cmResetNotification, auditTotalFailedCount=auditTotalFailedCount, cardLastChangeTime=cardLastChangeTime, cardDetected=cardDetected, auditDescription=auditDescription, portCurrDsPower=portCurrDsPower, equipmentPortGroup=equipmentPortGroup, verboseLevel=verboseLevel, diskVolumeUsageNotification=diskVolumeUsageNotification, cardCarrierFwVersion=cardCarrierFwVersion, portDplxStatus=portDplxStatus, remainInDiagMode=remainInDiagMode, auditFailedCount=auditFailedCount, auditResult=auditResult, cardAction=cardAction, systemClock=systemClock, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diskVolumeId=diskVolumeId, cmUChannelID=cmUChannelID, portId=portId, portPrState=portPrState, portPrStateChange=portPrStateChange, cardSecStateChange=cardSecStateChange, errEvLoggingEnabled=errEvLoggingEnabled, auditStatus=auditStatus, TestScheduleCommand=TestScheduleCommand, PYSNMP_MODULE_ID=cadEquipmentMib, equipmentCardTestGroup=equipmentCardTestGroup, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, equipmentDiagGroup=equipmentDiagGroup, fpgaErrorEventTable=fpgaErrorEventTable, cardFwUpdateStatus=cardFwUpdateStatus, cardHwVersion=cardHwVersion, eqDiagConfig=eqDiagConfig, portType=portType, portMaxDsPower=portMaxDsPower, portAdminState=portAdminState, cardLastBootSource=cardLastBootSource, cardTempNoReportNotification=cardTempNoReportNotification, cardPicHwVersion=cardPicHwVersion, portCardSubType=portCardSubType, fpgaErrorEventGroup=fpgaErrorEventGroup, cardTemperatureHighError=cardTemperatureHighError, cardTestCommand=cardTestCommand, TestSchedule=TestSchedule, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, TestId=TestId, diskVolumeFileName=diskVolumeFileName, portNumber=portNumber, cardEntry=cardEntry, cardSubDetected=cardSubDetected, cardTestTime=cardTestTime, portDescription=portDescription, cardPicDetected=cardPicDetected, cardNumPorts=cardNumPorts, equipmentState=equipmentState, equipmentAuditGroup=equipmentAuditGroup, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardBusSpeed=cardBusSpeed, auditTime=auditTime, auditCycleCount=auditCycleCount, auditPassedCount=auditPassedCount, portMacIfIndex=portMacIfIndex, cardShelfTestIndex=cardShelfTestIndex, equipmentStateGroup=equipmentStateGroup, portDocsIfIndex=portDocsIfIndex, auditAutoScheduling=auditAutoScheduling, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portSecStateChange=portSecStateChange, cardNumber=cardNumber, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portRxFlowControlMode=portRxFlowControlMode, diagTestId=diagTestId, cardTestResultDesc=cardTestResultDesc, cadEquipmentMibGroup=cadEquipmentMibGroup, diskVolumeNumber=diskVolumeNumber, portMode=portMode, errEvLogLevel=errEvLogLevel, portDplxStatusChange=portDplxStatusChange, cmResetClearNotification=cmResetClearNotification, diskVolumeDriveId=diskVolumeDriveId, cardTestScheduleCommand=cardTestScheduleCommand, equipmentCardGroup=equipmentCardGroup, diskDriveNumber=diskDriveNumber, diskVolumeEntry=diskVolumeEntry, portSecState=portSecState, cardTestType=cardTestType, TestTransactionId=TestTransactionId, diskVolumeShelfId=diskVolumeShelfId, diskVolumeCardId=diskVolumeCardId, cardTestName=cardTestName, cmVendor=cmVendor, diskVolumeGroup=diskVolumeGroup, errEventId=errEventId, cardDetectedChange=cardDetectedChange, cardFwVersion=cardFwVersion, portDetectedMode=portDetectedMode, diskVolumeTable=diskVolumeTable, portCardId=portCardId, cardLastResetReason=cardLastResetReason, cardPicSerialNum=cardPicSerialNum, cardFpgaSource=cardFpgaSource, TestCommand=TestCommand, cardSpareGroupId=cardSpareGroupId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardTestId=cardTestId, equipmentDiag=equipmentDiag, portRxFlowControlDetected=portRxFlowControlDetected, equipmentShelfGroup=equipmentShelfGroup, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, diskVolumeUsageLevel=diskVolumeUsageLevel, downstreamPowerLoss=downstreamPowerLoss, auditEntry=auditEntry, portNumChans=portNumChans, cardTestSchedule=cardTestSchedule, cardSpareGroupMode=cardSpareGroupMode, portShelfId=portShelfId, cardSecState=cardSecState, portTrapInh=portTrapInh, shelfName=shelfName, shelfSwVersion=shelfSwVersion, cardTestDescription=cardTestDescription, cmMacAddress=cmMacAddress, cardAdminState=cardAdminState, auditId=auditId, cardBootVersion=cardBootVersion, diskVolumeName=diskVolumeName, cmDevice=cmDevice, equipmentTraps=equipmentTraps, trapSeverity=trapSeverity, auditLogOutput=auditLogOutput, cardFlashSize=cardFlashSize, cardTemperatureHighWarn=cardTemperatureHighWarn, cmRegistrationNotification=cmRegistrationNotification, auditShelfId=auditShelfId, systemKey=systemKey, cmPrimarySID=cmPrimarySID, equipmentTbl=equipmentTbl, portBgpId=portBgpId, cmResetUpTime=cmResetUpTime, cmResetStatus=cmResetStatus, cardTestIndex=cardTestIndex, cardTestResult=cardTestResult, cardTestTransId=cardTestTransId, cardCPLDVersion=cardCPLDVersion, equipmentAudit=equipmentAudit, shelfObjects=shelfObjects, cadEquipmentMibConformance=cadEquipmentMibConformance, portLastChangeTime=portLastChangeTime, cardTable=cardTable, errEvRowStatus=errEvRowStatus, diskVolumeTrapInh=diskVolumeTrapInh, cardId=cardId, cmIpAddress=cmIpAddress, diskVolumeDiskSize=diskVolumeDiskSize, TestResult=TestResult, cardShelfId=cardShelfId, cardTrapInh=cardTrapInh, errEvRecoveryEnabled=errEvRecoveryEnabled, consoleOutput=consoleOutput)
