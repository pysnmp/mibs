...
PortId, FlowControlMode, PortType, CardType, CardSubType, EqActionType, DiskVolumeUsageLevel, UnknownState, ShelfId, AdminState, CardId, DuplexStatus, FirmwareSource, PicType, PortMode, PortDetectedMode, PrimaryState, SecondaryState = mibBuilder.importSymbols("CADANT-TC", "PortId", "FlowControlMode", "PortType", "CardType", "CardSubType", "EqActionType", "DiskVolumeUsageLevel", "UnknownState", "ShelfId", "AdminState", "CardId", "DuplexStatus", "FirmwareSource", "PicType", "PortMode", "PortDetectedMode", "PrimaryState", "SecondaryState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
iso, Unsigned32, Gauge32, TimeTicks, Counter64, Integer32, Counter32, ObjectIdentity, ModuleIdentity, Bits, MibIdentifier, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Gauge32", "TimeTicks", "Counter64", "Integer32", "Counter32", "ObjectIdentity", "ModuleIdentity", "Bits", "MibIdentifier", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, MacAddress, DateAndTime, TruthValue, RowStatus, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "MacAddress", "DateAndTime", "TruthValue", "RowStatus", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardBusSpeed=cardBusSpeed, TestResult=TestResult, cardTestSchedule=cardTestSchedule, cardCarrierFwVersion=cardCarrierFwVersion, TestType=TestType, diskVolumeEntry=diskVolumeEntry, remainInDiagMode=remainInDiagMode, portDocsIfIndex=portDocsIfIndex, diskVolumeCardId=diskVolumeCardId, equipmentCardGroup=equipmentCardGroup, portAction=portAction, auditId=auditId, diskVolumeDiskSize=diskVolumeDiskSize, diskVolumeId=diskVolumeId, cardLastResetReason=cardLastResetReason, cardTestTransId=cardTestTransId, diagTestId=diagTestId, cadEquipmentMib=cadEquipmentMib, TestSchedule=TestSchedule, cardDplxStatus=cardDplxStatus, cardId=cardId, cardCarrierSerialNum=cardCarrierSerialNum, fpgaErrorEventGroup=fpgaErrorEventGroup, cardTestId=cardTestId, fpgaErrorEventTable=fpgaErrorEventTable, cardTemperatureHighWarn=cardTemperatureHighWarn, consoleOutput=consoleOutput, shelfNumber=shelfNumber, diskVolumeNumber=diskVolumeNumber, equipmentDiag=equipmentDiag, systemGeneral=systemGeneral, cmPrimarySID=cmPrimarySID, auditTotalFailedCount=auditTotalFailedCount, errEvRecoveryEnabled=errEvRecoveryEnabled, portNumChans=portNumChans, trapSeverity=trapSeverity, cardBootVersion=cardBootVersion, auditFailedCount=auditFailedCount, cardCarrierHwVersion=cardCarrierHwVersion, cardSerialNum=cardSerialNum, cardTrapInh=cardTrapInh, cardLastBootVersion=cardLastBootVersion, cardCpuType=cardCpuType, cardCPLDVersion=cardCPLDVersion, cardLastBootSource=cardLastBootSource, cmMacAddress=cmMacAddress, auditDescription=auditDescription, cardNumPorts=cardNumPorts, auditAutoScheduling=auditAutoScheduling, portConnectorId=portConnectorId, portCardId=portCardId, portMode=portMode, portMinDsPower=portMinDsPower, equipmentPortGroup=equipmentPortGroup, equipmentStateGroup=equipmentStateGroup, portDplxStatus=portDplxStatus, cardSubType=cardSubType, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeFileName=diskVolumeFileName, systemKey=systemKey, TestCommand=TestCommand, errEventId=errEventId, portNumber=portNumber, cardPrStateChange=cardPrStateChange, portRxFlowControlMode=portRxFlowControlMode, cardSpareGroupId=cardSpareGroupId, portRxFlowControlDetected=portRxFlowControlDetected, portAdminState=portAdminState, cmVendor=cmVendor, equipmentShelfGroup=equipmentShelfGroup, auditResult=auditResult, auditTable=auditTable, portCardSubType=portCardSubType, equipmentTbl=equipmentTbl, shelfObjects=shelfObjects, systemGeneralGroup=systemGeneralGroup, cardTestResultNotification=cardTestResultNotification, cardTemperatureHighError=cardTemperatureHighError, portPrStateChange=portPrStateChange, equipmentAudit=equipmentAudit, cmDevice=cmDevice, portMacIfIndex=portMacIfIndex, trapCounter=trapCounter, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, equipmentState=equipmentState, cmResetUpTime=cmResetUpTime, PYSNMP_MODULE_ID=cadEquipmentMib, cardSecStateChange=cardSecStateChange, portId=portId, cardTestTime=cardTestTime, auditLogOutput=auditLogOutput, cardShelfTestIndex=cardShelfTestIndex, cardTestScheduleCommand=cardTestScheduleCommand, diskVolumeUsageNotification=diskVolumeUsageNotification, shelfSwVersion=shelfSwVersion, cardFlashSize=cardFlashSize, auditCommand=auditCommand, auditShelfId=auditShelfId, errEvLogLevel=errEvLogLevel, portMacAddress=portMacAddress, cardDplxStatusChange=cardDplxStatusChange, portDplxStatusChange=portDplxStatusChange, equipmentCardTestGroup=equipmentCardTestGroup, portTxFlowControlDetected=portTxFlowControlDetected, portDetectedMode=portDetectedMode, cmResetNotification=cmResetNotification, cardDetected=cardDetected, portLastChangeTime=portLastChangeTime, cardPicDetected=cardPicDetected, portTrapInh=portTrapInh, auditName=auditName, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardEntry=cardEntry, portSecStateChange=portSecStateChange, cardUpTime=cardUpTime, shelfName=shelfName, diskVolumeShelfId=diskVolumeShelfId, cardTestDescription=cardTestDescription, auditLogThrottle=auditLogThrottle, portMaxDsPower=portMaxDsPower, auditEntry=auditEntry, auditCardId=auditCardId, cardSubDetected=cardSubDetected, verboseLevel=verboseLevel, cardCpuSpeed=cardCpuSpeed, portShelfId=portShelfId, portPrState=portPrState, diskVolumeTrapInh=diskVolumeTrapInh, auditStatus=auditStatus, equipmentAuditGroup=equipmentAuditGroup, auditCycleCount=auditCycleCount, cardTestCommand=cardTestCommand, cardSecState=cardSecState, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diskVolumeGroup=diskVolumeGroup, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portTable=portTable, cardType=cardType, cardSwVersion=cardSwVersion, cardAdminState=cardAdminState, cadEquipmentMibGroup=cadEquipmentMibGroup, cmIpAddress=cmIpAddress, cardRamSize=cardRamSize, portTxFlowControlMode=portTxFlowControlMode, cmResetInfo=cmResetInfo, equipmentDiagGroup=equipmentDiagGroup, cardAction=cardAction, cardTestTable=cardTestTable, cardTestResult=cardTestResult, errEvRowStatus=errEvRowStatus, cmRegistrationNotification=cmRegistrationNotification, cardTempNoReportNotification=cardTempNoReportNotification, cmResetClearNotification=cmResetClearNotification, portCurrDsPower=portCurrDsPower, diskVolumeSize=diskVolumeSize, cardTestIndex=cardTestIndex, cmResetReason=cmResetReason, cmUChannelID=cmUChannelID, auditTime=auditTime, cardFwUpdateStatus=cardFwUpdateStatus, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diskDriveNumber=diskDriveNumber, cardTestType=cardTestType, portBgpId=portBgpId, cardTestResultDesc=cardTestResultDesc, cadEquipmentMibConformance=cadEquipmentMibConformance, diskVolumeName=diskVolumeName, cardTemperature=cardTemperature, auditPassedCount=auditPassedCount, cardSpareGroupMode=cardSpareGroupMode, TestScheduleCommand=TestScheduleCommand, portDescription=portDescription, cardDetectedChange=cardDetectedChange, equipmentError=equipmentError, cardTable=cardTable, eqDiagConfig=eqDiagConfig, cardNumber=cardNumber, auditTotalPassedCount=auditTotalPassedCount, cardFwVersion=cardFwVersion, cardHwVersion=cardHwVersion, diskVolumeUsageLevel=diskVolumeUsageLevel, errEvLoggingEnabled=errEvLoggingEnabled, cardFpgaSource=cardFpgaSource, cmResetStatus=cmResetStatus, TestId=TestId, cardTestName=cardTestName, portSecState=portSecState, cardPicSerialNum=cardPicSerialNum, cadEquipmentMibCompliances=cadEquipmentMibCompliances, downstreamPowerLoss=downstreamPowerLoss, cardLastChangeTime=cardLastChangeTime, cardPicHwVersion=cardPicHwVersion, equipmentTraps=equipmentTraps, TestTransactionId=TestTransactionId, cardShelfId=cardShelfId, cardTestEntry=cardTestEntry, diskVolumeDriveId=diskVolumeDriveId, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, diskVolumeTable=diskVolumeTable, cardName=cardName, cardPrState=cardPrState, portEntry=portEntry, fpgaErrorEventEntry=fpgaErrorEventEntry, portType=portType, systemClock=systemClock, diskVolumeUsagePercentage=diskVolumeUsagePercentage)
