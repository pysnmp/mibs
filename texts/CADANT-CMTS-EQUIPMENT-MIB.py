...
PortDetectedMode, AdminState, PrimaryState, EqActionType, FirmwareSource, DiskVolumeUsageLevel, DuplexStatus, ShelfId, FlowControlMode, PortId, PortType, CardType, PortMode, SecondaryState, PicType, CardId, UnknownState, CardSubType = mibBuilder.importSymbols("CADANT-TC", "PortDetectedMode", "AdminState", "PrimaryState", "EqActionType", "FirmwareSource", "DiskVolumeUsageLevel", "DuplexStatus", "ShelfId", "FlowControlMode", "PortId", "PortType", "CardType", "PortMode", "SecondaryState", "PicType", "CardId", "UnknownState", "CardSubType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
ModuleIdentity, Counter32, Counter64, Unsigned32, ObjectIdentity, Integer32, MibIdentifier, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Counter64", "Unsigned32", "ObjectIdentity", "Integer32", "MibIdentifier", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardTestIndex=cardTestIndex, portPrStateChange=portPrStateChange, cardSubType=cardSubType, TestScheduleCommand=TestScheduleCommand, cardPicSerialNum=cardPicSerialNum, diskVolumeSize=diskVolumeSize, auditCommand=auditCommand, fpgaErrorEventEntry=fpgaErrorEventEntry, cmResetNotification=cmResetNotification, diskVolumeUsagePercentage=diskVolumeUsagePercentage, equipmentPortGroup=equipmentPortGroup, TestType=TestType, cmPrimarySID=cmPrimarySID, equipmentCardGroup=equipmentCardGroup, cardTemperature=cardTemperature, portMacAddress=portMacAddress, auditCardId=auditCardId, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, diskDriveNumber=diskDriveNumber, cardAction=cardAction, cardCarrierHwVersion=cardCarrierHwVersion, cardSpareGroupId=cardSpareGroupId, cardCpuSpeed=cardCpuSpeed, portId=portId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardTestSchedule=cardTestSchedule, fpgaErrorEventTable=fpgaErrorEventTable, cardRamSize=cardRamSize, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardTestName=cardTestName, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTestScheduleCommand=cardTestScheduleCommand, systemGeneralGroup=systemGeneralGroup, TestResult=TestResult, cardFwVersion=cardFwVersion, portLastChangeTime=portLastChangeTime, diskVolumeEntry=diskVolumeEntry, cardTempNoReportNotification=cardTempNoReportNotification, TestCommand=TestCommand, cardSpareGroupMode=cardSpareGroupMode, diskVolumeGroup=diskVolumeGroup, cardCarrierFwVersion=cardCarrierFwVersion, cardTable=cardTable, systemClock=systemClock, cardPrState=cardPrState, cardType=cardType, cardDplxStatus=cardDplxStatus, portMinDsPower=portMinDsPower, verboseLevel=verboseLevel, portNumChans=portNumChans, cmRegistrationNotification=cmRegistrationNotification, portMacIfIndex=portMacIfIndex, trapSeverity=trapSeverity, cmResetClearNotification=cmResetClearNotification, cardFpgaSource=cardFpgaSource, portCardSubType=portCardSubType, portCardId=portCardId, cardTestDescription=cardTestDescription, equipmentTraps=equipmentTraps, portDplxStatusChange=portDplxStatusChange, cardFlashSize=cardFlashSize, equipmentShelfGroup=equipmentShelfGroup, shelfName=shelfName, cardShelfTestIndex=cardShelfTestIndex, diskVolumeShelfId=diskVolumeShelfId, auditDescription=auditDescription, TestId=TestId, cardEntry=cardEntry, cardBootVersion=cardBootVersion, cmUChannelID=cmUChannelID, errEvRecoveryEnabled=errEvRecoveryEnabled, portShelfId=portShelfId, cmDevice=cmDevice, diagTestId=diagTestId, diskVolumeNumber=diskVolumeNumber, equipmentTbl=equipmentTbl, cardLastBootSource=cardLastBootSource, auditResult=auditResult, portTrapInh=portTrapInh, diskVolumeDiskSize=diskVolumeDiskSize, cardTestTransId=cardTestTransId, portSecState=portSecState, cmIpAddress=cmIpAddress, auditStatus=auditStatus, cardUpTime=cardUpTime, cardTestTime=cardTestTime, cardSubDetected=cardSubDetected, portMode=portMode, trapCounter=trapCounter, cardTestResultNotification=cardTestResultNotification, portRxFlowControlMode=portRxFlowControlMode, auditShelfId=auditShelfId, cardDetected=cardDetected, portDplxStatus=portDplxStatus, eqDiagConfig=eqDiagConfig, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditLogOutput=auditLogOutput, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, TestSchedule=TestSchedule, auditLogThrottle=auditLogThrottle, cardTemperatureHighError=cardTemperatureHighError, auditEntry=auditEntry, cardLastChangeTime=cardLastChangeTime, shelfSwVersion=shelfSwVersion, portConnectorId=portConnectorId, portBgpId=portBgpId, diskVolumeId=diskVolumeId, cardSecStateChange=cardSecStateChange, errEvRowStatus=errEvRowStatus, cmResetStatus=cmResetStatus, cardCPLDVersion=cardCPLDVersion, equipmentDiag=equipmentDiag, cardFwUpdateStatus=cardFwUpdateStatus, equipmentAudit=equipmentAudit, cardCpuType=cardCpuType, cmResetUpTime=cmResetUpTime, auditTotalPassedCount=auditTotalPassedCount, auditName=auditName, portTxFlowControlDetected=portTxFlowControlDetected, cardTempOverHeatNotification=cardTempOverHeatNotification, cardHwVersion=cardHwVersion, cmVendor=cmVendor, cardLastBootVersion=cardLastBootVersion, portDetectedMode=portDetectedMode, fpgaErrorEventGroup=fpgaErrorEventGroup, diskVolumeFileName=diskVolumeFileName, cmResetInfo=cmResetInfo, cadEquipmentMibGroup=cadEquipmentMibGroup, auditFailedCount=auditFailedCount, equipmentCardTestGroup=equipmentCardTestGroup, diskVolumeTrapInh=diskVolumeTrapInh, cadEquipmentMibConformance=cadEquipmentMibConformance, diskVolumeCardId=diskVolumeCardId, cmResetReason=cmResetReason, cardDplxStatusChange=cardDplxStatusChange, equipmentError=equipmentError, diskVolumeTable=diskVolumeTable, cadEquipmentMib=cadEquipmentMib, auditTable=auditTable, portRxFlowControlDetected=portRxFlowControlDetected, systemGeneral=systemGeneral, portTxFlowControlMode=portTxFlowControlMode, cardDetectedChange=cardDetectedChange, downstreamPowerLoss=downstreamPowerLoss, cardNumber=cardNumber, portAdminState=portAdminState, remainInDiagMode=remainInDiagMode, cardTemperatureHighWarn=cardTemperatureHighWarn, cardTestResultDesc=cardTestResultDesc, cardPrStateChange=cardPrStateChange, cardTestType=cardTestType, portSecStateChange=portSecStateChange, auditAutoScheduling=auditAutoScheduling, auditId=auditId, auditCycleCount=auditCycleCount, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portCurrDsPower=portCurrDsPower, cardShelfId=cardShelfId, errEventId=errEventId, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardSwVersion=cardSwVersion, consoleOutput=consoleOutput, cardTrapInh=cardTrapInh, auditTotalFailedCount=auditTotalFailedCount, cardPicDetected=cardPicDetected, cardPicHwVersion=cardPicHwVersion, portNumber=portNumber, portEntry=portEntry, portPrState=portPrState, cardTestTable=cardTestTable, auditPassedCount=auditPassedCount, TestTransactionId=TestTransactionId, cardTestCommand=cardTestCommand, shelfNumber=shelfNumber, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeDriveId=diskVolumeDriveId, diskVolumeName=diskVolumeName, equipmentAuditGroup=equipmentAuditGroup, cardName=cardName, portTable=portTable, cmMacAddress=cmMacAddress, PYSNMP_MODULE_ID=cadEquipmentMib, cardTestResult=cardTestResult, errEvLogLevel=errEvLogLevel, cardSecState=cardSecState, portType=portType, cardTestId=cardTestId, portDocsIfIndex=portDocsIfIndex, shelfObjects=shelfObjects, cardSerialNum=cardSerialNum, errEvLoggingEnabled=errEvLoggingEnabled, cardId=cardId, equipmentState=equipmentState, equipmentDiagGroup=equipmentDiagGroup, cardAdminState=cardAdminState, auditTime=auditTime, portAction=portAction, cardCarrierSerialNum=cardCarrierSerialNum, cardNumPorts=cardNumPorts, portMaxDsPower=portMaxDsPower, equipmentStateGroup=equipmentStateGroup, cadEquipmentMibCompliance=cadEquipmentMibCompliance, systemKey=systemKey, cardTestEntry=cardTestEntry, portDescription=portDescription, cardBusSpeed=cardBusSpeed, cardLastResetReason=cardLastResetReason)
