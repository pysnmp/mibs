...
EqActionType, PortMode, CardSubType, PrimaryState, DuplexStatus, ShelfId, CardType, PortId, SecondaryState, FirmwareSource, PicType, FlowControlMode, DiskVolumeUsageLevel, PortDetectedMode, AdminState, CardId, PortType, UnknownState = mibBuilder.importSymbols("CADANT-TC", "EqActionType", "PortMode", "CardSubType", "PrimaryState", "DuplexStatus", "ShelfId", "CardType", "PortId", "SecondaryState", "FirmwareSource", "PicType", "FlowControlMode", "DiskVolumeUsageLevel", "PortDetectedMode", "AdminState", "CardId", "PortType", "UnknownState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
iso, Integer32, Counter64, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, ObjectIdentity, ModuleIdentity, Counter32, MibIdentifier, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Counter64", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "ObjectIdentity", "ModuleIdentity", "Counter32", "MibIdentifier", "NotificationType", "TimeTicks")
DateAndTime, DisplayString, TextualConvention, RowStatus, TimeStamp, MacAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "TextualConvention", "RowStatus", "TimeStamp", "MacAddress", "TruthValue")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portCurrDsPower=portCurrDsPower, cardTestResultNotification=cardTestResultNotification, cardPicHwVersion=cardPicHwVersion, systemGeneralGroup=systemGeneralGroup, auditTotalFailedCount=auditTotalFailedCount, portTable=portTable, portNumber=portNumber, cardTestIndex=cardTestIndex, cardHwVersion=cardHwVersion, TestSchedule=TestSchedule, cardTestDescription=cardTestDescription, portTxFlowControlDetected=portTxFlowControlDetected, auditTable=auditTable, shelfSwVersion=shelfSwVersion, cardType=cardType, cadEquipmentMibGroup=cadEquipmentMibGroup, cardPicSerialNum=cardPicSerialNum, diskVolumeUsageNotification=diskVolumeUsageNotification, cardLastResetReason=cardLastResetReason, eqDiagConfig=eqDiagConfig, cardTempOverHeatNotification=cardTempOverHeatNotification, cardPicDetected=cardPicDetected, cardDetectedChange=cardDetectedChange, cardTable=cardTable, cardTrapInh=cardTrapInh, portId=portId, cmResetReason=cmResetReason, cardEntry=cardEntry, cadEquipmentMibCompliances=cadEquipmentMibCompliances, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, auditShelfId=auditShelfId, auditAutoScheduling=auditAutoScheduling, cmPrimarySID=cmPrimarySID, cardAction=cardAction, errEvRowStatus=errEvRowStatus, cardSecState=cardSecState, TestId=TestId, systemKey=systemKey, cardSubDetected=cardSubDetected, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, downstreamPowerLoss=downstreamPowerLoss, cardCarrierSerialNum=cardCarrierSerialNum, equipmentAuditGroup=equipmentAuditGroup, trapSeverity=trapSeverity, cardTemperatureHighError=cardTemperatureHighError, portSecState=portSecState, errEvLogLevel=errEvLogLevel, cardTempNoReportNotification=cardTempNoReportNotification, cardPrState=cardPrState, diskVolumeDiskSize=diskVolumeDiskSize, auditId=auditId, cadEquipmentMibConformance=cadEquipmentMibConformance, equipmentPortGroup=equipmentPortGroup, shelfNumber=shelfNumber, cardSpareGroupId=cardSpareGroupId, portTrapInh=portTrapInh, cmVendor=cmVendor, cardName=cardName, equipmentStateGroup=equipmentStateGroup, diskVolumeCardId=diskVolumeCardId, diagTestId=diagTestId, auditPassedCount=auditPassedCount, portDocsIfIndex=portDocsIfIndex, cardAdminState=cardAdminState, portConnectorId=portConnectorId, errEvRecoveryEnabled=errEvRecoveryEnabled, equipmentCardGroup=equipmentCardGroup, verboseLevel=verboseLevel, cardShelfId=cardShelfId, portMinDsPower=portMinDsPower, equipmentDiagGroup=equipmentDiagGroup, trapCounter=trapCounter, TestTransactionId=TestTransactionId, cardLastBootVersion=cardLastBootVersion, portMacIfIndex=portMacIfIndex, diskVolumeSize=diskVolumeSize, diskVolumeFileName=diskVolumeFileName, auditDescription=auditDescription, shelfObjects=shelfObjects, cardBusSpeed=cardBusSpeed, cardTestId=cardTestId, auditName=auditName, cmIpAddress=cmIpAddress, portTxFlowControlMode=portTxFlowControlMode, portDplxStatusChange=portDplxStatusChange, PYSNMP_MODULE_ID=cadEquipmentMib, cardTemperatureHighWarn=cardTemperatureHighWarn, portShelfId=portShelfId, cmResetUpTime=cmResetUpTime, cardPrStateChange=cardPrStateChange, equipmentDiag=equipmentDiag, diskDriveNumber=diskDriveNumber, cardFlashSize=cardFlashSize, diskVolumeShelfId=diskVolumeShelfId, portNumChans=portNumChans, cardCPLDVersion=cardCPLDVersion, cardId=cardId, cardNumPorts=cardNumPorts, cardCpuType=cardCpuType, portDescription=portDescription, auditCycleCount=auditCycleCount, cardSecStateChange=cardSecStateChange, diskVolumeId=diskVolumeId, cardTestScheduleCommand=cardTestScheduleCommand, cardTestEntry=cardTestEntry, cmUChannelID=cmUChannelID, cardCarrierHwVersion=cardCarrierHwVersion, cardFwVersion=cardFwVersion, TestType=TestType, portEntry=portEntry, portType=portType, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditStatus=auditStatus, errEvLoggingEnabled=errEvLoggingEnabled, auditResult=auditResult, fpgaErrorEventTable=fpgaErrorEventTable, cmResetNotification=cmResetNotification, auditEntry=auditEntry, portSecStateChange=portSecStateChange, diskVolumeTable=diskVolumeTable, cardShelfTestIndex=cardShelfTestIndex, cardRamSize=cardRamSize, cmResetClearNotification=cmResetClearNotification, portPrStateChange=portPrStateChange, portPrState=portPrState, fpgaErrorEventGroup=fpgaErrorEventGroup, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, equipmentTraps=equipmentTraps, auditFailedCount=auditFailedCount, cardDetected=cardDetected, equipmentTbl=equipmentTbl, portMode=portMode, cardBootVersion=cardBootVersion, auditCommand=auditCommand, cardNumber=cardNumber, portRxFlowControlMode=portRxFlowControlMode, systemGeneral=systemGeneral, cardTestResult=cardTestResult, auditTime=auditTime, cmRegistrationNotification=cmRegistrationNotification, cardCpuSpeed=cardCpuSpeed, cmMacAddress=cmMacAddress, equipmentState=equipmentState, errEventId=errEventId, portCardId=portCardId, portBgpId=portBgpId, diskVolumeGroup=diskVolumeGroup, cardFwUpdateStatus=cardFwUpdateStatus, auditTotalPassedCount=auditTotalPassedCount, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeNumber=diskVolumeNumber, cardTemperature=cardTemperature, cardDplxStatus=cardDplxStatus, cmDevice=cmDevice, auditLogOutput=auditLogOutput, consoleOutput=consoleOutput, cardFpgaSource=cardFpgaSource, portRxFlowControlDetected=portRxFlowControlDetected, cardTestName=cardTestName, cmResetInfo=cmResetInfo, cardTestTime=cardTestTime, TestCommand=TestCommand, portAction=portAction, diskVolumeDriveId=diskVolumeDriveId, equipmentError=equipmentError, remainInDiagMode=remainInDiagMode, portMaxDsPower=portMaxDsPower, equipmentAudit=equipmentAudit, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cadEquipmentMib=cadEquipmentMib, equipmentCardTestGroup=equipmentCardTestGroup, portDplxStatus=portDplxStatus, cardTestSchedule=cardTestSchedule, cardTestCommand=cardTestCommand, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardSwVersion=cardSwVersion, cardSubType=cardSubType, portAdminState=portAdminState, auditLogThrottle=auditLogThrottle, TestResult=TestResult, TestScheduleCommand=TestScheduleCommand, cardSpareGroupMode=cardSpareGroupMode, portLastChangeTime=portLastChangeTime, portCardSubType=portCardSubType, cardLastChangeTime=cardLastChangeTime, diskVolumeName=diskVolumeName, portDetectedMode=portDetectedMode, systemClock=systemClock, diskVolumeEntry=diskVolumeEntry, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cmResetStatus=cmResetStatus, diskVolumeTrapInh=diskVolumeTrapInh, cardTestTransId=cardTestTransId, portMacAddress=portMacAddress, cardUpTime=cardUpTime, fpgaErrorEventEntry=fpgaErrorEventEntry, shelfName=shelfName, cardTestType=cardTestType, cardDplxStatusChange=cardDplxStatusChange, cardTestResultDesc=cardTestResultDesc, cardTestTable=cardTestTable, cardSerialNum=cardSerialNum, equipmentShelfGroup=equipmentShelfGroup, cardLastBootSource=cardLastBootSource, auditCardId=auditCardId, cardCarrierFwVersion=cardCarrierFwVersion)
