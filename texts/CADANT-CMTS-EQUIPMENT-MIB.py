...
FirmwareSource, PortMode, PortType, DiskVolumeUsageLevel, PicType, AdminState, SecondaryState, PrimaryState, PortDetectedMode, UnknownState, DuplexStatus, FlowControlMode, PortId, ShelfId, CardSubType, CardId, CardType, EqActionType = mibBuilder.importSymbols("CADANT-TC", "FirmwareSource", "PortMode", "PortType", "DiskVolumeUsageLevel", "PicType", "AdminState", "SecondaryState", "PrimaryState", "PortDetectedMode", "UnknownState", "DuplexStatus", "FlowControlMode", "PortId", "ShelfId", "CardSubType", "CardId", "CardType", "EqActionType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
Counter32, Gauge32, ModuleIdentity, MibIdentifier, Counter64, Unsigned32, Bits, TimeTicks, ObjectIdentity, iso, IpAddress, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ModuleIdentity", "MibIdentifier", "Counter64", "Unsigned32", "Bits", "TimeTicks", "ObjectIdentity", "iso", "IpAddress", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
DateAndTime, TextualConvention, RowStatus, TruthValue, MacAddress, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "RowStatus", "TruthValue", "MacAddress", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardBootVersion=cardBootVersion, portAdminState=portAdminState, cardAdminState=cardAdminState, TestResult=TestResult, cardTestScheduleCommand=cardTestScheduleCommand, cardTestSchedule=cardTestSchedule, portSecStateChange=portSecStateChange, portMaxDsPower=portMaxDsPower, portDplxStatusChange=portDplxStatusChange, cmPrimarySID=cmPrimarySID, auditCycleCount=auditCycleCount, cmIpAddress=cmIpAddress, shelfSwVersion=shelfSwVersion, auditId=auditId, portNumChans=portNumChans, portPrStateChange=portPrStateChange, cardPrStateChange=cardPrStateChange, portDescription=portDescription, diskVolumeTable=diskVolumeTable, verboseLevel=verboseLevel, portTxFlowControlMode=portTxFlowControlMode, portMode=portMode, cardFpgaSource=cardFpgaSource, cardFwUpdateStatus=cardFwUpdateStatus, diagTestId=diagTestId, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTestIndex=cardTestIndex, auditTime=auditTime, auditCardId=auditCardId, auditAutoScheduling=auditAutoScheduling, shelfObjects=shelfObjects, cardCarrierSerialNum=cardCarrierSerialNum, auditLogOutput=auditLogOutput, fpgaErrorEventGroup=fpgaErrorEventGroup, cardSubType=cardSubType, cardLastBootVersion=cardLastBootVersion, portShelfId=portShelfId, diskVolumeEntry=diskVolumeEntry, cardTestCommand=cardTestCommand, cardPicHwVersion=cardPicHwVersion, cardDplxStatusChange=cardDplxStatusChange, cardTestName=cardTestName, diskVolumeId=diskVolumeId, cardCpuSpeed=cardCpuSpeed, cmResetClearNotification=cmResetClearNotification, auditFailedCount=auditFailedCount, equipmentError=equipmentError, cardTemperatureHighWarn=cardTemperatureHighWarn, TestCommand=TestCommand, cardSpareGroupId=cardSpareGroupId, portTable=portTable, remainInDiagMode=remainInDiagMode, cardSpareGroupMode=cardSpareGroupMode, cardTestTime=cardTestTime, portCurrDsPower=portCurrDsPower, diskVolumeUsageLevel=diskVolumeUsageLevel, cardId=cardId, cardTempNoReportNotification=cardTempNoReportNotification, equipmentShelfGroup=equipmentShelfGroup, cardTempOverHeatNotification=cardTempOverHeatNotification, cardSecState=cardSecState, equipmentTraps=equipmentTraps, TestType=TestType, errEventId=errEventId, cadEquipmentMibGroup=cadEquipmentMibGroup, cmResetUpTime=cmResetUpTime, auditName=auditName, cardLastResetReason=cardLastResetReason, cmResetReason=cmResetReason, auditTable=auditTable, portRxFlowControlMode=portRxFlowControlMode, cardTestDescription=cardTestDescription, equipmentTbl=equipmentTbl, auditCommand=auditCommand, cmResetInfo=cmResetInfo, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardNumPorts=cardNumPorts, portMacAddress=portMacAddress, portDplxStatus=portDplxStatus, auditTotalFailedCount=auditTotalFailedCount, diskDriveNumber=diskDriveNumber, cardTestResult=cardTestResult, diskVolumeName=diskVolumeName, cardPrState=cardPrState, systemKey=systemKey, portMacIfIndex=portMacIfIndex, cardLastChangeTime=cardLastChangeTime, auditDescription=auditDescription, cardTestResultNotification=cardTestResultNotification, errEvLoggingEnabled=errEvLoggingEnabled, portLastChangeTime=portLastChangeTime, portDetectedMode=portDetectedMode, cardSwVersion=cardSwVersion, eqDiagConfig=eqDiagConfig, consoleOutput=consoleOutput, cardDplxStatus=cardDplxStatus, errEvRowStatus=errEvRowStatus, diskVolumeSize=diskVolumeSize, diskVolumeTrapInh=diskVolumeTrapInh, diskVolumeGroup=diskVolumeGroup, cardFwVersion=cardFwVersion, cardTrapInh=cardTrapInh, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditShelfId=auditShelfId, cardCPLDVersion=cardCPLDVersion, cardTemperatureHighError=cardTemperatureHighError, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardLastBootSource=cardLastBootSource, trapSeverity=trapSeverity, shelfNumber=shelfNumber, cardFlashSize=cardFlashSize, fpgaErrorEventEntry=fpgaErrorEventEntry, cardTestTransId=cardTestTransId, diskVolumeNumber=diskVolumeNumber, portTrapInh=portTrapInh, cmResetStatus=cmResetStatus, auditResult=auditResult, downstreamPowerLoss=downstreamPowerLoss, diskVolumeDriveId=diskVolumeDriveId, TestSchedule=TestSchedule, cmResetNotification=cmResetNotification, systemGeneralGroup=systemGeneralGroup, TestTransactionId=TestTransactionId, cardDetectedChange=cardDetectedChange, cardEntry=cardEntry, errEvRecoveryEnabled=errEvRecoveryEnabled, equipmentPortGroup=equipmentPortGroup, cardSubDetected=cardSubDetected, portAction=portAction, equipmentCardGroup=equipmentCardGroup, cardTestType=cardTestType, cardSecStateChange=cardSecStateChange, diskVolumeCardId=diskVolumeCardId, cardPicSerialNum=cardPicSerialNum, cardName=cardName, cardShelfTestIndex=cardShelfTestIndex, cardHwVersion=cardHwVersion, cardRamSize=cardRamSize, portCardId=portCardId, cardCarrierFwVersion=cardCarrierFwVersion, cardTestId=cardTestId, cardType=cardType, equipmentState=equipmentState, portPrState=portPrState, cardTestResultDesc=cardTestResultDesc, portEntry=portEntry, diskVolumeShelfId=diskVolumeShelfId, diskVolumeDiskSize=diskVolumeDiskSize, auditStatus=auditStatus, systemClock=systemClock, cardTestEntry=cardTestEntry, portType=portType, portCardSubType=portCardSubType, cmVendor=cmVendor, portDocsIfIndex=portDocsIfIndex, cardUpTime=cardUpTime, portSecState=portSecState, cardPicDetected=cardPicDetected, cmDevice=cmDevice, fpgaErrorEventTable=fpgaErrorEventTable, portConnectorId=portConnectorId, cadEquipmentMibConformance=cadEquipmentMibConformance, cmRegistrationNotification=cmRegistrationNotification, cmMacAddress=cmMacAddress, cardCarrierHwVersion=cardCarrierHwVersion, equipmentCardTestGroup=equipmentCardTestGroup, cardDetected=cardDetected, equipmentDiagGroup=equipmentDiagGroup, cardCpuType=cardCpuType, errEvLogLevel=errEvLogLevel, equipmentAuditGroup=equipmentAuditGroup, auditLogThrottle=auditLogThrottle, equipmentAudit=equipmentAudit, portNumber=portNumber, cardBusSpeed=cardBusSpeed, trapCounter=trapCounter, cmUChannelID=cmUChannelID, cardTemperature=cardTemperature, auditEntry=auditEntry, cardNumber=cardNumber, equipmentDiag=equipmentDiag, auditPassedCount=auditPassedCount, auditTotalPassedCount=auditTotalPassedCount, TestId=TestId, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portBgpId=portBgpId, cardShelfId=cardShelfId, cardAction=cardAction, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portMinDsPower=portMinDsPower, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, equipmentStateGroup=equipmentStateGroup, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardTestTable=cardTestTable, systemGeneral=systemGeneral, TestScheduleCommand=TestScheduleCommand, portId=portId, cadEquipmentMib=cadEquipmentMib, shelfName=shelfName, PYSNMP_MODULE_ID=cadEquipmentMib, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeFileName=diskVolumeFileName, cardTable=cardTable, cardSerialNum=cardSerialNum)
