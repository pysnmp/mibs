...
PrimaryState, AdminState, FlowControlMode, PicType, PortId, PortDetectedMode, PortType, SecondaryState, CardId, CardType, FirmwareSource, EqActionType, DiskVolumeUsageLevel, PortMode, ShelfId, DuplexStatus, CardSubType, UnknownState = mibBuilder.importSymbols("CADANT-TC", "PrimaryState", "AdminState", "FlowControlMode", "PicType", "PortId", "PortDetectedMode", "PortType", "SecondaryState", "CardId", "CardType", "FirmwareSource", "EqActionType", "DiskVolumeUsageLevel", "PortMode", "ShelfId", "DuplexStatus", "CardSubType", "UnknownState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
Counter64, NotificationType, Gauge32, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Unsigned32, iso, ObjectIdentity, Bits, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "Gauge32", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Unsigned32", "iso", "ObjectIdentity", "Bits", "MibIdentifier", "ModuleIdentity")
MacAddress, TimeStamp, RowStatus, TruthValue, DateAndTime, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TimeStamp", "RowStatus", "TruthValue", "DateAndTime", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portDplxStatusChange=portDplxStatusChange, cmVendor=cmVendor, diskVolumeDriveId=diskVolumeDriveId, cardTemperature=cardTemperature, diskVolumeTable=diskVolumeTable, cadEquipmentMibConformance=cadEquipmentMibConformance, cardShelfId=cardShelfId, cardFwVersion=cardFwVersion, portMinDsPower=portMinDsPower, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditDescription=auditDescription, cardShelfTestIndex=cardShelfTestIndex, cadEquipmentMibGroup=cadEquipmentMibGroup, portBgpId=portBgpId, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTempOverHeatNotification=cardTempOverHeatNotification, systemGeneral=systemGeneral, diskDriveNumber=diskDriveNumber, portType=portType, portTxFlowControlDetected=portTxFlowControlDetected, cardTestResultNotification=cardTestResultNotification, TestResult=TestResult, portAction=portAction, cardAction=cardAction, diskVolumeDiskSize=diskVolumeDiskSize, equipmentAudit=equipmentAudit, cardDetectedChange=cardDetectedChange, equipmentCardTestGroup=equipmentCardTestGroup, auditResult=auditResult, cmRegistrationNotification=cmRegistrationNotification, portNumChans=portNumChans, cardHwVersion=cardHwVersion, auditCommand=auditCommand, diskVolumeNumber=diskVolumeNumber, auditTable=auditTable, TestSchedule=TestSchedule, cardFlashSize=cardFlashSize, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portSecStateChange=portSecStateChange, cardTemperatureHighError=cardTemperatureHighError, cadEquipmentMib=cadEquipmentMib, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardFwUpdateStatus=cardFwUpdateStatus, cardAdminState=cardAdminState, portDplxStatus=portDplxStatus, equipmentError=equipmentError, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardPicSerialNum=cardPicSerialNum, cardLastBootVersion=cardLastBootVersion, portNumber=portNumber, auditTotalPassedCount=auditTotalPassedCount, equipmentCardGroup=equipmentCardGroup, fpgaErrorEventEntry=fpgaErrorEventEntry, auditLogOutput=auditLogOutput, TestType=TestType, cardType=cardType, cardTestId=cardTestId, diskVolumeEntry=diskVolumeEntry, diskVolumeSize=diskVolumeSize, cardRamSize=cardRamSize, cardTestResultDesc=cardTestResultDesc, auditName=auditName, cardSerialNum=cardSerialNum, cmResetInfo=cmResetInfo, auditId=auditId, portRxFlowControlDetected=portRxFlowControlDetected, cardTable=cardTable, auditTotalFailedCount=auditTotalFailedCount, cardLastChangeTime=cardLastChangeTime, cardTestTable=cardTestTable, errEventId=errEventId, auditCardId=auditCardId, auditFailedCount=auditFailedCount, systemClock=systemClock, consoleOutput=consoleOutput, cmResetClearNotification=cmResetClearNotification, diskVolumeShelfId=diskVolumeShelfId, errEvRecoveryEnabled=errEvRecoveryEnabled, diskVolumeId=diskVolumeId, portAdminState=portAdminState, shelfSwVersion=shelfSwVersion, cardTestIndex=cardTestIndex, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cmResetReason=cmResetReason, cmPrimarySID=cmPrimarySID, errEvLogLevel=errEvLogLevel, portTable=portTable, portSecState=portSecState, equipmentTbl=equipmentTbl, portMacIfIndex=portMacIfIndex, cardCpuSpeed=cardCpuSpeed, cardTestTransId=cardTestTransId, cardPrStateChange=cardPrStateChange, downstreamPowerLoss=downstreamPowerLoss, cardSecState=cardSecState, cmDevice=cmDevice, auditCycleCount=auditCycleCount, errEvLoggingEnabled=errEvLoggingEnabled, cardNumPorts=cardNumPorts, errEvRowStatus=errEvRowStatus, cardFpgaSource=cardFpgaSource, cardTestEntry=cardTestEntry, portPrStateChange=portPrStateChange, portCardSubType=portCardSubType, cardCarrierSerialNum=cardCarrierSerialNum, diskVolumeUsageLevel=diskVolumeUsageLevel, cardName=cardName, portTxFlowControlMode=portTxFlowControlMode, shelfName=shelfName, equipmentDiag=equipmentDiag, cardPicHwVersion=cardPicHwVersion, equipmentState=equipmentState, cmIpAddress=cmIpAddress, portEntry=portEntry, portTrapInh=portTrapInh, cardTestSchedule=cardTestSchedule, portMode=portMode, fpgaErrorEventTable=fpgaErrorEventTable, portLastChangeTime=portLastChangeTime, cardTestDescription=cardTestDescription, cmResetNotification=cmResetNotification, diskVolumeTrapInh=diskVolumeTrapInh, portMacAddress=portMacAddress, diskVolumeFileName=diskVolumeFileName, trapSeverity=trapSeverity, auditPassedCount=auditPassedCount, auditShelfId=auditShelfId, auditStatus=auditStatus, diskVolumeGroup=diskVolumeGroup, cardTestResult=cardTestResult, auditLogThrottle=auditLogThrottle, cardTestTime=cardTestTime, equipmentDiagGroup=equipmentDiagGroup, portConnectorId=portConnectorId, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, TestId=TestId, cardEntry=cardEntry, cardTrapInh=cardTrapInh, cmMacAddress=cmMacAddress, cardCarrierHwVersion=cardCarrierHwVersion, equipmentShelfGroup=equipmentShelfGroup, portDetectedMode=portDetectedMode, cardTestName=cardTestName, portPrState=portPrState, cardDplxStatus=cardDplxStatus, diskVolumeCardId=diskVolumeCardId, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardDplxStatusChange=cardDplxStatusChange, equipmentPortGroup=equipmentPortGroup, portMaxDsPower=portMaxDsPower, remainInDiagMode=remainInDiagMode, cardSecStateChange=cardSecStateChange, equipmentAuditGroup=equipmentAuditGroup, portCardId=portCardId, cardId=cardId, cardLastBootSource=cardLastBootSource, shelfNumber=shelfNumber, cardSpareGroupId=cardSpareGroupId, equipmentStateGroup=equipmentStateGroup, cmResetUpTime=cmResetUpTime, cmResetStatus=cmResetStatus, cardTemperatureHighWarn=cardTemperatureHighWarn, portShelfId=portShelfId, cardUpTime=cardUpTime, cmUChannelID=cmUChannelID, cardTempNoReportNotification=cardTempNoReportNotification, cardSubType=cardSubType, PYSNMP_MODULE_ID=cadEquipmentMib, cardPicDetected=cardPicDetected, cardTestScheduleCommand=cardTestScheduleCommand, diskVolumeName=diskVolumeName, shelfObjects=shelfObjects, auditTime=auditTime, TestTransactionId=TestTransactionId, trapCounter=trapCounter, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portDescription=portDescription, fpgaErrorEventGroup=fpgaErrorEventGroup, cardDetected=cardDetected, auditAutoScheduling=auditAutoScheduling, cardCpuType=cardCpuType, portDocsIfIndex=portDocsIfIndex, cardSubDetected=cardSubDetected, cardSpareGroupMode=cardSpareGroupMode, equipmentTraps=equipmentTraps, cardTestType=cardTestType, cardSwVersion=cardSwVersion, cardLastResetReason=cardLastResetReason, cardPrState=cardPrState, cardCPLDVersion=cardCPLDVersion, diagTestId=diagTestId, auditEntry=auditEntry, TestScheduleCommand=TestScheduleCommand, cardBootVersion=cardBootVersion, cardTestCommand=cardTestCommand, cardBusSpeed=cardBusSpeed, portId=portId, portRxFlowControlMode=portRxFlowControlMode, portCurrDsPower=portCurrDsPower, eqDiagConfig=eqDiagConfig, systemKey=systemKey, verboseLevel=verboseLevel, TestCommand=TestCommand, systemGeneralGroup=systemGeneralGroup, cardNumber=cardNumber)
