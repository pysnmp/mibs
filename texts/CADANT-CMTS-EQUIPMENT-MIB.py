...
UnknownState, FlowControlMode, AdminState, PrimaryState, PortType, PortDetectedMode, DiskVolumeUsageLevel, PortMode, FirmwareSource, ShelfId, DuplexStatus, SecondaryState, PicType, CardSubType, CardType, EqActionType, CardId, PortId = mibBuilder.importSymbols("CADANT-TC", "UnknownState", "FlowControlMode", "AdminState", "PrimaryState", "PortType", "PortDetectedMode", "DiskVolumeUsageLevel", "PortMode", "FirmwareSource", "ShelfId", "DuplexStatus", "SecondaryState", "PicType", "CardSubType", "CardType", "EqActionType", "CardId", "PortId")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
Counter64, Gauge32, iso, IpAddress, TimeTicks, NotificationType, Bits, ObjectIdentity, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "iso", "IpAddress", "TimeTicks", "NotificationType", "Bits", "ObjectIdentity", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "MibIdentifier")
TimeStamp, TruthValue, DateAndTime, RowStatus, TextualConvention, MacAddress, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "DateAndTime", "RowStatus", "TextualConvention", "MacAddress", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", auditCardId=auditCardId, diskVolumeDiskSize=diskVolumeDiskSize, equipmentPortGroup=equipmentPortGroup, auditLogOutput=auditLogOutput, cadEquipmentMibConformance=cadEquipmentMibConformance, diskVolumeUsageLevel=diskVolumeUsageLevel, cardLastBootVersion=cardLastBootVersion, cardPicSerialNum=cardPicSerialNum, cardDetectedChange=cardDetectedChange, cardTestScheduleCommand=cardTestScheduleCommand, TestScheduleCommand=TestScheduleCommand, portSecStateChange=portSecStateChange, TestTransactionId=TestTransactionId, cardTempOverHeatNotification=cardTempOverHeatNotification, equipmentShelfGroup=equipmentShelfGroup, cardCarrierFwVersion=cardCarrierFwVersion, portDplxStatus=portDplxStatus, diskDriveNumber=diskDriveNumber, equipmentCardGroup=equipmentCardGroup, auditLogThrottle=auditLogThrottle, cmRegistrationNotification=cmRegistrationNotification, cardTemperatureHighWarn=cardTemperatureHighWarn, portSecState=portSecState, portRxFlowControlMode=portRxFlowControlMode, auditTime=auditTime, auditStatus=auditStatus, systemClock=systemClock, auditTable=auditTable, cardHwVersion=cardHwVersion, cardTestName=cardTestName, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portId=portId, cardPrState=cardPrState, portNumChans=portNumChans, consoleOutput=consoleOutput, cmResetClearNotification=cmResetClearNotification, eqDiagConfig=eqDiagConfig, cardTestResult=cardTestResult, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, auditCycleCount=auditCycleCount, portDescription=portDescription, cardTempNoReportNotification=cardTempNoReportNotification, portTrapInh=portTrapInh, cardShelfTestIndex=cardShelfTestIndex, cardTemperature=cardTemperature, cardPrStateChange=cardPrStateChange, cardSpareGroupId=cardSpareGroupId, portNumber=portNumber, portBgpId=portBgpId, equipmentAuditGroup=equipmentAuditGroup, shelfSwVersion=shelfSwVersion, cardAdminState=cardAdminState, cardTestType=cardTestType, diskVolumeTable=diskVolumeTable, equipmentError=equipmentError, auditShelfId=auditShelfId, fpgaErrorEventGroup=fpgaErrorEventGroup, auditName=auditName, diskVolumeGroup=diskVolumeGroup, equipmentAudit=equipmentAudit, diskVolumeDriveId=diskVolumeDriveId, cardTestEntry=cardTestEntry, auditEntry=auditEntry, portPrState=portPrState, portDplxStatusChange=portDplxStatusChange, verboseLevel=verboseLevel, auditCommand=auditCommand, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardFwUpdateStatus=cardFwUpdateStatus, cardPicDetected=cardPicDetected, portConnectorId=portConnectorId, cardAction=cardAction, cardNumPorts=cardNumPorts, cmPrimarySID=cmPrimarySID, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardSwVersion=cardSwVersion, portTable=portTable, cardLastBootSource=cardLastBootSource, portPrStateChange=portPrStateChange, cardEntry=cardEntry, diskVolumeNumber=diskVolumeNumber, cardType=cardType, cardDetected=cardDetected, diskVolumeId=diskVolumeId, cmResetUpTime=cmResetUpTime, equipmentDiagGroup=equipmentDiagGroup, cmResetReason=cmResetReason, cardTrapInh=cardTrapInh, cardId=cardId, cardCPLDVersion=cardCPLDVersion, TestCommand=TestCommand, auditAutoScheduling=auditAutoScheduling, cardSerialNum=cardSerialNum, equipmentCardTestGroup=equipmentCardTestGroup, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardCpuType=cardCpuType, diskVolumeEntry=diskVolumeEntry, cardDplxStatus=cardDplxStatus, auditId=auditId, cardRamSize=cardRamSize, cardTestResultNotification=cardTestResultNotification, portAdminState=portAdminState, portMacAddress=portMacAddress, cardBootVersion=cardBootVersion, shelfNumber=shelfNumber, cardTestSchedule=cardTestSchedule, portTxFlowControlMode=portTxFlowControlMode, systemGeneral=systemGeneral, errEvRecoveryEnabled=errEvRecoveryEnabled, cardTestTime=cardTestTime, equipmentTraps=equipmentTraps, diskVolumeShelfId=diskVolumeShelfId, auditPassedCount=auditPassedCount, TestSchedule=TestSchedule, shelfObjects=shelfObjects, portMode=portMode, cardLastChangeTime=cardLastChangeTime, fpgaErrorEventEntry=fpgaErrorEventEntry, cardFwVersion=cardFwVersion, remainInDiagMode=remainInDiagMode, portShelfId=portShelfId, portCardSubType=portCardSubType, equipmentState=equipmentState, cardSubDetected=cardSubDetected, auditDescription=auditDescription, auditTotalPassedCount=auditTotalPassedCount, downstreamPowerLoss=downstreamPowerLoss, cardBusSpeed=cardBusSpeed, diskVolumeCardId=diskVolumeCardId, diskVolumeSize=diskVolumeSize, portMaxDsPower=portMaxDsPower, fpgaErrorEventTable=fpgaErrorEventTable, shelfName=shelfName, portDocsIfIndex=portDocsIfIndex, equipmentStateGroup=equipmentStateGroup, cardSecState=cardSecState, cmDevice=cmDevice, cardTestResultDesc=cardTestResultDesc, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, TestResult=TestResult, cmResetInfo=cmResetInfo, cardTable=cardTable, PYSNMP_MODULE_ID=cadEquipmentMib, trapCounter=trapCounter, cardPicHwVersion=cardPicHwVersion, cardLastResetReason=cardLastResetReason, cmResetNotification=cmResetNotification, cardNumber=cardNumber, portAction=portAction, portCurrDsPower=portCurrDsPower, cardSubType=cardSubType, cardTestId=cardTestId, cardTestTransId=cardTestTransId, cmUChannelID=cmUChannelID, cardFpgaSource=cardFpgaSource, portDetectedMode=portDetectedMode, portMacIfIndex=portMacIfIndex, cardDplxStatusChange=cardDplxStatusChange, cardCarrierSerialNum=cardCarrierSerialNum, cardTestTable=cardTestTable, diagTestId=diagTestId, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeTrapInh=diskVolumeTrapInh, cardTemperatureHighError=cardTemperatureHighError, errEvLogLevel=errEvLogLevel, errEventId=errEventId, cardSecStateChange=cardSecStateChange, cardTestIndex=cardTestIndex, errEvLoggingEnabled=errEvLoggingEnabled, cmIpAddress=cmIpAddress, systemKey=systemKey, cardName=cardName, cmMacAddress=cmMacAddress, cardShelfId=cardShelfId, portMinDsPower=portMinDsPower, cadEquipmentMibGroup=cadEquipmentMibGroup, cardCarrierHwVersion=cardCarrierHwVersion, auditFailedCount=auditFailedCount, portCardId=portCardId, cmVendor=cmVendor, TestId=TestId, cmResetStatus=cmResetStatus, cardSpareGroupMode=cardSpareGroupMode, TestType=TestType, errEvRowStatus=errEvRowStatus, cardUpTime=cardUpTime, diskVolumeFileName=diskVolumeFileName, portTxFlowControlDetected=portTxFlowControlDetected, equipmentDiag=equipmentDiag, portLastChangeTime=portLastChangeTime, cardTestDescription=cardTestDescription, auditResult=auditResult, cardFlashSize=cardFlashSize, auditTotalFailedCount=auditTotalFailedCount, systemGeneralGroup=systemGeneralGroup, cardTestCommand=cardTestCommand, trapSeverity=trapSeverity, cardCpuSpeed=cardCpuSpeed, portEntry=portEntry, diskVolumeName=diskVolumeName, cadEquipmentMib=cadEquipmentMib, diskVolumeUsageNotification=diskVolumeUsageNotification, portType=portType, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, equipmentTbl=equipmentTbl)
