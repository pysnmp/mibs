...
DuplexStatus, CardId, DiskVolumeUsageLevel, SecondaryState, CardType, AdminState, EqActionType, CardSubType, PortId, PortType, FirmwareSource, FlowControlMode, PortMode, PrimaryState, UnknownState, PortDetectedMode, ShelfId, PicType = mibBuilder.importSymbols("CADANT-TC", "DuplexStatus", "CardId", "DiskVolumeUsageLevel", "SecondaryState", "CardType", "AdminState", "EqActionType", "CardSubType", "PortId", "PortType", "FirmwareSource", "FlowControlMode", "PortMode", "PrimaryState", "UnknownState", "PortDetectedMode", "ShelfId", "PicType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, TimeTicks, Unsigned32, Bits, Counter64, Counter32, IpAddress, NotificationType, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "TimeTicks", "Unsigned32", "Bits", "Counter64", "Counter32", "IpAddress", "NotificationType", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardDplxStatusChange=cardDplxStatusChange, portTable=portTable, auditId=auditId, portId=portId, equipmentStateGroup=equipmentStateGroup, cardBusSpeed=cardBusSpeed, TestScheduleCommand=TestScheduleCommand, portTxFlowControlDetected=portTxFlowControlDetected, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardPicDetected=cardPicDetected, diskVolumeGroup=diskVolumeGroup, systemClock=systemClock, equipmentDiagGroup=equipmentDiagGroup, portRxFlowControlMode=portRxFlowControlMode, equipmentState=equipmentState, diskVolumeDriveId=diskVolumeDriveId, cardLastChangeTime=cardLastChangeTime, cardFlashSize=cardFlashSize, cardAction=cardAction, diskVolumeTrapInh=diskVolumeTrapInh, cardFwUpdateStatus=cardFwUpdateStatus, cardPicSerialNum=cardPicSerialNum, equipmentPortGroup=equipmentPortGroup, cardDetectedChange=cardDetectedChange, portCurrDsPower=portCurrDsPower, cardFpgaSource=cardFpgaSource, auditTime=auditTime, equipmentError=equipmentError, cardTemperature=cardTemperature, diskVolumeDiskSize=diskVolumeDiskSize, cardTrapInh=cardTrapInh, errEventId=errEventId, auditCardId=auditCardId, verboseLevel=verboseLevel, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeShelfId=diskVolumeShelfId, TestId=TestId, cardDplxStatus=cardDplxStatus, cardSecStateChange=cardSecStateChange, cardShelfId=cardShelfId, errEvRowStatus=errEvRowStatus, systemGeneralGroup=systemGeneralGroup, cardNumber=cardNumber, portAction=portAction, diskVolumeSize=diskVolumeSize, cmPrimarySID=cmPrimarySID, diskVolumeFileName=diskVolumeFileName, portPrStateChange=portPrStateChange, auditAutoScheduling=auditAutoScheduling, equipmentTraps=equipmentTraps, auditEntry=auditEntry, cardTestIndex=cardTestIndex, auditTotalFailedCount=auditTotalFailedCount, equipmentShelfGroup=equipmentShelfGroup, auditLogThrottle=auditLogThrottle, cardTestResultDesc=cardTestResultDesc, PYSNMP_MODULE_ID=cadEquipmentMib, cardDetected=cardDetected, cardTestTransId=cardTestTransId, portMinDsPower=portMinDsPower, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardSubDetected=cardSubDetected, cardSubType=cardSubType, portSecStateChange=portSecStateChange, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cmResetNotification=cmResetNotification, portDescription=portDescription, cardShelfTestIndex=cardShelfTestIndex, equipmentCardTestGroup=equipmentCardTestGroup, cardName=cardName, cardTemperatureHighWarn=cardTemperatureHighWarn, systemKey=systemKey, shelfSwVersion=shelfSwVersion, cadEquipmentMibConformance=cadEquipmentMibConformance, cardId=cardId, TestResult=TestResult, portConnectorId=portConnectorId, portTrapInh=portTrapInh, portMacIfIndex=portMacIfIndex, cardTestScheduleCommand=cardTestScheduleCommand, cardSerialNum=cardSerialNum, TestSchedule=TestSchedule, auditFailedCount=auditFailedCount, cmRegistrationNotification=cmRegistrationNotification, systemGeneral=systemGeneral, shelfName=shelfName, TestCommand=TestCommand, portRxFlowControlDetected=portRxFlowControlDetected, cardCarrierSerialNum=cardCarrierSerialNum, cardTestCommand=cardTestCommand, cardSpareGroupId=cardSpareGroupId, cardRamSize=cardRamSize, portTxFlowControlMode=portTxFlowControlMode, portAdminState=portAdminState, cadEquipmentMibGroup=cadEquipmentMibGroup, portDetectedMode=portDetectedMode, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardLastResetReason=cardLastResetReason, auditDescription=auditDescription, fpgaErrorEventTable=fpgaErrorEventTable, cardNumPorts=cardNumPorts, auditCycleCount=auditCycleCount, cardCarrierFwVersion=cardCarrierFwVersion, cardUpTime=cardUpTime, cmDevice=cmDevice, portSecState=portSecState, trapSeverity=trapSeverity, cardTestEntry=cardTestEntry, cardTestResult=cardTestResult, cardSpareGroupMode=cardSpareGroupMode, cardTestSchedule=cardTestSchedule, equipmentCardGroup=equipmentCardGroup, portPrState=portPrState, TestType=TestType, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portCardId=portCardId, cardCpuSpeed=cardCpuSpeed, portMode=portMode, diagTestId=diagTestId, cadEquipmentMib=cadEquipmentMib, auditPassedCount=auditPassedCount, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTempNoReportNotification=cardTempNoReportNotification, cardTemperatureHighError=cardTemperatureHighError, cardTempOverHeatNotification=cardTempOverHeatNotification, cardTestResultNotification=cardTestResultNotification, cardTestType=cardTestType, cardTestTable=cardTestTable, consoleOutput=consoleOutput, errEvRecoveryEnabled=errEvRecoveryEnabled, cmResetReason=cmResetReason, shelfObjects=shelfObjects, downstreamPowerLoss=downstreamPowerLoss, shelfNumber=shelfNumber, portMaxDsPower=portMaxDsPower, cardSecState=cardSecState, diskVolumeCardId=diskVolumeCardId, cmVendor=cmVendor, diskVolumeTable=diskVolumeTable, auditTotalPassedCount=auditTotalPassedCount, auditShelfId=auditShelfId, equipmentAuditGroup=equipmentAuditGroup, portMacAddress=portMacAddress, cardTestDescription=cardTestDescription, cardSwVersion=cardSwVersion, cardLastBootVersion=cardLastBootVersion, TestTransactionId=TestTransactionId, portNumber=portNumber, auditStatus=auditStatus, cmMacAddress=cmMacAddress, portShelfId=portShelfId, equipmentDiag=equipmentDiag, cmResetInfo=cmResetInfo, portBgpId=portBgpId, cardCPLDVersion=cardCPLDVersion, portLastChangeTime=portLastChangeTime, auditLogOutput=auditLogOutput, auditResult=auditResult, trapCounter=trapCounter, cardBootVersion=cardBootVersion, cardFwVersion=cardFwVersion, remainInDiagMode=remainInDiagMode, cardCarrierHwVersion=cardCarrierHwVersion, cardAdminState=cardAdminState, cmUChannelID=cmUChannelID, equipmentTbl=equipmentTbl, portEntry=portEntry, cardPicHwVersion=cardPicHwVersion, portNumChans=portNumChans, cardTestName=cardTestName, cardCpuType=cardCpuType, equipmentAudit=equipmentAudit, auditCommand=auditCommand, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardLastBootSource=cardLastBootSource, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditTable=auditTable, cardPrStateChange=cardPrStateChange, eqDiagConfig=eqDiagConfig, portDplxStatusChange=portDplxStatusChange, cmResetClearNotification=cmResetClearNotification, portDocsIfIndex=portDocsIfIndex, cardType=cardType, fpgaErrorEventEntry=fpgaErrorEventEntry, diskVolumeName=diskVolumeName, errEvLogLevel=errEvLogLevel, auditName=auditName, diskDriveNumber=diskDriveNumber, portType=portType, portCardSubType=portCardSubType, cmIpAddress=cmIpAddress, portDplxStatus=portDplxStatus, cardPrState=cardPrState, cardTestId=cardTestId, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeEntry=diskVolumeEntry, cardHwVersion=cardHwVersion, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cmResetStatus=cmResetStatus, fpgaErrorEventGroup=fpgaErrorEventGroup, cardTable=cardTable, cardTestTime=cardTestTime, diskVolumeNumber=diskVolumeNumber, cardEntry=cardEntry, cmResetUpTime=cmResetUpTime, diskVolumeId=diskVolumeId)
