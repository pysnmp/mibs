...
PortId, PortType, PicType, FlowControlMode, PrimaryState, SecondaryState, ShelfId, CardSubType, PortDetectedMode, PortMode, CardType, EqActionType, DuplexStatus, UnknownState, AdminState, DiskVolumeUsageLevel, CardId, FirmwareSource = mibBuilder.importSymbols("CADANT-TC", "PortId", "PortType", "PicType", "FlowControlMode", "PrimaryState", "SecondaryState", "ShelfId", "CardSubType", "PortDetectedMode", "PortMode", "CardType", "EqActionType", "DuplexStatus", "UnknownState", "AdminState", "DiskVolumeUsageLevel", "CardId", "FirmwareSource")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
Counter64, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, TimeTicks, MibIdentifier, ModuleIdentity, IpAddress, iso, Integer32, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "IpAddress", "iso", "Integer32", "ObjectIdentity", "Counter32")
MacAddress, DateAndTime, TextualConvention, TimeStamp, DisplayString, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "DateAndTime", "TextualConvention", "TimeStamp", "DisplayString", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", auditEntry=auditEntry, diskVolumeTrapInh=diskVolumeTrapInh, cardTestCommand=cardTestCommand, auditFailedCount=auditFailedCount, cardAdminState=cardAdminState, auditTime=auditTime, portSecStateChange=portSecStateChange, cardPicHwVersion=cardPicHwVersion, auditCycleCount=auditCycleCount, portDplxStatusChange=portDplxStatusChange, cmIpAddress=cmIpAddress, cardLastResetReason=cardLastResetReason, cmUChannelID=cmUChannelID, cardDetectedChange=cardDetectedChange, TestType=TestType, cardType=cardType, cadEquipmentMibConformance=cadEquipmentMibConformance, cardSecStateChange=cardSecStateChange, cardName=cardName, portSecState=portSecState, cardTestResult=cardTestResult, fpgaErrorEventGroup=fpgaErrorEventGroup, cardId=cardId, cardTestId=cardTestId, cardLastBootVersion=cardLastBootVersion, cardFlashSize=cardFlashSize, portMaxDsPower=portMaxDsPower, diskVolumeCardId=diskVolumeCardId, auditTotalPassedCount=auditTotalPassedCount, remainInDiagMode=remainInDiagMode, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardTestEntry=cardTestEntry, cardCarrierFwVersion=cardCarrierFwVersion, cardTable=cardTable, shelfName=shelfName, cardDplxStatus=cardDplxStatus, shelfNumber=shelfNumber, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, equipmentDiag=equipmentDiag, diskVolumeName=diskVolumeName, cardTestSchedule=cardTestSchedule, cadEquipmentMib=cadEquipmentMib, diskVolumeShelfId=diskVolumeShelfId, systemClock=systemClock, portRxFlowControlMode=portRxFlowControlMode, consoleOutput=consoleOutput, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditId=auditId, portMinDsPower=portMinDsPower, cardTestTransId=cardTestTransId, auditTotalFailedCount=auditTotalFailedCount, portPrState=portPrState, cardTestTime=cardTestTime, trapSeverity=trapSeverity, errEvLoggingEnabled=errEvLoggingEnabled, PYSNMP_MODULE_ID=cadEquipmentMib, cardTestIndex=cardTestIndex, diskVolumeEntry=diskVolumeEntry, fpgaErrorEventEntry=fpgaErrorEventEntry, diskVolumeGroup=diskVolumeGroup, TestCommand=TestCommand, portNumber=portNumber, equipmentAudit=equipmentAudit, cardTestType=cardTestType, TestId=TestId, cardSerialNum=cardSerialNum, cmResetReason=cmResetReason, cardPrStateChange=cardPrStateChange, auditCardId=auditCardId, cardCpuType=cardCpuType, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditShelfId=auditShelfId, TestSchedule=TestSchedule, portTrapInh=portTrapInh, cardTemperatureHighError=cardTemperatureHighError, cmPrimarySID=cmPrimarySID, cardTestResultDesc=cardTestResultDesc, cardNumber=cardNumber, cardShelfTestIndex=cardShelfTestIndex, cardSubType=cardSubType, diskVolumeId=diskVolumeId, cmDevice=cmDevice, portCurrDsPower=portCurrDsPower, cardTempOverHeatNotification=cardTempOverHeatNotification, portShelfId=portShelfId, cardHwVersion=cardHwVersion, cardSpareGroupId=cardSpareGroupId, equipmentShelfGroup=equipmentShelfGroup, portMacIfIndex=portMacIfIndex, portConnectorId=portConnectorId, cardAction=cardAction, equipmentState=equipmentState, auditName=auditName, auditStatus=auditStatus, eqDiagConfig=eqDiagConfig, cardCpuSpeed=cardCpuSpeed, equipmentPortGroup=equipmentPortGroup, cmResetNotification=cmResetNotification, systemGeneralGroup=systemGeneralGroup, cardNumPorts=cardNumPorts, cardSpareGroupMode=cardSpareGroupMode, diskVolumeTable=diskVolumeTable, cardTrapInh=cardTrapInh, cardRamSize=cardRamSize, cardCarrierHwVersion=cardCarrierHwVersion, portMode=portMode, diagTestId=diagTestId, errEvLogLevel=errEvLogLevel, cardSwVersion=cardSwVersion, cmMacAddress=cmMacAddress, auditTable=auditTable, TestScheduleCommand=TestScheduleCommand, portLastChangeTime=portLastChangeTime, cardFwVersion=cardFwVersion, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardShelfId=cardShelfId, diskVolumeDriveId=diskVolumeDriveId, portTxFlowControlMode=portTxFlowControlMode, downstreamPowerLoss=downstreamPowerLoss, equipmentDiagGroup=equipmentDiagGroup, equipmentCardGroup=equipmentCardGroup, equipmentError=equipmentError, cardTestTable=cardTestTable, cardFpgaSource=cardFpgaSource, diskVolumeFileName=diskVolumeFileName, systemKey=systemKey, portBgpId=portBgpId, shelfObjects=shelfObjects, cardTestName=cardTestName, verboseLevel=verboseLevel, diskVolumeUsageNotification=diskVolumeUsageNotification, cardLastChangeTime=cardLastChangeTime, cardPrState=cardPrState, cardPicSerialNum=cardPicSerialNum, auditLogOutput=auditLogOutput, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditResult=auditResult, errEvRecoveryEnabled=errEvRecoveryEnabled, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, diskVolumeNumber=diskVolumeNumber, cmResetStatus=cmResetStatus, cardTestResultNotification=cardTestResultNotification, auditPassedCount=auditPassedCount, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cmResetClearNotification=cmResetClearNotification, cardLastBootSource=cardLastBootSource, cmVendor=cmVendor, portType=portType, cardTestScheduleCommand=cardTestScheduleCommand, cardBootVersion=cardBootVersion, cardUpTime=cardUpTime, cardCarrierSerialNum=cardCarrierSerialNum, portCardSubType=portCardSubType, cmResetUpTime=cmResetUpTime, cardDetected=cardDetected, TestTransactionId=TestTransactionId, diskDriveNumber=diskDriveNumber, portDescription=portDescription, auditDescription=auditDescription, cardDplxStatusChange=cardDplxStatusChange, cardPicDetected=cardPicDetected, diskVolumeDiskSize=diskVolumeDiskSize, portDplxStatus=portDplxStatus, cardTemperatureHighWarn=cardTemperatureHighWarn, portTable=portTable, portDetectedMode=portDetectedMode, auditAutoScheduling=auditAutoScheduling, portAction=portAction, auditCommand=auditCommand, cardTemperature=cardTemperature, equipmentTbl=equipmentTbl, portDocsIfIndex=portDocsIfIndex, cmResetInfo=cmResetInfo, equipmentStateGroup=equipmentStateGroup, cardFwUpdateStatus=cardFwUpdateStatus, shelfSwVersion=shelfSwVersion, portMacAddress=portMacAddress, cardTestDescription=cardTestDescription, portNumChans=portNumChans, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, equipmentAuditGroup=equipmentAuditGroup, portCardId=portCardId, cardSecState=cardSecState, auditLogThrottle=auditLogThrottle, cadEquipmentMibGroup=cadEquipmentMibGroup, equipmentCardTestGroup=equipmentCardTestGroup, equipmentTraps=equipmentTraps, systemGeneral=systemGeneral, fpgaErrorEventTable=fpgaErrorEventTable, diskVolumeUsageLevel=diskVolumeUsageLevel, trapCounter=trapCounter, cardTempNoReportNotification=cardTempNoReportNotification, portTxFlowControlDetected=portTxFlowControlDetected, TestResult=TestResult, errEventId=errEventId, portEntry=portEntry, cardCPLDVersion=cardCPLDVersion, portPrStateChange=portPrStateChange, cmRegistrationNotification=cmRegistrationNotification, diskVolumeSize=diskVolumeSize, errEvRowStatus=errEvRowStatus, portRxFlowControlDetected=portRxFlowControlDetected, portAdminState=portAdminState, cardBusSpeed=cardBusSpeed, cardEntry=cardEntry, cardSubDetected=cardSubDetected, portId=portId)
