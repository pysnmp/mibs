...
CardSubType, PortMode, PortType, CardType, DuplexStatus, ShelfId, EqActionType, FlowControlMode, PortId, SecondaryState, FirmwareSource, UnknownState, CardId, PrimaryState, AdminState, PortDetectedMode, PicType, DiskVolumeUsageLevel = mibBuilder.importSymbols("CADANT-TC", "CardSubType", "PortMode", "PortType", "CardType", "DuplexStatus", "ShelfId", "EqActionType", "FlowControlMode", "PortId", "SecondaryState", "FirmwareSource", "UnknownState", "CardId", "PrimaryState", "AdminState", "PortDetectedMode", "PicType", "DiskVolumeUsageLevel")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
iso, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, ModuleIdentity, MibIdentifier, ObjectIdentity, Integer32, Gauge32, Counter32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Integer32", "Gauge32", "Counter32", "TimeTicks", "IpAddress")
DateAndTime, TextualConvention, TruthValue, MacAddress, TimeStamp, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "TruthValue", "MacAddress", "TimeStamp", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", equipmentCardGroup=equipmentCardGroup, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portAdminState=portAdminState, portDescription=portDescription, diskDriveNumber=diskDriveNumber, cardName=cardName, TestId=TestId, equipmentState=equipmentState, TestCommand=TestCommand, portSecState=portSecState, diskVolumeShelfId=diskVolumeShelfId, portShelfId=portShelfId, cmResetInfo=cmResetInfo, auditLogThrottle=auditLogThrottle, cardTestTime=cardTestTime, portNumber=portNumber, cardShelfId=cardShelfId, cardCpuType=cardCpuType, diagTestId=diagTestId, cadEquipmentMibGroup=cadEquipmentMibGroup, diskVolumeTable=diskVolumeTable, diskVolumeTrapInh=diskVolumeTrapInh, shelfObjects=shelfObjects, cardCarrierSerialNum=cardCarrierSerialNum, shelfNumber=shelfNumber, portCurrDsPower=portCurrDsPower, cardFpgaSource=cardFpgaSource, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardSwVersion=cardSwVersion, eqDiagConfig=eqDiagConfig, trapSeverity=trapSeverity, equipmentPortGroup=equipmentPortGroup, portCardSubType=portCardSubType, cardTestType=cardTestType, cardRamSize=cardRamSize, equipmentStateGroup=equipmentStateGroup, cardFlashSize=cardFlashSize, cmResetUpTime=cmResetUpTime, portMaxDsPower=portMaxDsPower, portPrStateChange=portPrStateChange, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cmResetClearNotification=cmResetClearNotification, cmResetStatus=cmResetStatus, cardCpuSpeed=cardCpuSpeed, cardTestScheduleCommand=cardTestScheduleCommand, auditTotalPassedCount=auditTotalPassedCount, systemGeneralGroup=systemGeneralGroup, cardTemperature=cardTemperature, cadEquipmentMibCompliances=cadEquipmentMibCompliances, auditResult=auditResult, cardType=cardType, PYSNMP_MODULE_ID=cadEquipmentMib, cardAction=cardAction, portAction=portAction, errEventId=errEventId, shelfSwVersion=shelfSwVersion, cardCarrierHwVersion=cardCarrierHwVersion, portTable=portTable, cardHwVersion=cardHwVersion, cmUChannelID=cmUChannelID, cardCarrierFwVersion=cardCarrierFwVersion, cardEntry=cardEntry, cardTemperatureHighWarn=cardTemperatureHighWarn, cardLastChangeTime=cardLastChangeTime, portRxFlowControlDetected=portRxFlowControlDetected, cardTestId=cardTestId, cardFwUpdateStatus=cardFwUpdateStatus, diskVolumeId=diskVolumeId, cardTestCommand=cardTestCommand, systemClock=systemClock, portDplxStatus=portDplxStatus, portType=portType, cardTestTable=cardTestTable, TestResult=TestResult, cardTestDescription=cardTestDescription, TestSchedule=TestSchedule, portBgpId=portBgpId, cmResetNotification=cmResetNotification, auditTime=auditTime, portDocsIfIndex=portDocsIfIndex, portConnectorId=portConnectorId, cardPicHwVersion=cardPicHwVersion, diskVolumeEntry=diskVolumeEntry, cardTestResult=cardTestResult, fpgaErrorEventTable=fpgaErrorEventTable, shelfName=shelfName, cmResetReason=cmResetReason, cmVendor=cmVendor, diskVolumeCardId=diskVolumeCardId, auditEntry=auditEntry, remainInDiagMode=remainInDiagMode, auditTable=auditTable, diskVolumeUsagePercentage=diskVolumeUsagePercentage, errEvRowStatus=errEvRowStatus, cardSecState=cardSecState, cardDetected=cardDetected, auditDescription=auditDescription, cardSpareGroupMode=cardSpareGroupMode, cardLastBootSource=cardLastBootSource, portMode=portMode, auditPassedCount=auditPassedCount, cardBusSpeed=cardBusSpeed, systemGeneral=systemGeneral, cardTestTransId=cardTestTransId, portRxFlowControlMode=portRxFlowControlMode, verboseLevel=verboseLevel, auditName=auditName, auditCycleCount=auditCycleCount, cardDplxStatusChange=cardDplxStatusChange, portTxFlowControlDetected=portTxFlowControlDetected, portSecStateChange=portSecStateChange, equipmentTraps=equipmentTraps, cardId=cardId, cardCPLDVersion=cardCPLDVersion, cardShelfTestIndex=cardShelfTestIndex, auditId=auditId, cadEquipmentMib=cadEquipmentMib, cardTestResultDesc=cardTestResultDesc, auditCommand=auditCommand, auditFailedCount=auditFailedCount, cmMacAddress=cmMacAddress, cardPicDetected=cardPicDetected, cardPrStateChange=cardPrStateChange, cardTestIndex=cardTestIndex, cardLastResetReason=cardLastResetReason, cardDplxStatus=cardDplxStatus, auditAutoScheduling=auditAutoScheduling, portMacAddress=portMacAddress, portLastChangeTime=portLastChangeTime, auditLogOutput=auditLogOutput, equipmentAudit=equipmentAudit, portCardId=portCardId, cardTestResultNotification=cardTestResultNotification, auditCardId=auditCardId, cardFwVersion=cardFwVersion, diskVolumeNumber=diskVolumeNumber, cardSecStateChange=cardSecStateChange, cardTestName=cardTestName, diskVolumeUsageNotification=diskVolumeUsageNotification, equipmentDiagGroup=equipmentDiagGroup, trapCounter=trapCounter, auditStatus=auditStatus, equipmentCardTestGroup=equipmentCardTestGroup, auditTotalFailedCount=auditTotalFailedCount, cardLastBootVersion=cardLastBootVersion, cardUpTime=cardUpTime, cardDetectedChange=cardDetectedChange, TestTransactionId=TestTransactionId, cadEquipmentMibConformance=cadEquipmentMibConformance, equipmentShelfGroup=equipmentShelfGroup, equipmentTbl=equipmentTbl, diskVolumeDriveId=diskVolumeDriveId, diskVolumeSize=diskVolumeSize, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, diskVolumeFileName=diskVolumeFileName, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portId=portId, portPrState=portPrState, cardTempNoReportNotification=cardTempNoReportNotification, cardTrapInh=cardTrapInh, TestType=TestType, equipmentError=equipmentError, cardSubType=cardSubType, cardSerialNum=cardSerialNum, portNumChans=portNumChans, equipmentAuditGroup=equipmentAuditGroup, portDetectedMode=portDetectedMode, cardNumPorts=cardNumPorts, cardTemperatureHighError=cardTemperatureHighError, cardTable=cardTable, cardPicSerialNum=cardPicSerialNum, diskVolumeUsageLevel=diskVolumeUsageLevel, portMinDsPower=portMinDsPower, cardAdminState=cardAdminState, diskVolumeDiskSize=diskVolumeDiskSize, cardTestSchedule=cardTestSchedule, fpgaErrorEventGroup=fpgaErrorEventGroup, portEntry=portEntry, cardPrState=cardPrState, downstreamPowerLoss=downstreamPowerLoss, TestScheduleCommand=TestScheduleCommand, cardBootVersion=cardBootVersion, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, fpgaErrorEventEntry=fpgaErrorEventEntry, portTrapInh=portTrapInh, cardNumber=cardNumber, consoleOutput=consoleOutput, errEvLogLevel=errEvLogLevel, diskVolumeGroup=diskVolumeGroup, cardSubDetected=cardSubDetected, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardSpareGroupId=cardSpareGroupId, systemKey=systemKey, cmDevice=cmDevice, cardTempOverHeatNotification=cardTempOverHeatNotification, cardTestEntry=cardTestEntry, errEvRecoveryEnabled=errEvRecoveryEnabled, portDplxStatusChange=portDplxStatusChange, cmPrimarySID=cmPrimarySID, portTxFlowControlMode=portTxFlowControlMode, auditShelfId=auditShelfId, cmRegistrationNotification=cmRegistrationNotification, portMacIfIndex=portMacIfIndex, equipmentDiag=equipmentDiag, diskVolumeName=diskVolumeName, errEvLoggingEnabled=errEvLoggingEnabled, cmIpAddress=cmIpAddress)
