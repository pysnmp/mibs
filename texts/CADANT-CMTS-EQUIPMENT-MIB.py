...
UnknownState, AdminState, PortMode, PrimaryState, EqActionType, PortId, FlowControlMode, CardId, CardType, PortDetectedMode, ShelfId, DiskVolumeUsageLevel, FirmwareSource, CardSubType, PicType, PortType, SecondaryState, DuplexStatus = mibBuilder.importSymbols("CADANT-TC", "UnknownState", "AdminState", "PortMode", "PrimaryState", "EqActionType", "PortId", "FlowControlMode", "CardId", "CardType", "PortDetectedMode", "ShelfId", "DiskVolumeUsageLevel", "FirmwareSource", "CardSubType", "PicType", "PortType", "SecondaryState", "DuplexStatus")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
MibIdentifier, Gauge32, TimeTicks, Unsigned32, iso, ModuleIdentity, IpAddress, Counter64, ObjectIdentity, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "TimeTicks", "Unsigned32", "iso", "ModuleIdentity", "IpAddress", "Counter64", "ObjectIdentity", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType")
DateAndTime, MacAddress, TextualConvention, TimeStamp, TruthValue, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "MacAddress", "TextualConvention", "TimeStamp", "TruthValue", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", auditEntry=auditEntry, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cmRegistrationNotification=cmRegistrationNotification, cardLastBootSource=cardLastBootSource, portTrapInh=portTrapInh, cardPicDetected=cardPicDetected, diskVolumeTable=diskVolumeTable, cardTestTable=cardTestTable, equipmentAuditGroup=equipmentAuditGroup, portMode=portMode, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardTestCommand=cardTestCommand, cmResetReason=cmResetReason, TestType=TestType, cardShelfId=cardShelfId, errEvRowStatus=errEvRowStatus, equipmentShelfGroup=equipmentShelfGroup, cardSubDetected=cardSubDetected, cardSpareGroupId=cardSpareGroupId, auditName=auditName, fpgaErrorEventTable=fpgaErrorEventTable, errEvLogLevel=errEvLogLevel, cardTestId=cardTestId, cardLastBootVersion=cardLastBootVersion, auditStatus=auditStatus, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cadEquipmentMibCompliance=cadEquipmentMibCompliance, TestId=TestId, cardCarrierFwVersion=cardCarrierFwVersion, cardLastResetReason=cardLastResetReason, diskVolumeCardId=diskVolumeCardId, eqDiagConfig=eqDiagConfig, portType=portType, cardRamSize=cardRamSize, portPrStateChange=portPrStateChange, auditAutoScheduling=auditAutoScheduling, PYSNMP_MODULE_ID=cadEquipmentMib, auditPassedCount=auditPassedCount, cardCarrierHwVersion=cardCarrierHwVersion, equipmentTraps=equipmentTraps, cardTemperatureHighWarn=cardTemperatureHighWarn, cmDevice=cmDevice, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeUsageLevel=diskVolumeUsageLevel, cmMacAddress=cmMacAddress, cmResetNotification=cmResetNotification, auditLogThrottle=auditLogThrottle, fpgaErrorEventGroup=fpgaErrorEventGroup, portNumChans=portNumChans, portMacAddress=portMacAddress, cardTestResult=cardTestResult, cadEquipmentMibGroup=cadEquipmentMibGroup, portId=portId, cardSubType=cardSubType, cardTemperature=cardTemperature, TestResult=TestResult, cardTestResultNotification=cardTestResultNotification, equipmentPortGroup=equipmentPortGroup, cardSerialNum=cardSerialNum, portBgpId=portBgpId, diskVolumeEntry=diskVolumeEntry, cadEquipmentMib=cadEquipmentMib, verboseLevel=verboseLevel, cardDetected=cardDetected, cardPrState=cardPrState, cardTable=cardTable, trapSeverity=trapSeverity, cardType=cardType, portDplxStatus=portDplxStatus, cardTestScheduleCommand=cardTestScheduleCommand, cmVendor=cmVendor, diskVolumeNumber=diskVolumeNumber, portCurrDsPower=portCurrDsPower, diskVolumeName=diskVolumeName, diskVolumeDriveId=diskVolumeDriveId, equipmentDiagGroup=equipmentDiagGroup, cardDetectedChange=cardDetectedChange, portPrState=portPrState, portLastChangeTime=portLastChangeTime, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeDiskSize=diskVolumeDiskSize, cardTemperatureHighError=cardTemperatureHighError, portDocsIfIndex=portDocsIfIndex, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardHwVersion=cardHwVersion, portSecState=portSecState, auditCycleCount=auditCycleCount, portNumber=portNumber, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeSize=diskVolumeSize, auditDescription=auditDescription, systemClock=systemClock, cardLastChangeTime=cardLastChangeTime, TestSchedule=TestSchedule, cardId=cardId, fpgaErrorEventEntry=fpgaErrorEventEntry, portDetectedMode=portDetectedMode, cardTestIndex=cardTestIndex, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditId=auditId, equipmentError=equipmentError, auditCommand=auditCommand, auditShelfId=auditShelfId, portConnectorId=portConnectorId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, portDplxStatusChange=portDplxStatusChange, diskVolumeShelfId=diskVolumeShelfId, cardSpareGroupMode=cardSpareGroupMode, cmIpAddress=cmIpAddress, cardNumber=cardNumber, cardTestType=cardTestType, cardSecStateChange=cardSecStateChange, cardCarrierSerialNum=cardCarrierSerialNum, equipmentCardTestGroup=equipmentCardTestGroup, cardCpuType=cardCpuType, cardTestSchedule=cardTestSchedule, cardTestName=cardTestName, portCardId=portCardId, portRxFlowControlMode=portRxFlowControlMode, cardPicSerialNum=cardPicSerialNum, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, TestCommand=TestCommand, cmResetStatus=cmResetStatus, downstreamPowerLoss=downstreamPowerLoss, portMinDsPower=portMinDsPower, portSecStateChange=portSecStateChange, equipmentState=equipmentState, equipmentStateGroup=equipmentStateGroup, cardSwVersion=cardSwVersion, cardShelfTestIndex=cardShelfTestIndex, diskVolumeTrapInh=diskVolumeTrapInh, cardBootVersion=cardBootVersion, cardTestTime=cardTestTime, shelfObjects=shelfObjects, cardUpTime=cardUpTime, cardTestDescription=cardTestDescription, portTxFlowControlMode=portTxFlowControlMode, diskVolumeGroup=diskVolumeGroup, TestScheduleCommand=TestScheduleCommand, auditResult=auditResult, diskVolumeUsageNotification=diskVolumeUsageNotification, shelfNumber=shelfNumber, cardBusSpeed=cardBusSpeed, cadEquipmentMibConformance=cadEquipmentMibConformance, cardEntry=cardEntry, portMaxDsPower=portMaxDsPower, cardDplxStatusChange=cardDplxStatusChange, auditTime=auditTime, cmResetClearNotification=cmResetClearNotification, remainInDiagMode=remainInDiagMode, cmPrimarySID=cmPrimarySID, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, errEvLoggingEnabled=errEvLoggingEnabled, diagTestId=diagTestId, cardName=cardName, cmResetUpTime=cmResetUpTime, portTable=portTable, errEventId=errEventId, auditCardId=auditCardId, auditTotalFailedCount=auditTotalFailedCount, diskDriveNumber=diskDriveNumber, portShelfId=portShelfId, consoleOutput=consoleOutput, cmResetInfo=cmResetInfo, errEvRecoveryEnabled=errEvRecoveryEnabled, cardDplxStatus=cardDplxStatus, TestTransactionId=TestTransactionId, auditLogOutput=auditLogOutput, equipmentCardGroup=equipmentCardGroup, cardPrStateChange=cardPrStateChange, cardFlashSize=cardFlashSize, cardCPLDVersion=cardCPLDVersion, cardPicHwVersion=cardPicHwVersion, shelfName=shelfName, systemGeneralGroup=systemGeneralGroup, portAction=portAction, portDescription=portDescription, auditFailedCount=auditFailedCount, portEntry=portEntry, shelfSwVersion=shelfSwVersion, diskVolumeFileName=diskVolumeFileName, cmUChannelID=cmUChannelID, cardTrapInh=cardTrapInh, cardTestEntry=cardTestEntry, cardCpuSpeed=cardCpuSpeed, equipmentAudit=equipmentAudit, equipmentDiag=equipmentDiag, trapCounter=trapCounter, systemKey=systemKey, cardTestTransId=cardTestTransId, cardFwUpdateStatus=cardFwUpdateStatus, cardTempNoReportNotification=cardTempNoReportNotification, cardFpgaSource=cardFpgaSource, portAdminState=portAdminState, equipmentTbl=equipmentTbl, auditTotalPassedCount=auditTotalPassedCount, diskVolumeId=diskVolumeId, cardFwVersion=cardFwVersion, portMacIfIndex=portMacIfIndex, cardAdminState=cardAdminState, cardAction=cardAction, auditTable=auditTable, cardTestResultDesc=cardTestResultDesc, systemGeneral=systemGeneral, cardSecState=cardSecState, portCardSubType=portCardSubType, cardNumPorts=cardNumPorts)
