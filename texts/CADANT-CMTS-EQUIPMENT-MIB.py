...
SecondaryState, AdminState, PortMode, ShelfId, UnknownState, DuplexStatus, FirmwareSource, PortType, CardType, PicType, CardSubType, DiskVolumeUsageLevel, FlowControlMode, PortDetectedMode, PrimaryState, EqActionType, PortId, CardId = mibBuilder.importSymbols("CADANT-TC", "SecondaryState", "AdminState", "PortMode", "ShelfId", "UnknownState", "DuplexStatus", "FirmwareSource", "PortType", "CardType", "PicType", "CardSubType", "DiskVolumeUsageLevel", "FlowControlMode", "PortDetectedMode", "PrimaryState", "EqActionType", "PortId", "CardId")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
NotificationType, iso, MibIdentifier, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, Counter32, Integer32, Bits, Counter64, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "MibIdentifier", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "Counter32", "Integer32", "Bits", "Counter64", "ModuleIdentity", "IpAddress")
MacAddress, TruthValue, TimeStamp, TextualConvention, RowStatus, DateAndTime, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TruthValue", "TimeStamp", "TextualConvention", "RowStatus", "DateAndTime", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portTxFlowControlDetected=portTxFlowControlDetected, TestTransactionId=TestTransactionId, cardBusSpeed=cardBusSpeed, cardPicDetected=cardPicDetected, portLastChangeTime=portLastChangeTime, cardCPLDVersion=cardCPLDVersion, cardSecStateChange=cardSecStateChange, cmResetNotification=cmResetNotification, PYSNMP_MODULE_ID=cadEquipmentMib, cardLastChangeTime=cardLastChangeTime, fpgaErrorEventEntry=fpgaErrorEventEntry, equipmentError=equipmentError, diskVolumeTable=diskVolumeTable, portConnectorId=portConnectorId, diskDriveNumber=diskDriveNumber, equipmentAudit=equipmentAudit, cardDetectedChange=cardDetectedChange, cmResetUpTime=cmResetUpTime, equipmentCardGroup=equipmentCardGroup, portMacAddress=portMacAddress, cardShelfTestIndex=cardShelfTestIndex, cardLastBootVersion=cardLastBootVersion, portAdminState=portAdminState, diskVolumeCardId=diskVolumeCardId, cardId=cardId, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cmResetStatus=cmResetStatus, errEvRowStatus=errEvRowStatus, cardHwVersion=cardHwVersion, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeUsageLevel=diskVolumeUsageLevel, cardSpareGroupMode=cardSpareGroupMode, auditTable=auditTable, auditTotalPassedCount=auditTotalPassedCount, eqDiagConfig=eqDiagConfig, cardPicSerialNum=cardPicSerialNum, cardNumPorts=cardNumPorts, cmVendor=cmVendor, diskVolumeGroup=diskVolumeGroup, TestId=TestId, portDocsIfIndex=portDocsIfIndex, cardCarrierFwVersion=cardCarrierFwVersion, cardName=cardName, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardAction=cardAction, auditTime=auditTime, verboseLevel=verboseLevel, diskVolumeDiskSize=diskVolumeDiskSize, cmMacAddress=cmMacAddress, systemKey=systemKey, portRxFlowControlMode=portRxFlowControlMode, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, auditId=auditId, equipmentDiag=equipmentDiag, portMaxDsPower=portMaxDsPower, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portTxFlowControlMode=portTxFlowControlMode, portNumber=portNumber, cardTemperatureHighError=cardTemperatureHighError, portMacIfIndex=portMacIfIndex, equipmentStateGroup=equipmentStateGroup, fpgaErrorEventTable=fpgaErrorEventTable, diskVolumeNumber=diskVolumeNumber, cmIpAddress=cmIpAddress, diskVolumeTrapInh=diskVolumeTrapInh, cardCpuSpeed=cardCpuSpeed, cardFwVersion=cardFwVersion, portAction=portAction, systemGeneralGroup=systemGeneralGroup, equipmentAuditGroup=equipmentAuditGroup, trapSeverity=trapSeverity, cardSpareGroupId=cardSpareGroupId, auditDescription=auditDescription, errEvLogLevel=errEvLogLevel, portBgpId=portBgpId, equipmentState=equipmentState, cardTestName=cardTestName, cardDetected=cardDetected, auditCommand=auditCommand, cardSubDetected=cardSubDetected, cardSecState=cardSecState, portNumChans=portNumChans, auditAutoScheduling=auditAutoScheduling, equipmentDiagGroup=equipmentDiagGroup, portDplxStatus=portDplxStatus, cadEquipmentMibConformance=cadEquipmentMibConformance, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeSize=diskVolumeSize, cardSwVersion=cardSwVersion, equipmentPortGroup=equipmentPortGroup, cardType=cardType, cardTestTransId=cardTestTransId, TestSchedule=TestSchedule, cardAdminState=cardAdminState, cardBootVersion=cardBootVersion, errEvRecoveryEnabled=errEvRecoveryEnabled, cardTestType=cardTestType, cardFwUpdateStatus=cardFwUpdateStatus, systemClock=systemClock, cardTemperatureHighWarn=cardTemperatureHighWarn, cardTemperature=cardTemperature, cardSerialNum=cardSerialNum, cardTestEntry=cardTestEntry, auditPassedCount=auditPassedCount, auditName=auditName, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portDescription=portDescription, cmPrimarySID=cmPrimarySID, shelfObjects=shelfObjects, consoleOutput=consoleOutput, auditStatus=auditStatus, cardTestResultNotification=cardTestResultNotification, diskVolumeFileName=diskVolumeFileName, cardTempOverHeatNotification=cardTempOverHeatNotification, portPrState=portPrState, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portPrStateChange=portPrStateChange, cardDplxStatusChange=cardDplxStatusChange, cardLastBootSource=cardLastBootSource, portMinDsPower=portMinDsPower, cardTrapInh=cardTrapInh, errEventId=errEventId, diagTestId=diagTestId, cardTestTime=cardTestTime, portDetectedMode=portDetectedMode, TestType=TestType, cardTestCommand=cardTestCommand, cardPicHwVersion=cardPicHwVersion, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditTotalFailedCount=auditTotalFailedCount, cardFlashSize=cardFlashSize, auditEntry=auditEntry, cardLastResetReason=cardLastResetReason, systemGeneral=systemGeneral, cardUpTime=cardUpTime, cardRamSize=cardRamSize, cardTestResult=cardTestResult, cadEquipmentMibGroup=cadEquipmentMibGroup, cmUChannelID=cmUChannelID, cardTestScheduleCommand=cardTestScheduleCommand, cardNumber=cardNumber, fpgaErrorEventGroup=fpgaErrorEventGroup, equipmentTbl=equipmentTbl, cardPrState=cardPrState, portSecState=portSecState, cadEquipmentMib=cadEquipmentMib, shelfNumber=shelfNumber, diskVolumeName=diskVolumeName, portEntry=portEntry, portCardSubType=portCardSubType, portCurrDsPower=portCurrDsPower, diskVolumeDriveId=diskVolumeDriveId, diskVolumeEntry=diskVolumeEntry, cardTestIndex=cardTestIndex, diskVolumeUsagePercentage=diskVolumeUsagePercentage, TestCommand=TestCommand, auditCardId=auditCardId, cardTestResultDesc=cardTestResultDesc, cardTable=cardTable, cardPrStateChange=cardPrStateChange, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeId=diskVolumeId, TestScheduleCommand=TestScheduleCommand, auditFailedCount=auditFailedCount, portTable=portTable, cardTestId=cardTestId, cardSubType=cardSubType, cardTestDescription=cardTestDescription, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portShelfId=portShelfId, portId=portId, equipmentTraps=equipmentTraps, equipmentShelfGroup=equipmentShelfGroup, cmRegistrationNotification=cmRegistrationNotification, cmResetInfo=cmResetInfo, portCardId=portCardId, cardTestTable=cardTestTable, shelfName=shelfName, trapCounter=trapCounter, cmResetReason=cmResetReason, portTrapInh=portTrapInh, shelfSwVersion=shelfSwVersion, TestResult=TestResult, cardCarrierSerialNum=cardCarrierSerialNum, remainInDiagMode=remainInDiagMode, cardTestSchedule=cardTestSchedule, downstreamPowerLoss=downstreamPowerLoss, auditLogOutput=auditLogOutput, cardCpuType=cardCpuType, cardShelfId=cardShelfId, equipmentCardTestGroup=equipmentCardTestGroup, auditCycleCount=auditCycleCount, portSecStateChange=portSecStateChange, portType=portType, cardDplxStatus=cardDplxStatus, portMode=portMode, portDplxStatusChange=portDplxStatusChange, cmResetClearNotification=cmResetClearNotification, cardFpgaSource=cardFpgaSource, cardTempNoReportNotification=cardTempNoReportNotification, cardEntry=cardEntry, auditLogThrottle=auditLogThrottle, cmDevice=cmDevice, diskVolumeShelfId=diskVolumeShelfId, auditShelfId=auditShelfId, auditResult=auditResult)
