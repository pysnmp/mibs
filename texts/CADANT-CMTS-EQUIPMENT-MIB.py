...
FirmwareSource, PicType, EqActionType, CardType, PortId, PortMode, PortDetectedMode, ShelfId, PrimaryState, CardId, CardSubType, UnknownState, DuplexStatus, SecondaryState, AdminState, DiskVolumeUsageLevel, PortType, FlowControlMode = mibBuilder.importSymbols("CADANT-TC", "FirmwareSource", "PicType", "EqActionType", "CardType", "PortId", "PortMode", "PortDetectedMode", "ShelfId", "PrimaryState", "CardId", "CardSubType", "UnknownState", "DuplexStatus", "SecondaryState", "AdminState", "DiskVolumeUsageLevel", "PortType", "FlowControlMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Counter32, ObjectIdentity, Gauge32, Counter64, Integer32, iso, TimeTicks, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Counter32", "ObjectIdentity", "Gauge32", "Counter64", "Integer32", "iso", "TimeTicks", "MibIdentifier", "Bits")
TextualConvention, DateAndTime, TimeStamp, TruthValue, DisplayString, RowStatus, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DateAndTime", "TimeStamp", "TruthValue", "DisplayString", "RowStatus", "MacAddress")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", equipmentCardTestGroup=equipmentCardTestGroup, cardPrState=cardPrState, portShelfId=portShelfId, cardTestDescription=cardTestDescription, equipmentStateGroup=equipmentStateGroup, cmDevice=cmDevice, cardLastBootSource=cardLastBootSource, diskVolumeId=diskVolumeId, cardFwVersion=cardFwVersion, portDetectedMode=portDetectedMode, cardNumber=cardNumber, cardSwVersion=cardSwVersion, cardSpareGroupMode=cardSpareGroupMode, TestResult=TestResult, cardShelfTestIndex=cardShelfTestIndex, cmResetUpTime=cmResetUpTime, portDplxStatus=portDplxStatus, cardFlashSize=cardFlashSize, auditTime=auditTime, cardCarrierSerialNum=cardCarrierSerialNum, auditEntry=auditEntry, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portAction=portAction, cardCarrierFwVersion=cardCarrierFwVersion, cardCarrierHwVersion=cardCarrierHwVersion, cmUChannelID=cmUChannelID, auditTable=auditTable, cadEquipmentMibConformance=cadEquipmentMibConformance, equipmentDiag=equipmentDiag, portMacIfIndex=portMacIfIndex, auditTotalFailedCount=auditTotalFailedCount, cmIpAddress=cmIpAddress, cardTestScheduleCommand=cardTestScheduleCommand, diskVolumeDriveId=diskVolumeDriveId, equipmentDiagGroup=equipmentDiagGroup, auditName=auditName, shelfSwVersion=shelfSwVersion, diagTestId=diagTestId, portDescription=portDescription, portBgpId=portBgpId, cardTestResult=cardTestResult, cardDetected=cardDetected, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardAction=cardAction, cardFwUpdateStatus=cardFwUpdateStatus, cardDetectedChange=cardDetectedChange, portDocsIfIndex=portDocsIfIndex, fpgaErrorEventTable=fpgaErrorEventTable, cardTestType=cardTestType, equipmentAudit=equipmentAudit, portTrapInh=portTrapInh, cardTemperature=cardTemperature, cardTestResultNotification=cardTestResultNotification, cardPicDetected=cardPicDetected, TestType=TestType, diskVolumeShelfId=diskVolumeShelfId, equipmentShelfGroup=equipmentShelfGroup, equipmentTraps=equipmentTraps, auditCommand=auditCommand, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portId=portId, cmResetClearNotification=cmResetClearNotification, equipmentAuditGroup=equipmentAuditGroup, diskVolumeEntry=diskVolumeEntry, cardSpareGroupId=cardSpareGroupId, cmResetInfo=cmResetInfo, shelfNumber=shelfNumber, cardBusSpeed=cardBusSpeed, equipmentTbl=equipmentTbl, cadEquipmentMibGroup=cadEquipmentMibGroup, cardId=cardId, cardShelfId=cardShelfId, cardType=cardType, equipmentError=equipmentError, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, diskVolumeNumber=diskVolumeNumber, cardSerialNum=cardSerialNum, fpgaErrorEventEntry=fpgaErrorEventEntry, auditStatus=auditStatus, auditPassedCount=auditPassedCount, cardTemperatureHighWarn=cardTemperatureHighWarn, systemKey=systemKey, portCardId=portCardId, diskVolumeName=diskVolumeName, cardTestTime=cardTestTime, auditLogThrottle=auditLogThrottle, TestCommand=TestCommand, cardTestName=cardTestName, auditShelfId=auditShelfId, diskVolumeTable=diskVolumeTable, consoleOutput=consoleOutput, cmResetStatus=cmResetStatus, equipmentPortGroup=equipmentPortGroup, portConnectorId=portConnectorId, portDplxStatusChange=portDplxStatusChange, cardTestIndex=cardTestIndex, eqDiagConfig=eqDiagConfig, portEntry=portEntry, diskVolumeDiskSize=diskVolumeDiskSize, cardBootVersion=cardBootVersion, TestTransactionId=TestTransactionId, trapCounter=trapCounter, diskVolumeTrapInh=diskVolumeTrapInh, portPrStateChange=portPrStateChange, fpgaErrorEventGroup=fpgaErrorEventGroup, TestSchedule=TestSchedule, shelfObjects=shelfObjects, auditDescription=auditDescription, cardTestSchedule=cardTestSchedule, cardSecStateChange=cardSecStateChange, cardUpTime=cardUpTime, cardTestTransId=cardTestTransId, cmMacAddress=cmMacAddress, cardLastBootVersion=cardLastBootVersion, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardTestEntry=cardTestEntry, cardTemperatureHighError=cardTemperatureHighError, auditFailedCount=auditFailedCount, cardSubDetected=cardSubDetected, cardTestTable=cardTestTable, cardPicHwVersion=cardPicHwVersion, portMacAddress=portMacAddress, cmResetNotification=cmResetNotification, cardTempNoReportNotification=cardTempNoReportNotification, trapSeverity=trapSeverity, portSecState=portSecState, portTable=portTable, auditTotalPassedCount=auditTotalPassedCount, TestScheduleCommand=TestScheduleCommand, auditCardId=auditCardId, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardName=cardName, cmVendor=cmVendor, cardTable=cardTable, diskDriveNumber=diskDriveNumber, auditAutoScheduling=auditAutoScheduling, auditId=auditId, systemGeneralGroup=systemGeneralGroup, cmResetReason=cmResetReason, cardFpgaSource=cardFpgaSource, cadEquipmentMib=cadEquipmentMib, diskVolumeFileName=diskVolumeFileName, cardDplxStatusChange=cardDplxStatusChange, diskVolumeSize=diskVolumeSize, portPrState=portPrState, diskVolumeCardId=diskVolumeCardId, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portRxFlowControlDetected=portRxFlowControlDetected, cardTrapInh=cardTrapInh, errEvRowStatus=errEvRowStatus, systemGeneral=systemGeneral, systemClock=systemClock, portTxFlowControlDetected=portTxFlowControlDetected, portCurrDsPower=portCurrDsPower, cardCpuSpeed=cardCpuSpeed, diskVolumeGroup=diskVolumeGroup, cardCpuType=cardCpuType, auditCycleCount=auditCycleCount, cmPrimarySID=cmPrimarySID, auditLogOutput=auditLogOutput, errEvRecoveryEnabled=errEvRecoveryEnabled, errEvLoggingEnabled=errEvLoggingEnabled, errEventId=errEventId, cardSubType=cardSubType, remainInDiagMode=remainInDiagMode, cardTestId=cardTestId, auditResult=auditResult, portSecStateChange=portSecStateChange, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, shelfName=shelfName, cardNumPorts=cardNumPorts, downstreamPowerLoss=downstreamPowerLoss, PYSNMP_MODULE_ID=cadEquipmentMib, cardAdminState=cardAdminState, portTxFlowControlMode=portTxFlowControlMode, cardDplxStatus=cardDplxStatus, errEvLogLevel=errEvLogLevel, cardCPLDVersion=cardCPLDVersion, diskVolumeUsageNotification=diskVolumeUsageNotification, cardLastChangeTime=cardLastChangeTime, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, TestId=TestId, portMode=portMode, equipmentCardGroup=equipmentCardGroup, cardHwVersion=cardHwVersion, portType=portType, portMinDsPower=portMinDsPower, cardPicSerialNum=cardPicSerialNum, cardLastResetReason=cardLastResetReason, portRxFlowControlMode=portRxFlowControlMode, cardSecState=cardSecState, portAdminState=portAdminState, cardTestResultDesc=cardTestResultDesc, cmRegistrationNotification=cmRegistrationNotification, cardEntry=cardEntry, equipmentState=equipmentState, portMaxDsPower=portMaxDsPower, cardTestCommand=cardTestCommand, portNumber=portNumber, cardRamSize=cardRamSize, cardPrStateChange=cardPrStateChange, diskVolumeUsageLevel=diskVolumeUsageLevel, portCardSubType=portCardSubType, portLastChangeTime=portLastChangeTime, verboseLevel=verboseLevel, portNumChans=portNumChans)
