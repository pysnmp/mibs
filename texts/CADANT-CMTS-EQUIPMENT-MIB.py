...
AdminState, CardId, DuplexStatus, DiskVolumeUsageLevel, EqActionType, PrimaryState, FlowControlMode, CardType, PortId, PortMode, SecondaryState, ShelfId, FirmwareSource, UnknownState, CardSubType, PortType, PicType, PortDetectedMode = mibBuilder.importSymbols("CADANT-TC", "AdminState", "CardId", "DuplexStatus", "DiskVolumeUsageLevel", "EqActionType", "PrimaryState", "FlowControlMode", "CardType", "PortId", "PortMode", "SecondaryState", "ShelfId", "FirmwareSource", "UnknownState", "CardSubType", "PortType", "PicType", "PortDetectedMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
ModuleIdentity, Gauge32, MibIdentifier, ObjectIdentity, TimeTicks, Integer32, Unsigned32, iso, Counter32, Bits, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "MibIdentifier", "ObjectIdentity", "TimeTicks", "Integer32", "Unsigned32", "iso", "Counter32", "Bits", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
DisplayString, TruthValue, DateAndTime, MacAddress, TextualConvention, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "DateAndTime", "MacAddress", "TextualConvention", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", auditDescription=auditDescription, shelfName=shelfName, cardSubType=cardSubType, cardSecState=cardSecState, portMacIfIndex=portMacIfIndex, cardCpuType=cardCpuType, equipmentDiag=equipmentDiag, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, TestResult=TestResult, cardTestTable=cardTestTable, cmResetStatus=cmResetStatus, auditTable=auditTable, equipmentStateGroup=equipmentStateGroup, diskVolumeShelfId=diskVolumeShelfId, cardTestEntry=cardTestEntry, cardAdminState=cardAdminState, diskVolumeTrapInh=diskVolumeTrapInh, cardAction=cardAction, fpgaErrorEventEntry=fpgaErrorEventEntry, diskVolumeDriveId=diskVolumeDriveId, cmRegistrationNotification=cmRegistrationNotification, cardTestSchedule=cardTestSchedule, cardNumber=cardNumber, cardId=cardId, cadEquipmentMib=cadEquipmentMib, portMacAddress=portMacAddress, TestType=TestType, cadEquipmentMibConformance=cadEquipmentMibConformance, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, equipmentTbl=equipmentTbl, diagTestId=diagTestId, cardSerialNum=cardSerialNum, cardFwVersion=cardFwVersion, cardBusSpeed=cardBusSpeed, auditPassedCount=auditPassedCount, TestCommand=TestCommand, cardTestId=cardTestId, portDescription=portDescription, cardTemperatureHighWarn=cardTemperatureHighWarn, errEvRowStatus=errEvRowStatus, portLastChangeTime=portLastChangeTime, portTxFlowControlDetected=portTxFlowControlDetected, cardTestIndex=cardTestIndex, equipmentDiagGroup=equipmentDiagGroup, cardLastResetReason=cardLastResetReason, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardLastChangeTime=cardLastChangeTime, TestScheduleCommand=TestScheduleCommand, equipmentState=equipmentState, auditLogOutput=auditLogOutput, portCardId=portCardId, cardRamSize=cardRamSize, cardHwVersion=cardHwVersion, portAction=portAction, systemKey=systemKey, cardFlashSize=cardFlashSize, diskVolumeDiskSize=diskVolumeDiskSize, portCurrDsPower=portCurrDsPower, portTxFlowControlMode=portTxFlowControlMode, cmPrimarySID=cmPrimarySID, fpgaErrorEventGroup=fpgaErrorEventGroup, cardCpuSpeed=cardCpuSpeed, portType=portType, shelfNumber=shelfNumber, diskVolumeFileName=diskVolumeFileName, cardCPLDVersion=cardCPLDVersion, cardDplxStatus=cardDplxStatus, cadEquipmentMibGroup=cadEquipmentMibGroup, errEvRecoveryEnabled=errEvRecoveryEnabled, cardCarrierFwVersion=cardCarrierFwVersion, portBgpId=portBgpId, portDplxStatusChange=portDplxStatusChange, systemClock=systemClock, portEntry=portEntry, diskVolumeEntry=diskVolumeEntry, cardDplxStatusChange=cardDplxStatusChange, cardTestResult=cardTestResult, TestId=TestId, cardTestType=cardTestType, cardShelfId=cardShelfId, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portRxFlowControlMode=portRxFlowControlMode, TestTransactionId=TestTransactionId, cardTrapInh=cardTrapInh, cardDetected=cardDetected, portSecStateChange=portSecStateChange, systemGeneral=systemGeneral, cardCarrierSerialNum=cardCarrierSerialNum, cardSpareGroupId=cardSpareGroupId, shelfSwVersion=shelfSwVersion, cardTestResultDesc=cardTestResultDesc, portSecState=portSecState, eqDiagConfig=eqDiagConfig, diskVolumeTable=diskVolumeTable, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diskVolumeId=diskVolumeId, cmIpAddress=cmIpAddress, equipmentCardTestGroup=equipmentCardTestGroup, diskDriveNumber=diskDriveNumber, portDocsIfIndex=portDocsIfIndex, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeNumber=diskVolumeNumber, cmResetReason=cmResetReason, cardSwVersion=cardSwVersion, cardFpgaSource=cardFpgaSource, auditTotalFailedCount=auditTotalFailedCount, cardTestTime=cardTestTime, cardTable=cardTable, cardUpTime=cardUpTime, fpgaErrorEventTable=fpgaErrorEventTable, trapSeverity=trapSeverity, PYSNMP_MODULE_ID=cadEquipmentMib, portDplxStatus=portDplxStatus, diskVolumeGroup=diskVolumeGroup, cardPrState=cardPrState, cardPrStateChange=cardPrStateChange, cardType=cardType, diskVolumeUsageNotification=diskVolumeUsageNotification, equipmentPortGroup=equipmentPortGroup, cardTempOverHeatNotification=cardTempOverHeatNotification, cardSubDetected=cardSubDetected, cardLastBootSource=cardLastBootSource, portConnectorId=portConnectorId, portDetectedMode=portDetectedMode, auditCommand=auditCommand, auditEntry=auditEntry, portPrStateChange=portPrStateChange, cardSecStateChange=cardSecStateChange, cardBootVersion=cardBootVersion, cardFwUpdateStatus=cardFwUpdateStatus, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portMinDsPower=portMinDsPower, auditShelfId=auditShelfId, equipmentTraps=equipmentTraps, cardName=cardName, diskVolumeSize=diskVolumeSize, portTable=portTable, cardTestResultNotification=cardTestResultNotification, cmResetInfo=cmResetInfo, auditStatus=auditStatus, cmResetUpTime=cmResetUpTime, cardDetectedChange=cardDetectedChange, cmDevice=cmDevice, equipmentCardGroup=equipmentCardGroup, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardTempNoReportNotification=cardTempNoReportNotification, shelfObjects=shelfObjects, portNumber=portNumber, portId=portId, portNumChans=portNumChans, portPrState=portPrState, trapCounter=trapCounter, errEvLogLevel=errEvLogLevel, systemGeneralGroup=systemGeneralGroup, cardTemperatureHighError=cardTemperatureHighError, diskVolumeCardId=diskVolumeCardId, auditCycleCount=auditCycleCount, auditTotalPassedCount=auditTotalPassedCount, auditTime=auditTime, auditFailedCount=auditFailedCount, cmResetNotification=cmResetNotification, cardTemperature=cardTemperature, portMode=portMode, cmUChannelID=cmUChannelID, equipmentShelfGroup=equipmentShelfGroup, cardEntry=cardEntry, cardLastBootVersion=cardLastBootVersion, remainInDiagMode=remainInDiagMode, cardNumPorts=cardNumPorts, auditCardId=auditCardId, auditLogThrottle=auditLogThrottle, downstreamPowerLoss=downstreamPowerLoss, cardPicDetected=cardPicDetected, cardTestDescription=cardTestDescription, TestSchedule=TestSchedule, cardCarrierHwVersion=cardCarrierHwVersion, cardTestScheduleCommand=cardTestScheduleCommand, cmVendor=cmVendor, cardTestCommand=cardTestCommand, auditId=auditId, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portMaxDsPower=portMaxDsPower, auditName=auditName, cmResetClearNotification=cmResetClearNotification, cardSpareGroupMode=cardSpareGroupMode, portCardSubType=portCardSubType, diskVolumeName=diskVolumeName, consoleOutput=consoleOutput, equipmentAudit=equipmentAudit, cardTestName=cardTestName, cardPicSerialNum=cardPicSerialNum, auditAutoScheduling=auditAutoScheduling, portRxFlowControlDetected=portRxFlowControlDetected, cardShelfTestIndex=cardShelfTestIndex, cmMacAddress=cmMacAddress, cardTestTransId=cardTestTransId, portTrapInh=portTrapInh, errEventId=errEventId, equipmentError=equipmentError, portAdminState=portAdminState, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeUsageLevel=diskVolumeUsageLevel, cardPicHwVersion=cardPicHwVersion, equipmentAuditGroup=equipmentAuditGroup, portShelfId=portShelfId, verboseLevel=verboseLevel, auditResult=auditResult)
