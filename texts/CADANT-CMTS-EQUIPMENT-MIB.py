...
PortId, FlowControlMode, UnknownState, AdminState, CardId, PrimaryState, DiskVolumeUsageLevel, PicType, PortMode, DuplexStatus, ShelfId, PortDetectedMode, CardSubType, FirmwareSource, CardType, SecondaryState, EqActionType, PortType = mibBuilder.importSymbols("CADANT-TC", "PortId", "FlowControlMode", "UnknownState", "AdminState", "CardId", "PrimaryState", "DiskVolumeUsageLevel", "PicType", "PortMode", "DuplexStatus", "ShelfId", "PortDetectedMode", "CardSubType", "FirmwareSource", "CardType", "SecondaryState", "EqActionType", "PortType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
Gauge32, ObjectIdentity, IpAddress, Unsigned32, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Bits, Counter64, MibIdentifier, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "IpAddress", "Unsigned32", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Bits", "Counter64", "MibIdentifier", "ModuleIdentity", "NotificationType")
RowStatus, MacAddress, TextualConvention, DateAndTime, TimeStamp, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "MacAddress", "TextualConvention", "DateAndTime", "TimeStamp", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardAdminState=cardAdminState, trapSeverity=trapSeverity, portNumber=portNumber, auditLogThrottle=auditLogThrottle, portAction=portAction, cardTemperature=cardTemperature, errEvLoggingEnabled=errEvLoggingEnabled, cardSecStateChange=cardSecStateChange, auditName=auditName, cardTempOverHeatNotification=cardTempOverHeatNotification, cardPicDetected=cardPicDetected, cardLastBootVersion=cardLastBootVersion, diskVolumeDriveId=diskVolumeDriveId, cardTestScheduleCommand=cardTestScheduleCommand, cardTestTransId=cardTestTransId, cardShelfId=cardShelfId, diskVolumeUsageNotification=diskVolumeUsageNotification, cardNumber=cardNumber, errEvRecoveryEnabled=errEvRecoveryEnabled, auditFailedCount=auditFailedCount, portSecState=portSecState, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portMaxDsPower=portMaxDsPower, PYSNMP_MODULE_ID=cadEquipmentMib, cardDplxStatus=cardDplxStatus, auditPassedCount=auditPassedCount, diagTestId=diagTestId, consoleOutput=consoleOutput, equipmentShelfGroup=equipmentShelfGroup, shelfObjects=shelfObjects, equipmentTbl=equipmentTbl, cardTestDescription=cardTestDescription, cardId=cardId, cardRamSize=cardRamSize, cardPicHwVersion=cardPicHwVersion, cardTable=cardTable, portShelfId=portShelfId, diskVolumeShelfId=diskVolumeShelfId, cardTestResultNotification=cardTestResultNotification, cardPicSerialNum=cardPicSerialNum, portCardId=portCardId, cardCpuSpeed=cardCpuSpeed, errEventId=errEventId, diskVolumeEntry=diskVolumeEntry, equipmentCardGroup=equipmentCardGroup, cardSerialNum=cardSerialNum, cmResetInfo=cmResetInfo, cardBootVersion=cardBootVersion, cmVendor=cmVendor, diskVolumeDiskSize=diskVolumeDiskSize, shelfNumber=shelfNumber, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTestTable=cardTestTable, auditTable=auditTable, cardTestResultDesc=cardTestResultDesc, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardName=cardName, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portRxFlowControlMode=portRxFlowControlMode, cardSwVersion=cardSwVersion, cardSubDetected=cardSubDetected, cardFpgaSource=cardFpgaSource, downstreamPowerLoss=downstreamPowerLoss, equipmentAuditGroup=equipmentAuditGroup, shelfSwVersion=shelfSwVersion, eqDiagConfig=eqDiagConfig, equipmentPortGroup=equipmentPortGroup, cmResetUpTime=cmResetUpTime, portConnectorId=portConnectorId, cardTrapInh=cardTrapInh, TestResult=TestResult, cardAction=cardAction, cardCpuType=cardCpuType, portMacAddress=portMacAddress, errEvRowStatus=errEvRowStatus, cardLastChangeTime=cardLastChangeTime, diskVolumeName=diskVolumeName, auditEntry=auditEntry, cardTestType=cardTestType, portCardSubType=portCardSubType, diskVolumeCardId=diskVolumeCardId, portMode=portMode, cardTestName=cardTestName, portPrStateChange=portPrStateChange, diskVolumeTable=diskVolumeTable, auditDescription=auditDescription, portEntry=portEntry, cardPrStateChange=cardPrStateChange, portTxFlowControlMode=portTxFlowControlMode, trapCounter=trapCounter, cmIpAddress=cmIpAddress, shelfName=shelfName, cardFlashSize=cardFlashSize, portDplxStatusChange=portDplxStatusChange, cardDetected=cardDetected, portType=portType, equipmentState=equipmentState, portAdminState=portAdminState, cadEquipmentMib=cadEquipmentMib, cmUChannelID=cmUChannelID, fpgaErrorEventEntry=fpgaErrorEventEntry, cadEquipmentMibConformance=cadEquipmentMibConformance, portPrState=portPrState, cmResetNotification=cmResetNotification, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, verboseLevel=verboseLevel, auditTotalPassedCount=auditTotalPassedCount, diskVolumeTrapInh=diskVolumeTrapInh, cardTemperatureHighError=cardTemperatureHighError, equipmentDiagGroup=equipmentDiagGroup, auditStatus=auditStatus, auditCommand=auditCommand, equipmentTraps=equipmentTraps, cardCarrierFwVersion=cardCarrierFwVersion, portBgpId=portBgpId, portDetectedMode=portDetectedMode, cardTestId=cardTestId, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portDplxStatus=portDplxStatus, systemGeneral=systemGeneral, cardSecState=cardSecState, TestId=TestId, cardTestEntry=cardTestEntry, auditCycleCount=auditCycleCount, cardEntry=cardEntry, cardHwVersion=cardHwVersion, cardCPLDVersion=cardCPLDVersion, auditResult=auditResult, systemGeneralGroup=systemGeneralGroup, cardSpareGroupMode=cardSpareGroupMode, auditShelfId=auditShelfId, portTable=portTable, equipmentCardTestGroup=equipmentCardTestGroup, portCurrDsPower=portCurrDsPower, equipmentDiag=equipmentDiag, portTxFlowControlDetected=portTxFlowControlDetected, cmResetReason=cmResetReason, cardFwVersion=cardFwVersion, equipmentError=equipmentError, fpgaErrorEventTable=fpgaErrorEventTable, portId=portId, cmRegistrationNotification=cmRegistrationNotification, cardTempNoReportNotification=cardTempNoReportNotification, cardPrState=cardPrState, diskVolumeUsageLevel=diskVolumeUsageLevel, cardSubType=cardSubType, cardTestCommand=cardTestCommand, diskVolumeSize=diskVolumeSize, cmPrimarySID=cmPrimarySID, errEvLogLevel=errEvLogLevel, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portSecStateChange=portSecStateChange, cardTemperatureHighWarn=cardTemperatureHighWarn, TestScheduleCommand=TestScheduleCommand, portNumChans=portNumChans, cmResetStatus=cmResetStatus, TestCommand=TestCommand, auditCardId=auditCardId, cardTestResult=cardTestResult, portRxFlowControlDetected=portRxFlowControlDetected, portDescription=portDescription, TestType=TestType, diskDriveNumber=diskDriveNumber, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portTrapInh=portTrapInh, diskVolumeId=diskVolumeId, cmDevice=cmDevice, cardSpareGroupId=cardSpareGroupId, cmMacAddress=cmMacAddress, diskVolumeNumber=diskVolumeNumber, auditLogOutput=auditLogOutput, cardNumPorts=cardNumPorts, cardCarrierSerialNum=cardCarrierSerialNum, portDocsIfIndex=portDocsIfIndex, cardTestIndex=cardTestIndex, cardUpTime=cardUpTime, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardShelfTestIndex=cardShelfTestIndex, auditId=auditId, equipmentStateGroup=equipmentStateGroup, cardLastResetReason=cardLastResetReason, cmResetClearNotification=cmResetClearNotification, cardType=cardType, TestTransactionId=TestTransactionId, fpgaErrorEventGroup=fpgaErrorEventGroup, cadEquipmentMibGroup=cadEquipmentMibGroup, cardTestSchedule=cardTestSchedule, remainInDiagMode=remainInDiagMode, TestSchedule=TestSchedule, equipmentAudit=equipmentAudit, auditAutoScheduling=auditAutoScheduling, cardLastBootSource=cardLastBootSource, systemClock=systemClock, diskVolumeFileName=diskVolumeFileName, systemKey=systemKey, cardTestTime=cardTestTime, cardFwUpdateStatus=cardFwUpdateStatus, cardBusSpeed=cardBusSpeed, auditTotalFailedCount=auditTotalFailedCount, portLastChangeTime=portLastChangeTime, diskVolumeGroup=diskVolumeGroup, cardDplxStatusChange=cardDplxStatusChange, cardDetectedChange=cardDetectedChange, portMacIfIndex=portMacIfIndex, portMinDsPower=portMinDsPower, auditTime=auditTime)
