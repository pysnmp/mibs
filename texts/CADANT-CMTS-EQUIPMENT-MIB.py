...
PortDetectedMode, DuplexStatus, EqActionType, PortId, UnknownState, CardSubType, PicType, FlowControlMode, AdminState, FirmwareSource, SecondaryState, ShelfId, PortMode, CardId, PrimaryState, DiskVolumeUsageLevel, PortType, CardType = mibBuilder.importSymbols("CADANT-TC", "PortDetectedMode", "DuplexStatus", "EqActionType", "PortId", "UnknownState", "CardSubType", "PicType", "FlowControlMode", "AdminState", "FirmwareSource", "SecondaryState", "ShelfId", "PortMode", "CardId", "PrimaryState", "DiskVolumeUsageLevel", "PortType", "CardType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, NotificationType, iso, Bits, Unsigned32, IpAddress, Gauge32, ObjectIdentity, MibIdentifier, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "NotificationType", "iso", "Bits", "Unsigned32", "IpAddress", "Gauge32", "ObjectIdentity", "MibIdentifier", "Integer32", "Counter32")
DisplayString, DateAndTime, TimeStamp, RowStatus, TextualConvention, MacAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "DateAndTime", "TimeStamp", "RowStatus", "TextualConvention", "MacAddress", "TruthValue")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cmResetNotification=cmResetNotification, cardPrState=cardPrState, cardCarrierSerialNum=cardCarrierSerialNum, diskVolumeShelfId=diskVolumeShelfId, TestCommand=TestCommand, shelfNumber=shelfNumber, auditPassedCount=auditPassedCount, cardDplxStatusChange=cardDplxStatusChange, equipmentStateGroup=equipmentStateGroup, cardTemperatureHighWarn=cardTemperatureHighWarn, equipmentDiag=equipmentDiag, portCardSubType=portCardSubType, TestSchedule=TestSchedule, portDplxStatusChange=portDplxStatusChange, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardCpuType=cardCpuType, portMinDsPower=portMinDsPower, cardFwUpdateStatus=cardFwUpdateStatus, portDescription=portDescription, errEvRecoveryEnabled=errEvRecoveryEnabled, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardTestName=cardTestName, errEvRowStatus=errEvRowStatus, cardTestResultDesc=cardTestResultDesc, fpgaErrorEventTable=fpgaErrorEventTable, cmResetUpTime=cmResetUpTime, cardDplxStatus=cardDplxStatus, auditCycleCount=auditCycleCount, cardLastBootVersion=cardLastBootVersion, cardCpuSpeed=cardCpuSpeed, auditId=auditId, cardShelfId=cardShelfId, cardTestResult=cardTestResult, equipmentAuditGroup=equipmentAuditGroup, cadEquipmentMibCompliance=cadEquipmentMibCompliance, shelfName=shelfName, cardTestTable=cardTestTable, portPrStateChange=portPrStateChange, fpgaErrorEventGroup=fpgaErrorEventGroup, portNumber=portNumber, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portType=portType, auditResult=auditResult, errEvLogLevel=errEvLogLevel, cardLastBootSource=cardLastBootSource, portMacIfIndex=portMacIfIndex, cardTestSchedule=cardTestSchedule, diskVolumeFileName=diskVolumeFileName, portMacAddress=portMacAddress, cardType=cardType, portDplxStatus=portDplxStatus, portTxFlowControlMode=portTxFlowControlMode, cardHwVersion=cardHwVersion, portTrapInh=portTrapInh, auditDescription=auditDescription, equipmentTraps=equipmentTraps, diskVolumeTable=diskVolumeTable, auditStatus=auditStatus, cadEquipmentMibCompliances=cadEquipmentMibCompliances, equipmentShelfGroup=equipmentShelfGroup, cardSecStateChange=cardSecStateChange, portMode=portMode, cardTrapInh=cardTrapInh, cardTempOverHeatNotification=cardTempOverHeatNotification, cmResetInfo=cmResetInfo, verboseLevel=verboseLevel, diskVolumeEntry=diskVolumeEntry, cmResetReason=cmResetReason, cmResetClearNotification=cmResetClearNotification, auditEntry=auditEntry, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardShelfTestIndex=cardShelfTestIndex, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeDiskSize=diskVolumeDiskSize, auditTotalPassedCount=auditTotalPassedCount, cardEntry=cardEntry, cardSpareGroupMode=cardSpareGroupMode, systemGeneralGroup=systemGeneralGroup, portAction=portAction, cardUpTime=cardUpTime, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardSubType=cardSubType, cardCPLDVersion=cardCPLDVersion, cmRegistrationNotification=cmRegistrationNotification, diskVolumeUsageNotification=diskVolumeUsageNotification, portCardId=portCardId, equipmentCardGroup=equipmentCardGroup, portNumChans=portNumChans, errEventId=errEventId, cadEquipmentMib=cadEquipmentMib, cardBusSpeed=cardBusSpeed, portTable=portTable, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTestDescription=cardTestDescription, diskVolumeNumber=diskVolumeNumber, shelfSwVersion=shelfSwVersion, consoleOutput=consoleOutput, cardTestType=cardTestType, cardAdminState=cardAdminState, cardTestTime=cardTestTime, trapSeverity=trapSeverity, cadEquipmentMibGroup=cadEquipmentMibGroup, cardPicDetected=cardPicDetected, cmResetStatus=cmResetStatus, cardDetected=cardDetected, portConnectorId=portConnectorId, cardFwVersion=cardFwVersion, eqDiagConfig=eqDiagConfig, cmDevice=cmDevice, cardTempNoReportNotification=cardTempNoReportNotification, cmMacAddress=cmMacAddress, diskVolumeUsageLevel=diskVolumeUsageLevel, TestResult=TestResult, cardId=cardId, cardFlashSize=cardFlashSize, auditTable=auditTable, diskVolumeId=diskVolumeId, cardCarrierHwVersion=cardCarrierHwVersion, cardTestScheduleCommand=cardTestScheduleCommand, cardBootVersion=cardBootVersion, cardTable=cardTable, auditLogThrottle=auditLogThrottle, trapCounter=trapCounter, cardRamSize=cardRamSize, cardTestEntry=cardTestEntry, cardTestIndex=cardTestIndex, cardTestId=cardTestId, cardTestCommand=cardTestCommand, TestTransactionId=TestTransactionId, portAdminState=portAdminState, portBgpId=portBgpId, TestId=TestId, portSecState=portSecState, auditShelfId=auditShelfId, errEvLoggingEnabled=errEvLoggingEnabled, cardNumPorts=cardNumPorts, diskDriveNumber=diskDriveNumber, cmIpAddress=cmIpAddress, portRxFlowControlMode=portRxFlowControlMode, cardPicSerialNum=cardPicSerialNum, cadEquipmentMibConformance=cadEquipmentMibConformance, auditFailedCount=auditFailedCount, diskVolumeDriveId=diskVolumeDriveId, diskVolumeCardId=diskVolumeCardId, cardSecState=cardSecState, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, equipmentState=equipmentState, cardSpareGroupId=cardSpareGroupId, cardTemperature=cardTemperature, cardLastResetReason=cardLastResetReason, equipmentAudit=equipmentAudit, cardTemperatureHighError=cardTemperatureHighError, cmVendor=cmVendor, equipmentError=equipmentError, systemGeneral=systemGeneral, auditLogOutput=auditLogOutput, portEntry=portEntry, cardFpgaSource=cardFpgaSource, cardSubDetected=cardSubDetected, portMaxDsPower=portMaxDsPower, downstreamPowerLoss=downstreamPowerLoss, portDocsIfIndex=portDocsIfIndex, diskVolumeName=diskVolumeName, equipmentDiagGroup=equipmentDiagGroup, cardName=cardName, portLastChangeTime=portLastChangeTime, PYSNMP_MODULE_ID=cadEquipmentMib, diagTestId=diagTestId, portCurrDsPower=portCurrDsPower, cardLastChangeTime=cardLastChangeTime, cardPrStateChange=cardPrStateChange, cardTestResultNotification=cardTestResultNotification, portPrState=portPrState, cardPicHwVersion=cardPicHwVersion, auditCommand=auditCommand, diskVolumeGroup=diskVolumeGroup, auditCardId=auditCardId, cmUChannelID=cmUChannelID, shelfObjects=shelfObjects, portId=portId, TestType=TestType, portShelfId=portShelfId, portDetectedMode=portDetectedMode, auditTime=auditTime, diskVolumeSize=diskVolumeSize, auditName=auditName, cardNumber=cardNumber, cardTestTransId=cardTestTransId, cardDetectedChange=cardDetectedChange, cardSwVersion=cardSwVersion, systemClock=systemClock, cardAction=cardAction, equipmentPortGroup=equipmentPortGroup, equipmentTbl=equipmentTbl, remainInDiagMode=remainInDiagMode, auditAutoScheduling=auditAutoScheduling, cardSerialNum=cardSerialNum, diskVolumeTrapInh=diskVolumeTrapInh, portRxFlowControlDetected=portRxFlowControlDetected, systemKey=systemKey, portSecStateChange=portSecStateChange, cmPrimarySID=cmPrimarySID, auditTotalFailedCount=auditTotalFailedCount, TestScheduleCommand=TestScheduleCommand, equipmentCardTestGroup=equipmentCardTestGroup, fpgaErrorEventEntry=fpgaErrorEventEntry)
