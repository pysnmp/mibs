...
PortMode, CardId, SecondaryState, PrimaryState, CardSubType, PortType, CardType, UnknownState, FirmwareSource, ShelfId, DuplexStatus, FlowControlMode, PortDetectedMode, DiskVolumeUsageLevel, EqActionType, PicType, PortId, AdminState = mibBuilder.importSymbols("CADANT-TC", "PortMode", "CardId", "SecondaryState", "PrimaryState", "CardSubType", "PortType", "CardType", "UnknownState", "FirmwareSource", "ShelfId", "DuplexStatus", "FlowControlMode", "PortDetectedMode", "DiskVolumeUsageLevel", "EqActionType", "PicType", "PortId", "AdminState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
NotificationType, MibIdentifier, ObjectIdentity, Gauge32, Counter32, TimeTicks, Bits, Integer32, Unsigned32, IpAddress, Counter64, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "ObjectIdentity", "Gauge32", "Counter32", "TimeTicks", "Bits", "Integer32", "Unsigned32", "IpAddress", "Counter64", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
DateAndTime, DisplayString, TruthValue, MacAddress, TextualConvention, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "TruthValue", "MacAddress", "TextualConvention", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", diskVolumeSize=diskVolumeSize, cardId=cardId, cmResetClearNotification=cmResetClearNotification, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditShelfId=auditShelfId, cardNumPorts=cardNumPorts, auditTime=auditTime, cmIpAddress=cmIpAddress, portDplxStatusChange=portDplxStatusChange, auditCardId=auditCardId, cardTestDescription=cardTestDescription, cardTable=cardTable, cardDplxStatus=cardDplxStatus, verboseLevel=verboseLevel, portAdminState=portAdminState, systemGeneralGroup=systemGeneralGroup, cardLastChangeTime=cardLastChangeTime, cardTemperatureHighWarn=cardTemperatureHighWarn, auditPassedCount=auditPassedCount, cardCpuType=cardCpuType, cardAction=cardAction, cardTemperatureHighError=cardTemperatureHighError, auditCommand=auditCommand, auditTotalPassedCount=auditTotalPassedCount, cardTestTable=cardTestTable, cardDplxStatusChange=cardDplxStatusChange, portTrapInh=portTrapInh, PYSNMP_MODULE_ID=cadEquipmentMib, cardTestResultNotification=cardTestResultNotification, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardCarrierSerialNum=cardCarrierSerialNum, consoleOutput=consoleOutput, cardTestResultDesc=cardTestResultDesc, cardAdminState=cardAdminState, portMacAddress=portMacAddress, shelfNumber=shelfNumber, portTable=portTable, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardSpareGroupId=cardSpareGroupId, portId=portId, equipmentTbl=equipmentTbl, cardTempOverHeatNotification=cardTempOverHeatNotification, equipmentPortGroup=equipmentPortGroup, TestId=TestId, portAction=portAction, portDplxStatus=portDplxStatus, cardCarrierFwVersion=cardCarrierFwVersion, cardTestTransId=cardTestTransId, auditTable=auditTable, portEntry=portEntry, fpgaErrorEventTable=fpgaErrorEventTable, cardPicDetected=cardPicDetected, diskVolumeEntry=diskVolumeEntry, portDescription=portDescription, diskVolumeGroup=diskVolumeGroup, diskVolumeNumber=diskVolumeNumber, errEvRowStatus=errEvRowStatus, trapSeverity=trapSeverity, cardTestId=cardTestId, cardDetected=cardDetected, equipmentState=equipmentState, cardLastBootVersion=cardLastBootVersion, shelfObjects=shelfObjects, portSecStateChange=portSecStateChange, cadEquipmentMibGroup=cadEquipmentMibGroup, errEventId=errEventId, systemClock=systemClock, cardSpareGroupMode=cardSpareGroupMode, cardFlashSize=cardFlashSize, auditFailedCount=auditFailedCount, cmResetInfo=cmResetInfo, diskVolumeUsageNotification=diskVolumeUsageNotification, cmVendor=cmVendor, auditTotalFailedCount=auditTotalFailedCount, cardPrState=cardPrState, cardFpgaSource=cardFpgaSource, portMinDsPower=portMinDsPower, cadEquipmentMib=cadEquipmentMib, equipmentAuditGroup=equipmentAuditGroup, cardCPLDVersion=cardCPLDVersion, portPrState=portPrState, cadEquipmentMibConformance=cadEquipmentMibConformance, downstreamPowerLoss=downstreamPowerLoss, portNumber=portNumber, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, TestTransactionId=TestTransactionId, errEvLogLevel=errEvLogLevel, cardDetectedChange=cardDetectedChange, auditId=auditId, TestResult=TestResult, cardSerialNum=cardSerialNum, cardTestTime=cardTestTime, fpgaErrorEventEntry=fpgaErrorEventEntry, equipmentDiagGroup=equipmentDiagGroup, portMode=portMode, portCurrDsPower=portCurrDsPower, systemGeneral=systemGeneral, cmResetStatus=cmResetStatus, cardSecState=cardSecState, portCardSubType=portCardSubType, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portLastChangeTime=portLastChangeTime, diskVolumeTable=diskVolumeTable, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, TestScheduleCommand=TestScheduleCommand, diskVolumeId=diskVolumeId, cmResetNotification=cmResetNotification, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardCpuSpeed=cardCpuSpeed, TestCommand=TestCommand, portNumChans=portNumChans, cardBootVersion=cardBootVersion, portRxFlowControlDetected=portRxFlowControlDetected, auditResult=auditResult, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, fpgaErrorEventGroup=fpgaErrorEventGroup, cardFwUpdateStatus=cardFwUpdateStatus, portTxFlowControlMode=portTxFlowControlMode, cardLastResetReason=cardLastResetReason, errEvRecoveryEnabled=errEvRecoveryEnabled, trapCounter=trapCounter, cmUChannelID=cmUChannelID, portPrStateChange=portPrStateChange, errEvLoggingEnabled=errEvLoggingEnabled, equipmentCardGroup=equipmentCardGroup, cardTestType=cardTestType, cardTestSchedule=cardTestSchedule, auditLogOutput=auditLogOutput, diskVolumeTrapInh=diskVolumeTrapInh, portCardId=portCardId, cardShelfId=cardShelfId, cmRegistrationNotification=cmRegistrationNotification, diskVolumeCardId=diskVolumeCardId, cardSwVersion=cardSwVersion, portSecState=portSecState, portDetectedMode=portDetectedMode, cardType=cardType, cardUpTime=cardUpTime, portTxFlowControlDetected=portTxFlowControlDetected, TestSchedule=TestSchedule, auditAutoScheduling=auditAutoScheduling, cardNumber=cardNumber, shelfSwVersion=shelfSwVersion, diskVolumeDriveId=diskVolumeDriveId, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardPicSerialNum=cardPicSerialNum, equipmentAudit=equipmentAudit, cardHwVersion=cardHwVersion, diskVolumeDiskSize=diskVolumeDiskSize, diskDriveNumber=diskDriveNumber, equipmentError=equipmentError, auditName=auditName, cardCarrierHwVersion=cardCarrierHwVersion, portConnectorId=portConnectorId, portBgpId=portBgpId, auditDescription=auditDescription, cmDevice=cmDevice, cardTrapInh=cardTrapInh, cardEntry=cardEntry, equipmentTraps=equipmentTraps, diskVolumeFileName=diskVolumeFileName, cardSubType=cardSubType, cardPrStateChange=cardPrStateChange, equipmentCardTestGroup=equipmentCardTestGroup, cardRamSize=cardRamSize, equipmentDiag=equipmentDiag, portMacIfIndex=portMacIfIndex, cmResetUpTime=cmResetUpTime, cardTemperature=cardTemperature, cardBusSpeed=cardBusSpeed, equipmentStateGroup=equipmentStateGroup, diskVolumeUsageLevel=diskVolumeUsageLevel, portRxFlowControlMode=portRxFlowControlMode, cardTestName=cardTestName, cardLastBootSource=cardLastBootSource, equipmentShelfGroup=equipmentShelfGroup, cardSubDetected=cardSubDetected, cardPicHwVersion=cardPicHwVersion, cardFwVersion=cardFwVersion, cardTestScheduleCommand=cardTestScheduleCommand, cardTestResult=cardTestResult, eqDiagConfig=eqDiagConfig, auditStatus=auditStatus, shelfName=shelfName, auditCycleCount=auditCycleCount, diagTestId=diagTestId, cardTestCommand=cardTestCommand, systemKey=systemKey, diskVolumeShelfId=diskVolumeShelfId, TestType=TestType, diskVolumeName=diskVolumeName, cardShelfTestIndex=cardShelfTestIndex, cmResetReason=cmResetReason, cardTempNoReportNotification=cardTempNoReportNotification, portType=portType, cmMacAddress=cmMacAddress, cardSecStateChange=cardSecStateChange, portShelfId=portShelfId, portMaxDsPower=portMaxDsPower, cardName=cardName, remainInDiagMode=remainInDiagMode, cmPrimarySID=cmPrimarySID, auditEntry=auditEntry, cardTestEntry=cardTestEntry, auditLogThrottle=auditLogThrottle, cardTestIndex=cardTestIndex, portDocsIfIndex=portDocsIfIndex)
