...
DuplexStatus, CardType, FirmwareSource, PrimaryState, PicType, PortType, FlowControlMode, CardSubType, PortMode, CardId, DiskVolumeUsageLevel, ShelfId, EqActionType, PortId, PortDetectedMode, UnknownState, SecondaryState, AdminState = mibBuilder.importSymbols("CADANT-TC", "DuplexStatus", "CardType", "FirmwareSource", "PrimaryState", "PicType", "PortType", "FlowControlMode", "CardSubType", "PortMode", "CardId", "DiskVolumeUsageLevel", "ShelfId", "EqActionType", "PortId", "PortDetectedMode", "UnknownState", "SecondaryState", "AdminState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
ObjectIdentity, ModuleIdentity, Counter32, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Bits, IpAddress, Unsigned32, Integer32, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Counter32", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Bits", "IpAddress", "Unsigned32", "Integer32", "Counter64", "MibIdentifier")
MacAddress, DateAndTime, TruthValue, TextualConvention, TimeStamp, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "DateAndTime", "TruthValue", "TextualConvention", "TimeStamp", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardDetectedChange=cardDetectedChange, cardSerialNum=cardSerialNum, auditResult=auditResult, cardTable=cardTable, cardCarrierFwVersion=cardCarrierFwVersion, cardTestTime=cardTestTime, systemKey=systemKey, cardUpTime=cardUpTime, portId=portId, cardShelfId=cardShelfId, portShelfId=portShelfId, cardLastBootVersion=cardLastBootVersion, cardDplxStatus=cardDplxStatus, portLastChangeTime=portLastChangeTime, cardFwUpdateStatus=cardFwUpdateStatus, auditLogThrottle=auditLogThrottle, cardLastResetReason=cardLastResetReason, portCardSubType=portCardSubType, diskVolumeTable=diskVolumeTable, cardTrapInh=cardTrapInh, cmDevice=cmDevice, portNumChans=portNumChans, cardFlashSize=cardFlashSize, portRxFlowControlDetected=portRxFlowControlDetected, cardCarrierHwVersion=cardCarrierHwVersion, shelfNumber=shelfNumber, cardLastBootSource=cardLastBootSource, cardTestResultDesc=cardTestResultDesc, auditFailedCount=auditFailedCount, portDplxStatusChange=portDplxStatusChange, auditName=auditName, cmResetNotification=cmResetNotification, auditLogOutput=auditLogOutput, portMaxDsPower=portMaxDsPower, portDocsIfIndex=portDocsIfIndex, portAction=portAction, cardDplxStatusChange=cardDplxStatusChange, cardFpgaSource=cardFpgaSource, cardTempOverHeatNotification=cardTempOverHeatNotification, portBgpId=portBgpId, auditAutoScheduling=auditAutoScheduling, cardCPLDVersion=cardCPLDVersion, fpgaErrorEventTable=fpgaErrorEventTable, errEvLoggingEnabled=errEvLoggingEnabled, shelfSwVersion=shelfSwVersion, cmVendor=cmVendor, auditCycleCount=auditCycleCount, equipmentCardGroup=equipmentCardGroup, cardPicHwVersion=cardPicHwVersion, diskVolumeNumber=diskVolumeNumber, equipmentCardTestGroup=equipmentCardTestGroup, diskVolumeUsagePercentage=diskVolumeUsagePercentage, systemClock=systemClock, portDetectedMode=portDetectedMode, cmResetReason=cmResetReason, cardTemperature=cardTemperature, cmResetStatus=cmResetStatus, cadEquipmentMibGroup=cadEquipmentMibGroup, portTxFlowControlDetected=portTxFlowControlDetected, cardFwVersion=cardFwVersion, diskVolumeUsageLevel=diskVolumeUsageLevel, cardTestId=cardTestId, portMode=portMode, cmResetUpTime=cmResetUpTime, equipmentError=equipmentError, cardSpareGroupId=cardSpareGroupId, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardHwVersion=cardHwVersion, cardSecState=cardSecState, cardEntry=cardEntry, cardNumPorts=cardNumPorts, cmRegistrationNotification=cmRegistrationNotification, equipmentPortGroup=equipmentPortGroup, cmResetInfo=cmResetInfo, cardAdminState=cardAdminState, portPrState=portPrState, diskVolumeTrapInh=diskVolumeTrapInh, diskVolumeFileName=diskVolumeFileName, systemGeneralGroup=systemGeneralGroup, portDplxStatus=portDplxStatus, portEntry=portEntry, cardRamSize=cardRamSize, trapCounter=trapCounter, cardSpareGroupMode=cardSpareGroupMode, equipmentAuditGroup=equipmentAuditGroup, auditId=auditId, cardTestSchedule=cardTestSchedule, auditDescription=auditDescription, portPrStateChange=portPrStateChange, TestScheduleCommand=TestScheduleCommand, cardSecStateChange=cardSecStateChange, errEvLogLevel=errEvLogLevel, shelfName=shelfName, TestTransactionId=TestTransactionId, portDescription=portDescription, cardDetected=cardDetected, equipmentShelfGroup=equipmentShelfGroup, cardTempNoReportNotification=cardTempNoReportNotification, eqDiagConfig=eqDiagConfig, cardType=cardType, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, diagTestId=diagTestId, PYSNMP_MODULE_ID=cadEquipmentMib, auditStatus=auditStatus, equipmentState=equipmentState, fpgaErrorEventGroup=fpgaErrorEventGroup, cadEquipmentMib=cadEquipmentMib, TestResult=TestResult, equipmentTbl=equipmentTbl, diskVolumeDriveId=diskVolumeDriveId, diskVolumeEntry=diskVolumeEntry, auditCardId=auditCardId, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeSize=diskVolumeSize, portAdminState=portAdminState, TestType=TestType, diskVolumeDiskSize=diskVolumeDiskSize, portMacIfIndex=portMacIfIndex, cardShelfTestIndex=cardShelfTestIndex, TestCommand=TestCommand, cmMacAddress=cmMacAddress, cardId=cardId, portSecStateChange=portSecStateChange, cmUChannelID=cmUChannelID, cardPicSerialNum=cardPicSerialNum, diskVolumeName=diskVolumeName, cardTestCommand=cardTestCommand, cardSubType=cardSubType, portRxFlowControlMode=portRxFlowControlMode, cardSubDetected=cardSubDetected, cardTestTable=cardTestTable, auditTable=auditTable, diskVolumeCardId=diskVolumeCardId, diskVolumeShelfId=diskVolumeShelfId, cardSwVersion=cardSwVersion, auditTotalPassedCount=auditTotalPassedCount, portMacAddress=portMacAddress, cmResetClearNotification=cmResetClearNotification, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portNumber=portNumber, verboseLevel=verboseLevel, systemGeneral=systemGeneral, cardCarrierSerialNum=cardCarrierSerialNum, cardTestResult=cardTestResult, cardTemperatureHighError=cardTemperatureHighError, portSecState=portSecState, cardBusSpeed=cardBusSpeed, cardTemperatureHighWarn=cardTemperatureHighWarn, trapSeverity=trapSeverity, cardPrStateChange=cardPrStateChange, cardTestType=cardTestType, equipmentStateGroup=equipmentStateGroup, cardName=cardName, cmPrimarySID=cmPrimarySID, diskDriveNumber=diskDriveNumber, downstreamPowerLoss=downstreamPowerLoss, cardNumber=cardNumber, errEvRecoveryEnabled=errEvRecoveryEnabled, portMinDsPower=portMinDsPower, cardCpuType=cardCpuType, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portTxFlowControlMode=portTxFlowControlMode, cardTestDescription=cardTestDescription, equipmentTraps=equipmentTraps, cardPrState=cardPrState, consoleOutput=consoleOutput, cardPicDetected=cardPicDetected, portTrapInh=portTrapInh, auditEntry=auditEntry, equipmentDiagGroup=equipmentDiagGroup, cardCpuSpeed=cardCpuSpeed, equipmentAudit=equipmentAudit, cadEquipmentMibCompliances=cadEquipmentMibCompliances, auditShelfId=auditShelfId, auditCommand=auditCommand, shelfObjects=shelfObjects, TestId=TestId, cmIpAddress=cmIpAddress, errEventId=errEventId, portCurrDsPower=portCurrDsPower, remainInDiagMode=remainInDiagMode, cardBootVersion=cardBootVersion, TestSchedule=TestSchedule, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, errEvRowStatus=errEvRowStatus, cardTestName=cardTestName, auditPassedCount=auditPassedCount, cardTestTransId=cardTestTransId, cardTestScheduleCommand=cardTestScheduleCommand, diskVolumeGroup=diskVolumeGroup, equipmentDiag=equipmentDiag, cardLastChangeTime=cardLastChangeTime, portCardId=portCardId, portType=portType, cadEquipmentMibConformance=cadEquipmentMibConformance, cardTestEntry=cardTestEntry, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, auditTime=auditTime, cardAction=cardAction, cardTestIndex=cardTestIndex, diskVolumeId=diskVolumeId, portTable=portTable, portConnectorId=portConnectorId, cardTestResultNotification=cardTestResultNotification, fpgaErrorEventEntry=fpgaErrorEventEntry, auditTotalFailedCount=auditTotalFailedCount)
