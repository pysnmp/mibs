...
PrimaryState, PortMode, FlowControlMode, CardId, PortId, UnknownState, AdminState, EqActionType, PortDetectedMode, PortType, SecondaryState, FirmwareSource, ShelfId, DuplexStatus, PicType, DiskVolumeUsageLevel, CardSubType, CardType = mibBuilder.importSymbols("CADANT-TC", "PrimaryState", "PortMode", "FlowControlMode", "CardId", "PortId", "UnknownState", "AdminState", "EqActionType", "PortDetectedMode", "PortType", "SecondaryState", "FirmwareSource", "ShelfId", "DuplexStatus", "PicType", "DiskVolumeUsageLevel", "CardSubType", "CardType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
iso, IpAddress, Unsigned32, Counter64, Integer32, ObjectIdentity, Gauge32, MibIdentifier, Bits, NotificationType, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Unsigned32", "Counter64", "Integer32", "ObjectIdentity", "Gauge32", "MibIdentifier", "Bits", "NotificationType", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
TextualConvention, DisplayString, MacAddress, DateAndTime, RowStatus, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "MacAddress", "DateAndTime", "RowStatus", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardId=cardId, cardNumber=cardNumber, portAction=portAction, cardShelfTestIndex=cardShelfTestIndex, cmResetInfo=cmResetInfo, cardCarrierFwVersion=cardCarrierFwVersion, fpgaErrorEventTable=fpgaErrorEventTable, cardTestResultDesc=cardTestResultDesc, portTxFlowControlMode=portTxFlowControlMode, equipmentCardTestGroup=equipmentCardTestGroup, diskDriveNumber=diskDriveNumber, eqDiagConfig=eqDiagConfig, cardTestCommand=cardTestCommand, diskVolumeName=diskVolumeName, auditResult=auditResult, portCardId=portCardId, cardHwVersion=cardHwVersion, portMacIfIndex=portMacIfIndex, errEvLoggingEnabled=errEvLoggingEnabled, portCurrDsPower=portCurrDsPower, auditTotalPassedCount=auditTotalPassedCount, portMinDsPower=portMinDsPower, cardShelfId=cardShelfId, cardEntry=cardEntry, diskVolumeSize=diskVolumeSize, portType=portType, auditTable=auditTable, cardTempOverHeatNotification=cardTempOverHeatNotification, portTxFlowControlDetected=portTxFlowControlDetected, cardLastBootVersion=cardLastBootVersion, cardNumPorts=cardNumPorts, cardTrapInh=cardTrapInh, systemKey=systemKey, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, errEvRowStatus=errEvRowStatus, cardUpTime=cardUpTime, portRxFlowControlMode=portRxFlowControlMode, cadEquipmentMibGroup=cadEquipmentMibGroup, downstreamPowerLoss=downstreamPowerLoss, cardTestTime=cardTestTime, cardSpareGroupMode=cardSpareGroupMode, cmVendor=cmVendor, portDplxStatusChange=portDplxStatusChange, auditCardId=auditCardId, cardBusSpeed=cardBusSpeed, errEvRecoveryEnabled=errEvRecoveryEnabled, portMode=portMode, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardTestType=cardTestType, diskVolumeUsageLevel=diskVolumeUsageLevel, verboseLevel=verboseLevel, cadEquipmentMibConformance=cadEquipmentMibConformance, portConnectorId=portConnectorId, cmResetNotification=cmResetNotification, cardLastChangeTime=cardLastChangeTime, cardPrState=cardPrState, auditFailedCount=auditFailedCount, equipmentDiagGroup=equipmentDiagGroup, auditDescription=auditDescription, auditShelfId=auditShelfId, TestId=TestId, cardSecState=cardSecState, cardTemperatureHighError=cardTemperatureHighError, diagTestId=diagTestId, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, trapSeverity=trapSeverity, cardPicDetected=cardPicDetected, equipmentAuditGroup=equipmentAuditGroup, shelfName=shelfName, TestResult=TestResult, cardCarrierSerialNum=cardCarrierSerialNum, cardDetectedChange=cardDetectedChange, cardTestName=cardTestName, cardTestScheduleCommand=cardTestScheduleCommand, diskVolumeDiskSize=diskVolumeDiskSize, cardLastBootSource=cardLastBootSource, diskVolumeId=diskVolumeId, cardCarrierHwVersion=cardCarrierHwVersion, cardDplxStatus=cardDplxStatus, cmUChannelID=cmUChannelID, auditTotalFailedCount=auditTotalFailedCount, cardFpgaSource=cardFpgaSource, diskVolumeCardId=diskVolumeCardId, TestSchedule=TestSchedule, cmResetClearNotification=cmResetClearNotification, cardName=cardName, portAdminState=portAdminState, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardTable=cardTable, portPrState=portPrState, diskVolumeTrapInh=diskVolumeTrapInh, cardTestId=cardTestId, equipmentShelfGroup=equipmentShelfGroup, equipmentCardGroup=equipmentCardGroup, cardSubType=cardSubType, systemClock=systemClock, cardTemperatureHighWarn=cardTemperatureHighWarn, auditName=auditName, auditAutoScheduling=auditAutoScheduling, trapCounter=trapCounter, TestScheduleCommand=TestScheduleCommand, cmMacAddress=cmMacAddress, cardSecStateChange=cardSecStateChange, cmIpAddress=cmIpAddress, equipmentError=equipmentError, cardSubDetected=cardSubDetected, cmDevice=cmDevice, portMaxDsPower=portMaxDsPower, auditEntry=auditEntry, diskVolumeNumber=diskVolumeNumber, cardTempNoReportNotification=cardTempNoReportNotification, fpgaErrorEventGroup=fpgaErrorEventGroup, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, errEventId=errEventId, portTrapInh=portTrapInh, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditId=auditId, auditCycleCount=auditCycleCount, portSecStateChange=portSecStateChange, portDetectedMode=portDetectedMode, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portDplxStatus=portDplxStatus, equipmentState=equipmentState, cardTestIndex=cardTestIndex, portTable=portTable, cardBootVersion=cardBootVersion, cardRamSize=cardRamSize, cardFwVersion=cardFwVersion, diskVolumeFileName=diskVolumeFileName, cmResetReason=cmResetReason, cardTestResult=cardTestResult, cardTestTable=cardTestTable, portLastChangeTime=portLastChangeTime, cardTestEntry=cardTestEntry, portCardSubType=portCardSubType, portMacAddress=portMacAddress, portRxFlowControlDetected=portRxFlowControlDetected, portBgpId=portBgpId, cardTestDescription=cardTestDescription, remainInDiagMode=remainInDiagMode, cardPicHwVersion=cardPicHwVersion, diskVolumeEntry=diskVolumeEntry, cardPrStateChange=cardPrStateChange, cardTestResultNotification=cardTestResultNotification, PYSNMP_MODULE_ID=cadEquipmentMib, cardSerialNum=cardSerialNum, cardDplxStatusChange=cardDplxStatusChange, portPrStateChange=portPrStateChange, equipmentTbl=equipmentTbl, systemGeneralGroup=systemGeneralGroup, cmResetStatus=cmResetStatus, auditLogOutput=auditLogOutput, portShelfId=portShelfId, TestType=TestType, portDescription=portDescription, diskVolumeShelfId=diskVolumeShelfId, cardTestSchedule=cardTestSchedule, portNumChans=portNumChans, TestTransactionId=TestTransactionId, shelfNumber=shelfNumber, diskVolumeTable=diskVolumeTable, equipmentStateGroup=equipmentStateGroup, portEntry=portEntry, portDocsIfIndex=portDocsIfIndex, portId=portId, TestCommand=TestCommand, cardTestTransId=cardTestTransId, diskVolumeGroup=diskVolumeGroup, cadEquipmentMib=cadEquipmentMib, cardAdminState=cardAdminState, equipmentPortGroup=equipmentPortGroup, cardDetected=cardDetected, cardTemperature=cardTemperature, cardCpuType=cardCpuType, auditTime=auditTime, shelfObjects=shelfObjects, cadEquipmentMibCompliances=cadEquipmentMibCompliances, fpgaErrorEventEntry=fpgaErrorEventEntry, auditLogThrottle=auditLogThrottle, cardAction=cardAction, cardCpuSpeed=cardCpuSpeed, cardFlashSize=cardFlashSize, cardSpareGroupId=cardSpareGroupId, equipmentDiag=equipmentDiag, auditPassedCount=auditPassedCount, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portSecState=portSecState, systemGeneral=systemGeneral, cardType=cardType, diskVolumeDriveId=diskVolumeDriveId, consoleOutput=consoleOutput, cardSwVersion=cardSwVersion, cmPrimarySID=cmPrimarySID, cardLastResetReason=cardLastResetReason, portNumber=portNumber, auditStatus=auditStatus, diskVolumeUsageNotification=diskVolumeUsageNotification, cardFwUpdateStatus=cardFwUpdateStatus, cardPicSerialNum=cardPicSerialNum, auditCommand=auditCommand, errEvLogLevel=errEvLogLevel, cmRegistrationNotification=cmRegistrationNotification, equipmentAudit=equipmentAudit, cardCPLDVersion=cardCPLDVersion, equipmentTraps=equipmentTraps, shelfSwVersion=shelfSwVersion, cmResetUpTime=cmResetUpTime)
