...
CardSubType, CardType, DuplexStatus, PortDetectedMode, UnknownState, DiskVolumeUsageLevel, FlowControlMode, FirmwareSource, PortId, PrimaryState, PortMode, AdminState, CardId, SecondaryState, PicType, PortType, EqActionType, ShelfId = mibBuilder.importSymbols("CADANT-TC", "CardSubType", "CardType", "DuplexStatus", "PortDetectedMode", "UnknownState", "DiskVolumeUsageLevel", "FlowControlMode", "FirmwareSource", "PortId", "PrimaryState", "PortMode", "AdminState", "CardId", "SecondaryState", "PicType", "PortType", "EqActionType", "ShelfId")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, NotificationType, iso, Bits, Gauge32, TimeTicks, ObjectIdentity, Counter32, IpAddress, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "NotificationType", "iso", "Bits", "Gauge32", "TimeTicks", "ObjectIdentity", "Counter32", "IpAddress", "ModuleIdentity", "Integer32")
DateAndTime, TextualConvention, MacAddress, TruthValue, RowStatus, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "MacAddress", "TruthValue", "RowStatus", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portRxFlowControlDetected=portRxFlowControlDetected, cardTestId=cardTestId, shelfObjects=shelfObjects, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cmMacAddress=cmMacAddress, cardCpuSpeed=cardCpuSpeed, cardBusSpeed=cardBusSpeed, TestResult=TestResult, portDescription=portDescription, cardLastBootSource=cardLastBootSource, diskVolumeUsageLevel=diskVolumeUsageLevel, portCardId=portCardId, diskVolumeUsageNotification=diskVolumeUsageNotification, downstreamPowerLoss=downstreamPowerLoss, TestSchedule=TestSchedule, cardTestResult=cardTestResult, portCardSubType=portCardSubType, TestTransactionId=TestTransactionId, cardSecState=cardSecState, cardRamSize=cardRamSize, auditEntry=auditEntry, cardHwVersion=cardHwVersion, portDplxStatusChange=portDplxStatusChange, cardPrStateChange=cardPrStateChange, systemClock=systemClock, diskVolumeNumber=diskVolumeNumber, diskVolumeTrapInh=diskVolumeTrapInh, auditName=auditName, cardSpareGroupId=cardSpareGroupId, equipmentShelfGroup=equipmentShelfGroup, cardShelfTestIndex=cardShelfTestIndex, cardTempNoReportNotification=cardTempNoReportNotification, portRxFlowControlMode=portRxFlowControlMode, cardSubType=cardSubType, diskVolumeName=diskVolumeName, cardCpuType=cardCpuType, diskVolumeUsagePercentage=diskVolumeUsagePercentage, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardTestEntry=cardTestEntry, trapSeverity=trapSeverity, fpgaErrorEventTable=fpgaErrorEventTable, shelfName=shelfName, cardTrapInh=cardTrapInh, auditId=auditId, auditTotalPassedCount=auditTotalPassedCount, cmVendor=cmVendor, auditCardId=auditCardId, cardSubDetected=cardSubDetected, portDplxStatus=portDplxStatus, cardTestTable=cardTestTable, auditFailedCount=auditFailedCount, PYSNMP_MODULE_ID=cadEquipmentMib, cardTestDescription=cardTestDescription, cardCarrierSerialNum=cardCarrierSerialNum, trapCounter=trapCounter, cardType=cardType, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cmResetStatus=cmResetStatus, cadEquipmentMibConformance=cadEquipmentMibConformance, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portMacAddress=portMacAddress, fpgaErrorEventEntry=fpgaErrorEventEntry, cardDetected=cardDetected, shelfNumber=shelfNumber, eqDiagConfig=eqDiagConfig, errEvRowStatus=errEvRowStatus, equipmentAudit=equipmentAudit, equipmentPortGroup=equipmentPortGroup, portTrapInh=portTrapInh, equipmentState=equipmentState, portCurrDsPower=portCurrDsPower, cardTestScheduleCommand=cardTestScheduleCommand, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, portId=portId, portNumChans=portNumChans, diskVolumeCardId=diskVolumeCardId, verboseLevel=verboseLevel, cardTestType=cardTestType, cardTable=cardTable, cardFpgaSource=cardFpgaSource, portSecState=portSecState, cardShelfId=cardShelfId, portAction=portAction, diagTestId=diagTestId, equipmentCardTestGroup=equipmentCardTestGroup, errEvLogLevel=errEvLogLevel, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, TestScheduleCommand=TestScheduleCommand, diskVolumeTable=diskVolumeTable, portShelfId=portShelfId, portTable=portTable, cardTestSchedule=cardTestSchedule, diskVolumeFileName=diskVolumeFileName, cmPrimarySID=cmPrimarySID, cmIpAddress=cmIpAddress, portPrState=portPrState, equipmentTraps=equipmentTraps, cardTemperatureHighError=cardTemperatureHighError, cardTemperatureHighWarn=cardTemperatureHighWarn, equipmentAuditGroup=equipmentAuditGroup, shelfSwVersion=shelfSwVersion, portEntry=portEntry, portTxFlowControlDetected=portTxFlowControlDetected, cardLastResetReason=cardLastResetReason, cardSpareGroupMode=cardSpareGroupMode, remainInDiagMode=remainInDiagMode, portDocsIfIndex=portDocsIfIndex, cardSerialNum=cardSerialNum, cmResetInfo=cmResetInfo, errEvLoggingEnabled=errEvLoggingEnabled, auditLogOutput=auditLogOutput, portLastChangeTime=portLastChangeTime, cardTestTransId=cardTestTransId, cardUpTime=cardUpTime, cardSecStateChange=cardSecStateChange, cardCarrierHwVersion=cardCarrierHwVersion, portMinDsPower=portMinDsPower, TestType=TestType, cardTestResultDesc=cardTestResultDesc, cmResetClearNotification=cmResetClearNotification, auditAutoScheduling=auditAutoScheduling, auditDescription=auditDescription, auditCommand=auditCommand, errEvRecoveryEnabled=errEvRecoveryEnabled, diskDriveNumber=diskDriveNumber, cardTestName=cardTestName, portDetectedMode=portDetectedMode, cardPrState=cardPrState, cardPicDetected=cardPicDetected, equipmentTbl=equipmentTbl, cadEquipmentMib=cadEquipmentMib, consoleOutput=consoleOutput, cardPicHwVersion=cardPicHwVersion, systemKey=systemKey, cardTestIndex=cardTestIndex, cardName=cardName, equipmentDiag=equipmentDiag, cardDetectedChange=cardDetectedChange, auditStatus=auditStatus, portBgpId=portBgpId, cmResetUpTime=cmResetUpTime, auditTime=auditTime, cardPicSerialNum=cardPicSerialNum, cardTemperature=cardTemperature, portAdminState=portAdminState, equipmentCardGroup=equipmentCardGroup, cardCarrierFwVersion=cardCarrierFwVersion, equipmentError=equipmentError, systemGeneralGroup=systemGeneralGroup, diskVolumeShelfId=diskVolumeShelfId, cardTempOverHeatNotification=cardTempOverHeatNotification, equipmentDiagGroup=equipmentDiagGroup, portNumber=portNumber, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardFlashSize=cardFlashSize, auditCycleCount=auditCycleCount, auditShelfId=auditShelfId, systemGeneral=systemGeneral, diskVolumeSize=diskVolumeSize, portMacIfIndex=portMacIfIndex, errEventId=errEventId, cadEquipmentMibGroup=cadEquipmentMibGroup, portMaxDsPower=portMaxDsPower, cardId=cardId, cardDplxStatusChange=cardDplxStatusChange, cardTestResultNotification=cardTestResultNotification, equipmentStateGroup=equipmentStateGroup, cardSwVersion=cardSwVersion, TestId=TestId, cmResetNotification=cmResetNotification, cardEntry=cardEntry, portSecStateChange=portSecStateChange, cardAdminState=cardAdminState, cmDevice=cmDevice, portTxFlowControlMode=portTxFlowControlMode, cmRegistrationNotification=cmRegistrationNotification, cardAction=cardAction, cardNumber=cardNumber, diskVolumeDiskSize=diskVolumeDiskSize, portMode=portMode, auditLogThrottle=auditLogThrottle, cardBootVersion=cardBootVersion, cmUChannelID=cmUChannelID, diskVolumeId=diskVolumeId, portConnectorId=portConnectorId, cardTestCommand=cardTestCommand, auditTotalFailedCount=auditTotalFailedCount, cmResetReason=cmResetReason, cardFwUpdateStatus=cardFwUpdateStatus, cardLastBootVersion=cardLastBootVersion, cardCPLDVersion=cardCPLDVersion, TestCommand=TestCommand, portType=portType, cardNumPorts=cardNumPorts, auditResult=auditResult, cadEquipmentMibCompliances=cadEquipmentMibCompliances, diskVolumeGroup=diskVolumeGroup, auditPassedCount=auditPassedCount, diskVolumeEntry=diskVolumeEntry, cardDplxStatus=cardDplxStatus, cardFwVersion=cardFwVersion, diskVolumeDriveId=diskVolumeDriveId, auditTable=auditTable, portPrStateChange=portPrStateChange, cardLastChangeTime=cardLastChangeTime, cardTestTime=cardTestTime, fpgaErrorEventGroup=fpgaErrorEventGroup)
