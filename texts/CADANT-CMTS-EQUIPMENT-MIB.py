...
PicType, ShelfId, EqActionType, PrimaryState, DuplexStatus, AdminState, PortId, CardId, SecondaryState, DiskVolumeUsageLevel, FlowControlMode, CardType, PortDetectedMode, PortMode, PortType, UnknownState, FirmwareSource, CardSubType = mibBuilder.importSymbols("CADANT-TC", "PicType", "ShelfId", "EqActionType", "PrimaryState", "DuplexStatus", "AdminState", "PortId", "CardId", "SecondaryState", "DiskVolumeUsageLevel", "FlowControlMode", "CardType", "PortDetectedMode", "PortMode", "PortType", "UnknownState", "FirmwareSource", "CardSubType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
TimeTicks, MibIdentifier, ObjectIdentity, Counter32, iso, Unsigned32, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, NotificationType, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Counter32", "iso", "Unsigned32", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "NotificationType", "ModuleIdentity", "Bits")
DateAndTime, TruthValue, TimeStamp, TextualConvention, DisplayString, RowStatus, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TruthValue", "TimeStamp", "TextualConvention", "DisplayString", "RowStatus", "MacAddress")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardName=cardName, TestSchedule=TestSchedule, portShelfId=portShelfId, cardTemperatureHighError=cardTemperatureHighError, cardTestResult=cardTestResult, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardFpgaSource=cardFpgaSource, fpgaErrorEventGroup=fpgaErrorEventGroup, cardDetectedChange=cardDetectedChange, portPrState=portPrState, auditAutoScheduling=auditAutoScheduling, auditName=auditName, cadEquipmentMibConformance=cadEquipmentMibConformance, portLastChangeTime=portLastChangeTime, trapCounter=trapCounter, downstreamPowerLoss=downstreamPowerLoss, portRxFlowControlMode=portRxFlowControlMode, cardSecStateChange=cardSecStateChange, portAction=portAction, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTestCommand=cardTestCommand, equipmentError=equipmentError, cmResetClearNotification=cmResetClearNotification, cardLastChangeTime=cardLastChangeTime, diskVolumeEntry=diskVolumeEntry, diskVolumeId=diskVolumeId, diskDriveNumber=diskDriveNumber, cardTestName=cardTestName, TestResult=TestResult, auditEntry=auditEntry, portNumChans=portNumChans, errEvLogLevel=errEvLogLevel, diskVolumeDriveId=diskVolumeDriveId, diskVolumeName=diskVolumeName, errEventId=errEventId, cardShelfTestIndex=cardShelfTestIndex, cardLastResetReason=cardLastResetReason, cardDplxStatus=cardDplxStatus, cardSerialNum=cardSerialNum, equipmentState=equipmentState, cardTemperatureHighWarn=cardTemperatureHighWarn, cardNumber=cardNumber, cmMacAddress=cmMacAddress, cardUpTime=cardUpTime, consoleOutput=consoleOutput, cmRegistrationNotification=cmRegistrationNotification, cmUChannelID=cmUChannelID, portCurrDsPower=portCurrDsPower, systemKey=systemKey, cardTrapInh=cardTrapInh, shelfObjects=shelfObjects, diskVolumeGroup=diskVolumeGroup, diskVolumeFileName=diskVolumeFileName, cardId=cardId, portSecState=portSecState, cardCarrierSerialNum=cardCarrierSerialNum, auditTable=auditTable, equipmentTraps=equipmentTraps, cardHwVersion=cardHwVersion, cardTemperature=cardTemperature, portCardId=portCardId, cardCpuType=cardCpuType, cadEquipmentMib=cadEquipmentMib, equipmentCardTestGroup=equipmentCardTestGroup, cardFwVersion=cardFwVersion, auditShelfId=auditShelfId, errEvRecoveryEnabled=errEvRecoveryEnabled, cardBusSpeed=cardBusSpeed, cardLastBootVersion=cardLastBootVersion, cardAction=cardAction, cardSubType=cardSubType, cmResetInfo=cmResetInfo, systemGeneralGroup=systemGeneralGroup, cardTestIndex=cardTestIndex, TestScheduleCommand=TestScheduleCommand, diskVolumeNumber=diskVolumeNumber, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeTable=diskVolumeTable, auditResult=auditResult, diskVolumeUsageNotification=diskVolumeUsageNotification, portMacAddress=portMacAddress, shelfName=shelfName, portTxFlowControlMode=portTxFlowControlMode, cardTestTransId=cardTestTransId, cardLastBootSource=cardLastBootSource, auditCycleCount=auditCycleCount, cmResetReason=cmResetReason, trapSeverity=trapSeverity, equipmentPortGroup=equipmentPortGroup, equipmentAuditGroup=equipmentAuditGroup, cardFlashSize=cardFlashSize, TestTransactionId=TestTransactionId, remainInDiagMode=remainInDiagMode, cardTestResultDesc=cardTestResultDesc, cadEquipmentMibGroup=cadEquipmentMibGroup, auditStatus=auditStatus, cardCpuSpeed=cardCpuSpeed, portMaxDsPower=portMaxDsPower, cardTable=cardTable, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portTrapInh=portTrapInh, cmResetUpTime=cmResetUpTime, cardPrStateChange=cardPrStateChange, shelfNumber=shelfNumber, PYSNMP_MODULE_ID=cadEquipmentMib, portTxFlowControlDetected=portTxFlowControlDetected, cardShelfId=cardShelfId, cardPicHwVersion=cardPicHwVersion, portDescription=portDescription, cardNumPorts=cardNumPorts, cardBootVersion=cardBootVersion, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, portMinDsPower=portMinDsPower, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardSwVersion=cardSwVersion, auditFailedCount=auditFailedCount, cardTestTable=cardTestTable, cmDevice=cmDevice, cardTestResultNotification=cardTestResultNotification, portBgpId=portBgpId, errEvLoggingEnabled=errEvLoggingEnabled, portSecStateChange=portSecStateChange, shelfSwVersion=shelfSwVersion, portDplxStatus=portDplxStatus, portType=portType, auditTotalFailedCount=auditTotalFailedCount, diskVolumeTrapInh=diskVolumeTrapInh, equipmentDiagGroup=equipmentDiagGroup, auditCardId=auditCardId, portConnectorId=portConnectorId, cardAdminState=cardAdminState, equipmentAudit=equipmentAudit, cardPrState=cardPrState, cardDplxStatusChange=cardDplxStatusChange, cardTestId=cardTestId, cardSpareGroupId=cardSpareGroupId, diagTestId=diagTestId, eqDiagConfig=eqDiagConfig, cardTempNoReportNotification=cardTempNoReportNotification, cardCarrierHwVersion=cardCarrierHwVersion, auditPassedCount=auditPassedCount, cardTestScheduleCommand=cardTestScheduleCommand, equipmentCardGroup=equipmentCardGroup, portDocsIfIndex=portDocsIfIndex, cmPrimarySID=cmPrimarySID, portEntry=portEntry, systemClock=systemClock, portId=portId, auditTotalPassedCount=auditTotalPassedCount, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditTime=auditTime, errEvRowStatus=errEvRowStatus, cmVendor=cmVendor, cardDetected=cardDetected, cardTestEntry=cardTestEntry, cmResetNotification=cmResetNotification, auditDescription=auditDescription, cardTestTime=cardTestTime, cardTestDescription=cardTestDescription, portMacIfIndex=portMacIfIndex, equipmentTbl=equipmentTbl, portDplxStatusChange=portDplxStatusChange, equipmentShelfGroup=equipmentShelfGroup, cardSubDetected=cardSubDetected, cardCPLDVersion=cardCPLDVersion, portAdminState=portAdminState, cardTempOverHeatNotification=cardTempOverHeatNotification, cardRamSize=cardRamSize, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardFwUpdateStatus=cardFwUpdateStatus, cmIpAddress=cmIpAddress, cardTestType=cardTestType, cardTestSchedule=cardTestSchedule, cmResetStatus=cmResetStatus, cardEntry=cardEntry, verboseLevel=verboseLevel, auditId=auditId, diskVolumeDiskSize=diskVolumeDiskSize, diskVolumeShelfId=diskVolumeShelfId, diskVolumeSize=diskVolumeSize, equipmentDiag=equipmentDiag, auditLogThrottle=auditLogThrottle, portNumber=portNumber, TestCommand=TestCommand, cadEquipmentMibCompliances=cadEquipmentMibCompliances, equipmentStateGroup=equipmentStateGroup, fpgaErrorEventEntry=fpgaErrorEventEntry, portCardSubType=portCardSubType, TestId=TestId, portPrStateChange=portPrStateChange, portDetectedMode=portDetectedMode, cardType=cardType, diskVolumeCardId=diskVolumeCardId, auditLogOutput=auditLogOutput, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, TestType=TestType, cardPicSerialNum=cardPicSerialNum, cardSpareGroupMode=cardSpareGroupMode, portMode=portMode, auditCommand=auditCommand, systemGeneral=systemGeneral, cardSecState=cardSecState, cardPicDetected=cardPicDetected, fpgaErrorEventTable=fpgaErrorEventTable, portTable=portTable)
