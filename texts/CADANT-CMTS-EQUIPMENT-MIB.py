...
UnknownState, PortMode, DuplexStatus, PortType, CardType, SecondaryState, DiskVolumeUsageLevel, CardSubType, AdminState, CardId, FirmwareSource, PortDetectedMode, PrimaryState, ShelfId, PortId, EqActionType, PicType, FlowControlMode = mibBuilder.importSymbols("CADANT-TC", "UnknownState", "PortMode", "DuplexStatus", "PortType", "CardType", "SecondaryState", "DiskVolumeUsageLevel", "CardSubType", "AdminState", "CardId", "FirmwareSource", "PortDetectedMode", "PrimaryState", "ShelfId", "PortId", "EqActionType", "PicType", "FlowControlMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
IpAddress, Counter32, Bits, NotificationType, Counter64, TimeTicks, Unsigned32, iso, ModuleIdentity, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "Bits", "NotificationType", "Counter64", "TimeTicks", "Unsigned32", "iso", "ModuleIdentity", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier")
TimeStamp, MacAddress, DateAndTime, TruthValue, DisplayString, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "MacAddress", "DateAndTime", "TruthValue", "DisplayString", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardCpuSpeed=cardCpuSpeed, diskVolumeCardId=diskVolumeCardId, auditResult=auditResult, verboseLevel=verboseLevel, auditDescription=auditDescription, cardTestType=cardTestType, errEvLogLevel=errEvLogLevel, cardFpgaSource=cardFpgaSource, cardNumber=cardNumber, diskVolumeUsagePercentage=diskVolumeUsagePercentage, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cmResetStatus=cmResetStatus, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cadEquipmentMibCompliance=cadEquipmentMibCompliance, eqDiagConfig=eqDiagConfig, fpgaErrorEventEntry=fpgaErrorEventEntry, cardPicDetected=cardPicDetected, cardSubDetected=cardSubDetected, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, diskVolumeTable=diskVolumeTable, auditLogThrottle=auditLogThrottle, cmDevice=cmDevice, portDplxStatusChange=portDplxStatusChange, diskVolumeGroup=diskVolumeGroup, auditCommand=auditCommand, systemClock=systemClock, systemGeneral=systemGeneral, TestId=TestId, cardSpareGroupId=cardSpareGroupId, TestType=TestType, cardHwVersion=cardHwVersion, cardAction=cardAction, cardTestTable=cardTestTable, TestCommand=TestCommand, portTrapInh=portTrapInh, fpgaErrorEventGroup=fpgaErrorEventGroup, portDescription=portDescription, cardTestTransId=cardTestTransId, auditPassedCount=auditPassedCount, shelfObjects=shelfObjects, portTable=portTable, downstreamPowerLoss=downstreamPowerLoss, portNumber=portNumber, cardRamSize=cardRamSize, portTxFlowControlDetected=portTxFlowControlDetected, cardBusSpeed=cardBusSpeed, TestSchedule=TestSchedule, diskVolumeId=diskVolumeId, cardName=cardName, cardCarrierSerialNum=cardCarrierSerialNum, portDocsIfIndex=portDocsIfIndex, portAdminState=portAdminState, auditCardId=auditCardId, equipmentError=equipmentError, consoleOutput=consoleOutput, portMode=portMode, portDplxStatus=portDplxStatus, cmResetClearNotification=cmResetClearNotification, portMacIfIndex=portMacIfIndex, cardDetected=cardDetected, cardEntry=cardEntry, portLastChangeTime=portLastChangeTime, auditTotalFailedCount=auditTotalFailedCount, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTestEntry=cardTestEntry, portEntry=portEntry, auditCycleCount=auditCycleCount, cardPrState=cardPrState, cardTempNoReportNotification=cardTempNoReportNotification, diskVolumeDriveId=diskVolumeDriveId, TestScheduleCommand=TestScheduleCommand, cardSpareGroupMode=cardSpareGroupMode, cardPicHwVersion=cardPicHwVersion, equipmentState=equipmentState, cardLastBootVersion=cardLastBootVersion, portAction=portAction, portTxFlowControlMode=portTxFlowControlMode, cmResetNotification=cmResetNotification, auditStatus=auditStatus, cardCpuType=cardCpuType, portSecStateChange=portSecStateChange, diskVolumeName=diskVolumeName, cardTrapInh=cardTrapInh, portType=portType, diskVolumeTrapInh=diskVolumeTrapInh, cardSwVersion=cardSwVersion, cardCPLDVersion=cardCPLDVersion, cardLastResetReason=cardLastResetReason, cardSerialNum=cardSerialNum, diagTestId=diagTestId, portMinDsPower=portMinDsPower, portId=portId, portMaxDsPower=portMaxDsPower, cardAdminState=cardAdminState, cardTestDescription=cardTestDescription, portRxFlowControlDetected=portRxFlowControlDetected, trapSeverity=trapSeverity, diskVolumeShelfId=diskVolumeShelfId, portShelfId=portShelfId, cardTestResult=cardTestResult, portDetectedMode=portDetectedMode, auditAutoScheduling=auditAutoScheduling, portPrStateChange=portPrStateChange, cmPrimarySID=cmPrimarySID, cardPrStateChange=cardPrStateChange, cardTestScheduleCommand=cardTestScheduleCommand, cardSecStateChange=cardSecStateChange, cardType=cardType, portSecState=portSecState, cardTestTime=cardTestTime, cardFwVersion=cardFwVersion, diskDriveNumber=diskDriveNumber, cardShelfId=cardShelfId, cardLastChangeTime=cardLastChangeTime, portConnectorId=portConnectorId, diskVolumeSize=diskVolumeSize, cardTestResultDesc=cardTestResultDesc, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, errEventId=errEventId, trapCounter=trapCounter, cmResetUpTime=cmResetUpTime, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, shelfName=shelfName, auditShelfId=auditShelfId, cardCarrierHwVersion=cardCarrierHwVersion, equipmentCardGroup=equipmentCardGroup, cardTable=cardTable, cardDplxStatusChange=cardDplxStatusChange, cardShelfTestIndex=cardShelfTestIndex, equipmentDiagGroup=equipmentDiagGroup, cadEquipmentMibGroup=cadEquipmentMibGroup, systemKey=systemKey, equipmentDiag=equipmentDiag, diskVolumeEntry=diskVolumeEntry, cmResetReason=cmResetReason, equipmentPortGroup=equipmentPortGroup, auditTable=auditTable, cmMacAddress=cmMacAddress, cardDplxStatus=cardDplxStatus, portRxFlowControlMode=portRxFlowControlMode, remainInDiagMode=remainInDiagMode, diskVolumeUsageLevel=diskVolumeUsageLevel, cardSubType=cardSubType, cardBootVersion=cardBootVersion, cardTestName=cardTestName, cardSecState=cardSecState, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cmVendor=cmVendor, TestResult=TestResult, cadEquipmentMib=cadEquipmentMib, portBgpId=portBgpId, cardUpTime=cardUpTime, equipmentStateGroup=equipmentStateGroup, cardNumPorts=cardNumPorts, cardPicSerialNum=cardPicSerialNum, shelfSwVersion=shelfSwVersion, auditLogOutput=auditLogOutput, cardTestSchedule=cardTestSchedule, portCurrDsPower=portCurrDsPower, errEvLoggingEnabled=errEvLoggingEnabled, auditFailedCount=auditFailedCount, diskVolumeNumber=diskVolumeNumber, diskVolumeFileName=diskVolumeFileName, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portCardSubType=portCardSubType, equipmentTbl=equipmentTbl, fpgaErrorEventTable=fpgaErrorEventTable, cardTestResultNotification=cardTestResultNotification, equipmentShelfGroup=equipmentShelfGroup, cardTemperature=cardTemperature, cardTestId=cardTestId, errEvRowStatus=errEvRowStatus, errEvRecoveryEnabled=errEvRecoveryEnabled, equipmentAuditGroup=equipmentAuditGroup, cardTestIndex=cardTestIndex, cardFwUpdateStatus=cardFwUpdateStatus, auditTime=auditTime, cadEquipmentMibConformance=cadEquipmentMibConformance, portPrState=portPrState, cardTemperatureHighError=cardTemperatureHighError, equipmentAudit=equipmentAudit, equipmentTraps=equipmentTraps, cmRegistrationNotification=cmRegistrationNotification, TestTransactionId=TestTransactionId, diskVolumeDiskSize=diskVolumeDiskSize, systemGeneralGroup=systemGeneralGroup, cmIpAddress=cmIpAddress, PYSNMP_MODULE_ID=cadEquipmentMib, auditEntry=auditEntry, portCardId=portCardId, portMacAddress=portMacAddress, cmResetInfo=cmResetInfo, cardTestCommand=cardTestCommand, cardId=cardId, cardFlashSize=cardFlashSize, equipmentCardTestGroup=equipmentCardTestGroup, auditId=auditId, cardTempOverHeatNotification=cardTempOverHeatNotification, shelfNumber=shelfNumber, cmUChannelID=cmUChannelID, portNumChans=portNumChans, cardDetectedChange=cardDetectedChange, cardTemperatureHighWarn=cardTemperatureHighWarn, auditTotalPassedCount=auditTotalPassedCount, auditName=auditName, cardLastBootSource=cardLastBootSource)
