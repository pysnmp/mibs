...
PortId, ShelfId, DiskVolumeUsageLevel, SecondaryState, UnknownState, AdminState, EqActionType, CardType, FlowControlMode, CardId, CardSubType, FirmwareSource, PortMode, PicType, PortType, DuplexStatus, PrimaryState, PortDetectedMode = mibBuilder.importSymbols("CADANT-TC", "PortId", "ShelfId", "DiskVolumeUsageLevel", "SecondaryState", "UnknownState", "AdminState", "EqActionType", "CardType", "FlowControlMode", "CardId", "CardSubType", "FirmwareSource", "PortMode", "PicType", "PortType", "DuplexStatus", "PrimaryState", "PortDetectedMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
Gauge32, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Counter32, TimeTicks, iso, Bits, ObjectIdentity, IpAddress, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Counter32", "TimeTicks", "iso", "Bits", "ObjectIdentity", "IpAddress", "MibIdentifier", "Integer32")
DisplayString, MacAddress, TruthValue, DateAndTime, TimeStamp, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "MacAddress", "TruthValue", "DateAndTime", "TimeStamp", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", verboseLevel=verboseLevel, portMinDsPower=portMinDsPower, diskVolumeDriveId=diskVolumeDriveId, cmResetInfo=cmResetInfo, cardTable=cardTable, diskVolumeNumber=diskVolumeNumber, errEvRowStatus=errEvRowStatus, diskVolumeUsageNotification=diskVolumeUsageNotification, errEvLogLevel=errEvLogLevel, diskVolumeSize=diskVolumeSize, equipmentPortGroup=equipmentPortGroup, TestCommand=TestCommand, diskVolumeName=diskVolumeName, portTable=portTable, portMacAddress=portMacAddress, portMode=portMode, TestTransactionId=TestTransactionId, systemGeneralGroup=systemGeneralGroup, errEvLoggingEnabled=errEvLoggingEnabled, cardTemperatureHighError=cardTemperatureHighError, auditName=auditName, cardDplxStatus=cardDplxStatus, diskVolumeFileName=diskVolumeFileName, equipmentCardTestGroup=equipmentCardTestGroup, shelfSwVersion=shelfSwVersion, portPrStateChange=portPrStateChange, cardFwUpdateStatus=cardFwUpdateStatus, portPrState=portPrState, cardSecStateChange=cardSecStateChange, downstreamPowerLoss=downstreamPowerLoss, cardTestTransId=cardTestTransId, eqDiagConfig=eqDiagConfig, cardShelfId=cardShelfId, cardDplxStatusChange=cardDplxStatusChange, portId=portId, portRxFlowControlMode=portRxFlowControlMode, cardTemperatureHighWarn=cardTemperatureHighWarn, cardTestIndex=cardTestIndex, cardBusSpeed=cardBusSpeed, cardPicDetected=cardPicDetected, cmVendor=cmVendor, cardSpareGroupMode=cardSpareGroupMode, cardLastBootVersion=cardLastBootVersion, fpgaErrorEventTable=fpgaErrorEventTable, cadEquipmentMibGroup=cadEquipmentMibGroup, portSecState=portSecState, portDplxStatusChange=portDplxStatusChange, cmIpAddress=cmIpAddress, auditTotalFailedCount=auditTotalFailedCount, portDocsIfIndex=portDocsIfIndex, cardTrapInh=cardTrapInh, shelfObjects=shelfObjects, auditId=auditId, cadEquipmentMibConformance=cadEquipmentMibConformance, fpgaErrorEventEntry=fpgaErrorEventEntry, cardTestName=cardTestName, portSecStateChange=portSecStateChange, shelfName=shelfName, diskVolumeGroup=diskVolumeGroup, cardLastBootSource=cardLastBootSource, cardTestTable=cardTestTable, cardAction=cardAction, portRxFlowControlDetected=portRxFlowControlDetected, auditFailedCount=auditFailedCount, cardType=cardType, cardCarrierHwVersion=cardCarrierHwVersion, cmUChannelID=cmUChannelID, cadEquipmentMib=cadEquipmentMib, portLastChangeTime=portLastChangeTime, portCardSubType=portCardSubType, TestType=TestType, cardTestCommand=cardTestCommand, cardUpTime=cardUpTime, cardNumPorts=cardNumPorts, shelfNumber=shelfNumber, cardEntry=cardEntry, portBgpId=portBgpId, cardTestScheduleCommand=cardTestScheduleCommand, cardRamSize=cardRamSize, auditTotalPassedCount=auditTotalPassedCount, cardAdminState=cardAdminState, equipmentTraps=equipmentTraps, portMaxDsPower=portMaxDsPower, cardTestResultDesc=cardTestResultDesc, portTrapInh=portTrapInh, diagTestId=diagTestId, equipmentAuditGroup=equipmentAuditGroup, diskVolumeDiskSize=diskVolumeDiskSize, portDescription=portDescription, portTxFlowControlDetected=portTxFlowControlDetected, cardHwVersion=cardHwVersion, cmResetClearNotification=cmResetClearNotification, cardTestDescription=cardTestDescription, cardPrState=cardPrState, cardTestEntry=cardTestEntry, TestSchedule=TestSchedule, portCardId=portCardId, diskVolumeId=diskVolumeId, auditAutoScheduling=auditAutoScheduling, auditResult=auditResult, equipmentCardGroup=equipmentCardGroup, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardSwVersion=cardSwVersion, equipmentError=equipmentError, portNumChans=portNumChans, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portShelfId=portShelfId, cardTemperature=cardTemperature, diskVolumeUsageLevel=diskVolumeUsageLevel, cardCpuSpeed=cardCpuSpeed, diskVolumeTable=diskVolumeTable, diskVolumeShelfId=diskVolumeShelfId, portNumber=portNumber, auditLogOutput=auditLogOutput, portDetectedMode=portDetectedMode, portConnectorId=portConnectorId, equipmentShelfGroup=equipmentShelfGroup, auditDescription=auditDescription, equipmentDiag=equipmentDiag, portMacIfIndex=portMacIfIndex, cardSerialNum=cardSerialNum, remainInDiagMode=remainInDiagMode, auditPassedCount=auditPassedCount, auditCycleCount=auditCycleCount, consoleOutput=consoleOutput, diskVolumeCardId=diskVolumeCardId, cmResetReason=cmResetReason, equipmentState=equipmentState, cardTestSchedule=cardTestSchedule, cardPicHwVersion=cardPicHwVersion, cardDetectedChange=cardDetectedChange, auditStatus=auditStatus, errEvRecoveryEnabled=errEvRecoveryEnabled, auditLogThrottle=auditLogThrottle, portAdminState=portAdminState, cmResetStatus=cmResetStatus, cardCPLDVersion=cardCPLDVersion, cardSubDetected=cardSubDetected, cadEquipmentMibCompliances=cadEquipmentMibCompliances, systemGeneral=systemGeneral, trapSeverity=trapSeverity, diskVolumeEntry=diskVolumeEntry, portTxFlowControlMode=portTxFlowControlMode, cardPrStateChange=cardPrStateChange, cardFpgaSource=cardFpgaSource, cardTestResult=cardTestResult, cardCarrierFwVersion=cardCarrierFwVersion, equipmentAudit=equipmentAudit, cardFwVersion=cardFwVersion, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardCarrierSerialNum=cardCarrierSerialNum, auditCommand=auditCommand, TestId=TestId, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardLastChangeTime=cardLastChangeTime, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, equipmentDiagGroup=equipmentDiagGroup, cardName=cardName, portDplxStatus=portDplxStatus, auditTime=auditTime, systemClock=systemClock, cardSpareGroupId=cardSpareGroupId, cmRegistrationNotification=cmRegistrationNotification, TestResult=TestResult, cardTestResultNotification=cardTestResultNotification, cmMacAddress=cmMacAddress, cardId=cardId, cardTestType=cardTestType, cardTestTime=cardTestTime, auditEntry=auditEntry, cmResetNotification=cmResetNotification, TestScheduleCommand=TestScheduleCommand, cardBootVersion=cardBootVersion, cmDevice=cmDevice, cardPicSerialNum=cardPicSerialNum, portCurrDsPower=portCurrDsPower, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardDetected=cardDetected, cmPrimarySID=cmPrimarySID, cardLastResetReason=cardLastResetReason, equipmentStateGroup=equipmentStateGroup, cardTempNoReportNotification=cardTempNoReportNotification, cardSubType=cardSubType, cardCpuType=cardCpuType, PYSNMP_MODULE_ID=cadEquipmentMib, auditTable=auditTable, portType=portType, errEventId=errEventId, cardSecState=cardSecState, cmResetUpTime=cmResetUpTime, trapCounter=trapCounter, auditCardId=auditCardId, systemKey=systemKey, cardNumber=cardNumber, auditShelfId=auditShelfId, diskDriveNumber=diskDriveNumber, cardFlashSize=cardFlashSize, cardTempOverHeatNotification=cardTempOverHeatNotification, equipmentTbl=equipmentTbl, portEntry=portEntry, cardShelfTestIndex=cardShelfTestIndex, diskVolumeTrapInh=diskVolumeTrapInh, fpgaErrorEventGroup=fpgaErrorEventGroup, cardTestId=cardTestId, portAction=portAction)
