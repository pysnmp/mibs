...
PrimaryState, CardType, CardSubType, DuplexStatus, PortDetectedMode, FlowControlMode, ShelfId, UnknownState, PortId, PortType, AdminState, EqActionType, FirmwareSource, CardId, PicType, SecondaryState, PortMode, DiskVolumeUsageLevel = mibBuilder.importSymbols("CADANT-TC", "PrimaryState", "CardType", "CardSubType", "DuplexStatus", "PortDetectedMode", "FlowControlMode", "ShelfId", "UnknownState", "PortId", "PortType", "AdminState", "EqActionType", "FirmwareSource", "CardId", "PicType", "SecondaryState", "PortMode", "DiskVolumeUsageLevel")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
Gauge32, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Counter64, TimeTicks, MibIdentifier, Integer32, ObjectIdentity, ModuleIdentity, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Counter64", "TimeTicks", "MibIdentifier", "Integer32", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Bits")
TruthValue, TimeStamp, DateAndTime, MacAddress, RowStatus, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "DateAndTime", "MacAddress", "RowStatus", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardCarrierFwVersion=cardCarrierFwVersion, cmDevice=cmDevice, diagTestId=diagTestId, cardTestId=cardTestId, cardLastResetReason=cardLastResetReason, cardTestTable=cardTestTable, cmMacAddress=cmMacAddress, equipmentCardGroup=equipmentCardGroup, errEvLoggingEnabled=errEvLoggingEnabled, cardBusSpeed=cardBusSpeed, cardTestTime=cardTestTime, auditResult=auditResult, cmResetInfo=cmResetInfo, TestId=TestId, portCurrDsPower=portCurrDsPower, portMode=portMode, auditPassedCount=auditPassedCount, shelfSwVersion=shelfSwVersion, cardAdminState=cardAdminState, portMacIfIndex=portMacIfIndex, portNumber=portNumber, auditLogOutput=auditLogOutput, cmResetNotification=cmResetNotification, cmIpAddress=cmIpAddress, diskVolumeDriveId=diskVolumeDriveId, diskVolumeSize=diskVolumeSize, cmResetClearNotification=cmResetClearNotification, portDplxStatusChange=portDplxStatusChange, cardRamSize=cardRamSize, cardFwUpdateStatus=cardFwUpdateStatus, cardTemperatureHighWarn=cardTemperatureHighWarn, cardTestSchedule=cardTestSchedule, downstreamPowerLoss=downstreamPowerLoss, cardId=cardId, auditCardId=auditCardId, cardSpareGroupId=cardSpareGroupId, equipmentTraps=equipmentTraps, cardTestCommand=cardTestCommand, errEvLogLevel=errEvLogLevel, cardEntry=cardEntry, diskVolumeName=diskVolumeName, cmRegistrationNotification=cmRegistrationNotification, portType=portType, equipmentDiag=equipmentDiag, TestResult=TestResult, cardTestName=cardTestName, equipmentStateGroup=equipmentStateGroup, auditCycleCount=auditCycleCount, cardPrState=cardPrState, cardShelfTestIndex=cardShelfTestIndex, portSecState=portSecState, systemGeneral=systemGeneral, cardTestTransId=cardTestTransId, auditAutoScheduling=auditAutoScheduling, auditTotalFailedCount=auditTotalFailedCount, cmResetReason=cmResetReason, TestType=TestType, errEvRecoveryEnabled=errEvRecoveryEnabled, consoleOutput=consoleOutput, systemClock=systemClock, portAdminState=portAdminState, portBgpId=portBgpId, cmVendor=cmVendor, diskVolumeShelfId=diskVolumeShelfId, cardSpareGroupMode=cardSpareGroupMode, cardLastChangeTime=cardLastChangeTime, cardSubType=cardSubType, cardShelfId=cardShelfId, cardSwVersion=cardSwVersion, cardNumPorts=cardNumPorts, cardFlashSize=cardFlashSize, diskVolumeTable=diskVolumeTable, cardTempNoReportNotification=cardTempNoReportNotification, portConnectorId=portConnectorId, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portPrState=portPrState, cardPrStateChange=cardPrStateChange, auditFailedCount=auditFailedCount, TestSchedule=TestSchedule, remainInDiagMode=remainInDiagMode, diskVolumeUsageLevel=diskVolumeUsageLevel, TestCommand=TestCommand, portMacAddress=portMacAddress, cardTestIndex=cardTestIndex, errEvRowStatus=errEvRowStatus, cadEquipmentMibConformance=cadEquipmentMibConformance, diskVolumeEntry=diskVolumeEntry, cardSecState=cardSecState, portCardSubType=portCardSubType, portDocsIfIndex=portDocsIfIndex, diskVolumeDiskSize=diskVolumeDiskSize, cardFpgaSource=cardFpgaSource, shelfObjects=shelfObjects, cardTestScheduleCommand=cardTestScheduleCommand, auditName=auditName, fpgaErrorEventEntry=fpgaErrorEventEntry, cardDetectedChange=cardDetectedChange, cardTempOverHeatNotification=cardTempOverHeatNotification, portTable=portTable, diskVolumeFileName=diskVolumeFileName, cardTestResultDesc=cardTestResultDesc, portRxFlowControlMode=portRxFlowControlMode, cardPicSerialNum=cardPicSerialNum, auditDescription=auditDescription, equipmentAuditGroup=equipmentAuditGroup, cardLastBootVersion=cardLastBootVersion, cardPicDetected=cardPicDetected, cardSerialNum=cardSerialNum, cardTestDescription=cardTestDescription, cardTestResultNotification=cardTestResultNotification, cardUpTime=cardUpTime, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cadEquipmentMibCompliance=cadEquipmentMibCompliance, trapSeverity=trapSeverity, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, diskVolumeUsageNotification=diskVolumeUsageNotification, cadEquipmentMib=cadEquipmentMib, portAction=portAction, portPrStateChange=portPrStateChange, trapCounter=trapCounter, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portSecStateChange=portSecStateChange, cardCpuType=cardCpuType, cardCpuSpeed=cardCpuSpeed, diskVolumeGroup=diskVolumeGroup, diskVolumeId=diskVolumeId, equipmentDiagGroup=equipmentDiagGroup, portDescription=portDescription, cardDetected=cardDetected, diskVolumeTrapInh=diskVolumeTrapInh, cardTrapInh=cardTrapInh, shelfName=shelfName, diskVolumeNumber=diskVolumeNumber, auditShelfId=auditShelfId, auditLogThrottle=auditLogThrottle, cmResetStatus=cmResetStatus, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardTemperatureHighError=cardTemperatureHighError, systemKey=systemKey, portTrapInh=portTrapInh, cardName=cardName, portMinDsPower=portMinDsPower, cardTestType=cardTestType, auditTime=auditTime, portDetectedMode=portDetectedMode, cardTestResult=cardTestResult, cardTestEntry=cardTestEntry, verboseLevel=verboseLevel, cardCPLDVersion=cardCPLDVersion, portId=portId, cardAction=cardAction, portMaxDsPower=portMaxDsPower, portLastChangeTime=portLastChangeTime, TestScheduleCommand=TestScheduleCommand, fpgaErrorEventTable=fpgaErrorEventTable, equipmentTbl=equipmentTbl, cardLastBootSource=cardLastBootSource, equipmentPortGroup=equipmentPortGroup, portEntry=portEntry, cardHwVersion=cardHwVersion, equipmentAudit=equipmentAudit, TestTransactionId=TestTransactionId, portNumChans=portNumChans, cardType=cardType, cardSubDetected=cardSubDetected, portTxFlowControlMode=portTxFlowControlMode, cardSecStateChange=cardSecStateChange, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditCommand=auditCommand, shelfNumber=shelfNumber, cmUChannelID=cmUChannelID, equipmentCardTestGroup=equipmentCardTestGroup, equipmentError=equipmentError, auditStatus=auditStatus, errEventId=errEventId, cardCarrierSerialNum=cardCarrierSerialNum, cardTable=cardTable, cardNumber=cardNumber, auditTotalPassedCount=auditTotalPassedCount, fpgaErrorEventGroup=fpgaErrorEventGroup, cardFwVersion=cardFwVersion, cardPicHwVersion=cardPicHwVersion, eqDiagConfig=eqDiagConfig, auditId=auditId, portShelfId=portShelfId, portDplxStatus=portDplxStatus, cadEquipmentMibGroup=cadEquipmentMibGroup, equipmentState=equipmentState, cmResetUpTime=cmResetUpTime, equipmentShelfGroup=equipmentShelfGroup, portRxFlowControlDetected=portRxFlowControlDetected, cmPrimarySID=cmPrimarySID, cardDplxStatus=cardDplxStatus, systemGeneralGroup=systemGeneralGroup, diskVolumeCardId=diskVolumeCardId, cardBootVersion=cardBootVersion, PYSNMP_MODULE_ID=cadEquipmentMib, cardDplxStatusChange=cardDplxStatusChange, portCardId=portCardId, cardCarrierHwVersion=cardCarrierHwVersion, cardTemperature=cardTemperature, auditEntry=auditEntry, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, diskDriveNumber=diskDriveNumber, auditTable=auditTable)
