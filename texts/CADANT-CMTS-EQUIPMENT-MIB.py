...
DuplexStatus, CardType, CardId, CardSubType, DiskVolumeUsageLevel, PicType, FirmwareSource, PortMode, AdminState, PortDetectedMode, PrimaryState, SecondaryState, PortId, UnknownState, ShelfId, FlowControlMode, EqActionType, PortType = mibBuilder.importSymbols("CADANT-TC", "DuplexStatus", "CardType", "CardId", "CardSubType", "DiskVolumeUsageLevel", "PicType", "FirmwareSource", "PortMode", "AdminState", "PortDetectedMode", "PrimaryState", "SecondaryState", "PortId", "UnknownState", "ShelfId", "FlowControlMode", "EqActionType", "PortType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, Counter64, Bits, NotificationType, IpAddress, ObjectIdentity, Integer32, ModuleIdentity, TimeTicks, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "Counter64", "Bits", "NotificationType", "IpAddress", "ObjectIdentity", "Integer32", "ModuleIdentity", "TimeTicks", "Counter32", "iso")
DisplayString, MacAddress, DateAndTime, TextualConvention, RowStatus, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "MacAddress", "DateAndTime", "TextualConvention", "RowStatus", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", equipmentStateGroup=equipmentStateGroup, cmResetClearNotification=cmResetClearNotification, auditCardId=auditCardId, cardTestType=cardTestType, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditTime=auditTime, cardTrapInh=cardTrapInh, cardTestResult=cardTestResult, equipmentPortGroup=equipmentPortGroup, systemGeneral=systemGeneral, diskDriveNumber=diskDriveNumber, errEvLoggingEnabled=errEvLoggingEnabled, portType=portType, portDescription=portDescription, cardFwUpdateStatus=cardFwUpdateStatus, cardBusSpeed=cardBusSpeed, portMacAddress=portMacAddress, portCardSubType=portCardSubType, downstreamPowerLoss=downstreamPowerLoss, eqDiagConfig=eqDiagConfig, PYSNMP_MODULE_ID=cadEquipmentMib, portMode=portMode, cardTable=cardTable, systemGeneralGroup=systemGeneralGroup, fpgaErrorEventEntry=fpgaErrorEventEntry, cardAdminState=cardAdminState, cardTemperatureHighError=cardTemperatureHighError, portTxFlowControlDetected=portTxFlowControlDetected, systemClock=systemClock, cmResetInfo=cmResetInfo, auditLogThrottle=auditLogThrottle, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeSize=diskVolumeSize, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, TestScheduleCommand=TestScheduleCommand, cardSerialNum=cardSerialNum, cardAction=cardAction, cmRegistrationNotification=cmRegistrationNotification, TestId=TestId, TestType=TestType, fpgaErrorEventTable=fpgaErrorEventTable, verboseLevel=verboseLevel, portDocsIfIndex=portDocsIfIndex, cardLastBootVersion=cardLastBootVersion, cardTestName=cardTestName, auditCycleCount=auditCycleCount, cadEquipmentMibConformance=cadEquipmentMibConformance, cmVendor=cmVendor, portRxFlowControlDetected=portRxFlowControlDetected, auditStatus=auditStatus, cmResetUpTime=cmResetUpTime, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardDetectedChange=cardDetectedChange, auditCommand=auditCommand, portMacIfIndex=portMacIfIndex, cadEquipmentMib=cadEquipmentMib, systemKey=systemKey, cardRamSize=cardRamSize, cardTestSchedule=cardTestSchedule, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardSpareGroupMode=cardSpareGroupMode, portCurrDsPower=portCurrDsPower, equipmentCardTestGroup=equipmentCardTestGroup, cardTemperatureHighWarn=cardTemperatureHighWarn, cardLastChangeTime=cardLastChangeTime, portSecStateChange=portSecStateChange, cardPrState=cardPrState, cardShelfId=cardShelfId, portNumChans=portNumChans, errEventId=errEventId, TestSchedule=TestSchedule, equipmentDiagGroup=equipmentDiagGroup, cmResetStatus=cmResetStatus, portSecState=portSecState, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeId=diskVolumeId, cmResetReason=cmResetReason, cardLastBootSource=cardLastBootSource, shelfObjects=shelfObjects, diskVolumeName=diskVolumeName, portMaxDsPower=portMaxDsPower, cardSecStateChange=cardSecStateChange, portLastChangeTime=portLastChangeTime, portEntry=portEntry, TestTransactionId=TestTransactionId, diskVolumeEntry=diskVolumeEntry, cardPrStateChange=cardPrStateChange, auditLogOutput=auditLogOutput, cardUpTime=cardUpTime, portPrState=portPrState, cardCarrierHwVersion=cardCarrierHwVersion, cardTestCommand=cardTestCommand, errEvRecoveryEnabled=errEvRecoveryEnabled, consoleOutput=consoleOutput, portBgpId=portBgpId, cmMacAddress=cmMacAddress, cardTempNoReportNotification=cardTempNoReportNotification, auditResult=auditResult, cardTempOverHeatNotification=cardTempOverHeatNotification, equipmentAuditGroup=equipmentAuditGroup, cardTestIndex=cardTestIndex, cardFwVersion=cardFwVersion, cardShelfTestIndex=cardShelfTestIndex, cardFpgaSource=cardFpgaSource, cmIpAddress=cmIpAddress, diskVolumeNumber=diskVolumeNumber, shelfNumber=shelfNumber, cardTestScheduleCommand=cardTestScheduleCommand, cardSubDetected=cardSubDetected, cmUChannelID=cmUChannelID, diskVolumeGroup=diskVolumeGroup, trapCounter=trapCounter, cardFlashSize=cardFlashSize, diskVolumeTable=diskVolumeTable, cardTestTable=cardTestTable, diagTestId=diagTestId, diskVolumeDiskSize=diskVolumeDiskSize, auditFailedCount=auditFailedCount, cardCPLDVersion=cardCPLDVersion, cardHwVersion=cardHwVersion, cmResetNotification=cmResetNotification, portShelfId=portShelfId, cardNumPorts=cardNumPorts, trapSeverity=trapSeverity, equipmentAudit=equipmentAudit, auditId=auditId, equipmentTbl=equipmentTbl, portTrapInh=portTrapInh, cardPicHwVersion=cardPicHwVersion, cmDevice=cmDevice, portDplxStatusChange=portDplxStatusChange, cardDplxStatus=cardDplxStatus, cardTestDescription=cardTestDescription, errEvRowStatus=errEvRowStatus, cardNumber=cardNumber, cardPicDetected=cardPicDetected, cardLastResetReason=cardLastResetReason, portDplxStatus=portDplxStatus, portConnectorId=portConnectorId, cardBootVersion=cardBootVersion, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cmPrimarySID=cmPrimarySID, remainInDiagMode=remainInDiagMode, portPrStateChange=portPrStateChange, cardType=cardType, shelfName=shelfName, cardSwVersion=cardSwVersion, auditTotalPassedCount=auditTotalPassedCount, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardSecState=cardSecState, cardId=cardId, portTxFlowControlMode=portTxFlowControlMode, equipmentState=equipmentState, auditTotalFailedCount=auditTotalFailedCount, cardTestEntry=cardTestEntry, cardTestResultDesc=cardTestResultDesc, equipmentShelfGroup=equipmentShelfGroup, diskVolumeCardId=diskVolumeCardId, auditTable=auditTable, cardEntry=cardEntry, cardDetected=cardDetected, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardTestId=cardTestId, portCardId=portCardId, portNumber=portNumber, auditShelfId=auditShelfId, diskVolumeUsageNotification=diskVolumeUsageNotification, portMinDsPower=portMinDsPower, diskVolumeTrapInh=diskVolumeTrapInh, cardPicSerialNum=cardPicSerialNum, cadEquipmentMibGroup=cadEquipmentMibGroup, TestCommand=TestCommand, auditPassedCount=auditPassedCount, TestResult=TestResult, portAction=portAction, diskVolumeShelfId=diskVolumeShelfId, portTable=portTable, equipmentError=equipmentError, equipmentTraps=equipmentTraps, shelfSwVersion=shelfSwVersion, cardSubType=cardSubType, cardCpuSpeed=cardCpuSpeed, portDetectedMode=portDetectedMode, portRxFlowControlMode=portRxFlowControlMode, cardTestTransId=cardTestTransId, cardName=cardName, auditName=auditName, fpgaErrorEventGroup=fpgaErrorEventGroup, auditEntry=auditEntry, equipmentCardGroup=equipmentCardGroup, cardCpuType=cardCpuType, cardTemperature=cardTemperature, auditDescription=auditDescription, diskVolumeDriveId=diskVolumeDriveId, cardTestResultNotification=cardTestResultNotification, diskVolumeUsageLevel=diskVolumeUsageLevel, equipmentDiag=equipmentDiag, cardTestTime=cardTestTime, cardDplxStatusChange=cardDplxStatusChange, cardCarrierSerialNum=cardCarrierSerialNum, portAdminState=portAdminState, errEvLogLevel=errEvLogLevel, auditAutoScheduling=auditAutoScheduling, diskVolumeFileName=diskVolumeFileName, portId=portId, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardSpareGroupId=cardSpareGroupId)
