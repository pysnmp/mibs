...
ShelfId, CardType, FlowControlMode, PrimaryState, DiskVolumeUsageLevel, SecondaryState, CardId, EqActionType, PortId, PortMode, AdminState, FirmwareSource, PortDetectedMode, PortType, DuplexStatus, PicType, CardSubType, UnknownState = mibBuilder.importSymbols("CADANT-TC", "ShelfId", "CardType", "FlowControlMode", "PrimaryState", "DiskVolumeUsageLevel", "SecondaryState", "CardId", "EqActionType", "PortId", "PortMode", "AdminState", "FirmwareSource", "PortDetectedMode", "PortType", "DuplexStatus", "PicType", "CardSubType", "UnknownState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
Counter32, IpAddress, Bits, Counter64, MibIdentifier, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, ObjectIdentity, Integer32, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "Bits", "Counter64", "MibIdentifier", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "ObjectIdentity", "Integer32", "NotificationType", "Unsigned32")
DisplayString, RowStatus, TextualConvention, DateAndTime, TimeStamp, MacAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TextualConvention", "DateAndTime", "TimeStamp", "MacAddress", "TruthValue")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", TestType=TestType, cardSubType=cardSubType, cardTestTransId=cardTestTransId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, errEvRowStatus=errEvRowStatus, portDescription=portDescription, cardNumPorts=cardNumPorts, portDocsIfIndex=portDocsIfIndex, auditTotalFailedCount=auditTotalFailedCount, cardSpareGroupMode=cardSpareGroupMode, auditLogThrottle=auditLogThrottle, auditTotalPassedCount=auditTotalPassedCount, cardRamSize=cardRamSize, cardTestTime=cardTestTime, systemGeneralGroup=systemGeneralGroup, cmResetNotification=cmResetNotification, equipmentShelfGroup=equipmentShelfGroup, equipmentTraps=equipmentTraps, TestScheduleCommand=TestScheduleCommand, cardSubDetected=cardSubDetected, cardDetectedChange=cardDetectedChange, cardCarrierHwVersion=cardCarrierHwVersion, cardFwVersion=cardFwVersion, shelfName=shelfName, cardSecStateChange=cardSecStateChange, trapSeverity=trapSeverity, portRxFlowControlDetected=portRxFlowControlDetected, fpgaErrorEventTable=fpgaErrorEventTable, systemClock=systemClock, cardType=cardType, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeSize=diskVolumeSize, cardCarrierSerialNum=cardCarrierSerialNum, cardCpuSpeed=cardCpuSpeed, cmResetUpTime=cmResetUpTime, portMinDsPower=portMinDsPower, cardTestResult=cardTestResult, equipmentCardGroup=equipmentCardGroup, cardPrState=cardPrState, diskVolumeNumber=diskVolumeNumber, cardPrStateChange=cardPrStateChange, cardBootVersion=cardBootVersion, cardTemperatureHighWarn=cardTemperatureHighWarn, portAction=portAction, cmResetClearNotification=cmResetClearNotification, portTrapInh=portTrapInh, cmResetStatus=cmResetStatus, portPrStateChange=portPrStateChange, equipmentStateGroup=equipmentStateGroup, cmIpAddress=cmIpAddress, shelfSwVersion=shelfSwVersion, portMacIfIndex=portMacIfIndex, auditPassedCount=auditPassedCount, auditCommand=auditCommand, cardTestIndex=cardTestIndex, portPrState=portPrState, portNumChans=portNumChans, auditDescription=auditDescription, cardName=cardName, cmUChannelID=cmUChannelID, portTxFlowControlMode=portTxFlowControlMode, portSecStateChange=portSecStateChange, diskDriveNumber=diskDriveNumber, portAdminState=portAdminState, portBgpId=portBgpId, auditTime=auditTime, cmDevice=cmDevice, TestTransactionId=TestTransactionId, auditLogOutput=auditLogOutput, diskVolumeDriveId=diskVolumeDriveId, PYSNMP_MODULE_ID=cadEquipmentMib, cardFpgaSource=cardFpgaSource, cardPicHwVersion=cardPicHwVersion, diskVolumeShelfId=diskVolumeShelfId, cadEquipmentMib=cadEquipmentMib, cardLastChangeTime=cardLastChangeTime, cadEquipmentMibCompliance=cadEquipmentMibCompliance, TestId=TestId, equipmentDiag=equipmentDiag, portDplxStatusChange=portDplxStatusChange, cardPicSerialNum=cardPicSerialNum, cardTestResultNotification=cardTestResultNotification, cardLastBootVersion=cardLastBootVersion, portType=portType, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, shelfObjects=shelfObjects, cardCpuType=cardCpuType, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, equipmentTbl=equipmentTbl, downstreamPowerLoss=downstreamPowerLoss, cardHwVersion=cardHwVersion, cardDplxStatus=cardDplxStatus, cardSerialNum=cardSerialNum, cardTempNoReportNotification=cardTempNoReportNotification, cardNumber=cardNumber, auditTable=auditTable, errEventId=errEventId, cmVendor=cmVendor, diskVolumeCardId=diskVolumeCardId, portTable=portTable, diskVolumeTrapInh=diskVolumeTrapInh, diagTestId=diagTestId, cardTestDescription=cardTestDescription, portDetectedMode=portDetectedMode, diskVolumeFileName=diskVolumeFileName, cardShelfId=cardShelfId, portNumber=portNumber, cardTestScheduleCommand=cardTestScheduleCommand, cmResetReason=cmResetReason, cardTemperatureHighError=cardTemperatureHighError, auditShelfId=auditShelfId, auditId=auditId, equipmentState=equipmentState, cmResetInfo=cmResetInfo, diskVolumeGroup=diskVolumeGroup, auditEntry=auditEntry, cardTemperature=cardTemperature, cardLastBootSource=cardLastBootSource, cardTrapInh=cardTrapInh, verboseLevel=verboseLevel, auditName=auditName, diskVolumeUsagePercentage=diskVolumeUsagePercentage, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTestType=cardTestType, eqDiagConfig=eqDiagConfig, cardDplxStatusChange=cardDplxStatusChange, cardTestCommand=cardTestCommand, cardTestTable=cardTestTable, cardTestId=cardTestId, auditAutoScheduling=auditAutoScheduling, cardPicDetected=cardPicDetected, auditResult=auditResult, cardAction=cardAction, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTempOverHeatNotification=cardTempOverHeatNotification, equipmentAudit=equipmentAudit, shelfNumber=shelfNumber, portCardId=portCardId, cardSecState=cardSecState, systemGeneral=systemGeneral, TestCommand=TestCommand, auditCardId=auditCardId, portId=portId, diskVolumeUsageLevel=diskVolumeUsageLevel, errEvLoggingEnabled=errEvLoggingEnabled, auditStatus=auditStatus, diskVolumeDiskSize=diskVolumeDiskSize, cmPrimarySID=cmPrimarySID, equipmentError=equipmentError, cadEquipmentMibGroup=cadEquipmentMibGroup, cardTestSchedule=cardTestSchedule, remainInDiagMode=remainInDiagMode, cardCarrierFwVersion=cardCarrierFwVersion, cardTestEntry=cardTestEntry, portCardSubType=portCardSubType, equipmentDiagGroup=equipmentDiagGroup, portMacAddress=portMacAddress, TestResult=TestResult, portCurrDsPower=portCurrDsPower, errEvLogLevel=errEvLogLevel, cardEntry=cardEntry, diskVolumeEntry=diskVolumeEntry, portSecState=portSecState, cardDetected=cardDetected, equipmentCardTestGroup=equipmentCardTestGroup, TestSchedule=TestSchedule, auditCycleCount=auditCycleCount, portConnectorId=portConnectorId, errEvRecoveryEnabled=errEvRecoveryEnabled, diskVolumeUsageNotification=diskVolumeUsageNotification, cadEquipmentMibConformance=cadEquipmentMibConformance, cardFlashSize=cardFlashSize, fpgaErrorEventEntry=fpgaErrorEventEntry, equipmentPortGroup=equipmentPortGroup, cardBusSpeed=cardBusSpeed, portShelfId=portShelfId, portLastChangeTime=portLastChangeTime, cardSwVersion=cardSwVersion, diskVolumeName=diskVolumeName, cardFwUpdateStatus=cardFwUpdateStatus, portRxFlowControlMode=portRxFlowControlMode, cardShelfTestIndex=cardShelfTestIndex, portMode=portMode, cardUpTime=cardUpTime, diskVolumeId=diskVolumeId, cmRegistrationNotification=cmRegistrationNotification, cardTable=cardTable, consoleOutput=consoleOutput, auditFailedCount=auditFailedCount, systemKey=systemKey, cardAdminState=cardAdminState, fpgaErrorEventGroup=fpgaErrorEventGroup, cardSpareGroupId=cardSpareGroupId, cardTestResultDesc=cardTestResultDesc, cardLastResetReason=cardLastResetReason, portEntry=portEntry, equipmentAuditGroup=equipmentAuditGroup, portDplxStatus=portDplxStatus, cmMacAddress=cmMacAddress, cardTestName=cardTestName, cardCPLDVersion=cardCPLDVersion, trapCounter=trapCounter, diskVolumeTable=diskVolumeTable, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardId=cardId, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portMaxDsPower=portMaxDsPower)
