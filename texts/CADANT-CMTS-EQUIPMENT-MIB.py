...
CardId, DiskVolumeUsageLevel, DuplexStatus, ShelfId, PortId, CardSubType, PrimaryState, EqActionType, UnknownState, CardType, FlowControlMode, PortDetectedMode, FirmwareSource, SecondaryState, PortType, AdminState, PicType, PortMode = mibBuilder.importSymbols("CADANT-TC", "CardId", "DiskVolumeUsageLevel", "DuplexStatus", "ShelfId", "PortId", "CardSubType", "PrimaryState", "EqActionType", "UnknownState", "CardType", "FlowControlMode", "PortDetectedMode", "FirmwareSource", "SecondaryState", "PortType", "AdminState", "PicType", "PortMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
ModuleIdentity, IpAddress, NotificationType, Integer32, Counter64, Gauge32, MibIdentifier, Bits, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "NotificationType", "Integer32", "Counter64", "Gauge32", "MibIdentifier", "Bits", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "ObjectIdentity")
RowStatus, TimeStamp, DisplayString, TruthValue, MacAddress, DateAndTime, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "DisplayString", "TruthValue", "MacAddress", "DateAndTime", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", TestId=TestId, cardNumPorts=cardNumPorts, auditFailedCount=auditFailedCount, diskVolumeUsagePercentage=diskVolumeUsagePercentage, diskVolumeTrapInh=diskVolumeTrapInh, TestType=TestType, cadEquipmentMib=cadEquipmentMib, cardCarrierHwVersion=cardCarrierHwVersion, cardTempNoReportNotification=cardTempNoReportNotification, cardSpareGroupId=cardSpareGroupId, equipmentError=equipmentError, auditLogOutput=auditLogOutput, auditTable=auditTable, cardTemperature=cardTemperature, cardPicSerialNum=cardPicSerialNum, auditCommand=auditCommand, auditLogThrottle=auditLogThrottle, cardFlashSize=cardFlashSize, TestSchedule=TestSchedule, portSecState=portSecState, auditPassedCount=auditPassedCount, cmResetReason=cmResetReason, errEvRowStatus=errEvRowStatus, portEntry=portEntry, shelfSwVersion=shelfSwVersion, cadEquipmentMibGroup=cadEquipmentMibGroup, portDescription=portDescription, auditShelfId=auditShelfId, systemGeneral=systemGeneral, equipmentAudit=equipmentAudit, portPrStateChange=portPrStateChange, shelfNumber=shelfNumber, cardType=cardType, cmPrimarySID=cmPrimarySID, diskVolumeCardId=diskVolumeCardId, cardDetected=cardDetected, cardTestResultDesc=cardTestResultDesc, portTrapInh=portTrapInh, cmVendor=cmVendor, verboseLevel=verboseLevel, cardEntry=cardEntry, portMinDsPower=portMinDsPower, TestTransactionId=TestTransactionId, cardCarrierSerialNum=cardCarrierSerialNum, cmDevice=cmDevice, equipmentCardGroup=equipmentCardGroup, diskVolumeNumber=diskVolumeNumber, portCardId=portCardId, cardFpgaSource=cardFpgaSource, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeSize=diskVolumeSize, cardTestName=cardTestName, cardCPLDVersion=cardCPLDVersion, cardLastBootVersion=cardLastBootVersion, diskVolumeGroup=diskVolumeGroup, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, consoleOutput=consoleOutput, cardPicDetected=cardPicDetected, systemGeneralGroup=systemGeneralGroup, systemClock=systemClock, cardHwVersion=cardHwVersion, diskVolumeName=diskVolumeName, auditTotalFailedCount=auditTotalFailedCount, diskVolumeDriveId=diskVolumeDriveId, cardSerialNum=cardSerialNum, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardTestResultNotification=cardTestResultNotification, shelfName=shelfName, cardRamSize=cardRamSize, portAction=portAction, auditTime=auditTime, cmResetInfo=cmResetInfo, auditName=auditName, trapCounter=trapCounter, errEvRecoveryEnabled=errEvRecoveryEnabled, portAdminState=portAdminState, equipmentStateGroup=equipmentStateGroup, cardShelfId=cardShelfId, cardAdminState=cardAdminState, cardSpareGroupMode=cardSpareGroupMode, cardBusSpeed=cardBusSpeed, cardSecStateChange=cardSecStateChange, portDetectedMode=portDetectedMode, auditCycleCount=auditCycleCount, portTable=portTable, auditDescription=auditDescription, cardTestIndex=cardTestIndex, equipmentAuditGroup=equipmentAuditGroup, portMacIfIndex=portMacIfIndex, cardName=cardName, cardTestEntry=cardTestEntry, auditStatus=auditStatus, cmIpAddress=cmIpAddress, eqDiagConfig=eqDiagConfig, cardTestDescription=cardTestDescription, cardNumber=cardNumber, cmResetClearNotification=cmResetClearNotification, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardBootVersion=cardBootVersion, errEvLoggingEnabled=errEvLoggingEnabled, portSecStateChange=portSecStateChange, trapSeverity=trapSeverity, portNumChans=portNumChans, portTxFlowControlMode=portTxFlowControlMode, portRxFlowControlDetected=portRxFlowControlDetected, portMode=portMode, cardTemperatureHighWarn=cardTemperatureHighWarn, cardFwUpdateStatus=cardFwUpdateStatus, fpgaErrorEventEntry=fpgaErrorEventEntry, cardAction=cardAction, portDocsIfIndex=portDocsIfIndex, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portCurrDsPower=portCurrDsPower, equipmentDiagGroup=equipmentDiagGroup, portMacAddress=portMacAddress, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardTestResult=cardTestResult, cardTestTime=cardTestTime, cmResetUpTime=cmResetUpTime, portNumber=portNumber, portBgpId=portBgpId, cmRegistrationNotification=cmRegistrationNotification, equipmentTbl=equipmentTbl, cmResetNotification=cmResetNotification, cardTestCommand=cardTestCommand, fpgaErrorEventTable=fpgaErrorEventTable, cmResetStatus=cmResetStatus, portDplxStatusChange=portDplxStatusChange, cardLastChangeTime=cardLastChangeTime, diagTestId=diagTestId, equipmentPortGroup=equipmentPortGroup, cardTrapInh=cardTrapInh, cardTemperatureHighError=cardTemperatureHighError, equipmentTraps=equipmentTraps, portPrState=portPrState, cardSecState=cardSecState, portConnectorId=portConnectorId, equipmentCardTestGroup=equipmentCardTestGroup, cardPrStateChange=cardPrStateChange, diskVolumeEntry=diskVolumeEntry, PYSNMP_MODULE_ID=cadEquipmentMib, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardTestType=cardTestType, cardPrState=cardPrState, TestCommand=TestCommand, auditEntry=auditEntry, diskVolumeFileName=diskVolumeFileName, equipmentState=equipmentState, downstreamPowerLoss=downstreamPowerLoss, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardShelfTestIndex=cardShelfTestIndex, auditTotalPassedCount=auditTotalPassedCount, equipmentShelfGroup=equipmentShelfGroup, auditAutoScheduling=auditAutoScheduling, fpgaErrorEventGroup=fpgaErrorEventGroup, cardCpuType=cardCpuType, diskDriveNumber=diskDriveNumber, cardId=cardId, cardSwVersion=cardSwVersion, TestResult=TestResult, equipmentDiag=equipmentDiag, auditResult=auditResult, auditCardId=auditCardId, cmUChannelID=cmUChannelID, shelfObjects=shelfObjects, TestScheduleCommand=TestScheduleCommand, portCardSubType=portCardSubType, diskVolumeShelfId=diskVolumeShelfId, errEventId=errEventId, diskVolumeUsageNotification=diskVolumeUsageNotification, errEvLogLevel=errEvLogLevel, cardDplxStatus=cardDplxStatus, portId=portId, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardUpTime=cardUpTime, cardPicHwVersion=cardPicHwVersion, portLastChangeTime=portLastChangeTime, cardTestId=cardTestId, cardTestScheduleCommand=cardTestScheduleCommand, cardSubDetected=cardSubDetected, auditId=auditId, cardTestSchedule=cardTestSchedule, cadEquipmentMibConformance=cadEquipmentMibConformance, cardFwVersion=cardFwVersion, cardTestTransId=cardTestTransId, remainInDiagMode=remainInDiagMode, portDplxStatus=portDplxStatus, cardDetectedChange=cardDetectedChange, cardLastResetReason=cardLastResetReason, diskVolumeTable=diskVolumeTable, systemKey=systemKey, cmMacAddress=cmMacAddress, portShelfId=portShelfId, portType=portType, cardLastBootSource=cardLastBootSource, portRxFlowControlMode=portRxFlowControlMode, cardTable=cardTable, cardCpuSpeed=cardCpuSpeed, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeId=diskVolumeId, diskVolumeDiskSize=diskVolumeDiskSize, cardTestTable=cardTestTable, cardDplxStatusChange=cardDplxStatusChange, diskVolumeUsageLevel=diskVolumeUsageLevel, cardSubType=cardSubType, portMaxDsPower=portMaxDsPower)
