...
EqActionType, PortMode, FirmwareSource, DuplexStatus, PortType, PortId, CardSubType, FlowControlMode, CardId, PrimaryState, SecondaryState, ShelfId, CardType, UnknownState, AdminState, PortDetectedMode, DiskVolumeUsageLevel, PicType = mibBuilder.importSymbols("CADANT-TC", "EqActionType", "PortMode", "FirmwareSource", "DuplexStatus", "PortType", "PortId", "CardSubType", "FlowControlMode", "CardId", "PrimaryState", "SecondaryState", "ShelfId", "CardType", "UnknownState", "AdminState", "PortDetectedMode", "DiskVolumeUsageLevel", "PicType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
Bits, iso, Gauge32, Integer32, ModuleIdentity, Unsigned32, Counter32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "Gauge32", "Integer32", "ModuleIdentity", "Unsigned32", "Counter32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "IpAddress", "NotificationType")
TruthValue, MacAddress, RowStatus, DisplayString, TextualConvention, DateAndTime, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "MacAddress", "RowStatus", "DisplayString", "TextualConvention", "DateAndTime", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cadEquipmentMib=cadEquipmentMib, auditLogThrottle=auditLogThrottle, cardFwUpdateStatus=cardFwUpdateStatus, cardLastResetReason=cardLastResetReason, portId=portId, cmResetStatus=cmResetStatus, diskVolumeSize=diskVolumeSize, portShelfId=portShelfId, cardTestScheduleCommand=cardTestScheduleCommand, TestTransactionId=TestTransactionId, PYSNMP_MODULE_ID=cadEquipmentMib, equipmentPortGroup=equipmentPortGroup, cardTestTime=cardTestTime, cardTestType=cardTestType, portTable=portTable, portMacIfIndex=portMacIfIndex, auditCycleCount=auditCycleCount, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cmResetReason=cmResetReason, auditId=auditId, cardDplxStatus=cardDplxStatus, verboseLevel=verboseLevel, cardTestIndex=cardTestIndex, diskVolumeFileName=diskVolumeFileName, cardDetectedChange=cardDetectedChange, cardTestSchedule=cardTestSchedule, cmUChannelID=cmUChannelID, systemGeneralGroup=systemGeneralGroup, trapSeverity=trapSeverity, cardSubDetected=cardSubDetected, cardDplxStatusChange=cardDplxStatusChange, errEvRecoveryEnabled=errEvRecoveryEnabled, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, auditTable=auditTable, auditTotalFailedCount=auditTotalFailedCount, portSecStateChange=portSecStateChange, TestScheduleCommand=TestScheduleCommand, diskVolumeCardId=diskVolumeCardId, portPrState=portPrState, cardTempNoReportNotification=cardTempNoReportNotification, diskVolumeDiskSize=diskVolumeDiskSize, cardFwVersion=cardFwVersion, cadEquipmentMibCompliances=cadEquipmentMibCompliances, TestCommand=TestCommand, shelfSwVersion=shelfSwVersion, equipmentTbl=equipmentTbl, portTrapInh=portTrapInh, cardCarrierSerialNum=cardCarrierSerialNum, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTestId=cardTestId, cardTable=cardTable, portCardSubType=portCardSubType, diskVolumeShelfId=diskVolumeShelfId, cmVendor=cmVendor, shelfObjects=shelfObjects, cardTestCommand=cardTestCommand, portMinDsPower=portMinDsPower, auditAutoScheduling=auditAutoScheduling, auditName=auditName, equipmentDiag=equipmentDiag, cadEquipmentMibConformance=cadEquipmentMibConformance, cardUpTime=cardUpTime, cardCpuType=cardCpuType, cardTemperatureHighError=cardTemperatureHighError, cardTestDescription=cardTestDescription, cardTestResultDesc=cardTestResultDesc, cmRegistrationNotification=cmRegistrationNotification, cardCpuSpeed=cardCpuSpeed, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, errEvRowStatus=errEvRowStatus, trapCounter=trapCounter, diskVolumeGroup=diskVolumeGroup, diskVolumeUsageNotification=diskVolumeUsageNotification, portDplxStatus=portDplxStatus, cmMacAddress=cmMacAddress, equipmentState=equipmentState, cardBootVersion=cardBootVersion, auditFailedCount=auditFailedCount, portPrStateChange=portPrStateChange, equipmentCardTestGroup=equipmentCardTestGroup, cardPicDetected=cardPicDetected, TestType=TestType, cardLastBootVersion=cardLastBootVersion, portDocsIfIndex=portDocsIfIndex, portDplxStatusChange=portDplxStatusChange, auditCardId=auditCardId, cardTestEntry=cardTestEntry, errEventId=errEventId, downstreamPowerLoss=downstreamPowerLoss, cardAction=cardAction, remainInDiagMode=remainInDiagMode, auditEntry=auditEntry, systemGeneral=systemGeneral, cardPrStateChange=cardPrStateChange, errEvLogLevel=errEvLogLevel, diskVolumeName=diskVolumeName, portEntry=portEntry, cardTestTable=cardTestTable, portAdminState=portAdminState, portAction=portAction, cardId=cardId, cardAdminState=cardAdminState, diskVolumeUsageLevel=diskVolumeUsageLevel, auditCommand=auditCommand, auditResult=auditResult, cmResetUpTime=cmResetUpTime, equipmentAudit=equipmentAudit, cardHwVersion=cardHwVersion, cardCarrierFwVersion=cardCarrierFwVersion, equipmentStateGroup=equipmentStateGroup, cmResetClearNotification=cmResetClearNotification, cardNumber=cardNumber, cmIpAddress=cmIpAddress, systemClock=systemClock, cardName=cardName, cardTrapInh=cardTrapInh, diskVolumeId=diskVolumeId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cadEquipmentMibGroup=cadEquipmentMibGroup, shelfNumber=shelfNumber, cardSubType=cardSubType, cardNumPorts=cardNumPorts, cardFpgaSource=cardFpgaSource, cardLastBootSource=cardLastBootSource, cardTempOverHeatNotification=cardTempOverHeatNotification, portType=portType, cardSecStateChange=cardSecStateChange, cardDetected=cardDetected, portMaxDsPower=portMaxDsPower, TestSchedule=TestSchedule, auditDescription=auditDescription, portBgpId=portBgpId, diskVolumeEntry=diskVolumeEntry, cardTemperature=cardTemperature, cardShelfId=cardShelfId, cmResetNotification=cmResetNotification, equipmentCardGroup=equipmentCardGroup, cardType=cardType, systemKey=systemKey, cardPrState=cardPrState, portRxFlowControlMode=portRxFlowControlMode, consoleOutput=consoleOutput, equipmentAuditGroup=equipmentAuditGroup, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardTestResult=cardTestResult, TestId=TestId, cardSerialNum=cardSerialNum, portRxFlowControlDetected=portRxFlowControlDetected, auditPassedCount=auditPassedCount, auditTime=auditTime, fpgaErrorEventTable=fpgaErrorEventTable, auditShelfId=auditShelfId, auditTotalPassedCount=auditTotalPassedCount, equipmentTraps=equipmentTraps, cardCPLDVersion=cardCPLDVersion, cmPrimarySID=cmPrimarySID, fpgaErrorEventGroup=fpgaErrorEventGroup, diagTestId=diagTestId, equipmentError=equipmentError, cmDevice=cmDevice, auditLogOutput=auditLogOutput, eqDiagConfig=eqDiagConfig, cardEntry=cardEntry, cardSwVersion=cardSwVersion, cardSpareGroupMode=cardSpareGroupMode, cardSecState=cardSecState, portConnectorId=portConnectorId, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardCarrierHwVersion=cardCarrierHwVersion, portTxFlowControlMode=portTxFlowControlMode, cardTestTransId=cardTestTransId, diskDriveNumber=diskDriveNumber, diskVolumeTrapInh=diskVolumeTrapInh, portNumber=portNumber, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardBusSpeed=cardBusSpeed, portDescription=portDescription, portCardId=portCardId, cardTestName=cardTestName, cardPicSerialNum=cardPicSerialNum, cardLastChangeTime=cardLastChangeTime, cmResetInfo=cmResetInfo, fpgaErrorEventEntry=fpgaErrorEventEntry, cardTestResultNotification=cardTestResultNotification, portCurrDsPower=portCurrDsPower, equipmentShelfGroup=equipmentShelfGroup, portSecState=portSecState, portMacAddress=portMacAddress, portDetectedMode=portDetectedMode, shelfName=shelfName, portMode=portMode, diskVolumeDriveId=diskVolumeDriveId, cardShelfTestIndex=cardShelfTestIndex, cardFlashSize=cardFlashSize, cardTemperatureHighWarn=cardTemperatureHighWarn, portTxFlowControlDetected=portTxFlowControlDetected, portNumChans=portNumChans, TestResult=TestResult, diskVolumeTable=diskVolumeTable, diskVolumeNumber=diskVolumeNumber, cardPicHwVersion=cardPicHwVersion, cardSpareGroupId=cardSpareGroupId, cardRamSize=cardRamSize, equipmentDiagGroup=equipmentDiagGroup, auditStatus=auditStatus, errEvLoggingEnabled=errEvLoggingEnabled, portLastChangeTime=portLastChangeTime)
