...
SecondaryState, EqActionType, PrimaryState, CardId, PortType, AdminState, ShelfId, PicType, CardType, FirmwareSource, CardSubType, PortId, PortMode, DuplexStatus, FlowControlMode, PortDetectedMode, UnknownState, DiskVolumeUsageLevel = mibBuilder.importSymbols("CADANT-TC", "SecondaryState", "EqActionType", "PrimaryState", "CardId", "PortType", "AdminState", "ShelfId", "PicType", "CardType", "FirmwareSource", "CardSubType", "PortId", "PortMode", "DuplexStatus", "FlowControlMode", "PortDetectedMode", "UnknownState", "DiskVolumeUsageLevel")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
TimeTicks, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, IpAddress, Unsigned32, iso, NotificationType, Gauge32, Integer32, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "IpAddress", "Unsigned32", "iso", "NotificationType", "Gauge32", "Integer32", "Counter32", "Bits")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portSecState=portSecState, cardDetectedChange=cardDetectedChange, auditResult=auditResult, cardPicDetected=cardPicDetected, cardFlashSize=cardFlashSize, cadEquipmentMibGroup=cadEquipmentMibGroup, cardSerialNum=cardSerialNum, cardCpuType=cardCpuType, cardTrapInh=cardTrapInh, cardSpareGroupId=cardSpareGroupId, diagTestId=diagTestId, cardTestDescription=cardTestDescription, cardUpTime=cardUpTime, cmResetInfo=cmResetInfo, cmDevice=cmDevice, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portCurrDsPower=portCurrDsPower, shelfNumber=shelfNumber, portNumber=portNumber, auditStatus=auditStatus, diskVolumeSize=diskVolumeSize, auditEntry=auditEntry, systemClock=systemClock, portType=portType, diskVolumeTable=diskVolumeTable, cardName=cardName, errEvRowStatus=errEvRowStatus, cardTemperatureHighError=cardTemperatureHighError, portConnectorId=portConnectorId, cardTestResultDesc=cardTestResultDesc, systemKey=systemKey, errEventId=errEventId, cmVendor=cmVendor, cardTemperatureHighWarn=cardTemperatureHighWarn, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTempNoReportNotification=cardTempNoReportNotification, cardLastBootSource=cardLastBootSource, diskVolumeShelfId=diskVolumeShelfId, eqDiagConfig=eqDiagConfig, auditTable=auditTable, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditFailedCount=auditFailedCount, errEvRecoveryEnabled=errEvRecoveryEnabled, portDplxStatusChange=portDplxStatusChange, portTable=portTable, TestResult=TestResult, TestCommand=TestCommand, cardType=cardType, TestType=TestType, auditCommand=auditCommand, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardBootVersion=cardBootVersion, cardTemperature=cardTemperature, portPrStateChange=portPrStateChange, diskVolumeId=diskVolumeId, diskVolumeEntry=diskVolumeEntry, portAction=portAction, cmPrimarySID=cmPrimarySID, fpgaErrorEventGroup=fpgaErrorEventGroup, shelfSwVersion=shelfSwVersion, cardPicHwVersion=cardPicHwVersion, cardShelfTestIndex=cardShelfTestIndex, TestId=TestId, portTrapInh=portTrapInh, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portMode=portMode, diskVolumeDriveId=diskVolumeDriveId, cardTestId=cardTestId, systemGeneralGroup=systemGeneralGroup, auditDescription=auditDescription, portBgpId=portBgpId, cardTestResult=cardTestResult, diskVolumeName=diskVolumeName, trapCounter=trapCounter, cardTempOverHeatNotification=cardTempOverHeatNotification, cmResetUpTime=cmResetUpTime, trapSeverity=trapSeverity, cardDetected=cardDetected, portShelfId=portShelfId, cardTestType=cardTestType, cardLastBootVersion=cardLastBootVersion, portMacAddress=portMacAddress, diskVolumeUsageNotification=diskVolumeUsageNotification, PYSNMP_MODULE_ID=cadEquipmentMib, portRxFlowControlDetected=portRxFlowControlDetected, auditCardId=auditCardId, cardAdminState=cardAdminState, cardSecStateChange=cardSecStateChange, TestSchedule=TestSchedule, cardTestEntry=cardTestEntry, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardTestTime=cardTestTime, auditTotalFailedCount=auditTotalFailedCount, auditName=auditName, portTxFlowControlDetected=portTxFlowControlDetected, cadEquipmentMib=cadEquipmentMib, portDplxStatus=portDplxStatus, cardSubType=cardSubType, diskVolumeNumber=diskVolumeNumber, equipmentPortGroup=equipmentPortGroup, cardPrStateChange=cardPrStateChange, portMaxDsPower=portMaxDsPower, cardShelfId=cardShelfId, equipmentShelfGroup=equipmentShelfGroup, equipmentDiagGroup=equipmentDiagGroup, cardFwUpdateStatus=cardFwUpdateStatus, cardDplxStatusChange=cardDplxStatusChange, diskDriveNumber=diskDriveNumber, portDescription=portDescription, equipmentCardGroup=equipmentCardGroup, cardSwVersion=cardSwVersion, cardSubDetected=cardSubDetected, cardPrState=cardPrState, cardTestCommand=cardTestCommand, portCardSubType=portCardSubType, diskVolumeGroup=diskVolumeGroup, diskVolumeDiskSize=diskVolumeDiskSize, cardTestIndex=cardTestIndex, remainInDiagMode=remainInDiagMode, cardTable=cardTable, auditId=auditId, cardLastResetReason=cardLastResetReason, cmMacAddress=cmMacAddress, cadEquipmentMibConformance=cadEquipmentMibConformance, equipmentTbl=equipmentTbl, cardCarrierSerialNum=cardCarrierSerialNum, auditAutoScheduling=auditAutoScheduling, auditTotalPassedCount=auditTotalPassedCount, cardCpuSpeed=cardCpuSpeed, cardNumber=cardNumber, equipmentAuditGroup=equipmentAuditGroup, cardNumPorts=cardNumPorts, cmUChannelID=cmUChannelID, cardEntry=cardEntry, systemGeneral=systemGeneral, cardCarrierHwVersion=cardCarrierHwVersion, portId=portId, cardSpareGroupMode=cardSpareGroupMode, portSecStateChange=portSecStateChange, cardTestScheduleCommand=cardTestScheduleCommand, equipmentTraps=equipmentTraps, cardBusSpeed=cardBusSpeed, diskVolumeUsageLevel=diskVolumeUsageLevel, cmIpAddress=cmIpAddress, auditShelfId=auditShelfId, cardCPLDVersion=cardCPLDVersion, cmResetClearNotification=cmResetClearNotification, cardTestTransId=cardTestTransId, equipmentError=equipmentError, cmRegistrationNotification=cmRegistrationNotification, TestTransactionId=TestTransactionId, errEvLoggingEnabled=errEvLoggingEnabled, auditTime=auditTime, diskVolumeTrapInh=diskVolumeTrapInh, cardFpgaSource=cardFpgaSource, shelfObjects=shelfObjects, cardLastChangeTime=cardLastChangeTime, diskVolumeFileName=diskVolumeFileName, auditLogThrottle=auditLogThrottle, portDocsIfIndex=portDocsIfIndex, fpgaErrorEventEntry=fpgaErrorEventEntry, auditCycleCount=auditCycleCount, errEvLogLevel=errEvLogLevel, equipmentStateGroup=equipmentStateGroup, TestScheduleCommand=TestScheduleCommand, cardDplxStatus=cardDplxStatus, equipmentAudit=equipmentAudit, cardRamSize=cardRamSize, portDetectedMode=portDetectedMode, consoleOutput=consoleOutput, portPrState=portPrState, cardHwVersion=cardHwVersion, auditLogOutput=auditLogOutput, equipmentDiag=equipmentDiag, verboseLevel=verboseLevel, equipmentCardTestGroup=equipmentCardTestGroup, portLastChangeTime=portLastChangeTime, equipmentState=equipmentState, cardTestTable=cardTestTable, cardAction=cardAction, portTxFlowControlMode=portTxFlowControlMode, cardFwVersion=cardFwVersion, portMacIfIndex=portMacIfIndex, portEntry=portEntry, portAdminState=portAdminState, cardTestName=cardTestName, cardSecState=cardSecState, cmResetStatus=cmResetStatus, cardTestSchedule=cardTestSchedule, fpgaErrorEventTable=fpgaErrorEventTable, downstreamPowerLoss=downstreamPowerLoss, shelfName=shelfName, cmResetReason=cmResetReason, portNumChans=portNumChans, cardId=cardId, portMinDsPower=portMinDsPower, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTestResultNotification=cardTestResultNotification, cardPicSerialNum=cardPicSerialNum, auditPassedCount=auditPassedCount, cmResetNotification=cmResetNotification, portRxFlowControlMode=portRxFlowControlMode, cadEquipmentMibCompliances=cadEquipmentMibCompliances, diskVolumeCardId=diskVolumeCardId, portCardId=portCardId)
