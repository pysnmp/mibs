...
PortId, SecondaryState, DiskVolumeUsageLevel, CardType, CardSubType, FlowControlMode, ShelfId, UnknownState, CardId, PortDetectedMode, AdminState, PortType, EqActionType, FirmwareSource, PrimaryState, PortMode, DuplexStatus, PicType = mibBuilder.importSymbols("CADANT-TC", "PortId", "SecondaryState", "DiskVolumeUsageLevel", "CardType", "CardSubType", "FlowControlMode", "ShelfId", "UnknownState", "CardId", "PortDetectedMode", "AdminState", "PortType", "EqActionType", "FirmwareSource", "PrimaryState", "PortMode", "DuplexStatus", "PicType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
Integer32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, IpAddress, ObjectIdentity, Bits, ModuleIdentity, Counter32, Unsigned32, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "IpAddress", "ObjectIdentity", "Bits", "ModuleIdentity", "Counter32", "Unsigned32", "Gauge32", "iso")
TextualConvention, MacAddress, TruthValue, DateAndTime, DisplayString, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "MacAddress", "TruthValue", "DateAndTime", "DisplayString", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardAction=cardAction, cardTrapInh=cardTrapInh, auditName=auditName, cardLastBootVersion=cardLastBootVersion, portTrapInh=portTrapInh, portDescription=portDescription, diskVolumeShelfId=diskVolumeShelfId, cardTestTime=cardTestTime, portLastChangeTime=portLastChangeTime, errEventId=errEventId, equipmentShelfGroup=equipmentShelfGroup, cardTestResult=cardTestResult, cardEntry=cardEntry, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardTemperatureHighError=cardTemperatureHighError, diskVolumeCardId=diskVolumeCardId, equipmentTbl=equipmentTbl, cardDetectedChange=cardDetectedChange, auditShelfId=auditShelfId, cmPrimarySID=cmPrimarySID, cardTestSchedule=cardTestSchedule, auditCardId=auditCardId, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardLastResetReason=cardLastResetReason, equipmentDiag=equipmentDiag, diskVolumeGroup=diskVolumeGroup, auditPassedCount=auditPassedCount, TestId=TestId, cardTestId=cardTestId, systemGeneralGroup=systemGeneralGroup, cmIpAddress=cmIpAddress, auditAutoScheduling=auditAutoScheduling, cardSecState=cardSecState, cardFpgaSource=cardFpgaSource, remainInDiagMode=remainInDiagMode, cardPicDetected=cardPicDetected, equipmentAudit=equipmentAudit, auditDescription=auditDescription, equipmentCardGroup=equipmentCardGroup, auditTime=auditTime, cardTestTable=cardTestTable, cardFwUpdateStatus=cardFwUpdateStatus, diskVolumeUsageLevel=diskVolumeUsageLevel, cardDetected=cardDetected, cardBusSpeed=cardBusSpeed, cardNumPorts=cardNumPorts, portMacIfIndex=portMacIfIndex, portRxFlowControlDetected=portRxFlowControlDetected, portDocsIfIndex=portDocsIfIndex, portBgpId=portBgpId, eqDiagConfig=eqDiagConfig, PYSNMP_MODULE_ID=cadEquipmentMib, shelfSwVersion=shelfSwVersion, cardSubType=cardSubType, cmResetStatus=cmResetStatus, cardCpuSpeed=cardCpuSpeed, cardCarrierHwVersion=cardCarrierHwVersion, portMode=portMode, errEvLogLevel=errEvLogLevel, auditTable=auditTable, cardDplxStatus=cardDplxStatus, diskVolumeId=diskVolumeId, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portPrStateChange=portPrStateChange, errEvRecoveryEnabled=errEvRecoveryEnabled, portSecStateChange=portSecStateChange, cardPrState=cardPrState, cardType=cardType, auditLogOutput=auditLogOutput, cmResetClearNotification=cmResetClearNotification, cardSwVersion=cardSwVersion, cardTempNoReportNotification=cardTempNoReportNotification, portSecState=portSecState, cardPicSerialNum=cardPicSerialNum, cardSubDetected=cardSubDetected, cardId=cardId, equipmentError=equipmentError, portCardSubType=portCardSubType, cardShelfTestIndex=cardShelfTestIndex, portTxFlowControlDetected=portTxFlowControlDetected, auditLogThrottle=auditLogThrottle, portRxFlowControlMode=portRxFlowControlMode, cardPrStateChange=cardPrStateChange, auditResult=auditResult, cadEquipmentMibConformance=cadEquipmentMibConformance, diskDriveNumber=diskDriveNumber, diagTestId=diagTestId, cardTestType=cardTestType, diskVolumeFileName=diskVolumeFileName, cadEquipmentMibGroup=cadEquipmentMibGroup, equipmentDiagGroup=equipmentDiagGroup, cmResetReason=cmResetReason, cardTestResultDesc=cardTestResultDesc, portMaxDsPower=portMaxDsPower, diskVolumeDriveId=diskVolumeDriveId, equipmentState=equipmentState, cardTestResultNotification=cardTestResultNotification, diskVolumeTable=diskVolumeTable, diskVolumeNumber=diskVolumeNumber, fpgaErrorEventGroup=fpgaErrorEventGroup, cardLastChangeTime=cardLastChangeTime, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portEntry=portEntry, cadEquipmentMibCompliance=cadEquipmentMibCompliance, systemKey=systemKey, cardTestDescription=cardTestDescription, fpgaErrorEventTable=fpgaErrorEventTable, diskVolumeEntry=diskVolumeEntry, TestResult=TestResult, equipmentAuditGroup=equipmentAuditGroup, auditTotalFailedCount=auditTotalFailedCount, cardFwVersion=cardFwVersion, diskVolumeSize=diskVolumeSize, TestSchedule=TestSchedule, cardBootVersion=cardBootVersion, shelfName=shelfName, errEvRowStatus=errEvRowStatus, cmResetNotification=cmResetNotification, diskVolumeUsageNotification=diskVolumeUsageNotification, cardSpareGroupId=cardSpareGroupId, portTxFlowControlMode=portTxFlowControlMode, cmRegistrationNotification=cmRegistrationNotification, portMinDsPower=portMinDsPower, diskVolumeDiskSize=diskVolumeDiskSize, cardTestScheduleCommand=cardTestScheduleCommand, fpgaErrorEventEntry=fpgaErrorEventEntry, cardFlashSize=cardFlashSize, downstreamPowerLoss=downstreamPowerLoss, equipmentTraps=equipmentTraps, portNumChans=portNumChans, systemClock=systemClock, cmVendor=cmVendor, cardCPLDVersion=cardCPLDVersion, cardSecStateChange=cardSecStateChange, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portCurrDsPower=portCurrDsPower, cardCarrierFwVersion=cardCarrierFwVersion, cardTemperature=cardTemperature, portShelfId=portShelfId, portDplxStatusChange=portDplxStatusChange, portType=portType, consoleOutput=consoleOutput, shelfObjects=shelfObjects, cardHwVersion=cardHwVersion, cardSerialNum=cardSerialNum, auditTotalPassedCount=auditTotalPassedCount, verboseLevel=verboseLevel, cmResetUpTime=cmResetUpTime, auditStatus=auditStatus, TestScheduleCommand=TestScheduleCommand, cardTestCommand=cardTestCommand, cmMacAddress=cmMacAddress, portDetectedMode=portDetectedMode, auditId=auditId, portDplxStatus=portDplxStatus, auditEntry=auditEntry, portPrState=portPrState, cmResetInfo=cmResetInfo, cardCarrierSerialNum=cardCarrierSerialNum, auditCycleCount=auditCycleCount, auditFailedCount=auditFailedCount, cardTestName=cardTestName, portId=portId, cardTestEntry=cardTestEntry, cardDplxStatusChange=cardDplxStatusChange, equipmentStateGroup=equipmentStateGroup, cardRamSize=cardRamSize, trapSeverity=trapSeverity, TestType=TestType, diskVolumeTrapInh=diskVolumeTrapInh, cmDevice=cmDevice, portNumber=portNumber, cardAdminState=cardAdminState, auditCommand=auditCommand, equipmentCardTestGroup=equipmentCardTestGroup, cardUpTime=cardUpTime, cardSpareGroupMode=cardSpareGroupMode, errEvLoggingEnabled=errEvLoggingEnabled, equipmentPortGroup=equipmentPortGroup, systemGeneral=systemGeneral, cardShelfId=cardShelfId, trapCounter=trapCounter, cardTable=cardTable, cardLastBootSource=cardLastBootSource, portAdminState=portAdminState, diskVolumeName=diskVolumeName, cardName=cardName, portAction=portAction, cardNumber=cardNumber, TestTransactionId=TestTransactionId, cardTestTransId=cardTestTransId, cadEquipmentMib=cadEquipmentMib, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, portMacAddress=portMacAddress, portTable=portTable, portConnectorId=portConnectorId, cardPicHwVersion=cardPicHwVersion, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, shelfNumber=shelfNumber, cardTestIndex=cardTestIndex, cardCpuType=cardCpuType, TestCommand=TestCommand, cmUChannelID=cmUChannelID, cardTempOverHeatNotification=cardTempOverHeatNotification, portCardId=portCardId, cardTemperatureHighWarn=cardTemperatureHighWarn)
