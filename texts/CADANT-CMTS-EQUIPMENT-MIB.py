...
AdminState, PortDetectedMode, PortMode, CardSubType, EqActionType, SecondaryState, PicType, PrimaryState, ShelfId, FirmwareSource, PortId, CardId, PortType, CardType, UnknownState, FlowControlMode, DiskVolumeUsageLevel, DuplexStatus = mibBuilder.importSymbols("CADANT-TC", "AdminState", "PortDetectedMode", "PortMode", "CardSubType", "EqActionType", "SecondaryState", "PicType", "PrimaryState", "ShelfId", "FirmwareSource", "PortId", "CardId", "PortType", "CardType", "UnknownState", "FlowControlMode", "DiskVolumeUsageLevel", "DuplexStatus")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, IpAddress, iso, NotificationType, Bits, Counter64, Unsigned32, ObjectIdentity, Gauge32, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "IpAddress", "iso", "NotificationType", "Bits", "Counter64", "Unsigned32", "ObjectIdentity", "Gauge32", "MibIdentifier", "Integer32")
RowStatus, TextualConvention, MacAddress, TimeStamp, DateAndTime, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "MacAddress", "TimeStamp", "DateAndTime", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardTempNoReportNotification=cardTempNoReportNotification, cardDetected=cardDetected, cardTestId=cardTestId, trapSeverity=trapSeverity, cmDevice=cmDevice, fpgaErrorEventEntry=fpgaErrorEventEntry, eqDiagConfig=eqDiagConfig, equipmentDiagGroup=equipmentDiagGroup, auditName=auditName, cardNumPorts=cardNumPorts, diskVolumeTrapInh=diskVolumeTrapInh, cardSubDetected=cardSubDetected, equipmentError=equipmentError, shelfObjects=shelfObjects, equipmentAuditGroup=equipmentAuditGroup, systemKey=systemKey, auditCycleCount=auditCycleCount, cardTestTable=cardTestTable, cardSwVersion=cardSwVersion, cardTemperatureHighWarn=cardTemperatureHighWarn, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cmIpAddress=cmIpAddress, shelfSwVersion=shelfSwVersion, diskVolumeName=diskVolumeName, portTable=portTable, cadEquipmentMib=cadEquipmentMib, diskVolumeFileName=diskVolumeFileName, cardType=cardType, cmVendor=cmVendor, errEvLoggingEnabled=errEvLoggingEnabled, portId=portId, cardSerialNum=cardSerialNum, TestType=TestType, equipmentAudit=equipmentAudit, errEvRecoveryEnabled=errEvRecoveryEnabled, PYSNMP_MODULE_ID=cadEquipmentMib, cardLastResetReason=cardLastResetReason, cardName=cardName, cmRegistrationNotification=cmRegistrationNotification, equipmentPortGroup=equipmentPortGroup, fpgaErrorEventGroup=fpgaErrorEventGroup, consoleOutput=consoleOutput, downstreamPowerLoss=downstreamPowerLoss, equipmentTraps=equipmentTraps, cardFlashSize=cardFlashSize, cmResetInfo=cmResetInfo, cmPrimarySID=cmPrimarySID, cardId=cardId, portDescription=portDescription, TestResult=TestResult, equipmentDiag=equipmentDiag, cmResetStatus=cmResetStatus, equipmentShelfGroup=equipmentShelfGroup, cardCpuType=cardCpuType, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portDplxStatus=portDplxStatus, cardBusSpeed=cardBusSpeed, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diskVolumeUsageLevel=diskVolumeUsageLevel, portMode=portMode, cardTable=cardTable, cardTestTime=cardTestTime, shelfName=shelfName, cardRamSize=cardRamSize, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTestName=cardTestName, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portCardId=portCardId, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, TestTransactionId=TestTransactionId, portCurrDsPower=portCurrDsPower, cmResetUpTime=cmResetUpTime, equipmentState=equipmentState, portMacAddress=portMacAddress, cardTemperature=cardTemperature, portRxFlowControlMode=portRxFlowControlMode, diskVolumeEntry=diskVolumeEntry, diskDriveNumber=diskDriveNumber, diskVolumeShelfId=diskVolumeShelfId, portTrapInh=portTrapInh, cardDplxStatus=cardDplxStatus, cardPicSerialNum=cardPicSerialNum, portAdminState=portAdminState, cardTestCommand=cardTestCommand, cardPicHwVersion=cardPicHwVersion, cardLastChangeTime=cardLastChangeTime, cardTestScheduleCommand=cardTestScheduleCommand, cardTestSchedule=cardTestSchedule, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, auditAutoScheduling=auditAutoScheduling, portPrStateChange=portPrStateChange, cardCarrierSerialNum=cardCarrierSerialNum, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardTestResultDesc=cardTestResultDesc, cardCpuSpeed=cardCpuSpeed, cardTrapInh=cardTrapInh, portTxFlowControlDetected=portTxFlowControlDetected, auditCardId=auditCardId, diagTestId=diagTestId, portTxFlowControlMode=portTxFlowControlMode, cadEquipmentMibGroup=cadEquipmentMibGroup, diskVolumeSize=diskVolumeSize, cardTestIndex=cardTestIndex, cardAdminState=cardAdminState, cardTemperatureHighError=cardTemperatureHighError, cmResetReason=cmResetReason, portType=portType, cardSubType=cardSubType, diskVolumeNumber=diskVolumeNumber, auditTable=auditTable, cardTestResult=cardTestResult, cardTestTransId=cardTestTransId, equipmentCardTestGroup=equipmentCardTestGroup, portAction=portAction, cardPrState=cardPrState, systemGeneralGroup=systemGeneralGroup, errEvLogLevel=errEvLogLevel, portMaxDsPower=portMaxDsPower, diskVolumeDiskSize=diskVolumeDiskSize, auditTotalPassedCount=auditTotalPassedCount, TestCommand=TestCommand, cardDetectedChange=cardDetectedChange, TestSchedule=TestSchedule, TestScheduleCommand=TestScheduleCommand, portBgpId=portBgpId, cardFpgaSource=cardFpgaSource, cardNumber=cardNumber, diskVolumeCardId=diskVolumeCardId, diskVolumeTable=diskVolumeTable, cardTestType=cardTestType, fpgaErrorEventTable=fpgaErrorEventTable, verboseLevel=verboseLevel, cardAction=cardAction, cardTestEntry=cardTestEntry, cadEquipmentMibConformance=cadEquipmentMibConformance, cardSecState=cardSecState, auditDescription=auditDescription, cardCPLDVersion=cardCPLDVersion, portConnectorId=portConnectorId, auditLogOutput=auditLogOutput, auditResult=auditResult, auditPassedCount=auditPassedCount, cardTempOverHeatNotification=cardTempOverHeatNotification, portMinDsPower=portMinDsPower, portNumChans=portNumChans, cardBootVersion=cardBootVersion, cardTestResultNotification=cardTestResultNotification, portSecState=portSecState, cardSpareGroupId=cardSpareGroupId, cardSecStateChange=cardSecStateChange, portShelfId=portShelfId, cardPicDetected=cardPicDetected, remainInDiagMode=remainInDiagMode, cmMacAddress=cmMacAddress, portDocsIfIndex=portDocsIfIndex, auditStatus=auditStatus, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portSecStateChange=portSecStateChange, portEntry=portEntry, cardCarrierHwVersion=cardCarrierHwVersion, auditShelfId=auditShelfId, auditTotalFailedCount=auditTotalFailedCount, cardShelfTestIndex=cardShelfTestIndex, auditFailedCount=auditFailedCount, cardFwVersion=cardFwVersion, errEvRowStatus=errEvRowStatus, TestId=TestId, systemGeneral=systemGeneral, diskVolumeDriveId=diskVolumeDriveId, cardSpareGroupMode=cardSpareGroupMode, portRxFlowControlDetected=portRxFlowControlDetected, portPrState=portPrState, cardUpTime=cardUpTime, cardHwVersion=cardHwVersion, auditEntry=auditEntry, trapCounter=trapCounter, diskVolumeGroup=diskVolumeGroup, diskVolumeId=diskVolumeId, cardPrStateChange=cardPrStateChange, portDetectedMode=portDetectedMode, portCardSubType=portCardSubType, cardLastBootSource=cardLastBootSource, systemClock=systemClock, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditCommand=auditCommand, equipmentStateGroup=equipmentStateGroup, cardLastBootVersion=cardLastBootVersion, portLastChangeTime=portLastChangeTime, errEventId=errEventId, auditLogThrottle=auditLogThrottle, auditId=auditId, cmResetClearNotification=cmResetClearNotification, portNumber=portNumber, cardShelfId=cardShelfId, cardFwUpdateStatus=cardFwUpdateStatus, cardDplxStatusChange=cardDplxStatusChange, portDplxStatusChange=portDplxStatusChange, portMacIfIndex=portMacIfIndex, equipmentTbl=equipmentTbl, equipmentCardGroup=equipmentCardGroup, cmUChannelID=cmUChannelID, cardEntry=cardEntry, shelfNumber=shelfNumber, cardCarrierFwVersion=cardCarrierFwVersion, cardTestDescription=cardTestDescription, auditTime=auditTime, cmResetNotification=cmResetNotification)
