...
CardType, CardId, PicType, PortMode, DiskVolumeUsageLevel, PrimaryState, CardSubType, UnknownState, SecondaryState, PortId, FirmwareSource, EqActionType, ShelfId, PortDetectedMode, PortType, FlowControlMode, AdminState, DuplexStatus = mibBuilder.importSymbols("CADANT-TC", "CardType", "CardId", "PicType", "PortMode", "DiskVolumeUsageLevel", "PrimaryState", "CardSubType", "UnknownState", "SecondaryState", "PortId", "FirmwareSource", "EqActionType", "ShelfId", "PortDetectedMode", "PortType", "FlowControlMode", "AdminState", "DuplexStatus")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
Unsigned32, Bits, IpAddress, iso, MibIdentifier, NotificationType, TimeTicks, Counter32, Counter64, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "IpAddress", "iso", "MibIdentifier", "NotificationType", "TimeTicks", "Counter32", "Counter64", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32")
TimeStamp, DateAndTime, TruthValue, RowStatus, DisplayString, TextualConvention, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DateAndTime", "TruthValue", "RowStatus", "DisplayString", "TextualConvention", "MacAddress")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardNumber=cardNumber, cardTable=cardTable, cardEntry=cardEntry, portType=portType, errEvLoggingEnabled=errEvLoggingEnabled, auditTime=auditTime, TestTransactionId=TestTransactionId, cardTestIndex=cardTestIndex, portDplxStatusChange=portDplxStatusChange, cadEquipmentMib=cadEquipmentMib, fpgaErrorEventEntry=fpgaErrorEventEntry, diskVolumeDriveId=diskVolumeDriveId, cardPicDetected=cardPicDetected, portMacAddress=portMacAddress, diskVolumeId=diskVolumeId, cardTemperatureHighError=cardTemperatureHighError, cardAdminState=cardAdminState, cardTestType=cardTestType, equipmentAudit=equipmentAudit, systemGeneralGroup=systemGeneralGroup, cmPrimarySID=cmPrimarySID, cmResetInfo=cmResetInfo, trapSeverity=trapSeverity, cardTestTransId=cardTestTransId, cardFlashSize=cardFlashSize, cardHwVersion=cardHwVersion, diskVolumeShelfId=diskVolumeShelfId, portSecState=portSecState, diskVolumeUsagePercentage=diskVolumeUsagePercentage, TestSchedule=TestSchedule, cardSpareGroupId=cardSpareGroupId, cmDevice=cmDevice, portEntry=portEntry, diskDriveNumber=diskDriveNumber, cadEquipmentMibGroup=cadEquipmentMibGroup, auditDescription=auditDescription, equipmentCardGroup=equipmentCardGroup, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, shelfSwVersion=shelfSwVersion, auditShelfId=auditShelfId, portSecStateChange=portSecStateChange, portConnectorId=portConnectorId, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeEntry=diskVolumeEntry, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardTestDescription=cardTestDescription, auditTotalPassedCount=auditTotalPassedCount, cardBusSpeed=cardBusSpeed, diskVolumeNumber=diskVolumeNumber, downstreamPowerLoss=downstreamPowerLoss, cardTestScheduleCommand=cardTestScheduleCommand, equipmentError=equipmentError, auditName=auditName, cardTestCommand=cardTestCommand, equipmentDiagGroup=equipmentDiagGroup, auditCycleCount=auditCycleCount, TestCommand=TestCommand, PYSNMP_MODULE_ID=cadEquipmentMib, cardId=cardId, cmResetReason=cmResetReason, cardDetectedChange=cardDetectedChange, cadEquipmentMibConformance=cadEquipmentMibConformance, portDescription=portDescription, cardFwVersion=cardFwVersion, cardTestName=cardTestName, systemClock=systemClock, cardShelfId=cardShelfId, cardCPLDVersion=cardCPLDVersion, errEvLogLevel=errEvLogLevel, shelfObjects=shelfObjects, cmVendor=cmVendor, cmResetUpTime=cmResetUpTime, cmIpAddress=cmIpAddress, cardAction=cardAction, portDetectedMode=portDetectedMode, cardPrState=cardPrState, cmUChannelID=cmUChannelID, portAction=portAction, cmMacAddress=cmMacAddress, consoleOutput=consoleOutput, diskVolumeCardId=diskVolumeCardId, TestResult=TestResult, portDocsIfIndex=portDocsIfIndex, portAdminState=portAdminState, cardFpgaSource=cardFpgaSource, cardPicSerialNum=cardPicSerialNum, remainInDiagMode=remainInDiagMode, diskVolumeSize=diskVolumeSize, portShelfId=portShelfId, portBgpId=portBgpId, cardTempNoReportNotification=cardTempNoReportNotification, cardBootVersion=cardBootVersion, auditCommand=auditCommand, cardPrStateChange=cardPrStateChange, portId=portId, portNumChans=portNumChans, cardCpuSpeed=cardCpuSpeed, portPrStateChange=portPrStateChange, portDplxStatus=portDplxStatus, portTrapInh=portTrapInh, cardTestEntry=cardTestEntry, trapCounter=trapCounter, cardTrapInh=cardTrapInh, auditId=auditId, cardType=cardType, cardTestId=cardTestId, cadEquipmentMibCompliances=cadEquipmentMibCompliances, diskVolumeTrapInh=diskVolumeTrapInh, cardLastResetReason=cardLastResetReason, shelfName=shelfName, cardTestResult=cardTestResult, diskVolumeName=diskVolumeName, cardName=cardName, auditAutoScheduling=auditAutoScheduling, portRxFlowControlMode=portRxFlowControlMode, diskVolumeUsageNotification=diskVolumeUsageNotification, equipmentTbl=equipmentTbl, cardTestResultDesc=cardTestResultDesc, diskVolumeTable=diskVolumeTable, cardDplxStatusChange=cardDplxStatusChange, cardUpTime=cardUpTime, portMinDsPower=portMinDsPower, diskVolumeDiskSize=diskVolumeDiskSize, cardDplxStatus=cardDplxStatus, portTxFlowControlMode=portTxFlowControlMode, cardRamSize=cardRamSize, cardFwUpdateStatus=cardFwUpdateStatus, portPrState=portPrState, cardLastBootSource=cardLastBootSource, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, TestType=TestType, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, TestId=TestId, diagTestId=diagTestId, auditLogOutput=auditLogOutput, equipmentPortGroup=equipmentPortGroup, portMaxDsPower=portMaxDsPower, errEventId=errEventId, auditStatus=auditStatus, auditEntry=auditEntry, portTable=portTable, cmRegistrationNotification=cmRegistrationNotification, portNumber=portNumber, portCardId=portCardId, portCardSubType=portCardSubType, cmResetStatus=cmResetStatus, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, fpgaErrorEventGroup=fpgaErrorEventGroup, portRxFlowControlDetected=portRxFlowControlDetected, cardTemperature=cardTemperature, cardSerialNum=cardSerialNum, equipmentAuditGroup=equipmentAuditGroup, equipmentCardTestGroup=equipmentCardTestGroup, systemGeneral=systemGeneral, cardCarrierFwVersion=cardCarrierFwVersion, cardCarrierSerialNum=cardCarrierSerialNum, errEvRowStatus=errEvRowStatus, cardSubDetected=cardSubDetected, auditCardId=auditCardId, auditLogThrottle=auditLogThrottle, auditFailedCount=auditFailedCount, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portMacIfIndex=portMacIfIndex, portLastChangeTime=portLastChangeTime, shelfNumber=shelfNumber, portMode=portMode, TestScheduleCommand=TestScheduleCommand, equipmentShelfGroup=equipmentShelfGroup, systemKey=systemKey, cardNumPorts=cardNumPorts, cardShelfTestIndex=cardShelfTestIndex, cmResetNotification=cmResetNotification, cardDetected=cardDetected, equipmentTraps=equipmentTraps, cardPicHwVersion=cardPicHwVersion, auditTotalFailedCount=auditTotalFailedCount, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardSpareGroupMode=cardSpareGroupMode, portCurrDsPower=portCurrDsPower, cardTestTime=cardTestTime, errEvRecoveryEnabled=errEvRecoveryEnabled, cardSwVersion=cardSwVersion, cardCpuType=cardCpuType, eqDiagConfig=eqDiagConfig, cardLastChangeTime=cardLastChangeTime, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeUsageLevel=diskVolumeUsageLevel, cardSecState=cardSecState, verboseLevel=verboseLevel, auditResult=auditResult, cmResetClearNotification=cmResetClearNotification, equipmentDiag=equipmentDiag, cardTempOverHeatNotification=cardTempOverHeatNotification, equipmentStateGroup=equipmentStateGroup, fpgaErrorEventTable=fpgaErrorEventTable, cardLastBootVersion=cardLastBootVersion, auditTable=auditTable, cardSubType=cardSubType, auditPassedCount=auditPassedCount, equipmentState=equipmentState, diskVolumeGroup=diskVolumeGroup, cardSecStateChange=cardSecStateChange, cardTestResultNotification=cardTestResultNotification, cardTestSchedule=cardTestSchedule, cardTestTable=cardTestTable, diskVolumeFileName=diskVolumeFileName, cardTemperatureHighWarn=cardTemperatureHighWarn)
