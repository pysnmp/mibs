...
CardSubType, PortDetectedMode, PortType, PrimaryState, PicType, FirmwareSource, CardType, SecondaryState, AdminState, FlowControlMode, ShelfId, PortMode, DuplexStatus, PortId, UnknownState, CardId, EqActionType, DiskVolumeUsageLevel = mibBuilder.importSymbols("CADANT-TC", "CardSubType", "PortDetectedMode", "PortType", "PrimaryState", "PicType", "FirmwareSource", "CardType", "SecondaryState", "AdminState", "FlowControlMode", "ShelfId", "PortMode", "DuplexStatus", "PortId", "UnknownState", "CardId", "EqActionType", "DiskVolumeUsageLevel")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
Counter32, NotificationType, MibIdentifier, Counter64, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, TimeTicks, IpAddress, Gauge32, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "MibIdentifier", "Counter64", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "TimeTicks", "IpAddress", "Gauge32", "iso", "ModuleIdentity")
TruthValue, TextualConvention, RowStatus, DisplayString, DateAndTime, MacAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "RowStatus", "DisplayString", "DateAndTime", "MacAddress", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", TestScheduleCommand=TestScheduleCommand, cardTrapInh=cardTrapInh, equipmentError=equipmentError, cardSwVersion=cardSwVersion, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardHwVersion=cardHwVersion, cardLastResetReason=cardLastResetReason, portNumChans=portNumChans, cadEquipmentMibGroup=cadEquipmentMibGroup, trapCounter=trapCounter, portTxFlowControlDetected=portTxFlowControlDetected, cardTestSchedule=cardTestSchedule, diskVolumeTable=diskVolumeTable, cardTestTransId=cardTestTransId, diskVolumeNumber=diskVolumeNumber, diskVolumeFileName=diskVolumeFileName, equipmentAudit=equipmentAudit, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, portShelfId=portShelfId, shelfSwVersion=shelfSwVersion, cardCarrierFwVersion=cardCarrierFwVersion, cardPicDetected=cardPicDetected, portCardId=portCardId, portConnectorId=portConnectorId, portCurrDsPower=portCurrDsPower, cardTestResult=cardTestResult, downstreamPowerLoss=downstreamPowerLoss, cardSecStateChange=cardSecStateChange, equipmentCardGroup=equipmentCardGroup, cardLastChangeTime=cardLastChangeTime, TestCommand=TestCommand, cardDplxStatus=cardDplxStatus, cardTempOverHeatNotification=cardTempOverHeatNotification, cardBootVersion=cardBootVersion, cardCpuType=cardCpuType, systemGeneralGroup=systemGeneralGroup, cardTemperatureHighError=cardTemperatureHighError, cardTestTime=cardTestTime, cmResetNotification=cmResetNotification, cardId=cardId, portCardSubType=portCardSubType, cardShelfTestIndex=cardShelfTestIndex, cmResetStatus=cmResetStatus, cardLastBootVersion=cardLastBootVersion, cardAdminState=cardAdminState, cadEquipmentMib=cadEquipmentMib, diskVolumeDriveId=diskVolumeDriveId, auditDescription=auditDescription, fpgaErrorEventEntry=fpgaErrorEventEntry, diskVolumeTrapInh=diskVolumeTrapInh, cardTestScheduleCommand=cardTestScheduleCommand, portId=portId, cardSecState=cardSecState, equipmentDiag=equipmentDiag, cardTestName=cardTestName, cardTestEntry=cardTestEntry, cardFlashSize=cardFlashSize, cardTestType=cardTestType, auditCycleCount=auditCycleCount, systemClock=systemClock, portRxFlowControlMode=portRxFlowControlMode, portLastChangeTime=portLastChangeTime, cardTemperatureHighWarn=cardTemperatureHighWarn, cardTestIndex=cardTestIndex, equipmentAuditGroup=equipmentAuditGroup, portTable=portTable, portEntry=portEntry, cardPicHwVersion=cardPicHwVersion, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portAdminState=portAdminState, diskVolumeDiskSize=diskVolumeDiskSize, auditEntry=auditEntry, cardTestTable=cardTestTable, diagTestId=diagTestId, cardTempNoReportNotification=cardTempNoReportNotification, portMacAddress=portMacAddress, auditAutoScheduling=auditAutoScheduling, systemKey=systemKey, cardAction=cardAction, diskVolumeEntry=diskVolumeEntry, cmUChannelID=cmUChannelID, cardFpgaSource=cardFpgaSource, diskVolumeShelfId=diskVolumeShelfId, auditLogOutput=auditLogOutput, cardCPLDVersion=cardCPLDVersion, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditTotalPassedCount=auditTotalPassedCount, shelfName=shelfName, auditLogThrottle=auditLogThrottle, auditTable=auditTable, cardType=cardType, auditStatus=auditStatus, equipmentPortGroup=equipmentPortGroup, errEvLogLevel=errEvLogLevel, auditShelfId=auditShelfId, equipmentShelfGroup=equipmentShelfGroup, consoleOutput=consoleOutput, cmDevice=cmDevice, portSecStateChange=portSecStateChange, cardNumPorts=cardNumPorts, cardPrStateChange=cardPrStateChange, portBgpId=portBgpId, portPrState=portPrState, equipmentState=equipmentState, portMinDsPower=portMinDsPower, cardPrState=cardPrState, portMacIfIndex=portMacIfIndex, portSecState=portSecState, portRxFlowControlDetected=portRxFlowControlDetected, cardTestResultDesc=cardTestResultDesc, cardTestResultNotification=cardTestResultNotification, cardSubType=cardSubType, fpgaErrorEventTable=fpgaErrorEventTable, cardNumber=cardNumber, systemGeneral=systemGeneral, diskVolumeSize=diskVolumeSize, cardCpuSpeed=cardCpuSpeed, equipmentTbl=equipmentTbl, TestResult=TestResult, diskVolumeName=diskVolumeName, cardTemperature=cardTemperature, cardDetectedChange=cardDetectedChange, auditResult=auditResult, cardSpareGroupMode=cardSpareGroupMode, diskDriveNumber=diskDriveNumber, cardTestCommand=cardTestCommand, auditCommand=auditCommand, cmVendor=cmVendor, cmResetInfo=cmResetInfo, cardCarrierSerialNum=cardCarrierSerialNum, equipmentCardTestGroup=equipmentCardTestGroup, diskVolumeId=diskVolumeId, TestSchedule=TestSchedule, shelfNumber=shelfNumber, cmIpAddress=cmIpAddress, cardSubDetected=cardSubDetected, cardDplxStatusChange=cardDplxStatusChange, portType=portType, auditFailedCount=auditFailedCount, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portDescription=portDescription, errEvRowStatus=errEvRowStatus, cardBusSpeed=cardBusSpeed, cardTestDescription=cardTestDescription, cmMacAddress=cmMacAddress, cardSpareGroupId=cardSpareGroupId, auditPassedCount=auditPassedCount, diskVolumeGroup=diskVolumeGroup, cmResetUpTime=cmResetUpTime, TestId=TestId, diskVolumeCardId=diskVolumeCardId, cardRamSize=cardRamSize, fpgaErrorEventGroup=fpgaErrorEventGroup, portDplxStatus=portDplxStatus, cmResetClearNotification=cmResetClearNotification, cmResetReason=cmResetReason, cmRegistrationNotification=cmRegistrationNotification, cardDetected=cardDetected, diskVolumeUsageLevel=diskVolumeUsageLevel, auditCardId=auditCardId, cardName=cardName, cardCarrierHwVersion=cardCarrierHwVersion, portTrapInh=portTrapInh, cardSerialNum=cardSerialNum, portDocsIfIndex=portDocsIfIndex, cardFwUpdateStatus=cardFwUpdateStatus, portDplxStatusChange=portDplxStatusChange, auditId=auditId, errEvRecoveryEnabled=errEvRecoveryEnabled, portPrStateChange=portPrStateChange, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, remainInDiagMode=remainInDiagMode, TestType=TestType, cardPicSerialNum=cardPicSerialNum, eqDiagConfig=eqDiagConfig, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, auditTime=auditTime, portAction=portAction, cardFwVersion=cardFwVersion, PYSNMP_MODULE_ID=cadEquipmentMib, portMode=portMode, trapSeverity=trapSeverity, auditName=auditName, cardLastBootSource=cardLastBootSource, cadEquipmentMibConformance=cadEquipmentMibConformance, cmPrimarySID=cmPrimarySID, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeUsageNotification=diskVolumeUsageNotification, shelfObjects=shelfObjects, equipmentTraps=equipmentTraps, equipmentStateGroup=equipmentStateGroup, portMaxDsPower=portMaxDsPower, TestTransactionId=TestTransactionId, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portNumber=portNumber, auditTotalFailedCount=auditTotalFailedCount, errEventId=errEventId, equipmentDiagGroup=equipmentDiagGroup, cardEntry=cardEntry, cardShelfId=cardShelfId, errEvLoggingEnabled=errEvLoggingEnabled, cardTestId=cardTestId, cardTable=cardTable, portDetectedMode=portDetectedMode, verboseLevel=verboseLevel, portTxFlowControlMode=portTxFlowControlMode, cardUpTime=cardUpTime)
