...
DiskVolumeUsageLevel, DuplexStatus, PicType, EqActionType, CardType, AdminState, PortDetectedMode, PrimaryState, FirmwareSource, SecondaryState, ShelfId, UnknownState, PortMode, CardId, CardSubType, FlowControlMode, PortId, PortType = mibBuilder.importSymbols("CADANT-TC", "DiskVolumeUsageLevel", "DuplexStatus", "PicType", "EqActionType", "CardType", "AdminState", "PortDetectedMode", "PrimaryState", "FirmwareSource", "SecondaryState", "ShelfId", "UnknownState", "PortMode", "CardId", "CardSubType", "FlowControlMode", "PortId", "PortType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, TimeTicks, Counter64, iso, Unsigned32, Gauge32, NotificationType, MibIdentifier, Integer32, Counter32, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "TimeTicks", "Counter64", "iso", "Unsigned32", "Gauge32", "NotificationType", "MibIdentifier", "Integer32", "Counter32", "ModuleIdentity", "ObjectIdentity")
TruthValue, RowStatus, DisplayString, TextualConvention, TimeStamp, DateAndTime, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "DisplayString", "TextualConvention", "TimeStamp", "DateAndTime", "MacAddress")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardDetectedChange=cardDetectedChange, TestResult=TestResult, cardLastBootSource=cardLastBootSource, auditAutoScheduling=auditAutoScheduling, equipmentCardGroup=equipmentCardGroup, cardDplxStatus=cardDplxStatus, diskDriveNumber=diskDriveNumber, cmVendor=cmVendor, cardTempNoReportNotification=cardTempNoReportNotification, equipmentDiag=equipmentDiag, cardSubDetected=cardSubDetected, equipmentAuditGroup=equipmentAuditGroup, cardTestSchedule=cardTestSchedule, cardTemperatureHighError=cardTemperatureHighError, verboseLevel=verboseLevel, cmResetUpTime=cmResetUpTime, portCardId=portCardId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diagTestId=diagTestId, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, consoleOutput=consoleOutput, equipmentCardTestGroup=equipmentCardTestGroup, cardCpuSpeed=cardCpuSpeed, cardBootVersion=cardBootVersion, cardEntry=cardEntry, diskVolumeSize=diskVolumeSize, portType=portType, cardTestResultNotification=cardTestResultNotification, diskVolumeName=diskVolumeName, systemClock=systemClock, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diskVolumeId=diskVolumeId, auditResult=auditResult, cardHwVersion=cardHwVersion, auditCommand=auditCommand, portAction=portAction, cardTestScheduleCommand=cardTestScheduleCommand, auditTable=auditTable, cmResetClearNotification=cmResetClearNotification, cmUChannelID=cmUChannelID, portShelfId=portShelfId, cardLastChangeTime=cardLastChangeTime, auditTotalFailedCount=auditTotalFailedCount, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardSpareGroupMode=cardSpareGroupMode, errEventId=errEventId, shelfSwVersion=shelfSwVersion, diskVolumeUsagePercentage=diskVolumeUsagePercentage, diskVolumeUsageNotification=diskVolumeUsageNotification, cardSecState=cardSecState, auditLogOutput=auditLogOutput, cardPicDetected=cardPicDetected, portPrState=portPrState, cardSubType=cardSubType, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardShelfId=cardShelfId, cardAction=cardAction, diskVolumeCardId=diskVolumeCardId, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeDriveId=diskVolumeDriveId, diskVolumeNumber=diskVolumeNumber, portEntry=portEntry, portDplxStatus=portDplxStatus, fpgaErrorEventTable=fpgaErrorEventTable, cardTable=cardTable, portRxFlowControlMode=portRxFlowControlMode, cardTemperatureHighWarn=cardTemperatureHighWarn, cmResetStatus=cmResetStatus, cadEquipmentMibConformance=cadEquipmentMibConformance, cardTestIndex=cardTestIndex, errEvRecoveryEnabled=errEvRecoveryEnabled, portRxFlowControlDetected=portRxFlowControlDetected, cardCarrierHwVersion=cardCarrierHwVersion, cmResetReason=cmResetReason, cardSerialNum=cardSerialNum, portSecStateChange=portSecStateChange, cardTemperature=cardTemperature, portDplxStatusChange=portDplxStatusChange, auditName=auditName, cadEquipmentMib=cadEquipmentMib, equipmentError=equipmentError, cmResetInfo=cmResetInfo, portAdminState=portAdminState, eqDiagConfig=eqDiagConfig, downstreamPowerLoss=downstreamPowerLoss, cmResetNotification=cmResetNotification, TestId=TestId, diskVolumeFileName=diskVolumeFileName, portPrStateChange=portPrStateChange, equipmentTraps=equipmentTraps, cardCarrierFwVersion=cardCarrierFwVersion, errEvLogLevel=errEvLogLevel, cardDetected=cardDetected, cardFwUpdateStatus=cardFwUpdateStatus, trapSeverity=trapSeverity, equipmentAudit=equipmentAudit, portTxFlowControlDetected=portTxFlowControlDetected, cardCarrierSerialNum=cardCarrierSerialNum, cardTestEntry=cardTestEntry, equipmentStateGroup=equipmentStateGroup, auditEntry=auditEntry, portMacIfIndex=portMacIfIndex, portLastChangeTime=portLastChangeTime, TestTransactionId=TestTransactionId, cardTrapInh=cardTrapInh, cmDevice=cmDevice, portConnectorId=portConnectorId, trapCounter=trapCounter, cardRamSize=cardRamSize, auditCardId=auditCardId, equipmentTbl=equipmentTbl, cardTestResult=cardTestResult, shelfObjects=shelfObjects, portMacAddress=portMacAddress, auditCycleCount=auditCycleCount, cardSecStateChange=cardSecStateChange, cadEquipmentMibCompliances=cadEquipmentMibCompliances, auditLogThrottle=auditLogThrottle, remainInDiagMode=remainInDiagMode, cardNumber=cardNumber, portDocsIfIndex=portDocsIfIndex, cardId=cardId, systemGeneral=systemGeneral, cardUpTime=cardUpTime, cardPrStateChange=cardPrStateChange, equipmentDiagGroup=equipmentDiagGroup, systemGeneralGroup=systemGeneralGroup, auditPassedCount=auditPassedCount, auditTime=auditTime, cadEquipmentMibGroup=cadEquipmentMibGroup, portTrapInh=portTrapInh, cardName=cardName, cardShelfTestIndex=cardShelfTestIndex, cardAdminState=cardAdminState, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardSpareGroupId=cardSpareGroupId, cardTestCommand=cardTestCommand, equipmentState=equipmentState, cardCpuType=cardCpuType, equipmentPortGroup=equipmentPortGroup, PYSNMP_MODULE_ID=cadEquipmentMib, TestType=TestType, TestScheduleCommand=TestScheduleCommand, cardTestId=cardTestId, auditFailedCount=auditFailedCount, cardBusSpeed=cardBusSpeed, portMaxDsPower=portMaxDsPower, cmRegistrationNotification=cmRegistrationNotification, fpgaErrorEventGroup=fpgaErrorEventGroup, diskVolumeShelfId=diskVolumeShelfId, cmIpAddress=cmIpAddress, portCardSubType=portCardSubType, cardFwVersion=cardFwVersion, portId=portId, portNumber=portNumber, portMode=portMode, portNumChans=portNumChans, TestSchedule=TestSchedule, cardTestDescription=cardTestDescription, cardCPLDVersion=cardCPLDVersion, cardPicHwVersion=cardPicHwVersion, cardDplxStatusChange=cardDplxStatusChange, cardTestName=cardTestName, cardSwVersion=cardSwVersion, portSecState=portSecState, diskVolumeDiskSize=diskVolumeDiskSize, cardPrState=cardPrState, cardLastResetReason=cardLastResetReason, auditId=auditId, cardType=cardType, shelfName=shelfName, cardFpgaSource=cardFpgaSource, auditStatus=auditStatus, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeGroup=diskVolumeGroup, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portTxFlowControlMode=portTxFlowControlMode, portMinDsPower=portMinDsPower, equipmentShelfGroup=equipmentShelfGroup, systemKey=systemKey, cmMacAddress=cmMacAddress, cardTestTable=cardTestTable, cardFlashSize=cardFlashSize, cmPrimarySID=cmPrimarySID, portDetectedMode=portDetectedMode, portBgpId=portBgpId, diskVolumeTrapInh=diskVolumeTrapInh, auditTotalPassedCount=auditTotalPassedCount, diskVolumeEntry=diskVolumeEntry, auditDescription=auditDescription, fpgaErrorEventEntry=fpgaErrorEventEntry, portCurrDsPower=portCurrDsPower, cardPicSerialNum=cardPicSerialNum, portTable=portTable, cardTestType=cardTestType, auditShelfId=auditShelfId, portDescription=portDescription, cardNumPorts=cardNumPorts, cardTestTransId=cardTestTransId, cardTestResultDesc=cardTestResultDesc, cardLastBootVersion=cardLastBootVersion, cardTestTime=cardTestTime, errEvRowStatus=errEvRowStatus, diskVolumeTable=diskVolumeTable, TestCommand=TestCommand, shelfNumber=shelfNumber)
