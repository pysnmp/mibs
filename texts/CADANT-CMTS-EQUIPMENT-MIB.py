...
DuplexStatus, PortDetectedMode, PortId, CardId, PrimaryState, FlowControlMode, ShelfId, CardType, PortMode, EqActionType, CardSubType, DiskVolumeUsageLevel, FirmwareSource, PortType, SecondaryState, PicType, AdminState, UnknownState = mibBuilder.importSymbols("CADANT-TC", "DuplexStatus", "PortDetectedMode", "PortId", "CardId", "PrimaryState", "FlowControlMode", "ShelfId", "CardType", "PortMode", "EqActionType", "CardSubType", "DiskVolumeUsageLevel", "FirmwareSource", "PortType", "SecondaryState", "PicType", "AdminState", "UnknownState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
MibIdentifier, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Bits, iso, NotificationType, IpAddress, Integer32, Unsigned32, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Bits", "iso", "NotificationType", "IpAddress", "Integer32", "Unsigned32", "Gauge32", "Counter32")
DateAndTime, RowStatus, TruthValue, MacAddress, TimeStamp, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "RowStatus", "TruthValue", "MacAddress", "TimeStamp", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", shelfSwVersion=shelfSwVersion, trapCounter=trapCounter, cardTable=cardTable, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portMaxDsPower=portMaxDsPower, cardTestTable=cardTestTable, portAction=portAction, systemGeneralGroup=systemGeneralGroup, diagTestId=diagTestId, portPrStateChange=portPrStateChange, TestResult=TestResult, cardAction=cardAction, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portEntry=portEntry, cardId=cardId, portCardId=portCardId, cadEquipmentMibGroup=cadEquipmentMibGroup, diskVolumeTrapInh=diskVolumeTrapInh, cardTestCommand=cardTestCommand, auditEntry=auditEntry, errEvLoggingEnabled=errEvLoggingEnabled, portSecStateChange=portSecStateChange, auditShelfId=auditShelfId, trapSeverity=trapSeverity, diskVolumeSize=diskVolumeSize, errEventId=errEventId, eqDiagConfig=eqDiagConfig, cardUpTime=cardUpTime, portCurrDsPower=portCurrDsPower, diskVolumeShelfId=diskVolumeShelfId, auditStatus=auditStatus, cmMacAddress=cmMacAddress, diskVolumeCardId=diskVolumeCardId, auditResult=auditResult, cmPrimarySID=cmPrimarySID, auditTime=auditTime, cmResetReason=cmResetReason, equipmentStateGroup=equipmentStateGroup, shelfName=shelfName, cardFpgaSource=cardFpgaSource, cardCarrierFwVersion=cardCarrierFwVersion, cmResetUpTime=cmResetUpTime, cardCarrierSerialNum=cardCarrierSerialNum, cardType=cardType, portMinDsPower=portMinDsPower, cardAdminState=cardAdminState, auditAutoScheduling=auditAutoScheduling, portCardSubType=portCardSubType, cardFlashSize=cardFlashSize, cardSpareGroupMode=cardSpareGroupMode, portMode=portMode, shelfObjects=shelfObjects, cmResetInfo=cmResetInfo, cmDevice=cmDevice, cardDetected=cardDetected, equipmentCardTestGroup=equipmentCardTestGroup, cardTemperatureHighError=cardTemperatureHighError, portTable=portTable, cardDplxStatus=cardDplxStatus, cardCpuType=cardCpuType, diskVolumeFileName=diskVolumeFileName, diskVolumeId=diskVolumeId, portMacAddress=portMacAddress, portId=portId, portType=portType, portDescription=portDescription, auditDescription=auditDescription, equipmentTraps=equipmentTraps, cardPrStateChange=cardPrStateChange, TestSchedule=TestSchedule, consoleOutput=consoleOutput, equipmentAuditGroup=equipmentAuditGroup, cadEquipmentMib=cadEquipmentMib, portTxFlowControlMode=portTxFlowControlMode, cardEntry=cardEntry, cardTestSchedule=cardTestSchedule, cardTemperatureHighWarn=cardTemperatureHighWarn, cadEquipmentMibCompliances=cadEquipmentMibCompliances, TestCommand=TestCommand, equipmentPortGroup=equipmentPortGroup, cardTestEntry=cardTestEntry, systemKey=systemKey, systemGeneral=systemGeneral, portTrapInh=portTrapInh, PYSNMP_MODULE_ID=cadEquipmentMib, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, downstreamPowerLoss=downstreamPowerLoss, fpgaErrorEventGroup=fpgaErrorEventGroup, cardLastResetReason=cardLastResetReason, cardTestName=cardTestName, cardTempNoReportNotification=cardTempNoReportNotification, portNumChans=portNumChans, cardCarrierHwVersion=cardCarrierHwVersion, cardBusSpeed=cardBusSpeed, portShelfId=portShelfId, cardLastBootVersion=cardLastBootVersion, cardSubType=cardSubType, equipmentShelfGroup=equipmentShelfGroup, cardSubDetected=cardSubDetected, diskVolumeName=diskVolumeName, systemClock=systemClock, cardPicHwVersion=cardPicHwVersion, errEvRowStatus=errEvRowStatus, TestScheduleCommand=TestScheduleCommand, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTestId=cardTestId, auditCommand=auditCommand, auditPassedCount=auditPassedCount, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardPicDetected=cardPicDetected, cardDplxStatusChange=cardDplxStatusChange, cardNumPorts=cardNumPorts, diskVolumeTable=diskVolumeTable, cmRegistrationNotification=cmRegistrationNotification, equipmentTbl=equipmentTbl, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardTrapInh=cardTrapInh, cardTestIndex=cardTestIndex, cardTestTime=cardTestTime, cmResetNotification=cmResetNotification, cardSpareGroupId=cardSpareGroupId, cardShelfId=cardShelfId, portDplxStatusChange=portDplxStatusChange, cardSwVersion=cardSwVersion, cardTestResult=cardTestResult, auditFailedCount=auditFailedCount, portRxFlowControlDetected=portRxFlowControlDetected, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portSecState=portSecState, TestTransactionId=TestTransactionId, cardSerialNum=cardSerialNum, portMacIfIndex=portMacIfIndex, auditTotalFailedCount=auditTotalFailedCount, cardSecStateChange=cardSecStateChange, auditTotalPassedCount=auditTotalPassedCount, auditTable=auditTable, cardTestResultNotification=cardTestResultNotification, cmResetClearNotification=cmResetClearNotification, cardBootVersion=cardBootVersion, diskVolumeUsageLevel=diskVolumeUsageLevel, cardPrState=cardPrState, TestId=TestId, portTxFlowControlDetected=portTxFlowControlDetected, portDetectedMode=portDetectedMode, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diskVolumeUsageNotification=diskVolumeUsageNotification, auditId=auditId, cardSecState=cardSecState, diskVolumeEntry=diskVolumeEntry, cmResetStatus=cmResetStatus, cardRamSize=cardRamSize, errEvLogLevel=errEvLogLevel, TestType=TestType, cardFwVersion=cardFwVersion, equipmentState=equipmentState, portNumber=portNumber, cardTestDescription=cardTestDescription, fpgaErrorEventEntry=fpgaErrorEventEntry, cardDetectedChange=cardDetectedChange, fpgaErrorEventTable=fpgaErrorEventTable, cardShelfTestIndex=cardShelfTestIndex, auditCycleCount=auditCycleCount, shelfNumber=shelfNumber, equipmentError=equipmentError, equipmentCardGroup=equipmentCardGroup, portBgpId=portBgpId, cadEquipmentMibConformance=cadEquipmentMibConformance, cardTestType=cardTestType, cardCpuSpeed=cardCpuSpeed, equipmentDiagGroup=equipmentDiagGroup, cardLastChangeTime=cardLastChangeTime, cardFwUpdateStatus=cardFwUpdateStatus, portConnectorId=portConnectorId, errEvRecoveryEnabled=errEvRecoveryEnabled, cardNumber=cardNumber, cmVendor=cmVendor, portRxFlowControlMode=portRxFlowControlMode, auditLogThrottle=auditLogThrottle, portAdminState=portAdminState, cardCPLDVersion=cardCPLDVersion, diskDriveNumber=diskDriveNumber, auditCardId=auditCardId, cardTempOverHeatNotification=cardTempOverHeatNotification, cardLastBootSource=cardLastBootSource, remainInDiagMode=remainInDiagMode, portDplxStatus=portDplxStatus, equipmentDiag=equipmentDiag, verboseLevel=verboseLevel, cardPicSerialNum=cardPicSerialNum, diskVolumeDiskSize=diskVolumeDiskSize, cardTestScheduleCommand=cardTestScheduleCommand, portPrState=portPrState, diskVolumeNumber=diskVolumeNumber, cmUChannelID=cmUChannelID, cmIpAddress=cmIpAddress, equipmentAudit=equipmentAudit, auditLogOutput=auditLogOutput, diskVolumeDriveId=diskVolumeDriveId, cardHwVersion=cardHwVersion, cardName=cardName, diskVolumeGroup=diskVolumeGroup, cardTemperature=cardTemperature, portDocsIfIndex=portDocsIfIndex, auditName=auditName, portLastChangeTime=portLastChangeTime, cardTestTransId=cardTestTransId, cardTestResultDesc=cardTestResultDesc)
