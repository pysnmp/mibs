...
PortId, PicType, DuplexStatus, UnknownState, PrimaryState, CardId, ShelfId, PortMode, CardType, FlowControlMode, CardSubType, FirmwareSource, PortType, DiskVolumeUsageLevel, SecondaryState, PortDetectedMode, AdminState, EqActionType = mibBuilder.importSymbols("CADANT-TC", "PortId", "PicType", "DuplexStatus", "UnknownState", "PrimaryState", "CardId", "ShelfId", "PortMode", "CardType", "FlowControlMode", "CardSubType", "FirmwareSource", "PortType", "DiskVolumeUsageLevel", "SecondaryState", "PortDetectedMode", "AdminState", "EqActionType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
iso, Gauge32, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Bits, ObjectIdentity, IpAddress, MibIdentifier, Unsigned32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Bits", "ObjectIdentity", "IpAddress", "MibIdentifier", "Unsigned32", "TimeTicks", "Counter32")
TruthValue, RowStatus, TimeStamp, DisplayString, DateAndTime, MacAddress, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "TimeStamp", "DisplayString", "DateAndTime", "MacAddress", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardCarrierSerialNum=cardCarrierSerialNum, portNumChans=portNumChans, cmMacAddress=cmMacAddress, auditFailedCount=auditFailedCount, diskVolumeGroup=diskVolumeGroup, auditCycleCount=auditCycleCount, cardId=cardId, cardShelfTestIndex=cardShelfTestIndex, equipmentDiag=equipmentDiag, cardTrapInh=cardTrapInh, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeTrapInh=diskVolumeTrapInh, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, trapSeverity=trapSeverity, equipmentState=equipmentState, cardTable=cardTable, cardTestEntry=cardTestEntry, verboseLevel=verboseLevel, auditShelfId=auditShelfId, portTxFlowControlMode=portTxFlowControlMode, portDetectedMode=portDetectedMode, diskVolumeTable=diskVolumeTable, consoleOutput=consoleOutput, portMacIfIndex=portMacIfIndex, TestType=TestType, cardPrState=cardPrState, cardFpgaSource=cardFpgaSource, portNumber=portNumber, cardDetected=cardDetected, TestId=TestId, auditName=auditName, cardTestTable=cardTestTable, cardSecStateChange=cardSecStateChange, cardTestDescription=cardTestDescription, cardCpuSpeed=cardCpuSpeed, diskVolumeDriveId=diskVolumeDriveId, cardPicHwVersion=cardPicHwVersion, portAction=portAction, cadEquipmentMib=cadEquipmentMib, cmResetNotification=cmResetNotification, portSecState=portSecState, systemClock=systemClock, auditLogOutput=auditLogOutput, errEvLoggingEnabled=errEvLoggingEnabled, portCurrDsPower=portCurrDsPower, cardBusSpeed=cardBusSpeed, cmRegistrationNotification=cmRegistrationNotification, equipmentError=equipmentError, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTestScheduleCommand=cardTestScheduleCommand, equipmentDiagGroup=equipmentDiagGroup, portId=portId, diskVolumeSize=diskVolumeSize, portMacAddress=portMacAddress, portRxFlowControlMode=portRxFlowControlMode, systemGeneralGroup=systemGeneralGroup, equipmentCardGroup=equipmentCardGroup, TestTransactionId=TestTransactionId, errEventId=errEventId, cardDplxStatus=cardDplxStatus, cardTestCommand=cardTestCommand, cardSwVersion=cardSwVersion, portAdminState=portAdminState, cmDevice=cmDevice, portDocsIfIndex=portDocsIfIndex, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, fpgaErrorEventEntry=fpgaErrorEventEntry, errEvRowStatus=errEvRowStatus, TestSchedule=TestSchedule, downstreamPowerLoss=downstreamPowerLoss, auditResult=auditResult, cardSecState=cardSecState, portRxFlowControlDetected=portRxFlowControlDetected, equipmentShelfGroup=equipmentShelfGroup, errEvRecoveryEnabled=errEvRecoveryEnabled, diskVolumeShelfId=diskVolumeShelfId, portConnectorId=portConnectorId, cmIpAddress=cmIpAddress, equipmentStateGroup=equipmentStateGroup, cardCpuType=cardCpuType, cmResetReason=cmResetReason, cardCarrierHwVersion=cardCarrierHwVersion, shelfName=shelfName, cmUChannelID=cmUChannelID, eqDiagConfig=eqDiagConfig, cardSubType=cardSubType, cardTemperature=cardTemperature, auditLogThrottle=auditLogThrottle, auditId=auditId, cardLastChangeTime=cardLastChangeTime, portEntry=portEntry, cardPicDetected=cardPicDetected, auditCardId=auditCardId, portCardId=portCardId, cardUpTime=cardUpTime, cardSubDetected=cardSubDetected, equipmentPortGroup=equipmentPortGroup, cardLastBootSource=cardLastBootSource, PYSNMP_MODULE_ID=cadEquipmentMib, cardFwUpdateStatus=cardFwUpdateStatus, cardTestId=cardTestId, cardTestResultDesc=cardTestResultDesc, auditTable=auditTable, auditStatus=auditStatus, diskVolumeFileName=diskVolumeFileName, TestResult=TestResult, equipmentTraps=equipmentTraps, cmResetStatus=cmResetStatus, cardTempOverHeatNotification=cardTempOverHeatNotification, cardShelfId=cardShelfId, auditTotalFailedCount=auditTotalFailedCount, cardTemperatureHighError=cardTemperatureHighError, cardHwVersion=cardHwVersion, cardTemperatureHighWarn=cardTemperatureHighWarn, equipmentAudit=equipmentAudit, cardTestTime=cardTestTime, portType=portType, diskVolumeNumber=diskVolumeNumber, equipmentAuditGroup=equipmentAuditGroup, cardFlashSize=cardFlashSize, portSecStateChange=portSecStateChange, cardTestResultNotification=cardTestResultNotification, cardCarrierFwVersion=cardCarrierFwVersion, cardTestSchedule=cardTestSchedule, cardNumPorts=cardNumPorts, portDescription=portDescription, auditAutoScheduling=auditAutoScheduling, portTable=portTable, portLastChangeTime=portLastChangeTime, portMinDsPower=portMinDsPower, cadEquipmentMibCompliance=cadEquipmentMibCompliance, systemGeneral=systemGeneral, cardTestResult=cardTestResult, cardLastResetReason=cardLastResetReason, cardDetectedChange=cardDetectedChange, trapCounter=trapCounter, remainInDiagMode=remainInDiagMode, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardTestName=cardTestName, diskVolumeId=diskVolumeId, portTrapInh=portTrapInh, cardTestTransId=cardTestTransId, cardBootVersion=cardBootVersion, portBgpId=portBgpId, portMaxDsPower=portMaxDsPower, TestScheduleCommand=TestScheduleCommand, portMode=portMode, cardDplxStatusChange=cardDplxStatusChange, portDplxStatusChange=portDplxStatusChange, cmResetClearNotification=cmResetClearNotification, fpgaErrorEventGroup=fpgaErrorEventGroup, cmVendor=cmVendor, auditPassedCount=auditPassedCount, portDplxStatus=portDplxStatus, shelfSwVersion=shelfSwVersion, diskVolumeEntry=diskVolumeEntry, fpgaErrorEventTable=fpgaErrorEventTable, cardSpareGroupMode=cardSpareGroupMode, errEvLogLevel=errEvLogLevel, diskVolumeName=diskVolumeName, cardFwVersion=cardFwVersion, diskVolumeDiskSize=diskVolumeDiskSize, shelfObjects=shelfObjects, auditTotalPassedCount=auditTotalPassedCount, equipmentCardTestGroup=equipmentCardTestGroup, auditEntry=auditEntry, auditCommand=auditCommand, cadEquipmentMibGroup=cadEquipmentMibGroup, cardCPLDVersion=cardCPLDVersion, portTxFlowControlDetected=portTxFlowControlDetected, cardTestIndex=cardTestIndex, TestCommand=TestCommand, cardPicSerialNum=cardPicSerialNum, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cadEquipmentMibConformance=cadEquipmentMibConformance, portPrStateChange=portPrStateChange, cardRamSize=cardRamSize, cardTempNoReportNotification=cardTempNoReportNotification, cardPrStateChange=cardPrStateChange, cardType=cardType, cardAction=cardAction, cardLastBootVersion=cardLastBootVersion, equipmentTbl=equipmentTbl, cardName=cardName, cardSerialNum=cardSerialNum, cardAdminState=cardAdminState, cmPrimarySID=cmPrimarySID, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, diagTestId=diagTestId, systemKey=systemKey, cmResetInfo=cmResetInfo, auditTime=auditTime, diskVolumeCardId=diskVolumeCardId, cardTestType=cardTestType, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, shelfNumber=shelfNumber, cmResetUpTime=cmResetUpTime, cardEntry=cardEntry, portPrState=portPrState, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardNumber=cardNumber, portCardSubType=portCardSubType, portShelfId=portShelfId, auditDescription=auditDescription, cardSpareGroupId=cardSpareGroupId, diskDriveNumber=diskDriveNumber)
