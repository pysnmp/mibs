...
FlowControlMode, CardSubType, PortDetectedMode, PortType, PortId, EqActionType, SecondaryState, AdminState, PrimaryState, DiskVolumeUsageLevel, CardType, FirmwareSource, PicType, DuplexStatus, CardId, ShelfId, PortMode, UnknownState = mibBuilder.importSymbols("CADANT-TC", "FlowControlMode", "CardSubType", "PortDetectedMode", "PortType", "PortId", "EqActionType", "SecondaryState", "AdminState", "PrimaryState", "DiskVolumeUsageLevel", "CardType", "FirmwareSource", "PicType", "DuplexStatus", "CardId", "ShelfId", "PortMode", "UnknownState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
Counter64, NotificationType, ModuleIdentity, Integer32, Unsigned32, Bits, MibIdentifier, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "ModuleIdentity", "Integer32", "Unsigned32", "Bits", "MibIdentifier", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Gauge32", "TimeTicks")
TextualConvention, RowStatus, MacAddress, DateAndTime, TruthValue, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "MacAddress", "DateAndTime", "TruthValue", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardFlashSize=cardFlashSize, cardTestTransId=cardTestTransId, portEntry=portEntry, diskVolumeDiskSize=diskVolumeDiskSize, auditResult=auditResult, portSecStateChange=portSecStateChange, cmResetInfo=cmResetInfo, shelfObjects=shelfObjects, cardSwVersion=cardSwVersion, diskVolumeCardId=diskVolumeCardId, portPrStateChange=portPrStateChange, portAdminState=portAdminState, equipmentError=equipmentError, equipmentCardGroup=equipmentCardGroup, portType=portType, cardEntry=cardEntry, portConnectorId=portConnectorId, cardLastBootVersion=cardLastBootVersion, systemGeneralGroup=systemGeneralGroup, cardNumber=cardNumber, cardCpuType=cardCpuType, cardPrState=cardPrState, fpgaErrorEventGroup=fpgaErrorEventGroup, equipmentDiagGroup=equipmentDiagGroup, diskVolumeId=diskVolumeId, equipmentState=equipmentState, cardHwVersion=cardHwVersion, eqDiagConfig=eqDiagConfig, portTable=portTable, diskVolumeShelfId=diskVolumeShelfId, cardTestIndex=cardTestIndex, cardTestCommand=cardTestCommand, PYSNMP_MODULE_ID=cadEquipmentMib, diskVolumeSize=diskVolumeSize, cardPrStateChange=cardPrStateChange, consoleOutput=consoleOutput, trapSeverity=trapSeverity, cardTestResultNotification=cardTestResultNotification, cmResetClearNotification=cmResetClearNotification, auditTotalFailedCount=auditTotalFailedCount, portDocsIfIndex=portDocsIfIndex, TestCommand=TestCommand, cardTrapInh=cardTrapInh, cardTemperatureHighWarn=cardTemperatureHighWarn, cadEquipmentMibConformance=cadEquipmentMibConformance, portAction=portAction, cardSubDetected=cardSubDetected, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cmRegistrationNotification=cmRegistrationNotification, portNumber=portNumber, cardAdminState=cardAdminState, portDescription=portDescription, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeGroup=diskVolumeGroup, cardTestName=cardTestName, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portBgpId=portBgpId, cmIpAddress=cmIpAddress, portMaxDsPower=portMaxDsPower, cmResetStatus=cmResetStatus, cardLastBootSource=cardLastBootSource, equipmentDiag=equipmentDiag, TestSchedule=TestSchedule, cardTestResultDesc=cardTestResultDesc, equipmentStateGroup=equipmentStateGroup, cardTestResult=cardTestResult, cardDetectedChange=cardDetectedChange, portMode=portMode, auditDescription=auditDescription, cmDevice=cmDevice, auditLogOutput=auditLogOutput, portDplxStatus=portDplxStatus, cardCarrierHwVersion=cardCarrierHwVersion, trapCounter=trapCounter, auditAutoScheduling=auditAutoScheduling, cardShelfId=cardShelfId, cardNumPorts=cardNumPorts, cardTestTable=cardTestTable, cardName=cardName, errEvRecoveryEnabled=errEvRecoveryEnabled, systemGeneral=systemGeneral, cmResetReason=cmResetReason, auditCommand=auditCommand, equipmentAuditGroup=equipmentAuditGroup, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardLastChangeTime=cardLastChangeTime, portShelfId=portShelfId, equipmentShelfGroup=equipmentShelfGroup, diskVolumeNumber=diskVolumeNumber, equipmentTraps=equipmentTraps, cardBootVersion=cardBootVersion, cardShelfTestIndex=cardShelfTestIndex, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diskVolumeUsageNotification=diskVolumeUsageNotification, cardPicDetected=cardPicDetected, cardDplxStatusChange=cardDplxStatusChange, auditFailedCount=auditFailedCount, cmVendor=cmVendor, cardSecState=cardSecState, auditStatus=auditStatus, diskVolumeEntry=diskVolumeEntry, auditCycleCount=auditCycleCount, auditCardId=auditCardId, equipmentTbl=equipmentTbl, cardTable=cardTable, errEvLoggingEnabled=errEvLoggingEnabled, cardTempNoReportNotification=cardTempNoReportNotification, equipmentCardTestGroup=equipmentCardTestGroup, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeDriveId=diskVolumeDriveId, cardTestType=cardTestType, shelfName=shelfName, cardId=cardId, cmResetNotification=cmResetNotification, portNumChans=portNumChans, portTxFlowControlDetected=portTxFlowControlDetected, cardCarrierSerialNum=cardCarrierSerialNum, cardCPLDVersion=cardCPLDVersion, cardTemperature=cardTemperature, portMacAddress=portMacAddress, cardTestScheduleCommand=cardTestScheduleCommand, TestTransactionId=TestTransactionId, systemClock=systemClock, fpgaErrorEventTable=fpgaErrorEventTable, cardFwVersion=cardFwVersion, portLastChangeTime=portLastChangeTime, portDplxStatusChange=portDplxStatusChange, auditId=auditId, shelfNumber=shelfNumber, cardTestId=cardTestId, portSecState=portSecState, diskVolumeTable=diskVolumeTable, TestResult=TestResult, cardSecStateChange=cardSecStateChange, cmMacAddress=cmMacAddress, portMinDsPower=portMinDsPower, diskVolumeUsageLevel=diskVolumeUsageLevel, cardUpTime=cardUpTime, cardBusSpeed=cardBusSpeed, auditPassedCount=auditPassedCount, portCardId=portCardId, cardPicSerialNum=cardPicSerialNum, portCurrDsPower=portCurrDsPower, cardSpareGroupMode=cardSpareGroupMode, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, auditTotalPassedCount=auditTotalPassedCount, cardSerialNum=cardSerialNum, portMacIfIndex=portMacIfIndex, auditShelfId=auditShelfId, cadEquipmentMibGroup=cadEquipmentMibGroup, cardDplxStatus=cardDplxStatus, cardLastResetReason=cardLastResetReason, diskVolumeFileName=diskVolumeFileName, portId=portId, cardPicHwVersion=cardPicHwVersion, cardTestTime=cardTestTime, auditName=auditName, auditTable=auditTable, TestId=TestId, TestType=TestType, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, diskDriveNumber=diskDriveNumber, portTrapInh=portTrapInh, verboseLevel=verboseLevel, cadEquipmentMibCompliances=cadEquipmentMibCompliances, auditTime=auditTime, diskVolumeTrapInh=diskVolumeTrapInh, remainInDiagMode=remainInDiagMode, errEventId=errEventId, shelfSwVersion=shelfSwVersion, diskVolumeName=diskVolumeName, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cmUChannelID=cmUChannelID, cmPrimarySID=cmPrimarySID, errEvRowStatus=errEvRowStatus, portDetectedMode=portDetectedMode, cardAction=cardAction, auditEntry=auditEntry, cardFwUpdateStatus=cardFwUpdateStatus, portPrState=portPrState, portCardSubType=portCardSubType, cardSpareGroupId=cardSpareGroupId, cardTestSchedule=cardTestSchedule, auditLogThrottle=auditLogThrottle, downstreamPowerLoss=downstreamPowerLoss, cardType=cardType, portRxFlowControlMode=portRxFlowControlMode, equipmentPortGroup=equipmentPortGroup, TestScheduleCommand=TestScheduleCommand, portRxFlowControlDetected=portRxFlowControlDetected, portTxFlowControlMode=portTxFlowControlMode, diagTestId=diagTestId, cardTemperatureHighError=cardTemperatureHighError, cadEquipmentMib=cadEquipmentMib, cmResetUpTime=cmResetUpTime, cardTestEntry=cardTestEntry, cardDetected=cardDetected, cardCpuSpeed=cardCpuSpeed, errEvLogLevel=errEvLogLevel, cardRamSize=cardRamSize, fpgaErrorEventEntry=fpgaErrorEventEntry, cardSubType=cardSubType, cardTestDescription=cardTestDescription, cardFpgaSource=cardFpgaSource, systemKey=systemKey, equipmentAudit=equipmentAudit)
