...
ShelfId, PortType, DuplexStatus, CardId, FirmwareSource, EqActionType, PortDetectedMode, PrimaryState, SecondaryState, UnknownState, PicType, PortId, DiskVolumeUsageLevel, CardSubType, FlowControlMode, AdminState, CardType, PortMode = mibBuilder.importSymbols("CADANT-TC", "ShelfId", "PortType", "DuplexStatus", "CardId", "FirmwareSource", "EqActionType", "PortDetectedMode", "PrimaryState", "SecondaryState", "UnknownState", "PicType", "PortId", "DiskVolumeUsageLevel", "CardSubType", "FlowControlMode", "AdminState", "CardType", "PortMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
iso, Counter64, IpAddress, ObjectIdentity, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, MibIdentifier, Counter32, Gauge32, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "IpAddress", "ObjectIdentity", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "MibIdentifier", "Counter32", "Gauge32", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portAction=portAction, portCardSubType=portCardSubType, equipmentState=equipmentState, diskVolumeTrapInh=diskVolumeTrapInh, portSecState=portSecState, diskDriveNumber=diskDriveNumber, cmVendor=cmVendor, cardPicDetected=cardPicDetected, equipmentShelfGroup=equipmentShelfGroup, portDocsIfIndex=portDocsIfIndex, portDplxStatusChange=portDplxStatusChange, cardTestName=cardTestName, portShelfId=portShelfId, auditName=auditName, cardTestTime=cardTestTime, diskVolumeGroup=diskVolumeGroup, cardAdminState=cardAdminState, diskVolumeDiskSize=diskVolumeDiskSize, cmIpAddress=cmIpAddress, cardEntry=cardEntry, cmUChannelID=cmUChannelID, cmResetInfo=cmResetInfo, portPrState=portPrState, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, TestScheduleCommand=TestScheduleCommand, cardSpareGroupMode=cardSpareGroupMode, downstreamPowerLoss=downstreamPowerLoss, cardLastChangeTime=cardLastChangeTime, cardTestResultNotification=cardTestResultNotification, auditTable=auditTable, cardName=cardName, cardTempOverHeatNotification=cardTempOverHeatNotification, cardBusSpeed=cardBusSpeed, cardNumPorts=cardNumPorts, auditEntry=auditEntry, auditShelfId=auditShelfId, portBgpId=portBgpId, portDetectedMode=portDetectedMode, portNumber=portNumber, cardTemperatureHighWarn=cardTemperatureHighWarn, portMode=portMode, auditCardId=auditCardId, cardTestDescription=cardTestDescription, portConnectorId=portConnectorId, cardPrStateChange=cardPrStateChange, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, equipmentDiagGroup=equipmentDiagGroup, cardSecState=cardSecState, cardTemperatureHighError=cardTemperatureHighError, cardFwUpdateStatus=cardFwUpdateStatus, equipmentDiag=equipmentDiag, cmDevice=cmDevice, portNumChans=portNumChans, auditId=auditId, cardDplxStatus=cardDplxStatus, shelfObjects=shelfObjects, verboseLevel=verboseLevel, auditAutoScheduling=auditAutoScheduling, auditDescription=auditDescription, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cmResetNotification=cmResetNotification, diskVolumeUsageNotification=diskVolumeUsageNotification, cardFpgaSource=cardFpgaSource, equipmentAudit=equipmentAudit, portEntry=portEntry, cardCPLDVersion=cardCPLDVersion, portTrapInh=portTrapInh, TestResult=TestResult, cardLastBootSource=cardLastBootSource, portPrStateChange=portPrStateChange, cardCpuType=cardCpuType, cadEquipmentMibCompliances=cadEquipmentMibCompliances, shelfSwVersion=shelfSwVersion, auditStatus=auditStatus, auditFailedCount=auditFailedCount, portMaxDsPower=portMaxDsPower, cmResetReason=cmResetReason, portMacAddress=portMacAddress, auditCycleCount=auditCycleCount, equipmentStateGroup=equipmentStateGroup, errEventId=errEventId, cardTempNoReportNotification=cardTempNoReportNotification, diskVolumeCardId=diskVolumeCardId, diskVolumeUsagePercentage=diskVolumeUsagePercentage, fpgaErrorEventEntry=fpgaErrorEventEntry, portTable=portTable, diskVolumeShelfId=diskVolumeShelfId, diskVolumeUsageLevel=diskVolumeUsageLevel, TestType=TestType, cardFwVersion=cardFwVersion, shelfName=shelfName, cardCarrierSerialNum=cardCarrierSerialNum, systemGeneralGroup=systemGeneralGroup, equipmentCardGroup=equipmentCardGroup, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, consoleOutput=consoleOutput, cardRamSize=cardRamSize, systemGeneral=systemGeneral, cardDetected=cardDetected, cardSubType=cardSubType, cadEquipmentMibGroup=cadEquipmentMibGroup, errEvRecoveryEnabled=errEvRecoveryEnabled, auditTotalPassedCount=auditTotalPassedCount, cardLastBootVersion=cardLastBootVersion, cardHwVersion=cardHwVersion, auditPassedCount=auditPassedCount, diskVolumeTable=diskVolumeTable, cardTestType=cardTestType, cardLastResetReason=cardLastResetReason, portSecStateChange=portSecStateChange, portDescription=portDescription, cadEquipmentMib=cadEquipmentMib, portCurrDsPower=portCurrDsPower, diskVolumeFileName=diskVolumeFileName, cardDplxStatusChange=cardDplxStatusChange, cardTestResult=cardTestResult, errEvLogLevel=errEvLogLevel, cadEquipmentMibConformance=cadEquipmentMibConformance, fpgaErrorEventTable=fpgaErrorEventTable, systemClock=systemClock, portAdminState=portAdminState, equipmentTbl=equipmentTbl, portTxFlowControlMode=portTxFlowControlMode, portMacIfIndex=portMacIfIndex, portRxFlowControlDetected=portRxFlowControlDetected, trapSeverity=trapSeverity, cardTestSchedule=cardTestSchedule, diskVolumeDriveId=diskVolumeDriveId, errEvLoggingEnabled=errEvLoggingEnabled, cardSubDetected=cardSubDetected, cardShelfTestIndex=cardShelfTestIndex, cardTestTable=cardTestTable, equipmentCardTestGroup=equipmentCardTestGroup, cmPrimarySID=cmPrimarySID, portCardId=portCardId, portMinDsPower=portMinDsPower, diskVolumeEntry=diskVolumeEntry, cardType=cardType, auditTime=auditTime, cardTestResultDesc=cardTestResultDesc, cmResetUpTime=cmResetUpTime, TestId=TestId, PYSNMP_MODULE_ID=cadEquipmentMib, portLastChangeTime=portLastChangeTime, cardTemperature=cardTemperature, eqDiagConfig=eqDiagConfig, diskVolumeId=diskVolumeId, cardCpuSpeed=cardCpuSpeed, cardSpareGroupId=cardSpareGroupId, cardFlashSize=cardFlashSize, portRxFlowControlMode=portRxFlowControlMode, cardCarrierHwVersion=cardCarrierHwVersion, cardSecStateChange=cardSecStateChange, TestCommand=TestCommand, errEvRowStatus=errEvRowStatus, fpgaErrorEventGroup=fpgaErrorEventGroup, cardCarrierFwVersion=cardCarrierFwVersion, portDplxStatus=portDplxStatus, cardSwVersion=cardSwVersion, auditResult=auditResult, portId=portId, diagTestId=diagTestId, cmResetStatus=cmResetStatus, cardTestCommand=cardTestCommand, cardBootVersion=cardBootVersion, diskVolumeNumber=diskVolumeNumber, diskVolumeName=diskVolumeName, equipmentPortGroup=equipmentPortGroup, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, equipmentError=equipmentError, cardUpTime=cardUpTime, systemKey=systemKey, cardId=cardId, auditLogOutput=auditLogOutput, cardDetectedChange=cardDetectedChange, cardPicHwVersion=cardPicHwVersion, cmRegistrationNotification=cmRegistrationNotification, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardPicSerialNum=cardPicSerialNum, cardPrState=cardPrState, cardTestScheduleCommand=cardTestScheduleCommand, equipmentAuditGroup=equipmentAuditGroup, auditLogThrottle=auditLogThrottle, TestSchedule=TestSchedule, cardShelfId=cardShelfId, cardTestIndex=cardTestIndex, cardAction=cardAction, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardTable=cardTable, auditCommand=auditCommand, cmMacAddress=cmMacAddress, trapCounter=trapCounter, cardTrapInh=cardTrapInh, shelfNumber=shelfNumber, cardTestTransId=cardTestTransId, TestTransactionId=TestTransactionId, auditTotalFailedCount=auditTotalFailedCount, cmResetClearNotification=cmResetClearNotification, cardSerialNum=cardSerialNum, cardTestEntry=cardTestEntry, diskVolumeSize=diskVolumeSize, cardNumber=cardNumber, cardTestId=cardTestId, equipmentTraps=equipmentTraps, portType=portType, remainInDiagMode=remainInDiagMode, portTxFlowControlDetected=portTxFlowControlDetected)
