...
FirmwareSource, PicType, PortType, PortMode, PrimaryState, SecondaryState, PortId, ShelfId, CardId, EqActionType, FlowControlMode, PortDetectedMode, UnknownState, DiskVolumeUsageLevel, DuplexStatus, AdminState, CardSubType, CardType = mibBuilder.importSymbols("CADANT-TC", "FirmwareSource", "PicType", "PortType", "PortMode", "PrimaryState", "SecondaryState", "PortId", "ShelfId", "CardId", "EqActionType", "FlowControlMode", "PortDetectedMode", "UnknownState", "DiskVolumeUsageLevel", "DuplexStatus", "AdminState", "CardSubType", "CardType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, MibIdentifier, Gauge32, Integer32, Unsigned32, Bits, Counter64, IpAddress, iso, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "MibIdentifier", "Gauge32", "Integer32", "Unsigned32", "Bits", "Counter64", "IpAddress", "iso", "ObjectIdentity", "ModuleIdentity")
TextualConvention, RowStatus, MacAddress, DisplayString, TimeStamp, DateAndTime, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "MacAddress", "DisplayString", "TimeStamp", "DateAndTime", "TruthValue")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardTestScheduleCommand=cardTestScheduleCommand, cardTestCommand=cardTestCommand, systemClock=systemClock, portType=portType, diskVolumeUsageNotification=diskVolumeUsageNotification, equipmentShelfGroup=equipmentShelfGroup, portLastChangeTime=portLastChangeTime, cardUpTime=cardUpTime, equipmentStateGroup=equipmentStateGroup, portCardId=portCardId, equipmentDiagGroup=equipmentDiagGroup, cardTable=cardTable, cmMacAddress=cmMacAddress, TestSchedule=TestSchedule, diagTestId=diagTestId, equipmentError=equipmentError, shelfNumber=shelfNumber, cmIpAddress=cmIpAddress, cardTrapInh=cardTrapInh, auditLogOutput=auditLogOutput, auditName=auditName, cmUChannelID=cmUChannelID, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditTotalPassedCount=auditTotalPassedCount, portMacAddress=portMacAddress, portTrapInh=portTrapInh, cardTemperature=cardTemperature, cardTestTime=cardTestTime, diskVolumeDriveId=diskVolumeDriveId, diskVolumeTable=diskVolumeTable, cardType=cardType, portAction=portAction, cmResetClearNotification=cmResetClearNotification, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, diskVolumeFileName=diskVolumeFileName, trapSeverity=trapSeverity, cardFlashSize=cardFlashSize, downstreamPowerLoss=downstreamPowerLoss, cardEntry=cardEntry, cardTestResultNotification=cardTestResultNotification, portRxFlowControlMode=portRxFlowControlMode, fpgaErrorEventGroup=fpgaErrorEventGroup, cardSpareGroupId=cardSpareGroupId, portCardSubType=portCardSubType, diskVolumeUsageLevel=diskVolumeUsageLevel, remainInDiagMode=remainInDiagMode, cardTestId=cardTestId, cadEquipmentMib=cadEquipmentMib, cardTestTable=cardTestTable, diskVolumeCardId=diskVolumeCardId, auditId=auditId, cardLastResetReason=cardLastResetReason, diskVolumeId=diskVolumeId, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, errEventId=errEventId, diskVolumeName=diskVolumeName, auditCommand=auditCommand, cardTestEntry=cardTestEntry, portDetectedMode=portDetectedMode, cmResetStatus=cmResetStatus, portPrState=portPrState, shelfSwVersion=shelfSwVersion, cardPicDetected=cardPicDetected, cardTestResultDesc=cardTestResultDesc, TestId=TestId, cardPrStateChange=cardPrStateChange, portMaxDsPower=portMaxDsPower, TestScheduleCommand=TestScheduleCommand, cmResetUpTime=cmResetUpTime, cardDplxStatusChange=cardDplxStatusChange, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditTotalFailedCount=auditTotalFailedCount, cmResetReason=cmResetReason, TestType=TestType, auditAutoScheduling=auditAutoScheduling, auditPassedCount=auditPassedCount, shelfName=shelfName, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portConnectorId=portConnectorId, cardSecState=cardSecState, fpgaErrorEventTable=fpgaErrorEventTable, equipmentPortGroup=equipmentPortGroup, portAdminState=portAdminState, portSecStateChange=portSecStateChange, systemKey=systemKey, diskDriveNumber=diskDriveNumber, eqDiagConfig=eqDiagConfig, cmResetNotification=cmResetNotification, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditStatus=auditStatus, cardAction=cardAction, cardDetected=cardDetected, portDplxStatus=portDplxStatus, cardCarrierHwVersion=cardCarrierHwVersion, cardPicSerialNum=cardPicSerialNum, auditLogThrottle=auditLogThrottle, equipmentState=equipmentState, portDocsIfIndex=portDocsIfIndex, cmResetInfo=cmResetInfo, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardTemperatureHighWarn=cardTemperatureHighWarn, trapCounter=trapCounter, shelfObjects=shelfObjects, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, equipmentCardTestGroup=equipmentCardTestGroup, cardSubType=cardSubType, auditTime=auditTime, cardTestIndex=cardTestIndex, equipmentTraps=equipmentTraps, portNumber=portNumber, portDplxStatusChange=portDplxStatusChange, cardNumber=cardNumber, equipmentCardGroup=equipmentCardGroup, cardRamSize=cardRamSize, cardCpuType=cardCpuType, cardCPLDVersion=cardCPLDVersion, cardBootVersion=cardBootVersion, cardTestTransId=cardTestTransId, cardTempNoReportNotification=cardTempNoReportNotification, cardPrState=cardPrState, systemGeneralGroup=systemGeneralGroup, equipmentAudit=equipmentAudit, cardDplxStatus=cardDplxStatus, errEvLogLevel=errEvLogLevel, cardSecStateChange=cardSecStateChange, diskVolumeNumber=diskVolumeNumber, auditFailedCount=auditFailedCount, cardLastChangeTime=cardLastChangeTime, cmPrimarySID=cmPrimarySID, portTxFlowControlMode=portTxFlowControlMode, portMode=portMode, cardLastBootVersion=cardLastBootVersion, cardShelfTestIndex=cardShelfTestIndex, cmDevice=cmDevice, cmVendor=cmVendor, cardSwVersion=cardSwVersion, auditShelfId=auditShelfId, diskVolumeTrapInh=diskVolumeTrapInh, cardSpareGroupMode=cardSpareGroupMode, cardTestType=cardTestType, equipmentTbl=equipmentTbl, cardId=cardId, equipmentAuditGroup=equipmentAuditGroup, cardName=cardName, portTable=portTable, cardNumPorts=cardNumPorts, cardBusSpeed=cardBusSpeed, portShelfId=portShelfId, cardLastBootSource=cardLastBootSource, equipmentDiag=equipmentDiag, consoleOutput=consoleOutput, cardTempOverHeatNotification=cardTempOverHeatNotification, cardSubDetected=cardSubDetected, diskVolumeEntry=diskVolumeEntry, auditDescription=auditDescription, TestCommand=TestCommand, cmRegistrationNotification=cmRegistrationNotification, auditCycleCount=auditCycleCount, errEvRecoveryEnabled=errEvRecoveryEnabled, portDescription=portDescription, portMacIfIndex=portMacIfIndex, portTxFlowControlDetected=portTxFlowControlDetected, cardFwVersion=cardFwVersion, cardDetectedChange=cardDetectedChange, cardCarrierFwVersion=cardCarrierFwVersion, cardTestResult=cardTestResult, verboseLevel=verboseLevel, cardTestSchedule=cardTestSchedule, cardHwVersion=cardHwVersion, PYSNMP_MODULE_ID=cadEquipmentMib, diskVolumeGroup=diskVolumeGroup, auditEntry=auditEntry, TestTransactionId=TestTransactionId, portId=portId, fpgaErrorEventEntry=fpgaErrorEventEntry, diskVolumeShelfId=diskVolumeShelfId, cardCpuSpeed=cardCpuSpeed, portRxFlowControlDetected=portRxFlowControlDetected, errEvLoggingEnabled=errEvLoggingEnabled, auditResult=auditResult, cardSerialNum=cardSerialNum, cadEquipmentMibGroup=cadEquipmentMibGroup, cardPicHwVersion=cardPicHwVersion, portEntry=portEntry, diskVolumeSize=diskVolumeSize, portSecState=portSecState, portNumChans=portNumChans, portCurrDsPower=portCurrDsPower, cardCarrierSerialNum=cardCarrierSerialNum, portBgpId=portBgpId, diskVolumeDiskSize=diskVolumeDiskSize, cardTestName=cardTestName, portMinDsPower=portMinDsPower, auditCardId=auditCardId, cadEquipmentMibConformance=cadEquipmentMibConformance, portPrStateChange=portPrStateChange, cardFwUpdateStatus=cardFwUpdateStatus, cardAdminState=cardAdminState, auditTable=auditTable, cardTemperatureHighError=cardTemperatureHighError, TestResult=TestResult, errEvRowStatus=errEvRowStatus, cardTestDescription=cardTestDescription, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, systemGeneral=systemGeneral, cardFpgaSource=cardFpgaSource, cardShelfId=cardShelfId)
