...
UnknownState, EqActionType, PicType, CardSubType, PortId, CardId, PortDetectedMode, PortType, PrimaryState, FirmwareSource, CardType, SecondaryState, AdminState, ShelfId, PortMode, DiskVolumeUsageLevel, DuplexStatus, FlowControlMode = mibBuilder.importSymbols("CADANT-TC", "UnknownState", "EqActionType", "PicType", "CardSubType", "PortId", "CardId", "PortDetectedMode", "PortType", "PrimaryState", "FirmwareSource", "CardType", "SecondaryState", "AdminState", "ShelfId", "PortMode", "DiskVolumeUsageLevel", "DuplexStatus", "FlowControlMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, IpAddress, Unsigned32, ModuleIdentity, ObjectIdentity, TimeTicks, Counter64, Gauge32, iso, MibIdentifier, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "IpAddress", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Counter64", "Gauge32", "iso", "MibIdentifier", "NotificationType", "Counter32")
DateAndTime, TextualConvention, MacAddress, DisplayString, RowStatus, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "TextualConvention", "MacAddress", "DisplayString", "RowStatus", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", diskVolumeCardId=diskVolumeCardId, cardAdminState=cardAdminState, portDetectedMode=portDetectedMode, cardPicDetected=cardPicDetected, diskVolumeEntry=diskVolumeEntry, cardFlashSize=cardFlashSize, cardPicHwVersion=cardPicHwVersion, errEvRecoveryEnabled=errEvRecoveryEnabled, auditTime=auditTime, trapCounter=trapCounter, shelfNumber=shelfNumber, diskVolumeGroup=diskVolumeGroup, diskVolumeId=diskVolumeId, cardSubDetected=cardSubDetected, portAdminState=portAdminState, auditShelfId=auditShelfId, cardTestId=cardTestId, auditStatus=auditStatus, diskVolumeSize=diskVolumeSize, cardPrState=cardPrState, cmResetStatus=cmResetStatus, errEvRowStatus=errEvRowStatus, shelfSwVersion=shelfSwVersion, cardPrStateChange=cardPrStateChange, cardFwVersion=cardFwVersion, cardTestName=cardTestName, errEvLoggingEnabled=errEvLoggingEnabled, auditTable=auditTable, cardTempOverHeatNotification=cardTempOverHeatNotification, equipmentCardGroup=equipmentCardGroup, cardShelfId=cardShelfId, portMaxDsPower=portMaxDsPower, cadEquipmentMibCompliances=cadEquipmentMibCompliances, shelfName=shelfName, cardFwUpdateStatus=cardFwUpdateStatus, diskVolumeUsageNotification=diskVolumeUsageNotification, equipmentShelfGroup=equipmentShelfGroup, cardTemperatureHighError=cardTemperatureHighError, cardBootVersion=cardBootVersion, cardShelfTestIndex=cardShelfTestIndex, verboseLevel=verboseLevel, diskVolumeNumber=diskVolumeNumber, shelfObjects=shelfObjects, cardSecState=cardSecState, cmIpAddress=cmIpAddress, cardTempNoReportNotification=cardTempNoReportNotification, portLastChangeTime=portLastChangeTime, cardUpTime=cardUpTime, portRxFlowControlDetected=portRxFlowControlDetected, errEventId=errEventId, auditCycleCount=auditCycleCount, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cmUChannelID=cmUChannelID, cardTestTable=cardTestTable, cardSpareGroupId=cardSpareGroupId, auditTotalFailedCount=auditTotalFailedCount, consoleOutput=consoleOutput, cardHwVersion=cardHwVersion, auditCommand=auditCommand, portSecStateChange=portSecStateChange, cardTable=cardTable, cardId=cardId, portDplxStatus=portDplxStatus, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardTestSchedule=cardTestSchedule, equipmentAuditGroup=equipmentAuditGroup, systemGeneralGroup=systemGeneralGroup, cardName=cardName, cardRamSize=cardRamSize, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portEntry=portEntry, equipmentDiagGroup=equipmentDiagGroup, portDocsIfIndex=portDocsIfIndex, cardLastChangeTime=cardLastChangeTime, portAction=portAction, portMode=portMode, fpgaErrorEventGroup=fpgaErrorEventGroup, cadEquipmentMibConformance=cadEquipmentMibConformance, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, remainInDiagMode=remainInDiagMode, cardSubType=cardSubType, portId=portId, portNumChans=portNumChans, cardTestResult=cardTestResult, auditId=auditId, portTrapInh=portTrapInh, cmResetNotification=cmResetNotification, cardTrapInh=cardTrapInh, cardTestScheduleCommand=cardTestScheduleCommand, auditAutoScheduling=auditAutoScheduling, TestResult=TestResult, auditFailedCount=auditFailedCount, errEvLogLevel=errEvLogLevel, portTable=portTable, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portMacIfIndex=portMacIfIndex, systemGeneral=systemGeneral, TestSchedule=TestSchedule, auditResult=auditResult, cardDplxStatusChange=cardDplxStatusChange, portMacAddress=portMacAddress, diskVolumeShelfId=diskVolumeShelfId, cardDetectedChange=cardDetectedChange, diskDriveNumber=diskDriveNumber, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portCardSubType=portCardSubType, cardNumber=cardNumber, diskVolumeDiskSize=diskVolumeDiskSize, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, equipmentStateGroup=equipmentStateGroup, equipmentCardTestGroup=equipmentCardTestGroup, PYSNMP_MODULE_ID=cadEquipmentMib, diskVolumeDriveId=diskVolumeDriveId, cardEntry=cardEntry, diskVolumeName=diskVolumeName, cmResetReason=cmResetReason, diskVolumeTrapInh=diskVolumeTrapInh, cardTestType=cardTestType, cardTestResultNotification=cardTestResultNotification, TestCommand=TestCommand, auditName=auditName, diskVolumeFileName=diskVolumeFileName, auditLogOutput=auditLogOutput, equipmentState=equipmentState, equipmentAudit=equipmentAudit, cmResetInfo=cmResetInfo, equipmentTraps=equipmentTraps, cardType=cardType, cardCarrierSerialNum=cardCarrierSerialNum, equipmentError=equipmentError, auditPassedCount=auditPassedCount, cardLastBootSource=cardLastBootSource, cardTestEntry=cardTestEntry, portDplxStatusChange=portDplxStatusChange, cardCpuSpeed=cardCpuSpeed, diskVolumeTable=diskVolumeTable, cardBusSpeed=cardBusSpeed, eqDiagConfig=eqDiagConfig, cardTemperature=cardTemperature, systemClock=systemClock, TestScheduleCommand=TestScheduleCommand, cadEquipmentMib=cadEquipmentMib, cardCarrierFwVersion=cardCarrierFwVersion, portPrState=portPrState, portBgpId=portBgpId, cmMacAddress=cmMacAddress, fpgaErrorEventEntry=fpgaErrorEventEntry, cardTemperatureHighWarn=cardTemperatureHighWarn, portTxFlowControlMode=portTxFlowControlMode, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cmPrimarySID=cmPrimarySID, cmResetUpTime=cmResetUpTime, trapSeverity=trapSeverity, cardSpareGroupMode=cardSpareGroupMode, diskVolumeUsageLevel=diskVolumeUsageLevel, auditTotalPassedCount=auditTotalPassedCount, equipmentTbl=equipmentTbl, cardCarrierHwVersion=cardCarrierHwVersion, cardLastResetReason=cardLastResetReason, cardFpgaSource=cardFpgaSource, portDescription=portDescription, cmDevice=cmDevice, cardSwVersion=cardSwVersion, systemKey=systemKey, cardAction=cardAction, portNumber=portNumber, portMinDsPower=portMinDsPower, cmRegistrationNotification=cmRegistrationNotification, cardSerialNum=cardSerialNum, equipmentDiag=equipmentDiag, portCardId=portCardId, cmResetClearNotification=cmResetClearNotification, cardDplxStatus=cardDplxStatus, cardCPLDVersion=cardCPLDVersion, cardPicSerialNum=cardPicSerialNum, auditDescription=auditDescription, portPrStateChange=portPrStateChange, cardTestTransId=cardTestTransId, cardTestResultDesc=cardTestResultDesc, cardSecStateChange=cardSecStateChange, diagTestId=diagTestId, cardTestTime=cardTestTime, auditLogThrottle=auditLogThrottle, portSecState=portSecState, cmVendor=cmVendor, cardTestIndex=cardTestIndex, fpgaErrorEventTable=fpgaErrorEventTable, cardDetected=cardDetected, TestId=TestId, cadEquipmentMibGroup=cadEquipmentMibGroup, cardLastBootVersion=cardLastBootVersion, cardTestDescription=cardTestDescription, portType=portType, portCurrDsPower=portCurrDsPower, equipmentPortGroup=equipmentPortGroup, cardTestCommand=cardTestCommand, portTxFlowControlDetected=portTxFlowControlDetected, downstreamPowerLoss=downstreamPowerLoss, portShelfId=portShelfId, auditEntry=auditEntry, auditCardId=auditCardId, portConnectorId=portConnectorId, TestTransactionId=TestTransactionId, TestType=TestType, cardNumPorts=cardNumPorts, portRxFlowControlMode=portRxFlowControlMode, cardCpuType=cardCpuType)
