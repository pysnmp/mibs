...
FlowControlMode, PortDetectedMode, FirmwareSource, SecondaryState, CardType, EqActionType, DuplexStatus, PicType, AdminState, DiskVolumeUsageLevel, CardId, ShelfId, PortType, UnknownState, PortId, CardSubType, PrimaryState, PortMode = mibBuilder.importSymbols("CADANT-TC", "FlowControlMode", "PortDetectedMode", "FirmwareSource", "SecondaryState", "CardType", "EqActionType", "DuplexStatus", "PicType", "AdminState", "DiskVolumeUsageLevel", "CardId", "ShelfId", "PortType", "UnknownState", "PortId", "CardSubType", "PrimaryState", "PortMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
Unsigned32, ModuleIdentity, TimeTicks, IpAddress, Gauge32, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, MibIdentifier, Bits, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "TimeTicks", "IpAddress", "Gauge32", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "MibIdentifier", "Bits", "NotificationType", "Integer32")
RowStatus, MacAddress, TextualConvention, DisplayString, TruthValue, DateAndTime, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "MacAddress", "TextualConvention", "DisplayString", "TruthValue", "DateAndTime", "TimeStamp")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", systemGeneralGroup=systemGeneralGroup, TestSchedule=TestSchedule, cardSpareGroupMode=cardSpareGroupMode, cardTemperatureHighError=cardTemperatureHighError, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTestEntry=cardTestEntry, auditTotalPassedCount=auditTotalPassedCount, trapCounter=trapCounter, downstreamPowerLoss=downstreamPowerLoss, diskVolumeDriveId=diskVolumeDriveId, diskVolumeUsageLevel=diskVolumeUsageLevel, portEntry=portEntry, portType=portType, cardLastBootSource=cardLastBootSource, errEvLogLevel=errEvLogLevel, auditCycleCount=auditCycleCount, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardId=cardId, cardTempOverHeatNotification=cardTempOverHeatNotification, cardSecStateChange=cardSecStateChange, cardCpuSpeed=cardCpuSpeed, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cmPrimarySID=cmPrimarySID, diagTestId=diagTestId, portShelfId=portShelfId, cardFwUpdateStatus=cardFwUpdateStatus, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditStatus=auditStatus, portTxFlowControlDetected=portTxFlowControlDetected, auditDescription=auditDescription, cardType=cardType, equipmentAudit=equipmentAudit, cardFlashSize=cardFlashSize, auditPassedCount=auditPassedCount, cardLastChangeTime=cardLastChangeTime, consoleOutput=consoleOutput, cardTestTable=cardTestTable, equipmentCardGroup=equipmentCardGroup, portCurrDsPower=portCurrDsPower, cardDetectedChange=cardDetectedChange, TestResult=TestResult, cardDplxStatus=cardDplxStatus, fpgaErrorEventGroup=fpgaErrorEventGroup, portMode=portMode, systemGeneral=systemGeneral, cardSecState=cardSecState, portTrapInh=portTrapInh, diskVolumeShelfId=diskVolumeShelfId, cmDevice=cmDevice, diskVolumeTable=diskVolumeTable, systemClock=systemClock, errEventId=errEventId, auditFailedCount=auditFailedCount, portTable=portTable, diskVolumeGroup=diskVolumeGroup, cardRamSize=cardRamSize, errEvRowStatus=errEvRowStatus, cardTestScheduleCommand=cardTestScheduleCommand, cardAction=cardAction, cardTestSchedule=cardTestSchedule, cardName=cardName, cardDetected=cardDetected, cardNumPorts=cardNumPorts, cardPicSerialNum=cardPicSerialNum, cardTemperatureHighWarn=cardTemperatureHighWarn, cmResetInfo=cmResetInfo, cardTestIndex=cardTestIndex, portDplxStatus=portDplxStatus, cmIpAddress=cmIpAddress, equipmentError=equipmentError, cardSerialNum=cardSerialNum, cmResetClearNotification=cmResetClearNotification, cmRegistrationNotification=cmRegistrationNotification, portPrState=portPrState, auditCardId=auditCardId, shelfObjects=shelfObjects, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, equipmentDiag=equipmentDiag, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardLastResetReason=cardLastResetReason, cardSubType=cardSubType, diskVolumeId=diskVolumeId, diskVolumeTrapInh=diskVolumeTrapInh, cardEntry=cardEntry, portTxFlowControlMode=portTxFlowControlMode, auditTime=auditTime, cmResetReason=cmResetReason, diskVolumeEntry=diskVolumeEntry, cmResetStatus=cmResetStatus, errEvLoggingEnabled=errEvLoggingEnabled, cadEquipmentMibConformance=cadEquipmentMibConformance, cardTestName=cardTestName, equipmentShelfGroup=equipmentShelfGroup, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cmResetUpTime=cmResetUpTime, shelfNumber=shelfNumber, cardTrapInh=cardTrapInh, shelfSwVersion=shelfSwVersion, remainInDiagMode=remainInDiagMode, auditAutoScheduling=auditAutoScheduling, portDocsIfIndex=portDocsIfIndex, portId=portId, auditLogThrottle=auditLogThrottle, cardBootVersion=cardBootVersion, equipmentDiagGroup=equipmentDiagGroup, portLastChangeTime=portLastChangeTime, cardPrState=cardPrState, portMacAddress=portMacAddress, portSecStateChange=portSecStateChange, cardPrStateChange=cardPrStateChange, cardSpareGroupId=cardSpareGroupId, portMaxDsPower=portMaxDsPower, auditEntry=auditEntry, equipmentTraps=equipmentTraps, equipmentCardTestGroup=equipmentCardTestGroup, PYSNMP_MODULE_ID=cadEquipmentMib, TestCommand=TestCommand, cardDplxStatusChange=cardDplxStatusChange, portBgpId=portBgpId, portConnectorId=portConnectorId, auditResult=auditResult, cadEquipmentMibGroup=cadEquipmentMibGroup, portRxFlowControlDetected=portRxFlowControlDetected, cardPicDetected=cardPicDetected, TestId=TestId, cardFwVersion=cardFwVersion, cmMacAddress=cmMacAddress, equipmentStateGroup=equipmentStateGroup, auditTable=auditTable, shelfName=shelfName, cardShelfTestIndex=cardShelfTestIndex, cardCpuType=cardCpuType, diskVolumeName=diskVolumeName, portNumChans=portNumChans, portRxFlowControlMode=portRxFlowControlMode, cardAdminState=cardAdminState, cardTestType=cardTestType, portNumber=portNumber, portDetectedMode=portDetectedMode, cardTestId=cardTestId, portCardId=portCardId, cardHwVersion=cardHwVersion, TestType=TestType, cardTemperature=cardTemperature, portDescription=portDescription, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cardTestTransId=cardTestTransId, auditId=auditId, cardTempNoReportNotification=cardTempNoReportNotification, diskVolumeNumber=diskVolumeNumber, diskDriveNumber=diskDriveNumber, verboseLevel=verboseLevel, auditLogOutput=auditLogOutput, cardTestResultNotification=cardTestResultNotification, portMacIfIndex=portMacIfIndex, cardCarrierHwVersion=cardCarrierHwVersion, cardCarrierFwVersion=cardCarrierFwVersion, cadEquipmentMib=cadEquipmentMib, diskVolumeDiskSize=diskVolumeDiskSize, cardShelfId=cardShelfId, cardSubDetected=cardSubDetected, cardTestTime=cardTestTime, auditShelfId=auditShelfId, diskVolumeSize=diskVolumeSize, trapSeverity=trapSeverity, eqDiagConfig=eqDiagConfig, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cmUChannelID=cmUChannelID, portMinDsPower=portMinDsPower, auditTotalFailedCount=auditTotalFailedCount, portDplxStatusChange=portDplxStatusChange, cardPicHwVersion=cardPicHwVersion, portAction=portAction, cardCPLDVersion=cardCPLDVersion, fpgaErrorEventTable=fpgaErrorEventTable, equipmentPortGroup=equipmentPortGroup, diskVolumeCardId=diskVolumeCardId, cardTable=cardTable, cardSwVersion=cardSwVersion, cardLastBootVersion=cardLastBootVersion, auditCommand=auditCommand, cardCarrierSerialNum=cardCarrierSerialNum, diskVolumeFileName=diskVolumeFileName, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, TestScheduleCommand=TestScheduleCommand, portSecState=portSecState, cardTestResultDesc=cardTestResultDesc, cardUpTime=cardUpTime, cardTestCommand=cardTestCommand, cardTestDescription=cardTestDescription, cmResetNotification=cmResetNotification, portPrStateChange=portPrStateChange, portCardSubType=portCardSubType, equipmentAuditGroup=equipmentAuditGroup, cardBusSpeed=cardBusSpeed, TestTransactionId=TestTransactionId, auditName=auditName, equipmentState=equipmentState, fpgaErrorEventEntry=fpgaErrorEventEntry, cardNumber=cardNumber, portAdminState=portAdminState, cardFpgaSource=cardFpgaSource, errEvRecoveryEnabled=errEvRecoveryEnabled, cmVendor=cmVendor, equipmentTbl=equipmentTbl, systemKey=systemKey, cardTestResult=cardTestResult)
