...
CardSubType, FirmwareSource, PortType, ShelfId, PortDetectedMode, EqActionType, PortMode, SecondaryState, DiskVolumeUsageLevel, PicType, UnknownState, AdminState, CardId, FlowControlMode, CardType, PrimaryState, PortId, DuplexStatus = mibBuilder.importSymbols("CADANT-TC", "CardSubType", "FirmwareSource", "PortType", "ShelfId", "PortDetectedMode", "EqActionType", "PortMode", "SecondaryState", "DiskVolumeUsageLevel", "PicType", "UnknownState", "AdminState", "CardId", "FlowControlMode", "CardType", "PrimaryState", "PortId", "DuplexStatus")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
Bits, Counter32, iso, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Integer32, NotificationType, IpAddress, Unsigned32, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "iso", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Integer32", "NotificationType", "IpAddress", "Unsigned32", "Gauge32", "ModuleIdentity")
RowStatus, DateAndTime, MacAddress, TimeStamp, DisplayString, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DateAndTime", "MacAddress", "TimeStamp", "DisplayString", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", auditFailedCount=auditFailedCount, cardTrapInh=cardTrapInh, cadEquipmentMibConformance=cadEquipmentMibConformance, auditTable=auditTable, cmPrimarySID=cmPrimarySID, downstreamPowerLoss=downstreamPowerLoss, auditLogThrottle=auditLogThrottle, cardTestResult=cardTestResult, cmResetUpTime=cmResetUpTime, cardLastResetReason=cardLastResetReason, PYSNMP_MODULE_ID=cadEquipmentMib, diskVolumeUsagePercentage=diskVolumeUsagePercentage, equipmentCardGroup=equipmentCardGroup, shelfObjects=shelfObjects, cardType=cardType, cardLastBootSource=cardLastBootSource, cardSpareGroupId=cardSpareGroupId, cardCpuSpeed=cardCpuSpeed, auditTime=auditTime, portConnectorId=portConnectorId, portShelfId=portShelfId, diskVolumeName=diskVolumeName, cardTestName=cardTestName, cardFwUpdateStatus=cardFwUpdateStatus, cardBootVersion=cardBootVersion, cmResetReason=cmResetReason, cadEquipmentMibGroup=cadEquipmentMibGroup, cardCarrierHwVersion=cardCarrierHwVersion, shelfName=shelfName, cardTestTable=cardTestTable, cardTestTime=cardTestTime, auditPassedCount=auditPassedCount, errEvRecoveryEnabled=errEvRecoveryEnabled, TestTransactionId=TestTransactionId, cardDetectedChange=cardDetectedChange, cardSecState=cardSecState, portDetectedMode=portDetectedMode, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, equipmentPortGroup=equipmentPortGroup, cardName=cardName, portDplxStatusChange=portDplxStatusChange, fpgaErrorEventTable=fpgaErrorEventTable, cardId=cardId, cmResetInfo=cmResetInfo, portNumber=portNumber, cardCarrierSerialNum=cardCarrierSerialNum, cardTestResultNotification=cardTestResultNotification, cardSpareGroupMode=cardSpareGroupMode, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, equipmentStateGroup=equipmentStateGroup, portBgpId=portBgpId, portLastChangeTime=portLastChangeTime, equipmentCardTestGroup=equipmentCardTestGroup, shelfNumber=shelfNumber, cardAction=cardAction, cardSerialNum=cardSerialNum, auditTotalPassedCount=auditTotalPassedCount, cardSwVersion=cardSwVersion, cardTestIndex=cardTestIndex, portSecStateChange=portSecStateChange, portMacIfIndex=portMacIfIndex, TestId=TestId, cardCpuType=cardCpuType, cardTempOverHeatNotification=cardTempOverHeatNotification, diagTestId=diagTestId, TestSchedule=TestSchedule, diskVolumeUsageNotification=diskVolumeUsageNotification, systemClock=systemClock, cadEquipmentMibCompliances=cadEquipmentMibCompliances, trapSeverity=trapSeverity, diskVolumeSize=diskVolumeSize, equipmentAudit=equipmentAudit, remainInDiagMode=remainInDiagMode, TestScheduleCommand=TestScheduleCommand, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardBusSpeed=cardBusSpeed, errEventId=errEventId, portAction=portAction, systemKey=systemKey, portCardId=portCardId, errEvLogLevel=errEvLogLevel, portMaxDsPower=portMaxDsPower, cmRegistrationNotification=cmRegistrationNotification, diskVolumeId=diskVolumeId, cardTestCommand=cardTestCommand, cardAdminState=cardAdminState, cardUpTime=cardUpTime, cardPicSerialNum=cardPicSerialNum, portAdminState=portAdminState, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, equipmentDiag=equipmentDiag, cmIpAddress=cmIpAddress, cardLastChangeTime=cardLastChangeTime, cardTemperature=cardTemperature, portDescription=portDescription, eqDiagConfig=eqDiagConfig, diskVolumeDriveId=diskVolumeDriveId, auditTotalFailedCount=auditTotalFailedCount, portNumChans=portNumChans, cardTemperatureHighWarn=cardTemperatureHighWarn, auditShelfId=auditShelfId, portRxFlowControlMode=portRxFlowControlMode, equipmentError=equipmentError, portTrapInh=portTrapInh, cardNumPorts=cardNumPorts, cmResetStatus=cmResetStatus, cardTestScheduleCommand=cardTestScheduleCommand, cardCPLDVersion=cardCPLDVersion, cardTestResultDesc=cardTestResultDesc, cardSecStateChange=cardSecStateChange, cardTestTransId=cardTestTransId, cardFlashSize=cardFlashSize, systemGeneral=systemGeneral, equipmentState=equipmentState, portTxFlowControlMode=portTxFlowControlMode, TestType=TestType, TestCommand=TestCommand, portTxFlowControlDetected=portTxFlowControlDetected, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeTable=diskVolumeTable, auditAutoScheduling=auditAutoScheduling, equipmentDiagGroup=equipmentDiagGroup, equipmentTraps=equipmentTraps, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portCardSubType=portCardSubType, cardPrStateChange=cardPrStateChange, diskVolumeDiskSize=diskVolumeDiskSize, portDplxStatus=portDplxStatus, cardDplxStatusChange=cardDplxStatusChange, cardNumber=cardNumber, consoleOutput=consoleOutput, diskVolumeNumber=diskVolumeNumber, cardLastBootVersion=cardLastBootVersion, shelfSwVersion=shelfSwVersion, diskVolumeFileName=diskVolumeFileName, cardPrState=cardPrState, cardTestSchedule=cardTestSchedule, cmDevice=cmDevice, equipmentTbl=equipmentTbl, portCurrDsPower=portCurrDsPower, portMinDsPower=portMinDsPower, cardTempNoReportNotification=cardTempNoReportNotification, fpgaErrorEventGroup=fpgaErrorEventGroup, cardDetected=cardDetected, cardHwVersion=cardHwVersion, auditCycleCount=auditCycleCount, cardRamSize=cardRamSize, cardTestType=cardTestType, cmVendor=cmVendor, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, fpgaErrorEventEntry=fpgaErrorEventEntry, portPrState=portPrState, cardSubDetected=cardSubDetected, auditName=auditName, cmResetNotification=cmResetNotification, cmMacAddress=cmMacAddress, cardShelfId=cardShelfId, portTable=portTable, diskVolumeTrapInh=diskVolumeTrapInh, cardEntry=cardEntry, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portMode=portMode, cmResetClearNotification=cmResetClearNotification, cardTemperatureHighError=cardTemperatureHighError, portMacAddress=portMacAddress, auditCommand=auditCommand, errEvRowStatus=errEvRowStatus, equipmentShelfGroup=equipmentShelfGroup, portDocsIfIndex=portDocsIfIndex, auditResult=auditResult, cmUChannelID=cmUChannelID, portType=portType, portId=portId, auditCardId=auditCardId, cardFpgaSource=cardFpgaSource, cardSubType=cardSubType, cadEquipmentMib=cadEquipmentMib, TestResult=TestResult, cardCarrierFwVersion=cardCarrierFwVersion, auditId=auditId, portPrStateChange=portPrStateChange, errEvLoggingEnabled=errEvLoggingEnabled, verboseLevel=verboseLevel, cardDplxStatus=cardDplxStatus, cardShelfTestIndex=cardShelfTestIndex, diskDriveNumber=diskDriveNumber, portSecState=portSecState, cardPicHwVersion=cardPicHwVersion, cardFwVersion=cardFwVersion, diskVolumeCardId=diskVolumeCardId, cardTable=cardTable, cardTestId=cardTestId, auditEntry=auditEntry, auditDescription=auditDescription, trapCounter=trapCounter, cardTestDescription=cardTestDescription, auditStatus=auditStatus, diskVolumeShelfId=diskVolumeShelfId, auditLogOutput=auditLogOutput, equipmentAuditGroup=equipmentAuditGroup, cardPicDetected=cardPicDetected, diskVolumeGroup=diskVolumeGroup, portEntry=portEntry, cardTestEntry=cardTestEntry, diskVolumeEntry=diskVolumeEntry, systemGeneralGroup=systemGeneralGroup)
