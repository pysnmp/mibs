...
PortMode, PortType, PortId, DuplexStatus, PicType, SecondaryState, UnknownState, CardType, CardId, PrimaryState, FlowControlMode, DiskVolumeUsageLevel, CardSubType, AdminState, PortDetectedMode, FirmwareSource, ShelfId, EqActionType = mibBuilder.importSymbols("CADANT-TC", "PortMode", "PortType", "PortId", "DuplexStatus", "PicType", "SecondaryState", "UnknownState", "CardType", "CardId", "PrimaryState", "FlowControlMode", "DiskVolumeUsageLevel", "CardSubType", "AdminState", "PortDetectedMode", "FirmwareSource", "ShelfId", "EqActionType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
IpAddress, Counter32, ObjectIdentity, MibIdentifier, iso, ModuleIdentity, Integer32, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "ObjectIdentity", "MibIdentifier", "iso", "ModuleIdentity", "Integer32", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portDocsIfIndex=portDocsIfIndex, portPrStateChange=portPrStateChange, cardPicSerialNum=cardPicSerialNum, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portSecStateChange=portSecStateChange, cadEquipmentMibGroup=cadEquipmentMibGroup, PYSNMP_MODULE_ID=cadEquipmentMib, diskVolumeUsageLevel=diskVolumeUsageLevel, cardTestType=cardTestType, portMaxDsPower=portMaxDsPower, diskVolumeGroup=diskVolumeGroup, cardFpgaSource=cardFpgaSource, TestSchedule=TestSchedule, cardId=cardId, diagTestId=diagTestId, cardCPLDVersion=cardCPLDVersion, cardTestIndex=cardTestIndex, auditCardId=auditCardId, systemKey=systemKey, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeDriveId=diskVolumeDriveId, cardTestName=cardTestName, cmResetNotification=cmResetNotification, cardLastBootVersion=cardLastBootVersion, cardPrStateChange=cardPrStateChange, cardUpTime=cardUpTime, cardPicHwVersion=cardPicHwVersion, portDplxStatus=portDplxStatus, diskVolumeSize=diskVolumeSize, errEvRowStatus=errEvRowStatus, diskDriveNumber=diskDriveNumber, cardTempNoReportNotification=cardTempNoReportNotification, errEvRecoveryEnabled=errEvRecoveryEnabled, cardTestEntry=cardTestEntry, verboseLevel=verboseLevel, cardType=cardType, portRxFlowControlMode=portRxFlowControlMode, portDescription=portDescription, remainInDiagMode=remainInDiagMode, cardPicDetected=cardPicDetected, diskVolumeNumber=diskVolumeNumber, portCardSubType=portCardSubType, portEntry=portEntry, portRxFlowControlDetected=portRxFlowControlDetected, equipmentAuditGroup=equipmentAuditGroup, cardNumPorts=cardNumPorts, cardTestResultDesc=cardTestResultDesc, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTable=cardTable, auditName=auditName, cardTestSchedule=cardTestSchedule, cardTestTransId=cardTestTransId, cardCpuType=cardCpuType, shelfNumber=shelfNumber, cmDevice=cmDevice, cardTrapInh=cardTrapInh, portTrapInh=portTrapInh, equipmentStateGroup=equipmentStateGroup, portId=portId, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, trapCounter=trapCounter, auditPassedCount=auditPassedCount, cadEquipmentMibCompliances=cadEquipmentMibCompliances, downstreamPowerLoss=downstreamPowerLoss, equipmentTraps=equipmentTraps, auditTable=auditTable, auditStatus=auditStatus, cardBootVersion=cardBootVersion, cardPrState=cardPrState, diskVolumeTrapInh=diskVolumeTrapInh, portLastChangeTime=portLastChangeTime, auditResult=auditResult, cardTemperature=cardTemperature, diskVolumeUsagePercentage=diskVolumeUsagePercentage, equipmentState=equipmentState, cardRamSize=cardRamSize, cardSecState=cardSecState, portMinDsPower=portMinDsPower, cardLastChangeTime=cardLastChangeTime, auditShelfId=auditShelfId, cmRegistrationNotification=cmRegistrationNotification, auditFailedCount=auditFailedCount, cmResetInfo=cmResetInfo, cardCarrierSerialNum=cardCarrierSerialNum, eqDiagConfig=eqDiagConfig, cardName=cardName, cardShelfTestIndex=cardShelfTestIndex, cardNumber=cardNumber, portMacAddress=portMacAddress, cardTestScheduleCommand=cardTestScheduleCommand, auditAutoScheduling=auditAutoScheduling, auditId=auditId, cmMacAddress=cmMacAddress, cardSpareGroupId=cardSpareGroupId, diskVolumeFileName=diskVolumeFileName, cmVendor=cmVendor, portTxFlowControlMode=portTxFlowControlMode, cardTestDescription=cardTestDescription, portNumChans=portNumChans, errEvLogLevel=errEvLogLevel, auditEntry=auditEntry, cardTemperatureHighError=cardTemperatureHighError, equipmentDiagGroup=equipmentDiagGroup, cardSpareGroupMode=cardSpareGroupMode, shelfName=shelfName, equipmentCardGroup=equipmentCardGroup, cmResetClearNotification=cmResetClearNotification, equipmentDiag=equipmentDiag, cadEquipmentMibConformance=cadEquipmentMibConformance, cardSubDetected=cardSubDetected, portTxFlowControlDetected=portTxFlowControlDetected, portSecState=portSecState, diskVolumeName=diskVolumeName, equipmentAudit=equipmentAudit, cardSerialNum=cardSerialNum, cardTestTime=cardTestTime, cmResetReason=cmResetReason, cardEntry=cardEntry, diskVolumeCardId=diskVolumeCardId, TestId=TestId, diskVolumeEntry=diskVolumeEntry, cardTestResultNotification=cardTestResultNotification, cardAction=cardAction, auditTime=auditTime, auditTotalPassedCount=auditTotalPassedCount, cardShelfId=cardShelfId, auditTotalFailedCount=auditTotalFailedCount, cmPrimarySID=cmPrimarySID, cardFwVersion=cardFwVersion, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeTable=diskVolumeTable, cardTestId=cardTestId, cmUChannelID=cmUChannelID, cardBusSpeed=cardBusSpeed, cardLastResetReason=cardLastResetReason, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portNumber=portNumber, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, equipmentError=equipmentError, portBgpId=portBgpId, auditLogThrottle=auditLogThrottle, cardDplxStatus=cardDplxStatus, cmResetUpTime=cmResetUpTime, fpgaErrorEventGroup=fpgaErrorEventGroup, cardFwUpdateStatus=cardFwUpdateStatus, equipmentPortGroup=equipmentPortGroup, portCardId=portCardId, diskVolumeId=diskVolumeId, cardSwVersion=cardSwVersion, portPrState=portPrState, consoleOutput=consoleOutput, cmIpAddress=cmIpAddress, fpgaErrorEventEntry=fpgaErrorEventEntry, errEventId=errEventId, systemGeneralGroup=systemGeneralGroup, shelfSwVersion=shelfSwVersion, portConnectorId=portConnectorId, portDplxStatusChange=portDplxStatusChange, portTable=portTable, cardSubType=cardSubType, equipmentTbl=equipmentTbl, cardTestResult=cardTestResult, cardTempOverHeatNotification=cardTempOverHeatNotification, TestType=TestType, cardTestCommand=cardTestCommand, cardSecStateChange=cardSecStateChange, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardHwVersion=cardHwVersion, TestTransactionId=TestTransactionId, cardTestTable=cardTestTable, cardLastBootSource=cardLastBootSource, portType=portType, portMacIfIndex=portMacIfIndex, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardFlashSize=cardFlashSize, TestScheduleCommand=TestScheduleCommand, cardDplxStatusChange=cardDplxStatusChange, cardDetectedChange=cardDetectedChange, systemClock=systemClock, fpgaErrorEventTable=fpgaErrorEventTable, portDetectedMode=portDetectedMode, equipmentCardTestGroup=equipmentCardTestGroup, systemGeneral=systemGeneral, cardCarrierFwVersion=cardCarrierFwVersion, shelfObjects=shelfObjects, portAdminState=portAdminState, cadEquipmentMib=cadEquipmentMib, portAction=portAction, trapSeverity=trapSeverity, diskVolumeDiskSize=diskVolumeDiskSize, cmResetStatus=cmResetStatus, auditCommand=auditCommand, cardTemperatureHighWarn=cardTemperatureHighWarn, portMode=portMode, TestCommand=TestCommand, cardCpuSpeed=cardCpuSpeed, cardDetected=cardDetected, diskVolumeShelfId=diskVolumeShelfId, portShelfId=portShelfId, portCurrDsPower=portCurrDsPower, auditCycleCount=auditCycleCount, auditLogOutput=auditLogOutput, auditDescription=auditDescription, cardAdminState=cardAdminState, TestResult=TestResult, equipmentShelfGroup=equipmentShelfGroup, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold)
