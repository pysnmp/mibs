...
PortMode, EqActionType, CardSubType, AdminState, DuplexStatus, PortType, UnknownState, CardId, FlowControlMode, PicType, PortDetectedMode, CardType, DiskVolumeUsageLevel, SecondaryState, ShelfId, FirmwareSource, PrimaryState, PortId = mibBuilder.importSymbols("CADANT-TC", "PortMode", "EqActionType", "CardSubType", "AdminState", "DuplexStatus", "PortType", "UnknownState", "CardId", "FlowControlMode", "PicType", "PortDetectedMode", "CardType", "DiskVolumeUsageLevel", "SecondaryState", "ShelfId", "FirmwareSource", "PrimaryState", "PortId")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
Integer32, Counter64, MibIdentifier, IpAddress, NotificationType, TimeTicks, Unsigned32, ObjectIdentity, Bits, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "MibIdentifier", "IpAddress", "NotificationType", "TimeTicks", "Unsigned32", "ObjectIdentity", "Bits", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32")
TextualConvention, TruthValue, MacAddress, DisplayString, RowStatus, TimeStamp, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "MacAddress", "DisplayString", "RowStatus", "TimeStamp", "DateAndTime")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portConnectorId=portConnectorId, cmRegistrationNotification=cmRegistrationNotification, portSecStateChange=portSecStateChange, portDocsIfIndex=portDocsIfIndex, cardType=cardType, eqDiagConfig=eqDiagConfig, portMaxDsPower=portMaxDsPower, auditStatus=auditStatus, shelfName=shelfName, cardTestTable=cardTestTable, equipmentCardGroup=equipmentCardGroup, remainInDiagMode=remainInDiagMode, auditName=auditName, portDplxStatus=portDplxStatus, equipmentTbl=equipmentTbl, cardPrState=cardPrState, cardCPLDVersion=cardCPLDVersion, portSecState=portSecState, cardShelfTestIndex=cardShelfTestIndex, cardTable=cardTable, auditPassedCount=auditPassedCount, equipmentShelfGroup=equipmentShelfGroup, auditCycleCount=auditCycleCount, cadEquipmentMibConformance=cadEquipmentMibConformance, cmResetClearNotification=cmResetClearNotification, auditId=auditId, diskVolumeFileName=diskVolumeFileName, cardSubType=cardSubType, verboseLevel=verboseLevel, cmVendor=cmVendor, diskVolumeNumber=diskVolumeNumber, errEvRecoveryEnabled=errEvRecoveryEnabled, equipmentTraps=equipmentTraps, cardBusSpeed=cardBusSpeed, portDescription=portDescription, portDetectedMode=portDetectedMode, portMode=portMode, cardSecState=cardSecState, fpgaErrorEventGroup=fpgaErrorEventGroup, equipmentState=equipmentState, cardFwUpdateStatus=cardFwUpdateStatus, portAction=portAction, TestTransactionId=TestTransactionId, auditTable=auditTable, cardLastChangeTime=cardLastChangeTime, trapSeverity=trapSeverity, diskVolumeDriveId=diskVolumeDriveId, cardCarrierFwVersion=cardCarrierFwVersion, cadEquipmentMibGroup=cadEquipmentMibGroup, equipmentDiagGroup=equipmentDiagGroup, equipmentError=equipmentError, cardHwVersion=cardHwVersion, systemClock=systemClock, portRxFlowControlMode=portRxFlowControlMode, cardDplxStatus=cardDplxStatus, diskVolumeUsagePercentage=diskVolumeUsagePercentage, cmResetStatus=cmResetStatus, cmResetUpTime=cmResetUpTime, portCurrDsPower=portCurrDsPower, cardPrStateChange=cardPrStateChange, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardTempOverHeatNotification=cardTempOverHeatNotification, cmResetInfo=cmResetInfo, portMacIfIndex=portMacIfIndex, portNumber=portNumber, cardTrapInh=cardTrapInh, diskVolumeTrapInh=diskVolumeTrapInh, auditTotalPassedCount=auditTotalPassedCount, equipmentPortGroup=equipmentPortGroup, TestSchedule=TestSchedule, cardName=cardName, portTable=portTable, portCardSubType=portCardSubType, cardDetected=cardDetected, errEvLoggingEnabled=errEvLoggingEnabled, cardId=cardId, cardDplxStatusChange=cardDplxStatusChange, TestResult=TestResult, cardFwVersion=cardFwVersion, cmResetNotification=cmResetNotification, portShelfId=portShelfId, equipmentDiag=equipmentDiag, cardTestSchedule=cardTestSchedule, diskVolumeUsageNotification=diskVolumeUsageNotification, cardAdminState=cardAdminState, cardNumber=cardNumber, cardRamSize=cardRamSize, TestType=TestType, portTrapInh=portTrapInh, auditLogOutput=auditLogOutput, portId=portId, cardPicHwVersion=cardPicHwVersion, cardCarrierHwVersion=cardCarrierHwVersion, cardUpTime=cardUpTime, diskVolumeDiskSize=diskVolumeDiskSize, equipmentStateGroup=equipmentStateGroup, cardLastBootVersion=cardLastBootVersion, portBgpId=portBgpId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditEntry=auditEntry, auditCommand=auditCommand, portLastChangeTime=portLastChangeTime, diskVolumeUsageLevel=diskVolumeUsageLevel, systemGeneral=systemGeneral, cardCpuSpeed=cardCpuSpeed, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, auditFailedCount=auditFailedCount, cardLastResetReason=cardLastResetReason, trapCounter=trapCounter, portMacAddress=portMacAddress, diskVolumeEntry=diskVolumeEntry, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardSpareGroupId=cardSpareGroupId, diskVolumeGroup=diskVolumeGroup, cardTestDescription=cardTestDescription, auditResult=auditResult, diskDriveNumber=diskDriveNumber, errEventId=errEventId, cmPrimarySID=cmPrimarySID, cadEquipmentMib=cadEquipmentMib, cardTemperature=cardTemperature, auditAutoScheduling=auditAutoScheduling, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portDplxStatusChange=portDplxStatusChange, portCardId=portCardId, diagTestId=diagTestId, cmDevice=cmDevice, cmMacAddress=cmMacAddress, cardCpuType=cardCpuType, TestId=TestId, auditTotalFailedCount=auditTotalFailedCount, cardTestResultNotification=cardTestResultNotification, systemGeneralGroup=systemGeneralGroup, portAdminState=portAdminState, diskVolumeCardId=diskVolumeCardId, fpgaErrorEventEntry=fpgaErrorEventEntry, fpgaErrorEventTable=fpgaErrorEventTable, shelfNumber=shelfNumber, cardTestEntry=cardTestEntry, errEvLogLevel=errEvLogLevel, cardSwVersion=cardSwVersion, portPrState=portPrState, portMinDsPower=portMinDsPower, cardFlashSize=cardFlashSize, portNumChans=portNumChans, cardTestIndex=cardTestIndex, PYSNMP_MODULE_ID=cadEquipmentMib, auditCardId=auditCardId, cardTestType=cardTestType, cardCarrierSerialNum=cardCarrierSerialNum, cardFpgaSource=cardFpgaSource, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardTestTime=cardTestTime, auditLogThrottle=auditLogThrottle, cardTemperatureHighError=cardTemperatureHighError, cardSerialNum=cardSerialNum, equipmentAudit=equipmentAudit, diskVolumeTable=diskVolumeTable, cardTestId=cardTestId, portPrStateChange=portPrStateChange, portEntry=portEntry, diskVolumeShelfId=diskVolumeShelfId, TestScheduleCommand=TestScheduleCommand, cardTestCommand=cardTestCommand, cardNumPorts=cardNumPorts, cmResetReason=cmResetReason, auditDescription=auditDescription, cardEntry=cardEntry, cardSpareGroupMode=cardSpareGroupMode, errEvRowStatus=errEvRowStatus, cardTestResult=cardTestResult, consoleOutput=consoleOutput, portType=portType, cardBootVersion=cardBootVersion, portRxFlowControlDetected=portRxFlowControlDetected, portTxFlowControlMode=portTxFlowControlMode, auditShelfId=auditShelfId, cardTestTransId=cardTestTransId, TestCommand=TestCommand, cmUChannelID=cmUChannelID, cardLastBootSource=cardLastBootSource, equipmentCardTestGroup=equipmentCardTestGroup, cardShelfId=cardShelfId, equipmentAuditGroup=equipmentAuditGroup, systemKey=systemKey, cardTestScheduleCommand=cardTestScheduleCommand, cardTestName=cardTestName, cardSecStateChange=cardSecStateChange, diskVolumeId=diskVolumeId, cmIpAddress=cmIpAddress, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardAction=cardAction, cardSubDetected=cardSubDetected, downstreamPowerLoss=downstreamPowerLoss, cadEquipmentMibCompliance=cadEquipmentMibCompliance, shelfObjects=shelfObjects, cardTemperatureHighWarn=cardTemperatureHighWarn, cardTempNoReportNotification=cardTempNoReportNotification, cardTestResultDesc=cardTestResultDesc, cardDetectedChange=cardDetectedChange, diskVolumeSize=diskVolumeSize, cardPicDetected=cardPicDetected, cardPicSerialNum=cardPicSerialNum, diskVolumeName=diskVolumeName, auditTime=auditTime, shelfSwVersion=shelfSwVersion)
