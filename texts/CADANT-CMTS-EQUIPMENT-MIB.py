...
EqActionType, FirmwareSource, FlowControlMode, PortMode, UnknownState, DiskVolumeUsageLevel, ShelfId, PortId, DuplexStatus, PortType, SecondaryState, CardSubType, AdminState, PortDetectedMode, CardType, PrimaryState, PicType, CardId = mibBuilder.importSymbols("CADANT-TC", "EqActionType", "FirmwareSource", "FlowControlMode", "PortMode", "UnknownState", "DiskVolumeUsageLevel", "ShelfId", "PortId", "DuplexStatus", "PortType", "SecondaryState", "CardSubType", "AdminState", "PortDetectedMode", "CardType", "PrimaryState", "PicType", "CardId")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Counter64, IpAddress, Gauge32, Counter32, ObjectIdentity, TimeTicks, MibIdentifier, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Counter64", "IpAddress", "Gauge32", "Counter32", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Bits", "Unsigned32")
TextualConvention, DisplayString, RowStatus, MacAddress, TimeStamp, DateAndTime, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "RowStatus", "MacAddress", "TimeStamp", "DateAndTime", "TruthValue")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardEntry=cardEntry, cardTestCommand=cardTestCommand, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTestDescription=cardTestDescription, portDplxStatus=portDplxStatus, cardTable=cardTable, errEvRecoveryEnabled=errEvRecoveryEnabled, portDetectedMode=portDetectedMode, auditShelfId=auditShelfId, cardSerialNum=cardSerialNum, shelfSwVersion=shelfSwVersion, cmDevice=cmDevice, cmMacAddress=cmMacAddress, cmResetUpTime=cmResetUpTime, cardPicDetected=cardPicDetected, cardTemperatureHighError=cardTemperatureHighError, remainInDiagMode=remainInDiagMode, cardTestIndex=cardTestIndex, systemGeneral=systemGeneral, cardCPLDVersion=cardCPLDVersion, cardTestType=cardTestType, cardTestTime=cardTestTime, portSecState=portSecState, TestId=TestId, cardTestId=cardTestId, cardSecStateChange=cardSecStateChange, diskVolumeDiskSize=diskVolumeDiskSize, portDplxStatusChange=portDplxStatusChange, cardTestResultNotification=cardTestResultNotification, portTable=portTable, cardTestTransId=cardTestTransId, cmResetClearNotification=cmResetClearNotification, portMacIfIndex=portMacIfIndex, diskVolumeFileName=diskVolumeFileName, systemGeneralGroup=systemGeneralGroup, portMacAddress=portMacAddress, cardName=cardName, cardNumPorts=cardNumPorts, diskVolumeId=diskVolumeId, TestScheduleCommand=TestScheduleCommand, diskVolumeUsageLevel=diskVolumeUsageLevel, auditName=auditName, portBgpId=portBgpId, shelfNumber=shelfNumber, portRxFlowControlMode=portRxFlowControlMode, equipmentDiag=equipmentDiag, cmIpAddress=cmIpAddress, equipmentCardTestGroup=equipmentCardTestGroup, diskVolumeName=diskVolumeName, cardTempOverHeatNotification=cardTempOverHeatNotification, auditTotalPassedCount=auditTotalPassedCount, cardFwUpdateStatus=cardFwUpdateStatus, portConnectorId=portConnectorId, cadEquipmentMibConformance=cadEquipmentMibConformance, cardSpareGroupMode=cardSpareGroupMode, cmVendor=cmVendor, cadEquipmentMibGroup=cadEquipmentMibGroup, shelfName=shelfName, portLastChangeTime=portLastChangeTime, TestResult=TestResult, cardTestResult=cardTestResult, auditEntry=auditEntry, diskVolumeShelfId=diskVolumeShelfId, cardTemperature=cardTemperature, cardCpuType=cardCpuType, portPrState=portPrState, cardLastBootVersion=cardLastBootVersion, diskVolumeGroup=diskVolumeGroup, cardFlashSize=cardFlashSize, portDescription=portDescription, portPrStateChange=portPrStateChange, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardNumber=cardNumber, auditTotalFailedCount=auditTotalFailedCount, errEvRowStatus=errEvRowStatus, equipmentDiagGroup=equipmentDiagGroup, cardTempNoReportNotification=cardTempNoReportNotification, cardTestScheduleCommand=cardTestScheduleCommand, cmPrimarySID=cmPrimarySID, cardDetected=cardDetected, cardPicSerialNum=cardPicSerialNum, cardUpTime=cardUpTime, portRxFlowControlDetected=portRxFlowControlDetected, cmResetStatus=cmResetStatus, cmResetNotification=cmResetNotification, cardTestEntry=cardTestEntry, portNumber=portNumber, cardShelfId=cardShelfId, portMaxDsPower=portMaxDsPower, cmResetReason=cmResetReason, equipmentShelfGroup=equipmentShelfGroup, diskVolumeCardId=diskVolumeCardId, systemClock=systemClock, cadEquipmentMib=cadEquipmentMib, portType=portType, cardRamSize=cardRamSize, verboseLevel=verboseLevel, diskVolumeTable=diskVolumeTable, portEntry=portEntry, auditFailedCount=auditFailedCount, equipmentPortGroup=equipmentPortGroup, portAction=portAction, cardDetectedChange=cardDetectedChange, cmUChannelID=cmUChannelID, auditCycleCount=auditCycleCount, fpgaErrorEventGroup=fpgaErrorEventGroup, PYSNMP_MODULE_ID=cadEquipmentMib, cardBootVersion=cardBootVersion, eqDiagConfig=eqDiagConfig, portTxFlowControlDetected=portTxFlowControlDetected, portNumChans=portNumChans, cardSpareGroupId=cardSpareGroupId, cardCpuSpeed=cardCpuSpeed, cardLastResetReason=cardLastResetReason, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cmRegistrationNotification=cmRegistrationNotification, TestSchedule=TestSchedule, auditCommand=auditCommand, equipmentTbl=equipmentTbl, auditCardId=auditCardId, trapSeverity=trapSeverity, portAdminState=portAdminState, portTrapInh=portTrapInh, downstreamPowerLoss=downstreamPowerLoss, cardTestName=cardTestName, auditTable=auditTable, portCardId=portCardId, consoleOutput=consoleOutput, cardPrState=cardPrState, cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditResult=auditResult, equipmentStateGroup=equipmentStateGroup, auditId=auditId, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardShelfTestIndex=cardShelfTestIndex, diskVolumeTrapInh=diskVolumeTrapInh, equipmentCardGroup=equipmentCardGroup, auditDescription=auditDescription, diagTestId=diagTestId, cardTestResultDesc=cardTestResultDesc, cardFpgaSource=cardFpgaSource, cardPicHwVersion=cardPicHwVersion, auditLogThrottle=auditLogThrottle, cardAction=cardAction, auditLogOutput=auditLogOutput, auditPassedCount=auditPassedCount, TestType=TestType, errEvLogLevel=errEvLogLevel, diskVolumeEntry=diskVolumeEntry, cardLastBootSource=cardLastBootSource, cardTestSchedule=cardTestSchedule, cmResetInfo=cmResetInfo, equipmentState=equipmentState, portTxFlowControlMode=portTxFlowControlMode, portSecStateChange=portSecStateChange, portCardSubType=portCardSubType, equipmentAuditGroup=equipmentAuditGroup, cadEquipmentMibCompliances=cadEquipmentMibCompliances, equipmentTraps=equipmentTraps, auditTime=auditTime, cardSecState=cardSecState, cardTrapInh=cardTrapInh, cardTemperatureHighWarn=cardTemperatureHighWarn, cardCarrierFwVersion=cardCarrierFwVersion, shelfObjects=shelfObjects, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, TestCommand=TestCommand, cardSubDetected=cardSubDetected, portDocsIfIndex=portDocsIfIndex, auditStatus=auditStatus, TestTransactionId=TestTransactionId, cardId=cardId, diskVolumeSize=diskVolumeSize, diskVolumeUsagePercentage=diskVolumeUsagePercentage, fpgaErrorEventEntry=fpgaErrorEventEntry, cardType=cardType, cardCarrierSerialNum=cardCarrierSerialNum, fpgaErrorEventTable=fpgaErrorEventTable, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardHwVersion=cardHwVersion, cardBusSpeed=cardBusSpeed, equipmentAudit=equipmentAudit, cardTestTable=cardTestTable, diskDriveNumber=diskDriveNumber, cardLastChangeTime=cardLastChangeTime, trapCounter=trapCounter, errEvLoggingEnabled=errEvLoggingEnabled, portMode=portMode, systemKey=systemKey, cardDplxStatus=cardDplxStatus, cardSwVersion=cardSwVersion, diskVolumeDriveId=diskVolumeDriveId, auditAutoScheduling=auditAutoScheduling, errEventId=errEventId, cardAdminState=cardAdminState, portMinDsPower=portMinDsPower, cardSubType=cardSubType, cardFwVersion=cardFwVersion, cardPrStateChange=cardPrStateChange, cardDplxStatusChange=cardDplxStatusChange, portCurrDsPower=portCurrDsPower, equipmentError=equipmentError, portShelfId=portShelfId, portId=portId, diskVolumeNumber=diskVolumeNumber)
