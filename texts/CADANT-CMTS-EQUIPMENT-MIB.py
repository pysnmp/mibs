...
PortDetectedMode, CardSubType, PicType, PortMode, PrimaryState, PortType, SecondaryState, ShelfId, CardType, CardId, EqActionType, FirmwareSource, AdminState, PortId, UnknownState, DiskVolumeUsageLevel, DuplexStatus, FlowControlMode = mibBuilder.importSymbols("CADANT-TC", "PortDetectedMode", "CardSubType", "PicType", "PortMode", "PrimaryState", "PortType", "SecondaryState", "ShelfId", "CardType", "CardId", "EqActionType", "FirmwareSource", "AdminState", "PortId", "UnknownState", "DiskVolumeUsageLevel", "DuplexStatus", "FlowControlMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
NotificationType, ModuleIdentity, TimeTicks, iso, Bits, IpAddress, Unsigned32, Counter64, MibIdentifier, ObjectIdentity, Integer32, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "TimeTicks", "iso", "Bits", "IpAddress", "Unsigned32", "Counter64", "MibIdentifier", "ObjectIdentity", "Integer32", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, TruthValue, RowStatus, TimeStamp, MacAddress, DateAndTime, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "RowStatus", "TimeStamp", "MacAddress", "DateAndTime", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portSecState=portSecState, portPrState=portPrState, cardSwVersion=cardSwVersion, cmResetReason=cmResetReason, cardSubType=cardSubType, cardType=cardType, shelfObjects=shelfObjects, cardTemperature=cardTemperature, cardTestResultDesc=cardTestResultDesc, cmUChannelID=cmUChannelID, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portLastChangeTime=portLastChangeTime, cardTempNoReportNotification=cardTempNoReportNotification, cmIpAddress=cmIpAddress, cardAdminState=cardAdminState, auditTotalPassedCount=auditTotalPassedCount, diskVolumeGroup=diskVolumeGroup, portTxFlowControlMode=portTxFlowControlMode, equipmentError=equipmentError, equipmentShelfGroup=equipmentShelfGroup, cardPrState=cardPrState, TestResult=TestResult, fpgaErrorEventTable=fpgaErrorEventTable, auditAutoScheduling=auditAutoScheduling, portSecStateChange=portSecStateChange, portDplxStatus=portDplxStatus, cardTable=cardTable, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardFpgaSource=cardFpgaSource, errEvRowStatus=errEvRowStatus, portCardSubType=portCardSubType, cardTestName=cardTestName, errEvLogLevel=errEvLogLevel, cardSpareGroupMode=cardSpareGroupMode, TestId=TestId, cardCPLDVersion=cardCPLDVersion, portRxFlowControlMode=portRxFlowControlMode, equipmentCardGroup=equipmentCardGroup, equipmentTraps=equipmentTraps, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, eqDiagConfig=eqDiagConfig, cardLastChangeTime=cardLastChangeTime, cardHwVersion=cardHwVersion, cardNumPorts=cardNumPorts, cardPicDetected=cardPicDetected, consoleOutput=consoleOutput, cardEntry=cardEntry, portMinDsPower=portMinDsPower, shelfNumber=shelfNumber, cardBusSpeed=cardBusSpeed, diskVolumeUsageNotification=diskVolumeUsageNotification, auditCommand=auditCommand, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, auditTime=auditTime, cardDetectedChange=cardDetectedChange, cardShelfTestIndex=cardShelfTestIndex, portId=portId, portShelfId=portShelfId, cadEquipmentMibConformance=cadEquipmentMibConformance, portType=portType, portCurrDsPower=portCurrDsPower, diskVolumeTrapInh=diskVolumeTrapInh, auditEntry=auditEntry, auditName=auditName, equipmentStateGroup=equipmentStateGroup, errEvRecoveryEnabled=errEvRecoveryEnabled, cardCpuType=cardCpuType, cadEquipmentMibGroup=cadEquipmentMibGroup, cardFwVersion=cardFwVersion, TestSchedule=TestSchedule, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeDiskSize=diskVolumeDiskSize, cardTestTable=cardTestTable, cardTrapInh=cardTrapInh, cmPrimarySID=cmPrimarySID, diskVolumeNumber=diskVolumeNumber, cardDplxStatus=cardDplxStatus, portEntry=portEntry, cardPicSerialNum=cardPicSerialNum, cardTestScheduleCommand=cardTestScheduleCommand, cardLastBootVersion=cardLastBootVersion, TestScheduleCommand=TestScheduleCommand, cardBootVersion=cardBootVersion, equipmentDiag=equipmentDiag, cardTestCommand=cardTestCommand, equipmentAuditGroup=equipmentAuditGroup, diagTestId=diagTestId, cmResetNotification=cmResetNotification, cardUpTime=cardUpTime, trapCounter=trapCounter, portNumChans=portNumChans, cardTestIndex=cardTestIndex, diskVolumeId=diskVolumeId, auditLogThrottle=auditLogThrottle, cardSubDetected=cardSubDetected, cardTemperatureHighWarn=cardTemperatureHighWarn, cardTestType=cardTestType, cardTempOverHeatNotification=cardTempOverHeatNotification, systemKey=systemKey, cardName=cardName, portNumber=portNumber, cardPicHwVersion=cardPicHwVersion, auditId=auditId, equipmentTbl=equipmentTbl, cardDetected=cardDetected, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeDriveId=diskVolumeDriveId, diskVolumeFileName=diskVolumeFileName, diskVolumeCardId=diskVolumeCardId, cardTestDescription=cardTestDescription, equipmentState=equipmentState, cardLastResetReason=cardLastResetReason, portTrapInh=portTrapInh, downstreamPowerLoss=downstreamPowerLoss, systemGeneral=systemGeneral, cardTestResult=cardTestResult, portDplxStatusChange=portDplxStatusChange, auditPassedCount=auditPassedCount, cardCarrierFwVersion=cardCarrierFwVersion, auditStatus=auditStatus, cardTestResultNotification=cardTestResultNotification, cardId=cardId, fpgaErrorEventGroup=fpgaErrorEventGroup, cardCpuSpeed=cardCpuSpeed, portMacIfIndex=portMacIfIndex, cardTestTime=cardTestTime, cardCarrierSerialNum=cardCarrierSerialNum, systemClock=systemClock, equipmentPortGroup=equipmentPortGroup, equipmentAudit=equipmentAudit, cardSpareGroupId=cardSpareGroupId, cardSecState=cardSecState, shelfName=shelfName, cardFlashSize=cardFlashSize, auditShelfId=auditShelfId, auditLogOutput=auditLogOutput, cardCarrierHwVersion=cardCarrierHwVersion, cardTestTransId=cardTestTransId, portAction=portAction, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cmResetStatus=cmResetStatus, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, trapSeverity=trapSeverity, portBgpId=portBgpId, diskDriveNumber=diskDriveNumber, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cmMacAddress=cmMacAddress, cardSecStateChange=cardSecStateChange, cardFwUpdateStatus=cardFwUpdateStatus, PYSNMP_MODULE_ID=cadEquipmentMib, cadEquipmentMib=cadEquipmentMib, portDetectedMode=portDetectedMode, equipmentCardTestGroup=equipmentCardTestGroup, cardRamSize=cardRamSize, cardPrStateChange=cardPrStateChange, auditCardId=auditCardId, auditCycleCount=auditCycleCount, cardTestSchedule=cardTestSchedule, portMode=portMode, diskVolumeSize=diskVolumeSize, auditTotalFailedCount=auditTotalFailedCount, portMacAddress=portMacAddress, diskVolumeName=diskVolumeName, equipmentDiagGroup=equipmentDiagGroup, TestTransactionId=TestTransactionId, cardShelfId=cardShelfId, cardNumber=cardNumber, cmRegistrationNotification=cmRegistrationNotification, auditFailedCount=auditFailedCount, errEventId=errEventId, verboseLevel=verboseLevel, TestType=TestType, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portAdminState=portAdminState, portDocsIfIndex=portDocsIfIndex, systemGeneralGroup=systemGeneralGroup, portCardId=portCardId, auditTable=auditTable, cmResetClearNotification=cmResetClearNotification, shelfSwVersion=shelfSwVersion, auditResult=auditResult, cardTemperatureHighError=cardTemperatureHighError, cmResetInfo=cmResetInfo, portMaxDsPower=portMaxDsPower, TestCommand=TestCommand, diskVolumeTable=diskVolumeTable, portConnectorId=portConnectorId, portTable=portTable, diskVolumeShelfId=diskVolumeShelfId, portTxFlowControlDetected=portTxFlowControlDetected, errEvLoggingEnabled=errEvLoggingEnabled, cardTestId=cardTestId, cardLastBootSource=cardLastBootSource, cardDplxStatusChange=cardDplxStatusChange, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, remainInDiagMode=remainInDiagMode, auditDescription=auditDescription, cmVendor=cmVendor, cardTestEntry=cardTestEntry, portPrStateChange=portPrStateChange, cmResetUpTime=cmResetUpTime, cardSerialNum=cardSerialNum, cmDevice=cmDevice, fpgaErrorEventEntry=fpgaErrorEventEntry, diskVolumeEntry=diskVolumeEntry, cardAction=cardAction, portDescription=portDescription)
