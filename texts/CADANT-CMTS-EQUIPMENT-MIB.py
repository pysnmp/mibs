...
FlowControlMode, PicType, CardType, SecondaryState, PortType, PortId, CardSubType, AdminState, PortMode, ShelfId, CardId, UnknownState, PortDetectedMode, FirmwareSource, DuplexStatus, DiskVolumeUsageLevel, PrimaryState, EqActionType = mibBuilder.importSymbols("CADANT-TC", "FlowControlMode", "PicType", "CardType", "SecondaryState", "PortType", "PortId", "CardSubType", "AdminState", "PortMode", "ShelfId", "CardId", "UnknownState", "PortDetectedMode", "FirmwareSource", "DuplexStatus", "DiskVolumeUsageLevel", "PrimaryState", "EqActionType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
Counter64, Integer32, TimeTicks, IpAddress, Gauge32, Bits, NotificationType, Counter32, MibIdentifier, iso, ObjectIdentity, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "TimeTicks", "IpAddress", "Gauge32", "Bits", "NotificationType", "Counter32", "MibIdentifier", "iso", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
MacAddress, RowStatus, TimeStamp, TruthValue, DateAndTime, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "RowStatus", "TimeStamp", "TruthValue", "DateAndTime", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardTestResultNotification=cardTestResultNotification, portNumber=portNumber, shelfObjects=shelfObjects, cardShelfId=cardShelfId, equipmentAudit=equipmentAudit, errEventId=errEventId, TestCommand=TestCommand, portMacIfIndex=portMacIfIndex, cardHwVersion=cardHwVersion, cardAction=cardAction, portConnectorId=portConnectorId, portNumChans=portNumChans, cardTestResult=cardTestResult, diskVolumeFileName=diskVolumeFileName, cardLastChangeTime=cardLastChangeTime, cardTestTransId=cardTestTransId, cardPrState=cardPrState, portSecState=portSecState, equipmentError=equipmentError, cardPicSerialNum=cardPicSerialNum, cardCpuSpeed=cardCpuSpeed, cardTempOverHeatNotification=cardTempOverHeatNotification, cardSubType=cardSubType, auditDescription=auditDescription, cardTestTable=cardTestTable, diskVolumeUsageNotification=diskVolumeUsageNotification, auditCommand=auditCommand, diskVolumeShelfId=diskVolumeShelfId, cmResetUpTime=cmResetUpTime, cardCPLDVersion=cardCPLDVersion, cmMacAddress=cmMacAddress, equipmentTbl=equipmentTbl, cardPrStateChange=cardPrStateChange, portTrapInh=portTrapInh, cardAdminState=cardAdminState, cardTestTime=cardTestTime, portRxFlowControlDetected=portRxFlowControlDetected, shelfSwVersion=shelfSwVersion, portPrStateChange=portPrStateChange, portId=portId, cardCarrierHwVersion=cardCarrierHwVersion, cardTestIndex=cardTestIndex, errEvRowStatus=errEvRowStatus, cardSecState=cardSecState, cardPicHwVersion=cardPicHwVersion, portDplxStatus=portDplxStatus, diagTestId=diagTestId, cardFpgaSource=cardFpgaSource, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portCardSubType=portCardSubType, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardEntry=cardEntry, trapCounter=trapCounter, cardFwVersion=cardFwVersion, TestType=TestType, equipmentDiagGroup=equipmentDiagGroup, cadEquipmentMibGroup=cadEquipmentMibGroup, portRxFlowControlMode=portRxFlowControlMode, shelfNumber=shelfNumber, cardType=cardType, cardSubDetected=cardSubDetected, diskVolumeDriveId=diskVolumeDriveId, equipmentStateGroup=equipmentStateGroup, cardDetectedChange=cardDetectedChange, cardTemperature=cardTemperature, portDocsIfIndex=portDocsIfIndex, cmResetInfo=cmResetInfo, cadEquipmentMib=cadEquipmentMib, systemKey=systemKey, cardBootVersion=cardBootVersion, PYSNMP_MODULE_ID=cadEquipmentMib, portMacAddress=portMacAddress, systemGeneral=systemGeneral, cadEquipmentMibConformance=cadEquipmentMibConformance, auditShelfId=auditShelfId, cardTestCommand=cardTestCommand, consoleOutput=consoleOutput, portSecStateChange=portSecStateChange, cardSerialNum=cardSerialNum, auditStatus=auditStatus, portMode=portMode, equipmentState=equipmentState, cardCarrierFwVersion=cardCarrierFwVersion, TestResult=TestResult, equipmentCardGroup=equipmentCardGroup, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskDriveNumber=diskDriveNumber, auditTable=auditTable, cardUpTime=cardUpTime, cardNumber=cardNumber, portLastChangeTime=portLastChangeTime, cardTestId=cardTestId, diskVolumeTable=diskVolumeTable, portDplxStatusChange=portDplxStatusChange, cardTrapInh=cardTrapInh, cardRamSize=cardRamSize, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portCurrDsPower=portCurrDsPower, cardTestDescription=cardTestDescription, cmRegistrationNotification=cmRegistrationNotification, equipmentShelfGroup=equipmentShelfGroup, portPrState=portPrState, cardDplxStatus=cardDplxStatus, cardSwVersion=cardSwVersion, portAdminState=portAdminState, shelfName=shelfName, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, equipmentDiag=equipmentDiag, cardFlashSize=cardFlashSize, cardFwUpdateStatus=cardFwUpdateStatus, auditResult=auditResult, portAction=portAction, TestScheduleCommand=TestScheduleCommand, equipmentTraps=equipmentTraps, cardName=cardName, cmResetNotification=cmResetNotification, systemGeneralGroup=systemGeneralGroup, cmIpAddress=cmIpAddress, portEntry=portEntry, diskVolumeNumber=diskVolumeNumber, portTxFlowControlDetected=portTxFlowControlDetected, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cmResetStatus=cmResetStatus, cardSecStateChange=cardSecStateChange, cmUChannelID=cmUChannelID, diskVolumeDiskSize=diskVolumeDiskSize, auditCardId=auditCardId, auditEntry=auditEntry, fpgaErrorEventEntry=fpgaErrorEventEntry, cardTempNoReportNotification=cardTempNoReportNotification, portType=portType, auditLogOutput=auditLogOutput, portTable=portTable, cardSpareGroupMode=cardSpareGroupMode, remainInDiagMode=remainInDiagMode, cmVendor=cmVendor, auditFailedCount=auditFailedCount, auditAutoScheduling=auditAutoScheduling, cardTestName=cardTestName, equipmentCardTestGroup=equipmentCardTestGroup, verboseLevel=verboseLevel, cardId=cardId, diskVolumeEntry=diskVolumeEntry, cardLastBootVersion=cardLastBootVersion, portTxFlowControlMode=portTxFlowControlMode, cardTestScheduleCommand=cardTestScheduleCommand, cardPicDetected=cardPicDetected, portShelfId=portShelfId, auditName=auditName, errEvRecoveryEnabled=errEvRecoveryEnabled, cardTemperatureHighWarn=cardTemperatureHighWarn, diskVolumeId=diskVolumeId, portDescription=portDescription, errEvLoggingEnabled=errEvLoggingEnabled, cardTestType=cardTestType, equipmentAuditGroup=equipmentAuditGroup, errEvLogLevel=errEvLogLevel, eqDiagConfig=eqDiagConfig, cardTable=cardTable, diskVolumeUsagePercentage=diskVolumeUsagePercentage, systemClock=systemClock, auditLogThrottle=auditLogThrottle, diskVolumeUsageLevel=diskVolumeUsageLevel, downstreamPowerLoss=downstreamPowerLoss, equipmentPortGroup=equipmentPortGroup, TestSchedule=TestSchedule, trapSeverity=trapSeverity, cmResetClearNotification=cmResetClearNotification, cardDplxStatusChange=cardDplxStatusChange, fpgaErrorEventTable=fpgaErrorEventTable, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardCpuType=cardCpuType, cardLastResetReason=cardLastResetReason, diskVolumeSize=diskVolumeSize, cardLastBootSource=cardLastBootSource, cardTestEntry=cardTestEntry, TestTransactionId=TestTransactionId, diskVolumeGroup=diskVolumeGroup, cardTemperatureHighError=cardTemperatureHighError, portDetectedMode=portDetectedMode, diskVolumeCardId=diskVolumeCardId, diskVolumeTrapInh=diskVolumeTrapInh, diskVolumeName=diskVolumeName, cardShelfTestIndex=cardShelfTestIndex, auditPassedCount=auditPassedCount, fpgaErrorEventGroup=fpgaErrorEventGroup, cardBusSpeed=cardBusSpeed, cardTestSchedule=cardTestSchedule, auditCycleCount=auditCycleCount, TestId=TestId, cardNumPorts=cardNumPorts, cardSpareGroupId=cardSpareGroupId, portMinDsPower=portMinDsPower, cmDevice=cmDevice, auditTime=auditTime, cmResetReason=cmResetReason, portCardId=portCardId, auditTotalFailedCount=auditTotalFailedCount, cardTestResultDesc=cardTestResultDesc, cardCarrierSerialNum=cardCarrierSerialNum, cmPrimarySID=cmPrimarySID, auditId=auditId, portMaxDsPower=portMaxDsPower, auditTotalPassedCount=auditTotalPassedCount, cardDetected=cardDetected, portBgpId=portBgpId)
