...
CardType, PortType, FirmwareSource, PortMode, PicType, DuplexStatus, EqActionType, ShelfId, FlowControlMode, SecondaryState, AdminState, PortDetectedMode, PortId, CardId, CardSubType, DiskVolumeUsageLevel, UnknownState, PrimaryState = mibBuilder.importSymbols("CADANT-TC", "CardType", "PortType", "FirmwareSource", "PortMode", "PicType", "DuplexStatus", "EqActionType", "ShelfId", "FlowControlMode", "SecondaryState", "AdminState", "PortDetectedMode", "PortId", "CardId", "CardSubType", "DiskVolumeUsageLevel", "UnknownState", "PrimaryState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ObjectGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ObjectGroup", "ModuleCompliance")
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Counter32, TimeTicks, Unsigned32, Gauge32, iso, IpAddress, Counter64, Integer32, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Counter32", "TimeTicks", "Unsigned32", "Gauge32", "iso", "IpAddress", "Counter64", "Integer32", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portDetectedMode=portDetectedMode, cardRamSize=cardRamSize, fpgaErrorEventGroup=fpgaErrorEventGroup, cmResetClearNotification=cmResetClearNotification, cardTestType=cardTestType, diskVolumeUsageLevel=diskVolumeUsageLevel, auditTotalFailedCount=auditTotalFailedCount, portPrState=portPrState, auditAutoScheduling=auditAutoScheduling, cardId=cardId, auditResult=auditResult, downstreamPowerLoss=downstreamPowerLoss, diskVolumeSize=diskVolumeSize, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeDriveId=diskVolumeDriveId, cmIpAddress=cmIpAddress, systemClock=systemClock, cardTestId=cardTestId, TestCommand=TestCommand, errEvRecoveryEnabled=errEvRecoveryEnabled, portNumChans=portNumChans, portPrStateChange=portPrStateChange, cardHwVersion=cardHwVersion, auditLogOutput=auditLogOutput, cardLastResetReason=cardLastResetReason, portConnectorId=portConnectorId, auditTotalPassedCount=auditTotalPassedCount, errEvLogLevel=errEvLogLevel, fpgaErrorEventTable=fpgaErrorEventTable, diskVolumeNumber=diskVolumeNumber, cardShelfId=cardShelfId, equipmentPortGroup=equipmentPortGroup, cmPrimarySID=cmPrimarySID, portEntry=portEntry, cmUChannelID=cmUChannelID, cardAction=cardAction, TestSchedule=TestSchedule, cardSubType=cardSubType, cardCpuSpeed=cardCpuSpeed, cardTempNoReportNotification=cardTempNoReportNotification, portRxFlowControlMode=portRxFlowControlMode, cmResetStatus=cmResetStatus, systemGeneral=systemGeneral, cardSpareGroupMode=cardSpareGroupMode, portTable=portTable, portDplxStatus=portDplxStatus, cadEquipmentMibGroup=cadEquipmentMibGroup, auditTable=auditTable, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardTestSchedule=cardTestSchedule, cardPicDetected=cardPicDetected, cardTestResultNotification=cardTestResultNotification, cardCPLDVersion=cardCPLDVersion, cmDevice=cmDevice, equipmentShelfGroup=equipmentShelfGroup, cmMacAddress=cmMacAddress, cardUpTime=cardUpTime, cardType=cardType, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeCardId=diskVolumeCardId, cardSpareGroupId=cardSpareGroupId, cardShelfTestIndex=cardShelfTestIndex, equipmentDiag=equipmentDiag, cardCarrierFwVersion=cardCarrierFwVersion, cmResetNotification=cmResetNotification, auditFailedCount=auditFailedCount, cardTestDescription=cardTestDescription, equipmentTbl=equipmentTbl, cardPicSerialNum=cardPicSerialNum, cmResetUpTime=cmResetUpTime, portAction=portAction, portDescription=portDescription, portMinDsPower=portMinDsPower, cardTestTime=cardTestTime, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portDocsIfIndex=portDocsIfIndex, cardSecStateChange=cardSecStateChange, cardNumber=cardNumber, cardDetected=cardDetected, portDplxStatusChange=portDplxStatusChange, diskVolumeId=diskVolumeId, cardFpgaSource=cardFpgaSource, auditDescription=auditDescription, portMaxDsPower=portMaxDsPower, shelfName=shelfName, portTxFlowControlMode=portTxFlowControlMode, cardPicHwVersion=cardPicHwVersion, cadEquipmentMibConformance=cadEquipmentMibConformance, cardTestCommand=cardTestCommand, shelfSwVersion=shelfSwVersion, shelfNumber=shelfNumber, eqDiagConfig=eqDiagConfig, equipmentStateGroup=equipmentStateGroup, cardTemperatureHighWarn=cardTemperatureHighWarn, cardSecState=cardSecState, cardPrStateChange=cardPrStateChange, portNumber=portNumber, portMode=portMode, cardBusSpeed=cardBusSpeed, diskVolumeTrapInh=diskVolumeTrapInh, errEvRowStatus=errEvRowStatus, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, portSecStateChange=portSecStateChange, cardTestTransId=cardTestTransId, portBgpId=portBgpId, portAdminState=portAdminState, shelfObjects=shelfObjects, equipmentAudit=equipmentAudit, auditStatus=auditStatus, remainInDiagMode=remainInDiagMode, auditPassedCount=auditPassedCount, trapCounter=trapCounter, cardLastBootVersion=cardLastBootVersion, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, TestId=TestId, portMacIfIndex=portMacIfIndex, cardDplxStatusChange=cardDplxStatusChange, TestResult=TestResult, cardSubDetected=cardSubDetected, diskVolumeDiskSize=diskVolumeDiskSize, TestTransactionId=TestTransactionId, cardTestTable=cardTestTable, verboseLevel=verboseLevel, cadEquipmentMib=cadEquipmentMib, systemKey=systemKey, cardTemperature=cardTemperature, auditCommand=auditCommand, diskVolumeGroup=diskVolumeGroup, cardBootVersion=cardBootVersion, auditCycleCount=auditCycleCount, TestType=TestType, cardFwVersion=cardFwVersion, cardTable=cardTable, cardFlashSize=cardFlashSize, cardTestEntry=cardTestEntry, cardCarrierHwVersion=cardCarrierHwVersion, cardTrapInh=cardTrapInh, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeUsagePercentage=diskVolumeUsagePercentage, diskVolumeTable=diskVolumeTable, diskVolumeUsageNotification=diskVolumeUsageNotification, equipmentCardTestGroup=equipmentCardTestGroup, TestScheduleCommand=TestScheduleCommand, portMacAddress=portMacAddress, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, portId=portId, auditLogThrottle=auditLogThrottle, cardLastChangeTime=cardLastChangeTime, auditName=auditName, portRxFlowControlDetected=portRxFlowControlDetected, cardTestResult=cardTestResult, diskDriveNumber=diskDriveNumber, portCurrDsPower=portCurrDsPower, trapSeverity=trapSeverity, cardPrState=cardPrState, cardAdminState=cardAdminState, auditId=auditId, cardTestResultDesc=cardTestResultDesc, cardDetectedChange=cardDetectedChange, equipmentTraps=equipmentTraps, equipmentState=equipmentState, cardCarrierSerialNum=cardCarrierSerialNum, portLastChangeTime=portLastChangeTime, diskVolumeFileName=diskVolumeFileName, cmVendor=cmVendor, fpgaErrorEventEntry=fpgaErrorEventEntry, cardEntry=cardEntry, auditEntry=auditEntry, auditShelfId=auditShelfId, cmResetInfo=cmResetInfo, equipmentError=equipmentError, errEventId=errEventId, cardTestIndex=cardTestIndex, cardSwVersion=cardSwVersion, portTxFlowControlDetected=portTxFlowControlDetected, diagTestId=diagTestId, cardNumPorts=cardNumPorts, diskVolumeShelfId=diskVolumeShelfId, consoleOutput=consoleOutput, auditTime=auditTime, equipmentAuditGroup=equipmentAuditGroup, diskVolumeEntry=diskVolumeEntry, cardCpuType=cardCpuType, cardSerialNum=cardSerialNum, cardLastBootSource=cardLastBootSource, auditCardId=auditCardId, portType=portType, portCardId=portCardId, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardName=cardName, portTrapInh=portTrapInh, portSecState=portSecState, portCardSubType=portCardSubType, portShelfId=portShelfId, diskVolumeName=diskVolumeName, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, equipmentDiagGroup=equipmentDiagGroup, PYSNMP_MODULE_ID=cadEquipmentMib, cmRegistrationNotification=cmRegistrationNotification, cardTestName=cardTestName, cardDplxStatus=cardDplxStatus, cardTemperatureHighError=cardTemperatureHighError, cardTestScheduleCommand=cardTestScheduleCommand, cmResetReason=cmResetReason, equipmentCardGroup=equipmentCardGroup, systemGeneralGroup=systemGeneralGroup, cardFwUpdateStatus=cardFwUpdateStatus)
