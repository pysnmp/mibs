...
CardId, CardType, CardSubType, PortType, UnknownState, ShelfId, FirmwareSource, SecondaryState, FlowControlMode, DiskVolumeUsageLevel, EqActionType, PortDetectedMode, PortId, DuplexStatus, AdminState, PrimaryState, PortMode, PicType = mibBuilder.importSymbols("CADANT-TC", "CardId", "CardType", "CardSubType", "PortType", "UnknownState", "ShelfId", "FirmwareSource", "SecondaryState", "FlowControlMode", "DiskVolumeUsageLevel", "EqActionType", "PortDetectedMode", "PortId", "DuplexStatus", "AdminState", "PrimaryState", "PortMode", "PicType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
iso, IpAddress, Counter32, Bits, Gauge32, ModuleIdentity, Integer32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Counter32", "Bits", "Gauge32", "ModuleIdentity", "Integer32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", errEvRecoveryEnabled=errEvRecoveryEnabled, equipmentDiag=equipmentDiag, portDocsIfIndex=portDocsIfIndex, auditTable=auditTable, auditShelfId=auditShelfId, cardUpTime=cardUpTime, cardNumPorts=cardNumPorts, auditLogThrottle=auditLogThrottle, portLastChangeTime=portLastChangeTime, portTable=portTable, portTrapInh=portTrapInh, portMinDsPower=portMinDsPower, diskVolumeUsageLevel=diskVolumeUsageLevel, systemKey=systemKey, cardSubDetected=cardSubDetected, cardTestName=cardTestName, auditTime=auditTime, portDplxStatusChange=portDplxStatusChange, TestSchedule=TestSchedule, cardFpgaSource=cardFpgaSource, cmIpAddress=cmIpAddress, cardLastBootSource=cardLastBootSource, cardCarrierFwVersion=cardCarrierFwVersion, portMacIfIndex=portMacIfIndex, portBgpId=portBgpId, diskVolumeSize=diskVolumeSize, portNumChans=portNumChans, diskVolumeUsagePercentage=diskVolumeUsagePercentage, diskVolumeId=diskVolumeId, diskVolumeDiskSize=diskVolumeDiskSize, cardTestCommand=cardTestCommand, cardCpuType=cardCpuType, auditFailedCount=auditFailedCount, cardTemperatureHighError=cardTemperatureHighError, TestResult=TestResult, cardName=cardName, cmDevice=cmDevice, cardHwVersion=cardHwVersion, portMaxDsPower=portMaxDsPower, cardTestScheduleCommand=cardTestScheduleCommand, cmMacAddress=cmMacAddress, cardNumber=cardNumber, portShelfId=portShelfId, cardTestId=cardTestId, cardCPLDVersion=cardCPLDVersion, portNumber=portNumber, cardPicHwVersion=cardPicHwVersion, cardRamSize=cardRamSize, cardTestTable=cardTestTable, equipmentCardTestGroup=equipmentCardTestGroup, equipmentState=equipmentState, cardLastChangeTime=cardLastChangeTime, auditAutoScheduling=auditAutoScheduling, diagTestId=diagTestId, auditResult=auditResult, portRxFlowControlDetected=portRxFlowControlDetected, cardCarrierSerialNum=cardCarrierSerialNum, equipmentDiagGroup=equipmentDiagGroup, cardDetectedChange=cardDetectedChange, cardTestSchedule=cardTestSchedule, cmPrimarySID=cmPrimarySID, equipmentTbl=equipmentTbl, cardPicSerialNum=cardPicSerialNum, portAction=portAction, diskVolumeShelfId=diskVolumeShelfId, equipmentStateGroup=equipmentStateGroup, PYSNMP_MODULE_ID=cadEquipmentMib, portType=portType, cadEquipmentMibCompliances=cadEquipmentMibCompliances, fpgaErrorEventGroup=fpgaErrorEventGroup, equipmentCardGroup=equipmentCardGroup, cardTestResultNotification=cardTestResultNotification, portEntry=portEntry, portTxFlowControlMode=portTxFlowControlMode, cardPicDetected=cardPicDetected, cardBusSpeed=cardBusSpeed, auditName=auditName, cardLastResetReason=cardLastResetReason, trapCounter=trapCounter, cadEquipmentMibGroup=cadEquipmentMibGroup, cardSubType=cardSubType, cardTable=cardTable, equipmentShelfGroup=equipmentShelfGroup, cardTemperatureHighWarn=cardTemperatureHighWarn, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, diskVolumeTrapInh=diskVolumeTrapInh, cardSwVersion=cardSwVersion, diskVolumeNumber=diskVolumeNumber, portDplxStatus=portDplxStatus, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, auditPassedCount=auditPassedCount, cardTestDescription=cardTestDescription, cardSecStateChange=cardSecStateChange, TestTransactionId=TestTransactionId, cardSerialNum=cardSerialNum, cardPrState=cardPrState, cardShelfTestIndex=cardShelfTestIndex, equipmentAuditGroup=equipmentAuditGroup, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTestResultDesc=cardTestResultDesc, downstreamPowerLoss=downstreamPowerLoss, errEventId=errEventId, diskVolumeEntry=diskVolumeEntry, cardDetected=cardDetected, auditEntry=auditEntry, systemGeneral=systemGeneral, cardDplxStatus=cardDplxStatus, cardId=cardId, portAdminState=portAdminState, shelfSwVersion=shelfSwVersion, auditCardId=auditCardId, portId=portId, diskVolumeName=diskVolumeName, cardPrStateChange=cardPrStateChange, cmResetReason=cmResetReason, portCardId=portCardId, auditStatus=auditStatus, portPrStateChange=portPrStateChange, cardTestEntry=cardTestEntry, cardTempNoReportNotification=cardTempNoReportNotification, remainInDiagMode=remainInDiagMode, diskVolumeTable=diskVolumeTable, cmUChannelID=cmUChannelID, auditTotalPassedCount=auditTotalPassedCount, auditId=auditId, cardShelfId=cardShelfId, diskVolumeUsageNotification=diskVolumeUsageNotification, TestCommand=TestCommand, verboseLevel=verboseLevel, portDetectedMode=portDetectedMode, cardCpuSpeed=cardCpuSpeed, eqDiagConfig=eqDiagConfig, cmVendor=cmVendor, cardTestIndex=cardTestIndex, errEvLogLevel=errEvLogLevel, cardTrapInh=cardTrapInh, cmResetUpTime=cmResetUpTime, systemGeneralGroup=systemGeneralGroup, equipmentError=equipmentError, cmRegistrationNotification=cmRegistrationNotification, cardSpareGroupId=cardSpareGroupId, portSecState=portSecState, errEvLoggingEnabled=errEvLoggingEnabled, errEvRowStatus=errEvRowStatus, portDescription=portDescription, diskDriveNumber=diskDriveNumber, cmResetClearNotification=cmResetClearNotification, shelfName=shelfName, fpgaErrorEventTable=fpgaErrorEventTable, cardSecState=cardSecState, cardTestTime=cardTestTime, cardTestTransId=cardTestTransId, cardType=cardType, auditCycleCount=auditCycleCount, diskVolumeFileName=diskVolumeFileName, diskVolumeGroup=diskVolumeGroup, equipmentTraps=equipmentTraps, diskVolumeDriveId=diskVolumeDriveId, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, TestId=TestId, portSecStateChange=portSecStateChange, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardDplxStatusChange=cardDplxStatusChange, portCardSubType=portCardSubType, cardTestResult=cardTestResult, cardEntry=cardEntry, cardAction=cardAction, equipmentPortGroup=equipmentPortGroup, diskVolumeCardId=diskVolumeCardId, portPrState=portPrState, portTxFlowControlDetected=portTxFlowControlDetected, cardSpareGroupMode=cardSpareGroupMode, shelfObjects=shelfObjects, portMacAddress=portMacAddress, equipmentAudit=equipmentAudit, systemClock=systemClock, cmResetStatus=cmResetStatus, portRxFlowControlMode=portRxFlowControlMode, trapSeverity=trapSeverity, portCurrDsPower=portCurrDsPower, cardTemperature=cardTemperature, cardLastBootVersion=cardLastBootVersion, cmResetNotification=cmResetNotification, cardTestType=cardTestType, cardFwUpdateStatus=cardFwUpdateStatus, TestScheduleCommand=TestScheduleCommand, auditLogOutput=auditLogOutput, fpgaErrorEventEntry=fpgaErrorEventEntry, cmResetInfo=cmResetInfo, portConnectorId=portConnectorId, auditTotalFailedCount=auditTotalFailedCount, auditCommand=auditCommand, cardBootVersion=cardBootVersion, TestType=TestType, cardFlashSize=cardFlashSize, cardCarrierHwVersion=cardCarrierHwVersion, cadEquipmentMib=cadEquipmentMib, portMode=portMode, consoleOutput=consoleOutput, cardAdminState=cardAdminState, auditDescription=auditDescription, shelfNumber=shelfNumber, cardFwVersion=cardFwVersion, cadEquipmentMibConformance=cadEquipmentMibConformance, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold)
