...
PortId, PrimaryState, CardSubType, UnknownState, DiskVolumeUsageLevel, EqActionType, PortMode, DuplexStatus, CardId, AdminState, FirmwareSource, FlowControlMode, PortDetectedMode, PortType, ShelfId, SecondaryState, PicType, CardType = mibBuilder.importSymbols("CADANT-TC", "PortId", "PrimaryState", "CardSubType", "UnknownState", "DiskVolumeUsageLevel", "EqActionType", "PortMode", "DuplexStatus", "CardId", "AdminState", "FirmwareSource", "FlowControlMode", "PortDetectedMode", "PortType", "ShelfId", "SecondaryState", "PicType", "CardType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, Integer32, Bits, TimeTicks, iso, Gauge32, MibIdentifier, NotificationType, Counter32, Counter64, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "Integer32", "Bits", "TimeTicks", "iso", "Gauge32", "MibIdentifier", "NotificationType", "Counter32", "Counter64", "ModuleIdentity", "ObjectIdentity")
TimeStamp, DateAndTime, RowStatus, DisplayString, MacAddress, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DateAndTime", "RowStatus", "DisplayString", "MacAddress", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", systemGeneral=systemGeneral, cardName=cardName, portShelfId=portShelfId, portType=portType, diskVolumeSize=diskVolumeSize, errEvLogLevel=errEvLogLevel, fpgaErrorEventTable=fpgaErrorEventTable, cardBootVersion=cardBootVersion, diskVolumeTrapInh=diskVolumeTrapInh, cardCarrierHwVersion=cardCarrierHwVersion, remainInDiagMode=remainInDiagMode, cardTestName=cardTestName, cardNumPorts=cardNumPorts, cardUpTime=cardUpTime, auditLogOutput=auditLogOutput, cardPicHwVersion=cardPicHwVersion, cardSpareGroupMode=cardSpareGroupMode, diskVolumeDriveId=diskVolumeDriveId, portMode=portMode, cardPrState=cardPrState, portMinDsPower=portMinDsPower, cadEquipmentMib=cadEquipmentMib, equipmentAuditGroup=equipmentAuditGroup, shelfNumber=shelfNumber, auditCardId=auditCardId, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditId=auditId, trapSeverity=trapSeverity, equipmentStateGroup=equipmentStateGroup, cardSwVersion=cardSwVersion, cardDplxStatus=cardDplxStatus, cmUChannelID=cmUChannelID, cardSerialNum=cardSerialNum, cardTempOverHeatNotification=cardTempOverHeatNotification, cardCpuSpeed=cardCpuSpeed, portSecStateChange=portSecStateChange, portRxFlowControlMode=portRxFlowControlMode, cardPrStateChange=cardPrStateChange, cardFlashSize=cardFlashSize, cardTestEntry=cardTestEntry, shelfName=shelfName, cardTestType=cardTestType, cardTestCommand=cardTestCommand, cardTrapInh=cardTrapInh, cardTestTime=cardTestTime, cardLastBootSource=cardLastBootSource, diskVolumeName=diskVolumeName, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, equipmentCardTestGroup=equipmentCardTestGroup, portCardSubType=portCardSubType, equipmentState=equipmentState, cardFwVersion=cardFwVersion, TestResult=TestResult, cmRegistrationNotification=cmRegistrationNotification, TestSchedule=TestSchedule, equipmentPortGroup=equipmentPortGroup, TestScheduleCommand=TestScheduleCommand, cardTemperature=cardTemperature, portTxFlowControlMode=portTxFlowControlMode, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTestResultDesc=cardTestResultDesc, cardAdminState=cardAdminState, cardTestIndex=cardTestIndex, equipmentTraps=equipmentTraps, cmMacAddress=cmMacAddress, portNumChans=portNumChans, shelfSwVersion=shelfSwVersion, cardSubDetected=cardSubDetected, auditTime=auditTime, auditStatus=auditStatus, portPrStateChange=portPrStateChange, auditLogThrottle=auditLogThrottle, portLastChangeTime=portLastChangeTime, portTable=portTable, portCardId=portCardId, equipmentAudit=equipmentAudit, auditShelfId=auditShelfId, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cmVendor=cmVendor, equipmentError=equipmentError, errEvRecoveryEnabled=errEvRecoveryEnabled, diskVolumeId=diskVolumeId, portNumber=portNumber, cardTable=cardTable, cardSecStateChange=cardSecStateChange, cardPicDetected=cardPicDetected, diskVolumeFileName=diskVolumeFileName, portSecState=portSecState, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardRamSize=cardRamSize, auditTotalPassedCount=auditTotalPassedCount, errEventId=errEventId, eqDiagConfig=eqDiagConfig, TestTransactionId=TestTransactionId, cardHwVersion=cardHwVersion, diskVolumeUsageNotification=diskVolumeUsageNotification, cardCPLDVersion=cardCPLDVersion, TestType=TestType, cardTestTable=cardTestTable, cmResetStatus=cmResetStatus, portPrState=portPrState, portCurrDsPower=portCurrDsPower, trapCounter=trapCounter, cardTestId=cardTestId, cmResetUpTime=cmResetUpTime, cardTestSchedule=cardTestSchedule, errEvLoggingEnabled=errEvLoggingEnabled, cardId=cardId, cardLastBootVersion=cardLastBootVersion, verboseLevel=verboseLevel, cardTestResult=cardTestResult, cardFwUpdateStatus=cardFwUpdateStatus, auditCycleCount=auditCycleCount, auditTable=auditTable, cardNumber=cardNumber, diagTestId=diagTestId, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, auditPassedCount=auditPassedCount, diskVolumeShelfId=diskVolumeShelfId, cardPicSerialNum=cardPicSerialNum, portMacAddress=portMacAddress, cardEntry=cardEntry, diskVolumeUsageLevel=diskVolumeUsageLevel, cardType=cardType, auditDescription=auditDescription, systemGeneralGroup=systemGeneralGroup, cmResetInfo=cmResetInfo, PYSNMP_MODULE_ID=cadEquipmentMib, cardAction=cardAction, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portRxFlowControlDetected=portRxFlowControlDetected, consoleOutput=consoleOutput, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardLastResetReason=cardLastResetReason, cmPrimarySID=cmPrimarySID, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portAdminState=portAdminState, portMacIfIndex=portMacIfIndex, cardSecState=cardSecState, portTxFlowControlDetected=portTxFlowControlDetected, cmIpAddress=cmIpAddress, diskVolumeEntry=diskVolumeEntry, equipmentDiag=equipmentDiag, cardDplxStatusChange=cardDplxStatusChange, cardTempNoReportNotification=cardTempNoReportNotification, diskVolumeCardId=diskVolumeCardId, fpgaErrorEventGroup=fpgaErrorEventGroup, portDplxStatus=portDplxStatus, cmDevice=cmDevice, cmResetNotification=cmResetNotification, auditAutoScheduling=auditAutoScheduling, portAction=portAction, systemClock=systemClock, cardSpareGroupId=cardSpareGroupId, cardSubType=cardSubType, portEntry=portEntry, auditEntry=auditEntry, auditCommand=auditCommand, cardDetectedChange=cardDetectedChange, cadEquipmentMibGroup=cadEquipmentMibGroup, systemKey=systemKey, auditFailedCount=auditFailedCount, diskDriveNumber=diskDriveNumber, shelfObjects=shelfObjects, cmResetClearNotification=cmResetClearNotification, diskVolumeDiskSize=diskVolumeDiskSize, diskVolumeNumber=diskVolumeNumber, cardCpuType=cardCpuType, TestId=TestId, portId=portId, cardTemperatureHighError=cardTemperatureHighError, downstreamPowerLoss=downstreamPowerLoss, portMaxDsPower=portMaxDsPower, cardTestDescription=cardTestDescription, portTrapInh=portTrapInh, portConnectorId=portConnectorId, cardTestScheduleCommand=cardTestScheduleCommand, equipmentTbl=equipmentTbl, cardDetected=cardDetected, portBgpId=portBgpId, diskVolumeTable=diskVolumeTable, errEvRowStatus=errEvRowStatus, TestCommand=TestCommand, equipmentDiagGroup=equipmentDiagGroup, fpgaErrorEventEntry=fpgaErrorEventEntry, diskVolumeGroup=diskVolumeGroup, portDetectedMode=portDetectedMode, auditTotalFailedCount=auditTotalFailedCount, cardFpgaSource=cardFpgaSource, cmResetReason=cmResetReason, cardTestResultNotification=cardTestResultNotification, cardShelfId=cardShelfId, auditResult=auditResult, portDocsIfIndex=portDocsIfIndex, cardCarrierSerialNum=cardCarrierSerialNum, portDescription=portDescription, equipmentCardGroup=equipmentCardGroup, portDplxStatusChange=portDplxStatusChange, cadEquipmentMibConformance=cadEquipmentMibConformance, auditName=auditName, cardBusSpeed=cardBusSpeed, cardCarrierFwVersion=cardCarrierFwVersion, cardLastChangeTime=cardLastChangeTime, cardShelfTestIndex=cardShelfTestIndex, equipmentShelfGroup=equipmentShelfGroup, cardTestTransId=cardTestTransId, cardTemperatureHighWarn=cardTemperatureHighWarn)
