...
AdminState, CardId, PortId, DuplexStatus, EqActionType, SecondaryState, FlowControlMode, PrimaryState, PortType, UnknownState, CardSubType, PicType, ShelfId, CardType, FirmwareSource, PortMode, PortDetectedMode, DiskVolumeUsageLevel = mibBuilder.importSymbols("CADANT-TC", "AdminState", "CardId", "PortId", "DuplexStatus", "EqActionType", "SecondaryState", "FlowControlMode", "PrimaryState", "PortType", "UnknownState", "CardSubType", "PicType", "ShelfId", "CardType", "FirmwareSource", "PortMode", "PortDetectedMode", "DiskVolumeUsageLevel")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
Integer32, Bits, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, Gauge32, MibIdentifier, Counter32, Counter64, ModuleIdentity, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "Gauge32", "MibIdentifier", "Counter32", "Counter64", "ModuleIdentity", "NotificationType", "ObjectIdentity")
TimeStamp, TextualConvention, RowStatus, DisplayString, MacAddress, TruthValue, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString", "MacAddress", "TruthValue", "DateAndTime")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardCarrierHwVersion=cardCarrierHwVersion, diskVolumeCardId=diskVolumeCardId, errEvLoggingEnabled=errEvLoggingEnabled, trapCounter=trapCounter, TestId=TestId, cardTemperature=cardTemperature, cardDetected=cardDetected, portAction=portAction, equipmentDiagGroup=equipmentDiagGroup, TestScheduleCommand=TestScheduleCommand, cardAction=cardAction, portTrapInh=portTrapInh, auditShelfId=auditShelfId, cardShelfTestIndex=cardShelfTestIndex, shelfObjects=shelfObjects, cardDetectedChange=cardDetectedChange, portMacIfIndex=portMacIfIndex, diagTestId=diagTestId, portDocsIfIndex=portDocsIfIndex, fpgaErrorEventTable=fpgaErrorEventTable, portTxFlowControlDetected=portTxFlowControlDetected, equipmentCardTestGroup=equipmentCardTestGroup, cardBusSpeed=cardBusSpeed, diskVolumeFileName=diskVolumeFileName, portMode=portMode, auditFailedCount=auditFailedCount, cardNumPorts=cardNumPorts, auditEntry=auditEntry, cardSpareGroupId=cardSpareGroupId, portTxFlowControlMode=portTxFlowControlMode, cmResetStatus=cmResetStatus, cadEquipmentMibGroup=cadEquipmentMibGroup, cardEntry=cardEntry, cmVendor=cmVendor, systemGeneral=systemGeneral, cardRamSize=cardRamSize, portEntry=portEntry, cardTable=cardTable, portConnectorId=portConnectorId, cardSpareGroupMode=cardSpareGroupMode, cardTempNoReportNotification=cardTempNoReportNotification, cardSwVersion=cardSwVersion, diskVolumeGroup=diskVolumeGroup, TestTransactionId=TestTransactionId, auditResult=auditResult, cardLastBootSource=cardLastBootSource, equipmentState=equipmentState, auditName=auditName, cardFwUpdateStatus=cardFwUpdateStatus, equipmentTbl=equipmentTbl, portPrState=portPrState, diskVolumeUsagePercentage=diskVolumeUsagePercentage, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, equipmentStateGroup=equipmentStateGroup, cardTestId=cardTestId, portMinDsPower=portMinDsPower, diskVolumeName=diskVolumeName, shelfName=shelfName, auditId=auditId, portAdminState=portAdminState, fpgaErrorEventGroup=fpgaErrorEventGroup, cardType=cardType, portMaxDsPower=portMaxDsPower, auditCardId=auditCardId, TestCommand=TestCommand, TestType=TestType, portCardSubType=portCardSubType, errEventId=errEventId, trapSeverity=trapSeverity, cardDplxStatusChange=cardDplxStatusChange, equipmentPortGroup=equipmentPortGroup, cardSecState=cardSecState, cardTempOverHeatNotification=cardTempOverHeatNotification, cardFpgaSource=cardFpgaSource, portShelfId=portShelfId, auditTotalFailedCount=auditTotalFailedCount, cardShelfId=cardShelfId, portPrStateChange=portPrStateChange, fpgaErrorEventEntry=fpgaErrorEventEntry, cardLastResetReason=cardLastResetReason, portType=portType, downstreamPowerLoss=downstreamPowerLoss, diskVolumeTrapInh=diskVolumeTrapInh, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cmResetInfo=cmResetInfo, portCardId=portCardId, TestResult=TestResult, cardNumber=cardNumber, cadEquipmentMib=cadEquipmentMib, cardTestTime=cardTestTime, equipmentError=equipmentError, portSecStateChange=portSecStateChange, cardSerialNum=cardSerialNum, cardName=cardName, cmUChannelID=cmUChannelID, systemGeneralGroup=systemGeneralGroup, portBgpId=portBgpId, cardTrapInh=cardTrapInh, portId=portId, portRxFlowControlDetected=portRxFlowControlDetected, portRxFlowControlMode=portRxFlowControlMode, cardPicHwVersion=cardPicHwVersion, cmMacAddress=cmMacAddress, cardPicSerialNum=cardPicSerialNum, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, auditTotalPassedCount=auditTotalPassedCount, auditPassedCount=auditPassedCount, portNumber=portNumber, diskVolumeSize=diskVolumeSize, verboseLevel=verboseLevel, cmResetUpTime=cmResetUpTime, cardTestScheduleCommand=cardTestScheduleCommand, auditDescription=auditDescription, errEvRowStatus=errEvRowStatus, TestSchedule=TestSchedule, systemKey=systemKey, cmResetNotification=cmResetNotification, equipmentShelfGroup=equipmentShelfGroup, cmResetClearNotification=cmResetClearNotification, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, errEvLogLevel=errEvLogLevel, equipmentCardGroup=equipmentCardGroup, cardCpuSpeed=cardCpuSpeed, cardSubType=cardSubType, cardSubDetected=cardSubDetected, portDescription=portDescription, cardLastChangeTime=cardLastChangeTime, diskDriveNumber=diskDriveNumber, cardFlashSize=cardFlashSize, cardTestResult=cardTestResult, cadEquipmentMibCompliance=cadEquipmentMibCompliance, shelfNumber=shelfNumber, diskVolumeDiskSize=diskVolumeDiskSize, cardUpTime=cardUpTime, diskVolumeNumber=diskVolumeNumber, cardTestResultDesc=cardTestResultDesc, auditCommand=auditCommand, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, portMacAddress=portMacAddress, cardCpuType=cardCpuType, cmPrimarySID=cmPrimarySID, portSecState=portSecState, diskVolumeDriveId=diskVolumeDriveId, cadEquipmentMibConformance=cadEquipmentMibConformance, portNumChans=portNumChans, cardTestType=cardTestType, remainInDiagMode=remainInDiagMode, cardTestCommand=cardTestCommand, cardId=cardId, errEvRecoveryEnabled=errEvRecoveryEnabled, auditStatus=auditStatus, cardTemperatureHighError=cardTemperatureHighError, portLastChangeTime=portLastChangeTime, portDplxStatusChange=portDplxStatusChange, cardTestName=cardTestName, cmResetReason=cmResetReason, cardBootVersion=cardBootVersion, cardHwVersion=cardHwVersion, cardDplxStatus=cardDplxStatus, cardPicDetected=cardPicDetected, diskVolumeShelfId=diskVolumeShelfId, cardFwVersion=cardFwVersion, cmRegistrationNotification=cmRegistrationNotification, diskVolumeTable=diskVolumeTable, eqDiagConfig=eqDiagConfig, PYSNMP_MODULE_ID=cadEquipmentMib, portCurrDsPower=portCurrDsPower, diskVolumeUsageNotification=diskVolumeUsageNotification, auditAutoScheduling=auditAutoScheduling, portDetectedMode=portDetectedMode, auditTable=auditTable, equipmentTraps=equipmentTraps, equipmentAuditGroup=equipmentAuditGroup, cardCarrierSerialNum=cardCarrierSerialNum, portTable=portTable, cardSecStateChange=cardSecStateChange, cmDevice=cmDevice, cardCarrierFwVersion=cardCarrierFwVersion, cardAdminState=cardAdminState, equipmentAudit=equipmentAudit, auditLogThrottle=auditLogThrottle, cmIpAddress=cmIpAddress, systemClock=systemClock, consoleOutput=consoleOutput, auditCycleCount=auditCycleCount, cardTestDescription=cardTestDescription, cardTestTable=cardTestTable, cardTestEntry=cardTestEntry, equipmentDiag=equipmentDiag, cardTemperatureHighWarn=cardTemperatureHighWarn, portDplxStatus=portDplxStatus, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, diskVolumeId=diskVolumeId, cardTestTransId=cardTestTransId, auditLogOutput=auditLogOutput, cardCPLDVersion=cardCPLDVersion, shelfSwVersion=shelfSwVersion, cardLastBootVersion=cardLastBootVersion, diskVolumeEntry=diskVolumeEntry, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardTestIndex=cardTestIndex, cardTestSchedule=cardTestSchedule, cardPrStateChange=cardPrStateChange, auditTime=auditTime, cardTestResultNotification=cardTestResultNotification, cardPrState=cardPrState)
