...
CardType, ShelfId, PortDetectedMode, DiskVolumeUsageLevel, PicType, PrimaryState, PortMode, PortId, AdminState, DuplexStatus, CardId, PortType, CardSubType, FirmwareSource, EqActionType, SecondaryState, FlowControlMode, UnknownState = mibBuilder.importSymbols("CADANT-TC", "CardType", "ShelfId", "PortDetectedMode", "DiskVolumeUsageLevel", "PicType", "PrimaryState", "PortMode", "PortId", "AdminState", "DuplexStatus", "CardId", "PortType", "CardSubType", "FirmwareSource", "EqActionType", "SecondaryState", "FlowControlMode", "UnknownState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
iso, ModuleIdentity, IpAddress, Unsigned32, ObjectIdentity, Gauge32, MibIdentifier, NotificationType, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "IpAddress", "Unsigned32", "ObjectIdentity", "Gauge32", "MibIdentifier", "NotificationType", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "Counter32")
TimeStamp, DisplayString, MacAddress, TruthValue, DateAndTime, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "MacAddress", "TruthValue", "DateAndTime", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", remainInDiagMode=remainInDiagMode, consoleOutput=consoleOutput, portTable=portTable, auditEntry=auditEntry, portCurrDsPower=portCurrDsPower, cardTable=cardTable, auditTotalFailedCount=auditTotalFailedCount, portLastChangeTime=portLastChangeTime, TestCommand=TestCommand, equipmentAuditGroup=equipmentAuditGroup, diskVolumeNumber=diskVolumeNumber, cardFlashSize=cardFlashSize, diskVolumeGroup=diskVolumeGroup, errEventId=errEventId, cardSubDetected=cardSubDetected, cmResetClearNotification=cmResetClearNotification, portCardSubType=portCardSubType, portTrapInh=portTrapInh, trapSeverity=trapSeverity, cardTestDescription=cardTestDescription, cmPrimarySID=cmPrimarySID, portAction=portAction, cardAdminState=cardAdminState, portCardId=portCardId, cardTempOverHeatNotification=cardTempOverHeatNotification, cardLastResetReason=cardLastResetReason, auditCardId=auditCardId, portSecState=portSecState, cmResetStatus=cmResetStatus, cardSwVersion=cardSwVersion, portMacIfIndex=portMacIfIndex, portMacAddress=portMacAddress, cardTestResult=cardTestResult, cardNumber=cardNumber, portDocsIfIndex=portDocsIfIndex, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeFileName=diskVolumeFileName, cmResetNotification=cmResetNotification, auditTotalPassedCount=auditTotalPassedCount, cardDplxStatusChange=cardDplxStatusChange, cardTestTime=cardTestTime, diskVolumeName=diskVolumeName, errEvRowStatus=errEvRowStatus, equipmentStateGroup=equipmentStateGroup, cardSecState=cardSecState, cmMacAddress=cmMacAddress, cardId=cardId, TestId=TestId, cardTemperatureHighWarn=cardTemperatureHighWarn, auditTime=auditTime, cardTemperature=cardTemperature, portBgpId=portBgpId, errEvRecoveryEnabled=errEvRecoveryEnabled, cardCarrierHwVersion=cardCarrierHwVersion, portNumber=portNumber, cardTestResultNotification=cardTestResultNotification, cardShelfTestIndex=cardShelfTestIndex, cadEquipmentMibConformance=cadEquipmentMibConformance, portEntry=portEntry, systemKey=systemKey, cardPrState=cardPrState, TestScheduleCommand=TestScheduleCommand, cardTestTransId=cardTestTransId, cardPicSerialNum=cardPicSerialNum, trapCounter=trapCounter, portNumChans=portNumChans, cardDetectedChange=cardDetectedChange, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, systemClock=systemClock, diskVolumeCardId=diskVolumeCardId, cardLastBootVersion=cardLastBootVersion, auditAutoScheduling=auditAutoScheduling, cardLastChangeTime=cardLastChangeTime, cardTemperatureHighError=cardTemperatureHighError, equipmentShelfGroup=equipmentShelfGroup, diskDriveNumber=diskDriveNumber, portMode=portMode, portConnectorId=portConnectorId, equipmentPortGroup=equipmentPortGroup, equipmentTraps=equipmentTraps, cardSpareGroupId=cardSpareGroupId, systemGeneralGroup=systemGeneralGroup, cardTestType=cardTestType, portPrState=portPrState, diskVolumeSize=diskVolumeSize, cardAction=cardAction, portRxFlowControlDetected=portRxFlowControlDetected, cardUpTime=cardUpTime, cadEquipmentMib=cadEquipmentMib, portDescription=portDescription, diskVolumeDiskSize=diskVolumeDiskSize, portSecStateChange=portSecStateChange, auditPassedCount=auditPassedCount, cardCPLDVersion=cardCPLDVersion, cardTempNoReportNotification=cardTempNoReportNotification, diskVolumeShelfId=diskVolumeShelfId, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portMinDsPower=portMinDsPower, cardSecStateChange=cardSecStateChange, auditId=auditId, cmResetUpTime=cmResetUpTime, shelfName=shelfName, cardBusSpeed=cardBusSpeed, cardCarrierSerialNum=cardCarrierSerialNum, cardFwUpdateStatus=cardFwUpdateStatus, cardRamSize=cardRamSize, cardSubType=cardSubType, cardSpareGroupMode=cardSpareGroupMode, auditFailedCount=auditFailedCount, cardLastBootSource=cardLastBootSource, PYSNMP_MODULE_ID=cadEquipmentMib, diskVolumeId=diskVolumeId, errEvLogLevel=errEvLogLevel, downstreamPowerLoss=downstreamPowerLoss, TestSchedule=TestSchedule, auditStatus=auditStatus, cardCarrierFwVersion=cardCarrierFwVersion, systemGeneral=systemGeneral, portId=portId, diskVolumeEntry=diskVolumeEntry, cardDetected=cardDetected, portShelfId=portShelfId, cmDevice=cmDevice, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardName=cardName, portDplxStatus=portDplxStatus, cardPicHwVersion=cardPicHwVersion, cardTestEntry=cardTestEntry, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, fpgaErrorEventTable=fpgaErrorEventTable, cadEquipmentMibCompliances=cadEquipmentMibCompliances, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditCommand=auditCommand, fpgaErrorEventGroup=fpgaErrorEventGroup, auditResult=auditResult, equipmentState=equipmentState, cardTestTable=cardTestTable, portDplxStatusChange=portDplxStatusChange, TestType=TestType, auditName=auditName, equipmentTbl=equipmentTbl, auditLogThrottle=auditLogThrottle, TestResult=TestResult, cmResetReason=cmResetReason, cardTestName=cardTestName, cmVendor=cmVendor, cardEntry=cardEntry, cardBootVersion=cardBootVersion, shelfSwVersion=shelfSwVersion, portTxFlowControlMode=portTxFlowControlMode, diskVolumeDriveId=diskVolumeDriveId, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portRxFlowControlMode=portRxFlowControlMode, cardFwVersion=cardFwVersion, portPrStateChange=portPrStateChange, cardType=cardType, cardSerialNum=cardSerialNum, cadEquipmentMibGroup=cadEquipmentMibGroup, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardTestId=cardTestId, cardFpgaSource=cardFpgaSource, cardDplxStatus=cardDplxStatus, diskVolumeUsageLevel=diskVolumeUsageLevel, auditCycleCount=auditCycleCount, cardShelfId=cardShelfId, cardTestSchedule=cardTestSchedule, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardTrapInh=cardTrapInh, TestTransactionId=TestTransactionId, shelfNumber=shelfNumber, diskVolumeTable=diskVolumeTable, auditShelfId=auditShelfId, cardCpuType=cardCpuType, cmRegistrationNotification=cmRegistrationNotification, cardHwVersion=cardHwVersion, equipmentDiag=equipmentDiag, equipmentDiagGroup=equipmentDiagGroup, portTxFlowControlDetected=portTxFlowControlDetected, diagTestId=diagTestId, equipmentCardTestGroup=equipmentCardTestGroup, cardTestScheduleCommand=cardTestScheduleCommand, cardTestIndex=cardTestIndex, eqDiagConfig=eqDiagConfig, auditTable=auditTable, cardNumPorts=cardNumPorts, cardCpuSpeed=cardCpuSpeed, diskVolumeUsageNotification=diskVolumeUsageNotification, auditDescription=auditDescription, portType=portType, auditLogOutput=auditLogOutput, fpgaErrorEventEntry=fpgaErrorEventEntry, equipmentCardGroup=equipmentCardGroup, cardTestResultDesc=cardTestResultDesc, cardPicDetected=cardPicDetected, shelfObjects=shelfObjects, equipmentAudit=equipmentAudit, cardPrStateChange=cardPrStateChange, verboseLevel=verboseLevel, portMaxDsPower=portMaxDsPower, portDetectedMode=portDetectedMode, portAdminState=portAdminState, cmUChannelID=cmUChannelID, cmIpAddress=cmIpAddress, diskVolumeTrapInh=diskVolumeTrapInh, equipmentError=equipmentError, cmResetInfo=cmResetInfo, cardTestCommand=cardTestCommand)
