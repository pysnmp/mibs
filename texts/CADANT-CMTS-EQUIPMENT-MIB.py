...
DuplexStatus, PrimaryState, PortType, FirmwareSource, PortMode, SecondaryState, EqActionType, UnknownState, ShelfId, AdminState, FlowControlMode, CardType, DiskVolumeUsageLevel, CardSubType, CardId, PortId, PicType, PortDetectedMode = mibBuilder.importSymbols("CADANT-TC", "DuplexStatus", "PrimaryState", "PortType", "FirmwareSource", "PortMode", "SecondaryState", "EqActionType", "UnknownState", "ShelfId", "AdminState", "FlowControlMode", "CardType", "DiskVolumeUsageLevel", "CardSubType", "CardId", "PortId", "PicType", "PortDetectedMode")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
Unsigned32, IpAddress, NotificationType, Integer32, iso, TimeTicks, Gauge32, ModuleIdentity, ObjectIdentity, Bits, MibIdentifier, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "NotificationType", "Integer32", "iso", "TimeTicks", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Bits", "MibIdentifier", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cadEquipmentMib=cadEquipmentMib, remainInDiagMode=remainInDiagMode, downstreamPowerLoss=downstreamPowerLoss, auditTime=auditTime, portSecStateChange=portSecStateChange, equipmentTraps=equipmentTraps, auditLogThrottle=auditLogThrottle, diskVolumeId=diskVolumeId, diskVolumeUsageLevel=diskVolumeUsageLevel, portAction=portAction, cardAdminState=cardAdminState, errEvLogLevel=errEvLogLevel, diskDriveNumber=diskDriveNumber, cmMacAddress=cmMacAddress, TestId=TestId, equipmentDiagGroup=equipmentDiagGroup, cardHwVersion=cardHwVersion, cardTestTime=cardTestTime, portRxFlowControlMode=portRxFlowControlMode, portMaxDsPower=portMaxDsPower, portShelfId=portShelfId, cardDetected=cardDetected, cmResetClearNotification=cmResetClearNotification, cardFlashSize=cardFlashSize, cmIpAddress=cmIpAddress, cmResetUpTime=cmResetUpTime, TestCommand=TestCommand, consoleOutput=consoleOutput, cardTrapInh=cardTrapInh, portBgpId=portBgpId, cardTemperatureHighError=cardTemperatureHighError, cardUpTime=cardUpTime, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardSubType=cardSubType, equipmentCardGroup=equipmentCardGroup, shelfSwVersion=shelfSwVersion, cmResetReason=cmResetReason, systemClock=systemClock, systemGeneral=systemGeneral, cardSubDetected=cardSubDetected, portId=portId, cardShelfId=cardShelfId, cardCPLDVersion=cardCPLDVersion, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardDplxStatus=cardDplxStatus, cardDplxStatusChange=cardDplxStatusChange, cardSerialNum=cardSerialNum, auditShelfId=auditShelfId, diskVolumeDriveId=diskVolumeDriveId, cmResetInfo=cmResetInfo, errEvLoggingEnabled=errEvLoggingEnabled, cardCpuSpeed=cardCpuSpeed, cardNumPorts=cardNumPorts, diskVolumeFileName=diskVolumeFileName, portRxFlowControlDetected=portRxFlowControlDetected, portMacIfIndex=portMacIfIndex, errEvRecoveryEnabled=errEvRecoveryEnabled, errEvRowStatus=errEvRowStatus, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, equipmentError=equipmentError, cmResetStatus=cmResetStatus, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeEntry=diskVolumeEntry, portDplxStatus=portDplxStatus, cadEquipmentMibConformance=cadEquipmentMibConformance, cardDetectedChange=cardDetectedChange, portDplxStatusChange=portDplxStatusChange, cardTestScheduleCommand=cardTestScheduleCommand, equipmentDiag=equipmentDiag, portTxFlowControlMode=portTxFlowControlMode, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cmRegistrationNotification=cmRegistrationNotification, cardSwVersion=cardSwVersion, trapSeverity=trapSeverity, cardBusSpeed=cardBusSpeed, cardFwUpdateStatus=cardFwUpdateStatus, auditTotalPassedCount=auditTotalPassedCount, portDescription=portDescription, cardTestName=cardTestName, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portTable=portTable, fpgaErrorEventGroup=fpgaErrorEventGroup, cardSecState=cardSecState, cardCpuType=cardCpuType, equipmentState=equipmentState, cardFpgaSource=cardFpgaSource, diskVolumeTable=diskVolumeTable, diskVolumeShelfId=diskVolumeShelfId, shelfName=shelfName, cardTestResultNotification=cardTestResultNotification, portCurrDsPower=portCurrDsPower, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portDocsIfIndex=portDocsIfIndex, auditCardId=auditCardId, fpgaErrorEventTable=fpgaErrorEventTable, cardTempOverHeatNotification=cardTempOverHeatNotification, cmResetNotification=cmResetNotification, portNumChans=portNumChans, cardEntry=cardEntry, cardLastResetReason=cardLastResetReason, cardTestResultDesc=cardTestResultDesc, systemGeneralGroup=systemGeneralGroup, cardSpareGroupMode=cardSpareGroupMode, shelfNumber=shelfNumber, cmPrimarySID=cmPrimarySID, cardAction=cardAction, shelfObjects=shelfObjects, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTestType=cardTestType, portNumber=portNumber, cardTemperature=cardTemperature, auditCommand=auditCommand, auditFailedCount=auditFailedCount, portMinDsPower=portMinDsPower, cardTestDescription=cardTestDescription, cardTable=cardTable, cardLastChangeTime=cardLastChangeTime, portMode=portMode, portConnectorId=portConnectorId, verboseLevel=verboseLevel, TestScheduleCommand=TestScheduleCommand, cardTestTable=cardTestTable, cardTestTransId=cardTestTransId, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardCarrierHwVersion=cardCarrierHwVersion, cardNumber=cardNumber, PYSNMP_MODULE_ID=cadEquipmentMib, cardSpareGroupId=cardSpareGroupId, TestTransactionId=TestTransactionId, portSecState=portSecState, errEventId=errEventId, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, portTxFlowControlDetected=portTxFlowControlDetected, cardTestResult=cardTestResult, cardTemperatureHighWarn=cardTemperatureHighWarn, portAdminState=portAdminState, cardPrState=cardPrState, equipmentPortGroup=equipmentPortGroup, cardType=cardType, diskVolumeCardId=diskVolumeCardId, diskVolumeDiskSize=diskVolumeDiskSize, cardTestId=cardTestId, auditStatus=auditStatus, cardTestIndex=cardTestIndex, cardCarrierSerialNum=cardCarrierSerialNum, cmUChannelID=cmUChannelID, cardLastBootSource=cardLastBootSource, cmDevice=cmDevice, auditCycleCount=auditCycleCount, cardShelfTestIndex=cardShelfTestIndex, diagTestId=diagTestId, trapCounter=trapCounter, cardTestCommand=cardTestCommand, TestSchedule=TestSchedule, portPrState=portPrState, portDetectedMode=portDetectedMode, equipmentTbl=equipmentTbl, TestType=TestType, portLastChangeTime=portLastChangeTime, cadEquipmentMibGroup=cadEquipmentMibGroup, cardBootVersion=cardBootVersion, diskVolumeNumber=diskVolumeNumber, auditDescription=auditDescription, cardPrStateChange=cardPrStateChange, cardSecStateChange=cardSecStateChange, auditName=auditName, cardTestSchedule=cardTestSchedule, diskVolumeName=diskVolumeName, cardId=cardId, cardTestEntry=cardTestEntry, equipmentAuditGroup=equipmentAuditGroup, cardName=cardName, portMacAddress=portMacAddress, auditPassedCount=auditPassedCount, auditAutoScheduling=auditAutoScheduling, equipmentShelfGroup=equipmentShelfGroup, auditTable=auditTable, cardLastBootVersion=cardLastBootVersion, auditTotalFailedCount=auditTotalFailedCount, cardRamSize=cardRamSize, fpgaErrorEventEntry=fpgaErrorEventEntry, cardFwVersion=cardFwVersion, portType=portType, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diskVolumeSize=diskVolumeSize, cardPicHwVersion=cardPicHwVersion, equipmentStateGroup=equipmentStateGroup, cardPicSerialNum=cardPicSerialNum, equipmentCardTestGroup=equipmentCardTestGroup, cmVendor=cmVendor, auditLogOutput=auditLogOutput, portTrapInh=portTrapInh, systemKey=systemKey, portCardSubType=portCardSubType, diskVolumeTrapInh=diskVolumeTrapInh, eqDiagConfig=eqDiagConfig, equipmentAudit=equipmentAudit, diskVolumeGroup=diskVolumeGroup, auditEntry=auditEntry, TestResult=TestResult, cardPicDetected=cardPicDetected, auditResult=auditResult, auditId=auditId, cardTempNoReportNotification=cardTempNoReportNotification, portPrStateChange=portPrStateChange, portEntry=portEntry, portCardId=portCardId)
