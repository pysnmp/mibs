...
PrimaryState, CardType, ShelfId, EqActionType, CardSubType, FirmwareSource, PortDetectedMode, FlowControlMode, DiskVolumeUsageLevel, SecondaryState, UnknownState, PicType, DuplexStatus, CardId, PortMode, PortId, PortType, AdminState = mibBuilder.importSymbols("CADANT-TC", "PrimaryState", "CardType", "ShelfId", "EqActionType", "CardSubType", "FirmwareSource", "PortDetectedMode", "FlowControlMode", "DiskVolumeUsageLevel", "SecondaryState", "UnknownState", "PicType", "DuplexStatus", "CardId", "PortMode", "PortId", "PortType", "AdminState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, NotificationType, Bits, ObjectIdentity, Gauge32, Counter32, TimeTicks, Integer32, IpAddress, iso, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "NotificationType", "Bits", "ObjectIdentity", "Gauge32", "Counter32", "TimeTicks", "Integer32", "IpAddress", "iso", "MibIdentifier", "ModuleIdentity")
TextualConvention, DisplayString, TimeStamp, RowStatus, TruthValue, MacAddress, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TimeStamp", "RowStatus", "TruthValue", "MacAddress", "DateAndTime")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardFpgaSource=cardFpgaSource, cardDetectedChange=cardDetectedChange, cardName=cardName, cardSpareGroupMode=cardSpareGroupMode, cardPrState=cardPrState, auditTotalFailedCount=auditTotalFailedCount, equipmentShelfGroup=equipmentShelfGroup, portRxFlowControlDetected=portRxFlowControlDetected, cardTestTransId=cardTestTransId, auditPassedCount=auditPassedCount, cardTestSchedule=cardTestSchedule, cardTemperatureHighError=cardTemperatureHighError, cardAction=cardAction, portCardId=portCardId, cmDevice=cmDevice, cardAdminState=cardAdminState, equipmentState=equipmentState, portTable=portTable, TestId=TestId, cardNumber=cardNumber, diskVolumeEntry=diskVolumeEntry, cardPicSerialNum=cardPicSerialNum, cmResetNotification=cmResetNotification, portNumber=portNumber, equipmentTbl=equipmentTbl, cardTemperatureHighWarn=cardTemperatureHighWarn, portBgpId=portBgpId, cmResetStatus=cmResetStatus, auditLogThrottle=auditLogThrottle, cardPicHwVersion=cardPicHwVersion, cardHwVersion=cardHwVersion, downstreamPowerLoss=downstreamPowerLoss, portId=portId, errEvRecoveryEnabled=errEvRecoveryEnabled, cardSpareGroupId=cardSpareGroupId, diskVolumeCardId=diskVolumeCardId, diskVolumeShelfId=diskVolumeShelfId, portLastChangeTime=portLastChangeTime, cardTestResultDesc=cardTestResultDesc, cardPrStateChange=cardPrStateChange, cardCarrierFwVersion=cardCarrierFwVersion, TestType=TestType, portTxFlowControlDetected=portTxFlowControlDetected, portTxFlowControlMode=portTxFlowControlMode, cardTestScheduleCommand=cardTestScheduleCommand, auditShelfId=auditShelfId, TestTransactionId=TestTransactionId, cardCarrierHwVersion=cardCarrierHwVersion, auditDescription=auditDescription, cardLastChangeTime=cardLastChangeTime, diskVolumeTable=diskVolumeTable, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeNumber=diskVolumeNumber, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, cardLastResetReason=cardLastResetReason, cardPicDetected=cardPicDetected, TestCommand=TestCommand, cmVendor=cmVendor, cardDetected=cardDetected, cardTestTime=cardTestTime, portAdminState=portAdminState, portConnectorId=portConnectorId, verboseLevel=verboseLevel, cardTestType=cardTestType, cardType=cardType, fpgaErrorEventGroup=fpgaErrorEventGroup, auditEntry=auditEntry, cardLastBootSource=cardLastBootSource, consoleOutput=consoleOutput, systemKey=systemKey, cardTrapInh=cardTrapInh, auditTable=auditTable, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cardSubDetected=cardSubDetected, TestResult=TestResult, cadEquipmentMibGroup=cadEquipmentMibGroup, cardTestResult=cardTestResult, cardSwVersion=cardSwVersion, PYSNMP_MODULE_ID=cadEquipmentMib, portAction=portAction, cardCPLDVersion=cardCPLDVersion, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portShelfId=portShelfId, cardSerialNum=cardSerialNum, cardShelfTestIndex=cardShelfTestIndex, cardCarrierSerialNum=cardCarrierSerialNum, cardUpTime=cardUpTime, diskVolumeName=diskVolumeName, auditLogOutput=auditLogOutput, cardTempOverHeatNotification=cardTempOverHeatNotification, portSecStateChange=portSecStateChange, auditCardId=auditCardId, auditCycleCount=auditCycleCount, cardTestIndex=cardTestIndex, cardShelfId=cardShelfId, cardBusSpeed=cardBusSpeed, auditFailedCount=auditFailedCount, TestSchedule=TestSchedule, cardCpuType=cardCpuType, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, auditCommand=auditCommand, cardNumPorts=cardNumPorts, systemGeneral=systemGeneral, portEntry=portEntry, equipmentAuditGroup=equipmentAuditGroup, cardId=cardId, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, portDocsIfIndex=portDocsIfIndex, portNumChans=portNumChans, cardFwVersion=cardFwVersion, cardSecState=cardSecState, cardFwUpdateStatus=cardFwUpdateStatus, equipmentError=equipmentError, cardTestResultNotification=cardTestResultNotification, cardSecStateChange=cardSecStateChange, auditAutoScheduling=auditAutoScheduling, cardDplxStatusChange=cardDplxStatusChange, diskDriveNumber=diskDriveNumber, portMacIfIndex=portMacIfIndex, portType=portType, equipmentAudit=equipmentAudit, diskVolumeUsageNotification=diskVolumeUsageNotification, errEvLogLevel=errEvLogLevel, cardRamSize=cardRamSize, diskVolumeSize=diskVolumeSize, portSecState=portSecState, cardTestTable=cardTestTable, systemClock=systemClock, cardDplxStatus=cardDplxStatus, portMaxDsPower=portMaxDsPower, trapCounter=trapCounter, cardTestName=cardTestName, systemGeneralGroup=systemGeneralGroup, auditId=auditId, portDetectedMode=portDetectedMode, portTrapInh=portTrapInh, cmResetClearNotification=cmResetClearNotification, portMinDsPower=portMinDsPower, trapSeverity=trapSeverity, diskVolumeDriveId=diskVolumeDriveId, cmPrimarySID=cmPrimarySID, cmResetUpTime=cmResetUpTime, errEventId=errEventId, cmMacAddress=cmMacAddress, diskVolumeTrapInh=diskVolumeTrapInh, eqDiagConfig=eqDiagConfig, portMacAddress=portMacAddress, equipmentCardTestGroup=equipmentCardTestGroup, fpgaErrorEventEntry=fpgaErrorEventEntry, cmResetReason=cmResetReason, shelfName=shelfName, cardTempNoReportNotification=cardTempNoReportNotification, equipmentDiag=equipmentDiag, equipmentCardGroup=equipmentCardGroup, cardCpuSpeed=cardCpuSpeed, cardTestEntry=cardTestEntry, portPrStateChange=portPrStateChange, diskVolumeDiskSize=diskVolumeDiskSize, portDescription=portDescription, diagTestId=diagTestId, fpgaErrorEventTable=fpgaErrorEventTable, auditStatus=auditStatus, cmResetInfo=cmResetInfo, cmUChannelID=cmUChannelID, portPrState=portPrState, equipmentPortGroup=equipmentPortGroup, portCurrDsPower=portCurrDsPower, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardTestId=cardTestId, equipmentDiagGroup=equipmentDiagGroup, cardLastBootVersion=cardLastBootVersion, portRxFlowControlMode=portRxFlowControlMode, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cmIpAddress=cmIpAddress, TestScheduleCommand=TestScheduleCommand, shelfSwVersion=shelfSwVersion, portDplxStatus=portDplxStatus, auditResult=auditResult, remainInDiagMode=remainInDiagMode, cardBootVersion=cardBootVersion, errEvLoggingEnabled=errEvLoggingEnabled, shelfNumber=shelfNumber, shelfObjects=shelfObjects, cmRegistrationNotification=cmRegistrationNotification, cardTestDescription=cardTestDescription, cardTable=cardTable, cadEquipmentMibConformance=cadEquipmentMibConformance, cardSubType=cardSubType, auditName=auditName, portCardSubType=portCardSubType, cardEntry=cardEntry, diskVolumeFileName=diskVolumeFileName, portMode=portMode, equipmentStateGroup=equipmentStateGroup, diskVolumeId=diskVolumeId, cadEquipmentMib=cadEquipmentMib, errEvRowStatus=errEvRowStatus, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardTemperature=cardTemperature, cardFlashSize=cardFlashSize, auditTotalPassedCount=auditTotalPassedCount, portDplxStatusChange=portDplxStatusChange, cardTestCommand=cardTestCommand, auditTime=auditTime, diskVolumeGroup=diskVolumeGroup, equipmentTraps=equipmentTraps, cadEquipmentMibCompliances=cadEquipmentMibCompliances)
