...
DuplexStatus, SecondaryState, EqActionType, FlowControlMode, CardId, PicType, ShelfId, DiskVolumeUsageLevel, CardSubType, AdminState, FirmwareSource, PortId, PortDetectedMode, PrimaryState, CardType, PortMode, UnknownState, PortType = mibBuilder.importSymbols("CADANT-TC", "DuplexStatus", "SecondaryState", "EqActionType", "FlowControlMode", "CardId", "PicType", "ShelfId", "DiskVolumeUsageLevel", "CardSubType", "AdminState", "FirmwareSource", "PortId", "PortDetectedMode", "PrimaryState", "CardType", "PortMode", "UnknownState", "PortType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ModuleCompliance, NotificationGroup, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup", "ObjectGroup")
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Gauge32, Bits, Counter32, NotificationType, Integer32, Unsigned32, iso, Counter64, ObjectIdentity, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Gauge32", "Bits", "Counter32", "NotificationType", "Integer32", "Unsigned32", "iso", "Counter64", "ObjectIdentity", "MibIdentifier", "ModuleIdentity")
RowStatus, TimeStamp, TextualConvention, DisplayString, DateAndTime, MacAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TextualConvention", "DisplayString", "DateAndTime", "MacAddress", "TruthValue")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardTestIndex=cardTestIndex, equipmentAudit=equipmentAudit, shelfNumber=shelfNumber, cmVendor=cmVendor, portDetectedMode=portDetectedMode, systemClock=systemClock, cardBusSpeed=cardBusSpeed, portId=portId, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, equipmentError=equipmentError, portMinDsPower=portMinDsPower, errEvRecoveryEnabled=errEvRecoveryEnabled, fpgaErrorEventEntry=fpgaErrorEventEntry, portNumChans=portNumChans, cardCarrierSerialNum=cardCarrierSerialNum, cardPicHwVersion=cardPicHwVersion, verboseLevel=verboseLevel, portRxFlowControlDetected=portRxFlowControlDetected, diskVolumeName=diskVolumeName, cardTestType=cardTestType, cardPrStateChange=cardPrStateChange, equipmentCardGroup=equipmentCardGroup, cardTrapInh=cardTrapInh, portMacAddress=portMacAddress, cadEquipmentMib=cadEquipmentMib, auditCommand=auditCommand, cardFpgaSource=cardFpgaSource, portSecState=portSecState, portConnectorId=portConnectorId, diskVolumeNumber=diskVolumeNumber, diskVolumeTrapInh=diskVolumeTrapInh, cmUChannelID=cmUChannelID, remainInDiagMode=remainInDiagMode, cardEntry=cardEntry, cardTestTable=cardTestTable, cardTable=cardTable, cardBootVersion=cardBootVersion, portTxFlowControlDetected=portTxFlowControlDetected, portPrState=portPrState, diskVolumeUsageLevel=diskVolumeUsageLevel, equipmentStateGroup=equipmentStateGroup, auditShelfId=auditShelfId, diskVolumeCardId=diskVolumeCardId, portDescription=portDescription, cardTestId=cardTestId, cardDetectedChange=cardDetectedChange, errEvRowStatus=errEvRowStatus, diskVolumeTable=diskVolumeTable, shelfSwVersion=shelfSwVersion, cardId=cardId, portBgpId=portBgpId, cardTestResult=cardTestResult, cardTestName=cardTestName, cmDevice=cmDevice, cardTestResultNotification=cardTestResultNotification, cardAction=cardAction, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, diskVolumeGroup=diskVolumeGroup, cardCpuSpeed=cardCpuSpeed, errEvLogLevel=errEvLogLevel, cardAdminState=cardAdminState, equipmentShelfGroup=equipmentShelfGroup, portTrapInh=portTrapInh, equipmentState=equipmentState, cadEquipmentMibGroup=cadEquipmentMibGroup, cmPrimarySID=cmPrimarySID, cardCPLDVersion=cardCPLDVersion, TestTransactionId=TestTransactionId, consoleOutput=consoleOutput, portTxFlowControlMode=portTxFlowControlMode, diskVolumeDriveId=diskVolumeDriveId, diskVolumeUsagePercentage=diskVolumeUsagePercentage, trapSeverity=trapSeverity, portDplxStatusChange=portDplxStatusChange, auditName=auditName, cardSpareGroupId=cardSpareGroupId, equipmentCardTestGroup=equipmentCardTestGroup, auditDescription=auditDescription, systemGeneral=systemGeneral, cardTestResultDesc=cardTestResultDesc, diskVolumeUsageNotification=diskVolumeUsageNotification, cardTestTime=cardTestTime, TestResult=TestResult, equipmentTraps=equipmentTraps, portDocsIfIndex=portDocsIfIndex, portSecStateChange=portSecStateChange, portCardSubType=portCardSubType, cardDplxStatusChange=cardDplxStatusChange, equipmentDiagGroup=equipmentDiagGroup, portMaxDsPower=portMaxDsPower, auditPassedCount=auditPassedCount, cardLastBootSource=cardLastBootSource, cardFwUpdateStatus=cardFwUpdateStatus, cardShelfId=cardShelfId, cmResetReason=cmResetReason, PYSNMP_MODULE_ID=cadEquipmentMib, portLastChangeTime=portLastChangeTime, portCardId=portCardId, shelfName=shelfName, cardTestDescription=cardTestDescription, auditResult=auditResult, cardSerialNum=cardSerialNum, auditEntry=auditEntry, cmResetClearNotification=cmResetClearNotification, cardTemperatureHighError=cardTemperatureHighError, cardTempOverHeatNotification=cardTempOverHeatNotification, diskVolumeId=diskVolumeId, portShelfId=portShelfId, cmMacAddress=cmMacAddress, cardLastChangeTime=cardLastChangeTime, downstreamPowerLoss=downstreamPowerLoss, cardTestScheduleCommand=cardTestScheduleCommand, cmRegistrationNotification=cmRegistrationNotification, cardShelfTestIndex=cardShelfTestIndex, systemKey=systemKey, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardCpuType=cardCpuType, cardTestTransId=cardTestTransId, cardSecStateChange=cardSecStateChange, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cmResetStatus=cmResetStatus, TestCommand=TestCommand, diskVolumeFileName=diskVolumeFileName, TestType=TestType, cardSpareGroupMode=cardSpareGroupMode, cmIpAddress=cmIpAddress, cardFwVersion=cardFwVersion, auditCardId=auditCardId, diagTestId=diagTestId, cardNumPorts=cardNumPorts, portNumber=portNumber, errEventId=errEventId, cardHwVersion=cardHwVersion, portMacIfIndex=portMacIfIndex, diskVolumeSize=diskVolumeSize, portTable=portTable, cardName=cardName, portDplxStatus=portDplxStatus, cardCarrierFwVersion=cardCarrierFwVersion, cardTemperatureHighWarn=cardTemperatureHighWarn, auditTotalPassedCount=auditTotalPassedCount, fpgaErrorEventGroup=fpgaErrorEventGroup, portAction=portAction, auditCycleCount=auditCycleCount, equipmentDiag=equipmentDiag, diskVolumeEntry=diskVolumeEntry, cadEquipmentMibCompliance=cadEquipmentMibCompliance, portAdminState=portAdminState, cardRamSize=cardRamSize, TestSchedule=TestSchedule, portCurrDsPower=portCurrDsPower, cardSubDetected=cardSubDetected, cardSecState=cardSecState, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardPrState=cardPrState, cardTestEntry=cardTestEntry, auditTotalFailedCount=auditTotalFailedCount, cmResetNotification=cmResetNotification, portMode=portMode, cardTempNoReportNotification=cardTempNoReportNotification, diskVolumeDiskSize=diskVolumeDiskSize, cardLastBootVersion=cardLastBootVersion, auditStatus=auditStatus, portType=portType, cardNumber=cardNumber, cardPicSerialNum=cardPicSerialNum, portRxFlowControlMode=portRxFlowControlMode, cardType=cardType, portEntry=portEntry, diskVolumeShelfId=diskVolumeShelfId, cardUpTime=cardUpTime, cardSwVersion=cardSwVersion, cardLastResetReason=cardLastResetReason, cardFlashSize=cardFlashSize, TestScheduleCommand=TestScheduleCommand, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardTemperature=cardTemperature, trapCounter=trapCounter, cardTestCommand=cardTestCommand, auditId=auditId, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cmResetUpTime=cmResetUpTime, shelfObjects=shelfObjects, cardTestSchedule=cardTestSchedule, equipmentTbl=equipmentTbl, cardCarrierHwVersion=cardCarrierHwVersion, cardSubType=cardSubType, eqDiagConfig=eqDiagConfig, auditTime=auditTime, equipmentPortGroup=equipmentPortGroup, TestId=TestId, cmResetInfo=cmResetInfo, auditTable=auditTable, cardPicDetected=cardPicDetected, cardDetected=cardDetected, fpgaErrorEventTable=fpgaErrorEventTable, errEvLoggingEnabled=errEvLoggingEnabled, systemGeneralGroup=systemGeneralGroup, cadEquipmentMibConformance=cadEquipmentMibConformance, diskDriveNumber=diskDriveNumber, portPrStateChange=portPrStateChange, auditAutoScheduling=auditAutoScheduling, auditLogOutput=auditLogOutput, equipmentAuditGroup=equipmentAuditGroup, cardDplxStatus=cardDplxStatus, auditLogThrottle=auditLogThrottle, auditFailedCount=auditFailedCount)
