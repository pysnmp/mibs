...
PortId, PortDetectedMode, PortMode, UnknownState, EqActionType, CardSubType, PicType, CardType, CardId, DiskVolumeUsageLevel, FlowControlMode, PrimaryState, ShelfId, SecondaryState, AdminState, FirmwareSource, PortType, DuplexStatus = mibBuilder.importSymbols("CADANT-TC", "PortId", "PortDetectedMode", "PortMode", "UnknownState", "EqActionType", "CardSubType", "PicType", "CardType", "CardId", "DiskVolumeUsageLevel", "FlowControlMode", "PrimaryState", "ShelfId", "SecondaryState", "AdminState", "FirmwareSource", "PortType", "DuplexStatus")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "NotificationGroup", "ModuleCompliance")
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Counter64, TimeTicks, NotificationType, ModuleIdentity, Integer32, iso, ObjectIdentity, Gauge32, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Counter64", "TimeTicks", "NotificationType", "ModuleIdentity", "Integer32", "iso", "ObjectIdentity", "Gauge32", "IpAddress", "Counter32")
DateAndTime, RowStatus, MacAddress, TextualConvention, TimeStamp, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "RowStatus", "MacAddress", "TextualConvention", "TimeStamp", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardHwVersion=cardHwVersion, cardBootVersion=cardBootVersion, cardTable=cardTable, cmRegistrationNotification=cmRegistrationNotification, auditLogThrottle=auditLogThrottle, portTxFlowControlMode=portTxFlowControlMode, cardRamSize=cardRamSize, cmResetNotification=cmResetNotification, portNumber=portNumber, cardTestTime=cardTestTime, portAction=portAction, cardDetected=cardDetected, eqDiagConfig=eqDiagConfig, cardFwVersion=cardFwVersion, auditTotalFailedCount=auditTotalFailedCount, cardTempNoReportNotification=cardTempNoReportNotification, portShelfId=portShelfId, auditFailedCount=auditFailedCount, cmDevice=cmDevice, errEventId=errEventId, cardShelfId=cardShelfId, shelfObjects=shelfObjects, diskVolumeGroup=diskVolumeGroup, auditStatus=auditStatus, cmUChannelID=cmUChannelID, cardCpuType=cardCpuType, TestCommand=TestCommand, cmResetReason=cmResetReason, diskVolumeTrapInh=diskVolumeTrapInh, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, cardFpgaSource=cardFpgaSource, systemGeneral=systemGeneral, diskVolumeNumber=diskVolumeNumber, cardCpuSpeed=cardCpuSpeed, portBgpId=portBgpId, cardShelfTestIndex=cardShelfTestIndex, diskVolumeId=diskVolumeId, cardTestType=cardTestType, cardPrState=cardPrState, cardCPLDVersion=cardCPLDVersion, fpgaErrorEventEntry=fpgaErrorEventEntry, portType=portType, portSecStateChange=portSecStateChange, cardSubDetected=cardSubDetected, equipmentState=equipmentState, portMaxDsPower=portMaxDsPower, diskVolumeDriveId=diskVolumeDriveId, cmResetStatus=cmResetStatus, shelfNumber=shelfNumber, diskDriveNumber=diskDriveNumber, TestScheduleCommand=TestScheduleCommand, cardSpareGroupMode=cardSpareGroupMode, portTrapInh=portTrapInh, cmResetInfo=cmResetInfo, portCurrDsPower=portCurrDsPower, cadEquipmentMibCompliances=cadEquipmentMibCompliances, portEntry=portEntry, cardCarrierHwVersion=cardCarrierHwVersion, errEvRowStatus=errEvRowStatus, auditCardId=auditCardId, portMode=portMode, cardPicSerialNum=cardPicSerialNum, cardDplxStatus=cardDplxStatus, portTxFlowControlDetected=portTxFlowControlDetected, cardBusSpeed=cardBusSpeed, cardSecState=cardSecState, cardFwUpdateStatus=cardFwUpdateStatus, cardPicDetected=cardPicDetected, cardSubType=cardSubType, cardTemperatureHighWarn=cardTemperatureHighWarn, portPrState=portPrState, portMinDsPower=portMinDsPower, auditResult=auditResult, cardSecStateChange=cardSecStateChange, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardName=cardName, cardId=cardId, auditTable=auditTable, cmPrimarySID=cmPrimarySID, auditCommand=auditCommand, auditPassedCount=auditPassedCount, cadEquipmentMibGroup=cadEquipmentMibGroup, shelfSwVersion=shelfSwVersion, auditDescription=auditDescription, systemClock=systemClock, TestSchedule=TestSchedule, diskVolumeShelfId=diskVolumeShelfId, cardTestId=cardTestId, cmIpAddress=cmIpAddress, cardPicHwVersion=cardPicHwVersion, PYSNMP_MODULE_ID=cadEquipmentMib, cardTemperature=cardTemperature, cardDplxStatusChange=cardDplxStatusChange, cardTestIndex=cardTestIndex, cardTestResultNotification=cardTestResultNotification, remainInDiagMode=remainInDiagMode, cadEquipmentMibCompliance=cadEquipmentMibCompliance, auditName=auditName, equipmentDiagGroup=equipmentDiagGroup, cardPrStateChange=cardPrStateChange, portMacIfIndex=portMacIfIndex, cardTestResult=cardTestResult, equipmentCardGroup=equipmentCardGroup, cardTempOverHeatNotification=cardTempOverHeatNotification, auditEntry=auditEntry, systemGeneralGroup=systemGeneralGroup, equipmentTbl=equipmentTbl, cardTestDescription=cardTestDescription, cardAdminState=cardAdminState, verboseLevel=verboseLevel, TestType=TestType, equipmentTraps=equipmentTraps, portDplxStatusChange=portDplxStatusChange, downstreamPowerLoss=downstreamPowerLoss, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, portConnectorId=portConnectorId, cardTestTable=cardTestTable, cardTestName=cardTestName, cardLastResetReason=cardLastResetReason, diagTestId=diagTestId, errEvRecoveryEnabled=errEvRecoveryEnabled, cadEquipmentMibConformance=cadEquipmentMibConformance, diskVolumeSize=diskVolumeSize, cardNumber=cardNumber, auditShelfId=auditShelfId, portRxFlowControlDetected=portRxFlowControlDetected, cardTestResultDesc=cardTestResultDesc, TestId=TestId, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, diskVolumeName=diskVolumeName, auditTime=auditTime, cardFlashSize=cardFlashSize, cardSwVersion=cardSwVersion, diskVolumeUsageNotification=diskVolumeUsageNotification, cardNumPorts=cardNumPorts, equipmentPortGroup=equipmentPortGroup, TestTransactionId=TestTransactionId, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, cardCarrierSerialNum=cardCarrierSerialNum, cardCarrierFwVersion=cardCarrierFwVersion, portCardSubType=portCardSubType, portTable=portTable, portDplxStatus=portDplxStatus, diskVolumeFileName=diskVolumeFileName, cardTestTransId=cardTestTransId, systemKey=systemKey, cardTestSchedule=cardTestSchedule, fpgaErrorEventTable=fpgaErrorEventTable, trapCounter=trapCounter, equipmentStateGroup=equipmentStateGroup, portNumChans=portNumChans, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, equipmentDiag=equipmentDiag, portAdminState=portAdminState, cadEquipmentMib=cadEquipmentMib, cmMacAddress=cmMacAddress, cardLastChangeTime=cardLastChangeTime, diskVolumeEntry=diskVolumeEntry, portLastChangeTime=portLastChangeTime, cardSerialNum=cardSerialNum, consoleOutput=consoleOutput, cardTestEntry=cardTestEntry, cardSpareGroupId=cardSpareGroupId, diskVolumeUsageLevel=diskVolumeUsageLevel, portSecState=portSecState, portCardId=portCardId, diskVolumeCardId=diskVolumeCardId, portDocsIfIndex=portDocsIfIndex, cmResetUpTime=cmResetUpTime, auditId=auditId, diskVolumeTable=diskVolumeTable, portMacAddress=portMacAddress, TestResult=TestResult, equipmentAuditGroup=equipmentAuditGroup, auditAutoScheduling=auditAutoScheduling, cardTemperatureHighError=cardTemperatureHighError, cardEntry=cardEntry, auditTotalPassedCount=auditTotalPassedCount, equipmentAudit=equipmentAudit, errEvLoggingEnabled=errEvLoggingEnabled, portId=portId, cardAction=cardAction, diskVolumeUsagePercentage=diskVolumeUsagePercentage, equipmentError=equipmentError, cardLastBootVersion=cardLastBootVersion, portDescription=portDescription, cmResetClearNotification=cmResetClearNotification, shelfName=shelfName, cardDetectedChange=cardDetectedChange, diskVolumeDiskSize=diskVolumeDiskSize, auditCycleCount=auditCycleCount, portPrStateChange=portPrStateChange, fpgaErrorEventGroup=fpgaErrorEventGroup, auditLogOutput=auditLogOutput, cardUpTime=cardUpTime, portDetectedMode=portDetectedMode, errEvLogLevel=errEvLogLevel, equipmentShelfGroup=equipmentShelfGroup, cardTrapInh=cardTrapInh, portRxFlowControlMode=portRxFlowControlMode, cmVendor=cmVendor, cardType=cardType, cardTestScheduleCommand=cardTestScheduleCommand, trapSeverity=trapSeverity, cardTestCommand=cardTestCommand, equipmentCardTestGroup=equipmentCardTestGroup, cardLastBootSource=cardLastBootSource)
