...
DuplexStatus, AdminState, FirmwareSource, EqActionType, PortType, FlowControlMode, PortMode, PortDetectedMode, SecondaryState, ShelfId, UnknownState, CardType, PortId, PicType, DiskVolumeUsageLevel, PrimaryState, CardId, CardSubType = mibBuilder.importSymbols("CADANT-TC", "DuplexStatus", "AdminState", "FirmwareSource", "EqActionType", "PortType", "FlowControlMode", "PortMode", "PortDetectedMode", "SecondaryState", "ShelfId", "UnknownState", "CardType", "PortId", "PicType", "DiskVolumeUsageLevel", "PrimaryState", "CardId", "CardSubType")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
Unsigned32, Bits, Gauge32, Counter64, Counter32, ObjectIdentity, MibIdentifier, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "Gauge32", "Counter64", "Counter32", "ObjectIdentity", "MibIdentifier", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ModuleIdentity", "NotificationType")
TextualConvention, RowStatus, DisplayString, TimeStamp, TruthValue, MacAddress, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "DisplayString", "TimeStamp", "TruthValue", "MacAddress", "DateAndTime")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", cardTempOverHeatNotification=cardTempOverHeatNotification, cardTestCommand=cardTestCommand, cardTestName=cardTestName, auditAutoScheduling=auditAutoScheduling, portCardSubType=portCardSubType, diskVolumeSize=diskVolumeSize, cardCarrierSerialNum=cardCarrierSerialNum, portRxFlowControlDetected=portRxFlowControlDetected, cardDplxStatusChange=cardDplxStatusChange, cardTestResultNotification=cardTestResultNotification, equipmentCardTestGroup=equipmentCardTestGroup, TestId=TestId, cardLastBootVersion=cardLastBootVersion, cardLastResetReason=cardLastResetReason, cmUChannelID=cmUChannelID, portRxFlowControlMode=portRxFlowControlMode, portNumber=portNumber, cardTestScheduleCommand=cardTestScheduleCommand, eqDiagConfig=eqDiagConfig, portMode=portMode, equipmentDiagGroup=equipmentDiagGroup, downstreamPowerLoss=downstreamPowerLoss, equipmentPortGroup=equipmentPortGroup, equipmentShelfGroup=equipmentShelfGroup, diskDriveNumber=diskDriveNumber, cardLastBootSource=cardLastBootSource, equipmentDiag=equipmentDiag, equipmentAudit=equipmentAudit, cadEquipmentMibCompliance=cadEquipmentMibCompliance, diskVolumeUsageNotification=diskVolumeUsageNotification, cadEquipmentMibConformance=cadEquipmentMibConformance, cardSecStateChange=cardSecStateChange, cardTestIndex=cardTestIndex, auditResult=auditResult, cardTestDescription=cardTestDescription, auditPassedCount=auditPassedCount, cardDetected=cardDetected, cmDevice=cmDevice, portLastChangeTime=portLastChangeTime, cardPicDetected=cardPicDetected, portNumChans=portNumChans, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, auditTable=auditTable, cardTestResult=cardTestResult, cardDplxStatus=cardDplxStatus, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, TestSchedule=TestSchedule, cardTemperatureHighWarn=cardTemperatureHighWarn, TestTransactionId=TestTransactionId, diskVolumeNumber=diskVolumeNumber, cmResetReason=cmResetReason, cardShelfId=cardShelfId, cmResetClearNotification=cmResetClearNotification, portTable=portTable, cmPrimarySID=cmPrimarySID, cardFwUpdateStatus=cardFwUpdateStatus, portMacIfIndex=portMacIfIndex, portMaxDsPower=portMaxDsPower, cardNumber=cardNumber, cardDetectedChange=cardDetectedChange, portAction=portAction, diskVolumeCardId=diskVolumeCardId, auditCycleCount=auditCycleCount, portDplxStatus=portDplxStatus, errEvLogLevel=errEvLogLevel, auditTotalFailedCount=auditTotalFailedCount, cmResetInfo=cmResetInfo, cardTemperature=cardTemperature, cmRegistrationNotification=cmRegistrationNotification, portBgpId=portBgpId, auditLogThrottle=auditLogThrottle, trapSeverity=trapSeverity, portType=portType, diskVolumeDriveId=diskVolumeDriveId, auditCardId=auditCardId, cardTable=cardTable, portDescription=portDescription, diskVolumeUsagePercentage=diskVolumeUsagePercentage, auditTime=auditTime, cadEquipmentMibGroup=cadEquipmentMibGroup, cardBootVersion=cardBootVersion, errEvRowStatus=errEvRowStatus, cardCpuType=cardCpuType, cardCarrierFwVersion=cardCarrierFwVersion, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, fpgaErrorEventEntry=fpgaErrorEventEntry, equipmentTraps=equipmentTraps, equipmentError=equipmentError, portSecStateChange=portSecStateChange, cardPicHwVersion=cardPicHwVersion, cardCpuSpeed=cardCpuSpeed, cardShelfTestIndex=cardShelfTestIndex, systemGeneralGroup=systemGeneralGroup, cardTestTransId=cardTestTransId, cmResetStatus=cmResetStatus, shelfSwVersion=shelfSwVersion, cmMacAddress=cmMacAddress, cardSecState=cardSecState, equipmentState=equipmentState, equipmentTbl=equipmentTbl, diagTestId=diagTestId, cardAction=cardAction, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, TestType=TestType, portPrStateChange=portPrStateChange, cardPrState=cardPrState, systemClock=systemClock, cadEquipmentMib=cadEquipmentMib, auditTotalPassedCount=auditTotalPassedCount, portTxFlowControlDetected=portTxFlowControlDetected, auditName=auditName, TestCommand=TestCommand, equipmentCardGroup=equipmentCardGroup, cardFwVersion=cardFwVersion, auditEntry=auditEntry, systemKey=systemKey, shelfName=shelfName, cardSerialNum=cardSerialNum, diskVolumeUsageLevel=diskVolumeUsageLevel, auditDescription=auditDescription, cardFpgaSource=cardFpgaSource, diskVolumeGroup=diskVolumeGroup, cardNumPorts=cardNumPorts, portEntry=portEntry, diskVolumeId=diskVolumeId, portShelfId=portShelfId, errEvLoggingEnabled=errEvLoggingEnabled, cardPicSerialNum=cardPicSerialNum, portTrapInh=portTrapInh, auditId=auditId, cardId=cardId, diskVolumeTrapInh=diskVolumeTrapInh, portPrState=portPrState, cardFlashSize=cardFlashSize, cardTestSchedule=cardTestSchedule, portDplxStatusChange=portDplxStatusChange, cardName=cardName, portAdminState=portAdminState, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cmIpAddress=cmIpAddress, errEventId=errEventId, TestResult=TestResult, verboseLevel=verboseLevel, diskVolumeTable=diskVolumeTable, cardType=cardType, diskVolumeShelfId=diskVolumeShelfId, cardTempNoReportNotification=cardTempNoReportNotification, cardSpareGroupId=cardSpareGroupId, auditCommand=auditCommand, portMinDsPower=portMinDsPower, cmVendor=cmVendor, trapCounter=trapCounter, cmResetNotification=cmResetNotification, PYSNMP_MODULE_ID=cadEquipmentMib, cardBusSpeed=cardBusSpeed, diskVolumeName=diskVolumeName, cardTestType=cardTestType, fpgaErrorEventTable=fpgaErrorEventTable, cardLastChangeTime=cardLastChangeTime, cardEntry=cardEntry, diskVolumeEntry=diskVolumeEntry, cardRamSize=cardRamSize, equipmentAuditGroup=equipmentAuditGroup, cardUpTime=cardUpTime, cardHwVersion=cardHwVersion, cardSubDetected=cardSubDetected, portCardId=portCardId, diskVolumeFileName=diskVolumeFileName, portTxFlowControlMode=portTxFlowControlMode, auditStatus=auditStatus, errEvRecoveryEnabled=errEvRecoveryEnabled, cardTestEntry=cardTestEntry, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardSpareGroupMode=cardSpareGroupMode, cardCPLDVersion=cardCPLDVersion, auditLogOutput=auditLogOutput, auditShelfId=auditShelfId, fpgaErrorEventGroup=fpgaErrorEventGroup, shelfNumber=shelfNumber, cardSwVersion=cardSwVersion, portId=portId, cardTrapInh=cardTrapInh, portDetectedMode=portDetectedMode, portSecState=portSecState, cardTestTable=cardTestTable, cmResetUpTime=cmResetUpTime, cardTestTime=cardTestTime, portMacAddress=portMacAddress, shelfObjects=shelfObjects, cardSubType=cardSubType, auditFailedCount=auditFailedCount, remainInDiagMode=remainInDiagMode, cardCarrierHwVersion=cardCarrierHwVersion, portDocsIfIndex=portDocsIfIndex, TestScheduleCommand=TestScheduleCommand, portConnectorId=portConnectorId, consoleOutput=consoleOutput, equipmentStateGroup=equipmentStateGroup, cardTestId=cardTestId, cardTemperatureHighError=cardTemperatureHighError, systemGeneral=systemGeneral, cardTestResultDesc=cardTestResultDesc, cardAdminState=cardAdminState, portCurrDsPower=portCurrDsPower, diskVolumeDiskSize=diskVolumeDiskSize, cardPrStateChange=cardPrStateChange)
