...
DiskVolumeUsageLevel, PortType, PortMode, CardId, EqActionType, AdminState, ShelfId, CardSubType, UnknownState, SecondaryState, FlowControlMode, PicType, DuplexStatus, FirmwareSource, PortDetectedMode, PortId, CardType, PrimaryState = mibBuilder.importSymbols("CADANT-TC", "DiskVolumeUsageLevel", "PortType", "PortMode", "CardId", "EqActionType", "AdminState", "ShelfId", "CardSubType", "UnknownState", "SecondaryState", "FlowControlMode", "PicType", "DuplexStatus", "FirmwareSource", "PortDetectedMode", "PortId", "CardType", "PrimaryState")
TenthdBmV, = mibBuilder.importSymbols("DOCS-IF-MIB", "TenthdBmV")
InterfaceIndexOrZero, = mibBuilder.importSymbols("IF-MIB", "InterfaceIndexOrZero")
NotificationGroup, ModuleCompliance, ObjectGroup = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
Bits, ObjectIdentity, iso, MibIdentifier, Integer32, Counter32, TimeTicks, IpAddress, Unsigned32, Counter64, NotificationType, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "iso", "MibIdentifier", "Integer32", "Counter32", "TimeTicks", "IpAddress", "Unsigned32", "Counter64", "NotificationType", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TruthValue, MacAddress, DisplayString, DateAndTime, TimeStamp, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "MacAddress", "DisplayString", "DateAndTime", "TimeStamp", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("CADANT-CMTS-EQUIPMENT-MIB", portTxFlowControlMode=portTxFlowControlMode, portId=portId, portEntry=portEntry, errEventId=errEventId, TestSchedule=TestSchedule, portCurrDsPower=portCurrDsPower, cmResetClearNotification=cmResetClearNotification, diskVolumeUsageMinorThreshold=diskVolumeUsageMinorThreshold, systemGeneralGroup=systemGeneralGroup, cardAdminState=cardAdminState, diskVolumeNumber=diskVolumeNumber, portSecStateChange=portSecStateChange, equipmentCardGroup=equipmentCardGroup, portLastChangeTime=portLastChangeTime, diskVolumeUsagePercentage=diskVolumeUsagePercentage, portAdminState=portAdminState, cardTestType=cardTestType, diskVolumeFileName=diskVolumeFileName, cardSecState=cardSecState, portDplxStatus=portDplxStatus, cardSpareGroupId=cardSpareGroupId, portDocsIfIndex=portDocsIfIndex, auditStatus=auditStatus, cardHwVersion=cardHwVersion, portBgpId=portBgpId, diskVolumeDiskSize=diskVolumeDiskSize, cardTestCommand=cardTestCommand, cardLastBootVersion=cardLastBootVersion, TestTransactionId=TestTransactionId, equipmentDiagGroup=equipmentDiagGroup, cardTestResultNotification=cardTestResultNotification, auditName=auditName, auditPassedCount=auditPassedCount, verboseLevel=verboseLevel, auditShelfId=auditShelfId, cardCarrierFwVersion=cardCarrierFwVersion, cardTemperatureHighWarn=cardTemperatureHighWarn, equipmentPortGroup=equipmentPortGroup, portMode=portMode, cardName=cardName, cardLastChangeTime=cardLastChangeTime, fpgaErrorEventGroup=fpgaErrorEventGroup, diskVolumeAutoDeleteFileNotification=diskVolumeAutoDeleteFileNotification, diskVolumeCardId=diskVolumeCardId, cardFwUpdateStatus=cardFwUpdateStatus, cardAction=cardAction, portMinDsPower=portMinDsPower, cmResetStatus=cmResetStatus, PYSNMP_MODULE_ID=cadEquipmentMib, diskVolumeAutoDeleteUnusedFile=diskVolumeAutoDeleteUnusedFile, cardTemperatureHighError=cardTemperatureHighError, cmResetInfo=cmResetInfo, cardLastBootSource=cardLastBootSource, portNumChans=portNumChans, cardTemperature=cardTemperature, diskVolumeShelfId=diskVolumeShelfId, equipmentCardTestGroup=equipmentCardTestGroup, portTable=portTable, portRxFlowControlMode=portRxFlowControlMode, cardSecStateChange=cardSecStateChange, portAction=portAction, diskVolumeEntry=diskVolumeEntry, portShelfId=portShelfId, cardCarrierSerialNum=cardCarrierSerialNum, equipmentTbl=equipmentTbl, cardEntry=cardEntry, cardShelfId=cardShelfId, cardUpTime=cardUpTime, diskVolumeDriveId=diskVolumeDriveId, cmVendor=cmVendor, auditResult=auditResult, downstreamPowerLoss=downstreamPowerLoss, errEvLoggingEnabled=errEvLoggingEnabled, diskVolumeUsageCriticalThreshold=diskVolumeUsageCriticalThreshold, cardCpuSpeed=cardCpuSpeed, cardFlashSize=cardFlashSize, systemKey=systemKey, portCardId=portCardId, auditDescription=auditDescription, equipmentState=equipmentState, cardBootVersion=cardBootVersion, portMacIfIndex=portMacIfIndex, cardTempNoReportNotification=cardTempNoReportNotification, cardTempOutOfRangeNotification=cardTempOutOfRangeNotification, cardFwVersion=cardFwVersion, shelfObjects=shelfObjects, portType=portType, cardTempOverHeatNotification=cardTempOverHeatNotification, TestId=TestId, portNumber=portNumber, cardTestTable=cardTestTable, cardTestName=cardTestName, cardTestScheduleCommand=cardTestScheduleCommand, cadEquipmentMibCompliances=cadEquipmentMibCompliances, cardFpgaSource=cardFpgaSource, cardSerialNum=cardSerialNum, cardPicDetected=cardPicDetected, auditEntry=auditEntry, cmDevice=cmDevice, TestResult=TestResult, cadEquipmentMib=cadEquipmentMib, portCardSubType=portCardSubType, cardDplxStatus=cardDplxStatus, cardTable=cardTable, auditId=auditId, trapCounter=trapCounter, cardTestDescription=cardTestDescription, cardTestId=cardTestId, cardTestTime=cardTestTime, TestScheduleCommand=TestScheduleCommand, equipmentStateGroup=equipmentStateGroup, TestCommand=TestCommand, cardSubType=cardSubType, fpgaErrorEventEntry=fpgaErrorEventEntry, portPrStateChange=portPrStateChange, auditCommand=auditCommand, portTrapInh=portTrapInh, cmUChannelID=cmUChannelID, cardRamSize=cardRamSize, auditCardId=auditCardId, auditTotalFailedCount=auditTotalFailedCount, remainInDiagMode=remainInDiagMode, TestType=TestType, cardPrState=cardPrState, cardCpuType=cardCpuType, cadEquipmentMibCompliance=cadEquipmentMibCompliance, cmPrimarySID=cmPrimarySID, portMaxDsPower=portMaxDsPower, diskDriveNumber=diskDriveNumber, equipmentTraps=equipmentTraps, cadEquipmentMibGroup=cadEquipmentMibGroup, auditCycleCount=auditCycleCount, consoleOutput=consoleOutput, diskVolumeId=diskVolumeId, systemGeneral=systemGeneral, cardDplxStatusChange=cardDplxStatusChange, cardShelfTestIndex=cardShelfTestIndex, cardTestTransId=cardTestTransId, equipmentAuditGroup=equipmentAuditGroup, cardSwVersion=cardSwVersion, diskVolumeTrapInh=diskVolumeTrapInh, cmResetUpTime=cmResetUpTime, errEvRecoveryEnabled=errEvRecoveryEnabled, equipmentShelfGroup=equipmentShelfGroup, diskVolumeSize=diskVolumeSize, diagTestId=diagTestId, errEvRowStatus=errEvRowStatus, portConnectorId=portConnectorId, portDescription=portDescription, diskVolumeUsageLevel=diskVolumeUsageLevel, diskVolumeTable=diskVolumeTable, diskVolumeGroup=diskVolumeGroup, auditLogThrottle=auditLogThrottle, cmIpAddress=cmIpAddress, cardType=cardType, cadEquipmentMibConformance=cadEquipmentMibConformance, cardTestResultDesc=cardTestResultDesc, cardPrStateChange=cardPrStateChange, cardTestEntry=cardTestEntry, eqDiagConfig=eqDiagConfig, cardId=cardId, shelfName=shelfName, shelfNumber=shelfNumber, cardCPLDVersion=cardCPLDVersion, equipmentDiag=equipmentDiag, auditTime=auditTime, diskVolumeUsageMajorThreshold=diskVolumeUsageMajorThreshold, auditTotalPassedCount=auditTotalPassedCount, portDplxStatusChange=portDplxStatusChange, cardCarrierHwVersion=cardCarrierHwVersion, auditTable=auditTable, portPrState=portPrState, portSecState=portSecState, cardDetected=cardDetected, cardTestIndex=cardTestIndex, trapSeverity=trapSeverity, cmResetReason=cmResetReason, cardDetectedChange=cardDetectedChange, cmRegistrationNotification=cmRegistrationNotification, auditFailedCount=auditFailedCount, equipmentError=equipmentError, fpgaErrorEventTable=fpgaErrorEventTable, cardPicHwVersion=cardPicHwVersion, portDetectedMode=portDetectedMode, cmMacAddress=cmMacAddress, cardTrapInh=cardTrapInh, cardSpareGroupMode=cardSpareGroupMode, auditAutoScheduling=auditAutoScheduling, cardPicSerialNum=cardPicSerialNum, systemClock=systemClock, cardTestSchedule=cardTestSchedule, cardLastResetReason=cardLastResetReason, cardNumPorts=cardNumPorts, cardTestResult=cardTestResult, diskVolumeUsageNotification=diskVolumeUsageNotification, diskVolumeName=diskVolumeName, cardNumber=cardNumber, portMacAddress=portMacAddress, errEvLogLevel=errEvLogLevel, equipmentAudit=equipmentAudit, cardSubDetected=cardSubDetected, cmResetNotification=cmResetNotification, cardBusSpeed=cardBusSpeed, portRxFlowControlDetected=portRxFlowControlDetected, portTxFlowControlDetected=portTxFlowControlDetected, shelfSwVersion=shelfSwVersion, auditLogOutput=auditLogOutput)
