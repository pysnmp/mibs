...
mibBuilder.exportSymbols("GLOBAL-REG", controllerReg=controllerReg, controllerOrionReg=controllerOrionReg, root=root, PYSNMP_MODULE_ID=globalRegModule, products=products, controller=controller, orion=orion, caps=caps, globalRegModule=globalRegModule, reg=reg, regs=regs, generic=generic, delta=delta, modules=modules, expr=expr)
