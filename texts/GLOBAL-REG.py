...
mibBuilder.exportSymbols("GLOBAL-REG", controller=controller, modules=modules, generic=generic, caps=caps, controllerOrionReg=controllerOrionReg, delta=delta, controllerReg=controllerReg, orion=orion, expr=expr, root=root, globalRegModule=globalRegModule, PYSNMP_MODULE_ID=globalRegModule, regs=regs, reg=reg, products=products)
