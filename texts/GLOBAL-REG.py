...
mibBuilder.exportSymbols("GLOBAL-REG", PYSNMP_MODULE_ID=globalRegModule, caps=caps, controllerReg=controllerReg, controllerOrionReg=controllerOrionReg, reg=reg, root=root, orion=orion, generic=generic, regs=regs, delta=delta, modules=modules, products=products, controller=controller, expr=expr, globalRegModule=globalRegModule)
