...
mibBuilder.exportSymbols("GLOBAL-REG", modules=modules, root=root, products=products, controllerReg=controllerReg, reg=reg, orion=orion, controller=controller, controllerOrionReg=controllerOrionReg, PYSNMP_MODULE_ID=globalRegModule, expr=expr, globalRegModule=globalRegModule, regs=regs, delta=delta, generic=generic, caps=caps)
