...
mibBuilder.exportSymbols("GLOBAL-REG", controllerOrionReg=controllerOrionReg, regs=regs, globalRegModule=globalRegModule, modules=modules, controller=controller, root=root, caps=caps, delta=delta, controllerReg=controllerReg, products=products, PYSNMP_MODULE_ID=globalRegModule, reg=reg, orion=orion, generic=generic, expr=expr)
