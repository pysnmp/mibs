...
mibBuilder.exportSymbols("GLOBAL-REG", controller=controller, controllerReg=controllerReg, generic=generic, root=root, delta=delta, PYSNMP_MODULE_ID=globalRegModule, reg=reg, controllerOrionReg=controllerOrionReg, expr=expr, caps=caps, modules=modules, products=products, regs=regs, globalRegModule=globalRegModule, orion=orion)
