...
mibBuilder.exportSymbols("GLOBAL-REG", expr=expr, modules=modules, delta=delta, globalRegModule=globalRegModule, regs=regs, controllerOrionReg=controllerOrionReg, controller=controller, products=products, PYSNMP_MODULE_ID=globalRegModule, generic=generic, caps=caps, root=root, orion=orion, controllerReg=controllerReg, reg=reg)
