...
mibBuilder.exportSymbols("GLOBAL-REG", products=products, expr=expr, delta=delta, caps=caps, reg=reg, generic=generic, orion=orion, PYSNMP_MODULE_ID=globalRegModule, controller=controller, regs=regs, controllerReg=controllerReg, globalRegModule=globalRegModule, modules=modules, root=root, controllerOrionReg=controllerOrionReg)
