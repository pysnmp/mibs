...
mibBuilder.exportSymbols("GLOBAL-REG", modules=modules, PYSNMP_MODULE_ID=globalRegModule, generic=generic, caps=caps, globalRegModule=globalRegModule, products=products, expr=expr, controllerReg=controllerReg, root=root, controller=controller, regs=regs, reg=reg, controllerOrionReg=controllerOrionReg, orion=orion, delta=delta)
