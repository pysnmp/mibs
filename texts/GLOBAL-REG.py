...
mibBuilder.exportSymbols("GLOBAL-REG", PYSNMP_MODULE_ID=globalRegModule, controllerOrionReg=controllerOrionReg, regs=regs, controller=controller, products=products, controllerReg=controllerReg, root=root, delta=delta, orion=orion, expr=expr, caps=caps, generic=generic, globalRegModule=globalRegModule, modules=modules, reg=reg)
