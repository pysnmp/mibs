...
mibBuilder.exportSymbols("GLOBAL-REG", products=products, expr=expr, regs=regs, root=root, reg=reg, generic=generic, caps=caps, controllerOrionReg=controllerOrionReg, controller=controller, globalRegModule=globalRegModule, controllerReg=controllerReg, modules=modules, delta=delta, orion=orion, PYSNMP_MODULE_ID=globalRegModule)
