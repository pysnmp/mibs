...
mibBuilder.exportSymbols("GLOBAL-REG", regs=regs, PYSNMP_MODULE_ID=globalRegModule, products=products, controllerReg=controllerReg, globalRegModule=globalRegModule, orion=orion, expr=expr, reg=reg, modules=modules, controller=controller, root=root, generic=generic, caps=caps, controllerOrionReg=controllerOrionReg, delta=delta)
