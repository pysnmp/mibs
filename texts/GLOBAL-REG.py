...
mibBuilder.exportSymbols("GLOBAL-REG", controllerReg=controllerReg, generic=generic, orion=orion, regs=regs, products=products, expr=expr, globalRegModule=globalRegModule, PYSNMP_MODULE_ID=globalRegModule, root=root, modules=modules, caps=caps, delta=delta, controller=controller, controllerOrionReg=controllerOrionReg, reg=reg)
