...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlDaughterCardRev=eqlDaughterCardRev, eqlControllerCMRevision=eqlControllerCMRevision, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlControllerPLDrev=eqlControllerPLDrev, eqlSFPIndex=eqlSFPIndex, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlDaughterCardECO=eqlDaughterCardECO, eqlBackplaneType=eqlBackplaneType, eqlSFPPartNumber=eqlSFPPartNumber, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlChannelCardTable=eqlChannelCardTable, eqlSFPBitrate=eqlSFPBitrate, eqlControllerECO=eqlControllerECO, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlEMMSN=eqlEMMSN, eqlbackplaneObjects=eqlbackplaneObjects, eqlChannelCardIndex=eqlChannelCardIndex, eqlchannelcardObjects=eqlchannelcardObjects, eqlControllerPhysRam=eqlControllerPhysRam, eqlControllerTable=eqlControllerTable, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlsfpObjects=eqlsfpObjects, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlEMMModel=eqlEMMModel, eqlSFPConnector=eqlSFPConnector, eqlControllerModel=eqlControllerModel, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlBackplaneSN2=eqlBackplaneSN2, eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlSFPTable=eqlSFPTable, eqlEMMECO=eqlEMMECO, eqlControllerCPUPass=eqlControllerCPUPass, eqlDaughterCardModel=eqlDaughterCardModel, eqlControllerSwRevision=eqlControllerSwRevision, eqlBackplanePartNum=eqlBackplanePartNum, eqlControllerType=eqlControllerType, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqldaughtercardObjects=eqldaughtercardObjects, eqlSFPEntry=eqlSFPEntry, eqlSFPLength1=eqlSFPLength1, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlBackplaneEntry=eqlBackplaneEntry, eqlControllerDate=eqlControllerDate, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlSFPLength2=eqlSFPLength2, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlemmConformance=eqlemmConformance, eqlEMMRev=eqlEMMRev, eqlControllerIndex=eqlControllerIndex, eqlControllerEEprom=eqlControllerEEprom, eqlBackplaneIndex=eqlBackplaneIndex, eqlSFPIdentifier=eqlSFPIdentifier, eqlEMMTable=eqlEMMTable, eqlControllerPlatformType=eqlControllerPlatformType, eqlSFPStatus=eqlSFPStatus, eqlbackplaneConformance=eqlbackplaneConformance, eqlSFPDateCode=eqlSFPDateCode, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlDaughterCardDate=eqlDaughterCardDate, eqlcontrollerModule=eqlcontrollerModule, eqlemmNotifications=eqlemmNotifications, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlBackplaneECO=eqlBackplaneECO, eqlEMMIndex=eqlEMMIndex, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqlSFPMode=eqlSFPMode, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlSFPIfIndex=eqlSFPIfIndex, eqlDaughterCardSN=eqlDaughterCardSN, eqlSFPVendorName=eqlSFPVendorName, eqlBackplaneSN=eqlBackplaneSN, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlControllerBootTime=eqlControllerBootTime, eqlEMMDate=eqlEMMDate, eqlBackplaneRev=eqlBackplaneRev, eqlcontrollerConformance=eqlcontrollerConformance, eqlChannelCardStatus=eqlChannelCardStatus, eqlEMMEEprom=eqlEMMEEprom, eqlBackplaneTable=eqlBackplaneTable, eqlChannelCardEntry=eqlChannelCardEntry, eqlEMMSN2=eqlEMMSN2, eqlControllerCPUrev=eqlControllerCPUrev, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlBackplaneDate=eqlBackplaneDate, eqlEMMEntry=eqlEMMEntry, eqlDaughterCardTable=eqlDaughterCardTable, eqlcontrollerObjects=eqlcontrollerObjects, eqlControllerUpTime=eqlControllerUpTime, eqlemmObjects=eqlemmObjects, eqlEMMPartNum=eqlEMMPartNum, eqlControllerEntry=eqlControllerEntry, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlcontrollerNotifications=eqlcontrollerNotifications, eqldaughtercardConformance=eqldaughtercardConformance, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion)
