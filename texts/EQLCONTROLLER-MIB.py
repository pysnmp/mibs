...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlSFPLength2=eqlSFPLength2, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlSFPLength1=eqlSFPLength1, eqlEMMSN2=eqlEMMSN2, eqlControllerPhysRam=eqlControllerPhysRam, eqlEMMRev=eqlEMMRev, eqlControllerType=eqlControllerType, eqlchannelcardObjects=eqlchannelcardObjects, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlbackplaneObjects=eqlbackplaneObjects, eqlBackplanePartNum=eqlBackplanePartNum, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlBackplaneRev=eqlBackplaneRev, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlControllerPlatformType=eqlControllerPlatformType, eqlemmConformance=eqlemmConformance, eqlBackplaneIndex=eqlBackplaneIndex, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlControllerEEprom=eqlControllerEEprom, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlControllerBootTime=eqlControllerBootTime, eqlDaughterCardDate=eqlDaughterCardDate, eqlSFPStatus=eqlSFPStatus, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlBackplaneType=eqlBackplaneType, eqlDaughterCardRev=eqlDaughterCardRev, eqlEMMEntry=eqlEMMEntry, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlBackplaneDate=eqlBackplaneDate, eqlControllerDate=eqlControllerDate, eqlSFPConnector=eqlSFPConnector, eqlSFPPartNumber=eqlSFPPartNumber, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlDaughterCardModel=eqlDaughterCardModel, eqlcontrollerObjects=eqlcontrollerObjects, eqlEMMIndex=eqlEMMIndex, eqlSFPVendorName=eqlSFPVendorName, eqlBackplaneTable=eqlBackplaneTable, eqlemmObjects=eqlemmObjects, eqlControllerPLDrev=eqlControllerPLDrev, eqlDaughterCardTable=eqlDaughterCardTable, eqlbackplaneConformance=eqlbackplaneConformance, eqlEMMSN=eqlEMMSN, eqlcontrollerModule=eqlcontrollerModule, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlDaughterCardECO=eqlDaughterCardECO, eqlEMMModel=eqlEMMModel, eqlControllerIndex=eqlControllerIndex, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlChannelCardStatus=eqlChannelCardStatus, eqlControllerECO=eqlControllerECO, eqlemmNotifications=eqlemmNotifications, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlBackplaneSN2=eqlBackplaneSN2, eqlControllerSwRevision=eqlControllerSwRevision, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlControllerCMRevision=eqlControllerCMRevision, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlSFPBitrate=eqlSFPBitrate, eqlControllerCPUrev=eqlControllerCPUrev, eqlSFPDateCode=eqlSFPDateCode, eqldaughtercardConformance=eqldaughtercardConformance, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlEMMPartNum=eqlEMMPartNum, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlEMMECO=eqlEMMECO, eqldaughtercardObjects=eqldaughtercardObjects, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlDaughterCardSN=eqlDaughterCardSN, eqlSFPIndex=eqlSFPIndex, eqlBackplaneEntry=eqlBackplaneEntry, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqlSFPEntry=eqlSFPEntry, eqlChannelCardTable=eqlChannelCardTable, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlChannelCardIndex=eqlChannelCardIndex, eqlEMMTable=eqlEMMTable, eqlControllerCPUPass=eqlControllerCPUPass, eqlEMMDate=eqlEMMDate, eqlSFPIdentifier=eqlSFPIdentifier, eqlControllerEntry=eqlControllerEntry, eqlChannelCardEntry=eqlChannelCardEntry, eqlSFPTable=eqlSFPTable, eqlControllerTable=eqlControllerTable, eqlBackplaneECO=eqlBackplaneECO, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlControllerModel=eqlControllerModel, eqlsfpObjects=eqlsfpObjects, eqlControllerUpTime=eqlControllerUpTime, eqlcontrollerConformance=eqlcontrollerConformance, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlSFPMode=eqlSFPMode, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlSFPIfIndex=eqlSFPIfIndex, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlBackplaneSN=eqlBackplaneSN, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlEMMEEprom=eqlEMMEEprom)
