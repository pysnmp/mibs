...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlControllerIndex=eqlControllerIndex, eqlSFPIndex=eqlSFPIndex, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlDaughterCardDate=eqlDaughterCardDate, eqlDaughterCardSN=eqlDaughterCardSN, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlBackplaneType=eqlBackplaneType, eqlChannelCardTable=eqlChannelCardTable, eqlEMMPartNum=eqlEMMPartNum, eqlControllerModel=eqlControllerModel, eqlEMMModel=eqlEMMModel, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlControllerType=eqlControllerType, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlchannelcardObjects=eqlchannelcardObjects, eqlControllerEntry=eqlControllerEntry, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlBackplaneSN=eqlBackplaneSN, eqlSFPTable=eqlSFPTable, eqlControllerCPUPass=eqlControllerCPUPass, eqlBackplaneTable=eqlBackplaneTable, eqlSFPMode=eqlSFPMode, eqlEMMRev=eqlEMMRev, eqlbackplaneObjects=eqlbackplaneObjects, eqlControllerSwRevision=eqlControllerSwRevision, eqlSFPIfIndex=eqlSFPIfIndex, eqlBackplaneSN2=eqlBackplaneSN2, eqlControllerBootTime=eqlControllerBootTime, eqlSFPStatus=eqlSFPStatus, eqlEMMDate=eqlEMMDate, eqlControllerPhysRam=eqlControllerPhysRam, eqldaughtercardObjects=eqldaughtercardObjects, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlemmNotifications=eqlemmNotifications, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlSFPVendorName=eqlSFPVendorName, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlControllerEEprom=eqlControllerEEprom, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlemmObjects=eqlemmObjects, eqlBackplaneEntry=eqlBackplaneEntry, eqlBackplaneDate=eqlBackplaneDate, eqlSFPBitrate=eqlSFPBitrate, eqlEMMECO=eqlEMMECO, eqlSFPLength2=eqlSFPLength2, eqldaughtercardConformance=eqldaughtercardConformance, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlSFPEntry=eqlSFPEntry, eqlControllerUpTime=eqlControllerUpTime, eqlEMMTable=eqlEMMTable, eqlControllerPlatformType=eqlControllerPlatformType, eqlDaughterCardRev=eqlDaughterCardRev, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlsfpObjects=eqlsfpObjects, eqlControllerTable=eqlControllerTable, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlSFPIdentifier=eqlSFPIdentifier, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlControllerCPUrev=eqlControllerCPUrev, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlControllerCMRevision=eqlControllerCMRevision, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqlcontrollerModule=eqlcontrollerModule, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlDaughterCardModel=eqlDaughterCardModel, eqlChannelCardEntry=eqlChannelCardEntry, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlEMMSN=eqlEMMSN, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlBackplaneIndex=eqlBackplaneIndex, eqlChannelCardStatus=eqlChannelCardStatus, eqlDaughterCardTable=eqlDaughterCardTable, eqlChannelCardIndex=eqlChannelCardIndex, eqlSFPPartNumber=eqlSFPPartNumber, eqlbackplaneConformance=eqlbackplaneConformance, eqlBackplaneECO=eqlBackplaneECO, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlSFPConnector=eqlSFPConnector, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlDaughterCardECO=eqlDaughterCardECO, eqlcontrollerObjects=eqlcontrollerObjects, eqlBackplaneRev=eqlBackplaneRev, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlSFPLength1=eqlSFPLength1, eqlControllerECO=eqlControllerECO, eqlEMMSN2=eqlEMMSN2, eqlSFPDateCode=eqlSFPDateCode, eqlEMMIndex=eqlEMMIndex, eqlEMMEntry=eqlEMMEntry, eqlControllerDate=eqlControllerDate, eqlControllerPLDrev=eqlControllerPLDrev, eqlemmConformance=eqlemmConformance, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlBackplanePartNum=eqlBackplanePartNum, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlEMMEEprom=eqlEMMEEprom, eqlcontrollerConformance=eqlcontrollerConformance, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery)
