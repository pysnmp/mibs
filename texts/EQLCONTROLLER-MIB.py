...
ObjectIdentity, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, enterprises, Bits, IpAddress, iso, NotificationType, ModuleIdentity, Gauge32, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "enterprises", "Bits", "IpAddress", "iso", "NotificationType", "ModuleIdentity", "Gauge32", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlControllerCPUPass=eqlControllerCPUPass, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlEMMRev=eqlEMMRev, eqlBackplanePartNum=eqlBackplanePartNum, eqlEMMSN2=eqlEMMSN2, eqlBackplaneIndex=eqlBackplaneIndex, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlbackplaneConformance=eqlbackplaneConformance, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlEMMEntry=eqlEMMEntry, eqlSFPIfIndex=eqlSFPIfIndex, eqlSFPLength1=eqlSFPLength1, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqldaughtercardObjects=eqldaughtercardObjects, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlSFPIndex=eqlSFPIndex, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlcontrollerObjects=eqlcontrollerObjects, eqlChannelCardStatus=eqlChannelCardStatus, eqlDaughterCardDate=eqlDaughterCardDate, eqlControllerPhysRam=eqlControllerPhysRam, eqlDaughterCardRev=eqlDaughterCardRev, eqlsfpObjects=eqlsfpObjects, eqlDaughterCardECO=eqlDaughterCardECO, eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlEMMECO=eqlEMMECO, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlDaughterCardModel=eqlDaughterCardModel, eqlBackplaneTable=eqlBackplaneTable, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlemmConformance=eqlemmConformance, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlControllerModel=eqlControllerModel, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlBackplaneECO=eqlBackplaneECO, eqlSFPLength2=eqlSFPLength2, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlcontrollerConformance=eqlcontrollerConformance, eqlDaughterCardTable=eqlDaughterCardTable, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlControllerIndex=eqlControllerIndex, eqlSFPBitrate=eqlSFPBitrate, eqlControllerEEprom=eqlControllerEEprom, eqlEMMTable=eqlEMMTable, eqlcontrollerModule=eqlcontrollerModule, eqlSFPDateCode=eqlSFPDateCode, eqlControllerEntry=eqlControllerEntry, eqlControllerPlatformType=eqlControllerPlatformType, eqlEMMPartNum=eqlEMMPartNum, eqlControllerECO=eqlControllerECO, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlSFPTable=eqlSFPTable, eqlSFPVendorName=eqlSFPVendorName, eqlSFPPartNumber=eqlSFPPartNumber, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlControllerSwRevision=eqlControllerSwRevision, eqlBackplaneSN2=eqlBackplaneSN2, eqlBackplaneType=eqlBackplaneType, eqlEMMDate=eqlEMMDate, eqlEMMIndex=eqlEMMIndex, eqlControllerDate=eqlControllerDate, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlControllerType=eqlControllerType, eqlChannelCardTable=eqlChannelCardTable, eqlSFPMode=eqlSFPMode, eqlchannelcardObjects=eqlchannelcardObjects, eqlSFPIdentifier=eqlSFPIdentifier, eqlEMMSN=eqlEMMSN, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlBackplaneDate=eqlBackplaneDate, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlSFPStatus=eqlSFPStatus, eqlSFPEntry=eqlSFPEntry, eqlBackplaneEntry=eqlBackplaneEntry, eqldaughtercardConformance=eqldaughtercardConformance, eqlbackplaneObjects=eqlbackplaneObjects, eqlChannelCardIndex=eqlChannelCardIndex, eqlChannelCardEntry=eqlChannelCardEntry, eqlControllerUpTime=eqlControllerUpTime, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlDaughterCardSN=eqlDaughterCardSN, eqlBackplaneSN=eqlBackplaneSN, eqlControllerBootTime=eqlControllerBootTime, eqlEMMModel=eqlEMMModel, eqlEMMEEprom=eqlEMMEEprom, eqlBackplaneRev=eqlBackplaneRev, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlControllerCMRevision=eqlControllerCMRevision, eqlemmObjects=eqlemmObjects, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlControllerTable=eqlControllerTable, eqlemmNotifications=eqlemmNotifications, eqlSFPConnector=eqlSFPConnector, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlControllerCPUrev=eqlControllerCPUrev, eqlControllerPLDrev=eqlControllerPLDrev)
