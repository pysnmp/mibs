...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlSFPLength1=eqlSFPLength1, eqlEMMDate=eqlEMMDate, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlBackplaneECO=eqlBackplaneECO, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlControllerMinorVersion=eqlControllerMinorVersion, eqldaughtercardObjects=eqldaughtercardObjects, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlDaughterCardECO=eqlDaughterCardECO, eqlbackplaneConformance=eqlbackplaneConformance, eqlDaughterCardRev=eqlDaughterCardRev, eqlControllerCPUrev=eqlControllerCPUrev, eqlSFPConnector=eqlSFPConnector, eqlBackplaneRev=eqlBackplaneRev, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlControllerUpTime=eqlControllerUpTime, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlcontrollerConformance=eqlcontrollerConformance, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlEMMModel=eqlEMMModel, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlBackplaneIndex=eqlBackplaneIndex, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlControllerBootTime=eqlControllerBootTime, eqlbackplaneObjects=eqlbackplaneObjects, eqlSFPBitrate=eqlSFPBitrate, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlDaughterCardDate=eqlDaughterCardDate, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlDaughterCardModel=eqlDaughterCardModel, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlControllerModel=eqlControllerModel, eqlSFPIdentifier=eqlSFPIdentifier, eqlControllerCMRevision=eqlControllerCMRevision, eqlSFPEntry=eqlSFPEntry, eqlEMMRev=eqlEMMRev, eqlControllerEEprom=eqlControllerEEprom, eqlDaughterCardTable=eqlDaughterCardTable, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlControllerCPUPass=eqlControllerCPUPass, eqlControllerPhysRam=eqlControllerPhysRam, eqlEMMPartNum=eqlEMMPartNum, eqlBackplaneEntry=eqlBackplaneEntry, eqlemmObjects=eqlemmObjects, eqlSFPTable=eqlSFPTable, eqlSFPIndex=eqlSFPIndex, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlBackplanePartNum=eqlBackplanePartNum, eqlcontrollerObjects=eqlcontrollerObjects, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlControllerDate=eqlControllerDate, eqlControllerIndex=eqlControllerIndex, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlBackplaneType=eqlBackplaneType, eqlSFPVendorName=eqlSFPVendorName, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlSFPDateCode=eqlSFPDateCode, eqlEMMSN=eqlEMMSN, eqlControllerTable=eqlControllerTable, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlchannelcardObjects=eqlchannelcardObjects, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlSFPIfIndex=eqlSFPIfIndex, eqlSFPPartNumber=eqlSFPPartNumber, eqlControllerECO=eqlControllerECO, eqlEMMECO=eqlEMMECO, eqlSFPStatus=eqlSFPStatus, eqlBackplaneSN=eqlBackplaneSN, eqlemmConformance=eqlemmConformance, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlBackplaneDate=eqlBackplaneDate, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqldaughtercardConformance=eqldaughtercardConformance, eqlemmNotifications=eqlemmNotifications, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlEMMTable=eqlEMMTable, eqlSFPLength2=eqlSFPLength2, eqlControllerPLDrev=eqlControllerPLDrev, eqlBackplaneSN2=eqlBackplaneSN2, eqlcontrollerModule=eqlcontrollerModule, eqlChannelCardStatus=eqlChannelCardStatus, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlChannelCardTable=eqlChannelCardTable, eqlControllerPlatformType=eqlControllerPlatformType, eqlControllerType=eqlControllerType, eqlBackplaneTable=eqlBackplaneTable, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlEMMIndex=eqlEMMIndex, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlsfpObjects=eqlsfpObjects, eqlControllerSwRevision=eqlControllerSwRevision, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlChannelCardEntry=eqlChannelCardEntry, eqlEMMEntry=eqlEMMEntry, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlControllerEntry=eqlControllerEntry, eqlEMMEEprom=eqlEMMEEprom, eqlDaughterCardSN=eqlDaughterCardSN, eqlChannelCardIndex=eqlChannelCardIndex, eqlEMMSN2=eqlEMMSN2, eqlSFPMode=eqlSFPMode, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlControllerSerialNumber2=eqlControllerSerialNumber2)
