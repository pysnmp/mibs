...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlEMMECO=eqlEMMECO, eqlControllerIndex=eqlControllerIndex, eqlSFPIdentifier=eqlSFPIdentifier, eqlDaughterCardDate=eqlDaughterCardDate, eqlSFPIfIndex=eqlSFPIfIndex, eqlControllerModel=eqlControllerModel, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlChannelCardTable=eqlChannelCardTable, eqlControllerType=eqlControllerType, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlSFPLength2=eqlSFPLength2, eqlEMMDate=eqlEMMDate, eqldaughtercardNotifications=eqldaughtercardNotifications, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlEMMTable=eqlEMMTable, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlEMMSN2=eqlEMMSN2, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlControllerSwRevision=eqlControllerSwRevision, eqlemmObjects=eqlemmObjects, eqlchannelcardObjects=eqlchannelcardObjects, eqlChannelCardIndex=eqlChannelCardIndex, eqlControllerECO=eqlControllerECO, eqlBackplaneTable=eqlBackplaneTable, eqlSFPTable=eqlSFPTable, eqlbackplaneObjects=eqlbackplaneObjects, eqlSFPConnector=eqlSFPConnector, eqlControllerUpTime=eqlControllerUpTime, eqlSFPBitrate=eqlSFPBitrate, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlDaughterCardRev=eqlDaughterCardRev, eqlcontrollerObjects=eqlcontrollerObjects, eqlSFPDateCode=eqlSFPDateCode, eqlDaughterCardECO=eqlDaughterCardECO, eqlcontrollerModule=eqlcontrollerModule, eqlControllerCPUPass=eqlControllerCPUPass, eqlControllerBootTime=eqlControllerBootTime, eqlEMMSN=eqlEMMSN, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlControllerEntry=eqlControllerEntry, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlsfpObjects=eqlsfpObjects, eqlBackplanePartNum=eqlBackplanePartNum, eqlBackplaneECO=eqlBackplaneECO, eqlBackplaneEntry=eqlBackplaneEntry, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlBackplaneDate=eqlBackplaneDate, eqlDaughterCardModel=eqlDaughterCardModel, eqlemmNotifications=eqlemmNotifications, eqlControllerDate=eqlControllerDate, eqlControllerCPUrev=eqlControllerCPUrev, eqlEMMRev=eqlEMMRev, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlDaughterCardSN=eqlDaughterCardSN, eqlDaughterCardTable=eqlDaughterCardTable, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlBackplaneSN=eqlBackplaneSN, eqlEMMEEprom=eqlEMMEEprom, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlbackplaneConformance=eqlbackplaneConformance, eqlSFPMode=eqlSFPMode, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlSFPIndex=eqlSFPIndex, eqlChannelCardEntry=eqlChannelCardEntry, eqlSFPPartNumber=eqlSFPPartNumber, eqlSFPLength1=eqlSFPLength1, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlControllerEEprom=eqlControllerEEprom, eqlControllerPhysRam=eqlControllerPhysRam, eqlEMMIndex=eqlEMMIndex, eqlSFPStatus=eqlSFPStatus, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlBackplaneIndex=eqlBackplaneIndex, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlSFPVendorName=eqlSFPVendorName, eqlemmConformance=eqlemmConformance, eqldaughtercardConformance=eqldaughtercardConformance, eqlBackplaneRev=eqlBackplaneRev, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlChannelCardStatus=eqlChannelCardStatus, eqlControllerCMRevision=eqlControllerCMRevision, eqlControllerPLDrev=eqlControllerPLDrev, eqlControllerTable=eqlControllerTable, eqlSFPEntry=eqlSFPEntry, eqlEMMModel=eqlEMMModel, eqldaughtercardObjects=eqldaughtercardObjects, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqlEMMEntry=eqlEMMEntry, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlBackplaneSN2=eqlBackplaneSN2, eqlBackplaneType=eqlBackplaneType, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlEMMPartNum=eqlEMMPartNum, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlControllerPlatformType=eqlControllerPlatformType, eqlcontrollerConformance=eqlcontrollerConformance, eqlControllerSerialNumber2=eqlControllerSerialNumber2)
