...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlControllerSwRevision=eqlControllerSwRevision, eqlControllerDate=eqlControllerDate, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlSFPLength1=eqlSFPLength1, eqldaughtercardObjects=eqldaughtercardObjects, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlbackplaneConformance=eqlbackplaneConformance, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlChannelCardIndex=eqlChannelCardIndex, eqlControllerCPUrev=eqlControllerCPUrev, eqlEMMTable=eqlEMMTable, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlBackplaneSN=eqlBackplaneSN, eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlSFPIdentifier=eqlSFPIdentifier, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlSFPStatus=eqlSFPStatus, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlEMMIndex=eqlEMMIndex, eqlChannelCardTable=eqlChannelCardTable, eqlBackplaneDate=eqlBackplaneDate, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlSFPPartNumber=eqlSFPPartNumber, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlEMMDate=eqlEMMDate, eqlSFPEntry=eqlSFPEntry, eqlSFPIndex=eqlSFPIndex, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlControllerPLDrev=eqlControllerPLDrev, eqlEMMSN2=eqlEMMSN2, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlSFPTable=eqlSFPTable, eqlBackplaneTable=eqlBackplaneTable, eqlchannelcardObjects=eqlchannelcardObjects, eqlEMMPartNum=eqlEMMPartNum, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlSFPVendorName=eqlSFPVendorName, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlBackplaneRev=eqlBackplaneRev, eqlEMMRev=eqlEMMRev, eqlSFPConnector=eqlSFPConnector, eqlDaughterCardTable=eqlDaughterCardTable, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlSFPMode=eqlSFPMode, eqldaughtercardConformance=eqldaughtercardConformance, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlcontrollerModule=eqlcontrollerModule, eqlControllerBootTime=eqlControllerBootTime, eqlSFPDateCode=eqlSFPDateCode, eqlemmObjects=eqlemmObjects, eqlControllerType=eqlControllerType, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlDaughterCardDate=eqlDaughterCardDate, eqlDaughterCardSN=eqlDaughterCardSN, eqlSFPIfIndex=eqlSFPIfIndex, eqlcontrollerObjects=eqlcontrollerObjects, eqlControllerEntry=eqlControllerEntry, eqlControllerCMRevision=eqlControllerCMRevision, eqlemmNotifications=eqlemmNotifications, eqlChannelCardEntry=eqlChannelCardEntry, eqlEMMModel=eqlEMMModel, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqlBackplaneIndex=eqlBackplaneIndex, eqlEMMEntry=eqlEMMEntry, eqlDaughterCardECO=eqlDaughterCardECO, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlControllerModel=eqlControllerModel, eqlControllerPlatformType=eqlControllerPlatformType, eqlBackplaneSN2=eqlBackplaneSN2, eqlControllerUpTime=eqlControllerUpTime, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlControllerTable=eqlControllerTable, eqlControllerECO=eqlControllerECO, eqlControllerCPUPass=eqlControllerCPUPass, eqlBackplanePartNum=eqlBackplanePartNum, eqlBackplaneEntry=eqlBackplaneEntry, eqlBackplaneECO=eqlBackplaneECO, eqlControllerPhysRam=eqlControllerPhysRam, eqlemmConformance=eqlemmConformance, eqlsfpObjects=eqlsfpObjects, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlDaughterCardRev=eqlDaughterCardRev, eqlEMMECO=eqlEMMECO, eqlSFPLength2=eqlSFPLength2, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlDaughterCardModel=eqlDaughterCardModel, eqlEMMSN=eqlEMMSN, eqlChannelCardStatus=eqlChannelCardStatus, eqlSFPBitrate=eqlSFPBitrate, eqlbackplaneObjects=eqlbackplaneObjects, eqlControllerIndex=eqlControllerIndex, eqlBackplaneType=eqlBackplaneType, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlEMMEEprom=eqlEMMEEprom, eqlControllerEEprom=eqlControllerEEprom, eqlcontrollerConformance=eqlcontrollerConformance, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlControllerMinorVersion=eqlControllerMinorVersion)
