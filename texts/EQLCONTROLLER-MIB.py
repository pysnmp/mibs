...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, IpAddress, NotificationType, Integer32, Counter64, MibIdentifier, enterprises, Counter32, TimeTicks, Bits, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "IpAddress", "NotificationType", "Integer32", "Counter64", "MibIdentifier", "enterprises", "Counter32", "TimeTicks", "Bits", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlControllerPlatformType=eqlControllerPlatformType, eqlbackplaneConformance=eqlbackplaneConformance, eqlControllerEEprom=eqlControllerEEprom, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlControllerPhysRam=eqlControllerPhysRam, eqlSFPIdentifier=eqlSFPIdentifier, eqlemmObjects=eqlemmObjects, eqlControllerDate=eqlControllerDate, eqlChannelCardEntry=eqlChannelCardEntry, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlControllerCPUPass=eqlControllerCPUPass, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqldaughtercardConformance=eqldaughtercardConformance, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlDaughterCardDate=eqlDaughterCardDate, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlSFPMode=eqlSFPMode, eqlBackplaneSN2=eqlBackplaneSN2, eqlBackplaneRev=eqlBackplaneRev, eqlemmNotifications=eqlemmNotifications, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlEMMRev=eqlEMMRev, eqlDaughterCardRev=eqlDaughterCardRev, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlEMMTable=eqlEMMTable, eqlSFPStatus=eqlSFPStatus, eqlBackplaneIndex=eqlBackplaneIndex, eqlchannelcardObjects=eqlchannelcardObjects, eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlSFPEntry=eqlSFPEntry, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlSFPDateCode=eqlSFPDateCode, eqlemmConformance=eqlemmConformance, eqlEMMEntry=eqlEMMEntry, eqlEMMIndex=eqlEMMIndex, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlSFPPartNumber=eqlSFPPartNumber, eqlBackplaneECO=eqlBackplaneECO, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlcontrollerObjects=eqlcontrollerObjects, eqlEMMDate=eqlEMMDate, eqlChannelCardStatus=eqlChannelCardStatus, eqlSFPIndex=eqlSFPIndex, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlControllerIndex=eqlControllerIndex, eqlEMMPartNum=eqlEMMPartNum, eqlControllerModel=eqlControllerModel, eqlbackplaneObjects=eqlbackplaneObjects, eqlSFPVendorName=eqlSFPVendorName, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlControllerPLDrev=eqlControllerPLDrev, eqldaughtercardObjects=eqldaughtercardObjects, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqlControllerECO=eqlControllerECO, eqlControllerEntry=eqlControllerEntry, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlBackplaneSN=eqlBackplaneSN, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlBackplaneTable=eqlBackplaneTable, eqlSFPLength1=eqlSFPLength1, eqlControllerSwRevision=eqlControllerSwRevision, eqlChannelCardIndex=eqlChannelCardIndex, eqlcontrollerConformance=eqlcontrollerConformance, eqlControllerType=eqlControllerType, eqlEMMSN=eqlEMMSN, eqlChannelCardTable=eqlChannelCardTable, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlControllerBootTime=eqlControllerBootTime, eqlControllerCPUrev=eqlControllerCPUrev, eqlControllerCMRevision=eqlControllerCMRevision, eqlControllerTable=eqlControllerTable, eqlEMMEEprom=eqlEMMEEprom, eqlSFPIfIndex=eqlSFPIfIndex, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlControllerUpTime=eqlControllerUpTime, eqlEMMModel=eqlEMMModel, eqlDaughterCardModel=eqlDaughterCardModel, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlBackplaneType=eqlBackplaneType, eqlSFPBitrate=eqlSFPBitrate, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlBackplaneEntry=eqlBackplaneEntry, eqlDaughterCardECO=eqlDaughterCardECO, eqlSFPLength2=eqlSFPLength2, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlBackplaneDate=eqlBackplaneDate, eqlDaughterCardSN=eqlDaughterCardSN, eqlEMMSN2=eqlEMMSN2, eqlSFPTable=eqlSFPTable, eqlsfpObjects=eqlsfpObjects, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlEMMECO=eqlEMMECO, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlBackplanePartNum=eqlBackplanePartNum, eqlSFPConnector=eqlSFPConnector, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlcontrollerModule=eqlcontrollerModule, eqlDaughterCardTable=eqlDaughterCardTable)
