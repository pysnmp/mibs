...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlDaughterCardECO=eqlDaughterCardECO, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlControllerDate=eqlControllerDate, eqlControllerEEprom=eqlControllerEEprom, eqlSFPLength2=eqlSFPLength2, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlBackplanePartNum=eqlBackplanePartNum, eqlChannelCardEntry=eqlChannelCardEntry, eqlSFPEntry=eqlSFPEntry, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqlbackplaneConformance=eqlbackplaneConformance, eqlcontrollerConformance=eqlcontrollerConformance, eqlChannelCardStatus=eqlChannelCardStatus, eqlSFPIndex=eqlSFPIndex, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlControllerModel=eqlControllerModel, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlEMMModel=eqlEMMModel, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlControllerSwRevision=eqlControllerSwRevision, eqlControllerCPUrev=eqlControllerCPUrev, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlSFPPartNumber=eqlSFPPartNumber, eqlEMMSN=eqlEMMSN, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlsfpObjects=eqlsfpObjects, eqlBackplaneSN=eqlBackplaneSN, eqlSFPVendorName=eqlSFPVendorName, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlBackplaneIndex=eqlBackplaneIndex, eqlControllerIndex=eqlControllerIndex, eqlbackplaneObjects=eqlbackplaneObjects, eqlControllerCPUPass=eqlControllerCPUPass, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlSFPIfIndex=eqlSFPIfIndex, eqlBackplaneRev=eqlBackplaneRev, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlBackplaneType=eqlBackplaneType, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlControllerPLDrev=eqlControllerPLDrev, eqlControllerType=eqlControllerType, eqlControllerBootTime=eqlControllerBootTime, eqlEMMEntry=eqlEMMEntry, eqlControllerECO=eqlControllerECO, eqlEMMRev=eqlEMMRev, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqlBackplaneECO=eqlBackplaneECO, eqlSFPConnector=eqlSFPConnector, eqlEMMDate=eqlEMMDate, eqlControllerPhysRam=eqlControllerPhysRam, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlchannelcardObjects=eqlchannelcardObjects, eqlControllerTable=eqlControllerTable, eqlBackplaneSN2=eqlBackplaneSN2, eqlEMMTable=eqlEMMTable, eqlEMMEEprom=eqlEMMEEprom, eqldaughtercardObjects=eqldaughtercardObjects, eqlControllerEntry=eqlControllerEntry, eqlChannelCardTable=eqlChannelCardTable, eqlBackplaneDate=eqlBackplaneDate, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlemmConformance=eqlemmConformance, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlcontrollerModule=eqlcontrollerModule, eqlSFPLength1=eqlSFPLength1, eqlControllerPlatformType=eqlControllerPlatformType, eqlDaughterCardModel=eqlDaughterCardModel, eqlSFPMode=eqlSFPMode, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlSFPDateCode=eqlSFPDateCode, eqlEMMIndex=eqlEMMIndex, eqldaughtercardConformance=eqldaughtercardConformance, eqlEMMPartNum=eqlEMMPartNum, eqlChannelCardIndex=eqlChannelCardIndex, eqlSFPStatus=eqlSFPStatus, eqlEMMSN2=eqlEMMSN2, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlDaughterCardTable=eqlDaughterCardTable, eqlemmObjects=eqlemmObjects, eqlEMMECO=eqlEMMECO, eqlBackplaneEntry=eqlBackplaneEntry, eqlDaughterCardSN=eqlDaughterCardSN, eqlControllerUpTime=eqlControllerUpTime, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlSFPTable=eqlSFPTable, eqlemmNotifications=eqlemmNotifications, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlSFPBitrate=eqlSFPBitrate, eqlSFPIdentifier=eqlSFPIdentifier, eqlcontrollerObjects=eqlcontrollerObjects, eqlBackplaneTable=eqlBackplaneTable, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlDaughterCardRev=eqlDaughterCardRev, eqlDaughterCardDate=eqlDaughterCardDate, eqlControllerCMRevision=eqlControllerCMRevision)
