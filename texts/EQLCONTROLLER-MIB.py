...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlDaughterCardRev=eqlDaughterCardRev, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlSFPIfIndex=eqlSFPIfIndex, eqlDaughterCardModel=eqlDaughterCardModel, eqlEMMSN2=eqlEMMSN2, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlSFPIdentifier=eqlSFPIdentifier, eqldaughtercardConformance=eqldaughtercardConformance, eqlEMMEntry=eqlEMMEntry, eqlChannelCardStatus=eqlChannelCardStatus, eqlBackplaneSN2=eqlBackplaneSN2, eqlBackplaneTable=eqlBackplaneTable, eqlSFPLength1=eqlSFPLength1, eqlSFPDateCode=eqlSFPDateCode, eqlemmConformance=eqlemmConformance, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlcontrollerModule=eqlcontrollerModule, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlControllerModel=eqlControllerModel, eqlControllerUpTime=eqlControllerUpTime, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlBackplaneRev=eqlBackplaneRev, eqlEMMIndex=eqlEMMIndex, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlBackplaneType=eqlBackplaneType, eqlControllerTable=eqlControllerTable, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlSFPBitrate=eqlSFPBitrate, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlEMMECO=eqlEMMECO, eqlChannelCardEntry=eqlChannelCardEntry, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlSFPStatus=eqlSFPStatus, eqlSFPEntry=eqlSFPEntry, eqlControllerCPUrev=eqlControllerCPUrev, eqlSFPLength2=eqlSFPLength2, eqlBackplaneDate=eqlBackplaneDate, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlDaughterCardDate=eqlDaughterCardDate, eqlControllerBootTime=eqlControllerBootTime, eqlBackplaneIndex=eqlBackplaneIndex, eqlControllerCMRevision=eqlControllerCMRevision, eqlControllerPhysRam=eqlControllerPhysRam, eqlemmObjects=eqlemmObjects, eqlControllerECO=eqlControllerECO, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlControllerIndex=eqlControllerIndex, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlControllerCPUPass=eqlControllerCPUPass, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlSFPConnector=eqlSFPConnector, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlBackplaneEntry=eqlBackplaneEntry, eqlbackplaneConformance=eqlbackplaneConformance, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlChannelCardTable=eqlChannelCardTable, eqlControllerPlatformType=eqlControllerPlatformType, eqlBackplaneECO=eqlBackplaneECO, eqlControllerType=eqlControllerType, eqlEMMModel=eqlEMMModel, eqlControllerDate=eqlControllerDate, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlbackplaneObjects=eqlbackplaneObjects, eqlSFPIndex=eqlSFPIndex, eqlControllerPLDrev=eqlControllerPLDrev, eqlDaughterCardTable=eqlDaughterCardTable, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlBackplaneSN=eqlBackplaneSN, eqlDaughterCardECO=eqlDaughterCardECO, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlControllerEEprom=eqlControllerEEprom, eqlSFPVendorName=eqlSFPVendorName, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlControllerEntry=eqlControllerEntry, eqlControllerSwRevision=eqlControllerSwRevision, eqlEMMRev=eqlEMMRev, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlsfpObjects=eqlsfpObjects, eqlSFPPartNumber=eqlSFPPartNumber, eqlEMMPartNum=eqlEMMPartNum, eqlEMMEEprom=eqlEMMEEprom, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlemmNotifications=eqlemmNotifications, eqlcontrollerConformance=eqlcontrollerConformance, eqlEMMTable=eqlEMMTable, eqlEMMDate=eqlEMMDate, eqlChannelCardIndex=eqlChannelCardIndex, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlEMMSN=eqlEMMSN, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlSFPTable=eqlSFPTable, eqldaughtercardObjects=eqldaughtercardObjects, eqlchannelcardObjects=eqlchannelcardObjects, eqlSFPMode=eqlSFPMode, eqlBackplanePartNum=eqlBackplanePartNum, eqlcontrollerObjects=eqlcontrollerObjects, eqlDaughterCardSN=eqlDaughterCardSN)
