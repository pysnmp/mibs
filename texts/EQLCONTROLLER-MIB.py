...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlControllerMajorVersion=eqlControllerMajorVersion, eqlBackplanePartNum=eqlBackplanePartNum, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlControllerSwRevision=eqlControllerSwRevision, eqlEMMDate=eqlEMMDate, eqlemmObjects=eqlemmObjects, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlchannelcardObjects=eqlchannelcardObjects, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlEMMPartNum=eqlEMMPartNum, eqlSFPIdentifier=eqlSFPIdentifier, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlsfpObjects=eqlsfpObjects, eqlemmConformance=eqlemmConformance, eqlControllerModel=eqlControllerModel, eqlSFPVendorName=eqlSFPVendorName, eqlSFPBitrate=eqlSFPBitrate, eqlControllerPLDrev=eqlControllerPLDrev, eqlDaughterCardTable=eqlDaughterCardTable, eqlEMMECO=eqlEMMECO, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlEMMEntry=eqlEMMEntry, eqlSFPIndex=eqlSFPIndex, eqlSFPLength1=eqlSFPLength1, eqldaughtercardObjects=eqldaughtercardObjects, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlBackplaneType=eqlBackplaneType, eqlDaughterCardECO=eqlDaughterCardECO, eqlChannelCardIndex=eqlChannelCardIndex, eqlBackplaneECO=eqlBackplaneECO, eqlSFPDateCode=eqlSFPDateCode, eqlSFPMode=eqlSFPMode, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlEMMEEprom=eqlEMMEEprom, eqlChannelCardEntry=eqlChannelCardEntry, eqlSFPConnector=eqlSFPConnector, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlControllerProcessorTemp=eqlControllerProcessorTemp, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlemmNotifications=eqlemmNotifications, eqlDaughterCardRev=eqlDaughterCardRev, eqlBackplaneSN2=eqlBackplaneSN2, eqlbackplaneConformance=eqlbackplaneConformance, eqlSFPIfIndex=eqlSFPIfIndex, eqlSFPLength2=eqlSFPLength2, eqlControllerECO=eqlControllerECO, eqlControllerPlatformType=eqlControllerPlatformType, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlControllerIndex=eqlControllerIndex, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlDaughterCardSN=eqlDaughterCardSN, eqlControllerCPUPass=eqlControllerCPUPass, eqlControllerCPUrev=eqlControllerCPUrev, eqlEMMSN2=eqlEMMSN2, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlBackplaneSN=eqlBackplaneSN, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlControllerEntry=eqlControllerEntry, eqlControllerTable=eqlControllerTable, eqlControllerUpTime=eqlControllerUpTime, eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlChannelCardTable=eqlChannelCardTable, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlbackplaneObjects=eqlbackplaneObjects, eqlSFPStatus=eqlSFPStatus, eqlEMMModel=eqlEMMModel, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlChannelCardStatus=eqlChannelCardStatus, eqlControllerCMRevision=eqlControllerCMRevision, eqlSFPTable=eqlSFPTable, eqlBackplaneDate=eqlBackplaneDate, eqldaughtercardConformance=eqldaughtercardConformance, eqlBackplaneIndex=eqlBackplaneIndex, eqlEMMIndex=eqlEMMIndex, eqlControllerDate=eqlControllerDate, eqlcontrollerConformance=eqlcontrollerConformance, eqlControllerType=eqlControllerType, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlBackplaneEntry=eqlBackplaneEntry, eqlSFPEntry=eqlSFPEntry, eqlBackplaneTable=eqlBackplaneTable, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlBackplaneRev=eqlBackplaneRev, eqlEMMSN=eqlEMMSN, eqlControllerPhysRam=eqlControllerPhysRam, eqlSFPPartNumber=eqlSFPPartNumber, eqlControllerEEprom=eqlControllerEEprom, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlcontrollerObjects=eqlcontrollerObjects, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlDaughterCardModel=eqlDaughterCardModel, eqlcontrollerModule=eqlcontrollerModule, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlEMMTable=eqlEMMTable, eqlDaughterCardDate=eqlDaughterCardDate, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlEMMRev=eqlEMMRev, eqlControllerBootTime=eqlControllerBootTime)
