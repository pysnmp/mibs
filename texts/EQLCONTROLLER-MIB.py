...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlDaughterCardDate=eqlDaughterCardDate, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlDaughterCardECO=eqlDaughterCardECO, eqlBackplaneSN=eqlBackplaneSN, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlEMMModel=eqlEMMModel, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlChannelCardTable=eqlChannelCardTable, eqlSFPLength1=eqlSFPLength1, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlEMMECO=eqlEMMECO, eqlSFPMode=eqlSFPMode, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlControllerUpTime=eqlControllerUpTime, eqlControllerEntry=eqlControllerEntry, eqlSFPIdentifier=eqlSFPIdentifier, eqlSFPStatus=eqlSFPStatus, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlBackplaneSN2=eqlBackplaneSN2, eqlsfpObjects=eqlsfpObjects, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlSFPTable=eqlSFPTable, eqlEMMIndex=eqlEMMIndex, eqlSFPBitrate=eqlSFPBitrate, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqlChannelCardStatus=eqlChannelCardStatus, eqlBackplaneECO=eqlBackplaneECO, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlControllerModel=eqlControllerModel, eqlControllerPhysRam=eqlControllerPhysRam, eqlBackplaneRev=eqlBackplaneRev, eqlControllerDate=eqlControllerDate, eqlSFPPartNumber=eqlSFPPartNumber, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlEMMRev=eqlEMMRev, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlBackplaneIndex=eqlBackplaneIndex, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlEMMDate=eqlEMMDate, eqlemmObjects=eqlemmObjects, eqlcontrollerObjects=eqlcontrollerObjects, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqlControllerEEprom=eqlControllerEEprom, eqlControllerTable=eqlControllerTable, eqlControllerChipsetTemp=eqlControllerChipsetTemp, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlSFPLength2=eqlSFPLength2, eqlControllerIndex=eqlControllerIndex, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlControllerPLDrev=eqlControllerPLDrev, eqlBackplanePartNum=eqlBackplanePartNum, eqlControllerCPUPass=eqlControllerCPUPass, eqlBackplaneType=eqlBackplaneType, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlBackplaneEntry=eqlBackplaneEntry, eqlEMMSN2=eqlEMMSN2, eqldaughtercardObjects=eqldaughtercardObjects, eqlbackplaneObjects=eqlbackplaneObjects, eqlbackplaneConformance=eqlbackplaneConformance, eqlControllerType=eqlControllerType, eqlemmNotifications=eqlemmNotifications, eqlemmConformance=eqlemmConformance, eqlBackplaneTable=eqlBackplaneTable, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlSFPIndex=eqlSFPIndex, eqlDaughterCardRev=eqlDaughterCardRev, eqldaughtercardConformance=eqldaughtercardConformance, eqlEMMSN=eqlEMMSN, eqlControllerCPUrev=eqlControllerCPUrev, eqlDaughterCardSN=eqlDaughterCardSN, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlEMMPartNum=eqlEMMPartNum, eqlControllerPlatformType=eqlControllerPlatformType, eqlDaughterCardTable=eqlDaughterCardTable, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlEMMEEprom=eqlEMMEEprom, eqlchannelcardObjects=eqlchannelcardObjects, eqlControllerECO=eqlControllerECO, eqlEMMTable=eqlEMMTable, eqlcontrollerConformance=eqlcontrollerConformance, eqlDaughterCardModel=eqlDaughterCardModel, eqlSFPEntry=eqlSFPEntry, eqlChannelCardIndex=eqlChannelCardIndex, eqlControllerCMRevision=eqlControllerCMRevision, eqlControllerBootTime=eqlControllerBootTime, eqlEMMEntry=eqlEMMEntry, eqlSFPConnector=eqlSFPConnector, eqlSFPDateCode=eqlSFPDateCode, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlControllerSwRevision=eqlControllerSwRevision, eqlChannelCardEntry=eqlChannelCardEntry, eqlcontrollerModule=eqlcontrollerModule, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlBackplaneDate=eqlBackplaneDate, eqlSFPVendorName=eqlSFPVendorName, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlSFPIfIndex=eqlSFPIfIndex)
