...
mibBuilder.exportSymbols("EQLCONTROLLER-MIB", eqlControllerFullSwRevision=eqlControllerFullSwRevision, eqlControllerPLDrev=eqlControllerPLDrev, eqlBackplaneIndex=eqlBackplaneIndex, eqlcontrollerConformance=eqlcontrollerConformance, eqlcontrollerModule=eqlcontrollerModule, eqlemmNotifications=eqlemmNotifications, eqlBackplaneDate=eqlBackplaneDate, eqlBackplaneSN=eqlBackplaneSN, eqlSFPStatus=eqlSFPStatus, eqlDaughterCardEntry=eqlDaughterCardEntry, eqlSFPTable=eqlSFPTable, eqlControllerPrimaryOrSecondary=eqlControllerPrimaryOrSecondary, eqlBackplaneEntry=eqlBackplaneEntry, eqlControllerTable=eqlControllerTable, eqlSFPConnector=eqlSFPConnector, eqlControllerCPUPass=eqlControllerCPUPass, eqlControllerInfoMsg=eqlControllerInfoMsg, eqlDaughterCardPartNum=eqlDaughterCardPartNum, eqlControllerDate=eqlControllerDate, eqlEMMModel=eqlEMMModel, eqlChannelCardSerialNumber=eqlChannelCardSerialNumber, eqlSFPIfIndex=eqlSFPIfIndex, eqlemmObjects=eqlemmObjects, eqldaughtercardObjects=eqldaughtercardObjects, eqlControllerSerialNumber2=eqlControllerSerialNumber2, eqlControllerSerialNumber=eqlControllerSerialNumber, eqlSFPLength2=eqlSFPLength2, eqlSFPVendorName=eqlSFPVendorName, eqlControllerUpTime=eqlControllerUpTime, eqlControllerPrimaryFlashImageRev=eqlControllerPrimaryFlashImageRev, eqlSFPBitrate=eqlSFPBitrate, eqlControllerPlatformVersion=eqlControllerPlatformVersion, eqlBackplaneECO=eqlBackplaneECO, eqlEMMRev=eqlEMMRev, eqlControllerType=eqlControllerType, eqlControllerMaintenanceVersion=eqlControllerMaintenanceVersion, eqlControllerCPUfreq=eqlControllerCPUfreq, eqlemmConformance=eqlemmConformance, eqlControllerBootRomBuildDate=eqlControllerBootRomBuildDate, eqlControllerEEprom=eqlControllerEEprom, eqlChannelCardInitRev=eqlChannelCardInitRev, eqlBackplaneType=eqlBackplaneType, eqlChannelCardTable=eqlChannelCardTable, eqlcontrollerNotifications=eqlcontrollerNotifications, eqlControllerBootRomVersion=eqlControllerBootRomVersion, eqlBackplaneRev=eqlBackplaneRev, eqlControllerAthenaSataVersion=eqlControllerAthenaSataVersion, eqlBackplaneSN2=eqlBackplaneSN2, eqlSFPMode=eqlSFPMode, eqlEMMDate=eqlEMMDate, eqlEMMEntry=eqlEMMEntry, eqlControllerNVRAMBattery=eqlControllerNVRAMBattery, eqlDaughterCardRev=eqlDaughterCardRev, eqlControllerSWCompatibilityLevel=eqlControllerSWCompatibilityLevel, eqlSFPSerialNumber=eqlSFPSerialNumber, eqlSFPPartNumber=eqlSFPPartNumber, eqlBackplaneTypeId=eqlBackplaneTypeId, eqlDaughterCardTable=eqlDaughterCardTable, eqlControllerCPUrev=eqlControllerCPUrev, eqlSFPDateCode=eqlSFPDateCode, eqlChannelCardIndex=eqlChannelCardIndex, eqlbackplaneConformance=eqlbackplaneConformance, eqlbackplaneObjects=eqlbackplaneObjects, eqlEMMECO=eqlEMMECO, eqlSFPLength1=eqlSFPLength1, eqlsfpObjects=eqlsfpObjects, eqlControllerMajorVersion=eqlControllerMajorVersion, eqlDaughterCardIndex=eqlDaughterCardIndex, eqlEMMEEprom=eqlEMMEEprom, eqlChannelCardStatus=eqlChannelCardStatus, eqlControllerBatteryStatus=eqlControllerBatteryStatus, eqlEMMIndex=eqlEMMIndex, eqlDaughterCardDate=eqlDaughterCardDate, eqlEMMSN=eqlEMMSN, eqlControllerECO=eqlControllerECO, eqlEMMTable=eqlEMMTable, eqlDaughterCardModel=eqlDaughterCardModel, eqlDaughterCardEEprom=eqlDaughterCardEEprom, eqlEMMPartNum=eqlEMMPartNum, eqlSFPFirmwareRev=eqlSFPFirmwareRev, eqlControllerPlatformType=eqlControllerPlatformType, eqlControllerMinorVersion=eqlControllerMinorVersion, eqlBackplaneEEprom=eqlBackplaneEEprom, eqlDaughterCardECO=eqlDaughterCardECO, eqlControllerBootTime=eqlControllerBootTime, eqlChannelCardEntry=eqlChannelCardEntry, eqlchannelcardObjects=eqlchannelcardObjects, eqlControllerIndex=eqlControllerIndex, eqlSFPEntry=eqlSFPEntry, PYSNMP_MODULE_ID=eqlcontrollerModule, eqlControllerModel=eqlControllerModel, eqlSFPIndex=eqlSFPIndex, eqldaughtercardConformance=eqldaughtercardConformance, eqlDaughterCardSN=eqlDaughterCardSN, eqlControllerChipsetTemp=eqlControllerChipsetTemp, eqlSFPIdentifier=eqlSFPIdentifier, eqlControllerEntry=eqlControllerEntry, eqlcontrollerObjects=eqlcontrollerObjects, eqlControllerProcessorTemp=eqlControllerProcessorTemp, eqlbackplaneNotifications=eqlbackplaneNotifications, eqlControllerPhysRam=eqlControllerPhysRam, eqlBackplaneTable=eqlBackplaneTable, eqlControllerSecondaryFlashImageRev=eqlControllerSecondaryFlashImageRev, eqlBackplanePartNum=eqlBackplanePartNum, eqldaughtercardNotifications=eqldaughtercardNotifications, eqlChannelCardFirmwareRev=eqlChannelCardFirmwareRev, eqlEMMSN2=eqlEMMSN2, eqlControllerSwRevision=eqlControllerSwRevision, eqlControllerCMRevision=eqlControllerCMRevision)
