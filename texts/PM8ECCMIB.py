...
MibIdentifier, Integer32, Gauge32, TimeTicks, NotificationType, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, ObjectIdentity, Bits, IpAddress, ModuleIdentity, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "Gauge32", "TimeTicks", "NotificationType", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "ObjectIdentity", "Bits", "IpAddress", "ModuleIdentity", "iso", "Counter32")
...
mibBuilder.exportSymbols("PM8ECCMIB", pdPresentPowerDemand=pdPresentPowerDemand, cdPhase=cdPhase, alarmCountersTable=alarmCountersTable, tfProducts=tfProducts, metering=metering, ioConfigurationEntry=ioConfigurationEntry, midSerialNumber=midSerialNumber, midFirmwareVersion=midFirmwareVersion, voltageTable=voltageTable, ioConfigurationTable=ioConfigurationTable, alarmSummaryBitmapsEntry=alarmSummaryBitmapsEntry, pm8OnBoardAlarmP1=pm8OnBoardAlarmP1, cdLastCurrentDemand=cdLastCurrentDemand, vVlnAvg=vVlnAvg, transparentFactoryEthernet=transparentFactoryEthernet, AlarmLabel=AlarmLabel, alarmDateAndTime=alarmDateAndTime, alSumAlarms33to48=alSumAlarms33to48, lcIa=lcIa, lcIc=lcIc, pApparent=pApparent, iocCount=iocCount, frequencyEntry=frequencyEntry, lcIb=lcIb, powerFactorEntry=powerFactorEntry, alSumAlarms65to74=alSumAlarms65to74, voltageEntry=voltageEntry, acIndex=acIndex, eDateTimeReactiveEnergyReset=eDateTimeReactiveEnergyReset, alSumAlarms1to16=alSumAlarms1to16, eRealEnergy=eRealEnergy, pdIndex=pdIndex, swtIndex=swtIndex, vVbc=vVbc, frequencyTable=frequencyTable, meterIdentificationEntry=meterIdentificationEntry, ioOptionIDTable=ioOptionIDTable, trapVariables=trapVariables, pfPowerFactorTotal=pfPowerFactorTotal, iocIndex=iocIndex, pm8OnBoardAlarmP3=pm8OnBoardAlarmP3, pfIndex=pfIndex, IOPointType=IOPointType, pReactive=pReactive, loadCurrentEntry=loadCurrentEntry, cdPhaseEnum=cdPhaseEnum, currentDemandTable=currentDemandTable, alarmCountersEntry=alarmCountersEntry, loadCurrentTable=loadCurrentTable, iocPointNumber=iocPointNumber, fIndex=fIndex, AlarmType=AlarmType, swtWiringType=swtWiringType, powerFactorTable=powerFactorTable, pIndex=pIndex, iocPointType=iocPointType, cdIndex=cdIndex, eDateTimeApparentEnergyReset=eDateTimeApparentEnergyReset, powerEntry=powerEntry, acEnabled=acEnabled, pdComponent=pdComponent, acAlarmLabel=acAlarmLabel, powerDemandEntry=powerDemandEntry, iocMode=iocMode, pReal=pReal, acType=acType, systemWiringTypeEntry=systemWiringTypeEntry, acCounter=acCounter, ioIDIndex=ioIDIndex, midDeviceName=midDeviceName, iocLabel=iocLabel, midIndex=midIndex, ioIDInstalledOptionSlot1=ioIDInstalledOptionSlot1, vVab=vVab, IOPointLabel=IOPointLabel, schneiderElectric=schneiderElectric, alSumAlarms17to32=alSumAlarms17to32, systemWiringTypeTable=systemWiringTypeTable, cdPeakCurrentDemand=cdPeakCurrentDemand, ioStatIndex=ioStatIndex, pm8OnBoardAlarmP2=pm8OnBoardAlarmP2, acPriority=acPriority, pfPowerFactorDescription=pfPowerFactorDescription, currentDemandEntry=currentDemandEntry, cdPresentCurrentDemand=cdPresentCurrentDemand, vVca=vVca, acStatus=acStatus, alCntIndex=alCntIndex, powerTable=powerTable, equipmentProfile=equipmentProfile, cdPeakDateTime=cdPeakDateTime, midModelNumber=midModelNumber, alarmSummaryBitmapsTable=alarmSummaryBitmapsTable, ioOptionIDEntry=ioOptionIDEntry, ioStatSummaryBitmap=ioStatSummaryBitmap, alarmState=alarmState, pdPeakPowerDemand=pdPeakPowerDemand, eDateTimeRealEnergyReset=eDateTimeRealEnergyReset, ecc=ecc, alarmValue=alarmValue, eApparentEnergy=eApparentEnergy, alSumIndex=alSumIndex, alarmConfigurationTable=alarmConfigurationTable, iocStateOrValue=iocStateOrValue, ioStatusBitmapsEntry=ioStatusBitmapsEntry, mibVersion=mibVersion, ioStatusBitmapsTable=ioStatusBitmapsTable, meterIdentificationTable=meterIdentificationTable, pm8ecc=pm8ecc, iocType=iocType, acAlarmList4=acAlarmList4, io=io, alCntCount=alCntCount, cdResetDateTime=cdResetDateTime, alarmLabel=alarmLabel, lcIAvg=lcIAvg, pdLastPowerDemand=pdLastPowerDemand, fFrequency=fFrequency, alSumAlarms49to64=alSumAlarms49to64, alarmConfigurationEntry=alarmConfigurationEntry, alCntAlarmPosition=alCntAlarmPosition, alarms=alarms, energyEntry=energyEntry, pdPeakDateTime=pdPeakDateTime, eReactiveEnergy=eReactiveEnergy, ioIDInstalledOptionSlot2=ioIDInstalledOptionSlot2, energyTable=energyTable, lcIndex=lcIndex, vVcn=vVcn, eIndex=eIndex, pdResetDateTime=pdResetDateTime, acAlarmList3=acAlarmList3, vVllAvg=vVllAvg, powerDemandTable=powerDemandTable, acAlarmList2=acAlarmList2, vVan=vVan, vIndex=vIndex, meterSystem=meterSystem, vVbn=vVbn, pdComponentEnum=pdComponentEnum, acPosition=acPosition, acAlarmList1=acAlarmList1, alarmPriority=alarmPriority)
