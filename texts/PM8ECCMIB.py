...
ObjectIdentity, NotificationType, TimeTicks, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, enterprises, Integer32, NotificationType, ModuleIdentity, Bits, IpAddress, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "TimeTicks", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "enterprises", "Integer32", "NotificationType", "ModuleIdentity", "Bits", "IpAddress", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("PM8ECCMIB", pReal=pReal, eRealEnergy=eRealEnergy, swtWiringType=swtWiringType, mibVersion=mibVersion, acAlarmList4=acAlarmList4, ioIDInstalledOptionSlot2=ioIDInstalledOptionSlot2, pdIndex=pdIndex, acPosition=acPosition, transparentFactoryEthernet=transparentFactoryEthernet, voltageTable=voltageTable, vVcn=vVcn, energyTable=energyTable, AlarmType=AlarmType, ioStatusBitmapsTable=ioStatusBitmapsTable, cdPhase=cdPhase, io=io, alSumAlarms33to48=alSumAlarms33to48, iocPointType=iocPointType, AlarmLabel=AlarmLabel, eDateTimeReactiveEnergyReset=eDateTimeReactiveEnergyReset, eIndex=eIndex, currentDemandEntry=currentDemandEntry, iocIndex=iocIndex, voltageEntry=voltageEntry, powerDemandTable=powerDemandTable, alarmConfigurationEntry=alarmConfigurationEntry, ioOptionIDTable=ioOptionIDTable, eApparentEnergy=eApparentEnergy, cdLastCurrentDemand=cdLastCurrentDemand, vVab=vVab, vVllAvg=vVllAvg, alarmCountersEntry=alarmCountersEntry, alarmSummaryBitmapsEntry=alarmSummaryBitmapsEntry, alSumAlarms49to64=alSumAlarms49to64, cdPeakCurrentDemand=cdPeakCurrentDemand, ioConfigurationEntry=ioConfigurationEntry, pApparent=pApparent, pReactive=pReactive, loadCurrentEntry=loadCurrentEntry, vVlnAvg=vVlnAvg, ioStatusBitmapsEntry=ioStatusBitmapsEntry, ioStatIndex=ioStatIndex, IOPointLabel=IOPointLabel, ioIDIndex=ioIDIndex, alarmDateAndTime=alarmDateAndTime, alarmLabel=alarmLabel, cdPresentCurrentDemand=cdPresentCurrentDemand, acAlarmLabel=acAlarmLabel, pIndex=pIndex, cdPhaseEnum=cdPhaseEnum, fIndex=fIndex, ecc=ecc, vVbn=vVbn, pdLastPowerDemand=pdLastPowerDemand, pdPeakDateTime=pdPeakDateTime, lcIndex=lcIndex, pdPeakPowerDemand=pdPeakPowerDemand, acEnabled=acEnabled, meterSystem=meterSystem, pm8ecc=pm8ecc, alarmPriority=alarmPriority, ioConfigurationTable=ioConfigurationTable, vVbc=vVbc, midSerialNumber=midSerialNumber, vIndex=vIndex, systemWiringTypeEntry=systemWiringTypeEntry, vVca=vVca, vVan=vVan, loadCurrentTable=loadCurrentTable, cdResetDateTime=cdResetDateTime, IOPointType=IOPointType, alSumAlarms65to74=alSumAlarms65to74, midFirmwareVersion=midFirmwareVersion, lcIc=lcIc, powerFactorEntry=powerFactorEntry, cdIndex=cdIndex, cdPeakDateTime=cdPeakDateTime, powerDemandEntry=powerDemandEntry, ioIDInstalledOptionSlot1=ioIDInstalledOptionSlot1, pfPowerFactorTotal=pfPowerFactorTotal, iocStateOrValue=iocStateOrValue, midDeviceName=midDeviceName, acAlarmList2=acAlarmList2, alSumAlarms17to32=alSumAlarms17to32, frequencyTable=frequencyTable, alSumAlarms1to16=alSumAlarms1to16, eDateTimeApparentEnergyReset=eDateTimeApparentEnergyReset, pdResetDateTime=pdResetDateTime, meterIdentificationEntry=meterIdentificationEntry, fFrequency=fFrequency, pm8OnBoardAlarmP2=pm8OnBoardAlarmP2, eReactiveEnergy=eReactiveEnergy, alarmValue=alarmValue, acIndex=acIndex, ioOptionIDEntry=ioOptionIDEntry, powerTable=powerTable, pm8OnBoardAlarmP1=pm8OnBoardAlarmP1, acAlarmList1=acAlarmList1, acType=acType, lcIAvg=lcIAvg, acStatus=acStatus, acCounter=acCounter, acPriority=acPriority, pfIndex=pfIndex, tfProducts=tfProducts, alarmSummaryBitmapsTable=alarmSummaryBitmapsTable, systemWiringTypeTable=systemWiringTypeTable, alarmCountersTable=alarmCountersTable, midIndex=midIndex, trapVariables=trapVariables, ioStatSummaryBitmap=ioStatSummaryBitmap, frequencyEntry=frequencyEntry, alCntCount=alCntCount, alarms=alarms, pdPresentPowerDemand=pdPresentPowerDemand, schneiderElectric=schneiderElectric, iocType=iocType, currentDemandTable=currentDemandTable, alarmState=alarmState, equipmentProfile=equipmentProfile, eDateTimeRealEnergyReset=eDateTimeRealEnergyReset, iocCount=iocCount, powerFactorTable=powerFactorTable, acAlarmList3=acAlarmList3, swtIndex=swtIndex, pdComponentEnum=pdComponentEnum, meterIdentificationTable=meterIdentificationTable, lcIb=lcIb, metering=metering, pdComponent=pdComponent, alCntIndex=alCntIndex, iocMode=iocMode, pfPowerFactorDescription=pfPowerFactorDescription, powerEntry=powerEntry, lcIa=lcIa, energyEntry=energyEntry, pm8OnBoardAlarmP3=pm8OnBoardAlarmP3, alarmConfigurationTable=alarmConfigurationTable, alCntAlarmPosition=alCntAlarmPosition, midModelNumber=midModelNumber, iocLabel=iocLabel, alSumIndex=alSumIndex, iocPointNumber=iocPointNumber)
