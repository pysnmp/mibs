...
Counter32, NotificationType, ObjectIdentity, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, ModuleIdentity, iso, Gauge32, NotificationType, IpAddress, Bits, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "ModuleIdentity", "iso", "Gauge32", "NotificationType", "IpAddress", "Bits", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("PM8ECCMIB", eReactiveEnergy=eReactiveEnergy, trapVariables=trapVariables, IOPointType=IOPointType, pdIndex=pdIndex, lcIa=lcIa, acAlarmList1=acAlarmList1, midIndex=midIndex, iocPointNumber=iocPointNumber, midDeviceName=midDeviceName, vIndex=vIndex, iocStateOrValue=iocStateOrValue, alarmValue=alarmValue, transparentFactoryEthernet=transparentFactoryEthernet, vVan=vVan, acAlarmList2=acAlarmList2, vVab=vVab, cdPhaseEnum=cdPhaseEnum, acAlarmList4=acAlarmList4, alarmSummaryBitmapsTable=alarmSummaryBitmapsTable, tfProducts=tfProducts, iocPointType=iocPointType, cdIndex=cdIndex, voltageEntry=voltageEntry, fFrequency=fFrequency, cdPeakCurrentDemand=cdPeakCurrentDemand, alarmCountersEntry=alarmCountersEntry, alCntCount=alCntCount, eApparentEnergy=eApparentEnergy, alSumAlarms49to64=alSumAlarms49to64, midSerialNumber=midSerialNumber, systemWiringTypeEntry=systemWiringTypeEntry, powerDemandTable=powerDemandTable, alarmPriority=alarmPriority, eIndex=eIndex, acIndex=acIndex, energyEntry=energyEntry, meterIdentificationTable=meterIdentificationTable, ioOptionIDEntry=ioOptionIDEntry, alarmLabel=alarmLabel, alarmSummaryBitmapsEntry=alarmSummaryBitmapsEntry, lcIAvg=lcIAvg, currentDemandEntry=currentDemandEntry, pfPowerFactorTotal=pfPowerFactorTotal, lcIb=lcIb, alarmDateAndTime=alarmDateAndTime, cdResetDateTime=cdResetDateTime, pReactive=pReactive, cdPresentCurrentDemand=cdPresentCurrentDemand, cdPhase=cdPhase, alarmConfigurationEntry=alarmConfigurationEntry, alSumAlarms65to74=alSumAlarms65to74, pm8OnBoardAlarmP1=pm8OnBoardAlarmP1, vVcn=vVcn, cdLastCurrentDemand=cdLastCurrentDemand, iocLabel=iocLabel, pm8OnBoardAlarmP2=pm8OnBoardAlarmP2, AlarmLabel=AlarmLabel, eRealEnergy=eRealEnergy, alSumIndex=alSumIndex, ioStatSummaryBitmap=ioStatSummaryBitmap, ioOptionIDTable=ioOptionIDTable, ioConfigurationEntry=ioConfigurationEntry, vVllAvg=vVllAvg, acAlarmLabel=acAlarmLabel, pfPowerFactorDescription=pfPowerFactorDescription, alCntAlarmPosition=alCntAlarmPosition, ioIDInstalledOptionSlot1=ioIDInstalledOptionSlot1, alSumAlarms1to16=alSumAlarms1to16, acStatus=acStatus, pm8ecc=pm8ecc, alSumAlarms17to32=alSumAlarms17to32, alCntIndex=alCntIndex, vVbc=vVbc, pdComponentEnum=pdComponentEnum, ioStatusBitmapsTable=ioStatusBitmapsTable, midFirmwareVersion=midFirmwareVersion, meterIdentificationEntry=meterIdentificationEntry, swtWiringType=swtWiringType, AlarmType=AlarmType, powerTable=powerTable, currentDemandTable=currentDemandTable, acPosition=acPosition, pApparent=pApparent, acPriority=acPriority, fIndex=fIndex, vVlnAvg=vVlnAvg, loadCurrentTable=loadCurrentTable, loadCurrentEntry=loadCurrentEntry, ioIDIndex=ioIDIndex, iocType=iocType, pdResetDateTime=pdResetDateTime, iocIndex=iocIndex, metering=metering, ioConfigurationTable=ioConfigurationTable, io=io, cdPeakDateTime=cdPeakDateTime, energyTable=energyTable, alarmCountersTable=alarmCountersTable, powerFactorEntry=powerFactorEntry, acAlarmList3=acAlarmList3, iocMode=iocMode, alarmConfigurationTable=alarmConfigurationTable, pdComponent=pdComponent, alarmState=alarmState, powerFactorTable=powerFactorTable, frequencyEntry=frequencyEntry, pdPeakDateTime=pdPeakDateTime, frequencyTable=frequencyTable, swtIndex=swtIndex, ioStatIndex=ioStatIndex, midModelNumber=midModelNumber, lcIndex=lcIndex, powerEntry=powerEntry, ioStatusBitmapsEntry=ioStatusBitmapsEntry, systemWiringTypeTable=systemWiringTypeTable, pIndex=pIndex, voltageTable=voltageTable, ioIDInstalledOptionSlot2=ioIDInstalledOptionSlot2, meterSystem=meterSystem, acCounter=acCounter, eDateTimeRealEnergyReset=eDateTimeRealEnergyReset, eDateTimeReactiveEnergyReset=eDateTimeReactiveEnergyReset, alarms=alarms, equipmentProfile=equipmentProfile, acEnabled=acEnabled, pm8OnBoardAlarmP3=pm8OnBoardAlarmP3, IOPointLabel=IOPointLabel, alSumAlarms33to48=alSumAlarms33to48, pdLastPowerDemand=pdLastPowerDemand, eDateTimeApparentEnergyReset=eDateTimeApparentEnergyReset, mibVersion=mibVersion, acType=acType, vVca=vVca, pdPresentPowerDemand=pdPresentPowerDemand, lcIc=lcIc, vVbn=vVbn, powerDemandEntry=powerDemandEntry, pReal=pReal, iocCount=iocCount, ecc=ecc, pfIndex=pfIndex, schneiderElectric=schneiderElectric, pdPeakPowerDemand=pdPeakPowerDemand)
