...
Bits, Unsigned32, TimeTicks, Counter64, Counter32, ObjectIdentity, enterprises, ModuleIdentity, iso, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "TimeTicks", "Counter64", "Counter32", "ObjectIdentity", "enterprises", "ModuleIdentity", "iso", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("PM8ECCMIB", alCntAlarmPosition=alCntAlarmPosition, fFrequency=fFrequency, acAlarmList4=acAlarmList4, meterIdentificationTable=meterIdentificationTable, ioStatusBitmapsEntry=ioStatusBitmapsEntry, cdPeakDateTime=cdPeakDateTime, acAlarmList3=acAlarmList3, eDateTimeReactiveEnergyReset=eDateTimeReactiveEnergyReset, alCntCount=alCntCount, alarmState=alarmState, iocType=iocType, frequencyEntry=frequencyEntry, pApparent=pApparent, vVlnAvg=vVlnAvg, midFirmwareVersion=midFirmwareVersion, pm8OnBoardAlarmP2=pm8OnBoardAlarmP2, AlarmLabel=AlarmLabel, eIndex=eIndex, powerFactorTable=powerFactorTable, alarmConfigurationTable=alarmConfigurationTable, eApparentEnergy=eApparentEnergy, powerFactorEntry=powerFactorEntry, vVllAvg=vVllAvg, acPriority=acPriority, midIndex=midIndex, vVbc=vVbc, powerEntry=powerEntry, lcIc=lcIc, cdResetDateTime=cdResetDateTime, midSerialNumber=midSerialNumber, IOPointType=IOPointType, energyEntry=energyEntry, voltageEntry=voltageEntry, alarmLabel=alarmLabel, alarmValue=alarmValue, cdPresentCurrentDemand=cdPresentCurrentDemand, ioConfigurationTable=ioConfigurationTable, energyTable=energyTable, pfPowerFactorTotal=pfPowerFactorTotal, alSumAlarms17to32=alSumAlarms17to32, pm8OnBoardAlarmP3=pm8OnBoardAlarmP3, IOPointLabel=IOPointLabel, meterIdentificationEntry=meterIdentificationEntry, loadCurrentEntry=loadCurrentEntry, pdResetDateTime=pdResetDateTime, pReal=pReal, vVcn=vVcn, frequencyTable=frequencyTable, iocCount=iocCount, loadCurrentTable=loadCurrentTable, ioIDIndex=ioIDIndex, ioStatusBitmapsTable=ioStatusBitmapsTable, AlarmType=AlarmType, iocPointNumber=iocPointNumber, equipmentProfile=equipmentProfile, alarmPriority=alarmPriority, vVab=vVab, ioIDInstalledOptionSlot1=ioIDInstalledOptionSlot1, pdPeakDateTime=pdPeakDateTime, currentDemandTable=currentDemandTable, powerDemandTable=powerDemandTable, iocStateOrValue=iocStateOrValue, io=io, eReactiveEnergy=eReactiveEnergy, alSumAlarms33to48=alSumAlarms33to48, voltageTable=voltageTable, schneiderElectric=schneiderElectric, acAlarmList1=acAlarmList1, iocMode=iocMode, eDateTimeApparentEnergyReset=eDateTimeApparentEnergyReset, pdPeakPowerDemand=pdPeakPowerDemand, alarmCountersTable=alarmCountersTable, pIndex=pIndex, pdLastPowerDemand=pdLastPowerDemand, mibVersion=mibVersion, iocIndex=iocIndex, ioOptionIDTable=ioOptionIDTable, acStatus=acStatus, pfIndex=pfIndex, alarmConfigurationEntry=alarmConfigurationEntry, alSumIndex=alSumIndex, alSumAlarms49to64=alSumAlarms49to64, tfProducts=tfProducts, ioOptionIDEntry=ioOptionIDEntry, lcIAvg=lcIAvg, currentDemandEntry=currentDemandEntry, lcIndex=lcIndex, vVca=vVca, pdIndex=pdIndex, swtWiringType=swtWiringType, powerTable=powerTable, ioIDInstalledOptionSlot2=ioIDInstalledOptionSlot2, fIndex=fIndex, acIndex=acIndex, swtIndex=swtIndex, cdPhase=cdPhase, midDeviceName=midDeviceName, meterSystem=meterSystem, systemWiringTypeTable=systemWiringTypeTable, pm8ecc=pm8ecc, metering=metering, acAlarmList2=acAlarmList2, ioStatIndex=ioStatIndex, ecc=ecc, pm8OnBoardAlarmP1=pm8OnBoardAlarmP1, eDateTimeRealEnergyReset=eDateTimeRealEnergyReset, iocLabel=iocLabel, eRealEnergy=eRealEnergy, cdIndex=cdIndex, pdComponent=pdComponent, pdComponentEnum=pdComponentEnum, lcIb=lcIb, pfPowerFactorDescription=pfPowerFactorDescription, cdLastCurrentDemand=cdLastCurrentDemand, alCntIndex=alCntIndex, systemWiringTypeEntry=systemWiringTypeEntry, ioStatSummaryBitmap=ioStatSummaryBitmap, cdPeakCurrentDemand=cdPeakCurrentDemand, alarmSummaryBitmapsTable=alarmSummaryBitmapsTable, midModelNumber=midModelNumber, alarmCountersEntry=alarmCountersEntry, acAlarmLabel=acAlarmLabel, acEnabled=acEnabled, alarmSummaryBitmapsEntry=alarmSummaryBitmapsEntry, alarmDateAndTime=alarmDateAndTime, acType=acType, alSumAlarms1to16=alSumAlarms1to16, vVbn=vVbn, alarms=alarms, acPosition=acPosition, alSumAlarms65to74=alSumAlarms65to74, pReactive=pReactive, acCounter=acCounter, trapVariables=trapVariables, vIndex=vIndex, powerDemandEntry=powerDemandEntry, lcIa=lcIa, cdPhaseEnum=cdPhaseEnum, ioConfigurationEntry=ioConfigurationEntry, pdPresentPowerDemand=pdPresentPowerDemand, iocPointType=iocPointType, vVan=vVan, transparentFactoryEthernet=transparentFactoryEthernet)
