...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Integer32, Bits, Counter32, NotificationType, NotificationType, enterprises, TimeTicks, ModuleIdentity, IpAddress, MibIdentifier, Counter64, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Integer32", "Bits", "Counter32", "NotificationType", "NotificationType", "enterprises", "TimeTicks", "ModuleIdentity", "IpAddress", "MibIdentifier", "Counter64", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("PM8ECCMIB", acStatus=acStatus, eReactiveEnergy=eReactiveEnergy, ioOptionIDTable=ioOptionIDTable, cdIndex=cdIndex, pm8OnBoardAlarmP3=pm8OnBoardAlarmP3, iocIndex=iocIndex, ioStatSummaryBitmap=ioStatSummaryBitmap, pfPowerFactorDescription=pfPowerFactorDescription, alSumAlarms65to74=alSumAlarms65to74, cdPeakCurrentDemand=cdPeakCurrentDemand, currentDemandTable=currentDemandTable, alarmConfigurationEntry=alarmConfigurationEntry, iocPointType=iocPointType, lcIc=lcIc, pdComponent=pdComponent, cdPhaseEnum=cdPhaseEnum, pIndex=pIndex, eDateTimeReactiveEnergyReset=eDateTimeReactiveEnergyReset, pdLastPowerDemand=pdLastPowerDemand, midFirmwareVersion=midFirmwareVersion, pfPowerFactorTotal=pfPowerFactorTotal, acAlarmList3=acAlarmList3, acAlarmLabel=acAlarmLabel, fIndex=fIndex, vVbn=vVbn, powerDemandTable=powerDemandTable, cdLastCurrentDemand=cdLastCurrentDemand, ioStatusBitmapsEntry=ioStatusBitmapsEntry, lcIAvg=lcIAvg, alarms=alarms, vVab=vVab, ioStatusBitmapsTable=ioStatusBitmapsTable, alarmSummaryBitmapsEntry=alarmSummaryBitmapsEntry, lcIb=lcIb, mibVersion=mibVersion, acPosition=acPosition, iocCount=iocCount, cdPhase=cdPhase, loadCurrentTable=loadCurrentTable, alSumAlarms33to48=alSumAlarms33to48, trapVariables=trapVariables, pfIndex=pfIndex, swtIndex=swtIndex, AlarmLabel=AlarmLabel, vIndex=vIndex, alarmPriority=alarmPriority, acCounter=acCounter, ioConfigurationEntry=ioConfigurationEntry, midSerialNumber=midSerialNumber, ecc=ecc, vVlnAvg=vVlnAvg, eIndex=eIndex, alCntIndex=alCntIndex, alarmConfigurationTable=alarmConfigurationTable, voltageEntry=voltageEntry, acAlarmList4=acAlarmList4, alSumAlarms49to64=alSumAlarms49to64, vVca=vVca, IOPointType=IOPointType, frequencyEntry=frequencyEntry, cdPeakDateTime=cdPeakDateTime, pApparent=pApparent, metering=metering, alSumIndex=alSumIndex, powerEntry=powerEntry, midModelNumber=midModelNumber, ioIDIndex=ioIDIndex, iocMode=iocMode, pdResetDateTime=pdResetDateTime, energyEntry=energyEntry, alarmState=alarmState, ioConfigurationTable=ioConfigurationTable, transparentFactoryEthernet=transparentFactoryEthernet, pdPeakDateTime=pdPeakDateTime, lcIndex=lcIndex, powerTable=powerTable, cdPresentCurrentDemand=cdPresentCurrentDemand, ioStatIndex=ioStatIndex, ioIDInstalledOptionSlot1=ioIDInstalledOptionSlot1, alarmLabel=alarmLabel, pdComponentEnum=pdComponentEnum, iocType=iocType, frequencyTable=frequencyTable, iocStateOrValue=iocStateOrValue, vVllAvg=vVllAvg, alarmSummaryBitmapsTable=alarmSummaryBitmapsTable, powerDemandEntry=powerDemandEntry, vVcn=vVcn, acEnabled=acEnabled, pdIndex=pdIndex, pdPresentPowerDemand=pdPresentPowerDemand, iocLabel=iocLabel, tfProducts=tfProducts, alarmDateAndTime=alarmDateAndTime, acAlarmList1=acAlarmList1, pReal=pReal, midIndex=midIndex, pdPeakPowerDemand=pdPeakPowerDemand, IOPointLabel=IOPointLabel, meterIdentificationTable=meterIdentificationTable, eApparentEnergy=eApparentEnergy, eDateTimeApparentEnergyReset=eDateTimeApparentEnergyReset, swtWiringType=swtWiringType, vVan=vVan, currentDemandEntry=currentDemandEntry, midDeviceName=midDeviceName, systemWiringTypeTable=systemWiringTypeTable, powerFactorTable=powerFactorTable, systemWiringTypeEntry=systemWiringTypeEntry, lcIa=lcIa, pReactive=pReactive, alSumAlarms17to32=alSumAlarms17to32, cdResetDateTime=cdResetDateTime, acIndex=acIndex, alCntCount=alCntCount, eDateTimeRealEnergyReset=eDateTimeRealEnergyReset, meterSystem=meterSystem, ioOptionIDEntry=ioOptionIDEntry, eRealEnergy=eRealEnergy, acType=acType, pm8OnBoardAlarmP2=pm8OnBoardAlarmP2, energyTable=energyTable, alarmCountersTable=alarmCountersTable, iocPointNumber=iocPointNumber, pm8ecc=pm8ecc, ioIDInstalledOptionSlot2=ioIDInstalledOptionSlot2, alSumAlarms1to16=alSumAlarms1to16, powerFactorEntry=powerFactorEntry, voltageTable=voltageTable, pm8OnBoardAlarmP1=pm8OnBoardAlarmP1, alarmValue=alarmValue, vVbc=vVbc, meterIdentificationEntry=meterIdentificationEntry, acAlarmList2=acAlarmList2, alarmCountersEntry=alarmCountersEntry, loadCurrentEntry=loadCurrentEntry, AlarmType=AlarmType, schneiderElectric=schneiderElectric, acPriority=acPriority, fFrequency=fFrequency, io=io, alCntAlarmPosition=alCntAlarmPosition, equipmentProfile=equipmentProfile)
