...
TimeTicks, Integer32, NotificationType, Gauge32, MibIdentifier, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, Unsigned32, IpAddress, Bits, Counter64, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "NotificationType", "Gauge32", "MibIdentifier", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "IpAddress", "Bits", "Counter64", "iso", "Counter32")
...
mibBuilder.exportSymbols("PM8ECCMIB", ioStatusBitmapsTable=ioStatusBitmapsTable, acAlarmList1=acAlarmList1, pm8OnBoardAlarmP3=pm8OnBoardAlarmP3, eReactiveEnergy=eReactiveEnergy, alarmConfigurationTable=alarmConfigurationTable, alarms=alarms, iocPointType=iocPointType, pdPeakDateTime=pdPeakDateTime, vVca=vVca, eRealEnergy=eRealEnergy, powerFactorEntry=powerFactorEntry, powerDemandTable=powerDemandTable, ioIDInstalledOptionSlot1=ioIDInstalledOptionSlot1, vVbn=vVbn, iocType=iocType, trapVariables=trapVariables, meterIdentificationTable=meterIdentificationTable, cdPresentCurrentDemand=cdPresentCurrentDemand, acPosition=acPosition, alCntCount=alCntCount, alSumAlarms33to48=alSumAlarms33to48, alarmDateAndTime=alarmDateAndTime, alarmValue=alarmValue, alarmConfigurationEntry=alarmConfigurationEntry, iocMode=iocMode, meterSystem=meterSystem, eIndex=eIndex, AlarmType=AlarmType, iocIndex=iocIndex, alarmCountersTable=alarmCountersTable, cdPhase=cdPhase, alSumAlarms17to32=alSumAlarms17to32, midFirmwareVersion=midFirmwareVersion, pfPowerFactorDescription=pfPowerFactorDescription, acEnabled=acEnabled, voltageTable=voltageTable, midIndex=midIndex, pm8ecc=pm8ecc, lcIndex=lcIndex, eDateTimeRealEnergyReset=eDateTimeRealEnergyReset, pIndex=pIndex, pdPeakPowerDemand=pdPeakPowerDemand, alarmLabel=alarmLabel, systemWiringTypeTable=systemWiringTypeTable, acStatus=acStatus, vVan=vVan, alSumAlarms65to74=alSumAlarms65to74, swtWiringType=swtWiringType, acIndex=acIndex, midSerialNumber=midSerialNumber, pdPresentPowerDemand=pdPresentPowerDemand, acAlarmLabel=acAlarmLabel, lcIb=lcIb, cdIndex=cdIndex, alarmCountersEntry=alarmCountersEntry, pm8OnBoardAlarmP2=pm8OnBoardAlarmP2, energyTable=energyTable, pdIndex=pdIndex, powerEntry=powerEntry, alSumAlarms49to64=alSumAlarms49to64, pdComponentEnum=pdComponentEnum, ioStatIndex=ioStatIndex, acType=acType, pfIndex=pfIndex, lcIa=lcIa, systemWiringTypeEntry=systemWiringTypeEntry, pfPowerFactorTotal=pfPowerFactorTotal, ioStatSummaryBitmap=ioStatSummaryBitmap, alSumIndex=alSumIndex, eDateTimeReactiveEnergyReset=eDateTimeReactiveEnergyReset, cdPeakCurrentDemand=cdPeakCurrentDemand, alCntIndex=alCntIndex, mibVersion=mibVersion, fFrequency=fFrequency, iocPointNumber=iocPointNumber, fIndex=fIndex, ioOptionIDTable=ioOptionIDTable, ioConfigurationEntry=ioConfigurationEntry, cdPhaseEnum=cdPhaseEnum, alarmSummaryBitmapsTable=alarmSummaryBitmapsTable, vVlnAvg=vVlnAvg, alCntAlarmPosition=alCntAlarmPosition, powerFactorTable=powerFactorTable, ioIDInstalledOptionSlot2=ioIDInstalledOptionSlot2, IOPointLabel=IOPointLabel, powerDemandEntry=powerDemandEntry, currentDemandEntry=currentDemandEntry, io=io, energyEntry=energyEntry, frequencyEntry=frequencyEntry, acAlarmList2=acAlarmList2, schneiderElectric=schneiderElectric, pReactive=pReactive, vIndex=vIndex, swtIndex=swtIndex, alarmPriority=alarmPriority, cdLastCurrentDemand=cdLastCurrentDemand, acPriority=acPriority, acAlarmList4=acAlarmList4, lcIc=lcIc, pm8OnBoardAlarmP1=pm8OnBoardAlarmP1, cdPeakDateTime=cdPeakDateTime, pdLastPowerDemand=pdLastPowerDemand, transparentFactoryEthernet=transparentFactoryEthernet, loadCurrentEntry=loadCurrentEntry, pReal=pReal, IOPointType=IOPointType, acAlarmList3=acAlarmList3, metering=metering, loadCurrentTable=loadCurrentTable, iocCount=iocCount, iocStateOrValue=iocStateOrValue, alSumAlarms1to16=alSumAlarms1to16, midModelNumber=midModelNumber, alarmSummaryBitmapsEntry=alarmSummaryBitmapsEntry, vVllAvg=vVllAvg, pdComponent=pdComponent, lcIAvg=lcIAvg, AlarmLabel=AlarmLabel, ioOptionIDEntry=ioOptionIDEntry, pdResetDateTime=pdResetDateTime, ioConfigurationTable=ioConfigurationTable, midDeviceName=midDeviceName, vVcn=vVcn, frequencyTable=frequencyTable, tfProducts=tfProducts, acCounter=acCounter, alarmState=alarmState, ecc=ecc, powerTable=powerTable, ioIDIndex=ioIDIndex, voltageEntry=voltageEntry, vVab=vVab, ioStatusBitmapsEntry=ioStatusBitmapsEntry, eDateTimeApparentEnergyReset=eDateTimeApparentEnergyReset, pApparent=pApparent, meterIdentificationEntry=meterIdentificationEntry, currentDemandTable=currentDemandTable, vVbc=vVbc, equipmentProfile=equipmentProfile, eApparentEnergy=eApparentEnergy, cdResetDateTime=cdResetDateTime, iocLabel=iocLabel)
