...
ObjectIdentity, Integer32, Unsigned32, IpAddress, Counter64, ModuleIdentity, Gauge32, Bits, MibIdentifier, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, NotificationType, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "Unsigned32", "IpAddress", "Counter64", "ModuleIdentity", "Gauge32", "Bits", "MibIdentifier", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "NotificationType", "NotificationType")
...
mibBuilder.exportSymbols("PM8ECCMIB", pdLastPowerDemand=pdLastPowerDemand, transparentFactoryEthernet=transparentFactoryEthernet, frequencyTable=frequencyTable, eReactiveEnergy=eReactiveEnergy, vVbn=vVbn, fFrequency=fFrequency, midModelNumber=midModelNumber, pdComponentEnum=pdComponentEnum, alarmSummaryBitmapsEntry=alarmSummaryBitmapsEntry, eDateTimeRealEnergyReset=eDateTimeRealEnergyReset, acStatus=acStatus, pdIndex=pdIndex, AlarmType=AlarmType, acAlarmList1=acAlarmList1, ioStatIndex=ioStatIndex, AlarmLabel=AlarmLabel, ioOptionIDTable=ioOptionIDTable, alarmDateAndTime=alarmDateAndTime, vVlnAvg=vVlnAvg, midDeviceName=midDeviceName, midIndex=midIndex, pm8OnBoardAlarmP3=pm8OnBoardAlarmP3, alCntAlarmPosition=alCntAlarmPosition, iocMode=iocMode, pdPresentPowerDemand=pdPresentPowerDemand, pfPowerFactorDescription=pfPowerFactorDescription, pReactive=pReactive, pm8OnBoardAlarmP1=pm8OnBoardAlarmP1, powerEntry=powerEntry, alarmConfigurationTable=alarmConfigurationTable, voltageTable=voltageTable, swtWiringType=swtWiringType, ioConfigurationTable=ioConfigurationTable, pIndex=pIndex, cdResetDateTime=cdResetDateTime, cdLastCurrentDemand=cdLastCurrentDemand, eApparentEnergy=eApparentEnergy, iocPointType=iocPointType, vIndex=vIndex, pdPeakDateTime=pdPeakDateTime, powerFactorTable=powerFactorTable, iocLabel=iocLabel, eDateTimeApparentEnergyReset=eDateTimeApparentEnergyReset, acPosition=acPosition, midSerialNumber=midSerialNumber, alSumAlarms1to16=alSumAlarms1to16, vVbc=vVbc, mibVersion=mibVersion, pfIndex=pfIndex, ioStatSummaryBitmap=ioStatSummaryBitmap, IOPointLabel=IOPointLabel, alSumAlarms33to48=alSumAlarms33to48, frequencyEntry=frequencyEntry, iocType=iocType, alarmLabel=alarmLabel, ioIDIndex=ioIDIndex, ioIDInstalledOptionSlot1=ioIDInstalledOptionSlot1, alCntCount=alCntCount, meterIdentificationTable=meterIdentificationTable, swtIndex=swtIndex, alarmPriority=alarmPriority, acType=acType, ecc=ecc, acEnabled=acEnabled, lcIndex=lcIndex, IOPointType=IOPointType, alarmCountersTable=alarmCountersTable, alarmSummaryBitmapsTable=alarmSummaryBitmapsTable, cdPresentCurrentDemand=cdPresentCurrentDemand, ioStatusBitmapsEntry=ioStatusBitmapsEntry, cdPhase=cdPhase, pdPeakPowerDemand=pdPeakPowerDemand, vVan=vVan, powerFactorEntry=powerFactorEntry, vVab=vVab, iocIndex=iocIndex, alSumAlarms65to74=alSumAlarms65to74, alCntIndex=alCntIndex, acCounter=acCounter, cdPeakCurrentDemand=cdPeakCurrentDemand, equipmentProfile=equipmentProfile, lcIb=lcIb, eDateTimeReactiveEnergyReset=eDateTimeReactiveEnergyReset, alSumAlarms17to32=alSumAlarms17to32, eIndex=eIndex, pdResetDateTime=pdResetDateTime, io=io, pReal=pReal, acIndex=acIndex, iocCount=iocCount, fIndex=fIndex, energyEntry=energyEntry, meterSystem=meterSystem, powerDemandTable=powerDemandTable, ioIDInstalledOptionSlot2=ioIDInstalledOptionSlot2, cdPhaseEnum=cdPhaseEnum, iocStateOrValue=iocStateOrValue, pfPowerFactorTotal=pfPowerFactorTotal, midFirmwareVersion=midFirmwareVersion, voltageEntry=voltageEntry, powerTable=powerTable, vVca=vVca, lcIa=lcIa, alSumIndex=alSumIndex, acAlarmList3=acAlarmList3, acAlarmList4=acAlarmList4, trapVariables=trapVariables, cdPeakDateTime=cdPeakDateTime, metering=metering, loadCurrentTable=loadCurrentTable, currentDemandTable=currentDemandTable, currentDemandEntry=currentDemandEntry, schneiderElectric=schneiderElectric, alarmCountersEntry=alarmCountersEntry, loadCurrentEntry=loadCurrentEntry, lcIAvg=lcIAvg, lcIc=lcIc, pdComponent=pdComponent, systemWiringTypeTable=systemWiringTypeTable, vVllAvg=vVllAvg, alarmValue=alarmValue, alarmConfigurationEntry=alarmConfigurationEntry, iocPointNumber=iocPointNumber, alarmState=alarmState, alarms=alarms, ioOptionIDEntry=ioOptionIDEntry, acAlarmLabel=acAlarmLabel, pApparent=pApparent, pm8ecc=pm8ecc, acAlarmList2=acAlarmList2, eRealEnergy=eRealEnergy, meterIdentificationEntry=meterIdentificationEntry, systemWiringTypeEntry=systemWiringTypeEntry, powerDemandEntry=powerDemandEntry, energyTable=energyTable, vVcn=vVcn, acPriority=acPriority, tfProducts=tfProducts, ioConfigurationEntry=ioConfigurationEntry, pm8OnBoardAlarmP2=pm8OnBoardAlarmP2, cdIndex=cdIndex, ioStatusBitmapsTable=ioStatusBitmapsTable, alSumAlarms49to64=alSumAlarms49to64)
