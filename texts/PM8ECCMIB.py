...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, NotificationType, Counter64, MibIdentifier, ObjectIdentity, Unsigned32, Integer32, ModuleIdentity, IpAddress, iso, enterprises, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "NotificationType", "Counter64", "MibIdentifier", "ObjectIdentity", "Unsigned32", "Integer32", "ModuleIdentity", "IpAddress", "iso", "enterprises", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("PM8ECCMIB", pm8OnBoardAlarmP2=pm8OnBoardAlarmP2, vVcn=vVcn, transparentFactoryEthernet=transparentFactoryEthernet, pdPresentPowerDemand=pdPresentPowerDemand, frequencyEntry=frequencyEntry, cdPresentCurrentDemand=cdPresentCurrentDemand, pdComponent=pdComponent, voltageEntry=voltageEntry, pdPeakPowerDemand=pdPeakPowerDemand, ioOptionIDEntry=ioOptionIDEntry, pfIndex=pfIndex, powerDemandTable=powerDemandTable, IOPointLabel=IOPointLabel, pReal=pReal, cdPhase=cdPhase, acEnabled=acEnabled, midDeviceName=midDeviceName, eDateTimeReactiveEnergyReset=eDateTimeReactiveEnergyReset, alSumAlarms17to32=alSumAlarms17to32, alSumIndex=alSumIndex, vIndex=vIndex, pReactive=pReactive, metering=metering, powerTable=powerTable, eIndex=eIndex, systemWiringTypeTable=systemWiringTypeTable, powerFactorEntry=powerFactorEntry, vVan=vVan, cdPhaseEnum=cdPhaseEnum, midSerialNumber=midSerialNumber, alarmState=alarmState, pdComponentEnum=pdComponentEnum, fFrequency=fFrequency, ecc=ecc, iocLabel=iocLabel, ioIDInstalledOptionSlot2=ioIDInstalledOptionSlot2, eDateTimeRealEnergyReset=eDateTimeRealEnergyReset, schneiderElectric=schneiderElectric, iocType=iocType, acType=acType, loadCurrentEntry=loadCurrentEntry, pdPeakDateTime=pdPeakDateTime, alarmConfigurationEntry=alarmConfigurationEntry, systemWiringTypeEntry=systemWiringTypeEntry, tfProducts=tfProducts, pm8OnBoardAlarmP3=pm8OnBoardAlarmP3, acAlarmList3=acAlarmList3, iocIndex=iocIndex, acAlarmLabel=acAlarmLabel, lcIa=lcIa, powerEntry=powerEntry, powerFactorTable=powerFactorTable, pdResetDateTime=pdResetDateTime, lcIAvg=lcIAvg, meterIdentificationEntry=meterIdentificationEntry, cdLastCurrentDemand=cdLastCurrentDemand, vVllAvg=vVllAvg, midFirmwareVersion=midFirmwareVersion, iocPointType=iocPointType, ioStatusBitmapsTable=ioStatusBitmapsTable, cdPeakDateTime=cdPeakDateTime, alarmValue=alarmValue, pIndex=pIndex, vVbc=vVbc, ioOptionIDTable=ioOptionIDTable, trapVariables=trapVariables, iocMode=iocMode, pfPowerFactorTotal=pfPowerFactorTotal, alSumAlarms65to74=alSumAlarms65to74, meterSystem=meterSystem, acCounter=acCounter, acPriority=acPriority, IOPointType=IOPointType, alarmSummaryBitmapsEntry=alarmSummaryBitmapsEntry, acAlarmList1=acAlarmList1, currentDemandEntry=currentDemandEntry, acAlarmList2=acAlarmList2, swtWiringType=swtWiringType, currentDemandTable=currentDemandTable, fIndex=fIndex, pm8ecc=pm8ecc, cdPeakCurrentDemand=cdPeakCurrentDemand, pdLastPowerDemand=pdLastPowerDemand, eApparentEnergy=eApparentEnergy, loadCurrentTable=loadCurrentTable, ioStatSummaryBitmap=ioStatSummaryBitmap, energyTable=energyTable, alarmLabel=alarmLabel, alCntCount=alCntCount, pm8OnBoardAlarmP1=pm8OnBoardAlarmP1, ioConfigurationTable=ioConfigurationTable, alarmCountersTable=alarmCountersTable, vVlnAvg=vVlnAvg, ioStatusBitmapsEntry=ioStatusBitmapsEntry, swtIndex=swtIndex, pdIndex=pdIndex, voltageTable=voltageTable, alSumAlarms1to16=alSumAlarms1to16, alCntAlarmPosition=alCntAlarmPosition, vVca=vVca, energyEntry=energyEntry, AlarmLabel=AlarmLabel, alarms=alarms, eReactiveEnergy=eReactiveEnergy, acAlarmList4=acAlarmList4, acStatus=acStatus, pApparent=pApparent, iocPointNumber=iocPointNumber, midIndex=midIndex, vVab=vVab, iocCount=iocCount, ioStatIndex=ioStatIndex, acPosition=acPosition, ioConfigurationEntry=ioConfigurationEntry, vVbn=vVbn, ioIDInstalledOptionSlot1=ioIDInstalledOptionSlot1, acIndex=acIndex, cdResetDateTime=cdResetDateTime, alarmConfigurationTable=alarmConfigurationTable, alCntIndex=alCntIndex, iocStateOrValue=iocStateOrValue, alarmPriority=alarmPriority, midModelNumber=midModelNumber, alSumAlarms33to48=alSumAlarms33to48, mibVersion=mibVersion, lcIb=lcIb, lcIndex=lcIndex, lcIc=lcIc, cdIndex=cdIndex, io=io, equipmentProfile=equipmentProfile, meterIdentificationTable=meterIdentificationTable, ioIDIndex=ioIDIndex, eRealEnergy=eRealEnergy, alarmDateAndTime=alarmDateAndTime, alSumAlarms49to64=alSumAlarms49to64, alarmCountersEntry=alarmCountersEntry, frequencyTable=frequencyTable, alarmSummaryBitmapsTable=alarmSummaryBitmapsTable, pfPowerFactorDescription=pfPowerFactorDescription, AlarmType=AlarmType, eDateTimeApparentEnergyReset=eDateTimeApparentEnergyReset, powerDemandEntry=powerDemandEntry)
