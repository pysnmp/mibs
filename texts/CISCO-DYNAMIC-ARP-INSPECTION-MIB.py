...
# ASN.1 source CISCO-DYNAMIC-ARP-INSPECTION-MIB
# Source digest sha256:3e9f04efba828eaa7d5e2985c34cda0d77425ffb20c49d85a1aec972ea254298
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: ciscoDynamicArpInspectionMIB.setRevisionsDescriptions(('Add the following groups:\n         - cdaiLoggingConfigGroup.\n         - cdaiLogBufferGroup.\n         - cdaiLogBufferActionGroup.\n         - cdaiAddressValidationGroup.\n         - cdaiVlanCfgGroup.\n         - cdaiVlanArpProbeGroup.\n         - cdaiVlanStatisticsGroup.\n         - cdaiVlanExtStatisticsGroup.', 'Initial revision of this MIB module.',))
if mibBuilder.loadTexts: ciscoDynamicArpInspectionMIB.setLastUpdated('2011-03-21 00:00')
if mibBuilder.loadTexts: ciscoDynamicArpInspectionMIB.setOrganization('Cisco Systems, Inc.')
if mibBuilder.loadTexts: ciscoDynamicArpInspectionMIB.setContactInfo('        Cisco Systems\n                 Customer Service\n\n         Postal: 170 W Tasman Drive\n                 San Jose, CA 95134\n                 USA\n\n            Tel: +1 800 553-NETS\n\n         E-mail: cs-lan-switch-snmp@cisco.com')
if mibBuilder.loadTexts: ciscoDynamicArpInspectionMIB.setDescription('The MIB module is for configuration of Dynamic ARP Inspection \n         feature. Dynamic ARP Inspection is a security mechanism which\n         validate ARP packets seen on access ports.')
...
if mibBuilder.loadTexts: cdaiLogBufferAction.setDescription("This objects specifies the action can be taken with\n        respect to logging buffer. \n\n        'none' indicates that no operation is performed. This\n        object always return value 'none' when read.\n\n        'clear' indicates that all entries in cdaiLoggingBufferTable\n        will be cleared.")
cdaiLogBufferTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 374, 1, 1, 7), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cdaiLogBufferTable.setStatus('current')
if mibBuilder.loadTexts: cdaiLogBufferTable.setDescription('A table provides the information of logged ARP flows \n         for system message generation.')
cdaiLogBufferEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 374, 1, 1, 7, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiLogBufferIndex"))
if mibBuilder.loadTexts: cdaiLogBufferEntry.setStatus('current')
if mibBuilder.loadTexts: cdaiLogBufferEntry.setDescription('A row instance contains logged ARP flow data for system\n         message generation. Entries in the log are cleared once\n         system messages are generated on their behalf. A special\n         entry will be populated for accounting drops of all flows\n         that result in exceeding the number of entries of the log\n         buffer. Special entry only contains packets counter and\n         timestamps information. The rest of its fields are \n         irrelevant.')
cdaiLogBufferIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 374, 1, 1, 7, 1, 1), Unsigned32().subtype(subtypeSpec=ValueRangeConstraint(1, 65535))).setMaxAccess("notaccessible")
...
if mibBuilder.loadTexts: cdaiLogBufferInterface.setDescription('This object indicates the interface which sent the logged\n         ARP flow. Zero value indicates the special entry.')
...
if mibBuilder.loadTexts: cdaiLogBufferVlan.setDescription('This object indicates the VLAN number which the logged\n         ARP flow belongs to. Zero value indicates the special entry.')
...
if mibBuilder.loadTexts: cdaiLogBufferSenderMacAddress.setDescription('This object indicates the sender MAC address of the logged\n         ARP flow. All zeros MAC address value indicates the\n         special entry.')
...
if mibBuilder.loadTexts: cdaiLogBufferSenderAddressType.setDescription('This object indicates the sender Internet address type \n         of the logged ARP flow.')
...
if mibBuilder.loadTexts: cdaiLogBufferLastUpdate.setDescription('This object indicates the timestamp when the last packet\n         of this flow was accounted by the system.')
...
if mibBuilder.loadTexts: cdaiLogBufferPacketsCount.setDescription('This object indicates the number of packets of this ARP flow \n        was accounted by the system.')
cdaiVlanConfigTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 374, 1, 2, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cdaiVlanConfigTable.setStatus('current')
if mibBuilder.loadTexts: cdaiVlanConfigTable.setDescription('A table provides the mechanism to control Dynamic ARP\n        Inspection per VLAN. When a VLAN is created in a device\n        supporting this table, a corresponding entry of this table\n        will be added.')
cdaiVlanConfigEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 374, 1, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiVlanIndex"))
if mibBuilder.loadTexts: cdaiVlanConfigEntry.setStatus('current')
if mibBuilder.loadTexts: cdaiVlanConfigEntry.setDescription('A row instance contains the configuration to enable\n         or disable Dynamic ARP Inspection at each existing VLAN.')
cdaiVlanIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 374, 1, 2, 1, 1, 1), VlanIndex()).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cdaiVlanIndex.setStatus('current')
if mibBuilder.loadTexts: cdaiVlanIndex.setDescription('This object indicates the VLAN number on which Dynamic ARP\n        Inspection feature is configured.')
...
if mibBuilder.loadTexts: cdaiVlanDynArpInspEnable.setDescription("This object indicates whether Dynamic ARP Inspection is\n         enabled in this VLAN.\n\n         If this object is set to 'true', Dynamic ARP Inspection\n         is enabled. \n\n         If this object is set to 'false', Dynamic ARP Inspection\n         is disabled.")
cdaiVlanCfgTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 374, 1, 2, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cdaiVlanCfgTable.setStatus('current')
if mibBuilder.loadTexts: cdaiVlanCfgTable.setDescription('A table provides the mechanism to control Dynamic ARP\n        Inspection per VLAN. This table is populated for each\n        existing VLAN in the device as well as non-existing VLANs\n        which contains the Dynamic ARP Inspection configuration.')
cdaiVlanCfgEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 374, 1, 2, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiVlanId"))
if mibBuilder.loadTexts: cdaiVlanCfgEntry.setStatus('current')
if mibBuilder.loadTexts: cdaiVlanCfgEntry.setDescription('A row instance contains the Dynamic ARP inspection\n         configuration for a specific VLAN in the device.')
cdaiVlanId = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 374, 1, 2, 2, 1, 1), VlanIndex()).setMaxAccess("notaccessible")
...
if mibBuilder.loadTexts: cdaiVlanCfgStorageType.setDescription('The objects specifies the storage type for this conceptual\n        row.')
...
if mibBuilder.loadTexts: cdaiIfTrustEnable.setDescription("This object indicates whether the interface is trusted for\n        Dynamic ARP Inspection purpose. \n\n        If this object is set to 'true', the interface is trusted.\n        ARP packets coming to this interface will be forwarded\n        without checking.\n\n        If this object is set to 'false', the interface is not\n        trusted. ARP packets coming to this interface will be\n        subjected to ARP inspection.")
cdaiIfRateLimitTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 374, 1, 3, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: cdaiIfRateLimitTable.setStatus('current')
if mibBuilder.loadTexts: cdaiIfRateLimitTable.setDescription('A table provides the mechanism to configure the rate limit\n        for Dynamic ARP Inspection purpose at each physical interface\n        capable of this feature.')
cdaiIfRateLimitEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 374, 1, 3, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
if mibBuilder.loadTexts: cdaiIfRateLimitEntry.setStatus('current')
if mibBuilder.loadTexts: cdaiIfRateLimitEntry.setDescription('A row instance contains the configuration of rate limit \n        Dynamic ARP Inspection at each physical interface capable\n        of this feature.')
...
if mibBuilder.loadTexts: cdaiIfRateLimit.setDescription('This object indicates rate limit value for Dynamic ARP\n         Inspection purpose. If the incoming rate of ARP packets \n         exceeds the value of this object, ARP packets will be\n         dropped. ')
cdaiVlanStatsTable = MibTable((1, 3, 6, 1, 4, 1, 9, 9, 374, 1, 4, 1), ).setMaxAccess("notaccessible")
...
cdaiVlanStatsEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 9, 374, 1, 4, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-DYNAMIC-ARP-INSPECTION-MIB", "cdaiVlanStatsIndex"))
if mibBuilder.loadTexts: cdaiVlanStatsEntry.setStatus('current')
if mibBuilder.loadTexts: cdaiVlanStatsEntry.setDescription('A row instance contains Dynamic ARP Inspection statistics \n        information for each VLAN.')
cdaiVlanStatsIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 9, 374, 1, 4, 1, 1, 1), VlanIndex()).setMaxAccess("notaccessible")
...
if mibBuilder.loadTexts: cdaiVlanForwarded.setDescription('This object indicates the number of ARP packets forwarded by\n         Dynamic Arp Inspection feature.')
...
if mibBuilder.loadTexts: cdaiVlanDropped.setDescription('This object indicates the number of ARP packets dropped by\n         Dynamic ARP Inspection feature.')
...
if mibBuilder.loadTexts: cdaiVlanAclPermitted.setDescription('This object indicates the number of ARP packets permitted by\n         the configured ACL.')
...
if mibBuilder.loadTexts: cdaiVlanDhcpBindingsPermitted.setDescription('This object indicates the number of DHCP-binding permitted\n         ARP packets.')
...
if mibBuilder.loadTexts: cdaiVlanAclDenied.setDescription('This object indicates the number of ARP packets denied by the\n         configured ACL.')
...
if mibBuilder.loadTexts: cdaiVlanDhcpBindingDenied.setDescription('This object indicates the number of DHCP-binding denied \n         ARP packets.')
...
if mibBuilder.loadTexts: cdaiVlanSrcMacValidationFailures.setDescription('This object indicates the number of ARP packets that fail \n         source MAC address validation.')
...
if mibBuilder.loadTexts: cdaiVlanDestMacValidationFailures.setDescription('This object indicates the number of ARP packets that fail \n         destination MAC address validation.')
...
if mibBuilder.loadTexts: cdaiVlanIpValidationFailures.setDescription('This object indicates the number of ARP packets that fail \n         IP validation.')
...
if mibBuilder.loadTexts: cdaiVlanArpProbePermitted.setDescription('This object indicates the number of ARP Probe packets that \n         are permitted.')
...
if mibBuilder.loadTexts: cdaiVlanInvalidProtocolData.setDescription('This object indicates the number of ARP packets that contain \n         invalid protocol data.')
...
if mibBuilder.loadTexts: cdaiMIBCompliance.setDescription('The compliance statement for CISCO-DYNAMIC-ARP-INSPECTION-MIB.\n         This compliance is superceded by cdaiMIBCompliance1.')
...
if mibBuilder.loadTexts: cdaiGlobalLoggingGroup.setDescription('A collection of object which is used to configure Dynamic\n        ARP Inspection logging.')
...
if mibBuilder.loadTexts: cdaiVlanConfigGroup.setDescription('A collection of object which are used to configure as\n         well as show information regarding the Dynamic ARP\n         Inspection feature per VLAN.')
...
if mibBuilder.loadTexts: cdaiIfConfigGroup.setDescription('A collection of object which are used to configure as\n         well as show information regarding the interface trust\n         state for Dynamic ARP Inspection purpose.')
...
if mibBuilder.loadTexts: cdaiIfRateLimitGroup.setDescription('A collection of object which are used to configure as\n         well as show information regarding the rate limit per \n         interface for Dynamic ARP Inspection purpose.')
...
if mibBuilder.loadTexts: cdaiLoggingConfigGroup.setDescription('A collection of object which provides logging configuration \n         for Dynamic ARP Inspection feature.')
...
if mibBuilder.loadTexts: cdaiAddressValidationGroup.setDescription('A collection of object which provides address validation\n         configuration for Dynamic ARP Inspection feature.')
...
if mibBuilder.loadTexts: cdaiVlanCfgGroup.setDescription('A collection of object which provides additional VLAN \n         configuration for Dynamic ARP Inspection feature.')
...
if mibBuilder.loadTexts: cdaiVlanStatisticsGroup.setDescription('A collection of object which provides Dynamic ARP Inspection \n         statistics per VLAN.')
...
if mibBuilder.loadTexts: cdaiLogBufferGroup.setDescription('A collection of object which provides logging information\n         for Dynamic ARP Inspection feature.')
...
if mibBuilder.loadTexts: cdaiVlanExtStatisticsGroup.setDescription('A collection of object which provides additional Dynamic \n         ARP Inspection statistics per VLAN.')
...
if mibBuilder.loadTexts: cdaiVlanArpProbeGroup.setDescription('A collection of object which provides additional VLAN \n         configuration for ARP Probe packets.')
...
mibBuilder.exportSymbols("CISCO-DYNAMIC-ARP-INSPECTION-MIB", PYSNMP_MODULE_ID=ciscoDynamicArpInspectionMIB, cdaiAddressValidate=cdaiAddressValidate, cdaiAddressValidationGroup=cdaiAddressValidationGroup, cdaiGlobal=cdaiGlobal, cdaiGlobalLoggingGroup=cdaiGlobalLoggingGroup, cdaiIfConfigEntry=cdaiIfConfigEntry, cdaiIfConfigGroup=cdaiIfConfigGroup, cdaiIfConfigTable=cdaiIfConfigTable, cdaiIfRateLimit=cdaiIfRateLimit, cdaiIfRateLimitEntry=cdaiIfRateLimitEntry, cdaiIfRateLimitGroup=cdaiIfRateLimitGroup, cdaiIfRateLimitTable=cdaiIfRateLimitTable, cdaiIfTrustEnable=cdaiIfTrustEnable, cdaiInterface=cdaiInterface, cdaiLogBufferAction=cdaiLogBufferAction, cdaiLogBufferActionGroup=cdaiLogBufferActionGroup, cdaiLogBufferEntry=cdaiLogBufferEntry, cdaiLogBufferGroup=cdaiLogBufferGroup, cdaiLogBufferIndex=cdaiLogBufferIndex, cdaiLogBufferInterface=cdaiLogBufferInterface, cdaiLogBufferLastUpdate=cdaiLogBufferLastUpdate, cdaiLogBufferPacketsCount=cdaiLogBufferPacketsCount, cdaiLogBufferReason=cdaiLogBufferReason, cdaiLogBufferSenderAddressType=cdaiLogBufferSenderAddressType, cdaiLogBufferSenderIpAddress=cdaiLogBufferSenderIpAddress, cdaiLogBufferSenderMacAddress=cdaiLogBufferSenderMacAddress, cdaiLogBufferSize=cdaiLogBufferSize, cdaiLogBufferTable=cdaiLogBufferTable, cdaiLogBufferVlan=cdaiLogBufferVlan, cdaiLoggingConfigGroup=cdaiLoggingConfigGroup, cdaiLoggingEnable=cdaiLoggingEnable, cdaiLoggingInterval=cdaiLoggingInterval, cdaiLoggingRate=cdaiLoggingRate, cdaiMIBCompliance1=cdaiMIBCompliance1, cdaiMIBCompliance=cdaiMIBCompliance, cdaiMIBCompliances=cdaiMIBCompliances, cdaiMIBConformance=cdaiMIBConformance, cdaiMIBGroups=cdaiMIBGroups, cdaiMIBNotifs=cdaiMIBNotifs, cdaiMIBObjects=cdaiMIBObjects, cdaiStatistics=cdaiStatistics, cdaiVlan=cdaiVlan, cdaiVlanAclDenied=cdaiVlanAclDenied, cdaiVlanAclLogging=cdaiVlanAclLogging, cdaiVlanAclPermitted=cdaiVlanAclPermitted, cdaiVlanArpProbeGroup=cdaiVlanArpProbeGroup, cdaiVlanArpProbeLogging=cdaiVlanArpProbeLogging, cdaiVlanArpProbePermitted=cdaiVlanArpProbePermitted, cdaiVlanCfgEntry=cdaiVlanCfgEntry, cdaiVlanCfgGroup=cdaiVlanCfgGroup, cdaiVlanCfgRowStatus=cdaiVlanCfgRowStatus, cdaiVlanCfgStorageType=cdaiVlanCfgStorageType, cdaiVlanCfgTable=cdaiVlanCfgTable, cdaiVlanConfigEntry=cdaiVlanConfigEntry, cdaiVlanConfigGroup=cdaiVlanConfigGroup, cdaiVlanConfigTable=cdaiVlanConfigTable, cdaiVlanDestMacValidationFailures=cdaiVlanDestMacValidationFailures, cdaiVlanDhcpBindingDenied=cdaiVlanDhcpBindingDenied, cdaiVlanDhcpBindingLogging=cdaiVlanDhcpBindingLogging, cdaiVlanDhcpBindingsPermitted=cdaiVlanDhcpBindingsPermitted, cdaiVlanDropped=cdaiVlanDropped, cdaiVlanDynArpInspAdmin=cdaiVlanDynArpInspAdmin, cdaiVlanDynArpInspEnable=cdaiVlanDynArpInspEnable, cdaiVlanDynArpInspOper=cdaiVlanDynArpInspOper, cdaiVlanExtStatisticsGroup=cdaiVlanExtStatisticsGroup, cdaiVlanFilterArpAclName=cdaiVlanFilterArpAclName, cdaiVlanFilterArpAclStatic=cdaiVlanFilterArpAclStatic, cdaiVlanForwarded=cdaiVlanForwarded, cdaiVlanId=cdaiVlanId, cdaiVlanIndex=cdaiVlanIndex, cdaiVlanInvalidProtocolData=cdaiVlanInvalidProtocolData, cdaiVlanIpValidationFailures=cdaiVlanIpValidationFailures, cdaiVlanSrcMacValidationFailures=cdaiVlanSrcMacValidationFailures, cdaiVlanStatisticsGroup=cdaiVlanStatisticsGroup, cdaiVlanStatsEntry=cdaiVlanStatsEntry, cdaiVlanStatsIndex=cdaiVlanStatsIndex, cdaiVlanStatsTable=cdaiVlanStatsTable, ciscoDynamicArpInspectionMIB=ciscoDynamicArpInspectionMIB)
