...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonReturnPathFrequency=commonReturnPathFrequency, commonMACGroup=commonMACGroup, commonDeviceModelNumber=commonDeviceModelNumber, commonBackoffPeriod=commonBackoffPeriod, commonAdminUseRf=commonAdminUseRf, commonNELogicalID=commonNELogicalID, commonAgentBootWay=commonAgentBootWay, commonAgentTrapCommunity=commonAgentTrapCommunity, commonDeviceName=commonDeviceName, commonDeviceInfoTable=commonDeviceInfoTable, commonCheckCode=commonCheckCode, commonDeviceSerialNumber=commonDeviceSerialNumber, commonNetworkAddress=commonNetworkAddress, commonMacAddress=commonMacAddress, commonVarBindings=commonVarBindings, commonNEVendor=commonNEVendor, commonPhysAddress=commonPhysAddress, commonDeviceId=commonDeviceId, commonAdminGroup=commonAdminGroup, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonNEModelNumber=commonNEModelNumber, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonForwardPathFrequency=commonForwardPathFrequency, commonTime=commonTime, commonAlarmDetectionControl=commonAlarmDetectionControl, commonMaxPayloadSize=commonMaxPayloadSize, commonTrapAck=commonTrapAck, commonDeviceCraftStatus=commonDeviceCraftStatus, commonRfGroup=commonRfGroup, commonAgentReset=commonAgentReset, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonMaxReturnPower=commonMaxReturnPower, commonAgentTrapIP=commonAgentTrapIP, hfcColdStart=hfcColdStart, commonDeviceMFD=commonDeviceMFD, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonReset=commonReset, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonInvalidMacCmds=commonInvalidMacCmds, commonMacStats=commonMacStats, commonNESerialNumber=commonNESerialNumber, commonCraftStatus=commonCraftStatus, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonMulticastAddressNumber=commonMulticastAddressNumber, commonDeviceStatus=commonDeviceStatus, commonResetCause=commonResetCause, commonDeviceMACAddress=commonDeviceMACAddress, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceNum=commonDeviceNum, commonMulticastAddressTable=commonMulticastAddressTable, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonDeviceAcct=commonDeviceAcct, commonDeviceInfoEntry=commonDeviceInfoEntry, commonTrapCommunityString=commonTrapCommunityString, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonTamperStatus=commonTamperStatus, commonDeviceSlot=commonDeviceSlot, commonDeviceVendor=commonDeviceVendor, commonDevicesID=commonDevicesID, commonDeviceTamperStatus=commonDeviceTamperStatus, commonDeviceVendorInfo=commonDeviceVendorInfo, commonAdminUseEthernet=commonAdminUseEthernet, commonDeviceReset=commonDeviceReset, commonDeviceFW=commonDeviceFW, commonMulticastAddressEntry=commonMulticastAddressEntry, commonAgentTrapIndex=commonAgentTrapIndex, commonAgentTrapStatus=commonAgentTrapStatus, commonNEStatus=commonNEStatus, commonAgentGroup=commonAgentGroup, commonMulticastAddressIndex=commonMulticastAddressIndex, commonAgentMaxTraps=commonAgentMaxTraps, commonDeviceResetCause=commonDeviceResetCause, commonNEVendorInfo=commonNEVendorInfo, commonBackoffParams=commonBackoffParams, commonAgentTrapTable=commonAgentTrapTable, commonDeviceOID=commonDeviceOID, commonACKTimeoutWindow=commonACKTimeoutWindow, commonDevicesOID=commonDevicesOID, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonInternalTemperature=commonInternalTemperature, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonDeviceGroup=commonDeviceGroup, hfcWarmStart=hfcWarmStart)
