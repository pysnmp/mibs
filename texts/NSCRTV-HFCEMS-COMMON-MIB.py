...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonDeviceInfoTable=commonDeviceInfoTable, commonDeviceSlot=commonDeviceSlot, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonNELogicalID=commonNELogicalID, commonMulticastAddressNumber=commonMulticastAddressNumber, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonTrapAck=commonTrapAck, commonDeviceMACAddress=commonDeviceMACAddress, commonPhysAddress=commonPhysAddress, commonDeviceTamperStatus=commonDeviceTamperStatus, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonDeviceCraftStatus=commonDeviceCraftStatus, commonVarBindings=commonVarBindings, hfcWarmStart=hfcWarmStart, commonTime=commonTime, commonDeviceFW=commonDeviceFW, commonMacStats=commonMacStats, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonResetCause=commonResetCause, commonMulticastAddressIndex=commonMulticastAddressIndex, commonMaxReturnPower=commonMaxReturnPower, commonMacAddress=commonMacAddress, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonDevicesID=commonDevicesID, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDeviceMFD=commonDeviceMFD, commonForwardPathFrequency=commonForwardPathFrequency, commonDeviceVendorInfo=commonDeviceVendorInfo, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonNEModelNumber=commonNEModelNumber, commonDeviceResetCause=commonDeviceResetCause, commonAgentGroup=commonAgentGroup, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceName=commonDeviceName, commonNESerialNumber=commonNESerialNumber, commonNEStatus=commonNEStatus, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonAdminUseRf=commonAdminUseRf, commonDeviceId=commonDeviceId, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonDeviceAcct=commonDeviceAcct, commonNetworkAddress=commonNetworkAddress, commonAgentTrapIndex=commonAgentTrapIndex, commonAgentTrapCommunity=commonAgentTrapCommunity, commonAdminGroup=commonAdminGroup, commonAgentBootWay=commonAgentBootWay, commonDeviceGroup=commonDeviceGroup, commonNEVendorInfo=commonNEVendorInfo, commonInvalidMacCmds=commonInvalidMacCmds, commonAgentReset=commonAgentReset, commonBackoffParams=commonBackoffParams, commonTrapCommunityString=commonTrapCommunityString, commonAgentMaxTraps=commonAgentMaxTraps, commonDeviceReset=commonDeviceReset, commonAgentTrapTable=commonAgentTrapTable, commonTamperStatus=commonTamperStatus, commonAgentTrapIP=commonAgentTrapIP, commonDeviceNum=commonDeviceNum, hfcColdStart=hfcColdStart, commonNEVendor=commonNEVendor, commonDeviceModelNumber=commonDeviceModelNumber, commonDeviceSerialNumber=commonDeviceSerialNumber, commonCheckCode=commonCheckCode, commonReset=commonReset, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonAgentTrapStatus=commonAgentTrapStatus, commonBackoffPeriod=commonBackoffPeriod, commonAgentTrapEntry=commonAgentTrapEntry, commonMulticastAddressTable=commonMulticastAddressTable, commonMulticastAddressEntry=commonMulticastAddressEntry, commonMACGroup=commonMACGroup, commonACKTimeoutWindow=commonACKTimeoutWindow, commonCraftStatus=commonCraftStatus, commonInternalTemperature=commonInternalTemperature, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonAdminUseEthernet=commonAdminUseEthernet, commonRfGroup=commonRfGroup, commonReturnPathFrequency=commonReturnPathFrequency, commonDeviceOID=commonDeviceOID, commonAlarmDetectionControl=commonAlarmDetectionControl, commonDeviceInfoEntry=commonDeviceInfoEntry, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonMaxPayloadSize=commonMaxPayloadSize, commonDeviceStatus=commonDeviceStatus, commonDeviceVendor=commonDeviceVendor, commonDevicesOID=commonDevicesOID)
