...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceOID=commonDeviceOID, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonMulticastAddressIndex=commonMulticastAddressIndex, commonACKTimeoutWindow=commonACKTimeoutWindow, commonMacStats=commonMacStats, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonPhysAddress=commonPhysAddress, commonAgentGroup=commonAgentGroup, commonDeviceModelNumber=commonDeviceModelNumber, commonCraftStatus=commonCraftStatus, commonNEStatus=commonNEStatus, commonDeviceVendorInfo=commonDeviceVendorInfo, commonAgentReset=commonAgentReset, commonDevicesOID=commonDevicesOID, commonAdminUseRf=commonAdminUseRf, commonDeviceGroup=commonDeviceGroup, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonTrapAck=commonTrapAck, commonCheckCode=commonCheckCode, commonResetCause=commonResetCause, hfcWarmStart=hfcWarmStart, commonRfGroup=commonRfGroup, commonDeviceVendor=commonDeviceVendor, hfcColdStart=hfcColdStart, commonAgentTrapCommunity=commonAgentTrapCommunity, commonReturnPathFrequency=commonReturnPathFrequency, commonDeviceInfoTable=commonDeviceInfoTable, commonDeviceInfoEntry=commonDeviceInfoEntry, commonAlarmDetectionControl=commonAlarmDetectionControl, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonInvalidMacCmds=commonInvalidMacCmds, commonTime=commonTime, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonAdminGroup=commonAdminGroup, commonAgentTrapTable=commonAgentTrapTable, commonDeviceReset=commonDeviceReset, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonDeviceCraftStatus=commonDeviceCraftStatus, commonMACGroup=commonMACGroup, commonDeviceFW=commonDeviceFW, commonDeviceName=commonDeviceName, commonDeviceAcct=commonDeviceAcct, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonReset=commonReset, commonDeviceSerialNumber=commonDeviceSerialNumber, commonNEModelNumber=commonNEModelNumber, commonAgentTrapStatus=commonAgentTrapStatus, commonDevicesID=commonDevicesID, commonDeviceSlot=commonDeviceSlot, commonVarBindings=commonVarBindings, commonDeviceMACAddress=commonDeviceMACAddress, commonAgentBootWay=commonAgentBootWay, commonNEVendorInfo=commonNEVendorInfo, commonDeviceId=commonDeviceId, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonMaxPayloadSize=commonMaxPayloadSize, commonNEVendor=commonNEVendor, commonDeviceResetCause=commonDeviceResetCause, commonBackoffPeriod=commonBackoffPeriod, commonTamperStatus=commonTamperStatus, commonInternalTemperature=commonInternalTemperature, commonBackoffParams=commonBackoffParams, commonAgentTrapIP=commonAgentTrapIP, commonMulticastAddressTable=commonMulticastAddressTable, commonDeviceMFD=commonDeviceMFD, commonNELogicalID=commonNELogicalID, commonMulticastAddressEntry=commonMulticastAddressEntry, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonMaxReturnPower=commonMaxReturnPower, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonAgentMaxTraps=commonAgentMaxTraps, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceStatus=commonDeviceStatus, commonNetworkAddress=commonNetworkAddress, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonTrapCommunityString=commonTrapCommunityString, commonForwardPathFrequency=commonForwardPathFrequency, commonDeviceNum=commonDeviceNum, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonNESerialNumber=commonNESerialNumber, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonAdminUseEthernet=commonAdminUseEthernet, commonMacAddress=commonMacAddress, commonAgentTrapIndex=commonAgentTrapIndex, commonDeviceTamperStatus=commonDeviceTamperStatus, commonMulticastAddressNumber=commonMulticastAddressNumber)
