...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonCraftStatus=commonCraftStatus, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonCheckCode=commonCheckCode, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonDeviceFW=commonDeviceFW, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceMFD=commonDeviceMFD, hfcWarmStart=hfcWarmStart, commonInvalidMacCmds=commonInvalidMacCmds, commonAdminGroup=commonAdminGroup, commonDeviceAcct=commonDeviceAcct, commonDeviceSerialNumber=commonDeviceSerialNumber, commonMulticastAddressEntry=commonMulticastAddressEntry, commonDeviceReset=commonDeviceReset, commonMacStats=commonMacStats, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonDeviceVendorInfo=commonDeviceVendorInfo, commonReturnPathFrequency=commonReturnPathFrequency, commonNetworkAddress=commonNetworkAddress, commonAgentMaxTraps=commonAgentMaxTraps, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonTamperStatus=commonTamperStatus, commonAgentTrapStatus=commonAgentTrapStatus, commonAgentTrapCommunity=commonAgentTrapCommunity, commonForwardPathFrequency=commonForwardPathFrequency, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonResetCause=commonResetCause, commonTrapCommunityString=commonTrapCommunityString, commonAdminUseRf=commonAdminUseRf, commonBackoffParams=commonBackoffParams, commonDeviceSlot=commonDeviceSlot, commonAgentBootWay=commonAgentBootWay, commonDeviceInfoTable=commonDeviceInfoTable, hfcColdStart=hfcColdStart, commonDeviceStatus=commonDeviceStatus, commonAgentTrapEntry=commonAgentTrapEntry, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceMACAddress=commonDeviceMACAddress, commonBackoffPeriod=commonBackoffPeriod, commonMACGroup=commonMACGroup, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonNEModelNumber=commonNEModelNumber, commonDeviceInfoEntry=commonDeviceInfoEntry, commonVarBindings=commonVarBindings, commonDevicesID=commonDevicesID, commonMulticastAddressIndex=commonMulticastAddressIndex, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonMacAddress=commonMacAddress, commonRfGroup=commonRfGroup, commonMulticastAddressTable=commonMulticastAddressTable, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonDeviceCraftStatus=commonDeviceCraftStatus, commonInternalTemperature=commonInternalTemperature, commonNESerialNumber=commonNESerialNumber, commonAgentTrapTable=commonAgentTrapTable, commonAgentGroup=commonAgentGroup, commonMaxPayloadSize=commonMaxPayloadSize, commonAdminUseEthernet=commonAdminUseEthernet, commonDeviceTamperStatus=commonDeviceTamperStatus, commonReset=commonReset, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonNELogicalID=commonNELogicalID, commonNEVendorInfo=commonNEVendorInfo, commonDeviceVendor=commonDeviceVendor, commonDeviceNum=commonDeviceNum, commonAgentTrapIP=commonAgentTrapIP, commonNEStatus=commonNEStatus, commonDeviceId=commonDeviceId, commonAgentReset=commonAgentReset, commonMaxReturnPower=commonMaxReturnPower, commonDeviceGroup=commonDeviceGroup, commonDeviceResetCause=commonDeviceResetCause, commonDevicesOID=commonDevicesOID, commonDeviceName=commonDeviceName, commonMulticastAddressNumber=commonMulticastAddressNumber, commonNEVendor=commonNEVendor, commonDeviceOID=commonDeviceOID, commonAlarmDetectionControl=commonAlarmDetectionControl, commonACKTimeoutWindow=commonACKTimeoutWindow, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDeviceModelNumber=commonDeviceModelNumber, commonTime=commonTime, commonAgentTrapIndex=commonAgentTrapIndex, commonTrapAck=commonTrapAck, commonPhysAddress=commonPhysAddress)
