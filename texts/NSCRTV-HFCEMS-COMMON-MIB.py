...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonMacAddress=commonMacAddress, commonAdminGroup=commonAdminGroup, commonNetworkAddress=commonNetworkAddress, commonBackoffPeriod=commonBackoffPeriod, commonMaxReturnPower=commonMaxReturnPower, commonDevicesOID=commonDevicesOID, commonAgentReset=commonAgentReset, commonAgentBootWay=commonAgentBootWay, commonAgentTrapEntry=commonAgentTrapEntry, commonCheckCode=commonCheckCode, hfcWarmStart=hfcWarmStart, commonDeviceOID=commonDeviceOID, commonCraftStatus=commonCraftStatus, commonDeviceMFD=commonDeviceMFD, commonDeviceInfoEntry=commonDeviceInfoEntry, commonAgentTrapStatus=commonAgentTrapStatus, commonNEStatus=commonNEStatus, commonMulticastAddressEntry=commonMulticastAddressEntry, commonNEVendorInfo=commonNEVendorInfo, commonForwardPathFrequency=commonForwardPathFrequency, commonInternalTemperature=commonInternalTemperature, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonTime=commonTime, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonDeviceTamperStatus=commonDeviceTamperStatus, commonPhysAddress=commonPhysAddress, commonDeviceGroup=commonDeviceGroup, commonDeviceVendor=commonDeviceVendor, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonDeviceStatus=commonDeviceStatus, commonTamperStatus=commonTamperStatus, commonAgentTrapIP=commonAgentTrapIP, commonMaxPayloadSize=commonMaxPayloadSize, commonTrapAck=commonTrapAck, commonDeviceId=commonDeviceId, commonDeviceResetCause=commonDeviceResetCause, commonMulticastAddressNumber=commonMulticastAddressNumber, commonDeviceAcct=commonDeviceAcct, commonDeviceSerialNumber=commonDeviceSerialNumber, commonAdminUseRf=commonAdminUseRf, commonReset=commonReset, commonAlarmDetectionControl=commonAlarmDetectionControl, commonNELogicalID=commonNELogicalID, commonDeviceNum=commonDeviceNum, commonDeviceCraftStatus=commonDeviceCraftStatus, commonMACGroup=commonMACGroup, commonNEModelNumber=commonNEModelNumber, commonNESerialNumber=commonNESerialNumber, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonNEVendor=commonNEVendor, commonInvalidMacCmds=commonInvalidMacCmds, commonReturnPathFrequency=commonReturnPathFrequency, commonResetCause=commonResetCause, commonDeviceSlot=commonDeviceSlot, commonAgentGroup=commonAgentGroup, commonDeviceReset=commonDeviceReset, commonAgentMaxTraps=commonAgentMaxTraps, commonAdminUseEthernet=commonAdminUseEthernet, commonDevicesID=commonDevicesID, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonDeviceModelNumber=commonDeviceModelNumber, hfcColdStart=hfcColdStart, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonDeviceInfoTable=commonDeviceInfoTable, commonMulticastAddressIndex=commonMulticastAddressIndex, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonRfGroup=commonRfGroup, commonACKTimeoutWindow=commonACKTimeoutWindow, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonAgentTrapTable=commonAgentTrapTable, commonDeviceVendorInfo=commonDeviceVendorInfo, commonAgentTrapCommunity=commonAgentTrapCommunity, commonMacStats=commonMacStats, commonDeviceName=commonDeviceName, commonAgentTrapIndex=commonAgentTrapIndex, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceFW=commonDeviceFW, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonBackoffParams=commonBackoffParams, commonTrapCommunityString=commonTrapCommunityString, commonVarBindings=commonVarBindings, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonMulticastAddressTable=commonMulticastAddressTable, commonDeviceMACAddress=commonDeviceMACAddress)
