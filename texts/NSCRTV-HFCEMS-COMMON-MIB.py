...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonAgentTrapCommunity=commonAgentTrapCommunity, commonNELogicalID=commonNELogicalID, commonDeviceStatus=commonDeviceStatus, commonMulticastAddressIndex=commonMulticastAddressIndex, commonMacAddress=commonMacAddress, commonAgentTrapIndex=commonAgentTrapIndex, commonACKTimeoutWindow=commonACKTimeoutWindow, commonInvalidMacCmds=commonInvalidMacCmds, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonMulticastAddressEntry=commonMulticastAddressEntry, commonDeviceVendorInfo=commonDeviceVendorInfo, commonNEModelNumber=commonNEModelNumber, commonDeviceOID=commonDeviceOID, commonAdminGroup=commonAdminGroup, commonMacStats=commonMacStats, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonAdminUseEthernet=commonAdminUseEthernet, commonDeviceMACAddress=commonDeviceMACAddress, commonAgentBootWay=commonAgentBootWay, commonMaxReturnPower=commonMaxReturnPower, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonCraftStatus=commonCraftStatus, hfcColdStart=hfcColdStart, commonTrapCommunityString=commonTrapCommunityString, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonDeviceMFD=commonDeviceMFD, commonMulticastAddressTable=commonMulticastAddressTable, commonDeviceNum=commonDeviceNum, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonTrapAck=commonTrapAck, commonDeviceId=commonDeviceId, commonAdminUseRf=commonAdminUseRf, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonResetCause=commonResetCause, commonTime=commonTime, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonNEVendorInfo=commonNEVendorInfo, commonDeviceGroup=commonDeviceGroup, commonMulticastAddressNumber=commonMulticastAddressNumber, commonAgentTrapTable=commonAgentTrapTable, commonForwardPathFrequency=commonForwardPathFrequency, commonDeviceFW=commonDeviceFW, commonDeviceSlot=commonDeviceSlot, commonCheckCode=commonCheckCode, hfcWarmStart=hfcWarmStart, commonDeviceReset=commonDeviceReset, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonAgentTrapEntry=commonAgentTrapEntry, commonRfGroup=commonRfGroup, commonDeviceInfoEntry=commonDeviceInfoEntry, commonDeviceName=commonDeviceName, commonAgentMaxTraps=commonAgentMaxTraps, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonDeviceAcct=commonDeviceAcct, commonAlarmDetectionControl=commonAlarmDetectionControl, commonDeviceInfoTable=commonDeviceInfoTable, commonAgentTrapStatus=commonAgentTrapStatus, commonVarBindings=commonVarBindings, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonTamperStatus=commonTamperStatus, commonDevicesOID=commonDevicesOID, commonAgentGroup=commonAgentGroup, commonInternalTemperature=commonInternalTemperature, commonMACGroup=commonMACGroup, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonNEStatus=commonNEStatus, commonDevicesID=commonDevicesID, commonDeviceTamperStatus=commonDeviceTamperStatus, commonDeviceVendor=commonDeviceVendor, commonReset=commonReset, commonNESerialNumber=commonNESerialNumber, commonMaxPayloadSize=commonMaxPayloadSize, commonAgentTrapIP=commonAgentTrapIP, commonBackoffParams=commonBackoffParams, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonPhysAddress=commonPhysAddress, commonNEVendor=commonNEVendor, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonReturnPathFrequency=commonReturnPathFrequency, commonDeviceModelNumber=commonDeviceModelNumber, commonNetworkAddress=commonNetworkAddress, commonDeviceCraftStatus=commonDeviceCraftStatus, commonBackoffPeriod=commonBackoffPeriod, commonDeviceSerialNumber=commonDeviceSerialNumber, commonDeviceResetCause=commonDeviceResetCause, commonAgentReset=commonAgentReset)
