...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonMaxPayloadSize=commonMaxPayloadSize, commonDeviceId=commonDeviceId, commonAgentTrapTable=commonAgentTrapTable, commonNEStatus=commonNEStatus, commonAgentMaxTraps=commonAgentMaxTraps, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonMulticastAddressTable=commonMulticastAddressTable, commonTamperStatus=commonTamperStatus, commonDeviceName=commonDeviceName, commonMaxReturnPower=commonMaxReturnPower, commonBackoffPeriod=commonBackoffPeriod, commonDeviceAcct=commonDeviceAcct, commonAgentGroup=commonAgentGroup, commonMacAddress=commonMacAddress, commonInternalTemperature=commonInternalTemperature, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonDeviceTamperStatus=commonDeviceTamperStatus, hfcColdStart=hfcColdStart, commonDeviceCraftStatus=commonDeviceCraftStatus, commonDeviceMFD=commonDeviceMFD, commonDeviceInfoEntry=commonDeviceInfoEntry, commonAdminUseRf=commonAdminUseRf, commonNetworkAddress=commonNetworkAddress, commonDeviceResetCause=commonDeviceResetCause, commonAlarmDetectionControl=commonAlarmDetectionControl, commonTime=commonTime, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonAgentTrapEntry=commonAgentTrapEntry, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonReset=commonReset, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonResetCause=commonResetCause, commonDeviceStatus=commonDeviceStatus, hfcWarmStart=hfcWarmStart, commonAgentReset=commonAgentReset, commonDeviceReset=commonDeviceReset, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonMacStats=commonMacStats, commonMulticastAddressEntry=commonMulticastAddressEntry, commonDeviceFW=commonDeviceFW, commonAgentTrapIP=commonAgentTrapIP, commonDeviceGroup=commonDeviceGroup, commonReturnPathFrequency=commonReturnPathFrequency, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonTrapAck=commonTrapAck, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonTrapCommunityString=commonTrapCommunityString, commonBackoffParams=commonBackoffParams, commonAdminGroup=commonAdminGroup, commonAgentTrapCommunity=commonAgentTrapCommunity, commonDeviceModelNumber=commonDeviceModelNumber, commonAdminUseEthernet=commonAdminUseEthernet, commonCraftStatus=commonCraftStatus, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDevicesID=commonDevicesID, commonVarBindings=commonVarBindings, commonDeviceOID=commonDeviceOID, commonACKTimeoutWindow=commonACKTimeoutWindow, commonDevicesOID=commonDevicesOID, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonPhysAddress=commonPhysAddress, commonNESerialNumber=commonNESerialNumber, commonNELogicalID=commonNELogicalID, commonDeviceInfoTable=commonDeviceInfoTable, commonInvalidMacCmds=commonInvalidMacCmds, commonRfGroup=commonRfGroup, commonDeviceNum=commonDeviceNum, commonDeviceVendor=commonDeviceVendor, commonAgentBootWay=commonAgentBootWay, commonAgentTrapStatus=commonAgentTrapStatus, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceVendorInfo=commonDeviceVendorInfo, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonNEModelNumber=commonNEModelNumber, commonMulticastAddressNumber=commonMulticastAddressNumber, commonMulticastAddressIndex=commonMulticastAddressIndex, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonCheckCode=commonCheckCode, commonAgentTrapIndex=commonAgentTrapIndex, commonMACGroup=commonMACGroup, commonForwardPathFrequency=commonForwardPathFrequency, commonNEVendor=commonNEVendor, commonDeviceSlot=commonDeviceSlot, commonDeviceSerialNumber=commonDeviceSerialNumber, commonDeviceMACAddress=commonDeviceMACAddress, commonNEVendorInfo=commonNEVendorInfo)
