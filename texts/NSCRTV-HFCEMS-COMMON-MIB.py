...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonInternalTemperature=commonInternalTemperature, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceCraftStatus=commonDeviceCraftStatus, commonDeviceResetCause=commonDeviceResetCause, commonAgentTrapEntry=commonAgentTrapEntry, commonNELogicalID=commonNELogicalID, commonDeviceInfoEntry=commonDeviceInfoEntry, commonMulticastAddressNumber=commonMulticastAddressNumber, commonDeviceFW=commonDeviceFW, hfcColdStart=hfcColdStart, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonDevicesOID=commonDevicesOID, commonDeviceMACAddress=commonDeviceMACAddress, commonInvalidMacCmds=commonInvalidMacCmds, commonDeviceNum=commonDeviceNum, commonForwardPathFrequency=commonForwardPathFrequency, commonAgentTrapCommunity=commonAgentTrapCommunity, commonAdminUseRf=commonAdminUseRf, commonAgentTrapIP=commonAgentTrapIP, commonTrapAck=commonTrapAck, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonReturnPathFrequency=commonReturnPathFrequency, commonTime=commonTime, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDevicesID=commonDevicesID, commonDeviceSerialNumber=commonDeviceSerialNumber, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonMaxPayloadSize=commonMaxPayloadSize, commonAgentMaxTraps=commonAgentMaxTraps, commonDeviceId=commonDeviceId, commonDeviceVendorInfo=commonDeviceVendorInfo, commonDeviceGroup=commonDeviceGroup, commonMulticastAddressIndex=commonMulticastAddressIndex, commonNEStatus=commonNEStatus, commonAdminUseEthernet=commonAdminUseEthernet, commonDeviceMFD=commonDeviceMFD, commonDeviceOID=commonDeviceOID, commonDeviceStatus=commonDeviceStatus, commonAgentGroup=commonAgentGroup, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonAgentTrapTable=commonAgentTrapTable, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonDeviceTamperStatus=commonDeviceTamperStatus, commonMulticastAddressTable=commonMulticastAddressTable, commonDeviceModelNumber=commonDeviceModelNumber, commonDeviceName=commonDeviceName, commonMacStats=commonMacStats, commonCraftStatus=commonCraftStatus, commonBackoffParams=commonBackoffParams, commonDeviceSlot=commonDeviceSlot, commonRfGroup=commonRfGroup, commonDeviceAcct=commonDeviceAcct, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonNEVendorInfo=commonNEVendorInfo, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonReset=commonReset, commonAgentTrapStatus=commonAgentTrapStatus, commonAdminGroup=commonAdminGroup, commonAgentTrapIndex=commonAgentTrapIndex, commonBackoffPeriod=commonBackoffPeriod, commonAgentReset=commonAgentReset, hfcWarmStart=hfcWarmStart, commonNESerialNumber=commonNESerialNumber, commonTamperStatus=commonTamperStatus, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonMACGroup=commonMACGroup, commonNEVendor=commonNEVendor, commonDeviceInfoTable=commonDeviceInfoTable, commonNetworkAddress=commonNetworkAddress, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonAgentBootWay=commonAgentBootWay, commonAlarmDetectionControl=commonAlarmDetectionControl, commonVarBindings=commonVarBindings, commonTrapCommunityString=commonTrapCommunityString, commonDeviceVendor=commonDeviceVendor, commonNEModelNumber=commonNEModelNumber, commonMacAddress=commonMacAddress, commonResetCause=commonResetCause, commonMulticastAddressEntry=commonMulticastAddressEntry, commonPhysAddress=commonPhysAddress, commonCheckCode=commonCheckCode, commonACKTimeoutWindow=commonACKTimeoutWindow, commonDeviceReset=commonDeviceReset, commonMaxReturnPower=commonMaxReturnPower)
