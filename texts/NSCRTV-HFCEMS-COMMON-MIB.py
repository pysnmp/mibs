...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceSlot=commonDeviceSlot, commonDeviceResetCause=commonDeviceResetCause, commonDeviceCraftStatus=commonDeviceCraftStatus, commonReturnPathFrequency=commonReturnPathFrequency, commonTamperStatus=commonTamperStatus, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonAdminUseEthernet=commonAdminUseEthernet, commonDeviceStatus=commonDeviceStatus, commonAgentTrapStatus=commonAgentTrapStatus, commonAgentTrapIndex=commonAgentTrapIndex, commonDevicesOID=commonDevicesOID, commonDeviceGroup=commonDeviceGroup, hfcColdStart=hfcColdStart, commonMaxReturnPower=commonMaxReturnPower, commonDeviceSerialNumber=commonDeviceSerialNumber, commonAdminUseRf=commonAdminUseRf, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonTrapAck=commonTrapAck, commonDeviceName=commonDeviceName, commonNESerialNumber=commonNESerialNumber, commonAgentTrapCommunity=commonAgentTrapCommunity, commonDevicesID=commonDevicesID, commonRfGroup=commonRfGroup, commonDeviceReset=commonDeviceReset, commonMacStats=commonMacStats, commonNEModelNumber=commonNEModelNumber, commonNELogicalID=commonNELogicalID, commonVarBindings=commonVarBindings, commonForwardPathFrequency=commonForwardPathFrequency, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonAgentTrapTable=commonAgentTrapTable, commonAgentGroup=commonAgentGroup, commonDeviceInfoTable=commonDeviceInfoTable, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonInternalTemperature=commonInternalTemperature, commonResetCause=commonResetCause, commonDeviceModelNumber=commonDeviceModelNumber, commonDeviceInfoEntry=commonDeviceInfoEntry, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonNEVendor=commonNEVendor, commonMACGroup=commonMACGroup, commonDeviceVendorInfo=commonDeviceVendorInfo, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonAgentReset=commonAgentReset, commonAlarmDetectionControl=commonAlarmDetectionControl, commonAgentTrapEntry=commonAgentTrapEntry, commonBackoffParams=commonBackoffParams, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonMacAddress=commonMacAddress, commonDeviceOID=commonDeviceOID, commonMulticastAddressEntry=commonMulticastAddressEntry, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceMFD=commonDeviceMFD, commonCraftStatus=commonCraftStatus, commonCheckCode=commonCheckCode, commonMaxPayloadSize=commonMaxPayloadSize, commonMulticastAddressIndex=commonMulticastAddressIndex, commonNEVendorInfo=commonNEVendorInfo, commonAgentMaxTraps=commonAgentMaxTraps, commonNEStatus=commonNEStatus, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonDeviceFW=commonDeviceFW, commonDeviceId=commonDeviceId, commonTime=commonTime, commonACKTimeoutWindow=commonACKTimeoutWindow, commonAdminGroup=commonAdminGroup, commonMulticastAddressNumber=commonMulticastAddressNumber, commonPhysAddress=commonPhysAddress, commonDeviceVendor=commonDeviceVendor, commonInvalidMacCmds=commonInvalidMacCmds, commonDeviceNum=commonDeviceNum, commonAgentBootWay=commonAgentBootWay, commonDeviceTamperStatus=commonDeviceTamperStatus, commonTrapCommunityString=commonTrapCommunityString, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonReset=commonReset, commonDeviceMACAddress=commonDeviceMACAddress, commonBackoffPeriod=commonBackoffPeriod, hfcWarmStart=hfcWarmStart, commonAgentTrapIP=commonAgentTrapIP, commonNetworkAddress=commonNetworkAddress, commonDeviceAcct=commonDeviceAcct, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonMulticastAddressTable=commonMulticastAddressTable, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes)
