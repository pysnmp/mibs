...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonNESerialNumber=commonNESerialNumber, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonMulticastAddressIndex=commonMulticastAddressIndex, commonDeviceVendorInfo=commonDeviceVendorInfo, commonAdminUseEthernet=commonAdminUseEthernet, commonNEStatus=commonNEStatus, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonDeviceGroup=commonDeviceGroup, commonInternalTemperature=commonInternalTemperature, commonMulticastAddressEntry=commonMulticastAddressEntry, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonAgentBootWay=commonAgentBootWay, commonDeviceId=commonDeviceId, commonBackoffPeriod=commonBackoffPeriod, commonAgentReset=commonAgentReset, commonCraftStatus=commonCraftStatus, commonDeviceVendor=commonDeviceVendor, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonResetCause=commonResetCause, commonDeviceCraftStatus=commonDeviceCraftStatus, commonDeviceNum=commonDeviceNum, commonAgentTrapCommunity=commonAgentTrapCommunity, commonDeviceOID=commonDeviceOID, commonMulticastAddressNumber=commonMulticastAddressNumber, commonDeviceMACAddress=commonDeviceMACAddress, hfcColdStart=hfcColdStart, commonDeviceSerialNumber=commonDeviceSerialNumber, commonTrapAck=commonTrapAck, commonNELogicalID=commonNELogicalID, commonReset=commonReset, commonAgentGroup=commonAgentGroup, commonAgentMaxTraps=commonAgentMaxTraps, commonMaxReturnPower=commonMaxReturnPower, commonDeviceResetCause=commonDeviceResetCause, commonDevicesID=commonDevicesID, commonNEVendorInfo=commonNEVendorInfo, commonDeviceInfoTable=commonDeviceInfoTable, commonDeviceAcct=commonDeviceAcct, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonCheckCode=commonCheckCode, commonRfGroup=commonRfGroup, commonAdminUseRf=commonAdminUseRf, commonDeviceMFD=commonDeviceMFD, commonDeviceName=commonDeviceName, commonDeviceInfoEntry=commonDeviceInfoEntry, commonAdminGroup=commonAdminGroup, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonDeviceFW=commonDeviceFW, commonVarBindings=commonVarBindings, commonNEModelNumber=commonNEModelNumber, commonAgentTrapEntry=commonAgentTrapEntry, commonForwardPathFrequency=commonForwardPathFrequency, hfcWarmStart=hfcWarmStart, commonDeviceSlot=commonDeviceSlot, commonMaxPayloadSize=commonMaxPayloadSize, commonACKTimeoutWindow=commonACKTimeoutWindow, commonAgentTrapStatus=commonAgentTrapStatus, commonAgentTrapTable=commonAgentTrapTable, commonBackoffParams=commonBackoffParams, commonDeviceReset=commonDeviceReset, commonTime=commonTime, commonTrapCommunityString=commonTrapCommunityString, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonPhysAddress=commonPhysAddress, commonNetworkAddress=commonNetworkAddress, commonDeviceStatus=commonDeviceStatus, commonAgentTrapIP=commonAgentTrapIP, commonNEVendor=commonNEVendor, commonAgentTrapIndex=commonAgentTrapIndex, commonInvalidMacCmds=commonInvalidMacCmds, commonDevicesOID=commonDevicesOID, commonDeviceTamperStatus=commonDeviceTamperStatus, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonAlarmDetectionControl=commonAlarmDetectionControl, commonMulticastAddressTable=commonMulticastAddressTable, commonDeviceModelNumber=commonDeviceModelNumber, commonTamperStatus=commonTamperStatus, commonMacAddress=commonMacAddress, commonMACGroup=commonMACGroup, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonReturnPathFrequency=commonReturnPathFrequency, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonMacStats=commonMacStats, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl)
