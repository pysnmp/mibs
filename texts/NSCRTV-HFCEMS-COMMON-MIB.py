...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonForwardPathFrequency=commonForwardPathFrequency, commonDeviceVendorInfo=commonDeviceVendorInfo, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonBackoffParams=commonBackoffParams, commonTrapAck=commonTrapAck, commonDeviceId=commonDeviceId, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonAdminUseRf=commonAdminUseRf, hfcWarmStart=hfcWarmStart, commonMulticastAddressNumber=commonMulticastAddressNumber, commonMacAddress=commonMacAddress, commonDeviceSerialNumber=commonDeviceSerialNumber, commonDeviceReset=commonDeviceReset, commonNESerialNumber=commonNESerialNumber, commonAgentBootWay=commonAgentBootWay, commonMacStats=commonMacStats, commonDeviceMACAddress=commonDeviceMACAddress, commonAdminUseEthernet=commonAdminUseEthernet, commonNEVendor=commonNEVendor, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonAgentTrapCommunity=commonAgentTrapCommunity, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonACKTimeoutWindow=commonACKTimeoutWindow, commonCraftStatus=commonCraftStatus, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonAgentTrapTable=commonAgentTrapTable, commonAgentMaxTraps=commonAgentMaxTraps, commonDeviceName=commonDeviceName, commonResetCause=commonResetCause, commonAgentGroup=commonAgentGroup, commonDeviceCraftStatus=commonDeviceCraftStatus, commonAlarmDetectionControl=commonAlarmDetectionControl, commonTamperStatus=commonTamperStatus, commonBackoffPeriod=commonBackoffPeriod, commonDeviceTamperStatus=commonDeviceTamperStatus, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonDeviceGroup=commonDeviceGroup, commonDeviceNum=commonDeviceNum, commonMulticastAddressTable=commonMulticastAddressTable, commonDeviceVendor=commonDeviceVendor, commonCheckCode=commonCheckCode, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonTime=commonTime, commonReturnPathFrequency=commonReturnPathFrequency, commonAgentTrapIndex=commonAgentTrapIndex, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonMACGroup=commonMACGroup, commonInvalidMacCmds=commonInvalidMacCmds, commonDeviceInfoTable=commonDeviceInfoTable, commonDevicesID=commonDevicesID, commonAgentTrapIP=commonAgentTrapIP, commonMaxPayloadSize=commonMaxPayloadSize, commonAgentReset=commonAgentReset, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, hfcColdStart=hfcColdStart, commonDeviceModelNumber=commonDeviceModelNumber, commonDeviceResetCause=commonDeviceResetCause, commonNetworkAddress=commonNetworkAddress, commonTrapCommunityString=commonTrapCommunityString, commonInternalTemperature=commonInternalTemperature, commonReset=commonReset, commonRfGroup=commonRfGroup, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonMaxReturnPower=commonMaxReturnPower, commonNEStatus=commonNEStatus, commonVarBindings=commonVarBindings, commonNELogicalID=commonNELogicalID, commonDeviceOID=commonDeviceOID, commonAdminGroup=commonAdminGroup, commonDeviceStatus=commonDeviceStatus, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonDeviceInfoEntry=commonDeviceInfoEntry, commonAgentTrapStatus=commonAgentTrapStatus, commonDeviceMFD=commonDeviceMFD, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonNEModelNumber=commonNEModelNumber, commonNEVendorInfo=commonNEVendorInfo, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonPhysAddress=commonPhysAddress, commonDeviceSlot=commonDeviceSlot, commonDeviceAcct=commonDeviceAcct, commonAgentTrapEntry=commonAgentTrapEntry, commonDevicesOID=commonDevicesOID, commonDeviceFW=commonDeviceFW, commonMulticastAddressEntry=commonMulticastAddressEntry, commonMulticastAddressIndex=commonMulticastAddressIndex)
