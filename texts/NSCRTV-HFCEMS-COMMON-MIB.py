...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonAdminUseRf=commonAdminUseRf, commonMulticastAddressEntry=commonMulticastAddressEntry, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceStatus=commonDeviceStatus, commonDeviceMACAddress=commonDeviceMACAddress, commonDeviceTamperStatus=commonDeviceTamperStatus, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonMulticastAddressNumber=commonMulticastAddressNumber, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonNEVendor=commonNEVendor, commonCraftStatus=commonCraftStatus, commonMACGroup=commonMACGroup, commonAlarmDetectionControl=commonAlarmDetectionControl, commonAgentMaxTraps=commonAgentMaxTraps, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonRfGroup=commonRfGroup, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceModelNumber=commonDeviceModelNumber, commonDeviceMFD=commonDeviceMFD, commonTime=commonTime, commonMaxReturnPower=commonMaxReturnPower, hfcColdStart=hfcColdStart, commonAgentTrapIndex=commonAgentTrapIndex, commonTrapCommunityString=commonTrapCommunityString, commonDeviceSlot=commonDeviceSlot, commonDeviceSerialNumber=commonDeviceSerialNumber, hfcWarmStart=hfcWarmStart, commonAgentTrapStatus=commonAgentTrapStatus, commonReset=commonReset, commonAgentTrapIP=commonAgentTrapIP, commonVarBindings=commonVarBindings, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonDeviceNum=commonDeviceNum, commonReturnPathFrequency=commonReturnPathFrequency, commonTamperStatus=commonTamperStatus, commonResetCause=commonResetCause, commonPhysAddress=commonPhysAddress, commonDeviceName=commonDeviceName, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonAdminUseEthernet=commonAdminUseEthernet, commonDeviceReset=commonDeviceReset, commonInternalTemperature=commonInternalTemperature, commonCheckCode=commonCheckCode, commonMacAddress=commonMacAddress, commonAgentReset=commonAgentReset, commonDevicesOID=commonDevicesOID, commonACKTimeoutWindow=commonACKTimeoutWindow, commonDeviceGroup=commonDeviceGroup, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonMacStats=commonMacStats, commonAgentGroup=commonAgentGroup, commonMaxPayloadSize=commonMaxPayloadSize, commonNELogicalID=commonNELogicalID, commonDeviceInfoEntry=commonDeviceInfoEntry, commonDeviceOID=commonDeviceOID, commonAdminGroup=commonAdminGroup, commonDeviceId=commonDeviceId, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonMulticastAddressIndex=commonMulticastAddressIndex, commonTrapAck=commonTrapAck, commonBackoffPeriod=commonBackoffPeriod, commonNEVendorInfo=commonNEVendorInfo, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonMulticastAddressTable=commonMulticastAddressTable, commonInvalidMacCmds=commonInvalidMacCmds, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonDevicesID=commonDevicesID, commonNEStatus=commonNEStatus, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonBackoffParams=commonBackoffParams, commonNEModelNumber=commonNEModelNumber, commonAgentTrapTable=commonAgentTrapTable, commonDeviceResetCause=commonDeviceResetCause, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonDeviceVendor=commonDeviceVendor, commonDeviceFW=commonDeviceFW, commonDeviceAcct=commonDeviceAcct, commonDeviceVendorInfo=commonDeviceVendorInfo, commonDeviceCraftStatus=commonDeviceCraftStatus, commonForwardPathFrequency=commonForwardPathFrequency, commonNetworkAddress=commonNetworkAddress, commonNESerialNumber=commonNESerialNumber, commonAgentBootWay=commonAgentBootWay, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonAgentTrapCommunity=commonAgentTrapCommunity, commonDeviceInfoTable=commonDeviceInfoTable)
