...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceStatus=commonDeviceStatus, commonTrapAck=commonTrapAck, commonAgentTrapIndex=commonAgentTrapIndex, commonDeviceReset=commonDeviceReset, commonAgentReset=commonAgentReset, commonDeviceGroup=commonDeviceGroup, commonDeviceSerialNumber=commonDeviceSerialNumber, commonReset=commonReset, commonDeviceVendorInfo=commonDeviceVendorInfo, commonDeviceInfoTable=commonDeviceInfoTable, commonDevicesID=commonDevicesID, commonCraftStatus=commonCraftStatus, commonDeviceResetCause=commonDeviceResetCause, commonAdminUseEthernet=commonAdminUseEthernet, commonDeviceOID=commonDeviceOID, hfcColdStart=hfcColdStart, commonResetCause=commonResetCause, commonBackoffPeriod=commonBackoffPeriod, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonNetworkAddress=commonNetworkAddress, commonACKTimeoutWindow=commonACKTimeoutWindow, commonMulticastAddressEntry=commonMulticastAddressEntry, commonAdminUseRf=commonAdminUseRf, commonForwardPathFrequency=commonForwardPathFrequency, commonAgentTrapEntry=commonAgentTrapEntry, commonPhysAddress=commonPhysAddress, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonAgentTrapCommunity=commonAgentTrapCommunity, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceMFD=commonDeviceMFD, commonNEModelNumber=commonNEModelNumber, commonMulticastAddressTable=commonMulticastAddressTable, commonCheckCode=commonCheckCode, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonMulticastAddressIndex=commonMulticastAddressIndex, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonDevicesOID=commonDevicesOID, commonTrapCommunityString=commonTrapCommunityString, hfcWarmStart=hfcWarmStart, commonMacAddress=commonMacAddress, commonDeviceModelNumber=commonDeviceModelNumber, commonNEVendorInfo=commonNEVendorInfo, commonNELogicalID=commonNELogicalID, commonDeviceInfoEntry=commonDeviceInfoEntry, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonDeviceFW=commonDeviceFW, commonAgentTrapIP=commonAgentTrapIP, commonAgentBootWay=commonAgentBootWay, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonAgentTrapStatus=commonAgentTrapStatus, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonBackoffParams=commonBackoffParams, commonDeviceName=commonDeviceName, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonMaxReturnPower=commonMaxReturnPower, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonNEStatus=commonNEStatus, commonDeviceSlot=commonDeviceSlot, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDeviceNum=commonDeviceNum, commonMacStats=commonMacStats, commonAdminGroup=commonAdminGroup, commonDeviceId=commonDeviceId, commonDeviceMACAddress=commonDeviceMACAddress, commonNESerialNumber=commonNESerialNumber, commonTime=commonTime, commonRfGroup=commonRfGroup, commonInvalidMacCmds=commonInvalidMacCmds, commonInternalTemperature=commonInternalTemperature, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonNEVendor=commonNEVendor, commonAgentTrapTable=commonAgentTrapTable, commonReturnPathFrequency=commonReturnPathFrequency, commonDeviceAcct=commonDeviceAcct, commonMaxPayloadSize=commonMaxPayloadSize, commonAgentGroup=commonAgentGroup, commonDeviceVendor=commonDeviceVendor, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonAgentMaxTraps=commonAgentMaxTraps, commonTamperStatus=commonTamperStatus, commonDeviceTamperStatus=commonDeviceTamperStatus, commonMACGroup=commonMACGroup, commonVarBindings=commonVarBindings, commonDeviceCraftStatus=commonDeviceCraftStatus, commonAlarmDetectionControl=commonAlarmDetectionControl, commonMulticastAddressNumber=commonMulticastAddressNumber)
