...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceOID=commonDeviceOID, commonDeviceMACAddress=commonDeviceMACAddress, commonNELogicalID=commonNELogicalID, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonNEStatus=commonNEStatus, commonAgentTrapTable=commonAgentTrapTable, commonMACGroup=commonMACGroup, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonMulticastAddressNumber=commonMulticastAddressNumber, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonAdminGroup=commonAdminGroup, commonNetworkAddress=commonNetworkAddress, commonDevicesID=commonDevicesID, commonAgentTrapStatus=commonAgentTrapStatus, commonCraftStatus=commonCraftStatus, commonPhysAddress=commonPhysAddress, commonNEVendorInfo=commonNEVendorInfo, commonDeviceInfoTable=commonDeviceInfoTable, commonDeviceVendor=commonDeviceVendor, commonNESerialNumber=commonNESerialNumber, commonReset=commonReset, commonDeviceNum=commonDeviceNum, commonAgentMaxTraps=commonAgentMaxTraps, commonMacStats=commonMacStats, commonDeviceName=commonDeviceName, commonAdminUseRf=commonAdminUseRf, commonRfGroup=commonRfGroup, commonReturnPathFrequency=commonReturnPathFrequency, commonBackoffPeriod=commonBackoffPeriod, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonDeviceMFD=commonDeviceMFD, commonDeviceFW=commonDeviceFW, commonMaxReturnPower=commonMaxReturnPower, commonDeviceInfoEntry=commonDeviceInfoEntry, hfcWarmStart=hfcWarmStart, commonDeviceTamperStatus=commonDeviceTamperStatus, commonDeviceAcct=commonDeviceAcct, commonTrapCommunityString=commonTrapCommunityString, commonMaxPayloadSize=commonMaxPayloadSize, commonDeviceSlot=commonDeviceSlot, hfcColdStart=hfcColdStart, commonDeviceSerialNumber=commonDeviceSerialNumber, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonMulticastAddressEntry=commonMulticastAddressEntry, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonMacAddress=commonMacAddress, commonDeviceResetCause=commonDeviceResetCause, commonInternalTemperature=commonInternalTemperature, commonAgentTrapIndex=commonAgentTrapIndex, commonAdminUseEthernet=commonAdminUseEthernet, commonNEVendor=commonNEVendor, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonCheckCode=commonCheckCode, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonForwardPathFrequency=commonForwardPathFrequency, commonVarBindings=commonVarBindings, commonAgentReset=commonAgentReset, commonTime=commonTime, commonAgentBootWay=commonAgentBootWay, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonDeviceReset=commonDeviceReset, commonACKTimeoutWindow=commonACKTimeoutWindow, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonAgentGroup=commonAgentGroup, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonDeviceGroup=commonDeviceGroup, commonDevicesOID=commonDevicesOID, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonDeviceVendorInfo=commonDeviceVendorInfo, commonTamperStatus=commonTamperStatus, commonBackoffParams=commonBackoffParams, commonMulticastAddressIndex=commonMulticastAddressIndex, commonNEModelNumber=commonNEModelNumber, commonAlarmDetectionControl=commonAlarmDetectionControl, commonAgentTrapIP=commonAgentTrapIP, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceId=commonDeviceId, commonDeviceModelNumber=commonDeviceModelNumber, commonDeviceCraftStatus=commonDeviceCraftStatus, commonTrapAck=commonTrapAck, commonResetCause=commonResetCause, commonMulticastAddressTable=commonMulticastAddressTable, commonInvalidMacCmds=commonInvalidMacCmds, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceStatus=commonDeviceStatus, commonAgentTrapCommunity=commonAgentTrapCommunity)
