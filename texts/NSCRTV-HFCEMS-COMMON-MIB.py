...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonNetworkAddress=commonNetworkAddress, commonVarBindings=commonVarBindings, commonDeviceId=commonDeviceId, commonNEModelNumber=commonNEModelNumber, commonMacAddress=commonMacAddress, commonDeviceMACAddress=commonDeviceMACAddress, commonAgentBootWay=commonAgentBootWay, commonDeviceSlot=commonDeviceSlot, commonMulticastAddressIndex=commonMulticastAddressIndex, commonReturnPathFrequency=commonReturnPathFrequency, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonCheckCode=commonCheckCode, commonDeviceStatus=commonDeviceStatus, commonAdminGroup=commonAdminGroup, commonNEStatus=commonNEStatus, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, hfcWarmStart=hfcWarmStart, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonAgentMaxTraps=commonAgentMaxTraps, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonTrapAck=commonTrapAck, commonForwardPathFrequency=commonForwardPathFrequency, commonDeviceResetCause=commonDeviceResetCause, commonResetCause=commonResetCause, commonDeviceMFD=commonDeviceMFD, commonBackoffParams=commonBackoffParams, commonDeviceSerialNumber=commonDeviceSerialNumber, commonDevicesOID=commonDevicesOID, commonMulticastAddressTable=commonMulticastAddressTable, commonDeviceModelNumber=commonDeviceModelNumber, commonMaxReturnPower=commonMaxReturnPower, commonReset=commonReset, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonTrapCommunityString=commonTrapCommunityString, commonNEVendorInfo=commonNEVendorInfo, commonBackoffPeriod=commonBackoffPeriod, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonAdminUseEthernet=commonAdminUseEthernet, commonDeviceCraftStatus=commonDeviceCraftStatus, commonInternalTemperature=commonInternalTemperature, commonDeviceFW=commonDeviceFW, commonMACGroup=commonMACGroup, commonNELogicalID=commonNELogicalID, commonDeviceVendorInfo=commonDeviceVendorInfo, commonTime=commonTime, commonDeviceInfoTable=commonDeviceInfoTable, commonDeviceName=commonDeviceName, commonMaxPayloadSize=commonMaxPayloadSize, commonRfGroup=commonRfGroup, commonCraftStatus=commonCraftStatus, commonAdminUseRf=commonAdminUseRf, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonDeviceAcct=commonDeviceAcct, commonMulticastAddressEntry=commonMulticastAddressEntry, commonAlarmDetectionControl=commonAlarmDetectionControl, commonACKTimeoutWindow=commonACKTimeoutWindow, commonPhysAddress=commonPhysAddress, commonAgentTrapIP=commonAgentTrapIP, commonAgentTrapEntry=commonAgentTrapEntry, commonInvalidMacCmds=commonInvalidMacCmds, hfcColdStart=hfcColdStart, commonDeviceNum=commonDeviceNum, commonMacStats=commonMacStats, commonAgentTrapTable=commonAgentTrapTable, commonDeviceVendor=commonDeviceVendor, commonNEVendor=commonNEVendor, commonNESerialNumber=commonNESerialNumber, commonAgentTrapCommunity=commonAgentTrapCommunity, commonDeviceGroup=commonDeviceGroup, commonAgentTrapStatus=commonAgentTrapStatus, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonMulticastAddressNumber=commonMulticastAddressNumber, commonAgentTrapIndex=commonAgentTrapIndex, commonDeviceReset=commonDeviceReset, commonDeviceInfoEntry=commonDeviceInfoEntry, commonDeviceOID=commonDeviceOID, commonTamperStatus=commonTamperStatus, commonDevicesID=commonDevicesID, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonAgentGroup=commonAgentGroup, commonAgentReset=commonAgentReset, commonDeviceTamperStatus=commonDeviceTamperStatus)
