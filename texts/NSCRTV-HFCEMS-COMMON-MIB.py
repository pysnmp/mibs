...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonAdminUseEthernet=commonAdminUseEthernet, commonTamperStatus=commonTamperStatus, commonAgentTrapEntry=commonAgentTrapEntry, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonBackoffPeriod=commonBackoffPeriod, commonAgentTrapIP=commonAgentTrapIP, commonMaxReturnPower=commonMaxReturnPower, commonAgentTrapCommunity=commonAgentTrapCommunity, commonAgentMaxTraps=commonAgentMaxTraps, commonDevicesOID=commonDevicesOID, commonDeviceFW=commonDeviceFW, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonDeviceMACAddress=commonDeviceMACAddress, commonNEVendorInfo=commonNEVendorInfo, hfcWarmStart=hfcWarmStart, commonMACGroup=commonMACGroup, commonPhysAddress=commonPhysAddress, commonMulticastAddressIndex=commonMulticastAddressIndex, commonMacAddress=commonMacAddress, commonDeviceInfoEntry=commonDeviceInfoEntry, commonDeviceVendor=commonDeviceVendor, commonNetworkAddress=commonNetworkAddress, commonDeviceCraftStatus=commonDeviceCraftStatus, commonDeviceGroup=commonDeviceGroup, commonRfGroup=commonRfGroup, commonDeviceResetCause=commonDeviceResetCause, commonDeviceId=commonDeviceId, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonInvalidMacCmds=commonInvalidMacCmds, commonReset=commonReset, commonAgentTrapIndex=commonAgentTrapIndex, commonBackoffParams=commonBackoffParams, commonMulticastAddressTable=commonMulticastAddressTable, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonForwardPathFrequency=commonForwardPathFrequency, commonInternalTemperature=commonInternalTemperature, commonMaxPayloadSize=commonMaxPayloadSize, commonAdminUseRf=commonAdminUseRf, commonDeviceOID=commonDeviceOID, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonCheckCode=commonCheckCode, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonDeviceTamperStatus=commonDeviceTamperStatus, commonDevicesID=commonDevicesID, commonAgentTrapTable=commonAgentTrapTable, commonAgentReset=commonAgentReset, commonACKTimeoutWindow=commonACKTimeoutWindow, commonDeviceNum=commonDeviceNum, commonDeviceInfoTable=commonDeviceInfoTable, commonResetCause=commonResetCause, commonNEVendor=commonNEVendor, commonMulticastAddressEntry=commonMulticastAddressEntry, commonDeviceAcct=commonDeviceAcct, commonDeviceModelNumber=commonDeviceModelNumber, commonReturnPathFrequency=commonReturnPathFrequency, commonAgentGroup=commonAgentGroup, commonNELogicalID=commonNELogicalID, commonAlarmDetectionControl=commonAlarmDetectionControl, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonAgentTrapStatus=commonAgentTrapStatus, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceSlot=commonDeviceSlot, commonNEStatus=commonNEStatus, commonMulticastAddressNumber=commonMulticastAddressNumber, commonDeviceStatus=commonDeviceStatus, hfcColdStart=hfcColdStart, commonAgentBootWay=commonAgentBootWay, commonDeviceName=commonDeviceName, commonTrapCommunityString=commonTrapCommunityString, commonNESerialNumber=commonNESerialNumber, commonDeviceVendorInfo=commonDeviceVendorInfo, commonMacStats=commonMacStats, commonAdminGroup=commonAdminGroup, commonVarBindings=commonVarBindings, commonDeviceMFD=commonDeviceMFD, commonTime=commonTime, commonDeviceReset=commonDeviceReset, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonDeviceSerialNumber=commonDeviceSerialNumber, commonTrapAck=commonTrapAck, commonNEModelNumber=commonNEModelNumber, commonCraftStatus=commonCraftStatus)
