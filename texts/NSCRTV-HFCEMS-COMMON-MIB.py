...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceInfoTable=commonDeviceInfoTable, commonDeviceName=commonDeviceName, commonAgentGroup=commonAgentGroup, commonTrapCommunityString=commonTrapCommunityString, commonAgentReset=commonAgentReset, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonDeviceReset=commonDeviceReset, commonDeviceTamperStatus=commonDeviceTamperStatus, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceVendor=commonDeviceVendor, commonDeviceGroup=commonDeviceGroup, commonDeviceModelNumber=commonDeviceModelNumber, commonAgentTrapEntry=commonAgentTrapEntry, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonMulticastAddressTable=commonMulticastAddressTable, commonNEStatus=commonNEStatus, commonDeviceResetCause=commonDeviceResetCause, commonVarBindings=commonVarBindings, commonNELogicalID=commonNELogicalID, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceCraftStatus=commonDeviceCraftStatus, commonDevicesOID=commonDevicesOID, commonDeviceStatus=commonDeviceStatus, commonNEModelNumber=commonNEModelNumber, commonTrapAck=commonTrapAck, commonACKTimeoutWindow=commonACKTimeoutWindow, commonRfGroup=commonRfGroup, commonAdminUseRf=commonAdminUseRf, commonPhysAddress=commonPhysAddress, commonInvalidMacCmds=commonInvalidMacCmds, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonNetworkAddress=commonNetworkAddress, commonAgentTrapIP=commonAgentTrapIP, commonDeviceNum=commonDeviceNum, commonMaxPayloadSize=commonMaxPayloadSize, commonMaxReturnPower=commonMaxReturnPower, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonDeviceAcct=commonDeviceAcct, commonDeviceSlot=commonDeviceSlot, commonCheckCode=commonCheckCode, commonResetCause=commonResetCause, commonTime=commonTime, commonNEVendorInfo=commonNEVendorInfo, commonAgentTrapCommunity=commonAgentTrapCommunity, commonAgentTrapIndex=commonAgentTrapIndex, commonAgentTrapTable=commonAgentTrapTable, commonMacAddress=commonMacAddress, commonCraftStatus=commonCraftStatus, commonAgentBootWay=commonAgentBootWay, hfcColdStart=hfcColdStart, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonReturnPathFrequency=commonReturnPathFrequency, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonAgentTrapStatus=commonAgentTrapStatus, commonDeviceSerialNumber=commonDeviceSerialNumber, commonAdminUseEthernet=commonAdminUseEthernet, commonBackoffPeriod=commonBackoffPeriod, commonDeviceOID=commonDeviceOID, hfcWarmStart=hfcWarmStart, commonDeviceInfoEntry=commonDeviceInfoEntry, commonNESerialNumber=commonNESerialNumber, commonNEVendor=commonNEVendor, commonMacStats=commonMacStats, commonTamperStatus=commonTamperStatus, commonAgentMaxTraps=commonAgentMaxTraps, commonDeviceId=commonDeviceId, commonMACGroup=commonMACGroup, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonDeviceMACAddress=commonDeviceMACAddress, commonAdminGroup=commonAdminGroup, commonMulticastAddressEntry=commonMulticastAddressEntry, commonReset=commonReset, commonDeviceMFD=commonDeviceMFD, commonMulticastAddressIndex=commonMulticastAddressIndex, commonDeviceFW=commonDeviceFW, commonBackoffParams=commonBackoffParams, commonDeviceVendorInfo=commonDeviceVendorInfo, commonForwardPathFrequency=commonForwardPathFrequency, commonDevicesID=commonDevicesID, commonInternalTemperature=commonInternalTemperature, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonAlarmDetectionControl=commonAlarmDetectionControl, commonMulticastAddressNumber=commonMulticastAddressNumber, commonForwardPathCRCErrors=commonForwardPathCRCErrors)
