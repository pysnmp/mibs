...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceOID=commonDeviceOID, commonMulticastAddressTable=commonMulticastAddressTable, commonNEStatus=commonNEStatus, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonMulticastAddressNumber=commonMulticastAddressNumber, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonCheckCode=commonCheckCode, commonRfGroup=commonRfGroup, commonDeviceInfoTable=commonDeviceInfoTable, commonMacAddress=commonMacAddress, commonMaxPayloadSize=commonMaxPayloadSize, commonDeviceTamperStatus=commonDeviceTamperStatus, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonTrapCommunityString=commonTrapCommunityString, commonNELogicalID=commonNELogicalID, commonAgentTrapEntry=commonAgentTrapEntry, commonTamperStatus=commonTamperStatus, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonPhysAddress=commonPhysAddress, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonDeviceFW=commonDeviceFW, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonDeviceAcct=commonDeviceAcct, commonForwardPathFrequency=commonForwardPathFrequency, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonInternalTemperature=commonInternalTemperature, commonDeviceSlot=commonDeviceSlot, commonMACGroup=commonMACGroup, commonDeviceSerialNumber=commonDeviceSerialNumber, commonDeviceCraftStatus=commonDeviceCraftStatus, commonVarBindings=commonVarBindings, commonReset=commonReset, commonDeviceGroup=commonDeviceGroup, commonDeviceInfoEntry=commonDeviceInfoEntry, commonDeviceVendorInfo=commonDeviceVendorInfo, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonBackoffPeriod=commonBackoffPeriod, commonBackoffParams=commonBackoffParams, commonNESerialNumber=commonNESerialNumber, commonAgentReset=commonAgentReset, hfcColdStart=hfcColdStart, commonAdminUseEthernet=commonAdminUseEthernet, commonAgentTrapCommunity=commonAgentTrapCommunity, commonMulticastAddressEntry=commonMulticastAddressEntry, commonDeviceMACAddress=commonDeviceMACAddress, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonNEVendor=commonNEVendor, commonResetCause=commonResetCause, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonDeviceModelNumber=commonDeviceModelNumber, commonCraftStatus=commonCraftStatus, commonNetworkAddress=commonNetworkAddress, commonDeviceId=commonDeviceId, commonDeviceMFD=commonDeviceMFD, commonDevicesOID=commonDevicesOID, commonACKTimeoutWindow=commonACKTimeoutWindow, commonInvalidMacCmds=commonInvalidMacCmds, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonAgentMaxTraps=commonAgentMaxTraps, commonDeviceName=commonDeviceName, commonReturnPathFrequency=commonReturnPathFrequency, commonTrapAck=commonTrapAck, commonDeviceStatus=commonDeviceStatus, commonAgentGroup=commonAgentGroup, commonMaxReturnPower=commonMaxReturnPower, commonAgentBootWay=commonAgentBootWay, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDevicesID=commonDevicesID, commonAgentTrapStatus=commonAgentTrapStatus, commonNEVendorInfo=commonNEVendorInfo, commonMacStats=commonMacStats, commonAdminGroup=commonAdminGroup, hfcWarmStart=hfcWarmStart, commonTime=commonTime, commonAgentTrapTable=commonAgentTrapTable, commonAgentTrapIndex=commonAgentTrapIndex, commonDeviceResetCause=commonDeviceResetCause, commonAgentTrapIP=commonAgentTrapIP, commonDeviceReset=commonDeviceReset, commonMulticastAddressIndex=commonMulticastAddressIndex, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonAlarmDetectionControl=commonAlarmDetectionControl, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonNEModelNumber=commonNEModelNumber, commonDeviceVendor=commonDeviceVendor, commonAdminUseRf=commonAdminUseRf, commonDeviceNum=commonDeviceNum)
