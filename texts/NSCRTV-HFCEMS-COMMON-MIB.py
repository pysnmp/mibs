...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceOID=commonDeviceOID, commonMulticastAddressTable=commonMulticastAddressTable, commonDeviceResetCause=commonDeviceResetCause, commonNEVendorInfo=commonNEVendorInfo, commonDeviceMFD=commonDeviceMFD, commonTrapCommunityString=commonTrapCommunityString, commonNEStatus=commonNEStatus, commonPhysAddress=commonPhysAddress, commonTime=commonTime, commonNEVendor=commonNEVendor, commonRfGroup=commonRfGroup, commonNetworkAddress=commonNetworkAddress, commonBackoffPeriod=commonBackoffPeriod, commonDeviceVendorInfo=commonDeviceVendorInfo, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonMaxReturnPower=commonMaxReturnPower, commonAgentTrapIndex=commonAgentTrapIndex, hfcColdStart=hfcColdStart, commonAgentTrapStatus=commonAgentTrapStatus, commonTamperStatus=commonTamperStatus, commonDeviceReset=commonDeviceReset, commonMulticastAddressNumber=commonMulticastAddressNumber, commonAgentTrapTable=commonAgentTrapTable, commonAdminUseEthernet=commonAdminUseEthernet, commonDeviceInfoEntry=commonDeviceInfoEntry, commonAgentTrapCommunity=commonAgentTrapCommunity, commonReturnPathFrequency=commonReturnPathFrequency, commonMulticastAddressEntry=commonMulticastAddressEntry, commonNELogicalID=commonNELogicalID, commonDeviceStatus=commonDeviceStatus, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceModelNumber=commonDeviceModelNumber, commonBackoffParams=commonBackoffParams, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonDeviceMACAddress=commonDeviceMACAddress, commonReset=commonReset, commonMacAddress=commonMacAddress, commonAdminGroup=commonAdminGroup, commonDeviceGroup=commonDeviceGroup, commonInternalTemperature=commonInternalTemperature, commonAlarmDetectionControl=commonAlarmDetectionControl, commonDeviceId=commonDeviceId, commonResetCause=commonResetCause, commonMaxPayloadSize=commonMaxPayloadSize, commonAgentReset=commonAgentReset, commonMacStats=commonMacStats, commonDeviceName=commonDeviceName, commonDeviceTamperStatus=commonDeviceTamperStatus, commonAgentTrapIP=commonAgentTrapIP, commonDeviceInfoTable=commonDeviceInfoTable, commonNESerialNumber=commonNESerialNumber, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDeviceFW=commonDeviceFW, commonDeviceNum=commonDeviceNum, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonAgentBootWay=commonAgentBootWay, commonInvalidMacCmds=commonInvalidMacCmds, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonMulticastAddressIndex=commonMulticastAddressIndex, commonDeviceCraftStatus=commonDeviceCraftStatus, commonDeviceSlot=commonDeviceSlot, commonCheckCode=commonCheckCode, commonCraftStatus=commonCraftStatus, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonDeviceAcct=commonDeviceAcct, commonMACGroup=commonMACGroup, commonVarBindings=commonVarBindings, commonDeviceSerialNumber=commonDeviceSerialNumber, commonDevicesOID=commonDevicesOID, commonForwardPathFrequency=commonForwardPathFrequency, commonNEModelNumber=commonNEModelNumber, commonAdminUseRf=commonAdminUseRf, commonTrapAck=commonTrapAck, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonAgentMaxTraps=commonAgentMaxTraps, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonDevicesID=commonDevicesID, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonAgentTrapEntry=commonAgentTrapEntry, commonACKTimeoutWindow=commonACKTimeoutWindow, hfcWarmStart=hfcWarmStart, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonDeviceVendor=commonDeviceVendor, commonAgentGroup=commonAgentGroup)
