...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceId=commonDeviceId, commonDeviceNum=commonDeviceNum, commonACKTimeoutWindow=commonACKTimeoutWindow, commonNEModelNumber=commonNEModelNumber, commonInternalTemperature=commonInternalTemperature, commonAgentTrapStatus=commonAgentTrapStatus, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonDeviceName=commonDeviceName, commonDeviceGroup=commonDeviceGroup, commonNESerialNumber=commonNESerialNumber, commonNEStatus=commonNEStatus, commonReset=commonReset, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonAgentGroup=commonAgentGroup, commonAgentReset=commonAgentReset, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonMaxReturnPower=commonMaxReturnPower, commonAdminUseRf=commonAdminUseRf, commonDevicesID=commonDevicesID, commonAgentBootWay=commonAgentBootWay, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonNELogicalID=commonNELogicalID, commonDeviceTamperStatus=commonDeviceTamperStatus, commonForwardPathFrequency=commonForwardPathFrequency, commonBackoffParams=commonBackoffParams, commonAlarmDetectionControl=commonAlarmDetectionControl, commonMACGroup=commonMACGroup, commonTime=commonTime, commonRfGroup=commonRfGroup, commonDeviceInfoEntry=commonDeviceInfoEntry, commonTrapCommunityString=commonTrapCommunityString, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonMaxPayloadSize=commonMaxPayloadSize, hfcWarmStart=hfcWarmStart, commonResetCause=commonResetCause, commonVarBindings=commonVarBindings, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonMacAddress=commonMacAddress, commonMulticastAddressTable=commonMulticastAddressTable, commonDeviceReset=commonDeviceReset, commonDeviceAcct=commonDeviceAcct, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonMulticastAddressEntry=commonMulticastAddressEntry, commonTrapAck=commonTrapAck, commonMulticastAddressNumber=commonMulticastAddressNumber, commonBackoffPeriod=commonBackoffPeriod, commonDeviceStatus=commonDeviceStatus, commonDeviceVendorInfo=commonDeviceVendorInfo, hfcColdStart=hfcColdStart, commonNEVendor=commonNEVendor, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonDeviceModelNumber=commonDeviceModelNumber, commonDeviceCraftStatus=commonDeviceCraftStatus, commonDeviceOID=commonDeviceOID, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonAgentTrapIndex=commonAgentTrapIndex, commonAgentMaxTraps=commonAgentMaxTraps, commonDeviceFW=commonDeviceFW, commonDeviceSlot=commonDeviceSlot, commonDeviceVendor=commonDeviceVendor, commonMacStats=commonMacStats, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonAgentTrapTable=commonAgentTrapTable, commonAgentTrapIP=commonAgentTrapIP, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonInvalidMacCmds=commonInvalidMacCmds, commonAgentTrapCommunity=commonAgentTrapCommunity, commonReturnPathFrequency=commonReturnPathFrequency, commonNEVendorInfo=commonNEVendorInfo, commonDeviceResetCause=commonDeviceResetCause, commonAdminUseEthernet=commonAdminUseEthernet, commonDevicesOID=commonDevicesOID, commonTamperStatus=commonTamperStatus, commonDeviceSerialNumber=commonDeviceSerialNumber, commonAdminGroup=commonAdminGroup, commonDeviceMFD=commonDeviceMFD, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonCraftStatus=commonCraftStatus, commonNetworkAddress=commonNetworkAddress, commonDeviceInfoTable=commonDeviceInfoTable, commonMulticastAddressIndex=commonMulticastAddressIndex, commonCheckCode=commonCheckCode, commonDeviceMACAddress=commonDeviceMACAddress, commonPhysAddress=commonPhysAddress)
