...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonMulticastAddressTable=commonMulticastAddressTable, commonAgentTrapIP=commonAgentTrapIP, commonDeviceTamperStatus=commonDeviceTamperStatus, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceSlot=commonDeviceSlot, commonNESerialNumber=commonNESerialNumber, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonMulticastAddressIndex=commonMulticastAddressIndex, commonMACGroup=commonMACGroup, commonTrapCommunityString=commonTrapCommunityString, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonAgentTrapIndex=commonAgentTrapIndex, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonNEStatus=commonNEStatus, commonInternalTemperature=commonInternalTemperature, commonDeviceMFD=commonDeviceMFD, commonDeviceInfoEntry=commonDeviceInfoEntry, commonDevicesOID=commonDevicesOID, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonMacStats=commonMacStats, commonAgentMaxTraps=commonAgentMaxTraps, commonACKTimeoutWindow=commonACKTimeoutWindow, commonDeviceNum=commonDeviceNum, commonCraftStatus=commonCraftStatus, commonAgentTrapTable=commonAgentTrapTable, commonVarBindings=commonVarBindings, commonDeviceMACAddress=commonDeviceMACAddress, commonCheckCode=commonCheckCode, commonDeviceName=commonDeviceName, commonDeviceGroup=commonDeviceGroup, commonAgentGroup=commonAgentGroup, commonTrapAck=commonTrapAck, commonMulticastAddressEntry=commonMulticastAddressEntry, commonDeviceReset=commonDeviceReset, commonMacAddress=commonMacAddress, commonForwardPathFrequency=commonForwardPathFrequency, commonAdminUseEthernet=commonAdminUseEthernet, commonBackoffParams=commonBackoffParams, commonAgentReset=commonAgentReset, commonDeviceCraftStatus=commonDeviceCraftStatus, commonNEVendor=commonNEVendor, commonDeviceId=commonDeviceId, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonDevicesID=commonDevicesID, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDeviceVendorInfo=commonDeviceVendorInfo, commonNetworkAddress=commonNetworkAddress, commonMulticastAddressNumber=commonMulticastAddressNumber, commonDeviceStatus=commonDeviceStatus, commonBackoffPeriod=commonBackoffPeriod, commonMaxPayloadSize=commonMaxPayloadSize, commonRfGroup=commonRfGroup, commonAgentBootWay=commonAgentBootWay, commonNELogicalID=commonNELogicalID, commonTamperStatus=commonTamperStatus, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonDeviceAcct=commonDeviceAcct, commonAgentTrapStatus=commonAgentTrapStatus, commonTime=commonTime, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonDeviceSerialNumber=commonDeviceSerialNumber, commonAdminUseRf=commonAdminUseRf, commonNEVendorInfo=commonNEVendorInfo, commonDeviceFW=commonDeviceFW, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonReturnPathFrequency=commonReturnPathFrequency, commonPhysAddress=commonPhysAddress, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonMaxReturnPower=commonMaxReturnPower, hfcColdStart=hfcColdStart, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceInfoTable=commonDeviceInfoTable, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonResetCause=commonResetCause, commonDeviceOID=commonDeviceOID, commonAdminGroup=commonAdminGroup, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonDeviceResetCause=commonDeviceResetCause, commonNEModelNumber=commonNEModelNumber, commonInvalidMacCmds=commonInvalidMacCmds, commonDeviceModelNumber=commonDeviceModelNumber, hfcWarmStart=hfcWarmStart, commonAgentTrapCommunity=commonAgentTrapCommunity, commonReset=commonReset, commonDeviceVendor=commonDeviceVendor, commonAlarmDetectionControl=commonAlarmDetectionControl)
