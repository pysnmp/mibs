...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonDeviceFW=commonDeviceFW, commonDeviceMACAddress=commonDeviceMACAddress, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonDeviceNum=commonDeviceNum, commonNEVendor=commonNEVendor, commonAgentGroup=commonAgentGroup, commonInternalTemperature=commonInternalTemperature, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceSlot=commonDeviceSlot, commonBackoffParams=commonBackoffParams, commonForwardPathFrequency=commonForwardPathFrequency, commonDeviceId=commonDeviceId, commonAgentTrapIndex=commonAgentTrapIndex, commonReset=commonReset, commonAgentTrapStatus=commonAgentTrapStatus, commonNEStatus=commonNEStatus, commonAgentTrapIP=commonAgentTrapIP, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonDeviceVendorInfo=commonDeviceVendorInfo, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonDeviceInfoEntry=commonDeviceInfoEntry, commonCraftStatus=commonCraftStatus, hfcColdStart=hfcColdStart, commonNetworkAddress=commonNetworkAddress, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, hfcWarmStart=hfcWarmStart, commonAgentReset=commonAgentReset, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonDeviceVendor=commonDeviceVendor, commonInvalidMacCmds=commonInvalidMacCmds, commonReturnPathFrequency=commonReturnPathFrequency, commonMulticastAddressNumber=commonMulticastAddressNumber, commonAdminGroup=commonAdminGroup, commonMacAddress=commonMacAddress, commonTamperStatus=commonTamperStatus, commonAdminUseRf=commonAdminUseRf, commonDeviceStatus=commonDeviceStatus, commonDeviceInfoTable=commonDeviceInfoTable, commonTrapAck=commonTrapAck, commonDeviceModelNumber=commonDeviceModelNumber, commonMaxPayloadSize=commonMaxPayloadSize, commonDeviceGroup=commonDeviceGroup, commonResetCause=commonResetCause, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonDevicesID=commonDevicesID, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonAgentBootWay=commonAgentBootWay, commonPhysAddress=commonPhysAddress, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonTrapCommunityString=commonTrapCommunityString, commonAlarmDetectionControl=commonAlarmDetectionControl, commonDeviceMFD=commonDeviceMFD, commonNEModelNumber=commonNEModelNumber, commonDeviceSerialNumber=commonDeviceSerialNumber, commonDeviceTamperStatus=commonDeviceTamperStatus, commonMACGroup=commonMACGroup, commonAgentTrapCommunity=commonAgentTrapCommunity, commonDevicesOID=commonDevicesOID, commonMulticastAddressTable=commonMulticastAddressTable, commonCheckCode=commonCheckCode, commonMulticastAddressIndex=commonMulticastAddressIndex, commonMulticastAddressEntry=commonMulticastAddressEntry, commonDeviceAcct=commonDeviceAcct, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonACKTimeoutWindow=commonACKTimeoutWindow, commonRfGroup=commonRfGroup, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonNELogicalID=commonNELogicalID, commonAgentMaxTraps=commonAgentMaxTraps, commonDeviceResetCause=commonDeviceResetCause, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceCraftStatus=commonDeviceCraftStatus, commonMacStats=commonMacStats, commonNESerialNumber=commonNESerialNumber, commonAgentTrapTable=commonAgentTrapTable, commonDeviceOID=commonDeviceOID, commonAdminUseEthernet=commonAdminUseEthernet, commonNEVendorInfo=commonNEVendorInfo, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonDeviceReset=commonDeviceReset, commonVarBindings=commonVarBindings, commonBackoffPeriod=commonBackoffPeriod, commonMaxReturnPower=commonMaxReturnPower, commonDeviceName=commonDeviceName, commonTime=commonTime)
