...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonAgentTrapIP=commonAgentTrapIP, commonAgentTrapTable=commonAgentTrapTable, commonNEModelNumber=commonNEModelNumber, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonDeviceVendorInfo=commonDeviceVendorInfo, commonReturnPathFrequency=commonReturnPathFrequency, commonForwardPathFrequency=commonForwardPathFrequency, commonMACGroup=commonMACGroup, commonDeviceTamperStatus=commonDeviceTamperStatus, commonMacStats=commonMacStats, commonNetworkAddress=commonNetworkAddress, commonPhysAddress=commonPhysAddress, commonACKTimeoutWindow=commonACKTimeoutWindow, commonAgentTrapIndex=commonAgentTrapIndex, commonDeviceMACAddress=commonDeviceMACAddress, commonNEVendorInfo=commonNEVendorInfo, commonAgentReset=commonAgentReset, hfcColdStart=hfcColdStart, commonAdminUseRf=commonAdminUseRf, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceId=commonDeviceId, commonAgentMaxTraps=commonAgentMaxTraps, commonDeviceMFD=commonDeviceMFD, commonMaxPayloadSize=commonMaxPayloadSize, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonDeviceInfoTable=commonDeviceInfoTable, commonAgentTrapCommunity=commonAgentTrapCommunity, commonDeviceSlot=commonDeviceSlot, commonReset=commonReset, commonMulticastAddressIndex=commonMulticastAddressIndex, commonCheckCode=commonCheckCode, commonDeviceVendor=commonDeviceVendor, commonNELogicalID=commonNELogicalID, commonNESerialNumber=commonNESerialNumber, hfcWarmStart=hfcWarmStart, commonDeviceStatus=commonDeviceStatus, commonDevicesID=commonDevicesID, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonMulticastAddressEntry=commonMulticastAddressEntry, commonDevicesOID=commonDevicesOID, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonMulticastAddressTable=commonMulticastAddressTable, commonDeviceGroup=commonDeviceGroup, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonDeviceReset=commonDeviceReset, commonTime=commonTime, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonAgentTrapEntry=commonAgentTrapEntry, commonTamperStatus=commonTamperStatus, commonTrapAck=commonTrapAck, commonDeviceOID=commonDeviceOID, commonDeviceNum=commonDeviceNum, commonAgentTrapStatus=commonAgentTrapStatus, commonBackoffParams=commonBackoffParams, commonNEStatus=commonNEStatus, commonDeviceResetCause=commonDeviceResetCause, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonMulticastAddressNumber=commonMulticastAddressNumber, commonRfGroup=commonRfGroup, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceCraftStatus=commonDeviceCraftStatus, commonDeviceInfoEntry=commonDeviceInfoEntry, commonDeviceModelNumber=commonDeviceModelNumber, commonDeviceFW=commonDeviceFW, commonAgentGroup=commonAgentGroup, commonAdminUseEthernet=commonAdminUseEthernet, commonAgentBootWay=commonAgentBootWay, commonNEVendor=commonNEVendor, commonBackoffPeriod=commonBackoffPeriod, commonMaxReturnPower=commonMaxReturnPower, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonInternalTemperature=commonInternalTemperature, commonDeviceSerialNumber=commonDeviceSerialNumber, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonAlarmDetectionControl=commonAlarmDetectionControl, commonResetCause=commonResetCause, commonTrapCommunityString=commonTrapCommunityString, commonDeviceName=commonDeviceName, commonVarBindings=commonVarBindings, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDeviceAcct=commonDeviceAcct, commonMacAddress=commonMacAddress, commonCraftStatus=commonCraftStatus, commonInvalidMacCmds=commonInvalidMacCmds, commonAdminGroup=commonAdminGroup)
