...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonTrapAck=commonTrapAck, commonDeviceMFD=commonDeviceMFD, commonCraftStatus=commonCraftStatus, commonPhysAddress=commonPhysAddress, commonReturnPathFrequency=commonReturnPathFrequency, commonNEVendorInfo=commonNEVendorInfo, commonNEModelNumber=commonNEModelNumber, commonDeviceInfoTable=commonDeviceInfoTable, commonTime=commonTime, commonAgentBootWay=commonAgentBootWay, commonDeviceResetCause=commonDeviceResetCause, commonDeviceGroup=commonDeviceGroup, commonACKTimeoutWindow=commonACKTimeoutWindow, commonDeviceInfoEntry=commonDeviceInfoEntry, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonTrapCommunityString=commonTrapCommunityString, commonVarBindings=commonVarBindings, commonAgentTrapIndex=commonAgentTrapIndex, commonAgentTrapCommunity=commonAgentTrapCommunity, commonDeviceStatus=commonDeviceStatus, commonDeviceFW=commonDeviceFW, commonDeviceReset=commonDeviceReset, commonBackoffParams=commonBackoffParams, commonAdminUseEthernet=commonAdminUseEthernet, commonAgentMaxTraps=commonAgentMaxTraps, commonAgentTrapIP=commonAgentTrapIP, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceName=commonDeviceName, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonInvalidMacCmds=commonInvalidMacCmds, commonForwardPathFramingErrors=commonForwardPathFramingErrors, hfcWarmStart=hfcWarmStart, commonReset=commonReset, commonAdminGroup=commonAdminGroup, commonNESerialNumber=commonNESerialNumber, commonDeviceMACAddress=commonDeviceMACAddress, commonAgentTrapTable=commonAgentTrapTable, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonDevicesOID=commonDevicesOID, commonMaxPayloadSize=commonMaxPayloadSize, commonAgentTrapStatus=commonAgentTrapStatus, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonCheckCode=commonCheckCode, commonDeviceTamperStatus=commonDeviceTamperStatus, hfcColdStart=hfcColdStart, commonDeviceVendor=commonDeviceVendor, commonDeviceOID=commonDeviceOID, commonBackoffPeriod=commonBackoffPeriod, commonForwardPathFrequency=commonForwardPathFrequency, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDeviceAcct=commonDeviceAcct, commonDevicesID=commonDevicesID, commonDeviceId=commonDeviceId, commonTamperStatus=commonTamperStatus, commonNEStatus=commonNEStatus, commonDeviceSlot=commonDeviceSlot, commonAgentGroup=commonAgentGroup, commonAdminUseRf=commonAdminUseRf, commonAlarmDetectionControl=commonAlarmDetectionControl, commonNEVendor=commonNEVendor, commonMacAddress=commonMacAddress, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonMacStats=commonMacStats, commonMaxReturnPower=commonMaxReturnPower, commonAgentReset=commonAgentReset, commonDeviceCraftStatus=commonDeviceCraftStatus, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonInternalTemperature=commonInternalTemperature, commonRfGroup=commonRfGroup, commonResetCause=commonResetCause, commonNetworkAddress=commonNetworkAddress, commonMulticastAddressTable=commonMulticastAddressTable, commonMulticastAddressEntry=commonMulticastAddressEntry, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceModelNumber=commonDeviceModelNumber, commonNELogicalID=commonNELogicalID, commonDeviceSerialNumber=commonDeviceSerialNumber, commonDeviceNum=commonDeviceNum, commonDeviceVendorInfo=commonDeviceVendorInfo, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonMulticastAddressIndex=commonMulticastAddressIndex, commonMACGroup=commonMACGroup, commonMulticastAddressNumber=commonMulticastAddressNumber, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel)
