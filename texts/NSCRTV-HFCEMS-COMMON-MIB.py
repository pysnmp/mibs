...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonDeviceNum=commonDeviceNum, commonDeviceSerialNumber=commonDeviceSerialNumber, commonDeviceOID=commonDeviceOID, hfcWarmStart=hfcWarmStart, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonTamperStatus=commonTamperStatus, commonForwardPathFrequency=commonForwardPathFrequency, commonCraftStatus=commonCraftStatus, commonMulticastAddressTable=commonMulticastAddressTable, commonDeviceStatus=commonDeviceStatus, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonAgentTrapIP=commonAgentTrapIP, commonAgentReset=commonAgentReset, commonAgentGroup=commonAgentGroup, commonDeviceAcct=commonDeviceAcct, commonResetCause=commonResetCause, commonBackoffParams=commonBackoffParams, commonDeviceFW=commonDeviceFW, commonTrapCommunityString=commonTrapCommunityString, commonTime=commonTime, commonDevicesID=commonDevicesID, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonAlarmDetectionControl=commonAlarmDetectionControl, commonAgentTrapIndex=commonAgentTrapIndex, commonMulticastAddressNumber=commonMulticastAddressNumber, commonMulticastAddressEntry=commonMulticastAddressEntry, commonAdminGroup=commonAdminGroup, commonAgentMaxTraps=commonAgentMaxTraps, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonMaxPayloadSize=commonMaxPayloadSize, commonBackoffPeriod=commonBackoffPeriod, commonNEVendor=commonNEVendor, commonInvalidMacCmds=commonInvalidMacCmds, hfcColdStart=hfcColdStart, commonDeviceReset=commonDeviceReset, commonMulticastAddressIndex=commonMulticastAddressIndex, commonMacAddress=commonMacAddress, commonReset=commonReset, commonAgentTrapTable=commonAgentTrapTable, commonAgentTrapStatus=commonAgentTrapStatus, commonAdminUseEthernet=commonAdminUseEthernet, commonDeviceTamperStatus=commonDeviceTamperStatus, commonPhysAddress=commonPhysAddress, commonNESerialNumber=commonNESerialNumber, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonDeviceGroup=commonDeviceGroup, commonDeviceCraftStatus=commonDeviceCraftStatus, commonMaxReturnPower=commonMaxReturnPower, commonDeviceMFD=commonDeviceMFD, commonNetworkAddress=commonNetworkAddress, commonACKTimeoutWindow=commonACKTimeoutWindow, commonDevicesOID=commonDevicesOID, commonCheckCode=commonCheckCode, commonDeviceVendor=commonDeviceVendor, commonDeviceName=commonDeviceName, commonNELogicalID=commonNELogicalID, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonDeviceId=commonDeviceId, commonNEStatus=commonNEStatus, commonAgentTrapCommunity=commonAgentTrapCommunity, commonInternalTemperature=commonInternalTemperature, commonAdminUseRf=commonAdminUseRf, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonDeviceModelNumber=commonDeviceModelNumber, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceVendorInfo=commonDeviceVendorInfo, commonTrapAck=commonTrapAck, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonAgentTrapEntry=commonAgentTrapEntry, commonDeviceResetCause=commonDeviceResetCause, commonReturnPathFrequency=commonReturnPathFrequency, commonRfGroup=commonRfGroup, commonNEModelNumber=commonNEModelNumber, commonDeviceInfoTable=commonDeviceInfoTable, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonNEVendorInfo=commonNEVendorInfo, commonDeviceMACAddress=commonDeviceMACAddress, commonMacStats=commonMacStats, commonMACGroup=commonMACGroup, commonAgentBootWay=commonAgentBootWay, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceInfoEntry=commonDeviceInfoEntry, commonDeviceSlot=commonDeviceSlot, commonVarBindings=commonVarBindings)
