...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonMulticastAddressIndex=commonMulticastAddressIndex, commonDeviceId=commonDeviceId, commonDeviceSlot=commonDeviceSlot, commonNEVendor=commonNEVendor, commonNEModelNumber=commonNEModelNumber, commonAgentTrapCommunity=commonAgentTrapCommunity, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonNetworkAddress=commonNetworkAddress, commonAgentReset=commonAgentReset, commonMulticastAddressEntry=commonMulticastAddressEntry, commonNEStatus=commonNEStatus, commonRfGroup=commonRfGroup, commonAdminUseRf=commonAdminUseRf, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonTrapCommunityString=commonTrapCommunityString, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonAgentTrapEntry=commonAgentTrapEntry, commonMacStats=commonMacStats, commonMulticastAddressTable=commonMulticastAddressTable, commonTime=commonTime, commonDeviceNum=commonDeviceNum, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonCraftStatus=commonCraftStatus, commonBackoffPeriod=commonBackoffPeriod, commonDeviceReset=commonDeviceReset, commonNELogicalID=commonNELogicalID, commonDeviceResetCause=commonDeviceResetCause, commonAgentMaxTraps=commonAgentMaxTraps, commonMACGroup=commonMACGroup, hfcWarmStart=hfcWarmStart, commonDeviceMFD=commonDeviceMFD, commonDeviceSerialNumber=commonDeviceSerialNumber, commonAdminUseEthernet=commonAdminUseEthernet, hfcColdStart=hfcColdStart, commonAgentGroup=commonAgentGroup, commonDeviceFW=commonDeviceFW, commonCheckCode=commonCheckCode, commonMulticastAddressNumber=commonMulticastAddressNumber, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonAlarmDetectionControl=commonAlarmDetectionControl, commonAdminGroup=commonAdminGroup, commonAgentTrapIndex=commonAgentTrapIndex, commonDeviceVendorInfo=commonDeviceVendorInfo, commonMacAddress=commonMacAddress, commonDeviceInfoTable=commonDeviceInfoTable, commonBackoffParams=commonBackoffParams, commonDeviceAcct=commonDeviceAcct, commonDeviceMACAddress=commonDeviceMACAddress, commonPhysAddress=commonPhysAddress, commonAgentTrapIP=commonAgentTrapIP, commonDeviceTamperStatus=commonDeviceTamperStatus, commonACKTimeoutWindow=commonACKTimeoutWindow, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonVarBindings=commonVarBindings, commonReturnPathFrequency=commonReturnPathFrequency, commonAgentBootWay=commonAgentBootWay, commonTamperStatus=commonTamperStatus, commonNESerialNumber=commonNESerialNumber, commonAgentTrapTable=commonAgentTrapTable, commonDeviceGroup=commonDeviceGroup, commonTrapAck=commonTrapAck, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonInvalidMacCmds=commonInvalidMacCmds, commonReset=commonReset, commonDeviceModelNumber=commonDeviceModelNumber, commonDeviceVendor=commonDeviceVendor, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonInternalTemperature=commonInternalTemperature, commonNEVendorInfo=commonNEVendorInfo, commonDeviceInfoEntry=commonDeviceInfoEntry, commonDeviceStatus=commonDeviceStatus, commonDeviceName=commonDeviceName, commonForwardPathFrequency=commonForwardPathFrequency, commonDevicesOID=commonDevicesOID, commonResetCause=commonResetCause, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonDeviceCraftStatus=commonDeviceCraftStatus, commonMaxReturnPower=commonMaxReturnPower, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonAgentTrapStatus=commonAgentTrapStatus, commonDevicesID=commonDevicesID, commonMaxPayloadSize=commonMaxPayloadSize, commonDeviceOID=commonDeviceOID)
