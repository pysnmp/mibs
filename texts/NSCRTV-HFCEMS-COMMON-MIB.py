...
mibBuilder.exportSymbols("NSCRTV-HFCEMS-COMMON-MIB", commonMulticastAddressNumber=commonMulticastAddressNumber, commonDeviceVendor=commonDeviceVendor, commonTrapAck=commonTrapAck, commonDeviceInfoEntry=commonDeviceInfoEntry, commonMaxMulticastAddresses=commonMaxMulticastAddresses, commonCraftStatus=commonCraftStatus, commonNELogicalID=commonNELogicalID, commonRfGroup=commonRfGroup, commonDeviceInternalTemperature=commonDeviceInternalTemperature, commonAdminGroup=commonAdminGroup, commonMaximumMACLayerRetries=commonMaximumMACLayerRetries, commonNEStatus=commonNEStatus, commonCheckCode=commonCheckCode, commonTrapCommunityString=commonTrapCommunityString, commonNEVendorInfo=commonNEVendorInfo, commonBackoffParams=commonBackoffParams, commonMulticastAddressEntry=commonMulticastAddressEntry, commonNetworkAddress=commonNetworkAddress, commonForwardPathCRCErrors=commonForwardPathCRCErrors, commonReturnPathFrequency=commonReturnPathFrequency, commonDeviceVendorInfo=commonDeviceVendorInfo, commonBackoffMinimumExponent=commonBackoffMinimumExponent, commonTamperStatus=commonTamperStatus, commonInternalTemperature=commonInternalTemperature, commonAgentTrapCommunity=commonAgentTrapCommunity, commonNEVendor=commonNEVendor, commonAlarmDetectionControl=commonAlarmDetectionControl, commonDevicesOID=commonDevicesOID, commonInvalidMacCmds=commonInvalidMacCmds, commonAgentTrapMinInterval=commonAgentTrapMinInterval, commonBackoffPeriod=commonBackoffPeriod, commonDeviceTamperStatus=commonDeviceTamperStatus, commonDeviceResetCause=commonDeviceResetCause, commonDeviceGroup=commonDeviceGroup, commonForwardPathReceiveLevel=commonForwardPathReceiveLevel, commonDeviceAcct=commonDeviceAcct, commonReset=commonReset, commonMulticastAddressIndex=commonMulticastAddressIndex, commonMACGroup=commonMACGroup, commonAgentReset=commonAgentReset, commonNEModelNumber=commonNEModelNumber, commonDeviceModelNumber=commonDeviceModelNumber, commonProvisionedReturnPowerLevel=commonProvisionedReturnPowerLevel, commonForwardPathLOSEvents=commonForwardPathLOSEvents, commonBackwardPathCollisionTimes=commonBackwardPathCollisionTimes, commonDeviceStatus=commonDeviceStatus, commonDeviceSlot=commonDeviceSlot, commonBackoffMaximumExponent=commonBackoffMaximumExponent, commonDeviceInfoTable=commonDeviceInfoTable, commonPhysAddress=commonPhysAddress, commonMaxReturnPower=commonMaxReturnPower, commonDeviceReset=commonDeviceReset, commonTime=commonTime, commonNESerialNumber=commonNESerialNumber, commonDeviceMFD=commonDeviceMFD, commonAgentBootWay=commonAgentBootWay, commonVarBindings=commonVarBindings, commonForwardPathFrequency=commonForwardPathFrequency, commonMacStats=commonMacStats, commonAgentGroup=commonAgentGroup, commonDeviceId=commonDeviceId, commonDeviceFW=commonDeviceFW, commonMacAddress=commonMacAddress, commonMaxPayloadSize=commonMaxPayloadSize, commonAgentMaxTraps=commonAgentMaxTraps, commonForwardPathFramingErrors=commonForwardPathFramingErrors, commonDeviceNum=commonDeviceNum, commonDeviceMACAddress=commonDeviceMACAddress, commonDeviceAlarmDetectionControl=commonDeviceAlarmDetectionControl, commonDeviceCraftStatus=commonDeviceCraftStatus, commonAdminUseEthernet=commonAdminUseEthernet, commonDevicesID=commonDevicesID, commonAgentTrapTable=commonAgentTrapTable, commonAgentTrapMaxInterval=commonAgentTrapMaxInterval, commonResetCause=commonResetCause, commonAgentTrapIP=commonAgentTrapIP, commonAgentTrapStatus=commonAgentTrapStatus, commonDeviceName=commonDeviceName, commonDeviceSerialNumber=commonDeviceSerialNumber, commonAgentTrapEntry=commonAgentTrapEntry, commonAdminUseRf=commonAdminUseRf, commonMulticastAddressTable=commonMulticastAddressTable, hfcWarmStart=hfcWarmStart, commonDeviceOID=commonDeviceOID, commonAgentTrapIndex=commonAgentTrapIndex, hfcColdStart=hfcColdStart, commonACKTimeoutWindow=commonACKTimeoutWindow)
