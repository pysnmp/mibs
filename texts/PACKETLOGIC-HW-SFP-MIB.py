...
# ASN.1 source PACKETLOGIC-HW-SFP-MIB
# Source digest sha256:30dfb5244b27fa72c312d3df7bbf728c68d9fbd077765114cd7ecdceb9c21ce0
...
if mibBuilder.loadTexts: sfp.setLastUpdated('2019-09-12 15:00')
...
ports = MibTable((1, 3, 6, 1, 4, 1, 15397, 2, 30, 4, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: ports.setStatus('current')
if mibBuilder.loadTexts: ports.setDescription('Conceptual Table')
portEntry = MibTableRow((1, 3, 6, 1, 4, 1, 15397, 2, 30, 4, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "PACKETLOGIC-HW-SFP-MIB", "portEntryIndex"))
if mibBuilder.loadTexts: portEntry.setStatus('current')
if mibBuilder.loadTexts: portEntry.setDescription('Conceptual Table')
portEntryIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 15397, 2, 30, 4, 1, 1, 999), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 2147483647))).setMaxAccess("notaccessible")
...
mibBuilder.exportSymbols("PACKETLOGIC-HW-SFP-MIB", PYSNMP_MODULE_ID=sfp, checksumBaseFields=checksumBaseFields, checksumExtendedFields=checksumExtendedFields, portCompatibility=portCompatibility, portEntry=portEntry, portEntryIndex=portEntryIndex, portName=portName, portVendorDateCode=portVendorDateCode, portVendorName=portVendorName, portVendorOUI=portVendorOUI, portVendorPN=portVendorPN, portVendorRevisionLevel=portVendorRevisionLevel, portVendorSN=portVendorSN, ports=ports, sfp=sfp)
