...
iso, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Integer32, NotificationType, Gauge32, ObjectIdentity, Bits, TimeTicks, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Integer32", "NotificationType", "Gauge32", "ObjectIdentity", "Bits", "TimeTicks", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreTimeLastSeenB=lreTimeLastSeenB, iec62439=iec62439, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreNodesEntry=lreNodesEntry, lreNodesMacAddress=lreNodesMacAddress, lreProxyNodeTableClear=lreProxyNodeTableClear, lrePortAdminStateB=lrePortAdminStateB, lreCntUniqueB=lreCntUniqueB, lreCntDuplicateB=lreCntDuplicateB, lreDupListResideMaxTime=lreDupListResideMaxTime, lreMacAddress=lreMacAddress, lreCntUniqueC=lreCntUniqueC, lreProxyNodeEntry=lreProxyNodeEntry, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntErrWrongLanB=lreCntErrWrongLanB, mrp=mrp, lreCntOwnRxA=lreCntOwnRxA, lreTransparentReception=lreTransparentReception, lreCntRxB=lreCntRxB, lreNodesTable=lreNodesTable, lreNodeType=lreNodeType, crp=crp, lreCntTxB=lreCntTxB, lreNodesIndex=lreNodesIndex, lreCntOwnRxB=lreCntOwnRxB, lreInterfaceConfigTable=lreInterfaceConfigTable, lreProxyNodeTable=lreProxyNodeTable, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntTxA=lreCntTxA, linkRedundancyCompliance=linkRedundancyCompliance, linkRedundancyConformance=linkRedundancyConformance, prp=prp, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreRedBoxIdentity=lreRedBoxIdentity, lreDefaultGrp=lreDefaultGrp, lreCntMultiC=lreCntMultiC, lreRemNodeType=lreRemNodeType, lreInterfaceConfigIndex=lreInterfaceConfigIndex, rrp=rrp, linkRedundancyCompliances=linkRedundancyCompliances, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreNodesTableClear=lreNodesTableClear, lreCntErrorsB=lreCntErrorsB, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, SecondFraction=SecondFraction, lreCntDuplicateA=lreCntDuplicateA, lreSwitchingEndNode=lreSwitchingEndNode, lreCntErrorsC=lreCntErrorsC, ptp=ptp, lreEvaluateSupervision=lreEvaluateSupervision, lreLinkStatusA=lreLinkStatusA, lreCntUniqueA=lreCntUniqueA, lreCntNodes=lreCntNodes, lreCntRxA=lreCntRxA, lreGroups=lreGroups, lreProxyNodeIndex=lreProxyNodeIndex, lrePortAdminStateA=lrePortAdminStateA, lreVersionName=lreVersionName, lreLinkStatusB=lreLinkStatusB, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreStatisticsInterfaces=lreStatisticsInterfaces, lreTimeLastSeenA=lreTimeLastSeenA, lreRowStatus=lreRowStatus, lreInterfaceCount=lreInterfaceCount, drp=drp, PYSNMP_MODULE_ID=iec62439, lreCntErrorsA=lreCntErrorsA, lreCntDuplicateC=lreCntDuplicateC, brp=brp, lreConfiguration=lreConfiguration, lreDuplicateDiscard=lreDuplicateDiscard, lreCntMultiB=lreCntMultiB, lreStatistics=lreStatistics, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntProxyNodes=lreCntProxyNodes, lreCntRxC=lreCntRxC, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntMultiA=lreCntMultiA, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntTxC=lreCntTxC, lreNodeName=lreNodeName, lreCntErrWrongLanC=lreCntErrWrongLanC, lreManufacturerName=lreManufacturerName, lreHsrLREMode=lreHsrLREMode, lreInterfaceStatsEntry=lreInterfaceStatsEntry)
