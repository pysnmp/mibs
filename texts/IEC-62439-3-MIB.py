...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Integer32, TimeTicks, Counter32, iso, IpAddress, Gauge32, ObjectIdentity, Bits, Unsigned32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Integer32", "TimeTicks", "Counter32", "iso", "IpAddress", "Gauge32", "ObjectIdentity", "Bits", "Unsigned32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntErrWrongLanC=lreCntErrWrongLanC, lreNodesEntry=lreNodesEntry, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreTimeLastSeenA=lreTimeLastSeenA, lreNodeType=lreNodeType, lreProxyNodeEntry=lreProxyNodeEntry, lreConfiguration=lreConfiguration, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntDuplicateC=lreCntDuplicateC, lreDuplicateDiscard=lreDuplicateDiscard, lreRedBoxIdentity=lreRedBoxIdentity, lreCntOwnRxB=lreCntOwnRxB, lreCntUniqueC=lreCntUniqueC, lreMacAddress=lreMacAddress, lreCntRxC=lreCntRxC, lreLinkStatusB=lreLinkStatusB, lreNodeName=lreNodeName, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreInterfaceConfigTable=lreInterfaceConfigTable, lreInterfaceCount=lreInterfaceCount, lreCntRxA=lreCntRxA, lreSwitchingEndNode=lreSwitchingEndNode, lreCntDuplicateA=lreCntDuplicateA, PYSNMP_MODULE_ID=iec62439, lreCntProxyNodes=lreCntProxyNodes, lreRowStatus=lreRowStatus, ptp=ptp, rrp=rrp, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreInterfaceConfigEntry=lreInterfaceConfigEntry, crp=crp, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntMultiA=lreCntMultiA, lreInterfaceStatsTable=lreInterfaceStatsTable, lreManufacturerName=lreManufacturerName, lreNodesIndex=lreNodesIndex, lrePortAdminStateB=lrePortAdminStateB, lreConfigurationInterfaces=lreConfigurationInterfaces, lreVersionName=lreVersionName, lreStatisticsInterfaces=lreStatisticsInterfaces, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreHsrLREMode=lreHsrLREMode, lreTimeLastSeenB=lreTimeLastSeenB, iec62439=iec62439, lreCntMultiB=lreCntMultiB, lreEvaluateSupervision=lreEvaluateSupervision, lreCntErrWrongLanB=lreCntErrWrongLanB, linkRedundancyConformance=linkRedundancyConformance, lreCntTxA=lreCntTxA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntErrorsC=lreCntErrorsC, lreCntTxB=lreCntTxB, lreRemNodeType=lreRemNodeType, lreGroups=lreGroups, SecondFraction=SecondFraction, lreDefaultGrp=lreDefaultGrp, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntTxC=lreCntTxC, drp=drp, lreCntOwnRxA=lreCntOwnRxA, lreCntRxB=lreCntRxB, lreNodesTable=lreNodesTable, lreCntNodes=lreCntNodes, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreTransparentReception=lreTransparentReception, linkRedundancyCompliance=linkRedundancyCompliance, lreNodesTableClear=lreNodesTableClear, lreNodesMacAddress=lreNodesMacAddress, lreLinkStatusA=lreLinkStatusA, lreProxyNodeIndex=lreProxyNodeIndex, lreCntMultiC=lreCntMultiC, lrePortAdminStateA=lrePortAdminStateA, prp=prp, linkRedundancyCompliances=linkRedundancyCompliances, brp=brp, lreCntErrorsA=lreCntErrorsA, lreCntUniqueA=lreCntUniqueA, lreProxyNodeTable=lreProxyNodeTable, mrp=mrp, lreStatistics=lreStatistics, lreCntUniqueB=lreCntUniqueB, lreCntDuplicateB=lreCntDuplicateB, lreCntErrWrongLanA=lreCntErrWrongLanA, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntErrorsB=lreCntErrorsB)
