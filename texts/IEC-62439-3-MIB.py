...
IpAddress, MibIdentifier, TimeTicks, Gauge32, Counter32, NotificationType, Counter64, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "TimeTicks", "Gauge32", "Counter32", "NotificationType", "Counter64", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", SecondFraction=SecondFraction, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntNodes=lreCntNodes, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreInterfaceConfigTable=lreInterfaceConfigTable, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntTxB=lreCntTxB, lreNodeType=lreNodeType, lreMacAddress=lreMacAddress, lreCntMultiB=lreCntMultiB, lreNodesTableClear=lreNodesTableClear, lreManufacturerName=lreManufacturerName, lreInterfaceCount=lreInterfaceCount, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, crp=crp, lreDupListResideMaxTime=lreDupListResideMaxTime, lreRowStatus=lreRowStatus, iec62439=iec62439, lreNodesIndex=lreNodesIndex, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntErrWrongLanA=lreCntErrWrongLanA, lreNodesMacAddress=lreNodesMacAddress, lreCntDuplicateC=lreCntDuplicateC, linkRedundancyConformance=linkRedundancyConformance, lreTimeLastSeenB=lreTimeLastSeenB, lrePortAdminStateB=lrePortAdminStateB, lreLinkStatusB=lreLinkStatusB, lreProxyNodeEntry=lreProxyNodeEntry, lreConfigurationInterfaces=lreConfigurationInterfaces, lreProxyNodeIndex=lreProxyNodeIndex, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntDuplicateA=lreCntDuplicateA, mrp=mrp, lreDefaultGrp=lreDefaultGrp, lreInterfaceStatsIndex=lreInterfaceStatsIndex, prp=prp, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntErrWrongLanB=lreCntErrWrongLanB, lreStatistics=lreStatistics, linkRedundancyCompliances=linkRedundancyCompliances, lreGroups=lreGroups, lreTransparentReception=lreTransparentReception, lreHsrLREMode=lreHsrLREMode, lreCntDuplicateB=lreCntDuplicateB, drp=drp, lreCntMultiA=lreCntMultiA, lreEvaluateSupervision=lreEvaluateSupervision, lreCntUniqueC=lreCntUniqueC, lreCntRxB=lreCntRxB, lreCntErrorsB=lreCntErrorsB, lreNodesTable=lreNodesTable, lreVersionName=lreVersionName, lreCntUniqueB=lreCntUniqueB, lreCntTxA=lreCntTxA, lreNodesEntry=lreNodesEntry, lreRemNodeType=lreRemNodeType, lreCntTxC=lreCntTxC, lreInterfaceStatsTable=lreInterfaceStatsTable, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreProxyNodeTableClear=lreProxyNodeTableClear, ptp=ptp, lreLinkStatusA=lreLinkStatusA, lreCntUniqueA=lreCntUniqueA, lreCntMultiC=lreCntMultiC, lreDuplicateDiscard=lreDuplicateDiscard, PYSNMP_MODULE_ID=iec62439, linkRedundancyCompliance=linkRedundancyCompliance, lreRedBoxIdentity=lreRedBoxIdentity, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreNodeName=lreNodeName, lreProxyNodeTable=lreProxyNodeTable, brp=brp, lreCntErrorsC=lreCntErrorsC, lreTimeLastSeenA=lreTimeLastSeenA, lreCntOwnRxA=lreCntOwnRxA, rrp=rrp, lreConfiguration=lreConfiguration, lreCntProxyNodes=lreCntProxyNodes, lreCntOwnRxB=lreCntOwnRxB, lreCntRxC=lreCntRxC, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntRxA=lreCntRxA, lreCntErrorsA=lreCntErrorsA, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lrePortAdminStateA=lrePortAdminStateA, lreCntErrWrongLanC=lreCntErrWrongLanC, lreSwitchingEndNode=lreSwitchingEndNode)
