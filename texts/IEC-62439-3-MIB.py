...
ObjectIdentity, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, iso, NotificationType, Gauge32, Unsigned32, IpAddress, Bits, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "iso", "NotificationType", "Gauge32", "Unsigned32", "IpAddress", "Bits", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreDupListResideMaxTime=lreDupListResideMaxTime, lreRedBoxIdentity=lreRedBoxIdentity, prp=prp, lreCntOwnRxA=lreCntOwnRxA, lreCntDuplicateA=lreCntDuplicateA, lreCntRxC=lreCntRxC, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntRxA=lreCntRxA, lreNodeName=lreNodeName, lrePortAdminStateB=lrePortAdminStateB, lreInterfaceStatsTable=lreInterfaceStatsTable, lreNodesTable=lreNodesTable, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, rrp=rrp, lreCntOwnRxB=lreCntOwnRxB, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreProxyNodeTable=lreProxyNodeTable, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreTimeLastSeenA=lreTimeLastSeenA, brp=brp, lreCntErrWrongLanC=lreCntErrWrongLanC, drp=drp, lreNodesMacAddress=lreNodesMacAddress, lreCntTxA=lreCntTxA, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreConfigurationInterfaces=lreConfigurationInterfaces, lreGroups=lreGroups, lreCntProxyNodes=lreCntProxyNodes, lreCntMultiA=lreCntMultiA, lreCntErrorsA=lreCntErrorsA, lreCntMultiB=lreCntMultiB, lreCntErrorsC=lreCntErrorsC, lrePortAdminStateA=lrePortAdminStateA, lreCntTxB=lreCntTxB, lreSwitchingEndNode=lreSwitchingEndNode, linkRedundancyEntityConformance=linkRedundancyEntityConformance, iec62439=iec62439, PYSNMP_MODULE_ID=iec62439, lreStatisticsInterfaces=lreStatisticsInterfaces, crp=crp, lreCntRxB=lreCntRxB, lreCntErrWrongLanB=lreCntErrWrongLanB, lreTimeLastSeenB=lreTimeLastSeenB, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntMultiC=lreCntMultiC, lreLinkStatusA=lreLinkStatusA, lreCntUniqueC=lreCntUniqueC, lreNodeType=lreNodeType, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntTxC=lreCntTxC, lreInterfaceCount=lreInterfaceCount, ptp=ptp, lreTransparentReception=lreTransparentReception, linkRedundancyCompliance=linkRedundancyCompliance, lreConfiguration=lreConfiguration, lreNodesEntry=lreNodesEntry, lreProxyNodeIndex=lreProxyNodeIndex, lreInterfaceConfigTable=lreInterfaceConfigTable, mrp=mrp, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntErrorsB=lreCntErrorsB, lreNodesTableClear=lreNodesTableClear, lreProxyNodeEntry=lreProxyNodeEntry, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreRemNodeType=lreRemNodeType, lreNodesIndex=lreNodesIndex, lreLinkStatusB=lreLinkStatusB, lreStatistics=lreStatistics, lreRowStatus=lreRowStatus, lreVersionName=lreVersionName, linkRedundancyConformance=linkRedundancyConformance, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntErrWrongLanA=lreCntErrWrongLanA, lreDefaultGrp=lreDefaultGrp, lreCntDuplicateB=lreCntDuplicateB, linkRedundancyCompliances=linkRedundancyCompliances, lreEvaluateSupervision=lreEvaluateSupervision, lreCntDuplicateC=lreCntDuplicateC, lreCntUniqueB=lreCntUniqueB, lreManufacturerName=lreManufacturerName, lreCntNodes=lreCntNodes, lreMacAddress=lreMacAddress, lreDuplicateDiscard=lreDuplicateDiscard, lreHsrLREMode=lreHsrLREMode, SecondFraction=SecondFraction, lreCntUniqueA=lreCntUniqueA, lreInterfaceStatsEntry=lreInterfaceStatsEntry)
