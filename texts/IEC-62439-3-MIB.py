...
TimeTicks, Bits, IpAddress, Counter32, Unsigned32, NotificationType, Gauge32, iso, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "IpAddress", "Counter32", "Unsigned32", "NotificationType", "Gauge32", "iso", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreProxyNodeEntry=lreProxyNodeEntry, linkRedundancyCompliance=linkRedundancyCompliance, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreDefaultGrp=lreDefaultGrp, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntErrorsB=lreCntErrorsB, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntDuplicateA=lreCntDuplicateA, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntProxyNodes=lreCntProxyNodes, iec62439=iec62439, lreStatisticsInterfaces=lreStatisticsInterfaces, lreVersionName=lreVersionName, lreRemNodeType=lreRemNodeType, lreNodesTableClear=lreNodesTableClear, lreLinkStatusA=lreLinkStatusA, lreCntTxB=lreCntTxB, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreRedBoxIdentity=lreRedBoxIdentity, lreDuplicateDiscard=lreDuplicateDiscard, SecondFraction=SecondFraction, drp=drp, lreCntDuplicateC=lreCntDuplicateC, linkRedundancyConformance=linkRedundancyConformance, PYSNMP_MODULE_ID=iec62439, lreCntOwnRxB=lreCntOwnRxB, lreNodesIndex=lreNodesIndex, lreCntMultiA=lreCntMultiA, linkRedundancyCompliances=linkRedundancyCompliances, lreCntTxA=lreCntTxA, lreCntRxB=lreCntRxB, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntDuplicateB=lreCntDuplicateB, lreCntErrWrongLanB=lreCntErrWrongLanB, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreNodesMacAddress=lreNodesMacAddress, lreNodeType=lreNodeType, lreCntMultiC=lreCntMultiC, lreHsrLREMode=lreHsrLREMode, lreCntUniqueC=lreCntUniqueC, lreCntUniqueB=lreCntUniqueB, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntRxA=lreCntRxA, lreCntMultiB=lreCntMultiB, lreTransparentReception=lreTransparentReception, rrp=rrp, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreNodesEntry=lreNodesEntry, lreInterfaceStatsTable=lreInterfaceStatsTable, mrp=mrp, lrePortAdminStateB=lrePortAdminStateB, lreTimeLastSeenB=lreTimeLastSeenB, lreCntUniqueA=lreCntUniqueA, lreManufacturerName=lreManufacturerName, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, prp=prp, lreCntTxC=lreCntTxC, lreMacAddress=lreMacAddress, lreGroups=lreGroups, lreInterfaceConfigTable=lreInterfaceConfigTable, lreNodesTable=lreNodesTable, lreCntOwnRxA=lreCntOwnRxA, lreTimeLastSeenA=lreTimeLastSeenA, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lrePortAdminStateA=lrePortAdminStateA, lreConfiguration=lreConfiguration, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntErrWrongLanC=lreCntErrWrongLanC, lreInterfaceCount=lreInterfaceCount, lreEvaluateSupervision=lreEvaluateSupervision, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreNodeName=lreNodeName, lreSwitchingEndNode=lreSwitchingEndNode, lreProxyNodeIndex=lreProxyNodeIndex, crp=crp, brp=brp, ptp=ptp, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreRowStatus=lreRowStatus, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreStatistics=lreStatistics, lreLinkStatusB=lreLinkStatusB, lreCntRxC=lreCntRxC, lreCntErrorsC=lreCntErrorsC, lreCntNodes=lreCntNodes, lreProxyNodeTable=lreProxyNodeTable, lreCntErrorsA=lreCntErrorsA)
