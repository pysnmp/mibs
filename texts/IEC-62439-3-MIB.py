...
Counter32, Integer32, Counter64, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Bits, ModuleIdentity, IpAddress, Unsigned32, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Counter64", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Bits", "ModuleIdentity", "IpAddress", "Unsigned32", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreNodesTable=lreNodesTable, lreRowStatus=lreRowStatus, lreCntUniqueC=lreCntUniqueC, lreDupListResideMaxTime=lreDupListResideMaxTime, lreConfigurationInterfaces=lreConfigurationInterfaces, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntErrorsB=lreCntErrorsB, linkRedundancyCompliance=linkRedundancyCompliance, lreCntErrWrongLanC=lreCntErrWrongLanC, lreDefaultGrp=lreDefaultGrp, lreInterfaceStatsTable=lreInterfaceStatsTable, lreProxyNodeTableClear=lreProxyNodeTableClear, lreNodesIndex=lreNodesIndex, lreStatisticsInterfaces=lreStatisticsInterfaces, linkRedundancyCompliances=linkRedundancyCompliances, lreStatistics=lreStatistics, lreTimeLastSeenA=lreTimeLastSeenA, drp=drp, lreCntErrorsC=lreCntErrorsC, lrePortAdminStateA=lrePortAdminStateA, mrp=mrp, linkRedundancyConformance=linkRedundancyConformance, lreEvaluateSupervision=lreEvaluateSupervision, lreLinkStatusA=lreLinkStatusA, lreTimeLastSeenB=lreTimeLastSeenB, prp=prp, iec62439=iec62439, lreCntErrWrongLanB=lreCntErrWrongLanB, crp=crp, lreCntOwnRxB=lreCntOwnRxB, lreHsrLREMode=lreHsrLREMode, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lrePortAdminStateB=lrePortAdminStateB, lreCntRxA=lreCntRxA, lreCntMultiA=lreCntMultiA, lreCntErrorsA=lreCntErrorsA, lreSwitchingEndNode=lreSwitchingEndNode, lreCntTxC=lreCntTxC, lreProxyNodeIndex=lreProxyNodeIndex, lreCntUniqueA=lreCntUniqueA, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreNodeType=lreNodeType, lreCntDuplicateA=lreCntDuplicateA, lreLinkStatusB=lreLinkStatusB, lreInterfaceConfigTable=lreInterfaceConfigTable, lreProxyNodeEntry=lreProxyNodeEntry, lreConfiguration=lreConfiguration, lreCntTxB=lreCntTxB, lreCntDuplicateC=lreCntDuplicateC, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntUniqueB=lreCntUniqueB, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreNodesMacAddress=lreNodesMacAddress, lreCntDuplicateB=lreCntDuplicateB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntMultiB=lreCntMultiB, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntTxA=lreCntTxA, lreGroups=lreGroups, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntProxyNodes=lreCntProxyNodes, lreRemNodeType=lreRemNodeType, lreDuplicateDiscard=lreDuplicateDiscard, brp=brp, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreNodeName=lreNodeName, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntRxB=lreCntRxB, lreCntNodes=lreCntNodes, lreProxyNodeTable=lreProxyNodeTable, lreTransparentReception=lreTransparentReception, lreInterfaceCount=lreInterfaceCount, lreCntMultiC=lreCntMultiC, lreCntRxC=lreCntRxC, rrp=rrp, lreVersionName=lreVersionName, lreCntErrWrongLanA=lreCntErrWrongLanA, ptp=ptp, lreMacAddress=lreMacAddress, lreNodesEntry=lreNodesEntry, lreNodesTableClear=lreNodesTableClear, lreRedBoxIdentity=lreRedBoxIdentity, linkRedundancyEntityObjects=linkRedundancyEntityObjects, PYSNMP_MODULE_ID=iec62439, lreManufacturerName=lreManufacturerName, SecondFraction=SecondFraction, lreCntOwnRxA=lreCntOwnRxA)
