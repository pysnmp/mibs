...
Counter32, NotificationType, MibIdentifier, ObjectIdentity, TimeTicks, Counter64, ModuleIdentity, Bits, IpAddress, Integer32, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "MibIdentifier", "ObjectIdentity", "TimeTicks", "Counter64", "ModuleIdentity", "Bits", "IpAddress", "Integer32", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntMultiC=lreCntMultiC, lrePortAdminStateB=lrePortAdminStateB, lreProxyNodeEntry=lreProxyNodeEntry, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreRemNodeType=lreRemNodeType, lreCntTxB=lreCntTxB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreProxyNodeTableClear=lreProxyNodeTableClear, lreGroups=lreGroups, lreHsrLREMode=lreHsrLREMode, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreTransparentReception=lreTransparentReception, lreCntErrWrongLanB=lreCntErrWrongLanB, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreConfiguration=lreConfiguration, lreCntDuplicateA=lreCntDuplicateA, lreInterfaceStatsEntry=lreInterfaceStatsEntry, linkRedundancyCompliance=linkRedundancyCompliance, crp=crp, lreCntMultiB=lreCntMultiB, lreDefaultGrp=lreDefaultGrp, lreLinkStatusB=lreLinkStatusB, lreNodesMacAddress=lreNodesMacAddress, ptp=ptp, lreSwitchingEndNode=lreSwitchingEndNode, lreTimeLastSeenA=lreTimeLastSeenA, lreCntUniqueC=lreCntUniqueC, mrp=mrp, brp=brp, lreCntRxC=lreCntRxC, lreLinkStatusA=lreLinkStatusA, lreInterfaceCount=lreInterfaceCount, lreProxyNodeIndex=lreProxyNodeIndex, lreNodesTable=lreNodesTable, prp=prp, lreTimeLastSeenB=lreTimeLastSeenB, lreNodeName=lreNodeName, lreCntNodes=lreCntNodes, lreNodesEntry=lreNodesEntry, lreRowStatus=lreRowStatus, lreCntOwnRxA=lreCntOwnRxA, drp=drp, lreCntErrorsC=lreCntErrorsC, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreMacAddress=lreMacAddress, SecondFraction=SecondFraction, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntDuplicateC=lreCntDuplicateC, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntDuplicateB=lreCntDuplicateB, lreDuplicateDiscard=lreDuplicateDiscard, lreCntUniqueA=lreCntUniqueA, lreCntProxyNodes=lreCntProxyNodes, lreInterfaceConfigTable=lreInterfaceConfigTable, lreNodeType=lreNodeType, lreCntTxC=lreCntTxC, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntErrWrongLanC=lreCntErrWrongLanC, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceStatsTable=lreInterfaceStatsTable, lreManufacturerName=lreManufacturerName, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntOwnRxB=lreCntOwnRxB, lreCntUniqueB=lreCntUniqueB, iec62439=iec62439, lreRedBoxIdentity=lreRedBoxIdentity, lreCntTxA=lreCntTxA, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntErrorsB=lreCntErrorsB, lreCntMultiA=lreCntMultiA, lreNodesIndex=lreNodesIndex, rrp=rrp, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreEvaluateSupervision=lreEvaluateSupervision, lrePortAdminStateA=lrePortAdminStateA, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreStatisticsInterfaces=lreStatisticsInterfaces, lreStatistics=lreStatistics, lreCntErrorsA=lreCntErrorsA, lreCntRxA=lreCntRxA, linkRedundancyConformance=linkRedundancyConformance, lreNodesTableClear=lreNodesTableClear, lreVersionName=lreVersionName, linkRedundancyCompliances=linkRedundancyCompliances, lreCntRxB=lreCntRxB, PYSNMP_MODULE_ID=iec62439)
