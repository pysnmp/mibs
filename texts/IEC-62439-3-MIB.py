...
Counter64, NotificationType, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Bits, ObjectIdentity, Integer32, ModuleIdentity, MibIdentifier, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Bits", "ObjectIdentity", "Integer32", "ModuleIdentity", "MibIdentifier", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntTxB=lreCntTxB, lreManufacturerName=lreManufacturerName, lreInterfaceConfigIndex=lreInterfaceConfigIndex, iec62439=iec62439, lreCntErrorsA=lreCntErrorsA, lreCntDuplicateC=lreCntDuplicateC, lreInterfaceStatsIndex=lreInterfaceStatsIndex, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntRxA=lreCntRxA, prp=prp, lreNodesEntry=lreNodesEntry, lreInterfaceCount=lreInterfaceCount, ptp=ptp, lreRedBoxIdentity=lreRedBoxIdentity, lreProxyNodeTableClear=lreProxyNodeTableClear, lreRemNodeType=lreRemNodeType, lreInterfaceConfigTable=lreInterfaceConfigTable, lrePortAdminStateA=lrePortAdminStateA, lreNodesIndex=lreNodesIndex, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreNodesTableClear=lreNodesTableClear, lreNodeName=lreNodeName, lreCntDuplicateA=lreCntDuplicateA, lreRowStatus=lreRowStatus, crp=crp, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntUniqueB=lreCntUniqueB, rrp=rrp, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntErrWrongLanB=lreCntErrWrongLanB, PYSNMP_MODULE_ID=iec62439, lreVersionName=lreVersionName, brp=brp, lreCntRxC=lreCntRxC, lreCntNodes=lreCntNodes, lreCntErrorsC=lreCntErrorsC, lreDefaultGrp=lreDefaultGrp, lreProxyNodeEntry=lreProxyNodeEntry, lreNodeType=lreNodeType, lreNodesMacAddress=lreNodesMacAddress, lreTransparentReception=lreTransparentReception, lreCntUniqueC=lreCntUniqueC, lreCntOwnRxB=lreCntOwnRxB, lreCntUniqueA=lreCntUniqueA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntTxC=lreCntTxC, lreDupListResideMaxTime=lreDupListResideMaxTime, lreGroups=lreGroups, lreCntMultiA=lreCntMultiA, drp=drp, lreConfigurationInterfaces=lreConfigurationInterfaces, lreEvaluateSupervision=lreEvaluateSupervision, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreConfiguration=lreConfiguration, lreNodesTable=lreNodesTable, lreCntDuplicateB=lreCntDuplicateB, lreMacAddress=lreMacAddress, lreTimeLastSeenB=lreTimeLastSeenB, lreProxyNodeTable=lreProxyNodeTable, linkRedundancyConformance=linkRedundancyConformance, lreDuplicateDiscard=lreDuplicateDiscard, lreTimeLastSeenA=lreTimeLastSeenA, lreInterfaceStatsTable=lreInterfaceStatsTable, lreSwitchingEndNode=lreSwitchingEndNode, lreCntProxyNodes=lreCntProxyNodes, linkRedundancyCompliances=linkRedundancyCompliances, lreHsrLREMode=lreHsrLREMode, lreStatisticsInterfaces=lreStatisticsInterfaces, lreLinkStatusB=lreLinkStatusB, lreCntOwnRxA=lreCntOwnRxA, lreStatistics=lreStatistics, lreCntRxB=lreCntRxB, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreProxyNodeIndex=lreProxyNodeIndex, SecondFraction=SecondFraction, linkRedundancyCompliance=linkRedundancyCompliance, lrePortAdminStateB=lrePortAdminStateB, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntTxA=lreCntTxA, lreLinkStatusA=lreLinkStatusA, mrp=mrp, lreCntErrorsB=lreCntErrorsB, lreCntMultiB=lreCntMultiB, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntMultiC=lreCntMultiC)
