...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, Gauge32, Counter64, ObjectIdentity, ModuleIdentity, MibIdentifier, NotificationType, TimeTicks, Integer32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "Gauge32", "Counter64", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "NotificationType", "TimeTicks", "Integer32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntRxA=lreCntRxA, drp=drp, lreRedBoxIdentity=lreRedBoxIdentity, lreCntNodes=lreCntNodes, lreManufacturerName=lreManufacturerName, lreDuplicateDiscard=lreDuplicateDiscard, lreSwitchingEndNode=lreSwitchingEndNode, prp=prp, lreConfiguration=lreConfiguration, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, ptp=ptp, lreCntProxyNodes=lreCntProxyNodes, lreDefaultGrp=lreDefaultGrp, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntMultiA=lreCntMultiA, lreCntErrWrongLanC=lreCntErrWrongLanC, lreNodeType=lreNodeType, lreCntMultiC=lreCntMultiC, lreLinkStatusA=lreLinkStatusA, lreInterfaceConfigTable=lreInterfaceConfigTable, lreInterfaceStatsEntry=lreInterfaceStatsEntry, linkRedundancyCompliance=linkRedundancyCompliance, lreEvaluateSupervision=lreEvaluateSupervision, lreCntRxB=lreCntRxB, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreVersionName=lreVersionName, lreCntOwnRxB=lreCntOwnRxB, lreNodesTableClear=lreNodesTableClear, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntErrorsA=lreCntErrorsA, lreCntMultiB=lreCntMultiB, lrePortAdminStateA=lrePortAdminStateA, lreCntOwnRxA=lreCntOwnRxA, PYSNMP_MODULE_ID=iec62439, lreCntErrorsC=lreCntErrorsC, lreNodesIndex=lreNodesIndex, lreCntErrorsB=lreCntErrorsB, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreRowStatus=lreRowStatus, lreLinkStatusB=lreLinkStatusB, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntUniqueC=lreCntUniqueC, lreCntUniqueA=lreCntUniqueA, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntTxA=lreCntTxA, lreConfigurationInterfaces=lreConfigurationInterfaces, lreProxyNodeTableClear=lreProxyNodeTableClear, brp=brp, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntTxC=lreCntTxC, SecondFraction=SecondFraction, lreRemNodeType=lreRemNodeType, linkRedundancyCompliances=linkRedundancyCompliances, lreTimeLastSeenA=lreTimeLastSeenA, lreCntErrWrongLanB=lreCntErrWrongLanB, lreInterfaceCount=lreInterfaceCount, lreDupListResideMaxTime=lreDupListResideMaxTime, lreStatisticsInterfaces=lreStatisticsInterfaces, lreProxyNodeTable=lreProxyNodeTable, lreCntTxB=lreCntTxB, lreProxyNodeMacAddress=lreProxyNodeMacAddress, linkRedundancyConformance=linkRedundancyConformance, lreNodesTable=lreNodesTable, mrp=mrp, lreHsrLREMode=lreHsrLREMode, lreStatistics=lreStatistics, lreGroups=lreGroups, lreNodeName=lreNodeName, crp=crp, lreCntDuplicateB=lreCntDuplicateB, lreTransparentReception=lreTransparentReception, lreTimeLastSeenB=lreTimeLastSeenB, iec62439=iec62439, lreNodesEntry=lreNodesEntry, lreNodesMacAddress=lreNodesMacAddress, lreCntDuplicateA=lreCntDuplicateA, lrePortAdminStateB=lrePortAdminStateB, lreInterfaceStatsTable=lreInterfaceStatsTable, lreProxyNodeIndex=lreProxyNodeIndex, rrp=rrp, lreProxyNodeEntry=lreProxyNodeEntry, lreCntUniqueB=lreCntUniqueB, lreCntRxC=lreCntRxC, lreMacAddress=lreMacAddress, lreCntDuplicateC=lreCntDuplicateC)
