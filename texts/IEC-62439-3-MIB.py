...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Bits, Counter32, Counter64, Gauge32, ObjectIdentity, iso, ModuleIdentity, TimeTicks, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Bits", "Counter32", "Counter64", "Gauge32", "ObjectIdentity", "iso", "ModuleIdentity", "TimeTicks", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreLinkStatusB=lreLinkStatusB, lreProxyNodeIndex=lreProxyNodeIndex, lreVersionName=lreVersionName, lreManufacturerName=lreManufacturerName, lreInterfaceConfigEntry=lreInterfaceConfigEntry, mrp=mrp, lreRemNodeType=lreRemNodeType, lreCntErrorsC=lreCntErrorsC, SecondFraction=SecondFraction, lreProxyNodeTable=lreProxyNodeTable, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntMultiA=lreCntMultiA, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntDuplicateC=lreCntDuplicateC, lreGroups=lreGroups, lreCntOwnRxA=lreCntOwnRxA, lreCntMultiB=lreCntMultiB, lreHsrLREMode=lreHsrLREMode, rrp=rrp, brp=brp, lreMacAddress=lreMacAddress, lreRowStatus=lreRowStatus, lreConfiguration=lreConfiguration, lreCntTxC=lreCntTxC, drp=drp, lreTimeLastSeenA=lreTimeLastSeenA, lreProxyNodeEntry=lreProxyNodeEntry, iec62439=iec62439, lreStatistics=lreStatistics, lreDuplicateDiscard=lreDuplicateDiscard, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntTxB=lreCntTxB, lreTransparentReception=lreTransparentReception, lreCntNodes=lreCntNodes, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreInterfaceStatsEntry=lreInterfaceStatsEntry, ptp=ptp, lreCntTxA=lreCntTxA, lreCntProxyNodes=lreCntProxyNodes, PYSNMP_MODULE_ID=iec62439, lreSwitchingEndNode=lreSwitchingEndNode, lreCntErrorsB=lreCntErrorsB, lreDupListResideMaxTime=lreDupListResideMaxTime, lreNodesIndex=lreNodesIndex, lreCntDuplicateB=lreCntDuplicateB, lreRedBoxIdentity=lreRedBoxIdentity, lreCntUniqueA=lreCntUniqueA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreInterfaceConfigTable=lreInterfaceConfigTable, lreNodesMacAddress=lreNodesMacAddress, lreCntErrWrongLanB=lreCntErrWrongLanB, lreNodesTableClear=lreNodesTableClear, lreCntRxB=lreCntRxB, lreCntRxA=lreCntRxA, lreLinkStatusA=lreLinkStatusA, crp=crp, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntDuplicateA=lreCntDuplicateA, linkRedundancyConformance=linkRedundancyConformance, linkRedundancyCompliances=linkRedundancyCompliances, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreNodeName=lreNodeName, lrePortAdminStateB=lrePortAdminStateB, lreInterfaceCount=lreInterfaceCount, linkRedundancyCompliance=linkRedundancyCompliance, lreCntUniqueC=lreCntUniqueC, lreNodesTable=lreNodesTable, lreCntUniqueB=lreCntUniqueB, lreDefaultGrp=lreDefaultGrp, lreNodeType=lreNodeType, lreCntErrWrongLanA=lreCntErrWrongLanA, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreTimeLastSeenB=lreTimeLastSeenB, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreNodesEntry=lreNodesEntry, lreCntErrorsA=lreCntErrorsA, lreEvaluateSupervision=lreEvaluateSupervision, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntRxC=lreCntRxC, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntMultiC=lreCntMultiC, prp=prp, lrePortAdminStateA=lrePortAdminStateA, lreCntOwnRxB=lreCntOwnRxB)
