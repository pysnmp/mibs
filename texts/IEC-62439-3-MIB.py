...
Integer32, TimeTicks, Counter64, Unsigned32, Counter32, ObjectIdentity, IpAddress, ModuleIdentity, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "Counter64", "Unsigned32", "Counter32", "ObjectIdentity", "IpAddress", "ModuleIdentity", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreNodeType=lreNodeType, lreCntErrWrongLanC=lreCntErrWrongLanC, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreGroups=lreGroups, PYSNMP_MODULE_ID=iec62439, rrp=rrp, lreEvaluateSupervision=lreEvaluateSupervision, lreNodesEntry=lreNodesEntry, lreCntOwnRxA=lreCntOwnRxA, lreCntDuplicateC=lreCntDuplicateC, ptp=ptp, lreCntRxA=lreCntRxA, lreTimeLastSeenA=lreTimeLastSeenA, lreCntDuplicateA=lreCntDuplicateA, lreLinkStatusA=lreLinkStatusA, lreCntMultiC=lreCntMultiC, lreProxyNodeIndex=lreProxyNodeIndex, mrp=mrp, lreSwitchingEndNode=lreSwitchingEndNode, lreCntOwnRxB=lreCntOwnRxB, lreConfiguration=lreConfiguration, linkRedundancyCompliance=linkRedundancyCompliance, drp=drp, lreConfigurationInterfaces=lreConfigurationInterfaces, crp=crp, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreNodesIndex=lreNodesIndex, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntRxC=lreCntRxC, lreCntErrorsC=lreCntErrorsC, brp=brp, lreCntErrorsB=lreCntErrorsB, lrePortAdminStateA=lrePortAdminStateA, lreStatisticsInterfaces=lreStatisticsInterfaces, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreRemNodeType=lreRemNodeType, lreHsrLREMode=lreHsrLREMode, lreDefaultGrp=lreDefaultGrp, SecondFraction=SecondFraction, lreTransparentReception=lreTransparentReception, lreCntMultiB=lreCntMultiB, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntProxyNodes=lreCntProxyNodes, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceStatsTable=lreInterfaceStatsTable, linkRedundancyCompliances=linkRedundancyCompliances, lreCntErrorsA=lreCntErrorsA, lreInterfaceCount=lreInterfaceCount, lreNodesMacAddress=lreNodesMacAddress, lreCntTxB=lreCntTxB, lreCntMultiA=lreCntMultiA, lreNodeName=lreNodeName, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntTxC=lreCntTxC, lreCntDuplicateB=lreCntDuplicateB, lreMacAddress=lreMacAddress, lreRedBoxIdentity=lreRedBoxIdentity, lreProxyNodeEntry=lreProxyNodeEntry, linkRedundancyConformance=linkRedundancyConformance, lrePortAdminStateB=lrePortAdminStateB, lreDuplicateDiscard=lreDuplicateDiscard, lreCntUniqueB=lreCntUniqueB, lreLinkStatusB=lreLinkStatusB, prp=prp, lreCntErrWrongLanA=lreCntErrWrongLanA, lreStatistics=lreStatistics, lreRowStatus=lreRowStatus, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntUniqueA=lreCntUniqueA, lreVersionName=lreVersionName, lreDupListResideMaxTime=lreDupListResideMaxTime, lreTimeLastSeenB=lreTimeLastSeenB, iec62439=iec62439, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntRxB=lreCntRxB, lreNodesTable=lreNodesTable, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntNodes=lreCntNodes, lreNodesTableClear=lreNodesTableClear, lreCntUniqueC=lreCntUniqueC, lreCntTxA=lreCntTxA, lreManufacturerName=lreManufacturerName, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup)
