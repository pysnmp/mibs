...
# Produced by pysmi-1.1.8 at Thu Oct 12 08:47:19 2023
...
NotificationType, MibIdentifier, TimeTicks, Unsigned32, ModuleIdentity, Counter64, Bits, iso, Gauge32, Integer32, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "TimeTicks", "Unsigned32", "ModuleIdentity", "Counter64", "Bits", "iso", "Gauge32", "Integer32", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntRxA=lreCntRxA, lreDefaultGrp=lreDefaultGrp, lreCntUniqueC=lreCntUniqueC, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntMultiB=lreCntMultiB, lreCntTxB=lreCntTxB, lreDupListResideMaxTime=lreDupListResideMaxTime, ptp=ptp, lreNodeName=lreNodeName, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntDuplicateB=lreCntDuplicateB, lreSwitchingEndNode=lreSwitchingEndNode, lreStatistics=lreStatistics, linkRedundancyCompliance=linkRedundancyCompliance, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreProxyNodeMacAddress=lreProxyNodeMacAddress, crp=crp, lreMacAddress=lreMacAddress, lrePortAdminStateB=lrePortAdminStateB, drp=drp, lreCntTxA=lreCntTxA, linkRedundancyConformance=linkRedundancyConformance, lreManufacturerName=lreManufacturerName, lreCntDuplicateA=lreCntDuplicateA, lreNodeType=lreNodeType, lreCntDuplicateC=lreCntDuplicateC, lreInterfaceConfigTable=lreInterfaceConfigTable, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreLinkStatusA=lreLinkStatusA, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreProxyNodeIndex=lreProxyNodeIndex, lreCntRxB=lreCntRxB, lreCntOwnRxB=lreCntOwnRxB, lreNodesTableClear=lreNodesTableClear, lreProxyNodeEntry=lreProxyNodeEntry, lreCntMultiA=lreCntMultiA, lreCntTxC=lreCntTxC, lreCntMultiC=lreCntMultiC, lreTimeLastSeenA=lreTimeLastSeenA, lreCntErrWrongLanB=lreCntErrWrongLanB, lreInterfaceStatsTable=lreInterfaceStatsTable, mrp=mrp, brp=brp, lreEvaluateSupervision=lreEvaluateSupervision, lreTransparentReception=lreTransparentReception, lreCntUniqueB=lreCntUniqueB, rrp=rrp, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreHsrLREMode=lreHsrLREMode, lreVersionName=lreVersionName, lreRemNodeType=lreRemNodeType, lreLinkStatusB=lreLinkStatusB, lreProxyNodeTable=lreProxyNodeTable, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreInterfaceConfigIndex=lreInterfaceConfigIndex, linkRedundancyCompliances=linkRedundancyCompliances, lreInterfaceStatsIndex=lreInterfaceStatsIndex, PYSNMP_MODULE_ID=iec62439, lreCntErrorsB=lreCntErrorsB, lreCntErrorsC=lreCntErrorsC, lreCntNodes=lreCntNodes, lreConfiguration=lreConfiguration, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntUniqueA=lreCntUniqueA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntErrorsA=lreCntErrorsA, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lrePortAdminStateA=lrePortAdminStateA, lreCntRxC=lreCntRxC, lreRowStatus=lreRowStatus, lreGroups=lreGroups, lreTimeLastSeenB=lreTimeLastSeenB, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntOwnRxA=lreCntOwnRxA, lreNodesEntry=lreNodesEntry, lreStatisticsInterfaces=lreStatisticsInterfaces, prp=prp, lreNodesIndex=lreNodesIndex, iec62439=iec62439, SecondFraction=SecondFraction, lreNodesMacAddress=lreNodesMacAddress, lreRedBoxIdentity=lreRedBoxIdentity, lreCntProxyNodes=lreCntProxyNodes, lreDuplicateDiscard=lreDuplicateDiscard, lreNodesTable=lreNodesTable, lreInterfaceCount=lreInterfaceCount)
