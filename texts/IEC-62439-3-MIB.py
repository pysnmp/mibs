...
ObjectIdentity, TimeTicks, Counter64, IpAddress, ModuleIdentity, Bits, Gauge32, NotificationType, Counter32, Unsigned32, iso, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "Counter64", "IpAddress", "ModuleIdentity", "Bits", "Gauge32", "NotificationType", "Counter32", "Unsigned32", "iso", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntMultiC=lreCntMultiC, linkRedundancyCompliance=linkRedundancyCompliance, lreLinkStatusB=lreLinkStatusB, lreConfiguration=lreConfiguration, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntMultiA=lreCntMultiA, lreProxyNodeEntry=lreProxyNodeEntry, lreNodesEntry=lreNodesEntry, iec62439=iec62439, lreNodesTable=lreNodesTable, lreCntDuplicateC=lreCntDuplicateC, lreTransparentReception=lreTransparentReception, drp=drp, SecondFraction=SecondFraction, lreProxyNodeTableClear=lreProxyNodeTableClear, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreRedBoxIdentity=lreRedBoxIdentity, lreCntErrorsB=lreCntErrorsB, lreNodeName=lreNodeName, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreRowStatus=lreRowStatus, ptp=ptp, lreNodesTableClear=lreNodesTableClear, crp=crp, lreTimeLastSeenB=lreTimeLastSeenB, lreCntErrorsC=lreCntErrorsC, lreCntUniqueC=lreCntUniqueC, PYSNMP_MODULE_ID=iec62439, lreVersionName=lreVersionName, lreSwitchingEndNode=lreSwitchingEndNode, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreStatistics=lreStatistics, lrePortAdminStateA=lrePortAdminStateA, lreRemNodeType=lreRemNodeType, mrp=mrp, prp=prp, lreCntOwnRxB=lreCntOwnRxB, lreCntOwnRxA=lreCntOwnRxA, lreProxyNodeTable=lreProxyNodeTable, lreEvaluateSupervision=lreEvaluateSupervision, linkRedundancyConformance=linkRedundancyConformance, lreHsrLREMode=lreHsrLREMode, lreCntMultiB=lreCntMultiB, lreInterfaceCount=lreInterfaceCount, lreCntErrWrongLanB=lreCntErrWrongLanB, lreConfigurationInterfaces=lreConfigurationInterfaces, lreInterfaceConfigTable=lreInterfaceConfigTable, lreProxyNodeIndex=lreProxyNodeIndex, lreNodeType=lreNodeType, lreCntTxC=lreCntTxC, lreDefaultGrp=lreDefaultGrp, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lrePortAdminStateB=lrePortAdminStateB, brp=brp, lreManufacturerName=lreManufacturerName, lreCntRxA=lreCntRxA, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntNodes=lreCntNodes, lreCntTxA=lreCntTxA, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntTxB=lreCntTxB, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreDupListResideMaxTime=lreDupListResideMaxTime, lreStatisticsInterfaces=lreStatisticsInterfaces, lreLinkStatusA=lreLinkStatusA, lreCntRxC=lreCntRxC, lreCntRxB=lreCntRxB, lreCntDuplicateB=lreCntDuplicateB, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntErrorsA=lreCntErrorsA, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntDuplicateA=lreCntDuplicateA, lreNodesMacAddress=lreNodesMacAddress, lreDuplicateDiscard=lreDuplicateDiscard, lreCntErrWrongLanA=lreCntErrWrongLanA, rrp=rrp, linkRedundancyCompliances=linkRedundancyCompliances, lreMacAddress=lreMacAddress, lreNodesIndex=lreNodesIndex, lreGroups=lreGroups, lreTimeLastSeenA=lreTimeLastSeenA, lreCntUniqueB=lreCntUniqueB, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntUniqueA=lreCntUniqueA, lreCntProxyNodes=lreCntProxyNodes)
