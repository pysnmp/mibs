...
ObjectIdentity, ModuleIdentity, Unsigned32, Counter64, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Gauge32, NotificationType, iso, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Counter64", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Gauge32", "NotificationType", "iso", "Bits", "Integer32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreTransparentReception=lreTransparentReception, lreCntErrorsB=lreCntErrorsB, drp=drp, lreConfiguration=lreConfiguration, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntProxyNodes=lreCntProxyNodes, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntNodes=lreCntNodes, lreNodeType=lreNodeType, lreHsrLREMode=lreHsrLREMode, lreNodesEntry=lreNodesEntry, lreConfigurationInterfaces=lreConfigurationInterfaces, lreStatistics=lreStatistics, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreInterfaceStatsEntry=lreInterfaceStatsEntry, linkRedundancyConformance=linkRedundancyConformance, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntDuplicateB=lreCntDuplicateB, lreTimeLastSeenA=lreTimeLastSeenA, lreMacAddress=lreMacAddress, lreCntTxB=lreCntTxB, lreCntDuplicateC=lreCntDuplicateC, lreCntMultiA=lreCntMultiA, lreProxyNodeTableClear=lreProxyNodeTableClear, prp=prp, lreNodesIndex=lreNodesIndex, lreCntMultiC=lreCntMultiC, lreCntOwnRxA=lreCntOwnRxA, lreSwitchingEndNode=lreSwitchingEndNode, SecondFraction=SecondFraction, lreCntMultiB=lreCntMultiB, lreCntUniqueC=lreCntUniqueC, linkRedundancyCompliance=linkRedundancyCompliance, lreCntDuplicateA=lreCntDuplicateA, brp=brp, lreDupListResideMaxTime=lreDupListResideMaxTime, lreEvaluateSupervision=lreEvaluateSupervision, ptp=ptp, lreCntErrorsC=lreCntErrorsC, lreCntOwnRxB=lreCntOwnRxB, iec62439=iec62439, lreDefaultGrp=lreDefaultGrp, lreCntTxC=lreCntTxC, lreManufacturerName=lreManufacturerName, lreCntRxB=lreCntRxB, lrePortAdminStateB=lrePortAdminStateB, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreGroups=lreGroups, lreCntTxA=lreCntTxA, lreRemNodeType=lreRemNodeType, lreProxyNodeTable=lreProxyNodeTable, lreLinkStatusB=lreLinkStatusB, lreNodesMacAddress=lreNodesMacAddress, lreDuplicateDiscard=lreDuplicateDiscard, rrp=rrp, lreLinkStatusA=lreLinkStatusA, PYSNMP_MODULE_ID=iec62439, lreCntUniqueB=lreCntUniqueB, lreNodesTable=lreNodesTable, lreCntErrWrongLanC=lreCntErrWrongLanC, mrp=mrp, crp=crp, lreRedBoxIdentity=lreRedBoxIdentity, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreTimeLastSeenB=lreTimeLastSeenB, lreVersionName=lreVersionName, lreNodesTableClear=lreNodesTableClear, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreProxyNodeEntry=lreProxyNodeEntry, lreCntUniqueA=lreCntUniqueA, lreCntRxC=lreCntRxC, linkRedundancyCompliances=linkRedundancyCompliances, lreCntRxA=lreCntRxA, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreNodeName=lreNodeName, lreInterfaceCount=lreInterfaceCount, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lrePortAdminStateA=lrePortAdminStateA, lreCntErrWrongLanA=lreCntErrWrongLanA, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreInterfaceConfigTable=lreInterfaceConfigTable, lreProxyNodeIndex=lreProxyNodeIndex, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntErrorsA=lreCntErrorsA, lreRowStatus=lreRowStatus)
