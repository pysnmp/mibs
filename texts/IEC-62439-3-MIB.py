...
IpAddress, Unsigned32, NotificationType, Counter64, Integer32, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, Gauge32, TimeTicks, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "NotificationType", "Counter64", "Integer32", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "Gauge32", "TimeTicks", "iso", "Counter32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreLinkStatusA=lreLinkStatusA, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntDuplicateC=lreCntDuplicateC, prp=prp, lreCntDuplicateB=lreCntDuplicateB, lreCntUniqueB=lreCntUniqueB, lreManufacturerName=lreManufacturerName, lreNodesTable=lreNodesTable, lreCntErrorsC=lreCntErrorsC, ptp=ptp, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreProxyNodeMacAddress=lreProxyNodeMacAddress, SecondFraction=SecondFraction, lreNodeName=lreNodeName, lreNodesEntry=lreNodesEntry, lreNodesIndex=lreNodesIndex, lrePortAdminStateB=lrePortAdminStateB, lreStatisticsInterfaces=lreStatisticsInterfaces, mrp=mrp, lreInterfaceCount=lreInterfaceCount, linkRedundancyCompliances=linkRedundancyCompliances, lreLinkStatusB=lreLinkStatusB, lreCntUniqueC=lreCntUniqueC, lreHsrLREMode=lreHsrLREMode, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntMultiA=lreCntMultiA, brp=brp, lreDuplicateDiscard=lreDuplicateDiscard, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntErrWrongLanC=lreCntErrWrongLanC, lreDefaultGrp=lreDefaultGrp, iec62439=iec62439, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreEvaluateSupervision=lreEvaluateSupervision, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntTxC=lreCntTxC, lreTimeLastSeenA=lreTimeLastSeenA, lreCntRxC=lreCntRxC, lreStatistics=lreStatistics, lreCntRxB=lreCntRxB, lreCntTxB=lreCntTxB, lreCntOwnRxA=lreCntOwnRxA, lreCntProxyNodes=lreCntProxyNodes, lreRemNodeType=lreRemNodeType, lreCntMultiC=lreCntMultiC, PYSNMP_MODULE_ID=iec62439, lreNodeType=lreNodeType, lreNodesMacAddress=lreNodesMacAddress, lreRowStatus=lreRowStatus, lreTransparentReception=lreTransparentReception, lreNodesTableClear=lreNodesTableClear, lreVersionName=lreVersionName, lreCntRxA=lreCntRxA, lreProxyNodeEntry=lreProxyNodeEntry, lreCntMultiB=lreCntMultiB, lreCntNodes=lreCntNodes, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntErrorsA=lreCntErrorsA, lreCntUniqueA=lreCntUniqueA, lreCntDuplicateA=lreCntDuplicateA, lreInterfaceConfigEntry=lreInterfaceConfigEntry, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntTxA=lreCntTxA, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntOwnRxB=lreCntOwnRxB, rrp=rrp, lreRedBoxIdentity=lreRedBoxIdentity, lreGroups=lreGroups, lreSwitchingEndNode=lreSwitchingEndNode, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreProxyNodeIndex=lreProxyNodeIndex, linkRedundancyCompliance=linkRedundancyCompliance, lrePortAdminStateA=lrePortAdminStateA, lreConfiguration=lreConfiguration, lreConfigurationInterfaces=lreConfigurationInterfaces, linkRedundancyEntityObjects=linkRedundancyEntityObjects, drp=drp, lreDupListResideMaxTime=lreDupListResideMaxTime, crp=crp, lreInterfaceStatsTable=lreInterfaceStatsTable, lreProxyNodeTableClear=lreProxyNodeTableClear, linkRedundancyConformance=linkRedundancyConformance, lreMacAddress=lreMacAddress, lreCntErrorsB=lreCntErrorsB, lreTimeLastSeenB=lreTimeLastSeenB, lreInterfaceStatsEntry=lreInterfaceStatsEntry)
