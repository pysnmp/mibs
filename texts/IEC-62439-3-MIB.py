...
Bits, ObjectIdentity, Gauge32, TimeTicks, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, Counter32, iso, MibIdentifier, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Gauge32", "TimeTicks", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "Counter32", "iso", "MibIdentifier", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreTimeLastSeenA=lreTimeLastSeenA, lreSwitchingEndNode=lreSwitchingEndNode, brp=brp, rrp=rrp, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreInterfaceConfigTable=lreInterfaceConfigTable, lreProxyNodeEntry=lreProxyNodeEntry, lreStatistics=lreStatistics, SecondFraction=SecondFraction, lreLinkStatusA=lreLinkStatusA, lreNodeType=lreNodeType, lreConfigurationInterfaces=lreConfigurationInterfaces, iec62439=iec62439, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntProxyNodes=lreCntProxyNodes, lreConfiguration=lreConfiguration, lreCntDuplicateA=lreCntDuplicateA, lreCntErrorsA=lreCntErrorsA, lreCntRxA=lreCntRxA, lrePortAdminStateA=lrePortAdminStateA, lreRemNodeType=lreRemNodeType, PYSNMP_MODULE_ID=iec62439, lreCntMultiC=lreCntMultiC, lreProxyNodeIndex=lreProxyNodeIndex, lreManufacturerName=lreManufacturerName, lrePortAdminStateB=lrePortAdminStateB, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntTxB=lreCntTxB, ptp=ptp, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreDuplicateDiscard=lreDuplicateDiscard, linkRedundancyCompliance=linkRedundancyCompliance, lreInterfaceCount=lreInterfaceCount, lreCntRxC=lreCntRxC, linkRedundancyConformance=linkRedundancyConformance, lreTimeLastSeenB=lreTimeLastSeenB, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntOwnRxB=lreCntOwnRxB, lreCntUniqueA=lreCntUniqueA, lreCntDuplicateC=lreCntDuplicateC, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntOwnRxA=lreCntOwnRxA, lreDefaultGrp=lreDefaultGrp, lreCntMultiA=lreCntMultiA, lreVersionName=lreVersionName, lreCntNodes=lreCntNodes, lreMacAddress=lreMacAddress, lreCntMultiB=lreCntMultiB, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreEvaluateSupervision=lreEvaluateSupervision, lreNodesEntry=lreNodesEntry, lreGroups=lreGroups, lreNodesTable=lreNodesTable, lreRedBoxIdentity=lreRedBoxIdentity, linkRedundancyCompliances=linkRedundancyCompliances, lreCntTxA=lreCntTxA, prp=prp, lreRowStatus=lreRowStatus, lreStatisticsInterfaces=lreStatisticsInterfaces, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreNodesTableClear=lreNodesTableClear, lreCntErrorsC=lreCntErrorsC, lreNodeName=lreNodeName, crp=crp, lreLinkStatusB=lreLinkStatusB, drp=drp, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreProxyNodeTable=lreProxyNodeTable, lreCntDuplicateB=lreCntDuplicateB, linkRedundancyEntityObjects=linkRedundancyEntityObjects, mrp=mrp, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntRxB=lreCntRxB, lreCntErrorsB=lreCntErrorsB, lreNodesIndex=lreNodesIndex, lreHsrLREMode=lreHsrLREMode, lreCntUniqueC=lreCntUniqueC, lreTransparentReception=lreTransparentReception, lreNodesMacAddress=lreNodesMacAddress, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntTxC=lreCntTxC, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntUniqueB=lreCntUniqueB, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreProxyNodeTableClear=lreProxyNodeTableClear)
