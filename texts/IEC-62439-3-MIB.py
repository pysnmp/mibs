...
iso, ObjectIdentity, TimeTicks, Gauge32, Bits, MibIdentifier, Counter64, Unsigned32, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "TimeTicks", "Gauge32", "Bits", "MibIdentifier", "Counter64", "Unsigned32", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntRxA=lreCntRxA, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreLinkStatusB=lreLinkStatusB, lreTransparentReception=lreTransparentReception, lrePortAdminStateB=lrePortAdminStateB, lreRowStatus=lreRowStatus, lreCntErrorsB=lreCntErrorsB, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreNodesMacAddress=lreNodesMacAddress, lreCntRxB=lreCntRxB, linkRedundancyCompliances=linkRedundancyCompliances, lreCntErrWrongLanB=lreCntErrWrongLanB, ptp=ptp, lreNodesTable=lreNodesTable, lreProxyNodeIndex=lreProxyNodeIndex, lrePortAdminStateA=lrePortAdminStateA, lreProxyNodeTableClear=lreProxyNodeTableClear, lreInterfaceCount=lreInterfaceCount, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntErrorsC=lreCntErrorsC, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntUniqueA=lreCntUniqueA, linkRedundancyConformance=linkRedundancyConformance, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntOwnRxA=lreCntOwnRxA, lreCntDuplicateB=lreCntDuplicateB, iec62439=iec62439, lreMacAddress=lreMacAddress, SecondFraction=SecondFraction, lreSwitchingEndNode=lreSwitchingEndNode, linkRedundancyCompliance=linkRedundancyCompliance, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntDuplicateC=lreCntDuplicateC, lreCntTxC=lreCntTxC, lreConfiguration=lreConfiguration, lreNodesEntry=lreNodesEntry, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntTxA=lreCntTxA, lreStatistics=lreStatistics, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntUniqueC=lreCntUniqueC, lreRemNodeType=lreRemNodeType, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntNodes=lreCntNodes, lreCntRxC=lreCntRxC, lreCntProxyNodes=lreCntProxyNodes, lreInterfaceStatsTable=lreInterfaceStatsTable, lreTimeLastSeenA=lreTimeLastSeenA, lreInterfaceConfigIndex=lreInterfaceConfigIndex, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreDuplicateDiscard=lreDuplicateDiscard, lreRedBoxIdentity=lreRedBoxIdentity, lreLinkStatusA=lreLinkStatusA, rrp=rrp, PYSNMP_MODULE_ID=iec62439, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntOwnRxB=lreCntOwnRxB, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreManufacturerName=lreManufacturerName, lreConfigurationInterfaces=lreConfigurationInterfaces, mrp=mrp, lreDefaultGrp=lreDefaultGrp, prp=prp, lreVersionName=lreVersionName, lreNodesIndex=lreNodesIndex, lreCntTxB=lreCntTxB, lreNodesTableClear=lreNodesTableClear, lreEvaluateSupervision=lreEvaluateSupervision, lreCntMultiB=lreCntMultiB, lreCntMultiC=lreCntMultiC, lreCntErrorsA=lreCntErrorsA, lreHsrLREMode=lreHsrLREMode, crp=crp, lreCntDuplicateA=lreCntDuplicateA, lreTimeLastSeenB=lreTimeLastSeenB, drp=drp, lreNodeType=lreNodeType, brp=brp, lreNodeName=lreNodeName, lreGroups=lreGroups, lreCntUniqueB=lreCntUniqueB, lreProxyNodeEntry=lreProxyNodeEntry, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntMultiA=lreCntMultiA, lreProxyNodeTable=lreProxyNodeTable)
