...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Unsigned32, TimeTicks, Integer32, Counter32, Bits, IpAddress, ObjectIdentity, MibIdentifier, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Unsigned32", "TimeTicks", "Integer32", "Counter32", "Bits", "IpAddress", "ObjectIdentity", "MibIdentifier", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntOwnRxB=lreCntOwnRxB, lreGroups=lreGroups, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntErrorsB=lreCntErrorsB, lreDefaultGrp=lreDefaultGrp, lreProxyNodeMacAddress=lreProxyNodeMacAddress, linkRedundancyCompliance=linkRedundancyCompliance, lreSwitchingEndNode=lreSwitchingEndNode, lreNodesEntry=lreNodesEntry, lreProxyNodeTableClear=lreProxyNodeTableClear, linkRedundancyCompliances=linkRedundancyCompliances, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntErrorsA=lreCntErrorsA, lreProxyNodeIndex=lreProxyNodeIndex, lrePortAdminStateA=lrePortAdminStateA, lreCntErrWrongLanC=lreCntErrWrongLanC, lreStatistics=lreStatistics, lreRowStatus=lreRowStatus, lreProxyNodeEntry=lreProxyNodeEntry, brp=brp, prp=prp, lreCntRxB=lreCntRxB, lreVersionName=lreVersionName, lreInterfaceCount=lreInterfaceCount, lreNodeType=lreNodeType, ptp=ptp, linkRedundancyEntityObjects=linkRedundancyEntityObjects, rrp=rrp, lreNodesIndex=lreNodesIndex, lreCntMultiB=lreCntMultiB, lreCntTxA=lreCntTxA, lreLinkStatusA=lreLinkStatusA, lreTimeLastSeenB=lreTimeLastSeenB, drp=drp, lreRedBoxIdentity=lreRedBoxIdentity, lreCntProxyNodes=lreCntProxyNodes, lreInterfaceStatsTable=lreInterfaceStatsTable, lreMacAddress=lreMacAddress, lreManufacturerName=lreManufacturerName, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreEvaluateSupervision=lreEvaluateSupervision, lreConfiguration=lreConfiguration, lreCntRxA=lreCntRxA, iec62439=iec62439, lreDuplicateDiscard=lreDuplicateDiscard, PYSNMP_MODULE_ID=iec62439, lreCntTxC=lreCntTxC, lreCntDuplicateC=lreCntDuplicateC, lreCntErrorsC=lreCntErrorsC, lreDupListResideMaxTime=lreDupListResideMaxTime, lreNodesMacAddress=lreNodesMacAddress, lreCntRxC=lreCntRxC, lreNodesTable=lreNodesTable, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreHsrLREMode=lreHsrLREMode, lreCntDuplicateB=lreCntDuplicateB, lreCntUniqueC=lreCntUniqueC, SecondFraction=SecondFraction, lreCntDuplicateA=lreCntDuplicateA, lreLinkStatusB=lreLinkStatusB, lreNodeName=lreNodeName, lreCntErrWrongLanA=lreCntErrWrongLanA, mrp=mrp, lreCntTxB=lreCntTxB, lreTimeLastSeenA=lreTimeLastSeenA, lreCntMultiC=lreCntMultiC, lreCntOwnRxA=lreCntOwnRxA, lreTransparentReception=lreTransparentReception, lreCntUniqueB=lreCntUniqueB, lreStatisticsInterfaces=lreStatisticsInterfaces, lrePortAdminStateB=lrePortAdminStateB, lreCntErrWrongLanB=lreCntErrWrongLanB, crp=crp, lreCntNodes=lreCntNodes, linkRedundancyConformance=linkRedundancyConformance, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntMultiA=lreCntMultiA, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreNodesTableClear=lreNodesTableClear, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntUniqueA=lreCntUniqueA, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreRemNodeType=lreRemNodeType, linkRedundancyEntityConformance=linkRedundancyEntityConformance)
