...
Bits, Unsigned32, iso, IpAddress, TimeTicks, ObjectIdentity, Integer32, NotificationType, Counter64, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "iso", "IpAddress", "TimeTicks", "ObjectIdentity", "Integer32", "NotificationType", "Counter64", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lrePortAdminStateA=lrePortAdminStateA, lreCntTxC=lreCntTxC, lreProxyNodeTable=lreProxyNodeTable, lrePortAdminStateB=lrePortAdminStateB, lreCntDuplicateA=lreCntDuplicateA, crp=crp, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreHsrLREMode=lreHsrLREMode, lreCntErrWrongLanA=lreCntErrWrongLanA, lreProxyNodeIndex=lreProxyNodeIndex, lreSwitchingEndNode=lreSwitchingEndNode, lreTimeLastSeenB=lreTimeLastSeenB, lreNodeName=lreNodeName, ptp=ptp, lreNodesMacAddress=lreNodesMacAddress, lreCntTxB=lreCntTxB, lreGroups=lreGroups, lreVersionName=lreVersionName, lreCntDuplicateB=lreCntDuplicateB, lreCntProxyNodes=lreCntProxyNodes, lreCntUniqueB=lreCntUniqueB, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreInterfaceConfigIndex=lreInterfaceConfigIndex, PYSNMP_MODULE_ID=iec62439, lreInterfaceConfigTable=lreInterfaceConfigTable, lreTransparentReception=lreTransparentReception, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreNodesTable=lreNodesTable, linkRedundancyCompliance=linkRedundancyCompliance, lreCntOwnRxA=lreCntOwnRxA, lreNodeType=lreNodeType, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreRowStatus=lreRowStatus, lreRedBoxIdentity=lreRedBoxIdentity, lreDefaultGrp=lreDefaultGrp, prp=prp, lreProxyNodeEntry=lreProxyNodeEntry, SecondFraction=SecondFraction, lreConfigurationInterfaces=lreConfigurationInterfaces, lreNodesEntry=lreNodesEntry, brp=brp, lreCntTxA=lreCntTxA, lreInterfaceStatsTable=lreInterfaceStatsTable, lreTimeLastSeenA=lreTimeLastSeenA, lreCntRxC=lreCntRxC, drp=drp, lreNodesTableClear=lreNodesTableClear, lreCntUniqueC=lreCntUniqueC, linkRedundancyCompliances=linkRedundancyCompliances, linkRedundancyEntityConformance=linkRedundancyEntityConformance, mrp=mrp, lreCntMultiA=lreCntMultiA, lreCntRxB=lreCntRxB, lreCntOwnRxB=lreCntOwnRxB, lreCntErrorsB=lreCntErrorsB, lreInterfaceCount=lreInterfaceCount, lreCntRxA=lreCntRxA, lreCntNodes=lreCntNodes, lreDuplicateDiscard=lreDuplicateDiscard, lreCntDuplicateC=lreCntDuplicateC, lreMacAddress=lreMacAddress, rrp=rrp, lreRemNodeType=lreRemNodeType, lreManufacturerName=lreManufacturerName, lreCntUniqueA=lreCntUniqueA, lreConfiguration=lreConfiguration, iec62439=iec62439, lreLinkStatusA=lreLinkStatusA, lreStatistics=lreStatistics, lreCntErrorsC=lreCntErrorsC, lreCntErrWrongLanC=lreCntErrWrongLanC, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntMultiB=lreCntMultiB, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntMultiC=lreCntMultiC, linkRedundancyConformance=linkRedundancyConformance, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreStatisticsInterfaces=lreStatisticsInterfaces, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreLinkStatusB=lreLinkStatusB, lreCntErrWrongLanB=lreCntErrWrongLanB, lreNodesIndex=lreNodesIndex, lreCntErrorsA=lreCntErrorsA, lreEvaluateSupervision=lreEvaluateSupervision)
