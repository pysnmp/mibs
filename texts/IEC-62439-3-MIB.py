...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:16:20 2023
...
Counter32, TimeTicks, iso, Gauge32, MibIdentifier, IpAddress, Integer32, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "iso", "Gauge32", "MibIdentifier", "IpAddress", "Integer32", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreNodesIndex=lreNodesIndex, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntErrorsA=lreCntErrorsA, lreCntTxA=lreCntTxA, lreNodesEntry=lreNodesEntry, lreDefaultGrp=lreDefaultGrp, lreLinkStatusB=lreLinkStatusB, lreProxyNodeTableClear=lreProxyNodeTableClear, lreNodesMacAddress=lreNodesMacAddress, lreRemNodeType=lreRemNodeType, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreManufacturerName=lreManufacturerName, lreCntDuplicateB=lreCntDuplicateB, prp=prp, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntTxB=lreCntTxB, lreCntDuplicateC=lreCntDuplicateC, lreLinkStatusA=lreLinkStatusA, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceCount=lreInterfaceCount, lrePortAdminStateA=lrePortAdminStateA, lreCntUniqueB=lreCntUniqueB, linkRedundancyCompliances=linkRedundancyCompliances, lreNodeType=lreNodeType, lrePortAdminStateB=lrePortAdminStateB, iec62439=iec62439, lreCntTxC=lreCntTxC, lreCntOwnRxA=lreCntOwnRxA, mrp=mrp, lreEvaluateSupervision=lreEvaluateSupervision, lreTransparentReception=lreTransparentReception, crp=crp, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntDuplicateA=lreCntDuplicateA, lreNodesTable=lreNodesTable, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreConfiguration=lreConfiguration, lreCntNodes=lreCntNodes, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreTimeLastSeenB=lreTimeLastSeenB, lreCntMultiC=lreCntMultiC, lreNodeName=lreNodeName, lreCntErrorsC=lreCntErrorsC, PYSNMP_MODULE_ID=iec62439, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreMacAddress=lreMacAddress, lreCntErrWrongLanB=lreCntErrWrongLanB, SecondFraction=SecondFraction, lreCntUniqueC=lreCntUniqueC, lreCntMultiA=lreCntMultiA, lreRedBoxIdentity=lreRedBoxIdentity, lreGroups=lreGroups, drp=drp, lreCntRxB=lreCntRxB, lreCntUniqueA=lreCntUniqueA, lreCntRxA=lreCntRxA, rrp=rrp, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreProxyNodeIndex=lreProxyNodeIndex, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntOwnRxB=lreCntOwnRxB, lreProxyNodeEntry=lreProxyNodeEntry, lreCntErrWrongLanC=lreCntErrWrongLanC, brp=brp, linkRedundancyConformance=linkRedundancyConformance, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreRowStatus=lreRowStatus, lreNodesTableClear=lreNodesTableClear, lreDupListResideMaxTime=lreDupListResideMaxTime, lreVersionName=lreVersionName, lreStatistics=lreStatistics, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreTimeLastSeenA=lreTimeLastSeenA, linkRedundancyCompliance=linkRedundancyCompliance, lreCntRxC=lreCntRxC, lreProxyNodeMacAddress=lreProxyNodeMacAddress, ptp=ptp, lreSwitchingEndNode=lreSwitchingEndNode, lreDuplicateDiscard=lreDuplicateDiscard, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntProxyNodes=lreCntProxyNodes, lreCntErrorsB=lreCntErrorsB, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntMultiB=lreCntMultiB, lreInterfaceStatsTable=lreInterfaceStatsTable, lreHsrLREMode=lreHsrLREMode)
