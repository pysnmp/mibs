...
ObjectIdentity, TimeTicks, ModuleIdentity, iso, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Unsigned32, Bits, Integer32, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "iso", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Unsigned32", "Bits", "Integer32", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreNodesMacAddress=lreNodesMacAddress, lreCntTxA=lreCntTxA, linkRedundancyConformance=linkRedundancyConformance, lreTimeLastSeenB=lreTimeLastSeenB, lreTransparentReception=lreTransparentReception, drp=drp, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lrePortAdminStateA=lrePortAdminStateA, lreNodesIndex=lreNodesIndex, lreCntErrorsB=lreCntErrorsB, lreCntErrWrongLanA=lreCntErrWrongLanA, lreDefaultGrp=lreDefaultGrp, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntOwnRxA=lreCntOwnRxA, lreStatisticsInterfaces=lreStatisticsInterfaces, linkRedundancyCompliances=linkRedundancyCompliances, rrp=rrp, lreCntDuplicateA=lreCntDuplicateA, lreCntOwnRxB=lreCntOwnRxB, lreEvaluateSupervision=lreEvaluateSupervision, SecondFraction=SecondFraction, lreRemNodeType=lreRemNodeType, lreCntProxyNodes=lreCntProxyNodes, lreProxyNodeIndex=lreProxyNodeIndex, lreLinkStatusB=lreLinkStatusB, lreManufacturerName=lreManufacturerName, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntErrWrongLanB=lreCntErrWrongLanB, lreNodesEntry=lreNodesEntry, lreInterfaceCount=lreInterfaceCount, lreCntDuplicateC=lreCntDuplicateC, lreHsrLREMode=lreHsrLREMode, lreConfigurationInterfaces=lreConfigurationInterfaces, mrp=mrp, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreRowStatus=lreRowStatus, lreConfiguration=lreConfiguration, lreDupListResideMaxTime=lreDupListResideMaxTime, lreInterfaceStatsTable=lreInterfaceStatsTable, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreDuplicateDiscard=lreDuplicateDiscard, lreCntMultiB=lreCntMultiB, lreCntUniqueC=lreCntUniqueC, lreVersionName=lreVersionName, ptp=ptp, lreCntMultiA=lreCntMultiA, lreProxyNodeEntry=lreProxyNodeEntry, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntRxA=lreCntRxA, brp=brp, lreInterfaceConfigTable=lreInterfaceConfigTable, lreNodesTableClear=lreNodesTableClear, lreCntMultiC=lreCntMultiC, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntTxB=lreCntTxB, lreNodeName=lreNodeName, lreCntRxB=lreCntRxB, crp=crp, lreCntUniqueB=lreCntUniqueB, lreStatistics=lreStatistics, iec62439=iec62439, lreCntErrorsC=lreCntErrorsC, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, prp=prp, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreMacAddress=lreMacAddress, lreGroups=lreGroups, lreCntTxC=lreCntTxC, PYSNMP_MODULE_ID=iec62439, lreCntDuplicateB=lreCntDuplicateB, lreCntRxC=lreCntRxC, lreNodeType=lreNodeType, lreTimeLastSeenA=lreTimeLastSeenA, lreProxyNodeTableClear=lreProxyNodeTableClear, lreSwitchingEndNode=lreSwitchingEndNode, lrePortAdminStateB=lrePortAdminStateB, lreRedBoxIdentity=lreRedBoxIdentity, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntErrorsA=lreCntErrorsA, linkRedundancyCompliance=linkRedundancyCompliance, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreNodesTable=lreNodesTable, lreCntNodes=lreCntNodes, lreLinkStatusA=lreLinkStatusA, lreCntUniqueA=lreCntUniqueA)
