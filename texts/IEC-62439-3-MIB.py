...
Integer32, ModuleIdentity, Counter32, TimeTicks, Unsigned32, iso, Counter64, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Counter32", "TimeTicks", "Unsigned32", "iso", "Counter64", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", linkRedundancyConformance=linkRedundancyConformance, lrePortAdminStateA=lrePortAdminStateA, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreProxyNodeEntry=lreProxyNodeEntry, lreNodesMacAddress=lreNodesMacAddress, lreCntTxB=lreCntTxB, lreTimeLastSeenB=lreTimeLastSeenB, lreCntDuplicateA=lreCntDuplicateA, lreCntUniqueB=lreCntUniqueB, lreCntMultiC=lreCntMultiC, drp=drp, lreCntTxC=lreCntTxC, lreCntNodes=lreCntNodes, lreStatistics=lreStatistics, brp=brp, lreRedBoxIdentity=lreRedBoxIdentity, lreProxyNodeIndex=lreProxyNodeIndex, PYSNMP_MODULE_ID=iec62439, lreInterfaceConfigIndex=lreInterfaceConfigIndex, prp=prp, lreNodesTable=lreNodesTable, lreCntRxB=lreCntRxB, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreTransparentReception=lreTransparentReception, lreStatisticsInterfaces=lreStatisticsInterfaces, lreGroups=lreGroups, lreCntProxyNodes=lreCntProxyNodes, lreCntOwnRxB=lreCntOwnRxB, lreInterfaceStatsTable=lreInterfaceStatsTable, lreRowStatus=lreRowStatus, lreCntOwnRxA=lreCntOwnRxA, lreCntErrWrongLanC=lreCntErrWrongLanC, SecondFraction=SecondFraction, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreConfiguration=lreConfiguration, lreCntTxA=lreCntTxA, lreCntErrWrongLanA=lreCntErrWrongLanA, lreRemNodeType=lreRemNodeType, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntRxC=lreCntRxC, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreTimeLastSeenA=lreTimeLastSeenA, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreInterfaceStatsIndex=lreInterfaceStatsIndex, linkRedundancyCompliances=linkRedundancyCompliances, lreVersionName=lreVersionName, lreCntUniqueC=lreCntUniqueC, lreManufacturerName=lreManufacturerName, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreNodesTableClear=lreNodesTableClear, lreInterfaceCount=lreInterfaceCount, lreNodesIndex=lreNodesIndex, linkRedundancyEntityObjects=linkRedundancyEntityObjects, ptp=ptp, lreInterfaceConfigTable=lreInterfaceConfigTable, iec62439=iec62439, lreCntErrWrongLanB=lreCntErrWrongLanB, lreHsrLREMode=lreHsrLREMode, crp=crp, lreLinkStatusA=lreLinkStatusA, lreCntErrorsA=lreCntErrorsA, lreCntMultiB=lreCntMultiB, lrePortAdminStateB=lrePortAdminStateB, lreCntMultiA=lreCntMultiA, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreLinkStatusB=lreLinkStatusB, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreNodeType=lreNodeType, lreCntDuplicateB=lreCntDuplicateB, lreNodesEntry=lreNodesEntry, lreProxyNodeTable=lreProxyNodeTable, lreCntErrorsC=lreCntErrorsC, lreNodeName=lreNodeName, lreProxyNodeTableClear=lreProxyNodeTableClear, lreDuplicateDiscard=lreDuplicateDiscard, lreSwitchingEndNode=lreSwitchingEndNode, lreEvaluateSupervision=lreEvaluateSupervision, lreDefaultGrp=lreDefaultGrp, lreCntDuplicateC=lreCntDuplicateC, lreDupListResideMaxTime=lreDupListResideMaxTime, linkRedundancyCompliance=linkRedundancyCompliance, lreCntRxA=lreCntRxA, lreCntUniqueA=lreCntUniqueA, lreMacAddress=lreMacAddress, mrp=mrp, lreCntErrorsB=lreCntErrorsB, rrp=rrp)
