...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Gauge32, TimeTicks, Bits, IpAddress, ObjectIdentity, Counter64, Integer32, NotificationType, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Gauge32", "TimeTicks", "Bits", "IpAddress", "ObjectIdentity", "Counter64", "Integer32", "NotificationType", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreRemNodeType=lreRemNodeType, lreProxyNodeIndex=lreProxyNodeIndex, lreNodeName=lreNodeName, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceCount=lreInterfaceCount, lreCntMultiB=lreCntMultiB, lreCntMultiC=lreCntMultiC, lreConfigurationInterfaces=lreConfigurationInterfaces, lreNodeType=lreNodeType, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntDuplicateC=lreCntDuplicateC, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntOwnRxA=lreCntOwnRxA, lreCntErrorsC=lreCntErrorsC, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreTimeLastSeenB=lreTimeLastSeenB, lreRowStatus=lreRowStatus, lreCntErrWrongLanC=lreCntErrWrongLanC, lreLinkStatusA=lreLinkStatusA, lreSwitchingEndNode=lreSwitchingEndNode, brp=brp, mrp=mrp, lreCntUniqueB=lreCntUniqueB, lreRedBoxIdentity=lreRedBoxIdentity, lreCntRxC=lreCntRxC, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, linkRedundancyCompliances=linkRedundancyCompliances, lreCntProxyNodes=lreCntProxyNodes, lreLinkStatusB=lreLinkStatusB, lreCntErrorsB=lreCntErrorsB, lreCntUniqueC=lreCntUniqueC, lreNodesTable=lreNodesTable, crp=crp, lreTransparentReception=lreTransparentReception, lreVersionName=lreVersionName, lreCntErrWrongLanA=lreCntErrWrongLanA, lrePortAdminStateA=lrePortAdminStateA, lreInterfaceConfigEntry=lreInterfaceConfigEntry, iec62439=iec62439, lreCntTxB=lreCntTxB, lreDefaultGrp=lreDefaultGrp, lreEvaluateSupervision=lreEvaluateSupervision, lreManufacturerName=lreManufacturerName, lrePortAdminStateB=lrePortAdminStateB, lreNodesTableClear=lreNodesTableClear, drp=drp, linkRedundancyEntityObjects=linkRedundancyEntityObjects, prp=prp, PYSNMP_MODULE_ID=iec62439, lreDuplicateDiscard=lreDuplicateDiscard, lreGroups=lreGroups, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntErrWrongLanB=lreCntErrWrongLanB, rrp=rrp, ptp=ptp, lreHsrLREMode=lreHsrLREMode, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntNodes=lreCntNodes, lreDupListResideMaxTime=lreDupListResideMaxTime, lreStatisticsInterfaces=lreStatisticsInterfaces, lreMacAddress=lreMacAddress, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreNodesMacAddress=lreNodesMacAddress, lreCntMultiA=lreCntMultiA, lreTimeLastSeenA=lreTimeLastSeenA, lreConfiguration=lreConfiguration, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntDuplicateA=lreCntDuplicateA, linkRedundancyConformance=linkRedundancyConformance, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntUniqueA=lreCntUniqueA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntErrorsA=lreCntErrorsA, linkRedundancyCompliance=linkRedundancyCompliance, lreNodesEntry=lreNodesEntry, lreCntDuplicateB=lreCntDuplicateB, lreCntTxA=lreCntTxA, lreCntRxB=lreCntRxB, lreProxyNodeEntry=lreProxyNodeEntry, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreNodesIndex=lreNodesIndex, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntOwnRxB=lreCntOwnRxB, SecondFraction=SecondFraction, lreCntTxC=lreCntTxC, lreStatistics=lreStatistics, lreCntRxA=lreCntRxA)
