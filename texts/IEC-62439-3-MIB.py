...
ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Counter32, Gauge32, Unsigned32, iso, Counter64, ModuleIdentity, Integer32, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Counter32", "Gauge32", "Unsigned32", "iso", "Counter64", "ModuleIdentity", "Integer32", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreNodesIndex=lreNodesIndex, lreNodeName=lreNodeName, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntMultiB=lreCntMultiB, lreCntDuplicateB=lreCntDuplicateB, SecondFraction=SecondFraction, lreNodesTable=lreNodesTable, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntTxC=lreCntTxC, lreCntErrWrongLanB=lreCntErrWrongLanB, lreRedBoxIdentity=lreRedBoxIdentity, lreCntRxA=lreCntRxA, mrp=mrp, lreSwitchingEndNode=lreSwitchingEndNode, lreCntErrorsC=lreCntErrorsC, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, crp=crp, lreLinkStatusA=lreLinkStatusA, lreTransparentReception=lreTransparentReception, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntErrWrongLanA=lreCntErrWrongLanA, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreProxyNodeIndex=lreProxyNodeIndex, lreDuplicateDiscard=lreDuplicateDiscard, lreHsrLREMode=lreHsrLREMode, prp=prp, lreNodeType=lreNodeType, lreCntUniqueC=lreCntUniqueC, linkRedundancyConformance=linkRedundancyConformance, lreCntDuplicateA=lreCntDuplicateA, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntErrWrongLanC=lreCntErrWrongLanC, lreConfiguration=lreConfiguration, lreTimeLastSeenB=lreTimeLastSeenB, lreCntRxC=lreCntRxC, lreProxyNodeMacAddress=lreProxyNodeMacAddress, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreRowStatus=lreRowStatus, lreTimeLastSeenA=lreTimeLastSeenA, lreCntTxA=lreCntTxA, lreCntProxyNodes=lreCntProxyNodes, lreGroups=lreGroups, lreCntOwnRxA=lreCntOwnRxA, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lrePortAdminStateB=lrePortAdminStateB, lreEvaluateSupervision=lreEvaluateSupervision, PYSNMP_MODULE_ID=iec62439, lreManufacturerName=lreManufacturerName, lreMacAddress=lreMacAddress, lreInterfaceConfigIndex=lreInterfaceConfigIndex, ptp=ptp, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntUniqueA=lreCntUniqueA, lreRemNodeType=lreRemNodeType, linkRedundancyCompliance=linkRedundancyCompliance, drp=drp, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreDefaultGrp=lreDefaultGrp, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntUniqueB=lreCntUniqueB, lreCntDuplicateC=lreCntDuplicateC, linkRedundancyCompliances=linkRedundancyCompliances, lreLinkStatusB=lreLinkStatusB, lreCntErrorsB=lreCntErrorsB, lreCntNodes=lreCntNodes, lreNodesMacAddress=lreNodesMacAddress, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntMultiA=lreCntMultiA, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreInterfaceCount=lreInterfaceCount, lreInterfaceConfigTable=lreInterfaceConfigTable, lreProxyNodeEntry=lreProxyNodeEntry, lreVersionName=lreVersionName, lreNodesEntry=lreNodesEntry, lreCntTxB=lreCntTxB, lreStatistics=lreStatistics, lreNodesTableClear=lreNodesTableClear, lreCntOwnRxB=lreCntOwnRxB, lreCntMultiC=lreCntMultiC, rrp=rrp, lrePortAdminStateA=lrePortAdminStateA, brp=brp, lreCntRxB=lreCntRxB, lreCntErrorsA=lreCntErrorsA, iec62439=iec62439)
