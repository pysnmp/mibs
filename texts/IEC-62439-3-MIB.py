...
ModuleIdentity, Counter32, MibIdentifier, iso, NotificationType, Unsigned32, Bits, ObjectIdentity, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "MibIdentifier", "iso", "NotificationType", "Unsigned32", "Bits", "ObjectIdentity", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntDuplicateC=lreCntDuplicateC, ptp=ptp, lreTransparentReception=lreTransparentReception, PYSNMP_MODULE_ID=iec62439, lreNodeType=lreNodeType, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreSwitchingEndNode=lreSwitchingEndNode, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreDefaultGrp=lreDefaultGrp, rrp=rrp, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntErrorsB=lreCntErrorsB, lreCntErrWrongLanB=lreCntErrWrongLanB, linkRedundancyCompliance=linkRedundancyCompliance, iec62439=iec62439, lreCntRxB=lreCntRxB, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreNodesTableClear=lreNodesTableClear, lreCntOwnRxB=lreCntOwnRxB, lreStatistics=lreStatistics, lreGroups=lreGroups, lreCntOwnRxA=lreCntOwnRxA, lreCntErrorsA=lreCntErrorsA, lreCntMultiA=lreCntMultiA, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreTimeLastSeenA=lreTimeLastSeenA, lreTimeLastSeenB=lreTimeLastSeenB, lreMacAddress=lreMacAddress, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, SecondFraction=SecondFraction, lreCntDuplicateA=lreCntDuplicateA, lreHsrLREMode=lreHsrLREMode, lreCntProxyNodes=lreCntProxyNodes, lreCntUniqueC=lreCntUniqueC, lreProxyNodeTableClear=lreProxyNodeTableClear, lrePortAdminStateB=lrePortAdminStateB, lreCntUniqueB=lreCntUniqueB, lreCntTxC=lreCntTxC, lreCntTxA=lreCntTxA, lreNodesIndex=lreNodesIndex, lreDuplicateDiscard=lreDuplicateDiscard, lreNodesTable=lreNodesTable, lreRowStatus=lreRowStatus, lreCntUniqueA=lreCntUniqueA, prp=prp, lreVersionName=lreVersionName, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreNodesEntry=lreNodesEntry, lreRemNodeType=lreRemNodeType, drp=drp, lreInterfaceConfigEntry=lreInterfaceConfigEntry, crp=crp, lreEvaluateSupervision=lreEvaluateSupervision, linkRedundancyConformance=linkRedundancyConformance, linkRedundancyCompliances=linkRedundancyCompliances, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, mrp=mrp, lreLinkStatusB=lreLinkStatusB, lreInterfaceConfigTable=lreInterfaceConfigTable, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntMultiC=lreCntMultiC, lreInterfaceCount=lreInterfaceCount, lreInterfaceStatsTable=lreInterfaceStatsTable, lreProxyNodeIndex=lreProxyNodeIndex, lreLinkStatusA=lreLinkStatusA, lreCntMultiB=lreCntMultiB, lreCntTxB=lreCntTxB, lreCntErrorsC=lreCntErrorsC, lreCntRxC=lreCntRxC, lreRedBoxIdentity=lreRedBoxIdentity, brp=brp, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreProxyNodeTable=lreProxyNodeTable, lreProxyNodeEntry=lreProxyNodeEntry, lreCntDuplicateB=lreCntDuplicateB, lreCntNodes=lreCntNodes, lreConfiguration=lreConfiguration, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntRxA=lreCntRxA, lrePortAdminStateA=lrePortAdminStateA, lreManufacturerName=lreManufacturerName, lreNodesMacAddress=lreNodesMacAddress, lreCntErrWrongLanA=lreCntErrWrongLanA, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreNodeName=lreNodeName)
