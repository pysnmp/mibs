...
IpAddress, MibIdentifier, ModuleIdentity, Gauge32, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, NotificationType, Counter64, Counter32, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "ModuleIdentity", "Gauge32", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "NotificationType", "Counter64", "Counter32", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntDuplicateA=lreCntDuplicateA, linkRedundancyConformance=linkRedundancyConformance, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntTxB=lreCntTxB, lreDuplicateDiscard=lreDuplicateDiscard, lreCntUniqueC=lreCntUniqueC, lreCntDuplicateB=lreCntDuplicateB, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lrePortAdminStateB=lrePortAdminStateB, SecondFraction=SecondFraction, lreConfiguration=lreConfiguration, lreCntNodes=lreCntNodes, lreCntUniqueB=lreCntUniqueB, lreCntProxyNodes=lreCntProxyNodes, lreVersionName=lreVersionName, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreNodesEntry=lreNodesEntry, lreCntErrWrongLanC=lreCntErrWrongLanC, lreTransparentReception=lreTransparentReception, lreNodesMacAddress=lreNodesMacAddress, lreCntTxA=lreCntTxA, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreNodesIndex=lreNodesIndex, lreCntOwnRxB=lreCntOwnRxB, lreStatistics=lreStatistics, lreProxyNodeIndex=lreProxyNodeIndex, lreCntErrorsB=lreCntErrorsB, lreLinkStatusA=lreLinkStatusA, iec62439=iec62439, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreRemNodeType=lreRemNodeType, lreCntErrorsC=lreCntErrorsC, lreInterfaceStatsTable=lreInterfaceStatsTable, lreInterfaceCount=lreInterfaceCount, lreStatisticsInterfaces=lreStatisticsInterfaces, mrp=mrp, lreCntDuplicateC=lreCntDuplicateC, lreRowStatus=lreRowStatus, lreHsrLREMode=lreHsrLREMode, lreSwitchingEndNode=lreSwitchingEndNode, lreTimeLastSeenB=lreTimeLastSeenB, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntRxB=lreCntRxB, lreTimeLastSeenA=lreTimeLastSeenA, lreProxyNodeEntry=lreProxyNodeEntry, PYSNMP_MODULE_ID=iec62439, lreCntMultiC=lreCntMultiC, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntErrorsA=lreCntErrorsA, rrp=rrp, lreMacAddress=lreMacAddress, lreProxyNodeTable=lreProxyNodeTable, linkRedundancyCompliance=linkRedundancyCompliance, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntOwnRxA=lreCntOwnRxA, lreCntMultiB=lreCntMultiB, lreDefaultGrp=lreDefaultGrp, lreNodesTable=lreNodesTable, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreEvaluateSupervision=lreEvaluateSupervision, lreLinkStatusB=lreLinkStatusB, lreCntTxC=lreCntTxC, brp=brp, lreProxyNodeTableClear=lreProxyNodeTableClear, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreNodeName=lreNodeName, lreCntUniqueA=lreCntUniqueA, lreDupListResideMaxTime=lreDupListResideMaxTime, lreGroups=lreGroups, drp=drp, ptp=ptp, linkRedundancyCompliances=linkRedundancyCompliances, lreProxyNodeMacAddress=lreProxyNodeMacAddress, crp=crp, lreNodesTableClear=lreNodesTableClear, lreCntRxA=lreCntRxA, lreNodeType=lreNodeType, lrePortAdminStateA=lrePortAdminStateA, lreManufacturerName=lreManufacturerName, lreCntErrWrongLanA=lreCntErrWrongLanA, lreRedBoxIdentity=lreRedBoxIdentity, lreCntMultiA=lreCntMultiA, prp=prp, lreCntRxC=lreCntRxC)
