...
MibIdentifier, Integer32, NotificationType, Counter32, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Bits, Unsigned32, Gauge32, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "NotificationType", "Counter32", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Bits", "Unsigned32", "Gauge32", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreProxyNodeEntry=lreProxyNodeEntry, lreCntNodes=lreCntNodes, lreNodesEntry=lreNodesEntry, lreDuplicateDiscard=lreDuplicateDiscard, lreNodesMacAddress=lreNodesMacAddress, lreMacAddress=lreMacAddress, lreCntErrWrongLanA=lreCntErrWrongLanA, lreSwitchingEndNode=lreSwitchingEndNode, lreVersionName=lreVersionName, lreCntDuplicateA=lreCntDuplicateA, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreConfiguration=lreConfiguration, lreNodesTableClear=lreNodesTableClear, crp=crp, lreInterfaceCount=lreInterfaceCount, lreCntMultiC=lreCntMultiC, lreHsrLREMode=lreHsrLREMode, lreNodeName=lreNodeName, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreStatisticsInterfaces=lreStatisticsInterfaces, prp=prp, lreLinkStatusA=lreLinkStatusA, lreCntTxC=lreCntTxC, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntMultiA=lreCntMultiA, lreCntRxC=lreCntRxC, lreTimeLastSeenA=lreTimeLastSeenA, iec62439=iec62439, linkRedundancyCompliances=linkRedundancyCompliances, lreRedBoxIdentity=lreRedBoxIdentity, lreCntDuplicateB=lreCntDuplicateB, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntErrorsB=lreCntErrorsB, drp=drp, lreManufacturerName=lreManufacturerName, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreGroups=lreGroups, lrePortAdminStateB=lrePortAdminStateB, linkRedundancyCompliance=linkRedundancyCompliance, lreRowStatus=lreRowStatus, brp=brp, SecondFraction=SecondFraction, ptp=ptp, lreCntUniqueC=lreCntUniqueC, lreNodesTable=lreNodesTable, lreCntProxyNodes=lreCntProxyNodes, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntOwnRxB=lreCntOwnRxB, lreDefaultGrp=lreDefaultGrp, rrp=rrp, lreProxyNodeTableClear=lreProxyNodeTableClear, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntTxB=lreCntTxB, lreCntDuplicateC=lreCntDuplicateC, lreCntErrWrongLanC=lreCntErrWrongLanC, lreTimeLastSeenB=lreTimeLastSeenB, lrePortAdminStateA=lrePortAdminStateA, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntRxA=lreCntRxA, lreCntRxB=lreCntRxB, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, mrp=mrp, lreEvaluateSupervision=lreEvaluateSupervision, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntUniqueA=lreCntUniqueA, lreRemNodeType=lreRemNodeType, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntErrorsA=lreCntErrorsA, linkRedundancyConformance=linkRedundancyConformance, lreTransparentReception=lreTransparentReception, lreNodesIndex=lreNodesIndex, lreProxyNodeIndex=lreProxyNodeIndex, lreCntTxA=lreCntTxA, lreCntErrWrongLanB=lreCntErrWrongLanB, lreProxyNodeTable=lreProxyNodeTable, lreNodeType=lreNodeType, lreCntErrorsC=lreCntErrorsC, lreStatistics=lreStatistics, lreCntOwnRxA=lreCntOwnRxA, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntUniqueB=lreCntUniqueB, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreConfigurationInterfaces=lreConfigurationInterfaces, PYSNMP_MODULE_ID=iec62439, lreLinkStatusB=lreLinkStatusB, lreCntMultiB=lreCntMultiB, lreInterfaceConfigTable=lreInterfaceConfigTable)
