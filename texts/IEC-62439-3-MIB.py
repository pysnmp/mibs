...
Gauge32, IpAddress, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, Bits, ObjectIdentity, ModuleIdentity, Integer32, Counter32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "Bits", "ObjectIdentity", "ModuleIdentity", "Integer32", "Counter32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", linkRedundancyEntityConformance=linkRedundancyEntityConformance, lrePortAdminStateB=lrePortAdminStateB, lreInterfaceStatsIndex=lreInterfaceStatsIndex, rrp=rrp, lreProxyNodeEntry=lreProxyNodeEntry, lreLinkStatusB=lreLinkStatusB, lreCntUniqueB=lreCntUniqueB, prp=prp, lreCntMultiB=lreCntMultiB, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreNodesIndex=lreNodesIndex, lreInterfaceCount=lreInterfaceCount, lreRemNodeType=lreRemNodeType, lreTimeLastSeenB=lreTimeLastSeenB, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntMultiC=lreCntMultiC, lreRowStatus=lreRowStatus, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntDuplicateA=lreCntDuplicateA, lreCntErrorsB=lreCntErrorsB, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntTxC=lreCntTxC, linkRedundancyConformance=linkRedundancyConformance, lreInterfaceConfigTable=lreInterfaceConfigTable, lreGroups=lreGroups, lreLinkStatusA=lreLinkStatusA, lreCntDuplicateB=lreCntDuplicateB, lreVersionName=lreVersionName, lreNodeType=lreNodeType, lreCntTxB=lreCntTxB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, linkRedundancyCompliance=linkRedundancyCompliance, PYSNMP_MODULE_ID=iec62439, lreCntRxA=lreCntRxA, crp=crp, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntOwnRxA=lreCntOwnRxA, lreNodesTableClear=lreNodesTableClear, lreMacAddress=lreMacAddress, drp=drp, lreTransparentReception=lreTransparentReception, lreProxyNodeTable=lreProxyNodeTable, SecondFraction=SecondFraction, lreNodesTable=lreNodesTable, lreCntDuplicateC=lreCntDuplicateC, lreSwitchingEndNode=lreSwitchingEndNode, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntOwnRxB=lreCntOwnRxB, lreHsrLREMode=lreHsrLREMode, lrePortAdminStateA=lrePortAdminStateA, lreCntErrWrongLanA=lreCntErrWrongLanA, lreManufacturerName=lreManufacturerName, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntRxB=lreCntRxB, lreInterfaceConfigIndex=lreInterfaceConfigIndex, brp=brp, linkRedundancyCompliances=linkRedundancyCompliances, lreCntUniqueA=lreCntUniqueA, lreNodesMacAddress=lreNodesMacAddress, lreRedBoxIdentity=lreRedBoxIdentity, lreCntNodes=lreCntNodes, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntErrorsC=lreCntErrorsC, lreDuplicateDiscard=lreDuplicateDiscard, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntMultiA=lreCntMultiA, lreCntErrorsA=lreCntErrorsA, lreCntErrWrongLanC=lreCntErrWrongLanC, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreNodeName=lreNodeName, lreStatistics=lreStatistics, mrp=mrp, lreProxyNodeIndex=lreProxyNodeIndex, lreNodesEntry=lreNodesEntry, lreCntRxC=lreCntRxC, ptp=ptp, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntTxA=lreCntTxA, iec62439=iec62439, lreEvaluateSupervision=lreEvaluateSupervision, lreConfiguration=lreConfiguration, lreTimeLastSeenA=lreTimeLastSeenA, lreCntProxyNodes=lreCntProxyNodes, lreCntUniqueC=lreCntUniqueC, lreDefaultGrp=lreDefaultGrp)
