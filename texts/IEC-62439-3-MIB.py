...
ObjectIdentity, ModuleIdentity, Counter64, IpAddress, Bits, Gauge32, iso, Integer32, Unsigned32, NotificationType, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Counter64", "IpAddress", "Bits", "Gauge32", "iso", "Integer32", "Unsigned32", "NotificationType", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreConfigurationInterfaces=lreConfigurationInterfaces, lreNodeType=lreNodeType, lreCntOwnRxA=lreCntOwnRxA, lreCntMultiC=lreCntMultiC, lreRemNodeType=lreRemNodeType, lreManufacturerName=lreManufacturerName, crp=crp, lreProxyNodeIndex=lreProxyNodeIndex, lreCntNodes=lreCntNodes, lreTimeLastSeenA=lreTimeLastSeenA, lreCntErrorsA=lreCntErrorsA, lreCntUniqueC=lreCntUniqueC, lreCntErrorsB=lreCntErrorsB, lreCntRxC=lreCntRxC, linkRedundancyConformance=linkRedundancyConformance, lreCntRxB=lreCntRxB, lreStatisticsInterfaces=lreStatisticsInterfaces, lreProxyNodeTableClear=lreProxyNodeTableClear, lrePortAdminStateB=lrePortAdminStateB, mrp=mrp, drp=drp, lreNodesTable=lreNodesTable, lreNodesMacAddress=lreNodesMacAddress, lreCntRxA=lreCntRxA, lreNodesTableClear=lreNodesTableClear, lreMacAddress=lreMacAddress, linkRedundancyCompliance=linkRedundancyCompliance, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreConfiguration=lreConfiguration, lreStatistics=lreStatistics, lreCntUniqueA=lreCntUniqueA, lreEvaluateSupervision=lreEvaluateSupervision, PYSNMP_MODULE_ID=iec62439, lreDefaultGrp=lreDefaultGrp, lrePortAdminStateA=lrePortAdminStateA, lreNodesEntry=lreNodesEntry, linkRedundancyCompliances=linkRedundancyCompliances, prp=prp, SecondFraction=SecondFraction, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntErrorsC=lreCntErrorsC, lreLinkStatusA=lreLinkStatusA, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntOwnRxB=lreCntOwnRxB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreInterfaceConfigTable=lreInterfaceConfigTable, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntDuplicateC=lreCntDuplicateC, lreProxyNodeEntry=lreProxyNodeEntry, lreGroups=lreGroups, lreCntUniqueB=lreCntUniqueB, lreDuplicateDiscard=lreDuplicateDiscard, lreCntDuplicateA=lreCntDuplicateA, lreCntDuplicateB=lreCntDuplicateB, lreNodesIndex=lreNodesIndex, lreDupListResideMaxTime=lreDupListResideMaxTime, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreSwitchingEndNode=lreSwitchingEndNode, lreRedBoxIdentity=lreRedBoxIdentity, lreVersionName=lreVersionName, lreNodeName=lreNodeName, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntMultiA=lreCntMultiA, lreLinkStatusB=lreLinkStatusB, lreCntErrWrongLanB=lreCntErrWrongLanB, lreTransparentReception=lreTransparentReception, lreInterfaceCount=lreInterfaceCount, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntProxyNodes=lreCntProxyNodes, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreTimeLastSeenB=lreTimeLastSeenB, lreCntMultiB=lreCntMultiB, lreCntTxB=lreCntTxB, lreHsrLREMode=lreHsrLREMode, iec62439=iec62439, ptp=ptp, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntTxC=lreCntTxC, lreRowStatus=lreRowStatus, brp=brp, rrp=rrp, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntTxA=lreCntTxA, linkRedundancyEntityConformance=linkRedundancyEntityConformance)
