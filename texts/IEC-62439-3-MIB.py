...
ObjectIdentity, TimeTicks, Integer32, Counter32, IpAddress, iso, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, NotificationType, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "Integer32", "Counter32", "IpAddress", "iso", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "NotificationType", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntErrWrongLanC=lreCntErrWrongLanC, lreRemNodeType=lreRemNodeType, lreLinkStatusA=lreLinkStatusA, lreGroups=lreGroups, linkRedundancyCompliance=linkRedundancyCompliance, lreCntDuplicateC=lreCntDuplicateC, lreCntUniqueC=lreCntUniqueC, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntRxC=lreCntRxC, lreTransparentReception=lreTransparentReception, lreStatistics=lreStatistics, lreCntOwnRxA=lreCntOwnRxA, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntNodes=lreCntNodes, lreRowStatus=lreRowStatus, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreNodesIndex=lreNodesIndex, lreProxyNodeIndex=lreProxyNodeIndex, lreConfigurationInterfaces=lreConfigurationInterfaces, lrePortAdminStateB=lrePortAdminStateB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreVersionName=lreVersionName, lreCntUniqueB=lreCntUniqueB, lreCntErrorsA=lreCntErrorsA, lreNodesTableClear=lreNodesTableClear, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreLinkStatusB=lreLinkStatusB, lreTimeLastSeenB=lreTimeLastSeenB, lreNodesEntry=lreNodesEntry, lreCntMultiC=lreCntMultiC, lreHsrLREMode=lreHsrLREMode, lreCntTxC=lreCntTxC, lreCntDuplicateB=lreCntDuplicateB, ptp=ptp, brp=brp, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreProxyNodeEntry=lreProxyNodeEntry, mrp=mrp, lreCntErrWrongLanA=lreCntErrWrongLanA, prp=prp, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreEvaluateSupervision=lreEvaluateSupervision, lreInterfaceStatsIndex=lreInterfaceStatsIndex, drp=drp, crp=crp, linkRedundancyConformance=linkRedundancyConformance, lreCntProxyNodes=lreCntProxyNodes, lreCntUniqueA=lreCntUniqueA, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntMultiA=lreCntMultiA, rrp=rrp, lreDuplicateDiscard=lreDuplicateDiscard, lreInterfaceCount=lreInterfaceCount, lreTimeLastSeenA=lreTimeLastSeenA, PYSNMP_MODULE_ID=iec62439, lreDefaultGrp=lreDefaultGrp, lreProxyNodeTable=lreProxyNodeTable, iec62439=iec62439, lreDupListResideMaxTime=lreDupListResideMaxTime, lreInterfaceStatsTable=lreInterfaceStatsTable, SecondFraction=SecondFraction, lreRedBoxIdentity=lreRedBoxIdentity, lreNodeType=lreNodeType, lreCntMultiB=lreCntMultiB, lreCntErrorsC=lreCntErrorsC, lreCntDuplicateA=lreCntDuplicateA, linkRedundancyCompliances=linkRedundancyCompliances, lreConfiguration=lreConfiguration, lreProxyNodeTableClear=lreProxyNodeTableClear, lreStatisticsInterfaces=lreStatisticsInterfaces, lreNodesMacAddress=lreNodesMacAddress, lreMacAddress=lreMacAddress, lreCntTxB=lreCntTxB, lreManufacturerName=lreManufacturerName, lreCntRxB=lreCntRxB, lrePortAdminStateA=lrePortAdminStateA, lreSwitchingEndNode=lreSwitchingEndNode, lreCntErrWrongLanB=lreCntErrWrongLanB, lreNodesTable=lreNodesTable, lreCntErrorsB=lreCntErrorsB, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntOwnRxB=lreCntOwnRxB, lreCntRxA=lreCntRxA, lreNodeName=lreNodeName, lreCntTxA=lreCntTxA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreProxyNodeMacAddress=lreProxyNodeMacAddress)
