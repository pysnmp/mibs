...
IpAddress, TimeTicks, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, NotificationType, Counter32, ObjectIdentity, Gauge32, Unsigned32, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "NotificationType", "Counter32", "ObjectIdentity", "Gauge32", "Unsigned32", "Bits", "iso")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntUniqueC=lreCntUniqueC, lreStatisticsInterfaces=lreStatisticsInterfaces, lreInterfaceCount=lreInterfaceCount, lreRemNodeType=lreRemNodeType, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntOwnRxB=lreCntOwnRxB, lreProxyNodeIndex=lreProxyNodeIndex, lreCntDuplicateB=lreCntDuplicateB, linkRedundancyCompliance=linkRedundancyCompliance, lreSwitchingEndNode=lreSwitchingEndNode, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreNodesTable=lreNodesTable, lreGroups=lreGroups, lreCntRxC=lreCntRxC, lreCntErrWrongLanA=lreCntErrWrongLanA, lreTransparentReception=lreTransparentReception, PYSNMP_MODULE_ID=iec62439, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreInterfaceStatsTable=lreInterfaceStatsTable, lreManufacturerName=lreManufacturerName, lreCntMultiC=lreCntMultiC, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntTxA=lreCntTxA, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreDuplicateDiscard=lreDuplicateDiscard, lreCntMultiB=lreCntMultiB, lreTimeLastSeenB=lreTimeLastSeenB, lreCntDuplicateA=lreCntDuplicateA, lreNodesEntry=lreNodesEntry, lreCntErrorsA=lreCntErrorsA, lreStatistics=lreStatistics, crp=crp, lreEvaluateSupervision=lreEvaluateSupervision, lreInterfaceConfigTable=lreInterfaceConfigTable, lreProxyNodeTable=lreProxyNodeTable, linkRedundancyCompliances=linkRedundancyCompliances, lreCntErrWrongLanC=lreCntErrWrongLanC, lreNodeName=lreNodeName, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntDuplicateC=lreCntDuplicateC, lreCntOwnRxA=lreCntOwnRxA, lreRowStatus=lreRowStatus, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lrePortAdminStateA=lrePortAdminStateA, iec62439=iec62439, mrp=mrp, drp=drp, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntRxA=lreCntRxA, lreDefaultGrp=lreDefaultGrp, lreCntErrorsC=lreCntErrorsC, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreInterfaceConfigEntry=lreInterfaceConfigEntry, prp=prp, lreCntUniqueA=lreCntUniqueA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntUniqueB=lreCntUniqueB, lreInterfaceStatsEntry=lreInterfaceStatsEntry, brp=brp, lreProxyNodeEntry=lreProxyNodeEntry, lreConfiguration=lreConfiguration, lreNodeType=lreNodeType, lreNodesTableClear=lreNodesTableClear, lreLinkStatusB=lreLinkStatusB, lreCntMultiA=lreCntMultiA, lreMacAddress=lreMacAddress, lrePortAdminStateB=lrePortAdminStateB, lreVersionName=lreVersionName, lreTimeLastSeenA=lreTimeLastSeenA, lreHsrLREMode=lreHsrLREMode, lreRedBoxIdentity=lreRedBoxIdentity, linkRedundancyConformance=linkRedundancyConformance, lreLinkStatusA=lreLinkStatusA, lreCntTxC=lreCntTxC, lreCntNodes=lreCntNodes, lreNodesIndex=lreNodesIndex, lreCntProxyNodes=lreCntProxyNodes, lreNodesMacAddress=lreNodesMacAddress, ptp=ptp, rrp=rrp, lreCntTxB=lreCntTxB, lreCntErrWrongLanB=lreCntErrWrongLanB, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntRxB=lreCntRxB, SecondFraction=SecondFraction, lreCntErrorsB=lreCntErrorsB)
