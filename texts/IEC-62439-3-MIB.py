...
ObjectIdentity, IpAddress, Unsigned32, Integer32, TimeTicks, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, Counter32, ModuleIdentity, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Unsigned32", "Integer32", "TimeTicks", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "Counter32", "ModuleIdentity", "Gauge32", "iso")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntErrorsC=lreCntErrorsC, lreCntDuplicateA=lreCntDuplicateA, lreCntMultiB=lreCntMultiB, lreNodesTable=lreNodesTable, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntOwnRxB=lreCntOwnRxB, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreLinkStatusA=lreLinkStatusA, lreCntRxC=lreCntRxC, lreNodeName=lreNodeName, lreCntNodes=lreCntNodes, linkRedundancyCompliances=linkRedundancyCompliances, lreHsrLREMode=lreHsrLREMode, lreLinkStatusB=lreLinkStatusB, lreCntDuplicateB=lreCntDuplicateB, lreManufacturerName=lreManufacturerName, PYSNMP_MODULE_ID=iec62439, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntTxB=lreCntTxB, iec62439=iec62439, lreDefaultGrp=lreDefaultGrp, lreCntTxA=lreCntTxA, lreCntErrorsB=lreCntErrorsB, lreCntUniqueB=lreCntUniqueB, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntProxyNodes=lreCntProxyNodes, lreDuplicateDiscard=lreDuplicateDiscard, lreVersionName=lreVersionName, linkRedundancyCompliance=linkRedundancyCompliance, lreDupListResideMaxTime=lreDupListResideMaxTime, prp=prp, crp=crp, lreCntMultiA=lreCntMultiA, lreCntMultiC=lreCntMultiC, lreRedBoxIdentity=lreRedBoxIdentity, lreTimeLastSeenB=lreTimeLastSeenB, brp=brp, lreInterfaceCount=lreInterfaceCount, lreCntTxC=lreCntTxC, lreStatisticsInterfaces=lreStatisticsInterfaces, lreNodesMacAddress=lreNodesMacAddress, lreInterfaceConfigIndex=lreInterfaceConfigIndex, rrp=rrp, lreCntErrWrongLanB=lreCntErrWrongLanB, lreConfiguration=lreConfiguration, lreSwitchingEndNode=lreSwitchingEndNode, lreCntErrWrongLanC=lreCntErrWrongLanC, lreProxyNodeIndex=lreProxyNodeIndex, mrp=mrp, lreCntRxA=lreCntRxA, lreCntDuplicateC=lreCntDuplicateC, lreCntRxB=lreCntRxB, lreRemNodeType=lreRemNodeType, lreStatistics=lreStatistics, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreNodesTableClear=lreNodesTableClear, lreEvaluateSupervision=lreEvaluateSupervision, linkRedundancyConformance=linkRedundancyConformance, lreCntUniqueA=lreCntUniqueA, lreProxyNodeTableClear=lreProxyNodeTableClear, lreProxyNodeEntry=lreProxyNodeEntry, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreTransparentReception=lreTransparentReception, SecondFraction=SecondFraction, lreRowStatus=lreRowStatus, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntOwnRxA=lreCntOwnRxA, lrePortAdminStateA=lrePortAdminStateA, lreCntErrorsA=lreCntErrorsA, lreCntUniqueC=lreCntUniqueC, lreNodesIndex=lreNodesIndex, lreNodesEntry=lreNodesEntry, lreConfigurationInterfaces=lreConfigurationInterfaces, lreGroups=lreGroups, lreTimeLastSeenA=lreTimeLastSeenA, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreMacAddress=lreMacAddress, lrePortAdminStateB=lrePortAdminStateB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreNodeType=lreNodeType, drp=drp, ptp=ptp)
