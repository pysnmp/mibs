...
# Produced by pysmi-1.1.8 at Thu Oct 12 09:00:13 2023
...
TimeTicks, Counter32, NotificationType, Counter64, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Gauge32, ModuleIdentity, IpAddress, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "NotificationType", "Counter64", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Gauge32", "ModuleIdentity", "IpAddress", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lrePortAdminStateB=lrePortAdminStateB, lreDuplicateDiscard=lreDuplicateDiscard, lreLinkStatusA=lreLinkStatusA, lreStatistics=lreStatistics, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntProxyNodes=lreCntProxyNodes, lreCntErrorsB=lreCntErrorsB, lrePortAdminStateA=lrePortAdminStateA, lreManufacturerName=lreManufacturerName, lreCntTxB=lreCntTxB, crp=crp, prp=prp, lreEvaluateSupervision=lreEvaluateSupervision, lreCntRxC=lreCntRxC, ptp=ptp, lreCntErrWrongLanA=lreCntErrWrongLanA, linkRedundancyConformance=linkRedundancyConformance, lreCntMultiA=lreCntMultiA, lreCntDuplicateB=lreCntDuplicateB, lreTimeLastSeenB=lreTimeLastSeenB, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntUniqueA=lreCntUniqueA, lreCntUniqueB=lreCntUniqueB, drp=drp, lreNodesMacAddress=lreNodesMacAddress, lreGroups=lreGroups, lreCntMultiB=lreCntMultiB, lreInterfaceConfigTable=lreInterfaceConfigTable, lreNodesIndex=lreNodesIndex, lreInterfaceCount=lreInterfaceCount, lreProxyNodeEntry=lreProxyNodeEntry, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntTxA=lreCntTxA, lreRemNodeType=lreRemNodeType, rrp=rrp, lreNodeType=lreNodeType, lreCntTxC=lreCntTxC, lreMacAddress=lreMacAddress, lreCntNodes=lreCntNodes, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreDupListResideMaxTime=lreDupListResideMaxTime, lreNodeName=lreNodeName, lreCntOwnRxB=lreCntOwnRxB, lreSwitchingEndNode=lreSwitchingEndNode, iec62439=iec62439, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, linkRedundancyCompliance=linkRedundancyCompliance, lreNodesEntry=lreNodesEntry, lreTimeLastSeenA=lreTimeLastSeenA, lreProxyNodeTable=lreProxyNodeTable, lreCntErrorsC=lreCntErrorsC, lreNodesTableClear=lreNodesTableClear, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreTransparentReception=lreTransparentReception, lreProxyNodeIndex=lreProxyNodeIndex, brp=brp, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreVersionName=lreVersionName, lreCntUniqueC=lreCntUniqueC, lreStatisticsInterfaces=lreStatisticsInterfaces, PYSNMP_MODULE_ID=iec62439, lreLinkStatusB=lreLinkStatusB, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntDuplicateA=lreCntDuplicateA, lreConfiguration=lreConfiguration, mrp=mrp, linkRedundancyEntityObjects=linkRedundancyEntityObjects, SecondFraction=SecondFraction, lreCntRxA=lreCntRxA, lreCntMultiC=lreCntMultiC, lreProxyNodeTableClear=lreProxyNodeTableClear, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntErrorsA=lreCntErrorsA, lreCntDuplicateC=lreCntDuplicateC, lreHsrLREMode=lreHsrLREMode, lreRowStatus=lreRowStatus, linkRedundancyCompliances=linkRedundancyCompliances, lreCntRxB=lreCntRxB, lreRedBoxIdentity=lreRedBoxIdentity, lreDefaultGrp=lreDefaultGrp, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntOwnRxA=lreCntOwnRxA, lreNodesTable=lreNodesTable)
