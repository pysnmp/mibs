...
ObjectIdentity, ModuleIdentity, Counter32, Integer32, Gauge32, iso, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, NotificationType, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Counter32", "Integer32", "Gauge32", "iso", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "NotificationType", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreInterfaceStatsEntry=lreInterfaceStatsEntry, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntDuplicateB=lreCntDuplicateB, lreProxyNodeTable=lreProxyNodeTable, lreCntRxB=lreCntRxB, lrePortAdminStateB=lrePortAdminStateB, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntOwnRxA=lreCntOwnRxA, lreLinkStatusA=lreLinkStatusA, lreStatistics=lreStatistics, lreInterfaceCount=lreInterfaceCount, lreHsrLREMode=lreHsrLREMode, lreNodeName=lreNodeName, lreNodeType=lreNodeType, lreDefaultGrp=lreDefaultGrp, mrp=mrp, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntUniqueA=lreCntUniqueA, lreVersionName=lreVersionName, lrePortAdminStateA=lrePortAdminStateA, lreProxyNodeTableClear=lreProxyNodeTableClear, lreNodesTable=lreNodesTable, lreEvaluateSupervision=lreEvaluateSupervision, PYSNMP_MODULE_ID=iec62439, SecondFraction=SecondFraction, linkRedundancyCompliance=linkRedundancyCompliance, lreConfigurationInterfaces=lreConfigurationInterfaces, drp=drp, lreNodesEntry=lreNodesEntry, lreMacAddress=lreMacAddress, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntErrorsB=lreCntErrorsB, lreTimeLastSeenB=lreTimeLastSeenB, lreCntErrorsA=lreCntErrorsA, lreGroups=lreGroups, lreCntTxA=lreCntTxA, lreTransparentReception=lreTransparentReception, rrp=rrp, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntUniqueB=lreCntUniqueB, lreCntTxC=lreCntTxC, lreCntMultiA=lreCntMultiA, lreProxyNodeEntry=lreProxyNodeEntry, lreNodesMacAddress=lreNodesMacAddress, lreCntDuplicateC=lreCntDuplicateC, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreRedBoxIdentity=lreRedBoxIdentity, lreRowStatus=lreRowStatus, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreConfiguration=lreConfiguration, lreCntMultiB=lreCntMultiB, lreCntMultiC=lreCntMultiC, linkRedundancyEntityObjects=linkRedundancyEntityObjects, crp=crp, lreCntRxA=lreCntRxA, lreRemNodeType=lreRemNodeType, linkRedundancyCompliances=linkRedundancyCompliances, lreTimeLastSeenA=lreTimeLastSeenA, lreSwitchingEndNode=lreSwitchingEndNode, lreCntOwnRxB=lreCntOwnRxB, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreManufacturerName=lreManufacturerName, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntRxC=lreCntRxC, lreNodesTableClear=lreNodesTableClear, lreCntDuplicateA=lreCntDuplicateA, prp=prp, lreInterfaceStatsIndex=lreInterfaceStatsIndex, iec62439=iec62439, lreCntTxB=lreCntTxB, lreNodesIndex=lreNodesIndex, lreCntNodes=lreCntNodes, linkRedundancyConformance=linkRedundancyConformance, ptp=ptp, brp=brp, lreLinkStatusB=lreLinkStatusB, lreInterfaceConfigTable=lreInterfaceConfigTable, lreProxyNodeIndex=lreProxyNodeIndex, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntProxyNodes=lreCntProxyNodes, lreCntUniqueC=lreCntUniqueC, lreCntErrorsC=lreCntErrorsC, lreDuplicateDiscard=lreDuplicateDiscard, lreCntErrWrongLanA=lreCntErrWrongLanA, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntErrWrongLanB=lreCntErrWrongLanB)
