...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, Counter32, IpAddress, ObjectIdentity, TimeTicks, NotificationType, Integer32, Gauge32, ModuleIdentity, MibIdentifier, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "Counter32", "IpAddress", "ObjectIdentity", "TimeTicks", "NotificationType", "Integer32", "Gauge32", "ModuleIdentity", "MibIdentifier", "iso", "Counter64")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreRowStatus=lreRowStatus, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreProxyNodeTableClear=lreProxyNodeTableClear, lrePortAdminStateA=lrePortAdminStateA, lreCntDuplicateC=lreCntDuplicateC, lreInterfaceCount=lreInterfaceCount, lreCntOwnRxB=lreCntOwnRxB, lreCntUniqueA=lreCntUniqueA, lrePortAdminStateB=lrePortAdminStateB, lreCntUniqueB=lreCntUniqueB, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntProxyNodes=lreCntProxyNodes, lreConfigurationInterfaces=lreConfigurationInterfaces, prp=prp, lreNodesEntry=lreNodesEntry, SecondFraction=SecondFraction, lreCntTxC=lreCntTxC, lreNodeType=lreNodeType, lreEvaluateSupervision=lreEvaluateSupervision, lreCntDuplicateA=lreCntDuplicateA, lreCntDuplicateB=lreCntDuplicateB, lreLinkStatusA=lreLinkStatusA, lreStatisticsInterfaces=lreStatisticsInterfaces, lreProxyNodeTable=lreProxyNodeTable, lreProxyNodeEntry=lreProxyNodeEntry, lreNodesTable=lreNodesTable, lreCntUniqueC=lreCntUniqueC, lreTimeLastSeenB=lreTimeLastSeenB, mrp=mrp, lreDefaultGrp=lreDefaultGrp, lreRedBoxIdentity=lreRedBoxIdentity, lreLinkStatusB=lreLinkStatusB, drp=drp, lreInterfaceConfigTable=lreInterfaceConfigTable, lreGroups=lreGroups, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntErrWrongLanB=lreCntErrWrongLanB, lreStatistics=lreStatistics, lreProxyNodeIndex=lreProxyNodeIndex, lreCntErrWrongLanA=lreCntErrWrongLanA, lreNodeName=lreNodeName, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreDupListResideMaxTime=lreDupListResideMaxTime, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntTxA=lreCntTxA, lreCntTxB=lreCntTxB, lreNodesMacAddress=lreNodesMacAddress, lreCntErrorsB=lreCntErrorsB, lreInterfaceStatsIndex=lreInterfaceStatsIndex, iec62439=iec62439, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreManufacturerName=lreManufacturerName, lreCntErrorsA=lreCntErrorsA, lreConfiguration=lreConfiguration, lreCntRxC=lreCntRxC, linkRedundancyCompliances=linkRedundancyCompliances, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntMultiB=lreCntMultiB, lreInterfaceStatsTable=lreInterfaceStatsTable, lreTimeLastSeenA=lreTimeLastSeenA, lreRemNodeType=lreRemNodeType, lreCntErrWrongLanC=lreCntErrWrongLanC, lreHsrLREMode=lreHsrLREMode, lreCntMultiA=lreCntMultiA, lreTransparentReception=lreTransparentReception, lreDuplicateDiscard=lreDuplicateDiscard, lreCntMultiC=lreCntMultiC, lreSwitchingEndNode=lreSwitchingEndNode, rrp=rrp, brp=brp, lreMacAddress=lreMacAddress, linkRedundancyCompliance=linkRedundancyCompliance, crp=crp, lreNodesIndex=lreNodesIndex, lreCntOwnRxA=lreCntOwnRxA, lreCntRxA=lreCntRxA, PYSNMP_MODULE_ID=iec62439, ptp=ptp, lreCntErrorsC=lreCntErrorsC, lreNodesTableClear=lreNodesTableClear, lreVersionName=lreVersionName, lreCntRxB=lreCntRxB, lreCntNodes=lreCntNodes, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, linkRedundancyConformance=linkRedundancyConformance)
