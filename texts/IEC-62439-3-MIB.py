...
# Produced by pysmi-1.1.8 at Mon Jan  9 13:29:21 2023
...
MibIdentifier, Bits, TimeTicks, IpAddress, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, NotificationType, ObjectIdentity, Counter32, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "TimeTicks", "IpAddress", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "NotificationType", "ObjectIdentity", "Counter32", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntUniqueC=lreCntUniqueC, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreRedBoxIdentity=lreRedBoxIdentity, lreCntOwnRxB=lreCntOwnRxB, lreProxyNodeIndex=lreProxyNodeIndex, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreRowStatus=lreRowStatus, lreNodesMacAddress=lreNodesMacAddress, lreMacAddress=lreMacAddress, drp=drp, lreHsrLREMode=lreHsrLREMode, lreCntProxyNodes=lreCntProxyNodes, lreCntErrorsA=lreCntErrorsA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreInterfaceConfigTable=lreInterfaceConfigTable, brp=brp, lreTimeLastSeenB=lreTimeLastSeenB, lreCntDuplicateB=lreCntDuplicateB, lreCntMultiB=lreCntMultiB, lreNodeType=lreNodeType, lreCntErrWrongLanA=lreCntErrWrongLanA, prp=prp, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreNodesTable=lreNodesTable, iec62439=iec62439, lreCntErrorsC=lreCntErrorsC, lreNodesTableClear=lreNodesTableClear, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntUniqueA=lreCntUniqueA, lreEvaluateSupervision=lreEvaluateSupervision, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreSwitchingEndNode=lreSwitchingEndNode, lreCntRxC=lreCntRxC, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntTxC=lreCntTxC, lreCntErrorsB=lreCntErrorsB, rrp=rrp, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, linkRedundancyCompliances=linkRedundancyCompliances, lreCntDuplicateC=lreCntDuplicateC, lreNodesIndex=lreNodesIndex, lreLinkStatusA=lreLinkStatusA, lreDefaultGrp=lreDefaultGrp, ptp=ptp, lreProxyNodeTableClear=lreProxyNodeTableClear, lreInterfaceCount=lreInterfaceCount, lreCntRxA=lreCntRxA, lrePortAdminStateB=lrePortAdminStateB, lreProxyNodeEntry=lreProxyNodeEntry, linkRedundancyEntityConformance=linkRedundancyEntityConformance, crp=crp, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntTxA=lreCntTxA, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntDuplicateA=lreCntDuplicateA, linkRedundancyCompliance=linkRedundancyCompliance, lreCntMultiC=lreCntMultiC, lreNodesEntry=lreNodesEntry, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntMultiA=lreCntMultiA, lreCntErrWrongLanB=lreCntErrWrongLanB, lreRemNodeType=lreRemNodeType, lreCntOwnRxA=lreCntOwnRxA, SecondFraction=SecondFraction, lreCntTxB=lreCntTxB, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreManufacturerName=lreManufacturerName, mrp=mrp, lreTimeLastSeenA=lreTimeLastSeenA, lreConfigurationInterfaces=lreConfigurationInterfaces, lrePortAdminStateA=lrePortAdminStateA, PYSNMP_MODULE_ID=iec62439, lreLinkStatusB=lreLinkStatusB, lreVersionName=lreVersionName, lreCntNodes=lreCntNodes, lreStatistics=lreStatistics, lreTransparentReception=lreTransparentReception, lreProxyNodeTable=lreProxyNodeTable, lreConfiguration=lreConfiguration, lreCntUniqueB=lreCntUniqueB, lreCntRxB=lreCntRxB, lreNodeName=lreNodeName, lreDuplicateDiscard=lreDuplicateDiscard, lreGroups=lreGroups, lreProxyNodeMacAddress=lreProxyNodeMacAddress, linkRedundancyConformance=linkRedundancyConformance, lreInterfaceStatsIndex=lreInterfaceStatsIndex)
