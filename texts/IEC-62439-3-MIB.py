...
# Produced by pysmi-1.1.8 at Thu Jan  5 14:36:52 2023
...
IpAddress, TimeTicks, ObjectIdentity, Gauge32, MibIdentifier, Counter32, Unsigned32, iso, Counter64, Bits, NotificationType, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "ObjectIdentity", "Gauge32", "MibIdentifier", "Counter32", "Unsigned32", "iso", "Counter64", "Bits", "NotificationType", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreLinkStatusB=lreLinkStatusB, lreCntErrorsB=lreCntErrorsB, lreCntMultiC=lreCntMultiC, lreCntOwnRxB=lreCntOwnRxB, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntTxB=lreCntTxB, lreNodesTable=lreNodesTable, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreVersionName=lreVersionName, lreRowStatus=lreRowStatus, lreCntUniqueB=lreCntUniqueB, lreProxyNodeIndex=lreProxyNodeIndex, lreDuplicateDiscard=lreDuplicateDiscard, lreStatisticsInterfaces=lreStatisticsInterfaces, lreRemNodeType=lreRemNodeType, lreCntErrWrongLanC=lreCntErrWrongLanC, lreProxyNodeTable=lreProxyNodeTable, lreCntDuplicateC=lreCntDuplicateC, lreProxyNodeEntry=lreProxyNodeEntry, lreNodesIndex=lreNodesIndex, lreCntTxC=lreCntTxC, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntNodes=lreCntNodes, lreNodeName=lreNodeName, lreTransparentReception=lreTransparentReception, lreSwitchingEndNode=lreSwitchingEndNode, lreCntDuplicateA=lreCntDuplicateA, lreCntRxB=lreCntRxB, brp=brp, lreCntErrWrongLanB=lreCntErrWrongLanB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, PYSNMP_MODULE_ID=iec62439, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreInterfaceCount=lreInterfaceCount, lreNodeType=lreNodeType, lreTimeLastSeenB=lreTimeLastSeenB, iec62439=iec62439, lreRedBoxIdentity=lreRedBoxIdentity, lreTimeLastSeenA=lreTimeLastSeenA, linkRedundancyCompliances=linkRedundancyCompliances, linkRedundancyCompliance=linkRedundancyCompliance, lrePortAdminStateA=lrePortAdminStateA, lreCntProxyNodes=lreCntProxyNodes, drp=drp, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntUniqueC=lreCntUniqueC, crp=crp, prp=prp, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntErrorsC=lreCntErrorsC, lreCntMultiB=lreCntMultiB, lreConfigurationInterfaces=lreConfigurationInterfaces, lreLinkStatusA=lreLinkStatusA, linkRedundancyConformance=linkRedundancyConformance, lreDefaultGrp=lreDefaultGrp, mrp=mrp, lreCntRxA=lreCntRxA, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreConfiguration=lreConfiguration, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreNodesMacAddress=lreNodesMacAddress, lreCntRxC=lreCntRxC, lreCntErrWrongLanA=lreCntErrWrongLanA, lreNodesTableClear=lreNodesTableClear, lreCntOwnRxA=lreCntOwnRxA, lreMacAddress=lreMacAddress, lrePortAdminStateB=lrePortAdminStateB, lreManufacturerName=lreManufacturerName, lreHsrLREMode=lreHsrLREMode, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, ptp=ptp, SecondFraction=SecondFraction, lreCntDuplicateB=lreCntDuplicateB, lreCntMultiA=lreCntMultiA, lreStatistics=lreStatistics, lreCntTxA=lreCntTxA, lreNodesEntry=lreNodesEntry, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntUniqueA=lreCntUniqueA, rrp=rrp, lreCntErrorsA=lreCntErrorsA, lreEvaluateSupervision=lreEvaluateSupervision, lreInterfaceStatsTable=lreInterfaceStatsTable, lreGroups=lreGroups)
