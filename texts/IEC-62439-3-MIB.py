...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Counter64, TimeTicks, ModuleIdentity, Bits, NotificationType, Gauge32, IpAddress, iso, MibIdentifier, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Counter64", "TimeTicks", "ModuleIdentity", "Bits", "NotificationType", "Gauge32", "IpAddress", "iso", "MibIdentifier", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntRxA=lreCntRxA, linkRedundancyCompliances=linkRedundancyCompliances, lreCntRxB=lreCntRxB, lreRedBoxIdentity=lreRedBoxIdentity, crp=crp, lreCntOwnRxB=lreCntOwnRxB, lreMacAddress=lreMacAddress, lreInterfaceConfigTable=lreInterfaceConfigTable, lreInterfaceCount=lreInterfaceCount, rrp=rrp, lreNodesIndex=lreNodesIndex, lreNodesEntry=lreNodesEntry, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntTxA=lreCntTxA, lreStatistics=lreStatistics, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lrePortAdminStateB=lrePortAdminStateB, lreNodesTableClear=lreNodesTableClear, lreVersionName=lreVersionName, lreGroups=lreGroups, lreProxyNodeIndex=lreProxyNodeIndex, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntTxC=lreCntTxC, lreCntErrorsC=lreCntErrorsC, lreProxyNodeTable=lreProxyNodeTable, drp=drp, lreConfiguration=lreConfiguration, lreRowStatus=lreRowStatus, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntProxyNodes=lreCntProxyNodes, lreTimeLastSeenA=lreTimeLastSeenA, iec62439=iec62439, lreCntTxB=lreCntTxB, ptp=ptp, mrp=mrp, lreInterfaceStatsTable=lreInterfaceStatsTable, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntErrWrongLanB=lreCntErrWrongLanB, lreNodeType=lreNodeType, lreNodesMacAddress=lreNodesMacAddress, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lrePortAdminStateA=lrePortAdminStateA, lreTransparentReception=lreTransparentReception, lreNodesTable=lreNodesTable, lreCntErrorsB=lreCntErrorsB, lreProxyNodeEntry=lreProxyNodeEntry, lreCntUniqueB=lreCntUniqueB, lreLinkStatusB=lreLinkStatusB, lreRemNodeType=lreRemNodeType, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreNodeName=lreNodeName, lreCntOwnRxA=lreCntOwnRxA, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntMultiB=lreCntMultiB, lreCntDuplicateA=lreCntDuplicateA, brp=brp, lreEvaluateSupervision=lreEvaluateSupervision, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntUniqueA=lreCntUniqueA, lreCntNodes=lreCntNodes, lreDefaultGrp=lreDefaultGrp, lreLinkStatusA=lreLinkStatusA, lreCntErrorsA=lreCntErrorsA, lreDuplicateDiscard=lreDuplicateDiscard, lreSwitchingEndNode=lreSwitchingEndNode, lreDupListResideMaxTime=lreDupListResideMaxTime, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreHsrLREMode=lreHsrLREMode, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntMultiA=lreCntMultiA, lreCntDuplicateC=lreCntDuplicateC, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntErrWrongLanA=lreCntErrWrongLanA, prp=prp, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, SecondFraction=SecondFraction, lreTimeLastSeenB=lreTimeLastSeenB, linkRedundancyEntityConformance=linkRedundancyEntityConformance, linkRedundancyCompliance=linkRedundancyCompliance, lreCntDuplicateB=lreCntDuplicateB, lreCntMultiC=lreCntMultiC, linkRedundancyConformance=linkRedundancyConformance, PYSNMP_MODULE_ID=iec62439, lreCntRxC=lreCntRxC, lreCntUniqueC=lreCntUniqueC, lreManufacturerName=lreManufacturerName)
