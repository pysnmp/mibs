...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Gauge32, ObjectIdentity, iso, Counter32, NotificationType, TimeTicks, Counter64, ModuleIdentity, MibIdentifier, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Gauge32", "ObjectIdentity", "iso", "Counter32", "NotificationType", "TimeTicks", "Counter64", "ModuleIdentity", "MibIdentifier", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lrePortAdminStateA=lrePortAdminStateA, lreConfiguration=lreConfiguration, lreCntMultiC=lreCntMultiC, prp=prp, lreGroups=lreGroups, lreRedBoxIdentity=lreRedBoxIdentity, lreCntDuplicateA=lreCntDuplicateA, lreDuplicateDiscard=lreDuplicateDiscard, lreCntMultiA=lreCntMultiA, lreDupListResideMaxTime=lreDupListResideMaxTime, lreLinkStatusB=lreLinkStatusB, lreRowStatus=lreRowStatus, lreNodesIndex=lreNodesIndex, lreEvaluateSupervision=lreEvaluateSupervision, lreProxyNodeTable=lreProxyNodeTable, lreNodesTableClear=lreNodesTableClear, lreStatistics=lreStatistics, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreSwitchingEndNode=lreSwitchingEndNode, lreCntErrorsA=lreCntErrorsA, lreCntOwnRxA=lreCntOwnRxA, lreVersionName=lreVersionName, lreCntDuplicateC=lreCntDuplicateC, SecondFraction=SecondFraction, lreTimeLastSeenA=lreTimeLastSeenA, brp=brp, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreRemNodeType=lreRemNodeType, lreProxyNodeTableClear=lreProxyNodeTableClear, lreInterfaceStatsEntry=lreInterfaceStatsEntry, linkRedundancyCompliance=linkRedundancyCompliance, lreLinkStatusA=lreLinkStatusA, lrePortAdminStateB=lrePortAdminStateB, crp=crp, lreManufacturerName=lreManufacturerName, lreCntErrorsC=lreCntErrorsC, lreNodesTable=lreNodesTable, lreInterfaceConfigTable=lreInterfaceConfigTable, lreNodeType=lreNodeType, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreTimeLastSeenB=lreTimeLastSeenB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreHsrLREMode=lreHsrLREMode, lreTransparentReception=lreTransparentReception, lreCntDuplicateB=lreCntDuplicateB, linkRedundancyCompliances=linkRedundancyCompliances, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntUniqueA=lreCntUniqueA, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntNodes=lreCntNodes, lreInterfaceStatsTable=lreInterfaceStatsTable, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreMacAddress=lreMacAddress, PYSNMP_MODULE_ID=iec62439, lreCntTxA=lreCntTxA, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntErrWrongLanA=lreCntErrWrongLanA, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreInterfaceCount=lreInterfaceCount, lreCntOwnRxB=lreCntOwnRxB, iec62439=iec62439, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntProxyNodes=lreCntProxyNodes, mrp=mrp, lreDefaultGrp=lreDefaultGrp, lreNodeName=lreNodeName, lreCntRxA=lreCntRxA, lreNodesMacAddress=lreNodesMacAddress, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntRxC=lreCntRxC, lreCntUniqueB=lreCntUniqueB, lreCntUniqueC=lreCntUniqueC, lreCntTxC=lreCntTxC, lreCntErrorsB=lreCntErrorsB, lreNodesEntry=lreNodesEntry, lreCntRxB=lreCntRxB, lreProxyNodeIndex=lreProxyNodeIndex, lreCntTxB=lreCntTxB, lreProxyNodeEntry=lreProxyNodeEntry, lreCntMultiB=lreCntMultiB, drp=drp, lreStatisticsInterfaces=lreStatisticsInterfaces, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, ptp=ptp, linkRedundancyConformance=linkRedundancyConformance, rrp=rrp)
