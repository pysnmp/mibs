...
ObjectIdentity, Bits, NotificationType, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Counter64, iso, ModuleIdentity, IpAddress, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "NotificationType", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Counter64", "iso", "ModuleIdentity", "IpAddress", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntErrorsA=lreCntErrorsA, lrePortAdminStateB=lrePortAdminStateB, lreCntRxB=lreCntRxB, iec62439=iec62439, lreCntOwnRxA=lreCntOwnRxA, lreCntMultiB=lreCntMultiB, lreCntRxC=lreCntRxC, lreCntTxC=lreCntTxC, lreCntOwnRxB=lreCntOwnRxB, lreNodesMacAddress=lreNodesMacAddress, lreConfiguration=lreConfiguration, lreCntUniqueB=lreCntUniqueB, lreConfigurationInterfaces=lreConfigurationInterfaces, lreRowStatus=lreRowStatus, lreInterfaceStatsEntry=lreInterfaceStatsEntry, rrp=rrp, lreNodesEntry=lreNodesEntry, linkRedundancyCompliance=linkRedundancyCompliance, lreCntDuplicateB=lreCntDuplicateB, lreCntErrorsB=lreCntErrorsB, lreCntErrWrongLanA=lreCntErrWrongLanA, lreLinkStatusB=lreLinkStatusB, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreStatistics=lreStatistics, lreProxyNodeEntry=lreProxyNodeEntry, lreCntDuplicateA=lreCntDuplicateA, lreDefaultGrp=lreDefaultGrp, lreSwitchingEndNode=lreSwitchingEndNode, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreInterfaceConfigTable=lreInterfaceConfigTable, lreGroups=lreGroups, drp=drp, lreCntUniqueA=lreCntUniqueA, lreCntMultiA=lreCntMultiA, crp=crp, lreNodeName=lreNodeName, PYSNMP_MODULE_ID=iec62439, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreTransparentReception=lreTransparentReception, lreProxyNodeTableClear=lreProxyNodeTableClear, lreTimeLastSeenA=lreTimeLastSeenA, lreRedBoxIdentity=lreRedBoxIdentity, lreCntErrorsC=lreCntErrorsC, lreLinkStatusA=lreLinkStatusA, lreDuplicateDiscard=lreDuplicateDiscard, lreDupListResideMaxTime=lreDupListResideMaxTime, linkRedundancyCompliances=linkRedundancyCompliances, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreNodesTableClear=lreNodesTableClear, lreCntMultiC=lreCntMultiC, lreStatisticsInterfaces=lreStatisticsInterfaces, brp=brp, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntProxyNodes=lreCntProxyNodes, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, mrp=mrp, lreVersionName=lreVersionName, SecondFraction=SecondFraction, lreManufacturerName=lreManufacturerName, lreNodeType=lreNodeType, lreCntErrWrongLanC=lreCntErrWrongLanC, lreMacAddress=lreMacAddress, ptp=ptp, lreCntTxA=lreCntTxA, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntDuplicateC=lreCntDuplicateC, lreProxyNodeTable=lreProxyNodeTable, lreRemNodeType=lreRemNodeType, lreCntRxA=lreCntRxA, linkRedundancyConformance=linkRedundancyConformance, lreEvaluateSupervision=lreEvaluateSupervision, lreNodesIndex=lreNodesIndex, lreInterfaceCount=lreInterfaceCount, lreCntUniqueC=lreCntUniqueC, lreNodesTable=lreNodesTable, prp=prp, lreHsrLREMode=lreHsrLREMode, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreProxyNodeIndex=lreProxyNodeIndex, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lrePortAdminStateA=lrePortAdminStateA, lreTimeLastSeenB=lreTimeLastSeenB, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntNodes=lreCntNodes, lreCntTxB=lreCntTxB)
