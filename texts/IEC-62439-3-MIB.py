...
ModuleIdentity, ObjectIdentity, IpAddress, MibIdentifier, TimeTicks, Unsigned32, iso, Counter64, Counter32, NotificationType, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "IpAddress", "MibIdentifier", "TimeTicks", "Unsigned32", "iso", "Counter64", "Counter32", "NotificationType", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntTxC=lreCntTxC, lreCntProxyNodes=lreCntProxyNodes, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntMultiC=lreCntMultiC, ptp=ptp, lreNodesEntry=lreNodesEntry, lreNodesMacAddress=lreNodesMacAddress, brp=brp, lrePortAdminStateA=lrePortAdminStateA, lreProxyNodeEntry=lreProxyNodeEntry, lreCntNodes=lreCntNodes, lrePortAdminStateB=lrePortAdminStateB, lreCntMultiA=lreCntMultiA, lreNodeType=lreNodeType, lreDefaultGrp=lreDefaultGrp, mrp=mrp, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreInterfaceCount=lreInterfaceCount, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntRxC=lreCntRxC, lreHsrLREMode=lreHsrLREMode, lreCntUniqueC=lreCntUniqueC, lreCntErrWrongLanB=lreCntErrWrongLanB, lreVersionName=lreVersionName, lreConfigurationInterfaces=lreConfigurationInterfaces, lreRemNodeType=lreRemNodeType, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreTimeLastSeenA=lreTimeLastSeenA, lreNodesTable=lreNodesTable, lreStatisticsInterfaces=lreStatisticsInterfaces, lreTransparentReception=lreTransparentReception, lreNodesIndex=lreNodesIndex, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntDuplicateB=lreCntDuplicateB, lreProxyNodeMacAddress=lreProxyNodeMacAddress, drp=drp, lreCntErrWrongLanA=lreCntErrWrongLanA, lreLinkStatusA=lreLinkStatusA, lreRedBoxIdentity=lreRedBoxIdentity, linkRedundancyCompliances=linkRedundancyCompliances, lreCntUniqueB=lreCntUniqueB, lreCntErrorsC=lreCntErrorsC, lreTimeLastSeenB=lreTimeLastSeenB, lreGroups=lreGroups, crp=crp, lreCntUniqueA=lreCntUniqueA, lreCntOwnRxB=lreCntOwnRxB, lreCntMultiB=lreCntMultiB, lreCntOwnRxA=lreCntOwnRxA, lreNodeName=lreNodeName, SecondFraction=SecondFraction, lreMacAddress=lreMacAddress, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntErrWrongLanC=lreCntErrWrongLanC, iec62439=iec62439, lreSwitchingEndNode=lreSwitchingEndNode, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntErrorsB=lreCntErrorsB, rrp=rrp, lreCntRxB=lreCntRxB, lreLinkStatusB=lreLinkStatusB, linkRedundancyConformance=linkRedundancyConformance, lreStatistics=lreStatistics, lreRowStatus=lreRowStatus, lreCntErrorsA=lreCntErrorsA, lreEvaluateSupervision=lreEvaluateSupervision, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreProxyNodeIndex=lreProxyNodeIndex, lreCntRxA=lreCntRxA, lreConfiguration=lreConfiguration, lreDupListResideMaxTime=lreDupListResideMaxTime, lreManufacturerName=lreManufacturerName, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreDuplicateDiscard=lreDuplicateDiscard, linkRedundancyEntityConformance=linkRedundancyEntityConformance, prp=prp, PYSNMP_MODULE_ID=iec62439, lreNodesTableClear=lreNodesTableClear, lreCntTxA=lreCntTxA, lreCntDuplicateC=lreCntDuplicateC, linkRedundancyCompliance=linkRedundancyCompliance, lreCntTxB=lreCntTxB, lreCntDuplicateA=lreCntDuplicateA, lreInterfaceConfigIndex=lreInterfaceConfigIndex)
