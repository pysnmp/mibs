...
Gauge32, iso, Integer32, ModuleIdentity, Counter64, NotificationType, MibIdentifier, Unsigned32, Counter32, IpAddress, ObjectIdentity, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "Integer32", "ModuleIdentity", "Counter64", "NotificationType", "MibIdentifier", "Unsigned32", "Counter32", "IpAddress", "ObjectIdentity", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreSwitchingEndNode=lreSwitchingEndNode, lreStatistics=lreStatistics, lreConfiguration=lreConfiguration, linkRedundancyConformance=linkRedundancyConformance, lreNodeType=lreNodeType, lreNodesEntry=lreNodesEntry, lreCntErrorsB=lreCntErrorsB, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreInterfaceCount=lreInterfaceCount, lreLinkStatusA=lreLinkStatusA, lreMacAddress=lreMacAddress, lreNodesMacAddress=lreNodesMacAddress, lrePortAdminStateA=lrePortAdminStateA, brp=brp, lreDuplicateDiscard=lreDuplicateDiscard, lreManufacturerName=lreManufacturerName, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntNodes=lreCntNodes, lreGroups=lreGroups, lreCntOwnRxB=lreCntOwnRxB, lreProxyNodeIndex=lreProxyNodeIndex, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreInterfaceStatsTable=lreInterfaceStatsTable, lreProxyNodeEntry=lreProxyNodeEntry, lreNodesTableClear=lreNodesTableClear, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntTxA=lreCntTxA, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntErrorsC=lreCntErrorsC, lreRowStatus=lreRowStatus, lreCntUniqueB=lreCntUniqueB, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntMultiC=lreCntMultiC, lreInterfaceStatsEntry=lreInterfaceStatsEntry, ptp=ptp, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreDefaultGrp=lreDefaultGrp, lreCntTxC=lreCntTxC, lreNodesIndex=lreNodesIndex, lreNodeName=lreNodeName, iec62439=iec62439, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreVersionName=lreVersionName, lreEvaluateSupervision=lreEvaluateSupervision, lreCntDuplicateC=lreCntDuplicateC, lreNodesTable=lreNodesTable, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntRxB=lreCntRxB, lreCntMultiA=lreCntMultiA, lreTransparentReception=lreTransparentReception, lreCntErrorsA=lreCntErrorsA, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntTxB=lreCntTxB, lreCntUniqueC=lreCntUniqueC, prp=prp, lreCntRxA=lreCntRxA, linkRedundancyCompliance=linkRedundancyCompliance, lreCntDuplicateA=lreCntDuplicateA, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntMultiB=lreCntMultiB, lrePortAdminStateB=lrePortAdminStateB, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntUniqueA=lreCntUniqueA, drp=drp, PYSNMP_MODULE_ID=iec62439, lreProxyNodeTable=lreProxyNodeTable, rrp=rrp, lreCntErrWrongLanC=lreCntErrWrongLanC, lreDupListResideMaxTime=lreDupListResideMaxTime, lreTimeLastSeenB=lreTimeLastSeenB, lreHsrLREMode=lreHsrLREMode, lreCntErrWrongLanA=lreCntErrWrongLanA, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreTimeLastSeenA=lreTimeLastSeenA, lreLinkStatusB=lreLinkStatusB, lreRedBoxIdentity=lreRedBoxIdentity, SecondFraction=SecondFraction, lreCntRxC=lreCntRxC, lreCntProxyNodes=lreCntProxyNodes, mrp=mrp, linkRedundancyCompliances=linkRedundancyCompliances, lreCntDuplicateB=lreCntDuplicateB, lreRemNodeType=lreRemNodeType, crp=crp, lreCntOwnRxA=lreCntOwnRxA)
