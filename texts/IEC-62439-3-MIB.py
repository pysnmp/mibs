...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Unsigned32, Bits, Counter64, IpAddress, MibIdentifier, iso, Gauge32, Counter32, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Unsigned32", "Bits", "Counter64", "IpAddress", "MibIdentifier", "iso", "Gauge32", "Counter32", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", rrp=rrp, lreStatistics=lreStatistics, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntErrorsC=lreCntErrorsC, lreNodeName=lreNodeName, lreCntDuplicateC=lreCntDuplicateC, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntDuplicateA=lreCntDuplicateA, lreCntRxA=lreCntRxA, lreCntUniqueB=lreCntUniqueB, lreCntMultiC=lreCntMultiC, lreCntRxC=lreCntRxC, lreProxyNodeIndex=lreProxyNodeIndex, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreProxyNodeTable=lreProxyNodeTable, lreProxyNodeEntry=lreProxyNodeEntry, drp=drp, lreNodesTable=lreNodesTable, ptp=ptp, mrp=mrp, linkRedundancyEntityConformance=linkRedundancyEntityConformance, linkRedundancyCompliances=linkRedundancyCompliances, lreGroups=lreGroups, lreDefaultGrp=lreDefaultGrp, SecondFraction=SecondFraction, lreCntOwnRxA=lreCntOwnRxA, lreCntNodes=lreCntNodes, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntRxB=lreCntRxB, lreInterfaceStatsTable=lreInterfaceStatsTable, lrePortAdminStateB=lrePortAdminStateB, lreRemNodeType=lreRemNodeType, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntDuplicateB=lreCntDuplicateB, lreDupListResideMaxTime=lreDupListResideMaxTime, lreInterfaceStatsEntry=lreInterfaceStatsEntry, iec62439=iec62439, lreCntErrorsB=lreCntErrorsB, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreMacAddress=lreMacAddress, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntTxC=lreCntTxC, lreEvaluateSupervision=lreEvaluateSupervision, prp=prp, lreCntUniqueA=lreCntUniqueA, lreSwitchingEndNode=lreSwitchingEndNode, crp=crp, lreDuplicateDiscard=lreDuplicateDiscard, lreCntErrWrongLanC=lreCntErrWrongLanC, PYSNMP_MODULE_ID=iec62439, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreNodesIndex=lreNodesIndex, lreTimeLastSeenA=lreTimeLastSeenA, lreConfigurationInterfaces=lreConfigurationInterfaces, lrePortAdminStateA=lrePortAdminStateA, lreCntTxA=lreCntTxA, lreNodeType=lreNodeType, lreConfiguration=lreConfiguration, lreStatisticsInterfaces=lreStatisticsInterfaces, lreManufacturerName=lreManufacturerName, lreVersionName=lreVersionName, linkRedundancyConformance=linkRedundancyConformance, lreRedBoxIdentity=lreRedBoxIdentity, lreTransparentReception=lreTransparentReception, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntOwnRxB=lreCntOwnRxB, lreLinkStatusA=lreLinkStatusA, lreCntMultiA=lreCntMultiA, lreCntProxyNodes=lreCntProxyNodes, lreCntUniqueC=lreCntUniqueC, lreTimeLastSeenB=lreTimeLastSeenB, lreInterfaceCount=lreInterfaceCount, lreLinkStatusB=lreLinkStatusB, lreCntErrorsA=lreCntErrorsA, lreRowStatus=lreRowStatus, lreNodesTableClear=lreNodesTableClear, lreHsrLREMode=lreHsrLREMode, lreNodesEntry=lreNodesEntry, lreProxyNodeTableClear=lreProxyNodeTableClear, lreNodesMacAddress=lreNodesMacAddress, lreCntMultiB=lreCntMultiB, lreCntTxB=lreCntTxB, linkRedundancyCompliance=linkRedundancyCompliance, lreInterfaceConfigTable=lreInterfaceConfigTable, brp=brp, lreProxyNodeMacAddress=lreProxyNodeMacAddress)
