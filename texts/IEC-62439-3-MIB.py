...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, ObjectIdentity, Bits, iso, NotificationType, ModuleIdentity, MibIdentifier, Gauge32, Integer32, Counter32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "ObjectIdentity", "Bits", "iso", "NotificationType", "ModuleIdentity", "MibIdentifier", "Gauge32", "Integer32", "Counter32", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntMultiA=lreCntMultiA, lreNodesTable=lreNodesTable, lreNodesMacAddress=lreNodesMacAddress, ptp=ptp, iec62439=iec62439, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreHsrLREMode=lreHsrLREMode, lreSwitchingEndNode=lreSwitchingEndNode, lreCntUniqueB=lreCntUniqueB, crp=crp, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreConfiguration=lreConfiguration, lreCntMultiC=lreCntMultiC, rrp=rrp, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntErrorsB=lreCntErrorsB, lreCntUniqueC=lreCntUniqueC, lreCntNodes=lreCntNodes, lreRowStatus=lreRowStatus, lreCntDuplicateC=lreCntDuplicateC, lreTimeLastSeenB=lreTimeLastSeenB, lreNodesEntry=lreNodesEntry, brp=brp, lreRemNodeType=lreRemNodeType, lreCntUniqueA=lreCntUniqueA, lreTimeLastSeenA=lreTimeLastSeenA, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntTxB=lreCntTxB, drp=drp, lreNodeName=lreNodeName, lreStatistics=lreStatistics, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreProxyNodeEntry=lreProxyNodeEntry, prp=prp, lreDuplicateDiscard=lreDuplicateDiscard, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntRxA=lreCntRxA, lreInterfaceCount=lreInterfaceCount, lreCntDuplicateB=lreCntDuplicateB, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreDefaultGrp=lreDefaultGrp, lreEvaluateSupervision=lreEvaluateSupervision, lreManufacturerName=lreManufacturerName, lreGroups=lreGroups, lreCntErrorsC=lreCntErrorsC, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntErrWrongLanC=lreCntErrWrongLanC, lreMacAddress=lreMacAddress, lreCntRxC=lreCntRxC, lreCntDuplicateA=lreCntDuplicateA, lreCntProxyNodes=lreCntProxyNodes, lreNodesIndex=lreNodesIndex, lreCntErrWrongLanA=lreCntErrWrongLanA, linkRedundancyCompliance=linkRedundancyCompliance, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreNodeType=lreNodeType, lreDupListResideMaxTime=lreDupListResideMaxTime, linkRedundancyConformance=linkRedundancyConformance, mrp=mrp, lreCntTxA=lreCntTxA, lreStatisticsInterfaces=lreStatisticsInterfaces, lrePortAdminStateA=lrePortAdminStateA, lreLinkStatusA=lreLinkStatusA, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceStatsTable=lreInterfaceStatsTable, lreRedBoxIdentity=lreRedBoxIdentity, lreCntRxB=lreCntRxB, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lrePortAdminStateB=lrePortAdminStateB, lreCntMultiB=lreCntMultiB, lreVersionName=lreVersionName, lreCntTxC=lreCntTxC, lreLinkStatusB=lreLinkStatusB, lreProxyNodeIndex=lreProxyNodeIndex, lreNodesTableClear=lreNodesTableClear, SecondFraction=SecondFraction, lreCntOwnRxA=lreCntOwnRxA, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntOwnRxB=lreCntOwnRxB, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreTransparentReception=lreTransparentReception, PYSNMP_MODULE_ID=iec62439, lreProxyNodeTableClear=lreProxyNodeTableClear, linkRedundancyCompliances=linkRedundancyCompliances, lreCntErrorsA=lreCntErrorsA)
