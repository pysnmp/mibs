...
Counter32, Integer32, ObjectIdentity, iso, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, Counter64, IpAddress, TimeTicks, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "ObjectIdentity", "iso", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "Counter64", "IpAddress", "TimeTicks", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntMultiA=lreCntMultiA, lrePortAdminStateA=lrePortAdminStateA, lreCntMultiB=lreCntMultiB, lreTimeLastSeenB=lreTimeLastSeenB, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntDuplicateB=lreCntDuplicateB, lreTransparentReception=lreTransparentReception, lrePortAdminStateB=lrePortAdminStateB, lreNodesMacAddress=lreNodesMacAddress, ptp=ptp, lreRedBoxIdentity=lreRedBoxIdentity, lreLinkStatusA=lreLinkStatusA, lreTimeLastSeenA=lreTimeLastSeenA, lreProxyNodeTableClear=lreProxyNodeTableClear, lreStatistics=lreStatistics, lreLinkStatusB=lreLinkStatusB, lreNodesTableClear=lreNodesTableClear, lreNodeType=lreNodeType, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, iec62439=iec62439, PYSNMP_MODULE_ID=iec62439, lreNodesEntry=lreNodesEntry, lreCntErrorsB=lreCntErrorsB, linkRedundancyCompliance=linkRedundancyCompliance, lreDuplicateDiscard=lreDuplicateDiscard, lreConfiguration=lreConfiguration, lreStatisticsInterfaces=lreStatisticsInterfaces, lreInterfaceStatsTable=lreInterfaceStatsTable, lreProxyNodeEntry=lreProxyNodeEntry, lreCntDuplicateA=lreCntDuplicateA, lreCntProxyNodes=lreCntProxyNodes, linkRedundancyCompliances=linkRedundancyCompliances, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreManufacturerName=lreManufacturerName, lreCntRxA=lreCntRxA, lreCntErrorsA=lreCntErrorsA, lreCntErrWrongLanC=lreCntErrWrongLanC, lreRemNodeType=lreRemNodeType, lreHsrLREMode=lreHsrLREMode, lreCntDuplicateC=lreCntDuplicateC, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntOwnRxB=lreCntOwnRxB, drp=drp, lreConfigurationInterfaces=lreConfigurationInterfaces, lreRowStatus=lreRowStatus, lreNodeName=lreNodeName, lreCntTxB=lreCntTxB, lreInterfaceConfigTable=lreInterfaceConfigTable, lreProxyNodeTable=lreProxyNodeTable, lreSwitchingEndNode=lreSwitchingEndNode, lreEvaluateSupervision=lreEvaluateSupervision, lreCntRxB=lreCntRxB, lreCntErrorsC=lreCntErrorsC, lreNodesIndex=lreNodesIndex, lreCntRxC=lreCntRxC, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreMacAddress=lreMacAddress, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntNodes=lreCntNodes, lreInterfaceStatsEntry=lreInterfaceStatsEntry, rrp=rrp, lreVersionName=lreVersionName, lreProxyNodeMacAddress=lreProxyNodeMacAddress, brp=brp, lreCntUniqueB=lreCntUniqueB, lreProxyNodeIndex=lreProxyNodeIndex, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, linkRedundancyConformance=linkRedundancyConformance, lreCntMultiC=lreCntMultiC, lreDefaultGrp=lreDefaultGrp, lreCntUniqueA=lreCntUniqueA, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, prp=prp, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreNodesTable=lreNodesTable, lreCntTxC=lreCntTxC, lreCntOwnRxA=lreCntOwnRxA, mrp=mrp, crp=crp, SecondFraction=SecondFraction, lreCntErrWrongLanB=lreCntErrWrongLanB, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreInterfaceCount=lreInterfaceCount, lreCntUniqueC=lreCntUniqueC, lreCntTxA=lreCntTxA, lreGroups=lreGroups)
