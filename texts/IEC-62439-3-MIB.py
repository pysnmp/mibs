...
MibIdentifier, Bits, Counter64, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, IpAddress, Counter32, TimeTicks, NotificationType, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Counter64", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Counter32", "TimeTicks", "NotificationType", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", rrp=rrp, lreCntRxA=lreCntRxA, linkRedundancyCompliances=linkRedundancyCompliances, lreCntTxB=lreCntTxB, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntErrorsB=lreCntErrorsB, lreProxyNodeEntry=lreProxyNodeEntry, lreCntDuplicateC=lreCntDuplicateC, brp=brp, lreRowStatus=lreRowStatus, lreCntDuplicateB=lreCntDuplicateB, lreCntOwnRxB=lreCntOwnRxB, lreCntErrorsC=lreCntErrorsC, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreDuplicateDiscard=lreDuplicateDiscard, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreManufacturerName=lreManufacturerName, lrePortAdminStateA=lrePortAdminStateA, drp=drp, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreStatisticsInterfaces=lreStatisticsInterfaces, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreProxyNodeTable=lreProxyNodeTable, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreStatistics=lreStatistics, crp=crp, lreCntUniqueC=lreCntUniqueC, lreCntUniqueB=lreCntUniqueB, lreConfigurationInterfaces=lreConfigurationInterfaces, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreVersionName=lreVersionName, lreLinkStatusA=lreLinkStatusA, lreCntMultiC=lreCntMultiC, linkRedundancyConformance=linkRedundancyConformance, ptp=ptp, lreNodesIndex=lreNodesIndex, lreHsrLREMode=lreHsrLREMode, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreConfiguration=lreConfiguration, lreNodeType=lreNodeType, lreCntOwnRxA=lreCntOwnRxA, lreInterfaceStatsTable=lreInterfaceStatsTable, lreTransparentReception=lreTransparentReception, lreCntMultiA=lreCntMultiA, lreRemNodeType=lreRemNodeType, lreTimeLastSeenB=lreTimeLastSeenB, lreLinkStatusB=lreLinkStatusB, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreDupListResideMaxTime=lreDupListResideMaxTime, linkRedundancyCompliance=linkRedundancyCompliance, lreTimeLastSeenA=lreTimeLastSeenA, lreCntErrWrongLanA=lreCntErrWrongLanA, SecondFraction=SecondFraction, lreProxyNodeTableClear=lreProxyNodeTableClear, lreProxyNodeIndex=lreProxyNodeIndex, lreCntTxC=lreCntTxC, lreCntRxC=lreCntRxC, lrePortAdminStateB=lrePortAdminStateB, lreCntDuplicateA=lreCntDuplicateA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreRedBoxIdentity=lreRedBoxIdentity, lreNodeName=lreNodeName, lreInterfaceConfigTable=lreInterfaceConfigTable, lreNodesTable=lreNodesTable, lreCntProxyNodes=lreCntProxyNodes, lreCntUniqueA=lreCntUniqueA, lreGroups=lreGroups, lreCntTxA=lreCntTxA, lreNodesMacAddress=lreNodesMacAddress, lreCntMultiB=lreCntMultiB, lreCntErrorsA=lreCntErrorsA, lreDefaultGrp=lreDefaultGrp, lreSwitchingEndNode=lreSwitchingEndNode, lreNodesTableClear=lreNodesTableClear, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreInterfaceCount=lreInterfaceCount, lreMacAddress=lreMacAddress, mrp=mrp, prp=prp, PYSNMP_MODULE_ID=iec62439, lreEvaluateSupervision=lreEvaluateSupervision, lreNodesEntry=lreNodesEntry, lreCntNodes=lreCntNodes, iec62439=iec62439, lreCntRxB=lreCntRxB, lreCntErrWrongLanC=lreCntErrWrongLanC)
