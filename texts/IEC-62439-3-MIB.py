...
ObjectIdentity, IpAddress, Counter64, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, MibIdentifier, Gauge32, iso, Bits, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Counter64", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "MibIdentifier", "Gauge32", "iso", "Bits", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntMultiA=lreCntMultiA, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntErrWrongLanB=lreCntErrWrongLanB, SecondFraction=SecondFraction, lreCntDuplicateC=lreCntDuplicateC, lreLinkStatusA=lreLinkStatusA, drp=drp, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreDuplicateDiscard=lreDuplicateDiscard, lreNodesIndex=lreNodesIndex, iec62439=iec62439, lreGroups=lreGroups, linkRedundancyCompliances=linkRedundancyCompliances, lreCntUniqueC=lreCntUniqueC, lreMacAddress=lreMacAddress, rrp=rrp, lreProxyNodeIndex=lreProxyNodeIndex, lreCntRxA=lreCntRxA, lreInterfaceStatsEntry=lreInterfaceStatsEntry, crp=crp, lrePortAdminStateA=lrePortAdminStateA, lreConfigurationInterfaces=lreConfigurationInterfaces, lreRedBoxIdentity=lreRedBoxIdentity, lreEvaluateSupervision=lreEvaluateSupervision, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lrePortAdminStateB=lrePortAdminStateB, lreTimeLastSeenA=lreTimeLastSeenA, linkRedundancyCompliance=linkRedundancyCompliance, lreNodesMacAddress=lreNodesMacAddress, lreCntTxA=lreCntTxA, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntMultiB=lreCntMultiB, lreCntDuplicateB=lreCntDuplicateB, lreCntRxC=lreCntRxC, lreNodeName=lreNodeName, lreCntOwnRxA=lreCntOwnRxA, ptp=ptp, lreCntTxC=lreCntTxC, lreProxyNodeTable=lreProxyNodeTable, lreCntErrorsB=lreCntErrorsB, lreInterfaceStatsTable=lreInterfaceStatsTable, lreManufacturerName=lreManufacturerName, lreCntUniqueA=lreCntUniqueA, lreLinkStatusB=lreLinkStatusB, lreCntProxyNodes=lreCntProxyNodes, lreSwitchingEndNode=lreSwitchingEndNode, lreInterfaceConfigTable=lreInterfaceConfigTable, lreInterfaceConfigEntry=lreInterfaceConfigEntry, mrp=mrp, PYSNMP_MODULE_ID=iec62439, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreRemNodeType=lreRemNodeType, lreDefaultGrp=lreDefaultGrp, lreDupListResideMaxTime=lreDupListResideMaxTime, prp=prp, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreInterfaceCount=lreInterfaceCount, lreTransparentReception=lreTransparentReception, lreCntMultiC=lreCntMultiC, lreProxyNodeEntry=lreProxyNodeEntry, lreCntErrorsC=lreCntErrorsC, lreCntUniqueB=lreCntUniqueB, lreProxyNodeTableClear=lreProxyNodeTableClear, linkRedundancyConformance=linkRedundancyConformance, lreConfiguration=lreConfiguration, brp=brp, lreNodesTableClear=lreNodesTableClear, lreCntNodes=lreCntNodes, lreCntRxB=lreCntRxB, lreVersionName=lreVersionName, lreNodesEntry=lreNodesEntry, lreCntTxB=lreCntTxB, lreNodeType=lreNodeType, lreRowStatus=lreRowStatus, lreCntOwnRxB=lreCntOwnRxB, lreStatistics=lreStatistics, lreCntErrorsA=lreCntErrorsA, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntDuplicateA=lreCntDuplicateA, lreHsrLREMode=lreHsrLREMode, lreNodesTable=lreNodesTable, lreCntErrWrongLanA=lreCntErrWrongLanA, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreTimeLastSeenB=lreTimeLastSeenB)
