...
iso, TimeTicks, Counter64, Integer32, Bits, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, IpAddress, Gauge32, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Counter64", "Integer32", "Bits", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "IpAddress", "Gauge32", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntErrorsA=lreCntErrorsA, lreCntUniqueC=lreCntUniqueC, lreConfiguration=lreConfiguration, lreProxyNodeEntry=lreProxyNodeEntry, lreProxyNodeTableClear=lreProxyNodeTableClear, lreNodesEntry=lreNodesEntry, drp=drp, prp=prp, lreProxyNodeIndex=lreProxyNodeIndex, lreInterfaceStatsTable=lreInterfaceStatsTable, mrp=mrp, linkRedundancyCompliance=linkRedundancyCompliance, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntRxC=lreCntRxC, lreCntUniqueA=lreCntUniqueA, lreTransparentReception=lreTransparentReception, iec62439=iec62439, lreNodesTable=lreNodesTable, lreCntDuplicateC=lreCntDuplicateC, lreCntProxyNodes=lreCntProxyNodes, lreNodesTableClear=lreNodesTableClear, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreDefaultGrp=lreDefaultGrp, lreCntDuplicateB=lreCntDuplicateB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, brp=brp, lreNodesIndex=lreNodesIndex, lreCntTxB=lreCntTxB, lreNodeType=lreNodeType, rrp=rrp, lreStatistics=lreStatistics, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntOwnRxA=lreCntOwnRxA, lreCntMultiB=lreCntMultiB, lreCntTxA=lreCntTxA, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntUniqueB=lreCntUniqueB, lreLinkStatusA=lreLinkStatusA, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreInterfaceCount=lreInterfaceCount, ptp=ptp, lreCntRxB=lreCntRxB, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreTimeLastSeenA=lreTimeLastSeenA, linkRedundancyCompliances=linkRedundancyCompliances, linkRedundancyConformance=linkRedundancyConformance, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreVersionName=lreVersionName, lreRedBoxIdentity=lreRedBoxIdentity, SecondFraction=SecondFraction, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntErrWrongLanC=lreCntErrWrongLanC, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntRxA=lreCntRxA, lreEvaluateSupervision=lreEvaluateSupervision, lreInterfaceConfigTable=lreInterfaceConfigTable, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, crp=crp, lreCntNodes=lreCntNodes, lreCntMultiC=lreCntMultiC, lreTimeLastSeenB=lreTimeLastSeenB, lreCntMultiA=lreCntMultiA, lreManufacturerName=lreManufacturerName, lrePortAdminStateB=lrePortAdminStateB, lreCntErrorsC=lreCntErrorsC, lreProxyNodeTable=lreProxyNodeTable, lreRowStatus=lreRowStatus, lreCntErrorsB=lreCntErrorsB, lreCntDuplicateA=lreCntDuplicateA, lreCntOwnRxB=lreCntOwnRxB, lreRemNodeType=lreRemNodeType, lreDuplicateDiscard=lreDuplicateDiscard, lreCntErrWrongLanB=lreCntErrWrongLanB, PYSNMP_MODULE_ID=iec62439, lrePortAdminStateA=lrePortAdminStateA, lreHsrLREMode=lreHsrLREMode, lreDupListResideMaxTime=lreDupListResideMaxTime, lreGroups=lreGroups, lreMacAddress=lreMacAddress, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreConfigurationInterfaces=lreConfigurationInterfaces, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreNodeName=lreNodeName, lreCntTxC=lreCntTxC, lreLinkStatusB=lreLinkStatusB, lreSwitchingEndNode=lreSwitchingEndNode, lreNodesMacAddress=lreNodesMacAddress)
