...
Bits, IpAddress, Gauge32, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, ModuleIdentity, Integer32, TimeTicks, iso, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Gauge32", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "ModuleIdentity", "Integer32", "TimeTicks", "iso", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreMacAddress=lreMacAddress, lreHsrLREMode=lreHsrLREMode, lreNodesMacAddress=lreNodesMacAddress, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreProxyNodeTableClear=lreProxyNodeTableClear, lreManufacturerName=lreManufacturerName, drp=drp, lreVersionName=lreVersionName, lreEvaluateSupervision=lreEvaluateSupervision, lreCntMultiA=lreCntMultiA, lreCntOwnRxB=lreCntOwnRxB, linkRedundancyCompliance=linkRedundancyCompliance, prp=prp, lreNodeType=lreNodeType, lreCntMultiC=lreCntMultiC, linkRedundancyCompliances=linkRedundancyCompliances, lreCntTxA=lreCntTxA, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntDuplicateC=lreCntDuplicateC, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntOwnRxA=lreCntOwnRxA, lreProxyNodeEntry=lreProxyNodeEntry, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntRxA=lreCntRxA, lreNodesTableClear=lreNodesTableClear, lreCntErrorsC=lreCntErrorsC, lreRowStatus=lreRowStatus, lreCntErrWrongLanA=lreCntErrWrongLanA, crp=crp, PYSNMP_MODULE_ID=iec62439, lreNodesEntry=lreNodesEntry, lreInterfaceCount=lreInterfaceCount, lreSwitchingEndNode=lreSwitchingEndNode, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntUniqueB=lreCntUniqueB, ptp=ptp, brp=brp, lrePortAdminStateA=lrePortAdminStateA, lreTimeLastSeenB=lreTimeLastSeenB, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreProxyNodeIndex=lreProxyNodeIndex, lreStatistics=lreStatistics, lreLinkStatusA=lreLinkStatusA, lreDuplicateDiscard=lreDuplicateDiscard, lreTransparentReception=lreTransparentReception, lreStatisticsInterfaces=lreStatisticsInterfaces, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntTxB=lreCntTxB, lreCntRxB=lreCntRxB, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, SecondFraction=SecondFraction, lreCntMultiB=lreCntMultiB, lreRedBoxIdentity=lreRedBoxIdentity, lrePortAdminStateB=lrePortAdminStateB, rrp=rrp, lreCntNodes=lreCntNodes, lreCntErrorsA=lreCntErrorsA, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceConfigTable=lreInterfaceConfigTable, iec62439=iec62439, lreCntUniqueA=lreCntUniqueA, mrp=mrp, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntTxC=lreCntTxC, lreCntProxyNodes=lreCntProxyNodes, lreTimeLastSeenA=lreTimeLastSeenA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntErrorsB=lreCntErrorsB, linkRedundancyConformance=linkRedundancyConformance, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreGroups=lreGroups, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntUniqueC=lreCntUniqueC, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntDuplicateB=lreCntDuplicateB, lreLinkStatusB=lreLinkStatusB, lreCntDuplicateA=lreCntDuplicateA, lreDefaultGrp=lreDefaultGrp, lreNodesIndex=lreNodesIndex, lreConfiguration=lreConfiguration, lreNodeName=lreNodeName, lreCntRxC=lreCntRxC, lreInterfaceStatsTable=lreInterfaceStatsTable, lreRemNodeType=lreRemNodeType, lreNodesTable=lreNodesTable)
