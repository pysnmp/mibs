...
Counter64, Unsigned32, Bits, Gauge32, ObjectIdentity, IpAddress, MibIdentifier, ModuleIdentity, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "Bits", "Gauge32", "ObjectIdentity", "IpAddress", "MibIdentifier", "ModuleIdentity", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Integer32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntTxA=lreCntTxA, lreCntErrorsA=lreCntErrorsA, lreGroups=lreGroups, lreDefaultGrp=lreDefaultGrp, lreCntMultiC=lreCntMultiC, prp=prp, mrp=mrp, lreNodesMacAddress=lreNodesMacAddress, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreTimeLastSeenB=lreTimeLastSeenB, lreProxyNodeTable=lreProxyNodeTable, lreSwitchingEndNode=lreSwitchingEndNode, lreCntErrWrongLanB=lreCntErrWrongLanB, lreRemNodeType=lreRemNodeType, lreEvaluateSupervision=lreEvaluateSupervision, lreCntDuplicateC=lreCntDuplicateC, lreNodesIndex=lreNodesIndex, linkRedundancyEntityConformance=linkRedundancyEntityConformance, linkRedundancyCompliance=linkRedundancyCompliance, lreCntRxB=lreCntRxB, lreCntUniqueC=lreCntUniqueC, lrePortAdminStateB=lrePortAdminStateB, rrp=rrp, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreConfiguration=lreConfiguration, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreManufacturerName=lreManufacturerName, lreDupListResideMaxTime=lreDupListResideMaxTime, iec62439=iec62439, crp=crp, linkRedundancyConformance=linkRedundancyConformance, lreProxyNodeTableClear=lreProxyNodeTableClear, lreMacAddress=lreMacAddress, lreCntTxB=lreCntTxB, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntUniqueB=lreCntUniqueB, lreLinkStatusA=lreLinkStatusA, lreCntErrWrongLanC=lreCntErrWrongLanC, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntDuplicateA=lreCntDuplicateA, linkRedundancyCompliances=linkRedundancyCompliances, drp=drp, lreTimeLastSeenA=lreTimeLastSeenA, lreProxyNodeEntry=lreProxyNodeEntry, lreCntRxC=lreCntRxC, SecondFraction=SecondFraction, lreInterfaceCount=lreInterfaceCount, lreRowStatus=lreRowStatus, lreCntNodes=lreCntNodes, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreNodeName=lreNodeName, lreInterfaceConfigTable=lreInterfaceConfigTable, lreTransparentReception=lreTransparentReception, lreCntDuplicateB=lreCntDuplicateB, lreCntErrorsC=lreCntErrorsC, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreProxyNodeIndex=lreProxyNodeIndex, lreCntMultiA=lreCntMultiA, lreNodesTableClear=lreNodesTableClear, ptp=ptp, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntTxC=lreCntTxC, lreDuplicateDiscard=lreDuplicateDiscard, lreHsrLREMode=lreHsrLREMode, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntOwnRxA=lreCntOwnRxA, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntProxyNodes=lreCntProxyNodes, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntOwnRxB=lreCntOwnRxB, lreNodesEntry=lreNodesEntry, lreCntErrorsB=lreCntErrorsB, lreVersionName=lreVersionName, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreNodesTable=lreNodesTable, lreNodeType=lreNodeType, lrePortAdminStateA=lrePortAdminStateA, brp=brp, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntMultiB=lreCntMultiB, lreRedBoxIdentity=lreRedBoxIdentity, lreCntUniqueA=lreCntUniqueA, lreCntRxA=lreCntRxA, PYSNMP_MODULE_ID=iec62439, lreStatistics=lreStatistics, lreLinkStatusB=lreLinkStatusB, lreInterfaceStatsIndex=lreInterfaceStatsIndex)
