...
iso, ObjectIdentity, Integer32, ModuleIdentity, Unsigned32, Counter64, IpAddress, Bits, NotificationType, Gauge32, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Integer32", "ModuleIdentity", "Unsigned32", "Counter64", "IpAddress", "Bits", "NotificationType", "Gauge32", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreInterfaceCount=lreInterfaceCount, lreCntErrWrongLanA=lreCntErrWrongLanA, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreInterfaceStatsTable=lreInterfaceStatsTable, lreNodeName=lreNodeName, lreCntUniqueA=lreCntUniqueA, lreRowStatus=lreRowStatus, lreCntRxC=lreCntRxC, lreCntTxC=lreCntTxC, lreVersionName=lreVersionName, lreNodesMacAddress=lreNodesMacAddress, lreRedBoxIdentity=lreRedBoxIdentity, lreConfigurationInterfaces=lreConfigurationInterfaces, lreSwitchingEndNode=lreSwitchingEndNode, lreCntTxA=lreCntTxA, lreInterfaceConfigTable=lreInterfaceConfigTable, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreDuplicateDiscard=lreDuplicateDiscard, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreNodesIndex=lreNodesIndex, lreCntDuplicateA=lreCntDuplicateA, lreCntTxB=lreCntTxB, lreCntErrWrongLanC=lreCntErrWrongLanC, lreNodesEntry=lreNodesEntry, lreProxyNodeTable=lreProxyNodeTable, lreCntProxyNodes=lreCntProxyNodes, lreCntRxB=lreCntRxB, lreTimeLastSeenA=lreTimeLastSeenA, lreStatisticsInterfaces=lreStatisticsInterfaces, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreStatistics=lreStatistics, lreHsrLREMode=lreHsrLREMode, crp=crp, lrePortAdminStateA=lrePortAdminStateA, lreDefaultGrp=lreDefaultGrp, lreRemNodeType=lreRemNodeType, SecondFraction=SecondFraction, lreGroups=lreGroups, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreTimeLastSeenB=lreTimeLastSeenB, lreNodesTableClear=lreNodesTableClear, lreCntErrorsC=lreCntErrorsC, lreCntDuplicateC=lreCntDuplicateC, lreCntMultiB=lreCntMultiB, lreNodeType=lreNodeType, lreCntUniqueB=lreCntUniqueB, lreProxyNodeEntry=lreProxyNodeEntry, lreConfiguration=lreConfiguration, lreCntMultiC=lreCntMultiC, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntMultiA=lreCntMultiA, lreCntErrorsB=lreCntErrorsB, lreEvaluateSupervision=lreEvaluateSupervision, lreCntNodes=lreCntNodes, lreCntUniqueC=lreCntUniqueC, lreLinkStatusB=lreLinkStatusB, lreProxyNodeTableClear=lreProxyNodeTableClear, linkRedundancyConformance=linkRedundancyConformance, prp=prp, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, linkRedundancyCompliances=linkRedundancyCompliances, lreCntRxA=lreCntRxA, lreCntErrorsA=lreCntErrorsA, lreCntOwnRxA=lreCntOwnRxA, drp=drp, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreManufacturerName=lreManufacturerName, linkRedundancyCompliance=linkRedundancyCompliance, rrp=rrp, lrePortAdminStateB=lrePortAdminStateB, lreProxyNodeIndex=lreProxyNodeIndex, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreTransparentReception=lreTransparentReception, ptp=ptp, lreCntDuplicateB=lreCntDuplicateB, mrp=mrp, iec62439=iec62439, lreDupListResideMaxTime=lreDupListResideMaxTime, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreNodesTable=lreNodesTable, lreLinkStatusA=lreLinkStatusA, lreMacAddress=lreMacAddress, lreCntOwnRxB=lreCntOwnRxB, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreInterfaceStatsIndex=lreInterfaceStatsIndex, brp=brp, PYSNMP_MODULE_ID=iec62439)
