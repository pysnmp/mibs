...
Integer32, NotificationType, Counter32, Counter64, Gauge32, TimeTicks, IpAddress, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter32", "Counter64", "Gauge32", "TimeTicks", "IpAddress", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreMacAddress=lreMacAddress, rrp=rrp, lreCntMultiA=lreCntMultiA, lreNodesTableClear=lreNodesTableClear, lreCntErrWrongLanA=lreCntErrWrongLanA, lreTimeLastSeenA=lreTimeLastSeenA, lreDupListResideMaxTime=lreDupListResideMaxTime, lreProxyNodeEntry=lreProxyNodeEntry, lreNodesTable=lreNodesTable, iec62439=iec62439, lreTimeLastSeenB=lreTimeLastSeenB, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntErrorsB=lreCntErrorsB, lreLinkStatusA=lreLinkStatusA, lreCntTxA=lreCntTxA, lrePortAdminStateA=lrePortAdminStateA, lreRowStatus=lreRowStatus, linkRedundancyCompliance=linkRedundancyCompliance, lrePortAdminStateB=lrePortAdminStateB, SecondFraction=SecondFraction, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntRxB=lreCntRxB, lreNodesEntry=lreNodesEntry, lreTransparentReception=lreTransparentReception, lreProxyNodeTable=lreProxyNodeTable, lreDuplicateDiscard=lreDuplicateDiscard, lreGroups=lreGroups, lreCntUniqueB=lreCntUniqueB, PYSNMP_MODULE_ID=iec62439, lreCntErrorsA=lreCntErrorsA, brp=brp, lreNodesMacAddress=lreNodesMacAddress, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreDefaultGrp=lreDefaultGrp, lreRemNodeType=lreRemNodeType, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntMultiB=lreCntMultiB, lreCntOwnRxB=lreCntOwnRxB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntUniqueC=lreCntUniqueC, lreCntErrorsC=lreCntErrorsC, lreCntRxA=lreCntRxA, lreCntTxC=lreCntTxC, lreCntRxC=lreCntRxC, prp=prp, ptp=ptp, lreProxyNodeIndex=lreProxyNodeIndex, lreCntDuplicateA=lreCntDuplicateA, lreStatistics=lreStatistics, linkRedundancyCompliances=linkRedundancyCompliances, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreConfigurationInterfaces=lreConfigurationInterfaces, lreManufacturerName=lreManufacturerName, lreEvaluateSupervision=lreEvaluateSupervision, lreCntDuplicateC=lreCntDuplicateC, lreCntNodes=lreCntNodes, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntDuplicateB=lreCntDuplicateB, lreSwitchingEndNode=lreSwitchingEndNode, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntTxB=lreCntTxB, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreNodesIndex=lreNodesIndex, lreVersionName=lreVersionName, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreProxyNodeTableClear=lreProxyNodeTableClear, lreInterfaceCount=lreInterfaceCount, lreCntErrWrongLanB=lreCntErrWrongLanB, linkRedundancyConformance=linkRedundancyConformance, lreCntProxyNodes=lreCntProxyNodes, crp=crp, lreNodeName=lreNodeName, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntOwnRxA=lreCntOwnRxA, drp=drp, lreRedBoxIdentity=lreRedBoxIdentity, lreInterfaceConfigTable=lreInterfaceConfigTable, mrp=mrp, lreConfiguration=lreConfiguration, lreCntUniqueA=lreCntUniqueA, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreHsrLREMode=lreHsrLREMode, lreInterfaceStatsTable=lreInterfaceStatsTable, lreLinkStatusB=lreLinkStatusB, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntMultiC=lreCntMultiC, lreNodeType=lreNodeType)
