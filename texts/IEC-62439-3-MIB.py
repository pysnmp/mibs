...
Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, TimeTicks, NotificationType, IpAddress, Unsigned32, Counter32, Gauge32, iso, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "TimeTicks", "NotificationType", "IpAddress", "Unsigned32", "Counter32", "Gauge32", "iso", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", linkRedundancyCompliance=linkRedundancyCompliance, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntDuplicateB=lreCntDuplicateB, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreManufacturerName=lreManufacturerName, lreCntRxB=lreCntRxB, lreProxyNodeEntry=lreProxyNodeEntry, mrp=mrp, lreStatistics=lreStatistics, lreCntDuplicateA=lreCntDuplicateA, lreCntUniqueA=lreCntUniqueA, lreHsrLREMode=lreHsrLREMode, lreNodesIndex=lreNodesIndex, lreRemNodeType=lreRemNodeType, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntErrWrongLanC=lreCntErrWrongLanC, lreNodesTable=lreNodesTable, lreCntTxB=lreCntTxB, lreCntUniqueC=lreCntUniqueC, lreProxyNodeIndex=lreProxyNodeIndex, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreRedBoxIdentity=lreRedBoxIdentity, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntErrorsB=lreCntErrorsB, lreTimeLastSeenB=lreTimeLastSeenB, lreCntDuplicateC=lreCntDuplicateC, lreTimeLastSeenA=lreTimeLastSeenA, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntMultiA=lreCntMultiA, lreEvaluateSupervision=lreEvaluateSupervision, lrePortAdminStateB=lrePortAdminStateB, ptp=ptp, lreNodesEntry=lreNodesEntry, lreVersionName=lreVersionName, lreNodesMacAddress=lreNodesMacAddress, crp=crp, rrp=rrp, lreCntUniqueB=lreCntUniqueB, lreNodeName=lreNodeName, lreCntRxA=lreCntRxA, PYSNMP_MODULE_ID=iec62439, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntErrorsC=lreCntErrorsC, iec62439=iec62439, lreLinkStatusB=lreLinkStatusB, lreCntProxyNodes=lreCntProxyNodes, lreRowStatus=lreRowStatus, lreCntErrWrongLanA=lreCntErrWrongLanA, linkRedundancyCompliances=linkRedundancyCompliances, lreCntMultiC=lreCntMultiC, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntErrorsA=lreCntErrorsA, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntOwnRxB=lreCntOwnRxB, lreSwitchingEndNode=lreSwitchingEndNode, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreProxyNodeTableClear=lreProxyNodeTableClear, lreLinkStatusA=lreLinkStatusA, lreInterfaceConfigTable=lreInterfaceConfigTable, lreDefaultGrp=lreDefaultGrp, lreProxyNodeTable=lreProxyNodeTable, lreCntRxC=lreCntRxC, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreDuplicateDiscard=lreDuplicateDiscard, lreTransparentReception=lreTransparentReception, linkRedundancyConformance=linkRedundancyConformance, prp=prp, SecondFraction=SecondFraction, lreConfigurationInterfaces=lreConfigurationInterfaces, lreConfiguration=lreConfiguration, brp=brp, lreMacAddress=lreMacAddress, lreNodesTableClear=lreNodesTableClear, lreCntNodes=lreCntNodes, lreCntTxC=lreCntTxC, lreNodeType=lreNodeType, lreCntMultiB=lreCntMultiB, drp=drp, lreInterfaceCount=lreInterfaceCount, lreCntTxA=lreCntTxA, lreStatisticsInterfaces=lreStatisticsInterfaces, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreGroups=lreGroups, lreCntOwnRxA=lreCntOwnRxA, lrePortAdminStateA=lrePortAdminStateA, lreInterfaceStatsEntry=lreInterfaceStatsEntry)
