...
Counter32, ObjectIdentity, Unsigned32, TimeTicks, NotificationType, iso, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Bits, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "Unsigned32", "TimeTicks", "NotificationType", "iso", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Bits", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntRxB=lreCntRxB, brp=brp, lreCntProxyNodes=lreCntProxyNodes, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreNodeName=lreNodeName, lreNodesMacAddress=lreNodesMacAddress, lreSwitchingEndNode=lreSwitchingEndNode, linkRedundancyCompliances=linkRedundancyCompliances, lreCntDuplicateA=lreCntDuplicateA, lreCntOwnRxA=lreCntOwnRxA, lreStatistics=lreStatistics, lreCntMultiC=lreCntMultiC, iec62439=iec62439, lreLinkStatusA=lreLinkStatusA, lreCntUniqueC=lreCntUniqueC, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreNodesEntry=lreNodesEntry, lreProxyNodeMacAddress=lreProxyNodeMacAddress, SecondFraction=SecondFraction, lreRedBoxIdentity=lreRedBoxIdentity, lreProxyNodeTable=lreProxyNodeTable, lreCntUniqueB=lreCntUniqueB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreLinkStatusB=lreLinkStatusB, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreTransparentReception=lreTransparentReception, lreCntMultiB=lreCntMultiB, lrePortAdminStateB=lrePortAdminStateB, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntTxC=lreCntTxC, lreInterfaceCount=lreInterfaceCount, lreCntRxA=lreCntRxA, linkRedundancyConformance=linkRedundancyConformance, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntMultiA=lreCntMultiA, lreCntDuplicateC=lreCntDuplicateC, lreCntTxB=lreCntTxB, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreInterfaceConfigTable=lreInterfaceConfigTable, lrePortAdminStateA=lrePortAdminStateA, lreCntTxA=lreCntTxA, lreNodesIndex=lreNodesIndex, lreCntErrWrongLanA=lreCntErrWrongLanA, lreGroups=lreGroups, lreRowStatus=lreRowStatus, lreDupListResideMaxTime=lreDupListResideMaxTime, lreInterfaceStatsTable=lreInterfaceStatsTable, mrp=mrp, lreRemNodeType=lreRemNodeType, lreMacAddress=lreMacAddress, lreVersionName=lreVersionName, lreConfigurationInterfaces=lreConfigurationInterfaces, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntErrorsA=lreCntErrorsA, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntDuplicateB=lreCntDuplicateB, lreTimeLastSeenA=lreTimeLastSeenA, lreCntUniqueA=lreCntUniqueA, lreProxyNodeTableClear=lreProxyNodeTableClear, drp=drp, lreTimeLastSeenB=lreTimeLastSeenB, linkRedundancyCompliance=linkRedundancyCompliance, lreEvaluateSupervision=lreEvaluateSupervision, lreCntRxC=lreCntRxC, lreNodeType=lreNodeType, lreCntNodes=lreCntNodes, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntErrorsB=lreCntErrorsB, lreProxyNodeEntry=lreProxyNodeEntry, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntErrorsC=lreCntErrorsC, lreCntOwnRxB=lreCntOwnRxB, crp=crp, lreCntErrWrongLanB=lreCntErrWrongLanB, lreNodesTableClear=lreNodesTableClear, lreProxyNodeIndex=lreProxyNodeIndex, lreHsrLREMode=lreHsrLREMode, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreNodesTable=lreNodesTable, prp=prp, rrp=rrp, lreManufacturerName=lreManufacturerName, lreDuplicateDiscard=lreDuplicateDiscard, ptp=ptp, lreDefaultGrp=lreDefaultGrp, PYSNMP_MODULE_ID=iec62439, lreConfiguration=lreConfiguration)
