...
iso, TimeTicks, Counter64, IpAddress, Bits, NotificationType, Gauge32, MibIdentifier, Unsigned32, Counter32, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Counter64", "IpAddress", "Bits", "NotificationType", "Gauge32", "MibIdentifier", "Unsigned32", "Counter32", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lrePortAdminStateB=lrePortAdminStateB, lreProxyNodeTableClear=lreProxyNodeTableClear, lreHsrLREMode=lreHsrLREMode, lreCntRxA=lreCntRxA, lreDefaultGrp=lreDefaultGrp, lreCntErrorsB=lreCntErrorsB, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreNodeName=lreNodeName, lreCntMultiC=lreCntMultiC, SecondFraction=SecondFraction, ptp=ptp, lreRowStatus=lreRowStatus, lreCntTxA=lreCntTxA, lreCntRxB=lreCntRxB, lreLinkStatusB=lreLinkStatusB, lreCntErrorsA=lreCntErrorsA, linkRedundancyConformance=linkRedundancyConformance, lreStatistics=lreStatistics, lrePortAdminStateA=lrePortAdminStateA, lreRemNodeType=lreRemNodeType, lreDupListResideMaxTime=lreDupListResideMaxTime, mrp=mrp, lreCntErrWrongLanC=lreCntErrWrongLanC, lreMacAddress=lreMacAddress, lreLinkStatusA=lreLinkStatusA, lreProxyNodeTable=lreProxyNodeTable, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntMultiA=lreCntMultiA, rrp=rrp, lreStatisticsInterfaces=lreStatisticsInterfaces, drp=drp, lreCntErrWrongLanA=lreCntErrWrongLanA, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreProxyNodeEntry=lreProxyNodeEntry, PYSNMP_MODULE_ID=iec62439, lreNodesEntry=lreNodesEntry, lreTimeLastSeenA=lreTimeLastSeenA, lreCntOwnRxB=lreCntOwnRxB, lreCntDuplicateB=lreCntDuplicateB, lreCntProxyNodes=lreCntProxyNodes, lreInterfaceStatsTable=lreInterfaceStatsTable, lreEvaluateSupervision=lreEvaluateSupervision, lreCntDuplicateA=lreCntDuplicateA, lreVersionName=lreVersionName, lreTransparentReception=lreTransparentReception, lreNodeType=lreNodeType, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreProxyNodeIndex=lreProxyNodeIndex, lreInterfaceCount=lreInterfaceCount, lreCntRxC=lreCntRxC, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntErrorsC=lreCntErrorsC, lreCntDuplicateC=lreCntDuplicateC, prp=prp, lreManufacturerName=lreManufacturerName, lreCntUniqueA=lreCntUniqueA, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntUniqueB=lreCntUniqueB, lreGroups=lreGroups, lreTimeLastSeenB=lreTimeLastSeenB, lreSwitchingEndNode=lreSwitchingEndNode, crp=crp, lreCntNodes=lreCntNodes, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, linkRedundancyCompliance=linkRedundancyCompliance, lreCntTxC=lreCntTxC, lreDuplicateDiscard=lreDuplicateDiscard, lreNodesTable=lreNodesTable, lreCntMultiB=lreCntMultiB, lreCntUniqueC=lreCntUniqueC, lreCntOwnRxA=lreCntOwnRxA, lreConfigurationInterfaces=lreConfigurationInterfaces, lreInterfaceConfigTable=lreInterfaceConfigTable, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreNodesMacAddress=lreNodesMacAddress, brp=brp, lreRedBoxIdentity=lreRedBoxIdentity, lreNodesTableClear=lreNodesTableClear, lreCntTxB=lreCntTxB, lreNodesIndex=lreNodesIndex, iec62439=iec62439, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntErrWrongLanB=lreCntErrWrongLanB, linkRedundancyCompliances=linkRedundancyCompliances, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreConfiguration=lreConfiguration)
