...
NotificationType, IpAddress, Counter64, Unsigned32, Counter32, Gauge32, iso, Integer32, Bits, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Counter64", "Unsigned32", "Counter32", "Gauge32", "iso", "Integer32", "Bits", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreDuplicateDiscard=lreDuplicateDiscard, lreProxyNodeTableClear=lreProxyNodeTableClear, lreMacAddress=lreMacAddress, lreCntOwnRxB=lreCntOwnRxB, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntDuplicateC=lreCntDuplicateC, lreConfiguration=lreConfiguration, lreProxyNodeTable=lreProxyNodeTable, lreCntErrWrongLanA=lreCntErrWrongLanA, lreEvaluateSupervision=lreEvaluateSupervision, lreCntErrorsB=lreCntErrorsB, lrePortAdminStateA=lrePortAdminStateA, lreInterfaceStatsTable=lreInterfaceStatsTable, lreRowStatus=lreRowStatus, linkRedundancyConformance=linkRedundancyConformance, SecondFraction=SecondFraction, lreCntErrorsA=lreCntErrorsA, lreDefaultGrp=lreDefaultGrp, lreCntNodes=lreCntNodes, ptp=ptp, lreCntRxA=lreCntRxA, lreTimeLastSeenB=lreTimeLastSeenB, linkRedundancyEntityConformance=linkRedundancyEntityConformance, linkRedundancyEntityObjects=linkRedundancyEntityObjects, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, crp=crp, lreSwitchingEndNode=lreSwitchingEndNode, lreCntMultiB=lreCntMultiB, lreCntProxyNodes=lreCntProxyNodes, lreCntRxB=lreCntRxB, lreCntUniqueC=lreCntUniqueC, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntOwnRxA=lreCntOwnRxA, lreCntUniqueB=lreCntUniqueB, lreCntErrorsC=lreCntErrorsC, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreNodesTable=lreNodesTable, iec62439=iec62439, mrp=mrp, lreTimeLastSeenA=lreTimeLastSeenA, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreNodesTableClear=lreNodesTableClear, lreCntTxA=lreCntTxA, lreLinkStatusB=lreLinkStatusB, lreProxyNodeEntry=lreProxyNodeEntry, lreLinkStatusA=lreLinkStatusA, lreInterfaceConfigTable=lreInterfaceConfigTable, lreNodeName=lreNodeName, lreCntUniqueA=lreCntUniqueA, lreGroups=lreGroups, lreProxyNodeIndex=lreProxyNodeIndex, prp=prp, drp=drp, lrePortAdminStateB=lrePortAdminStateB, rrp=rrp, lreRedBoxIdentity=lreRedBoxIdentity, lreCntMultiC=lreCntMultiC, lreVersionName=lreVersionName, PYSNMP_MODULE_ID=iec62439, lreManufacturerName=lreManufacturerName, lreNodesIndex=lreNodesIndex, lreNodesMacAddress=lreNodesMacAddress, lreCntTxC=lreCntTxC, lreCntTxB=lreCntTxB, lreStatistics=lreStatistics, lreInterfaceConfigEntry=lreInterfaceConfigEntry, brp=brp, lreNodesEntry=lreNodesEntry, lreInterfaceCount=lreInterfaceCount, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntErrWrongLanB=lreCntErrWrongLanB, lreHsrLREMode=lreHsrLREMode, linkRedundancyCompliances=linkRedundancyCompliances, lreRemNodeType=lreRemNodeType, lreNodeType=lreNodeType, lreCntMultiA=lreCntMultiA, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreConfigurationInterfaces=lreConfigurationInterfaces, linkRedundancyCompliance=linkRedundancyCompliance, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreTransparentReception=lreTransparentReception, lreCntDuplicateB=lreCntDuplicateB, lreCntDuplicateA=lreCntDuplicateA, lreCntRxC=lreCntRxC, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup)
