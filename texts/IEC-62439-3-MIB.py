...
Gauge32, ObjectIdentity, Unsigned32, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Counter64, NotificationType, Counter32, Bits, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Unsigned32", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Counter64", "NotificationType", "Counter32", "Bits", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntTxC=lreCntTxC, lreMacAddress=lreMacAddress, lreVersionName=lreVersionName, lreProxyNodeIndex=lreProxyNodeIndex, lreCntErrorsC=lreCntErrorsC, iec62439=iec62439, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntUniqueC=lreCntUniqueC, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreNodesTableClear=lreNodesTableClear, lreDupListResideMaxTime=lreDupListResideMaxTime, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntDuplicateB=lreCntDuplicateB, lreConfigurationInterfaces=lreConfigurationInterfaces, ptp=ptp, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntDuplicateA=lreCntDuplicateA, lreTimeLastSeenB=lreTimeLastSeenB, lreNodeName=lreNodeName, lreStatistics=lreStatistics, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreTimeLastSeenA=lreTimeLastSeenA, lreLinkStatusB=lreLinkStatusB, linkRedundancyCompliances=linkRedundancyCompliances, lreEvaluateSupervision=lreEvaluateSupervision, PYSNMP_MODULE_ID=iec62439, lrePortAdminStateA=lrePortAdminStateA, lreNodesMacAddress=lreNodesMacAddress, prp=prp, lreCntOwnRxB=lreCntOwnRxB, lreNodeType=lreNodeType, linkRedundancyEntityObjects=linkRedundancyEntityObjects, brp=brp, lreRedBoxIdentity=lreRedBoxIdentity, lreCntProxyNodes=lreCntProxyNodes, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntUniqueB=lreCntUniqueB, lreCntErrorsA=lreCntErrorsA, lreCntRxC=lreCntRxC, lreDuplicateDiscard=lreDuplicateDiscard, lreCntDuplicateC=lreCntDuplicateC, lreHsrLREMode=lreHsrLREMode, rrp=rrp, lreCntOwnRxA=lreCntOwnRxA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, drp=drp, lreRemNodeType=lreRemNodeType, lreProxyNodeEntry=lreProxyNodeEntry, lreCntUniqueA=lreCntUniqueA, lreCntErrWrongLanA=lreCntErrWrongLanA, linkRedundancyConformance=linkRedundancyConformance, lreCntTxA=lreCntTxA, lreSwitchingEndNode=lreSwitchingEndNode, lreGroups=lreGroups, lreTransparentReception=lreTransparentReception, linkRedundancyEntityConformance=linkRedundancyEntityConformance, linkRedundancyCompliance=linkRedundancyCompliance, lreCntTxB=lreCntTxB, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreNodesTable=lreNodesTable, lreInterfaceCount=lreInterfaceCount, lreNodesEntry=lreNodesEntry, lreCntErrorsB=lreCntErrorsB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreNodesIndex=lreNodesIndex, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntMultiB=lreCntMultiB, lreLinkStatusA=lreLinkStatusA, lreCntRxB=lreCntRxB, lreCntErrWrongLanC=lreCntErrWrongLanC, lreDefaultGrp=lreDefaultGrp, lreConfiguration=lreConfiguration, lreCntRxA=lreCntRxA, lrePortAdminStateB=lrePortAdminStateB, crp=crp, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntNodes=lreCntNodes, lreInterfaceConfigTable=lreInterfaceConfigTable, lreRowStatus=lreRowStatus, SecondFraction=SecondFraction, lreCntMultiC=lreCntMultiC, lreCntMultiA=lreCntMultiA, lreManufacturerName=lreManufacturerName, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreProxyNodeTable=lreProxyNodeTable, mrp=mrp, lreProxyNodeTableClear=lreProxyNodeTableClear)
