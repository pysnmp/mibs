...
# Produced by pysmi-1.1.8 at Mon Jan  9 14:04:58 2023
...
ObjectIdentity, Counter64, ModuleIdentity, Integer32, Counter32, TimeTicks, Gauge32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "ModuleIdentity", "Integer32", "Counter32", "TimeTicks", "Gauge32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Bits", "iso")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreLinkStatusA=lreLinkStatusA, lreCntOwnRxA=lreCntOwnRxA, prp=prp, lreSwitchingEndNode=lreSwitchingEndNode, linkRedundancyConformance=linkRedundancyConformance, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreInterfaceStatsTable=lreInterfaceStatsTable, linkRedundancyCompliance=linkRedundancyCompliance, lreCntErrorsA=lreCntErrorsA, lreDuplicateDiscard=lreDuplicateDiscard, drp=drp, lreCntTxA=lreCntTxA, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntMultiC=lreCntMultiC, lreCntDuplicateC=lreCntDuplicateC, lreCntUniqueB=lreCntUniqueB, lreEvaluateSupervision=lreEvaluateSupervision, mrp=mrp, brp=brp, lreCntErrWrongLanB=lreCntErrWrongLanB, lreNodesMacAddress=lreNodesMacAddress, lreConfiguration=lreConfiguration, lreProxyNodeTable=lreProxyNodeTable, lreCntUniqueA=lreCntUniqueA, linkRedundancyCompliances=linkRedundancyCompliances, lreCntOwnRxB=lreCntOwnRxB, lreStatisticsInterfaces=lreStatisticsInterfaces, crp=crp, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreTimeLastSeenB=lreTimeLastSeenB, SecondFraction=SecondFraction, lrePortAdminStateA=lrePortAdminStateA, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntRxC=lreCntRxC, lreTimeLastSeenA=lreTimeLastSeenA, lreCntDuplicateA=lreCntDuplicateA, ptp=ptp, lreCntTxB=lreCntTxB, lreTransparentReception=lreTransparentReception, lreCntMultiA=lreCntMultiA, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreInterfaceStatsEntry=lreInterfaceStatsEntry, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntProxyNodes=lreCntProxyNodes, lreCntTxC=lreCntTxC, lreDupListResideMaxTime=lreDupListResideMaxTime, lreStatistics=lreStatistics, lreProxyNodeEntry=lreProxyNodeEntry, lreNodesEntry=lreNodesEntry, lreCntErrorsB=lreCntErrorsB, lreGroups=lreGroups, lreHsrLREMode=lreHsrLREMode, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntUniqueC=lreCntUniqueC, lreCntErrWrongLanC=lreCntErrWrongLanC, rrp=rrp, lreInterfaceConfigTable=lreInterfaceConfigTable, lreRowStatus=lreRowStatus, lreRedBoxIdentity=lreRedBoxIdentity, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreLinkStatusB=lreLinkStatusB, lrePortAdminStateB=lrePortAdminStateB, PYSNMP_MODULE_ID=iec62439, lreCntRxA=lreCntRxA, lreCntMultiB=lreCntMultiB, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreMacAddress=lreMacAddress, lreCntErrWrongLanA=lreCntErrWrongLanA, lreRemNodeType=lreRemNodeType, lreCntErrorsC=lreCntErrorsC, lreVersionName=lreVersionName, lreNodesTable=lreNodesTable, lreNodeType=lreNodeType, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntNodes=lreCntNodes, lreProxyNodeIndex=lreProxyNodeIndex, lreDefaultGrp=lreDefaultGrp, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreInterfaceCount=lreInterfaceCount, lreNodeName=lreNodeName, lreCntRxB=lreCntRxB, lreNodesTableClear=lreNodesTableClear, iec62439=iec62439, lreManufacturerName=lreManufacturerName, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntDuplicateB=lreCntDuplicateB, lreNodesIndex=lreNodesIndex)
