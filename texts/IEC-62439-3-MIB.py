...
iso, Unsigned32, Integer32, ModuleIdentity, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Counter32, TimeTicks, Counter64, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Integer32", "ModuleIdentity", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Counter32", "TimeTicks", "Counter64", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntMultiB=lreCntMultiB, lreNodesMacAddress=lreNodesMacAddress, lreStatistics=lreStatistics, prp=prp, lreLinkStatusA=lreLinkStatusA, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreTimeLastSeenA=lreTimeLastSeenA, lreDuplicateDiscard=lreDuplicateDiscard, lreCntUniqueC=lreCntUniqueC, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntMultiC=lreCntMultiC, lreCntTxB=lreCntTxB, lreMacAddress=lreMacAddress, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreProxyNodeTable=lreProxyNodeTable, lreNodeType=lreNodeType, lreRedBoxIdentity=lreRedBoxIdentity, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreConfiguration=lreConfiguration, lreCntUniqueA=lreCntUniqueA, lreProxyNodeIndex=lreProxyNodeIndex, brp=brp, lreNodesTableClear=lreNodesTableClear, rrp=rrp, lreCntProxyNodes=lreCntProxyNodes, lreTimeLastSeenB=lreTimeLastSeenB, ptp=ptp, lreRemNodeType=lreRemNodeType, lreCntRxA=lreCntRxA, PYSNMP_MODULE_ID=iec62439, lreProxyNodeEntry=lreProxyNodeEntry, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreConfigurationInterfaces=lreConfigurationInterfaces, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntTxA=lreCntTxA, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntRxC=lreCntRxC, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntDuplicateC=lreCntDuplicateC, lreInterfaceConfigTable=lreInterfaceConfigTable, lreInterfaceCount=lreInterfaceCount, lreDefaultGrp=lreDefaultGrp, lreNodeName=lreNodeName, lreInterfaceStatsTable=lreInterfaceStatsTable, lrePortAdminStateA=lrePortAdminStateA, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntTxC=lreCntTxC, lreHsrLREMode=lreHsrLREMode, lreCntUniqueB=lreCntUniqueB, lreEvaluateSupervision=lreEvaluateSupervision, lreRowStatus=lreRowStatus, linkRedundancyCompliance=linkRedundancyCompliance, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntNodes=lreCntNodes, crp=crp, linkRedundancyEntityConformance=linkRedundancyEntityConformance, linkRedundancyConformance=linkRedundancyConformance, lreSwitchingEndNode=lreSwitchingEndNode, lreCntMultiA=lreCntMultiA, lreTransparentReception=lreTransparentReception, lreCntErrWrongLanA=lreCntErrWrongLanA, lrePortAdminStateB=lrePortAdminStateB, lreCntErrorsB=lreCntErrorsB, drp=drp, lreStatisticsInterfaces=lreStatisticsInterfaces, mrp=mrp, linkRedundancyCompliances=linkRedundancyCompliances, lreCntErrWrongLanC=lreCntErrWrongLanC, SecondFraction=SecondFraction, lreCntOwnRxB=lreCntOwnRxB, lreCntDuplicateA=lreCntDuplicateA, lreCntErrorsC=lreCntErrorsC, lreManufacturerName=lreManufacturerName, lreGroups=lreGroups, lreNodesEntry=lreNodesEntry, lreVersionName=lreVersionName, lreCntRxB=lreCntRxB, lreCntOwnRxA=lreCntOwnRxA, lreNodesIndex=lreNodesIndex, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreNodesTable=lreNodesTable, lreCntErrorsA=lreCntErrorsA, lreCntDuplicateB=lreCntDuplicateB, lreLinkStatusB=lreLinkStatusB, iec62439=iec62439, lreProxyNodeTableClear=lreProxyNodeTableClear)
