...
Bits, TimeTicks, iso, Integer32, Gauge32, NotificationType, IpAddress, ModuleIdentity, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "iso", "Integer32", "Gauge32", "NotificationType", "IpAddress", "ModuleIdentity", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntDuplicateA=lreCntDuplicateA, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntOwnRxA=lreCntOwnRxA, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntProxyNodes=lreCntProxyNodes, lreProxyNodeTableClear=lreProxyNodeTableClear, lreNodesTableClear=lreNodesTableClear, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreTimeLastSeenA=lreTimeLastSeenA, lreCntNodes=lreCntNodes, lreCntMultiA=lreCntMultiA, lreInterfaceConfigEntry=lreInterfaceConfigEntry, mrp=mrp, lreRedBoxIdentity=lreRedBoxIdentity, lreManufacturerName=lreManufacturerName, lreNodesIndex=lreNodesIndex, lreLinkStatusA=lreLinkStatusA, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntRxB=lreCntRxB, lreCntTxB=lreCntTxB, drp=drp, lreCntDuplicateB=lreCntDuplicateB, lreCntRxA=lreCntRxA, lreDefaultGrp=lreDefaultGrp, crp=crp, lreConfigurationInterfaces=lreConfigurationInterfaces, lrePortAdminStateB=lrePortAdminStateB, lreTransparentReception=lreTransparentReception, lreMacAddress=lreMacAddress, lreRemNodeType=lreRemNodeType, lreDuplicateDiscard=lreDuplicateDiscard, lreCntTxC=lreCntTxC, lreCntDuplicateC=lreCntDuplicateC, lreNodeType=lreNodeType, lreEvaluateSupervision=lreEvaluateSupervision, lreStatisticsInterfaces=lreStatisticsInterfaces, lreNodesMacAddress=lreNodesMacAddress, lreSwitchingEndNode=lreSwitchingEndNode, lreCntErrorsA=lreCntErrorsA, lreNodesEntry=lreNodesEntry, lreCntUniqueC=lreCntUniqueC, lreHsrLREMode=lreHsrLREMode, lreCntErrWrongLanB=lreCntErrWrongLanB, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, rrp=rrp, linkRedundancyCompliance=linkRedundancyCompliance, iec62439=iec62439, lreCntOwnRxB=lreCntOwnRxB, lreNodesTable=lreNodesTable, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntErrorsB=lreCntErrorsB, lreStatistics=lreStatistics, PYSNMP_MODULE_ID=iec62439, lreRowStatus=lreRowStatus, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreGroups=lreGroups, lreProxyNodeTable=lreProxyNodeTable, prp=prp, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreProxyNodeEntry=lreProxyNodeEntry, lreLinkStatusB=lreLinkStatusB, linkRedundancyConformance=linkRedundancyConformance, lreCntTxA=lreCntTxA, lreCntUniqueB=lreCntUniqueB, lreCntMultiB=lreCntMultiB, lreTimeLastSeenB=lreTimeLastSeenB, lreCntErrWrongLanC=lreCntErrWrongLanC, lreVersionName=lreVersionName, lreDupListResideMaxTime=lreDupListResideMaxTime, SecondFraction=SecondFraction, lreCntErrorsC=lreCntErrorsC, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreConfiguration=lreConfiguration, lreCntUniqueA=lreCntUniqueA, lreCntRxC=lreCntRxC, lreCntMultiC=lreCntMultiC, brp=brp, lrePortAdminStateA=lrePortAdminStateA, lreInterfaceCount=lreInterfaceCount, ptp=ptp, lreProxyNodeIndex=lreProxyNodeIndex, linkRedundancyCompliances=linkRedundancyCompliances, lreInterfaceStatsTable=lreInterfaceStatsTable, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreNodeName=lreNodeName)
