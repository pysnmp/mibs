...
# Produced by pysmi-1.1.8 at Thu Sep  7 13:18:19 2023
...
Counter32, Gauge32, NotificationType, IpAddress, TimeTicks, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, ModuleIdentity, Unsigned32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "NotificationType", "IpAddress", "TimeTicks", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "ModuleIdentity", "Unsigned32", "Integer32", "iso")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntDuplicateC=lreCntDuplicateC, lreHsrLREMode=lreHsrLREMode, lreCntMultiC=lreCntMultiC, lreRedBoxIdentity=lreRedBoxIdentity, prp=prp, linkRedundancyConformance=linkRedundancyConformance, lreCntErrorsC=lreCntErrorsC, lreCntRxA=lreCntRxA, ptp=ptp, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lrePortAdminStateA=lrePortAdminStateA, lreCntUniqueA=lreCntUniqueA, lreProxyNodeEntry=lreProxyNodeEntry, lreCntMultiA=lreCntMultiA, lreCntErrorsB=lreCntErrorsB, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreNodesIndex=lreNodesIndex, lreEvaluateSupervision=lreEvaluateSupervision, lreCntTxA=lreCntTxA, lreGroups=lreGroups, lreCntUniqueB=lreCntUniqueB, lreStatisticsInterfaces=lreStatisticsInterfaces, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreInterfaceCount=lreInterfaceCount, lreRemNodeType=lreRemNodeType, lreCntDuplicateB=lreCntDuplicateB, lreSwitchingEndNode=lreSwitchingEndNode, lreDuplicateDiscard=lreDuplicateDiscard, lreCntNodes=lreCntNodes, lreLinkStatusA=lreLinkStatusA, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreNodesMacAddress=lreNodesMacAddress, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntOwnRxB=lreCntOwnRxB, PYSNMP_MODULE_ID=iec62439, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntTxC=lreCntTxC, lreDefaultGrp=lreDefaultGrp, linkRedundancyCompliance=linkRedundancyCompliance, lreManufacturerName=lreManufacturerName, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreProxyNodeIndex=lreProxyNodeIndex, rrp=rrp, lreCntDuplicateA=lreCntDuplicateA, lreCntRxC=lreCntRxC, lreCntErrWrongLanA=lreCntErrWrongLanA, lreMacAddress=lreMacAddress, lreCntMultiB=lreCntMultiB, lreLinkStatusB=lreLinkStatusB, lreCntTxB=lreCntTxB, lreCntErrWrongLanB=lreCntErrWrongLanB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreNodesTable=lreNodesTable, lreCntOwnRxA=lreCntOwnRxA, SecondFraction=SecondFraction, lreConfiguration=lreConfiguration, lreCntProxyNodes=lreCntProxyNodes, lreCntErrWrongLanC=lreCntErrWrongLanC, lreRowStatus=lreRowStatus, lreConfigurationInterfaces=lreConfigurationInterfaces, iec62439=iec62439, lreCntUniqueC=lreCntUniqueC, lreDupListResideMaxTime=lreDupListResideMaxTime, lreTimeLastSeenA=lreTimeLastSeenA, lreTransparentReception=lreTransparentReception, lreNodeType=lreNodeType, crp=crp, drp=drp, lrePortAdminStateB=lrePortAdminStateB, linkRedundancyCompliances=linkRedundancyCompliances, lreNodesEntry=lreNodesEntry, lreNodeName=lreNodeName, lreProxyNodeTable=lreProxyNodeTable, mrp=mrp, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntErrorsA=lreCntErrorsA, brp=brp, lreInterfaceConfigTable=lreInterfaceConfigTable, lreTimeLastSeenB=lreTimeLastSeenB, lreVersionName=lreVersionName, lreInterfaceStatsTable=lreInterfaceStatsTable, lreProxyNodeTableClear=lreProxyNodeTableClear, lreNodesTableClear=lreNodesTableClear, lreStatistics=lreStatistics, lreCntRxB=lreCntRxB)
