...
Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, NotificationType, TimeTicks, IpAddress, Integer32, Counter32, Counter64, iso, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "NotificationType", "TimeTicks", "IpAddress", "Integer32", "Counter32", "Counter64", "iso", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntErrWrongLanB=lreCntErrWrongLanB, lreTimeLastSeenB=lreTimeLastSeenB, lreCntMultiA=lreCntMultiA, ptp=ptp, lreRedBoxIdentity=lreRedBoxIdentity, lreNodesEntry=lreNodesEntry, iec62439=iec62439, lreVersionName=lreVersionName, lreProxyNodeEntry=lreProxyNodeEntry, lreLinkStatusA=lreLinkStatusA, lreCntTxA=lreCntTxA, lreCntRxB=lreCntRxB, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lrePortAdminStateB=lrePortAdminStateB, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntUniqueA=lreCntUniqueA, lreDefaultGrp=lreDefaultGrp, lreCntProxyNodes=lreCntProxyNodes, lreNodesTableClear=lreNodesTableClear, lreNodeName=lreNodeName, lreCntErrorsB=lreCntErrorsB, lreInterfaceStatsTable=lreInterfaceStatsTable, linkRedundancyCompliance=linkRedundancyCompliance, lreGroups=lreGroups, rrp=rrp, mrp=mrp, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntNodes=lreCntNodes, lreCntOwnRxA=lreCntOwnRxA, lreProxyNodeTableClear=lreProxyNodeTableClear, SecondFraction=SecondFraction, lreCntDuplicateB=lreCntDuplicateB, lreCntRxC=lreCntRxC, lreProxyNodeTable=lreProxyNodeTable, lreNodeType=lreNodeType, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreRowStatus=lreRowStatus, lreSwitchingEndNode=lreSwitchingEndNode, lreCntErrorsC=lreCntErrorsC, lreNodesMacAddress=lreNodesMacAddress, lreRemNodeType=lreRemNodeType, lreCntTxB=lreCntTxB, lreConfigurationInterfaces=lreConfigurationInterfaces, lreStatisticsInterfaces=lreStatisticsInterfaces, lreProxyNodeIndex=lreProxyNodeIndex, drp=drp, lreCntMultiC=lreCntMultiC, lrePortAdminStateA=lrePortAdminStateA, lreCntTxC=lreCntTxC, lreCntUniqueB=lreCntUniqueB, lreHsrLREMode=lreHsrLREMode, linkRedundancyCompliances=linkRedundancyCompliances, lreCntDuplicateC=lreCntDuplicateC, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreNodesTable=lreNodesTable, lreCntErrWrongLanA=lreCntErrWrongLanA, lreManufacturerName=lreManufacturerName, lreMacAddress=lreMacAddress, lreConfiguration=lreConfiguration, lreCntRxA=lreCntRxA, PYSNMP_MODULE_ID=iec62439, lreCntOwnRxB=lreCntOwnRxB, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreTransparentReception=lreTransparentReception, lreInterfaceCount=lreInterfaceCount, lreEvaluateSupervision=lreEvaluateSupervision, lreTimeLastSeenA=lreTimeLastSeenA, crp=crp, lreDuplicateDiscard=lreDuplicateDiscard, lreDupListResideMaxTime=lreDupListResideMaxTime, brp=brp, lreLinkStatusB=lreLinkStatusB, prp=prp, lreCntErrWrongLanC=lreCntErrWrongLanC, lreStatistics=lreStatistics, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntErrorsA=lreCntErrorsA, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreNodesIndex=lreNodesIndex, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntUniqueC=lreCntUniqueC, lreCntDuplicateA=lreCntDuplicateA, lreCntMultiB=lreCntMultiB, linkRedundancyConformance=linkRedundancyConformance)
