...
Unsigned32, TimeTicks, Counter64, IpAddress, ObjectIdentity, Integer32, ModuleIdentity, Bits, Counter32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "Counter64", "IpAddress", "ObjectIdentity", "Integer32", "ModuleIdentity", "Bits", "Counter32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", brp=brp, lreCntOwnRxA=lreCntOwnRxA, lreDuplicateDiscard=lreDuplicateDiscard, ptp=ptp, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreVersionName=lreVersionName, lreNodesEntry=lreNodesEntry, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreLinkStatusA=lreLinkStatusA, lreCntUniqueA=lreCntUniqueA, lreCntDuplicateB=lreCntDuplicateB, lreCntMultiA=lreCntMultiA, lreNodesTableClear=lreNodesTableClear, lreProxyNodeTableClear=lreProxyNodeTableClear, lreRedBoxIdentity=lreRedBoxIdentity, rrp=rrp, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntTxA=lreCntTxA, lreCntRxB=lreCntRxB, lreCntTxB=lreCntTxB, lreNodesMacAddress=lreNodesMacAddress, lrePortAdminStateA=lrePortAdminStateA, lreTimeLastSeenA=lreTimeLastSeenA, lreSwitchingEndNode=lreSwitchingEndNode, lreCntErrorsB=lreCntErrorsB, crp=crp, lreNodeName=lreNodeName, lreInterfaceStatsTable=lreInterfaceStatsTable, lreTimeLastSeenB=lreTimeLastSeenB, mrp=mrp, lreCntMultiB=lreCntMultiB, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntProxyNodes=lreCntProxyNodes, lreCntUniqueC=lreCntUniqueC, lreCntErrWrongLanC=lreCntErrWrongLanC, lreProxyNodeTable=lreProxyNodeTable, lreNodeType=lreNodeType, lreRowStatus=lreRowStatus, drp=drp, lreNodesTable=lreNodesTable, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, linkRedundancyConformance=linkRedundancyConformance, lreLinkStatusB=lreLinkStatusB, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntMultiC=lreCntMultiC, lreCntErrorsA=lreCntErrorsA, lreCntDuplicateA=lreCntDuplicateA, lreNodesIndex=lreNodesIndex, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntOwnRxB=lreCntOwnRxB, lreStatistics=lreStatistics, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntUniqueB=lreCntUniqueB, lreProxyNodeIndex=lreProxyNodeIndex, prp=prp, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreConfiguration=lreConfiguration, lreCntRxC=lreCntRxC, lreCntTxC=lreCntTxC, lreGroups=lreGroups, SecondFraction=SecondFraction, lreHsrLREMode=lreHsrLREMode, lreDupListResideMaxTime=lreDupListResideMaxTime, lreDefaultGrp=lreDefaultGrp, lreTransparentReception=lreTransparentReception, lreProxyNodeEntry=lreProxyNodeEntry, lreCntErrorsC=lreCntErrorsC, lreRemNodeType=lreRemNodeType, lreInterfaceConfigTable=lreInterfaceConfigTable, lreInterfaceCount=lreInterfaceCount, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntNodes=lreCntNodes, lreCntDuplicateC=lreCntDuplicateC, lreMacAddress=lreMacAddress, lreEvaluateSupervision=lreEvaluateSupervision, iec62439=iec62439, linkRedundancyCompliance=linkRedundancyCompliance, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lrePortAdminStateB=lrePortAdminStateB, PYSNMP_MODULE_ID=iec62439, lreCntRxA=lreCntRxA, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreManufacturerName=lreManufacturerName, linkRedundancyCompliances=linkRedundancyCompliances, lreCntErrWrongLanA=lreCntErrWrongLanA, lreStatisticsInterfaces=lreStatisticsInterfaces)
