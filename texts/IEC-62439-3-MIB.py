...
ModuleIdentity, MibIdentifier, NotificationType, Bits, IpAddress, Counter32, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, ObjectIdentity, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "NotificationType", "Bits", "IpAddress", "Counter32", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "ObjectIdentity", "iso", "Integer32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreManufacturerName=lreManufacturerName, lreNodeName=lreNodeName, lreLinkStatusB=lreLinkStatusB, lreCntMultiC=lreCntMultiC, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntRxA=lreCntRxA, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntTxB=lreCntTxB, lreCntErrorsA=lreCntErrorsA, lreNodesEntry=lreNodesEntry, lreMacAddress=lreMacAddress, prp=prp, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreInterfaceStatsTable=lreInterfaceStatsTable, lreLinkStatusA=lreLinkStatusA, lreRowStatus=lreRowStatus, lreCntDuplicateC=lreCntDuplicateC, PYSNMP_MODULE_ID=iec62439, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreInterfaceConfigIndex=lreInterfaceConfigIndex, iec62439=iec62439, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntDuplicateA=lreCntDuplicateA, lreNodeType=lreNodeType, lreRedBoxIdentity=lreRedBoxIdentity, lreProxyNodeEntry=lreProxyNodeEntry, lreVersionName=lreVersionName, rrp=rrp, lreInterfaceStatsEntry=lreInterfaceStatsEntry, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntNodes=lreCntNodes, lreCntUniqueA=lreCntUniqueA, lreCntMultiB=lreCntMultiB, SecondFraction=SecondFraction, lreStatistics=lreStatistics, lreProxyNodeIndex=lreProxyNodeIndex, lreRemNodeType=lreRemNodeType, lreGroups=lreGroups, lreNodesTable=lreNodesTable, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntUniqueC=lreCntUniqueC, lreCntRxB=lreCntRxB, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreNodesTableClear=lreNodesTableClear, lreCntMultiA=lreCntMultiA, lrePortAdminStateB=lrePortAdminStateB, lreCntDuplicateB=lreCntDuplicateB, lreCntUniqueB=lreCntUniqueB, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntOwnRxB=lreCntOwnRxB, lreHsrLREMode=lreHsrLREMode, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntErrWrongLanB=lreCntErrWrongLanB, lreInterfaceConfigTable=lreInterfaceConfigTable, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntTxC=lreCntTxC, lreEvaluateSupervision=lreEvaluateSupervision, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntProxyNodes=lreCntProxyNodes, lreNodesMacAddress=lreNodesMacAddress, lreCntErrWrongLanA=lreCntErrWrongLanA, linkRedundancyConformance=linkRedundancyConformance, lreCntOwnRxA=lreCntOwnRxA, lreTransparentReception=lreTransparentReception, linkRedundancyCompliance=linkRedundancyCompliance, lreDefaultGrp=lreDefaultGrp, lreCntTxA=lreCntTxA, lreDuplicateDiscard=lreDuplicateDiscard, lreProxyNodeTable=lreProxyNodeTable, linkRedundancyCompliances=linkRedundancyCompliances, crp=crp, brp=brp, lreCntErrorsC=lreCntErrorsC, lreSwitchingEndNode=lreSwitchingEndNode, lreTimeLastSeenA=lreTimeLastSeenA, lreInterfaceCount=lreInterfaceCount, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreNodesIndex=lreNodesIndex, linkRedundancyEntityObjects=linkRedundancyEntityObjects, ptp=ptp, lreCntRxC=lreCntRxC, lreCntErrorsB=lreCntErrorsB, lreConfiguration=lreConfiguration, drp=drp, lreTimeLastSeenB=lreTimeLastSeenB, lrePortAdminStateA=lrePortAdminStateA, mrp=mrp)
