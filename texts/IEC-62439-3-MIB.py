...
ObjectIdentity, iso, Counter64, Integer32, Unsigned32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Gauge32, Bits, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Counter64", "Integer32", "Unsigned32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Gauge32", "Bits", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntDuplicateC=lreCntDuplicateC, lreTransparentReception=lreTransparentReception, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreNodesEntry=lreNodesEntry, SecondFraction=SecondFraction, lreNodesTableClear=lreNodesTableClear, lreCntErrorsB=lreCntErrorsB, mrp=mrp, lreNodesIndex=lreNodesIndex, lreSwitchingEndNode=lreSwitchingEndNode, lreProxyNodeTableClear=lreProxyNodeTableClear, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntMultiB=lreCntMultiB, lreCntUniqueA=lreCntUniqueA, lreInterfaceConfigIndex=lreInterfaceConfigIndex, linkRedundancyConformance=linkRedundancyConformance, lreCntMultiA=lreCntMultiA, lreCntTxB=lreCntTxB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, linkRedundancyCompliance=linkRedundancyCompliance, lreCntOwnRxB=lreCntOwnRxB, lrePortAdminStateB=lrePortAdminStateB, lreCntErrWrongLanA=lreCntErrWrongLanA, lreProxyNodeIndex=lreProxyNodeIndex, lreCntDuplicateB=lreCntDuplicateB, lreInterfaceConfigTable=lreInterfaceConfigTable, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreRowStatus=lreRowStatus, lreTimeLastSeenB=lreTimeLastSeenB, lreStatistics=lreStatistics, lreRemNodeType=lreRemNodeType, lreConfiguration=lreConfiguration, lreGroups=lreGroups, lreCntRxC=lreCntRxC, lreCntMultiC=lreCntMultiC, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, crp=crp, lreInterfaceCount=lreInterfaceCount, lreVersionName=lreVersionName, lreManufacturerName=lreManufacturerName, lreLinkStatusA=lreLinkStatusA, lreCntErrWrongLanB=lreCntErrWrongLanB, rrp=rrp, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, prp=prp, lreCntUniqueB=lreCntUniqueB, lreCntDuplicateA=lreCntDuplicateA, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntErrWrongLanC=lreCntErrWrongLanC, lreMacAddress=lreMacAddress, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntUniqueC=lreCntUniqueC, lrePortAdminStateA=lrePortAdminStateA, lreCntRxB=lreCntRxB, lreRedBoxIdentity=lreRedBoxIdentity, lreCntErrorsA=lreCntErrorsA, drp=drp, iec62439=iec62439, lreNodesTable=lreNodesTable, lreNodeName=lreNodeName, lreCntTxA=lreCntTxA, lreNodeType=lreNodeType, lreDefaultGrp=lreDefaultGrp, lreProxyNodeTable=lreProxyNodeTable, brp=brp, linkRedundancyEntityConformance=linkRedundancyEntityConformance, ptp=ptp, lreDuplicateDiscard=lreDuplicateDiscard, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreProxyNodeEntry=lreProxyNodeEntry, lreCntProxyNodes=lreCntProxyNodes, lreCntTxC=lreCntTxC, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntRxA=lreCntRxA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreNodesMacAddress=lreNodesMacAddress, PYSNMP_MODULE_ID=iec62439, lreHsrLREMode=lreHsrLREMode, lreLinkStatusB=lreLinkStatusB, lreCntErrorsC=lreCntErrorsC, lreEvaluateSupervision=lreEvaluateSupervision, lreCntOwnRxA=lreCntOwnRxA, lreCntNodes=lreCntNodes, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreTimeLastSeenA=lreTimeLastSeenA, linkRedundancyCompliances=linkRedundancyCompliances)
