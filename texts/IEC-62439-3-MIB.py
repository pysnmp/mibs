...
Unsigned32, TimeTicks, Counter64, NotificationType, Bits, IpAddress, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, ObjectIdentity, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "Counter64", "NotificationType", "Bits", "IpAddress", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "iso", "Gauge32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntRxA=lreCntRxA, lreHsrLREMode=lreHsrLREMode, lreSwitchingEndNode=lreSwitchingEndNode, lreManufacturerName=lreManufacturerName, lreTransparentReception=lreTransparentReception, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntProxyNodes=lreCntProxyNodes, lreNodesIndex=lreNodesIndex, lreDefaultGrp=lreDefaultGrp, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreNodeType=lreNodeType, lreCntTxB=lreCntTxB, lreNodeName=lreNodeName, lreLinkStatusA=lreLinkStatusA, lreDuplicateDiscard=lreDuplicateDiscard, lreTimeLastSeenA=lreTimeLastSeenA, lreCntErrorsC=lreCntErrorsC, lreStatistics=lreStatistics, lreStatisticsInterfaces=lreStatisticsInterfaces, lreRowStatus=lreRowStatus, iec62439=iec62439, lreCntMultiC=lreCntMultiC, drp=drp, lreCntTxC=lreCntTxC, brp=brp, prp=prp, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntDuplicateA=lreCntDuplicateA, linkRedundancyCompliances=linkRedundancyCompliances, mrp=mrp, linkRedundancyConformance=linkRedundancyConformance, lreProxyNodeIndex=lreProxyNodeIndex, lreCntErrorsA=lreCntErrorsA, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntOwnRxA=lreCntOwnRxA, lrePortAdminStateA=lrePortAdminStateA, lreCntDuplicateB=lreCntDuplicateB, lreNodesMacAddress=lreNodesMacAddress, lreCntUniqueB=lreCntUniqueB, lreCntErrWrongLanC=lreCntErrWrongLanC, lreNodesTableClear=lreNodesTableClear, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreProxyNodeEntry=lreProxyNodeEntry, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntErrorsB=lreCntErrorsB, lreNodesTable=lreNodesTable, lreDupListResideMaxTime=lreDupListResideMaxTime, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceCount=lreInterfaceCount, lreEvaluateSupervision=lreEvaluateSupervision, lreTimeLastSeenB=lreTimeLastSeenB, crp=crp, lreRemNodeType=lreRemNodeType, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntTxA=lreCntTxA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntRxC=lreCntRxC, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lrePortAdminStateB=lrePortAdminStateB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntMultiB=lreCntMultiB, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntOwnRxB=lreCntOwnRxB, PYSNMP_MODULE_ID=iec62439, lreConfiguration=lreConfiguration, lreMacAddress=lreMacAddress, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreGroups=lreGroups, lreRedBoxIdentity=lreRedBoxIdentity, lreInterfaceStatsTable=lreInterfaceStatsTable, lreLinkStatusB=lreLinkStatusB, linkRedundancyCompliance=linkRedundancyCompliance, ptp=ptp, lreCntRxB=lreCntRxB, lreCntMultiA=lreCntMultiA, lreVersionName=lreVersionName, lreInterfaceStatsEntry=lreInterfaceStatsEntry, rrp=rrp, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntNodes=lreCntNodes, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntUniqueA=lreCntUniqueA, SecondFraction=SecondFraction, lreCntDuplicateC=lreCntDuplicateC, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntUniqueC=lreCntUniqueC, lreNodesEntry=lreNodesEntry)
