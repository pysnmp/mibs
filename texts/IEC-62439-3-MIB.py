...
Bits, IpAddress, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, ObjectIdentity, NotificationType, iso, TimeTicks, Counter64, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "ObjectIdentity", "NotificationType", "iso", "TimeTicks", "Counter64", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntUniqueB=lreCntUniqueB, SecondFraction=SecondFraction, lreCntRxB=lreCntRxB, iec62439=iec62439, lreCntErrorsB=lreCntErrorsB, lreCntOwnRxB=lreCntOwnRxB, linkRedundancyCompliances=linkRedundancyCompliances, lreNodeName=lreNodeName, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntTxA=lreCntTxA, lreCntErrorsC=lreCntErrorsC, lreCntDuplicateC=lreCntDuplicateC, lreNodesTableClear=lreNodesTableClear, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntRxA=lreCntRxA, lreProxyNodeEntry=lreProxyNodeEntry, prp=prp, lreMacAddress=lreMacAddress, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntTxC=lreCntTxC, lreManufacturerName=lreManufacturerName, lreCntMultiC=lreCntMultiC, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lrePortAdminStateB=lrePortAdminStateB, drp=drp, lreNodesEntry=lreNodesEntry, lreEvaluateSupervision=lreEvaluateSupervision, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreTransparentReception=lreTransparentReception, lreConfigurationInterfaces=lreConfigurationInterfaces, lreNodesIndex=lreNodesIndex, lreConfiguration=lreConfiguration, lreCntDuplicateB=lreCntDuplicateB, lreVersionName=lreVersionName, lreCntNodes=lreCntNodes, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntProxyNodes=lreCntProxyNodes, lreLinkStatusA=lreLinkStatusA, lreSwitchingEndNode=lreSwitchingEndNode, lreTimeLastSeenA=lreTimeLastSeenA, lreProxyNodeTable=lreProxyNodeTable, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreRemNodeType=lreRemNodeType, lreCntErrorsA=lreCntErrorsA, lreCntDuplicateA=lreCntDuplicateA, lreGroups=lreGroups, lreCntOwnRxA=lreCntOwnRxA, ptp=ptp, lreCntErrWrongLanC=lreCntErrWrongLanC, lreRedBoxIdentity=lreRedBoxIdentity, lreNodesMacAddress=lreNodesMacAddress, lreDupListResideMaxTime=lreDupListResideMaxTime, lreRowStatus=lreRowStatus, lreCntMultiA=lreCntMultiA, linkRedundancyCompliance=linkRedundancyCompliance, lreCntRxC=lreCntRxC, lreCntMultiB=lreCntMultiB, crp=crp, lreCntUniqueA=lreCntUniqueA, lreProxyNodeIndex=lreProxyNodeIndex, lreCntUniqueC=lreCntUniqueC, lreCntTxB=lreCntTxB, lreNodesTable=lreNodesTable, linkRedundancyConformance=linkRedundancyConformance, lreTimeLastSeenB=lreTimeLastSeenB, lreInterfaceStatsTable=lreInterfaceStatsTable, linkRedundancyEntityObjects=linkRedundancyEntityObjects, mrp=mrp, lreDuplicateDiscard=lreDuplicateDiscard, PYSNMP_MODULE_ID=iec62439, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreNodeType=lreNodeType, lrePortAdminStateA=lrePortAdminStateA, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreInterfaceConfigTable=lreInterfaceConfigTable, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreHsrLREMode=lreHsrLREMode, lreDefaultGrp=lreDefaultGrp, lreInterfaceCount=lreInterfaceCount, lreLinkStatusB=lreLinkStatusB, lreStatistics=lreStatistics, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntErrWrongLanA=lreCntErrWrongLanA, lreProxyNodeTableClear=lreProxyNodeTableClear, lreStatisticsInterfaces=lreStatisticsInterfaces, brp=brp, rrp=rrp)
