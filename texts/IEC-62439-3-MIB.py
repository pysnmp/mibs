...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:57:06 2023
...
iso, Bits, ObjectIdentity, Counter64, IpAddress, Gauge32, TimeTicks, Unsigned32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "ObjectIdentity", "Counter64", "IpAddress", "Gauge32", "TimeTicks", "Unsigned32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreEvaluateSupervision=lreEvaluateSupervision, SecondFraction=SecondFraction, lreCntDuplicateB=lreCntDuplicateB, lreCntUniqueA=lreCntUniqueA, prp=prp, lreCntOwnRxB=lreCntOwnRxB, lreCntErrorsC=lreCntErrorsC, lreInterfaceStatsTable=lreInterfaceStatsTable, lreInterfaceConfigTable=lreInterfaceConfigTable, lreDefaultGrp=lreDefaultGrp, lreDupListResideMaxTime=lreDupListResideMaxTime, lreConfigurationInterfaces=lreConfigurationInterfaces, lreNodesEntry=lreNodesEntry, lreConfiguration=lreConfiguration, lreHsrLREMode=lreHsrLREMode, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreNodesMacAddress=lreNodesMacAddress, lreTimeLastSeenA=lreTimeLastSeenA, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lrePortAdminStateA=lrePortAdminStateA, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreRemNodeType=lreRemNodeType, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreRowStatus=lreRowStatus, lreCntMultiC=lreCntMultiC, lreCntRxA=lreCntRxA, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, mrp=mrp, lreCntErrWrongLanC=lreCntErrWrongLanC, drp=drp, lreStatisticsInterfaces=lreStatisticsInterfaces, lreProxyNodeIndex=lreProxyNodeIndex, linkRedundancyCompliances=linkRedundancyCompliances, lreCntProxyNodes=lreCntProxyNodes, lreCntErrWrongLanA=lreCntErrWrongLanA, ptp=ptp, brp=brp, lreCntUniqueB=lreCntUniqueB, lreNodesTable=lreNodesTable, lreCntOwnRxA=lreCntOwnRxA, lreRedBoxIdentity=lreRedBoxIdentity, crp=crp, lreCntMultiA=lreCntMultiA, lreLinkStatusA=lreLinkStatusA, lreCntErrWrongLanB=lreCntErrWrongLanB, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreTransparentReception=lreTransparentReception, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntTxC=lreCntTxC, lreInterfaceStatsEntry=lreInterfaceStatsEntry, PYSNMP_MODULE_ID=iec62439, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntNodes=lreCntNodes, lreTimeLastSeenB=lreTimeLastSeenB, lreCntErrorsA=lreCntErrorsA, lreCntErrorsB=lreCntErrorsB, linkRedundancyConformance=linkRedundancyConformance, lreCntTxB=lreCntTxB, lreLinkStatusB=lreLinkStatusB, lreNodesTableClear=lreNodesTableClear, lreCntDuplicateA=lreCntDuplicateA, lreCntMultiB=lreCntMultiB, lreNodeName=lreNodeName, rrp=rrp, lreDuplicateDiscard=lreDuplicateDiscard, lreProxyNodeTable=lreProxyNodeTable, linkRedundancyCompliance=linkRedundancyCompliance, lreNodeType=lreNodeType, lreSwitchingEndNode=lreSwitchingEndNode, lreCntRxC=lreCntRxC, lreCntTxA=lreCntTxA, lreInterfaceCount=lreInterfaceCount, lreGroups=lreGroups, lreCntRxB=lreCntRxB, lreProxyNodeEntry=lreProxyNodeEntry, lrePortAdminStateB=lrePortAdminStateB, lreCntUniqueC=lreCntUniqueC, iec62439=iec62439, lreNodesIndex=lreNodesIndex, lreMacAddress=lreMacAddress, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntDuplicateC=lreCntDuplicateC, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreVersionName=lreVersionName, lreManufacturerName=lreManufacturerName, lreStatistics=lreStatistics)
