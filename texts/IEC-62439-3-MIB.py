...
Unsigned32, NotificationType, Gauge32, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, iso, Counter64, IpAddress, MibIdentifier, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "Gauge32", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "iso", "Counter64", "IpAddress", "MibIdentifier", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntErrorsC=lreCntErrorsC, lreNodesTable=lreNodesTable, lreVersionName=lreVersionName, iec62439=iec62439, drp=drp, lreCntRxB=lreCntRxB, lreCntTxB=lreCntTxB, lreInterfaceCount=lreInterfaceCount, crp=crp, lreTransparentReception=lreTransparentReception, rrp=rrp, brp=brp, lreCntDuplicateA=lreCntDuplicateA, lreCntRxC=lreCntRxC, lreDuplicateDiscard=lreDuplicateDiscard, lreCntTxA=lreCntTxA, lreRemNodeType=lreRemNodeType, lreInterfaceStatsTable=lreInterfaceStatsTable, lreStatisticsInterfaces=lreStatisticsInterfaces, lreEvaluateSupervision=lreEvaluateSupervision, lreTimeLastSeenA=lreTimeLastSeenA, lreCntErrorsA=lreCntErrorsA, linkRedundancyConformance=linkRedundancyConformance, lreCntTxC=lreCntTxC, lreCntMultiA=lreCntMultiA, lreCntErrorsB=lreCntErrorsB, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreStatistics=lreStatistics, lreNodeType=lreNodeType, lreCntErrWrongLanB=lreCntErrWrongLanB, lreGroups=lreGroups, lreManufacturerName=lreManufacturerName, lreHsrLREMode=lreHsrLREMode, lreConfiguration=lreConfiguration, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreLinkStatusA=lreLinkStatusA, SecondFraction=SecondFraction, lreProxyNodeEntry=lreProxyNodeEntry, lrePortAdminStateA=lrePortAdminStateA, lreMacAddress=lreMacAddress, lreCntOwnRxA=lreCntOwnRxA, lreTimeLastSeenB=lreTimeLastSeenB, lreCntDuplicateC=lreCntDuplicateC, lreCntRxA=lreCntRxA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreProxyNodeIndex=lreProxyNodeIndex, lreInterfaceConfigTable=lreInterfaceConfigTable, lreInterfaceStatsIndex=lreInterfaceStatsIndex, linkRedundancyCompliances=linkRedundancyCompliances, lreProxyNodeTable=lreProxyNodeTable, prp=prp, linkRedundancyCompliance=linkRedundancyCompliance, lreNodesEntry=lreNodesEntry, lreSwitchingEndNode=lreSwitchingEndNode, lreRowStatus=lreRowStatus, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreDefaultGrp=lreDefaultGrp, lreCntDuplicateB=lreCntDuplicateB, lreCntErrWrongLanA=lreCntErrWrongLanA, lreNodeName=lreNodeName, lreLinkStatusB=lreLinkStatusB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, ptp=ptp, lreNodesTableClear=lreNodesTableClear, lreCntUniqueA=lreCntUniqueA, PYSNMP_MODULE_ID=iec62439, lreCntUniqueB=lreCntUniqueB, lreProxyNodeTableClear=lreProxyNodeTableClear, lrePortAdminStateB=lrePortAdminStateB, lreRedBoxIdentity=lreRedBoxIdentity, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntOwnRxB=lreCntOwnRxB, lreNodesMacAddress=lreNodesMacAddress, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, mrp=mrp, lreCntMultiC=lreCntMultiC, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntNodes=lreCntNodes, lreCntProxyNodes=lreCntProxyNodes, lreConfigurationInterfaces=lreConfigurationInterfaces, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntMultiB=lreCntMultiB, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntUniqueC=lreCntUniqueC, lreNodesIndex=lreNodesIndex)
