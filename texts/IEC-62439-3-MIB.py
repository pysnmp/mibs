...
ModuleIdentity, iso, TimeTicks, IpAddress, Gauge32, ObjectIdentity, NotificationType, Integer32, Unsigned32, MibIdentifier, Bits, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "TimeTicks", "IpAddress", "Gauge32", "ObjectIdentity", "NotificationType", "Integer32", "Unsigned32", "MibIdentifier", "Bits", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", crp=crp, lrePortAdminStateA=lrePortAdminStateA, lreLinkStatusA=lreLinkStatusA, lreCntDuplicateA=lreCntDuplicateA, lreStatistics=lreStatistics, drp=drp, linkRedundancyCompliance=linkRedundancyCompliance, lreCntOwnRxA=lreCntOwnRxA, lreDefaultGrp=lreDefaultGrp, lreDuplicateDiscard=lreDuplicateDiscard, PYSNMP_MODULE_ID=iec62439, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntErrWrongLanC=lreCntErrWrongLanC, lreHsrLREMode=lreHsrLREMode, iec62439=iec62439, SecondFraction=SecondFraction, lreNodesTableClear=lreNodesTableClear, linkRedundancyEntityObjects=linkRedundancyEntityObjects, mrp=mrp, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntRxB=lreCntRxB, lreCntMultiA=lreCntMultiA, lreCntTxA=lreCntTxA, lreInterfaceStatsTable=lreInterfaceStatsTable, lreRemNodeType=lreRemNodeType, prp=prp, lreCntNodes=lreCntNodes, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreSwitchingEndNode=lreSwitchingEndNode, lreConfiguration=lreConfiguration, lreCntUniqueC=lreCntUniqueC, lreNodesTable=lreNodesTable, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntTxC=lreCntTxC, rrp=rrp, lreCntMultiC=lreCntMultiC, lreCntErrorsB=lreCntErrorsB, lreManufacturerName=lreManufacturerName, lreProxyNodeTableClear=lreProxyNodeTableClear, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreMacAddress=lreMacAddress, lreNodeName=lreNodeName, lreStatisticsInterfaces=lreStatisticsInterfaces, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreEvaluateSupervision=lreEvaluateSupervision, lreRowStatus=lreRowStatus, lreInterfaceCount=lreInterfaceCount, lreCntErrorsA=lreCntErrorsA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntRxC=lreCntRxC, lrePortAdminStateB=lrePortAdminStateB, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntErrWrongLanA=lreCntErrWrongLanA, linkRedundancyConformance=linkRedundancyConformance, lreRedBoxIdentity=lreRedBoxIdentity, lreCntRxA=lreCntRxA, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntDuplicateC=lreCntDuplicateC, lreTimeLastSeenA=lreTimeLastSeenA, lreLinkStatusB=lreLinkStatusB, lreNodeType=lreNodeType, lreCntProxyNodes=lreCntProxyNodes, lreNodesEntry=lreNodesEntry, lreNodesMacAddress=lreNodesMacAddress, lreProxyNodeTable=lreProxyNodeTable, lreTransparentReception=lreTransparentReception, brp=brp, lreCntUniqueB=lreCntUniqueB, lreCntTxB=lreCntTxB, lreProxyNodeEntry=lreProxyNodeEntry, lreVersionName=lreVersionName, lreCntOwnRxB=lreCntOwnRxB, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreInterfaceConfigTable=lreInterfaceConfigTable, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreGroups=lreGroups, lreCntErrorsC=lreCntErrorsC, linkRedundancyCompliances=linkRedundancyCompliances, lreNodesIndex=lreNodesIndex, lreCntErrWrongLanB=lreCntErrWrongLanB, lreProxyNodeIndex=lreProxyNodeIndex, lreTimeLastSeenB=lreTimeLastSeenB, ptp=ptp, lreCntUniqueA=lreCntUniqueA, lreCntMultiB=lreCntMultiB, lreCntDuplicateB=lreCntDuplicateB)
