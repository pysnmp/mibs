...
Counter32, ModuleIdentity, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, TimeTicks, Bits, MibIdentifier, IpAddress, Integer32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "TimeTicks", "Bits", "MibIdentifier", "IpAddress", "Integer32", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreEvaluateSupervision=lreEvaluateSupervision, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntTxA=lreCntTxA, ptp=ptp, lreCntTxB=lreCntTxB, lreNodesMacAddress=lreNodesMacAddress, lreDuplicateDiscard=lreDuplicateDiscard, lreConfigurationInterfaces=lreConfigurationInterfaces, lreProxyNodeIndex=lreProxyNodeIndex, lreManufacturerName=lreManufacturerName, lreCntErrorsB=lreCntErrorsB, lreCntMultiB=lreCntMultiB, lreInterfaceConfigTable=lreInterfaceConfigTable, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntRxB=lreCntRxB, linkRedundancyCompliance=linkRedundancyCompliance, lreTimeLastSeenA=lreTimeLastSeenA, lreHsrLREMode=lreHsrLREMode, lreNodesTable=lreNodesTable, SecondFraction=SecondFraction, lreRedBoxIdentity=lreRedBoxIdentity, lreTransparentReception=lreTransparentReception, mrp=mrp, lreTimeLastSeenB=lreTimeLastSeenB, lreInterfaceCount=lreInterfaceCount, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntErrWrongLanB=lreCntErrWrongLanB, lreSwitchingEndNode=lreSwitchingEndNode, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntRxC=lreCntRxC, lreCntMultiC=lreCntMultiC, lreCntTxC=lreCntTxC, lreCntDuplicateB=lreCntDuplicateB, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreRowStatus=lreRowStatus, lrePortAdminStateB=lrePortAdminStateB, lreVersionName=lreVersionName, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreNodesTableClear=lreNodesTableClear, linkRedundancyCompliances=linkRedundancyCompliances, crp=crp, lreStatistics=lreStatistics, lreDupListResideMaxTime=lreDupListResideMaxTime, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntOwnRxB=lreCntOwnRxB, lreCntDuplicateA=lreCntDuplicateA, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntErrWrongLanA=lreCntErrWrongLanA, lreProxyNodeTableClear=lreProxyNodeTableClear, lreNodesIndex=lreNodesIndex, lreCntProxyNodes=lreCntProxyNodes, lreLinkStatusB=lreLinkStatusB, lreCntUniqueC=lreCntUniqueC, lreCntDuplicateC=lreCntDuplicateC, lreGroups=lreGroups, lreRemNodeType=lreRemNodeType, iec62439=iec62439, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreMacAddress=lreMacAddress, lreCntMultiA=lreCntMultiA, lreLinkStatusA=lreLinkStatusA, lreCntRxA=lreCntRxA, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntOwnRxA=lreCntOwnRxA, lreProxyNodeEntry=lreProxyNodeEntry, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, linkRedundancyEntityObjects=linkRedundancyEntityObjects, PYSNMP_MODULE_ID=iec62439, lreDefaultGrp=lreDefaultGrp, lreCntUniqueB=lreCntUniqueB, brp=brp, lreNodeType=lreNodeType, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreNodesEntry=lreNodesEntry, drp=drp, lreConfiguration=lreConfiguration, lreNodeName=lreNodeName, lreProxyNodeTable=lreProxyNodeTable, lreCntErrorsC=lreCntErrorsC, lreCntUniqueA=lreCntUniqueA, lreInterfaceConfigEntry=lreInterfaceConfigEntry, linkRedundancyConformance=linkRedundancyConformance, rrp=rrp, lrePortAdminStateA=lrePortAdminStateA, lreCntNodes=lreCntNodes, prp=prp, lreCntErrorsA=lreCntErrorsA)
