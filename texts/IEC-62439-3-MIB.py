...
# Produced by pysmi-1.1.8 at Fri Jan 13 11:56:27 2023
...
TimeTicks, Counter32, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, MibIdentifier, Integer32, IpAddress, ModuleIdentity, ObjectIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "MibIdentifier", "Integer32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntNodes=lreCntNodes, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntTxB=lreCntTxB, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreManufacturerName=lreManufacturerName, brp=brp, lreHsrLREMode=lreHsrLREMode, lreStatisticsInterfaces=lreStatisticsInterfaces, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntErrWrongLanB=lreCntErrWrongLanB, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreConfigurationInterfaces=lreConfigurationInterfaces, lreProxyNodeEntry=lreProxyNodeEntry, lreLinkStatusB=lreLinkStatusB, lreCntRxA=lreCntRxA, lreTimeLastSeenA=lreTimeLastSeenA, lreVersionName=lreVersionName, lreCntOwnRxB=lreCntOwnRxB, linkRedundancyConformance=linkRedundancyConformance, rrp=rrp, lreRowStatus=lreRowStatus, lreLinkStatusA=lreLinkStatusA, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntDuplicateA=lreCntDuplicateA, lreGroups=lreGroups, lreNodesMacAddress=lreNodesMacAddress, lreCntUniqueC=lreCntUniqueC, lreNodeType=lreNodeType, lreEvaluateSupervision=lreEvaluateSupervision, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntTxC=lreCntTxC, lreCntDuplicateC=lreCntDuplicateC, lreCntOwnRxA=lreCntOwnRxA, lreNodesIndex=lreNodesIndex, lreCntRxC=lreCntRxC, lreNodesTable=lreNodesTable, lreDuplicateDiscard=lreDuplicateDiscard, lreCntMultiB=lreCntMultiB, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntUniqueB=lreCntUniqueB, SecondFraction=SecondFraction, drp=drp, prp=prp, PYSNMP_MODULE_ID=iec62439, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntErrWrongLanC=lreCntErrWrongLanC, lreStatistics=lreStatistics, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreRemNodeType=lreRemNodeType, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntProxyNodes=lreCntProxyNodes, lreProxyNodeIndex=lreProxyNodeIndex, lreCntErrWrongLanA=lreCntErrWrongLanA, iec62439=iec62439, lreCntDuplicateB=lreCntDuplicateB, lreProxyNodeTable=lreProxyNodeTable, lreTransparentReception=lreTransparentReception, lreCntUniqueA=lreCntUniqueA, lreCntRxB=lreCntRxB, lreTimeLastSeenB=lreTimeLastSeenB, mrp=mrp, lreCntTxA=lreCntTxA, lreNodesTableClear=lreNodesTableClear, linkRedundancyCompliances=linkRedundancyCompliances, lreCntMultiA=lreCntMultiA, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntMultiC=lreCntMultiC, lreSwitchingEndNode=lreSwitchingEndNode, crp=crp, lrePortAdminStateA=lrePortAdminStateA, lreNodesEntry=lreNodesEntry, lrePortAdminStateB=lrePortAdminStateB, lreRedBoxIdentity=lreRedBoxIdentity, lreCntErrorsB=lreCntErrorsB, lreDefaultGrp=lreDefaultGrp, linkRedundancyCompliance=linkRedundancyCompliance, lreMacAddress=lreMacAddress, ptp=ptp, lreNodeName=lreNodeName, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreDupListResideMaxTime=lreDupListResideMaxTime, lreConfiguration=lreConfiguration, lreCntErrorsA=lreCntErrorsA, lreInterfaceCount=lreInterfaceCount, lreCntErrorsC=lreCntErrorsC)
