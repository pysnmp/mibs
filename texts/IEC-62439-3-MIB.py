...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, ObjectIdentity, Counter64, Unsigned32, Counter32, Integer32, ModuleIdentity, TimeTicks, Gauge32, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "ObjectIdentity", "Counter64", "Unsigned32", "Counter32", "Integer32", "ModuleIdentity", "TimeTicks", "Gauge32", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreNodeType=lreNodeType, lreCntRxC=lreCntRxC, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntDuplicateB=lreCntDuplicateB, lreNodesEntry=lreNodesEntry, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, PYSNMP_MODULE_ID=iec62439, lreDefaultGrp=lreDefaultGrp, mrp=mrp, lreLinkStatusA=lreLinkStatusA, lreCntRxB=lreCntRxB, lreSwitchingEndNode=lreSwitchingEndNode, lreRedBoxIdentity=lreRedBoxIdentity, lreCntUniqueB=lreCntUniqueB, lreInterfaceCount=lreInterfaceCount, lreCntDuplicateA=lreCntDuplicateA, linkRedundancyCompliances=linkRedundancyCompliances, lreManufacturerName=lreManufacturerName, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntErrorsC=lreCntErrorsC, lrePortAdminStateA=lrePortAdminStateA, lreMacAddress=lreMacAddress, lreCntTxC=lreCntTxC, lreCntMultiC=lreCntMultiC, lreCntErrorsA=lreCntErrorsA, lreNodesTableClear=lreNodesTableClear, lreCntMultiB=lreCntMultiB, lreProxyNodeMacAddress=lreProxyNodeMacAddress, brp=brp, lreEvaluateSupervision=lreEvaluateSupervision, iec62439=iec62439, lreCntMultiA=lreCntMultiA, lreRemNodeType=lreRemNodeType, ptp=ptp, lreCntUniqueA=lreCntUniqueA, lreLinkStatusB=lreLinkStatusB, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntOwnRxB=lreCntOwnRxB, lreStatisticsInterfaces=lreStatisticsInterfaces, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreConfiguration=lreConfiguration, lreNodesIndex=lreNodesIndex, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntTxB=lreCntTxB, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreProxyNodeTable=lreProxyNodeTable, lreCntErrorsB=lreCntErrorsB, lreTimeLastSeenA=lreTimeLastSeenA, lreCntNodes=lreCntNodes, lreTransparentReception=lreTransparentReception, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreVersionName=lreVersionName, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntProxyNodes=lreCntProxyNodes, linkRedundancyConformance=linkRedundancyConformance, lreDuplicateDiscard=lreDuplicateDiscard, linkRedundancyCompliance=linkRedundancyCompliance, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreNodesTable=lreNodesTable, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntOwnRxA=lreCntOwnRxA, lreConfigurationInterfaces=lreConfigurationInterfaces, lreTimeLastSeenB=lreTimeLastSeenB, lreInterfaceConfigTable=lreInterfaceConfigTable, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lrePortAdminStateB=lrePortAdminStateB, lreNodeName=lreNodeName, rrp=rrp, lreCntTxA=lreCntTxA, lreNodesMacAddress=lreNodesMacAddress, lreProxyNodeEntry=lreProxyNodeEntry, lreCntRxA=lreCntRxA, lreProxyNodeIndex=lreProxyNodeIndex, lreDupListResideMaxTime=lreDupListResideMaxTime, lreRowStatus=lreRowStatus, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntDuplicateC=lreCntDuplicateC, SecondFraction=SecondFraction, prp=prp, lreHsrLREMode=lreHsrLREMode, lreGroups=lreGroups, drp=drp, crp=crp, lreCntUniqueC=lreCntUniqueC, lreStatistics=lreStatistics)
