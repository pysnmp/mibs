...
Counter32, Counter64, Unsigned32, Bits, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Integer32, Gauge32, MibIdentifier, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Unsigned32", "Bits", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Integer32", "Gauge32", "MibIdentifier", "NotificationType", "iso")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", ptp=ptp, lreStatisticsInterfaces=lreStatisticsInterfaces, lreTimeLastSeenA=lreTimeLastSeenA, lreStatistics=lreStatistics, lreCntRxC=lreCntRxC, lreProxyNodeEntry=lreProxyNodeEntry, lreCntMultiA=lreCntMultiA, SecondFraction=SecondFraction, lreRemNodeType=lreRemNodeType, linkRedundancyConformance=linkRedundancyConformance, linkRedundancyEntityConformance=linkRedundancyEntityConformance, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, linkRedundancyCompliances=linkRedundancyCompliances, mrp=mrp, rrp=rrp, lreCntMultiC=lreCntMultiC, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntDuplicateA=lreCntDuplicateA, lreCntUniqueB=lreCntUniqueB, lreLinkStatusA=lreLinkStatusA, lreNodesTableClear=lreNodesTableClear, lreCntNodes=lreCntNodes, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntTxC=lreCntTxC, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntRxA=lreCntRxA, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntUniqueA=lreCntUniqueA, lreConfiguration=lreConfiguration, lreCntTxB=lreCntTxB, lreCntErrorsA=lreCntErrorsA, lreNodeType=lreNodeType, lreCntOwnRxB=lreCntOwnRxB, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreProxyNodeTableClear=lreProxyNodeTableClear, lreConfigurationInterfaces=lreConfigurationInterfaces, lreNodesEntry=lreNodesEntry, lreCntErrWrongLanC=lreCntErrWrongLanC, lreNodesTable=lreNodesTable, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreProxyNodeTable=lreProxyNodeTable, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreManufacturerName=lreManufacturerName, lrePortAdminStateA=lrePortAdminStateA, lreCntRxB=lreCntRxB, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntErrWrongLanB=lreCntErrWrongLanB, lreNodesMacAddress=lreNodesMacAddress, lreHsrLREMode=lreHsrLREMode, lreProxyNodeIndex=lreProxyNodeIndex, lreSwitchingEndNode=lreSwitchingEndNode, lreProxyNodeMacAddress=lreProxyNodeMacAddress, drp=drp, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntDuplicateC=lreCntDuplicateC, lreDuplicateDiscard=lreDuplicateDiscard, PYSNMP_MODULE_ID=iec62439, crp=crp, brp=brp, lreCntUniqueC=lreCntUniqueC, lreTimeLastSeenB=lreTimeLastSeenB, iec62439=iec62439, lreCntDuplicateB=lreCntDuplicateB, linkRedundancyCompliance=linkRedundancyCompliance, lreCntMultiB=lreCntMultiB, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntErrorsC=lreCntErrorsC, lreCntProxyNodes=lreCntProxyNodes, lreTransparentReception=lreTransparentReception, lreEvaluateSupervision=lreEvaluateSupervision, lreDefaultGrp=lreDefaultGrp, lreNodeName=lreNodeName, lreRedBoxIdentity=lreRedBoxIdentity, lreVersionName=lreVersionName, lreCntOwnRxA=lreCntOwnRxA, lreMacAddress=lreMacAddress, lreInterfaceCount=lreInterfaceCount, lreLinkStatusB=lreLinkStatusB, lreGroups=lreGroups, lreRowStatus=lreRowStatus, prp=prp, lrePortAdminStateB=lrePortAdminStateB, lreNodesIndex=lreNodesIndex, lreCntTxA=lreCntTxA, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntErrorsB=lreCntErrorsB)
