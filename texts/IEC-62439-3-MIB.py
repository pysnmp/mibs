...
ObjectIdentity, TimeTicks, NotificationType, Integer32, MibIdentifier, iso, IpAddress, ModuleIdentity, Bits, Unsigned32, Gauge32, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "NotificationType", "Integer32", "MibIdentifier", "iso", "IpAddress", "ModuleIdentity", "Bits", "Unsigned32", "Gauge32", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", ptp=ptp, SecondFraction=SecondFraction, linkRedundancyCompliances=linkRedundancyCompliances, lreCntMultiC=lreCntMultiC, lreCntErrorsB=lreCntErrorsB, lreNodesTable=lreNodesTable, lreLinkStatusB=lreLinkStatusB, lrePortAdminStateB=lrePortAdminStateB, lreCntErrorsA=lreCntErrorsA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreTimeLastSeenA=lreTimeLastSeenA, lreCntNodes=lreCntNodes, lreRowStatus=lreRowStatus, lreNodeName=lreNodeName, lreStatistics=lreStatistics, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreNodesIndex=lreNodesIndex, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntDuplicateC=lreCntDuplicateC, lreCntRxA=lreCntRxA, lreNodesMacAddress=lreNodesMacAddress, lreConfiguration=lreConfiguration, lreCntDuplicateB=lreCntDuplicateB, lreCntOwnRxB=lreCntOwnRxB, lreStatisticsInterfaces=lreStatisticsInterfaces, linkRedundancyConformance=linkRedundancyConformance, lreRedBoxIdentity=lreRedBoxIdentity, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreGroups=lreGroups, lreManufacturerName=lreManufacturerName, rrp=rrp, lreCntErrWrongLanB=lreCntErrWrongLanB, iec62439=iec62439, lreCntRxB=lreCntRxB, prp=prp, lreCntUniqueC=lreCntUniqueC, crp=crp, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntRxC=lreCntRxC, lreCntErrWrongLanA=lreCntErrWrongLanA, lreHsrLREMode=lreHsrLREMode, lreDefaultGrp=lreDefaultGrp, brp=brp, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreSwitchingEndNode=lreSwitchingEndNode, lreCntUniqueB=lreCntUniqueB, mrp=mrp, lreCntTxB=lreCntTxB, lreCntMultiA=lreCntMultiA, lreCntErrorsC=lreCntErrorsC, lreTransparentReception=lreTransparentReception, lreCntTxC=lreCntTxC, lreDuplicateDiscard=lreDuplicateDiscard, lreProxyNodeTableClear=lreProxyNodeTableClear, linkRedundancyCompliance=linkRedundancyCompliance, lreRemNodeType=lreRemNodeType, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntProxyNodes=lreCntProxyNodes, lreCntOwnRxA=lreCntOwnRxA, lreProxyNodeIndex=lreProxyNodeIndex, lreProxyNodeEntry=lreProxyNodeEntry, lreTimeLastSeenB=lreTimeLastSeenB, lreInterfaceConfigTable=lreInterfaceConfigTable, lreCntUniqueA=lreCntUniqueA, lreCntDuplicateA=lreCntDuplicateA, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreLinkStatusA=lreLinkStatusA, lreCntMultiB=lreCntMultiB, lreCntErrWrongLanC=lreCntErrWrongLanC, lreEvaluateSupervision=lreEvaluateSupervision, PYSNMP_MODULE_ID=iec62439, lreProxyNodeTable=lreProxyNodeTable, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreNodeType=lreNodeType, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreNodesEntry=lreNodesEntry, lrePortAdminStateA=lrePortAdminStateA, lreConfigurationInterfaces=lreConfigurationInterfaces, lreInterfaceCount=lreInterfaceCount, lreNodesTableClear=lreNodesTableClear, lreCntTxA=lreCntTxA, lreMacAddress=lreMacAddress, lreVersionName=lreVersionName, drp=drp, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreInterfaceConfigIndex=lreInterfaceConfigIndex)
