...
ModuleIdentity, Unsigned32, MibIdentifier, iso, IpAddress, NotificationType, TimeTicks, Counter32, Gauge32, Bits, Counter64, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "MibIdentifier", "iso", "IpAddress", "NotificationType", "TimeTicks", "Counter32", "Gauge32", "Bits", "Counter64", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreRowStatus=lreRowStatus, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntTxB=lreCntTxB, lreNodesTableClear=lreNodesTableClear, mrp=mrp, lreCntRxB=lreCntRxB, lreSwitchingEndNode=lreSwitchingEndNode, lreTimeLastSeenB=lreTimeLastSeenB, lreLinkStatusB=lreLinkStatusB, lreEvaluateSupervision=lreEvaluateSupervision, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreTimeLastSeenA=lreTimeLastSeenA, lreManufacturerName=lreManufacturerName, lreProxyNodeEntry=lreProxyNodeEntry, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntRxC=lreCntRxC, lreCntUniqueB=lreCntUniqueB, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntDuplicateA=lreCntDuplicateA, lrePortAdminStateA=lrePortAdminStateA, lreCntUniqueA=lreCntUniqueA, brp=brp, lreCntMultiC=lreCntMultiC, lreCntProxyNodes=lreCntProxyNodes, lreCntUniqueC=lreCntUniqueC, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreRedBoxIdentity=lreRedBoxIdentity, crp=crp, lreHsrLREMode=lreHsrLREMode, SecondFraction=SecondFraction, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntMultiB=lreCntMultiB, lreProxyNodeTable=lreProxyNodeTable, iec62439=iec62439, lreCntRxA=lreCntRxA, linkRedundancyCompliance=linkRedundancyCompliance, lreCntTxA=lreCntTxA, ptp=ptp, lreCntDuplicateB=lreCntDuplicateB, rrp=rrp, lreGroups=lreGroups, lreDupListResideMaxTime=lreDupListResideMaxTime, lreMacAddress=lreMacAddress, lreNodesMacAddress=lreNodesMacAddress, lreInterfaceStatsEntry=lreInterfaceStatsEntry, prp=prp, lreConfiguration=lreConfiguration, lreInterfaceConfigTable=lreInterfaceConfigTable, lreTransparentReception=lreTransparentReception, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntOwnRxB=lreCntOwnRxB, lreInterfaceCount=lreInterfaceCount, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntErrWrongLanB=lreCntErrWrongLanB, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lrePortAdminStateB=lrePortAdminStateB, lreNodeType=lreNodeType, lreCntMultiA=lreCntMultiA, lreStatistics=lreStatistics, lreProxyNodeIndex=lreProxyNodeIndex, linkRedundancyConformance=linkRedundancyConformance, lreDuplicateDiscard=lreDuplicateDiscard, linkRedundancyCompliances=linkRedundancyCompliances, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, drp=drp, lreCntNodes=lreCntNodes, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntDuplicateC=lreCntDuplicateC, lreCntErrorsB=lreCntErrorsB, lreCntErrorsC=lreCntErrorsC, lreProxyNodeTableClear=lreProxyNodeTableClear, lreNodesIndex=lreNodesIndex, lreCntErrorsA=lreCntErrorsA, lreNodeName=lreNodeName, lreInterfaceStatsTable=lreInterfaceStatsTable, lreVersionName=lreVersionName, lreCntTxC=lreCntTxC, lreCntOwnRxA=lreCntOwnRxA, lreRemNodeType=lreRemNodeType, lreDefaultGrp=lreDefaultGrp, PYSNMP_MODULE_ID=iec62439, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreStatisticsInterfaces=lreStatisticsInterfaces, lreLinkStatusA=lreLinkStatusA, lreNodesTable=lreNodesTable, lreNodesEntry=lreNodesEntry)
