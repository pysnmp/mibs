...
IpAddress, MibIdentifier, NotificationType, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, ModuleIdentity, Counter64, Gauge32, Counter32, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "NotificationType", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Counter64", "Gauge32", "Counter32", "Bits", "Integer32")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntProxyNodes=lreCntProxyNodes, lreTimeLastSeenA=lreTimeLastSeenA, lreInterfaceCount=lreInterfaceCount, lreNodesIndex=lreNodesIndex, lreCntOwnRxA=lreCntOwnRxA, lreInterfaceConfigTable=lreInterfaceConfigTable, lrePortAdminStateA=lrePortAdminStateA, prp=prp, lreRemNodeType=lreRemNodeType, lreManufacturerName=lreManufacturerName, lreStatisticsInterfaces=lreStatisticsInterfaces, rrp=rrp, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntMultiA=lreCntMultiA, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntOwnRxB=lreCntOwnRxB, lreCntMultiB=lreCntMultiB, lreCntTxA=lreCntTxA, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntDuplicateB=lreCntDuplicateB, lreCntRxA=lreCntRxA, lreStatistics=lreStatistics, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreNodesTableClear=lreNodesTableClear, lreCntNodes=lreCntNodes, lreCntUniqueC=lreCntUniqueC, lreGroups=lreGroups, lreCntDuplicateA=lreCntDuplicateA, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreRedBoxIdentity=lreRedBoxIdentity, lreNodesEntry=lreNodesEntry, lreProxyNodeMacAddress=lreProxyNodeMacAddress, drp=drp, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreDefaultGrp=lreDefaultGrp, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreDupListResideMaxTime=lreDupListResideMaxTime, lreNodesMacAddress=lreNodesMacAddress, lreCntUniqueB=lreCntUniqueB, lreLinkStatusA=lreLinkStatusA, lreConfiguration=lreConfiguration, lreNodeType=lreNodeType, lreRowStatus=lreRowStatus, lreProxyNodeEntry=lreProxyNodeEntry, PYSNMP_MODULE_ID=iec62439, lreLinkStatusB=lreLinkStatusB, lreCntTxB=lreCntTxB, mrp=mrp, brp=brp, lreProxyNodeTableClear=lreProxyNodeTableClear, lreTransparentReception=lreTransparentReception, lreCntErrorsB=lreCntErrorsB, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntMultiC=lreCntMultiC, lreDuplicateDiscard=lreDuplicateDiscard, lreCntUniqueA=lreCntUniqueA, lrePortAdminStateB=lrePortAdminStateB, lreCntErrorsC=lreCntErrorsC, crp=crp, lreCntRxC=lreCntRxC, lreNodesTable=lreNodesTable, lreCntErrorsA=lreCntErrorsA, SecondFraction=SecondFraction, lreCntDuplicateC=lreCntDuplicateC, lreCntErrWrongLanA=lreCntErrWrongLanA, lreMacAddress=lreMacAddress, linkRedundancyConformance=linkRedundancyConformance, lreHsrLREMode=lreHsrLREMode, linkRedundancyCompliances=linkRedundancyCompliances, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreNodeName=lreNodeName, lreVersionName=lreVersionName, ptp=ptp, iec62439=iec62439, lreSwitchingEndNode=lreSwitchingEndNode, lreProxyNodeIndex=lreProxyNodeIndex, lreEvaluateSupervision=lreEvaluateSupervision, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreTimeLastSeenB=lreTimeLastSeenB, lreCntTxC=lreCntTxC, lreCntErrWrongLanC=lreCntErrWrongLanC, lreProxyNodeTable=lreProxyNodeTable, linkRedundancyCompliance=linkRedundancyCompliance, lreCntErrWrongLanB=lreCntErrWrongLanB, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntRxB=lreCntRxB)
