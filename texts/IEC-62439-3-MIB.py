...
Counter32, ModuleIdentity, MibIdentifier, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Integer32, iso, NotificationType, Gauge32, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "MibIdentifier", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Integer32", "iso", "NotificationType", "Gauge32", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntMultiB=lreCntMultiB, PYSNMP_MODULE_ID=iec62439, lreMacAddress=lreMacAddress, lreVersionName=lreVersionName, lreCntDuplicateB=lreCntDuplicateB, lreProxyNodeEntry=lreProxyNodeEntry, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, brp=brp, lreCntProxyNodes=lreCntProxyNodes, lreNodesIndex=lreNodesIndex, lreGroups=lreGroups, lreProxyNodeTableClear=lreProxyNodeTableClear, linkRedundancyCompliances=linkRedundancyCompliances, lreSwitchingEndNode=lreSwitchingEndNode, lreDuplicateDiscard=lreDuplicateDiscard, lreCntTxA=lreCntTxA, lreStatistics=lreStatistics, lreRemNodeType=lreRemNodeType, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreNodesMacAddress=lreNodesMacAddress, lreTimeLastSeenB=lreTimeLastSeenB, lreNodesTableClear=lreNodesTableClear, lreCntUniqueB=lreCntUniqueB, lreProxyNodeMacAddress=lreProxyNodeMacAddress, linkRedundancyConformance=linkRedundancyConformance, lreCntErrorsC=lreCntErrorsC, lreCntUniqueC=lreCntUniqueC, lreCntRxB=lreCntRxB, lreTimeLastSeenA=lreTimeLastSeenA, linkRedundancyCompliance=linkRedundancyCompliance, lreLinkStatusB=lreLinkStatusB, lreCntErrorsB=lreCntErrorsB, lreProxyNodeTable=lreProxyNodeTable, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreEvaluateSupervision=lreEvaluateSupervision, lreProxyNodeIndex=lreProxyNodeIndex, lreConfiguration=lreConfiguration, lreCntErrWrongLanC=lreCntErrWrongLanC, lreManufacturerName=lreManufacturerName, lreCntOwnRxB=lreCntOwnRxB, lreCntMultiA=lreCntMultiA, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, mrp=mrp, lrePortAdminStateB=lrePortAdminStateB, lreHsrLREMode=lreHsrLREMode, lreNodeType=lreNodeType, lreInterfaceConfigTable=lreInterfaceConfigTable, lreNodeName=lreNodeName, lreCntErrorsA=lreCntErrorsA, SecondFraction=SecondFraction, lreInterfaceConfigEntry=lreInterfaceConfigEntry, rrp=rrp, lreRedBoxIdentity=lreRedBoxIdentity, crp=crp, lreDefaultGrp=lreDefaultGrp, lreInterfaceCount=lreInterfaceCount, lreCntDuplicateA=lreCntDuplicateA, lreNodesEntry=lreNodesEntry, lreInterfaceStatsTable=lreInterfaceStatsTable, lreConfigurationInterfaces=lreConfigurationInterfaces, ptp=ptp, lreCntDuplicateC=lreCntDuplicateC, lreCntTxB=lreCntTxB, iec62439=iec62439, prp=prp, lreCntErrWrongLanB=lreCntErrWrongLanB, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntMultiC=lreCntMultiC, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreCntUniqueA=lreCntUniqueA, lreNodesTable=lreNodesTable, drp=drp, lreCntNodes=lreCntNodes, lreCntOwnRxA=lreCntOwnRxA, lreRowStatus=lreRowStatus, lreStatisticsInterfaces=lreStatisticsInterfaces, lreLinkStatusA=lreLinkStatusA, lreCntErrWrongLanA=lreCntErrWrongLanA, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntRxC=lreCntRxC, lreCntRxA=lreCntRxA, lreTransparentReception=lreTransparentReception, lreCntTxC=lreCntTxC, lrePortAdminStateA=lrePortAdminStateA, lreDupListResideMaxTime=lreDupListResideMaxTime)
