...
ModuleIdentity, ObjectIdentity, Counter64, IpAddress, Counter32, TimeTicks, Unsigned32, MibIdentifier, iso, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Counter64", "IpAddress", "Counter32", "TimeTicks", "Unsigned32", "MibIdentifier", "iso", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntRxC=lreCntRxC, SecondFraction=SecondFraction, lreCntDuplicateA=lreCntDuplicateA, lreProxyNodeEntry=lreProxyNodeEntry, linkRedundancyEntityObjects=linkRedundancyEntityObjects, linkRedundancyCompliances=linkRedundancyCompliances, linkRedundancyConformance=linkRedundancyConformance, lreTimeLastSeenA=lreTimeLastSeenA, lreNodeName=lreNodeName, lreCntMultiA=lreCntMultiA, drp=drp, lrePortAdminStateA=lrePortAdminStateA, lreCntMultiB=lreCntMultiB, lreCntUniqueC=lreCntUniqueC, lreCntDuplicateC=lreCntDuplicateC, lreTransparentReception=lreTransparentReception, lreInterfaceStatsTable=lreInterfaceStatsTable, lreLinkStatusB=lreLinkStatusB, lreVersionName=lreVersionName, linkRedundancyCompliance=linkRedundancyCompliance, lreMacAddress=lreMacAddress, lreGroups=lreGroups, lreDefaultGrp=lreDefaultGrp, lreCntRxA=lreCntRxA, lreStatistics=lreStatistics, lreCntTxB=lreCntTxB, prp=prp, lreProxyNodeIndex=lreProxyNodeIndex, lreProxyNodeTable=lreProxyNodeTable, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreNodesIndex=lreNodesIndex, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreSwitchingEndNode=lreSwitchingEndNode, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreCntErrorsC=lreCntErrorsC, mrp=mrp, linkRedundancyEntityConformance=linkRedundancyEntityConformance, PYSNMP_MODULE_ID=iec62439, ptp=ptp, iec62439=iec62439, lreCntOwnRxB=lreCntOwnRxB, lreCntUniqueB=lreCntUniqueB, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntRxB=lreCntRxB, lreInterfaceConfigTable=lreInterfaceConfigTable, lreHsrLREMode=lreHsrLREMode, lreNodesEntry=lreNodesEntry, lreRedBoxIdentity=lreRedBoxIdentity, lreRowStatus=lreRowStatus, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreCntErrorsB=lreCntErrorsB, lreCntOwnRxA=lreCntOwnRxA, lreConfiguration=lreConfiguration, lreNodesTableClear=lreNodesTableClear, brp=brp, lreCntErrorsA=lreCntErrorsA, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreCntTxC=lreCntTxC, lreCntDuplicateB=lreCntDuplicateB, lreCntErrWrongLanC=lreCntErrWrongLanC, lrePortAdminStateB=lrePortAdminStateB, lreCntProxyNodes=lreCntProxyNodes, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreNodesMacAddress=lreNodesMacAddress, lreCntTxA=lreCntTxA, crp=crp, lreStatisticsInterfaces=lreStatisticsInterfaces, lreInterfaceCount=lreInterfaceCount, lreCntMultiC=lreCntMultiC, rrp=rrp, lreLinkStatusA=lreLinkStatusA, lreCntNodes=lreCntNodes, lreDupListResideMaxTime=lreDupListResideMaxTime, lreNodeType=lreNodeType, lreManufacturerName=lreManufacturerName, lreDuplicateDiscard=lreDuplicateDiscard, lreRemNodeType=lreRemNodeType, lreNodesTable=lreNodesTable, lreEvaluateSupervision=lreEvaluateSupervision, lreCntUniqueA=lreCntUniqueA, lreProxyNodeTableClear=lreProxyNodeTableClear, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntErrWrongLanB=lreCntErrWrongLanB, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreTimeLastSeenB=lreTimeLastSeenB)
