...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, NotificationType, Gauge32, Unsigned32, ObjectIdentity, IpAddress, Bits, Counter64, iso, ModuleIdentity, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "NotificationType", "Gauge32", "Unsigned32", "ObjectIdentity", "IpAddress", "Bits", "Counter64", "iso", "ModuleIdentity", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", crp=crp, lreCntErrWrongLanB=lreCntErrWrongLanB, lreInterfaceConfigTable=lreInterfaceConfigTable, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntOwnRxB=lreCntOwnRxB, lreNodesTable=lreNodesTable, linkRedundancyCompliances=linkRedundancyCompliances, lreStatistics=lreStatistics, lreTimeLastSeenB=lreTimeLastSeenB, lreLinkStatusA=lreLinkStatusA, lreCntTxB=lreCntTxB, iec62439=iec62439, lreCntErrorsA=lreCntErrorsA, lreCntMultiA=lreCntMultiA, lreManufacturerName=lreManufacturerName, lreRowStatus=lreRowStatus, linkRedundancyConformance=linkRedundancyConformance, lreProxyNodeIndex=lreProxyNodeIndex, SecondFraction=SecondFraction, lreProxyNodeTableClear=lreProxyNodeTableClear, drp=drp, lreCntMultiC=lreCntMultiC, lreEvaluateSupervision=lreEvaluateSupervision, lreTransparentReception=lreTransparentReception, lreNodesIndex=lreNodesIndex, brp=brp, lreCntRxB=lreCntRxB, lreCntDuplicateC=lreCntDuplicateC, lreStatisticsInterfaces=lreStatisticsInterfaces, mrp=mrp, lreCntTxC=lreCntTxC, lreCntErrorsC=lreCntErrorsC, lreNodesTableClear=lreNodesTableClear, lreCntErrWrongLanA=lreCntErrWrongLanA, lreNodeName=lreNodeName, lreCntTxA=lreCntTxA, lreVersionName=lreVersionName, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lrePortAdminStateA=lrePortAdminStateA, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreHsrLREMode=lreHsrLREMode, lreTimeLastSeenA=lreTimeLastSeenA, lreInterfaceConfigEntry=lreInterfaceConfigEntry, rrp=rrp, lreDuplicateDiscard=lreDuplicateDiscard, lrePortAdminStateB=lrePortAdminStateB, lreNodesMacAddress=lreNodesMacAddress, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntUniqueB=lreCntUniqueB, lreConfigurationInterfaces=lreConfigurationInterfaces, lreInterfaceCount=lreInterfaceCount, PYSNMP_MODULE_ID=iec62439, linkRedundancyCompliance=linkRedundancyCompliance, lreCntUniqueA=lreCntUniqueA, lreRedBoxIdentity=lreRedBoxIdentity, lreCntRxC=lreCntRxC, lreProxyNodeEntry=lreProxyNodeEntry, lreRemNodeType=lreRemNodeType, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreCntDuplicateB=lreCntDuplicateB, lreConfiguration=lreConfiguration, lreCntErrorsB=lreCntErrorsB, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreProxyNodeTable=lreProxyNodeTable, lreCntDuplicateA=lreCntDuplicateA, lreMacAddress=lreMacAddress, lreDupListResideMaxTime=lreDupListResideMaxTime, lreSwitchingEndNode=lreSwitchingEndNode, lreCntProxyNodes=lreCntProxyNodes, lreCntOwnRxA=lreCntOwnRxA, lreNodesEntry=lreNodesEntry, lreInterfaceConfigIndex=lreInterfaceConfigIndex, ptp=ptp, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreCntNodes=lreCntNodes, lreCntMultiB=lreCntMultiB, lreCntRxA=lreCntRxA, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreGroups=lreGroups, lreLinkStatusB=lreLinkStatusB, prp=prp, lreInterfaceStatsTable=lreInterfaceStatsTable, lreNodeType=lreNodeType, lreDefaultGrp=lreDefaultGrp, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntUniqueC=lreCntUniqueC)
