...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Unsigned32, NotificationType, MibIdentifier, iso, Bits, Integer32, Counter64, ModuleIdentity, Counter32, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Unsigned32", "NotificationType", "MibIdentifier", "iso", "Bits", "Integer32", "Counter64", "ModuleIdentity", "Counter32", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntDuplicateA=lreCntDuplicateA, lreNodesTable=lreNodesTable, lreDuplicateDiscard=lreDuplicateDiscard, lreLinkStatusA=lreLinkStatusA, lreRowStatus=lreRowStatus, lreEvaluateSupervision=lreEvaluateSupervision, lreProxyNodeTable=lreProxyNodeTable, iec62439=iec62439, lreNodesTableClear=lreNodesTableClear, lreVersionName=lreVersionName, lreRedBoxIdentity=lreRedBoxIdentity, lreCntNodes=lreCntNodes, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreInterfaceConfigTable=lreInterfaceConfigTable, lreNodesEntry=lreNodesEntry, lreCntDuplicateC=lreCntDuplicateC, lreCntUniqueB=lreCntUniqueB, lreCntMultiB=lreCntMultiB, mrp=mrp, lrePortAdminStateA=lrePortAdminStateA, linkRedundancyCompliance=linkRedundancyCompliance, lreHsrLREMode=lreHsrLREMode, drp=drp, lreCntDuplicateB=lreCntDuplicateB, lreGroups=lreGroups, lreInterfaceCount=lreInterfaceCount, lreProxyNodeEntry=lreProxyNodeEntry, prp=prp, lreCntTxB=lreCntTxB, lreConfigurationInterfaces=lreConfigurationInterfaces, lreDefaultGrp=lreDefaultGrp, lreCntProxyNodes=lreCntProxyNodes, lreTimeLastSeenB=lreTimeLastSeenB, lreCntMultiA=lreCntMultiA, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreManufacturerName=lreManufacturerName, lreSwitchingEndNode=lreSwitchingEndNode, lrePortAdminStateB=lrePortAdminStateB, crp=crp, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreMacAddress=lreMacAddress, lreDupListResideMaxTime=lreDupListResideMaxTime, brp=brp, lreProxyNodeMacAddress=lreProxyNodeMacAddress, PYSNMP_MODULE_ID=iec62439, lreRemNodeType=lreRemNodeType, lreCntRxC=lreCntRxC, lreCntUniqueA=lreCntUniqueA, SecondFraction=SecondFraction, lreCntErrorsB=lreCntErrorsB, lreCntErrorsA=lreCntErrorsA, lreInterfaceStatsTable=lreInterfaceStatsTable, lreCntErrWrongLanB=lreCntErrWrongLanB, lreCntRxB=lreCntRxB, lreCntErrorsC=lreCntErrorsC, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreCntErrWrongLanA=lreCntErrWrongLanA, lreCntTxA=lreCntTxA, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntMultiC=lreCntMultiC, lreConfiguration=lreConfiguration, lreNodesMacAddress=lreNodesMacAddress, ptp=ptp, lreCntErrWrongLanC=lreCntErrWrongLanC, linkRedundancyConformance=linkRedundancyConformance, lreCntOwnRxB=lreCntOwnRxB, lreTimeLastSeenA=lreTimeLastSeenA, lreNodeType=lreNodeType, lreCntTxC=lreCntTxC, lreLinkStatusB=lreLinkStatusB, lreProxyNodeIndex=lreProxyNodeIndex, lreStatistics=lreStatistics, lreProxyNodeTableClear=lreProxyNodeTableClear, lreTransparentReception=lreTransparentReception, rrp=rrp, lreStatisticsInterfaces=lreStatisticsInterfaces, lreCntRxA=lreCntRxA, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreNodesIndex=lreNodesIndex, lreCntOwnRxA=lreCntOwnRxA, linkRedundancyCompliances=linkRedundancyCompliances, lreNodeName=lreNodeName, lreCntUniqueC=lreCntUniqueC, linkRedundancyEntityObjects=linkRedundancyEntityObjects)
