...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:12:06 2022
...
Counter64, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, iso, IpAddress, MibIdentifier, ModuleIdentity, ObjectIdentity, Integer32, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "iso", "IpAddress", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Integer32", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntProxyNodes=lreCntProxyNodes, iec62439=iec62439, lrePortAdminStateA=lrePortAdminStateA, lreCntUniqueC=lreCntUniqueC, linkRedundancyConformance=linkRedundancyConformance, lreRemNodeType=lreRemNodeType, prp=prp, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreCntTxB=lreCntTxB, lreCntMultiB=lreCntMultiB, lreCntDuplicateC=lreCntDuplicateC, lreCntMultiA=lreCntMultiA, lreTimeLastSeenA=lreTimeLastSeenA, lreNodeName=lreNodeName, lreCntTxC=lreCntTxC, lreCntErrorsA=lreCntErrorsA, lrePortAdminStateB=lrePortAdminStateB, lreCntErrorsB=lreCntErrorsB, lreCntErrWrongLanC=lreCntErrWrongLanC, lreRedBoxIdentity=lreRedBoxIdentity, lreProxyNodeIndex=lreProxyNodeIndex, lreCntRxB=lreCntRxB, lreCntErrWrongLanA=lreCntErrWrongLanA, lreInterfaceStatsIndex=lreInterfaceStatsIndex, lreNodesEntry=lreNodesEntry, lreNodesTableClear=lreNodesTableClear, lreHsrLREMode=lreHsrLREMode, lreMacAddress=lreMacAddress, lreSwitchingEndNode=lreSwitchingEndNode, lreProxyNodeTableClear=lreProxyNodeTableClear, lreInterfaceStatsEntry=lreInterfaceStatsEntry, lreTimeLastSeenB=lreTimeLastSeenB, lreProxyNodeEntry=lreProxyNodeEntry, lreCntOwnRxA=lreCntOwnRxA, linkRedundancyEntityObjects=linkRedundancyEntityObjects, brp=brp, lreCntDuplicateA=lreCntDuplicateA, lreInterfaceStatsTable=lreInterfaceStatsTable, lreNodesIndex=lreNodesIndex, lreNodeType=lreNodeType, lreProxyNodeMacAddress=lreProxyNodeMacAddress, lreCntNodes=lreCntNodes, lreInterfaceCount=lreInterfaceCount, lreConfiguration=lreConfiguration, lreStatisticsInterfaces=lreStatisticsInterfaces, ptp=ptp, linkRedundancyCompliances=linkRedundancyCompliances, lreCntOwnRxB=lreCntOwnRxB, linkRedundancyCompliance=linkRedundancyCompliance, lreVersionName=lreVersionName, lreCntRxA=lreCntRxA, lreNodesMacAddress=lreNodesMacAddress, SecondFraction=SecondFraction, lreLinkStatusA=lreLinkStatusA, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreStatistics=lreStatistics, crp=crp, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreGroups=lreGroups, lreCntRxC=lreCntRxC, lreNodesTable=lreNodesTable, PYSNMP_MODULE_ID=iec62439, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntDuplicateB=lreCntDuplicateB, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreEvaluateSupervision=lreEvaluateSupervision, lreCntErrWrongLanB=lreCntErrWrongLanB, rrp=rrp, lreDupListResideMaxTime=lreDupListResideMaxTime, lreCntTxA=lreCntTxA, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreConfigurationInterfaces=lreConfigurationInterfaces, lreProxyNodeTable=lreProxyNodeTable, lreDefaultGrp=lreDefaultGrp, lreLinkStatusB=lreLinkStatusB, lreCntErrorsC=lreCntErrorsC, lreCntMultiC=lreCntMultiC, drp=drp, lreDuplicateDiscard=lreDuplicateDiscard, lreCntUniqueA=lreCntUniqueA, lreCntUniqueB=lreCntUniqueB, lreManufacturerName=lreManufacturerName, lreInterfaceConfigTable=lreInterfaceConfigTable, lreRowStatus=lreRowStatus, mrp=mrp, lreTransparentReception=lreTransparentReception)
