...
# Produced by pysmi-1.1.8 at Thu Oct 26 11:11:11 2023
...
MibIdentifier, ModuleIdentity, Counter32, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, iso, TimeTicks, Gauge32, IpAddress, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Counter32", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "iso", "TimeTicks", "Gauge32", "IpAddress", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("IEC-62439-3-MIB", lreCntErrorsA=lreCntErrorsA, lreCntErrWrongLanC=lreCntErrWrongLanC, lreCntRxB=lreCntRxB, lreStatistics=lreStatistics, lrePortAdminStateA=lrePortAdminStateA, lreInterfaceConfigIndex=lreInterfaceConfigIndex, lreProxyNodeTable=lreProxyNodeTable, prp=prp, lreConfiguration=lreConfiguration, lreProxyNodeIndex=lreProxyNodeIndex, lreCntUniqueA=lreCntUniqueA, lreCntRxA=lreCntRxA, linkRedundancyEntityConformance=linkRedundancyEntityConformance, lreCntDuplicateC=lreCntDuplicateC, lreCntUniqueC=lreCntUniqueC, lreMacAddress=lreMacAddress, lreStatisticsInterfaceGroup=lreStatisticsInterfaceGroup, lreCntErrWrongLanB=lreCntErrWrongLanB, drp=drp, linkRedundancyCompliance=linkRedundancyCompliance, lreRedBoxIdentity=lreRedBoxIdentity, lreCntTxA=lreCntTxA, lreCntMultiB=lreCntMultiB, linkRedundancyCompliances=linkRedundancyCompliances, lreEvaluateSupervision=lreEvaluateSupervision, lreTransparentReception=lreTransparentReception, lreCntTxC=lreCntTxC, lreCntOwnRxB=lreCntOwnRxB, lreTimeLastSeenA=lreTimeLastSeenA, lreLinkStatusA=lreLinkStatusA, lreCntMultiA=lreCntMultiA, lreCntNodes=lreCntNodes, lreDefaultGrp=lreDefaultGrp, lreConfigurationInterfaceGroup=lreConfigurationInterfaceGroup, lreNodesTableClear=lreNodesTableClear, SecondFraction=SecondFraction, lreCntDuplicateA=lreCntDuplicateA, linkRedundancyEntityNotifications=linkRedundancyEntityNotifications, lreNodesEntry=lreNodesEntry, lreNodeName=lreNodeName, lreNodesTable=lreNodesTable, ptp=ptp, lreInterfaceStatsIndex=lreInterfaceStatsIndex, PYSNMP_MODULE_ID=iec62439, lreProxyNodeEntry=lreProxyNodeEntry, lreNodesMacAddress=lreNodesMacAddress, lrePortAdminStateB=lrePortAdminStateB, lreInterfaceStatsTable=lreInterfaceStatsTable, lreStatisticsInterfaces=lreStatisticsInterfaces, brp=brp, lreManufacturerName=lreManufacturerName, lreProxyNodeTableClear=lreProxyNodeTableClear, lreConfigurationInterfaces=lreConfigurationInterfaces, lreCntMultiC=lreCntMultiC, lreInterfaceCount=lreInterfaceCount, lreCntOwnRxA=lreCntOwnRxA, lreCntUniqueB=lreCntUniqueB, linkRedundancyEntityObjects=linkRedundancyEntityObjects, lreDupListResideMaxTime=lreDupListResideMaxTime, lreInterfaceStatsEntry=lreInterfaceStatsEntry, rrp=rrp, lreGroups=lreGroups, lreDuplicateDiscard=lreDuplicateDiscard, lreSwitchingEndNode=lreSwitchingEndNode, lreRemNodeType=lreRemNodeType, lreCntErrorsC=lreCntErrorsC, lreHsrLREMode=lreHsrLREMode, lreCntErrorsB=lreCntErrorsB, lreRowStatus=lreRowStatus, lreInterfaceConfigEntry=lreInterfaceConfigEntry, lreVersionName=lreVersionName, mrp=mrp, lreCntRxC=lreCntRxC, lreInterfaceConfigTable=lreInterfaceConfigTable, lreNodesIndex=lreNodesIndex, lreNodeType=lreNodeType, lreCntProxyNodes=lreCntProxyNodes, lreProxyNodeMacAddress=lreProxyNodeMacAddress, linkRedundancyConformance=linkRedundancyConformance, lreCntErrWrongLanA=lreCntErrWrongLanA, crp=crp, lreLinkStatusB=lreLinkStatusB, lreCntTxB=lreCntTxB, lreCntDuplicateB=lreCntDuplicateB, iec62439=iec62439, lreConfigurationGeneralGroup=lreConfigurationGeneralGroup, lreTimeLastSeenB=lreTimeLastSeenB)
