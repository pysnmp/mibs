...
PrtAlertTrainingLevelTC, PrtMediaPathTypeTC, PrtOutputTypeTC, PrtConsoleDisableTC, PrtMarkerMarkTechTC, PrtCoverStatusTC, PrtAlertCodeTC, PrtGeneralResetTC, PrtConsoleColorTC, PrtInterpreterLangFamilyTC, PrtMarkerSuppliesTypeTC, PrtChannelTypeTC, PrtInputTypeTC, PrtAlertGroupTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertTrainingLevelTC", "PrtMediaPathTypeTC", "PrtOutputTypeTC", "PrtConsoleDisableTC", "PrtMarkerMarkTechTC", "PrtCoverStatusTC", "PrtAlertCodeTC", "PrtGeneralResetTC", "PrtConsoleColorTC", "PrtInterpreterLangFamilyTC", "PrtMarkerSuppliesTypeTC", "PrtChannelTypeTC", "PrtInputTypeTC", "PrtAlertGroupTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInputDescription=prtInputDescription, prtChannelIndex=prtChannelIndex, prtMIBCompliance=prtMIBCompliance, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, printerV1Alert=printerV1Alert, prtOutputIndex=prtOutputIndex, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInputEntry=prtInputEntry, prtMIB2Groups=prtMIB2Groups, prtChannelState=prtChannelState, prtMediaPathDescription=prtMediaPathDescription, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMediaPathType=prtMediaPathType, prtMarkerGroup=prtMarkerGroup, prtMediaPathGroup=prtMediaPathGroup, prtChannelGroup=prtChannelGroup, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInterpreter=prtInterpreter, prtAlertGroupIndex=prtAlertGroupIndex, prtConsoleLights=prtConsoleLights, prtOutputSecurity=prtOutputSecurity, prtMarkerSpotColorants=prtMarkerSpotColorants, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMediaPathStatus=prtMediaPathStatus, prtCoverDescription=prtCoverDescription, prtChannelTable=prtChannelTable, prtMIBGroups=prtMIBGroups, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInputIndex=prtInputIndex, prtInterpreterTwoWay=prtInterpreterTwoWay, prtOutputName=prtOutputName, prtLocalizationIndex=prtLocalizationIndex, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInputDefaultIndex=prtInputDefaultIndex, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtExtendedOutputGroup=prtExtendedOutputGroup, prtOutputDecollating=prtOutputDecollating, PrtChannelStateTC=PrtChannelStateTC, prtInputMediaColor=prtInputMediaColor, prtOutput=prtOutput, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtOutputMaxCapacity=prtOutputMaxCapacity, prtAlertTimeGroup=prtAlertTimeGroup, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtAlertTrapGroup=prtAlertTrapGroup, prtInterpreterTable=prtInterpreterTable, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputGroup=prtOutputGroup, prtOutputDescription=prtOutputDescription, prtLocalizationEntry=prtLocalizationEntry, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtExtendedInputGroup=prtExtendedInputGroup, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtAlert=prtAlert, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMediaPath=prtMediaPath, prtAlertLocation=prtAlertLocation, prtInputMediaGroup=prtInputMediaGroup, prtOutputModel=prtOutputModel, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerEntry=prtMarkerEntry, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerMarkTech=prtMarkerMarkTech, prtInterpreterIndex=prtInterpreterIndex, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMarkerWestMargin=prtMarkerWestMargin, prtMarkerIndex=prtMarkerIndex, prtMarkerStatus=prtMarkerStatus, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtAlertGroup=prtAlertGroup, prtInputSecurity=prtInputSecurity, prtInputMediaWeight=prtInputMediaWeight, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInterpreterGroup=prtInterpreterGroup, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtGeneralGroup=prtGeneralGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtOutputStackingOrder=prtOutputStackingOrder, prtInterpreterDescription=prtInterpreterDescription, prtOutputVendorName=prtOutputVendorName, prtLocalization=prtLocalization, prtInput=prtInput, prtStorageRefEntry=prtStorageRefEntry, prtMarkerTable=prtMarkerTable, prtStorageRefTable=prtStorageRefTable, prtStorageRefIndex=prtStorageRefIndex, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtCoverTable=prtCoverTable, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerColorantGroup=prtMarkerColorantGroup, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtAlertCode=prtAlertCode, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtGeneralV2Group=prtGeneralV2Group, prtAlertIndex=prtAlertIndex, prtConsoleDisable=prtConsoleDisable, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtConsoleDescription=prtConsoleDescription, PrtPrintOrientationTC=PrtPrintOrientationTC, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputTable=prtOutputTable, prtMediaPathTable=prtMediaPathTable, prtConsoleLightIndex=prtConsoleLightIndex, prtAlertEntry=prtAlertEntry, prtGeneralServicePerson=prtGeneralServicePerson, prtInputMediaFormParts=prtInputMediaFormParts, prtCoverIndex=prtCoverIndex, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtGeneralReset=prtGeneralReset, prtInputMediaName=prtInputMediaName, prtInputVersion=prtInputVersion, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtChannelType=prtChannelType, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtOutputPageCollated=prtOutputPageCollated, prtCoverStatus=prtCoverStatus, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtAlertTable=prtAlertTable, prtAlertTime=prtAlertTime, prtMarkerColorantValue=prtMarkerColorantValue, prtAlertTableGroup=prtAlertTableGroup, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtGeneralPrinterName=prtGeneralPrinterName, prtInterpreterEntry=prtInterpreterEntry, prtInputModel=prtInputModel, printerV2Alert=printerV2Alert, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtConsoleLocalization=prtConsoleLocalization, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtChannelIfIndex=prtChannelIfIndex, prtAlertSeverityLevel=prtAlertSeverityLevel, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInputGroup=prtInputGroup, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtDeviceRefTable=prtDeviceRefTable, prtConsoleOffTime=prtConsoleOffTime, PresentOnOff=PresentOnOff, prtGeneral=prtGeneral, prtMarker=prtMarker, prtGeneralTable=prtGeneralTable, prtConsoleLightTable=prtConsoleLightTable, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtOutputType=prtOutputType, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtLocalizationCharacterSet=prtLocalizationCharacterSet, MediaUnit=MediaUnit, prtInputDimUnit=prtInputDimUnit, prtOutputDimUnit=prtOutputDimUnit, prtMarkerLifeCount=prtMarkerLifeCount, prtInputName=prtInputName, prtChannelInformation=prtChannelInformation, prtOutputEntry=prtOutputEntry, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInterpreterVersion=prtInterpreterVersion, prtInputSerialNumber=prtInputSerialNumber, prtChannelV2Group=prtChannelV2Group, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerSupplies=prtMarkerSupplies, prtInputStatus=prtInputStatus, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerEastMargin=prtMarkerEastMargin, prtConsoleGroup=prtConsoleGroup, prtInputVendorName=prtInputVendorName, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMIB2Compliance=prtMIB2Compliance, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInterpreterLangFamily=prtInterpreterLangFamily, SubUnitStatus=SubUnitStatus, printerV2AlertPrefix=printerV2AlertPrefix, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMediaPathEntry=prtMediaPathEntry, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtInputCapacityUnit=prtInputCapacityUnit, prtInputNextIndex=prtInputNextIndex, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtAlertDescription=prtAlertDescription, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtLocalizationTable=prtLocalizationTable, prtInputTable=prtInputTable, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInputMaxCapacity=prtInputMaxCapacity, prtMediaPathIndex=prtMediaPathIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerColorant=prtMarkerColorant, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInputType=prtInputType, prtOutputVersion=prtOutputVersion, PrtSubUnitStatusTC=PrtSubUnitStatusTC, printmib=printmib, prtMarkerColorantRole=prtMarkerColorantRole, prtOutputDefaultIndex=prtOutputDefaultIndex, prtGeneralEntry=prtGeneralEntry, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInterpreterLangVersion=prtInterpreterLangVersion, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerColorantIndex=prtMarkerColorantIndex, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputStatus=prtOutputStatus, prtCover=prtCover, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMarkerSouthMargin=prtMarkerSouthMargin, CodedCharSet=CodedCharSet, prtAlertAllEvents=prtAlertAllEvents, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMarkerColorantTable=prtMarkerColorantTable, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMarkerCounterUnit=prtMarkerCounterUnit, prtChannelEntry=prtChannelEntry, CapacityUnit=CapacityUnit, prtConsoleColor=prtConsoleColor, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMIBConformance=prtMIBConformance, prtChannel=prtChannel, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtOutputBursting=prtOutputBursting, prtConsoleOnTime=prtConsoleOnTime, prtMarkerNorthMargin=prtMarkerNorthMargin, prtCoverEntry=prtCoverEntry, prtInputMediaType=prtInputMediaType, prtLocalizationCountry=prtLocalizationCountry, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtChannelStatus=prtChannelStatus)
mibBuilder.exportSymbols("Printer-MIB", prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerProcessColorants=prtMarkerProcessColorants, PYSNMP_MODULE_ID=printmib)
