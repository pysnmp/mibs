...
PrtConsoleColorTC, PrtGeneralResetTC, PrtMediaPathTypeTC, PrtInterpreterLangFamilyTC, PrtMarkerSuppliesTypeTC, PrtAlertTrainingLevelTC, PrtMarkerMarkTechTC, PrtAlertCodeTC, PrtChannelTypeTC, PrtConsoleDisableTC, PrtOutputTypeTC, PrtInputTypeTC, PrtAlertGroupTC, PrtCoverStatusTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleColorTC", "PrtGeneralResetTC", "PrtMediaPathTypeTC", "PrtInterpreterLangFamilyTC", "PrtMarkerSuppliesTypeTC", "PrtAlertTrainingLevelTC", "PrtMarkerMarkTechTC", "PrtAlertCodeTC", "PrtChannelTypeTC", "PrtConsoleDisableTC", "PrtOutputTypeTC", "PrtInputTypeTC", "PrtAlertGroupTC", "PrtCoverStatusTC")
...
mibBuilder.exportSymbols("Printer-MIB", PrtCapacityUnitTC=PrtCapacityUnitTC, prtOutputDecollating=prtOutputDecollating, prtGeneral=prtGeneral, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtConsoleLights=prtConsoleLights, prtInterpreterDescription=prtInterpreterDescription, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelInformation=prtChannelInformation, prtLocalization=prtLocalization, PrtMediaUnitTC=PrtMediaUnitTC, prtInputMediaGroup=prtInputMediaGroup, prtInputDefaultIndex=prtInputDefaultIndex, MediaUnit=MediaUnit, prtCoverEntry=prtCoverEntry, prtAlertTableV2Group=prtAlertTableV2Group, prtMarker=prtMarker, prtMarkerNorthMargin=prtMarkerNorthMargin, prtStorageRefEntry=prtStorageRefEntry, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtChannelIndex=prtChannelIndex, prtChannelGroup=prtChannelGroup, prtAlertSeverityLevel=prtAlertSeverityLevel, prtOutputIndex=prtOutputIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtConsoleDescription=prtConsoleDescription, prtInputGroup=prtInputGroup, prtChannelState=prtChannelState, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputMediaName=prtInputMediaName, prtInputMediaFormParts=prtInputMediaFormParts, prtAlertGroupIndex=prtAlertGroupIndex, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInputEntry=prtInputEntry, prtInterpreterIndex=prtInterpreterIndex, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInputStatus=prtInputStatus, prtOutputMaxCapacity=prtOutputMaxCapacity, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputEntry=prtOutputEntry, prtMediaPathType=prtMediaPathType, prtConsoleColor=prtConsoleColor, prtOutputSecurity=prtOutputSecurity, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtAlertAllEvents=prtAlertAllEvents, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtLocalizationCountry=prtLocalizationCountry, prtMarkerMarkTech=prtMarkerMarkTech, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInputMaxCapacity=prtInputMaxCapacity, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerColorantIndex=prtMarkerColorantIndex, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtOutputStackingOrder=prtOutputStackingOrder, prtDeviceRefIndex=prtDeviceRefIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtLocalizationLanguage=prtLocalizationLanguage, prtInputModel=prtInputModel, prtCoverStatus=prtCoverStatus, prtConsoleOffTime=prtConsoleOffTime, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputDimUnit=prtInputDimUnit, prtMediaPathEntry=prtMediaPathEntry, printerV2Alert=printerV2Alert, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtOutputCapacityUnit=prtOutputCapacityUnit, prtAlertTable=prtAlertTable, prtMarkerEntry=prtMarkerEntry, prtAlertLocation=prtAlertLocation, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtLocalizationEntry=prtLocalizationEntry, prtDeviceRefEntry=prtDeviceRefEntry, prtInterpreterLangFamily=prtInterpreterLangFamily, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtOutputModel=prtOutputModel, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtAlertEntry=prtAlertEntry, prtMediaPathGroup=prtMediaPathGroup, prtMediaPathDescription=prtMediaPathDescription, prtInputSecurity=prtInputSecurity, prtGeneralPrinterName=prtGeneralPrinterName, prtGeneralTable=prtGeneralTable, prtGeneralV2Group=prtGeneralV2Group, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputIndex=prtInputIndex, prtInputMediaColor=prtInputMediaColor, prtGeneralSerialNumber=prtGeneralSerialNumber, prtOutputDimUnit=prtOutputDimUnit, prtGeneralEntry=prtGeneralEntry, prtMarkerColorantTable=prtMarkerColorantTable, prtAlertCriticalEvents=prtAlertCriticalEvents, prtConsoleDisable=prtConsoleDisable, prtOutputVendorName=prtOutputVendorName, prtInputSerialNumber=prtInputSerialNumber, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerColorantRole=prtMarkerColorantRole, prtInterpreterVersion=prtInterpreterVersion, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtChannelIfIndex=prtChannelIfIndex, prtAlertCode=prtAlertCode, prtMIBGroups=prtMIBGroups, prtAlertGroup=prtAlertGroup, prtGeneralGroup=prtGeneralGroup, prtOutputTable=prtOutputTable, prtOutputVersion=prtOutputVersion, PYSNMP_MODULE_ID=printmib, prtConsoleLightIndex=prtConsoleLightIndex, prtMarkerSuppliesType=prtMarkerSuppliesType, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, PrtChannelStateTC=PrtChannelStateTC, CapacityUnit=CapacityUnit, prtMarkerColorantValue=prtMarkerColorantValue, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInputVendorName=prtInputVendorName, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMarkerIndex=prtMarkerIndex, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMarkerColorant=prtMarkerColorant, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtChannelEntry=prtChannelEntry, prtGeneralServicePerson=prtGeneralServicePerson, prtAlertTime=prtAlertTime, prtOutputSerialNumber=prtOutputSerialNumber, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerSupplies=prtMarkerSupplies, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMIBCompliance=prtMIBCompliance, prtInputMediaType=prtInputMediaType, prtMarkerStatus=prtMarkerStatus, prtMediaPathIndex=prtMediaPathIndex, printerV2AlertPrefix=printerV2AlertPrefix, printmib=printmib, prtOutputPageCollated=prtOutputPageCollated, prtInputTable=prtInputTable, prtMediaPathStatus=prtMediaPathStatus, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInterpreterGroup=prtInterpreterGroup, prtAlertTrapGroup=prtAlertTrapGroup, prtMIBConformance=prtMIBConformance, prtInputVersion=prtInputVersion, prtInterpreter=prtInterpreter, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtOutputRemainingCapacity=prtOutputRemainingCapacity, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerWestMargin=prtMarkerWestMargin, prtLocalizationIndex=prtLocalizationIndex, prtInterpreterTwoWay=prtInterpreterTwoWay, prtStorageRefIndex=prtStorageRefIndex, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtOutputDescription=prtOutputDescription, prtCoverTable=prtCoverTable, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtExtendedInputGroup=prtExtendedInputGroup, prtChannel=prtChannel, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputCurrentLevel=prtInputCurrentLevel, printerV1Alert=printerV1Alert, SubUnitStatus=SubUnitStatus, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInterpreterTable=prtInterpreterTable, prtAlertDescription=prtAlertDescription, prtMIB2Compliance=prtMIB2Compliance, prtConsoleGroup=prtConsoleGroup, prtChannelV2Group=prtChannelV2Group, prtCoverDescription=prtCoverDescription, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtChannelTable=prtChannelTable, prtAlert=prtAlert, prtChannelProtocolVersion=prtChannelProtocolVersion, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputBursting=prtOutputBursting, prtMIB2Groups=prtMIB2Groups, prtAlertIndex=prtAlertIndex, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtChannelStatus=prtChannelStatus, prtGeneralReset=prtGeneralReset, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInputDescription=prtInputDescription, prtCoverIndex=prtCoverIndex, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtCover=prtCover, prtMarkerLifeCount=prtMarkerLifeCount, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtDeviceRefTable=prtDeviceRefTable, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInputMediaWeight=prtInputMediaWeight, prtMarkerProcessColorants=prtMarkerProcessColorants, prtStorageRefTable=prtStorageRefTable, prtInputNextIndex=prtInputNextIndex, prtInputName=prtInputName, prtInputCapacityUnit=prtInputCapacityUnit, prtMarkerTable=prtMarkerTable, prtOutputOffsetStacking=prtOutputOffsetStacking, prtOutputType=prtOutputType, prtMarkerEastMargin=prtMarkerEastMargin, CodedCharSet=CodedCharSet, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMediaPath=prtMediaPath, prtConsoleOnTime=prtConsoleOnTime, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInputType=prtInputType, prtMarkerCounterUnit=prtMarkerCounterUnit, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInput=prtInput, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutput=prtOutput, prtConsoleLightTable=prtConsoleLightTable, prtOutputGroup=prtOutputGroup, prtAlertTimeGroup=prtAlertTimeGroup, prtChannelType=prtChannelType, prtOutputName=prtOutputName, prtMarkerGroup=prtMarkerGroup, prtMediaPathTable=prtMediaPathTable, prtOutputStatus=prtOutputStatus, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInterpreterEntry=prtInterpreterEntry, PrtPrintOrientationTC=PrtPrintOrientationTC, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtLocalizationTable=prtLocalizationTable, prtConsoleLightEntry=prtConsoleLightEntry)
mibBuilder.exportSymbols("Printer-MIB", prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtConsoleLocalization=prtConsoleLocalization, prtAlertTableGroup=prtAlertTableGroup, PresentOnOff=PresentOnOff)
