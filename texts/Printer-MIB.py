...
PrtChannelTypeTC, PrtConsoleDisableTC, PrtGeneralResetTC, PrtMediaPathTypeTC, PrtMarkerSuppliesTypeTC, PrtAlertGroupTC, PrtAlertTrainingLevelTC, PrtOutputTypeTC, PrtInputTypeTC, PrtCoverStatusTC, PrtInterpreterLangFamilyTC, PrtAlertCodeTC, PrtConsoleColorTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtChannelTypeTC", "PrtConsoleDisableTC", "PrtGeneralResetTC", "PrtMediaPathTypeTC", "PrtMarkerSuppliesTypeTC", "PrtAlertGroupTC", "PrtAlertTrainingLevelTC", "PrtOutputTypeTC", "PrtInputTypeTC", "PrtCoverStatusTC", "PrtInterpreterLangFamilyTC", "PrtAlertCodeTC", "PrtConsoleColorTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInputMediaName=prtInputMediaName, prtChannelInformation=prtChannelInformation, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputMediaWeight=prtInputMediaWeight, prtOutputTable=prtOutputTable, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputDescription=prtInputDescription, prtInputDimUnit=prtInputDimUnit, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtConsoleOffTime=prtConsoleOffTime, prtConsoleColor=prtConsoleColor, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputType=prtInputType, prtAlertAllEvents=prtAlertAllEvents, prtGeneralV2Group=prtGeneralV2Group, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtChannelIndex=prtChannelIndex, prtMIBGroups=prtMIBGroups, prtExtendedInputGroup=prtExtendedInputGroup, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInputStatus=prtInputStatus, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMediaPathType=prtMediaPathType, prtLocalizationIndex=prtLocalizationIndex, prtCoverTable=prtCoverTable, prtConsoleLocalization=prtConsoleLocalization, PrtChannelStateTC=PrtChannelStateTC, prtMediaPathDescription=prtMediaPathDescription, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, PYSNMP_MODULE_ID=printmib, prtInputSwitchingGroup=prtInputSwitchingGroup, prtStorageRefIndex=prtStorageRefIndex, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMarkerWestMargin=prtMarkerWestMargin, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtCoverStatus=prtCoverStatus, prtLocalizationEntry=prtLocalizationEntry, prtMarkerSuppliesType=prtMarkerSuppliesType, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMediaPathGroup=prtMediaPathGroup, prtMIBCompliance=prtMIBCompliance, prtMarker=prtMarker, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMarkerProcessColorants=prtMarkerProcessColorants, prtAlertSeverityLevel=prtAlertSeverityLevel, PresentOnOff=PresentOnOff, SubUnitStatus=SubUnitStatus, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtOutputName=prtOutputName, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputCapacityUnit=prtOutputCapacityUnit, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerSuppliesClass=prtMarkerSuppliesClass, PrtCapacityUnitTC=PrtCapacityUnitTC, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtOutputDefaultIndex=prtOutputDefaultIndex, prtAlertCode=prtAlertCode, prtMarkerColorantGroup=prtMarkerColorantGroup, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtGeneralTable=prtGeneralTable, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtAlertIndex=prtAlertIndex, prtMIB2Compliance=prtMIB2Compliance, prtMarkerGroup=prtMarkerGroup, prtOutputEntry=prtOutputEntry, prtInputSerialNumber=prtInputSerialNumber, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInputEntry=prtInputEntry, prtAlertGroup=prtAlertGroup, prtOutputSecurity=prtOutputSecurity, prtLocalizationTable=prtLocalizationTable, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInterpreterTable=prtInterpreterTable, prtAlertEntry=prtAlertEntry, prtInterpreterGroup=prtInterpreterGroup, prtChannelV2Group=prtChannelV2Group, prtStorageRefTable=prtStorageRefTable, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerSpotColorants=prtMarkerSpotColorants, prtLocalizationCountry=prtLocalizationCountry, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtOutputVersion=prtOutputVersion, prtInput=prtInput, prtAlertTableGroup=prtAlertTableGroup, prtInterpreterEntry=prtInterpreterEntry, prtCoverEntry=prtCoverEntry, prtInputGroup=prtInputGroup, prtInputNextIndex=prtInputNextIndex, prtMarkerTable=prtMarkerTable, prtInterpreterLangLevel=prtInterpreterLangLevel, printerV1Alert=printerV1Alert, prtInputMediaFormParts=prtInputMediaFormParts, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMarkerColorantIndex=prtMarkerColorantIndex, prtOutputStatus=prtOutputStatus, prtGeneralReset=prtGeneralReset, prtInputName=prtInputName, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputModel=prtOutputModel, prtMediaPathEntry=prtMediaPathEntry, prtChannelEntry=prtChannelEntry, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInputModel=prtInputModel, prtAlertTime=prtAlertTime, prtInputIndex=prtInputIndex, prtChannelTable=prtChannelTable, prtGeneralServicePerson=prtGeneralServicePerson, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtGeneralSerialNumber=prtGeneralSerialNumber, prtOutputDimensionsGroup=prtOutputDimensionsGroup, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInterpreterVersion=prtInterpreterVersion, prtInputTable=prtInputTable, prtChannelStatus=prtChannelStatus, prtGeneralEntry=prtGeneralEntry, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerColorantTonality=prtMarkerColorantTonality, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMediaPathTable=prtMediaPathTable, prtCoverDescription=prtCoverDescription, prtMarkerSupplies=prtMarkerSupplies, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMarkerEntry=prtMarkerEntry, prtInterpreterIndex=prtInterpreterIndex, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMarkerLifeCount=prtMarkerLifeCount, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, MediaUnit=MediaUnit, prtStorageRefEntry=prtStorageRefEntry, prtAlertDescription=prtAlertDescription, prtMarkerEastMargin=prtMarkerEastMargin, prtOutputStackingOrder=prtOutputStackingOrder, prtOutputDescription=prtOutputDescription, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleOnTime=prtConsoleOnTime, prtInputCurrentLevel=prtInputCurrentLevel, prtInputVendorName=prtInputVendorName, prtInputMaxCapacity=prtInputMaxCapacity, prtChannelState=prtChannelState, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputType=prtOutputType, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtGeneralPrinterName=prtGeneralPrinterName, prtAlert=prtAlert, prtChannelType=prtChannelType, prtInterpreterLangFamily=prtInterpreterLangFamily, prtConsoleLightTable=prtConsoleLightTable, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtAlertLocation=prtAlertLocation, prtInputVersion=prtInputVersion, prtConsoleDisable=prtConsoleDisable, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtGeneral=prtGeneral, prtConsoleLights=prtConsoleLights, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtChannelIfIndex=prtChannelIfIndex, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtConsoleGroup=prtConsoleGroup, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtDeviceRefTable=prtDeviceRefTable, prtInputMediaColor=prtInputMediaColor, prtInterpreterDescription=prtInterpreterDescription, prtMarkerColorantValue=prtMarkerColorantValue, prtMarkerColorantTable=prtMarkerColorantTable, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtAlertTrainingLevel=prtAlertTrainingLevel, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMediaPathIndex=prtMediaPathIndex, prtConsoleDescription=prtConsoleDescription, prtInterpreterTwoWay=prtInterpreterTwoWay, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMediaPath=prtMediaPath, prtMarkerMarkTech=prtMarkerMarkTech, prtOutputBursting=prtOutputBursting, prtMarkerIndex=prtMarkerIndex, prtCover=prtCover, prtMIB2Groups=prtMIB2Groups, prtMarkerColorantRole=prtMarkerColorantRole, prtCoverIndex=prtCoverIndex, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtOutputDecollating=prtOutputDecollating, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputPageCollated=prtOutputPageCollated, prtOutput=prtOutput, PrtPrintOrientationTC=PrtPrintOrientationTC, prtDeviceRefIndex=prtDeviceRefIndex, prtMIBConformance=prtMIBConformance, printerV2AlertPrefix=printerV2AlertPrefix, prtLocalization=prtLocalization, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMediaPathStatus=prtMediaPathStatus, prtInterpreter=prtInterpreter, printerV2Alert=printerV2Alert, prtGeneralGroup=prtGeneralGroup, prtAlertGroupIndex=prtAlertGroupIndex, CapacityUnit=CapacityUnit, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, CodedCharSet=CodedCharSet, prtOutputMaxCapacity=prtOutputMaxCapacity, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputCapacityUnit=prtInputCapacityUnit, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputDimUnit=prtOutputDimUnit, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerColorant=prtMarkerColorant, prtOutputGroup=prtOutputGroup, prtConsoleLightIndex=prtConsoleLightIndex, prtInputMediaGroup=prtInputMediaGroup, prtInterpreterLangVersion=prtInterpreterLangVersion, prtAlertTable=prtAlertTable, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputSecurity=prtInputSecurity, prtOutputVendorName=prtOutputVendorName, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtGeneralConfigChanges=prtGeneralConfigChanges, prtChannel=prtChannel, prtInputDefaultIndex=prtInputDefaultIndex, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputMediaType=prtInputMediaType)
mibBuilder.exportSymbols("Printer-MIB", prtOutputIndex=prtOutputIndex, prtChannelGroup=prtChannelGroup, printmib=printmib, prtMarkerStatus=prtMarkerStatus)
