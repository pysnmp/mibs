...
PrtInputTypeTC, PrtConsoleColorTC, PrtChannelTypeTC, PrtGeneralResetTC, PrtAlertGroupTC, PrtAlertTrainingLevelTC, PrtConsoleDisableTC, PrtMarkerMarkTechTC, PrtMarkerSuppliesTypeTC, PrtOutputTypeTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC, PrtCoverStatusTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInputTypeTC", "PrtConsoleColorTC", "PrtChannelTypeTC", "PrtGeneralResetTC", "PrtAlertGroupTC", "PrtAlertTrainingLevelTC", "PrtConsoleDisableTC", "PrtMarkerMarkTechTC", "PrtMarkerSuppliesTypeTC", "PrtOutputTypeTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC", "PrtCoverStatusTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtGeneralPrinterName=prtGeneralPrinterName, prtCover=prtCover, prtInputIndex=prtInputIndex, prtMarkerEastMargin=prtMarkerEastMargin, prtInterpreterTwoWay=prtInterpreterTwoWay, PrtChannelStateTC=PrtChannelStateTC, prtConsoleOnTime=prtConsoleOnTime, prtChannelEntry=prtChannelEntry, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtGeneralV2Group=prtGeneralV2Group, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputDecollating=prtOutputDecollating, prtMarkerColorantTonality=prtMarkerColorantTonality, prtGeneralEntry=prtGeneralEntry, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtOutputEntry=prtOutputEntry, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputName=prtInputName, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtCoverStatus=prtCoverStatus, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtOutputSerialNumber=prtOutputSerialNumber, prtInputVersion=prtInputVersion, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInputType=prtInputType, prtOutputIndex=prtOutputIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtChannelStatus=prtChannelStatus, prtMediaPathTable=prtMediaPathTable, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMediaPathIndex=prtMediaPathIndex, prtOutputGroup=prtOutputGroup, PrtPrintOrientationTC=PrtPrintOrientationTC, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleGroup=prtConsoleGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtAlertAllEvents=prtAlertAllEvents, prtOutputOffsetStacking=prtOutputOffsetStacking, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInputNextIndex=prtInputNextIndex, prtInputTable=prtInputTable, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInterpreterLangLevel=prtInterpreterLangLevel, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtChannelType=prtChannelType, prtLocalizationIndex=prtLocalizationIndex, prtConsoleLightIndex=prtConsoleLightIndex, prtLocalizationTable=prtLocalizationTable, prtLocalizationCountry=prtLocalizationCountry, prtMarkerSupplies=prtMarkerSupplies, prtInputMediaColor=prtInputMediaColor, prtMediaPathStatus=prtMediaPathStatus, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInputVendorName=prtInputVendorName, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtConsoleDescription=prtConsoleDescription, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInputDimUnit=prtInputDimUnit, MediaUnit=MediaUnit, SubUnitStatus=SubUnitStatus, prtConsoleColor=prtConsoleColor, prtOutput=prtOutput, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputName=prtOutputName, prtInterpreterEntry=prtInterpreterEntry, prtInterpreterLangVersion=prtInterpreterLangVersion, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, CapacityUnit=CapacityUnit, prtInputCurrentLevel=prtInputCurrentLevel, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputMaxCapacity=prtOutputMaxCapacity, CodedCharSet=CodedCharSet, prtOutputDimUnit=prtOutputDimUnit, prtConsoleLocalization=prtConsoleLocalization, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtChannelV2Group=prtChannelV2Group, prtMediaPathDescription=prtMediaPathDescription, prtCoverTable=prtCoverTable, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtOutputDefaultIndex=prtOutputDefaultIndex, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMIBCompliance=prtMIBCompliance, prtGeneralConfigChanges=prtGeneralConfigChanges, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInputMediaName=prtInputMediaName, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInterpreterLangFamily=prtInterpreterLangFamily, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtConsoleLightTable=prtConsoleLightTable, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtCoverIndex=prtCoverIndex, prtStorageRefIndex=prtStorageRefIndex, prtInput=prtInput, prtInterpreterVersion=prtInterpreterVersion, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMIB2Groups=prtMIB2Groups, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtAlertIndex=prtAlertIndex, prtAlertTableGroup=prtAlertTableGroup, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, printmib=printmib, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMIBConformance=prtMIBConformance, prtGeneralServicePerson=prtGeneralServicePerson, prtOutputBursting=prtOutputBursting, prtMarkerIndex=prtMarkerIndex, prtMarkerSuppliesType=prtMarkerSuppliesType, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, PYSNMP_MODULE_ID=printmib, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtConsoleOffTime=prtConsoleOffTime, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerLifeCount=prtMarkerLifeCount, prtGeneral=prtGeneral, prtOutputDescription=prtOutputDescription, prtDeviceRefTable=prtDeviceRefTable, prtInputStatus=prtInputStatus, prtInputDefaultIndex=prtInputDefaultIndex, prtExtendedOutputGroup=prtExtendedOutputGroup, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerWestMargin=prtMarkerWestMargin, prtMarkerStatus=prtMarkerStatus, prtMarkerColorantRole=prtMarkerColorantRole, prtLocalization=prtLocalization, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInputGroup=prtInputGroup, prtInputSerialNumber=prtInputSerialNumber, prtAlertSeverityLevel=prtAlertSeverityLevel, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtAlertTable=prtAlertTable, prtInputMediaWeight=prtInputMediaWeight, prtConsoleDisable=prtConsoleDisable, prtCoverEntry=prtCoverEntry, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertEntry=prtAlertEntry, prtAlertGroupIndex=prtAlertGroupIndex, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInputDescription=prtInputDescription, prtInputSecurity=prtInputSecurity, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputType=prtOutputType, PresentOnOff=PresentOnOff, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtAlertCode=prtAlertCode, prtInputModel=prtInputModel, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInputMediaType=prtInputMediaType, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtOutputVendorName=prtOutputVendorName, prtDeviceRefEntry=prtDeviceRefEntry, prtConsoleLights=prtConsoleLights, prtAlertLocation=prtAlertLocation, printerV1Alert=printerV1Alert, prtGeneralReset=prtGeneralReset, prtMarkerColorantValue=prtMarkerColorantValue, prtGeneralGroup=prtGeneralGroup, prtMediaPathEntry=prtMediaPathEntry, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMarkerColorantEntry=prtMarkerColorantEntry, prtStorageRefEntry=prtStorageRefEntry, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMediaPathGroup=prtMediaPathGroup, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtAlertDescription=prtAlertDescription, prtMIB2Compliance=prtMIB2Compliance, prtLocalizationEntry=prtLocalizationEntry, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtCoverDescription=prtCoverDescription, prtChannelProtocolVersion=prtChannelProtocolVersion, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputCapacityUnit=prtOutputCapacityUnit, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMarker=prtMarker, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputModel=prtOutputModel, prtAlertTrainingLevel=prtAlertTrainingLevel, prtInputEntry=prtInputEntry, prtInputMediaGroup=prtInputMediaGroup, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInterpreterIndex=prtInterpreterIndex, prtInterpreterGroup=prtInterpreterGroup, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMediaPathType=prtMediaPathType, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtChannelState=prtChannelState, prtChannelTable=prtChannelTable, prtOutputPageCollated=prtOutputPageCollated, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInputCapacityUnit=prtInputCapacityUnit, prtAlertTimeGroup=prtAlertTimeGroup, prtOutputSecurity=prtOutputSecurity, prtStorageRefTable=prtStorageRefTable, prtChannelIfIndex=prtChannelIfIndex, prtOutputStatus=prtOutputStatus, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerEntry=prtMarkerEntry, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerColorant=prtMarkerColorant, prtMarkerColorantTable=prtMarkerColorantTable, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInterpreter=prtInterpreter, prtAlertTime=prtAlertTime, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtChannelInformation=prtChannelInformation, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInputSwitchingGroup=prtInputSwitchingGroup, prtExtendedInputGroup=prtExtendedInputGroup, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInputMaxCapacity=prtInputMaxCapacity, printerV2Alert=printerV2Alert, prtMarkerGroup=prtMarkerGroup, prtChannelGroup=prtChannelGroup, prtOutputTable=prtOutputTable, prtGeneralTable=prtGeneralTable, prtInterpreterTable=prtInterpreterTable, prtChannel=prtChannel, prtAlertGroup=prtAlertGroup, prtConsoleLightEntry=prtConsoleLightEntry, prtMIBGroups=prtMIBGroups, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerTable=prtMarkerTable, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtChannelIndex=prtChannelIndex, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInterpreterDescription=prtInterpreterDescription, prtOutputVersion=prtOutputVersion, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputStackingOrder=prtOutputStackingOrder, prtAlert=prtAlert)
mibBuilder.exportSymbols("Printer-MIB", prtMediaPath=prtMediaPath, printerV2AlertPrefix=printerV2AlertPrefix, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity)
