...
PrtAlertGroupTC, PrtInterpreterLangFamilyTC, PrtGeneralResetTC, PrtAlertTrainingLevelTC, PrtCoverStatusTC, PrtChannelTypeTC, PrtInputTypeTC, PrtMarkerMarkTechTC, PrtConsoleColorTC, PrtAlertCodeTC, PrtMediaPathTypeTC, PrtConsoleDisableTC, PrtMarkerSuppliesTypeTC, PrtOutputTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertGroupTC", "PrtInterpreterLangFamilyTC", "PrtGeneralResetTC", "PrtAlertTrainingLevelTC", "PrtCoverStatusTC", "PrtChannelTypeTC", "PrtInputTypeTC", "PrtMarkerMarkTechTC", "PrtConsoleColorTC", "PrtAlertCodeTC", "PrtMediaPathTypeTC", "PrtConsoleDisableTC", "PrtMarkerSuppliesTypeTC", "PrtOutputTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInterpreterDescription=prtInterpreterDescription, prtChannelType=prtChannelType, prtInputStatus=prtInputStatus, prtGeneralReset=prtGeneralReset, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInputMediaGroup=prtInputMediaGroup, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInputGroup=prtInputGroup, prtMarkerIndex=prtMarkerIndex, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerColorantTable=prtMarkerColorantTable, prtConsoleColor=prtConsoleColor, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputVersion=prtInputVersion, prtInputSerialNumber=prtInputSerialNumber, prtConsoleLightIndex=prtConsoleLightIndex, prtOutputStatus=prtOutputStatus, prtLocalization=prtLocalization, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtConsoleGroup=prtConsoleGroup, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtChannelState=prtChannelState, prtExtendedOutputGroup=prtExtendedOutputGroup, prtInputMediaType=prtInputMediaType, prtAlertDescription=prtAlertDescription, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerColorantTonality=prtMarkerColorantTonality, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtDeviceRefEntry=prtDeviceRefEntry, prtInputEntry=prtInputEntry, prtInputSwitchingGroup=prtInputSwitchingGroup, prtOutputCapacityUnit=prtOutputCapacityUnit, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtOutputDimUnit=prtOutputDimUnit, prtMediaPath=prtMediaPath, prtOutputDecollating=prtOutputDecollating, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtOutputSerialNumber=prtOutputSerialNumber, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtOutputBursting=prtOutputBursting, prtInterpreterLangFamily=prtInterpreterLangFamily, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtChannelEntry=prtChannelEntry, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMediaPathIndex=prtMediaPathIndex, prtConsoleOffTime=prtConsoleOffTime, prtAlertTime=prtAlertTime, prtInputSecurity=prtInputSecurity, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInputIndex=prtInputIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtOutputMaxCapacity=prtOutputMaxCapacity, prtOutputVersion=prtOutputVersion, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputMediaName=prtInputMediaName, prtMarkerNorthMargin=prtMarkerNorthMargin, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtCoverDescription=prtCoverDescription, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtConsoleLights=prtConsoleLights, prtInputCurrentLevel=prtInputCurrentLevel, printerV2Alert=printerV2Alert, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInputNextIndex=prtInputNextIndex, prtInput=prtInput, prtConsoleLocalization=prtConsoleLocalization, prtInputDefaultIndex=prtInputDefaultIndex, prtConsoleOnTime=prtConsoleOnTime, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInterpreterLangVersion=prtInterpreterLangVersion, printerV2AlertPrefix=printerV2AlertPrefix, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerSuppliesType=prtMarkerSuppliesType, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtCoverIndex=prtCoverIndex, prtMarkerColorantValue=prtMarkerColorantValue, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputDescription=prtInputDescription, prtMediaPathStatus=prtMediaPathStatus, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtCover=prtCover, prtGeneralPrinterName=prtGeneralPrinterName, prtConsoleLightEntry=prtConsoleLightEntry, prtMIBCompliance=prtMIBCompliance, prtLocalizationCountry=prtLocalizationCountry, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputIndex=prtOutputIndex, prtAlertCode=prtAlertCode, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtGeneralEntry=prtGeneralEntry, PresentOnOff=PresentOnOff, prtAlertAllEvents=prtAlertAllEvents, prtInputName=prtInputName, prtMarkerTable=prtMarkerTable, prtMediaPathDescription=prtMediaPathDescription, prtChannelStatus=prtChannelStatus, PYSNMP_MODULE_ID=printmib, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtOutputTable=prtOutputTable, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtConsoleDisable=prtConsoleDisable, prtChannelV2Group=prtChannelV2Group, PrtPrintOrientationTC=PrtPrintOrientationTC, MediaUnit=MediaUnit, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMediaPathType=prtMediaPathType, prtChannelTable=prtChannelTable, prtLocalizationTable=prtLocalizationTable, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtAlertTableGroup=prtAlertTableGroup, prtInterpreterEntry=prtInterpreterEntry, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtAlertEntry=prtAlertEntry, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtOutputGroup=prtOutputGroup, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputModel=prtOutputModel, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInputModel=prtInputModel, prtMarkerSouthMargin=prtMarkerSouthMargin, prtAlert=prtAlert, prtGeneralTable=prtGeneralTable, prtStorageRefTable=prtStorageRefTable, PrtMediaUnitTC=PrtMediaUnitTC, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMarkerEntry=prtMarkerEntry, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMIBConformance=prtMIBConformance, prtInterpreterGroup=prtInterpreterGroup, prtMIB2Groups=prtMIB2Groups, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutput=prtOutput, prtChannelInformation=prtChannelInformation, prtAlertTable=prtAlertTable, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtCoverStatus=prtCoverStatus, prtStorageRefEntry=prtStorageRefEntry, prtInterpreterIndex=prtInterpreterIndex, prtInputDimUnit=prtInputDimUnit, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtOutputEntry=prtOutputEntry, prtLocalizationLanguage=prtLocalizationLanguage, prtLocalizationIndex=prtLocalizationIndex, prtInputType=prtInputType, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputCapacityUnit=prtInputCapacityUnit, SubUnitStatus=SubUnitStatus, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMediaPathEntry=prtMediaPathEntry, prtInputMediaColor=prtInputMediaColor, prtLocalizationEntry=prtLocalizationEntry, prtMarkerColorantRole=prtMarkerColorantRole, prtOutputDefaultIndex=prtOutputDefaultIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInputMediaWeight=prtInputMediaWeight, prtGeneralConfigChanges=prtGeneralConfigChanges, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtOutputVendorName=prtOutputVendorName, prtMarker=prtMarker, prtMarkerEastMargin=prtMarkerEastMargin, prtOutputSecurity=prtOutputSecurity, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMediaPathGroup=prtMediaPathGroup, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtChannelIndex=prtChannelIndex, CapacityUnit=CapacityUnit, prtInterpreterTable=prtInterpreterTable, prtMarkerMarkTech=prtMarkerMarkTech, CodedCharSet=CodedCharSet, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputName=prtOutputName, prtCoverTable=prtCoverTable, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInputVendorName=prtInputVendorName, printerV1Alert=printerV1Alert, prtMarkerColorant=prtMarkerColorant, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtGeneralGroup=prtGeneralGroup, prtConsoleLightTable=prtConsoleLightTable, prtOutputDescription=prtOutputDescription, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtCoverEntry=prtCoverEntry, prtGeneralServicePerson=prtGeneralServicePerson, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMarkerStatus=prtMarkerStatus, prtConsoleDescription=prtConsoleDescription, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerWestMargin=prtMarkerWestMargin, prtMediaPathTable=prtMediaPathTable, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, PrtChannelStateTC=PrtChannelStateTC, prtChannelIfIndex=prtChannelIfIndex, prtStorageRefIndex=prtStorageRefIndex, prtMIBGroups=prtMIBGroups, prtMarkerColorantIndex=prtMarkerColorantIndex, printmib=printmib, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInterpreterLangLevel=prtInterpreterLangLevel, prtChannelGroup=prtChannelGroup, prtAlertGroup=prtAlertGroup, prtInterpreter=prtInterpreter, prtMIB2Compliance=prtMIB2Compliance, prtAlertLocation=prtAlertLocation, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMarkerColorantEntry=prtMarkerColorantEntry, prtGeneralV2Group=prtGeneralV2Group, prtOutputType=prtOutputType, prtOutputPageCollated=prtOutputPageCollated, prtMarkerSupplies=prtMarkerSupplies, prtExtendedInputGroup=prtExtendedInputGroup, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtDeviceRefTable=prtDeviceRefTable, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInputTable=prtInputTable, prtAlertIndex=prtAlertIndex, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInputMediaFormParts=prtInputMediaFormParts, prtInterpreterVersion=prtInterpreterVersion, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtAlertTableV2Group=prtAlertTableV2Group, prtGeneral=prtGeneral, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage)
mibBuilder.exportSymbols("Printer-MIB", prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerGroup=prtMarkerGroup, prtChannel=prtChannel, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex)
