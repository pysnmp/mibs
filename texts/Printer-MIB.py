...
PrtConsoleColorTC, PrtMarkerSuppliesTypeTC, PrtMediaPathTypeTC, PrtGeneralResetTC, PrtAlertCodeTC, PrtCoverStatusTC, PrtOutputTypeTC, PrtMarkerMarkTechTC, PrtInterpreterLangFamilyTC, PrtConsoleDisableTC, PrtAlertGroupTC, PrtAlertTrainingLevelTC, PrtChannelTypeTC, PrtInputTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleColorTC", "PrtMarkerSuppliesTypeTC", "PrtMediaPathTypeTC", "PrtGeneralResetTC", "PrtAlertCodeTC", "PrtCoverStatusTC", "PrtOutputTypeTC", "PrtMarkerMarkTechTC", "PrtInterpreterLangFamilyTC", "PrtConsoleDisableTC", "PrtAlertGroupTC", "PrtAlertTrainingLevelTC", "PrtChannelTypeTC", "PrtInputTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputOffsetStacking=prtOutputOffsetStacking, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtLocalizationTable=prtLocalizationTable, prtMarkerProcessColorants=prtMarkerProcessColorants, prtConsoleDisable=prtConsoleDisable, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtChannelStatus=prtChannelStatus, prtInputGroup=prtInputGroup, prtMarkerColorantTonality=prtMarkerColorantTonality, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMediaPath=prtMediaPath, prtChannelProtocolVersion=prtChannelProtocolVersion, printerV2Alert=printerV2Alert, prtMarkerSuppliesType=prtMarkerSuppliesType, prtOutputPageCollated=prtOutputPageCollated, prtDeviceRefTable=prtDeviceRefTable, prtInputMediaName=prtInputMediaName, prtInputMediaColor=prtInputMediaColor, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtDeviceRefIndex=prtDeviceRefIndex, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtChannelState=prtChannelState, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInputCapacityUnit=prtInputCapacityUnit, prtChannelGroup=prtChannelGroup, prtInterpreterVersion=prtInterpreterVersion, PrtChannelStateTC=PrtChannelStateTC, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMarkerColorantValue=prtMarkerColorantValue, prtInputStatus=prtInputStatus, prtMediaPathEntry=prtMediaPathEntry, prtOutputSerialNumber=prtOutputSerialNumber, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerColorant=prtMarkerColorant, prtInputSwitchingGroup=prtInputSwitchingGroup, prtAlertTableV2Group=prtAlertTableV2Group, prtAlertGroup=prtAlertGroup, prtAlertTime=prtAlertTime, prtMarkerTable=prtMarkerTable, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMarkerStatus=prtMarkerStatus, prtInputDescription=prtInputDescription, prtOutputMaxCapacity=prtOutputMaxCapacity, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInterpreterDescription=prtInterpreterDescription, prtAlert=prtAlert, prtInterpreterLangFamily=prtInterpreterLangFamily, prtOutputModel=prtOutputModel, prtAlertSeverityLevel=prtAlertSeverityLevel, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtOutput=prtOutput, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerEastMargin=prtMarkerEastMargin, prtChannelV2Group=prtChannelV2Group, prtMediaPathIndex=prtMediaPathIndex, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMediaPathGroup=prtMediaPathGroup, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInterpreterGroup=prtInterpreterGroup, prtAlertLocation=prtAlertLocation, prtChannelTable=prtChannelTable, prtInputIndex=prtInputIndex, prtInputNextIndex=prtInputNextIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtLocalizationEntry=prtLocalizationEntry, prtAlertTimeGroup=prtAlertTimeGroup, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMediaPathType=prtMediaPathType, prtChannel=prtChannel, prtAlertIndex=prtAlertIndex, CapacityUnit=CapacityUnit, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtExtendedOutputGroup=prtExtendedOutputGroup, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, printmib=printmib, prtChannelInformation=prtChannelInformation, prtAlertGroupIndex=prtAlertGroupIndex, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInputVersion=prtInputVersion, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtOutputGroup=prtOutputGroup, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtGeneral=prtGeneral, prtInputVendorName=prtInputVendorName, prtAlertEntry=prtAlertEntry, prtConsoleLightIndex=prtConsoleLightIndex, PrtMediaUnitTC=PrtMediaUnitTC, prtGeneralEntry=prtGeneralEntry, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtGeneralServicePerson=prtGeneralServicePerson, prtMIB2Compliance=prtMIB2Compliance, prtGeneralTable=prtGeneralTable, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMarkerSupplies=prtMarkerSupplies, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputDefaultIndex=prtOutputDefaultIndex, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputBursting=prtOutputBursting, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerLifeCount=prtMarkerLifeCount, prtAlertTable=prtAlertTable, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtGeneralReset=prtGeneralReset, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerSuppliesTable=prtMarkerSuppliesTable, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtAlertTrapGroup=prtAlertTrapGroup, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutputDimUnit=prtOutputDimUnit, prtMIB2Groups=prtMIB2Groups, prtConsoleLightTable=prtConsoleLightTable, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtOutputStatus=prtOutputStatus, prtInputType=prtInputType, prtInputMaxCapacity=prtInputMaxCapacity, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputTable=prtOutputTable, prtInterpreterLangVersion=prtInterpreterLangVersion, prtOutputSecurity=prtOutputSecurity, prtMarkerColorantRole=prtMarkerColorantRole, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMediaPathStatus=prtMediaPathStatus, prtGeneralPrinterName=prtGeneralPrinterName, prtOutputVendorName=prtOutputVendorName, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtConsoleOffTime=prtConsoleOffTime, prtCover=prtCover, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputDescription=prtOutputDescription, prtChannelIndex=prtChannelIndex, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInputName=prtInputName, prtInterpreterEntry=prtInterpreterEntry, prtConsoleGroup=prtConsoleGroup, prtCoverDescription=prtCoverDescription, prtMarkerEntry=prtMarkerEntry, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtAlertAllEvents=prtAlertAllEvents, prtConsoleOnTime=prtConsoleOnTime, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, CodedCharSet=CodedCharSet, prtOutputEntry=prtOutputEntry, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMediaPathDescription=prtMediaPathDescription, prtInputDimUnit=prtInputDimUnit, prtConsoleLights=prtConsoleLights, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, PYSNMP_MODULE_ID=printmib, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInterpreterTable=prtInterpreterTable, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtMarkerGroup=prtMarkerGroup, prtMIBGroups=prtMIBGroups, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarker=prtMarker, prtStorageRefTable=prtStorageRefTable, prtStorageRefIndex=prtStorageRefIndex, prtInputEntry=prtInputEntry, prtInputMediaFormParts=prtInputMediaFormParts, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMarkerIndex=prtMarkerIndex, prtInput=prtInput, prtOutputName=prtOutputName, prtAlertCode=prtAlertCode, prtMIBCompliance=prtMIBCompliance, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtAlertTrainingLevel=prtAlertTrainingLevel, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInterpreterIndex=prtInterpreterIndex, prtCoverStatus=prtCoverStatus, prtMarkerMarkTech=prtMarkerMarkTech, prtChannelEntry=prtChannelEntry, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, PrtPrintOrientationTC=PrtPrintOrientationTC, prtStorageRefEntry=prtStorageRefEntry, prtInputMediaGroup=prtInputMediaGroup, prtInputSerialNumber=prtInputSerialNumber, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, printerV1Alert=printerV1Alert, prtLocalizationIndex=prtLocalizationIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInputSecurity=prtInputSecurity, prtDeviceRefEntry=prtDeviceRefEntry, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMarkerWestMargin=prtMarkerWestMargin, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInputMediaType=prtInputMediaType, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, MediaUnit=MediaUnit, prtChannelIfIndex=prtChannelIfIndex, prtInterpreter=prtInterpreter, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMarkerColorantIndex=prtMarkerColorantIndex, SubUnitStatus=SubUnitStatus, prtAlertDescription=prtAlertDescription, prtMarkerColorantEntry=prtMarkerColorantEntry, printerV2AlertPrefix=printerV2AlertPrefix, prtConsoleLocalization=prtConsoleLocalization, PresentOnOff=PresentOnOff, prtOutputDecollating=prtOutputDecollating, prtGeneralGroup=prtGeneralGroup, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputIndex=prtOutputIndex, prtAlertCriticalEvents=prtAlertCriticalEvents, prtOutputVersion=prtOutputVersion, prtInputModel=prtInputModel, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtCoverIndex=prtCoverIndex, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleDescription=prtConsoleDescription, prtConsoleLightEntry=prtConsoleLightEntry, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInputMediaWeight=prtInputMediaWeight, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtOutputStackingOrder=prtOutputStackingOrder, prtAlertTableGroup=prtAlertTableGroup, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtGeneralV2Group=prtGeneralV2Group, prtInterpreterTwoWay=prtInterpreterTwoWay, prtCoverEntry=prtCoverEntry, prtLocalization=prtLocalization, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtChannelType=prtChannelType, prtLocalizationCountry=prtLocalizationCountry, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtConsoleColor=prtConsoleColor, prtOutputType=prtOutputType)
mibBuilder.exportSymbols("Printer-MIB", prtInputTable=prtInputTable, prtMIBConformance=prtMIBConformance, prtCoverTable=prtCoverTable, prtMediaPathTable=prtMediaPathTable)
