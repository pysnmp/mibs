...
PrtInterpreterLangFamilyTC, PrtInputTypeTC, PrtConsoleDisableTC, PrtCoverStatusTC, PrtGeneralResetTC, PrtMarkerMarkTechTC, PrtMarkerSuppliesTypeTC, PrtMediaPathTypeTC, PrtAlertGroupTC, PrtAlertCodeTC, PrtChannelTypeTC, PrtAlertTrainingLevelTC, PrtConsoleColorTC, PrtOutputTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInterpreterLangFamilyTC", "PrtInputTypeTC", "PrtConsoleDisableTC", "PrtCoverStatusTC", "PrtGeneralResetTC", "PrtMarkerMarkTechTC", "PrtMarkerSuppliesTypeTC", "PrtMediaPathTypeTC", "PrtAlertGroupTC", "PrtAlertCodeTC", "PrtChannelTypeTC", "PrtAlertTrainingLevelTC", "PrtConsoleColorTC", "PrtOutputTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtCoverIndex=prtCoverIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtInputGroup=prtInputGroup, prtMediaPathStatus=prtMediaPathStatus, prtAlertTrapGroup=prtAlertTrapGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputDescription=prtOutputDescription, prtMarkerSupplies=prtMarkerSupplies, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputEntry=prtOutputEntry, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInterpreterTable=prtInterpreterTable, prtChannel=prtChannel, prtMarkerIndex=prtMarkerIndex, prtInterpreterLangLevel=prtInterpreterLangLevel, prtAlertTime=prtAlertTime, prtMIBConformance=prtMIBConformance, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerGroup=prtMarkerGroup, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutputVendorName=prtOutputVendorName, prtOutputStackingOrder=prtOutputStackingOrder, prtConsoleColor=prtConsoleColor, prtConsoleLightIndex=prtConsoleLightIndex, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtExtendedOutputGroup=prtExtendedOutputGroup, prtCoverDescription=prtCoverDescription, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtConsoleLocalization=prtConsoleLocalization, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtConsoleLights=prtConsoleLights, prtInterpreterVersion=prtInterpreterVersion, prtGeneralReset=prtGeneralReset, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputVendorName=prtInputVendorName, printerV2Alert=printerV2Alert, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputCurrentLevel=prtInputCurrentLevel, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInputMediaColor=prtInputMediaColor, prtInputMediaName=prtInputMediaName, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlertTable=prtAlertTable, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtChannelTable=prtChannelTable, prtLocalization=prtLocalization, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInputType=prtInputType, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtChannelV2Group=prtChannelV2Group, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtChannelStatus=prtChannelStatus, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtOutputStatus=prtOutputStatus, prtDeviceRefTable=prtDeviceRefTable, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInterpreterEntry=prtInterpreterEntry, prtAlertIndex=prtAlertIndex, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputEntry=prtInputEntry, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtLocalizationCountry=prtLocalizationCountry, prtChannelInformation=prtChannelInformation, prtStorageRefIndex=prtStorageRefIndex, prtCoverStatus=prtCoverStatus, CapacityUnit=CapacityUnit, prtOutputSecurity=prtOutputSecurity, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtLocalizationLanguage=prtLocalizationLanguage, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutputIndex=prtOutputIndex, prtAlertGroup=prtAlertGroup, prtChannelGroup=prtChannelGroup, prtAlertEntry=prtAlertEntry, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputVersion=prtOutputVersion, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtInputTable=prtInputTable, prtMarkerTable=prtMarkerTable, prtInputCapacityUnit=prtInputCapacityUnit, prtChannelEntry=prtChannelEntry, prtOutputTable=prtOutputTable, prtInterpreter=prtInterpreter, SubUnitStatus=SubUnitStatus, prtGeneralConfigChanges=prtGeneralConfigChanges, prtChannelType=prtChannelType, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, MediaUnit=MediaUnit, prtMarkerSouthMargin=prtMarkerSouthMargin, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputBursting=prtOutputBursting, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMarker=prtMarker, prtAlertGroupIndex=prtAlertGroupIndex, prtConsoleLightEntry=prtConsoleLightEntry, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMIB2Compliance=prtMIB2Compliance, prtInputDescription=prtInputDescription, PrtCapacityUnitTC=PrtCapacityUnitTC, prtChannelIfIndex=prtChannelIfIndex, prtMediaPathTable=prtMediaPathTable, prtGeneralSerialNumber=prtGeneralSerialNumber, prtAlert=prtAlert, prtAlertCriticalEvents=prtAlertCriticalEvents, prtAlertTimeGroup=prtAlertTimeGroup, prtAlertAllEvents=prtAlertAllEvents, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerEntry=prtMarkerEntry, prtConsoleGroup=prtConsoleGroup, prtMarkerLifeCount=prtMarkerLifeCount, prtAlertCode=prtAlertCode, prtAlertLocation=prtAlertLocation, prtMarkerColorantRole=prtMarkerColorantRole, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputDefaultIndex=prtInputDefaultIndex, prtAlertDescription=prtAlertDescription, printerV1Alert=printerV1Alert, prtOutputCapacityUnit=prtOutputCapacityUnit, prtInterpreterGroup=prtInterpreterGroup, prtInputDimUnit=prtInputDimUnit, prtOutput=prtOutput, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMediaPathDescription=prtMediaPathDescription, prtOutputType=prtOutputType, prtOutputName=prtOutputName, prtInputMediaFormParts=prtInputMediaFormParts, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMediaPathType=prtMediaPathType, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtGeneral=prtGeneral, prtMarkerNorthMargin=prtMarkerNorthMargin, prtGeneralEntry=prtGeneralEntry, prtInputVersion=prtInputVersion, prtMarkerWestMargin=prtMarkerWestMargin, prtCoverTable=prtCoverTable, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputDecollating=prtOutputDecollating, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtConsoleOffTime=prtConsoleOffTime, prtMarkerStatus=prtMarkerStatus, prtAlertSeverityLevel=prtAlertSeverityLevel, prtLocalizationTable=prtLocalizationTable, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerColorantTable=prtMarkerColorantTable, CodedCharSet=CodedCharSet, prtInterpreterTwoWay=prtInterpreterTwoWay, prtOutputGroup=prtOutputGroup, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputOffsetStacking=prtOutputOffsetStacking, prtCoverEntry=prtCoverEntry, prtMediaPathEntry=prtMediaPathEntry, prtLocalizationEntry=prtLocalizationEntry, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInput=prtInput, prtAlertTrainingLevel=prtAlertTrainingLevel, printerV2AlertPrefix=printerV2AlertPrefix, prtOutputModel=prtOutputModel, prtOutputSerialNumber=prtOutputSerialNumber, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInputNextIndex=prtInputNextIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, prtAlertTableV2Group=prtAlertTableV2Group, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtChannelState=prtChannelState, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMIBCompliance=prtMIBCompliance, prtInputSecurity=prtInputSecurity, prtMarkerMarkTech=prtMarkerMarkTech, prtInputMediaType=prtInputMediaType, prtOutputDimUnit=prtOutputDimUnit, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtGeneralServicePerson=prtGeneralServicePerson, prtConsoleDescription=prtConsoleDescription, prtMarkerEastMargin=prtMarkerEastMargin, prtMediaPathGroup=prtMediaPathGroup, prtMIB2Groups=prtMIB2Groups, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputMediaWeight=prtInputMediaWeight, prtInputModel=prtInputModel, prtInputMaxCapacity=prtInputMaxCapacity, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtResponsiblePartyGroup=prtResponsiblePartyGroup, PYSNMP_MODULE_ID=printmib, prtDeviceRefEntry=prtDeviceRefEntry, prtStorageRefTable=prtStorageRefTable, prtInterpreterDescription=prtInterpreterDescription, PresentOnOff=PresentOnOff, prtOutputPageCollated=prtOutputPageCollated, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInterpreterIndex=prtInterpreterIndex, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtGeneralTable=prtGeneralTable, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputName=prtInputName, prtInputStatus=prtInputStatus, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtChannelIndex=prtChannelIndex, prtAlertTableGroup=prtAlertTableGroup, prtConsoleLightTable=prtConsoleLightTable, prtGeneralV2Group=prtGeneralV2Group, prtLocalizationIndex=prtLocalizationIndex, PrtSubUnitStatusTC=PrtSubUnitStatusTC, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtStorageRefEntry=prtStorageRefEntry, prtMarkerColorant=prtMarkerColorant, prtConsoleDisable=prtConsoleDisable, prtConsoleOnTime=prtConsoleOnTime, prtInputMediaGroup=prtInputMediaGroup, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMediaPath=prtMediaPath, prtMediaPathIndex=prtMediaPathIndex, PrtChannelStateTC=PrtChannelStateTC, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputIndex=prtInputIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMarkerSuppliesType=prtMarkerSuppliesType, prtOutputMaxCapacity=prtOutputMaxCapacity, prtGeneralGroup=prtGeneralGroup, prtCover=prtCover, prtOutputDefaultIndex=prtOutputDefaultIndex, printmib=printmib, prtMIBGroups=prtMIBGroups)
mibBuilder.exportSymbols("Printer-MIB", prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInputSerialNumber=prtInputSerialNumber, prtMarkerColorantValue=prtMarkerColorantValue, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC)
