...
PrtOutputTypeTC, PrtConsoleDisableTC, PrtChannelTypeTC, PrtAlertTrainingLevelTC, PrtGeneralResetTC, PrtMarkerMarkTechTC, PrtMarkerSuppliesTypeTC, PrtAlertGroupTC, PrtInterpreterLangFamilyTC, PrtConsoleColorTC, PrtMediaPathTypeTC, PrtInputTypeTC, PrtAlertCodeTC, PrtCoverStatusTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtOutputTypeTC", "PrtConsoleDisableTC", "PrtChannelTypeTC", "PrtAlertTrainingLevelTC", "PrtGeneralResetTC", "PrtMarkerMarkTechTC", "PrtMarkerSuppliesTypeTC", "PrtAlertGroupTC", "PrtInterpreterLangFamilyTC", "PrtConsoleColorTC", "PrtMediaPathTypeTC", "PrtInputTypeTC", "PrtAlertCodeTC", "PrtCoverStatusTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtConsoleGroup=prtConsoleGroup, prtInputSecurity=prtInputSecurity, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtOutputSerialNumber=prtOutputSerialNumber, prtAlertCode=prtAlertCode, prtOutputModel=prtOutputModel, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtChannelStatus=prtChannelStatus, prtExtendedInputGroup=prtExtendedInputGroup, prtMarkerSuppliesClass=prtMarkerSuppliesClass, printmib=printmib, prtInputNextIndex=prtInputNextIndex, prtDeviceRefEntry=prtDeviceRefEntry, prtChannelTable=prtChannelTable, prtAlertLocation=prtAlertLocation, prtMediaPathType=prtMediaPathType, prtInput=prtInput, prtConsoleDescription=prtConsoleDescription, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtChannelProtocolVersion=prtChannelProtocolVersion, prtExtendedOutputGroup=prtExtendedOutputGroup, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMediaPathTable=prtMediaPathTable, prtInputMediaName=prtInputMediaName, prtMediaPathEntry=prtMediaPathEntry, prtAlertCriticalEvents=prtAlertCriticalEvents, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputName=prtInputName, prtOutputType=prtOutputType, prtMarkerColorantRole=prtMarkerColorantRole, prtAlertTableV2Group=prtAlertTableV2Group, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtConsoleOffTime=prtConsoleOffTime, SubUnitStatus=SubUnitStatus, prtMIBCompliance=prtMIBCompliance, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlertAllEvents=prtAlertAllEvents, prtAlertEntry=prtAlertEntry, prtOutputName=prtOutputName, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertIndex=prtAlertIndex, prtGeneralServicePerson=prtGeneralServicePerson, prtOutputGroup=prtOutputGroup, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputStackingOrder=prtOutputStackingOrder, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputMediaType=prtInputMediaType, prtStorageRefEntry=prtStorageRefEntry, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, MediaUnit=MediaUnit, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtGeneralTable=prtGeneralTable, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtLocalizationEntry=prtLocalizationEntry, prtConsoleDisable=prtConsoleDisable, prtInputVersion=prtInputVersion, prtInterpreterVersion=prtInterpreterVersion, prtMIB2Compliance=prtMIB2Compliance, prtConsoleLightEntry=prtConsoleLightEntry, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtConsoleLightIndex=prtConsoleLightIndex, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMediaPathGroup=prtMediaPathGroup, CapacityUnit=CapacityUnit, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputCapacityUnit=prtInputCapacityUnit, prtOutputDescription=prtOutputDescription, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtAlertTime=prtAlertTime, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, PYSNMP_MODULE_ID=printmib, prtInterpreterIndex=prtInterpreterIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtStorageRefIndex=prtStorageRefIndex, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtInterpreterLangFamily=prtInterpreterLangFamily, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInputVendorName=prtInputVendorName, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtOutputCapacityUnit=prtOutputCapacityUnit, prtCoverDescription=prtCoverDescription, prtMediaPathStatus=prtMediaPathStatus, prtAlert=prtAlert, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerSuppliesTable=prtMarkerSuppliesTable, printerV1Alert=printerV1Alert, prtOutput=prtOutput, prtCoverTable=prtCoverTable, prtOutputSecurity=prtOutputSecurity, prtInputSwitchingGroup=prtInputSwitchingGroup, prtChannelEntry=prtChannelEntry, prtInterpreterDescription=prtInterpreterDescription, PrtPrintOrientationTC=PrtPrintOrientationTC, prtConsoleLocalization=prtConsoleLocalization, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtAlertTable=prtAlertTable, prtInputType=prtInputType, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtChannelIndex=prtChannelIndex, prtMIBGroups=prtMIBGroups, prtGeneralV2Group=prtGeneralV2Group, prtChannelV2Group=prtChannelV2Group, prtOutputVendorName=prtOutputVendorName, PrtMediaUnitTC=PrtMediaUnitTC, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtLocalizationCountry=prtLocalizationCountry, prtInputModel=prtInputModel, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtDeviceRefTable=prtDeviceRefTable, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInputMediaGroup=prtInputMediaGroup, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, PrtChannelStateTC=PrtChannelStateTC, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInputStatus=prtInputStatus, prtOutputDimUnit=prtOutputDimUnit, prtMarkerEntry=prtMarkerEntry, prtAlertDescription=prtAlertDescription, prtInputDescription=prtInputDescription, prtOutputVersion=prtOutputVersion, prtMarkerEastMargin=prtMarkerEastMargin, prtMediaPathDescription=prtMediaPathDescription, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerCounterUnit=prtMarkerCounterUnit, prtOutputFeaturesGroup=prtOutputFeaturesGroup, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtGeneralEntry=prtGeneralEntry, prtInterpreterTable=prtInterpreterTable, prtConsoleColor=prtConsoleColor, prtInputDimUnit=prtInputDimUnit, prtConsoleOnTime=prtConsoleOnTime, prtMarkerColorant=prtMarkerColorant, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputIndex=prtInputIndex, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputTable=prtOutputTable, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerIndex=prtMarkerIndex, prtMarkerColorantTable=prtMarkerColorantTable, prtMediaPath=prtMediaPath, prtMarkerNorthMargin=prtMarkerNorthMargin, prtGeneralPrinterName=prtGeneralPrinterName, prtInputTable=prtInputTable, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMarkerGroup=prtMarkerGroup, prtOutputBursting=prtOutputBursting, prtAlertGroup=prtAlertGroup, prtMarkerSouthMargin=prtMarkerSouthMargin, prtResponsiblePartyGroup=prtResponsiblePartyGroup, printerV2Alert=printerV2Alert, prtMarkerColorantEntry=prtMarkerColorantEntry, prtChannelType=prtChannelType, prtInterpreterEntry=prtInterpreterEntry, prtChannelIfIndex=prtChannelIfIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlertTrainingLevel=prtAlertTrainingLevel, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputMediaWeight=prtInputMediaWeight, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtCoverStatus=prtCoverStatus, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtConsoleLights=prtConsoleLights, prtMarkerSpotColorants=prtMarkerSpotColorants, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtCover=prtCover, prtLocalizationIndex=prtLocalizationIndex, prtAlertTimeGroup=prtAlertTimeGroup, prtMIBConformance=prtMIBConformance, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, printerV2AlertPrefix=printerV2AlertPrefix, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtOutputDecollating=prtOutputDecollating, prtConsoleLightTable=prtConsoleLightTable, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMarkerSupplies=prtMarkerSupplies, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerStatus=prtMarkerStatus, prtLocalizationLanguage=prtLocalizationLanguage, prtInputMediaColor=prtInputMediaColor, prtMarkerWestMargin=prtMarkerWestMargin, prtOutputStatus=prtOutputStatus, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtChannelGroup=prtChannelGroup, prtOutputEntry=prtOutputEntry, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInputCurrentLevel=prtInputCurrentLevel, prtGeneral=prtGeneral, prtLocalization=prtLocalization, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, CodedCharSet=CodedCharSet, prtLocalizationTable=prtLocalizationTable, prtInputMaxCapacity=prtInputMaxCapacity, prtGeneralReset=prtGeneralReset, prtCoverIndex=prtCoverIndex, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputIndex=prtOutputIndex, prtInterpreterGroup=prtInterpreterGroup, prtMarkerMarkTech=prtMarkerMarkTech, prtInputGroup=prtInputGroup, prtInputEntry=prtInputEntry, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtDeviceRefIndex=prtDeviceRefIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMarkerColorantValue=prtMarkerColorantValue, prtChannelState=prtChannelState, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtOutputPageCollated=prtOutputPageCollated, prtCoverEntry=prtCoverEntry, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtStorageRefTable=prtStorageRefTable, prtGeneralGroup=prtGeneralGroup, prtMIB2Groups=prtMIB2Groups, PresentOnOff=PresentOnOff, prtChannel=prtChannel, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtAlertTableGroup=prtAlertTableGroup, prtInterpreter=prtInterpreter, prtMarker=prtMarker, prtOutputOffsetStacking=prtOutputOffsetStacking, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputSerialNumber=prtInputSerialNumber, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMediaPathIndex=prtMediaPathIndex, prtMarkerTable=prtMarkerTable, prtAlertSeverityLevel=prtAlertSeverityLevel)
mibBuilder.exportSymbols("Printer-MIB", prtChannelInformation=prtChannelInformation, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir)
