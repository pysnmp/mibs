...
PrtConsoleDisableTC, PrtChannelTypeTC, PrtMediaPathTypeTC, PrtAlertCodeTC, PrtMarkerSuppliesTypeTC, PrtConsoleColorTC, PrtMarkerMarkTechTC, PrtGeneralResetTC, PrtInterpreterLangFamilyTC, PrtInputTypeTC, PrtCoverStatusTC, PrtOutputTypeTC, PrtAlertGroupTC, PrtAlertTrainingLevelTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleDisableTC", "PrtChannelTypeTC", "PrtMediaPathTypeTC", "PrtAlertCodeTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleColorTC", "PrtMarkerMarkTechTC", "PrtGeneralResetTC", "PrtInterpreterLangFamilyTC", "PrtInputTypeTC", "PrtCoverStatusTC", "PrtOutputTypeTC", "PrtAlertGroupTC", "PrtAlertTrainingLevelTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMIB2Groups=prtMIB2Groups, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInputCapacityUnit=prtInputCapacityUnit, prtLocalizationTable=prtLocalizationTable, prtAlertTrapGroup=prtAlertTrapGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtLocalizationCountry=prtLocalizationCountry, prtInput=prtInput, prtGeneralPrinterName=prtGeneralPrinterName, prtInputCurrentLevel=prtInputCurrentLevel, prtChannelIndex=prtChannelIndex, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMarker=prtMarker, prtStorageRefTable=prtStorageRefTable, PresentOnOff=PresentOnOff, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, SubUnitStatus=SubUnitStatus, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMIBCompliance=prtMIBCompliance, prtOutputTable=prtOutputTable, prtStorageRefEntry=prtStorageRefEntry, prtOutputGroup=prtOutputGroup, prtMediaPath=prtMediaPath, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerLifeCount=prtMarkerLifeCount, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtConsoleLightTable=prtConsoleLightTable, prtLocalizationIndex=prtLocalizationIndex, prtLocalization=prtLocalization, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputVendorName=prtOutputVendorName, prtMarkerGroup=prtMarkerGroup, prtOutputName=prtOutputName, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtGeneralSerialNumber=prtGeneralSerialNumber, printmib=printmib, prtMarkerSupplies=prtMarkerSupplies, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtGeneralGroup=prtGeneralGroup, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInputNextIndex=prtInputNextIndex, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMarkerColorantTable=prtMarkerColorantTable, prtChannelV2Group=prtChannelV2Group, prtOutputDimUnit=prtOutputDimUnit, prtChannelGroup=prtChannelGroup, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtOutputVersion=prtOutputVersion, prtMarkerColorant=prtMarkerColorant, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, CodedCharSet=CodedCharSet, prtAlertTableV2Group=prtAlertTableV2Group, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputEntry=prtInputEntry, prtMarkerMarkTech=prtMarkerMarkTech, prtMIBGroups=prtMIBGroups, prtAlertTableGroup=prtAlertTableGroup, prtInputIndex=prtInputIndex, prtInputStatus=prtInputStatus, prtMarkerSpotColorants=prtMarkerSpotColorants, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputBursting=prtOutputBursting, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerWestMargin=prtMarkerWestMargin, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerColorantEntry=prtMarkerColorantEntry, prtGeneralTable=prtGeneralTable, prtInputDefaultIndex=prtInputDefaultIndex, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtAlertGroupIndex=prtAlertGroupIndex, prtInputGroup=prtInputGroup, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputModel=prtInputModel, prtInterpreter=prtInterpreter, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputType=prtInputType, prtInputSerialNumber=prtInputSerialNumber, prtChannel=prtChannel, prtInterpreterDescription=prtInterpreterDescription, prtInputDimUnit=prtInputDimUnit, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtChannelState=prtChannelState, prtInterpreterEntry=prtInterpreterEntry, printerV2Alert=printerV2Alert, prtMarkerEastMargin=prtMarkerEastMargin, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtChannelEntry=prtChannelEntry, prtGeneralV2Group=prtGeneralV2Group, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMarkerEntry=prtMarkerEntry, prtInputVendorName=prtInputVendorName, prtCoverDescription=prtCoverDescription, prtMarkerNorthMargin=prtMarkerNorthMargin, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerColorantRole=prtMarkerColorantRole, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtChannelTable=prtChannelTable, prtInputMediaColor=prtInputMediaColor, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, PrtChannelStateTC=PrtChannelStateTC, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, PrtMediaUnitTC=PrtMediaUnitTC, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInputMediaFormParts=prtInputMediaFormParts, prtInputTable=prtInputTable, prtMediaPathDescription=prtMediaPathDescription, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInterpreterIndex=prtInterpreterIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtCover=prtCover, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutput=prtOutput, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtConsoleOnTime=prtConsoleOnTime, PYSNMP_MODULE_ID=printmib, CapacityUnit=CapacityUnit, prtCoverEntry=prtCoverEntry, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtGeneral=prtGeneral, prtAlertCode=prtAlertCode, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMIBConformance=prtMIBConformance, prtConsoleGroup=prtConsoleGroup, prtMediaPathType=prtMediaPathType, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputMediaName=prtInputMediaName, prtInputMediaGroup=prtInputMediaGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtAlertTrainingLevel=prtAlertTrainingLevel, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerTable=prtMarkerTable, prtMarkerColorantIndex=prtMarkerColorantIndex, prtAlertGroup=prtAlertGroup, prtInputSecurity=prtInputSecurity, prtOutputType=prtOutputType, prtOutputIndex=prtOutputIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, prtChannelType=prtChannelType, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInputMediaType=prtInputMediaType, prtInterpreterLangLevel=prtInterpreterLangLevel, prtDeviceRefTable=prtDeviceRefTable, prtInputVersion=prtInputVersion, prtMarkerColorantValue=prtMarkerColorantValue, prtCoverIndex=prtCoverIndex, prtConsoleLightEntry=prtConsoleLightEntry, prtChannelInformation=prtChannelInformation, prtMediaPathGroup=prtMediaPathGroup, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtOutputPageCollated=prtOutputPageCollated, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMarkerProcessColorants=prtMarkerProcessColorants, prtConsoleDisable=prtConsoleDisable, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInterpreterGroup=prtInterpreterGroup, prtAlertIndex=prtAlertIndex, printerV2AlertPrefix=printerV2AlertPrefix, prtAlertDescription=prtAlertDescription, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputDimensionsGroup=prtOutputDimensionsGroup, PrtCapacityUnitTC=PrtCapacityUnitTC, prtCoverTable=prtCoverTable, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtAlertTimeGroup=prtAlertTimeGroup, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtAlertLocation=prtAlertLocation, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtConsoleLights=prtConsoleLights, prtExtendedOutputGroup=prtExtendedOutputGroup, prtInputDescription=prtInputDescription, prtConsoleDescription=prtConsoleDescription, prtInputMediaWeight=prtInputMediaWeight, printerV1Alert=printerV1Alert, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMediaPathTable=prtMediaPathTable, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtGeneralReset=prtGeneralReset, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathEntry=prtMediaPathEntry, prtAlertEntry=prtAlertEntry, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtOutputSecurity=prtOutputSecurity, prtAlertCriticalEvents=prtAlertCriticalEvents, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtCoverStatus=prtCoverStatus, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInterpreterVersion=prtInterpreterVersion, prtOutputEntry=prtOutputEntry, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputSerialNumber=prtOutputSerialNumber, prtStorageRefIndex=prtStorageRefIndex, prtOutputDescription=prtOutputDescription, prtOutputModel=prtOutputModel, prtGeneralServicePerson=prtGeneralServicePerson, prtAlert=prtAlert, prtMarkerStatus=prtMarkerStatus, prtConsoleOffTime=prtConsoleOffTime, prtMIB2Compliance=prtMIB2Compliance, prtChannelStatus=prtChannelStatus, prtOutputDefaultIndex=prtOutputDefaultIndex, prtAlertTable=prtAlertTable, prtInterpreterTable=prtInterpreterTable, MediaUnit=MediaUnit, prtGeneralEntry=prtGeneralEntry, prtMediaPathIndex=prtMediaPathIndex, prtOutputStatus=prtOutputStatus, prtInputName=prtInputName, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputDecollating=prtOutputDecollating, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMediaPathStatus=prtMediaPathStatus, prtConsoleLocalization=prtConsoleLocalization, prtConsoleLightIndex=prtConsoleLightIndex, prtMarkerIndex=prtMarkerIndex, prtChannelIfIndex=prtChannelIfIndex, prtAlertTime=prtAlertTime, PrtPrintOrientationTC=PrtPrintOrientationTC, prtLocalizationEntry=prtLocalizationEntry, prtAlertAllEvents=prtAlertAllEvents, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtConsoleColor=prtConsoleColor, prtDeviceRefIndex=prtDeviceRefIndex)
