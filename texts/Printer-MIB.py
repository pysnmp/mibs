...
PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtInputTypeTC, PrtMarkerSuppliesTypeTC, PrtChannelTypeTC, PrtGeneralResetTC, PrtConsoleDisableTC, PrtAlertGroupTC, PrtMarkerMarkTechTC, PrtMediaPathTypeTC, PrtCoverStatusTC, PrtOutputTypeTC, PrtConsoleColorTC, PrtAlertTrainingLevelTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtInputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtChannelTypeTC", "PrtGeneralResetTC", "PrtConsoleDisableTC", "PrtAlertGroupTC", "PrtMarkerMarkTechTC", "PrtMediaPathTypeTC", "PrtCoverStatusTC", "PrtOutputTypeTC", "PrtConsoleColorTC", "PrtAlertTrainingLevelTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputIndex=prtOutputIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, PrtChannelStateTC=PrtChannelStateTC, prtInputName=prtInputName, prtInputStatus=prtInputStatus, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, PrtPrintOrientationTC=PrtPrintOrientationTC, prtExtendedOutputGroup=prtExtendedOutputGroup, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputMediaColor=prtInputMediaColor, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMIBCompliance=prtMIBCompliance, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInputMediaWeight=prtInputMediaWeight, prtMarkerEastMargin=prtMarkerEastMargin, prtChannelV2Group=prtChannelV2Group, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInterpreterTable=prtInterpreterTable, prtAlertLocation=prtAlertLocation, CodedCharSet=CodedCharSet, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtConsoleLights=prtConsoleLights, prtChannelInformation=prtChannelInformation, prtConsoleGroup=prtConsoleGroup, prtDeviceRefIndex=prtDeviceRefIndex, PresentOnOff=PresentOnOff, prtInputSecurity=prtInputSecurity, prtConsoleColor=prtConsoleColor, prtMarkerSouthMargin=prtMarkerSouthMargin, prtChannelEntry=prtChannelEntry, prtInputCapacityUnit=prtInputCapacityUnit, prtInputMediaName=prtInputMediaName, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMarkerSpotColorants=prtMarkerSpotColorants, MediaUnit=MediaUnit, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMIBGroups=prtMIBGroups, prtOutputVersion=prtOutputVersion, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtInputModel=prtInputModel, prtOutputStackingOrder=prtOutputStackingOrder, prtAlertIndex=prtAlertIndex, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMediaPathType=prtMediaPathType, prtMarkerGroup=prtMarkerGroup, prtMarkerColorantRole=prtMarkerColorantRole, prtAlertTimeGroup=prtAlertTimeGroup, prtGeneralSerialNumber=prtGeneralSerialNumber, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, printerV1Alert=printerV1Alert, PYSNMP_MODULE_ID=printmib, prtOutputDecollating=prtOutputDecollating, prtConsoleOffTime=prtConsoleOffTime, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtAlertCode=prtAlertCode, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtAlertCriticalEvents=prtAlertCriticalEvents, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputMaxCapacity=prtInputMaxCapacity, prtLocalizationTable=prtLocalizationTable, prtInputDimUnit=prtInputDimUnit, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtGeneralEntry=prtGeneralEntry, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtInputCurrentLevel=prtInputCurrentLevel, prtConsoleDisable=prtConsoleDisable, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMediaPathGroup=prtMediaPathGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, prtOutputTable=prtOutputTable, prtOutputDefaultIndex=prtOutputDefaultIndex, prtStorageRefEntry=prtStorageRefEntry, prtConsoleLightTable=prtConsoleLightTable, prtInputType=prtInputType, prtChannelTable=prtChannelTable, prtInputTable=prtInputTable, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMIB2Compliance=prtMIB2Compliance, prtAlertTrapGroup=prtAlertTrapGroup, prtOutputCapacityUnit=prtOutputCapacityUnit, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputEntry=prtOutputEntry, prtMediaPathDescription=prtMediaPathDescription, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerColorant=prtMarkerColorant, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtAlertAllEvents=prtAlertAllEvents, prtCoverStatus=prtCoverStatus, prtInterpreterLangFamily=prtInterpreterLangFamily, prtCoverIndex=prtCoverIndex, prtConsoleLocalization=prtConsoleLocalization, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtAlert=prtAlert, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtChannelType=prtChannelType, prtMIBConformance=prtMIBConformance, prtOutputName=prtOutputName, prtMarkerSupplies=prtMarkerSupplies, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtCoverDescription=prtCoverDescription, prtMarkerTable=prtMarkerTable, prtMediaPathStatus=prtMediaPathStatus, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtAlertTime=prtAlertTime, prtConsoleLightIndex=prtConsoleLightIndex, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInputMediaGroup=prtInputMediaGroup, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInputDefaultIndex=prtInputDefaultIndex, prtChannelStatus=prtChannelStatus, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtOutputGroup=prtOutputGroup, prtMarkerWestMargin=prtMarkerWestMargin, prtInput=prtInput, prtInterpreter=prtInterpreter, prtOutputSecurity=prtOutputSecurity, prtAlertDescription=prtAlertDescription, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputStatus=prtOutputStatus, prtOutputVendorName=prtOutputVendorName, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputIndex=prtInputIndex, SubUnitStatus=SubUnitStatus, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMediaPathEntry=prtMediaPathEntry, prtInputSerialNumber=prtInputSerialNumber, printmib=printmib, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInterpreterDescription=prtInterpreterDescription, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtConsoleLightEntry=prtConsoleLightEntry, prtInterpreterEntry=prtInterpreterEntry, prtMarkerMarkTech=prtMarkerMarkTech, prtLocalizationLanguage=prtLocalizationLanguage, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtAlertGroup=prtAlertGroup, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtExtendedInputGroup=prtExtendedInputGroup, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtCoverEntry=prtCoverEntry, prtLocalizationCountry=prtLocalizationCountry, prtMediaPathIndex=prtMediaPathIndex, prtOutputDimUnit=prtOutputDimUnit, prtChannelIndex=prtChannelIndex, prtConsoleOnTime=prtConsoleOnTime, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtOutputModel=prtOutputModel, prtOutputDescription=prtOutputDescription, prtLocalizationEntry=prtLocalizationEntry, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInterpreterLangLevel=prtInterpreterLangLevel, prtAlertTable=prtAlertTable, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputNextIndex=prtInputNextIndex, prtOutputType=prtOutputType, prtAlertTableV2Group=prtAlertTableV2Group, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtAlertTrainingLevel=prtAlertTrainingLevel, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputBursting=prtOutputBursting, prtGeneralTable=prtGeneralTable, prtCoverTable=prtCoverTable, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMarker=prtMarker, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtDeviceRefTable=prtDeviceRefTable, prtInputVendorName=prtInputVendorName, prtMarkerColorantEntry=prtMarkerColorantEntry, prtInputGroup=prtInputGroup, prtInputEntry=prtInputEntry, printerV2AlertPrefix=printerV2AlertPrefix, prtMediaPath=prtMediaPath, prtGeneralServicePerson=prtGeneralServicePerson, prtInputVersion=prtInputVersion, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerColorantTable=prtMarkerColorantTable, prtChannelIfIndex=prtChannelIfIndex, prtMediaPathTable=prtMediaPathTable, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerIndex=prtMarkerIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtGeneralV2Group=prtGeneralV2Group, prtInterpreterVersion=prtInterpreterVersion, prtMarkerColorantValue=prtMarkerColorantValue, prtChannel=prtChannel, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtChannelState=prtChannelState, prtAlertTableGroup=prtAlertTableGroup, prtStorageRefTable=prtStorageRefTable, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtAlertGroupIndex=prtAlertGroupIndex, prtMarkerEntry=prtMarkerEntry, prtChannelGroup=prtChannelGroup, prtInputMediaType=prtInputMediaType, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtConsoleDescription=prtConsoleDescription, prtGeneralPrinterName=prtGeneralPrinterName, prtStorageRefIndex=prtStorageRefIndex, prtOutputPageCollated=prtOutputPageCollated, prtGeneralGroup=prtGeneralGroup, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtLocalization=prtLocalization, prtDeviceRefEntry=prtDeviceRefEntry, prtOutput=prtOutput, printerV2Alert=printerV2Alert, prtInterpreterGroup=prtInterpreterGroup, prtMarkerCounterUnit=prtMarkerCounterUnit, prtGeneral=prtGeneral, prtMarkerSuppliesClass=prtMarkerSuppliesClass, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtCover=prtCover, prtMarkerLifeCount=prtMarkerLifeCount, prtInputDescription=prtInputDescription, prtInputMediaFormParts=prtInputMediaFormParts, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerNorthMargin=prtMarkerNorthMargin, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerStatus=prtMarkerStatus, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInterpreterIndex=prtInterpreterIndex, prtAlertEntry=prtAlertEntry, prtMIB2Groups=prtMIB2Groups, prtInterpreterTwoWay=prtInterpreterTwoWay, prtGeneralReset=prtGeneralReset, prtOutputSerialNumber=prtOutputSerialNumber, prtLocalizationIndex=prtLocalizationIndex, CapacityUnit=CapacityUnit, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, PrtCapacityUnitTC=PrtCapacityUnitTC, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC)
mibBuilder.exportSymbols("Printer-MIB", prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit)
