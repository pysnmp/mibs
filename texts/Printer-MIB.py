...
PrtMediaPathTypeTC, PrtInterpreterLangFamilyTC, PrtConsoleDisableTC, PrtAlertCodeTC, PrtGeneralResetTC, PrtMarkerSuppliesTypeTC, PrtCoverStatusTC, PrtChannelTypeTC, PrtInputTypeTC, PrtOutputTypeTC, PrtMarkerMarkTechTC, PrtAlertGroupTC, PrtAlertTrainingLevelTC, PrtConsoleColorTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMediaPathTypeTC", "PrtInterpreterLangFamilyTC", "PrtConsoleDisableTC", "PrtAlertCodeTC", "PrtGeneralResetTC", "PrtMarkerSuppliesTypeTC", "PrtCoverStatusTC", "PrtChannelTypeTC", "PrtInputTypeTC", "PrtOutputTypeTC", "PrtMarkerMarkTechTC", "PrtAlertGroupTC", "PrtAlertTrainingLevelTC", "PrtConsoleColorTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtChannelEntry=prtChannelEntry, prtOutputGroup=prtOutputGroup, prtStorageRefEntry=prtStorageRefEntry, MediaUnit=MediaUnit, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtChannelState=prtChannelState, prtOutputVersion=prtOutputVersion, prtChannelInformation=prtChannelInformation, prtInputDefaultIndex=prtInputDefaultIndex, prtGeneralEntry=prtGeneralEntry, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtAlertGroup=prtAlertGroup, prtStorageRefTable=prtStorageRefTable, PrtMediaUnitTC=PrtMediaUnitTC, prtInputModel=prtInputModel, prtMarkerMarkTech=prtMarkerMarkTech, prtInterpreterTable=prtInterpreterTable, prtConsoleLightIndex=prtConsoleLightIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, printmib=printmib, prtOutputModel=prtOutputModel, prtInterpreterEntry=prtInterpreterEntry, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, SubUnitStatus=SubUnitStatus, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtChannelStatus=prtChannelStatus, CapacityUnit=CapacityUnit, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInterpreterLangFamily=prtInterpreterLangFamily, prtAlertEntry=prtAlertEntry, prtInterpreterGroup=prtInterpreterGroup, prtMarkerWestMargin=prtMarkerWestMargin, prtMIBCompliance=prtMIBCompliance, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtStorageRefIndex=prtStorageRefIndex, prtOutputName=prtOutputName, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMediaWeight=prtInputMediaWeight, prtInputTable=prtInputTable, prtMarkerEastMargin=prtMarkerEastMargin, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInterpreterDescription=prtInterpreterDescription, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMIBGroups=prtMIBGroups, CodedCharSet=CodedCharSet, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtConsoleLights=prtConsoleLights, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputEntry=prtOutputEntry, prtInputType=prtInputType, prtCoverStatus=prtCoverStatus, prtAlertTableGroup=prtAlertTableGroup, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerNorthMargin=prtMarkerNorthMargin, prtDeviceRefTable=prtDeviceRefTable, prtGeneral=prtGeneral, printerV2Alert=printerV2Alert, prtLocalization=prtLocalization, prtAlertIndex=prtAlertIndex, prtMarkerSouthMargin=prtMarkerSouthMargin, printerV1Alert=printerV1Alert, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtGeneralTable=prtGeneralTable, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInputCurrentLevel=prtInputCurrentLevel, prtConsoleOnTime=prtConsoleOnTime, prtConsoleDescription=prtConsoleDescription, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutputIndex=prtOutputIndex, prtLocalizationTable=prtLocalizationTable, prtInterpreter=prtInterpreter, prtInputGroup=prtInputGroup, prtExtendedOutputGroup=prtExtendedOutputGroup, prtAlertTable=prtAlertTable, prtInterpreterLangVersion=prtInterpreterLangVersion, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtExtendedInputGroup=prtExtendedInputGroup, prtChannelIndex=prtChannelIndex, prtAlertLocation=prtAlertLocation, prtMediaPath=prtMediaPath, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMediaPathIndex=prtMediaPathIndex, prtOutputFeaturesGroup=prtOutputFeaturesGroup, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathStatus=prtMediaPathStatus, prtOutputSecurity=prtOutputSecurity, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInputMediaColor=prtInputMediaColor, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtLocalizationCountry=prtLocalizationCountry, prtMarkerSupplies=prtMarkerSupplies, prtChannel=prtChannel, prtMediaPathTable=prtMediaPathTable, prtInputDimUnit=prtInputDimUnit, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, printerV2AlertPrefix=printerV2AlertPrefix, PrtChannelStateTC=PrtChannelStateTC, prtConsoleLightTable=prtConsoleLightTable, prtAlert=prtAlert, prtAlertCriticalEvents=prtAlertCriticalEvents, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInputMediaType=prtInputMediaType, prtMIBConformance=prtMIBConformance, prtMarkerProcessColorants=prtMarkerProcessColorants, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtInput=prtInput, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMIB2Groups=prtMIB2Groups, prtMarker=prtMarker, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputDefaultIndex=prtOutputDefaultIndex, prtCover=prtCover, prtMarkerColorant=prtMarkerColorant, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInputSerialNumber=prtInputSerialNumber, prtInputName=prtInputName, PYSNMP_MODULE_ID=printmib, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtAlertDescription=prtAlertDescription, prtMediaPathEntry=prtMediaPathEntry, prtOutputStatus=prtOutputStatus, prtInputCapacityUnit=prtInputCapacityUnit, prtInputVendorName=prtInputVendorName, prtAlertGroupIndex=prtAlertGroupIndex, prtInputMaxCapacity=prtInputMaxCapacity, prtMarkerEntry=prtMarkerEntry, prtCoverDescription=prtCoverDescription, prtMarkerColorantGroup=prtMarkerColorantGroup, prtChannelType=prtChannelType, prtInputNextIndex=prtInputNextIndex, prtInputSwitchingGroup=prtInputSwitchingGroup, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtConsoleLocalization=prtConsoleLocalization, prtOutputBursting=prtOutputBursting, prtCoverIndex=prtCoverIndex, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputDimUnit=prtOutputDimUnit, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, PresentOnOff=PresentOnOff, prtMarkerColorantValue=prtMarkerColorantValue, prtConsoleColor=prtConsoleColor, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtConsoleGroup=prtConsoleGroup, prtChannelProtocolVersion=prtChannelProtocolVersion, prtOutputSerialNumber=prtOutputSerialNumber, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputStackingOrder=prtOutputStackingOrder, prtCoverTable=prtCoverTable, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtChannelIfIndex=prtChannelIfIndex, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerColorantIndex=prtMarkerColorantIndex, prtChannelGroup=prtChannelGroup, prtOutputType=prtOutputType, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInputMediaGroup=prtInputMediaGroup, prtOutputTable=prtOutputTable, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtConsoleOffTime=prtConsoleOffTime, prtAlertTrainingLevel=prtAlertTrainingLevel, prtAlertTimeGroup=prtAlertTimeGroup, prtAlertCode=prtAlertCode, prtGeneralV2Group=prtGeneralV2Group, prtGeneralReset=prtGeneralReset, prtGeneralServicePerson=prtGeneralServicePerson, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputVersion=prtInputVersion, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtConsoleLightEntry=prtConsoleLightEntry, prtDeviceRefEntry=prtDeviceRefEntry, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInterpreterVersion=prtInterpreterVersion, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtGeneralPrinterName=prtGeneralPrinterName, prtOutputVendorName=prtOutputVendorName, prtMIB2Compliance=prtMIB2Compliance, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerTable=prtMarkerTable, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtOutputDescription=prtOutputDescription, prtAlertTime=prtAlertTime, prtLocalizationEntry=prtLocalizationEntry, prtInputMediaName=prtInputMediaName, prtCoverEntry=prtCoverEntry, prtInputIndex=prtInputIndex, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtAlertAllEvents=prtAlertAllEvents, prtInputEntry=prtInputEntry, prtMediaPathType=prtMediaPathType, prtChannelTable=prtChannelTable, prtMediaPathDescription=prtMediaPathDescription, prtLocalizationIndex=prtLocalizationIndex, prtInterpreterIndex=prtInterpreterIndex, prtConsoleDisable=prtConsoleDisable, prtMarkerIndex=prtMarkerIndex, prtInputDescription=prtInputDescription, prtInterpreterLangLevel=prtInterpreterLangLevel, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMediaPathGroup=prtMediaPathGroup, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtOutputPageCollated=prtOutputPageCollated, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputDecollating=prtOutputDecollating, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerColorantEntry=prtMarkerColorantEntry, prtInputStatus=prtInputStatus, prtMarkerColorantRole=prtMarkerColorantRole, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerStatus=prtMarkerStatus, prtAlertTrapGroup=prtAlertTrapGroup, prtChannelV2Group=prtChannelV2Group, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInputSecurity=prtInputSecurity, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtGeneralGroup=prtGeneralGroup)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerGroup=prtMarkerGroup, prtOutput=prtOutput, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInputMediaFormParts=prtInputMediaFormParts)
