...
PrtOutputTypeTC, PrtGeneralResetTC, PrtMarkerSuppliesTypeTC, PrtConsoleColorTC, PrtInputTypeTC, PrtChannelTypeTC, PrtMarkerMarkTechTC, PrtAlertGroupTC, PrtCoverStatusTC, PrtAlertTrainingLevelTC, PrtConsoleDisableTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtOutputTypeTC", "PrtGeneralResetTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleColorTC", "PrtInputTypeTC", "PrtChannelTypeTC", "PrtMarkerMarkTechTC", "PrtAlertGroupTC", "PrtCoverStatusTC", "PrtAlertTrainingLevelTC", "PrtConsoleDisableTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", PresentOnOff=PresentOnOff, prtChannelInformation=prtChannelInformation, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtConsoleLightTable=prtConsoleLightTable, prtInputModel=prtInputModel, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInputMediaGroup=prtInputMediaGroup, prtOutputDimUnit=prtOutputDimUnit, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInterpreterEntry=prtInterpreterEntry, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, PrtMediaUnitTC=PrtMediaUnitTC, prtInputSerialNumber=prtInputSerialNumber, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtLocalizationCountry=prtLocalizationCountry, prtInputVendorName=prtInputVendorName, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputMediaName=prtInputMediaName, prtInputType=prtInputType, prtMarkerEntry=prtMarkerEntry, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtConsoleLights=prtConsoleLights, prtOutputName=prtOutputName, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtLocalizationIndex=prtLocalizationIndex, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtAlertLocation=prtAlertLocation, prtChannelState=prtChannelState, prtMIB2Compliance=prtMIB2Compliance, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputTable=prtOutputTable, prtMarkerWestMargin=prtMarkerWestMargin, prtMarkerGroup=prtMarkerGroup, prtInterpreterVersion=prtInterpreterVersion, printmib=printmib, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtAlertGroup=prtAlertGroup, prtInputDefaultIndex=prtInputDefaultIndex, prtConsoleColor=prtConsoleColor, prtChannelGroup=prtChannelGroup, prtMarkerColorantValue=prtMarkerColorantValue, prtGeneralPrinterName=prtGeneralPrinterName, prtMediaPathStatus=prtMediaPathStatus, prtInputMediaWeight=prtInputMediaWeight, prtInputIndex=prtInputIndex, prtChannelStatus=prtChannelStatus, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMediaPathEntry=prtMediaPathEntry, prtOutputPageCollated=prtOutputPageCollated, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtGeneral=prtGeneral, prtInputDescription=prtInputDescription, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMarkerColorant=prtMarkerColorant, prtMediaPathType=prtMediaPathType, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerTable=prtMarkerTable, prtOutputCapacityUnit=prtOutputCapacityUnit, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInputTable=prtInputTable, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, PrtChannelStateTC=PrtChannelStateTC, prtChannelIndex=prtChannelIndex, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMIBGroups=prtMIBGroups, prtLocalizationLanguage=prtLocalizationLanguage, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMarkerSouthMargin=prtMarkerSouthMargin, PrtCapacityUnitTC=PrtCapacityUnitTC, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtChannel=prtChannel, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtChannelV2Group=prtChannelV2Group, prtCoverIndex=prtCoverIndex, prtMarkerColorantEntry=prtMarkerColorantEntry, prtInputMediaType=prtInputMediaType, prtInputVersion=prtInputVersion, prtOutputDecollating=prtOutputDecollating, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtDeviceRefIndex=prtDeviceRefIndex, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputType=prtOutputType, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtChannelType=prtChannelType, prtMarkerColorantGroup=prtMarkerColorantGroup, prtLocalization=prtLocalization, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMarker=prtMarker, prtOutputStackingOrder=prtOutputStackingOrder, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, PYSNMP_MODULE_ID=printmib, prtInputMediaColor=prtInputMediaColor, prtConsoleDisable=prtConsoleDisable, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutputIndex=prtOutputIndex, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtGeneralEntry=prtGeneralEntry, prtChannelTable=prtChannelTable, prtCoverTable=prtCoverTable, printerV1Alert=printerV1Alert, prtMediaPathIndex=prtMediaPathIndex, prtMarkerLifeCount=prtMarkerLifeCount, prtOutput=prtOutput, prtExtendedInputGroup=prtExtendedInputGroup, prtInterpreterIndex=prtInterpreterIndex, prtChannelProtocolVersion=prtChannelProtocolVersion, prtAlertTimeGroup=prtAlertTimeGroup, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInterpreterLangVersion=prtInterpreterLangVersion, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInputMaxCapacity=prtInputMaxCapacity, prtInput=prtInput, prtCoverEntry=prtCoverEntry, prtMarkerCounterUnit=prtMarkerCounterUnit, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtOutputEntry=prtOutputEntry, CodedCharSet=CodedCharSet, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInterpreterDescription=prtInterpreterDescription, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlertTable=prtAlertTable, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerColorantTable=prtMarkerColorantTable, SubUnitStatus=SubUnitStatus, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtGeneralGroup=prtGeneralGroup, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInterpreter=prtInterpreter, prtCoverDescription=prtCoverDescription, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMarkerMarkTech=prtMarkerMarkTech, prtMediaPath=prtMediaPath, prtMIB2Groups=prtMIB2Groups, prtOutputVendorName=prtOutputVendorName, prtGeneralSerialNumber=prtGeneralSerialNumber, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerProcessColorants=prtMarkerProcessColorants, prtOutputStatus=prtOutputStatus, prtInterpreterTwoWay=prtInterpreterTwoWay, prtConsoleOffTime=prtConsoleOffTime, prtConsoleDescription=prtConsoleDescription, printerV2AlertPrefix=printerV2AlertPrefix, prtConsoleLightIndex=prtConsoleLightIndex, prtInputCapacityUnit=prtInputCapacityUnit, prtCover=prtCover, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerSupplies=prtMarkerSupplies, prtInterpreterGroup=prtInterpreterGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtExtendedOutputGroup=prtExtendedOutputGroup, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtAlertTime=prtAlertTime, prtGeneralV2Group=prtGeneralV2Group, prtOutputModel=prtOutputModel, prtOutputMaxCapacity=prtOutputMaxCapacity, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtAlertAllEvents=prtAlertAllEvents, prtLocalizationTable=prtLocalizationTable, prtInterpreterTable=prtInterpreterTable, printerV2Alert=printerV2Alert, prtInputSecurity=prtInputSecurity, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMarkerStatus=prtMarkerStatus, CapacityUnit=CapacityUnit, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtAlertTableGroup=prtAlertTableGroup, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInputName=prtInputName, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtDeviceRefTable=prtDeviceRefTable, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtInputGroup=prtInputGroup, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtAlert=prtAlert, prtConsoleLocalization=prtConsoleLocalization, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputSecurity=prtOutputSecurity, prtGeneralServicePerson=prtGeneralServicePerson, prtAlertIndex=prtAlertIndex, prtGeneralTable=prtGeneralTable, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtConsoleLightEntry=prtConsoleLightEntry, prtAlertGroupIndex=prtAlertGroupIndex, prtConsoleGroup=prtConsoleGroup, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerEastMargin=prtMarkerEastMargin, prtInputSwitchingGroup=prtInputSwitchingGroup, prtLocalizationEntry=prtLocalizationEntry, prtOutputVersion=prtOutputVersion, prtInputStatus=prtInputStatus, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMediaPathDescription=prtMediaPathDescription, prtAlertDescription=prtAlertDescription, prtMIBCompliance=prtMIBCompliance, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputDescription=prtOutputDescription, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtOutputBursting=prtOutputBursting, MediaUnit=MediaUnit, prtStorageRefEntry=prtStorageRefEntry, prtGeneralReset=prtGeneralReset, prtCoverStatus=prtCoverStatus, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtAlertTableV2Group=prtAlertTableV2Group, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMediaPathTable=prtMediaPathTable, prtInputDimUnit=prtInputDimUnit, prtConsoleOnTime=prtConsoleOnTime, prtInputEntry=prtInputEntry, prtChannelEntry=prtChannelEntry, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtChannelIfIndex=prtChannelIfIndex, prtAlertCode=prtAlertCode, prtAlertEntry=prtAlertEntry, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInputNextIndex=prtInputNextIndex, prtMarkerIndex=prtMarkerIndex, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMarkerNorthMargin=prtMarkerNorthMargin, prtOutputGroup=prtOutputGroup, prtStorageRefIndex=prtStorageRefIndex)
mibBuilder.exportSymbols("Printer-MIB", prtMIBConformance=prtMIBConformance, prtMediaPathGroup=prtMediaPathGroup, prtStorageRefTable=prtStorageRefTable, prtGeneralCurrentOperator=prtGeneralCurrentOperator)
