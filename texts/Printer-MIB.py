...
PrtMediaPathTypeTC, PrtInputTypeTC, PrtAlertTrainingLevelTC, PrtAlertCodeTC, PrtConsoleColorTC, PrtOutputTypeTC, PrtConsoleDisableTC, PrtMarkerMarkTechTC, PrtInterpreterLangFamilyTC, PrtCoverStatusTC, PrtChannelTypeTC, PrtAlertGroupTC, PrtMarkerSuppliesTypeTC, PrtGeneralResetTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMediaPathTypeTC", "PrtInputTypeTC", "PrtAlertTrainingLevelTC", "PrtAlertCodeTC", "PrtConsoleColorTC", "PrtOutputTypeTC", "PrtConsoleDisableTC", "PrtMarkerMarkTechTC", "PrtInterpreterLangFamilyTC", "PrtCoverStatusTC", "PrtChannelTypeTC", "PrtAlertGroupTC", "PrtMarkerSuppliesTypeTC", "PrtGeneralResetTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMIB2Groups=prtMIB2Groups, prtGeneralEntry=prtGeneralEntry, prtAlert=prtAlert, prtMediaPathGroup=prtMediaPathGroup, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtOutputGroup=prtOutputGroup, prtMediaPathStatus=prtMediaPathStatus, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutputModel=prtOutputModel, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, printerV2AlertPrefix=printerV2AlertPrefix, prtInterpreterGroup=prtInterpreterGroup, prtOutputPageCollated=prtOutputPageCollated, prtInputMediaGroup=prtInputMediaGroup, prtMarkerColorantTonality=prtMarkerColorantTonality, prtLocalizationLanguage=prtLocalizationLanguage, prtGeneralGroup=prtGeneralGroup, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInput=prtInput, prtConsoleDescription=prtConsoleDescription, prtAlertEntry=prtAlertEntry, prtInputSwitchingGroup=prtInputSwitchingGroup, prtAlertIndex=prtAlertIndex, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtLocalizationEntry=prtLocalizationEntry, prtGeneral=prtGeneral, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInputMediaType=prtInputMediaType, prtOutputCapacityUnit=prtOutputCapacityUnit, prtChannelTable=prtChannelTable, prtChannelGroup=prtChannelGroup, CodedCharSet=CodedCharSet, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputOffsetStacking=prtOutputOffsetStacking, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtChannelInformation=prtChannelInformation, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMarkerSupplies=prtMarkerSupplies, prtMarkerStatus=prtMarkerStatus, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInputDefaultIndex=prtInputDefaultIndex, prtInputType=prtInputType, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlertGroupIndex=prtAlertGroupIndex, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMarkerIndex=prtMarkerIndex, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInputTable=prtInputTable, prtAlertTrainingLevel=prtAlertTrainingLevel, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtLocalizationIndex=prtLocalizationIndex, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInputSerialNumber=prtInputSerialNumber, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtDeviceRefTable=prtDeviceRefTable, prtMarkerLifeCount=prtMarkerLifeCount, SubUnitStatus=SubUnitStatus, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtCoverIndex=prtCoverIndex, prtDeviceRefIndex=prtDeviceRefIndex, CapacityUnit=CapacityUnit, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtAlertTimeGroup=prtAlertTimeGroup, prtInputCapacityUnit=prtInputCapacityUnit, prtCoverTable=prtCoverTable, prtMediaPath=prtMediaPath, prtMIBConformance=prtMIBConformance, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerColorantIndex=prtMarkerColorantIndex, prtInputEntry=prtInputEntry, prtConsoleOnTime=prtConsoleOnTime, prtAlertTableGroup=prtAlertTableGroup, prtInputSecurity=prtInputSecurity, MediaUnit=MediaUnit, PrtChannelStateTC=PrtChannelStateTC, prtAlertTrapGroup=prtAlertTrapGroup, prtAlertGroup=prtAlertGroup, prtLocalizationCountry=prtLocalizationCountry, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, printmib=printmib, prtInterpreter=prtInterpreter, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtAlertCode=prtAlertCode, prtOutputName=prtOutputName, prtLocalization=prtLocalization, prtStorageRefIndex=prtStorageRefIndex, prtOutputStatus=prtOutputStatus, prtMarkerCounterUnit=prtMarkerCounterUnit, prtConsoleGroup=prtConsoleGroup, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerColorant=prtMarkerColorant, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMIB2Compliance=prtMIB2Compliance, prtInputMediaName=prtInputMediaName, prtOutputMaxCapacity=prtOutputMaxCapacity, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputModel=prtInputModel, prtInterpreterLangVersion=prtInterpreterLangVersion, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInputMediaFormParts=prtInputMediaFormParts, prtInterpreterVersion=prtInterpreterVersion, prtOutputSecurity=prtOutputSecurity, prtCoverEntry=prtCoverEntry, prtStorageRefTable=prtStorageRefTable, prtMarkerEastMargin=prtMarkerEastMargin, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtChannelType=prtChannelType, prtInputIndex=prtInputIndex, prtConsoleLights=prtConsoleLights, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputStatus=prtInputStatus, prtOutputDimUnit=prtOutputDimUnit, printerV1Alert=printerV1Alert, printerV2Alert=printerV2Alert, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputMediaWeight=prtInputMediaWeight, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputVersion=prtOutputVersion, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInterpreterLangFamily=prtInterpreterLangFamily, prtOutputEntry=prtOutputEntry, prtChannelStatus=prtChannelStatus, PresentOnOff=PresentOnOff, prtMarkerTable=prtMarkerTable, prtChannelIfIndex=prtChannelIfIndex, prtInputName=prtInputName, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtConsoleLocalization=prtConsoleLocalization, prtExtendedOutputGroup=prtExtendedOutputGroup, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerWestMargin=prtMarkerWestMargin, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputDecollating=prtOutputDecollating, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInterpreterDescription=prtInterpreterDescription, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtConsoleLightEntry=prtConsoleLightEntry, prtConsoleLightTable=prtConsoleLightTable, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerEntry=prtMarkerEntry, prtInputDimUnit=prtInputDimUnit, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputMediaColor=prtInputMediaColor, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtOutputBursting=prtOutputBursting, prtOutputTable=prtOutputTable, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtAlertLocation=prtAlertLocation, prtAlertAllEvents=prtAlertAllEvents, prtStorageRefEntry=prtStorageRefEntry, prtMediaPathEntry=prtMediaPathEntry, prtConsoleDisable=prtConsoleDisable, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtOutputSerialNumber=prtOutputSerialNumber, prtAlertTable=prtAlertTable, prtGeneralV2Group=prtGeneralV2Group, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtGeneralReset=prtGeneralReset, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, PYSNMP_MODULE_ID=printmib, prtChannelIndex=prtChannelIndex, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerColorantValue=prtMarkerColorantValue, prtDeviceRefEntry=prtDeviceRefEntry, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMediaPathDescription=prtMediaPathDescription, prtAlertDescription=prtAlertDescription, prtChannel=prtChannel, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtLocalizationTable=prtLocalizationTable, prtConsoleLightIndex=prtConsoleLightIndex, prtMediaPathTable=prtMediaPathTable, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInterpreterIndex=prtInterpreterIndex, prtMIBGroups=prtMIBGroups, prtChannelV2Group=prtChannelV2Group, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputStackingOrder=prtOutputStackingOrder, prtChannelState=prtChannelState, prtMarkerGroup=prtMarkerGroup, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtChannelEntry=prtChannelEntry, prtMediaPathIndex=prtMediaPathIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputGroup=prtInputGroup, prtAlertTableV2Group=prtAlertTableV2Group, prtGeneralTable=prtGeneralTable, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtExtendedInputGroup=prtExtendedInputGroup, prtConsoleOffTime=prtConsoleOffTime, prtOutputDescription=prtOutputDescription, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtOutputType=prtOutputType, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInputNextIndex=prtInputNextIndex, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarker=prtMarker, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtCoverStatus=prtCoverStatus, prtOutput=prtOutput, prtInputCurrentLevel=prtInputCurrentLevel, prtConsoleColor=prtConsoleColor, prtMarkerMarkTech=prtMarkerMarkTech, prtCoverDescription=prtCoverDescription, prtAlertTime=prtAlertTime, prtMIBCompliance=prtMIBCompliance, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInterpreterTable=prtInterpreterTable, prtInterpreterEntry=prtInterpreterEntry, prtOutputVendorName=prtOutputVendorName, prtAlertSeverityLevel=prtAlertSeverityLevel, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInputDescription=prtInputDescription, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInputVendorName=prtInputVendorName, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir)
mibBuilder.exportSymbols("Printer-MIB", prtMediaPathType=prtMediaPathType, prtOutputIndex=prtOutputIndex, prtInputVersion=prtInputVersion, prtCover=prtCover)
