...
PrtCoverStatusTC, PrtGeneralResetTC, PrtConsoleDisableTC, PrtAlertGroupTC, PrtInterpreterLangFamilyTC, PrtChannelTypeTC, PrtInputTypeTC, PrtOutputTypeTC, PrtAlertCodeTC, PrtAlertTrainingLevelTC, PrtConsoleColorTC, PrtMediaPathTypeTC, PrtMarkerSuppliesTypeTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtCoverStatusTC", "PrtGeneralResetTC", "PrtConsoleDisableTC", "PrtAlertGroupTC", "PrtInterpreterLangFamilyTC", "PrtChannelTypeTC", "PrtInputTypeTC", "PrtOutputTypeTC", "PrtAlertCodeTC", "PrtAlertTrainingLevelTC", "PrtConsoleColorTC", "PrtMediaPathTypeTC", "PrtMarkerSuppliesTypeTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputSwitchingGroup=prtInputSwitchingGroup, prtGeneralEntry=prtGeneralEntry, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtCoverStatus=prtCoverStatus, prtStorageRefIndex=prtStorageRefIndex, prtInputVersion=prtInputVersion, prtMarkerTable=prtMarkerTable, PrtPrintOrientationTC=PrtPrintOrientationTC, prtDeviceRefTable=prtDeviceRefTable, prtMediaPathType=prtMediaPathType, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputGroup=prtOutputGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtConsoleLightTable=prtConsoleLightTable, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMIBGroups=prtMIBGroups, prtInputEntry=prtInputEntry, prtOutputPageCollated=prtOutputPageCollated, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputStatus=prtOutputStatus, prtConsoleLightEntry=prtConsoleLightEntry, prtMIBConformance=prtMIBConformance, prtInputSecurity=prtInputSecurity, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInputMediaType=prtInputMediaType, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInterpreterEntry=prtInterpreterEntry, prtAlertCode=prtAlertCode, prtMIB2Compliance=prtMIB2Compliance, prtMarkerWestMargin=prtMarkerWestMargin, prtStorageRefEntry=prtStorageRefEntry, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtInterpreter=prtInterpreter, prtInputVendorName=prtInputVendorName, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerColorant=prtMarkerColorant, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInputType=prtInputType, prtCover=prtCover, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtGeneralReset=prtGeneralReset, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInputStatus=prtInputStatus, prtConsoleDisable=prtConsoleDisable, prtMediaPathIndex=prtMediaPathIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtCoverEntry=prtCoverEntry, prtChannelStatus=prtChannelStatus, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtAlertLocation=prtAlertLocation, prtInterpreterDescription=prtInterpreterDescription, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleColor=prtConsoleColor, prtMarkerGroup=prtMarkerGroup, PresentOnOff=PresentOnOff, printerV1Alert=printerV1Alert, prtChannelInformation=prtChannelInformation, prtDeviceRefEntry=prtDeviceRefEntry, prtConsoleLights=prtConsoleLights, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMediaPath=prtMediaPath, prtInput=prtInput, prtInputMaxCapacity=prtInputMaxCapacity, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMIBCompliance=prtMIBCompliance, prtLocalizationTable=prtLocalizationTable, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputName=prtOutputName, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelIndex=prtChannelIndex, prtConsoleDescription=prtConsoleDescription, prtInterpreterVersion=prtInterpreterVersion, prtAlertTable=prtAlertTable, prtMarkerColorantTable=prtMarkerColorantTable, prtChannelProtocolVersion=prtChannelProtocolVersion, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMediaPathEntry=prtMediaPathEntry, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtOutputSecurity=prtOutputSecurity, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtChannelState=prtChannelState, CodedCharSet=CodedCharSet, prtChannelGroup=prtChannelGroup, prtGeneralPrinterName=prtGeneralPrinterName, prtConsoleOnTime=prtConsoleOnTime, printerV2Alert=printerV2Alert, prtOutput=prtOutput, prtOutputDescription=prtOutputDescription, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtGeneralConfigChanges=prtGeneralConfigChanges, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInputModel=prtInputModel, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtConsoleGroup=prtConsoleGroup, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputNextIndex=prtInputNextIndex, prtMarkerMarkTech=prtMarkerMarkTech, prtOutputTable=prtOutputTable, prtAlert=prtAlert, prtOutputOffsetStacking=prtOutputOffsetStacking, printmib=printmib, prtAlertTime=prtAlertTime, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerSupplies=prtMarkerSupplies, prtInputDescription=prtInputDescription, prtInterpreterLangVersion=prtInterpreterLangVersion, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtLocalizationEntry=prtLocalizationEntry, prtOutputEntry=prtOutputEntry, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerStatus=prtMarkerStatus, prtOutputVersion=prtOutputVersion, prtMarkerIndex=prtMarkerIndex, prtChannel=prtChannel, prtInputMediaName=prtInputMediaName, prtGeneralServicePerson=prtGeneralServicePerson, prtOutputVendorName=prtOutputVendorName, prtInputCurrentLevel=prtInputCurrentLevel, prtInterpreterIndex=prtInterpreterIndex, prtExtendedOutputGroup=prtExtendedOutputGroup, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerColorantValue=prtMarkerColorantValue, prtChannelTable=prtChannelTable, prtLocalizationIndex=prtLocalizationIndex, prtOutputIndex=prtOutputIndex, prtMarker=prtMarker, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtOutputDecollating=prtOutputDecollating, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInterpreterGroup=prtInterpreterGroup, prtMIB2Groups=prtMIB2Groups, SubUnitStatus=SubUnitStatus, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtLocalization=prtLocalization, prtOutputType=prtOutputType, prtOutputModel=prtOutputModel, prtChannelIfIndex=prtChannelIfIndex, prtChannelV2Group=prtChannelV2Group, prtInputName=prtInputName, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerCounterUnit=prtMarkerCounterUnit, PrtMediaUnitTC=PrtMediaUnitTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtAlertIndex=prtAlertIndex, prtGeneralV2Group=prtGeneralV2Group, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtChannelEntry=prtChannelEntry, prtInterpreterTable=prtInterpreterTable, prtAlertEntry=prtAlertEntry, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, MediaUnit=MediaUnit, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMarkerEntry=prtMarkerEntry, prtGeneralGroup=prtGeneralGroup, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerColorantRole=prtMarkerColorantRole, prtInputMediaColor=prtInputMediaColor, prtMarkerNorthMargin=prtMarkerNorthMargin, prtAlertDescription=prtAlertDescription, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputMediaGroup=prtInputMediaGroup, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInputGroup=prtInputGroup, prtAlertTrapGroup=prtAlertTrapGroup, prtInputSerialNumber=prtInputSerialNumber, prtMarkerColorantIndex=prtMarkerColorantIndex, prtAlertTimeGroup=prtAlertTimeGroup, prtOutputDefaultIndex=prtOutputDefaultIndex, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInputCapacityUnit=prtInputCapacityUnit, prtInputIndex=prtInputIndex, prtStorageRefTable=prtStorageRefTable, prtConsoleLocalization=prtConsoleLocalization, prtCoverIndex=prtCoverIndex, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMediaPathTable=prtMediaPathTable, PrtChannelStateTC=PrtChannelStateTC, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInterpreterLangFamily=prtInterpreterLangFamily, prtCoverTable=prtCoverTable, prtInputDefaultIndex=prtInputDefaultIndex, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputDimUnit=prtInputDimUnit, prtOutputDimUnit=prtOutputDimUnit, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInterpreterTwoWay=prtInterpreterTwoWay, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtChannelType=prtChannelType, PYSNMP_MODULE_ID=printmib, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtGeneral=prtGeneral, prtAlertGroup=prtAlertGroup, prtGeneralTable=prtGeneralTable, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputMediaWeight=prtInputMediaWeight, prtOutputBursting=prtOutputBursting, prtAlertAllEvents=prtAlertAllEvents, prtCoverDescription=prtCoverDescription, prtAlertTrainingLevel=prtAlertTrainingLevel, prtAlertGroupIndex=prtAlertGroupIndex, prtAlertTableGroup=prtAlertTableGroup, prtLocalizationCountry=prtLocalizationCountry, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInputTable=prtInputTable, printerV2AlertPrefix=printerV2AlertPrefix, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMediaPathGroup=prtMediaPathGroup, prtConsoleLightIndex=prtConsoleLightIndex, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtConsoleOffTime=prtConsoleOffTime, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMediaPathDescription=prtMediaPathDescription)
mibBuilder.exportSymbols("Printer-MIB", prtMediaPathStatus=prtMediaPathStatus, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, CapacityUnit=CapacityUnit, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC)
