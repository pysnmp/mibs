...
PrtAlertTrainingLevelTC, PrtChannelTypeTC, PrtConsoleColorTC, PrtCoverStatusTC, PrtAlertGroupTC, PrtInputTypeTC, PrtMarkerSuppliesTypeTC, PrtConsoleDisableTC, PrtGeneralResetTC, PrtOutputTypeTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertTrainingLevelTC", "PrtChannelTypeTC", "PrtConsoleColorTC", "PrtCoverStatusTC", "PrtAlertGroupTC", "PrtInputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleDisableTC", "PrtGeneralResetTC", "PrtOutputTypeTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtCover=prtCover, prtChannelProtocolVersion=prtChannelProtocolVersion, prtStorageRefTable=prtStorageRefTable, prtConsoleDescription=prtConsoleDescription, prtInputEntry=prtInputEntry, prtInputVersion=prtInputVersion, CapacityUnit=CapacityUnit, prtMediaPathStatus=prtMediaPathStatus, prtInputTable=prtInputTable, prtChannelTable=prtChannelTable, prtMarkerSouthMargin=prtMarkerSouthMargin, prtChannel=prtChannel, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInputMediaColor=prtInputMediaColor, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInputStatus=prtInputStatus, prtGeneralV2Group=prtGeneralV2Group, prtMarkerGroup=prtMarkerGroup, prtInputName=prtInputName, prtInputNextIndex=prtInputNextIndex, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtChannelType=prtChannelType, prtGeneralConfigChanges=prtGeneralConfigChanges, prtChannelEntry=prtChannelEntry, prtMarkerColorant=prtMarkerColorant, prtAlertIndex=prtAlertIndex, prtChannelGroup=prtChannelGroup, prtChannelV2Group=prtChannelV2Group, prtInputMediaName=prtInputMediaName, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtConsoleLightIndex=prtConsoleLightIndex, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, PrtCapacityUnitTC=PrtCapacityUnitTC, prtAlertTimeGroup=prtAlertTimeGroup, prtConsoleGroup=prtConsoleGroup, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMIBGroups=prtMIBGroups, prtLocalizationEntry=prtLocalizationEntry, prtLocalizationIndex=prtLocalizationIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtInputSwitchingGroup=prtInputSwitchingGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtOutputIndex=prtOutputIndex, prtMIB2Groups=prtMIB2Groups, prtMediaPathGroup=prtMediaPathGroup, prtAlert=prtAlert, prtMIB2Compliance=prtMIB2Compliance, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMediaPathTable=prtMediaPathTable, prtMediaPathIndex=prtMediaPathIndex, prtConsoleLights=prtConsoleLights, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtOutput=prtOutput, prtMarkerSuppliesType=prtMarkerSuppliesType, prtConsoleDisable=prtConsoleDisable, prtChannelStatus=prtChannelStatus, prtOutputTable=prtOutputTable, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMediaPathDescription=prtMediaPathDescription, prtMediaPathEntry=prtMediaPathEntry, prtConsoleLocalization=prtConsoleLocalization, prtOutputCapacityUnit=prtOutputCapacityUnit, PYSNMP_MODULE_ID=printmib, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerColorantTonality=prtMarkerColorantTonality, prtConsoleOnTime=prtConsoleOnTime, prtInputMediaGroup=prtInputMediaGroup, prtConsoleLightEntry=prtConsoleLightEntry, prtDeviceRefTable=prtDeviceRefTable, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputMediaType=prtInputMediaType, prtMediaPath=prtMediaPath, prtExtendedOutputGroup=prtExtendedOutputGroup, prtGeneralReset=prtGeneralReset, PrtChannelStateTC=PrtChannelStateTC, prtAlertAllEvents=prtAlertAllEvents, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerColorantValue=prtMarkerColorantValue, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputMediaWeight=prtInputMediaWeight, prtOutputStackingOrder=prtOutputStackingOrder, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtGeneralServicePerson=prtGeneralServicePerson, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtStorageRefEntry=prtStorageRefEntry, prtAlertGroupIndex=prtAlertGroupIndex, prtInputGroup=prtInputGroup, prtInputCapacityUnit=prtInputCapacityUnit, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMarker=prtMarker, prtOutputVersion=prtOutputVersion, prtGeneral=prtGeneral, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, printerV2AlertPrefix=printerV2AlertPrefix, prtAlertTrapGroup=prtAlertTrapGroup, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtConsoleColor=prtConsoleColor, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMarkerSuppliesTable=prtMarkerSuppliesTable, printerV2Alert=printerV2Alert, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerMarkTech=prtMarkerMarkTech, prtAlertEntry=prtAlertEntry, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputMaxCapacity=prtInputMaxCapacity, prtLocalizationCountry=prtLocalizationCountry, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtChannelIndex=prtChannelIndex, prtInterpreterDescription=prtInterpreterDescription, prtLocalizationTable=prtLocalizationTable, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputBursting=prtOutputBursting, prtInterpreterLangVersion=prtInterpreterLangVersion, prtAlertDescription=prtAlertDescription, prtOutputPageCollated=prtOutputPageCollated, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtChannelInformation=prtChannelInformation, prtMIBConformance=prtMIBConformance, prtOutputSerialNumber=prtOutputSerialNumber, prtConsoleLightTable=prtConsoleLightTable, prtMarkerWestMargin=prtMarkerWestMargin, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMarkerSpotColorants=prtMarkerSpotColorants, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtCoverEntry=prtCoverEntry, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputDecollating=prtOutputDecollating, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtStorageRefIndex=prtStorageRefIndex, prtOutputDescription=prtOutputDescription, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtOutputModel=prtOutputModel, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, PrtMediaUnitTC=PrtMediaUnitTC, printmib=printmib, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInterpreter=prtInterpreter, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerProcessColorants=prtMarkerProcessColorants, prtAlertTrainingLevel=prtAlertTrainingLevel, prtInputModel=prtInputModel, prtInputSecurity=prtInputSecurity, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMediaPathType=prtMediaPathType, prtChannelState=prtChannelState, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputVendorName=prtInputVendorName, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtDeviceRefEntry=prtDeviceRefEntry, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtGeneralPrinterName=prtGeneralPrinterName, prtInputType=prtInputType, prtLocalization=prtLocalization, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, SubUnitStatus=SubUnitStatus, PresentOnOff=PresentOnOff, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputName=prtOutputName, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerSupplies=prtMarkerSupplies, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerColorantEntry=prtMarkerColorantEntry, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, CodedCharSet=CodedCharSet, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtAlertTableGroup=prtAlertTableGroup, prtOutputStatus=prtOutputStatus, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMarkerTable=prtMarkerTable, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMarkerLifeCount=prtMarkerLifeCount, prtInputDimUnit=prtInputDimUnit, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerStatus=prtMarkerStatus, prtOutputEntry=prtOutputEntry, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtOutputVendorName=prtOutputVendorName, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtGeneralEntry=prtGeneralEntry, prtLocalizationLanguage=prtLocalizationLanguage, prtInput=prtInput, prtAlertGroup=prtAlertGroup, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtExtendedInputGroup=prtExtendedInputGroup, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtAlertCriticalEvents=prtAlertCriticalEvents, prtOutputType=prtOutputType, prtAlertCode=prtAlertCode, prtInterpreterGroup=prtInterpreterGroup, prtMarkerEntry=prtMarkerEntry, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInterpreterIndex=prtInterpreterIndex, prtCoverDescription=prtCoverDescription, prtCoverStatus=prtCoverStatus, prtDeviceRefIndex=prtDeviceRefIndex, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputSecurity=prtOutputSecurity, printerV1Alert=printerV1Alert, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtOutputGroup=prtOutputGroup, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInterpreterTable=prtInterpreterTable, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtAlertTable=prtAlertTable, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtGeneralGroup=prtGeneralGroup, prtInputDescription=prtInputDescription, prtConsoleOffTime=prtConsoleOffTime, prtMIBCompliance=prtMIBCompliance, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtAlertLocation=prtAlertLocation, prtInterpreterLangLevel=prtInterpreterLangLevel, prtGeneralTable=prtGeneralTable, prtCoverTable=prtCoverTable, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerEastMargin=prtMarkerEastMargin, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMarkerIndex=prtMarkerIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtChannelIfIndex=prtChannelIfIndex, prtInputSerialNumber=prtInputSerialNumber, prtOutputDimUnit=prtOutputDimUnit, prtAlertTime=prtAlertTime, prtCoverIndex=prtCoverIndex, prtInterpreterVersion=prtInterpreterVersion, prtInterpreterEntry=prtInterpreterEntry)
mibBuilder.exportSymbols("Printer-MIB", prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, MediaUnit=MediaUnit, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputIndex=prtInputIndex)
