...
PrtInputTypeTC, PrtAlertGroupTC, PrtMediaPathTypeTC, PrtAlertCodeTC, PrtConsoleColorTC, PrtAlertTrainingLevelTC, PrtCoverStatusTC, PrtChannelTypeTC, PrtMarkerSuppliesTypeTC, PrtOutputTypeTC, PrtInterpreterLangFamilyTC, PrtMarkerMarkTechTC, PrtGeneralResetTC, PrtConsoleDisableTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInputTypeTC", "PrtAlertGroupTC", "PrtMediaPathTypeTC", "PrtAlertCodeTC", "PrtConsoleColorTC", "PrtAlertTrainingLevelTC", "PrtCoverStatusTC", "PrtChannelTypeTC", "PrtMarkerSuppliesTypeTC", "PrtOutputTypeTC", "PrtInterpreterLangFamilyTC", "PrtMarkerMarkTechTC", "PrtGeneralResetTC", "PrtConsoleDisableTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInputVersion=prtInputVersion, prtStorageRefTable=prtStorageRefTable, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMediaPathIndex=prtMediaPathIndex, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInputStatus=prtInputStatus, prtChannelV2Group=prtChannelV2Group, prtOutput=prtOutput, prtMarkerMarkTech=prtMarkerMarkTech, prtOutputSerialNumber=prtOutputSerialNumber, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputModel=prtInputModel, CapacityUnit=CapacityUnit, prtInterpreterVersion=prtInterpreterVersion, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtLocalizationCountry=prtLocalizationCountry, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, MediaUnit=MediaUnit, prtMarkerColorantEntry=prtMarkerColorantEntry, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtStorageRefEntry=prtStorageRefEntry, prtAlertIndex=prtAlertIndex, prtInterpreterGroup=prtInterpreterGroup, printerV2Alert=printerV2Alert, prtDeviceRefIndex=prtDeviceRefIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtAlertCriticalEvents=prtAlertCriticalEvents, prtOutputStackingOrder=prtOutputStackingOrder, prtConsoleOnTime=prtConsoleOnTime, prtAlertTableV2Group=prtAlertTableV2Group, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtChannelInformation=prtChannelInformation, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtCover=prtCover, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMarkerColorant=prtMarkerColorant, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtConsoleLightIndex=prtConsoleLightIndex, prtAlertTableGroup=prtAlertTableGroup, prtOutputEntry=prtOutputEntry, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerWestMargin=prtMarkerWestMargin, prtExtendedInputGroup=prtExtendedInputGroup, prtChannelIndex=prtChannelIndex, prtGeneralGroup=prtGeneralGroup, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInput=prtInput, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtAlertLocation=prtAlertLocation, prtStorageRefIndex=prtStorageRefIndex, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputCurrentLevel=prtInputCurrentLevel, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputDimUnit=prtOutputDimUnit, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInputIndex=prtInputIndex, prtOutputName=prtOutputName, prtOutputPageCollated=prtOutputPageCollated, prtMarkerIndex=prtMarkerIndex, prtChannelStatus=prtChannelStatus, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputEntry=prtInputEntry, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarker=prtMarker, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtConsoleDescription=prtConsoleDescription, prtConsoleLightTable=prtConsoleLightTable, prtMIBGroups=prtMIBGroups, prtOutputIndex=prtOutputIndex, prtOutputTable=prtOutputTable, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelTable=prtChannelTable, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerGroup=prtMarkerGroup, prtAlertTable=prtAlertTable, prtInputVendorName=prtInputVendorName, prtChannelGroup=prtChannelGroup, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtOutputStatus=prtOutputStatus, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtChannelType=prtChannelType, prtDeviceRefTable=prtDeviceRefTable, prtAlertGroupIndex=prtAlertGroupIndex, prtMarkerSouthMargin=prtMarkerSouthMargin, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputMaxCapacity=prtOutputMaxCapacity, prtGeneralReset=prtGeneralReset, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputDescription=prtInputDescription, prtAlertSeverityLevel=prtAlertSeverityLevel, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtChannel=prtChannel, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputSerialNumber=prtInputSerialNumber, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInputMediaWeight=prtInputMediaWeight, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtAlertGroup=prtAlertGroup, prtInputCapacityUnit=prtInputCapacityUnit, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtChannelIfIndex=prtChannelIfIndex, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputVendorName=prtOutputVendorName, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerStatus=prtMarkerStatus, prtInputNextIndex=prtInputNextIndex, prtOutputType=prtOutputType, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, printerV1Alert=printerV1Alert, prtMediaPathStatus=prtMediaPathStatus, printerV2AlertPrefix=printerV2AlertPrefix, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMediaPathEntry=prtMediaPathEntry, prtInterpreter=prtInterpreter, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMarkerColorantValue=prtMarkerColorantValue, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, SubUnitStatus=SubUnitStatus, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInterpreterIndex=prtInterpreterIndex, prtInputSecurity=prtInputSecurity, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMarkerEntry=prtMarkerEntry, prtGeneral=prtGeneral, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerSuppliesType=prtMarkerSuppliesType, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtAlertTimeGroup=prtAlertTimeGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerColorantGroup=prtMarkerColorantGroup, prtAlertTime=prtAlertTime, prtOutputModel=prtOutputModel, prtGeneralV2Group=prtGeneralV2Group, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerLifeCount=prtMarkerLifeCount, PYSNMP_MODULE_ID=printmib, printmib=printmib, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtOutputSecurity=prtOutputSecurity, prtConsoleDisable=prtConsoleDisable, prtLocalizationEntry=prtLocalizationEntry, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputType=prtInputType, prtChannelState=prtChannelState, prtMarkerSupplies=prtMarkerSupplies, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMIB2Compliance=prtMIB2Compliance, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMIB2Groups=prtMIB2Groups, prtMediaPathDescription=prtMediaPathDescription, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleColor=prtConsoleColor, prtInputMediaType=prtInputMediaType, prtCoverIndex=prtCoverIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtOutputBursting=prtOutputBursting, prtInterpreterEntry=prtInterpreterEntry, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputDimUnit=prtInputDimUnit, prtInterpreterDescription=prtInterpreterDescription, prtLocalizationTable=prtLocalizationTable, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtGeneralTable=prtGeneralTable, prtMediaPathTable=prtMediaPathTable, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathType=prtMediaPathType, prtChannelEntry=prtChannelEntry, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtConsoleLights=prtConsoleLights, prtInputMediaGroup=prtInputMediaGroup, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtConsoleGroup=prtConsoleGroup, prtInputMediaName=prtInputMediaName, prtMarkerTable=prtMarkerTable, prtCoverTable=prtCoverTable, prtInputMediaColor=prtInputMediaColor, prtConsoleOffTime=prtConsoleOffTime, prtInputGroup=prtInputGroup, prtLocalizationIndex=prtLocalizationIndex, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtOutputCapacityUnit=prtOutputCapacityUnit, prtCoverDescription=prtCoverDescription, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtOutputOffsetStacking=prtOutputOffsetStacking, prtConsoleLightEntry=prtConsoleLightEntry, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtGeneralEntry=prtGeneralEntry, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInterpreterTable=prtInterpreterTable, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtCoverEntry=prtCoverEntry, prtMediaPathGroup=prtMediaPathGroup, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputVersion=prtOutputVersion, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtAlertAllEvents=prtAlertAllEvents, prtConsoleLocalization=prtConsoleLocalization, PrtChannelStateTC=PrtChannelStateTC, prtAlert=prtAlert, prtOutputDescription=prtOutputDescription, prtMediaPath=prtMediaPath, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInputMaxCapacity=prtInputMaxCapacity, prtMIBCompliance=prtMIBCompliance, prtInterpreterTwoWay=prtInterpreterTwoWay, prtOutputGroup=prtOutputGroup, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerColorantTable=prtMarkerColorantTable, prtGeneralPrinterName=prtGeneralPrinterName, prtInputTable=prtInputTable, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerColorantIndex=prtMarkerColorantIndex, prtAlertDescription=prtAlertDescription, prtAlertEntry=prtAlertEntry, prtAlertCode=prtAlertCode, PresentOnOff=PresentOnOff, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInputName=prtInputName, CodedCharSet=CodedCharSet, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerColorantRole=prtMarkerColorantRole, prtOutputDecollating=prtOutputDecollating, prtChannelProtocolVersion=prtChannelProtocolVersion, prtAlertTrainingLevel=prtAlertTrainingLevel)
mibBuilder.exportSymbols("Printer-MIB", prtMIBConformance=prtMIBConformance, prtInputMediaFormParts=prtInputMediaFormParts, prtLocalization=prtLocalization, prtCoverStatus=prtCoverStatus)
