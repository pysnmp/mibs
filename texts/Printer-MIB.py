...
PrtAlertGroupTC, PrtOutputTypeTC, PrtInputTypeTC, PrtConsoleDisableTC, PrtGeneralResetTC, PrtCoverStatusTC, PrtMediaPathTypeTC, PrtChannelTypeTC, PrtAlertCodeTC, PrtConsoleColorTC, PrtInterpreterLangFamilyTC, PrtMarkerSuppliesTypeTC, PrtAlertTrainingLevelTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertGroupTC", "PrtOutputTypeTC", "PrtInputTypeTC", "PrtConsoleDisableTC", "PrtGeneralResetTC", "PrtCoverStatusTC", "PrtMediaPathTypeTC", "PrtChannelTypeTC", "PrtAlertCodeTC", "PrtConsoleColorTC", "PrtInterpreterLangFamilyTC", "PrtMarkerSuppliesTypeTC", "PrtAlertTrainingLevelTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputModel=prtOutputModel, prtMarkerEntry=prtMarkerEntry, prtInterpreterEntry=prtInterpreterEntry, prtOutputVendorName=prtOutputVendorName, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputIndex=prtInputIndex, prtGeneralReset=prtGeneralReset, prtInputNextIndex=prtInputNextIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInputMediaColor=prtInputMediaColor, prtMediaPath=prtMediaPath, prtOutputIndex=prtOutputIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInputStatus=prtInputStatus, prtInterpreterVersion=prtInterpreterVersion, prtInputEntry=prtInputEntry, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMIBCompliance=prtMIBCompliance, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtCoverEntry=prtCoverEntry, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMIB2Groups=prtMIB2Groups, PresentOnOff=PresentOnOff, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputGroup=prtOutputGroup, prtMarkerColorantTable=prtMarkerColorantTable, prtOutputDimUnit=prtOutputDimUnit, prtMarkerColorantRole=prtMarkerColorantRole, prtLocalizationCharacterSet=prtLocalizationCharacterSet, PrtChannelStateTC=PrtChannelStateTC, prtMarkerSupplies=prtMarkerSupplies, prtAlertTable=prtAlertTable, prtAlertIndex=prtAlertIndex, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtChannelGroup=prtChannelGroup, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMediaPathGroup=prtMediaPathGroup, prtInterpreterGroup=prtInterpreterGroup, printerV1Alert=printerV1Alert, prtLocalization=prtLocalization, prtAlertAllEvents=prtAlertAllEvents, prtDeviceRefEntry=prtDeviceRefEntry, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtConsoleGroup=prtConsoleGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerWestMargin=prtMarkerWestMargin, prtOutputOffsetStacking=prtOutputOffsetStacking, CodedCharSet=CodedCharSet, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtStorageRefIndex=prtStorageRefIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInputCapacityUnit=prtInputCapacityUnit, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarker=prtMarker, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtAlertTimeGroup=prtAlertTimeGroup, prtMediaPathTable=prtMediaPathTable, prtMediaPathType=prtMediaPathType, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInput=prtInput, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInputMaxCapacity=prtInputMaxCapacity, prtConsoleLocalization=prtConsoleLocalization, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputMediaType=prtInputMediaType, prtAlertTime=prtAlertTime, prtGeneral=prtGeneral, prtOutput=prtOutput, prtInputTable=prtInputTable, prtMarkerLifeCount=prtMarkerLifeCount, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtChannel=prtChannel, prtConsoleLightTable=prtConsoleLightTable, printerV2Alert=printerV2Alert, prtAlertTableV2Group=prtAlertTableV2Group, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInputDescription=prtInputDescription, prtOutputDecollating=prtOutputDecollating, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, PrtPrintOrientationTC=PrtPrintOrientationTC, prtGeneralServicePerson=prtGeneralServicePerson, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtChannelEntry=prtChannelEntry, prtInputName=prtInputName, prtChannelTable=prtChannelTable, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtChannelType=prtChannelType, prtExtendedInputGroup=prtExtendedInputGroup, prtAlertGroupIndex=prtAlertGroupIndex, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtCoverStatus=prtCoverStatus, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtConsoleOnTime=prtConsoleOnTime, prtInputGroup=prtInputGroup, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtCover=prtCover, prtOutputPageCollated=prtOutputPageCollated, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtAlertGroup=prtAlertGroup, prtOutputStackingOrder=prtOutputStackingOrder, prtOutputStatus=prtOutputStatus, prtLocalizationEntry=prtLocalizationEntry, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtStorageRefEntry=prtStorageRefEntry, prtOutputEntry=prtOutputEntry, prtInputMediaWeight=prtInputMediaWeight, prtDeviceRefIndex=prtDeviceRefIndex, prtGeneralTable=prtGeneralTable, prtMIB2Compliance=prtMIB2Compliance, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMediaPathIndex=prtMediaPathIndex, prtAlertLocation=prtAlertLocation, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerColorant=prtMarkerColorant, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, PrtCapacityUnitTC=PrtCapacityUnitTC, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtOutputType=prtOutputType, prtMarkerStatus=prtMarkerStatus, prtAlertTableGroup=prtAlertTableGroup, prtOutputName=prtOutputName, prtMarkerProcessColorants=prtMarkerProcessColorants, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtChannelInformation=prtChannelInformation, prtOutputCapacityUnit=prtOutputCapacityUnit, prtLocalizationCountry=prtLocalizationCountry, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMarkerGroup=prtMarkerGroup, prtInterpreterDescription=prtInterpreterDescription, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputVersion=prtInputVersion, prtInputMediaName=prtInputMediaName, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerColorantValue=prtMarkerColorantValue, prtConsoleColor=prtConsoleColor, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtChannelProtocolVersion=prtChannelProtocolVersion, prtOutputDefaultIndex=prtOutputDefaultIndex, prtAlertCode=prtAlertCode, prtStorageRefTable=prtStorageRefTable, prtOutputBursting=prtOutputBursting, prtConsoleDescription=prtConsoleDescription, prtInputSerialNumber=prtInputSerialNumber, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerColorantIndex=prtMarkerColorantIndex, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputTable=prtOutputTable, prtAlertEntry=prtAlertEntry, prtConsoleDisable=prtConsoleDisable, prtAlertDescription=prtAlertDescription, prtOutputSecurity=prtOutputSecurity, MediaUnit=MediaUnit, prtAlert=prtAlert, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, SubUnitStatus=SubUnitStatus, prtMIBConformance=prtMIBConformance, prtInterpreterTable=prtInterpreterTable, PYSNMP_MODULE_ID=printmib, prtMediaPathEntry=prtMediaPathEntry, prtChannelStatus=prtChannelStatus, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtConsoleLightEntry=prtConsoleLightEntry, prtMIBGroups=prtMIBGroups, prtInputCurrentLevel=prtInputCurrentLevel, prtChannelV2Group=prtChannelV2Group, prtOutputMaxCapacity=prtOutputMaxCapacity, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtConsoleOffTime=prtConsoleOffTime, prtLocalizationLanguage=prtLocalizationLanguage, printmib=printmib, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMediaPathStatus=prtMediaPathStatus, prtOutputDescription=prtOutputDescription, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInputType=prtInputType, prtCoverDescription=prtCoverDescription, prtLocalizationIndex=prtLocalizationIndex, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtLocalizationTable=prtLocalizationTable, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInterpreterTwoWay=prtInterpreterTwoWay, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInterpreterIndex=prtInterpreterIndex, prtGeneralEntry=prtGeneralEntry, prtMarkerMarkTech=prtMarkerMarkTech, prtInputSecurity=prtInputSecurity, prtMarkerCounterUnit=prtMarkerCounterUnit, prtChannelState=prtChannelState, prtChannelIfIndex=prtChannelIfIndex, prtChannelIndex=prtChannelIndex, prtConsoleLightIndex=prtConsoleLightIndex, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtDeviceRefTable=prtDeviceRefTable, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerTable=prtMarkerTable, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInterpreter=prtInterpreter, prtAlertTrapGroup=prtAlertTrapGroup, prtOutputSerialNumber=prtOutputSerialNumber, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, CapacityUnit=CapacityUnit, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputVendorName=prtInputVendorName, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInterpreterLangFamily=prtInterpreterLangFamily, prtCoverTable=prtCoverTable, prtOutputVersion=prtOutputVersion, prtInputSwitchingGroup=prtInputSwitchingGroup, prtGeneralV2Group=prtGeneralV2Group, prtMediaPathDescription=prtMediaPathDescription, prtMarkerIndex=prtMarkerIndex, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, printerV2AlertPrefix=printerV2AlertPrefix, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtGeneralGroup=prtGeneralGroup, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerEastMargin=prtMarkerEastMargin, prtCoverIndex=prtCoverIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInputDimUnit=prtInputDimUnit, prtMarkerColorantEntry=prtMarkerColorantEntry)
mibBuilder.exportSymbols("Printer-MIB", prtInputModel=prtInputModel, prtInputMediaGroup=prtInputMediaGroup, prtGeneralPrinterName=prtGeneralPrinterName, prtConsoleLights=prtConsoleLights)
