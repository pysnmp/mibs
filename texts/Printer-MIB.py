...
PrtCoverStatusTC, PrtAlertTrainingLevelTC, PrtConsoleColorTC, PrtConsoleDisableTC, PrtGeneralResetTC, PrtMediaPathTypeTC, PrtMarkerMarkTechTC, PrtInterpreterLangFamilyTC, PrtAlertGroupTC, PrtMarkerSuppliesTypeTC, PrtChannelTypeTC, PrtInputTypeTC, PrtAlertCodeTC, PrtOutputTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtCoverStatusTC", "PrtAlertTrainingLevelTC", "PrtConsoleColorTC", "PrtConsoleDisableTC", "PrtGeneralResetTC", "PrtMediaPathTypeTC", "PrtMarkerMarkTechTC", "PrtInterpreterLangFamilyTC", "PrtAlertGroupTC", "PrtMarkerSuppliesTypeTC", "PrtChannelTypeTC", "PrtInputTypeTC", "PrtAlertCodeTC", "PrtOutputTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputOffsetStacking=prtOutputOffsetStacking, prtChannelInformation=prtChannelInformation, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtGeneralConfigChanges=prtGeneralConfigChanges, prtDeviceRefIndex=prtDeviceRefIndex, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputSerialNumber=prtOutputSerialNumber, prtOutputBursting=prtOutputBursting, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtCoverStatus=prtCoverStatus, PYSNMP_MODULE_ID=printmib, prtConsoleLightTable=prtConsoleLightTable, prtInterpreterLangFamily=prtInterpreterLangFamily, prtOutputSecurity=prtOutputSecurity, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtCover=prtCover, prtCoverEntry=prtCoverEntry, prtOutputStackingOrder=prtOutputStackingOrder, prtConsoleOnTime=prtConsoleOnTime, prtStorageRefEntry=prtStorageRefEntry, prtMIB2Compliance=prtMIB2Compliance, prtMediaPathTable=prtMediaPathTable, prtChannelEntry=prtChannelEntry, prtInputDescription=prtInputDescription, prtInputName=prtInputName, prtAlertTrapGroup=prtAlertTrapGroup, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputStatus=prtOutputStatus, prtCoverIndex=prtCoverIndex, prtInputModel=prtInputModel, prtAlertLocation=prtAlertLocation, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtAlert=prtAlert, prtStorageRefTable=prtStorageRefTable, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerCounterUnit=prtMarkerCounterUnit, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputMaxCapacity=prtInputMaxCapacity, prtInputSerialNumber=prtInputSerialNumber, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtConsoleLights=prtConsoleLights, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtChannelType=prtChannelType, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInterpreterIndex=prtInterpreterIndex, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, printerV2Alert=printerV2Alert, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInterpreterTwoWay=prtInterpreterTwoWay, prtOutputName=prtOutputName, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, SubUnitStatus=SubUnitStatus, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtGeneralV2Group=prtGeneralV2Group, prtMIB2Groups=prtMIB2Groups, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInputVersion=prtInputVersion, prtOutputDimUnit=prtOutputDimUnit, prtChannelIfIndex=prtChannelIfIndex, prtMediaPathEntry=prtMediaPathEntry, prtGeneralSerialNumber=prtGeneralSerialNumber, prtChannelTable=prtChannelTable, prtOutputGroup=prtOutputGroup, prtMarkerSupplies=prtMarkerSupplies, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtAlertAllEvents=prtAlertAllEvents, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInterpreterGroup=prtInterpreterGroup, PrtCapacityUnitTC=PrtCapacityUnitTC, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtLocalizationLanguage=prtLocalizationLanguage, prtAlertGroup=prtAlertGroup, prtMediaPath=prtMediaPath, prtMediaPathDescription=prtMediaPathDescription, prtMediaPathGroup=prtMediaPathGroup, CapacityUnit=CapacityUnit, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInputCapacityUnit=prtInputCapacityUnit, prtGeneral=prtGeneral, prtMarkerEastMargin=prtMarkerEastMargin, prtInputSecurity=prtInputSecurity, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtConsoleOffTime=prtConsoleOffTime, prtInput=prtInput, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerWestMargin=prtMarkerWestMargin, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlertTableGroup=prtAlertTableGroup, printerV1Alert=printerV1Alert, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtOutput=prtOutput, prtGeneralTable=prtGeneralTable, prtInputStatus=prtInputStatus, prtConsoleColor=prtConsoleColor, prtAlertGroupIndex=prtAlertGroupIndex, MediaUnit=MediaUnit, prtMarkerColorantValue=prtMarkerColorantValue, prtConsoleDisable=prtConsoleDisable, prtLocalizationTable=prtLocalizationTable, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtCoverTable=prtCoverTable, prtOutputDescription=prtOutputDescription, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarkerTable=prtMarkerTable, prtLocalization=prtLocalization, prtMarkerColorantTable=prtMarkerColorantTable, printerV2AlertPrefix=printerV2AlertPrefix, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputMediaColor=prtInputMediaColor, prtInputDimUnit=prtInputDimUnit, prtOutputEntry=prtOutputEntry, prtMarker=prtMarker, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMarkerMarkTech=prtMarkerMarkTech, prtStorageRefSeqNumber=prtStorageRefSeqNumber, CodedCharSet=CodedCharSet, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtGeneralEntry=prtGeneralEntry, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtAlertTimeGroup=prtAlertTimeGroup, prtInterpreterEntry=prtInterpreterEntry, prtMIBConformance=prtMIBConformance, prtMarkerGroup=prtMarkerGroup, prtOutputDecollating=prtOutputDecollating, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtChannelStatus=prtChannelStatus, prtExtendedInputGroup=prtExtendedInputGroup, prtConsoleGroup=prtConsoleGroup, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInputVendorName=prtInputVendorName, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMediaPathStatus=prtMediaPathStatus, PresentOnOff=PresentOnOff, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputVersion=prtOutputVersion, prtAlertTrainingLevel=prtAlertTrainingLevel, prtInputTable=prtInputTable, prtMarkerColorant=prtMarkerColorant, prtLocalizationCountry=prtLocalizationCountry, prtMediaPathType=prtMediaPathType, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMarkerEntry=prtMarkerEntry, prtAlertEntry=prtAlertEntry, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, PrtChannelStateTC=PrtChannelStateTC, prtStorageRefIndex=prtStorageRefIndex, prtMarkerProcessColorants=prtMarkerProcessColorants, prtCoverDescription=prtCoverDescription, prtMarkerColorantEntry=prtMarkerColorantEntry, prtAlertDescription=prtAlertDescription, prtAlertTable=prtAlertTable, prtChannelV2Group=prtChannelV2Group, prtConsoleDescription=prtConsoleDescription, prtOutputMaxCapacity=prtOutputMaxCapacity, prtChannelIndex=prtChannelIndex, prtConsoleLocalization=prtConsoleLocalization, prtInputMediaWeight=prtInputMediaWeight, prtMediaPathIndex=prtMediaPathIndex, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMarkerLifeCount=prtMarkerLifeCount, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtLocalizationIndex=prtLocalizationIndex, prtOutputPageCollated=prtOutputPageCollated, prtOutputModel=prtOutputModel, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInterpreterTable=prtInterpreterTable, prtMIBGroups=prtMIBGroups, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInterpreterDescription=prtInterpreterDescription, prtInputNextIndex=prtInputNextIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtInputEntry=prtInputEntry, prtDeviceRefTable=prtDeviceRefTable, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtInputMediaName=prtInputMediaName, prtGeneralGroup=prtGeneralGroup, prtMIBCompliance=prtMIBCompliance, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMarkerColorantIndex=prtMarkerColorantIndex, prtAlertTime=prtAlertTime, prtInputIndex=prtInputIndex, prtConsoleLightEntry=prtConsoleLightEntry, prtAlertCriticalEvents=prtAlertCriticalEvents, prtLocalizationEntry=prtLocalizationEntry, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtConsoleLightIndex=prtConsoleLightIndex, prtAlertIndex=prtAlertIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, printmib=printmib, prtMarkerColorantTonality=prtMarkerColorantTonality, prtOutputCapacityUnit=prtOutputCapacityUnit, prtChannelState=prtChannelState, prtInputGroup=prtInputGroup, prtInputType=prtInputType, prtMarkerIndex=prtMarkerIndex, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInterpreter=prtInterpreter, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputVendorName=prtOutputVendorName, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtChannel=prtChannel, prtOutputTable=prtOutputTable, prtInputMediaGroup=prtInputMediaGroup, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerColorantRole=prtMarkerColorantRole, prtGeneralReset=prtGeneralReset, prtChannelGroup=prtChannelGroup, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInputSwitchingGroup=prtInputSwitchingGroup, prtOutputType=prtOutputType, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerStatus=prtMarkerStatus, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputIndex=prtOutputIndex, prtInterpreterVersion=prtInterpreterVersion)
mibBuilder.exportSymbols("Printer-MIB", prtAlertCode=prtAlertCode, prtGeneralServicePerson=prtGeneralServicePerson, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInputMediaType=prtInputMediaType)
