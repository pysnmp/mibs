...
PrtConsoleDisableTC, PrtCoverStatusTC, PrtInterpreterLangFamilyTC, PrtInputTypeTC, PrtConsoleColorTC, PrtOutputTypeTC, PrtChannelTypeTC, PrtAlertCodeTC, PrtMarkerSuppliesTypeTC, PrtGeneralResetTC, PrtAlertTrainingLevelTC, PrtMarkerMarkTechTC, PrtMediaPathTypeTC, PrtAlertGroupTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleDisableTC", "PrtCoverStatusTC", "PrtInterpreterLangFamilyTC", "PrtInputTypeTC", "PrtConsoleColorTC", "PrtOutputTypeTC", "PrtChannelTypeTC", "PrtAlertCodeTC", "PrtMarkerSuppliesTypeTC", "PrtGeneralResetTC", "PrtAlertTrainingLevelTC", "PrtMarkerMarkTechTC", "PrtMediaPathTypeTC", "PrtAlertGroupTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInputMediaName=prtInputMediaName, prtChannel=prtChannel, PrtMediaUnitTC=PrtMediaUnitTC, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtCoverStatus=prtCoverStatus, prtMarkerEastMargin=prtMarkerEastMargin, prtConsoleOnTime=prtConsoleOnTime, prtMarkerColorantValue=prtMarkerColorantValue, prtInputMediaType=prtInputMediaType, prtGeneralServicePerson=prtGeneralServicePerson, prtInputGroup=prtInputGroup, prtLocalizationEntry=prtLocalizationEntry, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMediaPathTable=prtMediaPathTable, printerV2Alert=printerV2Alert, prtOutputDimUnit=prtOutputDimUnit, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMarkerSupplies=prtMarkerSupplies, prtLocalization=prtLocalization, prtAlertGroup=prtAlertGroup, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMediaPathIndex=prtMediaPathIndex, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerProcessColorants=prtMarkerProcessColorants, prtConsoleLightEntry=prtConsoleLightEntry, prtInputMediaGroup=prtInputMediaGroup, prtAlertDescription=prtAlertDescription, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutput=prtOutput, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtGeneral=prtGeneral, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtLocalizationLanguage=prtLocalizationLanguage, prtInterpreterLangVersion=prtInterpreterLangVersion, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtOutputSerialNumber=prtOutputSerialNumber, prtInterpreterGroup=prtInterpreterGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtOutputVendorName=prtOutputVendorName, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInputVersion=prtInputVersion, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerStatus=prtMarkerStatus, printerV1Alert=printerV1Alert, prtAlertTimeGroup=prtAlertTimeGroup, prtDeviceRefTable=prtDeviceRefTable, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerTable=prtMarkerTable, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInputDimUnit=prtInputDimUnit, prtInputMediaWeight=prtInputMediaWeight, prtMediaPathGroup=prtMediaPathGroup, prtInputSerialNumber=prtInputSerialNumber, prtOutputGroup=prtOutputGroup, prtMarker=prtMarker, prtMIB2Groups=prtMIB2Groups, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputVendorName=prtInputVendorName, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInputModel=prtInputModel, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtGeneralEntry=prtGeneralEntry, prtChannelStatus=prtChannelStatus, SubUnitStatus=SubUnitStatus, prtInterpreterDescription=prtInterpreterDescription, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAlertTrainingLevel=prtAlertTrainingLevel, prtConsoleGroup=prtConsoleGroup, prtChannelIndex=prtChannelIndex, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtLocalizationTable=prtLocalizationTable, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputName=prtOutputName, prtMarkerWestMargin=prtMarkerWestMargin, prtStorageRefTable=prtStorageRefTable, prtOutputMaxCapacity=prtOutputMaxCapacity, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtChannelIfIndex=prtChannelIfIndex, prtInterpreterIndex=prtInterpreterIndex, prtMarkerSouthMargin=prtMarkerSouthMargin, prtOutputTable=prtOutputTable, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtAlertCode=prtAlertCode, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMediaPath=prtMediaPath, prtChannelState=prtChannelState, prtInputDefaultIndex=prtInputDefaultIndex, prtConsoleLightTable=prtConsoleLightTable, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerIndex=prtMarkerIndex, prtInterpreter=prtInterpreter, prtAlertIndex=prtAlertIndex, prtMediaPathStatus=prtMediaPathStatus, prtInputIndex=prtInputIndex, prtConsoleDescription=prtConsoleDescription, prtOutputVersion=prtOutputVersion, prtAlertSeverityLevel=prtAlertSeverityLevel, prtAlertTime=prtAlertTime, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, CapacityUnit=CapacityUnit, prtMediaPathType=prtMediaPathType, prtGeneralTable=prtGeneralTable, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputIndex=prtOutputIndex, prtInputTable=prtInputTable, PresentOnOff=PresentOnOff, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputDescription=prtOutputDescription, prtMediaPathEntry=prtMediaPathEntry, CodedCharSet=CodedCharSet, prtInputCapacityUnit=prtInputCapacityUnit, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtConsoleLocalization=prtConsoleLocalization, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputStackingOrder=prtOutputStackingOrder, prtOutputOffsetStacking=prtOutputOffsetStacking, prtOutputType=prtOutputType, prtMarkerSuppliesType=prtMarkerSuppliesType, printerV2AlertPrefix=printerV2AlertPrefix, prtConsoleLightIndex=prtConsoleLightIndex, prtInputMaxCapacity=prtInputMaxCapacity, prtAlertAllEvents=prtAlertAllEvents, prtMarkerLifeCount=prtMarkerLifeCount, prtAlertEntry=prtAlertEntry, prtGeneralV2Group=prtGeneralV2Group, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtGeneralPrinterName=prtGeneralPrinterName, prtExtendedOutputGroup=prtExtendedOutputGroup, prtCoverEntry=prtCoverEntry, prtCoverDescription=prtCoverDescription, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerNorthMargin=prtMarkerNorthMargin, prtAlertTableV2Group=prtAlertTableV2Group, prtInterpreterTable=prtInterpreterTable, prtMarkerGroup=prtMarkerGroup, prtCoverIndex=prtCoverIndex, prtCover=prtCover, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtConsoleDisable=prtConsoleDisable, prtConsoleLights=prtConsoleLights, prtMIBConformance=prtMIBConformance, prtMarkerColorantGroup=prtMarkerColorantGroup, prtDeviceRefEntry=prtDeviceRefEntry, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInterpreterVersion=prtInterpreterVersion, prtInputEntry=prtInputEntry, prtOutputPageCollated=prtOutputPageCollated, prtOutputModel=prtOutputModel, prtMarkerColorantTonality=prtMarkerColorantTonality, prtChannelType=prtChannelType, MediaUnit=MediaUnit, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtGeneralConfigChanges=prtGeneralConfigChanges, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerColorant=prtMarkerColorant, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputMediaFormParts=prtInputMediaFormParts, prtStorageRefIndex=prtStorageRefIndex, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtOutputBursting=prtOutputBursting, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtInterpreterLangFamily=prtInterpreterLangFamily, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtStorageRefEntry=prtStorageRefEntry, prtInterpreterEntry=prtInterpreterEntry, PYSNMP_MODULE_ID=printmib, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleColor=prtConsoleColor, printmib=printmib, prtInputSecurity=prtInputSecurity, prtDeviceRefIndex=prtDeviceRefIndex, prtInputDescription=prtInputDescription, prtConsoleOffTime=prtConsoleOffTime, prtInputStatus=prtInputStatus, prtChannelEntry=prtChannelEntry, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtAlertTable=prtAlertTable, prtMarkerMarkTech=prtMarkerMarkTech, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtChannelInformation=prtChannelInformation, prtInterpreterLangLevel=prtInterpreterLangLevel, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtOutputSecurity=prtOutputSecurity, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtAlertCriticalEvents=prtAlertCriticalEvents, prtLocalizationCountry=prtLocalizationCountry, prtInputType=prtInputType, prtMIBGroups=prtMIBGroups, prtOutputDecollating=prtOutputDecollating, prtMarkerColorantIndex=prtMarkerColorantIndex, prtOutputStatus=prtOutputStatus, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtChannelTable=prtChannelTable, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMediaPathDescription=prtMediaPathDescription, prtChannelGroup=prtChannelGroup, prtCoverTable=prtCoverTable, prtInputNextIndex=prtInputNextIndex, PrtChannelStateTC=PrtChannelStateTC, prtGeneralReset=prtGeneralReset, prtInputMediaColor=prtInputMediaColor, prtAlertTrapGroup=prtAlertTrapGroup, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtAlertLocation=prtAlertLocation, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtAlertGroupIndex=prtAlertGroupIndex, prtAlertTableGroup=prtAlertTableGroup, prtGeneralGroup=prtGeneralGroup, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerEntry=prtMarkerEntry, prtGeneralSerialNumber=prtGeneralSerialNumber, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtChannelV2Group=prtChannelV2Group, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputName=prtInputName, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlert=prtAlert, prtOutputEntry=prtOutputEntry, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInput=prtInput, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtLocalizationIndex=prtLocalizationIndex)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMIBCompliance=prtMIBCompliance, prtMIB2Compliance=prtMIB2Compliance, prtExtendedInputGroup=prtExtendedInputGroup)
