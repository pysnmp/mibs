...
PrtMarkerMarkTechTC, PrtInputTypeTC, PrtConsoleColorTC, PrtMediaPathTypeTC, PrtAlertCodeTC, PrtAlertGroupTC, PrtOutputTypeTC, PrtConsoleDisableTC, PrtCoverStatusTC, PrtAlertTrainingLevelTC, PrtInterpreterLangFamilyTC, PrtGeneralResetTC, PrtChannelTypeTC, PrtMarkerSuppliesTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerMarkTechTC", "PrtInputTypeTC", "PrtConsoleColorTC", "PrtMediaPathTypeTC", "PrtAlertCodeTC", "PrtAlertGroupTC", "PrtOutputTypeTC", "PrtConsoleDisableTC", "PrtCoverStatusTC", "PrtAlertTrainingLevelTC", "PrtInterpreterLangFamilyTC", "PrtGeneralResetTC", "PrtChannelTypeTC", "PrtMarkerSuppliesTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerEntry=prtMarkerEntry, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMediaPathGroup=prtMediaPathGroup, prtMIBCompliance=prtMIBCompliance, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtExtendedInputGroup=prtExtendedInputGroup, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputOffsetStacking=prtOutputOffsetStacking, prtGeneralPrinterName=prtGeneralPrinterName, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtOutputCapacityUnit=prtOutputCapacityUnit, prtInputMediaColor=prtInputMediaColor, prtAlertCriticalEvents=prtAlertCriticalEvents, prtChannelInformation=prtChannelInformation, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtInputMediaGroup=prtInputMediaGroup, prtInputStatus=prtInputStatus, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInputDescription=prtInputDescription, prtMarkerWestMargin=prtMarkerWestMargin, prtAlertIndex=prtAlertIndex, prtMarkerLifeCount=prtMarkerLifeCount, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputModel=prtInputModel, prtOutputPageCollated=prtOutputPageCollated, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtAlertCode=prtAlertCode, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerColorantTonality=prtMarkerColorantTonality, prtOutputVersion=prtOutputVersion, prtMarkerSuppliesTable=prtMarkerSuppliesTable, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtChannelState=prtChannelState, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerPowerOnCount=prtMarkerPowerOnCount, PrtMediaUnitTC=PrtMediaUnitTC, prtAlertDescription=prtAlertDescription, prtOutputDimUnit=prtOutputDimUnit, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerColorantRole=prtMarkerColorantRole, prtOutputStatus=prtOutputStatus, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMarkerTable=prtMarkerTable, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtOutputSerialNumber=prtOutputSerialNumber, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtOutputName=prtOutputName, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtGeneralConfigChanges=prtGeneralConfigChanges, prtOutputDescription=prtOutputDescription, prtCoverDescription=prtCoverDescription, prtConsoleDescription=prtConsoleDescription, prtAlertGroupIndex=prtAlertGroupIndex, prtConsoleColor=prtConsoleColor, prtCover=prtCover, prtOutputBursting=prtOutputBursting, prtAlertGroup=prtAlertGroup, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtLocalization=prtLocalization, prtGeneralV2Group=prtGeneralV2Group, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtLocalizationIndex=prtLocalizationIndex, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtCoverEntry=prtCoverEntry, prtInputType=prtInputType, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtConsoleLightTable=prtConsoleLightTable, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMarkerColorantValue=prtMarkerColorantValue, prtInterpreterTable=prtInterpreterTable, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInputMediaFormParts=prtInputMediaFormParts, prtChannelProtocolVersion=prtChannelProtocolVersion, printerV2AlertPrefix=printerV2AlertPrefix, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtConsoleOffTime=prtConsoleOffTime, prtAlert=prtAlert, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputDimUnit=prtInputDimUnit, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtConsoleLightIndex=prtConsoleLightIndex, prtConsoleGroup=prtConsoleGroup, prtInputCapacityUnit=prtInputCapacityUnit, prtMarkerGroup=prtMarkerGroup, prtOutputSecurity=prtOutputSecurity, CodedCharSet=CodedCharSet, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtChannel=prtChannel, prtCoverIndex=prtCoverIndex, prtAlertTable=prtAlertTable, prtAlertTimeGroup=prtAlertTimeGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtLocalizationCountry=prtLocalizationCountry, prtInputCurrentLevel=prtInputCurrentLevel, prtInputSerialNumber=prtInputSerialNumber, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMarkerCounterUnit=prtMarkerCounterUnit, prtOutputDecollating=prtOutputDecollating, SubUnitStatus=SubUnitStatus, prtInputEntry=prtInputEntry, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputGroup=prtInputGroup, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMediaPathTable=prtMediaPathTable, prtGeneralEntry=prtGeneralEntry, CapacityUnit=CapacityUnit, prtOutput=prtOutput, prtInputMediaName=prtInputMediaName, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerSouthMargin=prtMarkerSouthMargin, prtStorageRefIndex=prtStorageRefIndex, PrtPrintOrientationTC=PrtPrintOrientationTC, prtGeneralServicePerson=prtGeneralServicePerson, prtConsoleOnTime=prtConsoleOnTime, prtGeneralReset=prtGeneralReset, prtLocalizationEntry=prtLocalizationEntry, prtDeviceRefTable=prtDeviceRefTable, prtInputTable=prtInputTable, prtInterpreterDescription=prtInterpreterDescription, prtInputMediaWeight=prtInputMediaWeight, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInterpreterLangFamily=prtInterpreterLangFamily, prtGeneralTable=prtGeneralTable, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInterpreterGroup=prtInterpreterGroup, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputMaxCapacity=prtInputMaxCapacity, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMIBGroups=prtMIBGroups, prtInputIndex=prtInputIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtOutputVendorName=prtOutputVendorName, prtMediaPathStatus=prtMediaPathStatus, prtAlertTime=prtAlertTime, prtMIB2Groups=prtMIB2Groups, prtInputDefaultIndex=prtInputDefaultIndex, prtChannelV2Group=prtChannelV2Group, prtAlertLocation=prtAlertLocation, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInputSecurity=prtInputSecurity, prtMarkerColorant=prtMarkerColorant, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMediaPathType=prtMediaPathType, prtInterpreterLangVersion=prtInterpreterLangVersion, prtAlertEntry=prtAlertEntry, printerV2Alert=printerV2Alert, prtAlertTableV2Group=prtAlertTableV2Group, prtConsoleLocalization=prtConsoleLocalization, prtMediaPathDescription=prtMediaPathDescription, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMediaPath=prtMediaPath, prtOutputDefaultIndex=prtOutputDefaultIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInterpreterEntry=prtInterpreterEntry, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInputName=prtInputName, prtMIBConformance=prtMIBConformance, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMIB2Compliance=prtMIB2Compliance, printmib=printmib, prtInterpreterVersion=prtInterpreterVersion, prtChannelStatus=prtChannelStatus, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMarkerMarkTech=prtMarkerMarkTech, prtGeneralGroup=prtGeneralGroup, prtInputMediaType=prtInputMediaType, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerSuppliesType=prtMarkerSuppliesType, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtStorageRefEntry=prtStorageRefEntry, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInput=prtInput, prtChannelEntry=prtChannelEntry, prtInterpreter=prtInterpreter, prtMarkerColorantTable=prtMarkerColorantTable, PrtChannelStateTC=PrtChannelStateTC, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerColorantEntry=prtMarkerColorantEntry, prtCoverStatus=prtCoverStatus, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, printerV1Alert=printerV1Alert, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerStatus=prtMarkerStatus, prtMarker=prtMarker, prtOutputIndex=prtOutputIndex, prtOutputGroup=prtOutputGroup, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerSupplies=prtMarkerSupplies, prtMarkerProcessColorants=prtMarkerProcessColorants, prtChannelIfIndex=prtChannelIfIndex, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtOutputTable=prtOutputTable, prtGeneral=prtGeneral, prtOutputModel=prtOutputModel, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAlertTableGroup=prtAlertTableGroup, prtConsoleLightEntry=prtConsoleLightEntry, prtOutputEntry=prtOutputEntry, MediaUnit=MediaUnit, prtChannelIndex=prtChannelIndex, prtChannelTable=prtChannelTable, prtStorageRefTable=prtStorageRefTable, prtLocalizationTable=prtLocalizationTable, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, PresentOnOff=PresentOnOff, prtInputVendorName=prtInputVendorName, prtInputNextIndex=prtInputNextIndex, prtChannelType=prtChannelType, prtConsoleLights=prtConsoleLights, prtMarkerNorthMargin=prtMarkerNorthMargin, PYSNMP_MODULE_ID=printmib, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMediaPathIndex=prtMediaPathIndex, prtInterpreterIndex=prtInterpreterIndex, prtConsoleDisable=prtConsoleDisable, prtMarkerIndex=prtMarkerIndex, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtOutputType=prtOutputType, prtCoverTable=prtCoverTable, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex)
mibBuilder.exportSymbols("Printer-MIB", prtAlertAllEvents=prtAlertAllEvents, prtChannelGroup=prtChannelGroup, prtMediaPathEntry=prtMediaPathEntry, prtInputVersion=prtInputVersion)
