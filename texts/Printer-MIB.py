...
PrtCoverStatusTC, PrtChannelTypeTC, PrtConsoleColorTC, PrtInputTypeTC, PrtConsoleDisableTC, PrtOutputTypeTC, PrtGeneralResetTC, PrtAlertCodeTC, PrtAlertTrainingLevelTC, PrtInterpreterLangFamilyTC, PrtMarkerMarkTechTC, PrtMediaPathTypeTC, PrtAlertGroupTC, PrtMarkerSuppliesTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtCoverStatusTC", "PrtChannelTypeTC", "PrtConsoleColorTC", "PrtInputTypeTC", "PrtConsoleDisableTC", "PrtOutputTypeTC", "PrtGeneralResetTC", "PrtAlertCodeTC", "PrtAlertTrainingLevelTC", "PrtInterpreterLangFamilyTC", "PrtMarkerMarkTechTC", "PrtMediaPathTypeTC", "PrtAlertGroupTC", "PrtMarkerSuppliesTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarkerStatus=prtMarkerStatus, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtChannelIfIndex=prtChannelIfIndex, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInputDimUnit=prtInputDimUnit, prtOutputStackingOrder=prtOutputStackingOrder, prtStorageRefTable=prtStorageRefTable, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerMarkTech=prtMarkerMarkTech, prtMediaPath=prtMediaPath, prtOutputTable=prtOutputTable, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInputSwitchingGroup=prtInputSwitchingGroup, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerLifeCount=prtMarkerLifeCount, prtInterpreterVersion=prtInterpreterVersion, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputPageCollated=prtOutputPageCollated, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInterpreterGroup=prtInterpreterGroup, prtChannelInformation=prtChannelInformation, prtChannelType=prtChannelType, prtInputType=prtInputType, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtOutputEntry=prtOutputEntry, prtConsoleDescription=prtConsoleDescription, prtAlertTimeGroup=prtAlertTimeGroup, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtLocalizationLanguage=prtLocalizationLanguage, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtDeviceRefEntry=prtDeviceRefEntry, prtInputIndex=prtInputIndex, prtAlertTableV2Group=prtAlertTableV2Group, prtGeneralEntry=prtGeneralEntry, prtStorageRefIndex=prtStorageRefIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, MediaUnit=MediaUnit, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, printerV2Alert=printerV2Alert, prtConsoleOffTime=prtConsoleOffTime, prtMarkerColorantIndex=prtMarkerColorantIndex, prtAlertGroupIndex=prtAlertGroupIndex, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtConsoleGroup=prtConsoleGroup, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtCover=prtCover, prtInputMediaWeight=prtInputMediaWeight, prtMediaPathIndex=prtMediaPathIndex, prtOutputSecurity=prtOutputSecurity, prtOutputVendorName=prtOutputVendorName, prtAlertDescription=prtAlertDescription, prtGeneral=prtGeneral, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtChannel=prtChannel, prtMIB2Groups=prtMIB2Groups, prtGeneralSerialNumber=prtGeneralSerialNumber, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerWestMargin=prtMarkerWestMargin, prtMarkerColorantValue=prtMarkerColorantValue, prtChannelIndex=prtChannelIndex, prtInputDefaultIndex=prtInputDefaultIndex, printerV2AlertPrefix=printerV2AlertPrefix, prtMarkerColorant=prtMarkerColorant, prtChannelV2Group=prtChannelV2Group, prtMarkerEntry=prtMarkerEntry, prtLocalizationTable=prtLocalizationTable, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputMediaColor=prtInputMediaColor, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputStatus=prtInputStatus, prtMediaPathType=prtMediaPathType, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtCoverEntry=prtCoverEntry, prtMarkerEastMargin=prtMarkerEastMargin, prtMIBCompliance=prtMIBCompliance, prtInterpreterDescription=prtInterpreterDescription, prtLocalizationCountry=prtLocalizationCountry, prtGeneralTable=prtGeneralTable, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerGroup=prtMarkerGroup, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, CodedCharSet=CodedCharSet, prtInputSerialNumber=prtInputSerialNumber, prtInputMaxCapacity=prtInputMaxCapacity, prtGeneralServicePerson=prtGeneralServicePerson, prtOutputDescription=prtOutputDescription, prtConsoleColor=prtConsoleColor, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInputMediaGroup=prtInputMediaGroup, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtOutputCapacityUnit=prtOutputCapacityUnit, prtOutputName=prtOutputName, prtConsoleLightTable=prtConsoleLightTable, prtInterpreter=prtInterpreter, prtMarkerIndex=prtMarkerIndex, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerColorantTonality=prtMarkerColorantTonality, SubUnitStatus=SubUnitStatus, prtMarkerSuppliesType=prtMarkerSuppliesType, prtConsoleLights=prtConsoleLights, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtGeneralPrinterName=prtGeneralPrinterName, prtOutputBursting=prtOutputBursting, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtStorageRefEntry=prtStorageRefEntry, prtConsoleOnTime=prtConsoleOnTime, prtInputEntry=prtInputEntry, PresentOnOff=PresentOnOff, prtAlertTable=prtAlertTable, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerSupplies=prtMarkerSupplies, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtChannelStatus=prtChannelStatus, prtInputSecurity=prtInputSecurity, prtMediaPathStatus=prtMediaPathStatus, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtAlertCriticalEvents=prtAlertCriticalEvents, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInterpreterLangVersion=prtInterpreterLangVersion, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtInterpreterEntry=prtInterpreterEntry, prtAlertEntry=prtAlertEntry, prtGeneralReset=prtGeneralReset, prtInputTable=prtInputTable, prtAlertSeverityLevel=prtAlertSeverityLevel, prtDeviceRefIndex=prtDeviceRefIndex, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlertAllEvents=prtAlertAllEvents, prtLocalization=prtLocalization, prtAlertLocation=prtAlertLocation, prtAlertIndex=prtAlertIndex, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputName=prtInputName, prtGeneralGroup=prtGeneralGroup, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMediaPathGroup=prtMediaPathGroup, prtAlertGroup=prtAlertGroup, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtCoverIndex=prtCoverIndex, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputMediaName=prtInputMediaName, prtMediaPathEntry=prtMediaPathEntry, PrtChannelStateTC=PrtChannelStateTC, prtOutputDefaultIndex=prtOutputDefaultIndex, prtConsoleLocalization=prtConsoleLocalization, prtGeneralConfigChanges=prtGeneralConfigChanges, prtCoverTable=prtCoverTable, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtGeneralV2Group=prtGeneralV2Group, printmib=printmib, prtOutputModel=prtOutputModel, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtOutputStatus=prtOutputStatus, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputCapacityUnit=prtInputCapacityUnit, prtMarkerSpotColorants=prtMarkerSpotColorants, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerTable=prtMarkerTable, prtInputNextIndex=prtInputNextIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtChannelGroup=prtChannelGroup, prtAlertTrapGroup=prtAlertTrapGroup, prtOutputIndex=prtOutputIndex, prtAlertCode=prtAlertCode, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputVersion=prtInputVersion, PYSNMP_MODULE_ID=printmib, prtCoverDescription=prtCoverDescription, prtMarker=prtMarker, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputDecollating=prtOutputDecollating, prtChannelEntry=prtChannelEntry, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerCounterUnit=prtMarkerCounterUnit, prtAlert=prtAlert, prtInputMediaFormParts=prtInputMediaFormParts, prtChannelTable=prtChannelTable, prtOutput=prtOutput, prtOutputDimUnit=prtOutputDimUnit, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtChannelState=prtChannelState, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtInputModel=prtInputModel, prtOutputType=prtOutputType, prtConsoleDisable=prtConsoleDisable, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMediaPathDescription=prtMediaPathDescription, printerV1Alert=printerV1Alert, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInterpreterIndex=prtInterpreterIndex, prtLocalizationIndex=prtLocalizationIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtInputGroup=prtInputGroup, prtOutputGroup=prtOutputGroup, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMarkerColorantTable=prtMarkerColorantTable, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputMediaType=prtInputMediaType, prtCoverStatus=prtCoverStatus, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtLocalizationEntry=prtLocalizationEntry, prtMIBGroups=prtMIBGroups, prtAlertTableGroup=prtAlertTableGroup, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMediaPathTable=prtMediaPathTable, prtInputDescription=prtInputDescription, prtInput=prtInput, PrtCapacityUnitTC=PrtCapacityUnitTC, prtConsoleLightIndex=prtConsoleLightIndex, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputRemainingCapacity=prtOutputRemainingCapacity, PrtMediaUnitTC=PrtMediaUnitTC, prtInputVendorName=prtInputVendorName, prtAlertTime=prtAlertTime, prtOutputVersion=prtOutputVersion, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtOutputSerialNumber=prtOutputSerialNumber, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInterpreterTable=prtInterpreterTable, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMIB2Compliance=prtMIB2Compliance, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerColorantEntry=prtMarkerColorantEntry, prtMIBConformance=prtMIBConformance, CapacityUnit=CapacityUnit, prtDeviceRefTable=prtDeviceRefTable)
