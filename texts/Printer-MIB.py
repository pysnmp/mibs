...
PrtAlertGroupTC, PrtInputTypeTC, PrtCoverStatusTC, PrtMarkerMarkTechTC, PrtMarkerSuppliesTypeTC, PrtConsoleDisableTC, PrtMediaPathTypeTC, PrtAlertTrainingLevelTC, PrtChannelTypeTC, PrtOutputTypeTC, PrtGeneralResetTC, PrtInterpreterLangFamilyTC, PrtAlertCodeTC, PrtConsoleColorTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertGroupTC", "PrtInputTypeTC", "PrtCoverStatusTC", "PrtMarkerMarkTechTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleDisableTC", "PrtMediaPathTypeTC", "PrtAlertTrainingLevelTC", "PrtChannelTypeTC", "PrtOutputTypeTC", "PrtGeneralResetTC", "PrtInterpreterLangFamilyTC", "PrtAlertCodeTC", "PrtConsoleColorTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtConsoleDisable=prtConsoleDisable, prtChannel=prtChannel, prtConsoleLightIndex=prtConsoleLightIndex, prtMIB2Groups=prtMIB2Groups, prtInterpreterGroup=prtInterpreterGroup, prtInputName=prtInputName, prtInputEntry=prtInputEntry, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtAlertTable=prtAlertTable, prtInputMediaFormParts=prtInputMediaFormParts, prtAlertTrainingLevel=prtAlertTrainingLevel, prtAlertTableGroup=prtAlertTableGroup, prtInputModel=prtInputModel, prtMIBGroups=prtMIBGroups, prtInputMediaColor=prtInputMediaColor, prtConsoleLocalization=prtConsoleLocalization, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerSupplies=prtMarkerSupplies, prtOutputTable=prtOutputTable, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtGeneralSerialNumber=prtGeneralSerialNumber, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtChannelEntry=prtChannelEntry, prtGeneralReset=prtGeneralReset, prtAlertTime=prtAlertTime, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerEntry=prtMarkerEntry, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerColorantGroup=prtMarkerColorantGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtInterpreterIndex=prtInterpreterIndex, prtOutputOffsetStacking=prtOutputOffsetStacking, CapacityUnit=CapacityUnit, prtInputVendorName=prtInputVendorName, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerNorthMargin=prtMarkerNorthMargin, SubUnitStatus=SubUnitStatus, prtMarkerIndex=prtMarkerIndex, prtChannelV2Group=prtChannelV2Group, prtGeneralGroup=prtGeneralGroup, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtDeviceRefTable=prtDeviceRefTable, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtGeneralServicePerson=prtGeneralServicePerson, prtOutputSerialNumber=prtOutputSerialNumber, prtInputDefaultIndex=prtInputDefaultIndex, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInterpreterVersion=prtInterpreterVersion, prtMarker=prtMarker, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtConsoleGroup=prtConsoleGroup, prtStorageRefEntry=prtStorageRefEntry, prtOutputIndex=prtOutputIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtAlertGroup=prtAlertGroup, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtConsoleDescription=prtConsoleDescription, prtLocalizationIndex=prtLocalizationIndex, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerStatus=prtMarkerStatus, prtMarkerLifeCount=prtMarkerLifeCount, PYSNMP_MODULE_ID=printmib, prtInterpreterTable=prtInterpreterTable, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputMediaGroup=prtInputMediaGroup, prtOutputType=prtOutputType, prtGeneralV2Group=prtGeneralV2Group, prtInputIndex=prtInputIndex, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInterpreter=prtInterpreter, MediaUnit=MediaUnit, prtMediaPathEntry=prtMediaPathEntry, prtAlertIndex=prtAlertIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtOutputModel=prtOutputModel, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerColorantTonality=prtMarkerColorantTonality, prtConsoleColor=prtConsoleColor, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerWestMargin=prtMarkerWestMargin, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, printerV2AlertPrefix=printerV2AlertPrefix, prtOutputName=prtOutputName, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtCoverDescription=prtCoverDescription, prtStorageRefTable=prtStorageRefTable, prtInputSerialNumber=prtInputSerialNumber, prtConsoleLightTable=prtConsoleLightTable, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMarkerProcessColorants=prtMarkerProcessColorants, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputPageCollated=prtOutputPageCollated, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtChannelStatus=prtChannelStatus, prtOutputDecollating=prtOutputDecollating, prtMarkerEastMargin=prtMarkerEastMargin, prtLocalizationTable=prtLocalizationTable, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtStorageRefIndex=prtStorageRefIndex, prtInputDimUnit=prtInputDimUnit, prtOutputVersion=prtOutputVersion, prtInterpreterLangVersion=prtInterpreterLangVersion, PrtPrintOrientationTC=PrtPrintOrientationTC, PresentOnOff=PresentOnOff, prtMIBCompliance=prtMIBCompliance, prtChannelIfIndex=prtChannelIfIndex, prtInterpreterEntry=prtInterpreterEntry, prtAlertAllEvents=prtAlertAllEvents, prtMIB2Compliance=prtMIB2Compliance, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputCapacityUnit=prtInputCapacityUnit, prtGeneral=prtGeneral, prtMediaPathIndex=prtMediaPathIndex, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputMediaWeight=prtInputMediaWeight, printerV2Alert=printerV2Alert, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMarkerGroup=prtMarkerGroup, prtMarkerMarkTech=prtMarkerMarkTech, prtMediaPathGroup=prtMediaPathGroup, prtExtendedOutputGroup=prtExtendedOutputGroup, prtChannelTable=prtChannelTable, prtOutputCapacityUnit=prtOutputCapacityUnit, prtAlertTrapGroup=prtAlertTrapGroup, prtOutputStatus=prtOutputStatus, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerColorantIndex=prtMarkerColorantIndex, prtAlertGroupIndex=prtAlertGroupIndex, CodedCharSet=CodedCharSet, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtChannelInformation=prtChannelInformation, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtCoverStatus=prtCoverStatus, prtInput=prtInput, prtMarkerColorant=prtMarkerColorant, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMarkerColorantValue=prtMarkerColorantValue, printerV1Alert=printerV1Alert, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMediaPathStatus=prtMediaPathStatus, prtOutput=prtOutput, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMediaPath=prtMediaPath, prtOutputDescription=prtOutputDescription, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtLocalizationCountry=prtLocalizationCountry, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMediaPathDescription=prtMediaPathDescription, prtInterpreterDescription=prtInterpreterDescription, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlertDescription=prtAlertDescription, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputSecurity=prtOutputSecurity, PrtCapacityUnitTC=PrtCapacityUnitTC, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtCover=prtCover, prtGeneralEntry=prtGeneralEntry, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInputMediaType=prtInputMediaType, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputDimUnit=prtOutputDimUnit, prtInputGroup=prtInputGroup, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputTable=prtInputTable, prtInputMaxCapacity=prtInputMaxCapacity, prtMarkerSuppliesType=prtMarkerSuppliesType, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtChannelType=prtChannelType, prtConsoleLights=prtConsoleLights, prtResponsiblePartyGroup=prtResponsiblePartyGroup, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtLocalizationEntry=prtLocalizationEntry, prtOutputBursting=prtOutputBursting, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMIBConformance=prtMIBConformance, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtAlertEntry=prtAlertEntry, prtInputNextIndex=prtInputNextIndex, prtAlertLocation=prtAlertLocation, prtConsoleOnTime=prtConsoleOnTime, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerCounterUnit=prtMarkerCounterUnit, prtGeneralTable=prtGeneralTable, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerTable=prtMarkerTable, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInputStatus=prtInputStatus, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtAlert=prtAlert, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMediaPathTable=prtMediaPathTable, prtInputDescription=prtInputDescription, prtInputMediaName=prtInputMediaName, prtGeneralPrinterName=prtGeneralPrinterName, prtInputVersion=prtInputVersion, prtCoverIndex=prtCoverIndex, prtConsoleOffTime=prtConsoleOffTime, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInputCurrentLevel=prtInputCurrentLevel, prtAlertCode=prtAlertCode, prtInputType=prtInputType, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtCoverEntry=prtCoverEntry, prtDeviceRefIndex=prtDeviceRefIndex, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputEntry=prtOutputEntry, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtCoverTable=prtCoverTable, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtOutputMaxCapacity=prtOutputMaxCapacity, prtChannelIndex=prtChannelIndex, PrtChannelStateTC=PrtChannelStateTC, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtChannelGroup=prtChannelGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputSecurity=prtInputSecurity, prtLocalization=prtLocalization, prtOutputVendorName=prtOutputVendorName, prtMarkerSpotColorants=prtMarkerSpotColorants, printmib=printmib, prtMediaPathType=prtMediaPathType)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtOutputGroup=prtOutputGroup, prtChannelState=prtChannelState, prtOutputStackingOrder=prtOutputStackingOrder)
