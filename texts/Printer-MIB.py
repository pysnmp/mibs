...
PrtConsoleDisableTC, PrtInterpreterLangFamilyTC, PrtMarkerMarkTechTC, PrtAlertGroupTC, PrtInputTypeTC, PrtCoverStatusTC, PrtOutputTypeTC, PrtMediaPathTypeTC, PrtAlertTrainingLevelTC, PrtChannelTypeTC, PrtMarkerSuppliesTypeTC, PrtGeneralResetTC, PrtAlertCodeTC, PrtConsoleColorTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleDisableTC", "PrtInterpreterLangFamilyTC", "PrtMarkerMarkTechTC", "PrtAlertGroupTC", "PrtInputTypeTC", "PrtCoverStatusTC", "PrtOutputTypeTC", "PrtMediaPathTypeTC", "PrtAlertTrainingLevelTC", "PrtChannelTypeTC", "PrtMarkerSuppliesTypeTC", "PrtGeneralResetTC", "PrtAlertCodeTC", "PrtConsoleColorTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtConsoleGroup=prtConsoleGroup, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtAlertCode=prtAlertCode, PrtCapacityUnitTC=PrtCapacityUnitTC, SubUnitStatus=SubUnitStatus, prtGeneralConfigChanges=prtGeneralConfigChanges, prtGeneralEntry=prtGeneralEntry, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtOutputDimUnit=prtOutputDimUnit, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInputMediaName=prtInputMediaName, prtMarkerPowerOnCount=prtMarkerPowerOnCount, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMediaPathEntry=prtMediaPathEntry, prtMediaPathIndex=prtMediaPathIndex, prtConsoleDescription=prtConsoleDescription, prtMarkerWestMargin=prtMarkerWestMargin, prtStorageRefIndex=prtStorageRefIndex, prtConsoleLights=prtConsoleLights, printerV2AlertPrefix=printerV2AlertPrefix, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtAlertTrapGroup=prtAlertTrapGroup, prtInterpreterLangLevel=prtInterpreterLangLevel, printerV2Alert=printerV2Alert, prtInputGroup=prtInputGroup, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInterpreterLangFamily=prtInterpreterLangFamily, prtCover=prtCover, prtInputNextIndex=prtInputNextIndex, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerStatus=prtMarkerStatus, prtInterpreterVersion=prtInterpreterVersion, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputIndex=prtOutputIndex, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInterpreterGroup=prtInterpreterGroup, prtOutputDescription=prtOutputDescription, prtMarkerColorantGroup=prtMarkerColorantGroup, prtGeneralTable=prtGeneralTable, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputEntry=prtInputEntry, prtConsoleLightEntry=prtConsoleLightEntry, prtChannelEntry=prtChannelEntry, prtConsoleLightIndex=prtConsoleLightIndex, prtConsoleOffTime=prtConsoleOffTime, prtStorageRefTable=prtStorageRefTable, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputName=prtOutputName, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInputMediaType=prtInputMediaType, prtMediaPathType=prtMediaPathType, printerV1Alert=printerV1Alert, prtOutputBursting=prtOutputBursting, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputEntry=prtOutputEntry, prtInputCapacityUnit=prtInputCapacityUnit, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputMediaColor=prtInputMediaColor, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtInterpreterEntry=prtInterpreterEntry, prtMIBGroups=prtMIBGroups, prtOutputSecurity=prtOutputSecurity, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerGroup=prtMarkerGroup, prtInput=prtInput, prtMarkerSpotColorants=prtMarkerSpotColorants, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMarkerSupplies=prtMarkerSupplies, prtAlert=prtAlert, prtMarkerEntry=prtMarkerEntry, prtInputSecurity=prtInputSecurity, prtAlertLocation=prtAlertLocation, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtAlertTime=prtAlertTime, PresentOnOff=PresentOnOff, prtMIB2Groups=prtMIB2Groups, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtChannelGroup=prtChannelGroup, PYSNMP_MODULE_ID=printmib, prtGeneralReset=prtGeneralReset, prtChannelTable=prtChannelTable, prtAlertTableGroup=prtAlertTableGroup, prtOutputVendorName=prtOutputVendorName, prtMediaPathStatus=prtMediaPathStatus, prtInterpreterDescription=prtInterpreterDescription, prtDeviceRefEntry=prtDeviceRefEntry, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputDefaultIndex=prtOutputDefaultIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtDeviceRefTable=prtDeviceRefTable, prtInputModel=prtInputModel, prtMediaPath=prtMediaPath, prtInputStatus=prtInputStatus, prtInputDescription=prtInputDescription, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMarkerIndex=prtMarkerIndex, prtChannelInformation=prtChannelInformation, prtMarkerLifeCount=prtMarkerLifeCount, prtConsoleDisable=prtConsoleDisable, prtAlertAllEvents=prtAlertAllEvents, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtConsoleOnTime=prtConsoleOnTime, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtAlertGroup=prtAlertGroup, prtStorageRefEntry=prtStorageRefEntry, prtOutputType=prtOutputType, prtOutput=prtOutput, prtMIB2Compliance=prtMIB2Compliance, prtOutputDecollating=prtOutputDecollating, prtInterpreterTable=prtInterpreterTable, prtInputType=prtInputType, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputDefaultIndex=prtInputDefaultIndex, prtInputMediaWeight=prtInputMediaWeight, prtMarkerSuppliesTable=prtMarkerSuppliesTable, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtDeviceRefIndex=prtDeviceRefIndex, prtCoverTable=prtCoverTable, PrtMediaUnitTC=PrtMediaUnitTC, prtAlertTable=prtAlertTable, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInputIndex=prtInputIndex, prtConsoleLocalization=prtConsoleLocalization, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInputSerialNumber=prtInputSerialNumber, prtMarkerMarkTech=prtMarkerMarkTech, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtChannelType=prtChannelType, prtInputName=prtInputName, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtAlertDescription=prtAlertDescription, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtOutputPageCollated=prtOutputPageCollated, prtCoverIndex=prtCoverIndex, prtInputDimUnit=prtInputDimUnit, prtMarkerTable=prtMarkerTable, prtMIBCompliance=prtMIBCompliance, prtCoverEntry=prtCoverEntry, prtAlertTimeGroup=prtAlertTimeGroup, prtOutputStatus=prtOutputStatus, prtGeneralV2Group=prtGeneralV2Group, prtExtendedOutputGroup=prtExtendedOutputGroup, prtGeneralPrinterName=prtGeneralPrinterName, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtChannelState=prtChannelState, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputTable=prtInputTable, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtChannelProtocolVersion=prtChannelProtocolVersion, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtConsoleLightTable=prtConsoleLightTable, prtLocalizationEntry=prtLocalizationEntry, prtCoverDescription=prtCoverDescription, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtChannel=prtChannel, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtChannelIfIndex=prtChannelIfIndex, prtInterpreterIndex=prtInterpreterIndex, prtExtendedInputGroup=prtExtendedInputGroup, prtGeneral=prtGeneral, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMarkerColorantEntry=prtMarkerColorantEntry, prtLocalizationTable=prtLocalizationTable, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputVersion=prtOutputVersion, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerColorant=prtMarkerColorant, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMIBConformance=prtMIBConformance, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMarker=prtMarker, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputTable=prtOutputTable, prtMediaPathDescription=prtMediaPathDescription, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtAlertEntry=prtAlertEntry, prtAlertIndex=prtAlertIndex, prtMediaPathTable=prtMediaPathTable, prtChannelStatus=prtChannelStatus, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtOutputGroup=prtOutputGroup, prtConsoleColor=prtConsoleColor, printmib=printmib, prtOutputOffsetStacking=prtOutputOffsetStacking, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerSuppliesType=prtMarkerSuppliesType, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtLocalization=prtLocalization, prtOutputMaxCapacity=prtOutputMaxCapacity, CodedCharSet=CodedCharSet, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInterpreter=prtInterpreter, prtMediaPathGroup=prtMediaPathGroup, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtOutputSerialNumber=prtOutputSerialNumber, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInterpreterTwoWay=prtInterpreterTwoWay, prtGeneralSerialNumber=prtGeneralSerialNumber, MediaUnit=MediaUnit, prtChannelIndex=prtChannelIndex, prtMarkerSouthMargin=prtMarkerSouthMargin, prtAlertTrainingLevel=prtAlertTrainingLevel, CapacityUnit=CapacityUnit, prtAlertGroupIndex=prtAlertGroupIndex, PrtChannelStateTC=PrtChannelStateTC, prtMarkerColorantValue=prtMarkerColorantValue, prtGeneralGroup=prtGeneralGroup, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtLocalizationCountry=prtLocalizationCountry, prtMarkerColorantTable=prtMarkerColorantTable, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, PrtPrintOrientationTC=PrtPrintOrientationTC, prtChannelV2Group=prtChannelV2Group, prtLocalizationIndex=prtLocalizationIndex, prtInputVersion=prtInputVersion, prtOutputModel=prtOutputModel, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInputVendorName=prtInputVendorName, prtCoverStatus=prtCoverStatus)
mibBuilder.exportSymbols("Printer-MIB", prtLocalizationLanguage=prtLocalizationLanguage, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInputMediaGroup=prtInputMediaGroup)
