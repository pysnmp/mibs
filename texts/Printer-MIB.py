...
PrtMarkerSuppliesTypeTC, PrtAlertGroupTC, PrtChannelTypeTC, PrtConsoleDisableTC, PrtConsoleColorTC, PrtMarkerMarkTechTC, PrtMediaPathTypeTC, PrtOutputTypeTC, PrtInterpreterLangFamilyTC, PrtCoverStatusTC, PrtAlertCodeTC, PrtGeneralResetTC, PrtInputTypeTC, PrtAlertTrainingLevelTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerSuppliesTypeTC", "PrtAlertGroupTC", "PrtChannelTypeTC", "PrtConsoleDisableTC", "PrtConsoleColorTC", "PrtMarkerMarkTechTC", "PrtMediaPathTypeTC", "PrtOutputTypeTC", "PrtInterpreterLangFamilyTC", "PrtCoverStatusTC", "PrtAlertCodeTC", "PrtGeneralResetTC", "PrtInputTypeTC", "PrtAlertTrainingLevelTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtGeneralEntry=prtGeneralEntry, prtOutputStatus=prtOutputStatus, prtGeneralServicePerson=prtGeneralServicePerson, prtGeneralPrinterName=prtGeneralPrinterName, prtMarker=prtMarker, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtGeneralTable=prtGeneralTable, prtMarkerTable=prtMarkerTable, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInputType=prtInputType, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtLocalizationIndex=prtLocalizationIndex, prtInputMediaGroup=prtInputMediaGroup, prtInputMediaType=prtInputMediaType, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtAlertEntry=prtAlertEntry, prtConsoleLightTable=prtConsoleLightTable, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerStatus=prtMarkerStatus, prtChannelProtocolVersion=prtChannelProtocolVersion, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMarkerColorantTonality=prtMarkerColorantTonality, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerNorthMargin=prtMarkerNorthMargin, prtGeneralGroup=prtGeneralGroup, prtOutputIndex=prtOutputIndex, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInputNextIndex=prtInputNextIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtStorageRefIndex=prtStorageRefIndex, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtChannelGroup=prtChannelGroup, prtOutputSerialNumber=prtOutputSerialNumber, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtConsoleLightEntry=prtConsoleLightEntry, prtInputSecurity=prtInputSecurity, prtOutputName=prtOutputName, prtMarkerColorant=prtMarkerColorant, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtDeviceRefTable=prtDeviceRefTable, prtInputCapacityUnit=prtInputCapacityUnit, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInputStatus=prtInputStatus, prtChannelIndex=prtChannelIndex, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtAlert=prtAlert, prtOutputSecurity=prtOutputSecurity, prtMarkerSuppliesTable=prtMarkerSuppliesTable, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMarkerGroup=prtMarkerGroup, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtGeneral=prtGeneral, prtOutputBursting=prtOutputBursting, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMIB2Compliance=prtMIB2Compliance, prtAlertCode=prtAlertCode, prtInterpreter=prtInterpreter, prtConsoleColor=prtConsoleColor, prtStorageRefTable=prtStorageRefTable, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtGeneralV2Group=prtGeneralV2Group, prtConsoleLights=prtConsoleLights, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtMIBConformance=prtMIBConformance, prtMediaPathDescription=prtMediaPathDescription, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerColorantEntry=prtMarkerColorantEntry, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, printerV2AlertPrefix=printerV2AlertPrefix, PrtMediaUnitTC=PrtMediaUnitTC, prtMIBCompliance=prtMIBCompliance, prtExtendedOutputGroup=prtExtendedOutputGroup, prtOutputEntry=prtOutputEntry, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputMediaWeight=prtInputMediaWeight, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputEntry=prtInputEntry, prtMediaPathGroup=prtMediaPathGroup, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInterpreterDescription=prtInterpreterDescription, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInputModel=prtInputModel, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerColorantValue=prtMarkerColorantValue, prtChannelTable=prtChannelTable, prtMarkerEastMargin=prtMarkerEastMargin, prtCoverIndex=prtCoverIndex, prtInputSerialNumber=prtInputSerialNumber, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtAlertIndex=prtAlertIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtOutputPageCollated=prtOutputPageCollated, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtExtendedInputGroup=prtExtendedInputGroup, prtInputDescription=prtInputDescription, prtInputDimUnit=prtInputDimUnit, prtInputTable=prtInputTable, printerV1Alert=printerV1Alert, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInputIndex=prtInputIndex, SubUnitStatus=SubUnitStatus, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtAlertTableGroup=prtAlertTableGroup, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInput=prtInput, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerIndex=prtMarkerIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerColorantTable=prtMarkerColorantTable, prtDeviceRefEntry=prtDeviceRefEntry, prtMediaPathType=prtMediaPathType, prtChannelIfIndex=prtChannelIfIndex, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInterpreterEntry=prtInterpreterEntry, prtAlertSeverityLevel=prtAlertSeverityLevel, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMediaPathIndex=prtMediaPathIndex, prtOutputGroup=prtOutputGroup, prtInterpreterIndex=prtInterpreterIndex, prtInterpreterTable=prtInterpreterTable, prtChannelInformation=prtChannelInformation, prtGeneralSerialNumber=prtGeneralSerialNumber, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtConsoleGroup=prtConsoleGroup, prtMIBGroups=prtMIBGroups, PYSNMP_MODULE_ID=printmib, prtLocalizationLanguage=prtLocalizationLanguage, CodedCharSet=CodedCharSet, prtMediaPathTable=prtMediaPathTable, PresentOnOff=PresentOnOff, prtChannelEntry=prtChannelEntry, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtAlertAllEvents=prtAlertAllEvents, prtInputVersion=prtInputVersion, prtLocalizationEntry=prtLocalizationEntry, prtDeviceRefIndex=prtDeviceRefIndex, prtConsoleDescription=prtConsoleDescription, prtChannelV2Group=prtChannelV2Group, prtAlertLocation=prtAlertLocation, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtConsoleDisable=prtConsoleDisable, prtInterpreterGroup=prtInterpreterGroup, prtInputGroup=prtInputGroup, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerSouthMargin=prtMarkerSouthMargin, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtOutputDescription=prtOutputDescription, CapacityUnit=CapacityUnit, prtLocalization=prtLocalization, prtAlertTime=prtAlertTime, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, PrtChannelStateTC=PrtChannelStateTC, prtInputMediaColor=prtInputMediaColor, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtOutputDecollating=prtOutputDecollating, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerLifeCount=prtMarkerLifeCount, prtOutputTable=prtOutputTable, prtOutputModel=prtOutputModel, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtCoverEntry=prtCoverEntry, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtInterpreterLangLevel=prtInterpreterLangLevel, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMarkerEntry=prtMarkerEntry, prtCover=prtCover, prtStorageRefEntry=prtStorageRefEntry, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleLightIndex=prtConsoleLightIndex, prtOutputDimUnit=prtOutputDimUnit, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, printmib=printmib, prtAlertDescription=prtAlertDescription, prtGeneralReset=prtGeneralReset, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputVersion=prtOutputVersion, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, printerV2Alert=printerV2Alert, prtOutput=prtOutput, MediaUnit=MediaUnit, prtInputName=prtInputName, prtChannelState=prtChannelState, prtAlertTable=prtAlertTable, prtAlertTrainingLevel=prtAlertTrainingLevel, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtOutputVendorName=prtOutputVendorName, prtLocalizationCountry=prtLocalizationCountry, prtMarkerWestMargin=prtMarkerWestMargin, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerCounterUnit=prtMarkerCounterUnit, prtCoverTable=prtCoverTable, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMIB2Groups=prtMIB2Groups, prtMarkerMarkTech=prtMarkerMarkTech, prtInterpreterVersion=prtInterpreterVersion, prtConsoleOffTime=prtConsoleOffTime, prtAlertTimeGroup=prtAlertTimeGroup, prtChannel=prtChannel, prtConsoleOnTime=prtConsoleOnTime, prtOutputType=prtOutputType, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtAlertCriticalEvents=prtAlertCriticalEvents, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtInputMediaName=prtInputMediaName, prtCoverStatus=prtCoverStatus, prtOutputMaxCapacity=prtOutputMaxCapacity, prtLocalizationTable=prtLocalizationTable, prtInputVendorName=prtInputVendorName, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerSupplies=prtMarkerSupplies, prtMediaPath=prtMediaPath, prtAlertGroup=prtAlertGroup, prtAlertTableV2Group=prtAlertTableV2Group, prtCoverDescription=prtCoverDescription, prtMediaPathStatus=prtMediaPathStatus, prtChannelType=prtChannelType, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtChannelStatus=prtChannelStatus, prtConsoleLocalization=prtConsoleLocalization)
mibBuilder.exportSymbols("Printer-MIB", prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInputMaxCapacity=prtInputMaxCapacity, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMediaPathEntry=prtMediaPathEntry)
