...
PrtGeneralResetTC, PrtInputTypeTC, PrtConsoleColorTC, PrtMarkerSuppliesTypeTC, PrtAlertTrainingLevelTC, PrtAlertGroupTC, PrtConsoleDisableTC, PrtMediaPathTypeTC, PrtInterpreterLangFamilyTC, PrtOutputTypeTC, PrtAlertCodeTC, PrtChannelTypeTC, PrtCoverStatusTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtGeneralResetTC", "PrtInputTypeTC", "PrtConsoleColorTC", "PrtMarkerSuppliesTypeTC", "PrtAlertTrainingLevelTC", "PrtAlertGroupTC", "PrtConsoleDisableTC", "PrtMediaPathTypeTC", "PrtInterpreterLangFamilyTC", "PrtOutputTypeTC", "PrtAlertCodeTC", "PrtChannelTypeTC", "PrtCoverStatusTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", printerV2AlertPrefix=printerV2AlertPrefix, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, printerV2Alert=printerV2Alert, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputMediaColor=prtInputMediaColor, prtInputMaxCapacity=prtInputMaxCapacity, prtConsoleLights=prtConsoleLights, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMIBCompliance=prtMIBCompliance, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInputMediaGroup=prtInputMediaGroup, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtConsoleDisable=prtConsoleDisable, prtCoverEntry=prtCoverEntry, prtOutputVendorName=prtOutputVendorName, prtOutputMaxCapacity=prtOutputMaxCapacity, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInputMediaFormParts=prtInputMediaFormParts, prtConsoleGroup=prtConsoleGroup, prtInputMediaName=prtInputMediaName, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtAlertTimeGroup=prtAlertTimeGroup, prtAlertCode=prtAlertCode, prtAlertSeverityLevel=prtAlertSeverityLevel, prtDeviceRefEntry=prtDeviceRefEntry, prtGeneralSerialNumber=prtGeneralSerialNumber, prtAlertTrainingLevel=prtAlertTrainingLevel, prtInputCurrentLevel=prtInputCurrentLevel, prtChannelV2Group=prtChannelV2Group, prtMarker=prtMarker, prtOutputSecurity=prtOutputSecurity, prtOutputEntry=prtOutputEntry, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerColorantGroup=prtMarkerColorantGroup, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInputSerialNumber=prtInputSerialNumber, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInterpreter=prtInterpreter, prtAlertIndex=prtAlertIndex, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtStorageRefTable=prtStorageRefTable, prtInputSwitchingGroup=prtInputSwitchingGroup, prtConsoleLightIndex=prtConsoleLightIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtGeneralReset=prtGeneralReset, prtMarkerColorantValue=prtMarkerColorantValue, prtMediaPath=prtMediaPath, prtMarkerEastMargin=prtMarkerEastMargin, prtOutputModel=prtOutputModel, prtGeneralServicePerson=prtGeneralServicePerson, prtDeviceRefTable=prtDeviceRefTable, prtMediaPathDescription=prtMediaPathDescription, PresentOnOff=PresentOnOff, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtOutputBursting=prtOutputBursting, prtInput=prtInput, prtMarkerColorantTonality=prtMarkerColorantTonality, prtOutputType=prtOutputType, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerIndex=prtMarkerIndex, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtChannelEntry=prtChannelEntry, prtChannelInformation=prtChannelInformation, prtInterpreterEntry=prtInterpreterEntry, prtLocalizationTable=prtLocalizationTable, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtGeneralTable=prtGeneralTable, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInputCapacityUnit=prtInputCapacityUnit, prtOutputOffsetStacking=prtOutputOffsetStacking, prtConsoleOnTime=prtConsoleOnTime, prtAlert=prtAlert, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputVersion=prtInputVersion, prtInputModel=prtInputModel, prtGeneral=prtGeneral, prtExtendedInputGroup=prtExtendedInputGroup, prtLocalizationCountry=prtLocalizationCountry, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtOutputDescription=prtOutputDescription, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerColorant=prtMarkerColorant, prtDeviceRefIndex=prtDeviceRefIndex, prtInterpreterDescription=prtInterpreterDescription, prtOutputName=prtOutputName, prtLocalizationCharacterSet=prtLocalizationCharacterSet, PrtChannelStateTC=PrtChannelStateTC, prtCoverTable=prtCoverTable, prtAlertCriticalEvents=prtAlertCriticalEvents, prtChannelGroup=prtChannelGroup, prtAlertTableGroup=prtAlertTableGroup, prtLocalization=prtLocalization, prtMarkerEntry=prtMarkerEntry, prtCoverStatus=prtCoverStatus, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputNextIndex=prtInputNextIndex, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputEntry=prtInputEntry, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtConsoleDescription=prtConsoleDescription, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtChannelProtocolVersion=prtChannelProtocolVersion, prtConsoleOffTime=prtConsoleOffTime, CodedCharSet=CodedCharSet, prtOutputSerialNumber=prtOutputSerialNumber, prtAlertDescription=prtAlertDescription, PYSNMP_MODULE_ID=printmib, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInterpreterTwoWay=prtInterpreterTwoWay, SubUnitStatus=SubUnitStatus, prtMediaPathStatus=prtMediaPathStatus, prtOutputDecollating=prtOutputDecollating, prtMarkerNorthMargin=prtMarkerNorthMargin, prtOutputPageCollated=prtOutputPageCollated, prtInputDimUnit=prtInputDimUnit, prtAlertGroupIndex=prtAlertGroupIndex, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtAlertLocation=prtAlertLocation, prtMediaPathEntry=prtMediaPathEntry, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtGeneralGroup=prtGeneralGroup, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtLocalizationIndex=prtLocalizationIndex, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtChannelTable=prtChannelTable, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtOutput=prtOutput, prtMarkerMarkTech=prtMarkerMarkTech, prtChannelStatus=prtChannelStatus, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInterpreterVersion=prtInterpreterVersion, prtInterpreterIndex=prtInterpreterIndex, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputGroup=prtInputGroup, PrtCapacityUnitTC=PrtCapacityUnitTC, prtOutputGroup=prtOutputGroup, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtAlertAllEvents=prtAlertAllEvents, prtMIBGroups=prtMIBGroups, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtOutputTable=prtOutputTable, prtGeneralV2Group=prtGeneralV2Group, prtMarkerTable=prtMarkerTable, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtConsoleLightTable=prtConsoleLightTable, prtMediaPathGroup=prtMediaPathGroup, prtStorageRefIndex=prtStorageRefIndex, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtOutputStatus=prtOutputStatus, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtOutputIndex=prtOutputIndex, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInterpreterTable=prtInterpreterTable, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtGeneralEntry=prtGeneralEntry, prtCoverDescription=prtCoverDescription, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInputName=prtInputName, prtConsoleLightEntry=prtConsoleLightEntry, prtChannelIfIndex=prtChannelIfIndex, prtMIBConformance=prtMIBConformance, prtMIB2Groups=prtMIB2Groups, prtAlertTable=prtAlertTable, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, printmib=printmib, prtAlertTableV2Group=prtAlertTableV2Group, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, printerV1Alert=printerV1Alert, prtMediaPathIndex=prtMediaPathIndex, prtOutputStackingOrder=prtOutputStackingOrder, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInterpreterGroup=prtInterpreterGroup, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMarkerLifeCount=prtMarkerLifeCount, prtCoverIndex=prtCoverIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMIB2Compliance=prtMIB2Compliance, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerWestMargin=prtMarkerWestMargin, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMediaPathTable=prtMediaPathTable, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtStorageRefEntry=prtStorageRefEntry, prtInputTable=prtInputTable, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, MediaUnit=MediaUnit, CapacityUnit=CapacityUnit, prtInputStatus=prtInputStatus, prtOutputVersion=prtOutputVersion, prtLocalizationEntry=prtLocalizationEntry, prtInputSecurity=prtInputSecurity, prtMarkerStatus=prtMarkerStatus, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerGroup=prtMarkerGroup, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtAlertGroup=prtAlertGroup, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlertTrapGroup=prtAlertTrapGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtInputType=prtInputType, PrtMediaUnitTC=PrtMediaUnitTC, prtInputDescription=prtInputDescription, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtConsoleColor=prtConsoleColor, prtAlertEntry=prtAlertEntry, prtInputIndex=prtInputIndex, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMediaPathType=prtMediaPathType, prtInputMediaWeight=prtInputMediaWeight, prtChannelType=prtChannelType, prtOutputDimUnit=prtOutputDimUnit, prtChannelIndex=prtChannelIndex, prtMarkerColorantIndex=prtMarkerColorantIndex, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerSouthMargin=prtMarkerSouthMargin, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtCover=prtCover, prtChannelState=prtChannelState, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputVendorName=prtInputVendorName, prtMarkerSupplies=prtMarkerSupplies, prtAlertTime=prtAlertTime)
mibBuilder.exportSymbols("Printer-MIB", prtConsoleLocalization=prtConsoleLocalization, prtChannel=prtChannel, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputMediaType=prtInputMediaType)
