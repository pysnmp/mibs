...
PrtInputTypeTC, PrtAlertGroupTC, PrtAlertCodeTC, PrtAlertTrainingLevelTC, PrtOutputTypeTC, PrtMarkerMarkTechTC, PrtMarkerSuppliesTypeTC, PrtMediaPathTypeTC, PrtInterpreterLangFamilyTC, PrtConsoleDisableTC, PrtCoverStatusTC, PrtChannelTypeTC, PrtGeneralResetTC, PrtConsoleColorTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInputTypeTC", "PrtAlertGroupTC", "PrtAlertCodeTC", "PrtAlertTrainingLevelTC", "PrtOutputTypeTC", "PrtMarkerMarkTechTC", "PrtMarkerSuppliesTypeTC", "PrtMediaPathTypeTC", "PrtInterpreterLangFamilyTC", "PrtConsoleDisableTC", "PrtCoverStatusTC", "PrtChannelTypeTC", "PrtGeneralResetTC", "PrtConsoleColorTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtConsoleLightTable=prtConsoleLightTable, prtInputDescription=prtInputDescription, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMarkerIndex=prtMarkerIndex, prtStorageRefIndex=prtStorageRefIndex, prtInputSecurity=prtInputSecurity, prtDeviceRefTable=prtDeviceRefTable, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMediaPathIndex=prtMediaPathIndex, prtConsoleDescription=prtConsoleDescription, prtLocalizationIndex=prtLocalizationIndex, prtMarkerSuppliesTable=prtMarkerSuppliesTable, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMediaPathEntry=prtMediaPathEntry, prtConsoleColor=prtConsoleColor, prtInputSerialNumber=prtInputSerialNumber, prtChannelInformation=prtChannelInformation, prtInputMediaGroup=prtInputMediaGroup, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtOutputIndex=prtOutputIndex, prtMarkerTable=prtMarkerTable, prtLocalizationEntry=prtLocalizationEntry, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtCoverStatus=prtCoverStatus, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputMediaColor=prtInputMediaColor, prtMarker=prtMarker, prtMediaPathDescription=prtMediaPathDescription, prtMIB2Compliance=prtMIB2Compliance, prtInterpreterDescription=prtInterpreterDescription, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtCoverTable=prtCoverTable, prtMIBConformance=prtMIBConformance, prtGeneralConfigChanges=prtGeneralConfigChanges, PrtMediaUnitTC=PrtMediaUnitTC, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMIBGroups=prtMIBGroups, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtGeneralReset=prtGeneralReset, prtOutputDescription=prtOutputDescription, prtMediaPathGroup=prtMediaPathGroup, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtOutputVersion=prtOutputVersion, prtInterpreterLangVersion=prtInterpreterLangVersion, prtOutputGroup=prtOutputGroup, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtAlertTimeGroup=prtAlertTimeGroup, prtAlertTime=prtAlertTime, prtInputModel=prtInputModel, prtInputCurrentLevel=prtInputCurrentLevel, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtConsoleLightIndex=prtConsoleLightIndex, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInputDimUnit=prtInputDimUnit, prtMarkerColorantTonality=prtMarkerColorantTonality, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerSpotColorants=prtMarkerSpotColorants, prtLocalizationCountry=prtLocalizationCountry, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputMediaType=prtInputMediaType, CapacityUnit=CapacityUnit, PrtChannelStateTC=PrtChannelStateTC, prtMarkerNorthMargin=prtMarkerNorthMargin, prtCoverEntry=prtCoverEntry, prtDeviceRefEntry=prtDeviceRefEntry, prtMediaPathType=prtMediaPathType, prtAlertTable=prtAlertTable, prtLocalization=prtLocalization, prtAlertGroupIndex=prtAlertGroupIndex, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtGeneral=prtGeneral, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputPageCollated=prtOutputPageCollated, MediaUnit=MediaUnit, prtDeviceRefIndex=prtDeviceRefIndex, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInterpreterEntry=prtInterpreterEntry, prtMarkerColorantEntry=prtMarkerColorantEntry, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMediaPathStatus=prtMediaPathStatus, prtOutputTable=prtOutputTable, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInterpreterIndex=prtInterpreterIndex, prtMarkerColorant=prtMarkerColorant, prtAlertTableGroup=prtAlertTableGroup, prtInputVendorName=prtInputVendorName, prtOutputSecurity=prtOutputSecurity, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInterpreterVersion=prtInterpreterVersion, prtConsoleOnTime=prtConsoleOnTime, prtOutputMaxCapacity=prtOutputMaxCapacity, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtConsoleLightEntry=prtConsoleLightEntry, PYSNMP_MODULE_ID=printmib, prtOutput=prtOutput, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputType=prtOutputType, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtOutputEntry=prtOutputEntry, prtInterpreterTwoWay=prtInterpreterTwoWay, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtChannelEntry=prtChannelEntry, prtInputGroup=prtInputGroup, prtAlertCode=prtAlertCode, prtInputDefaultIndex=prtInputDefaultIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputBursting=prtOutputBursting, prtGeneralGroup=prtGeneralGroup, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerColorantTable=prtMarkerColorantTable, prtInterpreterTable=prtInterpreterTable, prtConsoleOffTime=prtConsoleOffTime, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, SubUnitStatus=SubUnitStatus, prtMarkerColorantRole=prtMarkerColorantRole, prtInputType=prtInputType, prtMarkerSupplies=prtMarkerSupplies, prtConsoleGroup=prtConsoleGroup, prtInputMaxCapacity=prtInputMaxCapacity, prtAlertEntry=prtAlertEntry, printmib=printmib, prtOutputVendorName=prtOutputVendorName, prtMarkerColorantValue=prtMarkerColorantValue, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtOutputOffsetStacking=prtOutputOffsetStacking, prtChannelStatus=prtChannelStatus, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputModel=prtOutputModel, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtInterpreterLangLevel=prtInterpreterLangLevel, CodedCharSet=CodedCharSet, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInterpreter=prtInterpreter, prtMediaPathTable=prtMediaPathTable, prtExtendedInputGroup=prtExtendedInputGroup, prtMarkerColorantGroup=prtMarkerColorantGroup, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMIBCompliance=prtMIBCompliance, prtAlertDescription=prtAlertDescription, prtChannelType=prtChannelType, prtCoverIndex=prtCoverIndex, printerV2Alert=printerV2Alert, prtChannelIfIndex=prtChannelIfIndex, prtAlertIndex=prtAlertIndex, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtAlertTrapGroup=prtAlertTrapGroup, prtStorageRefTable=prtStorageRefTable, prtMarkerLifeCount=prtMarkerLifeCount, prtExtendedOutputGroup=prtExtendedOutputGroup, printerV2AlertPrefix=printerV2AlertPrefix, prtMediaPath=prtMediaPath, prtOutputName=prtOutputName, prtStorageRefEntry=prtStorageRefEntry, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInputTable=prtInputTable, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtChannel=prtChannel, prtInputNextIndex=prtInputNextIndex, prtInputMediaName=prtInputMediaName, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMarkerWestMargin=prtMarkerWestMargin, prtInputStatus=prtInputStatus, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputDimUnit=prtOutputDimUnit, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputDecollating=prtOutputDecollating, prtMarkerStatus=prtMarkerStatus, prtGeneralTable=prtGeneralTable, prtMarkerProcessColorants=prtMarkerProcessColorants, prtChannelGroup=prtChannelGroup, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtAlert=prtAlert, PresentOnOff=PresentOnOff, prtMarkerColorantIndex=prtMarkerColorantIndex, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelIndex=prtChannelIndex, prtInterpreterGroup=prtInterpreterGroup, prtChannelState=prtChannelState, prtAlertAllEvents=prtAlertAllEvents, prtInputMediaWeight=prtInputMediaWeight, prtOutputCapacityUnit=prtOutputCapacityUnit, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMIB2Groups=prtMIB2Groups, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInputEntry=prtInputEntry, prtConsoleLights=prtConsoleLights, prtOutputSerialNumber=prtOutputSerialNumber, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtCoverDescription=prtCoverDescription, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInput=prtInput, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtGeneralV2Group=prtGeneralV2Group, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtConsoleLocalization=prtConsoleLocalization, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, printerV1Alert=printerV1Alert, prtChannelV2Group=prtChannelV2Group, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInputIndex=prtInputIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMediaFormParts=prtInputMediaFormParts, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtAlertLocation=prtAlertLocation, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtChannelTable=prtChannelTable, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMarkerEntry=prtMarkerEntry, prtInputVersion=prtInputVersion, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerGroup=prtMarkerGroup, prtInputName=prtInputName, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtAlertGroup=prtAlertGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInputCapacityUnit=prtInputCapacityUnit, prtGeneralEntry=prtGeneralEntry, prtLocalizationTable=prtLocalizationTable, prtMarkerMarkTech=prtMarkerMarkTech, prtOutputStatus=prtOutputStatus)
mibBuilder.exportSymbols("Printer-MIB", prtCover=prtCover, prtConsoleDisable=prtConsoleDisable, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir)
