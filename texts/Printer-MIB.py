...
PrtConsoleDisableTC, PrtConsoleColorTC, PrtOutputTypeTC, PrtAlertCodeTC, PrtMarkerMarkTechTC, PrtMediaPathTypeTC, PrtAlertTrainingLevelTC, PrtInterpreterLangFamilyTC, PrtChannelTypeTC, PrtAlertGroupTC, PrtInputTypeTC, PrtCoverStatusTC, PrtGeneralResetTC, PrtMarkerSuppliesTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleDisableTC", "PrtConsoleColorTC", "PrtOutputTypeTC", "PrtAlertCodeTC", "PrtMarkerMarkTechTC", "PrtMediaPathTypeTC", "PrtAlertTrainingLevelTC", "PrtInterpreterLangFamilyTC", "PrtChannelTypeTC", "PrtAlertGroupTC", "PrtInputTypeTC", "PrtCoverStatusTC", "PrtGeneralResetTC", "PrtMarkerSuppliesTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtLocalizationIndex=prtLocalizationIndex, prtChannelIfIndex=prtChannelIfIndex, PYSNMP_MODULE_ID=printmib, prtMediaPathDescription=prtMediaPathDescription, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputGroup=prtInputGroup, prtChannelState=prtChannelState, prtGeneralEntry=prtGeneralEntry, prtCoverDescription=prtCoverDescription, prtMIBConformance=prtMIBConformance, prtMarkerColorantEntry=prtMarkerColorantEntry, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtAlertEntry=prtAlertEntry, prtInputMediaGroup=prtInputMediaGroup, prtMediaPathGroup=prtMediaPathGroup, prtMIB2Groups=prtMIB2Groups, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtChannelType=prtChannelType, prtMarkerGroup=prtMarkerGroup, prtGeneralReset=prtGeneralReset, prtConsoleLights=prtConsoleLights, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMIBCompliance=prtMIBCompliance, prtAlertTime=prtAlertTime, prtOutputDescription=prtOutputDescription, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtChannelIndex=prtChannelIndex, prtInputStatus=prtInputStatus, prtCover=prtCover, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtConsoleColor=prtConsoleColor, prtMarkerColorantGroup=prtMarkerColorantGroup, prtDeviceRefIndex=prtDeviceRefIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtGeneralServicePerson=prtGeneralServicePerson, prtGeneralGroup=prtGeneralGroup, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInterpreterIndex=prtInterpreterIndex, prtAlertIndex=prtAlertIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertLocation=prtAlertLocation, prtInterpreterLangFamily=prtInterpreterLangFamily, prtOutputVendorName=prtOutputVendorName, prtAlertCode=prtAlertCode, prtLocalizationEntry=prtLocalizationEntry, prtOutputDefaultIndex=prtOutputDefaultIndex, prtAlertTableV2Group=prtAlertTableV2Group, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMarkerSuppliesType=prtMarkerSuppliesType, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInterpreterEntry=prtInterpreterEntry, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtAlertTableGroup=prtAlertTableGroup, prtOutputMaxCapacity=prtOutputMaxCapacity, prtInputMediaFormParts=prtInputMediaFormParts, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMarkerColorantRole=prtMarkerColorantRole, prtConsoleDisable=prtConsoleDisable, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtCoverIndex=prtCoverIndex, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerStatus=prtMarkerStatus, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInputDimUnit=prtInputDimUnit, prtAlertDescription=prtAlertDescription, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutputDimUnit=prtOutputDimUnit, prtMediaPathIndex=prtMediaPathIndex, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtGeneralTable=prtGeneralTable, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtOutputPageCollated=prtOutputPageCollated, prtOutputTable=prtOutputTable, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInputModel=prtInputModel, prtOutputStatus=prtOutputStatus, prtMarkerColorantTonality=prtMarkerColorantTonality, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, MediaUnit=MediaUnit, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtConsoleLightTable=prtConsoleLightTable, prtLocalizationTable=prtLocalizationTable, prtInputIndex=prtInputIndex, prtInputMediaName=prtInputMediaName, prtInputDescription=prtInputDescription, PrtChannelStateTC=PrtChannelStateTC, prtOutput=prtOutput, prtConsoleDescription=prtConsoleDescription, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInputNextIndex=prtInputNextIndex, prtMarkerNorthMargin=prtMarkerNorthMargin, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, PrtMediaUnitTC=PrtMediaUnitTC, prtGeneralPrinterName=prtGeneralPrinterName, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtOutputIndex=prtOutputIndex, printmib=printmib, printerV2Alert=printerV2Alert, prtMarkerColorantTable=prtMarkerColorantTable, prtConsoleLightEntry=prtConsoleLightEntry, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtGeneralV2Group=prtGeneralV2Group, prtConsoleLightIndex=prtConsoleLightIndex, prtLocalizationCountry=prtLocalizationCountry, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, SubUnitStatus=SubUnitStatus, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, PrtCapacityUnitTC=PrtCapacityUnitTC, prtCoverStatus=prtCoverStatus, prtInputEntry=prtInputEntry, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtOutputGroup=prtOutputGroup, prtOutputOffsetStacking=prtOutputOffsetStacking, prtOutputSerialNumber=prtOutputSerialNumber, prtMediaPathEntry=prtMediaPathEntry, PresentOnOff=PresentOnOff, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMarkerEastMargin=prtMarkerEastMargin, prtInputCapacityUnit=prtInputCapacityUnit, prtChannelV2Group=prtChannelV2Group, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputMediaColor=prtInputMediaColor, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputVendorName=prtInputVendorName, prtInputSecurity=prtInputSecurity, prtMarkerTable=prtMarkerTable, prtInput=prtInput, prtMarkerMarkTech=prtMarkerMarkTech, prtInterpreterVersion=prtInterpreterVersion, prtExtendedInputGroup=prtExtendedInputGroup, prtInterpreterGroup=prtInterpreterGroup, prtStorageRefTable=prtStorageRefTable, prtOutputModel=prtOutputModel, prtGeneralSerialNumber=prtGeneralSerialNumber, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerColorantIndex=prtMarkerColorantIndex, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMarkerColorantValue=prtMarkerColorantValue, prtDeviceRefTable=prtDeviceRefTable, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtAlertGroup=prtAlertGroup, PrtPrintOrientationTC=PrtPrintOrientationTC, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtAlertAllEvents=prtAlertAllEvents, prtConsoleOnTime=prtConsoleOnTime, prtConsoleLocalization=prtConsoleLocalization, prtMIBGroups=prtMIBGroups, prtAlert=prtAlert, prtInputName=prtInputName, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtCoverEntry=prtCoverEntry, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtOutputDecollating=prtOutputDecollating, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerWestMargin=prtMarkerWestMargin, prtInputVersion=prtInputVersion, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerColorant=prtMarkerColorant, prtOutputCapacityUnit=prtOutputCapacityUnit, prtAlertGroupIndex=prtAlertGroupIndex, printerV1Alert=printerV1Alert, prtInterpreter=prtInterpreter, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMediaPathTable=prtMediaPathTable, prtDeviceRefEntry=prtDeviceRefEntry, prtInputTable=prtInputTable, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInputSerialNumber=prtInputSerialNumber, prtMarkerEntry=prtMarkerEntry, prtMediaPath=prtMediaPath, printerV2AlertPrefix=printerV2AlertPrefix, prtExtendedOutputGroup=prtExtendedOutputGroup, prtOutputType=prtOutputType, prtMIB2Compliance=prtMIB2Compliance, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtAlertTrainingLevel=prtAlertTrainingLevel, prtOutputVersion=prtOutputVersion, prtOutputSecurity=prtOutputSecurity, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerSupplies=prtMarkerSupplies, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, CapacityUnit=CapacityUnit, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtStorageRefEntry=prtStorageRefEntry, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtGeneral=prtGeneral, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMediaPathType=prtMediaPathType, prtOutputName=prtOutputName, prtAlertCriticalEvents=prtAlertCriticalEvents, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtStorageRefIndex=prtStorageRefIndex, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtChannelProtocolVersion=prtChannelProtocolVersion, prtConsoleOffTime=prtConsoleOffTime, prtInputType=prtInputType, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtChannelEntry=prtChannelEntry, prtOutputBursting=prtOutputBursting, prtInterpreterDescription=prtInterpreterDescription, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputSwitchingGroup=prtInputSwitchingGroup, prtAlertSeverityLevel=prtAlertSeverityLevel, prtChannelStatus=prtChannelStatus, prtChannelGroup=prtChannelGroup, CodedCharSet=CodedCharSet, prtAlertTable=prtAlertTable, prtChannel=prtChannel, prtLocalization=prtLocalization, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtCoverTable=prtCoverTable, prtInputMediaWeight=prtInputMediaWeight, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMarkerLifeCount=prtMarkerLifeCount, prtAlertTrapGroup=prtAlertTrapGroup, prtInterpreterTable=prtInterpreterTable, prtMarkerIndex=prtMarkerIndex, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtChannelTable=prtChannelTable, prtInputMaxCapacity=prtInputMaxCapacity, prtAlertTimeGroup=prtAlertTimeGroup, prtOutputEntry=prtOutputEntry, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMarker=prtMarker, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMediaPathStatus=prtMediaPathStatus, prtChannelInformation=prtChannelInformation, prtConsoleGroup=prtConsoleGroup, prtInputDefaultIndex=prtInputDefaultIndex)
mibBuilder.exportSymbols("Printer-MIB", prtInterpreterTwoWay=prtInterpreterTwoWay, prtInputMediaType=prtInputMediaType, prtInputCurrentLevel=prtInputCurrentLevel, prtLocalizationCharacterSet=prtLocalizationCharacterSet)
