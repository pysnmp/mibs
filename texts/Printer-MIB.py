...
PrtAlertTrainingLevelTC, PrtAlertCodeTC, PrtChannelTypeTC, PrtConsoleDisableTC, PrtMediaPathTypeTC, PrtGeneralResetTC, PrtInterpreterLangFamilyTC, PrtConsoleColorTC, PrtMarkerMarkTechTC, PrtMarkerSuppliesTypeTC, PrtAlertGroupTC, PrtCoverStatusTC, PrtInputTypeTC, PrtOutputTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertTrainingLevelTC", "PrtAlertCodeTC", "PrtChannelTypeTC", "PrtConsoleDisableTC", "PrtMediaPathTypeTC", "PrtGeneralResetTC", "PrtInterpreterLangFamilyTC", "PrtConsoleColorTC", "PrtMarkerMarkTechTC", "PrtMarkerSuppliesTypeTC", "PrtAlertGroupTC", "PrtCoverStatusTC", "PrtInputTypeTC", "PrtOutputTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputModel=prtOutputModel, prtInputTable=prtInputTable, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMarkerEntry=prtMarkerEntry, prtCoverStatus=prtCoverStatus, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtChannelV2Group=prtChannelV2Group, prtLocalizationCountry=prtLocalizationCountry, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtAlertLocation=prtAlertLocation, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, CapacityUnit=CapacityUnit, prtInterpreterVersion=prtInterpreterVersion, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputMediaFormParts=prtInputMediaFormParts, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtChannelIfIndex=prtChannelIfIndex, prtExtendedInputGroup=prtExtendedInputGroup, prtStorageRefEntry=prtStorageRefEntry, prtAlertTableGroup=prtAlertTableGroup, prtMarkerSupplies=prtMarkerSupplies, prtInterpreterLangFamily=prtInterpreterLangFamily, prtOutputCapacityUnit=prtOutputCapacityUnit, prtLocalizationIndex=prtLocalizationIndex, prtOutput=prtOutput, prtMediaPathEntry=prtMediaPathEntry, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtCoverEntry=prtCoverEntry, prtInterpreter=prtInterpreter, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputName=prtOutputName, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtGeneralReset=prtGeneralReset, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtConsoleLocalization=prtConsoleLocalization, prtInputSerialNumber=prtInputSerialNumber, prtInterpreterEntry=prtInterpreterEntry, prtStorageRefIndex=prtStorageRefIndex, prtMarkerLifeCount=prtMarkerLifeCount, prtAlertIndex=prtAlertIndex, prtAlertTime=prtAlertTime, prtGeneralGroup=prtGeneralGroup, prtOutputDefaultIndex=prtOutputDefaultIndex, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtAlertTrapGroup=prtAlertTrapGroup, PresentOnOff=PresentOnOff, prtConsoleColor=prtConsoleColor, prtMarkerProcessColorants=prtMarkerProcessColorants, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputCapacityUnit=prtInputCapacityUnit, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtAlertDescription=prtAlertDescription, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtGeneralEntry=prtGeneralEntry, prtOutputBursting=prtOutputBursting, prtInputMediaGroup=prtInputMediaGroup, prtCoverIndex=prtCoverIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInputMaxCapacity=prtInputMaxCapacity, prtChannelInformation=prtChannelInformation, prtOutputDescription=prtOutputDescription, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMediaPathTable=prtMediaPathTable, prtInputSecurity=prtInputSecurity, prtOutputMaxCapacity=prtOutputMaxCapacity, prtConsoleDisable=prtConsoleDisable, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtGeneralPrinterName=prtGeneralPrinterName, prtInputEntry=prtInputEntry, prtMarkerColorantEntry=prtMarkerColorantEntry, prtInterpreterTable=prtInterpreterTable, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, printerV2AlertPrefix=printerV2AlertPrefix, prtMediaPathDescription=prtMediaPathDescription, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtOutputType=prtOutputType, prtMediaPathIndex=prtMediaPathIndex, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, PYSNMP_MODULE_ID=printmib, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtChannelEntry=prtChannelEntry, prtMarkerEastMargin=prtMarkerEastMargin, prtMIBCompliance=prtMIBCompliance, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtCover=prtCover, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputType=prtInputType, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarker=prtMarker, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtInputStatus=prtInputStatus, prtChannelTable=prtChannelTable, PrtChannelStateTC=PrtChannelStateTC, prtInputDescription=prtInputDescription, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtAlert=prtAlert, prtMIB2Compliance=prtMIB2Compliance, prtInputVendorName=prtInputVendorName, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtDeviceRefIndex=prtDeviceRefIndex, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtOutputSerialNumber=prtOutputSerialNumber, prtInputMediaType=prtInputMediaType, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtConsoleOnTime=prtConsoleOnTime, prtChannelType=prtChannelType, prtConsoleLightTable=prtConsoleLightTable, prtInputGroup=prtInputGroup, prtInterpreterLangVersion=prtInterpreterLangVersion, prtChannelIndex=prtChannelIndex, SubUnitStatus=SubUnitStatus, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMIB2Groups=prtMIB2Groups, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInput=prtInput, prtAlertGroupIndex=prtAlertGroupIndex, prtStorageRefTable=prtStorageRefTable, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, printerV2Alert=printerV2Alert, prtInterpreterGroup=prtInterpreterGroup, prtChannel=prtChannel, prtConsoleGroup=prtConsoleGroup, prtInputDimUnit=prtInputDimUnit, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerColorantValue=prtMarkerColorantValue, prtLocalizationTable=prtLocalizationTable, prtMediaPathType=prtMediaPathType, prtChannelStatus=prtChannelStatus, prtMarkerColorantTable=prtMarkerColorantTable, prtOutputEntry=prtOutputEntry, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtConsoleDescription=prtConsoleDescription, prtInputMediaColor=prtInputMediaColor, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtCoverDescription=prtCoverDescription, prtAlertCriticalEvents=prtAlertCriticalEvents, prtAlertTable=prtAlertTable, prtMarkerSpotColorants=prtMarkerSpotColorants, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtConsoleLightEntry=prtConsoleLightEntry, prtGeneralTable=prtGeneralTable, MediaUnit=MediaUnit, prtDeviceRefTable=prtDeviceRefTable, prtInputIndex=prtInputIndex, prtOutputTable=prtOutputTable, prtInterpreterLangLevel=prtInterpreterLangLevel, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerSuppliesTable=prtMarkerSuppliesTable, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerTable=prtMarkerTable, prtAlertTrainingLevel=prtAlertTrainingLevel, prtGeneralServicePerson=prtGeneralServicePerson, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMarkerGroup=prtMarkerGroup, prtMarkerWestMargin=prtMarkerWestMargin, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputDefaultIndex=prtInputDefaultIndex, prtInputCurrentLevel=prtInputCurrentLevel, prtInputName=prtInputName, prtCoverTable=prtCoverTable, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMIBConformance=prtMIBConformance, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputNextIndex=prtInputNextIndex, prtInputMediaWeight=prtInputMediaWeight, prtOutputSecurity=prtOutputSecurity, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMediaPath=prtMediaPath, prtOutputDimUnit=prtOutputDimUnit, prtConsoleLights=prtConsoleLights, prtAlertEntry=prtAlertEntry, PrtCapacityUnitTC=PrtCapacityUnitTC, prtOutputVendorName=prtOutputVendorName, prtOutputGroup=prtOutputGroup, CodedCharSet=CodedCharSet, printerV1Alert=printerV1Alert, prtAlertGroup=prtAlertGroup, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtAlertCode=prtAlertCode, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtConsoleOffTime=prtConsoleOffTime, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtDeviceRefEntry=prtDeviceRefEntry, prtAlertSeverityLevel=prtAlertSeverityLevel, prtLocalizationEntry=prtLocalizationEntry, prtMediaPathGroup=prtMediaPathGroup, prtLocalization=prtLocalization, prtInterpreterIndex=prtInterpreterIndex, prtMediaPathStatus=prtMediaPathStatus, prtMIBGroups=prtMIBGroups, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMarkerIndex=prtMarkerIndex, prtMarkerColorant=prtMarkerColorant, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtOutputPageCollated=prtOutputPageCollated, prtExtendedOutputGroup=prtExtendedOutputGroup, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMarkerStatus=prtMarkerStatus, prtGeneral=prtGeneral, prtMarkerColorantTonality=prtMarkerColorantTonality, prtOutputDecollating=prtOutputDecollating, prtOutputVersion=prtOutputVersion, printmib=printmib, prtConsoleLightIndex=prtConsoleLightIndex, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtChannelGroup=prtChannelGroup, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputStackingOrder=prtOutputStackingOrder, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtGeneralV2Group=prtGeneralV2Group, prtAlertTableV2Group=prtAlertTableV2Group, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInputVersion=prtInputVersion, prtAlertAllEvents=prtAlertAllEvents, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtOutputIndex=prtOutputIndex, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerNorthMargin=prtMarkerNorthMargin, prtChannelProtocolVersion=prtChannelProtocolVersion, prtChannelState=prtChannelState, prtInputModel=prtInputModel, prtInterpreterDescription=prtInterpreterDescription, prtOutputStatus=prtOutputStatus)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerMarkTech=prtMarkerMarkTech, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInputMediaName=prtInputMediaName)
