...
PrtMarkerSuppliesTypeTC, PrtMarkerMarkTechTC, PrtAlertCodeTC, PrtGeneralResetTC, PrtConsoleDisableTC, PrtCoverStatusTC, PrtConsoleColorTC, PrtInterpreterLangFamilyTC, PrtOutputTypeTC, PrtAlertTrainingLevelTC, PrtChannelTypeTC, PrtMediaPathTypeTC, PrtAlertGroupTC, PrtInputTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerSuppliesTypeTC", "PrtMarkerMarkTechTC", "PrtAlertCodeTC", "PrtGeneralResetTC", "PrtConsoleDisableTC", "PrtCoverStatusTC", "PrtConsoleColorTC", "PrtInterpreterLangFamilyTC", "PrtOutputTypeTC", "PrtAlertTrainingLevelTC", "PrtChannelTypeTC", "PrtMediaPathTypeTC", "PrtAlertGroupTC", "PrtInputTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtAlertCode=prtAlertCode, prtOutputEntry=prtOutputEntry, prtMarkerProcessColorants=prtMarkerProcessColorants, prtExtendedOutputGroup=prtExtendedOutputGroup, SubUnitStatus=SubUnitStatus, prtInterpreterLangVersion=prtInterpreterLangVersion, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, PrtMediaUnitTC=PrtMediaUnitTC, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtCoverIndex=prtCoverIndex, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerColorantRole=prtMarkerColorantRole, prtInputVersion=prtInputVersion, prtInputEntry=prtInputEntry, prtConsoleLightIndex=prtConsoleLightIndex, prtAlertCriticalEvents=prtAlertCriticalEvents, prtAlertTable=prtAlertTable, prtConsoleLocalization=prtConsoleLocalization, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtGeneral=prtGeneral, prtAlertEntry=prtAlertEntry, prtInputGroup=prtInputGroup, prtMIB2Compliance=prtMIB2Compliance, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMIB2Groups=prtMIB2Groups, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtChannelV2Group=prtChannelV2Group, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, CodedCharSet=CodedCharSet, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInterpreterDescription=prtInterpreterDescription, prtStorageRefIndex=prtStorageRefIndex, prtOutputDecollating=prtOutputDecollating, prtChannelEntry=prtChannelEntry, prtAlertIndex=prtAlertIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtAlertGroupIndex=prtAlertGroupIndex, prtInputCurrentLevel=prtInputCurrentLevel, prtChannelTable=prtChannelTable, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtCoverDescription=prtCoverDescription, prtMediaPathStatus=prtMediaPathStatus, prtConsoleLights=prtConsoleLights, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMarkerIndex=prtMarkerIndex, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputMaxCapacity=prtOutputMaxCapacity, prtOutputVendorName=prtOutputVendorName, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, printerV1Alert=printerV1Alert, prtInputSerialNumber=prtInputSerialNumber, prtChannelGroup=prtChannelGroup, prtAlertTableGroup=prtAlertTableGroup, prtGeneralTable=prtGeneralTable, prtGeneralSerialNumber=prtGeneralSerialNumber, prtChannelIfIndex=prtChannelIfIndex, prtMarkerEntry=prtMarkerEntry, prtGeneralEntry=prtGeneralEntry, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInputMediaType=prtInputMediaType, prtCoverStatus=prtCoverStatus, prtAlertSeverityLevel=prtAlertSeverityLevel, prtLocalizationTable=prtLocalizationTable, prtMarkerPowerOnCount=prtMarkerPowerOnCount, printerV2Alert=printerV2Alert, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtCoverTable=prtCoverTable, prtInputTable=prtInputTable, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInterpreterGroup=prtInterpreterGroup, prtGeneralPrinterName=prtGeneralPrinterName, prtDeviceRefEntry=prtDeviceRefEntry, prtDeviceRefIndex=prtDeviceRefIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtGeneralV2Group=prtGeneralV2Group, prtStorageRefEntry=prtStorageRefEntry, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtGeneralReset=prtGeneralReset, prtMarkerGroup=prtMarkerGroup, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtConsoleOffTime=prtConsoleOffTime, prtInputMediaGroup=prtInputMediaGroup, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInterpreterVersion=prtInterpreterVersion, CapacityUnit=CapacityUnit, prtAlertGroup=prtAlertGroup, prtInputMediaFormParts=prtInputMediaFormParts, prtChannelState=prtChannelState, prtInterpreterLangFamily=prtInterpreterLangFamily, prtChannelStatus=prtChannelStatus, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtAlertLocation=prtAlertLocation, prtMIBGroups=prtMIBGroups, prtInputMaxCapacity=prtInputMaxCapacity, prtMarkerMarkTech=prtMarkerMarkTech, prtLocalizationCountry=prtLocalizationCountry, prtOutputType=prtOutputType, prtAlertAllEvents=prtAlertAllEvents, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlertTrainingLevel=prtAlertTrainingLevel, prtInputNextIndex=prtInputNextIndex, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtLocalization=prtLocalization, prtMarkerEastMargin=prtMarkerEastMargin, prtOutputModel=prtOutputModel, MediaUnit=MediaUnit, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleLightTable=prtConsoleLightTable, prtInterpreterEntry=prtInterpreterEntry, prtCover=prtCover, prtLocalizationEntry=prtLocalizationEntry, prtMarkerSupplies=prtMarkerSupplies, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathEntry=prtMediaPathEntry, prtMediaPathTable=prtMediaPathTable, prtConsoleColor=prtConsoleColor, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMediaPathDescription=prtMediaPathDescription, prtConsoleDisable=prtConsoleDisable, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutputPageCollated=prtOutputPageCollated, prtMediaPathIndex=prtMediaPathIndex, prtInterpreterIndex=prtInterpreterIndex, prtOutputIndex=prtOutputIndex, prtMarkerColorant=prtMarkerColorant, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInputStatus=prtInputStatus, prtStorageRefTable=prtStorageRefTable, prtMarkerLifeCount=prtMarkerLifeCount, prtMediaPath=prtMediaPath, prtAlertTimeGroup=prtAlertTimeGroup, prtOutputBursting=prtOutputBursting, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtChannelInformation=prtChannelInformation, prtInputMediaColor=prtInputMediaColor, prtInputMediaWeight=prtInputMediaWeight, prtInputIndex=prtInputIndex, prtOutputSerialNumber=prtOutputSerialNumber, prtChannelType=prtChannelType, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtLocalizationIndex=prtLocalizationIndex, prtMarkerColorantValue=prtMarkerColorantValue, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputStatus=prtOutputStatus, PrtChannelStateTC=PrtChannelStateTC, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtOutputSecurity=prtOutputSecurity, prtInterpreter=prtInterpreter, prtMarkerTable=prtMarkerTable, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputTable=prtOutputTable, prtMarker=prtMarker, prtGeneralGroup=prtGeneralGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInputDimUnit=prtInputDimUnit, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtConsoleDescription=prtConsoleDescription, prtInputSecurity=prtInputSecurity, prtInputVendorName=prtInputVendorName, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtChannel=prtChannel, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtInputModel=prtInputModel, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMarkerSouthMargin=prtMarkerSouthMargin, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PresentOnOff=PresentOnOff, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtOutputDimUnit=prtOutputDimUnit, prtInput=prtInput, prtMarkerColorantTable=prtMarkerColorantTable, prtInputMediaName=prtInputMediaName, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtAlert=prtAlert, prtMarkerStatus=prtMarkerStatus, prtStorageRefSeqNumber=prtStorageRefSeqNumber, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtConsoleLightEntry=prtConsoleLightEntry, prtInterpreterTable=prtInterpreterTable, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, PYSNMP_MODULE_ID=printmib, printerV2AlertPrefix=printerV2AlertPrefix, prtDeviceRefTable=prtDeviceRefTable, prtInputType=prtInputType, prtMediaPathGroup=prtMediaPathGroup, prtAlertDescription=prtAlertDescription, prtInputDescription=prtInputDescription, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMarkerColorantEntry=prtMarkerColorantEntry, prtGeneralServicePerson=prtGeneralServicePerson, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtOutput=prtOutput, prtMIBConformance=prtMIBConformance, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtOutputStackingOrder=prtOutputStackingOrder, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputCapacityUnit=prtInputCapacityUnit, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtConsoleOnTime=prtConsoleOnTime, prtMediaPathType=prtMediaPathType, prtMIBCompliance=prtMIBCompliance, prtOutputName=prtOutputName, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtExtendedInputGroup=prtExtendedInputGroup, prtChannelProtocolVersion=prtChannelProtocolVersion, prtCoverEntry=prtCoverEntry, printmib=printmib, prtAlertTime=prtAlertTime, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, prtAlertTrapGroup=prtAlertTrapGroup, prtOutputDescription=prtOutputDescription, prtInputName=prtInputName, prtConsoleGroup=prtConsoleGroup, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, PrtCapacityUnitTC=PrtCapacityUnitTC, prtOutputGroup=prtOutputGroup)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerWestMargin=prtMarkerWestMargin, prtChannelIndex=prtChannelIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtOutputVersion=prtOutputVersion)
