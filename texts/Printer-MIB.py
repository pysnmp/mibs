...
PrtGeneralResetTC, PrtOutputTypeTC, PrtAlertCodeTC, PrtMarkerMarkTechTC, PrtAlertGroupTC, PrtInputTypeTC, PrtAlertTrainingLevelTC, PrtConsoleColorTC, PrtConsoleDisableTC, PrtCoverStatusTC, PrtMediaPathTypeTC, PrtChannelTypeTC, PrtInterpreterLangFamilyTC, PrtMarkerSuppliesTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtGeneralResetTC", "PrtOutputTypeTC", "PrtAlertCodeTC", "PrtMarkerMarkTechTC", "PrtAlertGroupTC", "PrtInputTypeTC", "PrtAlertTrainingLevelTC", "PrtConsoleColorTC", "PrtConsoleDisableTC", "PrtCoverStatusTC", "PrtMediaPathTypeTC", "PrtChannelTypeTC", "PrtInterpreterLangFamilyTC", "PrtMarkerSuppliesTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtAlertTrainingLevel=prtAlertTrainingLevel, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtAlertTrapGroup=prtAlertTrapGroup, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutputFeaturesGroup=prtOutputFeaturesGroup, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputIndex=prtOutputIndex, prtOutputDimUnit=prtOutputDimUnit, prtInput=prtInput, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtChannelV2Group=prtChannelV2Group, prtConsoleColor=prtConsoleColor, printmib=printmib, prtOutputVersion=prtOutputVersion, prtOutputStatus=prtOutputStatus, prtAlertLocation=prtAlertLocation, prtChannel=prtChannel, prtGeneralGroup=prtGeneralGroup, prtMarkerEastMargin=prtMarkerEastMargin, prtOutputSerialNumber=prtOutputSerialNumber, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlertCode=prtAlertCode, prtMarkerEntry=prtMarkerEntry, prtMediaPathType=prtMediaPathType, prtOutputBursting=prtOutputBursting, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtLocalizationTable=prtLocalizationTable, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputDecollating=prtOutputDecollating, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, PresentOnOff=PresentOnOff, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtGeneralEntry=prtGeneralEntry, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerColorantTable=prtMarkerColorantTable, prtInputMediaName=prtInputMediaName, prtInputMediaColor=prtInputMediaColor, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInterpreter=prtInterpreter, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerColorantRole=prtMarkerColorantRole, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerMarkTech=prtMarkerMarkTech, prtLocalizationCountry=prtLocalizationCountry, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtGeneralReset=prtGeneralReset, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputDescription=prtOutputDescription, prtChannelEntry=prtChannelEntry, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, PrtChannelStateTC=PrtChannelStateTC, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerColorantIndex=prtMarkerColorantIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtInputIndex=prtInputIndex, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerSuppliesType=prtMarkerSuppliesType, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtLocalizationIndex=prtLocalizationIndex, prtMarkerTable=prtMarkerTable, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMarkerColorantTonality=prtMarkerColorantTonality, SubUnitStatus=SubUnitStatus, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtCoverStatus=prtCoverStatus, prtCoverTable=prtCoverTable, prtOutputGroup=prtOutputGroup, prtChannelType=prtChannelType, printerV2Alert=printerV2Alert, prtInputMediaWeight=prtInputMediaWeight, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtOutputSecurity=prtOutputSecurity, CodedCharSet=CodedCharSet, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMarker=prtMarker, prtMediaPathStatus=prtMediaPathStatus, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtOutput=prtOutput, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerNorthMargin=prtMarkerNorthMargin, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMIBCompliance=prtMIBCompliance, prtInterpreterLangVersion=prtInterpreterLangVersion, prtGeneralV2Group=prtGeneralV2Group, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtOutputName=prtOutputName, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputMediaFormParts=prtInputMediaFormParts, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtAlertGroupIndex=prtAlertGroupIndex, prtInterpreterEntry=prtInterpreterEntry, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtAlertDescription=prtAlertDescription, prtLocalizationLanguage=prtLocalizationLanguage, prtInputSerialNumber=prtInputSerialNumber, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtAlertAllEvents=prtAlertAllEvents, prtAlertGroup=prtAlertGroup, prtOutputModel=prtOutputModel, prtMediaPath=prtMediaPath, prtStorageRefEntry=prtStorageRefEntry, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputTable=prtInputTable, printerV1Alert=printerV1Alert, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMIB2Groups=prtMIB2Groups, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMIBConformance=prtMIBConformance, prtCoverEntry=prtCoverEntry, prtMarkerColorantValue=prtMarkerColorantValue, prtMarkerGroup=prtMarkerGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtAlertTable=prtAlertTable, prtAlertTime=prtAlertTime, prtConsoleOffTime=prtConsoleOffTime, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInterpreterTable=prtInterpreterTable, prtInputVendorName=prtInputVendorName, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInterpreterIndex=prtInterpreterIndex, prtInputMediaGroup=prtInputMediaGroup, prtOutputVendorName=prtOutputVendorName, prtConsoleLocalization=prtConsoleLocalization, prtInterpreterLangFamily=prtInterpreterLangFamily, PrtSubUnitStatusTC=PrtSubUnitStatusTC, PYSNMP_MODULE_ID=printmib, prtOutputPageCollated=prtOutputPageCollated, prtInterpreterGroup=prtInterpreterGroup, prtInterpreterVersion=prtInterpreterVersion, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputType=prtOutputType, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMediaPathDescription=prtMediaPathDescription, prtConsoleGroup=prtConsoleGroup, prtConsoleLightEntry=prtConsoleLightEntry, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMediaPathIndex=prtMediaPathIndex, prtMarkerWestMargin=prtMarkerWestMargin, prtInputCapacityUnit=prtInputCapacityUnit, prtInputStatus=prtInputStatus, prtAlertTableV2Group=prtAlertTableV2Group, prtCover=prtCover, prtInputMediaType=prtInputMediaType, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerLifeCount=prtMarkerLifeCount, prtAlertEntry=prtAlertEntry, printerV2AlertPrefix=printerV2AlertPrefix, prtChannelGroup=prtChannelGroup, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtChannelIfIndex=prtChannelIfIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtConsoleLightTable=prtConsoleLightTable, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputStackingOrder=prtOutputStackingOrder, prtGeneralSerialNumber=prtGeneralSerialNumber, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtGeneral=prtGeneral, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputEntry=prtInputEntry, prtCoverDescription=prtCoverDescription, prtMediaPathEntry=prtMediaPathEntry, prtChannelIndex=prtChannelIndex, prtConsoleDisable=prtConsoleDisable, prtAlertTableGroup=prtAlertTableGroup, prtConsoleOnTime=prtConsoleOnTime, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtLocalizationEntry=prtLocalizationEntry, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtChannelStatus=prtChannelStatus, prtMarkerStatus=prtMarkerStatus, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMediaPathTable=prtMediaPathTable, prtAlert=prtAlert, prtInputMaxCapacity=prtInputMaxCapacity, prtAlertTimeGroup=prtAlertTimeGroup, prtGeneralServicePerson=prtGeneralServicePerson, prtInputModel=prtInputModel, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInputDimUnit=prtInputDimUnit, prtMIB2Compliance=prtMIB2Compliance, prtConsoleLightIndex=prtConsoleLightIndex, prtDeviceRefTable=prtDeviceRefTable, CapacityUnit=CapacityUnit, prtConsoleDescription=prtConsoleDescription, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtChannelState=prtChannelState, prtStorageRefTable=prtStorageRefTable, prtInterpreterDescription=prtInterpreterDescription, prtAlertCriticalEvents=prtAlertCriticalEvents, prtOutputMaxCapacity=prtOutputMaxCapacity, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMarkerIndex=prtMarkerIndex, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputTable=prtOutputTable, prtInputDescription=prtInputDescription, prtOutputEntry=prtOutputEntry, prtAlertIndex=prtAlertIndex, prtInputNextIndex=prtInputNextIndex, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMediaPathGroup=prtMediaPathGroup, MediaUnit=MediaUnit, prtInputVersion=prtInputVersion, prtInputSecurity=prtInputSecurity, prtMarkerColorantEntry=prtMarkerColorantEntry, prtGeneralTable=prtGeneralTable, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerSupplies=prtMarkerSupplies, prtDeviceRefEntry=prtDeviceRefEntry, prtStorageRefIndex=prtStorageRefIndex, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputName=prtInputName, prtMIBGroups=prtMIBGroups, prtInputType=prtInputType, prtConsoleLights=prtConsoleLights, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtCoverIndex=prtCoverIndex, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtChannelTable=prtChannelTable, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInputDefaultIndex=prtInputDefaultIndex, prtLocalization=prtLocalization, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut)
mibBuilder.exportSymbols("Printer-MIB", prtInputGroup=prtInputGroup, prtChannelInformation=prtChannelInformation, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerColorant=prtMarkerColorant)
