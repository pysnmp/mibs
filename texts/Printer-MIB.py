...
PrtConsoleColorTC, PrtInterpreterLangFamilyTC, PrtAlertCodeTC, PrtConsoleDisableTC, PrtChannelTypeTC, PrtMarkerMarkTechTC, PrtAlertGroupTC, PrtInputTypeTC, PrtMarkerSuppliesTypeTC, PrtCoverStatusTC, PrtAlertTrainingLevelTC, PrtGeneralResetTC, PrtMediaPathTypeTC, PrtOutputTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleColorTC", "PrtInterpreterLangFamilyTC", "PrtAlertCodeTC", "PrtConsoleDisableTC", "PrtChannelTypeTC", "PrtMarkerMarkTechTC", "PrtAlertGroupTC", "PrtInputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtCoverStatusTC", "PrtAlertTrainingLevelTC", "PrtGeneralResetTC", "PrtMediaPathTypeTC", "PrtOutputTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtStorageRefEntry=prtStorageRefEntry, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInputDimUnit=prtInputDimUnit, prtOutputVendorName=prtOutputVendorName, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMIB2Compliance=prtMIB2Compliance, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputSecurity=prtInputSecurity, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtGeneralTable=prtGeneralTable, prtInterpreterDescription=prtInterpreterDescription, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtChannelGroup=prtChannelGroup, prtMarkerIndex=prtMarkerIndex, PrtCapacityUnitTC=PrtCapacityUnitTC, prtLocalizationIndex=prtLocalizationIndex, prtInputMediaFormParts=prtInputMediaFormParts, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtAlert=prtAlert, printerV2Alert=printerV2Alert, prtMediaPathDescription=prtMediaPathDescription, prtGeneralReset=prtGeneralReset, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, CodedCharSet=CodedCharSet, prtMediaPathStatus=prtMediaPathStatus, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, PYSNMP_MODULE_ID=printmib, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMediaPathGroup=prtMediaPathGroup, prtInterpreterTable=prtInterpreterTable, prtMarkerColorantIndex=prtMarkerColorantIndex, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtConsoleDescription=prtConsoleDescription, prtInterpreterGroup=prtInterpreterGroup, prtOutput=prtOutput, prtGeneralV2Group=prtGeneralV2Group, prtConsoleLightTable=prtConsoleLightTable, prtOutputTable=prtOutputTable, prtInputCurrentLevel=prtInputCurrentLevel, prtChannelIndex=prtChannelIndex, prtGeneral=prtGeneral, prtOutputDimUnit=prtOutputDimUnit, PresentOnOff=PresentOnOff, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtConsoleLightIndex=prtConsoleLightIndex, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtOutputPageCollated=prtOutputPageCollated, prtOutputCapacityUnit=prtOutputCapacityUnit, prtInputMediaColor=prtInputMediaColor, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtAlertCriticalEvents=prtAlertCriticalEvents, printerV2AlertPrefix=printerV2AlertPrefix, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputMediaGroup=prtInputMediaGroup, prtCoverIndex=prtCoverIndex, prtLocalizationCountry=prtLocalizationCountry, prtLocalizationTable=prtLocalizationTable, prtDeviceRefTable=prtDeviceRefTable, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtChannelTable=prtChannelTable, prtInputSerialNumber=prtInputSerialNumber, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtChannelStatus=prtChannelStatus, prtMarkerEastMargin=prtMarkerEastMargin, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInterpreterEntry=prtInterpreterEntry, prtGeneralEntry=prtGeneralEntry, prtAlertTimeGroup=prtAlertTimeGroup, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputNextIndex=prtInputNextIndex, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputDescription=prtInputDescription, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputDecollating=prtOutputDecollating, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMIBConformance=prtMIBConformance, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtLocalizationEntry=prtLocalizationEntry, prtAlertIndex=prtAlertIndex, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputStatus=prtInputStatus, prtAlertAllEvents=prtAlertAllEvents, prtDeviceRefIndex=prtDeviceRefIndex, prtInterpreterLangLevel=prtInterpreterLangLevel, prtCoverEntry=prtCoverEntry, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMIB2Groups=prtMIB2Groups, prtMarkerWestMargin=prtMarkerWestMargin, prtStorageRefTable=prtStorageRefTable, prtInterpreterVersion=prtInterpreterVersion, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtConsoleOffTime=prtConsoleOffTime, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMediaPathEntry=prtMediaPathEntry, prtAlertTableV2Group=prtAlertTableV2Group, prtMediaPathTable=prtMediaPathTable, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarker=prtMarker, prtGeneralGroup=prtGeneralGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, prtExtendedOutputGroup=prtExtendedOutputGroup, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtAlertTableGroup=prtAlertTableGroup, prtMarkerStatus=prtMarkerStatus, prtInterpreter=prtInterpreter, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputOffsetStacking=prtOutputOffsetStacking, prtConsoleLights=prtConsoleLights, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, CapacityUnit=CapacityUnit, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtChannelEntry=prtChannelEntry, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, PrtChannelStateTC=PrtChannelStateTC, prtInputMediaWeight=prtInputMediaWeight, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMediaPathIndex=prtMediaPathIndex, prtChannel=prtChannel, prtInputModel=prtInputModel, prtInputMediaType=prtInputMediaType, prtMarkerSupplies=prtMarkerSupplies, prtChannelType=prtChannelType, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerEntry=prtMarkerEntry, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputVersion=prtOutputVersion, prtMarkerGroup=prtMarkerGroup, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInputType=prtInputType, prtAlertDescription=prtAlertDescription, prtGeneralConfigChanges=prtGeneralConfigChanges, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtCoverTable=prtCoverTable, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtChannelInformation=prtChannelInformation, prtMIBGroups=prtMIBGroups, prtOutputDescription=prtOutputDescription, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMIBCompliance=prtMIBCompliance, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInputGroup=prtInputGroup, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInterpreterLangVersion=prtInterpreterLangVersion, prtOutputSerialNumber=prtOutputSerialNumber, prtInputMaxCapacity=prtInputMaxCapacity, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMarkerColorantEntry=prtMarkerColorantEntry, prtChannelState=prtChannelState, prtMarkerColorant=prtMarkerColorant, prtInputDefaultIndex=prtInputDefaultIndex, prtOutputEntry=prtOutputEntry, prtOutputMaxCapacity=prtOutputMaxCapacity, prtOutputName=prtOutputName, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtOutputIndex=prtOutputIndex, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputType=prtOutputType, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtCover=prtCover, prtCoverDescription=prtCoverDescription, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerMarkTech=prtMarkerMarkTech, prtAlertLocation=prtAlertLocation, MediaUnit=MediaUnit, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInputVersion=prtInputVersion, prtExtendedInputGroup=prtExtendedInputGroup, prtInputTable=prtInputTable, prtMarkerNorthMargin=prtMarkerNorthMargin, prtConsoleOnTime=prtConsoleOnTime, prtConsoleGroup=prtConsoleGroup, prtLocalization=prtLocalization, prtAlertCode=prtAlertCode, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtChannelV2Group=prtChannelV2Group, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtAlertTrapGroup=prtAlertTrapGroup, prtInterpreterIndex=prtInterpreterIndex, prtAlertGroup=prtAlertGroup, prtConsoleLocalization=prtConsoleLocalization, prtInputVendorName=prtInputVendorName, prtOutputStatus=prtOutputStatus, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtAlertSeverityLevel=prtAlertSeverityLevel, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMarkerProcessColorants=prtMarkerProcessColorants, prtOutputStackingOrder=prtOutputStackingOrder, prtMediaPath=prtMediaPath, prtAlertTrainingLevel=prtAlertTrainingLevel, PrtPrintOrientationTC=PrtPrintOrientationTC, prtAlertTime=prtAlertTime, prtOutputBursting=prtOutputBursting, prtConsoleDisable=prtConsoleDisable, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInterpreterLangFamily=prtInterpreterLangFamily, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerColorantValue=prtMarkerColorantValue, prtInputEntry=prtInputEntry, prtMarkerColorantRole=prtMarkerColorantRole, prtOutputSecurity=prtOutputSecurity, prtOutputModel=prtOutputModel, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtChannelIfIndex=prtChannelIfIndex, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtAlertTable=prtAlertTable, prtStorageRefIndex=prtStorageRefIndex, prtInput=prtInput, prtInputName=prtInputName, prtInputCapacityUnit=prtInputCapacityUnit, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerColorantTonality=prtMarkerColorantTonality, prtOutputGroup=prtOutputGroup, prtInputIndex=prtInputIndex, SubUnitStatus=SubUnitStatus, prtConsoleColor=prtConsoleColor, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMarkerTable=prtMarkerTable, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtChannelProtocolVersion=prtChannelProtocolVersion, prtCoverStatus=prtCoverStatus, prtAlertEntry=prtAlertEntry, printmib=printmib, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInputMediaName=prtInputMediaName, printerV1Alert=printerV1Alert)
mibBuilder.exportSymbols("Printer-MIB", prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtGeneralServicePerson=prtGeneralServicePerson, prtMediaPathType=prtMediaPathType, prtMarkerLifeCount=prtMarkerLifeCount)
