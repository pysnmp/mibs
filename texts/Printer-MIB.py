...
PrtConsoleColorTC, PrtOutputTypeTC, PrtGeneralResetTC, PrtConsoleDisableTC, PrtMarkerMarkTechTC, PrtChannelTypeTC, PrtMarkerSuppliesTypeTC, PrtInputTypeTC, PrtMediaPathTypeTC, PrtAlertGroupTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtCoverStatusTC, PrtAlertTrainingLevelTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleColorTC", "PrtOutputTypeTC", "PrtGeneralResetTC", "PrtConsoleDisableTC", "PrtMarkerMarkTechTC", "PrtChannelTypeTC", "PrtMarkerSuppliesTypeTC", "PrtInputTypeTC", "PrtMediaPathTypeTC", "PrtAlertGroupTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtCoverStatusTC", "PrtAlertTrainingLevelTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarker=prtMarker, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMediaPathGroup=prtMediaPathGroup, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInputSerialNumber=prtInputSerialNumber, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInterpreterDescription=prtInterpreterDescription, prtMIBCompliance=prtMIBCompliance, prtMIB2Compliance=prtMIB2Compliance, prtConsoleLightEntry=prtConsoleLightEntry, prtInputModel=prtInputModel, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerSupplies=prtMarkerSupplies, prtChannelEntry=prtChannelEntry, prtAlertGroupIndex=prtAlertGroupIndex, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerColorantGroup=prtMarkerColorantGroup, prtConsoleGroup=prtConsoleGroup, prtOutputEntry=prtOutputEntry, prtInputType=prtInputType, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInputEntry=prtInputEntry, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtAlertTrapGroup=prtAlertTrapGroup, prtInputDimUnit=prtInputDimUnit, prtGeneralTable=prtGeneralTable, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMarkerGroup=prtMarkerGroup, prtConsoleDisable=prtConsoleDisable, prtCoverEntry=prtCoverEntry, prtInputIndex=prtInputIndex, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInputMediaColor=prtInputMediaColor, prtMarkerLifeCount=prtMarkerLifeCount, prtChannelState=prtChannelState, prtInterpreterLangFamily=prtInterpreterLangFamily, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMIB2Groups=prtMIB2Groups, prtAlertTime=prtAlertTime, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerColorantRole=prtMarkerColorantRole, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtOutputOffsetStacking=prtOutputOffsetStacking, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, CapacityUnit=CapacityUnit, prtOutputDecollating=prtOutputDecollating, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelType=prtChannelType, prtOutputTable=prtOutputTable, prtChannelIfIndex=prtChannelIfIndex, prtOutputModel=prtOutputModel, prtAlertIndex=prtAlertIndex, prtInputStatus=prtInputStatus, prtOutputSecurity=prtOutputSecurity, prtInterpreterIndex=prtInterpreterIndex, prtGeneralReset=prtGeneralReset, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtOutputVersion=prtOutputVersion, PrtSubUnitStatusTC=PrtSubUnitStatusTC, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputStackingOrder=prtOutputStackingOrder, prtInputTable=prtInputTable, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtCoverDescription=prtCoverDescription, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleOnTime=prtConsoleOnTime, prtInputMediaGroup=prtInputMediaGroup, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerEntry=prtMarkerEntry, prtInputGroup=prtInputGroup, prtMarkerMarkTech=prtMarkerMarkTech, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInputName=prtInputName, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtOutputCapacityUnit=prtOutputCapacityUnit, prtGeneralGroup=prtGeneralGroup, prtLocalizationCountry=prtLocalizationCountry, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInput=prtInput, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtCoverIndex=prtCoverIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtChannelIndex=prtChannelIndex, prtAlertCriticalEvents=prtAlertCriticalEvents, prtCoverStatus=prtCoverStatus, prtChannelTable=prtChannelTable, prtConsoleDescription=prtConsoleDescription, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerColorantValue=prtMarkerColorantValue, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtOutputName=prtOutputName, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlertSeverityLevel=prtAlertSeverityLevel, prtExtendedOutputGroup=prtExtendedOutputGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtLocalizationEntry=prtLocalizationEntry, prtConsoleColor=prtConsoleColor, prtMarkerSuppliesType=prtMarkerSuppliesType, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtChannelV2Group=prtChannelV2Group, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, PrtChannelStateTC=PrtChannelStateTC, prtMarkerStatus=prtMarkerStatus, prtOutputSerialNumber=prtOutputSerialNumber, prtAlertEntry=prtAlertEntry, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerSouthMargin=prtMarkerSouthMargin, prtConsoleLights=prtConsoleLights, prtMarkerWestMargin=prtMarkerWestMargin, prtConsoleLocalization=prtConsoleLocalization, prtDeviceRefEntry=prtDeviceRefEntry, prtInputVendorName=prtInputVendorName, prtOutputDimUnit=prtOutputDimUnit, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, SubUnitStatus=SubUnitStatus, prtStorageRefEntry=prtStorageRefEntry, prtOutputDescription=prtOutputDescription, prtMediaPathTable=prtMediaPathTable, prtChannel=prtChannel, prtInputMediaName=prtInputMediaName, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtConsoleLightTable=prtConsoleLightTable, prtChannelStatus=prtChannelStatus, prtMediaPathEntry=prtMediaPathEntry, prtMarkerProcessColorants=prtMarkerProcessColorants, printmib=printmib, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtAlertTableGroup=prtAlertTableGroup, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, PYSNMP_MODULE_ID=printmib, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtInputVersion=prtInputVersion, prtOutputIndex=prtOutputIndex, prtExtendedInputGroup=prtExtendedInputGroup, prtInputDefaultIndex=prtInputDefaultIndex, printerV2Alert=printerV2Alert, prtOutputMaxCapacity=prtOutputMaxCapacity, prtAlertAllEvents=prtAlertAllEvents, prtInterpreterTable=prtInterpreterTable, prtGeneral=prtGeneral, prtMediaPathIndex=prtMediaPathIndex, prtMarkerDefaultIndex=prtMarkerDefaultIndex, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtChannelInformation=prtChannelInformation, prtCover=prtCover, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtAlertTable=prtAlertTable, prtAlertLocation=prtAlertLocation, prtAlertTimeGroup=prtAlertTimeGroup, prtInputNextIndex=prtInputNextIndex, prtMediaPath=prtMediaPath, prtStorageRefTable=prtStorageRefTable, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlertTableV2Group=prtAlertTableV2Group, CodedCharSet=CodedCharSet, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtLocalizationIndex=prtLocalizationIndex, prtStorageRefIndex=prtStorageRefIndex, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtOutputVendorName=prtOutputVendorName, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMediaPathType=prtMediaPathType, prtMarkerColorant=prtMarkerColorant, PrtCapacityUnitTC=PrtCapacityUnitTC, prtAlertDescription=prtAlertDescription, prtOutputType=prtOutputType, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, printerV2AlertPrefix=printerV2AlertPrefix, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtAlertCode=prtAlertCode, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtChannelGroup=prtChannelGroup, prtInterpreterEntry=prtInterpreterEntry, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInterpreterGroup=prtInterpreterGroup, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtOutputStatus=prtOutputStatus, prtInterpreterVersion=prtInterpreterVersion, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, printerV1Alert=printerV1Alert, prtMIBConformance=prtMIBConformance, prtInterpreterLangLevel=prtInterpreterLangLevel, MediaUnit=MediaUnit, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInputDescription=prtInputDescription, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputMaxCapacity=prtInputMaxCapacity, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInputMediaType=prtInputMediaType, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtAlertGroup=prtAlertGroup, prtMarkerColorantTable=prtMarkerColorantTable, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInterpreter=prtInterpreter, prtOutputDefaultIndex=prtOutputDefaultIndex, prtDeviceRefTable=prtDeviceRefTable, prtAlert=prtAlert, prtConsoleOffTime=prtConsoleOffTime, prtGeneralPrinterName=prtGeneralPrinterName, prtGeneralEntry=prtGeneralEntry, prtMarkerNorthMargin=prtMarkerNorthMargin, prtCoverTable=prtCoverTable, prtGeneralV2Group=prtGeneralV2Group, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtOutputBursting=prtOutputBursting, prtInputMediaWeight=prtInputMediaWeight, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtLocalizationTable=prtLocalizationTable, prtMIBGroups=prtMIBGroups, prtInputMediaFormParts=prtInputMediaFormParts, prtOutput=prtOutput, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtOutputGroup=prtOutputGroup, PresentOnOff=PresentOnOff, prtConsoleLightIndex=prtConsoleLightIndex, prtInputSecurity=prtInputSecurity, prtMarkerIndex=prtMarkerIndex, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtOutputPageCollated=prtOutputPageCollated, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMediaPathDescription=prtMediaPathDescription, prtInterpreterTwoWay=prtInterpreterTwoWay, prtLocalizationLanguage=prtLocalizationLanguage, prtMediaPathStatus=prtMediaPathStatus)
mibBuilder.exportSymbols("Printer-MIB", prtInputCurrentLevel=prtInputCurrentLevel, prtInputCapacityUnit=prtInputCapacityUnit, prtMarkerTable=prtMarkerTable, prtLocalization=prtLocalization)
