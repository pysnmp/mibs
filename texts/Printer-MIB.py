...
PrtInputTypeTC, PrtAlertTrainingLevelTC, PrtMediaPathTypeTC, PrtInterpreterLangFamilyTC, PrtMarkerSuppliesTypeTC, PrtMarkerMarkTechTC, PrtCoverStatusTC, PrtConsoleDisableTC, PrtGeneralResetTC, PrtOutputTypeTC, PrtConsoleColorTC, PrtChannelTypeTC, PrtAlertGroupTC, PrtAlertCodeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInputTypeTC", "PrtAlertTrainingLevelTC", "PrtMediaPathTypeTC", "PrtInterpreterLangFamilyTC", "PrtMarkerSuppliesTypeTC", "PrtMarkerMarkTechTC", "PrtCoverStatusTC", "PrtConsoleDisableTC", "PrtGeneralResetTC", "PrtOutputTypeTC", "PrtConsoleColorTC", "PrtChannelTypeTC", "PrtAlertGroupTC", "PrtAlertCodeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputIndex=prtInputIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, prtConsoleOffTime=prtConsoleOffTime, prtInterpreterDescription=prtInterpreterDescription, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtChannelType=prtChannelType, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMIBConformance=prtMIBConformance, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtOutputGroup=prtOutputGroup, prtInputEntry=prtInputEntry, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtLocalization=prtLocalization, prtInterpreterLangLevel=prtInterpreterLangLevel, printerV2Alert=printerV2Alert, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtOutputTable=prtOutputTable, PrtMediaUnitTC=PrtMediaUnitTC, prtInputMediaWeight=prtInputMediaWeight, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtGeneralGroup=prtGeneralGroup, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInputSerialNumber=prtInputSerialNumber, prtMarkerColorantTonality=prtMarkerColorantTonality, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, SubUnitStatus=SubUnitStatus, prtAlert=prtAlert, prtInterpreterLangVersion=prtInterpreterLangVersion, prtDeviceRefEntry=prtDeviceRefEntry, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerIndex=prtMarkerIndex, prtMIBGroups=prtMIBGroups, prtMarkerSupplies=prtMarkerSupplies, prtConsoleDisable=prtConsoleDisable, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtAlertDescription=prtAlertDescription, prtOutputDecollating=prtOutputDecollating, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerEastMargin=prtMarkerEastMargin, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputVersion=prtInputVersion, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtOutputOffsetStacking=prtOutputOffsetStacking, prtConsoleColor=prtConsoleColor, prtInputDimUnit=prtInputDimUnit, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMediaPathType=prtMediaPathType, prtInterpreterLangFamily=prtInterpreterLangFamily, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtLocalizationEntry=prtLocalizationEntry, prtOutputType=prtOutputType, prtMediaPathIndex=prtMediaPathIndex, prtInputGroup=prtInputGroup, prtAlertTrapGroup=prtAlertTrapGroup, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputBursting=prtOutputBursting, prtInterpreterGroup=prtInterpreterGroup, prtGeneralTable=prtGeneralTable, prtConsoleLightEntry=prtConsoleLightEntry, prtCoverEntry=prtCoverEntry, prtLocalizationLanguage=prtLocalizationLanguage, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInputName=prtInputName, prtMarkerProcessColorants=prtMarkerProcessColorants, prtLocalizationIndex=prtLocalizationIndex, printerV2AlertPrefix=printerV2AlertPrefix, prtInputNextIndex=prtInputNextIndex, prtInterpreterIndex=prtInterpreterIndex, prtChannelProtocolVersion=prtChannelProtocolVersion, prtConsoleOnTime=prtConsoleOnTime, prtGeneralReset=prtGeneralReset, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtAlertLocation=prtAlertLocation, prtChannelGroup=prtChannelGroup, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtAlertTime=prtAlertTime, prtChannelV2Group=prtChannelV2Group, prtAlertAllEvents=prtAlertAllEvents, prtGeneralSerialNumber=prtGeneralSerialNumber, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerNorthMargin=prtMarkerNorthMargin, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtLocalizationTable=prtLocalizationTable, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerColorantIndex=prtMarkerColorantIndex, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtAlertIndex=prtAlertIndex, prtMarkerColorantTable=prtMarkerColorantTable, prtMediaPath=prtMediaPath, prtGeneralConfigChanges=prtGeneralConfigChanges, prtConsoleLightIndex=prtConsoleLightIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtLocalizationCountry=prtLocalizationCountry, prtOutputStackingOrder=prtOutputStackingOrder, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtAlertSeverityLevel=prtAlertSeverityLevel, prtAlertGroupIndex=prtAlertGroupIndex, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputStatus=prtOutputStatus, PresentOnOff=PresentOnOff, prtInputMediaName=prtInputMediaName, prtInputDescription=prtInputDescription, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtChannelIfIndex=prtChannelIfIndex, prtChannelInformation=prtChannelInformation, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerColorantValue=prtMarkerColorantValue, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMIB2Groups=prtMIB2Groups, prtAlertTable=prtAlertTable, prtMarker=prtMarker, prtMarkerColorantEntry=prtMarkerColorantEntry, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerWestMargin=prtMarkerWestMargin, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMarkerGroup=prtMarkerGroup, prtMarkerLifeCount=prtMarkerLifeCount, prtGeneralV2Group=prtGeneralV2Group, MediaUnit=MediaUnit, prtInputStatus=prtInputStatus, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMIBCompliance=prtMIBCompliance, prtAlertTableGroup=prtAlertTableGroup, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtOutputIndex=prtOutputIndex, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtOutputName=prtOutputName, prtDeviceRefTable=prtDeviceRefTable, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMediaPathDescription=prtMediaPathDescription, prtMediaPathEntry=prtMediaPathEntry, prtCoverTable=prtCoverTable, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputVersion=prtOutputVersion, prtCoverIndex=prtCoverIndex, prtStorageRefIndex=prtStorageRefIndex, prtMIB2Compliance=prtMIB2Compliance, prtOutputModel=prtOutputModel, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtAlertTimeGroup=prtAlertTimeGroup, CapacityUnit=CapacityUnit, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMediaPathStatus=prtMediaPathStatus, prtConsoleGroup=prtConsoleGroup, prtGeneralServicePerson=prtGeneralServicePerson, prtInputVendorName=prtInputVendorName, PYSNMP_MODULE_ID=printmib, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtOutputDimUnit=prtOutputDimUnit, prtConsoleDescription=prtConsoleDescription, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlertEntry=prtAlertEntry, prtInputCapacityUnit=prtInputCapacityUnit, prtGeneralEntry=prtGeneralEntry, prtMediaPathTable=prtMediaPathTable, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInterpreter=prtInterpreter, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, PrtChannelStateTC=PrtChannelStateTC, prtStorageRefEntry=prtStorageRefEntry, prtInputCurrentLevel=prtInputCurrentLevel, prtInterpreterVersion=prtInterpreterVersion, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtStorageRefTable=prtStorageRefTable, prtInputDefaultIndex=prtInputDefaultIndex, prtInterpreterTable=prtInterpreterTable, prtOutputEntry=prtOutputEntry, prtAlertCode=prtAlertCode, prtMarkerMarkTech=prtMarkerMarkTech, prtChannelIndex=prtChannelIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerColorantRole=prtMarkerColorantRole, prtInputType=prtInputType, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtConsoleLocalization=prtConsoleLocalization, prtChannel=prtChannel, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputMediaColor=prtInputMediaColor, prtConsoleLightTable=prtConsoleLightTable, prtChannelStatus=prtChannelStatus, prtInputTable=prtInputTable, prtAlertGroup=prtAlertGroup, prtOutputVendorName=prtOutputVendorName, prtCover=prtCover, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtChannelEntry=prtChannelEntry, printerV1Alert=printerV1Alert, prtCoverDescription=prtCoverDescription, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtInputMediaGroup=prtInputMediaGroup, printmib=printmib, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputDescription=prtOutputDescription, prtExtendedInputGroup=prtExtendedInputGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtChannelTable=prtChannelTable, prtInputSecurity=prtInputSecurity, prtMarkerStatus=prtMarkerStatus, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInput=prtInput, prtConsoleLights=prtConsoleLights, prtInputMediaType=prtInputMediaType, prtInterpreterEntry=prtInterpreterEntry, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutputSecurity=prtOutputSecurity, prtMarkerTable=prtMarkerTable, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputModel=prtInputModel, prtCoverStatus=prtCoverStatus, CodedCharSet=CodedCharSet, prtOutputPageCollated=prtOutputPageCollated, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtDeviceRefIndex=prtDeviceRefIndex, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerColorant=prtMarkerColorant, prtOutput=prtOutput, prtMarkerEntry=prtMarkerEntry, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtAlertTableV2Group=prtAlertTableV2Group)
mibBuilder.exportSymbols("Printer-MIB", prtGeneral=prtGeneral, prtMediaPathGroup=prtMediaPathGroup, prtChannelState=prtChannelState, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex)
