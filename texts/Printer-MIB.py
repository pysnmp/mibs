...
PrtInputTypeTC, PrtAlertGroupTC, PrtAlertTrainingLevelTC, PrtGeneralResetTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtOutputTypeTC, PrtCoverStatusTC, PrtChannelTypeTC, PrtConsoleDisableTC, PrtMediaPathTypeTC, PrtMarkerMarkTechTC, PrtConsoleColorTC, PrtMarkerSuppliesTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInputTypeTC", "PrtAlertGroupTC", "PrtAlertTrainingLevelTC", "PrtGeneralResetTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtOutputTypeTC", "PrtCoverStatusTC", "PrtChannelTypeTC", "PrtConsoleDisableTC", "PrtMediaPathTypeTC", "PrtMarkerMarkTechTC", "PrtConsoleColorTC", "PrtMarkerSuppliesTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMediaPathStatus=prtMediaPathStatus, prtChannelGroup=prtChannelGroup, prtCoverEntry=prtCoverEntry, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtOutputTable=prtOutputTable, prtCoverTable=prtCoverTable, prtChannelInformation=prtChannelInformation, prtMarkerStatus=prtMarkerStatus, prtAlertTrainingLevel=prtAlertTrainingLevel, prtGeneralTable=prtGeneralTable, prtAlert=prtAlert, prtCoverStatus=prtCoverStatus, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerColorantValue=prtMarkerColorantValue, prtConsoleOffTime=prtConsoleOffTime, PYSNMP_MODULE_ID=printmib, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMediaPathTable=prtMediaPathTable, prtAlertTableV2Group=prtAlertTableV2Group, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtOutput=prtOutput, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtStorageRefTable=prtStorageRefTable, prtInterpreterDescription=prtInterpreterDescription, prtOutputVersion=prtOutputVersion, prtLocalizationLanguage=prtLocalizationLanguage, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtGeneralGroup=prtGeneralGroup, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputIndex=prtOutputIndex, prtMarkerColorantTonality=prtMarkerColorantTonality, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtChannelIfIndex=prtChannelIfIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMIBCompliance=prtMIBCompliance, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtConsoleLightEntry=prtConsoleLightEntry, prtAlertIndex=prtAlertIndex, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInterpreterVersion=prtInterpreterVersion, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtChannelEntry=prtChannelEntry, prtOutputDescription=prtOutputDescription, prtOutputBursting=prtOutputBursting, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMediaPathType=prtMediaPathType, prtInputStatus=prtInputStatus, prtInputMediaGroup=prtInputMediaGroup, MediaUnit=MediaUnit, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputIndex=prtInputIndex, prtMarkerGroup=prtMarkerGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtConsoleColor=prtConsoleColor, prtAlertLocation=prtAlertLocation, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInterpreter=prtInterpreter, prtMIB2Groups=prtMIB2Groups, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMarkerColorant=prtMarkerColorant, prtMediaPathIndex=prtMediaPathIndex, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerColorantTable=prtMarkerColorantTable, prtInputVersion=prtInputVersion, prtMediaPath=prtMediaPath, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInputMediaWeight=prtInputMediaWeight, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, printmib=printmib, prtInputMediaFormParts=prtInputMediaFormParts, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMediaPathGroup=prtMediaPathGroup, prtOutputPageCollated=prtOutputPageCollated, prtInputTable=prtInputTable, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtChannelIndex=prtChannelIndex, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInterpreterIndex=prtInterpreterIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtInputModel=prtInputModel, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtChannelType=prtChannelType, PrtCapacityUnitTC=PrtCapacityUnitTC, printerV1Alert=printerV1Alert, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInputCapacityUnit=prtInputCapacityUnit, prtStorageRefEntry=prtStorageRefEntry, prtGeneral=prtGeneral, prtInputVendorName=prtInputVendorName, prtMarker=prtMarker, prtGeneralReset=prtGeneralReset, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInput=prtInput, prtInputMediaName=prtInputMediaName, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMediaPathDescription=prtMediaPathDescription, prtChannelTable=prtChannelTable, SubUnitStatus=SubUnitStatus, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtLocalizationEntry=prtLocalizationEntry, prtOutputSecurity=prtOutputSecurity, prtChannelState=prtChannelState, prtConsoleGroup=prtConsoleGroup, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInterpreterLangFamily=prtInterpreterLangFamily, prtConsoleOnTime=prtConsoleOnTime, prtLocalizationIndex=prtLocalizationIndex, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerWestMargin=prtMarkerWestMargin, prtInputMediaColor=prtInputMediaColor, prtMarkerEastMargin=prtMarkerEastMargin, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerEntry=prtMarkerEntry, prtMarkerSuppliesType=prtMarkerSuppliesType, prtLocalizationTable=prtLocalizationTable, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, printerV2AlertPrefix=printerV2AlertPrefix, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtGeneralServicePerson=prtGeneralServicePerson, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtOutputType=prtOutputType, prtOutputDecollating=prtOutputDecollating, prtInputSecurity=prtInputSecurity, prtOutputVendorName=prtOutputVendorName, prtConsoleLightIndex=prtConsoleLightIndex, prtMarkerColorantIndex=prtMarkerColorantIndex, prtInputDefaultIndex=prtInputDefaultIndex, PresentOnOff=PresentOnOff, prtInputMediaType=prtInputMediaType, prtOutputSerialNumber=prtOutputSerialNumber, prtAlertGroupIndex=prtAlertGroupIndex, prtAlertCode=prtAlertCode, prtOutputStatus=prtOutputStatus, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlertTable=prtAlertTable, prtCover=prtCover, prtChannelStatus=prtChannelStatus, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlertAllEvents=prtAlertAllEvents, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtChannelProtocolVersion=prtChannelProtocolVersion, printerV2Alert=printerV2Alert, prtConsoleDescription=prtConsoleDescription, prtInputGroup=prtInputGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, CodedCharSet=CodedCharSet, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputNextIndex=prtInputNextIndex, prtConsoleLights=prtConsoleLights, prtConsoleLightTable=prtConsoleLightTable, prtAlertDescription=prtAlertDescription, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtAlertTime=prtAlertTime, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtOutputEntry=prtOutputEntry, prtOutputOffsetStacking=prtOutputOffsetStacking, prtExtendedInputGroup=prtExtendedInputGroup, prtAlertEntry=prtAlertEntry, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInputSerialNumber=prtInputSerialNumber, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtCoverDescription=prtCoverDescription, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerIndex=prtMarkerIndex, prtOutputDimUnit=prtOutputDimUnit, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMIB2Compliance=prtMIB2Compliance, prtCoverIndex=prtCoverIndex, prtOutputModel=prtOutputModel, prtAlertGroup=prtAlertGroup, prtInputName=prtInputName, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtConsoleDisable=prtConsoleDisable, prtChannel=prtChannel, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtConsoleLocalization=prtConsoleLocalization, prtStorageRefIndex=prtStorageRefIndex, prtInputDescription=prtInputDescription, prtMarkerTable=prtMarkerTable, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerColorantRole=prtMarkerColorantRole, CapacityUnit=CapacityUnit, prtDeviceRefIndex=prtDeviceRefIndex, prtDeviceRefTable=prtDeviceRefTable, prtOutputName=prtOutputName, prtMIBConformance=prtMIBConformance, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMIBGroups=prtMIBGroups, prtMarkerColorantGroup=prtMarkerColorantGroup, prtGeneralV2Group=prtGeneralV2Group, prtAlertCriticalEvents=prtAlertCriticalEvents, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtAlertTrapGroup=prtAlertTrapGroup, prtInterpreterTable=prtInterpreterTable, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtOutputGroup=prtOutputGroup, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathEntry=prtMediaPathEntry, prtOutputFeaturesGroup=prtOutputFeaturesGroup, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerSupplies=prtMarkerSupplies, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtGeneralEntry=prtGeneralEntry, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputType=prtInputType, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtAlertTableGroup=prtAlertTableGroup, prtChannelV2Group=prtChannelV2Group, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtAlertTimeGroup=prtAlertTimeGroup, prtLocalization=prtLocalization, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtLocalizationCountry=prtLocalizationCountry, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputCapacityUnit=prtOutputCapacityUnit, prtGeneralPrinterName=prtGeneralPrinterName, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInputEntry=prtInputEntry, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputCurrentLevel=prtInputCurrentLevel, PrtChannelStateTC=PrtChannelStateTC, prtInterpreterGroup=prtInterpreterGroup, prtInputDimUnit=prtInputDimUnit)
mibBuilder.exportSymbols("Printer-MIB", prtInterpreterEntry=prtInterpreterEntry, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtDeviceRefEntry=prtDeviceRefEntry, prtInputMaxCapacity=prtInputMaxCapacity)
