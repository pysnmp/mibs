...
PrtGeneralResetTC, PrtInterpreterLangFamilyTC, PrtInputTypeTC, PrtConsoleColorTC, PrtChannelTypeTC, PrtMarkerSuppliesTypeTC, PrtConsoleDisableTC, PrtMediaPathTypeTC, PrtCoverStatusTC, PrtMarkerMarkTechTC, PrtOutputTypeTC, PrtAlertGroupTC, PrtAlertTrainingLevelTC, PrtAlertCodeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtGeneralResetTC", "PrtInterpreterLangFamilyTC", "PrtInputTypeTC", "PrtConsoleColorTC", "PrtChannelTypeTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleDisableTC", "PrtMediaPathTypeTC", "PrtCoverStatusTC", "PrtMarkerMarkTechTC", "PrtOutputTypeTC", "PrtAlertGroupTC", "PrtAlertTrainingLevelTC", "PrtAlertCodeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInput=prtInput, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInputCurrentLevel=prtInputCurrentLevel, prtInterpreterTwoWay=prtInterpreterTwoWay, prtChannelIfIndex=prtChannelIfIndex, prtMarkerTable=prtMarkerTable, printerV1Alert=printerV1Alert, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtAlert=prtAlert, prtInterpreterIndex=prtInterpreterIndex, CapacityUnit=CapacityUnit, prtInputNextIndex=prtInputNextIndex, prtInputSecurity=prtInputSecurity, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInputModel=prtInputModel, prtGeneralV2Group=prtGeneralV2Group, prtMarkerColorant=prtMarkerColorant, prtOutputVendorName=prtOutputVendorName, prtOutputPageCollated=prtOutputPageCollated, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtCover=prtCover, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtLocalizationEntry=prtLocalizationEntry, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInputVersion=prtInputVersion, prtCoverIndex=prtCoverIndex, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInputName=prtInputName, prtConsoleGroup=prtConsoleGroup, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtGeneral=prtGeneral, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInterpreterVersion=prtInterpreterVersion, prtChannel=prtChannel, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtOutputModel=prtOutputModel, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, SubUnitStatus=SubUnitStatus, prtInputDescription=prtInputDescription, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtChannelTable=prtChannelTable, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerEastMargin=prtMarkerEastMargin, prtInputIndex=prtInputIndex, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerStatus=prtMarkerStatus, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtChannelV2Group=prtChannelV2Group, PresentOnOff=PresentOnOff, prtStorageRefEntry=prtStorageRefEntry, prtChannelEntry=prtChannelEntry, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMediaPathGroup=prtMediaPathGroup, prtMarker=prtMarker, prtMarkerColorantEntry=prtMarkerColorantEntry, prtGeneralSerialNumber=prtGeneralSerialNumber, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtAlertDescription=prtAlertDescription, prtInputSwitchingGroup=prtInputSwitchingGroup, prtAlertTable=prtAlertTable, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtChannelInformation=prtChannelInformation, prtInputMediaName=prtInputMediaName, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputMediaFormParts=prtInputMediaFormParts, prtMediaPathIndex=prtMediaPathIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMarkerSupplies=prtMarkerSupplies, prtLocalizationIndex=prtLocalizationIndex, prtExtendedInputGroup=prtExtendedInputGroup, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtAlertTimeGroup=prtAlertTimeGroup, prtOutputType=prtOutputType, prtOutputBursting=prtOutputBursting, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtCoverTable=prtCoverTable, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputEntry=prtOutputEntry, prtInputGroup=prtInputGroup, prtOutput=prtOutput, prtCoverEntry=prtCoverEntry, prtOutputDescription=prtOutputDescription, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInputMediaGroup=prtInputMediaGroup, prtInterpreterGroup=prtInterpreterGroup, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtConsoleColor=prtConsoleColor, prtGeneralPrinterName=prtGeneralPrinterName, prtInputMediaWeight=prtInputMediaWeight, prtMarkerEntry=prtMarkerEntry, prtChannelIndex=prtChannelIndex, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMediaPathType=prtMediaPathType, PrtMediaUnitTC=PrtMediaUnitTC, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtConsoleLightTable=prtConsoleLightTable, prtCoverStatus=prtCoverStatus, prtOutputName=prtOutputName, prtConsoleDisable=prtConsoleDisable, printerV2Alert=printerV2Alert, prtExtendedOutputGroup=prtExtendedOutputGroup, prtInputStatus=prtInputStatus, prtMIBCompliance=prtMIBCompliance, prtMediaPathEntry=prtMediaPathEntry, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtOutputIndex=prtOutputIndex, prtMarkerColorantValue=prtMarkerColorantValue, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtDeviceRefTable=prtDeviceRefTable, prtMarkerIndex=prtMarkerIndex, prtInputMediaColor=prtInputMediaColor, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputEntry=prtInputEntry, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtOutputStatus=prtOutputStatus, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerColorantTable=prtMarkerColorantTable, prtChannelType=prtChannelType, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInterpreterTable=prtInterpreterTable, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtOutputMaxCapacity=prtOutputMaxCapacity, prtGeneralEntry=prtGeneralEntry, prtConsoleDescription=prtConsoleDescription, printmib=printmib, prtGeneralReset=prtGeneralReset, prtInputDimUnit=prtInputDimUnit, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMediaPathTable=prtMediaPathTable, prtAlertAllEvents=prtAlertAllEvents, prtChannelStatus=prtChannelStatus, prtAlertEntry=prtAlertEntry, prtAlertSeverityLevel=prtAlertSeverityLevel, CodedCharSet=CodedCharSet, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerMarkTech=prtMarkerMarkTech, prtGeneralGroup=prtGeneralGroup, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMIB2Groups=prtMIB2Groups, prtLocalizationLanguage=prtLocalizationLanguage, prtInputMediaType=prtInputMediaType, prtInputTable=prtInputTable, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtConsoleOnTime=prtConsoleOnTime, prtMarkerSouthMargin=prtMarkerSouthMargin, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtAlertTime=prtAlertTime, prtAlertIndex=prtAlertIndex, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputSecurity=prtOutputSecurity, PYSNMP_MODULE_ID=printmib, prtDeviceRefIndex=prtDeviceRefIndex, prtAlertCode=prtAlertCode, prtMarkerGroup=prtMarkerGroup, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInterpreter=prtInterpreter, prtMIBGroups=prtMIBGroups, prtMarkerSpotColorants=prtMarkerSpotColorants, prtStorageRefSeqNumber=prtStorageRefSeqNumber, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputVersion=prtOutputVersion, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, MediaUnit=MediaUnit, prtInputCapacityUnit=prtInputCapacityUnit, prtOutputDecollating=prtOutputDecollating, prtConsoleLocalization=prtConsoleLocalization, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtStorageRefTable=prtStorageRefTable, prtOutputDefaultIndex=prtOutputDefaultIndex, prtStorageRefIndex=prtStorageRefIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtAlertTrainingLevel=prtAlertTrainingLevel, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtChannelGroup=prtChannelGroup, prtMarkerColorantRole=prtMarkerColorantRole, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtAlertTableGroup=prtAlertTableGroup, prtLocalization=prtLocalization, prtConsoleLights=prtConsoleLights, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtAlertGroup=prtAlertGroup, prtGeneralTable=prtGeneralTable, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtOutputTable=prtOutputTable, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMIB2Compliance=prtMIB2Compliance, prtCoverDescription=prtCoverDescription, prtInputVendorName=prtInputVendorName, prtChannelState=prtChannelState, prtInputSerialNumber=prtInputSerialNumber, prtOutputGroup=prtOutputGroup, prtOutputDimUnit=prtOutputDimUnit, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtChannelProtocolVersion=prtChannelProtocolVersion, PrtChannelStateTC=PrtChannelStateTC, prtAlertCriticalEvents=prtAlertCriticalEvents, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtConsoleOffTime=prtConsoleOffTime, prtConsoleLightIndex=prtConsoleLightIndex, printerV2AlertPrefix=printerV2AlertPrefix, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInputType=prtInputType, prtConsoleLightEntry=prtConsoleLightEntry, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtMediaPath=prtMediaPath, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerProcessColorants=prtMarkerProcessColorants, prtLocalizationTable=prtLocalizationTable, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtAlertTableV2Group=prtAlertTableV2Group, prtMediaPathDescription=prtMediaPathDescription, prtAlertTrapGroup=prtAlertTrapGroup, prtAlertLocation=prtAlertLocation, prtLocalizationCountry=prtLocalizationCountry, prtOutputSerialNumber=prtOutputSerialNumber, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMediaPathStatus=prtMediaPathStatus, prtMIBConformance=prtMIBConformance, prtInterpreterDescription=prtInterpreterDescription)
mibBuilder.exportSymbols("Printer-MIB", prtAlertGroupIndex=prtAlertGroupIndex, prtInterpreterEntry=prtInterpreterEntry, prtMarkerWestMargin=prtMarkerWestMargin, prtGeneralServicePerson=prtGeneralServicePerson)
