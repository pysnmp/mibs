...
PrtChannelTypeTC, PrtGeneralResetTC, PrtMediaPathTypeTC, PrtMarkerSuppliesTypeTC, PrtConsoleDisableTC, PrtOutputTypeTC, PrtInterpreterLangFamilyTC, PrtCoverStatusTC, PrtInputTypeTC, PrtAlertTrainingLevelTC, PrtAlertCodeTC, PrtConsoleColorTC, PrtAlertGroupTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtChannelTypeTC", "PrtGeneralResetTC", "PrtMediaPathTypeTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleDisableTC", "PrtOutputTypeTC", "PrtInterpreterLangFamilyTC", "PrtCoverStatusTC", "PrtInputTypeTC", "PrtAlertTrainingLevelTC", "PrtAlertCodeTC", "PrtConsoleColorTC", "PrtAlertGroupTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarkerNorthMargin=prtMarkerNorthMargin, prtLocalizationIndex=prtLocalizationIndex, prtInputVersion=prtInputVersion, prtChannelTable=prtChannelTable, prtAlert=prtAlert, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerWestMargin=prtMarkerWestMargin, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInputCurrentLevel=prtInputCurrentLevel, prtAlertGroup=prtAlertGroup, prtMarkerTable=prtMarkerTable, prtConsoleLocalization=prtConsoleLocalization, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerColorantValue=prtMarkerColorantValue, prtMarkerColorantEntry=prtMarkerColorantEntry, prtInputModel=prtInputModel, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMarkerStatus=prtMarkerStatus, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtChannelInformation=prtChannelInformation, prtChannelEntry=prtChannelEntry, prtOutputDimUnit=prtOutputDimUnit, prtOutputGroup=prtOutputGroup, prtLocalizationEntry=prtLocalizationEntry, prtDeviceRefTable=prtDeviceRefTable, prtInterpreterTable=prtInterpreterTable, prtMIB2Groups=prtMIB2Groups, prtOutputDecollating=prtOutputDecollating, prtConsoleDescription=prtConsoleDescription, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtOutputStackingOrder=prtOutputStackingOrder, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMediaPathDescription=prtMediaPathDescription, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtOutputVendorName=prtOutputVendorName, prtInterpreterEntry=prtInterpreterEntry, prtOutput=prtOutput, prtInputName=prtInputName, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInputNextIndex=prtInputNextIndex, prtMediaPathType=prtMediaPathType, prtAlertSeverityLevel=prtAlertSeverityLevel, prtConsoleDisable=prtConsoleDisable, PresentOnOff=PresentOnOff, prtChannelIfIndex=prtChannelIfIndex, prtMediaPathGroup=prtMediaPathGroup, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtStorageRefEntry=prtStorageRefEntry, prtMarkerIndex=prtMarkerIndex, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputMediaGroup=prtInputMediaGroup, prtChannelGroup=prtChannelGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInputDimUnit=prtInputDimUnit, prtMarkerEntry=prtMarkerEntry, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtAlertTableV2Group=prtAlertTableV2Group, prtMediaPathEntry=prtMediaPathEntry, prtMarkerDefaultIndex=prtMarkerDefaultIndex, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtOutputTable=prtOutputTable, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, PrtMediaUnitTC=PrtMediaUnitTC, prtInput=prtInput, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerSuppliesType=prtMarkerSuppliesType, prtConsoleColor=prtConsoleColor, prtAlertTrapGroup=prtAlertTrapGroup, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputVendorName=prtInputVendorName, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInputDescription=prtInputDescription, prtMediaPathTable=prtMediaPathTable, prtInputGroup=prtInputGroup, prtMarker=prtMarker, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtConsoleLights=prtConsoleLights, prtGeneralGroup=prtGeneralGroup, prtCoverStatus=prtCoverStatus, prtInputCapacityUnit=prtInputCapacityUnit, prtOutputSecurity=prtOutputSecurity, prtOutputMaxCapacity=prtOutputMaxCapacity, prtInputMediaColor=prtInputMediaColor, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputDefaultIndex=prtOutputDefaultIndex, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMIBConformance=prtMIBConformance, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtCoverTable=prtCoverTable, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, PrtCapacityUnitTC=PrtCapacityUnitTC, prtOutputIndex=prtOutputIndex, CapacityUnit=CapacityUnit, PrtPrintOrientationTC=PrtPrintOrientationTC, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerColorantRole=prtMarkerColorantRole, PrtChannelStateTC=PrtChannelStateTC, prtOutputModel=prtOutputModel, prtGeneral=prtGeneral, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertTrainingLevel=prtAlertTrainingLevel, prtInputDefaultIndex=prtInputDefaultIndex, prtAlertIndex=prtAlertIndex, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInputMediaType=prtInputMediaType, prtConsoleLightEntry=prtConsoleLightEntry, prtAlertEntry=prtAlertEntry, prtExtendedInputGroup=prtExtendedInputGroup, prtAlertTableGroup=prtAlertTableGroup, prtMIB2Compliance=prtMIB2Compliance, printerV1Alert=printerV1Alert, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtCoverIndex=prtCoverIndex, SubUnitStatus=SubUnitStatus, prtMediaPath=prtMediaPath, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtCoverDescription=prtCoverDescription, prtInputStatus=prtInputStatus, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtDeviceRefEntry=prtDeviceRefEntry, prtGeneralPrinterName=prtGeneralPrinterName, prtInputEntry=prtInputEntry, prtMIBCompliance=prtMIBCompliance, printmib=printmib, prtOutputStatus=prtOutputStatus, prtOutputVersion=prtOutputVersion, prtConsoleOffTime=prtConsoleOffTime, prtAlertLocation=prtAlertLocation, prtMarkerColorant=prtMarkerColorant, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtConsoleLightIndex=prtConsoleLightIndex, prtGeneralEntry=prtGeneralEntry, prtInputMaxCapacity=prtInputMaxCapacity, prtInputSerialNumber=prtInputSerialNumber, prtInterpreter=prtInterpreter, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInputIndex=prtInputIndex, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtCover=prtCover, prtMarkerColorantGroup=prtMarkerColorantGroup, prtExtendedOutputGroup=prtExtendedOutputGroup, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerLifeCount=prtMarkerLifeCount, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtChannelState=prtChannelState, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtGeneralV2Group=prtGeneralV2Group, PYSNMP_MODULE_ID=printmib, prtInputSecurity=prtInputSecurity, prtOutputPageCollated=prtOutputPageCollated, prtOutputDescription=prtOutputDescription, prtAlertCriticalEvents=prtAlertCriticalEvents, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInputMediaWeight=prtInputMediaWeight, prtMarkerGroup=prtMarkerGroup, prtCoverEntry=prtCoverEntry, prtInterpreterVersion=prtInterpreterVersion, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMIBGroups=prtMIBGroups, prtInputType=prtInputType, prtMediaPathStatus=prtMediaPathStatus, prtStorageRefIndex=prtStorageRefIndex, prtInterpreterIndex=prtInterpreterIndex, prtInputMediaName=prtInputMediaName, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlertDescription=prtAlertDescription, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerMarkTech=prtMarkerMarkTech, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInputTable=prtInputTable, prtGeneralTable=prtGeneralTable, printerV2AlertPrefix=printerV2AlertPrefix, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtChannelV2Group=prtChannelV2Group, prtConsoleGroup=prtConsoleGroup, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtAlertAllEvents=prtAlertAllEvents, prtMarkerSupplies=prtMarkerSupplies, prtInterpreterGroup=prtInterpreterGroup, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInterpreterDescription=prtInterpreterDescription, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtChannelStatus=prtChannelStatus, CodedCharSet=CodedCharSet, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputCapacityUnit=prtOutputCapacityUnit, prtConsoleLightTable=prtConsoleLightTable, prtMarkerProcessColorants=prtMarkerProcessColorants, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtChannelIndex=prtChannelIndex, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerColorantIndex=prtMarkerColorantIndex, printerV2Alert=printerV2Alert, prtInterpreterLangFamily=prtInterpreterLangFamily, prtStorageRefTable=prtStorageRefTable, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtAlertTime=prtAlertTime, prtChannel=prtChannel, prtInterpreterLangVersion=prtInterpreterLangVersion, prtChannelType=prtChannelType, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtGeneralReset=prtGeneralReset, prtOutputEntry=prtOutputEntry, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtAlertGroupIndex=prtAlertGroupIndex, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtLocalizationTable=prtLocalizationTable, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutputName=prtOutputName, prtMarkerSouthMargin=prtMarkerSouthMargin, prtAlertCode=prtAlertCode, MediaUnit=MediaUnit, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputType=prtOutputType, prtAlertTable=prtAlertTable, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMediaPathIndex=prtMediaPathIndex, prtConsoleOnTime=prtConsoleOnTime, prtLocalization=prtLocalization, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtOutputBursting=prtOutputBursting)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtLocalizationCountry=prtLocalizationCountry)
