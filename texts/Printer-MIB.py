...
PrtInputTypeTC, PrtConsoleDisableTC, PrtAlertTrainingLevelTC, PrtOutputTypeTC, PrtMarkerSuppliesTypeTC, PrtAlertCodeTC, PrtAlertGroupTC, PrtChannelTypeTC, PrtInterpreterLangFamilyTC, PrtCoverStatusTC, PrtGeneralResetTC, PrtMarkerMarkTechTC, PrtMediaPathTypeTC, PrtConsoleColorTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInputTypeTC", "PrtConsoleDisableTC", "PrtAlertTrainingLevelTC", "PrtOutputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtAlertCodeTC", "PrtAlertGroupTC", "PrtChannelTypeTC", "PrtInterpreterLangFamilyTC", "PrtCoverStatusTC", "PrtGeneralResetTC", "PrtMarkerMarkTechTC", "PrtMediaPathTypeTC", "PrtConsoleColorTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtChannel=prtChannel, prtInputVendorName=prtInputVendorName, prtConsoleGroup=prtConsoleGroup, prtOutputModel=prtOutputModel, prtMarkerColorantRole=prtMarkerColorantRole, prtAlertIndex=prtAlertIndex, prtMarker=prtMarker, prtMarkerProcessColorants=prtMarkerProcessColorants, prtChannelIfIndex=prtChannelIfIndex, prtGeneralEntry=prtGeneralEntry, prtCover=prtCover, prtMarkerEntry=prtMarkerEntry, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertTableV2Group=prtAlertTableV2Group, PrtCapacityUnitTC=PrtCapacityUnitTC, prtAlertLocation=prtAlertLocation, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, printmib=printmib, prtInputMediaColor=prtInputMediaColor, prtMediaPathEntry=prtMediaPathEntry, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlertTableGroup=prtAlertTableGroup, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputDecollating=prtOutputDecollating, prtConsoleLightTable=prtConsoleLightTable, prtStorageRefTable=prtStorageRefTable, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMIB2Compliance=prtMIB2Compliance, prtExtendedOutputGroup=prtExtendedOutputGroup, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMediaPathStatus=prtMediaPathStatus, prtInputIndex=prtInputIndex, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtAlertEntry=prtAlertEntry, prtConsoleOffTime=prtConsoleOffTime, prtMarkerMarkTech=prtMarkerMarkTech, prtStorageRefEntry=prtStorageRefEntry, prtChannelState=prtChannelState, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMediaFormParts=prtInputMediaFormParts, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMIBConformance=prtMIBConformance, prtAlertDescription=prtAlertDescription, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMediaPathDescription=prtMediaPathDescription, prtConsoleLightEntry=prtConsoleLightEntry, prtOutputTable=prtOutputTable, prtGeneral=prtGeneral, prtMarkerColorant=prtMarkerColorant, prtInputSecurity=prtInputSecurity, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputType=prtOutputType, prtOutputDescription=prtOutputDescription, prtAlertAllEvents=prtAlertAllEvents, prtGeneralPrinterName=prtGeneralPrinterName, prtInputVersion=prtInputVersion, prtAlertCode=prtAlertCode, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInputEntry=prtInputEntry, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputGroup=prtInputGroup, prtInterpreterDescription=prtInterpreterDescription, prtGeneralConfigChanges=prtGeneralConfigChanges, prtConsoleColor=prtConsoleColor, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtGeneralGroup=prtGeneralGroup, prtInputType=prtInputType, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtConsoleLights=prtConsoleLights, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, printerV2AlertPrefix=printerV2AlertPrefix, prtInput=prtInput, prtOutputSecurity=prtOutputSecurity, prtMarkerColorantTable=prtMarkerColorantTable, prtDeviceRefTable=prtDeviceRefTable, prtConsoleOnTime=prtConsoleOnTime, prtInputStatus=prtInputStatus, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtChannelV2Group=prtChannelV2Group, prtLocalization=prtLocalization, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMarkerNorthMargin=prtMarkerNorthMargin, prtOutputPageCollated=prtOutputPageCollated, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtLocalizationIndex=prtLocalizationIndex, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtChannelGroup=prtChannelGroup, prtChannelStatus=prtChannelStatus, prtLocalizationLanguage=prtLocalizationLanguage, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtLocalizationTable=prtLocalizationTable, prtCoverTable=prtCoverTable, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtAlert=prtAlert, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMarkerIndex=prtMarkerIndex, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMediaPath=prtMediaPath, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, PresentOnOff=PresentOnOff, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputMediaGroup=prtInputMediaGroup, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterEntry=prtInterpreterEntry, CapacityUnit=CapacityUnit, prtInputName=prtInputName, prtCoverEntry=prtCoverEntry, prtOutputStackingOrder=prtOutputStackingOrder, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInterpreterGroup=prtInterpreterGroup, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtConsoleLightIndex=prtConsoleLightIndex, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtExtendedInputGroup=prtExtendedInputGroup, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMIB2Groups=prtMIB2Groups, prtOutputGroup=prtOutputGroup, prtStorageRefIndex=prtStorageRefIndex, prtOutputIndex=prtOutputIndex, prtChannelInformation=prtChannelInformation, prtInputDimUnit=prtInputDimUnit, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerColorantIndex=prtMarkerColorantIndex, prtInterpreterIndex=prtInterpreterIndex, prtMarkerColorantTonality=prtMarkerColorantTonality, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputTable=prtInputTable, prtGeneralSerialNumber=prtGeneralSerialNumber, prtConsoleDisable=prtConsoleDisable, prtMediaPathGroup=prtMediaPathGroup, prtChannelIndex=prtChannelIndex, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtOutput=prtOutput, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInterpreterTable=prtInterpreterTable, prtOutputName=prtOutputName, prtLocalizationEntry=prtLocalizationEntry, prtInterpreter=prtInterpreter, prtInputMediaWeight=prtInputMediaWeight, prtInputSwitchingGroup=prtInputSwitchingGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtChannelEntry=prtChannelEntry, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMediaPathTable=prtMediaPathTable, prtAlertCriticalEvents=prtAlertCriticalEvents, prtCoverStatus=prtCoverStatus, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputBursting=prtOutputBursting, prtInputDescription=prtInputDescription, prtInputCapacityUnit=prtInputCapacityUnit, prtInputMaxCapacity=prtInputMaxCapacity, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerTable=prtMarkerTable, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, PYSNMP_MODULE_ID=printmib, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInputDefaultIndex=prtInputDefaultIndex, prtMIBCompliance=prtMIBCompliance, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMIBGroups=prtMIBGroups, prtMarkerColorantGroup=prtMarkerColorantGroup, SubUnitStatus=SubUnitStatus, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMediaPathType=prtMediaPathType, prtLocalizationCountry=prtLocalizationCountry, prtMarkerStatus=prtMarkerStatus, CodedCharSet=CodedCharSet, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerWestMargin=prtMarkerWestMargin, prtInterpreterLangFamily=prtInterpreterLangFamily, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInputMediaName=prtInputMediaName, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerSuppliesType=prtMarkerSuppliesType, MediaUnit=MediaUnit, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtOutputVendorName=prtOutputVendorName, prtAlertTimeGroup=prtAlertTimeGroup, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutputDefaultIndex=prtOutputDefaultIndex, prtCoverDescription=prtCoverDescription, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputNextIndex=prtInputNextIndex, printerV2Alert=printerV2Alert, prtOutputVersion=prtOutputVersion, prtAlertGroup=prtAlertGroup, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMediaPathIndex=prtMediaPathIndex, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, printerV1Alert=printerV1Alert, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtGeneralServicePerson=prtGeneralServicePerson, prtOutputDimUnit=prtOutputDimUnit, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMarkerSupplies=prtMarkerSupplies, prtConsoleDescription=prtConsoleDescription, prtGeneralTable=prtGeneralTable, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtGeneralV2Group=prtGeneralV2Group, prtGeneralReset=prtGeneralReset, prtCoverIndex=prtCoverIndex, prtChannelTable=prtChannelTable, prtOutputEntry=prtOutputEntry, prtOutputCapacityUnit=prtOutputCapacityUnit, prtAlertGroupIndex=prtAlertGroupIndex, prtInputModel=prtInputModel, prtMarkerEastMargin=prtMarkerEastMargin, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInterpreterVersion=prtInterpreterVersion, prtOutputStatus=prtOutputStatus, prtMarkerGroup=prtMarkerGroup, prtChannelProtocolVersion=prtChannelProtocolVersion, prtAlertTime=prtAlertTime, prtInputMediaType=prtInputMediaType, prtMarkerColorantValue=prtMarkerColorantValue, prtConsoleLocalization=prtConsoleLocalization, prtChannelType=prtChannelType, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtAlertTable=prtAlertTable, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, PrtChannelStateTC=PrtChannelStateTC, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable)
mibBuilder.exportSymbols("Printer-MIB", PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputSerialNumber=prtInputSerialNumber, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir)
