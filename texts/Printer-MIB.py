...
PrtOutputTypeTC, PrtConsoleColorTC, PrtConsoleDisableTC, PrtCoverStatusTC, PrtInterpreterLangFamilyTC, PrtMarkerMarkTechTC, PrtMediaPathTypeTC, PrtInputTypeTC, PrtAlertCodeTC, PrtAlertGroupTC, PrtGeneralResetTC, PrtAlertTrainingLevelTC, PrtMarkerSuppliesTypeTC, PrtChannelTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtOutputTypeTC", "PrtConsoleColorTC", "PrtConsoleDisableTC", "PrtCoverStatusTC", "PrtInterpreterLangFamilyTC", "PrtMarkerMarkTechTC", "PrtMediaPathTypeTC", "PrtInputTypeTC", "PrtAlertCodeTC", "PrtAlertGroupTC", "PrtGeneralResetTC", "PrtAlertTrainingLevelTC", "PrtMarkerSuppliesTypeTC", "PrtChannelTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtConsoleLightIndex=prtConsoleLightIndex, prtConsoleGroup=prtConsoleGroup, prtMarkerColorantValue=prtMarkerColorantValue, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtConsoleDescription=prtConsoleDescription, prtExtendedInputGroup=prtExtendedInputGroup, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMIBCompliance=prtMIBCompliance, prtInputTable=prtInputTable, prtChannelGroup=prtChannelGroup, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMediaPathGroup=prtMediaPathGroup, prtMediaPathTable=prtMediaPathTable, prtOutputStatus=prtOutputStatus, prtAlertIndex=prtAlertIndex, prtCoverDescription=prtCoverDescription, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtOutputMaxCapacity=prtOutputMaxCapacity, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMIB2Groups=prtMIB2Groups, prtMediaPathEntry=prtMediaPathEntry, prtChannelTable=prtChannelTable, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtStorageRefTable=prtStorageRefTable, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputEntry=prtInputEntry, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerStatus=prtMarkerStatus, prtOutputPageCollated=prtOutputPageCollated, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreter=prtInterpreter, prtChannelState=prtChannelState, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtOutputDescription=prtOutputDescription, prtInterpreterEntry=prtInterpreterEntry, PrtPrintOrientationTC=PrtPrintOrientationTC, prtAlertTable=prtAlertTable, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputDescription=prtInputDescription, prtInputMediaType=prtInputMediaType, prtInputMediaGroup=prtInputMediaGroup, prtInterpreterDescription=prtInterpreterDescription, prtMarkerGroup=prtMarkerGroup, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputVendorName=prtOutputVendorName, prtMarkerNorthMargin=prtMarkerNorthMargin, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtConsoleOffTime=prtConsoleOffTime, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputTable=prtOutputTable, prtOutputSecurity=prtOutputSecurity, prtAlertGroupIndex=prtAlertGroupIndex, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMIBConformance=prtMIBConformance, prtCoverEntry=prtCoverEntry, prtChannelStatus=prtChannelStatus, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMarkerWestMargin=prtMarkerWestMargin, prtInterpreterLangLevel=prtInterpreterLangLevel, prtConsoleLightTable=prtConsoleLightTable, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtChannelEntry=prtChannelEntry, prtInputCapacityUnit=prtInputCapacityUnit, prtGeneralReset=prtGeneralReset, prtGeneralPrinterName=prtGeneralPrinterName, prtOutputEntry=prtOutputEntry, prtMediaPathStatus=prtMediaPathStatus, prtChannelIfIndex=prtChannelIfIndex, prtGeneralGroup=prtGeneralGroup, prtInputStatus=prtInputStatus, prtMarkerColorant=prtMarkerColorant, prtInterpreterIndex=prtInterpreterIndex, prtChannelV2Group=prtChannelV2Group, SubUnitStatus=SubUnitStatus, prtInterpreterVersion=prtInterpreterVersion, prtCoverTable=prtCoverTable, prtMediaPathIndex=prtMediaPathIndex, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputMaxCapacity=prtInputMaxCapacity, prtMarkerEastMargin=prtMarkerEastMargin, prtLocalization=prtLocalization, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInputDimUnit=prtInputDimUnit, prtInputSwitchingGroup=prtInputSwitchingGroup, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputCapacityUnit=prtOutputCapacityUnit, prtDeviceRefEntry=prtDeviceRefEntry, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMediaPathDescription=prtMediaPathDescription, prtInputIndex=prtInputIndex, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, PrtMediaUnitTC=PrtMediaUnitTC, prtAlertTime=prtAlertTime, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInterpreterTable=prtInterpreterTable, prtMarkerColorantTable=prtMarkerColorantTable, prtOutputDecollating=prtOutputDecollating, prtInputName=prtInputName, prtOutputDimUnit=prtOutputDimUnit, prtAlertCode=prtAlertCode, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtGeneralConfigChanges=prtGeneralConfigChanges, prtDeviceRefTable=prtDeviceRefTable, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerTable=prtMarkerTable, prtAlertGroup=prtAlertGroup, prtExtendedOutputGroup=prtExtendedOutputGroup, prtLocalizationEntry=prtLocalizationEntry, prtGeneralTable=prtGeneralTable, prtConsoleDisable=prtConsoleDisable, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarkerMarkTech=prtMarkerMarkTech, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtOutputType=prtOutputType, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarker=prtMarker, prtInputCurrentLevel=prtInputCurrentLevel, prtCoverStatus=prtCoverStatus, prtLocalizationCountry=prtLocalizationCountry, prtChannelInformation=prtChannelInformation, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtOutputBursting=prtOutputBursting, printmib=printmib, PYSNMP_MODULE_ID=printmib, prtInputVendorName=prtInputVendorName, prtInputSerialNumber=prtInputSerialNumber, prtOutputModel=prtOutputModel, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerLifeCount=prtMarkerLifeCount, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMediaPathType=prtMediaPathType, prtGeneralEntry=prtGeneralEntry, prtInputType=prtInputType, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, MediaUnit=MediaUnit, prtConsoleLightEntry=prtConsoleLightEntry, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInterpreterGroup=prtInterpreterGroup, prtGeneralV2Group=prtGeneralV2Group, prtMarkerColorantEntry=prtMarkerColorantEntry, prtStorageRefEntry=prtStorageRefEntry, prtAlertTimeGroup=prtAlertTimeGroup, prtCoverIndex=prtCoverIndex, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtConsoleLights=prtConsoleLights, prtAlertLocation=prtAlertLocation, printerV2AlertPrefix=printerV2AlertPrefix, prtConsoleOnTime=prtConsoleOnTime, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtGeneral=prtGeneral, prtOutputStackingOrder=prtOutputStackingOrder, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, PresentOnOff=PresentOnOff, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtStorageRefIndex=prtStorageRefIndex, prtInput=prtInput, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerColorantIndex=prtMarkerColorantIndex, prtAlertAllEvents=prtAlertAllEvents, PrtChannelStateTC=PrtChannelStateTC, prtOutput=prtOutput, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInputMediaColor=prtInputMediaColor, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, printerV2Alert=printerV2Alert, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInputMediaWeight=prtInputMediaWeight, prtMarkerEntry=prtMarkerEntry, prtOutputSerialNumber=prtOutputSerialNumber, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputGroup=prtInputGroup, prtChannel=prtChannel, prtConsoleLocalization=prtConsoleLocalization, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtCover=prtCover, prtInterpreterLangVersion=prtInterpreterLangVersion, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtAlertEntry=prtAlertEntry, prtInputNextIndex=prtInputNextIndex, prtAlertTableGroup=prtAlertTableGroup, prtInputModel=prtInputModel, prtAlert=prtAlert, prtAlertDescription=prtAlertDescription, prtLocalizationTable=prtLocalizationTable, prtOutputVersion=prtOutputVersion, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMIB2Compliance=prtMIB2Compliance, prtMarkerSupplies=prtMarkerSupplies, prtMarkerProcessColorants=prtMarkerProcessColorants, prtChannelType=prtChannelType, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtOutputName=prtOutputName, prtOutputIndex=prtOutputIndex, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInputSecurity=prtInputSecurity, prtOutputGroup=prtOutputGroup, prtOutputDimensionsGroup=prtOutputDimensionsGroup, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMIBGroups=prtMIBGroups, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMediaPath=prtMediaPath, CodedCharSet=CodedCharSet, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtConsoleColor=prtConsoleColor, printerV1Alert=printerV1Alert, prtGeneralSerialNumber=prtGeneralSerialNumber, prtChannelIndex=prtChannelIndex, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtLocalizationIndex=prtLocalizationIndex, prtMarkerIndex=prtMarkerIndex, CapacityUnit=CapacityUnit, prtAlertTrapGroup=prtAlertTrapGroup)
mibBuilder.exportSymbols("Printer-MIB", prtInputVersion=prtInputVersion, prtInputMediaName=prtInputMediaName, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex)
