...
PrtGeneralResetTC, PrtOutputTypeTC, PrtMediaPathTypeTC, PrtInterpreterLangFamilyTC, PrtAlertGroupTC, PrtMarkerSuppliesTypeTC, PrtChannelTypeTC, PrtAlertTrainingLevelTC, PrtConsoleDisableTC, PrtInputTypeTC, PrtCoverStatusTC, PrtAlertCodeTC, PrtMarkerMarkTechTC, PrtConsoleColorTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtGeneralResetTC", "PrtOutputTypeTC", "PrtMediaPathTypeTC", "PrtInterpreterLangFamilyTC", "PrtAlertGroupTC", "PrtMarkerSuppliesTypeTC", "PrtChannelTypeTC", "PrtAlertTrainingLevelTC", "PrtConsoleDisableTC", "PrtInputTypeTC", "PrtCoverStatusTC", "PrtAlertCodeTC", "PrtMarkerMarkTechTC", "PrtConsoleColorTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInputSwitchingGroup=prtInputSwitchingGroup, prtOutputDecollating=prtOutputDecollating, prtMIBConformance=prtMIBConformance, prtInputCurrentLevel=prtInputCurrentLevel, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtAlertGroup=prtAlertGroup, prtInputVersion=prtInputVersion, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtConsoleLightTable=prtConsoleLightTable, prtInputMediaColor=prtInputMediaColor, prtMediaPathType=prtMediaPathType, prtInputMediaGroup=prtInputMediaGroup, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtMarkerGroup=prtMarkerGroup, prtInputModel=prtInputModel, prtOutputDefaultIndex=prtOutputDefaultIndex, prtAlertSeverityLevel=prtAlertSeverityLevel, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtAlertEntry=prtAlertEntry, prtAlertGroupIndex=prtAlertGroupIndex, prtAlertTime=prtAlertTime, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtChannelType=prtChannelType, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtChannelV2Group=prtChannelV2Group, prtChannelGroup=prtChannelGroup, prtOutputMaxCapacity=prtOutputMaxCapacity, printerV1Alert=printerV1Alert, prtInputMediaWeight=prtInputMediaWeight, prtMIB2Groups=prtMIB2Groups, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtStorageRefIndex=prtStorageRefIndex, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtConsoleColor=prtConsoleColor, prtInterpreterTable=prtInterpreterTable, prtAlertLocation=prtAlertLocation, prtStorageRefEntry=prtStorageRefEntry, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtAlertDescription=prtAlertDescription, prtOutputName=prtOutputName, prtInterpreter=prtInterpreter, prtMediaPath=prtMediaPath, prtInputType=prtInputType, prtAlert=prtAlert, prtInputSerialNumber=prtInputSerialNumber, prtInputIndex=prtInputIndex, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerNorthMargin=prtMarkerNorthMargin, prtOutputType=prtOutputType, prtInputVendorName=prtInputVendorName, prtMIB2Compliance=prtMIB2Compliance, prtOutputCapacityUnit=prtOutputCapacityUnit, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutputModel=prtOutputModel, prtChannelIndex=prtChannelIndex, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtAlertTrainingLevel=prtAlertTrainingLevel, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMarkerLifeCount=prtMarkerLifeCount, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMediaPathTable=prtMediaPathTable, prtLocalizationLanguage=prtLocalizationLanguage, prtChannelTable=prtChannelTable, prtExtendedInputGroup=prtExtendedInputGroup, prtChannelState=prtChannelState, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputDescription=prtInputDescription, prtConsoleLightEntry=prtConsoleLightEntry, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMediaPathEntry=prtMediaPathEntry, prtMarkerSupplies=prtMarkerSupplies, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtOutputStatus=prtOutputStatus, prtInterpreterLangFamily=prtInterpreterLangFamily, prtAlertAllEvents=prtAlertAllEvents, prtInputMediaType=prtInputMediaType, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMarkerWestMargin=prtMarkerWestMargin, prtCoverIndex=prtCoverIndex, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtChannel=prtChannel, prtChannelIfIndex=prtChannelIfIndex, prtInterpreterEntry=prtInterpreterEntry, prtOutputGroup=prtOutputGroup, prtCoverDescription=prtCoverDescription, prtDeviceRefIndex=prtDeviceRefIndex, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInputGroup=prtInputGroup, prtMarkerStatus=prtMarkerStatus, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInterpreterIndex=prtInterpreterIndex, prtOutputEntry=prtOutputEntry, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtConsoleLights=prtConsoleLights, prtDeviceRefTable=prtDeviceRefTable, prtConsoleDisable=prtConsoleDisable, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerEntry=prtMarkerEntry, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMarkerColorantRole=prtMarkerColorantRole, prtConsoleOffTime=prtConsoleOffTime, prtOutputOffsetStacking=prtOutputOffsetStacking, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInterpreterDescription=prtInterpreterDescription, SubUnitStatus=SubUnitStatus, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtLocalizationTable=prtLocalizationTable, prtInputMediaName=prtInputMediaName, prtMarkerColorantGroup=prtMarkerColorantGroup, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutput=prtOutput, prtGeneralTable=prtGeneralTable, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInput=prtInput, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtCoverStatus=prtCoverStatus, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerTable=prtMarkerTable, prtMediaPathDescription=prtMediaPathDescription, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtOutputVersion=prtOutputVersion, prtOutputSecurity=prtOutputSecurity, prtMarkerColorantTonality=prtMarkerColorantTonality, prtChannelEntry=prtChannelEntry, prtMediaPathStatus=prtMediaPathStatus, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtOutputBursting=prtOutputBursting, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtChannelStatus=prtChannelStatus, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInterpreterGroup=prtInterpreterGroup, prtStorageRefTable=prtStorageRefTable, prtOutputPageCollated=prtOutputPageCollated, prtMarkerColorantEntry=prtMarkerColorantEntry, prtAlertTable=prtAlertTable, prtLocalizationIndex=prtLocalizationIndex, prtCover=prtCover, prtConsoleOnTime=prtConsoleOnTime, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtConsoleDescription=prtConsoleDescription, MediaUnit=MediaUnit, prtOutputVendorName=prtOutputVendorName, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, PrtChannelStateTC=PrtChannelStateTC, prtOutputIndex=prtOutputIndex, prtGeneralEntry=prtGeneralEntry, prtInputMediaFormParts=prtInputMediaFormParts, prtChannelInformation=prtChannelInformation, prtInterpreterVersion=prtInterpreterVersion, prtMediaPathGroup=prtMediaPathGroup, prtConsoleLightIndex=prtConsoleLightIndex, prtGeneralV2Group=prtGeneralV2Group, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputStatus=prtInputStatus, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtChannelProtocolVersion=prtChannelProtocolVersion, prtAlertIndex=prtAlertIndex, prtConsoleLocalization=prtConsoleLocalization, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputTable=prtOutputTable, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerSpotColorants=prtMarkerSpotColorants, prtDeviceRefEntry=prtDeviceRefEntry, prtInputNextIndex=prtInputNextIndex, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerColorantValue=prtMarkerColorantValue, prtLocalization=prtLocalization, CodedCharSet=CodedCharSet, prtAlertTimeGroup=prtAlertTimeGroup, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerSuppliesType=prtMarkerSuppliesType, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerMarkTech=prtMarkerMarkTech, printerV2AlertPrefix=printerV2AlertPrefix, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtOutputDimUnit=prtOutputDimUnit, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInputCapacityUnit=prtInputCapacityUnit, prtGeneralGroup=prtGeneralGroup, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerEastMargin=prtMarkerEastMargin, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMarker=prtMarker, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtOutputSerialNumber=prtOutputSerialNumber, prtAlertCode=prtAlertCode, prtOutputDescription=prtOutputDescription, prtMIBGroups=prtMIBGroups, prtInputDimUnit=prtInputDimUnit, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, PYSNMP_MODULE_ID=printmib, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInputSecurity=prtInputSecurity, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMediaPathIndex=prtMediaPathIndex, prtGeneral=prtGeneral, prtConsoleGroup=prtConsoleGroup, prtAlertTableV2Group=prtAlertTableV2Group, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, printmib=printmib, prtInputTable=prtInputTable, prtMarkerIndex=prtMarkerIndex, CapacityUnit=CapacityUnit, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInputMaxCapacity=prtInputMaxCapacity, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInputDefaultIndex=prtInputDefaultIndex, prtInputEntry=prtInputEntry, prtInterpreterLangVersion=prtInterpreterLangVersion, prtGeneralReset=prtGeneralReset, prtInputName=prtInputName, prtLocalizationCountry=prtLocalizationCountry, prtMIBCompliance=prtMIBCompliance, prtExtendedOutputGroup=prtExtendedOutputGroup, prtAlertTableGroup=prtAlertTableGroup, prtCoverTable=prtCoverTable, prtCoverEntry=prtCoverEntry, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMarkerCounterUnit=prtMarkerCounterUnit, prtLocalizationEntry=prtLocalizationEntry, PresentOnOff=PresentOnOff)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerColorant=prtMarkerColorant, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, printerV2Alert=printerV2Alert)
