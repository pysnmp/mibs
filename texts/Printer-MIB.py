...
PrtMarkerMarkTechTC, PrtChannelTypeTC, PrtCoverStatusTC, PrtConsoleColorTC, PrtAlertCodeTC, PrtMarkerSuppliesTypeTC, PrtMediaPathTypeTC, PrtInterpreterLangFamilyTC, PrtGeneralResetTC, PrtOutputTypeTC, PrtConsoleDisableTC, PrtInputTypeTC, PrtAlertTrainingLevelTC, PrtAlertGroupTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerMarkTechTC", "PrtChannelTypeTC", "PrtCoverStatusTC", "PrtConsoleColorTC", "PrtAlertCodeTC", "PrtMarkerSuppliesTypeTC", "PrtMediaPathTypeTC", "PrtInterpreterLangFamilyTC", "PrtGeneralResetTC", "PrtOutputTypeTC", "PrtConsoleDisableTC", "PrtInputTypeTC", "PrtAlertTrainingLevelTC", "PrtAlertGroupTC")
...
mibBuilder.exportSymbols("Printer-MIB", CodedCharSet=CodedCharSet, prtAlertGroup=prtAlertGroup, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtChannelV2Group=prtChannelV2Group, prtOutputMaxCapacity=prtOutputMaxCapacity, PresentOnOff=PresentOnOff, prtInterpreterTwoWay=prtInterpreterTwoWay, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtStorageRefEntry=prtStorageRefEntry, prtChannelIndex=prtChannelIndex, prtOutputVendorName=prtOutputVendorName, prtOutputVersion=prtOutputVersion, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtLocalizationIndex=prtLocalizationIndex, prtMarkerSupplies=prtMarkerSupplies, prtInputSerialNumber=prtInputSerialNumber, MediaUnit=MediaUnit, prtMarkerColorantValue=prtMarkerColorantValue, prtInterpreterLangLevel=prtInterpreterLangLevel, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtInputMediaGroup=prtInputMediaGroup, prtAlertAllEvents=prtAlertAllEvents, PrtChannelStateTC=PrtChannelStateTC, prtCoverEntry=prtCoverEntry, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInputName=prtInputName, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtInterpreterGroup=prtInterpreterGroup, printerV2Alert=printerV2Alert, prtInputVersion=prtInputVersion, prtMarkerGroup=prtMarkerGroup, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtAlertCode=prtAlertCode, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerMarkTech=prtMarkerMarkTech, prtMediaPathIndex=prtMediaPathIndex, prtConsoleDescription=prtConsoleDescription, prtInterpreterLangVersion=prtInterpreterLangVersion, prtLocalizationTable=prtLocalizationTable, prtMediaPathEntry=prtMediaPathEntry, prtMIBGroups=prtMIBGroups, prtAlertDescription=prtAlertDescription, prtGeneralV2Group=prtGeneralV2Group, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputMediaType=prtInputMediaType, prtMediaPathType=prtMediaPathType, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtConsoleLocalization=prtConsoleLocalization, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtAlertTrainingLevel=prtAlertTrainingLevel, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputGroup=prtOutputGroup, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerNorthMargin=prtMarkerNorthMargin, printerV1Alert=printerV1Alert, prtInputNextIndex=prtInputNextIndex, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtConsoleLightEntry=prtConsoleLightEntry, prtGeneral=prtGeneral, prtAlertTimeGroup=prtAlertTimeGroup, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtConsoleGroup=prtConsoleGroup, prtInput=prtInput, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputSecurity=prtInputSecurity, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerTable=prtMarkerTable, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInputDescription=prtInputDescription, prtOutputName=prtOutputName, prtInputStatus=prtInputStatus, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtGeneralServicePerson=prtGeneralServicePerson, prtGeneralReset=prtGeneralReset, prtAlert=prtAlert, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtLocalizationCountry=prtLocalizationCountry, prtOutputStackingOrder=prtOutputStackingOrder, prtInputDimUnit=prtInputDimUnit, prtInputMaxCapacity=prtInputMaxCapacity, prtLocalizationEntry=prtLocalizationEntry, prtOutputModel=prtOutputModel, prtChannelInformation=prtChannelInformation, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtAlertLocation=prtAlertLocation, prtInputSwitchingGroup=prtInputSwitchingGroup, prtCoverStatus=prtCoverStatus, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInputType=prtInputType, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputDescription=prtOutputDescription, prtMIB2Groups=prtMIB2Groups, prtAlertIndex=prtAlertIndex, prtOutputStatus=prtOutputStatus, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtOutputBursting=prtOutputBursting, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputEntry=prtInputEntry, prtLocalizationLanguage=prtLocalizationLanguage, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtAlertSeverityLevel=prtAlertSeverityLevel, prtChannelTable=prtChannelTable, prtInputGroup=prtInputGroup, prtInterpreterTable=prtInterpreterTable, prtMarkerColorantEntry=prtMarkerColorantEntry, prtCoverIndex=prtCoverIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, PrtMediaUnitTC=PrtMediaUnitTC, prtAlertTableGroup=prtAlertTableGroup, prtMIBCompliance=prtMIBCompliance, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtOutputPageCollated=prtOutputPageCollated, prtMarkerLifeCount=prtMarkerLifeCount, prtInputMediaColor=prtInputMediaColor, prtInterpreterDescription=prtInterpreterDescription, prtGeneralGroup=prtGeneralGroup, prtMarkerEastMargin=prtMarkerEastMargin, prtOutputSerialNumber=prtOutputSerialNumber, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerColorantTonality=prtMarkerColorantTonality, prtGeneralEntry=prtGeneralEntry, prtConsoleOnTime=prtConsoleOnTime, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMIB2Compliance=prtMIB2Compliance, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputIndex=prtOutputIndex, prtMarkerSouthMargin=prtMarkerSouthMargin, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtConsoleLightIndex=prtConsoleLightIndex, prtAlertTime=prtAlertTime, prtExtendedOutputGroup=prtExtendedOutputGroup, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, printmib=printmib, prtMediaPath=prtMediaPath, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerIndex=prtMarkerIndex, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerColorant=prtMarkerColorant, prtOutputDecollating=prtOutputDecollating, prtStorageRefTable=prtStorageRefTable, prtGeneralPrinterName=prtGeneralPrinterName, prtAlertTableV2Group=prtAlertTableV2Group, prtChannelProtocolVersion=prtChannelProtocolVersion, prtConsoleColor=prtConsoleColor, prtInputMediaFormParts=prtInputMediaFormParts, prtMediaPathGroup=prtMediaPathGroup, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtAlertEntry=prtAlertEntry, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInputMediaWeight=prtInputMediaWeight, prtChannel=prtChannel, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtOutputFeaturesGroup=prtOutputFeaturesGroup, printerV2AlertPrefix=printerV2AlertPrefix, prtMarkerColorantTable=prtMarkerColorantTable, prtInterpreter=prtInterpreter, prtInputVendorName=prtInputVendorName, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInterpreterEntry=prtInterpreterEntry, prtConsoleLights=prtConsoleLights, prtInputModel=prtInputModel, prtGeneralTable=prtGeneralTable, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputMediaName=prtInputMediaName, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtLocalization=prtLocalization, prtCover=prtCover, prtMarkerStatus=prtMarkerStatus, prtOutputSecurity=prtOutputSecurity, prtGeneralConfigChanges=prtGeneralConfigChanges, prtDeviceRefTable=prtDeviceRefTable, prtMIBConformance=prtMIBConformance, prtMarkerEntry=prtMarkerEntry, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInputDefaultIndex=prtInputDefaultIndex, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputTable=prtInputTable, prtOutput=prtOutput, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerWestMargin=prtMarkerWestMargin, prtConsoleLightTable=prtConsoleLightTable, prtExtendedInputGroup=prtExtendedInputGroup, CapacityUnit=CapacityUnit, prtMediaPathStatus=prtMediaPathStatus, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleDisable=prtConsoleDisable, prtMediaPathTable=prtMediaPathTable, prtChannelState=prtChannelState, prtAlertCriticalEvents=prtAlertCriticalEvents, prtCoverDescription=prtCoverDescription, prtStorageRefIndex=prtStorageRefIndex, prtOutputType=prtOutputType, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtAlertTable=prtAlertTable, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtCoverTable=prtCoverTable, prtInputIndex=prtInputIndex, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMediaPathDescription=prtMediaPathDescription, PYSNMP_MODULE_ID=printmib, prtChannelEntry=prtChannelEntry, prtOutputEntry=prtOutputEntry, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerColorantRole=prtMarkerColorantRole, prtChannelGroup=prtChannelGroup, prtInterpreterVersion=prtInterpreterVersion, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtChannelIfIndex=prtChannelIfIndex, prtInterpreterIndex=prtInterpreterIndex, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputTable=prtOutputTable, prtChannelStatus=prtChannelStatus, prtInterpreterLangFamily=prtInterpreterLangFamily, prtChannelType=prtChannelType, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputDimUnit=prtOutputDimUnit, prtDeviceRefEntry=prtDeviceRefEntry, prtInputCurrentLevel=prtInputCurrentLevel, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared)
mibBuilder.exportSymbols("Printer-MIB", prtInputCapacityUnit=prtInputCapacityUnit, SubUnitStatus=SubUnitStatus, prtConsoleOffTime=prtConsoleOffTime, prtMarker=prtMarker)
