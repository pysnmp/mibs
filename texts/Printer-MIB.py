...
PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC, PrtAlertGroupTC, PrtCoverStatusTC, PrtOutputTypeTC, PrtAlertCodeTC, PrtConsoleColorTC, PrtChannelTypeTC, PrtMarkerSuppliesTypeTC, PrtInputTypeTC, PrtAlertTrainingLevelTC, PrtConsoleDisableTC, PrtMarkerMarkTechTC, PrtGeneralResetTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC", "PrtAlertGroupTC", "PrtCoverStatusTC", "PrtOutputTypeTC", "PrtAlertCodeTC", "PrtConsoleColorTC", "PrtChannelTypeTC", "PrtMarkerSuppliesTypeTC", "PrtInputTypeTC", "PrtAlertTrainingLevelTC", "PrtConsoleDisableTC", "PrtMarkerMarkTechTC", "PrtGeneralResetTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInputGroup=prtInputGroup, prtMarkerMarkTech=prtMarkerMarkTech, prtGeneralTable=prtGeneralTable, prtMarkerEastMargin=prtMarkerEastMargin, prtMediaPathTable=prtMediaPathTable, prtConsoleLocalization=prtConsoleLocalization, prtMarkerIndex=prtMarkerIndex, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtOutputSecurity=prtOutputSecurity, prtMarkerLifeCount=prtMarkerLifeCount, prtAlertIndex=prtAlertIndex, CodedCharSet=CodedCharSet, prtGeneralReset=prtGeneralReset, prtOutputVersion=prtOutputVersion, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInterpreterGroup=prtInterpreterGroup, prtConsoleGroup=prtConsoleGroup, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, printmib=printmib, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerColorantValue=prtMarkerColorantValue, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtCoverEntry=prtCoverEntry, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtOutputStackingOrder=prtOutputStackingOrder, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputNextIndex=prtInputNextIndex, prtLocalizationTable=prtLocalizationTable, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtConsoleColor=prtConsoleColor, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtStorageRefTable=prtStorageRefTable, prtInputMediaType=prtInputMediaType, prtOutputModel=prtOutputModel, CapacityUnit=CapacityUnit, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterVersion=prtInterpreterVersion, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerGroup=prtMarkerGroup, prtCoverDescription=prtCoverDescription, prtOutputIndex=prtOutputIndex, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerColorantTable=prtMarkerColorantTable, prtChannelStatus=prtChannelStatus, prtGeneralV2Group=prtGeneralV2Group, prtAlertEntry=prtAlertEntry, prtInputModel=prtInputModel, prtMarkerSouthMargin=prtMarkerSouthMargin, SubUnitStatus=SubUnitStatus, prtOutputSerialNumber=prtOutputSerialNumber, prtChannelV2Group=prtChannelV2Group, prtInputVendorName=prtInputVendorName, prtOutputPageCollated=prtOutputPageCollated, prtChannelState=prtChannelState, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputStatus=prtInputStatus, prtCoverIndex=prtCoverIndex, prtLocalizationIndex=prtLocalizationIndex, PYSNMP_MODULE_ID=printmib, prtInputSecurity=prtInputSecurity, prtLocalizationCountry=prtLocalizationCountry, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtChannelType=prtChannelType, PrtPrintOrientationTC=PrtPrintOrientationTC, prtAlertTrapGroup=prtAlertTrapGroup, prtMarker=prtMarker, PrtChannelStateTC=PrtChannelStateTC, prtChannelIndex=prtChannelIndex, prtMIBCompliance=prtMIBCompliance, prtAlertSeverityLevel=prtAlertSeverityLevel, prtChannelInformation=prtChannelInformation, prtGeneralEntry=prtGeneralEntry, PrtCapacityUnitTC=PrtCapacityUnitTC, prtDeviceRefIndex=prtDeviceRefIndex, prtChannelEntry=prtChannelEntry, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtAlertTable=prtAlertTable, prtAlertTime=prtAlertTime, prtOutputGroup=prtOutputGroup, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, printerV1Alert=printerV1Alert, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputVendorName=prtOutputVendorName, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtCoverStatus=prtCoverStatus, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInterpreter=prtInterpreter, prtMarkerNorthMargin=prtMarkerNorthMargin, prtAlert=prtAlert, prtOutputDimUnit=prtOutputDimUnit, prtAlertTimeGroup=prtAlertTimeGroup, prtConsoleOffTime=prtConsoleOffTime, prtMediaPathType=prtMediaPathType, PresentOnOff=PresentOnOff, prtMarkerTable=prtMarkerTable, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInputIndex=prtInputIndex, prtInputCurrentLevel=prtInputCurrentLevel, prtAlertAllEvents=prtAlertAllEvents, prtInputMediaFormParts=prtInputMediaFormParts, prtGeneralGroup=prtGeneralGroup, prtConsoleLightEntry=prtConsoleLightEntry, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInterpreterEntry=prtInterpreterEntry, prtCoverTable=prtCoverTable, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMIBConformance=prtMIBConformance, prtConsoleLightTable=prtConsoleLightTable, prtMarkerSuppliesType=prtMarkerSuppliesType, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtOutputBursting=prtOutputBursting, prtInputDimUnit=prtInputDimUnit, prtMediaPathGroup=prtMediaPathGroup, prtAlertGroupIndex=prtAlertGroupIndex, prtInput=prtInput, prtGeneralConfigChanges=prtGeneralConfigChanges, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInterpreterTwoWay=prtInterpreterTwoWay, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMediaPathIndex=prtMediaPathIndex, PrtMediaUnitTC=PrtMediaUnitTC, prtMediaPathStatus=prtMediaPathStatus, prtInputMediaGroup=prtInputMediaGroup, prtInterpreterDescription=prtInterpreterDescription, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerColorantRole=prtMarkerColorantRole, prtConsoleLights=prtConsoleLights, prtMarkerColorant=prtMarkerColorant, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtChannelGroup=prtChannelGroup, prtOutputEntry=prtOutputEntry, prtDeviceRefTable=prtDeviceRefTable, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputName=prtInputName, prtOutputType=prtOutputType, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInputCapacityUnit=prtInputCapacityUnit, prtInputMediaName=prtInputMediaName, prtOutputStatus=prtOutputStatus, prtLocalizationEntry=prtLocalizationEntry, prtOutput=prtOutput, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInputTable=prtInputTable, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerWestMargin=prtMarkerWestMargin, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInputVersion=prtInputVersion, prtInputType=prtInputType, prtInputSerialNumber=prtInputSerialNumber, prtAlertCode=prtAlertCode, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerStatus=prtMarkerStatus, prtMarkerSupplies=prtMarkerSupplies, prtInputEntry=prtInputEntry, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMIB2Compliance=prtMIB2Compliance, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtGeneralServicePerson=prtGeneralServicePerson, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMediaPathEntry=prtMediaPathEntry, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInterpreterLangVersion=prtInterpreterLangVersion, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtOutputTable=prtOutputTable, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputName=prtOutputName, prtLocalization=prtLocalization, prtMarkerCounterUnit=prtMarkerCounterUnit, prtAlertTableGroup=prtAlertTableGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtOutputDescription=prtOutputDescription, prtOutputDecollating=prtOutputDecollating, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtConsoleDisable=prtConsoleDisable, prtAlertCriticalEvents=prtAlertCriticalEvents, prtGeneral=prtGeneral, prtInputDefaultIndex=prtInputDefaultIndex, prtMediaPath=prtMediaPath, prtInputMaxCapacity=prtInputMaxCapacity, prtInputMediaWeight=prtInputMediaWeight, prtMIB2Groups=prtMIB2Groups, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtCover=prtCover, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputMediaColor=prtInputMediaColor, prtChannelProtocolVersion=prtChannelProtocolVersion, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtChannel=prtChannel, prtMIBGroups=prtMIBGroups, prtConsoleOnTime=prtConsoleOnTime, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, MediaUnit=MediaUnit, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtAlertGroup=prtAlertGroup, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtConsoleLightIndex=prtConsoleLightIndex, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMediaPathDescription=prtMediaPathDescription, prtConsoleDescription=prtConsoleDescription, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtDeviceRefEntry=prtDeviceRefEntry, prtChannelTable=prtChannelTable, prtStorageRefIndex=prtStorageRefIndex, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtAlertLocation=prtAlertLocation, printerV2Alert=printerV2Alert, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInterpreterTable=prtInterpreterTable, printerV2AlertPrefix=printerV2AlertPrefix, prtMarkerEntry=prtMarkerEntry, prtChannelIfIndex=prtChannelIfIndex, prtMarkerProcessColorants=prtMarkerProcessColorants, prtExtendedInputGroup=prtExtendedInputGroup, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtInputDescription=prtInputDescription, prtMarkerColorantTonality=prtMarkerColorantTonality)
mibBuilder.exportSymbols("Printer-MIB", prtInterpreterIndex=prtInterpreterIndex, prtMarkerColorantIndex=prtMarkerColorantIndex, prtStorageRefEntry=prtStorageRefEntry, prtAlertDescription=prtAlertDescription)
