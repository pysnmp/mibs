...
PrtInputTypeTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC, PrtAlertGroupTC, PrtOutputTypeTC, PrtConsoleColorTC, PrtMarkerSuppliesTypeTC, PrtCoverStatusTC, PrtConsoleDisableTC, PrtMarkerMarkTechTC, PrtAlertTrainingLevelTC, PrtChannelTypeTC, PrtGeneralResetTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInputTypeTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC", "PrtAlertGroupTC", "PrtOutputTypeTC", "PrtConsoleColorTC", "PrtMarkerSuppliesTypeTC", "PrtCoverStatusTC", "PrtConsoleDisableTC", "PrtMarkerMarkTechTC", "PrtAlertTrainingLevelTC", "PrtChannelTypeTC", "PrtGeneralResetTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtChannel=prtChannel, prtInputStatus=prtInputStatus, prtMarkerWestMargin=prtMarkerWestMargin, prtConsoleLightEntry=prtConsoleLightEntry, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtCoverEntry=prtCoverEntry, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtMarkerStatus=prtMarkerStatus, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtOutputStatus=prtOutputStatus, prtMarkerColorantRole=prtMarkerColorantRole, CapacityUnit=CapacityUnit, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtAlertIndex=prtAlertIndex, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtStorageRefEntry=prtStorageRefEntry, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtLocalizationCountry=prtLocalizationCountry, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtOutput=prtOutput, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerProcessColorants=prtMarkerProcessColorants, prtCoverIndex=prtCoverIndex, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtAlertCode=prtAlertCode, prtInputNextIndex=prtInputNextIndex, CodedCharSet=CodedCharSet, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInputDescription=prtInputDescription, prtInterpreterLangFamily=prtInterpreterLangFamily, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtConsoleLightIndex=prtConsoleLightIndex, prtMIBCompliance=prtMIBCompliance, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtConsoleDisable=prtConsoleDisable, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtConsoleLocalization=prtConsoleLocalization, prtLocalizationIndex=prtLocalizationIndex, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerIndex=prtMarkerIndex, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputDescription=prtOutputDescription, printmib=printmib, prtStorageRefTable=prtStorageRefTable, prtInputSerialNumber=prtInputSerialNumber, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputName=prtInputName, prtOutputDefaultIndex=prtOutputDefaultIndex, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMarkerCounterUnit=prtMarkerCounterUnit, prtOutputVersion=prtOutputVersion, prtMediaPathDescription=prtMediaPathDescription, prtLocalizationEntry=prtLocalizationEntry, prtMediaPathType=prtMediaPathType, printerV2AlertPrefix=printerV2AlertPrefix, prtInputIndex=prtInputIndex, prtMarkerTable=prtMarkerTable, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtConsoleOnTime=prtConsoleOnTime, prtAlertTable=prtAlertTable, prtMarkerColorantEntry=prtMarkerColorantEntry, prtInputVendorName=prtInputVendorName, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputTable=prtInputTable, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInputMaxCapacity=prtInputMaxCapacity, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInterpreterLangLevel=prtInterpreterLangLevel, prtChannelType=prtChannelType, prtStorageRefIndex=prtStorageRefIndex, prtLocalizationLanguage=prtLocalizationLanguage, prtMarker=prtMarker, prtConsoleColor=prtConsoleColor, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtChannelGroup=prtChannelGroup, prtMarkerColorantTonality=prtMarkerColorantTonality, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtOutputSecurity=prtOutputSecurity, prtChannelStatus=prtChannelStatus, prtCoverStatus=prtCoverStatus, prtOutputModel=prtOutputModel, prtCoverDescription=prtCoverDescription, prtInputMediaColor=prtInputMediaColor, prtChannelIfIndex=prtChannelIfIndex, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInputVersion=prtInputVersion, prtGeneralV2Group=prtGeneralV2Group, prtConsoleGroup=prtConsoleGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInterpreterGroup=prtInterpreterGroup, PrtMediaUnitTC=PrtMediaUnitTC, prtGeneral=prtGeneral, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputVendorName=prtOutputVendorName, prtMarkerMarkTech=prtMarkerMarkTech, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtLocalization=prtLocalization, prtAlertGroupIndex=prtAlertGroupIndex, prtInputMediaName=prtInputMediaName, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInterpreterVersion=prtInterpreterVersion, prtLocalizationTable=prtLocalizationTable, prtInputCurrentLevel=prtInputCurrentLevel, prtExtendedInputGroup=prtExtendedInputGroup, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleDescription=prtConsoleDescription, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMIB2Compliance=prtMIB2Compliance, prtInputMediaGroup=prtInputMediaGroup, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInput=prtInput, prtAlertAllEvents=prtAlertAllEvents, prtDeviceRefTable=prtDeviceRefTable, prtCoverTable=prtCoverTable, prtMarkerColorant=prtMarkerColorant, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtAlertEntry=prtAlertEntry, prtMIBConformance=prtMIBConformance, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMIB2Groups=prtMIB2Groups, prtAlertDescription=prtAlertDescription, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMediaPathIndex=prtMediaPathIndex, prtMarkerSouthMargin=prtMarkerSouthMargin, prtAlert=prtAlert, prtGeneralSerialNumber=prtGeneralSerialNumber, PYSNMP_MODULE_ID=printmib, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtChannelEntry=prtChannelEntry, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerSupplies=prtMarkerSupplies, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInputDimUnit=prtInputDimUnit, prtInputMediaType=prtInputMediaType, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtGeneralConfigChanges=prtGeneralConfigChanges, prtConsoleLightTable=prtConsoleLightTable, prtOutputMaxCapacity=prtOutputMaxCapacity, prtAlertTimeGroup=prtAlertTimeGroup, prtConsoleLights=prtConsoleLights, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtGeneralTable=prtGeneralTable, printerV2Alert=printerV2Alert, prtOutputCapacityUnit=prtOutputCapacityUnit, prtChannelIndex=prtChannelIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtConsoleOffTime=prtConsoleOffTime, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInterpreterEntry=prtInterpreterEntry, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerSuppliesType=prtMarkerSuppliesType, prtChannelTable=prtChannelTable, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputTable=prtOutputTable, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtGeneralEntry=prtGeneralEntry, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, SubUnitStatus=SubUnitStatus, prtMarkerDefaultIndex=prtMarkerDefaultIndex, PrtChannelStateTC=PrtChannelStateTC, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtChannelInformation=prtChannelInformation, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMediaPath=prtMediaPath, prtMediaPathTable=prtMediaPathTable, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtOutputType=prtOutputType, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMIBGroups=prtMIBGroups, prtAlertGroup=prtAlertGroup, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutputEntry=prtOutputEntry, prtAlertTime=prtAlertTime, prtInputType=prtInputType, prtChannelState=prtChannelState, prtInterpreter=prtInterpreter, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMediaPathGroup=prtMediaPathGroup, prtMediaPathStatus=prtMediaPathStatus, printerV1Alert=printerV1Alert, prtAlertTrapGroup=prtAlertTrapGroup, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInterpreterTable=prtInterpreterTable, prtAlertCriticalEvents=prtAlertCriticalEvents, prtOutputPageCollated=prtOutputPageCollated, prtChannelProtocolVersion=prtChannelProtocolVersion, PresentOnOff=PresentOnOff, prtAlertTableV2Group=prtAlertTableV2Group, prtInputModel=prtInputModel, prtMarkerColorantValue=prtMarkerColorantValue, prtMediaPathEntry=prtMediaPathEntry, prtOutputSerialNumber=prtOutputSerialNumber, prtAlertLocation=prtAlertLocation, prtGeneralGroup=prtGeneralGroup, prtMarkerColorantTable=prtMarkerColorantTable, prtInputMediaWeight=prtInputMediaWeight, prtInterpreterTwoWay=prtInterpreterTwoWay, prtOutputStackingOrder=prtOutputStackingOrder, prtOutputDimUnit=prtOutputDimUnit, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInterpreterIndex=prtInterpreterIndex, prtMarkerGroup=prtMarkerGroup, prtGeneralReset=prtGeneralReset, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInputEntry=prtInputEntry, prtOutputDecollating=prtOutputDecollating, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputCapacityUnit=prtInputCapacityUnit, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtDeviceRefEntry=prtDeviceRefEntry, MediaUnit=MediaUnit, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtAlertTableGroup=prtAlertTableGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtOutputGroup=prtOutputGroup, prtOutputBursting=prtOutputBursting, prtInterpreterDescription=prtInterpreterDescription, prtMarkerEntry=prtMarkerEntry, prtCover=prtCover, prtMarkerEastMargin=prtMarkerEastMargin, prtAlertTrainingLevel=prtAlertTrainingLevel, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputIndex=prtOutputIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtOutputName=prtOutputName, prtInputGroup=prtInputGroup, prtInputSecurity=prtInputSecurity, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC)
mibBuilder.exportSymbols("Printer-MIB", prtChannelV2Group=prtChannelV2Group, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtGeneralServicePerson=prtGeneralServicePerson, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC)
