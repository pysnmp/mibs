...
PrtConsoleDisableTC, PrtInterpreterLangFamilyTC, PrtInputTypeTC, PrtConsoleColorTC, PrtGeneralResetTC, PrtAlertTrainingLevelTC, PrtAlertCodeTC, PrtMarkerMarkTechTC, PrtMediaPathTypeTC, PrtOutputTypeTC, PrtAlertGroupTC, PrtCoverStatusTC, PrtChannelTypeTC, PrtMarkerSuppliesTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleDisableTC", "PrtInterpreterLangFamilyTC", "PrtInputTypeTC", "PrtConsoleColorTC", "PrtGeneralResetTC", "PrtAlertTrainingLevelTC", "PrtAlertCodeTC", "PrtMarkerMarkTechTC", "PrtMediaPathTypeTC", "PrtOutputTypeTC", "PrtAlertGroupTC", "PrtCoverStatusTC", "PrtChannelTypeTC", "PrtMarkerSuppliesTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInputIndex=prtInputIndex, prtGeneralSerialNumber=prtGeneralSerialNumber, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInput=prtInput, prtOutputMaxCapacity=prtOutputMaxCapacity, prtAlertAllEvents=prtAlertAllEvents, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInputStatus=prtInputStatus, prtOutputType=prtOutputType, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInterpreter=prtInterpreter, prtInputSecurity=prtInputSecurity, prtAlertIndex=prtAlertIndex, prtOutputBursting=prtOutputBursting, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputTable=prtInputTable, prtInputMediaWeight=prtInputMediaWeight, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtGeneral=prtGeneral, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtGeneralConfigChanges=prtGeneralConfigChanges, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInputMediaName=prtInputMediaName, prtAlertEntry=prtAlertEntry, prtInputMediaColor=prtInputMediaColor, prtCoverIndex=prtCoverIndex, prtGeneralServicePerson=prtGeneralServicePerson, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtAlert=prtAlert, prtMediaPathGroup=prtMediaPathGroup, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMediaPathTable=prtMediaPathTable, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInputMaxCapacity=prtInputMaxCapacity, prtGeneralV2Group=prtGeneralV2Group, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtOutputTable=prtOutputTable, prtMediaPathEntry=prtMediaPathEntry, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtOutputCapacityUnit=prtOutputCapacityUnit, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtConsoleDescription=prtConsoleDescription, prtMIB2Compliance=prtMIB2Compliance, prtExtendedOutputGroup=prtExtendedOutputGroup, prtCoverEntry=prtCoverEntry, prtMarkerColorantRole=prtMarkerColorantRole, printerV2AlertPrefix=printerV2AlertPrefix, prtOutputSerialNumber=prtOutputSerialNumber, prtCoverStatus=prtCoverStatus, CodedCharSet=CodedCharSet, prtStorageRefEntry=prtStorageRefEntry, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtAlertTimeGroup=prtAlertTimeGroup, prtLocalizationEntry=prtLocalizationEntry, prtDeviceRefTable=prtDeviceRefTable, prtOutputEntry=prtOutputEntry, prtMediaPathStatus=prtMediaPathStatus, prtChannelInformation=prtChannelInformation, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtConsoleLightIndex=prtConsoleLightIndex, prtInputMediaFormParts=prtInputMediaFormParts, prtInputCapacityUnit=prtInputCapacityUnit, prtStorageRefTable=prtStorageRefTable, prtInputDescription=prtInputDescription, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInputVendorName=prtInputVendorName, prtInputModel=prtInputModel, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerWestMargin=prtMarkerWestMargin, prtMarkerColorantGroup=prtMarkerColorantGroup, prtGeneralReset=prtGeneralReset, prtInterpreterTable=prtInterpreterTable, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtConsoleOnTime=prtConsoleOnTime, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerColorantTable=prtMarkerColorantTable, prtMediaPathType=prtMediaPathType, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMarkerLifeCount=prtMarkerLifeCount, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerIndex=prtMarkerIndex, prtInputGroup=prtInputGroup, prtInputDimUnit=prtInputDimUnit, prtAlertTable=prtAlertTable, prtMIBCompliance=prtMIBCompliance, prtMarkerColorantValue=prtMarkerColorantValue, prtGeneralGroup=prtGeneralGroup, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerEntry=prtMarkerEntry, prtStorageRefIndex=prtStorageRefIndex, prtConsoleLightEntry=prtConsoleLightEntry, prtLocalization=prtLocalization, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtOutputGroup=prtOutputGroup, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInterpreterGroup=prtInterpreterGroup, prtOutputPageCollated=prtOutputPageCollated, PrtChannelStateTC=PrtChannelStateTC, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputMediaType=prtInputMediaType, prtInterpreterVersion=prtInterpreterVersion, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtChannelStatus=prtChannelStatus, prtMarkerColorant=prtMarkerColorant, prtExtendedInputGroup=prtExtendedInputGroup, prtConsoleLights=prtConsoleLights, prtConsoleLocalization=prtConsoleLocalization, prtMarker=prtMarker, prtAlertCode=prtAlertCode, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlertTrainingLevel=prtAlertTrainingLevel, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInterpreterTwoWay=prtInterpreterTwoWay, prtChannelIfIndex=prtChannelIfIndex, prtAlertCriticalEvents=prtAlertCriticalEvents, prtLocalizationCountry=prtLocalizationCountry, prtOutputDecollating=prtOutputDecollating, prtInputMediaGroup=prtInputMediaGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtAlertGroup=prtAlertGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtOutputVersion=prtOutputVersion, MediaUnit=MediaUnit, prtConsoleDisable=prtConsoleDisable, prtOutputVendorName=prtOutputVendorName, PresentOnOff=PresentOnOff, prtDeviceRefEntry=prtDeviceRefEntry, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMIB2Groups=prtMIB2Groups, prtChannelIndex=prtChannelIndex, prtMarkerMarkTech=prtMarkerMarkTech, printerV2Alert=printerV2Alert, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtLocalizationIndex=prtLocalizationIndex, prtCoverDescription=prtCoverDescription, prtChannelV2Group=prtChannelV2Group, prtOutputDescription=prtOutputDescription, prtChannel=prtChannel, prtMediaPath=prtMediaPath, prtChannelTable=prtChannelTable, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputIndex=prtOutputIndex, prtInputVersion=prtInputVersion, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMarkerGroup=prtMarkerGroup, prtCover=prtCover, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtGeneralTable=prtGeneralTable, PrtPrintOrientationTC=PrtPrintOrientationTC, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, CapacityUnit=CapacityUnit, prtConsoleGroup=prtConsoleGroup, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtOutputStatus=prtOutputStatus, prtOutputModel=prtOutputModel, prtMarkerColorantEntry=prtMarkerColorantEntry, prtAlertLocation=prtAlertLocation, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputStackingOrder=prtOutputStackingOrder, prtOutputName=prtOutputName, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputEntry=prtInputEntry, prtAlertTableV2Group=prtAlertTableV2Group, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerSupplies=prtMarkerSupplies, prtAlertGroupIndex=prtAlertGroupIndex, prtOutput=prtOutput, prtMediaPathDescription=prtMediaPathDescription, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerColorantIndex=prtMarkerColorantIndex, prtAlertDescription=prtAlertDescription, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtConsoleOffTime=prtConsoleOffTime, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, printmib=printmib, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMarkerTable=prtMarkerTable, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlertTableGroup=prtAlertTableGroup, prtInterpreterLangVersion=prtInterpreterLangVersion, prtCoverTable=prtCoverTable, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, printerV1Alert=printerV1Alert, prtMediaPathIndex=prtMediaPathIndex, prtConsoleLightTable=prtConsoleLightTable, prtInterpreterIndex=prtInterpreterIndex, prtMarkerNorthMargin=prtMarkerNorthMargin, prtConsoleColor=prtConsoleColor, prtChannelEntry=prtChannelEntry, prtResponsiblePartyGroup=prtResponsiblePartyGroup, PYSNMP_MODULE_ID=printmib, prtLocalizationTable=prtLocalizationTable, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInterpreterDescription=prtInterpreterDescription, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputNextIndex=prtInputNextIndex, PrtCapacityUnitTC=PrtCapacityUnitTC, prtOutputDimUnit=prtOutputDimUnit, prtMarkerEastMargin=prtMarkerEastMargin, prtInterpreterEntry=prtInterpreterEntry, prtAlertTime=prtAlertTime, prtMIBGroups=prtMIBGroups, prtChannelState=prtChannelState, prtInputSerialNumber=prtInputSerialNumber, prtOutputSecurity=prtOutputSecurity, prtMarkerStatus=prtMarkerStatus, prtAlertTrapGroup=prtAlertTrapGroup, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMIBConformance=prtMIBConformance, prtMarkerSouthMargin=prtMarkerSouthMargin, prtChannelGroup=prtChannelGroup, prtInputName=prtInputName, SubUnitStatus=SubUnitStatus, prtInputCurrentLevel=prtInputCurrentLevel, prtInputType=prtInputType, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtChannelType=prtChannelType)
mibBuilder.exportSymbols("Printer-MIB", prtGeneralEntry=prtGeneralEntry, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity)
