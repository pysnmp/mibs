...
PrtInputTypeTC, PrtMediaPathTypeTC, PrtAlertCodeTC, PrtMarkerSuppliesTypeTC, PrtConsoleDisableTC, PrtInterpreterLangFamilyTC, PrtChannelTypeTC, PrtAlertGroupTC, PrtOutputTypeTC, PrtCoverStatusTC, PrtMarkerMarkTechTC, PrtGeneralResetTC, PrtConsoleColorTC, PrtAlertTrainingLevelTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInputTypeTC", "PrtMediaPathTypeTC", "PrtAlertCodeTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleDisableTC", "PrtInterpreterLangFamilyTC", "PrtChannelTypeTC", "PrtAlertGroupTC", "PrtOutputTypeTC", "PrtCoverStatusTC", "PrtMarkerMarkTechTC", "PrtGeneralResetTC", "PrtConsoleColorTC", "PrtAlertTrainingLevelTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputName=prtOutputName, prtConsoleGroup=prtConsoleGroup, PrtPrintOrientationTC=PrtPrintOrientationTC, prtAlertTableGroup=prtAlertTableGroup, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtLocalizationLanguage=prtLocalizationLanguage, prtInputTable=prtInputTable, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtCover=prtCover, prtStorageRefEntry=prtStorageRefEntry, prtOutputVersion=prtOutputVersion, prtOutputGroup=prtOutputGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtDeviceRefTable=prtDeviceRefTable, prtGeneralV2Group=prtGeneralV2Group, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtAlertTable=prtAlertTable, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtChannelGroup=prtChannelGroup, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtChannel=prtChannel, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputNextIndex=prtInputNextIndex, printerV2Alert=printerV2Alert, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtOutputType=prtOutputType, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInterpreterDescription=prtInterpreterDescription, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtLocalizationEntry=prtLocalizationEntry, prtAlertTrainingLevel=prtAlertTrainingLevel, prtOutputModel=prtOutputModel, prtInputMediaGroup=prtInputMediaGroup, prtInputCurrentLevel=prtInputCurrentLevel, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInputDimUnit=prtInputDimUnit, prtGeneral=prtGeneral, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtAlertDescription=prtAlertDescription, PrtMediaUnitTC=PrtMediaUnitTC, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputStatus=prtOutputStatus, prtGeneralPrinterName=prtGeneralPrinterName, prtChannelIfIndex=prtChannelIfIndex, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtAlertLocation=prtAlertLocation, prtGeneralConfigChanges=prtGeneralConfigChanges, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputDecollating=prtOutputDecollating, prtInputMediaFormParts=prtInputMediaFormParts, prtConsoleDisable=prtConsoleDisable, prtInterpreterEntry=prtInterpreterEntry, prtOutputCapacityUnit=prtOutputCapacityUnit, MediaUnit=MediaUnit, prtInputCapacityUnit=prtInputCapacityUnit, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInterpreter=prtInterpreter, prtMIBGroups=prtMIBGroups, prtMIBConformance=prtMIBConformance, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInterpreterLangLevel=prtInterpreterLangLevel, printmib=printmib, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtChannelType=prtChannelType, prtAlertGroup=prtAlertGroup, prtChannelEntry=prtChannelEntry, prtGeneralServicePerson=prtGeneralServicePerson, prtResponsiblePartyGroup=prtResponsiblePartyGroup, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputName=prtInputName, prtMarkerIndex=prtMarkerIndex, prtConsoleOffTime=prtConsoleOffTime, prtAlertGroupIndex=prtAlertGroupIndex, prtExtendedOutputGroup=prtExtendedOutputGroup, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMIBCompliance=prtMIBCompliance, prtGeneralEntry=prtGeneralEntry, prtOutputVendorName=prtOutputVendorName, prtMarker=prtMarker, prtMarkerEntry=prtMarkerEntry, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, PrtChannelStateTC=PrtChannelStateTC, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInterpreterLangFamily=prtInterpreterLangFamily, prtConsoleLightIndex=prtConsoleLightIndex, prtGeneralGroup=prtGeneralGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtCoverEntry=prtCoverEntry, prtAlertSeverityLevel=prtAlertSeverityLevel, prtExtendedInputGroup=prtExtendedInputGroup, prtCoverStatus=prtCoverStatus, prtConsoleLights=prtConsoleLights, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInterpreterGroup=prtInterpreterGroup, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerColorantIndex=prtMarkerColorantIndex, prtOutputStackingOrder=prtOutputStackingOrder, prtInputMediaName=prtInputMediaName, prtConsoleDescription=prtConsoleDescription, prtCoverIndex=prtCoverIndex, prtChannelTable=prtChannelTable, prtGeneralReset=prtGeneralReset, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMediaPathType=prtMediaPathType, prtMarkerProcessColorants=prtMarkerProcessColorants, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInputVendorName=prtInputVendorName, prtChannelProtocolVersion=prtChannelProtocolVersion, prtChannelIndex=prtChannelIndex, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMIB2Groups=prtMIB2Groups, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputStatus=prtInputStatus, prtMarkerColorantTonality=prtMarkerColorantTonality, prtDeviceRefIndex=prtDeviceRefIndex, prtConsoleLightTable=prtConsoleLightTable, prtMarkerColorantValue=prtMarkerColorantValue, prtMediaPathStatus=prtMediaPathStatus, prtConsoleColor=prtConsoleColor, prtAlertIndex=prtAlertIndex, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtChannelStatus=prtChannelStatus, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputSecurity=prtInputSecurity, prtInputDescription=prtInputDescription, prtMediaPathGroup=prtMediaPathGroup, prtInputModel=prtInputModel, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputGroup=prtInputGroup, prtMarkerWestMargin=prtMarkerWestMargin, prtConsoleOnTime=prtConsoleOnTime, prtAlertAllEvents=prtAlertAllEvents, prtCoverDescription=prtCoverDescription, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputDimUnit=prtOutputDimUnit, prtConsoleLocalization=prtConsoleLocalization, prtLocalizationCountry=prtLocalizationCountry, prtInputType=prtInputType, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMediaPathEntry=prtMediaPathEntry, prtMarkerTable=prtMarkerTable, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, printerV2AlertPrefix=printerV2AlertPrefix, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, SubUnitStatus=SubUnitStatus, prtMarkerColorantRole=prtMarkerColorantRole, prtInterpreterVersion=prtInterpreterVersion, prtMarkerColorantTable=prtMarkerColorantTable, prtLocalizationIndex=prtLocalizationIndex, prtInputSerialNumber=prtInputSerialNumber, prtChannelV2Group=prtChannelV2Group, prtOutputIndex=prtOutputIndex, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMediaPathIndex=prtMediaPathIndex, prtMediaPathDescription=prtMediaPathDescription, prtOutputPageCollated=prtOutputPageCollated, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtAlertCode=prtAlertCode, printerV1Alert=printerV1Alert, prtInputEntry=prtInputEntry, prtGeneralTable=prtGeneralTable, prtMarkerLifeCount=prtMarkerLifeCount, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAlertTimeGroup=prtAlertTimeGroup, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutputEntry=prtOutputEntry, prtOutputSecurity=prtOutputSecurity, prtMIB2Compliance=prtMIB2Compliance, prtStorageRefTable=prtStorageRefTable, prtMarkerStatus=prtMarkerStatus, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtOutputSerialNumber=prtOutputSerialNumber, prtInputIndex=prtInputIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtLocalizationTable=prtLocalizationTable, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInput=prtInput, prtStorageRefIndex=prtStorageRefIndex, prtOutputMaxCapacity=prtOutputMaxCapacity, prtInputMediaColor=prtInputMediaColor, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtOutputRemainingCapacity=prtOutputRemainingCapacity, CodedCharSet=CodedCharSet, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInputMediaWeight=prtInputMediaWeight, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerSouthMargin=prtMarkerSouthMargin, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMediaPath=prtMediaPath, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMarkerGroup=prtMarkerGroup, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInterpreterIndex=prtInterpreterIndex, prtAlert=prtAlert, prtInterpreterTable=prtInterpreterTable, prtChannelInformation=prtChannelInformation, prtCoverTable=prtCoverTable, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInputVersion=prtInputVersion, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerSupplies=prtMarkerSupplies, PresentOnOff=PresentOnOff, prtChannelState=prtChannelState, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtOutput=prtOutput, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInputDefaultIndex=prtInputDefaultIndex, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputBursting=prtOutputBursting, PYSNMP_MODULE_ID=printmib, CapacityUnit=CapacityUnit, prtOutputDescription=prtOutputDescription, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputMediaType=prtInputMediaType, prtMediaPathTable=prtMediaPathTable, prtAlertEntry=prtAlertEntry, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtLocalization=prtLocalization, prtOutputTable=prtOutputTable, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtAlertTrapGroup=prtAlertTrapGroup)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerColorant=prtMarkerColorant, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtAlertTime=prtAlertTime, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir)
