...
PrtOutputTypeTC, PrtChannelTypeTC, PrtConsoleDisableTC, PrtInputTypeTC, PrtConsoleColorTC, PrtCoverStatusTC, PrtGeneralResetTC, PrtMarkerSuppliesTypeTC, PrtAlertTrainingLevelTC, PrtMarkerMarkTechTC, PrtMediaPathTypeTC, PrtInterpreterLangFamilyTC, PrtAlertCodeTC, PrtAlertGroupTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtOutputTypeTC", "PrtChannelTypeTC", "PrtConsoleDisableTC", "PrtInputTypeTC", "PrtConsoleColorTC", "PrtCoverStatusTC", "PrtGeneralResetTC", "PrtMarkerSuppliesTypeTC", "PrtAlertTrainingLevelTC", "PrtMarkerMarkTechTC", "PrtMediaPathTypeTC", "PrtInterpreterLangFamilyTC", "PrtAlertCodeTC", "PrtAlertGroupTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtChannelType=prtChannelType, prtGeneralEntry=prtGeneralEntry, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtOutputSecurity=prtOutputSecurity, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMediaPathGroup=prtMediaPathGroup, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInputMaxCapacity=prtInputMaxCapacity, prtInterpreterTable=prtInterpreterTable, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtOutputVersion=prtOutputVersion, prtChannelStatus=prtChannelStatus, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMarkerColorant=prtMarkerColorant, prtMediaPathIndex=prtMediaPathIndex, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtExtendedOutputGroup=prtExtendedOutputGroup, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtChannelEntry=prtChannelEntry, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtCoverDescription=prtCoverDescription, prtInputNextIndex=prtInputNextIndex, prtInputSerialNumber=prtInputSerialNumber, prtGeneralServicePerson=prtGeneralServicePerson, prtAlertTrainingLevel=prtAlertTrainingLevel, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMediaPath=prtMediaPath, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputCurrentLevel=prtInputCurrentLevel, prtChannel=prtChannel, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtOutputStatus=prtOutputStatus, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtLocalizationEntry=prtLocalizationEntry, prtMediaPathTable=prtMediaPathTable, prtOutputMaxCapacity=prtOutputMaxCapacity, prtAlertEntry=prtAlertEntry, prtOutputIndex=prtOutputIndex, prtConsoleLights=prtConsoleLights, prtAlertTrapGroup=prtAlertTrapGroup, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtChannelIfIndex=prtChannelIfIndex, prtGeneralReset=prtGeneralReset, PYSNMP_MODULE_ID=printmib, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtDeviceRefTable=prtDeviceRefTable, prtMarkerGroup=prtMarkerGroup, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtCoverTable=prtCoverTable, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtStorageRefEntry=prtStorageRefEntry, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMediaPathDescription=prtMediaPathDescription, prtInterpreterEntry=prtInterpreterEntry, prtAlert=prtAlert, prtInputSwitchingGroup=prtInputSwitchingGroup, prtOutputDescription=prtOutputDescription, prtAlertTableV2Group=prtAlertTableV2Group, prtAlertIndex=prtAlertIndex, prtInputEntry=prtInputEntry, prtInputDimUnit=prtInputDimUnit, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtLocalizationLanguage=prtLocalizationLanguage, prtConsoleGroup=prtConsoleGroup, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputGroup=prtInputGroup, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInterpreterTwoWay=prtInterpreterTwoWay, prtOutputTable=prtOutputTable, prtOutputModel=prtOutputModel, prtMarkerEastMargin=prtMarkerEastMargin, prtInputSecurity=prtInputSecurity, prtMarkerEntry=prtMarkerEntry, prtCover=prtCover, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMediaPathType=prtMediaPathType, prtMarker=prtMarker, prtMarkerSpotColorants=prtMarkerSpotColorants, CapacityUnit=CapacityUnit, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputType=prtOutputType, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtChannelInformation=prtChannelInformation, prtMarkerColorantRole=prtMarkerColorantRole, prtAlertTimeGroup=prtAlertTimeGroup, prtMIB2Compliance=prtMIB2Compliance, prtAlertGroup=prtAlertGroup, prtExtendedInputGroup=prtExtendedInputGroup, prtLocalizationTable=prtLocalizationTable, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMarkerStatus=prtMarkerStatus, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputTable=prtInputTable, prtConsoleOffTime=prtConsoleOffTime, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtOutputVendorName=prtOutputVendorName, prtChannelTable=prtChannelTable, prtOutputName=prtOutputName, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerSupplies=prtMarkerSupplies, prtOutputEntry=prtOutputEntry, prtInterpreterVersion=prtInterpreterVersion, prtLocalizationCharacterSet=prtLocalizationCharacterSet, PrtCapacityUnitTC=PrtCapacityUnitTC, prtAlertAllEvents=prtAlertAllEvents, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMediaPathEntry=prtMediaPathEntry, prtDeviceRefEntry=prtDeviceRefEntry, prtStorageRefIndex=prtStorageRefIndex, prtGeneralGroup=prtGeneralGroup, prtAlertTableGroup=prtAlertTableGroup, prtInputStatus=prtInputStatus, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtChannelV2Group=prtChannelV2Group, prtGeneralCurrentOperator=prtGeneralCurrentOperator, CodedCharSet=CodedCharSet, printerV2Alert=printerV2Alert, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInputMediaColor=prtInputMediaColor, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleLocalization=prtConsoleLocalization, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMIBCompliance=prtMIBCompliance, prtGeneralV2Group=prtGeneralV2Group, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtGeneralConfigChanges=prtGeneralConfigChanges, prtOutputPageCollated=prtOutputPageCollated, prtLocalizationIndex=prtLocalizationIndex, prtChannelState=prtChannelState, prtGeneralPrinterName=prtGeneralPrinterName, prtOutputBursting=prtOutputBursting, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, printmib=printmib, prtMarkerTable=prtMarkerTable, prtOutputDimUnit=prtOutputDimUnit, MediaUnit=MediaUnit, prtMarkerColorantValue=prtMarkerColorantValue, prtOutputOffsetStacking=prtOutputOffsetStacking, prtAlertTime=prtAlertTime, prtInputName=prtInputName, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMIBGroups=prtMIBGroups, prtOutputDecollating=prtOutputDecollating, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputIndex=prtInputIndex, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInputModel=prtInputModel, printerV1Alert=printerV1Alert, prtConsoleDescription=prtConsoleDescription, prtConsoleLightEntry=prtConsoleLightEntry, prtMIB2Groups=prtMIB2Groups, prtInputMediaWeight=prtInputMediaWeight, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInputMediaGroup=prtInputMediaGroup, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtMarkerIndex=prtMarkerIndex, PrtChannelStateTC=PrtChannelStateTC, prtCoverIndex=prtCoverIndex, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInterpreterLangVersion=prtInterpreterLangVersion, prtAlertGroupIndex=prtAlertGroupIndex, prtInputType=prtInputType, prtConsoleColor=prtConsoleColor, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMediaPathStatus=prtMediaPathStatus, prtLocalizationCountry=prtLocalizationCountry, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtAlertDescription=prtAlertDescription, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, SubUnitStatus=SubUnitStatus, prtConsoleOnTime=prtConsoleOnTime, prtConsoleLightTable=prtConsoleLightTable, prtMarkerMarkTech=prtMarkerMarkTech, prtGeneralTable=prtGeneralTable, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtGeneralSerialNumber=prtGeneralSerialNumber, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtAlertTable=prtAlertTable, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtConsoleDisable=prtConsoleDisable, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtOutputGroup=prtOutputGroup, prtAlertLocation=prtAlertLocation, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInputVendorName=prtInputVendorName, prtChannelProtocolVersion=prtChannelProtocolVersion, prtCoverStatus=prtCoverStatus, prtInputCapacityUnit=prtInputCapacityUnit, PrtMediaUnitTC=PrtMediaUnitTC, prtInterpreter=prtInterpreter, prtConsoleLightIndex=prtConsoleLightIndex, prtGeneral=prtGeneral, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInput=prtInput, prtAlertCode=prtAlertCode, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerWestMargin=prtMarkerWestMargin, prtInputVersion=prtInputVersion, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtCoverEntry=prtCoverEntry, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInputDescription=prtInputDescription, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMarkerColorantTonality=prtMarkerColorantTonality, prtChannelIndex=prtChannelIndex, prtMIBConformance=prtMIBConformance, prtInterpreterGroup=prtInterpreterGroup, PresentOnOff=PresentOnOff, prtInterpreterIndex=prtInterpreterIndex, prtStorageRefTable=prtStorageRefTable, prtChannelGroup=prtChannelGroup, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtLocalization=prtLocalization, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutput=prtOutput, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMarkerColorantTable=prtMarkerColorantTable, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtInputMediaType=prtInputMediaType, printerV2AlertPrefix=printerV2AlertPrefix, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber)
mibBuilder.exportSymbols("Printer-MIB", prtInputMediaName=prtInputMediaName, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInterpreterDescription=prtInterpreterDescription, prtMarkerSuppliesType=prtMarkerSuppliesType)
