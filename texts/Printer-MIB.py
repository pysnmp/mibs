...
PrtMarkerSuppliesTypeTC, PrtConsoleColorTC, PrtChannelTypeTC, PrtAlertCodeTC, PrtMarkerMarkTechTC, PrtCoverStatusTC, PrtOutputTypeTC, PrtAlertTrainingLevelTC, PrtGeneralResetTC, PrtMediaPathTypeTC, PrtInputTypeTC, PrtConsoleDisableTC, PrtInterpreterLangFamilyTC, PrtAlertGroupTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerSuppliesTypeTC", "PrtConsoleColorTC", "PrtChannelTypeTC", "PrtAlertCodeTC", "PrtMarkerMarkTechTC", "PrtCoverStatusTC", "PrtOutputTypeTC", "PrtAlertTrainingLevelTC", "PrtGeneralResetTC", "PrtMediaPathTypeTC", "PrtInputTypeTC", "PrtConsoleDisableTC", "PrtInterpreterLangFamilyTC", "PrtAlertGroupTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtChannelProtocolVersion=prtChannelProtocolVersion, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMIBConformance=prtMIBConformance, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, printmib=printmib, prtStorageRefTable=prtStorageRefTable, prtOutputName=prtOutputName, prtAlertTable=prtAlertTable, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMarkerColorantTable=prtMarkerColorantTable, prtChannelTable=prtChannelTable, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtChannelInformation=prtChannelInformation, prtInputDimUnit=prtInputDimUnit, prtMarkerLifeCount=prtMarkerLifeCount, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtChannelV2Group=prtChannelV2Group, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputIndex=prtInputIndex, CodedCharSet=CodedCharSet, CapacityUnit=CapacityUnit, prtInputCapacityUnit=prtInputCapacityUnit, PrtChannelStateTC=PrtChannelStateTC, prtInputMediaColor=prtInputMediaColor, prtChannelType=prtChannelType, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtAlertGroupIndex=prtAlertGroupIndex, prtMediaPath=prtMediaPath, prtExtendedOutputGroup=prtExtendedOutputGroup, prtChannelGroup=prtChannelGroup, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerTable=prtMarkerTable, prtAlert=prtAlert, prtInputName=prtInputName, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputVersion=prtInputVersion, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInputGroup=prtInputGroup, prtInputMediaGroup=prtInputMediaGroup, prtAlertTime=prtAlertTime, prtMediaPathGroup=prtMediaPathGroup, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtChannelEntry=prtChannelEntry, prtOutputPageCollated=prtOutputPageCollated, prtMediaPathType=prtMediaPathType, prtGeneralTable=prtGeneralTable, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtLocalization=prtLocalization, PYSNMP_MODULE_ID=printmib, prtMIB2Compliance=prtMIB2Compliance, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInputMediaWeight=prtInputMediaWeight, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtGeneralEntry=prtGeneralEntry, prtOutputDecollating=prtOutputDecollating, prtOutputModel=prtOutputModel, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarker=prtMarker, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerColorant=prtMarkerColorant, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtInputMediaType=prtInputMediaType, prtAlertCode=prtAlertCode, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInterpreterVersion=prtInterpreterVersion, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtAlertTrainingLevel=prtAlertTrainingLevel, prtOutputEntry=prtOutputEntry, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtGeneral=prtGeneral, prtLocalizationLanguage=prtLocalizationLanguage, prtMediaPathIndex=prtMediaPathIndex, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputStatus=prtOutputStatus, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtOutputDimUnit=prtOutputDimUnit, prtConsoleLights=prtConsoleLights, SubUnitStatus=SubUnitStatus, prtConsoleLightIndex=prtConsoleLightIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtChannelState=prtChannelState, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, printerV2Alert=printerV2Alert, prtAlertTrapGroup=prtAlertTrapGroup, prtGeneralReset=prtGeneralReset, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMarkerColorantRole=prtMarkerColorantRole, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputGroup=prtOutputGroup, prtInputStatus=prtInputStatus, prtOutputSecurity=prtOutputSecurity, prtInputDefaultIndex=prtInputDefaultIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtCoverEntry=prtCoverEntry, prtInterpreterIndex=prtInterpreterIndex, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMediaPathTable=prtMediaPathTable, prtOutputDefaultIndex=prtOutputDefaultIndex, prtGeneralServicePerson=prtGeneralServicePerson, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerColorantIndex=prtMarkerColorantIndex, prtOutputSerialNumber=prtOutputSerialNumber, prtChannelStatus=prtChannelStatus, prtCoverDescription=prtCoverDescription, prtMediaPathStatus=prtMediaPathStatus, prtOutputVersion=prtOutputVersion, prtCoverTable=prtCoverTable, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInputVendorName=prtInputVendorName, prtOutputVendorName=prtOutputVendorName, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtGeneralSerialNumber=prtGeneralSerialNumber, printerV1Alert=printerV1Alert, printerV2AlertPrefix=printerV2AlertPrefix, prtMarkerEastMargin=prtMarkerEastMargin, prtDeviceRefTable=prtDeviceRefTable, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtOutputOffsetStacking=prtOutputOffsetStacking, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputModel=prtInputModel, prtInputNextIndex=prtInputNextIndex, prtConsoleColor=prtConsoleColor, prtLocalizationEntry=prtLocalizationEntry, prtStorageRefIndex=prtStorageRefIndex, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtChannelIfIndex=prtChannelIfIndex, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtConsoleLocalization=prtConsoleLocalization, prtInputType=prtInputType, prtCoverStatus=prtCoverStatus, prtInputSwitchingGroup=prtInputSwitchingGroup, prtAlertIndex=prtAlertIndex, prtMarkerStatus=prtMarkerStatus, PrtMediaUnitTC=PrtMediaUnitTC, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInterpreterEntry=prtInterpreterEntry, prtDeviceRefIndex=prtDeviceRefIndex, prtInterpreter=prtInterpreter, prtInterpreterGroup=prtInterpreterGroup, prtMIB2Groups=prtMIB2Groups, prtInputTable=prtInputTable, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInputMediaName=prtInputMediaName, prtConsoleGroup=prtConsoleGroup, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMarkerIndex=prtMarkerIndex, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputCapacityUnit=prtOutputCapacityUnit, prtChannelIndex=prtChannelIndex, prtAlertEntry=prtAlertEntry, prtAlertTableGroup=prtAlertTableGroup, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutputStackingOrder=prtOutputStackingOrder, prtOutput=prtOutput, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerNorthMargin=prtMarkerNorthMargin, prtConsoleDescription=prtConsoleDescription, prtConsoleDisable=prtConsoleDisable, prtStorageRefEntry=prtStorageRefEntry, prtOutputIndex=prtOutputIndex, prtAlertGroup=prtAlertGroup, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtLocalizationIndex=prtLocalizationIndex, prtMarkerColorantGroup=prtMarkerColorantGroup, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputEntry=prtInputEntry, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMediaPathEntry=prtMediaPathEntry, prtAlertDescription=prtAlertDescription, PrtCapacityUnitTC=PrtCapacityUnitTC, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputMaxCapacity=prtInputMaxCapacity, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMIBGroups=prtMIBGroups, prtMarkerGroup=prtMarkerGroup, MediaUnit=MediaUnit, prtAlertAllEvents=prtAlertAllEvents, prtMIBCompliance=prtMIBCompliance, prtAlertLocation=prtAlertLocation, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtAlertTimeGroup=prtAlertTimeGroup, prtDeviceRefEntry=prtDeviceRefEntry, prtInputSecurity=prtInputSecurity, prtInterpreterLangFamily=prtInterpreterLangFamily, prtCoverIndex=prtCoverIndex, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInputSerialNumber=prtInputSerialNumber, prtInputDescription=prtInputDescription, prtOutputBursting=prtOutputBursting, prtMarkerMarkTech=prtMarkerMarkTech, prtInterpreterTable=prtInterpreterTable, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtLocalizationCountry=prtLocalizationCountry, prtMarkerSupplies=prtMarkerSupplies, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtLocalizationTable=prtLocalizationTable, prtOutputDescription=prtOutputDescription, prtCover=prtCover, prtMarkerColorantValue=prtMarkerColorantValue, prtInputMediaFormParts=prtInputMediaFormParts, prtAlertSeverityLevel=prtAlertSeverityLevel, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtChannel=prtChannel, prtOutputTable=prtOutputTable, PresentOnOff=PresentOnOff, prtAlertCriticalEvents=prtAlertCriticalEvents, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerEntry=prtMarkerEntry, prtInterpreterDescription=prtInterpreterDescription, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputType=prtOutputType, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMediaPathDescription=prtMediaPathDescription, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtConsoleOffTime=prtConsoleOffTime, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtConsoleLightTable=prtConsoleLightTable, prtGeneralGroup=prtGeneralGroup, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMarkerWestMargin=prtMarkerWestMargin, prtConsoleOnTime=prtConsoleOnTime, prtGeneralV2Group=prtGeneralV2Group)
mibBuilder.exportSymbols("Printer-MIB", prtOutputMaxCapacity=prtOutputMaxCapacity, prtInput=prtInput, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir)
