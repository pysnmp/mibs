...
PrtAlertTrainingLevelTC, PrtConsoleDisableTC, PrtAlertCodeTC, PrtInputTypeTC, PrtGeneralResetTC, PrtOutputTypeTC, PrtCoverStatusTC, PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC, PrtAlertGroupTC, PrtChannelTypeTC, PrtMarkerSuppliesTypeTC, PrtConsoleColorTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertTrainingLevelTC", "PrtConsoleDisableTC", "PrtAlertCodeTC", "PrtInputTypeTC", "PrtGeneralResetTC", "PrtOutputTypeTC", "PrtCoverStatusTC", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC", "PrtAlertGroupTC", "PrtChannelTypeTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleColorTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputSecurity=prtOutputSecurity, prtDeviceRefEntry=prtDeviceRefEntry, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtOutputModel=prtOutputModel, prtOutputDimUnit=prtOutputDimUnit, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtChannelType=prtChannelType, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInterpreterVersion=prtInterpreterVersion, PrtCapacityUnitTC=PrtCapacityUnitTC, prtAlertIndex=prtAlertIndex, prtOutputEntry=prtOutputEntry, prtLocalizationLanguage=prtLocalizationLanguage, prtMarker=prtMarker, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtGeneralTable=prtGeneralTable, prtAlertCode=prtAlertCode, PrtPrintOrientationTC=PrtPrintOrientationTC, prtAlertDescription=prtAlertDescription, printerV2AlertPrefix=printerV2AlertPrefix, prtInputName=prtInputName, prtStorageRefTable=prtStorageRefTable, prtMarkerPowerOnCount=prtMarkerPowerOnCount, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInputCapacityUnit=prtInputCapacityUnit, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerStatus=prtMarkerStatus, prtInterpreterIndex=prtInterpreterIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMIB2Compliance=prtMIB2Compliance, CapacityUnit=CapacityUnit, prtConsoleLocalization=prtConsoleLocalization, prtInputMediaFormParts=prtInputMediaFormParts, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtCover=prtCover, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMediaPathEntry=prtMediaPathEntry, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMediaPathIndex=prtMediaPathIndex, prtMIBGroups=prtMIBGroups, prtConsoleGroup=prtConsoleGroup, prtAlertTrapGroup=prtAlertTrapGroup, prtOutputName=prtOutputName, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMIB2Groups=prtMIB2Groups, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterLangLevel=prtInterpreterLangLevel, prtLocalizationEntry=prtLocalizationEntry, prtInputStatus=prtInputStatus, prtOutputBursting=prtOutputBursting, prtOutputGroup=prtOutputGroup, prtInputDescription=prtInputDescription, prtStorageRefIndex=prtStorageRefIndex, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtAlertAllEvents=prtAlertAllEvents, MediaUnit=MediaUnit, prtAlertTableGroup=prtAlertTableGroup, PresentOnOff=PresentOnOff, prtInterpreterTwoWay=prtInterpreterTwoWay, PrtMediaUnitTC=PrtMediaUnitTC, prtInputEntry=prtInputEntry, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInputMediaName=prtInputMediaName, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtAlertTableV2Group=prtAlertTableV2Group, prtChannelState=prtChannelState, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMIBCompliance=prtMIBCompliance, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtCoverStatus=prtCoverStatus, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtOutputStatus=prtOutputStatus, prtMarkerWestMargin=prtMarkerWestMargin, prtGeneral=prtGeneral, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, printmib=printmib, prtOutputIndex=prtOutputIndex, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInputTable=prtInputTable, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtChannel=prtChannel, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputType=prtOutputType, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtChannelInformation=prtChannelInformation, prtConsoleLightEntry=prtConsoleLightEntry, prtInterpreter=prtInterpreter, prtInterpreterDescription=prtInterpreterDescription, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtInputMediaGroup=prtInputMediaGroup, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtGeneralV2Group=prtGeneralV2Group, prtConsoleDisable=prtConsoleDisable, prtMarkerColorantGroup=prtMarkerColorantGroup, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMarkerSupplies=prtMarkerSupplies, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerColorantIndex=prtMarkerColorantIndex, prtInputVersion=prtInputVersion, prtMarkerColorantTable=prtMarkerColorantTable, prtMediaPathType=prtMediaPathType, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutputVersion=prtOutputVersion, prtGeneralServicePerson=prtGeneralServicePerson, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMarkerSouthMargin=prtMarkerSouthMargin, prtAlert=prtAlert, prtOutputDescription=prtOutputDescription, prtInputIndex=prtInputIndex, prtMediaPathTable=prtMediaPathTable, prtChannelEntry=prtChannelEntry, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtChannelIndex=prtChannelIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInterpreterTable=prtInterpreterTable, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtAlertTable=prtAlertTable, prtAlertTrainingLevel=prtAlertTrainingLevel, CodedCharSet=CodedCharSet, prtGeneralPrinterName=prtGeneralPrinterName, prtInputVendorName=prtInputVendorName, prtOutput=prtOutput, prtInterpreterLangFamily=prtInterpreterLangFamily, prtAlertEntry=prtAlertEntry, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtStorageRefEntry=prtStorageRefEntry, prtGeneralReset=prtGeneralReset, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMarkerEntry=prtMarkerEntry, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtExtendedOutputGroup=prtExtendedOutputGroup, prtOutputOffsetStacking=prtOutputOffsetStacking, prtChannelGroup=prtChannelGroup, prtMediaPathGroup=prtMediaPathGroup, prtMediaPathStatus=prtMediaPathStatus, prtGeneralGroup=prtGeneralGroup, prtMediaPath=prtMediaPath, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtChannelIfIndex=prtChannelIfIndex, prtLocalizationIndex=prtLocalizationIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtChannelStatus=prtChannelStatus, prtExtendedInputGroup=prtExtendedInputGroup, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerColorant=prtMarkerColorant, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtAlertTime=prtAlertTime, prtChannelV2Group=prtChannelV2Group, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtCoverTable=prtCoverTable, prtMarkerSuppliesType=prtMarkerSuppliesType, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMediaPathDescription=prtMediaPathDescription, prtAlertSeverityLevel=prtAlertSeverityLevel, printerV1Alert=printerV1Alert, prtMIBConformance=prtMIBConformance, prtInputGroup=prtInputGroup, prtOutputSerialNumber=prtOutputSerialNumber, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtAlertCriticalEvents=prtAlertCriticalEvents, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputMediaWeight=prtInputMediaWeight, printerV2Alert=printerV2Alert, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerTable=prtMarkerTable, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtLocalizationTable=prtLocalizationTable, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtLocalization=prtLocalization, prtOutputDecollating=prtOutputDecollating, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtCoverEntry=prtCoverEntry, prtInputType=prtInputType, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInputSecurity=prtInputSecurity, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtDeviceRefIndex=prtDeviceRefIndex, prtConsoleLightIndex=prtConsoleLightIndex, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMarkerIndex=prtMarkerIndex, PrtChannelStateTC=PrtChannelStateTC, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerLifeCount=prtMarkerLifeCount, prtInterpreterEntry=prtInterpreterEntry, prtInputMaxCapacity=prtInputMaxCapacity, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtConsoleLights=prtConsoleLights, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerColorantTonality=prtMarkerColorantTonality, prtConsoleOffTime=prtConsoleOffTime, prtAlertGroup=prtAlertGroup, prtInputDimUnit=prtInputDimUnit, prtAlertTimeGroup=prtAlertTimeGroup, prtConsoleDescription=prtConsoleDescription, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerEastMargin=prtMarkerEastMargin, SubUnitStatus=SubUnitStatus, prtMarkerColorantValue=prtMarkerColorantValue, prtMarkerNorthMargin=prtMarkerNorthMargin, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtConsoleOnTime=prtConsoleOnTime, prtAlertLocation=prtAlertLocation, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtOutputVendorName=prtOutputVendorName, prtChannelTable=prtChannelTable, prtConsoleColor=prtConsoleColor, prtMarkerGroup=prtMarkerGroup, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputTable=prtOutputTable, prtOutputMaxCapacity=prtOutputMaxCapacity, prtGeneralEntry=prtGeneralEntry, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtOutputPageCollated=prtOutputPageCollated, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtDeviceRefTable=prtDeviceRefTable, prtInterpreterGroup=prtInterpreterGroup, prtInput=prtInput, prtInputMediaType=prtInputMediaType, prtMarkerCounterUnit=prtMarkerCounterUnit, prtCoverIndex=prtCoverIndex, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtOutputStackingOrder=prtOutputStackingOrder, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, PYSNMP_MODULE_ID=printmib, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputCapacityUnit=prtOutputCapacityUnit, prtLocalizationCountry=prtLocalizationCountry, prtInputSwitchingGroup=prtInputSwitchingGroup, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputModel=prtInputModel, prtInputSerialNumber=prtInputSerialNumber, prtCoverDescription=prtCoverDescription, prtInputMediaColor=prtInputMediaColor, prtInputNextIndex=prtInputNextIndex)
mibBuilder.exportSymbols("Printer-MIB", PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInterpreterLangVersion=prtInterpreterLangVersion, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtConsoleLightTable=prtConsoleLightTable)
