...
PrtMarkerMarkTechTC, PrtAlertTrainingLevelTC, PrtMediaPathTypeTC, PrtInputTypeTC, PrtInterpreterLangFamilyTC, PrtAlertGroupTC, PrtConsoleDisableTC, PrtAlertCodeTC, PrtChannelTypeTC, PrtOutputTypeTC, PrtConsoleColorTC, PrtCoverStatusTC, PrtGeneralResetTC, PrtMarkerSuppliesTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerMarkTechTC", "PrtAlertTrainingLevelTC", "PrtMediaPathTypeTC", "PrtInputTypeTC", "PrtInterpreterLangFamilyTC", "PrtAlertGroupTC", "PrtConsoleDisableTC", "PrtAlertCodeTC", "PrtChannelTypeTC", "PrtOutputTypeTC", "PrtConsoleColorTC", "PrtCoverStatusTC", "PrtGeneralResetTC", "PrtMarkerSuppliesTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtChannelV2Group=prtChannelV2Group, prtGeneralTable=prtGeneralTable, prtOutputName=prtOutputName, prtOutputDescription=prtOutputDescription, prtChannelProtocolVersion=prtChannelProtocolVersion, prtAlertTable=prtAlertTable, prtMarker=prtMarker, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputStatus=prtOutputStatus, prtOutputDimUnit=prtOutputDimUnit, prtMediaPathIndex=prtMediaPathIndex, prtOutputEntry=prtOutputEntry, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtChannelEntry=prtChannelEntry, prtOutputType=prtOutputType, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtAlertTableGroup=prtAlertTableGroup, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, PresentOnOff=PresentOnOff, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInputEntry=prtInputEntry, prtMarkerColorantEntry=prtMarkerColorantEntry, prtLocalizationCountry=prtLocalizationCountry, prtChannelIfIndex=prtChannelIfIndex, prtAlertEntry=prtAlertEntry, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleOffTime=prtConsoleOffTime, prtInputMediaGroup=prtInputMediaGroup, prtOutputVersion=prtOutputVersion, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInputName=prtInputName, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerWestMargin=prtMarkerWestMargin, prtDeviceRefTable=prtDeviceRefTable, prtAlertCode=prtAlertCode, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, PrtPrintOrientationTC=PrtPrintOrientationTC, SubUnitStatus=SubUnitStatus, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInputMediaName=prtInputMediaName, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInputDescription=prtInputDescription, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMediaPathType=prtMediaPathType, prtStorageRefTable=prtStorageRefTable, prtInputDimUnit=prtInputDimUnit, prtMarkerStatus=prtMarkerStatus, prtChannelStatus=prtChannelStatus, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInterpreter=prtInterpreter, prtOutputCapacityUnit=prtOutputCapacityUnit, CodedCharSet=CodedCharSet, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputMaxCapacity=prtInputMaxCapacity, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtOutputModel=prtOutputModel, prtChannel=prtChannel, prtInputType=prtInputType, prtInputVendorName=prtInputVendorName, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtConsoleLocalization=prtConsoleLocalization, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtGeneralPrinterName=prtGeneralPrinterName, prtConsoleLightTable=prtConsoleLightTable, prtAlertTrainingLevel=prtAlertTrainingLevel, prtOutputMaxCapacity=prtOutputMaxCapacity, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtGeneralGroup=prtGeneralGroup, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputTable=prtOutputTable, prtConsoleLights=prtConsoleLights, prtLocalizationEntry=prtLocalizationEntry, printerV2Alert=printerV2Alert, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtCoverEntry=prtCoverEntry, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtStorageRefEntry=prtStorageRefEntry, prtLocalizationTable=prtLocalizationTable, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtChannelGroup=prtChannelGroup, prtConsoleGroup=prtConsoleGroup, prtGeneralV2Group=prtGeneralV2Group, prtLocalization=prtLocalization, prtOutputVendorName=prtOutputVendorName, prtMIBCompliance=prtMIBCompliance, prtConsoleOnTime=prtConsoleOnTime, PrtMediaUnitTC=PrtMediaUnitTC, prtInputMediaType=prtInputMediaType, prtMarkerColorantValue=prtMarkerColorantValue, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtAlertGroup=prtAlertGroup, prtAlertTableV2Group=prtAlertTableV2Group, prtMIBConformance=prtMIBConformance, prtMarkerLifeCount=prtMarkerLifeCount, prtInputIndex=prtInputIndex, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtChannelInformation=prtChannelInformation, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInputSecurity=prtInputSecurity, prtConsoleLightEntry=prtConsoleLightEntry, prtCoverIndex=prtCoverIndex, prtMarkerSuppliesType=prtMarkerSuppliesType, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtAlertSeverityLevel=prtAlertSeverityLevel, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerNorthMargin=prtMarkerNorthMargin, prtAlertIndex=prtAlertIndex, prtInputModel=prtInputModel, prtInputStatus=prtInputStatus, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtChannelType=prtChannelType, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMarkerColorantTonality=prtMarkerColorantTonality, PrtChannelStateTC=PrtChannelStateTC, prtMarkerColorantRole=prtMarkerColorantRole, prtConsoleDescription=prtConsoleDescription, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputNextIndex=prtInputNextIndex, prtOutputDefaultIndex=prtOutputDefaultIndex, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtGeneral=prtGeneral, printerV1Alert=printerV1Alert, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtOutputGroup=prtOutputGroup, prtInputMediaFormParts=prtInputMediaFormParts, prtAlertGroupIndex=prtAlertGroupIndex, prtAlertAllEvents=prtAlertAllEvents, prtMarkerEastMargin=prtMarkerEastMargin, prtInputCurrentLevel=prtInputCurrentLevel, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInterpreterEntry=prtInterpreterEntry, prtMIBGroups=prtMIBGroups, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputSerialNumber=prtOutputSerialNumber, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtAlertTime=prtAlertTime, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, printmib=printmib, prtInputMediaColor=prtInputMediaColor, PYSNMP_MODULE_ID=printmib, prtInputCapacityUnit=prtInputCapacityUnit, prtMediaPathEntry=prtMediaPathEntry, prtMediaPathDescription=prtMediaPathDescription, prtGeneralReset=prtGeneralReset, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMIB2Groups=prtMIB2Groups, prtMediaPathTable=prtMediaPathTable, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtInputSerialNumber=prtInputSerialNumber, prtCoverTable=prtCoverTable, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMediaPath=prtMediaPath, prtInterpreterIndex=prtInterpreterIndex, prtInterpreterVersion=prtInterpreterVersion, prtGeneralServicePerson=prtGeneralServicePerson, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputIndex=prtOutputIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutputPageCollated=prtOutputPageCollated, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtCoverDescription=prtCoverDescription, prtMIB2Compliance=prtMIB2Compliance, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerIndex=prtMarkerIndex, PrtCapacityUnitTC=PrtCapacityUnitTC, prtOutputDecollating=prtOutputDecollating, prtMediaPathStatus=prtMediaPathStatus, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelIndex=prtChannelIndex, prtInput=prtInput, prtMarkerEntry=prtMarkerEntry, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInterpreterTable=prtInterpreterTable, prtConsoleColor=prtConsoleColor, prtAlertLocation=prtAlertLocation, printerV2AlertPrefix=printerV2AlertPrefix, prtChannelState=prtChannelState, prtInputDefaultIndex=prtInputDefaultIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtDeviceRefIndex=prtDeviceRefIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerSupplies=prtMarkerSupplies, prtMarkerColorant=prtMarkerColorant, prtChannelTable=prtChannelTable, prtInputVersion=prtInputVersion, prtConsoleLightIndex=prtConsoleLightIndex, prtInputMediaWeight=prtInputMediaWeight, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtExtendedInputGroup=prtExtendedInputGroup, MediaUnit=MediaUnit, prtAlert=prtAlert, prtInputSwitchingGroup=prtInputSwitchingGroup, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInterpreterGroup=prtInterpreterGroup, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtAlertDescription=prtAlertDescription, prtConsoleDisable=prtConsoleDisable, prtInputTable=prtInputTable, prtCoverStatus=prtCoverStatus, prtOutput=prtOutput, prtOutputSecurity=prtOutputSecurity, prtCover=prtCover, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInterpreterDescription=prtInterpreterDescription, prtMediaPathGroup=prtMediaPathGroup, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInterpreterTwoWay=prtInterpreterTwoWay, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerTable=prtMarkerTable, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInterpreterLangLevel=prtInterpreterLangLevel, CapacityUnit=CapacityUnit, prtGeneralEntry=prtGeneralEntry, prtOutputBursting=prtOutputBursting, prtMarkerColorantIndex=prtMarkerColorantIndex, prtLocalizationIndex=prtLocalizationIndex, prtInputGroup=prtInputGroup, prtStorageRefIndex=prtStorageRefIndex, prtOutputStackingOrder=prtOutputStackingOrder)
mibBuilder.exportSymbols("Printer-MIB", prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarkerGroup=prtMarkerGroup, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage)
