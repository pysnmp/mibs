...
PrtConsoleDisableTC, PrtAlertTrainingLevelTC, PrtGeneralResetTC, PrtMarkerMarkTechTC, PrtConsoleColorTC, PrtAlertCodeTC, PrtInputTypeTC, PrtCoverStatusTC, PrtChannelTypeTC, PrtInterpreterLangFamilyTC, PrtOutputTypeTC, PrtMarkerSuppliesTypeTC, PrtAlertGroupTC, PrtMediaPathTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleDisableTC", "PrtAlertTrainingLevelTC", "PrtGeneralResetTC", "PrtMarkerMarkTechTC", "PrtConsoleColorTC", "PrtAlertCodeTC", "PrtInputTypeTC", "PrtCoverStatusTC", "PrtChannelTypeTC", "PrtInterpreterLangFamilyTC", "PrtOutputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtAlertGroupTC", "PrtMediaPathTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInputEntry=prtInputEntry, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMediaColor=prtInputMediaColor, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, PrtMediaUnitTC=PrtMediaUnitTC, prtLocalizationCountry=prtLocalizationCountry, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtAlertTable=prtAlertTable, prtAlertCode=prtAlertCode, prtCoverTable=prtCoverTable, prtOutputBursting=prtOutputBursting, prtAlertTime=prtAlertTime, prtMIBConformance=prtMIBConformance, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerGroup=prtMarkerGroup, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInterpreterIndex=prtInterpreterIndex, prtOutputTable=prtOutputTable, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerProcessColorants=prtMarkerProcessColorants, prtChannelType=prtChannelType, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputTable=prtInputTable, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInputGroup=prtInputGroup, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtInterpreter=prtInterpreter, prtInputMediaType=prtInputMediaType, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtAlertTableGroup=prtAlertTableGroup, prtGeneralReset=prtGeneralReset, CodedCharSet=CodedCharSet, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtOutputDescription=prtOutputDescription, prtMarkerWestMargin=prtMarkerWestMargin, prtMediaPathType=prtMediaPathType, prtMediaPathGroup=prtMediaPathGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputDescription=prtInputDescription, prtMarkerColorantTonality=prtMarkerColorantTonality, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMIBCompliance=prtMIBCompliance, prtInterpreterLangLevel=prtInterpreterLangLevel, SubUnitStatus=SubUnitStatus, prtAlertGroup=prtAlertGroup, printerV1Alert=printerV1Alert, prtOutputSecurity=prtOutputSecurity, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInputNextIndex=prtInputNextIndex, prtInputMaxCapacity=prtInputMaxCapacity, prtAlertGroupIndex=prtAlertGroupIndex, PrtChannelStateTC=PrtChannelStateTC, prtMarkerTable=prtMarkerTable, prtAlertDescription=prtAlertDescription, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtChannel=prtChannel, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputMediaName=prtInputMediaName, prtOutputCapacityUnit=prtOutputCapacityUnit, prtGeneralConfigChanges=prtGeneralConfigChanges, CapacityUnit=CapacityUnit, prtAlertCriticalEvents=prtAlertCriticalEvents, prtChannelEntry=prtChannelEntry, PresentOnOff=PresentOnOff, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtAlertEntry=prtAlertEntry, prtMarkerSouthMargin=prtMarkerSouthMargin, prtStorageRefIndex=prtStorageRefIndex, prtOutputIndex=prtOutputIndex, prtOutputName=prtOutputName, prtMarkerEntry=prtMarkerEntry, prtMediaPathStatus=prtMediaPathStatus, prtMarkerColorant=prtMarkerColorant, prtMarkerSuppliesType=prtMarkerSuppliesType, prtOutputGroup=prtOutputGroup, prtMarker=prtMarker, prtMarkerColorantValue=prtMarkerColorantValue, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInterpreterLangVersion=prtInterpreterLangVersion, prtStorageRefTable=prtStorageRefTable, prtOutputSerialNumber=prtOutputSerialNumber, prtOutputType=prtOutputType, prtInputVersion=prtInputVersion, prtInputDimUnit=prtInputDimUnit, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtCoverEntry=prtCoverEntry, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtGeneral=prtGeneral, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtGeneralSerialNumber=prtGeneralSerialNumber, prtGeneralServicePerson=prtGeneralServicePerson, prtConsoleLightTable=prtConsoleLightTable, prtConsoleColor=prtConsoleColor, prtAlertIndex=prtAlertIndex, prtExtendedOutputGroup=prtExtendedOutputGroup, prtInterpreterVersion=prtInterpreterVersion, prtInterpreterGroup=prtInterpreterGroup, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMarkerIndex=prtMarkerIndex, printerV2AlertPrefix=printerV2AlertPrefix, prtOutputDimUnit=prtOutputDimUnit, prtOutputVendorName=prtOutputVendorName, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtCoverDescription=prtCoverDescription, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMarkerColorantIndex=prtMarkerColorantIndex, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInterpreterDescription=prtInterpreterDescription, prtLocalization=prtLocalization, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtAlert=prtAlert, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtLocalizationIndex=prtLocalizationIndex, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerEastMargin=prtMarkerEastMargin, prtConsoleOnTime=prtConsoleOnTime, prtDeviceRefIndex=prtDeviceRefIndex, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerColorantEntry=prtMarkerColorantEntry, prtInterpreterEntry=prtInterpreterEntry, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMediaPathEntry=prtMediaPathEntry, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtConsoleGroup=prtConsoleGroup, prtLocalizationEntry=prtLocalizationEntry, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtChannelStatus=prtChannelStatus, prtChannelInformation=prtChannelInformation, prtConsoleLights=prtConsoleLights, prtInputCapacityUnit=prtInputCapacityUnit, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, PYSNMP_MODULE_ID=printmib, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtExtendedInputGroup=prtExtendedInputGroup, prtConsoleLightEntry=prtConsoleLightEntry, prtMediaPathTable=prtMediaPathTable, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtOutputVersion=prtOutputVersion, prtChannelIfIndex=prtChannelIfIndex, printerV2Alert=printerV2Alert, prtMIBGroups=prtMIBGroups, prtMarkerStatus=prtMarkerStatus, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtOutputEntry=prtOutputEntry, prtConsoleLocalization=prtConsoleLocalization, prtInputSerialNumber=prtInputSerialNumber, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputPageCollated=prtOutputPageCollated, prtChannelState=prtChannelState, prtLocalizationLanguage=prtLocalizationLanguage, prtAlertAllEvents=prtAlertAllEvents, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtChannelIndex=prtChannelIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtOutput=prtOutput, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtConsoleDisable=prtConsoleDisable, prtAlertTimeGroup=prtAlertTimeGroup, prtInterpreterTable=prtInterpreterTable, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerColorantTable=prtMarkerColorantTable, prtInterpreterLangFamily=prtInterpreterLangFamily, MediaUnit=MediaUnit, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtOutputDecollating=prtOutputDecollating, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtOutputStackingOrder=prtOutputStackingOrder, prtInputSwitchingGroup=prtInputSwitchingGroup, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtLocalizationTable=prtLocalizationTable, printmib=printmib, prtMIB2Groups=prtMIB2Groups, prtAlertTrapGroup=prtAlertTrapGroup, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInputType=prtInputType, prtInputMediaWeight=prtInputMediaWeight, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInputVendorName=prtInputVendorName, prtMarkerColorantRole=prtMarkerColorantRole, prtCoverIndex=prtCoverIndex, prtConsoleDescription=prtConsoleDescription, prtOutputModel=prtOutputModel, prtMarkerCounterUnit=prtMarkerCounterUnit, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMediaPath=prtMediaPath, prtAlertTrainingLevel=prtAlertTrainingLevel, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtGeneralGroup=prtGeneralGroup, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInput=prtInput, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMarkerSupplies=prtMarkerSupplies, prtMediaPathIndex=prtMediaPathIndex, prtInputMediaGroup=prtInputMediaGroup, prtConsoleOffTime=prtConsoleOffTime, prtMarkerNorthMargin=prtMarkerNorthMargin, prtChannelGroup=prtChannelGroup, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputSecurity=prtInputSecurity, prtGeneralEntry=prtGeneralEntry, prtAlertLocation=prtAlertLocation, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMIB2Compliance=prtMIB2Compliance, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtGeneralTable=prtGeneralTable, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInputModel=prtInputModel, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtConsoleLightIndex=prtConsoleLightIndex, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtCover=prtCover, prtGeneralV2Group=prtGeneralV2Group, prtCoverStatus=prtCoverStatus, prtOutputMaxCapacity=prtOutputMaxCapacity, prtInputIndex=prtInputIndex, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMediaPathDescription=prtMediaPathDescription, prtAlertTableV2Group=prtAlertTableV2Group, prtChannelV2Group=prtChannelV2Group, prtDeviceRefTable=prtDeviceRefTable, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputStatus=prtOutputStatus, prtInputName=prtInputName)
mibBuilder.exportSymbols("Printer-MIB", prtChannelTable=prtChannelTable, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInputStatus=prtInputStatus, prtStorageRefEntry=prtStorageRefEntry)
