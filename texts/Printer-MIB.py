...
PrtCoverStatusTC, PrtInterpreterLangFamilyTC, PrtMarkerMarkTechTC, PrtConsoleColorTC, PrtInputTypeTC, PrtOutputTypeTC, PrtMediaPathTypeTC, PrtGeneralResetTC, PrtAlertGroupTC, PrtAlertTrainingLevelTC, PrtConsoleDisableTC, PrtAlertCodeTC, PrtChannelTypeTC, PrtMarkerSuppliesTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtCoverStatusTC", "PrtInterpreterLangFamilyTC", "PrtMarkerMarkTechTC", "PrtConsoleColorTC", "PrtInputTypeTC", "PrtOutputTypeTC", "PrtMediaPathTypeTC", "PrtGeneralResetTC", "PrtAlertGroupTC", "PrtAlertTrainingLevelTC", "PrtConsoleDisableTC", "PrtAlertCodeTC", "PrtChannelTypeTC", "PrtMarkerSuppliesTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtAlertSeverityLevel=prtAlertSeverityLevel, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMIBGroups=prtMIBGroups, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerSpotColorants=prtMarkerSpotColorants, prtGeneralPrinterName=prtGeneralPrinterName, prtAlertDescription=prtAlertDescription, prtGeneralReset=prtGeneralReset, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputDescription=prtOutputDescription, prtChannelState=prtChannelState, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtExtendedInputGroup=prtExtendedInputGroup, prtGeneralEntry=prtGeneralEntry, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, SubUnitStatus=SubUnitStatus, PrtMediaUnitTC=PrtMediaUnitTC, prtConsoleLightIndex=prtConsoleLightIndex, prtChannelStatus=prtChannelStatus, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMediaPathDescription=prtMediaPathDescription, prtInputName=prtInputName, printmib=printmib, prtInputEntry=prtInputEntry, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMediaPathEntry=prtMediaPathEntry, prtCoverStatus=prtCoverStatus, prtConsoleLights=prtConsoleLights, prtStorageRefEntry=prtStorageRefEntry, prtOutputStatus=prtOutputStatus, printerV2Alert=printerV2Alert, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInputMediaColor=prtInputMediaColor, prtAlertLocation=prtAlertLocation, prtLocalizationTable=prtLocalizationTable, prtMarkerColorantIndex=prtMarkerColorantIndex, prtChannelInformation=prtChannelInformation, prtInputMediaWeight=prtInputMediaWeight, prtOutputPageCollated=prtOutputPageCollated, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerTable=prtMarkerTable, prtStorageRefIndex=prtStorageRefIndex, prtInputDescription=prtInputDescription, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInterpreterEntry=prtInterpreterEntry, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtConsoleOffTime=prtConsoleOffTime, prtConsoleGroup=prtConsoleGroup, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarker=prtMarker, prtGeneralTable=prtGeneralTable, prtAlertGroupIndex=prtAlertGroupIndex, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtAlertGroup=prtAlertGroup, prtInputMaxCapacity=prtInputMaxCapacity, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtChannelGroup=prtChannelGroup, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInputCurrentLevel=prtInputCurrentLevel, prtAlertEntry=prtAlertEntry, prtMediaPath=prtMediaPath, prtMarkerNorthMargin=prtMarkerNorthMargin, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInputMediaFormParts=prtInputMediaFormParts, PresentOnOff=PresentOnOff, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerWestMargin=prtMarkerWestMargin, prtGeneral=prtGeneral, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerIndex=prtMarkerIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtMediaPathGroup=prtMediaPathGroup, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInputVendorName=prtInputVendorName, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtOutputEntry=prtOutputEntry, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtLocalizationEntry=prtLocalizationEntry, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtAlertIndex=prtAlertIndex, prtInputMediaName=prtInputMediaName, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtOutputType=prtOutputType, prtMarkerProcessColorants=prtMarkerProcessColorants, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputVersion=prtInputVersion, prtOutputIndex=prtOutputIndex, prtLocalization=prtLocalization, prtCover=prtCover, prtCoverEntry=prtCoverEntry, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInterpreterTable=prtInterpreterTable, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, PrtCapacityUnitTC=PrtCapacityUnitTC, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMIBConformance=prtMIBConformance, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInterpreterLangFamily=prtInterpreterLangFamily, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtAlertTime=prtAlertTime, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtConsoleOnTime=prtConsoleOnTime, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerGroup=prtMarkerGroup, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInterpreterGroup=prtInterpreterGroup, prtAlertTrapGroup=prtAlertTrapGroup, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtCoverIndex=prtCoverIndex, PrtPrintOrientationTC=PrtPrintOrientationTC, prtChannelEntry=prtChannelEntry, prtOutputGroup=prtOutputGroup, prtMarkerColorantGroup=prtMarkerColorantGroup, prtChannel=prtChannel, prtInputIndex=prtInputIndex, prtMarkerColorantTable=prtMarkerColorantTable, prtConsoleColor=prtConsoleColor, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtChannelIfIndex=prtChannelIfIndex, prtDeviceRefTable=prtDeviceRefTable, prtOutputTable=prtOutputTable, prtChannelTable=prtChannelTable, prtDeviceRefEntry=prtDeviceRefEntry, prtInputSerialNumber=prtInputSerialNumber, prtOutputVersion=prtOutputVersion, PYSNMP_MODULE_ID=printmib, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMediaPathStatus=prtMediaPathStatus, prtOutputBursting=prtOutputBursting, prtConsoleLightTable=prtConsoleLightTable, prtLocalizationCountry=prtLocalizationCountry, prtOutputDimUnit=prtOutputDimUnit, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInput=prtInput, prtInputModel=prtInputModel, MediaUnit=MediaUnit, prtInterpreterIndex=prtInterpreterIndex, prtGeneralGroup=prtGeneralGroup, prtMediaPathTable=prtMediaPathTable, prtMarkerSouthMargin=prtMarkerSouthMargin, prtOutputSerialNumber=prtOutputSerialNumber, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, printerV2AlertPrefix=printerV2AlertPrefix, prtInputStatus=prtInputStatus, prtInputMediaType=prtInputMediaType, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarkerColorant=prtMarkerColorant, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputName=prtOutputName, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerSupplies=prtMarkerSupplies, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInputGroup=prtInputGroup, prtConsoleLightEntry=prtConsoleLightEntry, prtOutputModel=prtOutputModel, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMarkerColorantValue=prtMarkerColorantValue, PrtChannelStateTC=PrtChannelStateTC, prtOutput=prtOutput, prtMediaPathType=prtMediaPathType, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, CapacityUnit=CapacityUnit, prtInputType=prtInputType, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtCoverDescription=prtCoverDescription, CodedCharSet=CodedCharSet, prtOutputDecollating=prtOutputDecollating, prtChannelV2Group=prtChannelV2Group, prtAlert=prtAlert, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerEntry=prtMarkerEntry, prtConsoleDisable=prtConsoleDisable, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMediaPathIndex=prtMediaPathIndex, prtMIBCompliance=prtMIBCompliance, prtAlertTable=prtAlertTable, prtAlertCode=prtAlertCode, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtConsoleLocalization=prtConsoleLocalization, prtInputNextIndex=prtInputNextIndex, prtOutputSecurity=prtOutputSecurity, prtMarkerLifeCount=prtMarkerLifeCount, prtOutputVendorName=prtOutputVendorName, prtInputCapacityUnit=prtInputCapacityUnit, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtCoverTable=prtCoverTable, prtInputTable=prtInputTable, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInputDimUnit=prtInputDimUnit, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMIB2Compliance=prtMIB2Compliance, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMarkerEastMargin=prtMarkerEastMargin, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerStatus=prtMarkerStatus, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtChannelType=prtChannelType, prtInterpreterVersion=prtInterpreterVersion, prtInputMediaGroup=prtInputMediaGroup, prtMarkerMarkTech=prtMarkerMarkTech, prtConsoleDescription=prtConsoleDescription, prtAlertTableGroup=prtAlertTableGroup, printerV1Alert=printerV1Alert, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtLocalizationIndex=prtLocalizationIndex, prtMIB2Groups=prtMIB2Groups, prtGeneralConfigChanges=prtGeneralConfigChanges, prtAlertAllEvents=prtAlertAllEvents, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInputSecurity=prtInputSecurity, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInterpreterDescription=prtInterpreterDescription, prtChannelProtocolVersion=prtChannelProtocolVersion, prtGeneralV2Group=prtGeneralV2Group, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtGeneralSerialNumber=prtGeneralSerialNumber, prtChannelIndex=prtChannelIndex)
mibBuilder.exportSymbols("Printer-MIB", prtInterpreter=prtInterpreter, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtStorageRefTable=prtStorageRefTable)
