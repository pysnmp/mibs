...
PrtMarkerSuppliesTypeTC, PrtInputTypeTC, PrtAlertTrainingLevelTC, PrtAlertGroupTC, PrtGeneralResetTC, PrtConsoleDisableTC, PrtCoverStatusTC, PrtMediaPathTypeTC, PrtInterpreterLangFamilyTC, PrtMarkerMarkTechTC, PrtOutputTypeTC, PrtChannelTypeTC, PrtAlertCodeTC, PrtConsoleColorTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerSuppliesTypeTC", "PrtInputTypeTC", "PrtAlertTrainingLevelTC", "PrtAlertGroupTC", "PrtGeneralResetTC", "PrtConsoleDisableTC", "PrtCoverStatusTC", "PrtMediaPathTypeTC", "PrtInterpreterLangFamilyTC", "PrtMarkerMarkTechTC", "PrtOutputTypeTC", "PrtChannelTypeTC", "PrtAlertCodeTC", "PrtConsoleColorTC")
...
mibBuilder.exportSymbols("Printer-MIB", MediaUnit=MediaUnit, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtOutputIndex=prtOutputIndex, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtLocalizationTable=prtLocalizationTable, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, PrtChannelStateTC=PrtChannelStateTC, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtConsoleLightTable=prtConsoleLightTable, prtMIBGroups=prtMIBGroups, prtChannelGroup=prtChannelGroup, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtOutputBursting=prtOutputBursting, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInterpreterLangLevel=prtInterpreterLangLevel, prtCoverEntry=prtCoverEntry, prtOutputEntry=prtOutputEntry, prtStorageRefIndex=prtStorageRefIndex, prtInputMediaWeight=prtInputMediaWeight, prtGeneral=prtGeneral, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerEastMargin=prtMarkerEastMargin, prtAlertCode=prtAlertCode, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtLocalizationEntry=prtLocalizationEntry, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtChannelIndex=prtChannelIndex, prtOutputSerialNumber=prtOutputSerialNumber, prtMediaPathType=prtMediaPathType, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInputGroup=prtInputGroup, prtInputEntry=prtInputEntry, prtInterpreterLangFamily=prtInterpreterLangFamily, prtChannelInformation=prtChannelInformation, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMarkerColorantTonality=prtMarkerColorantTonality, prtLocalization=prtLocalization, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMediaPathIndex=prtMediaPathIndex, prtInterpreterDescription=prtInterpreterDescription, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtGeneralTable=prtGeneralTable, prtAlertGroupIndex=prtAlertGroupIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtInterpreter=prtInterpreter, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerSupplies=prtMarkerSupplies, prtConsoleLights=prtConsoleLights, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtOutputName=prtOutputName, prtAlert=prtAlert, prtOutputStackingOrder=prtOutputStackingOrder, prtInterpreterVersion=prtInterpreterVersion, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInputMediaFormParts=prtInputMediaFormParts, prtGeneralV2Group=prtGeneralV2Group, prtOutputPageCollated=prtOutputPageCollated, CodedCharSet=CodedCharSet, prtMarkerColorantValue=prtMarkerColorantValue, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerWestMargin=prtMarkerWestMargin, prtConsoleDescription=prtConsoleDescription, prtInputDimUnit=prtInputDimUnit, prtAlertTime=prtAlertTime, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInputModel=prtInputModel, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMarkerSouthMargin=prtMarkerSouthMargin, prtCoverIndex=prtCoverIndex, prtMarkerGroup=prtMarkerGroup, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtDeviceRefIndex=prtDeviceRefIndex, printerV1Alert=printerV1Alert, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputSecurity=prtOutputSecurity, prtOutputDecollating=prtOutputDecollating, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerEntry=prtMarkerEntry, prtInputStatus=prtInputStatus, prtStorageRefTable=prtStorageRefTable, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtGeneralEntry=prtGeneralEntry, prtMIBCompliance=prtMIBCompliance, prtInput=prtInput, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerColorantGroup=prtMarkerColorantGroup, prtExtendedOutputGroup=prtExtendedOutputGroup, prtAlertTableV2Group=prtAlertTableV2Group, prtAlertTrapGroup=prtAlertTrapGroup, prtConsoleDisable=prtConsoleDisable, prtChannelTable=prtChannelTable, prtInputSerialNumber=prtInputSerialNumber, prtInputVendorName=prtInputVendorName, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtGeneralReset=prtGeneralReset, printerV2Alert=printerV2Alert, prtMarkerTable=prtMarkerTable, prtMarkerLifeCount=prtMarkerLifeCount, prtAlertTrainingLevel=prtAlertTrainingLevel, prtStorageRefEntry=prtStorageRefEntry, prtMediaPathGroup=prtMediaPathGroup, PresentOnOff=PresentOnOff, prtAlertAllEvents=prtAlertAllEvents, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInterpreterGroup=prtInterpreterGroup, prtInputVersion=prtInputVersion, prtInterpreterEntry=prtInterpreterEntry, prtLocalizationCountry=prtLocalizationCountry, prtOutputDimUnit=prtOutputDimUnit, prtInputSecurity=prtInputSecurity, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, PrtPrintOrientationTC=PrtPrintOrientationTC, prtConsoleLightIndex=prtConsoleLightIndex, prtAlertLocation=prtAlertLocation, prtInputName=prtInputName, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerIndex=prtMarkerIndex, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, PYSNMP_MODULE_ID=printmib, prtCoverTable=prtCoverTable, prtInputMediaGroup=prtInputMediaGroup, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInputMediaType=prtInputMediaType, prtOutputVersion=prtOutputVersion, SubUnitStatus=SubUnitStatus, prtGeneralConfigChanges=prtGeneralConfigChanges, prtChannelV2Group=prtChannelV2Group, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, printmib=printmib, prtOutputStatus=prtOutputStatus, prtMarkerColorant=prtMarkerColorant, prtMarkerColorantEntry=prtMarkerColorantEntry, prtChannelType=prtChannelType, prtChannelState=prtChannelState, prtOutputMaxCapacity=prtOutputMaxCapacity, prtAlertTable=prtAlertTable, prtOutputOffsetStacking=prtOutputOffsetStacking, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInputTable=prtInputTable, prtOutputType=prtOutputType, prtChannel=prtChannel, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtDeviceRefEntry=prtDeviceRefEntry, prtInputSwitchingGroup=prtInputSwitchingGroup, prtChannelStatus=prtChannelStatus, prtMediaPathStatus=prtMediaPathStatus, prtOutput=prtOutput, prtGeneralServicePerson=prtGeneralServicePerson, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputType=prtInputType, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInputMediaColor=prtInputMediaColor, prtMediaPath=prtMediaPath, prtMIBConformance=prtMIBConformance, prtAlertIndex=prtAlertIndex, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtConsoleOffTime=prtConsoleOffTime, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtOutputTable=prtOutputTable, prtOutputVendorName=prtOutputVendorName, prtCoverStatus=prtCoverStatus, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMediaPathDescription=prtMediaPathDescription, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtConsoleLightEntry=prtConsoleLightEntry, prtLocalizationIndex=prtLocalizationIndex, prtMarkerStatus=prtMarkerStatus, prtDeviceRefTable=prtDeviceRefTable, prtInputNextIndex=prtInputNextIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtInputIndex=prtInputIndex, prtConsoleLocalization=prtConsoleLocalization, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMarkerColorantTable=prtMarkerColorantTable, prtInterpreterIndex=prtInterpreterIndex, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputDescription=prtOutputDescription, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInterpreterLangVersion=prtInterpreterLangVersion, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtCover=prtCover, prtMarkerCounterUnit=prtMarkerCounterUnit, prtChannelIfIndex=prtChannelIfIndex, prtConsoleColor=prtConsoleColor, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMarker=prtMarker, prtGeneralPrinterName=prtGeneralPrinterName, prtAlertEntry=prtAlertEntry, prtMIB2Compliance=prtMIB2Compliance, prtOutputGroup=prtOutputGroup, prtOutputDefaultIndex=prtOutputDefaultIndex, prtConsoleOnTime=prtConsoleOnTime, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMediaPathTable=prtMediaPathTable, prtMediaPathEntry=prtMediaPathEntry, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInterpreterTable=prtInterpreterTable, prtMIB2Groups=prtMIB2Groups, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtGeneralGroup=prtGeneralGroup, CapacityUnit=CapacityUnit, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtCoverDescription=prtCoverDescription, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertSeverityLevel=prtAlertSeverityLevel, prtAlertDescription=prtAlertDescription, prtMarkerColorantRole=prtMarkerColorantRole, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtAlertGroup=prtAlertGroup, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtChannelEntry=prtChannelEntry, prtOutputModel=prtOutputModel, prtInputDescription=prtInputDescription, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputCapacityUnit=prtInputCapacityUnit, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtExtendedInputGroup=prtExtendedInputGroup, prtConsoleGroup=prtConsoleGroup, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerSuppliesType=prtMarkerSuppliesType, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtAlertTableGroup=prtAlertTableGroup, prtInputMediaName=prtInputMediaName, prtMarkerMarkTech=prtMarkerMarkTech, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC)
mibBuilder.exportSymbols("Printer-MIB", prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, printerV2AlertPrefix=printerV2AlertPrefix, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMarkerProcessColorants=prtMarkerProcessColorants)
