...
PrtAlertTrainingLevelTC, PrtGeneralResetTC, PrtConsoleColorTC, PrtMediaPathTypeTC, PrtChannelTypeTC, PrtInterpreterLangFamilyTC, PrtOutputTypeTC, PrtMarkerMarkTechTC, PrtMarkerSuppliesTypeTC, PrtInputTypeTC, PrtAlertGroupTC, PrtConsoleDisableTC, PrtAlertCodeTC, PrtCoverStatusTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertTrainingLevelTC", "PrtGeneralResetTC", "PrtConsoleColorTC", "PrtMediaPathTypeTC", "PrtChannelTypeTC", "PrtInterpreterLangFamilyTC", "PrtOutputTypeTC", "PrtMarkerMarkTechTC", "PrtMarkerSuppliesTypeTC", "PrtInputTypeTC", "PrtAlertGroupTC", "PrtConsoleDisableTC", "PrtAlertCodeTC", "PrtCoverStatusTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtConsoleLights=prtConsoleLights, prtInterpreterLangFamily=prtInterpreterLangFamily, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtAlertEntry=prtAlertEntry, prtGeneralGroup=prtGeneralGroup, prtOutputDescription=prtOutputDescription, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMIBCompliance=prtMIBCompliance, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputTable=prtOutputTable, prtOutputType=prtOutputType, prtOutputDimUnit=prtOutputDimUnit, prtInputName=prtInputName, prtOutputVendorName=prtOutputVendorName, prtGeneralEntry=prtGeneralEntry, prtOutputVersion=prtOutputVersion, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtConsoleGroup=prtConsoleGroup, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtStorageRefEntry=prtStorageRefEntry, printerV2AlertPrefix=printerV2AlertPrefix, prtOutputMaxCapacity=prtOutputMaxCapacity, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputStatus=prtOutputStatus, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtGeneralTable=prtGeneralTable, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtAlertCode=prtAlertCode, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerTable=prtMarkerTable, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputName=prtOutputName, prtMarkerSouthMargin=prtMarkerSouthMargin, prtOutputGroup=prtOutputGroup, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, PresentOnOff=PresentOnOff, prtMarkerMarkTech=prtMarkerMarkTech, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtOutputIndex=prtOutputIndex, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtOutputDecollating=prtOutputDecollating, prtAlertGroupIndex=prtAlertGroupIndex, prtInputModel=prtInputModel, prtMarkerCounterUnit=prtMarkerCounterUnit, prtChannelEntry=prtChannelEntry, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtAlertTable=prtAlertTable, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMarkerIndex=prtMarkerIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtStorageRefTable=prtStorageRefTable, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtCoverIndex=prtCoverIndex, prtOutputModel=prtOutputModel, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerSpotColorants=prtMarkerSpotColorants, prtDeviceRefTable=prtDeviceRefTable, prtInterpreterEntry=prtInterpreterEntry, prtInputGroup=prtInputGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputSecurity=prtInputSecurity, prtInputCapacityUnit=prtInputCapacityUnit, prtGeneralV2Group=prtGeneralV2Group, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtInterpreter=prtInterpreter, PrtChannelStateTC=PrtChannelStateTC, prtLocalizationEntry=prtLocalizationEntry, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputNextIndex=prtInputNextIndex, prtChannelState=prtChannelState, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMIBGroups=prtMIBGroups, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerColorantTonality=prtMarkerColorantTonality, prtChannelIndex=prtChannelIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInputEntry=prtInputEntry, prtMediaPathEntry=prtMediaPathEntry, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtLocalizationTable=prtLocalizationTable, prtInputMediaName=prtInputMediaName, prtAlertTableGroup=prtAlertTableGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, prtAlertGroup=prtAlertGroup, CodedCharSet=CodedCharSet, prtInterpreterGroup=prtInterpreterGroup, CapacityUnit=CapacityUnit, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, PYSNMP_MODULE_ID=printmib, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtConsoleDescription=prtConsoleDescription, prtAlert=prtAlert, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtExtendedInputGroup=prtExtendedInputGroup, prtChannel=prtChannel, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtConsoleLightEntry=prtConsoleLightEntry, prtChannelV2Group=prtChannelV2Group, prtOutputBursting=prtOutputBursting, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputPageCollated=prtOutputPageCollated, PrtMediaUnitTC=PrtMediaUnitTC, prtCoverEntry=prtCoverEntry, prtMarkerColorant=prtMarkerColorant, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMIB2Groups=prtMIB2Groups, prtMediaPathStatus=prtMediaPathStatus, printmib=printmib, prtAlertIndex=prtAlertIndex, prtLocalizationCountry=prtLocalizationCountry, prtInputVendorName=prtInputVendorName, prtMarkerSupplies=prtMarkerSupplies, prtMarkerEntry=prtMarkerEntry, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInputDimUnit=prtInputDimUnit, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtGeneralReset=prtGeneralReset, prtAlertTimeGroup=prtAlertTimeGroup, prtInterpreterVersion=prtInterpreterVersion, prtMarkerEastMargin=prtMarkerEastMargin, prtOutputOffsetStacking=prtOutputOffsetStacking, prtConsoleLocalization=prtConsoleLocalization, prtInputIndex=prtInputIndex, prtInputType=prtInputType, prtOutputCapacityUnit=prtOutputCapacityUnit, prtInputMediaColor=prtInputMediaColor, printerV1Alert=printerV1Alert, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInputDescription=prtInputDescription, prtInputVersion=prtInputVersion, prtInterpreterIndex=prtInterpreterIndex, prtAlertCriticalEvents=prtAlertCriticalEvents, prtOutputDefaultIndex=prtOutputDefaultIndex, prtAlertTrapGroup=prtAlertTrapGroup, prtInterpreterTable=prtInterpreterTable, SubUnitStatus=SubUnitStatus, prtMarkerNorthMargin=prtMarkerNorthMargin, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtAlertAllEvents=prtAlertAllEvents, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutputStackingOrder=prtOutputStackingOrder, prtInputMediaType=prtInputMediaType, prtConsoleLightIndex=prtConsoleLightIndex, prtAlertSeverityLevel=prtAlertSeverityLevel, prtConsoleColor=prtConsoleColor, prtMarkerLifeCount=prtMarkerLifeCount, prtLocalizationIndex=prtLocalizationIndex, prtMarker=prtMarker, prtMIB2Compliance=prtMIB2Compliance, PrtCapacityUnitTC=PrtCapacityUnitTC, prtCoverDescription=prtCoverDescription, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMediaPathGroup=prtMediaPathGroup, prtDeviceRefEntry=prtDeviceRefEntry, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtGeneralServicePerson=prtGeneralServicePerson, prtMediaPathType=prtMediaPathType, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerStatus=prtMarkerStatus, prtLocalization=prtLocalization, prtInputCurrentLevel=prtInputCurrentLevel, prtCover=prtCover, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtInputStatus=prtInputStatus, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerColorantValue=prtMarkerColorantValue, prtConsoleLightTable=prtConsoleLightTable, prtMarkerWestMargin=prtMarkerWestMargin, prtGeneral=prtGeneral, prtGeneralSerialNumber=prtGeneralSerialNumber, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtChannelType=prtChannelType, prtCoverTable=prtCoverTable, prtConsoleOffTime=prtConsoleOffTime, prtConsoleDisable=prtConsoleDisable, prtStorageRefIndex=prtStorageRefIndex, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMarkerSuppliesType=prtMarkerSuppliesType, MediaUnit=MediaUnit, prtInterpreterDescription=prtInterpreterDescription, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMediaPath=prtMediaPath, prtOutputSerialNumber=prtOutputSerialNumber, prtInputMediaWeight=prtInputMediaWeight, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInput=prtInput, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMediaPathDescription=prtMediaPathDescription, prtChannelTable=prtChannelTable, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInputSerialNumber=prtInputSerialNumber, prtOutputSecurity=prtOutputSecurity, prtConsoleOnTime=prtConsoleOnTime, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtAlertLocation=prtAlertLocation, prtInterpreterLangLevel=prtInterpreterLangLevel, prtChannelGroup=prtChannelGroup, prtMediaPathIndex=prtMediaPathIndex, prtMarkerGroup=prtMarkerGroup, prtMarkerColorantEntry=prtMarkerColorantEntry, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtChannelIfIndex=prtChannelIfIndex, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtAlertDescription=prtAlertDescription, prtInputMaxCapacity=prtInputMaxCapacity, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerColorantRole=prtMarkerColorantRole, printerV2Alert=printerV2Alert, prtCoverStatus=prtCoverStatus, prtMarkerColorantTable=prtMarkerColorantTable, prtOutput=prtOutput, prtInputTable=prtInputTable, prtMediaPathTable=prtMediaPathTable, prtChannelInformation=prtChannelInformation, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputMediaFormParts=prtInputMediaFormParts, prtMIBConformance=prtMIBConformance, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputMediaGroup=prtInputMediaGroup, prtAlertTime=prtAlertTime, prtOutputEntry=prtOutputEntry, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared)
mibBuilder.exportSymbols("Printer-MIB", prtInterpreterLangVersion=prtInterpreterLangVersion, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputDefaultIndex=prtInputDefaultIndex, prtChannelStatus=prtChannelStatus)
