...
PrtMarkerMarkTechTC, PrtGeneralResetTC, PrtConsoleDisableTC, PrtMarkerSuppliesTypeTC, PrtConsoleColorTC, PrtCoverStatusTC, PrtMediaPathTypeTC, PrtChannelTypeTC, PrtInputTypeTC, PrtInterpreterLangFamilyTC, PrtAlertTrainingLevelTC, PrtAlertCodeTC, PrtOutputTypeTC, PrtAlertGroupTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerMarkTechTC", "PrtGeneralResetTC", "PrtConsoleDisableTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleColorTC", "PrtCoverStatusTC", "PrtMediaPathTypeTC", "PrtChannelTypeTC", "PrtInputTypeTC", "PrtInterpreterLangFamilyTC", "PrtAlertTrainingLevelTC", "PrtAlertCodeTC", "PrtOutputTypeTC", "PrtAlertGroupTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMediaPathDescription=prtMediaPathDescription, prtAlertLocation=prtAlertLocation, prtMarkerColorant=prtMarkerColorant, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtAlertTableGroup=prtAlertTableGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtLocalization=prtLocalization, prtInterpreterLangFamily=prtInterpreterLangFamily, prtGeneralPrinterName=prtGeneralPrinterName, prtOutputDimUnit=prtOutputDimUnit, prtStorageRefIndex=prtStorageRefIndex, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtLocalizationLanguage=prtLocalizationLanguage, prtConsoleLocalization=prtConsoleLocalization, prtInputSecurity=prtInputSecurity, prtInputVersion=prtInputVersion, prtAlertIndex=prtAlertIndex, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMarkerWestMargin=prtMarkerWestMargin, prtInterpreterDescription=prtInterpreterDescription, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtConsoleGroup=prtConsoleGroup, prtInputCurrentLevel=prtInputCurrentLevel, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, CapacityUnit=CapacityUnit, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInputTable=prtInputTable, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerColorantTable=prtMarkerColorantTable, prtInterpreterIndex=prtInterpreterIndex, prtLocalizationIndex=prtLocalizationIndex, prtInputType=prtInputType, prtInterpreter=prtInterpreter, prtMarkerColorantEntry=prtMarkerColorantEntry, prtGeneralV2Group=prtGeneralV2Group, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, PresentOnOff=PresentOnOff, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtDeviceRefTable=prtDeviceRefTable, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInterpreterVersion=prtInterpreterVersion, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInputMediaColor=prtInputMediaColor, prtMarkerColorantRole=prtMarkerColorantRole, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInputModel=prtInputModel, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtConsoleDescription=prtConsoleDescription, prtInterpreterTwoWay=prtInterpreterTwoWay, prtConsoleOnTime=prtConsoleOnTime, printmib=printmib, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputMediaWeight=prtInputMediaWeight, prtGeneralGroup=prtGeneralGroup, prtChannelInformation=prtChannelInformation, prtDeviceRefIndex=prtDeviceRefIndex, prtChannelTable=prtChannelTable, prtExtendedOutputGroup=prtExtendedOutputGroup, prtGeneral=prtGeneral, prtCoverEntry=prtCoverEntry, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerTable=prtMarkerTable, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInputVendorName=prtInputVendorName, prtAlertEntry=prtAlertEntry, prtMIBCompliance=prtMIBCompliance, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMediaPathGroup=prtMediaPathGroup, printerV2AlertPrefix=printerV2AlertPrefix, prtInputStatus=prtInputStatus, prtOutputGroup=prtOutputGroup, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtAlertTime=prtAlertTime, prtInputSerialNumber=prtInputSerialNumber, prtInputDescription=prtInputDescription, prtGeneralReset=prtGeneralReset, prtOutputModel=prtOutputModel, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputName=prtInputName, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInterpreterGroup=prtInterpreterGroup, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, MediaUnit=MediaUnit, prtOutputType=prtOutputType, prtInputGroup=prtInputGroup, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtAlertAllEvents=prtAlertAllEvents, prtMarkerIndex=prtMarkerIndex, prtMarkerEastMargin=prtMarkerEastMargin, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMediaPathStatus=prtMediaPathStatus, PYSNMP_MODULE_ID=printmib, prtMediaPathTable=prtMediaPathTable, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtConsoleLightEntry=prtConsoleLightEntry, prtInputEntry=prtInputEntry, prtMarker=prtMarker, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInputMediaGroup=prtInputMediaGroup, prtGeneralEntry=prtGeneralEntry, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtChannelType=prtChannelType, prtChannel=prtChannel, prtCoverDescription=prtCoverDescription, prtInput=prtInput, prtInputMediaFormParts=prtInputMediaFormParts, prtInputNextIndex=prtInputNextIndex, prtCoverStatus=prtCoverStatus, prtMarkerEntry=prtMarkerEntry, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMediaPathType=prtMediaPathType, prtMarkerGroup=prtMarkerGroup, prtCoverIndex=prtCoverIndex, prtOutputMaxCapacity=prtOutputMaxCapacity, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerSupplies=prtMarkerSupplies, printerV2Alert=printerV2Alert, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtGeneralConfigChanges=prtGeneralConfigChanges, prtDeviceRefEntry=prtDeviceRefEntry, prtGeneralSerialNumber=prtGeneralSerialNumber, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtChannelGroup=prtChannelGroup, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputMediaName=prtInputMediaName, prtOutputIndex=prtOutputIndex, prtAlertSeverityLevel=prtAlertSeverityLevel, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtExtendedInputGroup=prtExtendedInputGroup, prtInputCapacityUnit=prtInputCapacityUnit, prtOutputVersion=prtOutputVersion, prtOutputVendorName=prtOutputVendorName, prtMIB2Groups=prtMIB2Groups, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputMediaType=prtInputMediaType, prtAlertDescription=prtAlertDescription, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMediaPathIndex=prtMediaPathIndex, prtAlertCriticalEvents=prtAlertCriticalEvents, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtOutputDecollating=prtOutputDecollating, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtOutputBursting=prtOutputBursting, prtConsoleLightIndex=prtConsoleLightIndex, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMarkerStatus=prtMarkerStatus, prtChannelStatus=prtChannelStatus, prtAlert=prtAlert, prtOutputName=prtOutputName, prtChannelState=prtChannelState, prtAlertGroupIndex=prtAlertGroupIndex, prtOutput=prtOutput, prtInputDimUnit=prtInputDimUnit, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtOutputEntry=prtOutputEntry, prtAlertTable=prtAlertTable, prtLocalizationTable=prtLocalizationTable, PrtCapacityUnitTC=PrtCapacityUnitTC, prtGeneralTable=prtGeneralTable, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerMarkTech=prtMarkerMarkTech, printerV1Alert=printerV1Alert, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtChannelV2Group=prtChannelV2Group, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtConsoleDisable=prtConsoleDisable, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtOutputStackingOrder=prtOutputStackingOrder, prtConsoleColor=prtConsoleColor, prtInputIndex=prtInputIndex, SubUnitStatus=SubUnitStatus, prtLocalizationEntry=prtLocalizationEntry, prtChannelEntry=prtChannelEntry, prtInterpreterEntry=prtInterpreterEntry, prtOutputDescription=prtOutputDescription, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, prtCoverTable=prtCoverTable, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMIBGroups=prtMIBGroups, prtOutputPageCollated=prtOutputPageCollated, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtChannelIfIndex=prtChannelIfIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMediaPath=prtMediaPath, prtInterpreterTable=prtInterpreterTable, CodedCharSet=CodedCharSet, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtChannelIndex=prtChannelIndex, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtConsoleLights=prtConsoleLights, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtGeneralServicePerson=prtGeneralServicePerson, prtAlertGroup=prtAlertGroup, prtOutputSecurity=prtOutputSecurity, prtMediaPathEntry=prtMediaPathEntry, prtLocalizationCountry=prtLocalizationCountry, PrtChannelStateTC=PrtChannelStateTC, prtMIBConformance=prtMIBConformance, prtStorageRefEntry=prtStorageRefEntry, prtOutputTable=prtOutputTable, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputMaxCapacity=prtInputMaxCapacity, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtOutputOffsetStacking=prtOutputOffsetStacking, prtStorageRefTable=prtStorageRefTable, prtOutputDefaultIndex=prtOutputDefaultIndex, prtAlertCode=prtAlertCode, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtCover=prtCover, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMarkerProcessColorants=prtMarkerProcessColorants, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerColorantValue=prtMarkerColorantValue, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtOutputStatus=prtOutputStatus, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtConsoleOffTime=prtConsoleOffTime)
mibBuilder.exportSymbols("Printer-MIB", prtMIB2Compliance=prtMIB2Compliance, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtConsoleLightTable=prtConsoleLightTable, PrtMediaUnitTC=PrtMediaUnitTC)
