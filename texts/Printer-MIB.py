...
PrtAlertGroupTC, PrtMarkerMarkTechTC, PrtConsoleColorTC, PrtAlertTrainingLevelTC, PrtMarkerSuppliesTypeTC, PrtChannelTypeTC, PrtGeneralResetTC, PrtCoverStatusTC, PrtInputTypeTC, PrtAlertCodeTC, PrtMediaPathTypeTC, PrtInterpreterLangFamilyTC, PrtOutputTypeTC, PrtConsoleDisableTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertGroupTC", "PrtMarkerMarkTechTC", "PrtConsoleColorTC", "PrtAlertTrainingLevelTC", "PrtMarkerSuppliesTypeTC", "PrtChannelTypeTC", "PrtGeneralResetTC", "PrtCoverStatusTC", "PrtInputTypeTC", "PrtAlertCodeTC", "PrtMediaPathTypeTC", "PrtInterpreterLangFamilyTC", "PrtOutputTypeTC", "PrtConsoleDisableTC")
...
mibBuilder.exportSymbols("Printer-MIB", PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtLocalization=prtLocalization, prtGeneralV2Group=prtGeneralV2Group, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerWestMargin=prtMarkerWestMargin, prtStorageRefEntry=prtStorageRefEntry, prtInputNextIndex=prtInputNextIndex, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtAlertTrapGroup=prtAlertTrapGroup, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputModel=prtInputModel, prtOutputEntry=prtOutputEntry, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInterpreterTable=prtInterpreterTable, prtConsoleOnTime=prtConsoleOnTime, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerSupplies=prtMarkerSupplies, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtOutputStatus=prtOutputStatus, prtAlertCriticalEvents=prtAlertCriticalEvents, prtChannelState=prtChannelState, prtAlertDescription=prtAlertDescription, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInterpreter=prtInterpreter, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlertTimeGroup=prtAlertTimeGroup, prtConsoleLightIndex=prtConsoleLightIndex, prtOutputDescription=prtOutputDescription, prtAlertTable=prtAlertTable, prtInputMediaColor=prtInputMediaColor, prtInterpreterEntry=prtInterpreterEntry, prtAlertTableGroup=prtAlertTableGroup, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtAlertLocation=prtAlertLocation, prtInterpreterGroup=prtInterpreterGroup, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInputVendorName=prtInputVendorName, prtMarkerEntry=prtMarkerEntry, prtAlertIndex=prtAlertIndex, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtConsoleDisable=prtConsoleDisable, prtOutputType=prtOutputType, prtChannelProtocolVersion=prtChannelProtocolVersion, prtChannelV2Group=prtChannelV2Group, prtAlertGroupIndex=prtAlertGroupIndex, prtMediaPathEntry=prtMediaPathEntry, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerSuppliesType=prtMarkerSuppliesType, prtOutputPageCollated=prtOutputPageCollated, prtAlertGroup=prtAlertGroup, prtChannelIndex=prtChannelIndex, prtMIBGroups=prtMIBGroups, printerV2AlertPrefix=printerV2AlertPrefix, prtInputMediaWeight=prtInputMediaWeight, prtOutputTable=prtOutputTable, CapacityUnit=CapacityUnit, prtCoverDescription=prtCoverDescription, prtMIB2Compliance=prtMIB2Compliance, prtInterpreterVersion=prtInterpreterVersion, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtLocalizationIndex=prtLocalizationIndex, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInputStatus=prtInputStatus, prtChannel=prtChannel, prtAlertCode=prtAlertCode, prtLocalizationEntry=prtLocalizationEntry, prtLocalizationLanguage=prtLocalizationLanguage, prtInputSecurity=prtInputSecurity, prtAlertTrainingLevel=prtAlertTrainingLevel, printerV2Alert=printerV2Alert, prtConsoleGroup=prtConsoleGroup, prtMarkerColorant=prtMarkerColorant, PrtPrintOrientationTC=PrtPrintOrientationTC, SubUnitStatus=SubUnitStatus, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputMediaName=prtInputMediaName, prtMarkerStatus=prtMarkerStatus, prtConsoleColor=prtConsoleColor, prtInputTable=prtInputTable, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtConsoleLights=prtConsoleLights, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMediaPathTable=prtMediaPathTable, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputCapacityUnit=prtInputCapacityUnit, prtMarkerGroup=prtMarkerGroup, prtInputMediaGroup=prtInputMediaGroup, prtMediaPathGroup=prtMediaPathGroup, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMarkerColorantIndex=prtMarkerColorantIndex, prtInputEntry=prtInputEntry, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtLocalizationTable=prtLocalizationTable, MediaUnit=MediaUnit, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutput=prtOutput, prtOutputSerialNumber=prtOutputSerialNumber, prtOutputSecurity=prtOutputSecurity, prtOutputBursting=prtOutputBursting, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInputDimUnit=prtInputDimUnit, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputMaxCapacity=prtInputMaxCapacity, prtInputSerialNumber=prtInputSerialNumber, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtGeneralEntry=prtGeneralEntry, prtCoverStatus=prtCoverStatus, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInput=prtInput, prtOutputIndex=prtOutputIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtChannelStatus=prtChannelStatus, prtInputDefaultIndex=prtInputDefaultIndex, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputStackingOrder=prtOutputStackingOrder, prtOutputVersion=prtOutputVersion, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtDeviceRefIndex=prtDeviceRefIndex, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMediaPath=prtMediaPath, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerColorantValue=prtMarkerColorantValue, prtConsoleLightTable=prtConsoleLightTable, prtInputIndex=prtInputIndex, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputOffsetStacking=prtOutputOffsetStacking, CodedCharSet=CodedCharSet, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMediaPathDescription=prtMediaPathDescription, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMarkerIndex=prtMarkerIndex, prtAlert=prtAlert, prtOutputGroup=prtOutputGroup, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtExtendedOutputGroup=prtExtendedOutputGroup, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, PrtCapacityUnitTC=PrtCapacityUnitTC, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtChannelEntry=prtChannelEntry, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathType=prtMediaPathType, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtConsoleLocalization=prtConsoleLocalization, PresentOnOff=PresentOnOff, prtInputName=prtInputName, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtCoverIndex=prtCoverIndex, prtMarkerEastMargin=prtMarkerEastMargin, prtInterpreterIndex=prtInterpreterIndex, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtGeneralConfigChanges=prtGeneralConfigChanges, prtStorageRefIndex=prtStorageRefIndex, prtChannelType=prtChannelType, prtInputType=prtInputType, prtMIB2Groups=prtMIB2Groups, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputDimUnit=prtOutputDimUnit, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtStorageRefTable=prtStorageRefTable, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInterpreterDescription=prtInterpreterDescription, prtMarkerColorantTable=prtMarkerColorantTable, PrtChannelStateTC=PrtChannelStateTC, prtExtendedInputGroup=prtExtendedInputGroup, prtLocalizationCountry=prtLocalizationCountry, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMIBConformance=prtMIBConformance, prtMediaPathIndex=prtMediaPathIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtChannelGroup=prtChannelGroup, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMIBCompliance=prtMIBCompliance, prtInputMediaType=prtInputMediaType, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtCover=prtCover, prtDeviceRefTable=prtDeviceRefTable, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, PrtMediaUnitTC=PrtMediaUnitTC, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerMarkTech=prtMarkerMarkTech, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtChannelInformation=prtChannelInformation, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtGeneralGroup=prtGeneralGroup, prtConsoleOffTime=prtConsoleOffTime, printerV1Alert=printerV1Alert, prtGeneralTable=prtGeneralTable, prtCoverEntry=prtCoverEntry, prtMarkerProcessColorants=prtMarkerProcessColorants, prtGeneralReset=prtGeneralReset, prtMediaPathStatus=prtMediaPathStatus, prtCoverTable=prtCoverTable, prtInputVersion=prtInputVersion, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtChannelIfIndex=prtChannelIfIndex, prtMarker=prtMarker, prtAlertEntry=prtAlertEntry, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutputModel=prtOutputModel, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInterpreterLangVersion=prtInterpreterLangVersion, prtAlertTime=prtAlertTime, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtOutputName=prtOutputName, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtResponsiblePartyGroup=prtResponsiblePartyGroup, printmib=printmib, prtGeneralServicePerson=prtGeneralServicePerson, prtAlertAllEvents=prtAlertAllEvents, prtMarkerColorantTonality=prtMarkerColorantTonality, prtConsoleDescription=prtConsoleDescription, PYSNMP_MODULE_ID=printmib, prtChannelTable=prtChannelTable, prtOutputVendorName=prtOutputVendorName, prtInputDescription=prtInputDescription, prtGeneral=prtGeneral, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputDecollating=prtOutputDecollating, prtDeviceRefEntry=prtDeviceRefEntry, prtInputGroup=prtInputGroup, prtMarkerTable=prtMarkerTable, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerNorthMargin=prtMarkerNorthMargin)
mibBuilder.exportSymbols("Printer-MIB", prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir)
