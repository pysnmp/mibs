...
PrtInputTypeTC, PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC, PrtConsoleColorTC, PrtAlertTrainingLevelTC, PrtOutputTypeTC, PrtAlertCodeTC, PrtCoverStatusTC, PrtAlertGroupTC, PrtConsoleDisableTC, PrtMarkerSuppliesTypeTC, PrtMarkerMarkTechTC, PrtChannelTypeTC, PrtGeneralResetTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInputTypeTC", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC", "PrtConsoleColorTC", "PrtAlertTrainingLevelTC", "PrtOutputTypeTC", "PrtAlertCodeTC", "PrtCoverStatusTC", "PrtAlertGroupTC", "PrtConsoleDisableTC", "PrtMarkerSuppliesTypeTC", "PrtMarkerMarkTechTC", "PrtChannelTypeTC", "PrtGeneralResetTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputNextIndex=prtInputNextIndex, prtMarkerEastMargin=prtMarkerEastMargin, prtOutputName=prtOutputName, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInputName=prtInputName, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInput=prtInput, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtAlertSeverityLevel=prtAlertSeverityLevel, PYSNMP_MODULE_ID=printmib, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputEntry=prtOutputEntry, prtInputModel=prtInputModel, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtOutputDimUnit=prtOutputDimUnit, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerColorantValue=prtMarkerColorantValue, PrtCapacityUnitTC=PrtCapacityUnitTC, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerColorant=prtMarkerColorant, prtGeneralGroup=prtGeneralGroup, PrtPrintOrientationTC=PrtPrintOrientationTC, PresentOnOff=PresentOnOff, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMarkerColorantTable=prtMarkerColorantTable, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtCover=prtCover, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtCoverEntry=prtCoverEntry, prtOutputMaxCapacity=prtOutputMaxCapacity, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtConsoleOnTime=prtConsoleOnTime, prtMediaPathTable=prtMediaPathTable, prtInputGroup=prtInputGroup, prtExtendedOutputGroup=prtExtendedOutputGroup, prtInputMaxCapacity=prtInputMaxCapacity, prtMarkerSupplies=prtMarkerSupplies, prtMediaPathEntry=prtMediaPathEntry, prtAlertTableV2Group=prtAlertTableV2Group, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerMarkTech=prtMarkerMarkTech, prtConsoleDescription=prtConsoleDescription, prtMarkerColorantEntry=prtMarkerColorantEntry, prtInputEntry=prtInputEntry, prtChannelType=prtChannelType, prtChannelStatus=prtChannelStatus, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlertGroup=prtAlertGroup, prtInputVendorName=prtInputVendorName, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtOutputModel=prtOutputModel, prtInterpreterTwoWay=prtInterpreterTwoWay, prtCoverIndex=prtCoverIndex, prtLocalizationIndex=prtLocalizationIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerIndex=prtMarkerIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtLocalizationCountry=prtLocalizationCountry, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerSouthMargin=prtMarkerSouthMargin, prtOutputDescription=prtOutputDescription, prtAlertTable=prtAlertTable, prtMIBConformance=prtMIBConformance, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtChannelIfIndex=prtChannelIfIndex, prtInterpreterDescription=prtInterpreterDescription, prtInterpreterEntry=prtInterpreterEntry, prtConsoleLightIndex=prtConsoleLightIndex, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMediaPathStatus=prtMediaPathStatus, prtDeviceRefTable=prtDeviceRefTable, prtConsoleGroup=prtConsoleGroup, prtMarkerLifeCount=prtMarkerLifeCount, prtGeneralPrinterName=prtGeneralPrinterName, prtInterpreterLangFamily=prtInterpreterLangFamily, CapacityUnit=CapacityUnit, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInputCapacityUnit=prtInputCapacityUnit, prtOutputBursting=prtOutputBursting, prtInputSecurity=prtInputSecurity, prtOutputGroup=prtOutputGroup, prtMarker=prtMarker, printerV1Alert=printerV1Alert, prtAlertTableGroup=prtAlertTableGroup, prtConsoleLights=prtConsoleLights, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMediaPath=prtMediaPath, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInputTable=prtInputTable, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputCapacityUnit=prtOutputCapacityUnit, prtChannel=prtChannel, prtMarkerColorantTonality=prtMarkerColorantTonality, prtGeneralReset=prtGeneralReset, prtMIBGroups=prtMIBGroups, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputMediaType=prtInputMediaType, prtMIBCompliance=prtMIBCompliance, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtCoverTable=prtCoverTable, MediaUnit=MediaUnit, prtOutputVendorName=prtOutputVendorName, prtAlertCode=prtAlertCode, prtExtendedInputGroup=prtExtendedInputGroup, prtChannelGroup=prtChannelGroup, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtConsoleDisable=prtConsoleDisable, prtInterpreter=prtInterpreter, prtLocalizationTable=prtLocalizationTable, prtOutputVersion=prtOutputVersion, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlertEntry=prtAlertEntry, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtAlertLocation=prtAlertLocation, SubUnitStatus=SubUnitStatus, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMediaPathGroup=prtMediaPathGroup, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtDeviceRefIndex=prtDeviceRefIndex, prtMediaPathType=prtMediaPathType, prtChannelV2Group=prtChannelV2Group, prtChannelIndex=prtChannelIndex, printmib=printmib, prtStorageRefEntry=prtStorageRefEntry, prtConsoleColor=prtConsoleColor, prtConsoleLightTable=prtConsoleLightTable, prtInputMediaColor=prtInputMediaColor, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerStatus=prtMarkerStatus, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInputMediaName=prtInputMediaName, prtInterpreterGroup=prtInterpreterGroup, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtConsoleOffTime=prtConsoleOffTime, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtOutputPageCollated=prtOutputPageCollated, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerGroup=prtMarkerGroup, prtInterpreterVersion=prtInterpreterVersion, prtAlertDescription=prtAlertDescription, prtAlertIndex=prtAlertIndex, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtGeneralV2Group=prtGeneralV2Group, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtChannelTable=prtChannelTable, prtMIB2Compliance=prtMIB2Compliance, prtMarkerSuppliesType=prtMarkerSuppliesType, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtLocalizationEntry=prtLocalizationEntry, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtChannelState=prtChannelState, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtCoverDescription=prtCoverDescription, printerV2Alert=printerV2Alert, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutputSerialNumber=prtOutputSerialNumber, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMarkerWestMargin=prtMarkerWestMargin, prtOutputIndex=prtOutputIndex, prtOutputStatus=prtOutputStatus, prtAlert=prtAlert, prtInputDescription=prtInputDescription, prtOutput=prtOutput, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtConsoleLocalization=prtConsoleLocalization, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtInputSerialNumber=prtInputSerialNumber, prtLocalizationLanguage=prtLocalizationLanguage, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtGeneralEntry=prtGeneralEntry, prtGeneralSerialNumber=prtGeneralSerialNumber, prtLocalization=prtLocalization, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtGeneralTable=prtGeneralTable, prtInputVersion=prtInputVersion, prtOutputDecollating=prtOutputDecollating, prtMarkerTable=prtMarkerTable, prtMarkerEntry=prtMarkerEntry, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtChannelInformation=prtChannelInformation, prtMediaPathIndex=prtMediaPathIndex, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtAlertTime=prtAlertTime, prtChannelEntry=prtChannelEntry, prtOutputType=prtOutputType, prtStorageRefTable=prtStorageRefTable, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtAlertTrapGroup=prtAlertTrapGroup, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInterpreterIndex=prtInterpreterIndex, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, printerV2AlertPrefix=printerV2AlertPrefix, prtInterpreterLangVersion=prtInterpreterLangVersion, prtOutputSecurity=prtOutputSecurity, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInputIndex=prtInputIndex, prtOutputTable=prtOutputTable, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtOutputOffsetStacking=prtOutputOffsetStacking, PrtChannelStateTC=PrtChannelStateTC, prtInputDefaultIndex=prtInputDefaultIndex, prtInputType=prtInputType, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtCoverStatus=prtCoverStatus, prtGeneral=prtGeneral, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMIB2Groups=prtMIB2Groups, prtInputMediaWeight=prtInputMediaWeight, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputStatus=prtInputStatus, prtInputMediaGroup=prtInputMediaGroup, prtAlertAllEvents=prtAlertAllEvents, prtInterpreterTable=prtInterpreterTable, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtAlertGroupIndex=prtAlertGroupIndex, prtMediaPathDescription=prtMediaPathDescription, prtStorageRefIndex=prtStorageRefIndex, prtOutputStackingOrder=prtOutputStackingOrder, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMarkerProcessColorants=prtMarkerProcessColorants, CodedCharSet=CodedCharSet, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared)
mibBuilder.exportSymbols("Printer-MIB", PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputDimUnit=prtInputDimUnit, prtGeneralServicePerson=prtGeneralServicePerson)
