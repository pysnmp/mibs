...
PrtMarkerMarkTechTC, PrtConsoleColorTC, PrtOutputTypeTC, PrtAlertCodeTC, PrtMarkerSuppliesTypeTC, PrtMediaPathTypeTC, PrtCoverStatusTC, PrtGeneralResetTC, PrtInterpreterLangFamilyTC, PrtAlertTrainingLevelTC, PrtConsoleDisableTC, PrtInputTypeTC, PrtChannelTypeTC, PrtAlertGroupTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerMarkTechTC", "PrtConsoleColorTC", "PrtOutputTypeTC", "PrtAlertCodeTC", "PrtMarkerSuppliesTypeTC", "PrtMediaPathTypeTC", "PrtCoverStatusTC", "PrtGeneralResetTC", "PrtInterpreterLangFamilyTC", "PrtAlertTrainingLevelTC", "PrtConsoleDisableTC", "PrtInputTypeTC", "PrtChannelTypeTC", "PrtAlertGroupTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMIBCompliance=prtMIBCompliance, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerProcessColorants=prtMarkerProcessColorants, prtStorageRefEntry=prtStorageRefEntry, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, MediaUnit=MediaUnit, prtMarkerColorantTable=prtMarkerColorantTable, PresentOnOff=PresentOnOff, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerEntry=prtMarkerEntry, prtInputStatus=prtInputStatus, PrtCapacityUnitTC=PrtCapacityUnitTC, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtOutputOffsetStacking=prtOutputOffsetStacking, prtExtendedOutputGroup=prtExtendedOutputGroup, printerV2Alert=printerV2Alert, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtOutputModel=prtOutputModel, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerColorantGroup=prtMarkerColorantGroup, prtLocalizationTable=prtLocalizationTable, prtMediaPathGroup=prtMediaPathGroup, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutput=prtOutput, prtOutputIndex=prtOutputIndex, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputName=prtInputName, prtInputMediaColor=prtInputMediaColor, prtConsoleLightIndex=prtConsoleLightIndex, prtGeneralV2Group=prtGeneralV2Group, prtMarkerColorantRole=prtMarkerColorantRole, prtCoverIndex=prtCoverIndex, prtConsoleOnTime=prtConsoleOnTime, prtMediaPathDescription=prtMediaPathDescription, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtAlert=prtAlert, prtChannelIndex=prtChannelIndex, prtAlertTrapGroup=prtAlertTrapGroup, prtInputDimUnit=prtInputDimUnit, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputVendorName=prtInputVendorName, prtMarkerSuppliesType=prtMarkerSuppliesType, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtAlertTable=prtAlertTable, CapacityUnit=CapacityUnit, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerMarkTech=prtMarkerMarkTech, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, PrtChannelStateTC=PrtChannelStateTC, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerGroup=prtMarkerGroup, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMediaPathStatus=prtMediaPathStatus, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtChannelTable=prtChannelTable, prtMediaPath=prtMediaPath, printerV2AlertPrefix=printerV2AlertPrefix, prtInterpreterGroup=prtInterpreterGroup, PYSNMP_MODULE_ID=printmib, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtChannelType=prtChannelType, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputDescription=prtInputDescription, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMIB2Groups=prtMIB2Groups, prtInputType=prtInputType, prtMarkerColorantValue=prtMarkerColorantValue, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelInformation=prtChannelInformation, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtGeneral=prtGeneral, prtChannel=prtChannel, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtAlertLocation=prtAlertLocation, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMediaPathEntry=prtMediaPathEntry, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputMaxCapacity=prtOutputMaxCapacity, prtAlertDescription=prtAlertDescription, prtStorageRefIndex=prtStorageRefIndex, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtStorageRefTable=prtStorageRefTable, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtLocalizationIndex=prtLocalizationIndex, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtConsoleLocalization=prtConsoleLocalization, prtChannelState=prtChannelState, prtInputSwitchingGroup=prtInputSwitchingGroup, prtDeviceRefEntry=prtDeviceRefEntry, prtAlertIndex=prtAlertIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMediaPathTable=prtMediaPathTable, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtConsoleDisable=prtConsoleDisable, prtInputMediaType=prtInputMediaType, prtOutputTable=prtOutputTable, prtMarkerWestMargin=prtMarkerWestMargin, prtAlertTimeGroup=prtAlertTimeGroup, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMediaPathType=prtMediaPathType, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputPageCollated=prtOutputPageCollated, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInterpreterEntry=prtInterpreterEntry, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtOutputStatus=prtOutputStatus, printmib=printmib, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtGeneralPrinterName=prtGeneralPrinterName, prtLocalizationCountry=prtLocalizationCountry, prtAlertGroupIndex=prtAlertGroupIndex, prtInputMaxCapacity=prtInputMaxCapacity, prtLocalization=prtLocalization, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, SubUnitStatus=SubUnitStatus, prtInputVersion=prtInputVersion, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerIndex=prtMarkerIndex, prtInterpreterDescription=prtInterpreterDescription, prtCoverDescription=prtCoverDescription, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerSupplies=prtMarkerSupplies, prtInputTable=prtInputTable, prtOutputStackingOrder=prtOutputStackingOrder, prtGeneralReset=prtGeneralReset, prtMIBGroups=prtMIBGroups, prtLocalizationEntry=prtLocalizationEntry, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtAlertGroup=prtAlertGroup, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtGeneralSerialNumber=prtGeneralSerialNumber, prtLocalizationLanguage=prtLocalizationLanguage, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtOutputSecurity=prtOutputSecurity, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputBursting=prtOutputBursting, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtAlertCode=prtAlertCode, prtOutputDecollating=prtOutputDecollating, prtExtendedInputGroup=prtExtendedInputGroup, prtConsoleLightTable=prtConsoleLightTable, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMIB2Compliance=prtMIB2Compliance, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, PrtMediaUnitTC=PrtMediaUnitTC, prtMediaPathIndex=prtMediaPathIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerStatus=prtMarkerStatus, prtInputIndex=prtInputIndex, prtOutputGroup=prtOutputGroup, prtChannelGroup=prtChannelGroup, prtAlertTrainingLevel=prtAlertTrainingLevel, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputName=prtOutputName, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutputEntry=prtOutputEntry, prtInputEntry=prtInputEntry, prtCoverStatus=prtCoverStatus, prtGeneralEntry=prtGeneralEntry, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMarkerColorant=prtMarkerColorant, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInputMediaGroup=prtInputMediaGroup, prtOutputVendorName=prtOutputVendorName, prtMarkerColorantEntry=prtMarkerColorantEntry, prtChannelV2Group=prtChannelV2Group, prtMarker=prtMarker, prtConsoleColor=prtConsoleColor, prtGeneralGroup=prtGeneralGroup, prtGeneralTable=prtGeneralTable, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputMediaWeight=prtInputMediaWeight, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtChannelIfIndex=prtChannelIfIndex, prtInterpreter=prtInterpreter, prtGeneralServicePerson=prtGeneralServicePerson, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerEastMargin=prtMarkerEastMargin, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerTable=prtMarkerTable, prtMarkerNorthMargin=prtMarkerNorthMargin, prtOutputType=prtOutputType, prtCover=prtCover, prtInterpreterTable=prtInterpreterTable, prtInputGroup=prtInputGroup, prtInput=prtInput, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputSecurity=prtInputSecurity, prtInputSerialNumber=prtInputSerialNumber, prtOutputDescription=prtOutputDescription, prtInputNextIndex=prtInputNextIndex, prtMarkerColorantTonality=prtMarkerColorantTonality, prtOutputDimUnit=prtOutputDimUnit, prtInputModel=prtInputModel, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputMediaName=prtInputMediaName, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMIBConformance=prtMIBConformance, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtAlertTime=prtAlertTime, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtChannelStatus=prtChannelStatus, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtCoverEntry=prtCoverEntry, prtAlertEntry=prtAlertEntry, printerV1Alert=printerV1Alert, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtDeviceRefTable=prtDeviceRefTable, prtConsoleLightEntry=prtConsoleLightEntry, prtAlertSeverityLevel=prtAlertSeverityLevel, prtOutputVersion=prtOutputVersion, prtAlertTableGroup=prtAlertTableGroup, prtCoverTable=prtCoverTable, prtConsoleGroup=prtConsoleGroup, prtInputCapacityUnit=prtInputCapacityUnit, prtConsoleOffTime=prtConsoleOffTime, prtConsoleDescription=prtConsoleDescription, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInterpreterTwoWay=prtInterpreterTwoWay, prtDeviceRefIndex=prtDeviceRefIndex, prtInterpreterIndex=prtInterpreterIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputMediaFormParts=prtInputMediaFormParts, prtChannelEntry=prtChannelEntry, prtAlertAllEvents=prtAlertAllEvents, prtInterpreterVersion=prtInterpreterVersion)
mibBuilder.exportSymbols("Printer-MIB", prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtConsoleLights=prtConsoleLights, CodedCharSet=CodedCharSet, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines)
