...
PrtGeneralResetTC, PrtCoverStatusTC, PrtInputTypeTC, PrtMediaPathTypeTC, PrtAlertGroupTC, PrtInterpreterLangFamilyTC, PrtAlertCodeTC, PrtAlertTrainingLevelTC, PrtMarkerSuppliesTypeTC, PrtConsoleDisableTC, PrtOutputTypeTC, PrtConsoleColorTC, PrtChannelTypeTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtGeneralResetTC", "PrtCoverStatusTC", "PrtInputTypeTC", "PrtMediaPathTypeTC", "PrtAlertGroupTC", "PrtInterpreterLangFamilyTC", "PrtAlertCodeTC", "PrtAlertTrainingLevelTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleDisableTC", "PrtOutputTypeTC", "PrtConsoleColorTC", "PrtChannelTypeTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtLocalizationIndex=prtLocalizationIndex, prtInputDescription=prtInputDescription, prtCoverIndex=prtCoverIndex, prtCoverTable=prtCoverTable, prtAlertTableGroup=prtAlertTableGroup, prtMarkerSupplies=prtMarkerSupplies, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtChannelTable=prtChannelTable, prtOutputSerialNumber=prtOutputSerialNumber, prtInterpreterIndex=prtInterpreterIndex, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMediaPathIndex=prtMediaPathIndex, prtInputMediaGroup=prtInputMediaGroup, prtMarkerSuppliesType=prtMarkerSuppliesType, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMediaPathGroup=prtMediaPathGroup, prtInput=prtInput, prtInputIndex=prtInputIndex, prtLocalizationLanguage=prtLocalizationLanguage, prtAlertEntry=prtAlertEntry, prtConsoleOnTime=prtConsoleOnTime, prtMarker=prtMarker, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtConsoleGroup=prtConsoleGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtExtendedInputGroup=prtExtendedInputGroup, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInputSerialNumber=prtInputSerialNumber, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInputMediaColor=prtInputMediaColor, prtOutput=prtOutput, prtInputMediaFormParts=prtInputMediaFormParts, prtGeneralEntry=prtGeneralEntry, prtOutputType=prtOutputType, prtMarkerProcessColorants=prtMarkerProcessColorants, prtCoverEntry=prtCoverEntry, prtMarkerIndex=prtMarkerIndex, prtConsoleColor=prtConsoleColor, prtChannelType=prtChannelType, prtChannelGroup=prtChannelGroup, prtAlertAllEvents=prtAlertAllEvents, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtAlertGroup=prtAlertGroup, prtStorageRefEntry=prtStorageRefEntry, prtMediaPath=prtMediaPath, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, printmib=printmib, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInputTable=prtInputTable, prtMarkerSpotColorants=prtMarkerSpotColorants, prtOutputMaxCapacity=prtOutputMaxCapacity, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtOutputDescription=prtOutputDescription, prtInputMediaName=prtInputMediaName, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInputType=prtInputType, prtInputDimUnit=prtInputDimUnit, prtOutputStatus=prtOutputStatus, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInputCurrentLevel=prtInputCurrentLevel, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtExtendedOutputGroup=prtExtendedOutputGroup, prtInterpreterDescription=prtInterpreterDescription, prtMarkerEntry=prtMarkerEntry, MediaUnit=MediaUnit, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtOutputVersion=prtOutputVersion, prtInputModel=prtInputModel, prtStorageRefTable=prtStorageRefTable, prtConsoleDisable=prtConsoleDisable, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtOutputSecurity=prtOutputSecurity, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtGeneralReset=prtGeneralReset, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerColorantRole=prtMarkerColorantRole, prtInputNextIndex=prtInputNextIndex, printerV2AlertPrefix=printerV2AlertPrefix, prtMediaPathDescription=prtMediaPathDescription, prtOutputVendorName=prtOutputVendorName, prtMIB2Compliance=prtMIB2Compliance, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInputName=prtInputName, prtOutputCapacityUnit=prtOutputCapacityUnit, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleLocalization=prtConsoleLocalization, PrtChannelStateTC=PrtChannelStateTC, SubUnitStatus=SubUnitStatus, prtChannel=prtChannel, prtConsoleLights=prtConsoleLights, prtMarkerLifeCount=prtMarkerLifeCount, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtStorageRefIndex=prtStorageRefIndex, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtLocalizationTable=prtLocalizationTable, prtInputVersion=prtInputVersion, prtInputVendorName=prtInputVendorName, prtAlertIndex=prtAlertIndex, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtAlertDescription=prtAlertDescription, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputGroup=prtInputGroup, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtConsoleLightTable=prtConsoleLightTable, prtLocalization=prtLocalization, prtMIBGroups=prtMIBGroups, prtInputSwitchingGroup=prtInputSwitchingGroup, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputIndex=prtOutputIndex, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMediaPathStatus=prtMediaPathStatus, prtMarkerGroup=prtMarkerGroup, prtAlertTrainingLevel=prtAlertTrainingLevel, prtCoverStatus=prtCoverStatus, prtInputCapacityUnit=prtInputCapacityUnit, prtAlertTrapGroup=prtAlertTrapGroup, prtInputDefaultIndex=prtInputDefaultIndex, printerV1Alert=printerV1Alert, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputGroup=prtOutputGroup, PrtPrintOrientationTC=PrtPrintOrientationTC, prtDeviceRefTable=prtDeviceRefTable, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtGeneralV2Group=prtGeneralV2Group, prtAlertLocation=prtAlertLocation, PYSNMP_MODULE_ID=printmib, prtOutputDecollating=prtOutputDecollating, prtConsoleDescription=prtConsoleDescription, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputPageCollated=prtOutputPageCollated, prtAlertCriticalEvents=prtAlertCriticalEvents, prtChannelEntry=prtChannelEntry, prtAlertGroupIndex=prtAlertGroupIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerColorantTable=prtMarkerColorantTable, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtOutputEntry=prtOutputEntry, prtInterpreterLangLevel=prtInterpreterLangLevel, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtChannelProtocolVersion=prtChannelProtocolVersion, prtOutputStackingOrder=prtOutputStackingOrder, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputModel=prtOutputModel, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtLocalizationCountry=prtLocalizationCountry, CapacityUnit=CapacityUnit, prtOutputBursting=prtOutputBursting, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMarkerColorantValue=prtMarkerColorantValue, prtMediaPathType=prtMediaPathType, prtChannelIfIndex=prtChannelIfIndex, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtCover=prtCover, prtMediaPathTable=prtMediaPathTable, CodedCharSet=CodedCharSet, prtAlertTable=prtAlertTable, prtInputStatus=prtInputStatus, prtAlertTime=prtAlertTime, prtConsoleLightEntry=prtConsoleLightEntry, prtConsoleOffTime=prtConsoleOffTime, prtGeneralConfigChanges=prtGeneralConfigChanges, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputTable=prtOutputTable, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerTable=prtMarkerTable, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInterpreterVersion=prtInterpreterVersion, prtInterpreterEntry=prtInterpreterEntry, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInterpreterLangFamily=prtInterpreterLangFamily, PresentOnOff=PresentOnOff, prtInputMediaWeight=prtInputMediaWeight, prtCoverDescription=prtCoverDescription, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerStatus=prtMarkerStatus, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerColorantEntry=prtMarkerColorantEntry, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtAlertSeverityLevel=prtAlertSeverityLevel, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtConsoleLightIndex=prtConsoleLightIndex, prtGeneralTable=prtGeneralTable, prtMIB2Groups=prtMIB2Groups, prtInputEntry=prtInputEntry, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerWestMargin=prtMarkerWestMargin, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInterpreter=prtInterpreter, prtInputMediaType=prtInputMediaType, prtChannelInformation=prtChannelInformation, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputName=prtOutputName, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMIBConformance=prtMIBConformance, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputMaxCapacity=prtInputMaxCapacity, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtChannelStatus=prtChannelStatus, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtOutputOffsetStacking=prtOutputOffsetStacking, prtAlertTimeGroup=prtAlertTimeGroup, prtInterpreterTable=prtInterpreterTable, printerV2Alert=printerV2Alert, prtInterpreterGroup=prtInterpreterGroup, prtMarkerColorant=prtMarkerColorant, prtAlertCode=prtAlertCode, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMediaPathEntry=prtMediaPathEntry, prtGeneralGroup=prtGeneralGroup, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInputSecurity=prtInputSecurity, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMIBCompliance=prtMIBCompliance, prtAlert=prtAlert, prtLocalizationEntry=prtLocalizationEntry, prtGeneralServicePerson=prtGeneralServicePerson, PrtCapacityUnitTC=PrtCapacityUnitTC, prtChannelState=prtChannelState, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtGeneral=prtGeneral)
mibBuilder.exportSymbols("Printer-MIB", prtChannelV2Group=prtChannelV2Group, prtChannelIndex=prtChannelIndex, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtOutputDimUnit=prtOutputDimUnit)
