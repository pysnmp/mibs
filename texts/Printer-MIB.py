...
PrtGeneralResetTC, PrtCoverStatusTC, PrtAlertCodeTC, PrtInputTypeTC, PrtOutputTypeTC, PrtAlertGroupTC, PrtAlertTrainingLevelTC, PrtMarkerSuppliesTypeTC, PrtChannelTypeTC, PrtConsoleColorTC, PrtMarkerMarkTechTC, PrtConsoleDisableTC, PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtGeneralResetTC", "PrtCoverStatusTC", "PrtAlertCodeTC", "PrtInputTypeTC", "PrtOutputTypeTC", "PrtAlertGroupTC", "PrtAlertTrainingLevelTC", "PrtMarkerSuppliesTypeTC", "PrtChannelTypeTC", "PrtConsoleColorTC", "PrtMarkerMarkTechTC", "PrtConsoleDisableTC", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerGroup=prtMarkerGroup, prtConsoleLights=prtConsoleLights, prtGeneralServicePerson=prtGeneralServicePerson, prtCover=prtCover, prtInputModel=prtInputModel, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInterpreterEntry=prtInterpreterEntry, prtMIB2Compliance=prtMIB2Compliance, prtMarkerProcessColorants=prtMarkerProcessColorants, prtCoverDescription=prtCoverDescription, prtInputVendorName=prtInputVendorName, SubUnitStatus=SubUnitStatus, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, PrtMediaUnitTC=PrtMediaUnitTC, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtGeneralTable=prtGeneralTable, prtCoverIndex=prtCoverIndex, prtInputGroup=prtInputGroup, prtStorageRefTable=prtStorageRefTable, prtChannelTable=prtChannelTable, prtMediaPathEntry=prtMediaPathEntry, CodedCharSet=CodedCharSet, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtCoverTable=prtCoverTable, printerV2AlertPrefix=printerV2AlertPrefix, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtOutputEntry=prtOutputEntry, prtOutputSecurity=prtOutputSecurity, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMediaPathDescription=prtMediaPathDescription, prtChannelInformation=prtChannelInformation, prtMIBGroups=prtMIBGroups, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtResponsiblePartyGroup=prtResponsiblePartyGroup, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputDimUnit=prtOutputDimUnit, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputIndex=prtOutputIndex, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerColorantTonality=prtMarkerColorantTonality, prtGeneralEntry=prtGeneralEntry, prtDeviceRefTable=prtDeviceRefTable, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, PrtCapacityUnitTC=PrtCapacityUnitTC, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputTable=prtOutputTable, prtConsoleGroup=prtConsoleGroup, prtMarkerColorantTable=prtMarkerColorantTable, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAlertLocation=prtAlertLocation, prtChannelEntry=prtChannelEntry, prtInput=prtInput, prtInputDescription=prtInputDescription, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInterpreter=prtInterpreter, prtConsoleOnTime=prtConsoleOnTime, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerTable=prtMarkerTable, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtLocalizationEntry=prtLocalizationEntry, prtOutputModel=prtOutputModel, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerSupplies=prtMarkerSupplies, CapacityUnit=CapacityUnit, prtCoverEntry=prtCoverEntry, prtAlertTimeGroup=prtAlertTimeGroup, prtInputNextIndex=prtInputNextIndex, prtOutputStackingOrder=prtOutputStackingOrder, prtInputType=prtInputType, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerSuppliesType=prtMarkerSuppliesType, prtChannelStatus=prtChannelStatus, prtAlertDescription=prtAlertDescription, prtInputMediaWeight=prtInputMediaWeight, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInputEntry=prtInputEntry, prtMediaPathStatus=prtMediaPathStatus, prtAlertCode=prtAlertCode, prtStorageRefIndex=prtStorageRefIndex, prtInputMediaType=prtInputMediaType, prtGeneralV2Group=prtGeneralV2Group, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputCapacityUnit=prtInputCapacityUnit, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, PrtPrintOrientationTC=PrtPrintOrientationTC, prtAlertTrainingLevel=prtAlertTrainingLevel, printmib=printmib, MediaUnit=MediaUnit, prtMarkerStatus=prtMarkerStatus, prtInterpreterLangFamily=prtInterpreterLangFamily, prtOutputSerialNumber=prtOutputSerialNumber, prtAlertAllEvents=prtAlertAllEvents, prtGeneralGroup=prtGeneralGroup, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtAlertTrapGroup=prtAlertTrapGroup, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleLightEntry=prtConsoleLightEntry, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterDescription=prtInterpreterDescription, prtAlertTable=prtAlertTable, printerV1Alert=printerV1Alert, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutputVersion=prtOutputVersion, prtOutputName=prtOutputName, prtOutputBursting=prtOutputBursting, prtMarkerLifeCount=prtMarkerLifeCount, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerWestMargin=prtMarkerWestMargin, prtInterpreterIndex=prtInterpreterIndex, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtAlert=prtAlert, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtAlertTime=prtAlertTime, prtInputMediaName=prtInputMediaName, prtMarker=prtMarker, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtAlertGroupIndex=prtAlertGroupIndex, prtExtendedInputGroup=prtExtendedInputGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerEntry=prtMarkerEntry, prtAlertIndex=prtAlertIndex, prtMarkerColorantIndex=prtMarkerColorantIndex, prtGeneralReset=prtGeneralReset, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, PresentOnOff=PresentOnOff, prtAlertEntry=prtAlertEntry, prtOutputDecollating=prtOutputDecollating, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInputSerialNumber=prtInputSerialNumber, prtOutputPageCollated=prtOutputPageCollated, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, PYSNMP_MODULE_ID=printmib, prtLocalization=prtLocalization, prtAlertTableGroup=prtAlertTableGroup, prtConsoleOffTime=prtConsoleOffTime, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerColorant=prtMarkerColorant, prtOutputStatus=prtOutputStatus, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtDeviceRefIndex=prtDeviceRefIndex, prtInputName=prtInputName, prtMarkerNorthMargin=prtMarkerNorthMargin, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtChannelIndex=prtChannelIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInputIndex=prtInputIndex, prtMIB2Groups=prtMIB2Groups, prtExtendedOutputGroup=prtExtendedOutputGroup, prtChannelIfIndex=prtChannelIfIndex, prtConsoleDisable=prtConsoleDisable, prtMediaPathIndex=prtMediaPathIndex, prtConsoleLightIndex=prtConsoleLightIndex, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtChannel=prtChannel, prtInputSecurity=prtInputSecurity, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMediaPathType=prtMediaPathType, prtAlertGroup=prtAlertGroup, prtConsoleColor=prtConsoleColor, prtOutput=prtOutput, prtCoverStatus=prtCoverStatus, prtOutputVendorName=prtOutputVendorName, prtOutputType=prtOutputType, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtGeneral=prtGeneral, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMarkerMarkTech=prtMarkerMarkTech, prtChannelType=prtChannelType, prtMediaPathGroup=prtMediaPathGroup, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInputMaxCapacity=prtInputMaxCapacity, prtInputMediaColor=prtInputMediaColor, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMediaPathTable=prtMediaPathTable, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInterpreterGroup=prtInterpreterGroup, printerV2Alert=printerV2Alert, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtStorageRefEntry=prtStorageRefEntry, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerIndex=prtMarkerIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtChannelState=prtChannelState, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtConsoleDescription=prtConsoleDescription, prtInputVersion=prtInputVersion, prtOutputCapacityUnit=prtOutputCapacityUnit, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtInputTable=prtInputTable, prtInterpreterTable=prtInterpreterTable, prtInterpreterLangLevel=prtInterpreterLangLevel, prtChannelGroup=prtChannelGroup, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtChannelV2Group=prtChannelV2Group, prtInterpreterVersion=prtInterpreterVersion, prtLocalizationTable=prtLocalizationTable, prtMIBConformance=prtMIBConformance, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtConsoleLocalization=prtConsoleLocalization, prtMediaPath=prtMediaPath, PrtChannelStateTC=PrtChannelStateTC, prtOutputGroup=prtOutputGroup, prtInputMediaGroup=prtInputMediaGroup, prtMarkerColorantValue=prtMarkerColorantValue, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerEastMargin=prtMarkerEastMargin, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtConsoleLightTable=prtConsoleLightTable, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInputDefaultIndex=prtInputDefaultIndex, prtInputDimUnit=prtInputDimUnit, prtMIBCompliance=prtMIBCompliance, prtMarkerSpotColorants=prtMarkerSpotColorants, prtOutputDescription=prtOutputDescription, prtMarkerColorantGroup=prtMarkerColorantGroup, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtLocalizationCountry=prtLocalizationCountry, prtOutputMaxCapacity=prtOutputMaxCapacity, prtLocalizationIndex=prtLocalizationIndex, prtInputStatus=prtInputStatus, prtMarkerColorantRole=prtMarkerColorantRole, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit)
mibBuilder.exportSymbols("Printer-MIB", prtAlertTableV2Group=prtAlertTableV2Group, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInputMediaFormParts=prtInputMediaFormParts, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir)
