...
PrtAlertCodeTC, PrtMarkerMarkTechTC, PrtMarkerSuppliesTypeTC, PrtInterpreterLangFamilyTC, PrtAlertTrainingLevelTC, PrtCoverStatusTC, PrtChannelTypeTC, PrtConsoleDisableTC, PrtAlertGroupTC, PrtMediaPathTypeTC, PrtInputTypeTC, PrtConsoleColorTC, PrtOutputTypeTC, PrtGeneralResetTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertCodeTC", "PrtMarkerMarkTechTC", "PrtMarkerSuppliesTypeTC", "PrtInterpreterLangFamilyTC", "PrtAlertTrainingLevelTC", "PrtCoverStatusTC", "PrtChannelTypeTC", "PrtConsoleDisableTC", "PrtAlertGroupTC", "PrtMediaPathTypeTC", "PrtInputTypeTC", "PrtConsoleColorTC", "PrtOutputTypeTC", "PrtGeneralResetTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtAlertIndex=prtAlertIndex, prtInputMediaColor=prtInputMediaColor, prtConsoleDisable=prtConsoleDisable, prtAlertTable=prtAlertTable, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtAlertTableGroup=prtAlertTableGroup, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInput=prtInput, prtOutputSecurity=prtOutputSecurity, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInputCapacityUnit=prtInputCapacityUnit, prtOutputModel=prtOutputModel, prtMarkerStatus=prtMarkerStatus, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputMediaName=prtInputMediaName, prtAlert=prtAlert, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtAlertTimeGroup=prtAlertTimeGroup, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInterpreterTable=prtInterpreterTable, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtConsoleLocalization=prtConsoleLocalization, prtLocalizationLanguage=prtLocalizationLanguage, prtInputVersion=prtInputVersion, prtInputSwitchingGroup=prtInputSwitchingGroup, prtGeneralV2Group=prtGeneralV2Group, prtLocalization=prtLocalization, prtAlertGroupIndex=prtAlertGroupIndex, prtMarkerColorantGroup=prtMarkerColorantGroup, prtConsoleOffTime=prtConsoleOffTime, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtOutputIndex=prtOutputIndex, prtOutputVendorName=prtOutputVendorName, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtAlertTrainingLevel=prtAlertTrainingLevel, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputDefaultIndex=prtInputDefaultIndex, prtInterpreter=prtInterpreter, prtMIBConformance=prtMIBConformance, prtOutputType=prtOutputType, prtOutputDecollating=prtOutputDecollating, prtExtendedInputGroup=prtExtendedInputGroup, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputMediaGroup=prtInputMediaGroup, PrtMediaUnitTC=PrtMediaUnitTC, CapacityUnit=CapacityUnit, prtConsoleOnTime=prtConsoleOnTime, prtMarkerTable=prtMarkerTable, prtAlertDescription=prtAlertDescription, SubUnitStatus=SubUnitStatus, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtGeneral=prtGeneral, prtInputModel=prtInputModel, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputPageCollated=prtOutputPageCollated, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMarkerGroup=prtMarkerGroup, prtInterpreterLangVersion=prtInterpreterLangVersion, prtDeviceRefIndex=prtDeviceRefIndex, prtInputEntry=prtInputEntry, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, printmib=printmib, MediaUnit=MediaUnit, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerEntry=prtMarkerEntry, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInputMediaWeight=prtInputMediaWeight, PYSNMP_MODULE_ID=printmib, prtStorageRefEntry=prtStorageRefEntry, prtOutputEntry=prtOutputEntry, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtStorageRefTable=prtStorageRefTable, prtGeneralReset=prtGeneralReset, prtInputIndex=prtInputIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInputType=prtInputType, prtOutputSerialNumber=prtOutputSerialNumber, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInterpreterGroup=prtInterpreterGroup, prtInterpreterEntry=prtInterpreterEntry, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtAlertLocation=prtAlertLocation, CodedCharSet=CodedCharSet, prtChannelGroup=prtChannelGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInputName=prtInputName, printerV2AlertPrefix=printerV2AlertPrefix, prtInputStatus=prtInputStatus, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInterpreterIndex=prtInterpreterIndex, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMIB2Groups=prtMIB2Groups, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputDimUnit=prtInputDimUnit, prtExtendedOutputGroup=prtExtendedOutputGroup, prtInterpreterLangLevel=prtInterpreterLangLevel, prtChannelV2Group=prtChannelV2Group, prtGeneralSerialNumber=prtGeneralSerialNumber, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtChannelType=prtChannelType, prtLocalizationEntry=prtLocalizationEntry, prtChannelEntry=prtChannelEntry, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerColorant=prtMarkerColorant, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtDeviceRefTable=prtDeviceRefTable, prtMarkerSuppliesType=prtMarkerSuppliesType, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtAlertAllEvents=prtAlertAllEvents, prtOutputOffsetStacking=prtOutputOffsetStacking, prtGeneralGroup=prtGeneralGroup, prtCoverDescription=prtCoverDescription, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtConsoleLightIndex=prtConsoleLightIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtChannelTable=prtChannelTable, prtInputGroup=prtInputGroup, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMediaPathDescription=prtMediaPathDescription, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtChannelIfIndex=prtChannelIfIndex, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtOutputStatus=prtOutputStatus, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtStorageRefIndex=prtStorageRefIndex, prtOutputName=prtOutputName, prtInputSecurity=prtInputSecurity, prtOutputStackingOrder=prtOutputStackingOrder, prtOutput=prtOutput, prtInterpreterLangFamily=prtInterpreterLangFamily, prtAlertCriticalEvents=prtAlertCriticalEvents, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtAlertGroup=prtAlertGroup, prtInputCurrentLevel=prtInputCurrentLevel, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, printerV1Alert=printerV1Alert, PrtChannelStateTC=PrtChannelStateTC, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInputMaxCapacity=prtInputMaxCapacity, prtAlertTrapGroup=prtAlertTrapGroup, printerV2Alert=printerV2Alert, prtCoverEntry=prtCoverEntry, prtAlertCode=prtAlertCode, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtCoverIndex=prtCoverIndex, PresentOnOff=PresentOnOff, prtInputMediaType=prtInputMediaType, prtConsoleLights=prtConsoleLights, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtLocalizationTable=prtLocalizationTable, prtMediaPathStatus=prtMediaPathStatus, prtAlertTime=prtAlertTime, prtInputSerialNumber=prtInputSerialNumber, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMediaPathGroup=prtMediaPathGroup, prtConsoleColor=prtConsoleColor, prtMarkerLifeCount=prtMarkerLifeCount, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerColorantTable=prtMarkerColorantTable, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathIndex=prtMediaPathIndex, prtMarker=prtMarker, prtInterpreterVersion=prtInterpreterVersion, prtMediaPath=prtMediaPath, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtLocalizationCountry=prtLocalizationCountry, prtOutputBursting=prtOutputBursting, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInputVendorName=prtInputVendorName, prtMIBGroups=prtMIBGroups, prtChannelStatus=prtChannelStatus, prtConsoleDescription=prtConsoleDescription, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMediaPathEntry=prtMediaPathEntry, prtOutputDescription=prtOutputDescription, prtChannelState=prtChannelState, prtOutputVersion=prtOutputVersion, prtMarkerMarkTech=prtMarkerMarkTech, prtChannel=prtChannel, prtCover=prtCover, prtMediaPathType=prtMediaPathType, prtMarkerWestMargin=prtMarkerWestMargin, prtOutputDimUnit=prtOutputDimUnit, prtMarkerIndex=prtMarkerIndex, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputTable=prtOutputTable, prtConsoleLightTable=prtConsoleLightTable, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerSouthMargin=prtMarkerSouthMargin, prtChannelIndex=prtChannelIndex, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtInputNextIndex=prtInputNextIndex, prtCoverTable=prtCoverTable, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerSupplies=prtMarkerSupplies, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputGroup=prtOutputGroup, PrtCapacityUnitTC=PrtCapacityUnitTC, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMIBCompliance=prtMIBCompliance, prtGeneralConfigChanges=prtGeneralConfigChanges, prtGeneralTable=prtGeneralTable, prtLocalizationIndex=prtLocalizationIndex, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtGeneralEntry=prtGeneralEntry, prtChannelInformation=prtChannelInformation, prtMarkerColorantValue=prtMarkerColorantValue, prtCoverStatus=prtCoverStatus, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtConsoleLightEntry=prtConsoleLightEntry, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMarkerColorantTonality=prtMarkerColorantTonality, prtConsoleGroup=prtConsoleGroup, prtAlertEntry=prtAlertEntry, prtInterpreterDescription=prtInterpreterDescription, prtMIB2Compliance=prtMIB2Compliance, prtInputTable=prtInputTable)
mibBuilder.exportSymbols("Printer-MIB", prtInputDescription=prtInputDescription, prtMediaPathTable=prtMediaPathTable, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerColorantRole=prtMarkerColorantRole)
