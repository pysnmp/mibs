...
PrtChannelTypeTC, PrtGeneralResetTC, PrtAlertCodeTC, PrtAlertGroupTC, PrtCoverStatusTC, PrtConsoleDisableTC, PrtMarkerSuppliesTypeTC, PrtAlertTrainingLevelTC, PrtInputTypeTC, PrtConsoleColorTC, PrtMarkerMarkTechTC, PrtOutputTypeTC, PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtChannelTypeTC", "PrtGeneralResetTC", "PrtAlertCodeTC", "PrtAlertGroupTC", "PrtCoverStatusTC", "PrtConsoleDisableTC", "PrtMarkerSuppliesTypeTC", "PrtAlertTrainingLevelTC", "PrtInputTypeTC", "PrtConsoleColorTC", "PrtMarkerMarkTechTC", "PrtOutputTypeTC", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtAlertTrainingLevel=prtAlertTrainingLevel, prtMediaPathType=prtMediaPathType, prtOutputEntry=prtOutputEntry, prtOutputMaxCapacity=prtOutputMaxCapacity, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputPageCollated=prtOutputPageCollated, prtGeneralTable=prtGeneralTable, prtLocalizationTable=prtLocalizationTable, prtInputMediaWeight=prtInputMediaWeight, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerProcessColorants=prtMarkerProcessColorants, prtGeneralGroup=prtGeneralGroup, prtMIB2Groups=prtMIB2Groups, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputBursting=prtOutputBursting, prtGeneralConfigChanges=prtGeneralConfigChanges, prtInputDefaultIndex=prtInputDefaultIndex, prtConsoleDisable=prtConsoleDisable, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtCoverTable=prtCoverTable, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtStorageRefEntry=prtStorageRefEntry, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtAlertIndex=prtAlertIndex, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInputName=prtInputName, prtOutputVendorName=prtOutputVendorName, prtChannelIndex=prtChannelIndex, prtChannelTable=prtChannelTable, prtInterpreterGroup=prtInterpreterGroup, prtMarkerSuppliesType=prtMarkerSuppliesType, PrtCapacityUnitTC=PrtCapacityUnitTC, prtConsoleOnTime=prtConsoleOnTime, prtOutputDimUnit=prtOutputDimUnit, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtLocalization=prtLocalization, prtGeneralPrinterName=prtGeneralPrinterName, prtOutputName=prtOutputName, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtAlertCode=prtAlertCode, prtOutputStatus=prtOutputStatus, prtMarkerEntry=prtMarkerEntry, printerV1Alert=printerV1Alert, prtOutputTable=prtOutputTable, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMIBConformance=prtMIBConformance, prtChannelType=prtChannelType, prtGeneral=prtGeneral, prtMarkerIndex=prtMarkerIndex, printerV2AlertPrefix=printerV2AlertPrefix, prtGeneralSerialNumber=prtGeneralSerialNumber, prtConsoleGroup=prtConsoleGroup, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtLocalizationCountry=prtLocalizationCountry, prtInputCapacityUnit=prtInputCapacityUnit, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerColorantGroup=prtMarkerColorantGroup, prtAlertEntry=prtAlertEntry, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtConsoleDescription=prtConsoleDescription, prtAlertSeverityLevel=prtAlertSeverityLevel, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtStorageRefTable=prtStorageRefTable, prtOutputGroup=prtOutputGroup, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtConsoleLightTable=prtConsoleLightTable, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMarkerColorantTable=prtMarkerColorantTable, prtInputSecurity=prtInputSecurity, prtInputNextIndex=prtInputNextIndex, prtMarkerColorantValue=prtMarkerColorantValue, prtMediaPath=prtMediaPath, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtOutput=prtOutput, prtMediaPathDescription=prtMediaPathDescription, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerStatus=prtMarkerStatus, MediaUnit=MediaUnit, prtGeneralServicePerson=prtGeneralServicePerson, prtDeviceRefTable=prtDeviceRefTable, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtGeneralEntry=prtGeneralEntry, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMIBGroups=prtMIBGroups, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerCounterUnit=prtMarkerCounterUnit, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtAlertTime=prtAlertTime, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtAlertTableV2Group=prtAlertTableV2Group, prtStorageRefIndex=prtStorageRefIndex, prtCover=prtCover, prtInputTable=prtInputTable, prtChannelEntry=prtChannelEntry, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInputGroup=prtInputGroup, prtInputMediaName=prtInputMediaName, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtDeviceRefIndex=prtDeviceRefIndex, prtGeneralReset=prtGeneralReset, prtMarkerGroup=prtMarkerGroup, prtMarkerColorantRole=prtMarkerColorantRole, prtInterpreterEntry=prtInterpreterEntry, prtExtendedOutputGroup=prtExtendedOutputGroup, PresentOnOff=PresentOnOff, prtInputMaxCapacity=prtInputMaxCapacity, prtInputSerialNumber=prtInputSerialNumber, prtInputDescription=prtInputDescription, prtMediaPathTable=prtMediaPathTable, prtAlertTable=prtAlertTable, prtMarkerSupplies=prtMarkerSupplies, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtOutputCapacityUnit=prtOutputCapacityUnit, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInputType=prtInputType, prtAlertAllEvents=prtAlertAllEvents, prtAlert=prtAlert, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerEastMargin=prtMarkerEastMargin, prtAlertGroupIndex=prtAlertGroupIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtConsoleLocalization=prtConsoleLocalization, printmib=printmib, prtInterpreterTwoWay=prtInterpreterTwoWay, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInputModel=prtInputModel, prtInterpreter=prtInterpreter, prtInputMediaColor=prtInputMediaColor, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInterpreterIndex=prtInterpreterIndex, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtAlertTrapGroup=prtAlertTrapGroup, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputEntry=prtInputEntry, prtGeneralV2Group=prtGeneralV2Group, prtChannelState=prtChannelState, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtMediaPathIndex=prtMediaPathIndex, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtOutputVersion=prtOutputVersion, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInterpreterTable=prtInterpreterTable, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMarkerColorant=prtMarkerColorant, prtInputDimUnit=prtInputDimUnit, prtMarkerWestMargin=prtMarkerWestMargin, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtConsoleColor=prtConsoleColor, prtMarker=prtMarker, prtOutputDecollating=prtOutputDecollating, prtInputMediaType=prtInputMediaType, prtConsoleLights=prtConsoleLights, prtCoverIndex=prtCoverIndex, prtConsoleOffTime=prtConsoleOffTime, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerTable=prtMarkerTable, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelInformation=prtChannelInformation, prtChannelIfIndex=prtChannelIfIndex, prtCoverEntry=prtCoverEntry, prtCoverDescription=prtCoverDescription, PrtMediaUnitTC=PrtMediaUnitTC, prtDeviceRefEntry=prtDeviceRefEntry, prtMediaPathEntry=prtMediaPathEntry, prtConsoleLightIndex=prtConsoleLightIndex, prtLocalizationLanguage=prtLocalizationLanguage, CodedCharSet=CodedCharSet, printerV2Alert=printerV2Alert, prtInputVersion=prtInputVersion, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtChannelStatus=prtChannelStatus, prtInputVendorName=prtInputVendorName, prtMIB2Compliance=prtMIB2Compliance, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, CapacityUnit=CapacityUnit, prtChannel=prtChannel, prtExtendedInputGroup=prtExtendedInputGroup, prtLocalizationEntry=prtLocalizationEntry, prtInputMediaGroup=prtInputMediaGroup, prtOutputType=prtOutputType, prtChannelGroup=prtChannelGroup, prtOutputSerialNumber=prtOutputSerialNumber, prtLocalizationIndex=prtLocalizationIndex, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMediaPathStatus=prtMediaPathStatus, prtAlertGroup=prtAlertGroup, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputStatus=prtInputStatus, PrtChannelStateTC=PrtChannelStateTC, SubUnitStatus=SubUnitStatus, prtMediaPathGroup=prtMediaPathGroup, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMIBCompliance=prtMIBCompliance, prtInput=prtInput, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputSecurity=prtOutputSecurity, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMarkerSouthMargin=prtMarkerSouthMargin, prtAlertDescription=prtAlertDescription, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInterpreterLangVersion=prtInterpreterLangVersion, prtAlertTimeGroup=prtAlertTimeGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, prtOutputIndex=prtOutputIndex, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInterpreterVersion=prtInterpreterVersion, prtInterpreterDescription=prtInterpreterDescription, prtAlertLocation=prtAlertLocation, prtInputMediaFormParts=prtInputMediaFormParts, prtChannelV2Group=prtChannelV2Group, prtOutputModel=prtOutputModel, prtOutputDescription=prtOutputDescription, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtAlertTableGroup=prtAlertTableGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines)
mibBuilder.exportSymbols("Printer-MIB", prtInputIndex=prtInputIndex, prtConsoleLightEntry=prtConsoleLightEntry, prtCoverStatus=prtCoverStatus, PYSNMP_MODULE_ID=printmib)
