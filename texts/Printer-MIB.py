...
PrtChannelTypeTC, PrtInterpreterLangFamilyTC, PrtConsoleDisableTC, PrtCoverStatusTC, PrtGeneralResetTC, PrtInputTypeTC, PrtMediaPathTypeTC, PrtAlertTrainingLevelTC, PrtOutputTypeTC, PrtMarkerSuppliesTypeTC, PrtMarkerMarkTechTC, PrtAlertCodeTC, PrtAlertGroupTC, PrtConsoleColorTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtChannelTypeTC", "PrtInterpreterLangFamilyTC", "PrtConsoleDisableTC", "PrtCoverStatusTC", "PrtGeneralResetTC", "PrtInputTypeTC", "PrtMediaPathTypeTC", "PrtAlertTrainingLevelTC", "PrtOutputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtMarkerMarkTechTC", "PrtAlertCodeTC", "PrtAlertGroupTC", "PrtConsoleColorTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputGroup=prtOutputGroup, PrtMediaUnitTC=PrtMediaUnitTC, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtAlertLocation=prtAlertLocation, prtExtendedOutputGroup=prtExtendedOutputGroup, PresentOnOff=PresentOnOff, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMarkerEastMargin=prtMarkerEastMargin, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtChannelGroup=prtChannelGroup, prtGeneralReset=prtGeneralReset, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerSupplies=prtMarkerSupplies, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, printerV1Alert=printerV1Alert, prtChannelEntry=prtChannelEntry, prtInputMediaWeight=prtInputMediaWeight, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMediaPathDescription=prtMediaPathDescription, prtGeneralServicePerson=prtGeneralServicePerson, prtOutputBursting=prtOutputBursting, prtOutputPageCollated=prtOutputPageCollated, prtCoverIndex=prtCoverIndex, prtOutputDefaultIndex=prtOutputDefaultIndex, prtLocalizationTable=prtLocalizationTable, prtInputVendorName=prtInputVendorName, prtChannelStatus=prtChannelStatus, prtInterpreterIndex=prtInterpreterIndex, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerGroup=prtMarkerGroup, prtExtendedInputGroup=prtExtendedInputGroup, prtInputType=prtInputType, prtConsoleLightIndex=prtConsoleLightIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtConsoleLights=prtConsoleLights, prtInputGroup=prtInputGroup, prtOutputStackingOrder=prtOutputStackingOrder, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerSuppliesTable=prtMarkerSuppliesTable, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInput=prtInput, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtOutputDecollating=prtOutputDecollating, prtConsoleLightTable=prtConsoleLightTable, prtAlertEntry=prtAlertEntry, prtGeneralPrinterName=prtGeneralPrinterName, prtDeviceRefTable=prtDeviceRefTable, prtAlertTimeGroup=prtAlertTimeGroup, prtAlertGroupIndex=prtAlertGroupIndex, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerCounterUnit=prtMarkerCounterUnit, prtMarkerLifeCount=prtMarkerLifeCount, prtOutputOffsetStacking=prtOutputOffsetStacking, prtCoverDescription=prtCoverDescription, prtOutputName=prtOutputName, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMIB2Groups=prtMIB2Groups, prtGeneralV2Group=prtGeneralV2Group, prtConsoleOnTime=prtConsoleOnTime, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtLocalization=prtLocalization, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerWestMargin=prtMarkerWestMargin, printerV2AlertPrefix=printerV2AlertPrefix, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputMaxCapacity=prtOutputMaxCapacity, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerEntry=prtMarkerEntry, prtInputMediaType=prtInputMediaType, prtMarker=prtMarker, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtInputMediaGroup=prtInputMediaGroup, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtCover=prtCover, prtInputDescription=prtInputDescription, prtOutputIndex=prtOutputIndex, prtOutputVersion=prtOutputVersion, prtInputCapacityUnit=prtInputCapacityUnit, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputDimUnit=prtOutputDimUnit, prtStorageRefIndex=prtStorageRefIndex, prtMediaPath=prtMediaPath, prtGeneralGroup=prtGeneralGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInputTable=prtInputTable, prtLocalizationCountry=prtLocalizationCountry, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtChannel=prtChannel, prtOutputVendorName=prtOutputVendorName, prtInputVersion=prtInputVersion, prtMarkerColorantValue=prtMarkerColorantValue, prtInterpreterGroup=prtInterpreterGroup, prtDeviceRefIndex=prtDeviceRefIndex, prtMIBGroups=prtMIBGroups, prtOutputModel=prtOutputModel, prtInterpreterDescription=prtInterpreterDescription, prtOutputSerialNumber=prtOutputSerialNumber, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInputMediaName=prtInputMediaName, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtChannelTable=prtChannelTable, prtMediaPathTable=prtMediaPathTable, prtChannelState=prtChannelState, prtGeneralTable=prtGeneralTable, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtAlertCriticalEvents=prtAlertCriticalEvents, PrtCapacityUnitTC=PrtCapacityUnitTC, prtChannelIndex=prtChannelIndex, prtAlertIndex=prtAlertIndex, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInputSerialNumber=prtInputSerialNumber, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtLocalizationEntry=prtLocalizationEntry, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtAlertTableV2Group=prtAlertTableV2Group, prtInputDimUnit=prtInputDimUnit, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerColorantRole=prtMarkerColorantRole, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtOutputEntry=prtOutputEntry, prtMIBConformance=prtMIBConformance, prtInterpreterEntry=prtInterpreterEntry, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtAlertAllEvents=prtAlertAllEvents, prtGeneralEntry=prtGeneralEntry, prtStorageRefTable=prtStorageRefTable, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMarkerSouthMargin=prtMarkerSouthMargin, prtGeneralSerialNumber=prtGeneralSerialNumber, prtLocalizationIndex=prtLocalizationIndex, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInterpreterTable=prtInterpreterTable, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputStatus=prtOutputStatus, prtAlertTable=prtAlertTable, prtInputName=prtInputName, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtConsoleLightEntry=prtConsoleLightEntry, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, MediaUnit=MediaUnit, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputModel=prtInputModel, prtChannelV2Group=prtChannelV2Group, SubUnitStatus=SubUnitStatus, prtAlertTime=prtAlertTime, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMediaPathEntry=prtMediaPathEntry, prtInterpreterLangFamily=prtInterpreterLangFamily, printerV2Alert=printerV2Alert, prtMediaPathGroup=prtMediaPathGroup, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtAlertTableGroup=prtAlertTableGroup, printmib=printmib, prtOutputDescription=prtOutputDescription, prtMarkerIndex=prtMarkerIndex, prtChannelType=prtChannelType, PrtSubUnitStatusTC=PrtSubUnitStatusTC, PrtPrintOrientationTC=PrtPrintOrientationTC, prtCoverTable=prtCoverTable, prtMarkerColorantTonality=prtMarkerColorantTonality, prtAlertCode=prtAlertCode, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtConsoleColor=prtConsoleColor, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtAlert=prtAlert, prtAlertGroup=prtAlertGroup, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerColorantTable=prtMarkerColorantTable, PYSNMP_MODULE_ID=printmib, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInputMediaColor=prtInputMediaColor, prtCoverEntry=prtCoverEntry, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtConsoleDisable=prtConsoleDisable, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInterpreter=prtInterpreter, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtGeneralConfigChanges=prtGeneralConfigChanges, prtOutput=prtOutput, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMarkerColorantGroup=prtMarkerColorantGroup, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerStatus=prtMarkerStatus, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMarkerSuppliesType=prtMarkerSuppliesType, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtAlertTrapGroup=prtAlertTrapGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInputMaxCapacity=prtInputMaxCapacity, prtInputIndex=prtInputIndex, prtStorageRefEntry=prtStorageRefEntry, CapacityUnit=CapacityUnit, prtOutputTable=prtOutputTable, prtConsoleLocalization=prtConsoleLocalization, prtInputSecurity=prtInputSecurity, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputEntry=prtInputEntry, prtAlertTrainingLevel=prtAlertTrainingLevel, CodedCharSet=CodedCharSet, prtCoverStatus=prtCoverStatus, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleDescription=prtConsoleDescription, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtOutputSecurity=prtOutputSecurity, prtOutputType=prtOutputType, prtMediaPathStatus=prtMediaPathStatus, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtInputStatus=prtInputStatus, prtDeviceRefEntry=prtDeviceRefEntry, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtConsoleOffTime=prtConsoleOffTime, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMarkerTable=prtMarkerTable, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMediaPathType=prtMediaPathType, prtInterpreterVersion=prtInterpreterVersion, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtGeneral=prtGeneral, prtInputNextIndex=prtInputNextIndex, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerColorant=prtMarkerColorant, prtChannelIfIndex=prtChannelIfIndex, prtChannelInformation=prtChannelInformation, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, PrtChannelStateTC=PrtChannelStateTC, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtAlertDescription=prtAlertDescription, prtMIB2Compliance=prtMIB2Compliance, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMIBCompliance=prtMIBCompliance, prtMediaPathIndex=prtMediaPathIndex)
mibBuilder.exportSymbols("Printer-MIB", prtConsoleGroup=prtConsoleGroup, prtMarkerMarkTech=prtMarkerMarkTech, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen)
