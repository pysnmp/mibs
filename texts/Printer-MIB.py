...
PrtChannelTypeTC, PrtAlertTrainingLevelTC, PrtInputTypeTC, PrtMarkerMarkTechTC, PrtMediaPathTypeTC, PrtMarkerSuppliesTypeTC, PrtConsoleDisableTC, PrtAlertCodeTC, PrtConsoleColorTC, PrtAlertGroupTC, PrtGeneralResetTC, PrtOutputTypeTC, PrtInterpreterLangFamilyTC, PrtCoverStatusTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtChannelTypeTC", "PrtAlertTrainingLevelTC", "PrtInputTypeTC", "PrtMarkerMarkTechTC", "PrtMediaPathTypeTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleDisableTC", "PrtAlertCodeTC", "PrtConsoleColorTC", "PrtAlertGroupTC", "PrtGeneralResetTC", "PrtOutputTypeTC", "PrtInterpreterLangFamilyTC", "PrtCoverStatusTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtLocalizationEntry=prtLocalizationEntry, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtCoverIndex=prtCoverIndex, prtOutputMaxCapacity=prtOutputMaxCapacity, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtAlertDescription=prtAlertDescription, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtConsoleLightIndex=prtConsoleLightIndex, prtInterpreterGroup=prtInterpreterGroup, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtOutputDecollating=prtOutputDecollating, prtChannelIndex=prtChannelIndex, prtAlertTableV2Group=prtAlertTableV2Group, prtInputSerialNumber=prtInputSerialNumber, prtOutputVendorName=prtOutputVendorName, prtMarkerSpotColorants=prtMarkerSpotColorants, prtOutputGroup=prtOutputGroup, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterLangVersion=prtInterpreterLangVersion, prtCoverTable=prtCoverTable, prtStorageRefEntry=prtStorageRefEntry, prtInput=prtInput, prtOutputEntry=prtOutputEntry, prtMarkerIndex=prtMarkerIndex, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerWestMargin=prtMarkerWestMargin, prtGeneralEntry=prtGeneralEntry, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerMarkTech=prtMarkerMarkTech, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtAlertGroup=prtAlertGroup, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtAlertTable=prtAlertTable, prtAlertTableGroup=prtAlertTableGroup, prtChannelEntry=prtChannelEntry, prtGeneralReset=prtGeneralReset, prtAlertIndex=prtAlertIndex, SubUnitStatus=SubUnitStatus, prtConsoleDisable=prtConsoleDisable, prtOutputCapacityUnit=prtOutputCapacityUnit, prtExtendedInputGroup=prtExtendedInputGroup, printerV2AlertPrefix=printerV2AlertPrefix, PrtPrintOrientationTC=PrtPrintOrientationTC, printerV1Alert=printerV1Alert, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMarkerProcessColorants=prtMarkerProcessColorants, prtInputNextIndex=prtInputNextIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, CapacityUnit=CapacityUnit, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, MediaUnit=MediaUnit, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputEntry=prtInputEntry, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtLocalizationLanguage=prtLocalizationLanguage, prtMIB2Compliance=prtMIB2Compliance, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerGroup=prtMarkerGroup, prtMediaPathEntry=prtMediaPathEntry, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInputMediaWeight=prtInputMediaWeight, prtAlert=prtAlert, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtStorageRefTable=prtStorageRefTable, PrtMediaUnitTC=PrtMediaUnitTC, prtGeneralPrinterName=prtGeneralPrinterName, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInterpreterLangLevel=prtInterpreterLangLevel, prtConsoleDescription=prtConsoleDescription, prtChannelV2Group=prtChannelV2Group, prtStorageRefIndex=prtStorageRefIndex, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtChannelInformation=prtChannelInformation, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtConsoleOffTime=prtConsoleOffTime, prtMIB2Groups=prtMIB2Groups, prtInterpreterIndex=prtInterpreterIndex, prtMediaPathDescription=prtMediaPathDescription, prtLocalizationIndex=prtLocalizationIndex, prtMarkerColorant=prtMarkerColorant, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtConsoleOnTime=prtConsoleOnTime, printerV2Alert=printerV2Alert, prtInputDescription=prtInputDescription, prtCoverDescription=prtCoverDescription, prtInputMediaName=prtInputMediaName, prtOutputTable=prtOutputTable, prtInputSecurity=prtInputSecurity, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInterpreterTable=prtInterpreterTable, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInputGroup=prtInputGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtOutputSerialNumber=prtOutputSerialNumber, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputIndex=prtOutputIndex, prtOutputBursting=prtOutputBursting, prtAlertTimeGroup=prtAlertTimeGroup, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInterpreterLangFamily=prtInterpreterLangFamily, prtOutputDimUnit=prtOutputDimUnit, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerColorantRole=prtMarkerColorantRole, prtAlertCode=prtAlertCode, prtMarkerColorantGroup=prtMarkerColorantGroup, prtAlertTrapGroup=prtAlertTrapGroup, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMediaPathIndex=prtMediaPathIndex, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAlertTrainingLevel=prtAlertTrainingLevel, prtCover=prtCover, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerColorantTable=prtMarkerColorantTable, prtInterpreter=prtInterpreter, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtChannelGroup=prtChannelGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerLifeCount=prtMarkerLifeCount, prtLocalizationTable=prtLocalizationTable, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtGeneralGroup=prtGeneralGroup, prtInputCapacityUnit=prtInputCapacityUnit, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputVersion=prtOutputVersion, prtInputIndex=prtInputIndex, prtLocalizationCountry=prtLocalizationCountry, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMarkerColorantValue=prtMarkerColorantValue, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtGeneralV2Group=prtGeneralV2Group, prtInputMediaColor=prtInputMediaColor, prtChannelStatus=prtChannelStatus, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtCoverStatus=prtCoverStatus, prtLocalization=prtLocalization, prtChannelType=prtChannelType, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtConsoleLightTable=prtConsoleLightTable, prtConsoleColor=prtConsoleColor, prtExtendedOutputGroup=prtExtendedOutputGroup, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputMediaType=prtInputMediaType, prtDeviceRefTable=prtDeviceRefTable, prtGeneralSerialNumber=prtGeneralSerialNumber, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutputStatus=prtOutputStatus, prtInputName=prtInputName, prtInterpreterEntry=prtInterpreterEntry, prtMIBConformance=prtMIBConformance, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMediaPath=prtMediaPath, prtInputSwitchingGroup=prtInputSwitchingGroup, PYSNMP_MODULE_ID=printmib, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInputVersion=prtInputVersion, prtAlertLocation=prtAlertLocation, prtConsoleLights=prtConsoleLights, prtGeneral=prtGeneral, prtConsoleLocalization=prtConsoleLocalization, prtMediaPathStatus=prtMediaPathStatus, prtMarker=prtMarker, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInputVendorName=prtInputVendorName, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerSouthMargin=prtMarkerSouthMargin, prtChannelIfIndex=prtChannelIfIndex, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputName=prtOutputName, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlertTime=prtAlertTime, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMIBCompliance=prtMIBCompliance, prtInputType=prtInputType, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PresentOnOff=PresentOnOff, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, CodedCharSet=CodedCharSet, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMediaPathGroup=prtMediaPathGroup, prtCoverEntry=prtCoverEntry, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtDeviceRefIndex=prtDeviceRefIndex, prtInputStatus=prtInputStatus, prtInputModel=prtInputModel, prtOutput=prtOutput, prtOutputDescription=prtOutputDescription, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerEastMargin=prtMarkerEastMargin, prtMediaPathTable=prtMediaPathTable, prtChannelProtocolVersion=prtChannelProtocolVersion, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInputMediaFormParts=prtInputMediaFormParts, prtGeneralTable=prtGeneralTable, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInterpreterDescription=prtInterpreterDescription, prtChannelTable=prtChannelTable, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerTable=prtMarkerTable, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtAlertSeverityLevel=prtAlertSeverityLevel, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputPageCollated=prtOutputPageCollated, printmib=printmib, prtMediaPathType=prtMediaPathType, prtAlertEntry=prtAlertEntry, prtMIBGroups=prtMIBGroups, prtChannelState=prtChannelState, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtChannel=prtChannel, prtGeneralServicePerson=prtGeneralServicePerson, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtAlertAllEvents=prtAlertAllEvents, prtOutputSecurity=prtOutputSecurity, prtInterpreterVersion=prtInterpreterVersion, prtGeneralConfigChanges=prtGeneralConfigChanges, PrtChannelStateTC=PrtChannelStateTC, prtMarkerStatus=prtMarkerStatus, prtInputMediaGroup=prtInputMediaGroup, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMarkerColorantIndex=prtMarkerColorantIndex, prtOutputType=prtOutputType, prtOutputModel=prtOutputModel, prtInputDefaultIndex=prtInputDefaultIndex, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerEntry=prtMarkerEntry, prtMarkerColorantTonality=prtMarkerColorantTonality, prtConsoleGroup=prtConsoleGroup)
mibBuilder.exportSymbols("Printer-MIB", PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInputDimUnit=prtInputDimUnit, prtMarkerSupplies=prtMarkerSupplies, prtInputTable=prtInputTable)
