...
PrtMarkerMarkTechTC, PrtOutputTypeTC, PrtCoverStatusTC, PrtMediaPathTypeTC, PrtChannelTypeTC, PrtGeneralResetTC, PrtInputTypeTC, PrtConsoleColorTC, PrtConsoleDisableTC, PrtAlertTrainingLevelTC, PrtAlertGroupTC, PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtMarkerSuppliesTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerMarkTechTC", "PrtOutputTypeTC", "PrtCoverStatusTC", "PrtMediaPathTypeTC", "PrtChannelTypeTC", "PrtGeneralResetTC", "PrtInputTypeTC", "PrtConsoleColorTC", "PrtConsoleDisableTC", "PrtAlertTrainingLevelTC", "PrtAlertGroupTC", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtMarkerSuppliesTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputOffsetStacking=prtOutputOffsetStacking, prtAlertTableV2Group=prtAlertTableV2Group, prtConsoleDisable=prtConsoleDisable, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtConsoleLightIndex=prtConsoleLightIndex, prtInputMediaWeight=prtInputMediaWeight, prtMarkerSouthMargin=prtMarkerSouthMargin, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputVendorName=prtInputVendorName, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtMIBCompliance=prtMIBCompliance, prtOutputIndex=prtOutputIndex, prtInputMaxCapacity=prtInputMaxCapacity, prtGeneralV2Group=prtGeneralV2Group, prtMediaPathGroup=prtMediaPathGroup, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMediaPathIndex=prtMediaPathIndex, prtGeneralEntry=prtGeneralEntry, prtGeneralPrinterName=prtGeneralPrinterName, prtInputCapacityUnit=prtInputCapacityUnit, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtStorageRefIndex=prtStorageRefIndex, prtMediaPathTable=prtMediaPathTable, CapacityUnit=CapacityUnit, prtChannelType=prtChannelType, prtInputCurrentLevel=prtInputCurrentLevel, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputSecurity=prtOutputSecurity, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtAlertEntry=prtAlertEntry, prtCover=prtCover, prtAlert=prtAlert, printerV1Alert=printerV1Alert, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtOutputGroup=prtOutputGroup, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutputDimUnit=prtOutputDimUnit, prtChannelIndex=prtChannelIndex, prtChannelEntry=prtChannelEntry, prtAlertLocation=prtAlertLocation, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtAlertGroup=prtAlertGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtAlertSeverityLevel=prtAlertSeverityLevel, prtGeneralSerialNumber=prtGeneralSerialNumber, prtOutputRemainingCapacity=prtOutputRemainingCapacity, SubUnitStatus=SubUnitStatus, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInputIndex=prtInputIndex, prtMediaPathType=prtMediaPathType, prtInputMediaFormParts=prtInputMediaFormParts, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerLifeCount=prtMarkerLifeCount, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInputMediaType=prtInputMediaType, prtAlertGroupIndex=prtAlertGroupIndex, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, printerV2AlertPrefix=printerV2AlertPrefix, prtInterpreterVersion=prtInterpreterVersion, prtChannelInformation=prtChannelInformation, prtAlertDescription=prtAlertDescription, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtConsoleColor=prtConsoleColor, prtAlertIndex=prtAlertIndex, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMediaPathStatus=prtMediaPathStatus, prtMarkerIndex=prtMarkerIndex, prtCoverTable=prtCoverTable, prtMarkerGroup=prtMarkerGroup, prtInterpreterTable=prtInterpreterTable, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMarkerEastMargin=prtMarkerEastMargin, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, printerV2Alert=printerV2Alert, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMIBGroups=prtMIBGroups, prtAlertTrapGroup=prtAlertTrapGroup, prtCoverEntry=prtCoverEntry, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtDeviceRefEntry=prtDeviceRefEntry, prtInputTable=prtInputTable, prtChannel=prtChannel, prtCoverIndex=prtCoverIndex, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, MediaUnit=MediaUnit, prtMIB2Compliance=prtMIB2Compliance, prtOutputTable=prtOutputTable, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutputCapacityUnit=prtOutputCapacityUnit, prtStorageRefEntry=prtStorageRefEntry, prtGeneralServicePerson=prtGeneralServicePerson, prtInputMediaGroup=prtInputMediaGroup, prtConsoleDescription=prtConsoleDescription, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerWestMargin=prtMarkerWestMargin, prtChannelStatus=prtChannelStatus, prtChannelIfIndex=prtChannelIfIndex, prtInterpreterDescription=prtInterpreterDescription, PYSNMP_MODULE_ID=printmib, prtOutputModel=prtOutputModel, prtLocalizationLanguage=prtLocalizationLanguage, prtGeneralGroup=prtGeneralGroup, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputVendorName=prtOutputVendorName, prtOutputBursting=prtOutputBursting, prtGeneral=prtGeneral, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputEntry=prtOutputEntry, PrtChannelStateTC=PrtChannelStateTC, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputStatus=prtOutputStatus, prtMIBConformance=prtMIBConformance, prtAlertTableGroup=prtAlertTableGroup, CodedCharSet=CodedCharSet, prtMarkerSuppliesType=prtMarkerSuppliesType, prtOutputSerialNumber=prtOutputSerialNumber, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerTable=prtMarkerTable, prtMediaPathDescription=prtMediaPathDescription, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputMediaName=prtInputMediaName, prtOutputVersion=prtOutputVersion, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMarkerColorantTable=prtMarkerColorantTable, prtOutputName=prtOutputName, prtOutputDefaultIndex=prtOutputDefaultIndex, PrtPrintOrientationTC=PrtPrintOrientationTC, prtCoverDescription=prtCoverDescription, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMIB2Groups=prtMIB2Groups, prtMarkerColorant=prtMarkerColorant, prtOutputDescription=prtOutputDescription, prtAlertTable=prtAlertTable, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtConsoleLocalization=prtConsoleLocalization, prtMarkerSpotColorants=prtMarkerSpotColorants, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtExtendedInputGroup=prtExtendedInputGroup, prtInputVersion=prtInputVersion, prtConsoleGroup=prtConsoleGroup, prtGeneralReset=prtGeneralReset, prtInputModel=prtInputModel, prtChannelTable=prtChannelTable, prtChannelState=prtChannelState, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtAlertTime=prtAlertTime, PresentOnOff=PresentOnOff, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInterpreterEntry=prtInterpreterEntry, prtGeneralTable=prtGeneralTable, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtChannelV2Group=prtChannelV2Group, prtDeviceRefIndex=prtDeviceRefIndex, prtInputEntry=prtInputEntry, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInterpreter=prtInterpreter, prtInputType=prtInputType, prtMarkerColorantValue=prtMarkerColorantValue, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInputNextIndex=prtInputNextIndex, prtInputMediaColor=prtInputMediaColor, prtInterpreterIndex=prtInterpreterIndex, prtStorageRefTable=prtStorageRefTable, prtInputName=prtInputName, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtLocalizationIndex=prtLocalizationIndex, prtMarkerEntry=prtMarkerEntry, prtAlertAllEvents=prtAlertAllEvents, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerSupplies=prtMarkerSupplies, prtConsoleLightEntry=prtConsoleLightEntry, prtInputSwitchingGroup=prtInputSwitchingGroup, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMarkerDefaultIndex=prtMarkerDefaultIndex, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtAlertTimeGroup=prtAlertTimeGroup, prtConsoleOffTime=prtConsoleOffTime, prtInputDefaultIndex=prtInputDefaultIndex, prtInputDimUnit=prtInputDimUnit, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInputDescription=prtInputDescription, prtLocalizationTable=prtLocalizationTable, prtMarkerColorantIndex=prtMarkerColorantIndex, prtOutputDecollating=prtOutputDecollating, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtGeneralConfigChanges=prtGeneralConfigChanges, prtConsoleOnTime=prtConsoleOnTime, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInput=prtInput, prtCoverStatus=prtCoverStatus, prtLocalization=prtLocalization, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerPowerOnCount=prtMarkerPowerOnCount, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInputGroup=prtInputGroup, prtAlertCode=prtAlertCode, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMediaPathEntry=prtMediaPathEntry, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtConsoleLights=prtConsoleLights, prtChannelGroup=prtChannelGroup, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInterpreterGroup=prtInterpreterGroup, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtLocalizationCountry=prtLocalizationCountry, prtInputStatus=prtInputStatus, prtMarkerProcessColorants=prtMarkerProcessColorants, prtLocalizationEntry=prtLocalizationEntry, prtMarkerStatus=prtMarkerStatus, PrtMediaUnitTC=PrtMediaUnitTC, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputSerialNumber=prtInputSerialNumber, prtOutputPageCollated=prtOutputPageCollated, printmib=printmib, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtMarker=prtMarker, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputType=prtOutputType, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInterpreterLangFamily=prtInterpreterLangFamily, prtConsoleLightTable=prtConsoleLightTable, prtInputSecurity=prtInputSecurity, prtMediaPath=prtMediaPath, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerColorantEntry=prtMarkerColorantEntry, prtDeviceRefTable=prtDeviceRefTable)
mibBuilder.exportSymbols("Printer-MIB", PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtOutput=prtOutput, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir)
