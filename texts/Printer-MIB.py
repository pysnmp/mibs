...
PrtAlertTrainingLevelTC, PrtAlertCodeTC, PrtGeneralResetTC, PrtOutputTypeTC, PrtChannelTypeTC, PrtConsoleDisableTC, PrtConsoleColorTC, PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC, PrtInputTypeTC, PrtMarkerMarkTechTC, PrtMarkerSuppliesTypeTC, PrtCoverStatusTC, PrtAlertGroupTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertTrainingLevelTC", "PrtAlertCodeTC", "PrtGeneralResetTC", "PrtOutputTypeTC", "PrtChannelTypeTC", "PrtConsoleDisableTC", "PrtConsoleColorTC", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC", "PrtInputTypeTC", "PrtMarkerMarkTechTC", "PrtMarkerSuppliesTypeTC", "PrtCoverStatusTC", "PrtAlertGroupTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarkerProcessColorants=prtMarkerProcessColorants, prtMIBGroups=prtMIBGroups, prtConsoleDescription=prtConsoleDescription, prtOutputMaxCapacity=prtOutputMaxCapacity, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerColorant=prtMarkerColorant, prtMediaPathTable=prtMediaPathTable, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtConsoleLights=prtConsoleLights, prtCoverStatus=prtCoverStatus, prtMarkerSupplies=prtMarkerSupplies, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtOutputStatus=prtOutputStatus, prtAlertSeverityLevel=prtAlertSeverityLevel, prtConsoleLightTable=prtConsoleLightTable, prtChannel=prtChannel, prtMarkerEntry=prtMarkerEntry, prtMIB2Compliance=prtMIB2Compliance, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputStatus=prtInputStatus, prtInputDimUnit=prtInputDimUnit, prtConsoleLightIndex=prtConsoleLightIndex, printerV2Alert=printerV2Alert, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtGeneralConfigChanges=prtGeneralConfigChanges, printmib=printmib, prtAlertTable=prtAlertTable, PrtMediaUnitTC=PrtMediaUnitTC, prtInputSerialNumber=prtInputSerialNumber, prtOutputModel=prtOutputModel, prtExtendedOutputGroup=prtExtendedOutputGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, prtChannelV2Group=prtChannelV2Group, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInterpreterVersion=prtInterpreterVersion, prtMarkerColorantValue=prtMarkerColorantValue, prtInputVendorName=prtInputVendorName, prtOutputDimUnit=prtOutputDimUnit, prtMarkerColorantEntry=prtMarkerColorantEntry, CodedCharSet=CodedCharSet, prtGeneralV2Group=prtGeneralV2Group, prtMarkerTable=prtMarkerTable, prtMarkerSuppliesTable=prtMarkerSuppliesTable, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtStorageRefTable=prtStorageRefTable, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputVersion=prtOutputVersion, prtInterpreterDescription=prtInterpreterDescription, prtGeneralServicePerson=prtGeneralServicePerson, prtConsoleLocalization=prtConsoleLocalization, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtConsoleOnTime=prtConsoleOnTime, prtCoverTable=prtCoverTable, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtChannelType=prtChannelType, prtInputTable=prtInputTable, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtLocalizationTable=prtLocalizationTable, prtDeviceRefTable=prtDeviceRefTable, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtAlertTableGroup=prtAlertTableGroup, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInputIndex=prtInputIndex, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputNextIndex=prtInputNextIndex, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarkerColorantGroup=prtMarkerColorantGroup, prtCoverDescription=prtCoverDescription, prtMarkerMarkTech=prtMarkerMarkTech, PresentOnOff=PresentOnOff, prtMarkerSuppliesType=prtMarkerSuppliesType, prtChannelStatus=prtChannelStatus, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutputTable=prtOutputTable, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtOutputDecollating=prtOutputDecollating, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtAlertGroupIndex=prtAlertGroupIndex, prtConsoleDisable=prtConsoleDisable, prtConsoleGroup=prtConsoleGroup, prtOutputVendorName=prtOutputVendorName, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, printerV2AlertPrefix=printerV2AlertPrefix, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtConsoleLightEntry=prtConsoleLightEntry, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMediaPathStatus=prtMediaPathStatus, prtOutputPageCollated=prtOutputPageCollated, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtGeneralTable=prtGeneralTable, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputMediaFormParts=prtInputMediaFormParts, prtChannelEntry=prtChannelEntry, prtLocalizationEntry=prtLocalizationEntry, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInputMediaWeight=prtInputMediaWeight, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInputType=prtInputType, prtAlertIndex=prtAlertIndex, prtAlertLocation=prtAlertLocation, prtInterpreterLangFamily=prtInterpreterLangFamily, prtAlert=prtAlert, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtInputCapacityUnit=prtInputCapacityUnit, prtMediaPathIndex=prtMediaPathIndex, CapacityUnit=CapacityUnit, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtStorageRefEntry=prtStorageRefEntry, prtOutputSecurity=prtOutputSecurity, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtExtendedInputGroup=prtExtendedInputGroup, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtCoverEntry=prtCoverEntry, prtInterpreterGroup=prtInterpreterGroup, prtChannelInformation=prtChannelInformation, prtCoverIndex=prtCoverIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtGeneral=prtGeneral, prtAlertEntry=prtAlertEntry, prtMarkerLifeCount=prtMarkerLifeCount, prtGeneralEntry=prtGeneralEntry, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerStatus=prtMarkerStatus, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtGeneralReset=prtGeneralReset, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, MediaUnit=MediaUnit, prtAlertDescription=prtAlertDescription, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMediaGroup=prtInputMediaGroup, prtInputSecurity=prtInputSecurity, prtInterpreterEntry=prtInterpreterEntry, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtOutput=prtOutput, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleOffTime=prtConsoleOffTime, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInputModel=prtInputModel, prtOutputGroup=prtOutputGroup, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtDeviceRefIndex=prtDeviceRefIndex, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInputDefaultIndex=prtInputDefaultIndex, prtMarkerGroup=prtMarkerGroup, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMediaPathEntry=prtMediaPathEntry, PrtChannelStateTC=PrtChannelStateTC, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputDescription=prtInputDescription, prtMarkerWestMargin=prtMarkerWestMargin, prtInputEntry=prtInputEntry, prtOutputEntry=prtOutputEntry, prtInterpreter=prtInterpreter, prtMediaPathGroup=prtMediaPathGroup, prtMarkerEastMargin=prtMarkerEastMargin, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtDeviceRefEntry=prtDeviceRefEntry, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtLocalizationCountry=prtLocalizationCountry, prtInput=prtInput, prtOutputDescription=prtOutputDescription, prtMarkerSuppliesClass=prtMarkerSuppliesClass, PrtCapacityUnitTC=PrtCapacityUnitTC, prtAlertAllEvents=prtAlertAllEvents, prtInputMediaColor=prtInputMediaColor, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInputName=prtInputName, prtLocalization=prtLocalization, prtMarkerCounterUnit=prtMarkerCounterUnit, prtLocalizationIndex=prtLocalizationIndex, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerColorantTable=prtMarkerColorantTable, prtMarker=prtMarker, prtMediaPathType=prtMediaPathType, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtConsoleColor=prtConsoleColor, prtMIBCompliance=prtMIBCompliance, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtOutputBursting=prtOutputBursting, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtAlertTime=prtAlertTime, prtGeneralGroup=prtGeneralGroup, prtGeneralPrinterName=prtGeneralPrinterName, prtInputMaxCapacity=prtInputMaxCapacity, prtCover=prtCover, PYSNMP_MODULE_ID=printmib, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtStorageRefIndex=prtStorageRefIndex, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtInputMediaName=prtInputMediaName, prtInputMediaType=prtInputMediaType, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtChannelTable=prtChannelTable, prtChannelState=prtChannelState, prtInterpreterTable=prtInterpreterTable, prtInterpreterIndex=prtInterpreterIndex, prtAlertGroup=prtAlertGroup, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMediaPath=prtMediaPath, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, PrtSubUnitStatusTC=PrtSubUnitStatusTC, printerV1Alert=printerV1Alert, prtChannelGroup=prtChannelGroup, prtChannelIfIndex=prtChannelIfIndex, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMIB2Groups=prtMIB2Groups, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInterpreterLangVersion=prtInterpreterLangVersion, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerNorthMargin=prtMarkerNorthMargin, prtAlertCriticalEvents=prtAlertCriticalEvents, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputName=prtOutputName, prtInputCurrentLevel=prtInputCurrentLevel, prtInputVersion=prtInputVersion, SubUnitStatus=SubUnitStatus, prtOutputType=prtOutputType, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMIBConformance=prtMIBConformance, prtMediaPathDescription=prtMediaPathDescription, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtAlertCode=prtAlertCode, prtChannelIndex=prtChannelIndex, prtMarkerIndex=prtMarkerIndex)
mibBuilder.exportSymbols("Printer-MIB", PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputSerialNumber=prtOutputSerialNumber, prtInputGroup=prtInputGroup, prtOutputIndex=prtOutputIndex)
