...
PrtMediaPathTypeTC, PrtConsoleDisableTC, PrtAlertTrainingLevelTC, PrtAlertCodeTC, PrtOutputTypeTC, PrtChannelTypeTC, PrtGeneralResetTC, PrtMarkerMarkTechTC, PrtCoverStatusTC, PrtInputTypeTC, PrtMarkerSuppliesTypeTC, PrtInterpreterLangFamilyTC, PrtAlertGroupTC, PrtConsoleColorTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMediaPathTypeTC", "PrtConsoleDisableTC", "PrtAlertTrainingLevelTC", "PrtAlertCodeTC", "PrtOutputTypeTC", "PrtChannelTypeTC", "PrtGeneralResetTC", "PrtMarkerMarkTechTC", "PrtCoverStatusTC", "PrtInputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtInterpreterLangFamilyTC", "PrtAlertGroupTC", "PrtConsoleColorTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtChannelType=prtChannelType, prtMarkerTable=prtMarkerTable, prtOutputOffsetStacking=prtOutputOffsetStacking, prtGeneralV2Group=prtGeneralV2Group, prtMarkerSupplies=prtMarkerSupplies, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtInputEntry=prtInputEntry, prtMarkerColorant=prtMarkerColorant, prtMarkerIndex=prtMarkerIndex, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtCover=prtCover, prtOutputVersion=prtOutputVersion, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInputTable=prtInputTable, PYSNMP_MODULE_ID=printmib, prtInputIndex=prtInputIndex, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtAlertSeverityLevel=prtAlertSeverityLevel, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInputStatus=prtInputStatus, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMIB2Groups=prtMIB2Groups, prtMarkerLifeCount=prtMarkerLifeCount, prtInputModel=prtInputModel, prtGeneralPrinterName=prtGeneralPrinterName, prtInputSecurity=prtInputSecurity, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInterpreterEntry=prtInterpreterEntry, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputEntry=prtOutputEntry, prtMediaPathEntry=prtMediaPathEntry, prtChannelInformation=prtChannelInformation, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtOutputSecurity=prtOutputSecurity, prtOutputGroup=prtOutputGroup, MediaUnit=MediaUnit, prtInterpreterLangFamily=prtInterpreterLangFamily, prtExtendedOutputGroup=prtExtendedOutputGroup, prtOutputBursting=prtOutputBursting, prtChannelState=prtChannelState, prtInputVersion=prtInputVersion, prtInputSerialNumber=prtInputSerialNumber, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputPageCollated=prtOutputPageCollated, prtInputDefaultIndex=prtInputDefaultIndex, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtOutputStackingOrder=prtOutputStackingOrder, prtOutputModel=prtOutputModel, prtChannelIfIndex=prtChannelIfIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtAlertCode=prtAlertCode, prtMarkerColorantRole=prtMarkerColorantRole, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMediaPathGroup=prtMediaPathGroup, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtCoverStatus=prtCoverStatus, prtGeneralSerialNumber=prtGeneralSerialNumber, prtCoverIndex=prtCoverIndex, prtChannelIndex=prtChannelIndex, prtStorageRefIndex=prtStorageRefIndex, prtChannelEntry=prtChannelEntry, prtInputMediaType=prtInputMediaType, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMarkerColorantIndex=prtMarkerColorantIndex, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtAlertLocation=prtAlertLocation, prtChannelGroup=prtChannelGroup, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerSpotColorants=prtMarkerSpotColorants, prtGeneralTable=prtGeneralTable, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtChannelProtocolVersion=prtChannelProtocolVersion, PrtCapacityUnitTC=PrtCapacityUnitTC, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtOutputType=prtOutputType, prtMediaPathStatus=prtMediaPathStatus, prtOutputFeaturesGroup=prtOutputFeaturesGroup, printmib=printmib, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtGeneralEntry=prtGeneralEntry, prtOutputIndex=prtOutputIndex, prtOutputVendorName=prtOutputVendorName, prtMIBConformance=prtMIBConformance, prtInputMediaGroup=prtInputMediaGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtChannelStatus=prtChannelStatus, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtAlertEntry=prtAlertEntry, prtStorageRefTable=prtStorageRefTable, prtInterpreterTwoWay=prtInterpreterTwoWay, printerV2AlertPrefix=printerV2AlertPrefix, prtInputCapacityUnit=prtInputCapacityUnit, prtAlertIndex=prtAlertIndex, prtInputGroup=prtInputGroup, prtConsoleLightIndex=prtConsoleLightIndex, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputStatus=prtOutputStatus, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerStatus=prtMarkerStatus, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerColorantTonality=prtMarkerColorantTonality, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, printerV1Alert=printerV1Alert, prtInputMediaName=prtInputMediaName, prtConsoleLights=prtConsoleLights, prtConsoleDescription=prtConsoleDescription, prtAlertDescription=prtAlertDescription, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtOutputDimUnit=prtOutputDimUnit, prtMarkerColorantValue=prtMarkerColorantValue, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInputMaxCapacity=prtInputMaxCapacity, prtMarkerSuppliesType=prtMarkerSuppliesType, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtCoverEntry=prtCoverEntry, prtLocalizationCountry=prtLocalizationCountry, prtMarkerNorthMargin=prtMarkerNorthMargin, CapacityUnit=CapacityUnit, prtInputMediaColor=prtInputMediaColor, prtConsoleLightEntry=prtConsoleLightEntry, prtAlertTable=prtAlertTable, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtMIBGroups=prtMIBGroups, prtGeneral=prtGeneral, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerMarkTech=prtMarkerMarkTech, prtInputType=prtInputType, prtInterpreter=prtInterpreter, prtAlertGroup=prtAlertGroup, prtLocalization=prtLocalization, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerWestMargin=prtMarkerWestMargin, prtAlertAllEvents=prtAlertAllEvents, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtMIBCompliance=prtMIBCompliance, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtOutputDescription=prtOutputDescription, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputDefaultIndex=prtOutputDefaultIndex, prtChannelV2Group=prtChannelV2Group, prtAlertTableGroup=prtAlertTableGroup, prtChannelTable=prtChannelTable, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerGroup=prtMarkerGroup, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtDeviceRefTable=prtDeviceRefTable, prtInputDescription=prtInputDescription, prtMarkerColorantTable=prtMarkerColorantTable, prtMediaPathTable=prtMediaPathTable, prtChannel=prtChannel, prtConsoleDisable=prtConsoleDisable, prtConsoleGroup=prtConsoleGroup, prtMediaPathDescription=prtMediaPathDescription, prtInterpreterIndex=prtInterpreterIndex, prtOutputName=prtOutputName, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerEastMargin=prtMarkerEastMargin, prtAlert=prtAlert, prtGeneralServicePerson=prtGeneralServicePerson, prtLocalizationEntry=prtLocalizationEntry, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtAlertTrapGroup=prtAlertTrapGroup, prtOutputDecollating=prtOutputDecollating, prtInputSwitchingGroup=prtInputSwitchingGroup, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMIB2Compliance=prtMIB2Compliance, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMediaPathType=prtMediaPathType, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtGeneralGroup=prtGeneralGroup, CodedCharSet=CodedCharSet, prtExtendedInputGroup=prtExtendedInputGroup, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtCoverTable=prtCoverTable, prtOutput=prtOutput, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, printerV2Alert=printerV2Alert, prtInputDimUnit=prtInputDimUnit, PrtMediaUnitTC=PrtMediaUnitTC, prtMediaPathIndex=prtMediaPathIndex, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtAlertTimeGroup=prtAlertTimeGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarker=prtMarker, prtInputName=prtInputName, prtCoverDescription=prtCoverDescription, prtInputVendorName=prtInputVendorName, prtMarkerEntry=prtMarkerEntry, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputTable=prtOutputTable, prtInterpreterLangLevel=prtInterpreterLangLevel, prtLocalizationIndex=prtLocalizationIndex, prtGeneralReset=prtGeneralReset, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMediaPath=prtMediaPath, prtInterpreterTable=prtInterpreterTable, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtConsoleOnTime=prtConsoleOnTime, prtConsoleLocalization=prtConsoleLocalization, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInterpreterGroup=prtInterpreterGroup, prtInputMediaWeight=prtInputMediaWeight, prtConsoleOffTime=prtConsoleOffTime, prtConsoleColor=prtConsoleColor, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerProcessColorants=prtMarkerProcessColorants, prtLocalizationTable=prtLocalizationTable, prtStorageRefEntry=prtStorageRefEntry, PresentOnOff=PresentOnOff, prtAlertTime=prtAlertTime, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInputNextIndex=prtInputNextIndex, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInput=prtInput, prtInterpreterVersion=prtInterpreterVersion, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry)
mibBuilder.exportSymbols("Printer-MIB", PrtChannelStateTC=PrtChannelStateTC, prtInterpreterDescription=prtInterpreterDescription, SubUnitStatus=SubUnitStatus, prtConsoleLightTable=prtConsoleLightTable)
