...
PrtConsoleColorTC, PrtAlertGroupTC, PrtInterpreterLangFamilyTC, PrtGeneralResetTC, PrtMarkerSuppliesTypeTC, PrtOutputTypeTC, PrtAlertTrainingLevelTC, PrtAlertCodeTC, PrtInputTypeTC, PrtMediaPathTypeTC, PrtChannelTypeTC, PrtConsoleDisableTC, PrtCoverStatusTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleColorTC", "PrtAlertGroupTC", "PrtInterpreterLangFamilyTC", "PrtGeneralResetTC", "PrtMarkerSuppliesTypeTC", "PrtOutputTypeTC", "PrtAlertTrainingLevelTC", "PrtAlertCodeTC", "PrtInputTypeTC", "PrtMediaPathTypeTC", "PrtChannelTypeTC", "PrtConsoleDisableTC", "PrtCoverStatusTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtAlertDescription=prtAlertDescription, prtMarkerColorantTable=prtMarkerColorantTable, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtMarkerMarkTech=prtMarkerMarkTech, prtLocalizationEntry=prtLocalizationEntry, prtStorageRefIndex=prtStorageRefIndex, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerWestMargin=prtMarkerWestMargin, prtChannelGroup=prtChannelGroup, PrtChannelStateTC=PrtChannelStateTC, printerV2AlertPrefix=printerV2AlertPrefix, prtDeviceRefIndex=prtDeviceRefIndex, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtInputSecurity=prtInputSecurity, prtInputMediaName=prtInputMediaName, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtOutput=prtOutput, prtInterpreterVersion=prtInterpreterVersion, prtCoverDescription=prtCoverDescription, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, printerV1Alert=printerV1Alert, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputModel=prtOutputModel, prtMarker=prtMarker, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerSpotColorants=prtMarkerSpotColorants, prtInterpreterEntry=prtInterpreterEntry, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtGeneralConfigChanges=prtGeneralConfigChanges, prtDeviceRefTable=prtDeviceRefTable, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputName=prtInputName, prtLocalization=prtLocalization, MediaUnit=MediaUnit, prtOutputName=prtOutputName, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, PresentOnOff=PresentOnOff, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMarkerNorthMargin=prtMarkerNorthMargin, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtChannelInformation=prtChannelInformation, prtInterpreterTable=prtInterpreterTable, prtChannelEntry=prtChannelEntry, prtLocalizationIndex=prtLocalizationIndex, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMarkerColorantIndex=prtMarkerColorantIndex, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtInterpreterDescription=prtInterpreterDescription, prtInputDimUnit=prtInputDimUnit, prtInputSerialNumber=prtInputSerialNumber, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtCoverStatus=prtCoverStatus, prtMarkerTable=prtMarkerTable, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtAlertTrainingLevel=prtAlertTrainingLevel, prtExtendedInputGroup=prtExtendedInputGroup, prtInputDefaultIndex=prtInputDefaultIndex, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtChannelType=prtChannelType, prtChannelV2Group=prtChannelV2Group, prtAlertAllEvents=prtAlertAllEvents, prtOutputTable=prtOutputTable, prtMediaPathIndex=prtMediaPathIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtChannel=prtChannel, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerColorant=prtMarkerColorant, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtOutputDescription=prtOutputDescription, prtConsoleLocalization=prtConsoleLocalization, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtConsoleColor=prtConsoleColor, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputDecollating=prtOutputDecollating, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMediaPath=prtMediaPath, prtAlertLocation=prtAlertLocation, prtInputMediaType=prtInputMediaType, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInputCapacityUnit=prtInputCapacityUnit, prtAlertEntry=prtAlertEntry, prtAlertTrapGroup=prtAlertTrapGroup, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputBursting=prtOutputBursting, prtLocalizationCountry=prtLocalizationCountry, prtOutputDimUnit=prtOutputDimUnit, prtOutputSecurity=prtOutputSecurity, prtGeneralTable=prtGeneralTable, prtInputMaxCapacity=prtInputMaxCapacity, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMediaPathDescription=prtMediaPathDescription, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerGroup=prtMarkerGroup, prtConsoleGroup=prtConsoleGroup, prtConsoleOnTime=prtConsoleOnTime, prtConsoleLightEntry=prtConsoleLightEntry, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtGeneralGroup=prtGeneralGroup, CapacityUnit=CapacityUnit, prtOutputDefaultIndex=prtOutputDefaultIndex, prtStorageRefEntry=prtStorageRefEntry, PrtMediaUnitTC=PrtMediaUnitTC, prtCover=prtCover, prtMIBCompliance=prtMIBCompliance, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMIBGroups=prtMIBGroups, PrtPrintOrientationTC=PrtPrintOrientationTC, prtGeneral=prtGeneral, prtCoverIndex=prtCoverIndex, prtGeneralV2Group=prtGeneralV2Group, prtInputStatus=prtInputStatus, prtInterpreter=prtInterpreter, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputStackingOrder=prtOutputStackingOrder, prtOutputVersion=prtOutputVersion, prtMediaPathGroup=prtMediaPathGroup, printerV2Alert=printerV2Alert, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtOutputEntry=prtOutputEntry, prtAlertGroup=prtAlertGroup, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMIBConformance=prtMIBConformance, prtGeneralEntry=prtGeneralEntry, prtInputIndex=prtInputIndex, prtOutputIndex=prtOutputIndex, SubUnitStatus=SubUnitStatus, prtInputDescription=prtInputDescription, prtOutputType=prtOutputType, prtConsoleLights=prtConsoleLights, prtInterpreterGroup=prtInterpreterGroup, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtAlertTable=prtAlertTable, PYSNMP_MODULE_ID=printmib, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMIB2Groups=prtMIB2Groups, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInputVendorName=prtInputVendorName, prtAlertIndex=prtAlertIndex, prtGeneralServicePerson=prtGeneralServicePerson, prtAlertTime=prtAlertTime, prtConsoleDescription=prtConsoleDescription, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMediaPathStatus=prtMediaPathStatus, prtChannelIfIndex=prtChannelIfIndex, prtAlertTableGroup=prtAlertTableGroup, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtAlertCriticalEvents=prtAlertCriticalEvents, printmib=printmib, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMediaPathEntry=prtMediaPathEntry, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtConsoleLightTable=prtConsoleLightTable, prtMarkerStatus=prtMarkerStatus, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMarkerProcessColorants=prtMarkerProcessColorants, prtAlertTimeGroup=prtAlertTimeGroup, prtInputTable=prtInputTable, prtOutputPageCollated=prtOutputPageCollated, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlertCode=prtAlertCode, prtInputMediaColor=prtInputMediaColor, prtInputNextIndex=prtInputNextIndex, prtCoverEntry=prtCoverEntry, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtConsoleLightIndex=prtConsoleLightIndex, prtOutputSerialNumber=prtOutputSerialNumber, prtDeviceRefEntry=prtDeviceRefEntry, prtStorageRefTable=prtStorageRefTable, prtMarkerIndex=prtMarkerIndex, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInputMediaWeight=prtInputMediaWeight, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputVendorName=prtOutputVendorName, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMediaPathType=prtMediaPathType, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtInput=prtInput, prtConsoleOffTime=prtConsoleOffTime, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputMediaGroup=prtInputMediaGroup, prtChannelTable=prtChannelTable, CodedCharSet=CodedCharSet, prtOutputCapacityUnit=prtOutputCapacityUnit, prtInterpreterIndex=prtInterpreterIndex, prtGeneralReset=prtGeneralReset, prtInputModel=prtInputModel, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtLocalizationTable=prtLocalizationTable, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerColorantValue=prtMarkerColorantValue, prtInputGroup=prtInputGroup, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerSupplies=prtMarkerSupplies, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputStatus=prtOutputStatus, prtOutputGroup=prtOutputGroup, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtInputVersion=prtInputVersion, prtMarkerColorantRole=prtMarkerColorantRole, prtConsoleDisable=prtConsoleDisable, prtInputEntry=prtInputEntry, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtChannelState=prtChannelState, prtChannelStatus=prtChannelStatus, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInputType=prtInputType, prtAlert=prtAlert, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtChannelIndex=prtChannelIndex, prtMarkerEntry=prtMarkerEntry, prtMIB2Compliance=prtMIB2Compliance, prtExtendedOutputGroup=prtExtendedOutputGroup, prtCoverTable=prtCoverTable)
mibBuilder.exportSymbols("Printer-MIB", prtMediaPathTable=prtMediaPathTable, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtGeneralPrinterName=prtGeneralPrinterName)
