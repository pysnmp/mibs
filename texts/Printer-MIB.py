...
PrtAlertTrainingLevelTC, PrtAlertCodeTC, PrtInputTypeTC, PrtOutputTypeTC, PrtChannelTypeTC, PrtConsoleColorTC, PrtMarkerMarkTechTC, PrtAlertGroupTC, PrtConsoleDisableTC, PrtMarkerSuppliesTypeTC, PrtGeneralResetTC, PrtMediaPathTypeTC, PrtInterpreterLangFamilyTC, PrtCoverStatusTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertTrainingLevelTC", "PrtAlertCodeTC", "PrtInputTypeTC", "PrtOutputTypeTC", "PrtChannelTypeTC", "PrtConsoleColorTC", "PrtMarkerMarkTechTC", "PrtAlertGroupTC", "PrtConsoleDisableTC", "PrtMarkerSuppliesTypeTC", "PrtGeneralResetTC", "PrtMediaPathTypeTC", "PrtInterpreterLangFamilyTC", "PrtCoverStatusTC")
...
mibBuilder.exportSymbols("Printer-MIB", printerV2AlertPrefix=printerV2AlertPrefix, prtExtendedOutputGroup=prtExtendedOutputGroup, prtAlert=prtAlert, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerGroup=prtMarkerGroup, prtAlertTimeGroup=prtAlertTimeGroup, prtMIBCompliance=prtMIBCompliance, prtLocalizationIndex=prtLocalizationIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtOutputVendorName=prtOutputVendorName, prtMarkerWestMargin=prtMarkerWestMargin, prtInterpreterVersion=prtInterpreterVersion, prtCoverDescription=prtCoverDescription, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtConsoleDescription=prtConsoleDescription, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtInputSecurity=prtInputSecurity, prtInputMediaWeight=prtInputMediaWeight, prtConsoleLightIndex=prtConsoleLightIndex, prtConsoleColor=prtConsoleColor, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMediaPathType=prtMediaPathType, prtMarkerMarkTech=prtMarkerMarkTech, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtChannel=prtChannel, prtOutputType=prtOutputType, prtMarkerColorantTable=prtMarkerColorantTable, prtOutputModel=prtOutputModel, prtMarkerStatus=prtMarkerStatus, prtLocalizationEntry=prtLocalizationEntry, prtMarkerColorant=prtMarkerColorant, prtAlertTrapGroup=prtAlertTrapGroup, prtAlertIndex=prtAlertIndex, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtOutputCapacityUnit=prtOutputCapacityUnit, CodedCharSet=CodedCharSet, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerSouthMargin=prtMarkerSouthMargin, MediaUnit=MediaUnit, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtCoverIndex=prtCoverIndex, prtMIBConformance=prtMIBConformance, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtLocalizationLanguage=prtLocalizationLanguage, prtAlertGroupIndex=prtAlertGroupIndex, prtMarkerSuppliesType=prtMarkerSuppliesType, prtAlertCriticalEvents=prtAlertCriticalEvents, prtConsoleDisable=prtConsoleDisable, prtStorageRefIndex=prtStorageRefIndex, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMediaPath=prtMediaPath, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInputDefaultIndex=prtInputDefaultIndex, PresentOnOff=PresentOnOff, prtOutputSerialNumber=prtOutputSerialNumber, prtOutputStackingOrder=prtOutputStackingOrder, prtInputDescription=prtInputDescription, prtOutputName=prtOutputName, prtInterpreterTable=prtInterpreterTable, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtOutputEntry=prtOutputEntry, prtGeneralEntry=prtGeneralEntry, prtOutputStatus=prtOutputStatus, prtChannelTable=prtChannelTable, prtOutputDecollating=prtOutputDecollating, prtChannelProtocolVersion=prtChannelProtocolVersion, prtCoverTable=prtCoverTable, prtInputMediaFormParts=prtInputMediaFormParts, prtInputGroup=prtInputGroup, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMarkerColorantEntry=prtMarkerColorantEntry, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtGeneralServicePerson=prtGeneralServicePerson, prtInputMediaColor=prtInputMediaColor, prtExtendedInputGroup=prtExtendedInputGroup, prtMediaPathGroup=prtMediaPathGroup, prtInputStatus=prtInputStatus, CapacityUnit=CapacityUnit, prtInputMediaName=prtInputMediaName, prtOutputIndex=prtOutputIndex, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtGeneralSerialNumber=prtGeneralSerialNumber, prtLocalizationCountry=prtLocalizationCountry, prtOutputVersion=prtOutputVersion, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputTable=prtInputTable, prtInputNextIndex=prtInputNextIndex, PYSNMP_MODULE_ID=printmib, prtInputVersion=prtInputVersion, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtChannelType=prtChannelType, prtInputDimUnit=prtInputDimUnit, prtOutputDimensionsGroup=prtOutputDimensionsGroup, PrtPrintOrientationTC=PrtPrintOrientationTC, prtAlertDescription=prtAlertDescription, prtConsoleLocalization=prtConsoleLocalization, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtCover=prtCover, prtChannelState=prtChannelState, prtLocalization=prtLocalization, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtOutputGroup=prtOutputGroup, prtMarkerColorantValue=prtMarkerColorantValue, prtStorageRefTable=prtStorageRefTable, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMediaPathDescription=prtMediaPathDescription, prtConsoleLightTable=prtConsoleLightTable, prtMarkerSpotColorants=prtMarkerSpotColorants, prtGeneral=prtGeneral, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtAlertTableV2Group=prtAlertTableV2Group, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerEastMargin=prtMarkerEastMargin, prtInputMediaType=prtInputMediaType, prtMediaPathStatus=prtMediaPathStatus, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtChannelV2Group=prtChannelV2Group, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInputModel=prtInputModel, prtChannelEntry=prtChannelEntry, prtChannelInformation=prtChannelInformation, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputVendorName=prtInputVendorName, prtMarkerColorantTonality=prtMarkerColorantTonality, prtGeneralV2Group=prtGeneralV2Group, prtInputType=prtInputType, prtInterpreter=prtInterpreter, prtAlertAllEvents=prtAlertAllEvents, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtConsoleLights=prtConsoleLights, prtMIBGroups=prtMIBGroups, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputPageCollated=prtOutputPageCollated, prtMarkerIndex=prtMarkerIndex, prtOutputBursting=prtOutputBursting, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInterpreterDescription=prtInterpreterDescription, prtAlertTable=prtAlertTable, prtMarker=prtMarker, prtMarkerTable=prtMarkerTable, prtMediaPathIndex=prtMediaPathIndex, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMIB2Compliance=prtMIB2Compliance, SubUnitStatus=SubUnitStatus, prtInputMediaGroup=prtInputMediaGroup, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMIB2Groups=prtMIB2Groups, prtAlertCode=prtAlertCode, prtMarkerColorantRole=prtMarkerColorantRole, prtMediaPathTable=prtMediaPathTable, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtGeneralReset=prtGeneralReset, prtOutput=prtOutput, prtGeneralPrinterName=prtGeneralPrinterName, printerV1Alert=printerV1Alert, prtGeneralConfigChanges=prtGeneralConfigChanges, prtOutputTable=prtOutputTable, printerV2Alert=printerV2Alert, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMediaPathEntry=prtMediaPathEntry, prtCoverStatus=prtCoverStatus, prtInputIndex=prtInputIndex, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtOutputDimUnit=prtOutputDimUnit, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputCapacityUnit=prtInputCapacityUnit, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInputName=prtInputName, prtChannelIndex=prtChannelIndex, prtMarkerSupplies=prtMarkerSupplies, prtConsoleOnTime=prtConsoleOnTime, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtChannelGroup=prtChannelGroup, PrtChannelStateTC=PrtChannelStateTC, prtInterpreterEntry=prtInterpreterEntry, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMarkerProcessColorants=prtMarkerProcessColorants, prtAlertTime=prtAlertTime, prtInterpreterGroup=prtInterpreterGroup, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtLocalizationTable=prtLocalizationTable, prtAlertTableGroup=prtAlertTableGroup, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtInterpreterIndex=prtInterpreterIndex, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtAlertTrainingLevel=prtAlertTrainingLevel, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInputCurrentLevel=prtInputCurrentLevel, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtCoverEntry=prtCoverEntry, prtMarkerLifeCount=prtMarkerLifeCount, prtStorageRefEntry=prtStorageRefEntry, prtOutputDescription=prtOutputDescription, prtOutputSecurity=prtOutputSecurity, PrtCapacityUnitTC=PrtCapacityUnitTC, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, printmib=printmib, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtDeviceRefTable=prtDeviceRefTable, prtGeneralTable=prtGeneralTable, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerEntry=prtMarkerEntry, prtConsoleOffTime=prtConsoleOffTime, prtInputMaxCapacity=prtInputMaxCapacity, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtAlertGroup=prtAlertGroup, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtConsoleGroup=prtConsoleGroup, prtInputEntry=prtInputEntry, prtGeneralGroup=prtGeneralGroup, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtAlertLocation=prtAlertLocation, prtDeviceRefIndex=prtDeviceRefIndex, prtChannelStatus=prtChannelStatus, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtChannelIfIndex=prtChannelIfIndex, prtAlertSeverityLevel=prtAlertSeverityLevel)
mibBuilder.exportSymbols("Printer-MIB", prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtAlertEntry=prtAlertEntry, prtInputSerialNumber=prtInputSerialNumber, prtInput=prtInput)
