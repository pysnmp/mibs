...
PrtMediaPathTypeTC, PrtAlertCodeTC, PrtAlertTrainingLevelTC, PrtAlertGroupTC, PrtInterpreterLangFamilyTC, PrtMarkerMarkTechTC, PrtConsoleDisableTC, PrtChannelTypeTC, PrtGeneralResetTC, PrtCoverStatusTC, PrtOutputTypeTC, PrtMarkerSuppliesTypeTC, PrtInputTypeTC, PrtConsoleColorTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMediaPathTypeTC", "PrtAlertCodeTC", "PrtAlertTrainingLevelTC", "PrtAlertGroupTC", "PrtInterpreterLangFamilyTC", "PrtMarkerMarkTechTC", "PrtConsoleDisableTC", "PrtChannelTypeTC", "PrtGeneralResetTC", "PrtCoverStatusTC", "PrtOutputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtInputTypeTC", "PrtConsoleColorTC")
...
mibBuilder.exportSymbols("Printer-MIB", PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerNorthMargin=prtMarkerNorthMargin, prtConsoleLightIndex=prtConsoleLightIndex, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMIBGroups=prtMIBGroups, PrtChannelStateTC=PrtChannelStateTC, prtCover=prtCover, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputDecollating=prtOutputDecollating, prtInputVendorName=prtInputVendorName, prtGeneralGroup=prtGeneralGroup, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInterpreterLangFamily=prtInterpreterLangFamily, prtAlertGroupIndex=prtAlertGroupIndex, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInterpreterDescription=prtInterpreterDescription, prtInputIndex=prtInputIndex, prtGeneral=prtGeneral, prtInputSwitchingGroup=prtInputSwitchingGroup, prtLocalizationIndex=prtLocalizationIndex, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputModel=prtOutputModel, prtStorageRefIndex=prtStorageRefIndex, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleGroup=prtConsoleGroup, prtMIB2Groups=prtMIB2Groups, prtChannelV2Group=prtChannelV2Group, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerStatus=prtMarkerStatus, printerV1Alert=printerV1Alert, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtCoverStatus=prtCoverStatus, prtAlertTrainingLevel=prtAlertTrainingLevel, prtConsoleLightEntry=prtConsoleLightEntry, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtGeneralV2Group=prtGeneralV2Group, prtInputNextIndex=prtInputNextIndex, prtInputSerialNumber=prtInputSerialNumber, printerV2AlertPrefix=printerV2AlertPrefix, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputStatus=prtOutputStatus, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtChannel=prtChannel, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtOutputEntry=prtOutputEntry, prtLocalizationEntry=prtLocalizationEntry, prtStorageRefEntry=prtStorageRefEntry, prtDeviceRefTable=prtDeviceRefTable, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtGeneralReset=prtGeneralReset, PrtCapacityUnitTC=PrtCapacityUnitTC, prtMediaPathType=prtMediaPathType, prtInputMediaColor=prtInputMediaColor, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMarkerColorantIndex=prtMarkerColorantIndex, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtLocalizationTable=prtLocalizationTable, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtConsoleLightTable=prtConsoleLightTable, prtInput=prtInput, prtOutputStackingOrder=prtOutputStackingOrder, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerSupplies=prtMarkerSupplies, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtInputMaxCapacity=prtInputMaxCapacity, prtInterpreterLangVersion=prtInterpreterLangVersion, prtGeneralEntry=prtGeneralEntry, prtInputDescription=prtInputDescription, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtInputEntry=prtInputEntry, prtInterpreterTable=prtInterpreterTable, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputMediaName=prtInputMediaName, prtInputMediaWeight=prtInputMediaWeight, prtOutputVendorName=prtOutputVendorName, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInterpreterLangLevel=prtInterpreterLangLevel, prtAlertEntry=prtAlertEntry, prtInputModel=prtInputModel, prtInputSecurity=prtInputSecurity, prtOutputName=prtOutputName, prtOutputVersion=prtOutputVersion, prtOutputOffsetStacking=prtOutputOffsetStacking, PrtPrintOrientationTC=PrtPrintOrientationTC, prtChannelIfIndex=prtChannelIfIndex, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInputDimUnit=prtInputDimUnit, prtInputType=prtInputType, prtInputCapacityUnit=prtInputCapacityUnit, prtMarkerWestMargin=prtMarkerWestMargin, prtExtendedInputGroup=prtExtendedInputGroup, prtMediaPathIndex=prtMediaPathIndex, prtConsoleOnTime=prtConsoleOnTime, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInterpreterEntry=prtInterpreterEntry, printmib=printmib, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInputCurrentLevel=prtInputCurrentLevel, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtCoverIndex=prtCoverIndex, prtAlertAllEvents=prtAlertAllEvents, prtCoverTable=prtCoverTable, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerLifeCount=prtMarkerLifeCount, prtOutputPageCollated=prtOutputPageCollated, prtMediaPathDescription=prtMediaPathDescription, prtAlertIndex=prtAlertIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerColorantTable=prtMarkerColorantTable, prtConsoleColor=prtConsoleColor, prtLocalizationCountry=prtLocalizationCountry, prtDeviceRefEntry=prtDeviceRefEntry, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtGeneralTable=prtGeneralTable, prtOutputCapacityUnit=prtOutputCapacityUnit, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerColorantValue=prtMarkerColorantValue, prtMIBCompliance=prtMIBCompliance, PresentOnOff=PresentOnOff, prtOutputSerialNumber=prtOutputSerialNumber, prtOutputDescription=prtOutputDescription, prtInterpreterTwoWay=prtInterpreterTwoWay, prtConsoleDescription=prtConsoleDescription, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInputTable=prtInputTable, prtOutputIndex=prtOutputIndex, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerColorantEntry=prtMarkerColorantEntry, prtExtendedOutputGroup=prtExtendedOutputGroup, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtConsoleOffTime=prtConsoleOffTime, prtMediaPathGroup=prtMediaPathGroup, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtLocalizationLanguage=prtLocalizationLanguage, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputStatus=prtInputStatus, prtAlertTimeGroup=prtAlertTimeGroup, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerIndex=prtMarkerIndex, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtOutputBursting=prtOutputBursting, prtInputMediaFormParts=prtInputMediaFormParts, prtMarkerProcessColorants=prtMarkerProcessColorants, prtChannelTable=prtChannelTable, prtChannelStatus=prtChannelStatus, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtOutputDimUnit=prtOutputDimUnit, prtInterpreter=prtInterpreter, prtGeneralConfigChanges=prtGeneralConfigChanges, prtCoverEntry=prtCoverEntry, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, PrtSubUnitStatusTC=PrtSubUnitStatusTC, MediaUnit=MediaUnit, printerV2Alert=printerV2Alert, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerColorantRole=prtMarkerColorantRole, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtAlertDescription=prtAlertDescription, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerEntry=prtMarkerEntry, prtOutput=prtOutput, prtMarkerCounterUnit=prtMarkerCounterUnit, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtAlertCode=prtAlertCode, prtAlertTime=prtAlertTime, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, CapacityUnit=CapacityUnit, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtChannelProtocolVersion=prtChannelProtocolVersion, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInputGroup=prtInputGroup, prtOutputGroup=prtOutputGroup, prtMarkerGroup=prtMarkerGroup, prtChannelGroup=prtChannelGroup, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtChannelInformation=prtChannelInformation, prtMediaPath=prtMediaPath, prtChannelEntry=prtChannelEntry, prtMediaPathTable=prtMediaPathTable, prtAlertTable=prtAlertTable, prtStorageRefTable=prtStorageRefTable, prtInputMediaGroup=prtInputMediaGroup, prtMarker=prtMarker, prtMarkerColorant=prtMarkerColorant, prtInputVersion=prtInputVersion, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMediaPathStatus=prtMediaPathStatus, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMarkerSuppliesType=prtMarkerSuppliesType, prtCoverDescription=prtCoverDescription, prtInputName=prtInputName, prtMediaPathEntry=prtMediaPathEntry, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInterpreterIndex=prtInterpreterIndex, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtLocalization=prtLocalization, prtMarkerTable=prtMarkerTable, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtAlert=prtAlert, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtChannelState=prtChannelState, prtAlertGroup=prtAlertGroup, prtChannelIndex=prtChannelIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtAlertTableGroup=prtAlertTableGroup, prtInputMediaType=prtInputMediaType, PYSNMP_MODULE_ID=printmib, prtOutputSecurity=prtOutputSecurity, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMIB2Compliance=prtMIB2Compliance, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtChannelType=prtChannelType, prtMarkerSpotColorants=prtMarkerSpotColorants, prtDeviceRefIndex=prtDeviceRefIndex, prtOutputType=prtOutputType, prtMIBConformance=prtMIBConformance, prtMarkerColorantGroup=prtMarkerColorantGroup, prtConsoleLights=prtConsoleLights, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInterpreterVersion=prtInterpreterVersion, prtOutputTable=prtOutputTable, prtInterpreterGroup=prtInterpreterGroup, SubUnitStatus=SubUnitStatus, CodedCharSet=CodedCharSet, prtConsoleLocalization=prtConsoleLocalization, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtConsoleDisable=prtConsoleDisable)
mibBuilder.exportSymbols("Printer-MIB", prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtAlertTableV2Group=prtAlertTableV2Group, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtAlertLocation=prtAlertLocation)
