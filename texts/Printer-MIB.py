...
PrtAlertCodeTC, PrtOutputTypeTC, PrtGeneralResetTC, PrtCoverStatusTC, PrtConsoleColorTC, PrtChannelTypeTC, PrtAlertTrainingLevelTC, PrtInterpreterLangFamilyTC, PrtAlertGroupTC, PrtInputTypeTC, PrtMarkerMarkTechTC, PrtMediaPathTypeTC, PrtConsoleDisableTC, PrtMarkerSuppliesTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertCodeTC", "PrtOutputTypeTC", "PrtGeneralResetTC", "PrtCoverStatusTC", "PrtConsoleColorTC", "PrtChannelTypeTC", "PrtAlertTrainingLevelTC", "PrtInterpreterLangFamilyTC", "PrtAlertGroupTC", "PrtInputTypeTC", "PrtMarkerMarkTechTC", "PrtMediaPathTypeTC", "PrtConsoleDisableTC", "PrtMarkerSuppliesTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtConsoleLightTable=prtConsoleLightTable, prtAlertIndex=prtAlertIndex, prtChannelGroup=prtChannelGroup, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtMarkerSouthMargin=prtMarkerSouthMargin, prtGeneralCurrentOperator=prtGeneralCurrentOperator, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputGroup=prtOutputGroup, prtConsoleGroup=prtConsoleGroup, prtMarkerColorantTonality=prtMarkerColorantTonality, prtAlertTrapGroup=prtAlertTrapGroup, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInterpreterVersion=prtInterpreterVersion, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtDeviceRefIndex=prtDeviceRefIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtChannel=prtChannel, prtChannelV2Group=prtChannelV2Group, prtCoverEntry=prtCoverEntry, prtInterpreterIndex=prtInterpreterIndex, prtInputIndex=prtInputIndex, prtChannelState=prtChannelState, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtGeneralPrinterName=prtGeneralPrinterName, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtAlertLocation=prtAlertLocation, prtOutput=prtOutput, prtInputName=prtInputName, prtMarkerMarkTech=prtMarkerMarkTech, prtConsoleColor=prtConsoleColor, prtAlertCode=prtAlertCode, prtInputSwitchingGroup=prtInputSwitchingGroup, prtInterpreterLangVersion=prtInterpreterLangVersion, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMarkerEntry=prtMarkerEntry, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInterpreterTwoWay=prtInterpreterTwoWay, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtInputMediaWeight=prtInputMediaWeight, prtMediaPathEntry=prtMediaPathEntry, prtInterpreterLangFamily=prtInterpreterLangFamily, prtGeneral=prtGeneral, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInputMediaGroup=prtInputMediaGroup, prtConsoleLightIndex=prtConsoleLightIndex, prtInputSerialNumber=prtInputSerialNumber, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtCoverTable=prtCoverTable, prtInputMaxCapacity=prtInputMaxCapacity, printerV2Alert=printerV2Alert, prtGeneralReset=prtGeneralReset, prtMediaPathGroup=prtMediaPathGroup, prtOutputVendorName=prtOutputVendorName, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMediaPathTable=prtMediaPathTable, prtConsoleLights=prtConsoleLights, prtGeneralGroup=prtGeneralGroup, prtOutputPageCollated=prtOutputPageCollated, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, PrtCapacityUnitTC=PrtCapacityUnitTC, prtConsoleLocalization=prtConsoleLocalization, prtExtendedOutputGroup=prtExtendedOutputGroup, PrtChannelStateTC=PrtChannelStateTC, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtGeneralV2Group=prtGeneralV2Group, prtLocalizationCountry=prtLocalizationCountry, prtLocalizationLanguage=prtLocalizationLanguage, printmib=printmib, prtMarkerTable=prtMarkerTable, prtStorageRefIndex=prtStorageRefIndex, CodedCharSet=CodedCharSet, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtChannelEntry=prtChannelEntry, prtOutputDimensionsGroup=prtOutputDimensionsGroup, printerV1Alert=printerV1Alert, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtAlertTable=prtAlertTable, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInputEntry=prtInputEntry, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtOutputStackingOrder=prtOutputStackingOrder, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputStatus=prtOutputStatus, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInputSecurity=prtInputSecurity, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerWestMargin=prtMarkerWestMargin, prtInputMediaName=prtInputMediaName, prtInterpreterEntry=prtInterpreterEntry, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtCoverDescription=prtCoverDescription, prtLocalizationTable=prtLocalizationTable, prtInputModel=prtInputModel, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertAllEvents=prtAlertAllEvents, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtGeneralServicePerson=prtGeneralServicePerson, prtOutputCapacityUnit=prtOutputCapacityUnit, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputName=prtOutputName, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerSuppliesType=prtMarkerSuppliesType, prtGeneralConfigChanges=prtGeneralConfigChanges, prtGeneralEntry=prtGeneralEntry, MediaUnit=MediaUnit, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtOutputDescription=prtOutputDescription, prtConsoleDisable=prtConsoleDisable, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleOffTime=prtConsoleOffTime, prtInputGroup=prtInputGroup, prtOutputMaxCapacity=prtOutputMaxCapacity, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtChannelStatus=prtChannelStatus, prtMediaPathDescription=prtMediaPathDescription, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtInputType=prtInputType, SubUnitStatus=SubUnitStatus, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInputTable=prtInputTable, prtOutputIndex=prtOutputIndex, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMarkerGroup=prtMarkerGroup, prtMarkerNorthMargin=prtMarkerNorthMargin, prtCoverStatus=prtCoverStatus, prtOutputVersion=prtOutputVersion, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputDecollating=prtOutputDecollating, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtDeviceRefTable=prtDeviceRefTable, prtInputMediaFormParts=prtInputMediaFormParts, prtMediaPathIndex=prtMediaPathIndex, prtMIB2Compliance=prtMIB2Compliance, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtExtendedInputGroup=prtExtendedInputGroup, prtInput=prtInput, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputOffsetStacking=prtOutputOffsetStacking, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMarkerColorantTable=prtMarkerColorantTable, prtCover=prtCover, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMediaPath=prtMediaPath, prtLocalization=prtLocalization, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerCounterUnit=prtMarkerCounterUnit, prtAlertSeverityLevel=prtAlertSeverityLevel, prtMIBGroups=prtMIBGroups, CapacityUnit=CapacityUnit, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerColorantValue=prtMarkerColorantValue, prtInputVendorName=prtInputVendorName, prtMIBConformance=prtMIBConformance, prtChannelTable=prtChannelTable, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtOutputDefaultIndex=prtOutputDefaultIndex, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtAlert=prtAlert, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMIBCompliance=prtMIBCompliance, prtOutputSecurity=prtOutputSecurity, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtAlertEntry=prtAlertEntry, PYSNMP_MODULE_ID=printmib, prtOutputModel=prtOutputModel, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtLocalizationEntry=prtLocalizationEntry, prtOutputFeaturesGroup=prtOutputFeaturesGroup, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMediaPathType=prtMediaPathType, prtChannelProtocolVersion=prtChannelProtocolVersion, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtOutputType=prtOutputType, prtInputVersion=prtInputVersion, prtConsoleDescription=prtConsoleDescription, prtAlertTableGroup=prtAlertTableGroup, PresentOnOff=PresentOnOff, prtMarkerColorantRole=prtMarkerColorantRole, prtInterpreterDescription=prtInterpreterDescription, prtInputCapacityUnit=prtInputCapacityUnit, prtChannelType=prtChannelType, prtMarkerSupplies=prtMarkerSupplies, prtInterpreter=prtInterpreter, prtGeneralTable=prtGeneralTable, prtInputDefaultIndex=prtInputDefaultIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerIndex=prtMarkerIndex, prtMediaPathStatus=prtMediaPathStatus, prtInputDescription=prtInputDescription, prtMarkerStatus=prtMarkerStatus, prtOutputBursting=prtOutputBursting, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInputMediaType=prtInputMediaType, prtAlertTimeGroup=prtAlertTimeGroup, prtCoverIndex=prtCoverIndex, prtInputNextIndex=prtInputNextIndex, prtAlertGroup=prtAlertGroup, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInterpreterLangLevel=prtInterpreterLangLevel, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtLocalizationIndex=prtLocalizationIndex, prtConsoleLightEntry=prtConsoleLightEntry, prtConsoleOnTime=prtConsoleOnTime, prtAlertDescription=prtAlertDescription, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerEastMargin=prtMarkerEastMargin, prtDeviceRefEntry=prtDeviceRefEntry, prtChannelIfIndex=prtChannelIfIndex, prtAlertTableV2Group=prtAlertTableV2Group, prtInputStatus=prtInputStatus, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputDimUnit=prtOutputDimUnit, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtStorageRefTable=prtStorageRefTable, prtAlertCriticalEvents=prtAlertCriticalEvents, prtInputDimUnit=prtInputDimUnit, prtOutputTable=prtOutputTable, prtChannelInformation=prtChannelInformation, prtMIB2Groups=prtMIB2Groups, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtAlertTime=prtAlertTime, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, printerV2AlertPrefix=printerV2AlertPrefix, prtInterpreterGroup=prtInterpreterGroup, prtChannelIndex=prtChannelIndex, prtInterpreterTable=prtInterpreterTable, prtMarkerColorant=prtMarkerColorant)
mibBuilder.exportSymbols("Printer-MIB", prtOutputEntry=prtOutputEntry, prtMarker=prtMarker, prtStorageRefEntry=prtStorageRefEntry, prtInputMediaColor=prtInputMediaColor)
