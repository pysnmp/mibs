...
PrtMarkerMarkTechTC, PrtInterpreterLangFamilyTC, PrtAlertTrainingLevelTC, PrtConsoleDisableTC, PrtAlertGroupTC, PrtAlertCodeTC, PrtConsoleColorTC, PrtGeneralResetTC, PrtCoverStatusTC, PrtInputTypeTC, PrtMarkerSuppliesTypeTC, PrtChannelTypeTC, PrtMediaPathTypeTC, PrtOutputTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtMarkerMarkTechTC", "PrtInterpreterLangFamilyTC", "PrtAlertTrainingLevelTC", "PrtConsoleDisableTC", "PrtAlertGroupTC", "PrtAlertCodeTC", "PrtConsoleColorTC", "PrtGeneralResetTC", "PrtCoverStatusTC", "PrtInputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtChannelTypeTC", "PrtMediaPathTypeTC", "PrtOutputTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInputSerialNumber=prtInputSerialNumber, prtChannelIfIndex=prtChannelIfIndex, prtMarkerWestMargin=prtMarkerWestMargin, prtLocalizationEntry=prtLocalizationEntry, prtOutputTable=prtOutputTable, prtAlertTableV2Group=prtAlertTableV2Group, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtInputMediaFormParts=prtInputMediaFormParts, prtCoverStatus=prtCoverStatus, prtCoverIndex=prtCoverIndex, prtInputMediaWeight=prtInputMediaWeight, prtMediaPathIndex=prtMediaPathIndex, prtMediaPathStatus=prtMediaPathStatus, prtCoverTable=prtCoverTable, prtMIBConformance=prtMIBConformance, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtGeneralTable=prtGeneralTable, prtOutputType=prtOutputType, prtChannelIndex=prtChannelIndex, prtChannelInformation=prtChannelInformation, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputDescription=prtOutputDescription, prtOutputSecurity=prtOutputSecurity, prtAlertSeverityLevel=prtAlertSeverityLevel, PYSNMP_MODULE_ID=printmib, prtOutputCapacityUnit=prtOutputCapacityUnit, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtDeviceRefEntry=prtDeviceRefEntry, prtCoverDescription=prtCoverDescription, prtInputName=prtInputName, prtMarkerSouthMargin=prtMarkerSouthMargin, prtConsoleDisable=prtConsoleDisable, prtStorageRefIndex=prtStorageRefIndex, prtConsoleOnTime=prtConsoleOnTime, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtOutputDefaultIndex=prtOutputDefaultIndex, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtLocalizationLanguage=prtLocalizationLanguage, prtInputMaxCapacity=prtInputMaxCapacity, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtStorageRefTable=prtStorageRefTable, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInterpreterEntry=prtInterpreterEntry, prtChannelGroup=prtChannelGroup, prtMarkerColorantValue=prtMarkerColorantValue, prtOutputBursting=prtOutputBursting, prtAlertEntry=prtAlertEntry, prtMarkerSpotColorants=prtMarkerSpotColorants, PrtChannelStateTC=PrtChannelStateTC, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInputMediaGroup=prtInputMediaGroup, prtInputIndex=prtInputIndex, prtInputDimUnit=prtInputDimUnit, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, printerV1Alert=printerV1Alert, prtChannelV2Group=prtChannelV2Group, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtAlertCriticalEvents=prtAlertCriticalEvents, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerColorantIndex=prtMarkerColorantIndex, prtConsoleGroup=prtConsoleGroup, prtInterpreterIndex=prtInterpreterIndex, prtMediaPathEntry=prtMediaPathEntry, prtInputModel=prtInputModel, prtConsoleLocalization=prtConsoleLocalization, prtAlertTable=prtAlertTable, printmib=printmib, prtInputCapacityUnit=prtInputCapacityUnit, prtMediaPathType=prtMediaPathType, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtConsoleOffTime=prtConsoleOffTime, prtOutputStackingOrder=prtOutputStackingOrder, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInterpreterLangFamily=prtInterpreterLangFamily, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtOutputDimUnit=prtOutputDimUnit, printerV2Alert=printerV2Alert, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerColorantRole=prtMarkerColorantRole, prtDeviceRefIndex=prtDeviceRefIndex, prtGeneralGroup=prtGeneralGroup, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtExtendedOutputGroup=prtExtendedOutputGroup, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMediaPathDescription=prtMediaPathDescription, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMarkerCounterUnit=prtMarkerCounterUnit, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerProcessColorants=prtMarkerProcessColorants, prtChannelType=prtChannelType, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtInputMediaColor=prtInputMediaColor, prtInputDescription=prtInputDescription, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputGroup=prtOutputGroup, prtOutputName=prtOutputName, prtConsoleLightTable=prtConsoleLightTable, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerStatus=prtMarkerStatus, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMarkerEastMargin=prtMarkerEastMargin, prtGeneralReset=prtGeneralReset, prtLocalizationTable=prtLocalizationTable, prtLocalizationCountry=prtLocalizationCountry, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputSerialNumber=prtOutputSerialNumber, prtAlertTrainingLevel=prtAlertTrainingLevel, prtOutputIndex=prtOutputIndex, prtAlertTableGroup=prtAlertTableGroup, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, PrtMediaUnitTC=PrtMediaUnitTC, prtMediaPathTable=prtMediaPathTable, prtChannel=prtChannel, prtInterpreterGroup=prtInterpreterGroup, prtOutputVersion=prtOutputVersion, prtDeviceRefTable=prtDeviceRefTable, prtInputVersion=prtInputVersion, prtConsoleLightIndex=prtConsoleLightIndex, prtAlertIndex=prtAlertIndex, prtConsoleDescription=prtConsoleDescription, prtMIBGroups=prtMIBGroups, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInputSecurity=prtInputSecurity, prtInputType=prtInputType, prtOutputPageCollated=prtOutputPageCollated, prtOutputStatus=prtOutputStatus, prtStorageRefEntry=prtStorageRefEntry, PresentOnOff=PresentOnOff, prtAlertAllEvents=prtAlertAllEvents, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtChannelStatus=prtChannelStatus, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerSuppliesTable=prtMarkerSuppliesTable, PrtCapacityUnitTC=PrtCapacityUnitTC, PrtPrintOrientationTC=PrtPrintOrientationTC, MediaUnit=MediaUnit, prtInput=prtInput, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtInputMediaName=prtInputMediaName, prtLocalizationIndex=prtLocalizationIndex, CapacityUnit=CapacityUnit, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMarkerIndex=prtMarkerIndex, prtChannelEntry=prtChannelEntry, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMarkerTable=prtMarkerTable, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMarkerDefaultIndex=prtMarkerDefaultIndex, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtAlertCode=prtAlertCode, prtOutputOffsetStacking=prtOutputOffsetStacking, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInterpreterLangLevel=prtInterpreterLangLevel, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtInterpreterTable=prtInterpreterTable, prtAlertLocation=prtAlertLocation, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtInputNextIndex=prtInputNextIndex, prtMarkerColorantTable=prtMarkerColorantTable, prtAlertDescription=prtAlertDescription, prtMIBCompliance=prtMIBCompliance, prtInputVendorName=prtInputVendorName, prtMediaPathGroup=prtMediaPathGroup, prtOutput=prtOutput, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInterpreterVersion=prtInterpreterVersion, prtGeneralServicePerson=prtGeneralServicePerson, prtInputCurrentLevel=prtInputCurrentLevel, prtMarkerLifeCount=prtMarkerLifeCount, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtCoverEntry=prtCoverEntry, prtLocalization=prtLocalization, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtGeneralPrinterName=prtGeneralPrinterName, CodedCharSet=CodedCharSet, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtCover=prtCover, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInterpreterTwoWay=prtInterpreterTwoWay, prtInputStatus=prtInputStatus, prtInputMediaType=prtInputMediaType, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtOutputDecollating=prtOutputDecollating, prtMIB2Compliance=prtMIB2Compliance, prtMarkerGroup=prtMarkerGroup, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtChannelState=prtChannelState, prtMediaPath=prtMediaPath, prtOutputMaxCapacity=prtOutputMaxCapacity, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtConsoleLightEntry=prtConsoleLightEntry, prtAlertGroup=prtAlertGroup, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarker=prtMarker, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputTable=prtInputTable, prtChannelProtocolVersion=prtChannelProtocolVersion, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtAlertGroupIndex=prtAlertGroupIndex, printerV2AlertPrefix=printerV2AlertPrefix, prtMIB2Groups=prtMIB2Groups, prtConsoleColor=prtConsoleColor, prtOutputEntry=prtOutputEntry, prtMarkerSupplies=prtMarkerSupplies, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtGeneral=prtGeneral, prtChannelTable=prtChannelTable, prtInterpreterDescription=prtInterpreterDescription, prtMarkerEntry=prtMarkerEntry, prtGeneralEntry=prtGeneralEntry, prtMarkerColorant=prtMarkerColorant, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInputEntry=prtInputEntry, prtInterpreter=prtInterpreter, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtGeneralV2Group=prtGeneralV2Group, prtAlertTime=prtAlertTime, prtInputDefaultIndex=prtInputDefaultIndex, prtAlert=prtAlert, prtGeneralSerialNumber=prtGeneralSerialNumber, prtOutputVendorName=prtOutputVendorName, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInputSwitchingGroup=prtInputSwitchingGroup, prtAlertTrapGroup=prtAlertTrapGroup, SubUnitStatus=SubUnitStatus, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInputGroup=prtInputGroup, prtOutputModel=prtOutputModel)
mibBuilder.exportSymbols("Printer-MIB", prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtConsoleLights=prtConsoleLights)
