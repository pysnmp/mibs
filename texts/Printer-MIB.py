...
PrtGeneralResetTC, PrtInputTypeTC, PrtChannelTypeTC, PrtMarkerSuppliesTypeTC, PrtMarkerMarkTechTC, PrtAlertCodeTC, PrtAlertGroupTC, PrtInterpreterLangFamilyTC, PrtConsoleColorTC, PrtConsoleDisableTC, PrtMediaPathTypeTC, PrtAlertTrainingLevelTC, PrtOutputTypeTC, PrtCoverStatusTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtGeneralResetTC", "PrtInputTypeTC", "PrtChannelTypeTC", "PrtMarkerSuppliesTypeTC", "PrtMarkerMarkTechTC", "PrtAlertCodeTC", "PrtAlertGroupTC", "PrtInterpreterLangFamilyTC", "PrtConsoleColorTC", "PrtConsoleDisableTC", "PrtMediaPathTypeTC", "PrtAlertTrainingLevelTC", "PrtOutputTypeTC", "PrtCoverStatusTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputEntry=prtInputEntry, prtInputName=prtInputName, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputType=prtOutputType, prtConsoleGroup=prtConsoleGroup, prtAlertGroupIndex=prtAlertGroupIndex, prtGeneralConfigChanges=prtGeneralConfigChanges, prtAlertTableGroup=prtAlertTableGroup, prtInputCapacityUnit=prtInputCapacityUnit, prtLocalizationIndex=prtLocalizationIndex, prtCoverTable=prtCoverTable, prtInput=prtInput, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtOutputTable=prtOutputTable, prtGeneralSerialNumber=prtGeneralSerialNumber, prtAlertDescription=prtAlertDescription, prtInputMediaWeight=prtInputMediaWeight, prtOutputStatus=prtOutputStatus, prtMediaPathIndex=prtMediaPathIndex, prtMediaPath=prtMediaPath, prtInterpreter=prtInterpreter, prtOutputIndex=prtOutputIndex, prtAlertTime=prtAlertTime, prtMarkerNorthMargin=prtMarkerNorthMargin, prtChannelTable=prtChannelTable, prtMIB2Compliance=prtMIB2Compliance, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleLocalization=prtConsoleLocalization, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, CodedCharSet=CodedCharSet, prtInterpreterVersion=prtInterpreterVersion, prtOutputDimUnit=prtOutputDimUnit, prtMarkerGroup=prtMarkerGroup, CapacityUnit=CapacityUnit, PresentOnOff=PresentOnOff, prtStorageRefIndex=prtStorageRefIndex, SubUnitStatus=SubUnitStatus, prtOutputDescription=prtOutputDescription, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputDimUnit=prtInputDimUnit, prtResponsiblePartyGroup=prtResponsiblePartyGroup, PrtChannelStateTC=PrtChannelStateTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtGeneralEntry=prtGeneralEntry, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtGeneral=prtGeneral, prtInputMediaColor=prtInputMediaColor, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtOutputDecollating=prtOutputDecollating, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtConsoleDisable=prtConsoleDisable, prtLocalizationLanguage=prtLocalizationLanguage, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, printerV2AlertPrefix=printerV2AlertPrefix, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtStorageRefSeqNumber=prtStorageRefSeqNumber, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerColorantTable=prtMarkerColorantTable, prtChannelIndex=prtChannelIndex, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInterpreterLangVersion=prtInterpreterLangVersion, prtGeneralReset=prtGeneralReset, prtMarkerCounterUnit=prtMarkerCounterUnit, prtLocalizationTable=prtLocalizationTable, prtInputMaxCapacity=prtInputMaxCapacity, prtChannelGroup=prtChannelGroup, prtMediaPathTable=prtMediaPathTable, prtLocalization=prtLocalization, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtConsoleLightIndex=prtConsoleLightIndex, prtAlertLocation=prtAlertLocation, PrtPrintOrientationTC=PrtPrintOrientationTC, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtOutputSecurity=prtOutputSecurity, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerTable=prtMarkerTable, prtMarkerWestMargin=prtMarkerWestMargin, prtCover=prtCover, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtConsoleDescription=prtConsoleDescription, prtMediaPathEntry=prtMediaPathEntry, prtMarkerStatus=prtMarkerStatus, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMediaPathGroup=prtMediaPathGroup, prtMarkerMarkTech=prtMarkerMarkTech, PrtCapacityUnitTC=PrtCapacityUnitTC, prtStorageRefEntry=prtStorageRefEntry, prtInputDescription=prtInputDescription, prtCoverIndex=prtCoverIndex, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtInputSerialNumber=prtInputSerialNumber, prtLocalizationCountry=prtLocalizationCountry, prtInputStatus=prtInputStatus, prtCoverStatus=prtCoverStatus, prtMarkerColorantEntry=prtMarkerColorantEntry, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInterpreterLangLevel=prtInterpreterLangLevel, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtLocalizationEntry=prtLocalizationEntry, prtMarkerColorantIndex=prtMarkerColorantIndex, prtExtendedOutputGroup=prtExtendedOutputGroup, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtAlertCriticalEvents=prtAlertCriticalEvents, prtDeviceRefIndex=prtDeviceRefIndex, prtAlertTimeGroup=prtAlertTimeGroup, prtConsoleColor=prtConsoleColor, prtOutputPageCollated=prtOutputPageCollated, prtOutputSerialNumber=prtOutputSerialNumber, prtInputSecurity=prtInputSecurity, prtGeneralPrinterName=prtGeneralPrinterName, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtCoverEntry=prtCoverEntry, prtAlertGroup=prtAlertGroup, prtOutputVersion=prtOutputVersion, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtOutputCapacityUnit=prtOutputCapacityUnit, prtAlertAllEvents=prtAlertAllEvents, prtAlertCode=prtAlertCode, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, printmib=printmib, prtGeneralServicePerson=prtGeneralServicePerson, prtInputCurrentLevel=prtInputCurrentLevel, prtChannelIfIndex=prtChannelIfIndex, printerV1Alert=printerV1Alert, prtInputTable=prtInputTable, prtInterpreterLangFamily=prtInterpreterLangFamily, prtAlertIndex=prtAlertIndex, prtMarkerProcessColorants=prtMarkerProcessColorants, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtConsoleOnTime=prtConsoleOnTime, prtChannel=prtChannel, prtInterpreterIndex=prtInterpreterIndex, prtAlertSeverityLevel=prtAlertSeverityLevel, prtOutputStackingOrder=prtOutputStackingOrder, printerV2Alert=printerV2Alert, prtGeneralGroup=prtGeneralGroup, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputEntry=prtOutputEntry, prtInputMediaGroup=prtInputMediaGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerColorantTonality=prtMarkerColorantTonality, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtConsoleLightTable=prtConsoleLightTable, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputGroup=prtInputGroup, prtOutputOffsetStacking=prtOutputOffsetStacking, prtAlertTable=prtAlertTable, prtMarkerColorantGroup=prtMarkerColorantGroup, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtStorageRefTable=prtStorageRefTable, prtMarkerLifeCount=prtMarkerLifeCount, prtInputNextIndex=prtInputNextIndex, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarker=prtMarker, prtMIBConformance=prtMIBConformance, prtConsoleLights=prtConsoleLights, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInterpreterEntry=prtInterpreterEntry, prtMediaPathType=prtMediaPathType, prtOutputModel=prtOutputModel, prtInputDefaultIndex=prtInputDefaultIndex, prtInterpreterTwoWay=prtInterpreterTwoWay, prtChannelV2Group=prtChannelV2Group, prtChannelEntry=prtChannelEntry, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputGroup=prtOutputGroup, prtInterpreterDescription=prtInterpreterDescription, prtAlertTrapGroup=prtAlertTrapGroup, prtChannelInformation=prtChannelInformation, prtInputType=prtInputType, prtMIBGroups=prtMIBGroups, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMarkerIndex=prtMarkerIndex, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMarkerColorantRole=prtMarkerColorantRole, prtInterpreterTable=prtInterpreterTable, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtDeviceRefEntry=prtDeviceRefEntry, prtAlert=prtAlert, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtOutputVendorName=prtOutputVendorName, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtInputVersion=prtInputVersion, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerEastMargin=prtMarkerEastMargin, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMarkerSupplies=prtMarkerSupplies, prtMarkerColorantValue=prtMarkerColorantValue, prtGeneralTable=prtGeneralTable, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInputModel=prtInputModel, prtMarkerEntry=prtMarkerEntry, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMarkerSouthMargin=prtMarkerSouthMargin, prtCoverDescription=prtCoverDescription, prtChannelState=prtChannelState, prtConsoleLightEntry=prtConsoleLightEntry, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtExtendedInputGroup=prtExtendedInputGroup, prtOutput=prtOutput, PYSNMP_MODULE_ID=printmib, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, MediaUnit=MediaUnit, prtMediaPathDescription=prtMediaPathDescription, prtMIB2Groups=prtMIB2Groups, prtInputVendorName=prtInputVendorName, prtMIBCompliance=prtMIBCompliance, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMediaPathStatus=prtMediaPathStatus, prtGeneralV2Group=prtGeneralV2Group, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputMediaName=prtInputMediaName, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtConsoleOffTime=prtConsoleOffTime, prtChannelStatus=prtChannelStatus, prtDeviceRefTable=prtDeviceRefTable, prtOutputName=prtOutputName, prtChannelType=prtChannelType, prtMarkerColorant=prtMarkerColorant, prtInterpreterGroup=prtInterpreterGroup, prtInputMediaType=prtInputMediaType, prtLocalizationCharacterSet=prtLocalizationCharacterSet)
mibBuilder.exportSymbols("Printer-MIB", prtInputIndex=prtInputIndex, prtOutputBursting=prtOutputBursting, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtAlertEntry=prtAlertEntry)
