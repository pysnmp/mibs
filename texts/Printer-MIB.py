...
PrtAlertGroupTC, PrtMediaPathTypeTC, PrtInterpreterLangFamilyTC, PrtOutputTypeTC, PrtMarkerSuppliesTypeTC, PrtAlertCodeTC, PrtAlertTrainingLevelTC, PrtConsoleColorTC, PrtConsoleDisableTC, PrtChannelTypeTC, PrtCoverStatusTC, PrtInputTypeTC, PrtGeneralResetTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertGroupTC", "PrtMediaPathTypeTC", "PrtInterpreterLangFamilyTC", "PrtOutputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtAlertCodeTC", "PrtAlertTrainingLevelTC", "PrtConsoleColorTC", "PrtConsoleDisableTC", "PrtChannelTypeTC", "PrtCoverStatusTC", "PrtInputTypeTC", "PrtGeneralResetTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarkerColorantEntry=prtMarkerColorantEntry, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMarkerColorantValue=prtMarkerColorantValue, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtOutputIndex=prtOutputIndex, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, CodedCharSet=CodedCharSet, prtInputMaxCapacity=prtInputMaxCapacity, prtMediaPathIndex=prtMediaPathIndex, prtChannelGroup=prtChannelGroup, prtOutputStatus=prtOutputStatus, prtMediaPathDescription=prtMediaPathDescription, prtDeviceRefIndex=prtDeviceRefIndex, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtInputDefaultIndex=prtInputDefaultIndex, prtMIBGroups=prtMIBGroups, prtStorageRefEntry=prtStorageRefEntry, prtGeneralReset=prtGeneralReset, prtInputSerialNumber=prtInputSerialNumber, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtChannelStatus=prtChannelStatus, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputCapacityUnit=prtOutputCapacityUnit, prtOutputModel=prtOutputModel, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtCoverDescription=prtCoverDescription, prtDeviceRefTable=prtDeviceRefTable, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerEastMargin=prtMarkerEastMargin, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtLocalizationEntry=prtLocalizationEntry, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputSecurity=prtOutputSecurity, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInputMediaWeight=prtInputMediaWeight, prtMarkerTable=prtMarkerTable, prtMediaPathType=prtMediaPathType, prtConsoleLightTable=prtConsoleLightTable, prtConsoleOnTime=prtConsoleOnTime, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerLifeCount=prtMarkerLifeCount, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtOutputDimUnit=prtOutputDimUnit, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMediaPathGroup=prtMediaPathGroup, prtInputMediaGroup=prtInputMediaGroup, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtOutputMaxCapacity=prtOutputMaxCapacity, prtOutputVersion=prtOutputVersion, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtInputTable=prtInputTable, prtCoverIndex=prtCoverIndex, prtInputMediaColor=prtInputMediaColor, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMIB2Groups=prtMIB2Groups, prtMarkerColorantGroup=prtMarkerColorantGroup, prtConsoleLocalization=prtConsoleLocalization, prtOutputDecollating=prtOutputDecollating, prtAlertCriticalEvents=prtAlertCriticalEvents, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtLocalizationTable=prtLocalizationTable, prtInterpreterDescription=prtInterpreterDescription, prtInputMediaType=prtInputMediaType, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInterpreterEntry=prtInterpreterEntry, prtConsoleLights=prtConsoleLights, prtConsoleDescription=prtConsoleDescription, printerV1Alert=printerV1Alert, prtOutputFeaturesGroup=prtOutputFeaturesGroup, printerV2AlertPrefix=printerV2AlertPrefix, prtOutputEntry=prtOutputEntry, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtInputIndex=prtInputIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtConsoleLightIndex=prtConsoleLightIndex, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtGeneralEntry=prtGeneralEntry, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtOutputGroup=prtOutputGroup, prtStorageRefIndex=prtStorageRefIndex, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtChannelIndex=prtChannelIndex, prtChannelIfIndex=prtChannelIfIndex, prtConsoleOffTime=prtConsoleOffTime, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtInputVersion=prtInputVersion, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtGeneralV2Group=prtGeneralV2Group, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInterpreterTable=prtInterpreterTable, prtLocalizationLanguage=prtLocalizationLanguage, prtAlert=prtAlert, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, PrtPrintOrientationTC=PrtPrintOrientationTC, PrtMediaUnitTC=PrtMediaUnitTC, prtInputType=prtInputType, prtInterpreterVersion=prtInterpreterVersion, prtAlertSeverityLevel=prtAlertSeverityLevel, prtAlertDescription=prtAlertDescription, prtMarkerGroup=prtMarkerGroup, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtGeneralConfigChanges=prtGeneralConfigChanges, prtConsoleGroup=prtConsoleGroup, prtMarkerEntry=prtMarkerEntry, printerV2Alert=printerV2Alert, PresentOnOff=PresentOnOff, prtInputCapacityUnit=prtInputCapacityUnit, prtOutput=prtOutput, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAlertTable=prtAlertTable, prtAlertIndex=prtAlertIndex, prtMarkerNorthMargin=prtMarkerNorthMargin, prtAlertTime=prtAlertTime, prtOutputBursting=prtOutputBursting, prtMIB2Compliance=prtMIB2Compliance, prtInputStatus=prtInputStatus, prtCoverEntry=prtCoverEntry, prtLocalization=prtLocalization, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtAlertCode=prtAlertCode, prtConsoleColor=prtConsoleColor, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMarkerStatus=prtMarkerStatus, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, printmib=printmib, prtMediaPath=prtMediaPath, PrtChannelStateTC=PrtChannelStateTC, prtInputEntry=prtInputEntry, prtStorageRefTable=prtStorageRefTable, prtGeneralTable=prtGeneralTable, prtAlertGroupIndex=prtAlertGroupIndex, prtChannelEntry=prtChannelEntry, prtMarkerIndex=prtMarkerIndex, prtInterpreterIndex=prtInterpreterIndex, prtMarkerPowerOnCount=prtMarkerPowerOnCount, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtGeneral=prtGeneral, prtMarkerColorantTable=prtMarkerColorantTable, prtGeneralPrinterName=prtGeneralPrinterName, prtInputName=prtInputName, prtMarkerWestMargin=prtMarkerWestMargin, prtOutputStackingOrder=prtOutputStackingOrder, prtChannelProtocolVersion=prtChannelProtocolVersion, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtExtendedInputGroup=prtExtendedInputGroup, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtDeviceRefEntry=prtDeviceRefEntry, prtMarkerColorant=prtMarkerColorant, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtCoverStatus=prtCoverStatus, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtMarker=prtMarker, prtOutputPageCollated=prtOutputPageCollated, prtInputDimUnit=prtInputDimUnit, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtChannelTable=prtChannelTable, prtConsoleLightEntry=prtConsoleLightEntry, prtInputModel=prtInputModel, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtCover=prtCover, prtInput=prtInput, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtInputVendorName=prtInputVendorName, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMIBConformance=prtMIBConformance, prtInterpreter=prtInterpreter, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtChannelInformation=prtChannelInformation, prtAlertTimeGroup=prtAlertTimeGroup, prtMediaPathEntry=prtMediaPathEntry, prtChannelV2Group=prtChannelV2Group, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMIBCompliance=prtMIBCompliance, prtChannelState=prtChannelState, prtAlertLocation=prtAlertLocation, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInterpreterGroup=prtInterpreterGroup, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtChannelType=prtChannelType, prtOutputType=prtOutputType, prtConsoleDisable=prtConsoleDisable, prtInputNextIndex=prtInputNextIndex, prtStorageRefSeqNumber=prtStorageRefSeqNumber, MediaUnit=MediaUnit, prtInputSwitchingGroup=prtInputSwitchingGroup, PYSNMP_MODULE_ID=printmib, prtOutputSerialNumber=prtOutputSerialNumber, prtInputSecurity=prtInputSecurity, prtMarkerColorantTonality=prtMarkerColorantTonality, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInterpreterLangVersion=prtInterpreterLangVersion, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtAlertTableV2Group=prtAlertTableV2Group, prtCoverTable=prtCoverTable, prtInputDescription=prtInputDescription, prtGeneralGroup=prtGeneralGroup, prtInterpreterLangLevel=prtInterpreterLangLevel, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtOutputVendorName=prtOutputVendorName, prtGeneralSerialNumber=prtGeneralSerialNumber, prtAlertAllEvents=prtAlertAllEvents, prtLocalizationCountry=prtLocalizationCountry, prtChannel=prtChannel, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtOutputName=prtOutputName, CapacityUnit=CapacityUnit, prtMarkerSuppliesType=prtMarkerSuppliesType, prtInputMediaName=prtInputMediaName, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMarkerSupplies=prtMarkerSupplies, prtMediaPathTable=prtMediaPathTable, prtInputGroup=prtInputGroup, PrtCapacityUnitTC=PrtCapacityUnitTC, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputDescription=prtOutputDescription, prtOutputTable=prtOutputTable, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtAlertGroup=prtAlertGroup, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtAlertEntry=prtAlertEntry, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtMediaPathStatus=prtMediaPathStatus, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, SubUnitStatus=SubUnitStatus, prtInterpreterLangFamily=prtInterpreterLangFamily, prtLocalizationIndex=prtLocalizationIndex)
mibBuilder.exportSymbols("Printer-MIB", prtAlertTableGroup=prtAlertTableGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerCounterUnit=prtMarkerCounterUnit)
