...
PrtInterpreterLangFamilyTC, PrtAlertTrainingLevelTC, PrtGeneralResetTC, PrtMarkerSuppliesTypeTC, PrtConsoleColorTC, PrtAlertGroupTC, PrtConsoleDisableTC, PrtAlertCodeTC, PrtInputTypeTC, PrtMediaPathTypeTC, PrtCoverStatusTC, PrtOutputTypeTC, PrtChannelTypeTC, PrtMarkerMarkTechTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInterpreterLangFamilyTC", "PrtAlertTrainingLevelTC", "PrtGeneralResetTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleColorTC", "PrtAlertGroupTC", "PrtConsoleDisableTC", "PrtAlertCodeTC", "PrtInputTypeTC", "PrtMediaPathTypeTC", "PrtCoverStatusTC", "PrtOutputTypeTC", "PrtChannelTypeTC", "PrtMarkerMarkTechTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtInput=prtInput, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtOutputIndex=prtOutputIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtStorageRefEntry=prtStorageRefEntry, prtGeneral=prtGeneral, prtOutputPageCollated=prtOutputPageCollated, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtGeneralGroup=prtGeneralGroup, prtGeneralReset=prtGeneralReset, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtOutputType=prtOutputType, prtChannelState=prtChannelState, prtInputEntry=prtInputEntry, PrtPrintOrientationTC=PrtPrintOrientationTC, prtConsoleOnTime=prtConsoleOnTime, prtAlertGroup=prtAlertGroup, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInterpreterVersion=prtInterpreterVersion, prtOutputName=prtOutputName, prtGeneralTable=prtGeneralTable, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, SubUnitStatus=SubUnitStatus, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtInputMediaFormParts=prtInputMediaFormParts, prtOutputStatus=prtOutputStatus, prtAlertIndex=prtAlertIndex, prtGeneralPrinterName=prtGeneralPrinterName, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMediaPathDescription=prtMediaPathDescription, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtOutputDefaultIndex=prtOutputDefaultIndex, prtConsoleDisable=prtConsoleDisable, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtAlertCode=prtAlertCode, prtLocalization=prtLocalization, printerV1Alert=printerV1Alert, prtAlertTableV2Group=prtAlertTableV2Group, prtOutputEntry=prtOutputEntry, prtInterpreterEntry=prtInterpreterEntry, prtMarkerEastMargin=prtMarkerEastMargin, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtOutputBursting=prtOutputBursting, prtLocalizationEntry=prtLocalizationEntry, prtMarkerSpotColorants=prtMarkerSpotColorants, prtMarkerCounterUnit=prtMarkerCounterUnit, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtAlertTable=prtAlertTable, prtInterpreter=prtInterpreter, prtInputGroup=prtInputGroup, prtConsoleDescription=prtConsoleDescription, prtInputMaxCapacity=prtInputMaxCapacity, prtGeneralConfigChanges=prtGeneralConfigChanges, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtDeviceRefEntry=prtDeviceRefEntry, prtInputMediaGroup=prtInputMediaGroup, prtInterpreterTable=prtInterpreterTable, prtInputName=prtInputName, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMediaPath=prtMediaPath, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtAlertAllEvents=prtAlertAllEvents, prtInputSecurity=prtInputSecurity, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtMediaPathType=prtMediaPathType, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerNorthMargin=prtMarkerNorthMargin, prtOutputStackingOrder=prtOutputStackingOrder, prtInputTable=prtInputTable, prtLocalizationTable=prtLocalizationTable, prtMIBGroups=prtMIBGroups, prtExtendedInputGroup=prtExtendedInputGroup, prtMarker=prtMarker, prtOutputDescription=prtOutputDescription, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtMIBConformance=prtMIBConformance, prtMarkerColorantGroup=prtMarkerColorantGroup, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtCoverStatus=prtCoverStatus, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtConsoleColor=prtConsoleColor, prtConsoleOffTime=prtConsoleOffTime, prtCoverTable=prtCoverTable, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtChannelType=prtChannelType, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerSuppliesType=prtMarkerSuppliesType, prtDeviceRefTable=prtDeviceRefTable, prtOutputDecollating=prtOutputDecollating, prtAlertTime=prtAlertTime, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtCoverIndex=prtCoverIndex, prtChannelV2Group=prtChannelV2Group, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtAlertTrainingLevel=prtAlertTrainingLevel, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInterpreterDescription=prtInterpreterDescription, prtOutputDimUnit=prtOutputDimUnit, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtExtendedOutputGroup=prtExtendedOutputGroup, PrtChannelStateTC=PrtChannelStateTC, prtChannelGroup=prtChannelGroup, prtOutputDimensionsGroup=prtOutputDimensionsGroup, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInterpreterIndex=prtInterpreterIndex, prtOutputCapacityUnit=prtOutputCapacityUnit, prtInterpreterLangFamily=prtInterpreterLangFamily, prtMarkerEntry=prtMarkerEntry, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtChannelInformation=prtChannelInformation, prtInterpreterGroup=prtInterpreterGroup, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMarkerPowerOnCount=prtMarkerPowerOnCount, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtMediaPathGroup=prtMediaPathGroup, prtChannelIfIndex=prtChannelIfIndex, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtAlertEntry=prtAlertEntry, prtMIBCompliance=prtMIBCompliance, prtMediaPathTable=prtMediaPathTable, prtLocalizationIndex=prtLocalizationIndex, prtConsoleLightTable=prtConsoleLightTable, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarkerColorantIndex=prtMarkerColorantIndex, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputDimUnit=prtInputDimUnit, prtAlertGroupIndex=prtAlertGroupIndex, prtMIB2Compliance=prtMIB2Compliance, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, PrtCapacityUnitTC=PrtCapacityUnitTC, prtAlertTimeGroup=prtAlertTimeGroup, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, printerV2Alert=printerV2Alert, prtInputVendorName=prtInputVendorName, prtMIB2Groups=prtMIB2Groups, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtDeviceRefIndex=prtDeviceRefIndex, prtConsoleLightEntry=prtConsoleLightEntry, prtInputIndex=prtInputIndex, prtOutput=prtOutput, prtInputDefaultIndex=prtInputDefaultIndex, prtAlert=prtAlert, prtMarkerProcessColorants=prtMarkerProcessColorants, PresentOnOff=PresentOnOff, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMediaPathStatus=prtMediaPathStatus, prtMarkerSupplies=prtMarkerSupplies, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerTable=prtMarkerTable, prtMarkerWestMargin=prtMarkerWestMargin, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtConsoleLightIndex=prtConsoleLightIndex, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtMarkerColorantTonality=prtMarkerColorantTonality, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInterpreterLangLevel=prtInterpreterLangLevel, prtCoverDescription=prtCoverDescription, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMarkerIndex=prtMarkerIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtAlertTrapGroup=prtAlertTrapGroup, prtStorageRefIndex=prtStorageRefIndex, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtGeneralV2Group=prtGeneralV2Group, prtOutputGroup=prtOutputGroup, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInputSerialNumber=prtInputSerialNumber, prtOutputSecurity=prtOutputSecurity, prtInputMediaColor=prtInputMediaColor, prtAlertTableGroup=prtAlertTableGroup, printmib=printmib, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtInputCapacityUnit=prtInputCapacityUnit, prtInputDescription=prtInputDescription, prtAlertDescription=prtAlertDescription, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAlertLocation=prtAlertLocation, prtInputType=prtInputType, prtOutputModel=prtOutputModel, prtInputModel=prtInputModel, prtMarkerMarkTech=prtMarkerMarkTech, prtInputSwitchingGroup=prtInputSwitchingGroup, prtConsoleGroup=prtConsoleGroup, prtMarkerColorantValue=prtMarkerColorantValue, prtGeneralServicePerson=prtGeneralServicePerson, prtOutputMaxCapacity=prtOutputMaxCapacity, MediaUnit=MediaUnit, prtOutputSerialNumber=prtOutputSerialNumber, prtChannelTable=prtChannelTable, prtGeneralSerialNumber=prtGeneralSerialNumber, prtMarkerStatus=prtMarkerStatus, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMediaPathEntry=prtMediaPathEntry, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtInputMediaWeight=prtInputMediaWeight, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInputNextIndex=prtInputNextIndex, prtOutputVendorName=prtOutputVendorName, prtAlertSeverityLevel=prtAlertSeverityLevel, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtChannel=prtChannel, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMediaPathIndex=prtMediaPathIndex, prtInputStatus=prtInputStatus, prtInputCurrentLevel=prtInputCurrentLevel, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtLocalizationCountry=prtLocalizationCountry, prtInputVersion=prtInputVersion, prtMarkerLifeCount=prtMarkerLifeCount, prtStorageRefTable=prtStorageRefTable, prtConsoleLights=prtConsoleLights, printerV2AlertPrefix=printerV2AlertPrefix, PYSNMP_MODULE_ID=printmib, prtLocalizationLanguage=prtLocalizationLanguage, prtConsoleLocalization=prtConsoleLocalization, prtCoverEntry=prtCoverEntry, prtOutputTable=prtOutputTable, prtChannelIndex=prtChannelIndex, prtMarkerGroup=prtMarkerGroup, prtMarkerColorantEntry=prtMarkerColorantEntry, prtInputMediaType=prtInputMediaType, prtOutputVersion=prtOutputVersion, CapacityUnit=CapacityUnit, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInputMediaName=prtInputMediaName, prtChannelEntry=prtChannelEntry, prtChannelProtocolVersion=prtChannelProtocolVersion, prtChannelStatus=prtChannelStatus, prtMarkerSouthMargin=prtMarkerSouthMargin, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, CodedCharSet=CodedCharSet, prtCover=prtCover, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout)
mibBuilder.exportSymbols("Printer-MIB", prtGeneralEntry=prtGeneralEntry, prtMarkerColorant=prtMarkerColorant, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, PrtMediaUnitTC=PrtMediaUnitTC)
