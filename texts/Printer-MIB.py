...
PrtAlertCodeTC, PrtInterpreterLangFamilyTC, PrtInputTypeTC, PrtCoverStatusTC, PrtOutputTypeTC, PrtMediaPathTypeTC, PrtAlertTrainingLevelTC, PrtConsoleDisableTC, PrtAlertGroupTC, PrtGeneralResetTC, PrtConsoleColorTC, PrtMarkerMarkTechTC, PrtChannelTypeTC, PrtMarkerSuppliesTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertCodeTC", "PrtInterpreterLangFamilyTC", "PrtInputTypeTC", "PrtCoverStatusTC", "PrtOutputTypeTC", "PrtMediaPathTypeTC", "PrtAlertTrainingLevelTC", "PrtConsoleDisableTC", "PrtAlertGroupTC", "PrtGeneralResetTC", "PrtConsoleColorTC", "PrtMarkerMarkTechTC", "PrtChannelTypeTC", "PrtMarkerSuppliesTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtAlertLocation=prtAlertLocation, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtInputMediaGroup=prtInputMediaGroup, prtOutputGroup=prtOutputGroup, prtInputDescription=prtInputDescription, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtCover=prtCover, prtInputMediaFormParts=prtInputMediaFormParts, prtMIB2Groups=prtMIB2Groups, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, CapacityUnit=CapacityUnit, prtMarkerSpotColorants=prtMarkerSpotColorants, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtInputMediaType=prtInputMediaType, prtMarkerNorthMargin=prtMarkerNorthMargin, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtOutput=prtOutput, prtMediaPathGroup=prtMediaPathGroup, prtInterpreter=prtInterpreter, prtOutputBursting=prtOutputBursting, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtStorageRefTable=prtStorageRefTable, prtInputVendorName=prtInputVendorName, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtGeneralReset=prtGeneralReset, prtMarkerIndex=prtMarkerIndex, prtOutputModel=prtOutputModel, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtGeneralGroup=prtGeneralGroup, prtMarkerWestMargin=prtMarkerWestMargin, prtAlertSeverityLevel=prtAlertSeverityLevel, printmib=printmib, prtGeneralTable=prtGeneralTable, prtCoverTable=prtCoverTable, prtCoverDescription=prtCoverDescription, prtInterpreterLangVersion=prtInterpreterLangVersion, prtAlertCode=prtAlertCode, prtStorageRefIndex=prtStorageRefIndex, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInterpreterTwoWay=prtInterpreterTwoWay, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtAlertIndex=prtAlertIndex, prtExtendedOutputGroup=prtExtendedOutputGroup, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMIBConformance=prtMIBConformance, prtMIB2Compliance=prtMIB2Compliance, prtConsoleGroup=prtConsoleGroup, prtChannelV2Group=prtChannelV2Group, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMIBGroups=prtMIBGroups, prtOutputDefaultIndex=prtOutputDefaultIndex, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtLocalizationEntry=prtLocalizationEntry, prtInputTable=prtInputTable, prtMarkerColorantRole=prtMarkerColorantRole, prtInterpreterDescription=prtInterpreterDescription, prtInterpreterGroup=prtInterpreterGroup, prtMarkerDefaultIndex=prtMarkerDefaultIndex, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputDimUnit=prtOutputDimUnit, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtAlertGroup=prtAlertGroup, prtMediaPathStatus=prtMediaPathStatus, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtLocalization=prtLocalization, prtInputDimUnit=prtInputDimUnit, prtInputMediaWeight=prtInputMediaWeight, prtAlertTrainingLevel=prtAlertTrainingLevel, prtGeneralSerialNumber=prtGeneralSerialNumber, prtOutputVersion=prtOutputVersion, prtConsoleColor=prtConsoleColor, prtLocalizationIndex=prtLocalizationIndex, printerV1Alert=printerV1Alert, prtInputGroup=prtInputGroup, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtMarkerColorantGroup=prtMarkerColorantGroup, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerColorantIndex=prtMarkerColorantIndex, prtAlertTime=prtAlertTime, PrtChannelStateTC=PrtChannelStateTC, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtAlertEntry=prtAlertEntry, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtOutputDescription=prtOutputDescription, prtCoverEntry=prtCoverEntry, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, PrtPrintOrientationTC=PrtPrintOrientationTC, prtInput=prtInput, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtMarkerTable=prtMarkerTable, prtConsoleLights=prtConsoleLights, prtOutputMaxCapacity=prtOutputMaxCapacity, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputEntry=prtOutputEntry, prtInterpreterLangLevel=prtInterpreterLangLevel, prtAlertGroupIndex=prtAlertGroupIndex, prtConsoleDisable=prtConsoleDisable, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtGeneral=prtGeneral, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, printerV2Alert=printerV2Alert, prtGeneralV2Group=prtGeneralV2Group, prtGeneralConfigChanges=prtGeneralConfigChanges, prtAlertAllEvents=prtAlertAllEvents, prtMarkerEastMargin=prtMarkerEastMargin, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtChannelEntry=prtChannelEntry, prtOutputStackingOrder=prtOutputStackingOrder, prtMediaPathTable=prtMediaPathTable, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtInputDefaultIndex=prtInputDefaultIndex, prtOutputName=prtOutputName, prtInputName=prtInputName, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtGeneralPrinterName=prtGeneralPrinterName, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtInputModel=prtInputModel, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInputNextIndex=prtInputNextIndex, prtMarkerStatus=prtMarkerStatus, prtAlertTableGroup=prtAlertTableGroup, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputOffsetStacking=prtOutputOffsetStacking, prtConsoleDescription=prtConsoleDescription, prtMarkerLifeCount=prtMarkerLifeCount, prtOutputStatus=prtOutputStatus, prtOutputSecurity=prtOutputSecurity, prtMarkerGroup=prtMarkerGroup, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtConsoleOnTime=prtConsoleOnTime, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInputMediaColor=prtInputMediaColor, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtAlertCriticalEvents=prtAlertCriticalEvents, prtConsoleLightIndex=prtConsoleLightIndex, prtExtendedInputGroup=prtExtendedInputGroup, prtInterpreterEntry=prtInterpreterEntry, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtInterpreterVersion=prtInterpreterVersion, prtInputCurrentLevel=prtInputCurrentLevel, prtMediaPath=prtMediaPath, prtMarkerCounterUnit=prtMarkerCounterUnit, printerV2AlertPrefix=printerV2AlertPrefix, prtChannelState=prtChannelState, prtMediaPathIndex=prtMediaPathIndex, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, CodedCharSet=CodedCharSet, MediaUnit=MediaUnit, prtMarkerColorantTable=prtMarkerColorantTable, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtChannel=prtChannel, prtInterpreterIndex=prtInterpreterIndex, prtInputType=prtInputType, prtInputVersion=prtInputVersion, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtGeneralEntry=prtGeneralEntry, prtCoverStatus=prtCoverStatus, prtChannelStatus=prtChannelStatus, prtInputCapacityUnit=prtInputCapacityUnit, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtGeneralServicePerson=prtGeneralServicePerson, prtMediaPathType=prtMediaPathType, prtOutputSerialNumber=prtOutputSerialNumber, prtInputIndex=prtInputIndex, prtChannelTable=prtChannelTable, prtConsoleOffTime=prtConsoleOffTime, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtChannelIndex=prtChannelIndex, prtChannelInformation=prtChannelInformation, prtOutputType=prtOutputType, prtChannelType=prtChannelType, prtConsoleLocalization=prtConsoleLocalization, prtLocalizationTable=prtLocalizationTable, prtAlertTable=prtAlertTable, prtInputSerialNumber=prtInputSerialNumber, prtMediaPathDescription=prtMediaPathDescription, prtAlert=prtAlert, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMarkerColorant=prtMarkerColorant, prtAlertTableV2Group=prtAlertTableV2Group, prtChannelGroup=prtChannelGroup, PrtCapacityUnitTC=PrtCapacityUnitTC, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtChannelProtocolVersion=prtChannelProtocolVersion, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtMarkerSupplies=prtMarkerSupplies, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarker=prtMarker, prtDeviceRefEntry=prtDeviceRefEntry, prtAlertTimeGroup=prtAlertTimeGroup, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtMIBCompliance=prtMIBCompliance, prtMarkerColorantValue=prtMarkerColorantValue, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMediaPathEntry=prtMediaPathEntry, prtAlertDescription=prtAlertDescription, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtInputEntry=prtInputEntry, prtDeviceRefTable=prtDeviceRefTable, prtConsoleLightTable=prtConsoleLightTable, prtConsoleLightEntry=prtConsoleLightEntry, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtInputSwitchingGroup=prtInputSwitchingGroup, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, SubUnitStatus=SubUnitStatus, prtMarkerColorantEntry=prtMarkerColorantEntry, PresentOnOff=PresentOnOff, prtStorageRefEntry=prtStorageRefEntry, prtOutputIndex=prtOutputIndex, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtOutputVendorName=prtOutputVendorName, prtCoverIndex=prtCoverIndex, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtOutputDecollating=prtOutputDecollating, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, PYSNMP_MODULE_ID=printmib, prtDeviceRefIndex=prtDeviceRefIndex, prtInputSecurity=prtInputSecurity, prtOutputTable=prtOutputTable, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMarkerEntry=prtMarkerEntry, prtInterpreterTable=prtInterpreterTable, prtLocalizationCountry=prtLocalizationCountry, prtInterpreterLangFamily=prtInterpreterLangFamily)
mibBuilder.exportSymbols("Printer-MIB", prtChannelIfIndex=prtChannelIfIndex, prtOutputPageCollated=prtOutputPageCollated, prtInputStatus=prtInputStatus, prtInputMediaName=prtInputMediaName)
