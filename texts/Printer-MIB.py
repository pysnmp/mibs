...
PrtAlertCodeTC, PrtChannelTypeTC, PrtOutputTypeTC, PrtGeneralResetTC, PrtMarkerMarkTechTC, PrtInterpreterLangFamilyTC, PrtCoverStatusTC, PrtConsoleDisableTC, PrtMarkerSuppliesTypeTC, PrtMediaPathTypeTC, PrtAlertGroupTC, PrtConsoleColorTC, PrtInputTypeTC, PrtAlertTrainingLevelTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtAlertCodeTC", "PrtChannelTypeTC", "PrtOutputTypeTC", "PrtGeneralResetTC", "PrtMarkerMarkTechTC", "PrtInterpreterLangFamilyTC", "PrtCoverStatusTC", "PrtConsoleDisableTC", "PrtMarkerSuppliesTypeTC", "PrtMediaPathTypeTC", "PrtAlertGroupTC", "PrtConsoleColorTC", "PrtInputTypeTC", "PrtAlertTrainingLevelTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtOutputModel=prtOutputModel, prtMarkerColorantIndex=prtMarkerColorantIndex, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtInputMaxCapacity=prtInputMaxCapacity, prtMediaPathStatus=prtMediaPathStatus, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtChannelType=prtChannelType, prtInputMediaWeight=prtInputMediaWeight, prtChannelGroup=prtChannelGroup, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtMediaPathType=prtMediaPathType, prtMarkerWestMargin=prtMarkerWestMargin, prtInterpreter=prtInterpreter, prtMIBCompliance=prtMIBCompliance, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtMIBGroups=prtMIBGroups, prtInputMediaType=prtInputMediaType, prtInputSerialNumber=prtInputSerialNumber, prtInputIndex=prtInputIndex, prtMediaPathEntry=prtMediaPathEntry, prtChannelIfIndex=prtChannelIfIndex, printerV2Alert=printerV2Alert, prtGeneralServicePerson=prtGeneralServicePerson, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtConsoleColor=prtConsoleColor, prtAlertGroup=prtAlertGroup, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, CodedCharSet=CodedCharSet, prtInterpreterLangLevel=prtInterpreterLangLevel, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputBursting=prtOutputBursting, prtMarkerColorantRole=prtMarkerColorantRole, PrtPrintOrientationTC=PrtPrintOrientationTC, prtMediaPathGroup=prtMediaPathGroup, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtGeneralConfigChanges=prtGeneralConfigChanges, prtGeneralPrinterName=prtGeneralPrinterName, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtCover=prtCover, prtOutputMaxCapacity=prtOutputMaxCapacity, prtInputTable=prtInputTable, prtConsoleLightIndex=prtConsoleLightIndex, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtCoverIndex=prtCoverIndex, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtOutputGroup=prtOutputGroup, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtGeneralGroup=prtGeneralGroup, prtInputVendorName=prtInputVendorName, prtGeneral=prtGeneral, prtLocalizationTable=prtLocalizationTable, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, PrtMediaUnitTC=PrtMediaUnitTC, prtInterpreterGroup=prtInterpreterGroup, prtConsoleLightTable=prtConsoleLightTable, prtInputModel=prtInputModel, prtConsoleLights=prtConsoleLights, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtConsoleOnTime=prtConsoleOnTime, PrtChannelStateTC=PrtChannelStateTC, prtAlertTable=prtAlertTable, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarker=prtMarker, prtAlertIndex=prtAlertIndex, prtExtendedInputGroup=prtExtendedInputGroup, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtGeneralTable=prtGeneralTable, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtMarkerLifeCount=prtMarkerLifeCount, prtConsoleGroup=prtConsoleGroup, prtGeneralV2Group=prtGeneralV2Group, prtAlertTableGroup=prtAlertTableGroup, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputMediaFormParts=prtInputMediaFormParts, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtCoverTable=prtCoverTable, prtStorageRefIndex=prtStorageRefIndex, prtAlertLocation=prtAlertLocation, prtMarkerMarkTech=prtMarkerMarkTech, prtMarkerSuppliesClass=prtMarkerSuppliesClass, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, CapacityUnit=CapacityUnit, prtInputNextIndex=prtInputNextIndex, prtMIB2Compliance=prtMIB2Compliance, prtInputCapacityUnit=prtInputCapacityUnit, prtMIBConformance=prtMIBConformance, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtChannelStatus=prtChannelStatus, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtInputSwitchingGroup=prtInputSwitchingGroup, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, printerV2AlertPrefix=printerV2AlertPrefix, prtOutputType=prtOutputType, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerColorantValue=prtMarkerColorantValue, prtAlertTableV2Group=prtAlertTableV2Group, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMarkerColorantTable=prtMarkerColorantTable, prtInputName=prtInputName, prtCoverDescription=prtCoverDescription, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtInputDescription=prtInputDescription, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtOutputDimensionsGroup=prtOutputDimensionsGroup, PresentOnOff=PresentOnOff, prtOutputPageCollated=prtOutputPageCollated, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, PrtCapacityUnitTC=PrtCapacityUnitTC, prtLocalizationEntry=prtLocalizationEntry, prtMarkerGroup=prtMarkerGroup, prtAlertSeverityLevel=prtAlertSeverityLevel, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtInterpreterDescription=prtInterpreterDescription, prtOutputSerialNumber=prtOutputSerialNumber, prtStorageRefEntry=prtStorageRefEntry, prtOutputEntry=prtOutputEntry, prtOutputDecollating=prtOutputDecollating, prtDeviceRefEntry=prtDeviceRefEntry, prtLocalizationLanguage=prtLocalizationLanguage, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAlertGroupIndex=prtAlertGroupIndex, prtMarkerStatus=prtMarkerStatus, prtMarkerColorantEntry=prtMarkerColorantEntry, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtConsoleDisable=prtConsoleDisable, prtLocalization=prtLocalization, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtCoverStatus=prtCoverStatus, prtAlertCriticalEvents=prtAlertCriticalEvents, prtLocalizationIndex=prtLocalizationIndex, prtStorageRefTable=prtStorageRefTable, prtOutputCapacityUnit=prtOutputCapacityUnit, prtMarkerEntry=prtMarkerEntry, prtGeneralEntry=prtGeneralEntry, prtMarkerCounterUnit=prtMarkerCounterUnit, prtChannelProtocolVersion=prtChannelProtocolVersion, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInterpreterVersion=prtInterpreterVersion, prtOutputSecurity=prtOutputSecurity, prtInputDimUnit=prtInputDimUnit, prtAlertTimeGroup=prtAlertTimeGroup, prtAlertAllEvents=prtAlertAllEvents, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputStatus=prtOutputStatus, prtOutputVersion=prtOutputVersion, prtAlertTime=prtAlertTime, prtAlertCode=prtAlertCode, prtInputEntry=prtInputEntry, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtConsoleOffTime=prtConsoleOffTime, prtAlertEntry=prtAlertEntry, SubUnitStatus=SubUnitStatus, prtCoverEntry=prtCoverEntry, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtOutputName=prtOutputName, prtGeneralReset=prtGeneralReset, prtInterpreterTable=prtInterpreterTable, prtInterpreterLangVersion=prtInterpreterLangVersion, prtMarkerColorantTonality=prtMarkerColorantTonality, prtInterpreterIndex=prtInterpreterIndex, prtInputMediaColor=prtInputMediaColor, prtOutputTable=prtOutputTable, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtOutput=prtOutput, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtConsoleLightEntry=prtConsoleLightEntry, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtAlertDescription=prtAlertDescription, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtChannelV2Group=prtChannelV2Group, prtMediaPathIndex=prtMediaPathIndex, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtInterpreterEntry=prtInterpreterEntry, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtDeviceRefIndex=prtDeviceRefIndex, prtChannelTable=prtChannelTable, prtMarkerSupplies=prtMarkerSupplies, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, printmib=printmib, prtOutputDescription=prtOutputDescription, prtInputDefaultIndex=prtInputDefaultIndex, prtChannelIndex=prtChannelIndex, prtMarkerIndex=prtMarkerIndex, prtAlert=prtAlert, prtAlertTrainingLevel=prtAlertTrainingLevel, prtMIB2Groups=prtMIB2Groups, printerV1Alert=printerV1Alert, prtChannel=prtChannel, prtOutputDimUnit=prtOutputDimUnit, prtInputVersion=prtInputVersion, prtMediaPathDescription=prtMediaPathDescription, prtMarkerColorantGroup=prtMarkerColorantGroup, prtChannelInformation=prtChannelInformation, prtInputGroup=prtInputGroup, prtOutputOffsetStacking=prtOutputOffsetStacking, prtOutputIndex=prtOutputIndex, prtChannelEntry=prtChannelEntry, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputSecurity=prtInputSecurity, prtMarkerColorant=prtMarkerColorant, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtConsoleLocalization=prtConsoleLocalization, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputMediaName=prtInputMediaName, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtChannelState=prtChannelState, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, MediaUnit=MediaUnit, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMediaPath=prtMediaPath, prtInputType=prtInputType, prtMarkerTable=prtMarkerTable, prtMarkerSpotColorants=prtMarkerSpotColorants, prtLocalizationCountry=prtLocalizationCountry, prtGeneralSerialNumber=prtGeneralSerialNumber, prtDeviceRefTable=prtDeviceRefTable, prtInput=prtInput, prtConsoleDescription=prtConsoleDescription, prtOutputVendorName=prtOutputVendorName, prtMediaPathTable=prtMediaPathTable, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMarkerNorthMargin=prtMarkerNorthMargin, prtInputCurrentLevel=prtInputCurrentLevel)
mibBuilder.exportSymbols("Printer-MIB", prtInputMediaGroup=prtInputMediaGroup, prtInputStatus=prtInputStatus, PYSNMP_MODULE_ID=printmib, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir)
