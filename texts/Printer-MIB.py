...
PrtInputTypeTC, PrtChannelTypeTC, PrtAlertTrainingLevelTC, PrtMarkerSuppliesTypeTC, PrtConsoleColorTC, PrtCoverStatusTC, PrtInterpreterLangFamilyTC, PrtConsoleDisableTC, PrtGeneralResetTC, PrtMediaPathTypeTC, PrtMarkerMarkTechTC, PrtAlertGroupTC, PrtAlertCodeTC, PrtOutputTypeTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtInputTypeTC", "PrtChannelTypeTC", "PrtAlertTrainingLevelTC", "PrtMarkerSuppliesTypeTC", "PrtConsoleColorTC", "PrtCoverStatusTC", "PrtInterpreterLangFamilyTC", "PrtConsoleDisableTC", "PrtGeneralResetTC", "PrtMediaPathTypeTC", "PrtMarkerMarkTechTC", "PrtAlertGroupTC", "PrtAlertCodeTC", "PrtOutputTypeTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, prtConsoleDescription=prtConsoleDescription, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtLocalizationIndex=prtLocalizationIndex, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtAlertCode=prtAlertCode, prtOutputStatus=prtOutputStatus, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtAlertAllEvents=prtAlertAllEvents, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtLocalizationTable=prtLocalizationTable, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, prtOutputMaxCapacity=prtOutputMaxCapacity, prtMediaPath=prtMediaPath, prtMediaPathTable=prtMediaPathTable, prtMIB2Compliance=prtMIB2Compliance, prtMarkerNorthMargin=prtMarkerNorthMargin, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, printerV2Alert=printerV2Alert, prtAlertLocation=prtAlertLocation, prtInputDefaultIndex=prtInputDefaultIndex, prtGeneralServicePerson=prtGeneralServicePerson, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtInputIndex=prtInputIndex, prtInputEntry=prtInputEntry, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtInputType=prtInputType, prtChannelInformation=prtChannelInformation, prtAlertDescription=prtAlertDescription, prtAlertTimeGroup=prtAlertTimeGroup, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtOutputSecurity=prtOutputSecurity, CodedCharSet=CodedCharSet, prtGeneral=prtGeneral, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtOutputStackingOrder=prtOutputStackingOrder, prtMarkerEntry=prtMarkerEntry, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtMarkerWestMargin=prtMarkerWestMargin, prtCoverDescription=prtCoverDescription, prtConsoleLights=prtConsoleLights, prtInterpreterGroup=prtInterpreterGroup, prtInputCurrentLevel=prtInputCurrentLevel, prtAlertEntry=prtAlertEntry, prtMarkerCounterUnit=prtMarkerCounterUnit, prtInputDescription=prtInputDescription, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtMarkerLifeCount=prtMarkerLifeCount, prtMarkerSouthMargin=prtMarkerSouthMargin, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtChannelTable=prtChannelTable, printmib=printmib, prtAlertCriticalEvents=prtAlertCriticalEvents, prtChannelStatus=prtChannelStatus, prtInput=prtInput, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, printerV2AlertPrefix=printerV2AlertPrefix, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtInputSecurity=prtInputSecurity, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, prtInputNextIndex=prtInputNextIndex, prtMIBConformance=prtMIBConformance, prtOutputGroup=prtOutputGroup, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtGeneralTable=prtGeneralTable, prtMediaPathIndex=prtMediaPathIndex, prtStorageRefIndex=prtStorageRefIndex, prtOutputVendorName=prtOutputVendorName, prtChannelEntry=prtChannelEntry, prtMediaPathDescription=prtMediaPathDescription, prtAlertSeverityLevel=prtAlertSeverityLevel, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtOutputName=prtOutputName, prtInputModel=prtInputModel, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerColorant=prtMarkerColorant, prtMarkerColorantIndex=prtMarkerColorantIndex, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtMIBGroups=prtMIBGroups, prtMarkerColorantGroup=prtMarkerColorantGroup, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtDeviceRefTable=prtDeviceRefTable, prtMarkerColorantTonality=prtMarkerColorantTonality, prtChannel=prtChannel, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtDeviceRefEntry=prtDeviceRefEntry, prtConsoleDisable=prtConsoleDisable, prtMarkerTable=prtMarkerTable, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtMarkerProcessColorants=prtMarkerProcessColorants, prtGeneralReset=prtGeneralReset, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, SubUnitStatus=SubUnitStatus, prtCoverIndex=prtCoverIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtConsoleColor=prtConsoleColor, prtAlertTableGroup=prtAlertTableGroup, prtOutputCapacityUnit=prtOutputCapacityUnit, prtStorageRefTable=prtStorageRefTable, prtMIBCompliance=prtMIBCompliance, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtMarkerStatus=prtMarkerStatus, prtConsoleLightEntry=prtConsoleLightEntry, prtChannelProtocolVersion=prtChannelProtocolVersion, prtInputName=prtInputName, prtOutputEntry=prtOutputEntry, printerV1Alert=printerV1Alert, prtOutputSerialNumber=prtOutputSerialNumber, prtLocalizationEntry=prtLocalizationEntry, prtMarkerColorantEntry=prtMarkerColorantEntry, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInterpreterTable=prtInterpreterTable, prtOutputType=prtOutputType, prtMarkerEastMargin=prtMarkerEastMargin, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtMediaPathGroup=prtMediaPathGroup, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInterpreterTwoWay=prtInterpreterTwoWay, prtOutput=prtOutput, prtMarkerColorantTable=prtMarkerColorantTable, prtInterpreterLangVersion=prtInterpreterLangVersion, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtOutputBursting=prtOutputBursting, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtLocalizationCountry=prtLocalizationCountry, prtOutputDescription=prtOutputDescription, prtOutputVersion=prtOutputVersion, prtOutputOffsetStacking=prtOutputOffsetStacking, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtExtendedOutputGroup=prtExtendedOutputGroup, PrtCapacityUnitTC=PrtCapacityUnitTC, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtOutputPageCollated=prtOutputPageCollated, CapacityUnit=CapacityUnit, prtConsoleOffTime=prtConsoleOffTime, prtInputVendorName=prtInputVendorName, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, prtCover=prtCover, prtStorageRefEntry=prtStorageRefEntry, prtInputMediaGroup=prtInputMediaGroup, prtMarkerSpotColorants=prtMarkerSpotColorants, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInputMediaFormParts=prtInputMediaFormParts, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtConsoleOnTime=prtConsoleOnTime, prtAlert=prtAlert, prtInterpreterLangFamily=prtInterpreterLangFamily, prtExtendedInputGroup=prtExtendedInputGroup, prtChannelGroup=prtChannelGroup, prtAlertTableV2Group=prtAlertTableV2Group, prtConsoleLocalization=prtConsoleLocalization, prtChannelState=prtChannelState, prtInputGroup=prtInputGroup, prtAlertTable=prtAlertTable, PrtSubUnitStatusTC=PrtSubUnitStatusTC, PYSNMP_MODULE_ID=printmib, prtInterpreterDescription=prtInterpreterDescription, prtMarkerColorantValue=prtMarkerColorantValue, prtOutputTable=prtOutputTable, prtGeneralEntry=prtGeneralEntry, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtGeneralPrinterName=prtGeneralPrinterName, prtInterpreterVersion=prtInterpreterVersion, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtInputDimUnit=prtInputDimUnit, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMIB2Groups=prtMIB2Groups, PresentOnOff=PresentOnOff, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtOutputDimUnit=prtOutputDimUnit, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtCoverStatus=prtCoverStatus, prtInputMediaType=prtInputMediaType, prtInterpreterEntry=prtInterpreterEntry, prtConsoleLightTable=prtConsoleLightTable, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputModel=prtOutputModel, prtInputSwitchingGroup=prtInputSwitchingGroup, prtChannelV2Group=prtChannelV2Group, prtMarkerSupplies=prtMarkerSupplies, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtInterpreterLangLevel=prtInterpreterLangLevel, prtChannelType=prtChannelType, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtMediaPathType=prtMediaPathType, prtInputMediaWeight=prtInputMediaWeight, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtInputCapacityUnit=prtInputCapacityUnit, prtInputMaxCapacity=prtInputMaxCapacity, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtGeneralV2Group=prtGeneralV2Group, prtInputMediaColor=prtInputMediaColor, prtMarkerIndex=prtMarkerIndex, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, prtInterpreter=prtInterpreter, prtAlertTrapGroup=prtAlertTrapGroup, prtMarkerMarkTech=prtMarkerMarkTech, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtInputMediaName=prtInputMediaName, prtGeneralConfigChanges=prtGeneralConfigChanges, prtLocalizationLanguage=prtLocalizationLanguage, prtAlertTrainingLevel=prtAlertTrainingLevel, prtChannelIndex=prtChannelIndex, prtInputSerialNumber=prtInputSerialNumber, prtLocalization=prtLocalization, prtMarkerSuppliesType=prtMarkerSuppliesType, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtAlertGroupIndex=prtAlertGroupIndex, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtDeviceRefIndex=prtDeviceRefIndex, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerGroup=prtMarkerGroup, prtMediaPathEntry=prtMediaPathEntry, prtMarker=prtMarker, prtInterpreterIndex=prtInterpreterIndex, prtAlertTime=prtAlertTime, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtConsoleLightIndex=prtConsoleLightIndex, prtMarkerColorantRole=prtMarkerColorantRole, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtConsoleGroup=prtConsoleGroup, MediaUnit=MediaUnit, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, prtOutputDecollating=prtOutputDecollating, prtAlertIndex=prtAlertIndex, prtCoverTable=prtCoverTable, prtInputTable=prtInputTable, prtInputVersion=prtInputVersion, prtOutputIndex=prtOutputIndex, prtMediaPathStatus=prtMediaPathStatus, prtAlertGroup=prtAlertGroup, PrtMediaUnitTC=PrtMediaUnitTC, prtOutputDefaultIndex=prtOutputDefaultIndex, prtGeneralSerialNumber=prtGeneralSerialNumber, PrtChannelStateTC=PrtChannelStateTC, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputStatus=prtInputStatus)
mibBuilder.exportSymbols("Printer-MIB", prtGeneralGroup=prtGeneralGroup, prtChannelIfIndex=prtChannelIfIndex, prtCoverEntry=prtCoverEntry, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability)
