...
PrtConsoleColorTC, PrtConsoleDisableTC, PrtGeneralResetTC, PrtChannelTypeTC, PrtCoverStatusTC, PrtInterpreterLangFamilyTC, PrtMediaPathTypeTC, PrtAlertCodeTC, PrtOutputTypeTC, PrtAlertTrainingLevelTC, PrtInputTypeTC, PrtMarkerSuppliesTypeTC, PrtMarkerMarkTechTC, PrtAlertGroupTC = mibBuilder.importSymbols("IANA-PRINTER-MIB", "PrtConsoleColorTC", "PrtConsoleDisableTC", "PrtGeneralResetTC", "PrtChannelTypeTC", "PrtCoverStatusTC", "PrtInterpreterLangFamilyTC", "PrtMediaPathTypeTC", "PrtAlertCodeTC", "PrtOutputTypeTC", "PrtAlertTrainingLevelTC", "PrtInputTypeTC", "PrtMarkerSuppliesTypeTC", "PrtMarkerMarkTechTC", "PrtAlertGroupTC")
...
mibBuilder.exportSymbols("Printer-MIB", prtGeneralTable=prtGeneralTable, prtMediaPathMaxSpeedPrintUnit=prtMediaPathMaxSpeedPrintUnit, prtOutputDefaultIndex=prtOutputDefaultIndex, prtOutputMaxDimFeedDir=prtOutputMaxDimFeedDir, prtMediaPathType=prtMediaPathType, prtAlertIndex=prtAlertIndex, prtOutputTable=prtOutputTable, prtMediaPathMediaSizeUnit=prtMediaPathMediaSizeUnit, prtAlertTrainingLevel=prtAlertTrainingLevel, prtConsoleLightEntry=prtConsoleLightEntry, prtExtendedInputGroup=prtExtendedInputGroup, prtMIB2Groups=prtMIB2Groups, prtLocalizationCountry=prtLocalizationCountry, prtConsoleColor=prtConsoleColor, prtGeneralGroup=prtGeneralGroup, prtAlertTimeGroup=prtAlertTimeGroup, prtInterpreterDefaultCharSetOut=prtInterpreterDefaultCharSetOut, prtMarkerColorant=prtMarkerColorant, PrtInterpreterTwoWayTC=PrtInterpreterTwoWayTC, prtMarkerColorantTonality=prtMarkerColorantTonality, prtChannelGroup=prtChannelGroup, prtConsoleDisplayBufferText=prtConsoleDisplayBufferText, prtDeviceRefIndex=prtDeviceRefIndex, prtMarkerSuppliesLevel=prtMarkerSuppliesLevel, prtMarkerSuppliesClass=prtMarkerSuppliesClass, prtInterpreterDefaultCharSetIn=prtInterpreterDefaultCharSetIn, printerV2Alert=printerV2Alert, printerV2AlertPrefix=printerV2AlertPrefix, prtInputVersion=prtInputVersion, prtDeviceRefTable=prtDeviceRefTable, prtOutputIndex=prtOutputIndex, prtOutputDescription=prtOutputDescription, prtInputMediaGroup=prtInputMediaGroup, prtChannelProtocolVersion=prtChannelProtocolVersion, MediaUnit=MediaUnit, prtInterpreterTable=prtInterpreterTable, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, CodedCharSet=CodedCharSet, prtLocalizationCharacterSet=prtLocalizationCharacterSet, prtConsoleOffTime=prtConsoleOffTime, prtMarkerColorantMarkerIndex=prtMarkerColorantMarkerIndex, prtMarkerStatus=prtMarkerStatus, prtOutputName=prtOutputName, PrtMarkerAddressabilityUnitTC=PrtMarkerAddressabilityUnitTC, prtInputMediaDimXFeedDirDeclared=prtInputMediaDimXFeedDirDeclared, prtOutputMinDimFeedDir=prtOutputMinDimFeedDir, prtGeneralConfigChanges=prtGeneralConfigChanges, prtMediaPathMaxMediaFeedDir=prtMediaPathMaxMediaFeedDir, prtMediaPathMinMediaFeedDir=prtMediaPathMinMediaFeedDir, prtCoverTable=prtCoverTable, PrtSubUnitStatusTC=PrtSubUnitStatusTC, prtMIB2Compliance=prtMIB2Compliance, prtAlertTrapGroup=prtAlertTrapGroup, prtAuxiliarySheetBannerPage=prtAuxiliarySheetBannerPage, prtInterpreterFeedAddressability=prtInterpreterFeedAddressability, prtMIBGroups=prtMIBGroups, prtInterpreterIndex=prtInterpreterIndex, prtConsoleLightTable=prtConsoleLightTable, prtMarkerCounterUnit=prtMarkerCounterUnit, prtAlertGroup=prtAlertGroup, PrtCapacityUnitTC=PrtCapacityUnitTC, prtOutputDecollating=prtOutputDecollating, prtOutputCapacityUnit=prtOutputCapacityUnit, PrtOutputStackingOrderTC=PrtOutputStackingOrderTC, prtInputDefaultIndex=prtInputDefaultIndex, prtConsoleDisable=prtConsoleDisable, prtInputVendorName=prtInputVendorName, prtMarkerSuppliesMarkerIndex=prtMarkerSuppliesMarkerIndex, prtMediaPathDescription=prtMediaPathDescription, prtChannelEntry=prtChannelEntry, prtCover=prtCover, prtConsoleDisplayBufferIndex=prtConsoleDisplayBufferIndex, prtConsoleDescription=prtConsoleDescription, prtAlertTableV2Group=prtAlertTableV2Group, prtInputType=prtInputType, prtOutputPageCollated=prtOutputPageCollated, prtInputIndex=prtInputIndex, prtConsoleOnTime=prtConsoleOnTime, prtMediaPathDefaultIndex=prtMediaPathDefaultIndex, prtInputMediaDimXFeedDirChosen=prtInputMediaDimXFeedDirChosen, prtOutputStatus=prtOutputStatus, prtOutputPageDeliveryOrientation=prtOutputPageDeliveryOrientation, prtMarkerSuppliesType=prtMarkerSuppliesType, prtMediaPathIndex=prtMediaPathIndex, prtConsoleLights=prtConsoleLights, prtInputMediaWeight=prtInputMediaWeight, prtStorageRefIndex=prtStorageRefIndex, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtInputMediaFormParts=prtInputMediaFormParts, PrtMarkerColorantRoleTC=PrtMarkerColorantRoleTC, prtOutputMaxCapacity=prtOutputMaxCapacity, prtChannelState=prtChannelState, prtOutputVersion=prtOutputVersion, prtAuxiliarySheetGroup=prtAuxiliarySheetGroup, prtOutputDimUnit=prtOutputDimUnit, prtAlertCriticalEvents=prtAlertCriticalEvents, prtMarker=prtMarker, prtMediaPath=prtMediaPath, prtMarkerSupplies=prtMarkerSupplies, prtExtendedOutputGroup=prtExtendedOutputGroup, prtMediaPathMaxSpeed=prtMediaPathMaxSpeed, prtInputMediaDimFeedDirDeclared=prtInputMediaDimFeedDirDeclared, prtOutputSerialNumber=prtOutputSerialNumber, prtMarkerSuppliesGroup=prtMarkerSuppliesGroup, prtOutputVendorName=prtOutputVendorName, prtInputName=prtInputName, prtInputModel=prtInputModel, prtAlertAllEvents=prtAlertAllEvents, prtCoverStatus=prtCoverStatus, prtInterpreter=prtInterpreter, prtGeneralCurrentLocalization=prtGeneralCurrentLocalization, prtChannelIfIndex=prtChannelIfIndex, prtConsoleNumberOfDisplayLines=prtConsoleNumberOfDisplayLines, prtInputMediaName=prtInputMediaName, prtLocalization=prtLocalization, prtAlertTableGroup=prtAlertTableGroup, PrtAlertSeverityLevelTC=PrtAlertSeverityLevelTC, prtOutputType=prtOutputType, prtCoverEntry=prtCoverEntry, PrtMarkerSuppliesClassTC=PrtMarkerSuppliesClassTC, prtStorageRefSeqNumber=prtStorageRefSeqNumber, prtAlertEntry=prtAlertEntry, printerV1Alert=printerV1Alert, prtOutputEntry=prtOutputEntry, PrtLocalizedDescriptionStringTC=PrtLocalizedDescriptionStringTC, prtMarkerPowerOnCount=prtMarkerPowerOnCount, prtAlertTable=prtAlertTable, prtInterpreterVersion=prtInterpreterVersion, prtInputDescription=prtInputDescription, prtChannelTable=prtChannelTable, prtInterpreterLangFamily=prtInterpreterLangFamily, prtInterpreterDescription=prtInterpreterDescription, prtAlertGroupIndex=prtAlertGroupIndex, prtCoverDescription=prtCoverDescription, prtStorageRefEntry=prtStorageRefEntry, PresentOnOff=PresentOnOff, PrtMediaPathMaxSpeedPrintUnitTC=PrtMediaPathMaxSpeedPrintUnitTC, prtGeneralEntry=prtGeneralEntry, prtInputSwitchingGroup=prtInputSwitchingGroup, prtOutput=prtOutput, prtAlertLocation=prtAlertLocation, prtMediaPathMaxMediaXFeedDir=prtMediaPathMaxMediaXFeedDir, printmib=printmib, PrtOutputPageDeliveryOrientationTC=PrtOutputPageDeliveryOrientationTC, prtInputDimUnit=prtInputDimUnit, PYSNMP_MODULE_ID=printmib, prtInterpreterDefaultOrientation=prtInterpreterDefaultOrientation, PrtPrintOrientationTC=PrtPrintOrientationTC, prtOutputSecurity=prtOutputSecurity, prtOutputGroup=prtOutputGroup, prtMediaPathGroup=prtMediaPathGroup, prtLocalizationEntry=prtLocalizationEntry, prtDeviceRefEntry=prtDeviceRefEntry, CapacityUnit=CapacityUnit, prtChannelIndex=prtChannelIndex, prtLocalizationIndex=prtLocalizationIndex, prtConsoleGroup=prtConsoleGroup, prtGeneralPrinterName=prtGeneralPrinterName, prtOutputModel=prtOutputModel, prtMarkerSuppliesMaxCapacity=prtMarkerSuppliesMaxCapacity, prtMarkerSouthMargin=prtMarkerSouthMargin, prtConsoleLocalization=prtConsoleLocalization, prtChannelInformation=prtChannelInformation, prtGeneralV2Group=prtGeneralV2Group, prtMarkerAddressabilityXFeedDir=prtMarkerAddressabilityXFeedDir, prtMediaPathStatus=prtMediaPathStatus, prtMarkerColorantIndex=prtMarkerColorantIndex, prtMarkerSuppliesSupplyUnit=prtMarkerSuppliesSupplyUnit, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtInputNextIndex=prtInputNextIndex, prtChannelType=prtChannelType, prtGeneral=prtGeneral, prtInterpreterXFeedAddressability=prtInterpreterXFeedAddressability, prtMIBCompliance=prtMIBCompliance, prtLocalizationLanguage=prtLocalizationLanguage, prtGeneralServicePerson=prtGeneralServicePerson, prtInterpreterTwoWay=prtInterpreterTwoWay, prtAuxiliarySheetStartupPage=prtAuxiliarySheetStartupPage, PrtMarkerSuppliesSupplyUnitTC=PrtMarkerSuppliesSupplyUnitTC, prtMarkerColorantValue=prtMarkerColorantValue, prtOutputOffsetStacking=prtOutputOffsetStacking, prtInputMediaColor=prtInputMediaColor, prtGeneralCurrentOperator=prtGeneralCurrentOperator, prtInputMediaDimFeedDirChosen=prtInputMediaDimFeedDirChosen, prtInputMediaType=prtInputMediaType, prtMarkerIndex=prtMarkerIndex, prtGeneralSerialNumber=prtGeneralSerialNumber, prtInputMediaLoadTimeout=prtInputMediaLoadTimeout, prtLocalizationTable=prtLocalizationTable, prtMarkerProcessColorants=prtMarkerProcessColorants, prtMarkerSpotColorants=prtMarkerSpotColorants, prtChannelCurrentJobCntlLangIndex=prtChannelCurrentJobCntlLangIndex, prtChannelDefaultPageDescLangIndex=prtChannelDefaultPageDescLangIndex, prtInputSecurity=prtInputSecurity, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtResponsiblePartyGroup=prtResponsiblePartyGroup, prtOutputDimensionsGroup=prtOutputDimensionsGroup, prtInputMaxCapacity=prtInputMaxCapacity, prtOutputFeaturesGroup=prtOutputFeaturesGroup, prtMarkerColorantEntry=prtMarkerColorantEntry, prtConsoleNumberOfDisplayChars=prtConsoleNumberOfDisplayChars, prtMarkerColorantGroup=prtMarkerColorantGroup, prtInput=prtInput, prtMarkerAddressabilityUnit=prtMarkerAddressabilityUnit, prtInterpreterEntry=prtInterpreterEntry, prtDeviceRefSeqNumber=prtDeviceRefSeqNumber, prtMarkerWestMargin=prtMarkerWestMargin, prtAlertTime=prtAlertTime, prtMIBConformance=prtMIBConformance, prtMediaPathEntry=prtMediaPathEntry, prtInputTable=prtInputTable, PrtMarkerCounterUnitTC=PrtMarkerCounterUnitTC, prtMarkerSuppliesDescription=prtMarkerSuppliesDescription, prtInputGroup=prtInputGroup, prtMarkerLifeCount=prtMarkerLifeCount, prtStorageRefTable=prtStorageRefTable, prtChannel=prtChannel, prtMarkerTable=prtMarkerTable, prtMarkerColorantTable=prtMarkerColorantTable, prtMarkerMarkTech=prtMarkerMarkTech, prtInputSerialNumber=prtInputSerialNumber, prtInterpreterLangVersion=prtInterpreterLangVersion, PrtMediaUnitTC=PrtMediaUnitTC, prtMarkerNorthMargin=prtMarkerNorthMargin, prtAlertDescription=prtAlertDescription, PrtConsoleDescriptionStringTC=PrtConsoleDescriptionStringTC, prtMarkerGroup=prtMarkerGroup, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, SubUnitStatus=SubUnitStatus, prtAlertCode=prtAlertCode, prtMarkerAddressabilityFeedDir=prtMarkerAddressabilityFeedDir, prtMarkerSuppliesColorantIndex=prtMarkerSuppliesColorantIndex, prtInterpreterLangLevel=prtInterpreterLangLevel, prtGeneralReset=prtGeneralReset, prtMarkerDefaultIndex=prtMarkerDefaultIndex, prtOutputRemainingCapacity=prtOutputRemainingCapacity, prtChannelStatus=prtChannelStatus, prtMarkerColorantRole=prtMarkerColorantRole, prtMarkerSuppliesIndex=prtMarkerSuppliesIndex, prtOutputStackingOrder=prtOutputStackingOrder, prtAlertSeverityLevel=prtAlertSeverityLevel, prtInputCurrentLevel=prtInputCurrentLevel, prtOutputMaxDimXFeedDir=prtOutputMaxDimXFeedDir, prtMarkerEntry=prtMarkerEntry, prtInputEntry=prtInputEntry, prtOutputBursting=prtOutputBursting, prtInputStatus=prtInputStatus, prtOutputMinDimXFeedDir=prtOutputMinDimXFeedDir, prtMarkerEastMargin=prtMarkerEastMargin, prtInputCapacityUnit=prtInputCapacityUnit, prtMediaPathMinMediaXFeedDir=prtMediaPathMinMediaXFeedDir, prtConsoleLightIndex=prtConsoleLightIndex, prtAlert=prtAlert, prtChannelV2Group=prtChannelV2Group)
mibBuilder.exportSymbols("Printer-MIB", prtCoverIndex=prtCoverIndex, prtInterpreterGroup=prtInterpreterGroup, prtMediaPathTable=prtMediaPathTable, PrtChannelStateTC=PrtChannelStateTC)
