...
# ASN.1 source SQUID-MIB
# Source digest sha256:13f819a05c1a402768e727113e835fde8320af34304e609c65cf220fbf3e55e0
...
if mibBuilder.loadTexts: squid.setLastUpdated('2008-12-24 02:00')
...
cacheMedianSvcTable = MibTable((1, 3, 6, 1, 4, 1, 3495, 1, 3, 2, 2), ).setMaxAccess("notaccessible")
...
cacheMedianSvcEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3495, 1, 3, 2, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "SQUID-MIB", "cacheMedianTime"))
...
cacheMedianTime = MibTableColumn((1, 3, 6, 1, 4, 1, 3495, 1, 3, 2, 2, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(ValueRangeConstraint(1, 1), ValueRangeConstraint(5, 5), ValueRangeConstraint(60, 60), ))).setMaxAccess("notaccessible")
...
cachePeerTable = MibTable((1, 3, 6, 1, 4, 1, 3495, 1, 5, 1), ).setMaxAccess("notaccessible")
...
cachePeerEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3495, 1, 5, 1, 3), ).setMaxAccess("notaccessible").setIndexNames((0, "SQUID-MIB", "cachePeerIndex"))
...
cacheClientTable = MibTable((1, 3, 6, 1, 4, 1, 3495, 1, 5, 2), ).setMaxAccess("notaccessible")
...
cacheClientEntry = MibTableRow((1, 3, 6, 1, 4, 1, 3495, 1, 5, 2, 2), ).setMaxAccess("notaccessible").setIndexNames((0, "SQUID-MIB", "cacheClientAddress"))
...
mibBuilder.exportSymbols("SQUID-MIB", CachePeerTableIndex=CachePeerTableIndex, PYSNMP_MODULE_ID=squid, ValidPort=ValidPort, cacheAdmin=cacheAdmin, cacheAttemptReleaseLckEntries=cacheAttemptReleaseLckEntries, cacheBlockingGetHostByAddr=cacheBlockingGetHostByAddr, cacheBlockingGetHostByName=cacheBlockingGetHostByName, cacheClientAddress=cacheClientAddress, cacheClientAddressType=cacheClientAddressType, cacheClientEntry=cacheClientEntry, cacheClientHTTPHitKb=cacheClientHTTPHitKb, cacheClientHttpHits=cacheClientHttpHits, cacheClientHttpKb=cacheClientHttpKb, cacheClientHttpRequests=cacheClientHttpRequests, cacheClientIcpHitKb=cacheClientIcpHitKb, cacheClientIcpHits=cacheClientIcpHits, cacheClientIcpKb=cacheClientIcpKb, cacheClientIcpRequests=cacheClientIcpRequests, cacheClientTable=cacheClientTable, cacheClients=cacheClients, cacheConfig=cacheConfig, cacheCpuTime=cacheCpuTime, cacheCpuUsage=cacheCpuUsage, cacheCurrentFileDescrCnt=cacheCurrentFileDescrCnt, cacheCurrentFileDescrMax=cacheCurrentFileDescrMax, cacheCurrentLRUExpiration=cacheCurrentLRUExpiration, cacheCurrentResFileDescrCnt=cacheCurrentResFileDescrCnt, cacheCurrentSwapSize=cacheCurrentSwapSize, cacheCurrentUnlinkRequests=cacheCurrentUnlinkRequests, cacheCurrentUnusedFDescrCnt=cacheCurrentUnusedFDescrCnt, cacheDns=cacheDns, cacheDnsNumberServers=cacheDnsNumberServers, cacheDnsReplies=cacheDnsReplies, cacheDnsRequests=cacheDnsRequests, cacheDnsSvcTime=cacheDnsSvcTime, cacheFqdnCache=cacheFqdnCache, cacheFqdnEntries=cacheFqdnEntries, cacheFqdnHits=cacheFqdnHits, cacheFqdnMisses=cacheFqdnMisses, cacheFqdnNegativeHits=cacheFqdnNegativeHits, cacheFqdnPendingHits=cacheFqdnPendingHits, cacheFqdnRequests=cacheFqdnRequests, cacheHttpAllSvcTime=cacheHttpAllSvcTime, cacheHttpErrors=cacheHttpErrors, cacheHttpHitSvcTime=cacheHttpHitSvcTime, cacheHttpHits=cacheHttpHits, cacheHttpInKb=cacheHttpInKb, cacheHttpMissSvcTime=cacheHttpMissSvcTime, cacheHttpNhSvcTime=cacheHttpNhSvcTime, cacheHttpNmSvcTime=cacheHttpNmSvcTime, cacheHttpOutKb=cacheHttpOutKb, cacheIcpKbRecv=cacheIcpKbRecv, cacheIcpKbSent=cacheIcpKbSent, cacheIcpPktsRecv=cacheIcpPktsRecv, cacheIcpPktsSent=cacheIcpPktsSent, cacheIcpQuerySvcTime=cacheIcpQuerySvcTime, cacheIcpReplySvcTime=cacheIcpReplySvcTime, cacheIpCache=cacheIpCache, cacheIpEntries=cacheIpEntries, cacheIpHits=cacheIpHits, cacheIpMisses=cacheIpMisses, cacheIpNegativeHits=cacheIpNegativeHits, cacheIpPendingHits=cacheIpPendingHits, cacheIpRequests=cacheIpRequests, cacheLoggingFacility=cacheLoggingFacility, cacheMaxResSize=cacheMaxResSize, cacheMedianSvcEntry=cacheMedianSvcEntry, cacheMedianSvcTable=cacheMedianSvcTable, cacheMedianTime=cacheMedianTime, cacheMemMaxSize=cacheMemMaxSize, cacheMemUsage=cacheMemUsage, cacheMesh=cacheMesh, cacheNetwork=cacheNetwork, cacheNumObjCount=cacheNumObjCount, cachePeerAddress=cachePeerAddress, cachePeerAddressType=cachePeerAddressType, cachePeerEntry=cachePeerEntry, cachePeerFetches=cachePeerFetches, cachePeerIgnored=cachePeerIgnored, cachePeerIndex=cachePeerIndex, cachePeerKeepAlRecv=cachePeerKeepAlRecv, cachePeerKeepAlSent=cachePeerKeepAlSent, cachePeerName=cachePeerName, cachePeerPingsAcked=cachePeerPingsAcked, cachePeerPingsSent=cachePeerPingsSent, cachePeerPortHttp=cachePeerPortHttp, cachePeerPortIcp=cachePeerPortIcp, cachePeerRtt=cachePeerRtt, cachePeerState=cachePeerState, cachePeerTable=cachePeerTable, cachePeerType=cachePeerType, cachePerf=cachePerf, cacheProtoAggregateStats=cacheProtoAggregateStats, cacheProtoClientHttpRequests=cacheProtoClientHttpRequests, cacheProtoStats=cacheProtoStats, cacheRequestByteRatio=cacheRequestByteRatio, cacheRequestHitRatio=cacheRequestHitRatio, cacheServerErrors=cacheServerErrors, cacheServerInKb=cacheServerInKb, cacheServerOutKb=cacheServerOutKb, cacheServerRequests=cacheServerRequests, cacheSoftware=cacheSoftware, cacheStorageConfig=cacheStorageConfig, cacheSwapHighWM=cacheSwapHighWM, cacheSwapLowWM=cacheSwapLowWM, cacheSwapMaxSize=cacheSwapMaxSize, cacheSysNumReads=cacheSysNumReads, cacheSysPageFaults=cacheSysPageFaults, cacheSysPerf=cacheSysPerf, cacheSysStorage=cacheSysStorage, cacheSysVMsize=cacheSysVMsize, cacheSystem=cacheSystem, cacheUniqName=cacheUniqName, cacheUptime=cacheUptime, cacheVersionId=cacheVersionId, nlanr=nlanr, squid=squid)
