...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:35:49 2022
...
mibBuilder.exportSymbols("SQUID-MIB", cachePeerState=cachePeerState, cacheServerErrors=cacheServerErrors, cachePeerFetches=cachePeerFetches, cacheUptime=cacheUptime, ValidPort=ValidPort, cacheHttpErrors=cacheHttpErrors, cacheAdmin=cacheAdmin, cacheDnsRequests=cacheDnsRequests, cachePeerAddressType=cachePeerAddressType, cacheSysPerf=cacheSysPerf, cacheProtoAggregateStats=cacheProtoAggregateStats, cacheProtoClientHttpRequests=cacheProtoClientHttpRequests, cacheHttpHits=cacheHttpHits, cacheBlockingGetHostByName=cacheBlockingGetHostByName, cacheFqdnHits=cacheFqdnHits, cachePeerEntry=cachePeerEntry, cacheNetwork=cacheNetwork, squid=squid, cachePeerPortHttp=cachePeerPortHttp, cacheUniqName=cacheUniqName, cacheCurrentUnlinkRequests=cacheCurrentUnlinkRequests, cacheHttpMissSvcTime=cacheHttpMissSvcTime, cacheHttpNhSvcTime=cacheHttpNhSvcTime, cacheCurrentLRUExpiration=cacheCurrentLRUExpiration, cachePeerAddress=cachePeerAddress, cacheIpMisses=cacheIpMisses, cacheDns=cacheDns, cacheStorageConfig=cacheStorageConfig, nlanr=nlanr, cacheClientHttpHits=cacheClientHttpHits, cachePeerIndex=cachePeerIndex, cachePerf=cachePerf, cacheIpRequests=cacheIpRequests, cacheNumObjCount=cacheNumObjCount, PYSNMP_MODULE_ID=squid, cachePeerPingsAcked=cachePeerPingsAcked, cacheClientEntry=cacheClientEntry, cachePeerKeepAlSent=cachePeerKeepAlSent, cacheMaxResSize=cacheMaxResSize, cacheHttpHitSvcTime=cacheHttpHitSvcTime, cacheCpuTime=cacheCpuTime, cacheBlockingGetHostByAddr=cacheBlockingGetHostByAddr, cacheClientHTTPHitKb=cacheClientHTTPHitKb, cacheIpPendingHits=cacheIpPendingHits, cacheFqdnRequests=cacheFqdnRequests, cacheHttpOutKb=cacheHttpOutKb, cacheMemUsage=cacheMemUsage, cacheCpuUsage=cacheCpuUsage, cacheClientIcpRequests=cacheClientIcpRequests, cachePeerPortIcp=cachePeerPortIcp, cachePeerPingsSent=cachePeerPingsSent, cacheClientTable=cacheClientTable, cacheVersionId=cacheVersionId, cacheIcpKbRecv=cacheIcpKbRecv, cacheSysStorage=cacheSysStorage, cacheCurrentUnusedFDescrCnt=cacheCurrentUnusedFDescrCnt, cacheMedianTime=cacheMedianTime, cacheHttpInKb=cacheHttpInKb, cacheIcpQuerySvcTime=cacheIcpQuerySvcTime, cacheClientIcpKb=cacheClientIcpKb, cacheIpHits=cacheIpHits, cacheMedianSvcTable=cacheMedianSvcTable, cachePeerTable=cachePeerTable, cacheMesh=cacheMesh, cacheIcpPktsSent=cacheIcpPktsSent, cachePeerType=cachePeerType, cachePeerKeepAlRecv=cachePeerKeepAlRecv, cacheLoggingFacility=cacheLoggingFacility, cacheCurrentSwapSize=cacheCurrentSwapSize, cacheClientIcpHitKb=cacheClientIcpHitKb, cacheFqdnPendingHits=cacheFqdnPendingHits, cachePeerRtt=cachePeerRtt, cacheIpEntries=cacheIpEntries, cacheClientAddress=cacheClientAddress, cacheIcpKbSent=cacheIcpKbSent, cacheSwapMaxSize=cacheSwapMaxSize, cacheClientHttpKb=cacheClientHttpKb, cachePeerIgnored=cachePeerIgnored, cacheServerOutKb=cacheServerOutKb, cacheSysNumReads=cacheSysNumReads, cacheMemMaxSize=cacheMemMaxSize, cacheIcpReplySvcTime=cacheIcpReplySvcTime, cacheServerInKb=cacheServerInKb, cacheFqdnNegativeHits=cacheFqdnNegativeHits, cacheHttpAllSvcTime=cacheHttpAllSvcTime, cacheMedianSvcEntry=cacheMedianSvcEntry, cacheIpCache=cacheIpCache, cacheAttemptReleaseLckEntries=cacheAttemptReleaseLckEntries, cacheClientIcpHits=cacheClientIcpHits, cacheDnsReplies=cacheDnsReplies, cacheCurrentFileDescrMax=cacheCurrentFileDescrMax, cacheFqdnEntries=cacheFqdnEntries, cacheHttpNmSvcTime=cacheHttpNmSvcTime, cacheRequestHitRatio=cacheRequestHitRatio, cacheIcpPktsRecv=cacheIcpPktsRecv, cacheRequestByteRatio=cacheRequestByteRatio, cacheSystem=cacheSystem, cacheIpNegativeHits=cacheIpNegativeHits, cacheFqdnCache=cacheFqdnCache, cacheSysPageFaults=cacheSysPageFaults, cacheSoftware=cacheSoftware, cachePeerName=cachePeerName, cacheProtoStats=cacheProtoStats, cacheClients=cacheClients, cacheDnsSvcTime=cacheDnsSvcTime, cacheCurrentResFileDescrCnt=cacheCurrentResFileDescrCnt, cacheServerRequests=cacheServerRequests, CachePeerTableIndex=CachePeerTableIndex, cacheDnsNumberServers=cacheDnsNumberServers, cacheSysVMsize=cacheSysVMsize, cacheSwapHighWM=cacheSwapHighWM, cacheCurrentFileDescrCnt=cacheCurrentFileDescrCnt, cacheConfig=cacheConfig, cacheSwapLowWM=cacheSwapLowWM, cacheClientHttpRequests=cacheClientHttpRequests, cacheClientAddressType=cacheClientAddressType, cacheFqdnMisses=cacheFqdnMisses)
