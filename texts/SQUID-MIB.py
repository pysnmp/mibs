...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:58:56 2023
...
mibBuilder.exportSymbols("SQUID-MIB", cacheHttpHits=cacheHttpHits, cacheDnsRequests=cacheDnsRequests, cacheHttpInKb=cacheHttpInKb, squid=squid, cacheServerOutKb=cacheServerOutKb, cacheHttpMissSvcTime=cacheHttpMissSvcTime, cachePeerAddressType=cachePeerAddressType, cacheSoftware=cacheSoftware, cacheMemMaxSize=cacheMemMaxSize, cacheDnsNumberServers=cacheDnsNumberServers, cacheClientHttpRequests=cacheClientHttpRequests, cachePerf=cachePerf, ValidPort=ValidPort, cachePeerKeepAlRecv=cachePeerKeepAlRecv, cacheCurrentSwapSize=cacheCurrentSwapSize, cacheFqdnCache=cacheFqdnCache, cacheCurrentLRUExpiration=cacheCurrentLRUExpiration, cacheUniqName=cacheUniqName, cacheCpuTime=cacheCpuTime, cacheHttpNhSvcTime=cacheHttpNhSvcTime, cachePeerPingsAcked=cachePeerPingsAcked, cacheIcpKbSent=cacheIcpKbSent, cachePeerPortHttp=cachePeerPortHttp, cacheClientAddress=cacheClientAddress, cacheClientIcpKb=cacheClientIcpKb, cacheMaxResSize=cacheMaxResSize, cacheMedianTime=cacheMedianTime, cacheIpMisses=cacheIpMisses, cacheIpHits=cacheIpHits, CachePeerTableIndex=CachePeerTableIndex, cacheClientHttpKb=cacheClientHttpKb, cacheHttpErrors=cacheHttpErrors, cachePeerKeepAlSent=cachePeerKeepAlSent, cacheIcpPktsRecv=cacheIcpPktsRecv, cacheCurrentUnusedFDescrCnt=cacheCurrentUnusedFDescrCnt, cacheHttpAllSvcTime=cacheHttpAllSvcTime, cacheIcpQuerySvcTime=cacheIcpQuerySvcTime, cacheFqdnMisses=cacheFqdnMisses, cachePeerPingsSent=cachePeerPingsSent, cacheRequestHitRatio=cacheRequestHitRatio, cacheIpEntries=cacheIpEntries, cacheServerErrors=cacheServerErrors, cacheVersionId=cacheVersionId, cacheClientHTTPHitKb=cacheClientHTTPHitKb, cacheCurrentUnlinkRequests=cacheCurrentUnlinkRequests, cacheSysNumReads=cacheSysNumReads, cacheIcpReplySvcTime=cacheIcpReplySvcTime, cacheSysStorage=cacheSysStorage, cacheUptime=cacheUptime, cacheMemUsage=cacheMemUsage, cacheClients=cacheClients, cacheSysPerf=cacheSysPerf, cacheCpuUsage=cacheCpuUsage, cacheClientHttpHits=cacheClientHttpHits, cacheAttemptReleaseLckEntries=cacheAttemptReleaseLckEntries, cachePeerEntry=cachePeerEntry, cacheLoggingFacility=cacheLoggingFacility, cacheCurrentFileDescrMax=cacheCurrentFileDescrMax, cacheServerInKb=cacheServerInKb, cacheSwapHighWM=cacheSwapHighWM, cacheCurrentResFileDescrCnt=cacheCurrentResFileDescrCnt, cacheIcpKbRecv=cacheIcpKbRecv, cachePeerRtt=cachePeerRtt, cacheHttpNmSvcTime=cacheHttpNmSvcTime, cacheMesh=cacheMesh, cacheNumObjCount=cacheNumObjCount, cacheSysPageFaults=cacheSysPageFaults, cacheFqdnEntries=cacheFqdnEntries, cacheHttpHitSvcTime=cacheHttpHitSvcTime, cachePeerState=cachePeerState, PYSNMP_MODULE_ID=squid, cacheProtoAggregateStats=cacheProtoAggregateStats, cacheAdmin=cacheAdmin, cachePeerIgnored=cachePeerIgnored, cachePeerName=cachePeerName, cacheDns=cacheDns, cacheMedianSvcTable=cacheMedianSvcTable, cachePeerTable=cachePeerTable, cacheProtoClientHttpRequests=cacheProtoClientHttpRequests, cacheIpNegativeHits=cacheIpNegativeHits, cacheConfig=cacheConfig, cacheSystem=cacheSystem, cachePeerPortIcp=cachePeerPortIcp, cacheRequestByteRatio=cacheRequestByteRatio, cacheBlockingGetHostByName=cacheBlockingGetHostByName, cacheClientAddressType=cacheClientAddressType, cacheProtoStats=cacheProtoStats, cachePeerIndex=cachePeerIndex, cacheClientIcpHitKb=cacheClientIcpHitKb, cacheFqdnRequests=cacheFqdnRequests, cacheIpPendingHits=cacheIpPendingHits, cacheClientIcpHits=cacheClientIcpHits, cacheCurrentFileDescrCnt=cacheCurrentFileDescrCnt, cacheSwapMaxSize=cacheSwapMaxSize, cachePeerFetches=cachePeerFetches, cacheClientEntry=cacheClientEntry, cacheClientTable=cacheClientTable, nlanr=nlanr, cacheNetwork=cacheNetwork, cacheIpRequests=cacheIpRequests, cacheSysVMsize=cacheSysVMsize, cacheFqdnPendingHits=cacheFqdnPendingHits, cacheFqdnHits=cacheFqdnHits, cachePeerAddress=cachePeerAddress, cachePeerType=cachePeerType, cacheStorageConfig=cacheStorageConfig, cacheMedianSvcEntry=cacheMedianSvcEntry, cacheSwapLowWM=cacheSwapLowWM, cacheFqdnNegativeHits=cacheFqdnNegativeHits, cacheDnsReplies=cacheDnsReplies, cacheServerRequests=cacheServerRequests, cacheDnsSvcTime=cacheDnsSvcTime, cacheHttpOutKb=cacheHttpOutKb, cacheIcpPktsSent=cacheIcpPktsSent, cacheBlockingGetHostByAddr=cacheBlockingGetHostByAddr, cacheClientIcpRequests=cacheClientIcpRequests, cacheIpCache=cacheIpCache)
