...
# Produced by pysmi-1.1.8 at Fri Jan 13 12:15:47 2023
...
ModuleIdentity, Unsigned32, Bits, IpAddress, Integer32, Gauge32, ObjectIdentity, NotificationType, enterprises, Counter64, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Bits", "IpAddress", "Integer32", "Gauge32", "ObjectIdentity", "NotificationType", "enterprises", "Counter64", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("WTI-MPC-MIB", environmentUnitCurrentC=environmentUnitCurrentC, plugName=plugName, userAux1Access=userAux1Access, overCurrentInitialClearTrap=overCurrentInitialClearTrap, environmentUnitVoltageA=environmentUnitVoltageA, overTemperatureCriticalClearTrap=overTemperatureCriticalClearTrap, environmentUnitVoltageD=environmentUnitVoltageD, lockoutClearTrap=lockoutClearTrap, wtiTraps=wtiTraps, environmentSystemTotalCurrent=environmentSystemTotalCurrent, userWebAccess=userWebAccess, plugID=plugID, environmentUnitPowerA=environmentUnitPowerA, circuitBreakerOpenClearTrap=circuitBreakerOpenClearTrap, overCurrentInitialSetTrap=overCurrentInitialSetTrap, overCurrentCriticalSetTrap=overCurrentCriticalSetTrap, lostVoltageClearTrap=lostVoltageClearTrap, overCurrentInitialTraps=overCurrentInitialTraps, plugGroupIndex=plugGroupIndex, userAccessLevel=userAccessLevel, environmentBranchCTotalCurrent=environmentBranchCTotalCurrent, userEntry=userEntry, environmentUnitName=environmentUnitName, userName=userName, environmentUnitPowerC=environmentUnitPowerC, environmentUnitPowerB=environmentUnitPowerB, plugAction=plugAction, environmentBranchDTotalPower=environmentBranchDTotalPower, plugGroupEntry=plugGroupEntry, userAux2Access=userAux2Access, userLocalAccess=userLocalAccess, environmentUnitTemperature=environmentUnitTemperature, testTrap=testTrap, userIndex=userIndex, userSerialAccess=userSerialAccess, environmentUnitCurrentD=environmentUnitCurrentD, environmentMonthlyPowerLog=environmentMonthlyPowerLog, overTemperatureInitialClearTrap=overTemperatureInitialClearTrap, lostCommSetTrap=lostCommSetTrap, lostCommClearTrap=lostCommClearTrap, environmentUnitEntry=environmentUnitEntry, environmentUnitPowerD=environmentUnitPowerD, testTraps=testTraps, environmentUnitTable=environmentUnitTable, pingNoAnswerClearTrap=pingNoAnswerClearTrap, plugGroupName=plugGroupName, overTemperatureInitialTraps=overTemperatureInitialTraps, pingNoAnswerTraps=pingNoAnswerTraps, environmentBranchBTotalPower=environmentBranchBTotalPower, environmentUnitVoltageB=environmentUnitVoltageB, environmentUnitVoltageC=environmentUnitVoltageC, PYSNMP_MODULE_ID=wti, userSubmit=userSubmit, userGroupAccess=userGroupAccess, westernTelematic=westernTelematic, environmentBranchCTotalPower=environmentBranchCTotalPower, lockoutTraps=lockoutTraps, environmentUnitCurrentB=environmentUnitCurrentB, userPortAccess=userPortAccess, userCurrentPowerMetering=userCurrentPowerMetering, lostCommTraps=lostCommTraps, wti=wti, userPasswd=userPasswd, overTemperatureCriticalTraps=overTemperatureCriticalTraps, overCurrentCriticalClearTrap=overCurrentCriticalClearTrap, environmentSystemTotalPower=environmentSystemTotalPower, environmentUnitCurrentA=environmentUnitCurrentA, userTelnetSshAccess=userTelnetSshAccess, userAux3Access=userAux3Access, overTemperatureInitialSetTrap=overTemperatureInitialSetTrap, overTemperatureCriticalSetTrap=overTemperatureCriticalSetTrap, userCallbackNum=userCallbackNum, environmentUnitIndex=environmentUnitIndex, overCurrentCriticalTraps=overCurrentCriticalTraps, circuitBreakerOpenTraps=circuitBreakerOpenTraps, plugEntry=plugEntry, userTable=userTable, environmentBranchATotalCurrent=environmentBranchATotalCurrent, powercycleTraps=powercycleTraps, plugIndex=plugIndex, environmentBranchDTotalCurrent=environmentBranchDTotalCurrent, powercycleSetTrap=powercycleSetTrap, pingNoAnswerSetTrap=pingNoAnswerSetTrap, environmentTables=environmentTables, environmentBranchATotalPower=environmentBranchATotalPower, lostVoltageSetTrap=lostVoltageSetTrap, trapInfo=trapInfo, plugStatus=plugStatus, environmentBranchBTotalCurrent=environmentBranchBTotalCurrent, lockoutSetTrap=lockoutSetTrap, plugGroupTable=plugGroupTable, plugGroupAction=plugGroupAction, systemTables=systemTables, lostVoltageTraps=lostVoltageTraps, circuitBreakerOpenSetTrap=circuitBreakerOpenSetTrap, plugTable=plugTable)
