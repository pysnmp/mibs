...
Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, NotificationType, Counter64, Bits, TimeTicks, Gauge32, MibIdentifier, iso, enterprises, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "NotificationType", "Counter64", "Bits", "TimeTicks", "Gauge32", "MibIdentifier", "iso", "enterprises", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("WTI-MPC-MIB", userPortAccess=userPortAccess, plugIndex=plugIndex, userPasswd=userPasswd, userTable=userTable, overTemperatureInitialTraps=overTemperatureInitialTraps, environmentBranchCTotalCurrent=environmentBranchCTotalCurrent, userAux2Access=userAux2Access, environmentUnitIndex=environmentUnitIndex, pingNoAnswerTraps=pingNoAnswerTraps, userCallbackNum=userCallbackNum, environmentBranchATotalPower=environmentBranchATotalPower, trapInfo=trapInfo, environmentUnitName=environmentUnitName, environmentTables=environmentTables, environmentSystemTotalCurrent=environmentSystemTotalCurrent, environmentMonthlyPowerLog=environmentMonthlyPowerLog, testTraps=testTraps, lockoutClearTrap=lockoutClearTrap, circuitBreakerOpenTraps=circuitBreakerOpenTraps, plugEntry=plugEntry, westernTelematic=westernTelematic, overTemperatureCriticalClearTrap=overTemperatureCriticalClearTrap, environmentBranchBTotalCurrent=environmentBranchBTotalCurrent, lostCommSetTrap=lostCommSetTrap, environmentBranchCTotalPower=environmentBranchCTotalPower, userSubmit=userSubmit, plugGroupIndex=plugGroupIndex, userEntry=userEntry, environmentBranchDTotalCurrent=environmentBranchDTotalCurrent, userIndex=userIndex, plugGroupTable=plugGroupTable, overTemperatureCriticalTraps=overTemperatureCriticalTraps, testTrap=testTrap, environmentUnitPowerA=environmentUnitPowerA, overCurrentInitialTraps=overCurrentInitialTraps, environmentUnitVoltageB=environmentUnitVoltageB, overCurrentInitialSetTrap=overCurrentInitialSetTrap, environmentUnitCurrentB=environmentUnitCurrentB, userAux1Access=userAux1Access, circuitBreakerOpenClearTrap=circuitBreakerOpenClearTrap, pingNoAnswerSetTrap=pingNoAnswerSetTrap, userAccessLevel=userAccessLevel, pingNoAnswerClearTrap=pingNoAnswerClearTrap, environmentUnitVoltageD=environmentUnitVoltageD, environmentBranchDTotalPower=environmentBranchDTotalPower, userGroupAccess=userGroupAccess, lostVoltageTraps=lostVoltageTraps, userWebAccess=userWebAccess, environmentUnitCurrentD=environmentUnitCurrentD, overTemperatureInitialClearTrap=overTemperatureInitialClearTrap, plugAction=plugAction, userAux3Access=userAux3Access, lostCommTraps=lostCommTraps, plugGroupEntry=plugGroupEntry, overCurrentInitialClearTrap=overCurrentInitialClearTrap, environmentUnitPowerB=environmentUnitPowerB, systemTables=systemTables, powercycleTraps=powercycleTraps, overTemperatureInitialSetTrap=overTemperatureInitialSetTrap, overTemperatureCriticalSetTrap=overTemperatureCriticalSetTrap, environmentBranchATotalCurrent=environmentBranchATotalCurrent, environmentUnitEntry=environmentUnitEntry, PYSNMP_MODULE_ID=wti, userCurrentPowerMetering=userCurrentPowerMetering, environmentUnitCurrentC=environmentUnitCurrentC, plugName=plugName, plugStatus=plugStatus, lockoutSetTrap=lockoutSetTrap, environmentUnitVoltageA=environmentUnitVoltageA, environmentBranchBTotalPower=environmentBranchBTotalPower, circuitBreakerOpenSetTrap=circuitBreakerOpenSetTrap, wtiTraps=wtiTraps, plugGroupName=plugGroupName, plugGroupAction=plugGroupAction, userSerialAccess=userSerialAccess, lostVoltageClearTrap=lostVoltageClearTrap, environmentUnitTable=environmentUnitTable, lockoutTraps=lockoutTraps, plugTable=plugTable, userName=userName, environmentUnitCurrentA=environmentUnitCurrentA, environmentSystemTotalPower=environmentSystemTotalPower, overCurrentCriticalTraps=overCurrentCriticalTraps, plugID=plugID, environmentUnitPowerC=environmentUnitPowerC, wti=wti, overCurrentCriticalClearTrap=overCurrentCriticalClearTrap, lostCommClearTrap=lostCommClearTrap, lostVoltageSetTrap=lostVoltageSetTrap, powercycleSetTrap=powercycleSetTrap, environmentUnitTemperature=environmentUnitTemperature, environmentUnitVoltageC=environmentUnitVoltageC, userTelnetSshAccess=userTelnetSshAccess, overCurrentCriticalSetTrap=overCurrentCriticalSetTrap, userLocalAccess=userLocalAccess, environmentUnitPowerD=environmentUnitPowerD)
