...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:24:40 2022
...
Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, MibIdentifier, Unsigned32, NotificationType, Bits, ObjectIdentity, IpAddress, iso, ModuleIdentity, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "MibIdentifier", "Unsigned32", "NotificationType", "Bits", "ObjectIdentity", "IpAddress", "iso", "ModuleIdentity", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("WTI-MPC-MIB", plugGroupAction=plugGroupAction, overTemperatureCriticalSetTrap=overTemperatureCriticalSetTrap, environmentBranchDTotalCurrent=environmentBranchDTotalCurrent, environmentUnitVoltageD=environmentUnitVoltageD, overTemperatureInitialTraps=overTemperatureInitialTraps, lostVoltageClearTrap=lostVoltageClearTrap, powercycleSetTrap=powercycleSetTrap, environmentUnitCurrentB=environmentUnitCurrentB, environmentUnitPowerC=environmentUnitPowerC, plugID=plugID, userPasswd=userPasswd, overTemperatureInitialSetTrap=overTemperatureInitialSetTrap, environmentUnitName=environmentUnitName, userSubmit=userSubmit, environmentBranchBTotalPower=environmentBranchBTotalPower, userAux3Access=userAux3Access, userName=userName, environmentBranchBTotalCurrent=environmentBranchBTotalCurrent, overTemperatureInitialClearTrap=overTemperatureInitialClearTrap, userGroupAccess=userGroupAccess, userTable=userTable, environmentUnitPowerD=environmentUnitPowerD, userIndex=userIndex, westernTelematic=westernTelematic, circuitBreakerOpenSetTrap=circuitBreakerOpenSetTrap, environmentUnitTable=environmentUnitTable, environmentSystemTotalPower=environmentSystemTotalPower, userWebAccess=userWebAccess, environmentUnitCurrentA=environmentUnitCurrentA, testTraps=testTraps, lockoutTraps=lockoutTraps, overTemperatureCriticalClearTrap=overTemperatureCriticalClearTrap, environmentTables=environmentTables, overCurrentCriticalClearTrap=overCurrentCriticalClearTrap, trapInfo=trapInfo, plugGroupName=plugGroupName, plugIndex=plugIndex, environmentUnitPowerB=environmentUnitPowerB, lostCommSetTrap=lostCommSetTrap, environmentUnitPowerA=environmentUnitPowerA, wti=wti, userAux2Access=userAux2Access, userLocalAccess=userLocalAccess, lostCommTraps=lostCommTraps, environmentUnitEntry=environmentUnitEntry, lostCommClearTrap=lostCommClearTrap, lostVoltageSetTrap=lostVoltageSetTrap, environmentUnitIndex=environmentUnitIndex, circuitBreakerOpenClearTrap=circuitBreakerOpenClearTrap, userPortAccess=userPortAccess, plugStatus=plugStatus, userTelnetSshAccess=userTelnetSshAccess, lockoutClearTrap=lockoutClearTrap, environmentBranchCTotalPower=environmentBranchCTotalPower, overCurrentInitialClearTrap=overCurrentInitialClearTrap, environmentBranchATotalCurrent=environmentBranchATotalCurrent, pingNoAnswerSetTrap=pingNoAnswerSetTrap, plugName=plugName, userCallbackNum=userCallbackNum, overCurrentInitialSetTrap=overCurrentInitialSetTrap, overCurrentCriticalTraps=overCurrentCriticalTraps, environmentSystemTotalCurrent=environmentSystemTotalCurrent, overCurrentCriticalSetTrap=overCurrentCriticalSetTrap, environmentUnitVoltageC=environmentUnitVoltageC, plugGroupTable=plugGroupTable, pingNoAnswerTraps=pingNoAnswerTraps, environmentBranchCTotalCurrent=environmentBranchCTotalCurrent, userAccessLevel=userAccessLevel, lockoutSetTrap=lockoutSetTrap, testTrap=testTrap, userSerialAccess=userSerialAccess, plugGroupEntry=plugGroupEntry, environmentUnitCurrentD=environmentUnitCurrentD, environmentBranchATotalPower=environmentBranchATotalPower, environmentUnitVoltageB=environmentUnitVoltageB, userAux1Access=userAux1Access, pingNoAnswerClearTrap=pingNoAnswerClearTrap, userCurrentPowerMetering=userCurrentPowerMetering, systemTables=systemTables, PYSNMP_MODULE_ID=wti, plugGroupIndex=plugGroupIndex, environmentUnitCurrentC=environmentUnitCurrentC, environmentUnitVoltageA=environmentUnitVoltageA, environmentUnitTemperature=environmentUnitTemperature, overTemperatureCriticalTraps=overTemperatureCriticalTraps, environmentMonthlyPowerLog=environmentMonthlyPowerLog, plugAction=plugAction, circuitBreakerOpenTraps=circuitBreakerOpenTraps, wtiTraps=wtiTraps, userEntry=userEntry, environmentBranchDTotalPower=environmentBranchDTotalPower, overCurrentInitialTraps=overCurrentInitialTraps, plugTable=plugTable, plugEntry=plugEntry, lostVoltageTraps=lostVoltageTraps, powercycleTraps=powercycleTraps)
