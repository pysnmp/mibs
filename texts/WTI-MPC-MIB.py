...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:05:37 2021
...
Bits, MibIdentifier, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, Counter32, Counter64, NotificationType, ModuleIdentity, Gauge32, iso, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "Counter32", "Counter64", "NotificationType", "ModuleIdentity", "Gauge32", "iso", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("WTI-MPC-MIB", pingNoAnswerSetTrap=pingNoAnswerSetTrap, environmentSystemTotalCurrent=environmentSystemTotalCurrent, pingNoAnswerClearTrap=pingNoAnswerClearTrap, environmentUnitCurrentA=environmentUnitCurrentA, environmentUnitVoltageC=environmentUnitVoltageC, environmentMonthlyPowerLog=environmentMonthlyPowerLog, circuitBreakerOpenClearTrap=circuitBreakerOpenClearTrap, overCurrentCriticalClearTrap=overCurrentCriticalClearTrap, environmentUnitVoltageB=environmentUnitVoltageB, userName=userName, wti=wti, environmentBranchBTotalPower=environmentBranchBTotalPower, environmentBranchDTotalPower=environmentBranchDTotalPower, overTemperatureCriticalSetTrap=overTemperatureCriticalSetTrap, userPortAccess=userPortAccess, trapInfo=trapInfo, plugGroupAction=plugGroupAction, overCurrentInitialSetTrap=overCurrentInitialSetTrap, userAux2Access=userAux2Access, powercycleTraps=powercycleTraps, plugGroupEntry=plugGroupEntry, overTemperatureInitialTraps=overTemperatureInitialTraps, overTemperatureInitialClearTrap=overTemperatureInitialClearTrap, PYSNMP_MODULE_ID=wti, plugIndex=plugIndex, environmentUnitCurrentB=environmentUnitCurrentB, circuitBreakerOpenSetTrap=circuitBreakerOpenSetTrap, plugStatus=plugStatus, userSerialAccess=userSerialAccess, userEntry=userEntry, environmentUnitPowerB=environmentUnitPowerB, plugID=plugID, overCurrentCriticalTraps=overCurrentCriticalTraps, overTemperatureInitialSetTrap=overTemperatureInitialSetTrap, lostCommClearTrap=lostCommClearTrap, plugGroupIndex=plugGroupIndex, environmentUnitVoltageA=environmentUnitVoltageA, environmentUnitPowerA=environmentUnitPowerA, lostVoltageTraps=lostVoltageTraps, environmentBranchBTotalCurrent=environmentBranchBTotalCurrent, userSubmit=userSubmit, userAux1Access=userAux1Access, environmentUnitEntry=environmentUnitEntry, testTrap=testTrap, environmentSystemTotalPower=environmentSystemTotalPower, userIndex=userIndex, lostVoltageClearTrap=lostVoltageClearTrap, overCurrentInitialTraps=overCurrentInitialTraps, environmentBranchCTotalCurrent=environmentBranchCTotalCurrent, lockoutClearTrap=lockoutClearTrap, environmentBranchATotalPower=environmentBranchATotalPower, environmentBranchDTotalCurrent=environmentBranchDTotalCurrent, lostCommSetTrap=lostCommSetTrap, overCurrentCriticalSetTrap=overCurrentCriticalSetTrap, userCurrentPowerMetering=userCurrentPowerMetering, userTable=userTable, systemTables=systemTables, environmentUnitCurrentD=environmentUnitCurrentD, userWebAccess=userWebAccess, plugName=plugName, plugEntry=plugEntry, userTelnetSshAccess=userTelnetSshAccess, userPasswd=userPasswd, environmentUnitPowerC=environmentUnitPowerC, userGroupAccess=userGroupAccess, plugGroupName=plugGroupName, environmentUnitCurrentC=environmentUnitCurrentC, userAccessLevel=userAccessLevel, overCurrentInitialClearTrap=overCurrentInitialClearTrap, lostVoltageSetTrap=lostVoltageSetTrap, circuitBreakerOpenTraps=circuitBreakerOpenTraps, environmentUnitIndex=environmentUnitIndex, environmentUnitVoltageD=environmentUnitVoltageD, overTemperatureCriticalTraps=overTemperatureCriticalTraps, environmentUnitPowerD=environmentUnitPowerD, pingNoAnswerTraps=pingNoAnswerTraps, lockoutTraps=lockoutTraps, testTraps=testTraps, plugAction=plugAction, plugGroupTable=plugGroupTable, environmentUnitTable=environmentUnitTable, environmentUnitName=environmentUnitName, userCallbackNum=userCallbackNum, lockoutSetTrap=lockoutSetTrap, overTemperatureCriticalClearTrap=overTemperatureCriticalClearTrap, environmentUnitTemperature=environmentUnitTemperature, powercycleSetTrap=powercycleSetTrap, environmentBranchATotalCurrent=environmentBranchATotalCurrent, plugTable=plugTable, environmentTables=environmentTables, westernTelematic=westernTelematic, userAux3Access=userAux3Access, wtiTraps=wtiTraps, environmentBranchCTotalPower=environmentBranchCTotalPower, lostCommTraps=lostCommTraps, userLocalAccess=userLocalAccess)
