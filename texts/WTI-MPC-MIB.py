...
# Produced by pysmi-1.1.8 at Mon Feb  7 15:58:24 2022
...
MibIdentifier, Bits, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, enterprises, Counter64, iso, Gauge32, Unsigned32, Counter32, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "enterprises", "Counter64", "iso", "Gauge32", "Unsigned32", "Counter32", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("WTI-MPC-MIB", environmentBranchDTotalCurrent=environmentBranchDTotalCurrent, userIndex=userIndex, userAux3Access=userAux3Access, powercycleSetTrap=powercycleSetTrap, overCurrentInitialClearTrap=overCurrentInitialClearTrap, plugName=plugName, environmentBranchCTotalCurrent=environmentBranchCTotalCurrent, overTemperatureCriticalTraps=overTemperatureCriticalTraps, overTemperatureInitialClearTrap=overTemperatureInitialClearTrap, plugEntry=plugEntry, plugGroupEntry=plugGroupEntry, environmentUnitCurrentA=environmentUnitCurrentA, plugGroupName=plugGroupName, lostVoltageTraps=lostVoltageTraps, plugGroupTable=plugGroupTable, environmentBranchCTotalPower=environmentBranchCTotalPower, environmentUnitVoltageA=environmentUnitVoltageA, circuitBreakerOpenClearTrap=circuitBreakerOpenClearTrap, plugIndex=plugIndex, overTemperatureCriticalSetTrap=overTemperatureCriticalSetTrap, plugTable=plugTable, environmentUnitTable=environmentUnitTable, systemTables=systemTables, environmentUnitVoltageC=environmentUnitVoltageC, westernTelematic=westernTelematic, userGroupAccess=userGroupAccess, overTemperatureCriticalClearTrap=overTemperatureCriticalClearTrap, overTemperatureInitialTraps=overTemperatureInitialTraps, userPasswd=userPasswd, userAux2Access=userAux2Access, userSerialAccess=userSerialAccess, userEntry=userEntry, environmentSystemTotalPower=environmentSystemTotalPower, pingNoAnswerClearTrap=pingNoAnswerClearTrap, environmentUnitVoltageB=environmentUnitVoltageB, plugGroupIndex=plugGroupIndex, environmentBranchDTotalPower=environmentBranchDTotalPower, environmentBranchATotalPower=environmentBranchATotalPower, environmentUnitCurrentC=environmentUnitCurrentC, overCurrentInitialTraps=overCurrentInitialTraps, environmentSystemTotalCurrent=environmentSystemTotalCurrent, lockoutClearTrap=lockoutClearTrap, plugStatus=plugStatus, lostCommSetTrap=lostCommSetTrap, plugAction=plugAction, overCurrentCriticalTraps=overCurrentCriticalTraps, environmentUnitName=environmentUnitName, userName=userName, lockoutSetTrap=lockoutSetTrap, lostCommTraps=lostCommTraps, environmentUnitVoltageD=environmentUnitVoltageD, lostCommClearTrap=lostCommClearTrap, environmentUnitCurrentB=environmentUnitCurrentB, overCurrentCriticalSetTrap=overCurrentCriticalSetTrap, environmentUnitPowerD=environmentUnitPowerD, lostVoltageClearTrap=lostVoltageClearTrap, userCallbackNum=userCallbackNum, environmentUnitIndex=environmentUnitIndex, overTemperatureInitialSetTrap=overTemperatureInitialSetTrap, environmentBranchBTotalCurrent=environmentBranchBTotalCurrent, pingNoAnswerSetTrap=pingNoAnswerSetTrap, userPortAccess=userPortAccess, environmentUnitTemperature=environmentUnitTemperature, testTraps=testTraps, userTable=userTable, circuitBreakerOpenTraps=circuitBreakerOpenTraps, userLocalAccess=userLocalAccess, environmentUnitPowerB=environmentUnitPowerB, testTrap=testTrap, environmentUnitPowerC=environmentUnitPowerC, pingNoAnswerTraps=pingNoAnswerTraps, overCurrentInitialSetTrap=overCurrentInitialSetTrap, environmentUnitPowerA=environmentUnitPowerA, userAccessLevel=userAccessLevel, plugID=plugID, plugGroupAction=plugGroupAction, environmentUnitCurrentD=environmentUnitCurrentD, environmentBranchATotalCurrent=environmentBranchATotalCurrent, lockoutTraps=lockoutTraps, wtiTraps=wtiTraps, userTelnetSshAccess=userTelnetSshAccess, environmentBranchBTotalPower=environmentBranchBTotalPower, userAux1Access=userAux1Access, trapInfo=trapInfo, circuitBreakerOpenSetTrap=circuitBreakerOpenSetTrap, wti=wti, environmentUnitEntry=environmentUnitEntry, environmentTables=environmentTables, userWebAccess=userWebAccess, powercycleTraps=powercycleTraps, userSubmit=userSubmit, lostVoltageSetTrap=lostVoltageSetTrap, environmentMonthlyPowerLog=environmentMonthlyPowerLog, overCurrentCriticalClearTrap=overCurrentCriticalClearTrap, PYSNMP_MODULE_ID=wti, userCurrentPowerMetering=userCurrentPowerMetering)
