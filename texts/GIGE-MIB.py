...
mibBuilder.exportSymbols("GIGE-MIB", pauseSeverity=pauseSeverity, gfpOperStatus=gfpOperStatus, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, gfpHCOutIdlePkts=gfpHCOutIdlePkts, cosNumber=cosNumber, pauseTable=pauseTable, gigeAutoTest=gigeAutoTest, qosNumber=qosNumber, pauseCLT=pauseCLT, qosType=qosType, cosHCInOctets=cosHCInOctets, maintenanceResetQosCounters=maintenanceResetQosCounters, gfpEntry=gfpEntry, gigeIndex=gigeIndex, qosTable=qosTable, gfpHCOutPkts=gfpHCOutPkts, gfpFDSC=gfpFDSC, gfpHCOutOctets=gfpHCOutOctets, gfpMonitor=gfpMonitor, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, PauseFailure=PauseFailure, cosHCInCCDiscards=cosHCInCCDiscards, cosBwRRatioMax=cosBwRRatioMax, maintenanceResetGfpCounters=maintenanceResetGfpCounters, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, maintenanceTable=maintenanceTable, maintenancePRBSSent=maintenancePRBSSent, pauseMacSA=pauseMacSA, gfpIndex=gfpIndex, SchedulingSystem=SchedulingSystem, cosQosId=cosQosId, GfpState=GfpState, qosClassNumber=qosClassNumber, maintenanceIndex=maintenanceIndex, cosIndex=cosIndex, pauseFailure=pauseFailure, PYSNMP_MODULE_ID=gige, qosEntry=qosEntry, qosSchedulingSystem=qosSchedulingSystem, gigeTable=gigeTable, gfpSendingRate=gfpSendingRate, gigeWarmStart=gigeWarmStart, gfpHCInOctets=gfpHCInOctets, cosBwRRatioMin=cosBwRRatioMin, gfpSeverity=gfpSeverity, qosIndex=qosIndex, CongestionControl=CongestionControl, gigeEntry=gigeEntry, gfpFailure=gfpFailure, gfpLOFD=gfpLOFD, gige=gige, pauseTime=pauseTime, cosTable=cosTable, maintenanceLoopback=maintenanceLoopback, maintenanceResetAllCounters=maintenanceResetAllCounters, GfpFailure=GfpFailure, gfpOOFD=gfpOOFD, gigeNumber=gigeNumber, gfpHCInIdlePkts=gfpHCInIdlePkts, qosBwREnable=qosBwREnable, cosDefinition=cosDefinition, cosHCInPkts=cosHCInPkts, gfpHCFCSErrors=gfpHCFCSErrors, pauseEntry=pauseEntry, LoopbackGE=LoopbackGE, gfpTable=gfpTable, pauseBetweenTime=pauseBetweenTime, gfpNumber=gfpNumber, cosHCOutPkts=cosHCOutPkts, QosType=QosType, maintenanceNumber=maintenanceNumber, gigeSdhBandwidth=gigeSdhBandwidth, gfpAdminStatus=gfpAdminStatus, pauseModeRejected=pauseModeRejected, cosId=cosId, gfpHCInErrors=gfpHCInErrors, pauseCHT=pauseCHT, qosCongestionControl=qosCongestionControl, cosEntry=cosEntry, CosId=CosId, gfpHCInPkts=gfpHCInPkts, pauseIndex=pauseIndex, pauseMacDA=pauseMacDA, pauseNumber=pauseNumber, maintenanceEntry=maintenanceEntry, gfpState=gfpState, cosHCOutOctets=cosHCOutOctets, BandwidthSize=BandwidthSize, maintenancePRBSReceived=maintenancePRBSReceived, maintenanceResetLanCounters=maintenanceResetLanCounters, maintenanceAutoTest=maintenanceAutoTest, gfpIdleRate=gfpIdleRate, pauseMonitor=pauseMonitor)
