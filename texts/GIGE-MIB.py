...
mibBuilder.exportSymbols("GIGE-MIB", gfpAdminStatus=gfpAdminStatus, gfpLOFD=gfpLOFD, cosHCInOctets=cosHCInOctets, gfpHCInOctets=gfpHCInOctets, cosId=cosId, qosCongestionControl=qosCongestionControl, qosTable=qosTable, QosType=QosType, cosIndex=cosIndex, maintenanceResetLanCounters=maintenanceResetLanCounters, gfpMonitor=gfpMonitor, cosHCOutPkts=cosHCOutPkts, pauseBetweenTime=pauseBetweenTime, gfpHCInPkts=gfpHCInPkts, gigeEntry=gigeEntry, SchedulingSystem=SchedulingSystem, qosClassNumber=qosClassNumber, gfpTable=gfpTable, gigeTable=gigeTable, cosEntry=cosEntry, gfpHCOutIdlePkts=gfpHCOutIdlePkts, pauseTable=pauseTable, maintenanceResetQosCounters=maintenanceResetQosCounters, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, qosEntry=qosEntry, pauseCLT=pauseCLT, pauseCHT=pauseCHT, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, maintenanceLoopback=maintenanceLoopback, gfpIdleRate=gfpIdleRate, maintenancePRBSSent=maintenancePRBSSent, qosIndex=qosIndex, cosDefinition=cosDefinition, maintenanceNumber=maintenanceNumber, cosHCInCCDiscards=cosHCInCCDiscards, PYSNMP_MODULE_ID=gige, maintenanceIndex=maintenanceIndex, gigeWarmStart=gigeWarmStart, gfpHCInIdlePkts=gfpHCInIdlePkts, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, GfpState=GfpState, maintenancePRBSReceived=maintenancePRBSReceived, gigeNumber=gigeNumber, maintenanceResetGfpCounters=maintenanceResetGfpCounters, cosTable=cosTable, maintenanceAutoTest=maintenanceAutoTest, gfpSendingRate=gfpSendingRate, gfpSeverity=gfpSeverity, gigeAutoTest=gigeAutoTest, cosHCInPkts=cosHCInPkts, qosType=qosType, CosId=CosId, pauseMacSA=pauseMacSA, pauseTime=pauseTime, maintenanceEntry=maintenanceEntry, pauseFailure=pauseFailure, cosNumber=cosNumber, qosNumber=qosNumber, gige=gige, LoopbackGE=LoopbackGE, pauseIndex=pauseIndex, BandwidthSize=BandwidthSize, maintenanceResetAllCounters=maintenanceResetAllCounters, gigeIndex=gigeIndex, qosBwREnable=qosBwREnable, maintenanceTable=maintenanceTable, gigeSdhBandwidth=gigeSdhBandwidth, gfpHCFCSErrors=gfpHCFCSErrors, pauseMonitor=pauseMonitor, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, gfpOOFD=gfpOOFD, gfpFDSC=gfpFDSC, gfpHCOutOctets=gfpHCOutOctets, gfpFailure=gfpFailure, pauseModeRejected=pauseModeRejected, GfpFailure=GfpFailure, gfpIndex=gfpIndex, gfpOperStatus=gfpOperStatus, gfpNumber=gfpNumber, gfpHCOutPkts=gfpHCOutPkts, gfpHCInErrors=gfpHCInErrors, cosQosId=cosQosId, cosBwRRatioMax=cosBwRRatioMax, qosSchedulingSystem=qosSchedulingSystem, cosHCOutOctets=cosHCOutOctets, pauseMacDA=pauseMacDA, pauseEntry=pauseEntry, gfpEntry=gfpEntry, pauseSeverity=pauseSeverity, pauseNumber=pauseNumber, cosBwRRatioMin=cosBwRRatioMin, PauseFailure=PauseFailure, CongestionControl=CongestionControl, gfpState=gfpState)
