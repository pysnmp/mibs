...
mibBuilder.exportSymbols("GIGE-MIB", gfpFDSC=gfpFDSC, GfpFailure=GfpFailure, gfpOOFD=gfpOOFD, pauseTime=pauseTime, gfpAdminStatus=gfpAdminStatus, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, gfpHCInOctets=gfpHCInOctets, pauseFailure=pauseFailure, pauseModeRejected=pauseModeRejected, pauseCLT=pauseCLT, gigeIndex=gigeIndex, gigeSdhBandwidth=gigeSdhBandwidth, gigeWarmStart=gigeWarmStart, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, maintenanceEntry=maintenanceEntry, gigeNumber=gigeNumber, maintenanceTable=maintenanceTable, qosIndex=qosIndex, CosId=CosId, cosHCInCCDiscards=cosHCInCCDiscards, qosEntry=qosEntry, pauseSeverity=pauseSeverity, pauseMacDA=pauseMacDA, pauseBetweenTime=pauseBetweenTime, pauseTable=pauseTable, gfpHCInErrors=gfpHCInErrors, gfpMonitor=gfpMonitor, cosBwRRatioMax=cosBwRRatioMax, qosTable=qosTable, cosIndex=cosIndex, LoopbackGE=LoopbackGE, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpIndex=gfpIndex, gige=gige, cosTable=cosTable, gfpHCOutIdlePkts=gfpHCOutIdlePkts, qosClassNumber=qosClassNumber, qosCongestionControl=qosCongestionControl, cosHCOutPkts=cosHCOutPkts, PYSNMP_MODULE_ID=gige, maintenanceAutoTest=maintenanceAutoTest, pauseMacSA=pauseMacSA, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, maintenanceLoopback=maintenanceLoopback, cosHCInOctets=cosHCInOctets, PauseFailure=PauseFailure, gigeEntry=gigeEntry, CongestionControl=CongestionControl, maintenanceResetAllCounters=maintenanceResetAllCounters, gfpNumber=gfpNumber, gfpIdleRate=gfpIdleRate, cosEntry=cosEntry, maintenancePRBSSent=maintenancePRBSSent, gfpTable=gfpTable, qosNumber=qosNumber, QosType=QosType, maintenanceIndex=maintenanceIndex, cosQosId=cosQosId, gfpHCInPkts=gfpHCInPkts, gigeAutoTest=gigeAutoTest, maintenanceResetLanCounters=maintenanceResetLanCounters, gfpEntry=gfpEntry, pauseNumber=pauseNumber, gfpHCOutPkts=gfpHCOutPkts, pauseEntry=pauseEntry, pauseMonitor=pauseMonitor, pauseIndex=pauseIndex, gfpHCFCSErrors=gfpHCFCSErrors, gfpSendingRate=gfpSendingRate, gfpSeverity=gfpSeverity, pauseCHT=pauseCHT, SchedulingSystem=SchedulingSystem, maintenancePRBSReceived=maintenancePRBSReceived, gfpHCOutOctets=gfpHCOutOctets, gigeTable=gigeTable, cosHCInPkts=cosHCInPkts, gfpOperStatus=gfpOperStatus, gfpHCInIdlePkts=gfpHCInIdlePkts, maintenanceResetQosCounters=maintenanceResetQosCounters, qosBwREnable=qosBwREnable, maintenanceResetGfpCounters=maintenanceResetGfpCounters, cosHCOutOctets=cosHCOutOctets, gfpState=gfpState, GfpState=GfpState, cosDefinition=cosDefinition, cosBwRRatioMin=cosBwRRatioMin, qosSchedulingSystem=qosSchedulingSystem, maintenanceNumber=maintenanceNumber, qosType=qosType, cosId=cosId, gfpLOFD=gfpLOFD, cosNumber=cosNumber, gfpFailure=gfpFailure, BandwidthSize=BandwidthSize)
