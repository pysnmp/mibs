...
mibBuilder.exportSymbols("GIGE-MIB", BandwidthSize=BandwidthSize, qosSchedulingSystem=qosSchedulingSystem, gfpAdminStatus=gfpAdminStatus, cosTable=cosTable, pauseBetweenTime=pauseBetweenTime, gfpHCInPkts=gfpHCInPkts, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, cosNumber=cosNumber, cosHCInOctets=cosHCInOctets, qosIndex=qosIndex, gigeSdhBandwidth=gigeSdhBandwidth, gfpState=gfpState, pauseTable=pauseTable, cosHCInPkts=cosHCInPkts, gfpOperStatus=gfpOperStatus, gfpNumber=gfpNumber, gfpFailure=gfpFailure, pauseFailure=pauseFailure, pauseMacDA=pauseMacDA, gfpHCInOctets=gfpHCInOctets, gigeWarmStart=gigeWarmStart, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gfpOOFD=gfpOOFD, gigeAutoTest=gigeAutoTest, cosBwRRatioMax=cosBwRRatioMax, pauseSeverity=pauseSeverity, gigeNumber=gigeNumber, maintenanceResetGfpCounters=maintenanceResetGfpCounters, qosType=qosType, gfpHCInErrors=gfpHCInErrors, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, gfpHCOutPkts=gfpHCOutPkts, cosId=cosId, GfpState=GfpState, gfpIndex=gfpIndex, cosHCOutPkts=cosHCOutPkts, gfpFDSC=gfpFDSC, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpHCInIdlePkts=gfpHCInIdlePkts, cosBwRRatioMin=cosBwRRatioMin, gfpSendingRate=gfpSendingRate, PYSNMP_MODULE_ID=gige, cosHCOutOctets=cosHCOutOctets, maintenancePRBSReceived=maintenancePRBSReceived, LoopbackGE=LoopbackGE, gfpHCOutIdlePkts=gfpHCOutIdlePkts, pauseIndex=pauseIndex, cosHCInCCDiscards=cosHCInCCDiscards, maintenanceIndex=maintenanceIndex, maintenanceResetLanCounters=maintenanceResetLanCounters, maintenanceNumber=maintenanceNumber, maintenanceResetAllCounters=maintenanceResetAllCounters, gigeEntry=gigeEntry, qosNumber=qosNumber, maintenanceResetQosCounters=maintenanceResetQosCounters, gfpIdleRate=gfpIdleRate, maintenanceEntry=maintenanceEntry, cosDefinition=cosDefinition, maintenanceAutoTest=maintenanceAutoTest, gfpTable=gfpTable, maintenanceTable=maintenanceTable, pauseEntry=pauseEntry, pauseMonitor=pauseMonitor, gfpLOFD=gfpLOFD, gfpHCOutOctets=gfpHCOutOctets, gfpHCFCSErrors=gfpHCFCSErrors, qosTable=qosTable, CosId=CosId, gigeIndex=gigeIndex, gfpEntry=gfpEntry, maintenancePRBSSent=maintenancePRBSSent, pauseModeRejected=pauseModeRejected, gigeTable=gigeTable, QosType=QosType, cosQosId=cosQosId, cosEntry=cosEntry, qosEntry=qosEntry, qosClassNumber=qosClassNumber, cosIndex=cosIndex, gfpSeverity=gfpSeverity, maintenanceLoopback=maintenanceLoopback, gige=gige, CongestionControl=CongestionControl, SchedulingSystem=SchedulingSystem, pauseCHT=pauseCHT, qosBwREnable=qosBwREnable, gfpMonitor=gfpMonitor, pauseTime=pauseTime, pauseNumber=pauseNumber, pauseCLT=pauseCLT, pauseMacSA=pauseMacSA, GfpFailure=GfpFailure, PauseFailure=PauseFailure, qosCongestionControl=qosCongestionControl)
