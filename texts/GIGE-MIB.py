...
mibBuilder.exportSymbols("GIGE-MIB", pauseIndex=pauseIndex, pauseCHT=pauseCHT, cosTable=cosTable, LoopbackGE=LoopbackGE, GfpState=GfpState, gfpTable=gfpTable, pauseEntry=pauseEntry, cosDefinition=cosDefinition, QosType=QosType, qosClassNumber=qosClassNumber, maintenanceEntry=maintenanceEntry, pauseBetweenTime=pauseBetweenTime, qosBwREnable=qosBwREnable, pauseCLT=pauseCLT, qosTable=qosTable, CongestionControl=CongestionControl, maintenancePRBSReceived=maintenancePRBSReceived, maintenanceResetLanCounters=maintenanceResetLanCounters, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, cosHCOutOctets=cosHCOutOctets, maintenanceTable=maintenanceTable, pauseMonitor=pauseMonitor, qosEntry=qosEntry, cosQosId=cosQosId, cosId=cosId, gfpHCOutPkts=gfpHCOutPkts, gfpSendingRate=gfpSendingRate, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, gfpOOFD=gfpOOFD, gfpHCOutOctets=gfpHCOutOctets, qosCongestionControl=qosCongestionControl, gfpHCFCSErrors=gfpHCFCSErrors, gigeSdhBandwidth=gigeSdhBandwidth, pauseMacDA=pauseMacDA, gfpState=gfpState, pauseNumber=pauseNumber, maintenanceResetQosCounters=maintenanceResetQosCounters, cosHCOutPkts=cosHCOutPkts, gfpSeverity=gfpSeverity, pauseModeRejected=pauseModeRejected, gigeAutoTest=gigeAutoTest, cosEntry=cosEntry, maintenanceLoopback=maintenanceLoopback, cosBwRRatioMax=cosBwRRatioMax, gfpFailure=gfpFailure, gfpFDSC=gfpFDSC, cosBwRRatioMin=cosBwRRatioMin, gfpHCInPkts=gfpHCInPkts, gfpLOFD=gfpLOFD, qosSchedulingSystem=qosSchedulingSystem, maintenanceAutoTest=maintenanceAutoTest, maintenanceNumber=maintenanceNumber, cosHCInCCDiscards=cosHCInCCDiscards, gfpIndex=gfpIndex, gfpAdminStatus=gfpAdminStatus, BandwidthSize=BandwidthSize, gige=gige, cosHCInOctets=cosHCInOctets, maintenanceResetAllCounters=maintenanceResetAllCounters, gfpMonitor=gfpMonitor, gfpHCInOctets=gfpHCInOctets, gfpNumber=gfpNumber, gigeTable=gigeTable, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, pauseTable=pauseTable, pauseFailure=pauseFailure, qosNumber=qosNumber, cosNumber=cosNumber, gigeNumber=gigeNumber, gfpIdleRate=gfpIdleRate, SchedulingSystem=SchedulingSystem, cosIndex=cosIndex, pauseTime=pauseTime, qosIndex=qosIndex, gigeIndex=gigeIndex, gigeEntry=gigeEntry, PYSNMP_MODULE_ID=gige, GfpFailure=GfpFailure, cosHCInPkts=cosHCInPkts, qosType=qosType, gfpOperStatus=gfpOperStatus, PauseFailure=PauseFailure, gfpHCOutIdlePkts=gfpHCOutIdlePkts, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, pauseSeverity=pauseSeverity, CosId=CosId, maintenancePRBSSent=maintenancePRBSSent, gfpEntry=gfpEntry, gfpHCInErrors=gfpHCInErrors, gigeWarmStart=gigeWarmStart, maintenanceIndex=maintenanceIndex, pauseMacSA=pauseMacSA, gfpHCInIdlePkts=gfpHCInIdlePkts)
