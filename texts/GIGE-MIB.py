...
mibBuilder.exportSymbols("GIGE-MIB", gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, qosEntry=qosEntry, maintenanceResetQosCounters=maintenanceResetQosCounters, pauseModeRejected=pauseModeRejected, gigeIndex=gigeIndex, pauseBetweenTime=pauseBetweenTime, gigeAutoTest=gigeAutoTest, pauseSeverity=pauseSeverity, maintenancePRBSSent=maintenancePRBSSent, pauseCHT=pauseCHT, QosType=QosType, pauseCLT=pauseCLT, pauseTable=pauseTable, gfpHCFCSErrors=gfpHCFCSErrors, qosNumber=qosNumber, pauseNumber=pauseNumber, cosTable=cosTable, gigeNumber=gigeNumber, PYSNMP_MODULE_ID=gige, cosQosId=cosQosId, pauseIndex=pauseIndex, maintenanceLoopback=maintenanceLoopback, qosClassNumber=qosClassNumber, gfpNumber=gfpNumber, gfpMonitor=gfpMonitor, gfpIndex=gfpIndex, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, cosHCInPkts=cosHCInPkts, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpHCOutIdlePkts=gfpHCOutIdlePkts, cosIndex=cosIndex, qosCongestionControl=qosCongestionControl, gfpEntry=gfpEntry, maintenanceAutoTest=maintenanceAutoTest, cosHCInCCDiscards=cosHCInCCDiscards, cosDefinition=cosDefinition, cosNumber=cosNumber, gfpState=gfpState, gfpAdminStatus=gfpAdminStatus, gfpIdleRate=gfpIdleRate, gfpOperStatus=gfpOperStatus, CosId=CosId, cosEntry=cosEntry, gfpHCInOctets=gfpHCInOctets, LoopbackGE=LoopbackGE, cosHCOutPkts=cosHCOutPkts, cosHCOutOctets=cosHCOutOctets, pauseMonitor=pauseMonitor, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, SchedulingSystem=SchedulingSystem, gfpFailure=gfpFailure, pauseTime=pauseTime, pauseMacSA=pauseMacSA, gige=gige, gigeEntry=gigeEntry, CongestionControl=CongestionControl, gfpHCOutOctets=gfpHCOutOctets, gfpFDSC=gfpFDSC, gigeWarmStart=gigeWarmStart, gfpOOFD=gfpOOFD, cosHCInOctets=cosHCInOctets, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpHCInIdlePkts=gfpHCInIdlePkts, qosType=qosType, gfpHCInErrors=gfpHCInErrors, gigeSdhBandwidth=gigeSdhBandwidth, PauseFailure=PauseFailure, gigeTable=gigeTable, pauseEntry=pauseEntry, qosIndex=qosIndex, maintenanceResetAllCounters=maintenanceResetAllCounters, qosSchedulingSystem=qosSchedulingSystem, gfpHCOutPkts=gfpHCOutPkts, qosTable=qosTable, gfpSendingRate=gfpSendingRate, pauseMacDA=pauseMacDA, cosBwRRatioMin=cosBwRRatioMin, gfpLOFD=gfpLOFD, maintenanceEntry=maintenanceEntry, BandwidthSize=BandwidthSize, cosId=cosId, GfpFailure=GfpFailure, GfpState=GfpState, gfpSeverity=gfpSeverity, maintenanceNumber=maintenanceNumber, maintenanceResetLanCounters=maintenanceResetLanCounters, gfpTable=gfpTable, qosBwREnable=qosBwREnable, maintenanceIndex=maintenanceIndex, gfpHCInPkts=gfpHCInPkts, pauseFailure=pauseFailure, maintenanceTable=maintenanceTable, maintenancePRBSReceived=maintenancePRBSReceived, cosBwRRatioMax=cosBwRRatioMax)
