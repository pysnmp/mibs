...
mibBuilder.exportSymbols("GIGE-MIB", gfpIdleRate=gfpIdleRate, gfpSendingRate=gfpSendingRate, gigeTable=gigeTable, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, pauseFailure=pauseFailure, cosTable=cosTable, cosHCOutOctets=cosHCOutOctets, pauseNumber=pauseNumber, gfpIndex=gfpIndex, cosBwRRatioMax=cosBwRRatioMax, BandwidthSize=BandwidthSize, pauseMacSA=pauseMacSA, maintenancePRBSSent=maintenancePRBSSent, maintenanceResetLanCounters=maintenanceResetLanCounters, LoopbackGE=LoopbackGE, pauseTime=pauseTime, cosHCInCCDiscards=cosHCInCCDiscards, gfpNumber=gfpNumber, gfpHCInIdlePkts=gfpHCInIdlePkts, pauseCHT=pauseCHT, pauseEntry=pauseEntry, pauseModeRejected=pauseModeRejected, gigeEntry=gigeEntry, gigeAutoTest=gigeAutoTest, gfpTable=gfpTable, GfpState=GfpState, gfpHCOutIdlePkts=gfpHCOutIdlePkts, cosQosId=cosQosId, cosId=cosId, gfpState=gfpState, GfpFailure=GfpFailure, gfpAdminStatus=gfpAdminStatus, gfpOperStatus=gfpOperStatus, PauseFailure=PauseFailure, cosIndex=cosIndex, QosType=QosType, SchedulingSystem=SchedulingSystem, gfpFailure=gfpFailure, pauseIndex=pauseIndex, maintenanceIndex=maintenanceIndex, gigeWarmStart=gigeWarmStart, pauseMonitor=pauseMonitor, qosType=qosType, qosCongestionControl=qosCongestionControl, cosNumber=cosNumber, qosEntry=qosEntry, maintenanceNumber=maintenanceNumber, pauseSeverity=pauseSeverity, gigeSdhBandwidth=gigeSdhBandwidth, qosBwREnable=qosBwREnable, qosNumber=qosNumber, cosHCInOctets=cosHCInOctets, gfpEntry=gfpEntry, maintenanceEntry=maintenanceEntry, PYSNMP_MODULE_ID=gige, cosBwRRatioMin=cosBwRRatioMin, pauseCLT=pauseCLT, maintenanceTable=maintenanceTable, gigeIndex=gigeIndex, gfpHCFCSErrors=gfpHCFCSErrors, gfpOOFD=gfpOOFD, maintenancePRBSReceived=maintenancePRBSReceived, cosHCOutPkts=cosHCOutPkts, maintenanceResetAllCounters=maintenanceResetAllCounters, maintenanceLoopback=maintenanceLoopback, gfpHCOutOctets=gfpHCOutOctets, maintenanceResetQosCounters=maintenanceResetQosCounters, gige=gige, qosSchedulingSystem=qosSchedulingSystem, gfpHCInOctets=gfpHCInOctets, gfpLOFD=gfpLOFD, qosClassNumber=qosClassNumber, cosDefinition=cosDefinition, gfpMonitor=gfpMonitor, pauseTable=pauseTable, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, cosEntry=cosEntry, cosHCInPkts=cosHCInPkts, qosTable=qosTable, gfpHCInPkts=gfpHCInPkts, CongestionControl=CongestionControl, pauseMacDA=pauseMacDA, gfpHCInErrors=gfpHCInErrors, gigeNumber=gigeNumber, gfpFDSC=gfpFDSC, maintenanceResetGfpCounters=maintenanceResetGfpCounters, maintenanceAutoTest=maintenanceAutoTest, pauseBetweenTime=pauseBetweenTime, gfpHCOutPkts=gfpHCOutPkts, qosIndex=qosIndex, gfpSeverity=gfpSeverity, CosId=CosId, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts)
