...
mibBuilder.exportSymbols("GIGE-MIB", gfpHCInErrors=gfpHCInErrors, gfpHCOutOctets=gfpHCOutOctets, pauseFailure=pauseFailure, cosQosId=cosQosId, qosTable=qosTable, gfpMonitor=gfpMonitor, GfpState=GfpState, maintenancePRBSSent=maintenancePRBSSent, pauseMacDA=pauseMacDA, qosSchedulingSystem=qosSchedulingSystem, gfpIdleRate=gfpIdleRate, maintenanceResetLanCounters=maintenanceResetLanCounters, gigeAutoTest=gigeAutoTest, pauseMacSA=pauseMacSA, GfpFailure=GfpFailure, maintenanceNumber=maintenanceNumber, maintenancePRBSReceived=maintenancePRBSReceived, gfpFDSC=gfpFDSC, gfpHCOutIdlePkts=gfpHCOutIdlePkts, qosEntry=qosEntry, cosHCInCCDiscards=cosHCInCCDiscards, maintenanceResetQosCounters=maintenanceResetQosCounters, gigeTable=gigeTable, qosCongestionControl=qosCongestionControl, PYSNMP_MODULE_ID=gige, gfpHCInPkts=gfpHCInPkts, pauseSeverity=pauseSeverity, gigeSdhBandwidth=gigeSdhBandwidth, SchedulingSystem=SchedulingSystem, gfpSendingRate=gfpSendingRate, pauseEntry=pauseEntry, pauseTable=pauseTable, maintenanceEntry=maintenanceEntry, cosEntry=cosEntry, cosTable=cosTable, gfpHCFCSErrors=gfpHCFCSErrors, maintenanceLoopback=maintenanceLoopback, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, cosHCOutPkts=cosHCOutPkts, qosType=qosType, pauseCHT=pauseCHT, gfpNumber=gfpNumber, gfpOperStatus=gfpOperStatus, pauseIndex=pauseIndex, gfpFailure=gfpFailure, pauseMonitor=pauseMonitor, gfpSeverity=gfpSeverity, cosHCInOctets=cosHCInOctets, LoopbackGE=LoopbackGE, pauseCLT=pauseCLT, gigeEntry=gigeEntry, BandwidthSize=BandwidthSize, gigeWarmStart=gigeWarmStart, maintenanceResetAllCounters=maintenanceResetAllCounters, maintenanceTable=maintenanceTable, cosNumber=cosNumber, gfpHCInIdlePkts=gfpHCInIdlePkts, gfpTable=gfpTable, pauseBetweenTime=pauseBetweenTime, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, qosIndex=qosIndex, cosHCInPkts=cosHCInPkts, qosNumber=qosNumber, gfpHCOutPkts=gfpHCOutPkts, cosBwRRatioMax=cosBwRRatioMax, PauseFailure=PauseFailure, gigeNumber=gigeNumber, pauseNumber=pauseNumber, gfpHCInOctets=gfpHCInOctets, gfpAdminStatus=gfpAdminStatus, maintenanceAutoTest=maintenanceAutoTest, cosIndex=cosIndex, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, maintenanceIndex=maintenanceIndex, gfpIndex=gfpIndex, cosDefinition=cosDefinition, qosClassNumber=qosClassNumber, QosType=QosType, gfpEntry=gfpEntry, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gige=gige, pauseModeRejected=pauseModeRejected, CongestionControl=CongestionControl, gigeIndex=gigeIndex, cosBwRRatioMin=cosBwRRatioMin, gfpOOFD=gfpOOFD, cosHCOutOctets=cosHCOutOctets, qosBwREnable=qosBwREnable, gfpLOFD=gfpLOFD, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpState=gfpState, pauseTime=pauseTime, CosId=CosId, cosId=cosId)
