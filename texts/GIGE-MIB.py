...
Bits, NotificationType, iso, MibIdentifier, Counter64, Integer32, Unsigned32, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "iso", "MibIdentifier", "Counter64", "Integer32", "Unsigned32", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("GIGE-MIB", GfpState=GfpState, qosIndex=qosIndex, QosType=QosType, cosEntry=cosEntry, gfpHCInOctets=gfpHCInOctets, gfpHCInPkts=gfpHCInPkts, maintenanceResetGfpCounters=maintenanceResetGfpCounters, pauseTable=pauseTable, cosHCInOctets=cosHCInOctets, cosHCOutPkts=cosHCOutPkts, cosQosId=cosQosId, gfpMonitor=gfpMonitor, qosSchedulingSystem=qosSchedulingSystem, pauseModeRejected=pauseModeRejected, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, qosClassNumber=qosClassNumber, cosNumber=cosNumber, gfpHCOutPkts=gfpHCOutPkts, gfpHCOutIdlePkts=gfpHCOutIdlePkts, maintenanceResetAllCounters=maintenanceResetAllCounters, cosBwRRatioMin=cosBwRRatioMin, pauseIndex=pauseIndex, cosHCInPkts=cosHCInPkts, gigeTable=gigeTable, gigeWarmStart=gigeWarmStart, gfpAdminStatus=gfpAdminStatus, pauseCLT=pauseCLT, CongestionControl=CongestionControl, pauseSeverity=pauseSeverity, gfpOOFD=gfpOOFD, pauseMacDA=pauseMacDA, cosIndex=cosIndex, qosEntry=qosEntry, qosNumber=qosNumber, gfpLOFD=gfpLOFD, gfpFailure=gfpFailure, qosType=qosType, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, GfpFailure=GfpFailure, cosTable=cosTable, pauseMonitor=pauseMonitor, LoopbackGE=LoopbackGE, maintenanceEntry=maintenanceEntry, gigeAutoTest=gigeAutoTest, gfpState=gfpState, gfpTable=gfpTable, qosCongestionControl=qosCongestionControl, gfpHCFCSErrors=gfpHCFCSErrors, pauseMacSA=pauseMacSA, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, BandwidthSize=BandwidthSize, gfpSeverity=gfpSeverity, gigeIndex=gigeIndex, gige=gige, PauseFailure=PauseFailure, cosHCOutOctets=cosHCOutOctets, maintenanceAutoTest=maintenanceAutoTest, gigeNumber=gigeNumber, maintenanceResetQosCounters=maintenanceResetQosCounters, qosTable=qosTable, pauseCHT=pauseCHT, gfpIdleRate=gfpIdleRate, SchedulingSystem=SchedulingSystem, gfpHCOutOctets=gfpHCOutOctets, pauseEntry=pauseEntry, gfpSendingRate=gfpSendingRate, maintenanceNumber=maintenanceNumber, CosId=CosId, PYSNMP_MODULE_ID=gige, pauseFailure=pauseFailure, gfpNumber=gfpNumber, pauseTime=pauseTime, qosBwREnable=qosBwREnable, maintenanceLoopback=maintenanceLoopback, maintenancePRBSSent=maintenancePRBSSent, gfpHCInErrors=gfpHCInErrors, gfpIndex=gfpIndex, maintenanceResetLanCounters=maintenanceResetLanCounters, gfpHCInIdlePkts=gfpHCInIdlePkts, gfpFDSC=gfpFDSC, cosHCInCCDiscards=cosHCInCCDiscards, pauseNumber=pauseNumber, maintenanceTable=maintenanceTable, pauseBetweenTime=pauseBetweenTime, gigeSdhBandwidth=gigeSdhBandwidth, gigeEntry=gigeEntry, gfpOperStatus=gfpOperStatus, maintenanceIndex=maintenanceIndex, cosDefinition=cosDefinition, cosId=cosId, maintenancePRBSReceived=maintenancePRBSReceived, cosBwRRatioMax=cosBwRRatioMax, gfpEntry=gfpEntry)
