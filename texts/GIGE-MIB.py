...
mibBuilder.exportSymbols("GIGE-MIB", qosType=qosType, gfpHCInPkts=gfpHCInPkts, maintenanceLoopback=maintenanceLoopback, qosEntry=qosEntry, BandwidthSize=BandwidthSize, cosQosId=cosQosId, cosIndex=cosIndex, pauseTime=pauseTime, qosBwREnable=qosBwREnable, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, qosIndex=qosIndex, gigeEntry=gigeEntry, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpFDSC=gfpFDSC, pauseTable=pauseTable, pauseMacDA=pauseMacDA, pauseBetweenTime=pauseBetweenTime, cosHCInCCDiscards=cosHCInCCDiscards, maintenanceAutoTest=maintenanceAutoTest, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, maintenancePRBSSent=maintenancePRBSSent, gfpAdminStatus=gfpAdminStatus, cosBwRRatioMin=cosBwRRatioMin, pauseMonitor=pauseMonitor, qosTable=qosTable, cosEntry=cosEntry, pauseCHT=pauseCHT, cosDefinition=cosDefinition, GfpFailure=GfpFailure, gfpHCOutIdlePkts=gfpHCOutIdlePkts, gfpEntry=gfpEntry, cosBwRRatioMax=cosBwRRatioMax, gfpHCInOctets=gfpHCInOctets, PYSNMP_MODULE_ID=gige, maintenanceIndex=maintenanceIndex, maintenanceNumber=maintenanceNumber, gfpSendingRate=gfpSendingRate, LoopbackGE=LoopbackGE, pauseFailure=pauseFailure, cosTable=cosTable, pauseCLT=pauseCLT, gigeNumber=gigeNumber, qosNumber=qosNumber, gfpFailure=gfpFailure, qosCongestionControl=qosCongestionControl, gige=gige, gigeTable=gigeTable, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, gigeAutoTest=gigeAutoTest, gfpLOFD=gfpLOFD, cosHCOutPkts=cosHCOutPkts, maintenanceTable=maintenanceTable, CosId=CosId, cosId=cosId, maintenancePRBSReceived=maintenancePRBSReceived, qosClassNumber=qosClassNumber, GfpState=GfpState, SchedulingSystem=SchedulingSystem, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, gigeIndex=gigeIndex, gfpHCFCSErrors=gfpHCFCSErrors, pauseNumber=pauseNumber, maintenanceResetQosCounters=maintenanceResetQosCounters, cosHCInOctets=cosHCInOctets, maintenanceEntry=maintenanceEntry, cosHCOutOctets=cosHCOutOctets, pauseSeverity=pauseSeverity, cosNumber=cosNumber, gfpHCInIdlePkts=gfpHCInIdlePkts, pauseMacSA=pauseMacSA, gfpHCOutOctets=gfpHCOutOctets, CongestionControl=CongestionControl, qosSchedulingSystem=qosSchedulingSystem, pauseEntry=pauseEntry, pauseIndex=pauseIndex, gfpHCOutPkts=gfpHCOutPkts, gfpTable=gfpTable, gfpMonitor=gfpMonitor, gfpIndex=gfpIndex, gfpIdleRate=gfpIdleRate, QosType=QosType, gfpSeverity=gfpSeverity, maintenanceResetLanCounters=maintenanceResetLanCounters, gfpOperStatus=gfpOperStatus, pauseModeRejected=pauseModeRejected, gfpNumber=gfpNumber, cosHCInPkts=cosHCInPkts, gfpState=gfpState, gigeSdhBandwidth=gigeSdhBandwidth, PauseFailure=PauseFailure, maintenanceResetAllCounters=maintenanceResetAllCounters, gigeWarmStart=gigeWarmStart, gfpOOFD=gfpOOFD, gfpHCInErrors=gfpHCInErrors)
