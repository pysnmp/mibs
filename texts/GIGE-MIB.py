...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, NotificationType, Counter64, TimeTicks, Gauge32, Unsigned32, Integer32, Counter32, IpAddress, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "NotificationType", "Counter64", "TimeTicks", "Gauge32", "Unsigned32", "Integer32", "Counter32", "IpAddress", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("GIGE-MIB", cosBwRRatioMin=cosBwRRatioMin, qosNumber=qosNumber, maintenanceResetGfpCounters=maintenanceResetGfpCounters, cosHCInOctets=cosHCInOctets, PauseFailure=PauseFailure, gfpHCInErrors=gfpHCInErrors, gigeEntry=gigeEntry, gfpSendingRate=gfpSendingRate, pauseMonitor=pauseMonitor, gfpFDSC=gfpFDSC, gigeIndex=gigeIndex, GfpFailure=GfpFailure, gfpIdleRate=gfpIdleRate, gigeAutoTest=gigeAutoTest, QosType=QosType, gigeSdhBandwidth=gigeSdhBandwidth, LoopbackGE=LoopbackGE, pauseFailure=pauseFailure, qosEntry=qosEntry, gfpLOFD=gfpLOFD, gigeTable=gigeTable, pauseCLT=pauseCLT, cosId=cosId, cosEntry=cosEntry, cosHCOutPkts=cosHCOutPkts, maintenanceAutoTest=maintenanceAutoTest, pauseEntry=pauseEntry, maintenanceNumber=maintenanceNumber, maintenanceTable=maintenanceTable, cosHCOutOctets=cosHCOutOctets, pauseMacDA=pauseMacDA, cosHCInCCDiscards=cosHCInCCDiscards, gfpHCOutOctets=gfpHCOutOctets, cosTable=cosTable, qosType=qosType, gfpIndex=gfpIndex, pauseSeverity=pauseSeverity, cosQosId=cosQosId, gfpState=gfpState, pauseIndex=pauseIndex, cosBwRRatioMax=cosBwRRatioMax, qosTable=qosTable, qosCongestionControl=qosCongestionControl, maintenanceLoopback=maintenanceLoopback, maintenancePRBSSent=maintenancePRBSSent, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, GfpState=GfpState, cosDefinition=cosDefinition, qosClassNumber=qosClassNumber, gfpHCOutPkts=gfpHCOutPkts, gfpNumber=gfpNumber, maintenancePRBSReceived=maintenancePRBSReceived, gigeWarmStart=gigeWarmStart, pauseTime=pauseTime, gige=gige, gfpSeverity=gfpSeverity, gfpEntry=gfpEntry, pauseBetweenTime=pauseBetweenTime, qosSchedulingSystem=qosSchedulingSystem, gfpHCInOctets=gfpHCInOctets, maintenanceResetAllCounters=maintenanceResetAllCounters, maintenanceResetQosCounters=maintenanceResetQosCounters, cosIndex=cosIndex, gfpTable=gfpTable, maintenanceResetLanCounters=maintenanceResetLanCounters, cosNumber=cosNumber, pauseNumber=pauseNumber, gfpFailure=gfpFailure, BandwidthSize=BandwidthSize, CongestionControl=CongestionControl, cosHCInPkts=cosHCInPkts, gfpHCInIdlePkts=gfpHCInIdlePkts, SchedulingSystem=SchedulingSystem, CosId=CosId, gfpHCOutIdlePkts=gfpHCOutIdlePkts, gfpMonitor=gfpMonitor, gfpOOFD=gfpOOFD, gfpOperStatus=gfpOperStatus, pauseTable=pauseTable, qosBwREnable=qosBwREnable, pauseCHT=pauseCHT, gfpHCInPkts=gfpHCInPkts, gigeNumber=gigeNumber, qosIndex=qosIndex, pauseModeRejected=pauseModeRejected, gfpAdminStatus=gfpAdminStatus, gfpHCFCSErrors=gfpHCFCSErrors, pauseMacSA=pauseMacSA, maintenanceEntry=maintenanceEntry, PYSNMP_MODULE_ID=gige, maintenanceIndex=maintenanceIndex, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts)
