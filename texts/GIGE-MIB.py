...
mibBuilder.exportSymbols("GIGE-MIB", maintenancePRBSReceived=maintenancePRBSReceived, gfpSeverity=gfpSeverity, gige=gige, LoopbackGE=LoopbackGE, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, cosHCOutPkts=cosHCOutPkts, gfpIndex=gfpIndex, cosBwRRatioMax=cosBwRRatioMax, pauseMacDA=pauseMacDA, gigeAutoTest=gigeAutoTest, gigeIndex=gigeIndex, maintenanceResetQosCounters=maintenanceResetQosCounters, qosEntry=qosEntry, gfpHCOutIdlePkts=gfpHCOutIdlePkts, cosHCInPkts=cosHCInPkts, pauseTable=pauseTable, cosId=cosId, gfpAdminStatus=gfpAdminStatus, pauseTime=pauseTime, maintenanceResetGfpCounters=maintenanceResetGfpCounters, pauseEntry=pauseEntry, maintenanceIndex=maintenanceIndex, gfpFailure=gfpFailure, gfpHCFCSErrors=gfpHCFCSErrors, PauseFailure=PauseFailure, QosType=QosType, gfpOperStatus=gfpOperStatus, qosType=qosType, PYSNMP_MODULE_ID=gige, GfpFailure=GfpFailure, maintenanceAutoTest=maintenanceAutoTest, qosIndex=qosIndex, qosCongestionControl=qosCongestionControl, pauseCLT=pauseCLT, gigeTable=gigeTable, maintenanceTable=maintenanceTable, gfpLOFD=gfpLOFD, qosTable=qosTable, gfpTable=gfpTable, GfpState=GfpState, pauseModeRejected=pauseModeRejected, CongestionControl=CongestionControl, qosBwREnable=qosBwREnable, gfpState=gfpState, cosNumber=cosNumber, cosHCInCCDiscards=cosHCInCCDiscards, CosId=CosId, gfpSendingRate=gfpSendingRate, gfpHCInErrors=gfpHCInErrors, cosQosId=cosQosId, gfpIdleRate=gfpIdleRate, cosTable=cosTable, gfpHCInIdlePkts=gfpHCInIdlePkts, gfpOOFD=gfpOOFD, pauseBetweenTime=pauseBetweenTime, gfpHCOutOctets=gfpHCOutOctets, cosHCInOctets=cosHCInOctets, cosDefinition=cosDefinition, cosBwRRatioMin=cosBwRRatioMin, gfpHCOutPkts=gfpHCOutPkts, gfpHCInPkts=gfpHCInPkts, pauseFailure=pauseFailure, maintenancePRBSSent=maintenancePRBSSent, gigeEntry=gigeEntry, pauseMacSA=pauseMacSA, maintenanceLoopback=maintenanceLoopback, gigeNumber=gigeNumber, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, pauseCHT=pauseCHT, maintenanceResetLanCounters=maintenanceResetLanCounters, maintenanceNumber=maintenanceNumber, pauseSeverity=pauseSeverity, pauseNumber=pauseNumber, qosNumber=qosNumber, BandwidthSize=BandwidthSize, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, cosIndex=cosIndex, gfpEntry=gfpEntry, maintenanceEntry=maintenanceEntry, SchedulingSystem=SchedulingSystem, pauseMonitor=pauseMonitor, gigeWarmStart=gigeWarmStart, gfpMonitor=gfpMonitor, qosClassNumber=qosClassNumber, gfpFDSC=gfpFDSC, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gfpNumber=gfpNumber, gigeSdhBandwidth=gigeSdhBandwidth, gfpHCInOctets=gfpHCInOctets, cosHCOutOctets=cosHCOutOctets, cosEntry=cosEntry, qosSchedulingSystem=qosSchedulingSystem, maintenanceResetAllCounters=maintenanceResetAllCounters, pauseIndex=pauseIndex)
