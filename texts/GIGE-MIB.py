...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, iso, ModuleIdentity, Gauge32, MibIdentifier, Integer32, Unsigned32, NotificationType, Counter64, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "iso", "ModuleIdentity", "Gauge32", "MibIdentifier", "Integer32", "Unsigned32", "NotificationType", "Counter64", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("GIGE-MIB", qosCongestionControl=qosCongestionControl, cosQosId=cosQosId, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpTable=gfpTable, cosHCInOctets=cosHCInOctets, maintenanceTable=maintenanceTable, qosIndex=qosIndex, gfpOOFD=gfpOOFD, maintenanceResetQosCounters=maintenanceResetQosCounters, maintenanceLoopback=maintenanceLoopback, gfpHCInErrors=gfpHCInErrors, BandwidthSize=BandwidthSize, GfpFailure=GfpFailure, gfpIdleRate=gfpIdleRate, pauseMonitor=pauseMonitor, cosHCOutPkts=cosHCOutPkts, qosEntry=qosEntry, pauseFailure=pauseFailure, qosNumber=qosNumber, cosId=cosId, maintenanceResetLanCounters=maintenanceResetLanCounters, gigeEntry=gigeEntry, gfpAdminStatus=gfpAdminStatus, SchedulingSystem=SchedulingSystem, cosBwRRatioMin=cosBwRRatioMin, cosBwRRatioMax=cosBwRRatioMax, gfpFDSC=gfpFDSC, pauseCLT=pauseCLT, gigeTable=gigeTable, gigeNumber=gigeNumber, gigeSdhBandwidth=gigeSdhBandwidth, QosType=QosType, maintenanceEntry=maintenanceEntry, qosType=qosType, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, cosHCOutOctets=cosHCOutOctets, pauseIndex=pauseIndex, maintenancePRBSSent=maintenancePRBSSent, gfpHCOutPkts=gfpHCOutPkts, gfpHCOutOctets=gfpHCOutOctets, gfpHCFCSErrors=gfpHCFCSErrors, gfpHCInOctets=gfpHCInOctets, maintenancePRBSReceived=maintenancePRBSReceived, pauseTime=pauseTime, gfpNumber=gfpNumber, pauseCHT=pauseCHT, gfpSeverity=gfpSeverity, maintenanceResetAllCounters=maintenanceResetAllCounters, CosId=CosId, gfpIndex=gfpIndex, gfpHCOutIdlePkts=gfpHCOutIdlePkts, cosHCInCCDiscards=cosHCInCCDiscards, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, qosBwREnable=qosBwREnable, gfpSendingRate=gfpSendingRate, gfpState=gfpState, cosDefinition=cosDefinition, pauseMacSA=pauseMacSA, gfpOperStatus=gfpOperStatus, pauseEntry=pauseEntry, pauseMacDA=pauseMacDA, gfpLOFD=gfpLOFD, pauseTable=pauseTable, pauseNumber=pauseNumber, qosClassNumber=qosClassNumber, LoopbackGE=LoopbackGE, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gigeIndex=gigeIndex, gige=gige, GfpState=GfpState, CongestionControl=CongestionControl, maintenanceAutoTest=maintenanceAutoTest, cosTable=cosTable, qosTable=qosTable, PauseFailure=PauseFailure, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, pauseBetweenTime=pauseBetweenTime, qosSchedulingSystem=qosSchedulingSystem, pauseModeRejected=pauseModeRejected, maintenanceNumber=maintenanceNumber, cosIndex=cosIndex, cosEntry=cosEntry, gfpEntry=gfpEntry, maintenanceIndex=maintenanceIndex, cosHCInPkts=cosHCInPkts, gfpMonitor=gfpMonitor, gfpHCInPkts=gfpHCInPkts, cosNumber=cosNumber, gfpHCInIdlePkts=gfpHCInIdlePkts, gfpFailure=gfpFailure, gigeWarmStart=gigeWarmStart, pauseSeverity=pauseSeverity, gigeAutoTest=gigeAutoTest, PYSNMP_MODULE_ID=gige)
