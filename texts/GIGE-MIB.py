...
mibBuilder.exportSymbols("GIGE-MIB", gfpSendingRate=gfpSendingRate, cosNumber=cosNumber, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, pauseFailure=pauseFailure, gigeNumber=gigeNumber, maintenanceResetLanCounters=maintenanceResetLanCounters, maintenanceNumber=maintenanceNumber, cosHCOutPkts=cosHCOutPkts, LoopbackGE=LoopbackGE, pauseTime=pauseTime, cosHCInOctets=cosHCInOctets, cosBwRRatioMax=cosBwRRatioMax, maintenanceResetGfpCounters=maintenanceResetGfpCounters, qosIndex=qosIndex, gigeSdhBandwidth=gigeSdhBandwidth, gfpSeverity=gfpSeverity, gfpHCInPkts=gfpHCInPkts, maintenanceIndex=maintenanceIndex, gfpFailure=gfpFailure, qosType=qosType, pauseSeverity=pauseSeverity, gfpAdminStatus=gfpAdminStatus, qosEntry=qosEntry, cosHCInPkts=cosHCInPkts, cosDefinition=cosDefinition, pauseBetweenTime=pauseBetweenTime, GfpState=GfpState, maintenancePRBSReceived=maintenancePRBSReceived, qosTable=qosTable, qosClassNumber=qosClassNumber, gfpIdleRate=gfpIdleRate, BandwidthSize=BandwidthSize, qosCongestionControl=qosCongestionControl, cosEntry=cosEntry, maintenancePRBSSent=maintenancePRBSSent, PauseFailure=PauseFailure, gfpHCInOctets=gfpHCInOctets, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gfpNumber=gfpNumber, gfpHCFCSErrors=gfpHCFCSErrors, cosHCInCCDiscards=cosHCInCCDiscards, gfpHCOutOctets=gfpHCOutOctets, pauseMacDA=pauseMacDA, gfpEntry=gfpEntry, pauseIndex=pauseIndex, gige=gige, cosHCOutOctets=cosHCOutOctets, pauseModeRejected=pauseModeRejected, cosTable=cosTable, maintenanceResetAllCounters=maintenanceResetAllCounters, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, CongestionControl=CongestionControl, pauseMonitor=pauseMonitor, cosId=cosId, pauseEntry=pauseEntry, pauseTable=pauseTable, maintenanceEntry=maintenanceEntry, gfpTable=gfpTable, pauseMacSA=pauseMacSA, pauseCLT=pauseCLT, maintenanceTable=maintenanceTable, pauseNumber=pauseNumber, gfpHCInIdlePkts=gfpHCInIdlePkts, gfpHCOutPkts=gfpHCOutPkts, gfpMonitor=gfpMonitor, cosQosId=cosQosId, GfpFailure=GfpFailure, gigeWarmStart=gigeWarmStart, SchedulingSystem=SchedulingSystem, qosBwREnable=qosBwREnable, CosId=CosId, qosNumber=qosNumber, gfpLOFD=gfpLOFD, gfpHCInErrors=gfpHCInErrors, pauseCHT=pauseCHT, PYSNMP_MODULE_ID=gige, maintenanceAutoTest=maintenanceAutoTest, cosIndex=cosIndex, gfpHCOutIdlePkts=gfpHCOutIdlePkts, gfpIndex=gfpIndex, gfpOOFD=gfpOOFD, qosSchedulingSystem=qosSchedulingSystem, gigeAutoTest=gigeAutoTest, gigeTable=gigeTable, maintenanceLoopback=maintenanceLoopback, cosBwRRatioMin=cosBwRRatioMin, gfpState=gfpState, maintenanceResetQosCounters=maintenanceResetQosCounters, gigeIndex=gigeIndex, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpOperStatus=gfpOperStatus, gigeEntry=gigeEntry, gfpFDSC=gfpFDSC, QosType=QosType)
