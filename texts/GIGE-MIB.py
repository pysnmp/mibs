...
mibBuilder.exportSymbols("GIGE-MIB", GfpState=GfpState, gfpHCOutOctets=gfpHCOutOctets, pauseMacDA=pauseMacDA, cosHCInCCDiscards=cosHCInCCDiscards, cosHCInOctets=cosHCInOctets, maintenanceLoopback=maintenanceLoopback, maintenancePRBSReceived=maintenancePRBSReceived, qosTable=qosTable, gfpFailure=gfpFailure, maintenancePRBSSent=maintenancePRBSSent, gigeEntry=gigeEntry, PYSNMP_MODULE_ID=gige, cosBwRRatioMax=cosBwRRatioMax, gfpHCInIdlePkts=gfpHCInIdlePkts, pauseCLT=pauseCLT, cosIndex=cosIndex, maintenanceTable=maintenanceTable, gige=gige, gfpState=gfpState, CosId=CosId, PauseFailure=PauseFailure, qosType=qosType, gigeAutoTest=gigeAutoTest, pauseIndex=pauseIndex, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, cosTable=cosTable, GfpFailure=GfpFailure, cosHCInPkts=cosHCInPkts, pauseSeverity=pauseSeverity, gfpIndex=gfpIndex, gfpLOFD=gfpLOFD, qosCongestionControl=qosCongestionControl, gfpOOFD=gfpOOFD, gfpSeverity=gfpSeverity, cosDefinition=cosDefinition, gfpHCInOctets=gfpHCInOctets, pauseTable=pauseTable, gfpHCOutPkts=gfpHCOutPkts, maintenanceAutoTest=maintenanceAutoTest, cosNumber=cosNumber, pauseNumber=pauseNumber, cosQosId=cosQosId, pauseTime=pauseTime, qosClassNumber=qosClassNumber, gfpHCOutIdlePkts=gfpHCOutIdlePkts, gfpIdleRate=gfpIdleRate, gigeSdhBandwidth=gigeSdhBandwidth, gfpAdminStatus=gfpAdminStatus, gfpMonitor=gfpMonitor, maintenanceResetLanCounters=maintenanceResetLanCounters, maintenanceNumber=maintenanceNumber, QosType=QosType, gfpHCInErrors=gfpHCInErrors, qosEntry=qosEntry, maintenanceResetQosCounters=maintenanceResetQosCounters, pauseModeRejected=pauseModeRejected, pauseMacSA=pauseMacSA, cosHCOutPkts=cosHCOutPkts, pauseEntry=pauseEntry, pauseMonitor=pauseMonitor, qosIndex=qosIndex, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gigeIndex=gigeIndex, pauseCHT=pauseCHT, gfpNumber=gfpNumber, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpEntry=gfpEntry, cosHCOutOctets=cosHCOutOctets, gfpOperStatus=gfpOperStatus, gigeWarmStart=gigeWarmStart, CongestionControl=CongestionControl, gfpTable=gfpTable, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, pauseFailure=pauseFailure, LoopbackGE=LoopbackGE, gfpHCInPkts=gfpHCInPkts, BandwidthSize=BandwidthSize, maintenanceEntry=maintenanceEntry, gfpSendingRate=gfpSendingRate, maintenanceResetAllCounters=maintenanceResetAllCounters, qosSchedulingSystem=qosSchedulingSystem, pauseBetweenTime=pauseBetweenTime, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, cosBwRRatioMin=cosBwRRatioMin, maintenanceIndex=maintenanceIndex, cosEntry=cosEntry, gfpHCFCSErrors=gfpHCFCSErrors, gigeTable=gigeTable, SchedulingSystem=SchedulingSystem, qosNumber=qosNumber, cosId=cosId, gfpFDSC=gfpFDSC, qosBwREnable=qosBwREnable, gigeNumber=gigeNumber)
