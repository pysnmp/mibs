...
Bits, Integer32, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, MibIdentifier, TimeTicks, NotificationType, Unsigned32, ModuleIdentity, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "MibIdentifier", "TimeTicks", "NotificationType", "Unsigned32", "ModuleIdentity", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("GIGE-MIB", gfpFDSC=gfpFDSC, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpFailure=gfpFailure, CosId=CosId, gigeSdhBandwidth=gigeSdhBandwidth, pauseMacDA=pauseMacDA, maintenanceIndex=maintenanceIndex, cosId=cosId, gfpEntry=gfpEntry, pauseFailure=pauseFailure, cosHCOutOctets=cosHCOutOctets, cosIndex=cosIndex, gfpHCOutOctets=gfpHCOutOctets, pauseEntry=pauseEntry, gfpNumber=gfpNumber, gfpState=gfpState, gfpHCInOctets=gfpHCInOctets, gfpHCInPkts=gfpHCInPkts, gfpHCOutIdlePkts=gfpHCOutIdlePkts, pauseCLT=pauseCLT, gfpTable=gfpTable, gigeTable=gigeTable, cosBwRRatioMin=cosBwRRatioMin, SchedulingSystem=SchedulingSystem, gigeWarmStart=gigeWarmStart, pauseIndex=pauseIndex, pauseNumber=pauseNumber, pauseSeverity=pauseSeverity, GfpState=GfpState, qosCongestionControl=qosCongestionControl, gigeEntry=gigeEntry, CongestionControl=CongestionControl, cosHCInCCDiscards=cosHCInCCDiscards, gfpIdleRate=gfpIdleRate, gfpSendingRate=gfpSendingRate, gigeIndex=gigeIndex, gfpOOFD=gfpOOFD, qosBwREnable=qosBwREnable, pauseBetweenTime=pauseBetweenTime, maintenanceAutoTest=maintenanceAutoTest, gfpSeverity=gfpSeverity, BandwidthSize=BandwidthSize, pauseCHT=pauseCHT, maintenanceNumber=maintenanceNumber, maintenanceTable=maintenanceTable, gigeAutoTest=gigeAutoTest, cosHCInOctets=cosHCInOctets, PYSNMP_MODULE_ID=gige, cosDefinition=cosDefinition, cosEntry=cosEntry, pauseTable=pauseTable, LoopbackGE=LoopbackGE, cosHCInPkts=cosHCInPkts, maintenanceResetAllCounters=maintenanceResetAllCounters, gfpOperStatus=gfpOperStatus, QosType=QosType, pauseModeRejected=pauseModeRejected, cosQosId=cosQosId, qosEntry=qosEntry, qosIndex=qosIndex, pauseMacSA=pauseMacSA, qosNumber=qosNumber, gfpLOFD=gfpLOFD, qosSchedulingSystem=qosSchedulingSystem, pauseTime=pauseTime, gfpHCOutPkts=gfpHCOutPkts, gfpIndex=gfpIndex, GfpFailure=GfpFailure, gfpHCInIdlePkts=gfpHCInIdlePkts, maintenanceLoopback=maintenanceLoopback, PauseFailure=PauseFailure, gfpAdminStatus=gfpAdminStatus, maintenanceResetQosCounters=maintenanceResetQosCounters, gigeNumber=gigeNumber, maintenanceEntry=maintenanceEntry, cosTable=cosTable, gfpHCInErrors=gfpHCInErrors, maintenancePRBSSent=maintenancePRBSSent, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, gfpHCFCSErrors=gfpHCFCSErrors, qosType=qosType, gige=gige, cosNumber=cosNumber, qosTable=qosTable, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, cosHCOutPkts=cosHCOutPkts, gfpMonitor=gfpMonitor, maintenancePRBSReceived=maintenancePRBSReceived, pauseMonitor=pauseMonitor, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, maintenanceResetLanCounters=maintenanceResetLanCounters, qosClassNumber=qosClassNumber, cosBwRRatioMax=cosBwRRatioMax)
