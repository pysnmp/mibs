...
mibBuilder.exportSymbols("GIGE-MIB", SchedulingSystem=SchedulingSystem, cosHCOutPkts=cosHCOutPkts, gfpHCOutPkts=gfpHCOutPkts, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, qosType=qosType, gfpOperStatus=gfpOperStatus, pauseBetweenTime=pauseBetweenTime, gigeWarmStart=gigeWarmStart, gfpNumber=gfpNumber, PauseFailure=PauseFailure, cosNumber=cosNumber, cosQosId=cosQosId, pauseCHT=pauseCHT, gfpSeverity=gfpSeverity, gigeAutoTest=gigeAutoTest, CongestionControl=CongestionControl, gigeIndex=gigeIndex, cosDefinition=cosDefinition, qosBwREnable=qosBwREnable, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, maintenanceResetQosCounters=maintenanceResetQosCounters, PYSNMP_MODULE_ID=gige, qosEntry=qosEntry, gige=gige, GfpState=GfpState, maintenancePRBSReceived=maintenancePRBSReceived, pauseNumber=pauseNumber, gigeSdhBandwidth=gigeSdhBandwidth, gfpHCOutOctets=gfpHCOutOctets, gfpTable=gfpTable, gfpAdminStatus=gfpAdminStatus, qosNumber=qosNumber, maintenanceIndex=maintenanceIndex, pauseCLT=pauseCLT, GfpFailure=GfpFailure, qosSchedulingSystem=qosSchedulingSystem, CosId=CosId, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, pauseEntry=pauseEntry, gfpIdleRate=gfpIdleRate, gfpHCOutIdlePkts=gfpHCOutIdlePkts, gigeEntry=gigeEntry, QosType=QosType, pauseSeverity=pauseSeverity, gfpHCInIdlePkts=gfpHCInIdlePkts, cosEntry=cosEntry, gigeNumber=gigeNumber, cosTable=cosTable, cosHCInCCDiscards=cosHCInCCDiscards, gfpEntry=gfpEntry, gfpState=gfpState, qosClassNumber=qosClassNumber, cosHCInPkts=cosHCInPkts, pauseMonitor=pauseMonitor, maintenanceNumber=maintenanceNumber, BandwidthSize=BandwidthSize, maintenanceAutoTest=maintenanceAutoTest, cosHCOutOctets=cosHCOutOctets, pauseMacSA=pauseMacSA, cosBwRRatioMin=cosBwRRatioMin, maintenanceResetAllCounters=maintenanceResetAllCounters, pauseTime=pauseTime, qosTable=qosTable, pauseFailure=pauseFailure, gfpHCInPkts=gfpHCInPkts, gfpHCInOctets=gfpHCInOctets, gigeTable=gigeTable, maintenanceTable=maintenanceTable, gfpLOFD=gfpLOFD, maintenanceLoopback=maintenanceLoopback, gfpFailure=gfpFailure, pauseModeRejected=pauseModeRejected, cosId=cosId, maintenanceResetLanCounters=maintenanceResetLanCounters, qosCongestionControl=qosCongestionControl, pauseMacDA=pauseMacDA, gfpIndex=gfpIndex, cosIndex=cosIndex, cosHCInOctets=cosHCInOctets, gfpHCInErrors=gfpHCInErrors, qosIndex=qosIndex, gfpFDSC=gfpFDSC, cosBwRRatioMax=cosBwRRatioMax, gfpMonitor=gfpMonitor, maintenancePRBSSent=maintenancePRBSSent, pauseTable=pauseTable, LoopbackGE=LoopbackGE, gfpOOFD=gfpOOFD, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpSendingRate=gfpSendingRate, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, pauseIndex=pauseIndex, gfpHCFCSErrors=gfpHCFCSErrors, maintenanceEntry=maintenanceEntry)
