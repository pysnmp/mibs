...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Counter32, ObjectIdentity, iso, Unsigned32, Bits, Gauge32, NotificationType, MibIdentifier, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Counter32", "ObjectIdentity", "iso", "Unsigned32", "Bits", "Gauge32", "NotificationType", "MibIdentifier", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("GIGE-MIB", qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, gigeSdhBandwidth=gigeSdhBandwidth, QosType=QosType, qosBwREnable=qosBwREnable, qosNumber=qosNumber, cosId=cosId, pauseTime=pauseTime, GfpFailure=GfpFailure, gfpHCInPkts=gfpHCInPkts, cosIndex=cosIndex, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, maintenanceResetGfpCounters=maintenanceResetGfpCounters, pauseCLT=pauseCLT, cosHCInCCDiscards=cosHCInCCDiscards, GfpState=GfpState, gfpSendingRate=gfpSendingRate, pauseMacDA=pauseMacDA, cosTable=cosTable, PYSNMP_MODULE_ID=gige, qosCongestionControl=qosCongestionControl, gfpOOFD=gfpOOFD, maintenanceResetLanCounters=maintenanceResetLanCounters, maintenancePRBSReceived=maintenancePRBSReceived, qosType=qosType, gfpNumber=gfpNumber, SchedulingSystem=SchedulingSystem, pauseMacSA=pauseMacSA, maintenanceNumber=maintenanceNumber, pauseEntry=pauseEntry, pauseCHT=pauseCHT, LoopbackGE=LoopbackGE, gfpHCInIdlePkts=gfpHCInIdlePkts, pauseIndex=pauseIndex, cosHCOutPkts=cosHCOutPkts, gigeWarmStart=gigeWarmStart, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gfpLOFD=gfpLOFD, maintenancePRBSSent=maintenancePRBSSent, BandwidthSize=BandwidthSize, gfpIdleRate=gfpIdleRate, PauseFailure=PauseFailure, gigeTable=gigeTable, qosTable=qosTable, maintenanceLoopback=maintenanceLoopback, cosDefinition=cosDefinition, pauseBetweenTime=pauseBetweenTime, gfpAdminStatus=gfpAdminStatus, qosClassNumber=qosClassNumber, gfpSeverity=gfpSeverity, gige=gige, pauseModeRejected=pauseModeRejected, qosEntry=qosEntry, pauseNumber=pauseNumber, cosHCInPkts=cosHCInPkts, maintenanceResetAllCounters=maintenanceResetAllCounters, cosHCOutOctets=cosHCOutOctets, gfpHCOutOctets=gfpHCOutOctets, qosSchedulingSystem=qosSchedulingSystem, gfpHCOutIdlePkts=gfpHCOutIdlePkts, pauseTable=pauseTable, maintenanceAutoTest=maintenanceAutoTest, gigeAutoTest=gigeAutoTest, gigeNumber=gigeNumber, CongestionControl=CongestionControl, gfpIndex=gfpIndex, cosBwRRatioMax=cosBwRRatioMax, gfpHCFCSErrors=gfpHCFCSErrors, gfpEntry=gfpEntry, gigeEntry=gigeEntry, maintenanceResetQosCounters=maintenanceResetQosCounters, gfpHCInOctets=gfpHCInOctets, maintenanceEntry=maintenanceEntry, cosHCInOctets=cosHCInOctets, cosQosId=cosQosId, maintenanceIndex=maintenanceIndex, gfpFDSC=gfpFDSC, cosBwRRatioMin=cosBwRRatioMin, cosNumber=cosNumber, gigeIndex=gigeIndex, gfpMonitor=gfpMonitor, pauseFailure=pauseFailure, gfpOperStatus=gfpOperStatus, qosIndex=qosIndex, gfpHCInErrors=gfpHCInErrors, pauseMonitor=pauseMonitor, pauseSeverity=pauseSeverity, gfpFailure=gfpFailure, CosId=CosId, cosEntry=cosEntry, gfpTable=gfpTable, maintenanceTable=maintenanceTable, gfpState=gfpState, gfpHCOutPkts=gfpHCOutPkts)
