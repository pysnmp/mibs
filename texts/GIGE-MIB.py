...
mibBuilder.exportSymbols("GIGE-MIB", maintenanceLoopback=maintenanceLoopback, PauseFailure=PauseFailure, cosHCOutOctets=cosHCOutOctets, gfpSendingRate=gfpSendingRate, gigeSdhBandwidth=gigeSdhBandwidth, cosIndex=cosIndex, pauseTime=pauseTime, pauseModeRejected=pauseModeRejected, gfpFDSC=gfpFDSC, pauseTable=pauseTable, gfpTable=gfpTable, gfpHCOutOctets=gfpHCOutOctets, gfpFailure=gfpFailure, SchedulingSystem=SchedulingSystem, pauseSeverity=pauseSeverity, maintenanceResetLanCounters=maintenanceResetLanCounters, cosQosId=cosQosId, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, maintenanceAutoTest=maintenanceAutoTest, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, cosBwRRatioMax=cosBwRRatioMax, gigeAutoTest=gigeAutoTest, cosDefinition=cosDefinition, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, maintenancePRBSSent=maintenancePRBSSent, gfpEntry=gfpEntry, gfpNumber=gfpNumber, pauseCHT=pauseCHT, qosTable=qosTable, gfpState=gfpState, PYSNMP_MODULE_ID=gige, maintenanceResetAllCounters=maintenanceResetAllCounters, qosNumber=qosNumber, cosHCInPkts=cosHCInPkts, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, pauseNumber=pauseNumber, pauseCLT=pauseCLT, cosHCOutPkts=cosHCOutPkts, gfpHCOutIdlePkts=gfpHCOutIdlePkts, pauseMacDA=pauseMacDA, QosType=QosType, maintenanceEntry=maintenanceEntry, gfpIndex=gfpIndex, LoopbackGE=LoopbackGE, maintenanceResetQosCounters=maintenanceResetQosCounters, cosBwRRatioMin=cosBwRRatioMin, qosBwREnable=qosBwREnable, maintenanceTable=maintenanceTable, gfpHCFCSErrors=gfpHCFCSErrors, qosClassNumber=qosClassNumber, gigeNumber=gigeNumber, gfpSeverity=gfpSeverity, gigeIndex=gigeIndex, cosEntry=cosEntry, maintenancePRBSReceived=maintenancePRBSReceived, pauseBetweenTime=pauseBetweenTime, pauseEntry=pauseEntry, gfpHCInIdlePkts=gfpHCInIdlePkts, gfpHCInPkts=gfpHCInPkts, cosNumber=cosNumber, pauseMacSA=pauseMacSA, gfpHCOutPkts=gfpHCOutPkts, maintenanceNumber=maintenanceNumber, pauseIndex=pauseIndex, gfpIdleRate=gfpIdleRate, CongestionControl=CongestionControl, gfpHCInOctets=gfpHCInOctets, maintenanceResetGfpCounters=maintenanceResetGfpCounters, qosCongestionControl=qosCongestionControl, maintenanceIndex=maintenanceIndex, gfpAdminStatus=gfpAdminStatus, pauseFailure=pauseFailure, gigeWarmStart=gigeWarmStart, gige=gige, qosSchedulingSystem=qosSchedulingSystem, qosEntry=qosEntry, GfpState=GfpState, gigeEntry=gigeEntry, gfpLOFD=gfpLOFD, GfpFailure=GfpFailure, gfpOperStatus=gfpOperStatus, gfpOOFD=gfpOOFD, gfpHCInErrors=gfpHCInErrors, pauseMonitor=pauseMonitor, BandwidthSize=BandwidthSize, qosType=qosType, cosHCInCCDiscards=cosHCInCCDiscards, cosTable=cosTable, qosIndex=qosIndex, cosHCInOctets=cosHCInOctets, cosId=cosId, gfpMonitor=gfpMonitor, gigeTable=gigeTable, CosId=CosId)
