...
mibBuilder.exportSymbols("GIGE-MIB", qosClassNumber=qosClassNumber, gfpHCOutPkts=gfpHCOutPkts, gfpSeverity=gfpSeverity, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, pauseCHT=pauseCHT, GfpFailure=GfpFailure, gfpFailure=gfpFailure, PauseFailure=PauseFailure, cosId=cosId, gfpTable=gfpTable, qosSchedulingSystem=qosSchedulingSystem, cosHCOutPkts=cosHCOutPkts, cosNumber=cosNumber, qosNumber=qosNumber, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gigeSdhBandwidth=gigeSdhBandwidth, pauseMonitor=pauseMonitor, gfpAdminStatus=gfpAdminStatus, pauseTable=pauseTable, gfpHCFCSErrors=gfpHCFCSErrors, cosHCInOctets=cosHCInOctets, gfpNumber=gfpNumber, cosBwRRatioMin=cosBwRRatioMin, gigeEntry=gigeEntry, maintenanceResetQosCounters=maintenanceResetQosCounters, pauseMacDA=pauseMacDA, gigeWarmStart=gigeWarmStart, gfpState=gfpState, pauseCLT=pauseCLT, pauseIndex=pauseIndex, cosHCInPkts=cosHCInPkts, cosTable=cosTable, gfpHCOutIdlePkts=gfpHCOutIdlePkts, LoopbackGE=LoopbackGE, GfpState=GfpState, cosEntry=cosEntry, gfpEntry=gfpEntry, pauseMacSA=pauseMacSA, QosType=QosType, qosType=qosType, cosBwRRatioMax=cosBwRRatioMax, gfpLOFD=gfpLOFD, gfpSendingRate=gfpSendingRate, maintenanceResetLanCounters=maintenanceResetLanCounters, pauseNumber=pauseNumber, gfpIdleRate=gfpIdleRate, pauseModeRejected=pauseModeRejected, maintenanceResetGfpCounters=maintenanceResetGfpCounters, pauseTime=pauseTime, gige=gige, maintenanceTable=maintenanceTable, pauseEntry=pauseEntry, CosId=CosId, gfpOperStatus=gfpOperStatus, maintenancePRBSReceived=maintenancePRBSReceived, maintenanceEntry=maintenanceEntry, pauseFailure=pauseFailure, SchedulingSystem=SchedulingSystem, gigeIndex=gigeIndex, BandwidthSize=BandwidthSize, cosIndex=cosIndex, cosQosId=cosQosId, qosEntry=qosEntry, qosTable=qosTable, maintenanceIndex=maintenanceIndex, cosHCOutOctets=cosHCOutOctets, gfpOOFD=gfpOOFD, qosBwREnable=qosBwREnable, gfpHCInPkts=gfpHCInPkts, maintenanceNumber=maintenanceNumber, cosDefinition=cosDefinition, maintenancePRBSSent=maintenancePRBSSent, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpHCInIdlePkts=gfpHCInIdlePkts, gfpMonitor=gfpMonitor, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, CongestionControl=CongestionControl, pauseSeverity=pauseSeverity, qosIndex=qosIndex, maintenanceResetAllCounters=maintenanceResetAllCounters, gfpIndex=gfpIndex, cosHCInCCDiscards=cosHCInCCDiscards, maintenanceLoopback=maintenanceLoopback, gigeAutoTest=gigeAutoTest, qosCongestionControl=qosCongestionControl, gfpFDSC=gfpFDSC, gigeTable=gigeTable, gfpHCOutOctets=gfpHCOutOctets, pauseBetweenTime=pauseBetweenTime, PYSNMP_MODULE_ID=gige, gfpHCInErrors=gfpHCInErrors, maintenanceAutoTest=maintenanceAutoTest, gigeNumber=gigeNumber, gfpHCInOctets=gfpHCInOctets)
