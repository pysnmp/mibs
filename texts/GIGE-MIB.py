...
mibBuilder.exportSymbols("GIGE-MIB", gfpHCOutIdlePkts=gfpHCOutIdlePkts, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, maintenanceResetAllCounters=maintenanceResetAllCounters, gfpHCOutPkts=gfpHCOutPkts, cosHCInPkts=cosHCInPkts, gigeNumber=gigeNumber, gfpAdminStatus=gfpAdminStatus, gfpHCInIdlePkts=gfpHCInIdlePkts, pauseTime=pauseTime, maintenanceTable=maintenanceTable, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, PauseFailure=PauseFailure, maintenanceResetQosCounters=maintenanceResetQosCounters, qosNumber=qosNumber, maintenanceIndex=maintenanceIndex, maintenancePRBSReceived=maintenancePRBSReceived, PYSNMP_MODULE_ID=gige, GfpFailure=GfpFailure, gfpNumber=gfpNumber, cosIndex=cosIndex, gfpFailure=gfpFailure, gigeAutoTest=gigeAutoTest, gfpOOFD=gfpOOFD, gfpSeverity=gfpSeverity, gfpOperStatus=gfpOperStatus, cosNumber=cosNumber, gfpHCInErrors=gfpHCInErrors, qosTable=qosTable, gigeWarmStart=gigeWarmStart, gfpTable=gfpTable, cosQosId=cosQosId, gfpLOFD=gfpLOFD, cosHCOutOctets=cosHCOutOctets, cosId=cosId, LoopbackGE=LoopbackGE, cosEntry=cosEntry, maintenanceNumber=maintenanceNumber, gfpIdleRate=gfpIdleRate, qosEntry=qosEntry, qosSchedulingSystem=qosSchedulingSystem, gfpHCInOctets=gfpHCInOctets, pauseFailure=pauseFailure, gfpHCFCSErrors=gfpHCFCSErrors, pauseBetweenTime=pauseBetweenTime, pauseCHT=pauseCHT, cosHCOutPkts=cosHCOutPkts, cosBwRRatioMax=cosBwRRatioMax, gfpHCOutOctets=gfpHCOutOctets, pauseEntry=pauseEntry, CongestionControl=CongestionControl, cosTable=cosTable, cosBwRRatioMin=cosBwRRatioMin, gigeSdhBandwidth=gigeSdhBandwidth, QosType=QosType, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpHCInPkts=gfpHCInPkts, gige=gige, pauseModeRejected=pauseModeRejected, SchedulingSystem=SchedulingSystem, pauseCLT=pauseCLT, cosHCInCCDiscards=cosHCInCCDiscards, qosCongestionControl=qosCongestionControl, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, qosType=qosType, gigeTable=gigeTable, gfpSendingRate=gfpSendingRate, maintenancePRBSSent=maintenancePRBSSent, maintenanceAutoTest=maintenanceAutoTest, cosDefinition=cosDefinition, pauseNumber=pauseNumber, pauseTable=pauseTable, pauseMonitor=pauseMonitor, gfpMonitor=gfpMonitor, pauseSeverity=pauseSeverity, maintenanceResetLanCounters=maintenanceResetLanCounters, maintenanceLoopback=maintenanceLoopback, gfpIndex=gfpIndex, gigeEntry=gigeEntry, qosClassNumber=qosClassNumber, gfpEntry=gfpEntry, cosHCInOctets=cosHCInOctets, pauseMacDA=pauseMacDA, qosIndex=qosIndex, CosId=CosId, pauseMacSA=pauseMacSA, BandwidthSize=BandwidthSize, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gfpState=gfpState, maintenanceEntry=maintenanceEntry, qosBwREnable=qosBwREnable, gfpFDSC=gfpFDSC, gigeIndex=gigeIndex, pauseIndex=pauseIndex, GfpState=GfpState)
