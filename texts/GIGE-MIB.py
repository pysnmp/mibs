...
mibBuilder.exportSymbols("GIGE-MIB", LoopbackGE=LoopbackGE, gfpHCOutIdlePkts=gfpHCOutIdlePkts, qosBwREnable=qosBwREnable, gfpHCOutOctets=gfpHCOutOctets, qosNumber=qosNumber, maintenanceResetQosCounters=maintenanceResetQosCounters, gigeEntry=gigeEntry, cosHCInOctets=cosHCInOctets, cosIndex=cosIndex, gfpMonitor=gfpMonitor, maintenanceNumber=maintenanceNumber, gfpSeverity=gfpSeverity, pauseTime=pauseTime, gigeWarmStart=gigeWarmStart, gfpHCInPkts=gfpHCInPkts, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, gfpOperStatus=gfpOperStatus, GfpState=GfpState, pauseCLT=pauseCLT, cosHCOutOctets=cosHCOutOctets, pauseBetweenTime=pauseBetweenTime, gigeSdhBandwidth=gigeSdhBandwidth, gfpOOFD=gfpOOFD, pauseModeRejected=pauseModeRejected, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, qosSchedulingSystem=qosSchedulingSystem, pauseSeverity=pauseSeverity, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, pauseCHT=pauseCHT, cosBwRRatioMax=cosBwRRatioMax, cosHCOutPkts=cosHCOutPkts, PYSNMP_MODULE_ID=gige, qosType=qosType, pauseEntry=pauseEntry, cosEntry=cosEntry, gfpHCFCSErrors=gfpHCFCSErrors, gigeNumber=gigeNumber, maintenanceIndex=maintenanceIndex, gfpSendingRate=gfpSendingRate, cosTable=cosTable, cosBwRRatioMin=cosBwRRatioMin, CosId=CosId, pauseIndex=pauseIndex, gfpHCOutPkts=gfpHCOutPkts, maintenanceResetLanCounters=maintenanceResetLanCounters, QosType=QosType, gigeAutoTest=gigeAutoTest, gfpAdminStatus=gfpAdminStatus, maintenancePRBSSent=maintenancePRBSSent, gfpTable=gfpTable, pauseMacDA=pauseMacDA, gfpFailure=gfpFailure, qosClassNumber=qosClassNumber, maintenanceLoopback=maintenanceLoopback, BandwidthSize=BandwidthSize, pauseFailure=pauseFailure, maintenanceTable=maintenanceTable, cosNumber=cosNumber, gfpHCInOctets=gfpHCInOctets, qosEntry=qosEntry, qosCongestionControl=qosCongestionControl, maintenanceResetAllCounters=maintenanceResetAllCounters, gfpNumber=gfpNumber, pauseMacSA=pauseMacSA, PauseFailure=PauseFailure, gfpLOFD=gfpLOFD, qosTable=qosTable, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpFDSC=gfpFDSC, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, maintenanceEntry=maintenanceEntry, maintenancePRBSReceived=maintenancePRBSReceived, gfpIndex=gfpIndex, gfpHCInIdlePkts=gfpHCInIdlePkts, gigeIndex=gigeIndex, CongestionControl=CongestionControl, cosId=cosId, gfpHCInErrors=gfpHCInErrors, pauseNumber=pauseNumber, cosHCInPkts=cosHCInPkts, gige=gige, gigeTable=gigeTable, GfpFailure=GfpFailure, cosDefinition=cosDefinition, gfpState=gfpState, pauseMonitor=pauseMonitor, SchedulingSystem=SchedulingSystem, maintenanceAutoTest=maintenanceAutoTest, gfpEntry=gfpEntry, cosQosId=cosQosId, qosIndex=qosIndex, pauseTable=pauseTable, cosHCInCCDiscards=cosHCInCCDiscards, gfpIdleRate=gfpIdleRate)
