...
mibBuilder.exportSymbols("GIGE-MIB", gfpNumber=gfpNumber, cosDefinition=cosDefinition, gigeWarmStart=gigeWarmStart, gfpOperStatus=gfpOperStatus, qosClassNumber=qosClassNumber, LoopbackGE=LoopbackGE, maintenanceAutoTest=maintenanceAutoTest, gfpMonitor=gfpMonitor, cosId=cosId, cosBwRRatioMax=cosBwRRatioMax, gigeAutoTest=gigeAutoTest, qosType=qosType, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, qosEntry=qosEntry, qosBwREnable=qosBwREnable, pauseModeRejected=pauseModeRejected, CongestionControl=CongestionControl, gigeEntry=gigeEntry, gigeTable=gigeTable, gfpHCInPkts=gfpHCInPkts, gfpSeverity=gfpSeverity, gfpLOFD=gfpLOFD, gfpIndex=gfpIndex, cosHCOutPkts=cosHCOutPkts, gfpFailure=gfpFailure, gfpHCOutPkts=gfpHCOutPkts, pauseCHT=pauseCHT, maintenanceLoopback=maintenanceLoopback, pauseSeverity=pauseSeverity, pauseMonitor=pauseMonitor, gfpHCInErrors=gfpHCInErrors, pauseEntry=pauseEntry, gigeNumber=gigeNumber, pauseIndex=pauseIndex, cosTable=cosTable, maintenanceIndex=maintenanceIndex, maintenanceResetLanCounters=maintenanceResetLanCounters, gfpHCInIdlePkts=gfpHCInIdlePkts, SchedulingSystem=SchedulingSystem, gfpTable=gfpTable, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, cosIndex=cosIndex, cosQosId=cosQosId, cosEntry=cosEntry, gfpState=gfpState, gigeIndex=gigeIndex, cosHCOutOctets=cosHCOutOctets, gfpHCOutOctets=gfpHCOutOctets, maintenancePRBSReceived=maintenancePRBSReceived, GfpState=GfpState, cosBwRRatioMin=cosBwRRatioMin, gige=gige, cosHCInPkts=cosHCInPkts, QosType=QosType, gfpFDSC=gfpFDSC, gfpAdminStatus=gfpAdminStatus, pauseMacSA=pauseMacSA, gfpSendingRate=gfpSendingRate, maintenanceResetAllCounters=maintenanceResetAllCounters, maintenancePRBSSent=maintenancePRBSSent, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, maintenanceTable=maintenanceTable, qosNumber=qosNumber, pauseMacDA=pauseMacDA, gfpIdleRate=gfpIdleRate, pauseTime=pauseTime, maintenanceEntry=maintenanceEntry, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, pauseBetweenTime=pauseBetweenTime, gfpHCInOctets=gfpHCInOctets, PauseFailure=PauseFailure, GfpFailure=GfpFailure, qosTable=qosTable, pauseFailure=pauseFailure, BandwidthSize=BandwidthSize, maintenanceResetQosCounters=maintenanceResetQosCounters, gfpOOFD=gfpOOFD, gfpEntry=gfpEntry, pauseTable=pauseTable, gfpHCOutIdlePkts=gfpHCOutIdlePkts, CosId=CosId, qosSchedulingSystem=qosSchedulingSystem, cosHCInCCDiscards=cosHCInCCDiscards, gfpHCFCSErrors=gfpHCFCSErrors, pauseNumber=pauseNumber, cosNumber=cosNumber, cosHCInOctets=cosHCInOctets, gigeSdhBandwidth=gigeSdhBandwidth, maintenanceResetGfpCounters=maintenanceResetGfpCounters, qosCongestionControl=qosCongestionControl, pauseCLT=pauseCLT, PYSNMP_MODULE_ID=gige, maintenanceNumber=maintenanceNumber, qosIndex=qosIndex)
