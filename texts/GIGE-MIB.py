...
mibBuilder.exportSymbols("GIGE-MIB", maintenanceAutoTest=maintenanceAutoTest, qosIndex=qosIndex, maintenanceNumber=maintenanceNumber, pauseEntry=pauseEntry, gigeNumber=gigeNumber, qosEntry=qosEntry, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, qosBwREnable=qosBwREnable, gfpEntry=gfpEntry, qosClassNumber=qosClassNumber, PYSNMP_MODULE_ID=gige, gigeIndex=gigeIndex, pauseIndex=pauseIndex, gigeAutoTest=gigeAutoTest, CongestionControl=CongestionControl, gfpMonitor=gfpMonitor, GfpFailure=GfpFailure, CosId=CosId, gfpHCOutPkts=gfpHCOutPkts, maintenanceLoopback=maintenanceLoopback, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, cosBwRRatioMax=cosBwRRatioMax, gfpHCInErrors=gfpHCInErrors, maintenanceResetGfpCounters=maintenanceResetGfpCounters, maintenanceResetLanCounters=maintenanceResetLanCounters, gfpLOFD=gfpLOFD, gfpSendingRate=gfpSendingRate, gfpFDSC=gfpFDSC, cosQosId=cosQosId, gfpNumber=gfpNumber, pauseTable=pauseTable, PauseFailure=PauseFailure, gfpHCOutOctets=gfpHCOutOctets, pauseMacDA=pauseMacDA, gfpOperStatus=gfpOperStatus, gigeSdhBandwidth=gigeSdhBandwidth, pauseBetweenTime=pauseBetweenTime, maintenancePRBSReceived=maintenancePRBSReceived, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, cosBwRRatioMin=cosBwRRatioMin, maintenancePRBSSent=maintenancePRBSSent, SchedulingSystem=SchedulingSystem, pauseTime=pauseTime, cosEntry=cosEntry, gfpOOFD=gfpOOFD, cosHCInOctets=cosHCInOctets, gige=gige, gigeWarmStart=gigeWarmStart, BandwidthSize=BandwidthSize, gfpHCInOctets=gfpHCInOctets, cosHCOutOctets=cosHCOutOctets, gigeEntry=gigeEntry, maintenanceResetAllCounters=maintenanceResetAllCounters, cosHCInCCDiscards=cosHCInCCDiscards, gfpSeverity=gfpSeverity, cosTable=cosTable, GfpState=GfpState, gfpAdminStatus=gfpAdminStatus, gfpFailure=gfpFailure, maintenanceTable=maintenanceTable, QosType=QosType, gfpIndex=gfpIndex, cosIndex=cosIndex, qosCongestionControl=qosCongestionControl, gfpState=gfpState, qosTable=qosTable, gfpHCInPkts=gfpHCInPkts, pauseModeRejected=pauseModeRejected, maintenanceEntry=maintenanceEntry, pauseCHT=pauseCHT, pauseNumber=pauseNumber, qosSchedulingSystem=qosSchedulingSystem, cosHCOutPkts=cosHCOutPkts, gfpIdleRate=gfpIdleRate, gfpHCOutIdlePkts=gfpHCOutIdlePkts, pauseSeverity=pauseSeverity, pauseMonitor=pauseMonitor, LoopbackGE=LoopbackGE, maintenanceIndex=maintenanceIndex, pauseFailure=pauseFailure, maintenanceResetQosCounters=maintenanceResetQosCounters, cosId=cosId, qosNumber=qosNumber, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, cosHCInPkts=cosHCInPkts, pauseCLT=pauseCLT, gfpHCInIdlePkts=gfpHCInIdlePkts, gigeTable=gigeTable, gfpTable=gfpTable, pauseMacSA=pauseMacSA, cosDefinition=cosDefinition, qosType=qosType, cosNumber=cosNumber, gfpHCFCSErrors=gfpHCFCSErrors)
