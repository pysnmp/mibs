...
mibBuilder.exportSymbols("GIGE-MIB", qosClassNumber=qosClassNumber, cosQosId=cosQosId, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpHCInPkts=gfpHCInPkts, GfpFailure=GfpFailure, gfpIdleRate=gfpIdleRate, cosId=cosId, gfpSendingRate=gfpSendingRate, pauseFailure=pauseFailure, gfpState=gfpState, cosHCInCCDiscards=cosHCInCCDiscards, maintenanceTable=maintenanceTable, qosTable=qosTable, qosSchedulingSystem=qosSchedulingSystem, cosBwRRatioMin=cosBwRRatioMin, gfpNumber=gfpNumber, gfpHCOutIdlePkts=gfpHCOutIdlePkts, cosDefinition=cosDefinition, gfpIndex=gfpIndex, SchedulingSystem=SchedulingSystem, pauseTable=pauseTable, pauseSeverity=pauseSeverity, gigeIndex=gigeIndex, cosHCInOctets=cosHCInOctets, GfpState=GfpState, pauseMacDA=pauseMacDA, gigeTable=gigeTable, maintenanceResetQosCounters=maintenanceResetQosCounters, gfpMonitor=gfpMonitor, gigeNumber=gigeNumber, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, pauseBetweenTime=pauseBetweenTime, PYSNMP_MODULE_ID=gige, gigeWarmStart=gigeWarmStart, maintenancePRBSReceived=maintenancePRBSReceived, maintenanceResetLanCounters=maintenanceResetLanCounters, pauseTime=pauseTime, gfpSeverity=gfpSeverity, pauseCLT=pauseCLT, maintenanceLoopback=maintenanceLoopback, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, gfpLOFD=gfpLOFD, CosId=CosId, pauseMacSA=pauseMacSA, qosNumber=qosNumber, gfpHCInErrors=gfpHCInErrors, gigeAutoTest=gigeAutoTest, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, cosIndex=cosIndex, pauseNumber=pauseNumber, qosType=qosType, qosBwREnable=qosBwREnable, CongestionControl=CongestionControl, cosHCOutPkts=cosHCOutPkts, gfpHCInOctets=gfpHCInOctets, cosHCOutOctets=cosHCOutOctets, qosEntry=qosEntry, maintenanceEntry=maintenanceEntry, qosIndex=qosIndex, pauseMonitor=pauseMonitor, pauseEntry=pauseEntry, cosTable=cosTable, cosBwRRatioMax=cosBwRRatioMax, gfpFailure=gfpFailure, pauseCHT=pauseCHT, maintenanceNumber=maintenanceNumber, gfpOOFD=gfpOOFD, gige=gige, gfpFDSC=gfpFDSC, pauseIndex=pauseIndex, cosHCInPkts=cosHCInPkts, maintenanceIndex=maintenanceIndex, maintenancePRBSSent=maintenancePRBSSent, pauseModeRejected=pauseModeRejected, gigeSdhBandwidth=gigeSdhBandwidth, gfpOperStatus=gfpOperStatus, BandwidthSize=BandwidthSize, maintenanceResetAllCounters=maintenanceResetAllCounters, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gigeEntry=gigeEntry, qosCongestionControl=qosCongestionControl, gfpHCFCSErrors=gfpHCFCSErrors, gfpHCOutPkts=gfpHCOutPkts, gfpAdminStatus=gfpAdminStatus, gfpTable=gfpTable, QosType=QosType, gfpEntry=gfpEntry, gfpHCInIdlePkts=gfpHCInIdlePkts, gfpHCOutOctets=gfpHCOutOctets, maintenanceAutoTest=maintenanceAutoTest, PauseFailure=PauseFailure, cosNumber=cosNumber, LoopbackGE=LoopbackGE, cosEntry=cosEntry)
