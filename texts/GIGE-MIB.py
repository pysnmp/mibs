...
ModuleIdentity, Bits, Counter64, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Unsigned32, Integer32, TimeTicks, iso, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Counter64", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Unsigned32", "Integer32", "TimeTicks", "iso", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("GIGE-MIB", QosType=QosType, maintenanceIndex=maintenanceIndex, gfpHCInIdlePkts=gfpHCInIdlePkts, gfpFDSC=gfpFDSC, gigeAutoTest=gigeAutoTest, pauseIndex=pauseIndex, CosId=CosId, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, pauseCHT=pauseCHT, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpIdleRate=gfpIdleRate, pauseModeRejected=pauseModeRejected, pauseMacSA=pauseMacSA, LoopbackGE=LoopbackGE, gfpIndex=gfpIndex, maintenanceResetAllCounters=maintenanceResetAllCounters, cosBwRRatioMax=cosBwRRatioMax, gigeSdhBandwidth=gigeSdhBandwidth, gigeNumber=gigeNumber, cosQosId=cosQosId, maintenancePRBSSent=maintenancePRBSSent, qosCongestionControl=qosCongestionControl, pauseMonitor=pauseMonitor, cosIndex=cosIndex, qosClassNumber=qosClassNumber, pauseMacDA=pauseMacDA, gfpTable=gfpTable, GfpState=GfpState, cosBwRRatioMin=cosBwRRatioMin, qosEntry=qosEntry, qosType=qosType, pauseCLT=pauseCLT, gfpHCInOctets=gfpHCInOctets, maintenanceAutoTest=maintenanceAutoTest, qosTable=qosTable, maintenancePRBSReceived=maintenancePRBSReceived, pauseEntry=pauseEntry, gfpHCInErrors=gfpHCInErrors, cosHCInPkts=cosHCInPkts, gfpAdminStatus=gfpAdminStatus, maintenanceTable=maintenanceTable, gfpOOFD=gfpOOFD, maintenanceResetQosCounters=maintenanceResetQosCounters, gigeIndex=gigeIndex, gigeWarmStart=gigeWarmStart, pauseFailure=pauseFailure, gfpHCInPkts=gfpHCInPkts, qosIndex=qosIndex, cosHCOutOctets=cosHCOutOctets, cosDefinition=cosDefinition, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, pauseNumber=pauseNumber, maintenanceLoopback=maintenanceLoopback, gfpSeverity=gfpSeverity, gfpLOFD=gfpLOFD, cosHCOutPkts=cosHCOutPkts, BandwidthSize=BandwidthSize, PYSNMP_MODULE_ID=gige, gigeEntry=gigeEntry, gfpState=gfpState, SchedulingSystem=SchedulingSystem, maintenanceResetLanCounters=maintenanceResetLanCounters, gfpHCFCSErrors=gfpHCFCSErrors, cosEntry=cosEntry, gfpHCOutIdlePkts=gfpHCOutIdlePkts, gfpHCOutPkts=gfpHCOutPkts, qosNumber=qosNumber, gfpOperStatus=gfpOperStatus, gfpFailure=gfpFailure, cosNumber=cosNumber, gfpEntry=gfpEntry, cosHCInOctets=cosHCInOctets, gfpMonitor=gfpMonitor, pauseSeverity=pauseSeverity, gige=gige, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, pauseTime=pauseTime, qosSchedulingSystem=qosSchedulingSystem, pauseBetweenTime=pauseBetweenTime, PauseFailure=PauseFailure, cosHCInCCDiscards=cosHCInCCDiscards, gigeTable=gigeTable, GfpFailure=GfpFailure, cosTable=cosTable, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, cosId=cosId, gfpSendingRate=gfpSendingRate, gfpHCOutOctets=gfpHCOutOctets, maintenanceEntry=maintenanceEntry, CongestionControl=CongestionControl, gfpNumber=gfpNumber, qosBwREnable=qosBwREnable, pauseTable=pauseTable, maintenanceNumber=maintenanceNumber)
