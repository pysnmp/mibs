...
mibBuilder.exportSymbols("GIGE-MIB", pauseMacSA=pauseMacSA, pauseModeRejected=pauseModeRejected, gfpHCOutOctets=gfpHCOutOctets, maintenanceResetAllCounters=maintenanceResetAllCounters, qosIndex=qosIndex, gfpHCOutPkts=gfpHCOutPkts, cosHCOutPkts=cosHCOutPkts, gfpHCInOctets=gfpHCInOctets, pauseNumber=pauseNumber, maintenanceResetLanCounters=maintenanceResetLanCounters, gfpHCInPkts=gfpHCInPkts, gfpNumber=gfpNumber, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, qosClassNumber=qosClassNumber, gigeIndex=gigeIndex, qosBwREnable=qosBwREnable, pauseMacDA=pauseMacDA, cosTable=cosTable, gfpHCOutIdlePkts=gfpHCOutIdlePkts, gfpSeverity=gfpSeverity, gfpEntry=gfpEntry, qosCongestionControl=qosCongestionControl, cosId=cosId, gfpMonitor=gfpMonitor, gfpFDSC=gfpFDSC, qosSchedulingSystem=qosSchedulingSystem, maintenancePRBSReceived=maintenancePRBSReceived, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gfpSendingRate=gfpSendingRate, maintenanceLoopback=maintenanceLoopback, cosHCInOctets=cosHCInOctets, maintenanceResetQosCounters=maintenanceResetQosCounters, pauseTable=pauseTable, gfpFailure=gfpFailure, gigeNumber=gigeNumber, QosType=QosType, gigeTable=gigeTable, gfpIndex=gfpIndex, gfpHCInErrors=gfpHCInErrors, gigeEntry=gigeEntry, gigeAutoTest=gigeAutoTest, CosId=CosId, gfpOOFD=gfpOOFD, gfpLOFD=gfpLOFD, gfpOperStatus=gfpOperStatus, pauseSeverity=pauseSeverity, GfpFailure=GfpFailure, gigeWarmStart=gigeWarmStart, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, BandwidthSize=BandwidthSize, LoopbackGE=LoopbackGE, gigeSdhBandwidth=gigeSdhBandwidth, PauseFailure=PauseFailure, pauseCHT=pauseCHT, cosQosId=cosQosId, pauseTime=pauseTime, cosDefinition=cosDefinition, pauseFailure=pauseFailure, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, cosBwRRatioMax=cosBwRRatioMax, SchedulingSystem=SchedulingSystem, maintenanceTable=maintenanceTable, pauseEntry=pauseEntry, pauseIndex=pauseIndex, maintenanceNumber=maintenanceNumber, maintenanceIndex=maintenanceIndex, gfpHCFCSErrors=gfpHCFCSErrors, qosType=qosType, gfpState=gfpState, maintenanceAutoTest=maintenanceAutoTest, gfpAdminStatus=gfpAdminStatus, maintenanceResetGfpCounters=maintenanceResetGfpCounters, cosEntry=cosEntry, qosTable=qosTable, cosHCOutOctets=cosHCOutOctets, pauseBetweenTime=pauseBetweenTime, gige=gige, GfpState=GfpState, cosNumber=cosNumber, maintenanceEntry=maintenanceEntry, cosBwRRatioMin=cosBwRRatioMin, gfpTable=gfpTable, maintenancePRBSSent=maintenancePRBSSent, cosIndex=cosIndex, CongestionControl=CongestionControl, gfpHCInIdlePkts=gfpHCInIdlePkts, qosNumber=qosNumber, pauseCLT=pauseCLT, cosHCInCCDiscards=cosHCInCCDiscards, pauseMonitor=pauseMonitor, PYSNMP_MODULE_ID=gige, gfpIdleRate=gfpIdleRate, qosEntry=qosEntry, cosHCInPkts=cosHCInPkts)
