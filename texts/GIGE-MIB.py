...
mibBuilder.exportSymbols("GIGE-MIB", pauseSeverity=pauseSeverity, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, cosNumber=cosNumber, pauseTime=pauseTime, cosHCOutOctets=cosHCOutOctets, gige=gige, gfpHCOutPkts=gfpHCOutPkts, gigeEntry=gigeEntry, cosTable=cosTable, gfpHCOutIdlePkts=gfpHCOutIdlePkts, gigeAutoTest=gigeAutoTest, pauseEntry=pauseEntry, cosId=cosId, gfpAdminStatus=gfpAdminStatus, pauseIndex=pauseIndex, qosBwREnable=qosBwREnable, maintenanceTable=maintenanceTable, maintenanceNumber=maintenanceNumber, maintenanceResetAllCounters=maintenanceResetAllCounters, gigeIndex=gigeIndex, cosIndex=cosIndex, gfpHCFCSErrors=gfpHCFCSErrors, gigeWarmStart=gigeWarmStart, LoopbackGE=LoopbackGE, pauseTable=pauseTable, pauseModeRejected=pauseModeRejected, gfpOOFD=gfpOOFD, pauseMacSA=pauseMacSA, qosIndex=qosIndex, maintenanceEntry=maintenanceEntry, cosBwRRatioMin=cosBwRRatioMin, cosHCInCCDiscards=cosHCInCCDiscards, GfpState=GfpState, gigeTable=gigeTable, cosHCInPkts=cosHCInPkts, qosType=qosType, qosEntry=qosEntry, maintenanceResetQosCounters=maintenanceResetQosCounters, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, gfpEntry=gfpEntry, maintenanceIndex=maintenanceIndex, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpOperStatus=gfpOperStatus, gfpHCInPkts=gfpHCInPkts, qosNumber=qosNumber, gfpHCOutOctets=gfpHCOutOctets, qosCongestionControl=qosCongestionControl, qosSchedulingSystem=qosSchedulingSystem, cosDefinition=cosDefinition, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, pauseMacDA=pauseMacDA, gfpFDSC=gfpFDSC, PauseFailure=PauseFailure, pauseNumber=pauseNumber, pauseMonitor=pauseMonitor, GfpFailure=GfpFailure, gfpNumber=gfpNumber, gfpHCInIdlePkts=gfpHCInIdlePkts, gfpIdleRate=gfpIdleRate, gfpSeverity=gfpSeverity, cosHCOutPkts=cosHCOutPkts, QosType=QosType, cosEntry=cosEntry, pauseCHT=pauseCHT, SchedulingSystem=SchedulingSystem, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, gigeNumber=gigeNumber, maintenancePRBSReceived=maintenancePRBSReceived, CosId=CosId, gfpHCInOctets=gfpHCInOctets, gigeSdhBandwidth=gigeSdhBandwidth, PYSNMP_MODULE_ID=gige, cosQosId=cosQosId, BandwidthSize=BandwidthSize, pauseBetweenTime=pauseBetweenTime, maintenanceResetLanCounters=maintenanceResetLanCounters, pauseFailure=pauseFailure, CongestionControl=CongestionControl, gfpMonitor=gfpMonitor, cosHCInOctets=cosHCInOctets, gfpTable=gfpTable, gfpLOFD=gfpLOFD, cosBwRRatioMax=cosBwRRatioMax, pauseCLT=pauseCLT, gfpSendingRate=gfpSendingRate, qosClassNumber=qosClassNumber, maintenancePRBSSent=maintenancePRBSSent, maintenanceLoopback=maintenanceLoopback, gfpHCInErrors=gfpHCInErrors, qosTable=qosTable, gfpFailure=gfpFailure, maintenanceAutoTest=maintenanceAutoTest, gfpState=gfpState, gfpIndex=gfpIndex)
