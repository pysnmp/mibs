...
mibBuilder.exportSymbols("GIGE-MIB", gfpSeverity=gfpSeverity, gfpOOFD=gfpOOFD, gfpLOFD=gfpLOFD, cosQosId=cosQosId, pauseMonitor=pauseMonitor, pauseFailure=pauseFailure, maintenancePRBSReceived=maintenancePRBSReceived, gigeTable=gigeTable, pauseEntry=pauseEntry, cosBwRRatioMin=cosBwRRatioMin, BandwidthSize=BandwidthSize, gfpHCInErrors=gfpHCInErrors, cosTable=cosTable, SchedulingSystem=SchedulingSystem, pauseSeverity=pauseSeverity, gfpHCOutIdlePkts=gfpHCOutIdlePkts, qosNumber=qosNumber, gfpHCOutPkts=gfpHCOutPkts, qosType=qosType, maintenanceResetQosCounters=maintenanceResetQosCounters, gfpHCInOctets=gfpHCInOctets, gfpSendingRate=gfpSendingRate, CosId=CosId, gigeEntry=gigeEntry, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, cosDefinition=cosDefinition, gigeNumber=gigeNumber, cosBwRRatioMax=cosBwRRatioMax, qosSchedulingSystem=qosSchedulingSystem, pauseTime=pauseTime, cosHCInPkts=cosHCInPkts, PauseFailure=PauseFailure, maintenancePRBSSent=maintenancePRBSSent, gigeSdhBandwidth=gigeSdhBandwidth, qosIndex=qosIndex, gfpNumber=gfpNumber, maintenanceEntry=maintenanceEntry, qosClassNumber=qosClassNumber, gfpIdleRate=gfpIdleRate, maintenanceResetAllCounters=maintenanceResetAllCounters, maintenanceResetGfpCounters=maintenanceResetGfpCounters, GfpFailure=GfpFailure, gfpFailure=gfpFailure, pauseTable=pauseTable, maintenanceTable=maintenanceTable, cosNumber=cosNumber, gfpHCOutOctets=gfpHCOutOctets, gfpHCInPkts=gfpHCInPkts, LoopbackGE=LoopbackGE, qosEntry=qosEntry, pauseNumber=pauseNumber, GfpState=GfpState, pauseMacDA=pauseMacDA, gfpIndex=gfpIndex, gigeIndex=gigeIndex, QosType=QosType, pauseCHT=pauseCHT, cosHCOutOctets=cosHCOutOctets, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gfpEntry=gfpEntry, gige=gige, maintenanceNumber=maintenanceNumber, qosBwREnable=qosBwREnable, gfpOperStatus=gfpOperStatus, gfpFDSC=gfpFDSC, gfpMonitor=gfpMonitor, pauseCLT=pauseCLT, cosHCInCCDiscards=cosHCInCCDiscards, maintenanceIndex=maintenanceIndex, maintenanceResetLanCounters=maintenanceResetLanCounters, cosId=cosId, pauseMacSA=pauseMacSA, qosTable=qosTable, gfpHCInIdlePkts=gfpHCInIdlePkts, cosIndex=cosIndex, PYSNMP_MODULE_ID=gige, gfpState=gfpState, gigeWarmStart=gigeWarmStart, gfpAdminStatus=gfpAdminStatus, CongestionControl=CongestionControl, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, gigeAutoTest=gigeAutoTest, pauseIndex=pauseIndex, maintenanceAutoTest=maintenanceAutoTest, pauseBetweenTime=pauseBetweenTime, pauseModeRejected=pauseModeRejected, maintenanceLoopback=maintenanceLoopback, cosHCInOctets=cosHCInOctets, qosCongestionControl=qosCongestionControl, cosHCOutPkts=cosHCOutPkts, gfpTable=gfpTable, gfpHCFCSErrors=gfpHCFCSErrors, cosEntry=cosEntry, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan)
