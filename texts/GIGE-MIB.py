...
ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, MibIdentifier, Counter64, Bits, TimeTicks, Integer32, Gauge32, ObjectIdentity, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "MibIdentifier", "Counter64", "Bits", "TimeTicks", "Integer32", "Gauge32", "ObjectIdentity", "IpAddress", "iso")
...
mibBuilder.exportSymbols("GIGE-MIB", gfpNumber=gfpNumber, pauseEntry=pauseEntry, qosIndex=qosIndex, gfpAdminStatus=gfpAdminStatus, cosQosId=cosQosId, pauseBetweenTime=pauseBetweenTime, gfpHCFCSErrors=gfpHCFCSErrors, gfpHCInErrors=gfpHCInErrors, BandwidthSize=BandwidthSize, cosHCOutOctets=cosHCOutOctets, gfpHCInOctets=gfpHCInOctets, maintenancePRBSSent=maintenancePRBSSent, gfpSeverity=gfpSeverity, maintenanceIndex=maintenanceIndex, qosNumber=qosNumber, cosNumber=cosNumber, cosTable=cosTable, QosType=QosType, pauseCHT=pauseCHT, cosDefinition=cosDefinition, gfpIdleRate=gfpIdleRate, cosBwRRatioMax=cosBwRRatioMax, qosBwREnable=qosBwREnable, LoopbackGE=LoopbackGE, pauseIndex=pauseIndex, maintenanceEntry=maintenanceEntry, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, SchedulingSystem=SchedulingSystem, GfpState=GfpState, maintenanceResetQosCounters=maintenanceResetQosCounters, gfpHCInIdlePkts=gfpHCInIdlePkts, cosHCInCCDiscards=cosHCInCCDiscards, gigeWarmStart=gigeWarmStart, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, cosHCInOctets=cosHCInOctets, cosHCInPkts=cosHCInPkts, qosClassNumber=qosClassNumber, gfpMonitor=gfpMonitor, gfpFailure=gfpFailure, pauseNumber=pauseNumber, qosEntry=qosEntry, gfpFDSC=gfpFDSC, gigeAutoTest=gigeAutoTest, maintenanceResetLanCounters=maintenanceResetLanCounters, gfpSendingRate=gfpSendingRate, cosHCOutPkts=cosHCOutPkts, maintenanceAutoTest=maintenanceAutoTest, gfpTable=gfpTable, gigeSdhBandwidth=gigeSdhBandwidth, gfpState=gfpState, CosId=CosId, gfpHCOutOctets=gfpHCOutOctets, cosId=cosId, pauseSeverity=pauseSeverity, qosTable=qosTable, qosSchedulingSystem=qosSchedulingSystem, pauseFailure=pauseFailure, PauseFailure=PauseFailure, GfpFailure=GfpFailure, gige=gige, pauseCLT=pauseCLT, gfpOOFD=gfpOOFD, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, qosCongestionControl=qosCongestionControl, gfpHCOutPkts=gfpHCOutPkts, gigeIndex=gigeIndex, maintenanceLoopback=maintenanceLoopback, qosType=qosType, pauseModeRejected=pauseModeRejected, pauseMacDA=pauseMacDA, gigeNumber=gigeNumber, PYSNMP_MODULE_ID=gige, gfpHCInPkts=gfpHCInPkts, gfpEntry=gfpEntry, pauseMacSA=pauseMacSA, pauseTime=pauseTime, maintenancePRBSReceived=maintenancePRBSReceived, pauseTable=pauseTable, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpLOFD=gfpLOFD, cosIndex=cosIndex, maintenanceResetAllCounters=maintenanceResetAllCounters, gfpIndex=gfpIndex, cosEntry=cosEntry, gigeEntry=gigeEntry, gfpHCOutIdlePkts=gfpHCOutIdlePkts, maintenanceNumber=maintenanceNumber, maintenanceTable=maintenanceTable, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gfpOperStatus=gfpOperStatus, CongestionControl=CongestionControl, cosBwRRatioMin=cosBwRRatioMin, gigeTable=gigeTable, pauseMonitor=pauseMonitor)
