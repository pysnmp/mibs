...
mibBuilder.exportSymbols("GIGE-MIB", gfpOperStatus=gfpOperStatus, gfpHCFCSErrors=gfpHCFCSErrors, gigeAutoTest=gigeAutoTest, maintenanceIndex=maintenanceIndex, gfpIndex=gfpIndex, gfpEntry=gfpEntry, gfpIdleRate=gfpIdleRate, gfpHCOutIdlePkts=gfpHCOutIdlePkts, CosId=CosId, cosNumber=cosNumber, gfpOOFD=gfpOOFD, gige=gige, gfpHCOutOctets=gfpHCOutOctets, qosBwREnable=qosBwREnable, pauseIndex=pauseIndex, pauseModeRejected=pauseModeRejected, cosEntry=cosEntry, cosHCOutOctets=cosHCOutOctets, pauseFailure=pauseFailure, gfpHCInPkts=gfpHCInPkts, pauseCLT=pauseCLT, cosBwRRatioMin=cosBwRRatioMin, gigeIndex=gigeIndex, gfpLOFD=gfpLOFD, cosId=cosId, gigeNumber=gigeNumber, gigeTable=gigeTable, maintenanceAutoTest=maintenanceAutoTest, CongestionControl=CongestionControl, qosEntry=qosEntry, maintenanceTable=maintenanceTable, BandwidthSize=BandwidthSize, LoopbackGE=LoopbackGE, pauseBetweenTime=pauseBetweenTime, gfpAdminStatus=gfpAdminStatus, PauseFailure=PauseFailure, gfpTable=gfpTable, cosIndex=cosIndex, pauseMacDA=pauseMacDA, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpNumber=gfpNumber, qosIndex=qosIndex, cosHCInOctets=cosHCInOctets, qosCongestionControl=qosCongestionControl, gfpHCInErrors=gfpHCInErrors, PYSNMP_MODULE_ID=gige, gfpSeverity=gfpSeverity, pauseTable=pauseTable, gfpFailure=gfpFailure, gfpMonitor=gfpMonitor, gfpHCInIdlePkts=gfpHCInIdlePkts, gfpHCInOctets=gfpHCInOctets, cosTable=cosTable, gfpSendingRate=gfpSendingRate, maintenanceEntry=maintenanceEntry, cosHCInPkts=cosHCInPkts, QosType=QosType, GfpState=GfpState, qosSchedulingSystem=qosSchedulingSystem, cosQosId=cosQosId, gfpFDSC=gfpFDSC, GfpFailure=GfpFailure, maintenanceResetQosCounters=maintenanceResetQosCounters, cosBwRRatioMax=cosBwRRatioMax, pauseMacSA=pauseMacSA, maintenancePRBSSent=maintenancePRBSSent, pauseMonitor=pauseMonitor, qosTable=qosTable, gigeEntry=gigeEntry, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, pauseCHT=pauseCHT, qosClassNumber=qosClassNumber, pauseEntry=pauseEntry, maintenanceResetGfpCounters=maintenanceResetGfpCounters, qosType=qosType, qosNumber=qosNumber, cosHCOutPkts=cosHCOutPkts, gigeWarmStart=gigeWarmStart, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, maintenanceLoopback=maintenanceLoopback, maintenanceNumber=maintenanceNumber, gfpHCOutPkts=gfpHCOutPkts, cosHCInCCDiscards=cosHCInCCDiscards, pauseSeverity=pauseSeverity, maintenancePRBSReceived=maintenancePRBSReceived, maintenanceResetAllCounters=maintenanceResetAllCounters, maintenanceResetLanCounters=maintenanceResetLanCounters, SchedulingSystem=SchedulingSystem, pauseNumber=pauseNumber, gfpState=gfpState, pauseTime=pauseTime, cosDefinition=cosDefinition, gigeSdhBandwidth=gigeSdhBandwidth)
