...
mibBuilder.exportSymbols("GIGE-MIB", cosDefinition=cosDefinition, gigeIndex=gigeIndex, gfpHCInOctets=gfpHCInOctets, BandwidthSize=BandwidthSize, pauseMacDA=pauseMacDA, gfpState=gfpState, pauseMacSA=pauseMacSA, PYSNMP_MODULE_ID=gige, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, maintenancePRBSSent=maintenancePRBSSent, qosEntry=qosEntry, gfpFailure=gfpFailure, pauseCHT=pauseCHT, cosId=cosId, gfpHCInPkts=gfpHCInPkts, maintenanceResetAllCounters=maintenanceResetAllCounters, maintenanceResetQosCounters=maintenanceResetQosCounters, gfpTable=gfpTable, gfpSeverity=gfpSeverity, QosType=QosType, maintenancePRBSReceived=maintenancePRBSReceived, gfpLOFD=gfpLOFD, gfpHCInIdlePkts=gfpHCInIdlePkts, maintenanceResetLanCounters=maintenanceResetLanCounters, pauseMonitor=pauseMonitor, cosBwRRatioMax=cosBwRRatioMax, qosSchedulingSystem=qosSchedulingSystem, gfpHCOutPkts=gfpHCOutPkts, cosHCOutPkts=cosHCOutPkts, pauseBetweenTime=pauseBetweenTime, pauseTime=pauseTime, gfpHCFCSErrors=gfpHCFCSErrors, pauseIndex=pauseIndex, gfpFDSC=gfpFDSC, gigeWarmStart=gigeWarmStart, cosBwRRatioMin=cosBwRRatioMin, cosHCInPkts=cosHCInPkts, gfpIdleRate=gfpIdleRate, cosQosId=cosQosId, pauseEntry=pauseEntry, maintenanceIndex=maintenanceIndex, SchedulingSystem=SchedulingSystem, gfpHCOutIdlePkts=gfpHCOutIdlePkts, GfpState=GfpState, maintenanceEntry=maintenanceEntry, gigeTable=gigeTable, gige=gige, gigeNumber=gigeNumber, maintenanceResetGfpCounters=maintenanceResetGfpCounters, LoopbackGE=LoopbackGE, pauseCLT=pauseCLT, CongestionControl=CongestionControl, gigeSdhBandwidth=gigeSdhBandwidth, gfpSendingRate=gfpSendingRate, cosNumber=cosNumber, gfpEntry=gfpEntry, pauseSeverity=pauseSeverity, pauseFailure=pauseFailure, qosNumber=qosNumber, gfpAdminStatus=gfpAdminStatus, gfpHCInErrors=gfpHCInErrors, maintenanceNumber=maintenanceNumber, gfpMonitor=gfpMonitor, qosIndex=qosIndex, gfpHCOutOctets=gfpHCOutOctets, cosEntry=cosEntry, gfpOOFD=gfpOOFD, gfpOperStatus=gfpOperStatus, gigeAutoTest=gigeAutoTest, GfpFailure=GfpFailure, PauseFailure=PauseFailure, maintenanceTable=maintenanceTable, pauseTable=pauseTable, gfpIndex=gfpIndex, pauseNumber=pauseNumber, cosHCInCCDiscards=cosHCInCCDiscards, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, maintenanceAutoTest=maintenanceAutoTest, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, maintenanceLoopback=maintenanceLoopback, qosType=qosType, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, pauseModeRejected=pauseModeRejected, qosCongestionControl=qosCongestionControl, qosClassNumber=qosClassNumber, cosHCOutOctets=cosHCOutOctets, gfpNumber=gfpNumber, cosTable=cosTable, gigeEntry=gigeEntry, CosId=CosId, qosBwREnable=qosBwREnable, cosHCInOctets=cosHCInOctets, cosIndex=cosIndex, qosTable=qosTable)
