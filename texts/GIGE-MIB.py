...
mibBuilder.exportSymbols("GIGE-MIB", gfpHCOutIdlePkts=gfpHCOutIdlePkts, gfpSendingRate=gfpSendingRate, maintenancePRBSSent=maintenancePRBSSent, gfpHCInErrors=gfpHCInErrors, maintenanceResetLanCounters=maintenanceResetLanCounters, maintenanceResetQosCounters=maintenanceResetQosCounters, pauseEntry=pauseEntry, maintenanceResetAllCounters=maintenanceResetAllCounters, gigeWarmStart=gigeWarmStart, cosQosId=cosQosId, pauseTime=pauseTime, gigeNumber=gigeNumber, pauseMacSA=pauseMacSA, gigeTable=gigeTable, gige=gige, maintenanceTable=maintenanceTable, cosHCInPkts=cosHCInPkts, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, pauseFailure=pauseFailure, maintenanceLoopback=maintenanceLoopback, maintenancePRBSReceived=maintenancePRBSReceived, qosSchedulingSystem=qosSchedulingSystem, gfpHCInOctets=gfpHCInOctets, gfpHCOutOctets=gfpHCOutOctets, CongestionControl=CongestionControl, pauseMonitor=pauseMonitor, gigeAutoTest=gigeAutoTest, cosHCOutOctets=cosHCOutOctets, gfpOperStatus=gfpOperStatus, qosEntry=qosEntry, gfpHCOutPkts=gfpHCOutPkts, qosNumber=qosNumber, pauseCHT=pauseCHT, maintenanceResetGfpCounters=maintenanceResetGfpCounters, cosDefinition=cosDefinition, QosType=QosType, gfpOOFD=gfpOOFD, cosBwRRatioMin=cosBwRRatioMin, CosId=CosId, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, gfpState=gfpState, gfpIdleRate=gfpIdleRate, gfpHCFCSErrors=gfpHCFCSErrors, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, maintenanceIndex=maintenanceIndex, gfpAdminStatus=gfpAdminStatus, cosEntry=cosEntry, cosIndex=cosIndex, gfpEntry=gfpEntry, qosIndex=qosIndex, pauseModeRejected=pauseModeRejected, maintenanceEntry=maintenanceEntry, cosHCOutPkts=cosHCOutPkts, cosId=cosId, gfpHCInPkts=gfpHCInPkts, pauseIndex=pauseIndex, gfpSeverity=gfpSeverity, qosCongestionControl=qosCongestionControl, pauseTable=pauseTable, qosType=qosType, gfpTable=gfpTable, cosBwRRatioMax=cosBwRRatioMax, maintenanceAutoTest=maintenanceAutoTest, BandwidthSize=BandwidthSize, gigeSdhBandwidth=gigeSdhBandwidth, gigeIndex=gigeIndex, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gfpNumber=gfpNumber, qosBwREnable=qosBwREnable, PYSNMP_MODULE_ID=gige, cosTable=cosTable, GfpState=GfpState, gfpLOFD=gfpLOFD, gfpFailure=gfpFailure, gfpHCInIdlePkts=gfpHCInIdlePkts, maintenanceNumber=maintenanceNumber, pauseBetweenTime=pauseBetweenTime, LoopbackGE=LoopbackGE, SchedulingSystem=SchedulingSystem, pauseCLT=pauseCLT, cosHCInCCDiscards=cosHCInCCDiscards, qosClassNumber=qosClassNumber, gfpMonitor=gfpMonitor, GfpFailure=GfpFailure, cosNumber=cosNumber, PauseFailure=PauseFailure, qosTable=qosTable, gfpIndex=gfpIndex, pauseMacDA=pauseMacDA, pauseSeverity=pauseSeverity, gfpFDSC=gfpFDSC, cosHCInOctets=cosHCInOctets, pauseNumber=pauseNumber, gigeEntry=gigeEntry)
