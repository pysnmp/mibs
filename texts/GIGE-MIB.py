...
mibBuilder.exportSymbols("GIGE-MIB", gfpFDSC=gfpFDSC, gfpHCOutPkts=gfpHCOutPkts, qosBwREnable=qosBwREnable, GfpState=GfpState, qosIndex=qosIndex, gfpHCInOctets=gfpHCInOctets, pauseMonitor=pauseMonitor, pauseIndex=pauseIndex, gfpEntry=gfpEntry, qosType=qosType, gfpOperStatus=gfpOperStatus, pauseMacSA=pauseMacSA, qosEntry=qosEntry, pauseModeRejected=pauseModeRejected, QosType=QosType, gfpSendingRate=gfpSendingRate, maintenanceLoopback=maintenanceLoopback, BandwidthSize=BandwidthSize, gfpSeverity=gfpSeverity, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, cosQosId=cosQosId, gigeNumber=gigeNumber, CosId=CosId, qosClassNumber=qosClassNumber, cosBwRRatioMin=cosBwRRatioMin, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, cosHCOutOctets=cosHCOutOctets, gigeEntry=gigeEntry, gfpHCInPkts=gfpHCInPkts, cosHCInCCDiscards=cosHCInCCDiscards, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gigeWarmStart=gigeWarmStart, cosEntry=cosEntry, gigeTable=gigeTable, maintenancePRBSReceived=maintenancePRBSReceived, maintenanceIndex=maintenanceIndex, gfpHCFCSErrors=gfpHCFCSErrors, pauseBetweenTime=pauseBetweenTime, qosTable=qosTable, gigeSdhBandwidth=gigeSdhBandwidth, maintenanceTable=maintenanceTable, gfpNumber=gfpNumber, gfpHCOutOctets=gfpHCOutOctets, cosHCInOctets=cosHCInOctets, gfpState=gfpState, pauseSeverity=pauseSeverity, cosTable=cosTable, gigeAutoTest=gigeAutoTest, cosHCOutPkts=cosHCOutPkts, maintenanceNumber=maintenanceNumber, gfpHCOutIdlePkts=gfpHCOutIdlePkts, PYSNMP_MODULE_ID=gige, LoopbackGE=LoopbackGE, gfpAdminStatus=gfpAdminStatus, gfpOOFD=gfpOOFD, pauseEntry=pauseEntry, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, pauseNumber=pauseNumber, gfpLOFD=gfpLOFD, maintenanceResetAllCounters=maintenanceResetAllCounters, pauseCLT=pauseCLT, qosNumber=qosNumber, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, PauseFailure=PauseFailure, gfpFailure=gfpFailure, cosId=cosId, qosCongestionControl=qosCongestionControl, maintenanceResetQosCounters=maintenanceResetQosCounters, SchedulingSystem=SchedulingSystem, gfpIdleRate=gfpIdleRate, cosIndex=cosIndex, maintenanceResetLanCounters=maintenanceResetLanCounters, gfpMonitor=gfpMonitor, maintenanceAutoTest=maintenanceAutoTest, CongestionControl=CongestionControl, cosHCInPkts=cosHCInPkts, maintenanceEntry=maintenanceEntry, gfpHCInErrors=gfpHCInErrors, gfpTable=gfpTable, gfpIndex=gfpIndex, GfpFailure=GfpFailure, pauseTime=pauseTime, pauseMacDA=pauseMacDA, pauseTable=pauseTable, pauseFailure=pauseFailure, gfpHCInIdlePkts=gfpHCInIdlePkts, maintenancePRBSSent=maintenancePRBSSent, cosBwRRatioMax=cosBwRRatioMax, gige=gige, qosSchedulingSystem=qosSchedulingSystem, cosNumber=cosNumber, gigeIndex=gigeIndex, pauseCHT=pauseCHT, cosDefinition=cosDefinition)
