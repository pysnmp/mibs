...
mibBuilder.exportSymbols("GIGE-MIB", gfpHCInPkts=gfpHCInPkts, gfpState=gfpState, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, pauseMacDA=pauseMacDA, pauseModeRejected=pauseModeRejected, cosBwRRatioMin=cosBwRRatioMin, cosHCInOctets=cosHCInOctets, pauseCHT=pauseCHT, cosHCInPkts=cosHCInPkts, qosClassNumber=qosClassNumber, gfpHCOutIdlePkts=gfpHCOutIdlePkts, GfpState=GfpState, cosHCOutOctets=cosHCOutOctets, pauseTable=pauseTable, gigeIndex=gigeIndex, maintenanceAutoTest=maintenanceAutoTest, gigeWarmStart=gigeWarmStart, LoopbackGE=LoopbackGE, cosQosId=cosQosId, gfpLOFD=gfpLOFD, gfpFDSC=gfpFDSC, cosTable=cosTable, pauseFailure=pauseFailure, maintenancePRBSReceived=maintenancePRBSReceived, gige=gige, maintenanceTable=maintenanceTable, gfpIdleRate=gfpIdleRate, cosEntry=cosEntry, maintenanceIndex=maintenanceIndex, gigeAutoTest=gigeAutoTest, CosId=CosId, pauseEntry=pauseEntry, maintenanceLoopback=maintenanceLoopback, PauseFailure=PauseFailure, maintenancePRBSSent=maintenancePRBSSent, CongestionControl=CongestionControl, maintenanceNumber=maintenanceNumber, gfpTable=gfpTable, cosIndex=cosIndex, pauseMacSA=pauseMacSA, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, gfpHCInIdlePkts=gfpHCInIdlePkts, SchedulingSystem=SchedulingSystem, pauseTime=pauseTime, pauseMonitor=pauseMonitor, BandwidthSize=BandwidthSize, gigeTable=gigeTable, qosBwREnable=qosBwREnable, cosBwRRatioMax=cosBwRRatioMax, maintenanceResetLanCounters=maintenanceResetLanCounters, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpIndex=gfpIndex, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, gfpMonitor=gfpMonitor, gfpHCOutOctets=gfpHCOutOctets, maintenanceResetAllCounters=maintenanceResetAllCounters, gfpOOFD=gfpOOFD, QosType=QosType, pauseNumber=pauseNumber, cosDefinition=cosDefinition, qosTable=qosTable, pauseBetweenTime=pauseBetweenTime, gfpFailure=gfpFailure, GfpFailure=GfpFailure, cosNumber=cosNumber, qosCongestionControl=qosCongestionControl, gfpOperStatus=gfpOperStatus, gfpAdminStatus=gfpAdminStatus, gfpEntry=gfpEntry, pauseCLT=pauseCLT, pauseSeverity=pauseSeverity, gfpSendingRate=gfpSendingRate, maintenanceEntry=maintenanceEntry, gfpHCInOctets=gfpHCInOctets, cosId=cosId, qosEntry=qosEntry, qosNumber=qosNumber, gfpHCFCSErrors=gfpHCFCSErrors, PYSNMP_MODULE_ID=gige, maintenanceResetQosCounters=maintenanceResetQosCounters, gfpSeverity=gfpSeverity, cosHCOutPkts=cosHCOutPkts, cosHCInCCDiscards=cosHCInCCDiscards, gigeEntry=gigeEntry, gfpHCOutPkts=gfpHCOutPkts, pauseIndex=pauseIndex, gigeSdhBandwidth=gigeSdhBandwidth, qosSchedulingSystem=qosSchedulingSystem, gfpNumber=gfpNumber, gfpHCInErrors=gfpHCInErrors, qosType=qosType, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gigeNumber=gigeNumber, qosIndex=qosIndex)
