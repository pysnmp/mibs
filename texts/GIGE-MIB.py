...
mibBuilder.exportSymbols("GIGE-MIB", gfpSendingRate=gfpSendingRate, gfpLOFD=gfpLOFD, cosHCInOctets=cosHCInOctets, qosBwREnable=qosBwREnable, cosEntry=cosEntry, gfpSeverity=gfpSeverity, gfpNumber=gfpNumber, pauseEntry=pauseEntry, gigeAutoTest=gigeAutoTest, gigeSdhBandwidth=gigeSdhBandwidth, gfpTable=gfpTable, pauseMacSA=pauseMacSA, gfpState=gfpState, cosDefinition=cosDefinition, gfpAdminStatus=gfpAdminStatus, gfpIdleRate=gfpIdleRate, gfpOperStatus=gfpOperStatus, gigeEntry=gigeEntry, qosEntry=qosEntry, gfpHCInPkts=gfpHCInPkts, qosSchedulingSystem=qosSchedulingSystem, cosBwRRatioMax=cosBwRRatioMax, cosHCOutPkts=cosHCOutPkts, pauseCHT=pauseCHT, maintenancePRBSReceived=maintenancePRBSReceived, pauseTime=pauseTime, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, pauseNumber=pauseNumber, maintenanceLoopback=maintenanceLoopback, maintenanceEntry=maintenanceEntry, gigeTable=gigeTable, pauseCLT=pauseCLT, cosHCOutOctets=cosHCOutOctets, gfpHCOutPkts=gfpHCOutPkts, pauseMonitor=pauseMonitor, qosClassNumber=qosClassNumber, pauseBetweenTime=pauseBetweenTime, gfpEntry=gfpEntry, BandwidthSize=BandwidthSize, pauseFailure=pauseFailure, maintenanceAutoTest=maintenanceAutoTest, cosHCInPkts=cosHCInPkts, maintenanceResetAllCounters=maintenanceResetAllCounters, gfpHCInOctets=gfpHCInOctets, gfpHCOutOctets=gfpHCOutOctets, pauseTable=pauseTable, gfpHCInErrors=gfpHCInErrors, cosQosId=cosQosId, gfpOOFD=gfpOOFD, gfpHCFCSErrors=gfpHCFCSErrors, gfpFDSC=gfpFDSC, cosHCInCCDiscards=cosHCInCCDiscards, QosType=QosType, gfpHCOutIdlePkts=gfpHCOutIdlePkts, pauseMacDA=pauseMacDA, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpFailure=gfpFailure, maintenanceIndex=maintenanceIndex, GfpFailure=GfpFailure, qosIndex=qosIndex, qosCongestionControl=qosCongestionControl, cosId=cosId, gigeNumber=gigeNumber, qosType=qosType, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, maintenancePRBSSent=maintenancePRBSSent, SchedulingSystem=SchedulingSystem, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, pauseModeRejected=pauseModeRejected, cosTable=cosTable, gfpMonitor=gfpMonitor, LoopbackGE=LoopbackGE, cosNumber=cosNumber, maintenanceNumber=maintenanceNumber, qosTable=qosTable, PYSNMP_MODULE_ID=gige, pauseSeverity=pauseSeverity, gige=gige, GfpState=GfpState, pauseIndex=pauseIndex, gfpHCInIdlePkts=gfpHCInIdlePkts, maintenanceResetLanCounters=maintenanceResetLanCounters, maintenanceTable=maintenanceTable, PauseFailure=PauseFailure, cosBwRRatioMin=cosBwRRatioMin, CosId=CosId, cosIndex=cosIndex, CongestionControl=CongestionControl, gigeWarmStart=gigeWarmStart, maintenanceResetQosCounters=maintenanceResetQosCounters, qosNumber=qosNumber, gfpIndex=gfpIndex, gigeIndex=gigeIndex)
