...
IpAddress, MibIdentifier, ObjectIdentity, NotificationType, Unsigned32, Counter64, Integer32, Counter32, ModuleIdentity, TimeTicks, iso, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "ObjectIdentity", "NotificationType", "Unsigned32", "Counter64", "Integer32", "Counter32", "ModuleIdentity", "TimeTicks", "iso", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("GIGE-MIB", PYSNMP_MODULE_ID=gige, gfpEntry=gfpEntry, gigeTable=gigeTable, qosEntry=qosEntry, gigeAutoTest=gigeAutoTest, qosClassNumber=qosClassNumber, cosNumber=cosNumber, gfpFailure=gfpFailure, gigeWarmStart=gigeWarmStart, pauseMacSA=pauseMacSA, pauseEntry=pauseEntry, cosIndex=cosIndex, maintenanceResetLanCounters=maintenanceResetLanCounters, qosNumber=qosNumber, gfpHCInIdlePkts=gfpHCInIdlePkts, cosDefinition=cosDefinition, qosBwREnable=qosBwREnable, gfpFDSC=gfpFDSC, maintenanceResetGfpCounters=maintenanceResetGfpCounters, LoopbackGE=LoopbackGE, pauseMonitor=pauseMonitor, cosEntry=cosEntry, maintenanceNumber=maintenanceNumber, gfpIndex=gfpIndex, gfpHCOutIdlePkts=gfpHCOutIdlePkts, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gfpHCOutOctets=gfpHCOutOctets, pauseSeverity=pauseSeverity, BandwidthSize=BandwidthSize, cosHCInCCDiscards=cosHCInCCDiscards, maintenanceResetQosCounters=maintenanceResetQosCounters, gfpNumber=gfpNumber, gige=gige, qosIndex=qosIndex, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, PauseFailure=PauseFailure, pauseCLT=pauseCLT, gfpIdleRate=gfpIdleRate, pauseModeRejected=pauseModeRejected, gfpOOFD=gfpOOFD, cosHCOutPkts=cosHCOutPkts, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, gfpState=gfpState, cosQosId=cosQosId, gfpTable=gfpTable, pauseMacDA=pauseMacDA, gfpAdminStatus=gfpAdminStatus, CosId=CosId, maintenancePRBSSent=maintenancePRBSSent, gigeNumber=gigeNumber, maintenanceTable=maintenanceTable, QosType=QosType, cosHCOutOctets=cosHCOutOctets, gigeIndex=gigeIndex, gfpHCFCSErrors=gfpHCFCSErrors, pauseCHT=pauseCHT, CongestionControl=CongestionControl, cosTable=cosTable, pauseTable=pauseTable, pauseNumber=pauseNumber, gfpLOFD=gfpLOFD, maintenanceAutoTest=maintenanceAutoTest, cosBwRRatioMax=cosBwRRatioMax, pauseBetweenTime=pauseBetweenTime, SchedulingSystem=SchedulingSystem, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpHCInErrors=gfpHCInErrors, cosHCInPkts=cosHCInPkts, qosType=qosType, gigeSdhBandwidth=gigeSdhBandwidth, maintenanceIndex=maintenanceIndex, gfpSeverity=gfpSeverity, maintenanceLoopback=maintenanceLoopback, qosTable=qosTable, maintenancePRBSReceived=maintenancePRBSReceived, GfpState=GfpState, gfpMonitor=gfpMonitor, gfpSendingRate=gfpSendingRate, pauseFailure=pauseFailure, GfpFailure=GfpFailure, maintenanceEntry=maintenanceEntry, pauseIndex=pauseIndex, qosSchedulingSystem=qosSchedulingSystem, gigeEntry=gigeEntry, maintenanceResetAllCounters=maintenanceResetAllCounters, cosBwRRatioMin=cosBwRRatioMin, cosId=cosId, gfpHCInPkts=gfpHCInPkts, cosHCInOctets=cosHCInOctets, pauseTime=pauseTime, gfpHCOutPkts=gfpHCOutPkts, qosCongestionControl=qosCongestionControl, gfpHCInOctets=gfpHCInOctets, gfpOperStatus=gfpOperStatus)
