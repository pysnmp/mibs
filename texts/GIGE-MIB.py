...
Integer32, ModuleIdentity, Counter64, iso, Bits, TimeTicks, Counter32, NotificationType, Gauge32, Unsigned32, IpAddress, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Counter64", "iso", "Bits", "TimeTicks", "Counter32", "NotificationType", "Gauge32", "Unsigned32", "IpAddress", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("GIGE-MIB", qosSchedulingSystem=qosSchedulingSystem, cosHCOutOctets=cosHCOutOctets, gfpLOFD=gfpLOFD, qosNumber=qosNumber, gigeAutoTest=gigeAutoTest, gigeWarmStart=gigeWarmStart, maintenanceAutoTest=maintenanceAutoTest, qosClassNumber=qosClassNumber, cosHCInCCDiscards=cosHCInCCDiscards, gfpFailure=gfpFailure, BandwidthSize=BandwidthSize, gfpHCOutOctets=gfpHCOutOctets, maintenanceNumber=maintenanceNumber, cosIndex=cosIndex, pauseMacSA=pauseMacSA, maintenanceResetAllCounters=maintenanceResetAllCounters, cosHCInPkts=cosHCInPkts, maintenanceIndex=maintenanceIndex, maintenanceResetGfpCounters=maintenanceResetGfpCounters, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, pauseModeRejected=pauseModeRejected, cosBwRRatioMax=cosBwRRatioMax, SchedulingSystem=SchedulingSystem, LoopbackGE=LoopbackGE, gfpNumber=gfpNumber, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, gfpFDSC=gfpFDSC, maintenanceTable=maintenanceTable, GfpState=GfpState, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, maintenancePRBSSent=maintenancePRBSSent, pauseNumber=pauseNumber, pauseBetweenTime=pauseBetweenTime, gfpState=gfpState, maintenanceLoopback=maintenanceLoopback, gfpMonitor=gfpMonitor, pauseSeverity=pauseSeverity, gfpOperStatus=gfpOperStatus, pauseTime=pauseTime, qosTable=qosTable, pauseEntry=pauseEntry, gigeNumber=gigeNumber, gfpSeverity=gfpSeverity, qosBwREnable=qosBwREnable, gfpHCFCSErrors=gfpHCFCSErrors, cosHCOutPkts=cosHCOutPkts, gfpHCInPkts=gfpHCInPkts, maintenanceResetLanCounters=maintenanceResetLanCounters, gfpHCOutIdlePkts=gfpHCOutIdlePkts, gfpSendingRate=gfpSendingRate, GfpFailure=GfpFailure, cosQosId=cosQosId, PYSNMP_MODULE_ID=gige, qosIndex=qosIndex, pauseMacDA=pauseMacDA, pauseCLT=pauseCLT, gfpOOFD=gfpOOFD, gfpAdminStatus=gfpAdminStatus, QosType=QosType, pauseCHT=pauseCHT, pauseTable=pauseTable, qosCongestionControl=qosCongestionControl, gfpHCInOctets=gfpHCInOctets, PauseFailure=PauseFailure, cosEntry=cosEntry, gfpIndex=gfpIndex, gfpHCInIdlePkts=gfpHCInIdlePkts, pauseIndex=pauseIndex, cosTable=cosTable, gigeIndex=gigeIndex, maintenanceEntry=maintenanceEntry, cosBwRRatioMin=cosBwRRatioMin, gfpIdleRate=gfpIdleRate, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, cosNumber=cosNumber, gigeTable=gigeTable, gfpTable=gfpTable, pauseMonitor=pauseMonitor, pauseFailure=pauseFailure, gigeEntry=gigeEntry, CosId=CosId, cosDefinition=cosDefinition, gigeSdhBandwidth=gigeSdhBandwidth, gige=gige, qosEntry=qosEntry, maintenancePRBSReceived=maintenancePRBSReceived, CongestionControl=CongestionControl, qosType=qosType, cosId=cosId, gfpEntry=gfpEntry, gfpHCOutPkts=gfpHCOutPkts, cosHCInOctets=cosHCInOctets, gfpHCInErrors=gfpHCInErrors, maintenanceResetQosCounters=maintenanceResetQosCounters)
