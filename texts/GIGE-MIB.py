...
mibBuilder.exportSymbols("GIGE-MIB", gfpState=gfpState, maintenanceLoopback=maintenanceLoopback, cosHCInCCDiscards=cosHCInCCDiscards, gfpSendingRate=gfpSendingRate, qosEntry=qosEntry, gfpHCInPkts=gfpHCInPkts, maintenanceTable=maintenanceTable, gigeEntry=gigeEntry, SchedulingSystem=SchedulingSystem, gfpHCOutPkts=gfpHCOutPkts, cosQosId=cosQosId, gfpFDSC=gfpFDSC, gfpIdleRate=gfpIdleRate, gfpNumber=gfpNumber, PYSNMP_MODULE_ID=gige, pauseMacDA=pauseMacDA, cosHCInOctets=cosHCInOctets, pauseCLT=pauseCLT, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gfpSeverity=gfpSeverity, cosBwRRatioMin=cosBwRRatioMin, maintenanceNumber=maintenanceNumber, cosHCOutOctets=cosHCOutOctets, gfpHCOutIdlePkts=gfpHCOutIdlePkts, gigeSdhBandwidth=gigeSdhBandwidth, gfpHCFCSErrors=gfpHCFCSErrors, gfpHCInOctets=gfpHCInOctets, cosEntry=cosEntry, maintenanceResetAllCounters=maintenanceResetAllCounters, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, pauseNumber=pauseNumber, pauseEntry=pauseEntry, pauseMacSA=pauseMacSA, maintenanceResetQosCounters=maintenanceResetQosCounters, pauseCHT=pauseCHT, maintenancePRBSSent=maintenancePRBSSent, gigeIndex=gigeIndex, gfpHCOutOctets=gfpHCOutOctets, maintenanceResetLanCounters=maintenanceResetLanCounters, GfpFailure=GfpFailure, pauseFailure=pauseFailure, qosTable=qosTable, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, cosBwRRatioMax=cosBwRRatioMax, gigeNumber=gigeNumber, gigeAutoTest=gigeAutoTest, pauseMonitor=pauseMonitor, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gigeTable=gigeTable, qosSchedulingSystem=qosSchedulingSystem, qosBwREnable=qosBwREnable, qosType=qosType, pauseIndex=pauseIndex, gige=gige, maintenancePRBSReceived=maintenancePRBSReceived, gfpIndex=gfpIndex, gfpFailure=gfpFailure, gfpOperStatus=gfpOperStatus, cosIndex=cosIndex, pauseTime=pauseTime, pauseTable=pauseTable, BandwidthSize=BandwidthSize, gfpMonitor=gfpMonitor, gfpHCInIdlePkts=gfpHCInIdlePkts, cosHCOutPkts=cosHCOutPkts, gfpEntry=gfpEntry, cosHCInPkts=cosHCInPkts, gfpHCInErrors=gfpHCInErrors, qosNumber=qosNumber, CongestionControl=CongestionControl, cosDefinition=cosDefinition, gigeWarmStart=gigeWarmStart, cosNumber=cosNumber, QosType=QosType, maintenanceAutoTest=maintenanceAutoTest, maintenanceEntry=maintenanceEntry, pauseBetweenTime=pauseBetweenTime, pauseSeverity=pauseSeverity, gfpTable=gfpTable, LoopbackGE=LoopbackGE, qosIndex=qosIndex, cosTable=cosTable, GfpState=GfpState, PauseFailure=PauseFailure, qosClassNumber=qosClassNumber, maintenanceIndex=maintenanceIndex, qosCongestionControl=qosCongestionControl, gfpOOFD=gfpOOFD, cosId=cosId, gfpLOFD=gfpLOFD, CosId=CosId, pauseModeRejected=pauseModeRejected, gfpAdminStatus=gfpAdminStatus)
