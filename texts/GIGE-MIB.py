...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Integer32, Gauge32, NotificationType, iso, ModuleIdentity, Unsigned32, TimeTicks, Bits, Counter64, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Integer32", "Gauge32", "NotificationType", "iso", "ModuleIdentity", "Unsigned32", "TimeTicks", "Bits", "Counter64", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("GIGE-MIB", cosBwRRatioMin=cosBwRRatioMin, gigeWarmStart=gigeWarmStart, gigeAutoTest=gigeAutoTest, GfpFailure=GfpFailure, pauseFailure=pauseFailure, gfpFailure=gfpFailure, gfpFDSC=gfpFDSC, gigeEntry=gigeEntry, gfpEntry=gfpEntry, gigeTable=gigeTable, LoopbackGE=LoopbackGE, maintenancePRBSReceived=maintenancePRBSReceived, cosHCOutOctets=cosHCOutOctets, pauseCHT=pauseCHT, maintenanceLoopback=maintenanceLoopback, gfpLOFD=gfpLOFD, gigeNumber=gigeNumber, cosHCOutPkts=cosHCOutPkts, cosBwRRatioMax=cosBwRRatioMax, pauseMacDA=pauseMacDA, pauseMonitor=pauseMonitor, PauseFailure=PauseFailure, gigeIndex=gigeIndex, qosClassNumber=qosClassNumber, maintenanceNumber=maintenanceNumber, qosBwREnable=qosBwREnable, cosHCInCCDiscards=cosHCInCCDiscards, PYSNMP_MODULE_ID=gige, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpSeverity=gfpSeverity, pauseBetweenTime=pauseBetweenTime, cosTable=cosTable, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, qosType=qosType, cosDefinition=cosDefinition, pauseIndex=pauseIndex, cosQosId=cosQosId, gfpOOFD=gfpOOFD, qosEntry=qosEntry, pauseSeverity=pauseSeverity, gfpHCOutPkts=gfpHCOutPkts, maintenanceAutoTest=maintenanceAutoTest, BandwidthSize=BandwidthSize, pauseTime=pauseTime, cosIndex=cosIndex, gfpIdleRate=gfpIdleRate, maintenanceTable=maintenanceTable, qosSchedulingSystem=qosSchedulingSystem, gfpHCInIdlePkts=gfpHCInIdlePkts, gfpSendingRate=gfpSendingRate, SchedulingSystem=SchedulingSystem, cosEntry=cosEntry, CosId=CosId, cosId=cosId, GfpState=GfpState, QosType=QosType, gfpNumber=gfpNumber, gige=gige, gfpHCFCSErrors=gfpHCFCSErrors, qosTable=qosTable, gfpHCInErrors=gfpHCInErrors, gfpHCInOctets=gfpHCInOctets, pauseTable=pauseTable, pauseModeRejected=pauseModeRejected, gfpOperStatus=gfpOperStatus, gfpIndex=gfpIndex, qosCongestionControl=qosCongestionControl, gfpAdminStatus=gfpAdminStatus, gfpState=gfpState, maintenanceResetLanCounters=maintenanceResetLanCounters, cosHCInOctets=cosHCInOctets, pauseNumber=pauseNumber, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpMonitor=gfpMonitor, qosIndex=qosIndex, CongestionControl=CongestionControl, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, maintenanceEntry=maintenanceEntry, maintenancePRBSSent=maintenancePRBSSent, gfpHCInPkts=gfpHCInPkts, pauseMacSA=pauseMacSA, cosHCInPkts=cosHCInPkts, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, maintenanceIndex=maintenanceIndex, gigeSdhBandwidth=gigeSdhBandwidth, maintenanceResetAllCounters=maintenanceResetAllCounters, qosNumber=qosNumber, gfpTable=gfpTable, pauseCLT=pauseCLT, pauseEntry=pauseEntry, maintenanceResetQosCounters=maintenanceResetQosCounters, cosNumber=cosNumber, gfpHCOutOctets=gfpHCOutOctets, gfpHCOutIdlePkts=gfpHCOutIdlePkts)
