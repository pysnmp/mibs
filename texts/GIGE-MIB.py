...
TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Integer32, NotificationType, ModuleIdentity, Counter32, ObjectIdentity, Bits, Counter64, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Integer32", "NotificationType", "ModuleIdentity", "Counter32", "ObjectIdentity", "Bits", "Counter64", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("GIGE-MIB", cosId=cosId, cosIndex=cosIndex, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, cosHCOutPkts=cosHCOutPkts, pauseCLT=pauseCLT, PauseFailure=PauseFailure, qosIndex=qosIndex, gfpFailure=gfpFailure, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, gfpAdminStatus=gfpAdminStatus, BandwidthSize=BandwidthSize, gigeTable=gigeTable, pauseTime=pauseTime, gigeIndex=gigeIndex, gfpTable=gfpTable, PYSNMP_MODULE_ID=gige, cosBwRRatioMin=cosBwRRatioMin, gigeWarmStart=gigeWarmStart, cosHCInOctets=cosHCInOctets, qosEntry=qosEntry, pauseMacSA=pauseMacSA, maintenanceLoopback=maintenanceLoopback, gfpMonitor=gfpMonitor, maintenanceResetGfpCounters=maintenanceResetGfpCounters, maintenanceEntry=maintenanceEntry, gigeEntry=gigeEntry, gfpHCInIdlePkts=gfpHCInIdlePkts, pauseEntry=pauseEntry, gfpSeverity=gfpSeverity, maintenanceTable=maintenanceTable, gfpHCOutIdlePkts=gfpHCOutIdlePkts, gigeSdhBandwidth=gigeSdhBandwidth, gfpFDSC=gfpFDSC, gfpHCFCSErrors=gfpHCFCSErrors, pauseNumber=pauseNumber, gigeNumber=gigeNumber, gfpIndex=gfpIndex, gfpSendingRate=gfpSendingRate, gfpHCInErrors=gfpHCInErrors, cosHCInPkts=cosHCInPkts, QosType=QosType, GfpState=GfpState, qosType=qosType, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, maintenancePRBSReceived=maintenancePRBSReceived, gfpHCOutOctets=gfpHCOutOctets, gfpIdleRate=gfpIdleRate, maintenanceResetLanCounters=maintenanceResetLanCounters, gigeAutoTest=gigeAutoTest, qosNumber=qosNumber, cosHCOutOctets=cosHCOutOctets, cosBwRRatioMax=cosBwRRatioMax, maintenancePRBSSent=maintenancePRBSSent, qosTable=qosTable, qosBwREnable=qosBwREnable, pauseIndex=pauseIndex, cosNumber=cosNumber, cosHCInCCDiscards=cosHCInCCDiscards, gfpEntry=gfpEntry, maintenanceIndex=maintenanceIndex, maintenanceResetAllCounters=maintenanceResetAllCounters, CongestionControl=CongestionControl, pauseSeverity=pauseSeverity, pauseModeRejected=pauseModeRejected, CosId=CosId, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, cosQosId=cosQosId, gfpHCOutPkts=gfpHCOutPkts, LoopbackGE=LoopbackGE, maintenanceResetQosCounters=maintenanceResetQosCounters, pauseMacDA=pauseMacDA, pauseBetweenTime=pauseBetweenTime, GfpFailure=GfpFailure, qosSchedulingSystem=qosSchedulingSystem, pauseTable=pauseTable, maintenanceNumber=maintenanceNumber, gfpOOFD=gfpOOFD, pauseCHT=pauseCHT, gige=gige, gfpLOFD=gfpLOFD, cosTable=cosTable, qosCongestionControl=qosCongestionControl, gfpNumber=gfpNumber, qosClassNumber=qosClassNumber, cosEntry=cosEntry, pauseFailure=pauseFailure, cosDefinition=cosDefinition, gfpState=gfpState, gfpHCInPkts=gfpHCInPkts, gfpHCInOctets=gfpHCInOctets, maintenanceAutoTest=maintenanceAutoTest, SchedulingSystem=SchedulingSystem, pauseMonitor=pauseMonitor, gfpOperStatus=gfpOperStatus)
