...
mibBuilder.exportSymbols("GIGE-MIB", cosHCOutPkts=cosHCOutPkts, gfpHCOutIdlePkts=gfpHCOutIdlePkts, cosEntry=cosEntry, PYSNMP_MODULE_ID=gige, maintenanceResetGfpCounters=maintenanceResetGfpCounters, gfpAdminStatus=gfpAdminStatus, pauseEntry=pauseEntry, cosBwRRatioMin=cosBwRRatioMin, gfpTable=gfpTable, qosType=qosType, cosBwRRatioMax=cosBwRRatioMax, gfpMonitor=gfpMonitor, maintenanceTable=maintenanceTable, qosCongestionControl=qosCongestionControl, gfpOperStatus=gfpOperStatus, maintenanceIndex=maintenanceIndex, PauseFailure=PauseFailure, maintenancePRBSReceived=maintenancePRBSReceived, gfpSendingRate=gfpSendingRate, qosEntry=qosEntry, pauseCHT=pauseCHT, gigeWarmStart=gigeWarmStart, pauseTime=pauseTime, gigeNumber=gigeNumber, QosType=QosType, cosIndex=cosIndex, cosHCInOctets=cosHCInOctets, LoopbackGE=LoopbackGE, gfpHCInErrors=gfpHCInErrors, gige=gige, gfpHCOutOctets=gfpHCOutOctets, maintenanceResetLanCounters=maintenanceResetLanCounters, qosIndex=qosIndex, maintenanceNumber=maintenanceNumber, pauseFailure=pauseFailure, cosId=cosId, SchedulingSystem=SchedulingSystem, qosTable=qosTable, qosHCInCCDiscardsGe=qosHCInCCDiscardsGe, qosClassNumber=qosClassNumber, cosNumber=cosNumber, BandwidthSize=BandwidthSize, pauseIndex=pauseIndex, maintenanceEntry=maintenanceEntry, cosHCInCCDiscards=cosHCInCCDiscards, gfpHCOutPkts=gfpHCOutPkts, CosId=CosId, gfpIdleRate=gfpIdleRate, maintenanceLoopback=maintenanceLoopback, cosQosId=cosQosId, cosHCInPkts=cosHCInPkts, maintenancePRBSSent=maintenancePRBSSent, gfpHCFCSErrors=gfpHCFCSErrors, pauseMonitor=pauseMonitor, pauseNumber=pauseNumber, maintenanceAutoTest=maintenanceAutoTest, pauseModeRejected=pauseModeRejected, qosHCInCCDiscardsWan=qosHCInCCDiscardsWan, pauseCLT=pauseCLT, maintenanceResetQosCounters=maintenanceResetQosCounters, pauseSeverity=pauseSeverity, cosHCOutOctets=cosHCOutOctets, cosTable=cosTable, GfpState=GfpState, pauseBetweenTime=pauseBetweenTime, gfpHCInOctets=gfpHCInOctets, gfpHCInCorruptedPkts=gfpHCInCorruptedPkts, gfpHCInPkts=gfpHCInPkts, gfpState=gfpState, gfpHCInIdlePkts=gfpHCInIdlePkts, qosBwREnable=qosBwREnable, gfpLOFD=gfpLOFD, qosSchedulingSystem=qosSchedulingSystem, gfpNumber=gfpNumber, qosNumber=qosNumber, CongestionControl=CongestionControl, gfpIndex=gfpIndex, gfpOOFD=gfpOOFD, cosDefinition=cosDefinition, gigeTable=gigeTable, pauseMacSA=pauseMacSA, gfpFDSC=gfpFDSC, gfpFailure=gfpFailure, gigeSdhBandwidth=gigeSdhBandwidth, pauseMacDA=pauseMacDA, gigeEntry=gigeEntry, GfpFailure=GfpFailure, gigeAutoTest=gigeAutoTest, gigeIndex=gigeIndex, gfpHCInCorrectedPkts=gfpHCInCorrectedPkts, gfpEntry=gfpEntry, pauseTable=pauseTable, gfpSeverity=gfpSeverity, maintenanceResetAllCounters=maintenanceResetAllCounters)
