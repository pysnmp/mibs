...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, MibIdentifier, Unsigned32, Counter64, iso, enterprises, NotificationType, Integer32, Bits, Gauge32, ModuleIdentity, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "MibIdentifier", "Unsigned32", "Counter64", "iso", "enterprises", "NotificationType", "Integer32", "Bits", "Gauge32", "ModuleIdentity", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("TELECOM-MIB", matConfStsAcVoltLowLoss=matConfStsAcVoltLowLoss, matStsControlPowerFail=matStsControlPowerFail, matReturnFromInvNotRespond=matReturnFromInvNotRespond, matConTemperatureHigh=matConTemperatureHigh, matStsModuleIndex=matStsModuleIndex, matStsMainLowLossVoltage=matStsMainLowLossVoltage, matInvOutputVoltLow=matInvOutputVoltLow, matInvLineFreq=matInvLineFreq, matInvMBSPosError=matInvMBSPosError, matReturnFromInvBypassSCRShort=matReturnFromInvBypassSCRShort, matInvNegativePowerProtect=matInvNegativePowerProtect, matInvOutputPower=matInvOutputPower, matConCanBusOff=matConCanBusOff, matInvBusVoltageOverLimit=matInvBusVoltageOverLimit, matConfStsAcVoltHighLoss=matConfStsAcVoltHighLoss, matTrapSeverityLevel=matTrapSeverityLevel, matReturnFromInvHardwareError=matReturnFromInvHardwareError, matReturnFromInvBusVoltOverLimit=matReturnFromInvBusVoltOverLimit, matReturnFromInvInputAbnormal=matReturnFromInvInputAbnormal, matConfStsIpvVoltLowLoss=matConfStsIpvVoltLowLoss, matInverter=matInverter, matConfInvOutputPower=matConfInvOutputPower, matInvFanFault=matInvFanFault, matStsOutputFreq=matStsOutputFreq, matStsTable=matStsTable, matStsInvFail=matStsInvFail, matStsMaintenanceBypass=matStsMaintenanceBypass, matReturnFromStsTemperatureHigh=matReturnFromStsTemperatureHigh, matController=matController, matStsWarningState=matStsWarningState, matReturnFromInvFault=matReturnFromInvFault, matDryContactIndex=matDryContactIndex, matStsMainInputFreq=matStsMainInputFreq, matReturnFromInvEEPROMFault=matReturnFromInvEEPROMFault, matStsOutputPower=matStsOutputPower, matTrapTargetsTable=matTrapTargetsTable, matReturnFromStsInvBypassMode=matReturnFromStsInvBypassMode, matInvOutputCurrent=matInvOutputCurrent, matConTemperature=matConTemperature, matStsScr2ShortCurcuit=matStsScr2ShortCurcuit, matReturnFromInvOutputVoltHigh=matReturnFromInvOutputVoltHigh, matObjects=matObjects, matStsOutputCurrent=matStsOutputCurrent, matReturnFromStsEEPROMFault=matReturnFromStsEEPROMFault, matInvTable=matInvTable, matReturnFromInvMaintenaceBypass=matReturnFromInvMaintenaceBypass, matReturnFromCommunicationLost=matReturnFromCommunicationLost, matDryContactEntry=matDryContactEntry, matReturnFromStsMainFail=matReturnFromStsMainFail, matInvBusSoftFail=matInvBusSoftFail, matInvMbsPosition=matInvMbsPosition, matInvTempPowerLimit=matInvTempPowerLimit, matInvOnOffStatus=matInvOnOffStatus, matDryContactNum=matDryContactNum, matStsHardwareVersion=matStsHardwareVersion, matInvBypassSCRShort=matInvBypassSCRShort, matReturnFromStsOutputShortCircuit=matReturnFromStsOutputShortCircuit, matReturnFromStsControlPowerFail=matReturnFromStsControlPowerFail, matInvWarningState=matInvWarningState, matConfInvSysOutputVoltLowLoss=matConfInvSysOutputVoltLowLoss, matConName=matConName, matInvRunTime=matInvRunTime, matReturnFromStsMaintenanceBypass=matReturnFromStsMaintenanceBypass, matConSerialNum=matConSerialNum, matInvBatteryVoltage=matInvBatteryVoltage, matReturnFromInvMBSPosError=matReturnFromInvMBSPosError, matInvRunMode=matInvRunMode, matConfInvSysInputVolt=matConfInvSysInputVolt, matTrapTargetsIndex=matTrapTargetsIndex, matReturnFromConBatteryVoltHigh=matReturnFromConBatteryVoltHigh, matStsOutputAbnormal=matStsOutputAbnormal, matStsTemperature=matStsTemperature, matReturnFromInvTempPowerLimit=matReturnFromInvTempPowerLimit, matReturnFromInvBusVoltUnderLimit=matReturnFromInvBusVoltUnderLimit, matInvPowerLimit=matInvPowerLimit, matStsRuntime=matStsRuntime, matInvBusVoltageUnderLimit=matInvBusVoltageUnderLimit, matInvMainUnavailable=matInvMainUnavailable, matReturnFromInvBusSoftFail=matReturnFromInvBusSoftFail, matStsInvInputVoltage=matStsInvInputVoltage, matConfInvOutputVoltHighLoss=matConfInvOutputVoltHighLoss, matStsTemperatureHigh=matStsTemperatureHigh, matInvModuleIndex=matInvModuleIndex, matStsBackfeedRelayOpen=matStsBackfeedRelayOpen, matConWarningState=matConWarningState, matReturnFromStsMBSPosFault=matReturnFromStsMBSPosFault, matStsSerialNum=matStsSerialNum, matConfStsFanSpeed=matConfStsFanSpeed, matStsEntry=matStsEntry, matReturnFromInvEPOShutdown=matReturnFromInvEPOShutdown, matConfig=matConfig, matReturnFromStsScr2ShortCurcuit=matReturnFromStsScr2ShortCurcuit, matConfInvInputVoltage=matConfInvInputVoltage, matInvEPOShutdown=matInvEPOShutdown, matStsModuleNum=matStsModuleNum, matTrapTargetsDesc=matTrapTargetsDesc, matInvMaintenaceBypass=matInvMaintenaceBypass, matInvTemperature=matInvTemperature, NonNegativeInteger=NonNegativeInteger, matReturnFromInvFanFault=matReturnFromInvFanFault, matDryContactTable=matDryContactTable, matReturnFromStsInvFail=matReturnFromStsInvFail, matInvSoftStartFail=matInvSoftStartFail, matReturnFromConBatteryLow=matReturnFromConBatteryLow, matTraps=matTraps, matStsInvLosLossVoltage=matStsInvLosLossVoltage, matReturnFromStsOutputAbnormal=matReturnFromStsOutputAbnormal, matInvFirmwareVersion=matInvFirmwareVersion, matConfStsPriority=matConfStsPriority, matStsBypassUnavailable=matStsBypassUnavailable, matStsOutputShortCircuit=matStsOutputShortCircuit, matStsRunningMode=matStsRunningMode, matStsInvInputFreq=matStsInvInputFreq, matConfInvOutputVoltage=matConfInvOutputVoltage, matReturnFromInvOutputShort=matReturnFromInvOutputShort, matStsInvBypassMode=matStsInvBypassMode, matConfInvOutputFreq=matConfInvOutputFreq, matDryContact=matDryContact, matReturnFromInvTemperatureHigh=matReturnFromInvTemperatureHigh, matStsFaultMode=matStsFaultMode, PositiveInteger=PositiveInteger, matConfInvSysLineVoltLowLoss=matConfInvSysLineVoltLowLoss, matStsOverLoad=matStsOverLoad, matConfInvSysOutputFreq=matConfInvSysOutputFreq, matInvPriority=matInvPriority, matStsMbsStatus=matStsMbsStatus, matDryContactString=matDryContactString, matTrapTargetsAddress=matTrapTargetsAddress, matTrapTargets=matTrapTargets, matReturnFromInvLowInputShutdown=matReturnFromInvLowInputShutdown, matInvPulseFault=matInvPulseFault, matStsFanFault=matStsFanFault, matConCommunicationLost=matConCommunicationLost, matReturnFromInvBackfeedRelayOpen=matReturnFromInvBackfeedRelayOpen, matTrapTargetsEntry=matTrapTargetsEntry, matInvOutputShort=matInvOutputShort, matReturnFromInvSoftStartFail=matReturnFromInvSoftStartFail, matInvInputAbnormal=matInvInputAbnormal, matReturnFromStsBypassUnavailable=matReturnFromStsBypassUnavailable, matInvOutputVoltHigh=matInvOutputVoltHigh, matInvModuleNum=matInvModuleNum, matInvHardwareVersion=matInvHardwareVersion, matReturnFromStsNotRespond=matReturnFromStsNotRespond, matConfInvSysOutputVoltHighLoss=matConfInvSysOutputVoltHighLoss, matTrapType=matTrapType, matReturnFromStsScr1ShortCurcuit=matReturnFromStsScr1ShortCurcuit, matInvOutputFreq=matInvOutputFreq, matConEEPROMFault=matConEEPROMFault, matConfStsIpvVoltHighLoss=matConfStsIpvVoltHighLoss, matConfInvOutputVoltLowLoss=matConfInvOutputVoltLowLoss, matStsMainHighLossVoltage=matStsMainHighLossVoltage, matConBatteryLow=matConBatteryLow, matStsOutputVoltage=matStsOutputVoltage, matReturnFromInvNegativePowerProtect=matReturnFromInvNegativePowerProtect, matReturnFromInvPulseFault=matReturnFromInvPulseFault, matInvBackfeedRelayOpen=matInvBackfeedRelayOpen, matReturnFromInvOverLoad=matReturnFromInvOverLoad, matReturnFromInvOutputVoltLow=matReturnFromInvOutputVoltLow, matInvSerialNum=matInvSerialNum, matConfInvSysPriority=matConfInvSysPriority, device=device, matInvTemperatureHigh=matInvTemperatureHigh, matReturnFromConEEPROMFault=matReturnFromConEEPROMFault, matInvNotRespond=matInvNotRespond, matSts=matSts, ppc=ppc, matReturnFromStsOverLoad=matReturnFromStsOverLoad, matStsMainsFail=matStsMainsFail, matInvOverLoad=matInvOverLoad, matInvHardwareError=matInvHardwareError, matAgent=matAgent, matStsStatus=matStsStatus, matConfInvSysFanSpeed=matConfInvSysFanSpeed, matInvLowInputShutdown=matInvLowInputShutdown, matReturnFromInvMainUnavailable=matReturnFromInvMainUnavailable, matStsInvHighLossVoltage=matStsInvHighLossVoltage, matConfInvSysOutputVolt=matConfInvSysOutputVolt, matConBatteryVoltHigh=matConBatteryVoltHigh, matInvFault=matInvFault, matReturnFromConTemperatureHigh=matReturnFromConTemperatureHigh, matStsMainInputVoltage=matStsMainInputVoltage, matInvEntry=matInvEntry, matInvEEPROMFault=matInvEEPROMFault, matStsEEPROMFault=matStsEEPROMFault, matStsFirmwareVersion=matStsFirmwareVersion, matAgentSoftwareVerison=matAgentSoftwareVerison, matInvPhaseType=matInvPhaseType, matStsMBSPosFault=matStsMBSPosFault, matReturnFromConCanBusOff=matReturnFromConCanBusOff, matConfInvSysLineVoltHighLoss=matConfInvSysLineVoltHighLoss, matInvOutputVoltage=matInvOutputVoltage, matReturnFromStsBackfeedRelayOpen=matReturnFromStsBackfeedRelayOpen, matStsModuleType=matStsModuleType, matInvLineVoltage=matInvLineVoltage, matStsScr1ShortCurcuit=matStsScr1ShortCurcuit, matReturnFromStsFanFault=matReturnFromStsFanFault, matStsNotRespond=matStsNotRespond, matTrapTargetsNum=matTrapTargetsNum, matConfInvSysPowerLimit=matConfInvSysPowerLimit, matTrapTargetsCommunity=matTrapTargetsCommunity, matReturnFromStsFaultMode=matReturnFromStsFaultMode)
