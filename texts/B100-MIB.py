...
iso, ObjectIdentity, TimeTicks, Gauge32, Bits, Counter32, Unsigned32, NotificationType, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "TimeTicks", "Gauge32", "Bits", "Counter32", "Unsigned32", "NotificationType", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("B100-MIB", adaptivCtrlMinP=adaptivCtrlMinP, vSpersistenceTimeout=vSpersistenceTimeout, b100RSTable=b100RSTable, vSstate=vSstate, rSActiveConns=rSActiveConns, vSInPkts=vSInPkts, rSstateChange=rSstateChange, vScheckerType=vScheckerType, vSport=vSport, vSActivConns=vSActivConns, rSInBytes=rSInBytes, rSweight=rSweight, vSstateChange=vSstateChange, numServices=numServices, b100=b100, adaptivInterval=adaptivInterval, vSfollow=vSfollow, vSadaptiveMethod=vSadaptiveMethod, hAstate=hAstate, daemonState=daemonState, totalTps=totalTps, sslTps=sslTps, rsEntry=rsEntry, version=version, rSstate=rSstate, vSidx=vSidx, rSInactiveConns=rSInactiveConns, tcpTimeOut=tcpTimeOut, adaptivUrl=adaptivUrl, rSvsidx=rSvsidx, hAstateChange=hAstateChange, vSInBytes=vSInBytes, vSprotocol=vSprotocol, udpTimeOut=udpTimeOut, vSname=vSname, b100Notifications=b100Notifications, b100NotificationsPrefix=b100NotificationsPrefix, tcpFinTimeOut=tcpFinTimeOut, vSOutPkts=vSOutPkts, vsEntry=vsEntry, adaptivMinWeight=adaptivMinWeight, licenseExceeded=licenseExceeded, PYSNMP_MODULE_ID=b100, vSConns=vSConns, hashTableSize=hashTableSize, rSInPkts=rSInPkts, rSidx=rSidx, vSnumDests=vSnumDests, rSip=rSip, vSOutBytes=vSOutBytes, vSip=vSip, b100VSTable=b100VSTable, rSport=rSport, vSl7cookieId=vSl7cookieId, vSl7persist=vSl7persist, mcastInterface=mcastInterface, rSforwardingMethod=rSforwardingMethod, rSOutPkts=rSOutPkts, rSOutBytes=rSOutBytes, rSaddrtype=rSaddrtype, patchVersion=patchVersion, vSschedulingMethod=vSschedulingMethod, vSaddrtype=vSaddrtype, rSConns=rSConns)
