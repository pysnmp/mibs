...
Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, NotificationType, Counter32, ModuleIdentity, Counter64, iso, Unsigned32, IpAddress, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "NotificationType", "Counter32", "ModuleIdentity", "Counter64", "iso", "Unsigned32", "IpAddress", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("B100-MIB", vSip=vSip, vSpersistenceTimeout=vSpersistenceTimeout, vSnumDests=vSnumDests, rSInPkts=rSInPkts, rSInactiveConns=rSInactiveConns, rSOutPkts=rSOutPkts, version=version, vSConns=vSConns, vSInBytes=vSInBytes, adaptivUrl=adaptivUrl, vSport=vSport, rSstateChange=rSstateChange, tcpFinTimeOut=tcpFinTimeOut, rSvsidx=rSvsidx, tcpTimeOut=tcpTimeOut, vsEntry=vsEntry, adaptivCtrlMinP=adaptivCtrlMinP, udpTimeOut=udpTimeOut, vSidx=vSidx, rSip=rSip, licenseExceeded=licenseExceeded, vSaddrtype=vSaddrtype, sslTps=sslTps, vSprotocol=vSprotocol, rSforwardingMethod=rSforwardingMethod, rSweight=rSweight, adaptivInterval=adaptivInterval, vSschedulingMethod=vSschedulingMethod, vSadaptiveMethod=vSadaptiveMethod, vSfollow=vSfollow, hashTableSize=hashTableSize, rSstate=rSstate, numServices=numServices, mcastInterface=mcastInterface, rSInBytes=rSInBytes, b100VSTable=b100VSTable, totalTps=totalTps, rSport=rSport, rSOutBytes=rSOutBytes, vSInPkts=vSInPkts, rSaddrtype=rSaddrtype, rsEntry=rsEntry, rSidx=rSidx, patchVersion=patchVersion, vSstateChange=vSstateChange, b100RSTable=b100RSTable, b100=b100, PYSNMP_MODULE_ID=b100, vScheckerType=vScheckerType, vSl7persist=vSl7persist, vSname=vSname, hAstate=hAstate, rSActiveConns=rSActiveConns, daemonState=daemonState, vSl7cookieId=vSl7cookieId, hAstateChange=hAstateChange, rSConns=rSConns, b100Notifications=b100Notifications, vSOutPkts=vSOutPkts, vSstate=vSstate, vSOutBytes=vSOutBytes, b100NotificationsPrefix=b100NotificationsPrefix, vSActivConns=vSActivConns, adaptivMinWeight=adaptivMinWeight)
