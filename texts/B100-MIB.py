...
ObjectIdentity, Unsigned32, Gauge32, Counter64, iso, Integer32, Counter32, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Gauge32", "Counter64", "iso", "Integer32", "Counter32", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("B100-MIB", mcastInterface=mcastInterface, vSport=vSport, vSOutBytes=vSOutBytes, rSport=rSport, adaptivUrl=adaptivUrl, rSInactiveConns=rSInactiveConns, vSip=vSip, vSl7persist=vSl7persist, rsEntry=rsEntry, hAstateChange=hAstateChange, vSname=vSname, vSnumDests=vSnumDests, tcpFinTimeOut=tcpFinTimeOut, hAstate=hAstate, vSadaptiveMethod=vSadaptiveMethod, rSOutPkts=rSOutPkts, rSaddrtype=rSaddrtype, version=version, vSaddrtype=vSaddrtype, vSInBytes=vSInBytes, adaptivInterval=adaptivInterval, udpTimeOut=udpTimeOut, rSforwardingMethod=rSforwardingMethod, sslTps=sslTps, numServices=numServices, tcpTimeOut=tcpTimeOut, rSActiveConns=rSActiveConns, b100Notifications=b100Notifications, rSvsidx=rSvsidx, rSstateChange=rSstateChange, vScheckerType=vScheckerType, vsEntry=vsEntry, vSInPkts=vSInPkts, vSstateChange=vSstateChange, rSInPkts=rSInPkts, rSweight=rSweight, rSidx=rSidx, b100=b100, rSip=rSip, adaptivCtrlMinP=adaptivCtrlMinP, b100NotificationsPrefix=b100NotificationsPrefix, vSidx=vSidx, vSprotocol=vSprotocol, rSOutBytes=rSOutBytes, b100VSTable=b100VSTable, b100RSTable=b100RSTable, patchVersion=patchVersion, vSOutPkts=vSOutPkts, rSstate=rSstate, adaptivMinWeight=adaptivMinWeight, vSfollow=vSfollow, PYSNMP_MODULE_ID=b100, vSstate=vSstate, hashTableSize=hashTableSize, rSConns=rSConns, vSConns=vSConns, totalTps=totalTps, vSpersistenceTimeout=vSpersistenceTimeout, rSInBytes=rSInBytes, licenseExceeded=licenseExceeded, vSl7cookieId=vSl7cookieId, vSActivConns=vSActivConns, vSschedulingMethod=vSschedulingMethod, daemonState=daemonState)
