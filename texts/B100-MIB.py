...
ObjectIdentity, ModuleIdentity, Unsigned32, Counter64, MibIdentifier, IpAddress, Gauge32, Counter32, TimeTicks, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Counter64", "MibIdentifier", "IpAddress", "Gauge32", "Counter32", "TimeTicks", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits")
...
mibBuilder.exportSymbols("B100-MIB", vSname=vSname, rSweight=rSweight, rSidx=rSidx, mcastInterface=mcastInterface, b100VSTable=b100VSTable, rsEntry=rsEntry, b100NotificationsPrefix=b100NotificationsPrefix, hashTableSize=hashTableSize, b100Notifications=b100Notifications, vSOutPkts=vSOutPkts, vSActivConns=vSActivConns, b100=b100, rSConns=rSConns, rSActiveConns=rSActiveConns, rSInactiveConns=rSInactiveConns, udpTimeOut=udpTimeOut, totalTps=totalTps, patchVersion=patchVersion, rSport=rSport, vSstateChange=vSstateChange, vSInPkts=vSInPkts, rSOutBytes=rSOutBytes, hAstate=hAstate, vSaddrtype=vSaddrtype, tcpFinTimeOut=tcpFinTimeOut, rSforwardingMethod=rSforwardingMethod, rSstateChange=rSstateChange, vSOutBytes=vSOutBytes, rSip=rSip, adaptivInterval=adaptivInterval, adaptivUrl=adaptivUrl, rSOutPkts=rSOutPkts, licenseExceeded=licenseExceeded, PYSNMP_MODULE_ID=b100, adaptivMinWeight=adaptivMinWeight, rSInPkts=rSInPkts, vSpersistenceTimeout=vSpersistenceTimeout, daemonState=daemonState, b100RSTable=b100RSTable, vScheckerType=vScheckerType, vSschedulingMethod=vSschedulingMethod, vSl7persist=vSl7persist, rSvsidx=rSvsidx, tcpTimeOut=tcpTimeOut, vSport=vSport, vSnumDests=vSnumDests, rSstate=rSstate, adaptivCtrlMinP=adaptivCtrlMinP, vSInBytes=vSInBytes, rSaddrtype=rSaddrtype, vSstate=vSstate, numServices=numServices, sslTps=sslTps, vSfollow=vSfollow, vSidx=vSidx, vSl7cookieId=vSl7cookieId, vSadaptiveMethod=vSadaptiveMethod, hAstateChange=hAstateChange, rSInBytes=rSInBytes, vSip=vSip, version=version, vSprotocol=vSprotocol, vsEntry=vsEntry, vSConns=vSConns)
