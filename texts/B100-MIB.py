...
Bits, IpAddress, MibIdentifier, NotificationType, Counter32, Counter64, ModuleIdentity, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "MibIdentifier", "NotificationType", "Counter32", "Counter64", "ModuleIdentity", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("B100-MIB", rSInPkts=rSInPkts, daemonState=daemonState, vsEntry=vsEntry, vSaddrtype=vSaddrtype, vSl7persist=vSl7persist, adaptivUrl=adaptivUrl, tcpFinTimeOut=tcpFinTimeOut, vSInBytes=vSInBytes, b100VSTable=b100VSTable, vSActivConns=vSActivConns, vSstate=vSstate, rSport=rSport, vSstateChange=vSstateChange, vSOutBytes=vSOutBytes, b100NotificationsPrefix=b100NotificationsPrefix, rSInactiveConns=rSInactiveConns, adaptivInterval=adaptivInterval, rSOutBytes=rSOutBytes, licenseExceeded=licenseExceeded, udpTimeOut=udpTimeOut, vSip=vSip, rSaddrtype=rSaddrtype, vSInPkts=vSInPkts, vSadaptiveMethod=vSadaptiveMethod, vScheckerType=vScheckerType, rSforwardingMethod=rSforwardingMethod, totalTps=totalTps, version=version, rSstateChange=rSstateChange, rSvsidx=rSvsidx, rSip=rSip, rSstate=rSstate, b100RSTable=b100RSTable, rSOutPkts=rSOutPkts, rSweight=rSweight, adaptivCtrlMinP=adaptivCtrlMinP, vSschedulingMethod=vSschedulingMethod, adaptivMinWeight=adaptivMinWeight, hAstateChange=hAstateChange, rSConns=rSConns, vSConns=vSConns, rSidx=rSidx, vSl7cookieId=vSl7cookieId, PYSNMP_MODULE_ID=b100, vSidx=vSidx, sslTps=sslTps, vSfollow=vSfollow, vSOutPkts=vSOutPkts, rSInBytes=rSInBytes, rSActiveConns=rSActiveConns, b100=b100, hashTableSize=hashTableSize, vSprotocol=vSprotocol, vSpersistenceTimeout=vSpersistenceTimeout, tcpTimeOut=tcpTimeOut, mcastInterface=mcastInterface, vSnumDests=vSnumDests, rsEntry=rsEntry, numServices=numServices, hAstate=hAstate, vSport=vSport, vSname=vSname, b100Notifications=b100Notifications, patchVersion=patchVersion)
