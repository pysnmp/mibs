...
MibIdentifier, IpAddress, Integer32, iso, TimeTicks, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Bits, Counter64, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Integer32", "iso", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Bits", "Counter64", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("B100-MIB", vSstate=vSstate, vSschedulingMethod=vSschedulingMethod, licenseExceeded=licenseExceeded, udpTimeOut=udpTimeOut, vSname=vSname, rsEntry=rsEntry, hAstate=hAstate, vSOutPkts=vSOutPkts, vSActivConns=vSActivConns, adaptivInterval=adaptivInterval, version=version, vSOutBytes=vSOutBytes, vSidx=vSidx, rSOutPkts=rSOutPkts, rSweight=rSweight, numServices=numServices, adaptivUrl=adaptivUrl, rSstate=rSstate, totalTps=totalTps, sslTps=sslTps, b100VSTable=b100VSTable, rSvsidx=rSvsidx, vSl7cookieId=vSl7cookieId, rSip=rSip, vSConns=vSConns, rSforwardingMethod=rSforwardingMethod, vSpersistenceTimeout=vSpersistenceTimeout, hashTableSize=hashTableSize, vSip=vSip, tcpFinTimeOut=tcpFinTimeOut, vSInPkts=vSInPkts, rSOutBytes=rSOutBytes, rSActiveConns=rSActiveConns, daemonState=daemonState, rSInactiveConns=rSInactiveConns, PYSNMP_MODULE_ID=b100, vSl7persist=vSl7persist, vSport=vSport, rSaddrtype=rSaddrtype, mcastInterface=mcastInterface, rSidx=rSidx, b100NotificationsPrefix=b100NotificationsPrefix, vSprotocol=vSprotocol, rSConns=rSConns, patchVersion=patchVersion, vsEntry=vsEntry, vSfollow=vSfollow, b100Notifications=b100Notifications, b100RSTable=b100RSTable, adaptivMinWeight=adaptivMinWeight, rSstateChange=rSstateChange, rSport=rSport, adaptivCtrlMinP=adaptivCtrlMinP, rSInPkts=rSInPkts, tcpTimeOut=tcpTimeOut, vSadaptiveMethod=vSadaptiveMethod, vSInBytes=vSInBytes, hAstateChange=hAstateChange, vSaddrtype=vSaddrtype, rSInBytes=rSInBytes, vSnumDests=vSnumDests, vSstateChange=vSstateChange, vScheckerType=vScheckerType, b100=b100)
