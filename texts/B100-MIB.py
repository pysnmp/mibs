...
Integer32, Bits, Counter32, ObjectIdentity, Unsigned32, Gauge32, Counter64, ModuleIdentity, IpAddress, NotificationType, iso, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Counter32", "ObjectIdentity", "Unsigned32", "Gauge32", "Counter64", "ModuleIdentity", "IpAddress", "NotificationType", "iso", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("B100-MIB", vSpersistenceTimeout=vSpersistenceTimeout, rSaddrtype=rSaddrtype, udpTimeOut=udpTimeOut, vSActivConns=vSActivConns, numServices=numServices, adaptivUrl=adaptivUrl, adaptivMinWeight=adaptivMinWeight, rSvsidx=rSvsidx, rSstateChange=rSstateChange, rSport=rSport, vSInPkts=vSInPkts, vSstate=vSstate, hAstate=hAstate, tcpFinTimeOut=tcpFinTimeOut, patchVersion=patchVersion, rSInPkts=rSInPkts, version=version, vSip=vSip, vSl7cookieId=vSl7cookieId, rSInactiveConns=rSInactiveConns, rSOutBytes=rSOutBytes, vSnumDests=vSnumDests, rSActiveConns=rSActiveConns, b100VSTable=b100VSTable, b100=b100, hAstateChange=hAstateChange, vSfollow=vSfollow, vSInBytes=vSInBytes, rSip=rSip, vSschedulingMethod=vSschedulingMethod, rSOutPkts=rSOutPkts, rSInBytes=rSInBytes, vSidx=vSidx, rSConns=rSConns, vSl7persist=vSl7persist, vSport=vSport, rSidx=rSidx, licenseExceeded=licenseExceeded, daemonState=daemonState, adaptivInterval=adaptivInterval, b100Notifications=b100Notifications, vsEntry=vsEntry, totalTps=totalTps, b100NotificationsPrefix=b100NotificationsPrefix, vSname=vSname, rSstate=rSstate, sslTps=sslTps, vSstateChange=vSstateChange, vSadaptiveMethod=vSadaptiveMethod, vSOutPkts=vSOutPkts, vSaddrtype=vSaddrtype, rSweight=rSweight, tcpTimeOut=tcpTimeOut, hashTableSize=hashTableSize, b100RSTable=b100RSTable, vSprotocol=vSprotocol, PYSNMP_MODULE_ID=b100, adaptivCtrlMinP=adaptivCtrlMinP, mcastInterface=mcastInterface, vSOutBytes=vSOutBytes, vSConns=vSConns, vScheckerType=vScheckerType, rsEntry=rsEntry, rSforwardingMethod=rSforwardingMethod)
