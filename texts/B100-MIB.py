...
ObjectIdentity, iso, IpAddress, Counter32, NotificationType, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, MibIdentifier, Gauge32, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "IpAddress", "Counter32", "NotificationType", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "MibIdentifier", "Gauge32", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("B100-MIB", adaptivUrl=adaptivUrl, b100Notifications=b100Notifications, adaptivCtrlMinP=adaptivCtrlMinP, vSnumDests=vSnumDests, vSInBytes=vSInBytes, vSActivConns=vSActivConns, rSweight=rSweight, vSl7persist=vSl7persist, rSInactiveConns=rSInactiveConns, hashTableSize=hashTableSize, vSip=vSip, vSConns=vSConns, licenseExceeded=licenseExceeded, tcpTimeOut=tcpTimeOut, vSstateChange=vSstateChange, b100VSTable=b100VSTable, b100RSTable=b100RSTable, vSprotocol=vSprotocol, rsEntry=rsEntry, vSOutPkts=vSOutPkts, adaptivInterval=adaptivInterval, b100NotificationsPrefix=b100NotificationsPrefix, rSvsidx=rSvsidx, rSstateChange=rSstateChange, vSport=vSport, rSport=rSport, patchVersion=patchVersion, tcpFinTimeOut=tcpFinTimeOut, daemonState=daemonState, hAstate=hAstate, rSInBytes=rSInBytes, adaptivMinWeight=adaptivMinWeight, rSstate=rSstate, vsEntry=vsEntry, rSOutBytes=rSOutBytes, vSschedulingMethod=vSschedulingMethod, vSfollow=vSfollow, vSInPkts=vSInPkts, udpTimeOut=udpTimeOut, b100=b100, version=version, hAstateChange=hAstateChange, rSConns=rSConns, vSl7cookieId=vSl7cookieId, rSaddrtype=rSaddrtype, vSstate=vSstate, vSaddrtype=vSaddrtype, numServices=numServices, vSpersistenceTimeout=vSpersistenceTimeout, rSidx=rSidx, rSOutPkts=rSOutPkts, mcastInterface=mcastInterface, vSidx=vSidx, PYSNMP_MODULE_ID=b100, vSOutBytes=vSOutBytes, rSInPkts=rSInPkts, sslTps=sslTps, totalTps=totalTps, rSActiveConns=rSActiveConns, rSforwardingMethod=rSforwardingMethod, vSadaptiveMethod=vSadaptiveMethod, vScheckerType=vScheckerType, vSname=vSname, rSip=rSip)
