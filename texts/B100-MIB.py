...
Bits, MibIdentifier, Integer32, Gauge32, IpAddress, TimeTicks, Counter64, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Integer32", "Gauge32", "IpAddress", "TimeTicks", "Counter64", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Counter32", "iso")
...
mibBuilder.exportSymbols("B100-MIB", vSstate=vSstate, vSaddrtype=vSaddrtype, rSInactiveConns=rSInactiveConns, rSaddrtype=rSaddrtype, udpTimeOut=udpTimeOut, vSfollow=vSfollow, rSInPkts=rSInPkts, adaptivCtrlMinP=adaptivCtrlMinP, vSl7cookieId=vSl7cookieId, rSConns=rSConns, vSOutBytes=vSOutBytes, version=version, adaptivUrl=adaptivUrl, rSip=rSip, rSport=rSport, rSvsidx=rSvsidx, rSOutPkts=rSOutPkts, b100=b100, rSstateChange=rSstateChange, vSInBytes=vSInBytes, hashTableSize=hashTableSize, vSidx=vSidx, tcpFinTimeOut=tcpFinTimeOut, vSstateChange=vSstateChange, rSforwardingMethod=rSforwardingMethod, mcastInterface=mcastInterface, vSActivConns=vSActivConns, rSActiveConns=rSActiveConns, daemonState=daemonState, rsEntry=rsEntry, numServices=numServices, b100NotificationsPrefix=b100NotificationsPrefix, vSadaptiveMethod=vSadaptiveMethod, PYSNMP_MODULE_ID=b100, tcpTimeOut=tcpTimeOut, vSnumDests=vSnumDests, vSConns=vSConns, hAstate=hAstate, adaptivInterval=adaptivInterval, vsEntry=vsEntry, sslTps=sslTps, vSInPkts=vSInPkts, hAstateChange=hAstateChange, rSidx=rSidx, rSweight=rSweight, totalTps=totalTps, vSport=vSport, patchVersion=patchVersion, rSInBytes=rSInBytes, rSstate=rSstate, licenseExceeded=licenseExceeded, vSip=vSip, vSpersistenceTimeout=vSpersistenceTimeout, vSname=vSname, b100VSTable=b100VSTable, adaptivMinWeight=adaptivMinWeight, vScheckerType=vScheckerType, vSl7persist=vSl7persist, rSOutBytes=rSOutBytes, b100Notifications=b100Notifications, vSprotocol=vSprotocol, vSschedulingMethod=vSschedulingMethod, b100RSTable=b100RSTable, vSOutPkts=vSOutPkts)
