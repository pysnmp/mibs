...
Gauge32, iso, NotificationType, ModuleIdentity, ObjectIdentity, Bits, Counter32, Unsigned32, Counter64, MibIdentifier, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Bits", "Counter32", "Unsigned32", "Counter64", "MibIdentifier", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("B100-MIB", rSInPkts=rSInPkts, rSvsidx=rSvsidx, hAstate=hAstate, vSpersistenceTimeout=vSpersistenceTimeout, rSidx=rSidx, vSfollow=vSfollow, vSActivConns=vSActivConns, rSport=rSport, udpTimeOut=udpTimeOut, rSConns=rSConns, patchVersion=patchVersion, rSInBytes=rSInBytes, vSInPkts=vSInPkts, vSaddrtype=vSaddrtype, rSOutBytes=rSOutBytes, adaptivCtrlMinP=adaptivCtrlMinP, vSOutPkts=vSOutPkts, adaptivInterval=adaptivInterval, vSidx=vSidx, b100RSTable=b100RSTable, vSstate=vSstate, mcastInterface=mcastInterface, licenseExceeded=licenseExceeded, b100Notifications=b100Notifications, vSInBytes=vSInBytes, rSstateChange=rSstateChange, vScheckerType=vScheckerType, rsEntry=rsEntry, vSname=vSname, adaptivUrl=adaptivUrl, b100NotificationsPrefix=b100NotificationsPrefix, vSschedulingMethod=vSschedulingMethod, adaptivMinWeight=adaptivMinWeight, rSInactiveConns=rSInactiveConns, vSOutBytes=vSOutBytes, rSip=rSip, rSOutPkts=rSOutPkts, sslTps=sslTps, vSadaptiveMethod=vSadaptiveMethod, rSforwardingMethod=rSforwardingMethod, vSport=vSport, vSnumDests=vSnumDests, rSstate=rSstate, vSl7cookieId=vSl7cookieId, PYSNMP_MODULE_ID=b100, vSip=vSip, rSActiveConns=rSActiveConns, b100VSTable=b100VSTable, tcpFinTimeOut=tcpFinTimeOut, vSprotocol=vSprotocol, rSweight=rSweight, rSaddrtype=rSaddrtype, hashTableSize=hashTableSize, tcpTimeOut=tcpTimeOut, hAstateChange=hAstateChange, numServices=numServices, vSl7persist=vSl7persist, vSstateChange=vSstateChange, vSConns=vSConns, totalTps=totalTps, version=version, vsEntry=vsEntry, daemonState=daemonState, b100=b100)
