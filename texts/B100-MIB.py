...
ModuleIdentity, MibIdentifier, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, iso, IpAddress, Counter64, Counter32, Gauge32, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "iso", "IpAddress", "Counter64", "Counter32", "Gauge32", "Integer32", "Bits")
...
mibBuilder.exportSymbols("B100-MIB", hashTableSize=hashTableSize, rSInBytes=rSInBytes, rSOutBytes=rSOutBytes, vSnumDests=vSnumDests, rSaddrtype=rSaddrtype, rSOutPkts=rSOutPkts, vSstateChange=vSstateChange, vSschedulingMethod=vSschedulingMethod, version=version, vSOutPkts=vSOutPkts, vsEntry=vsEntry, hAstateChange=hAstateChange, vScheckerType=vScheckerType, rSInPkts=rSInPkts, daemonState=daemonState, rSConns=rSConns, vSOutBytes=vSOutBytes, adaptivCtrlMinP=adaptivCtrlMinP, vSidx=vSidx, vSadaptiveMethod=vSadaptiveMethod, udpTimeOut=udpTimeOut, vSInBytes=vSInBytes, rSInactiveConns=rSInactiveConns, vSConns=vSConns, totalTps=totalTps, adaptivUrl=adaptivUrl, tcpTimeOut=tcpTimeOut, b100NotificationsPrefix=b100NotificationsPrefix, numServices=numServices, vSInPkts=vSInPkts, adaptivInterval=adaptivInterval, vSpersistenceTimeout=vSpersistenceTimeout, rSvsidx=rSvsidx, vSaddrtype=vSaddrtype, b100VSTable=b100VSTable, vSfollow=vSfollow, rSActiveConns=rSActiveConns, b100RSTable=b100RSTable, b100=b100, rSidx=rSidx, vSl7cookieId=vSl7cookieId, b100Notifications=b100Notifications, licenseExceeded=licenseExceeded, rSport=rSport, rSstateChange=rSstateChange, sslTps=sslTps, tcpFinTimeOut=tcpFinTimeOut, vSname=vSname, mcastInterface=mcastInterface, vSport=vSport, vSl7persist=vSl7persist, vSstate=vSstate, vSActivConns=vSActivConns, rsEntry=rsEntry, rSforwardingMethod=rSforwardingMethod, patchVersion=patchVersion, rSstate=rSstate, vSip=vSip, PYSNMP_MODULE_ID=b100, rSip=rSip, vSprotocol=vSprotocol, rSweight=rSweight, adaptivMinWeight=adaptivMinWeight, hAstate=hAstate)
