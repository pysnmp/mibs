...
ModuleIdentity, Counter32, TimeTicks, NotificationType, IpAddress, Counter64, Unsigned32, Bits, ObjectIdentity, Integer32, MibIdentifier, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "TimeTicks", "NotificationType", "IpAddress", "Counter64", "Unsigned32", "Bits", "ObjectIdentity", "Integer32", "MibIdentifier", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("B100-MIB", rSip=rSip, vSActivConns=vSActivConns, vSadaptiveMethod=vSadaptiveMethod, vSport=vSport, rSport=rSport, vSprotocol=vSprotocol, hAstate=hAstate, vSInBytes=vSInBytes, vSInPkts=vSInPkts, b100NotificationsPrefix=b100NotificationsPrefix, vSl7persist=vSl7persist, rSActiveConns=rSActiveConns, rSvsidx=rSvsidx, licenseExceeded=licenseExceeded, rSInBytes=rSInBytes, mcastInterface=mcastInterface, rSInPkts=rSInPkts, sslTps=sslTps, vSConns=vSConns, udpTimeOut=udpTimeOut, b100RSTable=b100RSTable, b100Notifications=b100Notifications, adaptivInterval=adaptivInterval, version=version, vSpersistenceTimeout=vSpersistenceTimeout, rSweight=rSweight, adaptivMinWeight=adaptivMinWeight, rSstateChange=rSstateChange, rSOutBytes=rSOutBytes, vSOutBytes=vSOutBytes, vSip=vSip, rSConns=rSConns, vSname=vSname, daemonState=daemonState, hAstateChange=hAstateChange, b100=b100, rsEntry=rsEntry, rSOutPkts=rSOutPkts, totalTps=totalTps, hashTableSize=hashTableSize, adaptivUrl=adaptivUrl, vSnumDests=vSnumDests, vSidx=vSidx, rSInactiveConns=rSInactiveConns, vSOutPkts=vSOutPkts, tcpTimeOut=tcpTimeOut, PYSNMP_MODULE_ID=b100, numServices=numServices, vScheckerType=vScheckerType, rSidx=rSidx, vSschedulingMethod=vSschedulingMethod, patchVersion=patchVersion, vSstate=vSstate, rSforwardingMethod=rSforwardingMethod, vSaddrtype=vSaddrtype, adaptivCtrlMinP=adaptivCtrlMinP, rSaddrtype=rSaddrtype, vSfollow=vSfollow, b100VSTable=b100VSTable, tcpFinTimeOut=tcpFinTimeOut, vsEntry=vsEntry, vSstateChange=vSstateChange, rSstate=rSstate, vSl7cookieId=vSl7cookieId)
