...
TimeTicks, Counter32, Unsigned32, Counter64, MibIdentifier, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Bits, ObjectIdentity, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Unsigned32", "Counter64", "MibIdentifier", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Bits", "ObjectIdentity", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("B100-MIB", adaptivInterval=adaptivInterval, patchVersion=patchVersion, tcpTimeOut=tcpTimeOut, rSstate=rSstate, licenseExceeded=licenseExceeded, vSInPkts=vSInPkts, rSidx=rSidx, vSfollow=vSfollow, rSweight=rSweight, rSstateChange=rSstateChange, vSl7cookieId=vSl7cookieId, mcastInterface=mcastInterface, numServices=numServices, rSInactiveConns=rSInactiveConns, vSpersistenceTimeout=vSpersistenceTimeout, vsEntry=vsEntry, vSname=vSname, vSstate=vSstate, vSInBytes=vSInBytes, vSActivConns=vSActivConns, vScheckerType=vScheckerType, vSl7persist=vSl7persist, vSidx=vSidx, rSip=rSip, vSschedulingMethod=vSschedulingMethod, version=version, rsEntry=rsEntry, rSActiveConns=rSActiveConns, rSport=rSport, adaptivUrl=adaptivUrl, vSConns=vSConns, rSInBytes=rSInBytes, rSOutPkts=rSOutPkts, hashTableSize=hashTableSize, b100RSTable=b100RSTable, tcpFinTimeOut=tcpFinTimeOut, vSadaptiveMethod=vSadaptiveMethod, vSOutBytes=vSOutBytes, sslTps=sslTps, b100VSTable=b100VSTable, b100=b100, totalTps=totalTps, adaptivCtrlMinP=adaptivCtrlMinP, rSvsidx=rSvsidx, vSOutPkts=vSOutPkts, PYSNMP_MODULE_ID=b100, udpTimeOut=udpTimeOut, vSstateChange=vSstateChange, vSaddrtype=vSaddrtype, vSip=vSip, rSInPkts=rSInPkts, hAstate=hAstate, b100Notifications=b100Notifications, hAstateChange=hAstateChange, vSnumDests=vSnumDests, rSforwardingMethod=rSforwardingMethod, rSOutBytes=rSOutBytes, rSaddrtype=rSaddrtype, b100NotificationsPrefix=b100NotificationsPrefix, daemonState=daemonState, vSport=vSport, rSConns=rSConns, adaptivMinWeight=adaptivMinWeight, vSprotocol=vSprotocol)
