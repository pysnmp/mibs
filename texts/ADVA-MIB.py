...
TimeTicks, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Gauge32, MibIdentifier, Counter32, ModuleIdentity, enterprises, IpAddress, Counter64, snmpModules, Unsigned32, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Gauge32", "MibIdentifier", "Counter32", "ModuleIdentity", "enterprises", "IpAddress", "Counter64", "snmpModules", "Unsigned32", "mib-2", "Integer32")
DateAndTime, DisplayString, TestAndIncr, TextualConvention, MacAddress, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DateAndTime", "DisplayString", "TestAndIncr", "TextualConvention", "MacAddress", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("ADVA-MIB", ncuScheduledDbRestore=ncuScheduledDbRestore, swDbDataArea=swDbDataArea, neInfo=neInfo, snmpWriteAccessRestriction=snmpWriteAccessRestriction, neBackupPassword=neBackupPassword, vtpEntityContainedIn=vtpEntityContainedIn, otuSectionConfigPayload=otuSectionConfigPayload, LoopConfigCaps=LoopConfigCaps, controlPlaneOtnEntityClass=controlPlaneOtnEntityClass, controlPlaneWdmContainsEntry=controlPlaneWdmContainsEntry, fwDataEntry=fwDataEntry, fwDataProtectionPart=fwDataProtectionPart, swDbFilePgmType=swDbFilePgmType, otuSectionDataResultingTotalBitrate=otuSectionDataResultingTotalBitrate, inventoryEntry=inventoryEntry, EquipmentState=EquipmentState, fsp150cm=fsp150cm, controlPlaneWdmEntityTable=controlPlaneWdmEntityTable, snmpProxyEntrySingleTargetOutContext=snmpProxyEntrySingleTargetOutContext, neF7AutomaticBackupStartTime=neF7AutomaticBackupStartTime, neDateAndTime=neDateAndTime, neF7AutomaticRemoteBackupPassword=neF7AutomaticRemoteBackupPassword, FspDate=FspDate, neStorageTable=neStorageTable, oduSectionConfigEntry=oduSectionConfigEntry, FspR7AdminStateSnmpProxyCaps=FspR7AdminStateSnmpProxyCaps, neRestoreFileBackupDate=neRestoreFileBackupDate, otuSectionDataTraceReceivedSapi=otuSectionDataTraceReceivedSapi, controlPlaneOtnEntityIndexAid=controlPlaneOtnEntityIndexAid, OtnTcmLevelCaps=OtnTcmLevelCaps, StandbyServiceAffecting=StandbyServiceAffecting, ptpEntityIndex=ptpEntityIndex, neF7AutomaticRemoteBackupSrvLogin=neF7AutomaticRemoteBackupSrvLogin, otuSectionDataTraceReceivedOpsp=otuSectionDataTraceReceivedOpsp, neSwUpgradeCommonIpSrv=neSwUpgradeCommonIpSrv, vtpEntityClass=vtpEntityClass, oduSectionDataTraceReceivedDapi=oduSectionDataTraceReceivedDapi, neEventLogVarUnsigned32Val=neEventLogVarUnsigned32Val, otuSectionConfigTimMode=otuSectionConfigTimMode, neEventsLogged=neEventsLogged, sonetSectionDataEntry=sonetSectionDataEntry, oduTcmCConfigTraceTransmitSapi=oduTcmCConfigTraceTransmitSapi, swDbDataDefaultsRestoreConfig=swDbDataDefaultsRestoreConfig, sonetSectionDataTable=sonetSectionDataTable, swDbDataNumEqpt=swDbDataNumEqpt, otuSectionDataTraceReceivedDapi=otuSectionDataTraceReceivedDapi, eqpFwNextEqpForUpdate=eqpFwNextEqpForUpdate, swDbFileComment=swDbFileComment, ptpEntityType=ptpEntityType, inventoryCleiCode=inventoryCleiCode, aosProducts=aosProducts, swVersionTable=swVersionTable, fsp2000=fsp2000, neF7AutomaticBackupNextDate=neF7AutomaticBackupNextDate, oduTcmCConfigEntry=oduTcmCConfigEntry, EthDuplexModeCaps=EthDuplexModeCaps, inventoryFpgaRev=inventoryFpgaRev, inventoryType=inventoryType, fwDataFirmwarePackageRev=fwDataFirmwarePackageRev, config=config, installedEqpt=installedEqpt, sonetSectionDataTraceReceived=sonetSectionDataTraceReceived, inventoryTable=inventoryTable, controlPlaneOtnContainsIndex=controlPlaneOtnContainsIndex, F7AutoBackupRunState=F7AutoBackupRunState, oduTcmBConfigTcmLevel=oduTcmBConfigTcmLevel, neEventLogVarType=neEventLogVarType, swDbDataNumNativeNsaUpdate=swDbDataNumNativeNsaUpdate, oduTcmADataTraceReceivedOpsp=oduTcmADataTraceReceivedOpsp, neStorageIndex=neStorageIndex, ncuActivationDate=ncuActivationDate, ptpEntityEquipmentState=ptpEntityEquipmentState, ncuActivationTime=ncuActivationTime, swDbFileArea=swDbFileArea, swDbDataDefaultsUpgradeRequest=swDbDataDefaultsUpgradeRequest, oduTcmADataTraceReceivedSapi=oduTcmADataTraceReceivedSapi, oduTcmAConfigSignalDegradeThreshold=oduTcmAConfigSignalDegradeThreshold, swDbFileCreationTime=swDbFileCreationTime, neSwUpgradeFileName=neSwUpgradeFileName, neAutoBackupServerPasswd=neAutoBackupServerPasswd, controlPlaneEthEntityClassInstanceNumber=controlPlaneEthEntityClassInstanceNumber, neTrapsinkTable=neTrapsinkTable, neEventLogIdentityTranslation=neEventLogIdentityTranslation, swDbFileTable=swDbFileTable, snmpProxyEntrySingleTargetOutNodeAgentStatus=snmpProxyEntrySingleTargetOutNodeAgentStatus, oduTcmCConfigSignalDegradePeriod=oduTcmCConfigSignalDegradePeriod, EnableStateCaps=EnableStateCaps, ApsHoldoffTimeCaps=ApsHoldoffTimeCaps, BootState=BootState, selectedFile=selectedFile, oduTcmAConfigTraceTransmitDapi=oduTcmAConfigTraceTransmitDapi, ptpEntityAssignmentState=ptpEntityAssignmentState, oduTcmBDataTraceReceivedOpsp=oduTcmBDataTraceReceivedOpsp, inventoryMib=inventoryMib, neAutoBackupServerLogin=neAutoBackupServerLogin, events=events, oduSectionConfigSignalDegradePeriod=oduSectionConfigSignalDegradePeriod, vtpEntityIndex=vtpEntityIndex, neAutoBackupServerDirectory=neAutoBackupServerDirectory, otuSectionConfigTraceTransmitSapi=otuSectionConfigTraceTransmitSapi, oduTcmBConfigTimMode=oduTcmBConfigTimMode, neSwInstallState=neSwInstallState, swDbFileSize=swDbFileSize, NeSwUpgradeStatusType=NeSwUpgradeStatusType, swAdmin=swAdmin, fsp150=fsp150, sourceIpAddress=sourceIpAddress, neEventLogVarOctetStringVal=neEventLogVarOctetStringVal, otuSectionConfigTraceExpected=otuSectionConfigTraceExpected, NoYesNA=NoYesNA, inventoryPartnumber=inventoryPartnumber, entityType=entityType, oduTcmAConfigTable=oduTcmAConfigTable, neF7AutomaticRemoteBackupSrvIp=neF7AutomaticRemoteBackupSrvIp, FspR7Date=FspR7Date, snmpWriteAccessNmsName=snmpWriteAccessNmsName, FileType=FileType, oduTcmBConfigTraceTransmitDapi=oduTcmBConfigTraceTransmitDapi, controlPlaneWdmEntityAssignmentState=controlPlaneWdmEntityAssignmentState, otuSectionDataTable=otuSectionDataTable, oduTcmCConfigSignalDegradeThreshold=oduTcmCConfigSignalDegradeThreshold, oduTcmADataEntry=oduTcmADataEntry, neStorageAvailable=neStorageAvailable, oduTcmAConfigEntry=oduTcmAConfigEntry, inventorySerialNum=inventorySerialNum, aos=aos, inventoryCfModel=inventoryCfModel, FspR7YesNo=FspR7YesNo, containsIndex=containsIndex, ptpEntityEntry=ptpEntityEntry, ptpEntityContainedIn=ptpEntityContainedIn, fwDataFirmwareAvailable=fwDataFirmwareAvailable, fspNm=fspNm, oduSectionConfigTraceTransmitSapi=oduSectionConfigTraceTransmitSapi, TrapCounter=TrapCounter, oduTcmCDataTraceReceivedSapi=oduTcmCDataTraceReceivedSapi, fwDataStandbyServiceImpairment=fwDataStandbyServiceImpairment, neEventLogNotificationOID=neEventLogNotificationOID, ptpEntityClass=ptpEntityClass, oduTcmADataTraceReceivedDapi=oduTcmADataTraceReceivedDapi, FspR7EquipmentType=FspR7EquipmentType, vtpEntityEquipmentState=vtpEntityEquipmentState, fsp1000=fsp1000, EntityClass=EntityClass, oduConfig=oduConfig, entityClass=entityClass, controlPlaneWdmContainsTable=controlPlaneWdmContainsTable, oduTcmBConfigTraceExpected=oduTcmBConfigTraceExpected, SonetVcBundleAllocationCaps=SonetVcBundleAllocationCaps, containsTable=containsTable, snmpProxyEntrySingleTargetOutEntry=snmpProxyEntrySingleTargetOutEntry, sonetSectionConfigTable=sonetSectionConfigTable, coldRestartCapTable=coldRestartCapTable, Counter64String=Counter64String, controlPlaneOtnContainsEntry=controlPlaneOtnContainsEntry, neTrapsinkAddress=neTrapsinkAddress, snmpWriteAccessTable=snmpWriteAccessTable, F7FileTimeStamp=F7FileTimeStamp, PYSNMP_MODULE_ID=advaMIB, fsp1000adm=fsp1000adm, ProtectionMechCaps=ProtectionMechCaps, snmpProxyServerPort=snmpProxyServerPort, neSwUpgradeType=neSwUpgradeType, F7AutoBackupInterval=F7AutoBackupInterval, sonetSectionConfigSignalDegradeThreshhold=sonetSectionConfigSignalDegradeThreshhold, oduTcmAConfigTimMode=oduTcmAConfigTimMode, swDbDataFirmwareSetVersion=swDbDataFirmwareSetVersion, swDbDataCapRestoreConfig=swDbDataCapRestoreConfig, entityEquipmentState=entityEquipmentState, otuSectionDataEntry=otuSectionDataEntry, ApsDirection=ApsDirection, neTrapsinkType=neTrapsinkType, fwDataTable=fwDataTable, SonetTimingSourceCaps=SonetTimingSourceCaps, Grade=Grade, neEventLogVarTable=neEventLogVarTable, neSwUpgradeServerDirectory=neSwUpgradeServerDirectory, swDbDataDatabaseVersion=swDbDataDatabaseVersion, controlPlaneOtnEntityEntry=controlPlaneOtnEntityEntry, neEventLogTable=neEventLogTable, swDbFileRowStatus=swDbFileRowStatus, oduTcmBConfigEntry=oduTcmBConfigEntry, oduSectionDataEntry=oduSectionDataEntry, EntityIndex=EntityIndex, oduTcmCDataEntry=oduTcmCDataEntry, neAutoBackupNextActionAt=neAutoBackupNextActionAt, FspR7Time=FspR7Time, neF7AutomaticRemoteBackupSrcIp=neF7AutomaticRemoteBackupSrcIp, sonetSectionConfigTimMode=sonetSectionConfigTimMode, oduTcmAConfigTcmLevel=oduTcmAConfigTcmLevel, oduSectionConfigTimMode=oduSectionConfigTimMode, swDbDataProgramVersion=swDbDataProgramVersion, vtpEntityIndexAid=vtpEntityIndexAid, OhTerminationLevelCaps=OhTerminationLevelCaps, neInitialConnectionMode=neInitialConnectionMode, oduSectionDataTable=oduSectionDataTable, snmpProxyEntrySingleTargetOutUserName=snmpProxyEntrySingleTargetOutUserName, neManufacturer=neManufacturer, EntityType=EntityType, ModuleForm=ModuleForm, swDbFileIndex=swDbFileIndex, swDbDataNumNativeSaUpdate=swDbDataNumNativeSaUpdate, neF7AutomaticRemoteBackupProtocol=neF7AutomaticRemoteBackupProtocol, oduTcmBDataTraceReceivedSapi=oduTcmBDataTraceReceivedSapi, oduSectionConfigTraceTransmitOpsp=oduSectionConfigTraceTransmitOpsp, oduTcmBDataTable=oduTcmBDataTable, swDbDataActivationTime=swDbDataActivationTime, provContainerEntry=provContainerEntry, otuSectionConfigTraceTransmitOpsp=otuSectionConfigTraceTransmitOpsp, oduTcmBConfigTable=oduTcmBConfigTable, fsp3000=fsp3000, fwDataServiceImpairment=fwDataServiceImpairment, FspR7UsersDb=FspR7UsersDb, snmpServerPort=snmpServerPort, oduSectionConfigTraceExpected=oduSectionConfigTraceExpected, FspR7EnableDisable=FspR7EnableDisable, LoopConfig=LoopConfig, neBackupRestoreFile=neBackupRestoreFile, snmpProxyServerSynchroStage=snmpProxyServerSynchroStage, swDbDataNumSaNotReady=swDbDataNumSaNotReady, eqpFwServiceImpairment=eqpFwServiceImpairment, neF7AutomaticBackupStartDate=neF7AutomaticBackupStartDate, fwDataFirmwareApproved=fwDataFirmwareApproved, oduTcmBDataTraceReceivedDapi=oduTcmBDataTraceReceivedDapi, LogicalIfTransport=LogicalIfTransport, oduTcmCConfigTraceTransmitDapi=oduTcmCConfigTraceTransmitDapi, ptpEntityClassInstanceNumber=ptpEntityClassInstanceNumber, oduTcmBConfigTraceTransmitOpsp=oduTcmBConfigTraceTransmitOpsp, fwDataNewVersion=fwDataNewVersion, neF7AutomaticBackupTimeStamp=neF7AutomaticBackupTimeStamp, swDbFileVersion=swDbFileVersion, ServiceAffecting=ServiceAffecting, neTrapsinkEntry=neTrapsinkEntry, provAssignmentState=provAssignmentState, neAutoBackupConfig=neAutoBackupConfig, controlPlaneEthEntityTable=controlPlaneEthEntityTable, swDbDataCapTable=swDbDataCapTable, advaMIB=advaMIB, swDbFileGrade=swDbFileGrade, controlPlaneWdmEntityIndex=controlPlaneWdmEntityIndex, neSwUpgradeNeDirectory=neSwUpgradeNeDirectory, oduSectionConfigTable=oduSectionConfigTable, sonetConfig=sonetConfig, snmpProxyEntrySingleTargetOutPort=snmpProxyEntrySingleTargetOutPort, neSwUpgradeTransferProtocol=neSwUpgradeTransferProtocol, inventoryCfSerialNum=inventoryCfSerialNum, sonetSectionConfigEntry=sonetSectionConfigEntry, controlPlaneEthEntityAssignmentState=controlPlaneEthEntityAssignmentState, OtnTcmLevel=OtnTcmLevel, SonetVcBundleAllocation=SonetVcBundleAllocation, sonetSectionConfigTimingSource=sonetSectionConfigTimingSource, ncuScheduledActivation=ncuScheduledActivation, swDbDataDefaultsTable=swDbDataDefaultsTable, neAutoBackupServerAddress=neAutoBackupServerAddress)
mibBuilder.exportSymbols("ADVA-MIB", fwDataFirmwarePackageRevBackup=fwDataFirmwarePackageRevBackup, neF7AutomaticRemoteBackupSrvPass=neF7AutomaticRemoteBackupSrvPass, neMibVariant=neMibVariant, oduSectionDataTraceReceivedOpsp=oduSectionDataTraceReceivedOpsp, containsEntry=containsEntry, neTrapsinkCommunity=neTrapsinkCommunity, NeSwInstallStatusType=NeSwInstallStatusType, eqpFwNcuServerBusy=eqpFwNcuServerBusy, controlPlaneOtnEntityContainedIn=controlPlaneOtnEntityContainedIn, EthDuplexMode=EthDuplexMode, IdentityTranslation=IdentityTranslation, oduTcmCConfigTcmLevel=oduTcmCConfigTcmLevel, neF7AutomaticBackupRunState=neF7AutomaticBackupRunState, coldRestartCapServiceAffectingCap=coldRestartCapServiceAffectingCap, RestoreActivationCaps=RestoreActivationCaps, SonetTraceFormCaps=SonetTraceFormCaps, neEventLogVarIpAddressVal=neEventLogVarIpAddressVal, admin=admin, swDbDataEntry=swDbDataEntry, ProtectionMech=ProtectionMech, controlPlaneWdmEntityClass=controlPlaneWdmEntityClass, OnOff=OnOff, fsp1500=fsp1500, neSwDownloadProgress=neSwDownloadProgress, oduTcmBDataEntry=oduTcmBDataEntry, inventoryVendorId=inventoryVendorId, neSwUpgradeServerLogin=neSwUpgradeServerLogin, software=software, neMemorySizeFree=neMemorySizeFree, neAlarmStatus=neAlarmStatus, ServiceAffectingCaps=ServiceAffectingCaps, neF7AutomaticRemoteBackupTimeStamp=neF7AutomaticRemoteBackupTimeStamp, neAutoBackupInterval=neAutoBackupInterval, fspR7=fspR7, ArcState=ArcState, neSwUpgradeServerAddress=neSwUpgradeServerAddress, NcuAutoActivation=NcuAutoActivation, sonetSectionConfigTraceExpected=sonetSectionConfigTraceExpected, fwDataStandbyVersion=fwDataStandbyVersion, vtpEntityTable=vtpEntityTable, ncuActivationTimeUtc=ncuActivationTimeUtc, swVersionInactiveOperatingSw=swVersionInactiveOperatingSw, neSwUpgradeRequest=neSwUpgradeRequest, controlPlaneEthContainsTable=controlPlaneEthContainsTable, OtnPayloadType=OtnPayloadType, swDbDataCapUpgradeRequest=swDbDataCapUpgradeRequest, controlPlaneOtnEntityAssignmentState=controlPlaneOtnEntityAssignmentState, fsp3000alm=fsp3000alm, oduTcmAConfigTraceTransmitOpsp=oduTcmAConfigTraceTransmitOpsp, provContainerTable=provContainerTable, SonetSectSigDegThresCaps=SonetSectSigDegThresCaps, neStorageDescr=neStorageDescr, controlPlaneWdmEntityClassInstanceNumber=controlPlaneWdmEntityClassInstanceNumber, neEventLogVarId=neEventLogVarId, CommandEqpt=CommandEqpt, neSoftwareUpgrade=neSoftwareUpgrade, fwDataForm=fwDataForm, swDbDataCapEntry=swDbDataCapEntry, sonetSectionConfigTraceForm=sonetSectionConfigTraceForm, updateBackupRestoreMib=updateBackupRestoreMib, eqpFwEqpServerBusy=eqpFwEqpServerBusy, neF7AutomaticBackupTable=neF7AutomaticBackupTable, controlPlaneWdmContainsIndex=controlPlaneWdmContainsIndex, vtpEntityAssignmentState=vtpEntityAssignmentState, neEventLogVarIndex=neEventLogVarIndex, neTrapsinkRowStatus=neTrapsinkRowStatus, neF7AutomaticBackupIndex=neF7AutomaticBackupIndex, snmpProxyServerSynchroState=snmpProxyServerSynchroState, swDbFileEntry=swDbFileEntry, swDbDataRestoreConfig=swDbDataRestoreConfig, snmpProxyEntrySingleTargetOutTable=snmpProxyEntrySingleTargetOutTable, swDbDataTable=swDbDataTable, oduTcmCConfigTraceTransmitOpsp=oduTcmCConfigTraceTransmitOpsp, otn=otn, neStorageCapacity=neStorageCapacity, snmpAgent=snmpAgent, neBackupRestore=neBackupRestore, RestoreActivation=RestoreActivation, sonetSectionConfigSignalDegradePeriod=sonetSectionConfigSignalDegradePeriod, neF7AutomaticRemoteBackupUsers=neF7AutomaticRemoteBackupUsers, fwDataActivationReadyOnStandby=fwDataActivationReadyOnStandby, eqpFwEqpType=eqpFwEqpType, aosCommon=aosCommon, neEventLogEntry=neEventLogEntry, neF7AutomaticBackupEntry=neF7AutomaticBackupEntry, FspR7EquipmentTypeCaps=FspR7EquipmentTypeCaps, FspR7TrapsinkLifetime=FspR7TrapsinkLifetime, VirtualContainerTypeCaps=VirtualContainerTypeCaps, controlPlaneOtnContainsTable=controlPlaneOtnContainsTable, SourceIpAddress=SourceIpAddress, YesNoNA=YesNoNA, oduTcmBConfigSignalDegradeThreshold=oduTcmBConfigSignalDegradeThreshold, entityAssignmentState=entityAssignmentState, provEquipmentState=provEquipmentState, FspR7FalseTrue=FspR7FalseTrue, vtpEntityType=vtpEntityType, clearRdiskRequest=clearRdiskRequest, snmpProxyEntrySingleTargetOutRowStatus=snmpProxyEntrySingleTargetOutRowStatus, neBackupRestoreRequest=neBackupRestoreRequest, oduSectionConfigTraceTransmitDapi=oduSectionConfigTraceTransmitDapi, neStorageEntry=neStorageEntry, inventoryUnitName=inventoryUnitName, fsp3000c=fsp3000c, neEventLogVarOidVal=neEventLogVarOidVal, FspTime=FspTime, oduTcmCDataTraceReceivedOpsp=oduTcmCDataTraceReceivedOpsp, oduTcmAConfigSignalDegradePeriod=oduTcmAConfigSignalDegradePeriod, SnmpProxySynchronizationState=SnmpProxySynchronizationState, neTrapsinkUserName=neTrapsinkUserName, AvailState=AvailState, neRestoreConfig=neRestoreConfig, swDbFileType=swDbFileType, entityIndex=entityIndex, controlPlaneOtnEntityTable=controlPlaneOtnEntityTable, AssignmentState=AssignmentState, SonetSectSigDegThres=SonetSectSigDegThres, otuSectionConfigTraceTransmitDapi=otuSectionConfigTraceTransmitDapi, oduTcmBConfigSignalDegradePeriod=oduTcmBConfigSignalDegradePeriod, controlPlaneEthEntityIndex=controlPlaneEthEntityIndex, neF7AutomaticBackupInterval=neF7AutomaticBackupInterval, entityContainedIn=entityContainedIn, controlPlaneEthEntityContainedIn=controlPlaneEthEntityContainedIn, neF7AutomaticRemoteBackupEncryption=neF7AutomaticRemoteBackupEncryption, EnableState=EnableState, controlPlaneEthContainsIndex=controlPlaneEthContainsIndex, encryptionFwpFile=encryptionFwpFile, oduTcmCConfigTable=oduTcmCConfigTable, oduTcmAConfigTraceTransmitSapi=oduTcmAConfigTraceTransmitSapi, snmpProxyEntrySingleTargetOutAddress=snmpProxyEntrySingleTargetOutAddress, neBackupUsers=neBackupUsers, oduTcmCConfigTimMode=oduTcmCConfigTimMode, TimMode=TimMode, neEventLogIndex=neEventLogIndex, entityTable=entityTable, otuSectionConfigSignalDegradeThreshold=otuSectionConfigSignalDegradeThreshold, neTrapsinkVersion=neTrapsinkVersion, KBytes=KBytes, controlPlaneOtnEntityClassInstanceNumber=controlPlaneOtnEntityClassInstanceNumber, fwDataStandbyFirmwareAvailable=fwDataStandbyFirmwareAvailable, swVersionEntry=swVersionEntry, neAutoBackup=neAutoBackup, inventoryFirmwarePackageRev=inventoryFirmwarePackageRev, swDbDataDefaultsEntry=swDbDataDefaultsEntry, neBackupEncryption=neBackupEncryption, inventorySoftwareRev=inventorySoftwareRev, controlPlaneWdmEntityEntry=controlPlaneWdmEntityEntry, FspR7AdminStateSnmpProxy=FspR7AdminStateSnmpProxy, neSwUpgradeServerPasswd=neSwUpgradeServerPasswd, neEventLogVarEntry=neEventLogVarEntry, FileArea=FileArea, oduTcmAConfigTraceExpected=oduTcmAConfigTraceExpected, updateEqpt=updateEqpt, dbAdmin=dbAdmin, controlPlaneEthContainsEntry=controlPlaneEthContainsEntry, ptpEntityReferencedTo=ptpEntityReferencedTo, common=common, OtnPayloadTypeCaps=OtnPayloadTypeCaps, snmpProxyEntrySingleTargetOutAdminState=snmpProxyEntrySingleTargetOutAdminState, oduTcmBConfigTraceTransmitSapi=oduTcmBConfigTraceTransmitSapi, SnmpProxySynchronizationStage=SnmpProxySynchronizationStage, controlPlaneWdmEntityIndexAid=controlPlaneWdmEntityIndexAid, OhTerminationLevel=OhTerminationLevel, coldRestartCapEntry=coldRestartCapEntry, PgmType=PgmType, swVersionNextBoot=swVersionNextBoot, ApsHoldoffTime=ApsHoldoffTime, oduTcmADataTable=oduTcmADataTable, otuSectionConfigSignalDegradePeriod=otuSectionConfigSignalDegradePeriod, ptpEntityTable=ptpEntityTable, controlPlaneEthEntityIndexAid=controlPlaneEthEntityIndexAid, neEventLogVarInteger32Val=neEventLogVarInteger32Val, fwDataBootStatus=fwDataBootStatus, entityIndexAid=entityIndexAid, PartitionStatus=PartitionStatus, vtpEntityEntry=vtpEntityEntry, VirtualContainerType=VirtualContainerType, controlPlaneOtnEntityIndex=controlPlaneOtnEntityIndex, snmpWriteAccessNmsAddress=snmpWriteAccessNmsAddress, ncuActivationDateUtc=ncuActivationDateUtc, swDbDataStandbyPartitionStatus=swDbDataStandbyPartitionStatus, controlPlaneEthEntityClass=controlPlaneEthEntityClass, controlPlaneWdmEntityContainedIn=controlPlaneWdmEntityContainedIn, swVersionActiveApplSw=swVersionActiveApplSw, products=products, neF7AutomaticRemoteBackupCommonIpSrv=neF7AutomaticRemoteBackupCommonIpSrv, swDbDataNumLegacyUpdate=swDbDataNumLegacyUpdate, ptpEntityIndexAid=ptpEntityIndexAid, entityClassInstanceNumber=entityClassInstanceNumber, transportStandards=transportStandards, oduSectionDataTraceReceivedSapi=oduSectionDataTraceReceivedSapi, swDbDataNumLegacyEqpt=swDbDataNumLegacyEqpt, vtpEntityReferencedTo=vtpEntityReferencedTo, CpWdmEntityClass=CpWdmEntityClass, neSwUpgradeState=neSwUpgradeState, oduTcmCConfigTraceExpected=oduTcmCConfigTraceExpected, inventoryHardwareRev=inventoryHardwareRev, inventoryUniversalSerialIdent=inventoryUniversalSerialIdent, swDbDataIndex=swDbDataIndex, TrapAlarmSeverity=TrapAlarmSeverity, LogicalIfTransportCaps=LogicalIfTransportCaps, vtpEntityClassInstanceNumber=vtpEntityClassInstanceNumber, SonetTimingSource=SonetTimingSource, swDbDataNumNsaNotReady=swDbDataNumNsaNotReady, controlPlaneEthEntityEntry=controlPlaneEthEntityEntry, oduTcmCDataTable=oduTcmCDataTable, otuSectionConfigStuffing=otuSectionConfigStuffing, ServiceImpairment=ServiceImpairment, swVersionActiveOperatingSw=swVersionActiveOperatingSw, neF7AutomaticRemoteBackupSrvDir=neF7AutomaticRemoteBackupSrvDir, fwDataReadyForActivation=fwDataReadyForActivation, oduTcmCDataTraceReceivedDapi=oduTcmCDataTraceReceivedDapi, neMemorySizeTotal=neMemorySizeTotal, otuSectionConfigTable=otuSectionConfigTable, swDbFileFileName=swDbFileFileName, FileTransferProtocol=FileTransferProtocol, eqpFwUpgradeRequest=eqpFwUpgradeRequest, sonetSectionConfigTraceTransmit=sonetSectionConfigTraceTransmit, sonet=sonet, swDbDataNcuSoftwareVersion=swDbDataNcuSoftwareVersion, inventoryMacAddress=inventoryMacAddress, otuSectionConfigEntry=otuSectionConfigEntry, entityEntry=entityEntry, otuConfig=otuConfig, oduSectionConfigSignalDegradeThres=oduSectionConfigSignalDegradeThres, inventoryGradeInventory=inventoryGradeInventory, neBackupRestoreState=neBackupRestoreState, snmpWriteAccessEntry=snmpWriteAccessEntry, swVersionInactiveApplSw=swVersionInactiveApplSw, TimModeCaps=TimModeCaps, ApsDirectionCaps=ApsDirectionCaps, neEventLogVarCounter64Val=neEventLogVarCounter64Val, neTrapsinkPort=neTrapsinkPort, snmpProxyServerAdminState=snmpProxyServerAdminState, neEventLogTimeStamp=neEventLogTimeStamp, SonetTraceForm=SonetTraceForm, DestinationNodeOrAgentState=DestinationNodeOrAgentState)
