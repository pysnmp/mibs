...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:33:00 2023
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, Integer32, ObjectIdentity, MibIdentifier, NotificationType, iso, Unsigned32, enterprises, Counter32, Gauge32, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "Integer32", "ObjectIdentity", "MibIdentifier", "NotificationType", "iso", "Unsigned32", "enterprises", "Counter32", "Gauge32", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", nicIndex=nicIndex, shareProjectName=shareProjectName, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiTargetName=iscsiTargetName, globalStatistics=globalStatistics, tegileConformance=tegileConformance, notifications=notifications, notificationTargetEntityName=notificationTargetEntityName, projectShareCount=projectShareCount, poolName=poolName, haControllerA_Name=haControllerA_Name, fcInitiators=fcInitiators, upgradeCompleted=upgradeCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcPortOnline=fcPortOnline, lunTable=lunTable, tdpsUpgradeFailed=tdpsUpgradeFailed, tdpsUpgradeTimeout=tdpsUpgradeTimeout, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareCIFSWriteLatency=shareCIFSWriteLatency, diskChassisIdx=diskChassisIdx, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiProperties=iscsiProperties, poolTotalSaving=poolTotalSaving, diskRandomIOCount=diskRandomIOCount, poolWriteCacheWriteIops=poolWriteCacheWriteIops, cacheSSDReads=cacheSSDReads, poolDegraded=poolDegraded, iscsiInitiatorGroup=iscsiInitiatorGroup, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunReadLatency=lunReadLatency, nicMTU=nicMTU, diskIOCount=diskIOCount, notificationObjects=notificationObjects, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolFreeSizeHigh=poolFreeSizeHigh, poolSizeLow=poolSizeLow, poolTotalReadMbps=poolTotalReadMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, shareEntry=shareEntry, lunWriteIops=lunWriteIops, fcTargetName=fcTargetName, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, volumeQuotaFinished=volumeQuotaFinished, fcTotalReadIops=fcTotalReadIops, iscsiInitiatorIndex=iscsiInitiatorIndex, nfsTotalReadMbps=nfsTotalReadMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolReadCacheWriteIops=poolReadCacheWriteIops, fcInitiatorName=fcInitiatorName, poolCount=poolCount, projectQuotaSizeHigh=projectQuotaSizeHigh, haResources=haResources, iscsiTargetGroupError=iscsiTargetGroupError, replicationStarted=replicationStarted, nfsTotalWriteIops=nfsTotalWriteIops, snapshotDeleteFailed=snapshotDeleteFailed, poolDataSizeLow=poolDataSizeLow, diskIndex=diskIndex, notificationSensorSuspect=notificationSensorSuspect, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, notificationProps=notificationProps, fcTargetIndex=fcTargetIndex, diskTable=diskTable, poolProjectCount=poolProjectCount, haResourceActiveNode=haResourceActiveNode, notificationSensorNumber=notificationSensorNumber, targetGroupCreateCompleted=targetGroupCreateCompleted, shareCompressedRatio=shareCompressedRatio, shareNFSEnabled=shareNFSEnabled, sensorFailureEvent=sensorFailureEvent, cpuInterrupts=cpuInterrupts, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiTargetEntry=iscsiTargetEntry, lunEntry=lunEntry, iscsiTargetWriteMbps=iscsiTargetWriteMbps, nfsTotalReadIops=nfsTotalReadIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, haResourceDescription=haResourceDescription, projectTotalSaving=projectTotalSaving, projectPoolName=projectPoolName, projectEntry=projectEntry, fcInitiatorsTable=fcInitiatorsTable, shareNFSReadIops=shareNFSReadIops, fcTotalWriteIops=fcTotalWriteIops, nvdimmFailInitializationError=nvdimmFailInitializationError, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, diskState=diskState, fcTargetEntry=fcTargetEntry, controllerUp=controllerUp, shareNFSReadMbps=shareNFSReadMbps, snmpServiceStopFailed=snmpServiceStopFailed, notificationSensorAction=notificationSensorAction, fcAvgWriteLatency=fcAvgWriteLatency, haResourceEntry=haResourceEntry, shareCIFSEnabled=shareCIFSEnabled, diskTotalReadMbps=diskTotalReadMbps, projectDeletionFailed=projectDeletionFailed, properties=properties, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, controllerTimeDrift=controllerTimeDrift, shareCompressionEnabled=shareCompressionEnabled, replicationComplete=replicationComplete, poolMetaWriteLatency=poolMetaWriteLatency, poolState=poolState, fcTargetWriteIops=fcTargetWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, diskDataReadIops=diskDataReadIops, snapshotCreationFailed=snapshotCreationFailed, currentObjectGroup=currentObjectGroup, testNotification=testNotification, cifsTotalWriteMbps=cifsTotalWriteMbps, poolCreated=poolCreated, shareNFSWriteIops=shareNFSWriteIops, controllerHardwareModel=controllerHardwareModel, poolDataReadMbps=poolDataReadMbps, netbiosSocketFailure=netbiosSocketFailure, nicEntry=nicEntry, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, disks=disks, lunDataSizeHigh=lunDataSizeHigh, shareCIFSReadLatency=shareCIFSReadLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, smisServiceStarted=smisServiceStarted, shareIndex=shareIndex, shareQuotaHigh=shareQuotaHigh, memoryFailure=memoryFailure, fcTargetGroup=fcTargetGroup, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareNFSReadLatency=shareNFSReadLatency, nicTable=nicTable, shareQuotaLow=shareQuotaLow, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, snapshotCloningFailed=snapshotCloningFailed, iscsiTargetReadLatency=iscsiTargetReadLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, nvdimmFailUnknownError=nvdimmFailUnknownError, poolTable=poolTable, diskAlias=diskAlias, poolAvgWriteLatency=poolAvgWriteLatency, nicName=nicName, haControllerB_Name=haControllerB_Name, fcTargetReadMbps=fcTargetReadMbps, poolDataReadLatency=poolDataReadLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, notificationComponentName=notificationComponentName, diskTotalReadIops=diskTotalReadIops, iscsiInitiators=iscsiInitiators, sharePoolName=sharePoolName, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcProperties=fcProperties, tegile=tegile, fcAvgReadLatency=fcAvgReadLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, poolQuotaFinished=poolQuotaFinished, cacheTotalWriteMbps=cacheTotalWriteMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareCIFSReadIops=shareCIFSReadIops, replicationPaused=replicationPaused, poolUsedSizeHigh=poolUsedSizeHigh, cifsTotalReadMbps=cifsTotalReadMbps, snmpServiceStarted=snmpServiceStarted, PYSNMP_MODULE_ID=tegile, ipmiFan=ipmiFan, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, diskTotalWriteMbps=diskTotalWriteMbps, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, cifsTotalReadIops=cifsTotalReadIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, shareTable=shareTable, fcTotalWriteMbps=fcTotalWriteMbps, lunDataSizeLow=lunDataSizeLow, diskPoolName=diskPoolName, fcTargetModifyCompleted=fcTargetModifyCompleted, shareCIFSWriteIops=shareCIFSWriteIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcTargetReadIops=fcTargetReadIops, volumeDeleteCompleted=volumeDeleteCompleted, replicationAbandoned=replicationAbandoned, diskAvgReadLatency=diskAvgReadLatency, iscsiTargetGroup=iscsiTargetGroup, networkTotalReceiveMbps=networkTotalReceiveMbps, ipmiVoltage=ipmiVoltage, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiWriteIops=iscsiWriteIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskIsOnline=diskIsOnline, iscsiTargets=iscsiTargets, poolDataReadIops=poolDataReadIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, nicState=nicState, tegileCompliances=tegileCompliances, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diskError=diskError, poolTotalWriteIops=poolTotalWriteIops, notificationTime=notificationTime, ipmiThreshold=ipmiThreshold, projectName=projectName, shareName=shareName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, ipmiCurrent=ipmiCurrent, pools=pools, projectIndex=projectIndex, diskTotalWriteIops=diskTotalWriteIops, shareCIFSReadMbps=shareCIFSReadMbps, upgradeStarted=upgradeStarted, projectFreeSizeHigh=projectFreeSizeHigh, iscsiTargetAuth=iscsiTargetAuth, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, haResourceName=haResourceName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, nvdimmFailSoftError=nvdimmFailSoftError, snmpAgentVersion=snmpAgentVersion, shareDeletionFailed=shareDeletionFailed, diskDataReadMbps=diskDataReadMbps, projectDedupEnabled=projectDedupEnabled, lunTargetGroup=lunTargetGroup, networkIpmpGroupDown=networkIpmpGroupDown, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcTargets=fcTargets, poolMetaReadIops=poolMetaReadIops, poolDeleted=poolDeleted, fcTargetReadLatency=fcTargetReadLatency, snapshotCloneCompleted=snapshotCloneCompleted, diskSizeHigh=diskSizeHigh, notificationDescription=notificationDescription, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunSizeLow=lunSizeLow, networkTotalTransmitMbps=networkTotalTransmitMbps, poolUpgraded=poolUpgraded, tegileArray_notifications=tegileArray_notifications, ipmiTemperature=ipmiTemperature, projectDataSizeLow=projectDataSizeLow, networkInterfaceUp=networkInterfaceUp, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, maintenanceModeDisabled=maintenanceModeDisabled, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolDataSizeHigh=poolDataSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectCreatedSuccessfully=projectCreatedSuccessfully, diskSequentialIOCount=diskSequentialIOCount, poolOwnerController=poolOwnerController, alertsCleanupCompleted=alertsCleanupCompleted, shareDataSizeLow=shareDataSizeLow, haControllerB_IPAddr=haControllerB_IPAddr, nfsAvgWriteLatency=nfsAvgWriteLatency, shareMountPoint=shareMountPoint, poolProjects=poolProjects)
mibBuilder.exportSymbols("TEGILE-MIB", haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcInitiatorEntry=fcInitiatorEntry, cifsAvgWriteLatency=cifsAvgWriteLatency, projectFreeSizeLow=projectFreeSizeLow, fcTargetsTable=fcTargetsTable, fcTargetWriteMbps=fcTargetWriteMbps, poolSizeHigh=poolSizeHigh, nicGroup=nicGroup, poolDeletionFailed=poolDeletionFailed, targetGroupMemberAdded=targetGroupMemberAdded, lunFreeSizeLow=lunFreeSizeLow, fcInitiatorGroup=fcInitiatorGroup, network=network, lunGUID=lunGUID, fcInitiatorIndex=fcInitiatorIndex, snapshotRollbackFailed=snapshotRollbackFailed, cpuSystemCalls=cpuSystemCalls, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, lunSizeHigh=lunSizeHigh, notificationReadingUnit=notificationReadingUnit, poolUsedSizeLow=poolUsedSizeLow, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunDedupEnabled=lunDedupEnabled, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, targetGroupMemberRemoved=targetGroupMemberRemoved, projectDeleted=projectDeleted, diskSlowIo=diskSlowIo, cacheRAMReads=cacheRAMReads, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTotalReadMbps=iscsiTotalReadMbps, upgradeTimeout=upgradeTimeout, lunIndex=lunIndex, projectCompressionEnabled=projectCompressionEnabled, unknownSensorEvent=unknownSensorEvent, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiInitiatorEntry=iscsiInitiatorEntry, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, userLoginFailed=userLoginFailed, smbSocketFailure=smbSocketFailure, notificationEventCode=notificationEventCode, deleteFolderCompleted=deleteFolderCompleted, cpuTotalUsage=cpuTotalUsage, shareExceedThresholdWarning=shareExceedThresholdWarning, lunProtocol=lunProtocol, iscsiInitiatorName=iscsiInitiatorName, tegileGroups=tegileGroups, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectTable=projectTable, networkIpmpGroupUp=networkIpmpGroupUp, cacheTotalWriteIops=cacheTotalWriteIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, diskDataWriteIops=diskDataWriteIops, projectLunCount=projectLunCount, haControllerA_Uptime=haControllerA_Uptime, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, snmpServiceStartFailed=snmpServiceStartFailed, sanProperties=sanProperties, poolMetaWriteMbps=poolMetaWriteMbps, poolDataWriteLatency=poolDataWriteLatency, lunReservedSizeLow=lunReservedSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, lunReservedSizeHigh=lunReservedSizeHigh, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectThresholdExceedWarning=projectThresholdExceedWarning, shareReservedSizeHigh=shareReservedSizeHigh, shareNFSWriteMbps=shareNFSWriteMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, notificationSeverity=notificationSeverity, spareDiskReplaced=spareDiskReplaced, aclMigrationStarted=aclMigrationStarted, ntpServerTimeDrift=ntpServerTimeDrift, nfsAvgReadLatency=nfsAvgReadLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, iscsiAvgReadLatency=iscsiAvgReadLatency, upgradeDownloadFailed=upgradeDownloadFailed, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, haResourcesTable=haResourcesTable, lunPoolName=lunPoolName, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunReadIops=lunReadIops, lunFreeSizeHigh=lunFreeSizeHigh, lunCompressionEnabled=lunCompressionEnabled, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTargetIndex=iscsiTargetIndex, lunWriteLatency=lunWriteLatency, lunName=lunName, projectModified=projectModified, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcPortOffline=fcPortOffline, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolEntry=poolEntry, snapshotRollbackCompleted=snapshotRollbackCompleted, haResourceStatus=haResourceStatus, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, lunProjectName=lunProjectName, iscsiTargetWriteLatency=iscsiTargetWriteLatency, replicationTargetDeleted=replicationTargetDeleted, tegileArray=tegileArray, smisServiceStartFailed=smisServiceStartFailed, volumeModifyCompleted=volumeModifyCompleted, haResourceGroup=haResourceGroup, snmpServiceStopped=snmpServiceStopped, aclMigrationCompleted=aclMigrationCompleted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, replicationSourceRegistered=replicationSourceRegistered, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, poolMetaWriteIops=poolMetaWriteIops, diskAvgWriteLatency=diskAvgWriteLatency, fcTargetStatus=fcTargetStatus, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolAvgReadLatency=poolAvgReadLatency, lunReadMbps=lunReadMbps, cacheTotalReadMbps=cacheTotalReadMbps, networkInterfaceDown=networkInterfaceDown, iscsiTargetWriteIops=iscsiTargetWriteIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiTargetReadIops=iscsiTargetReadIops, poolExported=poolExported, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunBlockSize=lunBlockSize, poolExpanded=poolExpanded, shareCreatedSuccessfully=shareCreatedSuccessfully, deleteFolderFailed=deleteFolderFailed, basicCompliance=basicCompliance, lunInitiatorGroup=lunInitiatorGroup, cifsAvgReadLatency=cifsAvgReadLatency, cacheTotalReadIops=cacheTotalReadIops, replicationAborted=replicationAborted, iscsiTargetError=iscsiTargetError, diskSizeLow=diskSizeLow, smisServiceStopFailed=smisServiceStopFailed, shareQuotaFinished=shareQuotaFinished, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, ipmiMemory=ipmiMemory, shareReservedSizeLow=shareReservedSizeLow, lunCompressedRatio=lunCompressedRatio, vmwareNFSDatastores=vmwareNFSDatastores, shareDeleted=shareDeleted, haResourceIndex=haResourceIndex, poolMetaReadMbps=poolMetaReadMbps, poolTotalWriteMbps=poolTotalWriteMbps, ipmiPowerSupply=ipmiPowerSupply, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diagnosticDataUploaded=diagnosticDataUploaded, poolHealth=poolHealth, adServerTimeDrift=adServerTimeDrift, smisServiceStopped=smisServiceStopped, nicReceiveMbps=nicReceiveMbps, projectLUNs=projectLUNs, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskEntry=diskEntry, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcTotalReadMbps=fcTotalReadMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunWriteMbps=lunWriteMbps, poolIndex=poolIndex, projectDataSizeHigh=projectDataSizeHigh, replicationFailed=replicationFailed, upgradeFailed=upgradeFailed, fcTargetWriteLatency=fcTargetWriteLatency, haControllerA_IPAddr=haControllerA_IPAddr, diskGoneOffline=diskGoneOffline, poolTotalReadIops=poolTotalReadIops, diskType=diskType, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, nicTransmitMbps=nicTransmitMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, replicationResumed=replicationResumed, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiTargetsTable=iscsiTargetsTable, maintenanceModeEnabled=maintenanceModeEnabled, poolDataWriteIops=poolDataWriteIops, projectQuotaFinished=projectQuotaFinished, iscsiTargetAlias=iscsiTargetAlias, ipmiOther=ipmiOther, diskDataWriteMbps=diskDataWriteMbps, iscsiTotalReadIops=iscsiTotalReadIops, poolFreeSizeLow=poolFreeSizeLow, projectQuotaSizeLow=projectQuotaSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, poolMetaReadLatency=poolMetaReadLatency, targetGroupDeleteCompleted=targetGroupDeleteCompleted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, haControllerB_Uptime=haControllerB_Uptime, controllerDown=controllerDown, poolDataWriteMbps=poolDataWriteMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectShares=projectShares, upgradeDownloadStarted=upgradeDownloadStarted, diskCount=diskCount, cifsTotalWriteIops=cifsTotalWriteIops, currentNotificationGroup=currentNotificationGroup, shareDedupEnabled=shareDedupEnabled, poolImported=poolImported, iscsiTargetReadMbps=iscsiTargetReadMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, volumeDeleteFailed=volumeDeleteFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareDataSizeHigh=shareDataSizeHigh, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted)
