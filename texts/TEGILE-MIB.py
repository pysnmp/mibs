...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:31:14 2022
...
NotificationType, ModuleIdentity, TimeTicks, Integer32, Bits, ObjectIdentity, Gauge32, Counter64, Unsigned32, Counter32, enterprises, IpAddress, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "TimeTicks", "Integer32", "Bits", "ObjectIdentity", "Gauge32", "Counter64", "Unsigned32", "Counter32", "enterprises", "IpAddress", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiTotalWriteMbps=iscsiTotalWriteMbps, tegileArray_notifications=tegileArray_notifications, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, lunEntry=lunEntry, haResourcesTable=haResourcesTable, notificationSeverity=notificationSeverity, lunWriteIops=lunWriteIops, notificationProps=notificationProps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, targetGroupCreateCompleted=targetGroupCreateCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolCount=poolCount, diskSequentialIOCount=diskSequentialIOCount, nfsTotalWriteMbps=nfsTotalWriteMbps, networkIpmpGroupDown=networkIpmpGroupDown, poolDataWriteMbps=poolDataWriteMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, lunProtocol=lunProtocol, diskIOCount=diskIOCount, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, networkIpmpGroupUp=networkIpmpGroupUp, unknownSensorEvent=unknownSensorEvent, nfsTotalReadIops=nfsTotalReadIops, poolDataReadMbps=poolDataReadMbps, shareQuotaHigh=shareQuotaHigh, iscsiInitiatorsTable=iscsiInitiatorsTable, poolQuotaFinished=poolQuotaFinished, volumeCreatedSuccessfully=volumeCreatedSuccessfully, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskDataReadMbps=diskDataReadMbps, shareDataSizeHigh=shareDataSizeHigh, poolOwnerController=poolOwnerController, shareCreatedSuccessfully=shareCreatedSuccessfully, projectQuotaFinished=projectQuotaFinished, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolAvgReadLatency=poolAvgReadLatency, shareMountPoint=shareMountPoint, ipmiFan=ipmiFan, diskState=diskState, projectQuotaSizeHigh=projectQuotaSizeHigh, snmpServiceStopped=snmpServiceStopped, poolIndex=poolIndex, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolState=poolState, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, haResourceActiveNode=haResourceActiveNode, controllerHardwareModel=controllerHardwareModel, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, lunBlockSize=lunBlockSize, shareDedupEnabled=shareDedupEnabled, cifsTotalReadMbps=cifsTotalReadMbps, poolTotalSaving=poolTotalSaving, nicTransmitMbps=nicTransmitMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, deleteFolderCompleted=deleteFolderCompleted, diskPoolName=diskPoolName, network=network, fcTargetReadMbps=fcTargetReadMbps, poolUpgraded=poolUpgraded, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diagnosticDataUploaded=diagnosticDataUploaded, notificationTime=notificationTime, poolMetaReadLatency=poolMetaReadLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, maintenanceModeDisabled=maintenanceModeDisabled, snapshotCloningFailed=snapshotCloningFailed, haControllerA_Uptime=haControllerA_Uptime, ntpServerTimeDrift=ntpServerTimeDrift, poolTable=poolTable, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolDegraded=poolDegraded, snmpAgentVersion=snmpAgentVersion, shareNFSReadIops=shareNFSReadIops, iscsiTargetGroup=iscsiTargetGroup, fcInitiatorIndex=fcInitiatorIndex, iscsiTargetReadIops=iscsiTargetReadIops, upgradeFailed=upgradeFailed, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunFreeSizeHigh=lunFreeSizeHigh, shareNFSReadMbps=shareNFSReadMbps, fcPortOnline=fcPortOnline, shareIndex=shareIndex, controllerTimeDrift=controllerTimeDrift, haControllerA_Name=haControllerA_Name, shareNFSWriteMbps=shareNFSWriteMbps, testNotification=testNotification, fcTargetEntry=fcTargetEntry, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, notificationSensorAction=notificationSensorAction, diskDataWriteIops=diskDataWriteIops, currentNotificationGroup=currentNotificationGroup, fcTargets=fcTargets, userLoginFailed=userLoginFailed, currentObjectGroup=currentObjectGroup, nfsAvgWriteLatency=nfsAvgWriteLatency, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolAvgWriteLatency=poolAvgWriteLatency, poolDataWriteIops=poolDataWriteIops, diskTotalWriteIops=diskTotalWriteIops, shareName=shareName, fcTargetName=fcTargetName, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolUsedSizeLow=poolUsedSizeLow, lunName=lunName, notificationEventCode=notificationEventCode, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareCompressionEnabled=shareCompressionEnabled, poolMetaReadMbps=poolMetaReadMbps, ipmiCurrent=ipmiCurrent, shareNFSWriteIops=shareNFSWriteIops, smbSocketFailure=smbSocketFailure, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectDedupEnabled=projectDedupEnabled, smisServiceStarted=smisServiceStarted, volumeQuotaFinished=volumeQuotaFinished, properties=properties, diskAlias=diskAlias, poolMetaWriteLatency=poolMetaWriteLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareCIFSWriteIops=shareCIFSWriteIops, upgradeTimeout=upgradeTimeout, nfsTotalReadMbps=nfsTotalReadMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, replicationComplete=replicationComplete, fcInitiatorEntry=fcInitiatorEntry, targetGroupDeleteCompleted=targetGroupDeleteCompleted, replicationFailed=replicationFailed, projectShareCount=projectShareCount, replicationAborted=replicationAborted, netbiosSocketFailure=netbiosSocketFailure, haResourceDescription=haResourceDescription, cacheSSDReads=cacheSSDReads, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcPortOffline=fcPortOffline, snmpServiceStarted=snmpServiceStarted, diskIsOnline=diskIsOnline, iscsiTargetWriteIops=iscsiTargetWriteIops, poolDataReadIops=poolDataReadIops, haControllerB_Uptime=haControllerB_Uptime, projectCreatedSuccessfully=projectCreatedSuccessfully, volumeModifyCompleted=volumeModifyCompleted, fcTargetStatus=fcTargetStatus, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, tegileCompliances=tegileCompliances, shareReservedSizeLow=shareReservedSizeLow, projectCompressionEnabled=projectCompressionEnabled, notificationReadingUnit=notificationReadingUnit, volumeDeleteFailed=volumeDeleteFailed, notifications=notifications, basicCompliance=basicCompliance, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, diskType=diskType, poolDataSizeHigh=poolDataSizeHigh, notificationTargetEntityName=notificationTargetEntityName, upgradeCompleted=upgradeCompleted, snmpServiceStopFailed=snmpServiceStopFailed, webdocsUpgradeFailed=webdocsUpgradeFailed, lunWriteLatency=lunWriteLatency, lunReadIops=lunReadIops, shareCIFSWriteLatency=shareCIFSWriteLatency, lunReservedSizeLow=lunReservedSizeLow, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, haResourceName=haResourceName, diskError=diskError, haControllerB_Name=haControllerB_Name, shareProjectName=shareProjectName, nvdimmFailUnknownError=nvdimmFailUnknownError, poolTotalReadMbps=poolTotalReadMbps, smisServiceStopFailed=smisServiceStopFailed, replicationStarted=replicationStarted, poolMetaWriteMbps=poolMetaWriteMbps, volumeDeleteCompleted=volumeDeleteCompleted, iscsiInitiatorGroup=iscsiInitiatorGroup, lunReadMbps=lunReadMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcProperties=fcProperties, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, projectDataSizeLow=projectDataSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, projectName=projectName, lunFreeSizeLow=lunFreeSizeLow, fcTotalReadMbps=fcTotalReadMbps, cifsTotalWriteIops=cifsTotalWriteIops, projectTable=projectTable, projectFreeSizeLow=projectFreeSizeLow, nicGroup=nicGroup, cpuTotalUsage=cpuTotalUsage, iscsiTargets=iscsiTargets, poolImported=poolImported, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, cifsAvgWriteLatency=cifsAvgWriteLatency, tegileConformance=tegileConformance, fcTargetReadLatency=fcTargetReadLatency, alertsCleanupCompleted=alertsCleanupCompleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiProperties=iscsiProperties, iscsiTargetGroupError=iscsiTargetGroupError, fcInitiatorGroup=fcInitiatorGroup, projectDeleted=projectDeleted, poolSizeHigh=poolSizeHigh, lunCompressionEnabled=lunCompressionEnabled, lunCompressedRatio=lunCompressedRatio, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskIndex=diskIndex, nvdimmFailInitializationError=nvdimmFailInitializationError, poolDataSizeLow=poolDataSizeLow, disks=disks, haResources=haResources, poolExported=poolExported, projectPoolName=projectPoolName, projectFreeSizeHigh=projectFreeSizeHigh, nicState=nicState, cacheTotalWriteMbps=cacheTotalWriteMbps, lunSizeHigh=lunSizeHigh, upgradeDownloadStarted=upgradeDownloadStarted, projectShares=projectShares, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, replicationPaused=replicationPaused, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, cpuInterrupts=cpuInterrupts, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, snapshotCloneCompleted=snapshotCloneCompleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolMetaReadIops=poolMetaReadIops, nicMTU=nicMTU, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nicTable=nicTable, iscsiWriteIops=iscsiWriteIops, snapshotDeleteFailed=snapshotDeleteFailed, fcTargetIndex=fcTargetIndex, shareCIFSEnabled=shareCIFSEnabled, shareEntry=shareEntry, iscsiTargetEntry=iscsiTargetEntry, sharePoolName=sharePoolName, nicName=nicName, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolHealth=poolHealth)
mibBuilder.exportSymbols("TEGILE-MIB", vmwareNFSDatastores=vmwareNFSDatastores, cpuSystemCalls=cpuSystemCalls, lunReservedSizeHigh=lunReservedSizeHigh, cacheTotalReadIops=cacheTotalReadIops, fcTargetReadIops=fcTargetReadIops, poolExpanded=poolExpanded, fcTargetWriteLatency=fcTargetWriteLatency, poolSizeLow=poolSizeLow, cacheRAMReads=cacheRAMReads, diskEntry=diskEntry, projectLUNs=projectLUNs, iscsiTargetReadMbps=iscsiTargetReadMbps, upgradeDownloadFailed=upgradeDownloadFailed, networkTotalTransmitMbps=networkTotalTransmitMbps, cifsTotalReadIops=cifsTotalReadIops, nvdimmFailSoftError=nvdimmFailSoftError, diskDataWriteMbps=diskDataWriteMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, shareNFSEnabled=shareNFSEnabled, replicationSourceRegistered=replicationSourceRegistered, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, iscsiTargetError=iscsiTargetError, fcTargetWriteMbps=fcTargetWriteMbps, shareReservedSizeHigh=shareReservedSizeHigh, tegileArray=tegileArray, fcAvgWriteLatency=fcAvgWriteLatency, sanProperties=sanProperties, fcTargetsTable=fcTargetsTable, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, targetGroupMemberRemoved=targetGroupMemberRemoved, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolDataReadLatency=poolDataReadLatency, smisServiceStartFailed=smisServiceStartFailed, snmpServiceStartFailed=snmpServiceStartFailed, shareTable=shareTable, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareDataSizeLow=shareDataSizeLow, fcAvgReadLatency=fcAvgReadLatency, tegileGroups=tegileGroups, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiInitiators=iscsiInitiators, shareQuotaLow=shareQuotaLow, lunTargetGroup=lunTargetGroup, cacheTotalWriteIops=cacheTotalWriteIops, cacheTotalReadMbps=cacheTotalReadMbps, lunGUID=lunGUID, controllerUp=controllerUp, diskSizeHigh=diskSizeHigh, fcTargetGroup=fcTargetGroup, diskCount=diskCount, maintenanceModeEnabled=maintenanceModeEnabled, diskTotalReadIops=diskTotalReadIops, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, nicEntry=nicEntry, upgradeStarted=upgradeStarted, haControllerA_IPAddr=haControllerA_IPAddr, diskAvgWriteLatency=diskAvgWriteLatency, ipmiMemory=ipmiMemory, replicationResumed=replicationResumed, ipmiOther=ipmiOther, diskDataReadIops=diskDataReadIops, networkInterfaceDown=networkInterfaceDown, shareNFSReadLatency=shareNFSReadLatency, shareCIFSReadMbps=shareCIFSReadMbps, spareDiskReplaced=spareDiskReplaced, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, haResourceEntry=haResourceEntry, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, fcTotalWriteMbps=fcTotalWriteMbps, notificationSensorNumber=notificationSensorNumber, diskChassisIdx=diskChassisIdx, poolProjects=poolProjects, tdpsUpgradeTimeout=tdpsUpgradeTimeout, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolTotalWriteMbps=poolTotalWriteMbps, sensorFailureEvent=sensorFailureEvent, shareSnapshotSizeLow=shareSnapshotSizeLow, fcTargetWriteIops=fcTargetWriteIops, ipmiPowerSupply=ipmiPowerSupply, fcInitiators=fcInitiators, networkInterfaceUp=networkInterfaceUp, fcInitiatorsTable=fcInitiatorsTable, nicIndex=nicIndex, lunPoolName=lunPoolName, projectTotalSaving=projectTotalSaving, initiatorGroupMemberAdded=initiatorGroupMemberAdded, targetGroupMemberAdded=targetGroupMemberAdded, smisServiceStopped=smisServiceStopped, iscsiTargetName=iscsiTargetName, fcInitiatorName=fcInitiatorName, snapshotCreationFailed=snapshotCreationFailed, poolReadCacheReadIops=poolReadCacheReadIops, iscsiTargetAlias=iscsiTargetAlias, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiInitiatorChapUser=iscsiInitiatorChapUser, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunProjectName=lunProjectName, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, projectIndex=projectIndex, poolEntry=poolEntry, iscsiInitiatorEntry=iscsiInitiatorEntry, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcTotalWriteIops=fcTotalWriteIops, lunIndex=lunIndex, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, projectThresholdExceedWarning=projectThresholdExceedWarning, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectSnapshotSizeLow=projectSnapshotSizeLow, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskTotalWriteMbps=diskTotalWriteMbps, haResourceIndex=haResourceIndex, shareQuotaFinished=shareQuotaFinished, ipmiThreshold=ipmiThreshold, notificationObjects=notificationObjects, PYSNMP_MODULE_ID=tegile, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolFreeSizeLow=poolFreeSizeLow, fcTotalReadIops=fcTotalReadIops, shareCIFSWriteMbps=shareCIFSWriteMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectSnapshotSizeHigh=projectSnapshotSizeHigh, cifsTotalWriteMbps=cifsTotalWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, haResourceGroup=haResourceGroup, poolName=poolName, poolDeletionFailed=poolDeletionFailed, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, snapshotRollbackFailed=snapshotRollbackFailed, projectDataSizeHigh=projectDataSizeHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiTotalReadIops=iscsiTotalReadIops, nvdimmFailDeviceError=nvdimmFailDeviceError, lunWriteMbps=lunWriteMbps, cifsAvgReadLatency=cifsAvgReadLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectDeletionFailed=projectDeletionFailed, poolTotalWriteIops=poolTotalWriteIops, globalStatistics=globalStatistics, networkTotalReceiveMbps=networkTotalReceiveMbps, lunDataSizeLow=lunDataSizeLow, replicationTargetDeleted=replicationTargetDeleted, replicationAbandoned=replicationAbandoned, iscsiTargetIndex=iscsiTargetIndex, poolCreated=poolCreated, notificationSensorSuspect=notificationSensorSuspect, poolDeleted=poolDeleted, poolTotalReadIops=poolTotalReadIops, fcTargetModifyCompleted=fcTargetModifyCompleted, deleteFolderFailed=deleteFolderFailed, shareCompressedRatio=shareCompressedRatio, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, lunDataSizeHigh=lunDataSizeHigh, aclMigrationStarted=aclMigrationStarted, iscsiTargetsTable=iscsiTargetsTable, poolFreeSizeHigh=poolFreeSizeHigh, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiInitiatorName=iscsiInitiatorName, diskSizeLow=diskSizeLow, projectLunCount=projectLunCount, shareCIFSReadIops=shareCIFSReadIops, iscsiTargetAuth=iscsiTargetAuth, diskAvgReadLatency=diskAvgReadLatency, ipmiVoltage=ipmiVoltage, memoryFailure=memoryFailure, ipmiTemperature=ipmiTemperature, lunDedupEnabled=lunDedupEnabled, poolProjectCount=poolProjectCount, nicReceiveMbps=nicReceiveMbps, notificationComponentName=notificationComponentName, projectModified=projectModified, pools=pools, shareExceedThresholdWarning=shareExceedThresholdWarning, poolUsedSizeHigh=poolUsedSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, adServerTimeDrift=adServerTimeDrift, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, tegile=tegile, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, diskGoneOffline=diskGoneOffline, diskTotalReadMbps=diskTotalReadMbps, lunTable=lunTable, shareDeletionFailed=shareDeletionFailed, shareDeleted=shareDeleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectEntry=projectEntry, notificationDescription=notificationDescription, lunSizeLow=lunSizeLow, tdpsUpgradeCompleted=tdpsUpgradeCompleted, nfsTotalWriteIops=nfsTotalWriteIops, projectQuotaSizeLow=projectQuotaSizeLow, lunReadLatency=lunReadLatency, lunInitiatorGroup=lunInitiatorGroup, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolDataWriteLatency=poolDataWriteLatency, haControllerB_IPAddr=haControllerB_IPAddr, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, diskRandomIOCount=diskRandomIOCount, aclMigrationCompleted=aclMigrationCompleted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, haResourceStatus=haResourceStatus, diskTable=diskTable, diskSlowIo=diskSlowIo, poolMetaWriteIops=poolMetaWriteIops, controllerDown=controllerDown)
