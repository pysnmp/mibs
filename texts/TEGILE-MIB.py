...
Gauge32, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Unsigned32, NotificationType, TimeTicks, Counter64, iso, enterprises, IpAddress, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Unsigned32", "NotificationType", "TimeTicks", "Counter64", "iso", "enterprises", "IpAddress", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", snmpAgentVersion=snmpAgentVersion, ipmiVoltage=ipmiVoltage, projectFreeSizeHigh=projectFreeSizeHigh, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiTotalReadMbps=iscsiTotalReadMbps, vmwareNFSDatastores=vmwareNFSDatastores, lunInitiatorGroup=lunInitiatorGroup, iscsiTotalReadIops=iscsiTotalReadIops, fcAvgReadLatency=fcAvgReadLatency, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolUpgraded=poolUpgraded, projectModified=projectModified, shareCIFSReadLatency=shareCIFSReadLatency, poolDataWriteIops=poolDataWriteIops, projectPoolName=projectPoolName, haControllerB_Uptime=haControllerB_Uptime, iscsiTargetReadMbps=iscsiTargetReadMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, shareTable=shareTable, basicCompliance=basicCompliance, upgradeDownloadCompleted=upgradeDownloadCompleted, replicationStarted=replicationStarted, poolAvgWriteLatency=poolAvgWriteLatency, diskEntry=diskEntry, snmpServiceStartFailed=snmpServiceStartFailed, fcTargets=fcTargets, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, maintenanceModeDisabled=maintenanceModeDisabled, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolSizeLow=poolSizeLow, globalStatistics=globalStatistics, nfsTotalWriteIops=nfsTotalWriteIops, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargetGroup=iscsiTargetGroup, tegileGroups=tegileGroups, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, haResourcesTable=haResourcesTable, iscsiTargetError=iscsiTargetError, cifsTotalWriteMbps=cifsTotalWriteMbps, notificationComponentName=notificationComponentName, shareDataSizeHigh=shareDataSizeHigh, networkIpmpGroupDown=networkIpmpGroupDown, nfsTotalReadIops=nfsTotalReadIops, haControllerA_IPAddr=haControllerA_IPAddr, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, tdpsUpgradeTimeout=tdpsUpgradeTimeout, fcInitiators=fcInitiators, fcTargetModifyCompleted=fcTargetModifyCompleted, poolReadCacheReadLatency=poolReadCacheReadLatency, upgradeStarted=upgradeStarted, networkInterfaceDown=networkInterfaceDown, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, cacheSSDReads=cacheSSDReads, projectDataSizeLow=projectDataSizeLow, poolReadCacheWriteIops=poolReadCacheWriteIops, volumeModifyCompleted=volumeModifyCompleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, haResourceIndex=haResourceIndex, shareQuotaHigh=shareQuotaHigh, lunCompressionEnabled=lunCompressionEnabled, diskAlias=diskAlias, projectTotalSaving=projectTotalSaving, iscsiTargetReadLatency=iscsiTargetReadLatency, shareDeleted=shareDeleted, lunWriteIops=lunWriteIops, replicationFailed=replicationFailed, projectShareCount=projectShareCount, shareEntry=shareEntry, cifsTotalReadIops=cifsTotalReadIops, diskSizeLow=diskSizeLow, fcTargetGroup=fcTargetGroup, lunCompressedRatio=lunCompressedRatio, lunTable=lunTable, poolDegraded=poolDegraded, replicationSourceRegistered=replicationSourceRegistered, poolDataReadLatency=poolDataReadLatency, targetGroupMemberAdded=targetGroupMemberAdded, ipmiCriticalInterrupt=ipmiCriticalInterrupt, intelliFlashSoftwareDown=intelliFlashSoftwareDown, ntpServerTimeDrift=ntpServerTimeDrift, haResourceStatus=haResourceStatus, cpuInterrupts=cpuInterrupts, shareNFSWriteIops=shareNFSWriteIops, shareNFSEnabled=shareNFSEnabled, poolSizeHigh=poolSizeHigh, poolTotalWriteMbps=poolTotalWriteMbps, notificationSensorSuspect=notificationSensorSuspect, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, fcTargetReadMbps=fcTargetReadMbps, notificationSeverity=notificationSeverity, iscsiInitiatorIndex=iscsiInitiatorIndex, ipmiFan=ipmiFan, shareReservedSizeHigh=shareReservedSizeHigh, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiTargetName=iscsiTargetName, adServerTimeDrift=adServerTimeDrift, iscsiInitiatorChapUser=iscsiInitiatorChapUser, cpuSystemCalls=cpuSystemCalls, shareNFSWriteMbps=shareNFSWriteMbps, testNotification=testNotification, iscsiTargets=iscsiTargets, nfsTotalWriteMbps=nfsTotalWriteMbps, shareMountPoint=shareMountPoint, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskRandomIOCount=diskRandomIOCount, lunReadLatency=lunReadLatency, nicName=nicName, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, snapshotCloneCompleted=snapshotCloneCompleted, snapshotRollbackFailed=snapshotRollbackFailed, diskIOCount=diskIOCount, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, aclMigrationStarted=aclMigrationStarted, projectCompressionEnabled=projectCompressionEnabled, poolMetaReadMbps=poolMetaReadMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, notificationReadingTriggerValue=notificationReadingTriggerValue, diskTotalWriteIops=diskTotalWriteIops, nicEntry=nicEntry, diskDataReadIops=diskDataReadIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, upgradeFailed=upgradeFailed, haResourceDescription=haResourceDescription, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunSizeHigh=lunSizeHigh, diskTable=diskTable, poolExported=poolExported, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, cacheTotalReadIops=cacheTotalReadIops, haResourceEntry=haResourceEntry, poolMetaReadLatency=poolMetaReadLatency, notifications=notifications, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiTargetReadIops=iscsiTargetReadIops, poolMetaWriteLatency=poolMetaWriteLatency, fcTargetWriteIops=fcTargetWriteIops, poolMetaWriteMbps=poolMetaWriteMbps, smisServiceStartFailed=smisServiceStartFailed, tegileCompliances=tegileCompliances, fcAvgWriteLatency=fcAvgWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, fcTargetIndex=fcTargetIndex, snmpServiceStarted=snmpServiceStarted, projectDataSizeHigh=projectDataSizeHigh, tdpsUpgradeFailed=tdpsUpgradeFailed, controllerHardwareModel=controllerHardwareModel, poolName=poolName, tegileConformance=tegileConformance, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolTotalReadMbps=poolTotalReadMbps, poolDeletionFailed=poolDeletionFailed, replicationPaused=replicationPaused, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, haResources=haResources, lunFreeSizeHigh=lunFreeSizeHigh, haControllerB_IPAddr=haControllerB_IPAddr, shareDataSizeLow=shareDataSizeLow, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, tegileArray_notifications=tegileArray_notifications, shareCIFSWriteMbps=shareCIFSWriteMbps, notificationObjects=notificationObjects, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskAvgReadLatency=diskAvgReadLatency, poolTotalSaving=poolTotalSaving, projectFreeSizeLow=projectFreeSizeLow, poolFreeSizeLow=poolFreeSizeLow, notificationReadingUnit=notificationReadingUnit, snapshotDeleteFailed=snapshotDeleteFailed, poolDataWriteMbps=poolDataWriteMbps, poolMetaWriteIops=poolMetaWriteIops, sensorFailureEvent=sensorFailureEvent, iscsiTargetAuth=iscsiTargetAuth, lunReservedSizeLow=lunReservedSizeLow, poolDataReadIops=poolDataReadIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, diagnosticDataUploaded=diagnosticDataUploaded, nvdimmFailInitializationError=nvdimmFailInitializationError, targetGroupMemberRemoved=targetGroupMemberRemoved, nfsTotalReadMbps=nfsTotalReadMbps, upgradeTimeout=upgradeTimeout, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolDeleted=poolDeleted, haResourceActiveNode=haResourceActiveNode, fcTargetsTable=fcTargetsTable, poolReadCacheWriteMbps=poolReadCacheWriteMbps, diskDataReadMbps=diskDataReadMbps, lunWriteMbps=lunWriteMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, snapshotCloningFailed=snapshotCloningFailed, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, poolHealth=poolHealth, projectCreatedSuccessfully=projectCreatedSuccessfully, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunTargetGroup=lunTargetGroup, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareSnapshotSizeLow=shareSnapshotSizeLow, fcInitiatorName=fcInitiatorName, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTotalReadIops=fcTotalReadIops, lunSizeLow=lunSizeLow, notificationSensorAction=notificationSensorAction, currentNotificationGroup=currentNotificationGroup, iscsiInitiatorEntry=iscsiInitiatorEntry, fcTargetWriteLatency=fcTargetWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, volumeDeleteFailed=volumeDeleteFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcPortOffline=fcPortOffline, replicationComplete=replicationComplete, poolOwnerController=poolOwnerController, lunDataSizeHigh=lunDataSizeHigh, projectLunCount=projectLunCount, poolImported=poolImported, sanProperties=sanProperties, haControllerA_Name=haControllerA_Name, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, haControllerB_Name=haControllerB_Name, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, nicTransmitMbps=nicTransmitMbps, nfsAvgReadLatency=nfsAvgReadLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiTargetWriteLatency=iscsiTargetWriteLatency, diskChassisIdx=diskChassisIdx, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunBlockSize=lunBlockSize, replicationResumed=replicationResumed, maintenanceModeEnabled=maintenanceModeEnabled, networkIpmpGroupUp=networkIpmpGroupUp, notificationSensorNumber=notificationSensorNumber, cifsAvgReadLatency=cifsAvgReadLatency, diskCount=diskCount, projectThresholdExceedWarning=projectThresholdExceedWarning, poolAvgReadLatency=poolAvgReadLatency, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, tdpsUpgradeCompleted=tdpsUpgradeCompleted, diskIndex=diskIndex, poolTable=poolTable, controllerDown=controllerDown, cifsTotalWriteIops=cifsTotalWriteIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectIndex=projectIndex, poolEntry=poolEntry)
mibBuilder.exportSymbols("TEGILE-MIB", pools=pools, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcProperties=fcProperties, ipmiPowerSupply=ipmiPowerSupply, shareIndex=shareIndex, smbSocketFailure=smbSocketFailure, targetGroupDeleteCompleted=targetGroupDeleteCompleted, fcTotalWriteIops=fcTotalWriteIops, upgradeCompleted=upgradeCompleted, projectQuotaSizeLow=projectQuotaSizeLow, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, unknownSensorEvent=unknownSensorEvent, shareCreatedSuccessfully=shareCreatedSuccessfully, projectShares=projectShares, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolMetaReadIops=poolMetaReadIops, tegile=tegile, smisServiceStarted=smisServiceStarted, lunProtocol=lunProtocol, nvdimmFailUnknownError=nvdimmFailUnknownError, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunReservedSizeHigh=lunReservedSizeHigh, projectQuotaFinished=projectQuotaFinished, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolProjectCount=poolProjectCount, cpuTotalUsage=cpuTotalUsage, lunDataSizeLow=lunDataSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, snmpServiceStopFailed=snmpServiceStopFailed, poolFreeSizeHigh=poolFreeSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, ipmiOther=ipmiOther, poolReadCacheReadIops=poolReadCacheReadIops, shareCIFSEnabled=shareCIFSEnabled, poolCount=poolCount, shareSnapshotSizeHigh=shareSnapshotSizeHigh, ipmiThreshold=ipmiThreshold, nicMTU=nicMTU, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nvdimmFailDeviceError=nvdimmFailDeviceError, poolDataWriteLatency=poolDataWriteLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, network=network, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareCIFSReadMbps=shareCIFSReadMbps, diskSlowIo=diskSlowIo, poolUsedSizeLow=poolUsedSizeLow, upgradeDownloadFailed=upgradeDownloadFailed, ipmiMemory=ipmiMemory, replicationAborted=replicationAborted, projectDeleted=projectDeleted, shareCIFSWriteIops=shareCIFSWriteIops, poolDataReadMbps=poolDataReadMbps, lunIndex=lunIndex, snapshotRollbackCompleted=snapshotRollbackCompleted, diskType=diskType, iscsiTargetsTable=iscsiTargetsTable, alertsCleanupCompleted=alertsCleanupCompleted, lunGUID=lunGUID, projectDedupEnabled=projectDedupEnabled, controllerTimeDrift=controllerTimeDrift, fcInitiatorEntry=fcInitiatorEntry, replicationAbandoned=replicationAbandoned, nicGroup=nicGroup, shareQuotaLow=shareQuotaLow, replicationTargetDeleted=replicationTargetDeleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcTargetReadLatency=fcTargetReadLatency, iscsiWriteIops=iscsiWriteIops, iscsiProperties=iscsiProperties, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunReadIops=lunReadIops, cifsTotalReadMbps=cifsTotalReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, projectName=projectName, diskIsOnline=diskIsOnline, shareCompressionEnabled=shareCompressionEnabled, lunEntry=lunEntry, notificationTime=notificationTime, iscsiTargetEntry=iscsiTargetEntry, shareCIFSReadIops=shareCIFSReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, lunDedupEnabled=lunDedupEnabled, fcTargetStatus=fcTargetStatus, spareDiskReplaced=spareDiskReplaced, haControllerA_Uptime=haControllerA_Uptime, lunWriteLatency=lunWriteLatency, fcInitiatorGroup=fcInitiatorGroup, disks=disks, poolCreated=poolCreated, poolQuotaFinished=poolQuotaFinished, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunPoolName=lunPoolName, poolReadCacheReadMbps=poolReadCacheReadMbps, shareReservedSizeLow=shareReservedSizeLow, smisServiceStopped=smisServiceStopped, notificationTargetEntityName=notificationTargetEntityName, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, netbiosSocketFailure=netbiosSocketFailure, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, sharePoolName=sharePoolName, ipmiCurrent=ipmiCurrent, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcInitiatorsTable=fcInitiatorsTable, poolProjects=poolProjects, diskSizeHigh=diskSizeHigh, poolUsedSizeHigh=poolUsedSizeHigh, userLoginFailed=userLoginFailed, projectLUNs=projectLUNs, diskTotalReadIops=diskTotalReadIops, deleteFolderFailed=deleteFolderFailed, aclMigrationCompleted=aclMigrationCompleted, projectTable=projectTable, haResourceName=haResourceName, fcTargetReadIops=fcTargetReadIops, diskState=diskState, nfsAvgWriteLatency=nfsAvgWriteLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiImproperTargetGroup=iscsiImproperTargetGroup, nicIndex=nicIndex, volumeDeleteCompleted=volumeDeleteCompleted, iscsiInitiatorName=iscsiInitiatorName, controllerUp=controllerUp, tegileArray=tegileArray, diskTotalWriteMbps=diskTotalWriteMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, shareDedupEnabled=shareDedupEnabled, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, diskDataWriteIops=diskDataWriteIops, shareNFSReadMbps=shareNFSReadMbps, fcTargetEntry=fcTargetEntry, webdocsUpgradeCompleted=webdocsUpgradeCompleted, notificationEventCode=notificationEventCode, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTotalReadMbps=fcTotalReadMbps, projectEntry=projectEntry, iscsiInitiators=iscsiInitiators, properties=properties, shareQuotaFinished=shareQuotaFinished, currentObjectGroup=currentObjectGroup, PYSNMP_MODULE_ID=tegile, lunFreeSizeLow=lunFreeSizeLow, iscsiAvgReadLatency=iscsiAvgReadLatency, networkInterfaceUp=networkInterfaceUp, poolDataSizeLow=poolDataSizeLow, snapshotCreationFailed=snapshotCreationFailed, fcPortOnline=fcPortOnline, lunReadMbps=lunReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, shareCompressedRatio=shareCompressedRatio, projectDeletionFailed=projectDeletionFailed, nicReceiveMbps=nicReceiveMbps, poolDataSizeHigh=poolDataSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, diskGoneOffline=diskGoneOffline, cacheTotalWriteMbps=cacheTotalWriteMbps, lunName=lunName, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, ipmiTemperature=ipmiTemperature, iscsiTargetAlias=iscsiTargetAlias, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diskTotalReadMbps=diskTotalReadMbps, poolIndex=poolIndex, poolExpanded=poolExpanded, lunSnapshotSizeLow=lunSnapshotSizeLow, diskError=diskError, smisServiceStopFailed=smisServiceStopFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, volumeQuotaFinished=volumeQuotaFinished, shareName=shareName, poolState=poolState, fcTargetName=fcTargetName, networkTotalTransmitMbps=networkTotalTransmitMbps, nvdimmFailSoftError=nvdimmFailSoftError, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, cacheRAMReads=cacheRAMReads, notificationDescription=notificationDescription, fcInitiatorIndex=fcInitiatorIndex, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargetWriteMbps=fcTargetWriteMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, deleteFolderCompleted=deleteFolderCompleted, upgradeDownloadStarted=upgradeDownloadStarted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiTargetIndex=iscsiTargetIndex, snmpServiceStopped=snmpServiceStopped, shareNFSReadLatency=shareNFSReadLatency, memoryFailure=memoryFailure, shareProjectName=shareProjectName, nicTable=nicTable, notificationProps=notificationProps, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, lunProjectName=lunProjectName, poolTotalReadIops=poolTotalReadIops, diskSequentialIOCount=diskSequentialIOCount, nicState=nicState, poolTotalWriteIops=poolTotalWriteIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, diskDataWriteMbps=diskDataWriteMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, diskPoolName=diskPoolName, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, haResourceGroup=haResourceGroup, shareDeletionFailed=shareDeletionFailed, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareNFSReadIops=shareNFSReadIops)
