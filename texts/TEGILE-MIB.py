...
Counter64, enterprises, Unsigned32, ObjectIdentity, IpAddress, ModuleIdentity, iso, Counter32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "enterprises", "Unsigned32", "ObjectIdentity", "IpAddress", "ModuleIdentity", "iso", "Counter32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunReservedSizeLow=lunReservedSizeLow, PYSNMP_MODULE_ID=tegile, lunReservedSizeHigh=lunReservedSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolMetaReadMbps=poolMetaReadMbps, cpuInterrupts=cpuInterrupts, networkInterfaceUp=networkInterfaceUp, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, notificationDescription=notificationDescription, iscsiTargets=iscsiTargets, diskPoolName=diskPoolName, fcTargetName=fcTargetName, ipmiCurrent=ipmiCurrent, aclMigrationStarted=aclMigrationStarted, projectIndex=projectIndex, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, smbSocketFailure=smbSocketFailure, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolSizeLow=poolSizeLow, nicMTU=nicMTU, shareNFSWriteMbps=shareNFSWriteMbps, projectDedupEnabled=projectDedupEnabled, projectDeletionFailed=projectDeletionFailed, poolTotalReadIops=poolTotalReadIops, fcTotalReadIops=fcTotalReadIops, haControllerA_IPAddr=haControllerA_IPAddr, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, iscsiTargetName=iscsiTargetName, poolImported=poolImported, diskAvgWriteLatency=diskAvgWriteLatency, diskState=diskState, cacheTotalReadMbps=cacheTotalReadMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcInitiatorsTable=fcInitiatorsTable, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiInitiatorGroup=iscsiInitiatorGroup, projectShares=projectShares, poolTotalWriteMbps=poolTotalWriteMbps, tegileGroups=tegileGroups, projectFreeSizeHigh=projectFreeSizeHigh, nfsAvgReadLatency=nfsAvgReadLatency, nvdimmFailDeviceError=nvdimmFailDeviceError, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, controllerDown=controllerDown, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, controllerUp=controllerUp, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, poolUsedSizeLow=poolUsedSizeLow, poolProjects=poolProjects, fcInitiators=fcInitiators, poolTotalReadMbps=poolTotalReadMbps, volumeDeleteCompleted=volumeDeleteCompleted, snapshotRollbackCompleted=snapshotRollbackCompleted, cifsAvgReadLatency=cifsAvgReadLatency, cifsTotalReadIops=cifsTotalReadIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, smisServiceStopFailed=smisServiceStopFailed, lunWriteMbps=lunWriteMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, ntpServerTimeDrift=ntpServerTimeDrift, cacheTotalReadIops=cacheTotalReadIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, replicationFailed=replicationFailed, cacheRAMReads=cacheRAMReads, diskTotalWriteIops=diskTotalWriteIops, spareDiskReplaced=spareDiskReplaced, snmpAgentVersion=snmpAgentVersion, shareName=shareName, upgradeDownloadStarted=upgradeDownloadStarted, notificationTime=notificationTime, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolDataWriteIops=poolDataWriteIops, netbiosSocketFailure=netbiosSocketFailure, notificationSensorNumber=notificationSensorNumber, replicationComplete=replicationComplete, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, nicName=nicName, poolMetaReadIops=poolMetaReadIops, lunGUID=lunGUID, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, ipmiCriticalInterrupt=ipmiCriticalInterrupt, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcTargetWriteMbps=fcTargetWriteMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, poolAvgReadLatency=poolAvgReadLatency, lunTable=lunTable, nicEntry=nicEntry, iscsiImproperTargetGroup=iscsiImproperTargetGroup, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiTargetAlias=iscsiTargetAlias, maintenanceModeEnabled=maintenanceModeEnabled, poolTotalSaving=poolTotalSaving, haResourceStatus=haResourceStatus, poolWriteCacheWriteIops=poolWriteCacheWriteIops, notificationReadingTriggerValue=notificationReadingTriggerValue, shareNFSReadIops=shareNFSReadIops, iscsiTargetEntry=iscsiTargetEntry, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, networkIpmpGroupDown=networkIpmpGroupDown, lunSizeLow=lunSizeLow, notificationObjects=notificationObjects, poolDegraded=poolDegraded, diskDataReadIops=diskDataReadIops, smisServiceStopped=smisServiceStopped, iscsiWriteIops=iscsiWriteIops, iscsiInitiators=iscsiInitiators, poolState=poolState, fcAvgReadLatency=fcAvgReadLatency, lunReadIops=lunReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcTargetStatus=fcTargetStatus, cacheTotalWriteIops=cacheTotalWriteIops, haResourcesTable=haResourcesTable, poolMetaWriteIops=poolMetaWriteIops, projectLUNs=projectLUNs, lunProjectName=lunProjectName, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, diskGoneOffline=diskGoneOffline, fcTargetGroup=fcTargetGroup, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolDataReadMbps=poolDataReadMbps, notificationReadingUnit=notificationReadingUnit, webdocsUpgradeFailed=webdocsUpgradeFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolOwnerController=poolOwnerController, shareQuotaHigh=shareQuotaHigh, poolDataWriteMbps=poolDataWriteMbps, upgradeFailed=upgradeFailed, projectShareCount=projectShareCount, notificationSensorSuspect=notificationSensorSuspect, snmpServiceStopped=snmpServiceStopped, nfsTotalReadMbps=nfsTotalReadMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolDataSizeHigh=poolDataSizeHigh, shareEntry=shareEntry, targetGroupMemberRemoved=targetGroupMemberRemoved, sensorFailureEvent=sensorFailureEvent, iscsiTargetIndex=iscsiTargetIndex, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTargets=fcTargets, diskChassisIdx=diskChassisIdx, iscsiTargetGroupError=iscsiTargetGroupError, projectName=projectName, snapshotCloningFailed=snapshotCloningFailed, networkInterfaceDown=networkInterfaceDown, diskTable=diskTable, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, userLoginFailed=userLoginFailed, smisServiceStartFailed=smisServiceStartFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, notificationEventCode=notificationEventCode, diskIndex=diskIndex, fcTargetWriteIops=fcTargetWriteIops, shareCIFSEnabled=shareCIFSEnabled, iscsiInitiatorEntry=iscsiInitiatorEntry, notificationProps=notificationProps, diskSlowIo=diskSlowIo, poolExported=poolExported, controllerTimeDrift=controllerTimeDrift, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareNFSWriteLatency=shareNFSWriteLatency, iscsiTargetError=iscsiTargetError, shareTable=shareTable, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, ipmiThreshold=ipmiThreshold, poolReadCacheReadMbps=poolReadCacheReadMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectEntry=projectEntry, haResourceName=haResourceName, iscsiProperties=iscsiProperties, webdocsUpgradeCompleted=webdocsUpgradeCompleted, haControllerA_Uptime=haControllerA_Uptime, fcTotalReadMbps=fcTotalReadMbps, snapshotRollbackFailed=snapshotRollbackFailed, projectDeleted=projectDeleted, diskEntry=diskEntry, snmpServiceStarted=snmpServiceStarted, replicationTargetDeleted=replicationTargetDeleted, haResourceGroup=haResourceGroup, notificationComponentName=notificationComponentName, tegileConformance=tegileConformance, lunDataSizeHigh=lunDataSizeHigh, lunReadMbps=lunReadMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, ipmiPowerSupply=ipmiPowerSupply, diskAlias=diskAlias, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, diskIsOnline=diskIsOnline, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, unknownSensorEvent=unknownSensorEvent, memoryFailure=memoryFailure, lunDedupEnabled=lunDedupEnabled, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcInitiatorGroup=fcInitiatorGroup, cacheSSDReads=cacheSSDReads, snmpServiceStopFailed=snmpServiceStopFailed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiTargetWriteIops=iscsiTargetWriteIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, lunFreeSizeHigh=lunFreeSizeHigh, shareNFSEnabled=shareNFSEnabled, cpuSystemCalls=cpuSystemCalls, replicationAborted=replicationAborted, tdpsUpgradeFailed=tdpsUpgradeFailed, shareDataSizeLow=shareDataSizeLow, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcTargetEntry=fcTargetEntry, tegileArray_notifications=tegileArray_notifications, cifsTotalReadMbps=cifsTotalReadMbps, replicationPaused=replicationPaused, diskSizeHigh=diskSizeHigh, poolUpgraded=poolUpgraded, ipmiTemperature=ipmiTemperature, volumeQuotaFinished=volumeQuotaFinished, projectPoolName=projectPoolName, currentObjectGroup=currentObjectGroup, deleteFolderFailed=deleteFolderFailed, snapshotCreationFailed=snapshotCreationFailed, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, shareQuotaLow=shareQuotaLow, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, shareExceedThresholdWarning=shareExceedThresholdWarning, tegile=tegile, poolUsedSizeHigh=poolUsedSizeHigh, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiTargetReadLatency=iscsiTargetReadLatency, ipmiOther=ipmiOther, diskSequentialIOCount=diskSequentialIOCount, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, lunTargetGroup=lunTargetGroup, nvdimmFailInitializationError=nvdimmFailInitializationError, poolMetaWriteLatency=poolMetaWriteLatency, fcAvgWriteLatency=fcAvgWriteLatency, ipmiMemory=ipmiMemory, poolIndex=poolIndex, fcTargetsTable=fcTargetsTable, poolQuotaFinished=poolQuotaFinished, globalStatistics=globalStatistics, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcPortOnline=fcPortOnline, fcTargetReadIops=fcTargetReadIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareCIFSReadIops=shareCIFSReadIops)
mibBuilder.exportSymbols("TEGILE-MIB", poolAvgWriteLatency=poolAvgWriteLatency, upgradeStarted=upgradeStarted, poolDeletionFailed=poolDeletionFailed, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, haControllerA_Name=haControllerA_Name, snapshotDeleteFailed=snapshotDeleteFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, replicationAbandoned=replicationAbandoned, haResources=haResources, cifsTotalWriteIops=cifsTotalWriteIops, sharePoolName=sharePoolName, replicationStarted=replicationStarted, shareCIFSWriteLatency=shareCIFSWriteLatency, poolSizeHigh=poolSizeHigh, projectLunCount=projectLunCount, shareCIFSWriteIops=shareCIFSWriteIops, snmpServiceStartFailed=snmpServiceStartFailed, haResourceActiveNode=haResourceActiveNode, lunWriteIops=lunWriteIops, network=network, diskTotalReadIops=diskTotalReadIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareReservedSizeHigh=shareReservedSizeHigh, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, notificationSeverity=notificationSeverity, upgradeDownloadFailed=upgradeDownloadFailed, poolDataSizeLow=poolDataSizeLow, lunIndex=lunIndex, lunReadLatency=lunReadLatency, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, poolEntry=poolEntry, diskType=diskType, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, testNotification=testNotification, fcTargetReadLatency=fcTargetReadLatency, nicTransmitMbps=nicTransmitMbps, diskError=diskError, notificationSensorAction=notificationSensorAction, poolDataWriteLatency=poolDataWriteLatency, projectQuotaFinished=projectQuotaFinished, maintenanceModeDisabled=maintenanceModeDisabled, shareDataSizeHigh=shareDataSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcProperties=fcProperties, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolTotalWriteIops=poolTotalWriteIops, lunInitiatorGroup=lunInitiatorGroup, nicIndex=nicIndex, nfsTotalWriteMbps=nfsTotalWriteMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, upgradeTimeout=upgradeTimeout, diskDataWriteIops=diskDataWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, projectCompressionEnabled=projectCompressionEnabled, poolDataReadLatency=poolDataReadLatency, projectQuotaSizeLow=projectQuotaSizeLow, targetGroupMemberAdded=targetGroupMemberAdded, iscsiTotalReadIops=iscsiTotalReadIops, projectDataSizeHigh=projectDataSizeHigh, ipmiFan=ipmiFan, nicTable=nicTable, diskIOCount=diskIOCount, poolCreated=poolCreated, fcTargetIndex=fcTargetIndex, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolFreeSizeHigh=poolFreeSizeHigh, lunDataSizeLow=lunDataSizeLow, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, properties=properties, shareSnapshotSizeLow=shareSnapshotSizeLow, replicationResumed=replicationResumed, notificationTargetEntityName=notificationTargetEntityName, diagnosticDataUploaded=diagnosticDataUploaded, currentNotificationGroup=currentNotificationGroup, diskDataReadMbps=diskDataReadMbps, fcPortOffline=fcPortOffline, shareNFSReadLatency=shareNFSReadLatency, poolMetaReadLatency=poolMetaReadLatency, poolReadCacheReadIops=poolReadCacheReadIops, controllerHardwareModel=controllerHardwareModel, projectFreeSizeLow=projectFreeSizeLow, lunSnapshotSizeLow=lunSnapshotSizeLow, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, nfsTotalWriteIops=nfsTotalWriteIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, nicState=nicState, smisServiceStarted=smisServiceStarted, lunBlockSize=lunBlockSize, alertsCleanupCompleted=alertsCleanupCompleted, iscsiTargetAuth=iscsiTargetAuth, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, lunEntry=lunEntry, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, diskAvgReadLatency=diskAvgReadLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, pools=pools, projectModified=projectModified, shareIndex=shareIndex, nfsAvgWriteLatency=nfsAvgWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, upgradeCompleted=upgradeCompleted, lunName=lunName, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, cpuTotalUsage=cpuTotalUsage, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiTargetReadMbps=iscsiTargetReadMbps, haResourceEntry=haResourceEntry, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, aclMigrationCompleted=aclMigrationCompleted, shareReservedSizeLow=shareReservedSizeLow, diskRandomIOCount=diskRandomIOCount, poolFreeSizeLow=poolFreeSizeLow, fcInitiatorCreateFailed=fcInitiatorCreateFailed, shareCIFSReadMbps=shareCIFSReadMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, poolHealth=poolHealth, targetGroupDeleteCompleted=targetGroupDeleteCompleted, diskTotalWriteMbps=diskTotalWriteMbps, lunCompressedRatio=lunCompressedRatio, projectQuotaSizeHigh=projectQuotaSizeHigh, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiInitiatorName=iscsiInitiatorName, replicationSourceRegistered=replicationSourceRegistered, nicReceiveMbps=nicReceiveMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, projectTable=projectTable, adServerTimeDrift=adServerTimeDrift, shareCompressedRatio=shareCompressedRatio, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiTargetsTable=iscsiTargetsTable, lunPoolName=lunPoolName, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, poolTable=poolTable, haControllerB_IPAddr=haControllerB_IPAddr, projectTotalSaving=projectTotalSaving, fcInitiatorEntry=fcInitiatorEntry, lunSnapshotSizeHigh=lunSnapshotSizeHigh, diskCount=diskCount, diskTotalReadMbps=diskTotalReadMbps, lunFreeSizeLow=lunFreeSizeLow, initiatorGroupMemberAdded=initiatorGroupMemberAdded, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcTargetReadMbps=fcTargetReadMbps, notifications=notifications, shareQuotaFinished=shareQuotaFinished, cifsTotalWriteMbps=cifsTotalWriteMbps, haControllerB_Name=haControllerB_Name, networkIpmpGroupUp=networkIpmpGroupUp, fcTotalWriteIops=fcTotalWriteIops, shareProjectName=shareProjectName, shareMountPoint=shareMountPoint, fcInitiatorName=fcInitiatorName, diskSizeLow=diskSizeLow, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, sanProperties=sanProperties, projectThresholdExceedWarning=projectThresholdExceedWarning, fcInitiatorIndex=fcInitiatorIndex, deleteFolderCompleted=deleteFolderCompleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, disks=disks, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, networkTotalTransmitMbps=networkTotalTransmitMbps, nicGroup=nicGroup, lunProtocol=lunProtocol, snapshotCloneCompleted=snapshotCloneCompleted, iscsiTotalReadMbps=iscsiTotalReadMbps, shareNFSReadMbps=shareNFSReadMbps, tegileCompliances=tegileCompliances, iscsiAvgWriteLatency=iscsiAvgWriteLatency, haControllerB_Uptime=haControllerB_Uptime, iscsiTargetGroup=iscsiTargetGroup, fcTotalWriteMbps=fcTotalWriteMbps, haResourceIndex=haResourceIndex, projectDataSizeLow=projectDataSizeLow, haResourceDescription=haResourceDescription, lunWriteLatency=lunWriteLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, nvdimmFailSoftError=nvdimmFailSoftError, poolExpanded=poolExpanded, basicCompliance=basicCompliance, iscsiTargetReadIops=iscsiTargetReadIops, shareCompressionEnabled=shareCompressionEnabled, poolDeleted=poolDeleted, nfsTotalReadIops=nfsTotalReadIops, lunCompressionEnabled=lunCompressionEnabled, shareNFSWriteIops=shareNFSWriteIops, volumeDeleteFailed=volumeDeleteFailed, shareDeleted=shareDeleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolProjectCount=poolProjectCount, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, ipmiVoltage=ipmiVoltage, shareCIFSReadLatency=shareCIFSReadLatency, tegileArray=tegileArray, poolDataReadIops=poolDataReadIops, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, volumeModifyCompleted=volumeModifyCompleted, shareDeletionFailed=shareDeletionFailed, lunSizeHigh=lunSizeHigh, poolName=poolName, shareDedupEnabled=shareDedupEnabled, diskDataWriteMbps=diskDataWriteMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolCount=poolCount, poolMetaWriteMbps=poolMetaWriteMbps, iscsiAvgReadLatency=iscsiAvgReadLatency)
