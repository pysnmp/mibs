...
# Produced by pysmi-1.1.10 at Fri Nov 10 10:17:38 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, Integer32, Counter32, NotificationType, ObjectIdentity, TimeTicks, iso, Unsigned32, MibIdentifier, IpAddress, ModuleIdentity, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "Integer32", "Counter32", "NotificationType", "ObjectIdentity", "TimeTicks", "iso", "Unsigned32", "MibIdentifier", "IpAddress", "ModuleIdentity", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiInitiators=iscsiInitiators, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolDeleted=poolDeleted, haResourceName=haResourceName, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, intelliFlashSoftwareUp=intelliFlashSoftwareUp, ipmiMemory=ipmiMemory, poolUsedSizeLow=poolUsedSizeLow, targetGroupMemberAdded=targetGroupMemberAdded, shareCIFSReadLatency=shareCIFSReadLatency, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, networkIpmpGroupUp=networkIpmpGroupUp, poolTotalWriteIops=poolTotalWriteIops, haResourceStatus=haResourceStatus, lunCompressionEnabled=lunCompressionEnabled, cacheSSDReads=cacheSSDReads, shareCIFSReadMbps=shareCIFSReadMbps, fcInitiatorEntry=fcInitiatorEntry, poolMetaReadMbps=poolMetaReadMbps, poolDataReadMbps=poolDataReadMbps, disks=disks, ipmiCriticalInterrupt=ipmiCriticalInterrupt, networkInterfaceUp=networkInterfaceUp, smisServiceStarted=smisServiceStarted, notificationReadingTriggerValue=notificationReadingTriggerValue, targetGroupCreateCompleted=targetGroupCreateCompleted, poolReadCacheReadLatency=poolReadCacheReadLatency, snapshotDeleteFailed=snapshotDeleteFailed, shareNFSWriteLatency=shareNFSWriteLatency, notificationComponentName=notificationComponentName, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, nicGroup=nicGroup, iscsiTargetReadIops=iscsiTargetReadIops, fcTargetName=fcTargetName, aclMigrationStarted=aclMigrationStarted, lunReadMbps=lunReadMbps, shareEntry=shareEntry, fcPortOffline=fcPortOffline, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolReadCacheReadMbps=poolReadCacheReadMbps, fcTotalReadMbps=fcTotalReadMbps, lunTargetGroup=lunTargetGroup, tdpsUpgradeFailed=tdpsUpgradeFailed, fcInitiatorIndex=fcInitiatorIndex, iscsiTotalReadIops=iscsiTotalReadIops, shareIndex=shareIndex, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargetGroup=fcTargetGroup, diskTotalWriteIops=diskTotalWriteIops, adServerTimeDrift=adServerTimeDrift, shareQuotaHigh=shareQuotaHigh, iscsiTargetIndex=iscsiTargetIndex, lunFreeSizeLow=lunFreeSizeLow, haResourceActiveNode=haResourceActiveNode, lunSnapshotSizeHigh=lunSnapshotSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, cpuInterrupts=cpuInterrupts, upgradeFailed=upgradeFailed, fcAvgWriteLatency=fcAvgWriteLatency, iscsiInitiatorGroup=iscsiInitiatorGroup, haResources=haResources, iscsiTargetGroupError=iscsiTargetGroupError, ipmiFan=ipmiFan, poolOwnerController=poolOwnerController, poolUpgraded=poolUpgraded, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, nicTable=nicTable, poolMetaWriteMbps=poolMetaWriteMbps, snapshotRollbackFailed=snapshotRollbackFailed, diskTotalReadMbps=diskTotalReadMbps, poolTotalReadMbps=poolTotalReadMbps, lunTable=lunTable, diskError=diskError, iscsiAvgReadLatency=iscsiAvgReadLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolSizeHigh=poolSizeHigh, poolState=poolState, lunSizeHigh=lunSizeHigh, upgradeDownloadStarted=upgradeDownloadStarted, poolExported=poolExported, ipmiTemperature=ipmiTemperature, replicationResumed=replicationResumed, poolMetaWriteIops=poolMetaWriteIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectModified=projectModified, tegileGroups=tegileGroups, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, lunReadIops=lunReadIops, poolAvgWriteLatency=poolAvgWriteLatency, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskIOCount=diskIOCount, fcAvgReadLatency=fcAvgReadLatency, nicTransmitMbps=nicTransmitMbps, projectThresholdExceedWarning=projectThresholdExceedWarning, fcTargetReadIops=fcTargetReadIops, replicationSourceRegistered=replicationSourceRegistered, fcInitiatorsTable=fcInitiatorsTable, sensorFailureEvent=sensorFailureEvent, shareQuotaFinished=shareQuotaFinished, upgradeTimeout=upgradeTimeout, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, haResourceIndex=haResourceIndex, projectPoolName=projectPoolName, ntpServerTimeDrift=ntpServerTimeDrift, shareDataSizeLow=shareDataSizeLow, snapshotCreationFailed=snapshotCreationFailed, projectFreeSizeLow=projectFreeSizeLow, poolTotalWriteMbps=poolTotalWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, nicIndex=nicIndex, ipmiPowerSupply=ipmiPowerSupply, lunName=lunName, volumeQuotaFinished=volumeQuotaFinished, smisServiceStartFailed=smisServiceStartFailed, haControllerB_IPAddr=haControllerB_IPAddr, shareNFSReadMbps=shareNFSReadMbps, poolProjectCount=poolProjectCount, poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiProperties=iscsiProperties, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, properties=properties, snmpServiceStopped=snmpServiceStopped, iscsiImproperTargetGroup=iscsiImproperTargetGroup, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, notificationReadingUnit=notificationReadingUnit, snmpServiceStarted=snmpServiceStarted, diskTotalWriteMbps=diskTotalWriteMbps, poolIndex=poolIndex, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcTargetReadMbps=fcTargetReadMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, ipmiOther=ipmiOther, shareDedupEnabled=shareDedupEnabled, shareCIFSEnabled=shareCIFSEnabled, iscsiTargetReadLatency=iscsiTargetReadLatency, replicationTargetDeleted=replicationTargetDeleted, projectEntry=projectEntry, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, haControllerB_Name=haControllerB_Name, nvdimmFailDeviceError=nvdimmFailDeviceError, fcTotalWriteIops=fcTotalWriteIops, diagnosticDataUploaded=diagnosticDataUploaded, poolFreeSizeLow=poolFreeSizeLow, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, fcInitiatorName=fcInitiatorName, poolDataWriteIops=poolDataWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, tegileConformance=tegileConformance, lunSnapshotSizeLow=lunSnapshotSizeLow, projectShares=projectShares, shareCIFSReadIops=shareCIFSReadIops, poolQuotaFinished=poolQuotaFinished, spareDiskReplaced=spareDiskReplaced, snapshotCloningFailed=snapshotCloningFailed, snapshotCloneCompleted=snapshotCloneCompleted, diskCount=diskCount, cpuTotalUsage=cpuTotalUsage, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, diskSizeLow=diskSizeLow, cacheTotalReadIops=cacheTotalReadIops, iscsiTargetEntry=iscsiTargetEntry, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcInitiators=fcInitiators, lunWriteLatency=lunWriteLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, pools=pools, diskAvgWriteLatency=diskAvgWriteLatency, controllerDown=controllerDown, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunDataSizeHigh=lunDataSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiTargetWriteIops=iscsiTargetWriteIops, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, iscsiTargetGroup=iscsiTargetGroup, volumeModifyCompleted=volumeModifyCompleted, poolCount=poolCount, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, replicationAborted=replicationAborted, shareDeletionFailed=shareDeletionFailed, cacheTotalReadMbps=cacheTotalReadMbps, lunProtocol=lunProtocol, projectSnapshotSizeLow=projectSnapshotSizeLow, deleteFolderFailed=deleteFolderFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, controllerHardwareModel=controllerHardwareModel, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, network=network, poolCreated=poolCreated, ipmiThreshold=ipmiThreshold, nicState=nicState, diskDataWriteMbps=diskDataWriteMbps, lunIndex=lunIndex, smisServiceStopped=smisServiceStopped, cacheRAMReads=cacheRAMReads, cifsTotalReadIops=cifsTotalReadIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareCompressedRatio=shareCompressedRatio, nvdimmFailUnknownError=nvdimmFailUnknownError, diskRandomIOCount=diskRandomIOCount, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetAlias=iscsiTargetAlias, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, projectTotalSaving=projectTotalSaving, fcProperties=fcProperties, iscsiInitiatorName=iscsiInitiatorName, poolTable=poolTable, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolProjects=poolProjects, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, snmpAgentVersion=snmpAgentVersion, projectQuotaSizeLow=projectQuotaSizeLow, diskSlowIo=diskSlowIo, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, notificationSensorAction=notificationSensorAction, poolDataWriteMbps=poolDataWriteMbps, diskType=diskType, poolMetaReadIops=poolMetaReadIops, notifications=notifications, projectDeletionFailed=projectDeletionFailed, shareName=shareName, ipmiCurrent=ipmiCurrent, networkIpmpGroupDown=networkIpmpGroupDown, nfsAvgWriteLatency=nfsAvgWriteLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, upgradeCompleted=upgradeCompleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareReservedSizeLow=shareReservedSizeLow, fcTargetWriteIops=fcTargetWriteIops, tegileArray=tegileArray, lunReservedSizeLow=lunReservedSizeLow, replicationFailed=replicationFailed, smisServiceStopFailed=smisServiceStopFailed, cifsTotalWriteMbps=cifsTotalWriteMbps, snmpServiceStartFailed=snmpServiceStartFailed, nfsTotalWriteIops=nfsTotalWriteIops, diskIndex=diskIndex, diskEntry=diskEntry, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunReservedSizeHigh=lunReservedSizeHigh, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunWriteIops=lunWriteIops, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, lunBlockSize=lunBlockSize, cacheTotalWriteIops=cacheTotalWriteIops, projectQuotaSizeHigh=projectQuotaSizeHigh, shareSnapshotSizeHigh=shareSnapshotSizeHigh, vmwareNFSDatastores=vmwareNFSDatastores)
mibBuilder.exportSymbols("TEGILE-MIB", replicationPaused=replicationPaused, iscsiTargetsTable=iscsiTargetsTable, volumeDeleteFailed=volumeDeleteFailed, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, nvdimmFailInitializationError=nvdimmFailInitializationError, haResourceDescription=haResourceDescription, controllerUp=controllerUp, nicName=nicName, notificationProps=notificationProps, fcTargetsTable=fcTargetsTable, netbiosSocketFailure=netbiosSocketFailure, lunDataSizeLow=lunDataSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, haResourcesTable=haResourcesTable, iscsiTargets=iscsiTargets, shareMountPoint=shareMountPoint, iscsiTargetName=iscsiTargetName, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, diskDataReadIops=diskDataReadIops, shareProjectName=shareProjectName, shareNFSReadLatency=shareNFSReadLatency, upgradeStarted=upgradeStarted, unknownSensorEvent=unknownSensorEvent, shareTable=shareTable, webdocsUpgradeFailed=webdocsUpgradeFailed, shareDataSizeHigh=shareDataSizeHigh, iscsiInitiatorsTable=iscsiInitiatorsTable, shareCreatedSuccessfully=shareCreatedSuccessfully, poolDataWriteLatency=poolDataWriteLatency, nfsAvgReadLatency=nfsAvgReadLatency, currentNotificationGroup=currentNotificationGroup, networkTotalReceiveMbps=networkTotalReceiveMbps, diskPoolName=diskPoolName, nicEntry=nicEntry, snapshotRollbackCompleted=snapshotRollbackCompleted, nicReceiveMbps=nicReceiveMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, nvdimmFailSoftError=nvdimmFailSoftError, fcTargetModifyCompleted=fcTargetModifyCompleted, diskSequentialIOCount=diskSequentialIOCount, lunSizeLow=lunSizeLow, notificationObjects=notificationObjects, diskAvgReadLatency=diskAvgReadLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, diskTotalReadIops=diskTotalReadIops, projectFreeSizeHigh=projectFreeSizeHigh, nfsTotalWriteMbps=nfsTotalWriteMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, nfsTotalReadIops=nfsTotalReadIops, notificationTargetEntityName=notificationTargetEntityName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, ipmiVoltage=ipmiVoltage, projectQuotaFinished=projectQuotaFinished, cacheTotalWriteMbps=cacheTotalWriteMbps, networkInterfaceDown=networkInterfaceDown, smbSocketFailure=smbSocketFailure, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolFreeSizeHigh=poolFreeSizeHigh, sharePoolName=sharePoolName, lunWriteMbps=lunWriteMbps, fcTargetEntry=fcTargetEntry, haControllerB_Uptime=haControllerB_Uptime, fcTargetReadLatency=fcTargetReadLatency, diskChassisIdx=diskChassisIdx, fcPortOnline=fcPortOnline, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, cpuSystemCalls=cpuSystemCalls, lunCompressedRatio=lunCompressedRatio, notificationTime=notificationTime, diskState=diskState, shareQuotaLow=shareQuotaLow, controllerTimeDrift=controllerTimeDrift, poolDataReadIops=poolDataReadIops, poolDataReadLatency=poolDataReadLatency, poolReadCacheReadIops=poolReadCacheReadIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunPoolName=lunPoolName, diskIsOnline=diskIsOnline, poolName=poolName, fcTargetIndex=fcTargetIndex, upgradeDownloadFailed=upgradeDownloadFailed, projectShareCount=projectShareCount, snmpServiceStopFailed=snmpServiceStopFailed, projectTable=projectTable, tegileCompliances=tegileCompliances, nfsTotalReadMbps=nfsTotalReadMbps, projectCompressionEnabled=projectCompressionEnabled, projectDataSizeHigh=projectDataSizeHigh, lunProjectName=lunProjectName, poolTotalSaving=poolTotalSaving, iscsiTargetWriteMbps=iscsiTargetWriteMbps, cifsTotalReadMbps=cifsTotalReadMbps, poolAvgReadLatency=poolAvgReadLatency, volumeDeleteCompleted=volumeDeleteCompleted, lunFreeSizeHigh=lunFreeSizeHigh, projectDataSizeLow=projectDataSizeLow, poolReadCacheWriteIops=poolReadCacheWriteIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, maintenanceModeDisabled=maintenanceModeDisabled, poolTotalReadIops=poolTotalReadIops, poolMetaReadLatency=poolMetaReadLatency, poolSizeLow=poolSizeLow, projectDeleted=projectDeleted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, tdpsUpgradeCompleted=tdpsUpgradeCompleted, fcInitiatorGroup=fcInitiatorGroup, iscsiWriteIops=iscsiWriteIops, fcTargetWriteLatency=fcTargetWriteLatency, fcTargets=fcTargets, deleteFolderCompleted=deleteFolderCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcTotalWriteMbps=fcTotalWriteMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, basicCompliance=basicCompliance, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, replicationStarted=replicationStarted, poolDegraded=poolDegraded, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, memoryFailure=memoryFailure, diskTable=diskTable, notificationSensorSuspect=notificationSensorSuspect, upgradeDownloadCompleted=upgradeDownloadCompleted, fcTotalReadIops=fcTotalReadIops, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, lunEntry=lunEntry, poolExpanded=poolExpanded, sanProperties=sanProperties, shareNFSWriteIops=shareNFSWriteIops, userLoginFailed=userLoginFailed, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, PYSNMP_MODULE_ID=tegile, diskGoneOffline=diskGoneOffline, shareNFSEnabled=shareNFSEnabled, diskSizeHigh=diskSizeHigh, poolWriteCacheWriteIops=poolWriteCacheWriteIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, iscsiTargetReadMbps=iscsiTargetReadMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, poolEntry=poolEntry, shareDeleted=shareDeleted, notificationSeverity=notificationSeverity, shareReservedSizeHigh=shareReservedSizeHigh, lunDedupEnabled=lunDedupEnabled, lunReadLatency=lunReadLatency, haControllerA_IPAddr=haControllerA_IPAddr, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolImported=poolImported, tegile=tegile, replicationAbandoned=replicationAbandoned, projectDedupEnabled=projectDedupEnabled, poolDataSizeHigh=poolDataSizeHigh, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcTargetWriteMbps=fcTargetWriteMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, shareSnapshotSizeLow=shareSnapshotSizeLow, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, notificationSensorNumber=notificationSensorNumber, fcInitiatorCreateFailed=fcInitiatorCreateFailed, currentObjectGroup=currentObjectGroup, maintenanceModeEnabled=maintenanceModeEnabled, notificationEventCode=notificationEventCode, poolMetaWriteLatency=poolMetaWriteLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskAlias=diskAlias, testNotification=testNotification, alertsCleanupCompleted=alertsCleanupCompleted, iscsiTargetAuth=iscsiTargetAuth, aclMigrationCompleted=aclMigrationCompleted, nicMTU=nicMTU, volumeCreatedSuccessfully=volumeCreatedSuccessfully, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunInitiatorGroup=lunInitiatorGroup, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareCompressionEnabled=shareCompressionEnabled, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectName=projectName, diskDataWriteIops=diskDataWriteIops, projectLUNs=projectLUNs, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolUsedSizeHigh=poolUsedSizeHigh, haControllerA_Uptime=haControllerA_Uptime, haControllerA_Name=haControllerA_Name, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, replicationComplete=replicationComplete, diskDataReadMbps=diskDataReadMbps, notificationDescription=notificationDescription, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, projectLunCount=projectLunCount, shareCIFSWriteIops=shareCIFSWriteIops, iscsiTotalReadMbps=iscsiTotalReadMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, iscsiInitiatorIndex=iscsiInitiatorIndex, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiTargetError=iscsiTargetError, poolDeletionFailed=poolDeletionFailed, lunGUID=lunGUID, haResourceEntry=haResourceEntry, haResourceGroup=haResourceGroup, cifsAvgReadLatency=cifsAvgReadLatency, poolHealth=poolHealth, tegileArray_notifications=tegileArray_notifications, projectIndex=projectIndex, fcTargetStatus=fcTargetStatus, globalStatistics=globalStatistics, shareCIFSWriteMbps=shareCIFSWriteMbps)
