...
IpAddress, TimeTicks, MibIdentifier, iso, Gauge32, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, Counter32, Bits, NotificationType, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "MibIdentifier", "iso", "Gauge32", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "Counter32", "Bits", "NotificationType", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", sensorFailureEvent=sensorFailureEvent, iscsiInitiatorName=iscsiInitiatorName, lunReadIops=lunReadIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolQuotaFinished=poolQuotaFinished, iscsiInitiatorIndex=iscsiInitiatorIndex, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareDedupEnabled=shareDedupEnabled, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, diskTotalWriteIops=diskTotalWriteIops, shareSnapshotSizeLow=shareSnapshotSizeLow, upgradeDownloadFailed=upgradeDownloadFailed, diskDataWriteIops=diskDataWriteIops, nicEntry=nicEntry, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, ipmiVoltage=ipmiVoltage, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunCompressionEnabled=lunCompressionEnabled, projectTable=projectTable, poolDeleted=poolDeleted, fcTargetStatus=fcTargetStatus, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, lunInitiatorGroup=lunInitiatorGroup, notificationEventCode=notificationEventCode, notificationReadingUnit=notificationReadingUnit, intelliFlashSoftwareUp=intelliFlashSoftwareUp, diskSizeLow=diskSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, cifsAvgReadLatency=cifsAvgReadLatency, lunFreeSizeLow=lunFreeSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, cifsAvgWriteLatency=cifsAvgWriteLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcProperties=fcProperties, diskIsOnline=diskIsOnline, iscsiInitiatorEntry=iscsiInitiatorEntry, fcTotalReadMbps=fcTotalReadMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, poolDataWriteIops=poolDataWriteIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolIndex=poolIndex, shareName=shareName, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectDataSizeLow=projectDataSizeLow, nicTransmitMbps=nicTransmitMbps, poolDataSizeLow=poolDataSizeLow, shareCIFSReadIops=shareCIFSReadIops, iscsiInitiators=iscsiInitiators, nicState=nicState, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, fcTotalWriteMbps=fcTotalWriteMbps, projectModified=projectModified, ipmiOther=ipmiOther, maintenanceModeDisabled=maintenanceModeDisabled, fcTargetReadMbps=fcTargetReadMbps, diskTotalWriteMbps=diskTotalWriteMbps, diskTotalReadIops=diskTotalReadIops, lunProjectName=lunProjectName, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareDataSizeLow=shareDataSizeLow, poolUsedSizeHigh=poolUsedSizeHigh, diskAlias=diskAlias, replicationAbandoned=replicationAbandoned, shareMountPoint=shareMountPoint, nvdimmFailDeviceError=nvdimmFailDeviceError, lunBlockSize=lunBlockSize, poolDegraded=poolDegraded, snmpServiceStartFailed=snmpServiceStartFailed, diskDataReadMbps=diskDataReadMbps, projectEntry=projectEntry, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, replicationPaused=replicationPaused, lunIndex=lunIndex, volumeQuotaFinished=volumeQuotaFinished, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, haResourceStatus=haResourceStatus, snapshotCreationFailed=snapshotCreationFailed, replicationStarted=replicationStarted, poolName=poolName, controllerDown=controllerDown, shareCIFSReadMbps=shareCIFSReadMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, smisServiceStopFailed=smisServiceStopFailed, networkIpmpGroupDown=networkIpmpGroupDown, diskIOCount=diskIOCount, haResourceGroup=haResourceGroup, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, spareDiskReplaced=spareDiskReplaced, poolDataReadMbps=poolDataReadMbps, poolHealth=poolHealth, networkTotalReceiveMbps=networkTotalReceiveMbps, projectCompressionEnabled=projectCompressionEnabled, shareIndex=shareIndex, volumeModifyCompleted=volumeModifyCompleted, networkInterfaceUp=networkInterfaceUp, fcInitiators=fcInitiators, haResourceDescription=haResourceDescription, lunDataSizeLow=lunDataSizeLow, poolImported=poolImported, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolMetaReadMbps=poolMetaReadMbps, ipmiCurrent=ipmiCurrent, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, unknownSensorEvent=unknownSensorEvent, diskDataReadIops=diskDataReadIops, projectTotalSaving=projectTotalSaving, notificationTargetEntityName=notificationTargetEntityName, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, replicationAborted=replicationAborted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcTargetReadLatency=fcTargetReadLatency, tegile=tegile, poolEntry=poolEntry, diskSizeHigh=diskSizeHigh, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolDataReadLatency=poolDataReadLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiInitiatorsTable=iscsiInitiatorsTable, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolDataSizeHigh=poolDataSizeHigh, projectCreatedSuccessfully=projectCreatedSuccessfully, diskTable=diskTable, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, haResourceIndex=haResourceIndex, sanProperties=sanProperties, aclMigrationStarted=aclMigrationStarted, lunWriteLatency=lunWriteLatency, lunReservedSizeHigh=lunReservedSizeHigh, diskAvgWriteLatency=diskAvgWriteLatency, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTargets=iscsiTargets, diskSequentialIOCount=diskSequentialIOCount, diskIndex=diskIndex, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, globalStatistics=globalStatistics, smbSocketFailure=smbSocketFailure, notificationObjects=notificationObjects, diskType=diskType, poolReadCacheReadMbps=poolReadCacheReadMbps, poolExpanded=poolExpanded, deleteFolderFailed=deleteFolderFailed, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, haControllerA_Uptime=haControllerA_Uptime, smisServiceStopped=smisServiceStopped, poolExported=poolExported, lunReadMbps=lunReadMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, alertsCleanupCompleted=alertsCleanupCompleted, snmpAgentVersion=snmpAgentVersion, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, nicName=nicName, userLoginFailed=userLoginFailed, memoryFailure=memoryFailure, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcTargetWriteMbps=fcTargetWriteMbps, diskChassisIdx=diskChassisIdx, cpuTotalUsage=cpuTotalUsage, iscsiInitiatorChapUser=iscsiInitiatorChapUser, volumeCreatedSuccessfully=volumeCreatedSuccessfully, notificationSensorNumber=notificationSensorNumber, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolDeletionFailed=poolDeletionFailed, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, projectQuotaSizeHigh=projectQuotaSizeHigh, shareTable=shareTable, ipmiTemperature=ipmiTemperature, pools=pools, netbiosSocketFailure=netbiosSocketFailure, cacheRAMReads=cacheRAMReads, diskError=diskError, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolProjectCount=poolProjectCount, snmpServiceStopFailed=snmpServiceStopFailed, lunProtocol=lunProtocol, projectQuotaFinished=projectQuotaFinished, upgradeTimeout=upgradeTimeout, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcInitiatorIndex=fcInitiatorIndex, lunCompressedRatio=lunCompressedRatio, poolMetaReadLatency=poolMetaReadLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, snmpServiceStopped=snmpServiceStopped, network=network, poolMetaReadIops=poolMetaReadIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, snmpServiceStarted=snmpServiceStarted, fcTargetGroup=fcTargetGroup, lunWriteMbps=lunWriteMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, poolProjects=poolProjects, poolMetaWriteIops=poolMetaWriteIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunPoolName=lunPoolName, haControllerB_Uptime=haControllerB_Uptime, shareCreatedSuccessfully=shareCreatedSuccessfully, cifsTotalReadIops=cifsTotalReadIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, targetGroupMemberAdded=targetGroupMemberAdded, fcPortOffline=fcPortOffline, nicReceiveMbps=nicReceiveMbps, iscsiTargetAuth=iscsiTargetAuth, lunReadLatency=lunReadLatency, projectLunCount=projectLunCount, ipmiThreshold=ipmiThreshold, fcTotalReadIops=fcTotalReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolDataWriteLatency=poolDataWriteLatency, shareDeletionFailed=shareDeletionFailed, targetGroupMemberRemoved=targetGroupMemberRemoved, fcAvgReadLatency=fcAvgReadLatency, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, lunGUID=lunGUID, replicationResumed=replicationResumed, poolAvgWriteLatency=poolAvgWriteLatency, notificationTime=notificationTime, fcTargetEntry=fcTargetEntry, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, notificationComponentName=notificationComponentName, poolReadCacheReadLatency=poolReadCacheReadLatency, projectFreeSizeHigh=projectFreeSizeHigh, projectDedupEnabled=projectDedupEnabled, iscsiTargetGroupError=iscsiTargetGroupError, poolCount=poolCount, targetGroupDeleteCompleted=targetGroupDeleteCompleted, replicationComplete=replicationComplete, iscsiTargetEntry=iscsiTargetEntry, shareNFSReadLatency=shareNFSReadLatency, iscsiTargetReadIops=iscsiTargetReadIops, nfsTotalWriteIops=nfsTotalWriteIops, diskGoneOffline=diskGoneOffline, shareCIFSEnabled=shareCIFSEnabled, poolTotalReadIops=poolTotalReadIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, tegileCompliances=tegileCompliances, projectName=projectName, nicGroup=nicGroup, lunSizeLow=lunSizeLow, fcInitiatorName=fcInitiatorName, shareQuotaHigh=shareQuotaHigh, shareCompressedRatio=shareCompressedRatio, cpuSystemCalls=cpuSystemCalls)
mibBuilder.exportSymbols("TEGILE-MIB", tdpsUpgradeTimeout=tdpsUpgradeTimeout, projectSnapshotSizeLow=projectSnapshotSizeLow, shareDeleted=shareDeleted, replicationSourceRegistered=replicationSourceRegistered, fcAvgWriteLatency=fcAvgWriteLatency, projectLUNs=projectLUNs, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcTargetName=fcTargetName, intelliFlashSoftwareDown=intelliFlashSoftwareDown, ipmiFan=ipmiFan, poolOwnerController=poolOwnerController, iscsiTotalReadIops=iscsiTotalReadIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcPortOnline=fcPortOnline, vmwareNFSDatastores=vmwareNFSDatastores, currentNotificationGroup=currentNotificationGroup, poolWriteCacheWriteIops=poolWriteCacheWriteIops, volumeDeleteCompleted=volumeDeleteCompleted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, lunName=lunName, cifsTotalWriteMbps=cifsTotalWriteMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareQuotaFinished=shareQuotaFinished, iscsiProperties=iscsiProperties, diskCount=diskCount, testNotification=testNotification, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, nvdimmFailSoftError=nvdimmFailSoftError, fcTargetIndex=fcTargetIndex, poolTotalSaving=poolTotalSaving, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, shareNFSReadMbps=shareNFSReadMbps, lunTargetGroup=lunTargetGroup, nicMTU=nicMTU, webdocsUpgradeFailed=webdocsUpgradeFailed, haResources=haResources, ipmiMemory=ipmiMemory, fcTargetWriteIops=fcTargetWriteIops, haControllerA_IPAddr=haControllerA_IPAddr, cifsTotalWriteIops=cifsTotalWriteIops, replicationFailed=replicationFailed, controllerHardwareModel=controllerHardwareModel, iscsiTargetIndex=iscsiTargetIndex, lunEntry=lunEntry, iscsiTargetAlias=iscsiTargetAlias, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, snapshotCloneCompleted=snapshotCloneCompleted, diagnosticDataUploaded=diagnosticDataUploaded, aclMigrationCompleted=aclMigrationCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, haResourcesTable=haResourcesTable, iscsiTargetsTable=iscsiTargetsTable, shareProjectName=shareProjectName, fcInitiatorEntry=fcInitiatorEntry, projectShareCount=projectShareCount, haControllerA_Name=haControllerA_Name, notifications=notifications, cacheTotalWriteIops=cacheTotalWriteIops, cpuInterrupts=cpuInterrupts, upgradeFailed=upgradeFailed, fcTargetReadIops=fcTargetReadIops, smisServiceStartFailed=smisServiceStartFailed, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, nicIndex=nicIndex, poolFreeSizeHigh=poolFreeSizeHigh, snapshotRollbackFailed=snapshotRollbackFailed, shareDataSizeHigh=shareDataSizeHigh, poolDataWriteMbps=poolDataWriteMbps, poolUsedSizeLow=poolUsedSizeLow, cacheTotalReadIops=cacheTotalReadIops, tegileArray_notifications=tegileArray_notifications, poolMetaWriteMbps=poolMetaWriteMbps, fcTotalWriteIops=fcTotalWriteIops, PYSNMP_MODULE_ID=tegile, poolTotalReadMbps=poolTotalReadMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, notificationReadingTriggerValue=notificationReadingTriggerValue, networkIpmpGroupUp=networkIpmpGroupUp, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectIndex=projectIndex, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTargetModifyCompleted=fcTargetModifyCompleted, currentObjectGroup=currentObjectGroup, lunSnapshotSizeHigh=lunSnapshotSizeHigh, notificationSeverity=notificationSeverity, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, controllerUp=controllerUp, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiWriteIops=iscsiWriteIops, notificationProps=notificationProps, volumeDeleteFailed=volumeDeleteFailed, fcInitiatorsTable=fcInitiatorsTable, shareQuotaLow=shareQuotaLow, projectShares=projectShares, shareReservedSizeHigh=shareReservedSizeHigh, deleteFolderCompleted=deleteFolderCompleted, notificationSensorSuspect=notificationSensorSuspect, iscsiTargetName=iscsiTargetName, tegileConformance=tegileConformance, upgradeDownloadStarted=upgradeDownloadStarted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunTable=lunTable, shareNFSWriteLatency=shareNFSWriteLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, disks=disks, poolMetaWriteLatency=poolMetaWriteLatency, iscsiTargetError=iscsiTargetError, nicTable=nicTable, poolUpgraded=poolUpgraded, poolCreated=poolCreated, iscsiTargetWriteMbps=iscsiTargetWriteMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, maintenanceModeEnabled=maintenanceModeEnabled, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskState=diskState, diskPoolName=diskPoolName, projectQuotaSizeLow=projectQuotaSizeLow, iscsiTotalReadMbps=iscsiTotalReadMbps, lunReservedSizeLow=lunReservedSizeLow, shareNFSWriteMbps=shareNFSWriteMbps, nfsTotalReadMbps=nfsTotalReadMbps, snapshotDeleteFailed=snapshotDeleteFailed, poolTable=poolTable, tegileGroups=tegileGroups, haResourceActiveNode=haResourceActiveNode, ipmiPowerSupply=ipmiPowerSupply, nfsTotalWriteMbps=nfsTotalWriteMbps, projectPoolName=projectPoolName, lunDedupEnabled=lunDedupEnabled, lunWriteIops=lunWriteIops, nfsTotalReadIops=nfsTotalReadIops, poolSizeLow=poolSizeLow, snapshotCloningFailed=snapshotCloningFailed, poolTotalWriteIops=poolTotalWriteIops, sharePoolName=sharePoolName, poolReadCacheWriteIops=poolReadCacheWriteIops, shareCIFSReadLatency=shareCIFSReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, adServerTimeDrift=adServerTimeDrift, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, notificationDescription=notificationDescription, shareReservedSizeLow=shareReservedSizeLow, networkTotalTransmitMbps=networkTotalTransmitMbps, lunFreeSizeHigh=lunFreeSizeHigh, projectDeletionFailed=projectDeletionFailed, networkInterfaceDown=networkInterfaceDown, notificationSensorAction=notificationSensorAction, diskEntry=diskEntry, haResourceName=haResourceName, projectDeleted=projectDeleted, iscsiInitiatorGroup=iscsiInitiatorGroup, nfsAvgReadLatency=nfsAvgReadLatency, cacheSSDReads=cacheSSDReads, smisServiceStarted=smisServiceStarted, haControllerB_Name=haControllerB_Name, poolAvgReadLatency=poolAvgReadLatency, poolDataReadIops=poolDataReadIops, fcInitiatorGroup=fcInitiatorGroup, shareNFSEnabled=shareNFSEnabled, diskDataWriteMbps=diskDataWriteMbps, haResourceEntry=haResourceEntry, properties=properties, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, iscsiTargetWriteIops=iscsiTargetWriteIops, fcTargets=fcTargets, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, upgradeCompleted=upgradeCompleted, projectDataSizeHigh=projectDataSizeHigh, upgradeDownloadCompleted=upgradeDownloadCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, shareCompressionEnabled=shareCompressionEnabled, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolTotalWriteMbps=poolTotalWriteMbps, upgradeStarted=upgradeStarted, lunSizeHigh=lunSizeHigh, shareNFSReadIops=shareNFSReadIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, diskAvgReadLatency=diskAvgReadLatency, lunDataSizeHigh=lunDataSizeHigh, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, tegileArray=tegileArray, basicCompliance=basicCompliance, replicationTargetDeleted=replicationTargetDeleted, controllerTimeDrift=controllerTimeDrift, poolFreeSizeLow=poolFreeSizeLow, fcTargetsTable=fcTargetsTable, haControllerB_IPAddr=haControllerB_IPAddr, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, diskTotalReadMbps=diskTotalReadMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectFreeSizeLow=projectFreeSizeLow, poolState=poolState, cacheTotalReadMbps=cacheTotalReadMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, diskSlowIo=diskSlowIo, shareCIFSWriteIops=shareCIFSWriteIops, poolSizeHigh=poolSizeHigh, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargetGroup=iscsiTargetGroup, shareNFSWriteIops=shareNFSWriteIops, poolReadCacheReadIops=poolReadCacheReadIops, shareEntry=shareEntry, ntpServerTimeDrift=ntpServerTimeDrift, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion)
