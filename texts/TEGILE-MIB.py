...
Counter32, ObjectIdentity, ModuleIdentity, Bits, Integer32, Unsigned32, Gauge32, IpAddress, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "ModuleIdentity", "Bits", "Integer32", "Unsigned32", "Gauge32", "IpAddress", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", ipmiFan=ipmiFan, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolTotalSaving=poolTotalSaving, network=network, targetGroupMemberRemoved=targetGroupMemberRemoved, projectSnapshotSizeHigh=projectSnapshotSizeHigh, snmpServiceStopped=snmpServiceStopped, controllerDown=controllerDown, upgradeDownloadStarted=upgradeDownloadStarted, notificationTime=notificationTime, nvdimmFailUnknownError=nvdimmFailUnknownError, nicReceiveMbps=nicReceiveMbps, fcAvgReadLatency=fcAvgReadLatency, iscsiTotalReadIops=iscsiTotalReadIops, diskDataReadMbps=diskDataReadMbps, nfsTotalReadMbps=nfsTotalReadMbps, notificationEventCode=notificationEventCode, iscsiTargetAlias=iscsiTargetAlias, fcTargets=fcTargets, shareCompressionEnabled=shareCompressionEnabled, snapshotRollbackFailed=snapshotRollbackFailed, iscsiInitiatorEntry=iscsiInitiatorEntry, fcTotalReadMbps=fcTotalReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, nvdimmFailSoftError=nvdimmFailSoftError, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiInitiatorName=iscsiInitiatorName, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolEntry=poolEntry, fcTargetModifyCompleted=fcTargetModifyCompleted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, cifsAvgWriteLatency=cifsAvgWriteLatency, haResourceGroup=haResourceGroup, snapshotCloningFailed=snapshotCloningFailed, cifsTotalReadMbps=cifsTotalReadMbps, networkInterfaceUp=networkInterfaceUp, shareEntry=shareEntry, fcInitiatorCreateFailed=fcInitiatorCreateFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolName=poolName, haResourceIndex=haResourceIndex, fcTargetGroup=fcTargetGroup, lunInitiatorGroup=lunInitiatorGroup, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolDataWriteIops=poolDataWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareNFSReadLatency=shareNFSReadLatency, ipmiTemperature=ipmiTemperature, snmpAgentVersion=snmpAgentVersion, ipmiVoltage=ipmiVoltage, poolMetaReadMbps=poolMetaReadMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, ipmiThreshold=ipmiThreshold, poolReadCacheReadLatency=poolReadCacheReadLatency, projectDeletionFailed=projectDeletionFailed, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, nfsAvgReadLatency=nfsAvgReadLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, lunPoolName=lunPoolName, haResourceActiveNode=haResourceActiveNode, controllerHardwareModel=controllerHardwareModel, projectLUNs=projectLUNs, diskSizeLow=diskSizeLow, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, diskSizeHigh=diskSizeHigh, poolFreeSizeLow=poolFreeSizeLow, shareProjectName=shareProjectName, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectShares=projectShares, shareNFSReadMbps=shareNFSReadMbps, upgradeTimeout=upgradeTimeout, diskAvgWriteLatency=diskAvgWriteLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, haResourceDescription=haResourceDescription, intelliFlashSoftwareDown=intelliFlashSoftwareDown, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiTargetIndex=iscsiTargetIndex, shareCompressedRatio=shareCompressedRatio, iscsiTargets=iscsiTargets, iscsiInitiators=iscsiInitiators, haControllerA_Uptime=haControllerA_Uptime, poolHealth=poolHealth, smisServiceStopFailed=smisServiceStopFailed, fcTargetWriteLatency=fcTargetWriteLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolFreeSizeHigh=poolFreeSizeHigh, adServerTimeDrift=adServerTimeDrift, initiatorGroupMemberAdded=initiatorGroupMemberAdded, nicMTU=nicMTU, fcInitiatorEntry=fcInitiatorEntry, poolDegraded=poolDegraded, poolReadCacheReadIops=poolReadCacheReadIops, shareDeletionFailed=shareDeletionFailed, iscsiTargetGroup=iscsiTargetGroup, projectName=projectName, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, notificationProps=notificationProps, lunReadMbps=lunReadMbps, poolOwnerController=poolOwnerController, haControllerA_Name=haControllerA_Name, lunSnapshotSizeLow=lunSnapshotSizeLow, deleteFolderFailed=deleteFolderFailed, fcInitiators=fcInitiators, memoryFailure=memoryFailure, iscsiTargetWriteMbps=iscsiTargetWriteMbps, shareCIFSEnabled=shareCIFSEnabled, userLoginFailed=userLoginFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, projectShareCount=projectShareCount, replicationPaused=replicationPaused, haControllerA_IPAddr=haControllerA_IPAddr, iscsiTotalReadMbps=iscsiTotalReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, fcTargetsTable=fcTargetsTable, snmpServiceStartFailed=snmpServiceStartFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, nicGroup=nicGroup, shareQuotaHigh=shareQuotaHigh, shareCIFSReadIops=shareCIFSReadIops, fcInitiatorGroup=fcInitiatorGroup, shareTable=shareTable, diagnosticDataUploaded=diagnosticDataUploaded, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectQuotaSizeHigh=projectQuotaSizeHigh, snmpServiceStarted=snmpServiceStarted, notificationReadingUnit=notificationReadingUnit, projectQuotaSizeLow=projectQuotaSizeLow, shareIndex=shareIndex, tegileConformance=tegileConformance, maintenanceModeDisabled=maintenanceModeDisabled, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectTotalSaving=projectTotalSaving, controllerUp=controllerUp, poolMetaReadLatency=poolMetaReadLatency, snmpServiceStopFailed=snmpServiceStopFailed, lunReservedSizeLow=lunReservedSizeLow, fcInitiatorIndex=fcInitiatorIndex, volumeDeleteFailed=volumeDeleteFailed, diskIsOnline=diskIsOnline, tegileArray=tegileArray, fcTotalWriteIops=fcTotalWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, ipmiOther=ipmiOther, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunWriteIops=lunWriteIops, cacheTotalReadIops=cacheTotalReadIops, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, fcTargetIndex=fcTargetIndex, projectDataSizeLow=projectDataSizeLow, nicIndex=nicIndex, iscsiTargetWriteIops=iscsiTargetWriteIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, haResourceEntry=haResourceEntry, poolExported=poolExported, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, nicName=nicName, maintenanceModeEnabled=maintenanceModeEnabled, iscsiAvgReadLatency=iscsiAvgReadLatency, poolDataReadLatency=poolDataReadLatency, poolMetaWriteLatency=poolMetaWriteLatency, projectDeleted=projectDeleted, iscsiTargetError=iscsiTargetError, controllerTimeDrift=controllerTimeDrift, poolProjects=poolProjects, fcTargetWriteIops=fcTargetWriteIops, fcInitiatorsTable=fcInitiatorsTable, projectDataSizeHigh=projectDataSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, PYSNMP_MODULE_ID=tegile, poolUsedSizeHigh=poolUsedSizeHigh, lunProjectName=lunProjectName, shareSnapshotSizeLow=shareSnapshotSizeLow, lunReadLatency=lunReadLatency, shareDataSizeHigh=shareDataSizeHigh, poolSizeLow=poolSizeLow, iscsiTotalWriteMbps=iscsiTotalWriteMbps, replicationAbandoned=replicationAbandoned, sanProperties=sanProperties, webdocsUpgradeFailed=webdocsUpgradeFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, tegileGroups=tegileGroups, cacheTotalWriteMbps=cacheTotalWriteMbps, projectQuotaFinished=projectQuotaFinished, tdpsUpgradeCompleted=tdpsUpgradeCompleted, fcTargetName=fcTargetName, vmwareNFSDatastores=vmwareNFSDatastores, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, targetGroupDeleteCompleted=targetGroupDeleteCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, diskEntry=diskEntry, notificationReadingTriggerValue=notificationReadingTriggerValue, testNotification=testNotification, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskTable=diskTable, lunDedupEnabled=lunDedupEnabled, cifsTotalWriteIops=cifsTotalWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, diskCount=diskCount, projectSnapshotSizeLow=projectSnapshotSizeLow, nicTransmitMbps=nicTransmitMbps, poolImported=poolImported, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskDataReadIops=diskDataReadIops, shareCIFSReadLatency=shareCIFSReadLatency, projectPoolName=projectPoolName, replicationSourceRegistered=replicationSourceRegistered, haResourceStatus=haResourceStatus, tdpsUpgradeTimeout=tdpsUpgradeTimeout, haResources=haResources, smisServiceStarted=smisServiceStarted, currentNotificationGroup=currentNotificationGroup, cifsTotalWriteMbps=cifsTotalWriteMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, replicationAborted=replicationAborted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, cpuTotalUsage=cpuTotalUsage, poolTable=poolTable, nfsTotalWriteIops=nfsTotalWriteIops, cpuInterrupts=cpuInterrupts, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, snapshotDeleteFailed=snapshotDeleteFailed, haControllerB_Uptime=haControllerB_Uptime, fcTargetStatus=fcTargetStatus, shareNFSWriteIops=shareNFSWriteIops, poolQuotaFinished=poolQuotaFinished, nicTable=nicTable, notificationSeverity=notificationSeverity, haControllerB_Name=haControllerB_Name, upgradeStarted=upgradeStarted, diskIOCount=diskIOCount, diskRandomIOCount=diskRandomIOCount, diskGoneOffline=diskGoneOffline, fcTargetEntry=fcTargetEntry, poolSizeHigh=poolSizeHigh, notificationComponentName=notificationComponentName, volumeDeleteCompleted=volumeDeleteCompleted, notificationDescription=notificationDescription, diskTotalWriteMbps=diskTotalWriteMbps, poolMetaWriteMbps=poolMetaWriteMbps, poolCreated=poolCreated, shareNFSReadIops=shareNFSReadIops)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetReadLatency=iscsiTargetReadLatency, lunDataSizeLow=lunDataSizeLow, networkTotalReceiveMbps=networkTotalReceiveMbps, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareNFSWriteLatency=shareNFSWriteLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, shareCIFSReadMbps=shareCIFSReadMbps, notificationSensorAction=notificationSensorAction, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, snapshotCreationFailed=snapshotCreationFailed, smisServiceStopped=smisServiceStopped, tegileArray_notifications=tegileArray_notifications, iscsiTargetReadIops=iscsiTargetReadIops, networkInterfaceDown=networkInterfaceDown, currentObjectGroup=currentObjectGroup, shareReservedSizeHigh=shareReservedSizeHigh, lunIndex=lunIndex, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, upgradeFailed=upgradeFailed, lunReadIops=lunReadIops, poolDataReadMbps=poolDataReadMbps, lunProtocol=lunProtocol, shareName=shareName, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, haControllerB_IPAddr=haControllerB_IPAddr, webdocsUpgradeCompleted=webdocsUpgradeCompleted, disks=disks, lunGUID=lunGUID, alertsCleanupCompleted=alertsCleanupCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, cacheRAMReads=cacheRAMReads, notifications=notifications, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTargetsTable=iscsiTargetsTable, projectLunCount=projectLunCount, lunFreeSizeHigh=lunFreeSizeHigh, poolDeleted=poolDeleted, cifsAvgReadLatency=cifsAvgReadLatency, replicationStarted=replicationStarted, fcTargetReadIops=fcTargetReadIops, nfsTotalReadIops=nfsTotalReadIops, aclMigrationCompleted=aclMigrationCompleted, nicEntry=nicEntry, snapshotRollbackCompleted=snapshotRollbackCompleted, fcAvgWriteLatency=fcAvgWriteLatency, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, targetGroupMemberAdded=targetGroupMemberAdded, properties=properties, fcTargetWriteMbps=fcTargetWriteMbps, fcTargetReadMbps=fcTargetReadMbps, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, globalStatistics=globalStatistics, replicationComplete=replicationComplete, shareQuotaLow=shareQuotaLow, upgradeCompleted=upgradeCompleted, fcTargetReadLatency=fcTargetReadLatency, sensorFailureEvent=sensorFailureEvent, nicState=nicState, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunFreeSizeLow=lunFreeSizeLow, lunWriteLatency=lunWriteLatency, shareCIFSWriteIops=shareCIFSWriteIops, iscsiInitiatorChapUser=iscsiInitiatorChapUser, iscsiProperties=iscsiProperties, diskChassisIdx=diskChassisIdx, shareExceedThresholdWarning=shareExceedThresholdWarning, lunSizeHigh=lunSizeHigh, lunCompressionEnabled=lunCompressionEnabled, iscsiTargetReadMbps=iscsiTargetReadMbps, volumeQuotaFinished=volumeQuotaFinished, poolCount=poolCount, iscsiWriteIops=iscsiWriteIops, lunWriteMbps=lunWriteMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, poolTotalReadMbps=poolTotalReadMbps, cpuSystemCalls=cpuSystemCalls, projectFreeSizeHigh=projectFreeSizeHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, projectFreeSizeLow=projectFreeSizeLow, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiInitiatorGroup=iscsiInitiatorGroup, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, notificationSensorNumber=notificationSensorNumber, ntpServerTimeDrift=ntpServerTimeDrift, poolAvgReadLatency=poolAvgReadLatency, volumeModifyCompleted=volumeModifyCompleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, diskTotalReadIops=diskTotalReadIops, poolIndex=poolIndex, iscsiTargetName=iscsiTargetName, projectCreatedSuccessfully=projectCreatedSuccessfully, lunDataSizeHigh=lunDataSizeHigh, lunCompressedRatio=lunCompressedRatio, iscsiTargetEntry=iscsiTargetEntry, diskTotalWriteIops=diskTotalWriteIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, shareNFSWriteMbps=shareNFSWriteMbps, cacheTotalWriteIops=cacheTotalWriteIops, diskDataWriteIops=diskDataWriteIops, poolDataReadIops=poolDataReadIops, diskState=diskState, cifsTotalReadIops=cifsTotalReadIops, ipmiMemory=ipmiMemory, tegileCompliances=tegileCompliances, iscsiTargetAuth=iscsiTargetAuth, projectCompressionEnabled=projectCompressionEnabled, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcPortOffline=fcPortOffline, pools=pools, poolDataSizeHigh=poolDataSizeHigh, projectModified=projectModified, lunSizeLow=lunSizeLow, iscsiAvgWriteLatency=iscsiAvgWriteLatency, cacheTotalReadMbps=cacheTotalReadMbps, netbiosSocketFailure=netbiosSocketFailure, shareQuotaFinished=shareQuotaFinished, iscsiInitiatorsTable=iscsiInitiatorsTable, aclMigrationStarted=aclMigrationStarted, poolDataSizeLow=poolDataSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, lunName=lunName, poolAvgWriteLatency=poolAvgWriteLatency, diskAlias=diskAlias, diskAvgReadLatency=diskAvgReadLatency, cacheSSDReads=cacheSSDReads, notificationThresholdTriggerValue=notificationThresholdTriggerValue, networkIpmpGroupDown=networkIpmpGroupDown, deleteFolderCompleted=deleteFolderCompleted, diskIndex=diskIndex, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, replicationTargetDeleted=replicationTargetDeleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunBlockSize=lunBlockSize, spareDiskReplaced=spareDiskReplaced, lunEntry=lunEntry, diskType=diskType, replicationResumed=replicationResumed, poolMetaReadIops=poolMetaReadIops, diskSequentialIOCount=diskSequentialIOCount, nfsTotalWriteMbps=nfsTotalWriteMbps, shareDedupEnabled=shareDedupEnabled, diskTotalReadMbps=diskTotalReadMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, lunTable=lunTable, poolUpgraded=poolUpgraded, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskPoolName=diskPoolName, lunReservedSizeHigh=lunReservedSizeHigh, poolDeletionFailed=poolDeletionFailed, shareMountPoint=shareMountPoint, projectEntry=projectEntry, notificationTargetEntityName=notificationTargetEntityName, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, haResourcesTable=haResourcesTable, notificationObjects=notificationObjects, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareNFSEnabled=shareNFSEnabled, poolProjectCount=poolProjectCount, smbSocketFailure=smbSocketFailure, shareDeleted=shareDeleted, tegile=tegile, fcTotalWriteMbps=fcTotalWriteMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolMetaWriteIops=poolMetaWriteIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, fcTotalReadIops=fcTotalReadIops, ipmiCurrent=ipmiCurrent, fcInitiatorName=fcInitiatorName, poolTotalWriteIops=poolTotalWriteIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcPortOnline=fcPortOnline, smisServiceStartFailed=smisServiceStartFailed, diskDataWriteMbps=diskDataWriteMbps, projectDedupEnabled=projectDedupEnabled, snapshotCloneCompleted=snapshotCloneCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareReservedSizeLow=shareReservedSizeLow, shareDataSizeLow=shareDataSizeLow, lunTargetGroup=lunTargetGroup, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolDataWriteMbps=poolDataWriteMbps, poolUsedSizeLow=poolUsedSizeLow, shareCreatedSuccessfully=shareCreatedSuccessfully, networkIpmpGroupUp=networkIpmpGroupUp, upgradeDownloadFailed=upgradeDownloadFailed, unknownSensorEvent=unknownSensorEvent, basicCompliance=basicCompliance, poolDataWriteLatency=poolDataWriteLatency, projectIndex=projectIndex, poolTotalReadIops=poolTotalReadIops, haResourceName=haResourceName, diskError=diskError, networkTotalTransmitMbps=networkTotalTransmitMbps, sharePoolName=sharePoolName, notificationSensorSuspect=notificationSensorSuspect, poolState=poolState, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectTable=projectTable, ipmiPowerSupply=ipmiPowerSupply, poolTotalWriteMbps=poolTotalWriteMbps, replicationFailed=replicationFailed, diskSlowIo=diskSlowIo, fcProperties=fcProperties, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolExpanded=poolExpanded)
