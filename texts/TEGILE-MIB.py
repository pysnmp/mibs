...
# Produced by pysmi-1.1.3 at Sat Nov 20 16:56:43 2021
...
ModuleIdentity, MibIdentifier, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, IpAddress, ObjectIdentity, Counter32, NotificationType, TimeTicks, iso, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "IpAddress", "ObjectIdentity", "Counter32", "NotificationType", "TimeTicks", "iso", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolTotalSaving=poolTotalSaving, memoryFailure=memoryFailure, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareNFSReadMbps=shareNFSReadMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, iscsiTargets=iscsiTargets, shareNFSWriteLatency=shareNFSWriteLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, lunCompressionEnabled=lunCompressionEnabled, haResourceActiveNode=haResourceActiveNode, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, volumeDeleteCompleted=volumeDeleteCompleted, cpuSystemCalls=cpuSystemCalls, upgradeStarted=upgradeStarted, nvdimmFailSoftError=nvdimmFailSoftError, shareTable=shareTable, aclMigrationCompleted=aclMigrationCompleted, upgradeDownloadFailed=upgradeDownloadFailed, diskType=diskType, diskSequentialIOCount=diskSequentialIOCount, deleteFolderFailed=deleteFolderFailed, vmwareNFSDatastores=vmwareNFSDatastores, fcTargetWriteMbps=fcTargetWriteMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolMetaWriteMbps=poolMetaWriteMbps, lunWriteLatency=lunWriteLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolHealth=poolHealth, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolReadCacheReadIops=poolReadCacheReadIops, netbiosSocketFailure=netbiosSocketFailure, ipmiPowerSupply=ipmiPowerSupply, iscsiTargetIndex=iscsiTargetIndex, fcTargetModifyCompleted=fcTargetModifyCompleted, cacheTotalReadMbps=cacheTotalReadMbps, controllerUp=controllerUp, intelliFlashSoftwareUp=intelliFlashSoftwareUp, snmpServiceStartFailed=snmpServiceStartFailed, nfsAvgWriteLatency=nfsAvgWriteLatency, sanProperties=sanProperties, projectTable=projectTable, fcInitiatorEntry=fcInitiatorEntry, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolEntry=poolEntry, lunCompressedRatio=lunCompressedRatio, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, nicIndex=nicIndex, iscsiTargetError=iscsiTargetError, diskSizeLow=diskSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, diskDataWriteIops=diskDataWriteIops, diskTotalReadIops=diskTotalReadIops, spareDiskReplaced=spareDiskReplaced, aclMigrationStarted=aclMigrationStarted, cacheSSDReads=cacheSSDReads, lunReadMbps=lunReadMbps, controllerDown=controllerDown, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, volumeDeleteFailed=volumeDeleteFailed, lunDataSizeHigh=lunDataSizeHigh, PYSNMP_MODULE_ID=tegile, deleteFolderCompleted=deleteFolderCompleted, shareReservedSizeHigh=shareReservedSizeHigh, fcPortOnline=fcPortOnline, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, notificationTargetEntityName=notificationTargetEntityName, shareExceedThresholdWarning=shareExceedThresholdWarning, projectSnapshotSizeLow=projectSnapshotSizeLow, fcInitiators=fcInitiators, shareDedupEnabled=shareDedupEnabled, cpuInterrupts=cpuInterrupts, haResourceStatus=haResourceStatus, projectDedupEnabled=projectDedupEnabled, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcAvgReadLatency=fcAvgReadLatency, poolDataWriteMbps=poolDataWriteMbps, snmpAgentVersion=snmpAgentVersion, iscsiTargetsTable=iscsiTargetsTable, nicReceiveMbps=nicReceiveMbps, userLoginFailed=userLoginFailed, diskChassisIdx=diskChassisIdx, projectCompressionEnabled=projectCompressionEnabled, nvdimmFailInitializationError=nvdimmFailInitializationError, projectIndex=projectIndex, fcInitiatorName=fcInitiatorName, snapshotDeleteFailed=snapshotDeleteFailed, diskEntry=diskEntry, currentObjectGroup=currentObjectGroup, poolQuotaFinished=poolQuotaFinished, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectQuotaSizeLow=projectQuotaSizeLow, cifsTotalWriteMbps=cifsTotalWriteMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, diskPoolName=diskPoolName, haControllerB_Uptime=haControllerB_Uptime, poolState=poolState, diskState=diskState, alertsCleanupCompleted=alertsCleanupCompleted, iscsiTargetName=iscsiTargetName, upgradeDownloadStarted=upgradeDownloadStarted, lunInitiatorGroup=lunInitiatorGroup, poolIndex=poolIndex, iscsiInitiatorEntry=iscsiInitiatorEntry, snapshotRollbackCompleted=snapshotRollbackCompleted, smbSocketFailure=smbSocketFailure, projectDataSizeLow=projectDataSizeLow, sharePoolName=sharePoolName, cacheTotalWriteMbps=cacheTotalWriteMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, snapshotCloningFailed=snapshotCloningFailed, ipmiVoltage=ipmiVoltage, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, notificationSeverity=notificationSeverity, lunDedupEnabled=lunDedupEnabled, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskIOCount=diskIOCount, poolMetaReadMbps=poolMetaReadMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunIndex=lunIndex, projectQuotaSizeHigh=projectQuotaSizeHigh, pools=pools, replicationStarted=replicationStarted, lunName=lunName, cacheTotalReadIops=cacheTotalReadIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareProjectName=shareProjectName, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolDataSizeLow=poolDataSizeLow, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, shareQuotaFinished=shareQuotaFinished, fcTargets=fcTargets, nfsTotalWriteIops=nfsTotalWriteIops, poolTotalWriteMbps=poolTotalWriteMbps, ntpServerTimeDrift=ntpServerTimeDrift, fcTargetStatus=fcTargetStatus, poolDataSizeHigh=poolDataSizeHigh, haControllerB_Name=haControllerB_Name, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectFreeSizeHigh=projectFreeSizeHigh, iscsiInitiatorGroup=iscsiInitiatorGroup, poolMetaReadLatency=poolMetaReadLatency, poolMetaWriteLatency=poolMetaWriteLatency, snmpServiceStarted=snmpServiceStarted, iscsiTargetReadMbps=iscsiTargetReadMbps, lunProtocol=lunProtocol, poolTotalReadMbps=poolTotalReadMbps, diskDataReadIops=diskDataReadIops, fcInitiatorIndex=fcInitiatorIndex, haResourceEntry=haResourceEntry, nfsAvgReadLatency=nfsAvgReadLatency, cifsAvgReadLatency=cifsAvgReadLatency, snapshotRollbackFailed=snapshotRollbackFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolReadCacheReadLatency=poolReadCacheReadLatency, tegile=tegile, iscsiTotalReadIops=iscsiTotalReadIops, shareCompressionEnabled=shareCompressionEnabled, fcTotalWriteMbps=fcTotalWriteMbps, projectFreeSizeLow=projectFreeSizeLow, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolFreeSizeHigh=poolFreeSizeHigh, currentNotificationGroup=currentNotificationGroup, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, notificationProps=notificationProps, poolAvgReadLatency=poolAvgReadLatency, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareDataSizeLow=shareDataSizeLow, haResourceIndex=haResourceIndex, replicationAborted=replicationAborted, haResourceName=haResourceName, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolName=poolName, fcTargetWriteIops=fcTargetWriteIops, diskAvgReadLatency=diskAvgReadLatency, shareQuotaLow=shareQuotaLow, controllerHardwareModel=controllerHardwareModel, webdocsUpgradeCompleted=webdocsUpgradeCompleted, notificationTime=notificationTime, notificationSensorSuspect=notificationSensorSuspect, networkIpmpGroupUp=networkIpmpGroupUp, poolMetaReadIops=poolMetaReadIops, adServerTimeDrift=adServerTimeDrift, smisServiceStopped=smisServiceStopped, poolImported=poolImported, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, haResources=haResources, maintenanceModeEnabled=maintenanceModeEnabled, nicEntry=nicEntry, poolFreeSizeLow=poolFreeSizeLow, networkInterfaceDown=networkInterfaceDown, shareDataSizeHigh=shareDataSizeHigh, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolCount=poolCount, nicName=nicName, smisServiceStopFailed=smisServiceStopFailed, shareCompressedRatio=shareCompressedRatio, projectShares=projectShares, poolReadCacheWriteIops=poolReadCacheWriteIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, ipmiMemory=ipmiMemory, haControllerA_Name=haControllerA_Name, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectCreatedSuccessfully=projectCreatedSuccessfully, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectModified=projectModified, shareDeleted=shareDeleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, fcTargetReadMbps=fcTargetReadMbps, properties=properties, poolOwnerController=poolOwnerController, fcTargetWriteLatency=fcTargetWriteLatency, networkTotalReceiveMbps=networkTotalReceiveMbps, replicationAbandoned=replicationAbandoned, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunReadIops=lunReadIops, shareCIFSReadIops=shareCIFSReadIops, lunReservedSizeHigh=lunReservedSizeHigh, fcTotalReadMbps=fcTotalReadMbps, ipmiFan=ipmiFan, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareIndex=shareIndex, poolDataReadLatency=poolDataReadLatency, tegileArray_notifications=tegileArray_notifications, cifsTotalWriteIops=cifsTotalWriteIops, snmpServiceStopFailed=snmpServiceStopFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskIndex=diskIndex, poolDegraded=poolDegraded, nfsTotalReadIops=nfsTotalReadIops, diskTotalReadMbps=diskTotalReadMbps, poolDeleted=poolDeleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolProjects=poolProjects, shareNFSWriteMbps=shareNFSWriteMbps, lunFreeSizeHigh=lunFreeSizeHigh, projectShareCount=projectShareCount, poolReadCacheWriteMbps=poolReadCacheWriteMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, poolTotalWriteIops=poolTotalWriteIops, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiTargetGroup=iscsiTargetGroup)
mibBuilder.exportSymbols("TEGILE-MIB", diskSlowIo=diskSlowIo, fcInitiatorsTable=fcInitiatorsTable, basicCompliance=basicCompliance, cpuTotalUsage=cpuTotalUsage, poolReadCacheWriteLatency=poolReadCacheWriteLatency, notificationReadingUnit=notificationReadingUnit, controllerTimeDrift=controllerTimeDrift, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolCreated=poolCreated, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, haResourcesTable=haResourcesTable, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, shareCIFSReadLatency=shareCIFSReadLatency, diskCount=diskCount, shareEntry=shareEntry, notificationObjects=notificationObjects, haControllerB_IPAddr=haControllerB_IPAddr, diskAvgWriteLatency=diskAvgWriteLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, tegileGroups=tegileGroups, diskTotalWriteMbps=diskTotalWriteMbps, network=network, projectQuotaFinished=projectQuotaFinished, upgradeFailed=upgradeFailed, shareCIFSWriteIops=shareCIFSWriteIops, upgradeTimeout=upgradeTimeout, snapshotCloneCompleted=snapshotCloneCompleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, diagnosticDataUploaded=diagnosticDataUploaded, nvdimmFailUnknownError=nvdimmFailUnknownError, diskError=diskError, lunProjectName=lunProjectName, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, snmpServiceStopped=snmpServiceStopped, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, lunWriteIops=lunWriteIops, iscsiInitiatorsTable=iscsiInitiatorsTable, shareCIFSWriteLatency=shareCIFSWriteLatency, poolDataWriteLatency=poolDataWriteLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, nfsTotalWriteMbps=nfsTotalWriteMbps, notificationSensorAction=notificationSensorAction, fcTargetGroup=fcTargetGroup, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectDataSizeHigh=projectDataSizeHigh, iscsiInitiatorName=iscsiInitiatorName, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiWriteIops=iscsiWriteIops, poolSizeHigh=poolSizeHigh, projectDeleted=projectDeleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, lunEntry=lunEntry, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunWriteMbps=lunWriteMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, fcInitiatorGroup=fcInitiatorGroup, replicationResumed=replicationResumed, projectEntry=projectEntry, iscsiTargetEntry=iscsiTargetEntry, fcTargetReadLatency=fcTargetReadLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, diskAlias=diskAlias, volumeCreatedSuccessfully=volumeCreatedSuccessfully, nicGroup=nicGroup, volumeQuotaFinished=volumeQuotaFinished, snapshotCreationFailed=snapshotCreationFailed, ipmiCurrent=ipmiCurrent, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, nicTable=nicTable, networkIpmpGroupDown=networkIpmpGroupDown, unknownSensorEvent=unknownSensorEvent, shareNFSReadLatency=shareNFSReadLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, diskTotalWriteIops=diskTotalWriteIops, lunBlockSize=lunBlockSize, projectDeletionFailed=projectDeletionFailed, lunTargetGroup=lunTargetGroup, tegileConformance=tegileConformance, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectLUNs=projectLUNs, poolMetaWriteIops=poolMetaWriteIops, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, disks=disks, cacheTotalWriteIops=cacheTotalWriteIops, fcTargetEntry=fcTargetEntry, poolDataReadIops=poolDataReadIops, poolUsedSizeLow=poolUsedSizeLow, lunPoolName=lunPoolName, iscsiTargetReadLatency=iscsiTargetReadLatency, replicationTargetDeleted=replicationTargetDeleted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolUsedSizeHigh=poolUsedSizeHigh, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, upgradeCompleted=upgradeCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, tegileArray=tegileArray, lunSizeHigh=lunSizeHigh, fcAvgWriteLatency=fcAvgWriteLatency, diskTable=diskTable, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, replicationPaused=replicationPaused, fcTargetIndex=fcTargetIndex, diskRandomIOCount=diskRandomIOCount, poolUpgraded=poolUpgraded, sensorFailureEvent=sensorFailureEvent, projectName=projectName, lunFreeSizeLow=lunFreeSizeLow, projectPoolName=projectPoolName, poolAvgWriteLatency=poolAvgWriteLatency, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, ipmiThreshold=ipmiThreshold, notificationSensorNumber=notificationSensorNumber, shareNFSReadIops=shareNFSReadIops, globalStatistics=globalStatistics, shareQuotaHigh=shareQuotaHigh, notifications=notifications, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, nicMTU=nicMTU, iscsiTargetAuth=iscsiTargetAuth, shareMountPoint=shareMountPoint, lunReservedSizeLow=lunReservedSizeLow, lunTable=lunTable, fcProperties=fcProperties, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, ipmiOther=ipmiOther, shareName=shareName, targetGroupMemberAdded=targetGroupMemberAdded, fcTotalWriteIops=fcTotalWriteIops, cifsTotalReadMbps=cifsTotalReadMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, poolSizeLow=poolSizeLow, haControllerA_Uptime=haControllerA_Uptime, cifsAvgWriteLatency=cifsAvgWriteLatency, volumeModifyCompleted=volumeModifyCompleted, lunDataSizeLow=lunDataSizeLow, nfsTotalReadMbps=nfsTotalReadMbps, fcTargetReadIops=fcTargetReadIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, projectTotalSaving=projectTotalSaving, haControllerA_IPAddr=haControllerA_IPAddr, lunReadLatency=lunReadLatency, fcTotalReadIops=fcTotalReadIops, poolReadCacheReadMbps=poolReadCacheReadMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, cacheRAMReads=cacheRAMReads, iscsiTotalReadMbps=iscsiTotalReadMbps, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiTargetAlias=iscsiTargetAlias, diskGoneOffline=diskGoneOffline, iscsiTargetWriteMbps=iscsiTargetWriteMbps, replicationComplete=replicationComplete, diskIsOnline=diskIsOnline, tdpsUpgradeTimeout=tdpsUpgradeTimeout, projectLunCount=projectLunCount, notificationComponentName=notificationComponentName, maintenanceModeDisabled=maintenanceModeDisabled, notificationEventCode=notificationEventCode, shareCreatedSuccessfully=shareCreatedSuccessfully, ipmiTemperature=ipmiTemperature, poolDeletionFailed=poolDeletionFailed, poolDataReadMbps=poolDataReadMbps, shareCIFSEnabled=shareCIFSEnabled, lunGUID=lunGUID, replicationFailed=replicationFailed, haResourceGroup=haResourceGroup, poolExpanded=poolExpanded, shareCIFSReadMbps=shareCIFSReadMbps, notificationDescription=notificationDescription, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareDeletionFailed=shareDeletionFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diskSizeHigh=diskSizeHigh, smisServiceStartFailed=smisServiceStartFailed, upgradeDownloadCompleted=upgradeDownloadCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, nicState=nicState, poolExported=poolExported, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diskDataReadMbps=diskDataReadMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiTargetReadIops=iscsiTargetReadIops, tegileCompliances=tegileCompliances, shareReservedSizeLow=shareReservedSizeLow, poolTotalReadIops=poolTotalReadIops, iscsiProperties=iscsiProperties, iscsiTargetGroupError=iscsiTargetGroupError, shareNFSWriteIops=shareNFSWriteIops, haResourceDescription=haResourceDescription, fcTargetsTable=fcTargetsTable, poolDataWriteIops=poolDataWriteIops, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiInitiators=iscsiInitiators, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, testNotification=testNotification, targetGroupMemberRemoved=targetGroupMemberRemoved, fcTargetName=fcTargetName, smisServiceStarted=smisServiceStarted, iscsiTargetWriteIops=iscsiTargetWriteIops, fcPortOffline=fcPortOffline, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, diskDataWriteMbps=diskDataWriteMbps, cifsTotalReadIops=cifsTotalReadIops, networkInterfaceUp=networkInterfaceUp, poolTable=poolTable, shareNFSEnabled=shareNFSEnabled, nicTransmitMbps=nicTransmitMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, lunSizeLow=lunSizeLow, poolProjectCount=poolProjectCount, replicationSourceRegistered=replicationSourceRegistered)
