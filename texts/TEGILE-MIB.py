...
Unsigned32, NotificationType, iso, TimeTicks, ObjectIdentity, Counter32, Integer32, Gauge32, IpAddress, ModuleIdentity, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "iso", "TimeTicks", "ObjectIdentity", "Counter32", "Integer32", "Gauge32", "IpAddress", "ModuleIdentity", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", adServerTimeDrift=adServerTimeDrift, tdpsUpgradeTimeout=tdpsUpgradeTimeout, upgradeDownloadFailed=upgradeDownloadFailed, lunReadIops=lunReadIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcTargetReadMbps=fcTargetReadMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunInitiatorGroup=lunInitiatorGroup, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiTargetGroupError=iscsiTargetGroupError, fcInitiatorIndex=fcInitiatorIndex, replicationPaused=replicationPaused, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, fcTargetsTable=fcTargetsTable, diagnosticDataUploaded=diagnosticDataUploaded, ipmiMemory=ipmiMemory, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, replicationAborted=replicationAborted, poolSizeHigh=poolSizeHigh, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, cpuSystemCalls=cpuSystemCalls, fcTargets=fcTargets, poolProjectCount=poolProjectCount, fcTargetGroup=fcTargetGroup, fcInitiatorName=fcInitiatorName, lunReadMbps=lunReadMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, nvdimmFailSoftError=nvdimmFailSoftError, poolProjects=poolProjects, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, haControllerB_Uptime=haControllerB_Uptime, fcTargetName=fcTargetName, diskIOCount=diskIOCount, testNotification=testNotification, diskSlowIo=diskSlowIo, poolDataWriteLatency=poolDataWriteLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, currentNotificationGroup=currentNotificationGroup, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, diskDataReadMbps=diskDataReadMbps, lunFreeSizeLow=lunFreeSizeLow, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunWriteMbps=lunWriteMbps, diskTable=diskTable, sharePoolName=sharePoolName, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolDataWriteMbps=poolDataWriteMbps, projectDataSizeLow=projectDataSizeLow, volumeQuotaFinished=volumeQuotaFinished, lunSizeLow=lunSizeLow, disks=disks, diskEntry=diskEntry, cacheTotalReadIops=cacheTotalReadIops, shareDataSizeLow=shareDataSizeLow, projectDeleted=projectDeleted, snapshotCloneCompleted=snapshotCloneCompleted, shareCIFSWriteMbps=shareCIFSWriteMbps, shareProjectName=shareProjectName, lunTable=lunTable, iscsiTargetName=iscsiTargetName, iscsiTargetReadLatency=iscsiTargetReadLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcTargetWriteMbps=fcTargetWriteMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, shareQuotaFinished=shareQuotaFinished, projectTotalSaving=projectTotalSaving, shareIndex=shareIndex, haResourceGroup=haResourceGroup, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectFreeSizeHigh=projectFreeSizeHigh, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcAvgWriteLatency=fcAvgWriteLatency, iscsiTargetEntry=iscsiTargetEntry, shareNFSReadMbps=shareNFSReadMbps, shareDeleted=shareDeleted, snmpServiceStarted=snmpServiceStarted, notificationReadingTriggerValue=notificationReadingTriggerValue, poolReadCacheReadIops=poolReadCacheReadIops, shareSnapshotSizeLow=shareSnapshotSizeLow, shareCIFSReadIops=shareCIFSReadIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, replicationAbandoned=replicationAbandoned, lunTargetGroup=lunTargetGroup, iscsiTargetReadIops=iscsiTargetReadIops, iscsiTargetWriteIops=iscsiTargetWriteIops, spareDiskReplaced=spareDiskReplaced, poolName=poolName, iscsiInitiators=iscsiInitiators, webdocsUpgradeFailed=webdocsUpgradeFailed, poolUpgraded=poolUpgraded, projectDeletionFailed=projectDeletionFailed, nvdimmFailInitializationError=nvdimmFailInitializationError, lunEntry=lunEntry, replicationStarted=replicationStarted, nfsAvgReadLatency=nfsAvgReadLatency, poolExpanded=poolExpanded, diskIndex=diskIndex, snapshotRollbackFailed=snapshotRollbackFailed, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcTargetIndex=fcTargetIndex, poolReadCacheWriteIops=poolReadCacheWriteIops, poolDataReadLatency=poolDataReadLatency, diskSequentialIOCount=diskSequentialIOCount, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolReadCacheReadLatency=poolReadCacheReadLatency, poolDataSizeHigh=poolDataSizeHigh, replicationFailed=replicationFailed, shareTable=shareTable, projectSnapshotSizeHigh=projectSnapshotSizeHigh, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diskType=diskType, cacheTotalWriteMbps=cacheTotalWriteMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, lunProjectName=lunProjectName, ntpServerTimeDrift=ntpServerTimeDrift, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, aclMigrationStarted=aclMigrationStarted, diskAvgWriteLatency=diskAvgWriteLatency, diskGoneOffline=diskGoneOffline, shareExceedThresholdWarning=shareExceedThresholdWarning, sanProperties=sanProperties, diskPoolName=diskPoolName, poolMetaWriteMbps=poolMetaWriteMbps, fcTargetStatus=fcTargetStatus, shareCIFSReadLatency=shareCIFSReadLatency, poolImported=poolImported, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, cifsAvgReadLatency=cifsAvgReadLatency, properties=properties, controllerUp=controllerUp, iscsiInitiatorsTable=iscsiInitiatorsTable, shareDedupEnabled=shareDedupEnabled, notificationEventCode=notificationEventCode, projectName=projectName, diskAvgReadLatency=diskAvgReadLatency, netbiosSocketFailure=netbiosSocketFailure, ipmiVoltage=ipmiVoltage, networkInterfaceDown=networkInterfaceDown, shareCIFSEnabled=shareCIFSEnabled, lunSizeHigh=lunSizeHigh, iscsiWriteIops=iscsiWriteIops, shareCIFSReadMbps=shareCIFSReadMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, diskSizeLow=diskSizeLow, haResources=haResources, iscsiInitiatorChapUser=iscsiInitiatorChapUser, haResourceStatus=haResourceStatus, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diskError=diskError, projectModified=projectModified, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, cifsAvgWriteLatency=cifsAvgWriteLatency, snmpServiceStopFailed=snmpServiceStopFailed, projectIndex=projectIndex, upgradeStarted=upgradeStarted, poolCreated=poolCreated, poolExported=poolExported, basicCompliance=basicCompliance, globalStatistics=globalStatistics, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, shareCompressionEnabled=shareCompressionEnabled, lunSnapshotSizeLow=lunSnapshotSizeLow, poolDeletionFailed=poolDeletionFailed, diskDataWriteMbps=diskDataWriteMbps, poolMetaWriteLatency=poolMetaWriteLatency, fcInitiators=fcInitiators, shareMountPoint=shareMountPoint, shareQuotaLow=shareQuotaLow, iscsiTargetWriteMbps=iscsiTargetWriteMbps, ipmiThreshold=ipmiThreshold, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolUsedSizeLow=poolUsedSizeLow, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, targetGroupMemberAdded=targetGroupMemberAdded, nicTable=nicTable, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry, maintenanceModeDisabled=maintenanceModeDisabled, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolFreeSizeHigh=poolFreeSizeHigh, intelliFlashSoftwareUp=intelliFlashSoftwareUp, network=network, PYSNMP_MODULE_ID=tegile, diskAlias=diskAlias, notificationTime=notificationTime, poolTotalWriteIops=poolTotalWriteIops, diskChassisIdx=diskChassisIdx, ipmiPowerSupply=ipmiPowerSupply, notificationSensorSuspect=notificationSensorSuspect, upgradeDownloadCompleted=upgradeDownloadCompleted, lunFreeSizeHigh=lunFreeSizeHigh, poolTotalWriteMbps=poolTotalWriteMbps, upgradeTimeout=upgradeTimeout, snapshotCloningFailed=snapshotCloningFailed, volumeDeleteFailed=volumeDeleteFailed, cpuInterrupts=cpuInterrupts, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, haResourceDescription=haResourceDescription, cacheTotalReadMbps=cacheTotalReadMbps, projectPoolName=projectPoolName, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareEntry=shareEntry, volumeModifyCompleted=volumeModifyCompleted, notificationReadingUnit=notificationReadingUnit, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolMetaReadMbps=poolMetaReadMbps, shareCIFSWriteIops=shareCIFSWriteIops, lunWriteLatency=lunWriteLatency, snapshotDeleteFailed=snapshotDeleteFailed, projectQuotaFinished=projectQuotaFinished, replicationSourceRegistered=replicationSourceRegistered, poolAvgReadLatency=poolAvgReadLatency, projectQuotaSizeLow=projectQuotaSizeLow, haControllerA_Uptime=haControllerA_Uptime, vmwareNFSDatastores=vmwareNFSDatastores, deleteFolderFailed=deleteFolderFailed, networkInterfaceUp=networkInterfaceUp, poolAvgWriteLatency=poolAvgWriteLatency, poolTotalReadIops=poolTotalReadIops, nfsAvgWriteLatency=nfsAvgWriteLatency, upgradeDownloadStarted=upgradeDownloadStarted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, ipmiTemperature=ipmiTemperature, snmpServiceStopped=snmpServiceStopped, poolDataReadMbps=poolDataReadMbps, notificationObjects=notificationObjects, haControllerB_Name=haControllerB_Name, tegileArray_notifications=tegileArray_notifications, lunProtocol=lunProtocol, diskTotalReadIops=diskTotalReadIops, poolDataWriteIops=poolDataWriteIops, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunReadLatency=lunReadLatency, cacheSSDReads=cacheSSDReads, shareCreatedSuccessfully=shareCreatedSuccessfully, fcTargetModifyCompleted=fcTargetModifyCompleted, smbSocketFailure=smbSocketFailure, projectShareCount=projectShareCount, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareNFSWriteIops=shareNFSWriteIops, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectCompressionEnabled=projectCompressionEnabled, cifsTotalReadIops=cifsTotalReadIops, poolDataReadIops=poolDataReadIops, memoryFailure=memoryFailure, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiAvgWriteLatency=iscsiAvgWriteLatency)
mibBuilder.exportSymbols("TEGILE-MIB", notificationDescription=notificationDescription, lunPoolName=lunPoolName, shareNFSWriteLatency=shareNFSWriteLatency, lunReservedSizeLow=lunReservedSizeLow, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, haResourceActiveNode=haResourceActiveNode, notifications=notifications, fcTargetEntry=fcTargetEntry, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, alertsCleanupCompleted=alertsCleanupCompleted, diskCount=diskCount, currentObjectGroup=currentObjectGroup, fcTargetReadLatency=fcTargetReadLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunName=lunName, iscsiImproperTargetGroup=iscsiImproperTargetGroup, shareReservedSizeLow=shareReservedSizeLow, fcTargetWriteIops=fcTargetWriteIops, poolState=poolState, fcTargetReadIops=fcTargetReadIops, haResourcesTable=haResourcesTable, iscsiTargets=iscsiTargets, haControllerB_IPAddr=haControllerB_IPAddr, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiInitiatorGroup=iscsiInitiatorGroup, poolMetaWriteIops=poolMetaWriteIops, snmpServiceStartFailed=snmpServiceStartFailed, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcInitiatorsTable=fcInitiatorsTable, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, projectDedupEnabled=projectDedupEnabled, lunSnapshotSizeHigh=lunSnapshotSizeHigh, controllerHardwareModel=controllerHardwareModel, poolMetaReadIops=poolMetaReadIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, haControllerA_Name=haControllerA_Name, diskRandomIOCount=diskRandomIOCount, projectFreeSizeLow=projectFreeSizeLow, unknownSensorEvent=unknownSensorEvent, iscsiProperties=iscsiProperties, shareCompressedRatio=shareCompressedRatio, notificationSensorAction=notificationSensorAction, diskSizeHigh=diskSizeHigh, fcInitiatorCreateFailed=fcInitiatorCreateFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolTotalReadMbps=poolTotalReadMbps, ipmiCurrent=ipmiCurrent, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, tegileCompliances=tegileCompliances, userLoginFailed=userLoginFailed, fcTotalReadIops=fcTotalReadIops, smisServiceStarted=smisServiceStarted, lunDedupEnabled=lunDedupEnabled, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, haResourceName=haResourceName, snmpAgentVersion=snmpAgentVersion, sensorFailureEvent=sensorFailureEvent, projectLunCount=projectLunCount, smisServiceStopped=smisServiceStopped, upgradeCompleted=upgradeCompleted, projectLUNs=projectLUNs, shareDataSizeHigh=shareDataSizeHigh, nicTransmitMbps=nicTransmitMbps, fcPortOffline=fcPortOffline, cifsTotalWriteMbps=cifsTotalWriteMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, poolFreeSizeLow=poolFreeSizeLow, poolReadCacheReadMbps=poolReadCacheReadMbps, notificationSensorNumber=notificationSensorNumber, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTotalWriteMbps=fcTotalWriteMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, deleteFolderCompleted=deleteFolderCompleted, lunDataSizeHigh=lunDataSizeHigh, volumeCreatedSuccessfully=volumeCreatedSuccessfully, lunReservedSizeHigh=lunReservedSizeHigh, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, nicIndex=nicIndex, fcAvgReadLatency=fcAvgReadLatency, poolIndex=poolIndex, cacheRAMReads=cacheRAMReads, upgradeFailed=upgradeFailed, nicEntry=nicEntry, networkIpmpGroupUp=networkIpmpGroupUp, diskTotalWriteIops=diskTotalWriteIops, smisServiceStopFailed=smisServiceStopFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, replicationResumed=replicationResumed, cacheTotalWriteIops=cacheTotalWriteIops, shareNFSWriteMbps=shareNFSWriteMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, nicMTU=nicMTU, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectTable=projectTable, iscsiTargetError=iscsiTargetError, shareCIFSWriteLatency=shareCIFSWriteLatency, volumeDeleteCompleted=volumeDeleteCompleted, nicReceiveMbps=nicReceiveMbps, shareNFSEnabled=shareNFSEnabled, controllerDown=controllerDown, nfsTotalWriteMbps=nfsTotalWriteMbps, poolQuotaFinished=poolQuotaFinished, diskTotalWriteMbps=diskTotalWriteMbps, poolTable=poolTable, lunDataSizeLow=lunDataSizeLow, nicState=nicState, nfsTotalReadMbps=nfsTotalReadMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, ipmiFan=ipmiFan, fcTotalReadMbps=fcTotalReadMbps, tegileConformance=tegileConformance, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiInitiatorName=iscsiInitiatorName, fcTotalWriteIops=fcTotalWriteIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, cifsTotalReadMbps=cifsTotalReadMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiTotalReadIops=iscsiTotalReadIops, fcInitiatorGroup=fcInitiatorGroup, haControllerA_IPAddr=haControllerA_IPAddr, poolSizeLow=poolSizeLow, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargetWriteLatency=fcTargetWriteLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunGUID=lunGUID, haResourceEntry=haResourceEntry, haResourceIndex=haResourceIndex, replicationComplete=replicationComplete, poolDataSizeLow=poolDataSizeLow, iscsiTargetAlias=iscsiTargetAlias, diskDataWriteIops=diskDataWriteIops, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolReadCacheWriteMbps=poolReadCacheWriteMbps, diskIsOnline=diskIsOnline, ipmiOther=ipmiOther, poolUsedSizeHigh=poolUsedSizeHigh, shareNFSReadLatency=shareNFSReadLatency, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, diskDataReadIops=diskDataReadIops, fcProperties=fcProperties, poolMetaReadLatency=poolMetaReadLatency, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, lunBlockSize=lunBlockSize, projectDataSizeHigh=projectDataSizeHigh, ipmiCriticalInterrupt=ipmiCriticalInterrupt, notificationSeverity=notificationSeverity, fcInitiatorEntry=fcInitiatorEntry, tegileArray=tegileArray, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, notificationComponentName=notificationComponentName, lunIndex=lunIndex, nicName=nicName, diskState=diskState, poolEntry=poolEntry, shareName=shareName, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, networkTotalTransmitMbps=networkTotalTransmitMbps, networkIpmpGroupDown=networkIpmpGroupDown, targetGroupDeleteCompleted=targetGroupDeleteCompleted, lunCompressionEnabled=lunCompressionEnabled, cifsTotalWriteIops=cifsTotalWriteIops, poolOwnerController=poolOwnerController, lunWriteIops=lunWriteIops, poolDegraded=poolDegraded, cpuTotalUsage=cpuTotalUsage, iscsiTargetIndex=iscsiTargetIndex, smisServiceStartFailed=smisServiceStartFailed, poolTotalSaving=poolTotalSaving, shareReservedSizeHigh=shareReservedSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiTargetAuth=iscsiTargetAuth, tegileGroups=tegileGroups, diskTotalReadMbps=diskTotalReadMbps, iscsiTargetsTable=iscsiTargetsTable, replicationTargetDeleted=replicationTargetDeleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, controllerTimeDrift=controllerTimeDrift, poolCount=poolCount, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareQuotaHigh=shareQuotaHigh, iscsiTargetReadMbps=iscsiTargetReadMbps, notificationTargetEntityName=notificationTargetEntityName, poolHealth=poolHealth, aclMigrationCompleted=aclMigrationCompleted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, projectSnapshotSizeLow=projectSnapshotSizeLow, projectEntry=projectEntry, notificationProps=notificationProps, poolDeleted=poolDeleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, pools=pools, nfsTotalReadIops=nfsTotalReadIops, fcPortOnline=fcPortOnline, shareDeletionFailed=shareDeletionFailed, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectShares=projectShares, shareNFSReadIops=shareNFSReadIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, nfsTotalWriteIops=nfsTotalWriteIops, tegile=tegile, maintenanceModeEnabled=maintenanceModeEnabled, snapshotCreationFailed=snapshotCreationFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargetGroup=iscsiTargetGroup, nicGroup=nicGroup, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, snapshotRollbackCompleted=snapshotRollbackCompleted, lunCompressedRatio=lunCompressedRatio)
