...
# Produced by pysmi-1.1.3 at Thu Dec  9 14:32:40 2021
...
IpAddress, ModuleIdentity, MibIdentifier, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, enterprises, Bits, TimeTicks, Gauge32, ObjectIdentity, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "MibIdentifier", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "enterprises", "Bits", "TimeTicks", "Gauge32", "ObjectIdentity", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolTotalSaving=poolTotalSaving, diskSizeHigh=diskSizeHigh, upgradeTimeout=upgradeTimeout, nicMTU=nicMTU, cacheTotalWriteMbps=cacheTotalWriteMbps, poolIndex=poolIndex, upgradeStarted=upgradeStarted, projectShareCount=projectShareCount, memoryFailure=memoryFailure, lunReservedSizeHigh=lunReservedSizeHigh, notificationSensorNumber=notificationSensorNumber, snmpServiceStartFailed=snmpServiceStartFailed, smbSocketFailure=smbSocketFailure, cacheTotalWriteIops=cacheTotalWriteIops, haResourceStatus=haResourceStatus, diskChassisIdx=diskChassisIdx, iscsiProperties=iscsiProperties, tegileArray=tegileArray, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, cifsTotalReadMbps=cifsTotalReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, shareNFSReadLatency=shareNFSReadLatency, poolDeleted=poolDeleted, iscsiInitiatorIndex=iscsiInitiatorIndex, lunGUID=lunGUID, alertsCleanupCompleted=alertsCleanupCompleted, lunTable=lunTable, network=network, shareNFSWriteIops=shareNFSWriteIops, fcTotalReadIops=fcTotalReadIops, nicGroup=nicGroup, poolProjectCount=poolProjectCount, fcInitiatorName=fcInitiatorName, shareDataSizeHigh=shareDataSizeHigh, poolEntry=poolEntry, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcTargetWriteMbps=fcTargetWriteMbps, poolAvgWriteLatency=poolAvgWriteLatency, shareDeleted=shareDeleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, aclMigrationStarted=aclMigrationStarted, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, nicTransmitMbps=nicTransmitMbps, lunTargetGroup=lunTargetGroup, shareCIFSWriteLatency=shareCIFSWriteLatency, fcInitiatorEntry=fcInitiatorEntry, replicationAborted=replicationAborted, lunBlockSize=lunBlockSize, notificationReadingUnit=notificationReadingUnit, iscsiTargetError=iscsiTargetError, volumeDeleteFailed=volumeDeleteFailed, poolUsedSizeHigh=poolUsedSizeHigh, poolName=poolName, maintenanceModeEnabled=maintenanceModeEnabled, diskIOCount=diskIOCount, replicationSourceRegistered=replicationSourceRegistered, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectLUNs=projectLUNs, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, haResourceEntry=haResourceEntry, poolMetaReadIops=poolMetaReadIops, shareNFSEnabled=shareNFSEnabled, iscsiTargetReadLatency=iscsiTargetReadLatency, poolDataWriteIops=poolDataWriteIops, snmpServiceStarted=snmpServiceStarted, haControllerA_IPAddr=haControllerA_IPAddr, nvdimmFailUnknownError=nvdimmFailUnknownError, diskTotalReadMbps=diskTotalReadMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskRandomIOCount=diskRandomIOCount, notificationThresholdTriggerValue=notificationThresholdTriggerValue, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, nicReceiveMbps=nicReceiveMbps, smisServiceStarted=smisServiceStarted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, replicationTargetDeleted=replicationTargetDeleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, sharePoolName=sharePoolName, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolDegraded=poolDegraded, nfsAvgWriteLatency=nfsAvgWriteLatency, notificationComponentName=notificationComponentName, shareSnapshotSizeHigh=shareSnapshotSizeHigh, upgradeCompleted=upgradeCompleted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolOwnerController=poolOwnerController, projectDeleted=projectDeleted, shareSnapshotSizeLow=shareSnapshotSizeLow, haResourceIndex=haResourceIndex, fcPortOnline=fcPortOnline, cpuSystemCalls=cpuSystemCalls, tegileArray_notifications=tegileArray_notifications, fcTargetStatus=fcTargetStatus, cpuTotalUsage=cpuTotalUsage, diskError=diskError, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunCompressionEnabled=lunCompressionEnabled, haResourceGroup=haResourceGroup, targetGroupCreateCompleted=targetGroupCreateCompleted, snapshotCloneCompleted=snapshotCloneCompleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, userLoginFailed=userLoginFailed, shareMountPoint=shareMountPoint, shareDataSizeLow=shareDataSizeLow, iscsiTargetsTable=iscsiTargetsTable, iscsiTargetName=iscsiTargetName, cacheSSDReads=cacheSSDReads, poolMetaReadMbps=poolMetaReadMbps, diskDataWriteMbps=diskDataWriteMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, nicState=nicState, smisServiceStopFailed=smisServiceStopFailed, diskTotalReadIops=diskTotalReadIops, notifications=notifications, sensorFailureEvent=sensorFailureEvent, fcAvgReadLatency=fcAvgReadLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, controllerDown=controllerDown, poolTotalReadMbps=poolTotalReadMbps, poolTotalWriteIops=poolTotalWriteIops, diskTable=diskTable, projectEntry=projectEntry, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, notificationEventCode=notificationEventCode, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareCompressionEnabled=shareCompressionEnabled, iscsiTargetReadMbps=iscsiTargetReadMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, ntpServerTimeDrift=ntpServerTimeDrift, snapshotCloningFailed=snapshotCloningFailed, poolReadCacheReadMbps=poolReadCacheReadMbps, notificationSensorAction=notificationSensorAction, poolImported=poolImported, iscsiTargets=iscsiTargets, ipmiOther=ipmiOther, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diagnosticDataUploaded=diagnosticDataUploaded, ipmiThreshold=ipmiThreshold, shareReservedSizeHigh=shareReservedSizeHigh, volumeQuotaFinished=volumeQuotaFinished, poolDataWriteLatency=poolDataWriteLatency, shareNFSReadMbps=shareNFSReadMbps, haResourcesTable=haResourcesTable, shareCreatedSuccessfully=shareCreatedSuccessfully, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolDataSizeLow=poolDataSizeLow, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, poolCreated=poolCreated, projectModified=projectModified, nvdimmFailInitializationError=nvdimmFailInitializationError, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiTargetIndex=iscsiTargetIndex, diskIsOnline=diskIsOnline, networkTotalTransmitMbps=networkTotalTransmitMbps, projectDeletionFailed=projectDeletionFailed, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, lunWriteMbps=lunWriteMbps, maintenanceModeDisabled=maintenanceModeDisabled, poolTotalReadIops=poolTotalReadIops, poolReadCacheReadLatency=poolReadCacheReadLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiTargetGroup=iscsiTargetGroup, poolExpanded=poolExpanded, snmpAgentVersion=snmpAgentVersion, pools=pools, diskGoneOffline=diskGoneOffline, diskTotalWriteMbps=diskTotalWriteMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcInitiatorGroup=fcInitiatorGroup, notificationDescription=notificationDescription, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, targetGroupMemberRemoved=targetGroupMemberRemoved, shareNFSReadIops=shareNFSReadIops, snapshotRollbackCompleted=snapshotRollbackCompleted, fcTargets=fcTargets, ipmiTemperature=ipmiTemperature, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, haResourceDescription=haResourceDescription, projectDataSizeLow=projectDataSizeLow, poolSizeLow=poolSizeLow, nfsTotalReadIops=nfsTotalReadIops, deleteFolderFailed=deleteFolderFailed, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, cifsTotalWriteMbps=cifsTotalWriteMbps, nicIndex=nicIndex, shareCIFSReadMbps=shareCIFSReadMbps, poolProjects=poolProjects, fcProperties=fcProperties, poolQuotaFinished=poolQuotaFinished, iscsiTotalWriteMbps=iscsiTotalWriteMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskCount=diskCount, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, nicTable=nicTable, haResourceActiveNode=haResourceActiveNode, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, snapshotRollbackFailed=snapshotRollbackFailed, cacheTotalReadIops=cacheTotalReadIops, tegile=tegile, poolMetaReadLatency=poolMetaReadLatency, basicCompliance=basicCompliance, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, globalStatistics=globalStatistics, poolUpgraded=poolUpgraded, upgradeDownloadStarted=upgradeDownloadStarted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiWriteIops=iscsiWriteIops, fcTargetModifyCompleted=fcTargetModifyCompleted, replicationFailed=replicationFailed, upgradeDownloadFailed=upgradeDownloadFailed, ipmiCurrent=ipmiCurrent, snmpServiceStopFailed=snmpServiceStopFailed, ipmiVoltage=ipmiVoltage, iscsiInitiatorChapUser=iscsiInitiatorChapUser, iscsiInitiators=iscsiInitiators, notificationTime=notificationTime, poolDeletionFailed=poolDeletionFailed, cacheRAMReads=cacheRAMReads, iscsiTargetEntry=iscsiTargetEntry, snmpServiceStopped=snmpServiceStopped, fcTotalWriteIops=fcTotalWriteIops, replicationComplete=replicationComplete, lunWriteIops=lunWriteIops, fcInitiatorIndex=fcInitiatorIndex, poolReadCacheReadIops=poolReadCacheReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolFreeSizeHigh=poolFreeSizeHigh, tegileGroups=tegileGroups, shareDedupEnabled=shareDedupEnabled, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTargetAuth=iscsiTargetAuth, replicationPaused=replicationPaused, shareCIFSWriteIops=shareCIFSWriteIops, fcAvgWriteLatency=fcAvgWriteLatency, cifsTotalReadIops=cifsTotalReadIops, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, volumeModifyCompleted=volumeModifyCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, poolSizeHigh=poolSizeHigh)
mibBuilder.exportSymbols("TEGILE-MIB", notificationReadingTriggerValue=notificationReadingTriggerValue, notificationTargetEntityName=notificationTargetEntityName, poolExported=poolExported, iscsiTargetGroupError=iscsiTargetGroupError, lunDataSizeHigh=lunDataSizeHigh, lunDedupEnabled=lunDedupEnabled, shareExceedThresholdWarning=shareExceedThresholdWarning, shareTable=shareTable, nicEntry=nicEntry, diskTotalWriteIops=diskTotalWriteIops, projectCreatedSuccessfully=projectCreatedSuccessfully, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunSnapshotSizeLow=lunSnapshotSizeLow, upgradeDownloadCompleted=upgradeDownloadCompleted, shareQuotaFinished=shareQuotaFinished, iscsiTargetWriteIops=iscsiTargetWriteIops, nvdimmFailSoftError=nvdimmFailSoftError, tegileCompliances=tegileCompliances, projectQuotaSizeHigh=projectQuotaSizeHigh, ipmiMemory=ipmiMemory, intelliFlashSoftwareUp=intelliFlashSoftwareUp, webdocsUpgradeFailed=webdocsUpgradeFailed, adServerTimeDrift=adServerTimeDrift, diskDataWriteIops=diskDataWriteIops, replicationAbandoned=replicationAbandoned, lunEntry=lunEntry, lunReadLatency=lunReadLatency, replicationResumed=replicationResumed, lunProjectName=lunProjectName, projectName=projectName, diskType=diskType, poolDataWriteMbps=poolDataWriteMbps, shareQuotaHigh=shareQuotaHigh, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolUsedSizeLow=poolUsedSizeLow, lunCompressedRatio=lunCompressedRatio, diskSequentialIOCount=diskSequentialIOCount, projectQuotaFinished=projectQuotaFinished, deleteFolderCompleted=deleteFolderCompleted, testNotification=testNotification, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolTotalWriteMbps=poolTotalWriteMbps, shareEntry=shareEntry, projectFreeSizeHigh=projectFreeSizeHigh, poolDataReadLatency=poolDataReadLatency, fcTotalReadMbps=fcTotalReadMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, cifsTotalWriteIops=cifsTotalWriteIops, shareQuotaLow=shareQuotaLow, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, lunInitiatorGroup=lunInitiatorGroup, lunProtocol=lunProtocol, diskDataReadMbps=diskDataReadMbps, notificationProps=notificationProps, iscsiInitiatorEntry=iscsiInitiatorEntry, webdocsUpgradeCompleted=webdocsUpgradeCompleted, PYSNMP_MODULE_ID=tegile, cpuInterrupts=cpuInterrupts, projectSnapshotSizeLow=projectSnapshotSizeLow, diskAlias=diskAlias, tdpsUpgradeFailed=tdpsUpgradeFailed, shareNFSWriteLatency=shareNFSWriteLatency, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcTargetEntry=fcTargetEntry, diskAvgWriteLatency=diskAvgWriteLatency, poolHealth=poolHealth, targetGroupMemberAdded=targetGroupMemberAdded, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolMetaWriteMbps=poolMetaWriteMbps, controllerHardwareModel=controllerHardwareModel, fcInitiators=fcInitiators, controllerTimeDrift=controllerTimeDrift, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, smisServiceStartFailed=smisServiceStartFailed, projectShares=projectShares, iscsiTotalReadIops=iscsiTotalReadIops, projectQuotaSizeLow=projectQuotaSizeLow, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareReservedSizeLow=shareReservedSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, fcTotalWriteMbps=fcTotalWriteMbps, snapshotCreationFailed=snapshotCreationFailed, iscsiAvgReadLatency=iscsiAvgReadLatency, unknownSensorEvent=unknownSensorEvent, shareIndex=shareIndex, spareDiskReplaced=spareDiskReplaced, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareCompressedRatio=shareCompressedRatio, projectDedupEnabled=projectDedupEnabled, notificationSeverity=notificationSeverity, projectIndex=projectIndex, lunSizeHigh=lunSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunFreeSizeLow=lunFreeSizeLow, poolDataSizeHigh=poolDataSizeHigh, fcPortOffline=fcPortOffline, cacheTotalReadMbps=cacheTotalReadMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, haControllerB_Uptime=haControllerB_Uptime, poolCount=poolCount, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectTotalSaving=projectTotalSaving, shareProjectName=shareProjectName, nfsTotalWriteMbps=nfsTotalWriteMbps, poolState=poolState, vmwareNFSDatastores=vmwareNFSDatastores, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, aclMigrationCompleted=aclMigrationCompleted, diskEntry=diskEntry, fcTargetReadLatency=fcTargetReadLatency, cifsAvgReadLatency=cifsAvgReadLatency, nfsAvgReadLatency=nfsAvgReadLatency, diskPoolName=diskPoolName, lunSizeLow=lunSizeLow, fcTargetWriteIops=fcTargetWriteIops, lunName=lunName, fcTargetName=fcTargetName, ipmiPowerSupply=ipmiPowerSupply, nfsTotalWriteIops=nfsTotalWriteIops, poolMetaWriteIops=poolMetaWriteIops, lunPoolName=lunPoolName, projectDataSizeHigh=projectDataSizeHigh, disks=disks, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiInitiatorName=iscsiInitiatorName, poolWriteCacheWriteIops=poolWriteCacheWriteIops, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, projectLunCount=projectLunCount, networkInterfaceDown=networkInterfaceDown, replicationStarted=replicationStarted, shareCIFSReadIops=shareCIFSReadIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcTargetReadIops=fcTargetReadIops, controllerUp=controllerUp, poolDataReadIops=poolDataReadIops, haResources=haResources, fcTargetsTable=fcTargetsTable, notificationSensorSuspect=notificationSensorSuspect, nfsTotalReadMbps=nfsTotalReadMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, projectTable=projectTable, projectPoolName=projectPoolName, diskDataReadIops=diskDataReadIops, diskState=diskState, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectFreeSizeLow=projectFreeSizeLow, shareDeletionFailed=shareDeletionFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunIndex=lunIndex, fcTargetIndex=fcTargetIndex, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, haControllerA_Uptime=haControllerA_Uptime, poolFreeSizeLow=poolFreeSizeLow, lunReadIops=lunReadIops, diskSizeLow=diskSizeLow, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolMetaWriteLatency=poolMetaWriteLatency, lunReadMbps=lunReadMbps, networkIpmpGroupDown=networkIpmpGroupDown, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, snapshotDeleteFailed=snapshotDeleteFailed, poolDataReadMbps=poolDataReadMbps, diskAvgReadLatency=diskAvgReadLatency, netbiosSocketFailure=netbiosSocketFailure, smisServiceStopped=smisServiceStopped, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, haControllerA_Name=haControllerA_Name, nvdimmFailDeviceError=nvdimmFailDeviceError, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareName=shareName, fcTargetWriteLatency=fcTargetWriteLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcInitiatorsTable=fcInitiatorsTable, networkInterfaceUp=networkInterfaceUp, diskIndex=diskIndex, properties=properties, volumeDeleteCompleted=volumeDeleteCompleted, shareCIFSEnabled=shareCIFSEnabled, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunDataSizeLow=lunDataSizeLow, nicName=nicName, haControllerB_IPAddr=haControllerB_IPAddr, lunReservedSizeLow=lunReservedSizeLow, projectThresholdExceedWarning=projectThresholdExceedWarning, ipmiFan=ipmiFan, upgradeFailed=upgradeFailed, haControllerB_Name=haControllerB_Name, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, tegileConformance=tegileConformance, diskSlowIo=diskSlowIo, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, lunWriteLatency=lunWriteLatency, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, sanProperties=sanProperties, iscsiTargetReadIops=iscsiTargetReadIops, lunFreeSizeHigh=lunFreeSizeHigh, fcTargetReadMbps=fcTargetReadMbps, iscsiTargetAlias=iscsiTargetAlias, projectCompressionEnabled=projectCompressionEnabled, currentNotificationGroup=currentNotificationGroup, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolAvgReadLatency=poolAvgReadLatency, poolTable=poolTable, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, networkIpmpGroupUp=networkIpmpGroupUp, haResourceName=haResourceName, notificationObjects=notificationObjects)
