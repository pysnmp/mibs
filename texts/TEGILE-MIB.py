...
# Produced by pysmi-1.1.8 at Sat Jan 15 18:17:14 2022
...
Unsigned32, Counter32, MibIdentifier, TimeTicks, enterprises, Gauge32, iso, IpAddress, NotificationType, Bits, Integer32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "MibIdentifier", "TimeTicks", "enterprises", "Gauge32", "iso", "IpAddress", "NotificationType", "Bits", "Integer32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareTable=shareTable, poolMetaReadIops=poolMetaReadIops, lunCompressedRatio=lunCompressedRatio, volumeDeleteFailed=volumeDeleteFailed, shareNFSReadMbps=shareNFSReadMbps, nfsAvgReadLatency=nfsAvgReadLatency, lunTargetGroup=lunTargetGroup, lunFreeSizeLow=lunFreeSizeLow, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, targetGroupMemberRemoved=targetGroupMemberRemoved, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcPortOffline=fcPortOffline, lunTable=lunTable, snmpServiceStopped=snmpServiceStopped, nicMTU=nicMTU, snmpServiceStarted=snmpServiceStarted, diskDataReadIops=diskDataReadIops, projectDataSizeHigh=projectDataSizeHigh, poolDataReadLatency=poolDataReadLatency, shareDedupEnabled=shareDedupEnabled, currentObjectGroup=currentObjectGroup, poolCount=poolCount, poolReadCacheWriteLatency=poolReadCacheWriteLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareCIFSReadLatency=shareCIFSReadLatency, fcTotalReadMbps=fcTotalReadMbps, diskError=diskError, lunReservedSizeHigh=lunReservedSizeHigh, testNotification=testNotification, lunGUID=lunGUID, networkTotalTransmitMbps=networkTotalTransmitMbps, replicationPaused=replicationPaused, haResourceName=haResourceName, notificationTargetEntityName=notificationTargetEntityName, diskSizeLow=diskSizeLow, volumeQuotaFinished=volumeQuotaFinished, diskTotalReadMbps=diskTotalReadMbps, nicIndex=nicIndex, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, lunProtocol=lunProtocol, cifsTotalReadMbps=cifsTotalReadMbps, lunDataSizeLow=lunDataSizeLow, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcTargetReadMbps=fcTargetReadMbps, ipmiThreshold=ipmiThreshold, shareExceedThresholdWarning=shareExceedThresholdWarning, notificationThresholdTriggerValue=notificationThresholdTriggerValue, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiTargetWriteIops=iscsiTargetWriteIops, lunWriteIops=lunWriteIops, notificationTime=notificationTime, lunName=lunName, projectCompressionEnabled=projectCompressionEnabled, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, cpuSystemCalls=cpuSystemCalls, haResourceIndex=haResourceIndex, diskDataWriteIops=diskDataWriteIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, cacheTotalReadMbps=cacheTotalReadMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunDedupEnabled=lunDedupEnabled, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, nfsTotalReadIops=nfsTotalReadIops, tdpsUpgradeTimeout=tdpsUpgradeTimeout, currentNotificationGroup=currentNotificationGroup, poolTable=poolTable, volumeCreatedSuccessfully=volumeCreatedSuccessfully, haControllerA_Uptime=haControllerA_Uptime, poolMetaWriteIops=poolMetaWriteIops, fcTotalWriteMbps=fcTotalWriteMbps, fcTargetsTable=fcTargetsTable, poolCreated=poolCreated, diskCount=diskCount, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcTargetModifyCompleted=fcTargetModifyCompleted, smisServiceStarted=smisServiceStarted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, notificationProps=notificationProps, iscsiInitiatorGroup=iscsiInitiatorGroup, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolTotalWriteIops=poolTotalWriteIops, poolProjects=poolProjects, networkIpmpGroupUp=networkIpmpGroupUp, poolIndex=poolIndex, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, shareName=shareName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, shareCIFSReadIops=shareCIFSReadIops, projectSnapshotSizeLow=projectSnapshotSizeLow, projectDataSizeLow=projectDataSizeLow, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolOwnerController=poolOwnerController, diskIndex=diskIndex, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, targetGroupDeleteCompleted=targetGroupDeleteCompleted, notificationSeverity=notificationSeverity, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, haResourceGroup=haResourceGroup, cpuInterrupts=cpuInterrupts, iscsiAvgWriteLatency=iscsiAvgWriteLatency, replicationAbandoned=replicationAbandoned, poolMetaReadLatency=poolMetaReadLatency, ipmiVoltage=ipmiVoltage, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiTargetWriteMbps=iscsiTargetWriteMbps, networkIpmpGroupDown=networkIpmpGroupDown, diskSlowIo=diskSlowIo, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, cifsTotalWriteIops=cifsTotalWriteIops, replicationStarted=replicationStarted, lunInitiatorGroup=lunInitiatorGroup, diskEntry=diskEntry, replicationAborted=replicationAborted, projectShares=projectShares, fcAvgReadLatency=fcAvgReadLatency, networkInterfaceDown=networkInterfaceDown, diskAlias=diskAlias, intelliFlashSoftwareUp=intelliFlashSoftwareUp, diagnosticDataUploaded=diagnosticDataUploaded, poolDeletionFailed=poolDeletionFailed, ipmiMemory=ipmiMemory, fcInitiatorEntry=fcInitiatorEntry, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, sanProperties=sanProperties, lunWriteMbps=lunWriteMbps, nicName=nicName, nicState=nicState, fcTargetName=fcTargetName, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, haResourceDescription=haResourceDescription, snmpAgentVersion=snmpAgentVersion, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolDeleted=poolDeleted, poolName=poolName, iscsiInitiatorsTable=iscsiInitiatorsTable, spareDiskReplaced=spareDiskReplaced, disks=disks, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, upgradeTimeout=upgradeTimeout, snapshotRollbackFailed=snapshotRollbackFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, fcTargetIndex=fcTargetIndex, fcTargetWriteLatency=fcTargetWriteLatency, diskType=diskType, nvdimmFailInitializationError=nvdimmFailInitializationError, shareDataSizeLow=shareDataSizeLow, iscsiInitiatorEntry=iscsiInitiatorEntry, diskGoneOffline=diskGoneOffline, fcTargetReadLatency=fcTargetReadLatency, targetGroupMemberAdded=targetGroupMemberAdded, smisServiceStartFailed=smisServiceStartFailed, iscsiTotalReadIops=iscsiTotalReadIops, poolQuotaFinished=poolQuotaFinished, shareMountPoint=shareMountPoint, snapshotRollbackCompleted=snapshotRollbackCompleted, shareCompressionEnabled=shareCompressionEnabled, shareCreatedSuccessfully=shareCreatedSuccessfully, diskTotalWriteMbps=diskTotalWriteMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, cifsTotalReadIops=cifsTotalReadIops, shareDeletionFailed=shareDeletionFailed, nicEntry=nicEntry, lunSnapshotSizeLow=lunSnapshotSizeLow, notificationReadingUnit=notificationReadingUnit, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareNFSWriteLatency=shareNFSWriteLatency, ipmiCurrent=ipmiCurrent, shareQuotaFinished=shareQuotaFinished, poolDataWriteMbps=poolDataWriteMbps, deleteFolderFailed=deleteFolderFailed, snapshotDeleteFailed=snapshotDeleteFailed, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolDataWriteLatency=poolDataWriteLatency, notificationEventCode=notificationEventCode, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, globalStatistics=globalStatistics, shareQuotaLow=shareQuotaLow, poolReadCacheWriteIops=poolReadCacheWriteIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunReservedSizeLow=lunReservedSizeLow, poolProjectCount=poolProjectCount, poolReadCacheReadMbps=poolReadCacheReadMbps, diskTable=diskTable, shareReservedSizeHigh=shareReservedSizeHigh, tegileGroups=tegileGroups, iscsiInitiators=iscsiInitiators, shareCIFSEnabled=shareCIFSEnabled, projectPoolName=projectPoolName, sharePoolName=sharePoolName, fcPortOnline=fcPortOnline, ipmiCriticalInterrupt=ipmiCriticalInterrupt, snapshotCreationFailed=snapshotCreationFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, projectTable=projectTable, intelliFlashSoftwareDown=intelliFlashSoftwareDown, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, deleteFolderCompleted=deleteFolderCompleted, shareCIFSWriteMbps=shareCIFSWriteMbps, poolAvgWriteLatency=poolAvgWriteLatency, projectQuotaSizeLow=projectQuotaSizeLow, notificationSensorSuspect=notificationSensorSuspect, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcTargetStatus=fcTargetStatus, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, tegileArray=tegileArray, haControllerB_Uptime=haControllerB_Uptime, shareProjectName=shareProjectName, iscsiTargetGroupError=iscsiTargetGroupError, poolDataReadMbps=poolDataReadMbps, replicationComplete=replicationComplete, nfsTotalReadMbps=nfsTotalReadMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolHealth=poolHealth, fcAvgWriteLatency=fcAvgWriteLatency, iscsiTargetWriteLatency=iscsiTargetWriteLatency, shareNFSWriteIops=shareNFSWriteIops, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiTargetsTable=iscsiTargetsTable, replicationResumed=replicationResumed, unknownSensorEvent=unknownSensorEvent, poolFreeSizeLow=poolFreeSizeLow, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunEntry=lunEntry, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcProperties=fcProperties, iscsiWriteIops=iscsiWriteIops, notificationSensorNumber=notificationSensorNumber, poolSizeHigh=poolSizeHigh, diskPoolName=diskPoolName, shareCompressedRatio=shareCompressedRatio, notificationObjects=notificationObjects, poolReadCacheReadLatency=poolReadCacheReadLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunDataSizeHigh=lunDataSizeHigh, aclMigrationCompleted=aclMigrationCompleted, haResourceStatus=haResourceStatus, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiTargetName=iscsiTargetName, basicCompliance=basicCompliance, projectDeleted=projectDeleted, aclMigrationStarted=aclMigrationStarted, ipmiFan=ipmiFan)
mibBuilder.exportSymbols("TEGILE-MIB", cpuTotalUsage=cpuTotalUsage, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunReadMbps=lunReadMbps, cacheSSDReads=cacheSSDReads, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, properties=properties, diskIsOnline=diskIsOnline, poolState=poolState, projectQuotaFinished=projectQuotaFinished, lunSizeHigh=lunSizeHigh, haControllerA_Name=haControllerA_Name, networkInterfaceUp=networkInterfaceUp, controllerHardwareModel=controllerHardwareModel, lunSizeLow=lunSizeLow, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, tegileArray_notifications=tegileArray_notifications, controllerTimeDrift=controllerTimeDrift, notificationDescription=notificationDescription, haResources=haResources, haResourcesTable=haResourcesTable, haControllerA_IPAddr=haControllerA_IPAddr, vmwareNFSDatastores=vmwareNFSDatastores, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, smisServiceStopFailed=smisServiceStopFailed, nvdimmFailDeviceError=nvdimmFailDeviceError, fcInitiators=fcInitiators, iscsiTargetIndex=iscsiTargetIndex, lunReadIops=lunReadIops, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, sensorFailureEvent=sensorFailureEvent, diskDataWriteMbps=diskDataWriteMbps, poolSizeLow=poolSizeLow, diskTotalReadIops=diskTotalReadIops, fcTargetEntry=fcTargetEntry, iscsiInitiatorIndex=iscsiInitiatorIndex, poolExported=poolExported, lunSnapshotSizeHigh=lunSnapshotSizeHigh, volumeModifyCompleted=volumeModifyCompleted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolFreeSizeHigh=poolFreeSizeHigh, diskIOCount=diskIOCount, poolUpgraded=poolUpgraded, pools=pools, projectLUNs=projectLUNs, poolDataSizeLow=poolDataSizeLow, fcTargetReadIops=fcTargetReadIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, ipmiPowerSupply=ipmiPowerSupply, diskSequentialIOCount=diskSequentialIOCount, iscsiProperties=iscsiProperties, poolDataSizeHigh=poolDataSizeHigh, fcTargets=fcTargets, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, lunIndex=lunIndex, diskSizeHigh=diskSizeHigh, nfsTotalWriteIops=nfsTotalWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, replicationTargetDeleted=replicationTargetDeleted, projectShareCount=projectShareCount, iscsiTargetGroup=iscsiTargetGroup, fcTargetWriteMbps=fcTargetWriteMbps, diskAvgWriteLatency=diskAvgWriteLatency, fcInitiatorIndex=fcInitiatorIndex, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, haResourceEntry=haResourceEntry, poolDataWriteIops=poolDataWriteIops, upgradeFailed=upgradeFailed, shareIndex=shareIndex, shareDataSizeHigh=shareDataSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, fcInitiatorName=fcInitiatorName, lunReadLatency=lunReadLatency, fcInitiatorGroup=fcInitiatorGroup, tegileCompliances=tegileCompliances, fcTargetGroup=fcTargetGroup, userLoginFailed=userLoginFailed, maintenanceModeEnabled=maintenanceModeEnabled, shareNFSReadLatency=shareNFSReadLatency, notifications=notifications, iscsiTargetAlias=iscsiTargetAlias, iscsiTotalReadMbps=iscsiTotalReadMbps, shareQuotaHigh=shareQuotaHigh, cacheRAMReads=cacheRAMReads, fcTotalWriteIops=fcTotalWriteIops, nicTable=nicTable, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, diskChassisIdx=diskChassisIdx, shareCIFSWriteIops=shareCIFSWriteIops, lunWriteLatency=lunWriteLatency, nvdimmFailUnknownError=nvdimmFailUnknownError, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectLunCount=projectLunCount, shareNFSReadIops=shareNFSReadIops, iscsiTargetEntry=iscsiTargetEntry, ipmiOther=ipmiOther, shareNFSWriteMbps=shareNFSWriteMbps, poolExpanded=poolExpanded, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, haControllerB_Name=haControllerB_Name, diskState=diskState, maintenanceModeDisabled=maintenanceModeDisabled, adServerTimeDrift=adServerTimeDrift, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, lunPoolName=lunPoolName, poolMetaWriteLatency=poolMetaWriteLatency, tegile=tegile, diskAvgReadLatency=diskAvgReadLatency, netbiosSocketFailure=netbiosSocketFailure, shareNFSEnabled=shareNFSEnabled, shareReservedSizeLow=shareReservedSizeLow, haControllerB_IPAddr=haControllerB_IPAddr, notificationComponentName=notificationComponentName, poolDegraded=poolDegraded, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, tegileConformance=tegileConformance, diskRandomIOCount=diskRandomIOCount, poolTotalSaving=poolTotalSaving, poolAvgReadLatency=poolAvgReadLatency, iscsiTargetAuth=iscsiTargetAuth, smbSocketFailure=smbSocketFailure, memoryFailure=memoryFailure, cacheTotalWriteIops=cacheTotalWriteIops, replicationFailed=replicationFailed, poolImported=poolImported, iscsiTargets=iscsiTargets, smisServiceStopped=smisServiceStopped, poolUsedSizeHigh=poolUsedSizeHigh, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, snapshotCloningFailed=snapshotCloningFailed, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, nicTransmitMbps=nicTransmitMbps, shareDeleted=shareDeleted, projectEntry=projectEntry, projectSnapshotSizeHigh=projectSnapshotSizeHigh, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, ntpServerTimeDrift=ntpServerTimeDrift, shareCIFSWriteLatency=shareCIFSWriteLatency, diskTotalWriteIops=diskTotalWriteIops, poolUsedSizeLow=poolUsedSizeLow, projectTotalSaving=projectTotalSaving, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, upgradeStarted=upgradeStarted, cacheTotalReadIops=cacheTotalReadIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectDedupEnabled=projectDedupEnabled, lunFreeSizeHigh=lunFreeSizeHigh, notificationSensorAction=notificationSensorAction, targetGroupCreateCompleted=targetGroupCreateCompleted, cacheTotalWriteMbps=cacheTotalWriteMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, alertsCleanupCompleted=alertsCleanupCompleted, upgradeDownloadStarted=upgradeDownloadStarted, poolTotalReadMbps=poolTotalReadMbps, snmpServiceStartFailed=snmpServiceStartFailed, poolMetaReadMbps=poolMetaReadMbps, projectModified=projectModified, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectIndex=projectIndex, shareEntry=shareEntry, iscsiTargetReadIops=iscsiTargetReadIops, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiInitiatorName=iscsiInitiatorName, PYSNMP_MODULE_ID=tegile, lunCompressionEnabled=lunCompressionEnabled, upgradeCompleted=upgradeCompleted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, iscsiAvgReadLatency=iscsiAvgReadLatency, poolMetaWriteMbps=poolMetaWriteMbps, controllerUp=controllerUp, volumeDeleteCompleted=volumeDeleteCompleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, nicReceiveMbps=nicReceiveMbps, poolEntry=poolEntry, notificationReadingTriggerValue=notificationReadingTriggerValue, haResourceActiveNode=haResourceActiveNode, lunProjectName=lunProjectName, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectDeletionFailed=projectDeletionFailed, nicGroup=nicGroup, fcTotalReadIops=fcTotalReadIops, nfsTotalWriteMbps=nfsTotalWriteMbps, poolTotalWriteMbps=poolTotalWriteMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, lunBlockSize=lunBlockSize, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, controllerDown=controllerDown, upgradeDownloadCompleted=upgradeDownloadCompleted, fcInitiatorsTable=fcInitiatorsTable, projectFreeSizeHigh=projectFreeSizeHigh, projectName=projectName, poolTotalReadIops=poolTotalReadIops, replicationSourceRegistered=replicationSourceRegistered, projectQuotaSizeHigh=projectQuotaSizeHigh, fcTargetWriteIops=fcTargetWriteIops, diskDataReadMbps=diskDataReadMbps, snmpServiceStopFailed=snmpServiceStopFailed, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, cifsAvgWriteLatency=cifsAvgWriteLatency, cifsAvgReadLatency=cifsAvgReadLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, projectFreeSizeLow=projectFreeSizeLow, iscsiTargetError=iscsiTargetError, ipmiTemperature=ipmiTemperature, poolDataReadIops=poolDataReadIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, nvdimmFailSoftError=nvdimmFailSoftError, snapshotCloneCompleted=snapshotCloneCompleted, network=network)
