...
ObjectIdentity, enterprises, ModuleIdentity, Bits, Gauge32, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, Integer32, MibIdentifier, iso, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "ModuleIdentity", "Bits", "Gauge32", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "Integer32", "MibIdentifier", "iso", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", nicReceiveMbps=nicReceiveMbps, iscsiInitiators=iscsiInitiators, smisServiceStopFailed=smisServiceStopFailed, lunReadIops=lunReadIops, fcTargetGroup=fcTargetGroup, fcPortOffline=fcPortOffline, aclMigrationCompleted=aclMigrationCompleted, nicIndex=nicIndex, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, upgradeDownloadFailed=upgradeDownloadFailed, currentObjectGroup=currentObjectGroup, lunFreeSizeHigh=lunFreeSizeHigh, lunFreeSizeLow=lunFreeSizeLow, targetGroupMemberAdded=targetGroupMemberAdded, fcInitiatorEntry=fcInitiatorEntry, poolExported=poolExported, diskRandomIOCount=diskRandomIOCount, webdocsUpgradeCompleted=webdocsUpgradeCompleted, projectModified=projectModified, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, nfsTotalReadMbps=nfsTotalReadMbps, shareDataSizeHigh=shareDataSizeHigh, notificationReadingTriggerValue=notificationReadingTriggerValue, smisServiceStartFailed=smisServiceStartFailed, iscsiProperties=iscsiProperties, iscsiTotalWriteMbps=iscsiTotalWriteMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, diskSizeHigh=diskSizeHigh, poolExpanded=poolExpanded, replicationSourceRegistered=replicationSourceRegistered, lunDedupEnabled=lunDedupEnabled, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, cifsAvgReadLatency=cifsAvgReadLatency, volumeModifyCompleted=volumeModifyCompleted, snmpServiceStartFailed=snmpServiceStartFailed, shareCreatedSuccessfully=shareCreatedSuccessfully, poolName=poolName, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunReservedSizeLow=lunReservedSizeLow, shareNFSReadMbps=shareNFSReadMbps, fcTargetWriteMbps=fcTargetWriteMbps, notificationProps=notificationProps, haResourceName=haResourceName, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, shareQuotaFinished=shareQuotaFinished, smisServiceStopped=smisServiceStopped, lunDataSizeLow=lunDataSizeLow, poolFreeSizeLow=poolFreeSizeLow, poolMetaReadMbps=poolMetaReadMbps, testNotification=testNotification, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, pools=pools, diskSlowIo=diskSlowIo, poolReadCacheWriteLatency=poolReadCacheWriteLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, poolReadCacheReadIops=poolReadCacheReadIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, userLoginFailed=userLoginFailed, sensorFailureEvent=sensorFailureEvent, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, vmwareNFSDatastores=vmwareNFSDatastores, diskAvgReadLatency=diskAvgReadLatency, projectShareCount=projectShareCount, nicEntry=nicEntry, diskDataWriteMbps=diskDataWriteMbps, notificationSensorAction=notificationSensorAction, iscsiTargets=iscsiTargets, cpuSystemCalls=cpuSystemCalls, projectCompressionEnabled=projectCompressionEnabled, iscsiInitiatorEntry=iscsiInitiatorEntry, poolAvgReadLatency=poolAvgReadLatency, projectName=projectName, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolTotalReadIops=poolTotalReadIops, nfsTotalReadIops=nfsTotalReadIops, poolMetaReadLatency=poolMetaReadLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, poolDataWriteIops=poolDataWriteIops, iscsiInitiatorGroup=iscsiInitiatorGroup, smbSocketFailure=smbSocketFailure, haResourceStatus=haResourceStatus, fcInitiatorCreateFailed=fcInitiatorCreateFailed, shareDeletionFailed=shareDeletionFailed, sharePoolName=sharePoolName, iscsiTargetReadLatency=iscsiTargetReadLatency, cacheSSDReads=cacheSSDReads, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiTargetReadIops=iscsiTargetReadIops, iscsiTargetError=iscsiTargetError, replicationComplete=replicationComplete, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectDeleted=projectDeleted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskDataReadMbps=diskDataReadMbps, projectEntry=projectEntry, haResources=haResources, lunProjectName=lunProjectName, nicState=nicState, diskAvgWriteLatency=diskAvgWriteLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolTable=poolTable, haControllerB_IPAddr=haControllerB_IPAddr, upgradeTimeout=upgradeTimeout, nicMTU=nicMTU, shareNFSWriteLatency=shareNFSWriteLatency, networkInterfaceDown=networkInterfaceDown, ipmiPowerSupply=ipmiPowerSupply, globalStatistics=globalStatistics, replicationTargetDeleted=replicationTargetDeleted, lunReadMbps=lunReadMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcPortOnline=fcPortOnline, intelliFlashSoftwareUp=intelliFlashSoftwareUp, lunDataSizeHigh=lunDataSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, poolCount=poolCount, networkIpmpGroupUp=networkIpmpGroupUp, poolTotalReadMbps=poolTotalReadMbps, projectFreeSizeHigh=projectFreeSizeHigh, iscsiTargetWriteIops=iscsiTargetWriteIops, ipmiMemory=ipmiMemory, fcTotalReadIops=fcTotalReadIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, notificationComponentName=notificationComponentName, snmpServiceStopFailed=snmpServiceStopFailed, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, targetGroupMemberRemoved=targetGroupMemberRemoved, fcTotalWriteIops=fcTotalWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, sanProperties=sanProperties, upgradeCompleted=upgradeCompleted, PYSNMP_MODULE_ID=tegile, shareCIFSEnabled=shareCIFSEnabled, diskAlias=diskAlias, shareNFSWriteIops=shareNFSWriteIops, diskTotalWriteIops=diskTotalWriteIops, diskGoneOffline=diskGoneOffline, ipmiFan=ipmiFan, projectPoolName=projectPoolName, shareSnapshotSizeHigh=shareSnapshotSizeHigh, notificationReadingUnit=notificationReadingUnit, haControllerB_Uptime=haControllerB_Uptime, haControllerA_Name=haControllerA_Name, notificationTargetEntityName=notificationTargetEntityName, ipmiCriticalInterrupt=ipmiCriticalInterrupt, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, replicationStarted=replicationStarted, deleteFolderCompleted=deleteFolderCompleted, notificationSeverity=notificationSeverity, maintenanceModeEnabled=maintenanceModeEnabled, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, shareCIFSWriteIops=shareCIFSWriteIops, poolMetaWriteMbps=poolMetaWriteMbps, diskIOCount=diskIOCount, maintenanceModeDisabled=maintenanceModeDisabled, lunSnapshotSizeLow=lunSnapshotSizeLow, poolDataWriteLatency=poolDataWriteLatency, haResourcesTable=haResourcesTable, network=network, controllerUp=controllerUp, poolMetaWriteIops=poolMetaWriteIops, cacheTotalWriteIops=cacheTotalWriteIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, cifsTotalReadMbps=cifsTotalReadMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, haControllerA_Uptime=haControllerA_Uptime, fcInitiatorGroup=fcInitiatorGroup, snmpServiceStopped=snmpServiceStopped, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, snapshotCloningFailed=snapshotCloningFailed, iscsiTargetWriteMbps=iscsiTargetWriteMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, snapshotCreationFailed=snapshotCreationFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, fcTargetIndex=fcTargetIndex, poolMetaWriteLatency=poolMetaWriteLatency, iscsiTargetEntry=iscsiTargetEntry, fcTargetName=fcTargetName, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolReadCacheReadMbps=poolReadCacheReadMbps, tegileGroups=tegileGroups, lunSizeLow=lunSizeLow, shareDataSizeLow=shareDataSizeLow, diskSizeLow=diskSizeLow, nicTransmitMbps=nicTransmitMbps, cacheTotalReadMbps=cacheTotalReadMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, haResourceIndex=haResourceIndex, ipmiTemperature=ipmiTemperature, fcTargetReadMbps=fcTargetReadMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, ipmiThreshold=ipmiThreshold, cifsTotalWriteIops=cifsTotalWriteIops, iscsiTargetReadMbps=iscsiTargetReadMbps, diskCount=diskCount, tegileArray=tegileArray, fcTargetWriteLatency=fcTargetWriteLatency, volumeQuotaFinished=volumeQuotaFinished, diskTotalReadIops=diskTotalReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, notificationSensorNumber=notificationSensorNumber, replicationAbandoned=replicationAbandoned, memoryFailure=memoryFailure, iscsiTargetGroupError=iscsiTargetGroupError, cifsAvgWriteLatency=cifsAvgWriteLatency, snmpServiceStarted=snmpServiceStarted, disks=disks, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiTotalReadMbps=iscsiTotalReadMbps, currentNotificationGroup=currentNotificationGroup, shareDedupEnabled=shareDedupEnabled, poolDataReadMbps=poolDataReadMbps, lunInitiatorGroup=lunInitiatorGroup, networkInterfaceUp=networkInterfaceUp, fcTargets=fcTargets, poolMetaReadIops=poolMetaReadIops, lunReservedSizeHigh=lunReservedSizeHigh, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, ntpServerTimeDrift=ntpServerTimeDrift, tegileConformance=tegileConformance, lunReadLatency=lunReadLatency, iscsiTargetIndex=iscsiTargetIndex, iscsiTargetWriteLatency=iscsiTargetWriteLatency, diskEntry=diskEntry, poolDegraded=poolDegraded, notificationObjects=notificationObjects, upgradeStarted=upgradeStarted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, diagnosticDataUploaded=diagnosticDataUploaded, aclMigrationStarted=aclMigrationStarted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiWriteIops=iscsiWriteIops, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolDataSizeLow=poolDataSizeLow, shareExceedThresholdWarning=shareExceedThresholdWarning, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectQuotaSizeHigh=projectQuotaSizeHigh, shareProjectName=shareProjectName, haResourceEntry=haResourceEntry, iscsiTargetGroup=iscsiTargetGroup, tegile=tegile, snapshotCloneCompleted=snapshotCloneCompleted, fcTargetEntry=fcTargetEntry, fcInitiators=fcInitiators)
mibBuilder.exportSymbols("TEGILE-MIB", vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiTargetsTable=iscsiTargetsTable, networkTotalTransmitMbps=networkTotalTransmitMbps, tegileCompliances=tegileCompliances, netbiosSocketFailure=netbiosSocketFailure, smisServiceStarted=smisServiceStarted, cpuTotalUsage=cpuTotalUsage, adServerTimeDrift=adServerTimeDrift, iscsiInitiatorName=iscsiInitiatorName, diskError=diskError, diskSequentialIOCount=diskSequentialIOCount, volumeDeleteFailed=volumeDeleteFailed, unknownSensorEvent=unknownSensorEvent, poolDataReadLatency=poolDataReadLatency, diskTable=diskTable, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareNFSWriteMbps=shareNFSWriteMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolCreated=poolCreated, cacheTotalReadIops=cacheTotalReadIops, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiTargetName=iscsiTargetName, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, diskPoolName=diskPoolName, poolSizeLow=poolSizeLow, shareNFSReadLatency=shareNFSReadLatency, controllerDown=controllerDown, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcTargetReadLatency=fcTargetReadLatency, nicTable=nicTable, ipmiCurrent=ipmiCurrent, poolAvgWriteLatency=poolAvgWriteLatency, fcTotalReadMbps=fcTotalReadMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, poolDataReadIops=poolDataReadIops, diskState=diskState, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, shareQuotaHigh=shareQuotaHigh, ipmiVoltage=ipmiVoltage, replicationFailed=replicationFailed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareTable=shareTable, poolTotalSaving=poolTotalSaving, lunIndex=lunIndex, iscsiInitiatorIndex=iscsiInitiatorIndex, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, fcInitiatorsTable=fcInitiatorsTable, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcInitiatorName=fcInitiatorName, poolImported=poolImported, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolOwnerController=poolOwnerController, fcTotalWriteMbps=fcTotalWriteMbps, replicationAborted=replicationAborted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolTotalWriteMbps=poolTotalWriteMbps, poolUsedSizeHigh=poolUsedSizeHigh, lunGUID=lunGUID, deleteFolderFailed=deleteFolderFailed, fcTargetsTable=fcTargetsTable, poolHealth=poolHealth, poolTotalWriteIops=poolTotalWriteIops, poolDataWriteMbps=poolDataWriteMbps, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, notificationDescription=notificationDescription, notificationSensorSuspect=notificationSensorSuspect, cacheRAMReads=cacheRAMReads, lunTable=lunTable, nicName=nicName, alertsCleanupCompleted=alertsCleanupCompleted, lunPoolName=lunPoolName, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, diskTotalReadMbps=diskTotalReadMbps, projectTotalSaving=projectTotalSaving, shareCIFSWriteMbps=shareCIFSWriteMbps, haResourceActiveNode=haResourceActiveNode, diskIsOnline=diskIsOnline, poolDataSizeHigh=poolDataSizeHigh, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectShares=projectShares, initiatorGroupMemberAdded=initiatorGroupMemberAdded, nfsAvgWriteLatency=nfsAvgWriteLatency, diskTotalWriteMbps=diskTotalWriteMbps, projectDedupEnabled=projectDedupEnabled, shareName=shareName, snapshotRollbackFailed=snapshotRollbackFailed, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunProtocol=lunProtocol, shareCIFSReadLatency=shareCIFSReadLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, controllerTimeDrift=controllerTimeDrift, shareCompressionEnabled=shareCompressionEnabled, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunEntry=lunEntry, projectDeletionFailed=projectDeletionFailed, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haControllerB_Name=haControllerB_Name, notificationEventCode=notificationEventCode, projectDataSizeHigh=projectDataSizeHigh, iscsiTargetAlias=iscsiTargetAlias, projectDataSizeLow=projectDataSizeLow, shareCIFSReadIops=shareCIFSReadIops, iscsiTargetAuth=iscsiTargetAuth, projectQuotaSizeLow=projectQuotaSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps, poolQuotaFinished=poolQuotaFinished, upgradeFailed=upgradeFailed, shareQuotaLow=shareQuotaLow, projectFreeSizeLow=projectFreeSizeLow, upgradeDownloadCompleted=upgradeDownloadCompleted, shareMountPoint=shareMountPoint, diskDataReadIops=diskDataReadIops, tegileArray_notifications=tegileArray_notifications, cpuInterrupts=cpuInterrupts, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolReadCacheWriteIops=poolReadCacheWriteIops, poolSizeHigh=poolSizeHigh, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, haControllerA_IPAddr=haControllerA_IPAddr, notifications=notifications, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, snapshotDeleteFailed=snapshotDeleteFailed, properties=properties, lunSizeHigh=lunSizeHigh, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectLUNs=projectLUNs, controllerHardwareModel=controllerHardwareModel, diskType=diskType, lunBlockSize=lunBlockSize, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, replicationPaused=replicationPaused, projectIndex=projectIndex, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcProperties=fcProperties, projectLunCount=projectLunCount, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, spareDiskReplaced=spareDiskReplaced, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, nicGroup=nicGroup, projectQuotaFinished=projectQuotaFinished, lunWriteIops=lunWriteIops, fcTargetReadIops=fcTargetReadIops, volumeDeleteCompleted=volumeDeleteCompleted, cifsTotalReadIops=cifsTotalReadIops, poolReadCacheReadLatency=poolReadCacheReadLatency, shareCompressedRatio=shareCompressedRatio, shareNFSReadIops=shareNFSReadIops, upgradeDownloadStarted=upgradeDownloadStarted, basicCompliance=basicCompliance, notificationTime=notificationTime, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcTargetStatus=fcTargetStatus, poolDeleted=poolDeleted, poolUpgraded=poolUpgraded, volumeCreatedSuccessfully=volumeCreatedSuccessfully, nvdimmFailDeviceError=nvdimmFailDeviceError, fcAvgWriteLatency=fcAvgWriteLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, ipmiOther=ipmiOther, diskChassisIdx=diskChassisIdx, cifsTotalWriteMbps=cifsTotalWriteMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, nvdimmFailSoftError=nvdimmFailSoftError, poolDeletionFailed=poolDeletionFailed, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, nfsTotalWriteIops=nfsTotalWriteIops, iscsiTotalReadIops=iscsiTotalReadIops, haResourceGroup=haResourceGroup, networkIpmpGroupDown=networkIpmpGroupDown, poolProjects=poolProjects, iscsiAvgReadLatency=iscsiAvgReadLatency, lunTargetGroup=lunTargetGroup, shareReservedSizeLow=shareReservedSizeLow, lunWriteMbps=lunWriteMbps, shareNFSEnabled=shareNFSEnabled, poolFreeSizeHigh=poolFreeSizeHigh, diskIndex=diskIndex, lunName=lunName, snmpAgentVersion=snmpAgentVersion, projectTable=projectTable, iscsiInitiatorsTable=iscsiInitiatorsTable, fcAvgReadLatency=fcAvgReadLatency, replicationResumed=replicationResumed, lunCompressedRatio=lunCompressedRatio, fcTargetWriteIops=fcTargetWriteIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, shareDeleted=shareDeleted, haResourceDescription=haResourceDescription, nvdimmFailInitializationError=nvdimmFailInitializationError, lunCompressionEnabled=lunCompressionEnabled, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, poolUsedSizeLow=poolUsedSizeLow, shareIndex=shareIndex, shareEntry=shareEntry, poolEntry=poolEntry, poolIndex=poolIndex, poolProjectCount=poolProjectCount, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareReservedSizeHigh=shareReservedSizeHigh, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunWriteLatency=lunWriteLatency, poolState=poolState, diskDataWriteIops=diskDataWriteIops, projectSnapshotSizeLow=projectSnapshotSizeLow, fcInitiatorIndex=fcInitiatorIndex)
