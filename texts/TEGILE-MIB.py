...
# Produced by pysmi-1.1.8 at Sat Jan 15 18:20:24 2022
...
IpAddress, Counter64, MibIdentifier, Bits, Counter32, iso, Unsigned32, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, ModuleIdentity, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "MibIdentifier", "Bits", "Counter32", "iso", "Unsigned32", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "ModuleIdentity", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", cpuInterrupts=cpuInterrupts, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, currentObjectGroup=currentObjectGroup, fcTargetReadLatency=fcTargetReadLatency, fcTargetReadMbps=fcTargetReadMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, nfsTotalWriteIops=nfsTotalWriteIops, nicEntry=nicEntry, diskType=diskType, cacheTotalWriteMbps=cacheTotalWriteMbps, lunEntry=lunEntry, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskTotalWriteIops=diskTotalWriteIops, cifsTotalWriteIops=cifsTotalWriteIops, shareNFSWriteLatency=shareNFSWriteLatency, cifsAvgReadLatency=cifsAvgReadLatency, fcInitiatorName=fcInitiatorName, diskChassisIdx=diskChassisIdx, lunDataSizeHigh=lunDataSizeHigh, cacheSSDReads=cacheSSDReads, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargets=fcTargets, poolMetaReadIops=poolMetaReadIops, fcInitiatorGroup=fcInitiatorGroup, lunProtocol=lunProtocol, iscsiTargetAuth=iscsiTargetAuth, poolCount=poolCount, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, upgradeDownloadFailed=upgradeDownloadFailed, nicIndex=nicIndex, poolDeleted=poolDeleted, notificationProps=notificationProps, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, haResourceGroup=haResourceGroup, haControllerA_IPAddr=haControllerA_IPAddr, projectThresholdExceedWarning=projectThresholdExceedWarning, poolTotalReadIops=poolTotalReadIops, lunDataSizeLow=lunDataSizeLow, diskTable=diskTable, notificationReadingUnit=notificationReadingUnit, shareNFSWriteIops=shareNFSWriteIops, lunReservedSizeHigh=lunReservedSizeHigh, network=network, diskCount=diskCount, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, notificationReadingTriggerValue=notificationReadingTriggerValue, userLoginFailed=userLoginFailed, shareNFSReadMbps=shareNFSReadMbps, shareMountPoint=shareMountPoint, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, diskDataWriteMbps=diskDataWriteMbps, poolTotalSaving=poolTotalSaving, shareDeletionFailed=shareDeletionFailed, ipmiVoltage=ipmiVoltage, diskPoolName=diskPoolName, lunCompressionEnabled=lunCompressionEnabled, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, ipmiOther=ipmiOther, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareCreatedSuccessfully=shareCreatedSuccessfully, poolMetaReadMbps=poolMetaReadMbps, diskSizeHigh=diskSizeHigh, snmpServiceStopFailed=snmpServiceStopFailed, notificationEventCode=notificationEventCode, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolTotalWriteIops=poolTotalWriteIops, iscsiInitiatorName=iscsiInitiatorName, lunReadLatency=lunReadLatency, poolAvgWriteLatency=poolAvgWriteLatency, fcTargetWriteMbps=fcTargetWriteMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, ipmiMemory=ipmiMemory, cacheRAMReads=cacheRAMReads, poolDataReadMbps=poolDataReadMbps, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunReservedSizeLow=lunReservedSizeLow, diskTotalWriteMbps=diskTotalWriteMbps, shareCIFSReadIops=shareCIFSReadIops, poolExported=poolExported, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, shareNFSReadIops=shareNFSReadIops, notificationSensorNumber=notificationSensorNumber, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, cifsTotalWriteMbps=cifsTotalWriteMbps, lunWriteLatency=lunWriteLatency, diskSequentialIOCount=diskSequentialIOCount, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, networkTotalReceiveMbps=networkTotalReceiveMbps, alertsCleanupCompleted=alertsCleanupCompleted, projectFreeSizeHigh=projectFreeSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, notificationObjects=notificationObjects, cifsAvgWriteLatency=cifsAvgWriteLatency, lunFreeSizeLow=lunFreeSizeLow, upgradeDownloadStarted=upgradeDownloadStarted, PYSNMP_MODULE_ID=tegile, fcTotalWriteIops=fcTotalWriteIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, lunReadMbps=lunReadMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, fcTargetReadIops=fcTargetReadIops, lunWriteIops=lunWriteIops, poolProjectCount=poolProjectCount, iscsiTargetIndex=iscsiTargetIndex, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolWriteCacheWriteIops=poolWriteCacheWriteIops, deleteFolderCompleted=deleteFolderCompleted, lunDedupEnabled=lunDedupEnabled, replicationAborted=replicationAborted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, lunName=lunName, snapshotCloneCompleted=snapshotCloneCompleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, cifsTotalReadIops=cifsTotalReadIops, poolName=poolName, projectEntry=projectEntry, fcTargetWriteIops=fcTargetWriteIops, replicationFailed=replicationFailed, poolState=poolState, fcProperties=fcProperties, targetGroupMemberRemoved=targetGroupMemberRemoved, fcTargetsTable=fcTargetsTable, projectPoolName=projectPoolName, haControllerB_IPAddr=haControllerB_IPAddr, snmpServiceStarted=snmpServiceStarted, projectCreatedSuccessfully=projectCreatedSuccessfully, fcTargetGroup=fcTargetGroup, smisServiceStopFailed=smisServiceStopFailed, webdocsUpgradeCompleted=webdocsUpgradeCompleted, haControllerB_Uptime=haControllerB_Uptime, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, currentNotificationGroup=currentNotificationGroup, iscsiTargetError=iscsiTargetError, replicationTargetDeleted=replicationTargetDeleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareProjectName=shareProjectName, lunSizeHigh=lunSizeHigh, fcTotalReadIops=fcTotalReadIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectShareCount=projectShareCount, ipmiPowerSupply=ipmiPowerSupply, poolDataWriteIops=poolDataWriteIops, networkIpmpGroupDown=networkIpmpGroupDown, controllerUp=controllerUp, upgradeDownloadCompleted=upgradeDownloadCompleted, fcInitiators=fcInitiators, shareDedupEnabled=shareDedupEnabled, poolUpgraded=poolUpgraded, replicationStarted=replicationStarted, projectQuotaSizeHigh=projectQuotaSizeHigh, poolUsedSizeLow=poolUsedSizeLow, iscsiTotalReadMbps=iscsiTotalReadMbps, notificationSensorSuspect=notificationSensorSuspect, snmpServiceStartFailed=snmpServiceStartFailed, networkInterfaceUp=networkInterfaceUp, tegileGroups=tegileGroups, iscsiTargetWriteIops=iscsiTargetWriteIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolTable=poolTable, fcInitiatorCreateFailed=fcInitiatorCreateFailed, haResourceActiveNode=haResourceActiveNode, replicationAbandoned=replicationAbandoned, memoryFailure=memoryFailure, projectDeletionFailed=projectDeletionFailed, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, lunWriteMbps=lunWriteMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, poolSizeHigh=poolSizeHigh, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, nfsTotalReadIops=nfsTotalReadIops, diskDataReadIops=diskDataReadIops, projectDataSizeHigh=projectDataSizeHigh, poolDataWriteLatency=poolDataWriteLatency, tegileCompliances=tegileCompliances, smisServiceStarted=smisServiceStarted, nicTransmitMbps=nicTransmitMbps, poolSizeLow=poolSizeLow, projectSnapshotSizeHigh=projectSnapshotSizeHigh, controllerTimeDrift=controllerTimeDrift, fcTotalReadMbps=fcTotalReadMbps, fcTargetWriteLatency=fcTargetWriteLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, poolFreeSizeHigh=poolFreeSizeHigh, poolCreated=poolCreated, poolImported=poolImported, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectIndex=projectIndex, shareCIFSWriteLatency=shareCIFSWriteLatency, ipmiFan=ipmiFan, iscsiTotalReadIops=iscsiTotalReadIops, volumeModifyCompleted=volumeModifyCompleted, projectTotalSaving=projectTotalSaving, diskIsOnline=diskIsOnline, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry, poolQuotaFinished=poolQuotaFinished, replicationPaused=replicationPaused, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiProperties=iscsiProperties, cpuTotalUsage=cpuTotalUsage, shareDataSizeHigh=shareDataSizeHigh, shareQuotaHigh=shareQuotaHigh, shareCompressedRatio=shareCompressedRatio, upgradeCompleted=upgradeCompleted, iscsiWriteIops=iscsiWriteIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, cifsTotalReadMbps=cifsTotalReadMbps, ipmiCurrent=ipmiCurrent, haResourceStatus=haResourceStatus, haResourceEntry=haResourceEntry, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareCIFSEnabled=shareCIFSEnabled, diskDataWriteIops=diskDataWriteIops, sharePoolName=sharePoolName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTargetsTable=iscsiTargetsTable, lunProjectName=lunProjectName, shareCompressionEnabled=shareCompressionEnabled, projectShares=projectShares, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareQuotaFinished=shareQuotaFinished, sanProperties=sanProperties, shareDataSizeLow=shareDataSizeLow, snapshotRollbackCompleted=snapshotRollbackCompleted, disks=disks, aclMigrationCompleted=aclMigrationCompleted, poolAvgReadLatency=poolAvgReadLatency, iscsiTargets=iscsiTargets, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, haControllerA_Name=haControllerA_Name, spareDiskReplaced=spareDiskReplaced, sensorFailureEvent=sensorFailureEvent, diskGoneOffline=diskGoneOffline, diskSlowIo=diskSlowIo, smbSocketFailure=smbSocketFailure, projectTable=projectTable, fcPortOffline=fcPortOffline, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcTargetName=fcTargetName, fcInitiatorIndex=fcInitiatorIndex, ipmiThreshold=ipmiThreshold, snapshotCloningFailed=snapshotCloningFailed, cpuSystemCalls=cpuSystemCalls, haControllerB_Name=haControllerB_Name, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiTargetReadMbps=iscsiTargetReadMbps)
mibBuilder.exportSymbols("TEGILE-MIB", shareSnapshotSizeLow=shareSnapshotSizeLow, fcPortOnline=fcPortOnline, projectSnapshotSizeLow=projectSnapshotSizeLow, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolIndex=poolIndex, nvdimmFailUnknownError=nvdimmFailUnknownError, haResourceIndex=haResourceIndex, poolFreeSizeLow=poolFreeSizeLow, poolTotalWriteMbps=poolTotalWriteMbps, fcInitiatorsTable=fcInitiatorsTable, nvdimmFailDeviceError=nvdimmFailDeviceError, lunTable=lunTable, lunReadIops=lunReadIops, nicTable=nicTable, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, snapshotDeleteFailed=snapshotDeleteFailed, diskEntry=diskEntry, diskTotalReadIops=diskTotalReadIops, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolDataSizeHigh=poolDataSizeHigh, poolMetaWriteIops=poolMetaWriteIops, haResourceName=haResourceName, fcAvgReadLatency=fcAvgReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareQuotaLow=shareQuotaLow, haResourceDescription=haResourceDescription, diskIndex=diskIndex, lunSnapshotSizeLow=lunSnapshotSizeLow, diskError=diskError, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunBlockSize=lunBlockSize, poolReadCacheReadMbps=poolReadCacheReadMbps, snapshotCreationFailed=snapshotCreationFailed, vmwareNFSDatastores=vmwareNFSDatastores, diskDataReadMbps=diskDataReadMbps, cacheTotalWriteIops=cacheTotalWriteIops, nicGroup=nicGroup, fcAvgWriteLatency=fcAvgWriteLatency, upgradeStarted=upgradeStarted, poolMetaWriteLatency=poolMetaWriteLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareCIFSReadLatency=shareCIFSReadLatency, poolEntry=poolEntry, haResources=haResources, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectModified=projectModified, aclMigrationStarted=aclMigrationStarted, iscsiAvgReadLatency=iscsiAvgReadLatency, lunGUID=lunGUID, diskAvgReadLatency=diskAvgReadLatency, iscsiTargetGroupError=iscsiTargetGroupError, replicationComplete=replicationComplete, snapshotRollbackFailed=snapshotRollbackFailed, iscsiTargetAlias=iscsiTargetAlias, nvdimmFailSoftError=nvdimmFailSoftError, lunSizeLow=lunSizeLow, tegile=tegile, projectQuotaSizeLow=projectQuotaSizeLow, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, fcTargetIndex=fcTargetIndex, projectDataSizeLow=projectDataSizeLow, globalStatistics=globalStatistics, smisServiceStopped=smisServiceStopped, poolDataReadLatency=poolDataReadLatency, volumeDeleteCompleted=volumeDeleteCompleted, snmpServiceStopped=snmpServiceStopped, poolProjects=poolProjects, cacheTotalReadMbps=cacheTotalReadMbps, poolDataReadIops=poolDataReadIops, lunCompressedRatio=lunCompressedRatio, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, fcTargetEntry=fcTargetEntry, haResourcesTable=haResourcesTable, pools=pools, notificationComponentName=notificationComponentName, iscsiTargetGroup=iscsiTargetGroup, cacheTotalReadIops=cacheTotalReadIops, shareNFSReadLatency=shareNFSReadLatency, volumeDeleteFailed=volumeDeleteFailed, shareIndex=shareIndex, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, tegileConformance=tegileConformance, iscsiTargetReadIops=iscsiTargetReadIops, notifications=notifications, notificationThresholdTriggerValue=notificationThresholdTriggerValue, haControllerA_Uptime=haControllerA_Uptime, projectLunCount=projectLunCount, fcTotalWriteMbps=fcTotalWriteMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, upgradeTimeout=upgradeTimeout, networkInterfaceDown=networkInterfaceDown, shareDeleted=shareDeleted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, volumeQuotaFinished=volumeQuotaFinished, ipmiTemperature=ipmiTemperature, diskTotalReadMbps=diskTotalReadMbps, notificationTargetEntityName=notificationTargetEntityName, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolReadCacheReadIops=poolReadCacheReadIops, nicReceiveMbps=nicReceiveMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, shareTable=shareTable, tegileArray_notifications=tegileArray_notifications, notificationSensorAction=notificationSensorAction, projectDedupEnabled=projectDedupEnabled, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolTotalReadMbps=poolTotalReadMbps, iscsiInitiators=iscsiInitiators, tdpsUpgradeTimeout=tdpsUpgradeTimeout, targetGroupMemberAdded=targetGroupMemberAdded, shareReservedSizeHigh=shareReservedSizeHigh, maintenanceModeEnabled=maintenanceModeEnabled, nicName=nicName, controllerHardwareModel=controllerHardwareModel, lunTargetGroup=lunTargetGroup, controllerDown=controllerDown, fcTargetModifyCompleted=fcTargetModifyCompleted, fcInitiatorEntry=fcInitiatorEntry, notificationSeverity=notificationSeverity, poolReadCacheWriteIops=poolReadCacheWriteIops, poolDeletionFailed=poolDeletionFailed, projectDeleted=projectDeleted, poolUsedSizeHigh=poolUsedSizeHigh, iscsiTargetWriteLatency=iscsiTargetWriteLatency, maintenanceModeDisabled=maintenanceModeDisabled, nfsTotalWriteMbps=nfsTotalWriteMbps, projectName=projectName, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, diskSizeLow=diskSizeLow, upgradeFailed=upgradeFailed, networkIpmpGroupUp=networkIpmpGroupUp, nicMTU=nicMTU, testNotification=testNotification, shareEntry=shareEntry, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, diskState=diskState, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectFreeSizeLow=projectFreeSizeLow, basicCompliance=basicCompliance, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcTargetStatus=fcTargetStatus, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, targetGroupCreateCompleted=targetGroupCreateCompleted, shareCIFSReadMbps=shareCIFSReadMbps, projectCompressionEnabled=projectCompressionEnabled, diskAlias=diskAlias, poolDegraded=poolDegraded, poolMetaWriteMbps=poolMetaWriteMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunIndex=lunIndex, replicationResumed=replicationResumed, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, properties=properties, lunPoolName=lunPoolName, lunInitiatorGroup=lunInitiatorGroup, ntpServerTimeDrift=ntpServerTimeDrift, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, unknownSensorEvent=unknownSensorEvent, nvdimmFailInitializationError=nvdimmFailInitializationError, diskRandomIOCount=diskRandomIOCount, replicationSourceRegistered=replicationSourceRegistered, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, notificationTime=notificationTime, notificationDescription=notificationDescription, deleteFolderFailed=deleteFolderFailed, netbiosSocketFailure=netbiosSocketFailure, smisServiceStartFailed=smisServiceStartFailed, shareExceedThresholdWarning=shareExceedThresholdWarning, projectQuotaFinished=projectQuotaFinished, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolMetaReadLatency=poolMetaReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolExpanded=poolExpanded, shareReservedSizeLow=shareReservedSizeLow, iscsiTargetEntry=iscsiTargetEntry, poolDataWriteMbps=poolDataWriteMbps, shareName=shareName, shareCIFSWriteIops=shareCIFSWriteIops, nicState=nicState, diskIOCount=diskIOCount, lunFreeSizeHigh=lunFreeSizeHigh, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, diagnosticDataUploaded=diagnosticDataUploaded, snmpAgentVersion=snmpAgentVersion, nfsTotalReadMbps=nfsTotalReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, tegileArray=tegileArray, iscsiTargetName=iscsiTargetName, adServerTimeDrift=adServerTimeDrift, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareNFSEnabled=shareNFSEnabled, poolOwnerController=poolOwnerController, poolHealth=poolHealth, projectLUNs=projectLUNs, networkTotalTransmitMbps=networkTotalTransmitMbps)
