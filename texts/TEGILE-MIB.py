...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Gauge32, TimeTicks, NotificationType, Integer32, Counter64, ModuleIdentity, MibIdentifier, IpAddress, ObjectIdentity, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Gauge32", "TimeTicks", "NotificationType", "Integer32", "Counter64", "ModuleIdentity", "MibIdentifier", "IpAddress", "ObjectIdentity", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", cifsTotalWriteIops=cifsTotalWriteIops, shareDataSizeHigh=shareDataSizeHigh, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolDeletionFailed=poolDeletionFailed, poolProjects=poolProjects, shareDeleted=shareDeleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolMetaReadMbps=poolMetaReadMbps, shareTable=shareTable, haResourceDescription=haResourceDescription, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, adServerTimeDrift=adServerTimeDrift, tdpsUpgradeFailed=tdpsUpgradeFailed, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, fcInitiatorGroup=fcInitiatorGroup, projectQuotaSizeLow=projectQuotaSizeLow, networkIpmpGroupUp=networkIpmpGroupUp, tegileArray=tegileArray, networkTotalTransmitMbps=networkTotalTransmitMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcAvgReadLatency=fcAvgReadLatency, nicMTU=nicMTU, fcInitiatorsTable=fcInitiatorsTable, tegileArray_notifications=tegileArray_notifications, aclMigrationCompleted=aclMigrationCompleted, fcTargetReadIops=fcTargetReadIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, replicationSourceRegistered=replicationSourceRegistered, poolDataReadLatency=poolDataReadLatency, diskState=diskState, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, cacheRAMReads=cacheRAMReads, poolOwnerController=poolOwnerController, fcTargetIndex=fcTargetIndex, nfsAvgWriteLatency=nfsAvgWriteLatency, vmwareNFSDatastores=vmwareNFSDatastores, poolWriteCacheWriteIops=poolWriteCacheWriteIops, controllerHardwareModel=controllerHardwareModel, nicIndex=nicIndex, nicTable=nicTable, lunSnapshotSizeHigh=lunSnapshotSizeHigh, replicationStarted=replicationStarted, lunReservedSizeHigh=lunReservedSizeHigh, fcTargetWriteMbps=fcTargetWriteMbps, currentObjectGroup=currentObjectGroup, poolName=poolName, nvdimmFailInitializationError=nvdimmFailInitializationError, diskGoneOffline=diskGoneOffline, nicEntry=nicEntry, diskDataWriteIops=diskDataWriteIops, iscsiInitiatorGroup=iscsiInitiatorGroup, fcTotalWriteIops=fcTotalWriteIops, shareCreatedSuccessfully=shareCreatedSuccessfully, poolMetaWriteMbps=poolMetaWriteMbps, sharePoolName=sharePoolName, cifsTotalWriteMbps=cifsTotalWriteMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, spareDiskReplaced=spareDiskReplaced, haControllerB_Name=haControllerB_Name, replicationResumed=replicationResumed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, diskAlias=diskAlias, replicationTargetDeleted=replicationTargetDeleted, iscsiWriteIops=iscsiWriteIops, lunFreeSizeLow=lunFreeSizeLow, haResourcesTable=haResourcesTable, diskTotalReadMbps=diskTotalReadMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, targetGroupCreateCompleted=targetGroupCreateCompleted, nvdimmFailSoftError=nvdimmFailSoftError, upgradeFailed=upgradeFailed, lunCompressedRatio=lunCompressedRatio, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, tegile=tegile, poolDataSizeHigh=poolDataSizeHigh, unknownSensorEvent=unknownSensorEvent, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskDataWriteMbps=diskDataWriteMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, fcInitiators=fcInitiators, lunReservedSizeLow=lunReservedSizeLow, nvdimmFailUnknownError=nvdimmFailUnknownError, projectCompressionEnabled=projectCompressionEnabled, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcTargetModifyCompleted=fcTargetModifyCompleted, diskDataReadIops=diskDataReadIops, poolDataWriteLatency=poolDataWriteLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareCIFSReadIops=shareCIFSReadIops, cacheTotalReadIops=cacheTotalReadIops, iscsiTotalReadMbps=iscsiTotalReadMbps, poolTotalWriteIops=poolTotalWriteIops, diskPoolName=diskPoolName, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiTargets=iscsiTargets, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareReservedSizeLow=shareReservedSizeLow, notificationSensorNumber=notificationSensorNumber, volumeModifyCompleted=volumeModifyCompleted, sanProperties=sanProperties, iscsiInitiators=iscsiInitiators, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, smisServiceStarted=smisServiceStarted, cacheTotalWriteIops=cacheTotalWriteIops, shareCIFSEnabled=shareCIFSEnabled, shareQuotaLow=shareQuotaLow, diskAvgWriteLatency=diskAvgWriteLatency, lunEntry=lunEntry, shareMountPoint=shareMountPoint, smbSocketFailure=smbSocketFailure, shareDeletionFailed=shareDeletionFailed, poolMetaReadLatency=poolMetaReadLatency, shareCIFSReadMbps=shareCIFSReadMbps, maintenanceModeDisabled=maintenanceModeDisabled, volumeDeleteFailed=volumeDeleteFailed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, pools=pools, upgradeDownloadCompleted=upgradeDownloadCompleted, poolTable=poolTable, notificationReadingUnit=notificationReadingUnit, poolState=poolState, diagnosticDataUploaded=diagnosticDataUploaded, shareCompressedRatio=shareCompressedRatio, tdpsUpgradeTimeout=tdpsUpgradeTimeout, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareNFSWriteLatency=shareNFSWriteLatency, poolUpgraded=poolUpgraded, diskIndex=diskIndex, iscsiTargetName=iscsiTargetName, fcPortOnline=fcPortOnline, projectThresholdExceedWarning=projectThresholdExceedWarning, diskIsOnline=diskIsOnline, poolMetaReadIops=poolMetaReadIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, memoryFailure=memoryFailure, iscsiInitiatorName=iscsiInitiatorName, poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, shareNFSReadMbps=shareNFSReadMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, replicationComplete=replicationComplete, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, testNotification=testNotification, controllerTimeDrift=controllerTimeDrift, cifsAvgReadLatency=cifsAvgReadLatency, upgradeTimeout=upgradeTimeout, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunReadIops=lunReadIops, targetGroupMemberAdded=targetGroupMemberAdded, shareExceedThresholdWarning=shareExceedThresholdWarning, replicationAbandoned=replicationAbandoned, upgradeCompleted=upgradeCompleted, projectTotalSaving=projectTotalSaving, lunWriteIops=lunWriteIops, poolHealth=poolHealth, notificationDescription=notificationDescription, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, ipmiCurrent=ipmiCurrent, shareDedupEnabled=shareDedupEnabled, projectFreeSizeLow=projectFreeSizeLow, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTargetIndex=iscsiTargetIndex, projectDeleted=projectDeleted, networkTotalReceiveMbps=networkTotalReceiveMbps, fcTargetWriteIops=fcTargetWriteIops, snmpAgentVersion=snmpAgentVersion, iscsiTargetsTable=iscsiTargetsTable, upgradeDownloadStarted=upgradeDownloadStarted, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, haControllerA_IPAddr=haControllerA_IPAddr, poolDataWriteIops=poolDataWriteIops, poolDataReadIops=poolDataReadIops, lunSizeHigh=lunSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, targetGroupDeleteCompleted=targetGroupDeleteCompleted, diskTable=diskTable, poolDeleted=poolDeleted, poolSizeLow=poolSizeLow, upgradeDownloadFailed=upgradeDownloadFailed, poolReadCacheReadMbps=poolReadCacheReadMbps, shareQuotaFinished=shareQuotaFinished, fcTargetsTable=fcTargetsTable, shareNFSWriteMbps=shareNFSWriteMbps, fcProperties=fcProperties, poolDataReadMbps=poolDataReadMbps, cifsTotalReadMbps=cifsTotalReadMbps, poolUsedSizeLow=poolUsedSizeLow, diskSizeHigh=diskSizeHigh, projectDedupEnabled=projectDedupEnabled, lunTable=lunTable, iscsiTotalReadIops=iscsiTotalReadIops, snmpServiceStopFailed=snmpServiceStopFailed, networkInterfaceDown=networkInterfaceDown, volumeDeleteCompleted=volumeDeleteCompleted, networkInterfaceUp=networkInterfaceUp, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareEntry=shareEntry, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, ipmiVoltage=ipmiVoltage, poolTotalWriteMbps=poolTotalWriteMbps, lunCompressionEnabled=lunCompressionEnabled, fcInitiatorIndex=fcInitiatorIndex, lunReadMbps=lunReadMbps, shareNFSReadIops=shareNFSReadIops, haControllerB_IPAddr=haControllerB_IPAddr, diskSequentialIOCount=diskSequentialIOCount, iscsiTargetEntry=iscsiTargetEntry, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareQuotaHigh=shareQuotaHigh, haResourceEntry=haResourceEntry, haResources=haResources, poolAvgReadLatency=poolAvgReadLatency, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectIndex=projectIndex, lunTargetGroup=lunTargetGroup, targetGroupMemberRemoved=targetGroupMemberRemoved, ipmiPowerSupply=ipmiPowerSupply, tegileConformance=tegileConformance, tegileCompliances=tegileCompliances, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunReadLatency=lunReadLatency, nicTransmitMbps=nicTransmitMbps, smisServiceStopped=smisServiceStopped, notificationSensorAction=notificationSensorAction, tdpsUpgradeCompleted=tdpsUpgradeCompleted, haResourceActiveNode=haResourceActiveNode, snmpServiceStartFailed=snmpServiceStartFailed, shareName=shareName, fcInitiatorEntry=fcInitiatorEntry, haControllerB_Uptime=haControllerB_Uptime, iscsiTargetGroup=iscsiTargetGroup, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, snapshotCloningFailed=snapshotCloningFailed, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, cifsAvgWriteLatency=cifsAvgWriteLatency, shareNFSWriteIops=shareNFSWriteIops, projectEntry=projectEntry, lunSnapshotSizeLow=lunSnapshotSizeLow, snmpServiceStarted=snmpServiceStarted, diskAvgReadLatency=diskAvgReadLatency, fcTotalReadMbps=fcTotalReadMbps, cacheSSDReads=cacheSSDReads, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunDataSizeLow=lunDataSizeLow, projectDataSizeLow=projectDataSizeLow, shareCIFSWriteLatency=shareCIFSWriteLatency, snmpServiceStopped=snmpServiceStopped, projectPoolName=projectPoolName, poolEntry=poolEntry)
mibBuilder.exportSymbols("TEGILE-MIB", nfsTotalWriteMbps=nfsTotalWriteMbps, alertsCleanupCompleted=alertsCleanupCompleted, projectName=projectName, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, diskChassisIdx=diskChassisIdx, lunGUID=lunGUID, lunName=lunName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskIOCount=diskIOCount, smisServiceStopFailed=smisServiceStopFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, replicationFailed=replicationFailed, iscsiProperties=iscsiProperties, notifications=notifications, ipmiMemory=ipmiMemory, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, sensorFailureEvent=sensorFailureEvent, ntpServerTimeDrift=ntpServerTimeDrift, projectLUNs=projectLUNs, projectDataSizeHigh=projectDataSizeHigh, shareSnapshotSizeLow=shareSnapshotSizeLow, fcTargetName=fcTargetName, projectQuotaFinished=projectQuotaFinished, haResourceIndex=haResourceIndex, nicState=nicState, nicReceiveMbps=nicReceiveMbps, notificationProps=notificationProps, iscsiAvgReadLatency=iscsiAvgReadLatency, lunWriteLatency=lunWriteLatency, poolMetaWriteIops=poolMetaWriteIops, fcAvgWriteLatency=fcAvgWriteLatency, maintenanceModeEnabled=maintenanceModeEnabled, aclMigrationStarted=aclMigrationStarted, replicationPaused=replicationPaused, controllerUp=controllerUp, diskTotalWriteMbps=diskTotalWriteMbps, cpuSystemCalls=cpuSystemCalls, deleteFolderFailed=deleteFolderFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, disks=disks, volumeQuotaFinished=volumeQuotaFinished, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcTargetReadLatency=fcTargetReadLatency, lunInitiatorGroup=lunInitiatorGroup, poolFreeSizeHigh=poolFreeSizeHigh, snapshotRollbackFailed=snapshotRollbackFailed, iscsiInitiatorEntry=iscsiInitiatorEntry, userLoginFailed=userLoginFailed, poolDegraded=poolDegraded, notificationReadingTriggerValue=notificationReadingTriggerValue, ipmiOther=ipmiOther, ipmiCriticalInterrupt=ipmiCriticalInterrupt, notificationSeverity=notificationSeverity, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolSizeHigh=poolSizeHigh, fcInitiatorName=fcInitiatorName, lunPoolName=lunPoolName, diskCount=diskCount, iscsiTargetAlias=iscsiTargetAlias, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, smisServiceStartFailed=smisServiceStartFailed, poolIndex=poolIndex, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolTotalReadMbps=poolTotalReadMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareReservedSizeHigh=shareReservedSizeHigh, nfsTotalWriteIops=nfsTotalWriteIops, lunProtocol=lunProtocol, shareIndex=shareIndex, ipmiThreshold=ipmiThreshold, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareDataSizeLow=shareDataSizeLow, notificationTargetEntityName=notificationTargetEntityName, basicCompliance=basicCompliance, cpuTotalUsage=cpuTotalUsage, lunDataSizeHigh=lunDataSizeHigh, haResourceStatus=haResourceStatus, nfsTotalReadIops=nfsTotalReadIops, properties=properties, replicationAborted=replicationAborted, projectFreeSizeHigh=projectFreeSizeHigh, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, haResourceName=haResourceName, projectQuotaSizeHigh=projectQuotaSizeHigh, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolDataWriteMbps=poolDataWriteMbps, shareCIFSWriteIops=shareCIFSWriteIops, PYSNMP_MODULE_ID=tegile, currentNotificationGroup=currentNotificationGroup, nvdimmFailDeviceError=nvdimmFailDeviceError, nfsAvgReadLatency=nfsAvgReadLatency, diskTotalWriteIops=diskTotalWriteIops, poolAvgWriteLatency=poolAvgWriteLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, shareCIFSReadLatency=shareCIFSReadLatency, shareCompressionEnabled=shareCompressionEnabled, fcTargetGroup=fcTargetGroup, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diskRandomIOCount=diskRandomIOCount, diskSizeLow=diskSizeLow, nfsTotalReadMbps=nfsTotalReadMbps, poolCount=poolCount, notificationObjects=notificationObjects, ipmiFan=ipmiFan, poolImported=poolImported, poolUsedSizeHigh=poolUsedSizeHigh, lunWriteMbps=lunWriteMbps, poolFreeSizeLow=poolFreeSizeLow, shareNFSEnabled=shareNFSEnabled, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcPortOffline=fcPortOffline, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectSnapshotSizeLow=projectSnapshotSizeLow, cacheTotalReadMbps=cacheTotalReadMbps, poolQuotaFinished=poolQuotaFinished, fcTargets=fcTargets, poolTotalReadIops=poolTotalReadIops, iscsiTargetWriteLatency=iscsiTargetWriteLatency, globalStatistics=globalStatistics, diskTotalReadIops=diskTotalReadIops, diskError=diskError, poolCreated=poolCreated, poolExported=poolExported, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, snapshotCloneCompleted=snapshotCloneCompleted, diskDataReadMbps=diskDataReadMbps, upgradeStarted=upgradeStarted, poolReadCacheReadIops=poolReadCacheReadIops, poolExpanded=poolExpanded, iscsiTargetError=iscsiTargetError, lunIndex=lunIndex, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, notificationComponentName=notificationComponentName, projectLunCount=projectLunCount, diskSlowIo=diskSlowIo, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectShareCount=projectShareCount, fcTotalWriteMbps=fcTotalWriteMbps, poolProjectCount=poolProjectCount, poolReadCacheWriteMbps=poolReadCacheWriteMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectShares=projectShares, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, iscsiTargetGroupError=iscsiTargetGroupError, lunBlockSize=lunBlockSize, lunDedupEnabled=lunDedupEnabled, notificationTime=notificationTime, iscsiTargetAuth=iscsiTargetAuth, networkIpmpGroupDown=networkIpmpGroupDown, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, tegileGroups=tegileGroups, netbiosSocketFailure=netbiosSocketFailure, iscsiAvgWriteLatency=iscsiAvgWriteLatency, notificationSensorSuspect=notificationSensorSuspect, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, lunSizeLow=lunSizeLow, nicName=nicName, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, diskEntry=diskEntry, poolMetaWriteLatency=poolMetaWriteLatency, cifsTotalReadIops=cifsTotalReadIops, poolTotalSaving=poolTotalSaving, cpuInterrupts=cpuInterrupts, haResourceGroup=haResourceGroup, shareNFSReadLatency=shareNFSReadLatency, fcTargetWriteLatency=fcTargetWriteLatency, fcTotalReadIops=fcTotalReadIops, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiTargetWriteIops=iscsiTargetWriteIops, projectDeletionFailed=projectDeletionFailed, projectTable=projectTable, network=network, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunFreeSizeHigh=lunFreeSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, snapshotRollbackCompleted=snapshotRollbackCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, cacheTotalWriteMbps=cacheTotalWriteMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, deleteFolderCompleted=deleteFolderCompleted, shareProjectName=shareProjectName, fcTargetStatus=fcTargetStatus, controllerDown=controllerDown, diskType=diskType, projectModified=projectModified, fcTargetEntry=fcTargetEntry, snapshotDeleteFailed=snapshotDeleteFailed, lunProjectName=lunProjectName, haControllerA_Name=haControllerA_Name, iscsiTargetReadLatency=iscsiTargetReadLatency, fcTargetReadMbps=fcTargetReadMbps, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, nicGroup=nicGroup, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, snapshotCreationFailed=snapshotCreationFailed, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, ipmiTemperature=ipmiTemperature, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationEventCode=notificationEventCode, haControllerA_Uptime=haControllerA_Uptime, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion)
