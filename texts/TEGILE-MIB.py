...
ObjectIdentity, Counter64, Integer32, Gauge32, enterprises, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Bits, iso, MibIdentifier, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Integer32", "Gauge32", "enterprises", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Bits", "iso", "MibIdentifier", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, smisServiceStartFailed=smisServiceStartFailed, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolTotalWriteMbps=poolTotalWriteMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, projectName=projectName, cpuTotalUsage=cpuTotalUsage, nfsAvgReadLatency=nfsAvgReadLatency, lunEntry=lunEntry, nicTable=nicTable, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcTargetIndex=fcTargetIndex, nvdimmFailUnknownError=nvdimmFailUnknownError, PYSNMP_MODULE_ID=tegile, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareDeleted=shareDeleted, iscsiProperties=iscsiProperties, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiTargetAuth=iscsiTargetAuth, smisServiceStarted=smisServiceStarted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolProjectCount=poolProjectCount, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, projectShares=projectShares, fcInitiatorIndex=fcInitiatorIndex, notificationReadingUnit=notificationReadingUnit, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, fcTargetWriteMbps=fcTargetWriteMbps, diskSizeLow=diskSizeLow, replicationComplete=replicationComplete, lunFreeSizeHigh=lunFreeSizeHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectPoolName=projectPoolName, lunTargetGroup=lunTargetGroup, networkTotalReceiveMbps=networkTotalReceiveMbps, volumeDeleteCompleted=volumeDeleteCompleted, targetGroupCreateCompleted=targetGroupCreateCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectDataSizeHigh=projectDataSizeHigh, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolMetaWriteLatency=poolMetaWriteLatency, snmpServiceStartFailed=snmpServiceStartFailed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunProtocol=lunProtocol, notificationObjects=notificationObjects, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiInitiatorGroup=iscsiInitiatorGroup, cifsTotalWriteIops=cifsTotalWriteIops, haResourceEntry=haResourceEntry, controllerDown=controllerDown, basicCompliance=basicCompliance, upgradeDownloadFailed=upgradeDownloadFailed, projectShareCount=projectShareCount, shareCIFSEnabled=shareCIFSEnabled, fcInitiatorsTable=fcInitiatorsTable, replicationAborted=replicationAborted, diagnosticDataUploaded=diagnosticDataUploaded, shareCreatedSuccessfully=shareCreatedSuccessfully, poolFreeSizeHigh=poolFreeSizeHigh, snapshotCloneCompleted=snapshotCloneCompleted, snapshotRollbackFailed=snapshotRollbackFailed, fcAvgReadLatency=fcAvgReadLatency, unknownSensorEvent=unknownSensorEvent, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcTargetReadIops=fcTargetReadIops, poolIndex=poolIndex, projectThresholdExceedWarning=projectThresholdExceedWarning, haControllerB_Uptime=haControllerB_Uptime, userLoginFailed=userLoginFailed, projectCompressionEnabled=projectCompressionEnabled, lunReservedSizeHigh=lunReservedSizeHigh, poolTotalReadMbps=poolTotalReadMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, haResourceDescription=haResourceDescription, shareEntry=shareEntry, pools=pools, lunDedupEnabled=lunDedupEnabled, shareCompressedRatio=shareCompressedRatio, notifications=notifications, lunSizeLow=lunSizeLow, iscsiInitiators=iscsiInitiators, replicationTargetDeleted=replicationTargetDeleted, shareCIFSWriteMbps=shareCIFSWriteMbps, properties=properties, shareCIFSReadLatency=shareCIFSReadLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareNFSEnabled=shareNFSEnabled, shareNFSReadLatency=shareNFSReadLatency, iscsiInitiatorName=iscsiInitiatorName, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, maintenanceModeDisabled=maintenanceModeDisabled, lunInitiatorGroup=lunInitiatorGroup, cacheSSDReads=cacheSSDReads, tegile=tegile, poolReadCacheReadMbps=poolReadCacheReadMbps, lunReadLatency=lunReadLatency, projectFreeSizeLow=projectFreeSizeLow, nicIndex=nicIndex, targetGroupMemberRemoved=targetGroupMemberRemoved, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcPortOffline=fcPortOffline, lunCompressedRatio=lunCompressedRatio, vmwareNFSDatastores=vmwareNFSDatastores, haResources=haResources, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiTargetReadMbps=iscsiTargetReadMbps, fcTotalReadIops=fcTotalReadIops, haResourceGroup=haResourceGroup, lunDataSizeHigh=lunDataSizeHigh, upgradeDownloadStarted=upgradeDownloadStarted, upgradeStarted=upgradeStarted, shareExceedThresholdWarning=shareExceedThresholdWarning, shareIndex=shareIndex, sensorFailureEvent=sensorFailureEvent, targetGroupMemberAdded=targetGroupMemberAdded, fcTargetEntry=fcTargetEntry, haControllerB_Name=haControllerB_Name, aclMigrationStarted=aclMigrationStarted, smbSocketFailure=smbSocketFailure, fcTargets=fcTargets, projectQuotaSizeHigh=projectQuotaSizeHigh, lunWriteLatency=lunWriteLatency, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolOwnerController=poolOwnerController, lunReadIops=lunReadIops, lunBlockSize=lunBlockSize, iscsiTargetWriteIops=iscsiTargetWriteIops, smisServiceStopped=smisServiceStopped, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolReadCacheReadLatency=poolReadCacheReadLatency, replicationResumed=replicationResumed, globalStatistics=globalStatistics, ipmiFan=ipmiFan, shareCIFSReadMbps=shareCIFSReadMbps, replicationAbandoned=replicationAbandoned, iscsiTargets=iscsiTargets, fcTotalWriteMbps=fcTotalWriteMbps, snmpAgentVersion=snmpAgentVersion, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, snapshotRollbackCompleted=snapshotRollbackCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskDataReadMbps=diskDataReadMbps, ntpServerTimeDrift=ntpServerTimeDrift, iscsiWriteIops=iscsiWriteIops, poolTotalSaving=poolTotalSaving, poolDataReadMbps=poolDataReadMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, projectDeletionFailed=projectDeletionFailed, shareDeletionFailed=shareDeletionFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, lunIndex=lunIndex, haResourceName=haResourceName, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunCompressionEnabled=lunCompressionEnabled, poolCount=poolCount, upgradeFailed=upgradeFailed, currentNotificationGroup=currentNotificationGroup, currentObjectGroup=currentObjectGroup, netbiosSocketFailure=netbiosSocketFailure, poolTotalReadIops=poolTotalReadIops, cpuSystemCalls=cpuSystemCalls, networkIpmpGroupUp=networkIpmpGroupUp, tegileConformance=tegileConformance, poolMetaWriteMbps=poolMetaWriteMbps, iscsiTargetReadIops=iscsiTargetReadIops, lunPoolName=lunPoolName, poolMetaReadIops=poolMetaReadIops, poolHealth=poolHealth, diskTable=diskTable, snapshotDeleteFailed=snapshotDeleteFailed, poolWriteCacheWriteIops=poolWriteCacheWriteIops, controllerTimeDrift=controllerTimeDrift, deleteFolderFailed=deleteFolderFailed, sharePoolName=sharePoolName, projectEntry=projectEntry, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, spareDiskReplaced=spareDiskReplaced, ipmiCurrent=ipmiCurrent, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcTargetReadMbps=fcTargetReadMbps, diskTotalWriteIops=diskTotalWriteIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, haControllerB_IPAddr=haControllerB_IPAddr, projectDataSizeLow=projectDataSizeLow, smisServiceStopFailed=smisServiceStopFailed, fcInitiatorName=fcInitiatorName, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectSnapshotSizeLow=projectSnapshotSizeLow, poolMetaReadLatency=poolMetaReadLatency, shareDataSizeLow=shareDataSizeLow, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolSizeLow=poolSizeLow, fcTotalReadMbps=fcTotalReadMbps, projectTable=projectTable, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, nicMTU=nicMTU, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, haResourceIndex=haResourceIndex, diskChassisIdx=diskChassisIdx, nicGroup=nicGroup, poolDeleted=poolDeleted, projectLUNs=projectLUNs, lunGUID=lunGUID, diskError=diskError, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, shareMountPoint=shareMountPoint, fcTargetWriteLatency=fcTargetWriteLatency, ipmiVoltage=ipmiVoltage, iscsiInitiatorChapUser=iscsiInitiatorChapUser, snmpServiceStopFailed=snmpServiceStopFailed, notificationSensorAction=notificationSensorAction, poolDegraded=poolDegraded, poolExpanded=poolExpanded, nicReceiveMbps=nicReceiveMbps, nfsTotalReadIops=nfsTotalReadIops, poolFreeSizeLow=poolFreeSizeLow, diskPoolName=diskPoolName, poolState=poolState, poolReadCacheWriteMbps=poolReadCacheWriteMbps, networkInterfaceUp=networkInterfaceUp, ipmiMemory=ipmiMemory, tegileArray_notifications=tegileArray_notifications, fcTotalWriteIops=fcTotalWriteIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunReadMbps=lunReadMbps, shareQuotaHigh=shareQuotaHigh, projectModified=projectModified, projectDeleted=projectDeleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, fcProperties=fcProperties, poolReadCacheReadIops=poolReadCacheReadIops, nfsTotalWriteIops=nfsTotalWriteIops, iscsiTotalReadMbps=iscsiTotalReadMbps, diskDataReadIops=diskDataReadIops, poolAvgReadLatency=poolAvgReadLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolDataSizeLow=poolDataSizeLow, iscsiTotalReadIops=iscsiTotalReadIops, replicationFailed=replicationFailed, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolUpgraded=poolUpgraded, nicTransmitMbps=nicTransmitMbps, iscsiTargetsTable=iscsiTargetsTable, shareNFSWriteLatency=shareNFSWriteLatency, cifsAvgReadLatency=cifsAvgReadLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops)
mibBuilder.exportSymbols("TEGILE-MIB", diskState=diskState, ipmiOther=ipmiOther, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, fcTargetStatus=fcTargetStatus, iscsiTargetIndex=iscsiTargetIndex, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareReservedSizeLow=shareReservedSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiInitiatorEntry=iscsiInitiatorEntry, diskCount=diskCount, ipmiThreshold=ipmiThreshold, poolMetaWriteIops=poolMetaWriteIops, tdpsUpgradeTimeout=tdpsUpgradeTimeout, haControllerA_Name=haControllerA_Name, shareReservedSizeHigh=shareReservedSizeHigh, notificationProps=notificationProps, cacheTotalWriteMbps=cacheTotalWriteMbps, tegileGroups=tegileGroups, fcInitiatorEntry=fcInitiatorEntry, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, haResourceActiveNode=haResourceActiveNode, nicEntry=nicEntry, iscsiTargetEntry=iscsiTargetEntry, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolDataSizeHigh=poolDataSizeHigh, lunFreeSizeLow=lunFreeSizeLow, snapshotCloningFailed=snapshotCloningFailed, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, snmpServiceStopped=snmpServiceStopped, shareName=shareName, shareQuotaLow=shareQuotaLow, poolAvgWriteLatency=poolAvgWriteLatency, diskAlias=diskAlias, projectDedupEnabled=projectDedupEnabled, nfsTotalWriteMbps=nfsTotalWriteMbps, projectQuotaSizeLow=projectQuotaSizeLow, diskAvgWriteLatency=diskAvgWriteLatency, lunProjectName=lunProjectName, haResourcesTable=haResourcesTable, fcTargetModifyCompleted=fcTargetModifyCompleted, volumeQuotaFinished=volumeQuotaFinished, network=network, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolImported=poolImported, poolMetaReadMbps=poolMetaReadMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolUsedSizeLow=poolUsedSizeLow, snapshotCreationFailed=snapshotCreationFailed, ipmiTemperature=ipmiTemperature, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, memoryFailure=memoryFailure, iscsiInitiatorsTable=iscsiInitiatorsTable, poolName=poolName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolDataReadIops=poolDataReadIops, poolEntry=poolEntry, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolProjects=poolProjects, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, tegileCompliances=tegileCompliances, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareDataSizeHigh=shareDataSizeHigh, haResourceStatus=haResourceStatus, notificationSensorNumber=notificationSensorNumber, projectTotalSaving=projectTotalSaving, diskEntry=diskEntry, replicationStarted=replicationStarted, shareNFSWriteIops=shareNFSWriteIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolDataWriteIops=poolDataWriteIops, notificationEventCode=notificationEventCode, diskGoneOffline=diskGoneOffline, lunDataSizeLow=lunDataSizeLow, iscsiTargetReadLatency=iscsiTargetReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolDataWriteMbps=poolDataWriteMbps, lunTable=lunTable, shareDedupEnabled=shareDedupEnabled, adServerTimeDrift=adServerTimeDrift, disks=disks, lunWriteIops=lunWriteIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunSizeHigh=lunSizeHigh, cacheTotalReadMbps=cacheTotalReadMbps, fcTargetGroup=fcTargetGroup, notificationDescription=notificationDescription, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, tegileArray=tegileArray, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectLunCount=projectLunCount, nicName=nicName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, networkIpmpGroupDown=networkIpmpGroupDown, cacheRAMReads=cacheRAMReads, iscsiTargetAlias=iscsiTargetAlias, iscsiTargetGroup=iscsiTargetGroup, maintenanceModeEnabled=maintenanceModeEnabled, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, shareCIFSReadIops=shareCIFSReadIops, volumeModifyCompleted=volumeModifyCompleted, poolTable=poolTable, fcInitiatorGroup=fcInitiatorGroup, shareCompressionEnabled=shareCompressionEnabled, haControllerA_Uptime=haControllerA_Uptime, shareNFSWriteMbps=shareNFSWriteMbps, deleteFolderCompleted=deleteFolderCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolExported=poolExported, shareNFSReadMbps=shareNFSReadMbps, upgradeTimeout=upgradeTimeout, projectFreeSizeHigh=projectFreeSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, networkInterfaceDown=networkInterfaceDown, cifsTotalReadMbps=cifsTotalReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, diskIsOnline=diskIsOnline, webdocsUpgradeCompleted=webdocsUpgradeCompleted, notificationSeverity=notificationSeverity, shareTable=shareTable, diskDataWriteMbps=diskDataWriteMbps, diskIOCount=diskIOCount, cacheTotalReadIops=cacheTotalReadIops, cifsTotalReadIops=cifsTotalReadIops, tdpsUpgradeFailed=tdpsUpgradeFailed, diskSizeHigh=diskSizeHigh, iscsiTargetError=iscsiTargetError, poolDataReadLatency=poolDataReadLatency, poolTotalWriteIops=poolTotalWriteIops, haControllerA_IPAddr=haControllerA_IPAddr, cifsTotalWriteMbps=cifsTotalWriteMbps, shareCIFSWriteIops=shareCIFSWriteIops, diskSlowIo=diskSlowIo, fcAvgWriteLatency=fcAvgWriteLatency, sanProperties=sanProperties, controllerUp=controllerUp, lunName=lunName, webdocsUpgradeFailed=webdocsUpgradeFailed, shareNFSReadIops=shareNFSReadIops, volumeDeleteFailed=volumeDeleteFailed, notificationTargetEntityName=notificationTargetEntityName, diskTotalWriteMbps=diskTotalWriteMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, shareQuotaFinished=shareQuotaFinished, upgradeCompleted=upgradeCompleted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, diskType=diskType, replicationSourceRegistered=replicationSourceRegistered, poolDeletionFailed=poolDeletionFailed, nfsTotalReadMbps=nfsTotalReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, poolCreated=poolCreated, lunReservedSizeLow=lunReservedSizeLow, diskTotalReadIops=diskTotalReadIops, notificationTime=notificationTime, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, targetGroupDeleteCompleted=targetGroupDeleteCompleted, ipmiPowerSupply=ipmiPowerSupply, diskSequentialIOCount=diskSequentialIOCount, diskDataWriteIops=diskDataWriteIops, alertsCleanupCompleted=alertsCleanupCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, shareProjectName=shareProjectName, lunWriteMbps=lunWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, diskTotalReadMbps=diskTotalReadMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, diskIndex=diskIndex, notificationSensorSuspect=notificationSensorSuspect, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, cpuInterrupts=cpuInterrupts, fcTargetWriteIops=fcTargetWriteIops, fcTargetName=fcTargetName, nvdimmFailInitializationError=nvdimmFailInitializationError, poolSizeHigh=poolSizeHigh, fcInitiators=fcInitiators, snmpServiceStarted=snmpServiceStarted, poolQuotaFinished=poolQuotaFinished, nicState=nicState, diskRandomIOCount=diskRandomIOCount, iscsiTargetName=iscsiTargetName, projectQuotaFinished=projectQuotaFinished, fcTargetsTable=fcTargetsTable, replicationPaused=replicationPaused, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, diskAvgReadLatency=diskAvgReadLatency, projectIndex=projectIndex, fcTargetReadLatency=fcTargetReadLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, controllerHardwareModel=controllerHardwareModel, poolDataWriteLatency=poolDataWriteLatency, poolUsedSizeHigh=poolUsedSizeHigh, notificationComponentName=notificationComponentName, testNotification=testNotification, nfsAvgWriteLatency=nfsAvgWriteLatency, projectSnapshotSizeHigh=projectSnapshotSizeHigh, fcPortOnline=fcPortOnline, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, nvdimmFailSoftError=nvdimmFailSoftError)
