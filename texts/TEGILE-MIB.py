...
Counter32, ModuleIdentity, NotificationType, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, MibIdentifier, Gauge32, ObjectIdentity, iso, enterprises, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "NotificationType", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "MibIdentifier", "Gauge32", "ObjectIdentity", "iso", "enterprises", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("TEGILE-MIB", projectLUNs=projectLUNs, replicationStarted=replicationStarted, projectName=projectName, aclMigrationStarted=aclMigrationStarted, notifications=notifications, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, diskAvgWriteLatency=diskAvgWriteLatency, notificationSensorSuspect=notificationSensorSuspect, poolExpanded=poolExpanded, notificationSensorNumber=notificationSensorNumber, shareCIFSReadMbps=shareCIFSReadMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareNFSReadMbps=shareNFSReadMbps, iscsiInitiatorName=iscsiInitiatorName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, nfsTotalWriteIops=nfsTotalWriteIops, poolMetaReadIops=poolMetaReadIops, fcTotalWriteMbps=fcTotalWriteMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolTotalWriteMbps=poolTotalWriteMbps, poolDegraded=poolDegraded, fcTargetGroup=fcTargetGroup, lunSnapshotSizeLow=lunSnapshotSizeLow, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareCompressedRatio=shareCompressedRatio, iscsiWriteIops=iscsiWriteIops, poolMetaWriteIops=poolMetaWriteIops, shareEntry=shareEntry, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, spareDiskReplaced=spareDiskReplaced, lunIndex=lunIndex, diskTotalWriteMbps=diskTotalWriteMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, haControllerA_Name=haControllerA_Name, volumeQuotaFinished=volumeQuotaFinished, poolFreeSizeHigh=poolFreeSizeHigh, smbSocketFailure=smbSocketFailure, shareCIFSEnabled=shareCIFSEnabled, notificationDescription=notificationDescription, nicIndex=nicIndex, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, shareCIFSWriteIops=shareCIFSWriteIops, controllerUp=controllerUp, cacheTotalWriteMbps=cacheTotalWriteMbps, volumeModifyCompleted=volumeModifyCompleted, ipmiOther=ipmiOther, replicationResumed=replicationResumed, networkTotalTransmitMbps=networkTotalTransmitMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, disks=disks, diskDataReadIops=diskDataReadIops, iscsiTotalReadMbps=iscsiTotalReadMbps, snmpServiceStopFailed=snmpServiceStopFailed, shareNFSReadLatency=shareNFSReadLatency, diskIOCount=diskIOCount, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, upgradeFailed=upgradeFailed, poolDataSizeLow=poolDataSizeLow, projectTotalSaving=projectTotalSaving, iscsiTargetGroup=iscsiTargetGroup, poolName=poolName, projectDedupEnabled=projectDedupEnabled, tdpsUpgradeCompleted=tdpsUpgradeCompleted, notificationTargetEntityName=notificationTargetEntityName, nvdimmFailSoftError=nvdimmFailSoftError, fcTargetReadMbps=fcTargetReadMbps, nicTransmitMbps=nicTransmitMbps, poolUpgraded=poolUpgraded, cifsTotalWriteIops=cifsTotalWriteIops, poolDataSizeHigh=poolDataSizeHigh, haResourceDescription=haResourceDescription, tegileConformance=tegileConformance, lunFreeSizeLow=lunFreeSizeLow, vmwareNFSDatastores=vmwareNFSDatastores, pools=pools, iscsiProperties=iscsiProperties, fcInitiatorIndex=fcInitiatorIndex, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcTargetName=fcTargetName, shareExceedThresholdWarning=shareExceedThresholdWarning, poolIndex=poolIndex, nicState=nicState, shareDedupEnabled=shareDedupEnabled, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, diskEntry=diskEntry, iscsiInitiatorIndex=iscsiInitiatorIndex, haResourceIndex=haResourceIndex, lunReadLatency=lunReadLatency, tegileArray_notifications=tegileArray_notifications, poolMetaReadMbps=poolMetaReadMbps, diskRandomIOCount=diskRandomIOCount, ipmiVoltage=ipmiVoltage, projectDataSizeLow=projectDataSizeLow, iscsiTargetGroupError=iscsiTargetGroupError, networkInterfaceUp=networkInterfaceUp, nfsTotalReadMbps=nfsTotalReadMbps, upgradeCompleted=upgradeCompleted, sanProperties=sanProperties, controllerHardwareModel=controllerHardwareModel, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiTargetEntry=iscsiTargetEntry, replicationAborted=replicationAborted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, ipmiTemperature=ipmiTemperature, iscsiTargetWriteMbps=iscsiTargetWriteMbps, targetGroupMemberAdded=targetGroupMemberAdded, projectQuotaFinished=projectQuotaFinished, cacheTotalReadIops=cacheTotalReadIops, shareQuotaLow=shareQuotaLow, diskState=diskState, upgradeStarted=upgradeStarted, snmpServiceStopped=snmpServiceStopped, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolReadCacheReadLatency=poolReadCacheReadLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, tegileCompliances=tegileCompliances, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcTotalReadIops=fcTotalReadIops, diagnosticDataUploaded=diagnosticDataUploaded, shareDeleted=shareDeleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiInitiatorGroup=iscsiInitiatorGroup, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolTable=poolTable, diskTotalReadIops=diskTotalReadIops, targetGroupMemberRemoved=targetGroupMemberRemoved, shareDataSizeHigh=shareDataSizeHigh, projectDeletionFailed=projectDeletionFailed, projectEntry=projectEntry, fcTotalReadMbps=fcTotalReadMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, cpuTotalUsage=cpuTotalUsage, ipmiPowerSupply=ipmiPowerSupply, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareNFSWriteLatency=shareNFSWriteLatency, shareCompressionEnabled=shareCompressionEnabled, projectModified=projectModified, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, projectThresholdExceedWarning=projectThresholdExceedWarning, fcTargets=fcTargets, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiTotalReadIops=iscsiTotalReadIops, networkIpmpGroupDown=networkIpmpGroupDown, poolExported=poolExported, haResourceGroup=haResourceGroup, cacheSSDReads=cacheSSDReads, shareNFSWriteIops=shareNFSWriteIops, shareMountPoint=shareMountPoint, poolDataWriteLatency=poolDataWriteLatency, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolDeleted=poolDeleted, diskDataWriteMbps=diskDataWriteMbps, haResourceEntry=haResourceEntry, ipmiThreshold=ipmiThreshold, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, lunCompressionEnabled=lunCompressionEnabled, poolDataReadIops=poolDataReadIops, smisServiceStopFailed=smisServiceStopFailed, ipmiFan=ipmiFan, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, replicationSourceRegistered=replicationSourceRegistered, lunProjectName=lunProjectName, lunReadIops=lunReadIops, shareCIFSReadIops=shareCIFSReadIops, projectFreeSizeHigh=projectFreeSizeHigh, aclMigrationCompleted=aclMigrationCompleted, notificationTime=notificationTime, snapshotDeleteFailed=snapshotDeleteFailed, nicMTU=nicMTU, iscsiAvgWriteLatency=iscsiAvgWriteLatency, nicName=nicName, shareSnapshotSizeHigh=shareSnapshotSizeHigh, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, unknownSensorEvent=unknownSensorEvent, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunReservedSizeLow=lunReservedSizeLow, poolImported=poolImported, fcTargetEntry=fcTargetEntry, fcInitiatorGroup=fcInitiatorGroup, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, ntpServerTimeDrift=ntpServerTimeDrift, projectCreatedSuccessfully=projectCreatedSuccessfully, poolSizeLow=poolSizeLow, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectShareCount=projectShareCount, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, fcPortOffline=fcPortOffline, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, diskTable=diskTable, poolCount=poolCount, lunPoolName=lunPoolName, lunGUID=lunGUID, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, haResourceStatus=haResourceStatus, nicReceiveMbps=nicReceiveMbps, shareCIFSReadLatency=shareCIFSReadLatency, lunEntry=lunEntry, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, replicationTargetDeleted=replicationTargetDeleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, testNotification=testNotification, diskTotalReadMbps=diskTotalReadMbps, poolMetaWriteLatency=poolMetaWriteLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolHealth=poolHealth, cacheTotalWriteIops=cacheTotalWriteIops, tegileGroups=tegileGroups, iscsiTargetName=iscsiTargetName, snapshotCloningFailed=snapshotCloningFailed, lunBlockSize=lunBlockSize, lunWriteMbps=lunWriteMbps, lunTable=lunTable, haResourcesTable=haResourcesTable, iscsiTargetAuth=iscsiTargetAuth, lunWriteIops=lunWriteIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiTargets=iscsiTargets, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, notificationObjects=notificationObjects, poolAvgWriteLatency=poolAvgWriteLatency, smisServiceStopped=smisServiceStopped, fcPortOnline=fcPortOnline, upgradeTimeout=upgradeTimeout, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolAvgReadLatency=poolAvgReadLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, haControllerA_IPAddr=haControllerA_IPAddr, diskDataReadMbps=diskDataReadMbps, ipmiCurrent=ipmiCurrent, poolProjects=poolProjects, projectShares=projectShares, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, currentObjectGroup=currentObjectGroup, fcInitiators=fcInitiators, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, diskPoolName=diskPoolName, poolMetaReadLatency=poolMetaReadLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectLunCount=projectLunCount, snmpAgentVersion=snmpAgentVersion, cpuInterrupts=cpuInterrupts, smisServiceStartFailed=smisServiceStartFailed)
mibBuilder.exportSymbols("TEGILE-MIB", fcAvgWriteLatency=fcAvgWriteLatency, lunDataSizeHigh=lunDataSizeHigh, properties=properties, nfsAvgReadLatency=nfsAvgReadLatency, fcInitiatorEntry=fcInitiatorEntry, notificationEventCode=notificationEventCode, networkTotalReceiveMbps=networkTotalReceiveMbps, volumeDeleteCompleted=volumeDeleteCompleted, fcProperties=fcProperties, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolReadCacheReadIops=poolReadCacheReadIops, poolTotalReadMbps=poolTotalReadMbps, memoryFailure=memoryFailure, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, shareDeletionFailed=shareDeletionFailed, fcInitiatorsTable=fcInitiatorsTable, snmpServiceStarted=snmpServiceStarted, volumeDeleteFailed=volumeDeleteFailed, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, snapshotCreationFailed=snapshotCreationFailed, fcInitiatorCreateFailed=fcInitiatorCreateFailed, haResourceActiveNode=haResourceActiveNode, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, nvdimmFailDeviceError=nvdimmFailDeviceError, shareCreatedSuccessfully=shareCreatedSuccessfully, poolTotalReadIops=poolTotalReadIops, lunReservedSizeHigh=lunReservedSizeHigh, poolReadCacheWriteLatency=poolReadCacheWriteLatency, nicEntry=nicEntry, shareQuotaFinished=shareQuotaFinished, notificationReadingUnit=notificationReadingUnit, fcTargetWriteLatency=fcTargetWriteLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, diskIsOnline=diskIsOnline, iscsiTargetReadMbps=iscsiTargetReadMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTargetWriteIops=iscsiTargetWriteIops, replicationPaused=replicationPaused, notificationSensorAction=notificationSensorAction, controllerDown=controllerDown, ipmiMemory=ipmiMemory, shareQuotaHigh=shareQuotaHigh, iscsiTargetError=iscsiTargetError, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, sharePoolName=sharePoolName, diskChassisIdx=diskChassisIdx, projectQuotaSizeLow=projectQuotaSizeLow, fcTargetStatus=fcTargetStatus, shareReservedSizeLow=shareReservedSizeLow, shareNFSWriteMbps=shareNFSWriteMbps, smisServiceStarted=smisServiceStarted, diskIndex=diskIndex, nicGroup=nicGroup, shareDataSizeLow=shareDataSizeLow, replicationComplete=replicationComplete, nvdimmFailInitializationError=nvdimmFailInitializationError, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, nicTable=nicTable, notificationProps=notificationProps, projectCompressionEnabled=projectCompressionEnabled, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareName=shareName, diskAlias=diskAlias, iscsiTargetIndex=iscsiTargetIndex, cacheTotalReadMbps=cacheTotalReadMbps, upgradeDownloadFailed=upgradeDownloadFailed, notificationComponentName=notificationComponentName, lunTargetGroup=lunTargetGroup, fcTargetReadLatency=fcTargetReadLatency, projectPoolName=projectPoolName, shareReservedSizeHigh=shareReservedSizeHigh, snapshotRollbackFailed=snapshotRollbackFailed, projectQuotaSizeHigh=projectQuotaSizeHigh, fcTargetReadIops=fcTargetReadIops, shareCIFSWriteLatency=shareCIFSWriteLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, snapshotCloneCompleted=snapshotCloneCompleted, diskCount=diskCount, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareNFSReadIops=shareNFSReadIops, diskType=diskType, haControllerB_Uptime=haControllerB_Uptime, tdpsUpgradeTimeout=tdpsUpgradeTimeout, haControllerA_Uptime=haControllerA_Uptime, poolMetaWriteMbps=poolMetaWriteMbps, poolOwnerController=poolOwnerController, projectDeleted=projectDeleted, tegile=tegile, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolEntry=poolEntry, lunName=lunName, poolDataWriteMbps=poolDataWriteMbps, network=network, poolState=poolState, diskSizeHigh=diskSizeHigh, projectFreeSizeLow=projectFreeSizeLow, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, haResourceName=haResourceName, poolDataWriteIops=poolDataWriteIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunSizeLow=lunSizeLow, replicationFailed=replicationFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunDataSizeLow=lunDataSizeLow, iscsiTargetReadLatency=iscsiTargetReadLatency, diskSequentialIOCount=diskSequentialIOCount, diskSizeLow=diskSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, diskError=diskError, maintenanceModeEnabled=maintenanceModeEnabled, alertsCleanupCompleted=alertsCleanupCompleted, nfsTotalReadIops=nfsTotalReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, fcTargetsTable=fcTargetsTable, networkInterfaceDown=networkInterfaceDown, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectIndex=projectIndex, lunFreeSizeHigh=lunFreeSizeHigh, poolQuotaFinished=poolQuotaFinished, iscsiTargetReadIops=iscsiTargetReadIops, upgradeDownloadStarted=upgradeDownloadStarted, shareNFSEnabled=shareNFSEnabled, projectTable=projectTable, tdpsUpgradeFailed=tdpsUpgradeFailed, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunSizeHigh=lunSizeHigh, lunWriteLatency=lunWriteLatency, poolTotalWriteIops=poolTotalWriteIops, poolFreeSizeLow=poolFreeSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, lunProtocol=lunProtocol, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolCreated=poolCreated, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, diskGoneOffline=diskGoneOffline, haResources=haResources, controllerTimeDrift=controllerTimeDrift, poolReadCacheReadMbps=poolReadCacheReadMbps, cacheRAMReads=cacheRAMReads, haControllerB_IPAddr=haControllerB_IPAddr, sensorFailureEvent=sensorFailureEvent, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolUsedSizeHigh=poolUsedSizeHigh, deleteFolderCompleted=deleteFolderCompleted, iscsiTargetAlias=iscsiTargetAlias, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcAvgReadLatency=fcAvgReadLatency, poolDataReadLatency=poolDataReadLatency, basicCompliance=basicCompliance, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectDataSizeHigh=projectDataSizeHigh, cifsTotalReadIops=cifsTotalReadIops, netbiosSocketFailure=netbiosSocketFailure, maintenanceModeDisabled=maintenanceModeDisabled, poolDataReadMbps=poolDataReadMbps, diskDataWriteIops=diskDataWriteIops, fcTargetWriteIops=fcTargetWriteIops, userLoginFailed=userLoginFailed, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, webdocsUpgradeFailed=webdocsUpgradeFailed, cifsAvgWriteLatency=cifsAvgWriteLatency, PYSNMP_MODULE_ID=tegile, fcTargetIndex=fcTargetIndex, shareTable=shareTable, poolSizeHigh=poolSizeHigh, snapshotRollbackCompleted=snapshotRollbackCompleted, lunInitiatorGroup=lunInitiatorGroup, diskTotalWriteIops=diskTotalWriteIops, notificationSeverity=notificationSeverity, fcInitiatorName=fcInitiatorName, haControllerB_Name=haControllerB_Name, poolReadCacheWriteIops=poolReadCacheWriteIops, nfsTotalWriteMbps=nfsTotalWriteMbps, lunCompressedRatio=lunCompressedRatio, cifsTotalWriteMbps=cifsTotalWriteMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiInitiators=iscsiInitiators, networkIpmpGroupUp=networkIpmpGroupUp, globalStatistics=globalStatistics, diskAvgReadLatency=diskAvgReadLatency, cifsAvgReadLatency=cifsAvgReadLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, diskSlowIo=diskSlowIo, poolProjectCount=poolProjectCount, adServerTimeDrift=adServerTimeDrift, shareIndex=shareIndex, currentNotificationGroup=currentNotificationGroup, notificationReadingTriggerValue=notificationReadingTriggerValue, cifsTotalReadMbps=cifsTotalReadMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolTotalSaving=poolTotalSaving, shareProjectName=shareProjectName, lunReadMbps=lunReadMbps, iscsiTargetsTable=iscsiTargetsTable, cpuSystemCalls=cpuSystemCalls, tegileArray=tegileArray, snmpServiceStartFailed=snmpServiceStartFailed, poolDeletionFailed=poolDeletionFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, lunDedupEnabled=lunDedupEnabled, replicationAbandoned=replicationAbandoned, poolUsedSizeLow=poolUsedSizeLow, deleteFolderFailed=deleteFolderFailed, fcTotalWriteIops=fcTotalWriteIops, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, shareSnapshotSizeLow=shareSnapshotSizeLow)
