...
# Produced by pysmi-1.1.8 at Fri Jan 27 15:55:21 2023
...
enterprises, Gauge32, Integer32, Counter64, ObjectIdentity, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, Counter32, IpAddress, MibIdentifier, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Integer32", "Counter64", "ObjectIdentity", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "Counter32", "IpAddress", "MibIdentifier", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", networkInterfaceUp=networkInterfaceUp, memoryFailure=memoryFailure, lunIndex=lunIndex, projectShareCount=projectShareCount, controllerHardwareModel=controllerHardwareModel, poolSizeLow=poolSizeLow, lunCompressedRatio=lunCompressedRatio, maintenanceModeDisabled=maintenanceModeDisabled, iscsiTargetAuth=iscsiTargetAuth, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolMetaReadIops=poolMetaReadIops, PYSNMP_MODULE_ID=tegile, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolAvgReadLatency=poolAvgReadLatency, iscsiTotalWriteMbps=iscsiTotalWriteMbps, networkIpmpGroupDown=networkIpmpGroupDown, fcInitiatorEntry=fcInitiatorEntry, sensorFailureEvent=sensorFailureEvent, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, cacheTotalReadIops=cacheTotalReadIops, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, haResourceDescription=haResourceDescription, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, poolDataReadIops=poolDataReadIops, lunReservedSizeHigh=lunReservedSizeHigh, cifsAvgWriteLatency=cifsAvgWriteLatency, haResourceGroup=haResourceGroup, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, haControllerA_Name=haControllerA_Name, cacheTotalWriteMbps=cacheTotalWriteMbps, haControllerB_Name=haControllerB_Name, shareNFSWriteMbps=shareNFSWriteMbps, controllerDown=controllerDown, properties=properties, replicationStarted=replicationStarted, poolDataWriteIops=poolDataWriteIops, lunSizeHigh=lunSizeHigh, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, snapshotRollbackCompleted=snapshotRollbackCompleted, shareName=shareName, projectLUNs=projectLUNs, nicMTU=nicMTU, haControllerB_IPAddr=haControllerB_IPAddr, notifications=notifications, diskChassisIdx=diskChassisIdx, lunSnapshotSizeLow=lunSnapshotSizeLow, controllerTimeDrift=controllerTimeDrift, poolImported=poolImported, snmpServiceStarted=snmpServiceStarted, fcProperties=fcProperties, smisServiceStopped=smisServiceStopped, iscsiTargetName=iscsiTargetName, poolName=poolName, ipmiPowerSupply=ipmiPowerSupply, cpuSystemCalls=cpuSystemCalls, lunReadLatency=lunReadLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, poolHealth=poolHealth, tegileConformance=tegileConformance, snmpServiceStopped=snmpServiceStopped, projectIndex=projectIndex, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, nicEntry=nicEntry, currentObjectGroup=currentObjectGroup, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareProjectName=shareProjectName, iscsiAvgReadLatency=iscsiAvgReadLatency, poolEntry=poolEntry, diskState=diskState, cifsTotalWriteIops=cifsTotalWriteIops, deleteFolderCompleted=deleteFolderCompleted, iscsiTargetWriteIops=iscsiTargetWriteIops, tegileCompliances=tegileCompliances, shareQuotaLow=shareQuotaLow, shareNFSReadMbps=shareNFSReadMbps, projectDeleted=projectDeleted, poolTotalWriteMbps=poolTotalWriteMbps, networkInterfaceDown=networkInterfaceDown, poolExpanded=poolExpanded, lunProtocol=lunProtocol, upgradeDownloadCompleted=upgradeDownloadCompleted, snmpAgentVersion=snmpAgentVersion, poolUsedSizeLow=poolUsedSizeLow, poolCreated=poolCreated, tegileArray=tegileArray, diskAvgReadLatency=diskAvgReadLatency, iscsiAvgWriteLatency=iscsiAvgWriteLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectQuotaFinished=projectQuotaFinished, fcTotalReadMbps=fcTotalReadMbps, iscsiTargetError=iscsiTargetError, poolState=poolState, fcInitiatorIndex=fcInitiatorIndex, poolDataSizeLow=poolDataSizeLow, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, ntpServerTimeDrift=ntpServerTimeDrift, diskPoolName=diskPoolName, haResources=haResources, poolTotalReadIops=poolTotalReadIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, nicReceiveMbps=nicReceiveMbps, volumeDeleteFailed=volumeDeleteFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, iscsiTargets=iscsiTargets, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, haResourceActiveNode=haResourceActiveNode, projectPoolName=projectPoolName, shareQuotaFinished=shareQuotaFinished, snapshotDeleteFailed=snapshotDeleteFailed, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, nicTable=nicTable, upgradeDownloadFailed=upgradeDownloadFailed, notificationProps=notificationProps, poolTable=poolTable, smisServiceStartFailed=smisServiceStartFailed, deleteFolderFailed=deleteFolderFailed, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolReadCacheReadMbps=poolReadCacheReadMbps, networkIpmpGroupUp=networkIpmpGroupUp, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, snmpServiceStopFailed=snmpServiceStopFailed, projectTotalSaving=projectTotalSaving, shareCIFSEnabled=shareCIFSEnabled, shareDataSizeLow=shareDataSizeLow, shareCompressedRatio=shareCompressedRatio, diskDataReadIops=diskDataReadIops, replicationPaused=replicationPaused, poolReadCacheWriteLatency=poolReadCacheWriteLatency, notificationReadingUnit=notificationReadingUnit, volumeQuotaFinished=volumeQuotaFinished, poolDataSizeHigh=poolDataSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, fcTotalReadIops=fcTotalReadIops, poolMetaReadLatency=poolMetaReadLatency, maintenanceModeEnabled=maintenanceModeEnabled, network=network, poolDataWriteMbps=poolDataWriteMbps, lunBlockSize=lunBlockSize, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, diskTotalReadIops=diskTotalReadIops, fcAvgReadLatency=fcAvgReadLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiTargetIndex=iscsiTargetIndex, projectEntry=projectEntry, networkTotalReceiveMbps=networkTotalReceiveMbps, fcTotalWriteIops=fcTotalWriteIops, nicState=nicState, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareNFSEnabled=shareNFSEnabled, notificationEventCode=notificationEventCode, shareCompressionEnabled=shareCompressionEnabled, replicationTargetDeleted=replicationTargetDeleted, poolSizeHigh=poolSizeHigh, fcTargetGroup=fcTargetGroup, shareMountPoint=shareMountPoint, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolDeleted=poolDeleted, replicationAbandoned=replicationAbandoned, projectFreeSizeHigh=projectFreeSizeHigh, fcInitiators=fcInitiators, shareReservedSizeHigh=shareReservedSizeHigh, shareCIFSReadLatency=shareCIFSReadLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, diskDataReadMbps=diskDataReadMbps, haControllerA_Uptime=haControllerA_Uptime, projectSnapshotSizeLow=projectSnapshotSizeLow, nicIndex=nicIndex, tdpsUpgradeFailed=tdpsUpgradeFailed, notificationComponentName=notificationComponentName, aclMigrationStarted=aclMigrationStarted, nfsAvgReadLatency=nfsAvgReadLatency, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, iscsiProperties=iscsiProperties, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, shareTable=shareTable, replicationSourceRegistered=replicationSourceRegistered, diskRandomIOCount=diskRandomIOCount, currentNotificationGroup=currentNotificationGroup, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, iscsiTargetReadIops=iscsiTargetReadIops, diskGoneOffline=diskGoneOffline, nvdimmFailUnknownError=nvdimmFailUnknownError, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, projectQuotaSizeLow=projectQuotaSizeLow, snapshotCloningFailed=snapshotCloningFailed, ipmiThreshold=ipmiThreshold, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareEntry=shareEntry, controllerUp=controllerUp, projectFreeSizeLow=projectFreeSizeLow, userLoginFailed=userLoginFailed, projectDataSizeHigh=projectDataSizeHigh, poolFreeSizeHigh=poolFreeSizeHigh, cifsTotalWriteMbps=cifsTotalWriteMbps, upgradeStarted=upgradeStarted, volumeModifyCompleted=volumeModifyCompleted, fcPortOffline=fcPortOffline, fcTargetReadMbps=fcTargetReadMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diskIsOnline=diskIsOnline, testNotification=testNotification, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskTotalReadMbps=diskTotalReadMbps, notificationTime=notificationTime, shareDeletionFailed=shareDeletionFailed, nvdimmFailSoftError=nvdimmFailSoftError, fcAvgWriteLatency=fcAvgWriteLatency, ipmiFan=ipmiFan, haControllerA_IPAddr=haControllerA_IPAddr, poolDataWriteLatency=poolDataWriteLatency, fcTargetName=fcTargetName, fcPortOnline=fcPortOnline, snmpServiceStartFailed=snmpServiceStartFailed, projectShares=projectShares, shareDataSizeHigh=shareDataSizeHigh, diskAlias=diskAlias, notificationObjects=notificationObjects, poolProjectCount=poolProjectCount, replicationFailed=replicationFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, notificationSensorSuspect=notificationSensorSuspect, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, pools=pools, notificationSensorNumber=notificationSensorNumber, poolMetaWriteIops=poolMetaWriteIops, shareDeleted=shareDeleted, projectDeletionFailed=projectDeletionFailed, projectDataSizeLow=projectDataSizeLow, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolUsedSizeHigh=poolUsedSizeHigh, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, diskIndex=diskIndex, lunReadIops=lunReadIops, projectModified=projectModified, shareCreatedSuccessfully=shareCreatedSuccessfully, diskError=diskError, poolProjects=poolProjects, poolDegraded=poolDegraded, diskDataWriteMbps=diskDataWriteMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed)
mibBuilder.exportSymbols("TEGILE-MIB", poolTotalWriteIops=poolTotalWriteIops, fcTargetModifyCompleted=fcTargetModifyCompleted, diskSizeHigh=diskSizeHigh, shareReservedSizeLow=shareReservedSizeLow, iscsiTargetsTable=iscsiTargetsTable, fcTargets=fcTargets, haControllerB_Uptime=haControllerB_Uptime, fcTargetWriteLatency=fcTargetWriteLatency, ipmiCurrent=ipmiCurrent, shareCIFSReadIops=shareCIFSReadIops, notificationTargetEntityName=notificationTargetEntityName, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, spareDiskReplaced=spareDiskReplaced, poolAvgWriteLatency=poolAvgWriteLatency, cifsTotalReadMbps=cifsTotalReadMbps, snapshotCloneCompleted=snapshotCloneCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiTargetGroup=iscsiTargetGroup, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunFreeSizeHigh=lunFreeSizeHigh, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, haResourcesTable=haResourcesTable, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, upgradeFailed=upgradeFailed, shareCIFSReadMbps=shareCIFSReadMbps, cifsTotalReadIops=cifsTotalReadIops, projectCompressionEnabled=projectCompressionEnabled, poolDataReadMbps=poolDataReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiTargetWriteLatency=iscsiTargetWriteLatency, upgradeCompleted=upgradeCompleted, lunName=lunName, poolUpgraded=poolUpgraded, diskDataWriteIops=diskDataWriteIops, diskType=diskType, nfsTotalWriteMbps=nfsTotalWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, shareDedupEnabled=shareDedupEnabled, iscsiTotalReadIops=iscsiTotalReadIops, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, replicationResumed=replicationResumed, iscsiInitiatorsTable=iscsiInitiatorsTable, lunWriteLatency=lunWriteLatency, diskEntry=diskEntry, fcTargetStatus=fcTargetStatus, haResourceEntry=haResourceEntry, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, unknownSensorEvent=unknownSensorEvent, lunReservedSizeLow=lunReservedSizeLow, snapshotRollbackFailed=snapshotRollbackFailed, iscsiTargetReadLatency=iscsiTargetReadLatency, tegile=tegile, disks=disks, poolReadCacheReadLatency=poolReadCacheReadLatency, shareNFSWriteLatency=shareNFSWriteLatency, nfsTotalWriteIops=nfsTotalWriteIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, lunSizeLow=lunSizeLow, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiTargetGroupError=iscsiTargetGroupError, lunWriteIops=lunWriteIops, shareNFSWriteIops=shareNFSWriteIops, fcTargetWriteMbps=fcTargetWriteMbps, fcTargetReadIops=fcTargetReadIops, volumeDeleteCompleted=volumeDeleteCompleted, ipmiOther=ipmiOther, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, haResourceName=haResourceName, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolTotalReadMbps=poolTotalReadMbps, fcTargetReadLatency=fcTargetReadLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, replicationComplete=replicationComplete, iscsiInitiatorEntry=iscsiInitiatorEntry, lunDedupEnabled=lunDedupEnabled, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, targetGroupDeleteCompleted=targetGroupDeleteCompleted, fcTargetWriteIops=fcTargetWriteIops, lunDataSizeLow=lunDataSizeLow, poolFreeSizeLow=poolFreeSizeLow, poolQuotaFinished=poolQuotaFinished, fcInitiatorName=fcInitiatorName, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunTable=lunTable, smisServiceStopFailed=smisServiceStopFailed, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, fcInitiatorsTable=fcInitiatorsTable, lunEntry=lunEntry, shareSnapshotSizeLow=shareSnapshotSizeLow, nicTransmitMbps=nicTransmitMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, nicName=nicName, shareQuotaHigh=shareQuotaHigh, ipmiMemory=ipmiMemory, diskSizeLow=diskSizeLow, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiInitiators=iscsiInitiators, lunGUID=lunGUID, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectDedupEnabled=projectDedupEnabled, lunFreeSizeLow=lunFreeSizeLow, notificationDescription=notificationDescription, shareIndex=shareIndex, nicGroup=nicGroup, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, projectThresholdExceedWarning=projectThresholdExceedWarning, poolCount=poolCount, fcInitiatorGroup=fcInitiatorGroup, iscsiWriteIops=iscsiWriteIops, ipmiTemperature=ipmiTemperature, tdpsUpgradeCompleted=tdpsUpgradeCompleted, notificationSensorAction=notificationSensorAction, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcTargetIndex=fcTargetIndex, poolReadCacheReadIops=poolReadCacheReadIops, lunCompressionEnabled=lunCompressionEnabled, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectName=projectName, targetGroupMemberAdded=targetGroupMemberAdded, iscsiTargetEntry=iscsiTargetEntry, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, cacheTotalReadMbps=cacheTotalReadMbps, diagnosticDataUploaded=diagnosticDataUploaded, poolMetaReadMbps=poolMetaReadMbps, lunTargetGroup=lunTargetGroup, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunReadMbps=lunReadMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, targetGroupMemberRemoved=targetGroupMemberRemoved, shareExceedThresholdWarning=shareExceedThresholdWarning, lunDataSizeHigh=lunDataSizeHigh, notificationSeverity=notificationSeverity, nfsTotalReadMbps=nfsTotalReadMbps, poolTotalSaving=poolTotalSaving, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, volumeCreatedSuccessfully=volumeCreatedSuccessfully, fcTargetsTable=fcTargetsTable, lunPoolName=lunPoolName, diskCount=diskCount, poolIndex=poolIndex, poolMetaWriteMbps=poolMetaWriteMbps, haResourceStatus=haResourceStatus, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskAvgWriteLatency=diskAvgWriteLatency, adServerTimeDrift=adServerTimeDrift, upgradeDownloadStarted=upgradeDownloadStarted, ipmiVoltage=ipmiVoltage, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, sharePoolName=sharePoolName, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, globalStatistics=globalStatistics, haResourceIndex=haResourceIndex, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, aclMigrationCompleted=aclMigrationCompleted, nfsTotalReadIops=nfsTotalReadIops, shareNFSReadIops=shareNFSReadIops, poolDataReadLatency=poolDataReadLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, poolDeletionFailed=poolDeletionFailed, basicCompliance=basicCompliance, lunInitiatorGroup=lunInitiatorGroup, lunWriteMbps=lunWriteMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiTotalReadMbps=iscsiTotalReadMbps, diskTable=diskTable, alertsCleanupCompleted=alertsCleanupCompleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, cacheTotalWriteIops=cacheTotalWriteIops, diskIOCount=diskIOCount, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolExported=poolExported, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiInitiatorIndex=iscsiInitiatorIndex, cpuInterrupts=cpuInterrupts, diskTotalWriteMbps=diskTotalWriteMbps, tegileGroups=tegileGroups, projectSnapshotSizeHigh=projectSnapshotSizeHigh, cacheRAMReads=cacheRAMReads, smbSocketFailure=smbSocketFailure, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskTotalWriteIops=diskTotalWriteIops, cacheSSDReads=cacheSSDReads, shareCIFSWriteIops=shareCIFSWriteIops, upgradeTimeout=upgradeTimeout, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcTotalWriteMbps=fcTotalWriteMbps, projectTable=projectTable, diskSequentialIOCount=diskSequentialIOCount, fcTargetEntry=fcTargetEntry, poolOwnerController=poolOwnerController, vmwareNFSDatastores=vmwareNFSDatastores, projectLunCount=projectLunCount, poolMetaWriteLatency=poolMetaWriteLatency, cpuTotalUsage=cpuTotalUsage, nvdimmFailInitializationError=nvdimmFailInitializationError, tegileArray_notifications=tegileArray_notifications, netbiosSocketFailure=netbiosSocketFailure, sanProperties=sanProperties, diskSlowIo=diskSlowIo, lunProjectName=lunProjectName, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, replicationAborted=replicationAborted, shareNFSReadLatency=shareNFSReadLatency, smisServiceStarted=smisServiceStarted, iscsiInitiatorName=iscsiInitiatorName, iscsiTargetAlias=iscsiTargetAlias, snapshotCreationFailed=snapshotCreationFailed, iscsiInitiatorChapUser=iscsiInitiatorChapUser, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, cifsAvgReadLatency=cifsAvgReadLatency)
