...
IpAddress, Gauge32, Unsigned32, ModuleIdentity, MibIdentifier, enterprises, Bits, iso, Integer32, Counter32, NotificationType, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Unsigned32", "ModuleIdentity", "MibIdentifier", "enterprises", "Bits", "iso", "Integer32", "Counter32", "NotificationType", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", replicationAbandoned=replicationAbandoned, poolDeleted=poolDeleted, tdpsUpgradeFailed=tdpsUpgradeFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, lunGUID=lunGUID, notificationObjects=notificationObjects, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareReservedSizeHigh=shareReservedSizeHigh, nicReceiveMbps=nicReceiveMbps, poolEntry=poolEntry, diskError=diskError, snapshotCreationFailed=snapshotCreationFailed, nicTransmitMbps=nicTransmitMbps, sanProperties=sanProperties, iscsiAvgReadLatency=iscsiAvgReadLatency, projectIndex=projectIndex, shareNFSReadIops=shareNFSReadIops, projectName=projectName, poolTable=poolTable, poolDataSizeHigh=poolDataSizeHigh, projectDeletionFailed=projectDeletionFailed, cacheRAMReads=cacheRAMReads, cifsTotalReadIops=cifsTotalReadIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunFreeSizeHigh=lunFreeSizeHigh, ntpServerTimeDrift=ntpServerTimeDrift, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, currentObjectGroup=currentObjectGroup, fcInitiatorIndex=fcInitiatorIndex, PYSNMP_MODULE_ID=tegile, nvdimmFailUnknownError=nvdimmFailUnknownError, lunIndex=lunIndex, iscsiTargetReadLatency=iscsiTargetReadLatency, diskTotalWriteIops=diskTotalWriteIops, diskAlias=diskAlias, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, cpuInterrupts=cpuInterrupts, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, iscsiTargetEntry=iscsiTargetEntry, ipmiTemperature=ipmiTemperature, controllerHardwareModel=controllerHardwareModel, poolDataReadMbps=poolDataReadMbps, shareTable=shareTable, haResourceStatus=haResourceStatus, poolReadCacheWriteIops=poolReadCacheWriteIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, lunFreeSizeLow=lunFreeSizeLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareEntry=shareEntry, smbSocketFailure=smbSocketFailure, replicationTargetDeleted=replicationTargetDeleted, shareNFSWriteIops=shareNFSWriteIops, nicMTU=nicMTU, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, notifications=notifications, projectSnapshotSizeLow=projectSnapshotSizeLow, fcTargetIndex=fcTargetIndex, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunBlockSize=lunBlockSize, targetGroupMemberAdded=targetGroupMemberAdded, networkIpmpGroupUp=networkIpmpGroupUp, diskDataWriteMbps=diskDataWriteMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, fcTotalWriteMbps=fcTotalWriteMbps, nicIndex=nicIndex, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectDataSizeLow=projectDataSizeLow, haResources=haResources, iscsiTotalReadIops=iscsiTotalReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, currentNotificationGroup=currentNotificationGroup, networkTotalReceiveMbps=networkTotalReceiveMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, netbiosSocketFailure=netbiosSocketFailure, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolDegraded=poolDegraded, poolReadCacheWriteLatency=poolReadCacheWriteLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, nicTable=nicTable, iscsiTargetAlias=iscsiTargetAlias, diskSlowIo=diskSlowIo, shareCIFSReadIops=shareCIFSReadIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, nicEntry=nicEntry, ipmiThreshold=ipmiThreshold, shareMountPoint=shareMountPoint, haResourceEntry=haResourceEntry, spareDiskReplaced=spareDiskReplaced, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolFreeSizeLow=poolFreeSizeLow, poolDataWriteIops=poolDataWriteIops, adServerTimeDrift=adServerTimeDrift, projectDataSizeHigh=projectDataSizeHigh, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, iscsiTotalReadMbps=iscsiTotalReadMbps, nfsTotalReadMbps=nfsTotalReadMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, shareDeletionFailed=shareDeletionFailed, iscsiTargetGroup=iscsiTargetGroup, diskDataWriteIops=diskDataWriteIops, diskAvgWriteLatency=diskAvgWriteLatency, globalStatistics=globalStatistics, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcTotalReadMbps=fcTotalReadMbps, controllerUp=controllerUp, snmpServiceStopped=snmpServiceStopped, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, aclMigrationStarted=aclMigrationStarted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, upgradeCompleted=upgradeCompleted, haResourceName=haResourceName, shareCIFSReadMbps=shareCIFSReadMbps, poolDeletionFailed=poolDeletionFailed, shareName=shareName, poolQuotaFinished=poolQuotaFinished, projectDeleted=projectDeleted, fcProperties=fcProperties, shareNFSWriteLatency=shareNFSWriteLatency, tegileConformance=tegileConformance, fcInitiatorCreateFailed=fcInitiatorCreateFailed, diagnosticDataUploaded=diagnosticDataUploaded, smisServiceStartFailed=smisServiceStartFailed, projectEntry=projectEntry, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolExported=poolExported, snapshotDeleteFailed=snapshotDeleteFailed, network=network, pools=pools, diskSizeHigh=diskSizeHigh, tegileGroups=tegileGroups, controllerDown=controllerDown, fcTotalReadIops=fcTotalReadIops, projectTable=projectTable, fcPortOnline=fcPortOnline, tegileCompliances=tegileCompliances, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargetIndex=iscsiTargetIndex, iscsiInitiatorName=iscsiInitiatorName, iscsiProperties=iscsiProperties, fcTargetEntry=fcTargetEntry, haResourceIndex=haResourceIndex, diskTotalWriteMbps=diskTotalWriteMbps, shareQuotaLow=shareQuotaLow, nfsAvgReadLatency=nfsAvgReadLatency, diskDataReadIops=diskDataReadIops, poolExpanded=poolExpanded, nfsTotalWriteIops=nfsTotalWriteIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, targetGroupMemberRemoved=targetGroupMemberRemoved, projectModified=projectModified, memoryFailure=memoryFailure, poolMetaReadLatency=poolMetaReadLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareReservedSizeLow=shareReservedSizeLow, tegileArray_notifications=tegileArray_notifications, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, fcInitiatorsTable=fcInitiatorsTable, shareCreatedSuccessfully=shareCreatedSuccessfully, snmpAgentVersion=snmpAgentVersion, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolMetaWriteIops=poolMetaWriteIops, replicationSourceRegistered=replicationSourceRegistered, poolName=poolName, poolSizeHigh=poolSizeHigh, haResourcesTable=haResourcesTable, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, notificationReadingUnit=notificationReadingUnit, diskSequentialIOCount=diskSequentialIOCount, lunProtocol=lunProtocol, poolTotalReadMbps=poolTotalReadMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, nvdimmFailInitializationError=nvdimmFailInitializationError, poolSizeLow=poolSizeLow, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, ipmiOther=ipmiOther, poolReadCacheReadLatency=poolReadCacheReadLatency, nvdimmFailSoftError=nvdimmFailSoftError, iscsiWriteIops=iscsiWriteIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareCompressionEnabled=shareCompressionEnabled, shareDataSizeLow=shareDataSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, diskTable=diskTable, shareCIFSWriteLatency=shareCIFSWriteLatency, diskEntry=diskEntry, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, ipmiVoltage=ipmiVoltage, iscsiTargets=iscsiTargets, haControllerB_IPAddr=haControllerB_IPAddr, projectPoolName=projectPoolName, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiTargetsTable=iscsiTargetsTable, fcInitiators=fcInitiators, projectShareCount=projectShareCount, volumeDeleteCompleted=volumeDeleteCompleted, iscsiTargetName=iscsiTargetName, lunReadMbps=lunReadMbps, snapshotCloningFailed=snapshotCloningFailed, diskSizeLow=diskSizeLow, iscsiTargetAuth=iscsiTargetAuth, lunEntry=lunEntry, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, upgradeDownloadFailed=upgradeDownloadFailed, notificationSeverity=notificationSeverity, fcInitiatorEntry=fcInitiatorEntry, notificationSensorSuspect=notificationSensorSuspect, sharePoolName=sharePoolName, shareNFSReadLatency=shareNFSReadLatency, shareProjectName=shareProjectName, shareIndex=shareIndex, fcTargetWriteIops=fcTargetWriteIops, haResourceGroup=haResourceGroup, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, testNotification=testNotification, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiTargetError=iscsiTargetError, replicationFailed=replicationFailed, shareCIFSEnabled=shareCIFSEnabled, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, projectFreeSizeLow=projectFreeSizeLow, networkIpmpGroupDown=networkIpmpGroupDown, projectQuotaSizeLow=projectQuotaSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, fcAvgWriteLatency=fcAvgWriteLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunSizeLow=lunSizeLow, lunDedupEnabled=lunDedupEnabled, sensorFailureEvent=sensorFailureEvent, shareDataSizeHigh=shareDataSizeHigh, lunCompressedRatio=lunCompressedRatio, networkTotalTransmitMbps=networkTotalTransmitMbps, diskType=diskType, poolDataSizeLow=poolDataSizeLow, cifsAvgReadLatency=cifsAvgReadLatency, replicationStarted=replicationStarted, basicCompliance=basicCompliance, poolDataReadLatency=poolDataReadLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, ipmiFan=ipmiFan, webdocsUpgradeFailed=webdocsUpgradeFailed, lunInitiatorGroup=lunInitiatorGroup, nicGroup=nicGroup, lunReservedSizeLow=lunReservedSizeLow, haControllerA_Name=haControllerA_Name, fcPortOffline=fcPortOffline, upgradeStarted=upgradeStarted)
mibBuilder.exportSymbols("TEGILE-MIB", ipmiPowerSupply=ipmiPowerSupply, poolMetaWriteLatency=poolMetaWriteLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcTargetGroup=fcTargetGroup, maintenanceModeDisabled=maintenanceModeDisabled, aclMigrationCompleted=aclMigrationCompleted, lunName=lunName, networkInterfaceDown=networkInterfaceDown, targetGroupCreateCompleted=targetGroupCreateCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, projectShares=projectShares, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolOwnerController=poolOwnerController, replicationPaused=replicationPaused, fcTargetsTable=fcTargetsTable, upgradeDownloadStarted=upgradeDownloadStarted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, notificationSensorAction=notificationSensorAction, snapshotCloneCompleted=snapshotCloneCompleted, diskTotalReadIops=diskTotalReadIops, poolReadCacheReadMbps=poolReadCacheReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, poolHealth=poolHealth, poolProjects=poolProjects, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolFreeSizeHigh=poolFreeSizeHigh, fcInitiatorGroup=fcInitiatorGroup, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiInitiatorIndex=iscsiInitiatorIndex, fcTargetReadLatency=fcTargetReadLatency, deleteFolderCompleted=deleteFolderCompleted, haControllerA_IPAddr=haControllerA_IPAddr, lunWriteIops=lunWriteIops, lunTable=lunTable, haControllerA_Uptime=haControllerA_Uptime, webdocsUpgradeCompleted=webdocsUpgradeCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareCIFSReadLatency=shareCIFSReadLatency, projectLunCount=projectLunCount, lunProjectName=lunProjectName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, alertsCleanupCompleted=alertsCleanupCompleted, poolTotalReadIops=poolTotalReadIops, smisServiceStarted=smisServiceStarted, cifsTotalWriteIops=cifsTotalWriteIops, shareCIFSWriteMbps=shareCIFSWriteMbps, diskChassisIdx=diskChassisIdx, ipmiCurrent=ipmiCurrent, poolDataReadIops=poolDataReadIops, upgradeTimeout=upgradeTimeout, poolCount=poolCount, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, cacheTotalReadIops=cacheTotalReadIops, volumeDeleteFailed=volumeDeleteFailed, snmpServiceStopFailed=snmpServiceStopFailed, cifsAvgWriteLatency=cifsAvgWriteLatency, snapshotRollbackCompleted=snapshotRollbackCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, cpuTotalUsage=cpuTotalUsage, replicationComplete=replicationComplete, shareDedupEnabled=shareDedupEnabled, fcTargetReadMbps=fcTargetReadMbps, cacheSSDReads=cacheSSDReads, lunWriteMbps=lunWriteMbps, diskAvgReadLatency=diskAvgReadLatency, projectCompressionEnabled=projectCompressionEnabled, lunDataSizeHigh=lunDataSizeHigh, cifsTotalWriteMbps=cifsTotalWriteMbps, volumeModifyCompleted=volumeModifyCompleted, fcAvgReadLatency=fcAvgReadLatency, unknownSensorEvent=unknownSensorEvent, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiInitiators=iscsiInitiators, diskState=diskState, haControllerB_Name=haControllerB_Name, haControllerB_Uptime=haControllerB_Uptime, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiInitiatorEntry=iscsiInitiatorEntry, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolDataWriteLatency=poolDataWriteLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, cifsTotalReadMbps=cifsTotalReadMbps, nfsTotalReadIops=nfsTotalReadIops, shareQuotaFinished=shareQuotaFinished, poolMetaReadIops=poolMetaReadIops, fcInitiatorName=fcInitiatorName, snmpServiceStartFailed=snmpServiceStartFailed, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunSizeHigh=lunSizeHigh, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, smisServiceStopped=smisServiceStopped, diskGoneOffline=diskGoneOffline, lunSnapshotSizeLow=lunSnapshotSizeLow, fcTargetReadIops=fcTargetReadIops, fcTargetWriteMbps=fcTargetWriteMbps, poolTotalSaving=poolTotalSaving, cpuSystemCalls=cpuSystemCalls, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolUsedSizeHigh=poolUsedSizeHigh, nfsTotalWriteMbps=nfsTotalWriteMbps, poolMetaWriteMbps=poolMetaWriteMbps, diskIndex=diskIndex, iscsiTargetGroupError=iscsiTargetGroupError, notificationSensorNumber=notificationSensorNumber, diskTotalReadMbps=diskTotalReadMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolUsedSizeLow=poolUsedSizeLow, disks=disks, nfsAvgWriteLatency=nfsAvgWriteLatency, lunReadLatency=lunReadLatency, nicState=nicState, poolIndex=poolIndex, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolAvgReadLatency=poolAvgReadLatency, projectTotalSaving=projectTotalSaving, projectCreatedSuccessfully=projectCreatedSuccessfully, networkInterfaceUp=networkInterfaceUp, lunCompressionEnabled=lunCompressionEnabled, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectLUNs=projectLUNs, cacheTotalReadMbps=cacheTotalReadMbps, diskIsOnline=diskIsOnline, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, haResourceActiveNode=haResourceActiveNode, tdpsUpgradeCompleted=tdpsUpgradeCompleted, userLoginFailed=userLoginFailed, smisServiceStopFailed=smisServiceStopFailed, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolTotalWriteIops=poolTotalWriteIops, notificationComponentName=notificationComponentName, tegile=tegile, poolState=poolState, lunSnapshotSizeHigh=lunSnapshotSizeHigh, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, haResourceDescription=haResourceDescription, poolTotalWriteMbps=poolTotalWriteMbps, lunTargetGroup=lunTargetGroup, snapshotRollbackFailed=snapshotRollbackFailed, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareCIFSWriteIops=shareCIFSWriteIops, lunDataSizeLow=lunDataSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, upgradeFailed=upgradeFailed, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcTargetStatus=fcTargetStatus, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, replicationResumed=replicationResumed, shareNFSEnabled=shareNFSEnabled, notificationProps=notificationProps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareNFSWriteMbps=shareNFSWriteMbps, diskDataReadMbps=diskDataReadMbps, poolMetaReadMbps=poolMetaReadMbps, diskPoolName=diskPoolName, poolAvgWriteLatency=poolAvgWriteLatency, notificationEventCode=notificationEventCode, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, deleteFolderFailed=deleteFolderFailed, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectFreeSizeHigh=projectFreeSizeHigh, diskRandomIOCount=diskRandomIOCount, shareDeleted=shareDeleted, notificationTime=notificationTime, notificationReadingTriggerValue=notificationReadingTriggerValue, controllerTimeDrift=controllerTimeDrift, snmpServiceStarted=snmpServiceStarted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareNFSReadMbps=shareNFSReadMbps, lunReadIops=lunReadIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, fcTotalWriteIops=fcTotalWriteIops, fcTargetName=fcTargetName, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiInitiatorGroup=iscsiInitiatorGroup, poolCreated=poolCreated, poolReadCacheReadIops=poolReadCacheReadIops, notificationTargetEntityName=notificationTargetEntityName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskIOCount=diskIOCount, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareCompressedRatio=shareCompressedRatio, nicName=nicName, lunReservedSizeHigh=lunReservedSizeHigh, tegileArray=tegileArray, lunPoolName=lunPoolName, notificationDescription=notificationDescription, projectQuotaFinished=projectQuotaFinished, fcTargetModifyCompleted=fcTargetModifyCompleted, replicationAborted=replicationAborted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolUpgraded=poolUpgraded, ipmiMemory=ipmiMemory, iscsiTargetReadMbps=iscsiTargetReadMbps, poolImported=poolImported, shareQuotaHigh=shareQuotaHigh, fcTargets=fcTargets, volumeQuotaFinished=volumeQuotaFinished, maintenanceModeEnabled=maintenanceModeEnabled, properties=properties, cacheTotalWriteIops=cacheTotalWriteIops, poolProjectCount=poolProjectCount, poolDataWriteMbps=poolDataWriteMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diskCount=diskCount, lunWriteLatency=lunWriteLatency, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectDedupEnabled=projectDedupEnabled, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh)
