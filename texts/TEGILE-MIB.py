...
Counter32, IpAddress, TimeTicks, Counter64, ObjectIdentity, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, NotificationType, Unsigned32, enterprises, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "TimeTicks", "Counter64", "ObjectIdentity", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "NotificationType", "Unsigned32", "enterprises", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunIndex=lunIndex, shareReservedSizeHigh=shareReservedSizeHigh, diskTotalReadIops=diskTotalReadIops, notificationProps=notificationProps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, tegileConformance=tegileConformance, poolDataWriteMbps=poolDataWriteMbps, diskTotalReadMbps=diskTotalReadMbps, tegileArray_notifications=tegileArray_notifications, lunWriteIops=lunWriteIops, projectCreatedSuccessfully=projectCreatedSuccessfully, fcInitiatorsTable=fcInitiatorsTable, networkTotalTransmitMbps=networkTotalTransmitMbps, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, snmpServiceStopFailed=snmpServiceStopFailed, shareNFSWriteLatency=shareNFSWriteLatency, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, replicationResumed=replicationResumed, tegile=tegile, lunReservedSizeHigh=lunReservedSizeHigh, aclMigrationStarted=aclMigrationStarted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, tegileGroups=tegileGroups, smisServiceStopped=smisServiceStopped, diskGoneOffline=diskGoneOffline, notificationObjects=notificationObjects, smisServiceStopFailed=smisServiceStopFailed, nvdimmFailSoftError=nvdimmFailSoftError, diskError=diskError, replicationTargetDeleted=replicationTargetDeleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, projectLunCount=projectLunCount, iscsiTargetEntry=iscsiTargetEntry, projectShareCount=projectShareCount, haControllerA_IPAddr=haControllerA_IPAddr, shareIndex=shareIndex, shareQuotaLow=shareQuotaLow, nfsTotalReadMbps=nfsTotalReadMbps, cacheSSDReads=cacheSSDReads, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareDataSizeLow=shareDataSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, adServerTimeDrift=adServerTimeDrift, shareDeleted=shareDeleted, poolState=poolState, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolReadCacheWriteIops=poolReadCacheWriteIops, lunCompressionEnabled=lunCompressionEnabled, shareSnapshotSizeLow=shareSnapshotSizeLow, sanProperties=sanProperties, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, targetGroupMemberAdded=targetGroupMemberAdded, haControllerA_Name=haControllerA_Name, spareDiskReplaced=spareDiskReplaced, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunProtocol=lunProtocol, iscsiTargets=iscsiTargets, nicTable=nicTable, poolTotalWriteIops=poolTotalWriteIops, diskEntry=diskEntry, intelliFlashSoftwareDown=intelliFlashSoftwareDown, diskTotalWriteIops=diskTotalWriteIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diagnosticDataUploaded=diagnosticDataUploaded, ipmiVoltage=ipmiVoltage, projectFreeSizeLow=projectFreeSizeLow, diskSizeHigh=diskSizeHigh, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskSlowIo=diskSlowIo, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolName=poolName, shareNFSReadLatency=shareNFSReadLatency, poolSizeHigh=poolSizeHigh, nfsTotalWriteIops=nfsTotalWriteIops, networkInterfaceDown=networkInterfaceDown, diskPoolName=diskPoolName, controllerTimeDrift=controllerTimeDrift, upgradeDownloadFailed=upgradeDownloadFailed, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectTable=projectTable, currentNotificationGroup=currentNotificationGroup, shareCIFSReadIops=shareCIFSReadIops, projectDataSizeLow=projectDataSizeLow, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, projectCompressionEnabled=projectCompressionEnabled, nfsAvgReadLatency=nfsAvgReadLatency, sharePoolName=sharePoolName, haResources=haResources, ipmiTemperature=ipmiTemperature, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, diskRandomIOCount=diskRandomIOCount, diskIsOnline=diskIsOnline, smisServiceStarted=smisServiceStarted, fcTotalWriteIops=fcTotalWriteIops, poolDataReadMbps=poolDataReadMbps, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, sensorFailureEvent=sensorFailureEvent, poolTotalReadIops=poolTotalReadIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolReadCacheReadMbps=poolReadCacheReadMbps, poolDataSizeHigh=poolDataSizeHigh, diskIOCount=diskIOCount, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, snmpAgentVersion=snmpAgentVersion, haResourceName=haResourceName, cacheTotalWriteIops=cacheTotalWriteIops, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolQuotaFinished=poolQuotaFinished, diskCount=diskCount, haControllerB_IPAddr=haControllerB_IPAddr, projectName=projectName, fcTargetModifyCompleted=fcTargetModifyCompleted, replicationFailed=replicationFailed, nfsTotalWriteMbps=nfsTotalWriteMbps, ipmiFan=ipmiFan, poolAvgWriteLatency=poolAvgWriteLatency, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargetAuth=iscsiTargetAuth, iscsiTargetIndex=iscsiTargetIndex, networkIpmpGroupUp=networkIpmpGroupUp, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, nicGroup=nicGroup, fcTargetReadLatency=fcTargetReadLatency, fcTargetsTable=fcTargetsTable, tegileCompliances=tegileCompliances, shareReservedSizeLow=shareReservedSizeLow, shareNFSEnabled=shareNFSEnabled, diskAlias=diskAlias, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiTargetsTable=iscsiTargetsTable, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, tegileArray=tegileArray, poolIndex=poolIndex, lunSizeLow=lunSizeLow, controllerHardwareModel=controllerHardwareModel, iscsiTargetError=iscsiTargetError, poolReadCacheReadIops=poolReadCacheReadIops, poolMetaReadLatency=poolMetaReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, cacheTotalWriteMbps=cacheTotalWriteMbps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcProperties=fcProperties, targetGroupDeleteCompleted=targetGroupDeleteCompleted, controllerUp=controllerUp, iscsiTargetGroup=iscsiTargetGroup, shareTable=shareTable, volumeModifyCompleted=volumeModifyCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunEntry=lunEntry, notificationDescription=notificationDescription, nfsAvgWriteLatency=nfsAvgWriteLatency, diskState=diskState, upgradeFailed=upgradeFailed, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolFreeSizeHigh=poolFreeSizeHigh, userLoginFailed=userLoginFailed, lunBlockSize=lunBlockSize, haControllerB_Name=haControllerB_Name, poolProjectCount=poolProjectCount, nvdimmFailInitializationError=nvdimmFailInitializationError, poolProjects=poolProjects, fcTargetWriteIops=fcTargetWriteIops, projectEntry=projectEntry, unknownSensorEvent=unknownSensorEvent, fcTargetWriteMbps=fcTargetWriteMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, haResourceIndex=haResourceIndex, shareNFSReadMbps=shareNFSReadMbps, notificationEventCode=notificationEventCode, networkIpmpGroupDown=networkIpmpGroupDown, projectDeletionFailed=projectDeletionFailed, replicationComplete=replicationComplete, diskDataWriteIops=diskDataWriteIops, iscsiInitiators=iscsiInitiators, poolDeleted=poolDeleted, shareDedupEnabled=shareDedupEnabled, iscsiInitiatorsTable=iscsiInitiatorsTable, shareQuotaHigh=shareQuotaHigh, diskDataReadIops=diskDataReadIops, tdpsUpgradeFailed=tdpsUpgradeFailed, deleteFolderCompleted=deleteFolderCompleted, nicEntry=nicEntry, notificationSensorAction=notificationSensorAction, shareCIFSReadLatency=shareCIFSReadLatency, cifsTotalReadIops=cifsTotalReadIops, network=network, fcTargetStatus=fcTargetStatus, iscsiTargetReadLatency=iscsiTargetReadLatency, lunDataSizeHigh=lunDataSizeHigh, targetGroupCreateCompleted=targetGroupCreateCompleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, targetGroupMemberRemoved=targetGroupMemberRemoved, fcPortOnline=fcPortOnline, iscsiImproperTargetGroup=iscsiImproperTargetGroup, projectTotalSaving=projectTotalSaving, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, volumeDeleteCompleted=volumeDeleteCompleted, upgradeStarted=upgradeStarted, iscsiTotalReadMbps=iscsiTotalReadMbps, lunSizeHigh=lunSizeHigh, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolUpgraded=poolUpgraded, iscsiTotalReadIops=iscsiTotalReadIops, iscsiProperties=iscsiProperties, cpuTotalUsage=cpuTotalUsage, replicationAborted=replicationAborted, poolTotalReadMbps=poolTotalReadMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, projectQuotaFinished=projectQuotaFinished, lunName=lunName, diskDataReadMbps=diskDataReadMbps, controllerDown=controllerDown, cifsTotalWriteMbps=cifsTotalWriteMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, maintenanceModeDisabled=maintenanceModeDisabled, haResourceActiveNode=haResourceActiveNode, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareCIFSWriteIops=shareCIFSWriteIops, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, disks=disks, poolOwnerController=poolOwnerController, projectSnapshotSizeLow=projectSnapshotSizeLow, replicationAbandoned=replicationAbandoned, fcInitiatorName=fcInitiatorName, lunReadLatency=lunReadLatency, haResourceStatus=haResourceStatus, poolMetaReadIops=poolMetaReadIops, fcTotalReadMbps=fcTotalReadMbps, iscsiTargetReadIops=iscsiTargetReadIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareNFSReadIops=shareNFSReadIops, fcInitiatorEntry=fcInitiatorEntry, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, smbSocketFailure=smbSocketFailure, diskType=diskType, poolImported=poolImported, netbiosSocketFailure=netbiosSocketFailure, haResourceDescription=haResourceDescription, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectThresholdExceedWarning=projectThresholdExceedWarning, lunReservedSizeLow=lunReservedSizeLow, poolAvgReadLatency=poolAvgReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted)
mibBuilder.exportSymbols("TEGILE-MIB", shareCompressionEnabled=shareCompressionEnabled, notifications=notifications, haControllerB_Uptime=haControllerB_Uptime, snapshotRollbackFailed=snapshotRollbackFailed, diskAvgWriteLatency=diskAvgWriteLatency, notificationTime=notificationTime, cifsAvgReadLatency=cifsAvgReadLatency, lunWriteLatency=lunWriteLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, nicState=nicState, lunTable=lunTable, volumeDeleteFailed=volumeDeleteFailed, poolCreated=poolCreated, fcTargetWriteLatency=fcTargetWriteLatency, projectDeleted=projectDeleted, poolDataWriteLatency=poolDataWriteLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, snmpServiceStarted=snmpServiceStarted, fcTargetEntry=fcTargetEntry, fcInitiators=fcInitiators, lunFreeSizeHigh=lunFreeSizeHigh, poolMetaReadMbps=poolMetaReadMbps, notificationComponentName=notificationComponentName, diskTable=diskTable, notificationReadingTriggerValue=notificationReadingTriggerValue, fcTotalReadIops=fcTotalReadIops, iscsiTargetGroupError=iscsiTargetGroupError, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, haResourceGroup=haResourceGroup, shareDeletionFailed=shareDeletionFailed, poolMetaWriteLatency=poolMetaWriteLatency, upgradeDownloadStarted=upgradeDownloadStarted, cacheRAMReads=cacheRAMReads, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, basicCompliance=basicCompliance, shareNFSWriteIops=shareNFSWriteIops, networkInterfaceUp=networkInterfaceUp, lunReadMbps=lunReadMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, replicationPaused=replicationPaused, nfsTotalReadIops=nfsTotalReadIops, currentObjectGroup=currentObjectGroup, diskSequentialIOCount=diskSequentialIOCount, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, lunDedupEnabled=lunDedupEnabled, globalStatistics=globalStatistics, fcTargetGroup=fcTargetGroup, nicMTU=nicMTU, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, iscsiInitiatorGroup=iscsiInitiatorGroup, cacheTotalReadIops=cacheTotalReadIops, cifsTotalWriteIops=cifsTotalWriteIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, ipmiCurrent=ipmiCurrent, replicationSourceRegistered=replicationSourceRegistered, iscsiInitiatorEntry=iscsiInitiatorEntry, diskDataWriteMbps=diskDataWriteMbps, deleteFolderFailed=deleteFolderFailed, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, ipmiPowerSupply=ipmiPowerSupply, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, alertsCleanupCompleted=alertsCleanupCompleted, projectLUNs=projectLUNs, lunPoolName=lunPoolName, diskTotalWriteMbps=diskTotalWriteMbps, poolUsedSizeHigh=poolUsedSizeHigh, lunFreeSizeLow=lunFreeSizeLow, projectDedupEnabled=projectDedupEnabled, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, notificationReadingUnit=notificationReadingUnit, ipmiMemory=ipmiMemory, fcTargetReadMbps=fcTargetReadMbps, poolDegraded=poolDegraded, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunProjectName=lunProjectName, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunWriteMbps=lunWriteMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskChassisIdx=diskChassisIdx, poolDataReadLatency=poolDataReadLatency, poolDataReadIops=poolDataReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, testNotification=testNotification, poolTable=poolTable, snmpServiceStopped=snmpServiceStopped, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectQuotaSizeLow=projectQuotaSizeLow, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, shareDataSizeHigh=shareDataSizeHigh, poolSizeLow=poolSizeLow, notificationTargetEntityName=notificationTargetEntityName, maintenanceModeEnabled=maintenanceModeEnabled, projectModified=projectModified, upgradeDownloadCompleted=upgradeDownloadCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, notificationThresholdTriggerValue=notificationThresholdTriggerValue, intelliFlashSoftwareUp=intelliFlashSoftwareUp, PYSNMP_MODULE_ID=tegile, haControllerA_Uptime=haControllerA_Uptime, shareMountPoint=shareMountPoint, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiTargetAlias=iscsiTargetAlias, shareName=shareName, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareCompressedRatio=shareCompressedRatio, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, snapshotCloningFailed=snapshotCloningFailed, diskIndex=diskIndex, lunReadIops=lunReadIops, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, iscsiWriteIops=iscsiWriteIops, poolEntry=poolEntry, shareEntry=shareEntry, projectIndex=projectIndex, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, fcInitiatorIndex=fcInitiatorIndex, poolDataWriteIops=poolDataWriteIops, nvdimmFailDeviceError=nvdimmFailDeviceError, poolFreeSizeLow=poolFreeSizeLow, upgradeCompleted=upgradeCompleted, properties=properties, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolMetaWriteMbps=poolMetaWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, poolDataSizeLow=poolDataSizeLow, iscsiInitiatorName=iscsiInitiatorName, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, cpuSystemCalls=cpuSystemCalls, cifsTotalReadMbps=cifsTotalReadMbps, snapshotCloneCompleted=snapshotCloneCompleted, poolExported=poolExported, poolMetaWriteIops=poolMetaWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolTotalWriteMbps=poolTotalWriteMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, nicReceiveMbps=nicReceiveMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, volumeQuotaFinished=volumeQuotaFinished, smisServiceStartFailed=smisServiceStartFailed, projectDataSizeHigh=projectDataSizeHigh, cpuInterrupts=cpuInterrupts, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, ipmiThreshold=ipmiThreshold, poolExpanded=poolExpanded, nicIndex=nicIndex, notificationSensorNumber=notificationSensorNumber, replicationStarted=replicationStarted, projectShares=projectShares, shareCIFSWriteLatency=shareCIFSWriteLatency, pools=pools, fcPortOffline=fcPortOffline, projectPoolName=projectPoolName, poolCount=poolCount, snapshotDeleteFailed=snapshotDeleteFailed, snmpServiceStartFailed=snmpServiceStartFailed, diskSizeLow=diskSizeLow, shareQuotaFinished=shareQuotaFinished, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, ipmiOther=ipmiOther, vmwareNFSDatastores=vmwareNFSDatastores, lunCompressedRatio=lunCompressedRatio, nicName=nicName, volumeCreatedSuccessfully=volumeCreatedSuccessfully, diskAvgReadLatency=diskAvgReadLatency, fcAvgWriteLatency=fcAvgWriteLatency, poolTotalSaving=poolTotalSaving, fcTargetReadIops=fcTargetReadIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, haResourcesTable=haResourcesTable, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, ntpServerTimeDrift=ntpServerTimeDrift, poolUsedSizeLow=poolUsedSizeLow, aclMigrationCompleted=aclMigrationCompleted, upgradeTimeout=upgradeTimeout, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, memoryFailure=memoryFailure, cacheTotalReadMbps=cacheTotalReadMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, snapshotCreationFailed=snapshotCreationFailed, fcTargetIndex=fcTargetIndex, shareProjectName=shareProjectName, notificationSeverity=notificationSeverity, ipmiCriticalInterrupt=ipmiCriticalInterrupt, lunGUID=lunGUID, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, notificationSensorSuspect=notificationSensorSuspect, shareNFSWriteMbps=shareNFSWriteMbps, lunInitiatorGroup=lunInitiatorGroup, fcTargetName=fcTargetName, iscsiTargetName=iscsiTargetName, lunDataSizeLow=lunDataSizeLow, shareCIFSReadMbps=shareCIFSReadMbps, poolDeletionFailed=poolDeletionFailed, lunTargetGroup=lunTargetGroup, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, fcTotalWriteMbps=fcTotalWriteMbps, nicTransmitMbps=nicTransmitMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcAvgReadLatency=fcAvgReadLatency, fcInitiatorGroup=fcInitiatorGroup, haResourceEntry=haResourceEntry, poolHealth=poolHealth, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareCIFSEnabled=shareCIFSEnabled, projectSnapshotSizeHigh=projectSnapshotSizeHigh, fcTargets=fcTargets)
