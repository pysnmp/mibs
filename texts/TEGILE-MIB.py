...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:46:04 2022
...
mibBuilder.exportSymbols("TEGILE-MIB", adServerTimeDrift=adServerTimeDrift, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolMetaReadLatency=poolMetaReadLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, notificationSensorAction=notificationSensorAction, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, notificationSensorSuspect=notificationSensorSuspect, diskGoneOffline=diskGoneOffline, diskSizeHigh=diskSizeHigh, poolProjects=poolProjects, snmpServiceStopped=snmpServiceStopped, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, sanProperties=sanProperties, shareSnapshotSizeLow=shareSnapshotSizeLow, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunEntry=lunEntry, poolState=poolState, nvdimmFailDeviceError=nvdimmFailDeviceError, poolDataWriteLatency=poolDataWriteLatency, shareQuotaFinished=shareQuotaFinished, spareDiskReplaced=spareDiskReplaced, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, lunPoolName=lunPoolName, diskTable=diskTable, poolTotalWriteIops=poolTotalWriteIops, notificationTime=notificationTime, projectIndex=projectIndex, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareProjectName=shareProjectName, diskIndex=diskIndex, tdpsUpgradeFailed=tdpsUpgradeFailed, disks=disks, poolAvgReadLatency=poolAvgReadLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunReadIops=lunReadIops, network=network, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, unknownSensorEvent=unknownSensorEvent, iscsiTotalReadMbps=iscsiTotalReadMbps, fcProperties=fcProperties, poolProjectCount=poolProjectCount, projectEntry=projectEntry, tegileCompliances=tegileCompliances, currentObjectGroup=currentObjectGroup, targetGroupCreateCompleted=targetGroupCreateCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, notificationSeverity=notificationSeverity, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiTotalReadIops=iscsiTotalReadIops, snmpServiceStartFailed=snmpServiceStartFailed, fcTargetIndex=fcTargetIndex, replicationFailed=replicationFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, controllerUp=controllerUp, fcTargetName=fcTargetName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, controllerHardwareModel=controllerHardwareModel, iscsiTargetsTable=iscsiTargetsTable, cacheSSDReads=cacheSSDReads, lunSizeLow=lunSizeLow, notificationObjects=notificationObjects, lunDedupEnabled=lunDedupEnabled, shareNFSWriteLatency=shareNFSWriteLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, poolImported=poolImported, haResourceActiveNode=haResourceActiveNode, fcPortOnline=fcPortOnline, ipmiPowerSupply=ipmiPowerSupply, shareQuotaHigh=shareQuotaHigh, iscsiInitiatorGroup=iscsiInitiatorGroup, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectQuotaSizeLow=projectQuotaSizeLow, fcTotalWriteMbps=fcTotalWriteMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiTargetAuth=iscsiTargetAuth, iscsiWriteIops=iscsiWriteIops, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareCompressionEnabled=shareCompressionEnabled, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectQuotaFinished=projectQuotaFinished, poolTotalSaving=poolTotalSaving, shareNFSWriteIops=shareNFSWriteIops, diskRandomIOCount=diskRandomIOCount, projectDeletionFailed=projectDeletionFailed, projectFreeSizeLow=projectFreeSizeLow, fcInitiators=fcInitiators, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, nfsAvgReadLatency=nfsAvgReadLatency, snapshotCreationFailed=snapshotCreationFailed, fcTargetWriteIops=fcTargetWriteIops, iscsiTargetReadIops=iscsiTargetReadIops, diagnosticDataUploaded=diagnosticDataUploaded, shareDedupEnabled=shareDedupEnabled, poolSizeLow=poolSizeLow, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectName=projectName, diskChassisIdx=diskChassisIdx, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiProperties=iscsiProperties, shareIndex=shareIndex, iscsiTargetIndex=iscsiTargetIndex, replicationAborted=replicationAborted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, shareCIFSReadLatency=shareCIFSReadLatency, lunFreeSizeLow=lunFreeSizeLow, projectShareCount=projectShareCount, iscsiTargetWriteLatency=iscsiTargetWriteLatency, volumeDeleteCompleted=volumeDeleteCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, maintenanceModeEnabled=maintenanceModeEnabled, fcTotalWriteIops=fcTotalWriteIops, networkInterfaceUp=networkInterfaceUp, targetGroupMemberAdded=targetGroupMemberAdded, poolDeletionFailed=poolDeletionFailed, aclMigrationStarted=aclMigrationStarted, diskState=diskState, iscsiTargetWriteIops=iscsiTargetWriteIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, lunDataSizeLow=lunDataSizeLow, poolQuotaFinished=poolQuotaFinished, poolUsedSizeLow=poolUsedSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcInitiatorEntry=fcInitiatorEntry, shareDataSizeLow=shareDataSizeLow, diskIOCount=diskIOCount, poolDataReadIops=poolDataReadIops, iscsiInitiatorEntry=iscsiInitiatorEntry, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskSizeLow=diskSizeLow, intelliFlashSoftwareDown=intelliFlashSoftwareDown, cacheTotalWriteMbps=cacheTotalWriteMbps, ntpServerTimeDrift=ntpServerTimeDrift, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolReadCacheReadMbps=poolReadCacheReadMbps, poolTable=poolTable, snmpServiceStopFailed=snmpServiceStopFailed, iscsiTargetWriteMbps=iscsiTargetWriteMbps, lunWriteLatency=lunWriteLatency, shareNFSReadMbps=shareNFSReadMbps, deleteFolderFailed=deleteFolderFailed, networkIpmpGroupDown=networkIpmpGroupDown, lunName=lunName, smisServiceStopped=smisServiceStopped, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareCIFSWriteIops=shareCIFSWriteIops, aclMigrationCompleted=aclMigrationCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, replicationResumed=replicationResumed, projectLunCount=projectLunCount, iscsiTargetEntry=iscsiTargetEntry, poolDataSizeHigh=poolDataSizeHigh, diskDataReadIops=diskDataReadIops, iscsiTargetGroup=iscsiTargetGroup, cacheTotalReadIops=cacheTotalReadIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, nfsTotalWriteMbps=nfsTotalWriteMbps, snmpServiceStarted=snmpServiceStarted, nfsTotalReadMbps=nfsTotalReadMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, cifsTotalWriteMbps=cifsTotalWriteMbps, replicationTargetDeleted=replicationTargetDeleted, iscsiTargetReadMbps=iscsiTargetReadMbps, lunGUID=lunGUID, shareName=shareName, notificationDescription=notificationDescription, poolReadCacheWriteMbps=poolReadCacheWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, nicMTU=nicMTU, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, cpuTotalUsage=cpuTotalUsage, cpuSystemCalls=cpuSystemCalls, projectSnapshotSizeHigh=projectSnapshotSizeHigh, snapshotCloningFailed=snapshotCloningFailed, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, fcAvgWriteLatency=fcAvgWriteLatency, haResourceDescription=haResourceDescription, lunProjectName=lunProjectName, shareDataSizeHigh=shareDataSizeHigh, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diskEntry=diskEntry, fcInitiatorName=fcInitiatorName, projectDedupEnabled=projectDedupEnabled, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, upgradeCompleted=upgradeCompleted, smisServiceStartFailed=smisServiceStartFailed, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiInitiators=iscsiInitiators, lunReadMbps=lunReadMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, haControllerA_IPAddr=haControllerA_IPAddr, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectModified=projectModified, poolDataWriteMbps=poolDataWriteMbps, nicGroup=nicGroup, poolTotalReadIops=poolTotalReadIops, ipmiMemory=ipmiMemory, lunProtocol=lunProtocol, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetError=iscsiTargetError, volumeModifyCompleted=volumeModifyCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectDataSizeHigh=projectDataSizeHigh, fcTargetReadIops=fcTargetReadIops, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, networkInterfaceDown=networkInterfaceDown, cifsAvgReadLatency=cifsAvgReadLatency, snapshotDeleteFailed=snapshotDeleteFailed, nicReceiveMbps=nicReceiveMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, haResourceEntry=haResourceEntry, diskIsOnline=diskIsOnline, nfsTotalReadIops=nfsTotalReadIops, haResources=haResources, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareDeleted=shareDeleted, cacheTotalReadMbps=cacheTotalReadMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, netbiosSocketFailure=netbiosSocketFailure, poolDataReadLatency=poolDataReadLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTargetAlias=iscsiTargetAlias, snapshotCloneCompleted=snapshotCloneCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, deleteFolderCompleted=deleteFolderCompleted, lunBlockSize=lunBlockSize, nfsTotalWriteIops=nfsTotalWriteIops, shareCIFSWriteLatency=shareCIFSWriteLatency, poolDataWriteIops=poolDataWriteIops, poolFreeSizeHigh=poolFreeSizeHigh, maintenanceModeDisabled=maintenanceModeDisabled, poolFreeSizeLow=poolFreeSizeLow, poolMetaWriteIops=poolMetaWriteIops, upgradeFailed=upgradeFailed, poolHealth=poolHealth, replicationComplete=replicationComplete, lunTargetGroup=lunTargetGroup, fcTargetWriteLatency=fcTargetWriteLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, fcTargetStatus=fcTargetStatus, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, lunWriteMbps=lunWriteMbps)
mibBuilder.exportSymbols("TEGILE-MIB", poolMetaReadMbps=poolMetaReadMbps, diskSlowIo=diskSlowIo, cacheTotalWriteIops=cacheTotalWriteIops, diskDataWriteIops=diskDataWriteIops, haResourceGroup=haResourceGroup, fcTargetWriteMbps=fcTargetWriteMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, shareCIFSEnabled=shareCIFSEnabled, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, nicTable=nicTable, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiInitiatorName=iscsiInitiatorName, lunInitiatorGroup=lunInitiatorGroup, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolMetaReadIops=poolMetaReadIops, fcTotalReadIops=fcTotalReadIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, lunWriteIops=lunWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, tegile=tegile, currentNotificationGroup=currentNotificationGroup, userLoginFailed=userLoginFailed, diskTotalReadIops=diskTotalReadIops, globalStatistics=globalStatistics, nvdimmFailSoftError=nvdimmFailSoftError, haControllerB_Name=haControllerB_Name, notificationReadingUnit=notificationReadingUnit, iscsiTargets=iscsiTargets, fcPortOffline=fcPortOffline, lunReservedSizeLow=lunReservedSizeLow, PYSNMP_MODULE_ID=tegile, tdpsUpgradeCompleted=tdpsUpgradeCompleted, diskDataWriteMbps=diskDataWriteMbps, memoryFailure=memoryFailure, projectQuotaSizeHigh=projectQuotaSizeHigh, lunFreeSizeHigh=lunFreeSizeHigh, poolExported=poolExported, fcInitiatorGroup=fcInitiatorGroup, projectTable=projectTable, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiTargetName=iscsiTargetName, notificationEventCode=notificationEventCode, ipmiThreshold=ipmiThreshold, upgradeTimeout=upgradeTimeout, replicationStarted=replicationStarted, alertsCleanupCompleted=alertsCleanupCompleted, notifications=notifications, tegileConformance=tegileConformance, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, pools=pools, poolCount=poolCount, networkTotalReceiveMbps=networkTotalReceiveMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, diskDataReadMbps=diskDataReadMbps, shareTable=shareTable, smisServiceStarted=smisServiceStarted, tegileGroups=tegileGroups, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectDeleted=projectDeleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiTargetGroupError=iscsiTargetGroupError, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, upgradeDownloadFailed=upgradeDownloadFailed, haResourceName=haResourceName, tegileArray=tegileArray, ipmiOther=ipmiOther, poolReadCacheReadIops=poolReadCacheReadIops, poolDataReadMbps=poolDataReadMbps, diskTotalWriteMbps=diskTotalWriteMbps, lunIndex=lunIndex, ipmiCurrent=ipmiCurrent, shareCIFSReadIops=shareCIFSReadIops, lunTable=lunTable, haResourcesTable=haResourcesTable, poolMetaWriteLatency=poolMetaWriteLatency, lunCompressedRatio=lunCompressedRatio, fcTargetReadMbps=fcTargetReadMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, volumeQuotaFinished=volumeQuotaFinished, snmpAgentVersion=snmpAgentVersion, projectCreatedSuccessfully=projectCreatedSuccessfully, shareEntry=shareEntry, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, vmwareNFSDatastores=vmwareNFSDatastores, testNotification=testNotification, diskAlias=diskAlias, shareExceedThresholdWarning=shareExceedThresholdWarning, shareCompressedRatio=shareCompressedRatio, smisServiceStopFailed=smisServiceStopFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, snapshotRollbackCompleted=snapshotRollbackCompleted, diskError=diskError, notificationTargetEntityName=notificationTargetEntityName, haResourceIndex=haResourceIndex, sharePoolName=sharePoolName, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectPoolName=projectPoolName, smbSocketFailure=smbSocketFailure, poolIndex=poolIndex, lunSizeHigh=lunSizeHigh, notificationComponentName=notificationComponentName, poolExpanded=poolExpanded, diskSequentialIOCount=diskSequentialIOCount, shareMountPoint=shareMountPoint, networkTotalTransmitMbps=networkTotalTransmitMbps, replicationPaused=replicationPaused, upgradeDownloadStarted=upgradeDownloadStarted, fcTargetReadLatency=fcTargetReadLatency, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcInitiatorsTable=fcInitiatorsTable, shareNFSReadLatency=shareNFSReadLatency, poolDeleted=poolDeleted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareNFSReadIops=shareNFSReadIops, controllerTimeDrift=controllerTimeDrift, projectShares=projectShares, iscsiAvgReadLatency=iscsiAvgReadLatency, snapshotRollbackFailed=snapshotRollbackFailed, ipmiVoltage=ipmiVoltage, poolUsedSizeHigh=poolUsedSizeHigh, shareNFSEnabled=shareNFSEnabled, poolDegraded=poolDegraded, projectFreeSizeHigh=projectFreeSizeHigh, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, nfsAvgWriteLatency=nfsAvgWriteLatency, notificationProps=notificationProps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, haControllerA_Name=haControllerA_Name, lunCompressionEnabled=lunCompressionEnabled, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, replicationSourceRegistered=replicationSourceRegistered, poolName=poolName, poolCreated=poolCreated, nicState=nicState, fcTargetModifyCompleted=fcTargetModifyCompleted, tegileArray_notifications=tegileArray_notifications, poolSizeHigh=poolSizeHigh, ipmiTemperature=ipmiTemperature, networkIpmpGroupUp=networkIpmpGroupUp, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunReadLatency=lunReadLatency, projectDataSizeLow=projectDataSizeLow, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, nvdimmFailInitializationError=nvdimmFailInitializationError, iscsiInitiatorChapUser=iscsiInitiatorChapUser, shareDeletionFailed=shareDeletionFailed, poolUpgraded=poolUpgraded, poolReadCacheReadLatency=poolReadCacheReadLatency, notificationSensorNumber=notificationSensorNumber, cacheRAMReads=cacheRAMReads, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectLUNs=projectLUNs, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareQuotaLow=shareQuotaLow, nicTransmitMbps=nicTransmitMbps, cpuInterrupts=cpuInterrupts, shareCreatedSuccessfully=shareCreatedSuccessfully, fcTotalReadMbps=fcTotalReadMbps, diskType=diskType, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, projectCompressionEnabled=projectCompressionEnabled, haControllerB_IPAddr=haControllerB_IPAddr, upgradeStarted=upgradeStarted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, diskTotalWriteIops=diskTotalWriteIops, properties=properties, poolReadCacheWriteLatency=poolReadCacheWriteLatency, cifsTotalReadIops=cifsTotalReadIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolAvgWriteLatency=poolAvgWriteLatency, basicCompliance=basicCompliance, fcInitiatorIndex=fcInitiatorIndex, haControllerA_Uptime=haControllerA_Uptime, poolOwnerController=poolOwnerController, nicEntry=nicEntry, poolMetaWriteMbps=poolMetaWriteMbps, fcTargets=fcTargets, diskTotalReadMbps=diskTotalReadMbps, controllerDown=controllerDown, shareReservedSizeLow=shareReservedSizeLow, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolTotalWriteMbps=poolTotalWriteMbps, poolTotalReadMbps=poolTotalReadMbps, lunDataSizeHigh=lunDataSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, diskCount=diskCount, fcTargetEntry=fcTargetEntry, fcAvgReadLatency=fcAvgReadLatency, sensorFailureEvent=sensorFailureEvent, poolEntry=poolEntry, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunReservedSizeHigh=lunReservedSizeHigh, poolReadCacheWriteIops=poolReadCacheWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diskAvgReadLatency=diskAvgReadLatency, volumeDeleteFailed=volumeDeleteFailed, diskPoolName=diskPoolName, haControllerB_Uptime=haControllerB_Uptime, fcTargetsTable=fcTargetsTable, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, nicName=nicName, diskAvgWriteLatency=diskAvgWriteLatency, shareReservedSizeHigh=shareReservedSizeHigh, haResourceStatus=haResourceStatus, nicIndex=nicIndex, ipmiFan=ipmiFan, replicationAbandoned=replicationAbandoned, lunSnapshotSizeLow=lunSnapshotSizeLow, projectTotalSaving=projectTotalSaving)
