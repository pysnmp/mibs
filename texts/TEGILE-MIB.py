...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:28:09 2022
...
ObjectIdentity, ModuleIdentity, Bits, TimeTicks, Counter64, IpAddress, Gauge32, MibIdentifier, Counter32, enterprises, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Bits", "TimeTicks", "Counter64", "IpAddress", "Gauge32", "MibIdentifier", "Counter32", "enterprises", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolUsedSizeLow=poolUsedSizeLow, haControllerA_Uptime=haControllerA_Uptime, lunReadMbps=lunReadMbps, ipmiMemory=ipmiMemory, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, ntpServerTimeDrift=ntpServerTimeDrift, poolFreeSizeLow=poolFreeSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, haResourceDescription=haResourceDescription, poolMetaWriteLatency=poolMetaWriteLatency, ipmiThreshold=ipmiThreshold, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiTargetGroup=iscsiTargetGroup, projectDeletionFailed=projectDeletionFailed, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, nicTransmitMbps=nicTransmitMbps, diskTotalWriteIops=diskTotalWriteIops, poolMetaReadMbps=poolMetaReadMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, lunInitiatorGroup=lunInitiatorGroup, iscsiAvgReadLatency=iscsiAvgReadLatency, poolDeletionFailed=poolDeletionFailed, shareQuotaFinished=shareQuotaFinished, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, fcPortOnline=fcPortOnline, tegileGroups=tegileGroups, shareDedupEnabled=shareDedupEnabled, ipmiFan=ipmiFan, shareSnapshotSizeLow=shareSnapshotSizeLow, poolExported=poolExported, cacheRAMReads=cacheRAMReads, sharePoolName=sharePoolName, shareNFSWriteIops=shareNFSWriteIops, fcTargetIndex=fcTargetIndex, iscsiTargetEntry=iscsiTargetEntry, vmwareNFSDatastores=vmwareNFSDatastores, smisServiceStarted=smisServiceStarted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiWriteIops=iscsiWriteIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunTable=lunTable, poolOwnerController=poolOwnerController, poolTotalWriteMbps=poolTotalWriteMbps, projectTable=projectTable, poolDataWriteIops=poolDataWriteIops, snmpServiceStopFailed=snmpServiceStopFailed, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, cifsAvgWriteLatency=cifsAvgWriteLatency, fcTargetWriteMbps=fcTargetWriteMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, diskDataWriteMbps=diskDataWriteMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, diskSizeLow=diskSizeLow, nvdimmFailSoftError=nvdimmFailSoftError, fcTotalWriteIops=fcTotalWriteIops, poolTotalReadMbps=poolTotalReadMbps, replicationTargetDeleted=replicationTargetDeleted, upgradeDownloadCompleted=upgradeDownloadCompleted, cpuSystemCalls=cpuSystemCalls, fcTargetName=fcTargetName, webdocsUpgradeCompleted=webdocsUpgradeCompleted, tegileArray=tegileArray, initiatorGroupMemberAdded=initiatorGroupMemberAdded, unknownSensorEvent=unknownSensorEvent, diskPoolName=diskPoolName, diskRandomIOCount=diskRandomIOCount, disks=disks, lunDataSizeLow=lunDataSizeLow, nicState=nicState, aclMigrationStarted=aclMigrationStarted, tegileCompliances=tegileCompliances, nicReceiveMbps=nicReceiveMbps, cifsAvgReadLatency=cifsAvgReadLatency, iscsiTargetWriteMbps=iscsiTargetWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, diskAlias=diskAlias, haControllerB_Uptime=haControllerB_Uptime, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectThresholdExceedWarning=projectThresholdExceedWarning, userLoginFailed=userLoginFailed, lunSnapshotSizeHigh=lunSnapshotSizeHigh, shareProjectName=shareProjectName, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiTargetReadIops=iscsiTargetReadIops, volumeDeleteCompleted=volumeDeleteCompleted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, globalStatistics=globalStatistics, shareCIFSReadLatency=shareCIFSReadLatency, shareCompressionEnabled=shareCompressionEnabled, nicMTU=nicMTU, poolProjects=poolProjects, poolExpanded=poolExpanded, lunCompressionEnabled=lunCompressionEnabled, cifsTotalReadIops=cifsTotalReadIops, notificationReadingTriggerValue=notificationReadingTriggerValue, iscsiTargetReadLatency=iscsiTargetReadLatency, poolCount=poolCount, ipmiTemperature=ipmiTemperature, poolMetaReadLatency=poolMetaReadLatency, iscsiTargets=iscsiTargets, projectFreeSizeHigh=projectFreeSizeHigh, poolEntry=poolEntry, replicationComplete=replicationComplete, diskDataReadIops=diskDataReadIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, alertsCleanupCompleted=alertsCleanupCompleted, notificationSensorAction=notificationSensorAction, tegile=tegile, poolMetaWriteMbps=poolMetaWriteMbps, volumeModifyCompleted=volumeModifyCompleted, projectIndex=projectIndex, replicationAbandoned=replicationAbandoned, fcTargetStatus=fcTargetStatus, notificationSensorSuspect=notificationSensorSuspect, sanProperties=sanProperties, webdocsUpgradeFailed=webdocsUpgradeFailed, haResourceActiveNode=haResourceActiveNode, projectLunCount=projectLunCount, projectCompressionEnabled=projectCompressionEnabled, targetGroupMemberRemoved=targetGroupMemberRemoved, fcAvgWriteLatency=fcAvgWriteLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, nicEntry=nicEntry, poolCreated=poolCreated, diagnosticDataUploaded=diagnosticDataUploaded, spareDiskReplaced=spareDiskReplaced, fcInitiatorIndex=fcInitiatorIndex, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareNFSReadIops=shareNFSReadIops, shareNFSReadMbps=shareNFSReadMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, volumeQuotaFinished=volumeQuotaFinished, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, volumeDeleteFailed=volumeDeleteFailed, notificationTime=notificationTime, snapshotDeleteFailed=snapshotDeleteFailed, notificationReadingUnit=notificationReadingUnit, replicationPaused=replicationPaused, iscsiTargetIndex=iscsiTargetIndex, adServerTimeDrift=adServerTimeDrift, cacheTotalWriteIops=cacheTotalWriteIops, upgradeTimeout=upgradeTimeout, iscsiTotalReadIops=iscsiTotalReadIops, iscsiInitiatorEntry=iscsiInitiatorEntry, poolQuotaFinished=poolQuotaFinished, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcPortOffline=fcPortOffline, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcTargetWriteLatency=fcTargetWriteLatency, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolSizeHigh=poolSizeHigh, poolFreeSizeHigh=poolFreeSizeHigh, lunSizeLow=lunSizeLow, iscsiTargetAlias=iscsiTargetAlias, sensorFailureEvent=sensorFailureEvent, notificationSensorNumber=notificationSensorNumber, snmpAgentVersion=snmpAgentVersion, lunName=lunName, diskDataReadMbps=diskDataReadMbps, nicGroup=nicGroup, cacheTotalReadMbps=cacheTotalReadMbps, cifsTotalReadMbps=cifsTotalReadMbps, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, lunProtocol=lunProtocol, upgradeDownloadFailed=upgradeDownloadFailed, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolMetaWriteIops=poolMetaWriteIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, notificationEventCode=notificationEventCode, aclMigrationCompleted=aclMigrationCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareQuotaHigh=shareQuotaHigh, networkIpmpGroupDown=networkIpmpGroupDown, projectFreeSizeLow=projectFreeSizeLow, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcTargets=fcTargets, upgradeFailed=upgradeFailed, haControllerA_IPAddr=haControllerA_IPAddr, lunReservedSizeHigh=lunReservedSizeHigh, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunWriteIops=lunWriteIops, haResourceGroup=haResourceGroup, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, deleteFolderCompleted=deleteFolderCompleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, snapshotCloneCompleted=snapshotCloneCompleted, haResourceIndex=haResourceIndex, diskTotalReadIops=diskTotalReadIops, lunWriteMbps=lunWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcTargetWriteIops=fcTargetWriteIops, nfsTotalReadIops=nfsTotalReadIops, replicationAborted=replicationAborted, shareIndex=shareIndex, iscsiInitiatorChapUser=iscsiInitiatorChapUser, notificationTargetEntityName=notificationTargetEntityName, diskSlowIo=diskSlowIo, diskTable=diskTable, basicCompliance=basicCompliance, nicName=nicName, iscsiInitiatorsTable=iscsiInitiatorsTable, nvdimmFailDeviceError=nvdimmFailDeviceError, haControllerB_IPAddr=haControllerB_IPAddr, shareCompressedRatio=shareCompressedRatio, poolMetaReadIops=poolMetaReadIops, maintenanceModeDisabled=maintenanceModeDisabled, notificationProps=notificationProps, cacheTotalReadIops=cacheTotalReadIops, pools=pools, lunEntry=lunEntry, snapshotCreationFailed=snapshotCreationFailed, shareEntry=shareEntry, cacheSSDReads=cacheSSDReads, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiTargetName=iscsiTargetName, poolTable=poolTable, iscsiInitiatorName=iscsiInitiatorName, shareReservedSizeLow=shareReservedSizeLow, fcInitiatorCreateFailed=fcInitiatorCreateFailed, smisServiceStartFailed=smisServiceStartFailed, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectDeleted=projectDeleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiTargetsTable=iscsiTargetsTable, tegileArray_notifications=tegileArray_notifications, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, lunBlockSize=lunBlockSize, lunSizeHigh=lunSizeHigh, snmpServiceStartFailed=snmpServiceStartFailed, nvdimmFailInitializationError=nvdimmFailInitializationError, diskTotalReadMbps=diskTotalReadMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, replicationSourceRegistered=replicationSourceRegistered, projectSnapshotSizeHigh=projectSnapshotSizeHigh, testNotification=testNotification, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareReservedSizeHigh=shareReservedSizeHigh, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, lunGUID=lunGUID, diskAvgWriteLatency=diskAvgWriteLatency, ipmiOther=ipmiOther, projectName=projectName, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName)
mibBuilder.exportSymbols("TEGILE-MIB", poolProjectCount=poolProjectCount, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, PYSNMP_MODULE_ID=tegile, ipmiVoltage=ipmiVoltage, networkTotalTransmitMbps=networkTotalTransmitMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolReadCacheReadLatency=poolReadCacheReadLatency, lunIndex=lunIndex, haResourceName=haResourceName, shareCreatedSuccessfully=shareCreatedSuccessfully, poolAvgReadLatency=poolAvgReadLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, diskSequentialIOCount=diskSequentialIOCount, controllerDown=controllerDown, snapshotCloningFailed=snapshotCloningFailed, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, diskChassisIdx=diskChassisIdx, poolDegraded=poolDegraded, controllerHardwareModel=controllerHardwareModel, snmpServiceStopped=snmpServiceStopped, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcProperties=fcProperties, shareCIFSEnabled=shareCIFSEnabled, poolReadCacheWriteIops=poolReadCacheWriteIops, poolReadCacheReadMbps=poolReadCacheReadMbps, haControllerB_Name=haControllerB_Name, poolDataReadLatency=poolDataReadLatency, poolDataWriteMbps=poolDataWriteMbps, lunCompressedRatio=lunCompressedRatio, fcTotalReadMbps=fcTotalReadMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, projectShares=projectShares, shareDeleted=shareDeleted, fcTotalWriteMbps=fcTotalWriteMbps, smbSocketFailure=smbSocketFailure, deleteFolderFailed=deleteFolderFailed, diskError=diskError, netbiosSocketFailure=netbiosSocketFailure, shareSnapshotSizeHigh=shareSnapshotSizeHigh, lunFreeSizeLow=lunFreeSizeLow, ipmiPowerSupply=ipmiPowerSupply, iscsiInitiatorGroup=iscsiInitiatorGroup, targetGroupCreateCompleted=targetGroupCreateCompleted, projectQuotaSizeLow=projectQuotaSizeLow, iscsiInitiators=iscsiInitiators, poolDataWriteLatency=poolDataWriteLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, fcTargetReadMbps=fcTargetReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, snapshotRollbackCompleted=snapshotRollbackCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, notificationDescription=notificationDescription, poolAvgWriteLatency=poolAvgWriteLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, currentNotificationGroup=currentNotificationGroup, poolDataSizeLow=poolDataSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, diskDataWriteIops=diskDataWriteIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, diskIsOnline=diskIsOnline, poolUsedSizeHigh=poolUsedSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, haResources=haResources, poolSizeLow=poolSizeLow, poolTotalWriteIops=poolTotalWriteIops, maintenanceModeEnabled=maintenanceModeEnabled, fcInitiatorName=fcInitiatorName, poolDeleted=poolDeleted, projectEntry=projectEntry, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, shareDeletionFailed=shareDeletionFailed, controllerTimeDrift=controllerTimeDrift, cpuInterrupts=cpuInterrupts, ipmiCurrent=ipmiCurrent, upgradeStarted=upgradeStarted, poolIndex=poolIndex, projectLUNs=projectLUNs, poolDataReadIops=poolDataReadIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, network=network, lunProjectName=lunProjectName, projectDataSizeLow=projectDataSizeLow, projectDedupEnabled=projectDedupEnabled, fcTotalReadIops=fcTotalReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, memoryFailure=memoryFailure, shareCIFSWriteMbps=shareCIFSWriteMbps, fcTargetReadIops=fcTargetReadIops, shareCIFSReadIops=shareCIFSReadIops, shareNFSWriteMbps=shareNFSWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, projectModified=projectModified, lunPoolName=lunPoolName, notificationThresholdTriggerValue=notificationThresholdTriggerValue, networkInterfaceUp=networkInterfaceUp, shareCIFSWriteIops=shareCIFSWriteIops, haResourcesTable=haResourcesTable, shareNFSReadLatency=shareNFSReadLatency, replicationResumed=replicationResumed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareQuotaLow=shareQuotaLow, nfsTotalWriteIops=nfsTotalWriteIops, poolTotalSaving=poolTotalSaving, haResourceEntry=haResourceEntry, poolName=poolName, nicTable=nicTable, upgradeDownloadStarted=upgradeDownloadStarted, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolTotalReadIops=poolTotalReadIops, projectPoolName=projectPoolName, diskAvgReadLatency=diskAvgReadLatency, diskSizeHigh=diskSizeHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, targetGroupDeleteCompleted=targetGroupDeleteCompleted, haControllerA_Name=haControllerA_Name, tdpsUpgradeFailed=tdpsUpgradeFailed, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcInitiators=fcInitiators, diskIndex=diskIndex, controllerUp=controllerUp, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, lunWriteLatency=lunWriteLatency, upgradeCompleted=upgradeCompleted, lunDataSizeHigh=lunDataSizeHigh, diskIOCount=diskIOCount, poolImported=poolImported, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolState=poolState, iscsiInitiatorIndex=iscsiInitiatorIndex, fcInitiatorGroup=fcInitiatorGroup, iscsiTargetError=iscsiTargetError, nfsTotalWriteMbps=nfsTotalWriteMbps, projectDataSizeHigh=projectDataSizeHigh, fcInitiatorEntry=fcInitiatorEntry, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, nfsTotalReadMbps=nfsTotalReadMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectQuotaFinished=projectQuotaFinished, fcTargetGroup=fcTargetGroup, iscsiProperties=iscsiProperties, fcAvgReadLatency=fcAvgReadLatency, shareDataSizeHigh=shareDataSizeHigh, notificationSeverity=notificationSeverity, diskEntry=diskEntry, replicationStarted=replicationStarted, fcTargetEntry=fcTargetEntry, tdpsUpgradeTimeout=tdpsUpgradeTimeout, projectSnapshotSizeLow=projectSnapshotSizeLow, notificationObjects=notificationObjects, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolDataSizeHigh=poolDataSizeHigh, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunReservedSizeLow=lunReservedSizeLow, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, snapshotRollbackFailed=snapshotRollbackFailed, lunFreeSizeHigh=lunFreeSizeHigh, shareNFSEnabled=shareNFSEnabled, shareDataSizeLow=shareDataSizeLow, lunTargetGroup=lunTargetGroup, poolDataReadMbps=poolDataReadMbps, shareTable=shareTable, haResourceStatus=haResourceStatus, lunReadLatency=lunReadLatency, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, diskCount=diskCount, projectQuotaSizeHigh=projectQuotaSizeHigh, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, notifications=notifications, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiTargetAuth=iscsiTargetAuth, properties=properties, snmpServiceStarted=snmpServiceStarted, networkInterfaceDown=networkInterfaceDown, diskState=diskState, replicationFailed=replicationFailed, fcTargetsTable=fcTargetsTable, poolUpgraded=poolUpgraded, shareMountPoint=shareMountPoint, diskType=diskType, currentObjectGroup=currentObjectGroup, smisServiceStopFailed=smisServiceStopFailed, cpuTotalUsage=cpuTotalUsage, notificationComponentName=notificationComponentName, fcInitiatorsTable=fcInitiatorsTable, nicIndex=nicIndex, tegileConformance=tegileConformance, fcTargetReadLatency=fcTargetReadLatency, projectShareCount=projectShareCount, poolHealth=poolHealth, lunReadIops=lunReadIops, shareCIFSReadMbps=shareCIFSReadMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskTotalWriteMbps=diskTotalWriteMbps, networkIpmpGroupUp=networkIpmpGroupUp, lunDedupEnabled=lunDedupEnabled, networkTotalReceiveMbps=networkTotalReceiveMbps, targetGroupMemberAdded=targetGroupMemberAdded, diskGoneOffline=diskGoneOffline, shareName=shareName, smisServiceStopped=smisServiceStopped, iscsiTargetReadMbps=iscsiTargetReadMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, projectTotalSaving=projectTotalSaving)
