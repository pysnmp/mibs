...
ModuleIdentity, Integer32, iso, Bits, enterprises, Unsigned32, MibIdentifier, TimeTicks, Counter64, Counter32, IpAddress, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "iso", "Bits", "enterprises", "Unsigned32", "MibIdentifier", "TimeTicks", "Counter64", "Counter32", "IpAddress", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("TEGILE-MIB", projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, nicEntry=nicEntry, projectDeleted=projectDeleted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiWriteIops=iscsiWriteIops, shareQuotaHigh=shareQuotaHigh, diskSizeLow=diskSizeLow, fcTotalReadIops=fcTotalReadIops, upgradeStarted=upgradeStarted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, shareCompressedRatio=shareCompressedRatio, iscsiTargetReadLatency=iscsiTargetReadLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, projectCompressionEnabled=projectCompressionEnabled, cifsTotalWriteIops=cifsTotalWriteIops, pools=pools, lunFreeSizeHigh=lunFreeSizeHigh, replicationResumed=replicationResumed, haControllerA_Name=haControllerA_Name, poolCreated=poolCreated, snmpServiceStopFailed=snmpServiceStopFailed, poolReadCacheWriteIops=poolReadCacheWriteIops, shareNFSWriteLatency=shareNFSWriteLatency, fcTotalWriteMbps=fcTotalWriteMbps, fcTargetsTable=fcTargetsTable, cpuInterrupts=cpuInterrupts, poolDeleted=poolDeleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectSnapshotSizeHigh=projectSnapshotSizeHigh, nicIndex=nicIndex, fcAvgReadLatency=fcAvgReadLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiTargetEntry=iscsiTargetEntry, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolTotalWriteIops=poolTotalWriteIops, poolReadCacheReadIops=poolReadCacheReadIops, iscsiTargetWriteIops=iscsiTargetWriteIops, tegileArray=tegileArray, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolFreeSizeHigh=poolFreeSizeHigh, nicReceiveMbps=nicReceiveMbps, fcInitiatorEntry=fcInitiatorEntry, shareDeleted=shareDeleted, lunReadIops=lunReadIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcInitiatorGroup=fcInitiatorGroup, iscsiImproperTargetGroup=iscsiImproperTargetGroup, spareDiskReplaced=spareDiskReplaced, projectPoolName=projectPoolName, poolMetaWriteIops=poolMetaWriteIops, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolUsedSizeLow=poolUsedSizeLow, poolProjects=poolProjects, lunInitiatorGroup=lunInitiatorGroup, projectCreatedSuccessfully=projectCreatedSuccessfully, ipmiThreshold=ipmiThreshold, nfsTotalWriteMbps=nfsTotalWriteMbps, poolMetaWriteLatency=poolMetaWriteLatency, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolDataReadLatency=poolDataReadLatency, poolName=poolName, lunSnapshotSizeHigh=lunSnapshotSizeHigh, diskError=diskError, nicTransmitMbps=nicTransmitMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, testNotification=testNotification, targetGroupMemberRemoved=targetGroupMemberRemoved, notificationTime=notificationTime, smisServiceStopped=smisServiceStopped, network=network, shareCIFSWriteIops=shareCIFSWriteIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, projectTable=projectTable, iscsiTotalReadIops=iscsiTotalReadIops, replicationComplete=replicationComplete, deleteFolderCompleted=deleteFolderCompleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolDeletionFailed=poolDeletionFailed, poolTable=poolTable, poolAvgReadLatency=poolAvgReadLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, poolImported=poolImported, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolIndex=poolIndex, diskDataWriteIops=diskDataWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, replicationPaused=replicationPaused, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcInitiatorsTable=fcInitiatorsTable, shareReservedSizeHigh=shareReservedSizeHigh, shareSnapshotSizeLow=shareSnapshotSizeLow, ipmiMemory=ipmiMemory, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, iscsiTargets=iscsiTargets, projectIndex=projectIndex, replicationStarted=replicationStarted, fcTargetIndex=fcTargetIndex, poolExported=poolExported, fcInitiatorIndex=fcInitiatorIndex, diskAvgWriteLatency=diskAvgWriteLatency, haControllerB_Uptime=haControllerB_Uptime, shareCIFSEnabled=shareCIFSEnabled, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolTotalReadIops=poolTotalReadIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, lunTable=lunTable, shareNFSReadLatency=shareNFSReadLatency, shareEntry=shareEntry, networkIpmpGroupUp=networkIpmpGroupUp, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, volumeDeleteCompleted=volumeDeleteCompleted, iscsiInitiators=iscsiInitiators, poolTotalWriteMbps=poolTotalWriteMbps, controllerHardwareModel=controllerHardwareModel, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, shareCIFSReadMbps=shareCIFSReadMbps, haControllerB_IPAddr=haControllerB_IPAddr, networkIpmpGroupDown=networkIpmpGroupDown, lunFreeSizeLow=lunFreeSizeLow, currentObjectGroup=currentObjectGroup, poolState=poolState, notificationDescription=notificationDescription, projectShares=projectShares, poolDataReadMbps=poolDataReadMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, notifications=notifications, poolDataWriteMbps=poolDataWriteMbps, replicationAborted=replicationAborted, memoryFailure=memoryFailure, fcTargetEntry=fcTargetEntry, iscsiTargetError=iscsiTargetError, haResourcesTable=haResourcesTable, poolTotalSaving=poolTotalSaving, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectSnapshotSizeLow=projectSnapshotSizeLow, lunPoolName=lunPoolName, vmwareNFSDatastores=vmwareNFSDatastores, ntpServerTimeDrift=ntpServerTimeDrift, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, cacheTotalReadMbps=cacheTotalReadMbps, sharePoolName=sharePoolName, projectLUNs=projectLUNs, shareSnapshotSizeHigh=shareSnapshotSizeHigh, lunWriteLatency=lunWriteLatency, cacheRAMReads=cacheRAMReads, iscsiTotalReadMbps=iscsiTotalReadMbps, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareQuotaLow=shareQuotaLow, nfsAvgWriteLatency=nfsAvgWriteLatency, projectDeletionFailed=projectDeletionFailed, volumeCreatedSuccessfully=volumeCreatedSuccessfully, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, alertsCleanupCompleted=alertsCleanupCompleted, poolDegraded=poolDegraded, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunReadLatency=lunReadLatency, ipmiPowerSupply=ipmiPowerSupply, nfsTotalReadMbps=nfsTotalReadMbps, shareDedupEnabled=shareDedupEnabled, iscsiTargetReadMbps=iscsiTargetReadMbps, notificationProps=notificationProps, diskGoneOffline=diskGoneOffline, poolDataWriteIops=poolDataWriteIops, notificationSensorSuspect=notificationSensorSuspect, iscsiInitiatorChapUser=iscsiInitiatorChapUser, fcTargets=fcTargets, shareMountPoint=shareMountPoint, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, diskRandomIOCount=diskRandomIOCount, maintenanceModeEnabled=maintenanceModeEnabled, shareCompressionEnabled=shareCompressionEnabled, lunSizeLow=lunSizeLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, haResourceGroup=haResourceGroup, netbiosSocketFailure=netbiosSocketFailure, fcPortOffline=fcPortOffline, upgradeTimeout=upgradeTimeout, unknownSensorEvent=unknownSensorEvent, poolDataSizeLow=poolDataSizeLow, tegileArray_notifications=tegileArray_notifications, sensorFailureEvent=sensorFailureEvent, iscsiTargetReadIops=iscsiTargetReadIops, projectFreeSizeHigh=projectFreeSizeHigh, poolSizeHigh=poolSizeHigh, projectQuotaSizeLow=projectQuotaSizeLow, diskTable=diskTable, notificationEventCode=notificationEventCode, tegileConformance=tegileConformance, haResources=haResources, tdpsUpgradeFailed=tdpsUpgradeFailed, tegileCompliances=tegileCompliances, cifsAvgWriteLatency=cifsAvgWriteLatency, tegile=tegile, fcTargetReadLatency=fcTargetReadLatency, fcPortOnline=fcPortOnline, poolOwnerController=poolOwnerController, lunEntry=lunEntry, diskDataReadIops=diskDataReadIops, lunWriteMbps=lunWriteMbps, lunDataSizeLow=lunDataSizeLow, shareDataSizeLow=shareDataSizeLow, volumeQuotaFinished=volumeQuotaFinished, shareCIFSWriteLatency=shareCIFSWriteLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareCreatedSuccessfully=shareCreatedSuccessfully, projectFreeSizeLow=projectFreeSizeLow, shareNFSWriteMbps=shareNFSWriteMbps, lunDataSizeHigh=lunDataSizeHigh, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, fcInitiatorName=fcInitiatorName, upgradeFailed=upgradeFailed, snmpServiceStarted=snmpServiceStarted, notificationTargetEntityName=notificationTargetEntityName, ipmiFan=ipmiFan, replicationTargetDeleted=replicationTargetDeleted, cacheTotalWriteIops=cacheTotalWriteIops, poolMetaWriteMbps=poolMetaWriteMbps, notificationSensorNumber=notificationSensorNumber, iscsiInitiatorEntry=iscsiInitiatorEntry, diskSlowIo=diskSlowIo, fcTargetWriteLatency=fcTargetWriteLatency, poolMetaReadIops=poolMetaReadIops, fcAvgWriteLatency=fcAvgWriteLatency, fcTargetName=fcTargetName, upgradeDownloadStarted=upgradeDownloadStarted, ipmiVoltage=ipmiVoltage, snapshotCloningFailed=snapshotCloningFailed, snmpServiceStartFailed=snmpServiceStartFailed, globalStatistics=globalStatistics, fcTargetGroup=fcTargetGroup, poolDataSizeHigh=poolDataSizeHigh, upgradeCompleted=upgradeCompleted, lunReservedSizeHigh=lunReservedSizeHigh, snapshotCreationFailed=snapshotCreationFailed, nfsTotalReadIops=nfsTotalReadIops, lunIndex=lunIndex, shareName=shareName, cifsTotalReadIops=cifsTotalReadIops, notificationReadingUnit=notificationReadingUnit, poolDataWriteLatency=poolDataWriteLatency, diskAvgReadLatency=diskAvgReadLatency, lunProtocol=lunProtocol, poolFreeSizeLow=poolFreeSizeLow, nicMTU=nicMTU, smisServiceStopFailed=smisServiceStopFailed, iscsiAvgReadLatency=iscsiAvgReadLatency, nvdimmFailInitializationError=nvdimmFailInitializationError)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetsTable=iscsiTargetsTable, networkInterfaceUp=networkInterfaceUp, upgradeDownloadCompleted=upgradeDownloadCompleted, diskChassisIdx=diskChassisIdx, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolCount=poolCount, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, diskIndex=diskIndex, projectTotalSaving=projectTotalSaving, shareReservedSizeLow=shareReservedSizeLow, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, haResourceIndex=haResourceIndex, projectName=projectName, shareCIFSReadLatency=shareCIFSReadLatency, aclMigrationCompleted=aclMigrationCompleted, notificationSensorAction=notificationSensorAction, poolTotalReadMbps=poolTotalReadMbps, projectShareCount=projectShareCount, replicationSourceRegistered=replicationSourceRegistered, currentNotificationGroup=currentNotificationGroup, networkInterfaceDown=networkInterfaceDown, cifsTotalReadMbps=cifsTotalReadMbps, projectEntry=projectEntry, diskDataWriteMbps=diskDataWriteMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, upgradeDownloadFailed=upgradeDownloadFailed, nicName=nicName, lunProjectName=lunProjectName, haResourceDescription=haResourceDescription, cacheTotalReadIops=cacheTotalReadIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, nicState=nicState, poolReadCacheReadMbps=poolReadCacheReadMbps, disks=disks, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, maintenanceModeDisabled=maintenanceModeDisabled, replicationAbandoned=replicationAbandoned, tegileGroups=tegileGroups, nfsTotalWriteIops=nfsTotalWriteIops, userLoginFailed=userLoginFailed, ipmiTemperature=ipmiTemperature, lunReadMbps=lunReadMbps, haResourceActiveNode=haResourceActiveNode, haResourceEntry=haResourceEntry, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, lunCompressedRatio=lunCompressedRatio, diskState=diskState, deleteFolderFailed=deleteFolderFailed, lunName=lunName, cifsTotalWriteMbps=cifsTotalWriteMbps, targetGroupMemberAdded=targetGroupMemberAdded, poolUsedSizeHigh=poolUsedSizeHigh, fcInitiators=fcInitiators, shareCIFSReadIops=shareCIFSReadIops, shareNFSReadIops=shareNFSReadIops, poolUpgraded=poolUpgraded, haControllerB_Name=haControllerB_Name, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, haResourceName=haResourceName, fcTargetReadIops=fcTargetReadIops, smbSocketFailure=smbSocketFailure, diskType=diskType, smisServiceStarted=smisServiceStarted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, ipmiCurrent=ipmiCurrent, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, lunSnapshotSizeLow=lunSnapshotSizeLow, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, ipmiOther=ipmiOther, lunWriteIops=lunWriteIops, nicTable=nicTable, shareDataSizeHigh=shareDataSizeHigh, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, iscsiInitiatorName=iscsiInitiatorName, shareTable=shareTable, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiInitiatorsTable=iscsiInitiatorsTable, lunTargetGroup=lunTargetGroup, smisServiceStartFailed=smisServiceStartFailed, projectLunCount=projectLunCount, diskIOCount=diskIOCount, networkTotalTransmitMbps=networkTotalTransmitMbps, cpuSystemCalls=cpuSystemCalls, networkTotalReceiveMbps=networkTotalReceiveMbps, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, lunGUID=lunGUID, fcTotalWriteIops=fcTotalWriteIops, notificationObjects=notificationObjects, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcTotalReadMbps=fcTotalReadMbps, cacheSSDReads=cacheSSDReads, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, aclMigrationStarted=aclMigrationStarted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, snapshotRollbackCompleted=snapshotRollbackCompleted, projectDataSizeHigh=projectDataSizeHigh, controllerTimeDrift=controllerTimeDrift, basicCompliance=basicCompliance, PYSNMP_MODULE_ID=tegile, replicationFailed=replicationFailed, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiTargetGroup=iscsiTargetGroup, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, controllerUp=controllerUp, sanProperties=sanProperties, iscsiProperties=iscsiProperties, poolQuotaFinished=poolQuotaFinished, poolMetaReadLatency=poolMetaReadLatency, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolSizeLow=poolSizeLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diagnosticDataUploaded=diagnosticDataUploaded, poolReadCacheReadLatency=poolReadCacheReadLatency, adServerTimeDrift=adServerTimeDrift, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, lunCompressionEnabled=lunCompressionEnabled, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diskAlias=diskAlias, notificationSeverity=notificationSeverity, haResourceStatus=haResourceStatus, snapshotDeleteFailed=snapshotDeleteFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, volumeModifyCompleted=volumeModifyCompleted, projectDataSizeLow=projectDataSizeLow, webdocsUpgradeFailed=webdocsUpgradeFailed, fcTargetModifyCompleted=fcTargetModifyCompleted, fcTargetWriteMbps=fcTargetWriteMbps, projectQuotaFinished=projectQuotaFinished, shareNFSReadMbps=shareNFSReadMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareNFSEnabled=shareNFSEnabled, poolExpanded=poolExpanded, nicGroup=nicGroup, lunSizeHigh=lunSizeHigh, diskSizeHigh=diskSizeHigh, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, nvdimmFailDeviceError=nvdimmFailDeviceError, shareNFSWriteIops=shareNFSWriteIops, poolAvgWriteLatency=poolAvgWriteLatency, iscsiTargetWriteLatency=iscsiTargetWriteLatency, volumeDeleteFailed=volumeDeleteFailed, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, diskCount=diskCount, nfsAvgReadLatency=nfsAvgReadLatency, shareQuotaFinished=shareQuotaFinished, shareCIFSWriteMbps=shareCIFSWriteMbps, diskTotalWriteIops=diskTotalWriteIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiTargetAlias=iscsiTargetAlias, diskEntry=diskEntry, poolHealth=poolHealth, diskDataReadMbps=diskDataReadMbps, diskTotalReadIops=diskTotalReadIops, projectModified=projectModified, snmpServiceStopped=snmpServiceStopped, cifsAvgReadLatency=cifsAvgReadLatency, fcTargetStatus=fcTargetStatus, targetGroupCreateCompleted=targetGroupCreateCompleted, diskTotalWriteMbps=diskTotalWriteMbps, haControllerA_Uptime=haControllerA_Uptime, diskIsOnline=diskIsOnline, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolDataReadIops=poolDataReadIops, poolEntry=poolEntry, shareProjectName=shareProjectName, shareDeletionFailed=shareDeletionFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, snapshotCloneCompleted=snapshotCloneCompleted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, diskPoolName=diskPoolName, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolMetaReadMbps=poolMetaReadMbps, iscsiTargetIndex=iscsiTargetIndex, diskTotalReadMbps=diskTotalReadMbps, snapshotRollbackFailed=snapshotRollbackFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, lunReservedSizeLow=lunReservedSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, haControllerA_IPAddr=haControllerA_IPAddr, snmpAgentVersion=snmpAgentVersion, properties=properties, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, cpuTotalUsage=cpuTotalUsage, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiTargetAuth=iscsiTargetAuth, diskSequentialIOCount=diskSequentialIOCount, fcTargetWriteIops=fcTargetWriteIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunBlockSize=lunBlockSize, poolProjectCount=poolProjectCount, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiTargetName=iscsiTargetName, controllerDown=controllerDown, fcTargetReadMbps=fcTargetReadMbps, projectDedupEnabled=projectDedupEnabled, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, lunDedupEnabled=lunDedupEnabled, shareIndex=shareIndex, fcProperties=fcProperties, notificationComponentName=notificationComponentName, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, nvdimmFailSoftError=nvdimmFailSoftError)
