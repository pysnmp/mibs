...
# Produced by pysmi-1.1.8 at Fri Jan  7 15:39:46 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, ObjectIdentity, Bits, Integer32, MibIdentifier, Counter64, Counter32, TimeTicks, Unsigned32, IpAddress, Gauge32, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "ObjectIdentity", "Bits", "Integer32", "MibIdentifier", "Counter64", "Counter32", "TimeTicks", "Unsigned32", "IpAddress", "Gauge32", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", cpuTotalUsage=cpuTotalUsage, volumeDeleteFailed=volumeDeleteFailed, controllerUp=controllerUp, poolSizeLow=poolSizeLow, lunWriteLatency=lunWriteLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, controllerTimeDrift=controllerTimeDrift, nicState=nicState, targetGroupDeleteCompleted=targetGroupDeleteCompleted, currentObjectGroup=currentObjectGroup, replicationAborted=replicationAborted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, snapshotRollbackFailed=snapshotRollbackFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolReadCacheReadIops=poolReadCacheReadIops, diskDataWriteIops=diskDataWriteIops, shareCIFSWriteIops=shareCIFSWriteIops, fcTargetModifyCompleted=fcTargetModifyCompleted, targetGroupMemberRemoved=targetGroupMemberRemoved, haControllerA_IPAddr=haControllerA_IPAddr, netbiosSocketFailure=netbiosSocketFailure, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargetWriteLatency=fcTargetWriteLatency, notifications=notifications, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolUsedSizeHigh=poolUsedSizeHigh, iscsiTotalReadIops=iscsiTotalReadIops, ipmiVoltage=ipmiVoltage, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectTotalSaving=projectTotalSaving, deleteFolderCompleted=deleteFolderCompleted, poolQuotaFinished=poolQuotaFinished, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskEntry=diskEntry, alertsCleanupCompleted=alertsCleanupCompleted, replicationAbandoned=replicationAbandoned, fcPortOnline=fcPortOnline, ipmiTemperature=ipmiTemperature, haControllerA_Name=haControllerA_Name, notificationSensorAction=notificationSensorAction, shareName=shareName, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, nvdimmFailInitializationError=nvdimmFailInitializationError, poolTotalSaving=poolTotalSaving, shareCIFSReadMbps=shareCIFSReadMbps, shareCompressionEnabled=shareCompressionEnabled, snapshotDeleteFailed=snapshotDeleteFailed, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunCompressionEnabled=lunCompressionEnabled, snmpAgentVersion=snmpAgentVersion, shareNFSReadMbps=shareNFSReadMbps, tegileConformance=tegileConformance, projectQuotaFinished=projectQuotaFinished, iscsiAvgReadLatency=iscsiAvgReadLatency, diskAvgWriteLatency=diskAvgWriteLatency, projectDataSizeLow=projectDataSizeLow, upgradeStarted=upgradeStarted, ipmiPowerSupply=ipmiPowerSupply, snapshotCloningFailed=snapshotCloningFailed, fcProperties=fcProperties, maintenanceModeEnabled=maintenanceModeEnabled, shareProjectName=shareProjectName, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolTable=poolTable, poolFreeSizeLow=poolFreeSizeLow, snmpServiceStopFailed=snmpServiceStopFailed, nicReceiveMbps=nicReceiveMbps, projectFreeSizeLow=projectFreeSizeLow, projectDeletionFailed=projectDeletionFailed, ntpServerTimeDrift=ntpServerTimeDrift, projectShareCount=projectShareCount, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareEntry=shareEntry, userLoginFailed=userLoginFailed, projectName=projectName, shareQuotaLow=shareQuotaLow, shareDataSizeLow=shareDataSizeLow, maintenanceModeDisabled=maintenanceModeDisabled, snapshotCreationFailed=snapshotCreationFailed, networkInterfaceDown=networkInterfaceDown, disks=disks, iscsiTargetWriteLatency=iscsiTargetWriteLatency, spareDiskReplaced=spareDiskReplaced, cifsAvgWriteLatency=cifsAvgWriteLatency, cacheTotalWriteIops=cacheTotalWriteIops, shareCIFSEnabled=shareCIFSEnabled, poolWriteCacheWriteIops=poolWriteCacheWriteIops, upgradeDownloadCompleted=upgradeDownloadCompleted, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, shareDeleted=shareDeleted, currentNotificationGroup=currentNotificationGroup, poolDeletionFailed=poolDeletionFailed, poolAvgWriteLatency=poolAvgWriteLatency, tdpsUpgradeTimeout=tdpsUpgradeTimeout, notificationSensorSuspect=notificationSensorSuspect, notificationComponentName=notificationComponentName, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, haResourceEntry=haResourceEntry, aclMigrationCompleted=aclMigrationCompleted, nfsTotalWriteIops=nfsTotalWriteIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, tegileGroups=tegileGroups, cacheSSDReads=cacheSSDReads, poolReadCacheReadMbps=poolReadCacheReadMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolExpanded=poolExpanded, fcInitiatorGroup=fcInitiatorGroup, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareCompressedRatio=shareCompressedRatio, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, snmpServiceStartFailed=snmpServiceStartFailed, haResourceActiveNode=haResourceActiveNode, shareReservedSizeHigh=shareReservedSizeHigh, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, cifsTotalReadIops=cifsTotalReadIops, notificationReadingTriggerValue=notificationReadingTriggerValue, adServerTimeDrift=adServerTimeDrift, diskChassisIdx=diskChassisIdx, projectShares=projectShares, iscsiInitiatorGroup=iscsiInitiatorGroup, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiTargetsTable=iscsiTargetsTable, projectSnapshotSizeHigh=projectSnapshotSizeHigh, notificationSeverity=notificationSeverity, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiTargetWriteMbps=iscsiTargetWriteMbps, lunFreeSizeHigh=lunFreeSizeHigh, diskDataReadIops=diskDataReadIops, tegileArray=tegileArray, iscsiTargetError=iscsiTargetError, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectFreeSizeHigh=projectFreeSizeHigh, fcInitiatorIndex=fcInitiatorIndex, poolCount=poolCount, shareDataSizeHigh=shareDataSizeHigh, poolMetaWriteIops=poolMetaWriteIops, deleteFolderFailed=deleteFolderFailed, diskAlias=diskAlias, snmpServiceStopped=snmpServiceStopped, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, cifsAvgReadLatency=cifsAvgReadLatency, lunTable=lunTable, replicationTargetDeleted=replicationTargetDeleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, globalStatistics=globalStatistics, networkInterfaceUp=networkInterfaceUp, projectSnapshotSizeLow=projectSnapshotSizeLow, shareQuotaFinished=shareQuotaFinished, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, diskDataReadMbps=diskDataReadMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcTargetsTable=fcTargetsTable, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectIndex=projectIndex, shareMountPoint=shareMountPoint, nfsTotalReadMbps=nfsTotalReadMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, smbSocketFailure=smbSocketFailure, poolMetaReadLatency=poolMetaReadLatency, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolDataReadIops=poolDataReadIops, iscsiTargetAlias=iscsiTargetAlias, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolFreeSizeHigh=poolFreeSizeHigh, shareCIFSWriteMbps=shareCIFSWriteMbps, nicEntry=nicEntry, tegileCompliances=tegileCompliances, lunProjectName=lunProjectName, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diskTotalWriteIops=diskTotalWriteIops, poolDataSizeLow=poolDataSizeLow, notificationObjects=notificationObjects, cacheTotalReadMbps=cacheTotalReadMbps, fcTargetName=fcTargetName, iscsiTargetReadMbps=iscsiTargetReadMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, upgradeFailed=upgradeFailed, projectEntry=projectEntry, shareNFSReadIops=shareNFSReadIops, shareExceedThresholdWarning=shareExceedThresholdWarning, snapshotRollbackCompleted=snapshotRollbackCompleted, projectCompressionEnabled=projectCompressionEnabled, poolIndex=poolIndex, cifsTotalWriteIops=cifsTotalWriteIops, diskTotalWriteMbps=diskTotalWriteMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, nfsAvgReadLatency=nfsAvgReadLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, volumeModifyCompleted=volumeModifyCompleted, diskSequentialIOCount=diskSequentialIOCount, lunDataSizeLow=lunDataSizeLow, fcTargetWriteIops=fcTargetWriteIops, nvdimmFailSoftError=nvdimmFailSoftError, fcInitiatorsTable=fcInitiatorsTable, haControllerB_IPAddr=haControllerB_IPAddr, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareNFSWriteMbps=shareNFSWriteMbps, iscsiTargetEntry=iscsiTargetEntry, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, cacheTotalReadIops=cacheTotalReadIops, projectDedupEnabled=projectDedupEnabled, notificationTime=notificationTime, cacheRAMReads=cacheRAMReads, nicName=nicName, diskError=diskError, fcTargetStatus=fcTargetStatus, haResourceIndex=haResourceIndex, targetGroupCreateCompleted=targetGroupCreateCompleted, poolUsedSizeLow=poolUsedSizeLow, smisServiceStartFailed=smisServiceStartFailed, haResourceGroup=haResourceGroup, smisServiceStopped=smisServiceStopped, iscsiInitiatorsTable=iscsiInitiatorsTable, projectModified=projectModified, volumeQuotaFinished=volumeQuotaFinished, poolTotalReadMbps=poolTotalReadMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolOwnerController=poolOwnerController, lunDataSizeHigh=lunDataSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareDeletionFailed=shareDeletionFailed, poolDataWriteIops=poolDataWriteIops, poolDataWriteLatency=poolDataWriteLatency, diskRandomIOCount=diskRandomIOCount, haResourceStatus=haResourceStatus, shareNFSReadLatency=shareNFSReadLatency, lunProtocol=lunProtocol, haResourcesTable=haResourcesTable, diskSlowIo=diskSlowIo, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareTable=shareTable, poolAvgReadLatency=poolAvgReadLatency, PYSNMP_MODULE_ID=tegile, diskTable=diskTable, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, nicTransmitMbps=nicTransmitMbps, networkIpmpGroupUp=networkIpmpGroupUp, upgradeDownloadFailed=upgradeDownloadFailed, ipmiThreshold=ipmiThreshold, cpuInterrupts=cpuInterrupts, shareNFSWriteIops=shareNFSWriteIops, poolEntry=poolEntry, lunGUID=lunGUID)
mibBuilder.exportSymbols("TEGILE-MIB", poolMetaReadMbps=poolMetaReadMbps, iscsiInitiatorName=iscsiInitiatorName, shareCIFSReadLatency=shareCIFSReadLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, testNotification=testNotification, pools=pools, fcAvgReadLatency=fcAvgReadLatency, smisServiceStopFailed=smisServiceStopFailed, nicMTU=nicMTU, diskTotalReadIops=diskTotalReadIops, notificationEventCode=notificationEventCode, upgradeDownloadStarted=upgradeDownloadStarted, iscsiTargetReadIops=iscsiTargetReadIops, tegile=tegile, lunSizeLow=lunSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunBlockSize=lunBlockSize, fcTotalReadMbps=fcTotalReadMbps, nicIndex=nicIndex, fcTargetGroup=fcTargetGroup, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskState=diskState, diskAvgReadLatency=diskAvgReadLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiTargetGroup=iscsiTargetGroup, poolName=poolName, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcPortOffline=fcPortOffline, poolState=poolState, lunFreeSizeLow=lunFreeSizeLow, poolMetaWriteMbps=poolMetaWriteMbps, ipmiFan=ipmiFan, tegileArray_notifications=tegileArray_notifications, poolReadCacheWriteIops=poolReadCacheWriteIops, projectTable=projectTable, poolImported=poolImported, diskIsOnline=diskIsOnline, projectDataSizeHigh=projectDataSizeHigh, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiTargets=iscsiTargets, poolTotalReadIops=poolTotalReadIops, snmpServiceStarted=snmpServiceStarted, poolProjectCount=poolProjectCount, poolDataReadLatency=poolDataReadLatency, shareIndex=shareIndex, replicationStarted=replicationStarted, memoryFailure=memoryFailure, shareQuotaHigh=shareQuotaHigh, notificationReadingUnit=notificationReadingUnit, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, upgradeCompleted=upgradeCompleted, basicCompliance=basicCompliance, lunPoolName=lunPoolName, fcInitiatorEntry=fcInitiatorEntry, poolReadCacheReadLatency=poolReadCacheReadLatency, poolTotalWriteIops=poolTotalWriteIops, iscsiProperties=iscsiProperties, shareNFSEnabled=shareNFSEnabled, poolUpgraded=poolUpgraded, iscsiTargetAuth=iscsiTargetAuth, replicationPaused=replicationPaused, fcTotalReadIops=fcTotalReadIops, notificationDescription=notificationDescription, cpuSystemCalls=cpuSystemCalls, replicationSourceRegistered=replicationSourceRegistered, cifsTotalWriteMbps=cifsTotalWriteMbps, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, aclMigrationStarted=aclMigrationStarted, lunInitiatorGroup=lunInitiatorGroup, networkTotalReceiveMbps=networkTotalReceiveMbps, diskType=diskType, fcTargetReadLatency=fcTargetReadLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, lunIndex=lunIndex, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcTargetIndex=fcTargetIndex, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunReadIops=lunReadIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, poolTotalWriteMbps=poolTotalWriteMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, controllerDown=controllerDown, sanProperties=sanProperties, lunReadLatency=lunReadLatency, diskGoneOffline=diskGoneOffline, iscsiWriteIops=iscsiWriteIops, lunEntry=lunEntry, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolDataWriteMbps=poolDataWriteMbps, diskSizeHigh=diskSizeHigh, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, nicTable=nicTable, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, shareReservedSizeLow=shareReservedSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolMetaReadIops=poolMetaReadIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, haResourceDescription=haResourceDescription, diskTotalReadMbps=diskTotalReadMbps, lunReservedSizeLow=lunReservedSizeLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, notificationProps=notificationProps, iscsiInitiators=iscsiInitiators, targetGroupMemberAdded=targetGroupMemberAdded, snapshotCloneCompleted=snapshotCloneCompleted, poolHealth=poolHealth, shareDedupEnabled=shareDedupEnabled, iscsiTargetName=iscsiTargetName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcAvgWriteLatency=fcAvgWriteLatency, replicationResumed=replicationResumed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, fcInitiatorName=fcInitiatorName, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, replicationComplete=replicationComplete, upgradeTimeout=upgradeTimeout, poolDeleted=poolDeleted, unknownSensorEvent=unknownSensorEvent, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, nicGroup=nicGroup, diskDataWriteMbps=diskDataWriteMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolExported=poolExported, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, cacheTotalWriteMbps=cacheTotalWriteMbps, smisServiceStarted=smisServiceStarted, poolProjects=poolProjects, shareCIFSReadIops=shareCIFSReadIops, diskIndex=diskIndex, haResourceName=haResourceName, notificationTargetEntityName=notificationTargetEntityName, iscsiTargetWriteIops=iscsiTargetWriteIops, controllerHardwareModel=controllerHardwareModel, cifsTotalReadMbps=cifsTotalReadMbps, projectQuotaSizeLow=projectQuotaSizeLow, projectDeleted=projectDeleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, networkIpmpGroupDown=networkIpmpGroupDown, projectLunCount=projectLunCount, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, nfsAvgWriteLatency=nfsAvgWriteLatency, lunDedupEnabled=lunDedupEnabled, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolDataSizeHigh=poolDataSizeHigh, diskIOCount=diskIOCount, fcTargetWriteMbps=fcTargetWriteMbps, network=network, projectLUNs=projectLUNs, lunReservedSizeHigh=lunReservedSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, ipmiCurrent=ipmiCurrent, lunTargetGroup=lunTargetGroup, lunSizeHigh=lunSizeHigh, diskCount=diskCount, poolSizeHigh=poolSizeHigh, ipmiMemory=ipmiMemory, sharePoolName=sharePoolName, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTotalReadMbps=iscsiTotalReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, tdpsUpgradeFailed=tdpsUpgradeFailed, nfsTotalReadIops=nfsTotalReadIops, diagnosticDataUploaded=diagnosticDataUploaded, diskPoolName=diskPoolName, lunWriteIops=lunWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, vmwareNFSDatastores=vmwareNFSDatastores, intelliFlashSoftwareUp=intelliFlashSoftwareUp, volumeCreatedSuccessfully=volumeCreatedSuccessfully, fcTargets=fcTargets, haResources=haResources, fcInitiators=fcInitiators, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolCreated=poolCreated, poolDegraded=poolDegraded, haControllerB_Name=haControllerB_Name, projectPoolName=projectPoolName, diskSizeLow=diskSizeLow, fcTotalWriteIops=fcTotalWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, properties=properties, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, sensorFailureEvent=sensorFailureEvent, fcTargetEntry=fcTargetEntry, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, volumeDeleteCompleted=volumeDeleteCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, poolDataReadMbps=poolDataReadMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, haControllerB_Uptime=haControllerB_Uptime, lunName=lunName, fcTargetReadIops=fcTargetReadIops, replicationFailed=replicationFailed, lunReadMbps=lunReadMbps, notificationSensorNumber=notificationSensorNumber, haControllerA_Uptime=haControllerA_Uptime, lunCompressedRatio=lunCompressedRatio, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunWriteMbps=lunWriteMbps, ipmiOther=ipmiOther, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcTargetReadMbps=fcTargetReadMbps)
