...
Gauge32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, Bits, Counter32, NotificationType, ModuleIdentity, IpAddress, iso, MibIdentifier, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "Bits", "Counter32", "NotificationType", "ModuleIdentity", "IpAddress", "iso", "MibIdentifier", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", notificationSensorSuspect=notificationSensorSuspect, fcTargetWriteMbps=fcTargetWriteMbps, nicIndex=nicIndex, ipmiCurrent=ipmiCurrent, poolMetaReadMbps=poolMetaReadMbps, poolDegraded=poolDegraded, diskPoolName=diskPoolName, fcTotalWriteMbps=fcTotalWriteMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, smisServiceStopFailed=smisServiceStopFailed, iscsiTargetReadMbps=iscsiTargetReadMbps, fcPortOffline=fcPortOffline, ipmiThreshold=ipmiThreshold, fcTargetReadIops=fcTargetReadIops, lunWriteMbps=lunWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, poolReadCacheReadMbps=poolReadCacheReadMbps, diskTotalWriteMbps=diskTotalWriteMbps, projectFreeSizeLow=projectFreeSizeLow, shareIndex=shareIndex, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, tegile=tegile, cpuSystemCalls=cpuSystemCalls, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, shareDeletionFailed=shareDeletionFailed, testNotification=testNotification, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunReadLatency=lunReadLatency, tegileGroups=tegileGroups, projectDataSizeLow=projectDataSizeLow, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, shareSnapshotSizeHigh=shareSnapshotSizeHigh, lunDataSizeLow=lunDataSizeLow, poolMetaReadLatency=poolMetaReadLatency, shareQuotaFinished=shareQuotaFinished, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolAvgReadLatency=poolAvgReadLatency, nicName=nicName, iscsiProperties=iscsiProperties, diagnosticDataUploaded=diagnosticDataUploaded, iscsiTargetError=iscsiTargetError, shareTable=shareTable, iscsiTargets=iscsiTargets, shareDataSizeHigh=shareDataSizeHigh, diskIOCount=diskIOCount, poolAvgWriteLatency=poolAvgWriteLatency, shareReservedSizeHigh=shareReservedSizeHigh, notificationProps=notificationProps, aclMigrationCompleted=aclMigrationCompleted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, haControllerA_Uptime=haControllerA_Uptime, diskTable=diskTable, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiAvgWriteLatency=iscsiAvgWriteLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolExpanded=poolExpanded, diskIndex=diskIndex, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolTotalReadMbps=poolTotalReadMbps, notificationSensorAction=notificationSensorAction, projectPoolName=projectPoolName, lunReadIops=lunReadIops, poolTotalReadIops=poolTotalReadIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, diskSequentialIOCount=diskSequentialIOCount, cifsTotalReadMbps=cifsTotalReadMbps, diskChassisIdx=diskChassisIdx, spareDiskReplaced=spareDiskReplaced, replicationSourceRegistered=replicationSourceRegistered, tegileArray=tegileArray, upgradeDownloadFailed=upgradeDownloadFailed, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, disks=disks, diskIsOnline=diskIsOnline, poolCreated=poolCreated, ntpServerTimeDrift=ntpServerTimeDrift, iscsiAvgReadLatency=iscsiAvgReadLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiTargetWriteIops=iscsiTargetWriteIops, projectDedupEnabled=projectDedupEnabled, nvdimmFailUnknownError=nvdimmFailUnknownError, notificationObjects=notificationObjects, shareCompressionEnabled=shareCompressionEnabled, volumeQuotaFinished=volumeQuotaFinished, poolName=poolName, poolWriteCacheWriteIops=poolWriteCacheWriteIops, lunReservedSizeHigh=lunReservedSizeHigh, networkTotalReceiveMbps=networkTotalReceiveMbps, shareQuotaLow=shareQuotaLow, projectThresholdExceedWarning=projectThresholdExceedWarning, poolDataWriteMbps=poolDataWriteMbps, tegileCompliances=tegileCompliances, shareCIFSReadIops=shareCIFSReadIops, poolExported=poolExported, iscsiInitiators=iscsiInitiators, nicTable=nicTable, iscsiTargetReadLatency=iscsiTargetReadLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, nfsTotalReadIops=nfsTotalReadIops, notificationTime=notificationTime, fcInitiators=fcInitiators, diskDataReadMbps=diskDataReadMbps, poolImported=poolImported, networkInterfaceDown=networkInterfaceDown, alertsCleanupCompleted=alertsCleanupCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, diskAlias=diskAlias, networkIpmpGroupDown=networkIpmpGroupDown, notificationSensorNumber=notificationSensorNumber, lunCompressionEnabled=lunCompressionEnabled, diskState=diskState, properties=properties, targetGroupMemberRemoved=targetGroupMemberRemoved, deleteFolderFailed=deleteFolderFailed, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareMountPoint=shareMountPoint, cifsAvgWriteLatency=cifsAvgWriteLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, projectShares=projectShares, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargetReadIops=iscsiTargetReadIops, fcInitiatorsTable=fcInitiatorsTable, iscsiImproperTargetGroup=iscsiImproperTargetGroup, deleteFolderCompleted=deleteFolderCompleted, projectQuotaSizeLow=projectQuotaSizeLow, projectDeleted=projectDeleted, snapshotDeleteFailed=snapshotDeleteFailed, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, snapshotRollbackCompleted=snapshotRollbackCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiTargetName=iscsiTargetName, projectIndex=projectIndex, lunProtocol=lunProtocol, projectName=projectName, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, networkTotalTransmitMbps=networkTotalTransmitMbps, diskTotalReadMbps=diskTotalReadMbps, lunInitiatorGroup=lunInitiatorGroup, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, snmpServiceStopped=snmpServiceStopped, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcTargetWriteLatency=fcTargetWriteLatency, haResourceEntry=haResourceEntry, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskError=diskError, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, shareCompressedRatio=shareCompressedRatio, haResourceStatus=haResourceStatus, upgradeStarted=upgradeStarted, fcTotalReadMbps=fcTotalReadMbps, iscsiTargetAuth=iscsiTargetAuth, shareNFSWriteMbps=shareNFSWriteMbps, smisServiceStopped=smisServiceStopped, poolSizeLow=poolSizeLow, currentObjectGroup=currentObjectGroup, fcTargetReadLatency=fcTargetReadLatency, lunSizeLow=lunSizeLow, fcPortOnline=fcPortOnline, haControllerB_IPAddr=haControllerB_IPAddr, poolMetaWriteLatency=poolMetaWriteLatency, nfsAvgReadLatency=nfsAvgReadLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, diskAvgWriteLatency=diskAvgWriteLatency, snapshotRollbackFailed=snapshotRollbackFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareDeleted=shareDeleted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiTotalReadMbps=iscsiTotalReadMbps, lunWriteLatency=lunWriteLatency, lunDedupEnabled=lunDedupEnabled, iscsiInitiatorName=iscsiInitiatorName, nfsAvgWriteLatency=nfsAvgWriteLatency, lunWriteIops=lunWriteIops, projectQuotaFinished=projectQuotaFinished, poolTotalWriteIops=poolTotalWriteIops, fcAvgWriteLatency=fcAvgWriteLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, nvdimmFailSoftError=nvdimmFailSoftError, poolDataReadIops=poolDataReadIops, nicReceiveMbps=nicReceiveMbps, iscsiTargetEntry=iscsiTargetEntry, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, ipmiMemory=ipmiMemory, shareSnapshotSizeLow=shareSnapshotSizeLow, haResourceGroup=haResourceGroup, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiTargetIndex=iscsiTargetIndex, iscsiInitiatorIndex=iscsiInitiatorIndex, lunTargetGroup=lunTargetGroup, cacheTotalReadMbps=cacheTotalReadMbps, fcInitiatorGroup=fcInitiatorGroup, poolTotalWriteMbps=poolTotalWriteMbps, unknownSensorEvent=unknownSensorEvent, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcAvgReadLatency=fcAvgReadLatency, nfsTotalReadMbps=nfsTotalReadMbps, ipmiOther=ipmiOther, iscsiTotalWriteMbps=iscsiTotalWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, diskAvgReadLatency=diskAvgReadLatency, controllerHardwareModel=controllerHardwareModel, targetGroupCreateCompleted=targetGroupCreateCompleted, smisServiceStartFailed=smisServiceStartFailed, projectDeletionFailed=projectDeletionFailed, diskDataWriteIops=diskDataWriteIops, diskTotalReadIops=diskTotalReadIops, poolMetaWriteIops=poolMetaWriteIops, poolIndex=poolIndex, shareCIFSEnabled=shareCIFSEnabled, shareCIFSWriteIops=shareCIFSWriteIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectDataSizeHigh=projectDataSizeHigh, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, nicState=nicState, haControllerA_Name=haControllerA_Name, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolDeletionFailed=poolDeletionFailed, iscsiTargetGroup=iscsiTargetGroup, shareDedupEnabled=shareDedupEnabled, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, snmpServiceStartFailed=snmpServiceStartFailed, projectModified=projectModified, poolDataSizeLow=poolDataSizeLow, notificationReadingTriggerValue=notificationReadingTriggerValue, diskType=diskType, iscsiTotalReadIops=iscsiTotalReadIops, poolQuotaFinished=poolQuotaFinished, ipmiFan=ipmiFan, fcTargetModifyCompleted=fcTargetModifyCompleted, diskSizeHigh=diskSizeHigh, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, cacheTotalWriteIops=cacheTotalWriteIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, cpuInterrupts=cpuInterrupts, poolReadCacheReadIops=poolReadCacheReadIops, smisServiceStarted=smisServiceStarted, upgradeDownloadCompleted=upgradeDownloadCompleted, poolOwnerController=poolOwnerController, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectCreatedSuccessfully=projectCreatedSuccessfully, snmpAgentVersion=snmpAgentVersion, fcTargetWriteIops=fcTargetWriteIops, upgradeDownloadStarted=upgradeDownloadStarted, projectSnapshotSizeLow=projectSnapshotSizeLow, ipmiTemperature=ipmiTemperature, lunSnapshotSizeHigh=lunSnapshotSizeHigh, shareNFSWriteLatency=shareNFSWriteLatency, cacheSSDReads=cacheSSDReads, poolUpgraded=poolUpgraded, basicCompliance=basicCompliance)
mibBuilder.exportSymbols("TEGILE-MIB", snapshotCloneCompleted=snapshotCloneCompleted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, replicationComplete=replicationComplete, globalStatistics=globalStatistics, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunGUID=lunGUID, shareExceedThresholdWarning=shareExceedThresholdWarning, nfsTotalWriteIops=nfsTotalWriteIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareNFSReadIops=shareNFSReadIops, poolReadCacheWriteIops=poolReadCacheWriteIops, targetGroupMemberAdded=targetGroupMemberAdded, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, maintenanceModeEnabled=maintenanceModeEnabled, projectEntry=projectEntry, poolFreeSizeHigh=poolFreeSizeHigh, fcTargetGroup=fcTargetGroup, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareCIFSReadMbps=shareCIFSReadMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcTotalWriteIops=fcTotalWriteIops, shareNFSReadMbps=shareNFSReadMbps, replicationPaused=replicationPaused, ipmiVoltage=ipmiVoltage, haControllerB_Name=haControllerB_Name, poolUsedSizeHigh=poolUsedSizeHigh, shareCIFSWriteLatency=shareCIFSWriteLatency, shareEntry=shareEntry, maintenanceModeDisabled=maintenanceModeDisabled, webdocsUpgradeFailed=webdocsUpgradeFailed, nicMTU=nicMTU, replicationTargetDeleted=replicationTargetDeleted, notifications=notifications, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, ipmiPowerSupply=ipmiPowerSupply, netbiosSocketFailure=netbiosSocketFailure, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareNFSWriteIops=shareNFSWriteIops, fcProperties=fcProperties, iscsiWriteIops=iscsiWriteIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolTotalSaving=poolTotalSaving, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, networkIpmpGroupUp=networkIpmpGroupUp, projectLunCount=projectLunCount, poolDataReadMbps=poolDataReadMbps, replicationStarted=replicationStarted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolDataReadLatency=poolDataReadLatency, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, targetGroupDeleteCompleted=targetGroupDeleteCompleted, snmpServiceStopFailed=snmpServiceStopFailed, poolReadCacheReadLatency=poolReadCacheReadLatency, fcTargetsTable=fcTargetsTable, memoryFailure=memoryFailure, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunIndex=lunIndex, replicationFailed=replicationFailed, pools=pools, lunTable=lunTable, notificationReadingUnit=notificationReadingUnit, poolReadCacheWriteLatency=poolReadCacheWriteLatency, haResources=haResources, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, snapshotCloningFailed=snapshotCloningFailed, tegileConformance=tegileConformance, fcInitiatorEntry=fcInitiatorEntry, snmpServiceStarted=snmpServiceStarted, lunBlockSize=lunBlockSize, smbSocketFailure=smbSocketFailure, poolHealth=poolHealth, shareName=shareName, haResourceName=haResourceName, haResourcesTable=haResourcesTable, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, PYSNMP_MODULE_ID=tegile, lunDataSizeHigh=lunDataSizeHigh, diskDataReadIops=diskDataReadIops, fcTargetIndex=fcTargetIndex, cifsTotalReadIops=cifsTotalReadIops, sharePoolName=sharePoolName, cpuTotalUsage=cpuTotalUsage, nicTransmitMbps=nicTransmitMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunPoolName=lunPoolName, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, fcTargets=fcTargets, volumeDeleteFailed=volumeDeleteFailed, diskSizeLow=diskSizeLow, notificationSeverity=notificationSeverity, poolEntry=poolEntry, diskGoneOffline=diskGoneOffline, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, tegileArray_notifications=tegileArray_notifications, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, shareCIFSReadLatency=shareCIFSReadLatency, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareDataSizeLow=shareDataSizeLow, cifsTotalWriteIops=cifsTotalWriteIops, haResourceDescription=haResourceDescription, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, haResourceIndex=haResourceIndex, poolSizeHigh=poolSizeHigh, poolDataWriteIops=poolDataWriteIops, lunSnapshotSizeLow=lunSnapshotSizeLow, currentNotificationGroup=currentNotificationGroup, adServerTimeDrift=adServerTimeDrift, cacheTotalWriteMbps=cacheTotalWriteMbps, shareNFSReadLatency=shareNFSReadLatency, poolFreeSizeLow=poolFreeSizeLow, diskSlowIo=diskSlowIo, upgradeCompleted=upgradeCompleted, cacheTotalReadIops=cacheTotalReadIops, poolProjectCount=poolProjectCount, projectTable=projectTable, fcInitiatorCreateFailed=fcInitiatorCreateFailed, replicationAbandoned=replicationAbandoned, controllerTimeDrift=controllerTimeDrift, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, notificationDescription=notificationDescription, haControllerA_IPAddr=haControllerA_IPAddr, poolDataSizeHigh=poolDataSizeHigh, userLoginFailed=userLoginFailed, iscsiTargetsTable=iscsiTargetsTable, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, sanProperties=sanProperties, lunProjectName=lunProjectName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, lunFreeSizeLow=lunFreeSizeLow, haResourceActiveNode=haResourceActiveNode, upgradeTimeout=upgradeTimeout, diskCount=diskCount, shareProjectName=shareProjectName, notificationComponentName=notificationComponentName, ipmiCriticalInterrupt=ipmiCriticalInterrupt, fcTotalReadIops=fcTotalReadIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, diskDataWriteMbps=diskDataWriteMbps, snapshotCreationFailed=snapshotCreationFailed, projectShareCount=projectShareCount, diskEntry=diskEntry, shareReservedSizeLow=shareReservedSizeLow, volumeDeleteCompleted=volumeDeleteCompleted, controllerDown=controllerDown, replicationAborted=replicationAborted, poolProjects=poolProjects, poolDataWriteLatency=poolDataWriteLatency, poolDeleted=poolDeleted, nicEntry=nicEntry, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolState=poolState, projectCompressionEnabled=projectCompressionEnabled, nicGroup=nicGroup, fcTargetStatus=fcTargetStatus, fcTargetReadMbps=fcTargetReadMbps, lunReservedSizeLow=lunReservedSizeLow, iscsiInitiatorsTable=iscsiInitiatorsTable, diskRandomIOCount=diskRandomIOCount, fcTargetEntry=fcTargetEntry, cifsAvgReadLatency=cifsAvgReadLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiInitiatorChapUser=iscsiInitiatorChapUser, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, upgradeFailed=upgradeFailed, network=network, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, fcInitiatorIndex=fcInitiatorIndex, poolUsedSizeLow=poolUsedSizeLow, lunEntry=lunEntry, poolMetaWriteMbps=poolMetaWriteMbps, projectLUNs=projectLUNs, volumeModifyCompleted=volumeModifyCompleted, cacheRAMReads=cacheRAMReads, notificationTargetEntityName=notificationTargetEntityName, replicationResumed=replicationResumed, lunSizeHigh=lunSizeHigh, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, fcTargetName=fcTargetName, iscsiTargetAlias=iscsiTargetAlias, diskTotalWriteIops=diskTotalWriteIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, tdpsUpgradeFailed=tdpsUpgradeFailed, fcInitiatorName=fcInitiatorName, haControllerB_Uptime=haControllerB_Uptime, notificationEventCode=notificationEventCode, sensorFailureEvent=sensorFailureEvent, shareQuotaHigh=shareQuotaHigh, lunFreeSizeHigh=lunFreeSizeHigh, controllerUp=controllerUp, poolTable=poolTable, poolMetaReadIops=poolMetaReadIops, poolCount=poolCount, intelliFlashSoftwareDown=intelliFlashSoftwareDown, networkInterfaceUp=networkInterfaceUp, iscsiInitiatorEntry=iscsiInitiatorEntry, cifsTotalWriteMbps=cifsTotalWriteMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareNFSEnabled=shareNFSEnabled, lunCompressedRatio=lunCompressedRatio, lunName=lunName, aclMigrationStarted=aclMigrationStarted, projectFreeSizeHigh=projectFreeSizeHigh, projectTotalSaving=projectTotalSaving, lunReadMbps=lunReadMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency)
