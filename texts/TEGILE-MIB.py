...
# Produced by pysmi-1.1.8 at Fri Jan  7 00:41:02 2022
...
ObjectIdentity, ModuleIdentity, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, NotificationType, IpAddress, Counter32, Counter64, Integer32, Unsigned32, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "NotificationType", "IpAddress", "Counter32", "Counter64", "Integer32", "Unsigned32", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolAvgReadLatency=poolAvgReadLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, haControllerA_Name=haControllerA_Name, projectDeleted=projectDeleted, shareNFSReadIops=shareNFSReadIops, sharePoolName=sharePoolName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, smisServiceStarted=smisServiceStarted, iscsiInitiatorsTable=iscsiInitiatorsTable, iscsiTargetName=iscsiTargetName, fcTotalWriteIops=fcTotalWriteIops, iscsiTargets=iscsiTargets, projectCompressionEnabled=projectCompressionEnabled, nicTransmitMbps=nicTransmitMbps, nicState=nicState, shareReservedSizeLow=shareReservedSizeLow, deleteFolderCompleted=deleteFolderCompleted, maintenanceModeEnabled=maintenanceModeEnabled, ipmiTemperature=ipmiTemperature, nvdimmFailInitializationError=nvdimmFailInitializationError, poolTotalWriteMbps=poolTotalWriteMbps, shareNFSReadMbps=shareNFSReadMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareQuotaHigh=shareQuotaHigh, notificationSensorAction=notificationSensorAction, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolWriteCacheWriteIops=poolWriteCacheWriteIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, smisServiceStopFailed=smisServiceStopFailed, diskChassisIdx=diskChassisIdx, fcTargetModifyCompleted=fcTargetModifyCompleted, fcAvgWriteLatency=fcAvgWriteLatency, lunWriteLatency=lunWriteLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, nvdimmFailSoftError=nvdimmFailSoftError, poolAvgWriteLatency=poolAvgWriteLatency, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, maintenanceModeDisabled=maintenanceModeDisabled, projectShareCount=projectShareCount, deleteFolderFailed=deleteFolderFailed, iscsiTargetsTable=iscsiTargetsTable, shareTable=shareTable, iscsiTotalWriteMbps=iscsiTotalWriteMbps, notificationTime=notificationTime, volumeModifyCompleted=volumeModifyCompleted, notificationEventCode=notificationEventCode, shareCIFSWriteMbps=shareCIFSWriteMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, poolHealth=poolHealth, lunReadLatency=lunReadLatency, diskState=diskState, poolMetaReadLatency=poolMetaReadLatency, tegile=tegile, controllerUp=controllerUp, tegileArray=tegileArray, lunCompressedRatio=lunCompressedRatio, shareDeleted=shareDeleted, shareCIFSWriteLatency=shareCIFSWriteLatency, diskAlias=diskAlias, poolProjects=poolProjects, ipmiThreshold=ipmiThreshold, poolCount=poolCount, cacheTotalReadMbps=cacheTotalReadMbps, cpuTotalUsage=cpuTotalUsage, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, replicationFailed=replicationFailed, poolFreeSizeHigh=poolFreeSizeHigh, sensorFailureEvent=sensorFailureEvent, cifsTotalWriteIops=cifsTotalWriteIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, userLoginFailed=userLoginFailed, PYSNMP_MODULE_ID=tegile, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, ipmiVoltage=ipmiVoltage, haResourcesTable=haResourcesTable, fcInitiatorsTable=fcInitiatorsTable, networkInterfaceDown=networkInterfaceDown, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, lunWriteIops=lunWriteIops, iscsiInitiatorName=iscsiInitiatorName, poolDataReadIops=poolDataReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, replicationComplete=replicationComplete, iscsiInitiatorChapUser=iscsiInitiatorChapUser, fcTargetReadMbps=fcTargetReadMbps, diskSequentialIOCount=diskSequentialIOCount, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareMountPoint=shareMountPoint, controllerTimeDrift=controllerTimeDrift, upgradeCompleted=upgradeCompleted, haControllerA_IPAddr=haControllerA_IPAddr, notificationComponentName=notificationComponentName, poolFreeSizeLow=poolFreeSizeLow, fcInitiatorEntry=fcInitiatorEntry, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunTargetGroup=lunTargetGroup, poolMetaReadMbps=poolMetaReadMbps, cacheSSDReads=cacheSSDReads, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, lunReservedSizeHigh=lunReservedSizeHigh, haControllerB_IPAddr=haControllerB_IPAddr, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, cifsAvgReadLatency=cifsAvgReadLatency, poolTable=poolTable, snmpServiceStarted=snmpServiceStarted, poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareQuotaLow=shareQuotaLow, iscsiTargetGroupError=iscsiTargetGroupError, tegileCompliances=tegileCompliances, pools=pools, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, notificationSensorNumber=notificationSensorNumber, alertsCleanupCompleted=alertsCleanupCompleted, diskAvgReadLatency=diskAvgReadLatency, iscsiTargetEntry=iscsiTargetEntry, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, volumeDeleteCompleted=volumeDeleteCompleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, fcTargetWriteLatency=fcTargetWriteLatency, poolDeletionFailed=poolDeletionFailed, replicationResumed=replicationResumed, iscsiInitiatorEntry=iscsiInitiatorEntry, shareCIFSReadLatency=shareCIFSReadLatency, poolImported=poolImported, shareReservedSizeHigh=shareReservedSizeHigh, notificationSeverity=notificationSeverity, notificationReadingUnit=notificationReadingUnit, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiInitiatorIndex=iscsiInitiatorIndex, projectCreatedSuccessfully=projectCreatedSuccessfully, fcInitiatorGroup=fcInitiatorGroup, notifications=notifications, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, nicEntry=nicEntry, haResourceGroup=haResourceGroup, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcProperties=fcProperties, nicTable=nicTable, iscsiTargetReadMbps=iscsiTargetReadMbps, shareIndex=shareIndex, nicMTU=nicMTU, iscsiInitiatorGroup=iscsiInitiatorGroup, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareNFSEnabled=shareNFSEnabled, projectEntry=projectEntry, fcTargetReadLatency=fcTargetReadLatency, projectDeletionFailed=projectDeletionFailed, cpuInterrupts=cpuInterrupts, poolTotalReadMbps=poolTotalReadMbps, diskIOCount=diskIOCount, snapshotCloningFailed=snapshotCloningFailed, poolExported=poolExported, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, replicationTargetDeleted=replicationTargetDeleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, projectName=projectName, currentNotificationGroup=currentNotificationGroup, aclMigrationCompleted=aclMigrationCompleted, ipmiPowerSupply=ipmiPowerSupply, cpuSystemCalls=cpuSystemCalls, shareCIFSReadIops=shareCIFSReadIops, networkIpmpGroupUp=networkIpmpGroupUp, projectTotalSaving=projectTotalSaving, upgradeStarted=upgradeStarted, poolMetaWriteLatency=poolMetaWriteLatency, upgradeDownloadStarted=upgradeDownloadStarted, aclMigrationStarted=aclMigrationStarted, fcTargetWriteIops=fcTargetWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectTable=projectTable, lunSizeLow=lunSizeLow, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, network=network, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunIndex=lunIndex, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, shareQuotaFinished=shareQuotaFinished, poolTotalSaving=poolTotalSaving, shareDataSizeHigh=shareDataSizeHigh, networkTotalReceiveMbps=networkTotalReceiveMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, diskTotalReadMbps=diskTotalReadMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, ipmiOther=ipmiOther, netbiosSocketFailure=netbiosSocketFailure, iscsiTargetReadIops=iscsiTargetReadIops, diskSizeHigh=diskSizeHigh, shareSnapshotSizeHigh=shareSnapshotSizeHigh, snapshotDeleteFailed=snapshotDeleteFailed, lunReadIops=lunReadIops, basicCompliance=basicCompliance, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diskDataReadIops=diskDataReadIops, shareProjectName=shareProjectName, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, haControllerB_Uptime=haControllerB_Uptime, disks=disks, diskAvgWriteLatency=diskAvgWriteLatency, poolUsedSizeLow=poolUsedSizeLow, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, currentObjectGroup=currentObjectGroup, nicGroup=nicGroup, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, snmpServiceStopped=snmpServiceStopped, iscsiTargetError=iscsiTargetError, spareDiskReplaced=spareDiskReplaced, cifsTotalReadIops=cifsTotalReadIops, globalStatistics=globalStatistics, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareCompressedRatio=shareCompressedRatio, lunGUID=lunGUID, lunCompressionEnabled=lunCompressionEnabled, poolDataReadLatency=poolDataReadLatency, replicationStarted=replicationStarted, nvdimmFailDeviceError=nvdimmFailDeviceError, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, diskError=diskError, poolProjectCount=poolProjectCount, notificationDescription=notificationDescription, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, ipmiMemory=ipmiMemory, tegileArray_notifications=tegileArray_notifications, shareNFSWriteLatency=shareNFSWriteLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolUsedSizeHigh=poolUsedSizeHigh, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolState=poolState, iscsiAvgReadLatency=iscsiAvgReadLatency, diskDataWriteMbps=diskDataWriteMbps, shareNFSReadLatency=shareNFSReadLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, replicationAborted=replicationAborted, projectLUNs=projectLUNs, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, testNotification=testNotification, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectDataSizeLow=projectDataSizeLow, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, snapshotRollbackFailed=snapshotRollbackFailed, lunInitiatorGroup=lunInitiatorGroup)
mibBuilder.exportSymbols("TEGILE-MIB", networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, diskCount=diskCount, diskSizeLow=diskSizeLow, projectModified=projectModified, diskType=diskType, notificationProps=notificationProps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, fcTargetGroup=fcTargetGroup, shareName=shareName, memoryFailure=memoryFailure, cacheTotalWriteMbps=cacheTotalWriteMbps, fcTargetIndex=fcTargetIndex, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, networkInterfaceUp=networkInterfaceUp, replicationSourceRegistered=replicationSourceRegistered, nicIndex=nicIndex, projectPoolName=projectPoolName, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, intelliFlashSoftwareUp=intelliFlashSoftwareUp, lunPoolName=lunPoolName, shareCIFSReadMbps=shareCIFSReadMbps, projectDedupEnabled=projectDedupEnabled, lunBlockSize=lunBlockSize, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, controllerHardwareModel=controllerHardwareModel, fcPortOffline=fcPortOffline, iscsiTargetAlias=iscsiTargetAlias, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunProjectName=lunProjectName, lunProtocol=lunProtocol, upgradeTimeout=upgradeTimeout, lunDedupEnabled=lunDedupEnabled, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunSizeHigh=lunSizeHigh, iscsiWriteIops=iscsiWriteIops, snmpAgentVersion=snmpAgentVersion, projectIndex=projectIndex, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, diskRandomIOCount=diskRandomIOCount, diskEntry=diskEntry, snapshotCreationFailed=snapshotCreationFailed, replicationAbandoned=replicationAbandoned, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetWriteMbps=fcTargetWriteMbps, haResourceEntry=haResourceEntry, lunDataSizeHigh=lunDataSizeHigh, fcPortOnline=fcPortOnline, projectFreeSizeLow=projectFreeSizeLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareCreatedSuccessfully=shareCreatedSuccessfully, nfsTotalWriteMbps=nfsTotalWriteMbps, snmpServiceStartFailed=snmpServiceStartFailed, shareExceedThresholdWarning=shareExceedThresholdWarning, poolTotalReadIops=poolTotalReadIops, cacheTotalWriteIops=cacheTotalWriteIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolDegraded=poolDegraded, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiTargetAuth=iscsiTargetAuth, tdpsUpgradeTimeout=tdpsUpgradeTimeout, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcTargets=fcTargets, iscsiTotalReadMbps=iscsiTotalReadMbps, diskSlowIo=diskSlowIo, targetGroupMemberAdded=targetGroupMemberAdded, nicReceiveMbps=nicReceiveMbps, cacheTotalReadIops=cacheTotalReadIops, poolExpanded=poolExpanded, snapshotRollbackCompleted=snapshotRollbackCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, lunFreeSizeLow=lunFreeSizeLow, tegileConformance=tegileConformance, poolTotalWriteIops=poolTotalWriteIops, tegileGroups=tegileGroups, volumeCreatedSuccessfully=volumeCreatedSuccessfully, nicName=nicName, poolDeleted=poolDeleted, fcTargetStatus=fcTargetStatus, fcAvgReadLatency=fcAvgReadLatency, vmwareNFSDatastores=vmwareNFSDatastores, adServerTimeDrift=adServerTimeDrift, lunSnapshotSizeHigh=lunSnapshotSizeHigh, properties=properties, smisServiceStopped=smisServiceStopped, nfsAvgReadLatency=nfsAvgReadLatency, nfsTotalReadMbps=nfsTotalReadMbps, shareDedupEnabled=shareDedupEnabled, diskDataWriteIops=diskDataWriteIops, shareNFSWriteIops=shareNFSWriteIops, iscsiTargetWriteLatency=iscsiTargetWriteLatency, haResourceStatus=haResourceStatus, poolCreated=poolCreated, ntpServerTimeDrift=ntpServerTimeDrift, notificationReadingTriggerValue=notificationReadingTriggerValue, iscsiTargetReadLatency=iscsiTargetReadLatency, cifsTotalReadMbps=cifsTotalReadMbps, fcTotalReadMbps=fcTotalReadMbps, poolMetaWriteMbps=poolMetaWriteMbps, poolDataWriteMbps=poolDataWriteMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, diskPoolName=diskPoolName, fcInitiatorIndex=fcInitiatorIndex, haControllerA_Uptime=haControllerA_Uptime, fcTotalReadIops=fcTotalReadIops, haResourceName=haResourceName, ipmiFan=ipmiFan, targetGroupMemberRemoved=targetGroupMemberRemoved, projectDataSizeHigh=projectDataSizeHigh, poolEntry=poolEntry, projectQuotaFinished=projectQuotaFinished, notificationTargetEntityName=notificationTargetEntityName, poolDataWriteLatency=poolDataWriteLatency, diskTotalReadIops=diskTotalReadIops, fcTargetsTable=fcTargetsTable, unknownSensorEvent=unknownSensorEvent, iscsiTotalReadIops=iscsiTotalReadIops, iscsiProperties=iscsiProperties, cacheRAMReads=cacheRAMReads, lunSnapshotSizeLow=lunSnapshotSizeLow, lunFreeSizeHigh=lunFreeSizeHigh, shareDataSizeLow=shareDataSizeLow, volumeQuotaFinished=volumeQuotaFinished, projectSnapshotSizeHigh=projectSnapshotSizeHigh, diskIsOnline=diskIsOnline, diskTotalWriteIops=diskTotalWriteIops, poolMetaReadIops=poolMetaReadIops, lunReadMbps=lunReadMbps, networkIpmpGroupDown=networkIpmpGroupDown, ipmiCurrent=ipmiCurrent, diskIndex=diskIndex, poolDataWriteIops=poolDataWriteIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, projectFreeSizeHigh=projectFreeSizeHigh, fcTotalWriteMbps=fcTotalWriteMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, networkTotalTransmitMbps=networkTotalTransmitMbps, notificationSensorSuspect=notificationSensorSuspect, diskDataReadMbps=diskDataReadMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, haResources=haResources, volumeDeleteFailed=volumeDeleteFailed, upgradeDownloadFailed=upgradeDownloadFailed, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolReadCacheReadIops=poolReadCacheReadIops, projectShares=projectShares, sanProperties=sanProperties, nfsTotalReadIops=nfsTotalReadIops, controllerDown=controllerDown, upgradeFailed=upgradeFailed, haResourceDescription=haResourceDescription, poolName=poolName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, webdocsUpgradeCompleted=webdocsUpgradeCompleted, lunReservedSizeLow=lunReservedSizeLow, iscsiTargetWriteIops=iscsiTargetWriteIops, shareCIFSWriteIops=shareCIFSWriteIops, shareCompressionEnabled=shareCompressionEnabled, projectThresholdExceedWarning=projectThresholdExceedWarning, fcInitiators=fcInitiators, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, haControllerB_Name=haControllerB_Name, diskTotalWriteMbps=diskTotalWriteMbps, smbSocketFailure=smbSocketFailure, iscsiTargetWriteMbps=iscsiTargetWriteMbps, haResourceActiveNode=haResourceActiveNode, lunTable=lunTable, nfsAvgWriteLatency=nfsAvgWriteLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiTargetGroup=iscsiTargetGroup, projectQuotaSizeLow=projectQuotaSizeLow, projectLunCount=projectLunCount, diskGoneOffline=diskGoneOffline, iscsiInitiators=iscsiInitiators, haResourceIndex=haResourceIndex, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcInitiatorName=fcInitiatorName, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolOwnerController=poolOwnerController, fcTargetEntry=fcTargetEntry, lunName=lunName, lunWriteMbps=lunWriteMbps, lunEntry=lunEntry, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolDataReadMbps=poolDataReadMbps, snapshotCloneCompleted=snapshotCloneCompleted, shareNFSWriteMbps=shareNFSWriteMbps, snmpServiceStopFailed=snmpServiceStopFailed, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareDeletionFailed=shareDeletionFailed, poolSizeHigh=poolSizeHigh, fcTargetName=fcTargetName, shareEntry=shareEntry, smisServiceStartFailed=smisServiceStartFailed, diskTable=diskTable, poolReadCacheWriteIops=poolReadCacheWriteIops, poolQuotaFinished=poolQuotaFinished, fcTargetReadIops=fcTargetReadIops, poolSizeLow=poolSizeLow, poolIndex=poolIndex, replicationPaused=replicationPaused, poolMetaWriteIops=poolMetaWriteIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunDataSizeLow=lunDataSizeLow, poolUpgraded=poolUpgraded, shareCIFSEnabled=shareCIFSEnabled, diagnosticDataUploaded=diagnosticDataUploaded, notificationObjects=notificationObjects, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolDataSizeHigh=poolDataSizeHigh, nfsTotalWriteIops=nfsTotalWriteIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted)
