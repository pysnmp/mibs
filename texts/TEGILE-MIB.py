...
Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Unsigned32, iso, enterprises, IpAddress, Gauge32, Bits, Counter32, Integer32, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Unsigned32", "iso", "enterprises", "IpAddress", "Gauge32", "Bits", "Counter32", "Integer32", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, networkIpmpGroupDown=networkIpmpGroupDown, targetGroupMemberRemoved=targetGroupMemberRemoved, projectShares=projectShares, poolUsedSizeHigh=poolUsedSizeHigh, projectIndex=projectIndex, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunReservedSizeHigh=lunReservedSizeHigh, snapshotDeleteFailed=snapshotDeleteFailed, nvdimmFailInitializationError=nvdimmFailInitializationError, fcTargetReadLatency=fcTargetReadLatency, cacheTotalWriteMbps=cacheTotalWriteMbps, poolAvgWriteLatency=poolAvgWriteLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiAvgReadLatency=iscsiAvgReadLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, networkInterfaceDown=networkInterfaceDown, lunDataSizeLow=lunDataSizeLow, ipmiFan=ipmiFan, haResourceIndex=haResourceIndex, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, fcTargetReadMbps=fcTargetReadMbps, diskSlowIo=diskSlowIo, haControllerB_Uptime=haControllerB_Uptime, diskTotalReadMbps=diskTotalReadMbps, shareQuotaHigh=shareQuotaHigh, lunSnapshotSizeLow=lunSnapshotSizeLow, lunProjectName=lunProjectName, fcTargetStatus=fcTargetStatus, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcInitiatorsTable=fcInitiatorsTable, controllerTimeDrift=controllerTimeDrift, iscsiTargetAuth=iscsiTargetAuth, poolDataReadMbps=poolDataReadMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, notificationEventCode=notificationEventCode, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, properties=properties, iscsiWriteIops=iscsiWriteIops, diagnosticDataUploaded=diagnosticDataUploaded, lunFreeSizeHigh=lunFreeSizeHigh, diskDataReadIops=diskDataReadIops, nfsTotalReadIops=nfsTotalReadIops, diskIsOnline=diskIsOnline, deleteFolderFailed=deleteFolderFailed, lunReadLatency=lunReadLatency, poolTable=poolTable, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, shareReservedSizeLow=shareReservedSizeLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, upgradeCompleted=upgradeCompleted, iscsiTargetError=iscsiTargetError, poolDataReadLatency=poolDataReadLatency, poolQuotaFinished=poolQuotaFinished, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcInitiatorEntry=fcInitiatorEntry, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, nfsTotalWriteIops=nfsTotalWriteIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, haResourceGroup=haResourceGroup, poolImported=poolImported, lunTable=lunTable, aclMigrationCompleted=aclMigrationCompleted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunTargetGroup=lunTargetGroup, notificationThresholdTriggerValue=notificationThresholdTriggerValue, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolTotalReadIops=poolTotalReadIops, network=network, haResourceEntry=haResourceEntry, replicationAborted=replicationAborted, controllerDown=controllerDown, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, nfsTotalReadMbps=nfsTotalReadMbps, nicEntry=nicEntry, projectDeleted=projectDeleted, poolIndex=poolIndex, poolTotalSaving=poolTotalSaving, projectPoolName=projectPoolName, poolSizeLow=poolSizeLow, sensorFailureEvent=sensorFailureEvent, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, smisServiceStopFailed=smisServiceStopFailed, lunReservedSizeLow=lunReservedSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolDeleted=poolDeleted, haResourceStatus=haResourceStatus, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunInitiatorGroup=lunInitiatorGroup, haControllerA_Uptime=haControllerA_Uptime, volumeQuotaFinished=volumeQuotaFinished, iscsiTargetIndex=iscsiTargetIndex, fcInitiatorIndex=fcInitiatorIndex, replicationStarted=replicationStarted, lunPoolName=lunPoolName, cifsTotalReadMbps=cifsTotalReadMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, ipmiCurrent=ipmiCurrent, shareDataSizeLow=shareDataSizeLow, diskTable=diskTable, projectTotalSaving=projectTotalSaving, shareQuotaLow=shareQuotaLow, fcInitiatorGroup=fcInitiatorGroup, lunDataSizeHigh=lunDataSizeHigh, shareCompressedRatio=shareCompressedRatio, maintenanceModeEnabled=maintenanceModeEnabled, ipmiVoltage=ipmiVoltage, poolTotalWriteIops=poolTotalWriteIops, fcTargetWriteIops=fcTargetWriteIops, projectQuotaSizeHigh=projectQuotaSizeHigh, snmpServiceStartFailed=snmpServiceStartFailed, haResourceActiveNode=haResourceActiveNode, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolOwnerController=poolOwnerController, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskTotalWriteMbps=diskTotalWriteMbps, smisServiceStarted=smisServiceStarted, poolDataReadIops=poolDataReadIops, lunEntry=lunEntry, projectFreeSizeHigh=projectFreeSizeHigh, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolDataSizeHigh=poolDataSizeHigh, vmwareNFSDatastores=vmwareNFSDatastores, haControllerB_Name=haControllerB_Name, nfsAvgWriteLatency=nfsAvgWriteLatency, notificationSeverity=notificationSeverity, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, upgradeTimeout=upgradeTimeout, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, diskChassisIdx=diskChassisIdx, poolTotalReadMbps=poolTotalReadMbps, basicCompliance=basicCompliance, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, haResourcesTable=haResourcesTable, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, nicMTU=nicMTU, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, notificationSensorNumber=notificationSensorNumber, controllerHardwareModel=controllerHardwareModel, poolMetaReadIops=poolMetaReadIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, lunProtocol=lunProtocol, tdpsUpgradeCompleted=tdpsUpgradeCompleted, shareQuotaFinished=shareQuotaFinished, poolTotalWriteMbps=poolTotalWriteMbps, lunIndex=lunIndex, nvdimmFailDeviceError=nvdimmFailDeviceError, shareIndex=shareIndex, PYSNMP_MODULE_ID=tegile, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, haResourceName=haResourceName, nicIndex=nicIndex, poolMetaWriteIops=poolMetaWriteIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, smbSocketFailure=smbSocketFailure, diskState=diskState, projectShareCount=projectShareCount, replicationFailed=replicationFailed, poolDataWriteLatency=poolDataWriteLatency, poolExpanded=poolExpanded, targetGroupMemberAdded=targetGroupMemberAdded, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareCIFSReadLatency=shareCIFSReadLatency, haControllerA_IPAddr=haControllerA_IPAddr, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, haControllerA_Name=haControllerA_Name, diskTotalReadIops=diskTotalReadIops, lunFreeSizeLow=lunFreeSizeLow, fcTargetName=fcTargetName, diskIOCount=diskIOCount, networkTotalReceiveMbps=networkTotalReceiveMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, notificationReadingUnit=notificationReadingUnit, poolProjectCount=poolProjectCount, iscsiInitiators=iscsiInitiators, diskRandomIOCount=diskRandomIOCount, diskDataReadMbps=diskDataReadMbps, poolDataWriteMbps=poolDataWriteMbps, shareNFSWriteIops=shareNFSWriteIops, poolAvgReadLatency=poolAvgReadLatency, snapshotCreationFailed=snapshotCreationFailed, cpuInterrupts=cpuInterrupts, networkTotalTransmitMbps=networkTotalTransmitMbps, projectLunCount=projectLunCount, projectSnapshotSizeLow=projectSnapshotSizeLow, cpuSystemCalls=cpuSystemCalls, iscsiTotalReadMbps=iscsiTotalReadMbps, haControllerB_IPAddr=haControllerB_IPAddr, notificationSensorAction=notificationSensorAction, shareNFSReadMbps=shareNFSReadMbps, alertsCleanupCompleted=alertsCleanupCompleted, iscsiTargets=iscsiTargets, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, maintenanceModeDisabled=maintenanceModeDisabled, haResourceDescription=haResourceDescription, poolEntry=poolEntry, iscsiProperties=iscsiProperties, ntpServerTimeDrift=ntpServerTimeDrift, poolSizeHigh=poolSizeHigh, volumeDeleteCompleted=volumeDeleteCompleted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, diskTotalWriteIops=diskTotalWriteIops, projectName=projectName, fcTargetGroup=fcTargetGroup, notificationDescription=notificationDescription, poolMetaWriteLatency=poolMetaWriteLatency, notificationObjects=notificationObjects, deleteFolderCompleted=deleteFolderCompleted, netbiosSocketFailure=netbiosSocketFailure, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, replicationComplete=replicationComplete, nfsAvgReadLatency=nfsAvgReadLatency, disks=disks, fcAvgReadLatency=fcAvgReadLatency, tegileConformance=tegileConformance, unknownSensorEvent=unknownSensorEvent, iscsiTargetEntry=iscsiTargetEntry, replicationPaused=replicationPaused, poolHealth=poolHealth, iscsiInitiatorGroup=iscsiInitiatorGroup, lunName=lunName, nicTransmitMbps=nicTransmitMbps, ipmiOther=ipmiOther, iscsiTargetName=iscsiTargetName, poolMetaReadMbps=poolMetaReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, tegileArray_notifications=tegileArray_notifications, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, lunSizeLow=lunSizeLow, iscsiTotalReadIops=iscsiTotalReadIops, fcTargetWriteLatency=fcTargetWriteLatency, shareReservedSizeHigh=shareReservedSizeHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, smisServiceStartFailed=smisServiceStartFailed, diskIndex=diskIndex, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiTargetsTable=iscsiTargetsTable, projectDataSizeHigh=projectDataSizeHigh, poolMetaWriteMbps=poolMetaWriteMbps, upgradeFailed=upgradeFailed, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiImproperTargetGroup=iscsiImproperTargetGroup, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually)
mibBuilder.exportSymbols("TEGILE-MIB", cpuTotalUsage=cpuTotalUsage, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, diskPoolName=diskPoolName, diskAlias=diskAlias, diskGoneOffline=diskGoneOffline, notificationTime=notificationTime, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diskDataWriteMbps=diskDataWriteMbps, shareCIFSReadIops=shareCIFSReadIops, lunWriteLatency=lunWriteLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, fcTargetReadIops=fcTargetReadIops, projectLUNs=projectLUNs, snapshotRollbackCompleted=snapshotRollbackCompleted, poolName=poolName, notificationReadingTriggerValue=notificationReadingTriggerValue, poolFreeSizeLow=poolFreeSizeLow, diskSizeHigh=diskSizeHigh, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunCompressedRatio=lunCompressedRatio, upgradeDownloadFailed=upgradeDownloadFailed, cifsAvgWriteLatency=cifsAvgWriteLatency, networkIpmpGroupUp=networkIpmpGroupUp, poolCount=poolCount, adServerTimeDrift=adServerTimeDrift, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, fcTotalWriteMbps=fcTotalWriteMbps, iscsiInitiatorName=iscsiInitiatorName, iscsiInitiatorEntry=iscsiInitiatorEntry, lunGUID=lunGUID, diskDataWriteIops=diskDataWriteIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetEntry=fcTargetEntry, nicReceiveMbps=nicReceiveMbps, nicName=nicName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, pools=pools, targetGroupDeleteCompleted=targetGroupDeleteCompleted, diskAvgReadLatency=diskAvgReadLatency, ipmiMemory=ipmiMemory, upgradeDownloadStarted=upgradeDownloadStarted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, notificationProps=notificationProps, tegileArray=tegileArray, diskSequentialIOCount=diskSequentialIOCount, shareTable=shareTable, testNotification=testNotification, upgradeDownloadCompleted=upgradeDownloadCompleted, tegileGroups=tegileGroups, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, lunSizeHigh=lunSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunBlockSize=lunBlockSize, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiTargetAlias=iscsiTargetAlias, snapshotCloneCompleted=snapshotCloneCompleted, projectDeletionFailed=projectDeletionFailed, iscsiTargetReadIops=iscsiTargetReadIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectEntry=projectEntry, shareNFSWriteMbps=shareNFSWriteMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiTargetGroup=iscsiTargetGroup, intelliFlashSoftwareDown=intelliFlashSoftwareDown, cacheRAMReads=cacheRAMReads, currentObjectGroup=currentObjectGroup, notifications=notifications, ipmiTemperature=ipmiTemperature, notificationSensorSuspect=notificationSensorSuspect, poolState=poolState, tegile=tegile, fcPortOffline=fcPortOffline, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareCIFSWriteIops=shareCIFSWriteIops, shareDataSizeHigh=shareDataSizeHigh, projectTable=projectTable, shareCreatedSuccessfully=shareCreatedSuccessfully, fcTargetIndex=fcTargetIndex, nicState=nicState, webdocsUpgradeFailed=webdocsUpgradeFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareName=shareName, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareCIFSWriteMbps=shareCIFSWriteMbps, snmpServiceStarted=snmpServiceStarted, projectCreatedSuccessfully=projectCreatedSuccessfully, ipmiPowerSupply=ipmiPowerSupply, diskSizeLow=diskSizeLow, poolUsedSizeLow=poolUsedSizeLow, shareNFSReadLatency=shareNFSReadLatency, fcProperties=fcProperties, poolDegraded=poolDegraded, fcTargets=fcTargets, sharePoolName=sharePoolName, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, spareDiskReplaced=spareDiskReplaced, fcTotalReadMbps=fcTotalReadMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, lunCompressionEnabled=lunCompressionEnabled, snapshotRollbackFailed=snapshotRollbackFailed, iscsiInitiatorsTable=iscsiInitiatorsTable, networkInterfaceUp=networkInterfaceUp, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, diskAvgWriteLatency=diskAvgWriteLatency, snmpServiceStopped=snmpServiceStopped, diskEntry=diskEntry, cifsTotalWriteIops=cifsTotalWriteIops, projectCompressionEnabled=projectCompressionEnabled, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareCIFSWriteLatency=shareCIFSWriteLatency, lunReadMbps=lunReadMbps, upgradeStarted=upgradeStarted, fcPortOnline=fcPortOnline, cacheTotalReadMbps=cacheTotalReadMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, shareEntry=shareEntry, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, snmpServiceStopFailed=snmpServiceStopFailed, nicGroup=nicGroup, poolDeletionFailed=poolDeletionFailed, cacheTotalWriteIops=cacheTotalWriteIops, ipmiThreshold=ipmiThreshold, fcInitiators=fcInitiators, diskCount=diskCount, fcTargetWriteMbps=fcTargetWriteMbps, shareDeletionFailed=shareDeletionFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, diskError=diskError, nvdimmFailUnknownError=nvdimmFailUnknownError, replicationAbandoned=replicationAbandoned, nicTable=nicTable, globalStatistics=globalStatistics, projectDedupEnabled=projectDedupEnabled, lunWriteMbps=lunWriteMbps, lunReadIops=lunReadIops, lunWriteIops=lunWriteIops, aclMigrationStarted=aclMigrationStarted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, tegileCompliances=tegileCompliances, sanProperties=sanProperties, snmpAgentVersion=snmpAgentVersion, projectFreeSizeLow=projectFreeSizeLow, fcInitiatorName=fcInitiatorName, shareDedupEnabled=shareDedupEnabled, shareNFSWriteLatency=shareNFSWriteLatency, iscsiTargetGroupError=iscsiTargetGroupError, replicationTargetDeleted=replicationTargetDeleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolProjects=poolProjects, fcAvgWriteLatency=fcAvgWriteLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolDataWriteIops=poolDataWriteIops, poolReadCacheReadLatency=poolReadCacheReadLatency, shareNFSReadIops=shareNFSReadIops, replicationResumed=replicationResumed, poolUpgraded=poolUpgraded, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareNFSEnabled=shareNFSEnabled, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, notificationTargetEntityName=notificationTargetEntityName, projectModified=projectModified, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, diskType=diskType, shareSnapshotSizeLow=shareSnapshotSizeLow, lunDedupEnabled=lunDedupEnabled, userLoginFailed=userLoginFailed, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, tdpsUpgradeFailed=tdpsUpgradeFailed, shareExceedThresholdWarning=shareExceedThresholdWarning, fcTargetsTable=fcTargetsTable, projectQuotaFinished=projectQuotaFinished, nvdimmFailSoftError=nvdimmFailSoftError, shareCompressionEnabled=shareCompressionEnabled, controllerUp=controllerUp, replicationSourceRegistered=replicationSourceRegistered, cacheTotalReadIops=cacheTotalReadIops, poolMetaReadLatency=poolMetaReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, projectQuotaSizeLow=projectQuotaSizeLow, poolCreated=poolCreated, notificationComponentName=notificationComponentName, smisServiceStopped=smisServiceStopped, projectDataSizeLow=projectDataSizeLow, shareMountPoint=shareMountPoint, haResources=haResources, shareProjectName=shareProjectName, volumeModifyCompleted=volumeModifyCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, volumeDeleteFailed=volumeDeleteFailed, poolFreeSizeHigh=poolFreeSizeHigh, fcTotalReadIops=fcTotalReadIops, shareCIFSReadMbps=shareCIFSReadMbps, poolExported=poolExported, snapshotCloningFailed=snapshotCloningFailed, shareCIFSEnabled=shareCIFSEnabled, memoryFailure=memoryFailure, cifsAvgReadLatency=cifsAvgReadLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, cifsTotalReadIops=cifsTotalReadIops, shareDeleted=shareDeleted, currentNotificationGroup=currentNotificationGroup, fcTotalWriteIops=fcTotalWriteIops, cacheSSDReads=cacheSSDReads)
