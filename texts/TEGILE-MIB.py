...
Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ObjectIdentity, Bits, NotificationType, Gauge32, Counter64, ModuleIdentity, Integer32, MibIdentifier, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ObjectIdentity", "Bits", "NotificationType", "Gauge32", "Counter64", "ModuleIdentity", "Integer32", "MibIdentifier", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskTable=diskTable, properties=properties, fcInitiatorIndex=fcInitiatorIndex, haResourceName=haResourceName, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, projectLUNs=projectLUNs, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiInitiators=iscsiInitiators, projectShares=projectShares, currentObjectGroup=currentObjectGroup, diskSizeLow=diskSizeLow, snapshotCreationFailed=snapshotCreationFailed, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskSlowIo=diskSlowIo, nicIndex=nicIndex, iscsiInitiatorGroup=iscsiInitiatorGroup, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, nfsTotalWriteIops=nfsTotalWriteIops, deleteFolderFailed=deleteFolderFailed, lunReservedSizeLow=lunReservedSizeLow, fcTargets=fcTargets, shareCIFSWriteMbps=shareCIFSWriteMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, haResourceDescription=haResourceDescription, replicationAborted=replicationAborted, replicationPaused=replicationPaused, poolDegraded=poolDegraded, diskEntry=diskEntry, diskIOCount=diskIOCount, diskAlias=diskAlias, targetGroupMemberAdded=targetGroupMemberAdded, nvdimmFailUnknownError=nvdimmFailUnknownError, currentNotificationGroup=currentNotificationGroup, poolDeleted=poolDeleted, diskIndex=diskIndex, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diskTotalReadIops=diskTotalReadIops, volumeDeleteCompleted=volumeDeleteCompleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, lunEntry=lunEntry, sharePoolName=sharePoolName, shareCompressedRatio=shareCompressedRatio, userLoginFailed=userLoginFailed, diskDataWriteIops=diskDataWriteIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, smisServiceStarted=smisServiceStarted, iscsiProperties=iscsiProperties, fcAvgWriteLatency=fcAvgWriteLatency, notificationSensorSuspect=notificationSensorSuspect, nicGroup=nicGroup, shareDedupEnabled=shareDedupEnabled, poolReadCacheReadIops=poolReadCacheReadIops, shareProjectName=shareProjectName, targetGroupCreateCompleted=targetGroupCreateCompleted, snmpServiceStarted=snmpServiceStarted, fcTargetStatus=fcTargetStatus, shareDeleted=shareDeleted, poolAvgWriteLatency=poolAvgWriteLatency, shareQuotaHigh=shareQuotaHigh, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolDataWriteLatency=poolDataWriteLatency, projectLunCount=projectLunCount, lunInitiatorGroup=lunInitiatorGroup, poolMetaWriteLatency=poolMetaWriteLatency, notificationReadingUnit=notificationReadingUnit, poolProjects=poolProjects, shareNFSReadIops=shareNFSReadIops, networkInterfaceUp=networkInterfaceUp, shareNFSWriteIops=shareNFSWriteIops, tegile=tegile, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectDataSizeLow=projectDataSizeLow, poolFreeSizeLow=poolFreeSizeLow, poolCreated=poolCreated, unknownSensorEvent=unknownSensorEvent, fcTargetReadIops=fcTargetReadIops, poolMetaWriteMbps=poolMetaWriteMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, intelliFlashSoftwareUp=intelliFlashSoftwareUp, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, haControllerA_Uptime=haControllerA_Uptime, projectQuotaSizeLow=projectQuotaSizeLow, lunFreeSizeLow=lunFreeSizeLow, diskDataReadIops=diskDataReadIops, globalStatistics=globalStatistics, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolSizeHigh=poolSizeHigh, lunReadMbps=lunReadMbps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcTotalWriteIops=fcTotalWriteIops, projectName=projectName, snapshotRollbackCompleted=snapshotRollbackCompleted, ipmiVoltage=ipmiVoltage, controllerUp=controllerUp, shareCIFSReadMbps=shareCIFSReadMbps, fcInitiators=fcInitiators, lunProjectName=lunProjectName, iscsiTargetEntry=iscsiTargetEntry, fcTargetsTable=fcTargetsTable, cpuInterrupts=cpuInterrupts, poolReadCacheReadLatency=poolReadCacheReadLatency, poolQuotaFinished=poolQuotaFinished, shareCIFSReadLatency=shareCIFSReadLatency, vmwareNFSDatastores=vmwareNFSDatastores, diskState=diskState, tegileGroups=tegileGroups, networkIpmpGroupUp=networkIpmpGroupUp, lunWriteMbps=lunWriteMbps, fcAvgReadLatency=fcAvgReadLatency, tegileArray_notifications=tegileArray_notifications, snmpServiceStartFailed=snmpServiceStartFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, notificationReadingTriggerValue=notificationReadingTriggerValue, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskPoolName=diskPoolName, adServerTimeDrift=adServerTimeDrift, fcTotalReadIops=fcTotalReadIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunSizeLow=lunSizeLow, controllerDown=controllerDown, iscsiTotalReadMbps=iscsiTotalReadMbps, cacheTotalWriteIops=cacheTotalWriteIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolTotalWriteMbps=poolTotalWriteMbps, shareCIFSEnabled=shareCIFSEnabled, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareExceedThresholdWarning=shareExceedThresholdWarning, fcTargetModifyCompleted=fcTargetModifyCompleted, upgradeDownloadFailed=upgradeDownloadFailed, haControllerB_Name=haControllerB_Name, shareQuotaFinished=shareQuotaFinished, snapshotDeleteFailed=snapshotDeleteFailed, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, cifsTotalWriteMbps=cifsTotalWriteMbps, shareCompressionEnabled=shareCompressionEnabled, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiAvgWriteLatency=iscsiAvgWriteLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, poolTotalSaving=poolTotalSaving, notificationThresholdTriggerValue=notificationThresholdTriggerValue, maintenanceModeEnabled=maintenanceModeEnabled, diskCount=diskCount, poolName=poolName, notifications=notifications, upgradeDownloadCompleted=upgradeDownloadCompleted, shareQuotaLow=shareQuotaLow, haControllerA_Name=haControllerA_Name, networkTotalReceiveMbps=networkTotalReceiveMbps, sanProperties=sanProperties, shareReservedSizeLow=shareReservedSizeLow, poolTotalReadMbps=poolTotalReadMbps, shareNFSReadMbps=shareNFSReadMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareEntry=shareEntry, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, haResourceIndex=haResourceIndex, lunName=lunName, poolIndex=poolIndex, replicationTargetDeleted=replicationTargetDeleted, cifsTotalReadIops=cifsTotalReadIops, alertsCleanupCompleted=alertsCleanupCompleted, fcTargetEntry=fcTargetEntry, iscsiTargets=iscsiTargets, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, poolDataWriteMbps=poolDataWriteMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcPortOffline=fcPortOffline, basicCompliance=basicCompliance, snapshotCloningFailed=snapshotCloningFailed, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, notificationDescription=notificationDescription, fcTotalWriteMbps=fcTotalWriteMbps, lunFreeSizeHigh=lunFreeSizeHigh, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiTargetAuth=iscsiTargetAuth, diskGoneOffline=diskGoneOffline, iscsiWriteIops=iscsiWriteIops, poolOwnerController=poolOwnerController, PYSNMP_MODULE_ID=tegile, diskTotalWriteIops=diskTotalWriteIops, poolTable=poolTable, shareSnapshotSizeHigh=shareSnapshotSizeHigh, upgradeFailed=upgradeFailed, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, ipmiTemperature=ipmiTemperature, haResourceActiveNode=haResourceActiveNode, projectQuotaFinished=projectQuotaFinished, network=network, networkIpmpGroupDown=networkIpmpGroupDown, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, diskSequentialIOCount=diskSequentialIOCount, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, notificationSensorAction=notificationSensorAction, shareTable=shareTable, projectShareCount=projectShareCount, nfsTotalWriteMbps=nfsTotalWriteMbps, diskRandomIOCount=diskRandomIOCount, volumeDeleteFailed=volumeDeleteFailed, replicationResumed=replicationResumed, snmpAgentVersion=snmpAgentVersion, shareIndex=shareIndex, tdpsUpgradeCompleted=tdpsUpgradeCompleted, fcInitiatorGroup=fcInitiatorGroup, nfsAvgWriteLatency=nfsAvgWriteLatency, lunIndex=lunIndex, deleteFolderCompleted=deleteFolderCompleted, fcPortOnline=fcPortOnline, fcTargetWriteIops=fcTargetWriteIops, lunWriteIops=lunWriteIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, notificationSensorNumber=notificationSensorNumber, poolUpgraded=poolUpgraded, poolImported=poolImported, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, aclMigrationStarted=aclMigrationStarted, fcInitiatorsTable=fcInitiatorsTable, notificationSeverity=notificationSeverity, projectTable=projectTable, cifsAvgWriteLatency=cifsAvgWriteLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiInitiatorIndex=iscsiInitiatorIndex, cacheRAMReads=cacheRAMReads, shareSnapshotSizeLow=shareSnapshotSizeLow, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, nvdimmFailSoftError=nvdimmFailSoftError, poolDeletionFailed=poolDeletionFailed, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolExpanded=poolExpanded, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolReadCacheWriteMbps=poolReadCacheWriteMbps, replicationSourceRegistered=replicationSourceRegistered, haResourceStatus=haResourceStatus, nfsTotalReadIops=nfsTotalReadIops, poolMetaWriteIops=poolMetaWriteIops, lunDataSizeLow=lunDataSizeLow, tdpsUpgradeTimeout=tdpsUpgradeTimeout)
mibBuilder.exportSymbols("TEGILE-MIB", lunCompressionEnabled=lunCompressionEnabled, haResourceEntry=haResourceEntry, projectIndex=projectIndex, replicationComplete=replicationComplete, shareName=shareName, haResources=haResources, poolUsedSizeHigh=poolUsedSizeHigh, targetGroupDeleteCompleted=targetGroupDeleteCompleted, ipmiMemory=ipmiMemory, cifsTotalWriteIops=cifsTotalWriteIops, poolEntry=poolEntry, smisServiceStartFailed=smisServiceStartFailed, lunPoolName=lunPoolName, diskSizeHigh=diskSizeHigh, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, iscsiTargetWriteIops=iscsiTargetWriteIops, poolMetaReadMbps=poolMetaReadMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareDataSizeLow=shareDataSizeLow, intelliFlashSoftwareDown=intelliFlashSoftwareDown, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, haControllerA_IPAddr=haControllerA_IPAddr, iscsiTargetGroupError=iscsiTargetGroupError, lunTargetGroup=lunTargetGroup, sensorFailureEvent=sensorFailureEvent, lunTable=lunTable, cpuTotalUsage=cpuTotalUsage, haControllerB_IPAddr=haControllerB_IPAddr, haControllerB_Uptime=haControllerB_Uptime, poolTotalReadIops=poolTotalReadIops, iscsiInitiatorEntry=iscsiInitiatorEntry, projectCreatedSuccessfully=projectCreatedSuccessfully, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, networkInterfaceDown=networkInterfaceDown, nfsTotalReadMbps=nfsTotalReadMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcTargetIndex=fcTargetIndex, cacheTotalReadIops=cacheTotalReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, fcTotalReadMbps=fcTotalReadMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectDeleted=projectDeleted, snapshotCloneCompleted=snapshotCloneCompleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, smisServiceStopped=smisServiceStopped, ntpServerTimeDrift=ntpServerTimeDrift, nicEntry=nicEntry, poolDataReadLatency=poolDataReadLatency, netbiosSocketFailure=netbiosSocketFailure, projectFreeSizeHigh=projectFreeSizeHigh, replicationFailed=replicationFailed, tegileCompliances=tegileCompliances, cpuSystemCalls=cpuSystemCalls, nicReceiveMbps=nicReceiveMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diagnosticDataUploaded=diagnosticDataUploaded, diskTotalWriteMbps=diskTotalWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, haResourcesTable=haResourcesTable, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, projectTotalSaving=projectTotalSaving, nicTransmitMbps=nicTransmitMbps, ipmiPowerSupply=ipmiPowerSupply, lunSizeHigh=lunSizeHigh, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, nvdimmFailInitializationError=nvdimmFailInitializationError, diskAvgReadLatency=diskAvgReadLatency, diskType=diskType, projectDeletionFailed=projectDeletionFailed, iscsiTargetReadMbps=iscsiTargetReadMbps, diskDataWriteMbps=diskDataWriteMbps, iscsiTargetAlias=iscsiTargetAlias, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, nicName=nicName, poolDataReadIops=poolDataReadIops, shareMountPoint=shareMountPoint, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectModified=projectModified, poolDataWriteIops=poolDataWriteIops, projectSnapshotSizeLow=projectSnapshotSizeLow, nicTable=nicTable, nicState=nicState, volumeModifyCompleted=volumeModifyCompleted, poolCount=poolCount, controllerTimeDrift=controllerTimeDrift, shareNFSWriteMbps=shareNFSWriteMbps, poolProjectCount=poolProjectCount, poolDataSizeHigh=poolDataSizeHigh, notificationComponentName=notificationComponentName, lunReadLatency=lunReadLatency, smbSocketFailure=smbSocketFailure, controllerHardwareModel=controllerHardwareModel, shareCIFSWriteIops=shareCIFSWriteIops, iscsiTargetReadIops=iscsiTargetReadIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, snmpServiceStopped=snmpServiceStopped, networkTotalTransmitMbps=networkTotalTransmitMbps, poolDataSizeLow=poolDataSizeLow, poolMetaReadLatency=poolMetaReadLatency, projectPoolName=projectPoolName, diskAvgWriteLatency=diskAvgWriteLatency, replicationAbandoned=replicationAbandoned, snmpServiceStopFailed=snmpServiceStopFailed, poolHealth=poolHealth, projectSnapshotSizeHigh=projectSnapshotSizeHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargetError=iscsiTargetError, upgradeCompleted=upgradeCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationProps=notificationProps, poolTotalWriteIops=poolTotalWriteIops, shareCIFSWriteLatency=shareCIFSWriteLatency, lunProtocol=lunProtocol, diskDataReadMbps=diskDataReadMbps, poolAvgReadLatency=poolAvgReadLatency, ipmiCurrent=ipmiCurrent, tegileConformance=tegileConformance, projectFreeSizeLow=projectFreeSizeLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolExported=poolExported, snapshotRollbackFailed=snapshotRollbackFailed, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTargetsTable=iscsiTargetsTable, poolUsedSizeLow=poolUsedSizeLow, upgradeDownloadStarted=upgradeDownloadStarted, upgradeStarted=upgradeStarted, iscsiTargetReadLatency=iscsiTargetReadLatency, projectDataSizeHigh=projectDataSizeHigh, shareDataSizeHigh=shareDataSizeHigh, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolDataReadMbps=poolDataReadMbps, diskError=diskError, fcProperties=fcProperties, projectEntry=projectEntry, iscsiImproperTargetGroup=iscsiImproperTargetGroup, diskIsOnline=diskIsOnline, fcTargetReadMbps=fcTargetReadMbps, ipmiFan=ipmiFan, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, smisServiceStopFailed=smisServiceStopFailed, lunWriteLatency=lunWriteLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunCompressedRatio=lunCompressedRatio, tegileArray=tegileArray, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, lunDedupEnabled=lunDedupEnabled, memoryFailure=memoryFailure, lunReadIops=lunReadIops, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTargetReadLatency=fcTargetReadLatency, cifsAvgReadLatency=cifsAvgReadLatency, shareNFSReadLatency=shareNFSReadLatency, fcInitiatorEntry=fcInitiatorEntry, fcTargetGroup=fcTargetGroup, testNotification=testNotification, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, ipmiThreshold=ipmiThreshold, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiTargetGroup=iscsiTargetGroup, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, lunReservedSizeHigh=lunReservedSizeHigh, poolMetaReadIops=poolMetaReadIops, iscsiTotalReadIops=iscsiTotalReadIops, notificationTargetEntityName=notificationTargetEntityName, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diskChassisIdx=diskChassisIdx, shareReservedSizeHigh=shareReservedSizeHigh, aclMigrationCompleted=aclMigrationCompleted, volumeQuotaFinished=volumeQuotaFinished, projectThresholdExceedWarning=projectThresholdExceedWarning, shareCIFSReadIops=shareCIFSReadIops, iscsiTargetIndex=iscsiTargetIndex, nicMTU=nicMTU, cacheSSDReads=cacheSSDReads, poolWriteCacheWriteIops=poolWriteCacheWriteIops, notificationObjects=notificationObjects, lunGUID=lunGUID, upgradeTimeout=upgradeTimeout, pools=pools, notificationTime=notificationTime, fcTargetWriteLatency=fcTargetWriteLatency, replicationStarted=replicationStarted, fcTargetWriteMbps=fcTargetWriteMbps, ipmiOther=ipmiOther, iscsiInitiatorName=iscsiInitiatorName, fcTargetName=fcTargetName, disks=disks, fcInitiatorName=fcInitiatorName, diskTotalReadMbps=diskTotalReadMbps, projectDedupEnabled=projectDedupEnabled, shareNFSEnabled=shareNFSEnabled, shareDeletionFailed=shareDeletionFailed, poolState=poolState, maintenanceModeDisabled=maintenanceModeDisabled, spareDiskReplaced=spareDiskReplaced, poolSizeLow=poolSizeLow, lunDataSizeHigh=lunDataSizeHigh, iscsiTargetName=iscsiTargetName, poolFreeSizeHigh=poolFreeSizeHigh, notificationEventCode=notificationEventCode, haResourceGroup=haResourceGroup, lunBlockSize=lunBlockSize, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, projectCompressionEnabled=projectCompressionEnabled)
