...
# Produced by pysmi-1.1.8 at Wed Oct 11 09:37:16 2023
...
iso, Gauge32, ObjectIdentity, enterprises, Counter32, Unsigned32, IpAddress, Integer32, MibIdentifier, ModuleIdentity, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "ObjectIdentity", "enterprises", "Counter32", "Unsigned32", "IpAddress", "Integer32", "MibIdentifier", "ModuleIdentity", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, tdpsUpgradeCompleted=tdpsUpgradeCompleted, nfsTotalReadMbps=nfsTotalReadMbps, shareNFSEnabled=shareNFSEnabled, nicTable=nicTable, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, replicationComplete=replicationComplete, diskChassisIdx=diskChassisIdx, tegileConformance=tegileConformance, poolAvgWriteLatency=poolAvgWriteLatency, poolTable=poolTable, targetGroupMemberAdded=targetGroupMemberAdded, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareQuotaFinished=shareQuotaFinished, poolOwnerController=poolOwnerController, pools=pools, iscsiInitiatorIndex=iscsiInitiatorIndex, replicationFailed=replicationFailed, poolCreated=poolCreated, networkIpmpGroupDown=networkIpmpGroupDown, haControllerA_IPAddr=haControllerA_IPAddr, controllerTimeDrift=controllerTimeDrift, snapshotDeleteFailed=snapshotDeleteFailed, projectCompressionEnabled=projectCompressionEnabled, fcTargetName=fcTargetName, testNotification=testNotification, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolAvgReadLatency=poolAvgReadLatency, diskSizeLow=diskSizeLow, lunFreeSizeLow=lunFreeSizeLow, haResourceActiveNode=haResourceActiveNode, poolImported=poolImported, diskIndex=diskIndex, iscsiTargetError=iscsiTargetError, shareDeletionFailed=shareDeletionFailed, fcTargets=fcTargets, diskSequentialIOCount=diskSequentialIOCount, fcTotalReadMbps=fcTotalReadMbps, lunIndex=lunIndex, fcInitiatorsTable=fcInitiatorsTable, diagnosticDataUploaded=diagnosticDataUploaded, projectCreatedSuccessfully=projectCreatedSuccessfully, fcTargetReadMbps=fcTargetReadMbps, deleteFolderCompleted=deleteFolderCompleted, shareNFSReadMbps=shareNFSReadMbps, poolDataReadIops=poolDataReadIops, ntpServerTimeDrift=ntpServerTimeDrift, cifsTotalWriteMbps=cifsTotalWriteMbps, poolDataWriteLatency=poolDataWriteLatency, iscsiWriteIops=iscsiWriteIops, shareNFSReadIops=shareNFSReadIops, shareTable=shareTable, lunTargetGroup=lunTargetGroup, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunGUID=lunGUID, lunInitiatorGroup=lunInitiatorGroup, cifsAvgReadLatency=cifsAvgReadLatency, tegileArray_notifications=tegileArray_notifications, nfsAvgReadLatency=nfsAvgReadLatency, snapshotCloneCompleted=snapshotCloneCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, shareCIFSEnabled=shareCIFSEnabled, ipmiVoltage=ipmiVoltage, poolUsedSizeHigh=poolUsedSizeHigh, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareCIFSReadLatency=shareCIFSReadLatency, snmpServiceStarted=snmpServiceStarted, poolTotalWriteIops=poolTotalWriteIops, tegileCompliances=tegileCompliances, lunReservedSizeLow=lunReservedSizeLow, shareReservedSizeLow=shareReservedSizeLow, smisServiceStarted=smisServiceStarted, upgradeDownloadStarted=upgradeDownloadStarted, shareDedupEnabled=shareDedupEnabled, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, lunTable=lunTable, iscsiTargetReadIops=iscsiTargetReadIops, fcTargetWriteMbps=fcTargetWriteMbps, notificationDescription=notificationDescription, poolSizeHigh=poolSizeHigh, nicGroup=nicGroup, iscsiAvgReadLatency=iscsiAvgReadLatency, diskType=diskType, iscsiTargetWriteMbps=iscsiTargetWriteMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunWriteIops=lunWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, deleteFolderFailed=deleteFolderFailed, iscsiInitiatorGroup=iscsiInitiatorGroup, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, globalStatistics=globalStatistics, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunFreeSizeHigh=lunFreeSizeHigh, projectLUNs=projectLUNs, poolWriteCacheWriteIops=poolWriteCacheWriteIops, diskDataWriteIops=diskDataWriteIops, iscsiTargetName=iscsiTargetName, diskEntry=diskEntry, fcTargetEntry=fcTargetEntry, haResourceGroup=haResourceGroup, fcAvgReadLatency=fcAvgReadLatency, nvdimmFailDeviceError=nvdimmFailDeviceError, poolSizeLow=poolSizeLow, ipmiTemperature=ipmiTemperature, shareNFSReadLatency=shareNFSReadLatency, lunDataSizeLow=lunDataSizeLow, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, notificationSensorAction=notificationSensorAction, iscsiTargetGroupError=iscsiTargetGroupError, poolReadCacheReadIops=poolReadCacheReadIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, lunSizeHigh=lunSizeHigh, shareCIFSReadIops=shareCIFSReadIops, networkInterfaceDown=networkInterfaceDown, shareNFSWriteIops=shareNFSWriteIops, haResourceName=haResourceName, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolDataSizeLow=poolDataSizeLow, volumeQuotaFinished=volumeQuotaFinished, cacheTotalWriteIops=cacheTotalWriteIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, sharePoolName=sharePoolName, notifications=notifications, poolDegraded=poolDegraded, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, lunDedupEnabled=lunDedupEnabled, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, unknownSensorEvent=unknownSensorEvent, ipmiMemory=ipmiMemory, nvdimmFailInitializationError=nvdimmFailInitializationError, replicationSourceRegistered=replicationSourceRegistered, poolTotalWriteMbps=poolTotalWriteMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, poolUsedSizeLow=poolUsedSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskSizeHigh=diskSizeHigh, notificationReadingUnit=notificationReadingUnit, shareQuotaLow=shareQuotaLow, cacheRAMReads=cacheRAMReads, poolMetaReadIops=poolMetaReadIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolDataSizeHigh=poolDataSizeHigh, webdocsUpgradeCompleted=webdocsUpgradeCompleted, notificationComponentName=notificationComponentName, upgradeTimeout=upgradeTimeout, shareReservedSizeHigh=shareReservedSizeHigh, notificationObjects=notificationObjects, nicTransmitMbps=nicTransmitMbps, fcInitiatorEntry=fcInitiatorEntry, projectTable=projectTable, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, disks=disks, projectEntry=projectEntry, poolMetaReadMbps=poolMetaReadMbps, lunProjectName=lunProjectName, haResources=haResources, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiTargetAuth=iscsiTargetAuth, haResourceIndex=haResourceIndex, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolTotalSaving=poolTotalSaving, poolFreeSizeHigh=poolFreeSizeHigh, lunProtocol=lunProtocol, iscsiTargetReadMbps=iscsiTargetReadMbps, poolEntry=poolEntry, poolMetaWriteLatency=poolMetaWriteLatency, fcTargetWriteIops=fcTargetWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, sensorFailureEvent=sensorFailureEvent, poolMetaReadLatency=poolMetaReadLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, smisServiceStartFailed=smisServiceStartFailed, vmwareNFSDatastores=vmwareNFSDatastores, diskIOCount=diskIOCount, cifsTotalReadIops=cifsTotalReadIops, projectIndex=projectIndex, poolDeleted=poolDeleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, adServerTimeDrift=adServerTimeDrift, snmpServiceStopped=snmpServiceStopped, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, snapshotCreationFailed=snapshotCreationFailed, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, iscsiTargetsTable=iscsiTargetsTable, ipmiPowerSupply=ipmiPowerSupply, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareCIFSReadMbps=shareCIFSReadMbps, cpuInterrupts=cpuInterrupts, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, ipmiOther=ipmiOther, fcAvgWriteLatency=fcAvgWriteLatency, replicationResumed=replicationResumed, networkInterfaceUp=networkInterfaceUp, snapshotRollbackFailed=snapshotRollbackFailed, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolMetaWriteMbps=poolMetaWriteMbps, poolDataWriteIops=poolDataWriteIops, tegileGroups=tegileGroups, diskPoolName=diskPoolName, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTotalReadMbps=iscsiTotalReadMbps, lunDataSizeHigh=lunDataSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolDataReadLatency=poolDataReadLatency, shareDataSizeLow=shareDataSizeLow, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, replicationStarted=replicationStarted, shareDeleted=shareDeleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, replicationAborted=replicationAborted, currentObjectGroup=currentObjectGroup, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, diskTotalReadIops=diskTotalReadIops, haControllerB_Name=haControllerB_Name, projectDataSizeHigh=projectDataSizeHigh, maintenanceModeDisabled=maintenanceModeDisabled, lunReadMbps=lunReadMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, volumeDeleteCompleted=volumeDeleteCompleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareEntry=shareEntry, projectPoolName=projectPoolName, lunWriteMbps=lunWriteMbps, aclMigrationStarted=aclMigrationStarted, poolExpanded=poolExpanded, iscsiInitiatorsTable=iscsiInitiatorsTable, snmpAgentVersion=snmpAgentVersion, diskTotalReadMbps=diskTotalReadMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, diskError=diskError, notificationSensorSuspect=notificationSensorSuspect, haControllerB_IPAddr=haControllerB_IPAddr, poolCount=poolCount, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, nvdimmFailUnknownError=nvdimmFailUnknownError, diskCount=diskCount, fcTargetStatus=fcTargetStatus)
mibBuilder.exportSymbols("TEGILE-MIB", haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, snapshotCloningFailed=snapshotCloningFailed, poolDeletionFailed=poolDeletionFailed, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiTargets=iscsiTargets, notificationThresholdTriggerValue=notificationThresholdTriggerValue, volumeCreatedSuccessfully=volumeCreatedSuccessfully, replicationTargetDeleted=replicationTargetDeleted, projectQuotaSizeLow=projectQuotaSizeLow, controllerHardwareModel=controllerHardwareModel, diskDataWriteMbps=diskDataWriteMbps, diskDataReadMbps=diskDataReadMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, lunCompressionEnabled=lunCompressionEnabled, fcInitiatorName=fcInitiatorName, diskAvgReadLatency=diskAvgReadLatency, snmpServiceStartFailed=snmpServiceStartFailed, shareSnapshotSizeLow=shareSnapshotSizeLow, lunReadIops=lunReadIops, notificationTargetEntityName=notificationTargetEntityName, poolProjects=poolProjects, iscsiInitiators=iscsiInitiators, shareQuotaHigh=shareQuotaHigh, fcTargetReadIops=fcTargetReadIops, projectFreeSizeLow=projectFreeSizeLow, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunCompressedRatio=lunCompressedRatio, smisServiceStopFailed=smisServiceStopFailed, cacheTotalReadIops=cacheTotalReadIops, shareNFSWriteMbps=shareNFSWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, fcTotalReadIops=fcTotalReadIops, controllerUp=controllerUp, tegile=tegile, currentNotificationGroup=currentNotificationGroup, nicReceiveMbps=nicReceiveMbps, projectShares=projectShares, haResourcesTable=haResourcesTable, poolDataWriteMbps=poolDataWriteMbps, fcTargetIndex=fcTargetIndex, shareCreatedSuccessfully=shareCreatedSuccessfully, poolName=poolName, maintenanceModeEnabled=maintenanceModeEnabled, poolFreeSizeLow=poolFreeSizeLow, projectDedupEnabled=projectDedupEnabled, haControllerB_Uptime=haControllerB_Uptime, cpuSystemCalls=cpuSystemCalls, smisServiceStopped=smisServiceStopped, fcProperties=fcProperties, alertsCleanupCompleted=alertsCleanupCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolProjectCount=poolProjectCount, upgradeStarted=upgradeStarted, shareProjectName=shareProjectName, fcPortOnline=fcPortOnline, haResourceEntry=haResourceEntry, fcTotalWriteIops=fcTotalWriteIops, notificationProps=notificationProps, smbSocketFailure=smbSocketFailure, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, ipmiCurrent=ipmiCurrent, iscsiTargetAlias=iscsiTargetAlias, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, haResourceDescription=haResourceDescription, lunEntry=lunEntry, shareMountPoint=shareMountPoint, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, tdpsUpgradeFailed=tdpsUpgradeFailed, sanProperties=sanProperties, poolIndex=poolIndex, projectDeletionFailed=projectDeletionFailed, fcInitiatorIndex=fcInitiatorIndex, volumeDeleteFailed=volumeDeleteFailed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcTargetReadLatency=fcTargetReadLatency, haControllerA_Uptime=haControllerA_Uptime, iscsiTargetGroup=iscsiTargetGroup, PYSNMP_MODULE_ID=tegile, shareCIFSWriteLatency=shareCIFSWriteLatency, poolTotalReadMbps=poolTotalReadMbps, poolHealth=poolHealth, spareDiskReplaced=spareDiskReplaced, projectDeleted=projectDeleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, notificationEventCode=notificationEventCode, projectQuotaFinished=projectQuotaFinished, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, aclMigrationCompleted=aclMigrationCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, initiatorGroupMemberAdded=initiatorGroupMemberAdded, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectTotalSaving=projectTotalSaving, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, nfsAvgWriteLatency=nfsAvgWriteLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, fcInitiators=fcInitiators, diskIsOnline=diskIsOnline, ipmiThreshold=ipmiThreshold, shareName=shareName, lunSizeLow=lunSizeLow, basicCompliance=basicCompliance, cifsAvgWriteLatency=cifsAvgWriteLatency, nicIndex=nicIndex, upgradeCompleted=upgradeCompleted, cifsTotalReadMbps=cifsTotalReadMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, lunReadLatency=lunReadLatency, cacheTotalReadMbps=cacheTotalReadMbps, poolTotalReadIops=poolTotalReadIops, projectFreeSizeHigh=projectFreeSizeHigh, ipmiFan=ipmiFan, fcTargetModifyCompleted=fcTargetModifyCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, poolQuotaFinished=poolQuotaFinished, poolMetaWriteIops=poolMetaWriteIops, diskAlias=diskAlias, lunWriteLatency=lunWriteLatency, notificationSensorNumber=notificationSensorNumber, cpuTotalUsage=cpuTotalUsage, shareIndex=shareIndex, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, replicationAbandoned=replicationAbandoned, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, cacheSSDReads=cacheSSDReads, poolState=poolState, diskSlowIo=diskSlowIo, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, replicationPaused=replicationPaused, haControllerA_Name=haControllerA_Name, poolReadCacheReadLatency=poolReadCacheReadLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareNFSWriteLatency=shareNFSWriteLatency, notificationSeverity=notificationSeverity, nfsTotalReadIops=nfsTotalReadIops, poolReadCacheWriteIops=poolReadCacheWriteIops, netbiosSocketFailure=netbiosSocketFailure, fcInitiatorGroup=fcInitiatorGroup, nicMTU=nicMTU, fcTargetGroup=fcTargetGroup, targetGroupCreateCompleted=targetGroupCreateCompleted, fcTargetsTable=fcTargetsTable, shareExceedThresholdWarning=shareExceedThresholdWarning, notificationTime=notificationTime, lunPoolName=lunPoolName, shareCompressedRatio=shareCompressedRatio, snmpServiceStopFailed=snmpServiceStopFailed, lunName=lunName, cacheTotalWriteMbps=cacheTotalWriteMbps, lunBlockSize=lunBlockSize, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiInitiatorEntry=iscsiInitiatorEntry, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskGoneOffline=diskGoneOffline, tegileArray=tegileArray, iscsiTargetIndex=iscsiTargetIndex, network=network, controllerDown=controllerDown, diskState=diskState, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, upgradeFailed=upgradeFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskAvgWriteLatency=diskAvgWriteLatency, properties=properties, iscsiInitiatorName=iscsiInitiatorName, upgradeDownloadFailed=upgradeDownloadFailed, fcPortOffline=fcPortOffline, shareDataSizeHigh=shareDataSizeHigh, volumeModifyCompleted=volumeModifyCompleted, networkIpmpGroupUp=networkIpmpGroupUp, projectName=projectName, nfsTotalWriteMbps=nfsTotalWriteMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareCompressionEnabled=shareCompressionEnabled, nicState=nicState, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareCIFSWriteIops=shareCIFSWriteIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectModified=projectModified, diskTotalWriteMbps=diskTotalWriteMbps, diskTotalWriteIops=diskTotalWriteIops, diskDataReadIops=diskDataReadIops, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiTargetEntry=iscsiTargetEntry, diskRandomIOCount=diskRandomIOCount, poolUpgraded=poolUpgraded, projectDataSizeLow=projectDataSizeLow, iscsiTargetReadLatency=iscsiTargetReadLatency, nvdimmFailSoftError=nvdimmFailSoftError, userLoginFailed=userLoginFailed, diskTable=diskTable, memoryFailure=memoryFailure, nfsTotalWriteIops=nfsTotalWriteIops, nicName=nicName, haResourceStatus=haResourceStatus, iscsiTotalReadIops=iscsiTotalReadIops, fcTargetWriteLatency=fcTargetWriteLatency, lunReservedSizeHigh=lunReservedSizeHigh, nicEntry=nicEntry, projectShareCount=projectShareCount, poolExported=poolExported, iscsiProperties=iscsiProperties, fcTotalWriteMbps=fcTotalWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, poolDataReadMbps=poolDataReadMbps, projectLunCount=projectLunCount)
