...
enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, NotificationType, iso, MibIdentifier, TimeTicks, IpAddress, ModuleIdentity, Counter64, Gauge32, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "NotificationType", "iso", "MibIdentifier", "TimeTicks", "IpAddress", "ModuleIdentity", "Counter64", "Gauge32", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetIndex=fcTargetIndex, iscsiTargetGroup=iscsiTargetGroup, shareCIFSWriteMbps=shareCIFSWriteMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, diskIsOnline=diskIsOnline, networkInterfaceDown=networkInterfaceDown, nfsAvgWriteLatency=nfsAvgWriteLatency, shareQuotaFinished=shareQuotaFinished, snapshotRollbackFailed=snapshotRollbackFailed, projectQuotaFinished=projectQuotaFinished, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunCompressedRatio=lunCompressedRatio, diskSizeHigh=diskSizeHigh, tegileGroups=tegileGroups, ipmiCurrent=ipmiCurrent, properties=properties, tegileArray=tegileArray, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolDeleted=poolDeleted, poolMetaWriteLatency=poolMetaWriteLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diskRandomIOCount=diskRandomIOCount, poolMetaWriteMbps=poolMetaWriteMbps, lunDataSizeHigh=lunDataSizeHigh, fcAvgWriteLatency=fcAvgWriteLatency, notificationSensorSuspect=notificationSensorSuspect, lunSizeLow=lunSizeLow, shareIndex=shareIndex, iscsiProperties=iscsiProperties, poolSizeHigh=poolSizeHigh, deleteFolderCompleted=deleteFolderCompleted, currentNotificationGroup=currentNotificationGroup, shareCompressionEnabled=shareCompressionEnabled, nvdimmFailUnknownError=nvdimmFailUnknownError, lunIndex=lunIndex, diskDataReadMbps=diskDataReadMbps, diskError=diskError, iscsiTargetWriteMbps=iscsiTargetWriteMbps, lunEntry=lunEntry, fcTargetReadIops=fcTargetReadIops, tegile=tegile, tdpsUpgradeCompleted=tdpsUpgradeCompleted, haControllerB_Uptime=haControllerB_Uptime, lunInitiatorGroup=lunInitiatorGroup, sharePoolName=sharePoolName, fcInitiatorGroup=fcInitiatorGroup, diskTotalReadMbps=diskTotalReadMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolDataSizeHigh=poolDataSizeHigh, smisServiceStopFailed=smisServiceStopFailed, diskSizeLow=diskSizeLow, projectTable=projectTable, haControllerB_Name=haControllerB_Name, iscsiTargetName=iscsiTargetName, projectName=projectName, upgradeFailed=upgradeFailed, notificationTime=notificationTime, snapshotCloneCompleted=snapshotCloneCompleted, smbSocketFailure=smbSocketFailure, controllerTimeDrift=controllerTimeDrift, targetGroupMemberRemoved=targetGroupMemberRemoved, snapshotCreationFailed=snapshotCreationFailed, iscsiTotalReadMbps=iscsiTotalReadMbps, nicMTU=nicMTU, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolMetaReadIops=poolMetaReadIops, shareReservedSizeHigh=shareReservedSizeHigh, cpuInterrupts=cpuInterrupts, ntpServerTimeDrift=ntpServerTimeDrift, cpuSystemCalls=cpuSystemCalls, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, nicTable=nicTable, poolDataSizeLow=poolDataSizeLow, diskPoolName=diskPoolName, maintenanceModeEnabled=maintenanceModeEnabled, shareNFSReadMbps=shareNFSReadMbps, fcProperties=fcProperties, projectQuotaSizeHigh=projectQuotaSizeHigh, ipmiPowerSupply=ipmiPowerSupply, notificationReadingTriggerValue=notificationReadingTriggerValue, network=network, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareNFSWriteMbps=shareNFSWriteMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, upgradeDownloadStarted=upgradeDownloadStarted, snapshotRollbackCompleted=snapshotRollbackCompleted, diskDataWriteIops=diskDataWriteIops, snmpAgentVersion=snmpAgentVersion, cifsTotalReadMbps=cifsTotalReadMbps, basicCompliance=basicCompliance, sanProperties=sanProperties, haResourceActiveNode=haResourceActiveNode, notificationSensorAction=notificationSensorAction, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolUpgraded=poolUpgraded, projectDataSizeHigh=projectDataSizeHigh, nfsTotalReadIops=nfsTotalReadIops, poolProjectCount=poolProjectCount, projectDeleted=projectDeleted, poolDataWriteMbps=poolDataWriteMbps, haControllerB_IPAddr=haControllerB_IPAddr, fcTargets=fcTargets, lunTargetGroup=lunTargetGroup, lunTable=lunTable, shareProjectName=shareProjectName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiAvgWriteLatency=iscsiAvgWriteLatency, ipmiTemperature=ipmiTemperature, projectShares=projectShares, iscsiTargetReadMbps=iscsiTargetReadMbps, poolTotalSaving=poolTotalSaving, lunWriteLatency=lunWriteLatency, snmpServiceStarted=snmpServiceStarted, poolSizeLow=poolSizeLow, sensorFailureEvent=sensorFailureEvent, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, netbiosSocketFailure=netbiosSocketFailure, poolMetaReadMbps=poolMetaReadMbps, shareReservedSizeLow=shareReservedSizeLow, fcPortOffline=fcPortOffline, controllerUp=controllerUp, iscsiInitiators=iscsiInitiators, poolEntry=poolEntry, iscsiInitiatorsTable=iscsiInitiatorsTable, fcTargetWriteMbps=fcTargetWriteMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, adServerTimeDrift=adServerTimeDrift, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunReadMbps=lunReadMbps, haResourceIndex=haResourceIndex, volumeDeleteFailed=volumeDeleteFailed, iscsiWriteIops=iscsiWriteIops, fcPortOnline=fcPortOnline, lunProjectName=lunProjectName, projectCreatedSuccessfully=projectCreatedSuccessfully, nicState=nicState, fcInitiatorEntry=fcInitiatorEntry, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, lunName=lunName, iscsiInitiatorGroup=iscsiInitiatorGroup, notificationEventCode=notificationEventCode, fcInitiatorName=fcInitiatorName, lunCompressionEnabled=lunCompressionEnabled, diskAlias=diskAlias, replicationAborted=replicationAborted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, volumeDeleteCompleted=volumeDeleteCompleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiTargetIndex=iscsiTargetIndex, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiInitiatorChapUser=iscsiInitiatorChapUser, tdpsUpgradeFailed=tdpsUpgradeFailed, targetGroupMemberAdded=targetGroupMemberAdded, lunProtocol=lunProtocol, iscsiTargetReadLatency=iscsiTargetReadLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, tegileConformance=tegileConformance, iscsiTotalReadIops=iscsiTotalReadIops, smisServiceStarted=smisServiceStarted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, replicationComplete=replicationComplete, shareDataSizeHigh=shareDataSizeHigh, cacheTotalReadMbps=cacheTotalReadMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, shareDeleted=shareDeleted, diskTable=diskTable, lunBlockSize=lunBlockSize, diskDataReadIops=diskDataReadIops, poolHealth=poolHealth, notificationTargetEntityName=notificationTargetEntityName, cifsTotalWriteIops=cifsTotalWriteIops, lunSnapshotSizeLow=lunSnapshotSizeLow, projectPoolName=projectPoolName, testNotification=testNotification, diskAvgWriteLatency=diskAvgWriteLatency, poolUsedSizeHigh=poolUsedSizeHigh, userLoginFailed=userLoginFailed, replicationSourceRegistered=replicationSourceRegistered, fcTargetModifyCompleted=fcTargetModifyCompleted, projectModified=projectModified, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, shareDeletionFailed=shareDeletionFailed, shareCIFSWriteLatency=shareCIFSWriteLatency, fcInitiatorCreateFailed=fcInitiatorCreateFailed, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, diskTotalReadIops=diskTotalReadIops, projectCompressionEnabled=projectCompressionEnabled, projectDedupEnabled=projectDedupEnabled, haResourceName=haResourceName, pools=pools, shareSnapshotSizeLow=shareSnapshotSizeLow, poolUsedSizeLow=poolUsedSizeLow, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectDataSizeLow=projectDataSizeLow, shareEntry=shareEntry, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolQuotaFinished=poolQuotaFinished, ipmiMemory=ipmiMemory, controllerDown=controllerDown, intelliFlashSoftwareDown=intelliFlashSoftwareDown, notificationReadingUnit=notificationReadingUnit, deleteFolderFailed=deleteFolderFailed, shareNFSWriteIops=shareNFSWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, poolName=poolName, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, nfsTotalWriteMbps=nfsTotalWriteMbps, spareDiskReplaced=spareDiskReplaced, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, haControllerA_Name=haControllerA_Name, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, nicTransmitMbps=nicTransmitMbps, diskChassisIdx=diskChassisIdx, poolTotalWriteIops=poolTotalWriteIops, poolTotalReadMbps=poolTotalReadMbps, poolAvgReadLatency=poolAvgReadLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectLunCount=projectLunCount, poolProjects=poolProjects, nicReceiveMbps=nicReceiveMbps, volumeModifyCompleted=volumeModifyCompleted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcTotalReadMbps=fcTotalReadMbps, fcInitiatorIndex=fcInitiatorIndex, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, lunReservedSizeHigh=lunReservedSizeHigh, poolState=poolState, notificationSeverity=notificationSeverity, notifications=notifications, shareNFSWriteLatency=shareNFSWriteLatency, upgradeCompleted=upgradeCompleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, snmpServiceStopped=snmpServiceStopped, cpuTotalUsage=cpuTotalUsage, poolImported=poolImported, shareNFSReadLatency=shareNFSReadLatency, haResourcesTable=haResourcesTable, diskAvgReadLatency=diskAvgReadLatency, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, upgradeDownloadFailed=upgradeDownloadFailed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted)
mibBuilder.exportSymbols("TEGILE-MIB", poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, diskIndex=diskIndex, lunDedupEnabled=lunDedupEnabled, cacheTotalReadIops=cacheTotalReadIops, diskCount=diskCount, poolReadCacheReadIops=poolReadCacheReadIops, cifsAvgReadLatency=cifsAvgReadLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, cacheTotalWriteIops=cacheTotalWriteIops, shareQuotaHigh=shareQuotaHigh, haResourceDescription=haResourceDescription, networkIpmpGroupDown=networkIpmpGroupDown, fcTotalWriteIops=fcTotalWriteIops, poolExported=poolExported, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectFreeSizeLow=projectFreeSizeLow, projectDeletionFailed=projectDeletionFailed, targetGroupDeleteCompleted=targetGroupDeleteCompleted, currentObjectGroup=currentObjectGroup, nfsTotalWriteIops=nfsTotalWriteIops, notificationSensorNumber=notificationSensorNumber, diskSlowIo=diskSlowIo, fcInitiators=fcInitiators, cacheSSDReads=cacheSSDReads, lunFreeSizeLow=lunFreeSizeLow, shareName=shareName, nicGroup=nicGroup, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiTargetAuth=iscsiTargetAuth, poolDeletionFailed=poolDeletionFailed, webdocsUpgradeCompleted=webdocsUpgradeCompleted, haResourceEntry=haResourceEntry, networkTotalReceiveMbps=networkTotalReceiveMbps, haResourceGroup=haResourceGroup, fcTotalReadIops=fcTotalReadIops, lunSizeHigh=lunSizeHigh, poolDataWriteLatency=poolDataWriteLatency, fcAvgReadLatency=fcAvgReadLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, poolFreeSizeLow=poolFreeSizeLow, poolReadCacheReadLatency=poolReadCacheReadLatency, snmpServiceStartFailed=snmpServiceStartFailed, shareDataSizeLow=shareDataSizeLow, vmwareNFSDatastores=vmwareNFSDatastores, nvdimmFailSoftError=nvdimmFailSoftError, fcTargetStatus=fcTargetStatus, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, alertsCleanupCompleted=alertsCleanupCompleted, fcTargetReadLatency=fcTargetReadLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, shareCIFSReadLatency=shareCIFSReadLatency, shareTable=shareTable, ipmiVoltage=ipmiVoltage, diskGoneOffline=diskGoneOffline, fcTargetReadMbps=fcTargetReadMbps, diskState=diskState, disks=disks, upgradeStarted=upgradeStarted, shareExceedThresholdWarning=shareExceedThresholdWarning, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareNFSReadIops=shareNFSReadIops, projectLUNs=projectLUNs, replicationAbandoned=replicationAbandoned, upgradeTimeout=upgradeTimeout, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, cacheTotalWriteMbps=cacheTotalWriteMbps, fcTargetEntry=fcTargetEntry, diskIOCount=diskIOCount, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diagnosticDataUploaded=diagnosticDataUploaded, replicationResumed=replicationResumed, lunFreeSizeHigh=lunFreeSizeHigh, shareSnapshotSizeHigh=shareSnapshotSizeHigh, haResources=haResources, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, cifsTotalReadIops=cifsTotalReadIops, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, lunPoolName=lunPoolName, volumeQuotaFinished=volumeQuotaFinished, cacheRAMReads=cacheRAMReads, diskType=diskType, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectFreeSizeHigh=projectFreeSizeHigh, replicationStarted=replicationStarted, notificationComponentName=notificationComponentName, snapshotDeleteFailed=snapshotDeleteFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diskTotalWriteMbps=diskTotalWriteMbps, poolDegraded=poolDegraded, diskSequentialIOCount=diskSequentialIOCount, nvdimmFailInitializationError=nvdimmFailInitializationError, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolDataWriteIops=poolDataWriteIops, shareQuotaLow=shareQuotaLow, diskDataWriteMbps=diskDataWriteMbps, poolFreeSizeHigh=poolFreeSizeHigh, poolOwnerController=poolOwnerController, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, nfsTotalReadMbps=nfsTotalReadMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, snapshotCloningFailed=snapshotCloningFailed, fcInitiatorsTable=fcInitiatorsTable, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolTotalWriteMbps=poolTotalWriteMbps, shareCIFSReadIops=shareCIFSReadIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, projectTotalSaving=projectTotalSaving, nicIndex=nicIndex, lunWriteMbps=lunWriteMbps, notificationProps=notificationProps, haControllerA_Uptime=haControllerA_Uptime, poolExpanded=poolExpanded, shareCIFSWriteIops=shareCIFSWriteIops, iscsiTargetEntry=iscsiTargetEntry, initiatorGroupMemberAdded=initiatorGroupMemberAdded, memoryFailure=memoryFailure, shareCIFSEnabled=shareCIFSEnabled, shareDedupEnabled=shareDedupEnabled, fcTargetWriteIops=fcTargetWriteIops, controllerHardwareModel=controllerHardwareModel, poolDataReadIops=poolDataReadIops, replicationTargetDeleted=replicationTargetDeleted, replicationPaused=replicationPaused, iscsiTargetReadIops=iscsiTargetReadIops, networkInterfaceUp=networkInterfaceUp, poolReadCacheReadMbps=poolReadCacheReadMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolMetaReadLatency=poolMetaReadLatency, shareCompressedRatio=shareCompressedRatio, fcTargetWriteLatency=fcTargetWriteLatency, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, globalStatistics=globalStatistics, lunWriteIops=lunWriteIops, aclMigrationCompleted=aclMigrationCompleted, lunReadIops=lunReadIops, ipmiOther=ipmiOther, shareMountPoint=shareMountPoint, ipmiFan=ipmiFan, diskTotalWriteIops=diskTotalWriteIops, smisServiceStartFailed=smisServiceStartFailed, replicationFailed=replicationFailed, haControllerA_IPAddr=haControllerA_IPAddr, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, iscsiTargetsTable=iscsiTargetsTable, aclMigrationStarted=aclMigrationStarted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiTargetError=iscsiTargetError, notificationObjects=notificationObjects, unknownSensorEvent=unknownSensorEvent, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiTargetAlias=iscsiTargetAlias, intelliFlashSoftwareUp=intelliFlashSoftwareUp, lunReservedSizeLow=lunReservedSizeLow, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, notificationDescription=notificationDescription, lunDataSizeLow=lunDataSizeLow, haResourceStatus=haResourceStatus, PYSNMP_MODULE_ID=tegile, smisServiceStopped=smisServiceStopped, iscsiInitiatorEntry=iscsiInitiatorEntry, snmpServiceStopFailed=snmpServiceStopFailed, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolMetaWriteIops=poolMetaWriteIops, poolDataReadMbps=poolDataReadMbps, lunReadLatency=lunReadLatency, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiTargetWriteIops=iscsiTargetWriteIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectEntry=projectEntry, iscsiInitiatorName=iscsiInitiatorName, tegileCompliances=tegileCompliances, fcTargetsTable=fcTargetsTable, projectIndex=projectIndex, iscsiTargets=iscsiTargets, ipmiThreshold=ipmiThreshold, nfsAvgReadLatency=nfsAvgReadLatency, networkIpmpGroupUp=networkIpmpGroupUp, poolTotalReadIops=poolTotalReadIops, poolTable=poolTable, nicEntry=nicEntry, iscsiAvgReadLatency=iscsiAvgReadLatency, tegileArray_notifications=tegileArray_notifications, projectQuotaSizeLow=projectQuotaSizeLow, fcTotalWriteMbps=fcTotalWriteMbps, poolCount=poolCount, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, shareCIFSReadMbps=shareCIFSReadMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolIndex=poolIndex, iscsiImproperTargetGroup=iscsiImproperTargetGroup, projectThresholdExceedWarning=projectThresholdExceedWarning, fcTargetGroup=fcTargetGroup, projectShareCount=projectShareCount, poolAvgWriteLatency=poolAvgWriteLatency, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolDataReadLatency=poolDataReadLatency, lunGUID=lunGUID, upgradeDownloadCompleted=upgradeDownloadCompleted, nicName=nicName, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolCreated=poolCreated, maintenanceModeDisabled=maintenanceModeDisabled, shareNFSEnabled=shareNFSEnabled, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcTargetName=fcTargetName, diskEntry=diskEntry)
