...
enterprises, NotificationType, MibIdentifier, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Counter64, Gauge32, Bits, Counter32, TimeTicks, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "MibIdentifier", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Counter64", "Gauge32", "Bits", "Counter32", "TimeTicks", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", webdocsUpgradeFailed=webdocsUpgradeFailed, lunBlockSize=lunBlockSize, projectCreatedSuccessfully=projectCreatedSuccessfully, poolDataSizeLow=poolDataSizeLow, notificationObjects=notificationObjects, notificationReadingUnit=notificationReadingUnit, globalStatistics=globalStatistics, lunCompressedRatio=lunCompressedRatio, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskError=diskError, cifsTotalReadMbps=cifsTotalReadMbps, poolMetaWriteMbps=poolMetaWriteMbps, userLoginFailed=userLoginFailed, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, fcInitiators=fcInitiators, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetAuth=iscsiTargetAuth, shareNFSReadLatency=shareNFSReadLatency, snapshotCreationFailed=snapshotCreationFailed, nicEntry=nicEntry, haControllerB_Name=haControllerB_Name, shareReservedSizeHigh=shareReservedSizeHigh, sharePoolName=sharePoolName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolImported=poolImported, projectTotalSaving=projectTotalSaving, iscsiTargetName=iscsiTargetName, shareMountPoint=shareMountPoint, projectModified=projectModified, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, properties=properties, diskPoolName=diskPoolName, shareNFSWriteLatency=shareNFSWriteLatency, controllerDown=controllerDown, projectTable=projectTable, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, upgradeStarted=upgradeStarted, diskTotalReadMbps=diskTotalReadMbps, upgradeDownloadFailed=upgradeDownloadFailed, networkInterfaceDown=networkInterfaceDown, snmpServiceStartFailed=snmpServiceStartFailed, networkIpmpGroupUp=networkIpmpGroupUp, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, nfsAvgReadLatency=nfsAvgReadLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, poolSizeLow=poolSizeLow, nvdimmFailDeviceError=nvdimmFailDeviceError, nfsTotalWriteIops=nfsTotalWriteIops, replicationAbandoned=replicationAbandoned, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareCreatedSuccessfully=shareCreatedSuccessfully, fcTargetWriteMbps=fcTargetWriteMbps, lunEntry=lunEntry, cifsAvgWriteLatency=cifsAvgWriteLatency, maintenanceModeEnabled=maintenanceModeEnabled, poolDeletionFailed=poolDeletionFailed, shareCIFSReadLatency=shareCIFSReadLatency, poolHealth=poolHealth, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcInitiatorCreateFailed=fcInitiatorCreateFailed, PYSNMP_MODULE_ID=tegile, poolDataWriteLatency=poolDataWriteLatency, lunWriteIops=lunWriteIops, iscsiAvgReadLatency=iscsiAvgReadLatency, lunReservedSizeHigh=lunReservedSizeHigh, lunReadIops=lunReadIops, notifications=notifications, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskDataWriteIops=diskDataWriteIops, deleteFolderFailed=deleteFolderFailed, ipmiThreshold=ipmiThreshold, targetGroupCreateCompleted=targetGroupCreateCompleted, nicTransmitMbps=nicTransmitMbps, lunReadLatency=lunReadLatency, shareQuotaHigh=shareQuotaHigh, diskAvgWriteLatency=diskAvgWriteLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, diskGoneOffline=diskGoneOffline, tdpsUpgradeTimeout=tdpsUpgradeTimeout, snmpAgentVersion=snmpAgentVersion, poolExported=poolExported, poolMetaWriteIops=poolMetaWriteIops, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, iscsiTargetReadIops=iscsiTargetReadIops, snmpServiceStopFailed=snmpServiceStopFailed, vmwareNFSDatastores=vmwareNFSDatastores, ipmiMemory=ipmiMemory, poolTotalWriteIops=poolTotalWriteIops, lunTargetGroup=lunTargetGroup, controllerTimeDrift=controllerTimeDrift, adServerTimeDrift=adServerTimeDrift, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, diskIndex=diskIndex, poolReadCacheReadIops=poolReadCacheReadIops, shareDataSizeLow=shareDataSizeLow, netbiosSocketFailure=netbiosSocketFailure, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, nvdimmFailUnknownError=nvdimmFailUnknownError, fcTotalReadMbps=fcTotalReadMbps, nicName=nicName, iscsiTotalWriteMbps=iscsiTotalWriteMbps, nicGroup=nicGroup, lunDataSizeHigh=lunDataSizeHigh, lunWriteMbps=lunWriteMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, nfsTotalReadMbps=nfsTotalReadMbps, poolState=poolState, fcTargetName=fcTargetName, lunDedupEnabled=lunDedupEnabled, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareDedupEnabled=shareDedupEnabled, snmpServiceStarted=snmpServiceStarted, lunPoolName=lunPoolName, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargetGroup=iscsiTargetGroup, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, notificationComponentName=notificationComponentName, poolMetaReadLatency=poolMetaReadLatency, lunGUID=lunGUID, volumeCreatedSuccessfully=volumeCreatedSuccessfully, upgradeDownloadCompleted=upgradeDownloadCompleted, snapshotCloningFailed=snapshotCloningFailed, poolQuotaFinished=poolQuotaFinished, testNotification=testNotification, snapshotCloneCompleted=snapshotCloneCompleted, diskAvgReadLatency=diskAvgReadLatency, diagnosticDataUploaded=diagnosticDataUploaded, notificationTargetEntityName=notificationTargetEntityName, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTargetWriteIops=iscsiTargetWriteIops, shareDataSizeHigh=shareDataSizeHigh, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolUsedSizeLow=poolUsedSizeLow, iscsiTargetIndex=iscsiTargetIndex, tegileGroups=tegileGroups, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, tegileArray=tegileArray, iscsiTargetReadLatency=iscsiTargetReadLatency, diskSizeHigh=diskSizeHigh, shareDeletionFailed=shareDeletionFailed, projectDedupEnabled=projectDedupEnabled, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, currentNotificationGroup=currentNotificationGroup, fcAvgReadLatency=fcAvgReadLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, diskDataWriteMbps=diskDataWriteMbps, cifsTotalReadIops=cifsTotalReadIops, replicationStarted=replicationStarted, haResourceGroup=haResourceGroup, shareCIFSWriteLatency=shareCIFSWriteLatency, poolCount=poolCount, controllerUp=controllerUp, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolName=poolName, shareCompressionEnabled=shareCompressionEnabled, lunSizeHigh=lunSizeHigh, iscsiTargetsTable=iscsiTargetsTable, projectLunCount=projectLunCount, iscsiInitiatorIndex=iscsiInitiatorIndex, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolProjectCount=poolProjectCount, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectDeletionFailed=projectDeletionFailed, diskDataReadMbps=diskDataReadMbps, snapshotDeleteFailed=snapshotDeleteFailed, haResourceActiveNode=haResourceActiveNode, poolAvgReadLatency=poolAvgReadLatency, deleteFolderCompleted=deleteFolderCompleted, poolTable=poolTable, projectQuotaFinished=projectQuotaFinished, smbSocketFailure=smbSocketFailure, nicMTU=nicMTU, diskTotalWriteIops=diskTotalWriteIops, unknownSensorEvent=unknownSensorEvent, poolReadCacheWriteLatency=poolReadCacheWriteLatency, shareReservedSizeLow=shareReservedSizeLow, projectSnapshotSizeLow=projectSnapshotSizeLow, projectShareCount=projectShareCount, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareSnapshotSizeLow=shareSnapshotSizeLow, poolDegraded=poolDegraded, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, haControllerB_IPAddr=haControllerB_IPAddr, diskChassisIdx=diskChassisIdx, ipmiPowerSupply=ipmiPowerSupply, shareQuotaFinished=shareQuotaFinished, iscsiInitiatorChapUser=iscsiInitiatorChapUser, iscsiInitiatorGroup=iscsiInitiatorGroup, shareNFSReadIops=shareNFSReadIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcPortOnline=fcPortOnline, poolCreated=poolCreated, fcTargetStatus=fcTargetStatus, tegileArray_notifications=tegileArray_notifications, iscsiTotalReadMbps=iscsiTotalReadMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunTable=lunTable, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolFreeSizeLow=poolFreeSizeLow, iscsiTargets=iscsiTargets, notificationSensorNumber=notificationSensorNumber, lunProtocol=lunProtocol, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, nfsAvgWriteLatency=nfsAvgWriteLatency, haResources=haResources, projectThresholdExceedWarning=projectThresholdExceedWarning, alertsCleanupCompleted=alertsCleanupCompleted, replicationPaused=replicationPaused, nicTable=nicTable, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, poolOwnerController=poolOwnerController, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolUpgraded=poolUpgraded, poolSizeHigh=poolSizeHigh, shareCIFSReadIops=shareCIFSReadIops, diskIsOnline=diskIsOnline, shareCIFSWriteIops=shareCIFSWriteIops, fcInitiatorsTable=fcInitiatorsTable, haResourcesTable=haResourcesTable, upgradeDownloadStarted=upgradeDownloadStarted, tegile=tegile, poolTotalSaving=poolTotalSaving, replicationResumed=replicationResumed, sanProperties=sanProperties, diskTotalReadIops=diskTotalReadIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, diskIOCount=diskIOCount, iscsiInitiatorEntry=iscsiInitiatorEntry, poolMetaWriteLatency=poolMetaWriteLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcAvgWriteLatency=fcAvgWriteLatency, shareCIFSReadMbps=shareCIFSReadMbps, poolDataWriteMbps=poolDataWriteMbps, fcInitiatorIndex=fcInitiatorIndex, notificationProps=notificationProps, aclMigrationStarted=aclMigrationStarted, cpuTotalUsage=cpuTotalUsage, poolDataReadLatency=poolDataReadLatency, targetGroupMemberRemoved=targetGroupMemberRemoved, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskRandomIOCount=diskRandomIOCount, poolTotalReadIops=poolTotalReadIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, lunReservedSizeLow=lunReservedSizeLow, cpuInterrupts=cpuInterrupts)
mibBuilder.exportSymbols("TEGILE-MIB", projectFreeSizeHigh=projectFreeSizeHigh, iscsiInitiators=iscsiInitiators, iscsiInitiatorName=iscsiInitiatorName, lunFreeSizeHigh=lunFreeSizeHigh, nvdimmFailInitializationError=nvdimmFailInitializationError, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, replicationTargetDeleted=replicationTargetDeleted, iscsiProperties=iscsiProperties, projectIndex=projectIndex, fcPortOffline=fcPortOffline, volumeModifyCompleted=volumeModifyCompleted, haControllerB_Uptime=haControllerB_Uptime, notificationReadingTriggerValue=notificationReadingTriggerValue, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, fcProperties=fcProperties, poolDeleted=poolDeleted, smisServiceStopFailed=smisServiceStopFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, fcTargetsTable=fcTargetsTable, maintenanceModeDisabled=maintenanceModeDisabled, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareCIFSEnabled=shareCIFSEnabled, fcInitiatorGroup=fcInitiatorGroup, replicationFailed=replicationFailed, networkIpmpGroupDown=networkIpmpGroupDown, controllerHardwareModel=controllerHardwareModel, poolDataReadIops=poolDataReadIops, diskSequentialIOCount=diskSequentialIOCount, fcTotalWriteIops=fcTotalWriteIops, lunSnapshotSizeLow=lunSnapshotSizeLow, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, diskTotalWriteMbps=diskTotalWriteMbps, fcTargetIndex=fcTargetIndex, diskCount=diskCount, haControllerA_Name=haControllerA_Name, poolMetaReadMbps=poolMetaReadMbps, shareName=shareName, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, replicationComplete=replicationComplete, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, haResourceStatus=haResourceStatus, diskSizeLow=diskSizeLow, projectFreeSizeLow=projectFreeSizeLow, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTargetWriteLatency=fcTargetWriteLatency, iscsiTargetEntry=iscsiTargetEntry, fcTargetGroup=fcTargetGroup, haResourceDescription=haResourceDescription, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, nicIndex=nicIndex, lunFreeSizeLow=lunFreeSizeLow, ipmiVoltage=ipmiVoltage, cifsTotalWriteMbps=cifsTotalWriteMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareNFSWriteIops=shareNFSWriteIops, volumeDeleteCompleted=volumeDeleteCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, targetGroupMemberAdded=targetGroupMemberAdded, network=network, nicState=nicState, lunSnapshotSizeHigh=lunSnapshotSizeHigh, nvdimmFailSoftError=nvdimmFailSoftError, shareIndex=shareIndex, cifsTotalWriteIops=cifsTotalWriteIops, poolExpanded=poolExpanded, smisServiceStartFailed=smisServiceStartFailed, lunInitiatorGroup=lunInitiatorGroup, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, volumeDeleteFailed=volumeDeleteFailed, lunProjectName=lunProjectName, projectEntry=projectEntry, poolReadCacheReadMbps=poolReadCacheReadMbps, cacheTotalReadIops=cacheTotalReadIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, cifsAvgReadLatency=cifsAvgReadLatency, smisServiceStopped=smisServiceStopped, disks=disks, diskDataReadIops=diskDataReadIops, fcInitiatorEntry=fcInitiatorEntry, shareNFSEnabled=shareNFSEnabled, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolTotalReadMbps=poolTotalReadMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectName=projectName, projectQuotaSizeLow=projectQuotaSizeLow, notificationDescription=notificationDescription, poolDataReadMbps=poolDataReadMbps, shareTable=shareTable, poolDataWriteIops=poolDataWriteIops, sensorFailureEvent=sensorFailureEvent, poolUsedSizeHigh=poolUsedSizeHigh, nfsTotalReadIops=nfsTotalReadIops, poolProjects=poolProjects, fcTargetWriteIops=fcTargetWriteIops, fcTargetEntry=fcTargetEntry, replicationAborted=replicationAborted, networkInterfaceUp=networkInterfaceUp, iscsiTargetError=iscsiTargetError, tegileCompliances=tegileCompliances, diskTable=diskTable, intelliFlashSoftwareUp=intelliFlashSoftwareUp, projectPoolName=projectPoolName, shareNFSWriteMbps=shareNFSWriteMbps, diskEntry=diskEntry, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, haResourceIndex=haResourceIndex, notificationSeverity=notificationSeverity, projectLUNs=projectLUNs, ipmiCurrent=ipmiCurrent, fcTargets=fcTargets, tegileConformance=tegileConformance, smisServiceStarted=smisServiceStarted, projectShares=projectShares, notificationThresholdTriggerValue=notificationThresholdTriggerValue, currentObjectGroup=currentObjectGroup, lunWriteLatency=lunWriteLatency, upgradeFailed=upgradeFailed, poolFreeSizeHigh=poolFreeSizeHigh, volumeQuotaFinished=volumeQuotaFinished, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcTargetReadMbps=fcTargetReadMbps, notificationEventCode=notificationEventCode, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, nfsTotalWriteMbps=nfsTotalWriteMbps, poolAvgWriteLatency=poolAvgWriteLatency, projectCompressionEnabled=projectCompressionEnabled, haControllerA_IPAddr=haControllerA_IPAddr, tdpsUpgradeFailed=tdpsUpgradeFailed, diskType=diskType, poolIndex=poolIndex, iscsiWriteIops=iscsiWriteIops, shareCompressedRatio=shareCompressedRatio, poolTotalWriteMbps=poolTotalWriteMbps, notificationTime=notificationTime, fcTargetModifyCompleted=fcTargetModifyCompleted, cacheSSDReads=cacheSSDReads, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiTargetAlias=iscsiTargetAlias, snapshotRollbackFailed=snapshotRollbackFailed, networkTotalReceiveMbps=networkTotalReceiveMbps, diskSlowIo=diskSlowIo, diskState=diskState, shareProjectName=shareProjectName, diskAlias=diskAlias, lunCompressionEnabled=lunCompressionEnabled, shareQuotaLow=shareQuotaLow, projectDataSizeHigh=projectDataSizeHigh, poolEntry=poolEntry, projectDataSizeLow=projectDataSizeLow, haResourceName=haResourceName, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiTargetWriteMbps=iscsiTargetWriteMbps, upgradeCompleted=upgradeCompleted, fcTargetReadLatency=fcTargetReadLatency, shareDeleted=shareDeleted, upgradeTimeout=upgradeTimeout, fcTotalReadIops=fcTotalReadIops, ipmiTemperature=ipmiTemperature, spareDiskReplaced=spareDiskReplaced, fcTargetReadIops=fcTargetReadIops, cpuSystemCalls=cpuSystemCalls, lunName=lunName, shareExceedThresholdWarning=shareExceedThresholdWarning, lunDataSizeLow=lunDataSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolMetaReadIops=poolMetaReadIops, poolReadCacheReadLatency=poolReadCacheReadLatency, replicationSourceRegistered=replicationSourceRegistered, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, tdpsUpgradeCompleted=tdpsUpgradeCompleted, basicCompliance=basicCompliance, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiImproperTargetGroup=iscsiImproperTargetGroup, notificationSensorSuspect=notificationSensorSuspect, shareNFSReadMbps=shareNFSReadMbps, cacheRAMReads=cacheRAMReads, networkTotalTransmitMbps=networkTotalTransmitMbps, lunIndex=lunIndex, snmpServiceStopped=snmpServiceStopped, shareEntry=shareEntry, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, lunSizeLow=lunSizeLow, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcTotalWriteMbps=fcTotalWriteMbps, pools=pools, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunReadMbps=lunReadMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, notificationSensorAction=notificationSensorAction, fcInitiatorName=fcInitiatorName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, ntpServerTimeDrift=ntpServerTimeDrift, iscsiTotalReadIops=iscsiTotalReadIops, nicReceiveMbps=nicReceiveMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolDataSizeHigh=poolDataSizeHigh, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, haResourceEntry=haResourceEntry, cacheTotalWriteIops=cacheTotalWriteIops, ipmiFan=ipmiFan, ipmiOther=ipmiOther, projectDeleted=projectDeleted, haControllerA_Uptime=haControllerA_Uptime, memoryFailure=memoryFailure)
