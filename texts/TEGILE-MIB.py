...
Counter64, NotificationType, ModuleIdentity, Bits, MibIdentifier, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Gauge32, enterprises, Unsigned32, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "ModuleIdentity", "Bits", "MibIdentifier", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Gauge32", "enterprises", "Unsigned32", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcInitiators=fcInitiators, fcTargetModifyCompleted=fcTargetModifyCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, ipmiTemperature=ipmiTemperature, diskAlias=diskAlias, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareMountPoint=shareMountPoint, adServerTimeDrift=adServerTimeDrift, replicationAborted=replicationAborted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, lunCompressedRatio=lunCompressedRatio, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, cacheTotalReadIops=cacheTotalReadIops, shareName=shareName, nicIndex=nicIndex, iscsiInitiatorEntry=iscsiInitiatorEntry, tegileConformance=tegileConformance, iscsiTargetReadIops=iscsiTargetReadIops, volumeDeleteFailed=volumeDeleteFailed, fcPortOnline=fcPortOnline, nfsTotalWriteIops=nfsTotalWriteIops, projectSnapshotSizeLow=projectSnapshotSizeLow, projectFreeSizeHigh=projectFreeSizeHigh, shareEntry=shareEntry, ipmiPowerSupply=ipmiPowerSupply, shareCIFSReadLatency=shareCIFSReadLatency, currentNotificationGroup=currentNotificationGroup, snmpServiceStarted=snmpServiceStarted, iscsiTargetGroup=iscsiTargetGroup, projectQuotaSizeLow=projectQuotaSizeLow, poolReadCacheReadMbps=poolReadCacheReadMbps, snapshotDeleteFailed=snapshotDeleteFailed, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareCompressedRatio=shareCompressedRatio, nicMTU=nicMTU, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, PYSNMP_MODULE_ID=tegile, notificationProps=notificationProps, poolDataReadIops=poolDataReadIops, diskTotalReadIops=diskTotalReadIops, shareTable=shareTable, networkInterfaceUp=networkInterfaceUp, haControllerB_Uptime=haControllerB_Uptime, nfsTotalWriteMbps=nfsTotalWriteMbps, fcProperties=fcProperties, poolAvgReadLatency=poolAvgReadLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiAvgReadLatency=iscsiAvgReadLatency, haControllerA_Name=haControllerA_Name, diskIndex=diskIndex, shareDataSizeLow=shareDataSizeLow, shareDedupEnabled=shareDedupEnabled, fcTargetsTable=fcTargetsTable, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, cifsAvgReadLatency=cifsAvgReadLatency, lunReadLatency=lunReadLatency, tegileArray_notifications=tegileArray_notifications, haControllerB_Name=haControllerB_Name, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareNFSEnabled=shareNFSEnabled, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiWriteIops=iscsiWriteIops, poolMetaReadLatency=poolMetaReadLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiTargetReadMbps=iscsiTargetReadMbps, poolUsedSizeLow=poolUsedSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, diskDataWriteMbps=diskDataWriteMbps, projectCompressionEnabled=projectCompressionEnabled, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolMetaWriteMbps=poolMetaWriteMbps, lunDataSizeLow=lunDataSizeLow, iscsiTargetsTable=iscsiTargetsTable, poolDataSizeHigh=poolDataSizeHigh, networkIpmpGroupDown=networkIpmpGroupDown, replicationFailed=replicationFailed, poolProjects=poolProjects, snapshotRollbackCompleted=snapshotRollbackCompleted, cifsTotalWriteIops=cifsTotalWriteIops, lunInitiatorGroup=lunInitiatorGroup, projectIndex=projectIndex, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolSizeHigh=poolSizeHigh, lunBlockSize=lunBlockSize, replicationAbandoned=replicationAbandoned, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, testNotification=testNotification, shareDeleted=shareDeleted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, pools=pools, cpuInterrupts=cpuInterrupts, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, volumeDeleteCompleted=volumeDeleteCompleted, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolUpgraded=poolUpgraded, volumeModifyCompleted=volumeModifyCompleted, shareNFSWriteIops=shareNFSWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, shareNFSWriteLatency=shareNFSWriteLatency, diskState=diskState, ipmiFan=ipmiFan, disks=disks, iscsiProperties=iscsiProperties, cpuTotalUsage=cpuTotalUsage, haResourceStatus=haResourceStatus, lunGUID=lunGUID, volumeCreatedSuccessfully=volumeCreatedSuccessfully, cacheTotalWriteMbps=cacheTotalWriteMbps, shareCIFSEnabled=shareCIFSEnabled, shareProjectName=shareProjectName, poolDegraded=poolDegraded, shareReservedSizeLow=shareReservedSizeLow, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectDeleted=projectDeleted, fcTargetStatus=fcTargetStatus, notificationSensorNumber=notificationSensorNumber, iscsiInitiatorsTable=iscsiInitiatorsTable, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolFreeSizeLow=poolFreeSizeLow, nvdimmFailSoftError=nvdimmFailSoftError, poolState=poolState, projectFreeSizeLow=projectFreeSizeLow, fcTargetIndex=fcTargetIndex, iscsiImproperTargetGroup=iscsiImproperTargetGroup, alertsCleanupCompleted=alertsCleanupCompleted, nfsTotalReadIops=nfsTotalReadIops, poolHealth=poolHealth, fcTargetReadMbps=fcTargetReadMbps, nicTransmitMbps=nicTransmitMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, shareQuotaHigh=shareQuotaHigh, poolDataWriteIops=poolDataWriteIops, poolDataWriteLatency=poolDataWriteLatency, replicationResumed=replicationResumed, snmpServiceStopFailed=snmpServiceStopFailed, diskGoneOffline=diskGoneOffline, basicCompliance=basicCompliance, poolName=poolName, lunWriteLatency=lunWriteLatency, lunName=lunName, ntpServerTimeDrift=ntpServerTimeDrift, diskSizeHigh=diskSizeHigh, poolTotalWriteIops=poolTotalWriteIops, replicationStarted=replicationStarted, tegileGroups=tegileGroups, iscsiTargetWriteLatency=iscsiTargetWriteLatency, unknownSensorEvent=unknownSensorEvent, ipmiVoltage=ipmiVoltage, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, notificationSeverity=notificationSeverity, nicState=nicState, poolFreeSizeHigh=poolFreeSizeHigh, projectDeletionFailed=projectDeletionFailed, projectShares=projectShares, volumeQuotaFinished=volumeQuotaFinished, notificationComponentName=notificationComponentName, smisServiceStarted=smisServiceStarted, snapshotCloningFailed=snapshotCloningFailed, haControllerA_Uptime=haControllerA_Uptime, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiTargetIndex=iscsiTargetIndex, diskTotalReadMbps=diskTotalReadMbps, lunDedupEnabled=lunDedupEnabled, upgradeDownloadStarted=upgradeDownloadStarted, lunProtocol=lunProtocol, diskTotalWriteIops=diskTotalWriteIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, shareQuotaFinished=shareQuotaFinished, controllerTimeDrift=controllerTimeDrift, diskIsOnline=diskIsOnline, fcTargetName=fcTargetName, poolExpanded=poolExpanded, snapshotCreationFailed=snapshotCreationFailed, poolCreated=poolCreated, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, projectLUNs=projectLUNs, fcTargetReadLatency=fcTargetReadLatency, poolMetaWriteLatency=poolMetaWriteLatency, shareNFSReadLatency=shareNFSReadLatency, iscsiTargetError=iscsiTargetError, memoryFailure=memoryFailure, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, cifsTotalReadMbps=cifsTotalReadMbps, projectTotalSaving=projectTotalSaving, iscsiTargets=iscsiTargets, vmwareNFSDatastores=vmwareNFSDatastores, fcTargetWriteMbps=fcTargetWriteMbps, haControllerA_IPAddr=haControllerA_IPAddr, lunReadMbps=lunReadMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, projectLunCount=projectLunCount, lunReservedSizeLow=lunReservedSizeLow, diskEntry=diskEntry, projectDataSizeLow=projectDataSizeLow, poolMetaReadMbps=poolMetaReadMbps, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareCreatedSuccessfully=shareCreatedSuccessfully, fcTargetReadIops=fcTargetReadIops, projectTable=projectTable, notificationTargetEntityName=notificationTargetEntityName, notificationReadingUnit=notificationReadingUnit, cifsTotalWriteMbps=cifsTotalWriteMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiInitiators=iscsiInitiators, fcTargetGroup=fcTargetGroup, deleteFolderCompleted=deleteFolderCompleted, diskSizeLow=diskSizeLow, diskDataReadIops=diskDataReadIops, sensorFailureEvent=sensorFailureEvent, notificationSensorAction=notificationSensorAction, fcInitiatorName=fcInitiatorName, haResourceActiveNode=haResourceActiveNode, lunIndex=lunIndex, shareNFSWriteMbps=shareNFSWriteMbps, upgradeCompleted=upgradeCompleted, poolTotalWriteMbps=poolTotalWriteMbps, diskAvgWriteLatency=diskAvgWriteLatency, nicReceiveMbps=nicReceiveMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, smisServiceStartFailed=smisServiceStartFailed, haResourceName=haResourceName, nicGroup=nicGroup, iscsiTotalReadMbps=iscsiTotalReadMbps, replicationPaused=replicationPaused, iscsiTargetAlias=iscsiTargetAlias, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, diskSequentialIOCount=diskSequentialIOCount, diskSlowIo=diskSlowIo, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, cacheTotalWriteIops=cacheTotalWriteIops, poolAvgWriteLatency=poolAvgWriteLatency, poolTotalReadIops=poolTotalReadIops, fcTotalReadIops=fcTotalReadIops, lunTable=lunTable, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, snapshotRollbackFailed=snapshotRollbackFailed, poolCount=poolCount, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted)
mibBuilder.exportSymbols("TEGILE-MIB", tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunWriteIops=lunWriteIops, fcTotalReadMbps=fcTotalReadMbps, lunSizeHigh=lunSizeHigh, properties=properties, lunProjectName=lunProjectName, shareCIFSWriteLatency=shareCIFSWriteLatency, projectDedupEnabled=projectDedupEnabled, poolReadCacheWriteIops=poolReadCacheWriteIops, networkTotalTransmitMbps=networkTotalTransmitMbps, ipmiThreshold=ipmiThreshold, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, ipmiMemory=ipmiMemory, lunFreeSizeLow=lunFreeSizeLow, iscsiTargetName=iscsiTargetName, smisServiceStopFailed=smisServiceStopFailed, poolReadCacheReadLatency=poolReadCacheReadLatency, tegile=tegile, lunSizeLow=lunSizeLow, shareIndex=shareIndex, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiTargetEntry=iscsiTargetEntry, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, lunFreeSizeHigh=lunFreeSizeHigh, shareCIFSWriteIops=shareCIFSWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolDeletionFailed=poolDeletionFailed, projectEntry=projectEntry, replicationTargetDeleted=replicationTargetDeleted, shareQuotaLow=shareQuotaLow, haResourcesTable=haResourcesTable, globalStatistics=globalStatistics, maintenanceModeEnabled=maintenanceModeEnabled, smbSocketFailure=smbSocketFailure, networkIpmpGroupUp=networkIpmpGroupUp, poolImported=poolImported, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcInitiatorIndex=fcInitiatorIndex, iscsiTargetGroupError=iscsiTargetGroupError, upgradeDownloadFailed=upgradeDownloadFailed, shareNFSReadMbps=shareNFSReadMbps, lunReservedSizeHigh=lunReservedSizeHigh, lunReadIops=lunReadIops, shareCIFSReadMbps=shareCIFSReadMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, userLoginFailed=userLoginFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolMetaWriteIops=poolMetaWriteIops, shareReservedSizeHigh=shareReservedSizeHigh, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, smisServiceStopped=smisServiceStopped, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, tegileCompliances=tegileCompliances, poolQuotaFinished=poolQuotaFinished, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiTargetAuth=iscsiTargetAuth, diskTable=diskTable, poolOwnerController=poolOwnerController, iscsiInitiatorIndex=iscsiInitiatorIndex, diagnosticDataUploaded=diagnosticDataUploaded, iscsiTargetWriteMbps=iscsiTargetWriteMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcAvgReadLatency=fcAvgReadLatency, projectShareCount=projectShareCount, haResources=haResources, controllerHardwareModel=controllerHardwareModel, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolDataSizeLow=poolDataSizeLow, lunTargetGroup=lunTargetGroup, controllerUp=controllerUp, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, haControllerB_IPAddr=haControllerB_IPAddr, diskDataReadMbps=diskDataReadMbps, cacheRAMReads=cacheRAMReads, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolReadCacheWriteLatency=poolReadCacheWriteLatency, nfsAvgReadLatency=nfsAvgReadLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, projectName=projectName, snapshotCloneCompleted=snapshotCloneCompleted, diskRandomIOCount=diskRandomIOCount, projectQuotaSizeHigh=projectQuotaSizeHigh, snmpAgentVersion=snmpAgentVersion, netbiosSocketFailure=netbiosSocketFailure, poolUsedSizeHigh=poolUsedSizeHigh, upgradeStarted=upgradeStarted, diskDataWriteIops=diskDataWriteIops, fcAvgWriteLatency=fcAvgWriteLatency, poolDeleted=poolDeleted, poolTotalReadMbps=poolTotalReadMbps, fcTotalWriteIops=fcTotalWriteIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, shareDeletionFailed=shareDeletionFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, tegileArray=tegileArray, diskIOCount=diskIOCount, lunEntry=lunEntry, fcTargets=fcTargets, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskCount=diskCount, cacheSSDReads=cacheSSDReads, notificationTime=notificationTime, aclMigrationCompleted=aclMigrationCompleted, shareNFSReadIops=shareNFSReadIops, poolSizeLow=poolSizeLow, fcTargetEntry=fcTargetEntry, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, nicTable=nicTable, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, diskError=diskError, snmpServiceStopped=snmpServiceStopped, iscsiTotalWriteMbps=iscsiTotalWriteMbps, network=network, lunDataSizeHigh=lunDataSizeHigh, poolIndex=poolIndex, nvdimmFailUnknownError=nvdimmFailUnknownError, aclMigrationStarted=aclMigrationStarted, nvdimmFailDeviceError=nvdimmFailDeviceError, nvdimmFailInitializationError=nvdimmFailInitializationError, iscsiInitiatorName=iscsiInitiatorName, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolDataReadLatency=poolDataReadLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, maintenanceModeDisabled=maintenanceModeDisabled, cifsTotalReadIops=cifsTotalReadIops, shareDataSizeHigh=shareDataSizeHigh, haResourceEntry=haResourceEntry, lunPoolName=lunPoolName, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectQuotaFinished=projectQuotaFinished, poolEntry=poolEntry, webdocsUpgradeCompleted=webdocsUpgradeCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, nicEntry=nicEntry, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, sanProperties=sanProperties, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, fcInitiatorEntry=fcInitiatorEntry, controllerDown=controllerDown, poolTable=poolTable, upgradeTimeout=upgradeTimeout, webdocsUpgradeFailed=webdocsUpgradeFailed, poolMetaReadIops=poolMetaReadIops, haResourceGroup=haResourceGroup, poolDataReadMbps=poolDataReadMbps, notificationObjects=notificationObjects, projectModified=projectModified, diskChassisIdx=diskChassisIdx, iscsiInitiatorGroup=iscsiInitiatorGroup, sharePoolName=sharePoolName, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, currentObjectGroup=currentObjectGroup, projectDataSizeHigh=projectDataSizeHigh, fcTargetWriteIops=fcTargetWriteIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcInitiatorGroup=fcInitiatorGroup, notificationDescription=notificationDescription, targetGroupCreateCompleted=targetGroupCreateCompleted, poolExported=poolExported, poolProjectCount=poolProjectCount, spareDiskReplaced=spareDiskReplaced, diskAvgReadLatency=diskAvgReadLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, fcTargetWriteLatency=fcTargetWriteLatency, poolDataWriteMbps=poolDataWriteMbps, notifications=notifications, ipmiCriticalInterrupt=ipmiCriticalInterrupt, ipmiOther=ipmiOther, fcInitiatorsTable=fcInitiatorsTable, shareCompressionEnabled=shareCompressionEnabled, diskPoolName=diskPoolName, lunCompressionEnabled=lunCompressionEnabled, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, nfsTotalReadMbps=nfsTotalReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, cpuSystemCalls=cpuSystemCalls, upgradeFailed=upgradeFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, poolReadCacheReadIops=poolReadCacheReadIops, fcPortOffline=fcPortOffline, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, replicationComplete=replicationComplete, networkInterfaceDown=networkInterfaceDown, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, snmpServiceStartFailed=snmpServiceStartFailed, lunWriteMbps=lunWriteMbps, nicName=nicName, projectPoolName=projectPoolName, notificationEventCode=notificationEventCode, targetGroupMemberAdded=targetGroupMemberAdded, shareCIFSReadIops=shareCIFSReadIops, deleteFolderFailed=deleteFolderFailed, ipmiCurrent=ipmiCurrent, upgradeDownloadCompleted=upgradeDownloadCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, replicationSourceRegistered=replicationSourceRegistered, diskTotalWriteMbps=diskTotalWriteMbps, cacheTotalReadMbps=cacheTotalReadMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, haResourceIndex=haResourceIndex, iscsiTotalReadIops=iscsiTotalReadIops, diskType=diskType, notificationSensorSuspect=notificationSensorSuspect, haResourceDescription=haResourceDescription)
