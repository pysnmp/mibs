...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Bits, TimeTicks, IpAddress, ModuleIdentity, Counter64, ObjectIdentity, Unsigned32, Gauge32, Integer32, enterprises, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Bits", "TimeTicks", "IpAddress", "ModuleIdentity", "Counter64", "ObjectIdentity", "Unsigned32", "Gauge32", "Integer32", "enterprises", "iso", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolMetaReadMbps=poolMetaReadMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolTotalWriteMbps=poolTotalWriteMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolDataSizeLow=poolDataSizeLow, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, network=network, cifsTotalWriteMbps=cifsTotalWriteMbps, smisServiceStartFailed=smisServiceStartFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, haResources=haResources, shareEntry=shareEntry, poolWriteCacheWriteIops=poolWriteCacheWriteIops, lunWriteMbps=lunWriteMbps, poolTotalReadMbps=poolTotalReadMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiTotalWriteMbps=iscsiTotalWriteMbps, volumeQuotaFinished=volumeQuotaFinished, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, controllerHardwareModel=controllerHardwareModel, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, notificationObjects=notificationObjects, shareCIFSWriteMbps=shareCIFSWriteMbps, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, iscsiTargetReadMbps=iscsiTargetReadMbps, poolFreeSizeHigh=poolFreeSizeHigh, ipmiTemperature=ipmiTemperature, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, replicationFailed=replicationFailed, diskChassisIdx=diskChassisIdx, cacheSSDReads=cacheSSDReads, lunFreeSizeHigh=lunFreeSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, ntpServerTimeDrift=ntpServerTimeDrift, lunProjectName=lunProjectName, targetGroupMemberAdded=targetGroupMemberAdded, cacheRAMReads=cacheRAMReads, poolIndex=poolIndex, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, notificationEventCode=notificationEventCode, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareDeleted=shareDeleted, lunReadIops=lunReadIops, lunEntry=lunEntry, diskSlowIo=diskSlowIo, networkInterfaceDown=networkInterfaceDown, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, deleteFolderFailed=deleteFolderFailed, smisServiceStarted=smisServiceStarted, notificationReadingUnit=notificationReadingUnit, lunDedupEnabled=lunDedupEnabled, fcTargetIndex=fcTargetIndex, lunSnapshotSizeLow=lunSnapshotSizeLow, diskAlias=diskAlias, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunIndex=lunIndex, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, diskSizeLow=diskSizeLow, diskIndex=diskIndex, fcTargetStatus=fcTargetStatus, replicationTargetDeleted=replicationTargetDeleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, nfsAvgReadLatency=nfsAvgReadLatency, snmpServiceStopped=snmpServiceStopped, diskTotalWriteIops=diskTotalWriteIops, currentObjectGroup=currentObjectGroup, fcInitiatorCreateFailed=fcInitiatorCreateFailed, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, tegileGroups=tegileGroups, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, shareCreatedSuccessfully=shareCreatedSuccessfully, snapshotCloneCompleted=snapshotCloneCompleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, notificationReadingTriggerValue=notificationReadingTriggerValue, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolMetaWriteMbps=poolMetaWriteMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, spareDiskReplaced=spareDiskReplaced, snapshotCreationFailed=snapshotCreationFailed, shareNFSReadLatency=shareNFSReadLatency, properties=properties, poolProjects=poolProjects, notificationSensorNumber=notificationSensorNumber, deleteFolderCompleted=deleteFolderCompleted, projectModified=projectModified, fcPortOffline=fcPortOffline, shareSnapshotSizeLow=shareSnapshotSizeLow, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectIndex=projectIndex, diskError=diskError, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry, poolReadCacheWriteMbps=poolReadCacheWriteMbps, globalStatistics=globalStatistics, fcInitiatorEntry=fcInitiatorEntry, iscsiTotalReadIops=iscsiTotalReadIops, fcInitiatorGroup=fcInitiatorGroup, poolMetaWriteIops=poolMetaWriteIops, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiInitiatorIndex=iscsiInitiatorIndex, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcTargetReadLatency=fcTargetReadLatency, tdpsUpgradeFailed=tdpsUpgradeFailed, tegileArray_notifications=tegileArray_notifications, notificationTargetEntityName=notificationTargetEntityName, iscsiTargetEntry=iscsiTargetEntry, diskDataReadMbps=diskDataReadMbps, lunCompressedRatio=lunCompressedRatio, shareProjectName=shareProjectName, poolDataWriteMbps=poolDataWriteMbps, shareTable=shareTable, lunWriteIops=lunWriteIops, shareCIFSReadMbps=shareCIFSReadMbps, nicTransmitMbps=nicTransmitMbps, poolHealth=poolHealth, snapshotCloningFailed=snapshotCloningFailed, ipmiVoltage=ipmiVoltage, nfsTotalReadIops=nfsTotalReadIops, fcInitiatorName=fcInitiatorName, networkInterfaceUp=networkInterfaceUp, poolMetaReadLatency=poolMetaReadLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, upgradeCompleted=upgradeCompleted, lunGUID=lunGUID, poolUpgraded=poolUpgraded, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, sanProperties=sanProperties, snapshotDeleteFailed=snapshotDeleteFailed, ipmiCurrent=ipmiCurrent, cifsTotalReadMbps=cifsTotalReadMbps, notifications=notifications, shareDeletionFailed=shareDeletionFailed, projectDeleted=projectDeleted, targetGroupMemberRemoved=targetGroupMemberRemoved, aclMigrationStarted=aclMigrationStarted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, sharePoolName=sharePoolName, shareCompressedRatio=shareCompressedRatio, memoryFailure=memoryFailure, poolExpanded=poolExpanded, iscsiAvgReadLatency=iscsiAvgReadLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, diskIsOnline=diskIsOnline, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiTargetsTable=iscsiTargetsTable, upgradeFailed=upgradeFailed, haResourceDescription=haResourceDescription, haResourceGroup=haResourceGroup, shareCIFSReadIops=shareCIFSReadIops, snmpAgentVersion=snmpAgentVersion, projectName=projectName, nicEntry=nicEntry, sensorFailureEvent=sensorFailureEvent, iscsiTargets=iscsiTargets, fcTargetGroup=fcTargetGroup, ipmiThreshold=ipmiThreshold, lunDataSizeHigh=lunDataSizeHigh, diskPoolName=diskPoolName, cacheTotalWriteIops=cacheTotalWriteIops, lunInitiatorGroup=lunInitiatorGroup, shareCIFSWriteLatency=shareCIFSWriteLatency, shareReservedSizeLow=shareReservedSizeLow, poolDataReadLatency=poolDataReadLatency, diskTotalReadIops=diskTotalReadIops, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, poolFreeSizeLow=poolFreeSizeLow, iscsiTotalReadMbps=iscsiTotalReadMbps, fcTargetsTable=fcTargetsTable, poolExported=poolExported, poolImported=poolImported, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, networkIpmpGroupDown=networkIpmpGroupDown, snapshotRollbackCompleted=snapshotRollbackCompleted, poolTotalWriteIops=poolTotalWriteIops, iscsiTargetName=iscsiTargetName, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, tegileConformance=tegileConformance, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolMetaReadIops=poolMetaReadIops, haControllerA_Uptime=haControllerA_Uptime, haResourceActiveNode=haResourceActiveNode, nicTable=nicTable, diskTotalReadMbps=diskTotalReadMbps, diskIOCount=diskIOCount, replicationPaused=replicationPaused, shareQuotaLow=shareQuotaLow, haResourcesTable=haResourcesTable, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, projectDataSizeHigh=projectDataSizeHigh, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolTable=poolTable, nicIndex=nicIndex, fcInitiatorIndex=fcInitiatorIndex, shareMountPoint=shareMountPoint, shareReservedSizeHigh=shareReservedSizeHigh, ipmiOther=ipmiOther, cpuSystemCalls=cpuSystemCalls, shareNFSWriteMbps=shareNFSWriteMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolSizeLow=poolSizeLow, iscsiTargetReadLatency=iscsiTargetReadLatency, userLoginFailed=userLoginFailed, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectShares=projectShares, poolDataWriteLatency=poolDataWriteLatency, alertsCleanupCompleted=alertsCleanupCompleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolName=poolName, shareDataSizeLow=shareDataSizeLow, aclMigrationCompleted=aclMigrationCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, fcProperties=fcProperties, fcTargets=fcTargets, tegileCompliances=tegileCompliances, fcTargetReadMbps=fcTargetReadMbps, controllerUp=controllerUp, vmwareNFSDatastores=vmwareNFSDatastores, poolTotalReadIops=poolTotalReadIops, adServerTimeDrift=adServerTimeDrift, haResourceStatus=haResourceStatus, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolTotalSaving=poolTotalSaving, notificationProps=notificationProps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, ipmiPowerSupply=ipmiPowerSupply, nfsTotalWriteMbps=nfsTotalWriteMbps, poolMetaWriteLatency=poolMetaWriteLatency, poolDataWriteIops=poolDataWriteIops, diskSizeHigh=diskSizeHigh, lunSizeHigh=lunSizeHigh, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, projectCompressionEnabled=projectCompressionEnabled, replicationSourceRegistered=replicationSourceRegistered, smisServiceStopFailed=smisServiceStopFailed, notificationDescription=notificationDescription, notificationSensorSuspect=notificationSensorSuspect, initiatorGroupMemberAdded=initiatorGroupMemberAdded)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiProperties=iscsiProperties, fcInitiators=fcInitiators, networkTotalTransmitMbps=networkTotalTransmitMbps, projectDedupEnabled=projectDedupEnabled, lunReadLatency=lunReadLatency, shareIndex=shareIndex, volumeDeleteFailed=volumeDeleteFailed, ipmiMemory=ipmiMemory, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, maintenanceModeDisabled=maintenanceModeDisabled, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, smisServiceStopped=smisServiceStopped, volumeDeleteCompleted=volumeDeleteCompleted, nicReceiveMbps=nicReceiveMbps, projectQuotaSizeLow=projectQuotaSizeLow, tdpsUpgradeTimeout=tdpsUpgradeTimeout, diskGoneOffline=diskGoneOffline, shareDataSizeHigh=shareDataSizeHigh, shareCompressionEnabled=shareCompressionEnabled, shareNFSWriteIops=shareNFSWriteIops, lunBlockSize=lunBlockSize, diskCount=diskCount, poolCreated=poolCreated, fcTargetName=fcTargetName, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiTargetWriteMbps=iscsiTargetWriteMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolDataSizeHigh=poolDataSizeHigh, iscsiTargetError=iscsiTargetError, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, replicationComplete=replicationComplete, poolCount=poolCount, haResourceName=haResourceName, lunReservedSizeHigh=lunReservedSizeHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcPortOnline=fcPortOnline, diskDataReadIops=diskDataReadIops, projectFreeSizeHigh=projectFreeSizeHigh, snmpServiceStarted=snmpServiceStarted, poolQuotaFinished=poolQuotaFinished, currentNotificationGroup=currentNotificationGroup, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectCreatedSuccessfully=projectCreatedSuccessfully, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, diskDataWriteIops=diskDataWriteIops, projectQuotaSizeHigh=projectQuotaSizeHigh, fcInitiatorsTable=fcInitiatorsTable, ipmiFan=ipmiFan, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiTargetAlias=iscsiTargetAlias, testNotification=testNotification, shareNFSEnabled=shareNFSEnabled, notificationTime=notificationTime, iscsiAvgWriteLatency=iscsiAvgWriteLatency, notificationComponentName=notificationComponentName, nfsAvgWriteLatency=nfsAvgWriteLatency, lunProtocol=lunProtocol, networkIpmpGroupUp=networkIpmpGroupUp, nfsTotalWriteIops=nfsTotalWriteIops, controllerDown=controllerDown, nvdimmFailSoftError=nvdimmFailSoftError, projectTotalSaving=projectTotalSaving, iscsiTargetGroup=iscsiTargetGroup, volumeCreatedSuccessfully=volumeCreatedSuccessfully, cifsTotalWriteIops=cifsTotalWriteIops, upgradeDownloadStarted=upgradeDownloadStarted, lunFreeSizeLow=lunFreeSizeLow, volumeModifyCompleted=volumeModifyCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunTable=lunTable, diskRandomIOCount=diskRandomIOCount, projectLUNs=projectLUNs, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiTargetGroupError=iscsiTargetGroupError, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, tegileArray=tegileArray, lunCompressionEnabled=lunCompressionEnabled, shareCIFSReadLatency=shareCIFSReadLatency, cifsAvgReadLatency=cifsAvgReadLatency, diagnosticDataUploaded=diagnosticDataUploaded, fcAvgReadLatency=fcAvgReadLatency, poolAvgReadLatency=poolAvgReadLatency, cacheTotalReadIops=cacheTotalReadIops, shareNFSReadMbps=shareNFSReadMbps, haResourceEntry=haResourceEntry, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, haControllerA_Name=haControllerA_Name, fcTargetReadIops=fcTargetReadIops, poolReadCacheReadLatency=poolReadCacheReadLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, shareQuotaFinished=shareQuotaFinished, poolSizeHigh=poolSizeHigh, poolEntry=poolEntry, lunPoolName=lunPoolName, iscsiWriteIops=iscsiWriteIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, unknownSensorEvent=unknownSensorEvent, shareCIFSEnabled=shareCIFSEnabled, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareNFSReadIops=shareNFSReadIops, poolDeleted=poolDeleted, iscsiInitiators=iscsiInitiators, nvdimmFailInitializationError=nvdimmFailInitializationError, iscsiTargetReadIops=iscsiTargetReadIops, diskEntry=diskEntry, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diskSequentialIOCount=diskSequentialIOCount, maintenanceModeEnabled=maintenanceModeEnabled, lunReadMbps=lunReadMbps, projectQuotaFinished=projectQuotaFinished, shareQuotaHigh=shareQuotaHigh, diskType=diskType, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolReadCacheReadIops=poolReadCacheReadIops, projectDeletionFailed=projectDeletionFailed, diskTable=diskTable, diskState=diskState, fcTotalWriteMbps=fcTotalWriteMbps, projectLunCount=projectLunCount, poolDegraded=poolDegraded, webdocsUpgradeCompleted=webdocsUpgradeCompleted, nfsTotalReadMbps=nfsTotalReadMbps, fcTargetWriteIops=fcTargetWriteIops, snmpServiceStartFailed=snmpServiceStartFailed, fcTargetEntry=fcTargetEntry, fcTargetWriteMbps=fcTargetWriteMbps, controllerTimeDrift=controllerTimeDrift, haResourceIndex=haResourceIndex, projectEntry=projectEntry, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, snmpServiceStopFailed=snmpServiceStopFailed, diskAvgReadLatency=diskAvgReadLatency, projectShareCount=projectShareCount, poolUsedSizeHigh=poolUsedSizeHigh, haControllerB_Name=haControllerB_Name, PYSNMP_MODULE_ID=tegile, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, snapshotRollbackFailed=snapshotRollbackFailed, nicState=nicState, disks=disks, lunSizeLow=lunSizeLow, replicationAborted=replicationAborted, projectSnapshotSizeLow=projectSnapshotSizeLow, basicCompliance=basicCompliance, tegile=tegile, smbSocketFailure=smbSocketFailure, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiTargetIndex=iscsiTargetIndex, diskTotalWriteMbps=diskTotalWriteMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, cacheTotalReadMbps=cacheTotalReadMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, cifsTotalReadIops=cifsTotalReadIops, projectPoolName=projectPoolName, projectDataSizeLow=projectDataSizeLow, haControllerB_Uptime=haControllerB_Uptime, diskAvgWriteLatency=diskAvgWriteLatency, lunWriteLatency=lunWriteLatency, replicationStarted=replicationStarted, shareCIFSWriteIops=shareCIFSWriteIops, fcTotalWriteIops=fcTotalWriteIops, poolDeletionFailed=poolDeletionFailed, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, haControllerB_IPAddr=haControllerB_IPAddr, lunReservedSizeLow=lunReservedSizeLow, replicationAbandoned=replicationAbandoned, networkTotalReceiveMbps=networkTotalReceiveMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, haControllerA_IPAddr=haControllerA_IPAddr, poolDataReadMbps=poolDataReadMbps, notificationSensorAction=notificationSensorAction, upgradeStarted=upgradeStarted, poolOwnerController=poolOwnerController, projectTable=projectTable, iscsiInitiatorName=iscsiInitiatorName, poolProjectCount=poolProjectCount, poolUsedSizeLow=poolUsedSizeLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, cpuInterrupts=cpuInterrupts, shareNFSWriteLatency=shareNFSWriteLatency, diskDataWriteMbps=diskDataWriteMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, nicMTU=nicMTU, cpuTotalUsage=cpuTotalUsage, netbiosSocketFailure=netbiosSocketFailure, poolState=poolState, nicGroup=nicGroup, upgradeTimeout=upgradeTimeout, lunDataSizeLow=lunDataSizeLow, projectFreeSizeLow=projectFreeSizeLow, replicationResumed=replicationResumed, lunTargetGroup=lunTargetGroup, fcTargetModifyCompleted=fcTargetModifyCompleted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcTotalReadMbps=fcTotalReadMbps, shareName=shareName, fcAvgWriteLatency=fcAvgWriteLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, nicName=nicName, pools=pools, lunName=lunName, shareDedupEnabled=shareDedupEnabled, poolDataReadIops=poolDataReadIops, poolAvgWriteLatency=poolAvgWriteLatency, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiTargetAuth=iscsiTargetAuth, fcTargetWriteLatency=fcTargetWriteLatency, notificationSeverity=notificationSeverity, fcTotalReadIops=fcTotalReadIops)
