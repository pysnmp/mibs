...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Integer32, Gauge32, IpAddress, Counter32, iso, Counter64, NotificationType, enterprises, ObjectIdentity, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Integer32", "Gauge32", "IpAddress", "Counter32", "iso", "Counter64", "NotificationType", "enterprises", "ObjectIdentity", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("TEGILE-MIB", snmpServiceStartFailed=snmpServiceStartFailed, upgradeTimeout=upgradeTimeout, diskAlias=diskAlias, lunPoolName=lunPoolName, projectEntry=projectEntry, poolCreated=poolCreated, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectThresholdExceedWarning=projectThresholdExceedWarning, nicIndex=nicIndex, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, upgradeDownloadFailed=upgradeDownloadFailed, diskTotalWriteMbps=diskTotalWriteMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiTargetGroupError=iscsiTargetGroupError, upgradeFailed=upgradeFailed, smisServiceStartFailed=smisServiceStartFailed, fcTargetEntry=fcTargetEntry, shareSnapshotSizeLow=shareSnapshotSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, tegileCompliances=tegileCompliances, notificationComponentName=notificationComponentName, replicationStarted=replicationStarted, sensorFailureEvent=sensorFailureEvent, nfsTotalReadIops=nfsTotalReadIops, tegile=tegile, lunCompressionEnabled=lunCompressionEnabled, fcTargetStatus=fcTargetStatus, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolSizeLow=poolSizeLow, projectLUNs=projectLUNs, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareQuotaFinished=shareQuotaFinished, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolName=poolName, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareDedupEnabled=shareDedupEnabled, nvdimmFailInitializationError=nvdimmFailInitializationError, poolMetaWriteMbps=poolMetaWriteMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiProperties=iscsiProperties, shareName=shareName, iscsiWriteIops=iscsiWriteIops, snmpAgentVersion=snmpAgentVersion, poolTotalWriteIops=poolTotalWriteIops, diskSizeLow=diskSizeLow, iscsiAvgReadLatency=iscsiAvgReadLatency, snapshotCloneCompleted=snapshotCloneCompleted, upgradeDownloadStarted=upgradeDownloadStarted, lunReservedSizeHigh=lunReservedSizeHigh, fcTargetModifyCompleted=fcTargetModifyCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, diskRandomIOCount=diskRandomIOCount, smisServiceStopFailed=smisServiceStopFailed, poolImported=poolImported, projectFreeSizeLow=projectFreeSizeLow, diskDataReadIops=diskDataReadIops, poolIndex=poolIndex, controllerHardwareModel=controllerHardwareModel, maintenanceModeEnabled=maintenanceModeEnabled, lunName=lunName, poolCount=poolCount, tdpsUpgradeFailed=tdpsUpgradeFailed, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, diskAvgWriteLatency=diskAvgWriteLatency, lunSizeHigh=lunSizeHigh, poolProjects=poolProjects, iscsiTargetName=iscsiTargetName, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolDegraded=poolDegraded, iscsiTotalReadMbps=iscsiTotalReadMbps, lunFreeSizeHigh=lunFreeSizeHigh, cpuTotalUsage=cpuTotalUsage, poolDeletionFailed=poolDeletionFailed, network=network, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, diskIsOnline=diskIsOnline, haControllerA_IPAddr=haControllerA_IPAddr, poolFreeSizeLow=poolFreeSizeLow, fcInitiatorIndex=fcInitiatorIndex, projectTable=projectTable, nfsTotalWriteMbps=nfsTotalWriteMbps, tegileArray=tegileArray, lunReadLatency=lunReadLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, userLoginFailed=userLoginFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunBlockSize=lunBlockSize, projectIndex=projectIndex, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolAvgWriteLatency=poolAvgWriteLatency, shareNFSWriteMbps=shareNFSWriteMbps, projectDeleted=projectDeleted, smbSocketFailure=smbSocketFailure, shareCIFSReadIops=shareCIFSReadIops, diskTable=diskTable, notificationSensorAction=notificationSensorAction, iscsiTargetWriteLatency=iscsiTargetWriteLatency, notifications=notifications, shareNFSWriteIops=shareNFSWriteIops, poolDataWriteIops=poolDataWriteIops, notificationReadingTriggerValue=notificationReadingTriggerValue, cifsAvgReadLatency=cifsAvgReadLatency, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareProjectName=shareProjectName, fcTargetWriteLatency=fcTargetWriteLatency, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcTotalReadMbps=fcTotalReadMbps, vmwareNFSDatastores=vmwareNFSDatastores, volumeDeleteFailed=volumeDeleteFailed, pools=pools, networkTotalReceiveMbps=networkTotalReceiveMbps, notificationSeverity=notificationSeverity, volumeQuotaFinished=volumeQuotaFinished, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcInitiatorCreateFailed=fcInitiatorCreateFailed, unknownSensorEvent=unknownSensorEvent, lunWriteLatency=lunWriteLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, deleteFolderCompleted=deleteFolderCompleted, haResourceDescription=haResourceDescription, volumeDeleteCompleted=volumeDeleteCompleted, fcTargetsTable=fcTargetsTable, poolState=poolState, projectModified=projectModified, cifsTotalReadIops=cifsTotalReadIops, poolDataReadLatency=poolDataReadLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, ipmiVoltage=ipmiVoltage, poolUsedSizeLow=poolUsedSizeLow, lunGUID=lunGUID, PYSNMP_MODULE_ID=tegile, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareCIFSReadMbps=shareCIFSReadMbps, nfsTotalReadMbps=nfsTotalReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, notificationProps=notificationProps, cpuInterrupts=cpuInterrupts, sanProperties=sanProperties, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcTargetWriteMbps=fcTargetWriteMbps, shareNFSWriteLatency=shareNFSWriteLatency, nicMTU=nicMTU, fcPortOffline=fcPortOffline, diskTotalReadMbps=diskTotalReadMbps, nicTransmitMbps=nicTransmitMbps, replicationAbandoned=replicationAbandoned, haResourceActiveNode=haResourceActiveNode, fcTotalWriteMbps=fcTotalWriteMbps, snmpServiceStarted=snmpServiceStarted, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, haResourceIndex=haResourceIndex, diskGoneOffline=diskGoneOffline, cacheTotalWriteMbps=cacheTotalWriteMbps, diskCount=diskCount, poolTable=poolTable, networkIpmpGroupUp=networkIpmpGroupUp, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectFreeSizeHigh=projectFreeSizeHigh, notificationTargetEntityName=notificationTargetEntityName, replicationFailed=replicationFailed, projectName=projectName, fcTargetName=fcTargetName, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, sharePoolName=sharePoolName, nicTable=nicTable, poolTotalWriteMbps=poolTotalWriteMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolAvgReadLatency=poolAvgReadLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, lunTable=lunTable, tegileConformance=tegileConformance, replicationSourceRegistered=replicationSourceRegistered, poolMetaReadLatency=poolMetaReadLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, fcTotalReadIops=fcTotalReadIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiTargetReadIops=iscsiTargetReadIops, fcTargetReadIops=fcTargetReadIops, targetGroupMemberAdded=targetGroupMemberAdded, lunFreeSizeLow=lunFreeSizeLow, lunSizeLow=lunSizeLow, fcProperties=fcProperties, networkInterfaceDown=networkInterfaceDown, nvdimmFailDeviceError=nvdimmFailDeviceError, poolMetaReadMbps=poolMetaReadMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, spareDiskReplaced=spareDiskReplaced, netbiosSocketFailure=netbiosSocketFailure, shareDeletionFailed=shareDeletionFailed, projectDataSizeLow=projectDataSizeLow, fcInitiatorEntry=fcInitiatorEntry, iscsiInitiatorsTable=iscsiInitiatorsTable, iscsiTargetsTable=iscsiTargetsTable, ipmiTemperature=ipmiTemperature, fcTargetWriteIops=fcTargetWriteIops, iscsiTargetAlias=iscsiTargetAlias, poolReadCacheReadIops=poolReadCacheReadIops, iscsiInitiatorIndex=iscsiInitiatorIndex, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, properties=properties, projectShares=projectShares, networkInterfaceUp=networkInterfaceUp, cifsTotalWriteIops=cifsTotalWriteIops, nvdimmFailSoftError=nvdimmFailSoftError, cacheRAMReads=cacheRAMReads, diskSequentialIOCount=diskSequentialIOCount, memoryFailure=memoryFailure, diskEntry=diskEntry, poolOwnerController=poolOwnerController, replicationComplete=replicationComplete, diskSlowIo=diskSlowIo, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolDataSizeLow=poolDataSizeLow, lunInitiatorGroup=lunInitiatorGroup, poolUsedSizeHigh=poolUsedSizeHigh, iscsiInitiatorEntry=iscsiInitiatorEntry, snapshotDeleteFailed=snapshotDeleteFailed, cpuSystemCalls=cpuSystemCalls, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, replicationResumed=replicationResumed, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, lunReadIops=lunReadIops, diskDataWriteMbps=diskDataWriteMbps, haResourceStatus=haResourceStatus, adServerTimeDrift=adServerTimeDrift, shareReservedSizeHigh=shareReservedSizeHigh, fcTargetReadMbps=fcTargetReadMbps, volumeModifyCompleted=volumeModifyCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, volumeCreatedSuccessfully=volumeCreatedSuccessfully, upgradeCompleted=upgradeCompleted, diskSizeHigh=diskSizeHigh, diskTotalReadIops=diskTotalReadIops, shareNFSReadMbps=shareNFSReadMbps, shareNFSReadIops=shareNFSReadIops, lunDataSizeLow=lunDataSizeLow, ntpServerTimeDrift=ntpServerTimeDrift, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, diskPoolName=diskPoolName, disks=disks, diskIndex=diskIndex, poolDataWriteLatency=poolDataWriteLatency, lunIndex=lunIndex, shareQuotaHigh=shareQuotaHigh)
mibBuilder.exportSymbols("TEGILE-MIB", lunCompressedRatio=lunCompressedRatio, fcTargets=fcTargets, poolTotalSaving=poolTotalSaving, diskTotalWriteIops=diskTotalWriteIops, poolMetaReadIops=poolMetaReadIops, projectQuotaFinished=projectQuotaFinished, fcTargetIndex=fcTargetIndex, poolDataReadIops=poolDataReadIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, controllerTimeDrift=controllerTimeDrift, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, fcTargetReadLatency=fcTargetReadLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, fcInitiatorName=fcInitiatorName, projectQuotaSizeLow=projectQuotaSizeLow, shareCIFSWriteLatency=shareCIFSWriteLatency, projectLunCount=projectLunCount, cifsTotalWriteMbps=cifsTotalWriteMbps, smisServiceStopped=smisServiceStopped, fcPortOnline=fcPortOnline, lunWriteIops=lunWriteIops, iscsiTargetError=iscsiTargetError, diskChassisIdx=diskChassisIdx, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, notificationSensorSuspect=notificationSensorSuspect, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, cifsTotalReadMbps=cifsTotalReadMbps, shareQuotaLow=shareQuotaLow, notificationEventCode=notificationEventCode, globalStatistics=globalStatistics, ipmiMemory=ipmiMemory, nicReceiveMbps=nicReceiveMbps, tegileArray_notifications=tegileArray_notifications, fcAvgWriteLatency=fcAvgWriteLatency, aclMigrationStarted=aclMigrationStarted, poolTotalReadIops=poolTotalReadIops, projectTotalSaving=projectTotalSaving, shareCIFSWriteIops=shareCIFSWriteIops, diskError=diskError, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, nvdimmFailUnknownError=nvdimmFailUnknownError, tdpsUpgradeCompleted=tdpsUpgradeCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, nicState=nicState, projectCompressionEnabled=projectCompressionEnabled, diskType=diskType, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskState=diskState, lunReservedSizeLow=lunReservedSizeLow, networkIpmpGroupDown=networkIpmpGroupDown, snapshotRollbackFailed=snapshotRollbackFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, snmpServiceStopFailed=snmpServiceStopFailed, snmpServiceStopped=snmpServiceStopped, poolUpgraded=poolUpgraded, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, fcAvgReadLatency=fcAvgReadLatency, haResourceGroup=haResourceGroup, webdocsUpgradeFailed=webdocsUpgradeFailed, nicGroup=nicGroup, iscsiTargetGroup=iscsiTargetGroup, cacheTotalWriteIops=cacheTotalWriteIops, cacheTotalReadMbps=cacheTotalReadMbps, projectDeletionFailed=projectDeletionFailed, projectSnapshotSizeHigh=projectSnapshotSizeHigh, maintenanceModeDisabled=maintenanceModeDisabled, iscsiInitiatorGroup=iscsiInitiatorGroup, shareMountPoint=shareMountPoint, diskDataReadMbps=diskDataReadMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, nicEntry=nicEntry, iscsiTargetEntry=iscsiTargetEntry, intelliFlashSoftwareUp=intelliFlashSoftwareUp, replicationPaused=replicationPaused, poolEntry=poolEntry, poolFreeSizeHigh=poolFreeSizeHigh, notificationObjects=notificationObjects, iscsiTargets=iscsiTargets, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcTargetGroup=fcTargetGroup, shareDataSizeLow=shareDataSizeLow, ipmiCurrent=ipmiCurrent, iscsiInitiators=iscsiInitiators, lunReadMbps=lunReadMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, shareNFSEnabled=shareNFSEnabled, haResourcesTable=haResourcesTable, notificationReadingUnit=notificationReadingUnit, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, replicationTargetDeleted=replicationTargetDeleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, lunDedupEnabled=lunDedupEnabled, poolDataSizeHigh=poolDataSizeHigh, poolSizeHigh=poolSizeHigh, poolExpanded=poolExpanded, upgradeDownloadCompleted=upgradeDownloadCompleted, snapshotCloningFailed=snapshotCloningFailed, iscsiTotalReadIops=iscsiTotalReadIops, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, controllerDown=controllerDown, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareEntry=shareEntry, shareReservedSizeLow=shareReservedSizeLow, diskIOCount=diskIOCount, tegileGroups=tegileGroups, lunEntry=lunEntry, poolMetaWriteIops=poolMetaWriteIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, haResourceName=haResourceName, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, aclMigrationCompleted=aclMigrationCompleted, fcInitiatorsTable=fcInitiatorsTable, ipmiPowerSupply=ipmiPowerSupply, lunTargetGroup=lunTargetGroup, nfsAvgReadLatency=nfsAvgReadLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcInitiators=fcInitiators, haControllerB_IPAddr=haControllerB_IPAddr, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, lunWriteMbps=lunWriteMbps, currentNotificationGroup=currentNotificationGroup, shareDataSizeHigh=shareDataSizeHigh, diagnosticDataUploaded=diagnosticDataUploaded, basicCompliance=basicCompliance, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, diskAvgReadLatency=diskAvgReadLatency, upgradeStarted=upgradeStarted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, shareCIFSEnabled=shareCIFSEnabled, poolHealth=poolHealth, poolTotalReadMbps=poolTotalReadMbps, projectPoolName=projectPoolName, iscsiTargetWriteIops=iscsiTargetWriteIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareDeleted=shareDeleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, smisServiceStarted=smisServiceStarted, ipmiOther=ipmiOther, iscsiInitiatorName=iscsiInitiatorName, cacheSSDReads=cacheSSDReads, nfsAvgWriteLatency=nfsAvgWriteLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, haControllerB_Uptime=haControllerB_Uptime, shareCIFSReadLatency=shareCIFSReadLatency, fcTotalWriteIops=fcTotalWriteIops, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, poolMetaWriteLatency=poolMetaWriteLatency, ipmiThreshold=ipmiThreshold, shareTable=shareTable, shareCompressedRatio=shareCompressedRatio, networkTotalTransmitMbps=networkTotalTransmitMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunDataSizeHigh=lunDataSizeHigh, poolExported=poolExported, poolQuotaFinished=poolQuotaFinished, targetGroupMemberRemoved=targetGroupMemberRemoved, poolReadCacheWriteLatency=poolReadCacheWriteLatency, notificationTime=notificationTime, cacheTotalReadIops=cacheTotalReadIops, haControllerA_Uptime=haControllerA_Uptime, shareIndex=shareIndex, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, iscsiTargetAuth=iscsiTargetAuth, lunSnapshotSizeLow=lunSnapshotSizeLow, projectDataSizeHigh=projectDataSizeHigh, alertsCleanupCompleted=alertsCleanupCompleted, haControllerA_Name=haControllerA_Name, projectShareCount=projectShareCount, haResourceEntry=haResourceEntry, notificationDescription=notificationDescription, testNotification=testNotification, poolProjectCount=poolProjectCount, targetGroupDeleteCompleted=targetGroupDeleteCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolDataReadMbps=poolDataReadMbps, notificationSensorNumber=notificationSensorNumber, iscsiTargetWriteMbps=iscsiTargetWriteMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, lunProjectName=lunProjectName, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareCompressionEnabled=shareCompressionEnabled, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, nicName=nicName, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, haResources=haResources, controllerUp=controllerUp, deleteFolderFailed=deleteFolderFailed, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolDeleted=poolDeleted, haControllerB_Name=haControllerB_Name, nfsTotalWriteIops=nfsTotalWriteIops, ipmiFan=ipmiFan, poolDataWriteMbps=poolDataWriteMbps, replicationAborted=replicationAborted, diskDataWriteIops=diskDataWriteIops, projectDedupEnabled=projectDedupEnabled, lunProtocol=lunProtocol, iscsiInitiatorChapUser=iscsiInitiatorChapUser, snapshotCreationFailed=snapshotCreationFailed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareNFSReadLatency=shareNFSReadLatency, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated)
