...
IpAddress, ObjectIdentity, ModuleIdentity, TimeTicks, Unsigned32, iso, Counter64, enterprises, Gauge32, MibIdentifier, Bits, Integer32, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Unsigned32", "iso", "Counter64", "enterprises", "Gauge32", "MibIdentifier", "Bits", "Integer32", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TEGILE-MIB", projectSnapshotSizeLow=projectSnapshotSizeLow, projectDedupEnabled=projectDedupEnabled, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, projectEntry=projectEntry, fcTargetReadIops=fcTargetReadIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, smbSocketFailure=smbSocketFailure, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, snmpServiceStarted=snmpServiceStarted, networkTotalReceiveMbps=networkTotalReceiveMbps, diskDataReadIops=diskDataReadIops, projectQuotaFinished=projectQuotaFinished, shareDataSizeLow=shareDataSizeLow, projectPoolName=projectPoolName, poolDataSizeHigh=poolDataSizeHigh, globalStatistics=globalStatistics, lunCompressedRatio=lunCompressedRatio, diskError=diskError, diskTable=diskTable, targetGroupCreateCompleted=targetGroupCreateCompleted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolDataReadIops=poolDataReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, deleteFolderFailed=deleteFolderFailed, diskSlowIo=diskSlowIo, haControllerA_IPAddr=haControllerA_IPAddr, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiTargetIndex=iscsiTargetIndex, currentObjectGroup=currentObjectGroup, notificationReadingUnit=notificationReadingUnit, haResourceIndex=haResourceIndex, nfsAvgWriteLatency=nfsAvgWriteLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareReservedSizeLow=shareReservedSizeLow, poolReadCacheReadMbps=poolReadCacheReadMbps, diskDataWriteIops=diskDataWriteIops, notificationTime=notificationTime, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, replicationPaused=replicationPaused, poolDataWriteMbps=poolDataWriteMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, volumeQuotaFinished=volumeQuotaFinished, pools=pools, controllerTimeDrift=controllerTimeDrift, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiAvgReadLatency=iscsiAvgReadLatency, poolUsedSizeHigh=poolUsedSizeHigh, smisServiceStopFailed=smisServiceStopFailed, diskRandomIOCount=diskRandomIOCount, iscsiTargetAlias=iscsiTargetAlias, haControllerB_Uptime=haControllerB_Uptime, nicName=nicName, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, diskTotalWriteMbps=diskTotalWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, shareName=shareName, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, replicationAbandoned=replicationAbandoned, haControllerB_Name=haControllerB_Name, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcTargetIndex=fcTargetIndex, projectDataSizeLow=projectDataSizeLow, shareQuotaFinished=shareQuotaFinished, userLoginFailed=userLoginFailed, diskDataWriteMbps=diskDataWriteMbps, poolTotalWriteMbps=poolTotalWriteMbps, shareCIFSReadLatency=shareCIFSReadLatency, snmpServiceStopFailed=snmpServiceStopFailed, diskEntry=diskEntry, diskTotalReadIops=diskTotalReadIops, smisServiceStartFailed=smisServiceStartFailed, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcInitiatorCreateFailed=fcInitiatorCreateFailed, maintenanceModeEnabled=maintenanceModeEnabled, nfsAvgReadLatency=nfsAvgReadLatency, cacheTotalReadIops=cacheTotalReadIops, adServerTimeDrift=adServerTimeDrift, shareNFSWriteMbps=shareNFSWriteMbps, lunTable=lunTable, ntpServerTimeDrift=ntpServerTimeDrift, diskTotalReadMbps=diskTotalReadMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, targetGroupMemberAdded=targetGroupMemberAdded, poolDataReadMbps=poolDataReadMbps, iscsiProperties=iscsiProperties, aclMigrationCompleted=aclMigrationCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, shareExceedThresholdWarning=shareExceedThresholdWarning, fcTargetName=fcTargetName, snapshotRollbackCompleted=snapshotRollbackCompleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, diskState=diskState, aclMigrationStarted=aclMigrationStarted, poolUsedSizeLow=poolUsedSizeLow, iscsiInitiatorName=iscsiInitiatorName, basicCompliance=basicCompliance, controllerUp=controllerUp, poolName=poolName, controllerHardwareModel=controllerHardwareModel, maintenanceModeDisabled=maintenanceModeDisabled, projectLunCount=projectLunCount, fcInitiatorName=fcInitiatorName, diskChassisIdx=diskChassisIdx, iscsiTargets=iscsiTargets, vmwareNFSDatastores=vmwareNFSDatastores, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, snmpAgentVersion=snmpAgentVersion, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetReadLatency=fcTargetReadLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectDataSizeHigh=projectDataSizeHigh, replicationAborted=replicationAborted, poolMetaReadMbps=poolMetaReadMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, cacheTotalWriteIops=cacheTotalWriteIops, fcTargetGroup=fcTargetGroup, iscsiTargetWriteLatency=iscsiTargetWriteLatency, lunGUID=lunGUID, iscsiInitiatorGroup=iscsiInitiatorGroup, ipmiOther=ipmiOther, nfsTotalReadMbps=nfsTotalReadMbps, iscsiTargetAuth=iscsiTargetAuth, projectTable=projectTable, tegileConformance=tegileConformance, shareReservedSizeHigh=shareReservedSizeHigh, fcAvgWriteLatency=fcAvgWriteLatency, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diskGoneOffline=diskGoneOffline, cifsTotalReadIops=cifsTotalReadIops, projectThresholdExceedWarning=projectThresholdExceedWarning, nicReceiveMbps=nicReceiveMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, volumeDeleteFailed=volumeDeleteFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, notificationSensorAction=notificationSensorAction, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, sharePoolName=sharePoolName, cifsAvgReadLatency=cifsAvgReadLatency, cifsTotalReadMbps=cifsTotalReadMbps, poolHealth=poolHealth, lunProjectName=lunProjectName, notificationDescription=notificationDescription, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, nfsTotalWriteMbps=nfsTotalWriteMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcInitiatorIndex=fcInitiatorIndex, lunReservedSizeLow=lunReservedSizeLow, replicationTargetDeleted=replicationTargetDeleted, shareCompressionEnabled=shareCompressionEnabled, diskIOCount=diskIOCount, poolDataReadLatency=poolDataReadLatency, poolQuotaFinished=poolQuotaFinished, nfsTotalReadIops=nfsTotalReadIops, poolEntry=poolEntry, iscsiTargetGroup=iscsiTargetGroup, fcTargetWriteLatency=fcTargetWriteLatency, poolMetaReadLatency=poolMetaReadLatency, fcTotalWriteIops=fcTotalWriteIops, notificationSensorSuspect=notificationSensorSuspect, poolImported=poolImported, ipmiMemory=ipmiMemory, snapshotCreationFailed=snapshotCreationFailed, shareCompressedRatio=shareCompressedRatio, poolAvgWriteLatency=poolAvgWriteLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, ipmiCriticalInterrupt=ipmiCriticalInterrupt, lunInitiatorGroup=lunInitiatorGroup, nicEntry=nicEntry, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiInitiatorsTable=iscsiInitiatorsTable, nvdimmFailDeviceError=nvdimmFailDeviceError, fcTargetEntry=fcTargetEntry, shareDeleted=shareDeleted, fcTargetReadMbps=fcTargetReadMbps, lunDataSizeLow=lunDataSizeLow, projectName=projectName, snapshotCloningFailed=snapshotCloningFailed, upgradeDownloadFailed=upgradeDownloadFailed, tegileCompliances=tegileCompliances, notificationTargetEntityName=notificationTargetEntityName, haControllerA_Uptime=haControllerA_Uptime, nicIndex=nicIndex, poolDataWriteLatency=poolDataWriteLatency, diskType=diskType, shareNFSEnabled=shareNFSEnabled, lunSizeHigh=lunSizeHigh, currentNotificationGroup=currentNotificationGroup, projectShares=projectShares, upgradeStarted=upgradeStarted, nvdimmFailInitializationError=nvdimmFailInitializationError, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcTargetModifyCompleted=fcTargetModifyCompleted, haResourceGroup=haResourceGroup, intelliFlashSoftwareDown=intelliFlashSoftwareDown, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunReadIops=lunReadIops, upgradeDownloadCompleted=upgradeDownloadCompleted, fcInitiatorEntry=fcInitiatorEntry, networkIpmpGroupDown=networkIpmpGroupDown, lunBlockSize=lunBlockSize, smisServiceStopped=smisServiceStopped, deleteFolderCompleted=deleteFolderCompleted, iscsiInitiatorIndex=iscsiInitiatorIndex, nicTable=nicTable, disks=disks, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectQuotaSizeLow=projectQuotaSizeLow, diskSequentialIOCount=diskSequentialIOCount, tegile=tegile, notificationSeverity=notificationSeverity, iscsiTotalReadIops=iscsiTotalReadIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiTargetReadIops=iscsiTargetReadIops, alertsCleanupCompleted=alertsCleanupCompleted, poolIndex=poolIndex, shareCIFSWriteLatency=shareCIFSWriteLatency, notificationProps=notificationProps, shareDataSizeHigh=shareDataSizeHigh, haResources=haResources, controllerDown=controllerDown, poolUpgraded=poolUpgraded, replicationComplete=replicationComplete, fcProperties=fcProperties, fcTargetStatus=fcTargetStatus, nvdimmFailSoftError=nvdimmFailSoftError, haResourceName=haResourceName, poolMetaWriteIops=poolMetaWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiTargetName=iscsiTargetName, lunPoolName=lunPoolName, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, cacheSSDReads=cacheSSDReads, lunSizeLow=lunSizeLow, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, testNotification=testNotification, iscsiTotalWriteMbps=iscsiTotalWriteMbps, cpuSystemCalls=cpuSystemCalls, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcAvgReadLatency=fcAvgReadLatency, poolTotalSaving=poolTotalSaving)
mibBuilder.exportSymbols("TEGILE-MIB", nicGroup=nicGroup, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiTargetReadLatency=iscsiTargetReadLatency, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, lunDataSizeHigh=lunDataSizeHigh, poolMetaWriteMbps=poolMetaWriteMbps, poolMetaWriteLatency=poolMetaWriteLatency, spareDiskReplaced=spareDiskReplaced, iscsiImproperTargetGroup=iscsiImproperTargetGroup, ipmiVoltage=ipmiVoltage, fcInitiatorGroup=fcInitiatorGroup, shareNFSWriteIops=shareNFSWriteIops, cacheTotalWriteMbps=cacheTotalWriteMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, projectShareCount=projectShareCount, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcTotalWriteMbps=fcTotalWriteMbps, haResourceEntry=haResourceEntry, poolDegraded=poolDegraded, shareCreatedSuccessfully=shareCreatedSuccessfully, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, fcInitiators=fcInitiators, unknownSensorEvent=unknownSensorEvent, lunDedupEnabled=lunDedupEnabled, diskTotalWriteIops=diskTotalWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, fcTargetsTable=fcTargetsTable, nicTransmitMbps=nicTransmitMbps, poolCount=poolCount, lunFreeSizeLow=lunFreeSizeLow, poolState=poolState, lunReadMbps=lunReadMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, sensorFailureEvent=sensorFailureEvent, cpuInterrupts=cpuInterrupts, lunFreeSizeHigh=lunFreeSizeHigh, notificationComponentName=notificationComponentName, projectLUNs=projectLUNs, diskCount=diskCount, lunReadLatency=lunReadLatency, shareTable=shareTable, upgradeFailed=upgradeFailed, poolTotalWriteIops=poolTotalWriteIops, haResourcesTable=haResourcesTable, PYSNMP_MODULE_ID=tegile, netbiosSocketFailure=netbiosSocketFailure, poolExpanded=poolExpanded, iscsiTargetError=iscsiTargetError, projectIndex=projectIndex, diskDataReadMbps=diskDataReadMbps, projectFreeSizeLow=projectFreeSizeLow, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, properties=properties, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, shareProjectName=shareProjectName, ipmiPowerSupply=ipmiPowerSupply, fcTotalReadMbps=fcTotalReadMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareNFSReadIops=shareNFSReadIops, volumeDeleteCompleted=volumeDeleteCompleted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolSizeLow=poolSizeLow, ipmiCurrent=ipmiCurrent, poolProjectCount=poolProjectCount, iscsiTargetWriteMbps=iscsiTargetWriteMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, volumeModifyCompleted=volumeModifyCompleted, projectCompressionEnabled=projectCompressionEnabled, tegileArray=tegileArray, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, cpuTotalUsage=cpuTotalUsage, notifications=notifications, networkIpmpGroupUp=networkIpmpGroupUp, ipmiFan=ipmiFan, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, nfsTotalWriteIops=nfsTotalWriteIops, fcInitiatorsTable=fcInitiatorsTable, iscsiWriteIops=iscsiWriteIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolFreeSizeHigh=poolFreeSizeHigh, lunWriteLatency=lunWriteLatency, poolProjects=poolProjects, diskSizeLow=diskSizeLow, lunName=lunName, notificationEventCode=notificationEventCode, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolSizeHigh=poolSizeHigh, lunTargetGroup=lunTargetGroup, projectModified=projectModified, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, replicationResumed=replicationResumed, snmpServiceStopped=snmpServiceStopped, memoryFailure=memoryFailure, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, cacheTotalReadMbps=cacheTotalReadMbps, diskPoolName=diskPoolName, lunProtocol=lunProtocol, projectDeletionFailed=projectDeletionFailed, ipmiTemperature=ipmiTemperature, networkInterfaceDown=networkInterfaceDown, poolTotalReadMbps=poolTotalReadMbps, shareNFSWriteLatency=shareNFSWriteLatency, shareQuotaHigh=shareQuotaHigh, nicMTU=nicMTU, tegileGroups=tegileGroups, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, ipmiThreshold=ipmiThreshold, shareCIFSEnabled=shareCIFSEnabled, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareQuotaLow=shareQuotaLow, replicationFailed=replicationFailed, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, shareDedupEnabled=shareDedupEnabled, fcTargetWriteIops=fcTargetWriteIops, poolCreated=poolCreated, upgradeDownloadStarted=upgradeDownloadStarted, poolTotalReadIops=poolTotalReadIops, poolMetaReadIops=poolMetaReadIops, cacheRAMReads=cacheRAMReads, nicState=nicState, fcTotalReadIops=fcTotalReadIops, shareMountPoint=shareMountPoint, diskAvgWriteLatency=diskAvgWriteLatency, iscsiInitiators=iscsiInitiators, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareCIFSReadMbps=shareCIFSReadMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcTargetWriteMbps=fcTargetWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, upgradeCompleted=upgradeCompleted, shareNFSReadLatency=shareNFSReadLatency, shareNFSReadMbps=shareNFSReadMbps, projectFreeSizeHigh=projectFreeSizeHigh, poolFreeSizeLow=poolFreeSizeLow, projectTotalSaving=projectTotalSaving, shareCIFSWriteIops=shareCIFSWriteIops, iscsiTotalReadMbps=iscsiTotalReadMbps, haControllerA_Name=haControllerA_Name, poolAvgReadLatency=poolAvgReadLatency, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareIndex=shareIndex, poolDeleted=poolDeleted, projectDeleted=projectDeleted, haResourceActiveNode=haResourceActiveNode, iscsiTargetEntry=iscsiTargetEntry, diskAlias=diskAlias, iscsiTargetWriteIops=iscsiTargetWriteIops, replicationSourceRegistered=replicationSourceRegistered, diskSizeHigh=diskSizeHigh, shareCIFSReadIops=shareCIFSReadIops, iscsiTargetsTable=iscsiTargetsTable, diagnosticDataUploaded=diagnosticDataUploaded, tdpsUpgradeFailed=tdpsUpgradeFailed, sanProperties=sanProperties, poolWriteCacheWriteIops=poolWriteCacheWriteIops, haResourceStatus=haResourceStatus, lunCompressionEnabled=lunCompressionEnabled, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, snapshotCloneCompleted=snapshotCloneCompleted, haResourceDescription=haResourceDescription, notificationObjects=notificationObjects, snapshotRollbackFailed=snapshotRollbackFailed, poolOwnerController=poolOwnerController, lunIndex=lunIndex, snmpServiceStartFailed=snmpServiceStartFailed, fcPortOffline=fcPortOffline, diskAvgReadLatency=diskAvgReadLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, haControllerB_IPAddr=haControllerB_IPAddr, poolExported=poolExported, snapshotDeleteFailed=snapshotDeleteFailed, targetGroupMemberRemoved=targetGroupMemberRemoved, lunWriteMbps=lunWriteMbps, network=network, poolTable=poolTable, replicationStarted=replicationStarted, networkInterfaceUp=networkInterfaceUp, lunSnapshotSizeLow=lunSnapshotSizeLow, intelliFlashSoftwareUp=intelliFlashSoftwareUp, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, diskIndex=diskIndex, shareEntry=shareEntry, iscsiTargetReadMbps=iscsiTargetReadMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, smisServiceStarted=smisServiceStarted, shareDeletionFailed=shareDeletionFailed, lunReservedSizeHigh=lunReservedSizeHigh, lunWriteIops=lunWriteIops, fcPortOnline=fcPortOnline, tegileArray_notifications=tegileArray_notifications, poolDeletionFailed=poolDeletionFailed, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunEntry=lunEntry, upgradeTimeout=upgradeTimeout, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolDataWriteIops=poolDataWriteIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcTargets=fcTargets, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolDataSizeLow=poolDataSizeLow, diskIsOnline=diskIsOnline)
