...
Unsigned32, MibIdentifier, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Counter64, ObjectIdentity, NotificationType, Integer32, IpAddress, ModuleIdentity, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Counter64", "ObjectIdentity", "NotificationType", "Integer32", "IpAddress", "ModuleIdentity", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolFreeSizeLow=poolFreeSizeLow, iscsiTargetWriteIops=iscsiTargetWriteIops, poolDataWriteMbps=poolDataWriteMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, ipmiMemory=ipmiMemory, poolCreated=poolCreated, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolQuotaFinished=poolQuotaFinished, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, tdpsUpgradeFailed=tdpsUpgradeFailed, projectIndex=projectIndex, projectLUNs=projectLUNs, targetGroupCreateCompleted=targetGroupCreateCompleted, replicationResumed=replicationResumed, cifsAvgReadLatency=cifsAvgReadLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, controllerTimeDrift=controllerTimeDrift, shareProjectName=shareProjectName, fcTargetReadMbps=fcTargetReadMbps, lunDataSizeLow=lunDataSizeLow, shareDeleted=shareDeleted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, aclMigrationStarted=aclMigrationStarted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectDataSizeHigh=projectDataSizeHigh, shareNFSEnabled=shareNFSEnabled, poolFreeSizeHigh=poolFreeSizeHigh, projectQuotaFinished=projectQuotaFinished, userLoginFailed=userLoginFailed, iscsiInitiatorEntry=iscsiInitiatorEntry, PYSNMP_MODULE_ID=tegile, lunReadIops=lunReadIops, poolMetaReadLatency=poolMetaReadLatency, shareNFSReadIops=shareNFSReadIops, notificationProps=notificationProps, iscsiTargets=iscsiTargets, shareReservedSizeLow=shareReservedSizeLow, upgradeStarted=upgradeStarted, lunFreeSizeLow=lunFreeSizeLow, notificationTargetEntityName=notificationTargetEntityName, fcTargetWriteIops=fcTargetWriteIops, currentNotificationGroup=currentNotificationGroup, shareName=shareName, poolDegraded=poolDegraded, poolSizeHigh=poolSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, snapshotRollbackFailed=snapshotRollbackFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, cpuInterrupts=cpuInterrupts, diskPoolName=diskPoolName, volumeDeleteFailed=volumeDeleteFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, tegileArray=tegileArray, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, fcTargetReadLatency=fcTargetReadLatency, ipmiThreshold=ipmiThreshold, haControllerB_Uptime=haControllerB_Uptime, ipmiPowerSupply=ipmiPowerSupply, shareQuotaFinished=shareQuotaFinished, projectLunCount=projectLunCount, smisServiceStarted=smisServiceStarted, fcAvgWriteLatency=fcAvgWriteLatency, notificationComponentName=notificationComponentName, diskIsOnline=diskIsOnline, poolTotalSaving=poolTotalSaving, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, globalStatistics=globalStatistics, tegileArray_notifications=tegileArray_notifications, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolEntry=poolEntry, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, controllerDown=controllerDown, iscsiInitiatorIndex=iscsiInitiatorIndex, haResourceStatus=haResourceStatus, nfsTotalWriteIops=nfsTotalWriteIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, cifsAvgWriteLatency=cifsAvgWriteLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, notificationSensorNumber=notificationSensorNumber, shareCompressionEnabled=shareCompressionEnabled, replicationComplete=replicationComplete, shareNFSWriteIops=shareNFSWriteIops, fcTargetStatus=fcTargetStatus, fcInitiatorIndex=fcInitiatorIndex, deleteFolderCompleted=deleteFolderCompleted, diskSizeLow=diskSizeLow, cifsTotalReadIops=cifsTotalReadIops, poolDeletionFailed=poolDeletionFailed, cifsTotalWriteMbps=cifsTotalWriteMbps, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, nicTable=nicTable, projectQuotaSizeLow=projectQuotaSizeLow, projectDedupEnabled=projectDedupEnabled, replicationAborted=replicationAborted, poolProjects=poolProjects, cifsTotalWriteIops=cifsTotalWriteIops, lunReservedSizeHigh=lunReservedSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolMetaReadMbps=poolMetaReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiTargetReadIops=iscsiTargetReadIops, haResourceIndex=haResourceIndex, lunReadMbps=lunReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcInitiatorsTable=fcInitiatorsTable, haResources=haResources, iscsiTotalWriteMbps=iscsiTotalWriteMbps, alertsCleanupCompleted=alertsCleanupCompleted, poolUsedSizeLow=poolUsedSizeLow, poolMetaWriteIops=poolMetaWriteIops, aclMigrationCompleted=aclMigrationCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, diskTotalReadMbps=diskTotalReadMbps, cacheSSDReads=cacheSSDReads, shareNFSReadMbps=shareNFSReadMbps, tegileGroups=tegileGroups, fcInitiatorEntry=fcInitiatorEntry, lunProjectName=lunProjectName, lunPoolName=lunPoolName, shareNFSWriteMbps=shareNFSWriteMbps, diskTable=diskTable, poolCount=poolCount, lunWriteMbps=lunWriteMbps, tegile=tegile, volumeDeleteCompleted=volumeDeleteCompleted, spareDiskReplaced=spareDiskReplaced, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, replicationSourceRegistered=replicationSourceRegistered, diskTotalWriteMbps=diskTotalWriteMbps, poolWriteCacheWriteIops=poolWriteCacheWriteIops, nvdimmFailDeviceError=nvdimmFailDeviceError, snapshotDeleteFailed=snapshotDeleteFailed, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiTargetsTable=iscsiTargetsTable, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolReadCacheReadIops=poolReadCacheReadIops, properties=properties, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, upgradeFailed=upgradeFailed, projectQuotaSizeHigh=projectQuotaSizeHigh, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, lunSizeHigh=lunSizeHigh, netbiosSocketFailure=netbiosSocketFailure, ipmiTemperature=ipmiTemperature, poolUpgraded=poolUpgraded, notificationSensorSuspect=notificationSensorSuspect, replicationStarted=replicationStarted, lunProtocol=lunProtocol, diskAvgReadLatency=diskAvgReadLatency, ipmiCurrent=ipmiCurrent, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, diskError=diskError, diskDataWriteMbps=diskDataWriteMbps, nicTransmitMbps=nicTransmitMbps, lunReadLatency=lunReadLatency, fcTargetWriteLatency=fcTargetWriteLatency, iscsiWriteIops=iscsiWriteIops, fcTargetIndex=fcTargetIndex, poolExported=poolExported, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolState=poolState, intelliFlashSoftwareDown=intelliFlashSoftwareDown, networkTotalReceiveMbps=networkTotalReceiveMbps, poolSizeLow=poolSizeLow, volumeCreatedSuccessfully=volumeCreatedSuccessfully, smisServiceStopped=smisServiceStopped, nvdimmFailInitializationError=nvdimmFailInitializationError, lunCompressionEnabled=lunCompressionEnabled, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, shareDataSizeLow=shareDataSizeLow, diskState=diskState, haControllerA_Uptime=haControllerA_Uptime, fcTargetWriteMbps=fcTargetWriteMbps, poolDataReadMbps=poolDataReadMbps, lunCompressedRatio=lunCompressedRatio, shareMountPoint=shareMountPoint, poolDataSizeLow=poolDataSizeLow, nfsTotalReadIops=nfsTotalReadIops, cacheRAMReads=cacheRAMReads, fcTotalWriteMbps=fcTotalWriteMbps, projectModified=projectModified, replicationPaused=replicationPaused, ipmiOther=ipmiOther, nicName=nicName, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, sensorFailureEvent=sensorFailureEvent, poolTotalReadIops=poolTotalReadIops, notificationReadingUnit=notificationReadingUnit, nicEntry=nicEntry, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcAvgReadLatency=fcAvgReadLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcInitiatorCreateFailed=fcInitiatorCreateFailed, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, snmpServiceStopFailed=snmpServiceStopFailed, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, diagnosticDataUploaded=diagnosticDataUploaded, poolName=poolName, projectShares=projectShares, cacheTotalReadIops=cacheTotalReadIops, fcTargetModifyCompleted=fcTargetModifyCompleted, poolMetaWriteMbps=poolMetaWriteMbps, vmwareNFSDatastores=vmwareNFSDatastores, shareNFSWriteLatency=shareNFSWriteLatency, upgradeDownloadStarted=upgradeDownloadStarted, poolTable=poolTable, volumeQuotaFinished=volumeQuotaFinished, nicState=nicState, fcPortOffline=fcPortOffline, lunGUID=lunGUID, haControllerB_IPAddr=haControllerB_IPAddr, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, replicationAbandoned=replicationAbandoned, diskRandomIOCount=diskRandomIOCount, ipmiVoltage=ipmiVoltage, diskDataReadIops=diskDataReadIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, disks=disks, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectFreeSizeHigh=projectFreeSizeHigh, projectEntry=projectEntry, haResourceActiveNode=haResourceActiveNode, fcTargetsTable=fcTargetsTable, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiTargetWriteLatency=iscsiTargetWriteLatency, networkIpmpGroupUp=networkIpmpGroupUp, shareEntry=shareEntry, fcInitiatorGroup=fcInitiatorGroup, shareCIFSWriteLatency=shareCIFSWriteLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiAvgReadLatency=iscsiAvgReadLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolReadCacheReadLatency=poolReadCacheReadLatency, maintenanceModeEnabled=maintenanceModeEnabled, lunDataSizeHigh=lunDataSizeHigh, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, nicReceiveMbps=nicReceiveMbps)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetName=iscsiTargetName, diskSizeHigh=diskSizeHigh, networkInterfaceUp=networkInterfaceUp, currentObjectGroup=currentObjectGroup, shareCIFSWriteIops=shareCIFSWriteIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, upgradeDownloadCompleted=upgradeDownloadCompleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, deleteFolderFailed=deleteFolderFailed, basicCompliance=basicCompliance, lunInitiatorGroup=lunInitiatorGroup, iscsiProperties=iscsiProperties, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, poolExpanded=poolExpanded, shareCIFSWriteMbps=shareCIFSWriteMbps, poolTotalWriteMbps=poolTotalWriteMbps, cpuSystemCalls=cpuSystemCalls, iscsiTargetAlias=iscsiTargetAlias, upgradeCompleted=upgradeCompleted, iscsiTargetGroupError=iscsiTargetGroupError, nfsAvgReadLatency=nfsAvgReadLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, upgradeDownloadFailed=upgradeDownloadFailed, snmpServiceStopped=snmpServiceStopped, diskAvgWriteLatency=diskAvgWriteLatency, lunWriteLatency=lunWriteLatency, haResourcesTable=haResourcesTable, networkIpmpGroupDown=networkIpmpGroupDown, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectTable=projectTable, shareReservedSizeHigh=shareReservedSizeHigh, diskTotalReadIops=diskTotalReadIops, shareTable=shareTable, nicGroup=nicGroup, poolDataReadLatency=poolDataReadLatency, poolAvgReadLatency=poolAvgReadLatency, shareNFSReadLatency=shareNFSReadLatency, notificationTime=notificationTime, notificationDescription=notificationDescription, cacheTotalReadMbps=cacheTotalReadMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiTotalReadIops=iscsiTotalReadIops, projectPoolName=projectPoolName, lunDedupEnabled=lunDedupEnabled, fcTotalReadIops=fcTotalReadIops, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, notificationSensorAction=notificationSensorAction, poolIndex=poolIndex, iscsiInitiatorName=iscsiInitiatorName, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, tegileCompliances=tegileCompliances, shareCIFSEnabled=shareCIFSEnabled, shareCIFSReadLatency=shareCIFSReadLatency, volumeModifyCompleted=volumeModifyCompleted, diskIOCount=diskIOCount, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiTargetGroup=iscsiTargetGroup, shareDedupEnabled=shareDedupEnabled, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, projectCompressionEnabled=projectCompressionEnabled, tegileConformance=tegileConformance, shareExceedThresholdWarning=shareExceedThresholdWarning, cacheTotalWriteIops=cacheTotalWriteIops, projectDataSizeLow=projectDataSizeLow, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, targetGroupMemberRemoved=targetGroupMemberRemoved, tdpsUpgradeTimeout=tdpsUpgradeTimeout, snmpServiceStartFailed=snmpServiceStartFailed, iscsiTargetEntry=iscsiTargetEntry, upgradeTimeout=upgradeTimeout, fcInitiators=fcInitiators, diskType=diskType, poolProjectCount=poolProjectCount, poolReadCacheReadMbps=poolReadCacheReadMbps, maintenanceModeDisabled=maintenanceModeDisabled, networkInterfaceDown=networkInterfaceDown, fcTotalReadMbps=fcTotalReadMbps, poolDataReadIops=poolDataReadIops, poolAvgWriteLatency=poolAvgWriteLatency, haControllerA_IPAddr=haControllerA_IPAddr, fcTargetGroup=fcTargetGroup, poolHealth=poolHealth, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cacheTotalWriteMbps=cacheTotalWriteMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, shareQuotaLow=shareQuotaLow, smbSocketFailure=smbSocketFailure, notifications=notifications, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcTargetReadIops=fcTargetReadIops, haResourceDescription=haResourceDescription, haControllerB_Name=haControllerB_Name, diskIndex=diskIndex, snmpServiceStarted=snmpServiceStarted, network=network, shareQuotaHigh=shareQuotaHigh, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareCIFSReadIops=shareCIFSReadIops, networkTotalTransmitMbps=networkTotalTransmitMbps, projectFreeSizeLow=projectFreeSizeLow, diskChassisIdx=diskChassisIdx, poolReadCacheWriteLatency=poolReadCacheWriteLatency, snapshotCloningFailed=snapshotCloningFailed, notificationEventCode=notificationEventCode, iscsiInitiators=iscsiInitiators, fcProperties=fcProperties, nvdimmFailUnknownError=nvdimmFailUnknownError, lunFreeSizeHigh=lunFreeSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, pools=pools, shareCompressedRatio=shareCompressedRatio, poolDataSizeHigh=poolDataSizeHigh, iscsiTargetAuth=iscsiTargetAuth, snapshotCreationFailed=snapshotCreationFailed, nvdimmFailSoftError=nvdimmFailSoftError, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, lunIndex=lunIndex, iscsiAvgWriteLatency=iscsiAvgWriteLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, sharePoolName=sharePoolName, sanProperties=sanProperties, diskAlias=diskAlias, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, haControllerA_Name=haControllerA_Name, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, lunBlockSize=lunBlockSize, fcPortOnline=fcPortOnline, nfsTotalWriteMbps=nfsTotalWriteMbps, poolDataWriteIops=poolDataWriteIops, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolOwnerController=poolOwnerController, shareCreatedSuccessfully=shareCreatedSuccessfully, poolTotalReadMbps=poolTotalReadMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, nicMTU=nicMTU, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, notificationObjects=notificationObjects, snmpAgentVersion=snmpAgentVersion, cpuTotalUsage=cpuTotalUsage, diskDataReadMbps=diskDataReadMbps, replicationFailed=replicationFailed, lunName=lunName, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcInitiatorName=fcInitiatorName, testNotification=testNotification, shareIndex=shareIndex, projectTotalSaving=projectTotalSaving, shareDataSizeHigh=shareDataSizeHigh, unknownSensorEvent=unknownSensorEvent, adServerTimeDrift=adServerTimeDrift, diskDataWriteIops=diskDataWriteIops, shareCIFSReadMbps=shareCIFSReadMbps, diskCount=diskCount, projectDeleted=projectDeleted, notificationSeverity=notificationSeverity, nicIndex=nicIndex, projectDeletionFailed=projectDeletionFailed, lunEntry=lunEntry, webdocsUpgradeFailed=webdocsUpgradeFailed, replicationTargetDeleted=replicationTargetDeleted, lunReservedSizeLow=lunReservedSizeLow, iscsiTargetIndex=iscsiTargetIndex, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskTotalWriteIops=diskTotalWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, projectName=projectName, fcTargetEntry=fcTargetEntry, poolTotalWriteIops=poolTotalWriteIops, haResourceGroup=haResourceGroup, controllerUp=controllerUp, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, ipmiFan=ipmiFan, lunTargetGroup=lunTargetGroup, poolUsedSizeHigh=poolUsedSizeHigh, nfsTotalReadMbps=nfsTotalReadMbps, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, smisServiceStopFailed=smisServiceStopFailed, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolDeleted=poolDeleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, diskGoneOffline=diskGoneOffline, ntpServerTimeDrift=ntpServerTimeDrift, notificationThresholdTriggerValue=notificationThresholdTriggerValue, lunTable=lunTable, shareSnapshotSizeHigh=shareSnapshotSizeHigh, lunWriteIops=lunWriteIops, snapshotCloneCompleted=snapshotCloneCompleted, diskSlowIo=diskSlowIo, targetGroupMemberAdded=targetGroupMemberAdded, projectSnapshotSizeLow=projectSnapshotSizeLow, smisServiceStartFailed=smisServiceStartFailed, diskEntry=diskEntry, fcTargets=fcTargets, diskSequentialIOCount=diskSequentialIOCount, poolDataWriteLatency=poolDataWriteLatency, fcTargetName=fcTargetName, controllerHardwareModel=controllerHardwareModel, poolMetaReadIops=poolMetaReadIops, lunSizeLow=lunSizeLow, haResourceName=haResourceName, poolImported=poolImported, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiTargetError=iscsiTargetError, memoryFailure=memoryFailure, projectShareCount=projectShareCount, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcTotalWriteIops=fcTotalWriteIops, haResourceEntry=haResourceEntry, nfsAvgWriteLatency=nfsAvgWriteLatency, shareDeletionFailed=shareDeletionFailed)
