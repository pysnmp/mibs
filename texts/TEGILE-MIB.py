...
Unsigned32, TimeTicks, Integer32, ModuleIdentity, Counter64, Bits, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, MibIdentifier, NotificationType, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "Integer32", "ModuleIdentity", "Counter64", "Bits", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "MibIdentifier", "NotificationType", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", replicationComplete=replicationComplete, projectLunCount=projectLunCount, sensorFailureEvent=sensorFailureEvent, vmwareNFSDatastores=vmwareNFSDatastores, userLoginFailed=userLoginFailed, diskAlias=diskAlias, lunPoolName=lunPoolName, lunCompressionEnabled=lunCompressionEnabled, poolDataWriteLatency=poolDataWriteLatency, snapshotCloningFailed=snapshotCloningFailed, fcInitiatorIndex=fcInitiatorIndex, lunWriteMbps=lunWriteMbps, diskDataReadMbps=diskDataReadMbps, lunReservedSizeLow=lunReservedSizeLow, volumeModifyCompleted=volumeModifyCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, lunTable=lunTable, ipmiPowerSupply=ipmiPowerSupply, pools=pools, poolDataWriteMbps=poolDataWriteMbps, fcTargetsTable=fcTargetsTable, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, poolFreeSizeHigh=poolFreeSizeHigh, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, volumeCreatedSuccessfully=volumeCreatedSuccessfully, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, tegileArray_notifications=tegileArray_notifications, diskSequentialIOCount=diskSequentialIOCount, volumeDeleteFailed=volumeDeleteFailed, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, maintenanceModeEnabled=maintenanceModeEnabled, diskEntry=diskEntry, snapshotCreationFailed=snapshotCreationFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolUpgraded=poolUpgraded, iscsiTotalWriteMbps=iscsiTotalWriteMbps, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, smisServiceStarted=smisServiceStarted, poolQuotaFinished=poolQuotaFinished, ipmiCurrent=ipmiCurrent, cpuSystemCalls=cpuSystemCalls, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, iscsiWriteIops=iscsiWriteIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiTargetReadLatency=iscsiTargetReadLatency, poolTable=poolTable, shareNFSEnabled=shareNFSEnabled, smisServiceStartFailed=smisServiceStartFailed, poolIndex=poolIndex, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, cacheTotalReadMbps=cacheTotalReadMbps, shareReservedSizeHigh=shareReservedSizeHigh, nicState=nicState, projectDataSizeHigh=projectDataSizeHigh, poolDataReadMbps=poolDataReadMbps, fcTargetWriteMbps=fcTargetWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, smisServiceStopFailed=smisServiceStopFailed, fcInitiatorName=fcInitiatorName, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolAvgWriteLatency=poolAvgWriteLatency, poolState=poolState, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunInitiatorGroup=lunInitiatorGroup, iscsiInitiatorsTable=iscsiInitiatorsTable, shareDataSizeHigh=shareDataSizeHigh, fcTargetEntry=fcTargetEntry, fcTargetModifyCompleted=fcTargetModifyCompleted, upgradeStarted=upgradeStarted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, volumeQuotaFinished=volumeQuotaFinished, nvdimmFailInitializationError=nvdimmFailInitializationError, diskTable=diskTable, lunReservedSizeHigh=lunReservedSizeHigh, testNotification=testNotification, iscsiInitiatorGroup=iscsiInitiatorGroup, projectDeletionFailed=projectDeletionFailed, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectTotalSaving=projectTotalSaving, iscsiTotalReadMbps=iscsiTotalReadMbps, lunFreeSizeLow=lunFreeSizeLow, haControllerB_IPAddr=haControllerB_IPAddr, shareNFSWriteLatency=shareNFSWriteLatency, fcProperties=fcProperties, replicationAborted=replicationAborted, lunDataSizeLow=lunDataSizeLow, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, unknownSensorEvent=unknownSensorEvent, cifsAvgWriteLatency=cifsAvgWriteLatency, replicationStarted=replicationStarted, poolReadCacheReadIops=poolReadCacheReadIops, upgradeFailed=upgradeFailed, diskType=diskType, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, volumeDeleteCompleted=volumeDeleteCompleted, projectShares=projectShares, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskSizeHigh=diskSizeHigh, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, haControllerA_Name=haControllerA_Name, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetWriteLatency=fcTargetWriteLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, fcTotalReadMbps=fcTotalReadMbps, notificationDescription=notificationDescription, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiTargetAlias=iscsiTargetAlias, shareName=shareName, fcTargetReadIops=fcTargetReadIops, adServerTimeDrift=adServerTimeDrift, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, nfsTotalWriteIops=nfsTotalWriteIops, diskChassisIdx=diskChassisIdx, poolExpanded=poolExpanded, nfsAvgWriteLatency=nfsAvgWriteLatency, poolEntry=poolEntry, diagnosticDataUploaded=diagnosticDataUploaded, poolReadCacheWriteIops=poolReadCacheWriteIops, poolMetaReadLatency=poolMetaReadLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, cifsTotalWriteIops=cifsTotalWriteIops, lunProtocol=lunProtocol, diskIsOnline=diskIsOnline, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, upgradeTimeout=upgradeTimeout, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolMetaReadMbps=poolMetaReadMbps, fcAvgReadLatency=fcAvgReadLatency, diskIOCount=diskIOCount, shareCIFSReadLatency=shareCIFSReadLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiTargetsTable=iscsiTargetsTable, upgradeDownloadStarted=upgradeDownloadStarted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, snmpServiceStopFailed=snmpServiceStopFailed, poolTotalReadMbps=poolTotalReadMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, fcTotalWriteIops=fcTotalWriteIops, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiInitiators=iscsiInitiators, shareNFSWriteMbps=shareNFSWriteMbps, fcTargetIndex=fcTargetIndex, fcInitiatorsTable=fcInitiatorsTable, poolReadCacheWriteMbps=poolReadCacheWriteMbps, networkIpmpGroupDown=networkIpmpGroupDown, poolHealth=poolHealth, shareSnapshotSizeHigh=shareSnapshotSizeHigh, cacheRAMReads=cacheRAMReads, deleteFolderFailed=deleteFolderFailed, snmpServiceStartFailed=snmpServiceStartFailed, haResources=haResources, replicationFailed=replicationFailed, haControllerA_IPAddr=haControllerA_IPAddr, shareReservedSizeLow=shareReservedSizeLow, cpuTotalUsage=cpuTotalUsage, diskTotalWriteIops=diskTotalWriteIops, nfsAvgReadLatency=nfsAvgReadLatency, globalStatistics=globalStatistics, poolSizeHigh=poolSizeHigh, notificationComponentName=notificationComponentName, disks=disks, lunSnapshotSizeLow=lunSnapshotSizeLow, poolDataWriteIops=poolDataWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, networkTotalReceiveMbps=networkTotalReceiveMbps, lunBlockSize=lunBlockSize, shareEntry=shareEntry, fcTargetReadMbps=fcTargetReadMbps, ipmiVoltage=ipmiVoltage, notificationSeverity=notificationSeverity, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, webdocsUpgradeCompleted=webdocsUpgradeCompleted, properties=properties, ipmiFan=ipmiFan, shareCIFSReadMbps=shareCIFSReadMbps, nfsTotalReadMbps=nfsTotalReadMbps, projectDedupEnabled=projectDedupEnabled, nicTransmitMbps=nicTransmitMbps, shareCIFSEnabled=shareCIFSEnabled, shareCIFSWriteIops=shareCIFSWriteIops, projectQuotaSizeHigh=projectQuotaSizeHigh, projectQuotaFinished=projectQuotaFinished, webdocsUpgradeFailed=webdocsUpgradeFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiInitiatorChapUser=iscsiInitiatorChapUser, lunEntry=lunEntry, cifsTotalReadMbps=cifsTotalReadMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetEntry=iscsiTargetEntry, cifsTotalReadIops=cifsTotalReadIops, haControllerB_Name=haControllerB_Name, poolOwnerController=poolOwnerController, poolDataReadLatency=poolDataReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, tegile=tegile, networkIpmpGroupUp=networkIpmpGroupUp, shareProjectName=shareProjectName, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, lunGUID=lunGUID, haResourceGroup=haResourceGroup, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, shareQuotaHigh=shareQuotaHigh, poolCreated=poolCreated, lunSizeHigh=lunSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiTargetReadIops=iscsiTargetReadIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolName=poolName, projectCreatedSuccessfully=projectCreatedSuccessfully, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, iscsiProperties=iscsiProperties, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolImported=poolImported, fcPortOnline=fcPortOnline, notificationProps=notificationProps, fcTargetWriteIops=fcTargetWriteIops, notificationEventCode=notificationEventCode, diskError=diskError, projectPoolName=projectPoolName, tdpsUpgradeFailed=tdpsUpgradeFailed, poolProjects=poolProjects, poolDataSizeHigh=poolDataSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, poolMetaWriteMbps=poolMetaWriteMbps, iscsiTargetName=iscsiTargetName, replicationTargetDeleted=replicationTargetDeleted, ipmiThreshold=ipmiThreshold, shareMountPoint=shareMountPoint, diskRandomIOCount=diskRandomIOCount, projectEntry=projectEntry, maintenanceModeDisabled=maintenanceModeDisabled, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareCompressedRatio=shareCompressedRatio, cacheTotalWriteMbps=cacheTotalWriteMbps, notificationObjects=notificationObjects, diskSlowIo=diskSlowIo, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, PYSNMP_MODULE_ID=tegile, poolSizeLow=poolSizeLow)
mibBuilder.exportSymbols("TEGILE-MIB", poolTotalSaving=poolTotalSaving, poolDataSizeLow=poolDataSizeLow, iscsiTotalReadIops=iscsiTotalReadIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, aclMigrationStarted=aclMigrationStarted, diskCount=diskCount, fcTargetStatus=fcTargetStatus, nfsTotalReadIops=nfsTotalReadIops, poolMetaReadIops=poolMetaReadIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolReadCacheReadMbps=poolReadCacheReadMbps, lunReadMbps=lunReadMbps, projectName=projectName, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiAvgReadLatency=iscsiAvgReadLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, notificationTime=notificationTime, poolCount=poolCount, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcTotalWriteMbps=fcTotalWriteMbps, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, projectDataSizeLow=projectDataSizeLow, snapshotRollbackFailed=snapshotRollbackFailed, projectModified=projectModified, poolExported=poolExported, diskAvgWriteLatency=diskAvgWriteLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, snmpServiceStopped=snmpServiceStopped, projectCompressionEnabled=projectCompressionEnabled, fcTargetName=fcTargetName, poolAvgReadLatency=poolAvgReadLatency, nicIndex=nicIndex, controllerHardwareModel=controllerHardwareModel, tegileConformance=tegileConformance, haResourceEntry=haResourceEntry, controllerTimeDrift=controllerTimeDrift, sharePoolName=sharePoolName, diskTotalReadMbps=diskTotalReadMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, diskGoneOffline=diskGoneOffline, replicationResumed=replicationResumed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectFreeSizeLow=projectFreeSizeLow, notificationReadingUnit=notificationReadingUnit, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolUsedSizeLow=poolUsedSizeLow, lunIndex=lunIndex, upgradeDownloadFailed=upgradeDownloadFailed, ipmiTemperature=ipmiTemperature, shareIndex=shareIndex, poolProjectCount=poolProjectCount, poolMetaWriteIops=poolMetaWriteIops, fcAvgWriteLatency=fcAvgWriteLatency, lunReadLatency=lunReadLatency, replicationSourceRegistered=replicationSourceRegistered, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, notificationTargetEntityName=notificationTargetEntityName, projectQuotaSizeLow=projectQuotaSizeLow, projectShareCount=projectShareCount, currentNotificationGroup=currentNotificationGroup, iscsiTargetIndex=iscsiTargetIndex, notifications=notifications, currentObjectGroup=currentObjectGroup, projectSnapshotSizeHigh=projectSnapshotSizeHigh, aclMigrationCompleted=aclMigrationCompleted, projectLUNs=projectLUNs, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, lunSizeLow=lunSizeLow, lunDedupEnabled=lunDedupEnabled, controllerUp=controllerUp, diskTotalWriteMbps=diskTotalWriteMbps, targetGroupMemberAdded=targetGroupMemberAdded, shareDeletionFailed=shareDeletionFailed, cacheTotalReadIops=cacheTotalReadIops, cacheSSDReads=cacheSSDReads, snapshotRollbackCompleted=snapshotRollbackCompleted, poolTotalWriteMbps=poolTotalWriteMbps, iscsiInitiatorName=iscsiInitiatorName, lunName=lunName, iscsiTargetGroup=iscsiTargetGroup, fcTargets=fcTargets, snapshotDeleteFailed=snapshotDeleteFailed, snapshotCloneCompleted=snapshotCloneCompleted, network=network, nvdimmFailSoftError=nvdimmFailSoftError, fcInitiatorEntry=fcInitiatorEntry, basicCompliance=basicCompliance, memoryFailure=memoryFailure, iscsiTargetError=iscsiTargetError, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, nicGroup=nicGroup, tegileGroups=tegileGroups, shareCIFSReadIops=shareCIFSReadIops, spareDiskReplaced=spareDiskReplaced, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, nicMTU=nicMTU, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, smbSocketFailure=smbSocketFailure, tdpsUpgradeTimeout=tdpsUpgradeTimeout, nvdimmFailDeviceError=nvdimmFailDeviceError, shareTable=shareTable, diskTotalReadIops=diskTotalReadIops, controllerDown=controllerDown, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiTargetAuth=iscsiTargetAuth, iscsiTargetReadMbps=iscsiTargetReadMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, lunWriteIops=lunWriteIops, nicReceiveMbps=nicReceiveMbps, alertsCleanupCompleted=alertsCleanupCompleted, tegileCompliances=tegileCompliances, haResourceIndex=haResourceIndex, projectFreeSizeHigh=projectFreeSizeHigh, diskPoolName=diskPoolName, shareDeleted=shareDeleted, shareCompressionEnabled=shareCompressionEnabled, poolDeletionFailed=poolDeletionFailed, lunWriteLatency=lunWriteLatency, replicationAbandoned=replicationAbandoned, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskDataWriteIops=diskDataWriteIops, projectTable=projectTable, lunCompressedRatio=lunCompressedRatio, nicEntry=nicEntry, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, shareNFSWriteIops=shareNFSWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, shareNFSReadLatency=shareNFSReadLatency, tegileArray=tegileArray, poolTotalWriteIops=poolTotalWriteIops, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolDataReadIops=poolDataReadIops, notificationSensorSuspect=notificationSensorSuspect, poolDeleted=poolDeleted, upgradeCompleted=upgradeCompleted, haResourceName=haResourceName, diskSizeLow=diskSizeLow, ipmiMemory=ipmiMemory, shareDataSizeLow=shareDataSizeLow, lunTargetGroup=lunTargetGroup, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareCIFSWriteLatency=shareCIFSWriteLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, cpuInterrupts=cpuInterrupts, haResourcesTable=haResourcesTable, shareNFSReadMbps=shareNFSReadMbps, shareNFSReadIops=shareNFSReadIops, deleteFolderCompleted=deleteFolderCompleted, haControllerA_Uptime=haControllerA_Uptime, poolReadCacheReadLatency=poolReadCacheReadLatency, haControllerB_Uptime=haControllerB_Uptime, cacheTotalWriteIops=cacheTotalWriteIops, diskDataWriteMbps=diskDataWriteMbps, ipmiOther=ipmiOther, shareQuotaFinished=shareQuotaFinished, replicationPaused=replicationPaused, cifsTotalWriteMbps=cifsTotalWriteMbps, diskDataReadIops=diskDataReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, snmpServiceStarted=snmpServiceStarted, fcInitiators=fcInitiators, shareQuotaLow=shareQuotaLow, iscsiTargets=iscsiTargets, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcInitiatorGroup=fcInitiatorGroup, nicName=nicName, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunReadIops=lunReadIops, fcTargetGroup=fcTargetGroup, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolFreeSizeLow=poolFreeSizeLow, smisServiceStopped=smisServiceStopped, diskIndex=diskIndex, snmpAgentVersion=snmpAgentVersion, projectDeleted=projectDeleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, lunDataSizeHigh=lunDataSizeHigh, lunFreeSizeHigh=lunFreeSizeHigh, nicTable=nicTable, shareDedupEnabled=shareDedupEnabled, fcTargetReadLatency=fcTargetReadLatency, diskState=diskState, intelliFlashSoftwareDown=intelliFlashSoftwareDown, diskAvgReadLatency=diskAvgReadLatency, haResourceDescription=haResourceDescription, shareSnapshotSizeLow=shareSnapshotSizeLow, fcPortOffline=fcPortOffline, lunProjectName=lunProjectName, fcTotalReadIops=fcTotalReadIops, netbiosSocketFailure=netbiosSocketFailure, sanProperties=sanProperties, ntpServerTimeDrift=ntpServerTimeDrift, targetGroupDeleteCompleted=targetGroupDeleteCompleted, cifsAvgReadLatency=cifsAvgReadLatency, networkInterfaceUp=networkInterfaceUp, poolUsedSizeHigh=poolUsedSizeHigh, haResourceActiveNode=haResourceActiveNode, poolTotalReadIops=poolTotalReadIops, notificationSensorNumber=notificationSensorNumber, nfsTotalWriteMbps=nfsTotalWriteMbps, notificationSensorAction=notificationSensorAction, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolDegraded=poolDegraded, haResourceStatus=haResourceStatus, projectIndex=projectIndex, networkInterfaceDown=networkInterfaceDown)
