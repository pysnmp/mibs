...
# Produced by pysmi-1.1.8 at Fri Jul  8 07:44:27 2022
...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, ObjectIdentity, Unsigned32, Counter32, iso, Bits, TimeTicks, Gauge32, enterprises, NotificationType, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Counter32", "iso", "Bits", "TimeTicks", "Gauge32", "enterprises", "NotificationType", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetsTable=fcTargetsTable, cpuInterrupts=cpuInterrupts, notificationEventCode=notificationEventCode, diagnosticDataUploaded=diagnosticDataUploaded, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiTotalReadMbps=iscsiTotalReadMbps, projectQuotaFinished=projectQuotaFinished, nicState=nicState, upgradeFailed=upgradeFailed, haResourceIndex=haResourceIndex, ipmiOther=ipmiOther, replicationResumed=replicationResumed, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareTable=shareTable, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectDeletionFailed=projectDeletionFailed, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, nfsAvgReadLatency=nfsAvgReadLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, smbSocketFailure=smbSocketFailure, diskSequentialIOCount=diskSequentialIOCount, notificationSensorAction=notificationSensorAction, shareCompressedRatio=shareCompressedRatio, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, fcTargetReadLatency=fcTargetReadLatency, volumeQuotaFinished=volumeQuotaFinished, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, iscsiInitiators=iscsiInitiators, poolUsedSizeHigh=poolUsedSizeHigh, haResourcesTable=haResourcesTable, notificationTargetEntityName=notificationTargetEntityName, poolAvgWriteLatency=poolAvgWriteLatency, projectCreatedSuccessfully=projectCreatedSuccessfully, memoryFailure=memoryFailure, iscsiTargetEntry=iscsiTargetEntry, poolReadCacheWriteMbps=poolReadCacheWriteMbps, notificationSeverity=notificationSeverity, shareCIFSEnabled=shareCIFSEnabled, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolReadCacheReadIops=poolReadCacheReadIops, shareNFSWriteMbps=shareNFSWriteMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, diskTotalWriteIops=diskTotalWriteIops, cifsTotalWriteIops=cifsTotalWriteIops, projectIndex=projectIndex, fcInitiatorGroup=fcInitiatorGroup, iscsiTargetReadLatency=iscsiTargetReadLatency, projectShares=projectShares, diskIndex=diskIndex, deleteFolderCompleted=deleteFolderCompleted, controllerHardwareModel=controllerHardwareModel, smisServiceStopped=smisServiceStopped, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, notificationSensorSuspect=notificationSensorSuspect, projectFreeSizeHigh=projectFreeSizeHigh, lunWriteMbps=lunWriteMbps, fcTargetReadMbps=fcTargetReadMbps, basicCompliance=basicCompliance, notificationSensorNumber=notificationSensorNumber, upgradeDownloadFailed=upgradeDownloadFailed, projectQuotaSizeLow=projectQuotaSizeLow, iscsiTargetGroupError=iscsiTargetGroupError, diskChassisIdx=diskChassisIdx, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, tegileArray=tegileArray, shareName=shareName, iscsiInitiatorsTable=iscsiInitiatorsTable, fcTargetGroup=fcTargetGroup, sanProperties=sanProperties, shareQuotaFinished=shareQuotaFinished, projectName=projectName, fcTargetStatus=fcTargetStatus, shareCIFSReadIops=shareCIFSReadIops, fcTargetIndex=fcTargetIndex, properties=properties, poolUsedSizeLow=poolUsedSizeLow, notificationReadingUnit=notificationReadingUnit, lunDataSizeHigh=lunDataSizeHigh, sharePoolName=sharePoolName, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareQuotaLow=shareQuotaLow, lunReadMbps=lunReadMbps, diskError=diskError, lunReservedSizeHigh=lunReservedSizeHigh, haControllerA_Uptime=haControllerA_Uptime, haResourceStatus=haResourceStatus, controllerUp=controllerUp, diskGoneOffline=diskGoneOffline, replicationTargetDeleted=replicationTargetDeleted, poolHealth=poolHealth, controllerDown=controllerDown, replicationStarted=replicationStarted, projectDataSizeLow=projectDataSizeLow, snapshotCloningFailed=snapshotCloningFailed, poolOwnerController=poolOwnerController, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, notificationProps=notificationProps, tdpsUpgradeFailed=tdpsUpgradeFailed, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcPortOnline=fcPortOnline, alertsCleanupCompleted=alertsCleanupCompleted, ipmiTemperature=ipmiTemperature, notificationObjects=notificationObjects, replicationFailed=replicationFailed, ipmiMemory=ipmiMemory, lunProtocol=lunProtocol, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiTargetError=iscsiTargetError, projectTable=projectTable, pools=pools, fcTotalReadMbps=fcTotalReadMbps, projectTotalSaving=projectTotalSaving, disks=disks, shareNFSWriteIops=shareNFSWriteIops, shareNFSReadIops=shareNFSReadIops, tegileCompliances=tegileCompliances, tdpsUpgradeCompleted=tdpsUpgradeCompleted, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargetGroup=iscsiTargetGroup, nvdimmFailDeviceError=nvdimmFailDeviceError, lunTargetGroup=lunTargetGroup, targetGroupDeleteCompleted=targetGroupDeleteCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcInitiators=fcInitiators, projectSnapshotSizeLow=projectSnapshotSizeLow, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunSizeHigh=lunSizeHigh, cacheRAMReads=cacheRAMReads, projectDataSizeHigh=projectDataSizeHigh, fcTotalReadIops=fcTotalReadIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, targetGroupCreateCompleted=targetGroupCreateCompleted, haControllerB_Name=haControllerB_Name, haResourceGroup=haResourceGroup, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, shareNFSReadMbps=shareNFSReadMbps, fcInitiatorsTable=fcInitiatorsTable, tegileArray_notifications=tegileArray_notifications, lunName=lunName, shareSnapshotSizeLow=shareSnapshotSizeLow, shareReservedSizeHigh=shareReservedSizeHigh, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareDataSizeHigh=shareDataSizeHigh, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diskIOCount=diskIOCount, lunWriteIops=lunWriteIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcTotalWriteIops=fcTotalWriteIops, iscsiTargetIndex=iscsiTargetIndex, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, nvdimmFailSoftError=nvdimmFailSoftError, diskCount=diskCount, iscsiTotalReadIops=iscsiTotalReadIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, spareDiskReplaced=spareDiskReplaced, diskType=diskType, cifsTotalReadIops=cifsTotalReadIops, poolExported=poolExported, lunProjectName=lunProjectName, unknownSensorEvent=unknownSensorEvent, fcTargetName=fcTargetName, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, snapshotRollbackCompleted=snapshotRollbackCompleted, diskIsOnline=diskIsOnline, cacheTotalReadIops=cacheTotalReadIops, lunSizeLow=lunSizeLow, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolFreeSizeLow=poolFreeSizeLow, snmpServiceStopFailed=snmpServiceStopFailed, ipmiVoltage=ipmiVoltage, nfsTotalReadMbps=nfsTotalReadMbps, nicMTU=nicMTU, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, nicName=nicName, fcAvgWriteLatency=fcAvgWriteLatency, smisServiceStopFailed=smisServiceStopFailed, fcInitiatorEntry=fcInitiatorEntry, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, projectLUNs=projectLUNs, diskAlias=diskAlias, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolTotalReadIops=poolTotalReadIops, replicationAbandoned=replicationAbandoned, testNotification=testNotification, iscsiTargets=iscsiTargets, poolMetaWriteIops=poolMetaWriteIops, iscsiAvgReadLatency=iscsiAvgReadLatency, lunInitiatorGroup=lunInitiatorGroup, projectFreeSizeLow=projectFreeSizeLow, poolTotalReadMbps=poolTotalReadMbps, PYSNMP_MODULE_ID=tegile, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolAvgReadLatency=poolAvgReadLatency, cifsTotalReadMbps=cifsTotalReadMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareProjectName=shareProjectName, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiTargetWriteMbps=iscsiTargetWriteMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, poolDataReadIops=poolDataReadIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, diskSizeHigh=diskSizeHigh, ipmiThreshold=ipmiThreshold, network=network, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolUpgraded=poolUpgraded, shareCreatedSuccessfully=shareCreatedSuccessfully, volumeDeleteFailed=volumeDeleteFailed, cacheTotalWriteIops=cacheTotalWriteIops, poolTable=poolTable, poolCreated=poolCreated, haControllerB_Uptime=haControllerB_Uptime, shareCIFSReadLatency=shareCIFSReadLatency, ntpServerTimeDrift=ntpServerTimeDrift, intelliFlashSoftwareUp=intelliFlashSoftwareUp, upgradeDownloadStarted=upgradeDownloadStarted, userLoginFailed=userLoginFailed, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, currentNotificationGroup=currentNotificationGroup, maintenanceModeEnabled=maintenanceModeEnabled, lunFreeSizeLow=lunFreeSizeLow, lunCompressedRatio=lunCompressedRatio, lunReadLatency=lunReadLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, fcTargetWriteIops=fcTargetWriteIops, poolDeletionFailed=poolDeletionFailed, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, haResources=haResources, poolReadCacheReadMbps=poolReadCacheReadMbps, diskDataWriteIops=diskDataWriteIops, shareDeleted=shareDeleted, lunDataSizeLow=lunDataSizeLow, lunGUID=lunGUID, haResourceName=haResourceName, projectShareCount=projectShareCount, snapshotCreationFailed=snapshotCreationFailed, poolDataWriteLatency=poolDataWriteLatency, projectDeleted=projectDeleted, snmpServiceStopped=snmpServiceStopped, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, cifsAvgWriteLatency=cifsAvgWriteLatency)
mibBuilder.exportSymbols("TEGILE-MIB", fcTotalWriteMbps=fcTotalWriteMbps, shareCompressionEnabled=shareCompressionEnabled, haResourceDescription=haResourceDescription, nvdimmFailUnknownError=nvdimmFailUnknownError, poolImported=poolImported, poolExpanded=poolExpanded, tegileGroups=tegileGroups, iscsiProperties=iscsiProperties, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, volumeModifyCompleted=volumeModifyCompleted, shareCIFSReadMbps=shareCIFSReadMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, upgradeStarted=upgradeStarted, poolDataSizeLow=poolDataSizeLow, lunEntry=lunEntry, poolIndex=poolIndex, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cpuSystemCalls=cpuSystemCalls, poolDataReadLatency=poolDataReadLatency, shareDedupEnabled=shareDedupEnabled, nicEntry=nicEntry, globalStatistics=globalStatistics, shareDataSizeLow=shareDataSizeLow, iscsiTargetWriteIops=iscsiTargetWriteIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, smisServiceStartFailed=smisServiceStartFailed, poolTotalWriteMbps=poolTotalWriteMbps, poolDataWriteIops=poolDataWriteIops, projectCompressionEnabled=projectCompressionEnabled, iscsiTargetReadMbps=iscsiTargetReadMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, ipmiCurrent=ipmiCurrent, maintenanceModeDisabled=maintenanceModeDisabled, shareMountPoint=shareMountPoint, replicationAborted=replicationAborted, replicationSourceRegistered=replicationSourceRegistered, haResourceEntry=haResourceEntry, nicGroup=nicGroup, poolMetaWriteMbps=poolMetaWriteMbps, tegileConformance=tegileConformance, ipmiFan=ipmiFan, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, lunBlockSize=lunBlockSize, projectEntry=projectEntry, lunWriteLatency=lunWriteLatency, notificationComponentName=notificationComponentName, fcPortOffline=fcPortOffline, iscsiInitiatorName=iscsiInitiatorName, networkIpmpGroupUp=networkIpmpGroupUp, notificationReadingTriggerValue=notificationReadingTriggerValue, lunTable=lunTable, shareCIFSWriteIops=shareCIFSWriteIops, nicTable=nicTable, iscsiTargetWriteLatency=iscsiTargetWriteLatency, lunReservedSizeLow=lunReservedSizeLow, sensorFailureEvent=sensorFailureEvent, nfsTotalWriteIops=nfsTotalWriteIops, adServerTimeDrift=adServerTimeDrift, haControllerB_IPAddr=haControllerB_IPAddr, diskDataWriteMbps=diskDataWriteMbps, poolProjectCount=poolProjectCount, poolMetaReadMbps=poolMetaReadMbps, snapshotDeleteFailed=snapshotDeleteFailed, netbiosSocketFailure=netbiosSocketFailure, poolDegraded=poolDegraded, diskEntry=diskEntry, replicationPaused=replicationPaused, projectModified=projectModified, iscsiInitiatorChapUser=iscsiInitiatorChapUser, deleteFolderFailed=deleteFolderFailed, lunCompressionEnabled=lunCompressionEnabled, nicIndex=nicIndex, diskDataReadMbps=diskDataReadMbps, snmpServiceStartFailed=snmpServiceStartFailed, shareNFSWriteLatency=shareNFSWriteLatency, poolTotalSaving=poolTotalSaving, poolDataWriteMbps=poolDataWriteMbps, fcInitiatorIndex=fcInitiatorIndex, iscsiTargetReadIops=iscsiTargetReadIops, iscsiTargetName=iscsiTargetName, poolCount=poolCount, fcProperties=fcProperties, snmpAgentVersion=snmpAgentVersion, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiTargetAuth=iscsiTargetAuth, lunIndex=lunIndex, lunFreeSizeHigh=lunFreeSizeHigh, networkInterfaceDown=networkInterfaceDown, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolReadCacheReadLatency=poolReadCacheReadLatency, notificationTime=notificationTime, cacheSSDReads=cacheSSDReads, networkIpmpGroupDown=networkIpmpGroupDown, replicationComplete=replicationComplete, iscsiInitiatorGroup=iscsiInitiatorGroup, shareNFSReadLatency=shareNFSReadLatency, lunDedupEnabled=lunDedupEnabled, upgradeCompleted=upgradeCompleted, diskDataReadIops=diskDataReadIops, poolEntry=poolEntry, lunPoolName=lunPoolName, targetGroupMemberAdded=targetGroupMemberAdded, notificationThresholdTriggerValue=notificationThresholdTriggerValue, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, fcAvgReadLatency=fcAvgReadLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, fcTargets=fcTargets, shareNFSEnabled=shareNFSEnabled, nfsTotalReadIops=nfsTotalReadIops, diskRandomIOCount=diskRandomIOCount, lunReadIops=lunReadIops, diskSizeLow=diskSizeLow, diskAvgReadLatency=diskAvgReadLatency, nvdimmFailInitializationError=nvdimmFailInitializationError, poolFreeSizeHigh=poolFreeSizeHigh, fcTargetReadIops=fcTargetReadIops, fcInitiatorName=fcInitiatorName, iscsiWriteIops=iscsiWriteIops, projectPoolName=projectPoolName, poolQuotaFinished=poolQuotaFinished, shareIndex=shareIndex, volumeDeleteCompleted=volumeDeleteCompleted, nfsTotalWriteMbps=nfsTotalWriteMbps, snmpServiceStarted=snmpServiceStarted, diskAvgWriteLatency=diskAvgWriteLatency, aclMigrationStarted=aclMigrationStarted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetModifyCompleted=fcTargetModifyCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, webdocsUpgradeFailed=webdocsUpgradeFailed, nfsAvgWriteLatency=nfsAvgWriteLatency, nicTransmitMbps=nicTransmitMbps, poolMetaWriteLatency=poolMetaWriteLatency, shareQuotaHigh=shareQuotaHigh, fcTargetWriteLatency=fcTargetWriteLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolTotalWriteIops=poolTotalWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolSizeLow=poolSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, shareReservedSizeLow=shareReservedSizeLow, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolDeleted=poolDeleted, poolName=poolName, diskSlowIo=diskSlowIo, nicReceiveMbps=nicReceiveMbps, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolReadCacheWriteIops=poolReadCacheWriteIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolDataReadMbps=poolDataReadMbps, diskTotalWriteMbps=diskTotalWriteMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, haResourceActiveNode=haResourceActiveNode, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, snapshotRollbackFailed=snapshotRollbackFailed, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolProjects=poolProjects, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, cifsTotalWriteMbps=cifsTotalWriteMbps, notifications=notifications, webdocsUpgradeCompleted=webdocsUpgradeCompleted, tegile=tegile, poolDataSizeHigh=poolDataSizeHigh, controllerTimeDrift=controllerTimeDrift, iscsiTargetAlias=iscsiTargetAlias, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, cpuTotalUsage=cpuTotalUsage, smisServiceStarted=smisServiceStarted, poolState=poolState, iscsiTargetsTable=iscsiTargetsTable, shareDeletionFailed=shareDeletionFailed, projectDedupEnabled=projectDedupEnabled, haControllerA_IPAddr=haControllerA_IPAddr, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, currentObjectGroup=currentObjectGroup, cacheTotalReadMbps=cacheTotalReadMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolMetaReadIops=poolMetaReadIops, poolMetaReadLatency=poolMetaReadLatency, diskPoolName=diskPoolName, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, upgradeTimeout=upgradeTimeout, diskTable=diskTable, targetGroupMemberRemoved=targetGroupMemberRemoved, fcTargetEntry=fcTargetEntry, snapshotCloneCompleted=snapshotCloneCompleted, diskTotalReadMbps=diskTotalReadMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, notificationDescription=notificationDescription, shareExceedThresholdWarning=shareExceedThresholdWarning, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectThresholdExceedWarning=projectThresholdExceedWarning, diskTotalReadIops=diskTotalReadIops, networkInterfaceUp=networkInterfaceUp, poolSizeHigh=poolSizeHigh, diskState=diskState, ipmiPowerSupply=ipmiPowerSupply, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, cifsAvgReadLatency=cifsAvgReadLatency, haControllerA_Name=haControllerA_Name, projectLunCount=projectLunCount, shareEntry=shareEntry)
