...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, IpAddress, MibIdentifier, Bits, Integer32, ObjectIdentity, ModuleIdentity, NotificationType, Gauge32, iso, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "IpAddress", "MibIdentifier", "Bits", "Integer32", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Gauge32", "iso", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", properties=properties, lunWriteLatency=lunWriteLatency, poolMetaReadLatency=poolMetaReadLatency, snapshotCreationFailed=snapshotCreationFailed, fcInitiatorsTable=fcInitiatorsTable, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareNFSReadLatency=shareNFSReadLatency, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcTargetWriteIops=fcTargetWriteIops, networkInterfaceDown=networkInterfaceDown, PYSNMP_MODULE_ID=tegile, diskSizeHigh=diskSizeHigh, poolDataSizeHigh=poolDataSizeHigh, controllerHardwareModel=controllerHardwareModel, iscsiTargetWriteMbps=iscsiTargetWriteMbps, testNotification=testNotification, lunReservedSizeLow=lunReservedSizeLow, iscsiInitiatorEntry=iscsiInitiatorEntry, lunDataSizeHigh=lunDataSizeHigh, haResourceEntry=haResourceEntry, projectQuotaSizeLow=projectQuotaSizeLow, replicationResumed=replicationResumed, tegileConformance=tegileConformance, diskDataReadIops=diskDataReadIops, upgradeTimeout=upgradeTimeout, notificationProps=notificationProps, spareDiskReplaced=spareDiskReplaced, shareNFSEnabled=shareNFSEnabled, projectLunCount=projectLunCount, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, lunWriteIops=lunWriteIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, ipmiOther=ipmiOther, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskSizeLow=diskSizeLow, smisServiceStopped=smisServiceStopped, iscsiTargetGroup=iscsiTargetGroup, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolDataWriteIops=poolDataWriteIops, lunName=lunName, shareCIFSEnabled=shareCIFSEnabled, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiTargetEntry=iscsiTargetEntry, notificationSeverity=notificationSeverity, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, upgradeCompleted=upgradeCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, fcInitiatorEntry=fcInitiatorEntry, cifsTotalReadMbps=cifsTotalReadMbps, ipmiCurrent=ipmiCurrent, diskIsOnline=diskIsOnline, poolExpanded=poolExpanded, poolTable=poolTable, poolDataWriteLatency=poolDataWriteLatency, smisServiceStopFailed=smisServiceStopFailed, cacheRAMReads=cacheRAMReads, fcTargetReadLatency=fcTargetReadLatency, projectModified=projectModified, poolUsedSizeLow=poolUsedSizeLow, haResourceStatus=haResourceStatus, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, lunIndex=lunIndex, projectQuotaFinished=projectQuotaFinished, projectFreeSizeHigh=projectFreeSizeHigh, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, snapshotDeleteFailed=snapshotDeleteFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTargetReadIops=fcTargetReadIops, diskAvgReadLatency=diskAvgReadLatency, shareCIFSReadLatency=shareCIFSReadLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiTargets=iscsiTargets, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, tegileArray=tegileArray, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolTotalReadIops=poolTotalReadIops, diskTable=diskTable, networkTotalTransmitMbps=networkTotalTransmitMbps, shareDedupEnabled=shareDedupEnabled, poolReadCacheReadMbps=poolReadCacheReadMbps, fcPortOnline=fcPortOnline, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, userLoginFailed=userLoginFailed, controllerDown=controllerDown, smisServiceStarted=smisServiceStarted, diskTotalReadMbps=diskTotalReadMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, upgradeDownloadStarted=upgradeDownloadStarted, iscsiWriteIops=iscsiWriteIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, haResourceDescription=haResourceDescription, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectDataSizeLow=projectDataSizeLow, fcTotalReadIops=fcTotalReadIops, shareNFSWriteMbps=shareNFSWriteMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, haControllerA_Uptime=haControllerA_Uptime, volumeModifyCompleted=volumeModifyCompleted, shareQuotaFinished=shareQuotaFinished, cacheSSDReads=cacheSSDReads, poolFreeSizeLow=poolFreeSizeLow, upgradeStarted=upgradeStarted, nvdimmFailInitializationError=nvdimmFailInitializationError, lunSnapshotSizeHigh=lunSnapshotSizeHigh, haResourcesTable=haResourcesTable, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, maintenanceModeDisabled=maintenanceModeDisabled, fcInitiatorCreateFailed=fcInitiatorCreateFailed, snmpServiceStopped=snmpServiceStopped, networkIpmpGroupUp=networkIpmpGroupUp, lunProjectName=lunProjectName, lunWriteMbps=lunWriteMbps, notifications=notifications, fcInitiatorGroup=fcInitiatorGroup, basicCompliance=basicCompliance, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiTargetAuth=iscsiTargetAuth, ipmiVoltage=ipmiVoltage, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, replicationSourceRegistered=replicationSourceRegistered, cpuSystemCalls=cpuSystemCalls, notificationEventCode=notificationEventCode, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolDataReadMbps=poolDataReadMbps, haControllerB_IPAddr=haControllerB_IPAddr, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, vmwareNFSDatastores=vmwareNFSDatastores, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, sanProperties=sanProperties, poolAvgWriteLatency=poolAvgWriteLatency, lunProtocol=lunProtocol, projectTotalSaving=projectTotalSaving, nicName=nicName, targetGroupDeleteCompleted=targetGroupDeleteCompleted, fcTargets=fcTargets, iscsiTargetReadLatency=iscsiTargetReadLatency, snapshotCloningFailed=snapshotCloningFailed, lunReservedSizeHigh=lunReservedSizeHigh, shareCIFSWriteMbps=shareCIFSWriteMbps, notificationSensorNumber=notificationSensorNumber, diskState=diskState, replicationStarted=replicationStarted, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolDataSizeLow=poolDataSizeLow, lunCompressedRatio=lunCompressedRatio, poolTotalReadMbps=poolTotalReadMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, replicationPaused=replicationPaused, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, replicationComplete=replicationComplete, poolMetaWriteIops=poolMetaWriteIops, nfsTotalWriteIops=nfsTotalWriteIops, haControllerA_IPAddr=haControllerA_IPAddr, nicState=nicState, nicTable=nicTable, snapshotRollbackFailed=snapshotRollbackFailed, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, network=network, snmpServiceStarted=snmpServiceStarted, fcPortOffline=fcPortOffline, fcTargetWriteLatency=fcTargetWriteLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareDataSizeHigh=shareDataSizeHigh, replicationAbandoned=replicationAbandoned, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiTotalReadIops=iscsiTotalReadIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiTargetsTable=iscsiTargetsTable, lunInitiatorGroup=lunInitiatorGroup, poolSizeHigh=poolSizeHigh, poolMetaReadIops=poolMetaReadIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, replicationFailed=replicationFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, globalStatistics=globalStatistics, projectShares=projectShares, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, ntpServerTimeDrift=ntpServerTimeDrift, projectDeletionFailed=projectDeletionFailed, shareCreatedSuccessfully=shareCreatedSuccessfully, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, nvdimmFailSoftError=nvdimmFailSoftError, shareEntry=shareEntry, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectQuotaSizeHigh=projectQuotaSizeHigh, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, networkIpmpGroupDown=networkIpmpGroupDown, iscsiInitiatorIndex=iscsiInitiatorIndex, nicIndex=nicIndex, ipmiThreshold=ipmiThreshold, snmpServiceStopFailed=snmpServiceStopFailed, currentNotificationGroup=currentNotificationGroup, snmpServiceStartFailed=snmpServiceStartFailed, replicationTargetDeleted=replicationTargetDeleted, fcTargetGroup=fcTargetGroup, notificationSensorSuspect=notificationSensorSuspect, poolEntry=poolEntry, lunBlockSize=lunBlockSize, projectLUNs=projectLUNs, cpuInterrupts=cpuInterrupts, cifsAvgReadLatency=cifsAvgReadLatency, shareNFSReadMbps=shareNFSReadMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareQuotaLow=shareQuotaLow, notificationTargetEntityName=notificationTargetEntityName, iscsiProperties=iscsiProperties, ipmiCriticalInterrupt=ipmiCriticalInterrupt, sensorFailureEvent=sensorFailureEvent, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectDeleted=projectDeleted, netbiosSocketFailure=netbiosSocketFailure, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, fcProperties=fcProperties, diskTotalReadIops=diskTotalReadIops, shareCIFSWriteLatency=shareCIFSWriteLatency, webdocsUpgradeCompleted=webdocsUpgradeCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareCIFSWriteIops=shareCIFSWriteIops, ipmiPowerSupply=ipmiPowerSupply, nfsTotalReadIops=nfsTotalReadIops, haResources=haResources, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diskEntry=diskEntry, currentObjectGroup=currentObjectGroup, nvdimmFailUnknownError=nvdimmFailUnknownError, nfsAvgReadLatency=nfsAvgReadLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, nfsTotalWriteMbps=nfsTotalWriteMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolExported=poolExported, lunTable=lunTable, cpuTotalUsage=cpuTotalUsage, poolUsedSizeHigh=poolUsedSizeHigh, fcTargetWriteMbps=fcTargetWriteMbps, poolProjects=poolProjects, poolName=poolName, diskAlias=diskAlias, haResourceIndex=haResourceIndex, notificationReadingUnit=notificationReadingUnit, poolDataWriteMbps=poolDataWriteMbps, targetGroupMemberRemoved=targetGroupMemberRemoved)
mibBuilder.exportSymbols("TEGILE-MIB", diskDataReadMbps=diskDataReadMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareReservedSizeHigh=shareReservedSizeHigh, shareMountPoint=shareMountPoint, alertsCleanupCompleted=alertsCleanupCompleted, poolDeletionFailed=poolDeletionFailed, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, ipmiMemory=ipmiMemory, nicGroup=nicGroup, lunGUID=lunGUID, nicReceiveMbps=nicReceiveMbps, deleteFolderCompleted=deleteFolderCompleted, lunDedupEnabled=lunDedupEnabled, lunReadMbps=lunReadMbps, diskPoolName=diskPoolName, iscsiTargetIndex=iscsiTargetIndex, iscsiTargetReadMbps=iscsiTargetReadMbps, iscsiTargetGroupError=iscsiTargetGroupError, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskIOCount=diskIOCount, iscsiTotalReadMbps=iscsiTotalReadMbps, notificationObjects=notificationObjects, projectShareCount=projectShareCount, shareTable=shareTable, fcTargetReadMbps=fcTargetReadMbps, poolIndex=poolIndex, poolProjectCount=poolProjectCount, lunSizeLow=lunSizeLow, fcInitiators=fcInitiators, haControllerB_Uptime=haControllerB_Uptime, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, smbSocketFailure=smbSocketFailure, diskIndex=diskIndex, cacheTotalReadIops=cacheTotalReadIops, diskType=diskType, volumeQuotaFinished=volumeQuotaFinished, diskCount=diskCount, shareDeleted=shareDeleted, lunReadIops=lunReadIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcTargetsTable=fcTargetsTable, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcInitiatorIndex=fcInitiatorIndex, nicEntry=nicEntry, shareQuotaHigh=shareQuotaHigh, iscsiInitiators=iscsiInitiators, snmpAgentVersion=snmpAgentVersion, shareCIFSReadIops=shareCIFSReadIops, poolSizeLow=poolSizeLow, aclMigrationCompleted=aclMigrationCompleted, shareProjectName=shareProjectName, upgradeDownloadCompleted=upgradeDownloadCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, nfsTotalReadMbps=nfsTotalReadMbps, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, projectPoolName=projectPoolName, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcTargetEntry=fcTargetEntry, deleteFolderFailed=deleteFolderFailed, shareCompressedRatio=shareCompressedRatio, diskAvgWriteLatency=diskAvgWriteLatency, poolTotalWriteIops=poolTotalWriteIops, lunDataSizeLow=lunDataSizeLow, maintenanceModeEnabled=maintenanceModeEnabled, aclMigrationStarted=aclMigrationStarted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolFreeSizeHigh=poolFreeSizeHigh, iscsiTargetError=iscsiTargetError, poolReadCacheReadLatency=poolReadCacheReadLatency, shareIndex=shareIndex, shareNFSWriteLatency=shareNFSWriteLatency, projectFreeSizeLow=projectFreeSizeLow, nfsAvgWriteLatency=nfsAvgWriteLatency, projectName=projectName, diskSlowIo=diskSlowIo, notificationDescription=notificationDescription, projectCompressionEnabled=projectCompressionEnabled, poolDeleted=poolDeleted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, lunFreeSizeLow=lunFreeSizeLow, haControllerA_Name=haControllerA_Name, fcAvgReadLatency=fcAvgReadLatency, cacheTotalReadMbps=cacheTotalReadMbps, shareNFSWriteIops=shareNFSWriteIops, lunSnapshotSizeLow=lunSnapshotSizeLow, tdpsUpgradeTimeout=tdpsUpgradeTimeout, projectEntry=projectEntry, notificationSensorAction=notificationSensorAction, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, snapshotRollbackCompleted=snapshotRollbackCompleted, poolTotalSaving=poolTotalSaving, replicationAborted=replicationAborted, cifsTotalWriteMbps=cifsTotalWriteMbps, tegileArray_notifications=tegileArray_notifications, unknownSensorEvent=unknownSensorEvent, poolDegraded=poolDegraded, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolImported=poolImported, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, targetGroupCreateCompleted=targetGroupCreateCompleted, haResourceGroup=haResourceGroup, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, pools=pools, iscsiTargetAlias=iscsiTargetAlias, poolTotalWriteMbps=poolTotalWriteMbps, diskSequentialIOCount=diskSequentialIOCount, controllerTimeDrift=controllerTimeDrift, cifsTotalReadIops=cifsTotalReadIops, shareDataSizeLow=shareDataSizeLow, diskDataWriteMbps=diskDataWriteMbps, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiAvgWriteLatency=iscsiAvgWriteLatency, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunSizeHigh=lunSizeHigh, lunFreeSizeHigh=lunFreeSizeHigh, poolCount=poolCount, iscsiAvgReadLatency=iscsiAvgReadLatency, ipmiTemperature=ipmiTemperature, projectCreatedSuccessfully=projectCreatedSuccessfully, volumeDeleteCompleted=volumeDeleteCompleted, smisServiceStartFailed=smisServiceStartFailed, nicTransmitMbps=nicTransmitMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, iscsiInitiatorGroup=iscsiInitiatorGroup, projectSnapshotSizeLow=projectSnapshotSizeLow, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolDataReadLatency=poolDataReadLatency, iscsiInitiatorName=iscsiInitiatorName, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, haResourceName=haResourceName, disks=disks, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskDataWriteIops=diskDataWriteIops, fcTargetModifyCompleted=fcTargetModifyCompleted, fcTotalWriteIops=fcTotalWriteIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolOwnerController=poolOwnerController, haResourceActiveNode=haResourceActiveNode, ipmiFan=ipmiFan, haControllerB_Name=haControllerB_Name, poolHealth=poolHealth, projectSnapshotSizeHigh=projectSnapshotSizeHigh, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiTargetName=iscsiTargetName, poolQuotaFinished=poolQuotaFinished, diagnosticDataUploaded=diagnosticDataUploaded, nicMTU=nicMTU, fcTotalWriteMbps=fcTotalWriteMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, adServerTimeDrift=adServerTimeDrift, lunReadLatency=lunReadLatency, diskChassisIdx=diskChassisIdx, volumeDeleteFailed=volumeDeleteFailed, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolMetaReadMbps=poolMetaReadMbps, projectDataSizeHigh=projectDataSizeHigh, projectTable=projectTable, diskGoneOffline=diskGoneOffline, cacheTotalWriteMbps=cacheTotalWriteMbps, snapshotCloneCompleted=snapshotCloneCompleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiTargetWriteIops=iscsiTargetWriteIops, diskTotalWriteIops=diskTotalWriteIops, fcTargetIndex=fcTargetIndex, poolDataReadIops=poolDataReadIops, fcAvgWriteLatency=fcAvgWriteLatency, notificationTime=notificationTime, poolCreated=poolCreated, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, lunEntry=lunEntry, upgradeFailed=upgradeFailed, shareReservedSizeLow=shareReservedSizeLow, tegileCompliances=tegileCompliances, tegile=tegile, notificationComponentName=notificationComponentName, projectIndex=projectIndex, sharePoolName=sharePoolName, diskTotalWriteMbps=diskTotalWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, tegileGroups=tegileGroups, lunPoolName=lunPoolName, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, targetGroupMemberAdded=targetGroupMemberAdded, lunTargetGroup=lunTargetGroup, fcInitiatorName=fcInitiatorName, projectDedupEnabled=projectDedupEnabled, fcTargetStatus=fcTargetStatus, fcTargetName=fcTargetName, shareDeletionFailed=shareDeletionFailed, poolMetaWriteLatency=poolMetaWriteLatency, shareName=shareName, lunCompressionEnabled=lunCompressionEnabled, iscsiTargetReadIops=iscsiTargetReadIops, poolAvgReadLatency=poolAvgReadLatency, tdpsUpgradeFailed=tdpsUpgradeFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolState=poolState, diskError=diskError, poolMetaWriteMbps=poolMetaWriteMbps, poolUpgraded=poolUpgraded, cacheTotalWriteIops=cacheTotalWriteIops, memoryFailure=memoryFailure, controllerUp=controllerUp, shareCompressionEnabled=shareCompressionEnabled, fcTotalReadMbps=fcTotalReadMbps, networkInterfaceUp=networkInterfaceUp)
