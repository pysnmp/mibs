...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:40:56 2023
...
Counter64, Integer32, Gauge32, ModuleIdentity, iso, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, TimeTicks, ObjectIdentity, MibIdentifier, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "Gauge32", "ModuleIdentity", "iso", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "TimeTicks", "ObjectIdentity", "MibIdentifier", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, PYSNMP_MODULE_ID=tegile, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, networkIpmpGroupDown=networkIpmpGroupDown, upgradeCompleted=upgradeCompleted, diskSizeHigh=diskSizeHigh, projectQuotaSizeHigh=projectQuotaSizeHigh, nicGroup=nicGroup, projectTotalSaving=projectTotalSaving, diskDataReadMbps=diskDataReadMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcTargetReadLatency=fcTargetReadLatency, volumeModifyCompleted=volumeModifyCompleted, replicationSourceRegistered=replicationSourceRegistered, pools=pools, lunFreeSizeLow=lunFreeSizeLow, nfsAvgReadLatency=nfsAvgReadLatency, notificationTime=notificationTime, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcPortOffline=fcPortOffline, projectCompressionEnabled=projectCompressionEnabled, properties=properties, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiProperties=iscsiProperties, nicEntry=nicEntry, shareReservedSizeHigh=shareReservedSizeHigh, projectFreeSizeLow=projectFreeSizeLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareCIFSWriteIops=shareCIFSWriteIops, poolDataWriteMbps=poolDataWriteMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, upgradeDownloadStarted=upgradeDownloadStarted, haControllerB_IPAddr=haControllerB_IPAddr, poolUpgraded=poolUpgraded, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diagnosticDataUploaded=diagnosticDataUploaded, iscsiTotalReadIops=iscsiTotalReadIops, notificationSensorAction=notificationSensorAction, poolUsedSizeHigh=poolUsedSizeHigh, lunWriteIops=lunWriteIops, replicationResumed=replicationResumed, iscsiInitiators=iscsiInitiators, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, volumeQuotaFinished=volumeQuotaFinished, initiatorGroupMemberAdded=initiatorGroupMemberAdded, cacheTotalWriteMbps=cacheTotalWriteMbps, notificationTargetEntityName=notificationTargetEntityName, poolReadCacheWriteIops=poolReadCacheWriteIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, lunName=lunName, shareCompressionEnabled=shareCompressionEnabled, upgradeDownloadCompleted=upgradeDownloadCompleted, networkInterfaceDown=networkInterfaceDown, fcInitiatorCreateFailed=fcInitiatorCreateFailed, aclMigrationCompleted=aclMigrationCompleted, controllerUp=controllerUp, ipmiThreshold=ipmiThreshold, lunEntry=lunEntry, diskChassisIdx=diskChassisIdx, alertsCleanupCompleted=alertsCleanupCompleted, basicCompliance=basicCompliance, shareNFSEnabled=shareNFSEnabled, poolDataWriteIops=poolDataWriteIops, cacheSSDReads=cacheSSDReads, fcTargetWriteIops=fcTargetWriteIops, memoryFailure=memoryFailure, unknownSensorEvent=unknownSensorEvent, cacheTotalReadMbps=cacheTotalReadMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, lunDataSizeLow=lunDataSizeLow, poolTotalWriteIops=poolTotalWriteIops, poolFreeSizeHigh=poolFreeSizeHigh, smbSocketFailure=smbSocketFailure, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolDataWriteLatency=poolDataWriteLatency, ipmiOther=ipmiOther, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, cacheTotalWriteIops=cacheTotalWriteIops, snmpServiceStopped=snmpServiceStopped, ipmiVoltage=ipmiVoltage, poolDeleted=poolDeleted, diskCount=diskCount, diskAvgWriteLatency=diskAvgWriteLatency, upgradeTimeout=upgradeTimeout, lunReadIops=lunReadIops, disks=disks, fcTargetName=fcTargetName, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolMetaReadLatency=poolMetaReadLatency, nicName=nicName, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareNFSReadMbps=shareNFSReadMbps, currentNotificationGroup=currentNotificationGroup, poolIndex=poolIndex, smisServiceStopped=smisServiceStopped, iscsiTargetIndex=iscsiTargetIndex, lunSizeHigh=lunSizeHigh, projectModified=projectModified, fcTargetWriteMbps=fcTargetWriteMbps, replicationAbandoned=replicationAbandoned, controllerDown=controllerDown, iscsiTargetsTable=iscsiTargetsTable, projectName=projectName, iscsiInitiatorEntry=iscsiInitiatorEntry, upgradeDownloadFailed=upgradeDownloadFailed, projectLUNs=projectLUNs, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectShareCount=projectShareCount, shareNFSReadLatency=shareNFSReadLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, tegileArray_notifications=tegileArray_notifications, poolDeletionFailed=poolDeletionFailed, controllerTimeDrift=controllerTimeDrift, shareDeleted=shareDeleted, projectTable=projectTable, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, poolMetaWriteMbps=poolMetaWriteMbps, poolTotalReadMbps=poolTotalReadMbps, poolExpanded=poolExpanded, poolAvgWriteLatency=poolAvgWriteLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolDataSizeLow=poolDataSizeLow, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectSnapshotSizeLow=projectSnapshotSizeLow, tegileGroups=tegileGroups, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, tegile=tegile, poolMetaWriteLatency=poolMetaWriteLatency, poolState=poolState, lunInitiatorGroup=lunInitiatorGroup, cifsAvgWriteLatency=cifsAvgWriteLatency, sharePoolName=sharePoolName, projectCreatedSuccessfully=projectCreatedSuccessfully, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareDataSizeHigh=shareDataSizeHigh, poolHealth=poolHealth, diskAvgReadLatency=diskAvgReadLatency, network=network, networkInterfaceUp=networkInterfaceUp, shareReservedSizeLow=shareReservedSizeLow, lunGUID=lunGUID, ipmiMemory=ipmiMemory, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, nvdimmFailUnknownError=nvdimmFailUnknownError, diskPoolName=diskPoolName, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, cifsTotalWriteIops=cifsTotalWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, diskIOCount=diskIOCount, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, aclMigrationStarted=aclMigrationStarted, fcTargetIndex=fcTargetIndex, poolEntry=poolEntry, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectFreeSizeHigh=projectFreeSizeHigh, nicReceiveMbps=nicReceiveMbps, diskAlias=diskAlias, fcTargetStatus=fcTargetStatus, cpuInterrupts=cpuInterrupts, nvdimmFailSoftError=nvdimmFailSoftError, iscsiTargetGroupError=iscsiTargetGroupError, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolDataReadMbps=poolDataReadMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunBlockSize=lunBlockSize, lunSnapshotSizeLow=lunSnapshotSizeLow, snmpServiceStopFailed=snmpServiceStopFailed, haResourceName=haResourceName, lunSnapshotSizeHigh=lunSnapshotSizeHigh, shareNFSWriteMbps=shareNFSWriteMbps, shareQuotaFinished=shareQuotaFinished, haResourceStatus=haResourceStatus, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, testNotification=testNotification, poolDataSizeHigh=poolDataSizeHigh, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, adServerTimeDrift=adServerTimeDrift, iscsiInitiatorGroup=iscsiInitiatorGroup, sanProperties=sanProperties, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, diskEntry=diskEntry, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareCIFSReadMbps=shareCIFSReadMbps, haResourceIndex=haResourceIndex, lunReservedSizeLow=lunReservedSizeLow, diskTotalWriteMbps=diskTotalWriteMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, haControllerA_Uptime=haControllerA_Uptime, iscsiTargetAlias=iscsiTargetAlias, poolDegraded=poolDegraded, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, diskSlowIo=diskSlowIo, snapshotDeleteFailed=snapshotDeleteFailed, poolName=poolName, poolUsedSizeLow=poolUsedSizeLow, lunCompressionEnabled=lunCompressionEnabled, diskRandomIOCount=diskRandomIOCount, deleteFolderCompleted=deleteFolderCompleted, notificationProps=notificationProps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectEntry=projectEntry, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diskTable=diskTable, nicMTU=nicMTU, targetGroupDeleteCompleted=targetGroupDeleteCompleted, replicationFailed=replicationFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiTargetAuth=iscsiTargetAuth, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcInitiatorsTable=fcInitiatorsTable, shareCIFSWriteMbps=shareCIFSWriteMbps, shareCIFSEnabled=shareCIFSEnabled, lunFreeSizeHigh=lunFreeSizeHigh, poolTable=poolTable, haResourceGroup=haResourceGroup, fcTargetReadMbps=fcTargetReadMbps, poolWriteCacheWriteIops=poolWriteCacheWriteIops, diskType=diskType, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, lunTable=lunTable, haControllerB_Uptime=haControllerB_Uptime, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, tegileCompliances=tegileCompliances, targetGroupMemberAdded=targetGroupMemberAdded, shareNFSWriteIops=shareNFSWriteIops, currentObjectGroup=currentObjectGroup, replicationTargetDeleted=replicationTargetDeleted, maintenanceModeDisabled=maintenanceModeDisabled, tegileArray=tegileArray, diskSequentialIOCount=diskSequentialIOCount, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, haControllerB_Name=haControllerB_Name, tegileConformance=tegileConformance, poolSizeLow=poolSizeLow, projectQuotaSizeLow=projectQuotaSizeLow, nfsTotalWriteIops=nfsTotalWriteIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunTargetGroup=lunTargetGroup, nfsAvgWriteLatency=nfsAvgWriteLatency, smisServiceStopFailed=smisServiceStopFailed, projectDedupEnabled=projectDedupEnabled, tdpsUpgradeCompleted=tdpsUpgradeCompleted, snmpServiceStarted=snmpServiceStarted, iscsiTargetEntry=iscsiTargetEntry)
mibBuilder.exportSymbols("TEGILE-MIB", diskDataWriteIops=diskDataWriteIops, networkTotalTransmitMbps=networkTotalTransmitMbps, lunProtocol=lunProtocol, shareCompressedRatio=shareCompressedRatio, poolImported=poolImported, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, replicationPaused=replicationPaused, nfsTotalReadMbps=nfsTotalReadMbps, projectLunCount=projectLunCount, intelliFlashSoftwareDown=intelliFlashSoftwareDown, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcInitiatorName=fcInitiatorName, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, networkIpmpGroupUp=networkIpmpGroupUp, diskIsOnline=diskIsOnline, lunCompressedRatio=lunCompressedRatio, poolFreeSizeLow=poolFreeSizeLow, haControllerA_IPAddr=haControllerA_IPAddr, targetGroupCreateCompleted=targetGroupCreateCompleted, lunDedupEnabled=lunDedupEnabled, iscsiTargetError=iscsiTargetError, notificationDescription=notificationDescription, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snapshotCloningFailed=snapshotCloningFailed, lunWriteMbps=lunWriteMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, lunProjectName=lunProjectName, fcAvgReadLatency=fcAvgReadLatency, notifications=notifications, lunReadLatency=lunReadLatency, shareIndex=shareIndex, cifsTotalReadMbps=cifsTotalReadMbps, shareQuotaLow=shareQuotaLow, poolAvgReadLatency=poolAvgReadLatency, poolMetaReadIops=poolMetaReadIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolCount=poolCount, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcTargetsTable=fcTargetsTable, poolMetaReadMbps=poolMetaReadMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, controllerHardwareModel=controllerHardwareModel, poolDataReadLatency=poolDataReadLatency, lunWriteLatency=lunWriteLatency, iscsiTargetReadIops=iscsiTargetReadIops, diskTotalWriteIops=diskTotalWriteIops, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcInitiatorEntry=fcInitiatorEntry, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, volumeDeleteCompleted=volumeDeleteCompleted, diskDataWriteMbps=diskDataWriteMbps, deleteFolderFailed=deleteFolderFailed, projectDataSizeHigh=projectDataSizeHigh, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, haResources=haResources, shareNFSWriteLatency=shareNFSWriteLatency, poolTotalWriteMbps=poolTotalWriteMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiTargets=iscsiTargets, replicationStarted=replicationStarted, iscsiInitiatorName=iscsiInitiatorName, replicationComplete=replicationComplete, cifsAvgReadLatency=cifsAvgReadLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, diskState=diskState, shareSnapshotSizeLow=shareSnapshotSizeLow, poolProjects=poolProjects, nicTable=nicTable, poolExported=poolExported, iscsiTargetGroup=iscsiTargetGroup, iscsiAvgWriteLatency=iscsiAvgWriteLatency, notificationReadingUnit=notificationReadingUnit, iscsiTargetReadLatency=iscsiTargetReadLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, netbiosSocketFailure=netbiosSocketFailure, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, upgradeStarted=upgradeStarted, fcTargetEntry=fcTargetEntry, fcTotalReadMbps=fcTotalReadMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectIndex=projectIndex, nvdimmFailInitializationError=nvdimmFailInitializationError, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolDataReadIops=poolDataReadIops, shareDeletionFailed=shareDeletionFailed, iscsiInitiatorsTable=iscsiInitiatorsTable, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcAvgWriteLatency=fcAvgWriteLatency, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, haResourceActiveNode=haResourceActiveNode, iscsiTargetWriteMbps=iscsiTargetWriteMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, diskGoneOffline=diskGoneOffline, snapshotCloneCompleted=snapshotCloneCompleted, diskSizeLow=diskSizeLow, haResourcesTable=haResourcesTable, haControllerA_Name=haControllerA_Name, lunIndex=lunIndex, diskIndex=diskIndex, cacheTotalReadIops=cacheTotalReadIops, targetGroupMemberRemoved=targetGroupMemberRemoved, globalStatistics=globalStatistics, volumeDeleteFailed=volumeDeleteFailed, snmpAgentVersion=snmpAgentVersion, snapshotCreationFailed=snapshotCreationFailed, cpuSystemCalls=cpuSystemCalls, haResourceEntry=haResourceEntry, nicIndex=nicIndex, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareNFSReadIops=shareNFSReadIops, diskTotalReadIops=diskTotalReadIops, nfsTotalReadIops=nfsTotalReadIops, iscsiTargetReadMbps=iscsiTargetReadMbps, poolTotalReadIops=poolTotalReadIops, fcTargetReadIops=fcTargetReadIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcTargetWriteLatency=fcTargetWriteLatency, cifsTotalReadIops=cifsTotalReadIops, poolOwnerController=poolOwnerController, shareDataSizeLow=shareDataSizeLow, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, ipmiFan=ipmiFan, notificationComponentName=notificationComponentName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareName=shareName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, userLoginFailed=userLoginFailed, ipmiTemperature=ipmiTemperature, notificationSeverity=notificationSeverity, shareQuotaHigh=shareQuotaHigh, fcInitiators=fcInitiators, sensorFailureEvent=sensorFailureEvent, fcTargetModifyCompleted=fcTargetModifyCompleted, projectPoolName=projectPoolName, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, projectShares=projectShares, ipmiCurrent=ipmiCurrent, notificationObjects=notificationObjects, shareDedupEnabled=shareDedupEnabled, poolMetaWriteIops=poolMetaWriteIops, projectDeletionFailed=projectDeletionFailed, snmpServiceStartFailed=snmpServiceStartFailed, ipmiPowerSupply=ipmiPowerSupply, vmwareNFSDatastores=vmwareNFSDatastores, smisServiceStarted=smisServiceStarted, fcTotalWriteMbps=fcTotalWriteMbps, notificationEventCode=notificationEventCode, diskDataReadIops=diskDataReadIops, projectDataSizeLow=projectDataSizeLow, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, notificationSensorSuspect=notificationSensorSuspect, poolQuotaFinished=poolQuotaFinished, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolReadCacheReadIops=poolReadCacheReadIops, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiWriteIops=iscsiWriteIops, fcTargets=fcTargets, cpuTotalUsage=cpuTotalUsage, lunPoolName=lunPoolName, shareCIFSReadLatency=shareCIFSReadLatency, diskTotalReadMbps=diskTotalReadMbps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, upgradeFailed=upgradeFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, nicState=nicState, fcTargetGroup=fcTargetGroup, fcTotalWriteIops=fcTotalWriteIops, fcInitiatorIndex=fcInitiatorIndex, poolProjectCount=poolProjectCount, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareCIFSWriteLatency=shareCIFSWriteLatency, shareMountPoint=shareMountPoint, shareProjectName=shareProjectName, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcTotalReadIops=fcTotalReadIops, lunSizeLow=lunSizeLow, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskError=diskError, smisServiceStartFailed=smisServiceStartFailed, fcInitiatorGroup=fcInitiatorGroup, poolSizeHigh=poolSizeHigh, haResourceDescription=haResourceDescription, cacheRAMReads=cacheRAMReads, lunReservedSizeHigh=lunReservedSizeHigh, spareDiskReplaced=spareDiskReplaced, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, ntpServerTimeDrift=ntpServerTimeDrift, iscsiImproperTargetGroup=iscsiImproperTargetGroup, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiTotalReadMbps=iscsiTotalReadMbps, shareEntry=shareEntry, lunReadMbps=lunReadMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectQuotaFinished=projectQuotaFinished, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareTable=shareTable, fcProperties=fcProperties, shareCIFSReadIops=shareCIFSReadIops, nicTransmitMbps=nicTransmitMbps, projectDeleted=projectDeleted, iscsiTargetName=iscsiTargetName, lunDataSizeHigh=lunDataSizeHigh, replicationAborted=replicationAborted, fcPortOnline=fcPortOnline, poolTotalSaving=poolTotalSaving, cifsTotalWriteMbps=cifsTotalWriteMbps, maintenanceModeEnabled=maintenanceModeEnabled, poolCreated=poolCreated, snapshotRollbackFailed=snapshotRollbackFailed, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps)
