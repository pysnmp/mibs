...
# Produced by pysmi-1.1.0 at Fri Nov 19 14:57:25 2021
...
Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Integer32, IpAddress, ModuleIdentity, iso, MibIdentifier, ObjectIdentity, Unsigned32, TimeTicks, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Integer32", "IpAddress", "ModuleIdentity", "iso", "MibIdentifier", "ObjectIdentity", "Unsigned32", "TimeTicks", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("TEGILE-MIB", notificationSensorNumber=notificationSensorNumber, iscsiTargetAlias=iscsiTargetAlias, shareCIFSReadLatency=shareCIFSReadLatency, fcTargetWriteMbps=fcTargetWriteMbps, smbSocketFailure=smbSocketFailure, nfsTotalWriteIops=nfsTotalWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, lunReadMbps=lunReadMbps, iscsiProperties=iscsiProperties, projectDeletionFailed=projectDeletionFailed, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunTable=lunTable, snapshotDeleteFailed=snapshotDeleteFailed, poolUpgraded=poolUpgraded, diskTotalWriteIops=diskTotalWriteIops, diskSizeHigh=diskSizeHigh, lunIndex=lunIndex, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, upgradeDownloadStarted=upgradeDownloadStarted, lunSizeLow=lunSizeLow, notificationSeverity=notificationSeverity, nicState=nicState, diskIndex=diskIndex, ipmiCriticalInterrupt=ipmiCriticalInterrupt, lunProjectName=lunProjectName, notificationReadingTriggerValue=notificationReadingTriggerValue, tegileCompliances=tegileCompliances, nfsTotalReadIops=nfsTotalReadIops, fcInitiatorsTable=fcInitiatorsTable, projectLunCount=projectLunCount, lunGUID=lunGUID, upgradeTimeout=upgradeTimeout, shareName=shareName, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, diskState=diskState, shareCIFSWriteIops=shareCIFSWriteIops, diskDataReadIops=diskDataReadIops, nvdimmFailSoftError=nvdimmFailSoftError, poolReadCacheReadLatency=poolReadCacheReadLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, controllerTimeDrift=controllerTimeDrift, projectShares=projectShares, shareDeleted=shareDeleted, shareQuotaLow=shareQuotaLow, cifsAvgReadLatency=cifsAvgReadLatency, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolTotalReadMbps=poolTotalReadMbps, poolProjects=poolProjects, spareDiskReplaced=spareDiskReplaced, poolMetaReadMbps=poolMetaReadMbps, notificationReadingUnit=notificationReadingUnit, projectFreeSizeLow=projectFreeSizeLow, cacheRAMReads=cacheRAMReads, tdpsUpgradeFailed=tdpsUpgradeFailed, projectModified=projectModified, poolFreeSizeHigh=poolFreeSizeHigh, haResourcesTable=haResourcesTable, diskSequentialIOCount=diskSequentialIOCount, poolDataWriteLatency=poolDataWriteLatency, shareReservedSizeLow=shareReservedSizeLow, notificationEventCode=notificationEventCode, fcTotalWriteMbps=fcTotalWriteMbps, poolEntry=poolEntry, poolTable=poolTable, smisServiceStartFailed=smisServiceStartFailed, userLoginFailed=userLoginFailed, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareDataSizeLow=shareDataSizeLow, poolDataSizeHigh=poolDataSizeHigh, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcTargets=fcTargets, iscsiInitiatorGroup=iscsiInitiatorGroup, poolReadCacheReadMbps=poolReadCacheReadMbps, cacheTotalReadIops=cacheTotalReadIops, fcTargetReadMbps=fcTargetReadMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, fcTargetIndex=fcTargetIndex, shareSnapshotSizeLow=shareSnapshotSizeLow, projectDedupEnabled=projectDedupEnabled, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, globalStatistics=globalStatistics, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, shareNFSEnabled=shareNFSEnabled, diskTable=diskTable, poolSizeHigh=poolSizeHigh, iscsiInitiatorsTable=iscsiInitiatorsTable, projectSnapshotSizeLow=projectSnapshotSizeLow, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, diskGoneOffline=diskGoneOffline, snapshotRollbackFailed=snapshotRollbackFailed, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolOwnerController=poolOwnerController, haControllerB_Uptime=haControllerB_Uptime, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskTotalWriteMbps=diskTotalWriteMbps, poolHealth=poolHealth, poolDataWriteIops=poolDataWriteIops, shareNFSReadIops=shareNFSReadIops, shareCIFSEnabled=shareCIFSEnabled, lunEntry=lunEntry, fcTotalReadIops=fcTotalReadIops, projectShareCount=projectShareCount, testNotification=testNotification, tegileGroups=tegileGroups, fcTargetName=fcTargetName, snmpServiceStopFailed=snmpServiceStopFailed, poolDataReadIops=poolDataReadIops, shareNFSReadLatency=shareNFSReadLatency, poolDataWriteMbps=poolDataWriteMbps, projectTotalSaving=projectTotalSaving, iscsiAvgWriteLatency=iscsiAvgWriteLatency, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiInitiatorEntry=iscsiInitiatorEntry, poolState=poolState, projectDeleted=projectDeleted, diskRandomIOCount=diskRandomIOCount, nfsAvgReadLatency=nfsAvgReadLatency, unknownSensorEvent=unknownSensorEvent, fcPortOffline=fcPortOffline, cacheTotalWriteIops=cacheTotalWriteIops, notificationProps=notificationProps, fcInitiatorGroup=fcInitiatorGroup, upgradeStarted=upgradeStarted, volumeDeleteCompleted=volumeDeleteCompleted, diskSlowIo=diskSlowIo, poolDegraded=poolDegraded, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcInitiatorIndex=fcInitiatorIndex, pools=pools, diskDataWriteMbps=diskDataWriteMbps, ipmiMemory=ipmiMemory, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolTotalReadIops=poolTotalReadIops, diskType=diskType, poolIndex=poolIndex, snmpAgentVersion=snmpAgentVersion, lunBlockSize=lunBlockSize, cpuTotalUsage=cpuTotalUsage, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, smisServiceStopFailed=smisServiceStopFailed, lunFreeSizeHigh=lunFreeSizeHigh, fcTargetReadLatency=fcTargetReadLatency, shareNFSWriteLatency=shareNFSWriteLatency, projectIndex=projectIndex, iscsiTotalReadIops=iscsiTotalReadIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareEntry=shareEntry, volumeQuotaFinished=volumeQuotaFinished, lunProtocol=lunProtocol, intelliFlashSoftwareDown=intelliFlashSoftwareDown, haControllerA_IPAddr=haControllerA_IPAddr, poolMetaWriteIops=poolMetaWriteIops, lunWriteMbps=lunWriteMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, haResourceDescription=haResourceDescription, ipmiFan=ipmiFan, poolDataReadLatency=poolDataReadLatency, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcAvgReadLatency=fcAvgReadLatency, tegile=tegile, diskIOCount=diskIOCount, networkIpmpGroupDown=networkIpmpGroupDown, replicationFailed=replicationFailed, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiWriteIops=iscsiWriteIops, projectCompressionEnabled=projectCompressionEnabled, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, cpuInterrupts=cpuInterrupts, poolWriteCacheWriteIops=poolWriteCacheWriteIops, snapshotRollbackCompleted=snapshotRollbackCompleted, lunReadIops=lunReadIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, nicMTU=nicMTU, iscsiTotalReadMbps=iscsiTotalReadMbps, shareCIFSReadMbps=shareCIFSReadMbps, fcInitiatorName=fcInitiatorName, notifications=notifications, controllerUp=controllerUp, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, snmpServiceStopped=snmpServiceStopped, ipmiPowerSupply=ipmiPowerSupply, lunCompressedRatio=lunCompressedRatio, haResourceName=haResourceName, diskAvgWriteLatency=diskAvgWriteLatency, iscsiTargetsTable=iscsiTargetsTable, cacheSSDReads=cacheSSDReads, iscsiTargetReadIops=iscsiTargetReadIops, snapshotCreationFailed=snapshotCreationFailed, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, replicationAborted=replicationAborted, diskPoolName=diskPoolName, iscsiTargetError=iscsiTargetError, projectDataSizeLow=projectDataSizeLow, volumeCreatedSuccessfully=volumeCreatedSuccessfully, currentNotificationGroup=currentNotificationGroup, ipmiVoltage=ipmiVoltage, lunSnapshotSizeHigh=lunSnapshotSizeHigh, haResourceIndex=haResourceIndex, network=network, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, controllerDown=controllerDown, lunWriteIops=lunWriteIops, diskTotalReadIops=diskTotalReadIops, iscsiTargetReadMbps=iscsiTargetReadMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareTable=shareTable, netbiosSocketFailure=netbiosSocketFailure, maintenanceModeDisabled=maintenanceModeDisabled, iscsiTargetReadLatency=iscsiTargetReadLatency, poolUsedSizeLow=poolUsedSizeLow, diskError=diskError, diskIsOnline=diskIsOnline, targetGroupMemberAdded=targetGroupMemberAdded, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskTotalReadMbps=diskTotalReadMbps, nicGroup=nicGroup, haResourceActiveNode=haResourceActiveNode, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, sanProperties=sanProperties, lunReservedSizeLow=lunReservedSizeLow, upgradeDownloadCompleted=upgradeDownloadCompleted, lunSizeHigh=lunSizeHigh, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunCompressionEnabled=lunCompressionEnabled, fcTotalWriteIops=fcTotalWriteIops, tegileArray_notifications=tegileArray_notifications, nicTransmitMbps=nicTransmitMbps, poolTotalWriteIops=poolTotalWriteIops, volumeModifyCompleted=volumeModifyCompleted, fcTargetsTable=fcTargetsTable, diskChassisIdx=diskChassisIdx, nfsTotalWriteMbps=nfsTotalWriteMbps, ntpServerTimeDrift=ntpServerTimeDrift, aclMigrationCompleted=aclMigrationCompleted, aclMigrationStarted=aclMigrationStarted, nicName=nicName, fcInitiators=fcInitiators, shareCIFSReadIops=shareCIFSReadIops, snapshotCloneCompleted=snapshotCloneCompleted, projectPoolName=projectPoolName, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted)
mibBuilder.exportSymbols("TEGILE-MIB", projectDataSizeHigh=projectDataSizeHigh, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, lunDedupEnabled=lunDedupEnabled, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcProperties=fcProperties, smisServiceStarted=smisServiceStarted, replicationTargetDeleted=replicationTargetDeleted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, haResourceStatus=haResourceStatus, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiInitiators=iscsiInitiators, tegileArray=tegileArray, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareNFSReadMbps=shareNFSReadMbps, poolUsedSizeHigh=poolUsedSizeHigh, snapshotCloningFailed=snapshotCloningFailed, iscsiTargets=iscsiTargets, nvdimmFailDeviceError=nvdimmFailDeviceError, projectCreatedSuccessfully=projectCreatedSuccessfully, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolDataSizeLow=poolDataSizeLow, shareNFSWriteMbps=shareNFSWriteMbps, notificationTargetEntityName=notificationTargetEntityName, poolAvgWriteLatency=poolAvgWriteLatency, smisServiceStopped=smisServiceStopped, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, lunInitiatorGroup=lunInitiatorGroup, lunReadLatency=lunReadLatency, ipmiThreshold=ipmiThreshold, poolFreeSizeLow=poolFreeSizeLow, replicationSourceRegistered=replicationSourceRegistered, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, shareCreatedSuccessfully=shareCreatedSuccessfully, shareIndex=shareIndex, shareCIFSWriteMbps=shareCIFSWriteMbps, networkInterfaceUp=networkInterfaceUp, nicIndex=nicIndex, fcTargetGroup=fcTargetGroup, notificationThresholdTriggerValue=notificationThresholdTriggerValue, ipmiCurrent=ipmiCurrent, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectQuotaSizeLow=projectQuotaSizeLow, replicationPaused=replicationPaused, replicationStarted=replicationStarted, cifsTotalReadMbps=cifsTotalReadMbps, poolDataReadMbps=poolDataReadMbps, notificationComponentName=notificationComponentName, poolProjectCount=poolProjectCount, poolName=poolName, haControllerB_Name=haControllerB_Name, replicationResumed=replicationResumed, notificationDescription=notificationDescription, poolCount=poolCount, networkTotalTransmitMbps=networkTotalTransmitMbps, diskSizeLow=diskSizeLow, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, diskDataReadMbps=diskDataReadMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiTargetGroup=iscsiTargetGroup, iscsiTargetName=iscsiTargetName, poolExported=poolExported, fcTargetWriteIops=fcTargetWriteIops, memoryFailure=memoryFailure, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, sharePoolName=sharePoolName, poolMetaWriteLatency=poolMetaWriteLatency, deleteFolderFailed=deleteFolderFailed, lunReservedSizeHigh=lunReservedSizeHigh, shareDeletionFailed=shareDeletionFailed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, tegileConformance=tegileConformance, nicReceiveMbps=nicReceiveMbps, lunTargetGroup=lunTargetGroup, PYSNMP_MODULE_ID=tegile, ipmiOther=ipmiOther, iscsiInitiatorChapUser=iscsiInitiatorChapUser, replicationComplete=replicationComplete, alertsCleanupCompleted=alertsCleanupCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, nicEntry=nicEntry, iscsiTargetEntry=iscsiTargetEntry, networkTotalReceiveMbps=networkTotalReceiveMbps, lunDataSizeHigh=lunDataSizeHigh, adServerTimeDrift=adServerTimeDrift, lunPoolName=lunPoolName, iscsiTotalWriteMbps=iscsiTotalWriteMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, cacheTotalWriteMbps=cacheTotalWriteMbps, projectTable=projectTable, shareDedupEnabled=shareDedupEnabled, diskCount=diskCount, haResourceEntry=haResourceEntry, diskAvgReadLatency=diskAvgReadLatency, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, projectQuotaFinished=projectQuotaFinished, deleteFolderCompleted=deleteFolderCompleted, poolAvgReadLatency=poolAvgReadLatency, poolTotalSaving=poolTotalSaving, notificationSensorSuspect=notificationSensorSuspect, projectQuotaSizeHigh=projectQuotaSizeHigh, cacheTotalReadMbps=cacheTotalReadMbps, projectThresholdExceedWarning=projectThresholdExceedWarning, haControllerA_Uptime=haControllerA_Uptime, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, shareCompressionEnabled=shareCompressionEnabled, diagnosticDataUploaded=diagnosticDataUploaded, nfsTotalReadMbps=nfsTotalReadMbps, poolMetaReadLatency=poolMetaReadLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, cifsTotalReadIops=cifsTotalReadIops, replicationAbandoned=replicationAbandoned, poolExpanded=poolExpanded, poolTotalWriteMbps=poolTotalWriteMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, notificationObjects=notificationObjects, shareReservedSizeHigh=shareReservedSizeHigh, poolDeletionFailed=poolDeletionFailed, projectLUNs=projectLUNs, fcAvgWriteLatency=fcAvgWriteLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, basicCompliance=basicCompliance, diskEntry=diskEntry, haControllerA_Name=haControllerA_Name, webdocsUpgradeCompleted=webdocsUpgradeCompleted, diskAlias=diskAlias, iscsiInitiatorName=iscsiInitiatorName, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haResourceGroup=haResourceGroup, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectEntry=projectEntry, notificationSensorAction=notificationSensorAction, maintenanceModeEnabled=maintenanceModeEnabled, properties=properties, shareProjectName=shareProjectName, nvdimmFailInitializationError=nvdimmFailInitializationError, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, diskDataWriteIops=diskDataWriteIops, disks=disks, currentObjectGroup=currentObjectGroup, upgradeDownloadFailed=upgradeDownloadFailed, shareQuotaHigh=shareQuotaHigh, networkInterfaceDown=networkInterfaceDown, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolDeleted=poolDeleted, upgradeFailed=upgradeFailed, cifsTotalWriteIops=cifsTotalWriteIops, fcTotalReadMbps=fcTotalReadMbps, poolQuotaFinished=poolQuotaFinished, fcTargetEntry=fcTargetEntry, shareCompressedRatio=shareCompressedRatio, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, snmpServiceStarted=snmpServiceStarted, targetGroupCreateCompleted=targetGroupCreateCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, lunWriteLatency=lunWriteLatency, fcInitiatorEntry=fcInitiatorEntry, upgradeCompleted=upgradeCompleted, snmpServiceStartFailed=snmpServiceStartFailed, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, shareCIFSWriteLatency=shareCIFSWriteLatency, fcInitiatorCreateFailed=fcInitiatorCreateFailed, volumeDeleteFailed=volumeDeleteFailed, fcPortOnline=fcPortOnline, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolReadCacheReadIops=poolReadCacheReadIops, notificationTime=notificationTime, vmwareNFSDatastores=vmwareNFSDatastores, poolMetaReadIops=poolMetaReadIops, poolSizeLow=poolSizeLow, shareNFSWriteIops=shareNFSWriteIops, haResources=haResources, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, lunDataSizeLow=lunDataSizeLow, shareQuotaFinished=shareQuotaFinished, intelliFlashSoftwareUp=intelliFlashSoftwareUp, haControllerB_IPAddr=haControllerB_IPAddr, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, sensorFailureEvent=sensorFailureEvent, cpuSystemCalls=cpuSystemCalls, cifsAvgWriteLatency=cifsAvgWriteLatency, shareMountPoint=shareMountPoint, nicTable=nicTable, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectName=projectName, projectFreeSizeHigh=projectFreeSizeHigh, lunName=lunName, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, networkIpmpGroupUp=networkIpmpGroupUp, lunSnapshotSizeLow=lunSnapshotSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, poolCreated=poolCreated, shareDataSizeHigh=shareDataSizeHigh, lunFreeSizeLow=lunFreeSizeLow, nfsAvgWriteLatency=nfsAvgWriteLatency, controllerHardwareModel=controllerHardwareModel, iscsiTargetAuth=iscsiTargetAuth, fcTargetStatus=fcTargetStatus, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, ipmiTemperature=ipmiTemperature, poolImported=poolImported, fcTargetReadIops=fcTargetReadIops, poolMetaWriteMbps=poolMetaWriteMbps)
