...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, NotificationType, Bits, enterprises, Integer32, TimeTicks, ObjectIdentity, iso, Counter32, Counter64, Gauge32, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "NotificationType", "Bits", "enterprises", "Integer32", "TimeTicks", "ObjectIdentity", "iso", "Counter32", "Counter64", "Gauge32", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetName=iscsiTargetName, tdpsUpgradeFailed=tdpsUpgradeFailed, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, haResourceEntry=haResourceEntry, poolDataWriteIops=poolDataWriteIops, fcTargetReadLatency=fcTargetReadLatency, snapshotDeleteFailed=snapshotDeleteFailed, cacheTotalWriteIops=cacheTotalWriteIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, poolIndex=poolIndex, haControllerA_Name=haControllerA_Name, ipmiMemory=ipmiMemory, cifsTotalReadIops=cifsTotalReadIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, fcTotalWriteIops=fcTotalWriteIops, iscsiTargetWriteIops=iscsiTargetWriteIops, poolDataSizeLow=poolDataSizeLow, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, network=network, iscsiTargetReadLatency=iscsiTargetReadLatency, lunFreeSizeHigh=lunFreeSizeHigh, diskDataWriteIops=diskDataWriteIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolSizeHigh=poolSizeHigh, ipmiCurrent=ipmiCurrent, lunWriteIops=lunWriteIops, shareNFSReadMbps=shareNFSReadMbps, cifsTotalWriteIops=cifsTotalWriteIops, poolUsedSizeLow=poolUsedSizeLow, shareProjectName=shareProjectName, haResourceStatus=haResourceStatus, nvdimmFailDeviceError=nvdimmFailDeviceError, diskIsOnline=diskIsOnline, replicationTargetDeleted=replicationTargetDeleted, poolTotalReadIops=poolTotalReadIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolSizeLow=poolSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, currentObjectGroup=currentObjectGroup, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, spareDiskReplaced=spareDiskReplaced, diskGoneOffline=diskGoneOffline, sharePoolName=sharePoolName, iscsiProperties=iscsiProperties, volumeDeleteFailed=volumeDeleteFailed, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolMetaReadIops=poolMetaReadIops, shareMountPoint=shareMountPoint, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, replicationAborted=replicationAborted, networkInterfaceUp=networkInterfaceUp, targetGroupMemberRemoved=targetGroupMemberRemoved, poolUsedSizeHigh=poolUsedSizeHigh, nvdimmFailUnknownError=nvdimmFailUnknownError, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, nfsTotalReadIops=nfsTotalReadIops, iscsiTotalReadMbps=iscsiTotalReadMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, diskTotalReadMbps=diskTotalReadMbps, cpuSystemCalls=cpuSystemCalls, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargetWriteLatency=fcTargetWriteLatency, diskDataReadMbps=diskDataReadMbps, projectQuotaFinished=projectQuotaFinished, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcAvgWriteLatency=fcAvgWriteLatency, lunSizeLow=lunSizeLow, haControllerB_Name=haControllerB_Name, snmpServiceStopFailed=snmpServiceStopFailed, controllerHardwareModel=controllerHardwareModel, nicTransmitMbps=nicTransmitMbps, projectDeletionFailed=projectDeletionFailed, poolTotalSaving=poolTotalSaving, shareSnapshotSizeLow=shareSnapshotSizeLow, upgradeFailed=upgradeFailed, smisServiceStarted=smisServiceStarted, iscsiTargetIndex=iscsiTargetIndex, haControllerB_IPAddr=haControllerB_IPAddr, poolQuotaFinished=poolQuotaFinished, iscsiInitiatorIndex=iscsiInitiatorIndex, snapshotCreationFailed=snapshotCreationFailed, fcInitiatorGroup=fcInitiatorGroup, cacheRAMReads=cacheRAMReads, shareEntry=shareEntry, fcPortOnline=fcPortOnline, diskType=diskType, diskRandomIOCount=diskRandomIOCount, poolReadCacheReadMbps=poolReadCacheReadMbps, poolCount=poolCount, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, upgradeDownloadFailed=upgradeDownloadFailed, diskPoolName=diskPoolName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcTotalReadMbps=fcTotalReadMbps, poolTotalWriteMbps=poolTotalWriteMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunReadLatency=lunReadLatency, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareQuotaHigh=shareQuotaHigh, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcTargetStatus=fcTargetStatus, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectPoolName=projectPoolName, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, cacheSSDReads=cacheSSDReads, snmpServiceStarted=snmpServiceStarted, lunCompressionEnabled=lunCompressionEnabled, adServerTimeDrift=adServerTimeDrift, fcTargetWriteIops=fcTargetWriteIops, poolMetaWriteMbps=poolMetaWriteMbps, diskAvgReadLatency=diskAvgReadLatency, tegileCompliances=tegileCompliances, diskTotalReadIops=diskTotalReadIops, projectEntry=projectEntry, poolEntry=poolEntry, properties=properties, poolProjects=poolProjects, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, notificationSensorSuspect=notificationSensorSuspect, webdocsUpgradeCompleted=webdocsUpgradeCompleted, cacheTotalWriteMbps=cacheTotalWriteMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, userLoginFailed=userLoginFailed, nicReceiveMbps=nicReceiveMbps, diskAvgWriteLatency=diskAvgWriteLatency, poolDataReadMbps=poolDataReadMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, notificationReadingUnit=notificationReadingUnit, poolMetaReadMbps=poolMetaReadMbps, vmwareNFSDatastores=vmwareNFSDatastores, cifsTotalWriteMbps=cifsTotalWriteMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, volumeModifyCompleted=volumeModifyCompleted, notificationProps=notificationProps, ipmiPowerSupply=ipmiPowerSupply, projectIndex=projectIndex, iscsiTargets=iscsiTargets, lunTargetGroup=lunTargetGroup, shareReservedSizeHigh=shareReservedSizeHigh, PYSNMP_MODULE_ID=tegile, fcTotalReadIops=fcTotalReadIops, poolTotalReadMbps=poolTotalReadMbps, shareNFSEnabled=shareNFSEnabled, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetEntry=fcTargetEntry, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareNFSWriteIops=shareNFSWriteIops, shareCIFSReadMbps=shareCIFSReadMbps, shareQuotaLow=shareQuotaLow, nvdimmFailInitializationError=nvdimmFailInitializationError, replicationStarted=replicationStarted, projectShares=projectShares, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectQuotaSizeLow=projectQuotaSizeLow, lunProtocol=lunProtocol, lunReadMbps=lunReadMbps, shareCIFSWriteIops=shareCIFSWriteIops, replicationAbandoned=replicationAbandoned, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcAvgReadLatency=fcAvgReadLatency, snmpServiceStopped=snmpServiceStopped, poolAvgReadLatency=poolAvgReadLatency, diskState=diskState, smisServiceStopped=smisServiceStopped, projectName=projectName, nfsTotalReadMbps=nfsTotalReadMbps, replicationFailed=replicationFailed, poolDataReadLatency=poolDataReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcPortOffline=fcPortOffline, iscsiTargetsTable=iscsiTargetsTable, haResourceName=haResourceName, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, nicMTU=nicMTU, fcTargets=fcTargets, poolHealth=poolHealth, diskSlowIo=diskSlowIo, basicCompliance=basicCompliance, tegile=tegile, iscsiInitiatorEntry=iscsiInitiatorEntry, networkIpmpGroupDown=networkIpmpGroupDown, diskError=diskError, webdocsUpgradeFailed=webdocsUpgradeFailed, upgradeTimeout=upgradeTimeout, lunReadIops=lunReadIops, ipmiThreshold=ipmiThreshold, poolOwnerController=poolOwnerController, iscsiTargetAlias=iscsiTargetAlias, poolDataSizeHigh=poolDataSizeHigh, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectDataSizeHigh=projectDataSizeHigh, projectShareCount=projectShareCount, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolProjectCount=poolProjectCount, poolMetaReadLatency=poolMetaReadLatency, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiInitiatorGroup=iscsiInitiatorGroup, shareCIFSWriteLatency=shareCIFSWriteLatency, shareIndex=shareIndex, poolTotalWriteIops=poolTotalWriteIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTargetAuth=iscsiTargetAuth, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, lunPoolName=lunPoolName, shareDedupEnabled=shareDedupEnabled, globalStatistics=globalStatistics, lunDataSizeHigh=lunDataSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, sanProperties=sanProperties, disks=disks, memoryFailure=memoryFailure, diskChassisIdx=diskChassisIdx, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, nicEntry=nicEntry, haResources=haResources, fcTargetReadIops=fcTargetReadIops, notificationTargetEntityName=notificationTargetEntityName, controllerUp=controllerUp, nvdimmFailSoftError=nvdimmFailSoftError, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectTable=projectTable, shareCIFSReadIops=shareCIFSReadIops, shareTable=shareTable, nfsAvgReadLatency=nfsAvgReadLatency, networkInterfaceDown=networkInterfaceDown, ipmiFan=ipmiFan, cifsTotalReadMbps=cifsTotalReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, cacheTotalReadIops=cacheTotalReadIops, tegileArray=tegileArray, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, lunTable=lunTable, shareDataSizeLow=shareDataSizeLow, lunWriteLatency=lunWriteLatency, snapshotCloningFailed=snapshotCloningFailed, replicationPaused=replicationPaused, ipmiTemperature=ipmiTemperature, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, smisServiceStopFailed=smisServiceStopFailed, poolAvgWriteLatency=poolAvgWriteLatency, notificationSeverity=notificationSeverity, fcTargetsTable=fcTargetsTable, networkIpmpGroupUp=networkIpmpGroupUp, haControllerA_IPAddr=haControllerA_IPAddr)
mibBuilder.exportSymbols("TEGILE-MIB", shareExceedThresholdWarning=shareExceedThresholdWarning, cpuTotalUsage=cpuTotalUsage, diskSizeHigh=diskSizeHigh, networkTotalReceiveMbps=networkTotalReceiveMbps, lunWriteMbps=lunWriteMbps, nicIndex=nicIndex, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, tegileGroups=tegileGroups, nicState=nicState, lunIndex=lunIndex, poolDeletionFailed=poolDeletionFailed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, haControllerB_Uptime=haControllerB_Uptime, fcInitiatorsTable=fcInitiatorsTable, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectDataSizeLow=projectDataSizeLow, iscsiTotalReadIops=iscsiTotalReadIops, notificationSensorNumber=notificationSensorNumber, iscsiTargetError=iscsiTargetError, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, maintenanceModeEnabled=maintenanceModeEnabled, poolImported=poolImported, notificationDescription=notificationDescription, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, snapshotCloneCompleted=snapshotCloneCompleted, maintenanceModeDisabled=maintenanceModeDisabled, controllerDown=controllerDown, poolReadCacheReadIops=poolReadCacheReadIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, snapshotRollbackFailed=snapshotRollbackFailed, lunGUID=lunGUID, shareName=shareName, snmpServiceStartFailed=snmpServiceStartFailed, poolState=poolState, snmpAgentVersion=snmpAgentVersion, cpuInterrupts=cpuInterrupts, projectTotalSaving=projectTotalSaving, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargetGroup=iscsiTargetGroup, lunSnapshotSizeLow=lunSnapshotSizeLow, diskEntry=diskEntry, lunFreeSizeLow=lunFreeSizeLow, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, projectFreeSizeHigh=projectFreeSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectDeleted=projectDeleted, projectSnapshotSizeLow=projectSnapshotSizeLow, fcProperties=fcProperties, replicationComplete=replicationComplete, nfsAvgWriteLatency=nfsAvgWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, netbiosSocketFailure=netbiosSocketFailure, smisServiceStartFailed=smisServiceStartFailed, projectModified=projectModified, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiTargetReadIops=iscsiTargetReadIops, haResourcesTable=haResourcesTable, nicGroup=nicGroup, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, ipmiOther=ipmiOther, fcInitiators=fcInitiators, tegileConformance=tegileConformance, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, haResourceGroup=haResourceGroup, projectCreatedSuccessfully=projectCreatedSuccessfully, projectCompressionEnabled=projectCompressionEnabled, lunDedupEnabled=lunDedupEnabled, iscsiTargetEntry=iscsiTargetEntry, poolExported=poolExported, diskTable=diskTable, shareQuotaFinished=shareQuotaFinished, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareReservedSizeLow=shareReservedSizeLow, haResourceDescription=haResourceDescription, notificationTime=notificationTime, nfsTotalWriteIops=nfsTotalWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareDeleted=shareDeleted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, unknownSensorEvent=unknownSensorEvent, fcTargetModifyCompleted=fcTargetModifyCompleted, shareNFSReadLatency=shareNFSReadLatency, haResourceIndex=haResourceIndex, volumeDeleteCompleted=volumeDeleteCompleted, ntpServerTimeDrift=ntpServerTimeDrift, poolName=poolName, ipmiVoltage=ipmiVoltage, cifsAvgReadLatency=cifsAvgReadLatency, iscsiInitiatorName=iscsiInitiatorName, poolDegraded=poolDegraded, replicationResumed=replicationResumed, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolTable=poolTable, lunEntry=lunEntry, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolExpanded=poolExpanded, poolDeleted=poolDeleted, targetGroupMemberAdded=targetGroupMemberAdded, notificationEventCode=notificationEventCode, notifications=notifications, intelliFlashSoftwareUp=intelliFlashSoftwareUp, diskSequentialIOCount=diskSequentialIOCount, aclMigrationStarted=aclMigrationStarted, shareCIFSEnabled=shareCIFSEnabled, notificationComponentName=notificationComponentName, nicTable=nicTable, fcTargetIndex=fcTargetIndex, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcTargetName=fcTargetName, poolFreeSizeHigh=poolFreeSizeHigh, sensorFailureEvent=sensorFailureEvent, poolDataWriteMbps=poolDataWriteMbps, shareCIFSReadLatency=shareCIFSReadLatency, iscsiWriteIops=iscsiWriteIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, deleteFolderCompleted=deleteFolderCompleted, replicationSourceRegistered=replicationSourceRegistered, projectThresholdExceedWarning=projectThresholdExceedWarning, poolDataReadIops=poolDataReadIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolCreated=poolCreated, deleteFolderFailed=deleteFolderFailed, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, notificationObjects=notificationObjects, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, notificationSensorAction=notificationSensorAction, lunCompressedRatio=lunCompressedRatio, iscsiInitiatorChapUser=iscsiInitiatorChapUser, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunInitiatorGroup=lunInitiatorGroup, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, shareNFSWriteLatency=shareNFSWriteLatency, lunProjectName=lunProjectName, notificationThresholdTriggerValue=notificationThresholdTriggerValue, nicName=nicName, poolDataWriteLatency=poolDataWriteLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiInitiators=iscsiInitiators, notificationReadingTriggerValue=notificationReadingTriggerValue, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, cacheTotalReadMbps=cacheTotalReadMbps, diskAlias=diskAlias, shareDataSizeHigh=shareDataSizeHigh, fcInitiatorName=fcInitiatorName, diskCount=diskCount, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareDeletionFailed=shareDeletionFailed, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, testNotification=testNotification, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, alertsCleanupCompleted=alertsCleanupCompleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, pools=pools, iscsiTargetReadMbps=iscsiTargetReadMbps, diagnosticDataUploaded=diagnosticDataUploaded, snapshotRollbackCompleted=snapshotRollbackCompleted, haResourceActiveNode=haResourceActiveNode, diskTotalWriteIops=diskTotalWriteIops, projectLUNs=projectLUNs, shareSnapshotSizeHigh=shareSnapshotSizeHigh, tegileArray_notifications=tegileArray_notifications, diskIOCount=diskIOCount, iscsiTargetGroupError=iscsiTargetGroupError, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, diskTotalWriteMbps=diskTotalWriteMbps, lunReservedSizeLow=lunReservedSizeLow, projectFreeSizeLow=projectFreeSizeLow, iscsiInitiatorsTable=iscsiInitiatorsTable, lunBlockSize=lunBlockSize, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, diskDataReadIops=diskDataReadIops, fcInitiatorIndex=fcInitiatorIndex, projectLunCount=projectLunCount, diskSizeLow=diskSizeLow, volumeQuotaFinished=volumeQuotaFinished, lunDataSizeLow=lunDataSizeLow, lunSizeHigh=lunSizeHigh, upgradeStarted=upgradeStarted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectDedupEnabled=projectDedupEnabled, fcTargetWriteMbps=fcTargetWriteMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, diskIndex=diskIndex, shareCompressionEnabled=shareCompressionEnabled, shareCompressedRatio=shareCompressedRatio, fcTargetReadMbps=fcTargetReadMbps, controllerTimeDrift=controllerTimeDrift, fcInitiatorEntry=fcInitiatorEntry, iscsiAvgReadLatency=iscsiAvgReadLatency, haControllerA_Uptime=haControllerA_Uptime, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, currentNotificationGroup=currentNotificationGroup, poolUpgraded=poolUpgraded, poolFreeSizeLow=poolFreeSizeLow, upgradeDownloadStarted=upgradeDownloadStarted, smbSocketFailure=smbSocketFailure, diskDataWriteMbps=diskDataWriteMbps, lunName=lunName, poolMetaWriteIops=poolMetaWriteIops, upgradeCompleted=upgradeCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted)
