...
Bits, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Unsigned32, enterprises, NotificationType, Integer32, ObjectIdentity, MibIdentifier, Counter32, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Unsigned32", "enterprises", "NotificationType", "Integer32", "ObjectIdentity", "MibIdentifier", "Counter32", "Gauge32", "iso")
...
mibBuilder.exportSymbols("TEGILE-MIB", disks=disks, iscsiInitiators=iscsiInitiators, haResourceStatus=haResourceStatus, pools=pools, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiTargetIndex=iscsiTargetIndex, poolAvgWriteLatency=poolAvgWriteLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diskDataReadIops=diskDataReadIops, poolSizeHigh=poolSizeHigh, nfsAvgWriteLatency=nfsAvgWriteLatency, lunFreeSizeLow=lunFreeSizeLow, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, intelliFlashSoftwareDown=intelliFlashSoftwareDown, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, diskSizeLow=diskSizeLow, projectQuotaSizeHigh=projectQuotaSizeHigh, shareMountPoint=shareMountPoint, iscsiTargetReadLatency=iscsiTargetReadLatency, poolMetaReadLatency=poolMetaReadLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolDataSizeLow=poolDataSizeLow, projectPoolName=projectPoolName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunCompressedRatio=lunCompressedRatio, controllerHardwareModel=controllerHardwareModel, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, testNotification=testNotification, poolReadCacheWriteMbps=poolReadCacheWriteMbps, notifications=notifications, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, projectShares=projectShares, notificationComponentName=notificationComponentName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolDeletionFailed=poolDeletionFailed, projectLunCount=projectLunCount, projectSnapshotSizeHigh=projectSnapshotSizeHigh, replicationSourceRegistered=replicationSourceRegistered, volumeDeleteFailed=volumeDeleteFailed, poolHealth=poolHealth, notificationProps=notificationProps, lunSnapshotSizeLow=lunSnapshotSizeLow, tegileGroups=tegileGroups, properties=properties, notificationSeverity=notificationSeverity, notificationSensorNumber=notificationSensorNumber, diskIOCount=diskIOCount, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiImproperTargetGroup=iscsiImproperTargetGroup, diskType=diskType, cifsTotalReadIops=cifsTotalReadIops, shareNFSWriteIops=shareNFSWriteIops, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareSnapshotSizeLow=shareSnapshotSizeLow, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolExported=poolExported, lunReadLatency=lunReadLatency, shareQuotaFinished=shareQuotaFinished, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiTargets=iscsiTargets, poolEntry=poolEntry, iscsiTargetError=iscsiTargetError, nicTable=nicTable, diagnosticDataUploaded=diagnosticDataUploaded, fcTotalReadMbps=fcTotalReadMbps, memoryFailure=memoryFailure, poolProjectCount=poolProjectCount, fcInitiatorsTable=fcInitiatorsTable, tegileArray=tegileArray, poolReadCacheReadMbps=poolReadCacheReadMbps, poolTotalSaving=poolTotalSaving, ntpServerTimeDrift=ntpServerTimeDrift, cacheTotalReadIops=cacheTotalReadIops, shareNFSWriteLatency=shareNFSWriteLatency, fcTargets=fcTargets, fcTargetsTable=fcTargetsTable, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcInitiatorIndex=fcInitiatorIndex, poolDataWriteMbps=poolDataWriteMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, diskPoolName=diskPoolName, shareExceedThresholdWarning=shareExceedThresholdWarning, vmwareNFSDatastores=vmwareNFSDatastores, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, lunDataSizeLow=lunDataSizeLow, lunWriteMbps=lunWriteMbps, currentNotificationGroup=currentNotificationGroup, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, snmpServiceStarted=snmpServiceStarted, poolExpanded=poolExpanded, fcProperties=fcProperties, upgradeFailed=upgradeFailed, deleteFolderFailed=deleteFolderFailed, poolProjects=poolProjects, replicationPaused=replicationPaused, projectTotalSaving=projectTotalSaving, poolDataReadIops=poolDataReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, iscsiTotalReadIops=iscsiTotalReadIops, poolUpgraded=poolUpgraded, ipmiMemory=ipmiMemory, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolQuotaFinished=poolQuotaFinished, nicReceiveMbps=nicReceiveMbps, volumeDeleteCompleted=volumeDeleteCompleted, nicMTU=nicMTU, notificationEventCode=notificationEventCode, lunDedupEnabled=lunDedupEnabled, haControllerB_Name=haControllerB_Name, lunCompressionEnabled=lunCompressionEnabled, nicEntry=nicEntry, notificationTargetEntityName=notificationTargetEntityName, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunGUID=lunGUID, tegileConformance=tegileConformance, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcTotalWriteMbps=fcTotalWriteMbps, diskDataWriteMbps=diskDataWriteMbps, diskState=diskState, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolTotalWriteMbps=poolTotalWriteMbps, haResourceIndex=haResourceIndex, iscsiProperties=iscsiProperties, projectLUNs=projectLUNs, poolFreeSizeHigh=poolFreeSizeHigh, cpuTotalUsage=cpuTotalUsage, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, smisServiceStopFailed=smisServiceStopFailed, fcTargetName=fcTargetName, networkInterfaceDown=networkInterfaceDown, haControllerB_IPAddr=haControllerB_IPAddr, poolUsedSizeHigh=poolUsedSizeHigh, shareCompressedRatio=shareCompressedRatio, sensorFailureEvent=sensorFailureEvent, poolDataSizeHigh=poolDataSizeHigh, shareNFSReadIops=shareNFSReadIops, diskGoneOffline=diskGoneOffline, shareProjectName=shareProjectName, diskRandomIOCount=diskRandomIOCount, shareName=shareName, controllerDown=controllerDown, lunTable=lunTable, targetGroupCreateCompleted=targetGroupCreateCompleted, cacheSSDReads=cacheSSDReads, cacheTotalWriteIops=cacheTotalWriteIops, lunPoolName=lunPoolName, diskSlowIo=diskSlowIo, poolImported=poolImported, lunProtocol=lunProtocol, lunProjectName=lunProjectName, aclMigrationCompleted=aclMigrationCompleted, fcTargetWriteIops=fcTargetWriteIops, cacheRAMReads=cacheRAMReads, shareReservedSizeHigh=shareReservedSizeHigh, currentObjectGroup=currentObjectGroup, iscsiTargetWriteLatency=iscsiTargetWriteLatency, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunReadMbps=lunReadMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, globalStatistics=globalStatistics, nicTransmitMbps=nicTransmitMbps, lunWriteLatency=lunWriteLatency, notificationSensorSuspect=notificationSensorSuspect, poolAvgReadLatency=poolAvgReadLatency, diskTotalReadMbps=diskTotalReadMbps, sharePoolName=sharePoolName, lunReservedSizeLow=lunReservedSizeLow, iscsiTotalWriteMbps=iscsiTotalWriteMbps, replicationAborted=replicationAborted, basicCompliance=basicCompliance, lunFreeSizeHigh=lunFreeSizeHigh, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectDedupEnabled=projectDedupEnabled, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcAvgReadLatency=fcAvgReadLatency, diskTable=diskTable, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskError=diskError, diskEntry=diskEntry, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolTotalReadMbps=poolTotalReadMbps, projectDataSizeLow=projectDataSizeLow, smisServiceStopped=smisServiceStopped, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectDeleted=projectDeleted, iscsiTargetAuth=iscsiTargetAuth, projectCompressionEnabled=projectCompressionEnabled, shareEntry=shareEntry, haControllerA_Name=haControllerA_Name, diskTotalReadIops=diskTotalReadIops, lunReadIops=lunReadIops, replicationTargetDeleted=replicationTargetDeleted, networkTotalTransmitMbps=networkTotalTransmitMbps, diskTotalWriteIops=diskTotalWriteIops, shareNFSEnabled=shareNFSEnabled, poolMetaWriteIops=poolMetaWriteIops, shareTable=shareTable, shareNFSReadLatency=shareNFSReadLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, upgradeDownloadCompleted=upgradeDownloadCompleted, fcPortOffline=fcPortOffline, unknownSensorEvent=unknownSensorEvent, poolReadCacheWriteIops=poolReadCacheWriteIops, shareDedupEnabled=shareDedupEnabled, iscsiWriteIops=iscsiWriteIops, projectQuotaFinished=projectQuotaFinished, poolDataWriteIops=poolDataWriteIops, fcTargetEntry=fcTargetEntry, nicState=nicState, projectModified=projectModified, shareQuotaHigh=shareQuotaHigh, adServerTimeDrift=adServerTimeDrift, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, networkIpmpGroupUp=networkIpmpGroupUp, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolWriteCacheWriteIops=poolWriteCacheWriteIops, ipmiPowerSupply=ipmiPowerSupply, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolCount=poolCount, haResourceName=haResourceName, iscsiTargetEntry=iscsiTargetEntry, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolTable=poolTable, lunEntry=lunEntry, notificationReadingTriggerValue=notificationReadingTriggerValue, nvdimmFailDeviceError=nvdimmFailDeviceError, networkIpmpGroupDown=networkIpmpGroupDown, poolTotalReadIops=poolTotalReadIops, projectName=projectName, maintenanceModeEnabled=maintenanceModeEnabled, upgradeTimeout=upgradeTimeout, shareCIFSWriteLatency=shareCIFSWriteLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, cifsTotalReadMbps=cifsTotalReadMbps, shareDeletionFailed=shareDeletionFailed, upgradeDownloadStarted=upgradeDownloadStarted, lunReservedSizeHigh=lunReservedSizeHigh, snmpServiceStopped=snmpServiceStopped, volumeQuotaFinished=volumeQuotaFinished, netbiosSocketFailure=netbiosSocketFailure, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully)
mibBuilder.exportSymbols("TEGILE-MIB", tdpsUpgradeTimeout=tdpsUpgradeTimeout, ipmiVoltage=ipmiVoltage, poolDegraded=poolDegraded, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diskAvgReadLatency=diskAvgReadLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, lunSizeLow=lunSizeLow, poolMetaReadMbps=poolMetaReadMbps, haResourceActiveNode=haResourceActiveNode, cpuInterrupts=cpuInterrupts, tegileCompliances=tegileCompliances, sanProperties=sanProperties, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, snmpServiceStopFailed=snmpServiceStopFailed, projectTable=projectTable, shareDataSizeHigh=shareDataSizeHigh, fcTotalWriteIops=fcTotalWriteIops, diskCount=diskCount, poolMetaReadIops=poolMetaReadIops, iscsiInitiatorChapUser=iscsiInitiatorChapUser, nfsTotalWriteMbps=nfsTotalWriteMbps, fcInitiatorName=fcInitiatorName, deleteFolderCompleted=deleteFolderCompleted, haResourceDescription=haResourceDescription, lunDataSizeHigh=lunDataSizeHigh, iscsiInitiatorsTable=iscsiInitiatorsTable, iscsiTargetGroup=iscsiTargetGroup, diskSequentialIOCount=diskSequentialIOCount, projectQuotaSizeLow=projectQuotaSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, PYSNMP_MODULE_ID=tegile, shareCIFSReadMbps=shareCIFSReadMbps, notificationTime=notificationTime, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareCIFSReadIops=shareCIFSReadIops, spareDiskReplaced=spareDiskReplaced, projectShareCount=projectShareCount, poolCreated=poolCreated, fcTargetReadLatency=fcTargetReadLatency, haControllerB_Uptime=haControllerB_Uptime, snapshotCloneCompleted=snapshotCloneCompleted, poolMetaWriteLatency=poolMetaWriteLatency, snapshotRollbackFailed=snapshotRollbackFailed, diskDataWriteIops=diskDataWriteIops, replicationResumed=replicationResumed, fcTargetIndex=fcTargetIndex, lunSizeHigh=lunSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, aclMigrationStarted=aclMigrationStarted, fcTotalReadIops=fcTotalReadIops, tegileArray_notifications=tegileArray_notifications, cifsAvgReadLatency=cifsAvgReadLatency, shareNFSReadMbps=shareNFSReadMbps, fcTargetStatus=fcTargetStatus, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, diskTotalWriteMbps=diskTotalWriteMbps, fcTargetWriteMbps=fcTargetWriteMbps, alertsCleanupCompleted=alertsCleanupCompleted, replicationComplete=replicationComplete, poolDataReadLatency=poolDataReadLatency, nfsTotalWriteIops=nfsTotalWriteIops, ipmiCurrent=ipmiCurrent, fcInitiators=fcInitiators, cifsTotalWriteMbps=cifsTotalWriteMbps, haControllerA_Uptime=haControllerA_Uptime, diskChassisIdx=diskChassisIdx, poolDataWriteLatency=poolDataWriteLatency, cpuSystemCalls=cpuSystemCalls, projectCreatedSuccessfully=projectCreatedSuccessfully, maintenanceModeDisabled=maintenanceModeDisabled, snapshotCreationFailed=snapshotCreationFailed, shareReservedSizeLow=shareReservedSizeLow, ipmiOther=ipmiOther, fcAvgWriteLatency=fcAvgWriteLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, smisServiceStarted=smisServiceStarted, poolDeleted=poolDeleted, replicationStarted=replicationStarted, poolSizeLow=poolSizeLow, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, cifsTotalWriteIops=cifsTotalWriteIops, projectIndex=projectIndex, iscsiTargetAlias=iscsiTargetAlias, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, cifsAvgWriteLatency=cifsAvgWriteLatency, fcInitiatorEntry=fcInitiatorEntry, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcTargetReadMbps=fcTargetReadMbps, iscsiTargetName=iscsiTargetName, cacheTotalWriteMbps=cacheTotalWriteMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, lunBlockSize=lunBlockSize, nfsAvgReadLatency=nfsAvgReadLatency, lunIndex=lunIndex, fcInitiatorGroup=fcInitiatorGroup, tegile=tegile, nvdimmFailSoftError=nvdimmFailSoftError, diskDataReadMbps=diskDataReadMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, smisServiceStartFailed=smisServiceStartFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, notificationSensorAction=notificationSensorAction, shareCIFSReadLatency=shareCIFSReadLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareCIFSEnabled=shareCIFSEnabled, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, diskSizeHigh=diskSizeHigh, lunWriteIops=lunWriteIops, lunInitiatorGroup=lunInitiatorGroup, network=network, iscsiTargetGroupError=iscsiTargetGroupError, tdpsUpgradeFailed=tdpsUpgradeFailed, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetReadIops=fcTargetReadIops, diskIsOnline=diskIsOnline, replicationAbandoned=replicationAbandoned, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolState=poolState, notificationDescription=notificationDescription, notificationReadingUnit=notificationReadingUnit, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareQuotaLow=shareQuotaLow, ipmiThreshold=ipmiThreshold, shareDeleted=shareDeleted, fcPortOnline=fcPortOnline, poolMetaWriteMbps=poolMetaWriteMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, nicName=nicName, upgradeStarted=upgradeStarted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, volumeModifyCompleted=volumeModifyCompleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, haResourceGroup=haResourceGroup, fcTargetGroup=fcTargetGroup, lunTargetGroup=lunTargetGroup, snapshotRollbackCompleted=snapshotRollbackCompleted, haResources=haResources, poolDataReadMbps=poolDataReadMbps, haResourcesTable=haResourcesTable, shareCIFSWriteIops=shareCIFSWriteIops, iscsiTargetsTable=iscsiTargetsTable, poolName=poolName, targetGroupMemberAdded=targetGroupMemberAdded, iscsiTargetWriteIops=iscsiTargetWriteIops, poolFreeSizeLow=poolFreeSizeLow, nfsTotalReadMbps=nfsTotalReadMbps, nicIndex=nicIndex, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, controllerTimeDrift=controllerTimeDrift, nvdimmFailInitializationError=nvdimmFailInitializationError, projectDataSizeHigh=projectDataSizeHigh, shareIndex=shareIndex, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, snmpServiceStartFailed=snmpServiceStartFailed, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, haResourceEntry=haResourceEntry, haControllerA_IPAddr=haControllerA_IPAddr, volumeCreatedSuccessfully=volumeCreatedSuccessfully, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectThresholdExceedWarning=projectThresholdExceedWarning, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, replicationFailed=replicationFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, lunName=lunName, shareCompressionEnabled=shareCompressionEnabled, ipmiFan=ipmiFan, userLoginFailed=userLoginFailed, smbSocketFailure=smbSocketFailure, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, projectDeletionFailed=projectDeletionFailed, nfsTotalReadIops=nfsTotalReadIops, snmpAgentVersion=snmpAgentVersion, nicGroup=nicGroup, networkTotalReceiveMbps=networkTotalReceiveMbps, upgradeDownloadFailed=upgradeDownloadFailed, iscsiTargetReadIops=iscsiTargetReadIops, diskIndex=diskIndex, projectEntry=projectEntry, diskAlias=diskAlias, upgradeCompleted=upgradeCompleted, diskAvgWriteLatency=diskAvgWriteLatency, notificationObjects=notificationObjects, cacheTotalReadMbps=cacheTotalReadMbps, ipmiTemperature=ipmiTemperature, projectFreeSizeLow=projectFreeSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, snapshotCloningFailed=snapshotCloningFailed, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolOwnerController=poolOwnerController, iscsiInitiatorName=iscsiInitiatorName, poolUsedSizeLow=poolUsedSizeLow, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, controllerUp=controllerUp, networkInterfaceUp=networkInterfaceUp, iscsiInitiatorIndex=iscsiInitiatorIndex, snapshotDeleteFailed=snapshotDeleteFailed, poolIndex=poolIndex, shareDataSizeLow=shareDataSizeLow, targetGroupMemberRemoved=targetGroupMemberRemoved, poolTotalWriteIops=poolTotalWriteIops)
