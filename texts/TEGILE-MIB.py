...
ModuleIdentity, ObjectIdentity, MibIdentifier, Integer32, Counter64, TimeTicks, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, IpAddress, NotificationType, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Integer32", "Counter64", "TimeTicks", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "IpAddress", "NotificationType", "Counter32", "Bits")
...
mibBuilder.exportSymbols("TEGILE-MIB", nicReceiveMbps=nicReceiveMbps, replicationAborted=replicationAborted, poolCount=poolCount, iscsiTargetReadIops=iscsiTargetReadIops, poolDegraded=poolDegraded, poolMetaReadIops=poolMetaReadIops, poolDataSizeHigh=poolDataSizeHigh, fcTargetName=fcTargetName, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, volumeCreatedSuccessfully=volumeCreatedSuccessfully, nicIndex=nicIndex, shareCIFSWriteLatency=shareCIFSWriteLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, nfsTotalReadMbps=nfsTotalReadMbps, lunName=lunName, shareExceedThresholdWarning=shareExceedThresholdWarning, smisServiceStopped=smisServiceStopped, volumeDeleteFailed=volumeDeleteFailed, iscsiInitiators=iscsiInitiators, iscsiAvgReadLatency=iscsiAvgReadLatency, projectTotalSaving=projectTotalSaving, shareEntry=shareEntry, cacheTotalReadMbps=cacheTotalReadMbps, poolDataWriteMbps=poolDataWriteMbps, fcTargetStatus=fcTargetStatus, iscsiTargetError=iscsiTargetError, alertsCleanupCompleted=alertsCleanupCompleted, diskChassisIdx=diskChassisIdx, nicGroup=nicGroup, shareCIFSReadLatency=shareCIFSReadLatency, ipmiThreshold=ipmiThreshold, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcInitiators=fcInitiators, lunEntry=lunEntry, diskIndex=diskIndex, iscsiTargets=iscsiTargets, nicMTU=nicMTU, projectFreeSizeHigh=projectFreeSizeHigh, projectFreeSizeLow=projectFreeSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, snmpServiceStopped=snmpServiceStopped, iscsiWriteIops=iscsiWriteIops, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskRandomIOCount=diskRandomIOCount, sharePoolName=sharePoolName, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectLunCount=projectLunCount, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, cifsTotalReadIops=cifsTotalReadIops, upgradeDownloadStarted=upgradeDownloadStarted, nfsAvgReadLatency=nfsAvgReadLatency, fcTotalReadMbps=fcTotalReadMbps, poolDeleted=poolDeleted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, notificationReadingUnit=notificationReadingUnit, lunCompressedRatio=lunCompressedRatio, projectName=projectName, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, diskSequentialIOCount=diskSequentialIOCount, fcPortOnline=fcPortOnline, iscsiTargetAuth=iscsiTargetAuth, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, userLoginFailed=userLoginFailed, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiProperties=iscsiProperties, fcTargetReadIops=fcTargetReadIops, fcTargetEntry=fcTargetEntry, iscsiTargetEntry=iscsiTargetEntry, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolSizeLow=poolSizeLow, notificationObjects=notificationObjects, controllerTimeDrift=controllerTimeDrift, iscsiTotalReadIops=iscsiTotalReadIops, poolCreated=poolCreated, basicCompliance=basicCompliance, projectModified=projectModified, iscsiTargetGroup=iscsiTargetGroup, iscsiTargetAlias=iscsiTargetAlias, diskTotalWriteMbps=diskTotalWriteMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, replicationFailed=replicationFailed, nicTransmitMbps=nicTransmitMbps, haControllerA_Name=haControllerA_Name, snapshotRollbackFailed=snapshotRollbackFailed, projectQuotaSizeHigh=projectQuotaSizeHigh, notificationDescription=notificationDescription, poolSizeHigh=poolSizeHigh, lunWriteLatency=lunWriteLatency, maintenanceModeDisabled=maintenanceModeDisabled, ipmiPowerSupply=ipmiPowerSupply, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiInitiatorGroup=iscsiInitiatorGroup, shareCIFSReadIops=shareCIFSReadIops, replicationTargetDeleted=replicationTargetDeleted, cifsTotalWriteIops=cifsTotalWriteIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diskEntry=diskEntry, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, notificationSensorAction=notificationSensorAction, targetGroupCreateCompleted=targetGroupCreateCompleted, fcInitiatorGroup=fcInitiatorGroup, haControllerB_IPAddr=haControllerB_IPAddr, fcTargetWriteIops=fcTargetWriteIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, nicName=nicName, poolMetaWriteLatency=poolMetaWriteLatency, upgradeDownloadFailed=upgradeDownloadFailed, upgradeCompleted=upgradeCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, shareDataSizeLow=shareDataSizeLow, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareCIFSReadMbps=shareCIFSReadMbps, replicationComplete=replicationComplete, projectDeletionFailed=projectDeletionFailed, iscsiTargetIndex=iscsiTargetIndex, poolExpanded=poolExpanded, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunProjectName=lunProjectName, networkInterfaceUp=networkInterfaceUp, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcTargets=fcTargets, ipmiTemperature=ipmiTemperature, poolTotalSaving=poolTotalSaving, lunWriteIops=lunWriteIops, shareNFSReadIops=shareNFSReadIops, cacheTotalWriteIops=cacheTotalWriteIops, shareReservedSizeHigh=shareReservedSizeHigh, haControllerB_Name=haControllerB_Name, smisServiceStarted=smisServiceStarted, poolReadCacheReadLatency=poolReadCacheReadLatency, vmwareNFSDatastores=vmwareNFSDatastores, diskIOCount=diskIOCount, nfsTotalReadIops=nfsTotalReadIops, iscsiInitiatorName=iscsiInitiatorName, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiTotalReadMbps=iscsiTotalReadMbps, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, haControllerB_Uptime=haControllerB_Uptime, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolExported=poolExported, haResourceIndex=haResourceIndex, iscsiAvgWriteLatency=iscsiAvgWriteLatency, diskTotalReadIops=diskTotalReadIops, tegileArray=tegileArray, haControllerA_IPAddr=haControllerA_IPAddr, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, cacheSSDReads=cacheSSDReads, poolProjectCount=poolProjectCount, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, nicTable=nicTable, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskSizeLow=diskSizeLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareNFSReadMbps=shareNFSReadMbps, haResourceStatus=haResourceStatus, netbiosSocketFailure=netbiosSocketFailure, shareCIFSWriteIops=shareCIFSWriteIops, poolDataSizeLow=poolDataSizeLow, nvdimmFailDeviceError=nvdimmFailDeviceError, nvdimmFailSoftError=nvdimmFailSoftError, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, networkTotalTransmitMbps=networkTotalTransmitMbps, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiInitiatorIndex=iscsiInitiatorIndex, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcTotalWriteIops=fcTotalWriteIops, shareNFSWriteLatency=shareNFSWriteLatency, diskTotalWriteIops=diskTotalWriteIops, lunSizeHigh=lunSizeHigh, iscsiTargetGroupError=iscsiTargetGroupError, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareNFSWriteMbps=shareNFSWriteMbps, nicState=nicState, fcTargetReadMbps=fcTargetReadMbps, cpuTotalUsage=cpuTotalUsage, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, fcTargetModifyCompleted=fcTargetModifyCompleted, poolTotalReadIops=poolTotalReadIops, adServerTimeDrift=adServerTimeDrift, fcTargetReadLatency=fcTargetReadLatency, pools=pools, haResourceActiveNode=haResourceActiveNode, poolTotalWriteIops=poolTotalWriteIops, snmpServiceStopFailed=snmpServiceStopFailed, tdpsUpgradeTimeout=tdpsUpgradeTimeout, projectShareCount=projectShareCount, cifsAvgWriteLatency=cifsAvgWriteLatency, poolReadCacheReadIops=poolReadCacheReadIops, projectEntry=projectEntry, fcPortOffline=fcPortOffline, shareNFSEnabled=shareNFSEnabled, shareCompressedRatio=shareCompressedRatio, shareDeleted=shareDeleted, poolFreeSizeLow=poolFreeSizeLow, haResourceEntry=haResourceEntry, fcInitiatorsTable=fcInitiatorsTable, lunWriteMbps=lunWriteMbps, ipmiCurrent=ipmiCurrent, projectDeleted=projectDeleted, snapshotDeleteFailed=snapshotDeleteFailed, shareName=shareName, notificationTargetEntityName=notificationTargetEntityName, lunSnapshotSizeHigh=lunSnapshotSizeHigh, cpuInterrupts=cpuInterrupts, ntpServerTimeDrift=ntpServerTimeDrift, networkIpmpGroupUp=networkIpmpGroupUp, poolName=poolName, snmpServiceStarted=snmpServiceStarted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, fcProperties=fcProperties, replicationPaused=replicationPaused, properties=properties, diskPoolName=diskPoolName, poolMetaWriteIops=poolMetaWriteIops, notifications=notifications, shareIndex=shareIndex, lunReadMbps=lunReadMbps, ipmiOther=ipmiOther, projectCreatedSuccessfully=projectCreatedSuccessfully, poolIndex=poolIndex, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, cacheTotalWriteMbps=cacheTotalWriteMbps, projectTable=projectTable, nfsTotalWriteMbps=nfsTotalWriteMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, poolDataWriteLatency=poolDataWriteLatency, iscsiTargetWriteLatency=iscsiTargetWriteLatency, upgradeTimeout=upgradeTimeout, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, notificationSeverity=notificationSeverity, lunPoolName=lunPoolName, poolReadCacheWriteIops=poolReadCacheWriteIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolAvgWriteLatency=poolAvgWriteLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, poolDataReadMbps=poolDataReadMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, diagnosticDataUploaded=diagnosticDataUploaded, notificationSensorNumber=notificationSensorNumber, unknownSensorEvent=unknownSensorEvent, nfsAvgWriteLatency=nfsAvgWriteLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, diskAvgWriteLatency=diskAvgWriteLatency, poolMetaReadLatency=poolMetaReadLatency, controllerHardwareModel=controllerHardwareModel, networkIpmpGroupDown=networkIpmpGroupDown, diskGoneOffline=diskGoneOffline)
mibBuilder.exportSymbols("TEGILE-MIB", lunGUID=lunGUID, smbSocketFailure=smbSocketFailure, nvdimmFailInitializationError=nvdimmFailInitializationError, projectQuotaSizeLow=projectQuotaSizeLow, testNotification=testNotification, tegile=tegile, disks=disks, fcTotalWriteMbps=fcTotalWriteMbps, poolFreeSizeHigh=poolFreeSizeHigh, cpuSystemCalls=cpuSystemCalls, fcTargetGroup=fcTargetGroup, snmpAgentVersion=snmpAgentVersion, projectDataSizeHigh=projectDataSizeHigh, fcInitiatorName=fcInitiatorName, projectDedupEnabled=projectDedupEnabled, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolMetaWriteMbps=poolMetaWriteMbps, networkInterfaceDown=networkInterfaceDown, shareProjectName=shareProjectName, fcInitiatorEntry=fcInitiatorEntry, projectPoolName=projectPoolName, sensorFailureEvent=sensorFailureEvent, fcTotalReadIops=fcTotalReadIops, diskIsOnline=diskIsOnline, poolDataWriteIops=poolDataWriteIops, globalStatistics=globalStatistics, diskDataReadIops=diskDataReadIops, volumeQuotaFinished=volumeQuotaFinished, maintenanceModeEnabled=maintenanceModeEnabled, targetGroupDeleteCompleted=targetGroupDeleteCompleted, replicationStarted=replicationStarted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolUpgraded=poolUpgraded, smisServiceStopFailed=smisServiceStopFailed, lunReservedSizeHigh=lunReservedSizeHigh, lunDedupEnabled=lunDedupEnabled, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareCreatedSuccessfully=shareCreatedSuccessfully, replicationResumed=replicationResumed, iscsiTargetReadMbps=iscsiTargetReadMbps, fcTargetsTable=fcTargetsTable, tegileArray_notifications=tegileArray_notifications, iscsiInitiatorEntry=iscsiInitiatorEntry, tegileCompliances=tegileCompliances, notificationReadingTriggerValue=notificationReadingTriggerValue, lunProtocol=lunProtocol, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunBlockSize=lunBlockSize, PYSNMP_MODULE_ID=tegile, poolOwnerController=poolOwnerController, lunTable=lunTable, poolHealth=poolHealth, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskDataWriteMbps=diskDataWriteMbps, lunDataSizeLow=lunDataSizeLow, diskState=diskState, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskSlowIo=diskSlowIo, poolWriteCacheWriteIops=poolWriteCacheWriteIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcTargetIndex=fcTargetIndex, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareDedupEnabled=shareDedupEnabled, iscsiImproperTargetGroup=iscsiImproperTargetGroup, shareReservedSizeLow=shareReservedSizeLow, replicationAbandoned=replicationAbandoned, currentNotificationGroup=currentNotificationGroup, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, diskDataWriteIops=diskDataWriteIops, shareCIFSEnabled=shareCIFSEnabled, diskSizeHigh=diskSizeHigh, lunFreeSizeLow=lunFreeSizeLow, haResourceGroup=haResourceGroup, notificationComponentName=notificationComponentName, fcAvgWriteLatency=fcAvgWriteLatency, poolUsedSizeHigh=poolUsedSizeHigh, poolProjects=poolProjects, iscsiInitiatorsTable=iscsiInitiatorsTable, tdpsUpgradeCompleted=tdpsUpgradeCompleted, diskTotalReadMbps=diskTotalReadMbps, cifsTotalWriteMbps=cifsTotalWriteMbps, poolEntry=poolEntry, poolMetaReadMbps=poolMetaReadMbps, poolUsedSizeLow=poolUsedSizeLow, diskError=diskError, iscsiTargetsTable=iscsiTargetsTable, aclMigrationCompleted=aclMigrationCompleted, projectLUNs=projectLUNs, shareNFSWriteIops=shareNFSWriteIops, snapshotRollbackCompleted=snapshotRollbackCompleted, lunReservedSizeLow=lunReservedSizeLow, poolTable=poolTable, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunDataSizeHigh=lunDataSizeHigh, controllerDown=controllerDown, poolDataReadLatency=poolDataReadLatency, projectQuotaFinished=projectQuotaFinished, targetGroupMemberAdded=targetGroupMemberAdded, tegileConformance=tegileConformance, poolAvgReadLatency=poolAvgReadLatency, memoryFailure=memoryFailure, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, upgradeFailed=upgradeFailed, poolTotalWriteMbps=poolTotalWriteMbps, lunCompressionEnabled=lunCompressionEnabled, lunIndex=lunIndex, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunReadLatency=lunReadLatency, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, controllerUp=controllerUp, volumeDeleteCompleted=volumeDeleteCompleted, snapshotCreationFailed=snapshotCreationFailed, projectShares=projectShares, fcInitiatorIndex=fcInitiatorIndex, poolTotalReadMbps=poolTotalReadMbps, projectCompressionEnabled=projectCompressionEnabled, haResources=haResources, lunTargetGroup=lunTargetGroup, iscsiTargetWriteMbps=iscsiTargetWriteMbps, lunSizeLow=lunSizeLow, deleteFolderFailed=deleteFolderFailed, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, notificationSensorSuspect=notificationSensorSuspect, aclMigrationStarted=aclMigrationStarted, shareQuotaFinished=shareQuotaFinished, network=network, projectThresholdExceedWarning=projectThresholdExceedWarning, projectDataSizeLow=projectDataSizeLow, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskTable=diskTable, smisServiceStartFailed=smisServiceStartFailed, shareDeletionFailed=shareDeletionFailed, iscsiTargetWriteIops=iscsiTargetWriteIops, projectSnapshotSizeLow=projectSnapshotSizeLow, poolDeletionFailed=poolDeletionFailed, shareDataSizeHigh=shareDataSizeHigh, haResourceName=haResourceName, currentObjectGroup=currentObjectGroup, ipmiFan=ipmiFan, lunSnapshotSizeLow=lunSnapshotSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareNFSReadLatency=shareNFSReadLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskType=diskType, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, snapshotCloneCompleted=snapshotCloneCompleted, diskDataReadMbps=diskDataReadMbps, haControllerA_Uptime=haControllerA_Uptime, fcAvgReadLatency=fcAvgReadLatency, snmpServiceStartFailed=snmpServiceStartFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, upgradeDownloadCompleted=upgradeDownloadCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareQuotaHigh=shareQuotaHigh, cacheRAMReads=cacheRAMReads, tegileGroups=tegileGroups, poolReadCacheWriteLatency=poolReadCacheWriteLatency, shareQuotaLow=shareQuotaLow, sanProperties=sanProperties, diskAvgReadLatency=diskAvgReadLatency, upgradeStarted=upgradeStarted, snapshotCloningFailed=snapshotCloningFailed, poolDataReadIops=poolDataReadIops, ipmiMemory=ipmiMemory, cifsAvgReadLatency=cifsAvgReadLatency, notificationTime=notificationTime, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, poolImported=poolImported, notificationProps=notificationProps, iscsiTargetName=iscsiTargetName, deleteFolderCompleted=deleteFolderCompleted, cifsTotalReadMbps=cifsTotalReadMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareMountPoint=shareMountPoint, shareTable=shareTable, notificationEventCode=notificationEventCode, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, volumeModifyCompleted=volumeModifyCompleted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolQuotaFinished=poolQuotaFinished, shareCompressionEnabled=shareCompressionEnabled, lunReadIops=lunReadIops, diskAlias=diskAlias, lunInitiatorGroup=lunInitiatorGroup, nfsTotalWriteIops=nfsTotalWriteIops, haResourcesTable=haResourcesTable, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolState=poolState, haResourceDescription=haResourceDescription, nicEntry=nicEntry, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, spareDiskReplaced=spareDiskReplaced, projectIndex=projectIndex, lunFreeSizeHigh=lunFreeSizeHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, cacheTotalReadIops=cacheTotalReadIops, replicationSourceRegistered=replicationSourceRegistered, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, ipmiVoltage=ipmiVoltage, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, targetGroupMemberRemoved=targetGroupMemberRemoved, diskCount=diskCount, fcTargetWriteMbps=fcTargetWriteMbps)
