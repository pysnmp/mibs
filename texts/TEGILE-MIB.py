...
Gauge32, ObjectIdentity, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Integer32, Counter32, iso, TimeTicks, enterprises, NotificationType, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Integer32", "Counter32", "iso", "TimeTicks", "enterprises", "NotificationType", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcTotalReadMbps=fcTotalReadMbps, projectDeleted=projectDeleted, poolUsedSizeHigh=poolUsedSizeHigh, shareNFSEnabled=shareNFSEnabled, ipmiCurrent=ipmiCurrent, haResourceIndex=haResourceIndex, notificationSensorAction=notificationSensorAction, poolReadCacheWriteIops=poolReadCacheWriteIops, shareDeleted=shareDeleted, diskDataWriteIops=diskDataWriteIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, haControllerB_IPAddr=haControllerB_IPAddr, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, aclMigrationStarted=aclMigrationStarted, tegileArray_notifications=tegileArray_notifications, iscsiTargetAlias=iscsiTargetAlias, shareCIFSReadIops=shareCIFSReadIops, ipmiPowerSupply=ipmiPowerSupply, lunSnapshotSizeLow=lunSnapshotSizeLow, nicName=nicName, intelliFlashSoftwareUp=intelliFlashSoftwareUp, projectQuotaFinished=projectQuotaFinished, poolProjects=poolProjects, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, nvdimmFailInitializationError=nvdimmFailInitializationError, iscsiTargetName=iscsiTargetName, nicTransmitMbps=nicTransmitMbps, controllerDown=controllerDown, snmpServiceStarted=snmpServiceStarted, haResourceActiveNode=haResourceActiveNode, diskTotalReadMbps=diskTotalReadMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolFreeSizeHigh=poolFreeSizeHigh, poolDeletionFailed=poolDeletionFailed, poolUpgraded=poolUpgraded, poolDataReadLatency=poolDataReadLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcInitiatorIndex=fcInitiatorIndex, projectEntry=projectEntry, projectQuotaSizeHigh=projectQuotaSizeHigh, nicEntry=nicEntry, projectIndex=projectIndex, notificationObjects=notificationObjects, lunDataSizeLow=lunDataSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, ipmiFan=ipmiFan, notificationSensorSuspect=notificationSensorSuspect, poolSizeHigh=poolSizeHigh, fcInitiatorName=fcInitiatorName, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, lunReservedSizeHigh=lunReservedSizeHigh, lunTargetGroup=lunTargetGroup, cifsTotalReadIops=cifsTotalReadIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiTargetEntry=iscsiTargetEntry, cpuTotalUsage=cpuTotalUsage, nfsTotalReadIops=nfsTotalReadIops, nicTable=nicTable, fcTotalReadIops=fcTotalReadIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, notificationEventCode=notificationEventCode, iscsiTargets=iscsiTargets, lunName=lunName, poolDataSizeLow=poolDataSizeLow, notificationComponentName=notificationComponentName, replicationResumed=replicationResumed, disks=disks, nfsAvgWriteLatency=nfsAvgWriteLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, PYSNMP_MODULE_ID=tegile, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, ipmiMemory=ipmiMemory, poolAvgReadLatency=poolAvgReadLatency, lunGUID=lunGUID, haControllerA_Uptime=haControllerA_Uptime, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskError=diskError, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolMetaReadLatency=poolMetaReadLatency, diskEntry=diskEntry, sharePoolName=sharePoolName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcAvgWriteLatency=fcAvgWriteLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, replicationSourceRegistered=replicationSourceRegistered, iscsiTargetGroupError=iscsiTargetGroupError, poolDataReadIops=poolDataReadIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolReadCacheWriteLatency=poolReadCacheWriteLatency, notificationSensorNumber=notificationSensorNumber, poolDeleted=poolDeleted, iscsiTargetError=iscsiTargetError, targetGroupMemberRemoved=targetGroupMemberRemoved, sanProperties=sanProperties, projectCreatedSuccessfully=projectCreatedSuccessfully, shareMountPoint=shareMountPoint, iscsiTargetWriteLatency=iscsiTargetWriteLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, ipmiThreshold=ipmiThreshold, shareReservedSizeHigh=shareReservedSizeHigh, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskTable=diskTable, projectTotalSaving=projectTotalSaving, poolMetaWriteLatency=poolMetaWriteLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolReadCacheReadLatency=poolReadCacheReadLatency, replicationTargetDeleted=replicationTargetDeleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolDegraded=poolDegraded, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunSizeLow=lunSizeLow, poolTotalReadMbps=poolTotalReadMbps, diskAlias=diskAlias, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, maintenanceModeEnabled=maintenanceModeEnabled, currentObjectGroup=currentObjectGroup, poolWriteCacheWriteIops=poolWriteCacheWriteIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, ipmiVoltage=ipmiVoltage, smbSocketFailure=smbSocketFailure, lunTable=lunTable, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiTargetReadIops=iscsiTargetReadIops, haResourceGroup=haResourceGroup, iscsiTotalReadIops=iscsiTotalReadIops, replicationPaused=replicationPaused, projectShares=projectShares, diskIndex=diskIndex, netbiosSocketFailure=netbiosSocketFailure, shareNFSReadIops=shareNFSReadIops, diskState=diskState, controllerTimeDrift=controllerTimeDrift, networkInterfaceUp=networkInterfaceUp, replicationAborted=replicationAborted, poolDataWriteIops=poolDataWriteIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiTargetReadMbps=iscsiTargetReadMbps, snapshotCloneCompleted=snapshotCloneCompleted, cifsAvgReadLatency=cifsAvgReadLatency, fcInitiators=fcInitiators, projectDeletionFailed=projectDeletionFailed, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cpuSystemCalls=cpuSystemCalls, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolTotalWriteMbps=poolTotalWriteMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareSnapshotSizeHigh=shareSnapshotSizeHigh, nvdimmFailUnknownError=nvdimmFailUnknownError, lunCompressedRatio=lunCompressedRatio, cifsTotalReadMbps=cifsTotalReadMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunDedupEnabled=lunDedupEnabled, diskAvgReadLatency=diskAvgReadLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, nicIndex=nicIndex, network=network, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, diskGoneOffline=diskGoneOffline, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiAvgReadLatency=iscsiAvgReadLatency, notificationDescription=notificationDescription, iscsiInitiatorsTable=iscsiInitiatorsTable, shareCIFSWriteMbps=shareCIFSWriteMbps, poolMetaWriteMbps=poolMetaWriteMbps, fcPortOnline=fcPortOnline, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, haResourceEntry=haResourceEntry, poolState=poolState, lunReadMbps=lunReadMbps, lunBlockSize=lunBlockSize, cacheTotalReadIops=cacheTotalReadIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, snapshotRollbackFailed=snapshotRollbackFailed, poolIndex=poolIndex, shareName=shareName, iscsiInitiators=iscsiInitiators, iscsiTotalReadMbps=iscsiTotalReadMbps, poolOwnerController=poolOwnerController, maintenanceModeDisabled=maintenanceModeDisabled, shareDedupEnabled=shareDedupEnabled, projectDataSizeHigh=projectDataSizeHigh, poolUsedSizeLow=poolUsedSizeLow, shareIndex=shareIndex, fcTargetGroup=fcTargetGroup, diskSizeLow=diskSizeLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiInitiatorChapUser=iscsiInitiatorChapUser, fcInitiatorGroup=fcInitiatorGroup, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectFreeSizeLow=projectFreeSizeLow, iscsiTargetAuth=iscsiTargetAuth, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, ntpServerTimeDrift=ntpServerTimeDrift, haControllerB_Uptime=haControllerB_Uptime, shareCreatedSuccessfully=shareCreatedSuccessfully, cpuInterrupts=cpuInterrupts, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, deleteFolderCompleted=deleteFolderCompleted, poolDataReadMbps=poolDataReadMbps, cifsTotalWriteIops=cifsTotalWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, tegileArray=tegileArray, haControllerA_IPAddr=haControllerA_IPAddr, tegile=tegile, diskSlowIo=diskSlowIo, upgradeFailed=upgradeFailed, shareTable=shareTable, diskDataReadMbps=diskDataReadMbps, poolFreeSizeLow=poolFreeSizeLow, currentNotificationGroup=currentNotificationGroup, diskSizeHigh=diskSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, lunDataSizeHigh=lunDataSizeHigh, shareQuotaHigh=shareQuotaHigh, nfsTotalWriteMbps=nfsTotalWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, memoryFailure=memoryFailure, projectDedupEnabled=projectDedupEnabled, lunCompressionEnabled=lunCompressionEnabled, lunProtocol=lunProtocol, targetGroupMemberAdded=targetGroupMemberAdded, poolDataWriteMbps=poolDataWriteMbps, diskSequentialIOCount=diskSequentialIOCount, notificationTargetEntityName=notificationTargetEntityName, projectLUNs=projectLUNs, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, testNotification=testNotification, haControllerA_Name=haControllerA_Name, poolTotalSaving=poolTotalSaving, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, smisServiceStartFailed=smisServiceStartFailed, volumeDeleteCompleted=volumeDeleteCompleted, projectPoolName=projectPoolName, projectSnapshotSizeLow=projectSnapshotSizeLow, shareDataSizeLow=shareDataSizeLow, haControllerB_Name=haControllerB_Name, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, smisServiceStopFailed=smisServiceStopFailed, shareCIFSEnabled=shareCIFSEnabled, poolImported=poolImported, projectShareCount=projectShareCount)
mibBuilder.exportSymbols("TEGILE-MIB", shareDataSizeHigh=shareDataSizeHigh, nicMTU=nicMTU, shareNFSWriteLatency=shareNFSWriteLatency, networkIpmpGroupDown=networkIpmpGroupDown, unknownSensorEvent=unknownSensorEvent, lunIndex=lunIndex, shareEntry=shareEntry, spareDiskReplaced=spareDiskReplaced, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, notifications=notifications, volumeModifyCompleted=volumeModifyCompleted, poolCreated=poolCreated, lunFreeSizeLow=lunFreeSizeLow, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, fcTargetName=fcTargetName, diskRandomIOCount=diskRandomIOCount, iscsiInitiatorName=iscsiInitiatorName, tegileConformance=tegileConformance, projectModified=projectModified, webdocsUpgradeFailed=webdocsUpgradeFailed, diskDataWriteMbps=diskDataWriteMbps, lunWriteIops=lunWriteIops, sensorFailureEvent=sensorFailureEvent, fcTargetWriteLatency=fcTargetWriteLatency, fcInitiatorsTable=fcInitiatorsTable, upgradeDownloadFailed=upgradeDownloadFailed, snapshotCloningFailed=snapshotCloningFailed, projectFreeSizeHigh=projectFreeSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareProjectName=shareProjectName, controllerHardwareModel=controllerHardwareModel, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, upgradeDownloadCompleted=upgradeDownloadCompleted, notificationProps=notificationProps, lunSizeHigh=lunSizeHigh, diskDataReadIops=diskDataReadIops, shareCompressedRatio=shareCompressedRatio, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectCompressionEnabled=projectCompressionEnabled, fcAvgReadLatency=fcAvgReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, snmpServiceStopped=snmpServiceStopped, snapshotCreationFailed=snapshotCreationFailed, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargetEntry=fcTargetEntry, tdpsUpgradeFailed=tdpsUpgradeFailed, cacheSSDReads=cacheSSDReads, poolExported=poolExported, fcTargetReadIops=fcTargetReadIops, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, shareNFSReadLatency=shareNFSReadLatency, shareQuotaFinished=shareQuotaFinished, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectTable=projectTable, poolMetaWriteIops=poolMetaWriteIops, nvdimmFailSoftError=nvdimmFailSoftError, notificationSeverity=notificationSeverity, poolReadCacheReadIops=poolReadCacheReadIops, poolTotalWriteIops=poolTotalWriteIops, ipmiOther=ipmiOther, notificationReadingTriggerValue=notificationReadingTriggerValue, userLoginFailed=userLoginFailed, volumeDeleteFailed=volumeDeleteFailed, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolEntry=poolEntry, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, deleteFolderFailed=deleteFolderFailed, shareCIFSReadMbps=shareCIFSReadMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, replicationFailed=replicationFailed, diagnosticDataUploaded=diagnosticDataUploaded, poolTable=poolTable, notificationReadingUnit=notificationReadingUnit, diskIsOnline=diskIsOnline, volumeQuotaFinished=volumeQuotaFinished, tegileCompliances=tegileCompliances, nicGroup=nicGroup, cacheTotalReadMbps=cacheTotalReadMbps, nicState=nicState, poolQuotaFinished=poolQuotaFinished, lunProjectName=lunProjectName, lunPoolName=lunPoolName, poolTotalReadIops=poolTotalReadIops, projectDataSizeLow=projectDataSizeLow, notificationTime=notificationTime, iscsiProperties=iscsiProperties, fcTotalWriteIops=fcTotalWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, poolName=poolName, fcTargetReadLatency=fcTargetReadLatency, iscsiTargetsTable=iscsiTargetsTable, snmpServiceStopFailed=snmpServiceStopFailed, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, poolExpanded=poolExpanded, diskTotalReadIops=diskTotalReadIops, diskAvgWriteLatency=diskAvgWriteLatency, upgradeDownloadStarted=upgradeDownloadStarted, nicReceiveMbps=nicReceiveMbps, poolCount=poolCount, cacheTotalWriteMbps=cacheTotalWriteMbps, lunWriteMbps=lunWriteMbps, networkInterfaceDown=networkInterfaceDown, haResourceDescription=haResourceDescription, poolDataSizeHigh=poolDataSizeHigh, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolMetaReadMbps=poolMetaReadMbps, globalStatistics=globalStatistics, vmwareNFSDatastores=vmwareNFSDatastores, fcPortOffline=fcPortOffline, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcTargetReadMbps=fcTargetReadMbps, basicCompliance=basicCompliance, snmpAgentVersion=snmpAgentVersion, lunReadLatency=lunReadLatency, haResourcesTable=haResourcesTable, replicationComplete=replicationComplete, fcTargetWriteMbps=fcTargetWriteMbps, shareReservedSizeLow=shareReservedSizeLow, fcTargetModifyCompleted=fcTargetModifyCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, tdpsUpgradeCompleted=tdpsUpgradeCompleted, networkTotalTransmitMbps=networkTotalTransmitMbps, shareCompressionEnabled=shareCompressionEnabled, iscsiTargetGroup=iscsiTargetGroup, fcTargetsTable=fcTargetsTable, shareQuotaLow=shareQuotaLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, diskTotalWriteMbps=diskTotalWriteMbps, shareNFSReadMbps=shareNFSReadMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, networkIpmpGroupUp=networkIpmpGroupUp, iscsiTargetIndex=iscsiTargetIndex, diskPoolName=diskPoolName, tegileGroups=tegileGroups, controllerUp=controllerUp, fcProperties=fcProperties, iscsiInitiatorEntry=iscsiInitiatorEntry, nfsAvgReadLatency=nfsAvgReadLatency, haResourceStatus=haResourceStatus, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskCount=diskCount, shareDeletionFailed=shareDeletionFailed, iscsiTargetWriteIops=iscsiTargetWriteIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, adServerTimeDrift=adServerTimeDrift, lunReadIops=lunReadIops, poolDataWriteLatency=poolDataWriteLatency, projectLunCount=projectLunCount, lunReservedSizeLow=lunReservedSizeLow, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, alertsCleanupCompleted=alertsCleanupCompleted, projectName=projectName, poolReadCacheReadMbps=poolReadCacheReadMbps, diskType=diskType, poolSizeLow=poolSizeLow, snmpServiceStartFailed=snmpServiceStartFailed, pools=pools, fcTargetStatus=fcTargetStatus, diskChassisIdx=diskChassisIdx, targetGroupCreateCompleted=targetGroupCreateCompleted, nfsTotalWriteIops=nfsTotalWriteIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, snapshotDeleteFailed=snapshotDeleteFailed, poolProjectCount=poolProjectCount, poolMetaReadIops=poolMetaReadIops, upgradeTimeout=upgradeTimeout, nvdimmFailDeviceError=nvdimmFailDeviceError, shareNFSWriteIops=shareNFSWriteIops, haResources=haResources, fcTargets=fcTargets, fcTargetWriteIops=fcTargetWriteIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, replicationStarted=replicationStarted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, haResourceName=haResourceName, aclMigrationCompleted=aclMigrationCompleted, replicationAbandoned=replicationAbandoned, cacheRAMReads=cacheRAMReads, projectQuotaSizeLow=projectQuotaSizeLow, poolHealth=poolHealth, smisServiceStopped=smisServiceStopped, properties=properties, fcTargetIndex=fcTargetIndex, lunInitiatorGroup=lunInitiatorGroup, lunFreeSizeHigh=lunFreeSizeHigh, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolAvgWriteLatency=poolAvgWriteLatency, nfsTotalReadMbps=nfsTotalReadMbps, ipmiTemperature=ipmiTemperature, upgradeStarted=upgradeStarted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiWriteIops=iscsiWriteIops, lunEntry=lunEntry, smisServiceStarted=smisServiceStarted, diskIOCount=diskIOCount, fcTotalWriteMbps=fcTotalWriteMbps, cacheTotalWriteIops=cacheTotalWriteIops, upgradeCompleted=upgradeCompleted, lunWriteLatency=lunWriteLatency, shareCIFSWriteIops=shareCIFSWriteIops, fcInitiatorEntry=fcInitiatorEntry, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, cifsTotalWriteMbps=cifsTotalWriteMbps, diskTotalWriteIops=diskTotalWriteIops)
