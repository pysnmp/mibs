...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, Gauge32, enterprises, TimeTicks, NotificationType, ObjectIdentity, MibIdentifier, Counter32, ModuleIdentity, Bits, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "Gauge32", "enterprises", "TimeTicks", "NotificationType", "ObjectIdentity", "MibIdentifier", "Counter32", "ModuleIdentity", "Bits", "Counter64", "iso")
...
mibBuilder.exportSymbols("TEGILE-MIB", targetGroupCreateCompleted=targetGroupCreateCompleted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolCreated=poolCreated, lunReadIops=lunReadIops, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiInitiatorIndex=iscsiInitiatorIndex, shareTable=shareTable, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareNFSReadLatency=shareNFSReadLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, aclMigrationStarted=aclMigrationStarted, diskTotalWriteMbps=diskTotalWriteMbps, diskTotalReadMbps=diskTotalReadMbps, iscsiTotalReadIops=iscsiTotalReadIops, notificationSensorSuspect=notificationSensorSuspect, nicEntry=nicEntry, poolAvgWriteLatency=poolAvgWriteLatency, notificationSeverity=notificationSeverity, diskError=diskError, haControllerB_IPAddr=haControllerB_IPAddr, volumeModifyCompleted=volumeModifyCompleted, lunDedupEnabled=lunDedupEnabled, basicCompliance=basicCompliance, projectPoolName=projectPoolName, shareQuotaFinished=shareQuotaFinished, iscsiTargetError=iscsiTargetError, fcTargets=fcTargets, projectLunCount=projectLunCount, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, notificationEventCode=notificationEventCode, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, iscsiTargetGroupError=iscsiTargetGroupError, cacheTotalWriteIops=cacheTotalWriteIops, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, lunSizeHigh=lunSizeHigh, haControllerB_Uptime=haControllerB_Uptime, haResourceActiveNode=haResourceActiveNode, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, fcTargetEntry=fcTargetEntry, iscsiTargetReadIops=iscsiTargetReadIops, iscsiTargetReadLatency=iscsiTargetReadLatency, projectIndex=projectIndex, cacheRAMReads=cacheRAMReads, iscsiTargetWriteMbps=iscsiTargetWriteMbps, netbiosSocketFailure=netbiosSocketFailure, iscsiTargetName=iscsiTargetName, webdocsUpgradeFailed=webdocsUpgradeFailed, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolCount=poolCount, controllerUp=controllerUp, fcInitiatorIndex=fcInitiatorIndex, fcInitiatorsTable=fcInitiatorsTable, iscsiInitiatorGroup=iscsiInitiatorGroup, lunReservedSizeLow=lunReservedSizeLow, upgradeCompleted=upgradeCompleted, fcTargetsTable=fcTargetsTable, maintenanceModeDisabled=maintenanceModeDisabled, shareNFSEnabled=shareNFSEnabled, shareCreatedSuccessfully=shareCreatedSuccessfully, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareNFSWriteIops=shareNFSWriteIops, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, nfsTotalReadIops=nfsTotalReadIops, ipmiOther=ipmiOther, poolDataReadIops=poolDataReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareCIFSWriteLatency=shareCIFSWriteLatency, networkInterfaceDown=networkInterfaceDown, diskDataReadMbps=diskDataReadMbps, ntpServerTimeDrift=ntpServerTimeDrift, poolIndex=poolIndex, cifsTotalWriteMbps=cifsTotalWriteMbps, haResourceStatus=haResourceStatus, diskSlowIo=diskSlowIo, targetGroupDeleteCompleted=targetGroupDeleteCompleted, ipmiPowerSupply=ipmiPowerSupply, poolFreeSizeLow=poolFreeSizeLow, deleteFolderFailed=deleteFolderFailed, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, fcAvgWriteLatency=fcAvgWriteLatency, notificationProps=notificationProps, projectFreeSizeHigh=projectFreeSizeHigh, poolTotalReadMbps=poolTotalReadMbps, shareCompressionEnabled=shareCompressionEnabled, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareDataSizeHigh=shareDataSizeHigh, diskAvgReadLatency=diskAvgReadLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, fcTargetModifyCompleted=fcTargetModifyCompleted, lunBlockSize=lunBlockSize, lunProjectName=lunProjectName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareProjectName=shareProjectName, lunReadLatency=lunReadLatency, projectModified=projectModified, projectDataSizeLow=projectDataSizeLow, projectDeleted=projectDeleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, nfsAvgReadLatency=nfsAvgReadLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, cifsTotalReadMbps=cifsTotalReadMbps, tegileGroups=tegileGroups, shareNFSWriteMbps=shareNFSWriteMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, lunDataSizeHigh=lunDataSizeHigh, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiInitiatorName=iscsiInitiatorName, shareCIFSWriteIops=shareCIFSWriteIops, properties=properties, networkIpmpGroupUp=networkIpmpGroupUp, tegileConformance=tegileConformance, globalStatistics=globalStatistics, diskState=diskState, fcTargetWriteIops=fcTargetWriteIops, cifsAvgReadLatency=cifsAvgReadLatency, snapshotRollbackCompleted=snapshotRollbackCompleted, poolUsedSizeLow=poolUsedSizeLow, memoryFailure=memoryFailure, iscsiTargetIndex=iscsiTargetIndex, poolProjectCount=poolProjectCount, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareNFSReadIops=shareNFSReadIops, deleteFolderCompleted=deleteFolderCompleted, poolDeleted=poolDeleted, notificationObjects=notificationObjects, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diskSequentialIOCount=diskSequentialIOCount, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, lunReadMbps=lunReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiTargetGroup=iscsiTargetGroup, replicationStarted=replicationStarted, fcProperties=fcProperties, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolMetaWriteIops=poolMetaWriteIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolHealth=poolHealth, snmpAgentVersion=snmpAgentVersion, fcTotalReadMbps=fcTotalReadMbps, diskSizeLow=diskSizeLow, snapshotRollbackFailed=snapshotRollbackFailed, shareIndex=shareIndex, intelliFlashSoftwareUp=intelliFlashSoftwareUp, replicationTargetDeleted=replicationTargetDeleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, haResourcesTable=haResourcesTable, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolQuotaFinished=poolQuotaFinished, shareNFSReadMbps=shareNFSReadMbps, nfsTotalWriteIops=nfsTotalWriteIops, poolReadCacheReadIops=poolReadCacheReadIops, ipmiThreshold=ipmiThreshold, nvdimmFailDeviceError=nvdimmFailDeviceError, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, diskType=diskType, shareQuotaHigh=shareQuotaHigh, poolTable=poolTable, sensorFailureEvent=sensorFailureEvent, shareReservedSizeHigh=shareReservedSizeHigh, upgradeDownloadStarted=upgradeDownloadStarted, cacheSSDReads=cacheSSDReads, upgradeDownloadFailed=upgradeDownloadFailed, tegileCompliances=tegileCompliances, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, targetGroupMemberAdded=targetGroupMemberAdded, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, nicTransmitMbps=nicTransmitMbps, smisServiceStarted=smisServiceStarted, iscsiTargetsTable=iscsiTargetsTable, fcTargetIndex=fcTargetIndex, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunPoolName=lunPoolName, poolDataReadLatency=poolDataReadLatency, iscsiWriteIops=iscsiWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, poolExported=poolExported, projectTable=projectTable, poolSizeLow=poolSizeLow, snmpServiceStarted=snmpServiceStarted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareDataSizeLow=shareDataSizeLow, networkTotalTransmitMbps=networkTotalTransmitMbps, diskEntry=diskEntry, snmpServiceStopped=snmpServiceStopped, ipmiVoltage=ipmiVoltage, notificationTargetEntityName=notificationTargetEntityName, fcAvgReadLatency=fcAvgReadLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, ipmiCurrent=ipmiCurrent, nicMTU=nicMTU, notificationSensorNumber=notificationSensorNumber, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastores=vmwareNFSDatastores, poolEntry=poolEntry, tegileArray_notifications=tegileArray_notifications, poolProjects=poolProjects, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, snmpServiceStopFailed=snmpServiceStopFailed, snapshotCloningFailed=snapshotCloningFailed, controllerTimeDrift=controllerTimeDrift, iscsiImproperTargetGroup=iscsiImproperTargetGroup, shareCIFSReadIops=shareCIFSReadIops, upgradeTimeout=upgradeTimeout, fcTotalReadIops=fcTotalReadIops, nvdimmFailUnknownError=nvdimmFailUnknownError, controllerDown=controllerDown, haResourceGroup=haResourceGroup, shareDeleted=shareDeleted, snapshotCreationFailed=snapshotCreationFailed, notificationReadingTriggerValue=notificationReadingTriggerValue, notificationTime=notificationTime, upgradeStarted=upgradeStarted, poolName=poolName, testNotification=testNotification, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskTotalWriteIops=diskTotalWriteIops, lunDataSizeLow=lunDataSizeLow, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskDataWriteIops=diskDataWriteIops, lunWriteIops=lunWriteIops, cacheTotalWriteMbps=cacheTotalWriteMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolDataWriteLatency=poolDataWriteLatency, replicationComplete=replicationComplete, tdpsUpgradeCompleted=tdpsUpgradeCompleted, shareMountPoint=shareMountPoint, projectQuotaSizeLow=projectQuotaSizeLow, diskIndex=diskIndex, poolState=poolState, haResourceName=haResourceName, shareCIFSWriteMbps=shareCIFSWriteMbps, diagnosticDataUploaded=diagnosticDataUploaded, controllerHardwareModel=controllerHardwareModel, ipmiTemperature=ipmiTemperature, poolMetaReadIops=poolMetaReadIops, notificationComponentName=notificationComponentName, network=network, ipmiCriticalInterrupt=ipmiCriticalInterrupt, fcInitiatorName=fcInitiatorName, shareNFSWriteLatency=shareNFSWriteLatency, PYSNMP_MODULE_ID=tegile)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiInitiators=iscsiInitiators, adServerTimeDrift=adServerTimeDrift, fcTargetName=fcTargetName, lunName=lunName, iscsiInitiatorEntry=iscsiInitiatorEntry, notifications=notifications, pools=pools, aclMigrationCompleted=aclMigrationCompleted, notificationReadingUnit=notificationReadingUnit, projectDedupEnabled=projectDedupEnabled, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolDegraded=poolDegraded, smbSocketFailure=smbSocketFailure, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, replicationAbandoned=replicationAbandoned, iscsiTotalWriteMbps=iscsiTotalWriteMbps, cpuInterrupts=cpuInterrupts, poolMetaWriteMbps=poolMetaWriteMbps, nicIndex=nicIndex, projectQuotaSizeHigh=projectQuotaSizeHigh, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, lunCompressedRatio=lunCompressedRatio, haResourceDescription=haResourceDescription, replicationFailed=replicationFailed, poolAvgReadLatency=poolAvgReadLatency, volumeDeleteFailed=volumeDeleteFailed, iscsiTargets=iscsiTargets, lunCompressionEnabled=lunCompressionEnabled, nicTable=nicTable, fcPortOnline=fcPortOnline, sanProperties=sanProperties, lunWriteLatency=lunWriteLatency, alertsCleanupCompleted=alertsCleanupCompleted, volumeDeleteCompleted=volumeDeleteCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, projectTotalSaving=projectTotalSaving, fcInitiatorCreateFailed=fcInitiatorCreateFailed, nicName=nicName, poolTotalWriteMbps=poolTotalWriteMbps, notificationSensorAction=notificationSensorAction, projectShareCount=projectShareCount, poolSizeHigh=poolSizeHigh, notificationDescription=notificationDescription, cpuSystemCalls=cpuSystemCalls, poolMetaReadMbps=poolMetaReadMbps, iscsiTargetAuth=iscsiTargetAuth, poolUsedSizeHigh=poolUsedSizeHigh, networkIpmpGroupDown=networkIpmpGroupDown, nfsTotalWriteMbps=nfsTotalWriteMbps, volumeQuotaFinished=volumeQuotaFinished, sharePoolName=sharePoolName, shareDedupEnabled=shareDedupEnabled, poolReadCacheReadLatency=poolReadCacheReadLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, nicGroup=nicGroup, diskDataWriteMbps=diskDataWriteMbps, smisServiceStopped=smisServiceStopped, haControllerA_Uptime=haControllerA_Uptime, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskAlias=diskAlias, tegile=tegile, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, projectName=projectName, diskGoneOffline=diskGoneOffline, replicationSourceRegistered=replicationSourceRegistered, replicationResumed=replicationResumed, lunFreeSizeLow=lunFreeSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, shareCIFSReadLatency=shareCIFSReadLatency, poolTotalSaving=poolTotalSaving, spareDiskReplaced=spareDiskReplaced, poolUpgraded=poolUpgraded, ipmiFan=ipmiFan, currentNotificationGroup=currentNotificationGroup, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiInitiatorsTable=iscsiInitiatorsTable, fcInitiatorGroup=fcInitiatorGroup, initiatorGroupMemberAdded=initiatorGroupMemberAdded, snapshotCloneCompleted=snapshotCloneCompleted, poolMetaReadLatency=poolMetaReadLatency, poolMetaWriteLatency=poolMetaWriteLatency, cacheTotalReadIops=cacheTotalReadIops, cifsTotalReadIops=cifsTotalReadIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, lunWriteMbps=lunWriteMbps, userLoginFailed=userLoginFailed, shareCIFSReadMbps=shareCIFSReadMbps, poolDataWriteIops=poolDataWriteIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, fcPortOffline=fcPortOffline, lunIndex=lunIndex, smisServiceStartFailed=smisServiceStartFailed, snapshotDeleteFailed=snapshotDeleteFailed, maintenanceModeEnabled=maintenanceModeEnabled, fcInitiatorEntry=fcInitiatorEntry, projectLUNs=projectLUNs, projectEntry=projectEntry, fcTargetWriteLatency=fcTargetWriteLatency, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectSnapshotSizeLow=projectSnapshotSizeLow, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolTotalWriteIops=poolTotalWriteIops, iscsiTargetEntry=iscsiTargetEntry, tegileArray=tegileArray, diskTable=diskTable, fcTargetReadMbps=fcTargetReadMbps, poolExpanded=poolExpanded, projectQuotaFinished=projectQuotaFinished, unknownSensorEvent=unknownSensorEvent, lunTargetGroup=lunTargetGroup, shareQuotaLow=shareQuotaLow, shareSnapshotSizeLow=shareSnapshotSizeLow, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolDataReadMbps=poolDataReadMbps, lunProtocol=lunProtocol, diskChassisIdx=diskChassisIdx, lunFreeSizeHigh=lunFreeSizeHigh, smisServiceStopFailed=smisServiceStopFailed, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, nvdimmFailInitializationError=nvdimmFailInitializationError, nicState=nicState, cifsTotalWriteIops=cifsTotalWriteIops, poolFreeSizeHigh=poolFreeSizeHigh, haControllerA_IPAddr=haControllerA_IPAddr, fcTargetGroup=fcTargetGroup, haResourceIndex=haResourceIndex, webdocsUpgradeCompleted=webdocsUpgradeCompleted, cpuTotalUsage=cpuTotalUsage, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolImported=poolImported, replicationPaused=replicationPaused, diskRandomIOCount=diskRandomIOCount, poolReadCacheReadMbps=poolReadCacheReadMbps, nfsTotalReadMbps=nfsTotalReadMbps, shareCIFSEnabled=shareCIFSEnabled, iscsiTotalReadMbps=iscsiTotalReadMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiAvgWriteLatency=iscsiAvgWriteLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, ipmiMemory=ipmiMemory, fcTargetReadLatency=fcTargetReadLatency, projectDeletionFailed=projectDeletionFailed, shareDeletionFailed=shareDeletionFailed, fcTargetStatus=fcTargetStatus, poolOwnerController=poolOwnerController, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunSizeLow=lunSizeLow, lunSnapshotSizeHigh=lunSnapshotSizeHigh, replicationAborted=replicationAborted, shareReservedSizeLow=shareReservedSizeLow, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, projectDataSizeHigh=projectDataSizeHigh, shareCompressedRatio=shareCompressedRatio, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareEntry=shareEntry, upgradeFailed=upgradeFailed, upgradeDownloadCompleted=upgradeDownloadCompleted, poolDataSizeLow=poolDataSizeLow, diskIsOnline=diskIsOnline, snmpServiceStartFailed=snmpServiceStartFailed, iscsiTargetAlias=iscsiTargetAlias, haResourceEntry=haResourceEntry, nvdimmFailSoftError=nvdimmFailSoftError, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiTargetReadMbps=iscsiTargetReadMbps, diskSizeHigh=diskSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, diskDataReadIops=diskDataReadIops, haResources=haResources, currentObjectGroup=currentObjectGroup, diskAvgWriteLatency=diskAvgWriteLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, poolDataSizeHigh=poolDataSizeHigh, fcTotalWriteMbps=fcTotalWriteMbps, nicReceiveMbps=nicReceiveMbps, lunInitiatorGroup=lunInitiatorGroup, haControllerB_Name=haControllerB_Name, projectShares=projectShares, fcTargetReadIops=fcTargetReadIops, iscsiProperties=iscsiProperties, networkInterfaceUp=networkInterfaceUp, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunGUID=lunGUID, diskPoolName=diskPoolName, poolDataWriteMbps=poolDataWriteMbps, projectFreeSizeLow=projectFreeSizeLow, nfsAvgWriteLatency=nfsAvgWriteLatency, poolDeletionFailed=poolDeletionFailed, fcTotalWriteIops=fcTotalWriteIops, projectThresholdExceedWarning=projectThresholdExceedWarning, lunEntry=lunEntry, tdpsUpgradeFailed=tdpsUpgradeFailed, projectCompressionEnabled=projectCompressionEnabled, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, disks=disks, diskIOCount=diskIOCount, diskCount=diskCount, haControllerA_Name=haControllerA_Name, lunTable=lunTable, shareName=shareName, diskTotalReadIops=diskTotalReadIops, cifsAvgWriteLatency=cifsAvgWriteLatency, targetGroupMemberRemoved=targetGroupMemberRemoved, fcInitiators=fcInitiators, poolTotalReadIops=poolTotalReadIops)
