...
ObjectIdentity, iso, IpAddress, ModuleIdentity, NotificationType, Integer32, Gauge32, MibIdentifier, TimeTicks, Bits, Counter64, Unsigned32, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "IpAddress", "ModuleIdentity", "NotificationType", "Integer32", "Gauge32", "MibIdentifier", "TimeTicks", "Bits", "Counter64", "Unsigned32", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetReadLatency=fcTargetReadLatency, poolExpanded=poolExpanded, lunGUID=lunGUID, controllerTimeDrift=controllerTimeDrift, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diskSizeHigh=diskSizeHigh, replicationPaused=replicationPaused, poolAvgWriteLatency=poolAvgWriteLatency, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, PYSNMP_MODULE_ID=tegile, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, shareTable=shareTable, shareCIFSReadLatency=shareCIFSReadLatency, maintenanceModeEnabled=maintenanceModeEnabled, projectThresholdExceedWarning=projectThresholdExceedWarning, poolDeletionFailed=poolDeletionFailed, projectTotalSaving=projectTotalSaving, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareName=shareName, iscsiInitiatorIndex=iscsiInitiatorIndex, networkIpmpGroupUp=networkIpmpGroupUp, fcInitiatorGroup=fcInitiatorGroup, fcInitiatorEntry=fcInitiatorEntry, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, globalStatistics=globalStatistics, nicReceiveMbps=nicReceiveMbps, fcTotalReadIops=fcTotalReadIops, poolReadCacheReadMbps=poolReadCacheReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargetStatus=fcTargetStatus, cifsAvgWriteLatency=cifsAvgWriteLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, fcTargetName=fcTargetName, adServerTimeDrift=adServerTimeDrift, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiTargetGroupError=iscsiTargetGroupError, snapshotRollbackCompleted=snapshotRollbackCompleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, targetGroupMemberRemoved=targetGroupMemberRemoved, lunReadMbps=lunReadMbps, diskGoneOffline=diskGoneOffline, projectCompressionEnabled=projectCompressionEnabled, diskAvgReadLatency=diskAvgReadLatency, fcInitiatorsTable=fcInitiatorsTable, poolDataReadLatency=poolDataReadLatency, networkIpmpGroupDown=networkIpmpGroupDown, shareSnapshotSizeLow=shareSnapshotSizeLow, poolTotalWriteMbps=poolTotalWriteMbps, cifsAvgReadLatency=cifsAvgReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcTargetReadMbps=fcTargetReadMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolReadCacheReadIops=poolReadCacheReadIops, shareDeletionFailed=shareDeletionFailed, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, snmpServiceStopped=snmpServiceStopped, shareCompressionEnabled=shareCompressionEnabled, replicationStarted=replicationStarted, fcTargetsTable=fcTargetsTable, iscsiImproperTargetGroup=iscsiImproperTargetGroup, projectLUNs=projectLUNs, lunTargetGroup=lunTargetGroup, notificationThresholdTriggerValue=notificationThresholdTriggerValue, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolDataSizeHigh=poolDataSizeHigh, poolMetaReadMbps=poolMetaReadMbps, lunProtocol=lunProtocol, volumeDeleteCompleted=volumeDeleteCompleted, notificationReadingUnit=notificationReadingUnit, poolDataSizeLow=poolDataSizeLow, ipmiOther=ipmiOther, iscsiTargetEntry=iscsiTargetEntry, fcTargets=fcTargets, iscsiTotalWriteMbps=iscsiTotalWriteMbps, lunReadLatency=lunReadLatency, ipmiPowerSupply=ipmiPowerSupply, ipmiFan=ipmiFan, fcInitiators=fcInitiators, diskDataReadMbps=diskDataReadMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, sanProperties=sanProperties, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, replicationSourceRegistered=replicationSourceRegistered, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolHealth=poolHealth, networkTotalReceiveMbps=networkTotalReceiveMbps, nicState=nicState, iscsiInitiatorsTable=iscsiInitiatorsTable, cacheSSDReads=cacheSSDReads, deleteFolderCompleted=deleteFolderCompleted, poolDeleted=poolDeleted, cifsTotalWriteIops=cifsTotalWriteIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, shareDedupEnabled=shareDedupEnabled, iscsiTargetGroup=iscsiTargetGroup, poolAvgReadLatency=poolAvgReadLatency, replicationFailed=replicationFailed, smisServiceStarted=smisServiceStarted, nvdimmFailDeviceError=nvdimmFailDeviceError, tegileCompliances=tegileCompliances, poolFreeSizeLow=poolFreeSizeLow, notificationTime=notificationTime, replicationResumed=replicationResumed, poolReadCacheWriteIops=poolReadCacheWriteIops, lunName=lunName, fcAvgWriteLatency=fcAvgWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunPoolName=lunPoolName, iscsiInitiatorEntry=iscsiInitiatorEntry, targetGroupMemberAdded=targetGroupMemberAdded, nfsAvgWriteLatency=nfsAvgWriteLatency, projectLunCount=projectLunCount, fcPortOffline=fcPortOffline, lunEntry=lunEntry, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectName=projectName, nicTable=nicTable, volumeDeleteFailed=volumeDeleteFailed, poolMetaWriteIops=poolMetaWriteIops, smisServiceStartFailed=smisServiceStartFailed, lunTable=lunTable, nvdimmFailSoftError=nvdimmFailSoftError, haResourcesTable=haResourcesTable, cifsTotalWriteMbps=cifsTotalWriteMbps, lunReservedSizeHigh=lunReservedSizeHigh, fcTargetIndex=fcTargetIndex, replicationComplete=replicationComplete, fcTotalReadMbps=fcTotalReadMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolDataReadIops=poolDataReadIops, poolTotalWriteIops=poolTotalWriteIops, lunWriteMbps=lunWriteMbps, upgradeStarted=upgradeStarted, iscsiTargets=iscsiTargets, vmwareNFSDatastores=vmwareNFSDatastores, cpuTotalUsage=cpuTotalUsage, diskIndex=diskIndex, haResourceIndex=haResourceIndex, poolSizeLow=poolSizeLow, notifications=notifications, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolDataWriteIops=poolDataWriteIops, projectFreeSizeLow=projectFreeSizeLow, diskSequentialIOCount=diskSequentialIOCount, poolProjects=poolProjects, fcTargetModifyCompleted=fcTargetModifyCompleted, smbSocketFailure=smbSocketFailure, shareCIFSReadMbps=shareCIFSReadMbps, diskRandomIOCount=diskRandomIOCount, diskTotalReadIops=diskTotalReadIops, fcTargetReadIops=fcTargetReadIops, haControllerA_Name=haControllerA_Name, poolDataWriteMbps=poolDataWriteMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, cacheTotalReadIops=cacheTotalReadIops, poolMetaWriteLatency=poolMetaWriteLatency, fcTargetWriteIops=fcTargetWriteIops, shareNFSEnabled=shareNFSEnabled, shareQuotaFinished=shareQuotaFinished, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, shareDataSizeHigh=shareDataSizeHigh, volumeCreatedSuccessfully=volumeCreatedSuccessfully, nicGroup=nicGroup, haResourceEntry=haResourceEntry, controllerHardwareModel=controllerHardwareModel, nicName=nicName, shareCIFSReadIops=shareCIFSReadIops, iscsiTargetAuth=iscsiTargetAuth, diskPoolName=diskPoolName, lunSnapshotSizeLow=lunSnapshotSizeLow, lunReservedSizeLow=lunReservedSizeLow, projectTable=projectTable, shareNFSWriteIops=shareNFSWriteIops, poolName=poolName, diskTable=diskTable, iscsiTargetReadIops=iscsiTargetReadIops, volumeQuotaFinished=volumeQuotaFinished, currentNotificationGroup=currentNotificationGroup, upgradeFailed=upgradeFailed, ipmiTemperature=ipmiTemperature, lunBlockSize=lunBlockSize, shareCompressedRatio=shareCompressedRatio, snmpServiceStarted=snmpServiceStarted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, memoryFailure=memoryFailure, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, notificationSensorAction=notificationSensorAction, tegileArray_notifications=tegileArray_notifications, nfsTotalReadIops=nfsTotalReadIops, fcPortOnline=fcPortOnline, ipmiCurrent=ipmiCurrent, shareReservedSizeHigh=shareReservedSizeHigh, controllerUp=controllerUp, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, cacheTotalWriteMbps=cacheTotalWriteMbps, poolUpgraded=poolUpgraded, poolTable=poolTable, poolUsedSizeLow=poolUsedSizeLow, controllerDown=controllerDown, poolSizeHigh=poolSizeHigh, haControllerB_Uptime=haControllerB_Uptime, notificationTargetEntityName=notificationTargetEntityName, haResources=haResources, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunWriteLatency=lunWriteLatency, snmpAgentVersion=snmpAgentVersion, iscsiTargetsTable=iscsiTargetsTable, iscsiTargetIndex=iscsiTargetIndex, shareNFSWriteLatency=shareNFSWriteLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, diskTotalWriteMbps=diskTotalWriteMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareCIFSWriteMbps=shareCIFSWriteMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, fcProperties=fcProperties, netbiosSocketFailure=netbiosSocketFailure, replicationTargetDeleted=replicationTargetDeleted, replicationAborted=replicationAborted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiTargetError=iscsiTargetError, networkInterfaceDown=networkInterfaceDown, poolProjectCount=poolProjectCount, fcInitiatorIndex=fcInitiatorIndex, projectPoolName=projectPoolName, fcTotalWriteMbps=fcTotalWriteMbps, poolOwnerController=poolOwnerController, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, cacheTotalReadMbps=cacheTotalReadMbps, projectFreeSizeHigh=projectFreeSizeHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectQuotaSizeLow=projectQuotaSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolIndex=poolIndex, snmpServiceStartFailed=snmpServiceStartFailed, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectDeletionFailed=projectDeletionFailed, nfsTotalWriteIops=nfsTotalWriteIops, fcTargetEntry=fcTargetEntry, poolImported=poolImported, currentObjectGroup=currentObjectGroup, userLoginFailed=userLoginFailed, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, lunWriteIops=lunWriteIops, basicCompliance=basicCompliance, poolReadCacheReadLatency=poolReadCacheReadLatency, testNotification=testNotification)
mibBuilder.exportSymbols("TEGILE-MIB", diskIsOnline=diskIsOnline, notificationProps=notificationProps, iscsiTargetReadLatency=iscsiTargetReadLatency, upgradeDownloadFailed=upgradeDownloadFailed, diskChassisIdx=diskChassisIdx, diskState=diskState, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectCreatedSuccessfully=projectCreatedSuccessfully, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareQuotaLow=shareQuotaLow, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectModified=projectModified, deleteFolderFailed=deleteFolderFailed, fcTargetGroup=fcTargetGroup, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, upgradeDownloadStarted=upgradeDownloadStarted, lunIndex=lunIndex, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, cpuInterrupts=cpuInterrupts, properties=properties, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, tegile=tegile, poolExported=poolExported, poolWriteCacheWriteIops=poolWriteCacheWriteIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, nfsTotalReadMbps=nfsTotalReadMbps, iscsiWriteIops=iscsiWriteIops, tegileGroups=tegileGroups, poolState=poolState, replicationAbandoned=replicationAbandoned, volumeModifyCompleted=volumeModifyCompleted, alertsCleanupCompleted=alertsCleanupCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcTargetWriteMbps=fcTargetWriteMbps, shareReservedSizeLow=shareReservedSizeLow, notificationEventCode=notificationEventCode, shareIndex=shareIndex, tegileConformance=tegileConformance, shareEntry=shareEntry, iscsiTargetName=iscsiTargetName, fcInitiatorName=fcInitiatorName, notificationSensorSuspect=notificationSensorSuspect, webdocsUpgradeFailed=webdocsUpgradeFailed, lunProjectName=lunProjectName, notificationSeverity=notificationSeverity, notificationReadingTriggerValue=notificationReadingTriggerValue, spareDiskReplaced=spareDiskReplaced, haControllerA_IPAddr=haControllerA_IPAddr, diskType=diskType, nicTransmitMbps=nicTransmitMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, lunFreeSizeHigh=lunFreeSizeHigh, lunSizeLow=lunSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunDataSizeHigh=lunDataSizeHigh, nicEntry=nicEntry, haControllerA_Uptime=haControllerA_Uptime, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolFreeSizeHigh=poolFreeSizeHigh, projectDataSizeHigh=projectDataSizeHigh, shareNFSReadIops=shareNFSReadIops, poolDataReadMbps=poolDataReadMbps, cifsTotalReadMbps=cifsTotalReadMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, targetGroupDeleteCompleted=targetGroupDeleteCompleted, ntpServerTimeDrift=ntpServerTimeDrift, ipmiVoltage=ipmiVoltage, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiProperties=iscsiProperties, snapshotRollbackFailed=snapshotRollbackFailed, projectDedupEnabled=projectDedupEnabled, lunReadIops=lunReadIops, shareNFSReadLatency=shareNFSReadLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, snapshotDeleteFailed=snapshotDeleteFailed, cifsTotalReadIops=cifsTotalReadIops, iscsiTargetReadMbps=iscsiTargetReadMbps, sharePoolName=sharePoolName, projectShares=projectShares, aclMigrationCompleted=aclMigrationCompleted, haControllerB_Name=haControllerB_Name, diskDataReadIops=diskDataReadIops, snapshotCloneCompleted=snapshotCloneCompleted, haResourceGroup=haResourceGroup, haResourceDescription=haResourceDescription, lunFreeSizeLow=lunFreeSizeLow, iscsiTargetAlias=iscsiTargetAlias, tegileArray=tegileArray, shareMountPoint=shareMountPoint, diskDataWriteIops=diskDataWriteIops, fcAvgReadLatency=fcAvgReadLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, diskSlowIo=diskSlowIo, nicIndex=nicIndex, shareDeleted=shareDeleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, shareQuotaHigh=shareQuotaHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, diskEntry=diskEntry, poolQuotaFinished=poolQuotaFinished, diskSizeLow=diskSizeLow, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, projectShareCount=projectShareCount, haResourceName=haResourceName, shareCIFSWriteIops=shareCIFSWriteIops, lunInitiatorGroup=lunInitiatorGroup, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, lunCompressedRatio=lunCompressedRatio, disks=disks, ipmiThreshold=ipmiThreshold, nfsAvgReadLatency=nfsAvgReadLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, notificationDescription=notificationDescription, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, aclMigrationStarted=aclMigrationStarted, pools=pools, diskIOCount=diskIOCount, projectSnapshotSizeLow=projectSnapshotSizeLow, upgradeTimeout=upgradeTimeout, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolTotalReadIops=poolTotalReadIops, cpuSystemCalls=cpuSystemCalls, iscsiAvgReadLatency=iscsiAvgReadLatency, poolDataWriteLatency=poolDataWriteLatency, lunDataSizeLow=lunDataSizeLow, poolCreated=poolCreated, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, upgradeDownloadCompleted=upgradeDownloadCompleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcTargetWriteLatency=fcTargetWriteLatency, cacheRAMReads=cacheRAMReads, network=network, ipmiMemory=ipmiMemory, sensorFailureEvent=sensorFailureEvent, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcTotalWriteIops=fcTotalWriteIops, notificationObjects=notificationObjects, iscsiTotalReadMbps=iscsiTotalReadMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, shareDataSizeLow=shareDataSizeLow, lunDedupEnabled=lunDedupEnabled, shareNFSReadMbps=shareNFSReadMbps, poolDegraded=poolDegraded, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiTargetWriteIops=iscsiTargetWriteIops, haResourceActiveNode=haResourceActiveNode, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, smisServiceStopFailed=smisServiceStopFailed, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunCompressionEnabled=lunCompressionEnabled, networkInterfaceUp=networkInterfaceUp, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolMetaWriteMbps=poolMetaWriteMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiInitiatorName=iscsiInitiatorName, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, cacheTotalWriteIops=cacheTotalWriteIops, diskTotalWriteIops=diskTotalWriteIops, shareCIFSEnabled=shareCIFSEnabled, shareProjectName=shareProjectName, poolUsedSizeHigh=poolUsedSizeHigh, notificationComponentName=notificationComponentName, haControllerB_IPAddr=haControllerB_IPAddr, poolTotalSaving=poolTotalSaving, haResourceStatus=haResourceStatus, maintenanceModeDisabled=maintenanceModeDisabled, iscsiInitiators=iscsiInitiators, projectSnapshotSizeHigh=projectSnapshotSizeHigh, snmpServiceStopFailed=snmpServiceStopFailed, diagnosticDataUploaded=diagnosticDataUploaded, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunSizeHigh=lunSizeHigh, diskError=diskError, diskAvgWriteLatency=diskAvgWriteLatency, nicMTU=nicMTU, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, nvdimmFailUnknownError=nvdimmFailUnknownError, diskCount=diskCount, poolEntry=poolEntry, diskAlias=diskAlias, poolMetaReadIops=poolMetaReadIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiInitiatorGroup=iscsiInitiatorGroup, snapshotCreationFailed=snapshotCreationFailed, diskTotalReadMbps=diskTotalReadMbps, snapshotCloningFailed=snapshotCloningFailed, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, projectIndex=projectIndex, upgradeCompleted=upgradeCompleted, poolCount=poolCount, projectDeleted=projectDeleted, smisServiceStopped=smisServiceStopped, projectDataSizeLow=projectDataSizeLow, projectEntry=projectEntry, projectQuotaFinished=projectQuotaFinished, poolTotalReadMbps=poolTotalReadMbps, iscsiTotalReadIops=iscsiTotalReadIops, unknownSensorEvent=unknownSensorEvent, poolMetaReadLatency=poolMetaReadLatency, diskDataWriteMbps=diskDataWriteMbps)
