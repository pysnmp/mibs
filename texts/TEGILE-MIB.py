...
Counter64, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Bits, Integer32, TimeTicks, ObjectIdentity, Unsigned32, Counter32, enterprises, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Bits", "Integer32", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter32", "enterprises", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("TEGILE-MIB", tegile=tegile, poolUsedSizeLow=poolUsedSizeLow, nfsTotalReadMbps=nfsTotalReadMbps, fcTargetWriteIops=fcTargetWriteIops, upgradeCompleted=upgradeCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunWriteIops=lunWriteIops, shareIndex=shareIndex, currentObjectGroup=currentObjectGroup, haResourcesTable=haResourcesTable, poolProjectCount=poolProjectCount, iscsiTargetsTable=iscsiTargetsTable, ipmiThreshold=ipmiThreshold, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcTargetModifyCompleted=fcTargetModifyCompleted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, sensorFailureEvent=sensorFailureEvent, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectShareCount=projectShareCount, nicState=nicState, nicTransmitMbps=nicTransmitMbps, diskPoolName=diskPoolName, disks=disks, snmpAgentVersion=snmpAgentVersion, snapshotCloneCompleted=snapshotCloneCompleted, snmpServiceStopFailed=snmpServiceStopFailed, fcTotalWriteIops=fcTotalWriteIops, iscsiTargetReadLatency=iscsiTargetReadLatency, volumeModifyCompleted=volumeModifyCompleted, projectLunCount=projectLunCount, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunIndex=lunIndex, snmpServiceStarted=snmpServiceStarted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, deleteFolderFailed=deleteFolderFailed, notificationReadingUnit=notificationReadingUnit, iscsiInitiators=iscsiInitiators, cpuInterrupts=cpuInterrupts, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareCompressionEnabled=shareCompressionEnabled, networkIpmpGroupDown=networkIpmpGroupDown, netbiosSocketFailure=netbiosSocketFailure, projectDedupEnabled=projectDedupEnabled, nvdimmFailInitializationError=nvdimmFailInitializationError, targetGroupMemberAdded=targetGroupMemberAdded, lunReservedSizeLow=lunReservedSizeLow, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareMountPoint=shareMountPoint, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolMetaWriteIops=poolMetaWriteIops, smisServiceStartFailed=smisServiceStartFailed, projectEntry=projectEntry, volumeCreatedSuccessfully=volumeCreatedSuccessfully, iscsiTargetIndex=iscsiTargetIndex, haResources=haResources, poolQuotaFinished=poolQuotaFinished, nfsTotalWriteIops=nfsTotalWriteIops, sharePoolName=sharePoolName, cpuTotalUsage=cpuTotalUsage, haResourceDescription=haResourceDescription, lunReadIops=lunReadIops, alertsCleanupCompleted=alertsCleanupCompleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, lunCompressionEnabled=lunCompressionEnabled, lunGUID=lunGUID, shareNFSWriteLatency=shareNFSWriteLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, haControllerB_Uptime=haControllerB_Uptime, controllerHardwareModel=controllerHardwareModel, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, ntpServerTimeDrift=ntpServerTimeDrift, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, diskIOCount=diskIOCount, shareCreatedSuccessfully=shareCreatedSuccessfully, fcTargetReadIops=fcTargetReadIops, snapshotDeleteFailed=snapshotDeleteFailed, projectLUNs=projectLUNs, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, tdpsUpgradeTimeout=tdpsUpgradeTimeout, replicationResumed=replicationResumed, volumeDeleteCompleted=volumeDeleteCompleted, replicationAborted=replicationAborted, cifsAvgReadLatency=cifsAvgReadLatency, shareCIFSReadIops=shareCIFSReadIops, fcTargets=fcTargets, notificationDescription=notificationDescription, iscsiWriteIops=iscsiWriteIops, nicIndex=nicIndex, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectDeletionFailed=projectDeletionFailed, projectSnapshotSizeHigh=projectSnapshotSizeHigh, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolAvgWriteLatency=poolAvgWriteLatency, shareNFSWriteIops=shareNFSWriteIops, projectTable=projectTable, lunCompressedRatio=lunCompressedRatio, diskTotalReadMbps=diskTotalReadMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiAvgWriteLatency=iscsiAvgWriteLatency, iscsiTargetWriteLatency=iscsiTargetWriteLatency, notificationTargetEntityName=notificationTargetEntityName, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectCompressionEnabled=projectCompressionEnabled, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolDataWriteIops=poolDataWriteIops, poolDataReadLatency=poolDataReadLatency, ipmiFan=ipmiFan, iscsiTotalReadIops=iscsiTotalReadIops, lunSizeLow=lunSizeLow, maintenanceModeEnabled=maintenanceModeEnabled, diskEntry=diskEntry, basicCompliance=basicCompliance, pools=pools, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, notificationSensorAction=notificationSensorAction, currentNotificationGroup=currentNotificationGroup, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, lunFreeSizeLow=lunFreeSizeLow, fcPortOffline=fcPortOffline, fcAvgReadLatency=fcAvgReadLatency, poolUpgraded=poolUpgraded, ipmiOther=ipmiOther, haControllerB_Name=haControllerB_Name, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, poolTotalReadIops=poolTotalReadIops, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, haResourceEntry=haResourceEntry, controllerDown=controllerDown, poolState=poolState, poolReadCacheReadLatency=poolReadCacheReadLatency, notificationSensorNumber=notificationSensorNumber, diskSizeLow=diskSizeLow, notificationTime=notificationTime, poolHealth=poolHealth, iscsiInitiatorName=iscsiInitiatorName, diskRandomIOCount=diskRandomIOCount, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareCIFSEnabled=shareCIFSEnabled, shareDeletionFailed=shareDeletionFailed, lunProtocol=lunProtocol, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareNFSReadLatency=shareNFSReadLatency, poolExpanded=poolExpanded, lunWriteLatency=lunWriteLatency, cifsTotalWriteIops=cifsTotalWriteIops, replicationPaused=replicationPaused, PYSNMP_MODULE_ID=tegile, iscsiTargetAlias=iscsiTargetAlias, snapshotCloningFailed=snapshotCloningFailed, poolDataWriteLatency=poolDataWriteLatency, nicReceiveMbps=nicReceiveMbps, projectFreeSizeLow=projectFreeSizeLow, projectName=projectName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, shareProjectName=shareProjectName, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, targetGroupCreateCompleted=targetGroupCreateCompleted, fcInitiatorName=fcInitiatorName, shareCIFSReadMbps=shareCIFSReadMbps, projectDeleted=projectDeleted, tegileArray_notifications=tegileArray_notifications, network=network, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiTargetError=iscsiTargetError, ipmiCurrent=ipmiCurrent, fcTargetStatus=fcTargetStatus, lunProjectName=lunProjectName, upgradeTimeout=upgradeTimeout, shareCompressedRatio=shareCompressedRatio, ipmiPowerSupply=ipmiPowerSupply, poolMetaReadMbps=poolMetaReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, networkTotalReceiveMbps=networkTotalReceiveMbps, replicationStarted=replicationStarted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareQuotaFinished=shareQuotaFinished, shareCIFSWriteMbps=shareCIFSWriteMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, adServerTimeDrift=adServerTimeDrift, poolTable=poolTable, lunBlockSize=lunBlockSize, lunSizeHigh=lunSizeHigh, poolEntry=poolEntry, notificationSeverity=notificationSeverity, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectSnapshotSizeLow=projectSnapshotSizeLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectPoolName=projectPoolName, projectQuotaSizeLow=projectQuotaSizeLow, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolImported=poolImported, fcInitiatorEntry=fcInitiatorEntry, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, smisServiceStopped=smisServiceStopped, haResourceName=haResourceName, poolReadCacheWriteIops=poolReadCacheWriteIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareNFSEnabled=shareNFSEnabled, tdpsUpgradeFailed=tdpsUpgradeFailed, poolFreeSizeHigh=poolFreeSizeHigh, poolReadCacheReadMbps=poolReadCacheReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, lunTargetGroup=lunTargetGroup, fcTargetWriteLatency=fcTargetWriteLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectQuotaSizeHigh=projectQuotaSizeHigh, diskSizeHigh=diskSizeHigh, poolCount=poolCount, iscsiTargetWriteIops=iscsiTargetWriteIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, nvdimmFailUnknownError=nvdimmFailUnknownError, lunSnapshotSizeLow=lunSnapshotSizeLow, poolName=poolName, shareEntry=shareEntry, cifsAvgWriteLatency=cifsAvgWriteLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, spareDiskReplaced=spareDiskReplaced, diskDataWriteMbps=diskDataWriteMbps, poolUsedSizeHigh=poolUsedSizeHigh, poolReadCacheReadIops=poolReadCacheReadIops, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, diskType=diskType, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcInitiatorCreateFailed=fcInitiatorCreateFailed, haResourceStatus=haResourceStatus, shareQuotaLow=shareQuotaLow, upgradeDownloadCompleted=upgradeDownloadCompleted, lunName=lunName, tegileCompliances=tegileCompliances, networkInterfaceUp=networkInterfaceUp, diagnosticDataUploaded=diagnosticDataUploaded, diskTotalWriteMbps=diskTotalWriteMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolMetaReadIops=poolMetaReadIops, fcPortOnline=fcPortOnline, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, ipmiTemperature=ipmiTemperature, poolMetaWriteLatency=poolMetaWriteLatency, fcTargetIndex=fcTargetIndex, nicTable=nicTable, lunTable=lunTable)
mibBuilder.exportSymbols("TEGILE-MIB", shareDataSizeHigh=shareDataSizeHigh, notificationEventCode=notificationEventCode, poolDataWriteMbps=poolDataWriteMbps, shareTable=shareTable, snmpServiceStopped=snmpServiceStopped, diskChassisIdx=diskChassisIdx, shareNFSReadMbps=shareNFSReadMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, shareCIFSWriteIops=shareCIFSWriteIops, unknownSensorEvent=unknownSensorEvent, poolSizeLow=poolSizeLow, diskError=diskError, haResourceActiveNode=haResourceActiveNode, lunInitiatorGroup=lunInitiatorGroup, tegileArray=tegileArray, haControllerB_IPAddr=haControllerB_IPAddr, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, diskDataReadMbps=diskDataReadMbps, nicName=nicName, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiTargetReadIops=iscsiTargetReadIops, fcInitiatorsTable=fcInitiatorsTable, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunDataSizeLow=lunDataSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, fcTargetGroup=fcTargetGroup, lunFreeSizeHigh=lunFreeSizeHigh, notifications=notifications, fcTargetsTable=fcTargetsTable, iscsiInitiatorsTable=iscsiInitiatorsTable, lunDataSizeHigh=lunDataSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, snapshotCreationFailed=snapshotCreationFailed, poolFreeSizeLow=poolFreeSizeLow, sanProperties=sanProperties, poolDataReadMbps=poolDataReadMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, poolDeleted=poolDeleted, snapshotRollbackFailed=snapshotRollbackFailed, cacheRAMReads=cacheRAMReads, fcProperties=fcProperties, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskCount=diskCount, iscsiTargets=iscsiTargets, haControllerA_IPAddr=haControllerA_IPAddr, fcTotalReadMbps=fcTotalReadMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareNFSReadIops=shareNFSReadIops, fcAvgWriteLatency=fcAvgWriteLatency, lunDedupEnabled=lunDedupEnabled, nicGroup=nicGroup, fcTargetName=fcTargetName, lunWriteMbps=lunWriteMbps, poolExported=poolExported, iscsiTargetGroup=iscsiTargetGroup, controllerTimeDrift=controllerTimeDrift, diskTotalReadIops=diskTotalReadIops, diskSequentialIOCount=diskSequentialIOCount, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, upgradeDownloadFailed=upgradeDownloadFailed, cpuSystemCalls=cpuSystemCalls, upgradeFailed=upgradeFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, nicEntry=nicEntry, smisServiceStopFailed=smisServiceStopFailed, smisServiceStarted=smisServiceStarted, fcTargetReadMbps=fcTargetReadMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, cifsTotalReadIops=cifsTotalReadIops, diskAvgReadLatency=diskAvgReadLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, haControllerA_Uptime=haControllerA_Uptime, aclMigrationCompleted=aclMigrationCompleted, diskTable=diskTable, poolWriteCacheWriteIops=poolWriteCacheWriteIops, deleteFolderCompleted=deleteFolderCompleted, projectModified=projectModified, ipmiCriticalInterrupt=ipmiCriticalInterrupt, notificationObjects=notificationObjects, maintenanceModeDisabled=maintenanceModeDisabled, haResourceIndex=haResourceIndex, iscsiTargetEntry=iscsiTargetEntry, cacheTotalWriteMbps=cacheTotalWriteMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, poolIndex=poolIndex, controllerUp=controllerUp, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolAvgReadLatency=poolAvgReadLatency, diskIndex=diskIndex, poolOwnerController=poolOwnerController, fcTargetEntry=fcTargetEntry, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectIndex=projectIndex, lunReadLatency=lunReadLatency, cacheTotalWriteIops=cacheTotalWriteIops, properties=properties, projectDataSizeHigh=projectDataSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, upgradeDownloadStarted=upgradeDownloadStarted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, networkIpmpGroupUp=networkIpmpGroupUp, tdpsUpgradeCompleted=tdpsUpgradeCompleted, targetGroupMemberRemoved=targetGroupMemberRemoved, networkInterfaceDown=networkInterfaceDown, cacheTotalReadMbps=cacheTotalReadMbps, poolDataReadIops=poolDataReadIops, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiInitiatorGroup=iscsiInitiatorGroup, webdocsUpgradeFailed=webdocsUpgradeFailed, fcInitiators=fcInitiators, replicationComplete=replicationComplete, memoryFailure=memoryFailure, fcTotalReadIops=fcTotalReadIops, shareName=shareName, projectShares=projectShares, shareDeleted=shareDeleted, shareDedupEnabled=shareDedupEnabled, fcTotalWriteMbps=fcTotalWriteMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, snmpServiceStartFailed=snmpServiceStartFailed, shareSnapshotSizeLow=shareSnapshotSizeLow, diskTotalWriteIops=diskTotalWriteIops, aclMigrationStarted=aclMigrationStarted, poolTotalWriteMbps=poolTotalWriteMbps, diskIsOnline=diskIsOnline, haResourceGroup=haResourceGroup, replicationSourceRegistered=replicationSourceRegistered, poolCreated=poolCreated, lunPoolName=lunPoolName, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiProperties=iscsiProperties, haControllerA_Name=haControllerA_Name, diskDataReadIops=diskDataReadIops, networkTotalTransmitMbps=networkTotalTransmitMbps, projectDataSizeLow=projectDataSizeLow, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolMetaWriteMbps=poolMetaWriteMbps, replicationTargetDeleted=replicationTargetDeleted, notificationComponentName=notificationComponentName, poolDataSizeHigh=poolDataSizeHigh, fcInitiatorIndex=fcInitiatorIndex, projectFreeSizeHigh=projectFreeSizeHigh, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcTargetReadLatency=fcTargetReadLatency, notificationSensorSuspect=notificationSensorSuspect, poolTotalWriteIops=poolTotalWriteIops, iscsiTargetName=iscsiTargetName, nfsAvgWriteLatency=nfsAvgWriteLatency, nvdimmFailSoftError=nvdimmFailSoftError, volumeDeleteFailed=volumeDeleteFailed, replicationFailed=replicationFailed, poolSizeHigh=poolSizeHigh, diskState=diskState, poolProjects=poolProjects, iscsiAvgReadLatency=iscsiAvgReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, diskDataWriteIops=diskDataWriteIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, smbSocketFailure=smbSocketFailure, replicationAbandoned=replicationAbandoned, poolMetaReadLatency=poolMetaReadLatency, lunReadMbps=lunReadMbps, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, tegileGroups=tegileGroups, poolDataSizeLow=poolDataSizeLow, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiTargetAuth=iscsiTargetAuth, shareSnapshotSizeHigh=shareSnapshotSizeHigh, globalStatistics=globalStatistics, poolDegraded=poolDegraded, nfsTotalReadIops=nfsTotalReadIops, diskAlias=diskAlias, iscsiTargetGroupError=iscsiTargetGroupError, tegileConformance=tegileConformance, diskSlowIo=diskSlowIo, shareReservedSizeLow=shareReservedSizeLow, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareReservedSizeHigh=shareReservedSizeHigh, nfsAvgReadLatency=nfsAvgReadLatency, volumeQuotaFinished=volumeQuotaFinished, ipmiMemory=ipmiMemory, shareDataSizeLow=shareDataSizeLow, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareQuotaHigh=shareQuotaHigh, lunSnapshotSizeHigh=lunSnapshotSizeHigh, diskGoneOffline=diskGoneOffline, poolTotalSaving=poolTotalSaving, poolDeletionFailed=poolDeletionFailed, vmwareNFSDatastores=vmwareNFSDatastores, cacheTotalReadIops=cacheTotalReadIops, cacheSSDReads=cacheSSDReads, poolTotalReadMbps=poolTotalReadMbps, userLoginFailed=userLoginFailed, testNotification=testNotification, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcTargetWriteMbps=fcTargetWriteMbps, projectQuotaFinished=projectQuotaFinished, ipmiVoltage=ipmiVoltage, projectTotalSaving=projectTotalSaving, upgradeStarted=upgradeStarted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, nicMTU=nicMTU, cifsTotalReadMbps=cifsTotalReadMbps, lunEntry=lunEntry, snapshotRollbackCompleted=snapshotRollbackCompleted, notificationProps=notificationProps)
