...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:48:55 2023
...
Counter64, Gauge32, Unsigned32, ModuleIdentity, IpAddress, TimeTicks, Bits, iso, Integer32, Counter32, ObjectIdentity, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "Unsigned32", "ModuleIdentity", "IpAddress", "TimeTicks", "Bits", "iso", "Integer32", "Counter32", "ObjectIdentity", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolName=poolName, diskTotalWriteMbps=diskTotalWriteMbps, diskChassisIdx=diskChassisIdx, shareCIFSWriteLatency=shareCIFSWriteLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, nicTable=nicTable, nicGroup=nicGroup, projectCreatedSuccessfully=projectCreatedSuccessfully, fcTargetWriteIops=fcTargetWriteIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, lunTargetGroup=lunTargetGroup, poolDataWriteMbps=poolDataWriteMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, poolTotalReadMbps=poolTotalReadMbps, diskCount=diskCount, iscsiTargetGroup=iscsiTargetGroup, shareCreatedSuccessfully=shareCreatedSuccessfully, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTargetReadIops=fcTargetReadIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, snapshotCreationFailed=snapshotCreationFailed, nicEntry=nicEntry, lunDedupEnabled=lunDedupEnabled, ntpServerTimeDrift=ntpServerTimeDrift, iscsiTargets=iscsiTargets, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, nicMTU=nicMTU, fcInitiatorsTable=fcInitiatorsTable, nicReceiveMbps=nicReceiveMbps, iscsiTargetEntry=iscsiTargetEntry, notificationSensorNumber=notificationSensorNumber, lunName=lunName, iscsiInitiatorIndex=iscsiInitiatorIndex, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolEntry=poolEntry, networkInterfaceUp=networkInterfaceUp, iscsiInitiatorName=iscsiInitiatorName, replicationAborted=replicationAborted, globalStatistics=globalStatistics, lunProjectName=lunProjectName, tegileCompliances=tegileCompliances, shareDataSizeLow=shareDataSizeLow, controllerHardwareModel=controllerHardwareModel, targetGroupCreateCompleted=targetGroupCreateCompleted, snmpServiceStarted=snmpServiceStarted, fcPortOffline=fcPortOffline, snapshotRollbackFailed=snapshotRollbackFailed, iscsiTargetAlias=iscsiTargetAlias, lunFreeSizeHigh=lunFreeSizeHigh, lunWriteMbps=lunWriteMbps, projectThresholdExceedWarning=projectThresholdExceedWarning, upgradeFailed=upgradeFailed, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcInitiators=fcInitiators, cacheTotalReadIops=cacheTotalReadIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectModified=projectModified, lunReadMbps=lunReadMbps, poolExported=poolExported, fcTargetGroup=fcTargetGroup, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcInitiatorIndex=fcInitiatorIndex, shareCIFSWriteMbps=shareCIFSWriteMbps, notificationDescription=notificationDescription, volumeDeleteFailed=volumeDeleteFailed, diskSlowIo=diskSlowIo, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiTargetIndex=iscsiTargetIndex, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunFreeSizeLow=lunFreeSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, fcTargetStatus=fcTargetStatus, poolTable=poolTable, poolReadCacheReadLatency=poolReadCacheReadLatency, notificationObjects=notificationObjects, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolTotalWriteIops=poolTotalWriteIops, notificationComponentName=notificationComponentName, network=network, volumeCreatedSuccessfully=volumeCreatedSuccessfully, haControllerA_Name=haControllerA_Name, diskType=diskType, shareCIFSReadMbps=shareCIFSReadMbps, replicationResumed=replicationResumed, haControllerA_Uptime=haControllerA_Uptime, cifsTotalReadIops=cifsTotalReadIops, haResourceIndex=haResourceIndex, shareNFSReadIops=shareNFSReadIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunSizeLow=lunSizeLow, haControllerB_Name=haControllerB_Name, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolDegraded=poolDegraded, shareSnapshotSizeLow=shareSnapshotSizeLow, fcTotalReadMbps=fcTotalReadMbps, shareMountPoint=shareMountPoint, fcTargetEntry=fcTargetEntry, replicationComplete=replicationComplete, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, nicState=nicState, PYSNMP_MODULE_ID=tegile, shareEntry=shareEntry, diskGoneOffline=diskGoneOffline, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunPoolName=lunPoolName, poolWriteCacheWriteIops=poolWriteCacheWriteIops, notificationTime=notificationTime, lunEntry=lunEntry, nicIndex=nicIndex, cifsTotalWriteMbps=cifsTotalWriteMbps, memoryFailure=memoryFailure, nicTransmitMbps=nicTransmitMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolSizeLow=poolSizeLow, shareQuotaFinished=shareQuotaFinished, networkTotalReceiveMbps=networkTotalReceiveMbps, poolProjects=poolProjects, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolSizeHigh=poolSizeHigh, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolUsedSizeLow=poolUsedSizeLow, poolMetaReadIops=poolMetaReadIops, notificationSensorAction=notificationSensorAction, tegileConformance=tegileConformance, cacheTotalReadMbps=cacheTotalReadMbps, haResourcesTable=haResourcesTable, shareCIFSWriteIops=shareCIFSWriteIops, poolUpgraded=poolUpgraded, cpuInterrupts=cpuInterrupts, fcInitiatorCreateFailed=fcInitiatorCreateFailed, cifsTotalReadMbps=cifsTotalReadMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, smbSocketFailure=smbSocketFailure, ipmiOther=ipmiOther, poolDeleted=poolDeleted, projectDeleted=projectDeleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, notificationSensorSuspect=notificationSensorSuspect, haResourceName=haResourceName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, projectShares=projectShares, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, deleteFolderFailed=deleteFolderFailed, poolMetaReadMbps=poolMetaReadMbps, shareReservedSizeHigh=shareReservedSizeHigh, alertsCleanupCompleted=alertsCleanupCompleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskAvgWriteLatency=diskAvgWriteLatency, poolTotalReadIops=poolTotalReadIops, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, currentObjectGroup=currentObjectGroup, iscsiTargetWriteIops=iscsiTargetWriteIops, poolMetaWriteIops=poolMetaWriteIops, diskPoolName=diskPoolName, tegileArray=tegileArray, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, cpuSystemCalls=cpuSystemCalls, sharePoolName=sharePoolName, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectQuotaSizeLow=projectQuotaSizeLow, nfsAvgReadLatency=nfsAvgReadLatency, diskIsOnline=diskIsOnline, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolProjectCount=poolProjectCount, iscsiAvgWriteLatency=iscsiAvgWriteLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, adServerTimeDrift=adServerTimeDrift, tegile=tegile, haResourceStatus=haResourceStatus, fcTargetReadMbps=fcTargetReadMbps, unknownSensorEvent=unknownSensorEvent, poolMetaWriteLatency=poolMetaWriteLatency, fcTargetReadLatency=fcTargetReadLatency, poolImported=poolImported, volumeModifyCompleted=volumeModifyCompleted, shareDeletionFailed=shareDeletionFailed, lunBlockSize=lunBlockSize, diskTotalReadMbps=diskTotalReadMbps, userLoginFailed=userLoginFailed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, networkIpmpGroupDown=networkIpmpGroupDown, iscsiProperties=iscsiProperties, upgradeStarted=upgradeStarted, shareNFSWriteIops=shareNFSWriteIops, lunTable=lunTable, shareNFSReadMbps=shareNFSReadMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolCreated=poolCreated, projectLunCount=projectLunCount, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiTargetsTable=iscsiTargetsTable, nvdimmFailDeviceError=nvdimmFailDeviceError, nfsTotalWriteIops=nfsTotalWriteIops, poolDataReadIops=poolDataReadIops, diskState=diskState, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolTotalSaving=poolTotalSaving, cacheTotalWriteIops=cacheTotalWriteIops, replicationTargetDeleted=replicationTargetDeleted, lunCompressionEnabled=lunCompressionEnabled, iscsiInitiatorGroup=iscsiInitiatorGroup, projectCompressionEnabled=projectCompressionEnabled, upgradeTimeout=upgradeTimeout, disks=disks, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, shareCompressedRatio=shareCompressedRatio, shareTable=shareTable, diskError=diskError, volumeDeleteCompleted=volumeDeleteCompleted, poolState=poolState, testNotification=testNotification, lunGUID=lunGUID, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectDeletionFailed=projectDeletionFailed, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectTable=projectTable, notificationSeverity=notificationSeverity, upgradeDownloadCompleted=upgradeDownloadCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, shareNFSReadLatency=shareNFSReadLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, smisServiceStarted=smisServiceStarted, cifsAvgWriteLatency=cifsAvgWriteLatency, shareDedupEnabled=shareDedupEnabled, fcAvgReadLatency=fcAvgReadLatency, iscsiTargetName=iscsiTargetName, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, replicationStarted=replicationStarted, diskDataReadIops=diskDataReadIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, ipmiPowerSupply=ipmiPowerSupply, fcInitiatorName=fcInitiatorName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, projectShareCount=projectShareCount, poolCount=poolCount, iscsiTargetReadMbps=iscsiTargetReadMbps, projectPoolName=projectPoolName, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareCompressionEnabled=shareCompressionEnabled, snapshotRollbackCompleted=snapshotRollbackCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue)
mibBuilder.exportSymbols("TEGILE-MIB", poolDataReadLatency=poolDataReadLatency, shareNFSWriteLatency=shareNFSWriteLatency, iscsiTargetGroupError=iscsiTargetGroupError, iscsiInitiators=iscsiInitiators, snapshotCloneCompleted=snapshotCloneCompleted, smisServiceStartFailed=smisServiceStartFailed, projectIndex=projectIndex, targetGroupMemberAdded=targetGroupMemberAdded, projectSnapshotSizeLow=projectSnapshotSizeLow, fcInitiatorGroup=fcInitiatorGroup, shareCIFSEnabled=shareCIFSEnabled, haResources=haResources, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, fcTargetModifyCompleted=fcTargetModifyCompleted, maintenanceModeDisabled=maintenanceModeDisabled, sensorFailureEvent=sensorFailureEvent, iscsiInitiatorEntry=iscsiInitiatorEntry, controllerTimeDrift=controllerTimeDrift, haControllerA_IPAddr=haControllerA_IPAddr, aclMigrationStarted=aclMigrationStarted, projectFreeSizeLow=projectFreeSizeLow, controllerUp=controllerUp, diskIndex=diskIndex, fcTotalReadIops=fcTotalReadIops, poolDeletionFailed=poolDeletionFailed, shareReservedSizeLow=shareReservedSizeLow, haResourceGroup=haResourceGroup, fcTargetName=fcTargetName, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, lunInitiatorGroup=lunInitiatorGroup, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolFreeSizeLow=poolFreeSizeLow, nicName=nicName, tegileGroups=tegileGroups, tdpsUpgradeTimeout=tdpsUpgradeTimeout, fcTargets=fcTargets, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunWriteLatency=lunWriteLatency, haControllerB_Uptime=haControllerB_Uptime, notificationTargetEntityName=notificationTargetEntityName, notificationReadingUnit=notificationReadingUnit, sanProperties=sanProperties, snmpAgentVersion=snmpAgentVersion, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolDataReadMbps=poolDataReadMbps, smisServiceStopFailed=smisServiceStopFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, pools=pools, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectDedupEnabled=projectDedupEnabled, projectFreeSizeHigh=projectFreeSizeHigh, upgradeCompleted=upgradeCompleted, fcTotalWriteMbps=fcTotalWriteMbps, diskSequentialIOCount=diskSequentialIOCount, spareDiskReplaced=spareDiskReplaced, poolQuotaFinished=poolQuotaFinished, diskDataReadMbps=diskDataReadMbps, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, lunReservedSizeLow=lunReservedSizeLow, ipmiMemory=ipmiMemory, fcProperties=fcProperties, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, tegileArray_notifications=tegileArray_notifications, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, tdpsUpgradeFailed=tdpsUpgradeFailed, poolMetaReadLatency=poolMetaReadLatency, smisServiceStopped=smisServiceStopped, nfsTotalReadMbps=nfsTotalReadMbps, snapshotDeleteFailed=snapshotDeleteFailed, shareQuotaLow=shareQuotaLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diagnosticDataUploaded=diagnosticDataUploaded, cifsTotalWriteIops=cifsTotalWriteIops, iscsiTargetReadLatency=iscsiTargetReadLatency, properties=properties, poolAvgWriteLatency=poolAvgWriteLatency, deleteFolderCompleted=deleteFolderCompleted, diskSizeLow=diskSizeLow, poolDataWriteLatency=poolDataWriteLatency, haControllerB_IPAddr=haControllerB_IPAddr, iscsiTargetAuth=iscsiTargetAuth, replicationFailed=replicationFailed, netbiosSocketFailure=netbiosSocketFailure, basicCompliance=basicCompliance, poolMetaWriteMbps=poolMetaWriteMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, cifsAvgReadLatency=cifsAvgReadLatency, poolIndex=poolIndex, networkTotalTransmitMbps=networkTotalTransmitMbps, fcTotalWriteIops=fcTotalWriteIops, shareQuotaHigh=shareQuotaHigh, ipmiCriticalInterrupt=ipmiCriticalInterrupt, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, diskDataWriteMbps=diskDataWriteMbps, snapshotCloningFailed=snapshotCloningFailed, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, upgradeDownloadStarted=upgradeDownloadStarted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diskSizeHigh=diskSizeHigh, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, snmpServiceStopFailed=snmpServiceStopFailed, maintenanceModeEnabled=maintenanceModeEnabled, poolDataWriteIops=poolDataWriteIops, replicationSourceRegistered=replicationSourceRegistered, lunProtocol=lunProtocol, fcAvgWriteLatency=fcAvgWriteLatency, poolTotalWriteMbps=poolTotalWriteMbps, shareName=shareName, iscsiTargetReadIops=iscsiTargetReadIops, currentNotificationGroup=currentNotificationGroup, shareDeleted=shareDeleted, diskAlias=diskAlias, nfsTotalReadIops=nfsTotalReadIops, diskDataWriteIops=diskDataWriteIops, diskIOCount=diskIOCount, poolOwnerController=poolOwnerController, notifications=notifications, shareDataSizeHigh=shareDataSizeHigh, projectLUNs=projectLUNs, poolDataSizeHigh=poolDataSizeHigh, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, cpuTotalUsage=cpuTotalUsage, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolDataSizeLow=poolDataSizeLow, nvdimmFailSoftError=nvdimmFailSoftError, lunReadLatency=lunReadLatency, shareProjectName=shareProjectName, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, haResourceActiveNode=haResourceActiveNode, iscsiImproperTargetGroup=iscsiImproperTargetGroup, vmwareNFSDatastores=vmwareNFSDatastores, notificationReadingTriggerValue=notificationReadingTriggerValue, projectDataSizeHigh=projectDataSizeHigh, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareIndex=shareIndex, nvdimmFailInitializationError=nvdimmFailInitializationError, projectName=projectName, lunWriteIops=lunWriteIops, lunIndex=lunIndex, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, ipmiFan=ipmiFan, targetGroupMemberRemoved=targetGroupMemberRemoved, replicationAbandoned=replicationAbandoned, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, notificationProps=notificationProps, poolReadCacheWriteIops=poolReadCacheWriteIops, networkIpmpGroupUp=networkIpmpGroupUp, poolHealth=poolHealth, fcTargetsTable=fcTargetsTable, iscsiTotalReadMbps=iscsiTotalReadMbps, projectDataSizeLow=projectDataSizeLow, poolUsedSizeHigh=poolUsedSizeHigh, nvdimmFailUnknownError=nvdimmFailUnknownError, webdocsUpgradeFailed=webdocsUpgradeFailed, fcPortOnline=fcPortOnline, ipmiCurrent=ipmiCurrent, projectTotalSaving=projectTotalSaving, snmpServiceStopped=snmpServiceStopped, shareCIFSReadIops=shareCIFSReadIops, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolFreeSizeHigh=poolFreeSizeHigh, diskTotalWriteIops=diskTotalWriteIops, shareExceedThresholdWarning=shareExceedThresholdWarning, ipmiThreshold=ipmiThreshold, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectEntry=projectEntry, fcTargetIndex=fcTargetIndex, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, snmpServiceStartFailed=snmpServiceStartFailed, ipmiVoltage=ipmiVoltage, cacheSSDReads=cacheSSDReads, webdocsUpgradeCompleted=webdocsUpgradeCompleted, ipmiTemperature=ipmiTemperature, haResourceDescription=haResourceDescription, shareCIFSReadLatency=shareCIFSReadLatency, projectQuotaFinished=projectQuotaFinished, lunDataSizeHigh=lunDataSizeHigh, lunSnapshotSizeLow=lunSnapshotSizeLow, fcInitiatorEntry=fcInitiatorEntry, haResourceEntry=haResourceEntry, networkInterfaceDown=networkInterfaceDown, shareNFSWriteMbps=shareNFSWriteMbps, iscsiTargetError=iscsiTargetError, lunReservedSizeHigh=lunReservedSizeHigh, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskTotalReadIops=diskTotalReadIops, replicationPaused=replicationPaused, iscsiInitiatorChapUser=iscsiInitiatorChapUser, fcTargetWriteLatency=fcTargetWriteLatency, aclMigrationCompleted=aclMigrationCompleted, poolAvgReadLatency=poolAvgReadLatency, lunDataSizeLow=lunDataSizeLow, diskEntry=diskEntry, diskTable=diskTable, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, cacheRAMReads=cacheRAMReads, lunSizeHigh=lunSizeHigh, shareNFSEnabled=shareNFSEnabled, poolExpanded=poolExpanded, diskAvgReadLatency=diskAvgReadLatency, notificationEventCode=notificationEventCode, iscsiTotalReadIops=iscsiTotalReadIops, iscsiWriteIops=iscsiWriteIops, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, controllerDown=controllerDown, lunReadIops=lunReadIops, volumeQuotaFinished=volumeQuotaFinished, lunCompressedRatio=lunCompressedRatio)
