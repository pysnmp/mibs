...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:21:36 2023
...
ModuleIdentity, Counter32, Counter64, MibIdentifier, enterprises, Bits, ObjectIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, NotificationType, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Counter64", "MibIdentifier", "enterprises", "Bits", "ObjectIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "NotificationType", "iso", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolAvgReadLatency=poolAvgReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, aclMigrationCompleted=aclMigrationCompleted, nfsTotalWriteIops=nfsTotalWriteIops, lunTable=lunTable, poolSizeHigh=poolSizeHigh, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diskIndex=diskIndex, iscsiTargetGroupError=iscsiTargetGroupError, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareCIFSEnabled=shareCIFSEnabled, fcTotalWriteMbps=fcTotalWriteMbps, poolDataWriteLatency=poolDataWriteLatency, lunReservedSizeHigh=lunReservedSizeHigh, fcTargetsTable=fcTargetsTable, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, snapshotCloningFailed=snapshotCloningFailed, haResourceEntry=haResourceEntry, iscsiWriteIops=iscsiWriteIops, controllerHardwareModel=controllerHardwareModel, lunSizeHigh=lunSizeHigh, iscsiTargetsTable=iscsiTargetsTable, poolCreated=poolCreated, notificationReadingUnit=notificationReadingUnit, diskSlowIo=diskSlowIo, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, replicationAborted=replicationAborted, poolDataReadLatency=poolDataReadLatency, iscsiTotalWriteMbps=iscsiTotalWriteMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, notifications=notifications, nfsTotalWriteMbps=nfsTotalWriteMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, ipmiMemory=ipmiMemory, haResourcesTable=haResourcesTable, lunWriteLatency=lunWriteLatency, shareNFSWriteLatency=shareNFSWriteLatency, fcTotalReadIops=fcTotalReadIops, projectQuotaSizeHigh=projectQuotaSizeHigh, cpuInterrupts=cpuInterrupts, shareName=shareName, replicationSourceRegistered=replicationSourceRegistered, replicationComplete=replicationComplete, fcTargetStatus=fcTargetStatus, tegileArray_notifications=tegileArray_notifications, nicName=nicName, disks=disks, diskState=diskState, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, volumeCreatedSuccessfully=volumeCreatedSuccessfully, iscsiTargetError=iscsiTargetError, tegile=tegile, cacheTotalReadMbps=cacheTotalReadMbps, shareNFSReadMbps=shareNFSReadMbps, shareQuotaFinished=shareQuotaFinished, fcTargetGroup=fcTargetGroup, cacheTotalWriteMbps=cacheTotalWriteMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, projectTotalSaving=projectTotalSaving, basicCompliance=basicCompliance, fcInitiatorIndex=fcInitiatorIndex, poolDeletionFailed=poolDeletionFailed, lunSizeLow=lunSizeLow, fcTargetName=fcTargetName, poolOwnerController=poolOwnerController, poolHealth=poolHealth, projectDataSizeLow=projectDataSizeLow, projectLUNs=projectLUNs, notificationSensorSuspect=notificationSensorSuspect, iscsiTotalReadIops=iscsiTotalReadIops, memoryFailure=memoryFailure, replicationStarted=replicationStarted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectModified=projectModified, diskDataReadMbps=diskDataReadMbps, fcTotalWriteIops=fcTotalWriteIops, adServerTimeDrift=adServerTimeDrift, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolDataReadIops=poolDataReadIops, nicGroup=nicGroup, lunWriteIops=lunWriteIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolImported=poolImported, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, ipmiTemperature=ipmiTemperature, cpuSystemCalls=cpuSystemCalls, diskError=diskError, projectFreeSizeHigh=projectFreeSizeHigh, lunName=lunName, lunDedupEnabled=lunDedupEnabled, volumeModifyCompleted=volumeModifyCompleted, shareReservedSizeHigh=shareReservedSizeHigh, lunDataSizeLow=lunDataSizeLow, diskTotalReadMbps=diskTotalReadMbps, diskTotalWriteMbps=diskTotalWriteMbps, PYSNMP_MODULE_ID=tegile, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcInitiators=fcInitiators, projectQuotaSizeLow=projectQuotaSizeLow, ipmiFan=ipmiFan, haResourceName=haResourceName, upgradeFailed=upgradeFailed, fcTargetEntry=fcTargetEntry, smisServiceStarted=smisServiceStarted, diskIsOnline=diskIsOnline, poolReadCacheReadIops=poolReadCacheReadIops, iscsiInitiatorsTable=iscsiInitiatorsTable, lunReadIops=lunReadIops, snmpServiceStopFailed=snmpServiceStopFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, ipmiVoltage=ipmiVoltage, lunWriteMbps=lunWriteMbps, nfsTotalReadMbps=nfsTotalReadMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, lunGUID=lunGUID, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, intelliFlashSoftwareUp=intelliFlashSoftwareUp, smisServiceStartFailed=smisServiceStartFailed, poolMetaWriteIops=poolMetaWriteIops, iscsiInitiatorIndex=iscsiInitiatorIndex, projectThresholdExceedWarning=projectThresholdExceedWarning, shareDeletionFailed=shareDeletionFailed, smisServiceStopFailed=smisServiceStopFailed, diskAvgWriteLatency=diskAvgWriteLatency, snmpAgentVersion=snmpAgentVersion, upgradeDownloadFailed=upgradeDownloadFailed, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, iscsiTargets=iscsiTargets, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, haControllerA_Uptime=haControllerA_Uptime, shareCIFSWriteIops=shareCIFSWriteIops, shareDeleted=shareDeleted, poolDataReadMbps=poolDataReadMbps, networkInterfaceUp=networkInterfaceUp, haResourceActiveNode=haResourceActiveNode, network=network, globalStatistics=globalStatistics, poolProjects=poolProjects, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectDedupEnabled=projectDedupEnabled, lunIndex=lunIndex, shareExceedThresholdWarning=shareExceedThresholdWarning, shareNFSReadIops=shareNFSReadIops, upgradeDownloadStarted=upgradeDownloadStarted, diskPoolName=diskPoolName, diskAlias=diskAlias, poolReadCacheWriteIops=poolReadCacheWriteIops, poolState=poolState, poolExpanded=poolExpanded, upgradeDownloadCompleted=upgradeDownloadCompleted, shareCIFSReadIops=shareCIFSReadIops, sensorFailureEvent=sensorFailureEvent, ipmiOther=ipmiOther, iscsiTargetReadMbps=iscsiTargetReadMbps, projectName=projectName, deleteFolderCompleted=deleteFolderCompleted, replicationTargetDeleted=replicationTargetDeleted, lunPoolName=lunPoolName, diskGoneOffline=diskGoneOffline, notificationDescription=notificationDescription, iscsiInitiatorName=iscsiInitiatorName, pools=pools, networkInterfaceDown=networkInterfaceDown, haControllerA_Name=haControllerA_Name, testNotification=testNotification, smisServiceStopped=smisServiceStopped, cacheSSDReads=cacheSSDReads, fcInitiatorEntry=fcInitiatorEntry, poolName=poolName, fcTargetReadMbps=fcTargetReadMbps, poolCount=poolCount, lunReadLatency=lunReadLatency, cifsTotalWriteIops=cifsTotalWriteIops, tegileGroups=tegileGroups, currentNotificationGroup=currentNotificationGroup, poolMetaReadMbps=poolMetaReadMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, haResourceDescription=haResourceDescription, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, fcAvgWriteLatency=fcAvgWriteLatency, iscsiTargetAlias=iscsiTargetAlias, iscsiTargetReadIops=iscsiTargetReadIops, lunProtocol=lunProtocol, networkTotalReceiveMbps=networkTotalReceiveMbps, shareDataSizeHigh=shareDataSizeHigh, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolQuotaFinished=poolQuotaFinished, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, projectDeletionFailed=projectDeletionFailed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, notificationSensorNumber=notificationSensorNumber, nfsAvgReadLatency=nfsAvgReadLatency, userLoginFailed=userLoginFailed, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareCIFSReadLatency=shareCIFSReadLatency, projectSnapshotSizeHigh=projectSnapshotSizeHigh, replicationFailed=replicationFailed, ipmiCurrent=ipmiCurrent, fcInitiatorName=fcInitiatorName, poolMetaReadLatency=poolMetaReadLatency, poolFreeSizeLow=poolFreeSizeLow, nicMTU=nicMTU, snapshotDeleteFailed=snapshotDeleteFailed, fcTargetWriteMbps=fcTargetWriteMbps, controllerUp=controllerUp, shareNFSEnabled=shareNFSEnabled, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diskSizeLow=diskSizeLow, lunEntry=lunEntry, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiTargetName=iscsiTargetName, nicIndex=nicIndex, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiAvgReadLatency=iscsiAvgReadLatency, shareQuotaLow=shareQuotaLow, projectCreatedSuccessfully=projectCreatedSuccessfully, projectDeleted=projectDeleted, shareNFSWriteIops=shareNFSWriteIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareCompressedRatio=shareCompressedRatio, diskType=diskType, nfsTotalReadIops=nfsTotalReadIops, projectLunCount=projectLunCount, shareSnapshotSizeLow=shareSnapshotSizeLow, notificationTime=notificationTime, poolDataWriteMbps=poolDataWriteMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, netbiosSocketFailure=netbiosSocketFailure, vmwareNFSDatastores=vmwareNFSDatastores, upgradeCompleted=upgradeCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolDataWriteIops=poolDataWriteIops, notificationSeverity=notificationSeverity, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiTargetIndex=iscsiTargetIndex, projectSnapshotSizeLow=projectSnapshotSizeLow, ntpServerTimeDrift=ntpServerTimeDrift, fcInitiatorsTable=fcInitiatorsTable, projectShares=projectShares, cifsAvgReadLatency=cifsAvgReadLatency, poolSizeLow=poolSizeLow, iscsiTargetWriteIops=iscsiTargetWriteIops, alertsCleanupCompleted=alertsCleanupCompleted, lunReservedSizeLow=lunReservedSizeLow, fcTargetReadIops=fcTargetReadIops, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually)
mibBuilder.exportSymbols("TEGILE-MIB", unknownSensorEvent=unknownSensorEvent, haResources=haResources, poolDataSizeHigh=poolDataSizeHigh, diskDataWriteMbps=diskDataWriteMbps, upgradeTimeout=upgradeTimeout, snapshotCreationFailed=snapshotCreationFailed, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolDataSizeLow=poolDataSizeLow, poolMetaReadIops=poolMetaReadIops, shareCreatedSuccessfully=shareCreatedSuccessfully, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, lunTargetGroup=lunTargetGroup, poolIndex=poolIndex, diagnosticDataUploaded=diagnosticDataUploaded, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareCIFSWriteMbps=shareCIFSWriteMbps, diskSizeHigh=diskSizeHigh, tegileArray=tegileArray, sanProperties=sanProperties, iscsiProperties=iscsiProperties, haControllerA_IPAddr=haControllerA_IPAddr, lunDataSizeHigh=lunDataSizeHigh, shareEntry=shareEntry, upgradeStarted=upgradeStarted, networkTotalTransmitMbps=networkTotalTransmitMbps, notificationSensorAction=notificationSensorAction, controllerDown=controllerDown, shareCIFSReadMbps=shareCIFSReadMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, haResourceStatus=haResourceStatus, diskTotalReadIops=diskTotalReadIops, poolUsedSizeLow=poolUsedSizeLow, networkIpmpGroupUp=networkIpmpGroupUp, diskChassisIdx=diskChassisIdx, nicReceiveMbps=nicReceiveMbps, cacheRAMReads=cacheRAMReads, nvdimmFailSoftError=nvdimmFailSoftError, fcTargets=fcTargets, shareNFSWriteMbps=shareNFSWriteMbps, iscsiInitiators=iscsiInitiators, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolEntry=poolEntry, lunSnapshotSizeHigh=lunSnapshotSizeHigh, deleteFolderFailed=deleteFolderFailed, lunFreeSizeHigh=lunFreeSizeHigh, notificationComponentName=notificationComponentName, diskRandomIOCount=diskRandomIOCount, nvdimmFailUnknownError=nvdimmFailUnknownError, notificationProps=notificationProps, projectEntry=projectEntry, notificationObjects=notificationObjects, snapshotRollbackFailed=snapshotRollbackFailed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, diskTotalWriteIops=diskTotalWriteIops, volumeDeleteCompleted=volumeDeleteCompleted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, targetGroupMemberAdded=targetGroupMemberAdded, shareDedupEnabled=shareDedupEnabled, cacheTotalReadIops=cacheTotalReadIops, fcPortOffline=fcPortOffline, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, fcAvgReadLatency=fcAvgReadLatency, diskDataWriteIops=diskDataWriteIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolAvgWriteLatency=poolAvgWriteLatency, shareMountPoint=shareMountPoint, fcInitiatorGroup=fcInitiatorGroup, shareCIFSWriteLatency=shareCIFSWriteLatency, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolTotalSaving=poolTotalSaving, fcProperties=fcProperties, shareReservedSizeLow=shareReservedSizeLow, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolFreeSizeHigh=poolFreeSizeHigh, lunReadMbps=lunReadMbps, iscsiTargetAuth=iscsiTargetAuth, nvdimmFailInitializationError=nvdimmFailInitializationError, haControllerB_Name=haControllerB_Name, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, currentObjectGroup=currentObjectGroup, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, properties=properties, poolTotalWriteIops=poolTotalWriteIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, ipmiPowerSupply=ipmiPowerSupply, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, controllerTimeDrift=controllerTimeDrift, diskIOCount=diskIOCount, targetGroupDeleteCompleted=targetGroupDeleteCompleted, haResourceGroup=haResourceGroup, poolTable=poolTable, nicState=nicState, cifsTotalReadMbps=cifsTotalReadMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectPoolName=projectPoolName, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolMetaWriteLatency=poolMetaWriteLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, sharePoolName=sharePoolName, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, lunProjectName=lunProjectName, volumeQuotaFinished=volumeQuotaFinished, poolReadCacheWriteMbps=poolReadCacheWriteMbps, diskTable=diskTable, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, nicTransmitMbps=nicTransmitMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, replicationResumed=replicationResumed, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, maintenanceModeDisabled=maintenanceModeDisabled, iscsiInitiatorGroup=iscsiInitiatorGroup, nicEntry=nicEntry, shareDataSizeLow=shareDataSizeLow, iscsiImproperTargetGroup=iscsiImproperTargetGroup, snmpServiceStartFailed=snmpServiceStartFailed, haControllerB_IPAddr=haControllerB_IPAddr, notificationTargetEntityName=notificationTargetEntityName, lunCompressionEnabled=lunCompressionEnabled, notificationReadingTriggerValue=notificationReadingTriggerValue, nfsAvgWriteLatency=nfsAvgWriteLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, notificationEventCode=notificationEventCode, shareProjectName=shareProjectName, shareCompressionEnabled=shareCompressionEnabled, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, replicationAbandoned=replicationAbandoned, fcPortOnline=fcPortOnline, replicationPaused=replicationPaused, shareTable=shareTable, diskAvgReadLatency=diskAvgReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, haResourceIndex=haResourceIndex, poolDegraded=poolDegraded, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cifsTotalWriteMbps=cifsTotalWriteMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, maintenanceModeEnabled=maintenanceModeEnabled, diskCount=diskCount, diskSequentialIOCount=diskSequentialIOCount, fcTargetWriteLatency=fcTargetWriteLatency, poolExported=poolExported, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, ipmiThreshold=ipmiThreshold, lunFreeSizeLow=lunFreeSizeLow, aclMigrationStarted=aclMigrationStarted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, spareDiskReplaced=spareDiskReplaced, fcTargetWriteIops=fcTargetWriteIops, networkIpmpGroupDown=networkIpmpGroupDown, diskDataReadIops=diskDataReadIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, volumeDeleteFailed=volumeDeleteFailed, poolUpgraded=poolUpgraded, cacheTotalWriteIops=cacheTotalWriteIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, iscsiInitiatorEntry=iscsiInitiatorEntry, tegileConformance=tegileConformance, iscsiTargetGroup=iscsiTargetGroup, diskEntry=diskEntry, webdocsUpgradeFailed=webdocsUpgradeFailed, fcTargetIndex=fcTargetIndex, projectFreeSizeLow=projectFreeSizeLow, poolProjectCount=poolProjectCount, snmpServiceStarted=snmpServiceStarted, poolTotalReadMbps=poolTotalReadMbps, haControllerB_Uptime=haControllerB_Uptime, poolTotalWriteMbps=poolTotalWriteMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcTotalReadMbps=fcTotalReadMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, nicTable=nicTable, lunBlockSize=lunBlockSize, tdpsUpgradeFailed=tdpsUpgradeFailed, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunInitiatorGroup=lunInitiatorGroup, shareQuotaHigh=shareQuotaHigh, fcTargetReadLatency=fcTargetReadLatency, snapshotCloneCompleted=snapshotCloneCompleted, projectIndex=projectIndex, poolReadCacheReadMbps=poolReadCacheReadMbps, projectDataSizeHigh=projectDataSizeHigh, smbSocketFailure=smbSocketFailure, shareIndex=shareIndex, intelliFlashSoftwareDown=intelliFlashSoftwareDown, snmpServiceStopped=snmpServiceStopped, cifsTotalReadIops=cifsTotalReadIops, projectShareCount=projectShareCount, projectQuotaFinished=projectQuotaFinished, tegileCompliances=tegileCompliances, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiTargetEntry=iscsiTargetEntry, poolTotalReadIops=poolTotalReadIops, shareNFSReadLatency=shareNFSReadLatency, poolDeleted=poolDeleted, cpuTotalUsage=cpuTotalUsage, poolUsedSizeHigh=poolUsedSizeHigh, projectTable=projectTable, lunCompressedRatio=lunCompressedRatio, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectCompressionEnabled=projectCompressionEnabled, poolMetaWriteMbps=poolMetaWriteMbps)
