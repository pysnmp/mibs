...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:36:28 2022
...
ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, Bits, Counter64, Integer32, ObjectIdentity, NotificationType, Counter32, MibIdentifier, Unsigned32, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "Bits", "Counter64", "Integer32", "ObjectIdentity", "NotificationType", "Counter32", "MibIdentifier", "Unsigned32", "Gauge32", "iso")
...
mibBuilder.exportSymbols("TEGILE-MIB", networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, shareReservedSizeLow=shareReservedSizeLow, ipmiThreshold=ipmiThreshold, tegileCompliances=tegileCompliances, poolReadCacheReadIops=poolReadCacheReadIops, targetGroupCreateCompleted=targetGroupCreateCompleted, ipmiCurrent=ipmiCurrent, lunGUID=lunGUID, nfsTotalReadIops=nfsTotalReadIops, iscsiInitiatorChapUser=iscsiInitiatorChapUser, unknownSensorEvent=unknownSensorEvent, poolTotalWriteMbps=poolTotalWriteMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, poolExported=poolExported, iscsiInitiatorName=iscsiInitiatorName, poolIndex=poolIndex, poolMetaWriteIops=poolMetaWriteIops, userLoginFailed=userLoginFailed, shareNFSWriteLatency=shareNFSWriteLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, projectQuotaFinished=projectQuotaFinished, diskTotalWriteIops=diskTotalWriteIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunName=lunName, shareCIFSWriteIops=shareCIFSWriteIops, notifications=notifications, ipmiTemperature=ipmiTemperature, haResourceDescription=haResourceDescription, tdpsUpgradeTimeout=tdpsUpgradeTimeout, cifsAvgWriteLatency=cifsAvgWriteLatency, projectLunCount=projectLunCount, shareNFSReadLatency=shareNFSReadLatency, snapshotCreationFailed=snapshotCreationFailed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, upgradeFailed=upgradeFailed, lunDedupEnabled=lunDedupEnabled, lunDataSizeHigh=lunDataSizeHigh, diskSequentialIOCount=diskSequentialIOCount, iscsiInitiatorsTable=iscsiInitiatorsTable, cacheRAMReads=cacheRAMReads, shareCIFSEnabled=shareCIFSEnabled, fcAvgWriteLatency=fcAvgWriteLatency, haResourceGroup=haResourceGroup, shareCompressionEnabled=shareCompressionEnabled, diagnosticDataUploaded=diagnosticDataUploaded, fcInitiatorIndex=fcInitiatorIndex, diskTotalWriteMbps=diskTotalWriteMbps, targetGroupMemberAdded=targetGroupMemberAdded, upgradeDownloadCompleted=upgradeDownloadCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, smisServiceStopped=smisServiceStopped, notificationProps=notificationProps, shareIndex=shareIndex, projectPoolName=projectPoolName, poolDataReadIops=poolDataReadIops, lunWriteMbps=lunWriteMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, notificationDescription=notificationDescription, volumeQuotaFinished=volumeQuotaFinished, shareCIFSWriteLatency=shareCIFSWriteLatency, shareCIFSReadIops=shareCIFSReadIops, shareSnapshotSizeLow=shareSnapshotSizeLow, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolProjects=poolProjects, webdocsUpgradeFailed=webdocsUpgradeFailed, poolQuotaFinished=poolQuotaFinished, replicationStarted=replicationStarted, cifsTotalReadIops=cifsTotalReadIops, smisServiceStopFailed=smisServiceStopFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, smisServiceStarted=smisServiceStarted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolMetaReadIops=poolMetaReadIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolDataWriteLatency=poolDataWriteLatency, poolUsedSizeLow=poolUsedSizeLow, replicationPaused=replicationPaused, shareCIFSReadLatency=shareCIFSReadLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, poolProjectCount=poolProjectCount, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunCompressionEnabled=lunCompressionEnabled, iscsiInitiatorGroup=iscsiInitiatorGroup, diskCount=diskCount, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareName=shareName, poolDataWriteMbps=poolDataWriteMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, shareNFSWriteMbps=shareNFSWriteMbps, upgradeDownloadFailed=upgradeDownloadFailed, cifsTotalReadMbps=cifsTotalReadMbps, replicationSourceRegistered=replicationSourceRegistered, diskRandomIOCount=diskRandomIOCount, snapshotRollbackFailed=snapshotRollbackFailed, iscsiTargets=iscsiTargets, tdpsUpgradeFailed=tdpsUpgradeFailed, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcInitiatorGroup=fcInitiatorGroup, iscsiImproperTargetGroup=iscsiImproperTargetGroup, controllerDown=controllerDown, networkTotalTransmitMbps=networkTotalTransmitMbps, poolDegraded=poolDegraded, nicName=nicName, fcTargetName=fcTargetName, replicationTargetDeleted=replicationTargetDeleted, shareNFSWriteIops=shareNFSWriteIops, iscsiTargetIndex=iscsiTargetIndex, lunSizeHigh=lunSizeHigh, iscsiTotalReadIops=iscsiTotalReadIops, projectCreatedSuccessfully=projectCreatedSuccessfully, maintenanceModeEnabled=maintenanceModeEnabled, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiTargetWriteIops=iscsiTargetWriteIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, shareDeleted=shareDeleted, poolTable=poolTable, shareCIFSReadMbps=shareCIFSReadMbps, haResources=haResources, haControllerA_IPAddr=haControllerA_IPAddr, fcTargetReadIops=fcTargetReadIops, snmpServiceStopped=snmpServiceStopped, iscsiTargetName=iscsiTargetName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, iscsiProperties=iscsiProperties, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, smbSocketFailure=smbSocketFailure, nvdimmFailInitializationError=nvdimmFailInitializationError, nicTable=nicTable, replicationComplete=replicationComplete, notificationEventCode=notificationEventCode, poolDataReadMbps=poolDataReadMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, nicGroup=nicGroup, lunTargetGroup=lunTargetGroup, projectShares=projectShares, poolDataReadLatency=poolDataReadLatency, lunPoolName=lunPoolName, poolDeleted=poolDeleted, cacheTotalWriteMbps=cacheTotalWriteMbps, projectTable=projectTable, controllerHardwareModel=controllerHardwareModel, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, upgradeCompleted=upgradeCompleted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, cpuTotalUsage=cpuTotalUsage, fcTargetIndex=fcTargetIndex, networkInterfaceDown=networkInterfaceDown, lunProjectName=lunProjectName, projectThresholdExceedWarning=projectThresholdExceedWarning, projectModified=projectModified, poolReadCacheReadLatency=poolReadCacheReadLatency, ipmiVoltage=ipmiVoltage, poolUsedSizeHigh=poolUsedSizeHigh, notificationReadingTriggerValue=notificationReadingTriggerValue, disks=disks, projectQuotaSizeHigh=projectQuotaSizeHigh, fcTargetEntry=fcTargetEntry, diskSizeHigh=diskSizeHigh, projectDeleted=projectDeleted, tegileConformance=tegileConformance, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, diskAlias=diskAlias, notificationObjects=notificationObjects, diskAvgWriteLatency=diskAvgWriteLatency, haControllerB_IPAddr=haControllerB_IPAddr, poolImported=poolImported, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, shareCreatedSuccessfully=shareCreatedSuccessfully, poolAvgWriteLatency=poolAvgWriteLatency, nicReceiveMbps=nicReceiveMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, nfsAvgReadLatency=nfsAvgReadLatency, netbiosSocketFailure=netbiosSocketFailure, notificationTime=notificationTime, fcInitiatorEntry=fcInitiatorEntry, haControllerB_Uptime=haControllerB_Uptime, notificationSeverity=notificationSeverity, notificationSensorNumber=notificationSensorNumber, volumeDeleteCompleted=volumeDeleteCompleted, nfsTotalWriteMbps=nfsTotalWriteMbps, ipmiOther=ipmiOther, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, upgradeDownloadStarted=upgradeDownloadStarted, notificationComponentName=notificationComponentName, lunWriteLatency=lunWriteLatency, projectFreeSizeHigh=projectFreeSizeHigh, nicTransmitMbps=nicTransmitMbps, fcTargetWriteIops=fcTargetWriteIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, snmpAgentVersion=snmpAgentVersion, globalStatistics=globalStatistics, projectSnapshotSizeLow=projectSnapshotSizeLow, poolTotalWriteIops=poolTotalWriteIops, projectEntry=projectEntry, iscsiTargetReadIops=iscsiTargetReadIops, projectIndex=projectIndex, nicEntry=nicEntry, iscsiAvgReadLatency=iscsiAvgReadLatency, diskType=diskType, poolReadCacheWriteLatency=poolReadCacheWriteLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolName=poolName, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, tegileArray=tegileArray, poolTotalSaving=poolTotalSaving, notificationSensorAction=notificationSensorAction, nvdimmFailSoftError=nvdimmFailSoftError, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectDataSizeHigh=projectDataSizeHigh, diskAvgReadLatency=diskAvgReadLatency, fcTargetModifyCompleted=fcTargetModifyCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, fcTargetReadMbps=fcTargetReadMbps, projectQuotaSizeLow=projectQuotaSizeLow, pools=pools, fcInitiatorsTable=fcInitiatorsTable, lunReservedSizeHigh=lunReservedSizeHigh, iscsiTargetError=iscsiTargetError, lunInitiatorGroup=lunInitiatorGroup, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, nicState=nicState, memoryFailure=memoryFailure, projectSnapshotSizeHigh=projectSnapshotSizeHigh, fcInitiatorName=fcInitiatorName, lunReadMbps=lunReadMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareDedupEnabled=shareDedupEnabled, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, haResourcesTable=haResourcesTable, poolAvgReadLatency=poolAvgReadLatency, shareQuotaFinished=shareQuotaFinished, fcPortOnline=fcPortOnline, diskDataWriteIops=diskDataWriteIops, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, haControllerB_Name=haControllerB_Name, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, ipmiFan=ipmiFan, haResourceEntry=haResourceEntry, aclMigrationCompleted=aclMigrationCompleted, testNotification=testNotification, fcTargetsTable=fcTargetsTable)
mibBuilder.exportSymbols("TEGILE-MIB", lunEntry=lunEntry, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, replicationAbandoned=replicationAbandoned, smisServiceStartFailed=smisServiceStartFailed, fcInitiators=fcInitiators, replicationAborted=replicationAborted, shareQuotaHigh=shareQuotaHigh, poolSizeLow=poolSizeLow, projectTotalSaving=projectTotalSaving, volumeCreatedSuccessfully=volumeCreatedSuccessfully, ipmiMemory=ipmiMemory, cifsAvgReadLatency=cifsAvgReadLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, shareNFSEnabled=shareNFSEnabled, shareDataSizeHigh=shareDataSizeHigh, poolReadCacheWriteIops=poolReadCacheWriteIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolEntry=poolEntry, lunFreeSizeHigh=lunFreeSizeHigh, diskSizeLow=diskSizeLow, nvdimmFailDeviceError=nvdimmFailDeviceError, basicCompliance=basicCompliance, shareDeletionFailed=shareDeletionFailed, diskError=diskError, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, snmpServiceStarted=snmpServiceStarted, diskIndex=diskIndex, controllerTimeDrift=controllerTimeDrift, fcTargetWriteLatency=fcTargetWriteLatency, haResourceName=haResourceName, iscsiTargetEntry=iscsiTargetEntry, maintenanceModeDisabled=maintenanceModeDisabled, fcTargetStatus=fcTargetStatus, snapshotDeleteFailed=snapshotDeleteFailed, lunReadIops=lunReadIops, cacheTotalReadIops=cacheTotalReadIops, iscsiTargetAlias=iscsiTargetAlias, fcAvgReadLatency=fcAvgReadLatency, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiWriteIops=iscsiWriteIops, diskDataWriteMbps=diskDataWriteMbps, fcTargetWriteMbps=fcTargetWriteMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, adServerTimeDrift=adServerTimeDrift, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolCount=poolCount, poolFreeSizeLow=poolFreeSizeLow, iscsiTargetWriteLatency=iscsiTargetWriteLatency, notificationSensorSuspect=notificationSensorSuspect, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolMetaWriteLatency=poolMetaWriteLatency, poolMetaReadMbps=poolMetaReadMbps, deleteFolderCompleted=deleteFolderCompleted, lunDataSizeLow=lunDataSizeLow, notificationReadingUnit=notificationReadingUnit, networkIpmpGroupUp=networkIpmpGroupUp, shareCompressedRatio=shareCompressedRatio, shareProjectName=shareProjectName, projectCompressionEnabled=projectCompressionEnabled, networkInterfaceUp=networkInterfaceUp, projectFreeSizeLow=projectFreeSizeLow, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareTable=shareTable, snapshotCloneCompleted=snapshotCloneCompleted, cifsTotalWriteIops=cifsTotalWriteIops, currentNotificationGroup=currentNotificationGroup, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, deleteFolderFailed=deleteFolderFailed, diskChassisIdx=diskChassisIdx, haResourceStatus=haResourceStatus, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, fcProperties=fcProperties, fcTargetReadLatency=fcTargetReadLatency, volumeDeleteFailed=volumeDeleteFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, network=network, fcTotalWriteMbps=fcTotalWriteMbps, lunCompressedRatio=lunCompressedRatio, lunSizeLow=lunSizeLow, properties=properties, nfsTotalWriteIops=nfsTotalWriteIops, snapshotCloningFailed=snapshotCloningFailed, cpuSystemCalls=cpuSystemCalls, controllerUp=controllerUp, lunBlockSize=lunBlockSize, lunTable=lunTable, tegile=tegile, diskDataReadMbps=diskDataReadMbps, tegileGroups=tegileGroups, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolDataSizeHigh=poolDataSizeHigh, projectDedupEnabled=projectDedupEnabled, poolTotalReadIops=poolTotalReadIops, poolOwnerController=poolOwnerController, upgradeTimeout=upgradeTimeout, snmpServiceStartFailed=snmpServiceStartFailed, networkIpmpGroupDown=networkIpmpGroupDown, poolDeletionFailed=poolDeletionFailed, shareMountPoint=shareMountPoint, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, diskSlowIo=diskSlowIo, ntpServerTimeDrift=ntpServerTimeDrift, nicMTU=nicMTU, volumeModifyCompleted=volumeModifyCompleted, fcPortOffline=fcPortOffline, iscsiInitiatorEntry=iscsiInitiatorEntry, cacheTotalWriteIops=cacheTotalWriteIops, poolExpanded=poolExpanded, diskDataReadIops=diskDataReadIops, cpuInterrupts=cpuInterrupts, diskGoneOffline=diskGoneOffline, fcTotalWriteIops=fcTotalWriteIops, tegileArray_notifications=tegileArray_notifications, poolState=poolState, iscsiTargetAuth=iscsiTargetAuth, spareDiskReplaced=spareDiskReplaced, PYSNMP_MODULE_ID=tegile, poolDataSizeLow=poolDataSizeLow, lunFreeSizeLow=lunFreeSizeLow, iscsiTargetReadMbps=iscsiTargetReadMbps, diskEntry=diskEntry, replicationFailed=replicationFailed, upgradeStarted=upgradeStarted, sanProperties=sanProperties, haControllerA_Name=haControllerA_Name, lunReservedSizeLow=lunReservedSizeLow, currentObjectGroup=currentObjectGroup, iscsiTargetReadLatency=iscsiTargetReadLatency, webdocsUpgradeCompleted=webdocsUpgradeCompleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, diskTable=diskTable, cacheSSDReads=cacheSSDReads, iscsiInitiators=iscsiInitiators, ipmiPowerSupply=ipmiPowerSupply, diskPoolName=diskPoolName, diskState=diskState, shareDataSizeLow=shareDataSizeLow, poolFreeSizeHigh=poolFreeSizeHigh, shareEntry=shareEntry, diskTotalReadMbps=diskTotalReadMbps, poolUpgraded=poolUpgraded, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTotalReadMbps=iscsiTotalReadMbps, projectDeletionFailed=projectDeletionFailed, shareNFSReadMbps=shareNFSReadMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, replicationResumed=replicationResumed, sensorFailureEvent=sensorFailureEvent, diskIsOnline=diskIsOnline, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcTotalReadMbps=fcTotalReadMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, lunReadLatency=lunReadLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, aclMigrationStarted=aclMigrationStarted, projectLUNs=projectLUNs, fcTargets=fcTargets, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareQuotaLow=shareQuotaLow, lunProtocol=lunProtocol, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, snmpServiceStopFailed=snmpServiceStopFailed, haControllerA_Uptime=haControllerA_Uptime, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolSizeHigh=poolSizeHigh, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcTargetGroup=fcTargetGroup, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunIndex=lunIndex, diskIOCount=diskIOCount, poolTotalReadMbps=poolTotalReadMbps, haResourceIndex=haResourceIndex, fcTotalReadIops=fcTotalReadIops, poolMetaWriteMbps=poolMetaWriteMbps, nfsTotalReadMbps=nfsTotalReadMbps, iscsiTargetsTable=iscsiTargetsTable, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolCreated=poolCreated, notificationTargetEntityName=notificationTargetEntityName, cacheTotalReadMbps=cacheTotalReadMbps, poolHealth=poolHealth, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargetGroupError=iscsiTargetGroupError, lunWriteIops=lunWriteIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, alertsCleanupCompleted=alertsCleanupCompleted, nicIndex=nicIndex, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, sharePoolName=sharePoolName, diskTotalReadIops=diskTotalReadIops, cifsTotalWriteMbps=cifsTotalWriteMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiTargetGroup=iscsiTargetGroup, projectShareCount=projectShareCount, projectDataSizeLow=projectDataSizeLow, poolMetaReadLatency=poolMetaReadLatency, poolDataWriteIops=poolDataWriteIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, haResourceActiveNode=haResourceActiveNode, shareReservedSizeHigh=shareReservedSizeHigh, projectName=projectName)
