...
ObjectIdentity, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, ModuleIdentity, Unsigned32, Counter32, Counter64, Bits, TimeTicks, Gauge32, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "ModuleIdentity", "Unsigned32", "Counter32", "Counter64", "Bits", "TimeTicks", "Gauge32", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTargetStatus=fcTargetStatus, poolDegraded=poolDegraded, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolAvgWriteLatency=poolAvgWriteLatency, notificationTargetEntityName=notificationTargetEntityName, poolReadCacheReadMbps=poolReadCacheReadMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareDataSizeLow=shareDataSizeLow, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, notifications=notifications, lunIndex=lunIndex, diskDataWriteMbps=diskDataWriteMbps, diskPoolName=diskPoolName, cacheTotalReadMbps=cacheTotalReadMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, snapshotRollbackCompleted=snapshotRollbackCompleted, diskIndex=diskIndex, notificationObjects=notificationObjects, upgradeDownloadStarted=upgradeDownloadStarted, fcTargetWriteLatency=fcTargetWriteLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolCreated=poolCreated, snapshotRollbackFailed=snapshotRollbackFailed, projectModified=projectModified, poolDataSizeHigh=poolDataSizeHigh, sensorFailureEvent=sensorFailureEvent, iscsiTargetAlias=iscsiTargetAlias, maintenanceModeEnabled=maintenanceModeEnabled, cacheSSDReads=cacheSSDReads, fcTargetGroup=fcTargetGroup, shareNFSWriteLatency=shareNFSWriteLatency, poolIndex=poolIndex, lunCompressionEnabled=lunCompressionEnabled, basicCompliance=basicCompliance, replicationSourceRegistered=replicationSourceRegistered, sharePoolName=sharePoolName, lunTargetGroup=lunTargetGroup, snapshotDeleteFailed=snapshotDeleteFailed, lunReservedSizeHigh=lunReservedSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, haResourcesTable=haResourcesTable, shareSnapshotSizeLow=shareSnapshotSizeLow, controllerUp=controllerUp, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, lunProjectName=lunProjectName, lunWriteIops=lunWriteIops, nicMTU=nicMTU, iscsiWriteIops=iscsiWriteIops, tegile=tegile, iscsiTotalReadIops=iscsiTotalReadIops, diskRandomIOCount=diskRandomIOCount, cacheTotalReadIops=cacheTotalReadIops, shareNFSEnabled=shareNFSEnabled, fcTargetEntry=fcTargetEntry, netbiosSocketFailure=netbiosSocketFailure, ipmiOther=ipmiOther, nfsTotalWriteMbps=nfsTotalWriteMbps, haResourceGroup=haResourceGroup, haResourceDescription=haResourceDescription, shareCIFSReadIops=shareCIFSReadIops, adServerTimeDrift=adServerTimeDrift, replicationPaused=replicationPaused, shareNFSReadMbps=shareNFSReadMbps, diskSizeHigh=diskSizeHigh, ipmiMemory=ipmiMemory, ipmiPowerSupply=ipmiPowerSupply, targetGroupDeleteCompleted=targetGroupDeleteCompleted, nfsTotalReadMbps=nfsTotalReadMbps, poolDeleted=poolDeleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, upgradeFailed=upgradeFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, ipmiFan=ipmiFan, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolTotalSaving=poolTotalSaving, poolTotalWriteIops=poolTotalWriteIops, shareTable=shareTable, controllerTimeDrift=controllerTimeDrift, disks=disks, nicEntry=nicEntry, fcTargetWriteMbps=fcTargetWriteMbps, haResourceName=haResourceName, upgradeStarted=upgradeStarted, shareMountPoint=shareMountPoint, cifsAvgReadLatency=cifsAvgReadLatency, fcTargetsTable=fcTargetsTable, tdpsUpgradeCompleted=tdpsUpgradeCompleted, replicationResumed=replicationResumed, shareQuotaLow=shareQuotaLow, notificationReadingTriggerValue=notificationReadingTriggerValue, nfsTotalReadIops=nfsTotalReadIops, diskState=diskState, upgradeCompleted=upgradeCompleted, poolExpanded=poolExpanded, shareCompressionEnabled=shareCompressionEnabled, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, projectQuotaFinished=projectQuotaFinished, userLoginFailed=userLoginFailed, lunBlockSize=lunBlockSize, iscsiTargetIndex=iscsiTargetIndex, network=network, shareEntry=shareEntry, cifsTotalWriteMbps=cifsTotalWriteMbps, ipmiTemperature=ipmiTemperature, projectDedupEnabled=projectDedupEnabled, replicationTargetDeleted=replicationTargetDeleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, networkIpmpGroupUp=networkIpmpGroupUp, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, diskTotalReadIops=diskTotalReadIops, fcTargetReadLatency=fcTargetReadLatency, ipmiThreshold=ipmiThreshold, diskIOCount=diskIOCount, lunEntry=lunEntry, tegileGroups=tegileGroups, shareName=shareName, diskTotalReadMbps=diskTotalReadMbps, projectTable=projectTable, poolUsedSizeLow=poolUsedSizeLow, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiProperties=iscsiProperties, notificationSensorAction=notificationSensorAction, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolOwnerController=poolOwnerController, haControllerA_Uptime=haControllerA_Uptime, nicState=nicState, nvdimmFailDeviceError=nvdimmFailDeviceError, replicationAborted=replicationAborted, shareQuotaHigh=shareQuotaHigh, poolDataReadLatency=poolDataReadLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, diskSequentialIOCount=diskSequentialIOCount, fcInitiatorIndex=fcInitiatorIndex, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcTotalWriteMbps=fcTotalWriteMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolDataSizeLow=poolDataSizeLow, poolFreeSizeHigh=poolFreeSizeHigh, projectEntry=projectEntry, iscsiTargetName=iscsiTargetName, diskSizeLow=diskSizeLow, lunFreeSizeLow=lunFreeSizeLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, PYSNMP_MODULE_ID=tegile, intelliFlashSoftwareDown=intelliFlashSoftwareDown, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolExported=poolExported, diskEntry=diskEntry, alertsCleanupCompleted=alertsCleanupCompleted, snmpAgentVersion=snmpAgentVersion, poolWriteCacheWriteIops=poolWriteCacheWriteIops, fcInitiatorsTable=fcInitiatorsTable, vmwareNFSDatastores=vmwareNFSDatastores, haControllerB_IPAddr=haControllerB_IPAddr, nvdimmFailInitializationError=nvdimmFailInitializationError, lunSnapshotSizeLow=lunSnapshotSizeLow, haControllerA_Name=haControllerA_Name, fcPortOnline=fcPortOnline, lunSizeHigh=lunSizeHigh, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcAvgWriteLatency=fcAvgWriteLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolTotalReadMbps=poolTotalReadMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, cpuSystemCalls=cpuSystemCalls, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargetReadMbps=fcTargetReadMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, unknownSensorEvent=unknownSensorEvent, cifsAvgWriteLatency=cifsAvgWriteLatency, notificationTime=notificationTime, poolSizeHigh=poolSizeHigh, iscsiTargetWriteIops=iscsiTargetWriteIops, poolReadCacheReadLatency=poolReadCacheReadLatency, fcPortOffline=fcPortOffline, notificationDescription=notificationDescription, projectDeleted=projectDeleted, aclMigrationCompleted=aclMigrationCompleted, spareDiskReplaced=spareDiskReplaced, haResourceStatus=haResourceStatus, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, haControllerA_IPAddr=haControllerA_IPAddr, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, replicationComplete=replicationComplete, shareCIFSReadLatency=shareCIFSReadLatency, deleteFolderCompleted=deleteFolderCompleted, fcTotalReadIops=fcTotalReadIops, poolReadCacheReadIops=poolReadCacheReadIops, poolState=poolState, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, smisServiceStopped=smisServiceStopped, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, notificationEventCode=notificationEventCode, poolDataWriteIops=poolDataWriteIops, poolTotalReadIops=poolTotalReadIops, poolUsedSizeHigh=poolUsedSizeHigh, upgradeDownloadCompleted=upgradeDownloadCompleted, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, nicTable=nicTable, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, snapshotCloningFailed=snapshotCloningFailed, poolUpgraded=poolUpgraded, volumeCreatedSuccessfully=volumeCreatedSuccessfully, iscsiAvgReadLatency=iscsiAvgReadLatency, notificationSeverity=notificationSeverity, testNotification=testNotification, tdpsUpgradeFailed=tdpsUpgradeFailed, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareCompressedRatio=shareCompressedRatio, snmpServiceStarted=snmpServiceStarted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, tegileArray_notifications=tegileArray_notifications, aclMigrationStarted=aclMigrationStarted, diskError=diskError, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiTargetAuth=iscsiTargetAuth, networkInterfaceDown=networkInterfaceDown, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolName=poolName, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, replicationStarted=replicationStarted, shareNFSWriteIops=shareNFSWriteIops, fcInitiatorGroup=fcInitiatorGroup, fcAvgReadLatency=fcAvgReadLatency, globalStatistics=globalStatistics, projectSnapshotSizeLow=projectSnapshotSizeLow, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, smbSocketFailure=smbSocketFailure, sanProperties=sanProperties, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunSizeLow=lunSizeLow, iscsiInitiatorName=iscsiInitiatorName, diskAvgReadLatency=diskAvgReadLatency, smisServiceStarted=smisServiceStarted, diskCount=diskCount, fcInitiatorName=fcInitiatorName, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, projectDataSizeLow=projectDataSizeLow, fcTargets=fcTargets, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, cacheTotalWriteIops=cacheTotalWriteIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted)
mibBuilder.exportSymbols("TEGILE-MIB", replicationFailed=replicationFailed, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, networkIpmpGroupDown=networkIpmpGroupDown, smisServiceStopFailed=smisServiceStopFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectCompressionEnabled=projectCompressionEnabled, targetGroupCreateCompleted=targetGroupCreateCompleted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareDedupEnabled=shareDedupEnabled, fcTargetWriteIops=fcTargetWriteIops, poolDataReadMbps=poolDataReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, haControllerB_Name=haControllerB_Name, poolEntry=poolEntry, lunDataSizeLow=lunDataSizeLow, projectTotalSaving=projectTotalSaving, projectLunCount=projectLunCount, shareReservedSizeLow=shareReservedSizeLow, lunTable=lunTable, nicGroup=nicGroup, iscsiTargetReadMbps=iscsiTargetReadMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, initiatorGroupMemberAdded=initiatorGroupMemberAdded, networkInterfaceUp=networkInterfaceUp, diskChassisIdx=diskChassisIdx, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, cacheTotalWriteMbps=cacheTotalWriteMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, poolMetaReadLatency=poolMetaReadLatency, diskAvgWriteLatency=diskAvgWriteLatency, lunDedupEnabled=lunDedupEnabled, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, nfsTotalWriteIops=nfsTotalWriteIops, tegileConformance=tegileConformance, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, nfsAvgReadLatency=nfsAvgReadLatency, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, memoryFailure=memoryFailure, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectPoolName=projectPoolName, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, currentNotificationGroup=currentNotificationGroup, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, nicName=nicName, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectFreeSizeLow=projectFreeSizeLow, fcInitiatorEntry=fcInitiatorEntry, projectCreatedSuccessfully=projectCreatedSuccessfully, notificationSensorSuspect=notificationSensorSuspect, poolImported=poolImported, poolDataReadIops=poolDataReadIops, shareNFSReadIops=shareNFSReadIops, iscsiTargetGroupError=iscsiTargetGroupError, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunReadLatency=lunReadLatency, lunReadMbps=lunReadMbps, cpuTotalUsage=cpuTotalUsage, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, tegileCompliances=tegileCompliances, fcInitiators=fcInitiators, projectQuotaSizeLow=projectQuotaSizeLow, iscsiInitiatorsTable=iscsiInitiatorsTable, cpuInterrupts=cpuInterrupts, shareNFSReadLatency=shareNFSReadLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, tegileArray=tegileArray, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, diskTable=diskTable, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareSnapshotSizeHigh=shareSnapshotSizeHigh, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareCIFSReadMbps=shareCIFSReadMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, cacheRAMReads=cacheRAMReads, diagnosticDataUploaded=diagnosticDataUploaded, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, haResources=haResources, lunFreeSizeHigh=lunFreeSizeHigh, notificationReadingUnit=notificationReadingUnit, poolHealth=poolHealth, poolFreeSizeLow=poolFreeSizeLow, projectName=projectName, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcProperties=fcProperties, poolMetaWriteLatency=poolMetaWriteLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskAlias=diskAlias, fcTargetName=fcTargetName, controllerDown=controllerDown, haResourceActiveNode=haResourceActiveNode, projectLUNs=projectLUNs, lunName=lunName, snapshotCreationFailed=snapshotCreationFailed, currentObjectGroup=currentObjectGroup, shareCIFSEnabled=shareCIFSEnabled, lunReservedSizeLow=lunReservedSizeLow, iscsiInitiators=iscsiInitiators, lunGUID=lunGUID, shareQuotaFinished=shareQuotaFinished, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolTotalWriteMbps=poolTotalWriteMbps, diskDataReadMbps=diskDataReadMbps, snapshotCloneCompleted=snapshotCloneCompleted, lunDataSizeHigh=lunDataSizeHigh, cifsTotalReadMbps=cifsTotalReadMbps, projectIndex=projectIndex, volumeModifyCompleted=volumeModifyCompleted, lunInitiatorGroup=lunInitiatorGroup, poolTable=poolTable, nicReceiveMbps=nicReceiveMbps, maintenanceModeDisabled=maintenanceModeDisabled, projectShares=projectShares, pools=pools, iscsiTargetEntry=iscsiTargetEntry, poolDataWriteLatency=poolDataWriteLatency, haResourceIndex=haResourceIndex, lunReadIops=lunReadIops, volumeDeleteFailed=volumeDeleteFailed, snmpServiceStopped=snmpServiceStopped, diskType=diskType, diskGoneOffline=diskGoneOffline, poolQuotaFinished=poolQuotaFinished, poolProjects=poolProjects, shareIndex=shareIndex, poolCount=poolCount, haControllerB_Uptime=haControllerB_Uptime, iscsiInitiatorGroup=iscsiInitiatorGroup, diskIsOnline=diskIsOnline, iscsiTargets=iscsiTargets, shareReservedSizeHigh=shareReservedSizeHigh, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskDataReadIops=diskDataReadIops, cifsTotalWriteIops=cifsTotalWriteIops, poolMetaReadMbps=poolMetaReadMbps, fcTargetIndex=fcTargetIndex, fcTargetReadIops=fcTargetReadIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, notificationComponentName=notificationComponentName, lunWriteMbps=lunWriteMbps, shareDataSizeHigh=shareDataSizeHigh, targetGroupMemberRemoved=targetGroupMemberRemoved, deleteFolderFailed=deleteFolderFailed, poolMetaReadIops=poolMetaReadIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareCIFSWriteIops=shareCIFSWriteIops, projectQuotaSizeHigh=projectQuotaSizeHigh, notificationProps=notificationProps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diskTotalWriteMbps=diskTotalWriteMbps, poolAvgReadLatency=poolAvgReadLatency, diskTotalWriteIops=diskTotalWriteIops, controllerHardwareModel=controllerHardwareModel, iscsiTargetsTable=iscsiTargetsTable, cifsTotalReadIops=cifsTotalReadIops, volumeDeleteCompleted=volumeDeleteCompleted, fcTotalReadMbps=fcTotalReadMbps, diskSlowIo=diskSlowIo, poolDeletionFailed=poolDeletionFailed, nicIndex=nicIndex, haResourceEntry=haResourceEntry, upgradeTimeout=upgradeTimeout, iscsiTargetGroup=iscsiTargetGroup, poolProjectCount=poolProjectCount, properties=properties, poolMetaWriteMbps=poolMetaWriteMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, diskDataWriteIops=diskDataWriteIops, poolMetaWriteIops=poolMetaWriteIops, upgradeDownloadFailed=upgradeDownloadFailed, notificationSensorNumber=notificationSensorNumber, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, projectShareCount=projectShareCount, ipmiCurrent=ipmiCurrent, ipmiVoltage=ipmiVoltage, lunPoolName=lunPoolName, shareDeleted=shareDeleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, volumeQuotaFinished=volumeQuotaFinished, snmpServiceStartFailed=snmpServiceStartFailed, poolSizeLow=poolSizeLow, projectFreeSizeHigh=projectFreeSizeHigh, ntpServerTimeDrift=ntpServerTimeDrift, nvdimmFailUnknownError=nvdimmFailUnknownError, projectDataSizeHigh=projectDataSizeHigh, projectDeletionFailed=projectDeletionFailed, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, iscsiTargetReadIops=iscsiTargetReadIops, shareDeletionFailed=shareDeletionFailed, shareNFSWriteMbps=shareNFSWriteMbps, nvdimmFailSoftError=nvdimmFailSoftError, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, targetGroupMemberAdded=targetGroupMemberAdded, webdocsUpgradeCompleted=webdocsUpgradeCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, lunProtocol=lunProtocol, shareExceedThresholdWarning=shareExceedThresholdWarning, fcTotalWriteIops=fcTotalWriteIops, iscsiTargetError=iscsiTargetError, shareProjectName=shareProjectName, lunWriteLatency=lunWriteLatency, lunCompressedRatio=lunCompressedRatio, nicTransmitMbps=nicTransmitMbps, smisServiceStartFailed=smisServiceStartFailed, snmpServiceStopFailed=snmpServiceStopFailed, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiTotalReadMbps=iscsiTotalReadMbps, poolDataWriteMbps=poolDataWriteMbps, replicationAbandoned=replicationAbandoned)
