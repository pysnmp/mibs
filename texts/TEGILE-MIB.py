...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:45:14 2021
...
MibIdentifier, Integer32, ObjectIdentity, Unsigned32, Counter32, TimeTicks, IpAddress, Bits, Gauge32, enterprises, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "ObjectIdentity", "Unsigned32", "Counter32", "TimeTicks", "IpAddress", "Bits", "Gauge32", "enterprises", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareNFSReadLatency=shareNFSReadLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, lunBlockSize=lunBlockSize, shareNFSReadMbps=shareNFSReadMbps, poolIndex=poolIndex, notificationSensorSuspect=notificationSensorSuspect, poolName=poolName, haControllerA_Name=haControllerA_Name, snmpServiceStopped=snmpServiceStopped, smisServiceStartFailed=smisServiceStartFailed, notificationEventCode=notificationEventCode, iscsiTargetAlias=iscsiTargetAlias, lunDataSizeLow=lunDataSizeLow, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcTargetWriteMbps=fcTargetWriteMbps, diskState=diskState, shareCIFSReadIops=shareCIFSReadIops, snapshotCloneCompleted=snapshotCloneCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, snapshotCloningFailed=snapshotCloningFailed, nfsAvgReadLatency=nfsAvgReadLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, maintenanceModeEnabled=maintenanceModeEnabled, nicMTU=nicMTU, lunSizeHigh=lunSizeHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, volumeModifyCompleted=volumeModifyCompleted, projectDeleted=projectDeleted, iscsiTotalReadMbps=iscsiTotalReadMbps, ipmiOther=ipmiOther, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, diskCount=diskCount, ipmiMemory=ipmiMemory, haControllerB_Name=haControllerB_Name, lunCompressedRatio=lunCompressedRatio, ipmiVoltage=ipmiVoltage, haResourceActiveNode=haResourceActiveNode, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, notificationTargetEntityName=notificationTargetEntityName, shareCIFSWriteIops=shareCIFSWriteIops, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, replicationComplete=replicationComplete, haResourceDescription=haResourceDescription, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareDedupEnabled=shareDedupEnabled, nfsTotalWriteMbps=nfsTotalWriteMbps, poolTable=poolTable, poolFreeSizeLow=poolFreeSizeLow, poolExported=poolExported, lunTargetGroup=lunTargetGroup, fcTargetsTable=fcTargetsTable, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareDataSizeLow=shareDataSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectIndex=projectIndex, fcTargetReadMbps=fcTargetReadMbps, ipmiTemperature=ipmiTemperature, replicationStarted=replicationStarted, properties=properties, intelliFlashSoftwareUp=intelliFlashSoftwareUp, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, lunWriteIops=lunWriteIops, smbSocketFailure=smbSocketFailure, shareTable=shareTable, fcTargetStatus=fcTargetStatus, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, shareDeletionFailed=shareDeletionFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolDataWriteMbps=poolDataWriteMbps, shareIndex=shareIndex, shareMountPoint=shareMountPoint, diskAlias=diskAlias, poolDataReadIops=poolDataReadIops, lunProtocol=lunProtocol, maintenanceModeDisabled=maintenanceModeDisabled, snmpServiceStopFailed=snmpServiceStopFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunReservedSizeLow=lunReservedSizeLow, poolEntry=poolEntry, controllerUp=controllerUp, spareDiskReplaced=spareDiskReplaced, iscsiTargetReadIops=iscsiTargetReadIops, poolTotalWriteMbps=poolTotalWriteMbps, notificationSeverity=notificationSeverity, iscsiTargetGroupError=iscsiTargetGroupError, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, nicTransmitMbps=nicTransmitMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunTable=lunTable, fcProperties=fcProperties, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectCompressionEnabled=projectCompressionEnabled, poolCreated=poolCreated, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, fcTargetName=fcTargetName, snmpAgentVersion=snmpAgentVersion, fcTargetWriteLatency=fcTargetWriteLatency, fcTotalReadMbps=fcTotalReadMbps, projectFreeSizeHigh=projectFreeSizeHigh, diskError=diskError, fcInitiatorCreateFailed=fcInitiatorCreateFailed, nicGroup=nicGroup, deleteFolderFailed=deleteFolderFailed, sanProperties=sanProperties, upgradeDownloadFailed=upgradeDownloadFailed, shareNFSWriteMbps=shareNFSWriteMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, notificationReadingUnit=notificationReadingUnit, smisServiceStarted=smisServiceStarted, projectEntry=projectEntry, diskTotalReadMbps=diskTotalReadMbps, nicIndex=nicIndex, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolUpgraded=poolUpgraded, fcInitiators=fcInitiators, projectDataSizeHigh=projectDataSizeHigh, nfsAvgWriteLatency=nfsAvgWriteLatency, poolQuotaFinished=poolQuotaFinished, poolMetaReadLatency=poolMetaReadLatency, shareDataSizeHigh=shareDataSizeHigh, projectLunCount=projectLunCount, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiWriteIops=iscsiWriteIops, shareCIFSReadLatency=shareCIFSReadLatency, fcPortOffline=fcPortOffline, notificationTime=notificationTime, poolTotalWriteIops=poolTotalWriteIops, poolAvgReadLatency=poolAvgReadLatency, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiTargetGroup=iscsiTargetGroup, lunWriteLatency=lunWriteLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, ipmiPowerSupply=ipmiPowerSupply, lunGUID=lunGUID, cacheSSDReads=cacheSSDReads, basicCompliance=basicCompliance, nicEntry=nicEntry, poolImported=poolImported, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, diskRandomIOCount=diskRandomIOCount, projectDataSizeLow=projectDataSizeLow, ipmiFan=ipmiFan, iscsiTargetsTable=iscsiTargetsTable, poolMetaWriteIops=poolMetaWriteIops, snapshotRollbackCompleted=snapshotRollbackCompleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, lunInitiatorGroup=lunInitiatorGroup, notificationDescription=notificationDescription, shareExceedThresholdWarning=shareExceedThresholdWarning, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcInitiatorEntry=fcInitiatorEntry, memoryFailure=memoryFailure, poolDataSizeLow=poolDataSizeLow, iscsiTargetReadMbps=iscsiTargetReadMbps, poolTotalReadMbps=poolTotalReadMbps, diagnosticDataUploaded=diagnosticDataUploaded, shareProjectName=shareProjectName, diskDataWriteMbps=diskDataWriteMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, diskIOCount=diskIOCount, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareSnapshotSizeLow=shareSnapshotSizeLow, cifsTotalWriteMbps=cifsTotalWriteMbps, lunEntry=lunEntry, diskDataWriteIops=diskDataWriteIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, notificationProps=notificationProps, projectQuotaFinished=projectQuotaFinished, nfsTotalReadIops=nfsTotalReadIops, iscsiProperties=iscsiProperties, diskSizeHigh=diskSizeHigh, projectShares=projectShares, poolSizeLow=poolSizeLow, shareNFSWriteIops=shareNFSWriteIops, shareNFSReadIops=shareNFSReadIops, notificationSensorAction=notificationSensorAction, poolDataReadMbps=poolDataReadMbps, nfsTotalWriteIops=nfsTotalWriteIops, fcTargetEntry=fcTargetEntry, shareDeleted=shareDeleted, lunName=lunName, tegileCompliances=tegileCompliances, poolMetaReadMbps=poolMetaReadMbps, diskEntry=diskEntry, cacheTotalWriteMbps=cacheTotalWriteMbps, cifsTotalReadIops=cifsTotalReadIops, fcInitiatorIndex=fcInitiatorIndex, targetGroupDeleteCompleted=targetGroupDeleteCompleted, haControllerB_IPAddr=haControllerB_IPAddr, shareCIFSEnabled=shareCIFSEnabled, poolUsedSizeLow=poolUsedSizeLow, fcTargetGroup=fcTargetGroup, snmpServiceStarted=snmpServiceStarted, diskGoneOffline=diskGoneOffline, webdocsUpgradeCompleted=webdocsUpgradeCompleted, haResourceEntry=haResourceEntry, lunReadIops=lunReadIops, replicationResumed=replicationResumed, targetGroupMemberAdded=targetGroupMemberAdded, fcPortOnline=fcPortOnline, diskChassisIdx=diskChassisIdx, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectQuotaSizeLow=projectQuotaSizeLow, cacheTotalWriteIops=cacheTotalWriteIops, unknownSensorEvent=unknownSensorEvent, controllerTimeDrift=controllerTimeDrift, poolCount=poolCount, poolHealth=poolHealth, shareQuotaLow=shareQuotaLow, fcInitiatorName=fcInitiatorName, shareName=shareName, notificationObjects=notificationObjects, shareNFSEnabled=shareNFSEnabled, fcAvgReadLatency=fcAvgReadLatency, notificationComponentName=notificationComponentName, diskAvgWriteLatency=diskAvgWriteLatency, projectSnapshotSizeHigh=projectSnapshotSizeHigh, replicationPaused=replicationPaused, controllerHardwareModel=controllerHardwareModel, networkIpmpGroupDown=networkIpmpGroupDown, snapshotDeleteFailed=snapshotDeleteFailed, haResourceGroup=haResourceGroup, iscsiInitiatorsTable=iscsiInitiatorsTable, PYSNMP_MODULE_ID=tegile, shareCreatedSuccessfully=shareCreatedSuccessfully, smisServiceStopFailed=smisServiceStopFailed, fcTotalWriteMbps=fcTotalWriteMbps, diskIsOnline=diskIsOnline, cpuTotalUsage=cpuTotalUsage, upgradeStarted=upgradeStarted, poolDataWriteIops=poolDataWriteIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolDeletionFailed=poolDeletionFailed, iscsiTargetIndex=iscsiTargetIndex, fcAvgWriteLatency=fcAvgWriteLatency, diskDataReadMbps=diskDataReadMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, pools=pools, iscsiInitiators=iscsiInitiators, currentObjectGroup=currentObjectGroup, vmwareNFSDatastores=vmwareNFSDatastores, haControllerA_IPAddr=haControllerA_IPAddr, notificationSensorNumber=notificationSensorNumber, iscsiTargets=iscsiTargets, lunReadLatency=lunReadLatency)
mibBuilder.exportSymbols("TEGILE-MIB", shareCIFSWriteLatency=shareCIFSWriteLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, networkInterfaceDown=networkInterfaceDown, fcInitiatorsTable=fcInitiatorsTable, poolDataSizeHigh=poolDataSizeHigh, diskTotalWriteMbps=diskTotalWriteMbps, shareNFSWriteLatency=shareNFSWriteLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolUsedSizeHigh=poolUsedSizeHigh, aclMigrationStarted=aclMigrationStarted, fcTargets=fcTargets, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, ipmiThreshold=ipmiThreshold, cifsAvgReadLatency=cifsAvgReadLatency, poolFreeSizeHigh=poolFreeSizeHigh, smisServiceStopped=smisServiceStopped, cifsTotalWriteIops=cifsTotalWriteIops, projectSnapshotSizeLow=projectSnapshotSizeLow, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, replicationSourceRegistered=replicationSourceRegistered, iscsiTargetError=iscsiTargetError, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, aclMigrationCompleted=aclMigrationCompleted, upgradeFailed=upgradeFailed, shareCompressedRatio=shareCompressedRatio, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskIndex=diskIndex, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, projectDedupEnabled=projectDedupEnabled, netbiosSocketFailure=netbiosSocketFailure, lunReservedSizeHigh=lunReservedSizeHigh, nicName=nicName, projectLUNs=projectLUNs, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, volumeDeleteCompleted=volumeDeleteCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, replicationFailed=replicationFailed, shareReservedSizeLow=shareReservedSizeLow, lunDedupEnabled=lunDedupEnabled, diskTable=diskTable, nvdimmFailInitializationError=nvdimmFailInitializationError, lunFreeSizeLow=lunFreeSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, diskTotalReadIops=diskTotalReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolSizeHigh=poolSizeHigh, haResourceName=haResourceName, sensorFailureEvent=sensorFailureEvent, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiTotalWriteMbps=iscsiTotalWriteMbps, volumeQuotaFinished=volumeQuotaFinished, network=network, haResources=haResources, tdpsUpgradeCompleted=tdpsUpgradeCompleted, globalStatistics=globalStatistics, poolReadCacheReadLatency=poolReadCacheReadLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, replicationAbandoned=replicationAbandoned, poolWriteCacheWriteIops=poolWriteCacheWriteIops, userLoginFailed=userLoginFailed, shareQuotaFinished=shareQuotaFinished, snapshotCreationFailed=snapshotCreationFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, nicTable=nicTable, lunReadMbps=lunReadMbps, fcTargetIndex=fcTargetIndex, iscsiTargetWriteMbps=iscsiTargetWriteMbps, replicationAborted=replicationAborted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, tegile=tegile, iscsiInitiatorEntry=iscsiInitiatorEntry, fcInitiatorGroup=fcInitiatorGroup, tegileConformance=tegileConformance, alertsCleanupCompleted=alertsCleanupCompleted, projectDeletionFailed=projectDeletionFailed, projectFreeSizeLow=projectFreeSizeLow, volumeDeleteFailed=volumeDeleteFailed, lunFreeSizeHigh=lunFreeSizeHigh, nicReceiveMbps=nicReceiveMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, lunSnapshotSizeLow=lunSnapshotSizeLow, upgradeDownloadCompleted=upgradeDownloadCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diskPoolName=diskPoolName, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskType=diskType, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolDegraded=poolDegraded, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, networkIpmpGroupUp=networkIpmpGroupUp, fcTotalWriteIops=fcTotalWriteIops, shareReservedSizeHigh=shareReservedSizeHigh, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, diskSequentialIOCount=diskSequentialIOCount, targetGroupMemberRemoved=targetGroupMemberRemoved, poolTotalSaving=poolTotalSaving, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, diskSlowIo=diskSlowIo, haResourceIndex=haResourceIndex, upgradeCompleted=upgradeCompleted, poolAvgWriteLatency=poolAvgWriteLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolMetaWriteMbps=poolMetaWriteMbps, haControllerA_Uptime=haControllerA_Uptime, iscsiTargetReadLatency=iscsiTargetReadLatency, poolProjectCount=poolProjectCount, iscsiTotalReadIops=iscsiTotalReadIops, poolState=poolState, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolDeleted=poolDeleted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareCIFSReadMbps=shareCIFSReadMbps, replicationTargetDeleted=replicationTargetDeleted, projectModified=projectModified, testNotification=testNotification, poolTotalReadIops=poolTotalReadIops, haResourceStatus=haResourceStatus, poolExpanded=poolExpanded, poolDataReadLatency=poolDataReadLatency, diskAvgReadLatency=diskAvgReadLatency, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, cifsTotalReadMbps=cifsTotalReadMbps, poolMetaWriteLatency=poolMetaWriteLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, haControllerB_Uptime=haControllerB_Uptime, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diskSizeLow=diskSizeLow, iscsiTargetAuth=iscsiTargetAuth, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, lunWriteMbps=lunWriteMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, notifications=notifications, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcTargetReadLatency=fcTargetReadLatency, shareCompressionEnabled=shareCompressionEnabled, cacheTotalReadMbps=cacheTotalReadMbps, iscsiInitiatorName=iscsiInitiatorName, tdpsUpgradeFailed=tdpsUpgradeFailed, networkInterfaceUp=networkInterfaceUp, poolProjects=poolProjects, cacheTotalReadIops=cacheTotalReadIops, projectShareCount=projectShareCount, deleteFolderCompleted=deleteFolderCompleted, adServerTimeDrift=adServerTimeDrift, projectTable=projectTable, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, currentNotificationGroup=currentNotificationGroup, lunProjectName=lunProjectName, projectPoolName=projectPoolName, projectName=projectName, lunPoolName=lunPoolName, poolOwnerController=poolOwnerController, upgradeTimeout=upgradeTimeout, snmpServiceStartFailed=snmpServiceStartFailed, fcTargetReadIops=fcTargetReadIops, ipmiCurrent=ipmiCurrent, snapshotRollbackFailed=snapshotRollbackFailed, cpuInterrupts=cpuInterrupts, iscsiTargetName=iscsiTargetName, sharePoolName=sharePoolName, disks=disks, tegileArray=tegileArray, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, upgradeDownloadStarted=upgradeDownloadStarted, lunDataSizeHigh=lunDataSizeHigh, nicState=nicState, diskTotalWriteIops=diskTotalWriteIops, nfsTotalReadMbps=nfsTotalReadMbps, shareEntry=shareEntry, tdpsUpgradeTimeout=tdpsUpgradeTimeout, tegileGroups=tegileGroups, ntpServerTimeDrift=ntpServerTimeDrift, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, diskDataReadIops=diskDataReadIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, nvdimmFailSoftError=nvdimmFailSoftError, tegileArray_notifications=tegileArray_notifications, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, cpuSystemCalls=cpuSystemCalls, projectQuotaSizeHigh=projectQuotaSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, cacheRAMReads=cacheRAMReads, iscsiTargetEntry=iscsiTargetEntry, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcTargetWriteIops=fcTargetWriteIops, fcTotalReadIops=fcTotalReadIops, shareQuotaHigh=shareQuotaHigh, lunIndex=lunIndex, haResourcesTable=haResourcesTable, poolMetaReadIops=poolMetaReadIops, poolDataWriteLatency=poolDataWriteLatency, controllerDown=controllerDown, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunCompressionEnabled=lunCompressionEnabled, lunSizeLow=lunSizeLow, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, projectThresholdExceedWarning=projectThresholdExceedWarning, projectTotalSaving=projectTotalSaving)
