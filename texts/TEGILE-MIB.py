...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:21:30 2021
...
Unsigned32, IpAddress, ModuleIdentity, NotificationType, ObjectIdentity, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, iso, TimeTicks, Counter64, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "iso", "TimeTicks", "Counter64", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetAuth=iscsiTargetAuth, nfsTotalWriteMbps=nfsTotalWriteMbps, notificationReadingUnit=notificationReadingUnit, iscsiTargetGroupError=iscsiTargetGroupError, vmwareNFSDatastores=vmwareNFSDatastores, shareName=shareName, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolDataWriteLatency=poolDataWriteLatency, shareSnapshotSizeLow=shareSnapshotSizeLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, fcTotalReadMbps=fcTotalReadMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetName=fcTargetName, nfsAvgReadLatency=nfsAvgReadLatency, adServerTimeDrift=adServerTimeDrift, poolDataWriteMbps=poolDataWriteMbps, nicState=nicState, diskDataReadIops=diskDataReadIops, diskEntry=diskEntry, shareTable=shareTable, upgradeDownloadStarted=upgradeDownloadStarted, poolCount=poolCount, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, haControllerB_Name=haControllerB_Name, notificationSensorNumber=notificationSensorNumber, diskGoneOffline=diskGoneOffline, ntpServerTimeDrift=ntpServerTimeDrift, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, networkTotalTransmitMbps=networkTotalTransmitMbps, shareNFSReadLatency=shareNFSReadLatency, nicName=nicName, poolSizeHigh=poolSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, diskRandomIOCount=diskRandomIOCount, shareMountPoint=shareMountPoint, lunSizeHigh=lunSizeHigh, shareCompressionEnabled=shareCompressionEnabled, haResourceStatus=haResourceStatus, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, projectDataSizeHigh=projectDataSizeHigh, diskAvgReadLatency=diskAvgReadLatency, poolOwnerController=poolOwnerController, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, networkInterfaceDown=networkInterfaceDown, snmpAgentVersion=snmpAgentVersion, projectQuotaSizeLow=projectQuotaSizeLow, lunCompressedRatio=lunCompressedRatio, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, fcTargetWriteLatency=fcTargetWriteLatency, upgradeFailed=upgradeFailed, upgradeCompleted=upgradeCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, tegileArray=tegileArray, snmpServiceStartFailed=snmpServiceStartFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiProperties=iscsiProperties, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolUsedSizeLow=poolUsedSizeLow, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolDataReadMbps=poolDataReadMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, nicTable=nicTable, smisServiceStarted=smisServiceStarted, targetGroupMemberAdded=targetGroupMemberAdded, deleteFolderFailed=deleteFolderFailed, diskTotalReadIops=diskTotalReadIops, notifications=notifications, poolCreated=poolCreated, haControllerB_Uptime=haControllerB_Uptime, lunDataSizeLow=lunDataSizeLow, poolImported=poolImported, notificationReadingTriggerValue=notificationReadingTriggerValue, poolMetaReadIops=poolMetaReadIops, volumeDeleteFailed=volumeDeleteFailed, ipmiThreshold=ipmiThreshold, currentObjectGroup=currentObjectGroup, haControllerA_Uptime=haControllerA_Uptime, nicIndex=nicIndex, cacheTotalReadMbps=cacheTotalReadMbps, fcTargetStatus=fcTargetStatus, nfsAvgWriteLatency=nfsAvgWriteLatency, notificationObjects=notificationObjects, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, tegileConformance=tegileConformance, haControllerA_IPAddr=haControllerA_IPAddr, iscsiTargets=iscsiTargets, ipmiCurrent=ipmiCurrent, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, haResourceActiveNode=haResourceActiveNode, shareQuotaFinished=shareQuotaFinished, smisServiceStopFailed=smisServiceStopFailed, diskDataReadMbps=diskDataReadMbps, projectTable=projectTable, iscsiTargetReadMbps=iscsiTargetReadMbps, fcInitiatorEntry=fcInitiatorEntry, shareIndex=shareIndex, iscsiTotalWriteMbps=iscsiTotalWriteMbps, projectDeletionFailed=projectDeletionFailed, shareProjectName=shareProjectName, shareEntry=shareEntry, iscsiInitiatorsTable=iscsiInitiatorsTable, diagnosticDataUploaded=diagnosticDataUploaded, diskSizeHigh=diskSizeHigh, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareCIFSReadIops=shareCIFSReadIops, spareDiskReplaced=spareDiskReplaced, nvdimmFailUnknownError=nvdimmFailUnknownError, shareNFSWriteMbps=shareNFSWriteMbps, nicTransmitMbps=nicTransmitMbps, PYSNMP_MODULE_ID=tegile, lunProtocol=lunProtocol, userLoginFailed=userLoginFailed, shareQuotaHigh=shareQuotaHigh, lunIndex=lunIndex, diskTable=diskTable, lunEntry=lunEntry, cifsAvgWriteLatency=cifsAvgWriteLatency, poolMetaWriteMbps=poolMetaWriteMbps, ipmiPowerSupply=ipmiPowerSupply, tegileArray_notifications=tegileArray_notifications, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiInitiators=iscsiInitiators, replicationPaused=replicationPaused, poolDataReadLatency=poolDataReadLatency, fcInitiatorsTable=fcInitiatorsTable, tdpsUpgradeCompleted=tdpsUpgradeCompleted, smbSocketFailure=smbSocketFailure, iscsiTargetAlias=iscsiTargetAlias, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, diskTotalWriteIops=diskTotalWriteIops, lunPoolName=lunPoolName, ipmiMemory=ipmiMemory, poolName=poolName, projectThresholdExceedWarning=projectThresholdExceedWarning, disks=disks, lunReservedSizeLow=lunReservedSizeLow, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolAvgWriteLatency=poolAvgWriteLatency, webdocsUpgradeCompleted=webdocsUpgradeCompleted, notificationSeverity=notificationSeverity, projectQuotaFinished=projectQuotaFinished, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, notificationProps=notificationProps, diskDataWriteMbps=diskDataWriteMbps, networkIpmpGroupUp=networkIpmpGroupUp, volumeQuotaFinished=volumeQuotaFinished, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, aclMigrationCompleted=aclMigrationCompleted, volumeDeleteCompleted=volumeDeleteCompleted, projectPoolName=projectPoolName, fcPortOnline=fcPortOnline, snapshotCloneCompleted=snapshotCloneCompleted, poolUsedSizeHigh=poolUsedSizeHigh, replicationAborted=replicationAborted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, replicationFailed=replicationFailed, fcInitiatorGroup=fcInitiatorGroup, iscsiTargetGroup=iscsiTargetGroup, cifsTotalReadMbps=cifsTotalReadMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, cacheTotalReadIops=cacheTotalReadIops, fcAvgWriteLatency=fcAvgWriteLatency, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcTargets=fcTargets, poolTotalWriteMbps=poolTotalWriteMbps, poolFreeSizeLow=poolFreeSizeLow, shareCompressedRatio=shareCompressedRatio, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, nfsTotalWriteIops=nfsTotalWriteIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, cpuTotalUsage=cpuTotalUsage, iscsiAvgWriteLatency=iscsiAvgWriteLatency, notificationComponentName=notificationComponentName, shareNFSReadMbps=shareNFSReadMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolWriteCacheWriteIops=poolWriteCacheWriteIops, haResourceName=haResourceName, poolProjects=poolProjects, alertsCleanupCompleted=alertsCleanupCompleted, haResourceDescription=haResourceDescription, cpuInterrupts=cpuInterrupts, notificationTime=notificationTime, fcTargetWriteIops=fcTargetWriteIops, controllerDown=controllerDown, lunSizeLow=lunSizeLow, diskSizeLow=diskSizeLow, diskIsOnline=diskIsOnline, cacheTotalWriteMbps=cacheTotalWriteMbps, shareNFSReadIops=shareNFSReadIops, poolMetaReadLatency=poolMetaReadLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, basicCompliance=basicCompliance, lunName=lunName, tegile=tegile, poolMetaReadMbps=poolMetaReadMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolProjectCount=poolProjectCount, fcProperties=fcProperties, haControllerA_Name=haControllerA_Name, aclMigrationStarted=aclMigrationStarted, cacheRAMReads=cacheRAMReads, iscsiTargetReadLatency=iscsiTargetReadLatency, replicationComplete=replicationComplete, notificationDescription=notificationDescription, ipmiTemperature=ipmiTemperature, networkIpmpGroupDown=networkIpmpGroupDown, lunReadMbps=lunReadMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, webdocsUpgradeFailed=webdocsUpgradeFailed, nfsTotalReadIops=nfsTotalReadIops, lunTargetGroup=lunTargetGroup, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, lunGUID=lunGUID, replicationResumed=replicationResumed, diskState=diskState, haResourceGroup=haResourceGroup, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiTargetsTable=iscsiTargetsTable, snmpServiceStopFailed=snmpServiceStopFailed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectName=projectName, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectEntry=projectEntry, shareReservedSizeLow=shareReservedSizeLow, cifsTotalWriteIops=cifsTotalWriteIops, iscsiTargetError=iscsiTargetError, snapshotCreationFailed=snapshotCreationFailed, diskSlowIo=diskSlowIo, snmpServiceStopped=snmpServiceStopped, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, lunInitiatorGroup=lunInitiatorGroup, diskPoolName=diskPoolName, tdpsUpgradeFailed=tdpsUpgradeFailed, replicationStarted=replicationStarted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, projectCompressionEnabled=projectCompressionEnabled, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, nicReceiveMbps=nicReceiveMbps, poolMetaWriteIops=poolMetaWriteIops, cpuSystemCalls=cpuSystemCalls, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiInitiatorName=iscsiInitiatorName, shareNFSWriteLatency=shareNFSWriteLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, replicationSourceRegistered=replicationSourceRegistered, replicationTargetDeleted=replicationTargetDeleted, cifsAvgReadLatency=cifsAvgReadLatency, lunReservedSizeHigh=lunReservedSizeHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolIndex=poolIndex, fcInitiatorCreateFailed=fcInitiatorCreateFailed, maintenanceModeEnabled=maintenanceModeEnabled, lunProjectName=lunProjectName, poolHealth=poolHealth, haResourceEntry=haResourceEntry, lunSnapshotSizeLow=lunSnapshotSizeLow, diskTotalWriteMbps=diskTotalWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, controllerHardwareModel=controllerHardwareModel, diskIndex=diskIndex, volumeCreatedSuccessfully=volumeCreatedSuccessfully, network=network, sanProperties=sanProperties, shareDeletionFailed=shareDeletionFailed, fcAvgReadLatency=fcAvgReadLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, sharePoolName=sharePoolName, haResourcesTable=haResourcesTable, poolDataSizeLow=poolDataSizeLow, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareCIFSReadLatency=shareCIFSReadLatency, maintenanceModeDisabled=maintenanceModeDisabled, snapshotCloningFailed=snapshotCloningFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, poolEntry=poolEntry, cifsTotalWriteMbps=cifsTotalWriteMbps, lunTable=lunTable, shareNFSEnabled=shareNFSEnabled, poolDeletionFailed=poolDeletionFailed, projectIndex=projectIndex, unknownSensorEvent=unknownSensorEvent, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, sensorFailureEvent=sensorFailureEvent, iscsiTotalReadIops=iscsiTotalReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, upgradeDownloadFailed=upgradeDownloadFailed, shareCIFSEnabled=shareCIFSEnabled, projectLunCount=projectLunCount, iscsiTargetWriteIops=iscsiTargetWriteIops, globalStatistics=globalStatistics, iscsiInitiatorGroup=iscsiInitiatorGroup, shareDataSizeHigh=shareDataSizeHigh, lunFreeSizeLow=lunFreeSizeLow, shareNFSWriteIops=shareNFSWriteIops, haResources=haResources, projectFreeSizeHigh=projectFreeSizeHigh, lunBlockSize=lunBlockSize, poolQuotaFinished=poolQuotaFinished, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolTotalReadIops=poolTotalReadIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectTotalSaving=projectTotalSaving, poolTable=poolTable, properties=properties, shareDataSizeLow=shareDataSizeLow, shareCIFSWriteMbps=shareCIFSWriteMbps, fcTargetReadIops=fcTargetReadIops, diskAlias=diskAlias, projectDataSizeLow=projectDataSizeLow, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, networkInterfaceUp=networkInterfaceUp, lunWriteMbps=lunWriteMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareDeleted=shareDeleted, nvdimmFailSoftError=nvdimmFailSoftError, fcInitiatorIndex=fcInitiatorIndex, projectDeleted=projectDeleted, upgradeStarted=upgradeStarted, iscsiTargetName=iscsiTargetName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolSizeLow=poolSizeLow, fcTotalWriteMbps=fcTotalWriteMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiTargetEntry=iscsiTargetEntry, fcTotalWriteIops=fcTotalWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, cacheSSDReads=cacheSSDReads, poolReadCacheWriteIops=poolReadCacheWriteIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolExported=poolExported, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, pools=pools, replicationAbandoned=replicationAbandoned, tegileCompliances=tegileCompliances, notificationTargetEntityName=notificationTargetEntityName, poolUpgraded=poolUpgraded, lunWriteIops=lunWriteIops, poolDataSizeHigh=poolDataSizeHigh, deleteFolderCompleted=deleteFolderCompleted, controllerUp=controllerUp, nicEntry=nicEntry, iscsiTotalReadMbps=iscsiTotalReadMbps, ipmiVoltage=ipmiVoltage, poolReadCacheReadIops=poolReadCacheReadIops, cifsTotalReadIops=cifsTotalReadIops, ipmiFan=ipmiFan, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, haControllerB_IPAddr=haControllerB_IPAddr, poolState=poolState, diskTotalReadMbps=diskTotalReadMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, diskIOCount=diskIOCount, lunReadIops=lunReadIops, controllerTimeDrift=controllerTimeDrift, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolAvgReadLatency=poolAvgReadLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, smisServiceStartFailed=smisServiceStartFailed, lunWriteLatency=lunWriteLatency, poolExpanded=poolExpanded, poolFreeSizeHigh=poolFreeSizeHigh, snapshotRollbackCompleted=snapshotRollbackCompleted, fcPortOffline=fcPortOffline, fcTargetReadLatency=fcTargetReadLatency, snapshotDeleteFailed=snapshotDeleteFailed, shareReservedSizeHigh=shareReservedSizeHigh, nicGroup=nicGroup, projectDedupEnabled=projectDedupEnabled, fcInitiators=fcInitiators, snmpServiceStarted=snmpServiceStarted, projectFreeSizeLow=projectFreeSizeLow, projectShareCount=projectShareCount, intelliFlashSoftwareUp=intelliFlashSoftwareUp, tegileGroups=tegileGroups, testNotification=testNotification, shareCIFSWriteIops=shareCIFSWriteIops, fcInitiatorName=fcInitiatorName, nfsTotalReadMbps=nfsTotalReadMbps, fcTargetEntry=fcTargetEntry, poolDegraded=poolDegraded, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareCreatedSuccessfully=shareCreatedSuccessfully, shareCIFSReadMbps=shareCIFSReadMbps, smisServiceStopped=smisServiceStopped, diskAvgWriteLatency=diskAvgWriteLatency, shareQuotaLow=shareQuotaLow, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, ipmiOther=ipmiOther, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskSequentialIOCount=diskSequentialIOCount, poolDataWriteIops=poolDataWriteIops, projectLUNs=projectLUNs, lunDedupEnabled=lunDedupEnabled, fcTargetGroup=fcTargetGroup, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, diskType=diskType, memoryFailure=memoryFailure, lunCompressionEnabled=lunCompressionEnabled, haResourceIndex=haResourceIndex, upgradeTimeout=upgradeTimeout, snapshotRollbackFailed=snapshotRollbackFailed, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolDataReadIops=poolDataReadIops, lunFreeSizeHigh=lunFreeSizeHigh, notificationSensorAction=notificationSensorAction, projectModified=projectModified, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskError=diskError, projectShares=projectShares, fcTargetIndex=fcTargetIndex, currentNotificationGroup=currentNotificationGroup, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolTotalReadMbps=poolTotalReadMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, nicMTU=nicMTU, notificationEventCode=notificationEventCode, poolTotalWriteIops=poolTotalWriteIops, diskCount=diskCount, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcTargetReadMbps=fcTargetReadMbps, iscsiWriteIops=iscsiWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, volumeModifyCompleted=volumeModifyCompleted, netbiosSocketFailure=netbiosSocketFailure, notificationSensorSuspect=notificationSensorSuspect, fcTotalReadIops=fcTotalReadIops, diskDataWriteIops=diskDataWriteIops, poolTotalSaving=poolTotalSaving, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolDeleted=poolDeleted, lunReadLatency=lunReadLatency, shareDedupEnabled=shareDedupEnabled, fcTargetModifyCompleted=fcTargetModifyCompleted, lunDataSizeHigh=lunDataSizeHigh, projectQuotaSizeHigh=projectQuotaSizeHigh, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiTargetIndex=iscsiTargetIndex, fcTargetsTable=fcTargetsTable, fcTargetWriteMbps=fcTargetWriteMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, diskChassisIdx=diskChassisIdx, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError)
