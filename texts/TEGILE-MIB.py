...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:39:08 2021
...
MibIdentifier, IpAddress, Unsigned32, Counter64, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, TimeTicks, Integer32, Counter32, Gauge32, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Unsigned32", "Counter64", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "TimeTicks", "Integer32", "Counter32", "Gauge32", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolCount=poolCount, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, cpuTotalUsage=cpuTotalUsage, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, haResourceIndex=haResourceIndex, poolDeletionFailed=poolDeletionFailed, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcTotalWriteIops=fcTotalWriteIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolAvgReadLatency=poolAvgReadLatency, shareNFSReadLatency=shareNFSReadLatency, notifications=notifications, volumeModifyCompleted=volumeModifyCompleted, memoryFailure=memoryFailure, lunGUID=lunGUID, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskDataReadIops=diskDataReadIops, lunDataSizeLow=lunDataSizeLow, snapshotCloningFailed=snapshotCloningFailed, tegileCompliances=tegileCompliances, iscsiInitiatorName=iscsiInitiatorName, notificationTime=notificationTime, diskDataWriteIops=diskDataWriteIops, sanProperties=sanProperties, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiTargetName=iscsiTargetName, fcPortOnline=fcPortOnline, projectLUNs=projectLUNs, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, nfsTotalWriteIops=nfsTotalWriteIops, fcTargetModifyCompleted=fcTargetModifyCompleted, diagnosticDataUploaded=diagnosticDataUploaded, targetGroupMemberAdded=targetGroupMemberAdded, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, notificationSensorAction=notificationSensorAction, fcTargetReadIops=fcTargetReadIops, snmpServiceStartFailed=snmpServiceStartFailed, shareNFSEnabled=shareNFSEnabled, fcTargetWriteIops=fcTargetWriteIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, deleteFolderFailed=deleteFolderFailed, lunDataSizeHigh=lunDataSizeHigh, fcInitiatorGroup=fcInitiatorGroup, lunSnapshotSizeLow=lunSnapshotSizeLow, nicState=nicState, cifsAvgWriteLatency=cifsAvgWriteLatency, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareCIFSWriteMbps=shareCIFSWriteMbps, projectShareCount=projectShareCount, shareIndex=shareIndex, PYSNMP_MODULE_ID=tegile, nfsTotalWriteMbps=nfsTotalWriteMbps, diskState=diskState, shareCIFSWriteLatency=shareCIFSWriteLatency, replicationPaused=replicationPaused, ipmiThreshold=ipmiThreshold, poolAvgWriteLatency=poolAvgWriteLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, nvdimmFailInitializationError=nvdimmFailInitializationError, poolTotalWriteMbps=poolTotalWriteMbps, iscsiTargets=iscsiTargets, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolDataReadMbps=poolDataReadMbps, lunProtocol=lunProtocol, networkInterfaceUp=networkInterfaceUp, projectModified=projectModified, testNotification=testNotification, properties=properties, iscsiTargetGroupError=iscsiTargetGroupError, notificationDescription=notificationDescription, poolMetaWriteMbps=poolMetaWriteMbps, shareNFSWriteIops=shareNFSWriteIops, replicationComplete=replicationComplete, iscsiTargetWriteLatency=iscsiTargetWriteLatency, snapshotCloneCompleted=snapshotCloneCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiTargetAuth=iscsiTargetAuth, projectName=projectName, cacheTotalReadMbps=cacheTotalReadMbps, diskSizeHigh=diskSizeHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, targetGroupCreateCompleted=targetGroupCreateCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, ipmiVoltage=ipmiVoltage, fcPortOffline=fcPortOffline, shareCIFSWriteIops=shareCIFSWriteIops, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, nicTransmitMbps=nicTransmitMbps, alertsCleanupCompleted=alertsCleanupCompleted, upgradeTimeout=upgradeTimeout, haControllerB_IPAddr=haControllerB_IPAddr, poolOwnerController=poolOwnerController, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, notificationSensorNumber=notificationSensorNumber, replicationSourceRegistered=replicationSourceRegistered, shareSnapshotSizeLow=shareSnapshotSizeLow, projectPoolName=projectPoolName, lunReservedSizeLow=lunReservedSizeLow, nvdimmFailDeviceError=nvdimmFailDeviceError, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiTargetError=iscsiTargetError, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, replicationAbandoned=replicationAbandoned, nicEntry=nicEntry, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcInitiatorIndex=fcInitiatorIndex, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolSizeLow=poolSizeLow, poolMetaWriteIops=poolMetaWriteIops, lunCompressionEnabled=lunCompressionEnabled, ipmiPowerSupply=ipmiPowerSupply, shareNFSReadMbps=shareNFSReadMbps, tegileArray=tegileArray, fcTargetEntry=fcTargetEntry, fcAvgReadLatency=fcAvgReadLatency, fcTargets=fcTargets, lunSizeLow=lunSizeLow, poolReadCacheWriteIops=poolReadCacheWriteIops, poolTotalSaving=poolTotalSaving, fcTotalReadIops=fcTotalReadIops, fcProperties=fcProperties, notificationReadingUnit=notificationReadingUnit, iscsiTotalReadIops=iscsiTotalReadIops, diskSequentialIOCount=diskSequentialIOCount, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectEntry=projectEntry, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareQuotaHigh=shareQuotaHigh, targetGroupMemberRemoved=targetGroupMemberRemoved, poolUpgraded=poolUpgraded, replicationStarted=replicationStarted, projectCompressionEnabled=projectCompressionEnabled, poolFreeSizeHigh=poolFreeSizeHigh, diskAlias=diskAlias, network=network, poolUsedSizeHigh=poolUsedSizeHigh, fcTotalWriteMbps=fcTotalWriteMbps, smisServiceStopFailed=smisServiceStopFailed, cacheTotalReadIops=cacheTotalReadIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, snmpServiceStopFailed=snmpServiceStopFailed, shareCompressionEnabled=shareCompressionEnabled, iscsiInitiatorsTable=iscsiInitiatorsTable, poolProjects=poolProjects, poolProjectCount=poolProjectCount, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolIndex=poolIndex, haResourcesTable=haResourcesTable, sharePoolName=sharePoolName, haResourceEntry=haResourceEntry, upgradeFailed=upgradeFailed, projectDeleted=projectDeleted, poolTotalReadMbps=poolTotalReadMbps, haControllerA_IPAddr=haControllerA_IPAddr, replicationTargetDeleted=replicationTargetDeleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolMetaWriteLatency=poolMetaWriteLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareQuotaFinished=shareQuotaFinished, lunReservedSizeHigh=lunReservedSizeHigh, iscsiTotalReadMbps=iscsiTotalReadMbps, haResourceStatus=haResourceStatus, poolDataWriteMbps=poolDataWriteMbps, lunProjectName=lunProjectName, lunReadMbps=lunReadMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, fcInitiators=fcInitiators, shareProjectName=shareProjectName, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolUsedSizeLow=poolUsedSizeLow, projectTable=projectTable, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haResourceGroup=haResourceGroup, diskGoneOffline=diskGoneOffline, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, shareDeleted=shareDeleted, shareCompressedRatio=shareCompressedRatio, shareCIFSReadIops=shareCIFSReadIops, poolFreeSizeLow=poolFreeSizeLow, volumeQuotaFinished=volumeQuotaFinished, networkIpmpGroupDown=networkIpmpGroupDown, cifsTotalReadMbps=cifsTotalReadMbps, lunFreeSizeHigh=lunFreeSizeHigh, iscsiTargetAlias=iscsiTargetAlias, projectQuotaSizeLow=projectQuotaSizeLow, volumeDeleteCompleted=volumeDeleteCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolExpanded=poolExpanded, iscsiTargetGroup=iscsiTargetGroup, poolReadCacheReadMbps=poolReadCacheReadMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, nicTable=nicTable, tegileGroups=tegileGroups, poolDegraded=poolDegraded, fcTargetStatus=fcTargetStatus, snapshotCreationFailed=snapshotCreationFailed, lunIndex=lunIndex, iscsiInitiatorEntry=iscsiInitiatorEntry, diskAvgWriteLatency=diskAvgWriteLatency, projectDeletionFailed=projectDeletionFailed, diskIOCount=diskIOCount, poolDataWriteLatency=poolDataWriteLatency, diskType=diskType, haControllerB_Name=haControllerB_Name, fcTargetGroup=fcTargetGroup, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, cacheTotalWriteMbps=cacheTotalWriteMbps, projectDedupEnabled=projectDedupEnabled, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiTargetEntry=iscsiTargetEntry, basicCompliance=basicCompliance, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunReadLatency=lunReadLatency, lunDedupEnabled=lunDedupEnabled, diskDataReadMbps=diskDataReadMbps, poolDataReadIops=poolDataReadIops, shareNFSWriteMbps=shareNFSWriteMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareDedupEnabled=shareDedupEnabled, ipmiOther=ipmiOther, projectIndex=projectIndex, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, notificationSeverity=notificationSeverity, projectFreeSizeLow=projectFreeSizeLow, notificationComponentName=notificationComponentName, poolDataWriteIops=poolDataWriteIops, iscsiTargetWriteIops=iscsiTargetWriteIops, shareMountPoint=shareMountPoint, iscsiTargetReadLatency=iscsiTargetReadLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskTotalWriteMbps=diskTotalWriteMbps, diskPoolName=diskPoolName, maintenanceModeDisabled=maintenanceModeDisabled, maintenanceModeEnabled=maintenanceModeEnabled, poolTable=poolTable, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, diskAvgReadLatency=diskAvgReadLatency, ipmiTemperature=ipmiTemperature)
mibBuilder.exportSymbols("TEGILE-MIB", poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectTotalSaving=projectTotalSaving, fcAvgWriteLatency=fcAvgWriteLatency, sensorFailureEvent=sensorFailureEvent, notificationObjects=notificationObjects, shareReservedSizeHigh=shareReservedSizeHigh, tegile=tegile, diskRandomIOCount=diskRandomIOCount, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, aclMigrationStarted=aclMigrationStarted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, notificationReadingTriggerValue=notificationReadingTriggerValue, poolReadCacheWriteMbps=poolReadCacheWriteMbps, haResourceName=haResourceName, poolDataReadLatency=poolDataReadLatency, upgradeCompleted=upgradeCompleted, fcTargetsTable=fcTargetsTable, lunFreeSizeLow=lunFreeSizeLow, currentObjectGroup=currentObjectGroup, nvdimmFailSoftError=nvdimmFailSoftError, fcTargetReadLatency=fcTargetReadLatency, poolReadCacheWriteLatency=poolReadCacheWriteLatency, notificationSensorSuspect=notificationSensorSuspect, ipmiFan=ipmiFan, diskDataWriteMbps=diskDataWriteMbps, diskIsOnline=diskIsOnline, shareDataSizeHigh=shareDataSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diskSlowIo=diskSlowIo, cpuInterrupts=cpuInterrupts, poolState=poolState, lunName=lunName, poolCreated=poolCreated, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, nicReceiveMbps=nicReceiveMbps, volumeDeleteFailed=volumeDeleteFailed, snmpServiceStopped=snmpServiceStopped, projectQuotaFinished=projectQuotaFinished, poolMetaReadLatency=poolMetaReadLatency, shareNFSReadIops=shareNFSReadIops, iscsiTargetsTable=iscsiTargetsTable, diskTotalWriteIops=diskTotalWriteIops, diskError=diskError, webdocsUpgradeFailed=webdocsUpgradeFailed, vmwareNFSDatastores=vmwareNFSDatastores, shareCreatedSuccessfully=shareCreatedSuccessfully, nfsTotalReadIops=nfsTotalReadIops, nfsAvgReadLatency=nfsAvgReadLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, shareTable=shareTable, cpuSystemCalls=cpuSystemCalls, lunCompressedRatio=lunCompressedRatio, haControllerA_Uptime=haControllerA_Uptime, snapshotRollbackFailed=snapshotRollbackFailed, upgradeDownloadStarted=upgradeDownloadStarted, shareReservedSizeLow=shareReservedSizeLow, projectDataSizeHigh=projectDataSizeHigh, iscsiTargetReadMbps=iscsiTargetReadMbps, lunWriteMbps=lunWriteMbps, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, currentNotificationGroup=currentNotificationGroup, snapshotDeleteFailed=snapshotDeleteFailed, iscsiInitiatorChapUser=iscsiInitiatorChapUser, notificationThresholdTriggerValue=notificationThresholdTriggerValue, notificationEventCode=notificationEventCode, shareNFSWriteLatency=shareNFSWriteLatency, userLoginFailed=userLoginFailed, networkTotalTransmitMbps=networkTotalTransmitMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, nfsTotalReadMbps=nfsTotalReadMbps, shareEntry=shareEntry, nvdimmFailUnknownError=nvdimmFailUnknownError, poolMetaReadMbps=poolMetaReadMbps, projectShares=projectShares, cifsTotalWriteMbps=cifsTotalWriteMbps, nicName=nicName, poolQuotaFinished=poolQuotaFinished, upgradeStarted=upgradeStarted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, lunWriteLatency=lunWriteLatency, smisServiceStopped=smisServiceStopped, fcInitiatorsTable=fcInitiatorsTable, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, lunPoolName=lunPoolName, smisServiceStarted=smisServiceStarted, cifsTotalReadIops=cifsTotalReadIops, shareName=shareName, projectCreatedSuccessfully=projectCreatedSuccessfully, cacheRAMReads=cacheRAMReads, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, cacheSSDReads=cacheSSDReads, haControllerB_Uptime=haControllerB_Uptime, poolEntry=poolEntry, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, lunTable=lunTable, poolDataSizeHigh=poolDataSizeHigh, controllerTimeDrift=controllerTimeDrift, aclMigrationCompleted=aclMigrationCompleted, upgradeDownloadFailed=upgradeDownloadFailed, nicGroup=nicGroup, cacheTotalWriteIops=cacheTotalWriteIops, poolExported=poolExported, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcInitiatorName=fcInitiatorName, haResourceActiveNode=haResourceActiveNode, replicationAborted=replicationAborted, controllerDown=controllerDown, replicationFailed=replicationFailed, shareDataSizeLow=shareDataSizeLow, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, haResourceDescription=haResourceDescription, haControllerA_Name=haControllerA_Name, poolName=poolName, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, diskTotalReadMbps=diskTotalReadMbps, diskEntry=diskEntry, diskTotalReadIops=diskTotalReadIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunReadIops=lunReadIops, fcTotalReadMbps=fcTotalReadMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, fcInitiatorEntry=fcInitiatorEntry, nicIndex=nicIndex, notificationProps=notificationProps, iscsiTargetReadIops=iscsiTargetReadIops, diskIndex=diskIndex, networkTotalReceiveMbps=networkTotalReceiveMbps, shareCIFSReadMbps=shareCIFSReadMbps, projectDataSizeLow=projectDataSizeLow, lunTargetGroup=lunTargetGroup, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, pools=pools, networkIpmpGroupUp=networkIpmpGroupUp, diskSizeLow=diskSizeLow, projectLunCount=projectLunCount, diskCount=diskCount, poolSizeHigh=poolSizeHigh, iscsiAvgWriteLatency=iscsiAvgWriteLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, nicMTU=nicMTU, shareDeletionFailed=shareDeletionFailed, replicationResumed=replicationResumed, ipmiCurrent=ipmiCurrent, poolHealth=poolHealth, diskChassisIdx=diskChassisIdx, poolDeleted=poolDeleted, poolMetaReadIops=poolMetaReadIops, fcTargetIndex=fcTargetIndex, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolTotalReadIops=poolTotalReadIops, unknownSensorEvent=unknownSensorEvent, projectQuotaSizeHigh=projectQuotaSizeHigh, snmpAgentVersion=snmpAgentVersion, lunInitiatorGroup=lunInitiatorGroup, snmpServiceStarted=snmpServiceStarted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiTargetWriteMbps=iscsiTargetWriteMbps, smisServiceStartFailed=smisServiceStartFailed, shareSnapshotSizeHigh=shareSnapshotSizeHigh, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolImported=poolImported, controllerUp=controllerUp, shareCIFSReadLatency=shareCIFSReadLatency, ntpServerTimeDrift=ntpServerTimeDrift, fcTargetName=fcTargetName, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, cifsAvgReadLatency=cifsAvgReadLatency, spareDiskReplaced=spareDiskReplaced, lunSizeHigh=lunSizeHigh, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, adServerTimeDrift=adServerTimeDrift, projectThresholdExceedWarning=projectThresholdExceedWarning, nfsAvgWriteLatency=nfsAvgWriteLatency, diskTable=diskTable, globalStatistics=globalStatistics, tegileConformance=tegileConformance, smbSocketFailure=smbSocketFailure, iscsiWriteIops=iscsiWriteIops, controllerHardwareModel=controllerHardwareModel, iscsiInitiators=iscsiInitiators, shareCIFSEnabled=shareCIFSEnabled, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, tegileArray_notifications=tegileArray_notifications, notificationTargetEntityName=notificationTargetEntityName, projectFreeSizeHigh=projectFreeSizeHigh, lunBlockSize=lunBlockSize, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, netbiosSocketFailure=netbiosSocketFailure, lunWriteIops=lunWriteIops, iscsiProperties=iscsiProperties, shareQuotaLow=shareQuotaLow, poolTotalWriteIops=poolTotalWriteIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, deleteFolderCompleted=deleteFolderCompleted, fcTargetWriteLatency=fcTargetWriteLatency, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiTargetIndex=iscsiTargetIndex, fcTargetReadMbps=fcTargetReadMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, haResources=haResources, ipmiMemory=ipmiMemory, poolReadCacheReadIops=poolReadCacheReadIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, cifsTotalWriteIops=cifsTotalWriteIops, fcTargetWriteMbps=fcTargetWriteMbps, networkInterfaceDown=networkInterfaceDown, disks=disks, lunEntry=lunEntry)
