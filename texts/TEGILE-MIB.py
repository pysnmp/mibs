...
# Produced by pysmi-1.1.10 at Fri Oct 27 12:21:57 2023
...
Integer32, IpAddress, ModuleIdentity, ObjectIdentity, NotificationType, Counter64, MibIdentifier, enterprises, TimeTicks, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Counter64", "MibIdentifier", "enterprises", "TimeTicks", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Bits")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiTargetError=iscsiTargetError, iscsiTargetIndex=iscsiTargetIndex, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, shareCIFSEnabled=shareCIFSEnabled, nicMTU=nicMTU, initiatorGroupMemberAdded=initiatorGroupMemberAdded, smisServiceStopFailed=smisServiceStopFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, nicState=nicState, diskIndex=diskIndex, networkIpmpGroupUp=networkIpmpGroupUp, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, networkTotalTransmitMbps=networkTotalTransmitMbps, nicTable=nicTable, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareQuotaHigh=shareQuotaHigh, volumeDeleteFailed=volumeDeleteFailed, poolMetaWriteIops=poolMetaWriteIops, shareCIFSWriteLatency=shareCIFSWriteLatency, poolAvgReadLatency=poolAvgReadLatency, poolDataSizeLow=poolDataSizeLow, shareQuotaLow=shareQuotaLow, iscsiTargetGroup=iscsiTargetGroup, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, nvdimmFailUnknownError=nvdimmFailUnknownError, diskAlias=diskAlias, networkInterfaceDown=networkInterfaceDown, haResourceIndex=haResourceIndex, deleteFolderFailed=deleteFolderFailed, cifsTotalReadMbps=cifsTotalReadMbps, diskSizeHigh=diskSizeHigh, poolDataReadIops=poolDataReadIops, projectTable=projectTable, poolDeletionFailed=poolDeletionFailed, lunBlockSize=lunBlockSize, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolTotalReadIops=poolTotalReadIops, lunSizeLow=lunSizeLow, fcAvgWriteLatency=fcAvgWriteLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, replicationStarted=replicationStarted, iscsiInitiatorsTable=iscsiInitiatorsTable, fcInitiatorCreateFailed=fcInitiatorCreateFailed, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, diskSequentialIOCount=diskSequentialIOCount, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskAvgReadLatency=diskAvgReadLatency, nfsTotalWriteMbps=nfsTotalWriteMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, nicTransmitMbps=nicTransmitMbps, upgradeFailed=upgradeFailed, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, targetGroupDeleteCompleted=targetGroupDeleteCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, haControllerA_IPAddr=haControllerA_IPAddr, userLoginFailed=userLoginFailed, lunProtocol=lunProtocol, disks=disks, iscsiTargetReadLatency=iscsiTargetReadLatency, fcTargetReadMbps=fcTargetReadMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolDataWriteLatency=poolDataWriteLatency, aclMigrationCompleted=aclMigrationCompleted, fcTotalReadMbps=fcTotalReadMbps, upgradeStarted=upgradeStarted, diagnosticDataUploaded=diagnosticDataUploaded, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolMetaReadLatency=poolMetaReadLatency, lunDataSizeHigh=lunDataSizeHigh, iscsiTotalReadIops=iscsiTotalReadIops, cpuInterrupts=cpuInterrupts, poolMetaReadMbps=poolMetaReadMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, replicationPaused=replicationPaused, diskTotalReadIops=diskTotalReadIops, notificationEventCode=notificationEventCode, projectPoolName=projectPoolName, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, shareProjectName=shareProjectName, shareNFSReadMbps=shareNFSReadMbps, poolHealth=poolHealth, lunFreeSizeHigh=lunFreeSizeHigh, snmpAgentVersion=snmpAgentVersion, spareDiskReplaced=spareDiskReplaced, lunTable=lunTable, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunTargetGroup=lunTargetGroup, nicIndex=nicIndex, lunCompressedRatio=lunCompressedRatio, fcTotalReadIops=fcTotalReadIops, shareIndex=shareIndex, shareSnapshotSizeHigh=shareSnapshotSizeHigh, projectQuotaFinished=projectQuotaFinished, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolProjectCount=poolProjectCount, iscsiInitiatorChapUser=iscsiInitiatorChapUser, deleteFolderCompleted=deleteFolderCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, shareCIFSReadMbps=shareCIFSReadMbps, poolState=poolState, aclMigrationStarted=aclMigrationStarted, ipmiFan=ipmiFan, targetGroupMemberAdded=targetGroupMemberAdded, nfsTotalWriteIops=nfsTotalWriteIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolCount=poolCount, lunInitiatorGroup=lunInitiatorGroup, lunWriteMbps=lunWriteMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiAvgWriteLatency=iscsiAvgWriteLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, haResourceEntry=haResourceEntry, poolDataSizeHigh=poolDataSizeHigh, lunDedupEnabled=lunDedupEnabled, fcTargetEntry=fcTargetEntry, shareCIFSReadLatency=shareCIFSReadLatency, tdpsUpgradeFailed=tdpsUpgradeFailed, tegileArray_notifications=tegileArray_notifications, fcInitiatorsTable=fcInitiatorsTable, replicationFailed=replicationFailed, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareNFSReadIops=shareNFSReadIops, iscsiInitiatorGroup=iscsiInitiatorGroup, nfsAvgWriteLatency=nfsAvgWriteLatency, diskChassisIdx=diskChassisIdx, ipmiOther=ipmiOther, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolName=poolName, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiTargetGroupError=iscsiTargetGroupError, projectShares=projectShares, tdpsUpgradeCompleted=tdpsUpgradeCompleted, snmpServiceStartFailed=snmpServiceStartFailed, replicationSourceRegistered=replicationSourceRegistered, fcProperties=fcProperties, iscsiTargetName=iscsiTargetName, diskDataWriteMbps=diskDataWriteMbps, properties=properties, lunReadIops=lunReadIops, projectIndex=projectIndex, shareTable=shareTable, poolUsedSizeLow=poolUsedSizeLow, poolExported=poolExported, poolReadCacheWriteMbps=poolReadCacheWriteMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, projectThresholdExceedWarning=projectThresholdExceedWarning, controllerTimeDrift=controllerTimeDrift, poolDataReadMbps=poolDataReadMbps, fcPortOnline=fcPortOnline, globalStatistics=globalStatistics, cacheTotalReadIops=cacheTotalReadIops, diskEntry=diskEntry, ipmiThreshold=ipmiThreshold, cifsTotalReadIops=cifsTotalReadIops, iscsiTargetsTable=iscsiTargetsTable, notificationReadingTriggerValue=notificationReadingTriggerValue, currentNotificationGroup=currentNotificationGroup, shareNFSWriteLatency=shareNFSWriteLatency, notificationTargetEntityName=notificationTargetEntityName, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, nfsTotalReadIops=nfsTotalReadIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, snapshotDeleteFailed=snapshotDeleteFailed, projectEntry=projectEntry, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareDedupEnabled=shareDedupEnabled, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolUpgraded=poolUpgraded, haResourceActiveNode=haResourceActiveNode, diskSlowIo=diskSlowIo, iscsiTargets=iscsiTargets, projectLunCount=projectLunCount, shareCompressedRatio=shareCompressedRatio, diskIsOnline=diskIsOnline, projectDataSizeHigh=projectDataSizeHigh, poolReadCacheReadMbps=poolReadCacheReadMbps, fcInitiatorName=fcInitiatorName, poolDataWriteIops=poolDataWriteIops, projectTotalSaving=projectTotalSaving, diskDataReadIops=diskDataReadIops, diskState=diskState, fcTargetStatus=fcTargetStatus, ntpServerTimeDrift=ntpServerTimeDrift, haResourceDescription=haResourceDescription, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, iscsiTargetReadIops=iscsiTargetReadIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, nfsTotalReadMbps=nfsTotalReadMbps, poolUsedSizeHigh=poolUsedSizeHigh, projectCreatedSuccessfully=projectCreatedSuccessfully, sensorFailureEvent=sensorFailureEvent, lunGUID=lunGUID, testNotification=testNotification, volumeQuotaFinished=volumeQuotaFinished, iscsiTargetAuth=iscsiTargetAuth, haControllerB_Name=haControllerB_Name, shareSnapshotSizeLow=shareSnapshotSizeLow, shareDataSizeLow=shareDataSizeLow, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareReservedSizeLow=shareReservedSizeLow, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, iscsiTotalReadMbps=iscsiTotalReadMbps, fcTargetGroup=fcTargetGroup, diskTable=diskTable, fcTargets=fcTargets, controllerHardwareModel=controllerHardwareModel, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, fcTotalWriteIops=fcTotalWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, basicCompliance=basicCompliance, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, fcTargetReadLatency=fcTargetReadLatency, cacheTotalReadMbps=cacheTotalReadMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolTotalReadMbps=poolTotalReadMbps, replicationTargetDeleted=replicationTargetDeleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, nicName=nicName, shareEntry=shareEntry, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, smisServiceStarted=smisServiceStarted, fcTargetReadIops=fcTargetReadIops, nicGroup=nicGroup, lunReservedSizeLow=lunReservedSizeLow, ipmiCriticalInterrupt=ipmiCriticalInterrupt, controllerDown=controllerDown, lunReadMbps=lunReadMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, smbSocketFailure=smbSocketFailure, cifsTotalWriteIops=cifsTotalWriteIops, snmpServiceStopFailed=snmpServiceStopFailed, maintenanceModeEnabled=maintenanceModeEnabled, haControllerA_Name=haControllerA_Name, nicReceiveMbps=nicReceiveMbps, poolTotalWriteMbps=poolTotalWriteMbps, fcTargetIndex=fcTargetIndex, notificationThresholdTriggerValue=notificationThresholdTriggerValue, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareName=shareName, shareCreatedSuccessfully=shareCreatedSuccessfully, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectFreeSizeLow=projectFreeSizeLow, projectCompressionEnabled=projectCompressionEnabled, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcTargetName=fcTargetName, lunIndex=lunIndex, notifications=notifications, shareMountPoint=shareMountPoint, tegileArray=tegileArray)
mibBuilder.exportSymbols("TEGILE-MIB", projectName=projectName, fcAvgReadLatency=fcAvgReadLatency, poolQuotaFinished=poolQuotaFinished, replicationAborted=replicationAborted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, tegileGroups=tegileGroups, poolIndex=poolIndex, tegileConformance=tegileConformance, sharePoolName=sharePoolName, poolDataWriteMbps=poolDataWriteMbps, adServerTimeDrift=adServerTimeDrift, poolEntry=poolEntry, projectDataSizeLow=projectDataSizeLow, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolDegraded=poolDegraded, lunDataSizeLow=lunDataSizeLow, replicationAbandoned=replicationAbandoned, ipmiPowerSupply=ipmiPowerSupply, poolExpanded=poolExpanded, ipmiMemory=ipmiMemory, upgradeDownloadCompleted=upgradeDownloadCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, cifsAvgReadLatency=cifsAvgReadLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolMetaReadIops=poolMetaReadIops, poolTable=poolTable, haResourceName=haResourceName, projectDedupEnabled=projectDedupEnabled, fcInitiatorIndex=fcInitiatorIndex, iscsiAvgReadLatency=iscsiAvgReadLatency, snapshotCreationFailed=snapshotCreationFailed, lunProjectName=lunProjectName, nvdimmFailDeviceError=nvdimmFailDeviceError, upgradeCompleted=upgradeCompleted, nvdimmFailSoftError=nvdimmFailSoftError, cacheTotalWriteMbps=cacheTotalWriteMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diskRandomIOCount=diskRandomIOCount, lunFreeSizeLow=lunFreeSizeLow, pools=pools, notificationProps=notificationProps, ipmiTemperature=ipmiTemperature, projectLUNs=projectLUNs, haControllerB_Uptime=haControllerB_Uptime, notificationSensorSuspect=notificationSensorSuspect, cifsAvgWriteLatency=cifsAvgWriteLatency, shareCIFSWriteIops=shareCIFSWriteIops, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskTotalWriteIops=diskTotalWriteIops, fcInitiatorEntry=fcInitiatorEntry, fcTotalWriteMbps=fcTotalWriteMbps, smisServiceStartFailed=smisServiceStartFailed, lunPoolName=lunPoolName, shareNFSWriteMbps=shareNFSWriteMbps, shareNFSReadLatency=shareNFSReadLatency, fcTargetsTable=fcTargetsTable, shareNFSEnabled=shareNFSEnabled, currentObjectGroup=currentObjectGroup, projectSnapshotSizeHigh=projectSnapshotSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolCreated=poolCreated, cacheSSDReads=cacheSSDReads, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunName=lunName, diskSizeLow=diskSizeLow, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolMetaWriteMbps=poolMetaWriteMbps, smisServiceStopped=smisServiceStopped, fcTargetWriteIops=fcTargetWriteIops, diskDataWriteIops=diskDataWriteIops, haResourceStatus=haResourceStatus, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, poolAvgWriteLatency=poolAvgWriteLatency, fcInitiators=fcInitiators, haControllerB_IPAddr=haControllerB_IPAddr, projectQuotaSizeLow=projectQuotaSizeLow, lunSnapshotSizeLow=lunSnapshotSizeLow, alertsCleanupCompleted=alertsCleanupCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, haResources=haResources, cifsTotalWriteMbps=cifsTotalWriteMbps, poolImported=poolImported, upgradeDownloadFailed=upgradeDownloadFailed, shareDataSizeHigh=shareDataSizeHigh, snapshotRollbackCompleted=snapshotRollbackCompleted, diskTotalReadMbps=diskTotalReadMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, notificationReadingUnit=notificationReadingUnit, iscsiInitiatorIndex=iscsiInitiatorIndex, tegileCompliances=tegileCompliances, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, unknownSensorEvent=unknownSensorEvent, snapshotRollbackFailed=snapshotRollbackFailed, iscsiTargetEntry=iscsiTargetEntry, diskAvgWriteLatency=diskAvgWriteLatency, projectDeleted=projectDeleted, diskCount=diskCount, fcInitiatorGroup=fcInitiatorGroup, fcTargetWriteLatency=fcTargetWriteLatency, projectDeletionFailed=projectDeletionFailed, poolFreeSizeHigh=poolFreeSizeHigh, ipmiCurrent=ipmiCurrent, lunReservedSizeHigh=lunReservedSizeHigh, lunWriteIops=lunWriteIops, cpuTotalUsage=cpuTotalUsage, diskIOCount=diskIOCount, projectModified=projectModified, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, PYSNMP_MODULE_ID=tegile, netbiosSocketFailure=netbiosSocketFailure, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, snmpServiceStopped=snmpServiceStopped, poolDataReadLatency=poolDataReadLatency, notificationTime=notificationTime, lunCompressionEnabled=lunCompressionEnabled, poolTotalWriteIops=poolTotalWriteIops, lunReadLatency=lunReadLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, notificationObjects=notificationObjects, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, diskTotalWriteMbps=diskTotalWriteMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, sanProperties=sanProperties, poolSizeLow=poolSizeLow, diskDataReadMbps=diskDataReadMbps, shareReservedSizeHigh=shareReservedSizeHigh, notificationSensorAction=notificationSensorAction, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, notificationSensorNumber=notificationSensorNumber, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareCompressionEnabled=shareCompressionEnabled, projectShareCount=projectShareCount, notificationDescription=notificationDescription, upgradeDownloadStarted=upgradeDownloadStarted, iscsiInitiatorName=iscsiInitiatorName, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiProperties=iscsiProperties, poolTotalSaving=poolTotalSaving, webdocsUpgradeFailed=webdocsUpgradeFailed, cacheTotalWriteIops=cacheTotalWriteIops, vmwareNFSDatastores=vmwareNFSDatastores, iscsiWriteIops=iscsiWriteIops, iscsiTargetAlias=iscsiTargetAlias, fcTargetModifyCompleted=fcTargetModifyCompleted, shareCIFSReadIops=shareCIFSReadIops, tegile=tegile, diskError=diskError, nicEntry=nicEntry, volumeModifyCompleted=volumeModifyCompleted, diskType=diskType, cpuSystemCalls=cpuSystemCalls, memoryFailure=memoryFailure, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, diskGoneOffline=diskGoneOffline, snapshotCloneCompleted=snapshotCloneCompleted, volumeDeleteCompleted=volumeDeleteCompleted, networkIpmpGroupDown=networkIpmpGroupDown, haResourceGroup=haResourceGroup, upgradeTimeout=upgradeTimeout, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, snmpServiceStarted=snmpServiceStarted, targetGroupCreateCompleted=targetGroupCreateCompleted, diskPoolName=diskPoolName, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiInitiators=iscsiInitiators, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectFreeSizeHigh=projectFreeSizeHigh, replicationResumed=replicationResumed, replicationComplete=replicationComplete, notificationComponentName=notificationComponentName, lunSizeHigh=lunSizeHigh, projectQuotaSizeHigh=projectQuotaSizeHigh, poolDeleted=poolDeleted, ipmiVoltage=ipmiVoltage, iscsiInitiatorEntry=iscsiInitiatorEntry, snapshotCloningFailed=snapshotCloningFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, shareDeleted=shareDeleted, fcTargetWriteMbps=fcTargetWriteMbps, controllerUp=controllerUp, poolSizeHigh=poolSizeHigh, poolFreeSizeLow=poolFreeSizeLow, shareNFSWriteIops=shareNFSWriteIops, shareDeletionFailed=shareDeletionFailed, haControllerA_Uptime=haControllerA_Uptime, haResourcesTable=haResourcesTable, shareQuotaFinished=shareQuotaFinished, notificationSeverity=notificationSeverity, cacheRAMReads=cacheRAMReads, maintenanceModeDisabled=maintenanceModeDisabled, nfsAvgReadLatency=nfsAvgReadLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolReadCacheReadIops=poolReadCacheReadIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, networkInterfaceUp=networkInterfaceUp, fcPortOffline=fcPortOffline, poolOwnerController=poolOwnerController, targetGroupMemberRemoved=targetGroupMemberRemoved, lunWriteLatency=lunWriteLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, lunEntry=lunEntry, network=network, iscsiTargetWriteIops=iscsiTargetWriteIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolProjects=poolProjects, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion)
