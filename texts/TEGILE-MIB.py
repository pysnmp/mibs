...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Integer32, TimeTicks, MibIdentifier, Counter32, Bits, IpAddress, Unsigned32, enterprises, ObjectIdentity, ModuleIdentity, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Integer32", "TimeTicks", "MibIdentifier", "Counter32", "Bits", "IpAddress", "Unsigned32", "enterprises", "ObjectIdentity", "ModuleIdentity", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", volumeDeleteCompleted=volumeDeleteCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, lunSnapshotSizeHigh=lunSnapshotSizeHigh, shareSnapshotSizeLow=shareSnapshotSizeLow, disks=disks, lunIndex=lunIndex, replicationResumed=replicationResumed, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcTotalWriteIops=fcTotalWriteIops, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiTargetEntry=iscsiTargetEntry, notificationSensorSuspect=notificationSensorSuspect, maintenanceModeDisabled=maintenanceModeDisabled, networkIpmpGroupDown=networkIpmpGroupDown, poolMetaWriteIops=poolMetaWriteIops, haResourceEntry=haResourceEntry, fcAvgReadLatency=fcAvgReadLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, targetGroupMemberRemoved=targetGroupMemberRemoved, lunCompressionEnabled=lunCompressionEnabled, projectPoolName=projectPoolName, cacheSSDReads=cacheSSDReads, shareCreatedSuccessfully=shareCreatedSuccessfully, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTargetName=iscsiTargetName, snmpServiceStopFailed=snmpServiceStopFailed, snapshotCloningFailed=snapshotCloningFailed, iscsiTargetReadLatency=iscsiTargetReadLatency, smisServiceStarted=smisServiceStarted, projectTable=projectTable, snmpServiceStartFailed=snmpServiceStartFailed, nfsTotalWriteIops=nfsTotalWriteIops, iscsiTotalReadIops=iscsiTotalReadIops, upgradeStarted=upgradeStarted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolSizeHigh=poolSizeHigh, haResourceActiveNode=haResourceActiveNode, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, volumeCreatedSuccessfully=volumeCreatedSuccessfully, replicationAborted=replicationAborted, lunGUID=lunGUID, poolDataReadMbps=poolDataReadMbps, lunReadMbps=lunReadMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, projectFreeSizeHigh=projectFreeSizeHigh, haResourceIndex=haResourceIndex, nicEntry=nicEntry, iscsiInitiatorName=iscsiInitiatorName, fcInitiatorName=fcInitiatorName, shareQuotaLow=shareQuotaLow, poolReadCacheWriteMbps=poolReadCacheWriteMbps, vmwareNFSDatastores=vmwareNFSDatastores, projectQuotaFinished=projectQuotaFinished, diskTotalWriteIops=diskTotalWriteIops, nfsAvgWriteLatency=nfsAvgWriteLatency, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, nicTable=nicTable, iscsiWriteIops=iscsiWriteIops, poolTotalReadMbps=poolTotalReadMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunProtocol=lunProtocol, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, fcTargetGroup=fcTargetGroup, poolDeletionFailed=poolDeletionFailed, replicationFailed=replicationFailed, lunWriteMbps=lunWriteMbps, poolCount=poolCount, iscsiInitiatorEntry=iscsiInitiatorEntry, diskType=diskType, fcTargetWriteMbps=fcTargetWriteMbps, poolExported=poolExported, shareNFSReadMbps=shareNFSReadMbps, diskRandomIOCount=diskRandomIOCount, poolTotalWriteIops=poolTotalWriteIops, projectShares=projectShares, ipmiOther=ipmiOther, poolMetaWriteLatency=poolMetaWriteLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolProjectCount=poolProjectCount, upgradeFailed=upgradeFailed, cpuInterrupts=cpuInterrupts, diskTotalReadMbps=diskTotalReadMbps, aclMigrationStarted=aclMigrationStarted, nfsTotalWriteMbps=nfsTotalWriteMbps, adServerTimeDrift=adServerTimeDrift, poolDataSizeLow=poolDataSizeLow, iscsiInitiatorIndex=iscsiInitiatorIndex, projectCreatedSuccessfully=projectCreatedSuccessfully, diagnosticDataUploaded=diagnosticDataUploaded, poolReadCacheReadIops=poolReadCacheReadIops, lunFreeSizeLow=lunFreeSizeLow, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskSlowIo=diskSlowIo, shareQuotaHigh=shareQuotaHigh, diskAvgReadLatency=diskAvgReadLatency, shareCIFSReadIops=shareCIFSReadIops, alertsCleanupCompleted=alertsCleanupCompleted, nicReceiveMbps=nicReceiveMbps, globalStatistics=globalStatistics, fcInitiatorCreateFailed=fcInitiatorCreateFailed, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, ipmiPowerSupply=ipmiPowerSupply, iscsiAvgReadLatency=iscsiAvgReadLatency, poolOwnerController=poolOwnerController, poolAvgWriteLatency=poolAvgWriteLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, projectDeleted=projectDeleted, upgradeDownloadFailed=upgradeDownloadFailed, poolImported=poolImported, fcTargetWriteIops=fcTargetWriteIops, sharePoolName=sharePoolName, poolMetaWriteMbps=poolMetaWriteMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, poolProjects=poolProjects, iscsiTargetReadIops=iscsiTargetReadIops, volumeModifyCompleted=volumeModifyCompleted, cacheTotalReadIops=cacheTotalReadIops, shareNFSReadIops=shareNFSReadIops, unknownSensorEvent=unknownSensorEvent, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, shareName=shareName, fcInitiatorGroup=fcInitiatorGroup, tegileConformance=tegileConformance, cpuTotalUsage=cpuTotalUsage, networkInterfaceDown=networkInterfaceDown, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareDeletionFailed=shareDeletionFailed, smbSocketFailure=smbSocketFailure, shareCIFSWriteIops=shareCIFSWriteIops, lunFreeSizeHigh=lunFreeSizeHigh, ipmiVoltage=ipmiVoltage, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, ipmiFan=ipmiFan, ipmiMemory=ipmiMemory, deleteFolderCompleted=deleteFolderCompleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareNFSWriteIops=shareNFSWriteIops, poolDataWriteIops=poolDataWriteIops, diskSizeLow=diskSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, replicationSourceRegistered=replicationSourceRegistered, diskError=diskError, poolDegraded=poolDegraded, fcPortOffline=fcPortOffline, replicationPaused=replicationPaused, notifications=notifications, nfsTotalReadIops=nfsTotalReadIops, diskDataReadIops=diskDataReadIops, haControllerA_Uptime=haControllerA_Uptime, snapshotDeleteFailed=snapshotDeleteFailed, poolUpgraded=poolUpgraded, snapshotRollbackCompleted=snapshotRollbackCompleted, network=network, iscsiTargetReadMbps=iscsiTargetReadMbps, shareNFSReadLatency=shareNFSReadLatency, iscsiTargetIndex=iscsiTargetIndex, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolTotalWriteMbps=poolTotalWriteMbps, cpuSystemCalls=cpuSystemCalls, diskGoneOffline=diskGoneOffline, lunInitiatorGroup=lunInitiatorGroup, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolCreated=poolCreated, diskCount=diskCount, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, cacheTotalWriteIops=cacheTotalWriteIops, poolMetaReadLatency=poolMetaReadLatency, poolDataWriteMbps=poolDataWriteMbps, projectDataSizeHigh=projectDataSizeHigh, fcTargetName=fcTargetName, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, networkTotalReceiveMbps=networkTotalReceiveMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, fcInitiators=fcInitiators, lunTable=lunTable, notificationProps=notificationProps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, webdocsUpgradeCompleted=webdocsUpgradeCompleted, currentObjectGroup=currentObjectGroup, ipmiCriticalInterrupt=ipmiCriticalInterrupt, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, diskChassisIdx=diskChassisIdx, aclMigrationCompleted=aclMigrationCompleted, diskSizeHigh=diskSizeHigh, poolDataReadIops=poolDataReadIops, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, controllerUp=controllerUp, fcTargetModifyCompleted=fcTargetModifyCompleted, fcTargetsTable=fcTargetsTable, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, notificationDescription=notificationDescription, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, basicCompliance=basicCompliance, maintenanceModeEnabled=maintenanceModeEnabled, notificationEventCode=notificationEventCode, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcTargetReadLatency=fcTargetReadLatency, shareDataSizeHigh=shareDataSizeHigh, lunSizeHigh=lunSizeHigh, fcTargetReadIops=fcTargetReadIops, snmpServiceStopped=snmpServiceStopped, snmpAgentVersion=snmpAgentVersion, fcTargets=fcTargets, shareReservedSizeHigh=shareReservedSizeHigh, lunProjectName=lunProjectName, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareCompressionEnabled=shareCompressionEnabled, fcProperties=fcProperties, tegileCompliances=tegileCompliances, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolName=poolName, lunReadIops=lunReadIops, notificationReadingTriggerValue=notificationReadingTriggerValue, fcTargetWriteLatency=fcTargetWriteLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, diskTable=diskTable, tegile=tegile, lunReadLatency=lunReadLatency, tdpsUpgradeTimeout=tdpsUpgradeTimeout, nicIndex=nicIndex, poolQuotaFinished=poolQuotaFinished, diskIOCount=diskIOCount, iscsiTargets=iscsiTargets, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectIndex=projectIndex, fcTargetIndex=fcTargetIndex, iscsiInitiatorGroup=iscsiInitiatorGroup, nicMTU=nicMTU, tegileArray_notifications=tegileArray_notifications, userLoginFailed=userLoginFailed, pools=pools, haControllerB_Uptime=haControllerB_Uptime, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, lunPoolName=lunPoolName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, sensorFailureEvent=sensorFailureEvent, upgradeCompleted=upgradeCompleted, diskDataWriteMbps=diskDataWriteMbps, replicationAbandoned=replicationAbandoned, notificationTime=notificationTime, nicName=nicName, smisServiceStopped=smisServiceStopped, controllerDown=controllerDown)
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolAvgReadLatency=poolAvgReadLatency, poolUsedSizeHigh=poolUsedSizeHigh, poolDataWriteLatency=poolDataWriteLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskTotalReadIops=diskTotalReadIops, projectLUNs=projectLUNs, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, replicationComplete=replicationComplete, poolDataSizeHigh=poolDataSizeHigh, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, notificationReadingUnit=notificationReadingUnit, netbiosSocketFailure=netbiosSocketFailure, upgradeTimeout=upgradeTimeout, cifsTotalReadIops=cifsTotalReadIops, projectName=projectName, diskAlias=diskAlias, poolDeleted=poolDeleted, tegileGroups=tegileGroups, iscsiTargetError=iscsiTargetError, projectTotalSaving=projectTotalSaving, replicationTargetDeleted=replicationTargetDeleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, lunReservedSizeLow=lunReservedSizeLow, properties=properties, memoryFailure=memoryFailure, fcPortOnline=fcPortOnline, ipmiCurrent=ipmiCurrent, nfsAvgReadLatency=nfsAvgReadLatency, lunWriteIops=lunWriteIops, shareQuotaFinished=shareQuotaFinished, notificationSensorAction=notificationSensorAction, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, shareIndex=shareIndex, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunDataSizeLow=lunDataSizeLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, haControllerB_IPAddr=haControllerB_IPAddr, cacheRAMReads=cacheRAMReads, diskIndex=diskIndex, iscsiTargetGroupError=iscsiTargetGroupError, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolExpanded=poolExpanded, diskPoolName=diskPoolName, sanProperties=sanProperties, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiProperties=iscsiProperties, cifsTotalReadMbps=cifsTotalReadMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareNFSEnabled=shareNFSEnabled, shareNFSWriteMbps=shareNFSWriteMbps, nfsTotalReadMbps=nfsTotalReadMbps, diskEntry=diskEntry, projectLunCount=projectLunCount, iscsiTargetWriteIops=iscsiTargetWriteIops, lunWriteLatency=lunWriteLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, smisServiceStopFailed=smisServiceStopFailed, lunReservedSizeHigh=lunReservedSizeHigh, testNotification=testNotification, haControllerA_IPAddr=haControllerA_IPAddr, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareDeleted=shareDeleted, projectEntry=projectEntry, PYSNMP_MODULE_ID=tegile, haResourceStatus=haResourceStatus, lunDataSizeHigh=lunDataSizeHigh, smisServiceStartFailed=smisServiceStartFailed, snmpServiceStarted=snmpServiceStarted, poolFreeSizeLow=poolFreeSizeLow, networkInterfaceUp=networkInterfaceUp, volumeDeleteFailed=volumeDeleteFailed, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcInitiatorsTable=fcInitiatorsTable, iscsiTotalReadMbps=iscsiTotalReadMbps, projectThresholdExceedWarning=projectThresholdExceedWarning, lunEntry=lunEntry, fcTargetReadMbps=fcTargetReadMbps, fcTotalReadIops=fcTotalReadIops, poolReadCacheReadLatency=poolReadCacheReadLatency, shareProjectName=shareProjectName, controllerHardwareModel=controllerHardwareModel, shareTable=shareTable, nicTransmitMbps=nicTransmitMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectModified=projectModified, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, haResourceName=haResourceName, shareCIFSWriteLatency=shareCIFSWriteLatency, poolTotalReadIops=poolTotalReadIops, cifsAvgWriteLatency=cifsAvgWriteLatency, lunSizeLow=lunSizeLow, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, haResourceDescription=haResourceDescription, haControllerA_Name=haControllerA_Name, diskDataReadMbps=diskDataReadMbps, currentNotificationGroup=currentNotificationGroup, poolState=poolState, haControllerB_Name=haControllerB_Name, projectDataSizeLow=projectDataSizeLow, fcInitiatorEntry=fcInitiatorEntry, cacheTotalReadMbps=cacheTotalReadMbps, diskIsOnline=diskIsOnline, shareEntry=shareEntry, targetGroupMemberAdded=targetGroupMemberAdded, replicationStarted=replicationStarted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectQuotaSizeLow=projectQuotaSizeLow, haResourcesTable=haResourcesTable, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolUsedSizeLow=poolUsedSizeLow, nicGroup=nicGroup, notificationComponentName=notificationComponentName, poolMetaReadIops=poolMetaReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, projectShareCount=projectShareCount, ipmiTemperature=ipmiTemperature, shareDataSizeLow=shareDataSizeLow, diskState=diskState, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskDataWriteIops=diskDataWriteIops, haResources=haResources, lunSnapshotSizeLow=lunSnapshotSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, shareCompressedRatio=shareCompressedRatio, cifsTotalWriteMbps=cifsTotalWriteMbps, diskSequentialIOCount=diskSequentialIOCount, networkIpmpGroupUp=networkIpmpGroupUp, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunBlockSize=lunBlockSize, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareExceedThresholdWarning=shareExceedThresholdWarning, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiTargetGroup=iscsiTargetGroup, fcTargetEntry=fcTargetEntry, snapshotCloneCompleted=snapshotCloneCompleted, projectCompressionEnabled=projectCompressionEnabled, poolEntry=poolEntry, shareMountPoint=shareMountPoint, nvdimmFailSoftError=nvdimmFailSoftError, shareCIFSReadLatency=shareCIFSReadLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, iscsiTargetsTable=iscsiTargetsTable, notificationSensorNumber=notificationSensorNumber, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareDedupEnabled=shareDedupEnabled, intelliFlashSoftwareDown=intelliFlashSoftwareDown, notificationObjects=notificationObjects, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolTotalSaving=poolTotalSaving, poolSizeLow=poolSizeLow, iscsiTargetAuth=iscsiTargetAuth, spareDiskReplaced=spareDiskReplaced, poolIndex=poolIndex, projectDedupEnabled=projectDedupEnabled, fcTotalWriteMbps=fcTotalWriteMbps, poolDataReadLatency=poolDataReadLatency, fcAvgWriteLatency=fcAvgWriteLatency, poolTable=poolTable, lunDedupEnabled=lunDedupEnabled, notificationTargetEntityName=notificationTargetEntityName, iscsiInitiators=iscsiInitiators, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, upgradeDownloadStarted=upgradeDownloadStarted, iscsiTargetAlias=iscsiTargetAlias, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, snapshotCreationFailed=snapshotCreationFailed, shareCIFSEnabled=shareCIFSEnabled, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, volumeQuotaFinished=volumeQuotaFinished, snapshotRollbackFailed=snapshotRollbackFailed, tegileArray=tegileArray, fcInitiatorIndex=fcInitiatorIndex, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, haResourceGroup=haResourceGroup, controllerTimeDrift=controllerTimeDrift, shareReservedSizeLow=shareReservedSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareCIFSReadMbps=shareCIFSReadMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, poolHealth=poolHealth, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, diskTotalWriteMbps=diskTotalWriteMbps, ipmiThreshold=ipmiThreshold, intelliFlashSoftwareUp=intelliFlashSoftwareUp, projectFreeSizeLow=projectFreeSizeLow, fcTargetStatus=fcTargetStatus, fcTotalReadMbps=fcTotalReadMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolMetaReadMbps=poolMetaReadMbps, notificationSeverity=notificationSeverity, projectDeletionFailed=projectDeletionFailed, lunTargetGroup=lunTargetGroup, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, iscsiTargetWriteMbps=iscsiTargetWriteMbps, lunName=lunName, cacheTotalWriteMbps=cacheTotalWriteMbps, lunCompressedRatio=lunCompressedRatio, ntpServerTimeDrift=ntpServerTimeDrift, cifsTotalWriteIops=cifsTotalWriteIops, nicState=nicState, deleteFolderFailed=deleteFolderFailed, cifsAvgReadLatency=cifsAvgReadLatency, diskAvgWriteLatency=diskAvgWriteLatency, poolFreeSizeHigh=poolFreeSizeHigh, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable)
