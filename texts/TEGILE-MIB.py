...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Integer32, IpAddress, MibIdentifier, iso, enterprises, ObjectIdentity, Bits, TimeTicks, ModuleIdentity, Counter32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Integer32", "IpAddress", "MibIdentifier", "iso", "enterprises", "ObjectIdentity", "Bits", "TimeTicks", "ModuleIdentity", "Counter32", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolEntry=poolEntry, iscsiTargetReadLatency=iscsiTargetReadLatency, poolDataReadLatency=poolDataReadLatency, lunTargetGroup=lunTargetGroup, haResourceStatus=haResourceStatus, intelliFlashSoftwareDown=intelliFlashSoftwareDown, nvdimmFailSoftError=nvdimmFailSoftError, cacheSSDReads=cacheSSDReads, poolMetaReadLatency=poolMetaReadLatency, haResourceGroup=haResourceGroup, diskTotalWriteIops=diskTotalWriteIops, nicState=nicState, lunReadMbps=lunReadMbps, haControllerA_Name=haControllerA_Name, fcInitiatorsTable=fcInitiatorsTable, replicationFailed=replicationFailed, poolProjectCount=poolProjectCount, lunSizeHigh=lunSizeHigh, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiTargetAuth=iscsiTargetAuth, shareNFSReadMbps=shareNFSReadMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolTotalSaving=poolTotalSaving, cacheRAMReads=cacheRAMReads, notificationObjects=notificationObjects, controllerUp=controllerUp, iscsiImproperTargetGroup=iscsiImproperTargetGroup, userLoginFailed=userLoginFailed, shareDeleted=shareDeleted, lunGUID=lunGUID, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, haControllerB_Name=haControllerB_Name, network=network, nfsTotalReadIops=nfsTotalReadIops, iscsiTargetsTable=iscsiTargetsTable, poolFreeSizeHigh=poolFreeSizeHigh, fcTargetWriteMbps=fcTargetWriteMbps, fcInitiatorEntry=fcInitiatorEntry, poolOwnerController=poolOwnerController, nfsAvgReadLatency=nfsAvgReadLatency, projectDeletionFailed=projectDeletionFailed, projectName=projectName, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectIndex=projectIndex, poolReadCacheReadMbps=poolReadCacheReadMbps, lunWriteMbps=lunWriteMbps, notificationSensorAction=notificationSensorAction, poolState=poolState, tegileCompliances=tegileCompliances, diskIndex=diskIndex, diagnosticDataUploaded=diagnosticDataUploaded, poolTotalWriteMbps=poolTotalWriteMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareCIFSWriteIops=shareCIFSWriteIops, shareNFSReadLatency=shareNFSReadLatency, iscsiTargets=iscsiTargets, snmpServiceStarted=snmpServiceStarted, notificationReadingUnit=notificationReadingUnit, iscsiProperties=iscsiProperties, poolReadCacheReadLatency=poolReadCacheReadLatency, nvdimmFailDeviceError=nvdimmFailDeviceError, shareQuotaHigh=shareQuotaHigh, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunCompressionEnabled=lunCompressionEnabled, ipmiTemperature=ipmiTemperature, cifsTotalWriteMbps=cifsTotalWriteMbps, diskSizeHigh=diskSizeHigh, poolDataReadIops=poolDataReadIops, fcAvgWriteLatency=fcAvgWriteLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, poolMetaReadMbps=poolMetaReadMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, nvdimmFailUnknownError=nvdimmFailUnknownError, upgradeStarted=upgradeStarted, shareCIFSReadLatency=shareCIFSReadLatency, shareReservedSizeLow=shareReservedSizeLow, poolDeletionFailed=poolDeletionFailed, nicName=nicName, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectFreeSizeLow=projectFreeSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, networkInterfaceDown=networkInterfaceDown, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolFreeSizeLow=poolFreeSizeLow, nicIndex=nicIndex, fcInitiatorName=fcInitiatorName, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, networkIpmpGroupUp=networkIpmpGroupUp, fcInitiatorIndex=fcInitiatorIndex, vmwareNFSDatastores=vmwareNFSDatastores, shareNFSReadIops=shareNFSReadIops, poolDegraded=poolDegraded, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, replicationTargetDeleted=replicationTargetDeleted, poolAvgReadLatency=poolAvgReadLatency, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargetName=iscsiTargetName, projectShares=projectShares, poolHealth=poolHealth, projectLunCount=projectLunCount, lunName=lunName, nicTable=nicTable, iscsiInitiatorGroup=iscsiInitiatorGroup, basicCompliance=basicCompliance, shareDataSizeHigh=shareDataSizeHigh, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunIndex=lunIndex, cifsAvgWriteLatency=cifsAvgWriteLatency, poolDeleted=poolDeleted, poolMetaWriteMbps=poolMetaWriteMbps, upgradeFailed=upgradeFailed, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareEntry=shareEntry, diskIOCount=diskIOCount, fcTargetWriteLatency=fcTargetWriteLatency, haResourceName=haResourceName, upgradeDownloadStarted=upgradeDownloadStarted, notificationProps=notificationProps, iscsiTargetWriteIops=iscsiTargetWriteIops, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunWriteLatency=lunWriteLatency, notificationTargetEntityName=notificationTargetEntityName, notificationEventCode=notificationEventCode, iscsiTargetReadMbps=iscsiTargetReadMbps, diskIsOnline=diskIsOnline, projectQuotaFinished=projectQuotaFinished, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, pools=pools, projectTable=projectTable, poolReadCacheWriteIops=poolReadCacheWriteIops, fcAvgReadLatency=fcAvgReadLatency, poolTotalWriteIops=poolTotalWriteIops, shareCIFSEnabled=shareCIFSEnabled, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunTable=lunTable, notificationTime=notificationTime, upgradeCompleted=upgradeCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcTargetEntry=fcTargetEntry, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, snapshotCreationFailed=snapshotCreationFailed, diskDataWriteMbps=diskDataWriteMbps, poolCreated=poolCreated, fcTotalReadMbps=fcTotalReadMbps, lunReadLatency=lunReadLatency, replicationPaused=replicationPaused, volumeModifyCompleted=volumeModifyCompleted, haResourceDescription=haResourceDescription, shareCIFSWriteMbps=shareCIFSWriteMbps, haResources=haResources, fcTargetIndex=fcTargetIndex, projectCreatedSuccessfully=projectCreatedSuccessfully, targetGroupMemberAdded=targetGroupMemberAdded, fcTargetName=fcTargetName, shareExceedThresholdWarning=shareExceedThresholdWarning, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, cacheTotalWriteMbps=cacheTotalWriteMbps, fcTargetReadMbps=fcTargetReadMbps, projectShareCount=projectShareCount, fcTotalWriteMbps=fcTotalWriteMbps, lunDataSizeHigh=lunDataSizeHigh, lunSnapshotSizeLow=lunSnapshotSizeLow, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, haControllerB_Uptime=haControllerB_Uptime, shareCompressedRatio=shareCompressedRatio, diskState=diskState, smisServiceStarted=smisServiceStarted, poolExported=poolExported, nicGroup=nicGroup, networkIpmpGroupDown=networkIpmpGroupDown, fcInitiators=fcInitiators, snapshotRollbackCompleted=snapshotRollbackCompleted, volumeQuotaFinished=volumeQuotaFinished, webdocsUpgradeFailed=webdocsUpgradeFailed, lunFreeSizeHigh=lunFreeSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, haResourceIndex=haResourceIndex, poolUsedSizeLow=poolUsedSizeLow, tegileGroups=tegileGroups, fcTargetStatus=fcTargetStatus, poolUsedSizeHigh=poolUsedSizeHigh, shareIndex=shareIndex, lunPoolName=lunPoolName, nfsTotalWriteIops=nfsTotalWriteIops, shareCompressionEnabled=shareCompressionEnabled, sanProperties=sanProperties, iscsiWriteIops=iscsiWriteIops, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareTable=shareTable, shareDedupEnabled=shareDedupEnabled, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, haControllerB_IPAddr=haControllerB_IPAddr, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, haResourcesTable=haResourcesTable, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, smbSocketFailure=smbSocketFailure, diskCount=diskCount, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, haControllerA_Uptime=haControllerA_Uptime, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, lunReadIops=lunReadIops, shareNFSWriteMbps=shareNFSWriteMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, tegile=tegile, PYSNMP_MODULE_ID=tegile, projectEntry=projectEntry, diskDataWriteIops=diskDataWriteIops, notificationDescription=notificationDescription, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectThresholdExceedWarning=projectThresholdExceedWarning, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, haControllerA_IPAddr=haControllerA_IPAddr, notificationReadingTriggerValue=notificationReadingTriggerValue, upgradeDownloadFailed=upgradeDownloadFailed, lunBlockSize=lunBlockSize, diskTotalReadIops=diskTotalReadIops, projectPoolName=projectPoolName, projectModified=projectModified, notifications=notifications, nfsTotalWriteMbps=nfsTotalWriteMbps, poolAvgWriteLatency=poolAvgWriteLatency, poolMetaReadIops=poolMetaReadIops, memoryFailure=memoryFailure, lunReservedSizeLow=lunReservedSizeLow, shareProjectName=shareProjectName, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, currentObjectGroup=currentObjectGroup, sharePoolName=sharePoolName, deleteFolderFailed=deleteFolderFailed, iscsiTargetGroupError=iscsiTargetGroupError, diskTable=diskTable, snmpServiceStopFailed=snmpServiceStopFailed, poolMetaWriteLatency=poolMetaWriteLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolTotalReadIops=poolTotalReadIops, cpuInterrupts=cpuInterrupts, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, deleteFolderCompleted=deleteFolderCompleted, notificationSeverity=notificationSeverity, iscsiTargetEntry=iscsiTargetEntry, ipmiCriticalInterrupt=ipmiCriticalInterrupt, maintenanceModeEnabled=maintenanceModeEnabled, spareDiskReplaced=spareDiskReplaced, diskTotalWriteMbps=diskTotalWriteMbps, lunSizeLow=lunSizeLow, lunProtocol=lunProtocol, maintenanceModeDisabled=maintenanceModeDisabled, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted)
mibBuilder.exportSymbols("TEGILE-MIB", nfsTotalReadMbps=nfsTotalReadMbps, cifsTotalReadIops=cifsTotalReadIops, poolName=poolName, upgradeDownloadCompleted=upgradeDownloadCompleted, diskAlias=diskAlias, replicationSourceRegistered=replicationSourceRegistered, replicationAborted=replicationAborted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, fcTargetsTable=fcTargetsTable, replicationComplete=replicationComplete, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolDataWriteIops=poolDataWriteIops, projectSnapshotSizeLow=projectSnapshotSizeLow, fcTargetGroup=fcTargetGroup, notificationSensorSuspect=notificationSensorSuspect, poolExpanded=poolExpanded, projectDeleted=projectDeleted, poolIndex=poolIndex, poolDataSizeLow=poolDataSizeLow, lunDataSizeLow=lunDataSizeLow, fcInitiatorGroup=fcInitiatorGroup, poolReadCacheReadIops=poolReadCacheReadIops, networkInterfaceUp=networkInterfaceUp, projectQuotaSizeLow=projectQuotaSizeLow, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareMountPoint=shareMountPoint, nicEntry=nicEntry, ipmiOther=ipmiOther, tdpsUpgradeFailed=tdpsUpgradeFailed, cacheTotalWriteIops=cacheTotalWriteIops, aclMigrationCompleted=aclMigrationCompleted, nicReceiveMbps=nicReceiveMbps, diskSequentialIOCount=diskSequentialIOCount, shareReservedSizeHigh=shareReservedSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTotalWriteIops=fcTotalWriteIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, replicationResumed=replicationResumed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, fcPortOffline=fcPortOffline, smisServiceStopped=smisServiceStopped, sensorFailureEvent=sensorFailureEvent, tegileArray_notifications=tegileArray_notifications, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, shareName=shareName, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiTotalReadIops=iscsiTotalReadIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskError=diskError, targetGroupCreateCompleted=targetGroupCreateCompleted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, notificationSensorNumber=notificationSensorNumber, fcProperties=fcProperties, poolWriteCacheWriteIops=poolWriteCacheWriteIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, iscsiTargetIndex=iscsiTargetIndex, upgradeTimeout=upgradeTimeout, cpuTotalUsage=cpuTotalUsage, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, globalStatistics=globalStatistics, projectFreeSizeHigh=projectFreeSizeHigh, poolUpgraded=poolUpgraded, shareQuotaFinished=shareQuotaFinished, nicTransmitMbps=nicTransmitMbps, poolSizeHigh=poolSizeHigh, snmpServiceStopped=snmpServiceStopped, snmpServiceStartFailed=snmpServiceStartFailed, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolCount=poolCount, projectDataSizeHigh=projectDataSizeHigh, shareCIFSReadIops=shareCIFSReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiAvgWriteLatency=iscsiAvgWriteLatency, netbiosSocketFailure=netbiosSocketFailure, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolDataWriteLatency=poolDataWriteLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, nicMTU=nicMTU, smisServiceStartFailed=smisServiceStartFailed, shareCIFSReadMbps=shareCIFSReadMbps, cpuSystemCalls=cpuSystemCalls, lunCompressedRatio=lunCompressedRatio, controllerTimeDrift=controllerTimeDrift, volumeDeleteCompleted=volumeDeleteCompleted, tegileArray=tegileArray, currentNotificationGroup=currentNotificationGroup, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, cifsTotalReadMbps=cifsTotalReadMbps, ntpServerTimeDrift=ntpServerTimeDrift, diskTotalReadMbps=diskTotalReadMbps, ipmiFan=ipmiFan, projectQuotaSizeHigh=projectQuotaSizeHigh, alertsCleanupCompleted=alertsCleanupCompleted, snapshotDeleteFailed=snapshotDeleteFailed, poolProjects=poolProjects, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, testNotification=testNotification, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiInitiatorName=iscsiInitiatorName, poolMetaWriteIops=poolMetaWriteIops, snapshotCloneCompleted=snapshotCloneCompleted, projectDedupEnabled=projectDedupEnabled, shareQuotaLow=shareQuotaLow, replicationStarted=replicationStarted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, controllerHardwareModel=controllerHardwareModel, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskDataReadMbps=diskDataReadMbps, cacheTotalReadIops=cacheTotalReadIops, smisServiceStopFailed=smisServiceStopFailed, aclMigrationStarted=aclMigrationStarted, properties=properties, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolDataWriteMbps=poolDataWriteMbps, cacheTotalReadMbps=cacheTotalReadMbps, poolQuotaFinished=poolQuotaFinished, diskAvgReadLatency=diskAvgReadLatency, projectDataSizeLow=projectDataSizeLow, fcPortOnline=fcPortOnline, poolDataReadMbps=poolDataReadMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, shareDeletionFailed=shareDeletionFailed, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolImported=poolImported, fcTotalReadIops=fcTotalReadIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunWriteIops=lunWriteIops, iscsiTargetAlias=iscsiTargetAlias, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareCreatedSuccessfully=shareCreatedSuccessfully, diskSlowIo=diskSlowIo, iscsiInitiatorChapUser=iscsiInitiatorChapUser, snapshotRollbackFailed=snapshotRollbackFailed, diskPoolName=diskPoolName, shareNFSWriteIops=shareNFSWriteIops, fcTargets=fcTargets, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiInitiators=iscsiInitiators, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetReadLatency=fcTargetReadLatency, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolTable=poolTable, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareNFSEnabled=shareNFSEnabled, shareCIFSWriteLatency=shareCIFSWriteLatency, projectCompressionEnabled=projectCompressionEnabled, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, notificationComponentName=notificationComponentName, lunProjectName=lunProjectName, shareNFSWriteLatency=shareNFSWriteLatency, ipmiVoltage=ipmiVoltage, controllerDown=controllerDown, poolSizeLow=poolSizeLow, ipmiCurrent=ipmiCurrent, poolTotalReadMbps=poolTotalReadMbps, disks=disks, ipmiMemory=ipmiMemory, ipmiThreshold=ipmiThreshold, projectTotalSaving=projectTotalSaving, lunEntry=lunEntry, volumeDeleteFailed=volumeDeleteFailed, iscsiTargetError=iscsiTargetError, diskSizeLow=diskSizeLow, diskGoneOffline=diskGoneOffline, ipmiPowerSupply=ipmiPowerSupply, iscsiTargetReadIops=iscsiTargetReadIops, diskRandomIOCount=diskRandomIOCount, diskDataReadIops=diskDataReadIops, iscsiTargetGroup=iscsiTargetGroup, haResourceEntry=haResourceEntry, lunInitiatorGroup=lunInitiatorGroup, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, adServerTimeDrift=adServerTimeDrift, projectLUNs=projectLUNs, lunDedupEnabled=lunDedupEnabled, lunFreeSizeLow=lunFreeSizeLow, fcTargetWriteIops=fcTargetWriteIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, replicationAbandoned=replicationAbandoned, iscsiAvgReadLatency=iscsiAvgReadLatency, unknownSensorEvent=unknownSensorEvent, diskEntry=diskEntry, iscsiTotalReadMbps=iscsiTotalReadMbps, haResourceActiveNode=haResourceActiveNode, iscsiInitiatorEntry=iscsiInitiatorEntry, diskAvgWriteLatency=diskAvgWriteLatency, iscsiTotalWriteMbps=iscsiTotalWriteMbps, snapshotCloningFailed=snapshotCloningFailed, shareDataSizeLow=shareDataSizeLow, volumeCreatedSuccessfully=volumeCreatedSuccessfully, targetGroupMemberRemoved=targetGroupMemberRemoved, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, snmpAgentVersion=snmpAgentVersion, cifsTotalWriteIops=cifsTotalWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, networkTotalTransmitMbps=networkTotalTransmitMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskType=diskType, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, fcTargetReadIops=fcTargetReadIops, tegileConformance=tegileConformance, cifsAvgReadLatency=cifsAvgReadLatency, webdocsUpgradeCompleted=webdocsUpgradeCompleted, diskChassisIdx=diskChassisIdx, poolDataSizeHigh=poolDataSizeHigh)
