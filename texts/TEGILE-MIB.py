...
# Produced by pysmi-1.1.8 at Mon Jan  2 15:36:17 2023
...
ObjectIdentity, enterprises, iso, IpAddress, TimeTicks, Unsigned32, Integer32, MibIdentifier, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "iso", "IpAddress", "TimeTicks", "Unsigned32", "Integer32", "MibIdentifier", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", cpuSystemCalls=cpuSystemCalls, lunDataSizeHigh=lunDataSizeHigh, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, cifsTotalReadIops=cifsTotalReadIops, iscsiTotalReadMbps=iscsiTotalReadMbps, projectQuotaSizeLow=projectQuotaSizeLow, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiTargetReadIops=iscsiTargetReadIops, lunReadLatency=lunReadLatency, lunReservedSizeHigh=lunReservedSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, iscsiInitiators=iscsiInitiators, shareSnapshotSizeLow=shareSnapshotSizeLow, projectName=projectName, haResourceName=haResourceName, iscsiTargetsTable=iscsiTargetsTable, iscsiInitiatorName=iscsiInitiatorName, haControllerA_Name=haControllerA_Name, poolMetaReadIops=poolMetaReadIops, lunName=lunName, shareDataSizeHigh=shareDataSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, volumeDeleteCompleted=volumeDeleteCompleted, poolReadCacheReadLatency=poolReadCacheReadLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunFreeSizeLow=lunFreeSizeLow, shareCIFSReadIops=shareCIFSReadIops, ipmiPowerSupply=ipmiPowerSupply, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolCreated=poolCreated, alertsCleanupCompleted=alertsCleanupCompleted, fcPortOnline=fcPortOnline, projectModified=projectModified, diagnosticDataUploaded=diagnosticDataUploaded, cacheTotalWriteIops=cacheTotalWriteIops, ipmiCurrent=ipmiCurrent, replicationAborted=replicationAborted, controllerHardwareModel=controllerHardwareModel, userLoginFailed=userLoginFailed, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, haControllerB_Uptime=haControllerB_Uptime, lunCompressionEnabled=lunCompressionEnabled, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolTotalReadMbps=poolTotalReadMbps, cifsTotalWriteMbps=cifsTotalWriteMbps, poolDataWriteLatency=poolDataWriteLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolIndex=poolIndex, poolTotalReadIops=poolTotalReadIops, snmpServiceStartFailed=snmpServiceStartFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diskSlowIo=diskSlowIo, diskIsOnline=diskIsOnline, diskState=diskState, fcTargetWriteIops=fcTargetWriteIops, deleteFolderFailed=deleteFolderFailed, memoryFailure=memoryFailure, spareDiskReplaced=spareDiskReplaced, smisServiceStarted=smisServiceStarted, cacheTotalWriteMbps=cacheTotalWriteMbps, snapshotCreationFailed=snapshotCreationFailed, poolDataSizeLow=poolDataSizeLow, cacheTotalReadIops=cacheTotalReadIops, pools=pools, shareQuotaHigh=shareQuotaHigh, poolDataSizeHigh=poolDataSizeHigh, projectDeleted=projectDeleted, poolFreeSizeHigh=poolFreeSizeHigh, globalStatistics=globalStatistics, shareCIFSEnabled=shareCIFSEnabled, fcTotalWriteIops=fcTotalWriteIops, shareReservedSizeHigh=shareReservedSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, networkIpmpGroupDown=networkIpmpGroupDown, diskDataReadIops=diskDataReadIops, shareCIFSReadLatency=shareCIFSReadLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, sanProperties=sanProperties, poolDataReadIops=poolDataReadIops, diskTotalReadIops=diskTotalReadIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcInitiatorName=fcInitiatorName, diskAlias=diskAlias, notificationThresholdTriggerValue=notificationThresholdTriggerValue, lunReadIops=lunReadIops, fcTargetModifyCompleted=fcTargetModifyCompleted, diskChassisIdx=diskChassisIdx, shareDeleted=shareDeleted, poolUpgraded=poolUpgraded, fcTargetReadLatency=fcTargetReadLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunProtocol=lunProtocol, diskGoneOffline=diskGoneOffline, diskCount=diskCount, poolState=poolState, tegileArray=tegileArray, iscsiTargets=iscsiTargets, fcTargetWriteLatency=fcTargetWriteLatency, nvdimmFailSoftError=nvdimmFailSoftError, projectCreatedSuccessfully=projectCreatedSuccessfully, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolCount=poolCount, iscsiAvgReadLatency=iscsiAvgReadLatency, shareIndex=shareIndex, haResourceEntry=haResourceEntry, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, shareQuotaFinished=shareQuotaFinished, ipmiTemperature=ipmiTemperature, iscsiTargetError=iscsiTargetError, notificationSensorNumber=notificationSensorNumber, poolFreeSizeLow=poolFreeSizeLow, tdpsUpgradeCompleted=tdpsUpgradeCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareNFSEnabled=shareNFSEnabled, iscsiTargetReadLatency=iscsiTargetReadLatency, notificationSensorSuspect=notificationSensorSuspect, tegileGroups=tegileGroups, upgradeDownloadStarted=upgradeDownloadStarted, tegileArray_notifications=tegileArray_notifications, diskTotalWriteMbps=diskTotalWriteMbps, cpuInterrupts=cpuInterrupts, replicationResumed=replicationResumed, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, notificationTargetEntityName=notificationTargetEntityName, projectPoolName=projectPoolName, poolMetaReadLatency=poolMetaReadLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, volumeModifyCompleted=volumeModifyCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, projectDataSizeHigh=projectDataSizeHigh, lunTargetGroup=lunTargetGroup, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, projectThresholdExceedWarning=projectThresholdExceedWarning, diskRandomIOCount=diskRandomIOCount, nfsTotalReadIops=nfsTotalReadIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, maintenanceModeEnabled=maintenanceModeEnabled, poolExpanded=poolExpanded, nvdimmFailDeviceError=nvdimmFailDeviceError, shareDataSizeLow=shareDataSizeLow, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareQuotaLow=shareQuotaLow, poolSizeLow=poolSizeLow, fcInitiatorsTable=fcInitiatorsTable, fcAvgWriteLatency=fcAvgWriteLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, projectShareCount=projectShareCount, poolTotalWriteIops=poolTotalWriteIops, poolDataWriteIops=poolDataWriteIops, iscsiProperties=iscsiProperties, network=network, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargetEntry=fcTargetEntry, diskSizeHigh=diskSizeHigh, controllerDown=controllerDown, lunPoolName=lunPoolName, poolTotalWriteMbps=poolTotalWriteMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, haControllerB_IPAddr=haControllerB_IPAddr, replicationComplete=replicationComplete, nicIndex=nicIndex, lunEntry=lunEntry, tegileConformance=tegileConformance, nicMTU=nicMTU, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, nicTransmitMbps=nicTransmitMbps, notificationTime=notificationTime, notificationSensorAction=notificationSensorAction, poolAvgReadLatency=poolAvgReadLatency, smisServiceStopped=smisServiceStopped, iscsiTargetEntry=iscsiTargetEntry, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunWriteLatency=lunWriteLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, replicationPaused=replicationPaused, haControllerA_IPAddr=haControllerA_IPAddr, projectDeletionFailed=projectDeletionFailed, sensorFailureEvent=sensorFailureEvent, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolDeletionFailed=poolDeletionFailed, notificationReadingUnit=notificationReadingUnit, aclMigrationStarted=aclMigrationStarted, vmwareNFSDatastores=vmwareNFSDatastores, diskSizeLow=diskSizeLow, intelliFlashSoftwareDown=intelliFlashSoftwareDown, controllerUp=controllerUp, snapshotRollbackCompleted=snapshotRollbackCompleted, shareTable=shareTable, fcInitiators=fcInitiators, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunReservedSizeLow=lunReservedSizeLow, diskSequentialIOCount=diskSequentialIOCount, cifsAvgWriteLatency=cifsAvgWriteLatency, diskTotalWriteIops=diskTotalWriteIops, poolProjects=poolProjects, shareEntry=shareEntry, ipmiThreshold=ipmiThreshold, haControllerA_Uptime=haControllerA_Uptime, projectQuotaSizeHigh=projectQuotaSizeHigh, shareNFSReadLatency=shareNFSReadLatency, fcInitiatorEntry=fcInitiatorEntry, poolDegraded=poolDegraded, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiTargetAlias=iscsiTargetAlias, lunCompressedRatio=lunCompressedRatio, shareNFSWriteMbps=shareNFSWriteMbps, projectDataSizeLow=projectDataSizeLow, lunDataSizeLow=lunDataSizeLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, adServerTimeDrift=adServerTimeDrift, nfsTotalWriteMbps=nfsTotalWriteMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareCompressedRatio=shareCompressedRatio, webdocsUpgradeCompleted=webdocsUpgradeCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolDataReadMbps=poolDataReadMbps, upgradeStarted=upgradeStarted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiTargetAuth=iscsiTargetAuth, fcTargetsTable=fcTargetsTable, notificationDescription=notificationDescription, shareDedupEnabled=shareDedupEnabled, haResourceActiveNode=haResourceActiveNode, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, nfsTotalWriteIops=nfsTotalWriteIops, basicCompliance=basicCompliance, replicationStarted=replicationStarted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, diskDataWriteIops=diskDataWriteIops, poolDataWriteMbps=poolDataWriteMbps, projectLUNs=projectLUNs, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolTable=poolTable, notificationObjects=notificationObjects, fcTargetReadIops=fcTargetReadIops, poolName=poolName, projectIndex=projectIndex, cifsTotalWriteIops=cifsTotalWriteIops, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, shareMountPoint=shareMountPoint, lunGUID=lunGUID, upgradeFailed=upgradeFailed, diskAvgReadLatency=diskAvgReadLatency)
mibBuilder.exportSymbols("TEGILE-MIB", snapshotCloneCompleted=snapshotCloneCompleted, iscsiWriteIops=iscsiWriteIops, lunSizeHigh=lunSizeHigh, fcAvgReadLatency=fcAvgReadLatency, notifications=notifications, haResourceStatus=haResourceStatus, iscsiTargetWriteIops=iscsiTargetWriteIops, lunDedupEnabled=lunDedupEnabled, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunWriteIops=lunWriteIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, snmpServiceStarted=snmpServiceStarted, diskError=diskError, fcInitiatorIndex=fcInitiatorIndex, netbiosSocketFailure=netbiosSocketFailure, notificationProps=notificationProps, poolTotalSaving=poolTotalSaving, replicationFailed=replicationFailed, haResources=haResources, sharePoolName=sharePoolName, poolUsedSizeHigh=poolUsedSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiInitiatorIndex=iscsiInitiatorIndex, diskDataWriteMbps=diskDataWriteMbps, diskIndex=diskIndex, notificationComponentName=notificationComponentName, lunSnapshotSizeLow=lunSnapshotSizeLow, nfsTotalReadMbps=nfsTotalReadMbps, maintenanceModeDisabled=maintenanceModeDisabled, nfsAvgWriteLatency=nfsAvgWriteLatency, networkInterfaceDown=networkInterfaceDown, cpuTotalUsage=cpuTotalUsage, tegileCompliances=tegileCompliances, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, shareNFSReadMbps=shareNFSReadMbps, currentObjectGroup=currentObjectGroup, poolSizeHigh=poolSizeHigh, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, networkTotalTransmitMbps=networkTotalTransmitMbps, poolDeleted=poolDeleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, nicGroup=nicGroup, cacheSSDReads=cacheSSDReads, unknownSensorEvent=unknownSensorEvent, fcTargetReadMbps=fcTargetReadMbps, nicEntry=nicEntry, fcTotalReadIops=fcTotalReadIops, targetGroupMemberAdded=targetGroupMemberAdded, initiatorGroupMemberAdded=initiatorGroupMemberAdded, upgradeDownloadCompleted=upgradeDownloadCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, diskType=diskType, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, properties=properties, projectLunCount=projectLunCount, lunReadMbps=lunReadMbps, notificationSeverity=notificationSeverity, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiAvgWriteLatency=iscsiAvgWriteLatency, testNotification=testNotification, tegile=tegile, upgradeDownloadFailed=upgradeDownloadFailed, poolMetaWriteMbps=poolMetaWriteMbps, haControllerB_Name=haControllerB_Name, projectEntry=projectEntry, snmpAgentVersion=snmpAgentVersion, volumeCreatedSuccessfully=volumeCreatedSuccessfully, smisServiceStopFailed=smisServiceStopFailed, volumeDeleteFailed=volumeDeleteFailed, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunIndex=lunIndex, iscsiTargetGroup=iscsiTargetGroup, snmpServiceStopFailed=snmpServiceStopFailed, lunTable=lunTable, shareCIFSReadMbps=shareCIFSReadMbps, replicationAbandoned=replicationAbandoned, poolMetaReadMbps=poolMetaReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, projectCompressionEnabled=projectCompressionEnabled, fcTotalWriteMbps=fcTotalWriteMbps, poolUsedSizeLow=poolUsedSizeLow, lunInitiatorGroup=lunInitiatorGroup, shareCIFSWriteMbps=shareCIFSWriteMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, poolDataReadLatency=poolDataReadLatency, poolImported=poolImported, nvdimmFailUnknownError=nvdimmFailUnknownError, snapshotDeleteFailed=snapshotDeleteFailed, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, volumeQuotaFinished=volumeQuotaFinished, projectSnapshotSizeLow=projectSnapshotSizeLow, diskPoolName=diskPoolName, upgradeTimeout=upgradeTimeout, nicTable=nicTable, iscsiTargetGroupError=iscsiTargetGroupError, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolHealth=poolHealth, lunProjectName=lunProjectName, iscsiTotalReadIops=iscsiTotalReadIops, deleteFolderCompleted=deleteFolderCompleted, fcProperties=fcProperties, fcPortOffline=fcPortOffline, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolReadCacheReadIops=poolReadCacheReadIops, projectQuotaFinished=projectQuotaFinished, projectTotalSaving=projectTotalSaving, PYSNMP_MODULE_ID=tegile, shareCIFSWriteIops=shareCIFSWriteIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, fcTotalReadMbps=fcTotalReadMbps, networkInterfaceUp=networkInterfaceUp, ipmiMemory=ipmiMemory, lunBlockSize=lunBlockSize, projectDedupEnabled=projectDedupEnabled, shareNFSReadIops=shareNFSReadIops, smbSocketFailure=smbSocketFailure, lunWriteMbps=lunWriteMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, cifsAvgReadLatency=cifsAvgReadLatency, snapshotRollbackFailed=snapshotRollbackFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareProjectName=shareProjectName, ipmiVoltage=ipmiVoltage, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, nicState=nicState, haResourceGroup=haResourceGroup, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, targetGroupMemberRemoved=targetGroupMemberRemoved, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, ntpServerTimeDrift=ntpServerTimeDrift, snmpServiceStopped=snmpServiceStopped, haResourceDescription=haResourceDescription, nicName=nicName, targetGroupCreateCompleted=targetGroupCreateCompleted, diskEntry=diskEntry, disks=disks, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, ipmiOther=ipmiOther, fcTargetWriteMbps=fcTargetWriteMbps, poolMetaWriteIops=poolMetaWriteIops, projectFreeSizeHigh=projectFreeSizeHigh, lunFreeSizeHigh=lunFreeSizeHigh, diskDataReadMbps=diskDataReadMbps, shareDeletionFailed=shareDeletionFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, projectTable=projectTable, fcTargetIndex=fcTargetIndex, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, shareNFSWriteIops=shareNFSWriteIops, cacheRAMReads=cacheRAMReads, currentNotificationGroup=currentNotificationGroup, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolReadCacheWriteLatency=poolReadCacheWriteLatency, snapshotCloningFailed=snapshotCloningFailed, poolProjectCount=poolProjectCount, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, shareCompressionEnabled=shareCompressionEnabled, fcTargets=fcTargets, fcTargetGroup=fcTargetGroup, cacheTotalReadMbps=cacheTotalReadMbps, smisServiceStartFailed=smisServiceStartFailed, haResourcesTable=haResourcesTable, projectFreeSizeLow=projectFreeSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiTargetIndex=iscsiTargetIndex, poolQuotaFinished=poolQuotaFinished, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, poolAvgWriteLatency=poolAvgWriteLatency, networkIpmpGroupUp=networkIpmpGroupUp, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcTargetName=fcTargetName, shareReservedSizeLow=shareReservedSizeLow, poolExported=poolExported, aclMigrationCompleted=aclMigrationCompleted, upgradeCompleted=upgradeCompleted, ipmiFan=ipmiFan, controllerTimeDrift=controllerTimeDrift, diskTable=diskTable, haResourceIndex=haResourceIndex, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, diskIOCount=diskIOCount, iscsiTargetName=iscsiTargetName, poolOwnerController=poolOwnerController, shareNFSWriteLatency=shareNFSWriteLatency, projectShares=projectShares, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, iscsiInitiatorGroup=iscsiInitiatorGroup, poolEntry=poolEntry, notificationEventCode=notificationEventCode, diskTotalReadMbps=diskTotalReadMbps, replicationSourceRegistered=replicationSourceRegistered, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, replicationTargetDeleted=replicationTargetDeleted, nicReceiveMbps=nicReceiveMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareName=shareName, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, lunSizeLow=lunSizeLow, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcInitiatorGroup=fcInitiatorGroup, nfsAvgReadLatency=nfsAvgReadLatency, fcTargetStatus=fcTargetStatus)
