...
Integer32, Gauge32, Bits, enterprises, IpAddress, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Counter32, ObjectIdentity, NotificationType, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Bits", "enterprises", "IpAddress", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Counter32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolImported=poolImported, projectDeletionFailed=projectDeletionFailed, haControllerB_Uptime=haControllerB_Uptime, tdpsUpgradeFailed=tdpsUpgradeFailed, projectTable=projectTable, poolOwnerController=poolOwnerController, upgradeFailed=upgradeFailed, network=network, diskPoolName=diskPoolName, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiTargetAlias=iscsiTargetAlias, poolEntry=poolEntry, replicationComplete=replicationComplete, shareCIFSWriteLatency=shareCIFSWriteLatency, shareReservedSizeHigh=shareReservedSizeHigh, poolDeletionFailed=poolDeletionFailed, replicationResumed=replicationResumed, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareNFSReadLatency=shareNFSReadLatency, shareDeletionFailed=shareDeletionFailed, poolHealth=poolHealth, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiTargetReadLatency=iscsiTargetReadLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, fcTargetIndex=fcTargetIndex, haResourceName=haResourceName, fcPortOffline=fcPortOffline, shareCIFSReadMbps=shareCIFSReadMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diskState=diskState, lunReadIops=lunReadIops, shareCompressionEnabled=shareCompressionEnabled, iscsiProperties=iscsiProperties, poolExpanded=poolExpanded, cacheSSDReads=cacheSSDReads, notificationReadingTriggerValue=notificationReadingTriggerValue, shareDeleted=shareDeleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolDataWriteLatency=poolDataWriteLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, projectDataSizeHigh=projectDataSizeHigh, cifsTotalReadIops=cifsTotalReadIops, cpuTotalUsage=cpuTotalUsage, diskEntry=diskEntry, notificationSeverity=notificationSeverity, aclMigrationStarted=aclMigrationStarted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareNFSWriteIops=shareNFSWriteIops, lunPoolName=lunPoolName, upgradeDownloadFailed=upgradeDownloadFailed, targetGroupMemberRemoved=targetGroupMemberRemoved, fcPortOnline=fcPortOnline, diskDataWriteMbps=diskDataWriteMbps, lunReservedSizeHigh=lunReservedSizeHigh, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareDataSizeLow=shareDataSizeLow, diskTotalReadIops=diskTotalReadIops, nicReceiveMbps=nicReceiveMbps, aclMigrationCompleted=aclMigrationCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, controllerTimeDrift=controllerTimeDrift, poolDataWriteMbps=poolDataWriteMbps, notificationSensorNumber=notificationSensorNumber, deleteFolderFailed=deleteFolderFailed, fcTotalWriteMbps=fcTotalWriteMbps, lunSizeLow=lunSizeLow, lunFreeSizeHigh=lunFreeSizeHigh, nicGroup=nicGroup, poolTotalWriteIops=poolTotalWriteIops, projectQuotaSizeHigh=projectQuotaSizeHigh, haResources=haResources, cacheTotalWriteMbps=cacheTotalWriteMbps, poolDataWriteIops=poolDataWriteIops, projectThresholdExceedWarning=projectThresholdExceedWarning, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, nicMTU=nicMTU, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, diskDataReadIops=diskDataReadIops, properties=properties, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, networkInterfaceUp=networkInterfaceUp, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, webdocsUpgradeCompleted=webdocsUpgradeCompleted, projectFreeSizeHigh=projectFreeSizeHigh, cifsTotalWriteMbps=cifsTotalWriteMbps, diskAvgReadLatency=diskAvgReadLatency, notificationComponentName=notificationComponentName, diskIOCount=diskIOCount, networkIpmpGroupUp=networkIpmpGroupUp, poolReadCacheReadIops=poolReadCacheReadIops, diskSizeLow=diskSizeLow, upgradeStarted=upgradeStarted, webdocsUpgradeFailed=webdocsUpgradeFailed, diskTotalWriteMbps=diskTotalWriteMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, replicationPaused=replicationPaused, fcInitiators=fcInitiators, ipmiOther=ipmiOther, notificationProps=notificationProps, shareNFSEnabled=shareNFSEnabled, shareProjectName=shareProjectName, smisServiceStartFailed=smisServiceStartFailed, PYSNMP_MODULE_ID=tegile, lunTable=lunTable, vmwareNFSDatastores=vmwareNFSDatastores, poolDataSizeHigh=poolDataSizeHigh, tegile=tegile, haResourceActiveNode=haResourceActiveNode, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcTotalReadIops=fcTotalReadIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, fcInitiatorsTable=fcInitiatorsTable, adServerTimeDrift=adServerTimeDrift, poolAvgReadLatency=poolAvgReadLatency, ipmiVoltage=ipmiVoltage, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, nicState=nicState, shareNFSReadIops=shareNFSReadIops, projectCreatedSuccessfully=projectCreatedSuccessfully, nicName=nicName, iscsiTargetsTable=iscsiTargetsTable, replicationSourceRegistered=replicationSourceRegistered, projectQuotaSizeLow=projectQuotaSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, fcInitiatorIndex=fcInitiatorIndex, fcTargetGroup=fcTargetGroup, iscsiInitiatorsTable=iscsiInitiatorsTable, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, maintenanceModeDisabled=maintenanceModeDisabled, tegileArray=tegileArray, projectShares=projectShares, ipmiCriticalInterrupt=ipmiCriticalInterrupt, nfsTotalReadMbps=nfsTotalReadMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, haResourceGroup=haResourceGroup, fcTargetReadMbps=fcTargetReadMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, fcProperties=fcProperties, sharePoolName=sharePoolName, iscsiTargetError=iscsiTargetError, cacheTotalReadIops=cacheTotalReadIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, tegileConformance=tegileConformance, poolUsedSizeLow=poolUsedSizeLow, ipmiFan=ipmiFan, snapshotCreationFailed=snapshotCreationFailed, projectPoolName=projectPoolName, lunDataSizeLow=lunDataSizeLow, projectDeleted=projectDeleted, lunCompressedRatio=lunCompressedRatio, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, haControllerA_Uptime=haControllerA_Uptime, replicationAborted=replicationAborted, lunCompressionEnabled=lunCompressionEnabled, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, notificationSensorSuspect=notificationSensorSuspect, projectCompressionEnabled=projectCompressionEnabled, poolSizeHigh=poolSizeHigh, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, fcAvgReadLatency=fcAvgReadLatency, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, unknownSensorEvent=unknownSensorEvent, poolTotalReadIops=poolTotalReadIops, nfsAvgWriteLatency=nfsAvgWriteLatency, diagnosticDataUploaded=diagnosticDataUploaded, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareIndex=shareIndex, fcTargetModifyCompleted=fcTargetModifyCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, snmpServiceStopped=snmpServiceStopped, diskCount=diskCount, upgradeDownloadStarted=upgradeDownloadStarted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, snapshotDeleteFailed=snapshotDeleteFailed, poolDataReadLatency=poolDataReadLatency, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, nfsTotalWriteMbps=nfsTotalWriteMbps, shareDedupEnabled=shareDedupEnabled, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, smisServiceStarted=smisServiceStarted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunIndex=lunIndex, notificationEventCode=notificationEventCode, iscsiTargetName=iscsiTargetName, notificationObjects=notificationObjects, projectSnapshotSizeLow=projectSnapshotSizeLow, ipmiMemory=ipmiMemory, poolQuotaFinished=poolQuotaFinished, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargetEntry=iscsiTargetEntry, poolDataSizeLow=poolDataSizeLow, iscsiInitiatorIndex=iscsiInitiatorIndex, disks=disks, poolExported=poolExported, projectLunCount=projectLunCount, lunInitiatorGroup=lunInitiatorGroup, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, poolMetaReadLatency=poolMetaReadLatency, smisServiceStopFailed=smisServiceStopFailed, projectIndex=projectIndex, notificationTime=notificationTime, shareMountPoint=shareMountPoint, poolIndex=poolIndex, shareNFSWriteMbps=shareNFSWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, poolReadCacheReadLatency=poolReadCacheReadLatency, poolFreeSizeLow=poolFreeSizeLow, notificationReadingUnit=notificationReadingUnit, sanProperties=sanProperties, globalStatistics=globalStatistics, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, smbSocketFailure=smbSocketFailure, diskAvgWriteLatency=diskAvgWriteLatency, projectEntry=projectEntry, nicEntry=nicEntry, cpuSystemCalls=cpuSystemCalls, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolFreeSizeHigh=poolFreeSizeHigh, diskDataWriteIops=diskDataWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareQuotaLow=shareQuotaLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, nfsTotalWriteIops=nfsTotalWriteIops, fcInitiatorName=fcInitiatorName, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, upgradeCompleted=upgradeCompleted, memoryFailure=memoryFailure, shareCompressedRatio=shareCompressedRatio, poolTotalWriteMbps=poolTotalWriteMbps, haControllerA_IPAddr=haControllerA_IPAddr, tdpsUpgradeTimeout=tdpsUpgradeTimeout, upgradeTimeout=upgradeTimeout, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, notificationDescription=notificationDescription, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolName=poolName, iscsiTotalReadIops=iscsiTotalReadIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, spareDiskReplaced=spareDiskReplaced, alertsCleanupCompleted=alertsCleanupCompleted)
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareDataSizeHigh=shareDataSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, ipmiThreshold=ipmiThreshold, projectFreeSizeLow=projectFreeSizeLow, diskAlias=diskAlias, diskTotalReadMbps=diskTotalReadMbps, lunSizeHigh=lunSizeHigh, poolState=poolState, diskIsOnline=diskIsOnline, lunWriteIops=lunWriteIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcInitiatorEntry=fcInitiatorEntry, poolMetaWriteLatency=poolMetaWriteLatency, iscsiTargetIndex=iscsiTargetIndex, volumeDeleteCompleted=volumeDeleteCompleted, cifsTotalReadMbps=cifsTotalReadMbps, projectLUNs=projectLUNs, snmpAgentVersion=snmpAgentVersion, nvdimmFailSoftError=nvdimmFailSoftError, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nicIndex=nicIndex, diskDataReadMbps=diskDataReadMbps, nicTable=nicTable, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTargetAuth=iscsiTargetAuth, lunName=lunName, shareQuotaHigh=shareQuotaHigh, ipmiPowerSupply=ipmiPowerSupply, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, snapshotRollbackFailed=snapshotRollbackFailed, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, replicationAbandoned=replicationAbandoned, poolTotalSaving=poolTotalSaving, poolCreated=poolCreated, controllerHardwareModel=controllerHardwareModel, poolDegraded=poolDegraded, volumeModifyCompleted=volumeModifyCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, projectDataSizeLow=projectDataSizeLow, fcTotalWriteIops=fcTotalWriteIops, fcAvgWriteLatency=fcAvgWriteLatency, iscsiInitiatorName=iscsiInitiatorName, nfsAvgReadLatency=nfsAvgReadLatency, shareCIFSReadIops=shareCIFSReadIops, shareQuotaFinished=shareQuotaFinished, diskSizeHigh=diskSizeHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, lunReadLatency=lunReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiTargetGroup=iscsiTargetGroup, poolProjectCount=poolProjectCount, fcTotalReadMbps=fcTotalReadMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diskSequentialIOCount=diskSequentialIOCount, haResourceStatus=haResourceStatus, lunTargetGroup=lunTargetGroup, poolReadCacheReadMbps=poolReadCacheReadMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcTargetName=fcTargetName, diskError=diskError, networkTotalReceiveMbps=networkTotalReceiveMbps, diskTable=diskTable, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, haControllerA_Name=haControllerA_Name, poolMetaReadIops=poolMetaReadIops, netbiosSocketFailure=netbiosSocketFailure, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcTargetStatus=fcTargetStatus, iscsiImproperTargetGroup=iscsiImproperTargetGroup, smisServiceStopped=smisServiceStopped, cacheRAMReads=cacheRAMReads, poolProjects=poolProjects, diskIndex=diskIndex, replicationStarted=replicationStarted, shareCIFSWriteIops=shareCIFSWriteIops, notifications=notifications, cacheTotalWriteIops=cacheTotalWriteIops, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareCIFSEnabled=shareCIFSEnabled, lunReadMbps=lunReadMbps, poolDataReadIops=poolDataReadIops, nvdimmFailUnknownError=nvdimmFailUnknownError, currentNotificationGroup=currentNotificationGroup, basicCompliance=basicCompliance, pools=pools, nvdimmFailInitializationError=nvdimmFailInitializationError, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareReservedSizeLow=shareReservedSizeLow, poolAvgWriteLatency=poolAvgWriteLatency, cifsAvgReadLatency=cifsAvgReadLatency, sensorFailureEvent=sensorFailureEvent, poolReadCacheWriteLatency=poolReadCacheWriteLatency, cacheTotalReadMbps=cacheTotalReadMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolCount=poolCount, nfsTotalReadIops=nfsTotalReadIops, lunProtocol=lunProtocol, shareTable=shareTable, fcTargetReadIops=fcTargetReadIops, iscsiInitiatorChapUser=iscsiInitiatorChapUser, notificationThresholdTriggerValue=notificationThresholdTriggerValue, networkTotalTransmitMbps=networkTotalTransmitMbps, lunWriteLatency=lunWriteLatency, iscsiInitiators=iscsiInitiators, haControllerB_IPAddr=haControllerB_IPAddr, lunGUID=lunGUID, controllerUp=controllerUp, projectModified=projectModified, fcTargetReadLatency=fcTargetReadLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, tegileArray_notifications=tegileArray_notifications, fcInitiatorGroup=fcInitiatorGroup, replicationTargetDeleted=replicationTargetDeleted, haControllerB_Name=haControllerB_Name, fcInitiatorCreateFailed=fcInitiatorCreateFailed, snmpServiceStarted=snmpServiceStarted, poolTotalReadMbps=poolTotalReadMbps, projectQuotaFinished=projectQuotaFinished, snmpServiceStopFailed=snmpServiceStopFailed, poolDeleted=poolDeleted, userLoginFailed=userLoginFailed, fcTargetsTable=fcTargetsTable, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, projectDedupEnabled=projectDedupEnabled, controllerDown=controllerDown, haResourceDescription=haResourceDescription, projectTotalSaving=projectTotalSaving, tegileGroups=tegileGroups, notificationSensorAction=notificationSensorAction, poolUsedSizeHigh=poolUsedSizeHigh, ipmiCurrent=ipmiCurrent, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiWriteIops=iscsiWriteIops, nicTransmitMbps=nicTransmitMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcTargetEntry=fcTargetEntry, networkIpmpGroupDown=networkIpmpGroupDown, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiTotalReadMbps=iscsiTotalReadMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, cpuInterrupts=cpuInterrupts, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, replicationFailed=replicationFailed, iscsiTargetReadMbps=iscsiTargetReadMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunBlockSize=lunBlockSize, notificationTargetEntityName=notificationTargetEntityName, nvdimmFailDeviceError=nvdimmFailDeviceError, shareName=shareName, fcTargetWriteMbps=fcTargetWriteMbps, networkInterfaceDown=networkInterfaceDown, ntpServerTimeDrift=ntpServerTimeDrift, poolTable=poolTable, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunEntry=lunEntry, snapshotCloneCompleted=snapshotCloneCompleted, lunProjectName=lunProjectName, iscsiTargets=iscsiTargets, poolMetaWriteIops=poolMetaWriteIops, tegileCompliances=tegileCompliances, diskChassisIdx=diskChassisIdx, poolSizeLow=poolSizeLow, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, shareCIFSReadLatency=shareCIFSReadLatency, lunWriteMbps=lunWriteMbps, fcTargetWriteLatency=fcTargetWriteLatency, lunDataSizeHigh=lunDataSizeHigh, ipmiTemperature=ipmiTemperature, shareEntry=shareEntry, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, lunFreeSizeLow=lunFreeSizeLow, projectName=projectName, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareNFSReadMbps=shareNFSReadMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolDataReadMbps=poolDataReadMbps, diskSlowIo=diskSlowIo, maintenanceModeEnabled=maintenanceModeEnabled, volumeQuotaFinished=volumeQuotaFinished, haResourcesTable=haResourcesTable, testNotification=testNotification, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, snapshotCloningFailed=snapshotCloningFailed, diskType=diskType, volumeDeleteFailed=volumeDeleteFailed, lunDedupEnabled=lunDedupEnabled, lunReservedSizeLow=lunReservedSizeLow, poolUpgraded=poolUpgraded, poolMetaWriteMbps=poolMetaWriteMbps, projectShareCount=projectShareCount, haResourceIndex=haResourceIndex, iscsiInitiatorEntry=iscsiInitiatorEntry, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, snmpServiceStartFailed=snmpServiceStartFailed, targetGroupCreateCompleted=targetGroupCreateCompleted, poolMetaReadMbps=poolMetaReadMbps, deleteFolderCompleted=deleteFolderCompleted, diskTotalWriteIops=diskTotalWriteIops, iscsiInitiatorGroup=iscsiInitiatorGroup, targetGroupMemberAdded=targetGroupMemberAdded, diskGoneOffline=diskGoneOffline, fcTargetWriteIops=fcTargetWriteIops, fcTargets=fcTargets, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, haResourceEntry=haResourceEntry)
