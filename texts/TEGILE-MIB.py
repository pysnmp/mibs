...
MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Unsigned32, ModuleIdentity, MibIdentifier, Counter64, Counter32, IpAddress, enterprises, iso, Gauge32, Integer32, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Unsigned32", "ModuleIdentity", "MibIdentifier", "Counter64", "Counter32", "IpAddress", "enterprises", "iso", "Gauge32", "Integer32", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareCIFSReadLatency=shareCIFSReadLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiAvgReadLatency=iscsiAvgReadLatency, notificationSeverity=notificationSeverity, fcTargetGroup=fcTargetGroup, poolDataReadMbps=poolDataReadMbps, tegileArray_notifications=tegileArray_notifications, nfsTotalWriteIops=nfsTotalWriteIops, shareNFSReadMbps=shareNFSReadMbps, shareDedupEnabled=shareDedupEnabled, nvdimmFailSoftError=nvdimmFailSoftError, cpuSystemCalls=cpuSystemCalls, diskGoneOffline=diskGoneOffline, shareCIFSReadIops=shareCIFSReadIops, snmpServiceStarted=snmpServiceStarted, fcTargetStatus=fcTargetStatus, nicName=nicName, poolIndex=poolIndex, haResourceDescription=haResourceDescription, tegileGroups=tegileGroups, poolDataReadLatency=poolDataReadLatency, smisServiceStopped=smisServiceStopped, diskIndex=diskIndex, iscsiTargets=iscsiTargets, upgradeTimeout=upgradeTimeout, upgradeFailed=upgradeFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, volumeDeleteCompleted=volumeDeleteCompleted, networkIpmpGroupDown=networkIpmpGroupDown, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolExported=poolExported, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, shareCIFSReadMbps=shareCIFSReadMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, notifications=notifications, diskIsOnline=diskIsOnline, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareName=shareName, replicationStarted=replicationStarted, shareSnapshotSizeLow=shareSnapshotSizeLow, smisServiceStopFailed=smisServiceStopFailed, networkIpmpGroupUp=networkIpmpGroupUp, poolFreeSizeHigh=poolFreeSizeHigh, notificationTime=notificationTime, iscsiInitiatorsTable=iscsiInitiatorsTable, shareNFSWriteMbps=shareNFSWriteMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, haControllerB_IPAddr=haControllerB_IPAddr, haControllerB_Uptime=haControllerB_Uptime, iscsiTargetAuth=iscsiTargetAuth, nicTransmitMbps=nicTransmitMbps, poolTotalReadMbps=poolTotalReadMbps, ipmiTemperature=ipmiTemperature, projectFreeSizeLow=projectFreeSizeLow, projectLunCount=projectLunCount, iscsiImproperTargetGroup=iscsiImproperTargetGroup, projectShareCount=projectShareCount, fcPortOffline=fcPortOffline, tegileCompliances=tegileCompliances, lunTable=lunTable, diskAvgReadLatency=diskAvgReadLatency, haResourceIndex=haResourceIndex, ipmiCurrent=ipmiCurrent, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolMetaReadIops=poolMetaReadIops, iscsiTotalReadIops=iscsiTotalReadIops, sharePoolName=sharePoolName, memoryFailure=memoryFailure, upgradeCompleted=upgradeCompleted, poolTable=poolTable, lunReservedSizeLow=lunReservedSizeLow, maintenanceModeEnabled=maintenanceModeEnabled, nfsTotalReadIops=nfsTotalReadIops, lunDedupEnabled=lunDedupEnabled, fcTargetWriteIops=fcTargetWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, snmpServiceStopFailed=snmpServiceStopFailed, poolWriteCacheWriteIops=poolWriteCacheWriteIops, snapshotCloningFailed=snapshotCloningFailed, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetsTable=iscsiTargetsTable, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, notificationTargetEntityName=notificationTargetEntityName, iscsiTotalReadMbps=iscsiTotalReadMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunIndex=lunIndex, controllerTimeDrift=controllerTimeDrift, fcAvgReadLatency=fcAvgReadLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunWriteMbps=lunWriteMbps, haControllerA_IPAddr=haControllerA_IPAddr, lunDataSizeHigh=lunDataSizeHigh, notificationComponentName=notificationComponentName, shareTable=shareTable, poolUpgraded=poolUpgraded, replicationPaused=replicationPaused, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectModified=projectModified, poolMetaReadMbps=poolMetaReadMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectIndex=projectIndex, notificationSensorSuspect=notificationSensorSuspect, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiInitiatorChapUser=iscsiInitiatorChapUser, shareNFSReadLatency=shareNFSReadLatency, projectCompressionEnabled=projectCompressionEnabled, poolDataWriteIops=poolDataWriteIops, basicCompliance=basicCompliance, cifsTotalReadMbps=cifsTotalReadMbps, poolTotalWriteIops=poolTotalWriteIops, nicTable=nicTable, fcTotalReadMbps=fcTotalReadMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolMetaWriteIops=poolMetaWriteIops, fcInitiators=fcInitiators, diskSizeHigh=diskSizeHigh, network=network, nfsAvgReadLatency=nfsAvgReadLatency, lunReadIops=lunReadIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, diskError=diskError, tdpsUpgradeCompleted=tdpsUpgradeCompleted, diskChassisIdx=diskChassisIdx, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, notificationSensorAction=notificationSensorAction, lunBlockSize=lunBlockSize, poolCreated=poolCreated, replicationAborted=replicationAborted, snapshotRollbackCompleted=snapshotRollbackCompleted, diskType=diskType, spareDiskReplaced=spareDiskReplaced, iscsiTargetWriteIops=iscsiTargetWriteIops, poolDataSizeLow=poolDataSizeLow, lunEntry=lunEntry, poolQuotaFinished=poolQuotaFinished, shareNFSWriteLatency=shareNFSWriteLatency, tegileConformance=tegileConformance, notificationReadingTriggerValue=notificationReadingTriggerValue, networkTotalReceiveMbps=networkTotalReceiveMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, snapshotDeleteFailed=snapshotDeleteFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, notificationEventCode=notificationEventCode, shareCIFSWriteLatency=shareCIFSWriteLatency, ipmiVoltage=ipmiVoltage, ipmiFan=ipmiFan, fcInitiatorEntry=fcInitiatorEntry, fcPortOnline=fcPortOnline, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectQuotaFinished=projectQuotaFinished, projectLUNs=projectLUNs, replicationTargetDeleted=replicationTargetDeleted, iscsiInitiatorGroup=iscsiInitiatorGroup, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiTargetAlias=iscsiTargetAlias, diskDataWriteMbps=diskDataWriteMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareNFSReadIops=shareNFSReadIops, poolExpanded=poolExpanded, poolState=poolState, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareQuotaLow=shareQuotaLow, iscsiProperties=iscsiProperties, disks=disks, adServerTimeDrift=adServerTimeDrift, nicGroup=nicGroup, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, cacheTotalReadIops=cacheTotalReadIops, shareDataSizeLow=shareDataSizeLow, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiTargetIndex=iscsiTargetIndex, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareIndex=shareIndex, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcInitiatorName=fcInitiatorName, diskCount=diskCount, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, upgradeDownloadFailed=upgradeDownloadFailed, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolSizeHigh=poolSizeHigh, poolDataWriteMbps=poolDataWriteMbps, cifsTotalWriteMbps=cifsTotalWriteMbps, poolDataReadIops=poolDataReadIops, diskPoolName=diskPoolName, diskDataReadMbps=diskDataReadMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, projectQuotaSizeHigh=projectQuotaSizeHigh, poolImported=poolImported, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolCount=poolCount, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, targetGroupMemberAdded=targetGroupMemberAdded, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolAvgWriteLatency=poolAvgWriteLatency, snmpServiceStartFailed=snmpServiceStartFailed, lunSizeLow=lunSizeLow, diskIOCount=diskIOCount, fcInitiatorIndex=fcInitiatorIndex, poolTotalWriteMbps=poolTotalWriteMbps, lunFreeSizeLow=lunFreeSizeLow, haResourcesTable=haResourcesTable, shareNFSWriteIops=shareNFSWriteIops, nicIndex=nicIndex, iscsiTargetReadMbps=iscsiTargetReadMbps, deleteFolderFailed=deleteFolderFailed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, tdpsUpgradeFailed=tdpsUpgradeFailed, aclMigrationStarted=aclMigrationStarted, diskAlias=diskAlias, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunReadMbps=lunReadMbps, pools=pools, shareDeletionFailed=shareDeletionFailed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, projectQuotaSizeLow=projectQuotaSizeLow, projectDataSizeLow=projectDataSizeLow, notificationObjects=notificationObjects, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, upgradeDownloadCompleted=upgradeDownloadCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, volumeCreatedSuccessfully=volumeCreatedSuccessfully, nicState=nicState, sensorFailureEvent=sensorFailureEvent, lunWriteLatency=lunWriteLatency, globalStatistics=globalStatistics, lunCompressedRatio=lunCompressedRatio, iscsiInitiatorName=iscsiInitiatorName, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolProjects=poolProjects, poolAvgReadLatency=poolAvgReadLatency, fcTargets=fcTargets, fcTargetIndex=fcTargetIndex, lunProjectName=lunProjectName, cpuTotalUsage=cpuTotalUsage, poolReadCacheReadMbps=poolReadCacheReadMbps, haResourceActiveNode=haResourceActiveNode, nfsTotalReadMbps=nfsTotalReadMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectTotalSaving=projectTotalSaving, projectName=projectName, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, ntpServerTimeDrift=ntpServerTimeDrift, shareCIFSWriteIops=shareCIFSWriteIops)
mibBuilder.exportSymbols("TEGILE-MIB", webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectDataSizeHigh=projectDataSizeHigh, shareCompressionEnabled=shareCompressionEnabled, volumeModifyCompleted=volumeModifyCompleted, haResourceEntry=haResourceEntry, networkInterfaceUp=networkInterfaceUp, iscsiTargetReadIops=iscsiTargetReadIops, userLoginFailed=userLoginFailed, diskDataReadIops=diskDataReadIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolDeletionFailed=poolDeletionFailed, replicationResumed=replicationResumed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, testNotification=testNotification, lunGUID=lunGUID, alertsCleanupCompleted=alertsCleanupCompleted, poolMetaWriteMbps=poolMetaWriteMbps, projectTable=projectTable, smbSocketFailure=smbSocketFailure, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, cpuInterrupts=cpuInterrupts, projectDeleted=projectDeleted, haResourceStatus=haResourceStatus, replicationSourceRegistered=replicationSourceRegistered, ipmiMemory=ipmiMemory, poolProjectCount=poolProjectCount, snapshotCloneCompleted=snapshotCloneCompleted, poolReadCacheReadIops=poolReadCacheReadIops, fcTargetName=fcTargetName, haResources=haResources, controllerHardwareModel=controllerHardwareModel, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolTotalReadIops=poolTotalReadIops, fcTargetsTable=fcTargetsTable, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, haControllerB_Name=haControllerB_Name, iscsiTargetReadLatency=iscsiTargetReadLatency, diskState=diskState, replicationAbandoned=replicationAbandoned, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolEntry=poolEntry, fcTargetEntry=fcTargetEntry, poolName=poolName, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, targetGroupMemberRemoved=targetGroupMemberRemoved, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcAvgWriteLatency=fcAvgWriteLatency, replicationComplete=replicationComplete, cifsAvgReadLatency=cifsAvgReadLatency, lunInitiatorGroup=lunInitiatorGroup, poolReadCacheWriteIops=poolReadCacheWriteIops, diskSlowIo=diskSlowIo, lunFreeSizeHigh=lunFreeSizeHigh, notificationDescription=notificationDescription, lunTargetGroup=lunTargetGroup, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, ipmiOther=ipmiOther, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectPoolName=projectPoolName, iscsiTargetError=iscsiTargetError, intelliFlashSoftwareDown=intelliFlashSoftwareDown, fcInitiatorsTable=fcInitiatorsTable, diskTable=diskTable, shareQuotaFinished=shareQuotaFinished, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectDeletionFailed=projectDeletionFailed, networkInterfaceDown=networkInterfaceDown, netbiosSocketFailure=netbiosSocketFailure, shareMountPoint=shareMountPoint, diskAvgWriteLatency=diskAvgWriteLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, lunPoolName=lunPoolName, smisServiceStarted=smisServiceStarted, upgradeStarted=upgradeStarted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, unknownSensorEvent=unknownSensorEvent, diskTotalWriteIops=diskTotalWriteIops, fcProperties=fcProperties, lunName=lunName, fcTotalWriteIops=fcTotalWriteIops, shareEntry=shareEntry, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, currentNotificationGroup=currentNotificationGroup, iscsiTargetEntry=iscsiTargetEntry, properties=properties, poolDegraded=poolDegraded, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, nicEntry=nicEntry, cacheTotalReadMbps=cacheTotalReadMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, cifsTotalReadIops=cifsTotalReadIops, notificationSensorNumber=notificationSensorNumber, diskTotalWriteMbps=diskTotalWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, shareNFSEnabled=shareNFSEnabled, cacheTotalWriteIops=cacheTotalWriteIops, fcTargetReadIops=fcTargetReadIops, fcTotalWriteMbps=fcTotalWriteMbps, ipmiThreshold=ipmiThreshold, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiInitiatorEntry=iscsiInitiatorEntry, poolHealth=poolHealth, poolOwnerController=poolOwnerController, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, deleteFolderCompleted=deleteFolderCompleted, projectDedupEnabled=projectDedupEnabled, tegileArray=tegileArray, projectCreatedSuccessfully=projectCreatedSuccessfully, haControllerA_Name=haControllerA_Name, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, shareReservedSizeLow=shareReservedSizeLow, smisServiceStartFailed=smisServiceStartFailed, tegile=tegile, poolReadCacheWriteLatency=poolReadCacheWriteLatency, shareQuotaHigh=shareQuotaHigh, poolMetaWriteLatency=poolMetaWriteLatency, haResourceGroup=haResourceGroup, fcTargetModifyCompleted=fcTargetModifyCompleted, controllerDown=controllerDown, diagnosticDataUploaded=diagnosticDataUploaded, poolSizeLow=poolSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunDataSizeLow=lunDataSizeLow, poolMetaReadLatency=poolMetaReadLatency, cacheRAMReads=cacheRAMReads, diskTotalReadIops=diskTotalReadIops, poolReadCacheReadLatency=poolReadCacheReadLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, shareCreatedSuccessfully=shareCreatedSuccessfully, snapshotCreationFailed=snapshotCreationFailed, maintenanceModeDisabled=maintenanceModeDisabled, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiWriteIops=iscsiWriteIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, controllerUp=controllerUp, snapshotRollbackFailed=snapshotRollbackFailed, fcTargetWriteMbps=fcTargetWriteMbps, diskTotalReadMbps=diskTotalReadMbps, lunSizeHigh=lunSizeHigh, targetGroupDeleteCompleted=targetGroupDeleteCompleted, sanProperties=sanProperties, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, PYSNMP_MODULE_ID=tegile, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, haControllerA_Uptime=haControllerA_Uptime, shareCIFSEnabled=shareCIFSEnabled, fcTargetReadMbps=fcTargetReadMbps, vmwareNFSDatastores=vmwareNFSDatastores, projectShares=projectShares, lunWriteIops=lunWriteIops, shareProjectName=shareProjectName, shareCompressedRatio=shareCompressedRatio, iscsiTargetName=iscsiTargetName, volumeDeleteFailed=volumeDeleteFailed, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, nvdimmFailInitializationError=nvdimmFailInitializationError, diskSequentialIOCount=diskSequentialIOCount, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolDataSizeHigh=poolDataSizeHigh, fcInitiatorGroup=fcInitiatorGroup, diskSizeLow=diskSizeLow, snmpServiceStopped=snmpServiceStopped, shareDeleted=shareDeleted, poolUsedSizeLow=poolUsedSizeLow, snmpAgentVersion=snmpAgentVersion, shareReservedSizeHigh=shareReservedSizeHigh, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, diskDataWriteIops=diskDataWriteIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, networkTotalTransmitMbps=networkTotalTransmitMbps, diskRandomIOCount=diskRandomIOCount, notificationProps=notificationProps, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, fcTargetWriteLatency=fcTargetWriteLatency, fcTotalReadIops=fcTotalReadIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolUsedSizeHigh=poolUsedSizeHigh, shareDataSizeHigh=shareDataSizeHigh, nvdimmFailUnknownError=nvdimmFailUnknownError, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, lunProtocol=lunProtocol, diskEntry=diskEntry, nicMTU=nicMTU, tdpsUpgradeTimeout=tdpsUpgradeTimeout, notificationReadingUnit=notificationReadingUnit, ipmiPowerSupply=ipmiPowerSupply, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcTargetReadLatency=fcTargetReadLatency, lunReadLatency=lunReadLatency, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectEntry=projectEntry, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, replicationFailed=replicationFailed, poolDataWriteLatency=poolDataWriteLatency, cacheSSDReads=cacheSSDReads, volumeQuotaFinished=volumeQuotaFinished, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiInitiators=iscsiInitiators, lunCompressionEnabled=lunCompressionEnabled, iscsiTargetGroup=iscsiTargetGroup, upgradeDownloadStarted=upgradeDownloadStarted, lunReservedSizeHigh=lunReservedSizeHigh, haResourceName=haResourceName, poolDeleted=poolDeleted, poolFreeSizeLow=poolFreeSizeLow, nicReceiveMbps=nicReceiveMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning)
