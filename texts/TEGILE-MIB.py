...
# Produced by pysmi-1.1.8 at Fri Jan  7 01:24:32 2022
...
enterprises, IpAddress, Counter32, Unsigned32, Gauge32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Counter64, NotificationType, TimeTicks, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "Counter32", "Unsigned32", "Gauge32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Counter64", "NotificationType", "TimeTicks", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", disks=disks, projectQuotaSizeHigh=projectQuotaSizeHigh, unknownSensorEvent=unknownSensorEvent, volumeQuotaFinished=volumeQuotaFinished, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolProjectCount=poolProjectCount, poolHealth=poolHealth, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, replicationComplete=replicationComplete, ntpServerTimeDrift=ntpServerTimeDrift, volumeCreatedSuccessfully=volumeCreatedSuccessfully, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolMetaWriteMbps=poolMetaWriteMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, cpuInterrupts=cpuInterrupts, poolDataReadIops=poolDataReadIops, snapshotCloningFailed=snapshotCloningFailed, notificationSensorAction=notificationSensorAction, projectLUNs=projectLUNs, lunSizeLow=lunSizeLow, poolDeleted=poolDeleted, diskTotalReadMbps=diskTotalReadMbps, replicationPaused=replicationPaused, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolTotalWriteIops=poolTotalWriteIops, fcInitiatorEntry=fcInitiatorEntry, fcTargetWriteIops=fcTargetWriteIops, memoryFailure=memoryFailure, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, cacheTotalReadIops=cacheTotalReadIops, shareNFSWriteIops=shareNFSWriteIops, volumeDeleteCompleted=volumeDeleteCompleted, poolTotalSaving=poolTotalSaving, haResourceIndex=haResourceIndex, poolOwnerController=poolOwnerController, aclMigrationStarted=aclMigrationStarted, lunGUID=lunGUID, ipmiThreshold=ipmiThreshold, tdpsUpgradeFailed=tdpsUpgradeFailed, lunTable=lunTable, diskTotalWriteIops=diskTotalWriteIops, projectQuotaSizeLow=projectQuotaSizeLow, tdpsUpgradeCompleted=tdpsUpgradeCompleted, maintenanceModeEnabled=maintenanceModeEnabled, diskTotalWriteMbps=diskTotalWriteMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, projectTotalSaving=projectTotalSaving, diskAvgWriteLatency=diskAvgWriteLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, poolMetaWriteIops=poolMetaWriteIops, projectName=projectName, sharePoolName=sharePoolName, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareNFSReadMbps=shareNFSReadMbps, ipmiPowerSupply=ipmiPowerSupply, poolEntry=poolEntry, notificationReadingUnit=notificationReadingUnit, fcInitiatorIndex=fcInitiatorIndex, userLoginFailed=userLoginFailed, lunReadMbps=lunReadMbps, lunDedupEnabled=lunDedupEnabled, fcTargetReadLatency=fcTargetReadLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcPortOffline=fcPortOffline, shareCompressedRatio=shareCompressedRatio, haControllerB_Uptime=haControllerB_Uptime, iscsiTargets=iscsiTargets, haControllerA_IPAddr=haControllerA_IPAddr, diskPoolName=diskPoolName, notificationThresholdTriggerValue=notificationThresholdTriggerValue, maintenanceModeDisabled=maintenanceModeDisabled, poolIndex=poolIndex, fcTargetEntry=fcTargetEntry, shareCIFSEnabled=shareCIFSEnabled, diskIOCount=diskIOCount, poolMetaReadLatency=poolMetaReadLatency, tegileArray_notifications=tegileArray_notifications, shareCIFSReadMbps=shareCIFSReadMbps, diskEntry=diskEntry, shareDataSizeLow=shareDataSizeLow, iscsiTargetGroupError=iscsiTargetGroupError, notificationTime=notificationTime, fcTargetGroup=fcTargetGroup, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, notificationEventCode=notificationEventCode, notificationReadingTriggerValue=notificationReadingTriggerValue, nicState=nicState, iscsiInitiators=iscsiInitiators, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, haResourceName=haResourceName, poolReadCacheReadLatency=poolReadCacheReadLatency, poolDataSizeLow=poolDataSizeLow, lunPoolName=lunPoolName, nicTransmitMbps=nicTransmitMbps, replicationAbandoned=replicationAbandoned, snapshotRollbackFailed=snapshotRollbackFailed, haResourceStatus=haResourceStatus, lunIndex=lunIndex, lunCompressedRatio=lunCompressedRatio, poolUpgraded=poolUpgraded, networkIpmpGroupUp=networkIpmpGroupUp, fcTargetWriteLatency=fcTargetWriteLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, diagnosticDataUploaded=diagnosticDataUploaded, diskTotalReadIops=diskTotalReadIops, cifsTotalWriteMbps=cifsTotalWriteMbps, poolExported=poolExported, cacheTotalWriteMbps=cacheTotalWriteMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, tegile=tegile, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, snmpServiceStartFailed=snmpServiceStartFailed, shareCreatedSuccessfully=shareCreatedSuccessfully, nvdimmFailSoftError=nvdimmFailSoftError, diskDataWriteMbps=diskDataWriteMbps, diskDataReadMbps=diskDataReadMbps, diskSizeHigh=diskSizeHigh, haResourceEntry=haResourceEntry, poolDataReadLatency=poolDataReadLatency, iscsiTargetName=iscsiTargetName, networkIpmpGroupDown=networkIpmpGroupDown, iscsiTotalReadMbps=iscsiTotalReadMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiTargetReadLatency=iscsiTargetReadLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, shareExceedThresholdWarning=shareExceedThresholdWarning, haResourceGroup=haResourceGroup, intelliFlashSoftwareUp=intelliFlashSoftwareUp, nfsTotalWriteMbps=nfsTotalWriteMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, upgradeFailed=upgradeFailed, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskAvgReadLatency=diskAvgReadLatency, shareNFSWriteLatency=shareNFSWriteLatency, cacheRAMReads=cacheRAMReads, notificationProps=notificationProps, deleteFolderCompleted=deleteFolderCompleted, shareCIFSWriteLatency=shareCIFSWriteLatency, poolMetaWriteLatency=poolMetaWriteLatency, targetGroupMemberAdded=targetGroupMemberAdded, lunWriteMbps=lunWriteMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, shareCIFSReadIops=shareCIFSReadIops, projectLunCount=projectLunCount, diskError=diskError, pools=pools, fcAvgWriteLatency=fcAvgWriteLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareQuotaLow=shareQuotaLow, lunReservedSizeLow=lunReservedSizeLow, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareTable=shareTable, volumeModifyCompleted=volumeModifyCompleted, shareIndex=shareIndex, fcTargetName=fcTargetName, diskType=diskType, lunWriteIops=lunWriteIops, haControllerA_Uptime=haControllerA_Uptime, fcInitiators=fcInitiators, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, controllerHardwareModel=controllerHardwareModel, nicTable=nicTable, shareCompressionEnabled=shareCompressionEnabled, iscsiTargetReadMbps=iscsiTargetReadMbps, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, networkInterfaceDown=networkInterfaceDown, projectDeleted=projectDeleted, snmpServiceStopped=snmpServiceStopped, fcTotalReadMbps=fcTotalReadMbps, diskDataReadIops=diskDataReadIops, snapshotCreationFailed=snapshotCreationFailed, poolDataReadMbps=poolDataReadMbps, poolTable=poolTable, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, lunTargetGroup=lunTargetGroup, projectFreeSizeHigh=projectFreeSizeHigh, shareNFSReadLatency=shareNFSReadLatency, shareMountPoint=shareMountPoint, projectIndex=projectIndex, controllerTimeDrift=controllerTimeDrift, tegileConformance=tegileConformance, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, snapshotDeleteFailed=snapshotDeleteFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskDataWriteIops=diskDataWriteIops, shareCIFSWriteIops=shareCIFSWriteIops, replicationTargetDeleted=replicationTargetDeleted, upgradeTimeout=upgradeTimeout, smisServiceStartFailed=smisServiceStartFailed, fcPortOnline=fcPortOnline, fcTargets=fcTargets, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolState=poolState, lunFreeSizeLow=lunFreeSizeLow, notificationTargetEntityName=notificationTargetEntityName, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiTotalReadIops=iscsiTotalReadIops, projectModified=projectModified, cifsAvgReadLatency=cifsAvgReadLatency, diskChassisIdx=diskChassisIdx, projectThresholdExceedWarning=projectThresholdExceedWarning, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, lunCompressionEnabled=lunCompressionEnabled, notificationSeverity=notificationSeverity, ipmiFan=ipmiFan, fcTargetModifyCompleted=fcTargetModifyCompleted, fcInitiatorsTable=fcInitiatorsTable, poolMetaReadMbps=poolMetaReadMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, sanProperties=sanProperties, cacheTotalWriteIops=cacheTotalWriteIops, poolFreeSizeHigh=poolFreeSizeHigh, projectDataSizeLow=projectDataSizeLow, iscsiInitiatorName=iscsiInitiatorName, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareDeletionFailed=shareDeletionFailed, poolDegraded=poolDegraded, smisServiceStopFailed=smisServiceStopFailed, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskAlias=diskAlias, lunDataSizeLow=lunDataSizeLow, spareDiskReplaced=spareDiskReplaced, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, nvdimmFailDeviceError=nvdimmFailDeviceError, nfsTotalReadIops=nfsTotalReadIops, shareDataSizeHigh=shareDataSizeHigh, poolAvgWriteLatency=poolAvgWriteLatency, cacheTotalReadMbps=cacheTotalReadMbps, haControllerB_Name=haControllerB_Name, poolUsedSizeLow=poolUsedSizeLow, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, diskSlowIo=diskSlowIo, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, projectShareCount=projectShareCount, fcAvgReadLatency=fcAvgReadLatency, shareProjectName=shareProjectName, shareCIFSReadLatency=shareCIFSReadLatency, ipmiCurrent=ipmiCurrent, lunInitiatorGroup=lunInitiatorGroup, diskIsOnline=diskIsOnline, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiTargetAuth=iscsiTargetAuth)
mibBuilder.exportSymbols("TEGILE-MIB", cifsTotalReadMbps=cifsTotalReadMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, poolDataWriteIops=poolDataWriteIops, properties=properties, notificationDescription=notificationDescription, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, iscsiWriteIops=iscsiWriteIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, shareDedupEnabled=shareDedupEnabled, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, fcTargetsTable=fcTargetsTable, nicMTU=nicMTU, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolDeletionFailed=poolDeletionFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, cifsTotalWriteIops=cifsTotalWriteIops, upgradeStarted=upgradeStarted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, diskGoneOffline=diskGoneOffline, projectFreeSizeLow=projectFreeSizeLow, lunProjectName=lunProjectName, fcTargetWriteMbps=fcTargetWriteMbps, poolDataWriteLatency=poolDataWriteLatency, smisServiceStarted=smisServiceStarted, poolSizeHigh=poolSizeHigh, poolTotalWriteMbps=poolTotalWriteMbps, projectCompressionEnabled=projectCompressionEnabled, snapshotRollbackCompleted=snapshotRollbackCompleted, notificationObjects=notificationObjects, volumeDeleteFailed=volumeDeleteFailed, snapshotCloneCompleted=snapshotCloneCompleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, diskRandomIOCount=diskRandomIOCount, currentNotificationGroup=currentNotificationGroup, ipmiVoltage=ipmiVoltage, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, testNotification=testNotification, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, tegileCompliances=tegileCompliances, iscsiTargetEntry=iscsiTargetEntry, diskState=diskState, diskSequentialIOCount=diskSequentialIOCount, iscsiAvgReadLatency=iscsiAvgReadLatency, lunWriteLatency=lunWriteLatency, fcTargetIndex=fcTargetIndex, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareNFSWriteMbps=shareNFSWriteMbps, notifications=notifications, replicationResumed=replicationResumed, shareNFSEnabled=shareNFSEnabled, webdocsUpgradeCompleted=webdocsUpgradeCompleted, projectEntry=projectEntry, projectPoolName=projectPoolName, diskTable=diskTable, lunBlockSize=lunBlockSize, netbiosSocketFailure=netbiosSocketFailure, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, cpuSystemCalls=cpuSystemCalls, lunReadIops=lunReadIops, lunFreeSizeHigh=lunFreeSizeHigh, networkTotalReceiveMbps=networkTotalReceiveMbps, notificationComponentName=notificationComponentName, diskSizeLow=diskSizeLow, shareCIFSWriteMbps=shareCIFSWriteMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolReadCacheWriteMbps=poolReadCacheWriteMbps, ipmiMemory=ipmiMemory, poolProjects=poolProjects, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiTargetReadIops=iscsiTargetReadIops, lunEntry=lunEntry, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolCreated=poolCreated, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, sensorFailureEvent=sensorFailureEvent, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, nfsTotalWriteIops=nfsTotalWriteIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, upgradeCompleted=upgradeCompleted, fcTargetReadIops=fcTargetReadIops, controllerDown=controllerDown, smisServiceStopped=smisServiceStopped, deleteFolderFailed=deleteFolderFailed, haControllerB_IPAddr=haControllerB_IPAddr, projectCreatedSuccessfully=projectCreatedSuccessfully, fcTotalReadIops=fcTotalReadIops, controllerUp=controllerUp, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, projectDedupEnabled=projectDedupEnabled, poolExpanded=poolExpanded, currentObjectGroup=currentObjectGroup, iscsiTargetWriteIops=iscsiTargetWriteIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiInitiatorGroup=iscsiInitiatorGroup, poolDataWriteMbps=poolDataWriteMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, alertsCleanupCompleted=alertsCleanupCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunDataSizeHigh=lunDataSizeHigh, vmwareNFSDatastores=vmwareNFSDatastores, iscsiInitiatorsTable=iscsiInitiatorsTable, fcTargetReadMbps=fcTargetReadMbps, fcProperties=fcProperties, adServerTimeDrift=adServerTimeDrift, projectDeletionFailed=projectDeletionFailed, poolName=poolName, replicationStarted=replicationStarted, poolTotalReadIops=poolTotalReadIops, poolTotalReadMbps=poolTotalReadMbps, notificationSensorNumber=notificationSensorNumber, aclMigrationCompleted=aclMigrationCompleted, poolReadCacheReadIops=poolReadCacheReadIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, shareQuotaFinished=shareQuotaFinished, projectQuotaFinished=projectQuotaFinished, haResourceDescription=haResourceDescription, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunProtocol=lunProtocol, poolQuotaFinished=poolQuotaFinished, poolAvgReadLatency=poolAvgReadLatency, nicEntry=nicEntry, ipmiTemperature=ipmiTemperature, poolCount=poolCount, poolUsedSizeHigh=poolUsedSizeHigh, nfsAvgReadLatency=nfsAvgReadLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, network=network, fcTotalWriteIops=fcTotalWriteIops, shareName=shareName, shareQuotaHigh=shareQuotaHigh, fcTargetStatus=fcTargetStatus, snmpServiceStarted=snmpServiceStarted, PYSNMP_MODULE_ID=tegile, upgradeDownloadFailed=upgradeDownloadFailed, poolDataSizeHigh=poolDataSizeHigh, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, cifsTotalReadIops=cifsTotalReadIops, nicIndex=nicIndex, notificationSensorSuspect=notificationSensorSuspect, ipmiOther=ipmiOther, haResourceActiveNode=haResourceActiveNode, iscsiProperties=iscsiProperties, cacheSSDReads=cacheSSDReads, poolSizeLow=poolSizeLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, snmpServiceStopFailed=snmpServiceStopFailed, replicationSourceRegistered=replicationSourceRegistered, iscsiTargetAlias=iscsiTargetAlias, replicationFailed=replicationFailed, fcInitiatorName=fcInitiatorName, shareNFSReadIops=shareNFSReadIops, iscsiInitiatorEntry=iscsiInitiatorEntry, lunSizeHigh=lunSizeHigh, basicCompliance=basicCompliance, webdocsUpgradeFailed=webdocsUpgradeFailed, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiTargetIndex=iscsiTargetIndex, iscsiTargetError=iscsiTargetError, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, shareEntry=shareEntry, cifsAvgWriteLatency=cifsAvgWriteLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, projectShares=projectShares, poolMetaReadIops=poolMetaReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, smbSocketFailure=smbSocketFailure, lunName=lunName, lunReservedSizeHigh=lunReservedSizeHigh, snmpAgentVersion=snmpAgentVersion, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, networkInterfaceUp=networkInterfaceUp, shareDeleted=shareDeleted, shareReservedSizeLow=shareReservedSizeLow, diskIndex=diskIndex, cpuTotalUsage=cpuTotalUsage, iscsiTargetsTable=iscsiTargetsTable, replicationAborted=replicationAborted, nfsTotalReadMbps=nfsTotalReadMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcInitiatorGroup=fcInitiatorGroup, tegileArray=tegileArray, poolFreeSizeLow=poolFreeSizeLow, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiTargetGroup=iscsiTargetGroup, haResources=haResources, tegileGroups=tegileGroups, poolReadCacheReadMbps=poolReadCacheReadMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolImported=poolImported, nicGroup=nicGroup, nicName=nicName, lunReadLatency=lunReadLatency, haResourcesTable=haResourcesTable, projectDataSizeHigh=projectDataSizeHigh, haControllerA_Name=haControllerA_Name, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectTable=projectTable, shareSnapshotSizeLow=shareSnapshotSizeLow, globalStatistics=globalStatistics, upgradeDownloadStarted=upgradeDownloadStarted, nicReceiveMbps=nicReceiveMbps, shareReservedSizeHigh=shareReservedSizeHigh, diskCount=diskCount, fcTotalWriteMbps=fcTotalWriteMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted)
