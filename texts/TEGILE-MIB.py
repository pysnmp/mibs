...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:05:40 2023
...
Counter64, Bits, NotificationType, MibIdentifier, Unsigned32, IpAddress, iso, Counter32, ObjectIdentity, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "NotificationType", "MibIdentifier", "Unsigned32", "IpAddress", "iso", "Counter32", "ObjectIdentity", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareName=shareName, lunDedupEnabled=lunDedupEnabled, iscsiTargetError=iscsiTargetError, smisServiceStopped=smisServiceStopped, lunTargetGroup=lunTargetGroup, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, volumeQuotaFinished=volumeQuotaFinished, snmpServiceStopped=snmpServiceStopped, shareCIFSReadMbps=shareCIFSReadMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolHealth=poolHealth, lunPoolName=lunPoolName, iscsiInitiators=iscsiInitiators, fcTargetReadIops=fcTargetReadIops, currentObjectGroup=currentObjectGroup, projectCreatedSuccessfully=projectCreatedSuccessfully, vmwareNFSDatastores=vmwareNFSDatastores, fcTargetsTable=fcTargetsTable, projectDeleted=projectDeleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, haControllerB_Uptime=haControllerB_Uptime, lunInitiatorGroup=lunInitiatorGroup, diskDataReadMbps=diskDataReadMbps, shareCIFSWriteIops=shareCIFSWriteIops, iscsiTargetGroup=iscsiTargetGroup, pools=pools, upgradeDownloadStarted=upgradeDownloadStarted, shareEntry=shareEntry, poolDataSizeLow=poolDataSizeLow, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTargetName=iscsiTargetName, shareNFSReadLatency=shareNFSReadLatency, deleteFolderCompleted=deleteFolderCompleted, fcAvgReadLatency=fcAvgReadLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcTargetWriteIops=fcTargetWriteIops, smisServiceStartFailed=smisServiceStartFailed, poolTotalReadMbps=poolTotalReadMbps, replicationComplete=replicationComplete, shareCIFSReadIops=shareCIFSReadIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, shareQuotaFinished=shareQuotaFinished, lunName=lunName, lunSizeLow=lunSizeLow, poolReadCacheReadLatency=poolReadCacheReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, diskIOCount=diskIOCount, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolMetaReadMbps=poolMetaReadMbps, snmpServiceStarted=snmpServiceStarted, ipmiFan=ipmiFan, nfsTotalWriteMbps=nfsTotalWriteMbps, ipmiCurrent=ipmiCurrent, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, userLoginFailed=userLoginFailed, notificationComponentName=notificationComponentName, shareIndex=shareIndex, poolDataWriteMbps=poolDataWriteMbps, fcInitiatorsTable=fcInitiatorsTable, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, nicIndex=nicIndex, poolDeleted=poolDeleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, globalStatistics=globalStatistics, poolDataReadMbps=poolDataReadMbps, haResourceIndex=haResourceIndex, notificationDescription=notificationDescription, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, sanProperties=sanProperties, projectQuotaSizeLow=projectQuotaSizeLow, notificationThresholdTriggerValue=notificationThresholdTriggerValue, snmpServiceStopFailed=snmpServiceStopFailed, diskIsOnline=diskIsOnline, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskRandomIOCount=diskRandomIOCount, diskAvgWriteLatency=diskAvgWriteLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, upgradeDownloadFailed=upgradeDownloadFailed, replicationAbandoned=replicationAbandoned, projectTotalSaving=projectTotalSaving, fcInitiatorIndex=fcInitiatorIndex, shareNFSReadIops=shareNFSReadIops, spareDiskReplaced=spareDiskReplaced, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectShareCount=projectShareCount, haResourceGroup=haResourceGroup, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, controllerDown=controllerDown, iscsiTargetAlias=iscsiTargetAlias, notificationSensorSuspect=notificationSensorSuspect, maintenanceModeEnabled=maintenanceModeEnabled, snmpServiceStartFailed=snmpServiceStartFailed, poolMetaReadLatency=poolMetaReadLatency, poolExported=poolExported, haControllerA_IPAddr=haControllerA_IPAddr, projectSnapshotSizeLow=projectSnapshotSizeLow, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, haResourceName=haResourceName, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, snapshotRollbackCompleted=snapshotRollbackCompleted, poolAvgWriteLatency=poolAvgWriteLatency, shareNFSWriteLatency=shareNFSWriteLatency, snapshotRollbackFailed=snapshotRollbackFailed, iscsiTotalReadMbps=iscsiTotalReadMbps, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiInitiatorName=iscsiInitiatorName, lunReservedSizeHigh=lunReservedSizeHigh, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareDeleted=shareDeleted, diagnosticDataUploaded=diagnosticDataUploaded, networkIpmpGroupUp=networkIpmpGroupUp, fcAvgWriteLatency=fcAvgWriteLatency, haResourceStatus=haResourceStatus, poolState=poolState, ipmiVoltage=ipmiVoltage, shareDedupEnabled=shareDedupEnabled, lunSizeHigh=lunSizeHigh, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiTargetsTable=iscsiTargetsTable, poolUpgraded=poolUpgraded, smbSocketFailure=smbSocketFailure, shareDataSizeHigh=shareDataSizeHigh, shareDataSizeLow=shareDataSizeLow, poolQuotaFinished=poolQuotaFinished, poolDegraded=poolDegraded, cacheSSDReads=cacheSSDReads, projectShares=projectShares, cifsAvgWriteLatency=cifsAvgWriteLatency, projectModified=projectModified, fcTargetGroup=fcTargetGroup, nicState=nicState, haControllerB_IPAddr=haControllerB_IPAddr, nfsAvgReadLatency=nfsAvgReadLatency, nicMTU=nicMTU, replicationSourceRegistered=replicationSourceRegistered, iscsiTargetReadIops=iscsiTargetReadIops, shareExceedThresholdWarning=shareExceedThresholdWarning, poolDataSizeHigh=poolDataSizeHigh, projectDeletionFailed=projectDeletionFailed, replicationStarted=replicationStarted, poolAvgReadLatency=poolAvgReadLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolDataWriteLatency=poolDataWriteLatency, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectDataSizeHigh=projectDataSizeHigh, fcTargetStatus=fcTargetStatus, intelliFlashSoftwareDown=intelliFlashSoftwareDown, notificationSensorNumber=notificationSensorNumber, poolMetaWriteLatency=poolMetaWriteLatency, adServerTimeDrift=adServerTimeDrift, ipmiTemperature=ipmiTemperature, shareQuotaHigh=shareQuotaHigh, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, disks=disks, poolReadCacheWriteLatency=poolReadCacheWriteLatency, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunWriteIops=lunWriteIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcTargetWriteMbps=fcTargetWriteMbps, testNotification=testNotification, haControllerB_Name=haControllerB_Name, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiTargets=iscsiTargets, shareReservedSizeHigh=shareReservedSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolReadCacheReadMbps=poolReadCacheReadMbps, poolDataReadIops=poolDataReadIops, replicationFailed=replicationFailed, shareProjectName=shareProjectName, deleteFolderFailed=deleteFolderFailed, PYSNMP_MODULE_ID=tegile, ipmiThreshold=ipmiThreshold, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, fcTotalWriteMbps=fcTotalWriteMbps, iscsiTargetAuth=iscsiTargetAuth, poolMetaWriteMbps=poolMetaWriteMbps, nicEntry=nicEntry, targetGroupMemberRemoved=targetGroupMemberRemoved, shareSnapshotSizeLow=shareSnapshotSizeLow, fcProperties=fcProperties, diskAvgReadLatency=diskAvgReadLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, tegileArray_notifications=tegileArray_notifications, nvdimmFailSoftError=nvdimmFailSoftError, nicTable=nicTable, poolIndex=poolIndex, volumeDeleteFailed=volumeDeleteFailed, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareReservedSizeLow=shareReservedSizeLow, poolDataReadLatency=poolDataReadLatency, poolTotalSaving=poolTotalSaving, fcInitiatorGroup=fcInitiatorGroup, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunReadMbps=lunReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, lunFreeSizeLow=lunFreeSizeLow, diskChassisIdx=diskChassisIdx, intelliFlashSoftwareUp=intelliFlashSoftwareUp, lunCompressedRatio=lunCompressedRatio, replicationResumed=replicationResumed, diskSizeLow=diskSizeLow, haResources=haResources, fcInitiatorName=fcInitiatorName, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationReadingUnit=notificationReadingUnit, snapshotDeleteFailed=snapshotDeleteFailed, poolReadCacheReadIops=poolReadCacheReadIops, iscsiTargetIndex=iscsiTargetIndex, upgradeFailed=upgradeFailed, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectDataSizeLow=projectDataSizeLow, alertsCleanupCompleted=alertsCleanupCompleted, nicGroup=nicGroup, poolTable=poolTable, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, smisServiceStopFailed=smisServiceStopFailed, tegileGroups=tegileGroups, iscsiTargetWriteLatency=iscsiTargetWriteLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, nfsTotalReadIops=nfsTotalReadIops, haControllerA_Uptime=haControllerA_Uptime, fcTotalReadMbps=fcTotalReadMbps, unknownSensorEvent=unknownSensorEvent, fcTargetReadMbps=fcTargetReadMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, shareCreatedSuccessfully=shareCreatedSuccessfully, tdpsUpgradeCompleted=tdpsUpgradeCompleted, upgradeStarted=upgradeStarted, diskSequentialIOCount=diskSequentialIOCount, poolExpanded=poolExpanded, controllerTimeDrift=controllerTimeDrift, diskTotalWriteMbps=diskTotalWriteMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiTargetReadLatency=iscsiTargetReadLatency, currentNotificationGroup=currentNotificationGroup, cpuInterrupts=cpuInterrupts, diskEntry=diskEntry, diskGoneOffline=diskGoneOffline, targetGroupDeleteCompleted=targetGroupDeleteCompleted, ipmiPowerSupply=ipmiPowerSupply, projectPoolName=projectPoolName, tegileConformance=tegileConformance)
mibBuilder.exportSymbols("TEGILE-MIB", cifsTotalWriteMbps=cifsTotalWriteMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, shareNFSReadMbps=shareNFSReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, diskCount=diskCount, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskIndex=diskIndex, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiInitiatorEntry=iscsiInitiatorEntry, fcTargetName=fcTargetName, upgradeCompleted=upgradeCompleted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolDataWriteIops=poolDataWriteIops, iscsiTargetWriteIops=iscsiTargetWriteIops, snapshotCreationFailed=snapshotCreationFailed, network=network, cifsTotalWriteIops=cifsTotalWriteIops, replicationTargetDeleted=replicationTargetDeleted, cacheRAMReads=cacheRAMReads, poolFreeSizeLow=poolFreeSizeLow, lunFreeSizeHigh=lunFreeSizeHigh, notifications=notifications, sensorFailureEvent=sensorFailureEvent, cpuTotalUsage=cpuTotalUsage, networkInterfaceDown=networkInterfaceDown, cacheTotalWriteIops=cacheTotalWriteIops, notificationProps=notificationProps, iscsiProperties=iscsiProperties, fcTargetModifyCompleted=fcTargetModifyCompleted, poolCount=poolCount, lunWriteLatency=lunWriteLatency, diskSlowIo=diskSlowIo, networkIpmpGroupDown=networkIpmpGroupDown, iscsiInitiatorIndex=iscsiInitiatorIndex, nfsTotalReadMbps=nfsTotalReadMbps, properties=properties, fcPortOffline=fcPortOffline, shareDeletionFailed=shareDeletionFailed, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolName=poolName, lunTable=lunTable, lunProjectName=lunProjectName, nicName=nicName, ipmiOther=ipmiOther, fcTotalWriteIops=fcTotalWriteIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, tegileCompliances=tegileCompliances, poolFreeSizeHigh=poolFreeSizeHigh, memoryFailure=memoryFailure, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, cacheTotalReadIops=cacheTotalReadIops, projectQuotaFinished=projectQuotaFinished, haResourceActiveNode=haResourceActiveNode, projectEntry=projectEntry, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, aclMigrationStarted=aclMigrationStarted, poolProjectCount=poolProjectCount, controllerHardwareModel=controllerHardwareModel, haResourceEntry=haResourceEntry, diskTotalReadMbps=diskTotalReadMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, notificationObjects=notificationObjects, poolUsedSizeHigh=poolUsedSizeHigh, lunDataSizeHigh=lunDataSizeHigh, poolImported=poolImported, cifsTotalReadIops=cifsTotalReadIops, fcTargetEntry=fcTargetEntry, shareNFSWriteIops=shareNFSWriteIops, networkInterfaceUp=networkInterfaceUp, projectName=projectName, iscsiInitiatorGroup=iscsiInitiatorGroup, lunDataSizeLow=lunDataSizeLow, shareCIFSWriteMbps=shareCIFSWriteMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunCompressionEnabled=lunCompressionEnabled, fcInitiatorEntry=fcInitiatorEntry, fcPortOnline=fcPortOnline, volumeDeleteCompleted=volumeDeleteCompleted, basicCompliance=basicCompliance, maintenanceModeDisabled=maintenanceModeDisabled, snmpAgentVersion=snmpAgentVersion, shareTable=shareTable, projectThresholdExceedWarning=projectThresholdExceedWarning, poolProjects=poolProjects, sharePoolName=sharePoolName, notificationTargetEntityName=notificationTargetEntityName, diskState=diskState, shareCompressedRatio=shareCompressedRatio, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolTotalReadIops=poolTotalReadIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectCompressionEnabled=projectCompressionEnabled, poolOwnerController=poolOwnerController, aclMigrationCompleted=aclMigrationCompleted, projectFreeSizeHigh=projectFreeSizeHigh, nfsTotalWriteIops=nfsTotalWriteIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, snapshotCloningFailed=snapshotCloningFailed, fcInitiators=fcInitiators, diskDataWriteIops=diskDataWriteIops, lunSnapshotSizeLow=lunSnapshotSizeLow, lunIndex=lunIndex, poolMetaWriteIops=poolMetaWriteIops, upgradeTimeout=upgradeTimeout, diskError=diskError, lunWriteMbps=lunWriteMbps, lunEntry=lunEntry, shareCIFSEnabled=shareCIFSEnabled, tegile=tegile, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, shareCIFSWriteLatency=shareCIFSWriteLatency, projectIndex=projectIndex, netbiosSocketFailure=netbiosSocketFailure, poolEntry=poolEntry, poolCreated=poolCreated, ntpServerTimeDrift=ntpServerTimeDrift, diskDataReadIops=diskDataReadIops, shareMountPoint=shareMountPoint, nvdimmFailInitializationError=nvdimmFailInitializationError, nicReceiveMbps=nicReceiveMbps, diskDataWriteMbps=diskDataWriteMbps, projectDedupEnabled=projectDedupEnabled, poolMetaReadIops=poolMetaReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareQuotaLow=shareQuotaLow, lunReadIops=lunReadIops, cpuSystemCalls=cpuSystemCalls, tegileArray=tegileArray, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, cacheTotalWriteMbps=cacheTotalWriteMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiTargetEntry=iscsiTargetEntry, fcTargetIndex=fcTargetIndex, iscsiInitiatorsTable=iscsiInitiatorsTable, projectLunCount=projectLunCount, iscsiTargetReadMbps=iscsiTargetReadMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectTable=projectTable, fcTargetReadLatency=fcTargetReadLatency, poolTotalWriteMbps=poolTotalWriteMbps, diskAlias=diskAlias, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolDeletionFailed=poolDeletionFailed, notificationSeverity=notificationSeverity, diskTable=diskTable, diskTotalReadIops=diskTotalReadIops, nicTransmitMbps=nicTransmitMbps, projectLUNs=projectLUNs, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunGUID=lunGUID, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolUsedSizeLow=poolUsedSizeLow, poolWriteCacheWriteIops=poolWriteCacheWriteIops, smisServiceStarted=smisServiceStarted, projectFreeSizeLow=projectFreeSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, haControllerA_Name=haControllerA_Name, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunReadLatency=lunReadLatency, shareCompressionEnabled=shareCompressionEnabled, iscsiTargetGroupError=iscsiTargetGroupError, diskTotalWriteIops=diskTotalWriteIops, diskPoolName=diskPoolName, lunBlockSize=lunBlockSize, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, targetGroupMemberAdded=targetGroupMemberAdded, replicationAborted=replicationAborted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, networkTotalReceiveMbps=networkTotalReceiveMbps, diskSizeHigh=diskSizeHigh, lunReservedSizeLow=lunReservedSizeLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, volumeModifyCompleted=volumeModifyCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, lunProtocol=lunProtocol, shareNFSEnabled=shareNFSEnabled, snapshotCloneCompleted=snapshotCloneCompleted, diskType=diskType, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolTotalWriteIops=poolTotalWriteIops, iscsiTotalReadIops=iscsiTotalReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, poolSizeLow=poolSizeLow, haResourceDescription=haResourceDescription, shareNFSWriteMbps=shareNFSWriteMbps, notificationTime=notificationTime, iscsiWriteIops=iscsiWriteIops, notificationEventCode=notificationEventCode, fcTotalReadIops=fcTotalReadIops, notificationSensorAction=notificationSensorAction, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, cacheTotalReadMbps=cacheTotalReadMbps, controllerUp=controllerUp, cifsAvgReadLatency=cifsAvgReadLatency, cifsTotalReadMbps=cifsTotalReadMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, ipmiMemory=ipmiMemory, replicationPaused=replicationPaused, fcTargets=fcTargets, haResourcesTable=haResourcesTable, poolSizeHigh=poolSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareCIFSReadLatency=shareCIFSReadLatency, tdpsUpgradeFailed=tdpsUpgradeFailed, projectSnapshotSizeHigh=projectSnapshotSizeHigh)
