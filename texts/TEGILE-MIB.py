...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:08:57 2022
...
Integer32, Unsigned32, Bits, Counter32, ModuleIdentity, NotificationType, Gauge32, IpAddress, TimeTicks, ObjectIdentity, iso, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Bits", "Counter32", "ModuleIdentity", "NotificationType", "Gauge32", "IpAddress", "TimeTicks", "ObjectIdentity", "iso", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("TEGILE-MIB", aclMigrationCompleted=aclMigrationCompleted, network=network, upgradeStarted=upgradeStarted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, nfsTotalReadIops=nfsTotalReadIops, diskTotalWriteIops=diskTotalWriteIops, poolState=poolState, sanProperties=sanProperties, poolMetaReadMbps=poolMetaReadMbps, properties=properties, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, shareEntry=shareEntry, notificationSensorAction=notificationSensorAction, projectCompressionEnabled=projectCompressionEnabled, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, tdpsUpgradeTimeout=tdpsUpgradeTimeout, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, snmpServiceStopFailed=snmpServiceStopFailed, ipmiVoltage=ipmiVoltage, cifsAvgWriteLatency=cifsAvgWriteLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, snapshotCreationFailed=snapshotCreationFailed, fcInitiators=fcInitiators, currentObjectGroup=currentObjectGroup, poolUpgraded=poolUpgraded, iscsiTargets=iscsiTargets, snmpServiceStarted=snmpServiceStarted, poolTable=poolTable, shareName=shareName, fcTargetWriteMbps=fcTargetWriteMbps, controllerTimeDrift=controllerTimeDrift, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, cifsTotalWriteMbps=cifsTotalWriteMbps, tegileArray=tegileArray, haResourceActiveNode=haResourceActiveNode, iscsiTargetAlias=iscsiTargetAlias, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcPortOffline=fcPortOffline, poolDataReadMbps=poolDataReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiInitiatorName=iscsiInitiatorName, nfsTotalWriteIops=nfsTotalWriteIops, poolProjects=poolProjects, poolDataSizeLow=poolDataSizeLow, fcAvgWriteLatency=fcAvgWriteLatency, shareQuotaFinished=shareQuotaFinished, shareSnapshotSizeLow=shareSnapshotSizeLow, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, replicationStarted=replicationStarted, shareNFSWriteLatency=shareNFSWriteLatency, shareNFSWriteIops=shareNFSWriteIops, haResourceIndex=haResourceIndex, shareNFSReadIops=shareNFSReadIops, diskTotalReadIops=diskTotalReadIops, fcTargetsTable=fcTargetsTable, notificationTime=notificationTime, poolUsedSizeLow=poolUsedSizeLow, notificationSeverity=notificationSeverity, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, replicationSourceRegistered=replicationSourceRegistered, shareCompressedRatio=shareCompressedRatio, nfsAvgReadLatency=nfsAvgReadLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, haControllerA_Uptime=haControllerA_Uptime, tdpsUpgradeFailed=tdpsUpgradeFailed, diskTable=diskTable, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolTotalReadIops=poolTotalReadIops, memoryFailure=memoryFailure, projectQuotaSizeLow=projectQuotaSizeLow, userLoginFailed=userLoginFailed, lunTable=lunTable, smisServiceStartFailed=smisServiceStartFailed, snapshotDeleteFailed=snapshotDeleteFailed, cpuTotalUsage=cpuTotalUsage, cifsTotalWriteIops=cifsTotalWriteIops, nvdimmFailSoftError=nvdimmFailSoftError, poolSizeHigh=poolSizeHigh, projectFreeSizeLow=projectFreeSizeLow, haResourceName=haResourceName, diagnosticDataUploaded=diagnosticDataUploaded, shareMountPoint=shareMountPoint, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, lunReadLatency=lunReadLatency, diskSizeHigh=diskSizeHigh, poolTotalSaving=poolTotalSaving, nfsTotalWriteMbps=nfsTotalWriteMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcAvgReadLatency=fcAvgReadLatency, iscsiInitiators=iscsiInitiators, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, projectShareCount=projectShareCount, projectSnapshotSizeLow=projectSnapshotSizeLow, sharePoolName=sharePoolName, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectModified=projectModified, unknownSensorEvent=unknownSensorEvent, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, volumeDeleteFailed=volumeDeleteFailed, controllerDown=controllerDown, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskDataWriteIops=diskDataWriteIops, diskDataReadIops=diskDataReadIops, fcTargetWriteLatency=fcTargetWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunIndex=lunIndex, ipmiCriticalInterrupt=ipmiCriticalInterrupt, fcInitiatorName=fcInitiatorName, projectPoolName=projectPoolName, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiTotalReadIops=iscsiTotalReadIops, nicTransmitMbps=nicTransmitMbps, iscsiTargetError=iscsiTargetError, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diskSequentialIOCount=diskSequentialIOCount, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskPoolName=diskPoolName, snmpAgentVersion=snmpAgentVersion, projectLUNs=projectLUNs, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolTotalReadMbps=poolTotalReadMbps, shareQuotaHigh=shareQuotaHigh, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, notifications=notifications, notificationObjects=notificationObjects, poolDataWriteIops=poolDataWriteIops, adServerTimeDrift=adServerTimeDrift, poolAvgReadLatency=poolAvgReadLatency, diskState=diskState, smbSocketFailure=smbSocketFailure, networkIpmpGroupUp=networkIpmpGroupUp, ipmiTemperature=ipmiTemperature, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, haResourceStatus=haResourceStatus, nicGroup=nicGroup, notificationThresholdTriggerValue=notificationThresholdTriggerValue, snapshotRollbackCompleted=snapshotRollbackCompleted, cifsAvgReadLatency=cifsAvgReadLatency, controllerHardwareModel=controllerHardwareModel, poolTotalWriteIops=poolTotalWriteIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, poolDataReadLatency=poolDataReadLatency, ipmiOther=ipmiOther, shareDeletionFailed=shareDeletionFailed, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, nvdimmFailDeviceError=nvdimmFailDeviceError, nvdimmFailUnknownError=nvdimmFailUnknownError, fcTargetWriteIops=fcTargetWriteIops, diskAvgReadLatency=diskAvgReadLatency, PYSNMP_MODULE_ID=tegile, snmpServiceStartFailed=snmpServiceStartFailed, globalStatistics=globalStatistics, fcTotalReadMbps=fcTotalReadMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, tegile=tegile, notificationSensorNumber=notificationSensorNumber, nicTable=nicTable, iscsiTargetIndex=iscsiTargetIndex, diskEntry=diskEntry, poolCount=poolCount, iscsiTargetReadMbps=iscsiTargetReadMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, currentNotificationGroup=currentNotificationGroup, projectIndex=projectIndex, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolMetaWriteLatency=poolMetaWriteLatency, upgradeCompleted=upgradeCompleted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, diskIsOnline=diskIsOnline, lunReservedSizeLow=lunReservedSizeLow, notificationDescription=notificationDescription, haControllerB_Name=haControllerB_Name, haControllerB_IPAddr=haControllerB_IPAddr, fcTargetEntry=fcTargetEntry, lunWriteMbps=lunWriteMbps, shareDeleted=shareDeleted, deleteFolderFailed=deleteFolderFailed, fcTargetReadMbps=fcTargetReadMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, poolDeleted=poolDeleted, iscsiTargetReadLatency=iscsiTargetReadLatency, cacheTotalReadIops=cacheTotalReadIops, tegileGroups=tegileGroups, cacheTotalWriteMbps=cacheTotalWriteMbps, notificationEventCode=notificationEventCode, haResourcesTable=haResourcesTable, lunCompressionEnabled=lunCompressionEnabled, fcPortOnline=fcPortOnline, smisServiceStopped=smisServiceStopped, projectShares=projectShares, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, diskSlowIo=diskSlowIo, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, fcTargetGroup=fcTargetGroup, poolReadCacheWriteLatency=poolReadCacheWriteLatency, cpuSystemCalls=cpuSystemCalls, spareDiskReplaced=spareDiskReplaced, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunDedupEnabled=lunDedupEnabled, projectDataSizeLow=projectDataSizeLow, ipmiPowerSupply=ipmiPowerSupply, lunReservedSizeHigh=lunReservedSizeHigh, disks=disks, poolSizeLow=poolSizeLow, cifsTotalReadIops=cifsTotalReadIops, lunReadIops=lunReadIops, shareNFSEnabled=shareNFSEnabled, poolMetaWriteMbps=poolMetaWriteMbps, notificationReadingUnit=notificationReadingUnit, diskGoneOffline=diskGoneOffline, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, snapshotCloningFailed=snapshotCloningFailed, iscsiTargetName=iscsiTargetName, networkInterfaceDown=networkInterfaceDown, projectDedupEnabled=projectDedupEnabled, poolHealth=poolHealth, poolMetaReadIops=poolMetaReadIops, networkInterfaceUp=networkInterfaceUp, projectQuotaFinished=projectQuotaFinished, lunSnapshotSizeLow=lunSnapshotSizeLow, nicName=nicName, fcTotalReadIops=fcTotalReadIops, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, ipmiThreshold=ipmiThreshold, lunPoolName=lunPoolName, diskCount=diskCount, fcTargets=fcTargets, poolFreeSizeHigh=poolFreeSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolOwnerController=poolOwnerController, fcTargetStatus=fcTargetStatus, targetGroupMemberAdded=targetGroupMemberAdded, iscsiProperties=iscsiProperties, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareTable=shareTable, volumeCreatedSuccessfully=volumeCreatedSuccessfully, networkIpmpGroupDown=networkIpmpGroupDown, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectQuotaSizeHigh=projectQuotaSizeHigh, maintenanceModeEnabled=maintenanceModeEnabled, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually)
mibBuilder.exportSymbols("TEGILE-MIB", shareReservedSizeHigh=shareReservedSizeHigh, fcProperties=fcProperties, poolDegraded=poolDegraded, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolReadCacheReadLatency=poolReadCacheReadLatency, sensorFailureEvent=sensorFailureEvent, lunFreeSizeHigh=lunFreeSizeHigh, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskAlias=diskAlias, tegileCompliances=tegileCompliances, fcInitiatorCreateFailed=fcInitiatorCreateFailed, shareSnapshotSizeHigh=shareSnapshotSizeHigh, replicationPaused=replicationPaused, volumeDeleteCompleted=volumeDeleteCompleted, poolProjectCount=poolProjectCount, cacheTotalWriteIops=cacheTotalWriteIops, lunName=lunName, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, upgradeTimeout=upgradeTimeout, lunTargetGroup=lunTargetGroup, haControllerB_Uptime=haControllerB_Uptime, iscsiInitiatorGroup=iscsiInitiatorGroup, shareDataSizeHigh=shareDataSizeHigh, iscsiTargetGroup=iscsiTargetGroup, fcTotalWriteMbps=fcTotalWriteMbps, iscsiWriteIops=iscsiWriteIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcInitiatorEntry=fcInitiatorEntry, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, fcInitiatorGroup=fcInitiatorGroup, diskAvgWriteLatency=diskAvgWriteLatency, lunFreeSizeLow=lunFreeSizeLow, haControllerA_IPAddr=haControllerA_IPAddr, diskDataWriteMbps=diskDataWriteMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareNFSReadLatency=shareNFSReadLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, cacheSSDReads=cacheSSDReads, shareDataSizeLow=shareDataSizeLow, lunGUID=lunGUID, diskType=diskType, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastores=vmwareNFSDatastores, projectDataSizeHigh=projectDataSizeHigh, replicationAbandoned=replicationAbandoned, networkTotalReceiveMbps=networkTotalReceiveMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, cacheTotalReadMbps=cacheTotalReadMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, haResources=haResources, haResourceEntry=haResourceEntry, shareNFSReadMbps=shareNFSReadMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, shareCompressionEnabled=shareCompressionEnabled, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, notificationSensorSuspect=notificationSensorSuspect, snmpServiceStopped=snmpServiceStopped, shareCIFSWriteMbps=shareCIFSWriteMbps, haResourceGroup=haResourceGroup, shareNFSWriteMbps=shareNFSWriteMbps, shareCIFSReadIops=shareCIFSReadIops, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskChassisIdx=diskChassisIdx, iscsiTargetAuth=iscsiTargetAuth, iscsiInitiatorsTable=iscsiInitiatorsTable, aclMigrationStarted=aclMigrationStarted, ipmiCurrent=ipmiCurrent, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, iscsiTargetWriteIops=iscsiTargetWriteIops, deleteFolderCompleted=deleteFolderCompleted, cifsTotalReadMbps=cifsTotalReadMbps, nicState=nicState, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareCIFSWriteLatency=shareCIFSWriteLatency, notificationProps=notificationProps, haResourceDescription=haResourceDescription, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiInitiatorIndex=iscsiInitiatorIndex, lunProjectName=lunProjectName, poolImported=poolImported, poolTotalWriteMbps=poolTotalWriteMbps, shareCIFSReadLatency=shareCIFSReadLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, diskSizeLow=diskSizeLow, poolDataReadIops=poolDataReadIops, projectEntry=projectEntry, tegileConformance=tegileConformance, shareQuotaLow=shareQuotaLow, poolFreeSizeLow=poolFreeSizeLow, iscsiAvgWriteLatency=iscsiAvgWriteLatency, upgradeFailed=upgradeFailed, controllerUp=controllerUp, snapshotCloneCompleted=snapshotCloneCompleted, alertsCleanupCompleted=alertsCleanupCompleted, nicEntry=nicEntry, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, snapshotRollbackFailed=snapshotRollbackFailed, projectFreeSizeHigh=projectFreeSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, cacheRAMReads=cacheRAMReads, lunBlockSize=lunBlockSize, shareReservedSizeLow=shareReservedSizeLow, replicationTargetDeleted=replicationTargetDeleted, iscsiTargetsTable=iscsiTargetsTable, smisServiceStarted=smisServiceStarted, lunSizeLow=lunSizeLow, poolCreated=poolCreated, shareCIFSEnabled=shareCIFSEnabled, poolDataSizeHigh=poolDataSizeHigh, replicationResumed=replicationResumed, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, diskTotalWriteMbps=diskTotalWriteMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, diskIOCount=diskIOCount, tegileArray_notifications=tegileArray_notifications, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTargetGroupError=iscsiTargetGroupError, lunWriteIops=lunWriteIops, fcTotalWriteIops=fcTotalWriteIops, poolDeletionFailed=poolDeletionFailed, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolQuotaFinished=poolQuotaFinished, diskDataReadMbps=diskDataReadMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunDataSizeHigh=lunDataSizeHigh, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcTargetModifyCompleted=fcTargetModifyCompleted, cpuInterrupts=cpuInterrupts, iscsiTargetEntry=iscsiTargetEntry, ntpServerTimeDrift=ntpServerTimeDrift, lunReadMbps=lunReadMbps, diskIndex=diskIndex, diskError=diskError, fcTargetName=fcTargetName, lunEntry=lunEntry, poolMetaWriteIops=poolMetaWriteIops, fcTargetIndex=fcTargetIndex, fcInitiatorsTable=fcInitiatorsTable, smisServiceStopFailed=smisServiceStopFailed, ipmiFan=ipmiFan, basicCompliance=basicCompliance, shareCIFSWriteIops=shareCIFSWriteIops, poolAvgWriteLatency=poolAvgWriteLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, nfsTotalReadMbps=nfsTotalReadMbps, maintenanceModeDisabled=maintenanceModeDisabled, fcTargetReadIops=fcTargetReadIops, poolIndex=poolIndex, poolEntry=poolEntry, poolUsedSizeHigh=poolUsedSizeHigh, notificationComponentName=notificationComponentName, replicationComplete=replicationComplete, notificationTargetEntityName=notificationTargetEntityName, tdpsUpgradeCompleted=tdpsUpgradeCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolMetaReadLatency=poolMetaReadLatency, netbiosSocketFailure=netbiosSocketFailure, poolReadCacheReadIops=poolReadCacheReadIops, lunDataSizeLow=lunDataSizeLow, lunSizeHigh=lunSizeHigh, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareIndex=shareIndex, ipmiMemory=ipmiMemory, iscsiInitiatorEntry=iscsiInitiatorEntry, replicationAborted=replicationAborted, lunProtocol=lunProtocol, diskTotalReadMbps=diskTotalReadMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, volumeModifyCompleted=volumeModifyCompleted, nicReceiveMbps=nicReceiveMbps, testNotification=testNotification, poolDataWriteMbps=poolDataWriteMbps, replicationFailed=replicationFailed, poolExported=poolExported, nvdimmFailInitializationError=nvdimmFailInitializationError, lunInitiatorGroup=lunInitiatorGroup, projectDeletionFailed=projectDeletionFailed, projectDeleted=projectDeleted, projectName=projectName, nicIndex=nicIndex, shareProjectName=shareProjectName, lunCompressedRatio=lunCompressedRatio, poolName=poolName, nicMTU=nicMTU, poolDataWriteLatency=poolDataWriteLatency, poolExpanded=poolExpanded, fcInitiatorIndex=fcInitiatorIndex, fcTargetReadLatency=fcTargetReadLatency, projectLunCount=projectLunCount, shareDedupEnabled=shareDedupEnabled, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, upgradeDownloadFailed=upgradeDownloadFailed, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectTable=projectTable, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectTotalSaving=projectTotalSaving, volumeQuotaFinished=volumeQuotaFinished, targetGroupMemberRemoved=targetGroupMemberRemoved, lunWriteLatency=lunWriteLatency, upgradeDownloadStarted=upgradeDownloadStarted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, haControllerA_Name=haControllerA_Name, pools=pools)
