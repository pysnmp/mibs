...
TimeTicks, MibIdentifier, Gauge32, Unsigned32, Counter64, NotificationType, iso, Integer32, IpAddress, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Gauge32", "Unsigned32", "Counter64", "NotificationType", "iso", "Integer32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", controllerDown=controllerDown, upgradeDownloadFailed=upgradeDownloadFailed, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareCreatedSuccessfully=shareCreatedSuccessfully, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskDataReadIops=diskDataReadIops, poolReadCacheReadLatency=poolReadCacheReadLatency, lunWriteMbps=lunWriteMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, alertsCleanupCompleted=alertsCleanupCompleted, fcTargetsTable=fcTargetsTable, fcInitiators=fcInitiators, lunGUID=lunGUID, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, adServerTimeDrift=adServerTimeDrift, nicName=nicName, sharePoolName=sharePoolName, cacheTotalReadIops=cacheTotalReadIops, cacheTotalWriteMbps=cacheTotalWriteMbps, poolDeleted=poolDeleted, networkIpmpGroupUp=networkIpmpGroupUp, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolUsedSizeLow=poolUsedSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, volumeDeleteCompleted=volumeDeleteCompleted, snmpServiceStopped=snmpServiceStopped, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolTotalWriteIops=poolTotalWriteIops, controllerTimeDrift=controllerTimeDrift, lunProtocol=lunProtocol, nicEntry=nicEntry, cacheTotalWriteIops=cacheTotalWriteIops, diskAlias=diskAlias, iscsiProperties=iscsiProperties, ntpServerTimeDrift=ntpServerTimeDrift, shareDataSizeHigh=shareDataSizeHigh, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, deleteFolderCompleted=deleteFolderCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectQuotaSizeHigh=projectQuotaSizeHigh, lunTable=lunTable, diskIsOnline=diskIsOnline, haResourcesTable=haResourcesTable, poolReadCacheReadIops=poolReadCacheReadIops, cpuTotalUsage=cpuTotalUsage, poolAvgWriteLatency=poolAvgWriteLatency, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareCIFSReadIops=shareCIFSReadIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, networkTotalTransmitMbps=networkTotalTransmitMbps, ipmiMemory=ipmiMemory, lunTargetGroup=lunTargetGroup, fcTargetModifyCompleted=fcTargetModifyCompleted, upgradeStarted=upgradeStarted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, replicationResumed=replicationResumed, tegileArray_notifications=tegileArray_notifications, shareEntry=shareEntry, smisServiceStarted=smisServiceStarted, lunDataSizeLow=lunDataSizeLow, fcPortOffline=fcPortOffline, haResourceActiveNode=haResourceActiveNode, poolMetaReadLatency=poolMetaReadLatency, lunSizeLow=lunSizeLow, poolMetaWriteMbps=poolMetaWriteMbps, poolExported=poolExported, shareName=shareName, ipmiCurrent=ipmiCurrent, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, notificationDescription=notificationDescription, poolTable=poolTable, fcTargetReadIops=fcTargetReadIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, haControllerB_IPAddr=haControllerB_IPAddr, diskAvgReadLatency=diskAvgReadLatency, diskType=diskType, nicTable=nicTable, diskAvgWriteLatency=diskAvgWriteLatency, lunWriteIops=lunWriteIops, snapshotDeleteFailed=snapshotDeleteFailed, diskSizeHigh=diskSizeHigh, notificationSensorNumber=notificationSensorNumber, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolMetaWriteLatency=poolMetaWriteLatency, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareNFSReadIops=shareNFSReadIops, poolUsedSizeHigh=poolUsedSizeHigh, diskState=diskState, nicTransmitMbps=nicTransmitMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, cifsTotalWriteIops=cifsTotalWriteIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, diskTotalReadIops=diskTotalReadIops, volumeDeleteFailed=volumeDeleteFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, targetGroupMemberAdded=targetGroupMemberAdded, poolUpgraded=poolUpgraded, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, replicationAborted=replicationAborted, maintenanceModeEnabled=maintenanceModeEnabled, sensorFailureEvent=sensorFailureEvent, ipmiThreshold=ipmiThreshold, iscsiTotalReadMbps=iscsiTotalReadMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, networkInterfaceUp=networkInterfaceUp, notificationComponentName=notificationComponentName, haControllerA_Name=haControllerA_Name, deleteFolderFailed=deleteFolderFailed, projectLUNs=projectLUNs, initiatorGroupMemberAdded=initiatorGroupMemberAdded, testNotification=testNotification, diskEntry=diskEntry, smisServiceStopped=smisServiceStopped, diskTotalReadMbps=diskTotalReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, shareCIFSReadMbps=shareCIFSReadMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiTargetGroupError=iscsiTargetGroupError, poolTotalSaving=poolTotalSaving, iscsiTotalWriteMbps=iscsiTotalWriteMbps, projectQuotaFinished=projectQuotaFinished, fcTargetGroup=fcTargetGroup, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiInitiatorGroup=iscsiInitiatorGroup, diskTable=diskTable, replicationSourceRegistered=replicationSourceRegistered, shareNFSWriteLatency=shareNFSWriteLatency, lunCompressionEnabled=lunCompressionEnabled, haResourceEntry=haResourceEntry, poolQuotaFinished=poolQuotaFinished, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, controllerHardwareModel=controllerHardwareModel, notificationObjects=notificationObjects, lunSnapshotSizeLow=lunSnapshotSizeLow, memoryFailure=memoryFailure, shareCIFSEnabled=shareCIFSEnabled, fcInitiatorsTable=fcInitiatorsTable, projectShares=projectShares, poolDataReadIops=poolDataReadIops, shareQuotaFinished=shareQuotaFinished, shareDeletionFailed=shareDeletionFailed, iscsiTargetError=iscsiTargetError, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, volumeQuotaFinished=volumeQuotaFinished, replicationComplete=replicationComplete, haControllerB_Name=haControllerB_Name, projectTotalSaving=projectTotalSaving, fcProperties=fcProperties, cpuSystemCalls=cpuSystemCalls, tegile=tegile, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolDataWriteLatency=poolDataWriteLatency, lunPoolName=lunPoolName, projectDeletionFailed=projectDeletionFailed, diskSizeLow=diskSizeLow, diskError=diskError, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolCreated=poolCreated, diskDataWriteMbps=diskDataWriteMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, networkTotalReceiveMbps=networkTotalReceiveMbps, lunReadMbps=lunReadMbps, diskSequentialIOCount=diskSequentialIOCount, fcTargetWriteIops=fcTargetWriteIops, notificationEventCode=notificationEventCode, fcInitiatorGroup=fcInitiatorGroup, poolSizeHigh=poolSizeHigh, fcTotalReadIops=fcTotalReadIops, targetGroupCreateCompleted=targetGroupCreateCompleted, poolDataSizeLow=poolDataSizeLow, poolMetaWriteIops=poolMetaWriteIops, projectModified=projectModified, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, nicReceiveMbps=nicReceiveMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, PYSNMP_MODULE_ID=tegile, shareCompressedRatio=shareCompressedRatio, ipmiTemperature=ipmiTemperature, ipmiCriticalInterrupt=ipmiCriticalInterrupt, lunReadIops=lunReadIops, fcInitiatorIndex=fcInitiatorIndex, nfsAvgReadLatency=nfsAvgReadLatency, nfsTotalReadMbps=nfsTotalReadMbps, poolOwnerController=poolOwnerController, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, smbSocketFailure=smbSocketFailure, lunReadLatency=lunReadLatency, tegileArray=tegileArray, shareCIFSWriteLatency=shareCIFSWriteLatency, currentObjectGroup=currentObjectGroup, properties=properties, notifications=notifications, upgradeFailed=upgradeFailed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, lunProjectName=lunProjectName, shareCIFSReadLatency=shareCIFSReadLatency, controllerUp=controllerUp, iscsiWriteIops=iscsiWriteIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, haResourceStatus=haResourceStatus, shareCIFSWriteIops=shareCIFSWriteIops, lunDedupEnabled=lunDedupEnabled, snapshotCreationFailed=snapshotCreationFailed, iscsiInitiators=iscsiInitiators, shareNFSWriteIops=shareNFSWriteIops, diskTotalWriteMbps=diskTotalWriteMbps, notificationSensorSuspect=notificationSensorSuspect, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcTotalWriteIops=fcTotalWriteIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, shareProjectName=shareProjectName, userLoginFailed=userLoginFailed, tegileCompliances=tegileCompliances, networkIpmpGroupDown=networkIpmpGroupDown, aclMigrationCompleted=aclMigrationCompleted, lunBlockSize=lunBlockSize, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, cifsTotalReadIops=cifsTotalReadIops, poolIndex=poolIndex, haResources=haResources, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolDataReadMbps=poolDataReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, haResourceGroup=haResourceGroup, projectCompressionEnabled=projectCompressionEnabled, projectLunCount=projectLunCount, projectDeleted=projectDeleted, currentNotificationGroup=currentNotificationGroup, poolName=poolName, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, projectQuotaSizeLow=projectQuotaSizeLow, projectDataSizeHigh=projectDataSizeHigh, shareDeleted=shareDeleted, poolHealth=poolHealth, iscsiTargetAuth=iscsiTargetAuth, snapshotRollbackCompleted=snapshotRollbackCompleted, poolProjects=poolProjects, poolMetaReadIops=poolMetaReadIops, fcTargetWriteLatency=fcTargetWriteLatency, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, replicationTargetDeleted=replicationTargetDeleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, upgradeDownloadCompleted=upgradeDownloadCompleted, projectShareCount=projectShareCount, replicationPaused=replicationPaused, networkInterfaceDown=networkInterfaceDown, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunDataSizeHigh=lunDataSizeHigh)
mibBuilder.exportSymbols("TEGILE-MIB", haControllerB_Uptime=haControllerB_Uptime, iscsiTotalReadIops=iscsiTotalReadIops, diskTotalWriteIops=diskTotalWriteIops, lunFreeSizeLow=lunFreeSizeLow, aclMigrationStarted=aclMigrationStarted, poolTotalWriteMbps=poolTotalWriteMbps, diskIOCount=diskIOCount, nicIndex=nicIndex, projectThresholdExceedWarning=projectThresholdExceedWarning, shareCIFSWriteMbps=shareCIFSWriteMbps, replicationStarted=replicationStarted, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiTargetAlias=iscsiTargetAlias, projectDedupEnabled=projectDedupEnabled, notificationTime=notificationTime, poolReadCacheWriteMbps=poolReadCacheWriteMbps, replicationFailed=replicationFailed, vmwareNFSDatastores=vmwareNFSDatastores, nfsAvgWriteLatency=nfsAvgWriteLatency, upgradeTimeout=upgradeTimeout, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, cifsTotalReadMbps=cifsTotalReadMbps, ipmiVoltage=ipmiVoltage, netbiosSocketFailure=netbiosSocketFailure, shareQuotaHigh=shareQuotaHigh, shareNFSReadMbps=shareNFSReadMbps, shareCompressionEnabled=shareCompressionEnabled, targetGroupMemberRemoved=targetGroupMemberRemoved, snapshotRollbackFailed=snapshotRollbackFailed, disks=disks, cacheTotalReadMbps=cacheTotalReadMbps, poolExpanded=poolExpanded, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolDataWriteIops=poolDataWriteIops, haControllerA_Uptime=haControllerA_Uptime, notificationProps=notificationProps, diskDataReadMbps=diskDataReadMbps, shareReservedSizeHigh=shareReservedSizeHigh, lunSizeHigh=lunSizeHigh, network=network, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, nfsTotalWriteMbps=nfsTotalWriteMbps, poolSizeLow=poolSizeLow, cpuInterrupts=cpuInterrupts, poolMetaReadMbps=poolMetaReadMbps, diskChassisIdx=diskChassisIdx, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolState=poolState, notificationThresholdTriggerValue=notificationThresholdTriggerValue, snmpAgentVersion=snmpAgentVersion, volumeModifyCompleted=volumeModifyCompleted, snmpServiceStarted=snmpServiceStarted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectPoolName=projectPoolName, shareDataSizeLow=shareDataSizeLow, notificationReadingUnit=notificationReadingUnit, cifsTotalWriteMbps=cifsTotalWriteMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, lunReservedSizeLow=lunReservedSizeLow, replicationAbandoned=replicationAbandoned, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiTargetEntry=iscsiTargetEntry, lunEntry=lunEntry, fcInitiatorEntry=fcInitiatorEntry, lunIndex=lunIndex, nicGroup=nicGroup, diskIndex=diskIndex, tdpsUpgradeTimeout=tdpsUpgradeTimeout, fcTargets=fcTargets, notificationSeverity=notificationSeverity, tdpsUpgradeFailed=tdpsUpgradeFailed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiTargetsTable=iscsiTargetsTable, pools=pools, fcTotalReadMbps=fcTotalReadMbps, shareNFSEnabled=shareNFSEnabled, diskCount=diskCount, shareIndex=shareIndex, shareDedupEnabled=shareDedupEnabled, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, nicState=nicState, shareQuotaLow=shareQuotaLow, fcInitiatorName=fcInitiatorName, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, ipmiPowerSupply=ipmiPowerSupply, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, fcTargetWriteMbps=fcTargetWriteMbps, tegileGroups=tegileGroups, projectDataSizeLow=projectDataSizeLow, iscsiTargetName=iscsiTargetName, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, nicMTU=nicMTU, smisServiceStartFailed=smisServiceStartFailed, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, snmpServiceStartFailed=snmpServiceStartFailed, nvdimmFailSoftError=nvdimmFailSoftError, poolAvgReadLatency=poolAvgReadLatency, iscsiTargetWriteMbps=iscsiTargetWriteMbps, nfsTotalWriteIops=nfsTotalWriteIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, haResourceDescription=haResourceDescription, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolDataSizeHigh=poolDataSizeHigh, upgradeCompleted=upgradeCompleted, sanProperties=sanProperties, shareNFSWriteMbps=shareNFSWriteMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolDeletionFailed=poolDeletionFailed, webdocsUpgradeFailed=webdocsUpgradeFailed, lunName=lunName, fcAvgWriteLatency=fcAvgWriteLatency, shareMountPoint=shareMountPoint, poolFreeSizeLow=poolFreeSizeLow, poolImported=poolImported, basicCompliance=basicCompliance, snapshotCloningFailed=snapshotCloningFailed, cifsAvgReadLatency=cifsAvgReadLatency, notificationTargetEntityName=notificationTargetEntityName, nvdimmFailUnknownError=nvdimmFailUnknownError, tegileConformance=tegileConformance, fcTargetIndex=fcTargetIndex, lunInitiatorGroup=lunInitiatorGroup, diskDataWriteIops=diskDataWriteIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, fcAvgReadLatency=fcAvgReadLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, poolDataWriteMbps=poolDataWriteMbps, ipmiFan=ipmiFan, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolProjectCount=poolProjectCount, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, cacheRAMReads=cacheRAMReads, cacheSSDReads=cacheSSDReads, poolDataReadLatency=poolDataReadLatency, shareTable=shareTable, spareDiskReplaced=spareDiskReplaced, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, smisServiceStopFailed=smisServiceStopFailed, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectTable=projectTable, maintenanceModeDisabled=maintenanceModeDisabled, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, fcTargetEntry=fcTargetEntry, diskGoneOffline=diskGoneOffline, lunFreeSizeHigh=lunFreeSizeHigh, iscsiTargetGroup=iscsiTargetGroup, poolCount=poolCount, poolFreeSizeHigh=poolFreeSizeHigh, shareNFSReadLatency=shareNFSReadLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiInitiatorIndex=iscsiInitiatorIndex, notificationReadingTriggerValue=notificationReadingTriggerValue, ipmiOther=ipmiOther, iscsiTargetIndex=iscsiTargetIndex, lunCompressedRatio=lunCompressedRatio, haResourceIndex=haResourceIndex, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiTargets=iscsiTargets, lunWriteLatency=lunWriteLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, iscsiTargetReadMbps=iscsiTargetReadMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, unknownSensorEvent=unknownSensorEvent, diskPoolName=diskPoolName, poolDegraded=poolDegraded, lunReservedSizeHigh=lunReservedSizeHigh, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, diagnosticDataUploaded=diagnosticDataUploaded, projectName=projectName, iscsiTargetReadIops=iscsiTargetReadIops, fcTargetReadMbps=fcTargetReadMbps, haControllerA_IPAddr=haControllerA_IPAddr, notificationSensorAction=notificationSensorAction, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, fcTargetName=fcTargetName, projectFreeSizeLow=projectFreeSizeLow, upgradeDownloadStarted=upgradeDownloadStarted, poolTotalReadMbps=poolTotalReadMbps, fcTargetStatus=fcTargetStatus, iscsiTargetWriteLatency=iscsiTargetWriteLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, projectIndex=projectIndex, poolTotalReadIops=poolTotalReadIops, snmpServiceStopFailed=snmpServiceStopFailed, iscsiInitiatorName=iscsiInitiatorName, iscsiAvgReadLatency=iscsiAvgReadLatency, fcPortOnline=fcPortOnline, globalStatistics=globalStatistics, fcTargetReadLatency=fcTargetReadLatency, shareReservedSizeLow=shareReservedSizeLow, nfsTotalReadIops=nfsTotalReadIops, poolEntry=poolEntry, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, snapshotCloneCompleted=snapshotCloneCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diskRandomIOCount=diskRandomIOCount, haResourceName=haResourceName, projectEntry=projectEntry, diskSlowIo=diskSlowIo)
