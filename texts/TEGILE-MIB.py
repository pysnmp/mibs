...
# Produced by pysmi-1.1.8 at Thu Sep 29 09:01:31 2022
...
IpAddress, Bits, Gauge32, Unsigned32, Counter64, NotificationType, iso, Integer32, MibIdentifier, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "Gauge32", "Unsigned32", "Counter64", "NotificationType", "iso", "Integer32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareNFSWriteIops=shareNFSWriteIops, diskRandomIOCount=diskRandomIOCount, shareCIFSWriteMbps=shareCIFSWriteMbps, ipmiPowerSupply=ipmiPowerSupply, shareCompressedRatio=shareCompressedRatio, networkTotalReceiveMbps=networkTotalReceiveMbps, lunBlockSize=lunBlockSize, diskDataReadMbps=diskDataReadMbps, tegileArray_notifications=tegileArray_notifications, poolReadCacheWriteIops=poolReadCacheWriteIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, networkIpmpGroupDown=networkIpmpGroupDown, lunGUID=lunGUID, fcTargets=fcTargets, fcTotalWriteMbps=fcTotalWriteMbps, shareNFSEnabled=shareNFSEnabled, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, haResourcesTable=haResourcesTable, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, fcTargetName=fcTargetName, vmwareNFSDatastores=vmwareNFSDatastores, replicationSourceRegistered=replicationSourceRegistered, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareQuotaLow=shareQuotaLow, shareReservedSizeHigh=shareReservedSizeHigh, poolMetaReadIops=poolMetaReadIops, notificationTargetEntityName=notificationTargetEntityName, fcTargetReadLatency=fcTargetReadLatency, maintenanceModeDisabled=maintenanceModeDisabled, lunWriteIops=lunWriteIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTargetGroupError=iscsiTargetGroupError, iscsiTargetGroup=iscsiTargetGroup, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, ipmiOther=ipmiOther, diskEntry=diskEntry, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, replicationAborted=replicationAborted, volumeDeleteFailed=volumeDeleteFailed, diskTotalWriteIops=diskTotalWriteIops, lunReadIops=lunReadIops, cacheTotalReadMbps=cacheTotalReadMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, diskAvgWriteLatency=diskAvgWriteLatency, cacheTotalWriteIops=cacheTotalWriteIops, projectQuotaSizeLow=projectQuotaSizeLow, projectEntry=projectEntry, poolDataReadMbps=poolDataReadMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, projectDataSizeLow=projectDataSizeLow, controllerTimeDrift=controllerTimeDrift, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diskGoneOffline=diskGoneOffline, spareDiskReplaced=spareDiskReplaced, diskSlowIo=diskSlowIo, shareCIFSReadIops=shareCIFSReadIops, upgradeDownloadStarted=upgradeDownloadStarted, lunProtocol=lunProtocol, shareNFSReadLatency=shareNFSReadLatency, diskIsOnline=diskIsOnline, projectModified=projectModified, tdpsUpgradeTimeout=tdpsUpgradeTimeout, nfsAvgWriteLatency=nfsAvgWriteLatency, shareTable=shareTable, diskDataWriteMbps=diskDataWriteMbps, notificationObjects=notificationObjects, fcTargetWriteMbps=fcTargetWriteMbps, shareQuotaFinished=shareQuotaFinished, cifsTotalReadMbps=cifsTotalReadMbps, nfsAvgReadLatency=nfsAvgReadLatency, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolSizeLow=poolSizeLow, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, projectIndex=projectIndex, haControllerA_Name=haControllerA_Name, poolSizeHigh=poolSizeHigh, diskSequentialIOCount=diskSequentialIOCount, diskCount=diskCount, poolDataReadIops=poolDataReadIops, shareCIFSReadLatency=shareCIFSReadLatency, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunReadMbps=lunReadMbps, projectPoolName=projectPoolName, nicState=nicState, poolState=poolState, fcTotalWriteIops=fcTotalWriteIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectSnapshotSizeLow=projectSnapshotSizeLow, haControllerA_IPAddr=haControllerA_IPAddr, tegileGroups=tegileGroups, haControllerB_Name=haControllerB_Name, projectFreeSizeHigh=projectFreeSizeHigh, projectCreatedSuccessfully=projectCreatedSuccessfully, lunSnapshotSizeHigh=lunSnapshotSizeHigh, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, cacheTotalWriteMbps=cacheTotalWriteMbps, unknownSensorEvent=unknownSensorEvent, basicCompliance=basicCompliance, iscsiImproperTargetGroup=iscsiImproperTargetGroup, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolMetaReadMbps=poolMetaReadMbps, diskIndex=diskIndex, fcInitiatorsTable=fcInitiatorsTable, projectDeleted=projectDeleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, cifsTotalReadIops=cifsTotalReadIops, network=network, ipmiThreshold=ipmiThreshold, nicName=nicName, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, notificationSensorSuspect=notificationSensorSuspect, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, poolProjects=poolProjects, shareDataSizeLow=shareDataSizeLow, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiInitiatorName=iscsiInitiatorName, poolTotalReadMbps=poolTotalReadMbps, iscsiTargetAlias=iscsiTargetAlias, projectQuotaFinished=projectQuotaFinished, smbSocketFailure=smbSocketFailure, lunSizeLow=lunSizeLow, lunDataSizeLow=lunDataSizeLow, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, diskType=diskType, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolCreated=poolCreated, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, webdocsUpgradeFailed=webdocsUpgradeFailed, haResourceName=haResourceName, cifsTotalWriteMbps=cifsTotalWriteMbps, fcTargetWriteLatency=fcTargetWriteLatency, lunName=lunName, lunFreeSizeHigh=lunFreeSizeHigh, notifications=notifications, snapshotCreationFailed=snapshotCreationFailed, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, properties=properties, lunDedupEnabled=lunDedupEnabled, fcTargetIndex=fcTargetIndex, iscsiTargetAuth=iscsiTargetAuth, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diskChassisIdx=diskChassisIdx, snapshotRollbackCompleted=snapshotRollbackCompleted, fcTotalReadMbps=fcTotalReadMbps, shareMountPoint=shareMountPoint, lunProjectName=lunProjectName, aclMigrationCompleted=aclMigrationCompleted, fcTargetReadIops=fcTargetReadIops, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, notificationTime=notificationTime, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, snmpServiceStarted=snmpServiceStarted, iscsiTargets=iscsiTargets, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiInitiators=iscsiInitiators, lunIndex=lunIndex, smisServiceStarted=smisServiceStarted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, lunDataSizeHigh=lunDataSizeHigh, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, cacheTotalReadIops=cacheTotalReadIops, haControllerB_Uptime=haControllerB_Uptime, haControllerB_IPAddr=haControllerB_IPAddr, lunReservedSizeHigh=lunReservedSizeHigh, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, nvdimmFailSoftError=nvdimmFailSoftError, volumeModifyCompleted=volumeModifyCompleted, aclMigrationStarted=aclMigrationStarted, ntpServerTimeDrift=ntpServerTimeDrift, notificationEventCode=notificationEventCode, shareQuotaHigh=shareQuotaHigh, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, ipmiTemperature=ipmiTemperature, shareNFSWriteLatency=shareNFSWriteLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, cacheRAMReads=cacheRAMReads, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, iscsiTargetWriteIops=iscsiTargetWriteIops, lunReservedSizeLow=lunReservedSizeLow, iscsiWriteIops=iscsiWriteIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcInitiatorEntry=fcInitiatorEntry, shareNFSReadMbps=shareNFSReadMbps, poolWriteCacheWriteIops=poolWriteCacheWriteIops, notificationSensorNumber=notificationSensorNumber, intelliFlashSoftwareUp=intelliFlashSoftwareUp, targetGroupDeleteCompleted=targetGroupDeleteCompleted, diskTable=diskTable, iscsiProperties=iscsiProperties, shareNFSWriteMbps=shareNFSWriteMbps, smisServiceStopFailed=smisServiceStopFailed, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, notificationSeverity=notificationSeverity, fcProperties=fcProperties, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snapshotCloningFailed=snapshotCloningFailed, diskError=diskError, iscsiTargetReadIops=iscsiTargetReadIops, notificationProps=notificationProps, lunWriteLatency=lunWriteLatency, smisServiceStartFailed=smisServiceStartFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, nicEntry=nicEntry, ipmiFan=ipmiFan, iscsiTargetsTable=iscsiTargetsTable, snapshotDeleteFailed=snapshotDeleteFailed, projectShareCount=projectShareCount, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolFreeSizeLow=poolFreeSizeLow, iscsiTargetIndex=iscsiTargetIndex, nicIndex=nicIndex, volumeQuotaFinished=volumeQuotaFinished, networkTotalTransmitMbps=networkTotalTransmitMbps, poolReadCacheReadIops=poolReadCacheReadIops, haResourceGroup=haResourceGroup, projectQuotaSizeHigh=projectQuotaSizeHigh, snmpAgentVersion=snmpAgentVersion, poolTable=poolTable, nicReceiveMbps=nicReceiveMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, snapshotCloneCompleted=snapshotCloneCompleted, poolDataReadLatency=poolDataReadLatency, adServerTimeDrift=adServerTimeDrift, shareCIFSEnabled=shareCIFSEnabled, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, notificationReadingTriggerValue=notificationReadingTriggerValue, lunReadLatency=lunReadLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, testNotification=testNotification, haResourceDescription=haResourceDescription, fcPortOffline=fcPortOffline, projectTable=projectTable, cpuTotalUsage=cpuTotalUsage, targetGroupCreateCompleted=targetGroupCreateCompleted, replicationFailed=replicationFailed, lunWriteMbps=lunWriteMbps, notificationSensorAction=notificationSensorAction, diskPoolName=diskPoolName, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolOwnerController=poolOwnerController, deleteFolderCompleted=deleteFolderCompleted, projectTotalSaving=projectTotalSaving, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed)
mibBuilder.exportSymbols("TEGILE-MIB", shareDeleted=shareDeleted, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolExported=poolExported, upgradeFailed=upgradeFailed, poolDataWriteIops=poolDataWriteIops, networkInterfaceUp=networkInterfaceUp, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, disks=disks, projectName=projectName, iscsiTargetReadMbps=iscsiTargetReadMbps, diskAvgReadLatency=diskAvgReadLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, nicTransmitMbps=nicTransmitMbps, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, snapshotRollbackFailed=snapshotRollbackFailed, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolName=poolName, targetGroupMemberAdded=targetGroupMemberAdded, userLoginFailed=userLoginFailed, fcAvgWriteLatency=fcAvgWriteLatency, shareDataSizeHigh=shareDataSizeHigh, diskTotalReadMbps=diskTotalReadMbps, haControllerA_Uptime=haControllerA_Uptime, upgradeDownloadCompleted=upgradeDownloadCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolTotalWriteMbps=poolTotalWriteMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, globalStatistics=globalStatistics, ipmiCurrent=ipmiCurrent, lunTargetGroup=lunTargetGroup, poolMetaReadLatency=poolMetaReadLatency, shareProjectName=shareProjectName, snmpServiceStopFailed=snmpServiceStopFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, lunInitiatorGroup=lunInitiatorGroup, projectDeletionFailed=projectDeletionFailed, currentNotificationGroup=currentNotificationGroup, shareSnapshotSizeLow=shareSnapshotSizeLow, replicationStarted=replicationStarted, tegileArray=tegileArray, replicationAbandoned=replicationAbandoned, fcTargetStatus=fcTargetStatus, nicGroup=nicGroup, cifsTotalWriteIops=cifsTotalWriteIops, projectCompressionEnabled=projectCompressionEnabled, lunTable=lunTable, pools=pools, nvdimmFailInitializationError=nvdimmFailInitializationError, poolDataWriteMbps=poolDataWriteMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiTotalReadIops=iscsiTotalReadIops, fcInitiatorGroup=fcInitiatorGroup, poolIndex=poolIndex, haResourceStatus=haResourceStatus, replicationResumed=replicationResumed, tdpsUpgradeFailed=tdpsUpgradeFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, projectLUNs=projectLUNs, diskDataReadIops=diskDataReadIops, haResourceActiveNode=haResourceActiveNode, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, haResourceIndex=haResourceIndex, shareDedupEnabled=shareDedupEnabled, notificationReadingUnit=notificationReadingUnit, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, notificationDescription=notificationDescription, iscsiTargetEntry=iscsiTargetEntry, shareDeletionFailed=shareDeletionFailed, nfsTotalReadMbps=nfsTotalReadMbps, poolExpanded=poolExpanded, shareExceedThresholdWarning=shareExceedThresholdWarning, maintenanceModeEnabled=maintenanceModeEnabled, netbiosSocketFailure=netbiosSocketFailure, lunPoolName=lunPoolName, shareName=shareName, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcInitiatorIndex=fcInitiatorIndex, controllerUp=controllerUp, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectFreeSizeLow=projectFreeSizeLow, poolEntry=poolEntry, diskDataWriteIops=diskDataWriteIops, nfsTotalWriteIops=nfsTotalWriteIops, tegileCompliances=tegileCompliances, projectShares=projectShares, haResources=haResources, shareCompressionEnabled=shareCompressionEnabled, snmpServiceStopped=snmpServiceStopped, diskAlias=diskAlias, poolHealth=poolHealth, replicationComplete=replicationComplete, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, upgradeTimeout=upgradeTimeout, fcTargetModifyCompleted=fcTargetModifyCompleted, poolDataSizeHigh=poolDataSizeHigh, poolTotalReadIops=poolTotalReadIops, lunSizeHigh=lunSizeHigh, controllerDown=controllerDown, poolAvgWriteLatency=poolAvgWriteLatency, shareNFSReadIops=shareNFSReadIops, upgradeStarted=upgradeStarted, cacheSSDReads=cacheSSDReads, cifsAvgWriteLatency=cifsAvgWriteLatency, alertsCleanupCompleted=alertsCleanupCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunEntry=lunEntry, fcTargetsTable=fcTargetsTable, fcTargetEntry=fcTargetEntry, fcTargetWriteIops=fcTargetWriteIops, iscsiInitiatorGroup=iscsiInitiatorGroup, poolMetaWriteMbps=poolMetaWriteMbps, diagnosticDataUploaded=diagnosticDataUploaded, fcTotalReadIops=fcTotalReadIops, poolDataWriteLatency=poolDataWriteLatency, fcPortOnline=fcPortOnline, networkInterfaceDown=networkInterfaceDown, diskState=diskState, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolUsedSizeLow=poolUsedSizeLow, projectDedupEnabled=projectDedupEnabled, poolTotalSaving=poolTotalSaving, replicationPaused=replicationPaused, ipmiMemory=ipmiMemory, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, volumeDeleteCompleted=volumeDeleteCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diskSizeLow=diskSizeLow, poolReadCacheReadLatency=poolReadCacheReadLatency, PYSNMP_MODULE_ID=tegile, deleteFolderFailed=deleteFolderFailed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectDataSizeHigh=projectDataSizeHigh, projectSnapshotSizeHigh=projectSnapshotSizeHigh, nfsTotalWriteMbps=nfsTotalWriteMbps, shareReservedSizeLow=shareReservedSizeLow, diskTotalWriteMbps=diskTotalWriteMbps, tegileConformance=tegileConformance, poolReadCacheWriteLatency=poolReadCacheWriteLatency, smisServiceStopped=smisServiceStopped, intelliFlashSoftwareDown=intelliFlashSoftwareDown, nicMTU=nicMTU, iscsiTargetError=iscsiTargetError, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, memoryFailure=memoryFailure, projectThresholdExceedWarning=projectThresholdExceedWarning, cifsAvgReadLatency=cifsAvgReadLatency, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, ipmiVoltage=ipmiVoltage, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolDataSizeLow=poolDataSizeLow, sensorFailureEvent=sensorFailureEvent, poolUsedSizeHigh=poolUsedSizeHigh, fcAvgReadLatency=fcAvgReadLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, sharePoolName=sharePoolName, haResourceEntry=haResourceEntry, shareIndex=shareIndex, cpuInterrupts=cpuInterrupts, poolReadCacheReadMbps=poolReadCacheReadMbps, shareCIFSWriteIops=shareCIFSWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolDeleted=poolDeleted, shareEntry=shareEntry, replicationTargetDeleted=replicationTargetDeleted, poolQuotaFinished=poolQuotaFinished, diskIOCount=diskIOCount, poolMetaWriteLatency=poolMetaWriteLatency, diskTotalReadIops=diskTotalReadIops, fcTargetReadMbps=fcTargetReadMbps, nicTable=nicTable, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, networkIpmpGroupUp=networkIpmpGroupUp, poolImported=poolImported, fcTargetGroup=fcTargetGroup, poolAvgReadLatency=poolAvgReadLatency, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectLunCount=projectLunCount, poolMetaWriteIops=poolMetaWriteIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, tegile=tegile, fcInitiators=fcInitiators, nfsTotalReadIops=nfsTotalReadIops, poolTotalWriteIops=poolTotalWriteIops, snmpServiceStartFailed=snmpServiceStartFailed, poolProjectCount=poolProjectCount, iscsiTargetName=iscsiTargetName, upgradeDownloadFailed=upgradeDownloadFailed, upgradeCompleted=upgradeCompleted, poolFreeSizeHigh=poolFreeSizeHigh, poolUpgraded=poolUpgraded, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, fcInitiatorName=fcInitiatorName, sanProperties=sanProperties, iscsiInitiatorsTable=iscsiInitiatorsTable, controllerHardwareModel=controllerHardwareModel, poolDegraded=poolDegraded, notificationComponentName=notificationComponentName, lunCompressedRatio=lunCompressedRatio, shareCIFSReadMbps=shareCIFSReadMbps, lunFreeSizeLow=lunFreeSizeLow, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, iscsiInitiatorIndex=iscsiInitiatorIndex, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunCompressionEnabled=lunCompressionEnabled, cpuSystemCalls=cpuSystemCalls, diskSizeHigh=diskSizeHigh, poolDeletionFailed=poolDeletionFailed, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolCount=poolCount)
