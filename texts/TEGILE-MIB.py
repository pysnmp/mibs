...
Unsigned32, iso, IpAddress, Bits, NotificationType, Counter64, ModuleIdentity, ObjectIdentity, Gauge32, MibIdentifier, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "IpAddress", "Bits", "NotificationType", "Counter64", "ModuleIdentity", "ObjectIdentity", "Gauge32", "MibIdentifier", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", disks=disks, spareDiskReplaced=spareDiskReplaced, poolOwnerController=poolOwnerController, lunProjectName=lunProjectName, poolDataSizeHigh=poolDataSizeHigh, poolProjectCount=poolProjectCount, diskError=diskError, poolTotalWriteMbps=poolTotalWriteMbps, projectDeletionFailed=projectDeletionFailed, controllerTimeDrift=controllerTimeDrift, iscsiTargetReadMbps=iscsiTargetReadMbps, poolMetaWriteLatency=poolMetaWriteLatency, diskDataWriteIops=diskDataWriteIops, fcTargetGroup=fcTargetGroup, adServerTimeDrift=adServerTimeDrift, fcInitiatorIndex=fcInitiatorIndex, lunBlockSize=lunBlockSize, shareCreatedSuccessfully=shareCreatedSuccessfully, nvdimmFailSoftError=nvdimmFailSoftError, lunSizeLow=lunSizeLow, pools=pools, volumeModifyCompleted=volumeModifyCompleted, shareDataSizeLow=shareDataSizeLow, tegileConformance=tegileConformance, poolEntry=poolEntry, fcTargetWriteLatency=fcTargetWriteLatency, notificationSensorNumber=notificationSensorNumber, ipmiPowerSupply=ipmiPowerSupply, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiTargets=iscsiTargets, notificationReadingTriggerValue=notificationReadingTriggerValue, projectDeleted=projectDeleted, targetGroupMemberRemoved=targetGroupMemberRemoved, network=network, upgradeDownloadCompleted=upgradeDownloadCompleted, controllerDown=controllerDown, iscsiImproperTargetGroup=iscsiImproperTargetGroup, cacheSSDReads=cacheSSDReads, projectQuotaSizeLow=projectQuotaSizeLow, deleteFolderFailed=deleteFolderFailed, snmpServiceStopFailed=snmpServiceStopFailed, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiTargetIndex=iscsiTargetIndex, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareNFSWriteLatency=shareNFSWriteLatency, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolDataSizeLow=poolDataSizeLow, shareCIFSEnabled=shareCIFSEnabled, iscsiTargetWriteLatency=iscsiTargetWriteLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, diskType=diskType, shareQuotaFinished=shareQuotaFinished, poolMetaReadMbps=poolMetaReadMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, shareReservedSizeLow=shareReservedSizeLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, lunPoolName=lunPoolName, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolSizeHigh=poolSizeHigh, poolTable=poolTable, diskSizeLow=diskSizeLow, cpuInterrupts=cpuInterrupts, shareDataSizeHigh=shareDataSizeHigh, lunInitiatorGroup=lunInitiatorGroup, diskAvgReadLatency=diskAvgReadLatency, ipmiTemperature=ipmiTemperature, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, poolMetaReadLatency=poolMetaReadLatency, poolMetaReadIops=poolMetaReadIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolProjects=poolProjects, poolUsedSizeLow=poolUsedSizeLow, snmpServiceStartFailed=snmpServiceStartFailed, lunDataSizeHigh=lunDataSizeHigh, lunName=lunName, poolDataReadMbps=poolDataReadMbps, tegileGroups=tegileGroups, cacheTotalReadMbps=cacheTotalReadMbps, cacheTotalReadIops=cacheTotalReadIops, nvdimmFailUnknownError=nvdimmFailUnknownError, webdocsUpgradeFailed=webdocsUpgradeFailed, lunReadMbps=lunReadMbps, shareDeleted=shareDeleted, haControllerB_IPAddr=haControllerB_IPAddr, diskGoneOffline=diskGoneOffline, aclMigrationStarted=aclMigrationStarted, lunTargetGroup=lunTargetGroup, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, networkInterfaceDown=networkInterfaceDown, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareNFSReadMbps=shareNFSReadMbps, nicReceiveMbps=nicReceiveMbps, poolTotalWriteIops=poolTotalWriteIops, lunEntry=lunEntry, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareEntry=shareEntry, diskDataReadIops=diskDataReadIops, networkIpmpGroupDown=networkIpmpGroupDown, poolState=poolState, diskTotalWriteMbps=diskTotalWriteMbps, shareNFSWriteIops=shareNFSWriteIops, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolDegraded=poolDegraded, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcAvgWriteLatency=fcAvgWriteLatency, diskSequentialIOCount=diskSequentialIOCount, nfsTotalReadIops=nfsTotalReadIops, lunSizeHigh=lunSizeHigh, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, haResourceStatus=haResourceStatus, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiTargetError=iscsiTargetError, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, haControllerB_Uptime=haControllerB_Uptime, diskTotalWriteIops=diskTotalWriteIops, replicationStarted=replicationStarted, projectThresholdExceedWarning=projectThresholdExceedWarning, ipmiVoltage=ipmiVoltage, projectIndex=projectIndex, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareTable=shareTable, iscsiTargetGroup=iscsiTargetGroup, nicMTU=nicMTU, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, nicGroup=nicGroup, poolMetaWriteMbps=poolMetaWriteMbps, haResourceDescription=haResourceDescription, nicTransmitMbps=nicTransmitMbps, projectFreeSizeLow=projectFreeSizeLow, diskAvgWriteLatency=diskAvgWriteLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiTotalReadIops=iscsiTotalReadIops, iscsiTargetsTable=iscsiTargetsTable, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiWriteIops=iscsiWriteIops, tegileCompliances=tegileCompliances, controllerHardwareModel=controllerHardwareModel, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, basicCompliance=basicCompliance, smbSocketFailure=smbSocketFailure, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, fcTargetModifyCompleted=fcTargetModifyCompleted, notificationTargetEntityName=notificationTargetEntityName, diskIOCount=diskIOCount, iscsiTargetWriteIops=iscsiTargetWriteIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolImported=poolImported, lunIndex=lunIndex, sharePoolName=sharePoolName, poolExported=poolExported, diskPoolName=diskPoolName, properties=properties, fcTargetIndex=fcTargetIndex, poolExpanded=poolExpanded, cifsAvgWriteLatency=cifsAvgWriteLatency, notificationComponentName=notificationComponentName, snapshotCloningFailed=snapshotCloningFailed, poolDataReadLatency=poolDataReadLatency, shareCIFSReadLatency=shareCIFSReadLatency, replicationFailed=replicationFailed, replicationAborted=replicationAborted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareCompressedRatio=shareCompressedRatio, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, cacheTotalWriteMbps=cacheTotalWriteMbps, poolDataWriteLatency=poolDataWriteLatency, diskTotalReadIops=diskTotalReadIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, controllerUp=controllerUp, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareCompressionEnabled=shareCompressionEnabled, replicationAbandoned=replicationAbandoned, testNotification=testNotification, diskChassisIdx=diskChassisIdx, fcProperties=fcProperties, smisServiceStopped=smisServiceStopped, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, fcTargetReadIops=fcTargetReadIops, haResourceIndex=haResourceIndex, shareNFSReadLatency=shareNFSReadLatency, globalStatistics=globalStatistics, diagnosticDataUploaded=diagnosticDataUploaded, diskRandomIOCount=diskRandomIOCount, volumeQuotaFinished=volumeQuotaFinished, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectPoolName=projectPoolName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcInitiatorName=fcInitiatorName, diskSizeHigh=diskSizeHigh, notificationObjects=notificationObjects, shareName=shareName, volumeDeleteFailed=volumeDeleteFailed, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcTargetReadMbps=fcTargetReadMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, diskTotalReadMbps=diskTotalReadMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, tegileArray_notifications=tegileArray_notifications, shareQuotaHigh=shareQuotaHigh, unknownSensorEvent=unknownSensorEvent, nfsTotalWriteIops=nfsTotalWriteIops, haControllerA_IPAddr=haControllerA_IPAddr, fcTotalWriteMbps=fcTotalWriteMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, networkTotalTransmitMbps=networkTotalTransmitMbps, smisServiceStopFailed=smisServiceStopFailed, poolFreeSizeHigh=poolFreeSizeHigh, projectShares=projectShares, diskState=diskState, lunCompressedRatio=lunCompressedRatio, lunWriteLatency=lunWriteLatency, notificationSensorSuspect=notificationSensorSuspect, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiProperties=iscsiProperties, lunCompressionEnabled=lunCompressionEnabled, haResourceEntry=haResourceEntry, cpuSystemCalls=cpuSystemCalls, poolName=poolName, nfsAvgWriteLatency=nfsAvgWriteLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareNFSWriteMbps=shareNFSWriteMbps, snapshotDeleteFailed=snapshotDeleteFailed, upgradeStarted=upgradeStarted, shareNFSEnabled=shareNFSEnabled, cifsTotalReadIops=cifsTotalReadIops, snmpAgentVersion=snmpAgentVersion, lunReservedSizeLow=lunReservedSizeLow, projectSnapshotSizeLow=projectSnapshotSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, tegileArray=tegileArray, sensorFailureEvent=sensorFailureEvent, nvdimmFailDeviceError=nvdimmFailDeviceError, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, fcTargets=fcTargets, iscsiInitiatorName=iscsiInitiatorName, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, replicationTargetDeleted=replicationTargetDeleted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, snapshotRollbackCompleted=snapshotRollbackCompleted, fcInitiatorGroup=fcInitiatorGroup)
mibBuilder.exportSymbols("TEGILE-MIB", haControllerA_Uptime=haControllerA_Uptime, projectQuotaFinished=projectQuotaFinished, poolFreeSizeLow=poolFreeSizeLow, haControllerA_Name=haControllerA_Name, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectDataSizeHigh=projectDataSizeHigh, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, smisServiceStartFailed=smisServiceStartFailed, fcTargetWriteMbps=fcTargetWriteMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, notificationProps=notificationProps, poolDeletionFailed=poolDeletionFailed, lunReadLatency=lunReadLatency, lunTable=lunTable, haResourceGroup=haResourceGroup, shareQuotaLow=shareQuotaLow, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, networkTotalReceiveMbps=networkTotalReceiveMbps, fcInitiators=fcInitiators, fcPortOnline=fcPortOnline, shareMountPoint=shareMountPoint, projectCreatedSuccessfully=projectCreatedSuccessfully, projectName=projectName, poolReadCacheReadMbps=poolReadCacheReadMbps, snapshotRollbackFailed=snapshotRollbackFailed, cacheTotalWriteIops=cacheTotalWriteIops, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolReadCacheWriteLatency=poolReadCacheWriteLatency, nicEntry=nicEntry, snmpServiceStopped=snmpServiceStopped, ntpServerTimeDrift=ntpServerTimeDrift, notificationSensorAction=notificationSensorAction, webdocsUpgradeCompleted=webdocsUpgradeCompleted, projectTotalSaving=projectTotalSaving, projectSnapshotSizeHigh=projectSnapshotSizeHigh, diskEntry=diskEntry, nicName=nicName, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskCount=diskCount, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolUpgraded=poolUpgraded, iscsiInitiators=iscsiInitiators, poolCount=poolCount, shareDeletionFailed=shareDeletionFailed, haControllerB_Name=haControllerB_Name, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, projectShareCount=projectShareCount, lunFreeSizeHigh=lunFreeSizeHigh, tegile=tegile, shareProjectName=shareProjectName, diskIsOnline=diskIsOnline, projectModified=projectModified, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, replicationComplete=replicationComplete, poolCreated=poolCreated, iscsiTargetAlias=iscsiTargetAlias, tdpsUpgradeTimeout=tdpsUpgradeTimeout, nicIndex=nicIndex, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcTotalReadIops=fcTotalReadIops, poolDataWriteMbps=poolDataWriteMbps, poolTotalReadMbps=poolTotalReadMbps, iscsiTargetAuth=iscsiTargetAuth, maintenanceModeEnabled=maintenanceModeEnabled, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, deleteFolderCompleted=deleteFolderCompleted, upgradeTimeout=upgradeTimeout, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, lunProtocol=lunProtocol, lunGUID=lunGUID, iscsiTargetReadIops=iscsiTargetReadIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, networkIpmpGroupUp=networkIpmpGroupUp, fcTargetsTable=fcTargetsTable, alertsCleanupCompleted=alertsCleanupCompleted, poolReadCacheReadIops=poolReadCacheReadIops, poolDataWriteIops=poolDataWriteIops, iscsiTargetName=iscsiTargetName, diskDataWriteMbps=diskDataWriteMbps, vmwareNFSDatastores=vmwareNFSDatastores, haResourceName=haResourceName, notifications=notifications, snmpServiceStarted=snmpServiceStarted, lunDedupEnabled=lunDedupEnabled, cifsAvgReadLatency=cifsAvgReadLatency, fcTargetReadLatency=fcTargetReadLatency, memoryFailure=memoryFailure, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, diskTable=diskTable, shareReservedSizeHigh=shareReservedSizeHigh, iscsiInitiatorEntry=iscsiInitiatorEntry, shareDedupEnabled=shareDedupEnabled, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargetStatus=fcTargetStatus, poolAvgWriteLatency=poolAvgWriteLatency, projectLunCount=projectLunCount, volumeDeleteCompleted=volumeDeleteCompleted, cacheRAMReads=cacheRAMReads, shareCIFSReadMbps=shareCIFSReadMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, currentObjectGroup=currentObjectGroup, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, upgradeDownloadFailed=upgradeDownloadFailed, ipmiOther=ipmiOther, PYSNMP_MODULE_ID=tegile, notificationSeverity=notificationSeverity, diskIndex=diskIndex, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolTotalSaving=poolTotalSaving, projectEntry=projectEntry, lunReadIops=lunReadIops, diskAlias=diskAlias, poolSizeLow=poolSizeLow, lunWriteMbps=lunWriteMbps, notificationEventCode=notificationEventCode, upgradeCompleted=upgradeCompleted, poolDeleted=poolDeleted, poolMetaWriteIops=poolMetaWriteIops, projectDataSizeLow=projectDataSizeLow, projectQuotaSizeHigh=projectQuotaSizeHigh, notificationTime=notificationTime, replicationResumed=replicationResumed, fcTotalWriteIops=fcTotalWriteIops, replicationPaused=replicationPaused, targetGroupMemberAdded=targetGroupMemberAdded, fcTotalReadMbps=fcTotalReadMbps, userLoginFailed=userLoginFailed, lunFreeSizeLow=lunFreeSizeLow, ipmiMemory=ipmiMemory, iscsiTargetEntry=iscsiTargetEntry, notificationDescription=notificationDescription, fcPortOffline=fcPortOffline, targetGroupCreateCompleted=targetGroupCreateCompleted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, notificationReadingUnit=notificationReadingUnit, upgradeFailed=upgradeFailed, poolTotalReadIops=poolTotalReadIops, projectTable=projectTable, shareCIFSReadIops=shareCIFSReadIops, smisServiceStarted=smisServiceStarted, nfsAvgReadLatency=nfsAvgReadLatency, nfsTotalReadMbps=nfsTotalReadMbps, diskSlowIo=diskSlowIo, snapshotCloneCompleted=snapshotCloneCompleted, projectFreeSizeHigh=projectFreeSizeHigh, fcTargetEntry=fcTargetEntry, nicTable=nicTable, ipmiThreshold=ipmiThreshold, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskDataReadMbps=diskDataReadMbps, poolUsedSizeHigh=poolUsedSizeHigh, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, maintenanceModeDisabled=maintenanceModeDisabled, fcInitiatorsTable=fcInitiatorsTable, ipmiCurrent=ipmiCurrent, lunDataSizeLow=lunDataSizeLow, netbiosSocketFailure=netbiosSocketFailure, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, lunWriteIops=lunWriteIops, fcAvgReadLatency=fcAvgReadLatency, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, haResources=haResources, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiInitiatorGroup=iscsiInitiatorGroup, haResourceActiveNode=haResourceActiveNode, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, haResourcesTable=haResourcesTable, tdpsUpgradeCompleted=tdpsUpgradeCompleted, fcInitiatorEntry=fcInitiatorEntry, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, nfsTotalWriteMbps=nfsTotalWriteMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolAvgReadLatency=poolAvgReadLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, snapshotCreationFailed=snapshotCreationFailed, projectLUNs=projectLUNs, replicationSourceRegistered=replicationSourceRegistered, poolQuotaFinished=poolQuotaFinished, projectDedupEnabled=projectDedupEnabled, upgradeDownloadStarted=upgradeDownloadStarted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolReadCacheWriteIops=poolReadCacheWriteIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, cifsTotalWriteIops=cifsTotalWriteIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolHealth=poolHealth, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcTargetName=fcTargetName, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, networkInterfaceUp=networkInterfaceUp, poolIndex=poolIndex, currentNotificationGroup=currentNotificationGroup, nicState=nicState, lunReservedSizeHigh=lunReservedSizeHigh, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectCompressionEnabled=projectCompressionEnabled, fcTargetWriteIops=fcTargetWriteIops, poolDataReadIops=poolDataReadIops, aclMigrationCompleted=aclMigrationCompleted, shareIndex=shareIndex, cpuTotalUsage=cpuTotalUsage, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareCIFSWriteIops=shareCIFSWriteIops, sanProperties=sanProperties, ipmiFan=ipmiFan)
