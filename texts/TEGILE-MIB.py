...
ObjectIdentity, TimeTicks, Unsigned32, enterprises, Counter64, NotificationType, IpAddress, Integer32, Bits, Counter32, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "Unsigned32", "enterprises", "Counter64", "NotificationType", "IpAddress", "Integer32", "Bits", "Counter32", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskDataWriteMbps=diskDataWriteMbps, lunReadMbps=lunReadMbps, poolFreeSizeHigh=poolFreeSizeHigh, poolTotalWriteIops=poolTotalWriteIops, smisServiceStartFailed=smisServiceStartFailed, poolProjects=poolProjects, replicationComplete=replicationComplete, tdpsUpgradeTimeout=tdpsUpgradeTimeout, tdpsUpgradeCompleted=tdpsUpgradeCompleted, projectTotalSaving=projectTotalSaving, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcTargetWriteMbps=fcTargetWriteMbps, fcPortOnline=fcPortOnline, poolDataWriteMbps=poolDataWriteMbps, projectDataSizeLow=projectDataSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunWriteLatency=lunWriteLatency, lunDataSizeHigh=lunDataSizeHigh, iscsiTargetGroup=iscsiTargetGroup, poolCreated=poolCreated, volumeQuotaFinished=volumeQuotaFinished, shareNFSReadLatency=shareNFSReadLatency, lunEntry=lunEntry, ipmiOther=ipmiOther, smisServiceStarted=smisServiceStarted, memoryFailure=memoryFailure, poolDeleted=poolDeleted, iscsiAvgReadLatency=iscsiAvgReadLatency, diskError=diskError, nvdimmFailInitializationError=nvdimmFailInitializationError, diskIsOnline=diskIsOnline, shareCreatedSuccessfully=shareCreatedSuccessfully, notificationSeverity=notificationSeverity, poolEntry=poolEntry, lunWriteMbps=lunWriteMbps, projectIndex=projectIndex, diskDataWriteIops=diskDataWriteIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolTotalSaving=poolTotalSaving, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, notificationSensorNumber=notificationSensorNumber, replicationAborted=replicationAborted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, diskGoneOffline=diskGoneOffline, cpuSystemCalls=cpuSystemCalls, poolTotalReadIops=poolTotalReadIops, poolState=poolState, poolReadCacheWriteIops=poolReadCacheWriteIops, poolTable=poolTable, shareExceedThresholdWarning=shareExceedThresholdWarning, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiInitiatorName=iscsiInitiatorName, lunFreeSizeLow=lunFreeSizeLow, sharePoolName=sharePoolName, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, lunFreeSizeHigh=lunFreeSizeHigh, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, alertsCleanupCompleted=alertsCleanupCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunTargetGroup=lunTargetGroup, networkInterfaceDown=networkInterfaceDown, poolQuotaFinished=poolQuotaFinished, fcInitiatorName=fcInitiatorName, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, controllerTimeDrift=controllerTimeDrift, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, userLoginFailed=userLoginFailed, diskTotalReadIops=diskTotalReadIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, nicIndex=nicIndex, fcTotalReadIops=fcTotalReadIops, projectEntry=projectEntry, shareCIFSReadLatency=shareCIFSReadLatency, poolReadCacheWriteLatency=poolReadCacheWriteLatency, haResourceEntry=haResourceEntry, projectLUNs=projectLUNs, poolMetaReadLatency=poolMetaReadLatency, cacheTotalReadIops=cacheTotalReadIops, diskAvgReadLatency=diskAvgReadLatency, diskIOCount=diskIOCount, projectTable=projectTable, poolAvgWriteLatency=poolAvgWriteLatency, fcInitiatorCreateFailed=fcInitiatorCreateFailed, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolReadCacheReadLatency=poolReadCacheReadLatency, projectDeletionFailed=projectDeletionFailed, cifsAvgReadLatency=cifsAvgReadLatency, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, diskEntry=diskEntry, volumeDeleteFailed=volumeDeleteFailed, notificationDescription=notificationDescription, networkIpmpGroupUp=networkIpmpGroupUp, currentNotificationGroup=currentNotificationGroup, poolUsedSizeHigh=poolUsedSizeHigh, diskState=diskState, shareNFSWriteMbps=shareNFSWriteMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolMetaWriteMbps=poolMetaWriteMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, nicGroup=nicGroup, iscsiTargetReadIops=iscsiTargetReadIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, aclMigrationStarted=aclMigrationStarted, projectLunCount=projectLunCount, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diskDataReadIops=diskDataReadIops, poolDataWriteIops=poolDataWriteIops, cifsTotalReadIops=cifsTotalReadIops, poolUpgraded=poolUpgraded, nicTable=nicTable, nvdimmFailDeviceError=nvdimmFailDeviceError, notificationThresholdTriggerValue=notificationThresholdTriggerValue, ipmiTemperature=ipmiTemperature, fcProperties=fcProperties, networkInterfaceUp=networkInterfaceUp, lunInitiatorGroup=lunInitiatorGroup, upgradeCompleted=upgradeCompleted, haControllerA_Name=haControllerA_Name, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, haResourceName=haResourceName, aclMigrationCompleted=aclMigrationCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, fcInitiatorsTable=fcInitiatorsTable, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, nvdimmFailSoftError=nvdimmFailSoftError, replicationSourceRegistered=replicationSourceRegistered, shareSnapshotSizeLow=shareSnapshotSizeLow, projectDeleted=projectDeleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, tegileArray=tegileArray, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, nfsTotalWriteIops=nfsTotalWriteIops, tegileGroups=tegileGroups, diskAlias=diskAlias, shareCIFSWriteMbps=shareCIFSWriteMbps, haResourceStatus=haResourceStatus, fcAvgReadLatency=fcAvgReadLatency, fcTargetReadIops=fcTargetReadIops, upgradeStarted=upgradeStarted, poolReadCacheReadIops=poolReadCacheReadIops, cifsAvgWriteLatency=cifsAvgWriteLatency, basicCompliance=basicCompliance, PYSNMP_MODULE_ID=tegile, diagnosticDataUploaded=diagnosticDataUploaded, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, haResourcesTable=haResourcesTable, unknownSensorEvent=unknownSensorEvent, fcTargetWriteLatency=fcTargetWriteLatency, nvdimmFailUnknownError=nvdimmFailUnknownError, snapshotCloneCompleted=snapshotCloneCompleted, haControllerA_Uptime=haControllerA_Uptime, notificationReadingUnit=notificationReadingUnit, poolDataSizeLow=poolDataSizeLow, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolCount=poolCount, replicationAbandoned=replicationAbandoned, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, lunName=lunName, targetGroupCreateCompleted=targetGroupCreateCompleted, poolDegraded=poolDegraded, shareCompressedRatio=shareCompressedRatio, lunGUID=lunGUID, tegile=tegile, projectDedupEnabled=projectDedupEnabled, poolIndex=poolIndex, snmpAgentVersion=snmpAgentVersion, iscsiTargetAlias=iscsiTargetAlias, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, network=network, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetStatus=fcTargetStatus, lunDedupEnabled=lunDedupEnabled, diskType=diskType, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareDedupEnabled=shareDedupEnabled, snmpServiceStopFailed=snmpServiceStopFailed, diskSlowIo=diskSlowIo, upgradeDownloadStarted=upgradeDownloadStarted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, volumeModifyCompleted=volumeModifyCompleted, iscsiTargetEntry=iscsiTargetEntry, projectSnapshotSizeHigh=projectSnapshotSizeHigh, replicationStarted=replicationStarted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, cpuTotalUsage=cpuTotalUsage, webdocsUpgradeCompleted=webdocsUpgradeCompleted, tegileCompliances=tegileCompliances, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunSizeHigh=lunSizeHigh, iscsiInitiatorGroup=iscsiInitiatorGroup, globalStatistics=globalStatistics, networkIpmpGroupDown=networkIpmpGroupDown, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, nfsTotalReadIops=nfsTotalReadIops, lunDataSizeLow=lunDataSizeLow, currentObjectGroup=currentObjectGroup, ipmiMemory=ipmiMemory, haResourceDescription=haResourceDescription, shareDeleted=shareDeleted, maintenanceModeEnabled=maintenanceModeEnabled, ipmiCurrent=ipmiCurrent, fcTotalWriteMbps=fcTotalWriteMbps, poolExported=poolExported, iscsiProperties=iscsiProperties, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, snmpServiceStopped=snmpServiceStopped, shareNFSWriteIops=shareNFSWriteIops, poolAvgReadLatency=poolAvgReadLatency, shareDeletionFailed=shareDeletionFailed, shareIndex=shareIndex, pools=pools, projectCompressionEnabled=projectCompressionEnabled, shareCIFSWriteLatency=shareCIFSWriteLatency, nicReceiveMbps=nicReceiveMbps, lunBlockSize=lunBlockSize, shareName=shareName, projectFreeSizeHigh=projectFreeSizeHigh, poolDataReadIops=poolDataReadIops, diskSizeLow=diskSizeLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, ipmiPowerSupply=ipmiPowerSupply, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectCreatedSuccessfully=projectCreatedSuccessfully, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskTotalWriteMbps=diskTotalWriteMbps, replicationTargetDeleted=replicationTargetDeleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareEntry=shareEntry, projectDataSizeHigh=projectDataSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolMetaWriteIops=poolMetaWriteIops, poolTotalReadMbps=poolTotalReadMbps, iscsiTargetsTable=iscsiTargetsTable, haControllerB_IPAddr=haControllerB_IPAddr, shareReservedSizeHigh=shareReservedSizeHigh, haControllerB_Uptime=haControllerB_Uptime, iscsiTargetError=iscsiTargetError, haResourceGroup=haResourceGroup, iscsiTargetName=iscsiTargetName, diskTable=diskTable, nicState=nicState, shareReservedSizeLow=shareReservedSizeLow, haControllerB_Name=haControllerB_Name, adServerTimeDrift=adServerTimeDrift, diskTotalReadMbps=diskTotalReadMbps)
mibBuilder.exportSymbols("TEGILE-MIB", lunReadLatency=lunReadLatency, controllerDown=controllerDown, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolSizeHigh=poolSizeHigh, diskCount=diskCount, fcInitiators=fcInitiators, iscsiTargetGroupError=iscsiTargetGroupError, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, deleteFolderFailed=deleteFolderFailed, nicEntry=nicEntry, iscsiInitiators=iscsiInitiators, upgradeTimeout=upgradeTimeout, diskPoolName=diskPoolName, targetGroupMemberRemoved=targetGroupMemberRemoved, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcTargetReadMbps=fcTargetReadMbps, iscsiTargetIndex=iscsiTargetIndex, nfsTotalReadMbps=nfsTotalReadMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, lunIndex=lunIndex, iscsiTotalReadMbps=iscsiTotalReadMbps, shareQuotaFinished=shareQuotaFinished, networkTotalReceiveMbps=networkTotalReceiveMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, vmwareNFSDatastores=vmwareNFSDatastores, poolDataSizeHigh=poolDataSizeHigh, tdpsUpgradeFailed=tdpsUpgradeFailed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareTable=shareTable, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, sensorFailureEvent=sensorFailureEvent, fcTotalWriteIops=fcTotalWriteIops, fcTargetModifyCompleted=fcTargetModifyCompleted, shareNFSWriteLatency=shareNFSWriteLatency, shareQuotaHigh=shareQuotaHigh, smisServiceStopFailed=smisServiceStopFailed, fcAvgWriteLatency=fcAvgWriteLatency, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, projectShares=projectShares, maintenanceModeDisabled=maintenanceModeDisabled, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolDataReadMbps=poolDataReadMbps, lunProtocol=lunProtocol, poolWriteCacheWriteIops=poolWriteCacheWriteIops, sanProperties=sanProperties, lunCompressionEnabled=lunCompressionEnabled, cacheSSDReads=cacheSSDReads, upgradeFailed=upgradeFailed, notificationEventCode=notificationEventCode, shareDataSizeHigh=shareDataSizeHigh, notificationComponentName=notificationComponentName, cpuInterrupts=cpuInterrupts, diskIndex=diskIndex, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, nfsTotalWriteMbps=nfsTotalWriteMbps, poolExpanded=poolExpanded, cacheTotalWriteMbps=cacheTotalWriteMbps, shareNFSReadMbps=shareNFSReadMbps, controllerUp=controllerUp, nicName=nicName, poolImported=poolImported, diskTotalWriteIops=diskTotalWriteIops, snapshotRollbackCompleted=snapshotRollbackCompleted, nicTransmitMbps=nicTransmitMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, nfsAvgReadLatency=nfsAvgReadLatency, notificationSensorAction=notificationSensorAction, ipmiFan=ipmiFan, shareCIFSReadMbps=shareCIFSReadMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, smbSocketFailure=smbSocketFailure, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, ipmiVoltage=ipmiVoltage, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolOwnerController=poolOwnerController, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectQuotaFinished=projectQuotaFinished, shareCIFSEnabled=shareCIFSEnabled, spareDiskReplaced=spareDiskReplaced, shareNFSEnabled=shareNFSEnabled, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiTargetReadMbps=iscsiTargetReadMbps, lunProjectName=lunProjectName, poolTotalWriteMbps=poolTotalWriteMbps, poolSizeLow=poolSizeLow, iscsiWriteIops=iscsiWriteIops, iscsiInitiatorChapUser=iscsiInitiatorChapUser, snapshotCreationFailed=snapshotCreationFailed, poolHealth=poolHealth, properties=properties, nicMTU=nicMTU, fcTargets=fcTargets, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, fcPortOffline=fcPortOffline, netbiosSocketFailure=netbiosSocketFailure, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, snapshotDeleteFailed=snapshotDeleteFailed, iscsiTargetReadLatency=iscsiTargetReadLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, tegileConformance=tegileConformance, cacheRAMReads=cacheRAMReads, controllerHardwareModel=controllerHardwareModel, projectQuotaSizeLow=projectQuotaSizeLow, haControllerA_IPAddr=haControllerA_IPAddr, lunSizeLow=lunSizeLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, projectModified=projectModified, projectThresholdExceedWarning=projectThresholdExceedWarning, snmpServiceStarted=snmpServiceStarted, shareNFSReadIops=shareNFSReadIops, poolDeletionFailed=poolDeletionFailed, cifsTotalWriteIops=cifsTotalWriteIops, snapshotCloningFailed=snapshotCloningFailed, fcTargetName=fcTargetName, notificationSensorSuspect=notificationSensorSuspect, snmpServiceStartFailed=snmpServiceStartFailed, deleteFolderCompleted=deleteFolderCompleted, notifications=notifications, fcTargetWriteIops=fcTargetWriteIops, diskAvgWriteLatency=diskAvgWriteLatency, ipmiThreshold=ipmiThreshold, cacheTotalReadMbps=cacheTotalReadMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiTargets=iscsiTargets, fcInitiatorGroup=fcInitiatorGroup, shareCIFSReadIops=shareCIFSReadIops, upgradeDownloadCompleted=upgradeDownloadCompleted, shareMountPoint=shareMountPoint, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolName=poolName, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcTargetIndex=fcTargetIndex, nfsAvgWriteLatency=nfsAvgWriteLatency, poolFreeSizeLow=poolFreeSizeLow, cifsTotalWriteMbps=cifsTotalWriteMbps, cacheTotalWriteIops=cacheTotalWriteIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcInitiatorIndex=fcInitiatorIndex, ntpServerTimeDrift=ntpServerTimeDrift, notificationObjects=notificationObjects, projectName=projectName, fcTargetGroup=fcTargetGroup, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcTargetEntry=fcTargetEntry, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectShareCount=projectShareCount, disks=disks, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, fcTotalReadMbps=fcTotalReadMbps, haResources=haResources, cifsTotalReadMbps=cifsTotalReadMbps, shareCompressionEnabled=shareCompressionEnabled, iscsiTargetAuth=iscsiTargetAuth, notificationProps=notificationProps, replicationResumed=replicationResumed, poolDataReadLatency=poolDataReadLatency, lunWriteIops=lunWriteIops, volumeDeleteCompleted=volumeDeleteCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, testNotification=testNotification, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunTable=lunTable, smisServiceStopped=smisServiceStopped, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolMetaReadMbps=poolMetaReadMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, shareCIFSWriteIops=shareCIFSWriteIops, targetGroupMemberAdded=targetGroupMemberAdded, poolMetaReadIops=poolMetaReadIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, replicationPaused=replicationPaused, projectPoolName=projectPoolName, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolUsedSizeLow=poolUsedSizeLow, diskSequentialIOCount=diskSequentialIOCount, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, diskSizeHigh=diskSizeHigh, diskChassisIdx=diskChassisIdx, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunReservedSizeHigh=lunReservedSizeHigh, notificationTime=notificationTime, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, notificationTargetEntityName=notificationTargetEntityName, lunCompressedRatio=lunCompressedRatio, diskDataReadMbps=diskDataReadMbps, shareProjectName=shareProjectName, iscsiTotalReadIops=iscsiTotalReadIops, lunReadIops=lunReadIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, tegileArray_notifications=tegileArray_notifications, lunReservedSizeLow=lunReservedSizeLow, poolDataWriteLatency=poolDataWriteLatency, lunPoolName=lunPoolName, shareQuotaLow=shareQuotaLow, haResourceIndex=haResourceIndex, poolProjectCount=poolProjectCount, fcInitiatorEntry=fcInitiatorEntry, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcTargetReadLatency=fcTargetReadLatency, projectFreeSizeLow=projectFreeSizeLow, fcTargetsTable=fcTargetsTable, replicationFailed=replicationFailed, shareDataSizeLow=shareDataSizeLow, snapshotRollbackFailed=snapshotRollbackFailed, iscsiInitiatorsTable=iscsiInitiatorsTable, haResourceActiveNode=haResourceActiveNode)
