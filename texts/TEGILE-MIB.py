...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:37:19 2021
...
Gauge32, IpAddress, ObjectIdentity, Unsigned32, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, MibIdentifier, enterprises, iso, ModuleIdentity, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "ObjectIdentity", "Unsigned32", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "MibIdentifier", "enterprises", "iso", "ModuleIdentity", "Bits", "Counter64")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareQuotaHigh=shareQuotaHigh, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, haResourceEntry=haResourceEntry, notificationTargetEntityName=notificationTargetEntityName, shareMountPoint=shareMountPoint, projectEntry=projectEntry, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunInitiatorGroup=lunInitiatorGroup, snmpAgentVersion=snmpAgentVersion, cifsAvgReadLatency=cifsAvgReadLatency, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, nicIndex=nicIndex, tdpsUpgradeFailed=tdpsUpgradeFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, poolMetaReadMbps=poolMetaReadMbps, nicTransmitMbps=nicTransmitMbps, lunWriteIops=lunWriteIops, fcTotalReadIops=fcTotalReadIops, projectFreeSizeLow=projectFreeSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiProperties=iscsiProperties, iscsiInitiatorIndex=iscsiInitiatorIndex, diskSlowIo=diskSlowIo, haControllerB_Name=haControllerB_Name, cacheTotalReadIops=cacheTotalReadIops, networkInterfaceDown=networkInterfaceDown, projectShares=projectShares, lunName=lunName, poolDeletionFailed=poolDeletionFailed, lunSizeHigh=lunSizeHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, projectDataSizeHigh=projectDataSizeHigh, fcTargetReadLatency=fcTargetReadLatency, network=network, ipmiFan=ipmiFan, poolTotalWriteMbps=poolTotalWriteMbps, poolProjects=poolProjects, replicationStarted=replicationStarted, tegileCompliances=tegileCompliances, lunReservedSizeLow=lunReservedSizeLow, volumeDeleteFailed=volumeDeleteFailed, fcInitiatorCreateFailed=fcInitiatorCreateFailed, snapshotRollbackFailed=snapshotRollbackFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, aclMigrationCompleted=aclMigrationCompleted, lunCompressedRatio=lunCompressedRatio, maintenanceModeEnabled=maintenanceModeEnabled, ipmiCriticalInterrupt=ipmiCriticalInterrupt, snmpServiceStopped=snmpServiceStopped, cacheRAMReads=cacheRAMReads, iscsiTargetEntry=iscsiTargetEntry, iscsiTargetReadMbps=iscsiTargetReadMbps, poolCount=poolCount, shareCIFSWriteLatency=shareCIFSWriteLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, networkIpmpGroupUp=networkIpmpGroupUp, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolTotalReadIops=poolTotalReadIops, targetGroupCreateCompleted=targetGroupCreateCompleted, notificationSeverity=notificationSeverity, projectThresholdExceedWarning=projectThresholdExceedWarning, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, spareDiskReplaced=spareDiskReplaced, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunProjectName=lunProjectName, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, replicationFailed=replicationFailed, fcTargets=fcTargets, poolMetaReadIops=poolMetaReadIops, poolExpanded=poolExpanded, controllerHardwareModel=controllerHardwareModel, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nicReceiveMbps=nicReceiveMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolTable=poolTable, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiTargetWriteLatency=iscsiTargetWriteLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolWriteCacheWriteIops=poolWriteCacheWriteIops, haResourceDescription=haResourceDescription, poolReadCacheReadMbps=poolReadCacheReadMbps, poolMetaWriteMbps=poolMetaWriteMbps, fcAvgReadLatency=fcAvgReadLatency, shareCompressedRatio=shareCompressedRatio, shareNFSEnabled=shareNFSEnabled, smbSocketFailure=smbSocketFailure, shareQuotaLow=shareQuotaLow, lunGUID=lunGUID, projectQuotaFinished=projectQuotaFinished, properties=properties, lunReadMbps=lunReadMbps, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, nicName=nicName, nvdimmFailUnknownError=nvdimmFailUnknownError, shareDataSizeLow=shareDataSizeLow, poolReadCacheReadLatency=poolReadCacheReadLatency, diskCount=diskCount, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, diskState=diskState, upgradeDownloadFailed=upgradeDownloadFailed, lunReadIops=lunReadIops, poolTotalReadMbps=poolTotalReadMbps, projectLUNs=projectLUNs, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareNFSWriteIops=shareNFSWriteIops, haResourceName=haResourceName, fcProperties=fcProperties, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunDataSizeLow=lunDataSizeLow, notificationProps=notificationProps, shareCIFSReadIops=shareCIFSReadIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, notifications=notifications, sharePoolName=sharePoolName, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiInitiatorName=iscsiInitiatorName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, intelliFlashSoftwareUp=intelliFlashSoftwareUp, diskTotalWriteMbps=diskTotalWriteMbps, poolMetaReadLatency=poolMetaReadLatency, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectTable=projectTable, lunWriteMbps=lunWriteMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskDataReadIops=diskDataReadIops, fcInitiators=fcInitiators, cifsAvgWriteLatency=cifsAvgWriteLatency, lunFreeSizeLow=lunFreeSizeLow, nfsTotalReadIops=nfsTotalReadIops, iscsiTargetsTable=iscsiTargetsTable, poolHealth=poolHealth, projectQuotaSizeHigh=projectQuotaSizeHigh, poolDataWriteLatency=poolDataWriteLatency, poolDeleted=poolDeleted, ipmiVoltage=ipmiVoltage, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, projectLunCount=projectLunCount, replicationTargetDeleted=replicationTargetDeleted, diskGoneOffline=diskGoneOffline, fcTotalWriteMbps=fcTotalWriteMbps, shareDeletionFailed=shareDeletionFailed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, diskIsOnline=diskIsOnline, tegileConformance=tegileConformance, targetGroupMemberRemoved=targetGroupMemberRemoved, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, networkTotalTransmitMbps=networkTotalTransmitMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, smisServiceStopFailed=smisServiceStopFailed, cacheSSDReads=cacheSSDReads, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, fcTargetEntry=fcTargetEntry, haResourceStatus=haResourceStatus, poolIndex=poolIndex, shareTable=shareTable, poolState=poolState, disks=disks, lunSnapshotSizeHigh=lunSnapshotSizeHigh, diskSizeLow=diskSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, basicCompliance=basicCompliance, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, fcInitiatorGroup=fcInitiatorGroup, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, cpuInterrupts=cpuInterrupts, fcTargetWriteMbps=fcTargetWriteMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, diskIndex=diskIndex, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolProjectCount=poolProjectCount, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolImported=poolImported, projectSnapshotSizeLow=projectSnapshotSizeLow, vmwareNFSDatastores=vmwareNFSDatastores, fcTargetsTable=fcTargetsTable, diskIOCount=diskIOCount, diskTotalReadMbps=diskTotalReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, aclMigrationStarted=aclMigrationStarted, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, snmpServiceStopFailed=snmpServiceStopFailed, lunProtocol=lunProtocol, projectModified=projectModified, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolDataWriteMbps=poolDataWriteMbps, controllerTimeDrift=controllerTimeDrift, shareCreatedSuccessfully=shareCreatedSuccessfully, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, shareNFSWriteLatency=shareNFSWriteLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcAvgWriteLatency=fcAvgWriteLatency, nicState=nicState, snapshotCloneCompleted=snapshotCloneCompleted, nicEntry=nicEntry, ipmiCurrent=ipmiCurrent, smisServiceStartFailed=smisServiceStartFailed, maintenanceModeDisabled=maintenanceModeDisabled, snmpServiceStarted=snmpServiceStarted, smisServiceStarted=smisServiceStarted, poolAvgReadLatency=poolAvgReadLatency, snapshotDeleteFailed=snapshotDeleteFailed, cacheTotalWriteIops=cacheTotalWriteIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcTargetWriteIops=fcTargetWriteIops, lunEntry=lunEntry, fcTargetReadMbps=fcTargetReadMbps, nvdimmFailSoftError=nvdimmFailSoftError, poolMetaWriteLatency=poolMetaWriteLatency, shareDedupEnabled=shareDedupEnabled, shareProjectName=shareProjectName, iscsiInitiatorsTable=iscsiInitiatorsTable, cifsTotalWriteIops=cifsTotalWriteIops, notificationObjects=notificationObjects, poolReadCacheReadIops=poolReadCacheReadIops, projectCompressionEnabled=projectCompressionEnabled, poolDegraded=poolDegraded, sanProperties=sanProperties, notificationReadingUnit=notificationReadingUnit, shareDeleted=shareDeleted, fcPortOffline=fcPortOffline, shareCIFSEnabled=shareCIFSEnabled, notificationSensorAction=notificationSensorAction, deleteFolderCompleted=deleteFolderCompleted, poolDataSizeHigh=poolDataSizeHigh, cacheTotalReadMbps=cacheTotalReadMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, ipmiMemory=ipmiMemory, diskError=diskError, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiWriteIops=iscsiWriteIops, haControllerA_Uptime=haControllerA_Uptime, lunCompressionEnabled=lunCompressionEnabled, shareCIFSReadMbps=shareCIFSReadMbps, iscsiTotalReadIops=iscsiTotalReadIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolTotalWriteIops=poolTotalWriteIops, poolDataReadIops=poolDataReadIops)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargets=iscsiTargets, globalStatistics=globalStatistics, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTargetAuth=iscsiTargetAuth, cifsTotalWriteMbps=cifsTotalWriteMbps, lunBlockSize=lunBlockSize, diagnosticDataUploaded=diagnosticDataUploaded, iscsiTargetReadIops=iscsiTargetReadIops, replicationAborted=replicationAborted, poolSizeHigh=poolSizeHigh, lunPoolName=lunPoolName, projectName=projectName, haResourceIndex=haResourceIndex, projectPoolName=projectPoolName, lunReadLatency=lunReadLatency, haResourceGroup=haResourceGroup, nfsTotalWriteIops=nfsTotalWriteIops, fcInitiatorEntry=fcInitiatorEntry, diskEntry=diskEntry, iscsiTargetWriteMbps=iscsiTargetWriteMbps, projectTotalSaving=projectTotalSaving, diskDataWriteMbps=diskDataWriteMbps, volumeQuotaFinished=volumeQuotaFinished, networkInterfaceUp=networkInterfaceUp, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, nfsTotalReadMbps=nfsTotalReadMbps, poolAvgWriteLatency=poolAvgWriteLatency, alertsCleanupCompleted=alertsCleanupCompleted, fcTotalReadMbps=fcTotalReadMbps, poolName=poolName, nicTable=nicTable, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, snapshotCreationFailed=snapshotCreationFailed, upgradeStarted=upgradeStarted, fcInitiatorsTable=fcInitiatorsTable, nfsAvgWriteLatency=nfsAvgWriteLatency, adServerTimeDrift=adServerTimeDrift, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskDataReadMbps=diskDataReadMbps, poolTotalSaving=poolTotalSaving, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiTargetGroup=iscsiTargetGroup, fcTotalWriteIops=fcTotalWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareNFSReadIops=shareNFSReadIops, poolDataSizeLow=poolDataSizeLow, poolDataReadMbps=poolDataReadMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, shareQuotaFinished=shareQuotaFinished, volumeCreatedSuccessfully=volumeCreatedSuccessfully, ipmiPowerSupply=ipmiPowerSupply, poolDataWriteIops=poolDataWriteIops, nicMTU=nicMTU, diskSequentialIOCount=diskSequentialIOCount, upgradeTimeout=upgradeTimeout, haResourceActiveNode=haResourceActiveNode, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcTargetModifyCompleted=fcTargetModifyCompleted, diskChassisIdx=diskChassisIdx, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, fcTargetStatus=fcTargetStatus, lunSizeLow=lunSizeLow, iscsiTargetName=iscsiTargetName, projectFreeSizeHigh=projectFreeSizeHigh, haResourcesTable=haResourcesTable, tegileArray_notifications=tegileArray_notifications, poolUpgraded=poolUpgraded, tegileArray=tegileArray, shareReservedSizeHigh=shareReservedSizeHigh, lunWriteLatency=lunWriteLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareIndex=shareIndex, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcTargetWriteLatency=fcTargetWriteLatency, notificationSensorNumber=notificationSensorNumber, replicationAbandoned=replicationAbandoned, fcTargetIndex=fcTargetIndex, poolCreated=poolCreated, haControllerA_IPAddr=haControllerA_IPAddr, poolUsedSizeHigh=poolUsedSizeHigh, diskTable=diskTable, memoryFailure=memoryFailure, notificationSensorSuspect=notificationSensorSuspect, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, shareDataSizeHigh=shareDataSizeHigh, shareNFSReadLatency=shareNFSReadLatency, tegile=tegile, ipmiTemperature=ipmiTemperature, projectQuotaSizeLow=projectQuotaSizeLow, haControllerB_IPAddr=haControllerB_IPAddr, lunDataSizeHigh=lunDataSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, cifsTotalReadMbps=cifsTotalReadMbps, lunDedupEnabled=lunDedupEnabled, iscsiTotalReadMbps=iscsiTotalReadMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, cifsTotalReadIops=cifsTotalReadIops, targetGroupMemberAdded=targetGroupMemberAdded, projectShareCount=projectShareCount, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, volumeModifyCompleted=volumeModifyCompleted, diskTotalReadIops=diskTotalReadIops, poolMetaWriteIops=poolMetaWriteIops, shareName=shareName, diskAlias=diskAlias, iscsiTargetAlias=iscsiTargetAlias, iscsiInitiatorEntry=iscsiInitiatorEntry, shareNFSReadMbps=shareNFSReadMbps, unknownSensorEvent=unknownSensorEvent, iscsiTargetIndex=iscsiTargetIndex, shareCompressionEnabled=shareCompressionEnabled, diskAvgReadLatency=diskAvgReadLatency, ipmiThreshold=ipmiThreshold, diskSizeHigh=diskSizeHigh, diskDataWriteIops=diskDataWriteIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, notificationDescription=notificationDescription, fcTargetName=fcTargetName, controllerDown=controllerDown, smisServiceStopped=smisServiceStopped, nvdimmFailInitializationError=nvdimmFailInitializationError, snapshotCloningFailed=snapshotCloningFailed, iscsiTargetError=iscsiTargetError, snmpServiceStartFailed=snmpServiceStartFailed, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, notificationEventCode=notificationEventCode, poolExported=poolExported, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcInitiatorName=fcInitiatorName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, replicationResumed=replicationResumed, upgradeCompleted=upgradeCompleted, poolOwnerController=poolOwnerController, pools=pools, userLoginFailed=userLoginFailed, projectDeleted=projectDeleted, cacheTotalWriteMbps=cacheTotalWriteMbps, poolEntry=poolEntry, iscsiTargetGroupError=iscsiTargetGroupError, cpuSystemCalls=cpuSystemCalls, haControllerA_Name=haControllerA_Name, shareExceedThresholdWarning=shareExceedThresholdWarning, deleteFolderFailed=deleteFolderFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, currentNotificationGroup=currentNotificationGroup, testNotification=testNotification, shareReservedSizeLow=shareReservedSizeLow, fcPortOnline=fcPortOnline, nfsAvgReadLatency=nfsAvgReadLatency, notificationTime=notificationTime, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, ipmiOther=ipmiOther, haControllerB_Uptime=haControllerB_Uptime, lunTable=lunTable, ntpServerTimeDrift=ntpServerTimeDrift, snapshotRollbackCompleted=snapshotRollbackCompleted, poolFreeSizeHigh=poolFreeSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectDataSizeLow=projectDataSizeLow, poolQuotaFinished=poolQuotaFinished, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, replicationComplete=replicationComplete, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, projectDedupEnabled=projectDedupEnabled, projectDeletionFailed=projectDeletionFailed, shareCIFSWriteIops=shareCIFSWriteIops, tegileGroups=tegileGroups, upgradeDownloadStarted=upgradeDownloadStarted, fcTargetReadIops=fcTargetReadIops, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, cpuTotalUsage=cpuTotalUsage, lunTargetGroup=lunTargetGroup, netbiosSocketFailure=netbiosSocketFailure, nicGroup=nicGroup, diskTotalWriteIops=diskTotalWriteIops, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiInitiators=iscsiInitiators, controllerUp=controllerUp, diskType=diskType, fcInitiatorIndex=fcInitiatorIndex, notificationComponentName=notificationComponentName, iscsiTargetWriteIops=iscsiTargetWriteIops, poolDataReadLatency=poolDataReadLatency, lunFreeSizeHigh=lunFreeSizeHigh, replicationPaused=replicationPaused, sensorFailureEvent=sensorFailureEvent, upgradeDownloadCompleted=upgradeDownloadCompleted, shareEntry=shareEntry, iscsiTotalWriteMbps=iscsiTotalWriteMbps, replicationSourceRegistered=replicationSourceRegistered, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, PYSNMP_MODULE_ID=tegile, poolUsedSizeLow=poolUsedSizeLow, volumeDeleteCompleted=volumeDeleteCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolFreeSizeLow=poolFreeSizeLow, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, networkIpmpGroupDown=networkIpmpGroupDown, projectIndex=projectIndex, lunIndex=lunIndex, upgradeFailed=upgradeFailed, diskRandomIOCount=diskRandomIOCount, poolSizeLow=poolSizeLow, webdocsUpgradeCompleted=webdocsUpgradeCompleted, diskPoolName=diskPoolName, haResources=haResources)
