...
Bits, Unsigned32, iso, ObjectIdentity, TimeTicks, Gauge32, MibIdentifier, Counter32, ModuleIdentity, Counter64, NotificationType, Integer32, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "iso", "ObjectIdentity", "TimeTicks", "Gauge32", "MibIdentifier", "Counter32", "ModuleIdentity", "Counter64", "NotificationType", "Integer32", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolAvgWriteLatency=poolAvgWriteLatency, iscsiTargetEntry=iscsiTargetEntry, haResourceName=haResourceName, iscsiInitiatorChapUser=iscsiInitiatorChapUser, iscsiTargetGroup=iscsiTargetGroup, projectLUNs=projectLUNs, poolDataWriteLatency=poolDataWriteLatency, shareDataSizeLow=shareDataSizeLow, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, volumeDeleteFailed=volumeDeleteFailed, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcTargetReadLatency=fcTargetReadLatency, iscsiTargetReadIops=iscsiTargetReadIops, nvdimmFailDeviceError=nvdimmFailDeviceError, poolName=poolName, iscsiTargetIndex=iscsiTargetIndex, haControllerB_Uptime=haControllerB_Uptime, diskState=diskState, haControllerB_Name=haControllerB_Name, poolCreated=poolCreated, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, projectShareCount=projectShareCount, diskType=diskType, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, snapshotRollbackCompleted=snapshotRollbackCompleted, tegileArray_notifications=tegileArray_notifications, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskDataReadMbps=diskDataReadMbps, diskDataWriteIops=diskDataWriteIops, upgradeFailed=upgradeFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolDataWriteIops=poolDataWriteIops, poolMetaReadMbps=poolMetaReadMbps, notificationObjects=notificationObjects, poolFreeSizeLow=poolFreeSizeLow, poolTotalReadMbps=poolTotalReadMbps, snmpServiceStartFailed=snmpServiceStartFailed, cifsTotalReadMbps=cifsTotalReadMbps, cifsTotalWriteMbps=cifsTotalWriteMbps, diskTotalReadMbps=diskTotalReadMbps, diskChassisIdx=diskChassisIdx, fcTargetName=fcTargetName, upgradeDownloadStarted=upgradeDownloadStarted, poolOwnerController=poolOwnerController, smisServiceStarted=smisServiceStarted, diskSequentialIOCount=diskSequentialIOCount, shareQuotaLow=shareQuotaLow, networkTotalReceiveMbps=networkTotalReceiveMbps, spareDiskReplaced=spareDiskReplaced, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, deleteFolderCompleted=deleteFolderCompleted, shareCIFSEnabled=shareCIFSEnabled, snmpServiceStopped=snmpServiceStopped, poolExpanded=poolExpanded, ipmiMemory=ipmiMemory, lunCompressedRatio=lunCompressedRatio, poolAvgReadLatency=poolAvgReadLatency, nfsAvgReadLatency=nfsAvgReadLatency, diskIsOnline=diskIsOnline, testNotification=testNotification, lunWriteLatency=lunWriteLatency, snapshotRollbackFailed=snapshotRollbackFailed, nicGroup=nicGroup, fcInitiatorCreateFailed=fcInitiatorCreateFailed, userLoginFailed=userLoginFailed, iscsiTargetGroupError=iscsiTargetGroupError, smbSocketFailure=smbSocketFailure, snapshotCloneCompleted=snapshotCloneCompleted, fcTargetIndex=fcTargetIndex, controllerHardwareModel=controllerHardwareModel, haResources=haResources, cifsTotalReadIops=cifsTotalReadIops, lunSnapshotSizeLow=lunSnapshotSizeLow, diagnosticDataUploaded=diagnosticDataUploaded, poolTotalWriteMbps=poolTotalWriteMbps, cpuInterrupts=cpuInterrupts, fcTargetReadIops=fcTargetReadIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, networkInterfaceUp=networkInterfaceUp, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolMetaWriteMbps=poolMetaWriteMbps, lunWriteMbps=lunWriteMbps, shareIndex=shareIndex, shareEntry=shareEntry, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry, fcPortOnline=fcPortOnline, ipmiTemperature=ipmiTemperature, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcInitiatorGroup=fcInitiatorGroup, fcTargetsTable=fcTargetsTable, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunGUID=lunGUID, projectDataSizeHigh=projectDataSizeHigh, iscsiTargetAuth=iscsiTargetAuth, fcTotalReadIops=fcTotalReadIops, shareCreatedSuccessfully=shareCreatedSuccessfully, haControllerA_IPAddr=haControllerA_IPAddr, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, haControllerA_Name=haControllerA_Name, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, diskCount=diskCount, poolUsedSizeHigh=poolUsedSizeHigh, tegileGroups=tegileGroups, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiInitiatorGroup=iscsiInitiatorGroup, lunTable=lunTable, smisServiceStartFailed=smisServiceStartFailed, diskTable=diskTable, poolProjectCount=poolProjectCount, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunReservedSizeHigh=lunReservedSizeHigh, fcTargetGroup=fcTargetGroup, notificationTargetEntityName=notificationTargetEntityName, iscsiInitiatorName=iscsiInitiatorName, haResourceEntry=haResourceEntry, lunBlockSize=lunBlockSize, iscsiTargetsTable=iscsiTargetsTable, shareCIFSReadLatency=shareCIFSReadLatency, networkInterfaceDown=networkInterfaceDown, nvdimmFailSoftError=nvdimmFailSoftError, shareMountPoint=shareMountPoint, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, cifsAvgReadLatency=cifsAvgReadLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diskAlias=diskAlias, deleteFolderFailed=deleteFolderFailed, iscsiTargets=iscsiTargets, currentObjectGroup=currentObjectGroup, intelliFlashSoftwareDown=intelliFlashSoftwareDown, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareExceedThresholdWarning=shareExceedThresholdWarning, fcTargetWriteIops=fcTargetWriteIops, shareDataSizeHigh=shareDataSizeHigh, poolEntry=poolEntry, notificationComponentName=notificationComponentName, replicationSourceRegistered=replicationSourceRegistered, snmpServiceStopFailed=snmpServiceStopFailed, maintenanceModeDisabled=maintenanceModeDisabled, lunName=lunName, shareCIFSWriteLatency=shareCIFSWriteLatency, poolSizeLow=poolSizeLow, volumeCreatedSuccessfully=volumeCreatedSuccessfully, networkTotalTransmitMbps=networkTotalTransmitMbps, diskDataWriteMbps=diskDataWriteMbps, haControllerB_IPAddr=haControllerB_IPAddr, lunDedupEnabled=lunDedupEnabled, fcInitiators=fcInitiators, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, tegileConformance=tegileConformance, ntpServerTimeDrift=ntpServerTimeDrift, iscsiTargetAlias=iscsiTargetAlias, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareCIFSWriteIops=shareCIFSWriteIops, shareNFSWriteIops=shareNFSWriteIops, shareReservedSizeHigh=shareReservedSizeHigh, volumeDeleteCompleted=volumeDeleteCompleted, replicationComplete=replicationComplete, vmwareNFSDatastores=vmwareNFSDatastores, cacheTotalWriteMbps=cacheTotalWriteMbps, shareReservedSizeLow=shareReservedSizeLow, netbiosSocketFailure=netbiosSocketFailure, aclMigrationCompleted=aclMigrationCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, haResourceDescription=haResourceDescription, disks=disks, projectPoolName=projectPoolName, snapshotCloningFailed=snapshotCloningFailed, poolMetaWriteIops=poolMetaWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, cacheTotalReadIops=cacheTotalReadIops, fcInitiatorName=fcInitiatorName, fcTargets=fcTargets, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, diskDataReadIops=diskDataReadIops, cacheSSDReads=cacheSSDReads, upgradeStarted=upgradeStarted, fcAvgWriteLatency=fcAvgWriteLatency, poolDeletionFailed=poolDeletionFailed, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunTargetGroup=lunTargetGroup, projectQuotaSizeLow=projectQuotaSizeLow, shareNFSReadIops=shareNFSReadIops, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolMetaReadIops=poolMetaReadIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, replicationAbandoned=replicationAbandoned, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcTargetWriteLatency=fcTargetWriteLatency, fcTargetStatus=fcTargetStatus, replicationAborted=replicationAborted, nfsTotalWriteMbps=nfsTotalWriteMbps, ipmiPowerSupply=ipmiPowerSupply, haResourceGroup=haResourceGroup, shareSnapshotSizeHigh=shareSnapshotSizeHigh, nicTransmitMbps=nicTransmitMbps, upgradeDownloadFailed=upgradeDownloadFailed, volumeModifyCompleted=volumeModifyCompleted, projectShares=projectShares, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, shareName=shareName, poolImported=poolImported, lunReservedSizeLow=lunReservedSizeLow, iscsiTargetName=iscsiTargetName, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcTotalReadMbps=fcTotalReadMbps, nfsTotalWriteIops=nfsTotalWriteIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, ipmiVoltage=ipmiVoltage, tdpsUpgradeTimeout=tdpsUpgradeTimeout, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, ipmiOther=ipmiOther, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, shareNFSReadLatency=shareNFSReadLatency, projectModified=projectModified, lunPoolName=lunPoolName, poolUpgraded=poolUpgraded, nicIndex=nicIndex, iscsiTargetError=iscsiTargetError, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiInitiators=iscsiInitiators, projectName=projectName, replicationStarted=replicationStarted, lunReadLatency=lunReadLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, cpuSystemCalls=cpuSystemCalls, diskSizeLow=diskSizeLow, poolDataWriteMbps=poolDataWriteMbps, networkIpmpGroupUp=networkIpmpGroupUp, lunSizeLow=lunSizeLow, poolDataReadMbps=poolDataReadMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, notificationEventCode=notificationEventCode, lunInitiatorGroup=lunInitiatorGroup, tegileCompliances=tegileCompliances)
mibBuilder.exportSymbols("TEGILE-MIB", properties=properties, aclMigrationStarted=aclMigrationStarted, haControllerA_Uptime=haControllerA_Uptime, notificationThresholdTriggerValue=notificationThresholdTriggerValue, snmpAgentVersion=snmpAgentVersion, poolDegraded=poolDegraded, projectSnapshotSizeLow=projectSnapshotSizeLow, diskAvgWriteLatency=diskAvgWriteLatency, sensorFailureEvent=sensorFailureEvent, iscsiWriteIops=iscsiWriteIops, lunFreeSizeLow=lunFreeSizeLow, globalStatistics=globalStatistics, shareCIFSReadMbps=shareCIFSReadMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, unknownSensorEvent=unknownSensorEvent, fcTargetWriteMbps=fcTargetWriteMbps, fcTotalWriteMbps=fcTotalWriteMbps, smisServiceStopFailed=smisServiceStopFailed, poolExported=poolExported, networkIpmpGroupDown=networkIpmpGroupDown, upgradeTimeout=upgradeTimeout, lunDataSizeLow=lunDataSizeLow, nvdimmFailUnknownError=nvdimmFailUnknownError, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, pools=pools, shareDedupEnabled=shareDedupEnabled, poolTotalSaving=poolTotalSaving, alertsCleanupCompleted=alertsCleanupCompleted, poolSizeHigh=poolSizeHigh, poolFreeSizeHigh=poolFreeSizeHigh, projectIndex=projectIndex, shareNFSWriteMbps=shareNFSWriteMbps, fcInitiatorEntry=fcInitiatorEntry, fcInitiatorIndex=fcInitiatorIndex, diskError=diskError, shareNFSEnabled=shareNFSEnabled, poolState=poolState, diskTotalReadIops=diskTotalReadIops, diskAvgReadLatency=diskAvgReadLatency, haResourcesTable=haResourcesTable, shareQuotaFinished=shareQuotaFinished, notificationSeverity=notificationSeverity, notificationReadingUnit=notificationReadingUnit, iscsiTargetWriteMbps=iscsiTargetWriteMbps, controllerDown=controllerDown, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolWriteCacheWriteIops=poolWriteCacheWriteIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, replicationResumed=replicationResumed, replicationTargetDeleted=replicationTargetDeleted, nvdimmFailInitializationError=nvdimmFailInitializationError, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, controllerUp=controllerUp, fcProperties=fcProperties, haResourceIndex=haResourceIndex, currentNotificationGroup=currentNotificationGroup, poolReadCacheReadLatency=poolReadCacheReadLatency, poolDeleted=poolDeleted, sharePoolName=sharePoolName, lunEntry=lunEntry, projectTotalSaving=projectTotalSaving, iscsiInitiatorsTable=iscsiInitiatorsTable, fcTargetModifyCompleted=fcTargetModifyCompleted, nicEntry=nicEntry, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, replicationPaused=replicationPaused, network=network, notificationSensorNumber=notificationSensorNumber, lunProtocol=lunProtocol, shareCIFSReadIops=shareCIFSReadIops, ipmiFan=ipmiFan, projectDeleted=projectDeleted, diskEntry=diskEntry, poolDataSizeLow=poolDataSizeLow, projectFreeSizeHigh=projectFreeSizeHigh, poolIndex=poolIndex, notificationSensorSuspect=notificationSensorSuspect, lunProjectName=lunProjectName, shareQuotaHigh=shareQuotaHigh, tegile=tegile, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, projectLunCount=projectLunCount, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, diskIOCount=diskIOCount, shareCompressedRatio=shareCompressedRatio, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, basicCompliance=basicCompliance, poolReadCacheReadIops=poolReadCacheReadIops, iscsiTargetReadMbps=iscsiTargetReadMbps, sanProperties=sanProperties, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, adServerTimeDrift=adServerTimeDrift, iscsiTotalReadIops=iscsiTotalReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, nfsTotalReadMbps=nfsTotalReadMbps, nicTable=nicTable, poolTable=poolTable, diskTotalWriteIops=diskTotalWriteIops, nfsTotalReadIops=nfsTotalReadIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcTargetReadMbps=fcTargetReadMbps, poolQuotaFinished=poolQuotaFinished, fcInitiatorsTable=fcInitiatorsTable, projectCreatedSuccessfully=projectCreatedSuccessfully, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, volumeQuotaFinished=volumeQuotaFinished, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, notificationProps=notificationProps, poolDataReadIops=poolDataReadIops, notificationTime=notificationTime, shareCompressionEnabled=shareCompressionEnabled, projectThresholdExceedWarning=projectThresholdExceedWarning, notifications=notifications, notificationSensorAction=notificationSensorAction, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, nicState=nicState, poolCount=poolCount, iscsiProperties=iscsiProperties, notificationDescription=notificationDescription, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectCompressionEnabled=projectCompressionEnabled, cifsTotalWriteIops=cifsTotalWriteIops, projectDeletionFailed=projectDeletionFailed, notificationReadingTriggerValue=notificationReadingTriggerValue, maintenanceModeEnabled=maintenanceModeEnabled, fcTargetEntry=fcTargetEntry, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolProjects=poolProjects, targetGroupMemberRemoved=targetGroupMemberRemoved, nicMTU=nicMTU, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolTotalReadIops=poolTotalReadIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, cpuTotalUsage=cpuTotalUsage, cacheTotalWriteIops=cacheTotalWriteIops, PYSNMP_MODULE_ID=tegile, lunFreeSizeHigh=lunFreeSizeHigh, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, cacheTotalReadMbps=cacheTotalReadMbps, diskRandomIOCount=diskRandomIOCount, shareProjectName=shareProjectName, poolMetaReadLatency=poolMetaReadLatency, lunSizeHigh=lunSizeHigh, cacheRAMReads=cacheRAMReads, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectTable=projectTable, nfsAvgWriteLatency=nfsAvgWriteLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, cifsAvgWriteLatency=cifsAvgWriteLatency, diskGoneOffline=diskGoneOffline, projectDedupEnabled=projectDedupEnabled, fcAvgReadLatency=fcAvgReadLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, diskTotalWriteMbps=diskTotalWriteMbps, diskSlowIo=diskSlowIo, diskIndex=diskIndex, controllerTimeDrift=controllerTimeDrift, tegileArray=tegileArray, shareSnapshotSizeLow=shareSnapshotSizeLow, poolTotalWriteIops=poolTotalWriteIops, upgradeCompleted=upgradeCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diskSizeHigh=diskSizeHigh, diskPoolName=diskPoolName, haResourceStatus=haResourceStatus, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareTable=shareTable, lunCompressionEnabled=lunCompressionEnabled, shareDeletionFailed=shareDeletionFailed, snmpServiceStarted=snmpServiceStarted, projectDataSizeLow=projectDataSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, projectEntry=projectEntry, nicReceiveMbps=nicReceiveMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, snapshotCreationFailed=snapshotCreationFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, lunReadMbps=lunReadMbps, haResourceActiveNode=haResourceActiveNode, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, lunWriteIops=lunWriteIops, ipmiCurrent=ipmiCurrent, fcPortOffline=fcPortOffline, snapshotDeleteFailed=snapshotDeleteFailed, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolDataSizeHigh=poolDataSizeHigh, poolDataReadLatency=poolDataReadLatency, poolHealth=poolHealth, lunDataSizeHigh=lunDataSizeHigh, shareCIFSWriteMbps=shareCIFSWriteMbps, targetGroupMemberAdded=targetGroupMemberAdded, memoryFailure=memoryFailure, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, ipmiThreshold=ipmiThreshold, smisServiceStopped=smisServiceStopped, iscsiTargetReadLatency=iscsiTargetReadLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, replicationFailed=replicationFailed, shareNFSReadMbps=shareNFSReadMbps, projectQuotaFinished=projectQuotaFinished, poolUsedSizeLow=poolUsedSizeLow, fcTotalWriteIops=fcTotalWriteIops, nicName=nicName, projectFreeSizeLow=projectFreeSizeLow, lunReadIops=lunReadIops, lunIndex=lunIndex, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareDeleted=shareDeleted)
