...
ObjectIdentity, TimeTicks, Bits, IpAddress, NotificationType, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Counter64, Counter32, Unsigned32, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "Bits", "IpAddress", "NotificationType", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Counter64", "Counter32", "Unsigned32", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", snapshotCloningFailed=snapshotCloningFailed, diskGoneOffline=diskGoneOffline, cacheRAMReads=cacheRAMReads, aclMigrationCompleted=aclMigrationCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, upgradeStarted=upgradeStarted, poolIndex=poolIndex, poolQuotaFinished=poolQuotaFinished, haResourcesTable=haResourcesTable, userLoginFailed=userLoginFailed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectName=projectName, projectTable=projectTable, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectSnapshotSizeLow=projectSnapshotSizeLow, smisServiceStartFailed=smisServiceStartFailed, poolReadCacheReadLatency=poolReadCacheReadLatency, notificationSensorNumber=notificationSensorNumber, sensorFailureEvent=sensorFailureEvent, ipmiTemperature=ipmiTemperature, upgradeDownloadFailed=upgradeDownloadFailed, poolTable=poolTable, poolMetaWriteIops=poolMetaWriteIops, snapshotRollbackCompleted=snapshotRollbackCompleted, diskSequentialIOCount=diskSequentialIOCount, fcTargetReadIops=fcTargetReadIops, poolAvgReadLatency=poolAvgReadLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, shareCIFSReadLatency=shareCIFSReadLatency, projectShareCount=projectShareCount, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, cpuInterrupts=cpuInterrupts, lunReadMbps=lunReadMbps, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, haControllerB_Name=haControllerB_Name, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, lunIndex=lunIndex, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, nicTransmitMbps=nicTransmitMbps, haResources=haResources, shareDataSizeLow=shareDataSizeLow, memoryFailure=memoryFailure, poolUpgraded=poolUpgraded, tegileArray=tegileArray, diskAlias=diskAlias, iscsiInitiatorName=iscsiInitiatorName, fcTotalWriteIops=fcTotalWriteIops, haResourceIndex=haResourceIndex, replicationAborted=replicationAborted, networkInterfaceUp=networkInterfaceUp, diskTotalWriteMbps=diskTotalWriteMbps, currentNotificationGroup=currentNotificationGroup, poolExpanded=poolExpanded, upgradeFailed=upgradeFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, cacheSSDReads=cacheSSDReads, cifsTotalWriteIops=cifsTotalWriteIops, poolImported=poolImported, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiTargetReadIops=iscsiTargetReadIops, poolTotalReadIops=poolTotalReadIops, nvdimmFailUnknownError=nvdimmFailUnknownError, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunFreeSizeLow=lunFreeSizeLow, shareReservedSizeHigh=shareReservedSizeHigh, diskAvgReadLatency=diskAvgReadLatency, shareReservedSizeLow=shareReservedSizeLow, poolSizeHigh=poolSizeHigh, targetGroupCreateCompleted=targetGroupCreateCompleted, shareCIFSWriteLatency=shareCIFSWriteLatency, poolHealth=poolHealth, cifsTotalReadIops=cifsTotalReadIops, tegileGroups=tegileGroups, targetGroupDeleteCompleted=targetGroupDeleteCompleted, haResourceEntry=haResourceEntry, diskChassisIdx=diskChassisIdx, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiInitiatorGroup=iscsiInitiatorGroup, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolOwnerController=poolOwnerController, cifsTotalWriteMbps=cifsTotalWriteMbps, ipmiMemory=ipmiMemory, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, network=network, poolEntry=poolEntry, upgradeDownloadStarted=upgradeDownloadStarted, fcTargets=fcTargets, notificationTime=notificationTime, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolDataWriteLatency=poolDataWriteLatency, projectEntry=projectEntry, shareNFSReadIops=shareNFSReadIops, nicEntry=nicEntry, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, unknownSensorEvent=unknownSensorEvent, ntpServerTimeDrift=ntpServerTimeDrift, lunEntry=lunEntry, tegile=tegile, fcTargetEntry=fcTargetEntry, nicName=nicName, fcTotalWriteMbps=fcTotalWriteMbps, replicationComplete=replicationComplete, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, notificationSensorAction=notificationSensorAction, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiTargetGroupError=iscsiTargetGroupError, replicationPaused=replicationPaused, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskSlowIo=diskSlowIo, iscsiTargetsTable=iscsiTargetsTable, lunWriteMbps=lunWriteMbps, lunDataSizeHigh=lunDataSizeHigh, diskTotalReadIops=diskTotalReadIops, lunCompressionEnabled=lunCompressionEnabled, controllerTimeDrift=controllerTimeDrift, projectFreeSizeLow=projectFreeSizeLow, smbSocketFailure=smbSocketFailure, notificationThresholdTriggerValue=notificationThresholdTriggerValue, haResourceDescription=haResourceDescription, projectCompressionEnabled=projectCompressionEnabled, networkIpmpGroupUp=networkIpmpGroupUp, poolTotalWriteIops=poolTotalWriteIops, nfsTotalWriteIops=nfsTotalWriteIops, poolReadCacheReadMbps=poolReadCacheReadMbps, diskEntry=diskEntry, poolDataWriteMbps=poolDataWriteMbps, iscsiTargetIndex=iscsiTargetIndex, poolSizeLow=poolSizeLow, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, upgradeCompleted=upgradeCompleted, snmpServiceStarted=snmpServiceStarted, lunProtocol=lunProtocol, iscsiTargetReadMbps=iscsiTargetReadMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectTotalSaving=projectTotalSaving, nvdimmFailSoftError=nvdimmFailSoftError, projectCreatedSuccessfully=projectCreatedSuccessfully, lunProjectName=lunProjectName, fcInitiatorsTable=fcInitiatorsTable, snapshotDeleteFailed=snapshotDeleteFailed, shareCreatedSuccessfully=shareCreatedSuccessfully, projectPoolName=projectPoolName, poolReadCacheReadIops=poolReadCacheReadIops, shareCIFSReadIops=shareCIFSReadIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, fcTargetGroup=fcTargetGroup, cacheTotalWriteIops=cacheTotalWriteIops, poolMetaWriteMbps=poolMetaWriteMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskState=diskState, ipmiVoltage=ipmiVoltage, diskTable=diskTable, poolCreated=poolCreated, deleteFolderFailed=deleteFolderFailed, sharePoolName=sharePoolName, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskTotalWriteIops=diskTotalWriteIops, nfsTotalWriteMbps=nfsTotalWriteMbps, haResourceStatus=haResourceStatus, fcTargetsTable=fcTargetsTable, projectLUNs=projectLUNs, poolDataReadMbps=poolDataReadMbps, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareNFSReadMbps=shareNFSReadMbps, lunPoolName=lunPoolName, sanProperties=sanProperties, poolWriteCacheWriteIops=poolWriteCacheWriteIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskType=diskType, intelliFlashSoftwareDown=intelliFlashSoftwareDown, fcInitiatorName=fcInitiatorName, lunTable=lunTable, iscsiAvgWriteLatency=iscsiAvgWriteLatency, diskSizeHigh=diskSizeHigh, shareQuotaLow=shareQuotaLow, volumeModifyCompleted=volumeModifyCompleted, maintenanceModeDisabled=maintenanceModeDisabled, upgradeTimeout=upgradeTimeout, poolDataWriteIops=poolDataWriteIops, nfsTotalReadMbps=nfsTotalReadMbps, diskDataReadIops=diskDataReadIops, iscsiWriteIops=iscsiWriteIops, lunWriteIops=lunWriteIops, lunSizeLow=lunSizeLow, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, diskDataWriteIops=diskDataWriteIops, snmpAgentVersion=snmpAgentVersion, targetGroupMemberRemoved=targetGroupMemberRemoved, poolMetaReadMbps=poolMetaReadMbps, PYSNMP_MODULE_ID=tegile, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, netbiosSocketFailure=netbiosSocketFailure, pools=pools, projectLunCount=projectLunCount, diskIndex=diskIndex, lunReservedSizeLow=lunReservedSizeLow, diskDataReadMbps=diskDataReadMbps, replicationSourceRegistered=replicationSourceRegistered, cacheTotalReadMbps=cacheTotalReadMbps, fcTargetReadMbps=fcTargetReadMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, diskPoolName=diskPoolName, fcInitiatorIndex=fcInitiatorIndex, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunGUID=lunGUID, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolTotalWriteMbps=poolTotalWriteMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolExported=poolExported, networkTotalReceiveMbps=networkTotalReceiveMbps, shareMountPoint=shareMountPoint, shareDeleted=shareDeleted, snapshotRollbackFailed=snapshotRollbackFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, notificationReadingUnit=notificationReadingUnit, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, nicMTU=nicMTU, shareCIFSWriteIops=shareCIFSWriteIops, poolUsedSizeLow=poolUsedSizeLow, aclMigrationStarted=aclMigrationStarted, projectQuotaSizeLow=projectQuotaSizeLow, haControllerA_Name=haControllerA_Name, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolMetaReadLatency=poolMetaReadLatency, poolFreeSizeLow=poolFreeSizeLow, shareCIFSReadMbps=shareCIFSReadMbps, poolDataReadLatency=poolDataReadLatency, cacheTotalWriteMbps=cacheTotalWriteMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolDataReadIops=poolDataReadIops, controllerHardwareModel=controllerHardwareModel, controllerDown=controllerDown, fcTargetWriteLatency=fcTargetWriteLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, shareNFSWriteIops=shareNFSWriteIops, lunWriteLatency=lunWriteLatency, nfsAvgReadLatency=nfsAvgReadLatency, haControllerA_IPAddr=haControllerA_IPAddr, iscsiTargetAuth=iscsiTargetAuth, ipmiCurrent=ipmiCurrent, diskError=diskError, iscsiTargetWriteMbps=iscsiTargetWriteMbps, snapshotCloneCompleted=snapshotCloneCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, haResourceActiveNode=haResourceActiveNode, poolTotalReadMbps=poolTotalReadMbps)
mibBuilder.exportSymbols("TEGILE-MIB", projectQuotaSizeHigh=projectQuotaSizeHigh, haControllerB_IPAddr=haControllerB_IPAddr, poolName=poolName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, diskSizeLow=diskSizeLow, volumeDeleteFailed=volumeDeleteFailed, smisServiceStopFailed=smisServiceStopFailed, basicCompliance=basicCompliance, fcTargetIndex=fcTargetIndex, poolDegraded=poolDegraded, ipmiThreshold=ipmiThreshold, lunSnapshotSizeLow=lunSnapshotSizeLow, poolMetaWriteLatency=poolMetaWriteLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolMetaReadIops=poolMetaReadIops, shareEntry=shareEntry, iscsiTargetEntry=iscsiTargetEntry, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snmpServiceStopped=snmpServiceStopped, iscsiInitiatorEntry=iscsiInitiatorEntry, upgradeDownloadCompleted=upgradeDownloadCompleted, notifications=notifications, shareTable=shareTable, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareProjectName=shareProjectName, smisServiceStopped=smisServiceStopped, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolDeletionFailed=poolDeletionFailed, notificationSeverity=notificationSeverity, replicationTargetDeleted=replicationTargetDeleted, properties=properties, shareCompressedRatio=shareCompressedRatio, poolDeleted=poolDeleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, fcTotalReadMbps=fcTotalReadMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, fcPortOffline=fcPortOffline, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, deleteFolderCompleted=deleteFolderCompleted, snmpServiceStartFailed=snmpServiceStartFailed, fcTotalReadIops=fcTotalReadIops, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunCompressedRatio=lunCompressedRatio, controllerUp=controllerUp, fcAvgReadLatency=fcAvgReadLatency, shareCompressionEnabled=shareCompressionEnabled, networkIpmpGroupDown=networkIpmpGroupDown, shareDataSizeHigh=shareDataSizeHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, diskCount=diskCount, notificationEventCode=notificationEventCode, spareDiskReplaced=spareDiskReplaced, replicationFailed=replicationFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, fcPortOnline=fcPortOnline, poolUsedSizeHigh=poolUsedSizeHigh, poolFreeSizeHigh=poolFreeSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, ipmiOther=ipmiOther, fcTargetModifyCompleted=fcTargetModifyCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiTotalReadMbps=iscsiTotalReadMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, projectIndex=projectIndex, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareQuotaHigh=shareQuotaHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiTotalReadIops=iscsiTotalReadIops, projectFreeSizeHigh=projectFreeSizeHigh, nicTable=nicTable, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, fcTargetReadLatency=fcTargetReadLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, lunDedupEnabled=lunDedupEnabled, maintenanceModeEnabled=maintenanceModeEnabled, cifsAvgWriteLatency=cifsAvgWriteLatency, smisServiceStarted=smisServiceStarted, diskDataWriteMbps=diskDataWriteMbps, tegileArray_notifications=tegileArray_notifications, tegileConformance=tegileConformance, iscsiTargetAlias=iscsiTargetAlias, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiTargetWriteIops=iscsiTargetWriteIops, adServerTimeDrift=adServerTimeDrift, lunTargetGroup=lunTargetGroup, notificationReadingTriggerValue=notificationReadingTriggerValue, fcTargetWriteIops=fcTargetWriteIops, projectDedupEnabled=projectDedupEnabled, poolReadCacheWriteIops=poolReadCacheWriteIops, nvdimmFailInitializationError=nvdimmFailInitializationError, poolAvgWriteLatency=poolAvgWriteLatency, haControllerB_Uptime=haControllerB_Uptime, fcAvgWriteLatency=fcAvgWriteLatency, projectShares=projectShares, targetGroupMemberAdded=targetGroupMemberAdded, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, cifsTotalReadMbps=cifsTotalReadMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcProperties=fcProperties, notificationComponentName=notificationComponentName, lunReadLatency=lunReadLatency, shareQuotaFinished=shareQuotaFinished, nicIndex=nicIndex, lunReadIops=lunReadIops, fcInitiators=fcInitiators, volumeDeleteCompleted=volumeDeleteCompleted, projectQuotaFinished=projectQuotaFinished, ipmiPowerSupply=ipmiPowerSupply, networkInterfaceDown=networkInterfaceDown, ipmiFan=ipmiFan, haResourceName=haResourceName, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareIndex=shareIndex, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, nicReceiveMbps=nicReceiveMbps, iscsiTargetName=iscsiTargetName, fcTargetName=fcTargetName, nicState=nicState, currentObjectGroup=currentObjectGroup, haControllerA_Uptime=haControllerA_Uptime, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiInitiators=iscsiInitiators, cacheTotalReadIops=cacheTotalReadIops, diskTotalReadMbps=diskTotalReadMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, notificationSensorSuspect=notificationSensorSuspect, notificationObjects=notificationObjects, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunDataSizeLow=lunDataSizeLow, volumeCreatedSuccessfully=volumeCreatedSuccessfully, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, nfsTotalReadIops=nfsTotalReadIops, shareDedupEnabled=shareDedupEnabled, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, snapshotCreationFailed=snapshotCreationFailed, replicationStarted=replicationStarted, diskRandomIOCount=diskRandomIOCount, projectDeleted=projectDeleted, projectDataSizeLow=projectDataSizeLow, lunBlockSize=lunBlockSize, snmpServiceStopFailed=snmpServiceStopFailed, iscsiTargetError=iscsiTargetError, notificationDescription=notificationDescription, lunName=lunName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, fcTargetStatus=fcTargetStatus, diskAvgWriteLatency=diskAvgWriteLatency, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, tegileCompliances=tegileCompliances, fcInitiatorGroup=fcInitiatorGroup, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, poolTotalSaving=poolTotalSaving, alertsCleanupCompleted=alertsCleanupCompleted, poolProjects=poolProjects, lunReservedSizeHigh=lunReservedSizeHigh, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, projectDeletionFailed=projectDeletionFailed, cpuSystemCalls=cpuSystemCalls, poolDataSizeHigh=poolDataSizeHigh, projectDataSizeHigh=projectDataSizeHigh, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, replicationResumed=replicationResumed, projectModified=projectModified, testNotification=testNotification, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, disks=disks, lunFreeSizeHigh=lunFreeSizeHigh, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareCIFSEnabled=shareCIFSEnabled, diskIOCount=diskIOCount, lunSizeHigh=lunSizeHigh, poolCount=poolCount, iscsiTargets=iscsiTargets, shareNFSWriteLatency=shareNFSWriteLatency, shareName=shareName, iscsiTargetGroup=iscsiTargetGroup, diskIsOnline=diskIsOnline, haResourceGroup=haResourceGroup, nicGroup=nicGroup, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcTargetWriteMbps=fcTargetWriteMbps, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareDeletionFailed=shareDeletionFailed, globalStatistics=globalStatistics, fcInitiatorEntry=fcInitiatorEntry, volumeQuotaFinished=volumeQuotaFinished, shareNFSReadLatency=shareNFSReadLatency, iscsiProperties=iscsiProperties, cifsAvgReadLatency=cifsAvgReadLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunInitiatorGroup=lunInitiatorGroup, shareNFSEnabled=shareNFSEnabled, iscsiInitiatorsTable=iscsiInitiatorsTable, diagnosticDataUploaded=diagnosticDataUploaded, poolState=poolState, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, replicationAbandoned=replicationAbandoned, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, notificationTargetEntityName=notificationTargetEntityName, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, cpuTotalUsage=cpuTotalUsage, poolProjectCount=poolProjectCount, notificationProps=notificationProps)
