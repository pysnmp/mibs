...
Integer32, enterprises, IpAddress, TimeTicks, ObjectIdentity, Gauge32, ModuleIdentity, Bits, MibIdentifier, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "IpAddress", "TimeTicks", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Bits", "MibIdentifier", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", nicName=nicName, nicGroup=nicGroup, projectSnapshotSizeLow=projectSnapshotSizeLow, poolAvgReadLatency=poolAvgReadLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunInitiatorGroup=lunInitiatorGroup, shareReservedSizeHigh=shareReservedSizeHigh, nicMTU=nicMTU, projectQuotaFinished=projectQuotaFinished, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolState=poolState, tegileArray=tegileArray, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, snmpServiceStartFailed=snmpServiceStartFailed, poolTotalReadMbps=poolTotalReadMbps, shareIndex=shareIndex, haResourceActiveNode=haResourceActiveNode, fcTargetStatus=fcTargetStatus, diskSequentialIOCount=diskSequentialIOCount, iscsiTotalReadMbps=iscsiTotalReadMbps, replicationStarted=replicationStarted, replicationResumed=replicationResumed, shareSnapshotSizeLow=shareSnapshotSizeLow, memoryFailure=memoryFailure, tegileCompliances=tegileCompliances, nvdimmFailDeviceError=nvdimmFailDeviceError, lunReservedSizeLow=lunReservedSizeLow, ipmiVoltage=ipmiVoltage, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolIndex=poolIndex, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolMetaReadMbps=poolMetaReadMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, replicationTargetDeleted=replicationTargetDeleted, fcInitiatorName=fcInitiatorName, smisServiceStopFailed=smisServiceStopFailed, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, snmpServiceStarted=snmpServiceStarted, properties=properties, netbiosSocketFailure=netbiosSocketFailure, diagnosticDataUploaded=diagnosticDataUploaded, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, haResourceEntry=haResourceEntry, disks=disks, networkTotalTransmitMbps=networkTotalTransmitMbps, spareDiskReplaced=spareDiskReplaced, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolMetaWriteLatency=poolMetaWriteLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, diskDataWriteIops=diskDataWriteIops, fcTargetReadIops=fcTargetReadIops, haResourceDescription=haResourceDescription, poolSizeLow=poolSizeLow, diskSizeLow=diskSizeLow, fcTargetModifyCompleted=fcTargetModifyCompleted, shareEntry=shareEntry, nicState=nicState, projectDataSizeLow=projectDataSizeLow, iscsiTargetReadIops=iscsiTargetReadIops, volumeDeleteFailed=volumeDeleteFailed, iscsiTargetIndex=iscsiTargetIndex, diskDataReadMbps=diskDataReadMbps, snapshotCloningFailed=snapshotCloningFailed, shareNFSReadMbps=shareNFSReadMbps, poolFreeSizeHigh=poolFreeSizeHigh, vmwareNFSDatastores=vmwareNFSDatastores, targetGroupCreateCompleted=targetGroupCreateCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, snapshotDeleteFailed=snapshotDeleteFailed, lunWriteIops=lunWriteIops, sensorFailureEvent=sensorFailureEvent, shareNFSReadLatency=shareNFSReadLatency, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectQuotaSizeHigh=projectQuotaSizeHigh, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, fcProperties=fcProperties, poolDataWriteMbps=poolDataWriteMbps, iscsiTargetError=iscsiTargetError, poolSizeHigh=poolSizeHigh, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, cpuTotalUsage=cpuTotalUsage, notificationTargetEntityName=notificationTargetEntityName, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunReadIops=lunReadIops, diskType=diskType, diskTotalWriteMbps=diskTotalWriteMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareCIFSReadIops=shareCIFSReadIops, fcTargetReadMbps=fcTargetReadMbps, poolExported=poolExported, fcTotalReadMbps=fcTotalReadMbps, notificationObjects=notificationObjects, upgradeCompleted=upgradeCompleted, lunProtocol=lunProtocol, pools=pools, lunSnapshotSizeLow=lunSnapshotSizeLow, cacheTotalWriteIops=cacheTotalWriteIops, cpuInterrupts=cpuInterrupts, nicTransmitMbps=nicTransmitMbps, shareMountPoint=shareMountPoint, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, haResourceIndex=haResourceIndex, projectLUNs=projectLUNs, fcInitiatorCreateFailed=fcInitiatorCreateFailed, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolDataSizeLow=poolDataSizeLow, haResourcesTable=haResourcesTable, shareProjectName=shareProjectName, nicTable=nicTable, notificationSeverity=notificationSeverity, iscsiTargetReadLatency=iscsiTargetReadLatency, ipmiCurrent=ipmiCurrent, tdpsUpgradeTimeout=tdpsUpgradeTimeout, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, targetGroupDeleteCompleted=targetGroupDeleteCompleted, sanProperties=sanProperties, projectModified=projectModified, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectCreatedSuccessfully=projectCreatedSuccessfully, poolMetaWriteIops=poolMetaWriteIops, nvdimmFailInitializationError=nvdimmFailInitializationError, diskCount=diskCount, cacheTotalReadMbps=cacheTotalReadMbps, controllerHardwareModel=controllerHardwareModel, notificationProps=notificationProps, smisServiceStarted=smisServiceStarted, replicationAbandoned=replicationAbandoned, diskAvgWriteLatency=diskAvgWriteLatency, haControllerB_Uptime=haControllerB_Uptime, iscsiWriteIops=iscsiWriteIops, fcAvgWriteLatency=fcAvgWriteLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskSlowIo=diskSlowIo, networkInterfaceDown=networkInterfaceDown, poolQuotaFinished=poolQuotaFinished, diskIOCount=diskIOCount, tegileArray_notifications=tegileArray_notifications, snapshotRollbackFailed=snapshotRollbackFailed, cacheSSDReads=cacheSSDReads, projectPoolName=projectPoolName, fcTargetWriteMbps=fcTargetWriteMbps, poolImported=poolImported, poolTotalReadIops=poolTotalReadIops, lunWriteMbps=lunWriteMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, tdpsUpgradeFailed=tdpsUpgradeFailed, nvdimmFailSoftError=nvdimmFailSoftError, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcTargetReadLatency=fcTargetReadLatency, lunSizeHigh=lunSizeHigh, nfsAvgReadLatency=nfsAvgReadLatency, lunFreeSizeHigh=lunFreeSizeHigh, cifsTotalWriteIops=cifsTotalWriteIops, networkIpmpGroupUp=networkIpmpGroupUp, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, ntpServerTimeDrift=ntpServerTimeDrift, diskDataReadIops=diskDataReadIops, tegileConformance=tegileConformance, diskSizeHigh=diskSizeHigh, poolCount=poolCount, diskTable=diskTable, projectCompressionEnabled=projectCompressionEnabled, poolWriteCacheWriteIops=poolWriteCacheWriteIops, ipmiMemory=ipmiMemory, projectDataSizeHigh=projectDataSizeHigh, volumeQuotaFinished=volumeQuotaFinished, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunIndex=lunIndex, poolName=poolName, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectQuotaSizeLow=projectQuotaSizeLow, shareNFSWriteIops=shareNFSWriteIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, upgradeFailed=upgradeFailed, fcInitiators=fcInitiators, poolOwnerController=poolOwnerController, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunReadMbps=lunReadMbps, haResources=haResources, diskChassisIdx=diskChassisIdx, lunName=lunName, iscsiInitiatorsTable=iscsiInitiatorsTable, diskTotalWriteIops=diskTotalWriteIops, fcInitiatorEntry=fcInitiatorEntry, upgradeStarted=upgradeStarted, nfsTotalWriteIops=nfsTotalWriteIops, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, aclMigrationCompleted=aclMigrationCompleted, tegileGroups=tegileGroups, diskState=diskState, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, diskEntry=diskEntry, haControllerA_Uptime=haControllerA_Uptime, shareNFSEnabled=shareNFSEnabled, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, upgradeTimeout=upgradeTimeout, diskAlias=diskAlias, poolDataWriteIops=poolDataWriteIops, diskTotalReadIops=diskTotalReadIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareDeletionFailed=shareDeletionFailed, unknownSensorEvent=unknownSensorEvent, fcTargetsTable=fcTargetsTable, smbSocketFailure=smbSocketFailure, replicationPaused=replicationPaused, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiInitiatorEntry=iscsiInitiatorEntry, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, smisServiceStopped=smisServiceStopped, poolMetaReadLatency=poolMetaReadLatency, diskDataWriteMbps=diskDataWriteMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolDataSizeHigh=poolDataSizeHigh, poolMetaReadIops=poolMetaReadIops, projectShares=projectShares, poolTotalWriteMbps=poolTotalWriteMbps, fcAvgReadLatency=fcAvgReadLatency, haResourceGroup=haResourceGroup, shareCIFSWriteIops=shareCIFSWriteIops, lunDataSizeHigh=lunDataSizeHigh, projectTotalSaving=projectTotalSaving, poolDegraded=poolDegraded, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, projectTable=projectTable, iscsiTargetName=iscsiTargetName, shareCIFSWriteMbps=shareCIFSWriteMbps, networkInterfaceUp=networkInterfaceUp, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, lunDataSizeLow=lunDataSizeLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolTable=poolTable, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, shareCreatedSuccessfully=shareCreatedSuccessfully, nfsTotalReadIops=nfsTotalReadIops, notificationReadingTriggerValue=notificationReadingTriggerValue, notifications=notifications, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, replicationSourceRegistered=replicationSourceRegistered, nicIndex=nicIndex, diskAvgReadLatency=diskAvgReadLatency, iscsiTargetGroup=iscsiTargetGroup)
mibBuilder.exportSymbols("TEGILE-MIB", poolUsedSizeHigh=poolUsedSizeHigh, notificationDescription=notificationDescription, shareCompressionEnabled=shareCompressionEnabled, poolReadCacheReadIops=poolReadCacheReadIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, haResourceName=haResourceName, nicReceiveMbps=nicReceiveMbps, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, projectFreeSizeLow=projectFreeSizeLow, webdocsUpgradeCompleted=webdocsUpgradeCompleted, maintenanceModeDisabled=maintenanceModeDisabled, fcTargets=fcTargets, lunEntry=lunEntry, snapshotCloneCompleted=snapshotCloneCompleted, projectLunCount=projectLunCount, cifsTotalReadIops=cifsTotalReadIops, fcTotalWriteIops=fcTotalWriteIops, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, snmpServiceStopFailed=snmpServiceStopFailed, nfsTotalWriteMbps=nfsTotalWriteMbps, PYSNMP_MODULE_ID=tegile, snmpServiceStopped=snmpServiceStopped, ipmiOther=ipmiOther, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareDedupEnabled=shareDedupEnabled, targetGroupMemberRemoved=targetGroupMemberRemoved, globalStatistics=globalStatistics, sharePoolName=sharePoolName, shareCIFSReadMbps=shareCIFSReadMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiInitiatorName=iscsiInitiatorName, fcTotalWriteMbps=fcTotalWriteMbps, cifsTotalReadMbps=cifsTotalReadMbps, snapshotCreationFailed=snapshotCreationFailed, poolProjectCount=poolProjectCount, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, haControllerB_IPAddr=haControllerB_IPAddr, fcTargetName=fcTargetName, shareCIFSWriteLatency=shareCIFSWriteLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunReadLatency=lunReadLatency, snmpAgentVersion=snmpAgentVersion, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, haControllerA_Name=haControllerA_Name, iscsiInitiatorIndex=iscsiInitiatorIndex, notificationComponentName=notificationComponentName, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareReservedSizeLow=shareReservedSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, fcPortOffline=fcPortOffline, fcTargetIndex=fcTargetIndex, lunDedupEnabled=lunDedupEnabled, volumeDeleteCompleted=volumeDeleteCompleted, cacheRAMReads=cacheRAMReads, intelliFlashSoftwareUp=intelliFlashSoftwareUp, lunBlockSize=lunBlockSize, deleteFolderFailed=deleteFolderFailed, networkIpmpGroupDown=networkIpmpGroupDown, poolEntry=poolEntry, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunPoolName=lunPoolName, shareTable=shareTable, poolReadCacheReadLatency=poolReadCacheReadLatency, diskError=diskError, alertsCleanupCompleted=alertsCleanupCompleted, diskPoolName=diskPoolName, lunCompressionEnabled=lunCompressionEnabled, iscsiTargetEntry=iscsiTargetEntry, testNotification=testNotification, maintenanceModeEnabled=maintenanceModeEnabled, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiInitiators=iscsiInitiators, shareCompressedRatio=shareCompressedRatio, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, shareSnapshotSizeHigh=shareSnapshotSizeHigh, deleteFolderCompleted=deleteFolderCompleted, lunWriteLatency=lunWriteLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, lunTable=lunTable, shareCIFSReadLatency=shareCIFSReadLatency, shareQuotaLow=shareQuotaLow, projectFreeSizeHigh=projectFreeSizeHigh, iscsiTargetAlias=iscsiTargetAlias, volumeModifyCompleted=volumeModifyCompleted, shareNFSWriteMbps=shareNFSWriteMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, shareDeleted=shareDeleted, notificationSensorSuspect=notificationSensorSuspect, cacheTotalReadIops=cacheTotalReadIops, notificationSensorNumber=notificationSensorNumber, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectDeletionFailed=projectDeletionFailed, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolUsedSizeLow=poolUsedSizeLow, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, replicationFailed=replicationFailed, poolExpanded=poolExpanded, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, poolHealth=poolHealth, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTargetWriteIops=fcTargetWriteIops, cifsAvgReadLatency=cifsAvgReadLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectIndex=projectIndex, fcTotalReadIops=fcTotalReadIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, fcPortOnline=fcPortOnline, basicCompliance=basicCompliance, poolDataReadLatency=poolDataReadLatency, iscsiTotalReadIops=iscsiTotalReadIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, notificationSensorAction=notificationSensorAction, poolDeletionFailed=poolDeletionFailed, fcInitiatorsTable=fcInitiatorsTable, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, lunGUID=lunGUID, poolCreated=poolCreated, poolMetaWriteMbps=poolMetaWriteMbps, shareDataSizeLow=shareDataSizeLow, haResourceStatus=haResourceStatus, lunSizeLow=lunSizeLow, iscsiProperties=iscsiProperties, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nfsTotalReadMbps=nfsTotalReadMbps, controllerDown=controllerDown, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolTotalWriteIops=poolTotalWriteIops, poolFreeSizeLow=poolFreeSizeLow, poolTotalSaving=poolTotalSaving, shareQuotaFinished=shareQuotaFinished, aclMigrationStarted=aclMigrationStarted, diskIsOnline=diskIsOnline, iscsiInitiatorGroup=iscsiInitiatorGroup, nicEntry=nicEntry, haControllerB_Name=haControllerB_Name, notificationTime=notificationTime, shareExceedThresholdWarning=shareExceedThresholdWarning, replicationComplete=replicationComplete, fcTargetWriteLatency=fcTargetWriteLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolAvgWriteLatency=poolAvgWriteLatency, smisServiceStartFailed=smisServiceStartFailed, adServerTimeDrift=adServerTimeDrift, diskIndex=diskIndex, targetGroupMemberAdded=targetGroupMemberAdded, lunFreeSizeLow=lunFreeSizeLow, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, projectDeleted=projectDeleted, notificationEventCode=notificationEventCode, ipmiPowerSupply=ipmiPowerSupply, lunTargetGroup=lunTargetGroup, projectThresholdExceedWarning=projectThresholdExceedWarning, shareDataSizeHigh=shareDataSizeHigh, projectEntry=projectEntry, upgradeDownloadFailed=upgradeDownloadFailed, notificationReadingUnit=notificationReadingUnit, poolDataReadIops=poolDataReadIops, diskTotalReadMbps=diskTotalReadMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskRandomIOCount=diskRandomIOCount, shareNFSReadIops=shareNFSReadIops, cacheTotalWriteMbps=cacheTotalWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, controllerUp=controllerUp, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolDataWriteLatency=poolDataWriteLatency, poolProjects=poolProjects, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTargetAuth=iscsiTargetAuth, cpuSystemCalls=cpuSystemCalls, fcInitiatorGroup=fcInitiatorGroup, shareName=shareName, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, projectName=projectName, poolUpgraded=poolUpgraded, userLoginFailed=userLoginFailed, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectShareCount=projectShareCount, projectDedupEnabled=projectDedupEnabled, shareCIFSEnabled=shareCIFSEnabled, lunReservedSizeHigh=lunReservedSizeHigh, lunCompressedRatio=lunCompressedRatio, ipmiFan=ipmiFan, controllerTimeDrift=controllerTimeDrift, iscsiTargetsTable=iscsiTargetsTable, fcTargetEntry=fcTargetEntry, shareQuotaHigh=shareQuotaHigh, ipmiThreshold=ipmiThreshold, iscsiTargets=iscsiTargets, lunProjectName=lunProjectName, upgradeDownloadStarted=upgradeDownloadStarted, fcInitiatorIndex=fcInitiatorIndex, poolDataReadMbps=poolDataReadMbps, replicationAborted=replicationAborted, diskGoneOffline=diskGoneOffline, iscsiTargetWriteMbps=iscsiTargetWriteMbps, ipmiTemperature=ipmiTemperature, currentNotificationGroup=currentNotificationGroup, currentObjectGroup=currentObjectGroup, tegile=tegile, poolDeleted=poolDeleted, haControllerA_IPAddr=haControllerA_IPAddr, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, network=network)
