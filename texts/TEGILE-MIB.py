...
# Produced by pysmi-1.1.8 at Tue Jan 11 20:54:20 2022
...
TimeTicks, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, ModuleIdentity, Counter32, Gauge32, MibIdentifier, IpAddress, Integer32, ObjectIdentity, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "ModuleIdentity", "Counter32", "Gauge32", "MibIdentifier", "IpAddress", "Integer32", "ObjectIdentity", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareQuotaLow=shareQuotaLow, diskState=diskState, lunBlockSize=lunBlockSize, lunTable=lunTable, shareProjectName=shareProjectName, shareCIFSReadMbps=shareCIFSReadMbps, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, snmpServiceStarted=snmpServiceStarted, poolUpgraded=poolUpgraded, intelliFlashSoftwareDown=intelliFlashSoftwareDown, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargetIndex=iscsiTargetIndex, nfsAvgReadLatency=nfsAvgReadLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiTargetGroup=iscsiTargetGroup, webdocsUpgradeCompleted=webdocsUpgradeCompleted, lunInitiatorGroup=lunInitiatorGroup, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiTotalReadIops=iscsiTotalReadIops, cifsTotalWriteMbps=cifsTotalWriteMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskEntry=diskEntry, networkTotalTransmitMbps=networkTotalTransmitMbps, poolProjects=poolProjects, nfsTotalWriteMbps=nfsTotalWriteMbps, nicReceiveMbps=nicReceiveMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectLunCount=projectLunCount, maintenanceModeDisabled=maintenanceModeDisabled, lunReservedSizeHigh=lunReservedSizeHigh, userLoginFailed=userLoginFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, shareExceedThresholdWarning=shareExceedThresholdWarning, fcTargetWriteLatency=fcTargetWriteLatency, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareIndex=shareIndex, diskTotalReadMbps=diskTotalReadMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, controllerTimeDrift=controllerTimeDrift, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcTargetGroup=fcTargetGroup, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcAvgWriteLatency=fcAvgWriteLatency, network=network, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, cpuInterrupts=cpuInterrupts, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiTargetName=iscsiTargetName, nicMTU=nicMTU, nvdimmFailDeviceError=nvdimmFailDeviceError, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolDeleted=poolDeleted, deleteFolderFailed=deleteFolderFailed, fcTargets=fcTargets, poolMetaReadIops=poolMetaReadIops, poolDataReadMbps=poolDataReadMbps, lunFreeSizeLow=lunFreeSizeLow, poolProjectCount=poolProjectCount, fcPortOffline=fcPortOffline, volumeModifyCompleted=volumeModifyCompleted, iscsiAvgReadLatency=iscsiAvgReadLatency, projectDeletionFailed=projectDeletionFailed, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskSizeHigh=diskSizeHigh, ipmiTemperature=ipmiTemperature, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareCIFSReadLatency=shareCIFSReadLatency, fcTargetReadIops=fcTargetReadIops, fcInitiatorName=fcInitiatorName, nicName=nicName, poolUsedSizeLow=poolUsedSizeLow, projectThresholdExceedWarning=projectThresholdExceedWarning, shareQuotaHigh=shareQuotaHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, haControllerA_Uptime=haControllerA_Uptime, shareCompressionEnabled=shareCompressionEnabled, notificationSeverity=notificationSeverity, shareCIFSEnabled=shareCIFSEnabled, fcTotalWriteMbps=fcTotalWriteMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectCompressionEnabled=projectCompressionEnabled, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareNFSWriteMbps=shareNFSWriteMbps, haControllerA_Name=haControllerA_Name, smbSocketFailure=smbSocketFailure, alertsCleanupCompleted=alertsCleanupCompleted, upgradeCompleted=upgradeCompleted, snapshotDeleteFailed=snapshotDeleteFailed, replicationPaused=replicationPaused, snapshotCloneCompleted=snapshotCloneCompleted, haResourceDescription=haResourceDescription, haResources=haResources, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, diskPoolName=diskPoolName, iscsiTargetAuth=iscsiTargetAuth, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, shareReservedSizeLow=shareReservedSizeLow, controllerUp=controllerUp, maintenanceModeEnabled=maintenanceModeEnabled, upgradeTimeout=upgradeTimeout, lunSnapshotSizeLow=lunSnapshotSizeLow, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolMetaWriteLatency=poolMetaWriteLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, fcTargetWriteMbps=fcTargetWriteMbps, projectTable=projectTable, lunDataSizeHigh=lunDataSizeHigh, diskTotalWriteMbps=diskTotalWriteMbps, snmpAgentVersion=snmpAgentVersion, sharePoolName=sharePoolName, shareCreatedSuccessfully=shareCreatedSuccessfully, diskDataWriteIops=diskDataWriteIops, poolReadCacheReadIops=poolReadCacheReadIops, poolFreeSizeLow=poolFreeSizeLow, iscsiTotalReadMbps=iscsiTotalReadMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolQuotaFinished=poolQuotaFinished, poolOwnerController=poolOwnerController, shareNFSReadLatency=shareNFSReadLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectDataSizeHigh=projectDataSizeHigh, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, projectName=projectName, poolSizeHigh=poolSizeHigh, shareNFSEnabled=shareNFSEnabled, upgradeDownloadStarted=upgradeDownloadStarted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, nicGroup=nicGroup, smisServiceStopped=smisServiceStopped, notificationReadingTriggerValue=notificationReadingTriggerValue, poolUsedSizeHigh=poolUsedSizeHigh, nvdimmFailSoftError=nvdimmFailSoftError, nfsTotalReadMbps=nfsTotalReadMbps, sanProperties=sanProperties, fcTargetName=fcTargetName, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, haResourcesTable=haResourcesTable, poolDataWriteMbps=poolDataWriteMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiTargetReadIops=iscsiTargetReadIops, lunFreeSizeHigh=lunFreeSizeHigh, diskDataReadMbps=diskDataReadMbps, poolMetaReadMbps=poolMetaReadMbps, spareDiskReplaced=spareDiskReplaced, nvdimmFailUnknownError=nvdimmFailUnknownError, poolImported=poolImported, webdocsUpgradeFailed=webdocsUpgradeFailed, diskTable=diskTable, tegile=tegile, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolAvgWriteLatency=poolAvgWriteLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, tegileCompliances=tegileCompliances, basicCompliance=basicCompliance, upgradeDownloadCompleted=upgradeDownloadCompleted, fcTotalReadMbps=fcTotalReadMbps, diskSlowIo=diskSlowIo, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, nfsTotalReadIops=nfsTotalReadIops, projectEntry=projectEntry, projectFreeSizeHigh=projectFreeSizeHigh, fcInitiators=fcInitiators, replicationComplete=replicationComplete, diskCount=diskCount, ntpServerTimeDrift=ntpServerTimeDrift, controllerDown=controllerDown, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, nfsTotalWriteIops=nfsTotalWriteIops, networkIpmpGroupDown=networkIpmpGroupDown, projectLUNs=projectLUNs, fcTargetEntry=fcTargetEntry, diskAlias=diskAlias, lunTargetGroup=lunTargetGroup, adServerTimeDrift=adServerTimeDrift, diagnosticDataUploaded=diagnosticDataUploaded, shareDeleted=shareDeleted, cifsAvgReadLatency=cifsAvgReadLatency, snapshotCloningFailed=snapshotCloningFailed, poolDataReadIops=poolDataReadIops, poolMetaReadLatency=poolMetaReadLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, smisServiceStartFailed=smisServiceStartFailed, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareNFSWriteLatency=shareNFSWriteLatency, poolTable=poolTable, notificationThresholdTriggerValue=notificationThresholdTriggerValue, cacheTotalWriteMbps=cacheTotalWriteMbps, lunPoolName=lunPoolName, poolCount=poolCount, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, ipmiOther=ipmiOther, projectIndex=projectIndex, ipmiPowerSupply=ipmiPowerSupply, iscsiTargetWriteIops=iscsiTargetWriteIops, fcProperties=fcProperties, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, cacheTotalWriteIops=cacheTotalWriteIops, lunWriteIops=lunWriteIops, testNotification=testNotification, snapshotRollbackFailed=snapshotRollbackFailed, fcInitiatorsTable=fcInitiatorsTable, lunCompressionEnabled=lunCompressionEnabled, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareCIFSReadIops=shareCIFSReadIops, cacheSSDReads=cacheSSDReads, networkInterfaceDown=networkInterfaceDown, fcTargetWriteIops=fcTargetWriteIops, diskAvgReadLatency=diskAvgReadLatency, notificationSensorNumber=notificationSensorNumber, replicationFailed=replicationFailed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, networkIpmpGroupUp=networkIpmpGroupUp, diskIsOnline=diskIsOnline, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, notificationObjects=notificationObjects, fcTargetReadMbps=fcTargetReadMbps, haResourceActiveNode=haResourceActiveNode, poolExpanded=poolExpanded, sensorFailureEvent=sensorFailureEvent, lunEntry=lunEntry, shareNFSReadMbps=shareNFSReadMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, fcTargetStatus=fcTargetStatus, smisServiceStopFailed=smisServiceStopFailed, notificationEventCode=notificationEventCode, poolDataSizeLow=poolDataSizeLow, iscsiTargetAlias=iscsiTargetAlias, poolReadCacheReadMbps=poolReadCacheReadMbps, deleteFolderCompleted=deleteFolderCompleted, diskIOCount=diskIOCount, shareName=shareName, cacheRAMReads=cacheRAMReads, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, shareDataSizeLow=shareDataSizeLow, ipmiCurrent=ipmiCurrent)
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetIndex=fcTargetIndex, fcPortOnline=fcPortOnline, projectCreatedSuccessfully=projectCreatedSuccessfully, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, fcTotalReadIops=fcTotalReadIops, diskIndex=diskIndex, cifsTotalReadIops=cifsTotalReadIops, poolDeletionFailed=poolDeletionFailed, shareReservedSizeHigh=shareReservedSizeHigh, tegileArray_notifications=tegileArray_notifications, notifications=notifications, diskGoneOffline=diskGoneOffline, iscsiTargetsTable=iscsiTargetsTable, poolTotalWriteMbps=poolTotalWriteMbps, replicationAborted=replicationAborted, poolDataReadLatency=poolDataReadLatency, vmwareNFSDatastores=vmwareNFSDatastores, iscsiInitiatorGroup=iscsiInitiatorGroup, targetGroupMemberAdded=targetGroupMemberAdded, iscsiProperties=iscsiProperties, diskChassisIdx=diskChassisIdx, poolTotalReadIops=poolTotalReadIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, ipmiFan=ipmiFan, PYSNMP_MODULE_ID=tegile, poolDataSizeHigh=poolDataSizeHigh, poolFreeSizeHigh=poolFreeSizeHigh, diskError=diskError, iscsiTargetWriteLatency=iscsiTargetWriteLatency, networkTotalReceiveMbps=networkTotalReceiveMbps, poolDataWriteLatency=poolDataWriteLatency, volumeQuotaFinished=volumeQuotaFinished, replicationAbandoned=replicationAbandoned, upgradeStarted=upgradeStarted, projectPoolName=projectPoolName, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareCIFSWriteIops=shareCIFSWriteIops, upgradeFailed=upgradeFailed, projectShares=projectShares, targetGroupDeleteCompleted=targetGroupDeleteCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, lunDataSizeLow=lunDataSizeLow, notificationDescription=notificationDescription, currentNotificationGroup=currentNotificationGroup, fcInitiatorIndex=fcInitiatorIndex, notificationReadingUnit=notificationReadingUnit, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcAvgReadLatency=fcAvgReadLatency, fcTargetReadLatency=fcTargetReadLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunReadLatency=lunReadLatency, replicationSourceRegistered=replicationSourceRegistered, iscsiInitiatorName=iscsiInitiatorName, controllerHardwareModel=controllerHardwareModel, ipmiThreshold=ipmiThreshold, poolEntry=poolEntry, cifsTotalWriteIops=cifsTotalWriteIops, projectTotalSaving=projectTotalSaving, haResourceGroup=haResourceGroup, cpuTotalUsage=cpuTotalUsage, projectQuotaSizeHigh=projectQuotaSizeHigh, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareTable=shareTable, haResourceIndex=haResourceIndex, volumeDeleteCompleted=volumeDeleteCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolAvgReadLatency=poolAvgReadLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolMetaWriteMbps=poolMetaWriteMbps, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, smisServiceStarted=smisServiceStarted, poolTotalSaving=poolTotalSaving, lunProjectName=lunProjectName, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiTargetEntry=iscsiTargetEntry, nicTable=nicTable, shareCompressedRatio=shareCompressedRatio, snapshotRollbackCompleted=snapshotRollbackCompleted, shareDedupEnabled=shareDedupEnabled, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, diskTotalWriteIops=diskTotalWriteIops, ipmiMemory=ipmiMemory, iscsiTargets=iscsiTargets, haControllerB_Uptime=haControllerB_Uptime, lunIndex=lunIndex, iscsiTargetReadLatency=iscsiTargetReadLatency, poolCreated=poolCreated, replicationResumed=replicationResumed, poolHealth=poolHealth, poolName=poolName, cpuSystemCalls=cpuSystemCalls, memoryFailure=memoryFailure, nicState=nicState, lunName=lunName, iscsiTargetReadMbps=iscsiTargetReadMbps, nicTransmitMbps=nicTransmitMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, haControllerB_IPAddr=haControllerB_IPAddr, poolSizeLow=poolSizeLow, lunWriteLatency=lunWriteLatency, shareQuotaFinished=shareQuotaFinished, poolTotalWriteIops=poolTotalWriteIops, networkInterfaceUp=networkInterfaceUp, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, lunSizeLow=lunSizeLow, projectDataSizeLow=projectDataSizeLow, notificationSensorSuspect=notificationSensorSuspect, lunProtocol=lunProtocol, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, tegileGroups=tegileGroups, fcTotalWriteIops=fcTotalWriteIops, targetGroupMemberRemoved=targetGroupMemberRemoved, diskSequentialIOCount=diskSequentialIOCount, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haControllerA_IPAddr=haControllerA_IPAddr, notificationProps=notificationProps, notificationTime=notificationTime, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunReadIops=lunReadIops, haResourceName=haResourceName, snmpServiceStopFailed=snmpServiceStopFailed, haResourceEntry=haResourceEntry, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, snmpServiceStartFailed=snmpServiceStartFailed, poolState=poolState, tegileArray=tegileArray, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, pools=pools, snmpServiceStopped=snmpServiceStopped, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, volumeDeleteFailed=volumeDeleteFailed, unknownSensorEvent=unknownSensorEvent, shareNFSWriteIops=shareNFSWriteIops, shareCIFSWriteLatency=shareCIFSWriteLatency, properties=properties, nicIndex=nicIndex, cacheTotalReadIops=cacheTotalReadIops, fcTargetsTable=fcTargetsTable, fcTargetModifyCompleted=fcTargetModifyCompleted, shareMountPoint=shareMountPoint, cifsTotalReadMbps=cifsTotalReadMbps, poolDataWriteIops=poolDataWriteIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, projectDeleted=projectDeleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, diskSizeLow=diskSizeLow, notificationTargetEntityName=notificationTargetEntityName, diskTotalReadIops=diskTotalReadIops, haControllerB_Name=haControllerB_Name, netbiosSocketFailure=netbiosSocketFailure, notificationComponentName=notificationComponentName, projectQuotaFinished=projectQuotaFinished, upgradeDownloadFailed=upgradeDownloadFailed, lunGUID=lunGUID, globalStatistics=globalStatistics, projectDedupEnabled=projectDedupEnabled, diskDataWriteMbps=diskDataWriteMbps, nicEntry=nicEntry, aclMigrationStarted=aclMigrationStarted, shareDeletionFailed=shareDeletionFailed, ipmiVoltage=ipmiVoltage, lunWriteMbps=lunWriteMbps, lunReadMbps=lunReadMbps, diskDataReadIops=diskDataReadIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiWriteIops=iscsiWriteIops, disks=disks, iscsiInitiators=iscsiInitiators, snapshotCreationFailed=snapshotCreationFailed, notificationSensorAction=notificationSensorAction, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectModified=projectModified, poolReadCacheReadLatency=poolReadCacheReadLatency, poolMetaWriteIops=poolMetaWriteIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolIndex=poolIndex, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, diskType=diskType, projectShareCount=projectShareCount, aclMigrationCompleted=aclMigrationCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolExported=poolExported, haResourceStatus=haResourceStatus, poolDegraded=poolDegraded, cifsAvgWriteLatency=cifsAvgWriteLatency, replicationStarted=replicationStarted, currentObjectGroup=currentObjectGroup, poolTotalReadMbps=poolTotalReadMbps, lunCompressedRatio=lunCompressedRatio, diskAvgWriteLatency=diskAvgWriteLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunReservedSizeLow=lunReservedSizeLow, fcInitiatorEntry=fcInitiatorEntry, lunDedupEnabled=lunDedupEnabled, iscsiTargetGroupError=iscsiTargetGroupError, fcInitiatorGroup=fcInitiatorGroup, nvdimmFailInitializationError=nvdimmFailInitializationError, shareEntry=shareEntry, tegileConformance=tegileConformance, iscsiTargetError=iscsiTargetError, diskRandomIOCount=diskRandomIOCount, replicationTargetDeleted=replicationTargetDeleted, projectFreeSizeLow=projectFreeSizeLow, shareDataSizeHigh=shareDataSizeHigh, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareCIFSWriteMbps=shareCIFSWriteMbps, projectQuotaSizeLow=projectQuotaSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, lunSizeHigh=lunSizeHigh)
