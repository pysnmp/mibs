...
IpAddress, MibIdentifier, Integer32, Counter64, Unsigned32, TimeTicks, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, ModuleIdentity, ObjectIdentity, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "Integer32", "Counter64", "Unsigned32", "TimeTicks", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "ModuleIdentity", "ObjectIdentity", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcInitiatorName=fcInitiatorName, diskDataWriteMbps=diskDataWriteMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, vmwareNFSDatastores=vmwareNFSDatastores, replicationStarted=replicationStarted, nicMTU=nicMTU, shareCompressedRatio=shareCompressedRatio, haControllerA_IPAddr=haControllerA_IPAddr, iscsiTotalReadMbps=iscsiTotalReadMbps, poolDeleted=poolDeleted, poolMetaReadLatency=poolMetaReadLatency, poolUsedSizeLow=poolUsedSizeLow, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, projectQuotaSizeLow=projectQuotaSizeLow, poolMetaWriteMbps=poolMetaWriteMbps, ipmiFan=ipmiFan, notificationTime=notificationTime, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, smisServiceStopped=smisServiceStopped, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, haResourceDescription=haResourceDescription, replicationTargetDeleted=replicationTargetDeleted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, ipmiTemperature=ipmiTemperature, diskDataReadIops=diskDataReadIops, iscsiTargetAlias=iscsiTargetAlias, notificationSeverity=notificationSeverity, networkIpmpGroupUp=networkIpmpGroupUp, fcTotalReadMbps=fcTotalReadMbps, projectDataSizeHigh=projectDataSizeHigh, lunBlockSize=lunBlockSize, lunCompressionEnabled=lunCompressionEnabled, notificationReadingUnit=notificationReadingUnit, iscsiInitiatorEntry=iscsiInitiatorEntry, nfsTotalWriteIops=nfsTotalWriteIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, projectPoolName=projectPoolName, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunProjectName=lunProjectName, tegileArray_notifications=tegileArray_notifications, sharePoolName=sharePoolName, volumeQuotaFinished=volumeQuotaFinished, nvdimmFailDeviceError=nvdimmFailDeviceError, shareQuotaLow=shareQuotaLow, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiTargetReadLatency=iscsiTargetReadLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, projectModified=projectModified, iscsiTargetIndex=iscsiTargetIndex, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, snmpAgentVersion=snmpAgentVersion, maintenanceModeDisabled=maintenanceModeDisabled, poolHealth=poolHealth, poolDataSizeHigh=poolDataSizeHigh, iscsiWriteIops=iscsiWriteIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcInitiatorCreateFailed=fcInitiatorCreateFailed, targetGroupMemberAdded=targetGroupMemberAdded, diskTotalWriteMbps=diskTotalWriteMbps, haResourceName=haResourceName, nicEntry=nicEntry, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, smisServiceStartFailed=smisServiceStartFailed, networkTotalReceiveMbps=networkTotalReceiveMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, nicGroup=nicGroup, projectTotalSaving=projectTotalSaving, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolMetaWriteLatency=poolMetaWriteLatency, notificationSensorNumber=notificationSensorNumber, fcInitiatorEntry=fcInitiatorEntry, projectThresholdExceedWarning=projectThresholdExceedWarning, diskCount=diskCount, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcTargetEntry=fcTargetEntry, poolDataWriteIops=poolDataWriteIops, fcTargetReadMbps=fcTargetReadMbps, shareNFSReadIops=shareNFSReadIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolState=poolState, shareDedupEnabled=shareDedupEnabled, poolExpanded=poolExpanded, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, snapshotCloningFailed=snapshotCloningFailed, notificationSensorSuspect=notificationSensorSuspect, diskAvgReadLatency=diskAvgReadLatency, fcTargetStatus=fcTargetStatus, shareQuotaFinished=shareQuotaFinished, poolDegraded=poolDegraded, notificationTargetEntityName=notificationTargetEntityName, lunTable=lunTable, nfsAvgWriteLatency=nfsAvgWriteLatency, projectFreeSizeLow=projectFreeSizeLow, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolCreated=poolCreated, poolEntry=poolEntry, iscsiTargetReadMbps=iscsiTargetReadMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectTable=projectTable, cifsTotalReadMbps=cifsTotalReadMbps, poolImported=poolImported, haResourceGroup=haResourceGroup, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, snapshotCreationFailed=snapshotCreationFailed, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, sanProperties=sanProperties, networkInterfaceDown=networkInterfaceDown, poolUsedSizeHigh=poolUsedSizeHigh, shareReservedSizeHigh=shareReservedSizeHigh, shareProjectName=shareProjectName, shareTable=shareTable, diskType=diskType, upgradeDownloadFailed=upgradeDownloadFailed, notificationComponentName=notificationComponentName, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, adServerTimeDrift=adServerTimeDrift, lunDataSizeLow=lunDataSizeLow, upgradeStarted=upgradeStarted, diskChassisIdx=diskChassisIdx, intelliFlashSoftwareDown=intelliFlashSoftwareDown, diskDataReadMbps=diskDataReadMbps, lunProtocol=lunProtocol, iscsiTargetError=iscsiTargetError, lunName=lunName, shareCIFSReadMbps=shareCIFSReadMbps, fcProperties=fcProperties, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, diskSequentialIOCount=diskSequentialIOCount, poolAvgWriteLatency=poolAvgWriteLatency, diskAvgWriteLatency=diskAvgWriteLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, poolDataReadMbps=poolDataReadMbps, notifications=notifications, upgradeTimeout=upgradeTimeout, iscsiTargetsTable=iscsiTargetsTable, nfsTotalReadMbps=nfsTotalReadMbps, diskState=diskState, poolMetaReadMbps=poolMetaReadMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcTargetReadIops=fcTargetReadIops, notificationReadingTriggerValue=notificationReadingTriggerValue, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, notificationDescription=notificationDescription, upgradeDownloadCompleted=upgradeDownloadCompleted, targetGroupCreateCompleted=targetGroupCreateCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, poolTotalReadIops=poolTotalReadIops, network=network, cpuSystemCalls=cpuSystemCalls, iscsiTargetWriteIops=iscsiTargetWriteIops, cifsTotalWriteMbps=cifsTotalWriteMbps, shareCIFSEnabled=shareCIFSEnabled, poolDataWriteMbps=poolDataWriteMbps, fcInitiatorGroup=fcInitiatorGroup, replicationResumed=replicationResumed, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, nicReceiveMbps=nicReceiveMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, shareNFSEnabled=shareNFSEnabled, poolReadCacheReadMbps=poolReadCacheReadMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiInitiators=iscsiInitiators, diskAlias=diskAlias, fcTargetName=fcTargetName, basicCompliance=basicCompliance, diskGoneOffline=diskGoneOffline, projectCompressionEnabled=projectCompressionEnabled, nfsAvgReadLatency=nfsAvgReadLatency, lunCompressedRatio=lunCompressedRatio, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, projectEntry=projectEntry, poolDataReadLatency=poolDataReadLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunSizeHigh=lunSizeHigh, projectCreatedSuccessfully=projectCreatedSuccessfully, snmpServiceStartFailed=snmpServiceStartFailed, lunReservedSizeHigh=lunReservedSizeHigh, nfsTotalWriteMbps=nfsTotalWriteMbps, ntpServerTimeDrift=ntpServerTimeDrift, userLoginFailed=userLoginFailed, haResources=haResources, projectShares=projectShares, targetGroupMemberRemoved=targetGroupMemberRemoved, projectDeleted=projectDeleted, diskTotalReadIops=diskTotalReadIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiTargetReadIops=iscsiTargetReadIops, projectLunCount=projectLunCount, projectDataSizeLow=projectDataSizeLow, lunEntry=lunEntry, volumeModifyCompleted=volumeModifyCompleted, iscsiTargetEntry=iscsiTargetEntry, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareCIFSWriteLatency=shareCIFSWriteLatency, projectDedupEnabled=projectDedupEnabled, aclMigrationCompleted=aclMigrationCompleted, diskRandomIOCount=diskRandomIOCount, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, networkIpmpGroupDown=networkIpmpGroupDown, shareName=shareName, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, haResourceEntry=haResourceEntry, poolExported=poolExported, fcTargetModifyCompleted=fcTargetModifyCompleted, lunDedupEnabled=lunDedupEnabled, fcPortOffline=fcPortOffline, poolProjectCount=poolProjectCount, poolSizeLow=poolSizeLow, properties=properties, poolTotalWriteMbps=poolTotalWriteMbps, poolReadCacheReadIops=poolReadCacheReadIops, nicTransmitMbps=nicTransmitMbps, cacheTotalReadMbps=cacheTotalReadMbps, diskError=diskError, targetGroupDeleteCompleted=targetGroupDeleteCompleted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, spareDiskReplaced=spareDiskReplaced, fcPortOnline=fcPortOnline, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, diagnosticDataUploaded=diagnosticDataUploaded, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, haResourcesTable=haResourcesTable, tegile=tegile, controllerTimeDrift=controllerTimeDrift, shareDeletionFailed=shareDeletionFailed, notificationSensorAction=notificationSensorAction, shareReservedSizeLow=shareReservedSizeLow, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, controllerDown=controllerDown, poolDataReadIops=poolDataReadIops, lunWriteLatency=lunWriteLatency, projectDeletionFailed=projectDeletionFailed, iscsiInitiatorName=iscsiInitiatorName, diskEntry=diskEntry, lunReadIops=lunReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, ipmiCurrent=ipmiCurrent, shareIndex=shareIndex, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, haResourceIndex=haResourceIndex, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiTargetAuth=iscsiTargetAuth, controllerHardwareModel=controllerHardwareModel, tegileCompliances=tegileCompliances)
mibBuilder.exportSymbols("TEGILE-MIB", cacheTotalReadIops=cacheTotalReadIops, poolTotalReadMbps=poolTotalReadMbps, lunWriteIops=lunWriteIops, diskIndex=diskIndex, nvdimmFailUnknownError=nvdimmFailUnknownError, poolOwnerController=poolOwnerController, diskIOCount=diskIOCount, shareCompressionEnabled=shareCompressionEnabled, poolDataWriteLatency=poolDataWriteLatency, fcInitiatorsTable=fcInitiatorsTable, shareNFSWriteMbps=shareNFSWriteMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, fcInitiatorIndex=fcInitiatorIndex, upgradeFailed=upgradeFailed, nvdimmFailInitializationError=nvdimmFailInitializationError, networkInterfaceUp=networkInterfaceUp, lunInitiatorGroup=lunInitiatorGroup, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, diskSizeLow=diskSizeLow, projectLUNs=projectLUNs, iscsiInitiatorIndex=iscsiInitiatorIndex, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, memoryFailure=memoryFailure, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, haControllerA_Name=haControllerA_Name, iscsiAvgReadLatency=iscsiAvgReadLatency, nicTable=nicTable, haControllerB_Name=haControllerB_Name, PYSNMP_MODULE_ID=tegile, shareDataSizeHigh=shareDataSizeHigh, cifsAvgWriteLatency=cifsAvgWriteLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, cacheSSDReads=cacheSSDReads, projectSnapshotSizeHigh=projectSnapshotSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunSizeLow=lunSizeLow, shareCIFSWriteIops=shareCIFSWriteIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolMetaReadIops=poolMetaReadIops, poolTable=poolTable, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiInitiatorsTable=iscsiInitiatorsTable, fcTargetWriteLatency=fcTargetWriteLatency, haResourceStatus=haResourceStatus, poolSizeHigh=poolSizeHigh, poolFreeSizeHigh=poolFreeSizeHigh, lunFreeSizeHigh=lunFreeSizeHigh, poolTotalSaving=poolTotalSaving, snapshotDeleteFailed=snapshotDeleteFailed, projectFreeSizeHigh=projectFreeSizeHigh, snmpServiceStarted=snmpServiceStarted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, nvdimmFailSoftError=nvdimmFailSoftError, fcAvgReadLatency=fcAvgReadLatency, poolMetaWriteIops=poolMetaWriteIops, upgradeDownloadStarted=upgradeDownloadStarted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, cpuTotalUsage=cpuTotalUsage, poolTotalWriteIops=poolTotalWriteIops, tegileConformance=tegileConformance, replicationAbandoned=replicationAbandoned, lunDataSizeHigh=lunDataSizeHigh, poolIndex=poolIndex, smisServiceStarted=smisServiceStarted, replicationAborted=replicationAborted, poolUpgraded=poolUpgraded, poolAvgReadLatency=poolAvgReadLatency, deleteFolderFailed=deleteFolderFailed, shareSnapshotSizeLow=shareSnapshotSizeLow, replicationPaused=replicationPaused, notificationEventCode=notificationEventCode, aclMigrationStarted=aclMigrationStarted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, lunTargetGroup=lunTargetGroup, nicIndex=nicIndex, cacheTotalWriteIops=cacheTotalWriteIops, iscsiTotalReadIops=iscsiTotalReadIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, projectQuotaFinished=projectQuotaFinished, nfsTotalReadIops=nfsTotalReadIops, fcTargetsTable=fcTargetsTable, cifsTotalReadIops=cifsTotalReadIops, fcInitiators=fcInitiators, maintenanceModeEnabled=maintenanceModeEnabled, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, smbSocketFailure=smbSocketFailure, cpuInterrupts=cpuInterrupts, netbiosSocketFailure=netbiosSocketFailure, ipmiOther=ipmiOther, poolFreeSizeLow=poolFreeSizeLow, snapshotRollbackFailed=snapshotRollbackFailed, ipmiMemory=ipmiMemory, iscsiTargetGroup=iscsiTargetGroup, diskIsOnline=diskIsOnline, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, haControllerA_Uptime=haControllerA_Uptime, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, lunIndex=lunIndex, fcTargetWriteIops=fcTargetWriteIops, lunPoolName=lunPoolName, shareNFSWriteIops=shareNFSWriteIops, lunReadMbps=lunReadMbps, haControllerB_IPAddr=haControllerB_IPAddr, cifsTotalWriteIops=cifsTotalWriteIops, diskSlowIo=diskSlowIo, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, replicationSourceRegistered=replicationSourceRegistered, diskTotalWriteIops=diskTotalWriteIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolProjects=poolProjects, testNotification=testNotification, tegileGroups=tegileGroups, diskTotalReadMbps=diskTotalReadMbps, shareCIFSReadLatency=shareCIFSReadLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, sensorFailureEvent=sensorFailureEvent, iscsiInitiatorGroup=iscsiInitiatorGroup, cacheRAMReads=cacheRAMReads, diskPoolName=diskPoolName, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, pools=pools, ipmiVoltage=ipmiVoltage, diskSizeHigh=diskSizeHigh, cifsAvgReadLatency=cifsAvgReadLatency, unknownSensorEvent=unknownSensorEvent, iscsiProperties=iscsiProperties, lunReadLatency=lunReadLatency, ipmiPowerSupply=ipmiPowerSupply, shareQuotaHigh=shareQuotaHigh, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiTargets=iscsiTargets, projectIndex=projectIndex, haControllerB_Uptime=haControllerB_Uptime, shareCIFSReadIops=shareCIFSReadIops, controllerUp=controllerUp, globalStatistics=globalStatistics, replicationComplete=replicationComplete, iscsiTargetName=iscsiTargetName, iscsiTargetGroupError=iscsiTargetGroupError, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, snapshotCloneCompleted=snapshotCloneCompleted, upgradeCompleted=upgradeCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunReservedSizeLow=lunReservedSizeLow, deleteFolderCompleted=deleteFolderCompleted, currentNotificationGroup=currentNotificationGroup, diskDataWriteIops=diskDataWriteIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareDataSizeLow=shareDataSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcTargetGroup=fcTargetGroup, nicState=nicState, volumeCreatedSuccessfully=volumeCreatedSuccessfully, smisServiceStopFailed=smisServiceStopFailed, shareDeleted=shareDeleted, notificationObjects=notificationObjects, poolDataSizeLow=poolDataSizeLow, poolCount=poolCount, ipmiThreshold=ipmiThreshold, fcTargetReadLatency=fcTargetReadLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, volumeDeleteCompleted=volumeDeleteCompleted, disks=disks, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, snapshotRollbackCompleted=snapshotRollbackCompleted, poolQuotaFinished=poolQuotaFinished, projectName=projectName, snmpServiceStopFailed=snmpServiceStopFailed, notificationProps=notificationProps, snmpServiceStopped=snmpServiceStopped, replicationFailed=replicationFailed, tegileArray=tegileArray, lunFreeSizeLow=lunFreeSizeLow, nicName=nicName, fcTotalWriteIops=fcTotalWriteIops, shareEntry=shareEntry, shareMountPoint=shareMountPoint, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolDeletionFailed=poolDeletionFailed, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcTargets=fcTargets, lunWriteMbps=lunWriteMbps, haResourceActiveNode=haResourceActiveNode, alertsCleanupCompleted=alertsCleanupCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareNFSReadLatency=shareNFSReadLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolName=poolName, lunSnapshotSizeLow=lunSnapshotSizeLow, diskTable=diskTable, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, fcTargetIndex=fcTargetIndex, projectShareCount=projectShareCount, fcTargetWriteMbps=fcTargetWriteMbps, lunGUID=lunGUID, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, tdpsUpgradeFailed=tdpsUpgradeFailed, fcAvgWriteLatency=fcAvgWriteLatency, fcTotalReadIops=fcTotalReadIops, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, volumeDeleteFailed=volumeDeleteFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcTotalWriteMbps=fcTotalWriteMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareNFSReadMbps=shareNFSReadMbps)
