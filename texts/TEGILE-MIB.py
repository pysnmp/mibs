...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, ModuleIdentity, Bits, Gauge32, MibIdentifier, enterprises, iso, Counter64, ObjectIdentity, Unsigned32, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "ModuleIdentity", "Bits", "Gauge32", "MibIdentifier", "enterprises", "iso", "Counter64", "ObjectIdentity", "Unsigned32", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcInitiators=fcInitiators, fcTargetName=fcTargetName, snmpServiceStarted=snmpServiceStarted, haResourceGroup=haResourceGroup, poolMetaReadMbps=poolMetaReadMbps, replicationResumed=replicationResumed, lunIndex=lunIndex, iscsiTargetWriteMbps=iscsiTargetWriteMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, snmpServiceStopFailed=snmpServiceStopFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, nicGroup=nicGroup, diskPoolName=diskPoolName, iscsiTargetReadIops=iscsiTargetReadIops, ipmiOther=ipmiOther, cacheTotalWriteIops=cacheTotalWriteIops, networkIpmpGroupDown=networkIpmpGroupDown, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolDataSizeHigh=poolDataSizeHigh, cpuInterrupts=cpuInterrupts, iscsiTargetWriteLatency=iscsiTargetWriteLatency, ipmiPowerSupply=ipmiPowerSupply, diskTotalReadIops=diskTotalReadIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, fcPortOnline=fcPortOnline, poolImported=poolImported, diskSlowIo=diskSlowIo, iscsiTotalReadMbps=iscsiTotalReadMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolDeletionFailed=poolDeletionFailed, deleteFolderCompleted=deleteFolderCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, snmpAgentVersion=snmpAgentVersion, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, diskTotalReadMbps=diskTotalReadMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunTargetGroup=lunTargetGroup, lunWriteLatency=lunWriteLatency, ipmiCurrent=ipmiCurrent, nfsTotalWriteMbps=nfsTotalWriteMbps, fcTargetIndex=fcTargetIndex, fcInitiatorsTable=fcInitiatorsTable, shareCIFSWriteLatency=shareCIFSWriteLatency, PYSNMP_MODULE_ID=tegile, fcInitiatorName=fcInitiatorName, tegileArray=tegileArray, projectTable=projectTable, fcProperties=fcProperties, upgradeDownloadStarted=upgradeDownloadStarted, upgradeFailed=upgradeFailed, shareIndex=shareIndex, ntpServerTimeDrift=ntpServerTimeDrift, ipmiFan=ipmiFan, projectTotalSaving=projectTotalSaving, controllerDown=controllerDown, poolHealth=poolHealth, projectDataSizeLow=projectDataSizeLow, haControllerB_Uptime=haControllerB_Uptime, lunGUID=lunGUID, networkInterfaceUp=networkInterfaceUp, diskAlias=diskAlias, lunInitiatorGroup=lunInitiatorGroup, shareCreatedSuccessfully=shareCreatedSuccessfully, poolDataWriteLatency=poolDataWriteLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, upgradeDownloadFailed=upgradeDownloadFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareCompressionEnabled=shareCompressionEnabled, cpuSystemCalls=cpuSystemCalls, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, snapshotCloneCompleted=snapshotCloneCompleted, lunPoolName=lunPoolName, snapshotCloningFailed=snapshotCloningFailed, snapshotDeleteFailed=snapshotDeleteFailed, upgradeStarted=upgradeStarted, notificationSensorNumber=notificationSensorNumber, shareNFSReadLatency=shareNFSReadLatency, lunName=lunName, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunWriteMbps=lunWriteMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, projectThresholdExceedWarning=projectThresholdExceedWarning, nvdimmFailDeviceError=nvdimmFailDeviceError, fcTargetsTable=fcTargetsTable, volumeDeleteFailed=volumeDeleteFailed, notificationSeverity=notificationSeverity, poolState=poolState, shareCIFSReadLatency=shareCIFSReadLatency, haResourceIndex=haResourceIndex, notificationSensorAction=notificationSensorAction, shareDataSizeHigh=shareDataSizeHigh, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunReadMbps=lunReadMbps, diskDataReadIops=diskDataReadIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolDataSizeLow=poolDataSizeLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTotalReadIops=iscsiTotalReadIops, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, nvdimmFailInitializationError=nvdimmFailInitializationError, notificationComponentName=notificationComponentName, projectCreatedSuccessfully=projectCreatedSuccessfully, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectCompressionEnabled=projectCompressionEnabled, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, disks=disks, lunProtocol=lunProtocol, fcTargetStatus=fcTargetStatus, diskGoneOffline=diskGoneOffline, cacheTotalReadIops=cacheTotalReadIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcTargetWriteIops=fcTargetWriteIops, tegileConformance=tegileConformance, fcTotalReadIops=fcTotalReadIops, poolTotalReadMbps=poolTotalReadMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, diskTotalWriteMbps=diskTotalWriteMbps, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetGroup=iscsiTargetGroup, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, lunReservedSizeHigh=lunReservedSizeHigh, poolTotalSaving=poolTotalSaving, properties=properties, fcTargetWriteMbps=fcTargetWriteMbps, shareCIFSEnabled=shareCIFSEnabled, lunEntry=lunEntry, poolTotalWriteIops=poolTotalWriteIops, poolReadCacheReadMbps=poolReadCacheReadMbps, poolMetaWriteMbps=poolMetaWriteMbps, poolDegraded=poolDegraded, shareProjectName=shareProjectName, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskSequentialIOCount=diskSequentialIOCount, iscsiTargetsTable=iscsiTargetsTable, poolName=poolName, shareDeleted=shareDeleted, deleteFolderFailed=deleteFolderFailed, diskTotalWriteIops=diskTotalWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, shareDedupEnabled=shareDedupEnabled, shareMountPoint=shareMountPoint, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareNFSWriteIops=shareNFSWriteIops, haResourcesTable=haResourcesTable, poolDataReadIops=poolDataReadIops, notificationDescription=notificationDescription, poolTotalReadIops=poolTotalReadIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskAvgReadLatency=diskAvgReadLatency, lunDataSizeHigh=lunDataSizeHigh, lunCompressedRatio=lunCompressedRatio, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolQuotaFinished=poolQuotaFinished, iscsiInitiators=iscsiInitiators, poolDataReadLatency=poolDataReadLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, sanProperties=sanProperties, maintenanceModeDisabled=maintenanceModeDisabled, poolFreeSizeHigh=poolFreeSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, lunSizeHigh=lunSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskIsOnline=diskIsOnline, fcInitiatorCreateFailed=fcInitiatorCreateFailed, snapshotCreationFailed=snapshotCreationFailed, vmwareNFSDatastores=vmwareNFSDatastores, maintenanceModeEnabled=maintenanceModeEnabled, snapshotRollbackFailed=snapshotRollbackFailed, diskRandomIOCount=diskRandomIOCount, fcAvgWriteLatency=fcAvgWriteLatency, lunReadLatency=lunReadLatency, projectDedupEnabled=projectDedupEnabled, nfsAvgWriteLatency=nfsAvgWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, fcTargets=fcTargets, replicationComplete=replicationComplete, poolUpgraded=poolUpgraded, networkInterfaceDown=networkInterfaceDown, poolProjects=poolProjects, shareDataSizeLow=shareDataSizeLow, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, nicState=nicState, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareNFSEnabled=shareNFSEnabled, cifsAvgReadLatency=cifsAvgReadLatency, projectShares=projectShares, haControllerB_IPAddr=haControllerB_IPAddr, ipmiTemperature=ipmiTemperature, fcTotalReadMbps=fcTotalReadMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, fcTargetReadLatency=fcTargetReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolUsedSizeHigh=poolUsedSizeHigh, poolExpanded=poolExpanded, poolMetaReadIops=poolMetaReadIops, ipmiThreshold=ipmiThreshold, diskType=diskType, iscsiTargetReadLatency=iscsiTargetReadLatency, replicationStarted=replicationStarted, poolDataWriteIops=poolDataWriteIops, ipmiVoltage=ipmiVoltage, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, notificationReadingTriggerValue=notificationReadingTriggerValue, iscsiInitiatorIndex=iscsiInitiatorIndex, replicationAbandoned=replicationAbandoned, diskDataReadMbps=diskDataReadMbps, lunReadIops=lunReadIops, nfsTotalReadIops=nfsTotalReadIops, smisServiceStarted=smisServiceStarted, ipmiMemory=ipmiMemory, shareCompressedRatio=shareCompressedRatio, projectShareCount=projectShareCount, diskState=diskState, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, aclMigrationStarted=aclMigrationStarted, lunDedupEnabled=lunDedupEnabled, fcTargetEntry=fcTargetEntry, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolTotalWriteMbps=poolTotalWriteMbps, volumeDeleteCompleted=volumeDeleteCompleted, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, notificationObjects=notificationObjects, fcTotalWriteMbps=fcTotalWriteMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, iscsiTargetWriteIops=iscsiTargetWriteIops, shareCIFSWriteIops=shareCIFSWriteIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, lunWriteIops=lunWriteIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, haResourceActiveNode=haResourceActiveNode, targetGroupMemberAdded=targetGroupMemberAdded)
mibBuilder.exportSymbols("TEGILE-MIB", vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, diskCount=diskCount, replicationSourceRegistered=replicationSourceRegistered, lunSnapshotSizeHigh=lunSnapshotSizeHigh, network=network, fcInitiatorGroup=fcInitiatorGroup, projectLUNs=projectLUNs, fcTargetWriteLatency=fcTargetWriteLatency, upgradeTimeout=upgradeTimeout, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectDataSizeHigh=projectDataSizeHigh, snmpServiceStartFailed=snmpServiceStartFailed, replicationAborted=replicationAborted, fcAvgReadLatency=fcAvgReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, fcTargetReadMbps=fcTargetReadMbps, lunProjectName=lunProjectName, testNotification=testNotification, shareQuotaHigh=shareQuotaHigh, cifsTotalReadMbps=cifsTotalReadMbps, projectEntry=projectEntry, projectDeletionFailed=projectDeletionFailed, nicName=nicName, poolDeleted=poolDeleted, poolReadCacheReadIops=poolReadCacheReadIops, projectFreeSizeLow=projectFreeSizeLow, projectModified=projectModified, shareName=shareName, nfsTotalWriteIops=nfsTotalWriteIops, poolSizeLow=poolSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, haResourceName=haResourceName, nfsAvgReadLatency=nfsAvgReadLatency, nicEntry=nicEntry, volumeCreatedSuccessfully=volumeCreatedSuccessfully, iscsiWriteIops=iscsiWriteIops, nicTable=nicTable, adServerTimeDrift=adServerTimeDrift, notificationProps=notificationProps, iscsiProperties=iscsiProperties, tegileCompliances=tegileCompliances, lunDataSizeLow=lunDataSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiInitiatorName=iscsiInitiatorName, memoryFailure=memoryFailure, diskAvgWriteLatency=diskAvgWriteLatency, lunFreeSizeLow=lunFreeSizeLow, snmpServiceStopped=snmpServiceStopped, nfsTotalReadMbps=nfsTotalReadMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, shareEntry=shareEntry, poolFreeSizeLow=poolFreeSizeLow, projectName=projectName, sensorFailureEvent=sensorFailureEvent, shareCIFSReadIops=shareCIFSReadIops, notificationTime=notificationTime, poolUsedSizeLow=poolUsedSizeLow, shareNFSReadIops=shareNFSReadIops, projectSnapshotSizeLow=projectSnapshotSizeLow, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, smisServiceStopped=smisServiceStopped, poolExported=poolExported, lunReservedSizeLow=lunReservedSizeLow, netbiosSocketFailure=netbiosSocketFailure, projectIndex=projectIndex, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, currentObjectGroup=currentObjectGroup, nicTransmitMbps=nicTransmitMbps, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolCount=poolCount, controllerTimeDrift=controllerTimeDrift, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, replicationPaused=replicationPaused, haResourceDescription=haResourceDescription, userLoginFailed=userLoginFailed, globalStatistics=globalStatistics, iscsiInitiatorGroup=iscsiInitiatorGroup, targetGroupCreateCompleted=targetGroupCreateCompleted, smisServiceStartFailed=smisServiceStartFailed, notificationReadingUnit=notificationReadingUnit, lunFreeSizeHigh=lunFreeSizeHigh, projectDeleted=projectDeleted, shareQuotaLow=shareQuotaLow, basicCompliance=basicCompliance, fcTargetModifyCompleted=fcTargetModifyCompleted, diskEntry=diskEntry, diskChassisIdx=diskChassisIdx, shareNFSReadMbps=shareNFSReadMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiTargetAlias=iscsiTargetAlias, nicMTU=nicMTU, initiatorGroupMemberAdded=initiatorGroupMemberAdded, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiTargetName=iscsiTargetName, nvdimmFailSoftError=nvdimmFailSoftError, lunBlockSize=lunBlockSize, cacheTotalReadMbps=cacheTotalReadMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiTargetError=iscsiTargetError, poolOwnerController=poolOwnerController, sharePoolName=sharePoolName, tegileArray_notifications=tegileArray_notifications, poolTable=poolTable, tegile=tegile, haResourceEntry=haResourceEntry, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, diskSizeLow=diskSizeLow, shareTable=shareTable, controllerUp=controllerUp, replicationFailed=replicationFailed, fcInitiatorEntry=fcInitiatorEntry, volumeModifyCompleted=volumeModifyCompleted, alertsCleanupCompleted=alertsCleanupCompleted, fcTargetGroup=fcTargetGroup, lunSizeLow=lunSizeLow, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectQuotaFinished=projectQuotaFinished, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcInitiatorIndex=fcInitiatorIndex, notificationSensorSuspect=notificationSensorSuspect, shareNFSWriteLatency=shareNFSWriteLatency, cifsTotalReadIops=cifsTotalReadIops, cifsTotalWriteIops=cifsTotalWriteIops, fcPortOffline=fcPortOffline, smbSocketFailure=smbSocketFailure, fcTotalWriteIops=fcTotalWriteIops, iscsiTargetAuth=iscsiTargetAuth, webdocsUpgradeFailed=webdocsUpgradeFailed, poolMetaWriteIops=poolMetaWriteIops, iscsiAvgReadLatency=iscsiAvgReadLatency, poolSizeHigh=poolSizeHigh, notificationTargetEntityName=notificationTargetEntityName, replicationTargetDeleted=replicationTargetDeleted, lunTable=lunTable, shareQuotaFinished=shareQuotaFinished, poolProjectCount=poolProjectCount, projectLunCount=projectLunCount, spareDiskReplaced=spareDiskReplaced, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskIOCount=diskIOCount, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcTargetReadIops=fcTargetReadIops, haControllerA_IPAddr=haControllerA_IPAddr, projectPoolName=projectPoolName, iscsiTargetIndex=iscsiTargetIndex, diskSizeHigh=diskSizeHigh, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareDeletionFailed=shareDeletionFailed, haControllerB_Name=haControllerB_Name, haResourceStatus=haResourceStatus, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, cacheRAMReads=cacheRAMReads, poolReadCacheReadLatency=poolReadCacheReadLatency, projectQuotaSizeLow=projectQuotaSizeLow, poolDataWriteMbps=poolDataWriteMbps, nicReceiveMbps=nicReceiveMbps, diskIndex=diskIndex, poolAvgReadLatency=poolAvgReadLatency, pools=pools, diagnosticDataUploaded=diagnosticDataUploaded, diskDataWriteMbps=diskDataWriteMbps, iscsiTargetEntry=iscsiTargetEntry, lunCompressionEnabled=lunCompressionEnabled, currentNotificationGroup=currentNotificationGroup, tegileGroups=tegileGroups, iscsiTargets=iscsiTargets, cacheTotalWriteMbps=cacheTotalWriteMbps, diskError=diskError, diskDataWriteIops=diskDataWriteIops, shareReservedSizeLow=shareReservedSizeLow, controllerHardwareModel=controllerHardwareModel, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolIndex=poolIndex, shareReservedSizeHigh=shareReservedSizeHigh, unknownSensorEvent=unknownSensorEvent, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolEntry=poolEntry, smisServiceStopFailed=smisServiceStopFailed, poolAvgWriteLatency=poolAvgWriteLatency, diskTable=diskTable, notifications=notifications, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, upgradeCompleted=upgradeCompleted, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, haControllerA_Name=haControllerA_Name, nicIndex=nicIndex, notificationEventCode=notificationEventCode, volumeQuotaFinished=volumeQuotaFinished, intelliFlashSoftwareDown=intelliFlashSoftwareDown, haControllerA_Uptime=haControllerA_Uptime, poolCreated=poolCreated, iscsiInitiatorsTable=iscsiInitiatorsTable, haResources=haResources, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, cpuTotalUsage=cpuTotalUsage, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolDataReadMbps=poolDataReadMbps, networkIpmpGroupUp=networkIpmpGroupUp, cacheSSDReads=cacheSSDReads, poolMetaReadLatency=poolMetaReadLatency)
