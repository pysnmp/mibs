...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:19:15 2024
...
enterprises, Integer32, Counter32, Bits, MibIdentifier, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, IpAddress, NotificationType, TimeTicks, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "Counter32", "Bits", "MibIdentifier", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "IpAddress", "NotificationType", "TimeTicks", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", notificationObjects=notificationObjects, shareDeleted=shareDeleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, diskTotalReadIops=diskTotalReadIops, iscsiInitiatorsTable=iscsiInitiatorsTable, networkIpmpGroupDown=networkIpmpGroupDown, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, controllerTimeDrift=controllerTimeDrift, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, haResourceEntry=haResourceEntry, notificationSensorSuspect=notificationSensorSuspect, poolTotalReadMbps=poolTotalReadMbps, upgradeStarted=upgradeStarted, upgradeDownloadFailed=upgradeDownloadFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiTotalWriteMbps=iscsiTotalWriteMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, tegileConformance=tegileConformance, poolReadCacheWriteMbps=poolReadCacheWriteMbps, tegileArray=tegileArray, diskGoneOffline=diskGoneOffline, haResourceGroup=haResourceGroup, lunReadMbps=lunReadMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, lunReservedSizeHigh=lunReservedSizeHigh, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, globalStatistics=globalStatistics, haResourceStatus=haResourceStatus, networkTotalReceiveMbps=networkTotalReceiveMbps, volumeModifyCompleted=volumeModifyCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, fcInitiatorEntry=fcInitiatorEntry, notificationComponentName=notificationComponentName, haResourceName=haResourceName, iscsiInitiatorChapUser=iscsiInitiatorChapUser, lunTargetGroup=lunTargetGroup, iscsiTargetReadLatency=iscsiTargetReadLatency, PYSNMP_MODULE_ID=tegile, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, ntpServerTimeDrift=ntpServerTimeDrift, poolExported=poolExported, projectModified=projectModified, diagnosticDataUploaded=diagnosticDataUploaded, spareDiskReplaced=spareDiskReplaced, diskError=diskError, deleteFolderFailed=deleteFolderFailed, diskIOCount=diskIOCount, smisServiceStopFailed=smisServiceStopFailed, nfsTotalWriteMbps=nfsTotalWriteMbps, fcInitiatorGroup=fcInitiatorGroup, fcInitiatorIndex=fcInitiatorIndex, diskTotalReadMbps=diskTotalReadMbps, poolMetaWriteMbps=poolMetaWriteMbps, diskDataReadMbps=diskDataReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, snapshotDeleteFailed=snapshotDeleteFailed, notificationSeverity=notificationSeverity, nicTransmitMbps=nicTransmitMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, snapshotRollbackCompleted=snapshotRollbackCompleted, diskChassisIdx=diskChassisIdx, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, nfsTotalReadMbps=nfsTotalReadMbps, cifsTotalWriteMbps=cifsTotalWriteMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, haControllerB_Name=haControllerB_Name, projectDeleted=projectDeleted, memoryFailure=memoryFailure, diskState=diskState, diskAlias=diskAlias, poolMetaReadMbps=poolMetaReadMbps, fcTargetName=fcTargetName, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, projectEntry=projectEntry, lunSnapshotSizeLow=lunSnapshotSizeLow, haResourceIndex=haResourceIndex, projectQuotaFinished=projectQuotaFinished, lunBlockSize=lunBlockSize, shareExceedThresholdWarning=shareExceedThresholdWarning, projectQuotaSizeHigh=projectQuotaSizeHigh, lunWriteLatency=lunWriteLatency, poolFreeSizeLow=poolFreeSizeLow, poolUsedSizeHigh=poolUsedSizeHigh, volumeDeleteFailed=volumeDeleteFailed, volumeQuotaFinished=volumeQuotaFinished, cacheTotalWriteMbps=cacheTotalWriteMbps, fcTotalReadIops=fcTotalReadIops, poolReadCacheReadIops=poolReadCacheReadIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, replicationAborted=replicationAborted, projectDataSizeHigh=projectDataSizeHigh, poolUsedSizeLow=poolUsedSizeLow, shareCompressionEnabled=shareCompressionEnabled, diskTotalWriteMbps=diskTotalWriteMbps, fcTargetWriteLatency=fcTargetWriteLatency, lunFreeSizeHigh=lunFreeSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, nicMTU=nicMTU, shareDeletionFailed=shareDeletionFailed, projectTotalSaving=projectTotalSaving, fcTargetReadMbps=fcTargetReadMbps, shareReservedSizeHigh=shareReservedSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, nvdimmFailSoftError=nvdimmFailSoftError, projectLUNs=projectLUNs, cacheTotalReadIops=cacheTotalReadIops, shareQuotaLow=shareQuotaLow, fcInitiators=fcInitiators, shareNFSWriteLatency=shareNFSWriteLatency, properties=properties, haResources=haResources, diskIndex=diskIndex, replicationComplete=replicationComplete, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectFreeSizeLow=projectFreeSizeLow, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, deleteFolderCompleted=deleteFolderCompleted, poolQuotaFinished=poolQuotaFinished, snmpServiceStartFailed=snmpServiceStartFailed, haControllerB_IPAddr=haControllerB_IPAddr, userLoginFailed=userLoginFailed, cifsTotalReadIops=cifsTotalReadIops, diskType=diskType, lunWriteIops=lunWriteIops, fcTargetReadLatency=fcTargetReadLatency, diskRandomIOCount=diskRandomIOCount, diskIsOnline=diskIsOnline, notificationDescription=notificationDescription, poolProjects=poolProjects, projectShares=projectShares, iscsiTargetAlias=iscsiTargetAlias, poolCreated=poolCreated, lunDataSizeLow=lunDataSizeLow, fcInitiatorName=fcInitiatorName, poolDataReadLatency=poolDataReadLatency, cifsTotalWriteIops=cifsTotalWriteIops, poolDataWriteLatency=poolDataWriteLatency, poolIndex=poolIndex, upgradeDownloadCompleted=upgradeDownloadCompleted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcTargetEntry=fcTargetEntry, poolExpanded=poolExpanded, lunCompressionEnabled=lunCompressionEnabled, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolTotalWriteMbps=poolTotalWriteMbps, fcTargetGroup=fcTargetGroup, vmwareNFSDatastores=vmwareNFSDatastores, fcInitiatorsTable=fcInitiatorsTable, notificationEventCode=notificationEventCode, shareName=shareName, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, projectName=projectName, iscsiTotalReadIops=iscsiTotalReadIops, shareDataSizeLow=shareDataSizeLow, nicTable=nicTable, webdocsUpgradeCompleted=webdocsUpgradeCompleted, projectShareCount=projectShareCount, lunPoolName=lunPoolName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunReadIops=lunReadIops, lunWriteMbps=lunWriteMbps, haControllerA_IPAddr=haControllerA_IPAddr, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, basicCompliance=basicCompliance, nicName=nicName, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, poolTotalSaving=poolTotalSaving, targetGroupCreateCompleted=targetGroupCreateCompleted, shareProjectName=shareProjectName, ipmiFan=ipmiFan, ipmiPowerSupply=ipmiPowerSupply, projectIndex=projectIndex, shareIndex=shareIndex, shareQuotaFinished=shareQuotaFinished, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiTargetError=iscsiTargetError, replicationTargetDeleted=replicationTargetDeleted, lunCompressedRatio=lunCompressedRatio, notificationReadingUnit=notificationReadingUnit, shareSnapshotSizeLow=shareSnapshotSizeLow, nvdimmFailUnknownError=nvdimmFailUnknownError, maintenanceModeDisabled=maintenanceModeDisabled, fcTargets=fcTargets, poolImported=poolImported, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiTargetReadIops=iscsiTargetReadIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiTargetGroup=iscsiTargetGroup, networkIpmpGroupUp=networkIpmpGroupUp, notificationSensorAction=notificationSensorAction, nvdimmFailDeviceError=nvdimmFailDeviceError, haResourceActiveNode=haResourceActiveNode, shareCIFSReadLatency=shareCIFSReadLatency, diskPoolName=diskPoolName, sharePoolName=sharePoolName, shareSnapshotSizeHigh=shareSnapshotSizeHigh, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolOwnerController=poolOwnerController, poolName=poolName, lunReadLatency=lunReadLatency, fcProperties=fcProperties, nicGroup=nicGroup, poolSizeLow=poolSizeLow, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, iscsiTargetGroupError=iscsiTargetGroupError, poolEntry=poolEntry, iscsiTargetWriteMbps=iscsiTargetWriteMbps, currentObjectGroup=currentObjectGroup, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, fcTotalWriteIops=fcTotalWriteIops, shareNFSWriteMbps=shareNFSWriteMbps, poolMetaWriteIops=poolMetaWriteIops, ipmiCurrent=ipmiCurrent, poolReadCacheReadLatency=poolReadCacheReadLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, nicEntry=nicEntry, nfsAvgReadLatency=nfsAvgReadLatency, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, snmpAgentVersion=snmpAgentVersion, tegileArray_notifications=tegileArray_notifications, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareDedupEnabled=shareDedupEnabled, snmpServiceStopFailed=snmpServiceStopFailed, poolDataReadMbps=poolDataReadMbps, poolDeletionFailed=poolDeletionFailed, fcPortOffline=fcPortOffline, haResourcesTable=haResourcesTable, projectSnapshotSizeLow=projectSnapshotSizeLow, shareCreatedSuccessfully=shareCreatedSuccessfully, shareTable=shareTable, poolTotalReadIops=poolTotalReadIops, aclMigrationStarted=aclMigrationStarted, notifications=notifications, iscsiProperties=iscsiProperties, poolFreeSizeHigh=poolFreeSizeHigh, currentNotificationGroup=currentNotificationGroup, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, nicIndex=nicIndex, upgradeTimeout=upgradeTimeout, projectDeletionFailed=projectDeletionFailed, haControllerB_Uptime=haControllerB_Uptime, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTotalReadMbps=fcTotalReadMbps, upgradeFailed=upgradeFailed, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetName=iscsiTargetName, shareNFSReadMbps=shareNFSReadMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, sanProperties=sanProperties, tdpsUpgradeFailed=tdpsUpgradeFailed, smisServiceStartFailed=smisServiceStartFailed, diskTotalWriteIops=diskTotalWriteIops, lunFreeSizeLow=lunFreeSizeLow, iscsiInitiators=iscsiInitiators, cifsAvgReadLatency=cifsAvgReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, cpuTotalUsage=cpuTotalUsage, projectQuotaSizeLow=projectQuotaSizeLow, shareNFSEnabled=shareNFSEnabled, disks=disks, pools=pools, shareCIFSWriteIops=shareCIFSWriteIops, replicationStarted=replicationStarted, diskSizeHigh=diskSizeHigh, lunProtocol=lunProtocol, ipmiTemperature=ipmiTemperature, shareMountPoint=shareMountPoint, networkInterfaceUp=networkInterfaceUp, diskDataWriteIops=diskDataWriteIops, iscsiInitiatorName=iscsiInitiatorName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, haResourceDescription=haResourceDescription, ipmiOther=ipmiOther, alertsCleanupCompleted=alertsCleanupCompleted, lunEntry=lunEntry, lunDataSizeHigh=lunDataSizeHigh, controllerUp=controllerUp, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, fcTargetsTable=fcTargetsTable, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, controllerDown=controllerDown, cacheSSDReads=cacheSSDReads, iscsiTargetEntry=iscsiTargetEntry, fcTotalWriteMbps=fcTotalWriteMbps, cacheRAMReads=cacheRAMReads, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, projectSnapshotSizeHigh=projectSnapshotSizeHigh, diskSequentialIOCount=diskSequentialIOCount, lunName=lunName, network=network, poolDataSizeHigh=poolDataSizeHigh, notificationTargetEntityName=notificationTargetEntityName, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, snmpServiceStarted=snmpServiceStarted, notificationTime=notificationTime, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, replicationResumed=replicationResumed, tegileCompliances=tegileCompliances, replicationAbandoned=replicationAbandoned, nfsTotalWriteIops=nfsTotalWriteIops, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, ipmiMemory=ipmiMemory, adServerTimeDrift=adServerTimeDrift, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, diskAvgReadLatency=diskAvgReadLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, fcPortOnline=fcPortOnline, lunInitiatorGroup=lunInitiatorGroup, maintenanceModeEnabled=maintenanceModeEnabled, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, replicationPaused=replicationPaused, poolProjectCount=poolProjectCount, smisServiceStopped=smisServiceStopped, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, tegileGroups=tegileGroups, haControllerA_Name=haControllerA_Name, cpuInterrupts=cpuInterrupts, projectFreeSizeHigh=projectFreeSizeHigh, projectLunCount=projectLunCount, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, upgradeCompleted=upgradeCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, cpuSystemCalls=cpuSystemCalls, diskDataWriteMbps=diskDataWriteMbps, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, diskCount=diskCount, projectCompressionEnabled=projectCompressionEnabled, lunTable=lunTable, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiTargetsTable=iscsiTargetsTable, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, targetGroupMemberAdded=targetGroupMemberAdded, poolSizeHigh=poolSizeHigh, diskDataReadIops=diskDataReadIops, shareCIFSEnabled=shareCIFSEnabled, poolDeleted=poolDeleted, iscsiWriteIops=iscsiWriteIops, nvdimmFailInitializationError=nvdimmFailInitializationError, notificationReadingTriggerValue=notificationReadingTriggerValue, projectCreatedSuccessfully=projectCreatedSuccessfully, lunIndex=lunIndex, controllerHardwareModel=controllerHardwareModel, fcTargetStatus=fcTargetStatus, sensorFailureEvent=sensorFailureEvent, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, tdpsUpgradeCompleted=tdpsUpgradeCompleted, networkInterfaceDown=networkInterfaceDown, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskEntry=diskEntry, poolState=poolState, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectDedupEnabled=projectDedupEnabled, lunDedupEnabled=lunDedupEnabled, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, snapshotCreationFailed=snapshotCreationFailed, iscsiTotalReadMbps=iscsiTotalReadMbps, nicState=nicState, shareEntry=shareEntry, cifsAvgWriteLatency=cifsAvgWriteLatency, cacheTotalWriteIops=cacheTotalWriteIops, shareCIFSReadMbps=shareCIFSReadMbps, poolDegraded=poolDegraded, cacheTotalReadMbps=cacheTotalReadMbps, diskTable=diskTable, notificationProps=notificationProps, upgradeDownloadStarted=upgradeDownloadStarted, fcTargetReadIops=fcTargetReadIops, notificationSensorNumber=notificationSensorNumber, shareQuotaHigh=shareQuotaHigh, diskSizeLow=diskSizeLow, ipmiVoltage=ipmiVoltage, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolTable=poolTable, testNotification=testNotification, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, projectPoolName=projectPoolName, poolMetaWriteLatency=poolMetaWriteLatency, haControllerA_Uptime=haControllerA_Uptime, poolTotalWriteIops=poolTotalWriteIops, fcTargetIndex=fcTargetIndex, iscsiAvgWriteLatency=iscsiAvgWriteLatency, lunSizeLow=lunSizeLow, projectThresholdExceedWarning=projectThresholdExceedWarning, fcTargetModifyCompleted=fcTargetModifyCompleted, poolCount=poolCount, poolHealth=poolHealth, iscsiTargetReadMbps=iscsiTargetReadMbps, smbSocketFailure=smbSocketFailure, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiTargetWriteLatency=iscsiTargetWriteLatency, ipmiThreshold=ipmiThreshold, projectTable=projectTable, lunReservedSizeLow=lunReservedSizeLow, poolReadCacheReadMbps=poolReadCacheReadMbps, snapshotCloningFailed=snapshotCloningFailed, shareNFSWriteIops=shareNFSWriteIops, volumeDeleteCompleted=volumeDeleteCompleted, projectDataSizeLow=projectDataSizeLow, poolAvgReadLatency=poolAvgReadLatency, iscsiTargets=iscsiTargets, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcAvgReadLatency=fcAvgReadLatency, snapshotCloneCompleted=snapshotCloneCompleted, poolReadCacheWriteIops=poolReadCacheWriteIops, poolDataWriteMbps=poolDataWriteMbps, nicReceiveMbps=nicReceiveMbps, shareReservedSizeLow=shareReservedSizeLow, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, tdpsUpgradeTimeout=tdpsUpgradeTimeout, nfsTotalReadIops=nfsTotalReadIops, poolUpgraded=poolUpgraded, netbiosSocketFailure=netbiosSocketFailure, poolMetaReadLatency=poolMetaReadLatency, lunProjectName=lunProjectName, poolDataSizeLow=poolDataSizeLow, replicationFailed=replicationFailed, tegile=tegile, cifsTotalReadMbps=cifsTotalReadMbps, unknownSensorEvent=unknownSensorEvent, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, fcAvgWriteLatency=fcAvgWriteLatency, poolAvgWriteLatency=poolAvgWriteLatency, diskSlowIo=diskSlowIo, fcTargetWriteIops=fcTargetWriteIops, iscsiTargetAuth=iscsiTargetAuth, replicationSourceRegistered=replicationSourceRegistered, lunSizeHigh=lunSizeHigh, poolDataWriteIops=poolDataWriteIops, shareDataSizeHigh=shareDataSizeHigh, snmpServiceStopped=snmpServiceStopped, shareCompressedRatio=shareCompressedRatio, shareNFSReadLatency=shareNFSReadLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, lunGUID=lunGUID, iscsiTargetIndex=iscsiTargetIndex, smisServiceStarted=smisServiceStarted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, snapshotRollbackFailed=snapshotRollbackFailed, shareCIFSReadIops=shareCIFSReadIops, fcTargetWriteMbps=fcTargetWriteMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolMetaReadIops=poolMetaReadIops, poolDataReadIops=poolDataReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow)
