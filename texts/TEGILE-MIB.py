...
# Produced by pysmi-1.1.3 at Tue Dec  7 14:02:05 2021
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, iso, Counter32, Counter64, IpAddress, Unsigned32, Integer32, enterprises, MibIdentifier, Bits, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "iso", "Counter32", "Counter64", "IpAddress", "Unsigned32", "Integer32", "enterprises", "MibIdentifier", "Bits", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetGroup=fcTargetGroup, poolState=poolState, poolMetaReadMbps=poolMetaReadMbps, replicationComplete=replicationComplete, diskGoneOffline=diskGoneOffline, lunInitiatorGroup=lunInitiatorGroup, poolTotalWriteIops=poolTotalWriteIops, poolSizeLow=poolSizeLow, shareTable=shareTable, haResourceEntry=haResourceEntry, replicationAborted=replicationAborted, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolIndex=poolIndex, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareProjectName=shareProjectName, diskDataWriteIops=diskDataWriteIops, iscsiTargetIndex=iscsiTargetIndex, poolMetaReadIops=poolMetaReadIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcTargetsTable=fcTargetsTable, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, notificationReadingTriggerValue=notificationReadingTriggerValue, poolAvgWriteLatency=poolAvgWriteLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectQuotaSizeHigh=projectQuotaSizeHigh, poolMetaWriteIops=poolMetaWriteIops, iscsiInitiatorEntry=iscsiInitiatorEntry, poolReadCacheReadLatency=poolReadCacheReadLatency, diskCount=diskCount, poolAvgReadLatency=poolAvgReadLatency, fcAvgReadLatency=fcAvgReadLatency, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareCIFSReadLatency=shareCIFSReadLatency, iscsiInitiators=iscsiInitiators, notificationDescription=notificationDescription, snmpServiceStartFailed=snmpServiceStartFailed, nicReceiveMbps=nicReceiveMbps, tegileConformance=tegileConformance, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, tegileGroups=tegileGroups, shareQuotaHigh=shareQuotaHigh, shareReservedSizeHigh=shareReservedSizeHigh, haResourceDescription=haResourceDescription, disks=disks, notificationSensorAction=notificationSensorAction, upgradeStarted=upgradeStarted, poolDataReadMbps=poolDataReadMbps, notificationObjects=notificationObjects, nfsTotalWriteIops=nfsTotalWriteIops, poolUsedSizeHigh=poolUsedSizeHigh, projectQuotaSizeLow=projectQuotaSizeLow, diskDataWriteMbps=diskDataWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, poolTotalSaving=poolTotalSaving, cifsAvgReadLatency=cifsAvgReadLatency, fcTargetWriteLatency=fcTargetWriteLatency, fcPortOffline=fcPortOffline, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareDataSizeHigh=shareDataSizeHigh, controllerTimeDrift=controllerTimeDrift, poolFreeSizeHigh=poolFreeSizeHigh, lunCompressionEnabled=lunCompressionEnabled, shareDeletionFailed=shareDeletionFailed, cpuTotalUsage=cpuTotalUsage, vmwareNFSDatastores=vmwareNFSDatastores, targetGroupMemberAdded=targetGroupMemberAdded, nfsTotalReadMbps=nfsTotalReadMbps, userLoginFailed=userLoginFailed, lunFreeSizeLow=lunFreeSizeLow, sharePoolName=sharePoolName, nicGroup=nicGroup, lunName=lunName, haControllerB_Uptime=haControllerB_Uptime, poolDataReadLatency=poolDataReadLatency, projectTable=projectTable, iscsiInitiatorsTable=iscsiInitiatorsTable, haResourceIndex=haResourceIndex, nvdimmFailUnknownError=nvdimmFailUnknownError, maintenanceModeDisabled=maintenanceModeDisabled, diskType=diskType, intelliFlashSoftwareUp=intelliFlashSoftwareUp, projectDeleted=projectDeleted, shareCompressedRatio=shareCompressedRatio, poolDegraded=poolDegraded, ipmiOther=ipmiOther, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, diskChassisIdx=diskChassisIdx, controllerDown=controllerDown, lunReservedSizeHigh=lunReservedSizeHigh, poolTotalReadMbps=poolTotalReadMbps, poolCreated=poolCreated, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, snapshotCloningFailed=snapshotCloningFailed, diskAvgReadLatency=diskAvgReadLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiTargetReadLatency=iscsiTargetReadLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, fcInitiatorIndex=fcInitiatorIndex, upgradeTimeout=upgradeTimeout, iscsiTotalReadIops=iscsiTotalReadIops, poolMetaWriteMbps=poolMetaWriteMbps, shareCIFSReadIops=shareCIFSReadIops, fcInitiatorGroup=fcInitiatorGroup, diskAvgWriteLatency=diskAvgWriteLatency, sanProperties=sanProperties, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiInitiatorChapUser=iscsiInitiatorChapUser, haResourceGroup=haResourceGroup, lunTable=lunTable, snapshotDeleteFailed=snapshotDeleteFailed, upgradeCompleted=upgradeCompleted, cacheTotalWriteIops=cacheTotalWriteIops, snmpServiceStopFailed=snmpServiceStopFailed, fcTotalReadIops=fcTotalReadIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, volumeModifyCompleted=volumeModifyCompleted, projectDataSizeLow=projectDataSizeLow, smisServiceStopped=smisServiceStopped, projectPoolName=projectPoolName, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, PYSNMP_MODULE_ID=tegile, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunReservedSizeLow=lunReservedSizeLow, notificationSeverity=notificationSeverity, iscsiTargetReadMbps=iscsiTargetReadMbps, notificationSensorSuspect=notificationSensorSuspect, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolFreeSizeLow=poolFreeSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, smbSocketFailure=smbSocketFailure, lunProtocol=lunProtocol, snmpServiceStarted=snmpServiceStarted, cpuInterrupts=cpuInterrupts, diskState=diskState, snapshotRollbackCompleted=snapshotRollbackCompleted, nfsTotalReadIops=nfsTotalReadIops, nvdimmFailInitializationError=nvdimmFailInitializationError, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiTargetGroup=iscsiTargetGroup, networkTotalReceiveMbps=networkTotalReceiveMbps, haControllerA_Uptime=haControllerA_Uptime, lunDedupEnabled=lunDedupEnabled, lunReadLatency=lunReadLatency, haResourceName=haResourceName, haResourceActiveNode=haResourceActiveNode, nfsAvgReadLatency=nfsAvgReadLatency, networkIpmpGroupUp=networkIpmpGroupUp, cifsTotalWriteIops=cifsTotalWriteIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiTargetName=iscsiTargetName, fcTargetReadIops=fcTargetReadIops, diskEntry=diskEntry, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectQuotaFinished=projectQuotaFinished, cifsTotalReadIops=cifsTotalReadIops, notificationTargetEntityName=notificationTargetEntityName, haResources=haResources, projectDeletionFailed=projectDeletionFailed, poolCount=poolCount, shareDeleted=shareDeleted, diskSizeHigh=diskSizeHigh, ipmiFan=ipmiFan, diskSizeLow=diskSizeLow, projectSnapshotSizeLow=projectSnapshotSizeLow, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskIsOnline=diskIsOnline, poolExpanded=poolExpanded, projectModified=projectModified, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, nicIndex=nicIndex, lunDataSizeHigh=lunDataSizeHigh, networkTotalTransmitMbps=networkTotalTransmitMbps, ipmiMemory=ipmiMemory, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetsTable=iscsiTargetsTable, shareDataSizeLow=shareDataSizeLow, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolUpgraded=poolUpgraded, shareNFSReadLatency=shareNFSReadLatency, notificationEventCode=notificationEventCode, snmpAgentVersion=snmpAgentVersion, controllerUp=controllerUp, haControllerA_Name=haControllerA_Name, unknownSensorEvent=unknownSensorEvent, poolTable=poolTable, iscsiProperties=iscsiProperties, cacheTotalReadIops=cacheTotalReadIops, diskTotalReadMbps=diskTotalReadMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, nfsTotalWriteMbps=nfsTotalWriteMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolDeletionFailed=poolDeletionFailed, targetGroupCreateCompleted=targetGroupCreateCompleted, projectFreeSizeLow=projectFreeSizeLow, iscsiTargets=iscsiTargets, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, replicationTargetDeleted=replicationTargetDeleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, tdpsUpgradeCompleted=tdpsUpgradeCompleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, smisServiceStarted=smisServiceStarted, iscsiTargetReadIops=iscsiTargetReadIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, networkIpmpGroupDown=networkIpmpGroupDown, targetGroupMemberRemoved=targetGroupMemberRemoved, testNotification=testNotification, lunTargetGroup=lunTargetGroup, poolTotalReadIops=poolTotalReadIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareNFSEnabled=shareNFSEnabled, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, projectFreeSizeHigh=projectFreeSizeHigh, pools=pools, shareNFSReadIops=shareNFSReadIops, replicationResumed=replicationResumed, tegileArray_notifications=tegileArray_notifications, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareQuotaLow=shareQuotaLow, lunGUID=lunGUID, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcTargetWriteIops=fcTargetWriteIops, poolProjects=poolProjects, projectEntry=projectEntry, lunSizeHigh=lunSizeHigh, smisServiceStartFailed=smisServiceStartFailed, fcTargets=fcTargets, snmpServiceStopped=snmpServiceStopped, poolOwnerController=poolOwnerController, poolDataWriteIops=poolDataWriteIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, diagnosticDataUploaded=diagnosticDataUploaded, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcAvgWriteLatency=fcAvgWriteLatency, ipmiTemperature=ipmiTemperature, cifsTotalWriteMbps=cifsTotalWriteMbps, diskAlias=diskAlias, volumeQuotaFinished=volumeQuotaFinished, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolDeleted=poolDeleted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, cacheSSDReads=cacheSSDReads)
mibBuilder.exportSymbols("TEGILE-MIB", projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiInitiatorGroup=iscsiInitiatorGroup, poolMetaWriteLatency=poolMetaWriteLatency, ipmiVoltage=ipmiVoltage, projectThresholdExceedWarning=projectThresholdExceedWarning, projectIndex=projectIndex, lunEntry=lunEntry, iscsiInitiatorIndex=iscsiInitiatorIndex, shareQuotaFinished=shareQuotaFinished, lunSnapshotSizeHigh=lunSnapshotSizeHigh, memoryFailure=memoryFailure, tegile=tegile, snapshotRollbackFailed=snapshotRollbackFailed, volumeDeleteCompleted=volumeDeleteCompleted, projectDataSizeHigh=projectDataSizeHigh, lunDataSizeLow=lunDataSizeLow, haControllerB_IPAddr=haControllerB_IPAddr, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiTargetEntry=iscsiTargetEntry, deleteFolderCompleted=deleteFolderCompleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, currentObjectGroup=currentObjectGroup, iscsiTargetAlias=iscsiTargetAlias, webdocsUpgradeFailed=webdocsUpgradeFailed, lunWriteLatency=lunWriteLatency, shareIndex=shareIndex, poolImported=poolImported, volumeDeleteFailed=volumeDeleteFailed, shareEntry=shareEntry, lunProjectName=lunProjectName, diskPoolName=diskPoolName, diskIndex=diskIndex, lunReadIops=lunReadIops, fcProperties=fcProperties, fcTotalWriteIops=fcTotalWriteIops, projectShareCount=projectShareCount, alertsCleanupCompleted=alertsCleanupCompleted, basicCompliance=basicCompliance, poolEntry=poolEntry, haControllerB_Name=haControllerB_Name, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, aclMigrationStarted=aclMigrationStarted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiWriteIops=iscsiWriteIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, replicationFailed=replicationFailed, shareMountPoint=shareMountPoint, intelliFlashSoftwareDown=intelliFlashSoftwareDown, notificationThresholdTriggerValue=notificationThresholdTriggerValue, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, replicationSourceRegistered=replicationSourceRegistered, adServerTimeDrift=adServerTimeDrift, shareName=shareName, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, globalStatistics=globalStatistics, projectTotalSaving=projectTotalSaving, ntpServerTimeDrift=ntpServerTimeDrift, poolSizeHigh=poolSizeHigh, diskDataReadMbps=diskDataReadMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, ipmiPowerSupply=ipmiPowerSupply, projectName=projectName, cifsTotalReadMbps=cifsTotalReadMbps, poolDataReadIops=poolDataReadIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, sensorFailureEvent=sensorFailureEvent, shareCIFSWriteMbps=shareCIFSWriteMbps, fcTargetStatus=fcTargetStatus, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunPoolName=lunPoolName, fcTargetWriteMbps=fcTargetWriteMbps, diskError=diskError, nicName=nicName, spareDiskReplaced=spareDiskReplaced, lunWriteMbps=lunWriteMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, notificationProps=notificationProps, iscsiTargetError=iscsiTargetError, shareNFSWriteLatency=shareNFSWriteLatency, ipmiThreshold=ipmiThreshold, nicEntry=nicEntry, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareReservedSizeLow=shareReservedSizeLow, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, notificationReadingUnit=notificationReadingUnit, lunIndex=lunIndex, notificationComponentName=notificationComponentName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolReadCacheWriteIops=poolReadCacheWriteIops, tegileArray=tegileArray, cifsAvgWriteLatency=cifsAvgWriteLatency, upgradeFailed=upgradeFailed, shareDedupEnabled=shareDedupEnabled, poolReadCacheReadIops=poolReadCacheReadIops, poolDataSizeLow=poolDataSizeLow, fcTargetModifyCompleted=fcTargetModifyCompleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunReadMbps=lunReadMbps, replicationAbandoned=replicationAbandoned, fcPortOnline=fcPortOnline, poolTotalWriteMbps=poolTotalWriteMbps, nicMTU=nicMTU, diskTotalWriteMbps=diskTotalWriteMbps, replicationPaused=replicationPaused, networkInterfaceDown=networkInterfaceDown, poolExported=poolExported, fcInitiators=fcInitiators, projectLUNs=projectLUNs, iscsiTargetWriteLatency=iscsiTargetWriteLatency, diskTotalReadIops=diskTotalReadIops, haControllerA_IPAddr=haControllerA_IPAddr, haResourcesTable=haResourcesTable, diskSlowIo=diskSlowIo, diskTable=diskTable, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diskRandomIOCount=diskRandomIOCount, projectDedupEnabled=projectDedupEnabled, maintenanceModeEnabled=maintenanceModeEnabled, shareNFSWriteIops=shareNFSWriteIops, fcInitiatorName=fcInitiatorName, poolQuotaFinished=poolQuotaFinished, shareCreatedSuccessfully=shareCreatedSuccessfully, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, ipmiCurrent=ipmiCurrent, shareCIFSWriteIops=shareCIFSWriteIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, netbiosSocketFailure=netbiosSocketFailure, diskSequentialIOCount=diskSequentialIOCount, fcTargetReadMbps=fcTargetReadMbps, lunFreeSizeHigh=lunFreeSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, notificationSensorNumber=notificationSensorNumber, lunWriteIops=lunWriteIops, tegileCompliances=tegileCompliances, poolUsedSizeLow=poolUsedSizeLow, properties=properties, lunSnapshotSizeLow=lunSnapshotSizeLow, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, projectCreatedSuccessfully=projectCreatedSuccessfully, poolMetaReadLatency=poolMetaReadLatency, currentNotificationGroup=currentNotificationGroup, replicationStarted=replicationStarted, fcTotalReadMbps=fcTotalReadMbps, networkInterfaceUp=networkInterfaceUp, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolHealth=poolHealth, poolProjectCount=poolProjectCount, fcTotalWriteMbps=fcTotalWriteMbps, cacheRAMReads=cacheRAMReads, diskTotalWriteIops=diskTotalWriteIops, snapshotCreationFailed=snapshotCreationFailed, shareNFSReadMbps=shareNFSReadMbps, smisServiceStopFailed=smisServiceStopFailed, iscsiInitiatorName=iscsiInitiatorName, iscsiAvgReadLatency=iscsiAvgReadLatency, projectCompressionEnabled=projectCompressionEnabled, lunCompressedRatio=lunCompressedRatio, upgradeDownloadStarted=upgradeDownloadStarted, projectShares=projectShares, poolDataWriteMbps=poolDataWriteMbps, iscsiTargetAuth=iscsiTargetAuth, fcTargetName=fcTargetName, shareCIFSEnabled=shareCIFSEnabled, shareCompressionEnabled=shareCompressionEnabled, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcTargetIndex=fcTargetIndex, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, network=network, haResourceStatus=haResourceStatus, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, diskIOCount=diskIOCount, notifications=notifications, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcTargetReadLatency=fcTargetReadLatency, fcInitiatorsTable=fcInitiatorsTable, cpuSystemCalls=cpuSystemCalls, upgradeDownloadFailed=upgradeDownloadFailed, lunBlockSize=lunBlockSize, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolDataWriteLatency=poolDataWriteLatency, snapshotCloneCompleted=snapshotCloneCompleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, cacheTotalReadMbps=cacheTotalReadMbps, projectLunCount=projectLunCount, nvdimmFailSoftError=nvdimmFailSoftError, volumeCreatedSuccessfully=volumeCreatedSuccessfully, nfsAvgWriteLatency=nfsAvgWriteLatency, nicState=nicState, poolName=poolName, nicTable=nicTable, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolDataSizeHigh=poolDataSizeHigh, controllerHardwareModel=controllerHardwareModel, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, deleteFolderFailed=deleteFolderFailed, notificationTime=notificationTime, shareSnapshotSizeHigh=shareSnapshotSizeHigh, nicTransmitMbps=nicTransmitMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, fcInitiatorEntry=fcInitiatorEntry, diskDataReadIops=diskDataReadIops, lunSizeLow=lunSizeLow, targetGroupDeleteCompleted=targetGroupDeleteCompleted, fcTargetEntry=fcTargetEntry, shareNFSWriteMbps=shareNFSWriteMbps, cacheTotalWriteMbps=cacheTotalWriteMbps)
