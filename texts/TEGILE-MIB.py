...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:29:50 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, ObjectIdentity, IpAddress, Unsigned32, NotificationType, enterprises, TimeTicks, Counter32, Gauge32, Integer32, Counter64, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "ObjectIdentity", "IpAddress", "Unsigned32", "NotificationType", "enterprises", "TimeTicks", "Counter32", "Gauge32", "Integer32", "Counter64", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareCIFSWriteIops=shareCIFSWriteIops, diskTotalWriteIops=diskTotalWriteIops, lunFreeSizeHigh=lunFreeSizeHigh, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, ipmiPowerSupply=ipmiPowerSupply, notificationObjects=notificationObjects, shareQuotaHigh=shareQuotaHigh, diskDataWriteMbps=diskDataWriteMbps, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareIndex=shareIndex, shareTable=shareTable, nicName=nicName, haControllerA_Name=haControllerA_Name, snmpServiceStopFailed=snmpServiceStopFailed, upgradeStarted=upgradeStarted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolDeletionFailed=poolDeletionFailed, lunCompressionEnabled=lunCompressionEnabled, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskSequentialIOCount=diskSequentialIOCount, fcPortOffline=fcPortOffline, volumeQuotaFinished=volumeQuotaFinished, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, ipmiOther=ipmiOther, poolCount=poolCount, iscsiTargetWriteIops=iscsiTargetWriteIops, lunBlockSize=lunBlockSize, poolImported=poolImported, shareCompressedRatio=shareCompressedRatio, replicationComplete=replicationComplete, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, notificationSeverity=notificationSeverity, targetGroupCreateCompleted=targetGroupCreateCompleted, fcTargetIndex=fcTargetIndex, snapshotDeleteFailed=snapshotDeleteFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, replicationTargetDeleted=replicationTargetDeleted, snmpServiceStartFailed=snmpServiceStartFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, poolOwnerController=poolOwnerController, diskSizeHigh=diskSizeHigh, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareReservedSizeHigh=shareReservedSizeHigh, lunDataSizeHigh=lunDataSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolTotalReadMbps=poolTotalReadMbps, projectQuotaFinished=projectQuotaFinished, fcTargetEntry=fcTargetEntry, cacheTotalWriteMbps=cacheTotalWriteMbps, cacheTotalWriteIops=cacheTotalWriteIops, poolSizeLow=poolSizeLow, notificationSensorAction=notificationSensorAction, lunCompressedRatio=lunCompressedRatio, fcTargetReadIops=fcTargetReadIops, diskTable=diskTable, shareNFSReadMbps=shareNFSReadMbps, cacheRAMReads=cacheRAMReads, poolDeleted=poolDeleted, iscsiTargetGroupError=iscsiTargetGroupError, projectPoolName=projectPoolName, projectDeleted=projectDeleted, projectEntry=projectEntry, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunIndex=lunIndex, maintenanceModeEnabled=maintenanceModeEnabled, initiatorGroupMemberAdded=initiatorGroupMemberAdded, notificationReadingTriggerValue=notificationReadingTriggerValue, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareDedupEnabled=shareDedupEnabled, projectQuotaSizeLow=projectQuotaSizeLow, nicState=nicState, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, notificationSensorSuspect=notificationSensorSuspect, aclMigrationStarted=aclMigrationStarted, replicationPaused=replicationPaused, shareEntry=shareEntry, haResourceIndex=haResourceIndex, haResourceDescription=haResourceDescription, ipmiCurrent=ipmiCurrent, lunSnapshotSizeLow=lunSnapshotSizeLow, networkInterfaceUp=networkInterfaceUp, poolReadCacheReadMbps=poolReadCacheReadMbps, fcInitiators=fcInitiators, iscsiProperties=iscsiProperties, fcAvgWriteLatency=fcAvgWriteLatency, nicEntry=nicEntry, projectCreatedSuccessfully=projectCreatedSuccessfully, volumeDeleteCompleted=volumeDeleteCompleted, shareQuotaLow=shareQuotaLow, haResourceGroup=haResourceGroup, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareProjectName=shareProjectName, nicIndex=nicIndex, nicGroup=nicGroup, lunTable=lunTable, currentNotificationGroup=currentNotificationGroup, poolState=poolState, iscsiInitiatorName=iscsiInitiatorName, shareNFSEnabled=shareNFSEnabled, iscsiTargetGroup=iscsiTargetGroup, tegileArray_notifications=tegileArray_notifications, poolIndex=poolIndex, shareCIFSReadIops=shareCIFSReadIops, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationComponentName=notificationComponentName, haControllerB_Name=haControllerB_Name, iscsiTotalReadIops=iscsiTotalReadIops, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, smbSocketFailure=smbSocketFailure, poolUsedSizeHigh=poolUsedSizeHigh, projectTotalSaving=projectTotalSaving, projectName=projectName, shareDeletionFailed=shareDeletionFailed, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolTotalWriteMbps=poolTotalWriteMbps, disks=disks, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diskAlias=diskAlias, shareSnapshotSizeLow=shareSnapshotSizeLow, fcTotalReadIops=fcTotalReadIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, cifsAvgReadLatency=cifsAvgReadLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolDegraded=poolDegraded, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, replicationAbandoned=replicationAbandoned, replicationResumed=replicationResumed, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiTotalWriteMbps=iscsiTotalWriteMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolHealth=poolHealth, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, iscsiTargetName=iscsiTargetName, lunReadMbps=lunReadMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, sharePoolName=sharePoolName, shareCompressionEnabled=shareCompressionEnabled, projectDeletionFailed=projectDeletionFailed, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolDataReadMbps=poolDataReadMbps, replicationStarted=replicationStarted, nfsTotalReadMbps=nfsTotalReadMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, projectLunCount=projectLunCount, nicReceiveMbps=nicReceiveMbps, upgradeFailed=upgradeFailed, snapshotCloningFailed=snapshotCloningFailed, projectCompressionEnabled=projectCompressionEnabled, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, netbiosSocketFailure=netbiosSocketFailure, nvdimmFailDeviceError=nvdimmFailDeviceError, lunGUID=lunGUID, notificationDescription=notificationDescription, shareDataSizeLow=shareDataSizeLow, diskCount=diskCount, poolSizeHigh=poolSizeHigh, projectFreeSizeLow=projectFreeSizeLow, poolDataSizeHigh=poolDataSizeHigh, smisServiceStartFailed=smisServiceStartFailed, projectDedupEnabled=projectDedupEnabled, cacheSSDReads=cacheSSDReads, nfsAvgReadLatency=nfsAvgReadLatency, shareMountPoint=shareMountPoint, lunDataSizeLow=lunDataSizeLow, controllerDown=controllerDown, poolDataWriteMbps=poolDataWriteMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolMetaReadIops=poolMetaReadIops, poolQuotaFinished=poolQuotaFinished, sanProperties=sanProperties, fcTargetStatus=fcTargetStatus, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, controllerTimeDrift=controllerTimeDrift, iscsiTargetWriteMbps=iscsiTargetWriteMbps, properties=properties, shareName=shareName, haControllerB_Uptime=haControllerB_Uptime, poolDataWriteLatency=poolDataWriteLatency, adServerTimeDrift=adServerTimeDrift, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTotalReadMbps=fcTotalReadMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, fcTargets=fcTargets, smisServiceStopped=smisServiceStopped, cacheTotalReadIops=cacheTotalReadIops, upgradeTimeout=upgradeTimeout, poolMetaReadLatency=poolMetaReadLatency, diskType=diskType, nfsTotalWriteIops=nfsTotalWriteIops, iscsiAvgReadLatency=iscsiAvgReadLatency, haControllerA_IPAddr=haControllerA_IPAddr, fcTargetName=fcTargetName, poolAvgReadLatency=poolAvgReadLatency, diskPoolName=diskPoolName, fcPortOnline=fcPortOnline, iscsiTargetIndex=iscsiTargetIndex, memoryFailure=memoryFailure, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, ipmiThreshold=ipmiThreshold, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, snmpServiceStopped=snmpServiceStopped, notifications=notifications, poolTotalReadIops=poolTotalReadIops, ipmiTemperature=ipmiTemperature, diskGoneOffline=diskGoneOffline, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, snmpAgentVersion=snmpAgentVersion, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, lunProjectName=lunProjectName, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolMetaReadMbps=poolMetaReadMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, diskState=diskState, diskDataWriteIops=diskDataWriteIops, smisServiceStarted=smisServiceStarted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareCIFSWriteLatency=shareCIFSWriteLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareExceedThresholdWarning=shareExceedThresholdWarning, cacheTotalReadMbps=cacheTotalReadMbps, networkIpmpGroupUp=networkIpmpGroupUp, snapshotCreationFailed=snapshotCreationFailed, nfsTotalWriteMbps=nfsTotalWriteMbps, poolExported=poolExported, fcProperties=fcProperties, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, globalStatistics=globalStatistics, lunEntry=lunEntry, lunWriteLatency=lunWriteLatency, replicationSourceRegistered=replicationSourceRegistered, tdpsUpgradeFailed=tdpsUpgradeFailed, shareCIFSReadLatency=shareCIFSReadLatency, lunSizeHigh=lunSizeHigh, shareNFSReadLatency=shareNFSReadLatency, fcInitiatorName=fcInitiatorName, snapshotRollbackFailed=snapshotRollbackFailed, shareNFSWriteMbps=shareNFSWriteMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, tdpsUpgradeTimeout=tdpsUpgradeTimeout, fcTargetWriteMbps=fcTargetWriteMbps, lunSizeLow=lunSizeLow, cpuTotalUsage=cpuTotalUsage, cifsTotalReadIops=cifsTotalReadIops)
mibBuilder.exportSymbols("TEGILE-MIB", diskIndex=diskIndex, poolName=poolName, diskSizeLow=diskSizeLow, iscsiInitiators=iscsiInitiators, poolDataReadLatency=poolDataReadLatency, lunName=lunName, diskIOCount=diskIOCount, iscsiInitiatorGroup=iscsiInitiatorGroup, projectTable=projectTable, poolCreated=poolCreated, snapshotCloneCompleted=snapshotCloneCompleted, ipmiMemory=ipmiMemory, fcInitiatorsTable=fcInitiatorsTable, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, projectShares=projectShares, lunPoolName=lunPoolName, iscsiInitiatorEntry=iscsiInitiatorEntry, poolReadCacheWriteMbps=poolReadCacheWriteMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiWriteIops=iscsiWriteIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcTargetWriteIops=fcTargetWriteIops, pools=pools, testNotification=testNotification, lunReadLatency=lunReadLatency, unknownSensorEvent=unknownSensorEvent, iscsiTargetError=iscsiTargetError, lunInitiatorGroup=lunInitiatorGroup, cpuSystemCalls=cpuSystemCalls, networkTotalReceiveMbps=networkTotalReceiveMbps, tegileConformance=tegileConformance, poolDataSizeLow=poolDataSizeLow, diskTotalReadMbps=diskTotalReadMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, nfsTotalReadIops=nfsTotalReadIops, shareDataSizeHigh=shareDataSizeHigh, fcInitiatorGroup=fcInitiatorGroup, alertsCleanupCompleted=alertsCleanupCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectDataSizeHigh=projectDataSizeHigh, targetGroupMemberAdded=targetGroupMemberAdded, poolEntry=poolEntry, iscsiTargetAlias=iscsiTargetAlias, upgradeDownloadFailed=upgradeDownloadFailed, iscsiTargetEntry=iscsiTargetEntry, poolDataWriteIops=poolDataWriteIops, diskError=diskError, nfsAvgWriteLatency=nfsAvgWriteLatency, haResourceName=haResourceName, diskAvgReadLatency=diskAvgReadLatency, upgradeDownloadStarted=upgradeDownloadStarted, lunReservedSizeHigh=lunReservedSizeHigh, projectDataSizeLow=projectDataSizeLow, notificationEventCode=notificationEventCode, haControllerB_IPAddr=haControllerB_IPAddr, deleteFolderFailed=deleteFolderFailed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, haResourceEntry=haResourceEntry, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiTargetAuth=iscsiTargetAuth, iscsiInitiatorsTable=iscsiInitiatorsTable, fcTargetGroup=fcTargetGroup, fcTargetReadMbps=fcTargetReadMbps, poolMetaWriteIops=poolMetaWriteIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolFreeSizeHigh=poolFreeSizeHigh, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiTargets=iscsiTargets, notificationTargetEntityName=notificationTargetEntityName, snmpServiceStarted=snmpServiceStarted, notificationProps=notificationProps, poolReadCacheReadIops=poolReadCacheReadIops, shareCIFSEnabled=shareCIFSEnabled, intelliFlashSoftwareDown=intelliFlashSoftwareDown, replicationFailed=replicationFailed, lunTargetGroup=lunTargetGroup, lunWriteIops=lunWriteIops, fcTargetReadLatency=fcTargetReadLatency, fcInitiatorIndex=fcInitiatorIndex, poolMetaWriteLatency=poolMetaWriteLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, controllerUp=controllerUp, projectFreeSizeHigh=projectFreeSizeHigh, PYSNMP_MODULE_ID=tegile, poolProjectCount=poolProjectCount, volumeDeleteFailed=volumeDeleteFailed, iscsiTargetReadLatency=iscsiTargetReadLatency, fcAvgReadLatency=fcAvgReadLatency, basicCompliance=basicCompliance, diagnosticDataUploaded=diagnosticDataUploaded, cifsTotalWriteMbps=cifsTotalWriteMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, cpuInterrupts=cpuInterrupts, lunDedupEnabled=lunDedupEnabled, poolAvgWriteLatency=poolAvgWriteLatency, fcTargetsTable=fcTargetsTable, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, network=network, poolTable=poolTable, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, diskDataReadIops=diskDataReadIops, cifsTotalReadMbps=cifsTotalReadMbps, poolUsedSizeLow=poolUsedSizeLow, fcTotalWriteIops=fcTotalWriteIops, shareNFSWriteLatency=shareNFSWriteLatency, upgradeCompleted=upgradeCompleted, fcTotalWriteMbps=fcTotalWriteMbps, poolTotalSaving=poolTotalSaving, shareDeleted=shareDeleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareReservedSizeLow=shareReservedSizeLow, lunWriteMbps=lunWriteMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, notificationTime=notificationTime, volumeModifyCompleted=volumeModifyCompleted, projectShareCount=projectShareCount, notificationReadingUnit=notificationReadingUnit, ipmiVoltage=ipmiVoltage, shareQuotaFinished=shareQuotaFinished, iscsiTotalReadMbps=iscsiTotalReadMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, ipmiFan=ipmiFan, poolProjects=poolProjects, projectLUNs=projectLUNs, diskChassisIdx=diskChassisIdx, ntpServerTimeDrift=ntpServerTimeDrift, poolDataReadIops=poolDataReadIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskTotalWriteMbps=diskTotalWriteMbps, replicationAborted=replicationAborted, fcTargetModifyCompleted=fcTargetModifyCompleted, diskTotalReadIops=diskTotalReadIops, targetGroupMemberRemoved=targetGroupMemberRemoved, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, userLoginFailed=userLoginFailed, poolWriteCacheWriteIops=poolWriteCacheWriteIops, cifsTotalWriteIops=cifsTotalWriteIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, fcInitiatorEntry=fcInitiatorEntry, nicTable=nicTable, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, spareDiskReplaced=spareDiskReplaced, haResourceActiveNode=haResourceActiveNode, shareCIFSReadMbps=shareCIFSReadMbps, diskDataReadMbps=diskDataReadMbps, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, controllerHardwareModel=controllerHardwareModel, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, haControllerA_Uptime=haControllerA_Uptime, nicTransmitMbps=nicTransmitMbps, sensorFailureEvent=sensorFailureEvent, diskSlowIo=diskSlowIo, poolUpgraded=poolUpgraded, shareNFSWriteIops=shareNFSWriteIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, diskEntry=diskEntry, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, vmwareNFSDatastores=vmwareNFSDatastores, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolFreeSizeLow=poolFreeSizeLow, poolTotalWriteIops=poolTotalWriteIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, maintenanceModeDisabled=maintenanceModeDisabled, aclMigrationCompleted=aclMigrationCompleted, tegileArray=tegileArray, projectIndex=projectIndex, poolExpanded=poolExpanded, snapshotRollbackCompleted=snapshotRollbackCompleted, shareNFSReadIops=shareNFSReadIops, lunReadIops=lunReadIops, haResources=haResources, projectModified=projectModified, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, haResourcesTable=haResourcesTable, iscsiTargetReadMbps=iscsiTargetReadMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, networkTotalTransmitMbps=networkTotalTransmitMbps, haResourceStatus=haResourceStatus, lunProtocol=lunProtocol, iscsiTargetsTable=iscsiTargetsTable, nicMTU=nicMTU, smisServiceStopFailed=smisServiceStopFailed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, networkInterfaceDown=networkInterfaceDown, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, shareCIFSWriteMbps=shareCIFSWriteMbps, deleteFolderCompleted=deleteFolderCompleted, tegileCompliances=tegileCompliances, lunReservedSizeLow=lunReservedSizeLow, tegileGroups=tegileGroups, diskRandomIOCount=diskRandomIOCount, iscsiInitiatorChapUser=iscsiInitiatorChapUser, lunFreeSizeLow=lunFreeSizeLow, diskAvgWriteLatency=diskAvgWriteLatency, currentObjectGroup=currentObjectGroup, diskIsOnline=diskIsOnline, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcTargetWriteLatency=fcTargetWriteLatency, nvdimmFailSoftError=nvdimmFailSoftError, networkIpmpGroupDown=networkIpmpGroupDown, iscsiAvgWriteLatency=iscsiAvgWriteLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, tegile=tegile, poolMetaWriteMbps=poolMetaWriteMbps)
