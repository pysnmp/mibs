...
# Produced by pysmi-1.1.12 at Fri Apr 12 00:33:45 2024
...
TimeTicks, MibIdentifier, Integer32, Bits, Counter32, Counter64, enterprises, iso, ModuleIdentity, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Integer32", "Bits", "Counter32", "Counter64", "enterprises", "iso", "ModuleIdentity", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcTargetReadLatency=fcTargetReadLatency, targetGroupMemberRemoved=targetGroupMemberRemoved, projectQuotaSizeHigh=projectQuotaSizeHigh, lunSnapshotSizeLow=lunSnapshotSizeLow, poolSizeLow=poolSizeLow, diskPoolName=diskPoolName, poolReadCacheWriteIops=poolReadCacheWriteIops, diskTotalReadMbps=diskTotalReadMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiWriteIops=iscsiWriteIops, volumeDeleteCompleted=volumeDeleteCompleted, replicationResumed=replicationResumed, poolMetaWriteMbps=poolMetaWriteMbps, projectName=projectName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, projectPoolName=projectPoolName, projectLunCount=projectLunCount, projectDedupEnabled=projectDedupEnabled, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, notificationDescription=notificationDescription, fcTargetReadIops=fcTargetReadIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, diskDataWriteMbps=diskDataWriteMbps, shareIndex=shareIndex, ipmiMemory=ipmiMemory, snmpServiceStopped=snmpServiceStopped, haResourceIndex=haResourceIndex, nvdimmFailSoftError=nvdimmFailSoftError, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiTotalReadIops=iscsiTotalReadIops, shareEntry=shareEntry, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareQuotaHigh=shareQuotaHigh, lunFreeSizeHigh=lunFreeSizeHigh, fcInitiatorGroup=fcInitiatorGroup, notificationProps=notificationProps, cacheTotalReadMbps=cacheTotalReadMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, lunName=lunName, lunProtocol=lunProtocol, poolImported=poolImported, cpuTotalUsage=cpuTotalUsage, network=network, iscsiImproperTargetGroup=iscsiImproperTargetGroup, notificationReadingUnit=notificationReadingUnit, globalStatistics=globalStatistics, projectDeletionFailed=projectDeletionFailed, poolMetaReadLatency=poolMetaReadLatency, lunProjectName=lunProjectName, intelliFlashSoftwareUp=intelliFlashSoftwareUp, cpuInterrupts=cpuInterrupts, nvdimmFailInitializationError=nvdimmFailInitializationError, shareCIFSReadMbps=shareCIFSReadMbps, ipmiCurrent=ipmiCurrent, nfsTotalWriteMbps=nfsTotalWriteMbps, diskDataReadIops=diskDataReadIops, volumeQuotaFinished=volumeQuotaFinished, controllerTimeDrift=controllerTimeDrift, properties=properties, nfsTotalReadIops=nfsTotalReadIops, sanProperties=sanProperties, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, fcInitiatorsTable=fcInitiatorsTable, diskGoneOffline=diskGoneOffline, shareCIFSWriteMbps=shareCIFSWriteMbps, maintenanceModeEnabled=maintenanceModeEnabled, nfsAvgReadLatency=nfsAvgReadLatency, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolOwnerController=poolOwnerController, poolWriteCacheWriteIops=poolWriteCacheWriteIops, lunTargetGroup=lunTargetGroup, fcTargets=fcTargets, projectFreeSizeLow=projectFreeSizeLow, tdpsUpgradeFailed=tdpsUpgradeFailed, snmpServiceStopFailed=snmpServiceStopFailed, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiTargetAuth=iscsiTargetAuth, poolTotalWriteIops=poolTotalWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, diskDataWriteIops=diskDataWriteIops, replicationAbandoned=replicationAbandoned, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, diskTable=diskTable, diskAvgReadLatency=diskAvgReadLatency, pools=pools, shareReservedSizeLow=shareReservedSizeLow, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskEntry=diskEntry, haResourceName=haResourceName, testNotification=testNotification, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cifsTotalReadMbps=cifsTotalReadMbps, volumeModifyCompleted=volumeModifyCompleted, iscsiInitiatorIndex=iscsiInitiatorIndex, nicTable=nicTable, ipmiOther=ipmiOther, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectFreeSizeHigh=projectFreeSizeHigh, networkIpmpGroupUp=networkIpmpGroupUp, iscsiTargetReadMbps=iscsiTargetReadMbps, iscsiTargets=iscsiTargets, haControllerA_Name=haControllerA_Name, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, snmpAgentVersion=snmpAgentVersion, nvdimmFailDeviceError=nvdimmFailDeviceError, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, tdpsUpgradeCompleted=tdpsUpgradeCompleted, projectIndex=projectIndex, networkInterfaceDown=networkInterfaceDown, replicationStarted=replicationStarted, networkTotalReceiveMbps=networkTotalReceiveMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, iscsiInitiatorChapUser=iscsiInitiatorChapUser, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, nicEntry=nicEntry, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diskSizeLow=diskSizeLow, poolTotalSaving=poolTotalSaving, fcTargetReadMbps=fcTargetReadMbps, fcProperties=fcProperties, lunBlockSize=lunBlockSize, ipmiPowerSupply=ipmiPowerSupply, cifsTotalWriteIops=cifsTotalWriteIops, notificationEventCode=notificationEventCode, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiTargetError=iscsiTargetError, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, nicReceiveMbps=nicReceiveMbps, lunReadIops=lunReadIops, fcPortOffline=fcPortOffline, poolMetaWriteIops=poolMetaWriteIops, lunReadLatency=lunReadLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, poolIndex=poolIndex, smbSocketFailure=smbSocketFailure, snapshotCloningFailed=snapshotCloningFailed, projectShares=projectShares, lunPoolName=lunPoolName, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiTargetGroup=iscsiTargetGroup, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, unknownSensorEvent=unknownSensorEvent, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskCount=diskCount, sensorFailureEvent=sensorFailureEvent, basicCompliance=basicCompliance, targetGroupMemberAdded=targetGroupMemberAdded, haControllerB_Name=haControllerB_Name, lunSizeHigh=lunSizeHigh, smisServiceStopped=smisServiceStopped, ntpServerTimeDrift=ntpServerTimeDrift, poolMetaReadMbps=poolMetaReadMbps, poolAvgWriteLatency=poolAvgWriteLatency, replicationAborted=replicationAborted, poolReadCacheReadMbps=poolReadCacheReadMbps, smisServiceStartFailed=smisServiceStartFailed, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, cpuSystemCalls=cpuSystemCalls, fcPortOnline=fcPortOnline, haControllerA_Uptime=haControllerA_Uptime, diskAvgWriteLatency=diskAvgWriteLatency, poolUsedSizeLow=poolUsedSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, notificationComponentName=notificationComponentName, iscsiTargetReadIops=iscsiTargetReadIops, diskDataReadMbps=diskDataReadMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, haResourceActiveNode=haResourceActiveNode, snapshotRollbackCompleted=snapshotRollbackCompleted, replicationPaused=replicationPaused, lunInitiatorGroup=lunInitiatorGroup, replicationTargetDeleted=replicationTargetDeleted, shareName=shareName, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolDegraded=poolDegraded, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, notificationSensorAction=notificationSensorAction, haResourceGroup=haResourceGroup, shareDeletionFailed=shareDeletionFailed, shareNFSWriteIops=shareNFSWriteIops, fcInitiators=fcInitiators, userLoginFailed=userLoginFailed, fcTargetsTable=fcTargetsTable, iscsiTargetsTable=iscsiTargetsTable, shareCompressionEnabled=shareCompressionEnabled, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectCompressionEnabled=projectCompressionEnabled, lunReservedSizeLow=lunReservedSizeLow, haResources=haResources, poolReadCacheWriteLatency=poolReadCacheWriteLatency, cacheSSDReads=cacheSSDReads, cifsAvgReadLatency=cifsAvgReadLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, lunGUID=lunGUID, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolEntry=poolEntry, fcTargetEntry=fcTargetEntry, diskRandomIOCount=diskRandomIOCount, fcTargetGroup=fcTargetGroup, poolTotalWriteMbps=poolTotalWriteMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, memoryFailure=memoryFailure, poolTotalReadMbps=poolTotalReadMbps, poolDeleted=poolDeleted, cacheRAMReads=cacheRAMReads, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, projectLUNs=projectLUNs, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskIOCount=diskIOCount, networkInterfaceUp=networkInterfaceUp, upgradeDownloadStarted=upgradeDownloadStarted, shareCIFSWriteLatency=shareCIFSWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, poolDataSizeHigh=poolDataSizeHigh, projectModified=projectModified, shareMountPoint=shareMountPoint, poolCreated=poolCreated, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolDataWriteLatency=poolDataWriteLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, upgradeCompleted=upgradeCompleted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolMetaWriteLatency=poolMetaWriteLatency, shareDataSizeLow=shareDataSizeLow, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, fcAvgWriteLatency=fcAvgWriteLatency, fcTargetStatus=fcTargetStatus, replicationFailed=replicationFailed, vmwareNFSDatastores=vmwareNFSDatastores, cacheTotalReadIops=cacheTotalReadIops, iscsiTargetReadLatency=iscsiTargetReadLatency, notificationObjects=notificationObjects, diskTotalWriteIops=diskTotalWriteIops, poolDataSizeLow=poolDataSizeLow, projectShareCount=projectShareCount, tegile=tegile, fcInitiatorEntry=fcInitiatorEntry, poolHealth=poolHealth, controllerHardwareModel=controllerHardwareModel, iscsiInitiators=iscsiInitiators, diskSlowIo=diskSlowIo, shareQuotaFinished=shareQuotaFinished, adServerTimeDrift=adServerTimeDrift)
mibBuilder.exportSymbols("TEGILE-MIB", diskChassisIdx=diskChassisIdx, notificationSensorSuspect=notificationSensorSuspect, iscsiTargetGroupError=iscsiTargetGroupError, lunTable=lunTable, controllerDown=controllerDown, networkIpmpGroupDown=networkIpmpGroupDown, fcAvgReadLatency=fcAvgReadLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunReadMbps=lunReadMbps, haResourceStatus=haResourceStatus, lunSizeLow=lunSizeLow, deleteFolderCompleted=deleteFolderCompleted, poolTotalReadIops=poolTotalReadIops, nicMTU=nicMTU, lunWriteIops=lunWriteIops, fcTotalWriteMbps=fcTotalWriteMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, projectDataSizeHigh=projectDataSizeHigh, fcInitiatorIndex=fcInitiatorIndex, nvdimmFailUnknownError=nvdimmFailUnknownError, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, shareProjectName=shareProjectName, poolState=poolState, poolDataReadMbps=poolDataReadMbps, upgradeStarted=upgradeStarted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, projectSnapshotSizeLow=projectSnapshotSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, poolAvgReadLatency=poolAvgReadLatency, diskAlias=diskAlias, lunCompressionEnabled=lunCompressionEnabled, controllerUp=controllerUp, shareCIFSReadLatency=shareCIFSReadLatency, currentObjectGroup=currentObjectGroup, fcTotalReadMbps=fcTotalReadMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, diskType=diskType, notifications=notifications, tegileCompliances=tegileCompliances, poolFreeSizeLow=poolFreeSizeLow, iscsiTargetName=iscsiTargetName, projectQuotaSizeLow=projectQuotaSizeLow, alertsCleanupCompleted=alertsCleanupCompleted, snmpServiceStarted=snmpServiceStarted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, fcTargetWriteIops=fcTargetWriteIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolReadCacheWriteMbps=poolReadCacheWriteMbps, aclMigrationCompleted=aclMigrationCompleted, deleteFolderFailed=deleteFolderFailed, iscsiInitiatorName=iscsiInitiatorName, fcTotalWriteIops=fcTotalWriteIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareDataSizeHigh=shareDataSizeHigh, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiTargetIndex=iscsiTargetIndex, shareNFSReadLatency=shareNFSReadLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, haControllerB_IPAddr=haControllerB_IPAddr, poolUsedSizeHigh=poolUsedSizeHigh, shareNFSReadIops=shareNFSReadIops, poolName=poolName, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskIndex=diskIndex, iscsiTargetEntry=iscsiTargetEntry, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, ipmiThreshold=ipmiThreshold, nicGroup=nicGroup, lunWriteMbps=lunWriteMbps, poolExpanded=poolExpanded, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, tdpsUpgradeTimeout=tdpsUpgradeTimeout, cifsTotalReadIops=cifsTotalReadIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareReservedSizeHigh=shareReservedSizeHigh, shareDeleted=shareDeleted, haResourcesTable=haResourcesTable, spareDiskReplaced=spareDiskReplaced, lunEntry=lunEntry, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiProperties=iscsiProperties, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectEntry=projectEntry, haResourceDescription=haResourceDescription, nfsTotalWriteIops=nfsTotalWriteIops, netbiosSocketFailure=netbiosSocketFailure, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, snapshotCreationFailed=snapshotCreationFailed, ipmiFan=ipmiFan, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, snapshotRollbackFailed=snapshotRollbackFailed, shareCIFSWriteIops=shareCIFSWriteIops, notificationTime=notificationTime, poolProjects=poolProjects, upgradeDownloadFailed=upgradeDownloadFailed, maintenanceModeDisabled=maintenanceModeDisabled, aclMigrationStarted=aclMigrationStarted, poolReadCacheReadLatency=poolReadCacheReadLatency, disks=disks, PYSNMP_MODULE_ID=tegile, notificationSeverity=notificationSeverity, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectDataSizeLow=projectDataSizeLow, initiatorGroupMemberAdded=initiatorGroupMemberAdded, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, diskState=diskState, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, tegileGroups=tegileGroups, tegileConformance=tegileConformance, nicTransmitMbps=nicTransmitMbps, poolFreeSizeHigh=poolFreeSizeHigh, poolDataWriteMbps=poolDataWriteMbps, fcTargetName=fcTargetName, diskSizeHigh=diskSizeHigh, ipmiCriticalInterrupt=ipmiCriticalInterrupt, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiTargetAlias=iscsiTargetAlias, ipmiTemperature=ipmiTemperature, shareNFSWriteLatency=shareNFSWriteLatency, haResourceEntry=haResourceEntry, smisServiceStarted=smisServiceStarted, haControllerA_IPAddr=haControllerA_IPAddr, poolDataWriteIops=poolDataWriteIops, shareNFSWriteMbps=shareNFSWriteMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, diskTotalWriteMbps=diskTotalWriteMbps, poolDataReadLatency=poolDataReadLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, haControllerB_Uptime=haControllerB_Uptime, currentNotificationGroup=currentNotificationGroup, nicState=nicState, poolDeletionFailed=poolDeletionFailed, poolReadCacheReadIops=poolReadCacheReadIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, snapshotCloneCompleted=snapshotCloneCompleted, diagnosticDataUploaded=diagnosticDataUploaded, poolMetaReadIops=poolMetaReadIops, diskSequentialIOCount=diskSequentialIOCount, projectTotalSaving=projectTotalSaving, shareCIFSReadIops=shareCIFSReadIops, replicationComplete=replicationComplete, iscsiInitiatorsTable=iscsiInitiatorsTable, webdocsUpgradeCompleted=webdocsUpgradeCompleted, lunDataSizeLow=lunDataSizeLow, projectQuotaFinished=projectQuotaFinished, lunDataSizeHigh=lunDataSizeHigh, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, notificationTargetEntityName=notificationTargetEntityName, poolUpgraded=poolUpgraded, shareCreatedSuccessfully=shareCreatedSuccessfully, tegileArray=tegileArray, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolTable=poolTable, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskError=diskError, shareNFSReadMbps=shareNFSReadMbps, diskTotalReadIops=diskTotalReadIops, webdocsUpgradeFailed=webdocsUpgradeFailed, lunFreeSizeLow=lunFreeSizeLow, volumeDeleteFailed=volumeDeleteFailed, upgradeTimeout=upgradeTimeout, snapshotDeleteFailed=snapshotDeleteFailed, replicationSourceRegistered=replicationSourceRegistered, projectTable=projectTable, poolDataReadIops=poolDataReadIops, sharePoolName=sharePoolName, smisServiceStopFailed=smisServiceStopFailed, iscsiTargetWriteIops=iscsiTargetWriteIops, diskIsOnline=diskIsOnline, poolProjectCount=poolProjectCount, fcTargetWriteMbps=fcTargetWriteMbps, shareCompressedRatio=shareCompressedRatio, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, snmpServiceStartFailed=snmpServiceStartFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, lunIndex=lunIndex, iscsiTargetWriteLatency=iscsiTargetWriteLatency, ipmiVoltage=ipmiVoltage, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcTargetIndex=fcTargetIndex, shareNFSEnabled=shareNFSEnabled, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, nicIndex=nicIndex, fcInitiatorCreateFailed=fcInitiatorCreateFailed, shareDedupEnabled=shareDedupEnabled, lunDedupEnabled=lunDedupEnabled, cacheTotalWriteIops=cacheTotalWriteIops, shareQuotaLow=shareQuotaLow, upgradeFailed=upgradeFailed, tegileArray_notifications=tegileArray_notifications, poolQuotaFinished=poolQuotaFinished, notificationReadingTriggerValue=notificationReadingTriggerValue, targetGroupCreateCompleted=targetGroupCreateCompleted, shareTable=shareTable, lunCompressedRatio=lunCompressedRatio, lunWriteLatency=lunWriteLatency, nfsTotalReadMbps=nfsTotalReadMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, nicName=nicName, shareCIFSEnabled=shareCIFSEnabled, projectDeleted=projectDeleted, poolCount=poolCount, poolSizeHigh=poolSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolExported=poolExported, fcInitiatorName=fcInitiatorName, fcTotalReadIops=fcTotalReadIops, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted)
