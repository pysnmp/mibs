...
# Produced by pysmi-1.1.8 at Sun Jan 16 15:59:08 2022
...
iso, Bits, Integer32, Unsigned32, IpAddress, Gauge32, MibIdentifier, NotificationType, ModuleIdentity, TimeTicks, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Integer32", "Unsigned32", "IpAddress", "Gauge32", "MibIdentifier", "NotificationType", "ModuleIdentity", "TimeTicks", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolAvgWriteLatency=poolAvgWriteLatency, haControllerB_Uptime=haControllerB_Uptime, projectDeleted=projectDeleted, fcTargetIndex=fcTargetIndex, shareCreatedSuccessfully=shareCreatedSuccessfully, basicCompliance=basicCompliance, projectShares=projectShares, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectEntry=projectEntry, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, notifications=notifications, shareCompressedRatio=shareCompressedRatio, lunName=lunName, snapshotRollbackCompleted=snapshotRollbackCompleted, pools=pools, shareProjectName=shareProjectName, poolMetaWriteIops=poolMetaWriteIops, projectName=projectName, lunDataSizeLow=lunDataSizeLow, poolFreeSizeLow=poolFreeSizeLow, networkTotalTransmitMbps=networkTotalTransmitMbps, fcTargetStatus=fcTargetStatus, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolTotalWriteMbps=poolTotalWriteMbps, iscsiWriteIops=iscsiWriteIops, notificationTargetEntityName=notificationTargetEntityName, poolDataReadLatency=poolDataReadLatency, poolEntry=poolEntry, upgradeFailed=upgradeFailed, haControllerA_Name=haControllerA_Name, diskRandomIOCount=diskRandomIOCount, iscsiTargetGroupError=iscsiTargetGroupError, tdpsUpgradeFailed=tdpsUpgradeFailed, cpuSystemCalls=cpuSystemCalls, networkIpmpGroupUp=networkIpmpGroupUp, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskIsOnline=diskIsOnline, poolSizeHigh=poolSizeHigh, poolExported=poolExported, replicationResumed=replicationResumed, lunInitiatorGroup=lunInitiatorGroup, iscsiInitiatorEntry=iscsiInitiatorEntry, cifsTotalReadIops=cifsTotalReadIops, poolDataWriteMbps=poolDataWriteMbps, testNotification=testNotification, shareNFSReadLatency=shareNFSReadLatency, diskIndex=diskIndex, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, diskState=diskState, poolReadCacheReadMbps=poolReadCacheReadMbps, lunReadIops=lunReadIops, shareQuotaFinished=shareQuotaFinished, tegileConformance=tegileConformance, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationSensorAction=notificationSensorAction, haResourceIndex=haResourceIndex, fcTotalReadIops=fcTotalReadIops, haResourcesTable=haResourcesTable, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunSizeHigh=lunSizeHigh, alertsCleanupCompleted=alertsCleanupCompleted, snapshotCloneCompleted=snapshotCloneCompleted, haControllerB_IPAddr=haControllerB_IPAddr, fcInitiatorGroup=fcInitiatorGroup, nvdimmFailInitializationError=nvdimmFailInitializationError, diskSizeHigh=diskSizeHigh, lunProjectName=lunProjectName, currentNotificationGroup=currentNotificationGroup, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, snmpServiceStartFailed=snmpServiceStartFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, notificationTime=notificationTime, poolImported=poolImported, projectLunCount=projectLunCount, lunTable=lunTable, ipmiVoltage=ipmiVoltage, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, nvdimmFailSoftError=nvdimmFailSoftError, poolDataReadMbps=poolDataReadMbps, fcTargetName=fcTargetName, networkInterfaceUp=networkInterfaceUp, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, cacheTotalReadMbps=cacheTotalReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolDegraded=poolDegraded, tdpsUpgradeTimeout=tdpsUpgradeTimeout, nicIndex=nicIndex, iscsiTargetWriteMbps=iscsiTargetWriteMbps, nfsTotalReadIops=nfsTotalReadIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, diskDataReadIops=diskDataReadIops, shareIndex=shareIndex, lunSizeLow=lunSizeLow, cifsTotalWriteMbps=cifsTotalWriteMbps, poolCount=poolCount, iscsiTargetsTable=iscsiTargetsTable, poolTotalSaving=poolTotalSaving, diskTotalWriteIops=diskTotalWriteIops, poolDataWriteIops=poolDataWriteIops, fcTargetReadIops=fcTargetReadIops, iscsiInitiatorName=iscsiInitiatorName, shareCIFSReadIops=shareCIFSReadIops, fcPortOnline=fcPortOnline, iscsiTargetAuth=iscsiTargetAuth, diskChassisIdx=diskChassisIdx, fcTotalWriteIops=fcTotalWriteIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, targetGroupMemberAdded=targetGroupMemberAdded, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolDeleted=poolDeleted, poolMetaWriteLatency=poolMetaWriteLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, spareDiskReplaced=spareDiskReplaced, projectQuotaFinished=projectQuotaFinished, projectDataSizeHigh=projectDataSizeHigh, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, diskAlias=diskAlias, iscsiTargetReadIops=iscsiTargetReadIops, lunTargetGroup=lunTargetGroup, shareReservedSizeHigh=shareReservedSizeHigh, networkInterfaceDown=networkInterfaceDown, projectShareCount=projectShareCount, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, globalStatistics=globalStatistics, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiTargetGroup=iscsiTargetGroup, poolOwnerController=poolOwnerController, poolDataWriteLatency=poolDataWriteLatency, projectPoolName=projectPoolName, shareNFSWriteMbps=shareNFSWriteMbps, fcAvgReadLatency=fcAvgReadLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, haResourceGroup=haResourceGroup, network=network, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiTargets=iscsiTargets, shareTable=shareTable, fcInitiatorEntry=fcInitiatorEntry, diagnosticDataUploaded=diagnosticDataUploaded, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, projectCreatedSuccessfully=projectCreatedSuccessfully, diskDataReadMbps=diskDataReadMbps, nfsTotalReadMbps=nfsTotalReadMbps, nicState=nicState, fcTotalReadMbps=fcTotalReadMbps, haResourceActiveNode=haResourceActiveNode, notificationReadingUnit=notificationReadingUnit, cifsAvgReadLatency=cifsAvgReadLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, maintenanceModeDisabled=maintenanceModeDisabled, iscsiInitiatorGroup=iscsiInitiatorGroup, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiTargetName=iscsiTargetName, notificationSensorSuspect=notificationSensorSuspect, poolMetaReadMbps=poolMetaReadMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, haResources=haResources, tegileArray_notifications=tegileArray_notifications, fcTargetModifyCompleted=fcTargetModifyCompleted, lunFreeSizeLow=lunFreeSizeLow, diskAvgReadLatency=diskAvgReadLatency, poolIndex=poolIndex, lunIndex=lunIndex, lunReadLatency=lunReadLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, cifsTotalWriteIops=cifsTotalWriteIops, projectDeletionFailed=projectDeletionFailed, cacheTotalWriteIops=cacheTotalWriteIops, volumeDeleteFailed=volumeDeleteFailed, maintenanceModeEnabled=maintenanceModeEnabled, memoryFailure=memoryFailure, iscsiInitiatorIndex=iscsiInitiatorIndex, ntpServerTimeDrift=ntpServerTimeDrift, notificationEventCode=notificationEventCode, shareQuotaHigh=shareQuotaHigh, smisServiceStopped=smisServiceStopped, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, volumeQuotaFinished=volumeQuotaFinished, replicationFailed=replicationFailed, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargetEntry=iscsiTargetEntry, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareCIFSReadMbps=shareCIFSReadMbps, shareNFSReadIops=shareNFSReadIops, nicMTU=nicMTU, volumeDeleteCompleted=volumeDeleteCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareDeleted=shareDeleted, controllerTimeDrift=controllerTimeDrift, intelliFlashSoftwareUp=intelliFlashSoftwareUp, notificationDescription=notificationDescription, cacheTotalReadIops=cacheTotalReadIops, poolDataReadIops=poolDataReadIops, ipmiTemperature=ipmiTemperature, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunPoolName=lunPoolName, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolFreeSizeHigh=poolFreeSizeHigh, shareDedupEnabled=shareDedupEnabled, projectSnapshotSizeLow=projectSnapshotSizeLow, lunReservedSizeLow=lunReservedSizeLow, smisServiceStartFailed=smisServiceStartFailed, diskEntry=diskEntry, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, haControllerB_Name=haControllerB_Name, shareDataSizeHigh=shareDataSizeHigh, poolProjects=poolProjects, projectFreeSizeLow=projectFreeSizeLow, projectSnapshotSizeHigh=projectSnapshotSizeHigh, snapshotDeleteFailed=snapshotDeleteFailed, diskError=diskError, nfsAvgReadLatency=nfsAvgReadLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, diskCount=diskCount, fcTotalWriteMbps=fcTotalWriteMbps, shareDeletionFailed=shareDeletionFailed, smbSocketFailure=smbSocketFailure, poolProjectCount=poolProjectCount, controllerUp=controllerUp, diskIOCount=diskIOCount, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolAvgReadLatency=poolAvgReadLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, poolDeletionFailed=poolDeletionFailed, iscsiInitiatorChapUser=iscsiInitiatorChapUser, aclMigrationCompleted=aclMigrationCompleted, nicTable=nicTable, replicationAborted=replicationAborted, diskTotalWriteMbps=diskTotalWriteMbps, lunWriteIops=lunWriteIops, poolUpgraded=poolUpgraded, shareCompressionEnabled=shareCompressionEnabled, aclMigrationStarted=aclMigrationStarted, nvdimmFailDeviceError=nvdimmFailDeviceError, replicationPaused=replicationPaused, projectTable=projectTable, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, nicTransmitMbps=nicTransmitMbps, shareQuotaLow=shareQuotaLow, poolMetaReadIops=poolMetaReadIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolReadCacheWriteLatency=poolReadCacheWriteLatency, snapshotCloningFailed=snapshotCloningFailed, poolMetaWriteMbps=poolMetaWriteMbps)
mibBuilder.exportSymbols("TEGILE-MIB", shareEntry=shareEntry, netbiosSocketFailure=netbiosSocketFailure, currentObjectGroup=currentObjectGroup, shareCIFSWriteLatency=shareCIFSWriteLatency, projectModified=projectModified, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolSizeLow=poolSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, iscsiTotalReadIops=iscsiTotalReadIops, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, smisServiceStarted=smisServiceStarted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareCIFSWriteIops=shareCIFSWriteIops, poolDataSizeHigh=poolDataSizeHigh, poolHealth=poolHealth, upgradeDownloadStarted=upgradeDownloadStarted, networkIpmpGroupDown=networkIpmpGroupDown, iscsiTargetWriteIops=iscsiTargetWriteIops, diskSequentialIOCount=diskSequentialIOCount, shareCIFSWriteMbps=shareCIFSWriteMbps, unknownSensorEvent=unknownSensorEvent, projectCompressionEnabled=projectCompressionEnabled, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectFreeSizeHigh=projectFreeSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, nicReceiveMbps=nicReceiveMbps, fcInitiators=fcInitiators, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, fcAvgWriteLatency=fcAvgWriteLatency, diskDataWriteIops=diskDataWriteIops, fcTargetReadMbps=fcTargetReadMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, fcTargetWriteIops=fcTargetWriteIops, shareNFSWriteIops=shareNFSWriteIops, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, upgradeDownloadCompleted=upgradeDownloadCompleted, lunWriteLatency=lunWriteLatency, cacheTotalWriteMbps=cacheTotalWriteMbps, replicationComplete=replicationComplete, fcTargetsTable=fcTargetsTable, shareSnapshotSizeLow=shareSnapshotSizeLow, lunDedupEnabled=lunDedupEnabled, snapshotRollbackFailed=snapshotRollbackFailed, sharePoolName=sharePoolName, shareCIFSReadLatency=shareCIFSReadLatency, lunBlockSize=lunBlockSize, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcProperties=fcProperties, snmpServiceStopped=snmpServiceStopped, lunReservedSizeHigh=lunReservedSizeHigh, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, disks=disks, fcTargetReadLatency=fcTargetReadLatency, diskTable=diskTable, notificationSensorNumber=notificationSensorNumber, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diskSlowIo=diskSlowIo, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, nfsTotalWriteMbps=nfsTotalWriteMbps, shareNFSEnabled=shareNFSEnabled, controllerDown=controllerDown, haResourceDescription=haResourceDescription, adServerTimeDrift=adServerTimeDrift, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, targetGroupCreateCompleted=targetGroupCreateCompleted, properties=properties, lunProtocol=lunProtocol, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, haResourceStatus=haResourceStatus, nicGroup=nicGroup, poolQuotaFinished=poolQuotaFinished, ipmiCurrent=ipmiCurrent, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolTotalWriteIops=poolTotalWriteIops, fcInitiatorName=fcInitiatorName, tegileArray=tegileArray, controllerHardwareModel=controllerHardwareModel, diskTotalReadIops=diskTotalReadIops, notificationThresholdTriggerValue=notificationThresholdTriggerValue, smisServiceStopFailed=smisServiceStopFailed, volumeModifyCompleted=volumeModifyCompleted, shareMountPoint=shareMountPoint, nicEntry=nicEntry, notificationSeverity=notificationSeverity, fcTargetWriteLatency=fcTargetWriteLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareName=shareName, projectDedupEnabled=projectDedupEnabled, diskDataWriteMbps=diskDataWriteMbps, sensorFailureEvent=sensorFailureEvent, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, haControllerA_Uptime=haControllerA_Uptime, haResourceName=haResourceName, poolDataSizeLow=poolDataSizeLow, iscsiAvgReadLatency=iscsiAvgReadLatency, poolUsedSizeLow=poolUsedSizeLow, shareCIFSEnabled=shareCIFSEnabled, iscsiInitiatorsTable=iscsiInitiatorsTable, lunEntry=lunEntry, lunFreeSizeHigh=lunFreeSizeHigh, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcTargetWriteMbps=fcTargetWriteMbps, shareNFSReadMbps=shareNFSReadMbps, snapshotCreationFailed=snapshotCreationFailed, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, ipmiMemory=ipmiMemory, tegileGroups=tegileGroups, lunCompressedRatio=lunCompressedRatio, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, ipmiOther=ipmiOther, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, webdocsUpgradeCompleted=webdocsUpgradeCompleted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, snmpAgentVersion=snmpAgentVersion, nvdimmFailUnknownError=nvdimmFailUnknownError, upgradeDownloadFailed=upgradeDownloadFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcTargetGroup=fcTargetGroup, ipmiFan=ipmiFan, fcInitiatorsTable=fcInitiatorsTable, cacheRAMReads=cacheRAMReads, diskSizeLow=diskSizeLow, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunDataSizeHigh=lunDataSizeHigh, poolState=poolState, lunGUID=lunGUID, shareReservedSizeLow=shareReservedSizeLow, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, snmpServiceStopFailed=snmpServiceStopFailed, diskGoneOffline=diskGoneOffline, iscsiInitiators=iscsiInitiators, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, lunReadMbps=lunReadMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, sanProperties=sanProperties, projectIndex=projectIndex, poolCreated=poolCreated, replicationTargetDeleted=replicationTargetDeleted, poolReadCacheReadIops=poolReadCacheReadIops, targetGroupMemberRemoved=targetGroupMemberRemoved, PYSNMP_MODULE_ID=tegile, lunCompressionEnabled=lunCompressionEnabled, poolExpanded=poolExpanded, diskTotalReadMbps=diskTotalReadMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, tegileCompliances=tegileCompliances, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiTargetIndex=iscsiTargetIndex, notificationObjects=notificationObjects, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, deleteFolderFailed=deleteFolderFailed, upgradeCompleted=upgradeCompleted, snmpServiceStarted=snmpServiceStarted, projectThresholdExceedWarning=projectThresholdExceedWarning, fcTargets=fcTargets, projectQuotaSizeHigh=projectQuotaSizeHigh, shareDataSizeLow=shareDataSizeLow, nfsTotalWriteIops=nfsTotalWriteIops, notificationProps=notificationProps, projectTotalSaving=projectTotalSaving, iscsiProperties=iscsiProperties, cacheSSDReads=cacheSSDReads, haControllerA_IPAddr=haControllerA_IPAddr, nicName=nicName, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiAvgWriteLatency=iscsiAvgWriteLatency, replicationAbandoned=replicationAbandoned, poolName=poolName, ipmiPowerSupply=ipmiPowerSupply, haResourceEntry=haResourceEntry, tegile=tegile, projectQuotaSizeLow=projectQuotaSizeLow, cpuTotalUsage=cpuTotalUsage, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, notificationComponentName=notificationComponentName, poolTotalReadIops=poolTotalReadIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, intelliFlashSoftwareDown=intelliFlashSoftwareDown, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, projectDataSizeLow=projectDataSizeLow, lunSnapshotSizeLow=lunSnapshotSizeLow, fcPortOffline=fcPortOffline, poolUsedSizeHigh=poolUsedSizeHigh, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiTargetAlias=iscsiTargetAlias, cpuInterrupts=cpuInterrupts, poolTotalReadMbps=poolTotalReadMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, deleteFolderCompleted=deleteFolderCompleted, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiTargetError=iscsiTargetError, diskPoolName=diskPoolName, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, projectLUNs=projectLUNs, lunWriteMbps=lunWriteMbps, diskType=diskType, poolMetaReadLatency=poolMetaReadLatency, fcTargetEntry=fcTargetEntry, ipmiThreshold=ipmiThreshold, upgradeStarted=upgradeStarted, upgradeTimeout=upgradeTimeout, poolTable=poolTable, fcInitiatorIndex=fcInitiatorIndex, userLoginFailed=userLoginFailed, replicationStarted=replicationStarted, replicationSourceRegistered=replicationSourceRegistered)
