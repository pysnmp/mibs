...
Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, NotificationType, Counter64, IpAddress, iso, Gauge32, TimeTicks, Bits, Unsigned32, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "NotificationType", "Counter64", "IpAddress", "iso", "Gauge32", "TimeTicks", "Bits", "Unsigned32", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunWriteLatency=lunWriteLatency, nvdimmFailDeviceError=nvdimmFailDeviceError, nicTransmitMbps=nicTransmitMbps, smbSocketFailure=smbSocketFailure, projectDeletionFailed=projectDeletionFailed, iscsiTargetError=iscsiTargetError, diskGoneOffline=diskGoneOffline, cifsTotalReadMbps=cifsTotalReadMbps, projectTable=projectTable, nvdimmFailSoftError=nvdimmFailSoftError, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, tegileArray_notifications=tegileArray_notifications, shareNFSWriteMbps=shareNFSWriteMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, unknownSensorEvent=unknownSensorEvent, snmpServiceStopped=snmpServiceStopped, deleteFolderFailed=deleteFolderFailed, shareCIFSReadIops=shareCIFSReadIops, shareNFSReadMbps=shareNFSReadMbps, aclMigrationStarted=aclMigrationStarted, ipmiMemory=ipmiMemory, snapshotCloningFailed=snapshotCloningFailed, projectFreeSizeHigh=projectFreeSizeHigh, shareCIFSWriteMbps=shareCIFSWriteMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, poolUsedSizeHigh=poolUsedSizeHigh, haResourceName=haResourceName, poolDataWriteIops=poolDataWriteIops, lunIndex=lunIndex, lunDedupEnabled=lunDedupEnabled, shareQuotaFinished=shareQuotaFinished, shareSnapshotSizeHigh=shareSnapshotSizeHigh, currentNotificationGroup=currentNotificationGroup, controllerUp=controllerUp, snapshotDeleteFailed=snapshotDeleteFailed, fcTargets=fcTargets, lunSizeHigh=lunSizeHigh, poolHealth=poolHealth, lunTable=lunTable, snmpServiceStarted=snmpServiceStarted, ipmiCurrent=ipmiCurrent, poolMetaReadMbps=poolMetaReadMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, nicName=nicName, haControllerB_Name=haControllerB_Name, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareNFSWriteLatency=shareNFSWriteLatency, poolDataSizeHigh=poolDataSizeHigh, notificationComponentName=notificationComponentName, volumeDeleteCompleted=volumeDeleteCompleted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, cifsAvgWriteLatency=cifsAvgWriteLatency, notificationObjects=notificationObjects, poolAvgWriteLatency=poolAvgWriteLatency, cpuSystemCalls=cpuSystemCalls, fcTargetReadIops=fcTargetReadIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, haControllerA_Name=haControllerA_Name, shareEntry=shareEntry, poolTotalWriteMbps=poolTotalWriteMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, upgradeTimeout=upgradeTimeout, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, lunCompressedRatio=lunCompressedRatio, iscsiInitiators=iscsiInitiators, tegileArray=tegileArray, iscsiWriteIops=iscsiWriteIops, notificationSensorSuspect=notificationSensorSuspect, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolDataReadMbps=poolDataReadMbps, shareNFSEnabled=shareNFSEnabled, notificationTime=notificationTime, poolExported=poolExported, upgradeFailed=upgradeFailed, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolEntry=poolEntry, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunBlockSize=lunBlockSize, poolProjects=poolProjects, haResourceDescription=haResourceDescription, notificationDescription=notificationDescription, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, cacheTotalReadMbps=cacheTotalReadMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiInitiatorChapUser=iscsiInitiatorChapUser, fcInitiators=fcInitiators, basicCompliance=basicCompliance, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunCompressionEnabled=lunCompressionEnabled, shareNFSWriteIops=shareNFSWriteIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, cacheRAMReads=cacheRAMReads, haResourceGroup=haResourceGroup, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunSizeLow=lunSizeLow, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcTargetName=fcTargetName, controllerHardwareModel=controllerHardwareModel, network=network, nicEntry=nicEntry, shareQuotaLow=shareQuotaLow, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareDeleted=shareDeleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, vmwareNFSDatastores=vmwareNFSDatastores, lunProjectName=lunProjectName, nicState=nicState, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiTargetAuth=iscsiTargetAuth, replicationTargetDeleted=replicationTargetDeleted, upgradeDownloadFailed=upgradeDownloadFailed, iscsiProperties=iscsiProperties, poolTotalReadIops=poolTotalReadIops, diskTotalReadMbps=diskTotalReadMbps, lunDataSizeHigh=lunDataSizeHigh, notificationSensorAction=notificationSensorAction, fcTargetsTable=fcTargetsTable, projectTotalSaving=projectTotalSaving, fcTargetWriteMbps=fcTargetWriteMbps, cacheTotalWriteIops=cacheTotalWriteIops, shareProjectName=shareProjectName, diskPoolName=diskPoolName, fcTargetGroup=fcTargetGroup, iscsiInitiatorName=iscsiInitiatorName, notifications=notifications, shareCIFSReadLatency=shareCIFSReadLatency, userLoginFailed=userLoginFailed, diskSizeHigh=diskSizeHigh, poolMetaReadIops=poolMetaReadIops, ipmiFan=ipmiFan, smisServiceStopped=smisServiceStopped, projectName=projectName, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, diskEntry=diskEntry, shareReservedSizeHigh=shareReservedSizeHigh, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, poolState=poolState, projectCompressionEnabled=projectCompressionEnabled, netbiosSocketFailure=netbiosSocketFailure, projectEntry=projectEntry, fcInitiatorName=fcInitiatorName, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, haControllerA_Uptime=haControllerA_Uptime, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolMetaWriteIops=poolMetaWriteIops, diskDataReadMbps=diskDataReadMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, diskSizeLow=diskSizeLow, volumeCreatedSuccessfully=volumeCreatedSuccessfully, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcTargetReadLatency=fcTargetReadLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, projectQuotaSizeLow=projectQuotaSizeLow, poolDataWriteLatency=poolDataWriteLatency, poolAvgReadLatency=poolAvgReadLatency, diskTable=diskTable, replicationAborted=replicationAborted, controllerDown=controllerDown, poolFreeSizeHigh=poolFreeSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, replicationResumed=replicationResumed, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskRandomIOCount=diskRandomIOCount, lunSnapshotSizeLow=lunSnapshotSizeLow, fcProperties=fcProperties, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolSizeHigh=poolSizeHigh, shareNFSReadIops=shareNFSReadIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, spareDiskReplaced=spareDiskReplaced, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, fcTotalReadIops=fcTotalReadIops, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, notificationReadingTriggerValue=notificationReadingTriggerValue, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunReadMbps=lunReadMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiTargets=iscsiTargets, poolSizeLow=poolSizeLow, volumeQuotaFinished=volumeQuotaFinished, aclMigrationCompleted=aclMigrationCompleted, notificationTargetEntityName=notificationTargetEntityName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, lunFreeSizeHigh=lunFreeSizeHigh, adServerTimeDrift=adServerTimeDrift, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, properties=properties, smisServiceStartFailed=smisServiceStartFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiTargetIndex=iscsiTargetIndex, diskChassisIdx=diskChassisIdx, nfsTotalReadMbps=nfsTotalReadMbps, lunPoolName=lunPoolName, nvdimmFailInitializationError=nvdimmFailInitializationError, fcTargetWriteLatency=fcTargetWriteLatency, iscsiTotalReadMbps=iscsiTotalReadMbps, poolOwnerController=poolOwnerController, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, cifsAvgReadLatency=cifsAvgReadLatency, tegile=tegile, haControllerB_Uptime=haControllerB_Uptime, networkInterfaceDown=networkInterfaceDown, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareMountPoint=shareMountPoint, cpuInterrupts=cpuInterrupts, iscsiTargetName=iscsiTargetName, cifsTotalWriteMbps=cifsTotalWriteMbps, projectShareCount=projectShareCount, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunReservedSizeLow=lunReservedSizeLow, poolDataReadLatency=poolDataReadLatency, lunProtocol=lunProtocol, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, sensorFailureEvent=sensorFailureEvent, poolMetaWriteMbps=poolMetaWriteMbps, shareCompressedRatio=shareCompressedRatio, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunInitiatorGroup=lunInitiatorGroup, fcTotalWriteMbps=fcTotalWriteMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareIndex=shareIndex, poolProjectCount=poolProjectCount, iscsiTargetReadIops=iscsiTargetReadIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, upgradeStarted=upgradeStarted, poolMetaWriteLatency=poolMetaWriteLatency, targetGroupMemberAdded=targetGroupMemberAdded, haResources=haResources, maintenanceModeEnabled=maintenanceModeEnabled, diskIndex=diskIndex, iscsiTargetAlias=iscsiTargetAlias, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunDataSizeLow=lunDataSizeLow, cifsTotalReadIops=cifsTotalReadIops, nfsTotalReadIops=nfsTotalReadIops, networkIpmpGroupUp=networkIpmpGroupUp, nicTable=nicTable, nicMTU=nicMTU, snmpServiceStartFailed=snmpServiceStartFailed, poolTable=poolTable, notificationReadingUnit=notificationReadingUnit, projectDedupEnabled=projectDedupEnabled, snmpServiceStopFailed=snmpServiceStopFailed, diskTotalWriteMbps=diskTotalWriteMbps, networkTotalTransmitMbps=networkTotalTransmitMbps)
mibBuilder.exportSymbols("TEGILE-MIB", diskSequentialIOCount=diskSequentialIOCount, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunReadLatency=lunReadLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolDegraded=poolDegraded, lunFreeSizeLow=lunFreeSizeLow, diskDataWriteIops=diskDataWriteIops, haResourceIndex=haResourceIndex, ipmiTemperature=ipmiTemperature, haResourceActiveNode=haResourceActiveNode, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiAvgReadLatency=iscsiAvgReadLatency, projectPoolName=projectPoolName, lunWriteMbps=lunWriteMbps, diskIsOnline=diskIsOnline, replicationPaused=replicationPaused, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, fcTargetIndex=fcTargetIndex, nfsTotalWriteIops=nfsTotalWriteIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectThresholdExceedWarning=projectThresholdExceedWarning, replicationStarted=replicationStarted, poolDataReadIops=poolDataReadIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiTargetWriteIops=iscsiTargetWriteIops, diskIOCount=diskIOCount, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareSnapshotSizeLow=shareSnapshotSizeLow, notificationSeverity=notificationSeverity, poolDeletionFailed=poolDeletionFailed, upgradeDownloadStarted=upgradeDownloadStarted, shareDedupEnabled=shareDedupEnabled, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectIndex=projectIndex, cacheTotalWriteMbps=cacheTotalWriteMbps, cacheSSDReads=cacheSSDReads, fcTargetReadMbps=fcTargetReadMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry, poolFreeSizeLow=poolFreeSizeLow, PYSNMP_MODULE_ID=tegile, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, upgradeDownloadCompleted=upgradeDownloadCompleted, volumeModifyCompleted=volumeModifyCompleted, alertsCleanupCompleted=alertsCleanupCompleted, diskCount=diskCount, maintenanceModeDisabled=maintenanceModeDisabled, poolName=poolName, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, ipmiVoltage=ipmiVoltage, nicGroup=nicGroup, testNotification=testNotification, haResourceEntry=haResourceEntry, fcInitiatorIndex=fcInitiatorIndex, iscsiTargetGroupError=iscsiTargetGroupError, shareTable=shareTable, shareQuotaHigh=shareQuotaHigh, poolCreated=poolCreated, lunSnapshotSizeHigh=lunSnapshotSizeHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunReadIops=lunReadIops, shareCIFSReadMbps=shareCIFSReadMbps, tegileConformance=tegileConformance, haResourcesTable=haResourcesTable, sanProperties=sanProperties, lunName=lunName, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcTargetWriteIops=fcTargetWriteIops, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolDataSizeLow=poolDataSizeLow, iscsiTargetWriteLatency=iscsiTargetWriteLatency, shareDeletionFailed=shareDeletionFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, replicationSourceRegistered=replicationSourceRegistered, fcTargetEntry=fcTargetEntry, controllerTimeDrift=controllerTimeDrift, poolQuotaFinished=poolQuotaFinished, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, fcAvgReadLatency=fcAvgReadLatency, cpuTotalUsage=cpuTotalUsage, projectFreeSizeLow=projectFreeSizeLow, nfsAvgReadLatency=nfsAvgReadLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, fcAvgWriteLatency=fcAvgWriteLatency, targetGroupMemberRemoved=targetGroupMemberRemoved, diskSlowIo=diskSlowIo, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolReadCacheWriteIops=poolReadCacheWriteIops, deleteFolderCompleted=deleteFolderCompleted, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, nicIndex=nicIndex, nicReceiveMbps=nicReceiveMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, projectDataSizeLow=projectDataSizeLow, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, currentObjectGroup=currentObjectGroup, shareReservedSizeLow=shareReservedSizeLow, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, networkIpmpGroupDown=networkIpmpGroupDown, fcInitiatorGroup=fcInitiatorGroup, poolIndex=poolIndex, poolUpgraded=poolUpgraded, projectLUNs=projectLUNs, shareDataSizeHigh=shareDataSizeHigh, cifsTotalWriteIops=cifsTotalWriteIops, diskAvgReadLatency=diskAvgReadLatency, replicationAbandoned=replicationAbandoned, shareCompressionEnabled=shareCompressionEnabled, iscsiInitiatorIndex=iscsiInitiatorIndex, snmpAgentVersion=snmpAgentVersion, diskDataReadIops=diskDataReadIops, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, ntpServerTimeDrift=ntpServerTimeDrift, fcTotalReadMbps=fcTotalReadMbps, lunReservedSizeHigh=lunReservedSizeHigh, targetGroupCreateCompleted=targetGroupCreateCompleted, smisServiceStarted=smisServiceStarted, lunGUID=lunGUID, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, diskType=diskType, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolDataWriteMbps=poolDataWriteMbps, poolUsedSizeLow=poolUsedSizeLow, memoryFailure=memoryFailure, replicationComplete=replicationComplete, smisServiceStopFailed=smisServiceStopFailed, tegileCompliances=tegileCompliances, ipmiOther=ipmiOther, shareDataSizeLow=shareDataSizeLow, tegileGroups=tegileGroups, notificationEventCode=notificationEventCode, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, ipmiThreshold=ipmiThreshold, diskAvgWriteLatency=diskAvgWriteLatency, nvdimmFailUnknownError=nvdimmFailUnknownError, poolImported=poolImported, fcPortOffline=fcPortOffline, lunWriteIops=lunWriteIops, upgradeCompleted=upgradeCompleted, poolDeleted=poolDeleted, disks=disks, diskDataWriteMbps=diskDataWriteMbps, poolWriteCacheWriteIops=poolWriteCacheWriteIops, pools=pools, projectQuotaFinished=projectQuotaFinished, fcPortOnline=fcPortOnline, projectLunCount=projectLunCount, snapshotCreationFailed=snapshotCreationFailed, ipmiPowerSupply=ipmiPowerSupply, snapshotCloneCompleted=snapshotCloneCompleted, diskAlias=diskAlias, fcTargetStatus=fcTargetStatus, diskTotalReadIops=diskTotalReadIops, iscsiTotalReadIops=iscsiTotalReadIops, networkInterfaceUp=networkInterfaceUp, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiTargetReadMbps=iscsiTargetReadMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiTargetEntry=iscsiTargetEntry, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunEntry=lunEntry, iscsiTargetsTable=iscsiTargetsTable, sharePoolName=sharePoolName, haControllerA_IPAddr=haControllerA_IPAddr, replicationFailed=replicationFailed, notificationProps=notificationProps, diskError=diskError, poolExpanded=poolExpanded, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiTargetReadLatency=iscsiTargetReadLatency, globalStatistics=globalStatistics, projectDataSizeHigh=projectDataSizeHigh, projectQuotaSizeHigh=projectQuotaSizeHigh, projectModified=projectModified, fcTotalWriteIops=fcTotalWriteIops, poolReadCacheReadLatency=poolReadCacheReadLatency, shareCIFSWriteIops=shareCIFSWriteIops, poolReadCacheReadIops=poolReadCacheReadIops, poolCount=poolCount, diskState=diskState, haControllerB_IPAddr=haControllerB_IPAddr, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, lunTargetGroup=lunTargetGroup, notificationSensorNumber=notificationSensorNumber, volumeDeleteFailed=volumeDeleteFailed, cacheTotalReadIops=cacheTotalReadIops, fcInitiatorEntry=fcInitiatorEntry, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareCIFSEnabled=shareCIFSEnabled, fcInitiatorsTable=fcInitiatorsTable, iscsiInitiatorGroup=iscsiInitiatorGroup, haResourceStatus=haResourceStatus, poolMetaReadLatency=poolMetaReadLatency, projectShares=projectShares, projectDeleted=projectDeleted, shareNFSReadLatency=shareNFSReadLatency, snapshotRollbackFailed=snapshotRollbackFailed, shareName=shareName, poolTotalReadMbps=poolTotalReadMbps, diskTotalWriteIops=diskTotalWriteIops, poolTotalWriteIops=poolTotalWriteIops, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiTargetGroup=iscsiTargetGroup, diagnosticDataUploaded=diagnosticDataUploaded)
