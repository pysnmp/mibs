...
# Produced by pysmi-1.1.8 at Fri Jan 13 12:14:42 2023
...
TimeTicks, NotificationType, Bits, Counter64, ModuleIdentity, Counter32, Integer32, MibIdentifier, ObjectIdentity, Unsigned32, IpAddress, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Bits", "Counter64", "ModuleIdentity", "Counter32", "Integer32", "MibIdentifier", "ObjectIdentity", "Unsigned32", "IpAddress", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolReadCacheWriteIops=poolReadCacheWriteIops, ipmiCurrent=ipmiCurrent, projectLUNs=projectLUNs, iscsiTargetsTable=iscsiTargetsTable, shareReservedSizeHigh=shareReservedSizeHigh, poolQuotaFinished=poolQuotaFinished, nfsTotalWriteMbps=nfsTotalWriteMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, replicationFailed=replicationFailed, memoryFailure=memoryFailure, ipmiFan=ipmiFan, diskAvgWriteLatency=diskAvgWriteLatency, iscsiTotalReadIops=iscsiTotalReadIops, fcProperties=fcProperties, lunWriteLatency=lunWriteLatency, poolDeleted=poolDeleted, sharePoolName=sharePoolName, diskAlias=diskAlias, cacheTotalReadIops=cacheTotalReadIops, poolReadCacheWriteLatency=poolReadCacheWriteLatency, replicationComplete=replicationComplete, lunDataSizeHigh=lunDataSizeHigh, lunPoolName=lunPoolName, poolReadCacheReadLatency=poolReadCacheReadLatency, notificationObjects=notificationObjects, haControllerA_Uptime=haControllerA_Uptime, fcTargetEntry=fcTargetEntry, haControllerB_IPAddr=haControllerB_IPAddr, notificationTime=notificationTime, poolSizeHigh=poolSizeHigh, poolTotalReadMbps=poolTotalReadMbps, shareNFSReadMbps=shareNFSReadMbps, controllerTimeDrift=controllerTimeDrift, snmpServiceStartFailed=snmpServiceStartFailed, shareReservedSizeLow=shareReservedSizeLow, diskSizeHigh=diskSizeHigh, PYSNMP_MODULE_ID=tegile, lunProtocol=lunProtocol, haControllerB_Uptime=haControllerB_Uptime, iscsiTargetGroupError=iscsiTargetGroupError, notificationProps=notificationProps, poolDataWriteIops=poolDataWriteIops, cifsTotalWriteIops=cifsTotalWriteIops, targetGroupMemberRemoved=targetGroupMemberRemoved, controllerUp=controllerUp, iscsiInitiatorEntry=iscsiInitiatorEntry, shareNFSEnabled=shareNFSEnabled, projectShareCount=projectShareCount, replicationStarted=replicationStarted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolExported=poolExported, poolCount=poolCount, fcTargetWriteLatency=fcTargetWriteLatency, replicationSourceRegistered=replicationSourceRegistered, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, lunReservedSizeHigh=lunReservedSizeHigh, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectQuotaFinished=projectQuotaFinished, iscsiTargetReadMbps=iscsiTargetReadMbps, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareNFSWriteMbps=shareNFSWriteMbps, poolProjectCount=poolProjectCount, poolDataWriteLatency=poolDataWriteLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, fcInitiatorGroup=fcInitiatorGroup, shareMountPoint=shareMountPoint, diskDataWriteIops=diskDataWriteIops, nvdimmFailInitializationError=nvdimmFailInitializationError, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiInitiators=iscsiInitiators, iscsiWriteIops=iscsiWriteIops, shareName=shareName, poolReadCacheReadMbps=poolReadCacheReadMbps, tegileCompliances=tegileCompliances, tegile=tegile, projectDeletionFailed=projectDeletionFailed, projectLunCount=projectLunCount, diskIndex=diskIndex, deleteFolderCompleted=deleteFolderCompleted, lunIndex=lunIndex, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcTargetWriteMbps=fcTargetWriteMbps, volumeQuotaFinished=volumeQuotaFinished, poolMetaReadIops=poolMetaReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cifsAvgReadLatency=cifsAvgReadLatency, notificationDescription=notificationDescription, diskType=diskType, nfsTotalReadIops=nfsTotalReadIops, iscsiInitiatorIndex=iscsiInitiatorIndex, snapshotCreationFailed=snapshotCreationFailed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcTargetsTable=fcTargetsTable, fcAvgReadLatency=fcAvgReadLatency, nicTable=nicTable, shareQuotaHigh=shareQuotaHigh, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nicTransmitMbps=nicTransmitMbps, cacheTotalReadMbps=cacheTotalReadMbps, netbiosSocketFailure=netbiosSocketFailure, lunWriteIops=lunWriteIops, nicName=nicName, tegileConformance=tegileConformance, nicIndex=nicIndex, iscsiTargetError=iscsiTargetError, upgradeFailed=upgradeFailed, shareDataSizeLow=shareDataSizeLow, shareDeletionFailed=shareDeletionFailed, networkInterfaceUp=networkInterfaceUp, lunReadMbps=lunReadMbps, shareDeleted=shareDeleted, upgradeTimeout=upgradeTimeout, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, cpuSystemCalls=cpuSystemCalls, nicGroup=nicGroup, nvdimmFailUnknownError=nvdimmFailUnknownError, replicationAbandoned=replicationAbandoned, fcTargetModifyCompleted=fcTargetModifyCompleted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTargetAuth=iscsiTargetAuth, snmpAgentVersion=snmpAgentVersion, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolState=poolState, diskSequentialIOCount=diskSequentialIOCount, lunTable=lunTable, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, iscsiTargetName=iscsiTargetName, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, upgradeDownloadStarted=upgradeDownloadStarted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, nicMTU=nicMTU, lunDataSizeLow=lunDataSizeLow, iscsiTotalReadMbps=iscsiTotalReadMbps, shareNFSReadLatency=shareNFSReadLatency, cpuTotalUsage=cpuTotalUsage, haResourceName=haResourceName, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, sensorFailureEvent=sensorFailureEvent, intelliFlashSoftwareDown=intelliFlashSoftwareDown, testNotification=testNotification, upgradeCompleted=upgradeCompleted, projectFreeSizeLow=projectFreeSizeLow, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiTargetIndex=iscsiTargetIndex, tdpsUpgradeTimeout=tdpsUpgradeTimeout, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, haResourceEntry=haResourceEntry, iscsiTargetGroup=iscsiTargetGroup, haResourceGroup=haResourceGroup, targetGroupCreateCompleted=targetGroupCreateCompleted, poolTotalWriteIops=poolTotalWriteIops, haResources=haResources, poolDegraded=poolDegraded, replicationPaused=replicationPaused, fcTargetWriteIops=fcTargetWriteIops, nicReceiveMbps=nicReceiveMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, haControllerA_Name=haControllerA_Name, lunReservedSizeLow=lunReservedSizeLow, lunReadIops=lunReadIops, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, haResourceIndex=haResourceIndex, shareCIFSWriteIops=shareCIFSWriteIops, iscsiTargetReadLatency=iscsiTargetReadLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, projectCompressionEnabled=projectCompressionEnabled, maintenanceModeEnabled=maintenanceModeEnabled, poolFreeSizeHigh=poolFreeSizeHigh, poolTable=poolTable, notifications=notifications, globalStatistics=globalStatistics, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareCIFSReadIops=shareCIFSReadIops, cacheRAMReads=cacheRAMReads, poolExpanded=poolExpanded, projectDeleted=projectDeleted, fcInitiators=fcInitiators, diskSizeLow=diskSizeLow, fcTargetReadMbps=fcTargetReadMbps, projectPoolName=projectPoolName, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, diskDataReadMbps=diskDataReadMbps, lunBlockSize=lunBlockSize, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, fcTargets=fcTargets, ntpServerTimeDrift=ntpServerTimeDrift, cacheTotalWriteIops=cacheTotalWriteIops, nfsTotalReadMbps=nfsTotalReadMbps, projectDataSizeHigh=projectDataSizeHigh, fcTotalWriteMbps=fcTotalWriteMbps, lunProjectName=lunProjectName, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, shareIndex=shareIndex, vmwareNFSDatastores=vmwareNFSDatastores, projectIndex=projectIndex, fcPortOffline=fcPortOffline, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, nfsAvgWriteLatency=nfsAvgWriteLatency, poolCreated=poolCreated, aclMigrationStarted=aclMigrationStarted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, projectQuotaSizeLow=projectQuotaSizeLow, lunGUID=lunGUID, fcInitiatorIndex=fcInitiatorIndex, basicCompliance=basicCompliance, replicationResumed=replicationResumed, poolDataReadIops=poolDataReadIops, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareTable=shareTable, poolProjects=poolProjects, smisServiceStopFailed=smisServiceStopFailed, diskState=diskState, lunSnapshotSizeLow=lunSnapshotSizeLow, shareDedupEnabled=shareDedupEnabled, volumeDeleteCompleted=volumeDeleteCompleted, lunWriteMbps=lunWriteMbps, ipmiTemperature=ipmiTemperature, poolTotalSaving=poolTotalSaving, snapshotDeleteFailed=snapshotDeleteFailed, poolAvgWriteLatency=poolAvgWriteLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolReadCacheReadIops=poolReadCacheReadIops, projectFreeSizeHigh=projectFreeSizeHigh, shareCompressedRatio=shareCompressedRatio, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolSizeLow=poolSizeLow, shareCIFSReadMbps=shareCIFSReadMbps, poolUsedSizeLow=poolUsedSizeLow, notificationSensorNumber=notificationSensorNumber, poolTotalReadIops=poolTotalReadIops, poolHealth=poolHealth, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, adServerTimeDrift=adServerTimeDrift, lunDedupEnabled=lunDedupEnabled, diskGoneOffline=diskGoneOffline, controllerHardwareModel=controllerHardwareModel, projectQuotaSizeHigh=projectQuotaSizeHigh, deleteFolderFailed=deleteFolderFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareCompressionEnabled=shareCompressionEnabled, poolMetaWriteIops=poolMetaWriteIops, notificationReadingUnit=notificationReadingUnit)
mibBuilder.exportSymbols("TEGILE-MIB", lunCompressedRatio=lunCompressedRatio, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, notificationReadingTriggerValue=notificationReadingTriggerValue, poolTotalWriteMbps=poolTotalWriteMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcTotalReadIops=fcTotalReadIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcPortOnline=fcPortOnline, iscsiInitiatorGroup=iscsiInitiatorGroup, network=network, smbSocketFailure=smbSocketFailure, poolDataWriteMbps=poolDataWriteMbps, poolDataSizeLow=poolDataSizeLow, diskDataWriteMbps=diskDataWriteMbps, snmpServiceStopped=snmpServiceStopped, shareExceedThresholdWarning=shareExceedThresholdWarning, diskTable=diskTable, networkIpmpGroupUp=networkIpmpGroupUp, pools=pools, replicationAborted=replicationAborted, shareCIFSWriteMbps=shareCIFSWriteMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, cifsTotalReadMbps=cifsTotalReadMbps, tegileArray=tegileArray, projectTotalSaving=projectTotalSaving, networkInterfaceDown=networkInterfaceDown, diskAvgReadLatency=diskAvgReadLatency, iscsiProperties=iscsiProperties, nicState=nicState, poolDataReadLatency=poolDataReadLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, upgradeStarted=upgradeStarted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareEntry=shareEntry, diskDataReadIops=diskDataReadIops, shareCreatedSuccessfully=shareCreatedSuccessfully, fcTotalWriteIops=fcTotalWriteIops, shareDataSizeHigh=shareDataSizeHigh, cacheTotalWriteMbps=cacheTotalWriteMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, shareNFSWriteLatency=shareNFSWriteLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, ipmiMemory=ipmiMemory, projectName=projectName, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcTargetName=fcTargetName, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, lunCompressionEnabled=lunCompressionEnabled, iscsiTargetWriteMbps=iscsiTargetWriteMbps, nfsTotalWriteIops=nfsTotalWriteIops, poolName=poolName, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareCIFSWriteLatency=shareCIFSWriteLatency, smisServiceStarted=smisServiceStarted, alertsCleanupCompleted=alertsCleanupCompleted, fcTargetReadIops=fcTargetReadIops, poolOwnerController=poolOwnerController, iscsiTargetAlias=iscsiTargetAlias, projectSnapshotSizeHigh=projectSnapshotSizeHigh, nfsAvgReadLatency=nfsAvgReadLatency, poolImported=poolImported, poolUsedSizeHigh=poolUsedSizeHigh, poolAvgReadLatency=poolAvgReadLatency, properties=properties, fcTargetIndex=fcTargetIndex, iscsiTargetReadIops=iscsiTargetReadIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, snapshotCloningFailed=snapshotCloningFailed, notificationEventCode=notificationEventCode, spareDiskReplaced=spareDiskReplaced, webdocsUpgradeCompleted=webdocsUpgradeCompleted, nicEntry=nicEntry, replicationTargetDeleted=replicationTargetDeleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcInitiatorEntry=fcInitiatorEntry, projectCreatedSuccessfully=projectCreatedSuccessfully, fcTotalReadMbps=fcTotalReadMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, projectModified=projectModified, ipmiPowerSupply=ipmiPowerSupply, tdpsUpgradeFailed=tdpsUpgradeFailed, diskSlowIo=diskSlowIo, volumeModifyCompleted=volumeModifyCompleted, nvdimmFailSoftError=nvdimmFailSoftError, poolMetaReadLatency=poolMetaReadLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, haControllerA_IPAddr=haControllerA_IPAddr, smisServiceStartFailed=smisServiceStartFailed, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiInitiatorChapUser=iscsiInitiatorChapUser, maintenanceModeDisabled=maintenanceModeDisabled, userLoginFailed=userLoginFailed, projectDataSizeLow=projectDataSizeLow, iscsiAvgReadLatency=iscsiAvgReadLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, currentObjectGroup=currentObjectGroup, lunReadLatency=lunReadLatency, lunFreeSizeLow=lunFreeSizeLow, snapshotRollbackFailed=snapshotRollbackFailed, poolEntry=poolEntry, poolMetaWriteMbps=poolMetaWriteMbps, notificationSensorSuspect=notificationSensorSuspect, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolUpgraded=poolUpgraded, diskIsOnline=diskIsOnline, poolMetaWriteLatency=poolMetaWriteLatency, shareQuotaLow=shareQuotaLow, poolDeletionFailed=poolDeletionFailed, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, controllerDown=controllerDown, lunSnapshotSizeHigh=lunSnapshotSizeHigh, snmpServiceStarted=snmpServiceStarted, disks=disks, targetGroupMemberAdded=targetGroupMemberAdded, diskTotalWriteIops=diskTotalWriteIops, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcAvgWriteLatency=fcAvgWriteLatency, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskIOCount=diskIOCount, poolMetaReadMbps=poolMetaReadMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiInitiatorName=iscsiInitiatorName, shareNFSReadIops=shareNFSReadIops, notificationTargetEntityName=notificationTargetEntityName, projectShares=projectShares, projectTable=projectTable, diagnosticDataUploaded=diagnosticDataUploaded, ipmiOther=ipmiOther, shareQuotaFinished=shareQuotaFinished, cacheSSDReads=cacheSSDReads, diskCount=diskCount, notificationSensorAction=notificationSensorAction, lunFreeSizeHigh=lunFreeSizeHigh, networkIpmpGroupDown=networkIpmpGroupDown, poolWriteCacheWriteIops=poolWriteCacheWriteIops, tegileArray_notifications=tegileArray_notifications, ipmiVoltage=ipmiVoltage, iscsiTargets=iscsiTargets, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, volumeDeleteFailed=volumeDeleteFailed, smisServiceStopped=smisServiceStopped, lunSizeLow=lunSizeLow, sanProperties=sanProperties, lunInitiatorGroup=lunInitiatorGroup, networkTotalReceiveMbps=networkTotalReceiveMbps, fcTargetReadLatency=fcTargetReadLatency, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunEntry=lunEntry, shareCIFSEnabled=shareCIFSEnabled, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, currentNotificationGroup=currentNotificationGroup, haResourceStatus=haResourceStatus, lunSizeHigh=lunSizeHigh, diskChassisIdx=diskChassisIdx, iscsiTargetWriteIops=iscsiTargetWriteIops, fcInitiatorName=fcInitiatorName, cpuInterrupts=cpuInterrupts, diskTotalWriteMbps=diskTotalWriteMbps, shareProjectName=shareProjectName, snapshotCloneCompleted=snapshotCloneCompleted, diskEntry=diskEntry, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolDataSizeHigh=poolDataSizeHigh, diskTotalReadMbps=diskTotalReadMbps, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiTargetEntry=iscsiTargetEntry, projectSnapshotSizeLow=projectSnapshotSizeLow, shareNFSWriteIops=shareNFSWriteIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, diskError=diskError, unknownSensorEvent=unknownSensorEvent, notificationComponentName=notificationComponentName, poolFreeSizeLow=poolFreeSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, tegileGroups=tegileGroups, haResourcesTable=haResourcesTable, fcInitiatorsTable=fcInitiatorsTable, fcTargetStatus=fcTargetStatus, snmpServiceStopFailed=snmpServiceStopFailed, ipmiThreshold=ipmiThreshold, shareSnapshotSizeLow=shareSnapshotSizeLow, haControllerB_Name=haControllerB_Name, poolIndex=poolIndex, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectEntry=projectEntry, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, haResourceActiveNode=haResourceActiveNode, lunTargetGroup=lunTargetGroup, projectDedupEnabled=projectDedupEnabled, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunName=lunName, haResourceDescription=haResourceDescription, diskPoolName=diskPoolName, poolDataReadMbps=poolDataReadMbps, diskTotalReadIops=diskTotalReadIops, notificationSeverity=notificationSeverity, cifsTotalReadIops=cifsTotalReadIops, aclMigrationCompleted=aclMigrationCompleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh)
