...
IpAddress, Bits, TimeTicks, enterprises, Counter32, iso, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, NotificationType, Gauge32, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "TimeTicks", "enterprises", "Counter32", "iso", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "NotificationType", "Gauge32", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareCompressedRatio=shareCompressedRatio, poolExpanded=poolExpanded, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, tegileCompliances=tegileCompliances, poolMetaWriteMbps=poolMetaWriteMbps, cifsAvgReadLatency=cifsAvgReadLatency, projectDataSizeHigh=projectDataSizeHigh, nvdimmFailInitializationError=nvdimmFailInitializationError, haControllerA_Uptime=haControllerA_Uptime, cifsTotalWriteMbps=cifsTotalWriteMbps, diskIndex=diskIndex, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, cacheTotalWriteIops=cacheTotalWriteIops, projectShareCount=projectShareCount, fcTotalWriteIops=fcTotalWriteIops, nicEntry=nicEntry, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, fcTargetReadLatency=fcTargetReadLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolProjects=poolProjects, haControllerA_IPAddr=haControllerA_IPAddr, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, smbSocketFailure=smbSocketFailure, aclMigrationCompleted=aclMigrationCompleted, snapshotCreationFailed=snapshotCreationFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolSizeHigh=poolSizeHigh, iscsiTargetReadMbps=iscsiTargetReadMbps, haResourceName=haResourceName, iscsiTargetGroup=iscsiTargetGroup, poolTable=poolTable, currentNotificationGroup=currentNotificationGroup, smisServiceStopFailed=smisServiceStopFailed, iscsiTargetIndex=iscsiTargetIndex, projectName=projectName, poolName=poolName, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiTotalReadIops=iscsiTotalReadIops, lunWriteMbps=lunWriteMbps, shareIndex=shareIndex, webdocsUpgradeFailed=webdocsUpgradeFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, replicationFailed=replicationFailed, poolDataWriteLatency=poolDataWriteLatency, fcInitiatorsTable=fcInitiatorsTable, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, nicReceiveMbps=nicReceiveMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, fcAvgReadLatency=fcAvgReadLatency, projectQuotaFinished=projectQuotaFinished, diskCount=diskCount, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, fcTargetModifyCompleted=fcTargetModifyCompleted, fcPortOnline=fcPortOnline, shareNFSReadLatency=shareNFSReadLatency, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunBlockSize=lunBlockSize, ipmiOther=ipmiOther, maintenanceModeEnabled=maintenanceModeEnabled, iscsiTargetsTable=iscsiTargetsTable, poolDataReadLatency=poolDataReadLatency, lunReadIops=lunReadIops, shareCIFSWriteMbps=shareCIFSWriteMbps, diskIOCount=diskIOCount, diskGoneOffline=diskGoneOffline, nfsTotalWriteMbps=nfsTotalWriteMbps, poolTotalWriteMbps=poolTotalWriteMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolReadCacheWriteIops=poolReadCacheWriteIops, shareNFSReadMbps=shareNFSReadMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareDedupEnabled=shareDedupEnabled, projectFreeSizeHigh=projectFreeSizeHigh, shareDeleted=shareDeleted, projectTotalSaving=projectTotalSaving, networkTotalReceiveMbps=networkTotalReceiveMbps, poolOwnerController=poolOwnerController, ipmiCurrent=ipmiCurrent, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, smisServiceStarted=smisServiceStarted, smisServiceStopped=smisServiceStopped, pools=pools, poolDataReadIops=poolDataReadIops, nfsTotalReadMbps=nfsTotalReadMbps, controllerHardwareModel=controllerHardwareModel, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolReadCacheReadLatency=poolReadCacheReadLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, upgradeDownloadFailed=upgradeDownloadFailed, fcTargetWriteIops=fcTargetWriteIops, nfsAvgReadLatency=nfsAvgReadLatency, projectPoolName=projectPoolName, notificationTime=notificationTime, shareNFSWriteIops=shareNFSWriteIops, lunWriteLatency=lunWriteLatency, snapshotRollbackFailed=snapshotRollbackFailed, lunPoolName=lunPoolName, poolCreated=poolCreated, upgradeFailed=upgradeFailed, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, networkInterfaceUp=networkInterfaceUp, iscsiTargets=iscsiTargets, diskDataReadMbps=diskDataReadMbps, haControllerA_Name=haControllerA_Name, controllerDown=controllerDown, cifsTotalWriteIops=cifsTotalWriteIops, iscsiTargetGroupError=iscsiTargetGroupError, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolCount=poolCount, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, controllerTimeDrift=controllerTimeDrift, targetGroupMemberRemoved=targetGroupMemberRemoved, basicCompliance=basicCompliance, ipmiCriticalInterrupt=ipmiCriticalInterrupt, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, volumeDeleteFailed=volumeDeleteFailed, fcTotalReadIops=fcTotalReadIops, shareCIFSEnabled=shareCIFSEnabled, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectDeletionFailed=projectDeletionFailed, notificationSensorAction=notificationSensorAction, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, ipmiPowerSupply=ipmiPowerSupply, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareName=shareName, intelliFlashSoftwareUp=intelliFlashSoftwareUp, tdpsUpgradeCompleted=tdpsUpgradeCompleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, targetGroupCreateCompleted=targetGroupCreateCompleted, diskSlowIo=diskSlowIo, lunSizeHigh=lunSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, lunWriteIops=lunWriteIops, shareCIFSReadMbps=shareCIFSReadMbps, deleteFolderFailed=deleteFolderFailed, notificationTargetEntityName=notificationTargetEntityName, poolEntry=poolEntry, diskDataWriteMbps=diskDataWriteMbps, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, snmpAgentVersion=snmpAgentVersion, cifsTotalReadIops=cifsTotalReadIops, poolAvgWriteLatency=poolAvgWriteLatency, iscsiProperties=iscsiProperties, poolTotalReadIops=poolTotalReadIops, lunCompressedRatio=lunCompressedRatio, upgradeDownloadCompleted=upgradeDownloadCompleted, sensorFailureEvent=sensorFailureEvent, diskError=diskError, networkTotalTransmitMbps=networkTotalTransmitMbps, shareNFSWriteLatency=shareNFSWriteLatency, snapshotCloningFailed=snapshotCloningFailed, fcTargetsTable=fcTargetsTable, fcInitiatorName=fcInitiatorName, fcTargetGroup=fcTargetGroup, spareDiskReplaced=spareDiskReplaced, shareCreatedSuccessfully=shareCreatedSuccessfully, shareExceedThresholdWarning=shareExceedThresholdWarning, snapshotDeleteFailed=snapshotDeleteFailed, projectTable=projectTable, diskPoolName=diskPoolName, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, snmpServiceStarted=snmpServiceStarted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diskDataWriteIops=diskDataWriteIops, nfsTotalReadIops=nfsTotalReadIops, tegileGroups=tegileGroups, shareTable=shareTable, haControllerB_IPAddr=haControllerB_IPAddr, lunReadMbps=lunReadMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, sanProperties=sanProperties, lunFreeSizeHigh=lunFreeSizeHigh, upgradeDownloadStarted=upgradeDownloadStarted, diagnosticDataUploaded=diagnosticDataUploaded, snapshotCloneCompleted=snapshotCloneCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, deleteFolderCompleted=deleteFolderCompleted, fcPortOffline=fcPortOffline, replicationAborted=replicationAborted, vmwareNFSDatastores=vmwareNFSDatastores, iscsiAvgReadLatency=iscsiAvgReadLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, notificationObjects=notificationObjects, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, networkIpmpGroupDown=networkIpmpGroupDown, shareNFSReadIops=shareNFSReadIops, diskEntry=diskEntry, iscsiTargetAuth=iscsiTargetAuth, fcTargetReadMbps=fcTargetReadMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, volumeDeleteCompleted=volumeDeleteCompleted, poolImported=poolImported, shareSnapshotSizeHigh=shareSnapshotSizeHigh, nicMTU=nicMTU, netbiosSocketFailure=netbiosSocketFailure, poolFreeSizeLow=poolFreeSizeLow, fcInitiators=fcInitiators, projectIndex=projectIndex, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry, fcTargetName=fcTargetName, replicationComplete=replicationComplete, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolMetaReadIops=poolMetaReadIops, ipmiThreshold=ipmiThreshold, nicName=nicName, poolMetaWriteIops=poolMetaWriteIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, diskTotalReadMbps=diskTotalReadMbps, shareQuotaLow=shareQuotaLow, tegileArray=tegileArray, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, shareCIFSWriteIops=shareCIFSWriteIops, shareCIFSReadLatency=shareCIFSReadLatency, poolState=poolState, poolDataWriteIops=poolDataWriteIops, projectEntry=projectEntry, projectFreeSizeLow=projectFreeSizeLow, ntpServerTimeDrift=ntpServerTimeDrift, projectDeleted=projectDeleted, lunDataSizeHigh=lunDataSizeHigh, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiInitiatorName=iscsiInitiatorName, nicTable=nicTable, PYSNMP_MODULE_ID=tegile, fcProperties=fcProperties, cpuInterrupts=cpuInterrupts, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, unknownSensorEvent=unknownSensorEvent, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, volumeModifyCompleted=volumeModifyCompleted, poolUsedSizeLow=poolUsedSizeLow, poolTotalSaving=poolTotalSaving, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunSizeLow=lunSizeLow)
mibBuilder.exportSymbols("TEGILE-MIB", fcTotalWriteMbps=fcTotalWriteMbps, alertsCleanupCompleted=alertsCleanupCompleted, shareReservedSizeHigh=shareReservedSizeHigh, fcAvgWriteLatency=fcAvgWriteLatency, ipmiMemory=ipmiMemory, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, haResourceIndex=haResourceIndex, cpuSystemCalls=cpuSystemCalls, poolReadCacheReadIops=poolReadCacheReadIops, replicationStarted=replicationStarted, poolAvgReadLatency=poolAvgReadLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, poolMetaReadLatency=poolMetaReadLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiTargetAlias=iscsiTargetAlias, replicationResumed=replicationResumed, fcInitiatorGroup=fcInitiatorGroup, fcTargetEntry=fcTargetEntry, notificationReadingUnit=notificationReadingUnit, properties=properties, nicState=nicState, shareDeletionFailed=shareDeletionFailed, lunTargetGroup=lunTargetGroup, notificationSeverity=notificationSeverity, notificationDescription=notificationDescription, iscsiTargetReadIops=iscsiTargetReadIops, haResourceActiveNode=haResourceActiveNode, aclMigrationStarted=aclMigrationStarted, lunReadLatency=lunReadLatency, ipmiTemperature=ipmiTemperature, iscsiTargetName=iscsiTargetName, lunGUID=lunGUID, tdpsUpgradeTimeout=tdpsUpgradeTimeout, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolExported=poolExported, fcTargets=fcTargets, diskDataReadIops=diskDataReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, ipmiFan=ipmiFan, haResources=haResources, lunName=lunName, fcInitiatorCreateFailed=fcInitiatorCreateFailed, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, network=network, notifications=notifications, shareReservedSizeLow=shareReservedSizeLow, nicGroup=nicGroup, haResourceDescription=haResourceDescription, cacheRAMReads=cacheRAMReads, volumeQuotaFinished=volumeQuotaFinished, iscsiTargetEntry=iscsiTargetEntry, memoryFailure=memoryFailure, shareProjectName=shareProjectName, poolReadCacheWriteLatency=poolReadCacheWriteLatency, nicTransmitMbps=nicTransmitMbps, fcInitiatorEntry=fcInitiatorEntry, replicationSourceRegistered=replicationSourceRegistered, projectThresholdExceedWarning=projectThresholdExceedWarning, projectLUNs=projectLUNs, fcTotalReadMbps=fcTotalReadMbps, poolFreeSizeHigh=poolFreeSizeHigh, ipmiVoltage=ipmiVoltage, cacheTotalWriteMbps=cacheTotalWriteMbps, cacheTotalReadMbps=cacheTotalReadMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, networkInterfaceDown=networkInterfaceDown, poolQuotaFinished=poolQuotaFinished, projectModified=projectModified, poolWriteCacheWriteIops=poolWriteCacheWriteIops, smisServiceStartFailed=smisServiceStartFailed, shareQuotaHigh=shareQuotaHigh, tegileArray_notifications=tegileArray_notifications, fcTargetWriteLatency=fcTargetWriteLatency, adServerTimeDrift=adServerTimeDrift, upgradeTimeout=upgradeTimeout, projectDedupEnabled=projectDedupEnabled, diskSizeLow=diskSizeLow, diskSizeHigh=diskSizeHigh, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolDeleted=poolDeleted, networkIpmpGroupUp=networkIpmpGroupUp, diskAvgReadLatency=diskAvgReadLatency, nfsTotalWriteIops=nfsTotalWriteIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolMetaWriteLatency=poolMetaWriteLatency, haResourceEntry=haResourceEntry, projectDataSizeLow=projectDataSizeLow, lunProtocol=lunProtocol, tegileConformance=tegileConformance, shareCIFSReadIops=shareCIFSReadIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolDeletionFailed=poolDeletionFailed, iscsiTargetError=iscsiTargetError, notificationSensorSuspect=notificationSensorSuspect, poolMetaReadMbps=poolMetaReadMbps, poolTotalReadMbps=poolTotalReadMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, shareDataSizeLow=shareDataSizeLow, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunSnapshotSizeHigh=lunSnapshotSizeHigh, snmpServiceStopped=snmpServiceStopped, projectLunCount=projectLunCount, lunSnapshotSizeLow=lunSnapshotSizeLow, shareCompressionEnabled=shareCompressionEnabled, notificationComponentName=notificationComponentName, poolProjectCount=poolProjectCount, upgradeCompleted=upgradeCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, notificationEventCode=notificationEventCode, nvdimmFailUnknownError=nvdimmFailUnknownError, lunProjectName=lunProjectName, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, snmpServiceStopFailed=snmpServiceStopFailed, cacheSSDReads=cacheSSDReads, diskType=diskType, nicIndex=nicIndex, replicationPaused=replicationPaused, diskIsOnline=diskIsOnline, replicationAbandoned=replicationAbandoned, diskAvgWriteLatency=diskAvgWriteLatency, lunReservedSizeHigh=lunReservedSizeHigh, shareSnapshotSizeLow=shareSnapshotSizeLow, shareEntry=shareEntry, iscsiTargetWriteIops=iscsiTargetWriteIops, disks=disks, diskChassisIdx=diskChassisIdx, poolDataWriteMbps=poolDataWriteMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolTotalWriteIops=poolTotalWriteIops, notificationSensorNumber=notificationSensorNumber, cacheTotalReadIops=cacheTotalReadIops, poolSizeLow=poolSizeLow, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snmpServiceStartFailed=snmpServiceStartFailed, poolReadCacheReadMbps=poolReadCacheReadMbps, diskSequentialIOCount=diskSequentialIOCount, projectQuotaSizeLow=projectQuotaSizeLow, replicationTargetDeleted=replicationTargetDeleted, userLoginFailed=userLoginFailed, fcTargetStatus=fcTargetStatus, fcInitiatorIndex=fcInitiatorIndex, poolUsedSizeHigh=poolUsedSizeHigh, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunIndex=lunIndex, nvdimmFailDeviceError=nvdimmFailDeviceError, poolIndex=poolIndex, haResourceStatus=haResourceStatus, targetGroupMemberAdded=targetGroupMemberAdded, projectShares=projectShares, controllerUp=controllerUp, upgradeStarted=upgradeStarted, diskAlias=diskAlias, lunReservedSizeLow=lunReservedSizeLow, notificationProps=notificationProps, diskState=diskState, poolDataSizeHigh=poolDataSizeHigh, lunFreeSizeLow=lunFreeSizeLow, iscsiTargetWriteMbps=iscsiTargetWriteMbps, maintenanceModeDisabled=maintenanceModeDisabled, diskRandomIOCount=diskRandomIOCount, testNotification=testNotification, poolHealth=poolHealth, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, lunDedupEnabled=lunDedupEnabled, iscsiInitiators=iscsiInitiators, notificationThresholdTriggerValue=notificationThresholdTriggerValue, lunTable=lunTable, diskTotalReadIops=diskTotalReadIops, lunInitiatorGroup=lunInitiatorGroup, poolDegraded=poolDegraded, currentObjectGroup=currentObjectGroup, nvdimmFailSoftError=nvdimmFailSoftError, iscsiAvgWriteLatency=iscsiAvgWriteLatency, haResourceGroup=haResourceGroup, fcTargetReadIops=fcTargetReadIops, haControllerB_Name=haControllerB_Name, tegile=tegile, diskTotalWriteIops=diskTotalWriteIops, haControllerB_Uptime=haControllerB_Uptime, poolDataSizeLow=poolDataSizeLow, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, lunCompressionEnabled=lunCompressionEnabled, diskTotalWriteMbps=diskTotalWriteMbps, cifsTotalReadMbps=cifsTotalReadMbps, lunEntry=lunEntry, fcTargetWriteMbps=fcTargetWriteMbps, lunDataSizeLow=lunDataSizeLow, globalStatistics=globalStatistics, shareMountPoint=shareMountPoint, shareNFSEnabled=shareNFSEnabled, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiInitiatorGroup=iscsiInitiatorGroup, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, shareQuotaFinished=shareQuotaFinished, shareNFSWriteMbps=shareNFSWriteMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareDataSizeHigh=shareDataSizeHigh, sharePoolName=sharePoolName, projectCompressionEnabled=projectCompressionEnabled, iscsiWriteIops=iscsiWriteIops, poolUpgraded=poolUpgraded, shareCIFSWriteLatency=shareCIFSWriteLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolDataReadMbps=poolDataReadMbps, diskTable=diskTable, cpuTotalUsage=cpuTotalUsage, haResourcesTable=haResourcesTable, fcTargetIndex=fcTargetIndex)
