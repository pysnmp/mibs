...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:00:27 2021
...
NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Integer32, iso, IpAddress, MibIdentifier, Unsigned32, Counter32, Bits, enterprises, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Integer32", "iso", "IpAddress", "MibIdentifier", "Unsigned32", "Counter32", "Bits", "enterprises", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolTotalWriteMbps=poolTotalWriteMbps, lunProjectName=lunProjectName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolMetaReadIops=poolMetaReadIops, poolDataWriteIops=poolDataWriteIops, projectQuotaFinished=projectQuotaFinished, webdocsUpgradeFailed=webdocsUpgradeFailed, alertsCleanupCompleted=alertsCleanupCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, haResourcesTable=haResourcesTable, projectDedupEnabled=projectDedupEnabled, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, controllerHardwareModel=controllerHardwareModel, notificationSensorAction=notificationSensorAction, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, upgradeDownloadStarted=upgradeDownloadStarted, fcInitiatorName=fcInitiatorName, diskSizeHigh=diskSizeHigh, poolUsedSizeHigh=poolUsedSizeHigh, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectDataSizeLow=projectDataSizeLow, notifications=notifications, nicEntry=nicEntry, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, maintenanceModeDisabled=maintenanceModeDisabled, cpuSystemCalls=cpuSystemCalls, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, cacheRAMReads=cacheRAMReads, poolDeleted=poolDeleted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskSizeLow=diskSizeLow, targetGroupMemberAdded=targetGroupMemberAdded, cpuInterrupts=cpuInterrupts, upgradeCompleted=upgradeCompleted, fcInitiators=fcInitiators, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareCIFSReadIops=shareCIFSReadIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareCIFSReadLatency=shareCIFSReadLatency, diskTable=diskTable, haResourceName=haResourceName, userLoginFailed=userLoginFailed, poolIndex=poolIndex, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectFreeSizeLow=projectFreeSizeLow, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunProtocol=lunProtocol, snmpServiceStarted=snmpServiceStarted, haControllerB_IPAddr=haControllerB_IPAddr, ipmiCurrent=ipmiCurrent, iscsiTargetReadMbps=iscsiTargetReadMbps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, replicationAborted=replicationAborted, poolProjects=poolProjects, notificationObjects=notificationObjects, projectDataSizeHigh=projectDataSizeHigh, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, cifsAvgWriteLatency=cifsAvgWriteLatency, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, snapshotRollbackFailed=snapshotRollbackFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, cacheSSDReads=cacheSSDReads, diskAvgReadLatency=diskAvgReadLatency, ipmiVoltage=ipmiVoltage, poolReadCacheReadLatency=poolReadCacheReadLatency, diskType=diskType, shareCIFSWriteIops=shareCIFSWriteIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, iscsiTargetIndex=iscsiTargetIndex, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectName=projectName, currentObjectGroup=currentObjectGroup, fcProperties=fcProperties, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareDataSizeLow=shareDataSizeLow, lunDedupEnabled=lunDedupEnabled, diskTotalReadMbps=diskTotalReadMbps, haControllerA_Uptime=haControllerA_Uptime, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, fcTargetModifyCompleted=fcTargetModifyCompleted, pools=pools, projectIndex=projectIndex, fcTargetWriteMbps=fcTargetWriteMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, lunIndex=lunIndex, nicMTU=nicMTU, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, replicationStarted=replicationStarted, properties=properties, sharePoolName=sharePoolName, poolExported=poolExported, haResourceGroup=haResourceGroup, poolTotalWriteIops=poolTotalWriteIops, poolName=poolName, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, lunSizeHigh=lunSizeHigh, projectShares=projectShares, shareNFSReadLatency=shareNFSReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, smisServiceStarted=smisServiceStarted, nvdimmFailUnknownError=nvdimmFailUnknownError, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiInitiators=iscsiInitiators, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, volumeModifyCompleted=volumeModifyCompleted, iscsiWriteIops=iscsiWriteIops, poolState=poolState, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, projectTotalSaving=projectTotalSaving, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcTargets=fcTargets, lunGUID=lunGUID, smisServiceStartFailed=smisServiceStartFailed, fcTargetWriteIops=fcTargetWriteIops, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, projectCompressionEnabled=projectCompressionEnabled, iscsiTargetWriteLatency=iscsiTargetWriteLatency, shareMountPoint=shareMountPoint, projectDeleted=projectDeleted, replicationResumed=replicationResumed, replicationSourceRegistered=replicationSourceRegistered, haControllerA_Name=haControllerA_Name, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, networkTotalReceiveMbps=networkTotalReceiveMbps, notificationReadingUnit=notificationReadingUnit, ipmiMemory=ipmiMemory, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiTargetReadIops=iscsiTargetReadIops, fcTargetWriteLatency=fcTargetWriteLatency, aclMigrationStarted=aclMigrationStarted, aclMigrationCompleted=aclMigrationCompleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunFreeSizeHigh=lunFreeSizeHigh, poolAvgReadLatency=poolAvgReadLatency, fcTotalReadIops=fcTotalReadIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, nicTransmitMbps=nicTransmitMbps, disks=disks, lunDataSizeHigh=lunDataSizeHigh, haResourceStatus=haResourceStatus, cifsTotalWriteIops=cifsTotalWriteIops, lunWriteLatency=lunWriteLatency, nicReceiveMbps=nicReceiveMbps, shareNFSReadMbps=shareNFSReadMbps, fcTargetReadLatency=fcTargetReadLatency, snapshotCloningFailed=snapshotCloningFailed, smisServiceStopped=smisServiceStopped, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcTargetStatus=fcTargetStatus, diskRandomIOCount=diskRandomIOCount, shareNFSEnabled=shareNFSEnabled, notificationSensorNumber=notificationSensorNumber, lunSnapshotSizeLow=lunSnapshotSizeLow, notificationTime=notificationTime, cifsTotalReadIops=cifsTotalReadIops, shareNFSWriteMbps=shareNFSWriteMbps, shareReservedSizeHigh=shareReservedSizeHigh, ipmiFan=ipmiFan, poolMetaWriteLatency=poolMetaWriteLatency, smbSocketFailure=smbSocketFailure, ipmiPowerSupply=ipmiPowerSupply, iscsiTargetAuth=iscsiTargetAuth, intelliFlashSoftwareDown=intelliFlashSoftwareDown, targetGroupMemberRemoved=targetGroupMemberRemoved, tegileArray_notifications=tegileArray_notifications, currentNotificationGroup=currentNotificationGroup, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, ipmiOther=ipmiOther, notificationComponentName=notificationComponentName, webdocsUpgradeCompleted=webdocsUpgradeCompleted, lunCompressedRatio=lunCompressedRatio, poolSizeHigh=poolSizeHigh, adServerTimeDrift=adServerTimeDrift, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcTargetReadIops=fcTargetReadIops, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, upgradeTimeout=upgradeTimeout, snapshotRollbackCompleted=snapshotRollbackCompleted, nfsTotalReadIops=nfsTotalReadIops, nicGroup=nicGroup, notificationProps=notificationProps, haControllerA_IPAddr=haControllerA_IPAddr, lunReservedSizeHigh=lunReservedSizeHigh, shareName=shareName, shareQuotaLow=shareQuotaLow, iscsiInitiatorsTable=iscsiInitiatorsTable, iscsiInitiatorEntry=iscsiInitiatorEntry, replicationPaused=replicationPaused, diskSequentialIOCount=diskSequentialIOCount, diskDataWriteMbps=diskDataWriteMbps, poolEntry=poolEntry, spareDiskReplaced=spareDiskReplaced, tdpsUpgradeTimeout=tdpsUpgradeTimeout, diskDataReadIops=diskDataReadIops, fcAvgWriteLatency=fcAvgWriteLatency, projectSnapshotSizeHigh=projectSnapshotSizeHigh, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, iscsiImproperTargetGroup=iscsiImproperTargetGroup, replicationTargetDeleted=replicationTargetDeleted, fcAvgReadLatency=fcAvgReadLatency, projectLUNs=projectLUNs, poolCount=poolCount, notificationSeverity=notificationSeverity, diskError=diskError, lunPoolName=lunPoolName, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolDataReadMbps=poolDataReadMbps, PYSNMP_MODULE_ID=tegile, lunEntry=lunEntry, poolTotalSaving=poolTotalSaving, poolMetaWriteMbps=poolMetaWriteMbps, poolImported=poolImported, iscsiTargetsTable=iscsiTargetsTable, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, upgradeDownloadFailed=upgradeDownloadFailed, iscsiTargetWriteIops=iscsiTargetWriteIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolReadCacheReadIops=poolReadCacheReadIops, fcInitiatorGroup=fcInitiatorGroup, iscsiAvgReadLatency=iscsiAvgReadLatency, snmpAgentVersion=snmpAgentVersion, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiTargetAlias=iscsiTargetAlias, controllerUp=controllerUp, fcTotalWriteIops=fcTotalWriteIops, networkInterfaceUp=networkInterfaceUp, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, projectModified=projectModified, shareQuotaFinished=shareQuotaFinished, sensorFailureEvent=sensorFailureEvent, snapshotCreationFailed=snapshotCreationFailed, ipmiTemperature=ipmiTemperature, diskIndex=diskIndex, lunTargetGroup=lunTargetGroup, smisServiceStopFailed=smisServiceStopFailed, diskTotalWriteIops=diskTotalWriteIops, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareCIFSEnabled=shareCIFSEnabled)
mibBuilder.exportSymbols("TEGILE-MIB", shareQuotaHigh=shareQuotaHigh, poolCreated=poolCreated, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolQuotaFinished=poolQuotaFinished, notificationDescription=notificationDescription, replicationComplete=replicationComplete, lunDataSizeLow=lunDataSizeLow, lunReadIops=lunReadIops, diskTotalWriteMbps=diskTotalWriteMbps, poolHealth=poolHealth, poolDataWriteMbps=poolDataWriteMbps, shareReservedSizeLow=shareReservedSizeLow, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcInitiatorIndex=fcInitiatorIndex, projectDeletionFailed=projectDeletionFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskDataReadMbps=diskDataReadMbps, notificationTargetEntityName=notificationTargetEntityName, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargetEntry=fcTargetEntry, diskDataWriteIops=diskDataWriteIops, haResourceIndex=haResourceIndex, tdpsUpgradeCompleted=tdpsUpgradeCompleted, nfsTotalWriteIops=nfsTotalWriteIops, lunInitiatorGroup=lunInitiatorGroup, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, volumeQuotaFinished=volumeQuotaFinished, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiTargetGroupError=iscsiTargetGroupError, poolExpanded=poolExpanded, iscsiTargetGroup=iscsiTargetGroup, replicationFailed=replicationFailed, diskCount=diskCount, shareCompressedRatio=shareCompressedRatio, deleteFolderCompleted=deleteFolderCompleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectEntry=projectEntry, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, cifsTotalWriteMbps=cifsTotalWriteMbps, shareIndex=shareIndex, nvdimmFailInitializationError=nvdimmFailInitializationError, shareDeletionFailed=shareDeletionFailed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargetReadLatency=iscsiTargetReadLatency, nicName=nicName, haResourceDescription=haResourceDescription, poolDegraded=poolDegraded, networkInterfaceDown=networkInterfaceDown, cacheTotalWriteMbps=cacheTotalWriteMbps, network=network, lunReservedSizeLow=lunReservedSizeLow, projectLunCount=projectLunCount, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolDataWriteLatency=poolDataWriteLatency, lunSizeLow=lunSizeLow, poolSizeLow=poolSizeLow, notificationReadingTriggerValue=notificationReadingTriggerValue, projectQuotaSizeLow=projectQuotaSizeLow, haResourceActiveNode=haResourceActiveNode, networkIpmpGroupUp=networkIpmpGroupUp, poolTotalReadIops=poolTotalReadIops, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolMetaReadLatency=poolMetaReadLatency, tegile=tegile, poolDeletionFailed=poolDeletionFailed, iscsiTargetError=iscsiTargetError, lunBlockSize=lunBlockSize, poolProjectCount=poolProjectCount, tegileCompliances=tegileCompliances, snmpServiceStartFailed=snmpServiceStartFailed, shareNFSReadIops=shareNFSReadIops, fcTargetName=fcTargetName, poolUpgraded=poolUpgraded, fcPortOffline=fcPortOffline, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectPoolName=projectPoolName, memoryFailure=memoryFailure, lunWriteMbps=lunWriteMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, lunReadMbps=lunReadMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, poolTable=poolTable, ipmiThreshold=ipmiThreshold, poolFreeSizeHigh=poolFreeSizeHigh, diskIsOnline=diskIsOnline, haResourceEntry=haResourceEntry, snmpServiceStopped=snmpServiceStopped, snmpServiceStopFailed=snmpServiceStopFailed, poolOwnerController=poolOwnerController, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, tegileGroups=tegileGroups, sanProperties=sanProperties, nfsTotalReadMbps=nfsTotalReadMbps, globalStatistics=globalStatistics, diskEntry=diskEntry, shareEntry=shareEntry, poolReadCacheReadMbps=poolReadCacheReadMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, diskAlias=diskAlias, iscsiTotalReadMbps=iscsiTotalReadMbps, volumeDeleteCompleted=volumeDeleteCompleted, upgradeFailed=upgradeFailed, shareDeleted=shareDeleted, nicIndex=nicIndex, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareExceedThresholdWarning=shareExceedThresholdWarning, poolDataSizeLow=poolDataSizeLow, controllerDown=controllerDown, networkIpmpGroupDown=networkIpmpGroupDown, lunFreeSizeLow=lunFreeSizeLow, haControllerB_Uptime=haControllerB_Uptime, diskSlowIo=diskSlowIo, poolReadCacheWriteIops=poolReadCacheWriteIops, testNotification=testNotification, fcInitiatorEntry=fcInitiatorEntry, iscsiInitiatorName=iscsiInitiatorName, shareTable=shareTable, deleteFolderFailed=deleteFolderFailed, controllerTimeDrift=controllerTimeDrift, replicationAbandoned=replicationAbandoned, nicTable=nicTable, shareCIFSWriteMbps=shareCIFSWriteMbps, diskPoolName=diskPoolName, poolUsedSizeLow=poolUsedSizeLow, projectThresholdExceedWarning=projectThresholdExceedWarning, snapshotCloneCompleted=snapshotCloneCompleted, shareCIFSReadMbps=shareCIFSReadMbps, cacheTotalWriteIops=cacheTotalWriteIops, projectShareCount=projectShareCount, shareSnapshotSizeLow=shareSnapshotSizeLow, nvdimmFailSoftError=nvdimmFailSoftError, poolMetaReadMbps=poolMetaReadMbps, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTotalReadIops=iscsiTotalReadIops, diskAvgWriteLatency=diskAvgWriteLatency, diskGoneOffline=diskGoneOffline, fcTotalWriteMbps=fcTotalWriteMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcTargetsTable=fcTargetsTable, shareNFSWriteIops=shareNFSWriteIops, lunReadLatency=lunReadLatency, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, tegileArray=tegileArray, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, basicCompliance=basicCompliance, poolTotalReadMbps=poolTotalReadMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, snapshotDeleteFailed=snapshotDeleteFailed, notificationSensorSuspect=notificationSensorSuspect, poolMetaWriteIops=poolMetaWriteIops, cpuTotalUsage=cpuTotalUsage, diskTotalReadIops=diskTotalReadIops, diskIOCount=diskIOCount, diskChassisIdx=diskChassisIdx, volumeDeleteFailed=volumeDeleteFailed, projectQuotaSizeHigh=projectQuotaSizeHigh, ntpServerTimeDrift=ntpServerTimeDrift, nfsTotalWriteMbps=nfsTotalWriteMbps, poolAvgWriteLatency=poolAvgWriteLatency, iscsiTargets=iscsiTargets, iscsiProperties=iscsiProperties, fcTargetGroup=fcTargetGroup, nicState=nicState, targetGroupCreateCompleted=targetGroupCreateCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, unknownSensorEvent=unknownSensorEvent, nfsAvgReadLatency=nfsAvgReadLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, shareDataSizeHigh=shareDataSizeHigh, poolFreeSizeLow=poolFreeSizeLow, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcTargetIndex=fcTargetIndex, shareCompressionEnabled=shareCompressionEnabled, maintenanceModeEnabled=maintenanceModeEnabled, lunTable=lunTable, poolDataSizeHigh=poolDataSizeHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, diskState=diskState, fcPortOnline=fcPortOnline, haControllerB_Name=haControllerB_Name, netbiosSocketFailure=netbiosSocketFailure, notificationThresholdTriggerValue=notificationThresholdTriggerValue, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolDataReadIops=poolDataReadIops, notificationEventCode=notificationEventCode, iscsiTargetEntry=iscsiTargetEntry, diagnosticDataUploaded=diagnosticDataUploaded, cifsAvgReadLatency=cifsAvgReadLatency, shareNFSWriteLatency=shareNFSWriteLatency, fcTargetReadMbps=fcTargetReadMbps, shareProjectName=shareProjectName, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolDataReadLatency=poolDataReadLatency, fcInitiatorsTable=fcInitiatorsTable, upgradeStarted=upgradeStarted, haResources=haResources, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcTotalReadMbps=fcTotalReadMbps, cacheTotalReadIops=cacheTotalReadIops, iscsiTargetName=iscsiTargetName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunWriteIops=lunWriteIops, lunCompressionEnabled=lunCompressionEnabled, lunName=lunName, tegileConformance=tegileConformance, iscsiInitiatorChapUser=iscsiInitiatorChapUser, shareDedupEnabled=shareDedupEnabled, projectTable=projectTable, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareSnapshotSizeHigh=shareSnapshotSizeHigh)
