...
Unsigned32, IpAddress, iso, TimeTicks, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, Bits, Counter64, Integer32, ObjectIdentity, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "iso", "TimeTicks", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "Bits", "Counter64", "Integer32", "ObjectIdentity", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunWriteMbps=lunWriteMbps, ipmiFan=ipmiFan, iscsiInitiators=iscsiInitiators, poolTotalWriteMbps=poolTotalWriteMbps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, ipmiOther=ipmiOther, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diskRandomIOCount=diskRandomIOCount, volumeDeleteFailed=volumeDeleteFailed, notificationSeverity=notificationSeverity, volumeModifyCompleted=volumeModifyCompleted, currentObjectGroup=currentObjectGroup, projectSnapshotSizeLow=projectSnapshotSizeLow, replicationAborted=replicationAborted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcTargetWriteLatency=fcTargetWriteLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, upgradeCompleted=upgradeCompleted, poolName=poolName, smisServiceStartFailed=smisServiceStartFailed, ntpServerTimeDrift=ntpServerTimeDrift, lunCompressedRatio=lunCompressedRatio, poolImported=poolImported, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, netbiosSocketFailure=netbiosSocketFailure, poolDeletionFailed=poolDeletionFailed, diskTotalWriteMbps=diskTotalWriteMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolEntry=poolEntry, poolTotalReadMbps=poolTotalReadMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectName=projectName, adServerTimeDrift=adServerTimeDrift, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, cifsAvgReadLatency=cifsAvgReadLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, ipmiVoltage=ipmiVoltage, notificationReadingTriggerValue=notificationReadingTriggerValue, poolMetaReadIops=poolMetaReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, haResourceName=haResourceName, poolHealth=poolHealth, iscsiTargetIndex=iscsiTargetIndex, poolExported=poolExported, snmpServiceStarted=snmpServiceStarted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolReadCacheWriteIops=poolReadCacheWriteIops, spareDiskReplaced=spareDiskReplaced, networkIpmpGroupDown=networkIpmpGroupDown, fcTargets=fcTargets, upgradeTimeout=upgradeTimeout, poolOwnerController=poolOwnerController, lunProtocol=lunProtocol, haControllerA_IPAddr=haControllerA_IPAddr, iscsiTargetGroup=iscsiTargetGroup, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, haControllerB_Name=haControllerB_Name, PYSNMP_MODULE_ID=tegile, diskDataWriteIops=diskDataWriteIops, fcTotalReadIops=fcTotalReadIops, replicationFailed=replicationFailed, fcTargetReadIops=fcTargetReadIops, fcTargetWriteMbps=fcTargetWriteMbps, notifications=notifications, smisServiceStopped=smisServiceStopped, projectQuotaSizeHigh=projectQuotaSizeHigh, snapshotCreationFailed=snapshotCreationFailed, fcTotalWriteIops=fcTotalWriteIops, projectShareCount=projectShareCount, shareMountPoint=shareMountPoint, poolDegraded=poolDegraded, vmwareNFSDatastores=vmwareNFSDatastores, projectDedupEnabled=projectDedupEnabled, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareDataSizeLow=shareDataSizeLow, fcTargetGroup=fcTargetGroup, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, tegileCompliances=tegileCompliances, fcTargetStatus=fcTargetStatus, iscsiTotalReadMbps=iscsiTotalReadMbps, haResourceDescription=haResourceDescription, fcTargetName=fcTargetName, projectQuotaFinished=projectQuotaFinished, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, targetGroupMemberAdded=targetGroupMemberAdded, snapshotDeleteFailed=snapshotDeleteFailed, projectDeleted=projectDeleted, poolTotalWriteIops=poolTotalWriteIops, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, lunFreeSizeLow=lunFreeSizeLow, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunIndex=lunIndex, lunInitiatorGroup=lunInitiatorGroup, iscsiTargetsTable=iscsiTargetsTable, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, tegileGroups=tegileGroups, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diskSlowIo=diskSlowIo, shareQuotaLow=shareQuotaLow, diskState=diskState, projectPoolName=projectPoolName, pools=pools, poolSizeHigh=poolSizeHigh, replicationAbandoned=replicationAbandoned, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, diskSizeHigh=diskSizeHigh, fcPortOnline=fcPortOnline, tdpsUpgradeFailed=tdpsUpgradeFailed, lunReservedSizeHigh=lunReservedSizeHigh, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskIOCount=diskIOCount, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunReadLatency=lunReadLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, fcInitiatorsTable=fcInitiatorsTable, projectModified=projectModified, shareNFSReadIops=shareNFSReadIops, nicReceiveMbps=nicReceiveMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, replicationPaused=replicationPaused, shareNFSWriteLatency=shareNFSWriteLatency, diskTotalReadMbps=diskTotalReadMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, poolMetaWriteMbps=poolMetaWriteMbps, globalStatistics=globalStatistics, volumeQuotaFinished=volumeQuotaFinished, iscsiAvgReadLatency=iscsiAvgReadLatency, cacheTotalWriteMbps=cacheTotalWriteMbps, projectCompressionEnabled=projectCompressionEnabled, testNotification=testNotification, poolDataReadMbps=poolDataReadMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectTotalSaving=projectTotalSaving, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, diskEntry=diskEntry, shareCIFSWriteLatency=shareCIFSWriteLatency, fcInitiatorGroup=fcInitiatorGroup, diskType=diskType, nvdimmFailUnknownError=nvdimmFailUnknownError, shareNFSReadLatency=shareNFSReadLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, tegileConformance=tegileConformance, poolIndex=poolIndex, nicGroup=nicGroup, lunTable=lunTable, nicTransmitMbps=nicTransmitMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, snmpServiceStopped=snmpServiceStopped, lunProjectName=lunProjectName, iscsiWriteIops=iscsiWriteIops, shareQuotaFinished=shareQuotaFinished, haResources=haResources, iscsiTargetWriteIops=iscsiTargetWriteIops, sanProperties=sanProperties, notificationReadingUnit=notificationReadingUnit, iscsiImproperTargetGroup=iscsiImproperTargetGroup, notificationSensorAction=notificationSensorAction, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunGUID=lunGUID, snmpServiceStartFailed=snmpServiceStartFailed, poolDeleted=poolDeleted, fcInitiatorName=fcInitiatorName, currentNotificationGroup=currentNotificationGroup, poolProjects=poolProjects, lunSizeLow=lunSizeLow, smbSocketFailure=smbSocketFailure, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, maintenanceModeDisabled=maintenanceModeDisabled, shareQuotaHigh=shareQuotaHigh, cpuTotalUsage=cpuTotalUsage, cacheTotalReadMbps=cacheTotalReadMbps, fcAvgReadLatency=fcAvgReadLatency, controllerUp=controllerUp, fcTargetWriteIops=fcTargetWriteIops, shareName=shareName, sharePoolName=sharePoolName, iscsiInitiatorIndex=iscsiInitiatorIndex, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, fcTargetEntry=fcTargetEntry, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, tegile=tegile, projectDataSizeLow=projectDataSizeLow, iscsiTargets=iscsiTargets, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiTargetGroupError=iscsiTargetGroupError, haResourcesTable=haResourcesTable, projectLunCount=projectLunCount, shareCompressedRatio=shareCompressedRatio, tegileArray=tegileArray, diskGoneOffline=diskGoneOffline, poolMetaWriteIops=poolMetaWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, notificationSensorSuspect=notificationSensorSuspect, shareNFSWriteMbps=shareNFSWriteMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolAvgReadLatency=poolAvgReadLatency, poolMetaReadLatency=poolMetaReadLatency, diskTotalReadIops=diskTotalReadIops, iscsiProperties=iscsiProperties, nicMTU=nicMTU, shareDedupEnabled=shareDedupEnabled, smisServiceStopFailed=smisServiceStopFailed, lunReadIops=lunReadIops, diskCount=diskCount, poolFreeSizeHigh=poolFreeSizeHigh, poolAvgWriteLatency=poolAvgWriteLatency, poolSizeLow=poolSizeLow, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiTargetReadIops=iscsiTargetReadIops, diskChassisIdx=diskChassisIdx, nicIndex=nicIndex, notificationThresholdTriggerValue=notificationThresholdTriggerValue, controllerDown=controllerDown, fcTargetModifyCompleted=fcTargetModifyCompleted, poolCount=poolCount, iscsiInitiatorChapUser=iscsiInitiatorChapUser, nfsTotalReadMbps=nfsTotalReadMbps, lunBlockSize=lunBlockSize, lunDedupEnabled=lunDedupEnabled, notificationProps=notificationProps, shareCIFSReadLatency=shareCIFSReadLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareDeleted=shareDeleted, sensorFailureEvent=sensorFailureEvent, poolQuotaFinished=poolQuotaFinished, ipmiMemory=ipmiMemory, disks=disks, poolFreeSizeLow=poolFreeSizeLow, upgradeStarted=upgradeStarted, volumeDeleteCompleted=volumeDeleteCompleted, iscsiTargetName=iscsiTargetName, lunName=lunName, shareCIFSReadIops=shareCIFSReadIops, unknownSensorEvent=unknownSensorEvent, cpuSystemCalls=cpuSystemCalls, nicName=nicName, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareReservedSizeHigh=shareReservedSizeHigh, nvdimmFailInitializationError=nvdimmFailInitializationError, shareEntry=shareEntry, iscsiTargetAuth=iscsiTargetAuth, replicationTargetDeleted=replicationTargetDeleted, iscsiTargetEntry=iscsiTargetEntry, smisServiceStarted=smisServiceStarted)
mibBuilder.exportSymbols("TEGILE-MIB", poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskPoolName=diskPoolName, lunSizeHigh=lunSizeHigh, shareReservedSizeLow=shareReservedSizeLow, fcProperties=fcProperties, poolTable=poolTable, poolCreated=poolCreated, poolDataReadLatency=poolDataReadLatency, shareCIFSWriteIops=shareCIFSWriteIops, fcTargetReadLatency=fcTargetReadLatency, fcPortOffline=fcPortOffline, fcTotalWriteMbps=fcTotalWriteMbps, fcTargetIndex=fcTargetIndex, poolDataReadIops=poolDataReadIops, projectEntry=projectEntry, alertsCleanupCompleted=alertsCleanupCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, diskIndex=diskIndex, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, replicationSourceRegistered=replicationSourceRegistered, deleteFolderFailed=deleteFolderFailed, fcInitiatorEntry=fcInitiatorEntry, ipmiThreshold=ipmiThreshold, nfsTotalWriteMbps=nfsTotalWriteMbps, poolMetaReadMbps=poolMetaReadMbps, poolProjectCount=poolProjectCount, projectDeletionFailed=projectDeletionFailed, snmpServiceStopFailed=snmpServiceStopFailed, poolDataWriteMbps=poolDataWriteMbps, cacheRAMReads=cacheRAMReads, replicationComplete=replicationComplete, iscsiInitiatorName=iscsiInitiatorName, haControllerB_IPAddr=haControllerB_IPAddr, memoryFailure=memoryFailure, webdocsUpgradeCompleted=webdocsUpgradeCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, notificationTime=notificationTime, fcTotalReadMbps=fcTotalReadMbps, shareTable=shareTable, notificationEventCode=notificationEventCode, cifsAvgWriteLatency=cifsAvgWriteLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, diagnosticDataUploaded=diagnosticDataUploaded, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectLUNs=projectLUNs, fcInitiatorIndex=fcInitiatorIndex, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, fcTargetReadMbps=fcTargetReadMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectDataSizeHigh=projectDataSizeHigh, networkInterfaceDown=networkInterfaceDown, lunCompressionEnabled=lunCompressionEnabled, haResourceIndex=haResourceIndex, snmpAgentVersion=snmpAgentVersion, ipmiTemperature=ipmiTemperature, networkInterfaceUp=networkInterfaceUp, iscsiInitiatorGroup=iscsiInitiatorGroup, intelliFlashSoftwareDown=intelliFlashSoftwareDown, diskIsOnline=diskIsOnline, nvdimmFailDeviceError=nvdimmFailDeviceError, replicationResumed=replicationResumed, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskAlias=diskAlias, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, haResourceEntry=haResourceEntry, notificationSensorNumber=notificationSensorNumber, diskTable=diskTable, shareDeletionFailed=shareDeletionFailed, upgradeDownloadStarted=upgradeDownloadStarted, shareNFSEnabled=shareNFSEnabled, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareCompressionEnabled=shareCompressionEnabled, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, networkTotalTransmitMbps=networkTotalTransmitMbps, cacheTotalReadIops=cacheTotalReadIops, iscsiTargetAlias=iscsiTargetAlias, controllerTimeDrift=controllerTimeDrift, tegileArray_notifications=tegileArray_notifications, poolDataSizeLow=poolDataSizeLow, snapshotRollbackFailed=snapshotRollbackFailed, diskError=diskError, diskAvgReadLatency=diskAvgReadLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, diskTotalWriteIops=diskTotalWriteIops, projectTable=projectTable, cifsTotalReadMbps=cifsTotalReadMbps, haResourceActiveNode=haResourceActiveNode, lunFreeSizeHigh=lunFreeSizeHigh, upgradeFailed=upgradeFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskDataWriteMbps=diskDataWriteMbps, lunReservedSizeLow=lunReservedSizeLow, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareDataSizeHigh=shareDataSizeHigh, maintenanceModeEnabled=maintenanceModeEnabled, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareCIFSReadMbps=shareCIFSReadMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, userLoginFailed=userLoginFailed, iscsiInitiatorEntry=iscsiInitiatorEntry, fcTargetsTable=fcTargetsTable, diskSequentialIOCount=diskSequentialIOCount, poolUsedSizeHigh=poolUsedSizeHigh, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, basicCompliance=basicCompliance, lunDataSizeHigh=lunDataSizeHigh, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, nicTable=nicTable, cacheSSDReads=cacheSSDReads, replicationStarted=replicationStarted, fcAvgWriteLatency=fcAvgWriteLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskDataReadMbps=diskDataReadMbps, snapshotCloneCompleted=snapshotCloneCompleted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareProjectName=shareProjectName, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectQuotaSizeLow=projectQuotaSizeLow, ipmiCurrent=ipmiCurrent, nvdimmFailSoftError=nvdimmFailSoftError, nfsAvgReadLatency=nfsAvgReadLatency, diskDataReadIops=diskDataReadIops, lunEntry=lunEntry, shareNFSWriteIops=shareNFSWriteIops, shareNFSReadMbps=shareNFSReadMbps, deleteFolderCompleted=deleteFolderCompleted, haControllerB_Uptime=haControllerB_Uptime, projectCreatedSuccessfully=projectCreatedSuccessfully, shareCIFSEnabled=shareCIFSEnabled, notificationComponentName=notificationComponentName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiTargetError=iscsiTargetError, networkTotalReceiveMbps=networkTotalReceiveMbps, lunDataSizeLow=lunDataSizeLow, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolMetaWriteLatency=poolMetaWriteLatency, lunReadMbps=lunReadMbps, networkIpmpGroupUp=networkIpmpGroupUp, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, nicEntry=nicEntry, ipmiCriticalInterrupt=ipmiCriticalInterrupt, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolTotalReadIops=poolTotalReadIops, cifsTotalWriteMbps=cifsTotalWriteMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, projectShares=projectShares, diskSizeLow=diskSizeLow, shareCreatedSuccessfully=shareCreatedSuccessfully, haControllerA_Name=haControllerA_Name, shareCIFSWriteMbps=shareCIFSWriteMbps, haResourceGroup=haResourceGroup, poolUsedSizeLow=poolUsedSizeLow, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolTotalSaving=poolTotalSaving, lunWriteIops=lunWriteIops, poolDataSizeHigh=poolDataSizeHigh, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, lunTargetGroup=lunTargetGroup, notificationObjects=notificationObjects, poolUpgraded=poolUpgraded, snapshotRollbackCompleted=snapshotRollbackCompleted, poolDataWriteLatency=poolDataWriteLatency, notificationTargetEntityName=notificationTargetEntityName, poolDataWriteIops=poolDataWriteIops, network=network, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, snapshotCloningFailed=snapshotCloningFailed, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, cacheTotalWriteIops=cacheTotalWriteIops, aclMigrationStarted=aclMigrationStarted, cifsTotalReadIops=cifsTotalReadIops, projectThresholdExceedWarning=projectThresholdExceedWarning, shareIndex=shareIndex, controllerHardwareModel=controllerHardwareModel, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolExpanded=poolExpanded, upgradeDownloadFailed=upgradeDownloadFailed, projectFreeSizeHigh=projectFreeSizeHigh, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, cpuInterrupts=cpuInterrupts, lunSnapshotSizeLow=lunSnapshotSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, properties=properties, nfsTotalReadIops=nfsTotalReadIops, iscsiTargetReadLatency=iscsiTargetReadLatency, projectFreeSizeLow=projectFreeSizeLow, ipmiPowerSupply=ipmiPowerSupply, iscsiTotalReadIops=iscsiTotalReadIops, nicState=nicState, iscsiAvgWriteLatency=iscsiAvgWriteLatency, haResourceStatus=haResourceStatus, haControllerA_Uptime=haControllerA_Uptime, lunPoolName=lunPoolName, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, notificationDescription=notificationDescription, volumeCreatedSuccessfully=volumeCreatedSuccessfully, diskAvgWriteLatency=diskAvgWriteLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, webdocsUpgradeFailed=webdocsUpgradeFailed, projectIndex=projectIndex, cifsTotalWriteIops=cifsTotalWriteIops, fcInitiators=fcInitiators, poolReadCacheReadLatency=poolReadCacheReadLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, nfsTotalWriteIops=nfsTotalWriteIops, lunWriteLatency=lunWriteLatency, poolState=poolState, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency)
