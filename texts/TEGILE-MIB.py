...
# Produced by pysmi-1.1.8 at Sat Jan 15 15:26:45 2022
...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, ObjectIdentity, MibIdentifier, Bits, ModuleIdentity, Counter64, Counter32, NotificationType, IpAddress, Gauge32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "ObjectIdentity", "MibIdentifier", "Bits", "ModuleIdentity", "Counter64", "Counter32", "NotificationType", "IpAddress", "Gauge32", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolAvgWriteLatency=poolAvgWriteLatency, fcTargetWriteMbps=fcTargetWriteMbps, fcInitiatorGroup=fcInitiatorGroup, iscsiTargetAuth=iscsiTargetAuth, networkTotalTransmitMbps=networkTotalTransmitMbps, poolTotalReadIops=poolTotalReadIops, notificationSensorAction=notificationSensorAction, poolSizeHigh=poolSizeHigh, shareNFSWriteIops=shareNFSWriteIops, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, fcTargetName=fcTargetName, iscsiAvgWriteLatency=iscsiAvgWriteLatency, replicationAborted=replicationAborted, poolUpgraded=poolUpgraded, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, notificationComponentName=notificationComponentName, projectDeletionFailed=projectDeletionFailed, lunGUID=lunGUID, shareNFSReadIops=shareNFSReadIops, poolTotalReadMbps=poolTotalReadMbps, shareNFSWriteLatency=shareNFSWriteLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, replicationSourceRegistered=replicationSourceRegistered, spareDiskReplaced=spareDiskReplaced, diskEntry=diskEntry, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, haResources=haResources, lunProjectName=lunProjectName, iscsiInitiatorGroup=iscsiInitiatorGroup, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, haResourceDescription=haResourceDescription, haResourceIndex=haResourceIndex, upgradeDownloadCompleted=upgradeDownloadCompleted, controllerTimeDrift=controllerTimeDrift, iscsiTargetReadLatency=iscsiTargetReadLatency, poolDataWriteLatency=poolDataWriteLatency, iscsiTotalReadIops=iscsiTotalReadIops, lunTargetGroup=lunTargetGroup, lunSizeHigh=lunSizeHigh, pools=pools, fcPortOffline=fcPortOffline, projectIndex=projectIndex, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolReadCacheWriteIops=poolReadCacheWriteIops, targetGroupMemberAdded=targetGroupMemberAdded, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, deleteFolderFailed=deleteFolderFailed, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiAvgReadLatency=iscsiAvgReadLatency, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetReadIops=fcTargetReadIops, snapshotCreationFailed=snapshotCreationFailed, fcTargetWriteLatency=fcTargetWriteLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, snmpAgentVersion=snmpAgentVersion, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTotalReadIops=fcTotalReadIops, deleteFolderCompleted=deleteFolderCompleted, aclMigrationCompleted=aclMigrationCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, notificationTime=notificationTime, iscsiTargetGroup=iscsiTargetGroup, poolUsedSizeHigh=poolUsedSizeHigh, shareCIFSReadLatency=shareCIFSReadLatency, diskChassisIdx=diskChassisIdx, lunFreeSizeHigh=lunFreeSizeHigh, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunReservedSizeLow=lunReservedSizeLow, poolDataWriteIops=poolDataWriteIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiTargetWriteMbps=iscsiTargetWriteMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, networkIpmpGroupDown=networkIpmpGroupDown, shareCreatedSuccessfully=shareCreatedSuccessfully, shareCIFSReadMbps=shareCIFSReadMbps, diskRandomIOCount=diskRandomIOCount, shareDedupEnabled=shareDedupEnabled, shareMountPoint=shareMountPoint, lunDedupEnabled=lunDedupEnabled, shareName=shareName, projectDataSizeHigh=projectDataSizeHigh, fcAvgReadLatency=fcAvgReadLatency, tegileArray_notifications=tegileArray_notifications, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunWriteLatency=lunWriteLatency, smisServiceStartFailed=smisServiceStartFailed, tegileCompliances=tegileCompliances, poolDeletionFailed=poolDeletionFailed, haResourceStatus=haResourceStatus, ipmiVoltage=ipmiVoltage, notificationTargetEntityName=notificationTargetEntityName, poolDataSizeLow=poolDataSizeLow, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolIndex=poolIndex, nicName=nicName, poolMetaWriteLatency=poolMetaWriteLatency, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, sensorFailureEvent=sensorFailureEvent, diskDataWriteIops=diskDataWriteIops, poolExported=poolExported, notifications=notifications, netbiosSocketFailure=netbiosSocketFailure, lunTable=lunTable, unknownSensorEvent=unknownSensorEvent, upgradeDownloadStarted=upgradeDownloadStarted, sanProperties=sanProperties, shareQuotaHigh=shareQuotaHigh, replicationStarted=replicationStarted, projectDedupEnabled=projectDedupEnabled, volumeModifyCompleted=volumeModifyCompleted, iscsiTargetError=iscsiTargetError, nvdimmFailInitializationError=nvdimmFailInitializationError, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunPoolName=lunPoolName, networkInterfaceDown=networkInterfaceDown, controllerUp=controllerUp, ipmiPowerSupply=ipmiPowerSupply, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, fcTargetStatus=fcTargetStatus, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareNFSWriteMbps=shareNFSWriteMbps, lunDataSizeLow=lunDataSizeLow, fcInitiatorName=fcInitiatorName, diskGoneOffline=diskGoneOffline, poolDataReadIops=poolDataReadIops, nicGroup=nicGroup, poolTotalWriteIops=poolTotalWriteIops, shareNFSEnabled=shareNFSEnabled, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareIndex=shareIndex, shareCompressionEnabled=shareCompressionEnabled, poolCount=poolCount, poolFreeSizeLow=poolFreeSizeLow, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolHealth=poolHealth, basicCompliance=basicCompliance, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolProjectCount=poolProjectCount, snmpServiceStarted=snmpServiceStarted, projectQuotaSizeLow=projectQuotaSizeLow, nicTable=nicTable, snapshotCloneCompleted=snapshotCloneCompleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, notificationReadingUnit=notificationReadingUnit, haControllerA_Name=haControllerA_Name, poolMetaReadLatency=poolMetaReadLatency, fcTotalWriteMbps=fcTotalWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, haResourceGroup=haResourceGroup, cacheRAMReads=cacheRAMReads, haControllerB_IPAddr=haControllerB_IPAddr, notificationDescription=notificationDescription, poolWriteCacheWriteIops=poolWriteCacheWriteIops, alertsCleanupCompleted=alertsCleanupCompleted, smbSocketFailure=smbSocketFailure, poolDataSizeHigh=poolDataSizeHigh, iscsiTotalWriteMbps=iscsiTotalWriteMbps, networkInterfaceUp=networkInterfaceUp, ipmiCurrent=ipmiCurrent, fcTotalWriteIops=fcTotalWriteIops, haResourceActiveNode=haResourceActiveNode, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectCompressionEnabled=projectCompressionEnabled, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareCIFSReadIops=shareCIFSReadIops, lunIndex=lunIndex, fcTargetsTable=fcTargetsTable, fcInitiators=fcInitiators, ipmiMemory=ipmiMemory, lunSnapshotSizeLow=lunSnapshotSizeLow, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskDataWriteMbps=diskDataWriteMbps, poolSizeLow=poolSizeLow, iscsiTargetsTable=iscsiTargetsTable, shareExceedThresholdWarning=shareExceedThresholdWarning, fcProperties=fcProperties, iscsiInitiators=iscsiInitiators, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunFreeSizeLow=lunFreeSizeLow, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolEntry=poolEntry, projectThresholdExceedWarning=projectThresholdExceedWarning, shareDataSizeLow=shareDataSizeLow, poolProjects=poolProjects, snapshotRollbackCompleted=snapshotRollbackCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcTargetIndex=fcTargetIndex, shareCIFSWriteLatency=shareCIFSWriteLatency, poolTotalWriteMbps=poolTotalWriteMbps, lunCompressionEnabled=lunCompressionEnabled, cacheSSDReads=cacheSSDReads, webdocsUpgradeCompleted=webdocsUpgradeCompleted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, upgradeDownloadFailed=upgradeDownloadFailed, iscsiTargets=iscsiTargets, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiTargetAlias=iscsiTargetAlias, shareQuotaLow=shareQuotaLow, lunReadMbps=lunReadMbps, disks=disks, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, upgradeStarted=upgradeStarted, controllerDown=controllerDown, fcTargets=fcTargets, nvdimmFailSoftError=nvdimmFailSoftError, lunWriteMbps=lunWriteMbps, diskIndex=diskIndex, iscsiInitiatorName=iscsiInitiatorName, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, iscsiTargetReadIops=iscsiTargetReadIops, projectLunCount=projectLunCount, ipmiThreshold=ipmiThreshold, notificationProps=notificationProps, projectEntry=projectEntry, notificationReadingTriggerValue=notificationReadingTriggerValue, cifsAvgWriteLatency=cifsAvgWriteLatency, diskType=diskType, notificationSeverity=notificationSeverity, diskTotalReadMbps=diskTotalReadMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, diskSlowIo=diskSlowIo, iscsiTotalReadMbps=iscsiTotalReadMbps, projectPoolName=projectPoolName, tegile=tegile, shareCompressedRatio=shareCompressedRatio, volumeQuotaFinished=volumeQuotaFinished, shareDataSizeHigh=shareDataSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, targetGroupDeleteCompleted=targetGroupDeleteCompleted, fcTargetModifyCompleted=fcTargetModifyCompleted, projectModified=projectModified, cacheTotalWriteIops=cacheTotalWriteIops, smisServiceStopFailed=smisServiceStopFailed, lunWriteIops=lunWriteIops, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcInitiatorEntry=fcInitiatorEntry, cifsTotalWriteIops=cifsTotalWriteIops, upgradeCompleted=upgradeCompleted, poolState=poolState, diskTable=diskTable, shareCIFSWriteIops=shareCIFSWriteIops, replicationResumed=replicationResumed, poolAvgReadLatency=poolAvgReadLatency, shareNFSReadMbps=shareNFSReadMbps)
mibBuilder.exportSymbols("TEGILE-MIB", poolDataWriteMbps=poolDataWriteMbps, poolMetaWriteMbps=poolMetaWriteMbps, notificationEventCode=notificationEventCode, shareDeletionFailed=shareDeletionFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, ipmiOther=ipmiOther, cifsTotalReadIops=cifsTotalReadIops, poolTable=poolTable, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, diskAvgWriteLatency=diskAvgWriteLatency, fcInitiatorsTable=fcInitiatorsTable, tdpsUpgradeCompleted=tdpsUpgradeCompleted, shareTable=shareTable, shareProjectName=shareProjectName, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolOwnerController=poolOwnerController, poolTotalSaving=poolTotalSaving, diskSequentialIOCount=diskSequentialIOCount, fcTotalReadMbps=fcTotalReadMbps, cacheTotalReadIops=cacheTotalReadIops, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, notificationSensorSuspect=notificationSensorSuspect, cpuSystemCalls=cpuSystemCalls, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, vmwareNFSDatastores=vmwareNFSDatastores, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diskAvgReadLatency=diskAvgReadLatency, projectDeleted=projectDeleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunReadLatency=lunReadLatency, networkTotalReceiveMbps=networkTotalReceiveMbps, nicState=nicState, lunSizeLow=lunSizeLow, iscsiInitiatorIndex=iscsiInitiatorIndex, maintenanceModeDisabled=maintenanceModeDisabled, fcTargetWriteIops=fcTargetWriteIops, cifsAvgReadLatency=cifsAvgReadLatency, diskSizeLow=diskSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps, snapshotCloningFailed=snapshotCloningFailed, poolReadCacheReadIops=poolReadCacheReadIops, diskDataReadMbps=diskDataReadMbps, projectTable=projectTable, nicMTU=nicMTU, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, fcInitiatorIndex=fcInitiatorIndex, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiWriteIops=iscsiWriteIops, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolDataReadMbps=poolDataReadMbps, poolMetaWriteIops=poolMetaWriteIops, lunBlockSize=lunBlockSize, volumeDeleteCompleted=volumeDeleteCompleted, haControllerA_IPAddr=haControllerA_IPAddr, replicationComplete=replicationComplete, nvdimmFailUnknownError=nvdimmFailUnknownError, projectQuotaFinished=projectQuotaFinished, targetGroupMemberRemoved=targetGroupMemberRemoved, haResourcesTable=haResourcesTable, nfsTotalReadIops=nfsTotalReadIops, iscsiTargetName=iscsiTargetName, projectFreeSizeLow=projectFreeSizeLow, haControllerA_Uptime=haControllerA_Uptime, iscsiTargetEntry=iscsiTargetEntry, poolExpanded=poolExpanded, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, replicationFailed=replicationFailed, poolDataReadLatency=poolDataReadLatency, shareQuotaFinished=shareQuotaFinished, diskIsOnline=diskIsOnline, projectDataSizeLow=projectDataSizeLow, replicationTargetDeleted=replicationTargetDeleted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskTotalWriteMbps=diskTotalWriteMbps, tegileGroups=tegileGroups, snapshotDeleteFailed=snapshotDeleteFailed, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, snapshotRollbackFailed=snapshotRollbackFailed, fcTargetEntry=fcTargetEntry, projectFreeSizeHigh=projectFreeSizeHigh, diskTotalReadIops=diskTotalReadIops, iscsiInitiatorEntry=iscsiInitiatorEntry, lunInitiatorGroup=lunInitiatorGroup, projectShares=projectShares, diskState=diskState, tdpsUpgradeTimeout=tdpsUpgradeTimeout, snmpServiceStartFailed=snmpServiceStartFailed, projectLUNs=projectLUNs, currentNotificationGroup=currentNotificationGroup, nicTransmitMbps=nicTransmitMbps, cacheTotalReadMbps=cacheTotalReadMbps, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, haControllerB_Uptime=haControllerB_Uptime, diskAlias=diskAlias, lunCompressedRatio=lunCompressedRatio, notificationObjects=notificationObjects, lunName=lunName, lunReadIops=lunReadIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunDataSizeHigh=lunDataSizeHigh, haControllerB_Name=haControllerB_Name, nfsTotalWriteIops=nfsTotalWriteIops, smisServiceStopped=smisServiceStopped, poolMetaReadIops=poolMetaReadIops, notificationSensorNumber=notificationSensorNumber, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, diskError=diskError, shareEntry=shareEntry, iscsiProperties=iscsiProperties, tegileArray=tegileArray, diskCount=diskCount, diskSizeHigh=diskSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectShareCount=projectShareCount, shareNFSReadLatency=shareNFSReadLatency, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, nfsTotalReadMbps=nfsTotalReadMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareReservedSizeHigh=shareReservedSizeHigh, controllerHardwareModel=controllerHardwareModel, haResourceEntry=haResourceEntry, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, globalStatistics=globalStatistics, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, diskTotalWriteIops=diskTotalWriteIops, poolReadCacheReadMbps=poolReadCacheReadMbps, PYSNMP_MODULE_ID=tegile, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareCIFSEnabled=shareCIFSEnabled, adServerTimeDrift=adServerTimeDrift, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiInitiatorsTable=iscsiInitiatorsTable, aclMigrationStarted=aclMigrationStarted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, networkIpmpGroupUp=networkIpmpGroupUp, poolName=poolName, replicationAbandoned=replicationAbandoned, poolQuotaFinished=poolQuotaFinished, nicEntry=nicEntry, iscsiInitiatorChapUser=iscsiInitiatorChapUser, sharePoolName=sharePoolName, ipmiFan=ipmiFan, fcPortOnline=fcPortOnline, ntpServerTimeDrift=ntpServerTimeDrift, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, network=network, poolDegraded=poolDegraded, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, properties=properties, projectTotalSaving=projectTotalSaving, diskIOCount=diskIOCount, smisServiceStarted=smisServiceStarted, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, ipmiTemperature=ipmiTemperature, currentObjectGroup=currentObjectGroup, testNotification=testNotification, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargetReadMbps=fcTargetReadMbps, lunEntry=lunEntry, maintenanceModeEnabled=maintenanceModeEnabled, ipmiCriticalInterrupt=ipmiCriticalInterrupt, cpuInterrupts=cpuInterrupts, diskPoolName=diskPoolName, cpuTotalUsage=cpuTotalUsage, nicReceiveMbps=nicReceiveMbps, poolFreeSizeHigh=poolFreeSizeHigh, diagnosticDataUploaded=diagnosticDataUploaded, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, snmpServiceStopped=snmpServiceStopped, shareCIFSWriteMbps=shareCIFSWriteMbps, shareReservedSizeLow=shareReservedSizeLow, poolReadCacheReadLatency=poolReadCacheReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, tdpsUpgradeFailed=tdpsUpgradeFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, tegileConformance=tegileConformance, volumeDeleteFailed=volumeDeleteFailed, lunProtocol=lunProtocol, userLoginFailed=userLoginFailed, poolDeleted=poolDeleted, memoryFailure=memoryFailure, fcAvgWriteLatency=fcAvgWriteLatency, projectCreatedSuccessfully=projectCreatedSuccessfully, poolReadCacheWriteLatency=poolReadCacheWriteLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetGroupError=iscsiTargetGroupError, poolUsedSizeLow=poolUsedSizeLow, poolReadCacheWriteMbps=poolReadCacheWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, replicationPaused=replicationPaused, snmpServiceStopFailed=snmpServiceStopFailed, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolCreated=poolCreated, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, fcTargetGroup=fcTargetGroup, haResourceName=haResourceName, shareDeleted=shareDeleted, diskDataReadIops=diskDataReadIops, upgradeTimeout=upgradeTimeout, volumeCreatedSuccessfully=volumeCreatedSuccessfully, fcTargetReadLatency=fcTargetReadLatency, upgradeFailed=upgradeFailed, iscsiTargetReadMbps=iscsiTargetReadMbps, poolImported=poolImported, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, nicIndex=nicIndex, poolMetaReadMbps=poolMetaReadMbps, projectName=projectName)
