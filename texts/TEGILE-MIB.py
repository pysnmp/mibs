...
TimeTicks, Counter32, Bits, enterprises, ModuleIdentity, MibIdentifier, Unsigned32, NotificationType, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Bits", "enterprises", "ModuleIdentity", "MibIdentifier", "Unsigned32", "NotificationType", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcInitiatorGroup=fcInitiatorGroup, controllerUp=controllerUp, fcPortOffline=fcPortOffline, notificationObjects=notificationObjects, shareCIFSReadLatency=shareCIFSReadLatency, poolDataSizeLow=poolDataSizeLow, projectFreeSizeLow=projectFreeSizeLow, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, diskTotalReadIops=diskTotalReadIops, poolMetaWriteMbps=poolMetaWriteMbps, lunBlockSize=lunBlockSize, poolReadCacheReadMbps=poolReadCacheReadMbps, networkIpmpGroupDown=networkIpmpGroupDown, tegile=tegile, notificationSensorAction=notificationSensorAction, poolExported=poolExported, controllerTimeDrift=controllerTimeDrift, iscsiTotalReadIops=iscsiTotalReadIops, sanProperties=sanProperties, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiTargetIndex=iscsiTargetIndex, notificationReadingUnit=notificationReadingUnit, cifsTotalWriteMbps=cifsTotalWriteMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, nicState=nicState, lunInitiatorGroup=lunInitiatorGroup, cpuInterrupts=cpuInterrupts, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiTargetWriteMbps=iscsiTargetWriteMbps, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, snapshotCloningFailed=snapshotCloningFailed, memoryFailure=memoryFailure, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolExpanded=poolExpanded, tegileConformance=tegileConformance, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunCompressedRatio=lunCompressedRatio, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, haResources=haResources, diskEntry=diskEntry, lunWriteIops=lunWriteIops, poolDataSizeHigh=poolDataSizeHigh, ipmiVoltage=ipmiVoltage, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, testNotification=testNotification, haControllerA_IPAddr=haControllerA_IPAddr, tegileArray=tegileArray, ipmiCurrent=ipmiCurrent, fcInitiatorEntry=fcInitiatorEntry, poolDegraded=poolDegraded, poolDataReadLatency=poolDataReadLatency, fcInitiatorsTable=fcInitiatorsTable, projectDataSizeHigh=projectDataSizeHigh, lunEntry=lunEntry, projectQuotaFinished=projectQuotaFinished, fcTargetStatus=fcTargetStatus, netbiosSocketFailure=netbiosSocketFailure, lunSizeLow=lunSizeLow, haControllerB_Name=haControllerB_Name, poolProjectCount=poolProjectCount, poolAvgReadLatency=poolAvgReadLatency, poolUsedSizeLow=poolUsedSizeLow, projectDeleted=projectDeleted, notificationTime=notificationTime, nicGroup=nicGroup, nfsTotalWriteIops=nfsTotalWriteIops, projectName=projectName, controllerDown=controllerDown, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, currentNotificationGroup=currentNotificationGroup, replicationComplete=replicationComplete, ipmiOther=ipmiOther, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolMetaReadIops=poolMetaReadIops, vmwareNFSDatastores=vmwareNFSDatastores, poolFreeSizeLow=poolFreeSizeLow, shareCIFSWriteIops=shareCIFSWriteIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, upgradeTimeout=upgradeTimeout, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, nfsTotalReadMbps=nfsTotalReadMbps, diskTotalWriteMbps=diskTotalWriteMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, projectDataSizeLow=projectDataSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, notificationReadingTriggerValue=notificationReadingTriggerValue, shareCreatedSuccessfully=shareCreatedSuccessfully, aclMigrationCompleted=aclMigrationCompleted, projectFreeSizeHigh=projectFreeSizeHigh, poolCreated=poolCreated, lunIndex=lunIndex, projectCompressionEnabled=projectCompressionEnabled, ipmiFan=ipmiFan, iscsiProperties=iscsiProperties, poolQuotaFinished=poolQuotaFinished, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, networkInterfaceUp=networkInterfaceUp, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolImported=poolImported, projectCreatedSuccessfully=projectCreatedSuccessfully, lunSnapshotSizeLow=lunSnapshotSizeLow, poolTotalSaving=poolTotalSaving, iscsiTargetReadMbps=iscsiTargetReadMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, projectShares=projectShares, iscsiTargetReadIops=iscsiTargetReadIops, diskTotalReadMbps=diskTotalReadMbps, tegileGroups=tegileGroups, shareCIFSEnabled=shareCIFSEnabled, shareCIFSWriteLatency=shareCIFSWriteLatency, projectDedupEnabled=projectDedupEnabled, projectTotalSaving=projectTotalSaving, poolState=poolState, lunReadLatency=lunReadLatency, projectTable=projectTable, shareCompressionEnabled=shareCompressionEnabled, cifsTotalReadIops=cifsTotalReadIops, ipmiPowerSupply=ipmiPowerSupply, lunWriteLatency=lunWriteLatency, shareNFSWriteLatency=shareNFSWriteLatency, poolDeletionFailed=poolDeletionFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolEntry=poolEntry, projectThresholdExceedWarning=projectThresholdExceedWarning, poolFreeSizeHigh=poolFreeSizeHigh, cacheTotalReadMbps=cacheTotalReadMbps, nicTable=nicTable, fcTargetReadMbps=fcTargetReadMbps, poolReadCacheReadIops=poolReadCacheReadIops, iscsiAvgReadLatency=iscsiAvgReadLatency, shareNFSReadMbps=shareNFSReadMbps, shareNFSEnabled=shareNFSEnabled, shareDataSizeLow=shareDataSizeLow, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, currentObjectGroup=currentObjectGroup, poolIndex=poolIndex, smisServiceStopped=smisServiceStopped, diskSizeLow=diskSizeLow, lunGUID=lunGUID, networkInterfaceDown=networkInterfaceDown, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, replicationAbandoned=replicationAbandoned, sensorFailureEvent=sensorFailureEvent, lunName=lunName, lunSizeHigh=lunSizeHigh, shareTable=shareTable, poolUpgraded=poolUpgraded, projectSnapshotSizeLow=projectSnapshotSizeLow, notificationDescription=notificationDescription, shareQuotaHigh=shareQuotaHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, shareReservedSizeHigh=shareReservedSizeHigh, haResourcesTable=haResourcesTable, projectIndex=projectIndex, lunProtocol=lunProtocol, tdpsUpgradeCompleted=tdpsUpgradeCompleted, deleteFolderCompleted=deleteFolderCompleted, diskRandomIOCount=diskRandomIOCount, poolTotalReadMbps=poolTotalReadMbps, alertsCleanupCompleted=alertsCleanupCompleted, targetGroupCreateCompleted=targetGroupCreateCompleted, diskTable=diskTable, tegileCompliances=tegileCompliances, deleteFolderFailed=deleteFolderFailed, volumeDeleteCompleted=volumeDeleteCompleted, notificationTargetEntityName=notificationTargetEntityName, notificationSeverity=notificationSeverity, nicEntry=nicEntry, replicationResumed=replicationResumed, iscsiInitiatorEntry=iscsiInitiatorEntry, notificationSensorSuspect=notificationSensorSuspect, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, diagnosticDataUploaded=diagnosticDataUploaded, cacheTotalWriteIops=cacheTotalWriteIops, diskDataReadIops=diskDataReadIops, shareNFSReadIops=shareNFSReadIops, cacheSSDReads=cacheSSDReads, nfsAvgWriteLatency=nfsAvgWriteLatency, cifsTotalWriteIops=cifsTotalWriteIops, replicationTargetDeleted=replicationTargetDeleted, lunCompressionEnabled=lunCompressionEnabled, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcTargetWriteIops=fcTargetWriteIops, diskType=diskType, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, poolTotalWriteMbps=poolTotalWriteMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diskSizeHigh=diskSizeHigh, poolReadCacheWriteIops=poolReadCacheWriteIops, targetGroupMemberRemoved=targetGroupMemberRemoved, lunTable=lunTable, basicCompliance=basicCompliance, webdocsUpgradeCompleted=webdocsUpgradeCompleted, fcTargetName=fcTargetName, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, diskIndex=diskIndex, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolMetaReadLatency=poolMetaReadLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, snmpServiceStopped=snmpServiceStopped, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, notificationEventCode=notificationEventCode, lunFreeSizeHigh=lunFreeSizeHigh, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, shareCompressedRatio=shareCompressedRatio, fcAvgReadLatency=fcAvgReadLatency, volumeDeleteFailed=volumeDeleteFailed, poolDataReadIops=poolDataReadIops, diskError=diskError, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, tdpsUpgradeTimeout=tdpsUpgradeTimeout, snmpServiceStarted=snmpServiceStarted, iscsiTotalReadMbps=iscsiTotalReadMbps, nicMTU=nicMTU, networkIpmpGroupUp=networkIpmpGroupUp, poolDataWriteIops=poolDataWriteIops, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, diskSlowIo=diskSlowIo, projectPoolName=projectPoolName, fcTotalReadIops=fcTotalReadIops, lunDataSizeLow=lunDataSizeLow, iscsiTargets=iscsiTargets, ntpServerTimeDrift=ntpServerTimeDrift, haResourceEntry=haResourceEntry, upgradeDownloadStarted=upgradeDownloadStarted, unknownSensorEvent=unknownSensorEvent, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, haResourceActiveNode=haResourceActiveNode, properties=properties, nvdimmFailSoftError=nvdimmFailSoftError, fcTargetsTable=fcTargetsTable, PYSNMP_MODULE_ID=tegile, poolTotalWriteIops=poolTotalWriteIops, shareNFSReadLatency=shareNFSReadLatency, lunDataSizeHigh=lunDataSizeHigh, fcTargetGroup=fcTargetGroup, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, spareDiskReplaced=spareDiskReplaced, diskAvgReadLatency=diskAvgReadLatency, targetGroupDeleteCompleted=targetGroupDeleteCompleted, replicationStarted=replicationStarted, diskSequentialIOCount=diskSequentialIOCount, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcAvgWriteLatency=fcAvgWriteLatency)
mibBuilder.exportSymbols("TEGILE-MIB", shareDeleted=shareDeleted, poolMetaReadMbps=poolMetaReadMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, lunProjectName=lunProjectName, lunReadMbps=lunReadMbps, shareCIFSReadIops=shareCIFSReadIops, iscsiTargetEntry=iscsiTargetEntry, projectModified=projectModified, iscsiTargetGroup=iscsiTargetGroup, lunReadIops=lunReadIops, fcTargetIndex=fcTargetIndex, fcInitiatorIndex=fcInitiatorIndex, upgradeStarted=upgradeStarted, diskGoneOffline=diskGoneOffline, poolSizeHigh=poolSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, fcTargetWriteLatency=fcTargetWriteLatency, cacheRAMReads=cacheRAMReads, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolHealth=poolHealth, diskDataWriteMbps=diskDataWriteMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskAlias=diskAlias, maintenanceModeDisabled=maintenanceModeDisabled, upgradeDownloadCompleted=upgradeDownloadCompleted, volumeModifyCompleted=volumeModifyCompleted, snmpAgentVersion=snmpAgentVersion, shareMountPoint=shareMountPoint, iscsiTargetName=iscsiTargetName, fcInitiatorName=fcInitiatorName, sharePoolName=sharePoolName, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolCount=poolCount, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, replicationSourceRegistered=replicationSourceRegistered, replicationAborted=replicationAborted, tegileArray_notifications=tegileArray_notifications, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, snmpServiceStopFailed=snmpServiceStopFailed, iscsiInitiators=iscsiInitiators, fcTargetModifyCompleted=fcTargetModifyCompleted, ipmiMemory=ipmiMemory, shareSnapshotSizeHigh=shareSnapshotSizeHigh, snapshotCloneCompleted=snapshotCloneCompleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiTargetError=iscsiTargetError, haControllerA_Uptime=haControllerA_Uptime, projectLUNs=projectLUNs, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiTargetGroupError=iscsiTargetGroupError, shareDedupEnabled=shareDedupEnabled, iscsiTargetAuth=iscsiTargetAuth, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, lunDedupEnabled=lunDedupEnabled, lunPoolName=lunPoolName, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, smisServiceStopFailed=smisServiceStopFailed, fcPortOnline=fcPortOnline, haControllerB_IPAddr=haControllerB_IPAddr, cifsAvgWriteLatency=cifsAvgWriteLatency, notifications=notifications, haResourceGroup=haResourceGroup, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiTotalWriteMbps=iscsiTotalWriteMbps, lunReservedSizeLow=lunReservedSizeLow, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunFreeSizeLow=lunFreeSizeLow, networkTotalTransmitMbps=networkTotalTransmitMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunReservedSizeHigh=lunReservedSizeHigh, poolSizeLow=poolSizeLow, snapshotDeleteFailed=snapshotDeleteFailed, projectLunCount=projectLunCount, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, maintenanceModeEnabled=maintenanceModeEnabled, diskDataReadMbps=diskDataReadMbps, poolDeleted=poolDeleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiInitiatorName=iscsiInitiatorName, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareNFSWriteIops=shareNFSWriteIops, upgradeCompleted=upgradeCompleted, snmpServiceStartFailed=snmpServiceStartFailed, poolName=poolName, ipmiThreshold=ipmiThreshold, fcTotalWriteMbps=fcTotalWriteMbps, diskDataWriteIops=diskDataWriteIops, projectQuotaSizeLow=projectQuotaSizeLow, shareQuotaLow=shareQuotaLow, notificationProps=notificationProps, haResourceName=haResourceName, cacheTotalReadIops=cacheTotalReadIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, nicName=nicName, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, upgradeDownloadFailed=upgradeDownloadFailed, shareQuotaFinished=shareQuotaFinished, fcTotalWriteIops=fcTotalWriteIops, notificationThresholdTriggerValue=notificationThresholdTriggerValue, ipmiTemperature=ipmiTemperature, poolTotalReadIops=poolTotalReadIops, shareEntry=shareEntry, nfsTotalWriteMbps=nfsTotalWriteMbps, shareCIFSReadMbps=shareCIFSReadMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, diskCount=diskCount, poolMetaWriteIops=poolMetaWriteIops, iscsiTargetWriteIops=iscsiTargetWriteIops, lunTargetGroup=lunTargetGroup, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, shareName=shareName, iscsiTargetsTable=iscsiTargetsTable, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiTargetAlias=iscsiTargetAlias, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcTargetEntry=fcTargetEntry, nicReceiveMbps=nicReceiveMbps, poolProjects=poolProjects, projectQuotaSizeHigh=projectQuotaSizeHigh, haResourceDescription=haResourceDescription, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, userLoginFailed=userLoginFailed, fcTargetReadLatency=fcTargetReadLatency, replicationFailed=replicationFailed, cifsAvgReadLatency=cifsAvgReadLatency, shareProjectName=shareProjectName, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, adServerTimeDrift=adServerTimeDrift, upgradeFailed=upgradeFailed, fcTargetWriteMbps=fcTargetWriteMbps, diskAvgWriteLatency=diskAvgWriteLatency, fcProperties=fcProperties, poolAvgWriteLatency=poolAvgWriteLatency, projectDeletionFailed=projectDeletionFailed, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, shareDeletionFailed=shareDeletionFailed, disks=disks, nfsTotalReadIops=nfsTotalReadIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, haResourceIndex=haResourceIndex, poolDataWriteMbps=poolDataWriteMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareIndex=shareIndex, shareNFSWriteMbps=shareNFSWriteMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, cacheTotalWriteMbps=cacheTotalWriteMbps, haControllerB_Uptime=haControllerB_Uptime, iscsiWriteIops=iscsiWriteIops, diskPoolName=diskPoolName, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, aclMigrationStarted=aclMigrationStarted, cpuTotalUsage=cpuTotalUsage, pools=pools, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareReservedSizeLow=shareReservedSizeLow, haControllerA_Name=haControllerA_Name, poolUsedSizeHigh=poolUsedSizeHigh, network=network, snapshotCreationFailed=snapshotCreationFailed, fcTargetReadIops=fcTargetReadIops, smisServiceStarted=smisServiceStarted, poolDataWriteLatency=poolDataWriteLatency, notificationComponentName=notificationComponentName, diskTotalWriteIops=diskTotalWriteIops, nicTransmitMbps=nicTransmitMbps, nicIndex=nicIndex, targetGroupMemberAdded=targetGroupMemberAdded, replicationPaused=replicationPaused, shareCIFSWriteMbps=shareCIFSWriteMbps, snapshotRollbackFailed=snapshotRollbackFailed, diskState=diskState, tdpsUpgradeFailed=tdpsUpgradeFailed, shareDataSizeHigh=shareDataSizeHigh, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, smisServiceStartFailed=smisServiceStartFailed, poolDataReadMbps=poolDataReadMbps, smbSocketFailure=smbSocketFailure, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareSnapshotSizeLow=shareSnapshotSizeLow, diskIsOnline=diskIsOnline, globalStatistics=globalStatistics, fcInitiators=fcInitiators, cifsTotalReadMbps=cifsTotalReadMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, haResourceStatus=haResourceStatus, poolMetaWriteLatency=poolMetaWriteLatency, fcTotalReadMbps=fcTotalReadMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, controllerHardwareModel=controllerHardwareModel, volumeQuotaFinished=volumeQuotaFinished, iscsiTargetReadLatency=iscsiTargetReadLatency, nvdimmFailInitializationError=nvdimmFailInitializationError, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolOwnerController=poolOwnerController, fcTargets=fcTargets, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, projectShareCount=projectShareCount, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskIOCount=diskIOCount, cpuSystemCalls=cpuSystemCalls, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunWriteMbps=lunWriteMbps, projectEntry=projectEntry, notificationSensorNumber=notificationSensorNumber, diskChassisIdx=diskChassisIdx, poolTable=poolTable, nfsAvgReadLatency=nfsAvgReadLatency)
