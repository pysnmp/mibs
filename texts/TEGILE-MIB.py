...
Counter64, ObjectIdentity, iso, enterprises, IpAddress, Gauge32, TimeTicks, ModuleIdentity, Counter32, NotificationType, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "iso", "enterprises", "IpAddress", "Gauge32", "TimeTicks", "ModuleIdentity", "Counter32", "NotificationType", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskTable=diskTable, shareReservedSizeLow=shareReservedSizeLow, fcTargets=fcTargets, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, iscsiTargetReadIops=iscsiTargetReadIops, projectQuotaFinished=projectQuotaFinished, fcTargetModifyCompleted=fcTargetModifyCompleted, shareQuotaFinished=shareQuotaFinished, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, poolTotalWriteMbps=poolTotalWriteMbps, diskState=diskState, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, nvdimmFailUnknownError=nvdimmFailUnknownError, lunIndex=lunIndex, currentObjectGroup=currentObjectGroup, fcInitiatorCreateFailed=fcInitiatorCreateFailed, cpuTotalUsage=cpuTotalUsage, shareQuotaHigh=shareQuotaHigh, poolTotalSaving=poolTotalSaving, shareDeleted=shareDeleted, cacheTotalReadIops=cacheTotalReadIops, fcTotalReadMbps=fcTotalReadMbps, replicationComplete=replicationComplete, diskRandomIOCount=diskRandomIOCount, poolTotalReadMbps=poolTotalReadMbps, iscsiTargetIndex=iscsiTargetIndex, diskTotalReadMbps=diskTotalReadMbps, haResourceEntry=haResourceEntry, poolTotalReadIops=poolTotalReadIops, cacheTotalWriteIops=cacheTotalWriteIops, disks=disks, notificationReadingTriggerValue=notificationReadingTriggerValue, poolCount=poolCount, fcTargetWriteLatency=fcTargetWriteLatency, nfsTotalWriteIops=nfsTotalWriteIops, smisServiceStartFailed=smisServiceStartFailed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolDeleted=poolDeleted, diskAlias=diskAlias, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareCIFSReadIops=shareCIFSReadIops, upgradeDownloadStarted=upgradeDownloadStarted, fcInitiators=fcInitiators, haResources=haResources, iscsiInitiatorGroup=iscsiInitiatorGroup, shareDedupEnabled=shareDedupEnabled, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareDataSizeHigh=shareDataSizeHigh, lunDataSizeHigh=lunDataSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolDataReadLatency=poolDataReadLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, nicState=nicState, memoryFailure=memoryFailure, projectSnapshotSizeLow=projectSnapshotSizeLow, deleteFolderCompleted=deleteFolderCompleted, replicationPaused=replicationPaused, projectDedupEnabled=projectDedupEnabled, lunName=lunName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunReservedSizeLow=lunReservedSizeLow, aclMigrationCompleted=aclMigrationCompleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiTotalWriteMbps=iscsiTotalWriteMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, ipmiVoltage=ipmiVoltage, haControllerA_Uptime=haControllerA_Uptime, alertsCleanupCompleted=alertsCleanupCompleted, networkIpmpGroupDown=networkIpmpGroupDown, poolMetaWriteMbps=poolMetaWriteMbps, adServerTimeDrift=adServerTimeDrift, notifications=notifications, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, basicCompliance=basicCompliance, tegileArray=tegileArray, notificationTargetEntityName=notificationTargetEntityName, poolCreated=poolCreated, nicGroup=nicGroup, controllerTimeDrift=controllerTimeDrift, projectCompressionEnabled=projectCompressionEnabled, cifsAvgWriteLatency=cifsAvgWriteLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, snapshotDeleteFailed=snapshotDeleteFailed, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolQuotaFinished=poolQuotaFinished, volumeDeleteFailed=volumeDeleteFailed, iscsiTargetReadLatency=iscsiTargetReadLatency, diskSlowIo=diskSlowIo, iscsiTargetReadMbps=iscsiTargetReadMbps, unknownSensorEvent=unknownSensorEvent, intelliFlashSoftwareUp=intelliFlashSoftwareUp, networkTotalReceiveMbps=networkTotalReceiveMbps, volumeModifyCompleted=volumeModifyCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, tegileGroups=tegileGroups, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiTargetAlias=iscsiTargetAlias, diskSizeLow=diskSizeLow, userLoginFailed=userLoginFailed, haControllerA_IPAddr=haControllerA_IPAddr, properties=properties, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, fcTargetStatus=fcTargetStatus, fcInitiatorGroup=fcInitiatorGroup, nicTable=nicTable, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcTotalWriteMbps=fcTotalWriteMbps, controllerHardwareModel=controllerHardwareModel, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, replicationFailed=replicationFailed, notificationEventCode=notificationEventCode, shareNFSWriteLatency=shareNFSWriteLatency, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, haControllerB_Name=haControllerB_Name, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectTable=projectTable, lunReadMbps=lunReadMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, cifsTotalReadMbps=cifsTotalReadMbps, lunCompressedRatio=lunCompressedRatio, fcInitiatorsTable=fcInitiatorsTable, replicationResumed=replicationResumed, shareQuotaLow=shareQuotaLow, ipmiTemperature=ipmiTemperature, snapshotCreationFailed=snapshotCreationFailed, notificationProps=notificationProps, fcInitiatorIndex=fcInitiatorIndex, iscsiTargetEntry=iscsiTargetEntry, poolName=poolName, iscsiTargetAuth=iscsiTargetAuth, pools=pools, nicName=nicName, webdocsUpgradeFailed=webdocsUpgradeFailed, fcAvgWriteLatency=fcAvgWriteLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, haControllerB_Uptime=haControllerB_Uptime, shareNFSReadMbps=shareNFSReadMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunWriteLatency=lunWriteLatency, shareNFSReadIops=shareNFSReadIops, poolMetaWriteIops=poolMetaWriteIops, projectEntry=projectEntry, lunDedupEnabled=lunDedupEnabled, haResourceName=haResourceName, fcTargetIndex=fcTargetIndex, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, networkInterfaceDown=networkInterfaceDown, lunTargetGroup=lunTargetGroup, shareSnapshotSizeLow=shareSnapshotSizeLow, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, projectFreeSizeLow=projectFreeSizeLow, poolUsedSizeHigh=poolUsedSizeHigh, globalStatistics=globalStatistics, projectQuotaSizeLow=projectQuotaSizeLow, poolMetaReadIops=poolMetaReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, fcTotalReadIops=fcTotalReadIops, fcTargetReadIops=fcTargetReadIops, shareCIFSEnabled=shareCIFSEnabled, nfsTotalReadIops=nfsTotalReadIops, lunReadIops=lunReadIops, poolState=poolState, lunGUID=lunGUID, webdocsUpgradeCompleted=webdocsUpgradeCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, snapshotCloningFailed=snapshotCloningFailed, diskPoolName=diskPoolName, diskCount=diskCount, lunSizeHigh=lunSizeHigh, projectName=projectName, maintenanceModeEnabled=maintenanceModeEnabled, poolDeletionFailed=poolDeletionFailed, shareNFSWriteMbps=shareNFSWriteMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectDeletionFailed=projectDeletionFailed, tegileConformance=tegileConformance, poolUsedSizeLow=poolUsedSizeLow, vmwareNFSDatastores=vmwareNFSDatastores, notificationSensorSuspect=notificationSensorSuspect, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiTargetGroup=iscsiTargetGroup, poolReadCacheReadIops=poolReadCacheReadIops, fcTargetsTable=fcTargetsTable, lunEntry=lunEntry, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, snmpServiceStarted=snmpServiceStarted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, ipmiPowerSupply=ipmiPowerSupply, iscsiTotalReadIops=iscsiTotalReadIops, lunProtocol=lunProtocol, nfsTotalReadMbps=nfsTotalReadMbps, cpuSystemCalls=cpuSystemCalls, lunCompressionEnabled=lunCompressionEnabled, fcAvgReadLatency=fcAvgReadLatency, notificationReadingUnit=notificationReadingUnit, shareCIFSReadLatency=shareCIFSReadLatency, poolSizeLow=poolSizeLow, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, shareExceedThresholdWarning=shareExceedThresholdWarning, upgradeFailed=upgradeFailed, lunProjectName=lunProjectName, sanProperties=sanProperties, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectFreeSizeHigh=projectFreeSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, controllerUp=controllerUp, smisServiceStopped=smisServiceStopped, smisServiceStarted=smisServiceStarted, lunSnapshotSizeLow=lunSnapshotSizeLow, poolImported=poolImported, fcPortOffline=fcPortOffline, lunWriteMbps=lunWriteMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, haResourceGroup=haResourceGroup, nvdimmFailSoftError=nvdimmFailSoftError, projectDataSizeHigh=projectDataSizeHigh, notificationObjects=notificationObjects, volumeDeleteCompleted=volumeDeleteCompleted, poolTotalWriteIops=poolTotalWriteIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, ipmiFan=ipmiFan, projectDataSizeLow=projectDataSizeLow, poolEntry=poolEntry, snmpAgentVersion=snmpAgentVersion, poolProjects=poolProjects, upgradeTimeout=upgradeTimeout, lunReadLatency=lunReadLatency, diskDataWriteIops=diskDataWriteIops, haResourceActiveNode=haResourceActiveNode, shareCIFSWriteIops=shareCIFSWriteIops, fcInitiatorName=fcInitiatorName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunSizeLow=lunSizeLow, poolDegraded=poolDegraded, lunBlockSize=lunBlockSize, aclMigrationStarted=aclMigrationStarted, snapshotRollbackFailed=snapshotRollbackFailed, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, fcProperties=fcProperties, fcTargetReadLatency=fcTargetReadLatency, diskType=diskType, networkInterfaceUp=networkInterfaceUp, poolAvgWriteLatency=poolAvgWriteLatency, targetGroupMemberAdded=targetGroupMemberAdded)
mibBuilder.exportSymbols("TEGILE-MIB", upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, currentNotificationGroup=currentNotificationGroup, poolDataWriteMbps=poolDataWriteMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareIndex=shareIndex, poolTable=poolTable, shareCIFSWriteLatency=shareCIFSWriteLatency, shareNFSWriteIops=shareNFSWriteIops, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, shareCreatedSuccessfully=shareCreatedSuccessfully, network=network, snmpServiceStopFailed=snmpServiceStopFailed, haControllerA_Name=haControllerA_Name, fcInitiatorEntry=fcInitiatorEntry, iscsiTargetWriteLatency=iscsiTargetWriteLatency, tegile=tegile, haResourcesTable=haResourcesTable, diagnosticDataUploaded=diagnosticDataUploaded, diskTotalReadIops=diskTotalReadIops, ipmiThreshold=ipmiThreshold, upgradeCompleted=upgradeCompleted, shareEntry=shareEntry, shareDataSizeLow=shareDataSizeLow, poolDataReadIops=poolDataReadIops, iscsiInitiatorIndex=iscsiInitiatorIndex, PYSNMP_MODULE_ID=tegile, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectLUNs=projectLUNs, iscsiInitiatorChapUser=iscsiInitiatorChapUser, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, poolDataReadMbps=poolDataReadMbps, ntpServerTimeDrift=ntpServerTimeDrift, iscsiTargetWriteMbps=iscsiTargetWriteMbps, shareNFSReadLatency=shareNFSReadLatency, deleteFolderFailed=deleteFolderFailed, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, notificationDescription=notificationDescription, iscsiInitiatorsTable=iscsiInitiatorsTable, cacheSSDReads=cacheSSDReads, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, cacheTotalReadMbps=cacheTotalReadMbps, diskChassisIdx=diskChassisIdx, diskAvgWriteLatency=diskAvgWriteLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, cifsAvgReadLatency=cifsAvgReadLatency, shareCompressedRatio=shareCompressedRatio, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, spareDiskReplaced=spareDiskReplaced, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, diskDataReadIops=diskDataReadIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectIndex=projectIndex, projectCreatedSuccessfully=projectCreatedSuccessfully, maintenanceModeDisabled=maintenanceModeDisabled, poolProjectCount=poolProjectCount, fcTargetWriteIops=fcTargetWriteIops, diskAvgReadLatency=diskAvgReadLatency, fcTargetName=fcTargetName, replicationTargetDeleted=replicationTargetDeleted, ipmiMemory=ipmiMemory, diskIsOnline=diskIsOnline, shareCompressionEnabled=shareCompressionEnabled, iscsiProperties=iscsiProperties, cifsTotalWriteMbps=cifsTotalWriteMbps, shareName=shareName, diskDataWriteMbps=diskDataWriteMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiAvgReadLatency=iscsiAvgReadLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunWriteIops=lunWriteIops, projectTotalSaving=projectTotalSaving, replicationAbandoned=replicationAbandoned, initiatorGroupMemberAdded=initiatorGroupMemberAdded, networkIpmpGroupUp=networkIpmpGroupUp, notificationComponentName=notificationComponentName, lunFreeSizeHigh=lunFreeSizeHigh, iscsiInitiators=iscsiInitiators, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, cacheRAMReads=cacheRAMReads, snapshotRollbackCompleted=snapshotRollbackCompleted, lunPoolName=lunPoolName, iscsiTotalReadMbps=iscsiTotalReadMbps, snmpServiceStopped=snmpServiceStopped, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, notificationTime=notificationTime, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, cacheTotalWriteMbps=cacheTotalWriteMbps, diskIOCount=diskIOCount, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, lunReservedSizeHigh=lunReservedSizeHigh, ipmiCurrent=ipmiCurrent, diskTotalWriteIops=diskTotalWriteIops, nicMTU=nicMTU, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolOwnerController=poolOwnerController, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, haResourceStatus=haResourceStatus, diskError=diskError, fcPortOnline=fcPortOnline, poolDataSizeHigh=poolDataSizeHigh, notificationSensorAction=notificationSensorAction, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareProjectName=shareProjectName, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectPoolName=projectPoolName, projectShares=projectShares, iscsiTargetName=iscsiTargetName, projectDeleted=projectDeleted, replicationStarted=replicationStarted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskSequentialIOCount=diskSequentialIOCount, diskTotalWriteMbps=diskTotalWriteMbps, projectModified=projectModified, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolDataWriteLatency=poolDataWriteLatency, replicationAborted=replicationAborted, haResourceIndex=haResourceIndex, shareReservedSizeHigh=shareReservedSizeHigh, poolReadCacheWriteIops=poolReadCacheWriteIops, sharePoolName=sharePoolName, netbiosSocketFailure=netbiosSocketFailure, nicEntry=nicEntry, targetGroupDeleteCompleted=targetGroupDeleteCompleted, nicReceiveMbps=nicReceiveMbps, projectLunCount=projectLunCount, snapshotCloneCompleted=snapshotCloneCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, sensorFailureEvent=sensorFailureEvent, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareTable=shareTable, poolExpanded=poolExpanded, diskDataReadMbps=diskDataReadMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareMountPoint=shareMountPoint, replicationSourceRegistered=replicationSourceRegistered, tegileArray_notifications=tegileArray_notifications, poolMetaWriteLatency=poolMetaWriteLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, projectShareCount=projectShareCount, poolFreeSizeLow=poolFreeSizeLow, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiTargets=iscsiTargets, nicIndex=nicIndex, smbSocketFailure=smbSocketFailure, lunFreeSizeLow=lunFreeSizeLow, testNotification=testNotification, networkTotalTransmitMbps=networkTotalTransmitMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, cifsTotalReadIops=cifsTotalReadIops, nfsAvgWriteLatency=nfsAvgWriteLatency, notificationSensorNumber=notificationSensorNumber, iscsiInitiatorName=iscsiInitiatorName, projectThresholdExceedWarning=projectThresholdExceedWarning, poolReadCacheWriteMbps=poolReadCacheWriteMbps, upgradeDownloadFailed=upgradeDownloadFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, tegileCompliances=tegileCompliances, diskSizeHigh=diskSizeHigh, diskIndex=diskIndex, cpuInterrupts=cpuInterrupts, snmpServiceStartFailed=snmpServiceStartFailed, volumeQuotaFinished=volumeQuotaFinished, iscsiTargetsTable=iscsiTargetsTable, smisServiceStopFailed=smisServiceStopFailed, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolFreeSizeHigh=poolFreeSizeHigh, cifsTotalWriteIops=cifsTotalWriteIops, controllerDown=controllerDown, poolExported=poolExported, poolAvgReadLatency=poolAvgReadLatency, haControllerB_IPAddr=haControllerB_IPAddr, lunInitiatorGroup=lunInitiatorGroup, iscsiWriteIops=iscsiWriteIops, poolMetaReadLatency=poolMetaReadLatency, fcTargetEntry=fcTargetEntry, fcTargetGroup=fcTargetGroup, lunTable=lunTable, poolUpgraded=poolUpgraded, fcTargetReadMbps=fcTargetReadMbps, diskGoneOffline=diskGoneOffline, upgradeStarted=upgradeStarted, nvdimmFailInitializationError=nvdimmFailInitializationError, poolDataWriteIops=poolDataWriteIops, poolMetaReadMbps=poolMetaReadMbps, shareNFSEnabled=shareNFSEnabled, poolDataSizeLow=poolDataSizeLow, haResourceDescription=haResourceDescription, poolHealth=poolHealth, ipmiOther=ipmiOther, diskEntry=diskEntry, nfsAvgReadLatency=nfsAvgReadLatency, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTotalWriteIops=fcTotalWriteIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolIndex=poolIndex, iscsiTargetGroupError=iscsiTargetGroupError, shareDeletionFailed=shareDeletionFailed, iscsiTargetError=iscsiTargetError, nicTransmitMbps=nicTransmitMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunDataSizeLow=lunDataSizeLow, poolSizeHigh=poolSizeHigh, notificationSeverity=notificationSeverity)
