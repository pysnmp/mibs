...
# Produced by pysmi-1.1.8 at Mon Jan 16 15:42:02 2023
...
Bits, Counter64, TimeTicks, iso, ObjectIdentity, enterprises, Gauge32, MibIdentifier, IpAddress, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "TimeTicks", "iso", "ObjectIdentity", "enterprises", "Gauge32", "MibIdentifier", "IpAddress", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcPortOnline=fcPortOnline, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunWriteIops=lunWriteIops, nicTable=nicTable, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolTotalWriteMbps=poolTotalWriteMbps, shareDataSizeHigh=shareDataSizeHigh, fcTargetStatus=fcTargetStatus, diskError=diskError, shareExceedThresholdWarning=shareExceedThresholdWarning, haResourcesTable=haResourcesTable, upgradeDownloadCompleted=upgradeDownloadCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, haResourceGroup=haResourceGroup, poolMetaReadMbps=poolMetaReadMbps, smisServiceStarted=smisServiceStarted, projectLunCount=projectLunCount, iscsiInitiatorsTable=iscsiInitiatorsTable, replicationComplete=replicationComplete, shareReservedSizeLow=shareReservedSizeLow, notificationEventCode=notificationEventCode, poolHealth=poolHealth, shareSnapshotSizeLow=shareSnapshotSizeLow, lunTable=lunTable, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, upgradeFailed=upgradeFailed, lunGUID=lunGUID, properties=properties, smbSocketFailure=smbSocketFailure, poolAvgReadLatency=poolAvgReadLatency, shareCompressedRatio=shareCompressedRatio, network=network, globalStatistics=globalStatistics, sanProperties=sanProperties, poolCount=poolCount, diskTotalReadMbps=diskTotalReadMbps, replicationFailed=replicationFailed, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, tdpsUpgradeTimeout=tdpsUpgradeTimeout, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, PYSNMP_MODULE_ID=tegile, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, lunSizeHigh=lunSizeHigh, tegile=tegile, projectQuotaFinished=projectQuotaFinished, deleteFolderCompleted=deleteFolderCompleted, shareNFSReadIops=shareNFSReadIops, lunName=lunName, projectQuotaSizeHigh=projectQuotaSizeHigh, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectShareCount=projectShareCount, fcInitiatorCreateFailed=fcInitiatorCreateFailed, shareNFSWriteMbps=shareNFSWriteMbps, haResourceActiveNode=haResourceActiveNode, poolProjects=poolProjects, alertsCleanupCompleted=alertsCleanupCompleted, lunIndex=lunIndex, fcAvgReadLatency=fcAvgReadLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareDeletionFailed=shareDeletionFailed, shareProjectName=shareProjectName, replicationResumed=replicationResumed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, haControllerB_IPAddr=haControllerB_IPAddr, fcInitiatorsTable=fcInitiatorsTable, shareCompressionEnabled=shareCompressionEnabled, snmpServiceStopFailed=snmpServiceStopFailed, iscsiTargetWriteMbps=iscsiTargetWriteMbps, disks=disks, upgradeDownloadFailed=upgradeDownloadFailed, nvdimmFailDeviceError=nvdimmFailDeviceError, notificationSeverity=notificationSeverity, poolQuotaFinished=poolQuotaFinished, ipmiOther=ipmiOther, diskCount=diskCount, iscsiTargetWriteIops=iscsiTargetWriteIops, shareCIFSReadIops=shareCIFSReadIops, fcTargetWriteMbps=fcTargetWriteMbps, diskIOCount=diskIOCount, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, iscsiInitiatorChapUser=iscsiInitiatorChapUser, haResourceName=haResourceName, projectEntry=projectEntry, snmpServiceStopped=snmpServiceStopped, volumeDeleteCompleted=volumeDeleteCompleted, lunWriteMbps=lunWriteMbps, iscsiTargetIndex=iscsiTargetIndex, poolMetaReadLatency=poolMetaReadLatency, lunReservedSizeHigh=lunReservedSizeHigh, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolState=poolState, diskTotalWriteMbps=diskTotalWriteMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectDataSizeLow=projectDataSizeLow, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, cacheTotalWriteMbps=cacheTotalWriteMbps, fcTargetIndex=fcTargetIndex, ipmiVoltage=ipmiVoltage, lunProtocol=lunProtocol, lunCompressionEnabled=lunCompressionEnabled, networkInterfaceUp=networkInterfaceUp, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, ipmiThreshold=ipmiThreshold, lunDedupEnabled=lunDedupEnabled, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareMountPoint=shareMountPoint, diskTotalReadIops=diskTotalReadIops, projectShares=projectShares, networkTotalTransmitMbps=networkTotalTransmitMbps, fcInitiatorIndex=fcInitiatorIndex, iscsiWriteIops=iscsiWriteIops, projectTotalSaving=projectTotalSaving, iscsiInitiatorEntry=iscsiInitiatorEntry, poolDegraded=poolDegraded, upgradeStarted=upgradeStarted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcPortOffline=fcPortOffline, poolEntry=poolEntry, diskDataWriteMbps=diskDataWriteMbps, cifsTotalReadIops=cifsTotalReadIops, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, currentObjectGroup=currentObjectGroup, cifsTotalWriteMbps=cifsTotalWriteMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskPoolName=diskPoolName, poolReadCacheWriteMbps=poolReadCacheWriteMbps, cpuInterrupts=cpuInterrupts, shareQuotaHigh=shareQuotaHigh, shareNFSEnabled=shareNFSEnabled, lunFreeSizeHigh=lunFreeSizeHigh, iscsiTargetGroupError=iscsiTargetGroupError, replicationPaused=replicationPaused, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskSizeHigh=diskSizeHigh, poolCreated=poolCreated, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectDataSizeHigh=projectDataSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolTotalSaving=poolTotalSaving, sharePoolName=sharePoolName, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, diagnosticDataUploaded=diagnosticDataUploaded, iscsiInitiatorName=iscsiInitiatorName, projectCreatedSuccessfully=projectCreatedSuccessfully, shareDedupEnabled=shareDedupEnabled, lunEntry=lunEntry, lunDataSizeHigh=lunDataSizeHigh, poolExported=poolExported, tegileArray_notifications=tegileArray_notifications, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolUsedSizeLow=poolUsedSizeLow, diskAvgReadLatency=diskAvgReadLatency, nicEntry=nicEntry, diskRandomIOCount=diskRandomIOCount, diskAvgWriteLatency=diskAvgWriteLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTargetName=iscsiTargetName, tegileConformance=tegileConformance, iscsiTargetAuth=iscsiTargetAuth, volumeModifyCompleted=volumeModifyCompleted, lunDataSizeLow=lunDataSizeLow, cifsAvgReadLatency=cifsAvgReadLatency, projectQuotaSizeLow=projectQuotaSizeLow, cifsTotalReadMbps=cifsTotalReadMbps, shareNFSWriteLatency=shareNFSWriteLatency, fcTotalReadMbps=fcTotalReadMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, upgradeDownloadStarted=upgradeDownloadStarted, diskEntry=diskEntry, cacheRAMReads=cacheRAMReads, poolName=poolName, iscsiTargetReadLatency=iscsiTargetReadLatency, webdocsUpgradeCompleted=webdocsUpgradeCompleted, lunSizeLow=lunSizeLow, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskSizeLow=diskSizeLow, poolTotalWriteIops=poolTotalWriteIops, shareCIFSWriteMbps=shareCIFSWriteMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiTargetAlias=iscsiTargetAlias, poolSizeHigh=poolSizeHigh, lunWriteLatency=lunWriteLatency, replicationAborted=replicationAborted, notificationSensorNumber=notificationSensorNumber, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, nicReceiveMbps=nicReceiveMbps, upgradeTimeout=upgradeTimeout, haControllerB_Name=haControllerB_Name, ntpServerTimeDrift=ntpServerTimeDrift, fcTargetWriteLatency=fcTargetWriteLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcTotalWriteIops=fcTotalWriteIops, iscsiTargetReadMbps=iscsiTargetReadMbps, nicState=nicState, shareCIFSWriteIops=shareCIFSWriteIops, tdpsUpgradeFailed=tdpsUpgradeFailed, lunInitiatorGroup=lunInitiatorGroup, notifications=notifications, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolFreeSizeLow=poolFreeSizeLow, lunTargetGroup=lunTargetGroup, ipmiPowerSupply=ipmiPowerSupply, poolMetaWriteIops=poolMetaWriteIops, shareCIFSEnabled=shareCIFSEnabled, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareNFSWriteIops=shareNFSWriteIops, fcTotalWriteMbps=fcTotalWriteMbps, spareDiskReplaced=spareDiskReplaced, smisServiceStopFailed=smisServiceStopFailed, poolDeletionFailed=poolDeletionFailed, haResourceDescription=haResourceDescription, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolDataReadMbps=poolDataReadMbps, poolProjectCount=poolProjectCount, diskIsOnline=diskIsOnline, cpuSystemCalls=cpuSystemCalls, cacheTotalReadMbps=cacheTotalReadMbps, nicGroup=nicGroup, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolReadCacheReadLatency=poolReadCacheReadLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, projectDeleted=projectDeleted, poolIndex=poolIndex, notificationSensorAction=notificationSensorAction, controllerDown=controllerDown, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, cacheTotalReadIops=cacheTotalReadIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, diskGoneOffline=diskGoneOffline, lunReservedSizeLow=lunReservedSizeLow, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiInitiatorGroup=iscsiInitiatorGroup, lunReadMbps=lunReadMbps, lunFreeSizeLow=lunFreeSizeLow, fcTargets=fcTargets, cacheSSDReads=cacheSSDReads, poolDataReadIops=poolDataReadIops, lunBlockSize=lunBlockSize, iscsiTotalReadMbps=iscsiTotalReadMbps, sensorFailureEvent=sensorFailureEvent, nfsAvgWriteLatency=nfsAvgWriteLatency, projectName=projectName)
mibBuilder.exportSymbols("TEGILE-MIB", shareTable=shareTable, nicIndex=nicIndex, iscsiInitiators=iscsiInitiators, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, snmpServiceStarted=snmpServiceStarted, nfsTotalReadIops=nfsTotalReadIops, haControllerA_Name=haControllerA_Name, replicationAbandoned=replicationAbandoned, nfsAvgReadLatency=nfsAvgReadLatency, poolTable=poolTable, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareCIFSReadLatency=shareCIFSReadLatency, diskTable=diskTable, iscsiImproperTargetGroup=iscsiImproperTargetGroup, notificationComponentName=notificationComponentName, nvdimmFailSoftError=nvdimmFailSoftError, iscsiProperties=iscsiProperties, fcInitiatorGroup=fcInitiatorGroup, notificationThresholdTriggerValue=notificationThresholdTriggerValue, volumeDeleteFailed=volumeDeleteFailed, volumeQuotaFinished=volumeQuotaFinished, tegileGroups=tegileGroups, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolFreeSizeHigh=poolFreeSizeHigh, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, userLoginFailed=userLoginFailed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, nfsTotalWriteIops=nfsTotalWriteIops, controllerUp=controllerUp, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcInitiatorEntry=fcInitiatorEntry, projectSnapshotSizeLow=projectSnapshotSizeLow, notificationReadingTriggerValue=notificationReadingTriggerValue, diskDataWriteIops=diskDataWriteIops, lunProjectName=lunProjectName, notificationDescription=notificationDescription, diskSequentialIOCount=diskSequentialIOCount, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargetReadIops=iscsiTargetReadIops, nvdimmFailInitializationError=nvdimmFailInitializationError, cacheTotalWriteIops=cacheTotalWriteIops, poolOwnerController=poolOwnerController, fcAvgWriteLatency=fcAvgWriteLatency, upgradeCompleted=upgradeCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, haResourceEntry=haResourceEntry, poolTotalReadMbps=poolTotalReadMbps, networkInterfaceDown=networkInterfaceDown, haControllerA_IPAddr=haControllerA_IPAddr, poolWriteCacheWriteIops=poolWriteCacheWriteIops, projectTable=projectTable, shareNFSReadMbps=shareNFSReadMbps, snapshotCloningFailed=snapshotCloningFailed, shareNFSReadLatency=shareNFSReadLatency, vmwareNFSDatastores=vmwareNFSDatastores, lunReadLatency=lunReadLatency, haResourceStatus=haResourceStatus, shareDataSizeLow=shareDataSizeLow, deleteFolderFailed=deleteFolderFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcProperties=fcProperties, fcInitiatorName=fcInitiatorName, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, nicName=nicName, tegileCompliances=tegileCompliances, fcTargetReadIops=fcTargetReadIops, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolDataWriteMbps=poolDataWriteMbps, snmpAgentVersion=snmpAgentVersion, diskChassisIdx=diskChassisIdx, adServerTimeDrift=adServerTimeDrift, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectDeletionFailed=projectDeletionFailed, controllerHardwareModel=controllerHardwareModel, fcTotalReadIops=fcTotalReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, snapshotRollbackFailed=snapshotRollbackFailed, ipmiFan=ipmiFan, diskSlowIo=diskSlowIo, shareCIFSWriteLatency=shareCIFSWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, pools=pools, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunReadIops=lunReadIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, replicationSourceRegistered=replicationSourceRegistered, targetGroupMemberAdded=targetGroupMemberAdded, snapshotCreationFailed=snapshotCreationFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareCreatedSuccessfully=shareCreatedSuccessfully, iscsiTargetEntry=iscsiTargetEntry, webdocsUpgradeFailed=webdocsUpgradeFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, currentNotificationGroup=currentNotificationGroup, shareQuotaLow=shareQuotaLow, fcTargetModifyCompleted=fcTargetModifyCompleted, cpuTotalUsage=cpuTotalUsage, projectFreeSizeHigh=projectFreeSizeHigh, snmpServiceStartFailed=snmpServiceStartFailed, diskDataReadIops=diskDataReadIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, nfsTotalWriteMbps=nfsTotalWriteMbps, shareIndex=shareIndex, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, maintenanceModeDisabled=maintenanceModeDisabled, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskState=diskState, haControllerA_Uptime=haControllerA_Uptime, poolDataSizeHigh=poolDataSizeHigh, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, networkIpmpGroupUp=networkIpmpGroupUp, poolDataWriteIops=poolDataWriteIops, netbiosSocketFailure=netbiosSocketFailure, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, haResourceIndex=haResourceIndex, tegileArray=tegileArray, poolMetaWriteMbps=poolMetaWriteMbps, iscsiTargetsTable=iscsiTargetsTable, poolReadCacheReadIops=poolReadCacheReadIops, haResources=haResources, controllerTimeDrift=controllerTimeDrift, snapshotCloneCompleted=snapshotCloneCompleted, maintenanceModeEnabled=maintenanceModeEnabled, diskIndex=diskIndex, nfsTotalReadMbps=nfsTotalReadMbps, poolMetaWriteLatency=poolMetaWriteLatency, notificationObjects=notificationObjects, fcTargetReadLatency=fcTargetReadLatency, cifsTotalWriteIops=cifsTotalWriteIops, smisServiceStartFailed=smisServiceStartFailed, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolImported=poolImported, unknownSensorEvent=unknownSensorEvent, nicTransmitMbps=nicTransmitMbps, poolDeleted=poolDeleted, snapshotDeleteFailed=snapshotDeleteFailed, projectFreeSizeLow=projectFreeSizeLow, shareName=shareName, iscsiTotalReadIops=iscsiTotalReadIops, poolDataWriteLatency=poolDataWriteLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolDataReadLatency=poolDataReadLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, notificationTargetEntityName=notificationTargetEntityName, iscsiTargetGroup=iscsiTargetGroup, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, shareEntry=shareEntry, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, notificationProps=notificationProps, fcTargetWriteIops=fcTargetWriteIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareQuotaFinished=shareQuotaFinished, targetGroupDeleteCompleted=targetGroupDeleteCompleted, haControllerB_Uptime=haControllerB_Uptime, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectPoolName=projectPoolName, replicationTargetDeleted=replicationTargetDeleted, fcTargetsTable=fcTargetsTable, notificationSensorSuspect=notificationSensorSuspect, testNotification=testNotification, snapshotRollbackCompleted=snapshotRollbackCompleted, memoryFailure=memoryFailure, iscsiInitiatorIndex=iscsiInitiatorIndex, smisServiceStopped=smisServiceStopped, projectCompressionEnabled=projectCompressionEnabled, targetGroupMemberRemoved=targetGroupMemberRemoved, replicationStarted=replicationStarted, iscsiTargets=iscsiTargets, networkIpmpGroupDown=networkIpmpGroupDown, diskAlias=diskAlias, volumeCreatedSuccessfully=volumeCreatedSuccessfully, ipmiTemperature=ipmiTemperature, notificationTime=notificationTime, ipmiMemory=ipmiMemory, basicCompliance=basicCompliance, poolAvgWriteLatency=poolAvgWriteLatency, shareReservedSizeHigh=shareReservedSizeHigh, projectDedupEnabled=projectDedupEnabled, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, lunSnapshotSizeLow=lunSnapshotSizeLow, poolExpanded=poolExpanded, nicMTU=nicMTU, ipmiCurrent=ipmiCurrent, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolUpgraded=poolUpgraded, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolSizeLow=poolSizeLow, poolUsedSizeHigh=poolUsedSizeHigh, iscsiTargetError=iscsiTargetError, projectModified=projectModified, aclMigrationStarted=aclMigrationStarted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, fcTargetName=fcTargetName, projectLUNs=projectLUNs, poolMetaReadIops=poolMetaReadIops, fcTargetEntry=fcTargetEntry, diskTotalWriteIops=diskTotalWriteIops, shareDeleted=shareDeleted, poolTotalReadIops=poolTotalReadIops, diskType=diskType, lunCompressedRatio=lunCompressedRatio, notificationReadingUnit=notificationReadingUnit, fcInitiators=fcInitiators, lunPoolName=lunPoolName, aclMigrationCompleted=aclMigrationCompleted, diskDataReadMbps=diskDataReadMbps, poolDataSizeLow=poolDataSizeLow, shareCIFSReadMbps=shareCIFSReadMbps, fcTargetReadMbps=fcTargetReadMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, projectIndex=projectIndex)
