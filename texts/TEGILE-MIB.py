...
iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, ObjectIdentity, Counter32, Gauge32, Integer32, NotificationType, ModuleIdentity, Unsigned32, Counter64, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "ObjectIdentity", "Counter32", "Gauge32", "Integer32", "NotificationType", "ModuleIdentity", "Unsigned32", "Counter64", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolProjects=poolProjects, replicationResumed=replicationResumed, notificationTargetEntityName=notificationTargetEntityName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolMetaReadLatency=poolMetaReadLatency, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, maintenanceModeEnabled=maintenanceModeEnabled, shareName=shareName, volumeDeleteFailed=volumeDeleteFailed, nicName=nicName, shareSnapshotSizeLow=shareSnapshotSizeLow, poolName=poolName, lunWriteLatency=lunWriteLatency, projectSnapshotSizeHigh=projectSnapshotSizeHigh, diskState=diskState, poolReadCacheReadIops=poolReadCacheReadIops, poolDeletionFailed=poolDeletionFailed, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, lunTargetGroup=lunTargetGroup, upgradeCompleted=upgradeCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareNFSReadIops=shareNFSReadIops, disks=disks, notificationSensorAction=notificationSensorAction, nicMTU=nicMTU, currentNotificationGroup=currentNotificationGroup, cifsTotalReadMbps=cifsTotalReadMbps, projectShares=projectShares, nicEntry=nicEntry, volumeCreatedSuccessfully=volumeCreatedSuccessfully, fcTargetModifyCompleted=fcTargetModifyCompleted, snapshotRollbackFailed=snapshotRollbackFailed, upgradeStarted=upgradeStarted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, fcTargetStatus=fcTargetStatus, iscsiTotalReadMbps=iscsiTotalReadMbps, fcTargetGroup=fcTargetGroup, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcInitiatorEntry=fcInitiatorEntry, projectDeletionFailed=projectDeletionFailed, targetGroupMemberAdded=targetGroupMemberAdded, ipmiCurrent=ipmiCurrent, nvdimmFailDeviceError=nvdimmFailDeviceError, lunDataSizeLow=lunDataSizeLow, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcAvgWriteLatency=fcAvgWriteLatency, lunWriteMbps=lunWriteMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, controllerHardwareModel=controllerHardwareModel, poolOwnerController=poolOwnerController, diskIsOnline=diskIsOnline, cacheTotalWriteMbps=cacheTotalWriteMbps, nfsTotalReadIops=nfsTotalReadIops, ipmiOther=ipmiOther, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, lunReadMbps=lunReadMbps, iscsiTargetGroup=iscsiTargetGroup, poolUpgraded=poolUpgraded, sensorFailureEvent=sensorFailureEvent, ntpServerTimeDrift=ntpServerTimeDrift, poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, aclMigrationCompleted=aclMigrationCompleted, haResourceStatus=haResourceStatus, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcProperties=fcProperties, networkIpmpGroupUp=networkIpmpGroupUp, replicationTargetDeleted=replicationTargetDeleted, diskDataWriteIops=diskDataWriteIops, fcTotalWriteIops=fcTotalWriteIops, notificationReadingUnit=notificationReadingUnit, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunEntry=lunEntry, sanProperties=sanProperties, projectThresholdExceedWarning=projectThresholdExceedWarning, shareProjectName=shareProjectName, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolDataWriteIops=poolDataWriteIops, haResourceIndex=haResourceIndex, lunReadLatency=lunReadLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, fcTargetReadLatency=fcTargetReadLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, lunInitiatorGroup=lunInitiatorGroup, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diskTotalReadIops=diskTotalReadIops, poolMetaWriteMbps=poolMetaWriteMbps, cpuTotalUsage=cpuTotalUsage, projectDataSizeLow=projectDataSizeLow, notificationProps=notificationProps, snmpServiceStarted=snmpServiceStarted, shareNFSReadMbps=shareNFSReadMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunWriteIops=lunWriteIops, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolUsedSizeHigh=poolUsedSizeHigh, iscsiAvgWriteLatency=iscsiAvgWriteLatency, replicationStarted=replicationStarted, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiTargetGroupError=iscsiTargetGroupError, ipmiTemperature=ipmiTemperature, shareDataSizeLow=shareDataSizeLow, poolProjectCount=poolProjectCount, pools=pools, shareCIFSReadIops=shareCIFSReadIops, tegileGroups=tegileGroups, iscsiTargetReadIops=iscsiTargetReadIops, lunDedupEnabled=lunDedupEnabled, poolFreeSizeLow=poolFreeSizeLow, fcPortOffline=fcPortOffline, projectShareCount=projectShareCount, lunTable=lunTable, webdocsUpgradeFailed=webdocsUpgradeFailed, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, projectDeleted=projectDeleted, poolTotalSaving=poolTotalSaving, ipmiThreshold=ipmiThreshold, networkIpmpGroupDown=networkIpmpGroupDown, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolAvgReadLatency=poolAvgReadLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunReadIops=lunReadIops, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolTotalWriteIops=poolTotalWriteIops, poolTable=poolTable, replicationAborted=replicationAborted, cacheSSDReads=cacheSSDReads, iscsiTargetWriteMbps=iscsiTargetWriteMbps, userLoginFailed=userLoginFailed, upgradeTimeout=upgradeTimeout, haControllerA_IPAddr=haControllerA_IPAddr, poolExpanded=poolExpanded, haControllerB_Uptime=haControllerB_Uptime, replicationComplete=replicationComplete, properties=properties, diskSizeLow=diskSizeLow, lunSizeHigh=lunSizeHigh, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolReadCacheReadLatency=poolReadCacheReadLatency, snmpAgentVersion=snmpAgentVersion, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, notificationComponentName=notificationComponentName, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareReservedSizeLow=shareReservedSizeLow, iscsiProperties=iscsiProperties, iscsiTargetName=iscsiTargetName, nvdimmFailInitializationError=nvdimmFailInitializationError, haResourceName=haResourceName, fcInitiatorIndex=fcInitiatorIndex, deleteFolderFailed=deleteFolderFailed, nicReceiveMbps=nicReceiveMbps, ipmiFan=ipmiFan, unknownSensorEvent=unknownSensorEvent, shareCompressedRatio=shareCompressedRatio, iscsiTargets=iscsiTargets, fcTargetReadIops=fcTargetReadIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, snmpServiceStartFailed=snmpServiceStartFailed, shareTable=shareTable, poolQuotaFinished=poolQuotaFinished, diskTable=diskTable, replicationFailed=replicationFailed, poolMetaWriteLatency=poolMetaWriteLatency, poolIndex=poolIndex, fcInitiatorName=fcInitiatorName, snapshotCreationFailed=snapshotCreationFailed, haControllerB_IPAddr=haControllerB_IPAddr, lunFreeSizeHigh=lunFreeSizeHigh, volumeDeleteCompleted=volumeDeleteCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, snmpServiceStopFailed=snmpServiceStopFailed, diskTotalWriteMbps=diskTotalWriteMbps, cifsTotalWriteMbps=cifsTotalWriteMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, diskRandomIOCount=diskRandomIOCount, iscsiTargetWriteIops=iscsiTargetWriteIops, projectFreeSizeHigh=projectFreeSizeHigh, cacheRAMReads=cacheRAMReads, nicIndex=nicIndex, diskSizeHigh=diskSizeHigh, lunGUID=lunGUID, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, poolEntry=poolEntry, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolDataWriteLatency=poolDataWriteLatency, projectTable=projectTable, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, haControllerA_Uptime=haControllerA_Uptime, haResourceDescription=haResourceDescription, fcPortOnline=fcPortOnline, iscsiInitiatorsTable=iscsiInitiatorsTable, diskEntry=diskEntry, tegileArray=tegileArray, poolCount=poolCount, notificationTime=notificationTime, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, snmpServiceStopped=snmpServiceStopped, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, replicationPaused=replicationPaused, projectFreeSizeLow=projectFreeSizeLow, globalStatistics=globalStatistics, haResourceGroup=haResourceGroup, notificationThresholdTriggerValue=notificationThresholdTriggerValue, volumeModifyCompleted=volumeModifyCompleted, iscsiTargetsTable=iscsiTargetsTable, notificationObjects=notificationObjects, lunSizeLow=lunSizeLow, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, iscsiTargetIndex=iscsiTargetIndex, upgradeDownloadStarted=upgradeDownloadStarted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, iscsiTargetAlias=iscsiTargetAlias, projectQuotaFinished=projectQuotaFinished, fcTargetWriteMbps=fcTargetWriteMbps, volumeQuotaFinished=volumeQuotaFinished, fcTotalReadIops=fcTotalReadIops, shareDataSizeHigh=shareDataSizeHigh, basicCompliance=basicCompliance, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcAvgReadLatency=fcAvgReadLatency, fcTargetName=fcTargetName, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolExported=poolExported, tegileArray_notifications=tegileArray_notifications, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, diskGoneOffline=diskGoneOffline, poolTotalReadIops=poolTotalReadIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, shareQuotaFinished=shareQuotaFinished, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolTotalWriteMbps=poolTotalWriteMbps, diskAlias=diskAlias, lunReservedSizeHigh=lunReservedSizeHigh, lunCompressedRatio=lunCompressedRatio, controllerUp=controllerUp, shareCIFSWriteLatency=shareCIFSWriteLatency, poolUsedSizeLow=poolUsedSizeLow, poolDegraded=poolDegraded, shareSnapshotSizeHigh=shareSnapshotSizeHigh, snapshotCloningFailed=snapshotCloningFailed)
mibBuilder.exportSymbols("TEGILE-MIB", diskSlowIo=diskSlowIo, diskTotalReadMbps=diskTotalReadMbps, projectTotalSaving=projectTotalSaving, shareCIFSReadLatency=shareCIFSReadLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, shareNFSWriteIops=shareNFSWriteIops, notificationSeverity=notificationSeverity, cacheTotalReadMbps=cacheTotalReadMbps, adServerTimeDrift=adServerTimeDrift, diskSequentialIOCount=diskSequentialIOCount, poolDataReadLatency=poolDataReadLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, notificationDescription=notificationDescription, poolReadCacheWriteLatency=poolReadCacheWriteLatency, network=network, iscsiAvgReadLatency=iscsiAvgReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, shareEntry=shareEntry, diskChassisIdx=diskChassisIdx, iscsiInitiatorName=iscsiInitiatorName, haResourceEntry=haResourceEntry, diskTotalWriteIops=diskTotalWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiTargetAuth=iscsiTargetAuth, shareDeletionFailed=shareDeletionFailed, shareNFSReadLatency=shareNFSReadLatency, lunBlockSize=lunBlockSize, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolTotalReadMbps=poolTotalReadMbps, smbSocketFailure=smbSocketFailure, cpuInterrupts=cpuInterrupts, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiTargetEntry=iscsiTargetEntry, upgradeDownloadFailed=upgradeDownloadFailed, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcTargets=fcTargets, tegileCompliances=tegileCompliances, lunProjectName=lunProjectName, shareReservedSizeHigh=shareReservedSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, netbiosSocketFailure=netbiosSocketFailure, diskError=diskError, cacheTotalReadIops=cacheTotalReadIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolAvgWriteLatency=poolAvgWriteLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, notificationSensorNumber=notificationSensorNumber, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiInitiatorGroup=iscsiInitiatorGroup, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, nvdimmFailSoftError=nvdimmFailSoftError, lunFreeSizeLow=lunFreeSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, ipmiMemory=ipmiMemory, poolCreated=poolCreated, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareDeleted=shareDeleted, shareCreatedSuccessfully=shareCreatedSuccessfully, smisServiceStopped=smisServiceStopped, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcInitiatorsTable=fcInitiatorsTable, smisServiceStartFailed=smisServiceStartFailed, projectEntry=projectEntry, PYSNMP_MODULE_ID=tegile, shareCIFSWriteMbps=shareCIFSWriteMbps, networkInterfaceUp=networkInterfaceUp, notifications=notifications, lunDataSizeHigh=lunDataSizeHigh, fcTotalWriteMbps=fcTotalWriteMbps, diskDataReadMbps=diskDataReadMbps, poolDataReadMbps=poolDataReadMbps, poolDataReadIops=poolDataReadIops, fcInitiators=fcInitiators, projectQuotaSizeLow=projectQuotaSizeLow, fcTargetsTable=fcTargetsTable, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareCIFSEnabled=shareCIFSEnabled, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareCIFSReadMbps=shareCIFSReadMbps, poolSizeHigh=poolSizeHigh, shareCIFSWriteIops=shareCIFSWriteIops, poolDataSizeHigh=poolDataSizeHigh, shareQuotaHigh=shareQuotaHigh, lunReservedSizeLow=lunReservedSizeLow, targetGroupMemberRemoved=targetGroupMemberRemoved, intelliFlashSoftwareUp=intelliFlashSoftwareUp, aclMigrationStarted=aclMigrationStarted, shareQuotaLow=shareQuotaLow, poolImported=poolImported, shareIndex=shareIndex, diskAvgWriteLatency=diskAvgWriteLatency, iscsiWriteIops=iscsiWriteIops, tegile=tegile, fcTargetEntry=fcTargetEntry, controllerTimeDrift=controllerTimeDrift, projectDedupEnabled=projectDedupEnabled, notificationReadingTriggerValue=notificationReadingTriggerValue, diskPoolName=diskPoolName, projectIndex=projectIndex, notificationSensorSuspect=notificationSensorSuspect, nfsAvgReadLatency=nfsAvgReadLatency, testNotification=testNotification, webdocsUpgradeCompleted=webdocsUpgradeCompleted, projectDataSizeHigh=projectDataSizeHigh, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunIndex=lunIndex, fcTargetIndex=fcTargetIndex, spareDiskReplaced=spareDiskReplaced, tegileConformance=tegileConformance, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiInitiatorEntry=iscsiInitiatorEntry, haControllerA_Name=haControllerA_Name, projectPoolName=projectPoolName, shareNFSWriteLatency=shareNFSWriteLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareMountPoint=shareMountPoint, iscsiTotalReadIops=iscsiTotalReadIops, diskDataReadIops=diskDataReadIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, projectCompressionEnabled=projectCompressionEnabled, poolSizeLow=poolSizeLow, nfsTotalWriteIops=nfsTotalWriteIops, shareDedupEnabled=shareDedupEnabled, replicationSourceRegistered=replicationSourceRegistered, cifsTotalWriteIops=cifsTotalWriteIops, diskIOCount=diskIOCount, nicState=nicState, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolDataWriteMbps=poolDataWriteMbps, lunProtocol=lunProtocol, lunSnapshotSizeLow=lunSnapshotSizeLow, poolDeleted=poolDeleted, iscsiTargetError=iscsiTargetError, projectLUNs=projectLUNs, poolMetaReadIops=poolMetaReadIops, maintenanceModeDisabled=maintenanceModeDisabled, poolMetaWriteIops=poolMetaWriteIops, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, alertsCleanupCompleted=alertsCleanupCompleted, replicationAbandoned=replicationAbandoned, diskIndex=diskIndex, smisServiceStopFailed=smisServiceStopFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, nfsTotalReadMbps=nfsTotalReadMbps, smisServiceStarted=smisServiceStarted, diskAvgReadLatency=diskAvgReadLatency, haResourceActiveNode=haResourceActiveNode, poolReadCacheReadMbps=poolReadCacheReadMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, fcTargetWriteLatency=fcTargetWriteLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, haResourcesTable=haResourcesTable, nicTransmitMbps=nicTransmitMbps, networkInterfaceDown=networkInterfaceDown, diskCount=diskCount, notificationEventCode=notificationEventCode, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, upgradeDownloadCompleted=upgradeDownloadCompleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, haControllerB_Name=haControllerB_Name, nicGroup=nicGroup, projectName=projectName, poolFreeSizeHigh=poolFreeSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, ipmiPowerSupply=ipmiPowerSupply, shareNFSWriteMbps=shareNFSWriteMbps, vmwareNFSDatastores=vmwareNFSDatastores, lunPoolName=lunPoolName, diagnosticDataUploaded=diagnosticDataUploaded, fcTotalReadMbps=fcTotalReadMbps, cifsTotalReadIops=cifsTotalReadIops, fcTargetReadMbps=fcTargetReadMbps, cifsAvgReadLatency=cifsAvgReadLatency, ipmiVoltage=ipmiVoltage, diskDataWriteMbps=diskDataWriteMbps, snapshotDeleteFailed=snapshotDeleteFailed, lunName=lunName, projectModified=projectModified, poolMetaReadMbps=poolMetaReadMbps, fcTargetWriteIops=fcTargetWriteIops, snapshotCloneCompleted=snapshotCloneCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolHealth=poolHealth, projectLunCount=projectLunCount, poolState=poolState, memoryFailure=memoryFailure, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, controllerDown=controllerDown, cpuSystemCalls=cpuSystemCalls, lunCompressionEnabled=lunCompressionEnabled, projectCreatedSuccessfully=projectCreatedSuccessfully, sharePoolName=sharePoolName, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, shareCompressionEnabled=shareCompressionEnabled, haResources=haResources, iscsiInitiators=iscsiInitiators, shareExceedThresholdWarning=shareExceedThresholdWarning, nfsTotalWriteMbps=nfsTotalWriteMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, shareNFSEnabled=shareNFSEnabled, diskType=diskType, upgradeFailed=upgradeFailed, cacheTotalWriteIops=cacheTotalWriteIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, nfsAvgWriteLatency=nfsAvgWriteLatency, deleteFolderCompleted=deleteFolderCompleted, nicTable=nicTable)
