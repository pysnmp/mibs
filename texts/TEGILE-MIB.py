...
# Produced by pysmi-1.1.8 at Tue Jul 26 15:34:40 2022
...
enterprises, NotificationType, iso, IpAddress, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, ModuleIdentity, Integer32, Counter64, Unsigned32, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "iso", "IpAddress", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "ModuleIdentity", "Integer32", "Counter64", "Unsigned32", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("TEGILE-MIB", webdocsUpgradeFailed=webdocsUpgradeFailed, smisServiceStartFailed=smisServiceStartFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, lunIndex=lunIndex, iscsiTargetGroup=iscsiTargetGroup, ipmiPowerSupply=ipmiPowerSupply, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolMetaWriteMbps=poolMetaWriteMbps, aclMigrationCompleted=aclMigrationCompleted, shareDeleted=shareDeleted, lunProtocol=lunProtocol, diskDataReadIops=diskDataReadIops, diskIsOnline=diskIsOnline, projectQuotaSizeLow=projectQuotaSizeLow, iscsiInitiatorsTable=iscsiInitiatorsTable, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, PYSNMP_MODULE_ID=tegile, poolReadCacheWriteMbps=poolReadCacheWriteMbps, diskSizeHigh=diskSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, ipmiTemperature=ipmiTemperature, tegileArray=tegileArray, deleteFolderCompleted=deleteFolderCompleted, nicName=nicName, diskAvgWriteLatency=diskAvgWriteLatency, snapshotRollbackCompleted=snapshotRollbackCompleted, shareCompressedRatio=shareCompressedRatio, snapshotDeleteFailed=snapshotDeleteFailed, lunTable=lunTable, fcTargetName=fcTargetName, poolMetaReadLatency=poolMetaReadLatency, lunBlockSize=lunBlockSize, replicationTargetDeleted=replicationTargetDeleted, poolTotalWriteIops=poolTotalWriteIops, poolFreeSizeLow=poolFreeSizeLow, nfsAvgWriteLatency=nfsAvgWriteLatency, fcTargetEntry=fcTargetEntry, testNotification=testNotification, haControllerA_IPAddr=haControllerA_IPAddr, diskRandomIOCount=diskRandomIOCount, iscsiInitiatorEntry=iscsiInitiatorEntry, shareCIFSEnabled=shareCIFSEnabled, fcInitiators=fcInitiators, lunName=lunName, diskDataWriteMbps=diskDataWriteMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, poolFreeSizeHigh=poolFreeSizeHigh, volumeDeleteCompleted=volumeDeleteCompleted, projectLunCount=projectLunCount, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcTargets=fcTargets, lunDedupEnabled=lunDedupEnabled, haResourceGroup=haResourceGroup, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcAvgReadLatency=fcAvgReadLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, lunCompressionEnabled=lunCompressionEnabled, iscsiTotalReadIops=iscsiTotalReadIops, lunTargetGroup=lunTargetGroup, basicCompliance=basicCompliance, fcInitiatorName=fcInitiatorName, poolDataWriteIops=poolDataWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, ipmiMemory=ipmiMemory, fcTargetIndex=fcTargetIndex, shareTable=shareTable, shareName=shareName, upgradeCompleted=upgradeCompleted, shareCIFSReadIops=shareCIFSReadIops, haResourceDescription=haResourceDescription, projectTable=projectTable, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareNFSWriteIops=shareNFSWriteIops, diskSlowIo=diskSlowIo, poolSizeLow=poolSizeLow, shareNFSEnabled=shareNFSEnabled, poolCount=poolCount, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, projectDeletionFailed=projectDeletionFailed, targetGroupMemberRemoved=targetGroupMemberRemoved, shareQuotaLow=shareQuotaLow, diskSizeLow=diskSizeLow, iscsiTargetEntry=iscsiTargetEntry, iscsiInitiators=iscsiInitiators, poolTotalWriteMbps=poolTotalWriteMbps, notificationSensorAction=notificationSensorAction, poolTotalReadIops=poolTotalReadIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunReadLatency=lunReadLatency, ipmiOther=ipmiOther, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, fcPortOffline=fcPortOffline, iscsiTargetAlias=iscsiTargetAlias, diskChassisIdx=diskChassisIdx, smbSocketFailure=smbSocketFailure, replicationComplete=replicationComplete, iscsiTargets=iscsiTargets, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskTotalReadMbps=diskTotalReadMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcInitiatorEntry=fcInitiatorEntry, lunGUID=lunGUID, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, nicEntry=nicEntry, networkInterfaceUp=networkInterfaceUp, cacheTotalWriteMbps=cacheTotalWriteMbps, controllerHardwareModel=controllerHardwareModel, notificationDescription=notificationDescription, shareCIFSWriteIops=shareCIFSWriteIops, notificationSeverity=notificationSeverity, poolExported=poolExported, volumeModifyCompleted=volumeModifyCompleted, shareCIFSReadMbps=shareCIFSReadMbps, projectPoolName=projectPoolName, upgradeDownloadCompleted=upgradeDownloadCompleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunReservedSizeHigh=lunReservedSizeHigh, currentNotificationGroup=currentNotificationGroup, snmpServiceStartFailed=snmpServiceStartFailed, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, lunReservedSizeLow=lunReservedSizeLow, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, nfsAvgReadLatency=nfsAvgReadLatency, iscsiInitiatorGroup=iscsiInitiatorGroup, disks=disks, shareQuotaFinished=shareQuotaFinished, shareExceedThresholdWarning=shareExceedThresholdWarning, fcTargetWriteIops=fcTargetWriteIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiTargetName=iscsiTargetName, lunWriteIops=lunWriteIops, deleteFolderFailed=deleteFolderFailed, poolOwnerController=poolOwnerController, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, adServerTimeDrift=adServerTimeDrift, notificationTargetEntityName=notificationTargetEntityName, lunReadMbps=lunReadMbps, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTargetError=iscsiTargetError, shareEntry=shareEntry, spareDiskReplaced=spareDiskReplaced, fcProperties=fcProperties, iscsiImproperTargetGroup=iscsiImproperTargetGroup, projectFreeSizeLow=projectFreeSizeLow, notifications=notifications, controllerDown=controllerDown, replicationStarted=replicationStarted, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, shareQuotaHigh=shareQuotaHigh, lunDataSizeHigh=lunDataSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, tegileArray_notifications=tegileArray_notifications, unknownSensorEvent=unknownSensorEvent, replicationAborted=replicationAborted, snapshotCreationFailed=snapshotCreationFailed, nvdimmFailSoftError=nvdimmFailSoftError, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, tegile=tegile, iscsiTotalReadMbps=iscsiTotalReadMbps, diskIOCount=diskIOCount, snmpServiceStarted=snmpServiceStarted, shareCreatedSuccessfully=shareCreatedSuccessfully, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, cacheRAMReads=cacheRAMReads, projectCreatedSuccessfully=projectCreatedSuccessfully, fcTargetReadMbps=fcTargetReadMbps, shareProjectName=shareProjectName, poolTotalReadMbps=poolTotalReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, lunFreeSizeHigh=lunFreeSizeHigh, userLoginFailed=userLoginFailed, projectShares=projectShares, iscsiInitiatorName=iscsiInitiatorName, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiTargetGroupError=iscsiTargetGroupError, shareNFSWriteMbps=shareNFSWriteMbps, fcTargetsTable=fcTargetsTable, diskAvgReadLatency=diskAvgReadLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, fcTargetStatus=fcTargetStatus, shareCIFSWriteMbps=shareCIFSWriteMbps, poolTotalSaving=poolTotalSaving, lunFreeSizeLow=lunFreeSizeLow, poolUpgraded=poolUpgraded, poolDataWriteMbps=poolDataWriteMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolExpanded=poolExpanded, tdpsUpgradeFailed=tdpsUpgradeFailed, replicationFailed=replicationFailed, upgradeDownloadFailed=upgradeDownloadFailed, lunWriteMbps=lunWriteMbps, networkInterfaceDown=networkInterfaceDown, notificationSensorSuspect=notificationSensorSuspect, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, tdpsUpgradeTimeout=tdpsUpgradeTimeout, cifsAvgWriteLatency=cifsAvgWriteLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, haResourceActiveNode=haResourceActiveNode, fcTargetGroup=fcTargetGroup, shareSnapshotSizeHigh=shareSnapshotSizeHigh, nicGroup=nicGroup, poolCreated=poolCreated, notificationTime=notificationTime, ipmiVoltage=ipmiVoltage, aclMigrationStarted=aclMigrationStarted, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, snmpServiceStopped=snmpServiceStopped, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, diagnosticDataUploaded=diagnosticDataUploaded, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareCIFSReadLatency=shareCIFSReadLatency, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, fcAvgWriteLatency=fcAvgWriteLatency, diskError=diskError, poolDeletionFailed=poolDeletionFailed, diskTotalWriteMbps=diskTotalWriteMbps, fcTotalReadMbps=fcTotalReadMbps, shareCompressionEnabled=shareCompressionEnabled, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, volumeDeleteFailed=volumeDeleteFailed, iscsiAvgReadLatency=iscsiAvgReadLatency, maintenanceModeDisabled=maintenanceModeDisabled, cacheSSDReads=cacheSSDReads, poolTable=poolTable, haResourceName=haResourceName, diskEntry=diskEntry, projectShareCount=projectShareCount, snapshotRollbackFailed=snapshotRollbackFailed, shareIndex=shareIndex, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareReservedSizeHigh=shareReservedSizeHigh, poolSizeHigh=poolSizeHigh, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, iscsiInitiatorIndex=iscsiInitiatorIndex, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunReadIops=lunReadIops, cifsAvgReadLatency=cifsAvgReadLatency, poolIndex=poolIndex, projectIndex=projectIndex, replicationPaused=replicationPaused, poolWriteCacheWriteIops=poolWriteCacheWriteIops, smisServiceStarted=smisServiceStarted, controllerTimeDrift=controllerTimeDrift, nfsTotalReadMbps=nfsTotalReadMbps)
mibBuilder.exportSymbols("TEGILE-MIB", projectModified=projectModified, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiTargetReadIops=iscsiTargetReadIops, cifsTotalWriteIops=cifsTotalWriteIops, haControllerA_Name=haControllerA_Name, projectEntry=projectEntry, cpuInterrupts=cpuInterrupts, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolAvgReadLatency=poolAvgReadLatency, nfsTotalReadIops=nfsTotalReadIops, fcTotalReadIops=fcTotalReadIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiTargetAuth=iscsiTargetAuth, diskSequentialIOCount=diskSequentialIOCount, lunWriteLatency=lunWriteLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, properties=properties, iscsiTargetReadMbps=iscsiTargetReadMbps, replicationSourceRegistered=replicationSourceRegistered, poolDegraded=poolDegraded, lunInitiatorGroup=lunInitiatorGroup, notificationEventCode=notificationEventCode, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, netbiosSocketFailure=netbiosSocketFailure, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcTargetReadLatency=fcTargetReadLatency, networkIpmpGroupUp=networkIpmpGroupUp, poolEntry=poolEntry, projectName=projectName, iscsiWriteIops=iscsiWriteIops, shareDedupEnabled=shareDedupEnabled, iscsiTargetIndex=iscsiTargetIndex, sensorFailureEvent=sensorFailureEvent, volumeQuotaFinished=volumeQuotaFinished, fcInitiatorCreateFailed=fcInitiatorCreateFailed, notificationReadingTriggerValue=notificationReadingTriggerValue, diskGoneOffline=diskGoneOffline, poolReadCacheWriteIops=poolReadCacheWriteIops, ipmiFan=ipmiFan, nvdimmFailInitializationError=nvdimmFailInitializationError, fcTargetWriteMbps=fcTargetWriteMbps, fcPortOnline=fcPortOnline, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareReservedSizeLow=shareReservedSizeLow, poolUsedSizeLow=poolUsedSizeLow, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, diskTotalWriteIops=diskTotalWriteIops, cacheTotalReadMbps=cacheTotalReadMbps, upgradeStarted=upgradeStarted, shareNFSReadLatency=shareNFSReadLatency, notificationObjects=notificationObjects, fcTotalWriteMbps=fcTotalWriteMbps, network=network, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskState=diskState, projectDataSizeLow=projectDataSizeLow, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, lunSnapshotSizeLow=lunSnapshotSizeLow, poolDataReadLatency=poolDataReadLatency, nicTable=nicTable, poolDataReadMbps=poolDataReadMbps, iscsiProperties=iscsiProperties, upgradeTimeout=upgradeTimeout, poolMetaReadMbps=poolMetaReadMbps, sharePoolName=sharePoolName, diskType=diskType, snmpAgentVersion=snmpAgentVersion, notificationReadingUnit=notificationReadingUnit, diskTable=diskTable, diskCount=diskCount, sanProperties=sanProperties, iscsiTargetReadLatency=iscsiTargetReadLatency, nfsTotalWriteIops=nfsTotalWriteIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolDataWriteLatency=poolDataWriteLatency, tegileConformance=tegileConformance, haResourceIndex=haResourceIndex, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, ipmiThreshold=ipmiThreshold, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetModifyCompleted=fcTargetModifyCompleted, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, smisServiceStopFailed=smisServiceStopFailed, shareNFSReadIops=shareNFSReadIops, replicationAbandoned=replicationAbandoned, poolProjectCount=poolProjectCount, haResourcesTable=haResourcesTable, notificationComponentName=notificationComponentName, tegileCompliances=tegileCompliances, nicReceiveMbps=nicReceiveMbps, diskTotalReadIops=diskTotalReadIops, cpuSystemCalls=cpuSystemCalls, globalStatistics=globalStatistics, snapshotCloningFailed=snapshotCloningFailed, poolUsedSizeHigh=poolUsedSizeHigh, nicMTU=nicMTU, networkIpmpGroupDown=networkIpmpGroupDown, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolReadCacheReadMbps=poolReadCacheReadMbps, cpuTotalUsage=cpuTotalUsage, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, notificationSensorNumber=notificationSensorNumber, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolMetaWriteLatency=poolMetaWriteLatency, nicIndex=nicIndex, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, upgradeDownloadStarted=upgradeDownloadStarted, projectDeleted=projectDeleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, targetGroupMemberAdded=targetGroupMemberAdded, poolDeleted=poolDeleted, diskDataWriteIops=diskDataWriteIops, haResourceStatus=haResourceStatus, poolState=poolState, cifsTotalReadIops=cifsTotalReadIops, poolHealth=poolHealth, shareDataSizeHigh=shareDataSizeHigh, fcTotalWriteIops=fcTotalWriteIops, projectSnapshotSizeLow=projectSnapshotSizeLow, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolImported=poolImported, fcTargetReadIops=fcTargetReadIops, cacheTotalWriteIops=cacheTotalWriteIops, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, smisServiceStopped=smisServiceStopped, intelliFlashSoftwareDown=intelliFlashSoftwareDown, fcInitiatorIndex=fcInitiatorIndex, diskPoolName=diskPoolName, fcTargetWriteLatency=fcTargetWriteLatency, shareNFSReadMbps=shareNFSReadMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, shareDataSizeLow=shareDataSizeLow, poolName=poolName, projectLUNs=projectLUNs, controllerUp=controllerUp, replicationResumed=replicationResumed, haControllerB_Uptime=haControllerB_Uptime, projectFreeSizeHigh=projectFreeSizeHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, targetGroupCreateCompleted=targetGroupCreateCompleted, diskIndex=diskIndex, alertsCleanupCompleted=alertsCleanupCompleted, snmpServiceStopFailed=snmpServiceStopFailed, poolDataSizeLow=poolDataSizeLow, haControllerB_Name=haControllerB_Name, memoryFailure=memoryFailure, lunDataSizeLow=lunDataSizeLow, haResourceEntry=haResourceEntry, currentObjectGroup=currentObjectGroup, diskAlias=diskAlias, projectDedupEnabled=projectDedupEnabled, projectDataSizeHigh=projectDataSizeHigh, nicTransmitMbps=nicTransmitMbps, projectTotalSaving=projectTotalSaving, lunProjectName=lunProjectName, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, ipmiCriticalInterrupt=ipmiCriticalInterrupt, pools=pools, networkTotalTransmitMbps=networkTotalTransmitMbps, haControllerB_IPAddr=haControllerB_IPAddr, poolMetaReadIops=poolMetaReadIops, iscsiTargetsTable=iscsiTargetsTable, haResources=haResources, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolDataReadIops=poolDataReadIops, maintenanceModeEnabled=maintenanceModeEnabled, diskDataReadMbps=diskDataReadMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunEntry=lunEntry, haControllerA_Uptime=haControllerA_Uptime, fcInitiatorsTable=fcInitiatorsTable, lunSizeHigh=lunSizeHigh, nfsTotalWriteMbps=nfsTotalWriteMbps, cifsTotalReadMbps=cifsTotalReadMbps, upgradeFailed=upgradeFailed, ipmiCurrent=ipmiCurrent, tegileGroups=tegileGroups, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolDataSizeHigh=poolDataSizeHigh, notificationProps=notificationProps, ntpServerTimeDrift=ntpServerTimeDrift, snapshotCloneCompleted=snapshotCloneCompleted, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolMetaWriteIops=poolMetaWriteIops, poolQuotaFinished=poolQuotaFinished, shareDeletionFailed=shareDeletionFailed, lunPoolName=lunPoolName, poolProjects=poolProjects, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareMountPoint=shareMountPoint, projectQuotaFinished=projectQuotaFinished, vmwareNFSDatastores=vmwareNFSDatastores, cacheTotalReadIops=cacheTotalReadIops, poolAvgWriteLatency=poolAvgWriteLatency, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, projectCompressionEnabled=projectCompressionEnabled, lunSizeLow=lunSizeLow, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareSnapshotSizeLow=shareSnapshotSizeLow, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunCompressedRatio=lunCompressedRatio, nicState=nicState)
