...
IpAddress, Unsigned32, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, ModuleIdentity, Gauge32, MibIdentifier, iso, enterprises, ObjectIdentity, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "ModuleIdentity", "Gauge32", "MibIdentifier", "iso", "enterprises", "ObjectIdentity", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", cpuSystemCalls=cpuSystemCalls, poolSizeLow=poolSizeLow, notificationEventCode=notificationEventCode, iscsiTargetReadMbps=iscsiTargetReadMbps, lunProtocol=lunProtocol, nvdimmFailSoftError=nvdimmFailSoftError, poolTable=poolTable, tdpsUpgradeFailed=tdpsUpgradeFailed, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, notificationObjects=notificationObjects, poolDataSizeHigh=poolDataSizeHigh, poolTotalReadMbps=poolTotalReadMbps, disks=disks, diskCount=diskCount, shareNFSWriteIops=shareNFSWriteIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, nicMTU=nicMTU, diskDataWriteMbps=diskDataWriteMbps, ipmiVoltage=ipmiVoltage, haResources=haResources, tegileConformance=tegileConformance, shareCompressedRatio=shareCompressedRatio, cifsTotalWriteIops=cifsTotalWriteIops, notifications=notifications, fcTargetReadLatency=fcTargetReadLatency, haResourcesTable=haResourcesTable, fcTargetWriteMbps=fcTargetWriteMbps, replicationAbandoned=replicationAbandoned, poolMetaWriteIops=poolMetaWriteIops, nvdimmFailUnknownError=nvdimmFailUnknownError, diskPoolName=diskPoolName, shareNFSWriteMbps=shareNFSWriteMbps, projectDeleted=projectDeleted, currentNotificationGroup=currentNotificationGroup, nvdimmFailDeviceError=nvdimmFailDeviceError, poolCreated=poolCreated, shareProjectName=shareProjectName, netbiosSocketFailure=netbiosSocketFailure, fcAvgReadLatency=fcAvgReadLatency, snmpAgentVersion=snmpAgentVersion, diskIsOnline=diskIsOnline, fcInitiators=fcInitiators, replicationResumed=replicationResumed, targetGroupMemberAdded=targetGroupMemberAdded, projectTable=projectTable, volumeModifyCompleted=volumeModifyCompleted, memoryFailure=memoryFailure, diskTotalWriteMbps=diskTotalWriteMbps, cifsTotalReadMbps=cifsTotalReadMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, iscsiTargetError=iscsiTargetError, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcInitiatorGroup=fcInitiatorGroup, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, nicName=nicName, iscsiInitiatorEntry=iscsiInitiatorEntry, notificationSensorNumber=notificationSensorNumber, notificationTime=notificationTime, shareExceedThresholdWarning=shareExceedThresholdWarning, fcInitiatorIndex=fcInitiatorIndex, iscsiTargetAuth=iscsiTargetAuth, networkIpmpGroupDown=networkIpmpGroupDown, poolTotalWriteIops=poolTotalWriteIops, shareDeletionFailed=shareDeletionFailed, smbSocketFailure=smbSocketFailure, tegileGroups=tegileGroups, fcTargetWriteLatency=fcTargetWriteLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareReservedSizeLow=shareReservedSizeLow, projectThresholdExceedWarning=projectThresholdExceedWarning, vmwareNFSDatastores=vmwareNFSDatastores, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, nvdimmFailInitializationError=nvdimmFailInitializationError, PYSNMP_MODULE_ID=tegile, diskAlias=diskAlias, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectSnapshotSizeHigh=projectSnapshotSizeHigh, volumeCreatedSuccessfully=volumeCreatedSuccessfully, ipmiOther=ipmiOther, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, fcTargetStatus=fcTargetStatus, controllerUp=controllerUp, diskAvgWriteLatency=diskAvgWriteLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, unknownSensorEvent=unknownSensorEvent, iscsiInitiatorIndex=iscsiInitiatorIndex, lunReservedSizeHigh=lunReservedSizeHigh, lunReadIops=lunReadIops, upgradeFailed=upgradeFailed, shareNFSReadMbps=shareNFSReadMbps, snapshotRollbackFailed=snapshotRollbackFailed, notificationSensorAction=notificationSensorAction, shareCIFSWriteMbps=shareCIFSWriteMbps, shareNFSReadIops=shareNFSReadIops, poolDataSizeLow=poolDataSizeLow, diskTotalReadIops=diskTotalReadIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiProperties=iscsiProperties, nfsTotalWriteMbps=nfsTotalWriteMbps, volumeDeleteFailed=volumeDeleteFailed, shareDataSizeHigh=shareDataSizeHigh, poolDataWriteLatency=poolDataWriteLatency, upgradeStarted=upgradeStarted, deleteFolderCompleted=deleteFolderCompleted, aclMigrationStarted=aclMigrationStarted, shareCreatedSuccessfully=shareCreatedSuccessfully, smisServiceStartFailed=smisServiceStartFailed, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolReadCacheWriteIops=poolReadCacheWriteIops, poolDataWriteIops=poolDataWriteIops, iscsiTotalReadMbps=iscsiTotalReadMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, tegile=tegile, cifsTotalWriteMbps=cifsTotalWriteMbps, controllerHardwareModel=controllerHardwareModel, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcAvgWriteLatency=fcAvgWriteLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, lunGUID=lunGUID, lunDataSizeHigh=lunDataSizeHigh, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolUsedSizeLow=poolUsedSizeLow, fcTargetIndex=fcTargetIndex, fcTargetReadIops=fcTargetReadIops, poolTotalReadIops=poolTotalReadIops, diskRandomIOCount=diskRandomIOCount, poolQuotaFinished=poolQuotaFinished, diagnosticDataUploaded=diagnosticDataUploaded, maintenanceModeDisabled=maintenanceModeDisabled, replicationTargetDeleted=replicationTargetDeleted, smisServiceStopFailed=smisServiceStopFailed, snapshotCloneCompleted=snapshotCloneCompleted, poolSizeHigh=poolSizeHigh, fcTotalWriteMbps=fcTotalWriteMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolDataReadLatency=poolDataReadLatency, iscsiTargets=iscsiTargets, poolName=poolName, cacheSSDReads=cacheSSDReads, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, globalStatistics=globalStatistics, notificationComponentName=notificationComponentName, shareCIFSReadIops=shareCIFSReadIops, diskIOCount=diskIOCount, nfsTotalWriteIops=nfsTotalWriteIops, haControllerA_Uptime=haControllerA_Uptime, lunSizeHigh=lunSizeHigh, iscsiInitiators=iscsiInitiators, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, shareNFSWriteLatency=shareNFSWriteLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, haResourceGroup=haResourceGroup, shareTable=shareTable, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcTargetsTable=fcTargetsTable, fcTargetGroup=fcTargetGroup, poolOwnerController=poolOwnerController, diskEntry=diskEntry, diskType=diskType, lunDedupEnabled=lunDedupEnabled, lunFreeSizeHigh=lunFreeSizeHigh, haControllerB_IPAddr=haControllerB_IPAddr, iscsiTargetWriteLatency=iscsiTargetWriteLatency, shareEntry=shareEntry, notificationReadingTriggerValue=notificationReadingTriggerValue, shareDeleted=shareDeleted, nfsAvgReadLatency=nfsAvgReadLatency, poolReadCacheWriteLatency=poolReadCacheWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, controllerTimeDrift=controllerTimeDrift, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiInitiatorsTable=iscsiInitiatorsTable, poolHealth=poolHealth, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, diskSlowIo=diskSlowIo, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolDataReadIops=poolDataReadIops, replicationSourceRegistered=replicationSourceRegistered, shareReservedSizeHigh=shareReservedSizeHigh, shareSnapshotSizeLow=shareSnapshotSizeLow, haControllerA_Name=haControllerA_Name, fcTotalReadIops=fcTotalReadIops, iscsiTargetReadIops=iscsiTargetReadIops, poolDegraded=poolDegraded, iscsiTargetsTable=iscsiTargetsTable, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetEntry=iscsiTargetEntry, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, nfsTotalReadIops=nfsTotalReadIops, upgradeDownloadFailed=upgradeDownloadFailed, lunIndex=lunIndex, poolIndex=poolIndex, iscsiTargetGroupError=iscsiTargetGroupError, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareMountPoint=shareMountPoint, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diskDataReadMbps=diskDataReadMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectFreeSizeLow=projectFreeSizeLow, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolProjectCount=poolProjectCount, tdpsUpgradeTimeout=tdpsUpgradeTimeout, deleteFolderFailed=deleteFolderFailed, tegileArray_notifications=tegileArray_notifications, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolCount=poolCount, diskSizeHigh=diskSizeHigh, lunCompressedRatio=lunCompressedRatio, snapshotCreationFailed=snapshotCreationFailed, poolFreeSizeLow=poolFreeSizeLow, notificationSeverity=notificationSeverity, networkInterfaceDown=networkInterfaceDown, fcTargetReadMbps=fcTargetReadMbps, shareCIFSWriteIops=shareCIFSWriteIops, notificationTargetEntityName=notificationTargetEntityName, poolFreeSizeHigh=poolFreeSizeHigh, shareCIFSEnabled=shareCIFSEnabled, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiTargetGroup=iscsiTargetGroup, network=network, projectFreeSizeHigh=projectFreeSizeHigh, projectLunCount=projectLunCount, diskTotalWriteIops=diskTotalWriteIops, volumeQuotaFinished=volumeQuotaFinished, maintenanceModeEnabled=maintenanceModeEnabled, upgradeCompleted=upgradeCompleted, haResourceActiveNode=haResourceActiveNode, adServerTimeDrift=adServerTimeDrift, smisServiceStarted=smisServiceStarted, projectEntry=projectEntry, poolDeleted=poolDeleted, shareCIFSWriteLatency=shareCIFSWriteLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, lunPoolName=lunPoolName, poolEntry=poolEntry, lunProjectName=lunProjectName, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, ipmiCurrent=ipmiCurrent, poolDataReadMbps=poolDataReadMbps, projectIndex=projectIndex, shareQuotaLow=shareQuotaLow, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, lunBlockSize=lunBlockSize, targetGroupCreateCompleted=targetGroupCreateCompleted, ipmiPowerSupply=ipmiPowerSupply)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetIndex=iscsiTargetIndex, shareQuotaFinished=shareQuotaFinished, haControllerB_Name=haControllerB_Name, snapshotRollbackCompleted=snapshotRollbackCompleted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, cifsAvgWriteLatency=cifsAvgWriteLatency, fcTotalReadMbps=fcTotalReadMbps, haControllerB_Uptime=haControllerB_Uptime, poolExported=poolExported, targetGroupMemberRemoved=targetGroupMemberRemoved, nicState=nicState, ntpServerTimeDrift=ntpServerTimeDrift, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareDataSizeLow=shareDataSizeLow, lunTable=lunTable, currentObjectGroup=currentObjectGroup, poolDataWriteMbps=poolDataWriteMbps, snapshotCloningFailed=snapshotCloningFailed, haResourceIndex=haResourceIndex, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolMetaReadLatency=poolMetaReadLatency, lunWriteLatency=lunWriteLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, diskTable=diskTable, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolMetaWriteLatency=poolMetaWriteLatency, cpuInterrupts=cpuInterrupts, haResourceStatus=haResourceStatus, poolMetaReadMbps=poolMetaReadMbps, tegileCompliances=tegileCompliances, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolExpanded=poolExpanded, ipmiTemperature=ipmiTemperature, fcTargetEntry=fcTargetEntry, shareDedupEnabled=shareDedupEnabled, poolReadCacheWriteMbps=poolReadCacheWriteMbps, replicationPaused=replicationPaused, fcInitiatorsTable=fcInitiatorsTable, projectDataSizeHigh=projectDataSizeHigh, diskGoneOffline=diskGoneOffline, sharePoolName=sharePoolName, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, volumeDeleteCompleted=volumeDeleteCompleted, aclMigrationCompleted=aclMigrationCompleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, shareCIFSReadLatency=shareCIFSReadLatency, targetGroupDeleteCompleted=targetGroupDeleteCompleted, networkIpmpGroupUp=networkIpmpGroupUp, shareName=shareName, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, snmpServiceStartFailed=snmpServiceStartFailed, lunName=lunName, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolTotalWriteMbps=poolTotalWriteMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectDedupEnabled=projectDedupEnabled, poolUpgraded=poolUpgraded, diskTotalReadMbps=diskTotalReadMbps, upgradeTimeout=upgradeTimeout, projectSnapshotSizeLow=projectSnapshotSizeLow, projectTotalSaving=projectTotalSaving, poolDeletionFailed=poolDeletionFailed, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareNFSReadLatency=shareNFSReadLatency, poolImported=poolImported, iscsiTargetWriteIops=iscsiTargetWriteIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, diskError=diskError, poolProjects=poolProjects, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, alertsCleanupCompleted=alertsCleanupCompleted, cacheRAMReads=cacheRAMReads, projectLUNs=projectLUNs, projectQuotaFinished=projectQuotaFinished, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, snmpServiceStopped=snmpServiceStopped, fcProperties=fcProperties, cacheTotalWriteMbps=cacheTotalWriteMbps, lunWriteIops=lunWriteIops, lunDataSizeLow=lunDataSizeLow, lunWriteMbps=lunWriteMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolAvgWriteLatency=poolAvgWriteLatency, projectShares=projectShares, nfsTotalReadMbps=nfsTotalReadMbps, poolMetaReadIops=poolMetaReadIops, iscsiWriteIops=iscsiWriteIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareQuotaHigh=shareQuotaHigh, replicationComplete=replicationComplete, cacheTotalReadMbps=cacheTotalReadMbps, replicationStarted=replicationStarted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunTargetGroup=lunTargetGroup, projectShareCount=projectShareCount, tegileArray=tegileArray, poolReadCacheReadLatency=poolReadCacheReadLatency, nicTransmitMbps=nicTransmitMbps, spareDiskReplaced=spareDiskReplaced, poolTotalSaving=poolTotalSaving, basicCompliance=basicCompliance, nicEntry=nicEntry, notificationProps=notificationProps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolAvgReadLatency=poolAvgReadLatency, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, upgradeDownloadStarted=upgradeDownloadStarted, networkTotalTransmitMbps=networkTotalTransmitMbps, cifsTotalReadIops=cifsTotalReadIops, poolReadCacheReadIops=poolReadCacheReadIops, controllerDown=controllerDown, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, haControllerA_IPAddr=haControllerA_IPAddr, projectPoolName=projectPoolName, fcTargets=fcTargets, lunReadMbps=lunReadMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunEntry=lunEntry, fcTotalWriteIops=fcTotalWriteIops, lunSnapshotSizeLow=lunSnapshotSizeLow, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiInitiatorName=iscsiInitiatorName, diskDataWriteIops=diskDataWriteIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, networkTotalReceiveMbps=networkTotalReceiveMbps, diskAvgReadLatency=diskAvgReadLatency, lunInitiatorGroup=lunInitiatorGroup, testNotification=testNotification, poolMetaWriteMbps=poolMetaWriteMbps, nicTable=nicTable, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiTargetName=iscsiTargetName, snapshotDeleteFailed=snapshotDeleteFailed, poolState=poolState, replicationFailed=replicationFailed, nicIndex=nicIndex, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, lunReadLatency=lunReadLatency, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, shareIndex=shareIndex, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, userLoginFailed=userLoginFailed, diskSizeLow=diskSizeLow, fcInitiatorName=fcInitiatorName, shareCompressionEnabled=shareCompressionEnabled, poolWriteCacheWriteIops=poolWriteCacheWriteIops, projectCompressionEnabled=projectCompressionEnabled, notificationReadingUnit=notificationReadingUnit, nicGroup=nicGroup, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunSizeLow=lunSizeLow, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiImproperTargetGroup=iscsiImproperTargetGroup, snmpServiceStarted=snmpServiceStarted, projectQuotaSizeLow=projectQuotaSizeLow, lunReservedSizeLow=lunReservedSizeLow, fcPortOffline=fcPortOffline, projectDeletionFailed=projectDeletionFailed, shareNFSEnabled=shareNFSEnabled, poolUsedSizeHigh=poolUsedSizeHigh, lunFreeSizeLow=lunFreeSizeLow, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, replicationAborted=replicationAborted, cacheTotalReadIops=cacheTotalReadIops, notificationThresholdTriggerValue=notificationThresholdTriggerValue, sensorFailureEvent=sensorFailureEvent, iscsiInitiatorGroup=iscsiInitiatorGroup, fcInitiatorEntry=fcInitiatorEntry, sanProperties=sanProperties, fcPortOnline=fcPortOnline, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, notificationDescription=notificationDescription, nicReceiveMbps=nicReceiveMbps, cacheTotalWriteIops=cacheTotalWriteIops, ipmiFan=ipmiFan, networkInterfaceUp=networkInterfaceUp, fcTargetWriteIops=fcTargetWriteIops, fcTargetName=fcTargetName, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, cifsAvgReadLatency=cifsAvgReadLatency, pools=pools, diskIndex=diskIndex, diskState=diskState, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectCreatedSuccessfully=projectCreatedSuccessfully, haResourceName=haResourceName, projectModified=projectModified, shareCIFSReadMbps=shareCIFSReadMbps, projectName=projectName, haResourceDescription=haResourceDescription, lunCompressionEnabled=lunCompressionEnabled, ipmiMemory=ipmiMemory, cpuTotalUsage=cpuTotalUsage, diskSequentialIOCount=diskSequentialIOCount, notificationSensorSuspect=notificationSensorSuspect, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskDataReadIops=diskDataReadIops, ipmiThreshold=ipmiThreshold, properties=properties, projectDataSizeLow=projectDataSizeLow, upgradeDownloadCompleted=upgradeDownloadCompleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, haResourceEntry=haResourceEntry, diskChassisIdx=diskChassisIdx, snmpServiceStopFailed=snmpServiceStopFailed, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiTargetAlias=iscsiTargetAlias, smisServiceStopped=smisServiceStopped, iscsiTotalReadIops=iscsiTotalReadIops)
