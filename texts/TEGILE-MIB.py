...
Counter64, IpAddress, Bits, TimeTicks, Counter32, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, MibIdentifier, Integer32, iso, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "Bits", "TimeTicks", "Counter32", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "MibIdentifier", "Integer32", "iso", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", projectCompressionEnabled=projectCompressionEnabled, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, diskTable=diskTable, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiInitiatorsTable=iscsiInitiatorsTable, shareSnapshotSizeLow=shareSnapshotSizeLow, shareNFSWriteIops=shareNFSWriteIops, shareDeleted=shareDeleted, iscsiInitiatorGroup=iscsiInitiatorGroup, replicationPaused=replicationPaused, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, lunProtocol=lunProtocol, diskState=diskState, projectQuotaFinished=projectQuotaFinished, deleteFolderCompleted=deleteFolderCompleted, network=network, poolHealth=poolHealth, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolReadCacheReadIops=poolReadCacheReadIops, poolTotalSaving=poolTotalSaving, fcTargetStatus=fcTargetStatus, poolProjectCount=poolProjectCount, diskIndex=diskIndex, nicIndex=nicIndex, poolName=poolName, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, controllerTimeDrift=controllerTimeDrift, poolFreeSizeHigh=poolFreeSizeHigh, diskDataReadMbps=diskDataReadMbps, projectTotalSaving=projectTotalSaving, poolTotalWriteMbps=poolTotalWriteMbps, snmpServiceStartFailed=snmpServiceStartFailed, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, haResourceName=haResourceName, cifsTotalWriteIops=cifsTotalWriteIops, shareDataSizeLow=shareDataSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, shareTable=shareTable, fcTargetIndex=fcTargetIndex, aclMigrationCompleted=aclMigrationCompleted, haControllerB_IPAddr=haControllerB_IPAddr, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nvdimmFailSoftError=nvdimmFailSoftError, projectEntry=projectEntry, lunDataSizeHigh=lunDataSizeHigh, iscsiInitiators=iscsiInitiators, poolTotalWriteIops=poolTotalWriteIops, projectFreeSizeLow=projectFreeSizeLow, volumeDeleteFailed=volumeDeleteFailed, poolUsedSizeLow=poolUsedSizeLow, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareProjectName=shareProjectName, iscsiTargetReadLatency=iscsiTargetReadLatency, notificationTargetEntityName=notificationTargetEntityName, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, notifications=notifications, ipmiTemperature=ipmiTemperature, iscsiTotalWriteMbps=iscsiTotalWriteMbps, snmpServiceStopFailed=snmpServiceStopFailed, poolDataWriteLatency=poolDataWriteLatency, diskDataWriteMbps=diskDataWriteMbps, poolOwnerController=poolOwnerController, shareNFSReadIops=shareNFSReadIops, shareCIFSWriteIops=shareCIFSWriteIops, lunCompressionEnabled=lunCompressionEnabled, haResourceDescription=haResourceDescription, properties=properties, snmpAgentVersion=snmpAgentVersion, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, userLoginFailed=userLoginFailed, cacheRAMReads=cacheRAMReads, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunCompressedRatio=lunCompressedRatio, haControllerB_Uptime=haControllerB_Uptime, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, iscsiTargetReadMbps=iscsiTargetReadMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, nfsAvgReadLatency=nfsAvgReadLatency, replicationStarted=replicationStarted, shareNFSWriteMbps=shareNFSWriteMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, unknownSensorEvent=unknownSensorEvent, haControllerB_Name=haControllerB_Name, fcTotalWriteIops=fcTotalWriteIops, diskCount=diskCount, poolDataSizeLow=poolDataSizeLow, shareNFSReadLatency=shareNFSReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiTotalReadMbps=iscsiTotalReadMbps, shareDeletionFailed=shareDeletionFailed, deleteFolderFailed=deleteFolderFailed, poolState=poolState, projectName=projectName, notificationEventCode=notificationEventCode, upgradeDownloadFailed=upgradeDownloadFailed, shareCompressionEnabled=shareCompressionEnabled, shareMountPoint=shareMountPoint, fcInitiatorName=fcInitiatorName, fcTargetReadLatency=fcTargetReadLatency, sharePoolName=sharePoolName, upgradeStarted=upgradeStarted, nicState=nicState, projectShares=projectShares, poolUsedSizeHigh=poolUsedSizeHigh, haResourceEntry=haResourceEntry, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareQuotaLow=shareQuotaLow, poolUpgraded=poolUpgraded, diskIsOnline=diskIsOnline, projectDataSizeLow=projectDataSizeLow, fcTotalReadIops=fcTotalReadIops, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, projectSnapshotSizeHigh=projectSnapshotSizeHigh, diskRandomIOCount=diskRandomIOCount, lunProjectName=lunProjectName, projectDataSizeHigh=projectDataSizeHigh, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiTargetReadIops=iscsiTargetReadIops, poolAvgReadLatency=poolAvgReadLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, vmwareNFSDatastores=vmwareNFSDatastores, nfsTotalWriteIops=nfsTotalWriteIops, basicCompliance=basicCompliance, targetGroupCreateCompleted=targetGroupCreateCompleted, ipmiThreshold=ipmiThreshold, diskDataWriteIops=diskDataWriteIops, iscsiProperties=iscsiProperties, poolCount=poolCount, poolAvgWriteLatency=poolAvgWriteLatency, tegileConformance=tegileConformance, projectLUNs=projectLUNs, poolFreeSizeLow=poolFreeSizeLow, poolImported=poolImported, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, replicationAborted=replicationAborted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, PYSNMP_MODULE_ID=tegile, poolTotalReadIops=poolTotalReadIops, cifsAvgReadLatency=cifsAvgReadLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, haControllerA_Name=haControllerA_Name, lunInitiatorGroup=lunInitiatorGroup, nvdimmFailUnknownError=nvdimmFailUnknownError, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, diskEntry=diskEntry, projectIndex=projectIndex, diskIOCount=diskIOCount, projectDeleted=projectDeleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, tdpsUpgradeFailed=tdpsUpgradeFailed, fcInitiatorsTable=fcInitiatorsTable, snapshotCreationFailed=snapshotCreationFailed, diskTotalReadIops=diskTotalReadIops, nicMTU=nicMTU, notificationTime=notificationTime, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiTargetGroup=iscsiTargetGroup, lunReadLatency=lunReadLatency, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectSnapshotSizeLow=projectSnapshotSizeLow, shareQuotaFinished=shareQuotaFinished, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, ipmiPowerSupply=ipmiPowerSupply, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, upgradeDownloadStarted=upgradeDownloadStarted, diskAvgReadLatency=diskAvgReadLatency, smisServiceStopped=smisServiceStopped, intelliFlashSoftwareUp=intelliFlashSoftwareUp, diskTotalWriteMbps=diskTotalWriteMbps, nicGroup=nicGroup, nvdimmFailInitializationError=nvdimmFailInitializationError, targetGroupDeleteCompleted=targetGroupDeleteCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, fcAvgWriteLatency=fcAvgWriteLatency, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, iscsiTargetAuth=iscsiTargetAuth, iscsiTargetsTable=iscsiTargetsTable, haResourceActiveNode=haResourceActiveNode, networkTotalTransmitMbps=networkTotalTransmitMbps, nicName=nicName, lunPoolName=lunPoolName, notificationProps=notificationProps, fcInitiatorGroup=fcInitiatorGroup, currentNotificationGroup=currentNotificationGroup, nvdimmFailDeviceError=nvdimmFailDeviceError, poolDataReadLatency=poolDataReadLatency, aclMigrationStarted=aclMigrationStarted, diskSizeHigh=diskSizeHigh, maintenanceModeEnabled=maintenanceModeEnabled, iscsiTotalReadIops=iscsiTotalReadIops, ipmiOther=ipmiOther, cpuInterrupts=cpuInterrupts, shareCIFSEnabled=shareCIFSEnabled, ipmiVoltage=ipmiVoltage, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, haControllerA_Uptime=haControllerA_Uptime, diagnosticDataUploaded=diagnosticDataUploaded, poolMetaWriteIops=poolMetaWriteIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, haResourcesTable=haResourcesTable, snapshotCloningFailed=snapshotCloningFailed, replicationSourceRegistered=replicationSourceRegistered, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolReadCacheWriteMbps=poolReadCacheWriteMbps, replicationTargetDeleted=replicationTargetDeleted, cpuTotalUsage=cpuTotalUsage, shareCIFSReadMbps=shareCIFSReadMbps, fcTargetGroup=fcTargetGroup, iscsiAvgWriteLatency=iscsiAvgWriteLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolSizeLow=poolSizeLow, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunWriteLatency=lunWriteLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, diskPoolName=diskPoolName, poolMetaWriteLatency=poolMetaWriteLatency, haResources=haResources, poolReadCacheWriteIops=poolReadCacheWriteIops, lunFreeSizeHigh=lunFreeSizeHigh, fcTargetEntry=fcTargetEntry, poolDataWriteMbps=poolDataWriteMbps, controllerUp=controllerUp, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectPoolName=projectPoolName, nicEntry=nicEntry, iscsiTargetGroupError=iscsiTargetGroupError, lunDataSizeLow=lunDataSizeLow, poolDeletionFailed=poolDeletionFailed, fcTargetsTable=fcTargetsTable, poolDeleted=poolDeleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, webdocsUpgradeCompleted=webdocsUpgradeCompleted, volumeModifyCompleted=volumeModifyCompleted, diskDataReadIops=diskDataReadIops, projectTable=projectTable, haControllerA_IPAddr=haControllerA_IPAddr, lunWriteIops=lunWriteIops, diskSlowIo=diskSlowIo, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, notificationSensorAction=notificationSensorAction, poolMetaReadMbps=poolMetaReadMbps, smbSocketFailure=smbSocketFailure, fcPortOffline=fcPortOffline, lunEntry=lunEntry, tegileGroups=tegileGroups, fcTotalReadMbps=fcTotalReadMbps, fcInitiatorEntry=fcInitiatorEntry, iscsiAvgReadLatency=iscsiAvgReadLatency)
mibBuilder.exportSymbols("TEGILE-MIB", lunGUID=lunGUID, shareEntry=shareEntry, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, ipmiFan=ipmiFan, controllerHardwareModel=controllerHardwareModel, spareDiskReplaced=spareDiskReplaced, iscsiTargetAlias=iscsiTargetAlias, cifsTotalReadMbps=cifsTotalReadMbps, cifsTotalReadIops=cifsTotalReadIops, fcTargetWriteLatency=fcTargetWriteLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunSizeLow=lunSizeLow, lunSnapshotSizeLow=lunSnapshotSizeLow, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskError=diskError, fcTargetModifyCompleted=fcTargetModifyCompleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunIndex=lunIndex, maintenanceModeDisabled=maintenanceModeDisabled, lunDedupEnabled=lunDedupEnabled, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareQuotaHigh=shareQuotaHigh, shareDedupEnabled=shareDedupEnabled, diskGoneOffline=diskGoneOffline, upgradeFailed=upgradeFailed, shareIndex=shareIndex, networkInterfaceDown=networkInterfaceDown, lunReadMbps=lunReadMbps, fcInitiatorIndex=fcInitiatorIndex, poolTable=poolTable, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareCIFSWriteLatency=shareCIFSWriteLatency, nicTable=nicTable, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, nicTransmitMbps=nicTransmitMbps, poolDataReadIops=poolDataReadIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, haResourceIndex=haResourceIndex, poolCreated=poolCreated, shareCompressedRatio=shareCompressedRatio, tegile=tegile, fcTargetName=fcTargetName, snapshotDeleteFailed=snapshotDeleteFailed, shareDataSizeHigh=shareDataSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, diskTotalWriteIops=diskTotalWriteIops, notificationDescription=notificationDescription, iscsiInitiatorEntry=iscsiInitiatorEntry, upgradeCompleted=upgradeCompleted, cacheTotalReadIops=cacheTotalReadIops, haResourceStatus=haResourceStatus, tegileArray_notifications=tegileArray_notifications, lunReservedSizeLow=lunReservedSizeLow, notificationSensorNumber=notificationSensorNumber, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunReadIops=lunReadIops, cifsTotalWriteMbps=cifsTotalWriteMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, fcTargetWriteIops=fcTargetWriteIops, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiTargetName=iscsiTargetName, volumeQuotaFinished=volumeQuotaFinished, cacheSSDReads=cacheSSDReads, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, ntpServerTimeDrift=ntpServerTimeDrift, diskTotalReadMbps=diskTotalReadMbps, sensorFailureEvent=sensorFailureEvent, adServerTimeDrift=adServerTimeDrift, lunBlockSize=lunBlockSize, shareCIFSWriteMbps=shareCIFSWriteMbps, shareNFSEnabled=shareNFSEnabled, lunTargetGroup=lunTargetGroup, iscsiInitiatorName=iscsiInitiatorName, iscsiTargetIndex=iscsiTargetIndex, poolTotalReadMbps=poolTotalReadMbps, projectModified=projectModified, snapshotCloneCompleted=snapshotCloneCompleted, iscsiWriteIops=iscsiWriteIops, fcTargetReadMbps=fcTargetReadMbps, lunWriteMbps=lunWriteMbps, haResourceGroup=haResourceGroup, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolExported=poolExported, volumeDeleteCompleted=volumeDeleteCompleted, snmpServiceStarted=snmpServiceStarted, fcTotalWriteMbps=fcTotalWriteMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolMetaWriteMbps=poolMetaWriteMbps, networkIpmpGroupUp=networkIpmpGroupUp, projectShareCount=projectShareCount, notificationReadingUnit=notificationReadingUnit, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, iscsiTargetEntry=iscsiTargetEntry, fcAvgReadLatency=fcAvgReadLatency, diskSizeLow=diskSizeLow, poolQuotaFinished=poolQuotaFinished, smisServiceStopFailed=smisServiceStopFailed, fcPortOnline=fcPortOnline, notificationComponentName=notificationComponentName, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareCIFSReadLatency=shareCIFSReadLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolDataReadMbps=poolDataReadMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, notificationObjects=notificationObjects, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, nfsTotalReadIops=nfsTotalReadIops, poolDataWriteIops=poolDataWriteIops, currentObjectGroup=currentObjectGroup, controllerDown=controllerDown, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskChassisIdx=diskChassisIdx, cacheTotalWriteIops=cacheTotalWriteIops, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, replicationAbandoned=replicationAbandoned, tegileArray=tegileArray, webdocsUpgradeFailed=webdocsUpgradeFailed, pools=pools, shareSnapshotSizeHigh=shareSnapshotSizeHigh, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, fcProperties=fcProperties, notificationThresholdTriggerValue=notificationThresholdTriggerValue, replicationComplete=replicationComplete, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, notificationReadingTriggerValue=notificationReadingTriggerValue, notificationSensorSuspect=notificationSensorSuspect, globalStatistics=globalStatistics, cpuSystemCalls=cpuSystemCalls, poolMetaReadLatency=poolMetaReadLatency, replicationFailed=replicationFailed, smisServiceStarted=smisServiceStarted, shareNFSReadMbps=shareNFSReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, fcInitiators=fcInitiators, sanProperties=sanProperties, cifsAvgWriteLatency=cifsAvgWriteLatency, ipmiCurrent=ipmiCurrent, poolDataSizeHigh=poolDataSizeHigh, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolDegraded=poolDegraded, diskType=diskType, shareName=shareName, memoryFailure=memoryFailure, lunName=lunName, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, smisServiceStartFailed=smisServiceStartFailed, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolProjects=poolProjects, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetReadIops=fcTargetReadIops, netbiosSocketFailure=netbiosSocketFailure, poolEntry=poolEntry, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, nfsTotalReadMbps=nfsTotalReadMbps, nicReceiveMbps=nicReceiveMbps, poolIndex=poolIndex, lunSizeHigh=lunSizeHigh, lunTable=lunTable, notificationSeverity=notificationSeverity, projectQuotaSizeLow=projectQuotaSizeLow, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, disks=disks, projectDedupEnabled=projectDedupEnabled, cacheTotalReadMbps=cacheTotalReadMbps, networkInterfaceUp=networkInterfaceUp, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, upgradeTimeout=upgradeTimeout, snmpServiceStopped=snmpServiceStopped, tegileCompliances=tegileCompliances, shareNFSWriteLatency=shareNFSWriteLatency, diskSequentialIOCount=diskSequentialIOCount, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectDeletionFailed=projectDeletionFailed, iscsiTargets=iscsiTargets, diskAlias=diskAlias, lunReservedSizeHigh=lunReservedSizeHigh, snapshotRollbackFailed=snapshotRollbackFailed, poolMetaReadIops=poolMetaReadIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareReservedSizeHigh=shareReservedSizeHigh, poolExpanded=poolExpanded, targetGroupMemberAdded=targetGroupMemberAdded, poolSizeHigh=poolSizeHigh, alertsCleanupCompleted=alertsCleanupCompleted, projectLunCount=projectLunCount, cacheTotalWriteMbps=cacheTotalWriteMbps, projectThresholdExceedWarning=projectThresholdExceedWarning, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, testNotification=testNotification, ipmiMemory=ipmiMemory, iscsiTargetWriteIops=iscsiTargetWriteIops, projectFreeSizeHigh=projectFreeSizeHigh, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, fcTargets=fcTargets, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, networkIpmpGroupDown=networkIpmpGroupDown, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunFreeSizeLow=lunFreeSizeLow, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiTargetError=iscsiTargetError, replicationResumed=replicationResumed, shareReservedSizeLow=shareReservedSizeLow, shareCIFSReadIops=shareCIFSReadIops)
