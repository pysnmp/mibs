...
ObjectIdentity, ModuleIdentity, iso, Bits, enterprises, Counter64, Unsigned32, Counter32, IpAddress, TimeTicks, Gauge32, NotificationType, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "iso", "Bits", "enterprises", "Counter64", "Unsigned32", "Counter32", "IpAddress", "TimeTicks", "Gauge32", "NotificationType", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TEGILE-MIB", replicationComplete=replicationComplete, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, networkIpmpGroupUp=networkIpmpGroupUp, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diskDataReadIops=diskDataReadIops, poolImported=poolImported, poolMetaWriteIops=poolMetaWriteIops, haResourceName=haResourceName, iscsiTargetError=iscsiTargetError, replicationFailed=replicationFailed, lunFreeSizeLow=lunFreeSizeLow, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, fcTargetWriteIops=fcTargetWriteIops, lunDataSizeLow=lunDataSizeLow, network=network, poolDataWriteLatency=poolDataWriteLatency, fcAvgWriteLatency=fcAvgWriteLatency, sharePoolName=sharePoolName, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, lunSizeLow=lunSizeLow, notifications=notifications, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, ipmiCriticalInterrupt=ipmiCriticalInterrupt, memoryFailure=memoryFailure, poolQuotaFinished=poolQuotaFinished, nicIndex=nicIndex, upgradeDownloadFailed=upgradeDownloadFailed, diskSequentialIOCount=diskSequentialIOCount, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolReadCacheReadMbps=poolReadCacheReadMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolAvgReadLatency=poolAvgReadLatency, replicationAbandoned=replicationAbandoned, poolCount=poolCount, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareDeletionFailed=shareDeletionFailed, snapshotRollbackFailed=snapshotRollbackFailed, unknownSensorEvent=unknownSensorEvent, poolDataReadLatency=poolDataReadLatency, networkInterfaceDown=networkInterfaceDown, diskChassisIdx=diskChassisIdx, poolUsedSizeHigh=poolUsedSizeHigh, controllerTimeDrift=controllerTimeDrift, haControllerA_Uptime=haControllerA_Uptime, fcInitiators=fcInitiators, diskTotalReadMbps=diskTotalReadMbps, fcTargetEntry=fcTargetEntry, shareNFSWriteMbps=shareNFSWriteMbps, haResourceIndex=haResourceIndex, iscsiTotalReadIops=iscsiTotalReadIops, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiInitiatorsTable=iscsiInitiatorsTable, upgradeCompleted=upgradeCompleted, shareIndex=shareIndex, poolProjects=poolProjects, snmpServiceStopped=snmpServiceStopped, fcTargetReadLatency=fcTargetReadLatency, replicationResumed=replicationResumed, projectDedupEnabled=projectDedupEnabled, poolExpanded=poolExpanded, nfsAvgWriteLatency=nfsAvgWriteLatency, projectQuotaFinished=projectQuotaFinished, ipmiVoltage=ipmiVoltage, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, haResourcesTable=haResourcesTable, shareCIFSReadMbps=shareCIFSReadMbps, controllerHardwareModel=controllerHardwareModel, cifsAvgReadLatency=cifsAvgReadLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, nicTransmitMbps=nicTransmitMbps, projectDeleted=projectDeleted, networkTotalReceiveMbps=networkTotalReceiveMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectDataSizeLow=projectDataSizeLow, shareNFSReadIops=shareNFSReadIops, shareNFSEnabled=shareNFSEnabled, disks=disks, projectCreatedSuccessfully=projectCreatedSuccessfully, lunWriteLatency=lunWriteLatency, poolReadCacheReadIops=poolReadCacheReadIops, nicName=nicName, smisServiceStartFailed=smisServiceStartFailed, fcTotalReadIops=fcTotalReadIops, netbiosSocketFailure=netbiosSocketFailure, networkIpmpGroupDown=networkIpmpGroupDown, diskType=diskType, lunGUID=lunGUID, shareDeleted=shareDeleted, shareNFSWriteLatency=shareNFSWriteLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, nicGroup=nicGroup, fcPortOnline=fcPortOnline, poolExported=poolExported, notificationReadingUnit=notificationReadingUnit, projectSnapshotSizeLow=projectSnapshotSizeLow, lunIndex=lunIndex, cacheTotalWriteIops=cacheTotalWriteIops, fcTargetIndex=fcTargetIndex, haControllerA_Name=haControllerA_Name, poolTotalReadIops=poolTotalReadIops, sanProperties=sanProperties, iscsiAvgWriteLatency=iscsiAvgWriteLatency, nvdimmFailInitializationError=nvdimmFailInitializationError, lunFreeSizeHigh=lunFreeSizeHigh, diskTable=diskTable, iscsiInitiatorIndex=iscsiInitiatorIndex, poolDataSizeLow=poolDataSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, shareCompressionEnabled=shareCompressionEnabled, tegileConformance=tegileConformance, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, ipmiTemperature=ipmiTemperature, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolTotalWriteMbps=poolTotalWriteMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiProperties=iscsiProperties, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskIndex=diskIndex, poolTotalReadMbps=poolTotalReadMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, cacheRAMReads=cacheRAMReads, projectPoolName=projectPoolName, volumeCreatedSuccessfully=volumeCreatedSuccessfully, replicationTargetDeleted=replicationTargetDeleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcInitiatorName=fcInitiatorName, nicTable=nicTable, diskSizeHigh=diskSizeHigh, poolCreated=poolCreated, targetGroupDeleteCompleted=targetGroupDeleteCompleted, lunWriteIops=lunWriteIops, nfsTotalReadIops=nfsTotalReadIops, projectShareCount=projectShareCount, lunReservedSizeHigh=lunReservedSizeHigh, lunReadIops=lunReadIops, upgradeDownloadStarted=upgradeDownloadStarted, fcTotalReadMbps=fcTotalReadMbps, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, diskDataWriteIops=diskDataWriteIops, projectCompressionEnabled=projectCompressionEnabled, shareSnapshotSizeLow=shareSnapshotSizeLow, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, ipmiPowerSupply=ipmiPowerSupply, deleteFolderCompleted=deleteFolderCompleted, iscsiTargetWriteIops=iscsiTargetWriteIops, poolUpgraded=poolUpgraded, fcTotalWriteIops=fcTotalWriteIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectQuotaSizeLow=projectQuotaSizeLow, iscsiTargetAuth=iscsiTargetAuth, spareDiskReplaced=spareDiskReplaced, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, nvdimmFailDeviceError=nvdimmFailDeviceError, replicationAborted=replicationAborted, notificationTime=notificationTime, aclMigrationCompleted=aclMigrationCompleted, projectName=projectName, shareTable=shareTable, currentObjectGroup=currentObjectGroup, shareCreatedSuccessfully=shareCreatedSuccessfully, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, upgradeTimeout=upgradeTimeout, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, tegileArray=tegileArray, projectEntry=projectEntry, lunReadMbps=lunReadMbps, fcInitiatorsTable=fcInitiatorsTable, haControllerA_IPAddr=haControllerA_IPAddr, poolDeleted=poolDeleted, snapshotDeleteFailed=snapshotDeleteFailed, fcTargetReadMbps=fcTargetReadMbps, projectSnapshotSizeHigh=projectSnapshotSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareCompressedRatio=shareCompressedRatio, snapshotRollbackCompleted=snapshotRollbackCompleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, diskTotalWriteIops=diskTotalWriteIops, volumeDeleteFailed=volumeDeleteFailed, haResourceDescription=haResourceDescription, ipmiOther=ipmiOther, alertsCleanupCompleted=alertsCleanupCompleted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareNFSReadLatency=shareNFSReadLatency, lunDataSizeHigh=lunDataSizeHigh, poolDataReadMbps=poolDataReadMbps, lunBlockSize=lunBlockSize, nicEntry=nicEntry, poolSizeLow=poolSizeLow, maintenanceModeEnabled=maintenanceModeEnabled, notificationEventCode=notificationEventCode, shareEntry=shareEntry, nvdimmFailSoftError=nvdimmFailSoftError, snmpServiceStartFailed=snmpServiceStartFailed, webdocsUpgradeFailed=webdocsUpgradeFailed, poolMetaReadLatency=poolMetaReadLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, diskError=diskError, snapshotCloningFailed=snapshotCloningFailed, snmpServiceStopFailed=snmpServiceStopFailed, nfsTotalReadMbps=nfsTotalReadMbps, shareQuotaFinished=shareQuotaFinished, haResourceStatus=haResourceStatus, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectShares=projectShares, snmpAgentVersion=snmpAgentVersion, lunPoolName=lunPoolName, controllerDown=controllerDown, poolEntry=poolEntry, poolTotalWriteIops=poolTotalWriteIops, iscsiTargetName=iscsiTargetName, pools=pools, notificationSensorSuspect=notificationSensorSuspect, iscsiTargetGroupError=iscsiTargetGroupError, cifsTotalReadMbps=cifsTotalReadMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, fcTargetGroup=fcTargetGroup, tdpsUpgradeFailed=tdpsUpgradeFailed, fcInitiatorIndex=fcInitiatorIndex, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, lunWriteMbps=lunWriteMbps, fcTargetStatus=fcTargetStatus, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolDegraded=poolDegraded, haResourceEntry=haResourceEntry, upgradeStarted=upgradeStarted, poolDataWriteMbps=poolDataWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, basicCompliance=basicCompliance, controllerUp=controllerUp, fcTargetModifyCompleted=fcTargetModifyCompleted, replicationPaused=replicationPaused, networkTotalTransmitMbps=networkTotalTransmitMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcPortOffline=fcPortOffline, upgradeFailed=upgradeFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, haControllerB_Name=haControllerB_Name, projectLUNs=projectLUNs, diskSlowIo=diskSlowIo, diskSizeLow=diskSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiTargetIndex=iscsiTargetIndex, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolDataSizeHigh=poolDataSizeHigh, tegileCompliances=tegileCompliances, ipmiCurrent=ipmiCurrent, networkInterfaceUp=networkInterfaceUp, globalStatistics=globalStatistics, shareCIFSWriteIops=shareCIFSWriteIops, poolAvgWriteLatency=poolAvgWriteLatency, projectFreeSizeLow=projectFreeSizeLow, projectTotalSaving=projectTotalSaving)
mibBuilder.exportSymbols("TEGILE-MIB", nvdimmFailUnknownError=nvdimmFailUnknownError, cifsTotalReadIops=cifsTotalReadIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTargetsTable=iscsiTargetsTable, cpuTotalUsage=cpuTotalUsage, diskCount=diskCount, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunSizeHigh=lunSizeHigh, iscsiTargetReadLatency=iscsiTargetReadLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, poolProjectCount=poolProjectCount, testNotification=testNotification, diskTotalReadIops=diskTotalReadIops, diskPoolName=diskPoolName, tegileGroups=tegileGroups, diskAvgReadLatency=diskAvgReadLatency, shareNFSReadMbps=shareNFSReadMbps, targetGroupMemberAdded=targetGroupMemberAdded, diskIsOnline=diskIsOnline, diskDataReadMbps=diskDataReadMbps, ipmiFan=ipmiFan, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, replicationSourceRegistered=replicationSourceRegistered, poolReadCacheReadLatency=poolReadCacheReadLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, fcTargetsTable=fcTargetsTable, iscsiInitiatorGroup=iscsiInitiatorGroup, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, smisServiceStarted=smisServiceStarted, iscsiInitiatorName=iscsiInitiatorName, lunSnapshotSizeHigh=lunSnapshotSizeHigh, notificationObjects=notificationObjects, notificationReadingTriggerValue=notificationReadingTriggerValue, poolMetaReadIops=poolMetaReadIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiTargetReadMbps=iscsiTargetReadMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectTable=projectTable, cacheSSDReads=cacheSSDReads, cacheTotalWriteMbps=cacheTotalWriteMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskIOCount=diskIOCount, lunCompressedRatio=lunCompressedRatio, notificationTargetEntityName=notificationTargetEntityName, snapshotCreationFailed=snapshotCreationFailed, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, currentNotificationGroup=currentNotificationGroup, lunReadLatency=lunReadLatency, sensorFailureEvent=sensorFailureEvent, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiWriteIops=iscsiWriteIops, shareName=shareName, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunSnapshotSizeLow=lunSnapshotSizeLow, fcTargetName=fcTargetName, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareNFSWriteIops=shareNFSWriteIops, iscsiInitiatorEntry=iscsiInitiatorEntry, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, shareReservedSizeLow=shareReservedSizeLow, haControllerB_IPAddr=haControllerB_IPAddr, iscsiTargetAlias=iscsiTargetAlias, poolState=poolState, shareQuotaLow=shareQuotaLow, poolDataWriteIops=poolDataWriteIops, projectModified=projectModified, poolHealth=poolHealth, poolIndex=poolIndex, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, iscsiAvgReadLatency=iscsiAvgReadLatency, diskAlias=diskAlias, projectQuotaSizeHigh=projectQuotaSizeHigh, volumeQuotaFinished=volumeQuotaFinished, ntpServerTimeDrift=ntpServerTimeDrift, adServerTimeDrift=adServerTimeDrift, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, shareDataSizeHigh=shareDataSizeHigh, shareCIFSEnabled=shareCIFSEnabled, diagnosticDataUploaded=diagnosticDataUploaded, lunName=lunName, iscsiInitiators=iscsiInitiators, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, nfsTotalWriteIops=nfsTotalWriteIops, cacheTotalReadIops=cacheTotalReadIops, iscsiTotalReadMbps=iscsiTotalReadMbps, maintenanceModeDisabled=maintenanceModeDisabled, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolDataReadIops=poolDataReadIops, nfsAvgReadLatency=nfsAvgReadLatency, cpuSystemCalls=cpuSystemCalls, shareQuotaHigh=shareQuotaHigh, iscsiTargets=iscsiTargets, haResourceActiveNode=haResourceActiveNode, poolFreeSizeHigh=poolFreeSizeHigh, ipmiThreshold=ipmiThreshold, fcAvgReadLatency=fcAvgReadLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, notificationComponentName=notificationComponentName, shareProjectName=shareProjectName, fcProperties=fcProperties, diskRandomIOCount=diskRandomIOCount, diskTotalWriteMbps=diskTotalWriteMbps, haResourceGroup=haResourceGroup, volumeDeleteCompleted=volumeDeleteCompleted, haResources=haResources, diskState=diskState, PYSNMP_MODULE_ID=tegile, upgradeDownloadCompleted=upgradeDownloadCompleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, snmpServiceStarted=snmpServiceStarted, tegile=tegile, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, haControllerB_Uptime=haControllerB_Uptime, projectLunCount=projectLunCount, lunEntry=lunEntry, cacheTotalReadMbps=cacheTotalReadMbps, notificationProps=notificationProps, ipmiMemory=ipmiMemory, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, targetGroupMemberRemoved=targetGroupMemberRemoved, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, nicMTU=nicMTU, lunCompressionEnabled=lunCompressionEnabled, lunProjectName=lunProjectName, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTargetReadIops=iscsiTargetReadIops, smbSocketFailure=smbSocketFailure, snapshotCloneCompleted=snapshotCloneCompleted, poolTotalSaving=poolTotalSaving, shareCIFSReadIops=shareCIFSReadIops, aclMigrationStarted=aclMigrationStarted, diskAvgWriteLatency=diskAvgWriteLatency, smisServiceStopped=smisServiceStopped, shareCIFSWriteMbps=shareCIFSWriteMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolOwnerController=poolOwnerController, notificationSeverity=notificationSeverity, notificationThresholdTriggerValue=notificationThresholdTriggerValue, lunInitiatorGroup=lunInitiatorGroup, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, tegileArray_notifications=tegileArray_notifications, shareDedupEnabled=shareDedupEnabled, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunTable=lunTable, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, replicationStarted=replicationStarted, lunTargetGroup=lunTargetGroup, poolDeletionFailed=poolDeletionFailed, poolMetaReadMbps=poolMetaReadMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolSizeHigh=poolSizeHigh, shareReservedSizeHigh=shareReservedSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareDataSizeLow=shareDataSizeLow, lunDedupEnabled=lunDedupEnabled, poolMetaWriteMbps=poolMetaWriteMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, nicReceiveMbps=nicReceiveMbps, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolTable=poolTable, iscsiTargetEntry=iscsiTargetEntry, iscsiImproperTargetGroup=iscsiImproperTargetGroup, smisServiceStopFailed=smisServiceStopFailed, fcTargetReadIops=fcTargetReadIops, notificationDescription=notificationDescription, lunProtocol=lunProtocol, cifsTotalWriteIops=cifsTotalWriteIops, notificationSensorAction=notificationSensorAction, cifsAvgWriteLatency=cifsAvgWriteLatency, notificationSensorNumber=notificationSensorNumber, nicState=nicState, fcTargetWriteLatency=fcTargetWriteLatency, fcTargets=fcTargets, volumeModifyCompleted=volumeModifyCompleted, properties=properties, poolMetaWriteLatency=poolMetaWriteLatency, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolName=poolName, projectFreeSizeHigh=projectFreeSizeHigh, diskEntry=diskEntry, poolFreeSizeLow=poolFreeSizeLow, projectDeletionFailed=projectDeletionFailed, deleteFolderFailed=deleteFolderFailed, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, userLoginFailed=userLoginFailed, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareMountPoint=shareMountPoint, fcInitiatorGroup=fcInitiatorGroup, poolUsedSizeLow=poolUsedSizeLow, fcTargetWriteMbps=fcTargetWriteMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, diskGoneOffline=diskGoneOffline, diskDataWriteMbps=diskDataWriteMbps, fcInitiatorEntry=fcInitiatorEntry, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiTargetGroup=iscsiTargetGroup, shareCIFSWriteLatency=shareCIFSWriteLatency, projectDataSizeHigh=projectDataSizeHigh, lunReservedSizeLow=lunReservedSizeLow, fcTotalWriteMbps=fcTotalWriteMbps, cpuInterrupts=cpuInterrupts, projectIndex=projectIndex, cifsTotalWriteMbps=cifsTotalWriteMbps)
