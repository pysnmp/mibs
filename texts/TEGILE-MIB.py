...
Gauge32, enterprises, iso, TimeTicks, MibIdentifier, NotificationType, Unsigned32, Integer32, Counter64, Bits, Counter32, ObjectIdentity, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "iso", "TimeTicks", "MibIdentifier", "NotificationType", "Unsigned32", "Integer32", "Counter64", "Bits", "Counter32", "ObjectIdentity", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunSizeHigh=lunSizeHigh, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, controllerDown=controllerDown, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolState=poolState, shareNFSWriteLatency=shareNFSWriteLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareNFSReadLatency=shareNFSReadLatency, upgradeCompleted=upgradeCompleted, poolDeletionFailed=poolDeletionFailed, sharePoolName=sharePoolName, fcTargetIndex=fcTargetIndex, ipmiVoltage=ipmiVoltage, diskTotalWriteIops=diskTotalWriteIops, lunWriteIops=lunWriteIops, haResources=haResources, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareTable=shareTable, diskGoneOffline=diskGoneOffline, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolExported=poolExported, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, sensorFailureEvent=sensorFailureEvent, upgradeTimeout=upgradeTimeout, diskTotalReadIops=diskTotalReadIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, replicationResumed=replicationResumed, diskPoolName=diskPoolName, nfsAvgWriteLatency=nfsAvgWriteLatency, maintenanceModeEnabled=maintenanceModeEnabled, shareNFSWriteIops=shareNFSWriteIops, notificationDescription=notificationDescription, networkTotalReceiveMbps=networkTotalReceiveMbps, replicationPaused=replicationPaused, webdocsUpgradeFailed=webdocsUpgradeFailed, projectSnapshotSizeHigh=projectSnapshotSizeHigh, ipmiCriticalInterrupt=ipmiCriticalInterrupt, snapshotCloningFailed=snapshotCloningFailed, fcTargetReadIops=fcTargetReadIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, notificationComponentName=notificationComponentName, projectEntry=projectEntry, haResourceEntry=haResourceEntry, shareDedupEnabled=shareDedupEnabled, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, snmpServiceStopFailed=snmpServiceStopFailed, shareQuotaHigh=shareQuotaHigh, projectShares=projectShares, shareQuotaFinished=shareQuotaFinished, shareProjectName=shareProjectName, networkIpmpGroupDown=networkIpmpGroupDown, targetGroupDeleteCompleted=targetGroupDeleteCompleted, cacheRAMReads=cacheRAMReads, diagnosticDataUploaded=diagnosticDataUploaded, haControllerB_IPAddr=haControllerB_IPAddr, notificationSeverity=notificationSeverity, fcInitiatorName=fcInitiatorName, diskError=diskError, lunProtocol=lunProtocol, fcTargetWriteMbps=fcTargetWriteMbps, diskIndex=diskIndex, iscsiTotalReadIops=iscsiTotalReadIops, poolFreeSizeHigh=poolFreeSizeHigh, notificationSensorNumber=notificationSensorNumber, nvdimmFailUnknownError=nvdimmFailUnknownError, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, shareCIFSReadIops=shareCIFSReadIops, fcInitiatorsTable=fcInitiatorsTable, snmpServiceStopped=snmpServiceStopped, shareQuotaLow=shareQuotaLow, diskChassisIdx=diskChassisIdx, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, deleteFolderFailed=deleteFolderFailed, poolReadCacheReadLatency=poolReadCacheReadLatency, fcInitiators=fcInitiators, projectDeletionFailed=projectDeletionFailed, unknownSensorEvent=unknownSensorEvent, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, volumeQuotaFinished=volumeQuotaFinished, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcInitiatorIndex=fcInitiatorIndex, shareName=shareName, cacheTotalReadMbps=cacheTotalReadMbps, volumeDeleteCompleted=volumeDeleteCompleted, volumeModifyCompleted=volumeModifyCompleted, projectTable=projectTable, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcPortOffline=fcPortOffline, aclMigrationStarted=aclMigrationStarted, cacheTotalReadIops=cacheTotalReadIops, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolTotalWriteMbps=poolTotalWriteMbps, haControllerB_Uptime=haControllerB_Uptime, notificationSensorSuspect=notificationSensorSuspect, cpuTotalUsage=cpuTotalUsage, snapshotRollbackCompleted=snapshotRollbackCompleted, maintenanceModeDisabled=maintenanceModeDisabled, notifications=notifications, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcTotalWriteIops=fcTotalWriteIops, shareSnapshotSizeLow=shareSnapshotSizeLow, fcProperties=fcProperties, poolDataReadIops=poolDataReadIops, poolName=poolName, tegileArray_notifications=tegileArray_notifications, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, projectTotalSaving=projectTotalSaving, tegileArray=tegileArray, fcTotalReadIops=fcTotalReadIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiInitiatorEntry=iscsiInitiatorEntry, lunFreeSizeLow=lunFreeSizeLow, adServerTimeDrift=adServerTimeDrift, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, smisServiceStartFailed=smisServiceStartFailed, projectModified=projectModified, haResourceIndex=haResourceIndex, projectName=projectName, diskSequentialIOCount=diskSequentialIOCount, cifsAvgWriteLatency=cifsAvgWriteLatency, netbiosSocketFailure=netbiosSocketFailure, shareReservedSizeHigh=shareReservedSizeHigh, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareNFSEnabled=shareNFSEnabled, nicGroup=nicGroup, haResourceGroup=haResourceGroup, upgradeFailed=upgradeFailed, ipmiFan=ipmiFan, memoryFailure=memoryFailure, networkInterfaceUp=networkInterfaceUp, iscsiAvgWriteLatency=iscsiAvgWriteLatency, haResourceStatus=haResourceStatus, snapshotDeleteFailed=snapshotDeleteFailed, cpuInterrupts=cpuInterrupts, lunReadMbps=lunReadMbps, snmpServiceStarted=snmpServiceStarted, poolDataWriteIops=poolDataWriteIops, shareCIFSReadLatency=shareCIFSReadLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTargetGroupError=iscsiTargetGroupError, targetGroupMemberRemoved=targetGroupMemberRemoved, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiTargetName=iscsiTargetName, nvdimmFailSoftError=nvdimmFailSoftError, projectDedupEnabled=projectDedupEnabled, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareCompressedRatio=shareCompressedRatio, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, shareEntry=shareEntry, shareDeleted=shareDeleted, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolQuotaFinished=poolQuotaFinished, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, cifsTotalReadMbps=cifsTotalReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiInitiators=iscsiInitiators, poolOwnerController=poolOwnerController, poolDataReadMbps=poolDataReadMbps, lunReadIops=lunReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, notificationTargetEntityName=notificationTargetEntityName, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiTargetReadIops=iscsiTargetReadIops, projectFreeSizeHigh=projectFreeSizeHigh, deleteFolderCompleted=deleteFolderCompleted, poolCreated=poolCreated, tegileCompliances=tegileCompliances, poolUsedSizeHigh=poolUsedSizeHigh, fcTargetWriteIops=fcTargetWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcAvgWriteLatency=fcAvgWriteLatency, fcInitiatorEntry=fcInitiatorEntry, shareCIFSWriteIops=shareCIFSWriteIops, shareMountPoint=shareMountPoint, poolTotalWriteIops=poolTotalWriteIops, projectSnapshotSizeLow=projectSnapshotSizeLow, fcTargetName=fcTargetName, haResourcesTable=haResourcesTable, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, PYSNMP_MODULE_ID=tegile, projectThresholdExceedWarning=projectThresholdExceedWarning, poolTotalReadMbps=poolTotalReadMbps, poolImported=poolImported, nicTable=nicTable, lunCompressedRatio=lunCompressedRatio, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskDataReadMbps=diskDataReadMbps, poolMetaWriteMbps=poolMetaWriteMbps, tdpsUpgradeFailed=tdpsUpgradeFailed, ipmiTemperature=ipmiTemperature, poolProjectCount=poolProjectCount, diskType=diskType, smisServiceStarted=smisServiceStarted, poolMetaWriteIops=poolMetaWriteIops, ipmiOther=ipmiOther, haResourceName=haResourceName, cacheTotalWriteMbps=cacheTotalWriteMbps, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, snapshotCloneCompleted=snapshotCloneCompleted, lunTable=lunTable, poolDataReadLatency=poolDataReadLatency, cacheTotalWriteIops=cacheTotalWriteIops, fcTotalReadMbps=fcTotalReadMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, volumeDeleteFailed=volumeDeleteFailed, currentNotificationGroup=currentNotificationGroup, intelliFlashSoftwareDown=intelliFlashSoftwareDown, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcTargets=fcTargets, lunReservedSizeHigh=lunReservedSizeHigh, iscsiInitiatorGroup=iscsiInitiatorGroup, nicMTU=nicMTU, poolAvgReadLatency=poolAvgReadLatency, nicName=nicName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, globalStatistics=globalStatistics, poolMetaReadLatency=poolMetaReadLatency, lunIndex=lunIndex, shareReservedSizeLow=shareReservedSizeLow, controllerUp=controllerUp, projectCompressionEnabled=projectCompressionEnabled, projectPoolName=projectPoolName, notificationEventCode=notificationEventCode, lunTargetGroup=lunTargetGroup, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, haControllerA_IPAddr=haControllerA_IPAddr, diskSizeHigh=diskSizeHigh, iscsiTargetIndex=iscsiTargetIndex, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, diskEntry=diskEntry, diskState=diskState, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, nicState=nicState, cifsAvgReadLatency=cifsAvgReadLatency, poolMetaWriteLatency=poolMetaWriteLatency, haResourceActiveNode=haResourceActiveNode, upgradeStarted=upgradeStarted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, currentObjectGroup=currentObjectGroup, haControllerA_Uptime=haControllerA_Uptime, shareCreatedSuccessfully=shareCreatedSuccessfully, nicTransmitMbps=nicTransmitMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, nicEntry=nicEntry)
mibBuilder.exportSymbols("TEGILE-MIB", shareNFSReadMbps=shareNFSReadMbps, diskSlowIo=diskSlowIo, lunEntry=lunEntry, snapshotCreationFailed=snapshotCreationFailed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, iscsiInitiatorsTable=iscsiInitiatorsTable, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, iscsiTargetEntry=iscsiTargetEntry, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, lunReservedSizeLow=lunReservedSizeLow, poolReadCacheWriteIops=poolReadCacheWriteIops, pools=pools, smisServiceStopped=smisServiceStopped, projectDataSizeHigh=projectDataSizeHigh, fcTargetWriteLatency=fcTargetWriteLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, fcInitiatorGroup=fcInitiatorGroup, fcTargetsTable=fcTargetsTable, cifsTotalWriteMbps=cifsTotalWriteMbps, replicationFailed=replicationFailed, fcTargetEntry=fcTargetEntry, iscsiTargetWriteIops=iscsiTargetWriteIops, lunWriteMbps=lunWriteMbps, ipmiCurrent=ipmiCurrent, iscsiTargetError=iscsiTargetError, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolReadCacheReadIops=poolReadCacheReadIops, networkIpmpGroupUp=networkIpmpGroupUp, iscsiTargetGroup=iscsiTargetGroup, targetGroupMemberAdded=targetGroupMemberAdded, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolDataWriteLatency=poolDataWriteLatency, ipmiMemory=ipmiMemory, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareNFSReadIops=shareNFSReadIops, diskAvgReadLatency=diskAvgReadLatency, lunProjectName=lunProjectName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolUsedSizeLow=poolUsedSizeLow, smisServiceStopFailed=smisServiceStopFailed, notificationProps=notificationProps, ipmiThreshold=ipmiThreshold, shareDeletionFailed=shareDeletionFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskAvgWriteLatency=diskAvgWriteLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiInitiatorName=iscsiInitiatorName, nfsTotalWriteIops=nfsTotalWriteIops, diskRandomIOCount=diskRandomIOCount, snmpAgentVersion=snmpAgentVersion, poolSizeLow=poolSizeLow, lunSizeLow=lunSizeLow, projectQuotaSizeLow=projectQuotaSizeLow, fcTargetReadMbps=fcTargetReadMbps, notificationSensorAction=notificationSensorAction, iscsiTotalReadMbps=iscsiTotalReadMbps, projectDeleted=projectDeleted, diskDataWriteMbps=diskDataWriteMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTotalWriteMbps=fcTotalWriteMbps, projectDataSizeLow=projectDataSizeLow, diskDataWriteIops=diskDataWriteIops, poolAvgWriteLatency=poolAvgWriteLatency, projectLunCount=projectLunCount, cacheSSDReads=cacheSSDReads, diskAlias=diskAlias, testNotification=testNotification, lunInitiatorGroup=lunInitiatorGroup, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, networkInterfaceDown=networkInterfaceDown, iscsiTargetAuth=iscsiTargetAuth, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, tegileGroups=tegileGroups, shareIndex=shareIndex, poolTotalSaving=poolTotalSaving, iscsiWriteIops=iscsiWriteIops, lunWriteLatency=lunWriteLatency, replicationComplete=replicationComplete, iscsiTotalWriteMbps=iscsiTotalWriteMbps, replicationAbandoned=replicationAbandoned, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, cifsTotalReadIops=cifsTotalReadIops, poolIndex=poolIndex, projectQuotaFinished=projectQuotaFinished, shareNFSWriteMbps=shareNFSWriteMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, diskDataReadIops=diskDataReadIops, ntpServerTimeDrift=ntpServerTimeDrift, nvdimmFailInitializationError=nvdimmFailInitializationError, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, haControllerA_Name=haControllerA_Name, fcTargetModifyCompleted=fcTargetModifyCompleted, diskIOCount=diskIOCount, poolMetaReadMbps=poolMetaReadMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, lunReadLatency=lunReadLatency, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, shareCIFSEnabled=shareCIFSEnabled, nfsTotalReadMbps=nfsTotalReadMbps, haResourceDescription=haResourceDescription, notificationThresholdTriggerValue=notificationThresholdTriggerValue, haControllerB_Name=haControllerB_Name, poolEntry=poolEntry, poolDataSizeHigh=poolDataSizeHigh, snmpServiceStartFailed=snmpServiceStartFailed, notificationObjects=notificationObjects, diskSizeLow=diskSizeLow, nicReceiveMbps=nicReceiveMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, cifsTotalWriteIops=cifsTotalWriteIops, projectFreeSizeLow=projectFreeSizeLow, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, notificationTime=notificationTime, shareExceedThresholdWarning=shareExceedThresholdWarning, properties=properties, projectQuotaSizeHigh=projectQuotaSizeHigh, fcTargetReadLatency=fcTargetReadLatency, lunBlockSize=lunBlockSize, poolDeleted=poolDeleted, disks=disks, smbSocketFailure=smbSocketFailure, controllerTimeDrift=controllerTimeDrift, poolFreeSizeLow=poolFreeSizeLow, snapshotRollbackFailed=snapshotRollbackFailed, diskTotalWriteMbps=diskTotalWriteMbps, diskTotalReadMbps=diskTotalReadMbps, notificationReadingUnit=notificationReadingUnit, vmwareNFSDatastores=vmwareNFSDatastores, replicationTargetDeleted=replicationTargetDeleted, replicationSourceRegistered=replicationSourceRegistered, poolCount=poolCount, poolTotalReadIops=poolTotalReadIops, poolSizeHigh=poolSizeHigh, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolMetaReadIops=poolMetaReadIops, nfsTotalWriteMbps=nfsTotalWriteMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolDataWriteMbps=poolDataWriteMbps, iscsiTargetAlias=iscsiTargetAlias, upgradeDownloadCompleted=upgradeDownloadCompleted, userLoginFailed=userLoginFailed, lunFreeSizeHigh=lunFreeSizeHigh, iscsiTargetsTable=iscsiTargetsTable, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareCompressionEnabled=shareCompressionEnabled, basicCompliance=basicCompliance, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, spareDiskReplaced=spareDiskReplaced, fcTargetGroup=fcTargetGroup, nfsTotalReadIops=nfsTotalReadIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, replicationAborted=replicationAborted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolTable=poolTable, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, diskTable=diskTable, aclMigrationCompleted=aclMigrationCompleted, nfsAvgReadLatency=nfsAvgReadLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunName=lunName, fcPortOnline=fcPortOnline, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, upgradeDownloadStarted=upgradeDownloadStarted, lunGUID=lunGUID, lunDedupEnabled=lunDedupEnabled, ipmiPowerSupply=ipmiPowerSupply, lunDataSizeLow=lunDataSizeLow, lunCompressionEnabled=lunCompressionEnabled, projectIndex=projectIndex, iscsiTargets=iscsiTargets, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, targetGroupCreateCompleted=targetGroupCreateCompleted, fcAvgReadLatency=fcAvgReadLatency, lunPoolName=lunPoolName, nicIndex=nicIndex, tegileConformance=tegileConformance, replicationStarted=replicationStarted, sanProperties=sanProperties, shareDataSizeLow=shareDataSizeLow, poolProjects=poolProjects, poolDataSizeLow=poolDataSizeLow, network=network, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolExpanded=poolExpanded, fcTargetStatus=fcTargetStatus, lunDataSizeHigh=lunDataSizeHigh, poolDegraded=poolDegraded, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiInitiatorChapUser=iscsiInitiatorChapUser, iscsiProperties=iscsiProperties, shareDataSizeHigh=shareDataSizeHigh, tegile=tegile, poolHealth=poolHealth, projectShareCount=projectShareCount, nvdimmFailDeviceError=nvdimmFailDeviceError, alertsCleanupCompleted=alertsCleanupCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, controllerHardwareModel=controllerHardwareModel, shareCIFSReadMbps=shareCIFSReadMbps, diskCount=diskCount, cpuSystemCalls=cpuSystemCalls, volumeCreatedSuccessfully=volumeCreatedSuccessfully, diskIsOnline=diskIsOnline, poolUpgraded=poolUpgraded, projectLUNs=projectLUNs)
