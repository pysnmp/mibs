...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:58:53 2021
...
enterprises, Counter32, Integer32, ModuleIdentity, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, Gauge32, Counter64, MibIdentifier, Bits, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Integer32", "ModuleIdentity", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "Gauge32", "Counter64", "MibIdentifier", "Bits", "iso", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolQuotaFinished=poolQuotaFinished, aclMigrationCompleted=aclMigrationCompleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, ipmiTemperature=ipmiTemperature, nfsTotalWriteIops=nfsTotalWriteIops, poolTotalWriteMbps=poolTotalWriteMbps, diskDataWriteMbps=diskDataWriteMbps, shareNFSReadMbps=shareNFSReadMbps, iscsiTargetName=iscsiTargetName, projectName=projectName, snapshotRollbackFailed=snapshotRollbackFailed, diskDataWriteIops=diskDataWriteIops, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareCIFSReadIops=shareCIFSReadIops, lunIndex=lunIndex, haControllerA_Uptime=haControllerA_Uptime, cacheTotalWriteIops=cacheTotalWriteIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, snmpServiceStartFailed=snmpServiceStartFailed, iscsiAvgWriteLatency=iscsiAvgWriteLatency, tegile=tegile, diskTotalReadIops=diskTotalReadIops, nvdimmFailSoftError=nvdimmFailSoftError, userLoginFailed=userLoginFailed, poolTotalReadMbps=poolTotalReadMbps, shareIndex=shareIndex, iscsiInitiatorsTable=iscsiInitiatorsTable, iscsiTargets=iscsiTargets, pools=pools, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolExported=poolExported, targetGroupCreateCompleted=targetGroupCreateCompleted, shareNFSWriteIops=shareNFSWriteIops, fcTargetReadIops=fcTargetReadIops, webdocsUpgradeFailed=webdocsUpgradeFailed, haControllerB_Uptime=haControllerB_Uptime, haResourceEntry=haResourceEntry, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareDataSizeLow=shareDataSizeLow, smisServiceStopFailed=smisServiceStopFailed, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, cacheTotalReadIops=cacheTotalReadIops, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, testNotification=testNotification, diskIsOnline=diskIsOnline, fcTargetWriteIops=fcTargetWriteIops, poolDeletionFailed=poolDeletionFailed, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunGUID=lunGUID, nfsTotalReadIops=nfsTotalReadIops, fcTotalWriteIops=fcTotalWriteIops, diskRandomIOCount=diskRandomIOCount, shareCIFSWriteMbps=shareCIFSWriteMbps, smisServiceStarted=smisServiceStarted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunSizeHigh=lunSizeHigh, lunSnapshotSizeLow=lunSnapshotSizeLow, poolImported=poolImported, fcInitiators=fcInitiators, notificationProps=notificationProps, iscsiTargetGroup=iscsiTargetGroup, iscsiInitiatorEntry=iscsiInitiatorEntry, notificationTargetEntityName=notificationTargetEntityName, iscsiInitiatorName=iscsiInitiatorName, replicationResumed=replicationResumed, fcInitiatorCreateFailed=fcInitiatorCreateFailed, shareCIFSEnabled=shareCIFSEnabled, fcProperties=fcProperties, upgradeCompleted=upgradeCompleted, shareQuotaHigh=shareQuotaHigh, poolUpgraded=poolUpgraded, notificationSensorAction=notificationSensorAction, shareMountPoint=shareMountPoint, poolName=poolName, aclMigrationStarted=aclMigrationStarted, diskTotalWriteMbps=diskTotalWriteMbps, shareCompressionEnabled=shareCompressionEnabled, lunDataSizeHigh=lunDataSizeHigh, poolReadCacheReadIops=poolReadCacheReadIops, projectTotalSaving=projectTotalSaving, shareQuotaLow=shareQuotaLow, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiTargetAuth=iscsiTargetAuth, poolDegraded=poolDegraded, poolDataReadMbps=poolDataReadMbps, poolUsedSizeHigh=poolUsedSizeHigh, diskSlowIo=diskSlowIo, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiTargetReadIops=iscsiTargetReadIops, poolMetaWriteLatency=poolMetaWriteLatency, nfsAvgReadLatency=nfsAvgReadLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, upgradeDownloadStarted=upgradeDownloadStarted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, nicIndex=nicIndex, fcTargetReadMbps=fcTargetReadMbps, poolDataReadLatency=poolDataReadLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, shareNFSWriteMbps=shareNFSWriteMbps, fcInitiatorsTable=fcInitiatorsTable, projectDeleted=projectDeleted, notificationTime=notificationTime, notificationReadingUnit=notificationReadingUnit, spareDiskReplaced=spareDiskReplaced, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, iscsiTargetEntry=iscsiTargetEntry, fcInitiatorGroup=fcInitiatorGroup, haResourceIndex=haResourceIndex, diskState=diskState, poolReadCacheWriteIops=poolReadCacheWriteIops, poolEntry=poolEntry, shareCIFSWriteLatency=shareCIFSWriteLatency, upgradeStarted=upgradeStarted, sensorFailureEvent=sensorFailureEvent, fcTargetModifyCompleted=fcTargetModifyCompleted, lunEntry=lunEntry, iscsiTargetIndex=iscsiTargetIndex, iscsiTargetWriteIops=iscsiTargetWriteIops, shareCompressedRatio=shareCompressedRatio, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, lunFreeSizeHigh=lunFreeSizeHigh, currentObjectGroup=currentObjectGroup, replicationAborted=replicationAborted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, lunReadIops=lunReadIops, diskPoolName=diskPoolName, poolTotalReadIops=poolTotalReadIops, projectCreatedSuccessfully=projectCreatedSuccessfully, diskIOCount=diskIOCount, shareDeleted=shareDeleted, haControllerA_IPAddr=haControllerA_IPAddr, diskType=diskType, haResourceDescription=haResourceDescription, properties=properties, tegileCompliances=tegileCompliances, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, nfsTotalReadMbps=nfsTotalReadMbps, notificationEventCode=notificationEventCode, snmpServiceStopped=snmpServiceStopped, notificationSensorSuspect=notificationSensorSuspect, projectDeletionFailed=projectDeletionFailed, upgradeTimeout=upgradeTimeout, iscsiTargetReadMbps=iscsiTargetReadMbps, nicEntry=nicEntry, fcTargetEntry=fcTargetEntry, notificationObjects=notificationObjects, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, deleteFolderCompleted=deleteFolderCompleted, fcTargetStatus=fcTargetStatus, replicationFailed=replicationFailed, poolCreated=poolCreated, sanProperties=sanProperties, cpuSystemCalls=cpuSystemCalls, diskIndex=diskIndex, tdpsUpgradeFailed=tdpsUpgradeFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskCount=diskCount, lunReservedSizeLow=lunReservedSizeLow, projectEntry=projectEntry, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, lunWriteMbps=lunWriteMbps, fcPortOffline=fcPortOffline, diskChassisIdx=diskChassisIdx, haResourceGroup=haResourceGroup, shareReservedSizeLow=shareReservedSizeLow, projectDedupEnabled=projectDedupEnabled, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, disks=disks, fcAvgWriteLatency=fcAvgWriteLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareDeletionFailed=shareDeletionFailed, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareTable=shareTable, nfsTotalWriteMbps=nfsTotalWriteMbps, projectShareCount=projectShareCount, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareNFSReadLatency=shareNFSReadLatency, networkIpmpGroupDown=networkIpmpGroupDown, poolDataWriteLatency=poolDataWriteLatency, shareNFSReadIops=shareNFSReadIops, haResources=haResources, iscsiInitiators=iscsiInitiators, vmwareNFSDatastores=vmwareNFSDatastores, projectSnapshotSizeLow=projectSnapshotSizeLow, projectFreeSizeHigh=projectFreeSizeHigh, poolProjects=poolProjects, nicMTU=nicMTU, memoryFailure=memoryFailure, diskAvgWriteLatency=diskAvgWriteLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, upgradeDownloadFailed=upgradeDownloadFailed, poolDataWriteIops=poolDataWriteIops, iscsiWriteIops=iscsiWriteIops, poolUsedSizeLow=poolUsedSizeLow, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcTotalReadIops=fcTotalReadIops, projectCompressionEnabled=projectCompressionEnabled, fcInitiatorName=fcInitiatorName, targetGroupDeleteCompleted=targetGroupDeleteCompleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, cacheSSDReads=cacheSSDReads, iscsiTargetWriteMbps=iscsiTargetWriteMbps, targetGroupMemberAdded=targetGroupMemberAdded, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolDeleted=poolDeleted, tegileGroups=tegileGroups, nicState=nicState, diagnosticDataUploaded=diagnosticDataUploaded, diskAlias=diskAlias, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolAvgWriteLatency=poolAvgWriteLatency, lunWriteLatency=lunWriteLatency, lunFreeSizeLow=lunFreeSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, cifsTotalWriteIops=cifsTotalWriteIops, poolState=poolState, diskSizeLow=diskSizeLow, replicationTargetDeleted=replicationTargetDeleted, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolCount=poolCount, projectModified=projectModified, maintenanceModeEnabled=maintenanceModeEnabled, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, webdocsUpgradeCompleted=webdocsUpgradeCompleted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunProtocol=lunProtocol, snapshotCreationFailed=snapshotCreationFailed, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, tegileArray_notifications=tegileArray_notifications, nicTransmitMbps=nicTransmitMbps, projectTable=projectTable, fcTargetGroup=fcTargetGroup, fcTargetWriteLatency=fcTargetWriteLatency, poolSizeHigh=poolSizeHigh, fcTargetReadLatency=fcTargetReadLatency, notifications=notifications, replicationComplete=replicationComplete, snmpServiceStarted=snmpServiceStarted, lunProjectName=lunProjectName, poolMetaWriteMbps=poolMetaWriteMbps, fcTargetWriteMbps=fcTargetWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, nicTable=nicTable, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, poolTotalWriteIops=poolTotalWriteIops)
mibBuilder.exportSymbols("TEGILE-MIB", cifsTotalWriteMbps=cifsTotalWriteMbps, network=network, haControllerB_Name=haControllerB_Name, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, diskSequentialIOCount=diskSequentialIOCount, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, networkTotalReceiveMbps=networkTotalReceiveMbps, projectDataSizeHigh=projectDataSizeHigh, notificationComponentName=notificationComponentName, fcAvgReadLatency=fcAvgReadLatency, sharePoolName=sharePoolName, poolMetaReadLatency=poolMetaReadLatency, ipmiPowerSupply=ipmiPowerSupply, iscsiTargetGroupError=iscsiTargetGroupError, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, replicationAbandoned=replicationAbandoned, deleteFolderFailed=deleteFolderFailed, snmpAgentVersion=snmpAgentVersion, haControllerA_Name=haControllerA_Name, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, replicationStarted=replicationStarted, shareDedupEnabled=shareDedupEnabled, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolFreeSizeLow=poolFreeSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, fcTargetsTable=fcTargetsTable, shareDataSizeHigh=shareDataSizeHigh, fcInitiatorIndex=fcInitiatorIndex, volumeCreatedSuccessfully=volumeCreatedSuccessfully, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, PYSNMP_MODULE_ID=tegile, notificationDescription=notificationDescription, poolExpanded=poolExpanded, projectLunCount=projectLunCount, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolDataWriteMbps=poolDataWriteMbps, diskTotalWriteIops=diskTotalWriteIops, ipmiVoltage=ipmiVoltage, nvdimmFailDeviceError=nvdimmFailDeviceError, networkIpmpGroupUp=networkIpmpGroupUp, shareName=shareName, poolHealth=poolHealth, cifsAvgReadLatency=cifsAvgReadLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiTotalReadIops=iscsiTotalReadIops, projectQuotaFinished=projectQuotaFinished, poolMetaReadMbps=poolMetaReadMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, diskTable=diskTable, shareEntry=shareEntry, projectLUNs=projectLUNs, controllerHardwareModel=controllerHardwareModel, diskDataReadIops=diskDataReadIops, ipmiThreshold=ipmiThreshold, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiImproperTargetGroup=iscsiImproperTargetGroup, ipmiFan=ipmiFan, smisServiceStartFailed=smisServiceStartFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, ntpServerTimeDrift=ntpServerTimeDrift, projectIndex=projectIndex, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, cifsTotalReadMbps=cifsTotalReadMbps, iscsiTargetAlias=iscsiTargetAlias, nfsAvgWriteLatency=nfsAvgWriteLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, maintenanceModeDisabled=maintenanceModeDisabled, projectFreeSizeLow=projectFreeSizeLow, replicationPaused=replicationPaused, nicName=nicName, shareCIFSReadMbps=shareCIFSReadMbps, fcTargetIndex=fcTargetIndex, iscsiProperties=iscsiProperties, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareNFSWriteLatency=shareNFSWriteLatency, notificationSeverity=notificationSeverity, poolProjectCount=poolProjectCount, projectQuotaSizeLow=projectQuotaSizeLow, haResourcesTable=haResourcesTable, tegileArray=tegileArray, haResourceActiveNode=haResourceActiveNode, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, lunPoolName=lunPoolName, iscsiTargetReadLatency=iscsiTargetReadLatency, poolDataSizeLow=poolDataSizeLow, iscsiAvgReadLatency=iscsiAvgReadLatency, lunReservedSizeHigh=lunReservedSizeHigh, fcTargetName=fcTargetName, fcPortOnline=fcPortOnline, diskSizeHigh=diskSizeHigh, snapshotCloningFailed=snapshotCloningFailed, cpuInterrupts=cpuInterrupts, lunReadLatency=lunReadLatency, fcInitiatorEntry=fcInitiatorEntry, cacheTotalWriteMbps=cacheTotalWriteMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, networkInterfaceDown=networkInterfaceDown, cacheTotalReadMbps=cacheTotalReadMbps, haResourceStatus=haResourceStatus, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, basicCompliance=basicCompliance, lunDataSizeLow=lunDataSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, diskEntry=diskEntry, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, lunDedupEnabled=lunDedupEnabled, diskDataReadMbps=diskDataReadMbps, smbSocketFailure=smbSocketFailure, shareNFSEnabled=shareNFSEnabled, projectShares=projectShares, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, cacheRAMReads=cacheRAMReads, tegileConformance=tegileConformance, poolReadCacheWriteMbps=poolReadCacheWriteMbps, shareReservedSizeHigh=shareReservedSizeHigh, notificationSensorNumber=notificationSensorNumber, netbiosSocketFailure=netbiosSocketFailure, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunCompressionEnabled=lunCompressionEnabled, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunTargetGroup=lunTargetGroup, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, iscsiTargetError=iscsiTargetError, poolMetaWriteIops=poolMetaWriteIops, volumeModifyCompleted=volumeModifyCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, snmpServiceStopFailed=snmpServiceStopFailed, fcTargets=fcTargets, poolMetaReadIops=poolMetaReadIops, adServerTimeDrift=adServerTimeDrift, poolIndex=poolIndex, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, controllerTimeDrift=controllerTimeDrift, replicationSourceRegistered=replicationSourceRegistered, unknownSensorEvent=unknownSensorEvent, diskError=diskError, shareSnapshotSizeHigh=shareSnapshotSizeHigh, nicReceiveMbps=nicReceiveMbps, haControllerB_IPAddr=haControllerB_IPAddr, currentNotificationGroup=currentNotificationGroup, cpuTotalUsage=cpuTotalUsage, cifsTotalReadIops=cifsTotalReadIops, ipmiOther=ipmiOther, poolDataReadIops=poolDataReadIops, poolSizeLow=poolSizeLow, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, diskGoneOffline=diskGoneOffline, networkTotalTransmitMbps=networkTotalTransmitMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, ipmiCurrent=ipmiCurrent, diskAvgReadLatency=diskAvgReadLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolDataSizeHigh=poolDataSizeHigh, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectPoolName=projectPoolName, iscsiTotalReadMbps=iscsiTotalReadMbps, projectDataSizeLow=projectDataSizeLow, volumeDeleteFailed=volumeDeleteFailed, globalStatistics=globalStatistics, lunCompressedRatio=lunCompressedRatio, shareQuotaFinished=shareQuotaFinished, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, cifsAvgWriteLatency=cifsAvgWriteLatency, poolOwnerController=poolOwnerController, snapshotDeleteFailed=snapshotDeleteFailed, controllerDown=controllerDown, poolFreeSizeHigh=poolFreeSizeHigh, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiTargetsTable=iscsiTargetsTable, lunName=lunName, poolAvgReadLatency=poolAvgReadLatency, alertsCleanupCompleted=alertsCleanupCompleted, smisServiceStopped=smisServiceStopped, fcTotalWriteMbps=fcTotalWriteMbps, volumeDeleteCompleted=volumeDeleteCompleted, poolTotalSaving=poolTotalSaving, snapshotCloneCompleted=snapshotCloneCompleted, nicGroup=nicGroup, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, notificationThresholdTriggerValue=notificationThresholdTriggerValue, upgradeFailed=upgradeFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunSizeLow=lunSizeLow, lunInitiatorGroup=lunInitiatorGroup, iscsiTotalWriteMbps=iscsiTotalWriteMbps, ipmiMemory=ipmiMemory, poolWriteCacheWriteIops=poolWriteCacheWriteIops, controllerUp=controllerUp, volumeQuotaFinished=volumeQuotaFinished, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, networkInterfaceUp=networkInterfaceUp, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareProjectName=shareProjectName, fcTotalReadMbps=fcTotalReadMbps, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, lunReadMbps=lunReadMbps, diskTotalReadMbps=diskTotalReadMbps, poolTable=poolTable, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, targetGroupMemberRemoved=targetGroupMemberRemoved, lunBlockSize=lunBlockSize, haResourceName=haResourceName, lunTable=lunTable, lunWriteIops=lunWriteIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareCIFSWriteIops=shareCIFSWriteIops)
