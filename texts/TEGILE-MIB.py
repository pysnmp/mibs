...
# Produced by pysmi-1.1.3 at Mon Nov 22 20:05:00 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, Bits, Gauge32, Counter32, ObjectIdentity, TimeTicks, Counter64, Unsigned32, IpAddress, ModuleIdentity, NotificationType, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "Bits", "Gauge32", "Counter32", "ObjectIdentity", "TimeTicks", "Counter64", "Unsigned32", "IpAddress", "ModuleIdentity", "NotificationType", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunSizeLow=lunSizeLow, lunDataSizeLow=lunDataSizeLow, diskTotalReadIops=diskTotalReadIops, iscsiTargetWriteIops=iscsiTargetWriteIops, lunTable=lunTable, tegileArray_notifications=tegileArray_notifications, projectFreeSizeHigh=projectFreeSizeHigh, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, adServerTimeDrift=adServerTimeDrift, vmwareNFSDatastores=vmwareNFSDatastores, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolDegraded=poolDegraded, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolEntry=poolEntry, diskTotalReadMbps=diskTotalReadMbps, nfsTotalWriteIops=nfsTotalWriteIops, replicationFailed=replicationFailed, haControllerA_Uptime=haControllerA_Uptime, replicationSourceRegistered=replicationSourceRegistered, projectQuotaFinished=projectQuotaFinished, lunReadIops=lunReadIops, poolReadCacheReadIops=poolReadCacheReadIops, projectCompressionEnabled=projectCompressionEnabled, projectSnapshotSizeLow=projectSnapshotSizeLow, fcTargetName=fcTargetName, lunCompressedRatio=lunCompressedRatio, replicationComplete=replicationComplete, nvdimmFailUnknownError=nvdimmFailUnknownError, snapshotRollbackFailed=snapshotRollbackFailed, notificationProps=notificationProps, iscsiTargetIndex=iscsiTargetIndex, shareQuotaFinished=shareQuotaFinished, lunTargetGroup=lunTargetGroup, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, memoryFailure=memoryFailure, projectDedupEnabled=projectDedupEnabled, notificationSensorNumber=notificationSensorNumber, haControllerA_Name=haControllerA_Name, diskTotalWriteMbps=diskTotalWriteMbps, diskState=diskState, notifications=notifications, shareProjectName=shareProjectName, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, tdpsUpgradeFailed=tdpsUpgradeFailed, poolHealth=poolHealth, ipmiVoltage=ipmiVoltage, fcProperties=fcProperties, diskError=diskError, projectLUNs=projectLUNs, diskDataReadIops=diskDataReadIops, fcAvgWriteLatency=fcAvgWriteLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, poolUsedSizeLow=poolUsedSizeLow, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, projectThresholdExceedWarning=projectThresholdExceedWarning, poolUsedSizeHigh=poolUsedSizeHigh, diskTable=diskTable, iscsiTargetReadMbps=iscsiTargetReadMbps, alertsCleanupCompleted=alertsCleanupCompleted, iscsiTargetName=iscsiTargetName, poolExported=poolExported, poolDataReadMbps=poolDataReadMbps, nicName=nicName, notificationEventCode=notificationEventCode, projectTable=projectTable, iscsiInitiatorChapUser=iscsiInitiatorChapUser, lunProtocol=lunProtocol, currentNotificationGroup=currentNotificationGroup, projectShares=projectShares, poolState=poolState, diskGoneOffline=diskGoneOffline, shareCIFSReadIops=shareCIFSReadIops, shareEntry=shareEntry, smisServiceStartFailed=smisServiceStartFailed, globalStatistics=globalStatistics, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, lunWriteMbps=lunWriteMbps, shareCIFSWriteIops=shareCIFSWriteIops, poolIndex=poolIndex, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTargetWriteLatency=iscsiTargetWriteLatency, volumeQuotaFinished=volumeQuotaFinished, diskPoolName=diskPoolName, currentObjectGroup=currentObjectGroup, projectPoolName=projectPoolName, poolDeletionFailed=poolDeletionFailed, poolSizeLow=poolSizeLow, poolTotalSaving=poolTotalSaving, ipmiCurrent=ipmiCurrent, iscsiInitiatorsTable=iscsiInitiatorsTable, upgradeTimeout=upgradeTimeout, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, haControllerB_IPAddr=haControllerB_IPAddr, upgradeDownloadStarted=upgradeDownloadStarted, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, iscsiTargets=iscsiTargets, projectIndex=projectIndex, targetGroupMemberRemoved=targetGroupMemberRemoved, cpuInterrupts=cpuInterrupts, nfsAvgReadLatency=nfsAvgReadLatency, ipmiPowerSupply=ipmiPowerSupply, haControllerB_Name=haControllerB_Name, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, controllerHardwareModel=controllerHardwareModel, fcTotalWriteIops=fcTotalWriteIops, ntpServerTimeDrift=ntpServerTimeDrift, smisServiceStopFailed=smisServiceStopFailed, shareNFSWriteIops=shareNFSWriteIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, fcTargetWriteMbps=fcTargetWriteMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, upgradeStarted=upgradeStarted, snapshotDeleteFailed=snapshotDeleteFailed, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, diagnosticDataUploaded=diagnosticDataUploaded, snmpServiceStartFailed=snmpServiceStartFailed, lunReadLatency=lunReadLatency, diskDataWriteMbps=diskDataWriteMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, replicationResumed=replicationResumed, fcTotalReadIops=fcTotalReadIops, fcTargetReadIops=fcTargetReadIops, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareSnapshotSizeHigh=shareSnapshotSizeHigh, lunWriteLatency=lunWriteLatency, notificationObjects=notificationObjects, iscsiTargetGroup=iscsiTargetGroup, cifsTotalReadIops=cifsTotalReadIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, snmpAgentVersion=snmpAgentVersion, shareCIFSReadMbps=shareCIFSReadMbps, shareCompressedRatio=shareCompressedRatio, notificationComponentName=notificationComponentName, intelliFlashSoftwareDown=intelliFlashSoftwareDown, volumeDeleteFailed=volumeDeleteFailed, haResourceActiveNode=haResourceActiveNode, shareQuotaHigh=shareQuotaHigh, fcTargetReadLatency=fcTargetReadLatency, ipmiOther=ipmiOther, poolDataWriteLatency=poolDataWriteLatency, poolQuotaFinished=poolQuotaFinished, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareNFSWriteLatency=shareNFSWriteLatency, nvdimmFailDeviceError=nvdimmFailDeviceError, shareNFSReadLatency=shareNFSReadLatency, shareNFSReadIops=shareNFSReadIops, poolDeleted=poolDeleted, networkIpmpGroupDown=networkIpmpGroupDown, cacheTotalWriteMbps=cacheTotalWriteMbps, nicMTU=nicMTU, notificationReadingTriggerValue=notificationReadingTriggerValue, poolReadCacheReadMbps=poolReadCacheReadMbps, ipmiThreshold=ipmiThreshold, poolCreated=poolCreated, shareMountPoint=shareMountPoint, notificationSensorSuspect=notificationSensorSuspect, poolDataWriteMbps=poolDataWriteMbps, projectQuotaSizeLow=projectQuotaSizeLow, iscsiProperties=iscsiProperties, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolTotalReadMbps=poolTotalReadMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, nicTransmitMbps=nicTransmitMbps, diskIsOnline=diskIsOnline, poolMetaWriteIops=poolMetaWriteIops, cifsTotalWriteIops=cifsTotalWriteIops, projectQuotaSizeHigh=projectQuotaSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, replicationPaused=replicationPaused, lunIndex=lunIndex, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskEntry=diskEntry, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolOwnerController=poolOwnerController, poolMetaWriteMbps=poolMetaWriteMbps, lunSizeHigh=lunSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, upgradeFailed=upgradeFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, poolDataReadIops=poolDataReadIops, fcInitiatorEntry=fcInitiatorEntry, notificationTargetEntityName=notificationTargetEntityName, properties=properties, iscsiTargetError=iscsiTargetError, smbSocketFailure=smbSocketFailure, iscsiTargetEntry=iscsiTargetEntry, fcTargetWriteLatency=fcTargetWriteLatency, cacheTotalReadMbps=cacheTotalReadMbps, nfsTotalReadMbps=nfsTotalReadMbps, poolImported=poolImported, upgradeDownloadFailed=upgradeDownloadFailed, iscsiTargetReadLatency=iscsiTargetReadLatency, haControllerA_IPAddr=haControllerA_IPAddr, haResourceGroup=haResourceGroup, sharePoolName=sharePoolName, ipmiMemory=ipmiMemory, networkInterfaceDown=networkInterfaceDown, poolMetaReadMbps=poolMetaReadMbps, networkIpmpGroupUp=networkIpmpGroupUp, poolTotalWriteMbps=poolTotalWriteMbps, snapshotCloningFailed=snapshotCloningFailed, projectDeleted=projectDeleted, nfsTotalReadIops=nfsTotalReadIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolExpanded=poolExpanded, poolUpgraded=poolUpgraded, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskAvgWriteLatency=diskAvgWriteLatency, lunEntry=lunEntry, fcTargetModifyCompleted=fcTargetModifyCompleted, sensorFailureEvent=sensorFailureEvent, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiInitiatorEntry=iscsiInitiatorEntry, lunWriteIops=lunWriteIops, iscsiTotalReadIops=iscsiTotalReadIops, tdpsUpgradeTimeout=tdpsUpgradeTimeout, fcAvgReadLatency=fcAvgReadLatency, controllerDown=controllerDown, poolDataSizeHigh=poolDataSizeHigh, lunPoolName=lunPoolName, nicReceiveMbps=nicReceiveMbps, haResourceName=haResourceName, tegileGroups=tegileGroups, cacheSSDReads=cacheSSDReads, nfsTotalWriteMbps=nfsTotalWriteMbps, projectDataSizeLow=projectDataSizeLow, replicationAbandoned=replicationAbandoned, tdpsUpgradeCompleted=tdpsUpgradeCompleted, shareCIFSWriteLatency=shareCIFSWriteLatency, poolMetaReadLatency=poolMetaReadLatency, haResourceStatus=haResourceStatus, intelliFlashSoftwareUp=intelliFlashSoftwareUp, diskAvgReadLatency=diskAvgReadLatency, shareDataSizeHigh=shareDataSizeHigh, lunReadMbps=lunReadMbps, iscsiAvgReadLatency=iscsiAvgReadLatency, cpuTotalUsage=cpuTotalUsage, pools=pools, haControllerB_Uptime=haControllerB_Uptime, disks=disks, projectShareCount=projectShareCount, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargetReadMbps=fcTargetReadMbps, nicGroup=nicGroup, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcTargetStatus=fcTargetStatus, iscsiAvgWriteLatency=iscsiAvgWriteLatency)
mibBuilder.exportSymbols("TEGILE-MIB", initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, ipmiTemperature=ipmiTemperature, cacheRAMReads=cacheRAMReads, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, nicIndex=nicIndex, diskSizeHigh=diskSizeHigh, fcInitiatorName=fcInitiatorName, diskRandomIOCount=diskRandomIOCount, poolMetaWriteLatency=poolMetaWriteLatency, cifsAvgWriteLatency=cifsAvgWriteLatency, poolDataSizeLow=poolDataSizeLow, deleteFolderFailed=deleteFolderFailed, fcInitiators=fcInitiators, shareCreatedSuccessfully=shareCreatedSuccessfully, shareCompressionEnabled=shareCompressionEnabled, poolDataReadLatency=poolDataReadLatency, diskTotalWriteIops=diskTotalWriteIops, poolDataWriteIops=poolDataWriteIops, projectDeletionFailed=projectDeletionFailed, targetGroupMemberAdded=targetGroupMemberAdded, maintenanceModeEnabled=maintenanceModeEnabled, projectDataSizeHigh=projectDataSizeHigh, upgradeDownloadCompleted=upgradeDownloadCompleted, fcInitiatorIndex=fcInitiatorIndex, webdocsUpgradeCompleted=webdocsUpgradeCompleted, volumeDeleteCompleted=volumeDeleteCompleted, networkInterfaceUp=networkInterfaceUp, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunFreeSizeHigh=lunFreeSizeHigh, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, replicationStarted=replicationStarted, poolAvgWriteLatency=poolAvgWriteLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, iscsiTotalReadMbps=iscsiTotalReadMbps, fcTotalReadMbps=fcTotalReadMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareDeleted=shareDeleted, deleteFolderCompleted=deleteFolderCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunName=lunName, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareName=shareName, nicEntry=nicEntry, lunInitiatorGroup=lunInitiatorGroup, poolTable=poolTable, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, cifsAvgReadLatency=cifsAvgReadLatency, poolMetaReadIops=poolMetaReadIops, shareCIFSEnabled=shareCIFSEnabled, shareReservedSizeHigh=shareReservedSizeHigh, haResourceEntry=haResourceEntry, shareNFSEnabled=shareNFSEnabled, tegileConformance=tegileConformance, fcTargets=fcTargets, iscsiInitiators=iscsiInitiators, nicState=nicState, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcTargetGroup=fcTargetGroup, lunCompressionEnabled=lunCompressionEnabled, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcTargetWriteIops=fcTargetWriteIops, nvdimmFailSoftError=nvdimmFailSoftError, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareDedupEnabled=shareDedupEnabled, cacheTotalReadIops=cacheTotalReadIops, shareNFSWriteMbps=shareNFSWriteMbps, haResourceIndex=haResourceIndex, poolName=poolName, iscsiTargetReadIops=iscsiTargetReadIops, nfsAvgWriteLatency=nfsAvgWriteLatency, diskSequentialIOCount=diskSequentialIOCount, lunReservedSizeHigh=lunReservedSizeHigh, iscsiTargetAlias=iscsiTargetAlias, spareDiskReplaced=spareDiskReplaced, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, unknownSensorEvent=unknownSensorEvent, iscsiInitiatorGroup=iscsiInitiatorGroup, cpuSystemCalls=cpuSystemCalls, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, nvdimmFailInitializationError=nvdimmFailInitializationError, projectName=projectName, diskDataWriteIops=diskDataWriteIops, iscsiTargetsTable=iscsiTargetsTable, maintenanceModeDisabled=maintenanceModeDisabled, shareIndex=shareIndex, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, diskIndex=diskIndex, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolSizeHigh=poolSizeHigh, fcPortOffline=fcPortOffline, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, diskSlowIo=diskSlowIo, fcTargetIndex=fcTargetIndex, snmpServiceStarted=snmpServiceStarted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, shareCIFSReadLatency=shareCIFSReadLatency, shareDeletionFailed=shareDeletionFailed, poolProjects=poolProjects, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareReservedSizeLow=shareReservedSizeLow, snapshotRollbackCompleted=snapshotRollbackCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskDataReadMbps=diskDataReadMbps, diskSizeLow=diskSizeLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiInitiatorName=iscsiInitiatorName, haResourceDescription=haResourceDescription, projectFreeSizeLow=projectFreeSizeLow, cifsTotalWriteMbps=cifsTotalWriteMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, tegileCompliances=tegileCompliances, projectTotalSaving=projectTotalSaving, lunBlockSize=lunBlockSize, lunGUID=lunGUID, replicationAborted=replicationAborted, targetGroupCreateCompleted=targetGroupCreateCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, diskCount=diskCount, poolWriteCacheWriteIops=poolWriteCacheWriteIops, fcInitiatorsTable=fcInitiatorsTable, poolCount=poolCount, poolTotalWriteIops=poolTotalWriteIops, lunDedupEnabled=lunDedupEnabled, shareCIFSWriteMbps=shareCIFSWriteMbps, lunReservedSizeLow=lunReservedSizeLow, cacheTotalWriteIops=cacheTotalWriteIops, diskAlias=diskAlias, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectLunCount=projectLunCount, smisServiceStarted=smisServiceStarted, shareNFSReadMbps=shareNFSReadMbps, snapshotCloneCompleted=snapshotCloneCompleted, poolAvgReadLatency=poolAvgReadLatency, cifsTotalReadMbps=cifsTotalReadMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, notificationSeverity=notificationSeverity, projectEntry=projectEntry, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, fcPortOnline=fcPortOnline, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, tegile=tegile, poolTotalReadIops=poolTotalReadIops, aclMigrationCompleted=aclMigrationCompleted, lunDataSizeHigh=lunDataSizeHigh, fcInitiatorCreateFailed=fcInitiatorCreateFailed, shareQuotaLow=shareQuotaLow, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, lunProjectName=lunProjectName, snapshotCreationFailed=snapshotCreationFailed, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, tegileArray=tegileArray, notificationTime=notificationTime, fcTargetsTable=fcTargetsTable, lunSnapshotSizeHigh=lunSnapshotSizeHigh, snmpServiceStopped=snmpServiceStopped, poolProjectCount=poolProjectCount, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, replicationTargetDeleted=replicationTargetDeleted, smisServiceStopped=smisServiceStopped, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, haResources=haResources, PYSNMP_MODULE_ID=tegile, aclMigrationStarted=aclMigrationStarted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, controllerUp=controllerUp, shareTable=shareTable, diskIOCount=diskIOCount, upgradeCompleted=upgradeCompleted, network=network, controllerTimeDrift=controllerTimeDrift, poolFreeSizeHigh=poolFreeSizeHigh, basicCompliance=basicCompliance, testNotification=testNotification, networkTotalReceiveMbps=networkTotalReceiveMbps, fcTargetEntry=fcTargetEntry, sanProperties=sanProperties, fcTotalWriteMbps=fcTotalWriteMbps, haResourcesTable=haResourcesTable, diskType=diskType, projectModified=projectModified, networkTotalTransmitMbps=networkTotalTransmitMbps, notificationSensorAction=notificationSensorAction, userLoginFailed=userLoginFailed, snmpServiceStopFailed=snmpServiceStopFailed, notificationDescription=notificationDescription, poolReadCacheWriteIops=poolReadCacheWriteIops, nicTable=nicTable, lunFreeSizeLow=lunFreeSizeLow, netbiosSocketFailure=netbiosSocketFailure, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiWriteIops=iscsiWriteIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, notificationReadingUnit=notificationReadingUnit, shareDataSizeLow=shareDataSizeLow, poolFreeSizeLow=poolFreeSizeLow, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiTargetGroupError=iscsiTargetGroupError, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiTargetAuth=iscsiTargetAuth, volumeModifyCompleted=volumeModifyCompleted, ipmiFan=ipmiFan, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskChassisIdx=diskChassisIdx)
