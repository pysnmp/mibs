...
# Produced by pysmi-1.1.8 at Mon Jan 16 15:13:36 2023
...
iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Integer32, TimeTicks, Counter32, ObjectIdentity, IpAddress, Bits, Counter64, Unsigned32, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Integer32", "TimeTicks", "Counter32", "ObjectIdentity", "IpAddress", "Bits", "Counter64", "Unsigned32", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, volumeDeleteFailed=volumeDeleteFailed, fcTargetIndex=fcTargetIndex, poolIndex=poolIndex, lunFreeSizeHigh=lunFreeSizeHigh, fcInitiatorName=fcInitiatorName, poolDataReadMbps=poolDataReadMbps, diskAvgReadLatency=diskAvgReadLatency, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, fcTotalReadMbps=fcTotalReadMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, ipmiMemory=ipmiMemory, shareQuotaLow=shareQuotaLow, projectDataSizeLow=projectDataSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps, notificationSensorSuspect=notificationSensorSuspect, volumeModifyCompleted=volumeModifyCompleted, haResourceStatus=haResourceStatus, nicGroup=nicGroup, iscsiTargetReadIops=iscsiTargetReadIops, haResourceIndex=haResourceIndex, nvdimmFailInitializationError=nvdimmFailInitializationError, notificationComponentName=notificationComponentName, snmpServiceStopFailed=snmpServiceStopFailed, poolEntry=poolEntry, properties=properties, haResources=haResources, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolDataWriteMbps=poolDataWriteMbps, notificationTargetEntityName=notificationTargetEntityName, diskAlias=diskAlias, projectShares=projectShares, tegileConformance=tegileConformance, projectCreatedSuccessfully=projectCreatedSuccessfully, poolWriteCacheWriteIops=poolWriteCacheWriteIops, maintenanceModeEnabled=maintenanceModeEnabled, snapshotRollbackFailed=snapshotRollbackFailed, notificationSensorNumber=notificationSensorNumber, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunReadMbps=lunReadMbps, iscsiTargetName=iscsiTargetName, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, targetGroupCreateCompleted=targetGroupCreateCompleted, lunEntry=lunEntry, networkIpmpGroupUp=networkIpmpGroupUp, cacheTotalReadMbps=cacheTotalReadMbps, lunDedupEnabled=lunDedupEnabled, shareNFSReadIops=shareNFSReadIops, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolMetaReadLatency=poolMetaReadLatency, shareDedupEnabled=shareDedupEnabled, shareEntry=shareEntry, snapshotDeleteFailed=snapshotDeleteFailed, lunTargetGroup=lunTargetGroup, haControllerA_Name=haControllerA_Name, networkInterfaceUp=networkInterfaceUp, notificationDescription=notificationDescription, tegile=tegile, poolAvgReadLatency=poolAvgReadLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, upgradeFailed=upgradeFailed, notificationReadingTriggerValue=notificationReadingTriggerValue, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, ipmiVoltage=ipmiVoltage, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, notificationSeverity=notificationSeverity, poolDegraded=poolDegraded, projectLunCount=projectLunCount, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiTargetEntry=iscsiTargetEntry, ipmiOther=ipmiOther, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTargetName=fcTargetName, iscsiTotalReadIops=iscsiTotalReadIops, nicName=nicName, diskTotalWriteMbps=diskTotalWriteMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, haControllerB_IPAddr=haControllerB_IPAddr, projectQuotaSizeLow=projectQuotaSizeLow, projectFreeSizeHigh=projectFreeSizeHigh, lunDataSizeHigh=lunDataSizeHigh, haResourceDescription=haResourceDescription, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolImported=poolImported, cpuSystemCalls=cpuSystemCalls, iscsiAvgWriteLatency=iscsiAvgWriteLatency, lunFreeSizeLow=lunFreeSizeLow, fcAvgWriteLatency=fcAvgWriteLatency, replicationTargetDeleted=replicationTargetDeleted, deleteFolderFailed=deleteFolderFailed, snmpServiceStarted=snmpServiceStarted, fcTargetWriteIops=fcTargetWriteIops, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, cpuTotalUsage=cpuTotalUsage, lunPoolName=lunPoolName, memoryFailure=memoryFailure, sanProperties=sanProperties, diskAvgWriteLatency=diskAvgWriteLatency, shareReservedSizeHigh=shareReservedSizeHigh, networkTotalReceiveMbps=networkTotalReceiveMbps, smisServiceStarted=smisServiceStarted, diskDataWriteIops=diskDataWriteIops, tegileGroups=tegileGroups, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, networkTotalTransmitMbps=networkTotalTransmitMbps, poolQuotaFinished=poolQuotaFinished, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectPoolName=projectPoolName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolReadCacheWriteMbps=poolReadCacheWriteMbps, upgradeTimeout=upgradeTimeout, shareCompressionEnabled=shareCompressionEnabled, snapshotCloneCompleted=snapshotCloneCompleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, nfsTotalReadIops=nfsTotalReadIops, shareNFSWriteIops=shareNFSWriteIops, snmpServiceStartFailed=snmpServiceStartFailed, replicationStarted=replicationStarted, lunDataSizeLow=lunDataSizeLow, lunProjectName=lunProjectName, nicIndex=nicIndex, fcTargetReadMbps=fcTargetReadMbps, poolHealth=poolHealth, upgradeDownloadCompleted=upgradeDownloadCompleted, cifsTotalWriteIops=cifsTotalWriteIops, projectShareCount=projectShareCount, lunCompressionEnabled=lunCompressionEnabled, diskIndex=diskIndex, diskRandomIOCount=diskRandomIOCount, iscsiInitiatorName=iscsiInitiatorName, fcPortOnline=fcPortOnline, projectDeleted=projectDeleted, shareCIFSWriteIops=shareCIFSWriteIops, ipmiThreshold=ipmiThreshold, cacheSSDReads=cacheSSDReads, fcProperties=fcProperties, diskSizeLow=diskSizeLow, shareIndex=shareIndex, poolDataSizeHigh=poolDataSizeHigh, projectModified=projectModified, volumeCreatedSuccessfully=volumeCreatedSuccessfully, cifsAvgWriteLatency=cifsAvgWriteLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, ipmiTemperature=ipmiTemperature, networkIpmpGroupDown=networkIpmpGroupDown, poolReadCacheReadLatency=poolReadCacheReadLatency, poolMetaWriteLatency=poolMetaWriteLatency, lunReadIops=lunReadIops, aclMigrationStarted=aclMigrationStarted, poolExpanded=poolExpanded, nvdimmFailDeviceError=nvdimmFailDeviceError, upgradeCompleted=upgradeCompleted, poolState=poolState, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskDataReadMbps=diskDataReadMbps, lunTable=lunTable, lunSnapshotSizeHigh=lunSnapshotSizeHigh, ntpServerTimeDrift=ntpServerTimeDrift, upgradeDownloadFailed=upgradeDownloadFailed, iscsiAvgReadLatency=iscsiAvgReadLatency, diskTotalReadMbps=diskTotalReadMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, smbSocketFailure=smbSocketFailure, ipmiFan=ipmiFan, iscsiInitiatorsTable=iscsiInitiatorsTable, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolDataWriteIops=poolDataWriteIops, poolName=poolName, shareExceedThresholdWarning=shareExceedThresholdWarning, unknownSensorEvent=unknownSensorEvent, targetGroupMemberAdded=targetGroupMemberAdded, shareNFSReadLatency=shareNFSReadLatency, cacheTotalReadIops=cacheTotalReadIops, snapshotCloningFailed=snapshotCloningFailed, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, globalStatistics=globalStatistics, cacheTotalWriteIops=cacheTotalWriteIops, haResourceEntry=haResourceEntry, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, shareDeleted=shareDeleted, haResourceGroup=haResourceGroup, fcTargetWriteMbps=fcTargetWriteMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, poolDataReadIops=poolDataReadIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, volumeQuotaFinished=volumeQuotaFinished, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolDeletionFailed=poolDeletionFailed, projectThresholdExceedWarning=projectThresholdExceedWarning, iscsiInitiatorGroup=iscsiInitiatorGroup, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, adServerTimeDrift=adServerTimeDrift, diskError=diskError, poolMetaReadMbps=poolMetaReadMbps, poolUsedSizeHigh=poolUsedSizeHigh, lunCompressedRatio=lunCompressedRatio, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolTotalReadMbps=poolTotalReadMbps, upgradeStarted=upgradeStarted, poolUpgraded=poolUpgraded, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareTable=shareTable, cifsAvgReadLatency=cifsAvgReadLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, lunName=lunName, nvdimmFailSoftError=nvdimmFailSoftError, shareCIFSWriteLatency=shareCIFSWriteLatency, pools=pools, poolTotalReadIops=poolTotalReadIops, diskType=diskType, ipmiPowerSupply=ipmiPowerSupply, diskSizeHigh=diskSizeHigh, diskTotalWriteIops=diskTotalWriteIops, alertsCleanupCompleted=alertsCleanupCompleted, nicReceiveMbps=nicReceiveMbps, iscsiTargetAuth=iscsiTargetAuth, nfsTotalReadMbps=nfsTotalReadMbps, shareNFSReadMbps=shareNFSReadMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareCompressedRatio=shareCompressedRatio, sharePoolName=sharePoolName, fcTotalWriteMbps=fcTotalWriteMbps, shareReservedSizeLow=shareReservedSizeLow, targetGroupMemberRemoved=targetGroupMemberRemoved, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiProperties=iscsiProperties, haResourcesTable=haResourcesTable, nicState=nicState, fcTotalWriteIops=fcTotalWriteIops, iscsiTargets=iscsiTargets, lunIndex=lunIndex, controllerHardwareModel=controllerHardwareModel, diskSlowIo=diskSlowIo, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiTargetGroupError=iscsiTargetGroupError, fcInitiatorEntry=fcInitiatorEntry, iscsiTargetReadLatency=iscsiTargetReadLatency, controllerUp=controllerUp, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency)
mibBuilder.exportSymbols("TEGILE-MIB", upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcTotalReadIops=fcTotalReadIops, diskEntry=diskEntry, fcInitiators=fcInitiators, notificationEventCode=notificationEventCode, projectQuotaFinished=projectQuotaFinished, poolFreeSizeLow=poolFreeSizeLow, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, snapshotCreationFailed=snapshotCreationFailed, poolSizeHigh=poolSizeHigh, diskDataReadIops=diskDataReadIops, nicTable=nicTable, nfsAvgWriteLatency=nfsAvgWriteLatency, poolProjects=poolProjects, fcTargetWriteLatency=fcTargetWriteLatency, poolDataReadLatency=poolDataReadLatency, lunSizeHigh=lunSizeHigh, deleteFolderCompleted=deleteFolderCompleted, diskIsOnline=diskIsOnline, shareNFSWriteLatency=shareNFSWriteLatency, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, cacheRAMReads=cacheRAMReads, fcTargetModifyCompleted=fcTargetModifyCompleted, projectName=projectName, nicMTU=nicMTU, shareQuotaHigh=shareQuotaHigh, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectTable=projectTable, projectLUNs=projectLUNs, aclMigrationCompleted=aclMigrationCompleted, sensorFailureEvent=sensorFailureEvent, notifications=notifications, volumeDeleteCompleted=volumeDeleteCompleted, projectEntry=projectEntry, iscsiTargetIndex=iscsiTargetIndex, fcTargets=fcTargets, replicationComplete=replicationComplete, webdocsUpgradeCompleted=webdocsUpgradeCompleted, smisServiceStopFailed=smisServiceStopFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, maintenanceModeDisabled=maintenanceModeDisabled, poolMetaWriteMbps=poolMetaWriteMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, fcPortOffline=fcPortOffline, replicationResumed=replicationResumed, shareSnapshotSizeLow=shareSnapshotSizeLow, haResourceName=haResourceName, poolSizeLow=poolSizeLow, projectSnapshotSizeLow=projectSnapshotSizeLow, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareMountPoint=shareMountPoint, poolAvgWriteLatency=poolAvgWriteLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskChassisIdx=diskChassisIdx, diskDataWriteMbps=diskDataWriteMbps, haResourceActiveNode=haResourceActiveNode, shareCreatedSuccessfully=shareCreatedSuccessfully, poolTotalWriteMbps=poolTotalWriteMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcTargetGroup=fcTargetGroup, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolExported=poolExported, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolDeleted=poolDeleted, diskTable=diskTable, iscsiTargetAlias=iscsiTargetAlias, fcTargetsTable=fcTargetsTable, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolOwnerController=poolOwnerController, controllerTimeDrift=controllerTimeDrift, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskIOCount=diskIOCount, networkInterfaceDown=networkInterfaceDown, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, cpuInterrupts=cpuInterrupts, controllerDown=controllerDown, currentNotificationGroup=currentNotificationGroup, disks=disks, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, diskPoolName=diskPoolName, projectFreeSizeLow=projectFreeSizeLow, haControllerA_IPAddr=haControllerA_IPAddr, shareCIFSEnabled=shareCIFSEnabled, shareCIFSReadLatency=shareCIFSReadLatency, shareDataSizeHigh=shareDataSizeHigh, lunWriteIops=lunWriteIops, testNotification=testNotification, ipmiCurrent=ipmiCurrent, lunWriteLatency=lunWriteLatency, poolMetaReadIops=poolMetaReadIops, tegileArray_notifications=tegileArray_notifications, projectCompressionEnabled=projectCompressionEnabled, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, lunReadLatency=lunReadLatency, poolFreeSizeHigh=poolFreeSizeHigh, diskTotalReadIops=diskTotalReadIops, projectDedupEnabled=projectDedupEnabled, iscsiTotalReadMbps=iscsiTotalReadMbps, poolMetaWriteIops=poolMetaWriteIops, poolReadCacheWriteIops=poolReadCacheWriteIops, shareDataSizeLow=shareDataSizeLow, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, tegileArray=tegileArray, projectIndex=projectIndex, replicationPaused=replicationPaused, network=network, iscsiTargetGroup=iscsiTargetGroup, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, diagnosticDataUploaded=diagnosticDataUploaded, notificationSensorAction=notificationSensorAction, snmpAgentVersion=snmpAgentVersion, shareName=shareName, cifsTotalWriteMbps=cifsTotalWriteMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, notificationReadingUnit=notificationReadingUnit, shareDeletionFailed=shareDeletionFailed, shareQuotaFinished=shareQuotaFinished, poolDataSizeLow=poolDataSizeLow, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, lunProtocol=lunProtocol, poolTable=poolTable, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, nfsTotalWriteIops=nfsTotalWriteIops, replicationAbandoned=replicationAbandoned, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, userLoginFailed=userLoginFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, notificationObjects=notificationObjects, shareProjectName=shareProjectName, spareDiskReplaced=spareDiskReplaced, poolReadCacheReadMbps=poolReadCacheReadMbps, diskGoneOffline=diskGoneOffline, lunSizeLow=lunSizeLow, iscsiTargetError=iscsiTargetError, poolUsedSizeLow=poolUsedSizeLow, lunInitiatorGroup=lunInitiatorGroup, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcInitiatorGroup=fcInitiatorGroup, fcTargetReadIops=fcTargetReadIops, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, currentObjectGroup=currentObjectGroup, nicTransmitMbps=nicTransmitMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, basicCompliance=basicCompliance, tegileCompliances=tegileCompliances, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareCIFSReadMbps=shareCIFSReadMbps, poolCreated=poolCreated, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcTargetReadLatency=fcTargetReadLatency, replicationFailed=replicationFailed, replicationAborted=replicationAborted, iscsiTargetReadMbps=iscsiTargetReadMbps, nfsAvgReadLatency=nfsAvgReadLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, cifsTotalReadIops=cifsTotalReadIops, smisServiceStopped=smisServiceStopped, haControllerA_Uptime=haControllerA_Uptime, iscsiInitiatorIndex=iscsiInitiatorIndex, notificationProps=notificationProps, shareNFSEnabled=shareNFSEnabled, poolProjectCount=poolProjectCount, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolCount=poolCount, fcInitiatorsTable=fcInitiatorsTable, shareCIFSReadIops=shareCIFSReadIops, lunBlockSize=lunBlockSize, iscsiInitiators=iscsiInitiators, iscsiTargetsTable=iscsiTargetsTable, vmwareNFSDatastores=vmwareNFSDatastores, poolTotalWriteIops=poolTotalWriteIops, lunWriteMbps=lunWriteMbps, netbiosSocketFailure=netbiosSocketFailure, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, projectDeletionFailed=projectDeletionFailed, PYSNMP_MODULE_ID=tegile, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiInitiatorChapUser=iscsiInitiatorChapUser, upgradeDownloadStarted=upgradeDownloadStarted, lunSnapshotSizeLow=lunSnapshotSizeLow, nicEntry=nicEntry, snmpServiceStopped=snmpServiceStopped, haControllerB_Name=haControllerB_Name, fcTargetEntry=fcTargetEntry, diskCount=diskCount, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcInitiatorIndex=fcInitiatorIndex, fcTargetStatus=fcTargetStatus, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectQuotaSizeHigh=projectQuotaSizeHigh, poolDataWriteLatency=poolDataWriteLatency, smisServiceStartFailed=smisServiceStartFailed, projectDataSizeHigh=projectDataSizeHigh, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiWriteIops=iscsiWriteIops, replicationSourceRegistered=replicationSourceRegistered, haControllerB_Uptime=haControllerB_Uptime, lunGUID=lunGUID, notificationTime=notificationTime, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, diskSequentialIOCount=diskSequentialIOCount, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, fcAvgReadLatency=fcAvgReadLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, projectTotalSaving=projectTotalSaving, shareNFSWriteMbps=shareNFSWriteMbps, lunReservedSizeLow=lunReservedSizeLow, diskState=diskState, lunReservedSizeHigh=lunReservedSizeHigh)
