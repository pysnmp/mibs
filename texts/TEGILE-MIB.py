...
Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, MibIdentifier, enterprises, IpAddress, ObjectIdentity, Integer32, TimeTicks, Gauge32, NotificationType, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "MibIdentifier", "enterprises", "IpAddress", "ObjectIdentity", "Integer32", "TimeTicks", "Gauge32", "NotificationType", "iso", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskEntry=diskEntry, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry, fcTotalReadMbps=fcTotalReadMbps, shareDedupEnabled=shareDedupEnabled, haResourcesTable=haResourcesTable, lunFreeSizeHigh=lunFreeSizeHigh, fcTargetWriteIops=fcTargetWriteIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, replicationAborted=replicationAborted, cpuInterrupts=cpuInterrupts, poolReadCacheReadIops=poolReadCacheReadIops, upgradeDownloadFailed=upgradeDownloadFailed, lunCompressedRatio=lunCompressedRatio, notificationTargetEntityName=notificationTargetEntityName, fcTargetStatus=fcTargetStatus, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, nvdimmFailSoftError=nvdimmFailSoftError, poolProjectCount=poolProjectCount, networkInterfaceDown=networkInterfaceDown, iscsiInitiators=iscsiInitiators, projectQuotaSizeLow=projectQuotaSizeLow, shareNFSWriteLatency=shareNFSWriteLatency, shareCIFSReadIops=shareCIFSReadIops, poolTable=poolTable, shareCIFSEnabled=shareCIFSEnabled, poolMetaWriteLatency=poolMetaWriteLatency, smisServiceStarted=smisServiceStarted, maintenanceModeDisabled=maintenanceModeDisabled, snapshotCloningFailed=snapshotCloningFailed, lunReservedSizeLow=lunReservedSizeLow, intelliFlashSoftwareUp=intelliFlashSoftwareUp, lunReadMbps=lunReadMbps, fcTargetIndex=fcTargetIndex, poolDegraded=poolDegraded, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, nfsTotalReadIops=nfsTotalReadIops, ipmiTemperature=ipmiTemperature, fcAvgReadLatency=fcAvgReadLatency, poolUsedSizeHigh=poolUsedSizeHigh, poolWriteCacheWriteIops=poolWriteCacheWriteIops, lunDataSizeHigh=lunDataSizeHigh, ipmiCurrent=ipmiCurrent, shareMountPoint=shareMountPoint, controllerUp=controllerUp, memoryFailure=memoryFailure, lunSnapshotSizeHigh=lunSnapshotSizeHigh, shareNFSReadMbps=shareNFSReadMbps, diskPoolName=diskPoolName, poolDeleted=poolDeleted, shareReservedSizeLow=shareReservedSizeLow, projectDeletionFailed=projectDeletionFailed, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolAvgWriteLatency=poolAvgWriteLatency, shareDataSizeHigh=shareDataSizeHigh, poolUpgraded=poolUpgraded, smbSocketFailure=smbSocketFailure, shareName=shareName, tdpsUpgradeTimeout=tdpsUpgradeTimeout, nicState=nicState, poolUsedSizeLow=poolUsedSizeLow, replicationTargetDeleted=replicationTargetDeleted, projectFreeSizeLow=projectFreeSizeLow, diskTable=diskTable, poolOwnerController=poolOwnerController, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolCreated=poolCreated, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, fcTargetName=fcTargetName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiTargetError=iscsiTargetError, shareExceedThresholdWarning=shareExceedThresholdWarning, nicName=nicName, diskDataWriteMbps=diskDataWriteMbps, haControllerA_Uptime=haControllerA_Uptime, poolMetaReadMbps=poolMetaReadMbps, notificationReadingUnit=notificationReadingUnit, projectTotalSaving=projectTotalSaving, controllerDown=controllerDown, smisServiceStopFailed=smisServiceStopFailed, nfsTotalWriteMbps=nfsTotalWriteMbps, diskIndex=diskIndex, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolReadCacheReadLatency=poolReadCacheReadLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiTargetsTable=iscsiTargetsTable, volumeModifyCompleted=volumeModifyCompleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskCount=diskCount, nfsTotalWriteIops=nfsTotalWriteIops, projectModified=projectModified, volumeDeleteFailed=volumeDeleteFailed, webdocsUpgradeCompleted=webdocsUpgradeCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, snmpServiceStarted=snmpServiceStarted, tegileArray_notifications=tegileArray_notifications, projectQuotaSizeHigh=projectQuotaSizeHigh, lunDataSizeLow=lunDataSizeLow, iscsiTargetWriteLatency=iscsiTargetWriteLatency, lunProtocol=lunProtocol, shareCompressionEnabled=shareCompressionEnabled, notificationSensorNumber=notificationSensorNumber, iscsiImproperTargetGroup=iscsiImproperTargetGroup, diskState=diskState, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, lunBlockSize=lunBlockSize, cacheTotalReadMbps=cacheTotalReadMbps, cacheSSDReads=cacheSSDReads, notificationObjects=notificationObjects, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, projectIndex=projectIndex, lunSizeHigh=lunSizeHigh, iscsiTargetWriteIops=iscsiTargetWriteIops, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareIndex=shareIndex, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, sharePoolName=sharePoolName, notificationEventCode=notificationEventCode, haResourceIndex=haResourceIndex, projectShareCount=projectShareCount, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTargetReadMbps=fcTargetReadMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolExpanded=poolExpanded, nvdimmFailDeviceError=nvdimmFailDeviceError, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, diskIOCount=diskIOCount, diskType=diskType, poolState=poolState, fcTargetsTable=fcTargetsTable, cacheTotalWriteMbps=cacheTotalWriteMbps, diskChassisIdx=diskChassisIdx, lunReadIops=lunReadIops, upgradeFailed=upgradeFailed, notificationSensorSuspect=notificationSensorSuspect, basicCompliance=basicCompliance, poolMetaReadIops=poolMetaReadIops, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectThresholdExceedWarning=projectThresholdExceedWarning, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolHealth=poolHealth, nfsTotalReadMbps=nfsTotalReadMbps, spareDiskReplaced=spareDiskReplaced, nicTable=nicTable, haControllerA_IPAddr=haControllerA_IPAddr, ipmiOther=ipmiOther, smisServiceStopped=smisServiceStopped, fcTargetGroup=fcTargetGroup, fcAvgWriteLatency=fcAvgWriteLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, shareQuotaHigh=shareQuotaHigh, poolMetaWriteMbps=poolMetaWriteMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, projectCompressionEnabled=projectCompressionEnabled, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskTotalReadMbps=diskTotalReadMbps, lunInitiatorGroup=lunInitiatorGroup, lunProjectName=lunProjectName, netbiosSocketFailure=netbiosSocketFailure, poolIndex=poolIndex, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcTotalReadIops=fcTotalReadIops, poolFreeSizeHigh=poolFreeSizeHigh, lunGUID=lunGUID, projectDataSizeHigh=projectDataSizeHigh, fcInitiatorIndex=fcInitiatorIndex, shareCIFSReadMbps=shareCIFSReadMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, cacheRAMReads=cacheRAMReads, nicIndex=nicIndex, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, diskDataReadIops=diskDataReadIops, controllerHardwareModel=controllerHardwareModel, pools=pools, ipmiThreshold=ipmiThreshold, poolDataWriteLatency=poolDataWriteLatency, haResources=haResources, nicEntry=nicEntry, poolDataSizeLow=poolDataSizeLow, smisServiceStartFailed=smisServiceStartFailed, snmpServiceStopped=snmpServiceStopped, deleteFolderCompleted=deleteFolderCompleted, diskError=diskError, lunPoolName=lunPoolName, fcTargetReadLatency=fcTargetReadLatency, tegileArray=tegileArray, nvdimmFailUnknownError=nvdimmFailUnknownError, tdpsUpgradeFailed=tdpsUpgradeFailed, diskSizeLow=diskSizeLow, cifsAvgWriteLatency=cifsAvgWriteLatency, replicationStarted=replicationStarted, controllerTimeDrift=controllerTimeDrift, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectLunCount=projectLunCount, fcTotalWriteMbps=fcTotalWriteMbps, iscsiTargetIndex=iscsiTargetIndex, ipmiVoltage=ipmiVoltage, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, notificationTime=notificationTime, ipmiPowerSupply=ipmiPowerSupply, projectName=projectName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, snapshotCloneCompleted=snapshotCloneCompleted, poolTotalSaving=poolTotalSaving, haResourceEntry=haResourceEntry, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolDataReadIops=poolDataReadIops, lunCompressionEnabled=lunCompressionEnabled, replicationComplete=replicationComplete, shareTable=shareTable, iscsiTargetAuth=iscsiTargetAuth, fcInitiatorName=fcInitiatorName, fcTotalWriteIops=fcTotalWriteIops, projectDataSizeLow=projectDataSizeLow, replicationFailed=replicationFailed, projectSnapshotSizeLow=projectSnapshotSizeLow, projectShares=projectShares, projectDedupEnabled=projectDedupEnabled, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, fcProperties=fcProperties, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, lunIndex=lunIndex, diskGoneOffline=diskGoneOffline, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectSnapshotSizeHigh=projectSnapshotSizeHigh, alertsCleanupCompleted=alertsCleanupCompleted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolEntry=poolEntry, fcInitiatorsTable=fcInitiatorsTable, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunTargetGroup=lunTargetGroup, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskTotalReadIops=diskTotalReadIops, cpuTotalUsage=cpuTotalUsage, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, diskIsOnline=diskIsOnline, poolDataWriteIops=poolDataWriteIops, poolTotalWriteIops=poolTotalWriteIops, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, snmpAgentVersion=snmpAgentVersion, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiWriteIops=iscsiWriteIops, projectQuotaFinished=projectQuotaFinished, testNotification=testNotification, notificationSensorAction=notificationSensorAction)
mibBuilder.exportSymbols("TEGILE-MIB", volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, sanProperties=sanProperties, poolDataReadLatency=poolDataReadLatency, lunEntry=lunEntry, replicationSourceRegistered=replicationSourceRegistered, haResourceStatus=haResourceStatus, replicationResumed=replicationResumed, lunSizeLow=lunSizeLow, diagnosticDataUploaded=diagnosticDataUploaded, fcInitiatorEntry=fcInitiatorEntry, lunDedupEnabled=lunDedupEnabled, nicGroup=nicGroup, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, userLoginFailed=userLoginFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, fcInitiatorGroup=fcInitiatorGroup, notificationSeverity=notificationSeverity, cifsTotalWriteMbps=cifsTotalWriteMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, poolDeletionFailed=poolDeletionFailed, cifsTotalReadIops=cifsTotalReadIops, lunWriteIops=lunWriteIops, shareCompressedRatio=shareCompressedRatio, tegileGroups=tegileGroups, poolDataSizeHigh=poolDataSizeHigh, haControllerA_Name=haControllerA_Name, nicTransmitMbps=nicTransmitMbps, ntpServerTimeDrift=ntpServerTimeDrift, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectPoolName=projectPoolName, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, cifsTotalWriteIops=cifsTotalWriteIops, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, targetGroupDeleteCompleted=targetGroupDeleteCompleted, ipmiFan=ipmiFan, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcTargetWriteLatency=fcTargetWriteLatency, snapshotCreationFailed=snapshotCreationFailed, iscsiTargetReadIops=iscsiTargetReadIops, shareNFSWriteMbps=shareNFSWriteMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, diskAvgReadLatency=diskAvgReadLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, networkIpmpGroupDown=networkIpmpGroupDown, cacheTotalReadIops=cacheTotalReadIops, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunFreeSizeLow=lunFreeSizeLow, snapshotRollbackCompleted=snapshotRollbackCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, iscsiTargetGroup=iscsiTargetGroup, haResourceGroup=haResourceGroup, diskSequentialIOCount=diskSequentialIOCount, shareQuotaLow=shareQuotaLow, disks=disks, poolProjects=poolProjects, iscsiTargets=iscsiTargets, lunSnapshotSizeLow=lunSnapshotSizeLow, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcTargetReadIops=fcTargetReadIops, volumeQuotaFinished=volumeQuotaFinished, fcTargetModifyCompleted=fcTargetModifyCompleted, poolDataWriteMbps=poolDataWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, notifications=notifications, poolMetaWriteIops=poolMetaWriteIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, nicReceiveMbps=nicReceiveMbps, iscsiTargetGroupError=iscsiTargetGroupError, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolName=poolName, tegile=tegile, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiTargetName=iscsiTargetName, upgradeTimeout=upgradeTimeout, currentObjectGroup=currentObjectGroup, diskDataReadMbps=diskDataReadMbps, adServerTimeDrift=adServerTimeDrift, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, haResourceDescription=haResourceDescription, fcTargetWriteMbps=fcTargetWriteMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolFreeSizeLow=poolFreeSizeLow, snapshotDeleteFailed=snapshotDeleteFailed, nvdimmFailInitializationError=nvdimmFailInitializationError, notificationDescription=notificationDescription, iscsiTotalReadIops=iscsiTotalReadIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, cacheTotalWriteIops=cacheTotalWriteIops, replicationPaused=replicationPaused, lunTable=lunTable, diskRandomIOCount=diskRandomIOCount, lunReadLatency=lunReadLatency, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, nicMTU=nicMTU, networkIpmpGroupUp=networkIpmpGroupUp, shareDataSizeLow=shareDataSizeLow, shareQuotaFinished=shareQuotaFinished, upgradeStarted=upgradeStarted, fcTargets=fcTargets, notificationProps=notificationProps, shareEntry=shareEntry, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, iscsiTargetAlias=iscsiTargetAlias, snapshotRollbackFailed=snapshotRollbackFailed, poolSizeLow=poolSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, network=network, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareNFSReadIops=shareNFSReadIops, poolMetaReadLatency=poolMetaReadLatency, shareProjectName=shareProjectName, projectFreeSizeHigh=projectFreeSizeHigh, haResourceName=haResourceName, PYSNMP_MODULE_ID=tegile, shareDeleted=shareDeleted, poolTotalReadMbps=poolTotalReadMbps, projectEntry=projectEntry, haResourceActiveNode=haResourceActiveNode, iscsiInitiatorGroup=iscsiInitiatorGroup, haControllerB_Name=haControllerB_Name, cifsTotalReadMbps=cifsTotalReadMbps, networkInterfaceUp=networkInterfaceUp, currentNotificationGroup=currentNotificationGroup, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunWriteMbps=lunWriteMbps, diskSlowIo=diskSlowIo, sensorFailureEvent=sensorFailureEvent, fcPortOnline=fcPortOnline, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiProperties=iscsiProperties, lunWriteLatency=lunWriteLatency, aclMigrationStarted=aclMigrationStarted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolImported=poolImported, diskTotalWriteIops=diskTotalWriteIops, iscsiTargetEntry=iscsiTargetEntry, fcPortOffline=fcPortOffline, iscsiTargetReadLatency=iscsiTargetReadLatency, shareNFSEnabled=shareNFSEnabled, tegileConformance=tegileConformance, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, tdpsUpgradeCompleted=tdpsUpgradeCompleted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareCIFSWriteLatency=shareCIFSWriteLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiTargetReadMbps=iscsiTargetReadMbps, globalStatistics=globalStatistics, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolDataReadMbps=poolDataReadMbps, projectLUNs=projectLUNs, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, projectTable=projectTable, volumeDeleteCompleted=volumeDeleteCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskSizeHigh=diskSizeHigh, poolExported=poolExported, poolAvgReadLatency=poolAvgReadLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, haControllerB_Uptime=haControllerB_Uptime, upgradeDownloadStarted=upgradeDownloadStarted, fcTargetEntry=fcTargetEntry, vmwareNFSDatastores=vmwareNFSDatastores, projectDeleted=projectDeleted, ipmiMemory=ipmiMemory, unknownSensorEvent=unknownSensorEvent, poolTotalWriteMbps=poolTotalWriteMbps, targetGroupMemberAdded=targetGroupMemberAdded, shareReservedSizeHigh=shareReservedSizeHigh, replicationAbandoned=replicationAbandoned, notificationReadingTriggerValue=notificationReadingTriggerValue, fcInitiators=fcInitiators, shareCIFSWriteIops=shareCIFSWriteIops, cpuSystemCalls=cpuSystemCalls, poolSizeHigh=poolSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, maintenanceModeEnabled=maintenanceModeEnabled, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, tegileCompliances=tegileCompliances, diskAlias=diskAlias, notificationComponentName=notificationComponentName, haControllerB_IPAddr=haControllerB_IPAddr, iscsiInitiatorName=iscsiInitiatorName, shareNFSWriteIops=shareNFSWriteIops, cifsAvgReadLatency=cifsAvgReadLatency, deleteFolderFailed=deleteFolderFailed, diskTotalWriteMbps=diskTotalWriteMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, targetGroupMemberRemoved=targetGroupMemberRemoved, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, shareCreatedSuccessfully=shareCreatedSuccessfully, snmpServiceStopFailed=snmpServiceStopFailed, shareNFSReadLatency=shareNFSReadLatency, shareDeletionFailed=shareDeletionFailed, poolReadCacheReadMbps=poolReadCacheReadMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolQuotaFinished=poolQuotaFinished, diskDataWriteIops=diskDataWriteIops, snmpServiceStartFailed=snmpServiceStartFailed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, diskAvgWriteLatency=diskAvgWriteLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, lunName=lunName, properties=properties, lunReservedSizeHigh=lunReservedSizeHigh, poolCount=poolCount, iscsiInitiatorIndex=iscsiInitiatorIndex, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, aclMigrationCompleted=aclMigrationCompleted, upgradeCompleted=upgradeCompleted, poolTotalReadIops=poolTotalReadIops)
