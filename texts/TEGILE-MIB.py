...
# Produced by pysmi-1.1.0 at Tue Nov 16 11:33:52 2021
...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, iso, Counter32, Gauge32, NotificationType, ModuleIdentity, Counter64, Bits, IpAddress, ObjectIdentity, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "iso", "Counter32", "Gauge32", "NotificationType", "ModuleIdentity", "Counter64", "Bits", "IpAddress", "ObjectIdentity", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiTargetAlias=iscsiTargetAlias, upgradeDownloadStarted=upgradeDownloadStarted, cacheTotalReadIops=cacheTotalReadIops, lunWriteIops=lunWriteIops, webdocsUpgradeFailed=webdocsUpgradeFailed, poolReadCacheReadIops=poolReadCacheReadIops, lunFreeSizeHigh=lunFreeSizeHigh, lunProjectName=lunProjectName, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, snapshotCreationFailed=snapshotCreationFailed, projectIndex=projectIndex, poolTotalWriteMbps=poolTotalWriteMbps, nicEntry=nicEntry, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, shareNFSReadLatency=shareNFSReadLatency, fcTargetReadMbps=fcTargetReadMbps, snmpServiceStopped=snmpServiceStopped, notificationReadingUnit=notificationReadingUnit, fcInitiatorGroup=fcInitiatorGroup, shareQuotaLow=shareQuotaLow, fcProperties=fcProperties, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargets=iscsiTargets, poolName=poolName, diskSlowIo=diskSlowIo, shareNFSWriteIops=shareNFSWriteIops, projectQuotaFinished=projectQuotaFinished, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, notificationProps=notificationProps, poolQuotaFinished=poolQuotaFinished, haResourceDescription=haResourceDescription, controllerHardwareModel=controllerHardwareModel, poolExported=poolExported, shareExceedThresholdWarning=shareExceedThresholdWarning, poolAvgWriteLatency=poolAvgWriteLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, smisServiceStarted=smisServiceStarted, iscsiWriteIops=iscsiWriteIops, replicationTargetDeleted=replicationTargetDeleted, fcInitiators=fcInitiators, poolDataWriteMbps=poolDataWriteMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcTargetWriteLatency=fcTargetWriteLatency, replicationPaused=replicationPaused, lunDataSizeHigh=lunDataSizeHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, spareDiskReplaced=spareDiskReplaced, upgradeTimeout=upgradeTimeout, shareCIFSEnabled=shareCIFSEnabled, lunTargetGroup=lunTargetGroup, projectName=projectName, fcInitiatorName=fcInitiatorName, fcTargetEntry=fcTargetEntry, haResourcesTable=haResourcesTable, nicTransmitMbps=nicTransmitMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, poolProjectCount=poolProjectCount, diskIndex=diskIndex, poolSizeHigh=poolSizeHigh, shareQuotaFinished=shareQuotaFinished, diskAvgReadLatency=diskAvgReadLatency, shareDedupEnabled=shareDedupEnabled, diskChassisIdx=diskChassisIdx, lunCompressionEnabled=lunCompressionEnabled, ipmiMemory=ipmiMemory, fcPortOffline=fcPortOffline, diskDataWriteIops=diskDataWriteIops, shareQuotaHigh=shareQuotaHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, haControllerB_Name=haControllerB_Name, fcTargets=fcTargets, cacheSSDReads=cacheSSDReads, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, smbSocketFailure=smbSocketFailure, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, network=network, nfsAvgReadLatency=nfsAvgReadLatency, diskDataReadMbps=diskDataReadMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, alertsCleanupCompleted=alertsCleanupCompleted, lunSizeHigh=lunSizeHigh, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskPoolName=diskPoolName, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, projectModified=projectModified, iscsiTargetWriteIops=iscsiTargetWriteIops, networkIpmpGroupUp=networkIpmpGroupUp, nfsAvgWriteLatency=nfsAvgWriteLatency, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolReadCacheReadLatency=poolReadCacheReadLatency, poolMetaReadLatency=poolMetaReadLatency, ipmiVoltage=ipmiVoltage, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolReadCacheWriteIops=poolReadCacheWriteIops, lunName=lunName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, upgradeFailed=upgradeFailed, iscsiInitiatorChapUser=iscsiInitiatorChapUser, iscsiTargetEntry=iscsiTargetEntry, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiTargetGroupError=iscsiTargetGroupError, aclMigrationStarted=aclMigrationStarted, sharePoolName=sharePoolName, fcTargetModifyCompleted=fcTargetModifyCompleted, poolTotalSaving=poolTotalSaving, fcTargetReadIops=fcTargetReadIops, ipmiOther=ipmiOther, ipmiFan=ipmiFan, tegileArray=tegileArray, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareDataSizeLow=shareDataSizeLow, poolMetaWriteMbps=poolMetaWriteMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, lunSizeLow=lunSizeLow, poolDeleted=poolDeleted, projectQuotaSizeHigh=projectQuotaSizeHigh, projectTable=projectTable, iscsiTotalReadIops=iscsiTotalReadIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, replicationResumed=replicationResumed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, controllerUp=controllerUp, targetGroupMemberAdded=targetGroupMemberAdded, snapshotCloningFailed=snapshotCloningFailed, poolTotalWriteIops=poolTotalWriteIops, cifsTotalReadMbps=cifsTotalReadMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectTotalSaving=projectTotalSaving, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, replicationFailed=replicationFailed, diskEntry=diskEntry, nicReceiveMbps=nicReceiveMbps, poolEntry=poolEntry, poolSizeLow=poolSizeLow, projectPoolName=projectPoolName, fcPortOnline=fcPortOnline, currentNotificationGroup=currentNotificationGroup, lunReservedSizeLow=lunReservedSizeLow, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, diskSizeLow=diskSizeLow, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, replicationSourceRegistered=replicationSourceRegistered, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, nfsTotalWriteMbps=nfsTotalWriteMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolMetaReadMbps=poolMetaReadMbps, shareCIFSWriteIops=shareCIFSWriteIops, shareCreatedSuccessfully=shareCreatedSuccessfully, volumeQuotaFinished=volumeQuotaFinished, lunSnapshotSizeHigh=lunSnapshotSizeHigh, unknownSensorEvent=unknownSensorEvent, webdocsUpgradeCompleted=webdocsUpgradeCompleted, shareTable=shareTable, haControllerA_Uptime=haControllerA_Uptime, smisServiceStopped=smisServiceStopped, networkInterfaceDown=networkInterfaceDown, deleteFolderCompleted=deleteFolderCompleted, nfsTotalReadIops=nfsTotalReadIops, tegileCompliances=tegileCompliances, shareCIFSWriteLatency=shareCIFSWriteLatency, notificationComponentName=notificationComponentName, cacheRAMReads=cacheRAMReads, haResourceStatus=haResourceStatus, lunWriteLatency=lunWriteLatency, projectQuotaSizeLow=projectQuotaSizeLow, nicIndex=nicIndex, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareCIFSReadLatency=shareCIFSReadLatency, shareCompressionEnabled=shareCompressionEnabled, fcTotalWriteIops=fcTotalWriteIops, diskTotalReadIops=diskTotalReadIops, upgradeStarted=upgradeStarted, iscsiInitiatorsTable=iscsiInitiatorsTable, cacheTotalWriteIops=cacheTotalWriteIops, poolState=poolState, shareSnapshotSizeHigh=shareSnapshotSizeHigh, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, ipmiCurrent=ipmiCurrent, lunTable=lunTable, poolOwnerController=poolOwnerController, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskSequentialIOCount=diskSequentialIOCount, upgradeCompleted=upgradeCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunPoolName=lunPoolName, nicState=nicState, ipmiThreshold=ipmiThreshold, cacheTotalWriteMbps=cacheTotalWriteMbps, testNotification=testNotification, projectShareCount=projectShareCount, notificationSensorAction=notificationSensorAction, tdpsUpgradeFailed=tdpsUpgradeFailed, snmpServiceStopFailed=snmpServiceStopFailed, poolFreeSizeHigh=poolFreeSizeHigh, smisServiceStopFailed=smisServiceStopFailed, ntpServerTimeDrift=ntpServerTimeDrift, lunReadLatency=lunReadLatency, shareIndex=shareIndex, tegileGroups=tegileGroups, shareCIFSReadIops=shareCIFSReadIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcInitiatorsTable=fcInitiatorsTable, lunFreeSizeLow=lunFreeSizeLow, haResources=haResources, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolCount=poolCount, lunBlockSize=lunBlockSize, haControllerA_Name=haControllerA_Name, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareDataSizeHigh=shareDataSizeHigh, PYSNMP_MODULE_ID=tegile, nicName=nicName, lunEntry=lunEntry, diskSizeHigh=diskSizeHigh, lunProtocol=lunProtocol, haControllerB_IPAddr=haControllerB_IPAddr, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, shareReservedSizeLow=shareReservedSizeLow, disks=disks, iscsiProperties=iscsiProperties, poolUpgraded=poolUpgraded, poolDataReadIops=poolDataReadIops, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiTargetAuth=iscsiTargetAuth, networkInterfaceUp=networkInterfaceUp, poolProjects=poolProjects, diskTable=diskTable, shareDeleted=shareDeleted, snapshotRollbackFailed=snapshotRollbackFailed, notificationTime=notificationTime, diskTotalReadMbps=diskTotalReadMbps, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, replicationAborted=replicationAborted, fcTargetReadLatency=fcTargetReadLatency, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, lunDedupEnabled=lunDedupEnabled, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareNFSWriteLatency=shareNFSWriteLatency, snmpAgentVersion=snmpAgentVersion, replicationAbandoned=replicationAbandoned, volumeDeleteCompleted=volumeDeleteCompleted)
mibBuilder.exportSymbols("TEGILE-MIB", poolExpanded=poolExpanded, projectCompressionEnabled=projectCompressionEnabled, haResourceEntry=haResourceEntry, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, diskError=diskError, iscsiInitiatorName=iscsiInitiatorName, nicTable=nicTable, upgradeDownloadFailed=upgradeDownloadFailed, diagnosticDataUploaded=diagnosticDataUploaded, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskDataReadIops=diskDataReadIops, notificationTargetEntityName=notificationTargetEntityName, currentObjectGroup=currentObjectGroup, poolFreeSizeLow=poolFreeSizeLow, iscsiInitiatorIndex=iscsiInitiatorIndex, diskTotalWriteMbps=diskTotalWriteMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, properties=properties, iscsiTargetName=iscsiTargetName, notifications=notifications, nfsTotalReadMbps=nfsTotalReadMbps, poolDataSizeHigh=poolDataSizeHigh, lunGUID=lunGUID, volumeDeleteFailed=volumeDeleteFailed, iscsiTargetReadMbps=iscsiTargetReadMbps, fcTargetWriteIops=fcTargetWriteIops, snmpServiceStartFailed=snmpServiceStartFailed, iscsiInitiatorGroup=iscsiInitiatorGroup, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolDataReadLatency=poolDataReadLatency, controllerTimeDrift=controllerTimeDrift, netbiosSocketFailure=netbiosSocketFailure, poolMetaReadIops=poolMetaReadIops, notificationReadingTriggerValue=notificationReadingTriggerValue, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, projectFreeSizeLow=projectFreeSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, upgradeDownloadCompleted=upgradeDownloadCompleted, snmpServiceStarted=snmpServiceStarted, deleteFolderFailed=deleteFolderFailed, sensorFailureEvent=sensorFailureEvent, projectDeleted=projectDeleted, cifsTotalReadIops=cifsTotalReadIops, cpuTotalUsage=cpuTotalUsage, diskIOCount=diskIOCount, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, projectLunCount=projectLunCount, fcTotalWriteMbps=fcTotalWriteMbps, poolIndex=poolIndex, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, aclMigrationCompleted=aclMigrationCompleted, notificationDescription=notificationDescription, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcTargetsTable=fcTargetsTable, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, fcInitiatorIndex=fcInitiatorIndex, projectSnapshotSizeLow=projectSnapshotSizeLow, projectDeletionFailed=projectDeletionFailed, nvdimmFailSoftError=nvdimmFailSoftError, iscsiTargetReadIops=iscsiTargetReadIops, userLoginFailed=userLoginFailed, vmwareNFSDatastores=vmwareNFSDatastores, diskIsOnline=diskIsOnline, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolUsedSizeLow=poolUsedSizeLow, poolReadCacheWriteLatency=poolReadCacheWriteLatency, smisServiceStartFailed=smisServiceStartFailed, projectDedupEnabled=projectDedupEnabled, sanProperties=sanProperties, tegileArray_notifications=tegileArray_notifications, cpuInterrupts=cpuInterrupts, diskCount=diskCount, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, fcAvgWriteLatency=fcAvgWriteLatency, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, haControllerB_Uptime=haControllerB_Uptime, globalStatistics=globalStatistics, poolMetaWriteIops=poolMetaWriteIops, shareNFSReadMbps=shareNFSReadMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, diskState=diskState, haControllerA_IPAddr=haControllerA_IPAddr, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, nicMTU=nicMTU, fcTargetGroup=fcTargetGroup, networkIpmpGroupDown=networkIpmpGroupDown, tdpsUpgradeCompleted=tdpsUpgradeCompleted, projectEntry=projectEntry, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunWriteMbps=lunWriteMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, notificationSensorSuspect=notificationSensorSuspect, iscsiTargetGroup=iscsiTargetGroup, diskAvgWriteLatency=diskAvgWriteLatency, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcInitiatorEntry=fcInitiatorEntry, replicationComplete=replicationComplete, fcTargetWriteMbps=fcTargetWriteMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolHealth=poolHealth, projectThresholdExceedWarning=projectThresholdExceedWarning, poolTotalReadMbps=poolTotalReadMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolTotalReadIops=poolTotalReadIops, iscsiInitiators=iscsiInitiators, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, cifsTotalWriteMbps=cifsTotalWriteMbps, cpuSystemCalls=cpuSystemCalls, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskDataWriteMbps=diskDataWriteMbps, notificationObjects=notificationObjects, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, volumeModifyCompleted=volumeModifyCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, lunDataSizeLow=lunDataSizeLow, maintenanceModeDisabled=maintenanceModeDisabled, targetGroupCreateCompleted=targetGroupCreateCompleted, diskTotalWriteIops=diskTotalWriteIops, lunCompressedRatio=lunCompressedRatio, lunReadMbps=lunReadMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, diskAlias=diskAlias, fcAvgReadLatency=fcAvgReadLatency, nvdimmFailDeviceError=nvdimmFailDeviceError, diskRandomIOCount=diskRandomIOCount, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, snapshotCloneCompleted=snapshotCloneCompleted, maintenanceModeEnabled=maintenanceModeEnabled, lunSnapshotSizeLow=lunSnapshotSizeLow, projectFreeSizeHigh=projectFreeSizeHigh, adServerTimeDrift=adServerTimeDrift, nfsTotalWriteIops=nfsTotalWriteIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, iscsiTargetError=iscsiTargetError, shareNFSEnabled=shareNFSEnabled, iscsiTargetsTable=iscsiTargetsTable, cifsTotalWriteIops=cifsTotalWriteIops, ipmiTemperature=ipmiTemperature, poolDataWriteIops=poolDataWriteIops, shareMountPoint=shareMountPoint, replicationStarted=replicationStarted, pools=pools, poolAvgReadLatency=poolAvgReadLatency, fcTargetIndex=fcTargetIndex, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, haResourceActiveNode=haResourceActiveNode, lunIndex=lunIndex, haResourceIndex=haResourceIndex, iscsiTargetIndex=iscsiTargetIndex, intelliFlashSoftwareUp=intelliFlashSoftwareUp, basicCompliance=basicCompliance, poolImported=poolImported, tegile=tegile, poolDataSizeLow=poolDataSizeLow, fcTotalReadMbps=fcTotalReadMbps, shareEntry=shareEntry, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diskType=diskType, diskGoneOffline=diskGoneOffline, cifsAvgWriteLatency=cifsAvgWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolDegraded=poolDegraded, controllerDown=controllerDown, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolDeletionFailed=poolDeletionFailed, shareDeletionFailed=shareDeletionFailed, volumeCreatedSuccessfully=volumeCreatedSuccessfully, ipmiPowerSupply=ipmiPowerSupply, shareCIFSReadMbps=shareCIFSReadMbps, haResourceName=haResourceName, nicGroup=nicGroup, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, cifsAvgReadLatency=cifsAvgReadLatency, poolMetaWriteLatency=poolMetaWriteLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, notificationEventCode=notificationEventCode, shareName=shareName, tegileConformance=tegileConformance, projectShares=projectShares, projectLUNs=projectLUNs, snapshotDeleteFailed=snapshotDeleteFailed, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareCompressedRatio=shareCompressedRatio, lunInitiatorGroup=lunInitiatorGroup, fcTargetName=fcTargetName, memoryFailure=memoryFailure, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, haResourceGroup=haResourceGroup, notificationSeverity=notificationSeverity, targetGroupMemberRemoved=targetGroupMemberRemoved, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, shareProjectName=shareProjectName, fcTargetStatus=fcTargetStatus, projectCreatedSuccessfully=projectCreatedSuccessfully, nvdimmFailUnknownError=nvdimmFailUnknownError, poolDataWriteLatency=poolDataWriteLatency, lunReservedSizeHigh=lunReservedSizeHigh, projectDataSizeHigh=projectDataSizeHigh, poolTable=poolTable, poolDataReadMbps=poolDataReadMbps, lunReadIops=lunReadIops, fcTotalReadIops=fcTotalReadIops, poolUsedSizeHigh=poolUsedSizeHigh, projectDataSizeLow=projectDataSizeLow, shareReservedSizeHigh=shareReservedSizeHigh, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolCreated=poolCreated, iscsiAvgReadLatency=iscsiAvgReadLatency)
