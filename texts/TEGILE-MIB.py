...
IpAddress, TimeTicks, Bits, ObjectIdentity, Integer32, Counter32, Unsigned32, NotificationType, Gauge32, enterprises, Counter64, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Bits", "ObjectIdentity", "Integer32", "Counter32", "Unsigned32", "NotificationType", "Gauge32", "enterprises", "Counter64", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolSizeHigh=poolSizeHigh, projectSnapshotSizeLow=projectSnapshotSizeLow, snapshotCloneCompleted=snapshotCloneCompleted, snmpServiceStopFailed=snmpServiceStopFailed, shareCIFSWriteMbps=shareCIFSWriteMbps, projectPoolName=projectPoolName, shareReservedSizeHigh=shareReservedSizeHigh, haControllerA_Name=haControllerA_Name, networkIpmpGroupUp=networkIpmpGroupUp, poolProjects=poolProjects, PYSNMP_MODULE_ID=tegile, shareIndex=shareIndex, globalStatistics=globalStatistics, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, basicCompliance=basicCompliance, cpuInterrupts=cpuInterrupts, notificationSeverity=notificationSeverity, smisServiceStarted=smisServiceStarted, unknownSensorEvent=unknownSensorEvent, shareCompressionEnabled=shareCompressionEnabled, snmpAgentVersion=snmpAgentVersion, projectModified=projectModified, replicationComplete=replicationComplete, poolEntry=poolEntry, lunCompressionEnabled=lunCompressionEnabled, lunInitiatorGroup=lunInitiatorGroup, cacheTotalReadMbps=cacheTotalReadMbps, projectDedupEnabled=projectDedupEnabled, lunProtocol=lunProtocol, haResourceName=haResourceName, shareEntry=shareEntry, iscsiTargetGroupError=iscsiTargetGroupError, tegileConformance=tegileConformance, poolTotalReadMbps=poolTotalReadMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, shareNFSReadLatency=shareNFSReadLatency, poolUpgraded=poolUpgraded, projectFreeSizeHigh=projectFreeSizeHigh, poolReadCacheReadLatency=poolReadCacheReadLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, fcInitiators=fcInitiators, networkTotalReceiveMbps=networkTotalReceiveMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, diskTable=diskTable, ntpServerTimeDrift=ntpServerTimeDrift, iscsiInitiatorName=iscsiInitiatorName, replicationPaused=replicationPaused, projectQuotaFinished=projectQuotaFinished, haControllerB_IPAddr=haControllerB_IPAddr, diskTotalReadMbps=diskTotalReadMbps, tegile=tegile, poolCount=poolCount, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, upgradeCompleted=upgradeCompleted, poolDataWriteIops=poolDataWriteIops, ipmiTemperature=ipmiTemperature, ipmiMemory=ipmiMemory, iscsiTargetAlias=iscsiTargetAlias, lunGUID=lunGUID, shareSnapshotSizeLow=shareSnapshotSizeLow, netbiosSocketFailure=netbiosSocketFailure, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, fcTargets=fcTargets, fcTargetsTable=fcTargetsTable, diskError=diskError, shareReservedSizeLow=shareReservedSizeLow, shareDeletionFailed=shareDeletionFailed, diskSlowIo=diskSlowIo, notificationSensorAction=notificationSensorAction, fcTargetReadMbps=fcTargetReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, poolOwnerController=poolOwnerController, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, nicEntry=nicEntry, notificationSensorSuspect=notificationSensorSuspect, diskCount=diskCount, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, fcInitiatorsTable=fcInitiatorsTable, volumeDeleteFailed=volumeDeleteFailed, lunCompressedRatio=lunCompressedRatio, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, fcPortOnline=fcPortOnline, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, iscsiTargets=iscsiTargets, shareCIFSWriteIops=shareCIFSWriteIops, notificationTargetEntityName=notificationTargetEntityName, iscsiInitiatorEntry=iscsiInitiatorEntry, poolUsedSizeHigh=poolUsedSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, notificationReadingUnit=notificationReadingUnit, diagnosticDataUploaded=diagnosticDataUploaded, nicGroup=nicGroup, notificationTime=notificationTime, diskRandomIOCount=diskRandomIOCount, fcTotalReadIops=fcTotalReadIops, poolDataWriteMbps=poolDataWriteMbps, shareQuotaHigh=shareQuotaHigh, replicationResumed=replicationResumed, poolMetaWriteLatency=poolMetaWriteLatency, testNotification=testNotification, tegileGroups=tegileGroups, poolDataReadMbps=poolDataReadMbps, fcInitiatorName=fcInitiatorName, iscsiAvgReadLatency=iscsiAvgReadLatency, notificationProps=notificationProps, notifications=notifications, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, snapshotRollbackFailed=snapshotRollbackFailed, shareNFSWriteIops=shareNFSWriteIops, diskAvgReadLatency=diskAvgReadLatency, cifsTotalReadIops=cifsTotalReadIops, projectShareCount=projectShareCount, diskTotalReadIops=diskTotalReadIops, shareDedupEnabled=shareDedupEnabled, intelliFlashSoftwareDown=intelliFlashSoftwareDown, cacheSSDReads=cacheSSDReads, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, snapshotDeleteFailed=snapshotDeleteFailed, lunIndex=lunIndex, poolDataWriteLatency=poolDataWriteLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, poolQuotaFinished=poolQuotaFinished, diskChassisIdx=diskChassisIdx, diskSizeHigh=diskSizeHigh, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareCompressedRatio=shareCompressedRatio, ipmiPowerSupply=ipmiPowerSupply, fcInitiatorIndex=fcInitiatorIndex, poolMetaWriteIops=poolMetaWriteIops, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, lunWriteLatency=lunWriteLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, haResourceDescription=haResourceDescription, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, ipmiThreshold=ipmiThreshold, fcTargetWriteIops=fcTargetWriteIops, webdocsUpgradeFailed=webdocsUpgradeFailed, shareCIFSReadMbps=shareCIFSReadMbps, poolDataReadLatency=poolDataReadLatency, poolFreeSizeLow=poolFreeSizeLow, tdpsUpgradeFailed=tdpsUpgradeFailed, snmpServiceStartFailed=snmpServiceStartFailed, shareCreatedSuccessfully=shareCreatedSuccessfully, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, volumeDeleteCompleted=volumeDeleteCompleted, diskAlias=diskAlias, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectFreeSizeLow=projectFreeSizeLow, fcTotalReadMbps=fcTotalReadMbps, poolDataSizeHigh=poolDataSizeHigh, nfsTotalReadMbps=nfsTotalReadMbps, projectTable=projectTable, projectEntry=projectEntry, iscsiTargetWriteMbps=iscsiTargetWriteMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, pools=pools, poolTotalReadIops=poolTotalReadIops, poolDataSizeLow=poolDataSizeLow, fcTargetIndex=fcTargetIndex, haResourceIndex=haResourceIndex, cacheRAMReads=cacheRAMReads, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, shareCIFSEnabled=shareCIFSEnabled, shareDataSizeHigh=shareDataSizeHigh, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolMetaWriteMbps=poolMetaWriteMbps, fcProperties=fcProperties, networkIpmpGroupDown=networkIpmpGroupDown, cpuTotalUsage=cpuTotalUsage, poolImported=poolImported, smbSocketFailure=smbSocketFailure, lunWriteIops=lunWriteIops, projectQuotaSizeHigh=projectQuotaSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, haControllerA_IPAddr=haControllerA_IPAddr, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, spareDiskReplaced=spareDiskReplaced, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, replicationFailed=replicationFailed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, tegileArray=tegileArray, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, replicationAborted=replicationAborted, adServerTimeDrift=adServerTimeDrift, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareCIFSWriteLatency=shareCIFSWriteLatency, projectIndex=projectIndex, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, smisServiceStopped=smisServiceStopped, poolUsedSizeLow=poolUsedSizeLow, shareName=shareName, volumeModifyCompleted=volumeModifyCompleted, fcTargetName=fcTargetName, lunProjectName=lunProjectName, iscsiInitiatorGroup=iscsiInitiatorGroup, ipmiVoltage=ipmiVoltage, poolIndex=poolIndex, poolReadCacheWriteIops=poolReadCacheWriteIops, upgradeDownloadFailed=upgradeDownloadFailed, iscsiTargetError=iscsiTargetError, nfsTotalWriteIops=nfsTotalWriteIops, sensorFailureEvent=sensorFailureEvent, replicationTargetDeleted=replicationTargetDeleted, diskIOCount=diskIOCount, cifsTotalReadMbps=cifsTotalReadMbps, diskPoolName=diskPoolName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolMetaReadIops=poolMetaReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, controllerDown=controllerDown, snapshotCreationFailed=snapshotCreationFailed, controllerUp=controllerUp, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, fcTargetReadIops=fcTargetReadIops, poolMetaReadMbps=poolMetaReadMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, maintenanceModeEnabled=maintenanceModeEnabled, iscsiTotalReadIops=iscsiTotalReadIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolAvgWriteLatency=poolAvgWriteLatency, diskDataWriteMbps=diskDataWriteMbps, networkInterfaceUp=networkInterfaceUp, properties=properties, shareNFSEnabled=shareNFSEnabled, shareCIFSReadLatency=shareCIFSReadLatency, poolDeletionFailed=poolDeletionFailed, sharePoolName=sharePoolName, smisServiceStartFailed=smisServiceStartFailed, ipmiOther=ipmiOther, cacheTotalWriteIops=cacheTotalWriteIops, lunWriteMbps=lunWriteMbps, smisServiceStopFailed=smisServiceStopFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTargetReadIops=iscsiTargetReadIops, lunDedupEnabled=lunDedupEnabled, diskTotalWriteMbps=diskTotalWriteMbps, projectDataSizeHigh=projectDataSizeHigh, maintenanceModeDisabled=maintenanceModeDisabled, fcAvgWriteLatency=fcAvgWriteLatency, projectCompressionEnabled=projectCompressionEnabled, lunReadMbps=lunReadMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, ipmiCurrent=ipmiCurrent)
mibBuilder.exportSymbols("TEGILE-MIB", poolProjectCount=poolProjectCount, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareSnapshotSizeHigh=shareSnapshotSizeHigh, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, iscsiWriteIops=iscsiWriteIops, targetGroupMemberAdded=targetGroupMemberAdded, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, haResources=haResources, snmpServiceStarted=snmpServiceStarted, currentObjectGroup=currentObjectGroup, fcPortOffline=fcPortOffline, poolReadCacheReadMbps=poolReadCacheReadMbps, memoryFailure=memoryFailure, haResourceEntry=haResourceEntry, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTargetName=iscsiTargetName, shareQuotaLow=shareQuotaLow, notificationSensorNumber=notificationSensorNumber, networkInterfaceDown=networkInterfaceDown, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, nvdimmFailDeviceError=nvdimmFailDeviceError, lunTable=lunTable, poolName=poolName, currentNotificationGroup=currentNotificationGroup, haControllerB_Uptime=haControllerB_Uptime, diskDataReadMbps=diskDataReadMbps, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, haControllerA_Uptime=haControllerA_Uptime, nicTransmitMbps=nicTransmitMbps, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, upgradeTimeout=upgradeTimeout, nicReceiveMbps=nicReceiveMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, targetGroupCreateCompleted=targetGroupCreateCompleted, lunFreeSizeHigh=lunFreeSizeHigh, deleteFolderFailed=deleteFolderFailed, fcTargetStatus=fcTargetStatus, iscsiInitiatorsTable=iscsiInitiatorsTable, replicationStarted=replicationStarted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolTotalWriteIops=poolTotalWriteIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskType=diskType, poolDataReadIops=poolDataReadIops, shareQuotaFinished=shareQuotaFinished, aclMigrationCompleted=aclMigrationCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiTargetReadMbps=iscsiTargetReadMbps, haControllerB_Name=haControllerB_Name, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, vmwareNFSDatastores=vmwareNFSDatastores, poolExported=poolExported, tegileArray_notifications=tegileArray_notifications, projectDeletionFailed=projectDeletionFailed, poolFreeSizeHigh=poolFreeSizeHigh, notificationEventCode=notificationEventCode, shareProjectName=shareProjectName, poolDegraded=poolDegraded, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiTargetAuth=iscsiTargetAuth, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, ipmiFan=ipmiFan, controllerTimeDrift=controllerTimeDrift, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, cifsAvgReadLatency=cifsAvgReadLatency, notificationComponentName=notificationComponentName, cacheTotalWriteMbps=cacheTotalWriteMbps, cpuSystemCalls=cpuSystemCalls, lunReadIops=lunReadIops, diskDataReadIops=diskDataReadIops, volumeQuotaFinished=volumeQuotaFinished, poolDeleted=poolDeleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolSizeLow=poolSizeLow, iscsiTargetEntry=iscsiTargetEntry, projectLunCount=projectLunCount, haResourceStatus=haResourceStatus, projectTotalSaving=projectTotalSaving, targetGroupMemberRemoved=targetGroupMemberRemoved, poolTotalSaving=poolTotalSaving, iscsiTargetWriteIops=iscsiTargetWriteIops, controllerHardwareModel=controllerHardwareModel, poolCreated=poolCreated, iscsiImproperTargetGroup=iscsiImproperTargetGroup, tegileCompliances=tegileCompliances, poolHealth=poolHealth, diskSizeLow=diskSizeLow, lunBlockSize=lunBlockSize, iscsiAvgWriteLatency=iscsiAvgWriteLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, projectName=projectName, diskGoneOffline=diskGoneOffline, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, replicationSourceRegistered=replicationSourceRegistered, lunDataSizeLow=lunDataSizeLow, disks=disks, haResourcesTable=haResourcesTable, fcTargetWriteMbps=fcTargetWriteMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolTotalWriteMbps=poolTotalWriteMbps, nfsTotalReadIops=nfsTotalReadIops, networkTotalTransmitMbps=networkTotalTransmitMbps, haResourceGroup=haResourceGroup, lunName=lunName, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, deleteFolderCompleted=deleteFolderCompleted, fcTargetReadLatency=fcTargetReadLatency, shareMountPoint=shareMountPoint, cifsTotalWriteMbps=cifsTotalWriteMbps, diskSequentialIOCount=diskSequentialIOCount, poolTable=poolTable, nicMTU=nicMTU, cacheTotalReadIops=cacheTotalReadIops, shareTable=shareTable, haResourceActiveNode=haResourceActiveNode, nicState=nicState, shareNFSWriteLatency=shareNFSWriteLatency, poolState=poolState, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolAvgReadLatency=poolAvgReadLatency, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunFreeSizeLow=lunFreeSizeLow, projectShares=projectShares, shareDataSizeLow=shareDataSizeLow, sanProperties=sanProperties, poolExpanded=poolExpanded, lunPoolName=lunPoolName, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, projectThresholdExceedWarning=projectThresholdExceedWarning, userLoginFailed=userLoginFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, upgradeDownloadStarted=upgradeDownloadStarted, replicationAbandoned=replicationAbandoned, snmpServiceStopped=snmpServiceStopped, diskTotalWriteIops=diskTotalWriteIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareNFSWriteMbps=shareNFSWriteMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcTotalWriteMbps=fcTotalWriteMbps, lunSizeLow=lunSizeLow, lunReadLatency=lunReadLatency, projectLUNs=projectLUNs, fcTargetEntry=fcTargetEntry, poolMetaReadLatency=poolMetaReadLatency, fcInitiatorGroup=fcInitiatorGroup, upgradeStarted=upgradeStarted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, notificationDescription=notificationDescription, fcTotalWriteIops=fcTotalWriteIops, lunTargetGroup=lunTargetGroup, snapshotCloningFailed=snapshotCloningFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectSnapshotSizeHigh=projectSnapshotSizeHigh, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunReservedSizeHigh=lunReservedSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareCIFSReadIops=shareCIFSReadIops, shareDeleted=shareDeleted, iscsiTargetsTable=iscsiTargetsTable, notificationObjects=notificationObjects, iscsiTargetGroup=iscsiTargetGroup, nicName=nicName, network=network, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, diskIsOnline=diskIsOnline, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, lunDataSizeHigh=lunDataSizeHigh, projectQuotaSizeLow=projectQuotaSizeLow, diskDataWriteIops=diskDataWriteIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcInitiatorEntry=fcInitiatorEntry, lunEntry=lunEntry, diskEntry=diskEntry, cifsTotalWriteIops=cifsTotalWriteIops, diskIndex=diskIndex, diskAvgWriteLatency=diskAvgWriteLatency, projectDataSizeLow=projectDataSizeLow, nvdimmFailInitializationError=nvdimmFailInitializationError, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiProperties=iscsiProperties, lunSnapshotSizeHigh=lunSnapshotSizeHigh, webdocsUpgradeCompleted=webdocsUpgradeCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, nvdimmFailSoftError=nvdimmFailSoftError, alertsCleanupCompleted=alertsCleanupCompleted, shareNFSReadIops=shareNFSReadIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, nicIndex=nicIndex, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolReadCacheReadIops=poolReadCacheReadIops, iscsiInitiators=iscsiInitiators, upgradeFailed=upgradeFailed, iscsiTargetIndex=iscsiTargetIndex, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetWriteLatency=fcTargetWriteLatency, lunReservedSizeLow=lunReservedSizeLow, nicTable=nicTable, projectDeleted=projectDeleted, diskState=diskState, fcAvgReadLatency=fcAvgReadLatency, shareNFSReadMbps=shareNFSReadMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, cifsAvgWriteLatency=cifsAvgWriteLatency, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, lunSizeHigh=lunSizeHigh, aclMigrationStarted=aclMigrationStarted)
