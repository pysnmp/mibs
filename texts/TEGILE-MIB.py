...
# Produced by pysmi-1.1.8 at Thu Jan  5 13:29:37 2023
...
iso, ObjectIdentity, Unsigned32, Bits, TimeTicks, Counter64, NotificationType, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, ModuleIdentity, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Unsigned32", "Bits", "TimeTicks", "Counter64", "NotificationType", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "ModuleIdentity", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolReadCacheReadLatency=poolReadCacheReadLatency, diskTotalWriteIops=diskTotalWriteIops, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolDeleted=poolDeleted, fcInitiatorName=fcInitiatorName, ipmiVoltage=ipmiVoltage, ntpServerTimeDrift=ntpServerTimeDrift, controllerTimeDrift=controllerTimeDrift, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolTotalSaving=poolTotalSaving, fcPortOnline=fcPortOnline, ipmiCurrent=ipmiCurrent, poolOwnerController=poolOwnerController, basicCompliance=basicCompliance, iscsiInitiatorChapUser=iscsiInitiatorChapUser, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiTargetIndex=iscsiTargetIndex, notificationReadingTriggerValue=notificationReadingTriggerValue, replicationAbandoned=replicationAbandoned, shareReservedSizeLow=shareReservedSizeLow, poolDataSizeHigh=poolDataSizeHigh, pools=pools, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcTargetReadMbps=fcTargetReadMbps, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, diskCount=diskCount, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectFreeSizeHigh=projectFreeSizeHigh, replicationPaused=replicationPaused, projectIndex=projectIndex, projectName=projectName, notificationProps=notificationProps, globalStatistics=globalStatistics, cacheTotalReadIops=cacheTotalReadIops, notificationObjects=notificationObjects, maintenanceModeDisabled=maintenanceModeDisabled, diskTable=diskTable, fcTargetWriteIops=fcTargetWriteIops, sanProperties=sanProperties, fcTargetName=fcTargetName, ipmiOther=ipmiOther, poolTotalWriteMbps=poolTotalWriteMbps, diskAlias=diskAlias, lunSizeHigh=lunSizeHigh, poolTable=poolTable, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, netbiosSocketFailure=netbiosSocketFailure, projectDedupEnabled=projectDedupEnabled, networkTotalReceiveMbps=networkTotalReceiveMbps, networkIpmpGroupDown=networkIpmpGroupDown, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, network=network, poolDataSizeLow=poolDataSizeLow, fcInitiatorEntry=fcInitiatorEntry, nicName=nicName, lunProtocol=lunProtocol, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, fcTargets=fcTargets, projectThresholdExceedWarning=projectThresholdExceedWarning, upgradeDownloadStarted=upgradeDownloadStarted, lunInitiatorGroup=lunInitiatorGroup, poolDegraded=poolDegraded, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, networkInterfaceDown=networkInterfaceDown, ipmiTemperature=ipmiTemperature, poolFreeSizeHigh=poolFreeSizeHigh, poolUsedSizeLow=poolUsedSizeLow, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectPoolName=projectPoolName, adServerTimeDrift=adServerTimeDrift, currentObjectGroup=currentObjectGroup, replicationTargetDeleted=replicationTargetDeleted, nfsTotalWriteMbps=nfsTotalWriteMbps, smbSocketFailure=smbSocketFailure, smisServiceStartFailed=smisServiceStartFailed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, poolSizeLow=poolSizeLow, upgradeDownloadFailed=upgradeDownloadFailed, diskTotalReadIops=diskTotalReadIops, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiTargets=iscsiTargets, cifsAvgReadLatency=cifsAvgReadLatency, shareDataSizeHigh=shareDataSizeHigh, shareMountPoint=shareMountPoint, shareTable=shareTable, shareNFSReadIops=shareNFSReadIops, shareProjectName=shareProjectName, diskSizeLow=diskSizeLow, cifsTotalWriteMbps=cifsTotalWriteMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolQuotaFinished=poolQuotaFinished, sensorFailureEvent=sensorFailureEvent, nfsAvgReadLatency=nfsAvgReadLatency, lunCompressionEnabled=lunCompressionEnabled, iscsiTotalWriteMbps=iscsiTotalWriteMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, nicMTU=nicMTU, testNotification=testNotification, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolDataWriteLatency=poolDataWriteLatency, poolExported=poolExported, fcTargetsTable=fcTargetsTable, iscsiAvgReadLatency=iscsiAvgReadLatency, shareCIFSReadIops=shareCIFSReadIops, iscsiInitiatorName=iscsiInitiatorName, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, shareCompressionEnabled=shareCompressionEnabled, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, shareCIFSReadLatency=shareCIFSReadLatency, poolProjects=poolProjects, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolUsedSizeHigh=poolUsedSizeHigh, projectEntry=projectEntry, lunFreeSizeHigh=lunFreeSizeHigh, diagnosticDataUploaded=diagnosticDataUploaded, poolReadCacheReadMbps=poolReadCacheReadMbps, diskSequentialIOCount=diskSequentialIOCount, lunPoolName=lunPoolName, iscsiTargetReadIops=iscsiTargetReadIops, shareNFSEnabled=shareNFSEnabled, poolMetaWriteIops=poolMetaWriteIops, haResourceGroup=haResourceGroup, networkInterfaceUp=networkInterfaceUp, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, sharePoolName=sharePoolName, haControllerB_IPAddr=haControllerB_IPAddr, controllerDown=controllerDown, snmpServiceStopped=snmpServiceStopped, shareExceedThresholdWarning=shareExceedThresholdWarning, projectShares=projectShares, diskDataWriteIops=diskDataWriteIops, diskEntry=diskEntry, fcAvgReadLatency=fcAvgReadLatency, shareNFSWriteIops=shareNFSWriteIops, projectSnapshotSizeLow=projectSnapshotSizeLow, poolReadCacheWriteIops=poolReadCacheWriteIops, fcPortOffline=fcPortOffline, fcTargetReadIops=fcTargetReadIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, haControllerA_Uptime=haControllerA_Uptime, iscsiTotalReadIops=iscsiTotalReadIops, diskPoolName=diskPoolName, lunReservedSizeHigh=lunReservedSizeHigh, fcTargetModifyCompleted=fcTargetModifyCompleted, haResources=haResources, notificationSensorNumber=notificationSensorNumber, volumeDeleteCompleted=volumeDeleteCompleted, volumeQuotaFinished=volumeQuotaFinished, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, snmpServiceStartFailed=snmpServiceStartFailed, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, spareDiskReplaced=spareDiskReplaced, snapshotDeleteFailed=snapshotDeleteFailed, diskTotalReadMbps=diskTotalReadMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolMetaWriteLatency=poolMetaWriteLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, shareCIFSWriteMbps=shareCIFSWriteMbps, notificationComponentName=notificationComponentName, nfsTotalReadMbps=nfsTotalReadMbps, poolDataReadIops=poolDataReadIops, diskError=diskError, poolReadCacheReadIops=poolReadCacheReadIops, nicReceiveMbps=nicReceiveMbps, diskIndex=diskIndex, shareEntry=shareEntry, nicTable=nicTable, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiInitiatorsTable=iscsiInitiatorsTable, nvdimmFailDeviceError=nvdimmFailDeviceError, alertsCleanupCompleted=alertsCleanupCompleted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, cacheSSDReads=cacheSSDReads, fcInitiatorsTable=fcInitiatorsTable, poolCreated=poolCreated, cpuSystemCalls=cpuSystemCalls, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareQuotaFinished=shareQuotaFinished, iscsiWriteIops=iscsiWriteIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, nicTransmitMbps=nicTransmitMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiTotalReadMbps=iscsiTotalReadMbps, volumeModifyCompleted=volumeModifyCompleted, properties=properties, nvdimmFailSoftError=nvdimmFailSoftError, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, cpuTotalUsage=cpuTotalUsage, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, tegileConformance=tegileConformance, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectFreeSizeLow=projectFreeSizeLow, poolState=poolState, haControllerA_Name=haControllerA_Name, shareDataSizeLow=shareDataSizeLow, replicationAborted=replicationAborted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, tdpsUpgradeTimeout=tdpsUpgradeTimeout, diskDataReadIops=diskDataReadIops, lunSizeLow=lunSizeLow, haResourceStatus=haResourceStatus, replicationResumed=replicationResumed, fcTargetEntry=fcTargetEntry, projectQuotaFinished=projectQuotaFinished, notificationSensorAction=notificationSensorAction, nicIndex=nicIndex, maintenanceModeEnabled=maintenanceModeEnabled, deleteFolderCompleted=deleteFolderCompleted, poolDataWriteIops=poolDataWriteIops, lunWriteIops=lunWriteIops, shareCIFSWriteLatency=shareCIFSWriteLatency, shareDeletionFailed=shareDeletionFailed, targetGroupMemberAdded=targetGroupMemberAdded, upgradeCompleted=upgradeCompleted, fcTargetWriteMbps=fcTargetWriteMbps, snapshotCreationFailed=snapshotCreationFailed, iscsiTargetGroup=iscsiTargetGroup, userLoginFailed=userLoginFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, haResourcesTable=haResourcesTable, poolIndex=poolIndex, notificationSeverity=notificationSeverity, shareNFSReadMbps=shareNFSReadMbps, snapshotRollbackFailed=snapshotRollbackFailed, PYSNMP_MODULE_ID=tegile, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiInitiatorEntry=iscsiInitiatorEntry, diskGoneOffline=diskGoneOffline, lunCompressedRatio=lunCompressedRatio, shareNFSWriteMbps=shareNFSWriteMbps, snmpServiceStarted=snmpServiceStarted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, iscsiTargetAuth=iscsiTargetAuth, snmpAgentVersion=snmpAgentVersion, poolTotalReadMbps=poolTotalReadMbps, fcTargetIndex=fcTargetIndex, poolMetaReadLatency=poolMetaReadLatency, diskChassisIdx=diskChassisIdx, projectSnapshotSizeHigh=projectSnapshotSizeHigh, fcTotalWriteIops=fcTotalWriteIops)
mibBuilder.exportSymbols("TEGILE-MIB", upgradeDownloadCompleted=upgradeDownloadCompleted, fcInitiatorIndex=fcInitiatorIndex, poolWriteCacheWriteIops=poolWriteCacheWriteIops, tdpsUpgradeFailed=tdpsUpgradeFailed, shareSnapshotSizeLow=shareSnapshotSizeLow, currentNotificationGroup=currentNotificationGroup, aclMigrationCompleted=aclMigrationCompleted, targetGroupMemberRemoved=targetGroupMemberRemoved, poolTotalWriteIops=poolTotalWriteIops, shareNFSWriteLatency=shareNFSWriteLatency, shareCIFSWriteIops=shareCIFSWriteIops, haResourceDescription=haResourceDescription, unknownSensorEvent=unknownSensorEvent, poolDataWriteMbps=poolDataWriteMbps, lunSnapshotSizeHigh=lunSnapshotSizeHigh, deleteFolderFailed=deleteFolderFailed, poolAvgReadLatency=poolAvgReadLatency, projectModified=projectModified, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectDataSizeHigh=projectDataSizeHigh, diskSlowIo=diskSlowIo, cifsAvgWriteLatency=cifsAvgWriteLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, shareName=shareName, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, nicState=nicState, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargetAlias=iscsiTargetAlias, haResourceEntry=haResourceEntry, replicationFailed=replicationFailed, smisServiceStopFailed=smisServiceStopFailed, cifsTotalReadMbps=cifsTotalReadMbps, projectTable=projectTable, tegile=tegile, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, nvdimmFailInitializationError=nvdimmFailInitializationError, nvdimmFailUnknownError=nvdimmFailUnknownError, haControllerB_Name=haControllerB_Name, ipmiMemory=ipmiMemory, lunSnapshotSizeLow=lunSnapshotSizeLow, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, volumeDeleteFailed=volumeDeleteFailed, aclMigrationStarted=aclMigrationStarted, cpuInterrupts=cpuInterrupts, tegileCompliances=tegileCompliances, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, projectLUNs=projectLUNs, shareCompressedRatio=shareCompressedRatio, lunReadLatency=lunReadLatency, iscsiProperties=iscsiProperties, shareIndex=shareIndex, vmwareNFSDatastores=vmwareNFSDatastores, fcInitiators=fcInitiators, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, diskRandomIOCount=diskRandomIOCount, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolExpanded=poolExpanded, ipmiPowerSupply=ipmiPowerSupply, shareQuotaLow=shareQuotaLow, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolMetaReadIops=poolMetaReadIops, shareDeleted=shareDeleted, replicationSourceRegistered=replicationSourceRegistered, networkTotalTransmitMbps=networkTotalTransmitMbps, nfsTotalWriteIops=nfsTotalWriteIops, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolFreeSizeLow=poolFreeSizeLow, shareReservedSizeHigh=shareReservedSizeHigh, replicationStarted=replicationStarted, fcTotalWriteMbps=fcTotalWriteMbps, networkIpmpGroupUp=networkIpmpGroupUp, disks=disks, lunFreeSizeLow=lunFreeSizeLow, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, haResourceActiveNode=haResourceActiveNode, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, lunTable=lunTable, projectShareCount=projectShareCount, shareCIFSEnabled=shareCIFSEnabled, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, lunWriteMbps=lunWriteMbps, diskIOCount=diskIOCount, lunDedupEnabled=lunDedupEnabled, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcTargetWriteLatency=fcTargetWriteLatency, fcAvgWriteLatency=fcAvgWriteLatency, poolAvgWriteLatency=poolAvgWriteLatency, projectDeletionFailed=projectDeletionFailed, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiInitiators=iscsiInitiators, poolImported=poolImported, poolName=poolName, haControllerB_Uptime=haControllerB_Uptime, poolDeletionFailed=poolDeletionFailed, notificationEventCode=notificationEventCode, cacheTotalWriteMbps=cacheTotalWriteMbps, lunEntry=lunEntry, iscsiTargetName=iscsiTargetName, iscsiTargetReadLatency=iscsiTargetReadLatency, poolUpgraded=poolUpgraded, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, ipmiThreshold=ipmiThreshold, fcTargetReadLatency=fcTargetReadLatency, fcTargetStatus=fcTargetStatus, shareCreatedSuccessfully=shareCreatedSuccessfully, haResourceIndex=haResourceIndex, lunGUID=lunGUID, diskDataWriteMbps=diskDataWriteMbps, cacheRAMReads=cacheRAMReads, fcInitiatorGroup=fcInitiatorGroup, nfsTotalReadIops=nfsTotalReadIops, diskType=diskType, snmpServiceStopFailed=snmpServiceStopFailed, iscsiImproperTargetGroup=iscsiImproperTargetGroup, upgradeTimeout=upgradeTimeout, fcTargetGroup=fcTargetGroup, poolProjectCount=poolProjectCount, poolTotalReadIops=poolTotalReadIops, poolDataReadLatency=poolDataReadLatency, replicationComplete=replicationComplete, projectQuotaSizeLow=projectQuotaSizeLow, lunName=lunName, iscsiTargetError=iscsiTargetError, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, diskIsOnline=diskIsOnline, poolMetaWriteMbps=poolMetaWriteMbps, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, lunProjectName=lunProjectName, lunReadMbps=lunReadMbps, shareQuotaHigh=shareQuotaHigh, shareNFSReadLatency=shareNFSReadLatency, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, smisServiceStarted=smisServiceStarted, upgradeFailed=upgradeFailed, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, notificationReadingUnit=notificationReadingUnit, diskState=diskState, lunDataSizeHigh=lunDataSizeHigh, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, volumeCreatedSuccessfully=volumeCreatedSuccessfully, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, notifications=notifications, notificationTargetEntityName=notificationTargetEntityName, lunIndex=lunIndex, poolSizeHigh=poolSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, diskTotalWriteMbps=diskTotalWriteMbps, lunTargetGroup=lunTargetGroup, smisServiceStopped=smisServiceStopped, projectTotalSaving=projectTotalSaving, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, nfsAvgWriteLatency=nfsAvgWriteLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, poolCount=poolCount, projectCompressionEnabled=projectCompressionEnabled, diskDataReadMbps=diskDataReadMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, diskSizeHigh=diskSizeHigh, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiTargetGroupError=iscsiTargetGroupError, notificationDescription=notificationDescription, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, projectCreatedSuccessfully=projectCreatedSuccessfully, shareDedupEnabled=shareDedupEnabled, iscsiTargetEntry=iscsiTargetEntry, haControllerA_IPAddr=haControllerA_IPAddr, lunBlockSize=lunBlockSize, nicGroup=nicGroup, tegileArray=tegileArray, tdpsUpgradeCompleted=tdpsUpgradeCompleted, fcTotalReadIops=fcTotalReadIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, haResourceName=haResourceName, notificationSensorSuspect=notificationSensorSuspect, poolMetaReadMbps=poolMetaReadMbps, lunWriteLatency=lunWriteLatency, fcProperties=fcProperties, projectLunCount=projectLunCount, iscsiTargetReadMbps=iscsiTargetReadMbps, snapshotCloneCompleted=snapshotCloneCompleted, poolDataReadMbps=poolDataReadMbps, poolEntry=poolEntry, nicEntry=nicEntry, lunReservedSizeLow=lunReservedSizeLow, diskAvgReadLatency=diskAvgReadLatency, projectDeleted=projectDeleted, memoryFailure=memoryFailure, cifsTotalWriteIops=cifsTotalWriteIops, upgradeStarted=upgradeStarted, iscsiTargetsTable=iscsiTargetsTable, controllerUp=controllerUp, ipmiFan=ipmiFan, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, tegileGroups=tegileGroups, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, controllerHardwareModel=controllerHardwareModel, tegileArray_notifications=tegileArray_notifications, shareCIFSReadMbps=shareCIFSReadMbps, diskAvgWriteLatency=diskAvgWriteLatency, projectDataSizeLow=projectDataSizeLow, cifsTotalReadIops=cifsTotalReadIops, fcTotalReadMbps=fcTotalReadMbps, notificationTime=notificationTime, poolHealth=poolHealth, lunReadIops=lunReadIops, targetGroupCreateCompleted=targetGroupCreateCompleted, snapshotCloningFailed=snapshotCloningFailed, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunDataSizeLow=lunDataSizeLow)
