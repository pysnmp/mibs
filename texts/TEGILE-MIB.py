...
# Produced by pysmi-1.1.8 at Thu Sep  8 10:25:59 2022
...
ObjectIdentity, MibIdentifier, Bits, enterprises, Integer32, ModuleIdentity, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, TimeTicks, Gauge32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Bits", "enterprises", "Integer32", "ModuleIdentity", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "TimeTicks", "Gauge32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolUsedSizeHigh=poolUsedSizeHigh, projectQuotaSizeHigh=projectQuotaSizeHigh, fcTargetWriteLatency=fcTargetWriteLatency, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, nfsAvgReadLatency=nfsAvgReadLatency, notificationTargetEntityName=notificationTargetEntityName, smisServiceStartFailed=smisServiceStartFailed, tegileArray=tegileArray, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, haControllerA_Name=haControllerA_Name, initiatorGroupMemberAdded=initiatorGroupMemberAdded, controllerHardwareModel=controllerHardwareModel, sensorFailureEvent=sensorFailureEvent, notificationReadingUnit=notificationReadingUnit, upgradeFailed=upgradeFailed, iscsiTargetReadMbps=iscsiTargetReadMbps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiAvgReadLatency=iscsiAvgReadLatency, lunFreeSizeLow=lunFreeSizeLow, fcTargetEntry=fcTargetEntry, nicMTU=nicMTU, projectName=projectName, unknownSensorEvent=unknownSensorEvent, nfsTotalReadIops=nfsTotalReadIops, diskTotalWriteIops=diskTotalWriteIops, iscsiTargetsTable=iscsiTargetsTable, webdocsUpgradeCompleted=webdocsUpgradeCompleted, sanProperties=sanProperties, haControllerB_IPAddr=haControllerB_IPAddr, replicationComplete=replicationComplete, lunInitiatorGroup=lunInitiatorGroup, lunWriteIops=lunWriteIops, shareCIFSReadLatency=shareCIFSReadLatency, diskAvgReadLatency=diskAvgReadLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, fcTargetsTable=fcTargetsTable, haResourceDescription=haResourceDescription, iscsiTargetError=iscsiTargetError, tdpsUpgradeCompleted=tdpsUpgradeCompleted, spareDiskReplaced=spareDiskReplaced, cacheSSDReads=cacheSSDReads, cifsAvgWriteLatency=cifsAvgWriteLatency, haResourceGroup=haResourceGroup, lunWriteLatency=lunWriteLatency, maintenanceModeDisabled=maintenanceModeDisabled, ipmiVoltage=ipmiVoltage, lunIndex=lunIndex, shareQuotaLow=shareQuotaLow, diskSlowIo=diskSlowIo, lunReadIops=lunReadIops, maintenanceModeEnabled=maintenanceModeEnabled, fcInitiatorIndex=fcInitiatorIndex, userLoginFailed=userLoginFailed, disks=disks, shareProjectName=shareProjectName, diskCount=diskCount, iscsiTargetReadLatency=iscsiTargetReadLatency, notificationSeverity=notificationSeverity, diskSizeHigh=diskSizeHigh, pools=pools, targetGroupCreateCompleted=targetGroupCreateCompleted, tegileGroups=tegileGroups, cpuTotalUsage=cpuTotalUsage, tegileArray_notifications=tegileArray_notifications, poolQuotaFinished=poolQuotaFinished, lunBlockSize=lunBlockSize, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, tdpsUpgradeFailed=tdpsUpgradeFailed, currentNotificationGroup=currentNotificationGroup, projectThresholdExceedWarning=projectThresholdExceedWarning, shareReservedSizeLow=shareReservedSizeLow, fcTargetStatus=fcTargetStatus, poolTotalSaving=poolTotalSaving, basicCompliance=basicCompliance, poolSizeLow=poolSizeLow, globalStatistics=globalStatistics, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectDedupEnabled=projectDedupEnabled, targetGroupMemberRemoved=targetGroupMemberRemoved, shareDeletionFailed=shareDeletionFailed, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, cacheTotalWriteIops=cacheTotalWriteIops, poolOwnerController=poolOwnerController, poolTotalWriteMbps=poolTotalWriteMbps, lunTargetGroup=lunTargetGroup, notificationObjects=notificationObjects, poolUsedSizeLow=poolUsedSizeLow, aclMigrationStarted=aclMigrationStarted, poolTotalWriteIops=poolTotalWriteIops, projectQuotaSizeLow=projectQuotaSizeLow, diskChassisIdx=diskChassisIdx, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectIndex=projectIndex, volumeDeleteCompleted=volumeDeleteCompleted, shareDeleted=shareDeleted, lunDataSizeHigh=lunDataSizeHigh, notificationSensorNumber=notificationSensorNumber, ipmiThreshold=ipmiThreshold, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiTargetIndex=iscsiTargetIndex, poolMetaWriteMbps=poolMetaWriteMbps, iscsiTargetName=iscsiTargetName, haControllerB_Uptime=haControllerB_Uptime, shareTable=shareTable, fcTargetReadMbps=fcTargetReadMbps, iscsiTargetAlias=iscsiTargetAlias, fcAvgReadLatency=fcAvgReadLatency, volumeModifyCompleted=volumeModifyCompleted, replicationSourceRegistered=replicationSourceRegistered, poolAvgWriteLatency=poolAvgWriteLatency, lunReservedSizeHigh=lunReservedSizeHigh, networkInterfaceDown=networkInterfaceDown, networkIpmpGroupUp=networkIpmpGroupUp, shareReservedSizeHigh=shareReservedSizeHigh, projectModified=projectModified, testNotification=testNotification, shareIndex=shareIndex, fcAvgWriteLatency=fcAvgWriteLatency, fcInitiatorEntry=fcInitiatorEntry, notificationProps=notificationProps, tegileCompliances=tegileCompliances, diskState=diskState, deleteFolderCompleted=deleteFolderCompleted, poolEntry=poolEntry, poolHealth=poolHealth, haResourceIndex=haResourceIndex, fcInitiators=fcInitiators, netbiosSocketFailure=netbiosSocketFailure, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcInitiatorName=fcInitiatorName, targetGroupMemberAdded=targetGroupMemberAdded, snmpServiceStopped=snmpServiceStopped, shareCreatedSuccessfully=shareCreatedSuccessfully, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, ipmiPowerSupply=ipmiPowerSupply, vmwareNFSDatastores=vmwareNFSDatastores, ipmiCurrent=ipmiCurrent, shareNFSWriteLatency=shareNFSWriteLatency, lunEntry=lunEntry, poolFreeSizeHigh=poolFreeSizeHigh, iscsiTotalWriteMbps=iscsiTotalWriteMbps, fcTargets=fcTargets, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, cpuSystemCalls=cpuSystemCalls, networkIpmpGroupDown=networkIpmpGroupDown, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, fcTotalWriteIops=fcTotalWriteIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiTargetGroupError=iscsiTargetGroupError, iscsiInitiatorIndex=iscsiInitiatorIndex, poolMetaReadIops=poolMetaReadIops, poolDegraded=poolDegraded, upgradeStarted=upgradeStarted, projectSnapshotSizeLow=projectSnapshotSizeLow, upgradeTimeout=upgradeTimeout, lunReservedSizeLow=lunReservedSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, volumeQuotaFinished=volumeQuotaFinished, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, smisServiceStarted=smisServiceStarted, poolReadCacheReadIops=poolReadCacheReadIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, diskGoneOffline=diskGoneOffline, shareNFSReadMbps=shareNFSReadMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, poolDeletionFailed=poolDeletionFailed, iscsiInitiatorsTable=iscsiInitiatorsTable, poolReadCacheWriteLatency=poolReadCacheWriteLatency, cifsTotalReadIops=cifsTotalReadIops, shareEntry=shareEntry, shareNFSWriteIops=shareNFSWriteIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolSizeHigh=poolSizeHigh, notifications=notifications, projectDataSizeLow=projectDataSizeLow, fcPortOffline=fcPortOffline, poolCount=poolCount, iscsiTargetGroup=iscsiTargetGroup, shareCompressionEnabled=shareCompressionEnabled, shareDedupEnabled=shareDedupEnabled, lunSizeLow=lunSizeLow, snapshotRollbackFailed=snapshotRollbackFailed, replicationFailed=replicationFailed, notificationSensorAction=notificationSensorAction, notificationThresholdTriggerValue=notificationThresholdTriggerValue, replicationAbandoned=replicationAbandoned, shareCIFSReadMbps=shareCIFSReadMbps, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, lunSizeHigh=lunSizeHigh, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nfsTotalReadMbps=nfsTotalReadMbps, lunReadLatency=lunReadLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, diskPoolName=diskPoolName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, fcPortOnline=fcPortOnline, replicationResumed=replicationResumed, haResourceName=haResourceName, replicationAborted=replicationAborted, lunDedupEnabled=lunDedupEnabled, ipmiTemperature=ipmiTemperature, diskEntry=diskEntry, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolTable=poolTable, shareCIFSWriteIops=shareCIFSWriteIops, diskError=diskError, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiInitiators=iscsiInitiators, diskIOCount=diskIOCount, volumeCreatedSuccessfully=volumeCreatedSuccessfully, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunCompressedRatio=lunCompressedRatio, lunWriteMbps=lunWriteMbps, cacheTotalReadMbps=cacheTotalReadMbps, cacheRAMReads=cacheRAMReads, controllerTimeDrift=controllerTimeDrift, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolDataWriteLatency=poolDataWriteLatency, iscsiTargetEntry=iscsiTargetEntry, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolExpanded=poolExpanded, replicationPaused=replicationPaused, projectCompressionEnabled=projectCompressionEnabled, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiWriteIops=iscsiWriteIops, diskTotalReadMbps=diskTotalReadMbps, projectQuotaFinished=projectQuotaFinished, lunPoolName=lunPoolName, lunProjectName=lunProjectName, haResources=haResources, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, upgradeDownloadFailed=upgradeDownloadFailed, projectTable=projectTable, poolIndex=poolIndex, shareCIFSWriteLatency=shareCIFSWriteLatency, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolTotalReadIops=poolTotalReadIops, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, diskDataWriteIops=diskDataWriteIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolDataSizeHigh=poolDataSizeHigh, fcTotalWriteMbps=fcTotalWriteMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, controllerUp=controllerUp, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, projectPoolName=projectPoolName, smisServiceStopped=smisServiceStopped, haResourceActiveNode=haResourceActiveNode, iscsiInitiatorGroup=iscsiInitiatorGroup)
mibBuilder.exportSymbols("TEGILE-MIB", nicReceiveMbps=nicReceiveMbps, iscsiTargetWriteMbps=iscsiTargetWriteMbps, sharePoolName=sharePoolName, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, shareNFSReadLatency=shareNFSReadLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiTargetAuth=iscsiTargetAuth, fcTargetWriteIops=fcTargetWriteIops, diskTable=diskTable, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, shareQuotaFinished=shareQuotaFinished, shareNFSReadIops=shareNFSReadIops, fcInitiatorGroup=fcInitiatorGroup, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, networkTotalTransmitMbps=networkTotalTransmitMbps, ntpServerTimeDrift=ntpServerTimeDrift, poolDeleted=poolDeleted, nfsAvgWriteLatency=nfsAvgWriteLatency, nicGroup=nicGroup, fcTargetIndex=fcTargetIndex, ipmiMemory=ipmiMemory, projectFreeSizeLow=projectFreeSizeLow, lunProtocol=lunProtocol, poolExported=poolExported, cacheTotalWriteMbps=cacheTotalWriteMbps, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, tegileConformance=tegileConformance, properties=properties, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolMetaWriteLatency=poolMetaWriteLatency, projectTotalSaving=projectTotalSaving, snmpServiceStopFailed=snmpServiceStopFailed, poolAvgReadLatency=poolAvgReadLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, shareCIFSWriteMbps=shareCIFSWriteMbps, networkInterfaceUp=networkInterfaceUp, poolDataSizeLow=poolDataSizeLow, volumeDeleteFailed=volumeDeleteFailed, shareCompressedRatio=shareCompressedRatio, cpuInterrupts=cpuInterrupts, fcTargetReadLatency=fcTargetReadLatency, nicIndex=nicIndex, networkTotalReceiveMbps=networkTotalReceiveMbps, fcTargetGroup=fcTargetGroup, diskAvgWriteLatency=diskAvgWriteLatency, replicationTargetDeleted=replicationTargetDeleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolProjects=poolProjects, ipmiFan=ipmiFan, nicState=nicState, poolReadCacheWriteIops=poolReadCacheWriteIops, lunGUID=lunGUID, lunCompressionEnabled=lunCompressionEnabled, cifsTotalWriteIops=cifsTotalWriteIops, notificationDescription=notificationDescription, iscsiTargets=iscsiTargets, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolState=poolState, poolImported=poolImported, shareNFSEnabled=shareNFSEnabled, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, smisServiceStopFailed=smisServiceStopFailed, poolReadCacheReadLatency=poolReadCacheReadLatency, currentObjectGroup=currentObjectGroup, haControllerA_IPAddr=haControllerA_IPAddr, tegile=tegile, nicEntry=nicEntry, poolDataReadIops=poolDataReadIops, snapshotCreationFailed=snapshotCreationFailed, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, diskIsOnline=diskIsOnline, replicationStarted=replicationStarted, cifsTotalReadMbps=cifsTotalReadMbps, upgradeDownloadStarted=upgradeDownloadStarted, poolTotalReadMbps=poolTotalReadMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetModifyCompleted=fcTargetModifyCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, projectLUNs=projectLUNs, diagnosticDataUploaded=diagnosticDataUploaded, iscsiInitiatorEntry=iscsiInitiatorEntry, diskIndex=diskIndex, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiTargetReadIops=iscsiTargetReadIops, poolFreeSizeLow=poolFreeSizeLow, projectFreeSizeHigh=projectFreeSizeHigh, PYSNMP_MODULE_ID=tegile, projectShares=projectShares, nicTable=nicTable, poolMetaWriteIops=poolMetaWriteIops, shareDataSizeLow=shareDataSizeLow, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, snmpServiceStartFailed=snmpServiceStartFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, diskDataWriteMbps=diskDataWriteMbps, diskSequentialIOCount=diskSequentialIOCount, haResourcesTable=haResourcesTable, projectLunCount=projectLunCount, diskDataReadIops=diskDataReadIops, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcTargetReadIops=fcTargetReadIops, poolUpgraded=poolUpgraded, lunName=lunName, diskAlias=diskAlias, controllerDown=controllerDown, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolCreated=poolCreated, notificationEventCode=notificationEventCode, shareDataSizeHigh=shareDataSizeHigh, iscsiTotalReadIops=iscsiTotalReadIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, cifsAvgReadLatency=cifsAvgReadLatency, snapshotDeleteFailed=snapshotDeleteFailed, poolDataWriteIops=poolDataWriteIops, cacheTotalReadIops=cacheTotalReadIops, nvdimmFailSoftError=nvdimmFailSoftError, poolName=poolName, haResourceEntry=haResourceEntry, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, upgradeCompleted=upgradeCompleted, poolMetaReadLatency=poolMetaReadLatency, diskDataReadMbps=diskDataReadMbps, projectDataSizeHigh=projectDataSizeHigh, diskType=diskType, iscsiProperties=iscsiProperties, projectDeleted=projectDeleted, fcProperties=fcProperties, adServerTimeDrift=adServerTimeDrift, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, diskTotalReadIops=diskTotalReadIops, notificationSensorSuspect=notificationSensorSuspect, snmpServiceStarted=snmpServiceStarted, fcTotalReadIops=fcTotalReadIops, shareCIFSEnabled=shareCIFSEnabled, nicName=nicName, alertsCleanupCompleted=alertsCleanupCompleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, nvdimmFailInitializationError=nvdimmFailInitializationError, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, haResourceStatus=haResourceStatus, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, haControllerB_Name=haControllerB_Name, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, projectEntry=projectEntry, upgradeDownloadCompleted=upgradeDownloadCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, deleteFolderFailed=deleteFolderFailed, lunTable=lunTable, fcTargetName=fcTargetName, snapshotCloningFailed=snapshotCloningFailed, lunDataSizeLow=lunDataSizeLow, diskTotalWriteMbps=diskTotalWriteMbps, lunFreeSizeHigh=lunFreeSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, smbSocketFailure=smbSocketFailure, nicTransmitMbps=nicTransmitMbps, notificationComponentName=notificationComponentName, projectShareCount=projectShareCount, ipmiOther=ipmiOther, projectSnapshotSizeHigh=projectSnapshotSizeHigh, diskRandomIOCount=diskRandomIOCount, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareName=shareName, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, shareMountPoint=shareMountPoint, haControllerA_Uptime=haControllerA_Uptime, shareQuotaHigh=shareQuotaHigh, memoryFailure=memoryFailure, iscsiTotalReadMbps=iscsiTotalReadMbps, poolDataWriteMbps=poolDataWriteMbps, projectDeletionFailed=projectDeletionFailed, poolDataReadLatency=poolDataReadLatency, poolMetaReadMbps=poolMetaReadMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, aclMigrationCompleted=aclMigrationCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareCIFSReadIops=shareCIFSReadIops, lunReadMbps=lunReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiInitiatorName=iscsiInitiatorName, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, diskSizeLow=diskSizeLow, nfsTotalWriteIops=nfsTotalWriteIops, poolProjectCount=poolProjectCount, fcTotalReadMbps=fcTotalReadMbps, fcTargetWriteMbps=fcTargetWriteMbps, network=network, poolDataReadMbps=poolDataReadMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, fcInitiatorsTable=fcInitiatorsTable, snapshotCloneCompleted=snapshotCloneCompleted, notificationTime=notificationTime, iscsiAvgWriteLatency=iscsiAvgWriteLatency, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, snmpAgentVersion=snmpAgentVersion)
