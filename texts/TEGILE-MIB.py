...
MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Integer32, ObjectIdentity, iso, IpAddress, Counter32, ModuleIdentity, Counter64, TimeTicks, MibIdentifier, Unsigned32, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Integer32", "ObjectIdentity", "iso", "IpAddress", "Counter32", "ModuleIdentity", "Counter64", "TimeTicks", "MibIdentifier", "Unsigned32", "enterprises", "Bits")
...
mibBuilder.exportSymbols("TEGILE-MIB", nicState=nicState, projectQuotaSizeLow=projectQuotaSizeLow, cacheTotalWriteIops=cacheTotalWriteIops, upgradeTimeout=upgradeTimeout, projectDeleted=projectDeleted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, upgradeStarted=upgradeStarted, networkInterfaceUp=networkInterfaceUp, projectQuotaSizeHigh=projectQuotaSizeHigh, poolProjectCount=poolProjectCount, nicIndex=nicIndex, poolSizeHigh=poolSizeHigh, poolTotalWriteIops=poolTotalWriteIops, upgradeDownloadFailed=upgradeDownloadFailed, notificationProps=notificationProps, iscsiTargetReadLatency=iscsiTargetReadLatency, smisServiceStopFailed=smisServiceStopFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, projectDataSizeLow=projectDataSizeLow, replicationComplete=replicationComplete, diskIsOnline=diskIsOnline, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetName=iscsiTargetName, lunEntry=lunEntry, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectShareCount=projectShareCount, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, notificationComponentName=notificationComponentName, shareCIFSWriteIops=shareCIFSWriteIops, unknownSensorEvent=unknownSensorEvent, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, nfsAvgWriteLatency=nfsAvgWriteLatency, poolExpanded=poolExpanded, lunBlockSize=lunBlockSize, lunReadIops=lunReadIops, cpuSystemCalls=cpuSystemCalls, diskIndex=diskIndex, poolProjects=poolProjects, currentNotificationGroup=currentNotificationGroup, haControllerA_IPAddr=haControllerA_IPAddr, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolDataWriteLatency=poolDataWriteLatency, sharePoolName=sharePoolName, poolDataReadLatency=poolDataReadLatency, fcTargetWriteIops=fcTargetWriteIops, sensorFailureEvent=sensorFailureEvent, iscsiTargetWriteIops=iscsiTargetWriteIops, targetGroupMemberRemoved=targetGroupMemberRemoved, testNotification=testNotification, shareTable=shareTable, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskType=diskType, globalStatistics=globalStatistics, notificationSensorAction=notificationSensorAction, smbSocketFailure=smbSocketFailure, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolReadCacheReadMbps=poolReadCacheReadMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiAvgReadLatency=iscsiAvgReadLatency, fcTotalWriteMbps=fcTotalWriteMbps, shareNFSReadMbps=shareNFSReadMbps, projectFreeSizeLow=projectFreeSizeLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, tegileArray_notifications=tegileArray_notifications, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, poolTotalReadIops=poolTotalReadIops, lunProjectName=lunProjectName, diskSlowIo=diskSlowIo, poolImported=poolImported, tdpsUpgradeFailed=tdpsUpgradeFailed, upgradeDownloadStarted=upgradeDownloadStarted, poolCreated=poolCreated, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, upgradeCompleted=upgradeCompleted, deleteFolderFailed=deleteFolderFailed, diskSequentialIOCount=diskSequentialIOCount, lunFreeSizeLow=lunFreeSizeLow, diskAvgReadLatency=diskAvgReadLatency, projectCompressionEnabled=projectCompressionEnabled, lunTargetGroup=lunTargetGroup, poolTotalSaving=poolTotalSaving, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiInitiatorChapUser=iscsiInitiatorChapUser, pools=pools, diskGoneOffline=diskGoneOffline, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectEntry=projectEntry, poolFreeSizeHigh=poolFreeSizeHigh, poolMetaReadIops=poolMetaReadIops, replicationSourceRegistered=replicationSourceRegistered, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunReadMbps=lunReadMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, fcProperties=fcProperties, ipmiThreshold=ipmiThreshold, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, cifsTotalReadMbps=cifsTotalReadMbps, nfsTotalWriteIops=nfsTotalWriteIops, replicationAborted=replicationAborted, cacheTotalReadMbps=cacheTotalReadMbps, diskRandomIOCount=diskRandomIOCount, notificationSeverity=notificationSeverity, projectIndex=projectIndex, diagnosticDataUploaded=diagnosticDataUploaded, lunDataSizeHigh=lunDataSizeHigh, nicReceiveMbps=nicReceiveMbps, fcTargets=fcTargets, shareCIFSWriteMbps=shareCIFSWriteMbps, volumeDeleteCompleted=volumeDeleteCompleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, ipmiFan=ipmiFan, ipmiPowerSupply=ipmiPowerSupply, ipmiMemory=ipmiMemory, shareQuotaFinished=shareQuotaFinished, nvdimmFailUnknownError=nvdimmFailUnknownError, shareCIFSReadMbps=shareCIFSReadMbps, diskTotalReadMbps=diskTotalReadMbps, snapshotCreationFailed=snapshotCreationFailed, nvdimmFailSoftError=nvdimmFailSoftError, tegile=tegile, diskDataReadMbps=diskDataReadMbps, lunReservedSizeLow=lunReservedSizeLow, poolMetaWriteMbps=poolMetaWriteMbps, replicationTargetDeleted=replicationTargetDeleted, haControllerA_Uptime=haControllerA_Uptime, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, cifsTotalReadIops=cifsTotalReadIops, ipmiOther=ipmiOther, netbiosSocketFailure=netbiosSocketFailure, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, snapshotRollbackCompleted=snapshotRollbackCompleted, replicationAbandoned=replicationAbandoned, lunName=lunName, userLoginFailed=userLoginFailed, fcInitiatorEntry=fcInitiatorEntry, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolHealth=poolHealth, properties=properties, targetGroupDeleteCompleted=targetGroupDeleteCompleted, disks=disks, haResourceStatus=haResourceStatus, poolUsedSizeHigh=poolUsedSizeHigh, nfsTotalWriteMbps=nfsTotalWriteMbps, diskAlias=diskAlias, diskState=diskState, fcInitiators=fcInitiators, iscsiTotalReadIops=iscsiTotalReadIops, fcTargetEntry=fcTargetEntry, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolExported=poolExported, poolMetaReadLatency=poolMetaReadLatency, poolMetaWriteIops=poolMetaWriteIops, maintenanceModeDisabled=maintenanceModeDisabled, fcTargetName=fcTargetName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, shareDeleted=shareDeleted, network=network, shareCIFSWriteLatency=shareCIFSWriteLatency, networkTotalReceiveMbps=networkTotalReceiveMbps, shareProjectName=shareProjectName, poolMetaReadMbps=poolMetaReadMbps, haResourceDescription=haResourceDescription, lunWriteLatency=lunWriteLatency, poolFreeSizeLow=poolFreeSizeLow, diskCount=diskCount, projectPoolName=projectPoolName, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, haResourceGroup=haResourceGroup, haResourceActiveNode=haResourceActiveNode, haResourcesTable=haResourcesTable, shareEntry=shareEntry, shareQuotaLow=shareQuotaLow, cifsAvgWriteLatency=cifsAvgWriteLatency, projectCreatedSuccessfully=projectCreatedSuccessfully, diskTotalWriteIops=diskTotalWriteIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, diskTable=diskTable, iscsiTargetAuth=iscsiTargetAuth, tegileCompliances=tegileCompliances, spareDiskReplaced=spareDiskReplaced, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, haControllerA_Name=haControllerA_Name, cacheTotalReadIops=cacheTotalReadIops, replicationStarted=replicationStarted, basicCompliance=basicCompliance, lunSizeLow=lunSizeLow, nicGroup=nicGroup, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTotalWriteIops=fcTotalWriteIops, diskDataReadIops=diskDataReadIops, iscsiTargetGroupError=iscsiTargetGroupError, iscsiImproperTargetGroup=iscsiImproperTargetGroup, snmpServiceStopFailed=snmpServiceStopFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiAvgWriteLatency=iscsiAvgWriteLatency, diskAvgWriteLatency=diskAvgWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, fcInitiatorsTable=fcInitiatorsTable, diskError=diskError, projectShares=projectShares, haResourceName=haResourceName, shareDataSizeHigh=shareDataSizeHigh, cacheSSDReads=cacheSSDReads, nfsTotalReadMbps=nfsTotalReadMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareNFSWriteLatency=shareNFSWriteLatency, nicMTU=nicMTU, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTargetGroup=fcTargetGroup, lunReservedSizeHigh=lunReservedSizeHigh, projectSnapshotSizeLow=projectSnapshotSizeLow, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolReadCacheReadIops=poolReadCacheReadIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, lunIndex=lunIndex, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, haControllerB_Name=haControllerB_Name, fcTargetReadMbps=fcTargetReadMbps, poolDataReadMbps=poolDataReadMbps, fcTotalReadIops=fcTotalReadIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskDataWriteMbps=diskDataWriteMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, lunProtocol=lunProtocol, lunSizeHigh=lunSizeHigh, poolEntry=poolEntry, diskTotalWriteMbps=diskTotalWriteMbps, fcTargetStatus=fcTargetStatus, snapshotRollbackFailed=snapshotRollbackFailed, upgradeDownloadCompleted=upgradeDownloadCompleted, alertsCleanupCompleted=alertsCleanupCompleted, diskIOCount=diskIOCount, replicationPaused=replicationPaused, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareReservedSizeLow=shareReservedSizeLow, poolName=poolName, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, notificationTime=notificationTime, cpuTotalUsage=cpuTotalUsage, haControllerB_Uptime=haControllerB_Uptime)
mibBuilder.exportSymbols("TEGILE-MIB", networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, snapshotDeleteFailed=snapshotDeleteFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, volumeQuotaFinished=volumeQuotaFinished, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, smisServiceStarted=smisServiceStarted, projectThresholdExceedWarning=projectThresholdExceedWarning, snmpServiceStartFailed=snmpServiceStartFailed, poolDataSizeLow=poolDataSizeLow, volumeModifyCompleted=volumeModifyCompleted, shareReservedSizeHigh=shareReservedSizeHigh, notificationThresholdTriggerValue=notificationThresholdTriggerValue, projectLunCount=projectLunCount, diskEntry=diskEntry, targetGroupMemberAdded=targetGroupMemberAdded, controllerUp=controllerUp, poolMetaWriteLatency=poolMetaWriteLatency, poolIndex=poolIndex, notificationReadingUnit=notificationReadingUnit, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, fcAvgReadLatency=fcAvgReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcTargetsTable=fcTargetsTable, iscsiTargetsTable=iscsiTargetsTable, iscsiTargetEntry=iscsiTargetEntry, notificationEventCode=notificationEventCode, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareSnapshotSizeHigh=shareSnapshotSizeHigh, notificationReadingTriggerValue=notificationReadingTriggerValue, fcPortOffline=fcPortOffline, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, shareMountPoint=shareMountPoint, cifsTotalWriteMbps=cifsTotalWriteMbps, lunTable=lunTable, projectQuotaFinished=projectQuotaFinished, iscsiInitiatorEntry=iscsiInitiatorEntry, poolReadCacheWriteIops=poolReadCacheWriteIops, fcTargetReadLatency=fcTargetReadLatency, shareQuotaHigh=shareQuotaHigh, iscsiTargetReadIops=iscsiTargetReadIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, shareSnapshotSizeLow=shareSnapshotSizeLow, poolOwnerController=poolOwnerController, ntpServerTimeDrift=ntpServerTimeDrift, fcTotalReadMbps=fcTotalReadMbps, projectTotalSaving=projectTotalSaving, poolAvgReadLatency=poolAvgReadLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, tegileConformance=tegileConformance, fcAvgWriteLatency=fcAvgWriteLatency, poolCount=poolCount, iscsiTargetReadMbps=iscsiTargetReadMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, lunDataSizeLow=lunDataSizeLow, shareCIFSReadLatency=shareCIFSReadLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, notificationObjects=notificationObjects, poolDataWriteMbps=poolDataWriteMbps, lunDedupEnabled=lunDedupEnabled, tegileArray=tegileArray, networkIpmpGroupUp=networkIpmpGroupUp, fcTargetWriteMbps=fcTargetWriteMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolDataSizeHigh=poolDataSizeHigh, notificationSensorNumber=notificationSensorNumber, iscsiTotalReadMbps=iscsiTotalReadMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, networkIpmpGroupDown=networkIpmpGroupDown, cacheTotalWriteMbps=cacheTotalWriteMbps, iscsiWriteIops=iscsiWriteIops, notifications=notifications, notificationDescription=notificationDescription, cifsAvgReadLatency=cifsAvgReadLatency, shareNFSEnabled=shareNFSEnabled, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, shareDedupEnabled=shareDedupEnabled, lunWriteMbps=lunWriteMbps, controllerHardwareModel=controllerHardwareModel, lunCompressionEnabled=lunCompressionEnabled, haResourceEntry=haResourceEntry, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, nicName=nicName, sanProperties=sanProperties, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareDeletionFailed=shareDeletionFailed, projectName=projectName, shareName=shareName, diskDataWriteIops=diskDataWriteIops, iscsiInitiatorName=iscsiInitiatorName, shareCreatedSuccessfully=shareCreatedSuccessfully, poolAvgWriteLatency=poolAvgWriteLatency, tegileGroups=tegileGroups, diskTotalReadIops=diskTotalReadIops, poolTable=poolTable, maintenanceModeEnabled=maintenanceModeEnabled, lunGUID=lunGUID, projectTable=projectTable, poolDegraded=poolDegraded, shareCompressionEnabled=shareCompressionEnabled, iscsiTargets=iscsiTargets, webdocsUpgradeCompleted=webdocsUpgradeCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareNFSReadIops=shareNFSReadIops, snmpServiceStopped=snmpServiceStopped, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiTargetGroup=iscsiTargetGroup, deleteFolderCompleted=deleteFolderCompleted, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiTargetWriteLatency=iscsiTargetWriteLatency, PYSNMP_MODULE_ID=tegile, shareCIFSEnabled=shareCIFSEnabled, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, haControllerB_IPAddr=haControllerB_IPAddr, iscsiInitiatorsTable=iscsiInitiatorsTable, replicationFailed=replicationFailed, projectFreeSizeHigh=projectFreeSizeHigh, projectDeletionFailed=projectDeletionFailed, projectLUNs=projectLUNs, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiProperties=iscsiProperties, poolDataReadIops=poolDataReadIops, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiInitiatorGroup=iscsiInitiatorGroup, lunReadLatency=lunReadLatency, nfsTotalReadIops=nfsTotalReadIops, cpuInterrupts=cpuInterrupts, controllerDown=controllerDown, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolDataWriteIops=poolDataWriteIops, poolReadCacheReadLatency=poolReadCacheReadLatency, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolQuotaFinished=poolQuotaFinished, snmpServiceStarted=snmpServiceStarted, projectDedupEnabled=projectDedupEnabled, lunWriteIops=lunWriteIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, fcTargetWriteLatency=fcTargetWriteLatency, fcInitiatorName=fcInitiatorName, ipmiCurrent=ipmiCurrent, nvdimmFailInitializationError=nvdimmFailInitializationError, poolUpgraded=poolUpgraded, notificationSensorSuspect=notificationSensorSuspect, shareCIFSReadIops=shareCIFSReadIops, vmwareNFSDatastores=vmwareNFSDatastores, ipmiVoltage=ipmiVoltage, iscsiTargetError=iscsiTargetError, fcInitiatorCreateFailed=fcInitiatorCreateFailed, projectModified=projectModified, tdpsUpgradeCompleted=tdpsUpgradeCompleted, memoryFailure=memoryFailure, projectDataSizeHigh=projectDataSizeHigh, poolTotalReadMbps=poolTotalReadMbps, iscsiTargetIndex=iscsiTargetIndex, iscsiTargetAlias=iscsiTargetAlias, lunFreeSizeHigh=lunFreeSizeHigh, diskPoolName=diskPoolName, nicTransmitMbps=nicTransmitMbps, poolTotalWriteMbps=poolTotalWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, notificationTargetEntityName=notificationTargetEntityName, diskSizeHigh=diskSizeHigh, fcTargetIndex=fcTargetIndex, fcInitiatorIndex=fcInitiatorIndex, lunCompressedRatio=lunCompressedRatio, nicTable=nicTable, volumeDeleteFailed=volumeDeleteFailed, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, lunInitiatorGroup=lunInitiatorGroup, snapshotCloneCompleted=snapshotCloneCompleted, cacheRAMReads=cacheRAMReads, shareNFSWriteMbps=shareNFSWriteMbps, haResources=haResources, snapshotCloningFailed=snapshotCloningFailed, adServerTimeDrift=adServerTimeDrift, diskChassisIdx=diskChassisIdx, controllerTimeDrift=controllerTimeDrift, networkInterfaceDown=networkInterfaceDown, poolDeletionFailed=poolDeletionFailed, nicEntry=nicEntry, shareNFSWriteIops=shareNFSWriteIops, poolUsedSizeLow=poolUsedSizeLow, shareDataSizeLow=shareDataSizeLow, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolDeleted=poolDeleted, shareIndex=shareIndex, nfsAvgReadLatency=nfsAvgReadLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunPoolName=lunPoolName, upgradeFailed=upgradeFailed, replicationResumed=replicationResumed, diskSizeLow=diskSizeLow, cifsTotalWriteIops=cifsTotalWriteIops, snmpAgentVersion=snmpAgentVersion, poolState=poolState, ipmiTemperature=ipmiTemperature, shareCompressedRatio=shareCompressedRatio, fcPortOnline=fcPortOnline, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcTargetReadIops=fcTargetReadIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiInitiators=iscsiInitiators, poolSizeLow=poolSizeLow, aclMigrationStarted=aclMigrationStarted, smisServiceStartFailed=smisServiceStartFailed, shareNFSReadLatency=shareNFSReadLatency, haResourceIndex=haResourceIndex, smisServiceStopped=smisServiceStopped)
