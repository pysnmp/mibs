...
iso, NotificationType, Gauge32, ModuleIdentity, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, IpAddress, Unsigned32, Counter32, Counter64, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Gauge32", "ModuleIdentity", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "IpAddress", "Unsigned32", "Counter32", "Counter64", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("TEGILE-MIB", initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, poolReadCacheReadIops=poolReadCacheReadIops, ipmiMemory=ipmiMemory, projectCompressionEnabled=projectCompressionEnabled, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, ipmiVoltage=ipmiVoltage, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolDataReadIops=poolDataReadIops, projectDeleted=projectDeleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, cifsAvgReadLatency=cifsAvgReadLatency, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, lunFreeSizeLow=lunFreeSizeLow, nvdimmFailInitializationError=nvdimmFailInitializationError, cifsTotalReadMbps=cifsTotalReadMbps, lunProtocol=lunProtocol, iscsiTotalReadIops=iscsiTotalReadIops, fcTargetsTable=fcTargetsTable, basicCompliance=basicCompliance, iscsiAvgReadLatency=iscsiAvgReadLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, diskRandomIOCount=diskRandomIOCount, tdpsUpgradeFailed=tdpsUpgradeFailed, lunWriteLatency=lunWriteLatency, snmpServiceStarted=snmpServiceStarted, poolReadCacheWriteIops=poolReadCacheWriteIops, iscsiTargetEntry=iscsiTargetEntry, fcInitiatorName=fcInitiatorName, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, nfsTotalReadIops=nfsTotalReadIops, shareCIFSEnabled=shareCIFSEnabled, networkInterfaceUp=networkInterfaceUp, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, controllerDown=controllerDown, fcTargetWriteMbps=fcTargetWriteMbps, shareCIFSReadMbps=shareCIFSReadMbps, iscsiTargetGroup=iscsiTargetGroup, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, nfsAvgReadLatency=nfsAvgReadLatency, userLoginFailed=userLoginFailed, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, snmpServiceStopFailed=snmpServiceStopFailed, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareCIFSWriteLatency=shareCIFSWriteLatency, adServerTimeDrift=adServerTimeDrift, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, projectTotalSaving=projectTotalSaving, haControllerB_IPAddr=haControllerB_IPAddr, poolName=poolName, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, snmpAgentVersion=snmpAgentVersion, haResourceGroup=haResourceGroup, lunName=lunName, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiTargetReadLatency=iscsiTargetReadLatency, netbiosSocketFailure=netbiosSocketFailure, haControllerA_IPAddr=haControllerA_IPAddr, upgradeCompleted=upgradeCompleted, shareNFSReadLatency=shareNFSReadLatency, nicTransmitMbps=nicTransmitMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, ipmiTemperature=ipmiTemperature, nicReceiveMbps=nicReceiveMbps, lunWriteIops=lunWriteIops, fcInitiatorGroup=fcInitiatorGroup, poolDataWriteLatency=poolDataWriteLatency, replicationTargetDeleted=replicationTargetDeleted, poolDeletionFailed=poolDeletionFailed, haResourcesTable=haResourcesTable, iscsiTargetReadMbps=iscsiTargetReadMbps, controllerUp=controllerUp, cifsTotalReadIops=cifsTotalReadIops, fcTotalReadIops=fcTotalReadIops, projectThresholdExceedWarning=projectThresholdExceedWarning, controllerHardwareModel=controllerHardwareModel, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, controllerTimeDrift=controllerTimeDrift, upgradeDownloadStarted=upgradeDownloadStarted, iscsiTargetWriteLatency=iscsiTargetWriteLatency, nfsTotalWriteIops=nfsTotalWriteIops, poolUpgraded=poolUpgraded, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolUsedSizeLow=poolUsedSizeLow, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, snapshotCloningFailed=snapshotCloningFailed, diskTable=diskTable, diskCount=diskCount, diskTotalWriteIops=diskTotalWriteIops, fcTargetReadIops=fcTargetReadIops, poolMetaWriteLatency=poolMetaWriteLatency, projectEntry=projectEntry, iscsiInitiatorIndex=iscsiInitiatorIndex, upgradeFailed=upgradeFailed, projectTable=projectTable, haResourceEntry=haResourceEntry, haResourceActiveNode=haResourceActiveNode, lunGUID=lunGUID, fcTargetModifyCompleted=fcTargetModifyCompleted, poolImported=poolImported, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiTargetError=iscsiTargetError, fcInitiatorsTable=fcInitiatorsTable, nvdimmFailDeviceError=nvdimmFailDeviceError, shareReservedSizeLow=shareReservedSizeLow, notificationReadingUnit=notificationReadingUnit, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, properties=properties, networkIpmpGroupUp=networkIpmpGroupUp, fcTargets=fcTargets, webdocsUpgradeFailed=webdocsUpgradeFailed, poolTotalSaving=poolTotalSaving, projectIndex=projectIndex, nicState=nicState, shareCIFSReadLatency=shareCIFSReadLatency, PYSNMP_MODULE_ID=tegile, poolTotalReadMbps=poolTotalReadMbps, snmpServiceStopped=snmpServiceStopped, volumeDeleteFailed=volumeDeleteFailed, notificationSeverity=notificationSeverity, diskAvgWriteLatency=diskAvgWriteLatency, shareName=shareName, fcTotalWriteMbps=fcTotalWriteMbps, haControllerB_Uptime=haControllerB_Uptime, tegileArray_notifications=tegileArray_notifications, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, lunReservedSizeLow=lunReservedSizeLow, shareNFSReadMbps=shareNFSReadMbps, notificationComponentName=notificationComponentName, upgradeStarted=upgradeStarted, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolDataWriteIops=poolDataWriteIops, shareIndex=shareIndex, memoryFailure=memoryFailure, iscsiTargets=iscsiTargets, projectShares=projectShares, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, notificationEventCode=notificationEventCode, replicationAborted=replicationAborted, nfsTotalReadMbps=nfsTotalReadMbps, shareNFSEnabled=shareNFSEnabled, lunCompressionEnabled=lunCompressionEnabled, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, cacheTotalWriteIops=cacheTotalWriteIops, poolExported=poolExported, testNotification=testNotification, fcTargetReadMbps=fcTargetReadMbps, aclMigrationStarted=aclMigrationStarted, cacheRAMReads=cacheRAMReads, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunBlockSize=lunBlockSize, aclMigrationCompleted=aclMigrationCompleted, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, networkTotalTransmitMbps=networkTotalTransmitMbps, upgradeDownloadFailed=upgradeDownloadFailed, lunProjectName=lunProjectName, smisServiceStopFailed=smisServiceStopFailed, poolDataReadMbps=poolDataReadMbps, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareNFSReadIops=shareNFSReadIops, fcTargetReadLatency=fcTargetReadLatency, lunReservedSizeHigh=lunReservedSizeHigh, diskAlias=diskAlias, diskSizeLow=diskSizeLow, replicationFailed=replicationFailed, diskChassisIdx=diskChassisIdx, poolEntry=poolEntry, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diskIOCount=diskIOCount, notificationProps=notificationProps, iscsiInitiators=iscsiInitiators, iscsiTargetAlias=iscsiTargetAlias, fcPortOnline=fcPortOnline, shareCIFSWriteMbps=shareCIFSWriteMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, lunTable=lunTable, poolAvgWriteLatency=poolAvgWriteLatency, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, projectSnapshotSizeLow=projectSnapshotSizeLow, haResourceDescription=haResourceDescription, poolDataSizeLow=poolDataSizeLow, poolMetaWriteIops=poolMetaWriteIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, diagnosticDataUploaded=diagnosticDataUploaded, disks=disks, shareCIFSWriteIops=shareCIFSWriteIops, projectFreeSizeHigh=projectFreeSizeHigh, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, smisServiceStarted=smisServiceStarted, ipmiPowerSupply=ipmiPowerSupply, diskDataWriteIops=diskDataWriteIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, ipmiCurrent=ipmiCurrent, poolProjects=poolProjects, shareCreatedSuccessfully=shareCreatedSuccessfully, poolTotalReadIops=poolTotalReadIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiTargetsTable=iscsiTargetsTable, lunTargetGroup=lunTargetGroup, shareQuotaLow=shareQuotaLow, nicMTU=nicMTU, haResources=haResources, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolDataReadLatency=poolDataReadLatency, lunSizeLow=lunSizeLow, tegileArray=tegileArray, diskDataReadMbps=diskDataReadMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiWriteIops=iscsiWriteIops, shareNFSWriteLatency=shareNFSWriteLatency, snapshotDeleteFailed=snapshotDeleteFailed, unknownSensorEvent=unknownSensorEvent, poolWriteCacheWriteIops=poolWriteCacheWriteIops, replicationStarted=replicationStarted, sharePoolName=sharePoolName, diskEntry=diskEntry, lunWriteMbps=lunWriteMbps, haResourceIndex=haResourceIndex, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, replicationAbandoned=replicationAbandoned, projectPoolName=projectPoolName, poolHealth=poolHealth, lunDedupEnabled=lunDedupEnabled, alertsCleanupCompleted=alertsCleanupCompleted, poolDataSizeHigh=poolDataSizeHigh, poolFreeSizeHigh=poolFreeSizeHigh, fcAvgReadLatency=fcAvgReadLatency, cacheSSDReads=cacheSSDReads, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, notificationSensorSuspect=notificationSensorSuspect, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareReservedSizeHigh=shareReservedSizeHigh, fcTargetWriteIops=fcTargetWriteIops, deleteFolderFailed=deleteFolderFailed, fcInitiatorCreateFailed=fcInitiatorCreateFailed, diskState=diskState, network=network, projectShareCount=projectShareCount, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectDedupEnabled=projectDedupEnabled, fcProperties=fcProperties, lunReadLatency=lunReadLatency, projectDeletionFailed=projectDeletionFailed, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareQuotaFinished=shareQuotaFinished, ipmiFan=ipmiFan, notificationTime=notificationTime, lunDataSizeLow=lunDataSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps)
mibBuilder.exportSymbols("TEGILE-MIB", shareMountPoint=shareMountPoint, poolTable=poolTable, volumeModifyCompleted=volumeModifyCompleted, poolMetaReadIops=poolMetaReadIops, iscsiTargetReadIops=iscsiTargetReadIops, notificationDescription=notificationDescription, poolDataWriteMbps=poolDataWriteMbps, projectLUNs=projectLUNs, diskSizeHigh=diskSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectCreatedSuccessfully=projectCreatedSuccessfully, replicationSourceRegistered=replicationSourceRegistered, shareNFSWriteIops=shareNFSWriteIops, volumeCreatedSuccessfully=volumeCreatedSuccessfully, iscsiProperties=iscsiProperties, haControllerA_Uptime=haControllerA_Uptime, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunReadIops=lunReadIops, fcPortOffline=fcPortOffline, projectQuotaSizeHigh=projectQuotaSizeHigh, sanProperties=sanProperties, poolCreated=poolCreated, nvdimmFailUnknownError=nvdimmFailUnknownError, poolAvgReadLatency=poolAvgReadLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, lunEntry=lunEntry, poolMetaReadMbps=poolMetaReadMbps, projectDataSizeHigh=projectDataSizeHigh, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, diskPoolName=diskPoolName, shareDataSizeHigh=shareDataSizeHigh, deleteFolderCompleted=deleteFolderCompleted, lunReadMbps=lunReadMbps, shareCompressionEnabled=shareCompressionEnabled, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectFreeSizeLow=projectFreeSizeLow, projectDataSizeLow=projectDataSizeLow, lunCompressedRatio=lunCompressedRatio, iscsiInitiatorsTable=iscsiInitiatorsTable, shareQuotaHigh=shareQuotaHigh, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiInitiatorGroup=iscsiInitiatorGroup, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, shareTable=shareTable, diskIsOnline=diskIsOnline, shareCIFSReadIops=shareCIFSReadIops, smisServiceStopped=smisServiceStopped, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareDedupEnabled=shareDedupEnabled, snapshotRollbackFailed=snapshotRollbackFailed, tegileConformance=tegileConformance, poolUsedSizeHigh=poolUsedSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiTargetGroupError=iscsiTargetGroupError, poolMetaReadLatency=poolMetaReadLatency, tegileCompliances=tegileCompliances, notifications=notifications, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, notificationReadingTriggerValue=notificationReadingTriggerValue, fcAvgWriteLatency=fcAvgWriteLatency, spareDiskReplaced=spareDiskReplaced, upgradeTimeout=upgradeTimeout, lunIndex=lunIndex, diskIndex=diskIndex, poolState=poolState, cpuSystemCalls=cpuSystemCalls, fcInitiatorIndex=fcInitiatorIndex, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, nicEntry=nicEntry, replicationComplete=replicationComplete, volumeQuotaFinished=volumeQuotaFinished, fcTargetName=fcTargetName, haResourceName=haResourceName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareExceedThresholdWarning=shareExceedThresholdWarning, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcTargetStatus=fcTargetStatus, shareDeleted=shareDeleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareProjectName=shareProjectName, iscsiTargetAuth=iscsiTargetAuth, ipmiCriticalInterrupt=ipmiCriticalInterrupt, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareEntry=shareEntry, fcTargetEntry=fcTargetEntry, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, vmwareNFSDatastores=vmwareNFSDatastores, pools=pools, shareCompressedRatio=shareCompressedRatio, poolTotalWriteMbps=poolTotalWriteMbps, nvdimmFailSoftError=nvdimmFailSoftError, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, iscsiInitiatorName=iscsiInitiatorName, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, haControllerB_Name=haControllerB_Name, poolTotalWriteIops=poolTotalWriteIops, iscsiTargetIndex=iscsiTargetIndex, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, networkInterfaceDown=networkInterfaceDown, shareNFSWriteMbps=shareNFSWriteMbps, notificationObjects=notificationObjects, targetGroupMemberAdded=targetGroupMemberAdded, ipmiOther=ipmiOther, projectModified=projectModified, diskTotalWriteMbps=diskTotalWriteMbps, haResourceStatus=haResourceStatus, poolCount=poolCount, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, notificationSensorNumber=notificationSensorNumber, cifsTotalWriteMbps=cifsTotalWriteMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, cacheTotalReadMbps=cacheTotalReadMbps, currentObjectGroup=currentObjectGroup, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareDeletionFailed=shareDeletionFailed, notificationSensorAction=notificationSensorAction, shareSnapshotSizeLow=shareSnapshotSizeLow, cacheTotalReadIops=cacheTotalReadIops, poolDegraded=poolDegraded, globalStatistics=globalStatistics, poolMetaWriteMbps=poolMetaWriteMbps, diskTotalReadMbps=diskTotalReadMbps, diskSequentialIOCount=diskSequentialIOCount, diskSlowIo=diskSlowIo, cpuInterrupts=cpuInterrupts, smbSocketFailure=smbSocketFailure, cpuTotalUsage=cpuTotalUsage, snapshotCloneCompleted=snapshotCloneCompleted, currentNotificationGroup=currentNotificationGroup, poolIndex=poolIndex, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, maintenanceModeDisabled=maintenanceModeDisabled, intelliFlashSoftwareDown=intelliFlashSoftwareDown, maintenanceModeEnabled=maintenanceModeEnabled, nicTable=nicTable, diskDataWriteMbps=diskDataWriteMbps, poolOwnerController=poolOwnerController, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcInitiatorEntry=fcInitiatorEntry, diskGoneOffline=diskGoneOffline, lunSizeHigh=lunSizeHigh, diskError=diskError, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, cifsTotalWriteIops=cifsTotalWriteIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, volumeDeleteCompleted=volumeDeleteCompleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, lunPoolName=lunPoolName, projectQuotaSizeLow=projectQuotaSizeLow, poolSizeHigh=poolSizeHigh, poolReadCacheReadLatency=poolReadCacheReadLatency, shareDataSizeLow=shareDataSizeLow, ntpServerTimeDrift=ntpServerTimeDrift, cifsAvgWriteLatency=cifsAvgWriteLatency, lunFreeSizeHigh=lunFreeSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcInitiators=fcInitiators, diskDataReadIops=diskDataReadIops, haControllerA_Name=haControllerA_Name, fcTotalReadMbps=fcTotalReadMbps, sensorFailureEvent=sensorFailureEvent, lunDataSizeHigh=lunDataSizeHigh, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snapshotCreationFailed=snapshotCreationFailed, fcTotalWriteIops=fcTotalWriteIops, poolFreeSizeLow=poolFreeSizeLow, networkTotalReceiveMbps=networkTotalReceiveMbps, fcTargetWriteLatency=fcTargetWriteLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, nicGroup=nicGroup, networkIpmpGroupDown=networkIpmpGroupDown, tegile=tegile, projectQuotaFinished=projectQuotaFinished, ipmiThreshold=ipmiThreshold, poolSizeLow=poolSizeLow, poolDeleted=poolDeleted, tegileGroups=tegileGroups, diskType=diskType, notificationTargetEntityName=notificationTargetEntityName, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiTargetName=iscsiTargetName, poolProjectCount=poolProjectCount, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectName=projectName, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, smisServiceStartFailed=smisServiceStartFailed, diskTotalReadIops=diskTotalReadIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, projectLunCount=projectLunCount, poolQuotaFinished=poolQuotaFinished, nicName=nicName, cacheTotalWriteMbps=cacheTotalWriteMbps, nicIndex=nicIndex, diskAvgReadLatency=diskAvgReadLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, fcTargetIndex=fcTargetIndex, lunInitiatorGroup=lunInitiatorGroup, replicationResumed=replicationResumed, poolExpanded=poolExpanded, snmpServiceStartFailed=snmpServiceStartFailed, iscsiTargetWriteIops=iscsiTargetWriteIops, replicationPaused=replicationPaused, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted)
