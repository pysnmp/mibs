...
MibIdentifier, ModuleIdentity, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Counter32, iso, Counter64, IpAddress, Integer32, ObjectIdentity, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Counter32", "iso", "Counter64", "IpAddress", "Integer32", "ObjectIdentity", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcInitiatorEntry=fcInitiatorEntry, smisServiceStarted=smisServiceStarted, diskTotalReadMbps=diskTotalReadMbps, snmpServiceStartFailed=snmpServiceStartFailed, poolOwnerController=poolOwnerController, iscsiTotalWriteMbps=iscsiTotalWriteMbps, haResourceStatus=haResourceStatus, nfsAvgWriteLatency=nfsAvgWriteLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, cacheTotalReadMbps=cacheTotalReadMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunDataSizeHigh=lunDataSizeHigh, shareQuotaHigh=shareQuotaHigh, haResourceEntry=haResourceEntry, poolMetaReadMbps=poolMetaReadMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiInitiatorIndex=iscsiInitiatorIndex, fcTargetIndex=fcTargetIndex, upgradeStarted=upgradeStarted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, diskAvgReadLatency=diskAvgReadLatency, shareProjectName=shareProjectName, diskSequentialIOCount=diskSequentialIOCount, volumeQuotaFinished=volumeQuotaFinished, projectIndex=projectIndex, sanProperties=sanProperties, upgradeDownloadStarted=upgradeDownloadStarted, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, ipmiMemory=ipmiMemory, maintenanceModeEnabled=maintenanceModeEnabled, shareReservedSizeHigh=shareReservedSizeHigh, nicTransmitMbps=nicTransmitMbps, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiProperties=iscsiProperties, snmpServiceStarted=snmpServiceStarted, lunWriteIops=lunWriteIops, poolTable=poolTable, networkTotalTransmitMbps=networkTotalTransmitMbps, cifsTotalWriteIops=cifsTotalWriteIops, snmpServiceStopFailed=snmpServiceStopFailed, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectQuotaSizeLow=projectQuotaSizeLow, network=network, poolHealth=poolHealth, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskIsOnline=diskIsOnline, projectShares=projectShares, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolTotalReadMbps=poolTotalReadMbps, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareSnapshotSizeLow=shareSnapshotSizeLow, diskChassisIdx=diskChassisIdx, tegileArray=tegileArray, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, deleteFolderCompleted=deleteFolderCompleted, poolAvgWriteLatency=poolAvgWriteLatency, replicationAborted=replicationAborted, cpuSystemCalls=cpuSystemCalls, lunCompressedRatio=lunCompressedRatio, haResourceIndex=haResourceIndex, poolTotalWriteMbps=poolTotalWriteMbps, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, projectName=projectName, intelliFlashSoftwareDown=intelliFlashSoftwareDown, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, cifsAvgReadLatency=cifsAvgReadLatency, haControllerA_Name=haControllerA_Name, controllerTimeDrift=controllerTimeDrift, shareCIFSReadIops=shareCIFSReadIops, lunSizeHigh=lunSizeHigh, poolMetaWriteMbps=poolMetaWriteMbps, notificationTime=notificationTime, shareDeleted=shareDeleted, smisServiceStartFailed=smisServiceStartFailed, diskSizeHigh=diskSizeHigh, deleteFolderFailed=deleteFolderFailed, projectFreeSizeLow=projectFreeSizeLow, shareNFSReadLatency=shareNFSReadLatency, poolReadCacheWriteLatency=poolReadCacheWriteLatency, fcPortOnline=fcPortOnline, nvdimmFailUnknownError=nvdimmFailUnknownError, networkInterfaceDown=networkInterfaceDown, volumeDeleteCompleted=volumeDeleteCompleted, iscsiTotalReadMbps=iscsiTotalReadMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, smbSocketFailure=smbSocketFailure, projectThresholdExceedWarning=projectThresholdExceedWarning, controllerHardwareModel=controllerHardwareModel, iscsiInitiatorEntry=iscsiInitiatorEntry, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunTable=lunTable, ipmiVoltage=ipmiVoltage, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectEntry=projectEntry, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, nfsTotalWriteIops=nfsTotalWriteIops, nicEntry=nicEntry, projectModified=projectModified, poolReadCacheReadIops=poolReadCacheReadIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, poolFreeSizeLow=poolFreeSizeLow, sensorFailureEvent=sensorFailureEvent, diskDataReadIops=diskDataReadIops, iscsiWriteIops=iscsiWriteIops, poolDataWriteMbps=poolDataWriteMbps, poolDataReadLatency=poolDataReadLatency, shareCompressedRatio=shareCompressedRatio, iscsiTargetError=iscsiTargetError, shareCIFSEnabled=shareCIFSEnabled, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, cifsTotalReadIops=cifsTotalReadIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, pools=pools, lunWriteMbps=lunWriteMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, lunInitiatorGroup=lunInitiatorGroup, memoryFailure=memoryFailure, poolState=poolState, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, replicationAbandoned=replicationAbandoned, diskIOCount=diskIOCount, poolExported=poolExported, iscsiTargetAuth=iscsiTargetAuth, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, snapshotRollbackCompleted=snapshotRollbackCompleted, iscsiTargetGroup=iscsiTargetGroup, fcTargetName=fcTargetName, haResourceGroup=haResourceGroup, lunReservedSizeHigh=lunReservedSizeHigh, userLoginFailed=userLoginFailed, fcTargetStatus=fcTargetStatus, cacheRAMReads=cacheRAMReads, poolTotalReadIops=poolTotalReadIops, shareNFSWriteLatency=shareNFSWriteLatency, testNotification=testNotification, shareCIFSReadLatency=shareCIFSReadLatency, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, notificationReadingUnit=notificationReadingUnit, lunCompressionEnabled=lunCompressionEnabled, shareCIFSReadMbps=shareCIFSReadMbps, cacheTotalReadIops=cacheTotalReadIops, poolIndex=poolIndex, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectCreatedSuccessfully=projectCreatedSuccessfully, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, haControllerB_Name=haControllerB_Name, adServerTimeDrift=adServerTimeDrift, ipmiOther=ipmiOther, fcTargetReadLatency=fcTargetReadLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, fcTotalWriteMbps=fcTotalWriteMbps, projectLUNs=projectLUNs, poolUpgraded=poolUpgraded, cacheTotalWriteMbps=cacheTotalWriteMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, projectTable=projectTable, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, diskError=diskError, maintenanceModeDisabled=maintenanceModeDisabled, nvdimmFailInitializationError=nvdimmFailInitializationError, tegileArray_notifications=tegileArray_notifications, upgradeTimeout=upgradeTimeout, diskIndex=diskIndex, fcTargetReadMbps=fcTargetReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolUsedSizeLow=poolUsedSizeLow, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiTargetReadIops=iscsiTargetReadIops, fcInitiatorName=fcInitiatorName, projectSnapshotSizeHigh=projectSnapshotSizeHigh, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, shareCIFSWriteMbps=shareCIFSWriteMbps, projectQuotaFinished=projectQuotaFinished, replicationFailed=replicationFailed, nvdimmFailDeviceError=nvdimmFailDeviceError, projectLunCount=projectLunCount, snapshotDeleteFailed=snapshotDeleteFailed, lunEntry=lunEntry, diskCount=diskCount, shareDataSizeHigh=shareDataSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, iscsiImproperTargetGroup=iscsiImproperTargetGroup, shareDeletionFailed=shareDeletionFailed, shareName=shareName, tegileCompliances=tegileCompliances, notificationSensorAction=notificationSensorAction, poolAvgReadLatency=poolAvgReadLatency, cpuTotalUsage=cpuTotalUsage, shareCreatedSuccessfully=shareCreatedSuccessfully, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetAlias=iscsiTargetAlias, diskDataWriteIops=diskDataWriteIops, projectTotalSaving=projectTotalSaving, lunProtocol=lunProtocol, fcTargetWriteIops=fcTargetWriteIops, fcInitiatorsTable=fcInitiatorsTable, notificationSeverity=notificationSeverity, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, controllerUp=controllerUp, projectFreeSizeHigh=projectFreeSizeHigh, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, PYSNMP_MODULE_ID=tegile, targetGroupMemberRemoved=targetGroupMemberRemoved, aclMigrationStarted=aclMigrationStarted, nicReceiveMbps=nicReceiveMbps, fcPortOffline=fcPortOffline, projectCompressionEnabled=projectCompressionEnabled, fcTargetReadIops=fcTargetReadIops, shareCIFSWriteLatency=shareCIFSWriteLatency, replicationStarted=replicationStarted, projectDeleted=projectDeleted, poolTotalSaving=poolTotalSaving, diskDataWriteMbps=diskDataWriteMbps, lunFreeSizeHigh=lunFreeSizeHigh, lunTargetGroup=lunTargetGroup, snapshotCloningFailed=snapshotCloningFailed, poolMetaReadIops=poolMetaReadIops, shareTable=shareTable, diskRandomIOCount=diskRandomIOCount, haControllerA_Uptime=haControllerA_Uptime, poolImported=poolImported, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, lunWriteLatency=lunWriteLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, smisServiceStopFailed=smisServiceStopFailed, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcTargetGroup=fcTargetGroup, poolUsedSizeHigh=poolUsedSizeHigh, notificationSensorNumber=notificationSensorNumber, lunReadIops=lunReadIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareQuotaFinished=shareQuotaFinished, poolDataReadMbps=poolDataReadMbps, shareIndex=shareIndex, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, replicationPaused=replicationPaused, fcTargetEntry=fcTargetEntry, diskEntry=diskEntry, lunSnapshotSizeLow=lunSnapshotSizeLow, diskAlias=diskAlias, fcAvgReadLatency=fcAvgReadLatency, poolExpanded=poolExpanded, diskState=diskState)
mibBuilder.exportSymbols("TEGILE-MIB", aclMigrationCompleted=aclMigrationCompleted, poolDegraded=poolDegraded, lunName=lunName, diskPoolName=diskPoolName, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, upgradeFailed=upgradeFailed, haResourceDescription=haResourceDescription, iscsiInitiatorGroup=iscsiInitiatorGroup, poolProjects=poolProjects, lunDedupEnabled=lunDedupEnabled, replicationSourceRegistered=replicationSourceRegistered, volumeDeleteFailed=volumeDeleteFailed, projectPoolName=projectPoolName, replicationComplete=replicationComplete, poolDeletionFailed=poolDeletionFailed, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, vmwareNFSDatastores=vmwareNFSDatastores, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, upgradeDownloadFailed=upgradeDownloadFailed, nicName=nicName, notificationDescription=notificationDescription, notificationReadingTriggerValue=notificationReadingTriggerValue, diskType=diskType, shareNFSEnabled=shareNFSEnabled, nvdimmFailSoftError=nvdimmFailSoftError, replicationTargetDeleted=replicationTargetDeleted, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiTargets=iscsiTargets, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolQuotaFinished=poolQuotaFinished, projectDeletionFailed=projectDeletionFailed, diskSlowIo=diskSlowIo, diskSizeLow=diskSizeLow, iscsiAvgReadLatency=iscsiAvgReadLatency, cpuInterrupts=cpuInterrupts, shareEntry=shareEntry, nfsAvgReadLatency=nfsAvgReadLatency, projectShareCount=projectShareCount, shareMountPoint=shareMountPoint, fcAvgWriteLatency=fcAvgWriteLatency, shareNFSReadIops=shareNFSReadIops, networkTotalReceiveMbps=networkTotalReceiveMbps, ipmiFan=ipmiFan, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, notificationObjects=notificationObjects, poolDataWriteLatency=poolDataWriteLatency, upgradeCompleted=upgradeCompleted, snapshotRollbackFailed=snapshotRollbackFailed, nfsTotalReadMbps=nfsTotalReadMbps, notificationComponentName=notificationComponentName, haControllerB_IPAddr=haControllerB_IPAddr, ntpServerTimeDrift=ntpServerTimeDrift, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolDataWriteIops=poolDataWriteIops, lunReservedSizeLow=lunReservedSizeLow, iscsiTargetReadMbps=iscsiTargetReadMbps, poolMetaReadLatency=poolMetaReadLatency, lunDataSizeLow=lunDataSizeLow, ipmiPowerSupply=ipmiPowerSupply, netbiosSocketFailure=netbiosSocketFailure, poolDataReadIops=poolDataReadIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, notificationProps=notificationProps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, nicState=nicState, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcTotalReadIops=fcTotalReadIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, lunReadLatency=lunReadLatency, poolDataSizeLow=poolDataSizeLow, targetGroupMemberAdded=targetGroupMemberAdded, shareNFSWriteIops=shareNFSWriteIops, tegileGroups=tegileGroups, cifsTotalWriteMbps=cifsTotalWriteMbps, shareQuotaLow=shareQuotaLow, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, projectDedupEnabled=projectDedupEnabled, diskTotalReadIops=diskTotalReadIops, haResourceActiveNode=haResourceActiveNode, cifsAvgWriteLatency=cifsAvgWriteLatency, haControllerA_IPAddr=haControllerA_IPAddr, shareReservedSizeLow=shareReservedSizeLow, poolSizeLow=poolSizeLow, fcInitiatorIndex=fcInitiatorIndex, unknownSensorEvent=unknownSensorEvent, diskAvgWriteLatency=diskAvgWriteLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, currentNotificationGroup=currentNotificationGroup, iscsiTargetGroupError=iscsiTargetGroupError, shareCompressionEnabled=shareCompressionEnabled, haControllerB_Uptime=haControllerB_Uptime, lunProjectName=lunProjectName, haResourcesTable=haResourcesTable, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, diagnosticDataUploaded=diagnosticDataUploaded, iscsiInitiatorsTable=iscsiInitiatorsTable, snmpServiceStopped=snmpServiceStopped, volumeModifyCompleted=volumeModifyCompleted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, diskTotalWriteMbps=diskTotalWriteMbps, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolReadCacheReadLatency=poolReadCacheReadLatency, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunSizeLow=lunSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, fcInitiators=fcInitiators, fcTotalWriteIops=fcTotalWriteIops, notificationEventCode=notificationEventCode, iscsiTargetName=iscsiTargetName, tdpsUpgradeFailed=tdpsUpgradeFailed, networkIpmpGroupDown=networkIpmpGroupDown, notificationSensorSuspect=notificationSensorSuspect, diskTable=diskTable, cacheSSDReads=cacheSSDReads, fcProperties=fcProperties, fcInitiatorGroup=fcInitiatorGroup, fcTargetWriteLatency=fcTargetWriteLatency, fcTargetWriteMbps=fcTargetWriteMbps, notifications=notifications, ipmiCurrent=ipmiCurrent, diskGoneOffline=diskGoneOffline, notificationTargetEntityName=notificationTargetEntityName, poolCount=poolCount, cacheTotalWriteIops=cacheTotalWriteIops, tegile=tegile, projectDataSizeLow=projectDataSizeLow, cifsTotalReadMbps=cifsTotalReadMbps, fcTargetsTable=fcTargetsTable, poolCreated=poolCreated, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, replicationResumed=replicationResumed, controllerDown=controllerDown, snmpAgentVersion=snmpAgentVersion, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, shareNFSWriteMbps=shareNFSWriteMbps, iscsiTargetsTable=iscsiTargetsTable, nicGroup=nicGroup, shareExceedThresholdWarning=shareExceedThresholdWarning, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, nicMTU=nicMTU, volumeCreatedSuccessfully=volumeCreatedSuccessfully, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, fcTotalReadMbps=fcTotalReadMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, networkIpmpGroupUp=networkIpmpGroupUp, shareDataSizeLow=shareDataSizeLow, shareNFSReadMbps=shareNFSReadMbps, poolEntry=poolEntry, sharePoolName=sharePoolName, networkInterfaceUp=networkInterfaceUp, snapshotCreationFailed=snapshotCreationFailed, disks=disks, poolMetaWriteLatency=poolMetaWriteLatency, properties=properties, nicIndex=nicIndex, ipmiTemperature=ipmiTemperature, lunBlockSize=lunBlockSize, tegileConformance=tegileConformance, diskDataReadMbps=diskDataReadMbps, projectDataSizeHigh=projectDataSizeHigh, fcTargets=fcTargets, alertsCleanupCompleted=alertsCleanupCompleted, haResources=haResources, webdocsUpgradeCompleted=webdocsUpgradeCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, iscsiTargetEntry=iscsiTargetEntry, smisServiceStopped=smisServiceStopped, poolProjectCount=poolProjectCount, iscsiTargetWriteLatency=iscsiTargetWriteLatency, spareDiskReplaced=spareDiskReplaced, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareDedupEnabled=shareDedupEnabled, poolDataSizeHigh=poolDataSizeHigh, lunIndex=lunIndex, poolSizeHigh=poolSizeHigh, nfsTotalReadIops=nfsTotalReadIops, currentObjectGroup=currentObjectGroup, poolName=poolName, lunReadMbps=lunReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, lunFreeSizeLow=lunFreeSizeLow, haResourceName=haResourceName, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcInitiatorCreateFailed=fcInitiatorCreateFailed, ipmiThreshold=ipmiThreshold, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolDeleted=poolDeleted, shareCIFSWriteIops=shareCIFSWriteIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, diskTotalWriteIops=diskTotalWriteIops, globalStatistics=globalStatistics, poolMetaWriteIops=poolMetaWriteIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, nicTable=nicTable, iscsiTargetIndex=iscsiTargetIndex, lunPoolName=lunPoolName, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, snapshotCloneCompleted=snapshotCloneCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolTotalWriteIops=poolTotalWriteIops, iscsiInitiators=iscsiInitiators, basicCompliance=basicCompliance, iscsiTotalReadIops=iscsiTotalReadIops, lunGUID=lunGUID, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiInitiatorName=iscsiInitiatorName, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolFreeSizeHigh=poolFreeSizeHigh)
