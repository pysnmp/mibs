...
# Produced by pysmi-1.1.12 at Mon Jun  3 12:04:22 2024
...
Bits, MibIdentifier, ObjectIdentity, Counter64, Counter32, NotificationType, ModuleIdentity, TimeTicks, Unsigned32, enterprises, IpAddress, Gauge32, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "ObjectIdentity", "Counter64", "Counter32", "NotificationType", "ModuleIdentity", "TimeTicks", "Unsigned32", "enterprises", "IpAddress", "Gauge32", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareNFSWriteMbps=shareNFSWriteMbps, fcTargetWriteIops=fcTargetWriteIops, snmpServiceStopFailed=snmpServiceStopFailed, cifsTotalReadMbps=cifsTotalReadMbps, poolDataReadLatency=poolDataReadLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, cifsTotalWriteIops=cifsTotalWriteIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolCreated=poolCreated, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, snmpServiceStartFailed=snmpServiceStartFailed, ipmiPowerSupply=ipmiPowerSupply, notificationTargetEntityName=notificationTargetEntityName, cacheSSDReads=cacheSSDReads, notificationProps=notificationProps, projectShares=projectShares, shareEntry=shareEntry, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareDeleted=shareDeleted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, poolDataWriteMbps=poolDataWriteMbps, poolMetaReadIops=poolMetaReadIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, iscsiTargetAuth=iscsiTargetAuth, projectDedupEnabled=projectDedupEnabled, lunName=lunName, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectQuotaSizeLow=projectQuotaSizeLow, fcInitiators=fcInitiators, haResourceGroup=haResourceGroup, fcTargetWriteMbps=fcTargetWriteMbps, poolProjectCount=poolProjectCount, targetGroupMemberAdded=targetGroupMemberAdded, diskTotalWriteMbps=diskTotalWriteMbps, projectDataSizeLow=projectDataSizeLow, poolMetaReadMbps=poolMetaReadMbps, poolSizeLow=poolSizeLow, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, smisServiceStartFailed=smisServiceStartFailed, iscsiInitiatorGroup=iscsiInitiatorGroup, notificationReadingUnit=notificationReadingUnit, projectDataSizeHigh=projectDataSizeHigh, spareDiskReplaced=spareDiskReplaced, lunBlockSize=lunBlockSize, iscsiTargetsTable=iscsiTargetsTable, haControllerB_Name=haControllerB_Name, iscsiTargetGroup=iscsiTargetGroup, iscsiTargetReadIops=iscsiTargetReadIops, poolMetaWriteIops=poolMetaWriteIops, nicReceiveMbps=nicReceiveMbps, cacheTotalReadIops=cacheTotalReadIops, cacheTotalWriteIops=cacheTotalWriteIops, diskIndex=diskIndex, shareCreatedSuccessfully=shareCreatedSuccessfully, lunDedupEnabled=lunDedupEnabled, lunWriteIops=lunWriteIops, iscsiTargetName=iscsiTargetName, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, diskType=diskType, globalStatistics=globalStatistics, poolMetaWriteMbps=poolMetaWriteMbps, lunReadIops=lunReadIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, diskTable=diskTable, ipmiOther=ipmiOther, iscsiTargetWriteIops=iscsiTargetWriteIops, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareDeletionFailed=shareDeletionFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, nvdimmFailSoftError=nvdimmFailSoftError, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargetEntry=fcTargetEntry, projectCreatedSuccessfully=projectCreatedSuccessfully, projectDeleted=projectDeleted, diskEntry=diskEntry, poolFreeSizeHigh=poolFreeSizeHigh, projectSnapshotSizeLow=projectSnapshotSizeLow, adServerTimeDrift=adServerTimeDrift, poolReadCacheReadIops=poolReadCacheReadIops, nicTransmitMbps=nicTransmitMbps, currentNotificationGroup=currentNotificationGroup, poolReadCacheWriteLatency=poolReadCacheWriteLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolName=poolName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTargetName=fcTargetName, fcTargetWriteLatency=fcTargetWriteLatency, notificationEventCode=notificationEventCode, poolDeletionFailed=poolDeletionFailed, notificationTime=notificationTime, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, fcTargetModifyCompleted=fcTargetModifyCompleted, lunTargetGroup=lunTargetGroup, diskCount=diskCount, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, cacheRAMReads=cacheRAMReads, diskSizeLow=diskSizeLow, cpuInterrupts=cpuInterrupts, nfsTotalReadMbps=nfsTotalReadMbps, haControllerB_IPAddr=haControllerB_IPAddr, nvdimmFailDeviceError=nvdimmFailDeviceError, fcProperties=fcProperties, diskDataWriteIops=diskDataWriteIops, replicationAbandoned=replicationAbandoned, iscsiTargetGroupError=iscsiTargetGroupError, nvdimmFailInitializationError=nvdimmFailInitializationError, tegileGroups=tegileGroups, fcTargetIndex=fcTargetIndex, poolImported=poolImported, replicationStarted=replicationStarted, smisServiceStopped=smisServiceStopped, projectFreeSizeHigh=projectFreeSizeHigh, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, sharePoolName=sharePoolName, poolReadCacheWriteIops=poolReadCacheWriteIops, upgradeStarted=upgradeStarted, projectTable=projectTable, cifsAvgReadLatency=cifsAvgReadLatency, notificationDescription=notificationDescription, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, PYSNMP_MODULE_ID=tegile, nicIndex=nicIndex, lunPoolName=lunPoolName, fcInitiatorIndex=fcInitiatorIndex, poolState=poolState, shareCIFSWriteMbps=shareCIFSWriteMbps, notificationSensorNumber=notificationSensorNumber, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolProjects=poolProjects, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, iscsiTargetAlias=iscsiTargetAlias, deleteFolderCompleted=deleteFolderCompleted, poolSizeHigh=poolSizeHigh, poolDeleted=poolDeleted, cifsTotalWriteMbps=cifsTotalWriteMbps, fcTargetGroup=fcTargetGroup, diskError=diskError, poolDataSizeHigh=poolDataSizeHigh, fcTargetReadMbps=fcTargetReadMbps, iscsiWriteIops=iscsiWriteIops, aclMigrationCompleted=aclMigrationCompleted, iscsiTargetEntry=iscsiTargetEntry, lunDataSizeLow=lunDataSizeLow, iscsiAvgReadLatency=iscsiAvgReadLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolDegraded=poolDegraded, diskRandomIOCount=diskRandomIOCount, lunSizeLow=lunSizeLow, memoryFailure=memoryFailure, fcTotalReadIops=fcTotalReadIops, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, vmwareNFSDatastores=vmwareNFSDatastores, diskPoolName=diskPoolName, haResources=haResources, diskTotalWriteIops=diskTotalWriteIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, nicMTU=nicMTU, basicCompliance=basicCompliance, networkIpmpGroupUp=networkIpmpGroupUp, poolMetaWriteLatency=poolMetaWriteLatency, projectLunCount=projectLunCount, cpuSystemCalls=cpuSystemCalls, nicGroup=nicGroup, volumeQuotaFinished=volumeQuotaFinished, fcInitiatorsTable=fcInitiatorsTable, volumeDeleteFailed=volumeDeleteFailed, controllerHardwareModel=controllerHardwareModel, diskIOCount=diskIOCount, poolDataReadIops=poolDataReadIops, poolHealth=poolHealth, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolTotalWriteIops=poolTotalWriteIops, upgradeDownloadFailed=upgradeDownloadFailed, nfsTotalWriteIops=nfsTotalWriteIops, shareExceedThresholdWarning=shareExceedThresholdWarning, lunSnapshotSizeLow=lunSnapshotSizeLow, networkTotalTransmitMbps=networkTotalTransmitMbps, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolFreeSizeLow=poolFreeSizeLow, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiInitiators=iscsiInitiators, poolUpgraded=poolUpgraded, snapshotCloningFailed=snapshotCloningFailed, poolUsedSizeLow=poolUsedSizeLow, projectDeletionFailed=projectDeletionFailed, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcTotalWriteIops=fcTotalWriteIops, poolTotalReadIops=poolTotalReadIops, diskDataReadIops=diskDataReadIops, shareCIFSEnabled=shareCIFSEnabled, fcInitiatorEntry=fcInitiatorEntry, poolTotalReadMbps=poolTotalReadMbps, controllerUp=controllerUp, cpuTotalUsage=cpuTotalUsage, networkInterfaceDown=networkInterfaceDown, poolQuotaFinished=poolQuotaFinished, poolTable=poolTable, notifications=notifications, nicTable=nicTable, controllerTimeDrift=controllerTimeDrift, lunEntry=lunEntry, snmpServiceStarted=snmpServiceStarted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, testNotification=testNotification, notificationSensorSuspect=notificationSensorSuspect, poolAvgWriteLatency=poolAvgWriteLatency, poolCount=poolCount, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiTargetReadLatency=iscsiTargetReadLatency, shareQuotaLow=shareQuotaLow, lunFreeSizeHigh=lunFreeSizeHigh, shareDataSizeHigh=shareDataSizeHigh, diskGoneOffline=diskGoneOffline, nfsTotalReadIops=nfsTotalReadIops, notificationComponentName=notificationComponentName, snmpServiceStopped=snmpServiceStopped, lunReservedSizeLow=lunReservedSizeLow, properties=properties, lunInitiatorGroup=lunInitiatorGroup, cacheTotalReadMbps=cacheTotalReadMbps, diskChassisIdx=diskChassisIdx, replicationFailed=replicationFailed, lunReadLatency=lunReadLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolDataSizeLow=poolDataSizeLow, snmpAgentVersion=snmpAgentVersion, deleteFolderFailed=deleteFolderFailed, fcPortOffline=fcPortOffline, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareNFSReadMbps=shareNFSReadMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diagnosticDataUploaded=diagnosticDataUploaded, tegile=tegile, projectShareCount=projectShareCount, notificationSeverity=notificationSeverity, targetGroupCreateCompleted=targetGroupCreateCompleted, cifsTotalReadIops=cifsTotalReadIops, lunFreeSizeLow=lunFreeSizeLow, poolTotalWriteMbps=poolTotalWriteMbps)
mibBuilder.exportSymbols("TEGILE-MIB", shareTable=shareTable, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, unknownSensorEvent=unknownSensorEvent, snapshotCloneCompleted=snapshotCloneCompleted, snapshotRollbackFailed=snapshotRollbackFailed, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolDataWriteLatency=poolDataWriteLatency, smisServiceStarted=smisServiceStarted, ntpServerTimeDrift=ntpServerTimeDrift, iscsiTargetWriteLatency=iscsiTargetWriteLatency, shareCIFSReadIops=shareCIFSReadIops, lunCompressionEnabled=lunCompressionEnabled, ipmiCurrent=ipmiCurrent, targetGroupMemberRemoved=targetGroupMemberRemoved, fcTargets=fcTargets, lunCompressedRatio=lunCompressedRatio, cifsAvgWriteLatency=cifsAvgWriteLatency, nvdimmFailUnknownError=nvdimmFailUnknownError, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunReadMbps=lunReadMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectModified=projectModified, tdpsUpgradeTimeout=tdpsUpgradeTimeout, iscsiTargetWriteMbps=iscsiTargetWriteMbps, aclMigrationStarted=aclMigrationStarted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectFreeSizeLow=projectFreeSizeLow, shareProjectName=shareProjectName, haResourceIndex=haResourceIndex, replicationResumed=replicationResumed, ipmiVoltage=ipmiVoltage, diskSequentialIOCount=diskSequentialIOCount, lunIndex=lunIndex, poolExported=poolExported, haResourceEntry=haResourceEntry, shareNFSWriteLatency=shareNFSWriteLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, snapshotDeleteFailed=snapshotDeleteFailed, diskDataWriteMbps=diskDataWriteMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectLUNs=projectLUNs, iscsiTargets=iscsiTargets, lunWriteLatency=lunWriteLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, lunGUID=lunGUID, shareDataSizeLow=shareDataSizeLow, iscsiInitiatorName=iscsiInitiatorName, ipmiTemperature=ipmiTemperature, snapshotRollbackCompleted=snapshotRollbackCompleted, haResourceDescription=haResourceDescription, haControllerB_Uptime=haControllerB_Uptime, shareNFSReadIops=shareNFSReadIops, fcTargetsTable=fcTargetsTable, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcTargetStatus=fcTargetStatus, fcInitiatorGroup=fcInitiatorGroup, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, networkIpmpGroupDown=networkIpmpGroupDown, replicationAborted=replicationAborted, haResourcesTable=haResourcesTable, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareReservedSizeLow=shareReservedSizeLow, nicName=nicName, ipmiMemory=ipmiMemory, volumeDeleteCompleted=volumeDeleteCompleted, smisServiceStopFailed=smisServiceStopFailed, lunProjectName=lunProjectName, iscsiTotalWriteMbps=iscsiTotalWriteMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolDataWriteIops=poolDataWriteIops, haResourceName=haResourceName, tegileArray=tegileArray, nicEntry=nicEntry, fcPortOnline=fcPortOnline, netbiosSocketFailure=netbiosSocketFailure, haResourceStatus=haResourceStatus, lunSizeHigh=lunSizeHigh, shareQuotaHigh=shareQuotaHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, projectCompressionEnabled=projectCompressionEnabled, shareCompressionEnabled=shareCompressionEnabled, poolUsedSizeHigh=poolUsedSizeHigh, projectSnapshotSizeHigh=projectSnapshotSizeHigh, replicationSourceRegistered=replicationSourceRegistered, iscsiTargetError=iscsiTargetError, disks=disks, poolIndex=poolIndex, iscsiTargetIndex=iscsiTargetIndex, nfsTotalWriteMbps=nfsTotalWriteMbps, nfsAvgReadLatency=nfsAvgReadLatency, diskAvgReadLatency=diskAvgReadLatency, shareCompressedRatio=shareCompressedRatio, shareCIFSWriteIops=shareCIFSWriteIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, fcInitiatorCreateFailed=fcInitiatorCreateFailed, maintenanceModeDisabled=maintenanceModeDisabled, diskDataReadMbps=diskDataReadMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunTable=lunTable, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, replicationTargetDeleted=replicationTargetDeleted, diskSizeHigh=diskSizeHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, upgradeDownloadCompleted=upgradeDownloadCompleted, networkTotalReceiveMbps=networkTotalReceiveMbps, userLoginFailed=userLoginFailed, diskAlias=diskAlias, fcTotalWriteMbps=fcTotalWriteMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunWriteMbps=lunWriteMbps, diskIsOnline=diskIsOnline, poolMetaReadLatency=poolMetaReadLatency, projectEntry=projectEntry, shareReservedSizeHigh=shareReservedSizeHigh, projectName=projectName, webdocsUpgradeFailed=webdocsUpgradeFailed, fcAvgWriteLatency=fcAvgWriteLatency, iscsiTotalReadMbps=iscsiTotalReadMbps, volumeModifyCompleted=volumeModifyCompleted, maintenanceModeEnabled=maintenanceModeEnabled, poolOwnerController=poolOwnerController, haControllerA_Name=haControllerA_Name, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, tdpsUpgradeFailed=tdpsUpgradeFailed, diskTotalReadMbps=diskTotalReadMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, ipmiFan=ipmiFan, diskSlowIo=diskSlowIo, lunProtocol=lunProtocol, iscsiTargetReadMbps=iscsiTargetReadMbps, poolEntry=poolEntry, shareIndex=shareIndex, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareName=shareName, intelliFlashSoftwareDown=intelliFlashSoftwareDown, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, haControllerA_Uptime=haControllerA_Uptime, projectIndex=projectIndex, replicationPaused=replicationPaused, networkInterfaceUp=networkInterfaceUp, projectQuotaFinished=projectQuotaFinished, upgradeFailed=upgradeFailed, shareNFSEnabled=shareNFSEnabled, tegileArray_notifications=tegileArray_notifications, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, ipmiThreshold=ipmiThreshold, iscsiInitiatorEntry=iscsiInitiatorEntry, notificationObjects=notificationObjects, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcInitiatorName=fcInitiatorName, lunReservedSizeHigh=lunReservedSizeHigh, controllerDown=controllerDown, haControllerA_IPAddr=haControllerA_IPAddr, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectThresholdExceedWarning=projectThresholdExceedWarning, fcAvgReadLatency=fcAvgReadLatency, shareSnapshotSizeLow=shareSnapshotSizeLow, tegileConformance=tegileConformance, diskState=diskState, upgradeCompleted=upgradeCompleted, poolAvgReadLatency=poolAvgReadLatency, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, sanProperties=sanProperties, shareCIFSReadMbps=shareCIFSReadMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, diskTotalReadIops=diskTotalReadIops, fcTotalReadMbps=fcTotalReadMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, lunDataSizeHigh=lunDataSizeHigh, smbSocketFailure=smbSocketFailure, projectPoolName=projectPoolName, poolDataReadMbps=poolDataReadMbps, notificationSensorAction=notificationSensorAction, fcTargetReadIops=fcTargetReadIops, poolReadCacheReadMbps=poolReadCacheReadMbps, nicState=nicState, snapshotCreationFailed=snapshotCreationFailed, projectTotalSaving=projectTotalSaving, pools=pools, fcTargetReadLatency=fcTargetReadLatency, network=network, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareQuotaFinished=shareQuotaFinished, haResourceActiveNode=haResourceActiveNode, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, notificationReadingTriggerValue=notificationReadingTriggerValue, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, upgradeDownloadStarted=upgradeDownloadStarted, sensorFailureEvent=sensorFailureEvent, shareNFSWriteIops=shareNFSWriteIops, shareCIFSReadLatency=shareCIFSReadLatency, diskAvgWriteLatency=diskAvgWriteLatency, currentObjectGroup=currentObjectGroup, shareDedupEnabled=shareDedupEnabled, shareMountPoint=shareMountPoint, shareNFSReadLatency=shareNFSReadLatency, iscsiProperties=iscsiProperties, replicationComplete=replicationComplete, poolExpanded=poolExpanded, iscsiTotalReadIops=iscsiTotalReadIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, upgradeTimeout=upgradeTimeout, notificationThresholdTriggerValue=notificationThresholdTriggerValue, tegileCompliances=tegileCompliances, iscsiAvgWriteLatency=iscsiAvgWriteLatency, alertsCleanupCompleted=alertsCleanupCompleted)
