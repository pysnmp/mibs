...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:45:02 2023
...
Counter32, MibIdentifier, iso, Unsigned32, Gauge32, TimeTicks, Counter64, ModuleIdentity, NotificationType, Integer32, enterprises, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "iso", "Unsigned32", "Gauge32", "TimeTicks", "Counter64", "ModuleIdentity", "NotificationType", "Integer32", "enterprises", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", iscsiInitiatorChapUser=iscsiInitiatorChapUser, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunSizeLow=lunSizeLow, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, replicationPaused=replicationPaused, intelliFlashSoftwareDown=intelliFlashSoftwareDown, fcTargetWriteLatency=fcTargetWriteLatency, diskIndex=diskIndex, poolOwnerController=poolOwnerController, volumeModifyCompleted=volumeModifyCompleted, ipmiTemperature=ipmiTemperature, fcTargets=fcTargets, deleteFolderFailed=deleteFolderFailed, poolDataWriteMbps=poolDataWriteMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiInitiators=iscsiInitiators, iscsiTargetGroupError=iscsiTargetGroupError, PYSNMP_MODULE_ID=tegile, notificationDescription=notificationDescription, poolDeletionFailed=poolDeletionFailed, lunDataSizeLow=lunDataSizeLow, poolDataReadMbps=poolDataReadMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiTargetError=iscsiTargetError, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, snapshotRollbackCompleted=snapshotRollbackCompleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolTotalReadIops=poolTotalReadIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, notificationReadingTriggerValue=notificationReadingTriggerValue, shareCompressionEnabled=shareCompressionEnabled, fcInitiatorIndex=fcInitiatorIndex, haResourceIndex=haResourceIndex, nicMTU=nicMTU, ipmiOther=ipmiOther, tegileGroups=tegileGroups, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcPortOnline=fcPortOnline, tegileCompliances=tegileCompliances, poolDeleted=poolDeleted, shareReservedSizeLow=shareReservedSizeLow, shareNFSReadLatency=shareNFSReadLatency, shareDedupEnabled=shareDedupEnabled, nicEntry=nicEntry, vmwareNFSDatastores=vmwareNFSDatastores, nfsAvgWriteLatency=nfsAvgWriteLatency, snmpServiceStopFailed=snmpServiceStopFailed, iscsiInitiatorsTable=iscsiInitiatorsTable, ipmiFan=ipmiFan, shareCompressedRatio=shareCompressedRatio, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, upgradeCompleted=upgradeCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, haResourceName=haResourceName, haControllerB_IPAddr=haControllerB_IPAddr, projectQuotaSizeHigh=projectQuotaSizeHigh, projectFreeSizeLow=projectFreeSizeLow, nfsTotalReadMbps=nfsTotalReadMbps, poolUpgraded=poolUpgraded, projectLUNs=projectLUNs, cifsTotalReadMbps=cifsTotalReadMbps, diagnosticDataUploaded=diagnosticDataUploaded, cifsTotalWriteIops=cifsTotalWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, ipmiThreshold=ipmiThreshold, projectIndex=projectIndex, lunFreeSizeHigh=lunFreeSizeHigh, fcInitiators=fcInitiators, iscsiTargetAlias=iscsiTargetAlias, diskTotalWriteMbps=diskTotalWriteMbps, lunReadIops=lunReadIops, fcTargetWriteMbps=fcTargetWriteMbps, tdpsUpgradeCompleted=tdpsUpgradeCompleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiProperties=iscsiProperties, diskSequentialIOCount=diskSequentialIOCount, notificationTime=notificationTime, fcInitiatorGroup=fcInitiatorGroup, controllerDown=controllerDown, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, tdpsUpgradeTimeout=tdpsUpgradeTimeout, tegile=tegile, networkIpmpGroupDown=networkIpmpGroupDown, notificationSensorNumber=notificationSensorNumber, projectShareCount=projectShareCount, shareReservedSizeHigh=shareReservedSizeHigh, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareCIFSEnabled=shareCIFSEnabled, iscsiTotalReadMbps=iscsiTotalReadMbps, projectDataSizeLow=projectDataSizeLow, shareNFSReadIops=shareNFSReadIops, iscsiTargetIndex=iscsiTargetIndex, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, shareQuotaFinished=shareQuotaFinished, diskIOCount=diskIOCount, shareCIFSReadLatency=shareCIFSReadLatency, diskDataReadMbps=diskDataReadMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, controllerUp=controllerUp, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectSnapshotSizeHigh=projectSnapshotSizeHigh, volumeQuotaFinished=volumeQuotaFinished, diskIsOnline=diskIsOnline, notificationSeverity=notificationSeverity, fcTargetIndex=fcTargetIndex, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, volumeDeleteCompleted=volumeDeleteCompleted, fcTargetsTable=fcTargetsTable, poolUsedSizeHigh=poolUsedSizeHigh, ipmiCurrent=ipmiCurrent, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolImported=poolImported, maintenanceModeEnabled=maintenanceModeEnabled, networkInterfaceUp=networkInterfaceUp, notificationComponentName=notificationComponentName, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiImproperTargetGroup=iscsiImproperTargetGroup, smbSocketFailure=smbSocketFailure, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectName=projectName, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, cifsAvgReadLatency=cifsAvgReadLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, haControllerA_IPAddr=haControllerA_IPAddr, iscsiInitiatorName=iscsiInitiatorName, notificationObjects=notificationObjects, fcTotalReadIops=fcTotalReadIops, smisServiceStarted=smisServiceStarted, aclMigrationStarted=aclMigrationStarted, cifsAvgWriteLatency=cifsAvgWriteLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, ipmiMemory=ipmiMemory, unknownSensorEvent=unknownSensorEvent, projectDataSizeHigh=projectDataSizeHigh, iscsiTargetName=iscsiTargetName, poolDataReadIops=poolDataReadIops, shareQuotaHigh=shareQuotaHigh, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, sanProperties=sanProperties, shareNFSReadMbps=shareNFSReadMbps, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, iscsiInitiatorIndex=iscsiInitiatorIndex, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolReadCacheReadLatency=poolReadCacheReadLatency, poolTable=poolTable, nicTransmitMbps=nicTransmitMbps, currentNotificationGroup=currentNotificationGroup, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, basicCompliance=basicCompliance, haResourceGroup=haResourceGroup, shareName=shareName, replicationFailed=replicationFailed, cacheTotalReadMbps=cacheTotalReadMbps, poolState=poolState, iscsiInitiatorGroup=iscsiInitiatorGroup, fcInitiatorName=fcInitiatorName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolMetaWriteIops=poolMetaWriteIops, diskDataWriteMbps=diskDataWriteMbps, haControllerB_Uptime=haControllerB_Uptime, diskError=diskError, tegileConformance=tegileConformance, tdpsUpgradeFailed=tdpsUpgradeFailed, poolCreated=poolCreated, snapshotCloningFailed=snapshotCloningFailed, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolCount=poolCount, ipmiCriticalInterrupt=ipmiCriticalInterrupt, nfsTotalWriteIops=nfsTotalWriteIops, shareTable=shareTable, diskEntry=diskEntry, shareCIFSReadIops=shareCIFSReadIops, nvdimmFailSoftError=nvdimmFailSoftError, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, ipmiPowerSupply=ipmiPowerSupply, nfsAvgReadLatency=nfsAvgReadLatency, projectQuotaSizeLow=projectQuotaSizeLow, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, fcInitiatorEntry=fcInitiatorEntry, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcPortOffline=fcPortOffline, cacheTotalWriteMbps=cacheTotalWriteMbps, shareNFSEnabled=shareNFSEnabled, upgradeDownloadCompleted=upgradeDownloadCompleted, replicationAborted=replicationAborted, poolIndex=poolIndex, diskTotalReadMbps=diskTotalReadMbps, poolSizeLow=poolSizeLow, shareExceedThresholdWarning=shareExceedThresholdWarning, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, notificationThresholdTriggerValue=notificationThresholdTriggerValue, nfsTotalReadIops=nfsTotalReadIops, projectEntry=projectEntry, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, maintenanceModeDisabled=maintenanceModeDisabled, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskTable=diskTable, diskType=diskType, projectModified=projectModified, haResourceStatus=haResourceStatus, lunEntry=lunEntry, fcTargetReadMbps=fcTargetReadMbps, lunWriteIops=lunWriteIops, shareNFSWriteIops=shareNFSWriteIops, iscsiTargetsTable=iscsiTargetsTable, cpuSystemCalls=cpuSystemCalls, poolFreeSizeLow=poolFreeSizeLow, notificationSensorSuspect=notificationSensorSuspect, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiTargetEntry=iscsiTargetEntry, shareDataSizeLow=shareDataSizeLow, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectDeletionFailed=projectDeletionFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, lunReadMbps=lunReadMbps, fcTargetName=fcTargetName, spareDiskReplaced=spareDiskReplaced, nicIndex=nicIndex, poolDegraded=poolDegraded, poolMetaReadIops=poolMetaReadIops, properties=properties, nvdimmFailInitializationError=nvdimmFailInitializationError, networkInterfaceDown=networkInterfaceDown, shareDataSizeHigh=shareDataSizeHigh, diskDataReadIops=diskDataReadIops, poolDataSizeHigh=poolDataSizeHigh, lunBlockSize=lunBlockSize, lunReservedSizeLow=lunReservedSizeLow, shareCIFSWriteMbps=shareCIFSWriteMbps, diskAlias=diskAlias, controllerTimeDrift=controllerTimeDrift, projectTable=projectTable, poolExported=poolExported, volumeDeleteFailed=volumeDeleteFailed, lunFreeSizeLow=lunFreeSizeLow, lunSnapshotSizeLow=lunSnapshotSizeLow, fcInitiatorsTable=fcInitiatorsTable, cacheSSDReads=cacheSSDReads, smisServiceStopFailed=smisServiceStopFailed, diskTotalWriteIops=diskTotalWriteIops)
mibBuilder.exportSymbols("TEGILE-MIB", poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunInitiatorGroup=lunInitiatorGroup, lunGUID=lunGUID, poolFreeSizeHigh=poolFreeSizeHigh, projectThresholdExceedWarning=projectThresholdExceedWarning, networkIpmpGroupUp=networkIpmpGroupUp, poolReadCacheWriteIops=poolReadCacheWriteIops, shareNFSWriteLatency=shareNFSWriteLatency, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, diskSizeHigh=diskSizeHigh, fcTargetEntry=fcTargetEntry, replicationSourceRegistered=replicationSourceRegistered, projectQuotaFinished=projectQuotaFinished, snapshotDeleteFailed=snapshotDeleteFailed, haResourcesTable=haResourcesTable, projectPoolName=projectPoolName, lunDedupEnabled=lunDedupEnabled, replicationResumed=replicationResumed, diskRandomIOCount=diskRandomIOCount, lunProjectName=lunProjectName, snmpServiceStartFailed=snmpServiceStartFailed, upgradeStarted=upgradeStarted, shareCIFSReadMbps=shareCIFSReadMbps, projectLunCount=projectLunCount, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, cpuInterrupts=cpuInterrupts, nicName=nicName, nicGroup=nicGroup, fcAvgWriteLatency=fcAvgWriteLatency, userLoginFailed=userLoginFailed, iscsiAvgWriteLatency=iscsiAvgWriteLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunIndex=lunIndex, notificationProps=notificationProps, smisServiceStopped=smisServiceStopped, cifsTotalReadIops=cifsTotalReadIops, iscsiInitiatorEntry=iscsiInitiatorEntry, replicationAbandoned=replicationAbandoned, poolMetaReadLatency=poolMetaReadLatency, fcTargetModifyCompleted=fcTargetModifyCompleted, fcAvgReadLatency=fcAvgReadLatency, diskSizeLow=diskSizeLow, nicReceiveMbps=nicReceiveMbps, snmpServiceStarted=snmpServiceStarted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, upgradeDownloadStarted=upgradeDownloadStarted, shareEntry=shareEntry, shareIndex=shareIndex, iscsiTargets=iscsiTargets, poolAvgWriteLatency=poolAvgWriteLatency, aclMigrationCompleted=aclMigrationCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolName=poolName, haControllerA_Name=haControllerA_Name, replicationTargetDeleted=replicationTargetDeleted, lunProtocol=lunProtocol, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiTargetGroup=iscsiTargetGroup, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, ntpServerTimeDrift=ntpServerTimeDrift, smisServiceStartFailed=smisServiceStartFailed, projectSnapshotSizeLow=projectSnapshotSizeLow, haResourceDescription=haResourceDescription, fcTotalWriteMbps=fcTotalWriteMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, iscsiTotalReadIops=iscsiTotalReadIops, iscsiWriteIops=iscsiWriteIops, projectDeleted=projectDeleted, upgradeFailed=upgradeFailed, notifications=notifications, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, fcTotalReadMbps=fcTotalReadMbps, cacheTotalWriteIops=cacheTotalWriteIops, lunCompressionEnabled=lunCompressionEnabled, tegileArray=tegileArray, poolProjects=poolProjects, poolTotalReadMbps=poolTotalReadMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, projectDedupEnabled=projectDedupEnabled, replicationStarted=replicationStarted, webdocsUpgradeFailed=webdocsUpgradeFailed, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, nvdimmFailDeviceError=nvdimmFailDeviceError, iscsiTargetReadLatency=iscsiTargetReadLatency, volumeCreatedSuccessfully=volumeCreatedSuccessfully, poolSizeHigh=poolSizeHigh, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, snapshotCreationFailed=snapshotCreationFailed, cacheTotalReadIops=cacheTotalReadIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, upgradeTimeout=upgradeTimeout, snmpServiceStopped=snmpServiceStopped, iscsiTargetAuth=iscsiTargetAuth, alertsCleanupCompleted=alertsCleanupCompleted, tegileArray_notifications=tegileArray_notifications, projectTotalSaving=projectTotalSaving, poolHealth=poolHealth, fcTotalWriteIops=fcTotalWriteIops, diskAvgReadLatency=diskAvgReadLatency, lunName=lunName, replicationComplete=replicationComplete, fcProperties=fcProperties, lunWriteMbps=lunWriteMbps, fcTargetGroup=fcTargetGroup, poolQuotaFinished=poolQuotaFinished, poolDataWriteIops=poolDataWriteIops, projectFreeSizeHigh=projectFreeSizeHigh, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolTotalSaving=poolTotalSaving, diskGoneOffline=diskGoneOffline, shareProjectName=shareProjectName, projectCompressionEnabled=projectCompressionEnabled, diskAvgWriteLatency=diskAvgWriteLatency, nicState=nicState, poolExpanded=poolExpanded, shareCIFSWriteIops=shareCIFSWriteIops, poolDataWriteLatency=poolDataWriteLatency, nvdimmFailUnknownError=nvdimmFailUnknownError, globalStatistics=globalStatistics, lunReservedSizeHigh=lunReservedSizeHigh, snapshotCloneCompleted=snapshotCloneCompleted, cacheRAMReads=cacheRAMReads, shareNFSWriteMbps=shareNFSWriteMbps, ipmiVoltage=ipmiVoltage, shareDeleted=shareDeleted, poolTotalWriteIops=poolTotalWriteIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, notificationEventCode=notificationEventCode, fcInitiatorCreateFailed=fcInitiatorCreateFailed, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, lunReadLatency=lunReadLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, shareCreatedSuccessfully=shareCreatedSuccessfully, adServerTimeDrift=adServerTimeDrift, haControllerB_Name=haControllerB_Name, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, notificationReadingUnit=notificationReadingUnit, diskPoolName=diskPoolName, haControllerA_Uptime=haControllerA_Uptime, poolUsedSizeLow=poolUsedSizeLow, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, controllerHardwareModel=controllerHardwareModel, poolDataSizeLow=poolDataSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, projectShares=projectShares, lunTargetGroup=lunTargetGroup, targetGroupMemberAdded=targetGroupMemberAdded, sensorFailureEvent=sensorFailureEvent, lunPoolName=lunPoolName, poolMetaReadMbps=poolMetaReadMbps, memoryFailure=memoryFailure, shareDeletionFailed=shareDeletionFailed, cpuTotalUsage=cpuTotalUsage, diskTotalReadIops=diskTotalReadIops, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, haResourceActiveNode=haResourceActiveNode, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolAvgReadLatency=poolAvgReadLatency, poolDataReadLatency=poolDataReadLatency, lunDataSizeHigh=lunDataSizeHigh, notificationSensorAction=notificationSensorAction, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, lunSizeHigh=lunSizeHigh, sharePoolName=sharePoolName, poolReadCacheReadIops=poolReadCacheReadIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiTargetReadIops=iscsiTargetReadIops, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, nicTable=nicTable, poolMetaWriteMbps=poolMetaWriteMbps, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, haResources=haResources, haResourceEntry=haResourceEntry, shareQuotaLow=shareQuotaLow, iscsiAvgReadLatency=iscsiAvgReadLatency, lunWriteLatency=lunWriteLatency, deleteFolderCompleted=deleteFolderCompleted, diskCount=diskCount, diskState=diskState, disks=disks, targetGroupDeleteCompleted=targetGroupDeleteCompleted, testNotification=testNotification, lunCompressedRatio=lunCompressedRatio, poolEntry=poolEntry, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcTargetStatus=fcTargetStatus, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunTable=lunTable, networkTotalTransmitMbps=networkTotalTransmitMbps, poolProjectCount=poolProjectCount, netbiosSocketFailure=netbiosSocketFailure, notificationTargetEntityName=notificationTargetEntityName, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolTotalWriteMbps=poolTotalWriteMbps, fcTargetReadLatency=fcTargetReadLatency, snapshotRollbackFailed=snapshotRollbackFailed, nfsTotalWriteMbps=nfsTotalWriteMbps, snmpAgentVersion=snmpAgentVersion, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskSlowIo=diskSlowIo, pools=pools, fcTargetWriteIops=fcTargetWriteIops, diskDataWriteIops=diskDataWriteIops, shareMountPoint=shareMountPoint, fcTargetReadIops=fcTargetReadIops, currentObjectGroup=currentObjectGroup, diskChassisIdx=diskChassisIdx, networkTotalReceiveMbps=networkTotalReceiveMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, network=network)
