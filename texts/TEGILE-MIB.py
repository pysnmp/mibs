...
NotificationType, Counter64, enterprises, Bits, TimeTicks, MibIdentifier, Gauge32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, ObjectIdentity, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "enterprises", "Bits", "TimeTicks", "MibIdentifier", "Gauge32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "ObjectIdentity", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("TEGILE-MIB", nicEntry=nicEntry, fcTotalReadMbps=fcTotalReadMbps, poolDataWriteLatency=poolDataWriteLatency, shareDeleted=shareDeleted, iscsiTargets=iscsiTargets, projectQuotaSizeLow=projectQuotaSizeLow, poolReadCacheWriteMbps=poolReadCacheWriteMbps, volumeDeleteCompleted=volumeDeleteCompleted, testNotification=testNotification, lunReadMbps=lunReadMbps, shareProjectName=shareProjectName, poolTotalWriteMbps=poolTotalWriteMbps, fcInitiatorEntry=fcInitiatorEntry, poolOwnerController=poolOwnerController, userLoginFailed=userLoginFailed, fcAvgWriteLatency=fcAvgWriteLatency, upgradeTimeout=upgradeTimeout, nvdimmFailUnknownError=nvdimmFailUnknownError, upgradeDownloadStarted=upgradeDownloadStarted, projectName=projectName, replicationAbandoned=replicationAbandoned, notificationProps=notificationProps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, fcTotalReadIops=fcTotalReadIops, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, tegileArray_notifications=tegileArray_notifications, diskCount=diskCount, projectShares=projectShares, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, fcTargetWriteLatency=fcTargetWriteLatency, lunDataSizeLow=lunDataSizeLow, iscsiTargetReadIops=iscsiTargetReadIops, shareReservedSizeHigh=shareReservedSizeHigh, lunCompressionEnabled=lunCompressionEnabled, diskState=diskState, nicTable=nicTable, smisServiceStarted=smisServiceStarted, projectThresholdExceedWarning=projectThresholdExceedWarning, networkTotalTransmitMbps=networkTotalTransmitMbps, smisServiceStartFailed=smisServiceStartFailed, networkTotalReceiveMbps=networkTotalReceiveMbps, lunName=lunName, diskSizeHigh=diskSizeHigh, cacheRAMReads=cacheRAMReads, poolEntry=poolEntry, fcTargetWriteIops=fcTargetWriteIops, iscsiTotalReadIops=iscsiTotalReadIops, poolDataWriteMbps=poolDataWriteMbps, poolQuotaFinished=poolQuotaFinished, tegileGroups=tegileGroups, poolDeleted=poolDeleted, cpuSystemCalls=cpuSystemCalls, shareCIFSReadIops=shareCIFSReadIops, poolDataReadMbps=poolDataReadMbps, snapshotCreationFailed=snapshotCreationFailed, smisServiceStopped=smisServiceStopped, iscsiInitiators=iscsiInitiators, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolDataSizeHigh=poolDataSizeHigh, intelliFlashSoftwareUp=intelliFlashSoftwareUp, ntpServerTimeDrift=ntpServerTimeDrift, fcInitiators=fcInitiators, notificationReadingUnit=notificationReadingUnit, poolCreated=poolCreated, diskTotalReadMbps=diskTotalReadMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, cifsAvgWriteLatency=cifsAvgWriteLatency, projectDedupEnabled=projectDedupEnabled, iscsiTargetReadLatency=iscsiTargetReadLatency, shareSnapshotSizeLow=shareSnapshotSizeLow, shareCreatedSuccessfully=shareCreatedSuccessfully, notifications=notifications, replicationStarted=replicationStarted, fcInitiatorName=fcInitiatorName, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolSizeHigh=poolSizeHigh, fcTargetStatus=fcTargetStatus, poolCount=poolCount, fcTargetGroup=fcTargetGroup, diskAlias=diskAlias, adServerTimeDrift=adServerTimeDrift, fcTargetReadMbps=fcTargetReadMbps, upgradeStarted=upgradeStarted, replicationTargetDeleted=replicationTargetDeleted, volumeModifyCompleted=volumeModifyCompleted, diskAvgWriteLatency=diskAvgWriteLatency, fcTotalWriteMbps=fcTotalWriteMbps, poolExported=poolExported, lunFreeSizeLow=lunFreeSizeLow, projectPoolName=projectPoolName, poolReadCacheWriteLatency=poolReadCacheWriteLatency, notificationSensorSuspect=notificationSensorSuspect, snmpServiceStopped=snmpServiceStopped, lunSnapshotSizeHigh=lunSnapshotSizeHigh, diskChassisIdx=diskChassisIdx, poolDegraded=poolDegraded, poolUsedSizeHigh=poolUsedSizeHigh, shareNFSWriteLatency=shareNFSWriteLatency, fcTargetEntry=fcTargetEntry, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcTargetWriteMbps=fcTargetWriteMbps, cpuTotalUsage=cpuTotalUsage, upgradeCompleted=upgradeCompleted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, volumeQuotaFinished=volumeQuotaFinished, nicName=nicName, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunBlockSize=lunBlockSize, ipmiCriticalInterrupt=ipmiCriticalInterrupt, volumeCreatedSuccessfully=volumeCreatedSuccessfully, iscsiTotalReadMbps=iscsiTotalReadMbps, poolName=poolName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskSequentialIOCount=diskSequentialIOCount, fcAvgReadLatency=fcAvgReadLatency, shareCIFSEnabled=shareCIFSEnabled, poolDataReadLatency=poolDataReadLatency, basicCompliance=basicCompliance, tegileArray=tegileArray, fcInitiatorsTable=fcInitiatorsTable, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareDataSizeHigh=shareDataSizeHigh, lunWriteIops=lunWriteIops, notificationDescription=notificationDescription, poolReadCacheReadIops=poolReadCacheReadIops, shareNFSReadIops=shareNFSReadIops, lunSizeHigh=lunSizeHigh, ipmiCurrent=ipmiCurrent, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, notificationSensorNumber=notificationSensorNumber, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, shareIndex=shareIndex, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, controllerHardwareModel=controllerHardwareModel, nicMTU=nicMTU, nvdimmFailInitializationError=nvdimmFailInitializationError, ipmiThreshold=ipmiThreshold, shareExceedThresholdWarning=shareExceedThresholdWarning, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, ipmiFan=ipmiFan, haControllerA_IPAddr=haControllerA_IPAddr, cifsAvgReadLatency=cifsAvgReadLatency, ipmiPowerSupply=ipmiPowerSupply, initiatorGroupMemberAdded=initiatorGroupMemberAdded, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, haControllerA_Uptime=haControllerA_Uptime, notificationReadingTriggerValue=notificationReadingTriggerValue, replicationPaused=replicationPaused, controllerDown=controllerDown, poolReadCacheWriteIops=poolReadCacheWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, controllerTimeDrift=controllerTimeDrift, lunWriteLatency=lunWriteLatency, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiTargetError=iscsiTargetError, nfsTotalWriteIops=nfsTotalWriteIops, diskEntry=diskEntry, lunFreeSizeHigh=lunFreeSizeHigh, poolHealth=poolHealth, networkIpmpGroupDown=networkIpmpGroupDown, diskTotalReadIops=diskTotalReadIops, poolIndex=poolIndex, maintenanceModeDisabled=maintenanceModeDisabled, lunSizeLow=lunSizeLow, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, networkInterfaceUp=networkInterfaceUp, haResourceEntry=haResourceEntry, iscsiTargetEntry=iscsiTargetEntry, iscsiAvgReadLatency=iscsiAvgReadLatency, diskType=diskType, shareReservedSizeLow=shareReservedSizeLow, nvdimmFailSoftError=nvdimmFailSoftError, shareEntry=shareEntry, haResourceName=haResourceName, diskDataWriteIops=diskDataWriteIops, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolExpanded=poolExpanded, projectDataSizeLow=projectDataSizeLow, cpuInterrupts=cpuInterrupts, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, haResourceDescription=haResourceDescription, poolMetaReadMbps=poolMetaReadMbps, shareQuotaFinished=shareQuotaFinished, shareNFSEnabled=shareNFSEnabled, iscsiTargetWriteIops=iscsiTargetWriteIops, aclMigrationStarted=aclMigrationStarted, diskTotalWriteIops=diskTotalWriteIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolState=poolState, nicReceiveMbps=nicReceiveMbps, nicState=nicState, cacheSSDReads=cacheSSDReads, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, tdpsUpgradeFailed=tdpsUpgradeFailed, lunPoolName=lunPoolName, fcTargetModifyCompleted=fcTargetModifyCompleted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectShareCount=projectShareCount, poolTotalSaving=poolTotalSaving, sharePoolName=sharePoolName, replicationResumed=replicationResumed, deleteFolderCompleted=deleteFolderCompleted, poolDataReadIops=poolDataReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunDedupEnabled=lunDedupEnabled, iscsiTotalWriteMbps=iscsiTotalWriteMbps, projectCompressionEnabled=projectCompressionEnabled, poolUpgraded=poolUpgraded, fcPortOffline=fcPortOffline, projectLUNs=projectLUNs, poolImported=poolImported, netbiosSocketFailure=netbiosSocketFailure, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, lunTargetGroup=lunTargetGroup, lunProjectName=lunProjectName, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, ipmiTemperature=ipmiTemperature, poolTotalReadMbps=poolTotalReadMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolFreeSizeLow=poolFreeSizeLow, shareCIFSWriteIops=shareCIFSWriteIops, nicTransmitMbps=nicTransmitMbps, lunReservedSizeHigh=lunReservedSizeHigh, lunIndex=lunIndex, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectModified=projectModified, iscsiTargetIndex=iscsiTargetIndex, iscsiTargetGroup=iscsiTargetGroup, fcTargetName=fcTargetName, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, diskIOCount=diskIOCount, snmpAgentVersion=snmpAgentVersion, smisServiceStopFailed=smisServiceStopFailed, diskRandomIOCount=diskRandomIOCount, fcInitiatorGroup=fcInitiatorGroup, snapshotCloneCompleted=snapshotCloneCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, smbSocketFailure=smbSocketFailure, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskAvgReadLatency=diskAvgReadLatency, notificationComponentName=notificationComponentName, nfsAvgReadLatency=nfsAvgReadLatency, lunGUID=lunGUID, projectDeletionFailed=projectDeletionFailed, projectTotalSaving=projectTotalSaving, diskTable=diskTable)
mibBuilder.exportSymbols("TEGILE-MIB", lunDataSizeHigh=lunDataSizeHigh, currentNotificationGroup=currentNotificationGroup, shareQuotaHigh=shareQuotaHigh, projectIndex=projectIndex, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, maintenanceModeEnabled=maintenanceModeEnabled, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolReadCacheReadLatency=poolReadCacheReadLatency, fcTotalWriteIops=fcTotalWriteIops, fcTargetReadLatency=fcTargetReadLatency, upgradeFailed=upgradeFailed, nfsTotalWriteMbps=nfsTotalWriteMbps, projectTable=projectTable, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareCIFSReadLatency=shareCIFSReadLatency, shareNFSReadLatency=shareNFSReadLatency, fcTargetsTable=fcTargetsTable, poolAvgWriteLatency=poolAvgWriteLatency, fcTargets=fcTargets, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, lunReadLatency=lunReadLatency, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolDeletionFailed=poolDeletionFailed, diskSlowIo=diskSlowIo, snmpServiceStartFailed=snmpServiceStartFailed, shareDataSizeLow=shareDataSizeLow, iscsiInitiatorGroup=iscsiInitiatorGroup, spareDiskReplaced=spareDiskReplaced, projectFreeSizeHigh=projectFreeSizeHigh, poolMetaReadLatency=poolMetaReadLatency, targetGroupCreateCompleted=targetGroupCreateCompleted, replicationAborted=replicationAborted, notificationSeverity=notificationSeverity, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiTargetGroupError=iscsiTargetGroupError, nfsTotalReadIops=nfsTotalReadIops, upgradeDownloadCompleted=upgradeDownloadCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiWriteIops=iscsiWriteIops, haResourceGroup=haResourceGroup, sensorFailureEvent=sensorFailureEvent, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareQuotaLow=shareQuotaLow, cifsTotalWriteIops=cifsTotalWriteIops, cifsTotalReadMbps=cifsTotalReadMbps, projectDataSizeHigh=projectDataSizeHigh, projectFreeSizeLow=projectFreeSizeLow, lunEntry=lunEntry, volumeDeleteFailed=volumeDeleteFailed, replicationComplete=replicationComplete, iscsiInitiatorEntry=iscsiInitiatorEntry, lunInitiatorGroup=lunInitiatorGroup, properties=properties, poolTotalWriteIops=poolTotalWriteIops, poolTotalReadIops=poolTotalReadIops, tegileConformance=tegileConformance, deleteFolderFailed=deleteFolderFailed, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcInitiatorIndex=fcInitiatorIndex, shareMountPoint=shareMountPoint, cacheTotalReadIops=cacheTotalReadIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, shareCIFSReadMbps=shareCIFSReadMbps, diskDataWriteMbps=diskDataWriteMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, memoryFailure=memoryFailure, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, shareDeletionFailed=shareDeletionFailed, haControllerB_Uptime=haControllerB_Uptime, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiInitiatorName=iscsiInitiatorName, intelliFlashSoftwareDown=intelliFlashSoftwareDown, diskGoneOffline=diskGoneOffline, lunSnapshotSizeLow=lunSnapshotSizeLow, notificationSensorAction=notificationSensorAction, vmwareNFSDatastores=vmwareNFSDatastores, snmpServiceStopFailed=snmpServiceStopFailed, diskIsOnline=diskIsOnline, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTargetReadIops=fcTargetReadIops, shareCIFSWriteMbps=shareCIFSWriteMbps, projectLunCount=projectLunCount, haResourceStatus=haResourceStatus, poolDataSizeLow=poolDataSizeLow, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareNFSWriteIops=shareNFSWriteIops, iscsiTargetAlias=iscsiTargetAlias, poolReadCacheReadMbps=poolReadCacheReadMbps, aclMigrationCompleted=aclMigrationCompleted, poolUsedSizeLow=poolUsedSizeLow, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolProjectCount=poolProjectCount, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, projectCreatedSuccessfully=projectCreatedSuccessfully, notificationEventCode=notificationEventCode, poolMetaReadIops=poolMetaReadIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, snapshotRollbackCompleted=snapshotRollbackCompleted, ipmiMemory=ipmiMemory, projectQuotaSizeHigh=projectQuotaSizeHigh, diagnosticDataUploaded=diagnosticDataUploaded, PYSNMP_MODULE_ID=tegile, network=network, cacheTotalWriteMbps=cacheTotalWriteMbps, iscsiTargetsTable=iscsiTargetsTable, alertsCleanupCompleted=alertsCleanupCompleted, cifsTotalReadIops=cifsTotalReadIops, notificationTargetEntityName=notificationTargetEntityName, shareName=shareName, haResourceActiveNode=haResourceActiveNode, networkIpmpGroupUp=networkIpmpGroupUp, tegile=tegile, tegileCompliances=tegileCompliances, nicIndex=nicIndex, shareCompressedRatio=shareCompressedRatio, poolAvgReadLatency=poolAvgReadLatency, snapshotDeleteFailed=snapshotDeleteFailed, poolDataWriteIops=poolDataWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, projectSnapshotSizeLow=projectSnapshotSizeLow, diskDataReadMbps=diskDataReadMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolSizeLow=poolSizeLow, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, unknownSensorEvent=unknownSensorEvent, lunWriteMbps=lunWriteMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, cacheTotalReadMbps=cacheTotalReadMbps, iscsiProperties=iscsiProperties, haControllerB_Name=haControllerB_Name, nicGroup=nicGroup, snmpServiceStarted=snmpServiceStarted, globalStatistics=globalStatistics, snapshotRollbackFailed=snapshotRollbackFailed, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, diskTotalWriteMbps=diskTotalWriteMbps, replicationFailed=replicationFailed, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, iscsiInitiatorsTable=iscsiInitiatorsTable, webdocsUpgradeFailed=webdocsUpgradeFailed, poolProjects=poolProjects, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiTargetName=iscsiTargetName, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, replicationSourceRegistered=replicationSourceRegistered, fcPortOnline=fcPortOnline, controllerUp=controllerUp, networkInterfaceDown=networkInterfaceDown, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareNFSReadMbps=shareNFSReadMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcProperties=fcProperties, haResources=haResources, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, disks=disks, targetGroupMemberRemoved=targetGroupMemberRemoved, targetGroupMemberAdded=targetGroupMemberAdded, projectDeleted=projectDeleted, ipmiVoltage=ipmiVoltage, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunReservedSizeLow=lunReservedSizeLow, snapshotCloningFailed=snapshotCloningFailed, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, notificationObjects=notificationObjects, shareCIFSWriteLatency=shareCIFSWriteLatency, fcTargetIndex=fcTargetIndex, pools=pools, diskError=diskError, haResourcesTable=haResourcesTable, ipmiOther=ipmiOther, lunCompressedRatio=lunCompressedRatio, shareTable=shareTable, haResourceIndex=haResourceIndex, diskSizeLow=diskSizeLow, haControllerA_Name=haControllerA_Name, cifsTotalWriteMbps=cifsTotalWriteMbps, lunProtocol=lunProtocol, nvdimmFailDeviceError=nvdimmFailDeviceError, projectEntry=projectEntry, diskIndex=diskIndex, diskDataReadIops=diskDataReadIops, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, diskPoolName=diskPoolName, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunReadIops=lunReadIops, notificationTime=notificationTime, haControllerB_IPAddr=haControllerB_IPAddr, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolTable=poolTable, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolMetaWriteIops=poolMetaWriteIops, cacheTotalWriteIops=cacheTotalWriteIops, poolMetaWriteMbps=poolMetaWriteMbps, iscsiTargetAuth=iscsiTargetAuth, shareDedupEnabled=shareDedupEnabled, webdocsUpgradeCompleted=webdocsUpgradeCompleted, sanProperties=sanProperties, currentObjectGroup=currentObjectGroup, shareCompressionEnabled=shareCompressionEnabled, poolFreeSizeHigh=poolFreeSizeHigh, lunTable=lunTable, nfsTotalReadMbps=nfsTotalReadMbps, projectQuotaFinished=projectQuotaFinished, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted)
