...
# Produced by pysmi-1.1.3 at Tue Nov 30 13:54:20 2021
...
Unsigned32, iso, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, TimeTicks, ObjectIdentity, MibIdentifier, Counter32, Integer32, enterprises, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Counter32", "Integer32", "enterprises", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareProjectName=shareProjectName, lunReservedSizeHigh=lunReservedSizeHigh, maintenanceModeDisabled=maintenanceModeDisabled, poolDataSizeLow=poolDataSizeLow, lunDataSizeLow=lunDataSizeLow, shareEntry=shareEntry, fcPortOnline=fcPortOnline, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolReadCacheReadIops=poolReadCacheReadIops, nfsTotalReadIops=nfsTotalReadIops, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, shareNFSReadMbps=shareNFSReadMbps, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, lunProtocol=lunProtocol, projectIndex=projectIndex, diskAvgReadLatency=diskAvgReadLatency, poolDeletionFailed=poolDeletionFailed, poolExpanded=poolExpanded, smisServiceStartFailed=smisServiceStartFailed, iscsiTotalReadMbps=iscsiTotalReadMbps, controllerTimeDrift=controllerTimeDrift, lunIndex=lunIndex, controllerDown=controllerDown, diskIsOnline=diskIsOnline, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareDataSizeLow=shareDataSizeLow, fcTargetEntry=fcTargetEntry, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolAvgWriteLatency=poolAvgWriteLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, snapshotDeleteFailed=snapshotDeleteFailed, diskGoneOffline=diskGoneOffline, upgradeDownloadCompleted=upgradeDownloadCompleted, lunFreeSizeHigh=lunFreeSizeHigh, notificationComponentName=notificationComponentName, projectName=projectName, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, nvdimmFailSoftError=nvdimmFailSoftError, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolTotalReadIops=poolTotalReadIops, haResourcesTable=haResourcesTable, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, haControllerB_Name=haControllerB_Name, lunDedupEnabled=lunDedupEnabled, tegileConformance=tegileConformance, maintenanceModeEnabled=maintenanceModeEnabled, tegileCompliances=tegileCompliances, iscsiTargetError=iscsiTargetError, fcProperties=fcProperties, diskSizeHigh=diskSizeHigh, nvdimmFailInitializationError=nvdimmFailInitializationError, poolTotalWriteMbps=poolTotalWriteMbps, PYSNMP_MODULE_ID=tegile, lunDataSizeHigh=lunDataSizeHigh, lunSizeLow=lunSizeLow, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectDedupEnabled=projectDedupEnabled, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, cacheTotalReadIops=cacheTotalReadIops, ipmiOther=ipmiOther, targetGroupMemberRemoved=targetGroupMemberRemoved, nicName=nicName, networkInterfaceDown=networkInterfaceDown, sensorFailureEvent=sensorFailureEvent, haControllerB_Uptime=haControllerB_Uptime, poolUsedSizeLow=poolUsedSizeLow, diskTable=diskTable, upgradeStarted=upgradeStarted, diskAlias=diskAlias, currentObjectGroup=currentObjectGroup, nicMTU=nicMTU, cacheRAMReads=cacheRAMReads, iscsiInitiatorIndex=iscsiInitiatorIndex, volumeModifyCompleted=volumeModifyCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, fcTargetStatus=fcTargetStatus, notifications=notifications, haResourceGroup=haResourceGroup, aclMigrationCompleted=aclMigrationCompleted, cifsTotalReadIops=cifsTotalReadIops, poolImported=poolImported, projectShares=projectShares, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, diskRandomIOCount=diskRandomIOCount, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, fcInitiatorIndex=fcInitiatorIndex, projectDeleted=projectDeleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, replicationComplete=replicationComplete, alertsCleanupCompleted=alertsCleanupCompleted, snmpServiceStarted=snmpServiceStarted, poolSizeHigh=poolSizeHigh, lunCompressionEnabled=lunCompressionEnabled, projectDataSizeHigh=projectDataSizeHigh, lunCompressedRatio=lunCompressedRatio, shareCIFSReadIops=shareCIFSReadIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, disks=disks, webdocsUpgradeCompleted=webdocsUpgradeCompleted, lunReservedSizeLow=lunReservedSizeLow, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, lunReadMbps=lunReadMbps, notificationProps=notificationProps, haResourceIndex=haResourceIndex, iscsiTargetIndex=iscsiTargetIndex, lunTargetGroup=lunTargetGroup, projectQuotaFinished=projectQuotaFinished, tegileArray=tegileArray, cifsTotalWriteMbps=cifsTotalWriteMbps, snmpServiceStopped=snmpServiceStopped, projectModified=projectModified, poolIndex=poolIndex, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiTargetsTable=iscsiTargetsTable, shareDedupEnabled=shareDedupEnabled, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, properties=properties, projectCreatedSuccessfully=projectCreatedSuccessfully, userLoginFailed=userLoginFailed, poolUsedSizeHigh=poolUsedSizeHigh, shareNFSReadLatency=shareNFSReadLatency, cacheTotalWriteIops=cacheTotalWriteIops, fcAvgReadLatency=fcAvgReadLatency, networkIpmpGroupDown=networkIpmpGroupDown, iscsiTargetGroupError=iscsiTargetGroupError, poolFreeSizeLow=poolFreeSizeLow, fcTargetWriteLatency=fcTargetWriteLatency, fcInitiatorsTable=fcInitiatorsTable, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, fcTotalWriteIops=fcTotalWriteIops, shareReservedSizeLow=shareReservedSizeLow, cpuTotalUsage=cpuTotalUsage, projectQuotaSizeHigh=projectQuotaSizeHigh, shareCIFSReadLatency=shareCIFSReadLatency, nicState=nicState, fcPortOffline=fcPortOffline, upgradeDownloadFailed=upgradeDownloadFailed, poolProjectCount=poolProjectCount, poolDataReadMbps=poolDataReadMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, haControllerA_IPAddr=haControllerA_IPAddr, cacheTotalReadMbps=cacheTotalReadMbps, diskDataReadIops=diskDataReadIops, cpuSystemCalls=cpuSystemCalls, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, fcTotalWriteMbps=fcTotalWriteMbps, fcInitiatorEntry=fcInitiatorEntry, iscsiInitiatorName=iscsiInitiatorName, shareSnapshotSizeLow=shareSnapshotSizeLow, tegileArray_notifications=tegileArray_notifications, vmwareNFSDatastores=vmwareNFSDatastores, aclMigrationStarted=aclMigrationStarted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, ntpServerTimeDrift=ntpServerTimeDrift, shareCreatedSuccessfully=shareCreatedSuccessfully, upgradeTimeout=upgradeTimeout, diskState=diskState, targetGroupCreateCompleted=targetGroupCreateCompleted, projectPoolName=projectPoolName, nicTable=nicTable, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, currentNotificationGroup=currentNotificationGroup, projectTotalSaving=projectTotalSaving, networkIpmpGroupUp=networkIpmpGroupUp, cacheSSDReads=cacheSSDReads, initiatorGroupMemberAdded=initiatorGroupMemberAdded, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiTargetAlias=iscsiTargetAlias, fcTargetWriteMbps=fcTargetWriteMbps, snapshotCloneCompleted=snapshotCloneCompleted, lunReadIops=lunReadIops, ipmiMemory=ipmiMemory, haResourceDescription=haResourceDescription, poolAvgReadLatency=poolAvgReadLatency, shareQuotaFinished=shareQuotaFinished, nfsTotalWriteIops=nfsTotalWriteIops, shareCompressionEnabled=shareCompressionEnabled, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, notificationReadingUnit=notificationReadingUnit, snmpServiceStartFailed=snmpServiceStartFailed, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargetsTable=fcTargetsTable, diskDataWriteIops=diskDataWriteIops, fcTargetIndex=fcTargetIndex, poolCount=poolCount, lunWriteLatency=lunWriteLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, testNotification=testNotification, smisServiceStopped=smisServiceStopped, iscsiWriteIops=iscsiWriteIops, tdpsUpgradeTimeout=tdpsUpgradeTimeout, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolEntry=poolEntry, poolReadCacheReadLatency=poolReadCacheReadLatency, smisServiceStarted=smisServiceStarted, notificationEventCode=notificationEventCode, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcTotalReadIops=fcTotalReadIops, shareNFSWriteMbps=shareNFSWriteMbps, haResourceEntry=haResourceEntry, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolReadCacheWriteIops=poolReadCacheWriteIops, fcTargetGroup=fcTargetGroup, iscsiTargetGroup=iscsiTargetGroup, haControllerB_IPAddr=haControllerB_IPAddr, lunReadLatency=lunReadLatency, notificationSensorSuspect=notificationSensorSuspect, fcInitiatorGroup=fcInitiatorGroup, haResourceName=haResourceName, poolProjects=poolProjects, iscsiTargets=iscsiTargets, fcTargetName=fcTargetName, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, upgradeCompleted=upgradeCompleted, shareQuotaLow=shareQuotaLow, iscsiInitiatorEntry=iscsiInitiatorEntry, poolMetaReadLatency=poolMetaReadLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolOwnerController=poolOwnerController, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, controllerHardwareModel=controllerHardwareModel, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, volumeQuotaFinished=volumeQuotaFinished, tegileGroups=tegileGroups, lunSizeHigh=lunSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, shareQuotaHigh=shareQuotaHigh, replicationStarted=replicationStarted, iscsiInitiators=iscsiInitiators, shareIndex=shareIndex, poolReadCacheWriteLatency=poolReadCacheWriteLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, poolMetaReadMbps=poolMetaReadMbps, nicTransmitMbps=nicTransmitMbps, poolName=poolName, netbiosSocketFailure=netbiosSocketFailure, ipmiVoltage=ipmiVoltage, diskPoolName=diskPoolName, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, spareDiskReplaced=spareDiskReplaced, replicationSourceRegistered=replicationSourceRegistered, replicationTargetDeleted=replicationTargetDeleted, projectShareCount=projectShareCount, fcInitiatorName=fcInitiatorName, notificationObjects=notificationObjects, fcTargetWriteIops=fcTargetWriteIops, smisServiceStopFailed=smisServiceStopFailed, diskType=diskType, poolDegraded=poolDegraded, iscsiTargetReadIops=iscsiTargetReadIops)
mibBuilder.exportSymbols("TEGILE-MIB", poolExported=poolExported, fcTargetModifyCompleted=fcTargetModifyCompleted, poolDataReadLatency=poolDataReadLatency, shareMountPoint=shareMountPoint, volumeDeleteFailed=volumeDeleteFailed, shareNFSWriteIops=shareNFSWriteIops, snmpServiceStopFailed=snmpServiceStopFailed, haResourceStatus=haResourceStatus, iscsiProperties=iscsiProperties, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiTargetWriteMbps=iscsiTargetWriteMbps, basicCompliance=basicCompliance, projectSnapshotSizeLow=projectSnapshotSizeLow, lunBlockSize=lunBlockSize, shareCIFSWriteLatency=shareCIFSWriteLatency, shareDataSizeHigh=shareDataSizeHigh, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, shareTable=shareTable, iscsiTotalReadIops=iscsiTotalReadIops, poolTotalWriteIops=poolTotalWriteIops, shareExceedThresholdWarning=shareExceedThresholdWarning, deleteFolderCompleted=deleteFolderCompleted, projectFreeSizeLow=projectFreeSizeLow, notificationSeverity=notificationSeverity, poolDataWriteIops=poolDataWriteIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareDeletionFailed=shareDeletionFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolTotalReadMbps=poolTotalReadMbps, notificationTargetEntityName=notificationTargetEntityName, projectTable=projectTable, projectCompressionEnabled=projectCompressionEnabled, projectDeletionFailed=projectDeletionFailed, diagnosticDataUploaded=diagnosticDataUploaded, diskError=diskError, projectThresholdExceedWarning=projectThresholdExceedWarning, lunWriteIops=lunWriteIops, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, poolMetaWriteIops=poolMetaWriteIops, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, lunName=lunName, replicationResumed=replicationResumed, snapshotCloningFailed=snapshotCloningFailed, iscsiTargetAuth=iscsiTargetAuth, shareCIFSWriteIops=shareCIFSWriteIops, iscsiAvgReadLatency=iscsiAvgReadLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, shareDeleted=shareDeleted, webdocsUpgradeFailed=webdocsUpgradeFailed, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolDataWriteMbps=poolDataWriteMbps, iscsiTargetName=iscsiTargetName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, shareCIFSEnabled=shareCIFSEnabled, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, replicationPaused=replicationPaused, cifsAvgWriteLatency=cifsAvgWriteLatency, cpuInterrupts=cpuInterrupts, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, poolTotalSaving=poolTotalSaving, shareNFSEnabled=shareNFSEnabled, diskChassisIdx=diskChassisIdx, poolQuotaFinished=poolQuotaFinished, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, snapshotRollbackCompleted=snapshotRollbackCompleted, diskTotalReadIops=diskTotalReadIops, diskSizeLow=diskSizeLow, haResourceActiveNode=haResourceActiveNode, projectDataSizeLow=projectDataSizeLow, projectLunCount=projectLunCount, diskTotalReadMbps=diskTotalReadMbps, diskTotalWriteIops=diskTotalWriteIops, fcTargets=fcTargets, haControllerA_Name=haControllerA_Name, fcAvgWriteLatency=fcAvgWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, lunPoolName=lunPoolName, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, sanProperties=sanProperties, snapshotCreationFailed=snapshotCreationFailed, diskCount=diskCount, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunInitiatorGroup=lunInitiatorGroup, memoryFailure=memoryFailure, shareCIFSWriteMbps=shareCIFSWriteMbps, diskSequentialIOCount=diskSequentialIOCount, replicationFailed=replicationFailed, networkTotalReceiveMbps=networkTotalReceiveMbps, ipmiPowerSupply=ipmiPowerSupply, tegile=tegile, fcTargetReadIops=fcTargetReadIops, poolMetaWriteMbps=poolMetaWriteMbps, adServerTimeDrift=adServerTimeDrift, poolFreeSizeHigh=poolFreeSizeHigh, notificationSensorNumber=notificationSensorNumber, haControllerA_Uptime=haControllerA_Uptime, lunSnapshotSizeLow=lunSnapshotSizeLow, diskDataWriteMbps=diskDataWriteMbps, cifsTotalWriteIops=cifsTotalWriteIops, sharePoolName=sharePoolName, targetGroupMemberAdded=targetGroupMemberAdded, diskIndex=diskIndex, notificationTime=notificationTime, notificationSensorAction=notificationSensorAction, poolTable=poolTable, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, deleteFolderFailed=deleteFolderFailed, lunTable=lunTable, lunEntry=lunEntry, poolDataReadIops=poolDataReadIops, nicEntry=nicEntry, poolMetaWriteLatency=poolMetaWriteLatency, iscsiInitiatorChapUser=iscsiInitiatorChapUser, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcInitiators=fcInitiators, notificationDescription=notificationDescription, iscsiTargetWriteLatency=iscsiTargetWriteLatency, projectFreeSizeHigh=projectFreeSizeHigh, iscsiInitiatorGroup=iscsiInitiatorGroup, poolUpgraded=poolUpgraded, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, nicReceiveMbps=nicReceiveMbps, diskAvgWriteLatency=diskAvgWriteLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, nicGroup=nicGroup, nfsAvgReadLatency=nfsAvgReadLatency, diskDataReadMbps=diskDataReadMbps, poolMetaReadIops=poolMetaReadIops, globalStatistics=globalStatistics, lunGUID=lunGUID, diskTotalWriteMbps=diskTotalWriteMbps, upgradeFailed=upgradeFailed, poolCreated=poolCreated, smbSocketFailure=smbSocketFailure, cacheTotalWriteMbps=cacheTotalWriteMbps, lunFreeSizeLow=lunFreeSizeLow, volumeCreatedSuccessfully=volumeCreatedSuccessfully, iscsiImproperTargetGroup=iscsiImproperTargetGroup, replicationAborted=replicationAborted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareReservedSizeHigh=shareReservedSizeHigh, poolSizeLow=poolSizeLow, shareNFSReadIops=shareNFSReadIops, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, unknownSensorEvent=unknownSensorEvent, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareNFSWriteLatency=shareNFSWriteLatency, nicIndex=nicIndex, projectLUNs=projectLUNs, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, ipmiThreshold=ipmiThreshold, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, nvdimmFailDeviceError=nvdimmFailDeviceError, snmpAgentVersion=snmpAgentVersion, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, upgradeDownloadStarted=upgradeDownloadStarted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiTargetReadMbps=iscsiTargetReadMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, cifsTotalReadMbps=cifsTotalReadMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, diskEntry=diskEntry, poolDataWriteLatency=poolDataWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, projectEntry=projectEntry, lunProjectName=lunProjectName, iscsiAvgWriteLatency=iscsiAvgWriteLatency, pools=pools, poolDeleted=poolDeleted, ipmiFan=ipmiFan, fcTotalReadMbps=fcTotalReadMbps, volumeDeleteCompleted=volumeDeleteCompleted, networkInterfaceUp=networkInterfaceUp, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskIOCount=diskIOCount, cifsAvgReadLatency=cifsAvgReadLatency, ipmiCurrent=ipmiCurrent, poolHealth=poolHealth, nfsTotalReadMbps=nfsTotalReadMbps, snapshotRollbackFailed=snapshotRollbackFailed, network=network, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcTargetReadMbps=fcTargetReadMbps, fcTargetReadLatency=fcTargetReadLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolDataSizeHigh=poolDataSizeHigh, controllerUp=controllerUp, poolState=poolState, shareName=shareName, projectQuotaSizeLow=projectQuotaSizeLow, ipmiTemperature=ipmiTemperature, haResources=haResources, iscsiTargetEntry=iscsiTargetEntry, replicationAbandoned=replicationAbandoned, poolReadCacheWriteMbps=poolReadCacheWriteMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, shareCompressedRatio=shareCompressedRatio, diskSlowIo=diskSlowIo, nfsTotalWriteMbps=nfsTotalWriteMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, lunWriteMbps=lunWriteMbps)
