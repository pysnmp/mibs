...
Bits, MibIdentifier, Counter32, ModuleIdentity, Unsigned32, enterprises, Integer32, Gauge32, NotificationType, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Counter32", "ModuleIdentity", "Unsigned32", "enterprises", "Integer32", "Gauge32", "NotificationType", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareNFSWriteLatency=shareNFSWriteLatency, notificationObjects=notificationObjects, projectCreatedSuccessfully=projectCreatedSuccessfully, diskTotalReadMbps=diskTotalReadMbps, tegileArray=tegileArray, testNotification=testNotification, poolQuotaFinished=poolQuotaFinished, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, projectQuotaFinished=projectQuotaFinished, volumeQuotaFinished=volumeQuotaFinished, haControllerA_Name=haControllerA_Name, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareNFSWriteMbps=shareNFSWriteMbps, lunTable=lunTable, lunSnapshotSizeLow=lunSnapshotSizeLow, diskGoneOffline=diskGoneOffline, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, replicationAbandoned=replicationAbandoned, poolTotalWriteMbps=poolTotalWriteMbps, fcAvgWriteLatency=fcAvgWriteLatency, shareDedupEnabled=shareDedupEnabled, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunGUID=lunGUID, ipmiOther=ipmiOther, lunSizeLow=lunSizeLow, controllerDown=controllerDown, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectDedupEnabled=projectDedupEnabled, controllerHardwareModel=controllerHardwareModel, fcInitiatorEntry=fcInitiatorEntry, aclMigrationCompleted=aclMigrationCompleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunReservedSizeLow=lunReservedSizeLow, poolFreeSizeLow=poolFreeSizeLow, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTargetReadIops=iscsiTargetReadIops, diagnosticDataUploaded=diagnosticDataUploaded, poolUsedSizeLow=poolUsedSizeLow, targetGroupCreateCompleted=targetGroupCreateCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, haControllerA_Uptime=haControllerA_Uptime, networkInterfaceDown=networkInterfaceDown, lunWriteLatency=lunWriteLatency, diskType=diskType, poolTotalReadIops=poolTotalReadIops, diskTotalWriteIops=diskTotalWriteIops, projectLUNs=projectLUNs, lunBlockSize=lunBlockSize, targetGroupDeleteCompleted=targetGroupDeleteCompleted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snmpServiceStopped=snmpServiceStopped, lunProtocol=lunProtocol, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, networkInterfaceUp=networkInterfaceUp, nfsTotalReadIops=nfsTotalReadIops, tegileCompliances=tegileCompliances, cifsAvgReadLatency=cifsAvgReadLatency, netbiosSocketFailure=netbiosSocketFailure, fcInitiators=fcInitiators, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolMetaReadIops=poolMetaReadIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, projectDataSizeLow=projectDataSizeLow, webdocsUpgradeFailed=webdocsUpgradeFailed, cacheTotalReadMbps=cacheTotalReadMbps, iscsiWriteIops=iscsiWriteIops, upgradeCompleted=upgradeCompleted, diskSizeLow=diskSizeLow, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolExported=poolExported, shareCIFSWriteIops=shareCIFSWriteIops, poolMetaWriteIops=poolMetaWriteIops, currentObjectGroup=currentObjectGroup, replicationComplete=replicationComplete, volumeDeleteFailed=volumeDeleteFailed, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunReadMbps=lunReadMbps, shareCIFSReadIops=shareCIFSReadIops, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, tegileConformance=tegileConformance, cpuTotalUsage=cpuTotalUsage, initiatorGroupMemberAdded=initiatorGroupMemberAdded, notifications=notifications, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, nvdimmFailUnknownError=nvdimmFailUnknownError, diskAvgWriteLatency=diskAvgWriteLatency, projectModified=projectModified, iscsiTotalReadMbps=iscsiTotalReadMbps, fcTargetStatus=fcTargetStatus, nfsTotalWriteMbps=nfsTotalWriteMbps, shareCIFSReadMbps=shareCIFSReadMbps, projectFreeSizeLow=projectFreeSizeLow, poolDataSizeHigh=poolDataSizeHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, cifsTotalWriteMbps=cifsTotalWriteMbps, notificationTargetEntityName=notificationTargetEntityName, lunFreeSizeLow=lunFreeSizeLow, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareIndex=shareIndex, fcTargetModifyCompleted=fcTargetModifyCompleted, haResourceDescription=haResourceDescription, haResourcesTable=haResourcesTable, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, cacheTotalReadIops=cacheTotalReadIops, iscsiTotalReadIops=iscsiTotalReadIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, diskRandomIOCount=diskRandomIOCount, snapshotCloneCompleted=snapshotCloneCompleted, notificationSensorNumber=notificationSensorNumber, diskDataWriteIops=diskDataWriteIops, diskAlias=diskAlias, lunReservedSizeHigh=lunReservedSizeHigh, sensorFailureEvent=sensorFailureEvent, poolWriteCacheWriteIops=poolWriteCacheWriteIops, smisServiceStartFailed=smisServiceStartFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskTotalWriteMbps=diskTotalWriteMbps, cifsAvgWriteLatency=cifsAvgWriteLatency, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, sanProperties=sanProperties, disks=disks, cifsTotalReadMbps=cifsTotalReadMbps, poolDeletionFailed=poolDeletionFailed, lunReadLatency=lunReadLatency, projectShareCount=projectShareCount, shareDataSizeHigh=shareDataSizeHigh, snapshotCreationFailed=snapshotCreationFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, poolAvgReadLatency=poolAvgReadLatency, smisServiceStarted=smisServiceStarted, nvdimmFailSoftError=nvdimmFailSoftError, ipmiMemory=ipmiMemory, lunCompressionEnabled=lunCompressionEnabled, smisServiceStopped=smisServiceStopped, iscsiTargetEntry=iscsiTargetEntry, lunDataSizeHigh=lunDataSizeHigh, fcTotalWriteIops=fcTotalWriteIops, iscsiTargetGroup=iscsiTargetGroup, ipmiVoltage=ipmiVoltage, pools=pools, poolExpanded=poolExpanded, properties=properties, diskSizeHigh=diskSizeHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, userLoginFailed=userLoginFailed, cpuSystemCalls=cpuSystemCalls, diskAvgReadLatency=diskAvgReadLatency, lunInitiatorGroup=lunInitiatorGroup, targetGroupMemberRemoved=targetGroupMemberRemoved, projectName=projectName, replicationSourceRegistered=replicationSourceRegistered, nvdimmFailDeviceError=nvdimmFailDeviceError, nicTransmitMbps=nicTransmitMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareQuotaHigh=shareQuotaHigh, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, poolReadCacheReadIops=poolReadCacheReadIops, poolImported=poolImported, shareEntry=shareEntry, poolDataReadLatency=poolDataReadLatency, notificationSeverity=notificationSeverity, memoryFailure=memoryFailure, poolCreated=poolCreated, fcTargetReadLatency=fcTargetReadLatency, fcInitiatorGroup=fcInitiatorGroup, notificationTime=notificationTime, nicIndex=nicIndex, ipmiCurrent=ipmiCurrent, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, diskState=diskState, poolDataWriteLatency=poolDataWriteLatency, notificationSensorAction=notificationSensorAction, projectDataSizeHigh=projectDataSizeHigh, tegileArray_notifications=tegileArray_notifications, shareProjectName=shareProjectName, fcPortOnline=fcPortOnline, upgradeDownloadFailed=upgradeDownloadFailed, replicationStarted=replicationStarted, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareSnapshotSizeHigh=shareSnapshotSizeHigh, lunReadIops=lunReadIops, nicState=nicState, poolDataWriteIops=poolDataWriteIops, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolState=poolState, poolTotalReadMbps=poolTotalReadMbps, notificationProps=notificationProps, ipmiThreshold=ipmiThreshold, shareCompressionEnabled=shareCompressionEnabled, iscsiAvgWriteLatency=iscsiAvgWriteLatency, iscsiTargetsTable=iscsiTargetsTable, iscsiTargetError=iscsiTargetError, poolMetaWriteMbps=poolMetaWriteMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, fcTargetReadIops=fcTargetReadIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, volumeCreatedSuccessfully=volumeCreatedSuccessfully, lunCompressedRatio=lunCompressedRatio, fcTargetName=fcTargetName, projectSnapshotSizeLow=projectSnapshotSizeLow, poolUpgraded=poolUpgraded, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectIndex=projectIndex, snmpServiceStartFailed=snmpServiceStartFailed, diskCount=diskCount, fcTargetWriteLatency=fcTargetWriteLatency, ipmiTemperature=ipmiTemperature, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunEntry=lunEntry, nicName=nicName, fcTargets=fcTargets, nfsTotalWriteIops=nfsTotalWriteIops, nvdimmFailInitializationError=nvdimmFailInitializationError, ipmiFan=ipmiFan, tegileGroups=tegileGroups, notificationEventCode=notificationEventCode, volumeDeleteCompleted=volumeDeleteCompleted, iscsiTargets=iscsiTargets, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, diskIOCount=diskIOCount, haControllerB_Name=haControllerB_Name, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, projectQuotaSizeLow=projectQuotaSizeLow, globalStatistics=globalStatistics, cacheTotalWriteMbps=cacheTotalWriteMbps, fcTargetReadMbps=fcTargetReadMbps, shareCIFSWriteLatency=shareCIFSWriteLatency, nicEntry=nicEntry, poolDegraded=poolDegraded, aclMigrationStarted=aclMigrationStarted, lunName=lunName, iscsiInitiatorName=iscsiInitiatorName, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolMetaReadMbps=poolMetaReadMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, replicationFailed=replicationFailed, snapshotDeleteFailed=snapshotDeleteFailed, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, replicationTargetDeleted=replicationTargetDeleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, haResources=haResources, poolFreeSizeHigh=poolFreeSizeHigh, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcInitiatorName=fcInitiatorName, fcAvgReadLatency=fcAvgReadLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, projectFreeSizeHigh=projectFreeSizeHigh, lunSizeHigh=lunSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, upgradeStarted=upgradeStarted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, haControllerA_IPAddr=haControllerA_IPAddr)
mibBuilder.exportSymbols("TEGILE-MIB", cifsTotalReadIops=cifsTotalReadIops, snmpServiceStopFailed=snmpServiceStopFailed, haResourceGroup=haResourceGroup, notificationReadingTriggerValue=notificationReadingTriggerValue, iscsiTargetAuth=iscsiTargetAuth, shareNFSEnabled=shareNFSEnabled, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, replicationAborted=replicationAborted, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, upgradeTimeout=upgradeTimeout, iscsiInitiators=iscsiInitiators, fcTargetsTable=fcTargetsTable, projectTotalSaving=projectTotalSaving, nicTable=nicTable, projectQuotaSizeHigh=projectQuotaSizeHigh, sharePoolName=sharePoolName, poolHealth=poolHealth, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, haResourceStatus=haResourceStatus, poolTotalWriteIops=poolTotalWriteIops, shareNFSReadMbps=shareNFSReadMbps, shareReservedSizeHigh=shareReservedSizeHigh, alertsCleanupCompleted=alertsCleanupCompleted, shareNFSWriteIops=shareNFSWriteIops, haResourceActiveNode=haResourceActiveNode, iscsiTargetName=iscsiTargetName, volumeModifyCompleted=volumeModifyCompleted, snapshotRollbackFailed=snapshotRollbackFailed, diskError=diskError, lunFreeSizeHigh=lunFreeSizeHigh, projectEntry=projectEntry, iscsiTargetWriteIops=iscsiTargetWriteIops, iscsiInitiatorIndex=iscsiInitiatorIndex, poolProjectCount=poolProjectCount, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiImproperTargetGroup=iscsiImproperTargetGroup, snapshotCloningFailed=snapshotCloningFailed, notificationComponentName=notificationComponentName, snmpServiceStarted=snmpServiceStarted, upgradeFailed=upgradeFailed, smisServiceStopFailed=smisServiceStopFailed, unknownSensorEvent=unknownSensorEvent, intelliFlashSoftwareUp=intelliFlashSoftwareUp, nicGroup=nicGroup, replicationPaused=replicationPaused, cifsTotalWriteIops=cifsTotalWriteIops, nicMTU=nicMTU, shareExceedThresholdWarning=shareExceedThresholdWarning, replicationResumed=replicationResumed, maintenanceModeEnabled=maintenanceModeEnabled, smbSocketFailure=smbSocketFailure, poolIndex=poolIndex, shareDataSizeLow=shareDataSizeLow, haResourceName=haResourceName, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, diskTotalReadIops=diskTotalReadIops, diskDataReadIops=diskDataReadIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, diskChassisIdx=diskChassisIdx, adServerTimeDrift=adServerTimeDrift, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, ntpServerTimeDrift=ntpServerTimeDrift, projectPoolName=projectPoolName, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, diskPoolName=diskPoolName, poolMetaReadLatency=poolMetaReadLatency, spareDiskReplaced=spareDiskReplaced, projectThresholdExceedWarning=projectThresholdExceedWarning, shareCompressedRatio=shareCompressedRatio, poolName=poolName, poolReadCacheReadMbps=poolReadCacheReadMbps, projectTable=projectTable, lunProjectName=lunProjectName, deleteFolderFailed=deleteFolderFailed, lunWriteIops=lunWriteIops, diskDataReadMbps=diskDataReadMbps, controllerUp=controllerUp, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, fcPortOffline=fcPortOffline, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolProjects=poolProjects, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, notificationDescription=notificationDescription, diskSlowIo=diskSlowIo, upgradeDownloadCompleted=upgradeDownloadCompleted, notificationReadingUnit=notificationReadingUnit, iscsiInitiatorsTable=iscsiInitiatorsTable, diskSequentialIOCount=diskSequentialIOCount, shareCIFSEnabled=shareCIFSEnabled, deleteFolderCompleted=deleteFolderCompleted, ipmiPowerSupply=ipmiPowerSupply, diskIndex=diskIndex, shareNFSReadIops=shareNFSReadIops, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, diskTable=diskTable, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectCompressionEnabled=projectCompressionEnabled, fcTargetGroup=fcTargetGroup, shareTable=shareTable, notificationSensorSuspect=notificationSensorSuspect, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolMetaWriteLatency=poolMetaWriteLatency, nfsTotalReadMbps=nfsTotalReadMbps, diskIsOnline=diskIsOnline, lunIndex=lunIndex, network=network, poolSizeHigh=poolSizeHigh, projectShares=projectShares, projectDeletionFailed=projectDeletionFailed, shareDeleted=shareDeleted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, upgradeDownloadStarted=upgradeDownloadStarted, targetGroupMemberAdded=targetGroupMemberAdded, poolDataSizeLow=poolDataSizeLow, fcTotalReadIops=fcTotalReadIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunDataSizeLow=lunDataSizeLow, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareReservedSizeLow=shareReservedSizeLow, poolDataReadIops=poolDataReadIops, lunTargetGroup=lunTargetGroup, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, maintenanceModeDisabled=maintenanceModeDisabled, poolDeleted=poolDeleted, controllerTimeDrift=controllerTimeDrift, tegile=tegile, cacheRAMReads=cacheRAMReads, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, haResourceEntry=haResourceEntry, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcTotalWriteMbps=fcTotalWriteMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcInitiatorIndex=fcInitiatorIndex, fcTotalReadMbps=fcTotalReadMbps, diskEntry=diskEntry, iscsiTargetAlias=iscsiTargetAlias, lunPoolName=lunPoolName, PYSNMP_MODULE_ID=tegile, currentNotificationGroup=currentNotificationGroup, iscsiInitiatorGroup=iscsiInitiatorGroup, shareCIFSWriteMbps=shareCIFSWriteMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, poolDataWriteMbps=poolDataWriteMbps, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiInitiatorChapUser=iscsiInitiatorChapUser, shareMountPoint=shareMountPoint, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, networkTotalTransmitMbps=networkTotalTransmitMbps, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolDataReadMbps=poolDataReadMbps, shareDeletionFailed=shareDeletionFailed, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, nicReceiveMbps=nicReceiveMbps, poolOwnerController=poolOwnerController, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, snmpAgentVersion=snmpAgentVersion, fcTargetEntry=fcTargetEntry, networkIpmpGroupUp=networkIpmpGroupUp, vmwareNFSDatastores=vmwareNFSDatastores, fcInitiatorCreateFailed=fcInitiatorCreateFailed, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, poolTable=poolTable, shareName=shareName, iscsiProperties=iscsiProperties, fcProperties=fcProperties, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, haResourceIndex=haResourceIndex, cacheTotalWriteIops=cacheTotalWriteIops, lunWriteMbps=lunWriteMbps, lunDedupEnabled=lunDedupEnabled, shareCIFSReadLatency=shareCIFSReadLatency, poolEntry=poolEntry, iscsiTargetIndex=iscsiTargetIndex, projectLunCount=projectLunCount, shareQuotaFinished=shareQuotaFinished, poolUsedSizeHigh=poolUsedSizeHigh, fcInitiatorsTable=fcInitiatorsTable, poolAvgWriteLatency=poolAvgWriteLatency, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, cacheSSDReads=cacheSSDReads, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, basicCompliance=basicCompliance, shareCreatedSuccessfully=shareCreatedSuccessfully, cpuInterrupts=cpuInterrupts, poolCount=poolCount, shareNFSReadLatency=shareNFSReadLatency, shareQuotaLow=shareQuotaLow, iscsiAvgReadLatency=iscsiAvgReadLatency, fcTargetWriteMbps=fcTargetWriteMbps, fcTargetIndex=fcTargetIndex, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiTargetWriteMbps=iscsiTargetWriteMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, haControllerB_Uptime=haControllerB_Uptime, diskDataWriteMbps=diskDataWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, nfsAvgReadLatency=nfsAvgReadLatency, projectDeleted=projectDeleted, haControllerB_IPAddr=haControllerB_IPAddr, iscsiTargetReadLatency=iscsiTargetReadLatency, poolSizeLow=poolSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, fcTargetWriteIops=fcTargetWriteIops, networkIpmpGroupDown=networkIpmpGroupDown, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow)
