...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:08:06 2021
...
Integer32, iso, Unsigned32, Counter64, Gauge32, MibIdentifier, Counter32, enterprises, TimeTicks, ObjectIdentity, ModuleIdentity, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Unsigned32", "Counter64", "Gauge32", "MibIdentifier", "Counter32", "enterprises", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", alertsCleanupCompleted=alertsCleanupCompleted, deleteFolderFailed=deleteFolderFailed, lunSizeLow=lunSizeLow, lunReservedSizeHigh=lunReservedSizeHigh, diskDataWriteMbps=diskDataWriteMbps, nicState=nicState, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, projectQuotaSizeLow=projectQuotaSizeLow, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, nicTable=nicTable, lunDataSizeHigh=lunDataSizeHigh, fcTotalReadMbps=fcTotalReadMbps, projectEntry=projectEntry, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolMetaReadMbps=poolMetaReadMbps, poolProjectCount=poolProjectCount, tdpsUpgradeTimeout=tdpsUpgradeTimeout, diskSizeLow=diskSizeLow, iscsiTargetsTable=iscsiTargetsTable, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskTotalWriteIops=diskTotalWriteIops, haResourceStatus=haResourceStatus, projectCompressionEnabled=projectCompressionEnabled, cpuInterrupts=cpuInterrupts, volumeCreatedSuccessfully=volumeCreatedSuccessfully, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, diskAlias=diskAlias, fcAvgReadLatency=fcAvgReadLatency, replicationFailed=replicationFailed, poolAvgReadLatency=poolAvgReadLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, targetGroupCreateCompleted=targetGroupCreateCompleted, PYSNMP_MODULE_ID=tegile, haControllerB_IPAddr=haControllerB_IPAddr, shareCIFSEnabled=shareCIFSEnabled, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, upgradeCompleted=upgradeCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, projectModified=projectModified, fcTargetReadLatency=fcTargetReadLatency, diskSizeHigh=diskSizeHigh, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, projectLunCount=projectLunCount, diskChassisIdx=diskChassisIdx, maintenanceModeDisabled=maintenanceModeDisabled, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, diskState=diskState, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolState=poolState, nfsTotalWriteMbps=nfsTotalWriteMbps, poolDataSizeHigh=poolDataSizeHigh, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskDataReadMbps=diskDataReadMbps, haResources=haResources, iscsiTotalReadMbps=iscsiTotalReadMbps, fcTargetWriteMbps=fcTargetWriteMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, snmpServiceStopped=snmpServiceStopped, poolOwnerController=poolOwnerController, snapshotCreationFailed=snapshotCreationFailed, fcTargetModifyCompleted=fcTargetModifyCompleted, fcTargetsTable=fcTargetsTable, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, replicationTargetDeleted=replicationTargetDeleted, shareQuotaHigh=shareQuotaHigh, cifsTotalReadIops=cifsTotalReadIops, fcTargetWriteLatency=fcTargetWriteLatency, smisServiceStopFailed=smisServiceStopFailed, networkIpmpGroupUp=networkIpmpGroupUp, nicGroup=nicGroup, haResourcesTable=haResourcesTable, haResourceGroup=haResourceGroup, snapshotCloningFailed=snapshotCloningFailed, nicMTU=nicMTU, aclMigrationStarted=aclMigrationStarted, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, projectCreatedSuccessfully=projectCreatedSuccessfully, ipmiMemory=ipmiMemory, iscsiInitiatorsTable=iscsiInitiatorsTable, shareNFSEnabled=shareNFSEnabled, fcTargetName=fcTargetName, projectDeleted=projectDeleted, shareDedupEnabled=shareDedupEnabled, replicationPaused=replicationPaused, replicationAbandoned=replicationAbandoned, tegileArray=tegileArray, poolCreated=poolCreated, network=network, notificationSensorNumber=notificationSensorNumber, poolFreeSizeLow=poolFreeSizeLow, sanProperties=sanProperties, iscsiTargetAlias=iscsiTargetAlias, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, snapshotCloneCompleted=snapshotCloneCompleted, nvdimmFailSoftError=nvdimmFailSoftError, shareDataSizeLow=shareDataSizeLow, notificationSeverity=notificationSeverity, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolDataWriteLatency=poolDataWriteLatency, poolProjects=poolProjects, lunInitiatorGroup=lunInitiatorGroup, haResourceEntry=haResourceEntry, notificationProps=notificationProps, fcTargetEntry=fcTargetEntry, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, nicReceiveMbps=nicReceiveMbps, disks=disks, projectFreeSizeHigh=projectFreeSizeHigh, diskType=diskType, currentObjectGroup=currentObjectGroup, cacheTotalReadMbps=cacheTotalReadMbps, projectThresholdExceedWarning=projectThresholdExceedWarning, projectDataSizeHigh=projectDataSizeHigh, diskSlowIo=diskSlowIo, cifsTotalWriteMbps=cifsTotalWriteMbps, shareDataSizeHigh=shareDataSizeHigh, lunSnapshotSizeLow=lunSnapshotSizeLow, shareProjectName=shareProjectName, poolMetaWriteIops=poolMetaWriteIops, projectDeletionFailed=projectDeletionFailed, lunFreeSizeLow=lunFreeSizeLow, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, upgradeTimeout=upgradeTimeout, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareCIFSReadIops=shareCIFSReadIops, replicationSourceRegistered=replicationSourceRegistered, diskCount=diskCount, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, unknownSensorEvent=unknownSensorEvent, poolDataSizeLow=poolDataSizeLow, poolReadCacheWriteLatency=poolReadCacheWriteLatency, notifications=notifications, globalStatistics=globalStatistics, diskTotalWriteMbps=diskTotalWriteMbps, iscsiTargetReadLatency=iscsiTargetReadLatency, ipmiCurrent=ipmiCurrent, shareIndex=shareIndex, poolHealth=poolHealth, lunDataSizeLow=lunDataSizeLow, cacheRAMReads=cacheRAMReads, projectQuotaSizeHigh=projectQuotaSizeHigh, fcTargetGroup=fcTargetGroup, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareCompressedRatio=shareCompressedRatio, tegileArray_notifications=tegileArray_notifications, deleteFolderCompleted=deleteFolderCompleted, notificationDescription=notificationDescription, diskDataWriteIops=diskDataWriteIops, poolMetaReadLatency=poolMetaReadLatency, nicEntry=nicEntry, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, replicationComplete=replicationComplete, poolTotalSaving=poolTotalSaving, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, snmpServiceStartFailed=snmpServiceStartFailed, notificationSensorAction=notificationSensorAction, nvdimmFailUnknownError=nvdimmFailUnknownError, volumeDeleteFailed=volumeDeleteFailed, iscsiInitiatorChapUser=iscsiInitiatorChapUser, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunWriteLatency=lunWriteLatency, fcTotalWriteMbps=fcTotalWriteMbps, currentNotificationGroup=currentNotificationGroup, poolMetaReadIops=poolMetaReadIops, lunProjectName=lunProjectName, lunPoolName=lunPoolName, poolReadCacheReadIops=poolReadCacheReadIops, shareDeleted=shareDeleted, ipmiTemperature=ipmiTemperature, fcTargets=fcTargets, shareNFSWriteIops=shareNFSWriteIops, controllerDown=controllerDown, cifsTotalWriteIops=cifsTotalWriteIops, shareCompressionEnabled=shareCompressionEnabled, iscsiTargetReadIops=iscsiTargetReadIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, snapshotRollbackFailed=snapshotRollbackFailed, fcInitiatorsTable=fcInitiatorsTable, fcTargetReadMbps=fcTargetReadMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, nfsTotalReadMbps=nfsTotalReadMbps, iscsiTargets=iscsiTargets, iscsiTargetWriteIops=iscsiTargetWriteIops, diskTotalReadMbps=diskTotalReadMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, notificationThresholdTriggerValue=notificationThresholdTriggerValue, nfsTotalReadIops=nfsTotalReadIops, shareMountPoint=shareMountPoint, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiTargetError=iscsiTargetError, fcTotalWriteIops=fcTotalWriteIops, lunWriteMbps=lunWriteMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolTotalReadMbps=poolTotalReadMbps, poolEntry=poolEntry, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunEntry=lunEntry, iscsiTotalWriteMbps=iscsiTotalWriteMbps, snmpServiceStarted=snmpServiceStarted, haControllerB_Uptime=haControllerB_Uptime, poolName=poolName, diskGoneOffline=diskGoneOffline, poolReadCacheReadLatency=poolReadCacheReadLatency, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolTotalWriteIops=poolTotalWriteIops, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, pools=pools, poolIndex=poolIndex, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, haResourceActiveNode=haResourceActiveNode, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolDataReadMbps=poolDataReadMbps, notificationSensorSuspect=notificationSensorSuspect, poolTotalReadIops=poolTotalReadIops, shareCIFSWriteMbps=shareCIFSWriteMbps, haControllerA_IPAddr=haControllerA_IPAddr, lunReservedSizeLow=lunReservedSizeLow, notificationTargetEntityName=notificationTargetEntityName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunCompressionEnabled=lunCompressionEnabled, poolUsedSizeLow=poolUsedSizeLow, controllerHardwareModel=controllerHardwareModel, snmpServiceStopFailed=snmpServiceStopFailed, shareNFSReadMbps=shareNFSReadMbps, haResourceName=haResourceName, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, lunSizeHigh=lunSizeHigh, notificationComponentName=notificationComponentName, poolExpanded=poolExpanded, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunTable=lunTable, iscsiAvgReadLatency=iscsiAvgReadLatency, poolMetaWriteLatency=poolMetaWriteLatency, maintenanceModeEnabled=maintenanceModeEnabled, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareName=shareName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, projectShares=projectShares, diskIsOnline=diskIsOnline, fcTargetReadIops=fcTargetReadIops, cpuTotalUsage=cpuTotalUsage, fcInitiatorName=fcInitiatorName, projectPoolName=projectPoolName, replicationAborted=replicationAborted, lunDedupEnabled=lunDedupEnabled, volumeQuotaFinished=volumeQuotaFinished)
mibBuilder.exportSymbols("TEGILE-MIB", shareQuotaLow=shareQuotaLow, spareDiskReplaced=spareDiskReplaced, fcProperties=fcProperties, lunFreeSizeHigh=lunFreeSizeHigh, volumeModifyCompleted=volumeModifyCompleted, iscsiTargetGroupError=iscsiTargetGroupError, cpuSystemCalls=cpuSystemCalls, notificationReadingTriggerValue=notificationReadingTriggerValue, properties=properties, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, lunSnapshotSizeHigh=lunSnapshotSizeHigh, snmpAgentVersion=snmpAgentVersion, iscsiInitiatorIndex=iscsiInitiatorIndex, diagnosticDataUploaded=diagnosticDataUploaded, tegileConformance=tegileConformance, poolAvgWriteLatency=poolAvgWriteLatency, diskEntry=diskEntry, upgradeDownloadStarted=upgradeDownloadStarted, projectQuotaFinished=projectQuotaFinished, iscsiTargetName=iscsiTargetName, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcInitiatorEntry=fcInitiatorEntry, poolSizeHigh=poolSizeHigh, projectShareCount=projectShareCount, iscsiInitiatorEntry=iscsiInitiatorEntry, ipmiThreshold=ipmiThreshold, haControllerA_Uptime=haControllerA_Uptime, notificationEventCode=notificationEventCode, diskSequentialIOCount=diskSequentialIOCount, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, upgradeStarted=upgradeStarted, haResourceIndex=haResourceIndex, iscsiTargetEntry=iscsiTargetEntry, aclMigrationCompleted=aclMigrationCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, netbiosSocketFailure=netbiosSocketFailure, nfsAvgReadLatency=nfsAvgReadLatency, nfsTotalWriteIops=nfsTotalWriteIops, poolDataReadIops=poolDataReadIops, shareQuotaFinished=shareQuotaFinished, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, projectFreeSizeLow=projectFreeSizeLow, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, sensorFailureEvent=sensorFailureEvent, fcTargetIndex=fcTargetIndex, networkIpmpGroupDown=networkIpmpGroupDown, projectDedupEnabled=projectDedupEnabled, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, vmwareNFSDatastores=vmwareNFSDatastores, poolTable=poolTable, adServerTimeDrift=adServerTimeDrift, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, shareNFSReadLatency=shareNFSReadLatency, iscsiTargetReadMbps=iscsiTargetReadMbps, iscsiTargetAuth=iscsiTargetAuth, nvdimmFailInitializationError=nvdimmFailInitializationError, fcPortOffline=fcPortOffline, poolMetaWriteMbps=poolMetaWriteMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, testNotification=testNotification, shareCreatedSuccessfully=shareCreatedSuccessfully, smbSocketFailure=smbSocketFailure, lunIndex=lunIndex, nvdimmFailDeviceError=nvdimmFailDeviceError, poolQuotaFinished=poolQuotaFinished, diskPoolName=diskPoolName, replicationStarted=replicationStarted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, haControllerA_Name=haControllerA_Name, iscsiProperties=iscsiProperties, fcInitiatorIndex=fcInitiatorIndex, poolDeletionFailed=poolDeletionFailed, smisServiceStartFailed=smisServiceStartFailed, sharePoolName=sharePoolName, snapshotDeleteFailed=snapshotDeleteFailed, targetGroupDeleteCompleted=targetGroupDeleteCompleted, lunProtocol=lunProtocol, iscsiTargetGroup=iscsiTargetGroup, tegile=tegile, shareCIFSWriteIops=shareCIFSWriteIops, diskIOCount=diskIOCount, fcTotalReadIops=fcTotalReadIops, shareCIFSReadMbps=shareCIFSReadMbps, lunTargetGroup=lunTargetGroup, nicName=nicName, diskError=diskError, nfsAvgWriteLatency=nfsAvgWriteLatency, ipmiOther=ipmiOther, poolFreeSizeHigh=poolFreeSizeHigh, shareReservedSizeHigh=shareReservedSizeHigh, ipmiPowerSupply=ipmiPowerSupply, poolExported=poolExported, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, controllerTimeDrift=controllerTimeDrift, poolUsedSizeHigh=poolUsedSizeHigh, fcAvgWriteLatency=fcAvgWriteLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, haControllerB_Name=haControllerB_Name, targetGroupMemberAdded=targetGroupMemberAdded, iscsiTotalReadIops=iscsiTotalReadIops, lunGUID=lunGUID, projectIndex=projectIndex, lunReadMbps=lunReadMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolDeleted=poolDeleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolDataWriteIops=poolDataWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiInitiatorGroup=iscsiInitiatorGroup, replicationResumed=replicationResumed, fcPortOnline=fcPortOnline, cifsAvgReadLatency=cifsAvgReadLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, projectDataSizeLow=projectDataSizeLow, iscsiTargetIndex=iscsiTargetIndex, poolUpgraded=poolUpgraded, lunName=lunName, fcInitiatorGroup=fcInitiatorGroup, poolSizeLow=poolSizeLow, ntpServerTimeDrift=ntpServerTimeDrift, shareExceedThresholdWarning=shareExceedThresholdWarning, networkInterfaceDown=networkInterfaceDown, shareNFSWriteMbps=shareNFSWriteMbps, targetGroupMemberRemoved=targetGroupMemberRemoved, volumeDeleteCompleted=volumeDeleteCompleted, poolDataReadLatency=poolDataReadLatency, cacheSSDReads=cacheSSDReads, networkInterfaceUp=networkInterfaceUp, notificationObjects=notificationObjects, userLoginFailed=userLoginFailed, projectSnapshotSizeLow=projectSnapshotSizeLow, notificationReadingUnit=notificationReadingUnit, lunReadIops=lunReadIops, cifsAvgWriteLatency=cifsAvgWriteLatency, cifsTotalReadMbps=cifsTotalReadMbps, tegileCompliances=tegileCompliances, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, smisServiceStopped=smisServiceStopped, diskAvgReadLatency=diskAvgReadLatency, upgradeDownloadFailed=upgradeDownloadFailed, shareTable=shareTable, diskRandomIOCount=diskRandomIOCount, tdpsUpgradeCompleted=tdpsUpgradeCompleted, basicCompliance=basicCompliance, diskIndex=diskIndex, fcTargetWriteIops=fcTargetWriteIops, lunReadLatency=lunReadLatency, upgradeFailed=upgradeFailed, lunBlockSize=lunBlockSize, cacheTotalWriteMbps=cacheTotalWriteMbps, shareNFSReadIops=shareNFSReadIops, lunWriteIops=lunWriteIops, tegileGroups=tegileGroups, poolImported=poolImported, controllerUp=controllerUp, shareEntry=shareEntry, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, projectLUNs=projectLUNs, fcInitiators=fcInitiators, projectTable=projectTable, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiInitiators=iscsiInitiators, diskDataReadIops=diskDataReadIops, shareReservedSizeLow=shareReservedSizeLow, poolWriteCacheWriteIops=poolWriteCacheWriteIops, networkTotalTransmitMbps=networkTotalTransmitMbps, ipmiVoltage=ipmiVoltage, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, nicTransmitMbps=nicTransmitMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskAvgWriteLatency=diskAvgWriteLatency, cacheTotalWriteIops=cacheTotalWriteIops, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolDegraded=poolDegraded, notificationTime=notificationTime, smisServiceStarted=smisServiceStarted, poolReadCacheWriteIops=poolReadCacheWriteIops, haResourceDescription=haResourceDescription, iscsiInitiatorName=iscsiInitiatorName, fcTargetStatus=fcTargetStatus, webdocsUpgradeCompleted=webdocsUpgradeCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, iscsiWriteIops=iscsiWriteIops, ipmiFan=ipmiFan, memoryFailure=memoryFailure, webdocsUpgradeFailed=webdocsUpgradeFailed, lunCompressedRatio=lunCompressedRatio, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, poolTotalWriteMbps=poolTotalWriteMbps, nicIndex=nicIndex, shareCIFSReadLatency=shareCIFSReadLatency, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, diskTable=diskTable, projectTotalSaving=projectTotalSaving, networkTotalReceiveMbps=networkTotalReceiveMbps, shareDeletionFailed=shareDeletionFailed, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolDataWriteMbps=poolDataWriteMbps, diskTotalReadIops=diskTotalReadIops, poolCount=poolCount, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, projectName=projectName, cacheTotalReadIops=cacheTotalReadIops, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion)
