...
ObjectIdentity, Counter64, Integer32, ModuleIdentity, iso, IpAddress, enterprises, NotificationType, Unsigned32, Bits, TimeTicks, Gauge32, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Integer32", "ModuleIdentity", "iso", "IpAddress", "enterprises", "NotificationType", "Unsigned32", "Bits", "TimeTicks", "Gauge32", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareCompressionEnabled=shareCompressionEnabled, iscsiInitiatorsTable=iscsiInitiatorsTable, nicIndex=nicIndex, haControllerB_IPAddr=haControllerB_IPAddr, poolReadCacheWriteIops=poolReadCacheWriteIops, poolWriteCacheWriteIops=poolWriteCacheWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, diskDataReadIops=diskDataReadIops, lunReadLatency=lunReadLatency, fcAvgReadLatency=fcAvgReadLatency, poolHealth=poolHealth, notificationTime=notificationTime, notificationThresholdTriggerValue=notificationThresholdTriggerValue, haControllerA_IPAddr=haControllerA_IPAddr, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolState=poolState, aclMigrationCompleted=aclMigrationCompleted, haResourceGroup=haResourceGroup, nfsAvgWriteLatency=nfsAvgWriteLatency, diskEntry=diskEntry, fcTargetEntry=fcTargetEntry, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, deleteFolderCompleted=deleteFolderCompleted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, nicMTU=nicMTU, lunDataSizeHigh=lunDataSizeHigh, tegileArray=tegileArray, projectDeletionFailed=projectDeletionFailed, diskSizeHigh=diskSizeHigh, nfsTotalWriteMbps=nfsTotalWriteMbps, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, volumeDeleteCompleted=volumeDeleteCompleted, poolTotalWriteMbps=poolTotalWriteMbps, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, diskIOCount=diskIOCount, projectSnapshotSizeLow=projectSnapshotSizeLow, aclMigrationStarted=aclMigrationStarted, ipmiFan=ipmiFan, poolDataReadLatency=poolDataReadLatency, upgradeDownloadFailed=upgradeDownloadFailed, cpuSystemCalls=cpuSystemCalls, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, upgradeDownloadCompleted=upgradeDownloadCompleted, tegileCompliances=tegileCompliances, upgradeCompleted=upgradeCompleted, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, cacheTotalReadMbps=cacheTotalReadMbps, unknownSensorEvent=unknownSensorEvent, tegile=tegile, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectLunCount=projectLunCount, userLoginFailed=userLoginFailed, ipmiMemory=ipmiMemory, poolExported=poolExported, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectQuotaFinished=projectQuotaFinished, poolProjects=poolProjects, iscsiWriteIops=iscsiWriteIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiTargetError=iscsiTargetError, lunReadMbps=lunReadMbps, fcTargetReadIops=fcTargetReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, snapshotRollbackFailed=snapshotRollbackFailed, lunPoolName=lunPoolName, cacheRAMReads=cacheRAMReads, fcTargetsTable=fcTargetsTable, ipmiVoltage=ipmiVoltage, diskSequentialIOCount=diskSequentialIOCount, nicName=nicName, diskTable=diskTable, iscsiTargetGroupError=iscsiTargetGroupError, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, fcAvgWriteLatency=fcAvgWriteLatency, snmpServiceStopped=snmpServiceStopped, poolTotalWriteIops=poolTotalWriteIops, iscsiInitiators=iscsiInitiators, shareCIFSWriteLatency=shareCIFSWriteLatency, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, nfsTotalReadMbps=nfsTotalReadMbps, notificationEventCode=notificationEventCode, haControllerA_Uptime=haControllerA_Uptime, shareCIFSReadLatency=shareCIFSReadLatency, poolQuotaFinished=poolQuotaFinished, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, shareDataSizeLow=shareDataSizeLow, tegileArray_notifications=tegileArray_notifications, snmpAgentVersion=snmpAgentVersion, networkIpmpGroupUp=networkIpmpGroupUp, iscsiTargetReadLatency=iscsiTargetReadLatency, shareNFSWriteLatency=shareNFSWriteLatency, shareReservedSizeHigh=shareReservedSizeHigh, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, lunGUID=lunGUID, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcTargetGroup=fcTargetGroup, nicState=nicState, diagnosticDataUploaded=diagnosticDataUploaded, iscsiTargets=iscsiTargets, cifsTotalWriteIops=cifsTotalWriteIops, diskSizeLow=diskSizeLow, replicationTargetDeleted=replicationTargetDeleted, projectShareCount=projectShareCount, fcTargetWriteLatency=fcTargetWriteLatency, diskGoneOffline=diskGoneOffline, sensorFailureEvent=sensorFailureEvent, diskDataWriteMbps=diskDataWriteMbps, sharePoolName=sharePoolName, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolDataWriteLatency=poolDataWriteLatency, iscsiTargetAlias=iscsiTargetAlias, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiTotalReadIops=iscsiTotalReadIops, projectDataSizeLow=projectDataSizeLow, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareCIFSReadMbps=shareCIFSReadMbps, lunEntry=lunEntry, poolMetaReadLatency=poolMetaReadLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, projectName=projectName, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareIndex=shareIndex, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, cifsTotalReadIops=cifsTotalReadIops, diskChassisIdx=diskChassisIdx, notificationDescription=notificationDescription, tegileConformance=tegileConformance, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, notificationSensorSuspect=notificationSensorSuspect, diskRandomIOCount=diskRandomIOCount, cacheTotalReadIops=cacheTotalReadIops, basicCompliance=basicCompliance, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, volumeQuotaFinished=volumeQuotaFinished, lunWriteMbps=lunWriteMbps, poolMetaWriteIops=poolMetaWriteIops, poolProjectCount=poolProjectCount, projectEntry=projectEntry, controllerHardwareModel=controllerHardwareModel, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, lunCompressionEnabled=lunCompressionEnabled, poolDataSizeHigh=poolDataSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, iscsiTargetsTable=iscsiTargetsTable, shareNFSReadLatency=shareNFSReadLatency, shareQuotaHigh=shareQuotaHigh, lunReservedSizeLow=lunReservedSizeLow, maintenanceModeDisabled=maintenanceModeDisabled, poolDataReadMbps=poolDataReadMbps, lunWriteLatency=lunWriteLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, properties=properties, diskTotalReadMbps=diskTotalReadMbps, notificationTargetEntityName=notificationTargetEntityName, poolOwnerController=poolOwnerController, iscsiInitiatorEntry=iscsiInitiatorEntry, cacheSSDReads=cacheSSDReads, notificationReadingUnit=notificationReadingUnit, fcTotalWriteIops=fcTotalWriteIops, projectIndex=projectIndex, shareNFSEnabled=shareNFSEnabled, poolDegraded=poolDegraded, pools=pools, fcTargetModifyCompleted=fcTargetModifyCompleted, fcTargetWriteMbps=fcTargetWriteMbps, shareQuotaLow=shareQuotaLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, shareName=shareName, poolDataReadIops=poolDataReadIops, haResourcesTable=haResourcesTable, poolUpgraded=poolUpgraded, replicationPaused=replicationPaused, notificationProps=notificationProps, haResourceDescription=haResourceDescription, projectCompressionEnabled=projectCompressionEnabled, shareMountPoint=shareMountPoint, poolDeleted=poolDeleted, poolName=poolName, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, lunSizeLow=lunSizeLow, snmpServiceStartFailed=snmpServiceStartFailed, poolMetaWriteLatency=poolMetaWriteLatency, nicGroup=nicGroup, shareDedupEnabled=shareDedupEnabled, poolReadCacheReadLatency=poolReadCacheReadLatency, snapshotCloneCompleted=snapshotCloneCompleted, iscsiTargetGroup=iscsiTargetGroup, networkInterfaceDown=networkInterfaceDown, poolReadCacheWriteMbps=poolReadCacheWriteMbps, smbSocketFailure=smbSocketFailure, iscsiInitiatorGroup=iscsiInitiatorGroup, cacheTotalWriteMbps=cacheTotalWriteMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, diskState=diskState, notificationSensorAction=notificationSensorAction, netbiosSocketFailure=netbiosSocketFailure, shareNFSReadIops=shareNFSReadIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, lunFreeSizeHigh=lunFreeSizeHigh, lunTargetGroup=lunTargetGroup, poolAvgReadLatency=poolAvgReadLatency, poolTotalReadIops=poolTotalReadIops, deleteFolderFailed=deleteFolderFailed, iscsiTotalReadMbps=iscsiTotalReadMbps, shareNFSReadMbps=shareNFSReadMbps, cacheTotalWriteIops=cacheTotalWriteIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiAvgReadLatency=iscsiAvgReadLatency, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, memoryFailure=memoryFailure, nvdimmFailSoftError=nvdimmFailSoftError, replicationSourceRegistered=replicationSourceRegistered, cpuTotalUsage=cpuTotalUsage, diskTotalWriteMbps=diskTotalWriteMbps, fcInitiatorCreateFailed=fcInitiatorCreateFailed, haResources=haResources, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareNFSWriteIops=shareNFSWriteIops, snapshotCreationFailed=snapshotCreationFailed, replicationFailed=replicationFailed, diskTotalReadIops=diskTotalReadIops, vmwareNFSDatastores=vmwareNFSDatastores, projectCreatedSuccessfully=projectCreatedSuccessfully, testNotification=testNotification, fcInitiators=fcInitiators, fcPortOffline=fcPortOffline, ipmiCurrent=ipmiCurrent, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, projectThresholdExceedWarning=projectThresholdExceedWarning, shareDeletionFailed=shareDeletionFailed, fcTargets=fcTargets, smisServiceStopFailed=smisServiceStopFailed, poolDeletionFailed=poolDeletionFailed, shareNFSWriteMbps=shareNFSWriteMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, poolTable=poolTable, diskType=diskType, poolExpanded=poolExpanded, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diskCount=diskCount, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, projectQuotaSizeHigh=projectQuotaSizeHigh, snmpServiceStarted=snmpServiceStarted, poolUsedSizeHigh=poolUsedSizeHigh)
mibBuilder.exportSymbols("TEGILE-MIB", poolDataWriteIops=poolDataWriteIops, projectPoolName=projectPoolName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, nfsTotalWriteIops=nfsTotalWriteIops, cifsAvgReadLatency=cifsAvgReadLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, fcTargetReadLatency=fcTargetReadLatency, poolUsedSizeLow=poolUsedSizeLow, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareQuotaFinished=shareQuotaFinished, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiAvgWriteLatency=iscsiAvgWriteLatency, lunWriteIops=lunWriteIops, poolDataSizeLow=poolDataSizeLow, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, haResourceStatus=haResourceStatus, cpuInterrupts=cpuInterrupts, projectDedupEnabled=projectDedupEnabled, upgradeTimeout=upgradeTimeout, nicTable=nicTable, replicationAbandoned=replicationAbandoned, haControllerA_Name=haControllerA_Name, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, shareReservedSizeLow=shareReservedSizeLow, poolReadCacheReadMbps=poolReadCacheReadMbps, diskAvgReadLatency=diskAvgReadLatency, smisServiceStarted=smisServiceStarted, volumeDeleteFailed=volumeDeleteFailed, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, upgradeStarted=upgradeStarted, fcTargetStatus=fcTargetStatus, diskDataWriteIops=diskDataWriteIops, poolFreeSizeLow=poolFreeSizeLow, iscsiTargetWriteIops=iscsiTargetWriteIops, lunProjectName=lunProjectName, tegileGroups=tegileGroups, diskPoolName=diskPoolName, diskIsOnline=diskIsOnline, snapshotDeleteFailed=snapshotDeleteFailed, iscsiImproperTargetGroup=iscsiImproperTargetGroup, notificationObjects=notificationObjects, lunName=lunName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, smisServiceStartFailed=smisServiceStartFailed, ntpServerTimeDrift=ntpServerTimeDrift, networkInterfaceUp=networkInterfaceUp, fcTargetReadMbps=fcTargetReadMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, replicationResumed=replicationResumed, lunFreeSizeLow=lunFreeSizeLow, lunIndex=lunIndex, notifications=notifications, upgradeFailed=upgradeFailed, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolSizeHigh=poolSizeHigh, fcInitiatorsTable=fcInitiatorsTable, fcInitiatorGroup=fcInitiatorGroup, upgradeDownloadStarted=upgradeDownloadStarted, networkTotalTransmitMbps=networkTotalTransmitMbps, diskDataReadMbps=diskDataReadMbps, currentObjectGroup=currentObjectGroup, adServerTimeDrift=adServerTimeDrift, poolCreated=poolCreated, projectDeleted=projectDeleted, globalStatistics=globalStatistics, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolIndex=poolIndex, poolImported=poolImported, controllerTimeDrift=controllerTimeDrift, sanProperties=sanProperties, diskTotalWriteIops=diskTotalWriteIops, fcPortOnline=fcPortOnline, haResourceEntry=haResourceEntry, shareDeleted=shareDeleted, projectLUNs=projectLUNs, iscsiTargetReadIops=iscsiTargetReadIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolDataWriteMbps=poolDataWriteMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, projectFreeSizeLow=projectFreeSizeLow, shareSnapshotSizeLow=shareSnapshotSizeLow, fcInitiatorName=fcInitiatorName, nicReceiveMbps=nicReceiveMbps, haControllerB_Name=haControllerB_Name, notificationComponentName=notificationComponentName, ipmiPowerSupply=ipmiPowerSupply, shareTable=shareTable, lunSnapshotSizeLow=lunSnapshotSizeLow, fcTotalWriteMbps=fcTotalWriteMbps, notificationSeverity=notificationSeverity, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, ipmiOther=ipmiOther, projectShares=projectShares, lunSizeHigh=lunSizeHigh, lunInitiatorGroup=lunInitiatorGroup, shareProjectName=shareProjectName, targetGroupMemberAdded=targetGroupMemberAdded, haResourceActiveNode=haResourceActiveNode, nfsTotalReadIops=nfsTotalReadIops, diskAvgWriteLatency=diskAvgWriteLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcTotalReadMbps=fcTotalReadMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiTargetIndex=iscsiTargetIndex, projectTable=projectTable, snapshotRollbackCompleted=snapshotRollbackCompleted, snmpServiceStopFailed=snmpServiceStopFailed, disks=disks, controllerUp=controllerUp, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcTotalReadIops=fcTotalReadIops, poolEntry=poolEntry, iscsiTargetName=iscsiTargetName, shareCompressedRatio=shareCompressedRatio, nfsAvgReadLatency=nfsAvgReadLatency, poolMetaReadIops=poolMetaReadIops, projectTotalSaving=projectTotalSaving, nicTransmitMbps=nicTransmitMbps, lunReadIops=lunReadIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiTargetWriteLatency=iscsiTargetWriteLatency, iscsiTargetEntry=iscsiTargetEntry, lunBlockSize=lunBlockSize, notificationReadingTriggerValue=notificationReadingTriggerValue, nvdimmFailDeviceError=nvdimmFailDeviceError, network=network, tdpsUpgradeCompleted=tdpsUpgradeCompleted, currentNotificationGroup=currentNotificationGroup, lunDedupEnabled=lunDedupEnabled, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareCIFSReadIops=shareCIFSReadIops, diskIndex=diskIndex, poolFreeSizeHigh=poolFreeSizeHigh, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolTotalSaving=poolTotalSaving, lunTable=lunTable, lunProtocol=lunProtocol, PYSNMP_MODULE_ID=tegile, lunDataSizeLow=lunDataSizeLow, projectDataSizeHigh=projectDataSizeHigh, alertsCleanupCompleted=alertsCleanupCompleted, controllerDown=controllerDown, poolAvgWriteLatency=poolAvgWriteLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, spareDiskReplaced=spareDiskReplaced, diskError=diskError, nicEntry=nicEntry, replicationComplete=replicationComplete, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, networkTotalReceiveMbps=networkTotalReceiveMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectModified=projectModified, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, nvdimmFailUnknownError=nvdimmFailUnknownError, iscsiProperties=iscsiProperties, projectFreeSizeHigh=projectFreeSizeHigh, snapshotCloningFailed=snapshotCloningFailed, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, webdocsUpgradeCompleted=webdocsUpgradeCompleted, networkIpmpGroupDown=networkIpmpGroupDown, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, fcInitiatorEntry=fcInitiatorEntry, smisServiceStopped=smisServiceStopped, maintenanceModeEnabled=maintenanceModeEnabled, cifsTotalReadMbps=cifsTotalReadMbps, poolCount=poolCount, shareEntry=shareEntry, notificationSensorNumber=notificationSensorNumber, targetGroupMemberRemoved=targetGroupMemberRemoved, diskSlowIo=diskSlowIo, replicationStarted=replicationStarted, shareCIFSWriteIops=shareCIFSWriteIops, webdocsUpgradeFailed=webdocsUpgradeFailed, ipmiTemperature=ipmiTemperature, cifsTotalWriteMbps=cifsTotalWriteMbps, iscsiTargetAuth=iscsiTargetAuth, volumeModifyCompleted=volumeModifyCompleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, haResourceIndex=haResourceIndex, shareCIFSEnabled=shareCIFSEnabled, fcTargetWriteIops=fcTargetWriteIops, diskAlias=diskAlias, fcTargetName=fcTargetName, fcProperties=fcProperties, ipmiThreshold=ipmiThreshold, fcInitiatorIndex=fcInitiatorIndex, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, haResourceName=haResourceName, poolSizeLow=poolSizeLow, iscsiInitiatorName=iscsiInitiatorName, replicationAborted=replicationAborted, projectQuotaSizeLow=projectQuotaSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, cifsAvgWriteLatency=cifsAvgWriteLatency, poolMetaReadMbps=poolMetaReadMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, poolMetaWriteMbps=poolMetaWriteMbps, poolTotalReadMbps=poolTotalReadMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, fcTargetIndex=fcTargetIndex, haControllerB_Uptime=haControllerB_Uptime, shareDataSizeHigh=shareDataSizeHigh, lunCompressedRatio=lunCompressedRatio)
