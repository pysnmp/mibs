...
NotificationType, enterprises, IpAddress, Gauge32, iso, Counter32, Bits, ModuleIdentity, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "IpAddress", "Gauge32", "iso", "Counter32", "Bits", "ModuleIdentity", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareDedupEnabled=shareDedupEnabled, alertsCleanupCompleted=alertsCleanupCompleted, diagnosticDataUploaded=diagnosticDataUploaded, nfsAvgReadLatency=nfsAvgReadLatency, projectDataSizeLow=projectDataSizeLow, poolFreeSizeHigh=poolFreeSizeHigh, projectLunCount=projectLunCount, poolWriteCacheWriteIops=poolWriteCacheWriteIops, notificationDescription=notificationDescription, diskType=diskType, shareExceedThresholdWarning=shareExceedThresholdWarning, diskEntry=diskEntry, projectIndex=projectIndex, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareNFSEnabled=shareNFSEnabled, poolTotalSaving=poolTotalSaving, diskSlowIo=diskSlowIo, notificationReadingTriggerValue=notificationReadingTriggerValue, nvdimmFailDeviceError=nvdimmFailDeviceError, projectQuotaFinished=projectQuotaFinished, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, tegileConformance=tegileConformance, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolDataSizeHigh=poolDataSizeHigh, nicIndex=nicIndex, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcPortOnline=fcPortOnline, fcTotalWriteIops=fcTotalWriteIops, shareCompressedRatio=shareCompressedRatio, poolTable=poolTable, shareDeletionFailed=shareDeletionFailed, adServerTimeDrift=adServerTimeDrift, nvdimmFailInitializationError=nvdimmFailInitializationError, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, unknownSensorEvent=unknownSensorEvent, poolReadCacheReadLatency=poolReadCacheReadLatency, iscsiTotalWriteMbps=iscsiTotalWriteMbps, iscsiTotalReadIops=iscsiTotalReadIops, shareNFSWriteMbps=shareNFSWriteMbps, projectName=projectName, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, haControllerA_Uptime=haControllerA_Uptime, shareCIFSWriteMbps=shareCIFSWriteMbps, diskIsOnline=diskIsOnline, snmpServiceStarted=snmpServiceStarted, ipmiCriticalInterrupt=ipmiCriticalInterrupt, diskAvgWriteLatency=diskAvgWriteLatency, shareReservedSizeLow=shareReservedSizeLow, iscsiImproperTargetGroup=iscsiImproperTargetGroup, lunName=lunName, poolProjects=poolProjects, shareDataSizeLow=shareDataSizeLow, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolHealth=poolHealth, poolTotalWriteMbps=poolTotalWriteMbps, lunReservedSizeLow=lunReservedSizeLow, nicGroup=nicGroup, sensorFailureEvent=sensorFailureEvent, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareNFSReadIops=shareNFSReadIops, aclMigrationStarted=aclMigrationStarted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, nicEntry=nicEntry, fcAvgWriteLatency=fcAvgWriteLatency, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunSnapshotSizeHigh=lunSnapshotSizeHigh, projectDeleted=projectDeleted, poolAvgReadLatency=poolAvgReadLatency, poolSizeHigh=poolSizeHigh, network=network, projectCompressionEnabled=projectCompressionEnabled, networkIpmpGroupUp=networkIpmpGroupUp, iscsiAvgReadLatency=iscsiAvgReadLatency, diskRandomIOCount=diskRandomIOCount, poolFreeSizeLow=poolFreeSizeLow, cacheTotalReadMbps=cacheTotalReadMbps, fcTotalWriteMbps=fcTotalWriteMbps, globalStatistics=globalStatistics, poolMetaWriteLatency=poolMetaWriteLatency, iscsiInitiatorName=iscsiInitiatorName, cacheRAMReads=cacheRAMReads, networkTotalTransmitMbps=networkTotalTransmitMbps, snmpServiceStopFailed=snmpServiceStopFailed, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolMetaReadLatency=poolMetaReadLatency, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, lunPoolName=lunPoolName, upgradeCompleted=upgradeCompleted, ipmiFan=ipmiFan, poolDeleted=poolDeleted, fcTargetEntry=fcTargetEntry, cpuInterrupts=cpuInterrupts, targetGroupMemberAdded=targetGroupMemberAdded, haControllerA_IPAddr=haControllerA_IPAddr, poolTotalReadIops=poolTotalReadIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, fcTotalReadIops=fcTotalReadIops, iscsiTargetName=iscsiTargetName, smisServiceStopFailed=smisServiceStopFailed, iscsiWriteIops=iscsiWriteIops, notificationComponentName=notificationComponentName, shareNFSWriteIops=shareNFSWriteIops, controllerUp=controllerUp, snapshotRollbackFailed=snapshotRollbackFailed, projectEntry=projectEntry, ipmiOther=ipmiOther, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, netbiosSocketFailure=netbiosSocketFailure, shareDataSizeHigh=shareDataSizeHigh, upgradeDownloadStarted=upgradeDownloadStarted, fcTargetsTable=fcTargetsTable, lunDataSizeHigh=lunDataSizeHigh, fcInitiatorGroup=fcInitiatorGroup, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, tegileCompliances=tegileCompliances, haResourceActiveNode=haResourceActiveNode, fcTargets=fcTargets, lunSizeHigh=lunSizeHigh, shareDeleted=shareDeleted, projectLUNs=projectLUNs, memoryFailure=memoryFailure, poolQuotaFinished=poolQuotaFinished, iscsiTargetWriteLatency=iscsiTargetWriteLatency, ipmiVoltage=ipmiVoltage, shareName=shareName, iscsiTargetAlias=iscsiTargetAlias, projectDeletionFailed=projectDeletionFailed, projectFreeSizeLow=projectFreeSizeLow, smisServiceStopped=smisServiceStopped, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diskDataWriteIops=diskDataWriteIops, ipmiTemperature=ipmiTemperature, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolSizeLow=poolSizeLow, poolMetaWriteIops=poolMetaWriteIops, webdocsUpgradeCompleted=webdocsUpgradeCompleted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, snmpAgentVersion=snmpAgentVersion, fcInitiators=fcInitiators, lunWriteIops=lunWriteIops, ipmiMemory=ipmiMemory, shareReservedSizeHigh=shareReservedSizeHigh, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, cifsTotalWriteIops=cifsTotalWriteIops, cacheTotalWriteIops=cacheTotalWriteIops, maintenanceModeDisabled=maintenanceModeDisabled, volumeDeleteCompleted=volumeDeleteCompleted, networkInterfaceDown=networkInterfaceDown, poolMetaWriteMbps=poolMetaWriteMbps, ipmiPowerSupply=ipmiPowerSupply, targetGroupCreateCompleted=targetGroupCreateCompleted, fcPortOffline=fcPortOffline, nfsTotalReadIops=nfsTotalReadIops, poolTotalWriteIops=poolTotalWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, lunGUID=lunGUID, sanProperties=sanProperties, lunInitiatorGroup=lunInitiatorGroup, diskTotalReadMbps=diskTotalReadMbps, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolState=poolState, notificationTargetEntityName=notificationTargetEntityName, nicTransmitMbps=nicTransmitMbps, fcTargetIndex=fcTargetIndex, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, lunIndex=lunIndex, cacheTotalReadIops=cacheTotalReadIops, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, networkInterfaceUp=networkInterfaceUp, poolName=poolName, ipmiThreshold=ipmiThreshold, volumeDeleteFailed=volumeDeleteFailed, diskTotalWriteIops=diskTotalWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, snapshotRollbackCompleted=snapshotRollbackCompleted, nicTable=nicTable, shareCIFSWriteIops=shareCIFSWriteIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolDataWriteMbps=poolDataWriteMbps, userLoginFailed=userLoginFailed, lunDedupEnabled=lunDedupEnabled, snapshotCloneCompleted=snapshotCloneCompleted, targetGroupMemberRemoved=targetGroupMemberRemoved, shareNFSWriteLatency=shareNFSWriteLatency, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolReadCacheWriteLatency=poolReadCacheWriteLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, poolDataWriteLatency=poolDataWriteLatency, poolCreated=poolCreated, cifsTotalReadIops=cifsTotalReadIops, projectDataSizeHigh=projectDataSizeHigh, ntpServerTimeDrift=ntpServerTimeDrift, snapshotCreationFailed=snapshotCreationFailed, notificationSeverity=notificationSeverity, diskError=diskError, cifsAvgWriteLatency=cifsAvgWriteLatency, shareCIFSEnabled=shareCIFSEnabled, iscsiInitiators=iscsiInitiators, currentNotificationGroup=currentNotificationGroup, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, notificationObjects=notificationObjects, replicationFailed=replicationFailed, replicationTargetDeleted=replicationTargetDeleted, cacheSSDReads=cacheSSDReads, poolMetaReadIops=poolMetaReadIops, diskDataReadMbps=diskDataReadMbps, fcInitiatorIndex=fcInitiatorIndex, diskIOCount=diskIOCount, poolReadCacheReadIops=poolReadCacheReadIops, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, replicationPaused=replicationPaused, projectTotalSaving=projectTotalSaving, diskTable=diskTable, smisServiceStartFailed=smisServiceStartFailed, shareNFSReadMbps=shareNFSReadMbps, vmwareNFSDatastores=vmwareNFSDatastores, fcTargetWriteMbps=fcTargetWriteMbps, diskCount=diskCount, poolOwnerController=poolOwnerController, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiInitiatorChapUser=iscsiInitiatorChapUser, projectDedupEnabled=projectDedupEnabled, haResources=haResources, iscsiProperties=iscsiProperties, networkIpmpGroupDown=networkIpmpGroupDown, poolDataSizeLow=poolDataSizeLow, shareCIFSReadMbps=shareCIFSReadMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectSnapshotSizeLow=projectSnapshotSizeLow, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, cifsTotalWriteMbps=cifsTotalWriteMbps, shareNFSReadLatency=shareNFSReadLatency, notificationSensorSuspect=notificationSensorSuspect, lunProjectName=lunProjectName, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, fcTargetWriteIops=fcTargetWriteIops, upgradeDownloadFailed=upgradeDownloadFailed, poolIndex=poolIndex, poolImported=poolImported, nicName=nicName, projectShareCount=projectShareCount, initiatorGroupMemberAdded=initiatorGroupMemberAdded, volumeQuotaFinished=volumeQuotaFinished, lunWriteMbps=lunWriteMbps, cifsAvgReadLatency=cifsAvgReadLatency, iscsiInitiatorGroup=iscsiInitiatorGroup, poolUpgraded=poolUpgraded, projectCreatedSuccessfully=projectCreatedSuccessfully, testNotification=testNotification, iscsiTargetAuth=iscsiTargetAuth)
mibBuilder.exportSymbols("TEGILE-MIB", volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, notificationReadingUnit=notificationReadingUnit, fcTargetWriteLatency=fcTargetWriteLatency, fcTotalReadMbps=fcTotalReadMbps, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunFreeSizeHigh=lunFreeSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, haResourceGroup=haResourceGroup, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, networkTotalReceiveMbps=networkTotalReceiveMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, fcAvgReadLatency=fcAvgReadLatency, shareMountPoint=shareMountPoint, lunReadLatency=lunReadLatency, shareTable=shareTable, tegileGroups=tegileGroups, lunProtocol=lunProtocol, lunEntry=lunEntry, iscsiTotalReadMbps=iscsiTotalReadMbps, smbSocketFailure=smbSocketFailure, cacheTotalWriteMbps=cacheTotalWriteMbps, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, iscsiTargetReadIops=iscsiTargetReadIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolEntry=poolEntry, projectQuotaSizeHigh=projectQuotaSizeHigh, shareQuotaLow=shareQuotaLow, shareCIFSWriteLatency=shareCIFSWriteLatency, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskChassisIdx=diskChassisIdx, poolReadCacheWriteMbps=poolReadCacheWriteMbps, haControllerA_Name=haControllerA_Name, shareProjectName=shareProjectName, replicationStarted=replicationStarted, fcTargetReadIops=fcTargetReadIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, iscsiTargetError=iscsiTargetError, poolMetaReadMbps=poolMetaReadMbps, projectTable=projectTable, lunReadIops=lunReadIops, lunCompressedRatio=lunCompressedRatio, smisServiceStarted=smisServiceStarted, sharePoolName=sharePoolName, deleteFolderCompleted=deleteFolderCompleted, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diskDataReadIops=diskDataReadIops, iscsiTargetsTable=iscsiTargetsTable, iscsiTargetGroupError=iscsiTargetGroupError, upgradeTimeout=upgradeTimeout, haResourceDescription=haResourceDescription, poolDataWriteIops=poolDataWriteIops, projectShares=projectShares, poolDataReadIops=poolDataReadIops, snmpServiceStopped=snmpServiceStopped, ipmiCurrent=ipmiCurrent, fcTargetStatus=fcTargetStatus, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunReadMbps=lunReadMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiTargetWriteIops=iscsiTargetWriteIops, shareIndex=shareIndex, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, upgradeFailed=upgradeFailed, haControllerB_Uptime=haControllerB_Uptime, currentObjectGroup=currentObjectGroup, shareQuotaHigh=shareQuotaHigh, poolAvgWriteLatency=poolAvgWriteLatency, lunDataSizeLow=lunDataSizeLow, projectQuotaSizeLow=projectQuotaSizeLow, tegile=tegile, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiTargetIndex=iscsiTargetIndex, maintenanceModeEnabled=maintenanceModeEnabled, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, lunBlockSize=lunBlockSize, replicationResumed=replicationResumed, cpuTotalUsage=cpuTotalUsage, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunSizeLow=lunSizeLow, diskAlias=diskAlias, tegileArray_notifications=tegileArray_notifications, disks=disks, poolProjectCount=poolProjectCount, fcInitiatorEntry=fcInitiatorEntry, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, notifications=notifications, haResourceStatus=haResourceStatus, diskPoolName=diskPoolName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskGoneOffline=diskGoneOffline, PYSNMP_MODULE_ID=tegile, intelliFlashSoftwareUp=intelliFlashSoftwareUp, controllerDown=controllerDown, notificationEventCode=notificationEventCode, fcTargetReadMbps=fcTargetReadMbps, notificationSensorNumber=notificationSensorNumber, poolTotalReadMbps=poolTotalReadMbps, lunTargetGroup=lunTargetGroup, shareEntry=shareEntry, intelliFlashSoftwareDown=intelliFlashSoftwareDown, haResourceEntry=haResourceEntry, nvdimmFailSoftError=nvdimmFailSoftError, shareSnapshotSizeLow=shareSnapshotSizeLow, fcTargetReadLatency=fcTargetReadLatency, snapshotDeleteFailed=snapshotDeleteFailed, tegileArray=tegileArray, poolCount=poolCount, haControllerB_IPAddr=haControllerB_IPAddr, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, projectPoolName=projectPoolName, diskAvgReadLatency=diskAvgReadLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, replicationSourceRegistered=replicationSourceRegistered, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunTable=lunTable, aclMigrationCompleted=aclMigrationCompleted, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, snmpServiceStartFailed=snmpServiceStartFailed, poolDataReadMbps=poolDataReadMbps, shareQuotaFinished=shareQuotaFinished, poolUsedSizeLow=poolUsedSizeLow, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolUsedSizeHigh=poolUsedSizeHigh, poolDataReadLatency=poolDataReadLatency, lunWriteLatency=lunWriteLatency, shareCIFSReadIops=shareCIFSReadIops, shareCIFSReadLatency=shareCIFSReadLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, diskDataWriteMbps=diskDataWriteMbps, projectFreeSizeHigh=projectFreeSizeHigh, webdocsUpgradeFailed=webdocsUpgradeFailed, haResourceIndex=haResourceIndex, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, nfsTotalWriteIops=nfsTotalWriteIops, fcTargetGroup=fcTargetGroup, controllerHardwareModel=controllerHardwareModel, shareCompressionEnabled=shareCompressionEnabled, diskIndex=diskIndex, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, lunReservedSizeHigh=lunReservedSizeHigh, diskTotalReadIops=diskTotalReadIops, replicationAbandoned=replicationAbandoned, fcInitiatorsTable=fcInitiatorsTable, diskTotalWriteMbps=diskTotalWriteMbps, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiInitiatorEntry=iscsiInitiatorEntry, deleteFolderFailed=deleteFolderFailed, poolReadCacheWriteIops=poolReadCacheWriteIops, shareCreatedSuccessfully=shareCreatedSuccessfully, replicationComplete=replicationComplete, cpuSystemCalls=cpuSystemCalls, snapshotCloningFailed=snapshotCloningFailed, volumeCreatedSuccessfully=volumeCreatedSuccessfully, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunCompressionEnabled=lunCompressionEnabled, diskSizeLow=diskSizeLow, projectThresholdExceedWarning=projectThresholdExceedWarning, nfsTotalReadMbps=nfsTotalReadMbps, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolDeletionFailed=poolDeletionFailed, haControllerB_Name=haControllerB_Name, fcInitiatorCreateFailed=fcInitiatorCreateFailed, nicState=nicState, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, properties=properties, iscsiTargetReadMbps=iscsiTargetReadMbps, haResourceName=haResourceName, nicReceiveMbps=nicReceiveMbps, diskSequentialIOCount=diskSequentialIOCount, haResourcesTable=haResourcesTable, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, spareDiskReplaced=spareDiskReplaced, upgradeStarted=upgradeStarted, diskSizeHigh=diskSizeHigh, fcInitiatorName=fcInitiatorName, replicationAborted=replicationAborted, cifsTotalReadMbps=cifsTotalReadMbps, poolExpanded=poolExpanded, pools=pools, iscsiInitiatorIndex=iscsiInitiatorIndex, lunFreeSizeLow=lunFreeSizeLow, tdpsUpgradeFailed=tdpsUpgradeFailed, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, nvdimmFailUnknownError=nvdimmFailUnknownError, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolReadCacheReadMbps=poolReadCacheReadMbps, diskState=diskState, basicCompliance=basicCompliance, notificationTime=notificationTime, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiTargetEntry=iscsiTargetEntry, controllerTimeDrift=controllerTimeDrift, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectModified=projectModified, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, nicMTU=nicMTU, notificationProps=notificationProps, poolExported=poolExported, notificationSensorAction=notificationSensorAction, fcProperties=fcProperties, fcTargetName=fcTargetName, poolDegraded=poolDegraded, volumeModifyCompleted=volumeModifyCompleted, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiTargetGroup=iscsiTargetGroup, iscsiTargets=iscsiTargets)
