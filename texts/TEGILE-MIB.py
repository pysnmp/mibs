...
# Produced by pysmi-1.1.3 at Sat Nov 20 22:39:23 2021
...
Gauge32, iso, Bits, Unsigned32, NotificationType, TimeTicks, Counter64, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, enterprises, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "Bits", "Unsigned32", "NotificationType", "TimeTicks", "Counter64", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "enterprises", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskState=diskState, projectName=projectName, shareCIFSWriteIops=shareCIFSWriteIops, diskTotalReadIops=diskTotalReadIops, projectSnapshotSizeHigh=projectSnapshotSizeHigh, poolDataWriteMbps=poolDataWriteMbps, projectQuotaFinished=projectQuotaFinished, iscsiProperties=iscsiProperties, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, diskAlias=diskAlias, spareDiskReplaced=spareDiskReplaced, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, webdocsUpgradeCompleted=webdocsUpgradeCompleted, projectDedupEnabled=projectDedupEnabled, shareSnapshotSizeLow=shareSnapshotSizeLow, deleteFolderCompleted=deleteFolderCompleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, iscsiInitiatorsTable=iscsiInitiatorsTable, snapshotCreationFailed=snapshotCreationFailed, projectDataSizeHigh=projectDataSizeHigh, poolFreeSizeLow=poolFreeSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, snapshotCloningFailed=snapshotCloningFailed, poolDataReadIops=poolDataReadIops, replicationTargetDeleted=replicationTargetDeleted, iscsiInitiatorIndex=iscsiInitiatorIndex, smisServiceStarted=smisServiceStarted, fcInitiatorGroup=fcInitiatorGroup, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, cacheTotalWriteMbps=cacheTotalWriteMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, smisServiceStopFailed=smisServiceStopFailed, shareDataSizeHigh=shareDataSizeHigh, lunSizeLow=lunSizeLow, controllerUp=controllerUp, notificationSensorNumber=notificationSensorNumber, shareNFSWriteLatency=shareNFSWriteLatency, lunWriteIops=lunWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, globalStatistics=globalStatistics, poolHealth=poolHealth, projectModified=projectModified, haControllerB_Name=haControllerB_Name, iscsiTargetIndex=iscsiTargetIndex, shareCIFSReadLatency=shareCIFSReadLatency, lunWriteLatency=lunWriteLatency, poolTotalReadMbps=poolTotalReadMbps, fcPortOffline=fcPortOffline, alertsCleanupCompleted=alertsCleanupCompleted, haResources=haResources, diskSequentialIOCount=diskSequentialIOCount, haResourceDescription=haResourceDescription, shareCIFSEnabled=shareCIFSEnabled, nvdimmFailSoftError=nvdimmFailSoftError, projectQuotaSizeLow=projectQuotaSizeLow, poolDataReadLatency=poolDataReadLatency, projectIndex=projectIndex, poolReadCacheReadMbps=poolReadCacheReadMbps, shareDedupEnabled=shareDedupEnabled, poolSizeLow=poolSizeLow, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskSizeLow=diskSizeLow, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, fcTargetWriteMbps=fcTargetWriteMbps, poolDataWriteIops=poolDataWriteIops, shareCIFSWriteMbps=shareCIFSWriteMbps, fcTotalReadIops=fcTotalReadIops, iscsiTargets=iscsiTargets, fcTargetEntry=fcTargetEntry, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareCIFSWriteLatency=shareCIFSWriteLatency, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolImported=poolImported, volumeDeleteCompleted=volumeDeleteCompleted, notificationDescription=notificationDescription, projectDeletionFailed=projectDeletionFailed, notificationObjects=notificationObjects, projectTable=projectTable, poolDeletionFailed=poolDeletionFailed, networkInterfaceDown=networkInterfaceDown, diskAvgWriteLatency=diskAvgWriteLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiTargetAuth=iscsiTargetAuth, shareQuotaFinished=shareQuotaFinished, ipmiPowerSupply=ipmiPowerSupply, iscsiInitiatorName=iscsiInitiatorName, projectPoolName=projectPoolName, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareProjectName=shareProjectName, network=network, ipmiMemory=ipmiMemory, diskChassisIdx=diskChassisIdx, fcTargetIndex=fcTargetIndex, shareDataSizeLow=shareDataSizeLow, networkTotalTransmitMbps=networkTotalTransmitMbps, snmpServiceStartFailed=snmpServiceStartFailed, ipmiCriticalInterrupt=ipmiCriticalInterrupt, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, ipmiFan=ipmiFan, notificationTime=notificationTime, poolMetaReadLatency=poolMetaReadLatency, volumeQuotaFinished=volumeQuotaFinished, snapshotDeleteFailed=snapshotDeleteFailed, replicationFailed=replicationFailed, tdpsUpgradeTimeout=tdpsUpgradeTimeout, ntpServerTimeDrift=ntpServerTimeDrift, poolTotalReadIops=poolTotalReadIops, poolEntry=poolEntry, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, nicMTU=nicMTU, fcAvgWriteLatency=fcAvgWriteLatency, fcInitiatorName=fcInitiatorName, poolMetaWriteIops=poolMetaWriteIops, lunProjectName=lunProjectName, iscsiTargetReadIops=iscsiTargetReadIops, replicationComplete=replicationComplete, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, lunTargetGroup=lunTargetGroup, haControllerB_IPAddr=haControllerB_IPAddr, cpuTotalUsage=cpuTotalUsage, poolMetaReadIops=poolMetaReadIops, lunSnapshotSizeHigh=lunSnapshotSizeHigh, testNotification=testNotification, volumeCreatedSuccessfully=volumeCreatedSuccessfully, cpuInterrupts=cpuInterrupts, ipmiVoltage=ipmiVoltage, diskIOCount=diskIOCount, targetGroupCreateCompleted=targetGroupCreateCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry, shareReservedSizeHigh=shareReservedSizeHigh, notificationProps=notificationProps, shareEntry=shareEntry, poolDegraded=poolDegraded, upgradeDownloadCompleted=upgradeDownloadCompleted, projectQuotaSizeHigh=projectQuotaSizeHigh, diskPoolName=diskPoolName, poolDataWriteLatency=poolDataWriteLatency, nfsTotalReadMbps=nfsTotalReadMbps, sharePoolName=sharePoolName, diskType=diskType, iscsiInitiatorGroup=iscsiInitiatorGroup, poolWriteCacheWriteIops=poolWriteCacheWriteIops, poolUpgraded=poolUpgraded, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, haResourceStatus=haResourceStatus, fcTargetsTable=fcTargetsTable, controllerHardwareModel=controllerHardwareModel, shareCreatedSuccessfully=shareCreatedSuccessfully, upgradeTimeout=upgradeTimeout, lunEntry=lunEntry, lunTable=lunTable, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, ipmiOther=ipmiOther, haResourcesTable=haResourcesTable, unknownSensorEvent=unknownSensorEvent, projectCompressionEnabled=projectCompressionEnabled, notificationSensorSuspect=notificationSensorSuspect, nfsTotalReadIops=nfsTotalReadIops, smbSocketFailure=smbSocketFailure, diskSlowIo=diskSlowIo, replicationAborted=replicationAborted, tdpsUpgradeFailed=tdpsUpgradeFailed, cifsAvgReadLatency=cifsAvgReadLatency, diskCount=diskCount, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiTargetReadMbps=iscsiTargetReadMbps, networkIpmpGroupDown=networkIpmpGroupDown, lunInitiatorGroup=lunInitiatorGroup, snmpServiceStopFailed=snmpServiceStopFailed, tegileGroups=tegileGroups, poolSizeHigh=poolSizeHigh, lunReadIops=lunReadIops, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, adServerTimeDrift=adServerTimeDrift, diskRandomIOCount=diskRandomIOCount, poolMetaWriteLatency=poolMetaWriteLatency, vmwareNFSDatastores=vmwareNFSDatastores, poolReadCacheWriteIops=poolReadCacheWriteIops, shareCompressedRatio=shareCompressedRatio, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiImproperTargetGroup=iscsiImproperTargetGroup, fcTargetModifyCompleted=fcTargetModifyCompleted, diskGoneOffline=diskGoneOffline, shareCIFSReadIops=shareCIFSReadIops, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, volumeModifyCompleted=volumeModifyCompleted, iscsiTargetName=iscsiTargetName, nfsAvgWriteLatency=nfsAvgWriteLatency, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, iscsiTargetGroup=iscsiTargetGroup, poolOwnerController=poolOwnerController, maintenanceModeEnabled=maintenanceModeEnabled, fcInitiatorsTable=fcInitiatorsTable, intelliFlashSoftwareDown=intelliFlashSoftwareDown, cacheSSDReads=cacheSSDReads, diskSizeHigh=diskSizeHigh, nicState=nicState, smisServiceStopped=smisServiceStopped, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareDeleted=shareDeleted, cifsTotalReadMbps=cifsTotalReadMbps, nfsAvgReadLatency=nfsAvgReadLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, shareDeletionFailed=shareDeletionFailed, poolDeleted=poolDeleted, fcTargetWriteLatency=fcTargetWriteLatency, poolQuotaFinished=poolQuotaFinished, upgradeCompleted=upgradeCompleted, shareTable=shareTable, replicationAbandoned=replicationAbandoned, nicIndex=nicIndex, haResourceEntry=haResourceEntry, shareNFSWriteIops=shareNFSWriteIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, ipmiTemperature=ipmiTemperature, fcInitiators=fcInitiators, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, diagnosticDataUploaded=diagnosticDataUploaded, userLoginFailed=userLoginFailed, projectDataSizeLow=projectDataSizeLow, diskAvgReadLatency=diskAvgReadLatency, fcAvgReadLatency=fcAvgReadLatency, notificationReadingUnit=notificationReadingUnit, netbiosSocketFailure=netbiosSocketFailure, nvdimmFailInitializationError=nvdimmFailInitializationError, smisServiceStartFailed=smisServiceStartFailed, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, diskEntry=diskEntry, poolDataSizeLow=poolDataSizeLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTargetsTable=iscsiTargetsTable, poolExpanded=poolExpanded, nicTable=nicTable, iscsiTargetWriteMbps=iscsiTargetWriteMbps, controllerDown=controllerDown, fcInitiatorCreateFailed=fcInitiatorCreateFailed, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, lunIndex=lunIndex, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, iscsiWriteIops=iscsiWriteIops, tegileArray=tegileArray, deleteFolderFailed=deleteFolderFailed, iscsiTargetAlias=iscsiTargetAlias, lunGUID=lunGUID)
mibBuilder.exportSymbols("TEGILE-MIB", fcTotalWriteMbps=fcTotalWriteMbps, currentObjectGroup=currentObjectGroup, poolIndex=poolIndex, cacheRAMReads=cacheRAMReads, notificationEventCode=notificationEventCode, memoryFailure=memoryFailure, iscsiTotalReadMbps=iscsiTotalReadMbps, shareNFSReadMbps=shareNFSReadMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, nvdimmFailDeviceError=nvdimmFailDeviceError, projectSnapshotSizeLow=projectSnapshotSizeLow, nicGroup=nicGroup, poolUsedSizeHigh=poolUsedSizeHigh, shareNFSReadLatency=shareNFSReadLatency, haResourceName=haResourceName, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, haControllerB_Uptime=haControllerB_Uptime, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, projectFreeSizeHigh=projectFreeSizeHigh, fcTargetGroup=fcTargetGroup, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, sensorFailureEvent=sensorFailureEvent, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcTotalWriteIops=fcTotalWriteIops, poolTotalWriteMbps=poolTotalWriteMbps, iscsiTargetGroupError=iscsiTargetGroupError, lunDataSizeLow=lunDataSizeLow, nicTransmitMbps=nicTransmitMbps, diskTotalWriteIops=diskTotalWriteIops, replicationStarted=replicationStarted, pools=pools, snapshotRollbackCompleted=snapshotRollbackCompleted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolMetaWriteMbps=poolMetaWriteMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, cifsTotalWriteMbps=cifsTotalWriteMbps, cacheTotalReadIops=cacheTotalReadIops, projectCreatedSuccessfully=projectCreatedSuccessfully, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, diskTotalWriteMbps=diskTotalWriteMbps, poolAvgReadLatency=poolAvgReadLatency, targetGroupMemberAdded=targetGroupMemberAdded, webdocsUpgradeFailed=webdocsUpgradeFailed, lunDataSizeHigh=lunDataSizeHigh, replicationPaused=replicationPaused, shareName=shareName, diskTable=diskTable, tdpsUpgradeCompleted=tdpsUpgradeCompleted, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, lunWriteMbps=lunWriteMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, lunDedupEnabled=lunDedupEnabled, lunReservedSizeHigh=lunReservedSizeHigh, haControllerA_Name=haControllerA_Name, tegileConformance=tegileConformance, poolTotalWriteIops=poolTotalWriteIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, haControllerA_IPAddr=haControllerA_IPAddr, projectShares=projectShares, targetGroupMemberRemoved=targetGroupMemberRemoved, cacheTotalReadMbps=cacheTotalReadMbps, lunBlockSize=lunBlockSize, diskDataReadIops=diskDataReadIops, projectShareCount=projectShareCount, iscsiTargetWriteLatency=iscsiTargetWriteLatency, lunSnapshotSizeLow=lunSnapshotSizeLow, networkInterfaceUp=networkInterfaceUp, aclMigrationStarted=aclMigrationStarted, iscsiInitiators=iscsiInitiators, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, snapshotCloneCompleted=snapshotCloneCompleted, poolFreeSizeHigh=poolFreeSizeHigh, notificationSensorAction=notificationSensorAction, diskDataWriteMbps=diskDataWriteMbps, fcTargetReadLatency=fcTargetReadLatency, haResourceIndex=haResourceIndex, nicReceiveMbps=nicReceiveMbps, poolCount=poolCount, cifsAvgWriteLatency=cifsAvgWriteLatency, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, diskIsOnline=diskIsOnline, lunFreeSizeLow=lunFreeSizeLow, fcTargetReadIops=fcTargetReadIops, poolName=poolName, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, fcTargets=fcTargets, nicName=nicName, poolState=poolState, poolReadCacheWriteLatency=poolReadCacheWriteLatency, networkIpmpGroupUp=networkIpmpGroupUp, cpuSystemCalls=cpuSystemCalls, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareNFSReadIops=shareNFSReadIops, projectEntry=projectEntry, nicEntry=nicEntry, fcTargetName=fcTargetName, lunCompressedRatio=lunCompressedRatio, iscsiInitiatorChapUser=iscsiInitiatorChapUser, tegile=tegile, lunReservedSizeLow=lunReservedSizeLow, lunFreeSizeHigh=lunFreeSizeHigh, projectLunCount=projectLunCount, diskDataReadMbps=diskDataReadMbps, projectLUNs=projectLUNs, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, upgradeStarted=upgradeStarted, upgradeDownloadFailed=upgradeDownloadFailed, poolProjectCount=poolProjectCount, poolDataSizeHigh=poolDataSizeHigh, notificationSeverity=notificationSeverity, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, diskTotalReadMbps=diskTotalReadMbps, shareNFSWriteMbps=shareNFSWriteMbps, shareQuotaHigh=shareQuotaHigh, snapshotRollbackFailed=snapshotRollbackFailed, upgradeFailed=upgradeFailed, lunReadLatency=lunReadLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolTotalSaving=poolTotalSaving, projectFreeSizeLow=projectFreeSizeLow, fcPortOnline=fcPortOnline, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, maintenanceModeDisabled=maintenanceModeDisabled, lunPoolName=lunPoolName, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareReservedSizeLow=shareReservedSizeLow, poolProjects=poolProjects, iscsiTargetEntry=iscsiTargetEntry, shareExceedThresholdWarning=shareExceedThresholdWarning, notificationTargetEntityName=notificationTargetEntityName, lunProtocol=lunProtocol, aclMigrationCompleted=aclMigrationCompleted, lunCompressionEnabled=lunCompressionEnabled, replicationSourceRegistered=replicationSourceRegistered, poolUsedSizeLow=poolUsedSizeLow, currentNotificationGroup=currentNotificationGroup, diskError=diskError, disks=disks, shareCompressionEnabled=shareCompressionEnabled, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, upgradeDownloadStarted=upgradeDownloadStarted, haResourceActiveNode=haResourceActiveNode, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, cifsTotalWriteIops=cifsTotalWriteIops, diskDataWriteIops=diskDataWriteIops, poolTable=poolTable, snmpAgentVersion=snmpAgentVersion, poolDataReadMbps=poolDataReadMbps, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, PYSNMP_MODULE_ID=tegile, iscsiTargetWriteIops=iscsiTargetWriteIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, diskIndex=diskIndex, lunReadMbps=lunReadMbps, basicCompliance=basicCompliance, ipmiThreshold=ipmiThreshold, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiTargetError=iscsiTargetError, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, snmpServiceStarted=snmpServiceStarted, tegileArray_notifications=tegileArray_notifications, haControllerA_Uptime=haControllerA_Uptime, nfsTotalWriteIops=nfsTotalWriteIops, poolCreated=poolCreated, fcTargetWriteIops=fcTargetWriteIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, lunName=lunName, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, notifications=notifications, poolReadCacheWriteMbps=poolReadCacheWriteMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareCIFSReadMbps=shareCIFSReadMbps, cacheTotalWriteIops=cacheTotalWriteIops, fcProperties=fcProperties, projectDeleted=projectDeleted, shareMountPoint=shareMountPoint, fcTargetStatus=fcTargetStatus, projectThresholdExceedWarning=projectThresholdExceedWarning, shareQuotaLow=shareQuotaLow, fcInitiatorEntry=fcInitiatorEntry, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, controllerTimeDrift=controllerTimeDrift, fcTotalReadMbps=fcTotalReadMbps, volumeDeleteFailed=volumeDeleteFailed, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, tegileCompliances=tegileCompliances, sanProperties=sanProperties, notificationComponentName=notificationComponentName, haResourceGroup=haResourceGroup, cifsTotalReadIops=cifsTotalReadIops, lunSizeHigh=lunSizeHigh, poolExported=poolExported, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, fcInitiatorIndex=fcInitiatorIndex, ipmiCurrent=ipmiCurrent, snmpServiceStopped=snmpServiceStopped, fcTargetReadMbps=fcTargetReadMbps, shareNFSEnabled=shareNFSEnabled, iscsiTotalReadIops=iscsiTotalReadIops, shareIndex=shareIndex, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, nfsTotalWriteMbps=nfsTotalWriteMbps, properties=properties, replicationResumed=replicationResumed, initiatorGroupMemberAdded=initiatorGroupMemberAdded, projectTotalSaving=projectTotalSaving, poolMetaReadMbps=poolMetaReadMbps, poolAvgWriteLatency=poolAvgWriteLatency)
