...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, Integer32, IpAddress, ModuleIdentity, enterprises, ObjectIdentity, TimeTicks, MibIdentifier, NotificationType, Counter64, Unsigned32, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "Integer32", "IpAddress", "ModuleIdentity", "enterprises", "ObjectIdentity", "TimeTicks", "MibIdentifier", "NotificationType", "Counter64", "Unsigned32", "iso", "Counter32")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunWriteIops=lunWriteIops, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry, fcInitiatorEntry=fcInitiatorEntry, lunReadMbps=lunReadMbps, poolDataWriteMbps=poolDataWriteMbps, poolName=poolName, cifsTotalReadIops=cifsTotalReadIops, tegileArray=tegileArray, diskDataWriteIops=diskDataWriteIops, diskDataReadIops=diskDataReadIops, shareCIFSReadMbps=shareCIFSReadMbps, currentNotificationGroup=currentNotificationGroup, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareQuotaHigh=shareQuotaHigh, globalStatistics=globalStatistics, lunDataSizeLow=lunDataSizeLow, projectLUNs=projectLUNs, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskTotalWriteIops=diskTotalWriteIops, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcTotalWriteMbps=fcTotalWriteMbps, fcTotalReadMbps=fcTotalReadMbps, poolReadCacheReadMbps=poolReadCacheReadMbps, nfsAvgReadLatency=nfsAvgReadLatency, diskIsOnline=diskIsOnline, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, fcTargetReadMbps=fcTargetReadMbps, iscsiTargetIndex=iscsiTargetIndex, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, fcTargetReadIops=fcTargetReadIops, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolDataWriteIops=poolDataWriteIops, nicName=nicName, shareNFSWriteLatency=shareNFSWriteLatency, webdocsUpgradeCompleted=webdocsUpgradeCompleted, properties=properties, notificationThresholdTriggerValue=notificationThresholdTriggerValue, replicationComplete=replicationComplete, iscsiAvgWriteLatency=iscsiAvgWriteLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, fcProperties=fcProperties, ipmiVoltage=ipmiVoltage, nicTable=nicTable, volumeQuotaFinished=volumeQuotaFinished, shareNFSWriteIops=shareNFSWriteIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, diskDataReadMbps=diskDataReadMbps, fcAvgWriteLatency=fcAvgWriteLatency, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiProperties=iscsiProperties, ipmiTemperature=ipmiTemperature, networkIpmpGroupDown=networkIpmpGroupDown, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, snapshotCloningFailed=snapshotCloningFailed, poolState=poolState, haResourcesTable=haResourcesTable, projectIndex=projectIndex, iscsiTargetAlias=iscsiTargetAlias, snapshotCloneCompleted=snapshotCloneCompleted, fcPortOnline=fcPortOnline, shareSnapshotSizeLow=shareSnapshotSizeLow, poolTotalReadIops=poolTotalReadIops, cifsTotalReadMbps=cifsTotalReadMbps, nfsTotalReadMbps=nfsTotalReadMbps, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, aclMigrationCompleted=aclMigrationCompleted, lunProjectName=lunProjectName, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, projectCompressionEnabled=projectCompressionEnabled, notificationProps=notificationProps, upgradeTimeout=upgradeTimeout, shareCreatedSuccessfully=shareCreatedSuccessfully, tdpsUpgradeTimeout=tdpsUpgradeTimeout, cacheTotalWriteIops=cacheTotalWriteIops, diskAvgReadLatency=diskAvgReadLatency, diskType=diskType, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, nicGroup=nicGroup, adServerTimeDrift=adServerTimeDrift, lunTargetGroup=lunTargetGroup, iscsiInitiatorsTable=iscsiInitiatorsTable, cifsAvgWriteLatency=cifsAvgWriteLatency, fcInitiatorsTable=fcInitiatorsTable, poolProjectCount=poolProjectCount, snapshotCreationFailed=snapshotCreationFailed, diskIOCount=diskIOCount, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunReservedSizeLow=lunReservedSizeLow, poolProjects=poolProjects, ipmiMemory=ipmiMemory, nicEntry=nicEntry, tegile=tegile, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolAvgWriteLatency=poolAvgWriteLatency, shareDataSizeLow=shareDataSizeLow, lunDedupEnabled=lunDedupEnabled, replicationFailed=replicationFailed, nicMTU=nicMTU, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, shareReservedSizeHigh=shareReservedSizeHigh, fcTargetReadLatency=fcTargetReadLatency, haControllerB_Name=haControllerB_Name, poolUsedSizeLow=poolUsedSizeLow, projectEntry=projectEntry, projectDataSizeLow=projectDataSizeLow, smisServiceStarted=smisServiceStarted, tegileArray_notifications=tegileArray_notifications, fcInitiators=fcInitiators, projectCreatedSuccessfully=projectCreatedSuccessfully, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, nicIndex=nicIndex, diskTable=diskTable, iscsiInitiators=iscsiInitiators, networkInterfaceDown=networkInterfaceDown, projectPoolName=projectPoolName, iscsiTargetGroupError=iscsiTargetGroupError, fcTargetIndex=fcTargetIndex, maintenanceModeDisabled=maintenanceModeDisabled, fcAvgReadLatency=fcAvgReadLatency, haResourceActiveNode=haResourceActiveNode, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareQuotaLow=shareQuotaLow, upgradeStarted=upgradeStarted, poolMetaReadIops=poolMetaReadIops, networkIpmpGroupUp=networkIpmpGroupUp, ipmiCurrent=ipmiCurrent, snmpServiceStopped=snmpServiceStopped, shareName=shareName, notificationObjects=notificationObjects, shareQuotaFinished=shareQuotaFinished, nfsTotalReadIops=nfsTotalReadIops, haResources=haResources, poolReadCacheWriteIops=poolReadCacheWriteIops, cpuSystemCalls=cpuSystemCalls, lunCompressedRatio=lunCompressedRatio, sensorFailureEvent=sensorFailureEvent, notificationReadingUnit=notificationReadingUnit, snmpServiceStopFailed=snmpServiceStopFailed, replicationSourceRegistered=replicationSourceRegistered, shareNFSReadIops=shareNFSReadIops, tegileGroups=tegileGroups, haControllerA_Uptime=haControllerA_Uptime, upgradeDownloadStarted=upgradeDownloadStarted, upgradeFailed=upgradeFailed, poolCreated=poolCreated, haControllerA_IPAddr=haControllerA_IPAddr, snmpAgentVersion=snmpAgentVersion, replicationPaused=replicationPaused, controllerTimeDrift=controllerTimeDrift, projectQuotaSizeLow=projectQuotaSizeLow, fcTargetModifyCompleted=fcTargetModifyCompleted, shareNFSWriteMbps=shareNFSWriteMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, iscsiWriteIops=iscsiWriteIops, ipmiFan=ipmiFan, fcTargetWriteLatency=fcTargetWriteLatency, shareCIFSWriteMbps=shareCIFSWriteMbps, notificationTime=notificationTime, poolDataWriteLatency=poolDataWriteLatency, lunProtocol=lunProtocol, notificationComponentName=notificationComponentName, diskGoneOffline=diskGoneOffline, cifsTotalWriteIops=cifsTotalWriteIops, diskChassisIdx=diskChassisIdx, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, nicState=nicState, upgradeCompleted=upgradeCompleted, shareDeletionFailed=shareDeletionFailed, poolReadCacheWriteLatency=poolReadCacheWriteLatency, diskCount=diskCount, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, snapshotRollbackCompleted=snapshotRollbackCompleted, shareCompressionEnabled=shareCompressionEnabled, haResourceStatus=haResourceStatus, projectFreeSizeLow=projectFreeSizeLow, shareDataSizeHigh=shareDataSizeHigh, notificationEventCode=notificationEventCode, fcTargetEntry=fcTargetEntry, diskTotalReadIops=diskTotalReadIops, fcTotalWriteIops=fcTotalWriteIops, PYSNMP_MODULE_ID=tegile, cacheRAMReads=cacheRAMReads, tegileCompliances=tegileCompliances, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunWriteMbps=lunWriteMbps, haResourceGroup=haResourceGroup, poolTable=poolTable, iscsiTargetWriteIops=iscsiTargetWriteIops, diskTotalWriteMbps=diskTotalWriteMbps, nvdimmFailSoftError=nvdimmFailSoftError, fcTargetStatus=fcTargetStatus, ntpServerTimeDrift=ntpServerTimeDrift, projectShares=projectShares, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, ipmiPowerSupply=ipmiPowerSupply, alertsCleanupCompleted=alertsCleanupCompleted, fcTotalReadIops=fcTotalReadIops, shareCIFSReadIops=shareCIFSReadIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, nvdimmFailUnknownError=nvdimmFailUnknownError, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, cacheTotalReadIops=cacheTotalReadIops, lunCompressionEnabled=lunCompressionEnabled, ipmiThreshold=ipmiThreshold, cifsTotalWriteMbps=cifsTotalWriteMbps, deleteFolderCompleted=deleteFolderCompleted, smbSocketFailure=smbSocketFailure, fcTargetWriteIops=fcTargetWriteIops, poolReadCacheWriteMbps=poolReadCacheWriteMbps, sanProperties=sanProperties, projectModified=projectModified, poolTotalWriteMbps=poolTotalWriteMbps, controllerDown=controllerDown, cacheTotalReadMbps=cacheTotalReadMbps, iscsiTargets=iscsiTargets, lunPoolName=lunPoolName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, poolReadCacheReadIops=poolReadCacheReadIops, cifsAvgReadLatency=cifsAvgReadLatency, notificationSeverity=notificationSeverity, targetGroupMemberRemoved=targetGroupMemberRemoved, lunSizeLow=lunSizeLow, webdocsUpgradeFailed=webdocsUpgradeFailed, basicCompliance=basicCompliance, haResourceDescription=haResourceDescription, controllerHardwareModel=controllerHardwareModel, diskDataWriteMbps=diskDataWriteMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, projectShareCount=projectShareCount, shareNFSReadLatency=shareNFSReadLatency, fcTargets=fcTargets, fcTargetName=fcTargetName, lunInitiatorGroup=lunInitiatorGroup, nfsTotalWriteMbps=nfsTotalWriteMbps, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiInitiatorChapUser=iscsiInitiatorChapUser, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, iscsiTargetAuth=iscsiTargetAuth, diskPoolName=diskPoolName, shareCIFSWriteLatency=shareCIFSWriteLatency, projectFreeSizeHigh=projectFreeSizeHigh, notifications=notifications, projectDataSizeHigh=projectDataSizeHigh, cpuInterrupts=cpuInterrupts, poolCount=poolCount, projectLunCount=projectLunCount, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolHealth=poolHealth, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning)
mibBuilder.exportSymbols("TEGILE-MIB", shareTable=shareTable, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunFreeSizeLow=lunFreeSizeLow, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, nfsTotalWriteIops=nfsTotalWriteIops, lunBlockSize=lunBlockSize, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolTotalReadMbps=poolTotalReadMbps, poolFreeSizeLow=poolFreeSizeLow, iscsiTotalReadIops=iscsiTotalReadIops, spareDiskReplaced=spareDiskReplaced, poolTotalWriteIops=poolTotalWriteIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolReadCacheReadLatency=poolReadCacheReadLatency, poolDataReadIops=poolDataReadIops, pools=pools, projectDeleted=projectDeleted, targetGroupMemberAdded=targetGroupMemberAdded, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, diskSizeLow=diskSizeLow, fcInitiatorCreateFailed=fcInitiatorCreateFailed, volumeCreatedSuccessfully=volumeCreatedSuccessfully, smisServiceStartFailed=smisServiceStartFailed, poolDataReadMbps=poolDataReadMbps, lunReadIops=lunReadIops, maintenanceModeEnabled=maintenanceModeEnabled, poolOwnerController=poolOwnerController, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunSnapshotSizeHigh=lunSnapshotSizeHigh, snapshotDeleteFailed=snapshotDeleteFailed, shareCIFSEnabled=shareCIFSEnabled, notificationSensorSuspect=notificationSensorSuspect, iscsiInitiatorIndex=iscsiInitiatorIndex, notificationTargetEntityName=notificationTargetEntityName, smisServiceStopped=smisServiceStopped, memoryFailure=memoryFailure, iscsiImproperTargetGroup=iscsiImproperTargetGroup, shareCompressedRatio=shareCompressedRatio, poolAvgReadLatency=poolAvgReadLatency, haResourceName=haResourceName, poolMetaReadMbps=poolMetaReadMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, haResourceIndex=haResourceIndex, replicationTargetDeleted=replicationTargetDeleted, poolImported=poolImported, currentObjectGroup=currentObjectGroup, sharePoolName=sharePoolName, poolEntry=poolEntry, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, disks=disks, nvdimmFailDeviceError=nvdimmFailDeviceError, projectName=projectName, replicationAbandoned=replicationAbandoned, lunGUID=lunGUID, poolExported=poolExported, ipmiOther=ipmiOther, aclMigrationStarted=aclMigrationStarted, poolTotalSaving=poolTotalSaving, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, upgradeDownloadFailed=upgradeDownloadFailed, lunIndex=lunIndex, lunFreeSizeHigh=lunFreeSizeHigh, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, projectQuotaFinished=projectQuotaFinished, poolDataSizeHigh=poolDataSizeHigh, deleteFolderFailed=deleteFolderFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, diskSizeHigh=diskSizeHigh, snapshotRollbackFailed=snapshotRollbackFailed, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolQuotaFinished=poolQuotaFinished, iscsiInitiatorName=iscsiInitiatorName, poolFreeSizeHigh=poolFreeSizeHigh, notificationReadingTriggerValue=notificationReadingTriggerValue, poolUpgraded=poolUpgraded, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolMetaWriteMbps=poolMetaWriteMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, smisServiceStopFailed=smisServiceStopFailed, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, shareMountPoint=shareMountPoint, diskRandomIOCount=diskRandomIOCount, poolMetaWriteLatency=poolMetaWriteLatency, haControllerB_IPAddr=haControllerB_IPAddr, projectTable=projectTable, replicationAborted=replicationAborted, iscsiTargetsTable=iscsiTargetsTable, network=network, shareEntry=shareEntry, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, shareNFSReadMbps=shareNFSReadMbps, diskSlowIo=diskSlowIo, poolMetaReadLatency=poolMetaReadLatency, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, volumeDeleteCompleted=volumeDeleteCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, shareIndex=shareIndex, haControllerA_Name=haControllerA_Name, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, iscsiTotalReadMbps=iscsiTotalReadMbps, poolWriteCacheWriteIops=poolWriteCacheWriteIops, volumeModifyCompleted=volumeModifyCompleted, shareProjectName=shareProjectName, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareCIFSWriteIops=shareCIFSWriteIops, unknownSensorEvent=unknownSensorEvent, fcInitiatorName=fcInitiatorName, intelliFlashSoftwareUp=intelliFlashSoftwareUp, tdpsUpgradeFailed=tdpsUpgradeFailed, shareNFSEnabled=shareNFSEnabled, haControllerB_Uptime=haControllerB_Uptime, fcTargetWriteMbps=fcTargetWriteMbps, haResourceEntry=haResourceEntry, lunReadLatency=lunReadLatency, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcPortOffline=fcPortOffline, fcTargetGroup=fcTargetGroup, poolUsedSizeHigh=poolUsedSizeHigh, lunEntry=lunEntry, diskAlias=diskAlias, poolDataReadLatency=poolDataReadLatency, poolIndex=poolIndex, poolMetaWriteIops=poolMetaWriteIops, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, shareReservedSizeLow=shareReservedSizeLow, diskTotalReadMbps=diskTotalReadMbps, iscsiTargetReadIops=iscsiTargetReadIops, upgradeDownloadCompleted=upgradeDownloadCompleted, projectDedupEnabled=projectDedupEnabled, replicationResumed=replicationResumed, poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, shareDedupEnabled=shareDedupEnabled, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, cacheSSDReads=cacheSSDReads, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, tegileConformance=tegileConformance, projectTotalSaving=projectTotalSaving, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, cpuTotalUsage=cpuTotalUsage, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, lunSnapshotSizeLow=lunSnapshotSizeLow, diagnosticDataUploaded=diagnosticDataUploaded, diskEntry=diskEntry, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectThresholdExceedWarning=projectThresholdExceedWarning, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, lunTable=lunTable, nfsAvgWriteLatency=nfsAvgWriteLatency, shareExceedThresholdWarning=shareExceedThresholdWarning, vmwareNFSDatastores=vmwareNFSDatastores, replicationStarted=replicationStarted, projectQuotaSizeHigh=projectQuotaSizeHigh, userLoginFailed=userLoginFailed, nicTransmitMbps=nicTransmitMbps, lunReservedSizeHigh=lunReservedSizeHigh, lunName=lunName, projectDeletionFailed=projectDeletionFailed, iscsiTargetName=iscsiTargetName, iscsiAvgReadLatency=iscsiAvgReadLatency, diskSequentialIOCount=diskSequentialIOCount, poolDegraded=poolDegraded, poolDeletionFailed=poolDeletionFailed, networkInterfaceUp=networkInterfaceUp, shareCIFSReadLatency=shareCIFSReadLatency, ipmiCriticalInterrupt=ipmiCriticalInterrupt, iscsiTargetGroup=iscsiTargetGroup, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, iscsiInitiatorGroup=iscsiInitiatorGroup, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, cacheTotalWriteMbps=cacheTotalWriteMbps, snmpServiceStartFailed=snmpServiceStartFailed, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcTargetsTable=fcTargetsTable, snmpServiceStarted=snmpServiceStarted, iscsiTargetError=iscsiTargetError, iscsiTargetReadMbps=iscsiTargetReadMbps, poolDeleted=poolDeleted, volumeDeleteFailed=volumeDeleteFailed, diskState=diskState, fcInitiatorIndex=fcInitiatorIndex, lunWriteLatency=lunWriteLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, shareSnapshotSizeHigh=shareSnapshotSizeHigh, notificationDescription=notificationDescription, notificationSensorNumber=notificationSensorNumber, diskIndex=diskIndex, netbiosSocketFailure=netbiosSocketFailure, diskError=diskError, targetGroupCreateCompleted=targetGroupCreateCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolExpanded=poolExpanded, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, controllerUp=controllerUp, poolSizeHigh=poolSizeHigh, nicReceiveMbps=nicReceiveMbps, notificationSensorAction=notificationSensorAction, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolSizeLow=poolSizeLow, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, testNotification=testNotification, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareDeleted=shareDeleted, lunSizeHigh=lunSizeHigh, iscsiTargetEntry=iscsiTargetEntry, lunDataSizeHigh=lunDataSizeHigh, fcInitiatorGroup=fcInitiatorGroup, projectSnapshotSizeHigh=projectSnapshotSizeHigh, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, diskAvgWriteLatency=diskAvgWriteLatency, iscsiTargetReadLatency=iscsiTargetReadLatency)
