...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Counter64, ObjectIdentity, TimeTicks, ModuleIdentity, NotificationType, MibIdentifier, Counter32, Bits, Unsigned32, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Counter64", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "NotificationType", "MibIdentifier", "Counter32", "Bits", "Unsigned32", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("TEGILE-MIB", snapshotCreationFailed=snapshotCreationFailed, diagnosticDataUploaded=diagnosticDataUploaded, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, upgradeFailed=upgradeFailed, currentNotificationGroup=currentNotificationGroup, smisServiceStopped=smisServiceStopped, haResources=haResources, globalStatistics=globalStatistics, webdocsUpgradeFailed=webdocsUpgradeFailed, notificationDescription=notificationDescription, cifsTotalReadMbps=cifsTotalReadMbps, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, aclMigrationStarted=aclMigrationStarted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, shareDedupEnabled=shareDedupEnabled, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, nicReceiveMbps=nicReceiveMbps, poolDataReadMbps=poolDataReadMbps, controllerTimeDrift=controllerTimeDrift, projectLUNs=projectLUNs, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, projectShareCount=projectShareCount, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, volumeDeleteCompleted=volumeDeleteCompleted, projectDedupEnabled=projectDedupEnabled, lunWriteLatency=lunWriteLatency, tegileCompliances=tegileCompliances, fcTargetEntry=fcTargetEntry, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, controllerHardwareModel=controllerHardwareModel, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, diskChassisIdx=diskChassisIdx, maintenanceModeEnabled=maintenanceModeEnabled, poolDataWriteMbps=poolDataWriteMbps, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, snmpServiceStartFailed=snmpServiceStartFailed, snapshotRollbackFailed=snapshotRollbackFailed, projectTotalSaving=projectTotalSaving, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiInitiatorEntry=iscsiInitiatorEntry, iscsiTargetGroupError=iscsiTargetGroupError, projectSnapshotSizeLow=projectSnapshotSizeLow, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, alertsCleanupCompleted=alertsCleanupCompleted, replicationResumed=replicationResumed, targetGroupCreateCompleted=targetGroupCreateCompleted, poolSizeLow=poolSizeLow, lunWriteIops=lunWriteIops, ipmiOther=ipmiOther, shareNFSReadMbps=shareNFSReadMbps, targetGroupDeleteCompleted=targetGroupDeleteCompleted, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiTargetAlias=iscsiTargetAlias, lunWriteMbps=lunWriteMbps, poolMetaWriteLatency=poolMetaWriteLatency, shareQuotaHigh=shareQuotaHigh, diskSlowIo=diskSlowIo, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, upgradeDownloadStarted=upgradeDownloadStarted, poolImported=poolImported, snapshotCloningFailed=snapshotCloningFailed, poolTotalWriteMbps=poolTotalWriteMbps, fcTargets=fcTargets, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, lunSizeHigh=lunSizeHigh, lunTable=lunTable, poolDataWriteIops=poolDataWriteIops, shareName=shareName, shareCIFSReadIops=shareCIFSReadIops, diskTotalReadIops=diskTotalReadIops, projectQuotaSizeLow=projectQuotaSizeLow, projectLunCount=projectLunCount, ntpServerTimeDrift=ntpServerTimeDrift, shareReservedSizeHigh=shareReservedSizeHigh, poolMetaReadMbps=poolMetaReadMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareNFSReadIops=shareNFSReadIops, diskSizeHigh=diskSizeHigh, replicationTargetDeleted=replicationTargetDeleted, poolProjects=poolProjects, lunBlockSize=lunBlockSize, lunFreeSizeLow=lunFreeSizeLow, nfsTotalReadMbps=nfsTotalReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, shareDataSizeLow=shareDataSizeLow, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareDataSizeHigh=shareDataSizeHigh, cifsTotalWriteMbps=cifsTotalWriteMbps, poolEntry=poolEntry, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, snmpServiceStopped=snmpServiceStopped, poolTotalWriteIops=poolTotalWriteIops, poolCount=poolCount, notificationSeverity=notificationSeverity, cacheTotalWriteMbps=cacheTotalWriteMbps, replicationComplete=replicationComplete, diskIsOnline=diskIsOnline, lunEntry=lunEntry, lunDedupEnabled=lunDedupEnabled, networkTotalReceiveMbps=networkTotalReceiveMbps, projectFreeSizeLow=projectFreeSizeLow, fcTotalWriteIops=fcTotalWriteIops, fcTargetStatus=fcTargetStatus, poolDataWriteLatency=poolDataWriteLatency, cacheRAMReads=cacheRAMReads, iscsiTargetWriteLatency=iscsiTargetWriteLatency, nvdimmFailSoftError=nvdimmFailSoftError, poolDegraded=poolDegraded, shareDeleted=shareDeleted, poolExported=poolExported, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunCompressedRatio=lunCompressedRatio, nfsTotalWriteIops=nfsTotalWriteIops, shareCIFSWriteIops=shareCIFSWriteIops, poolDeleted=poolDeleted, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, tdpsUpgradeFailed=tdpsUpgradeFailed, poolIndex=poolIndex, fcInitiatorIndex=fcInitiatorIndex, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, poolReadCacheReadIops=poolReadCacheReadIops, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, fcInitiatorEntry=fcInitiatorEntry, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, shareCompressionEnabled=shareCompressionEnabled, shareNFSEnabled=shareNFSEnabled, userLoginFailed=userLoginFailed, fcAvgReadLatency=fcAvgReadLatency, lunReservedSizeHigh=lunReservedSizeHigh, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, projectShares=projectShares, poolDataSizeHigh=poolDataSizeHigh, iscsiTargetReadLatency=iscsiTargetReadLatency, tegileConformance=tegileConformance, volumeDeleteFailed=volumeDeleteFailed, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, lunInitiatorGroup=lunInitiatorGroup, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiTargetGroup=iscsiTargetGroup, nicState=nicState, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, lunDataSizeLow=lunDataSizeLow, lunPoolName=lunPoolName, cacheTotalReadMbps=cacheTotalReadMbps, projectPoolName=projectPoolName, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolMetaReadLatency=poolMetaReadLatency, iscsiProperties=iscsiProperties, lunName=lunName, notificationSensorSuspect=notificationSensorSuspect, shareNFSWriteMbps=shareNFSWriteMbps, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareTable=shareTable, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, poolDataReadLatency=poolDataReadLatency, iscsiInitiators=iscsiInitiators, fcAvgWriteLatency=fcAvgWriteLatency, fcTargetIndex=fcTargetIndex, upgradeDownloadCompleted=upgradeDownloadCompleted, cifsAvgWriteLatency=cifsAvgWriteLatency, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, pools=pools, iscsiTargetWriteIops=iscsiTargetWriteIops, maintenanceModeDisabled=maintenanceModeDisabled, shareProjectName=shareProjectName, adServerTimeDrift=adServerTimeDrift, notificationSensorNumber=notificationSensorNumber, nfsTotalReadIops=nfsTotalReadIops, poolSizeHigh=poolSizeHigh, lunProtocol=lunProtocol, diskError=diskError, fcInitiatorCreateFailed=fcInitiatorCreateFailed, notificationProps=notificationProps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, upgradeTimeout=upgradeTimeout, poolTable=poolTable, projectQuotaFinished=projectQuotaFinished, diskAlias=diskAlias, notifications=notifications, projectName=projectName, replicationAbandoned=replicationAbandoned, networkIpmpGroupUp=networkIpmpGroupUp, ipmiCriticalInterrupt=ipmiCriticalInterrupt, notificationSensorAction=notificationSensorAction, notificationReadingTriggerValue=notificationReadingTriggerValue, shareEntry=shareEntry, shareQuotaFinished=shareQuotaFinished, unknownSensorEvent=unknownSensorEvent, projectDataSizeHigh=projectDataSizeHigh, lunCompressionEnabled=lunCompressionEnabled, projectCompressionEnabled=projectCompressionEnabled, poolMetaWriteMbps=poolMetaWriteMbps, haResourceActiveNode=haResourceActiveNode, tdpsUpgradeTimeout=tdpsUpgradeTimeout, projectModified=projectModified, poolDataReadIops=poolDataReadIops, sanProperties=sanProperties, diskGoneOffline=diskGoneOffline, snapshotCloneCompleted=snapshotCloneCompleted, iscsiTargetError=iscsiTargetError, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, diskRandomIOCount=diskRandomIOCount, smbSocketFailure=smbSocketFailure, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiTargetReadIops=iscsiTargetReadIops, shareQuotaLow=shareQuotaLow, diskTotalReadMbps=diskTotalReadMbps, smisServiceStartFailed=smisServiceStartFailed, upgradeStarted=upgradeStarted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, notificationEventCode=notificationEventCode, networkInterfaceDown=networkInterfaceDown, fcTotalWriteMbps=fcTotalWriteMbps, webdocsUpgradeCompleted=webdocsUpgradeCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, lunSizeLow=lunSizeLow, poolFreeSizeLow=poolFreeSizeLow, lunProjectName=lunProjectName, netbiosSocketFailure=netbiosSocketFailure, volumeModifyCompleted=volumeModifyCompleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, diskSizeLow=diskSizeLow, shareIndex=shareIndex, iscsiAvgWriteLatency=iscsiAvgWriteLatency, tegileArray=tegileArray, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, upgradeCompleted=upgradeCompleted, fcTargetGroup=fcTargetGroup, shareNFSReadLatency=shareNFSReadLatency, memoryFailure=memoryFailure, poolQuotaFinished=poolQuotaFinished, ipmiMemory=ipmiMemory, haResourcesTable=haResourcesTable, tegileGroups=tegileGroups, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, fcTargetReadMbps=fcTargetReadMbps, smisServiceStopFailed=smisServiceStopFailed, iscsiWriteIops=iscsiWriteIops, fcTargetName=fcTargetName)
mibBuilder.exportSymbols("TEGILE-MIB", iscsiInitiatorIndex=iscsiInitiatorIndex, ipmiCurrent=ipmiCurrent, lunSnapshotSizeHigh=lunSnapshotSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, haControllerA_IPAddr=haControllerA_IPAddr, replicationSourceRegistered=replicationSourceRegistered, snmpAgentVersion=snmpAgentVersion, sensorFailureEvent=sensorFailureEvent, diskAvgReadLatency=diskAvgReadLatency, diskState=diskState, tegileArray_notifications=tegileArray_notifications, iscsiTargetEntry=iscsiTargetEntry, diskDataReadMbps=diskDataReadMbps, lunReadLatency=lunReadLatency, iscsiTotalReadMbps=iscsiTotalReadMbps, poolName=poolName, replicationPaused=replicationPaused, poolReadCacheWriteLatency=poolReadCacheWriteLatency, shareNFSWriteIops=shareNFSWriteIops, haResourceEntry=haResourceEntry, notificationTime=notificationTime, iscsiInitiatorGroup=iscsiInitiatorGroup, poolExpanded=poolExpanded, diskIOCount=diskIOCount, nvdimmFailUnknownError=nvdimmFailUnknownError, poolProjectCount=poolProjectCount, shareCIFSReadLatency=shareCIFSReadLatency, snapshotDeleteFailed=snapshotDeleteFailed, nicMTU=nicMTU, cpuTotalUsage=cpuTotalUsage, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolOwnerController=poolOwnerController, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcInitiators=fcInitiators, diskTotalWriteMbps=diskTotalWriteMbps, ipmiThreshold=ipmiThreshold, snapshotRollbackCompleted=snapshotRollbackCompleted, shareCIFSEnabled=shareCIFSEnabled, poolTotalReadIops=poolTotalReadIops, poolFreeSizeHigh=poolFreeSizeHigh, diskDataReadIops=diskDataReadIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunReservedSizeLow=lunReservedSizeLow, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, poolHealth=poolHealth, haControllerA_Uptime=haControllerA_Uptime, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, targetGroupMemberAdded=targetGroupMemberAdded, properties=properties, poolAvgWriteLatency=poolAvgWriteLatency, haResourceGroup=haResourceGroup, diskDataWriteMbps=diskDataWriteMbps, ipmiFan=ipmiFan, iscsiInitiatorName=iscsiInitiatorName, iscsiTargetWriteMbps=iscsiTargetWriteMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, fcTargetReadIops=fcTargetReadIops, shareCIFSWriteMbps=shareCIFSWriteMbps, iscsiTotalReadIops=iscsiTotalReadIops, shareReservedSizeLow=shareReservedSizeLow, poolMetaReadIops=poolMetaReadIops, controllerUp=controllerUp, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareCompressedRatio=shareCompressedRatio, diskPoolName=diskPoolName, upgradeDownloadFailed=upgradeDownloadFailed, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, diskTable=diskTable, lunTargetGroup=lunTargetGroup, fcTotalReadMbps=fcTotalReadMbps, poolUpgraded=poolUpgraded, cpuInterrupts=cpuInterrupts, fcTargetModifyCompleted=fcTargetModifyCompleted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, haResourceIndex=haResourceIndex, cacheTotalWriteIops=cacheTotalWriteIops, projectTable=projectTable, lunDataSizeHigh=lunDataSizeHigh, poolUsedSizeHigh=poolUsedSizeHigh, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, nvdimmFailInitializationError=nvdimmFailInitializationError, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargetReadLatency=fcTargetReadLatency, network=network, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolWriteCacheWriteIops=poolWriteCacheWriteIops, haControllerB_Uptime=haControllerB_Uptime, snmpServiceStarted=snmpServiceStarted, intelliFlashSoftwareDown=intelliFlashSoftwareDown, lunGUID=lunGUID, testNotification=testNotification, poolUsedSizeLow=poolUsedSizeLow, iscsiTargetName=iscsiTargetName, notificationComponentName=notificationComponentName, cifsTotalWriteIops=cifsTotalWriteIops, shareCIFSReadMbps=shareCIFSReadMbps, shareMountPoint=shareMountPoint, haResourceName=haResourceName, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, cacheTotalReadIops=cacheTotalReadIops, cifsTotalReadIops=cifsTotalReadIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, cacheSSDReads=cacheSSDReads, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, PYSNMP_MODULE_ID=tegile, nfsTotalWriteMbps=nfsTotalWriteMbps, nicTable=nicTable, tegile=tegile, lunReadIops=lunReadIops, iscsiTargetsTable=iscsiTargetsTable, shareNFSWriteLatency=shareNFSWriteLatency, notificationReadingUnit=notificationReadingUnit, nfsAvgReadLatency=nfsAvgReadLatency, shareSnapshotSizeHigh=shareSnapshotSizeHigh, aclMigrationCompleted=aclMigrationCompleted, ipmiPowerSupply=ipmiPowerSupply, nicIndex=nicIndex, shareDeletionFailed=shareDeletionFailed, projectDataSizeLow=projectDataSizeLow, fcInitiatorName=fcInitiatorName, nfsAvgWriteLatency=nfsAvgWriteLatency, projectQuotaSizeHigh=projectQuotaSizeHigh, fcPortOnline=fcPortOnline, haResourceDescription=haResourceDescription, ipmiVoltage=ipmiVoltage, iscsiTargetAuth=iscsiTargetAuth, iscsiTargets=iscsiTargets, fcInitiatorsTable=fcInitiatorsTable, nicName=nicName, networkTotalTransmitMbps=networkTotalTransmitMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, poolMetaWriteIops=poolMetaWriteIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, volumeCreatedSuccessfully=volumeCreatedSuccessfully, sharePoolName=sharePoolName, fcProperties=fcProperties, shareCIFSWriteLatency=shareCIFSWriteLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, currentObjectGroup=currentObjectGroup, nicGroup=nicGroup, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcPortOffline=fcPortOffline, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, diskTotalWriteIops=diskTotalWriteIops, projectIndex=projectIndex, projectThresholdExceedWarning=projectThresholdExceedWarning, replicationFailed=replicationFailed, poolDeletionFailed=poolDeletionFailed, cpuSystemCalls=cpuSystemCalls, shareCreatedSuccessfully=shareCreatedSuccessfully, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, iscsiAvgReadLatency=iscsiAvgReadLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, nicTransmitMbps=nicTransmitMbps, haControllerB_IPAddr=haControllerB_IPAddr, diskIndex=diskIndex, poolAvgReadLatency=poolAvgReadLatency, fcTotalReadIops=fcTotalReadIops, notificationObjects=notificationObjects, disks=disks, basicCompliance=basicCompliance, vmwareNFSDatastores=vmwareNFSDatastores, cifsAvgReadLatency=cifsAvgReadLatency, diskCount=diskCount, lunFreeSizeHigh=lunFreeSizeHigh, fcInitiatorGroup=fcInitiatorGroup, projectDeleted=projectDeleted, fcTargetWriteMbps=fcTargetWriteMbps, snmpServiceStopFailed=snmpServiceStopFailed, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, lunSnapshotSizeLow=lunSnapshotSizeLow, networkIpmpGroupDown=networkIpmpGroupDown, diskType=diskType, poolTotalSaving=poolTotalSaving, poolReadCacheReadMbps=poolReadCacheReadMbps, haControllerB_Name=haControllerB_Name, iscsiImproperTargetGroup=iscsiImproperTargetGroup, projectDeletionFailed=projectDeletionFailed, poolState=poolState, haControllerA_Name=haControllerA_Name, diskDataWriteIops=diskDataWriteIops, nvdimmFailDeviceError=nvdimmFailDeviceError, projectFreeSizeHigh=projectFreeSizeHigh, smisServiceStarted=smisServiceStarted, lunReadMbps=lunReadMbps, poolCreated=poolCreated, volumeQuotaFinished=volumeQuotaFinished, fcTargetWriteIops=fcTargetWriteIops, replicationAborted=replicationAborted, deleteFolderCompleted=deleteFolderCompleted, networkInterfaceUp=networkInterfaceUp, fcTargetWriteLatency=fcTargetWriteLatency, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, notificationTargetEntityName=notificationTargetEntityName, diskSequentialIOCount=diskSequentialIOCount, ipmiTemperature=ipmiTemperature, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, nicEntry=nicEntry, diskAvgWriteLatency=diskAvgWriteLatency, lunIndex=lunIndex, controllerDown=controllerDown, poolTotalReadMbps=poolTotalReadMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, diskEntry=diskEntry, spareDiskReplaced=spareDiskReplaced, deleteFolderFailed=deleteFolderFailed, projectEntry=projectEntry, haResourceStatus=haResourceStatus, replicationStarted=replicationStarted, fcTargetsTable=fcTargetsTable)
