...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Counter64, Bits, MibIdentifier, NotificationType, IpAddress, TimeTicks, Gauge32, Unsigned32, iso, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Counter64", "Bits", "MibIdentifier", "NotificationType", "IpAddress", "TimeTicks", "Gauge32", "Unsigned32", "iso", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", userLoginFailed=userLoginFailed, projectSnapshotSizeLow=projectSnapshotSizeLow, unknownSensorEvent=unknownSensorEvent, poolDegraded=poolDegraded, PYSNMP_MODULE_ID=tegile, fcProperties=fcProperties, nicReceiveMbps=nicReceiveMbps, poolMetaWriteIops=poolMetaWriteIops, lunFreeSizeHigh=lunFreeSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, poolExported=poolExported, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, ipmiFan=ipmiFan, diskType=diskType, network=network, volumeQuotaFinished=volumeQuotaFinished, iscsiInitiatorsTable=iscsiInitiatorsTable, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, lunPoolName=lunPoolName, iscsiTargetAlias=iscsiTargetAlias, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, cpuTotalUsage=cpuTotalUsage, poolReadCacheReadLatency=poolReadCacheReadLatency, shareNFSWriteMbps=shareNFSWriteMbps, alertsCleanupCompleted=alertsCleanupCompleted, snmpServiceStopFailed=snmpServiceStopFailed, poolUpgraded=poolUpgraded, poolDataWriteMbps=poolDataWriteMbps, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, properties=properties, fcTargetEntry=fcTargetEntry, adServerTimeDrift=adServerTimeDrift, diskSizeLow=diskSizeLow, memoryFailure=memoryFailure, lunName=lunName, lunSizeHigh=lunSizeHigh, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, diagnosticDataUploaded=diagnosticDataUploaded, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, fcTargetIndex=fcTargetIndex, projectQuotaFinished=projectQuotaFinished, lunIndex=lunIndex, cifsTotalReadIops=cifsTotalReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunDataSizeHigh=lunDataSizeHigh, tegileCompliances=tegileCompliances, haControllerB_Uptime=haControllerB_Uptime, cifsTotalWriteMbps=cifsTotalWriteMbps, poolMetaReadMbps=poolMetaReadMbps, cacheTotalReadIops=cacheTotalReadIops, notificationProps=notificationProps, notificationObjects=notificationObjects, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, networkTotalTransmitMbps=networkTotalTransmitMbps, projectFreeSizeHigh=projectFreeSizeHigh, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, currentObjectGroup=currentObjectGroup, shareNFSEnabled=shareNFSEnabled, diskSizeHigh=diskSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, nfsTotalReadMbps=nfsTotalReadMbps, nicState=nicState, haResourcesTable=haResourcesTable, cifsAvgReadLatency=cifsAvgReadLatency, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolFreeSizeHigh=poolFreeSizeHigh, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, ipmiOther=ipmiOther, shareSnapshotSizeLow=shareSnapshotSizeLow, basicCompliance=basicCompliance, fcTargetWriteLatency=fcTargetWriteLatency, cacheTotalWriteMbps=cacheTotalWriteMbps, lunWriteIops=lunWriteIops, projectTotalSaving=projectTotalSaving, poolUsedSizeLow=poolUsedSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskDataWriteMbps=diskDataWriteMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunBlockSize=lunBlockSize, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolDataReadIops=poolDataReadIops, cifsAvgWriteLatency=cifsAvgWriteLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, poolTotalWriteMbps=poolTotalWriteMbps, shareNFSWriteIops=shareNFSWriteIops, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, lunEntry=lunEntry, notificationReadingUnit=notificationReadingUnit, fcTargetReadMbps=fcTargetReadMbps, maintenanceModeEnabled=maintenanceModeEnabled, diskAvgReadLatency=diskAvgReadLatency, fcAvgWriteLatency=fcAvgWriteLatency, snapshotCloningFailed=snapshotCloningFailed, lunCompressedRatio=lunCompressedRatio, shareDeletionFailed=shareDeletionFailed, cifsTotalWriteIops=cifsTotalWriteIops, currentNotificationGroup=currentNotificationGroup, replicationResumed=replicationResumed, ipmiVoltage=ipmiVoltage, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, controllerDown=controllerDown, lunWriteLatency=lunWriteLatency, controllerTimeDrift=controllerTimeDrift, diskSlowIo=diskSlowIo, intelliFlashSoftwareDown=intelliFlashSoftwareDown, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, iscsiTargetEntry=iscsiTargetEntry, sensorFailureEvent=sensorFailureEvent, cacheSSDReads=cacheSSDReads, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, haResourceIndex=haResourceIndex, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskSequentialIOCount=diskSequentialIOCount, shareName=shareName, haResourceActiveNode=haResourceActiveNode, diskDataWriteIops=diskDataWriteIops, shareCIFSWriteMbps=shareCIFSWriteMbps, poolDataWriteLatency=poolDataWriteLatency, poolReadCacheWriteIops=poolReadCacheWriteIops, poolAvgReadLatency=poolAvgReadLatency, poolDataWriteIops=poolDataWriteIops, projectDedupEnabled=projectDedupEnabled, iscsiInitiatorEntry=iscsiInitiatorEntry, lunGUID=lunGUID, poolCreated=poolCreated, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, nvdimmFailSoftError=nvdimmFailSoftError, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, poolMetaReadLatency=poolMetaReadLatency, projectSnapshotSizeHigh=projectSnapshotSizeHigh, fcTargetWriteMbps=fcTargetWriteMbps, haControllerA_Name=haControllerA_Name, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, lunSizeLow=lunSizeLow, tegileArray=tegileArray, iscsiTargetError=iscsiTargetError, poolState=poolState, notificationSensorNumber=notificationSensorNumber, lunTargetGroup=lunTargetGroup, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, smbSocketFailure=smbSocketFailure, poolSizeLow=poolSizeLow, iscsiTargetAuth=iscsiTargetAuth, haControllerA_Uptime=haControllerA_Uptime, replicationFailed=replicationFailed, fcTotalReadIops=fcTotalReadIops, fcTargets=fcTargets, diskTable=diskTable, projectIndex=projectIndex, iscsiTargetReadIops=iscsiTargetReadIops, shareProjectName=shareProjectName, nvdimmFailDeviceError=nvdimmFailDeviceError, projectEntry=projectEntry, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, haControllerB_Name=haControllerB_Name, notifications=notifications, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, diskTotalWriteMbps=diskTotalWriteMbps, poolMetaReadIops=poolMetaReadIops, networkTotalReceiveMbps=networkTotalReceiveMbps, shareCIFSReadMbps=shareCIFSReadMbps, diskAlias=diskAlias, projectCompressionEnabled=projectCompressionEnabled, iscsiTargetWriteMbps=iscsiTargetWriteMbps, fcTargetReadLatency=fcTargetReadLatency, fcPortOffline=fcPortOffline, shareMountPoint=shareMountPoint, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectDataSizeHigh=projectDataSizeHigh, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, shareNFSReadLatency=shareNFSReadLatency, ipmiThreshold=ipmiThreshold, replicationSourceRegistered=replicationSourceRegistered, iscsiTargetGroup=iscsiTargetGroup, shareSnapshotSizeHigh=shareSnapshotSizeHigh, shareCIFSWriteLatency=shareCIFSWriteLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolUsedSizeHigh=poolUsedSizeHigh, poolDeleted=poolDeleted, poolDeletionFailed=poolDeletionFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, poolTotalSaving=poolTotalSaving, targetGroupDeleteCompleted=targetGroupDeleteCompleted, lunProjectName=lunProjectName, notificationTargetEntityName=notificationTargetEntityName, smisServiceStartFailed=smisServiceStartFailed, fcPortOnline=fcPortOnline, iscsiProperties=iscsiProperties, projectDataSizeLow=projectDataSizeLow, projectLunCount=projectLunCount, shareNFSReadIops=shareNFSReadIops, iscsiAvgWriteLatency=iscsiAvgWriteLatency, nicTable=nicTable, targetGroupMemberAdded=targetGroupMemberAdded, diskTotalWriteIops=diskTotalWriteIops, poolOwnerController=poolOwnerController, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, iscsiInitiatorGroup=iscsiInitiatorGroup, iscsiTargetGroupError=iscsiTargetGroupError, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, snapshotCreationFailed=snapshotCreationFailed, diskDataReadIops=diskDataReadIops, shareQuotaFinished=shareQuotaFinished, fcTargetStatus=fcTargetStatus, tegile=tegile, lunFreeSizeLow=lunFreeSizeLow, iscsiTargetIndex=iscsiTargetIndex, haResourceName=haResourceName, haResources=haResources, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, projectTable=projectTable, snmpAgentVersion=snmpAgentVersion, shareNFSWriteLatency=shareNFSWriteLatency, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, diskTotalReadMbps=diskTotalReadMbps, cpuSystemCalls=cpuSystemCalls, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, ipmiCurrent=ipmiCurrent, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, lunDataSizeLow=lunDataSizeLow, fcTargetModifyCompleted=fcTargetModifyCompleted, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, volumeDeleteFailed=volumeDeleteFailed, cpuInterrupts=cpuInterrupts, tegileGroups=tegileGroups, shareDeleted=shareDeleted, haControllerA_IPAddr=haControllerA_IPAddr, iscsiAvgReadLatency=iscsiAvgReadLatency, projectDeleted=projectDeleted, controllerUp=controllerUp, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolDataSizeHigh=poolDataSizeHigh, lunReadMbps=lunReadMbps, networkInterfaceDown=networkInterfaceDown, diskEntry=diskEntry, shareTable=shareTable, iscsiTargetReadMbps=iscsiTargetReadMbps, iscsiTotalReadIops=iscsiTotalReadIops, disks=disks, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareCompressedRatio=shareCompressedRatio, notificationEventCode=notificationEventCode, shareDataSizeHigh=shareDataSizeHigh, cacheRAMReads=cacheRAMReads, networkIpmpGroupDown=networkIpmpGroupDown, projectQuotaSizeHigh=projectQuotaSizeHigh, notificationTime=notificationTime, haResourceStatus=haResourceStatus)
mibBuilder.exportSymbols("TEGILE-MIB", poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, fcTotalWriteMbps=fcTotalWriteMbps, cacheTotalReadMbps=cacheTotalReadMbps, poolReadCacheWriteLatency=poolReadCacheWriteLatency, lunWriteMbps=lunWriteMbps, iscsiWriteIops=iscsiWriteIops, lunReadLatency=lunReadLatency, poolReadCacheWriteMbps=poolReadCacheWriteMbps, networkIpmpGroupUp=networkIpmpGroupUp, poolTotalWriteIops=poolTotalWriteIops, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diskTotalReadIops=diskTotalReadIops, fcTargetName=fcTargetName, ipmiPowerSupply=ipmiPowerSupply, diskPoolName=diskPoolName, poolDataSizeLow=poolDataSizeLow, diskError=diskError, fcTargetsTable=fcTargetsTable, nfsAvgWriteLatency=nfsAvgWriteLatency, poolProjects=poolProjects, cifsTotalReadMbps=cifsTotalReadMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectShares=projectShares, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, nfsTotalWriteMbps=nfsTotalWriteMbps, projectPoolName=projectPoolName, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, tegileArray_notifications=tegileArray_notifications, ipmiCriticalInterrupt=ipmiCriticalInterrupt, deleteFolderCompleted=deleteFolderCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, lunTable=lunTable, globalStatistics=globalStatistics, iscsiTargetsTable=iscsiTargetsTable, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, nicName=nicName, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, lunReservedSizeLow=lunReservedSizeLow, fcTotalWriteIops=fcTotalWriteIops, shareDedupEnabled=shareDedupEnabled, projectShareCount=projectShareCount, nfsTotalReadIops=nfsTotalReadIops, replicationAborted=replicationAborted, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareEntry=shareEntry, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, snapshotDeleteFailed=snapshotDeleteFailed, smisServiceStopped=smisServiceStopped, poolSizeHigh=poolSizeHigh, snapshotRollbackFailed=snapshotRollbackFailed, fcAvgReadLatency=fcAvgReadLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, haResourceEntry=haResourceEntry, notificationReadingTriggerValue=notificationReadingTriggerValue, aclMigrationCompleted=aclMigrationCompleted, lunProtocol=lunProtocol, upgradeCompleted=upgradeCompleted, iscsiInitiatorName=iscsiInitiatorName, fcTargetWriteIops=fcTargetWriteIops, projectLUNs=projectLUNs, iscsiImproperTargetGroup=iscsiImproperTargetGroup, nicTransmitMbps=nicTransmitMbps, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, ipmiMemory=ipmiMemory, lunReadIops=lunReadIops, poolFreeSizeLow=poolFreeSizeLow, fcInitiators=fcInitiators, shareIndex=shareIndex, netbiosSocketFailure=netbiosSocketFailure, tdpsUpgradeFailed=tdpsUpgradeFailed, diskRandomIOCount=diskRandomIOCount, nvdimmFailInitializationError=nvdimmFailInitializationError, deleteFolderFailed=deleteFolderFailed, fcTotalReadMbps=fcTotalReadMbps, volumeModifyCompleted=volumeModifyCompleted, poolMetaWriteLatency=poolMetaWriteLatency, targetGroupMemberRemoved=targetGroupMemberRemoved, poolTotalReadIops=poolTotalReadIops, shareCIFSWriteIops=shareCIFSWriteIops, snmpServiceStopped=snmpServiceStopped, haResourceGroup=haResourceGroup, poolDataReadMbps=poolDataReadMbps, poolEntry=poolEntry, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolCount=poolCount, nicGroup=nicGroup, poolExpanded=poolExpanded, upgradeStarted=upgradeStarted, fcInitiatorsTable=fcInitiatorsTable, shareNFSReadMbps=shareNFSReadMbps, shareCIFSEnabled=shareCIFSEnabled, fcTargetReadIops=fcTargetReadIops, poolName=poolName, diskChassisIdx=diskChassisIdx, poolIndex=poolIndex, lunReservedSizeHigh=lunReservedSizeHigh, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, poolAvgWriteLatency=poolAvgWriteLatency, notificationSeverity=notificationSeverity, tegileConformance=tegileConformance, nicMTU=nicMTU, aclMigrationStarted=aclMigrationStarted, smisServiceStopFailed=smisServiceStopFailed, lunDedupEnabled=lunDedupEnabled, shareQuotaLow=shareQuotaLow, replicationTargetDeleted=replicationTargetDeleted, projectThresholdExceedWarning=projectThresholdExceedWarning, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, lunCompressionEnabled=lunCompressionEnabled, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareReservedSizeLow=shareReservedSizeLow, poolTable=poolTable, fcInitiatorIndex=fcInitiatorIndex, diskGoneOffline=diskGoneOffline, snmpServiceStartFailed=snmpServiceStartFailed, intelliFlashSoftwareUp=intelliFlashSoftwareUp, shareExceedThresholdWarning=shareExceedThresholdWarning, ipmiTemperature=ipmiTemperature, pools=pools, diskIsOnline=diskIsOnline, shareDataSizeLow=shareDataSizeLow, fcInitiatorGroup=fcInitiatorGroup, sanProperties=sanProperties, webdocsUpgradeCompleted=webdocsUpgradeCompleted, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, targetGroupCreateCompleted=targetGroupCreateCompleted, poolQuotaFinished=poolQuotaFinished, replicationComplete=replicationComplete, diskDataReadMbps=diskDataReadMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, shareQuotaHigh=shareQuotaHigh, notificationComponentName=notificationComponentName, fcInitiatorEntry=fcInitiatorEntry, snapshotCloneCompleted=snapshotCloneCompleted, notificationSensorAction=notificationSensorAction, iscsiTargetName=iscsiTargetName, fcInitiatorCreateFailed=fcInitiatorCreateFailed, replicationPaused=replicationPaused, poolHealth=poolHealth, poolTotalReadMbps=poolTotalReadMbps, iscsiTargetWriteIops=iscsiTargetWriteIops, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolProjectCount=poolProjectCount, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolImported=poolImported, projectModified=projectModified, poolMetaWriteMbps=poolMetaWriteMbps, diskAvgWriteLatency=diskAvgWriteLatency, volumeDeleteCompleted=volumeDeleteCompleted, vmwareNFSDatastores=vmwareNFSDatastores, poolDataReadLatency=poolDataReadLatency, projectDeletionFailed=projectDeletionFailed, nvdimmFailUnknownError=nvdimmFailUnknownError, projectName=projectName, iscsiInitiators=iscsiInitiators, nfsAvgReadLatency=nfsAvgReadLatency, notificationDescription=notificationDescription, projectCreatedSuccessfully=projectCreatedSuccessfully, diskIndex=diskIndex, shareCompressionEnabled=shareCompressionEnabled, replicationAbandoned=replicationAbandoned, iscsiTargets=iscsiTargets, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolReadCacheReadIops=poolReadCacheReadIops, upgradeFailed=upgradeFailed, iscsiTotalReadMbps=iscsiTotalReadMbps, networkInterfaceUp=networkInterfaceUp, volumeCreatedSuccessfully=volumeCreatedSuccessfully, replicationStarted=replicationStarted, shareCreatedSuccessfully=shareCreatedSuccessfully, haResourceDescription=haResourceDescription, diskState=diskState, haControllerB_IPAddr=haControllerB_IPAddr, projectQuotaSizeLow=projectQuotaSizeLow, notificationThresholdTriggerValue=notificationThresholdTriggerValue, nicIndex=nicIndex, projectFreeSizeLow=projectFreeSizeLow, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareCIFSReadIops=shareCIFSReadIops, snapshotRollbackCompleted=snapshotRollbackCompleted, notificationSensorSuspect=notificationSensorSuspect, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, snmpServiceStarted=snmpServiceStarted, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, sharePoolName=sharePoolName, testNotification=testNotification, upgradeDownloadStarted=upgradeDownloadStarted, maintenanceModeDisabled=maintenanceModeDisabled, lunInitiatorGroup=lunInitiatorGroup, upgradeDownloadFailed=upgradeDownloadFailed, nicEntry=nicEntry, shareCIFSReadLatency=shareCIFSReadLatency, fcInitiatorName=fcInitiatorName, upgradeTimeout=upgradeTimeout, shareReservedSizeHigh=shareReservedSizeHigh, smisServiceStarted=smisServiceStarted, poolReadCacheReadMbps=poolReadCacheReadMbps, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, nfsTotalWriteIops=nfsTotalWriteIops, diskCount=diskCount, diskIOCount=diskIOCount, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, ntpServerTimeDrift=ntpServerTimeDrift, spareDiskReplaced=spareDiskReplaced, cacheTotalWriteIops=cacheTotalWriteIops, controllerHardwareModel=controllerHardwareModel)
