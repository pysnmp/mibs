...
Gauge32, enterprises, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Bits, MibIdentifier, ObjectIdentity, Counter32, Integer32, NotificationType, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Bits", "MibIdentifier", "ObjectIdentity", "Counter32", "Integer32", "NotificationType", "Counter64", "iso")
...
mibBuilder.exportSymbols("TEGILE-MIB", lunIndex=lunIndex, controllerUp=controllerUp, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectLUNs=projectLUNs, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolCreated=poolCreated, network=network, projectShareCount=projectShareCount, poolMetaWriteMbps=poolMetaWriteMbps, fcAvgWriteLatency=fcAvgWriteLatency, lunReservedSizeHigh=lunReservedSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectDataSizeHigh=projectDataSizeHigh, projectFreeSizeLow=projectFreeSizeLow, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, lunDataSizeHigh=lunDataSizeHigh, lunEntry=lunEntry, ipmiPowerSupply=ipmiPowerSupply, fcInitiatorGroup=fcInitiatorGroup, upgradeDownloadCompleted=upgradeDownloadCompleted, iscsiTargets=iscsiTargets, iscsiTargetWriteIops=iscsiTargetWriteIops, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolDataReadIops=poolDataReadIops, shareCIFSWriteIops=shareCIFSWriteIops, currentObjectGroup=currentObjectGroup, iscsiInitiators=iscsiInitiators, iscsiAvgReadLatency=iscsiAvgReadLatency, deleteFolderCompleted=deleteFolderCompleted, deleteFolderFailed=deleteFolderFailed, shareNFSReadLatency=shareNFSReadLatency, fcTargetStatus=fcTargetStatus, replicationFailed=replicationFailed, maintenanceModeDisabled=maintenanceModeDisabled, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, shareCIFSWriteMbps=shareCIFSWriteMbps, lunSizeHigh=lunSizeHigh, poolIndex=poolIndex, unknownSensorEvent=unknownSensorEvent, lunInitiatorGroup=lunInitiatorGroup, iscsiTargetAlias=iscsiTargetAlias, poolDeletionFailed=poolDeletionFailed, shareCreatedSuccessfully=shareCreatedSuccessfully, projectDataSizeLow=projectDataSizeLow, projectTable=projectTable, upgradeCompleted=upgradeCompleted, lunProtocol=lunProtocol, cacheTotalWriteMbps=cacheTotalWriteMbps, disks=disks, lunTargetGroup=lunTargetGroup, lunDedupEnabled=lunDedupEnabled, poolEntry=poolEntry, shareMountPoint=shareMountPoint, poolFreeSizeLow=poolFreeSizeLow, cacheTotalReadIops=cacheTotalReadIops, poolUsedSizeLow=poolUsedSizeLow, sharePoolName=sharePoolName, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, initiatorGroupMemberAdded=initiatorGroupMemberAdded, smisServiceStarted=smisServiceStarted, shareExceedThresholdWarning=shareExceedThresholdWarning, haResourceActiveNode=haResourceActiveNode, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, spareDiskReplaced=spareDiskReplaced, snapshotCloneCompleted=snapshotCloneCompleted, diagnosticDataUploaded=diagnosticDataUploaded, networkInterfaceDown=networkInterfaceDown, targetGroupMemberAdded=targetGroupMemberAdded, iscsiTargetsTable=iscsiTargetsTable, shareProjectName=shareProjectName, tegileConformance=tegileConformance, poolReadCacheReadIops=poolReadCacheReadIops, shareNFSWriteMbps=shareNFSWriteMbps, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, smisServiceStopped=smisServiceStopped, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, tdpsUpgradeTimeout=tdpsUpgradeTimeout, lunPoolName=lunPoolName, cifsTotalReadIops=cifsTotalReadIops, replicationTargetDeleted=replicationTargetDeleted, fcTargetWriteIops=fcTargetWriteIops, snapshotCloningFailed=snapshotCloningFailed, shareReservedSizeHigh=shareReservedSizeHigh, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, poolUpgraded=poolUpgraded, upgradeDownloadFailed=upgradeDownloadFailed, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiTargetName=iscsiTargetName, iscsiTargetWriteLatency=iscsiTargetWriteLatency, diskTotalReadIops=diskTotalReadIops, diskAlias=diskAlias, nicIndex=nicIndex, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, notificationSeverity=notificationSeverity, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, poolHealth=poolHealth, projectCreatedSuccessfully=projectCreatedSuccessfully, cpuTotalUsage=cpuTotalUsage, ipmiCurrent=ipmiCurrent, iscsiInitiatorChapUser=iscsiInitiatorChapUser, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, lunWriteMbps=lunWriteMbps, diskSizeLow=diskSizeLow, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, cacheTotalWriteIops=cacheTotalWriteIops, nvdimmFailSoftError=nvdimmFailSoftError, poolImported=poolImported, iscsiTargetError=iscsiTargetError, poolMetaReadIops=poolMetaReadIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, diskChassisIdx=diskChassisIdx, maintenanceModeEnabled=maintenanceModeEnabled, tegileArray_notifications=tegileArray_notifications, lunReadIops=lunReadIops, diskAvgWriteLatency=diskAvgWriteLatency, poolName=poolName, iscsiTargetIndex=iscsiTargetIndex, cacheSSDReads=cacheSSDReads, poolSizeHigh=poolSizeHigh, smisServiceStartFailed=smisServiceStartFailed, iscsiInitiatorEntry=iscsiInitiatorEntry, projectModified=projectModified, snmpServiceStopped=snmpServiceStopped, cifsTotalWriteIops=cifsTotalWriteIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolDeleted=poolDeleted, poolSizeLow=poolSizeLow, iscsiTargetReadLatency=iscsiTargetReadLatency, poolMetaReadLatency=poolMetaReadLatency, fcTargetReadIops=fcTargetReadIops, fcTotalWriteIops=fcTotalWriteIops, fcTargetEntry=fcTargetEntry, smisServiceStopFailed=smisServiceStopFailed, ipmiTemperature=ipmiTemperature, lunReadMbps=lunReadMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, diskTotalWriteIops=diskTotalWriteIops, shareCompressionEnabled=shareCompressionEnabled, diskIndex=diskIndex, projectSnapshotSizeHigh=projectSnapshotSizeHigh, adServerTimeDrift=adServerTimeDrift, nvdimmFailDeviceError=nvdimmFailDeviceError, aclMigrationStarted=aclMigrationStarted, controllerDown=controllerDown, snapshotRollbackFailed=snapshotRollbackFailed, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, webdocsUpgradeFailed=webdocsUpgradeFailed, poolTotalReadMbps=poolTotalReadMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, projectDeletionFailed=projectDeletionFailed, replicationAbandoned=replicationAbandoned, targetGroupCreateCompleted=targetGroupCreateCompleted, ipmiVoltage=ipmiVoltage, replicationComplete=replicationComplete, controllerTimeDrift=controllerTimeDrift, shareSnapshotSizeLow=shareSnapshotSizeLow, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, diskType=diskType, notificationComponentName=notificationComponentName, poolTable=poolTable, lunCompressedRatio=lunCompressedRatio, diskIsOnline=diskIsOnline, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolAvgReadLatency=poolAvgReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, projectDedupEnabled=projectDedupEnabled, upgradeFailed=upgradeFailed, haControllerB_Name=haControllerB_Name, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, projectQuotaSizeLow=projectQuotaSizeLow, upgradeTimeout=upgradeTimeout, poolDegraded=poolDegraded, nicGroup=nicGroup, fcTargets=fcTargets, fcTotalReadMbps=fcTotalReadMbps, projectFreeSizeHigh=projectFreeSizeHigh, shareEntry=shareEntry, shareNFSReadIops=shareNFSReadIops, iscsiProperties=iscsiProperties, haResourceIndex=haResourceIndex, volumeCreatedSuccessfully=volumeCreatedSuccessfully, shareDeletionFailed=shareDeletionFailed, fcInitiatorsTable=fcInitiatorsTable, snmpServiceStartFailed=snmpServiceStartFailed, lunSnapshotSizeLow=lunSnapshotSizeLow, shareNFSReadMbps=shareNFSReadMbps, poolTotalSaving=poolTotalSaving, iscsiWriteIops=iscsiWriteIops, shareCIFSEnabled=shareCIFSEnabled, snmpServiceStarted=snmpServiceStarted, tegile=tegile, sensorFailureEvent=sensorFailureEvent, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, controllerHardwareModel=controllerHardwareModel, haControllerB_IPAddr=haControllerB_IPAddr, nvdimmFailUnknownError=nvdimmFailUnknownError, shareDataSizeLow=shareDataSizeLow, nicState=nicState, diskState=diskState, snapshotDeleteFailed=snapshotDeleteFailed, nvdimmFailInitializationError=nvdimmFailInitializationError, shareIndex=shareIndex, poolMetaWriteLatency=poolMetaWriteLatency, fcInitiatorName=fcInitiatorName, poolFreeSizeHigh=poolFreeSizeHigh, volumeQuotaFinished=volumeQuotaFinished, lunWriteLatency=lunWriteLatency, tegileGroups=tegileGroups, volumeModifyCompleted=volumeModifyCompleted, projectIndex=projectIndex, networkTotalReceiveMbps=networkTotalReceiveMbps, nicEntry=nicEntry, poolUsedSizeHigh=poolUsedSizeHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiTotalReadIops=iscsiTotalReadIops, diskTable=diskTable, shareQuotaHigh=shareQuotaHigh, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskRandomIOCount=diskRandomIOCount, projectQuotaSizeHigh=projectQuotaSizeHigh, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, lunProjectName=lunProjectName, pools=pools, shareName=shareName, shareCIFSReadMbps=shareCIFSReadMbps, poolExpanded=poolExpanded, cifsAvgReadLatency=cifsAvgReadLatency, lunDataSizeLow=lunDataSizeLow, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, poolQuotaFinished=poolQuotaFinished, shareCIFSReadLatency=shareCIFSReadLatency, networkIpmpGroupDown=networkIpmpGroupDown, notificationSensorAction=notificationSensorAction, replicationPaused=replicationPaused, shareCompressedRatio=shareCompressedRatio, poolProjects=poolProjects, fcTargetWriteMbps=fcTargetWriteMbps, diskError=diskError, fcTotalReadIops=fcTotalReadIops, poolCount=poolCount, shareReservedSizeLow=shareReservedSizeLow, upgradeDownloadStarted=upgradeDownloadStarted, iscsiTargetGroupError=iscsiTargetGroupError, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded)
mibBuilder.exportSymbols("TEGILE-MIB", cpuSystemCalls=cpuSystemCalls, diskDataWriteIops=diskDataWriteIops, projectSnapshotSizeLow=projectSnapshotSizeLow, notificationSensorNumber=notificationSensorNumber, projectLunCount=projectLunCount, ipmiOther=ipmiOther, shareNFSEnabled=shareNFSEnabled, diskDataReadMbps=diskDataReadMbps, replicationStarted=replicationStarted, lunFreeSizeLow=lunFreeSizeLow, volumeDeleteFailed=volumeDeleteFailed, nfsAvgReadLatency=nfsAvgReadLatency, diskSequentialIOCount=diskSequentialIOCount, diskGoneOffline=diskGoneOffline, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diskTotalWriteMbps=diskTotalWriteMbps, ipmiMemory=ipmiMemory, haControllerB_Uptime=haControllerB_Uptime, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, lunFreeSizeHigh=lunFreeSizeHigh, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, shareCIFSReadIops=shareCIFSReadIops, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolDataWriteMbps=poolDataWriteMbps, nicName=nicName, notifications=notifications, iscsiInitiatorIndex=iscsiInitiatorIndex, diskCount=diskCount, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, globalStatistics=globalStatistics, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiTargetReadMbps=iscsiTargetReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, projectDeleted=projectDeleted, alertsCleanupCompleted=alertsCleanupCompleted, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, notificationDescription=notificationDescription, haResourceGroup=haResourceGroup, replicationAborted=replicationAborted, shareNFSWriteLatency=shareNFSWriteLatency, netbiosSocketFailure=netbiosSocketFailure, diskTotalReadMbps=diskTotalReadMbps, diskPoolName=diskPoolName, shareQuotaLow=shareQuotaLow, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, cpuInterrupts=cpuInterrupts, lunGUID=lunGUID, testNotification=testNotification, nfsTotalWriteMbps=nfsTotalWriteMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, poolMetaReadMbps=poolMetaReadMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, webdocsUpgradeCompleted=webdocsUpgradeCompleted, targetGroupMemberRemoved=targetGroupMemberRemoved, haResourceName=haResourceName, poolState=poolState, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcTargetIndex=fcTargetIndex, projectTotalSaving=projectTotalSaving, shareCIFSWriteLatency=shareCIFSWriteLatency, nfsTotalWriteIops=nfsTotalWriteIops, lunTable=lunTable, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, notificationTargetEntityName=notificationTargetEntityName, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolAvgWriteLatency=poolAvgWriteLatency, currentNotificationGroup=currentNotificationGroup, fcTargetName=fcTargetName, diskDataWriteMbps=diskDataWriteMbps, diskEntry=diskEntry, networkIpmpGroupUp=networkIpmpGroupUp, haControllerA_IPAddr=haControllerA_IPAddr, fcAvgReadLatency=fcAvgReadLatency, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, shareTable=shareTable, ntpServerTimeDrift=ntpServerTimeDrift, poolTotalReadIops=poolTotalReadIops, shareQuotaFinished=shareQuotaFinished, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, lunName=lunName, diskIOCount=diskIOCount, tegileArray=tegileArray, haResources=haResources, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, nicTransmitMbps=nicTransmitMbps, snmpServiceStopFailed=snmpServiceStopFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, tegileCompliances=tegileCompliances, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, replicationSourceRegistered=replicationSourceRegistered, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, iscsiTargetReadIops=iscsiTargetReadIops, basicCompliance=basicCompliance, projectName=projectName, notificationSensorSuspect=notificationSensorSuspect, cacheRAMReads=cacheRAMReads, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolReadCacheReadMbps=poolReadCacheReadMbps, notificationTime=notificationTime, poolOwnerController=poolOwnerController, haResourcesTable=haResourcesTable, tdpsUpgradeFailed=tdpsUpgradeFailed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareDeleted=shareDeleted, haControllerA_Name=haControllerA_Name, smbSocketFailure=smbSocketFailure, networkInterfaceUp=networkInterfaceUp, projectEntry=projectEntry, notificationReadingUnit=notificationReadingUnit, vmwareNFSDatastores=vmwareNFSDatastores, poolTotalWriteMbps=poolTotalWriteMbps, lunReservedSizeLow=lunReservedSizeLow, poolDataReadMbps=poolDataReadMbps, poolReadCacheReadLatency=poolReadCacheReadLatency, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, intelliFlashSoftwareUp=intelliFlashSoftwareUp, diskAvgReadLatency=diskAvgReadLatency, fcTargetWriteLatency=fcTargetWriteLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, poolDataSizeHigh=poolDataSizeHigh, iscsiInitiatorName=iscsiInitiatorName, poolDataSizeLow=poolDataSizeLow, projectShares=projectShares, shareNFSWriteIops=shareNFSWriteIops, projectThresholdExceedWarning=projectThresholdExceedWarning, sanProperties=sanProperties, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareSnapshotSizeHigh=shareSnapshotSizeHigh, snmpAgentVersion=snmpAgentVersion, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, lunReadLatency=lunReadLatency, shareDedupEnabled=shareDedupEnabled, fcInitiatorEntry=fcInitiatorEntry, poolDataWriteIops=poolDataWriteIops, projectPoolName=projectPoolName, snapshotCreationFailed=snapshotCreationFailed, projectCompressionEnabled=projectCompressionEnabled, iscsiTargetGroup=iscsiTargetGroup, cifsTotalWriteMbps=cifsTotalWriteMbps, notificationEventCode=notificationEventCode, projectQuotaFinished=projectQuotaFinished, aclMigrationCompleted=aclMigrationCompleted, targetGroupDeleteCompleted=targetGroupDeleteCompleted, ipmiThreshold=ipmiThreshold, fcTargetReadMbps=fcTargetReadMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, fcTargetModifyCompleted=fcTargetModifyCompleted, cifsAvgWriteLatency=cifsAvgWriteLatency, haResourceEntry=haResourceEntry, fcPortOffline=fcPortOffline, poolMetaWriteIops=poolMetaWriteIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolExported=poolExported, diskSlowIo=diskSlowIo, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiTargetAuth=iscsiTargetAuth, poolDataReadLatency=poolDataReadLatency, nfsTotalReadIops=nfsTotalReadIops, haControllerA_Uptime=haControllerA_Uptime, fcTargetReadLatency=fcTargetReadLatency, memoryFailure=memoryFailure, fcInitiatorIndex=fcInitiatorIndex, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, poolProjectCount=poolProjectCount, diskDataReadIops=diskDataReadIops, nicTable=nicTable, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, lunCompressionEnabled=lunCompressionEnabled, haResourceStatus=haResourceStatus, haResourceDescription=haResourceDescription, fcPortOnline=fcPortOnline, properties=properties, fcInitiators=fcInitiators, nfsTotalReadMbps=nfsTotalReadMbps, diskSizeHigh=diskSizeHigh, fcTotalWriteMbps=fcTotalWriteMbps, lunSizeLow=lunSizeLow, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, nicReceiveMbps=nicReceiveMbps, poolDataWriteLatency=poolDataWriteLatency, iscsiImproperTargetGroup=iscsiImproperTargetGroup, userLoginFailed=userLoginFailed, volumeDeleteCompleted=volumeDeleteCompleted, lunBlockSize=lunBlockSize, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, PYSNMP_MODULE_ID=tegile, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, ipmiFan=ipmiFan, iscsiTotalReadMbps=iscsiTotalReadMbps, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, iscsiAvgWriteLatency=iscsiAvgWriteLatency, cacheTotalReadMbps=cacheTotalReadMbps, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, nicMTU=nicMTU, poolTotalWriteIops=poolTotalWriteIops, fcProperties=fcProperties, lunWriteIops=lunWriteIops, shareDataSizeHigh=shareDataSizeHigh, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, replicationResumed=replicationResumed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, notificationObjects=notificationObjects, notificationProps=notificationProps, upgradeStarted=upgradeStarted, cifsTotalReadMbps=cifsTotalReadMbps, fcTargetsTable=fcTargetsTable, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, iscsiTargetEntry=iscsiTargetEntry, fcTargetGroup=fcTargetGroup)
