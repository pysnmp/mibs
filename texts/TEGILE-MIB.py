...
MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, IpAddress, iso, Gauge32, MibIdentifier, Bits, Unsigned32, Counter64, NotificationType, TimeTicks, Counter32, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "IpAddress", "iso", "Gauge32", "MibIdentifier", "Bits", "Unsigned32", "Counter64", "NotificationType", "TimeTicks", "Counter32", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("TEGILE-MIB", fcTotalReadMbps=fcTotalReadMbps, fcTargetEntry=fcTargetEntry, notificationThresholdTriggerValue=notificationThresholdTriggerValue, nfsTotalReadIops=nfsTotalReadIops, shareName=shareName, replicationAborted=replicationAborted, shareCIFSReadIops=shareCIFSReadIops, iscsiInitiatorGroup=iscsiInitiatorGroup, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskTable=diskTable, diskAlias=diskAlias, poolIndex=poolIndex, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, snmpServiceStartFailed=snmpServiceStartFailed, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, haControllerB_Uptime=haControllerB_Uptime, diskState=diskState, nfsTotalWriteIops=nfsTotalWriteIops, nfsTotalReadMbps=nfsTotalReadMbps, nicIndex=nicIndex, poolMetaReadIops=poolMetaReadIops, tdpsUpgradeFailed=tdpsUpgradeFailed, nfsAvgReadLatency=nfsAvgReadLatency, tdpsUpgradeCompleted=tdpsUpgradeCompleted, replicationStarted=replicationStarted, controllerHardwareModel=controllerHardwareModel, fcInitiatorIndex=fcInitiatorIndex, shareDeletionFailed=shareDeletionFailed, ipmiFan=ipmiFan, cifsTotalWriteIops=cifsTotalWriteIops, lunTable=lunTable, lunDataSizeHigh=lunDataSizeHigh, notificationObjects=notificationObjects, poolHealth=poolHealth, lunReadLatency=lunReadLatency, shareNFSReadIops=shareNFSReadIops, diskIOCount=diskIOCount, poolTotalWriteMbps=poolTotalWriteMbps, poolDataWriteIops=poolDataWriteIops, poolReadCacheWriteIops=poolReadCacheWriteIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, smisServiceStopFailed=smisServiceStopFailed, sharePoolName=sharePoolName, poolProjectCount=poolProjectCount, iscsiTargetEntry=iscsiTargetEntry, alertsCleanupCompleted=alertsCleanupCompleted, targetGroupCreateCompleted=targetGroupCreateCompleted, networkIpmpGroupDown=networkIpmpGroupDown, lunSizeHigh=lunSizeHigh, poolCount=poolCount, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, lunName=lunName, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, notificationSensorSuspect=notificationSensorSuspect, vmwareNFSDatastores=vmwareNFSDatastores, tdpsUpgradeTimeout=tdpsUpgradeTimeout, diskSequentialIOCount=diskSequentialIOCount, upgradeStarted=upgradeStarted, snmpServiceStopFailed=snmpServiceStopFailed, fcTargetReadMbps=fcTargetReadMbps, snapshotRollbackFailed=snapshotRollbackFailed, controllerUp=controllerUp, projectTable=projectTable, notificationSensorAction=notificationSensorAction, notificationComponentName=notificationComponentName, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, poolTotalReadMbps=poolTotalReadMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolTotalSaving=poolTotalSaving, snapshotDeleteFailed=snapshotDeleteFailed, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, iscsiTargetsTable=iscsiTargetsTable, targetGroupMemberAdded=targetGroupMemberAdded, lunReadMbps=lunReadMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, iscsiAvgWriteLatency=iscsiAvgWriteLatency, fcAvgWriteLatency=fcAvgWriteLatency, lunInitiatorGroup=lunInitiatorGroup, fcAvgReadLatency=fcAvgReadLatency, poolMetaReadLatency=poolMetaReadLatency, fcTargetWriteLatency=fcTargetWriteLatency, poolDataReadLatency=poolDataReadLatency, iscsiTargetName=iscsiTargetName, notificationTime=notificationTime, shareNFSReadMbps=shareNFSReadMbps, shareCIFSEnabled=shareCIFSEnabled, poolOwnerController=poolOwnerController, snmpAgentVersion=snmpAgentVersion, haResourceIndex=haResourceIndex, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, tegile=tegile, ipmiTemperature=ipmiTemperature, projectThresholdExceedWarning=projectThresholdExceedWarning, replicationAbandoned=replicationAbandoned, maintenanceModeDisabled=maintenanceModeDisabled, fcInitiatorGroup=fcInitiatorGroup, poolMetaWriteIops=poolMetaWriteIops, tegileArray=tegileArray, iscsiTargetAuth=iscsiTargetAuth, volumeDeleteFailed=volumeDeleteFailed, testNotification=testNotification, poolFreeSizeLow=poolFreeSizeLow, lunSnapshotSizeHigh=lunSnapshotSizeHigh, aclMigrationStarted=aclMigrationStarted, diskIsOnline=diskIsOnline, lunDataSizeLow=lunDataSizeLow, iscsiTargetReadLatency=iscsiTargetReadLatency, iscsiTargetGroup=iscsiTargetGroup, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, unknownSensorEvent=unknownSensorEvent, lunIndex=lunIndex, iscsiWriteIops=iscsiWriteIops, fcInitiatorName=fcInitiatorName, notificationDescription=notificationDescription, pools=pools, lunWriteIops=lunWriteIops, networkTotalReceiveMbps=networkTotalReceiveMbps, poolDataSizeLow=poolDataSizeLow, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, properties=properties, nicMTU=nicMTU, ipmiPowerSupply=ipmiPowerSupply, fcTargetReadIops=fcTargetReadIops, cacheTotalReadIops=cacheTotalReadIops, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, iscsiTargets=iscsiTargets, lunTargetGroup=lunTargetGroup, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, shareProjectName=shareProjectName, fcTargetWriteIops=fcTargetWriteIops, poolMetaReadMbps=poolMetaReadMbps, poolTable=poolTable, projectLUNs=projectLUNs, shareDataSizeLow=shareDataSizeLow, notificationSeverity=notificationSeverity, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, spareDiskReplaced=spareDiskReplaced, iscsiTargetReadIops=iscsiTargetReadIops, upgradeDownloadStarted=upgradeDownloadStarted, shareDeleted=shareDeleted, cifsTotalWriteMbps=cifsTotalWriteMbps, cifsTotalReadMbps=cifsTotalReadMbps, haResourceActiveNode=haResourceActiveNode, fcInitiatorEntry=fcInitiatorEntry, poolAvgReadLatency=poolAvgReadLatency, webdocsUpgradeCompleted=webdocsUpgradeCompleted, iscsiInitiatorChapUser=iscsiInitiatorChapUser, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareReservedSizeLow=shareReservedSizeLow, replicationTargetDeleted=replicationTargetDeleted, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, poolTotalReadIops=poolTotalReadIops, shareIndex=shareIndex, shareCIFSWriteLatency=shareCIFSWriteLatency, upgradeDownloadCompleted=upgradeDownloadCompleted, shareCIFSReadMbps=shareCIFSReadMbps, shareCompressionEnabled=shareCompressionEnabled, shareNFSReadLatency=shareNFSReadLatency, fcTargetReadLatency=fcTargetReadLatency, diskTotalReadMbps=diskTotalReadMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, notificationTargetEntityName=notificationTargetEntityName, projectShareCount=projectShareCount, iscsiTargetGroupError=iscsiTargetGroupError, shareCIFSWriteIops=shareCIFSWriteIops, cacheSSDReads=cacheSSDReads, iscsiTargetWriteLatency=iscsiTargetWriteLatency, cpuTotalUsage=cpuTotalUsage, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, lunReservedSizeLow=lunReservedSizeLow, projectFreeSizeHigh=projectFreeSizeHigh, projectSnapshotSizeHigh=projectSnapshotSizeHigh, iscsiTotalReadIops=iscsiTotalReadIops, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareCreatedSuccessfully=shareCreatedSuccessfully, fcTargets=fcTargets, haResourceEntry=haResourceEntry, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, diskChassisIdx=diskChassisIdx, currentObjectGroup=currentObjectGroup, deleteFolderFailed=deleteFolderFailed, lunBlockSize=lunBlockSize, tegileConformance=tegileConformance, haControllerA_Name=haControllerA_Name, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, iscsiProperties=iscsiProperties, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, controllerTimeDrift=controllerTimeDrift, fcTargetName=fcTargetName, replicationFailed=replicationFailed, nicGroup=nicGroup, fcTotalWriteIops=fcTotalWriteIops, fcTargetsTable=fcTargetsTable, intelliFlashSoftwareUp=intelliFlashSoftwareUp, diskError=diskError, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareCompressedRatio=shareCompressedRatio, smisServiceStarted=smisServiceStarted, poolUpgraded=poolUpgraded, networkInterfaceDown=networkInterfaceDown, projectQuotaSizeHigh=projectQuotaSizeHigh, lunWriteMbps=lunWriteMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, lunReservedSizeHigh=lunReservedSizeHigh, shareNFSWriteMbps=shareNFSWriteMbps, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, fcTotalReadIops=fcTotalReadIops, controllerDown=controllerDown, shareDataSizeHigh=shareDataSizeHigh, poolReadCacheReadMbps=poolReadCacheReadMbps, projectDataSizeLow=projectDataSizeLow, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, tegileGroups=tegileGroups, lunCompressionEnabled=lunCompressionEnabled, diskType=diskType, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolTotalWriteIops=poolTotalWriteIops, iscsiTargetError=iscsiTargetError, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, ntpServerTimeDrift=ntpServerTimeDrift, snmpServiceStopped=snmpServiceStopped, fcTargetStatus=fcTargetStatus, cifsAvgWriteLatency=cifsAvgWriteLatency, poolDegraded=poolDegraded, poolDataSizeHigh=poolDataSizeHigh, iscsiTargetAlias=iscsiTargetAlias, replicationSourceRegistered=replicationSourceRegistered, projectCompressionEnabled=projectCompressionEnabled, PYSNMP_MODULE_ID=tegile, poolExpanded=poolExpanded, webdocsUpgradeFailed=webdocsUpgradeFailed, currentNotificationGroup=currentNotificationGroup, diskEntry=diskEntry, lunSizeLow=lunSizeLow, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunGUID=lunGUID, upgradeFailed=upgradeFailed, notificationReadingTriggerValue=notificationReadingTriggerValue, shareNFSEnabled=shareNFSEnabled, shareTable=shareTable, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, notificationEventCode=notificationEventCode, poolExported=poolExported, volumeQuotaFinished=volumeQuotaFinished, diskDataReadMbps=diskDataReadMbps, iscsiTargetIndex=iscsiTargetIndex, poolWriteCacheWriteIops=poolWriteCacheWriteIops, smisServiceStopped=smisServiceStopped, nicReceiveMbps=nicReceiveMbps, poolEntry=poolEntry)
mibBuilder.exportSymbols("TEGILE-MIB", fcProperties=fcProperties, projectModified=projectModified, poolSizeHigh=poolSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, poolMetaWriteLatency=poolMetaWriteLatency, diagnosticDataUploaded=diagnosticDataUploaded, userLoginFailed=userLoginFailed, projectEntry=projectEntry, lunProtocol=lunProtocol, nvdimmFailUnknownError=nvdimmFailUnknownError, diskPoolName=diskPoolName, volumeModifyCompleted=volumeModifyCompleted, poolDataReadMbps=poolDataReadMbps, diskDataReadIops=diskDataReadIops, ipmiCriticalInterrupt=ipmiCriticalInterrupt, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, nicTransmitMbps=nicTransmitMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, diskAvgReadLatency=diskAvgReadLatency, snapshotCreationFailed=snapshotCreationFailed, shareCIFSReadLatency=shareCIFSReadLatency, projectTotalSaving=projectTotalSaving, fcPortOnline=fcPortOnline, poolDataWriteMbps=poolDataWriteMbps, diskRandomIOCount=diskRandomIOCount, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, projectDataSizeHigh=projectDataSizeHigh, shareMountPoint=shareMountPoint, haResourceStatus=haResourceStatus, tegileCompliances=tegileCompliances, iscsiTargetWriteIops=iscsiTargetWriteIops, haControllerB_IPAddr=haControllerB_IPAddr, projectDeleted=projectDeleted, poolReadCacheReadLatency=poolReadCacheReadLatency, poolState=poolState, network=network, haControllerA_IPAddr=haControllerA_IPAddr, poolReadCacheWriteMbps=poolReadCacheWriteMbps, smbSocketFailure=smbSocketFailure, networkIpmpGroupUp=networkIpmpGroupUp, projectLunCount=projectLunCount, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, poolUsedSizeLow=poolUsedSizeLow, replicationComplete=replicationComplete, cacheTotalReadMbps=cacheTotalReadMbps, sanProperties=sanProperties, iscsiInitiatorName=iscsiInitiatorName, nicTable=nicTable, haResourceDescription=haResourceDescription, replicationPaused=replicationPaused, fcTargetWriteMbps=fcTargetWriteMbps, haResourceName=haResourceName, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, ipmiMemory=ipmiMemory, cpuInterrupts=cpuInterrupts, diskTotalReadIops=diskTotalReadIops, cifsTotalReadIops=cifsTotalReadIops, poolQuotaFinished=poolQuotaFinished, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, projectName=projectName, networkInterfaceUp=networkInterfaceUp, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcInitiatorsTable=fcInitiatorsTable, volumeCreatedSuccessfully=volumeCreatedSuccessfully, fcTotalWriteMbps=fcTotalWriteMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiTotalWriteMbps=iscsiTotalWriteMbps, memoryFailure=memoryFailure, diskDataWriteIops=diskDataWriteIops, shareNFSWriteLatency=shareNFSWriteLatency, diskSlowIo=diskSlowIo, ipmiVoltage=ipmiVoltage, poolUsedSizeHigh=poolUsedSizeHigh, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiAvgReadLatency=iscsiAvgReadLatency, snapshotCloningFailed=snapshotCloningFailed, upgradeDownloadFailed=upgradeDownloadFailed, fcTargetGroup=fcTargetGroup, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, snmpServiceStarted=snmpServiceStarted, shareQuotaLow=shareQuotaLow, ipmiCurrent=ipmiCurrent, poolReadCacheWriteLatency=poolReadCacheWriteLatency, projectIndex=projectIndex, lunFreeSizeLow=lunFreeSizeLow, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolMetaWriteMbps=poolMetaWriteMbps, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, lunDedupEnabled=lunDedupEnabled, poolCreated=poolCreated, projectDeletionFailed=projectDeletionFailed, lunWriteLatency=lunWriteLatency, diskAvgWriteLatency=diskAvgWriteLatency, haResourcesTable=haResourcesTable, iscsiTotalReadMbps=iscsiTotalReadMbps, cacheTotalWriteMbps=cacheTotalWriteMbps, fcTargetModifyCompleted=fcTargetModifyCompleted, poolName=poolName, targetGroupMemberRemoved=targetGroupMemberRemoved, diskGoneOffline=diskGoneOffline, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareQuotaFinished=shareQuotaFinished, poolSizeLow=poolSizeLow, projectDedupEnabled=projectDedupEnabled, poolFreeSizeHigh=poolFreeSizeHigh, diskIndex=diskIndex, projectFreeSizeLow=projectFreeSizeLow, haControllerA_Uptime=haControllerA_Uptime, adServerTimeDrift=adServerTimeDrift, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, disks=disks, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, lunCompressedRatio=lunCompressedRatio, replicationResumed=replicationResumed, upgradeTimeout=upgradeTimeout, intelliFlashSoftwareDown=intelliFlashSoftwareDown, lunSnapshotSizeLow=lunSnapshotSizeLow, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolProjects=poolProjects, projectQuotaSizeLow=projectQuotaSizeLow, nicName=nicName, fcInitiators=fcInitiators, netbiosSocketFailure=netbiosSocketFailure, ipmiOther=ipmiOther, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolImported=poolImported, shareReservedSizeHigh=shareReservedSizeHigh, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, sensorFailureEvent=sensorFailureEvent, shareDedupEnabled=shareDedupEnabled, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, targetGroupDeleteCompleted=targetGroupDeleteCompleted, iscsiTargetWriteMbps=iscsiTargetWriteMbps, nicState=nicState, notificationProps=notificationProps, shareNFSWriteIops=shareNFSWriteIops, cifsAvgReadLatency=cifsAvgReadLatency, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, diskTotalWriteMbps=diskTotalWriteMbps, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskSizeHigh=diskSizeHigh, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiInitiators=iscsiInitiators, projectShares=projectShares, projectPoolName=projectPoolName, diskTotalWriteIops=diskTotalWriteIops, lunEntry=lunEntry, lunProjectName=lunProjectName, shareCIFSWriteMbps=shareCIFSWriteMbps, snapshotCloneCompleted=snapshotCloneCompleted, haResourceGroup=haResourceGroup, cacheRAMReads=cacheRAMReads, nvdimmFailSoftError=nvdimmFailSoftError, diskCount=diskCount, nicEntry=nicEntry, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, poolDataWriteLatency=poolDataWriteLatency, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, smisServiceStartFailed=smisServiceStartFailed, networkTotalTransmitMbps=networkTotalTransmitMbps, fcTargetIndex=fcTargetIndex, maintenanceModeEnabled=maintenanceModeEnabled, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, notificationReadingUnit=notificationReadingUnit, lunFreeSizeHigh=lunFreeSizeHigh, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolAvgWriteLatency=poolAvgWriteLatency, haResources=haResources, poolDeleted=poolDeleted, iscsiTargetReadMbps=iscsiTargetReadMbps, notifications=notifications, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, cpuSystemCalls=cpuSystemCalls, tegileArray_notifications=tegileArray_notifications, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, fcPortOffline=fcPortOffline, nvdimmFailDeviceError=nvdimmFailDeviceError, shareQuotaHigh=shareQuotaHigh, notificationSensorNumber=notificationSensorNumber, upgradeCompleted=upgradeCompleted, aclMigrationCompleted=aclMigrationCompleted, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, ipmiThreshold=ipmiThreshold, basicCompliance=basicCompliance, lunReadIops=lunReadIops, nfsAvgWriteLatency=nfsAvgWriteLatency, deleteFolderCompleted=deleteFolderCompleted, shareEntry=shareEntry, projectQuotaFinished=projectQuotaFinished, poolReadCacheReadIops=poolReadCacheReadIops, haControllerB_Name=haControllerB_Name, globalStatistics=globalStatistics, volumeDeleteCompleted=volumeDeleteCompleted, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolDataReadIops=poolDataReadIops, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diskDataWriteMbps=diskDataWriteMbps, projectCreatedSuccessfully=projectCreatedSuccessfully, lunPoolName=lunPoolName, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, iscsiInitiatorEntry=iscsiInitiatorEntry, diskSizeLow=diskSizeLow, nfsTotalWriteMbps=nfsTotalWriteMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolDeletionFailed=poolDeletionFailed)
