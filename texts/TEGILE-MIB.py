...
# Produced by pysmi-1.1.10 at Fri Feb 16 02:42:26 2024
...
Unsigned32, iso, enterprises, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, MibIdentifier, TimeTicks, Gauge32, Integer32, ObjectIdentity, NotificationType, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "enterprises", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "MibIdentifier", "TimeTicks", "Gauge32", "Integer32", "ObjectIdentity", "NotificationType", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskDataWriteIops=diskDataWriteIops, upgradeFailed=upgradeFailed, diskPoolName=diskPoolName, cifsTotalReadMbps=cifsTotalReadMbps, projectQuotaSizeLow=projectQuotaSizeLow, notificationEventCode=notificationEventCode, nfsTotalReadIops=nfsTotalReadIops, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, diskDataWriteMbps=diskDataWriteMbps, projectTotalSaving=projectTotalSaving, iscsiTargetAlias=iscsiTargetAlias, disks=disks, fcTargetReadIops=fcTargetReadIops, poolDataReadLatency=poolDataReadLatency, unknownSensorEvent=unknownSensorEvent, currentNotificationGroup=currentNotificationGroup, nicEntry=nicEntry, replicationAborted=replicationAborted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolTotalWriteIops=poolTotalWriteIops, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, snmpServiceStopFailed=snmpServiceStopFailed, lunWriteMbps=lunWriteMbps, nvdimmFailUnknownError=nvdimmFailUnknownError, lunEntry=lunEntry, haResourceDescription=haResourceDescription, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, shareEntry=shareEntry, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, notificationSensorNumber=notificationSensorNumber, diskSequentialIOCount=diskSequentialIOCount, iscsiInitiatorIndex=iscsiInitiatorIndex, fcInitiatorGroup=fcInitiatorGroup, smisServiceStopFailed=smisServiceStopFailed, projectFreeSizeLow=projectFreeSizeLow, poolTotalSaving=poolTotalSaving, shareReservedSizeLow=shareReservedSizeLow, projectCompressionEnabled=projectCompressionEnabled, networkInterfaceDown=networkInterfaceDown, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, deleteFolderFailed=deleteFolderFailed, lunFreeSizeLow=lunFreeSizeLow, projectDeletionFailed=projectDeletionFailed, shareNFSWriteLatency=shareNFSWriteLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, diskTotalReadMbps=diskTotalReadMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectQuotaSizeHigh=projectQuotaSizeHigh, diskAvgReadLatency=diskAvgReadLatency, iscsiTargetGroupError=iscsiTargetGroupError, replicationSourceRegistered=replicationSourceRegistered, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, lunTable=lunTable, poolMetaWriteLatency=poolMetaWriteLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, shareNFSReadMbps=shareNFSReadMbps, nfsAvgReadLatency=nfsAvgReadLatency, projectQuotaFinished=projectQuotaFinished, iscsiTargetReadMbps=iscsiTargetReadMbps, netbiosSocketFailure=netbiosSocketFailure, poolIndex=poolIndex, iscsiInitiatorsTable=iscsiInitiatorsTable, poolDataSizeHigh=poolDataSizeHigh, networkInterfaceUp=networkInterfaceUp, haResourceName=haResourceName, poolDataReadIops=poolDataReadIops, nfsAvgWriteLatency=nfsAvgWriteLatency, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, adServerTimeDrift=adServerTimeDrift, fcTargetReadMbps=fcTargetReadMbps, notifications=notifications, poolAvgWriteLatency=poolAvgWriteLatency, ipmiFan=ipmiFan, smisServiceStarted=smisServiceStarted, upgradeDownloadCompleted=upgradeDownloadCompleted, targetGroupCreateCompleted=targetGroupCreateCompleted, notificationDescription=notificationDescription, poolImported=poolImported, controllerTimeDrift=controllerTimeDrift, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, projectDeleted=projectDeleted, poolDataWriteMbps=poolDataWriteMbps, lunName=lunName, replicationPaused=replicationPaused, iscsiTargetError=iscsiTargetError, nicTable=nicTable, targetGroupMemberRemoved=targetGroupMemberRemoved, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, notificationComponentName=notificationComponentName, pools=pools, poolDataWriteIops=poolDataWriteIops, intelliFlashSoftwareUp=intelliFlashSoftwareUp, poolFreeSizeLow=poolFreeSizeLow, iscsiTargetAuth=iscsiTargetAuth, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, fcTotalReadIops=fcTotalReadIops, poolTotalReadIops=poolTotalReadIops, shareMountPoint=shareMountPoint, maintenanceModeEnabled=maintenanceModeEnabled, haControllerA_Name=haControllerA_Name, lunIndex=lunIndex, targetGroupMemberAdded=targetGroupMemberAdded, snmpServiceStarted=snmpServiceStarted, cacheRAMReads=cacheRAMReads, cifsTotalWriteMbps=cifsTotalWriteMbps, iscsiWriteIops=iscsiWriteIops, nfsTotalWriteIops=nfsTotalWriteIops, sharePoolName=sharePoolName, snmpServiceStopped=snmpServiceStopped, tegileGroups=tegileGroups, lunSizeLow=lunSizeLow, fcInitiatorIndex=fcInitiatorIndex, poolSizeHigh=poolSizeHigh, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, shareIndex=shareIndex, iscsiInitiatorName=iscsiInitiatorName, smbSocketFailure=smbSocketFailure, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, cacheTotalReadMbps=cacheTotalReadMbps, fcTargetIndex=fcTargetIndex, lunSnapshotSizeLow=lunSnapshotSizeLow, haControllerB_IPAddr=haControllerB_IPAddr, fcTotalWriteMbps=fcTotalWriteMbps, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, shareQuotaLow=shareQuotaLow, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, nicMTU=nicMTU, tdpsUpgradeFailed=tdpsUpgradeFailed, notificationReadingUnit=notificationReadingUnit, cifsTotalWriteIops=cifsTotalWriteIops, fcTargetGroup=fcTargetGroup, poolMetaWriteIops=poolMetaWriteIops, shareCIFSReadLatency=shareCIFSReadLatency, diskDataReadIops=diskDataReadIops, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, poolName=poolName, projectDataSizeLow=projectDataSizeLow, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, tegile=tegile, haControllerA_Uptime=haControllerA_Uptime, nicIndex=nicIndex, poolExpanded=poolExpanded, fcAvgWriteLatency=fcAvgWriteLatency, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, diskDataReadMbps=diskDataReadMbps, nvdimmFailDeviceError=nvdimmFailDeviceError, poolUsedSizeHigh=poolUsedSizeHigh, fcInitiators=fcInitiators, projectSnapshotSizeHigh=projectSnapshotSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, replicationAbandoned=replicationAbandoned, fcInitiatorName=fcInitiatorName, lunProjectName=lunProjectName, poolReadCacheReadLatency=poolReadCacheReadLatency, fcTargetWriteMbps=fcTargetWriteMbps, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, diskIndex=diskIndex, snapshotRollbackFailed=snapshotRollbackFailed, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, tegileArray=tegileArray, poolFreeSizeHigh=poolFreeSizeHigh, lunReservedSizeLow=lunReservedSizeLow, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, cpuInterrupts=cpuInterrupts, shareName=shareName, currentObjectGroup=currentObjectGroup, cpuTotalUsage=cpuTotalUsage, lunReadLatency=lunReadLatency, shareDataSizeHigh=shareDataSizeHigh, lunReservedSizeHigh=lunReservedSizeHigh, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, shareCompressedRatio=shareCompressedRatio, lunTargetGroup=lunTargetGroup, shareCIFSWriteIops=shareCIFSWriteIops, poolState=poolState, nfsTotalReadMbps=nfsTotalReadMbps, projectThresholdExceedWarning=projectThresholdExceedWarning, poolProjectCount=poolProjectCount, sanProperties=sanProperties, projectDedupEnabled=projectDedupEnabled, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, lunReadIops=lunReadIops, shareProjectName=shareProjectName, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, shareDeletionFailed=shareDeletionFailed, diskRandomIOCount=diskRandomIOCount, notificationProps=notificationProps, poolUsedSizeLow=poolUsedSizeLow, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcTargets=fcTargets, poolDataSizeLow=poolDataSizeLow, shareNFSEnabled=shareNFSEnabled, ipmiVoltage=ipmiVoltage, fcInitiatorCreateFailed=fcInitiatorCreateFailed, fcTargetStatus=fcTargetStatus, notificationTargetEntityName=notificationTargetEntityName, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcAvgReadLatency=fcAvgReadLatency, iscsiTargetWriteIops=iscsiTargetWriteIops, lunCompressedRatio=lunCompressedRatio, replicationResumed=replicationResumed, snapshotCreationFailed=snapshotCreationFailed, projectCreatedSuccessfully=projectCreatedSuccessfully, diskSizeLow=diskSizeLow, diskTotalWriteIops=diskTotalWriteIops, projectShares=projectShares, shareCIFSReadIops=shareCIFSReadIops, fcTargetName=fcTargetName, ipmiPowerSupply=ipmiPowerSupply, diskGoneOffline=diskGoneOffline, networkIpmpGroupUp=networkIpmpGroupUp, tegileArray_notifications=tegileArray_notifications, iscsiAvgReadLatency=iscsiAvgReadLatency, lunFreeSizeHigh=lunFreeSizeHigh, ipmiThreshold=ipmiThreshold, cacheSSDReads=cacheSSDReads, shareCompressionEnabled=shareCompressionEnabled, networkIpmpGroupDown=networkIpmpGroupDown, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareCIFSWriteLatency=shareCIFSWriteLatency, iscsiTargetReadIops=iscsiTargetReadIops, cacheTotalWriteIops=cacheTotalWriteIops, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, snmpServiceStartFailed=snmpServiceStartFailed, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolExported=poolExported, nicGroup=nicGroup, cifsTotalReadIops=cifsTotalReadIops, iscsiInitiators=iscsiInitiators, fcTargetWriteLatency=fcTargetWriteLatency, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, nicTransmitMbps=nicTransmitMbps, shareQuotaFinished=shareQuotaFinished, ntpServerTimeDrift=ntpServerTimeDrift, shareCIFSWriteMbps=shareCIFSWriteMbps, tegileConformance=tegileConformance, haControllerB_Name=haControllerB_Name, memoryFailure=memoryFailure, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcPortOnline=fcPortOnline, lunWriteIops=lunWriteIops, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, tegileCompliances=tegileCompliances, shareDeleted=shareDeleted, poolCount=poolCount)
mibBuilder.exportSymbols("TEGILE-MIB", lunReadMbps=lunReadMbps, haResourceStatus=haResourceStatus, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolReadCacheReadIops=poolReadCacheReadIops, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, iscsiTotalWriteMbps=iscsiTotalWriteMbps, notificationReadingTriggerValue=notificationReadingTriggerValue, initiatorGroupMemberAdded=initiatorGroupMemberAdded, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, poolTable=poolTable, shareCreatedSuccessfully=shareCreatedSuccessfully, globalStatistics=globalStatistics, vmwareNFSDatastores=vmwareNFSDatastores, poolTotalWriteMbps=poolTotalWriteMbps, poolEntry=poolEntry, shareTable=shareTable, volumeDeleteFailed=volumeDeleteFailed, iscsiTargetIndex=iscsiTargetIndex, deleteFolderCompleted=deleteFolderCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, PYSNMP_MODULE_ID=tegile, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskAvgWriteLatency=diskAvgWriteLatency, projectLUNs=projectLUNs, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, poolMetaWriteMbps=poolMetaWriteMbps, snapshotRollbackCompleted=snapshotRollbackCompleted, projectDataSizeHigh=projectDataSizeHigh, shareDataSizeLow=shareDataSizeLow, fcPortOffline=fcPortOffline, iscsiImproperTargetGroup=iscsiImproperTargetGroup, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, ipmiOther=ipmiOther, cacheTotalWriteMbps=cacheTotalWriteMbps, projectEntry=projectEntry, lunSizeHigh=lunSizeHigh, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, replicationTargetDeleted=replicationTargetDeleted, haResourceActiveNode=haResourceActiveNode, network=network, diskState=diskState, shareNFSReadIops=shareNFSReadIops, aclMigrationCompleted=aclMigrationCompleted, volumeQuotaFinished=volumeQuotaFinished, lunGUID=lunGUID, iscsiTotalReadIops=iscsiTotalReadIops, networkTotalReceiveMbps=networkTotalReceiveMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, nicState=nicState, lunBlockSize=lunBlockSize, poolMetaReadIops=poolMetaReadIops, poolDataWriteLatency=poolDataWriteLatency, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, lunDataSizeLow=lunDataSizeLow, iscsiInitiatorEntry=iscsiInitiatorEntry, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, haControllerB_Uptime=haControllerB_Uptime, nicName=nicName, nicReceiveMbps=nicReceiveMbps, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, poolTotalReadMbps=poolTotalReadMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, fcTargetWriteIops=fcTargetWriteIops, shareNFSReadLatency=shareNFSReadLatency, upgradeStarted=upgradeStarted, diagnosticDataUploaded=diagnosticDataUploaded, controllerUp=controllerUp, lunCompressionEnabled=lunCompressionEnabled, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, haControllerA_IPAddr=haControllerA_IPAddr, poolDeletionFailed=poolDeletionFailed, lunInitiatorGroup=lunInitiatorGroup, shareSnapshotSizeHigh=shareSnapshotSizeHigh, replicationFailed=replicationFailed, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiTargetsTable=iscsiTargetsTable, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, iscsiTargets=iscsiTargets, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, haResourceGroup=haResourceGroup, diskType=diskType, lunDedupEnabled=lunDedupEnabled, cpuSystemCalls=cpuSystemCalls, snapshotDeleteFailed=snapshotDeleteFailed, iscsiTargetEntry=iscsiTargetEntry, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectShareCount=projectShareCount, nvdimmFailSoftError=nvdimmFailSoftError, lunProtocol=lunProtocol, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, fcTargetsTable=fcTargetsTable, projectName=projectName, projectIndex=projectIndex, shareSnapshotSizeLow=shareSnapshotSizeLow, snmpAgentVersion=snmpAgentVersion, volumeCreatedSuccessfully=volumeCreatedSuccessfully, iscsiAvgWriteLatency=iscsiAvgWriteLatency, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, fcInitiatorEntry=fcInitiatorEntry, poolCreated=poolCreated, upgradeDownloadStarted=upgradeDownloadStarted, webdocsUpgradeCompleted=webdocsUpgradeCompleted, ipmiCurrent=ipmiCurrent, shareExceedThresholdWarning=shareExceedThresholdWarning, haResourceEntry=haResourceEntry, poolReadCacheWriteLatency=poolReadCacheWriteLatency, userLoginFailed=userLoginFailed, poolUpgraded=poolUpgraded, notificationSeverity=notificationSeverity, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, projectSnapshotSizeLow=projectSnapshotSizeLow, smisServiceStopped=smisServiceStopped, poolReadCacheWriteIops=poolReadCacheWriteIops, snapshotCloneCompleted=snapshotCloneCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, diskIOCount=diskIOCount, basicCompliance=basicCompliance, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolMetaReadMbps=poolMetaReadMbps, shareCIFSReadMbps=shareCIFSReadMbps, iscsiInitiatorChapUser=iscsiInitiatorChapUser, controllerHardwareModel=controllerHardwareModel, diskIsOnline=diskIsOnline, diskTable=diskTable, lunPoolName=lunPoolName, fcTotalWriteIops=fcTotalWriteIops, projectFreeSizeHigh=projectFreeSizeHigh, projectLunCount=projectLunCount, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, poolDataReadMbps=poolDataReadMbps, diskSlowIo=diskSlowIo, nvdimmFailInitializationError=nvdimmFailInitializationError, diskCount=diskCount, alertsCleanupCompleted=alertsCleanupCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, fcProperties=fcProperties, poolHealth=poolHealth, shareReservedSizeHigh=shareReservedSizeHigh, shareNFSWriteMbps=shareNFSWriteMbps, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, upgradeDownloadFailed=upgradeDownloadFailed, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, intelliFlashSoftwareDown=intelliFlashSoftwareDown, replicationStarted=replicationStarted, iscsiProperties=iscsiProperties, projectTable=projectTable, fcTargetEntry=fcTargetEntry, properties=properties, nfsTotalWriteMbps=nfsTotalWriteMbps, smisServiceStartFailed=smisServiceStartFailed, iscsiTargetWriteLatency=iscsiTargetWriteLatency, fcTargetModifyCompleted=fcTargetModifyCompleted, cifsAvgReadLatency=cifsAvgReadLatency, fcTotalReadMbps=fcTotalReadMbps, aclMigrationStarted=aclMigrationStarted, shareQuotaHigh=shareQuotaHigh, diskSizeHigh=diskSizeHigh, volumeModifyCompleted=volumeModifyCompleted, shareCIFSEnabled=shareCIFSEnabled, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, ipmiMemory=ipmiMemory, fcTargetReadLatency=fcTargetReadLatency, notificationObjects=notificationObjects, snapshotCloningFailed=snapshotCloningFailed, upgradeTimeout=upgradeTimeout, ipmiTemperature=ipmiTemperature, haResourcesTable=haResourcesTable, controllerDown=controllerDown, maintenanceModeDisabled=maintenanceModeDisabled, projectPoolName=projectPoolName, lunDataSizeHigh=lunDataSizeHigh, poolProjects=poolProjects, iscsiTargetWriteMbps=iscsiTargetWriteMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, spareDiskReplaced=spareDiskReplaced, notificationSensorAction=notificationSensorAction, poolWriteCacheWriteIops=poolWriteCacheWriteIops, cacheTotalReadIops=cacheTotalReadIops, volumeDeleteCompleted=volumeDeleteCompleted, upgradeCompleted=upgradeCompleted, iscsiTargetGroup=iscsiTargetGroup, notificationSensorSuspect=notificationSensorSuspect, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, networkTotalTransmitMbps=networkTotalTransmitMbps, diskAlias=diskAlias, poolQuotaFinished=poolQuotaFinished, poolSizeLow=poolSizeLow, shareNFSWriteIops=shareNFSWriteIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolAvgReadLatency=poolAvgReadLatency, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, diskError=diskError, diskChassisIdx=diskChassisIdx, haResources=haResources, poolOwnerController=poolOwnerController, iscsiTotalReadMbps=iscsiTotalReadMbps, testNotification=testNotification, replicationComplete=replicationComplete, shareDedupEnabled=shareDedupEnabled, diskEntry=diskEntry, iscsiTargetName=iscsiTargetName, notificationTime=notificationTime, sensorFailureEvent=sensorFailureEvent, diskTotalWriteMbps=diskTotalWriteMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, fcInitiatorsTable=fcInitiatorsTable, poolDegraded=poolDegraded, poolMetaReadLatency=poolMetaReadLatency, lunWriteLatency=lunWriteLatency, projectModified=projectModified, haResourceIndex=haResourceIndex, diskTotalReadIops=diskTotalReadIops, poolDeleted=poolDeleted)
