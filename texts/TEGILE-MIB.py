...
Counter64, Gauge32, iso, IpAddress, TimeTicks, Bits, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, Integer32, Unsigned32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "iso", "IpAddress", "TimeTicks", "Bits", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "Integer32", "Unsigned32", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("TEGILE-MIB", networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, upgradeTimeout=upgradeTimeout, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, haResourceName=haResourceName, nvdimmFailDeviceError=nvdimmFailDeviceError, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, diskDataWriteIops=diskDataWriteIops, tegileConformance=tegileConformance, diskTotalWriteMbps=diskTotalWriteMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, volumeDeleteFailed=volumeDeleteFailed, lunPoolName=lunPoolName, poolHealth=poolHealth, projectIndex=projectIndex, diskType=diskType, networkInterfaceUp=networkInterfaceUp, controllerHardwareModel=controllerHardwareModel, volumeDeleteCompleted=volumeDeleteCompleted, fcTargetName=fcTargetName, PYSNMP_MODULE_ID=tegile, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiAvgWriteLatency=iscsiAvgWriteLatency, projectShares=projectShares, lunGUID=lunGUID, iscsiInitiators=iscsiInitiators, sharePoolName=sharePoolName, upgradeDownloadStarted=upgradeDownloadStarted, poolImported=poolImported, snmpServiceStopped=snmpServiceStopped, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, lunDedupEnabled=lunDedupEnabled, iscsiTargetReadIops=iscsiTargetReadIops, fcTargetWriteLatency=fcTargetWriteLatency, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, snapshotDeleteFailed=snapshotDeleteFailed, diskTotalWriteIops=diskTotalWriteIops, replicationResumed=replicationResumed, unknownSensorEvent=unknownSensorEvent, spareDiskReplaced=spareDiskReplaced, shareNFSReadMbps=shareNFSReadMbps, poolIndex=poolIndex, poolReadCacheWriteMbps=poolReadCacheWriteMbps, poolOwnerController=poolOwnerController, poolCreated=poolCreated, nvdimmFailInitializationError=nvdimmFailInitializationError, poolTotalSaving=poolTotalSaving, nicEntry=nicEntry, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, shareCompressedRatio=shareCompressedRatio, lunFreeSizeLow=lunFreeSizeLow, poolUsedSizeHigh=poolUsedSizeHigh, shareNFSWriteMbps=shareNFSWriteMbps, iscsiTargetAlias=iscsiTargetAlias, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, lunWriteLatency=lunWriteLatency, snmpServiceStarted=snmpServiceStarted, network=network, fcTargetReadMbps=fcTargetReadMbps, diskTotalReadMbps=diskTotalReadMbps, snapshotCloningFailed=snapshotCloningFailed, poolState=poolState, notificationReadingUnit=notificationReadingUnit, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, diskIndex=diskIndex, shareDeleted=shareDeleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, cifsTotalWriteIops=cifsTotalWriteIops, iscsiProperties=iscsiProperties, haControllerA_Uptime=haControllerA_Uptime, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, snapshotCreationFailed=snapshotCreationFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, fcTargetWriteMbps=fcTargetWriteMbps, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, networkTotalTransmitMbps=networkTotalTransmitMbps, projectSnapshotSizeLow=projectSnapshotSizeLow, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, upgradeCompleted=upgradeCompleted, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, ntpServerTimeDrift=ntpServerTimeDrift, lunCompressionEnabled=lunCompressionEnabled, haResourceIndex=haResourceIndex, poolExported=poolExported, controllerTimeDrift=controllerTimeDrift, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, projectShareCount=projectShareCount, iscsiTargetIndex=iscsiTargetIndex, cpuTotalUsage=cpuTotalUsage, ipmiThreshold=ipmiThreshold, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, shareQuotaHigh=shareQuotaHigh, lunWriteIops=lunWriteIops, haControllerB_Uptime=haControllerB_Uptime, lunSnapshotSizeHigh=lunSnapshotSizeHigh, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, poolDeleted=poolDeleted, poolUpgraded=poolUpgraded, haResourceDescription=haResourceDescription, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, replicationAborted=replicationAborted, iscsiWriteIops=iscsiWriteIops, projectFreeSizeHigh=projectFreeSizeHigh, fcProperties=fcProperties, iscsiInitiatorChapUser=iscsiInitiatorChapUser, notificationSensorNumber=notificationSensorNumber, iscsiImproperTargetGroup=iscsiImproperTargetGroup, controllerUp=controllerUp, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcTargets=fcTargets, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, poolSizeHigh=poolSizeHigh, initiatorGroupMemberAdded=initiatorGroupMemberAdded, lunIndex=lunIndex, shareCIFSReadIops=shareCIFSReadIops, projectPoolName=projectPoolName, iscsiTargetAuth=iscsiTargetAuth, fcInitiatorName=fcInitiatorName, iscsiTargetError=iscsiTargetError, iscsiInitiatorGroup=iscsiInitiatorGroup, notificationComponentName=notificationComponentName, shareMountPoint=shareMountPoint, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, fcTargetsTable=fcTargetsTable, shareCIFSWriteIops=shareCIFSWriteIops, diskSizeHigh=diskSizeHigh, poolUsedSizeLow=poolUsedSizeLow, lunReadLatency=lunReadLatency, smisServiceStopped=smisServiceStopped, iscsiTargetEntry=iscsiTargetEntry, poolDataReadIops=poolDataReadIops, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, cpuSystemCalls=cpuSystemCalls, nicName=nicName, notificationEventCode=notificationEventCode, fcTargetStatus=fcTargetStatus, shareEntry=shareEntry, testNotification=testNotification, shareCIFSEnabled=shareCIFSEnabled, ipmiCriticalInterrupt=ipmiCriticalInterrupt, projectSnapshotSizeHigh=projectSnapshotSizeHigh, fcTotalWriteIops=fcTotalWriteIops, poolTable=poolTable, shareNFSReadIops=shareNFSReadIops, notificationSeverity=notificationSeverity, projectDedupEnabled=projectDedupEnabled, notificationTime=notificationTime, diskError=diskError, replicationTargetDeleted=replicationTargetDeleted, lunBlockSize=lunBlockSize, projectFreeSizeLow=projectFreeSizeLow, nicGroup=nicGroup, iscsiTargetWriteIops=iscsiTargetWriteIops, haResources=haResources, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, lunSizeLow=lunSizeLow, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, poolDataWriteIops=poolDataWriteIops, lunReadIops=lunReadIops, fcPortOffline=fcPortOffline, iscsiTotalReadIops=iscsiTotalReadIops, nicIndex=nicIndex, fcTotalWriteMbps=fcTotalWriteMbps, haControllerB_Name=haControllerB_Name, cifsTotalWriteMbps=cifsTotalWriteMbps, lunDataSizeLow=lunDataSizeLow, snapshotCloneCompleted=snapshotCloneCompleted, tegileGroups=tegileGroups, diskTable=diskTable, diskIsOnline=diskIsOnline, deleteFolderCompleted=deleteFolderCompleted, notificationSensorAction=notificationSensorAction, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diskDataReadIops=diskDataReadIops, poolReadCacheReadIops=poolReadCacheReadIops, projectEntry=projectEntry, iscsiTargetReadMbps=iscsiTargetReadMbps, nicMTU=nicMTU, poolExpanded=poolExpanded, networkIpmpGroupUp=networkIpmpGroupUp, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolMetaWriteLatency=poolMetaWriteLatency, adServerTimeDrift=adServerTimeDrift, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, haControllerB_IPAddr=haControllerB_IPAddr, lunFreeSizeHigh=lunFreeSizeHigh, poolFreeSizeLow=poolFreeSizeLow, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, smisServiceStarted=smisServiceStarted, shareProjectName=shareProjectName, lunProjectName=lunProjectName, lunSnapshotSizeLow=lunSnapshotSizeLow, cacheTotalReadIops=cacheTotalReadIops, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, properties=properties, nfsAvgWriteLatency=nfsAvgWriteLatency, nfsAvgReadLatency=nfsAvgReadLatency, lunEntry=lunEntry, shareQuotaFinished=shareQuotaFinished, lunInitiatorGroup=lunInitiatorGroup, diskDataReadMbps=diskDataReadMbps, fcAvgReadLatency=fcAvgReadLatency, projectTable=projectTable, nicTransmitMbps=nicTransmitMbps, projectQuotaSizeLow=projectQuotaSizeLow, maintenanceModeEnabled=maintenanceModeEnabled, poolDataReadMbps=poolDataReadMbps, projectCompressionEnabled=projectCompressionEnabled, shareCIFSReadLatency=shareCIFSReadLatency, notificationReadingTriggerValue=notificationReadingTriggerValue, projectQuotaFinished=projectQuotaFinished, projectName=projectName, networkIpmpGroupDown=networkIpmpGroupDown, fcTotalReadMbps=fcTotalReadMbps, aclMigrationStarted=aclMigrationStarted, tegileArray_notifications=tegileArray_notifications, iscsiTotalReadMbps=iscsiTotalReadMbps, fcTargetGroup=fcTargetGroup, shareSnapshotSizeLow=shareSnapshotSizeLow, networkInterfaceDown=networkInterfaceDown, diskPoolName=diskPoolName, replicationPaused=replicationPaused, lunTargetGroup=lunTargetGroup, notifications=notifications, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, notificationObjects=notificationObjects, shareDataSizeHigh=shareDataSizeHigh, replicationFailed=replicationFailed, shareExceedThresholdWarning=shareExceedThresholdWarning, shareDataSizeLow=shareDataSizeLow, projectLUNs=projectLUNs, poolDataWriteMbps=poolDataWriteMbps, projectDeletionFailed=projectDeletionFailed, vmwareNFSDatastores=vmwareNFSDatastores, poolMetaReadLatency=poolMetaReadLatency, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, disks=disks, poolDataSizeLow=poolDataSizeLow, poolWriteCacheWriteIops=poolWriteCacheWriteIops, iscsiTargets=iscsiTargets, snapshotRollbackFailed=snapshotRollbackFailed, ipmiOther=ipmiOther, poolMetaReadIops=poolMetaReadIops, ipmiFan=ipmiFan, haControllerA_IPAddr=haControllerA_IPAddr, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, shareTable=shareTable, haResourcesTable=haResourcesTable, lunTable=lunTable, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved)
mibBuilder.exportSymbols("TEGILE-MIB", shareNFSEnabled=shareNFSEnabled, iscsiTargetReadLatency=iscsiTargetReadLatency, diagnosticDataUploaded=diagnosticDataUploaded, nvdimmFailUnknownError=nvdimmFailUnknownError, userLoginFailed=userLoginFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, snapshotRollbackCompleted=snapshotRollbackCompleted, upgradeDownloadCompleted=upgradeDownloadCompleted, poolTotalWriteMbps=poolTotalWriteMbps, replicationComplete=replicationComplete, poolTotalReadIops=poolTotalReadIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcTargetEntry=fcTargetEntry, cpuInterrupts=cpuInterrupts, fcAvgWriteLatency=fcAvgWriteLatency, fcTargetReadLatency=fcTargetReadLatency, cacheSSDReads=cacheSSDReads, diskState=diskState, webdocsUpgradeFailed=webdocsUpgradeFailed, haControllerA_Name=haControllerA_Name, projectCreatedSuccessfully=projectCreatedSuccessfully, smisServiceStopFailed=smisServiceStopFailed, ipmiCurrent=ipmiCurrent, shareReservedSizeHigh=shareReservedSizeHigh, diskAlias=diskAlias, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, netbiosSocketFailure=netbiosSocketFailure, shareName=shareName, diskRandomIOCount=diskRandomIOCount, haResourceGroup=haResourceGroup, poolReadCacheWriteIops=poolReadCacheWriteIops, cifsAvgWriteLatency=cifsAvgWriteLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, cifsTotalReadIops=cifsTotalReadIops, projectDataSizeLow=projectDataSizeLow, projectThresholdExceedWarning=projectThresholdExceedWarning, poolDeletionFailed=poolDeletionFailed, targetGroupMemberRemoved=targetGroupMemberRemoved, lunReservedSizeHigh=lunReservedSizeHigh, poolDegraded=poolDegraded, diskDataWriteMbps=diskDataWriteMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, cifsTotalReadMbps=cifsTotalReadMbps, poolFreeSizeHigh=poolFreeSizeHigh, iscsiInitiatorName=iscsiInitiatorName, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcTargetIndex=fcTargetIndex, poolDataWriteLatency=poolDataWriteLatency, poolReadCacheReadLatency=poolReadCacheReadLatency, aclMigrationCompleted=aclMigrationCompleted, lunReadMbps=lunReadMbps, projectTotalSaving=projectTotalSaving, controllerDown=controllerDown, shareNFSWriteLatency=shareNFSWriteLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, globalStatistics=globalStatistics, haResourceEntry=haResourceEntry, ipmiTemperature=ipmiTemperature, nvdimmFailSoftError=nvdimmFailSoftError, poolEntry=poolEntry, iscsiTargetsTable=iscsiTargetsTable, poolProjectCount=poolProjectCount, fcTargetModifyCompleted=fcTargetModifyCompleted, notificationTargetEntityName=notificationTargetEntityName, volumeModifyCompleted=volumeModifyCompleted, shareDeletionFailed=shareDeletionFailed, basicCompliance=basicCompliance, lunWriteMbps=lunWriteMbps, nfsTotalWriteIops=nfsTotalWriteIops, maintenanceModeDisabled=maintenanceModeDisabled, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, cacheRAMReads=cacheRAMReads, poolQuotaFinished=poolQuotaFinished, ipmiVoltage=ipmiVoltage, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, diskIOCount=diskIOCount, projectLunCount=projectLunCount, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, shareCompressionEnabled=shareCompressionEnabled, sanProperties=sanProperties, fcInitiatorGroup=fcInitiatorGroup, cacheTotalWriteMbps=cacheTotalWriteMbps, snmpServiceStartFailed=snmpServiceStartFailed, currentNotificationGroup=currentNotificationGroup, lunSizeHigh=lunSizeHigh, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, shareNFSWriteIops=shareNFSWriteIops, poolTotalReadMbps=poolTotalReadMbps, shareReservedSizeLow=shareReservedSizeLow, fcInitiators=fcInitiators, diskSizeLow=diskSizeLow, shareNFSReadLatency=shareNFSReadLatency, fcInitiatorsTable=fcInitiatorsTable, upgradeFailed=upgradeFailed, memoryFailure=memoryFailure, diskChassisIdx=diskChassisIdx, cacheTotalReadMbps=cacheTotalReadMbps, tegileArray=tegileArray, lunDataSizeHigh=lunDataSizeHigh, poolCount=poolCount, poolMetaWriteIops=poolMetaWriteIops, fcTargetWriteIops=fcTargetWriteIops, ipmiPowerSupply=ipmiPowerSupply, shareSnapshotSizeHigh=shareSnapshotSizeHigh, intelliFlashSoftwareDown=intelliFlashSoftwareDown, shareCIFSWriteMbps=shareCIFSWriteMbps, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectDeleted=projectDeleted, nicReceiveMbps=nicReceiveMbps, targetGroupMemberAdded=targetGroupMemberAdded, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, deleteFolderFailed=deleteFolderFailed, upgradeStarted=upgradeStarted, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, iscsiInitiatorsTable=iscsiInitiatorsTable, cacheTotalWriteIops=cacheTotalWriteIops, poolName=poolName, lunCompressedRatio=lunCompressedRatio, haResourceStatus=haResourceStatus, smisServiceStartFailed=smisServiceStartFailed, pools=pools, fcInitiatorEntry=fcInitiatorEntry, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diskTotalReadIops=diskTotalReadIops, iscsiInitiatorEntry=iscsiInitiatorEntry, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, notificationProps=notificationProps, notificationSensorSuspect=notificationSensorSuspect, poolDataSizeHigh=poolDataSizeHigh, webdocsUpgradeCompleted=webdocsUpgradeCompleted, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, projectDataSizeHigh=projectDataSizeHigh, diskAvgWriteLatency=diskAvgWriteLatency, diskSequentialIOCount=diskSequentialIOCount, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, poolTotalWriteIops=poolTotalWriteIops, diskEntry=diskEntry, poolMetaWriteMbps=poolMetaWriteMbps, sensorFailureEvent=sensorFailureEvent, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, poolDataReadLatency=poolDataReadLatency, shareDedupEnabled=shareDedupEnabled, replicationStarted=replicationStarted, projectQuotaSizeHigh=projectQuotaSizeHigh, diskCount=diskCount, fcPortOnline=fcPortOnline, poolProjects=poolProjects, nicTable=nicTable, fcTargetReadIops=fcTargetReadIops, poolAvgReadLatency=poolAvgReadLatency, intelliFlashSoftwareUp=intelliFlashSoftwareUp, replicationAbandoned=replicationAbandoned, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, ipmiMemory=ipmiMemory, fcInitiatorCreateFailed=fcInitiatorCreateFailed, snmpServiceStopFailed=snmpServiceStopFailed, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, iscsiTargetGroup=iscsiTargetGroup, smbSocketFailure=smbSocketFailure, cifsAvgReadLatency=cifsAvgReadLatency, fcTotalReadIops=fcTotalReadIops, tegileCompliances=tegileCompliances, networkTotalReceiveMbps=networkTotalReceiveMbps, snmpAgentVersion=snmpAgentVersion, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, alertsCleanupCompleted=alertsCleanupCompleted, nfsTotalReadIops=nfsTotalReadIops, tegile=tegile, haResourceActiveNode=haResourceActiveNode, fcInitiatorIndex=fcInitiatorIndex, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, nfsTotalReadMbps=nfsTotalReadMbps, volumeCreatedSuccessfully=volumeCreatedSuccessfully, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, diskAvgReadLatency=diskAvgReadLatency, lunProtocol=lunProtocol, currentObjectGroup=currentObjectGroup, iscsiTargetWriteLatency=iscsiTargetWriteLatency, poolReadCacheWriteLatency=poolReadCacheWriteLatency, notificationDescription=notificationDescription, upgradeDownloadFailed=upgradeDownloadFailed, targetGroupDeleteCompleted=targetGroupDeleteCompleted, diskSlowIo=diskSlowIo, nicState=nicState, volumeQuotaFinished=volumeQuotaFinished, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, poolSizeLow=poolSizeLow, shareQuotaLow=shareQuotaLow, shareCIFSReadMbps=shareCIFSReadMbps, projectModified=projectModified, targetGroupCreateCompleted=targetGroupCreateCompleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, poolAvgWriteLatency=poolAvgWriteLatency, tdpsUpgradeTimeout=tdpsUpgradeTimeout, replicationSourceRegistered=replicationSourceRegistered, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, shareCreatedSuccessfully=shareCreatedSuccessfully, lunName=lunName, diskGoneOffline=diskGoneOffline, lunReservedSizeLow=lunReservedSizeLow, iscsiTargetWriteMbps=iscsiTargetWriteMbps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, iscsiTargetGroupError=iscsiTargetGroupError, poolMetaReadMbps=poolMetaReadMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, shareIndex=shareIndex, iscsiTargetName=iscsiTargetName, tdpsUpgradeCompleted=tdpsUpgradeCompleted, poolReadCacheReadMbps=poolReadCacheReadMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion)
