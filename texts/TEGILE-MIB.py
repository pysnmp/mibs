...
# Produced by pysmi-1.1.0 at Tue Nov 16 11:58:55 2021
...
Counter64, ObjectIdentity, enterprises, TimeTicks, iso, Integer32, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Unsigned32, Bits, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "enterprises", "TimeTicks", "iso", "Integer32", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Unsigned32", "Bits", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("TEGILE-MIB", poolSizeHigh=poolSizeHigh, notificationSeverity=notificationSeverity, diskSizeLow=diskSizeLow, nicMTU=nicMTU, replicationStarted=replicationStarted, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, poolDataSizeHigh=poolDataSizeHigh, notificationReadingUnit=notificationReadingUnit, vmwareNFSDatastores=vmwareNFSDatastores, unknownSensorEvent=unknownSensorEvent, intelliFlashSoftwareUp=intelliFlashSoftwareUp, nicIndex=nicIndex, projectIndex=projectIndex, smisServiceStarted=smisServiceStarted, lunSnapshotSizeHigh=lunSnapshotSizeHigh, nicState=nicState, poolTotalReadMbps=poolTotalReadMbps, smbSocketFailure=smbSocketFailure, poolMetaWriteMbps=poolMetaWriteMbps, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diagnosticDataUploaded=diagnosticDataUploaded, fcInitiatorEntry=fcInitiatorEntry, diskDataWriteMbps=diskDataWriteMbps, poolTable=poolTable, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, networkInterfaceUp=networkInterfaceUp, diskTable=diskTable, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, diskIOCount=diskIOCount, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, lunSizeHigh=lunSizeHigh, projectTable=projectTable, shareDedupEnabled=shareDedupEnabled, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, shareIndex=shareIndex, diskAlias=diskAlias, fcTargetReadMbps=fcTargetReadMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, shareQuotaHigh=shareQuotaHigh, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, poolExported=poolExported, haResourceStatus=haResourceStatus, iscsiTotalReadMbps=iscsiTotalReadMbps, nfsTotalReadIops=nfsTotalReadIops, shareCIFSWriteIops=shareCIFSWriteIops, diskPoolName=diskPoolName, targetGroupDeleteCompleted=targetGroupDeleteCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, shareMountPoint=shareMountPoint, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, iscsiProperties=iscsiProperties, shareReservedSizeHigh=shareReservedSizeHigh, poolTotalWriteIops=poolTotalWriteIops, nicEntry=nicEntry, properties=properties, poolMetaWriteLatency=poolMetaWriteLatency, lunProjectName=lunProjectName, iscsiInitiatorIndex=iscsiInitiatorIndex, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolDataWriteMbps=poolDataWriteMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, diskDataReadMbps=diskDataReadMbps, shareCompressionEnabled=shareCompressionEnabled, ipmiFan=ipmiFan, poolTotalSaving=poolTotalSaving, lunFreeSizeLow=lunFreeSizeLow, fcInitiatorCreateFailed=fcInitiatorCreateFailed, iscsiAvgReadLatency=iscsiAvgReadLatency, ipmiVoltage=ipmiVoltage, shareNFSReadLatency=shareNFSReadLatency, projectDataSizeHigh=projectDataSizeHigh, lunReadIops=lunReadIops, poolProjectCount=poolProjectCount, notificationDescription=notificationDescription, shareProjectName=shareProjectName, poolFreeSizeLow=poolFreeSizeLow, projectEntry=projectEntry, diskTotalReadMbps=diskTotalReadMbps, sensorFailureEvent=sensorFailureEvent, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiTargetWriteLatency=iscsiTargetWriteLatency, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, smisServiceStartFailed=smisServiceStartFailed, lunReadLatency=lunReadLatency, globalStatistics=globalStatistics, fcTotalWriteMbps=fcTotalWriteMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, nfsTotalWriteIops=nfsTotalWriteIops, tegileGroups=tegileGroups, poolEntry=poolEntry, poolOwnerController=poolOwnerController, nicGroup=nicGroup, fcTargetReadLatency=fcTargetReadLatency, volumeModifyCompleted=volumeModifyCompleted, shareDeletionFailed=shareDeletionFailed, basicCompliance=basicCompliance, nicTable=nicTable, diskTotalWriteMbps=diskTotalWriteMbps, shareNFSReadMbps=shareNFSReadMbps, networkTotalReceiveMbps=networkTotalReceiveMbps, controllerDown=controllerDown, diskTotalReadIops=diskTotalReadIops, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, iscsiTargetsTable=iscsiTargetsTable, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, notificationObjects=notificationObjects, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, projectDeletionFailed=projectDeletionFailed, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, poolReadCacheWriteLatency=poolReadCacheWriteLatency, poolName=poolName, notificationSensorNumber=notificationSensorNumber, lunReadMbps=lunReadMbps, sanProperties=sanProperties, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, upgradeTimeout=upgradeTimeout, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, snapshotDeleteFailed=snapshotDeleteFailed, cifsTotalWriteIops=cifsTotalWriteIops, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, replicationPaused=replicationPaused, snmpServiceStopFailed=snmpServiceStopFailed, iscsiTargetGroup=iscsiTargetGroup, sharePoolName=sharePoolName, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, projectDeleted=projectDeleted, iscsiWriteIops=iscsiWriteIops, poolDataWriteLatency=poolDataWriteLatency, poolImported=poolImported, nicName=nicName, snapshotRollbackFailed=snapshotRollbackFailed, snapshotCloneCompleted=snapshotCloneCompleted, nfsAvgReadLatency=nfsAvgReadLatency, cifsAvgReadLatency=cifsAvgReadLatency, shareSnapshotSizeLow=shareSnapshotSizeLow, iscsiTotalReadIops=iscsiTotalReadIops, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiInitiatorGroup=iscsiInitiatorGroup, projectQuotaFinished=projectQuotaFinished, aclMigrationCompleted=aclMigrationCompleted, poolDeleted=poolDeleted, diskAvgWriteLatency=diskAvgWriteLatency, nfsTotalReadMbps=nfsTotalReadMbps, poolDataSizeLow=poolDataSizeLow, upgradeStarted=upgradeStarted, haControllerB_IPAddr=haControllerB_IPAddr, nvdimmFailUnknownError=nvdimmFailUnknownError, alertsCleanupCompleted=alertsCleanupCompleted, lunInitiatorGroup=lunInitiatorGroup, poolDegraded=poolDegraded, shareDataSizeHigh=shareDataSizeHigh, snmpAgentVersion=snmpAgentVersion, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, projectShareCount=projectShareCount, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, diskIsOnline=diskIsOnline, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, poolReadCacheReadLatency=poolReadCacheReadLatency, projectDedupEnabled=projectDedupEnabled, iscsiInitiators=iscsiInitiators, poolSizeLow=poolSizeLow, projectQuotaSizeLow=projectQuotaSizeLow, notificationSensorAction=notificationSensorAction, fcTargetModifyCompleted=fcTargetModifyCompleted, fcAvgReadLatency=fcAvgReadLatency, lunCompressionEnabled=lunCompressionEnabled, notificationTime=notificationTime, iscsiTargetIndex=iscsiTargetIndex, poolMetaReadLatency=poolMetaReadLatency, diskState=diskState, diskError=diskError, netbiosSocketFailure=netbiosSocketFailure, iscsiTargetGroupError=iscsiTargetGroupError, lunWriteLatency=lunWriteLatency, fcTotalReadIops=fcTotalReadIops, haControllerA_Uptime=haControllerA_Uptime, projectLUNs=projectLUNs, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectFreeSizeHigh=projectFreeSizeHigh, projectPoolName=projectPoolName, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, projectCompressionEnabled=projectCompressionEnabled, controllerHardwareModel=controllerHardwareModel, poolReadCacheWriteMbps=poolReadCacheWriteMbps, haControllerB_Uptime=haControllerB_Uptime, poolQuotaFinished=poolQuotaFinished, controllerUp=controllerUp, iscsiInitiatorsTable=iscsiInitiatorsTable, fcTargetStatus=fcTargetStatus, poolDataReadLatency=poolDataReadLatency, poolUsedSizeHigh=poolUsedSizeHigh, cifsTotalReadIops=cifsTotalReadIops, memoryFailure=memoryFailure, diskIndex=diskIndex, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, tegileArray_notifications=tegileArray_notifications, deleteFolderFailed=deleteFolderFailed, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, fcProperties=fcProperties, projectLunCount=projectLunCount, maintenanceModeEnabled=maintenanceModeEnabled, fcTargetGroup=fcTargetGroup, lunEntry=lunEntry, networkIpmpGroupUp=networkIpmpGroupUp, shareCIFSReadLatency=shareCIFSReadLatency, poolCount=poolCount, currentNotificationGroup=currentNotificationGroup, networkTotalTransmitMbps=networkTotalTransmitMbps, notificationTargetEntityName=notificationTargetEntityName, diskSizeHigh=diskSizeHigh, notificationComponentName=notificationComponentName, iscsiInitiatorName=iscsiInitiatorName, snapshotRollbackCompleted=snapshotRollbackCompleted, shareCIFSReadIops=shareCIFSReadIops, iscsiTargetWriteMbps=iscsiTargetWriteMbps, diskChassisIdx=diskChassisIdx, lunReservedSizeLow=lunReservedSizeLow, shareEntry=shareEntry, iscsiAvgWriteLatency=iscsiAvgWriteLatency, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, iscsiTargetError=iscsiTargetError, volumeCreatedSuccessfully=volumeCreatedSuccessfully, maintenanceModeDisabled=maintenanceModeDisabled, notificationProps=notificationProps, shareExceedThresholdWarning=shareExceedThresholdWarning, iscsiTargetReadLatency=iscsiTargetReadLatency, fcTargetIndex=fcTargetIndex, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, replicationAborted=replicationAborted, iscsiInitiatorEntry=iscsiInitiatorEntry, spareDiskReplaced=spareDiskReplaced, poolReadCacheWriteIops=poolReadCacheWriteIops, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, poolDataWriteIops=poolDataWriteIops, notificationEventCode=notificationEventCode, cpuInterrupts=cpuInterrupts, networkInterfaceDown=networkInterfaceDown, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolUsedSizeLow=poolUsedSizeLow, ntpServerTimeDrift=ntpServerTimeDrift, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, lunName=lunName, smisServiceStopFailed=smisServiceStopFailed, notificationThresholdTriggerValue=notificationThresholdTriggerValue, shareCIFSWriteLatency=shareCIFSWriteLatency, diskRandomIOCount=diskRandomIOCount, poolAvgReadLatency=poolAvgReadLatency, shareQuotaFinished=shareQuotaFinished, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, fcInitiatorGroup=fcInitiatorGroup)
mibBuilder.exportSymbols("TEGILE-MIB", diskGoneOffline=diskGoneOffline, poolTotalReadIops=poolTotalReadIops, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, fcTargetName=fcTargetName, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, ipmiThreshold=ipmiThreshold, shareQuotaLow=shareQuotaLow, iscsiTargetAuth=iscsiTargetAuth, shareDeleted=shareDeleted, shareCIFSWriteMbps=shareCIFSWriteMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, pools=pools, snapshotCreationFailed=snapshotCreationFailed, diskDataReadIops=diskDataReadIops, volumeDeleteFailed=volumeDeleteFailed, fcTargetWriteMbps=fcTargetWriteMbps, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, lunTargetGroup=lunTargetGroup, shareDataSizeLow=shareDataSizeLow, fcInitiatorName=fcInitiatorName, upgradeDownloadFailed=upgradeDownloadFailed, poolProjects=poolProjects, userLoginFailed=userLoginFailed, shareTable=shareTable, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, replicationTargetDeleted=replicationTargetDeleted, diskEntry=diskEntry, shareNFSWriteMbps=shareNFSWriteMbps, iscsiImproperTargetGroup=iscsiImproperTargetGroup, poolTotalWriteMbps=poolTotalWriteMbps, upgradeDownloadCompleted=upgradeDownloadCompleted, diskTotalWriteIops=diskTotalWriteIops, targetGroupCreateCompleted=targetGroupCreateCompleted, fcTotalReadMbps=fcTotalReadMbps, nfsAvgWriteLatency=nfsAvgWriteLatency, lunWriteMbps=lunWriteMbps, cacheTotalReadMbps=cacheTotalReadMbps, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, webdocsUpgradeFailed=webdocsUpgradeFailed, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, fcTargetReadIops=fcTargetReadIops, shareNFSEnabled=shareNFSEnabled, snapshotCloningFailed=snapshotCloningFailed, networkIpmpGroupDown=networkIpmpGroupDown, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, shareCIFSEnabled=shareCIFSEnabled, iscsiTargets=iscsiTargets, targetGroupMemberAdded=targetGroupMemberAdded, projectQuotaSizeHigh=projectQuotaSizeHigh, lunSizeLow=lunSizeLow, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, projectModified=projectModified, poolMetaReadMbps=poolMetaReadMbps, tegile=tegile, ipmiTemperature=ipmiTemperature, fcTargets=fcTargets, upgradeCompleted=upgradeCompleted, iscsiTargetEntry=iscsiTargetEntry, fcAvgWriteLatency=fcAvgWriteLatency, diskAvgReadLatency=diskAvgReadLatency, tegileCompliances=tegileCompliances, intelliFlashSoftwareDown=intelliFlashSoftwareDown, lunDedupEnabled=lunDedupEnabled, fcTargetEntry=fcTargetEntry, haResourceIndex=haResourceIndex, poolMetaWriteIops=poolMetaWriteIops, shareName=shareName, currentObjectGroup=currentObjectGroup, projectFreeSizeLow=projectFreeSizeLow, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, lunIndex=lunIndex, haResourceEntry=haResourceEntry, notificationSensorSuspect=notificationSensorSuspect, notificationReadingTriggerValue=notificationReadingTriggerValue, diskSlowIo=diskSlowIo, ipmiPowerSupply=ipmiPowerSupply, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, projectTotalSaving=projectTotalSaving, replicationSourceRegistered=replicationSourceRegistered, fcTargetsTable=fcTargetsTable, diskDataWriteIops=diskDataWriteIops, nvdimmFailInitializationError=nvdimmFailInitializationError, iscsiTargetReadIops=iscsiTargetReadIops, volumeDeleteCompleted=volumeDeleteCompleted, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, poolDataReadMbps=poolDataReadMbps, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, shareNFSWriteIops=shareNFSWriteIops, poolFreeSizeHigh=poolFreeSizeHigh, poolDeletionFailed=poolDeletionFailed, aclMigrationStarted=aclMigrationStarted, haControllerB_Name=haControllerB_Name, replicationAbandoned=replicationAbandoned, cifsTotalWriteMbps=cifsTotalWriteMbps, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, PYSNMP_MODULE_ID=tegile, fcTargetWriteIops=fcTargetWriteIops, shareCreatedSuccessfully=shareCreatedSuccessfully, lunTable=lunTable, nvdimmFailDeviceError=nvdimmFailDeviceError, ipmiCriticalInterrupt=ipmiCriticalInterrupt, lunDataSizeHigh=lunDataSizeHigh, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectShares=projectShares, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, haResources=haResources, iscsiTargetWriteIops=iscsiTargetWriteIops, poolHealth=poolHealth, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, notifications=notifications, fcTotalWriteIops=fcTotalWriteIops, network=network, projectCreatedSuccessfully=projectCreatedSuccessfully, fcInitiatorsTable=fcInitiatorsTable, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, adServerTimeDrift=adServerTimeDrift, lunReservedSizeHigh=lunReservedSizeHigh, shareCIFSReadMbps=shareCIFSReadMbps, nicReceiveMbps=nicReceiveMbps, poolState=poolState, diskSequentialIOCount=diskSequentialIOCount, fcInitiators=fcInitiators, replicationComplete=replicationComplete, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolUpgraded=poolUpgraded, snmpServiceStopped=snmpServiceStopped, disks=disks, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, snmpServiceStarted=snmpServiceStarted, iscsiTargetName=iscsiTargetName, webdocsUpgradeCompleted=webdocsUpgradeCompleted, lunCompressedRatio=lunCompressedRatio, haResourceDescription=haResourceDescription, cifsTotalReadMbps=cifsTotalReadMbps, upgradeFailed=upgradeFailed, tegileConformance=tegileConformance, snmpServiceStartFailed=snmpServiceStartFailed, cacheTotalWriteMbps=cacheTotalWriteMbps, cacheTotalReadIops=cacheTotalReadIops, cpuSystemCalls=cpuSystemCalls, poolMetaReadIops=poolMetaReadIops, testNotification=testNotification, lunFreeSizeHigh=lunFreeSizeHigh, tdpsUpgradeCompleted=tdpsUpgradeCompleted, lunWriteIops=lunWriteIops, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, upgradeDownloadStarted=upgradeDownloadStarted, projectSnapshotSizeHigh=projectSnapshotSizeHigh, haResourceGroup=haResourceGroup, lunBlockSize=lunBlockSize, lunPoolName=lunPoolName, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, cacheTotalWriteIops=cacheTotalWriteIops, shareCompressedRatio=shareCompressedRatio, fcPortOffline=fcPortOffline, cacheSSDReads=cacheSSDReads, poolReadCacheReadIops=poolReadCacheReadIops, haControllerA_IPAddr=haControllerA_IPAddr, projectName=projectName, poolReadCacheReadMbps=poolReadCacheReadMbps, shareNFSWriteLatency=shareNFSWriteLatency, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, nvdimmFailSoftError=nvdimmFailSoftError, poolCreated=poolCreated, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, nicTransmitMbps=nicTransmitMbps, iscsiTotalWriteMbps=iscsiTotalWriteMbps, poolDataReadIops=poolDataReadIops, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, projectThresholdExceedWarning=projectThresholdExceedWarning, diskCount=diskCount, poolWriteCacheWriteIops=poolWriteCacheWriteIops, shareSnapshotSizeHigh=shareSnapshotSizeHigh, haResourceName=haResourceName, shareNFSReadIops=shareNFSReadIops, targetGroupMemberRemoved=targetGroupMemberRemoved, projectSnapshotSizeLow=projectSnapshotSizeLow, lunProtocol=lunProtocol, replicationResumed=replicationResumed, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, ipmiOther=ipmiOther, fcPortOnline=fcPortOnline, haControllerA_Name=haControllerA_Name, ipmiCurrent=ipmiCurrent, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, smisServiceStopped=smisServiceStopped, ipmiMemory=ipmiMemory, deleteFolderCompleted=deleteFolderCompleted, lunDataSizeLow=lunDataSizeLow, iscsiTargetReadMbps=iscsiTargetReadMbps, volumeQuotaFinished=volumeQuotaFinished, projectDataSizeLow=projectDataSizeLow, haResourceActiveNode=haResourceActiveNode, fcTargetWriteLatency=fcTargetWriteLatency, haResourcesTable=haResourcesTable, cacheRAMReads=cacheRAMReads, poolIndex=poolIndex, replicationFailed=replicationFailed, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, tegileArray=tegileArray, poolExpanded=poolExpanded, poolAvgWriteLatency=poolAvgWriteLatency, shareReservedSizeLow=shareReservedSizeLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, diskType=diskType, fcInitiatorIndex=fcInitiatorIndex, controllerTimeDrift=controllerTimeDrift, iscsiTargetAlias=iscsiTargetAlias, lunGUID=lunGUID, cpuTotalUsage=cpuTotalUsage)
