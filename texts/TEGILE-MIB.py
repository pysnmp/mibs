...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:36:03 2021
...
MibIdentifier, iso, Gauge32, Bits, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, ObjectIdentity, TimeTicks, enterprises, ModuleIdentity, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Gauge32", "Bits", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "ObjectIdentity", "TimeTicks", "enterprises", "ModuleIdentity", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("TEGILE-MIB", shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, ipmiFan=ipmiFan, cifsTotalWriteMbps=cifsTotalWriteMbps, maintenanceModeEnabled=maintenanceModeEnabled, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, fcPortOnline=fcPortOnline, lunReadIops=lunReadIops, projectThresholdExceedWarning=projectThresholdExceedWarning, nvdimmFailDeviceError=nvdimmFailDeviceError, poolEntry=poolEntry, nicState=nicState, fcTargetName=fcTargetName, fcTargetReadLatency=fcTargetReadLatency, nfsAvgWriteLatency=nfsAvgWriteLatency, iscsiInitiatorIndex=iscsiInitiatorIndex, diskRandomIOCount=diskRandomIOCount, nicName=nicName, diskError=diskError, cacheTotalReadMbps=cacheTotalReadMbps, shareReservedSizeLow=shareReservedSizeLow, networkIpmpGroupUp=networkIpmpGroupUp, poolWriteCacheWriteIops=poolWriteCacheWriteIops, nicIndex=nicIndex, snmpServiceStarted=snmpServiceStarted, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, replicationStarted=replicationStarted, controllerDown=controllerDown, poolDataSizeHigh=poolDataSizeHigh, notificationTime=notificationTime, shareNFSReadMbps=shareNFSReadMbps, iscsiTargetsTable=iscsiTargetsTable, diskDataWriteMbps=diskDataWriteMbps, projectPoolName=projectPoolName, shareDeletionFailed=shareDeletionFailed, shareCIFSWriteIops=shareCIFSWriteIops, poolProjects=poolProjects, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, projectSnapshotSizeHigh=projectSnapshotSizeHigh, cifsAvgWriteLatency=cifsAvgWriteLatency, nicTransmitMbps=nicTransmitMbps, shareQuotaHigh=shareQuotaHigh, fcTargetEntry=fcTargetEntry, userLoginFailed=userLoginFailed, cifsTotalReadIops=cifsTotalReadIops, cpuInterrupts=cpuInterrupts, poolMetaReadIops=poolMetaReadIops, snapshotRollbackCompleted=snapshotRollbackCompleted, pools=pools, PYSNMP_MODULE_ID=tegile, smisServiceStopFailed=smisServiceStopFailed, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, fcTargetIndex=fcTargetIndex, poolProjectCount=poolProjectCount, networkIpmpGroupDown=networkIpmpGroupDown, shareDeleted=shareDeleted, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, diskSizeLow=diskSizeLow, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, iscsiTargets=iscsiTargets, tegileArray_notifications=tegileArray_notifications, cifsTotalReadMbps=cifsTotalReadMbps, poolTotalReadIops=poolTotalReadIops, projectCreatedSuccessfully=projectCreatedSuccessfully, notificationObjects=notificationObjects, nfsTotalWriteMbps=nfsTotalWriteMbps, iscsiAvgWriteLatency=iscsiAvgWriteLatency, iscsiWriteIops=iscsiWriteIops, nicGroup=nicGroup, shareCIFSReadIops=shareCIFSReadIops, replicationComplete=replicationComplete, shareNFSReadLatency=shareNFSReadLatency, initiatorGroupMemberAdded=initiatorGroupMemberAdded, iscsiTotalReadIops=iscsiTotalReadIops, haResources=haResources, poolReadCacheReadMbps=poolReadCacheReadMbps, shareSnapshotSizeLow=shareSnapshotSizeLow, projectFreeSizeLow=projectFreeSizeLow, poolReadCacheReadLatency=poolReadCacheReadLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, diskIsOnline=diskIsOnline, currentNotificationGroup=currentNotificationGroup, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, iscsiInitiatorEntry=iscsiInitiatorEntry, replicationResumed=replicationResumed, poolMetaWriteIops=poolMetaWriteIops, shareCIFSWriteLatency=shareCIFSWriteLatency, shareNFSEnabled=shareNFSEnabled, poolFreeSizeHigh=poolFreeSizeHigh, iscsiTargetAlias=iscsiTargetAlias, poolSizeHigh=poolSizeHigh, cacheTotalWriteIops=cacheTotalWriteIops, fcTargetModifyCompleted=fcTargetModifyCompleted, ipmiPowerSupply=ipmiPowerSupply, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, iscsiInitiatorChapUser=iscsiInitiatorChapUser, diskSequentialIOCount=diskSequentialIOCount, lunCompressedRatio=lunCompressedRatio, lunSizeLow=lunSizeLow, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareNFSWriteIops=shareNFSWriteIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, disks=disks, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, smisServiceStarted=smisServiceStarted, projectLunCount=projectLunCount, diskTotalReadMbps=diskTotalReadMbps, haControllerA_Uptime=haControllerA_Uptime, projectEntry=projectEntry, diskGoneOffline=diskGoneOffline, notificationThresholdTriggerValue=notificationThresholdTriggerValue, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, projectDeleted=projectDeleted, targetGroupCreateCompleted=targetGroupCreateCompleted, poolState=poolState, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, iscsiTargetWriteMbps=iscsiTargetWriteMbps, nfsTotalReadMbps=nfsTotalReadMbps, notificationEventCode=notificationEventCode, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, fcTargetGroup=fcTargetGroup, nvdimmFailUnknownError=nvdimmFailUnknownError, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, snmpServiceStopped=snmpServiceStopped, lunPoolName=lunPoolName, projectShares=projectShares, shareDedupEnabled=shareDedupEnabled, iscsiInitiatorGroup=iscsiInitiatorGroup, diskAvgReadLatency=diskAvgReadLatency, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, fcPortOffline=fcPortOffline, haResourceName=haResourceName, cpuSystemCalls=cpuSystemCalls, networkInterfaceDown=networkInterfaceDown, tegileConformance=tegileConformance, poolReadCacheReadIops=poolReadCacheReadIops, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, controllerTimeDrift=controllerTimeDrift, iscsiTotalWriteMbps=iscsiTotalWriteMbps, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, lunName=lunName, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, diskAvgWriteLatency=diskAvgWriteLatency, notificationComponentName=notificationComponentName, poolDataReadIops=poolDataReadIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, nfsAvgReadLatency=nfsAvgReadLatency, iscsiTargetEntry=iscsiTargetEntry, fcInitiatorName=fcInitiatorName, intelliFlashSoftwareDown=intelliFlashSoftwareDown, diskSlowIo=diskSlowIo, shareNFSReadIops=shareNFSReadIops, shareReservedSizeHigh=shareReservedSizeHigh, shareExceedThresholdWarning=shareExceedThresholdWarning, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, fcTotalReadIops=fcTotalReadIops, networkTotalTransmitMbps=networkTotalTransmitMbps, cacheRAMReads=cacheRAMReads, poolUsedSizeLow=poolUsedSizeLow, volumeCreatedSuccessfully=volumeCreatedSuccessfully, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, projectDataSizeHigh=projectDataSizeHigh, diskType=diskType, fcAvgWriteLatency=fcAvgWriteLatency, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, iscsiTargetName=iscsiTargetName, diskCount=diskCount, lunIndex=lunIndex, shareDataSizeHigh=shareDataSizeHigh, diagnosticDataUploaded=diagnosticDataUploaded, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, webdocsUpgradeCompleted=webdocsUpgradeCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, haControllerB_Uptime=haControllerB_Uptime, diskIOCount=diskIOCount, shareCIFSReadLatency=shareCIFSReadLatency, snapshotCloneCompleted=snapshotCloneCompleted, diskDataReadMbps=diskDataReadMbps, controllerHardwareModel=controllerHardwareModel, diskEntry=diskEntry, poolTotalWriteMbps=poolTotalWriteMbps, poolFreeSizeLow=poolFreeSizeLow, poolDataWriteMbps=poolDataWriteMbps, poolDataSizeLow=poolDataSizeLow, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, notificationProps=notificationProps, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, poolImported=poolImported, poolDataWriteIops=poolDataWriteIops, lunSizeHigh=lunSizeHigh, poolTotalSaving=poolTotalSaving, fcTargetStatus=fcTargetStatus, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, smisServiceStartFailed=smisServiceStartFailed, lunProtocol=lunProtocol, ipmiTemperature=ipmiTemperature, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, poolTotalReadMbps=poolTotalReadMbps, replicationFailed=replicationFailed, lunBlockSize=lunBlockSize, upgradeDownloadStarted=upgradeDownloadStarted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, globalStatistics=globalStatistics, basicCompliance=basicCompliance, nicReceiveMbps=nicReceiveMbps, ipmiCriticalInterrupt=ipmiCriticalInterrupt, shareQuotaFinished=shareQuotaFinished, iscsiTargetWriteIops=iscsiTargetWriteIops, snmpServiceStopFailed=snmpServiceStopFailed, snmpAgentVersion=snmpAgentVersion, diskDataReadIops=diskDataReadIops, haResourceDescription=haResourceDescription, tdpsUpgradeCompleted=tdpsUpgradeCompleted, adServerTimeDrift=adServerTimeDrift, iscsiTargetIndex=iscsiTargetIndex, fcInitiators=fcInitiators, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, tegileGroups=tegileGroups, intelliFlashSoftwareUp=intelliFlashSoftwareUp, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, notificationTargetEntityName=notificationTargetEntityName, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, lunTargetGroup=lunTargetGroup, poolDataReadLatency=poolDataReadLatency, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, projectModified=projectModified, testNotification=testNotification, haControllerB_Name=haControllerB_Name, fcTargetWriteIops=fcTargetWriteIops, projectTable=projectTable, notifications=notifications, shareNFSWriteMbps=shareNFSWriteMbps, iscsiInitiators=iscsiInitiators, poolTable=poolTable, snapshotCloningFailed=snapshotCloningFailed, poolQuotaFinished=poolQuotaFinished, cacheTotalWriteMbps=cacheTotalWriteMbps, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectShareCount=projectShareCount, projectQuotaFinished=projectQuotaFinished, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, vmwareNFSDatastores=vmwareNFSDatastores, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, fcTargetWriteLatency=fcTargetWriteLatency, fcTargets=fcTargets, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, poolDegraded=poolDegraded, haControllerA_IPAddr=haControllerA_IPAddr, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed)
mibBuilder.exportSymbols("TEGILE-MIB", shareDataSizeLow=shareDataSizeLow, tdpsUpgradeTimeout=tdpsUpgradeTimeout, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, targetGroupDeleteCompleted=targetGroupDeleteCompleted, tdpsUpgradeFailed=tdpsUpgradeFailed, poolExpanded=poolExpanded, lunWriteMbps=lunWriteMbps, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, shareCIFSWriteMbps=shareCIFSWriteMbps, memoryFailure=memoryFailure, shareProjectName=shareProjectName, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, diskAlias=diskAlias, shareMountPoint=shareMountPoint, poolName=poolName, iscsiImproperTargetGroup=iscsiImproperTargetGroup, volumeDeleteFailed=volumeDeleteFailed, lunSnapshotSizeHigh=lunSnapshotSizeHigh, tegile=tegile, poolTotalWriteIops=poolTotalWriteIops, projectIndex=projectIndex, fcTargetReadIops=fcTargetReadIops, targetGroupMemberAdded=targetGroupMemberAdded, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, smbSocketFailure=smbSocketFailure, projectName=projectName, lunInitiatorGroup=lunInitiatorGroup, replicationSourceRegistered=replicationSourceRegistered, shareCompressedRatio=shareCompressedRatio, shareNFSWriteLatency=shareNFSWriteLatency, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, iscsiTargetReadLatency=iscsiTargetReadLatency, shareCreatedSuccessfully=shareCreatedSuccessfully, targetGroupMemberRemoved=targetGroupMemberRemoved, projectQuotaSizeLow=projectQuotaSizeLow, replicationAbandoned=replicationAbandoned, fcProperties=fcProperties, diskIndex=diskIndex, diskState=diskState, projectFreeSizeHigh=projectFreeSizeHigh, lunWriteIops=lunWriteIops, projectTotalSaving=projectTotalSaving, haResourceIndex=haResourceIndex, snapshotCreationFailed=snapshotCreationFailed, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, tegileArray=tegileArray, snapshotRollbackFailed=snapshotRollbackFailed, diskTotalWriteIops=diskTotalWriteIops, poolIndex=poolIndex, poolDeleted=poolDeleted, tegileCompliances=tegileCompliances, notificationSensorNumber=notificationSensorNumber, haResourceStatus=haResourceStatus, haControllerB_IPAddr=haControllerB_IPAddr, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, diskChassisIdx=diskChassisIdx, lunReservedSizeHigh=lunReservedSizeHigh, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, lunTable=lunTable, networkInterfaceUp=networkInterfaceUp, networkTotalReceiveMbps=networkTotalReceiveMbps, poolDeletionFailed=poolDeletionFailed, cifsAvgReadLatency=cifsAvgReadLatency, sanProperties=sanProperties, notificationReadingUnit=notificationReadingUnit, upgradeStarted=upgradeStarted, fcAvgReadLatency=fcAvgReadLatency, shareCompressionEnabled=shareCompressionEnabled, projectDedupEnabled=projectDedupEnabled, shareEntry=shareEntry, poolMetaWriteLatency=poolMetaWriteLatency, notificationSensorSuspect=notificationSensorSuspect, diskTotalWriteMbps=diskTotalWriteMbps, poolOwnerController=poolOwnerController, nfsTotalWriteIops=nfsTotalWriteIops, lunGUID=lunGUID, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, nicEntry=nicEntry, diskTotalReadIops=diskTotalReadIops, shareName=shareName, shareCIFSEnabled=shareCIFSEnabled, ipmiThreshold=ipmiThreshold, fcTargetWriteMbps=fcTargetWriteMbps, fcTotalWriteIops=fcTotalWriteIops, fcTotalWriteMbps=fcTotalWriteMbps, volumeDeleteCompleted=volumeDeleteCompleted, aclMigrationCompleted=aclMigrationCompleted, ipmiCurrent=ipmiCurrent, projectCompressionEnabled=projectCompressionEnabled, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, upgradeDownloadFailed=upgradeDownloadFailed, iscsiTargetReadMbps=iscsiTargetReadMbps, cacheTotalReadIops=cacheTotalReadIops, iscsiTargetGroup=iscsiTargetGroup, notificationDescription=notificationDescription, lunReadMbps=lunReadMbps, lunProjectName=lunProjectName, volumeQuotaFinished=volumeQuotaFinished, lunFreeSizeLow=lunFreeSizeLow, snapshotDeleteFailed=snapshotDeleteFailed, ipmiOther=ipmiOther, nvdimmFailInitializationError=nvdimmFailInitializationError, cifsTotalWriteIops=cifsTotalWriteIops, lunReadLatency=lunReadLatency, poolDataReadMbps=poolDataReadMbps, lunDedupEnabled=lunDedupEnabled, iscsiInitiatorsTable=iscsiInitiatorsTable, notificationSeverity=notificationSeverity, poolAvgReadLatency=poolAvgReadLatency, poolReadCacheWriteLatency=poolReadCacheWriteLatency, maintenanceModeDisabled=maintenanceModeDisabled, replicationPaused=replicationPaused, replicationTargetDeleted=replicationTargetDeleted, upgradeFailed=upgradeFailed, nicTable=nicTable, lunDataSizeLow=lunDataSizeLow, lunSnapshotSizeLow=lunSnapshotSizeLow, sharePoolName=sharePoolName, haResourceEntry=haResourceEntry, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, projectQuotaSizeHigh=projectQuotaSizeHigh, projectLUNs=projectLUNs, poolSizeLow=poolSizeLow, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, fcInitiatorIndex=fcInitiatorIndex, poolMetaWriteMbps=poolMetaWriteMbps, haResourcesTable=haResourcesTable, fcTotalReadMbps=fcTotalReadMbps, haControllerA_Name=haControllerA_Name, lunCompressionEnabled=lunCompressionEnabled, upgradeDownloadCompleted=upgradeDownloadCompleted, poolCreated=poolCreated, fcInitiatorGroup=fcInitiatorGroup, replicationAborted=replicationAborted, iscsiInitiatorName=iscsiInitiatorName, diskDataWriteIops=diskDataWriteIops, upgradeTimeout=upgradeTimeout, poolReadCacheWriteIops=poolReadCacheWriteIops, lunWriteLatency=lunWriteLatency, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, lunFreeSizeHigh=lunFreeSizeHigh, projectDataSizeLow=projectDataSizeLow, poolDataWriteLatency=poolDataWriteLatency, volumeModifyCompleted=volumeModifyCompleted, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, iscsiTargetGroupError=iscsiTargetGroupError, ntpServerTimeDrift=ntpServerTimeDrift, deleteFolderFailed=deleteFolderFailed, poolAvgWriteLatency=poolAvgWriteLatency, fcTargetsTable=fcTargetsTable, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, lunDataSizeHigh=lunDataSizeHigh, poolCount=poolCount, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, shareCIFSReadMbps=shareCIFSReadMbps, notificationSensorAction=notificationSensorAction, cpuTotalUsage=cpuTotalUsage, sensorFailureEvent=sensorFailureEvent, haResourceActiveNode=haResourceActiveNode, ipmiMemory=ipmiMemory, iscsiTargetError=iscsiTargetError, shareQuotaLow=shareQuotaLow, netbiosSocketFailure=netbiosSocketFailure, lunReservedSizeLow=lunReservedSizeLow, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, lunEntry=lunEntry, shareTable=shareTable, poolUsedSizeHigh=poolUsedSizeHigh, poolHealth=poolHealth, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, fcTargetReadMbps=fcTargetReadMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, poolUpgraded=poolUpgraded, iscsiTargetReadIops=iscsiTargetReadIops, snmpServiceStartFailed=snmpServiceStartFailed, diskSizeHigh=diskSizeHigh, poolMetaReadLatency=poolMetaReadLatency, ipmiVoltage=ipmiVoltage, projectSnapshotSizeLow=projectSnapshotSizeLow, smisServiceStopped=smisServiceStopped, diskPoolName=diskPoolName, currentObjectGroup=currentObjectGroup, notificationReadingTriggerValue=notificationReadingTriggerValue, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, network=network, fcInitiatorEntry=fcInitiatorEntry, spareDiskReplaced=spareDiskReplaced, iscsiTargetAuth=iscsiTargetAuth, nvdimmFailSoftError=nvdimmFailSoftError, projectDeletionFailed=projectDeletionFailed, properties=properties, shareIndex=shareIndex, fcInitiatorCreateFailed=fcInitiatorCreateFailed, alertsCleanupCompleted=alertsCleanupCompleted, poolMetaReadMbps=poolMetaReadMbps, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcInitiatorsTable=fcInitiatorsTable, nfsTotalReadIops=nfsTotalReadIops, unknownSensorEvent=unknownSensorEvent, nicMTU=nicMTU, diskTable=diskTable, haResourceGroup=haResourceGroup, controllerUp=controllerUp, poolExported=poolExported, aclMigrationStarted=aclMigrationStarted, deleteFolderCompleted=deleteFolderCompleted, upgradeCompleted=upgradeCompleted, cacheSSDReads=cacheSSDReads, iscsiTotalReadMbps=iscsiTotalReadMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiAvgReadLatency=iscsiAvgReadLatency, iscsiProperties=iscsiProperties, iscsiTargetWriteLatency=iscsiTargetWriteLatency)
