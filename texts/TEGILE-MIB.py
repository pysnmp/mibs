...
Counter64, NotificationType, IpAddress, ModuleIdentity, enterprises, ObjectIdentity, TimeTicks, Gauge32, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "IpAddress", "ModuleIdentity", "enterprises", "ObjectIdentity", "TimeTicks", "Gauge32", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("TEGILE-MIB", adServerTimeDrift=adServerTimeDrift, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, replicationStarted=replicationStarted, volumeDeleteCompleted=volumeDeleteCompleted, volumeCreatedSuccessfully=volumeCreatedSuccessfully, volumeDeleteFailed=volumeDeleteFailed, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolMetaReadLatency=poolMetaReadLatency, ipmiFan=ipmiFan, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, shareNFSReadIops=shareNFSReadIops, aclMigrationCompleted=aclMigrationCompleted, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, diskPoolName=diskPoolName, nicState=nicState, nfsTotalReadMbps=nfsTotalReadMbps, networkInterfaceDown=networkInterfaceDown, shareCIFSEnabled=shareCIFSEnabled, poolMetaWriteIops=poolMetaWriteIops, deleteFolderFailed=deleteFolderFailed, networkInterfaceUp=networkInterfaceUp, haResourcesTable=haResourcesTable, poolAvgReadLatency=poolAvgReadLatency, iscsiInitiatorsTable=iscsiInitiatorsTable, poolDataReadMbps=poolDataReadMbps, targetGroupCreateCompleted=targetGroupCreateCompleted, nvdimmFailDeviceError=nvdimmFailDeviceError, ipmiCriticalInterrupt=ipmiCriticalInterrupt, tegileGroups=tegileGroups, shareCIFSWriteIops=shareCIFSWriteIops, shareCIFSReadLatency=shareCIFSReadLatency, shareCompressionEnabled=shareCompressionEnabled, poolProjectCount=poolProjectCount, iscsiTargetGroup=iscsiTargetGroup, lunReadLatency=lunReadLatency, cacheTotalReadIops=cacheTotalReadIops, shareQuotaHigh=shareQuotaHigh, cifsTotalWriteIops=cifsTotalWriteIops, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, iscsiWriteIops=iscsiWriteIops, nicName=nicName, networkTotalReceiveMbps=networkTotalReceiveMbps, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, fcTotalReadIops=fcTotalReadIops, iscsiTargetEntry=iscsiTargetEntry, intelliFlashSoftwareUp=intelliFlashSoftwareUp, notificationReadingUnit=notificationReadingUnit, nfsTotalReadIops=nfsTotalReadIops, netbiosSocketFailure=netbiosSocketFailure, poolTotalWriteMbps=poolTotalWriteMbps, lunSizeHigh=lunSizeHigh, poolSizeLow=poolSizeLow, intelliFlashSoftwareDown=intelliFlashSoftwareDown, iscsiInitiators=iscsiInitiators, disks=disks, shareNFSEnabled=shareNFSEnabled, projectPoolName=projectPoolName, fcTargetGroup=fcTargetGroup, diskError=diskError, poolReadCacheWriteLatency=poolReadCacheWriteLatency, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, lunIndex=lunIndex, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, sanProperties=sanProperties, poolQuotaFinished=poolQuotaFinished, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, smisServiceStopFailed=smisServiceStopFailed, ipmiCurrent=ipmiCurrent, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, fcInitiatorIndex=fcInitiatorIndex, haResourceGroup=haResourceGroup, iscsiTargetAuth=iscsiTargetAuth, sharePoolName=sharePoolName, networkTotalTransmitMbps=networkTotalTransmitMbps, diskSizeLow=diskSizeLow, fcTotalWriteMbps=fcTotalWriteMbps, iscsiInitiatorGroup=iscsiInitiatorGroup, diskAlias=diskAlias, cacheTotalReadMbps=cacheTotalReadMbps, lunReadIops=lunReadIops, poolAvgWriteLatency=poolAvgWriteLatency, shareTable=shareTable, lunProtocol=lunProtocol, poolTotalReadIops=poolTotalReadIops, fcTargetName=fcTargetName, properties=properties, shareCIFSReadMbps=shareCIFSReadMbps, nicTable=nicTable, lunDataSizeLow=lunDataSizeLow, fcTotalWriteIops=fcTotalWriteIops, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, diskType=diskType, diskState=diskState, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, replicationFailed=replicationFailed, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, projectQuotaSizeHigh=projectQuotaSizeHigh, tdpsUpgradeTimeout=tdpsUpgradeTimeout, nicReceiveMbps=nicReceiveMbps, poolDeletionFailed=poolDeletionFailed, iscsiTargetsTable=iscsiTargetsTable, haControllerB_IPAddr=haControllerB_IPAddr, poolExported=poolExported, poolReadCacheReadMbps=poolReadCacheReadMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, diskGoneOffline=diskGoneOffline, notificationEventCode=notificationEventCode, notificationObjects=notificationObjects, poolMetaReadIops=poolMetaReadIops, nvdimmFailUnknownError=nvdimmFailUnknownError, lunDedupEnabled=lunDedupEnabled, notificationComponentName=notificationComponentName, projectThresholdExceedWarning=projectThresholdExceedWarning, projectIndex=projectIndex, projectFreeSizeLow=projectFreeSizeLow, shareCompressedRatio=shareCompressedRatio, haControllerB_Name=haControllerB_Name, notificationSensorSuspect=notificationSensorSuspect, shareNFSReadMbps=shareNFSReadMbps, smisServiceStopped=smisServiceStopped, targetGroupMemberRemoved=targetGroupMemberRemoved, tegile=tegile, poolCreated=poolCreated, lunEntry=lunEntry, snapshotRollbackCompleted=snapshotRollbackCompleted, fcTargetStatus=fcTargetStatus, nvdimmFailSoftError=nvdimmFailSoftError, upgradeStarted=upgradeStarted, unknownSensorEvent=unknownSensorEvent, iscsiTargetWriteLatency=iscsiTargetWriteLatency, shareDataSizeHigh=shareDataSizeHigh, lunGUID=lunGUID, poolDataReadIops=poolDataReadIops, alertsCleanupCompleted=alertsCleanupCompleted, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, shareNFSWriteLatency=shareNFSWriteLatency, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, shareMountPoint=shareMountPoint, haResources=haResources, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, lunFreeSizeLow=lunFreeSizeLow, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, cifsTotalReadIops=cifsTotalReadIops, lunCompressionEnabled=lunCompressionEnabled, smisServiceStarted=smisServiceStarted, smisServiceStartFailed=smisServiceStartFailed, shareCIFSReadIops=shareCIFSReadIops, projectShares=projectShares, controllerTimeDrift=controllerTimeDrift, PYSNMP_MODULE_ID=tegile, networkIpmpGroupUp=networkIpmpGroupUp, iscsiTargetWriteMbps=iscsiTargetWriteMbps, replicationTargetDeleted=replicationTargetDeleted, iscsiTargetReadMbps=iscsiTargetReadMbps, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, shareDeletionFailed=shareDeletionFailed, shareProjectName=shareProjectName, cacheRAMReads=cacheRAMReads, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, notifications=notifications, cacheSSDReads=cacheSSDReads, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, shareName=shareName, spareDiskReplaced=spareDiskReplaced, poolProjects=poolProjects, maintenanceModeEnabled=maintenanceModeEnabled, fcTargetModifyCompleted=fcTargetModifyCompleted, diskIOCount=diskIOCount, projectQuotaFinished=projectQuotaFinished, notificationSensorAction=notificationSensorAction, nfsAvgReadLatency=nfsAvgReadLatency, cifsTotalWriteMbps=cifsTotalWriteMbps, upgradeTimeout=upgradeTimeout, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, notificationDescription=notificationDescription, notificationReadingTriggerValue=notificationReadingTriggerValue, diskTotalWriteMbps=diskTotalWriteMbps, nfsTotalWriteMbps=nfsTotalWriteMbps, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, tdpsUpgradeFailed=tdpsUpgradeFailed, diskAvgReadLatency=diskAvgReadLatency, haControllerA_Name=haControllerA_Name, cacheTotalWriteMbps=cacheTotalWriteMbps, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, haControllerA_IPAddr=haControllerA_IPAddr, cifsTotalReadMbps=cifsTotalReadMbps, poolReadCacheReadIops=poolReadCacheReadIops, projectTable=projectTable, notificationSensorNumber=notificationSensorNumber, userLoginFailed=userLoginFailed, ipmiPowerSupply=ipmiPowerSupply, maintenanceModeDisabled=maintenanceModeDisabled, replicationComplete=replicationComplete, nfsAvgWriteLatency=nfsAvgWriteLatency, poolName=poolName, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, ipmiTemperature=ipmiTemperature, diskDataWriteIops=diskDataWriteIops, projectDedupEnabled=projectDedupEnabled, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, projectEntry=projectEntry, projectSnapshotSizeHigh=projectSnapshotSizeHigh, lunWriteMbps=lunWriteMbps, replicationResumed=replicationResumed, poolTotalReadMbps=poolTotalReadMbps, projectTotalSaving=projectTotalSaving, lunInitiatorGroup=lunInitiatorGroup, poolFreeSizeHigh=poolFreeSizeHigh, fcTargetWriteLatency=fcTargetWriteLatency, diskSlowIo=diskSlowIo, shareReservedSizeLow=shareReservedSizeLow, haResourceEntry=haResourceEntry, cacheTotalWriteIops=cacheTotalWriteIops, fcAvgWriteLatency=fcAvgWriteLatency, lunPoolName=lunPoolName, poolDataReadLatency=poolDataReadLatency, iscsiTargetReadLatency=iscsiTargetReadLatency, tegileArray_notifications=tegileArray_notifications, poolHealth=poolHealth, controllerDown=controllerDown, upgradeDownloadStarted=upgradeDownloadStarted, projectLunCount=projectLunCount, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, snmpAgentVersion=snmpAgentVersion, tegileArray=tegileArray, shareDataSizeLow=shareDataSizeLow, lunSizeLow=lunSizeLow, initiatorGroupMemberAdded=initiatorGroupMemberAdded, notificationProps=notificationProps, fcTotalReadMbps=fcTotalReadMbps, nicEntry=nicEntry, poolMetaReadMbps=poolMetaReadMbps, snapshotDeleteFailed=snapshotDeleteFailed, projectSnapshotSizeLow=projectSnapshotSizeLow, poolImported=poolImported, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, cifsAvgWriteLatency=cifsAvgWriteLatency, iscsiTargetGroupError=iscsiTargetGroupError, fcTargetWriteMbps=fcTargetWriteMbps, basicCompliance=basicCompliance, poolEntry=poolEntry, poolState=poolState, ipmiOther=ipmiOther, poolFreeSizeLow=poolFreeSizeLow, haResourceStatus=haResourceStatus, poolDataWriteLatency=poolDataWriteLatency, upgradeCompleted=upgradeCompleted, nfsTotalWriteIops=nfsTotalWriteIops)
mibBuilder.exportSymbols("TEGILE-MIB", nicTransmitMbps=nicTransmitMbps, iscsiTargetReadIops=iscsiTargetReadIops, cpuSystemCalls=cpuSystemCalls, iscsiInitiatorName=iscsiInitiatorName, lunProjectName=lunProjectName, poolDataSizeLow=poolDataSizeLow, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, shareSnapshotSizeLow=shareSnapshotSizeLow, snapshotCloningFailed=snapshotCloningFailed, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, poolDataWriteMbps=poolDataWriteMbps, fcInitiatorEntry=fcInitiatorEntry, notificationTargetEntityName=notificationTargetEntityName, iscsiTargets=iscsiTargets, diskIndex=diskIndex, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, smbSocketFailure=smbSocketFailure, shareCIFSWriteMbps=shareCIFSWriteMbps, diskIsOnline=diskIsOnline, snapshotRollbackFailed=snapshotRollbackFailed, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, upgradeDownloadCompleted=upgradeDownloadCompleted, projectFreeSizeHigh=projectFreeSizeHigh, fcTargets=fcTargets, shareReservedSizeHigh=shareReservedSizeHigh, poolExpanded=poolExpanded, poolDegraded=poolDegraded, fcPortOffline=fcPortOffline, controllerUp=controllerUp, iscsiProperties=iscsiProperties, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, snmpServiceStopFailed=snmpServiceStopFailed, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, shareSnapshotSizeHigh=shareSnapshotSizeHigh, poolDataSizeHigh=poolDataSizeHigh, projectShareCount=projectShareCount, lunTargetGroup=lunTargetGroup, targetGroupDeleteCompleted=targetGroupDeleteCompleted, projectQuotaSizeLow=projectQuotaSizeLow, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, snmpServiceStartFailed=snmpServiceStartFailed, iscsiTotalWriteMbps=iscsiTotalWriteMbps, shareNFSWriteIops=shareNFSWriteIops, iscsiInitiatorEntry=iscsiInitiatorEntry, controllerHardwareModel=controllerHardwareModel, ntpServerTimeDrift=ntpServerTimeDrift, projectModified=projectModified, diskSequentialIOCount=diskSequentialIOCount, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, projectCompressionEnabled=projectCompressionEnabled, vmwareNFSDatastores=vmwareNFSDatastores, poolOwnerController=poolOwnerController, poolMetaWriteMbps=poolMetaWriteMbps, projectLUNs=projectLUNs, shareDedupEnabled=shareDedupEnabled, replicationPaused=replicationPaused, diskSizeHigh=diskSizeHigh, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, fcInitiatorName=fcInitiatorName, iscsiInitiatorChapUser=iscsiInitiatorChapUser, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, ipmiVoltage=ipmiVoltage, shareQuotaLow=shareQuotaLow, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, lunDataSizeHigh=lunDataSizeHigh, poolReadCacheWriteIops=poolReadCacheWriteIops, currentNotificationGroup=currentNotificationGroup, snmpServiceStarted=snmpServiceStarted, network=network, shareQuotaFinished=shareQuotaFinished, lunReadMbps=lunReadMbps, fcTargetWriteIops=fcTargetWriteIops, iscsiAvgReadLatency=iscsiAvgReadLatency, poolWriteCacheWriteIops=poolWriteCacheWriteIops, diskDataReadMbps=diskDataReadMbps, poolDeleted=poolDeleted, notificationSeverity=notificationSeverity, networkIpmpGroupDown=networkIpmpGroupDown, haControllerA_Uptime=haControllerA_Uptime, tegileCompliances=tegileCompliances, iscsiImproperTargetGroup=iscsiImproperTargetGroup, iscsiInitiatorIndex=iscsiInitiatorIndex, fcTargetIndex=fcTargetIndex, replicationSourceRegistered=replicationSourceRegistered, lunWriteLatency=lunWriteLatency, fcTargetReadIops=fcTargetReadIops, poolIndex=poolIndex, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, diskEntry=diskEntry, lunWriteIops=lunWriteIops, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, cpuTotalUsage=cpuTotalUsage, shareCreatedSuccessfully=shareCreatedSuccessfully, aclMigrationStarted=aclMigrationStarted, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, pools=pools, shareExceedThresholdWarning=shareExceedThresholdWarning, diskDataWriteMbps=diskDataWriteMbps, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, cifsAvgReadLatency=cifsAvgReadLatency, shareCIFSWriteLatency=shareCIFSWriteLatency, upgradeDownloadFailed=upgradeDownloadFailed, lunBlockSize=lunBlockSize, currentObjectGroup=currentObjectGroup, volumeModifyCompleted=volumeModifyCompleted, fcTargetEntry=fcTargetEntry, diagnosticDataUploaded=diagnosticDataUploaded, sensorFailureEvent=sensorFailureEvent, shareEntry=shareEntry, haResourceActiveNode=haResourceActiveNode, replicationAbandoned=replicationAbandoned, nvdimmFailInitializationError=nvdimmFailInitializationError, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, diskTable=diskTable, lunReservedSizeHigh=lunReservedSizeHigh, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, tegileConformance=tegileConformance, poolUsedSizeHigh=poolUsedSizeHigh, poolMetaWriteLatency=poolMetaWriteLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, diskRandomIOCount=diskRandomIOCount, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, lunName=lunName, shareIndex=shareIndex, fcInitiatorCreateFailed=fcInitiatorCreateFailed, poolSizeHigh=poolSizeHigh, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, lunReservedSizeLow=lunReservedSizeLow, iscsiTargetAlias=iscsiTargetAlias, webdocsUpgradeCompleted=webdocsUpgradeCompleted, poolReadCacheWriteMbps=poolReadCacheWriteMbps, diskAvgWriteLatency=diskAvgWriteLatency, fcTargetReadMbps=fcTargetReadMbps, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, iscsiTotalReadIops=iscsiTotalReadIops, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, projectDataSizeHigh=projectDataSizeHigh, poolDataWriteIops=poolDataWriteIops, fcInitiators=fcInitiators, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, diskDataReadIops=diskDataReadIops, testNotification=testNotification, lunCompressedRatio=lunCompressedRatio, fcInitiatorGroup=fcInitiatorGroup, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, targetGroupMemberAdded=targetGroupMemberAdded, iscsiTargetName=iscsiTargetName, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, poolUsedSizeLow=poolUsedSizeLow, replicationAborted=replicationAborted, projectName=projectName, diskTotalReadIops=diskTotalReadIops, projectDeletionFailed=projectDeletionFailed, ipmiThreshold=ipmiThreshold, shareNFSReadLatency=shareNFSReadLatency, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, projectDeleted=projectDeleted, snmpServiceStopped=snmpServiceStopped, poolUpgraded=poolUpgraded, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, snapshotCreationFailed=snapshotCreationFailed, tdpsUpgradeCompleted=tdpsUpgradeCompleted, iscsiAvgWriteLatency=iscsiAvgWriteLatency, shareDeleted=shareDeleted, projectCreatedSuccessfully=projectCreatedSuccessfully, haResourceDescription=haResourceDescription, diskCount=diskCount, diskTotalReadMbps=diskTotalReadMbps, snapshotCloneCompleted=snapshotCloneCompleted, memoryFailure=memoryFailure, fcTargetReadLatency=fcTargetReadLatency, fcTargetsTable=fcTargetsTable, poolTotalSaving=poolTotalSaving, diskChassisIdx=diskChassisIdx, globalStatistics=globalStatistics, notificationThresholdTriggerValue=notificationThresholdTriggerValue, iscsiTargetWriteIops=iscsiTargetWriteIops, notificationTime=notificationTime, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, ipmiMemory=ipmiMemory, projectDataSizeLow=projectDataSizeLow, nicIndex=nicIndex, cpuInterrupts=cpuInterrupts, fcAvgReadLatency=fcAvgReadLatency, poolTotalWriteIops=poolTotalWriteIops, haControllerB_Uptime=haControllerB_Uptime, lunFreeSizeHigh=lunFreeSizeHigh, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, poolReadCacheReadLatency=poolReadCacheReadLatency, haResourceIndex=haResourceIndex, fcPortOnline=fcPortOnline, nicMTU=nicMTU, fcInitiatorsTable=fcInitiatorsTable, shareNFSWriteMbps=shareNFSWriteMbps, volumeQuotaFinished=volumeQuotaFinished, upgradeFailed=upgradeFailed, lunSnapshotSizeHigh=lunSnapshotSizeHigh, iscsiTargetIndex=iscsiTargetIndex, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, iscsiTargetError=iscsiTargetError, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, deleteFolderCompleted=deleteFolderCompleted, webdocsUpgradeFailed=webdocsUpgradeFailed, poolTable=poolTable, nicGroup=nicGroup, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, diskTotalWriteIops=diskTotalWriteIops, haResourceName=haResourceName, fcProperties=fcProperties, poolCount=poolCount, lunTable=lunTable, iscsiTotalReadMbps=iscsiTotalReadMbps)
