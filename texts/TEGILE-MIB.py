...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:31:25 2022
...
iso, Gauge32, Unsigned32, TimeTicks, Counter32, NotificationType, Integer32, ObjectIdentity, ModuleIdentity, Bits, IpAddress, MibIdentifier, enterprises, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Unsigned32", "TimeTicks", "Counter32", "NotificationType", "Integer32", "ObjectIdentity", "ModuleIdentity", "Bits", "IpAddress", "MibIdentifier", "enterprises", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("TEGILE-MIB", diskAlias=diskAlias, poolProjects=poolProjects, poolTotalWriteIops=poolTotalWriteIops, smisServiceStopFailed=smisServiceStopFailed, vmwareNFSDatastoresTotalReadIops=vmwareNFSDatastoresTotalReadIops, poolReadCacheReadIops=poolReadCacheReadIops, projectUnusedReservedSizeHigh=projectUnusedReservedSizeHigh, diskTotalWriteIops=diskTotalWriteIops, fcTotalReadMbps=fcTotalReadMbps, shareExceedThresholdWarning=shareExceedThresholdWarning, diagnosticDataUploaded=diagnosticDataUploaded, ipmiThreshold=ipmiThreshold, projectSnapshotSizeHigh=projectSnapshotSizeHigh, vmwareNFSDatastores=vmwareNFSDatastores, lunGUID=lunGUID, basicCompliance=basicCompliance, vmwareNFSDatastoresTotalWriteIops=vmwareNFSDatastoresTotalWriteIops, volumeModifyCompleted=volumeModifyCompleted, iscsiInitiatorChapUser=iscsiInitiatorChapUser, iscsiTargetEntry=iscsiTargetEntry, webdocsUpgradeDownloadStarted=webdocsUpgradeDownloadStarted, fcInitiators=fcInitiators, vmwareNFSDatastoreReadLatency=vmwareNFSDatastoreReadLatency, targetGroupMemberAdded=targetGroupMemberAdded, pools=pools, lunReservedSizeHigh=lunReservedSizeHigh, shareCreatedWithNonOptimalBlockSize=shareCreatedWithNonOptimalBlockSize, webdocsUpgradeDownloadFailed=webdocsUpgradeDownloadFailed, shareCompressionEnabled=shareCompressionEnabled, poolImported=poolImported, ipmiCurrent=ipmiCurrent, poolHealth=poolHealth, controllerDown=controllerDown, poolUnusedReservedSizeHigh=poolUnusedReservedSizeHigh, snmpServiceStopFailed=snmpServiceStopFailed, replicationPaused=replicationPaused, diagnosticDataUploadingFailed=diagnosticDataUploadingFailed, projectTotalSaving=projectTotalSaving, ipmiCriticalInterrupt=ipmiCriticalInterrupt, replicationAbandoned=replicationAbandoned, vmwareNFSDatastoreESXName=vmwareNFSDatastoreESXName, iscsiInitiatorName=iscsiInitiatorName, iscsiTargetReadIops=iscsiTargetReadIops, diskCount=diskCount, notificationTargetEntityName=notificationTargetEntityName, sensorFailureEvent=sensorFailureEvent, notificationReadingUnit=notificationReadingUnit, shareDataSizeLow=shareDataSizeLow, nicReceiveMbps=nicReceiveMbps, volumeCreatedWithNonOptimalBlockSize=volumeCreatedWithNonOptimalBlockSize, snapshotCloningFailed=snapshotCloningFailed, shareCIFSWriteIops=shareCIFSWriteIops, diskError=diskError, diskIOCount=diskIOCount, iscsiTargetDeleteCompleted=iscsiTargetDeleteCompleted, fcTargetWriteMbps=fcTargetWriteMbps, projectDeletionFailed=projectDeletionFailed, diskTotalReadIops=diskTotalReadIops, poolTotalSaving=poolTotalSaving, fcTargetModifyCompleted=fcTargetModifyCompleted, haResourceGroupTakeOverCompleted=haResourceGroupTakeOverCompleted, smbSocketFailure=smbSocketFailure, diskAvgWriteLatency=diskAvgWriteLatency, haControllerA_Name=haControllerA_Name, controllerUp=controllerUp, cacheTotalReadMbps=cacheTotalReadMbps, poolDeletionFailed=poolDeletionFailed, projectPostCompressionDataSizeHigh=projectPostCompressionDataSizeHigh, shareMountPoint=shareMountPoint, poolDataWriteLatency=poolDataWriteLatency, projectEntry=projectEntry, vmwareNFSDatastoreCreated=vmwareNFSDatastoreCreated, poolReadCacheReadMbps=poolReadCacheReadMbps, poolReadCacheWriteIops=poolReadCacheWriteIops, tdpsUpgradeDownloadStarted=tdpsUpgradeDownloadStarted, projectPostCompressionDataSizeLow=projectPostCompressionDataSizeLow, poolTable=poolTable, iscsiInitiatorEntry=iscsiInitiatorEntry, poolExported=poolExported, lunIndex=lunIndex, iscsiTargetWriteMbps=iscsiTargetWriteMbps, notificationThresholdTriggerValue=notificationThresholdTriggerValue, diskTotalReadMbps=diskTotalReadMbps, diskType=diskType, snapshotDeletedSuccessfully=snapshotDeletedSuccessfully, alertsCleanupCompleted=alertsCleanupCompleted, poolAvgWriteLatency=poolAvgWriteLatency, poolWriteCacheWriteMbps=poolWriteCacheWriteMbps, nvdimmFailInitializationError=nvdimmFailInitializationError, lunReadLatency=lunReadLatency, diskState=diskState, haControllerB_IPAddr=haControllerB_IPAddr, lunCompressedRatio=lunCompressedRatio, shareCIFSReadIops=shareCIFSReadIops, fcTargetGroup=fcTargetGroup, fcInitiatorName=fcInitiatorName, iscsiTargets=iscsiTargets, globalStatistics=globalStatistics, haResources=haResources, poolMetaWriteIops=poolMetaWriteIops, lunDataSizeHigh=lunDataSizeHigh, initiatorGroupDeleteCompleted=initiatorGroupDeleteCompleted, projectCreatedWithNonOptimalBlockSize=projectCreatedWithNonOptimalBlockSize, projectPoolName=projectPoolName, shareDeleted=shareDeleted, volumeDeleteFailed=volumeDeleteFailed, shareSnapshotSizeHigh=shareSnapshotSizeHigh, fcTotalWriteIops=fcTotalWriteIops, vmwareNFSDatastoresAvgReadLatency=vmwareNFSDatastoresAvgReadLatency, networkInterfaceUp=networkInterfaceUp, haResourceDescription=haResourceDescription, diskRandomIOCount=diskRandomIOCount, vmwareNFSDatastoresTotalReadMbps=vmwareNFSDatastoresTotalReadMbps, lunSizeLow=lunSizeLow, projectCreatedSuccessfully=projectCreatedSuccessfully, fcTargetResetHbaPortFailed=fcTargetResetHbaPortFailed, tdpsUpgradeDownloadFailed=tdpsUpgradeDownloadFailed, testNotification=testNotification, fcTargetEntry=fcTargetEntry, projectIndex=projectIndex, vmwareNFSDatastoreWriteMbps=vmwareNFSDatastoreWriteMbps, intelliFlashSoftwareDown=intelliFlashSoftwareDown, notificationSensorNumber=notificationSensorNumber, iscsiImproperTargetGroup=iscsiImproperTargetGroup, shareNFSReadIops=shareNFSReadIops, fcInitiatorCreateFailed=fcInitiatorCreateFailed, lunTable=lunTable, fcInitiatorIndex=fcInitiatorIndex, diskSlowIo=diskSlowIo, shareNFSEnabled=shareNFSEnabled, iscsiInitiatorIndex=iscsiInitiatorIndex, fcTargetWriteLatency=fcTargetWriteLatency, fcAvgReadLatency=fcAvgReadLatency, lunBlockSize=lunBlockSize, targetGroupMemberRemoved=targetGroupMemberRemoved, iscsiTargetModifyCompleted=iscsiTargetModifyCompleted, poolUnusedReservedSizeLow=poolUnusedReservedSizeLow, vmwareNFSDatastoresAvgWriteLatency=vmwareNFSDatastoresAvgWriteLatency, diskDataWriteMbps=diskDataWriteMbps, currentNotificationGroup=currentNotificationGroup, sanProperties=sanProperties, shareSnapshotSizeLow=shareSnapshotSizeLow, snmpServiceStopped=snmpServiceStopped, notificationReadingTriggerValue=notificationReadingTriggerValue, diskChassisIdx=diskChassisIdx, poolProjectCount=poolProjectCount, vmwareNFSDatastoreVMName=vmwareNFSDatastoreVMName, userLoginFailed=userLoginFailed, shareQuotaHigh=shareQuotaHigh, poolReadCacheReadLatency=poolReadCacheReadLatency, shareDataSizeHigh=shareDataSizeHigh, shareCIFSReadLatency=shareCIFSReadLatency, haResourceGroup=haResourceGroup, shareNFSWriteIops=shareNFSWriteIops, disks=disks, lunSizeHigh=lunSizeHigh, fcAvgWriteLatency=fcAvgWriteLatency, fcPortOnline=fcPortOnline, replicationFailed=replicationFailed, networkIpmpGroupDown=networkIpmpGroupDown, projectQuotaFinished=projectQuotaFinished, poolFreeSizeLow=poolFreeSizeLow, iscsiTargetWriteLatency=iscsiTargetWriteLatency, memoryFailure=memoryFailure, poolPostCompressionDataSizeLow=poolPostCompressionDataSizeLow, networkIpmpMemberInterfaceAdded=networkIpmpMemberInterfaceAdded, iscsiTargetAlias=iscsiTargetAlias, notificationSensorAction=notificationSensorAction, ipmiMemory=ipmiMemory, ipmiPowerSupply=ipmiPowerSupply, targetGroupDeleteCompleted=targetGroupDeleteCompleted, cacheTotalWriteMbps=cacheTotalWriteMbps, maintenanceModeEnabled=maintenanceModeEnabled, upgradeCantProcessFilesManually=upgradeCantProcessFilesManually, poolDegraded=poolDegraded, poolFreeSizeHigh=poolFreeSizeHigh, shareTable=shareTable, fcTargetReadLatency=fcTargetReadLatency, lunSnapshotSizeHigh=lunSnapshotSizeHigh, fcPortOffline=fcPortOffline, iscsiTargetName=iscsiTargetName, networkTotalTransmitMbps=networkTotalTransmitMbps, iscsiTotalReadMbps=iscsiTotalReadMbps, intelliFlashSoftwareUp=intelliFlashSoftwareUp, notificationTime=notificationTime, webdocsUpgradeCompleted=webdocsUpgradeCompleted, diskSizeLow=diskSizeLow, lunDedupEnabled=lunDedupEnabled, cpuTotalUsage=cpuTotalUsage, projectQuotaSizeHigh=projectQuotaSizeHigh, poolWriteCacheWriteIops=poolWriteCacheWriteIops, fcTargetsTable=fcTargetsTable, poolUpgraded=poolUpgraded, snapshotCloneCompleted=snapshotCloneCompleted, cpuInterrupts=cpuInterrupts, iscsiTargetError=iscsiTargetError, nfsTotalWriteMbps=nfsTotalWriteMbps, notificationDescription=notificationDescription, projectCompressionEnabled=projectCompressionEnabled, shareReservedSizeLow=shareReservedSizeLow, ntpServerTimeDrift=ntpServerTimeDrift, lunFreeSizeHigh=lunFreeSizeHigh, poolOwnerController=poolOwnerController, diskDataReadMbps=diskDataReadMbps, poolDataSizeLow=poolDataSizeLow, projectDataSizeHigh=projectDataSizeHigh, replicationResumed=replicationResumed, nvdimmFailSoftError=nvdimmFailSoftError, poolAvgReadLatency=poolAvgReadLatency, poolQuotaExceedThresholdWarning=poolQuotaExceedThresholdWarning, snapshotRollbackFailed=snapshotRollbackFailed, diskSizeHigh=diskSizeHigh, replicationComplete=replicationComplete, diskPoolName=diskPoolName, shareCompressedRatio=shareCompressedRatio, poolUsedSizeLow=poolUsedSizeLow, fcInitiatorGroup=fcInitiatorGroup, lunTargetGroup=lunTargetGroup, cifsTotalWriteMbps=cifsTotalWriteMbps, poolDataReadIops=poolDataReadIops, notificationComponentName=notificationComponentName, poolExpanded=poolExpanded, webdocsUpgradeDownloadCompleted=webdocsUpgradeDownloadCompleted, upgradeTimeout=upgradeTimeout, nicIndex=nicIndex, diskDataReadIops=diskDataReadIops, diskTable=diskTable, iscsiInitiatorsTable=iscsiInitiatorsTable, diskIsOnline=diskIsOnline, snapshotRollbackCompleted=snapshotRollbackCompleted, projectName=projectName, notificationProps=notificationProps, targetGroupCreateCompleted=targetGroupCreateCompleted, haResourceGroupTakeBackCompleted=haResourceGroupTakeBackCompleted, poolState=poolState, cifsAvgWriteLatency=cifsAvgWriteLatency, shareEntry=shareEntry, tegileArray=tegileArray, haResourceStatus=haResourceStatus, snmpServiceStarted=snmpServiceStarted, notificationObjects=notificationObjects, tdpsUpgradeFailed=tdpsUpgradeFailed, ipmiTemperature=ipmiTemperature, poolDataReadLatency=poolDataReadLatency, webdocsUpgradeFailed=webdocsUpgradeFailed, maintenanceModeDisabled=maintenanceModeDisabled, deleteFolderCompleted=deleteFolderCompleted, poolDataWriteIops=poolDataWriteIops, upgradeFailed=upgradeFailed, ipmiOther=ipmiOther, iscsiProperties=iscsiProperties, replicationTargetDeleted=replicationTargetDeleted, poolQuotaFinished=poolQuotaFinished, smisServiceStopped=smisServiceStopped)
mibBuilder.exportSymbols("TEGILE-MIB", fcTotalReadIops=fcTotalReadIops, unknownSensorEvent=unknownSensorEvent, upgradeDownloadStarted=upgradeDownloadStarted, networkIpmpMemberInterfaceRemoved=networkIpmpMemberInterfaceRemoved, lunWriteMbps=lunWriteMbps, adServerTimeDrift=adServerTimeDrift, cacheTotalWriteIops=cacheTotalWriteIops, currentObjectGroup=currentObjectGroup, tegileGroups=tegileGroups, poolUsedSizeHigh=poolUsedSizeHigh, lunProjectName=lunProjectName, iscsiTargetIndex=iscsiTargetIndex, vmwareNFSDatastoreReadIops=vmwareNFSDatastoreReadIops, iscsiInitiatorModifyCompleted=iscsiInitiatorModifyCompleted, notificationSensorSuspect=notificationSensorSuspect, snapshotCreatedSuccessfully=snapshotCreatedSuccessfully, poolPostCompressionDataSizeHigh=poolPostCompressionDataSizeHigh, poolSizeLow=poolSizeLow, lunWriteIops=lunWriteIops, vmwareNFSDatastoresTable=vmwareNFSDatastoresTable, poolTotalWriteMbps=poolTotalWriteMbps, nicGroup=nicGroup, lunCompressionEnabled=lunCompressionEnabled, fcTargetIndex=fcTargetIndex, fcTargetReadMbps=fcTargetReadMbps, poolTotalReadMbps=poolTotalReadMbps, nfsTotalWriteIops=nfsTotalWriteIops, iscsiInitiators=iscsiInitiators, volumeDeleteCompleted=volumeDeleteCompleted, tdpsUpgradeCompleted=tdpsUpgradeCompleted, projectThresholdExceedWarning=projectThresholdExceedWarning, vmwareNFSDatastoreReadMbps=vmwareNFSDatastoreReadMbps, ipmiVoltage=ipmiVoltage, snmpAgentVersion=snmpAgentVersion, volumeExceedsThresholdWarning=volumeExceedsThresholdWarning, poolReadCacheWriteLatency=poolReadCacheWriteLatency, nfsTotalReadMbps=nfsTotalReadMbps, networkInterfaceDown=networkInterfaceDown, shareNFSWriteLatency=shareNFSWriteLatency, fcInitiatorModifyCompleted=fcInitiatorModifyCompleted, projectFreeSizeLow=projectFreeSizeLow, volumeQuotaFinished=volumeQuotaFinished, diskSequentialIOCount=diskSequentialIOCount, poolReadCacheWriteMbps=poolReadCacheWriteMbps, fcInitiatorEntry=fcInitiatorEntry, replicationSourceRegistered=replicationSourceRegistered, poolMetaWriteMbps=poolMetaWriteMbps, haResourceActiveNode=haResourceActiveNode, iscsiTotalWriteMbps=iscsiTotalWriteMbps, replicationAborted=replicationAborted, vmwareNFSDatastoreIndex=vmwareNFSDatastoreIndex, iscsiAvgWriteLatency=iscsiAvgWriteLatency, poolMetaReadMbps=poolMetaReadMbps, projectDedupEnabled=projectDedupEnabled, lunName=lunName, tdpsUpgradeDownloadCompleted=tdpsUpgradeDownloadCompleted, volumeCreatedSuccessfully=volumeCreatedSuccessfully, lunReservedSizeLow=lunReservedSizeLow, diskGoneOffline=diskGoneOffline, shareCIFSEnabled=shareCIFSEnabled, iscsiTargetReadMbps=iscsiTargetReadMbps, lunEntry=lunEntry, notificationEventCode=notificationEventCode, controllerHardwareModel=controllerHardwareModel, iscsiInitiatorCreateCompleted=iscsiInitiatorCreateCompleted, iscsiTargetGroupError=iscsiTargetGroupError, poolTotalReadIops=poolTotalReadIops, vmwareNFSDatastoreDeleted=vmwareNFSDatastoreDeleted, iscsiInitiatorCreateFailed=iscsiInitiatorCreateFailed, haControllerB_SoftwareVersion=haControllerB_SoftwareVersion, networkTotalReceiveMbps=networkTotalReceiveMbps, lunProtocol=lunProtocol, shareIndex=shareIndex, smisServiceStartFailed=smisServiceStartFailed, PYSNMP_MODULE_ID=tegile, projectFreeSizeHigh=projectFreeSizeHigh, projectLUNs=projectLUNs, shareCIFSReadMbps=shareCIFSReadMbps, initiatorGroupMemberAdded=initiatorGroupMemberAdded, netbiosSocketFailure=netbiosSocketFailure, shareNFSReadLatency=shareNFSReadLatency, poolDataReadMbps=poolDataReadMbps, fcInitiatorsTable=fcInitiatorsTable, poolDataSizeHigh=poolDataSizeHigh, properties=properties, shareCreatedSuccessfully=shareCreatedSuccessfully, projectDeleted=projectDeleted, nicMTU=nicMTU, network=network, poolCount=poolCount, nfsAvgReadLatency=nfsAvgReadLatency, fcTargetName=fcTargetName, sharePoolName=sharePoolName, tegile=tegile, nicTransmitMbps=nicTransmitMbps, poolMetaDataQuotaExceedThresholdWarning=poolMetaDataQuotaExceedThresholdWarning, lunPoolName=lunPoolName, cifsTotalReadMbps=cifsTotalReadMbps, vmwareNFSDatastoreEntry=vmwareNFSDatastoreEntry, cacheSSDReads=cacheSSDReads, tegileConformance=tegileConformance, diskIndex=diskIndex, nicState=nicState, poolWriteCacheWriteLatency=poolWriteCacheWriteLatency, fcTargets=fcTargets, projectQuotaSizeLow=projectQuotaSizeLow, shareDeletionFailed=shareDeletionFailed, snapshotDeleteFailed=snapshotDeleteFailed, upgradeDownloadCompleted=upgradeDownloadCompleted, nicEntry=nicEntry, shareProjectName=shareProjectName, iscsiTotalReadIops=iscsiTotalReadIops, poolPostDedupDataSizeLow=poolPostDedupDataSizeLow, poolPostDedupDataSizeHigh=poolPostDedupDataSizeHigh, projectSnapshotSizeLow=projectSnapshotSizeLow, cacheRAMReads=cacheRAMReads, spareDiskReplaced=spareDiskReplaced, fcTargetStatus=fcTargetStatus, iscsiTargetReadLatency=iscsiTargetReadLatency, fcInitiatorCreateCompleted=fcInitiatorCreateCompleted, cifsAvgReadLatency=cifsAvgReadLatency, haControllerB_Uptime=haControllerB_Uptime, poolDeleted=poolDeleted, haControllerA_IPAddr=haControllerA_IPAddr, aclMigrationStarted=aclMigrationStarted, haResourceEntry=haResourceEntry, deleteFolderFailed=deleteFolderFailed, projectShares=projectShares, iscsiTargetsTable=iscsiTargetsTable, shareQuotaFinished=shareQuotaFinished, poolMetaReadIops=poolMetaReadIops, notificationSeverity=notificationSeverity, haResourceIndex=haResourceIndex, nicTable=nicTable, diskTotalWriteMbps=diskTotalWriteMbps, fcProperties=fcProperties, poolAvailableMetaToDataRatioBelowThresholdWarning=poolAvailableMetaToDataRatioBelowThresholdWarning, upgradeDownloadFailed=upgradeDownloadFailed, shareReservedSizeHigh=shareReservedSizeHigh, diskDataWriteIops=diskDataWriteIops, nvdimmFailDeviceError=nvdimmFailDeviceError, haControllerB_Name=haControllerB_Name, iscsiWriteIops=iscsiWriteIops, snapshotCreationFailed=snapshotCreationFailed, projectLunCount=projectLunCount, ipmiFan=ipmiFan, lunFreeSizeLow=lunFreeSizeLow, vmwareNFSDatastoresTotalWriteMbps=vmwareNFSDatastoresTotalWriteMbps, lunSnapshotSizeLow=lunSnapshotSizeLow, nvdimmFailUnknownError=nvdimmFailUnknownError, networkIpmpGroupUp=networkIpmpGroupUp, aclMigrationCompleted=aclMigrationCompleted, poolIndex=poolIndex, fcTargetResetHbaPortCompleted=fcTargetResetHbaPortCompleted, lunDataSizeLow=lunDataSizeLow, controllerTimeDrift=controllerTimeDrift, poolEntry=poolEntry, tegileArray_notifications=tegileArray_notifications, nicName=nicName, shareNFSReadMbps=shareNFSReadMbps, poolMetaReadLatency=poolMetaReadLatency, projectUnusedReservedSizeLow=projectUnusedReservedSizeLow, smisServiceStarted=smisServiceStarted, shareCIFSWriteMbps=shareCIFSWriteMbps, vmwareNFSDatastoreWriteIops=vmwareNFSDatastoreWriteIops, iscsiTargetCreateCompleted=iscsiTargetCreateCompleted, snmpServiceStartFailed=snmpServiceStartFailed, iscsiInitiatorGroup=iscsiInitiatorGroup, nfsAvgWriteLatency=nfsAvgWriteLatency, shareDedupEnabled=shareDedupEnabled, projectDataSizeLow=projectDataSizeLow, iscsiTargetGroup=iscsiTargetGroup, diskAvgReadLatency=diskAvgReadLatency, poolCreated=poolCreated, poolName=poolName, upgradeStarted=upgradeStarted, cifsTotalWriteIops=cifsTotalWriteIops, diskEntry=diskEntry, upgradeCompleted=upgradeCompleted, cpuSystemCalls=cpuSystemCalls, cifsTotalReadIops=cifsTotalReadIops, shareNFSWriteMbps=shareNFSWriteMbps, poolMetaWriteLatency=poolMetaWriteLatency, initiatorGroupMemberRemoved=initiatorGroupMemberRemoved, fcTargetWriteIops=fcTargetWriteIops, cacheTotalReadIops=cacheTotalReadIops, lunInitiatorGroup=lunInitiatorGroup, haResourceName=haResourceName, vmwareNFSDatastoreWriteLatency=vmwareNFSDatastoreWriteLatency, fcTotalWriteMbps=fcTotalWriteMbps, iscsiTargetAuth=iscsiTargetAuth, haControllerA_SoftwareVersion=haControllerA_SoftwareVersion, haControllerA_Uptime=haControllerA_Uptime, projectModified=projectModified, iscsiInitiatorDeleteCompleted=iscsiInitiatorDeleteCompleted, lunWriteLatency=lunWriteLatency, initiatorGroupCreateCompleted=initiatorGroupCreateCompleted, fcTargetReadIops=fcTargetReadIops, poolDataWriteMbps=poolDataWriteMbps, tdpsUpgradeTimeout=tdpsUpgradeTimeout, shareName=shareName, lunReadIops=lunReadIops, shareQuotaLow=shareQuotaLow, shareCIFSWriteLatency=shareCIFSWriteLatency, nfsTotalReadIops=nfsTotalReadIops, lunReadMbps=lunReadMbps, tegileCompliances=tegileCompliances, poolSizeHigh=poolSizeHigh, iscsiTargetWriteIops=iscsiTargetWriteIops, projectTable=projectTable, projectShareCount=projectShareCount, replicationStarted=replicationStarted, iscsiAvgReadLatency=iscsiAvgReadLatency, notifications=notifications, haResourcesTable=haResourcesTable)
