...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, iPv4Address=iPv4Address, bridge=bridge, tFTPClient=tFTPClient, tDDSynchronizationMode=tDDSynchronizationMode, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, frequencyVariant=frequencyVariant, vectorErrorLinked=vectorErrorLinked, channelChangeTrap=channelChangeTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, systemReset=systemReset, auxPortQLRx=auxPortQLRx, transparentClock=transparentClock, sFPPortStatus=sFPPortStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, receiveFreqMHz=receiveFreqMHz, qOSPriorityScheme=qOSPriorityScheme, vectorError=vectorError, pubInstancedStatsTable=pubInstancedStatsTable, ptmp=ptmp, installStatus=installStatus, accessMethod=accessMethod, licenseInstancedTableNumber=licenseInstancedTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, remoteUnitName=remoteUnitName, range=range, dNSGroup=dNSGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, dataBridgingAvailability=dataBridgingAvailability, rangeLinked=rangeLinked, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, mABTransmissionInterval=mABTransmissionInterval, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, deviceMSN=deviceMSN, licenseEncryption=licenseEncryption, dataPortPauseFrames=dataPortPauseFrames, lbtDetectedTrap=lbtDetectedTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, PYSNMP_MODULE_ID=cambium, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, phyControlInstancedTableNumber=phyControlInstancedTableNumber, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, linkLoss=linkLoss, remoteInternetAddressLinked=remoteInternetAddressLinked, configurationInstancedTableIndex=configurationInstancedTableIndex, managementGroup=managementGroup, licenseGroup=licenseGroup, rawReceivePower=rawReceivePower, tDMChannelLoopback=tDMChannelLoopback, syslogState=syslogState, licenseTrialPeriod=licenseTrialPeriod, receiveDataRateLinked=receiveDataRateLinked, phyControlInstancedTable=phyControlInstancedTable, alarmInstancedTableNumber=alarmInstancedTableNumber, configuration=configuration, transmitFreqMHz=transmitFreqMHz, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, managementNetworkAccessEnabled=managementNetworkAccessEnabled, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mABNominalModulationMode=mABNominalModulationMode, softwareVersion=softwareVersion, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, dNSServerTable=dNSServerTable, ethernetPriorityTable=ethernetPriorityTable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, severelyErroredSeconds=severelyErroredSeconds, licenseSyncESupport=licenseSyncESupport, resetGroup=resetGroup, receiveDataRate=receiveDataRate, configurationGroup=configurationGroup, tDMInterfaceControl=tDMInterfaceControl, cableLoss=cableLoss, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, useVLANForMABProtocol=useVLANForMABProtocol, iPVersion=iPVersion, licenseInstancedTableEntry=licenseInstancedTableEntry, sFPPortAllocation=sFPPortAllocation, phyControl=phyControl, nIDULanPortStatus=nIDULanPortStatus, licenseGroupAccess=licenseGroupAccess, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, transparentClockVID=transparentClockVID, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPState=sNTPState, userTableIndex=userTableIndex, sFPPortAutoMdix=sFPPortAutoMdix, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, altitude=altitude, syslogClientTrap=syslogClientTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseInstancedTableIndex=licenseInstancedTableIndex, phyControlInstancedTableEntry=phyControlInstancedTableEntry, dNSServerTableEntry=dNSServerTableEntry, tDMChannelStatus=tDMChannelStatus, receivePower=receivePower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, timeZone=timeZone, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, dNSServerPortNumber=dNSServerPortNumber, dfsTableEntry=dfsTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, longitude=longitude, incompatibleRegulatoryBands=incompatibleRegulatoryBands, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, apcGroup=apcGroup, apc=apc, routerProtocols=routerProtocols, gatewayIPAddress=gatewayIPAddress, tdmTableEntry=tdmTableEntry, sFPPortQLRx=sFPPortQLRx, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseRARSupport=licenseRARSupport, tDDSynchronizationStatus=tDDSynchronizationStatus, lowestDataModulationMode=lowestDataModulationMode, hCMPLinkSymmetry=hCMPLinkSymmetry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetInstancedTableEntry=ethernetInstancedTableEntry, receiveChannel=receiveChannel, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, vLANManagementPriority=vLANManagementPriority, lowestTDMModulationMode=lowestTDMModulationMode, mainPSUPortSSMTx=mainPSUPortSSMTx, cableDiagnosticsWarning=cableDiagnosticsWarning, dNSServerInternetAddressType=dNSServerInternetAddressType, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, dNSServerInternetAddress=dNSServerInternetAddress, installStatusTrap=installStatusTrap, license=license, licenseCountry=licenseCountry, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, localPacketFiltering=localPacketFiltering, subnetMask=subnetMask, tempPcb=tempPcb, sMTPEnabledMessages=sMTPEnabledMessages, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, auxPortSyncERxStatus=auxPortSyncERxStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, ptp=ptp, remoteMaximumTransmitPower=remoteMaximumTransmitPower, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, userName=userName, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, licenseIEEE1588Support=licenseIEEE1588Support, transmitChannel=transmitChannel, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dNS=dNS, authorizationControlTableIndex=authorizationControlTableIndex, cableDiagPair1Results=cableDiagPair1Results, deviceMACAddress=deviceMACAddress, licenseTDDSyncSupport=licenseTDDSyncSupport, rxColorCode=rxColorCode, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, sNMPPortNumber=sNMPPortNumber, licenseIssueNumber=licenseIssueNumber, encryptionGroup=encryptionGroup, syslogStateTrap=syslogStateTrap, transmitterChannels=transmitterChannels, routerProtocolsGroup=routerProtocolsGroup, remoteUnitNameLinked=remoteUnitNameLinked, syncETracking=syncETracking, pubStats=pubStats, dfsTableNumber=dfsTableNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, mABHoldoffPeriod=mABHoldoffPeriod, phyStatus=phyStatus, authorizationControl=authorizationControl, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, hardwareVersion=hardwareVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dNSPrimaryServer=dNSPrimaryServer, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, rangingMode=rangingMode, sFPError=sFPError, sntp=sntp, receiveFreqKHz=receiveFreqKHz, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkSymmetry=linkSymmetry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, blacklistRMEnabled=blacklistRMEnabled, auxPortConfigurationMismatch=auxPortConfigurationMismatch, byteErrorRatioLinked=byteErrorRatioLinked, transmitDataRate=transmitDataRate, telnetPortNumber=telnetPortNumber, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseBandwidthCap=licenseBandwidthCap, secureModeAlarmTrap=secureModeAlarmTrap, receiveModulationModeDetail=receiveModulationModeDetail, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, transmitPower=transmitPower, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rawReceivePowerLinked=rawReceivePowerLinked, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, aggregateDataRateLinked=aggregateDataRateLinked, auxPortDisabledWarning=auxPortDisabledWarning, ptpCompliance=ptpCompliance, unitIdentificationGroup=unitIdentificationGroup, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, userRole=userRole, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTable=dfsTable, tDMConfigurationMismatch=tDMConfigurationMismatch, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseMaxLinkRange=licenseMaxLinkRange, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, regulatoryBand=regulatoryBand, ethernetGroup=ethernetGroup, transmitPowerLinked=transmitPowerLinked, sFPPortQLTx=sFPPortQLTx, mPLSTCPriorityTable=mPLSTCPriorityTable, mABNominalTransmitCapacity=mABNominalTransmitCapacity, daylightSaving=daylightSaving, transmitModulationMode=transmitModulationMode, dfsTableIndex=dfsTableIndex, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, licenseCapacity=licenseCapacity, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dSCPManagementPriority=dSCPManagementPriority)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tFTPServerInternetAddress=tFTPServerInternetAddress, alarmInstancedTableEntry=alarmInstancedTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mainPSUPortStatusTrap=mainPSUPortStatusTrap, bootVersion=bootVersion, sNTPServerTableNumber=sNTPServerTableNumber, supplementary=supplementary, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mgmtInstancedTable=mgmtInstancedTable, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tdmTableIndex=tdmTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, auxPortStatusTrap=auxPortStatusTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseGasGroup=licenseGasGroup, tDMGroup=tDMGroup, sNTPServerRetries=sNTPServerRetries, sNMPv3Enable=sNMPv3Enable, whitelistRMEnabled=whitelistRMEnabled, ptpTraps=ptpTraps, versionsGroup=versionsGroup, licenseSecurityLevel=licenseSecurityLevel, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitFreqKHz=transmitFreqKHz, transmitModulationModeLinked=transmitModulationModeLinked, wirelessLinkAvailability=wirelessLinkAvailability, channelBandwidth=channelBandwidth, userTable=userTable, linkLossLinked=linkLossLinked, authorizationControlGroup=authorizationControlGroup, syncESlavePort=syncESlavePort, enableTransmission=enableTransmission, cableDiagPair3Results=cableDiagPair3Results, dataBridgingStatus=dataBridgingStatus, mABMaintenanceLevel=mABMaintenanceLevel, ethernetStatisticsDataSource=ethernetStatisticsDataSource, ptpGroups=ptpGroups, sNTPServerTableEntry=sNTPServerTableEntry, tdmTable=tdmTable, tdmTableNumber=tdmTableNumber, regulatoryBandTrap=regulatoryBandTrap, licenseVersion=licenseVersion, installationMode=installationMode, syslogControl=syslogControl, aAAControlGroup=aAAControlGroup, remoteInternetAddressType=remoteInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, userTableNumber=userTableNumber, sNTPSync=sNTPSync, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, wirelessOutEthernetOctets=wirelessOutEthernetOctets, erroredSeconds=erroredSeconds, notificationsGroup=notificationsGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseHCMPSupport=licenseHCMPSupport, noWirelessChannelAvailable=noWirelessChannelAvailable, tDMChannelLineCode=tDMChannelLineCode, hTTPPortNumber=hTTPPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, smtpGroup=smtpGroup, txColorCode=txColorCode, alarmInstancedTableIndex=alarmInstancedTableIndex, wirelessLinkStatus=wirelessLinkStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tDMEnabledChannels=tDMEnabledChannels, cableDiagPair2Results=cableDiagPair2Results, sMTPServerInternetAddress=sMTPServerInternetAddress, receiveModulationMode=receiveModulationMode, hTTPSPortNumber=hTTPSPortNumber, signalStrengthRatio=signalStrengthRatio, userPassword=userPassword, iPDSCPPriorityTable=iPDSCPPriorityTable, wirelessTopology=wirelessTopology, transparentClockPort=transparentClockPort, authorizationControlTable=authorizationControlTable, authorizationControlTableNumber=authorizationControlTableNumber, syslogClient=syslogClient, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userEnabled=userEnabled, userTableEntry=userTableEntry, alarmInstancedTable=alarmInstancedTable, mgmtInstancedTableIndex=mgmtInstancedTableIndex, siteName=siteName, ethernetPriorityTableIndex=ethernetPriorityTableIndex, maximumTransmitPower=maximumTransmitPower, unitName=unitName, ethernet=ethernet, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, installArmState=installArmState, tDDControl=tDDControl, tFTPServerPortNumber=tFTPServerPortNumber, capacityVariantMismatchTrap=capacityVariantMismatchTrap, subbandHighestFrequency=subbandHighestFrequency, sNTPServerPortNumber=sNTPServerPortNumber, dNSServerTableIndex=dNSServerTableIndex, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sFPPortSyncERxStatus=sFPPortSyncERxStatus, productVariant=productVariant, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sFPPortStatusTrap=sFPPortStatusTrap, auxPortStatus=auxPortStatus, linkModeOptimization=linkModeOptimization, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, signalStrengthRatioLinked=signalStrengthRatioLinked, searchState=searchState, receivePowerLinked=receivePowerLinked, capacityVariantMismatchLinked=capacityVariantMismatchLinked, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, portAllocationMismatchLinked=portAllocationMismatchLinked, sMTPEmailAlert=sMTPEmailAlert, snmpControlGroup=snmpControlGroup, telnetAccessEnabled=telnetAccessEnabled, encryptionAlgorithm=encryptionAlgorithm, vLANManagementVID=vLANManagementVID, txMABFrames=txMABFrames, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseUnitSerialNumber=licenseUnitSerialNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, mABState=mABState, syslogControlGroup=syslogControlGroup, remoteMACAddressLinked=remoteMACAddressLinked, maximumNumberOfSlaves=maximumNumberOfSlaves, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, smtp=smtp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, authorizationMethod=authorizationMethod, sNMPTrapTableEntry=sNMPTrapTableEntry, mainPSUPortAllocation=mainPSUPortAllocation, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, unavailableSeconds=unavailableSeconds, sNMPTrapTable=sNMPTrapTable, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, byteErrorRatio=byteErrorRatio, dfsPeaks=dfsPeaks, licenseIPv6Support=licenseIPv6Support, useVLANForManagementInterfaces=useVLANForManagementInterfaces, cableDiagnosticsResultTable=cableDiagnosticsResultTable, installArmStateTrap=installArmStateTrap, sNTPServerTimeout=sNTPServerTimeout, receiveModulationModeLinked=receiveModulationModeLinked, productName=productName, licenseInstancedTable=licenseInstancedTable, phyControlInstancedTableIndex=phyControlInstancedTableIndex, dataBridgingStatusLinked=dataBridgingStatusLinked, sNMPEnabledTraps=sNMPEnabledTraps, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, syncEEquipmentClock=syncEEquipmentClock, packetsToInternalStack=packetsToInternalStack, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, installStatusLinked=installStatusLinked, cableDiagnosticsPorts=cableDiagnosticsPorts, dNSResolver=dNSResolver, sFPPortSSMTx=sFPPortSSMTx, masterSlaveMode=masterSlaveMode, configurationInstancedTableEntry=configurationInstancedTableEntry, versions=versions, ethernetInstancedTableIndex=ethernetInstancedTableIndex, subbandLowestFrequency=subbandLowestFrequency, ptp670=ptp670, secureModeAlarm=secureModeAlarm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, linkName=linkName, configurationInstancedTableNumber=configurationInstancedTableNumber, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, auxPortAcceptedQLRx=auxPortAcceptedQLRx, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, mABProtocolVID=mABProtocolVID, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetStatisticsTable=ethernetStatisticsTable, remoteInternetAddress=remoteInternetAddress, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, authorizationControlTableEntry=authorizationControlTableEntry, transparentClockVLAN=transparentClockVLAN, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, dfsGroup=dfsGroup, remoteMACAddress=remoteMACAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, snmpControl=snmpControl, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, tDMInterfaceStatus=tDMInterfaceStatus, alarmsGroup=alarmsGroup, targetRange=targetRange, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, reset=reset, hTTPSAccessEnabled=hTTPSAccessEnabled, aggregateDataRate=aggregateDataRate, licenseSFPPortSupport=licenseSFPPortSupport, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mABProtocolVLANPriority=mABProtocolVLANPriority, sNTPLastSync=sNTPLastSync, auxPortQLTx=auxPortQLTx, sNTPPollInterval=sNTPPollInterval, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPSyncTrap=sNTPSyncTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, cableDiagnosticsGroup=cableDiagnosticsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, l2CPPriorityTable=l2CPPriorityTable, tDMChannelCableLength=tDMChannelCableLength, supplementaryGroup=supplementaryGroup, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, systemClock=systemClock, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, wirelessOutOctets=wirelessOutOctets, cableDiagPair1Distance=cableDiagPair1Distance, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, portAllocationMismatchTrap=portAllocationMismatchTrap, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, ethernetInstancedTable=ethernetInstancedTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControlGroup=phyControlGroup, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, portAllocationMismatch=portAllocationMismatch, sNTPServerStatus=sNTPServerStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, mainPSUPortStatus=mainPSUPortStatus, auxPortSSMTx=auxPortSSMTx, groupID=groupID, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, configurationInstancedTable=configurationInstancedTable, phyInstancedStatusTable=phyInstancedStatusTable, blacklistRMMacAddress=blacklistRMMacAddress, capacityVariantMismatch=capacityVariantMismatch, mainPSUPortQLRx=mainPSUPortQLRx, tDM=tDM, alarms=alarms, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", management=management, cableDiagPair4Results=cableDiagPair4Results, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, ethernetPriorityTableNumber=ethernetPriorityTableNumber, bridgeGroup=bridgeGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseTLSRekey=licenseTLSRekey, antennaSelection=antennaSelection, transmitDataRateLinked=transmitDataRateLinked, cableDiagPair3Distance=cableDiagPair3Distance, searchStateLinked=searchStateLinked, sFPErrorTrap=sFPErrorTrap, encryption=encryption, cambium=cambium, tFTPServerInternetAddressType=tFTPServerInternetAddressType, auxPortAllocation=auxPortAllocation, unitIdentification=unitIdentification, tDMChannelStatusTrap=tDMChannelStatusTrap, targetMACAddress=targetMACAddress, syncETrackingState=syncETrackingState, dfs=dfs, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, iPv6Address=iPv6Address, sNTPPrimaryServer=sNTPPrimaryServer, dNSServerTableNumber=dNSServerTableNumber, cableDiagnosticsControl=cableDiagnosticsControl, cableDiagPair2Distance=cableDiagPair2Distance, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, latitude=latitude, pubStatsGroup=pubStatsGroup, cableDiagnostics=cableDiagnostics, sNTPServerTable=sNTPServerTable, antennaGain=antennaGain, packetsFromInternalStack=packetsFromInternalStack, dataPortWirelessDownAlert=dataPortWirelessDownAlert, oOBPriorityQueueMapping=oOBPriorityQueueMapping, deviceESN=deviceESN, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sNMPCommunityString=sNMPCommunityString, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseOOBManagementSupport=licenseOOBManagementSupport, maxLinkRangeExceeded=maxLinkRangeExceeded, ptpTrapPrefix=ptpTrapPrefix, iPv6PrefixLength=iPv6PrefixLength, wirelessLinkStatusLinked=wirelessLinkStatusLinked, eIRP=eIRP, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sntpGroup=sntpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, wirelessOutAllOctets=wirelessOutAllOctets, sFPPortDisabledWarning=sFPPortDisabledWarning, dataBridgingStatusAlarm=dataBridgingStatusAlarm, whitelistRMMacAddress=whitelistRMMacAddress, aAAControl=aAAControl, dfsMeans=dfsMeans, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked)
