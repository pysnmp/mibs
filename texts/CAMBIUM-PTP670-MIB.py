...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagnosticsGroup=cableDiagnosticsGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, unitOutOfCalibration=unitOutOfCalibration, maximumTransmitPower=maximumTransmitPower, transparentClock=transparentClock, sMTPEmailAlert=sMTPEmailAlert, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, userPassword=userPassword, severelyErroredSeconds=severelyErroredSeconds, sNTPServerTable=sNTPServerTable, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, transmitModulationMode=transmitModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsGroup=dfsGroup, authorizationControlTableNumber=authorizationControlTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseMaxLinkRange=licenseMaxLinkRange, mainPSUPortSSMTx=mainPSUPortSSMTx, dfsMeans=dfsMeans, syslogStateTrap=syslogStateTrap, pubStatsGroup=pubStatsGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, rangingMode=rangingMode, licenseInstancedTableIndex=licenseInstancedTableIndex, configurationInstancedTableEntry=configurationInstancedTableEntry, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetInstancedTableEntry=ethernetInstancedTableEntry, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tDMChannelCableLength=tDMChannelCableLength, altitude=altitude, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, capacityVariantMismatchLinked=capacityVariantMismatchLinked, auxPortStatus=auxPortStatus, management=management, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, sFPPortStatus=sFPPortStatus, gatewayIPAddress=gatewayIPAddress, sNMPPortNumber=sNMPPortNumber, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseTLSRekey=licenseTLSRekey, deviceMSN=deviceMSN, mainPSUPortStatus=mainPSUPortStatus, alarmInstancedTable=alarmInstancedTable, receiveModulationMode=receiveModulationMode, licenseRegulatoryBandsList=licenseRegulatoryBandsList, cableLoss=cableLoss, capacityVariantMismatch=capacityVariantMismatch, snmpControl=snmpControl, byteErrorRatioLinked=byteErrorRatioLinked, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableIndex=userTableIndex, transparentClockVLAN=transparentClockVLAN, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, ptp670=ptp670, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, rangeLinked=rangeLinked, alarmInstancedTableIndex=alarmInstancedTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, dNSGroup=dNSGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPCommunityString=sNMPCommunityString, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetInstancedTableIndex=ethernetInstancedTableIndex, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, receiveDataRateLinked=receiveDataRateLinked, tDMInterfaceStatus=tDMInterfaceStatus, licenseIssueNumber=licenseIssueNumber, cableDiagnosticsControl=cableDiagnosticsControl, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, syncETrackingState=syncETrackingState, packetsToInternalStack=packetsToInternalStack, txMABFrames=txMABFrames, licenseGasGroup=licenseGasGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sFPError=sFPError, receiveModulationModeLinked=receiveModulationModeLinked, eIRP=eIRP, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, cableDiagPair2Results=cableDiagPair2Results, sNTPServerTimeout=sNTPServerTimeout, auxPortSyncERxStatus=auxPortSyncERxStatus, tdmTableIndex=tdmTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, receiveFreqMHz=receiveFreqMHz, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkStatusLinked=wirelessLinkStatusLinked, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, systemReset=systemReset, phyControlGroup=phyControlGroup, sFPPortStatusTrap=sFPPortStatusTrap, mgmtInstancedTable=mgmtInstancedTable, tFTPServerPortNumber=tFTPServerPortNumber, transmitChannel=transmitChannel, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDMConfigurationMismatch=tDMConfigurationMismatch, nIDULanPortStatusTrap=nIDULanPortStatusTrap, aggregateDataRateLinked=aggregateDataRateLinked, phyStatusGroup=phyStatusGroup, aAAControlGroup=aAAControlGroup, sFPErrorTrap=sFPErrorTrap, licenseCapacity=licenseCapacity, rawReceivePower=rawReceivePower, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, licenseVersion=licenseVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, vectorError=vectorError, sNTPState=sNTPState, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, cableDiagnostics=cableDiagnostics, dNSServerTableEntry=dNSServerTableEntry, alarmInstancedTableNumber=alarmInstancedTableNumber, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, receiveFreqKHz=receiveFreqKHz, transmitFreqKHz=transmitFreqKHz, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, l2CPPriorityTable=l2CPPriorityTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, productName=productName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableDiagPair1Distance=cableDiagPair1Distance, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, auxPortQLRx=auxPortQLRx, enableTransmission=enableTransmission, targetRange=targetRange, dataBridgingAvailability=dataBridgingAvailability, sntp=sntp, ethernet=ethernet, mainPSUPortAutoMdix=mainPSUPortAutoMdix, iPv6Address=iPv6Address, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDControlGroup=tDDControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tdmTableNumber=tdmTableNumber, dNSServerTableNumber=dNSServerTableNumber, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDDSynchronizationMode=tDDSynchronizationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataBridgingStatusLinked=dataBridgingStatusLinked, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, dNSServerTable=dNSServerTable, mainPSUPortStatusTrap=mainPSUPortStatusTrap, linkName=linkName, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, userTableEntry=userTableEntry, phyControlInstancedTableNumber=phyControlInstancedTableNumber, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mABState=mABState, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNTPPollInterval=sNTPPollInterval, phyControlInstancedTable=phyControlInstancedTable, signalStrengthRatio=signalStrengthRatio, authorizationControlTable=authorizationControlTable, configurationInstancedTable=configurationInstancedTable, linkLossLinked=linkLossLinked, dfsTableEntry=dfsTableEntry, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, telnetPortNumber=telnetPortNumber, useVLANForMABProtocol=useVLANForMABProtocol, sFPPortAllocation=sFPPortAllocation, licenseRARSupport=licenseRARSupport, licenseHCMPSupport=licenseHCMPSupport, tDDControl=tDDControl, smtpGroup=smtpGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptp=ptp, unavailableSeconds=unavailableSeconds, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, authorizationControl=authorizationControl, wirelessTopology=wirelessTopology, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sFPPortQLTx=sFPPortQLTx, linkModeOptimization=linkModeOptimization, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, syslogClient=syslogClient, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapPortNumber=sNMPTrapPortNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, vectorErrorLinked=vectorErrorLinked, cableDiagnosticsWarning=cableDiagnosticsWarning, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, syslogControlGroup=syslogControlGroup, reset=reset, txColorCode=txColorCode, ethernetInstancedTable=ethernetInstancedTable, sNTPServerTableIndex=sNTPServerTableIndex, managementGroup=managementGroup, latitude=latitude, licenseTDDSyncSupport=licenseTDDSyncSupport, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, vLANManagementVID=vLANManagementVID, phyControl=phyControl, encryption=encryption, subbandHighestFrequency=subbandHighestFrequency, whitelistRMEnabled=whitelistRMEnabled, dfsPeaks=dfsPeaks, licenseGroupAccess=licenseGroupAccess, ptpCompliance=ptpCompliance, bridgeGroup=bridgeGroup, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, pubStats=pubStats, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sNTPServerRetries=sNTPServerRetries, regulatoryBandTrap=regulatoryBandTrap, sNTPServerTableEntry=sNTPServerTableEntry, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, remoteInternetAddressType=remoteInternetAddressType, tdmTableEntry=tdmTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPServerInternetAddress=sMTPServerInternetAddress, subbandLowestFrequency=subbandLowestFrequency, ptpGroups=ptpGroups, linkModeOptimizationMismatch=linkModeOptimizationMismatch, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, dNSServerTableIndex=dNSServerTableIndex, siteName=siteName, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerTableNumber=sNTPServerTableNumber, dataBridgingStatus=dataBridgingStatus, aAAControl=aAAControl, mgmtInstancedTableEntry=mgmtInstancedTableEntry, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sntpGroup=sntpGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, alarmsGroup=alarmsGroup, transparentClockPort=transparentClockPort, packetsFromInternalStack=packetsFromInternalStack, transmitPowerLinked=transmitPowerLinked, portAllocationMismatchLinked=portAllocationMismatchLinked, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyStatus=phyStatus, remoteMACAddress=remoteMACAddress, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, iPv6GatewayAddress=iPv6GatewayAddress, remoteInternetAddressLinked=remoteInternetAddressLinked, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, frequencyVariant=frequencyVariant, dSCPManagementPriority=dSCPManagementPriority, tempPcb=tempPcb, cambium=cambium, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rxColorCode=rxColorCode, licenseGroup=licenseGroup, configuration=configuration, bridge=bridge, dNSServerInternetAddressType=dNSServerInternetAddressType, cableDiagPair4Results=cableDiagPair4Results, licenseCountry=licenseCountry, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPv3Enable=sNMPv3Enable, iPv6PrefixLength=iPv6PrefixLength, unitName=unitName, mABNominalTransmitCapacity=mABNominalTransmitCapacity, installStatusTrap=installStatusTrap, aggregateDataRate=aggregateDataRate, tDMChannelLineCode=tDMChannelLineCode, sNMPEnabledTraps=sNMPEnabledTraps, licenseSFPPortSupport=licenseSFPPortSupport, secondarySoftwareVersion=secondarySoftwareVersion, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, lbtDetectedTrap=lbtDetectedTrap, tFTPClient=tFTPClient, pubInstancedStatsTable=pubInstancedStatsTable, targetMACAddress=targetMACAddress, phyInstancedStatusTable=phyInstancedStatusTable, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, versions=versions, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseInstancedTable=licenseInstancedTable, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mainPSUPortQLTx=mainPSUPortQLTx, transmitDataRateLinked=transmitDataRateLinked, blacklistRMEnabled=blacklistRMEnabled, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, dfsTable=dfsTable, accessMethod=accessMethod, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, antennaSelection=antennaSelection, iPv4Address=iPv4Address, encryptionGroup=encryptionGroup, sFPPortAutoMdix=sFPPortAutoMdix, sNTPSyncTrap=sNTPSyncTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, userName=userName, sNTPServerStatus=sNTPServerStatus, extendedSpectrumScanning=extendedSpectrumScanning, licenseEncryption=licenseEncryption, hardwareVersion=hardwareVersion, softwareVersion=softwareVersion, sFPPortQLRx=sFPPortQLRx, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, syslogState=syslogState, antennaGain=antennaGain, receivePowerLinked=receivePowerLinked, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, cableDiagPair1Results=cableDiagPair1Results, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, searchState=searchState, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, rawReceivePowerLinked=rawReceivePowerLinked, remoteUnitName=remoteUnitName, telnetAccessEnabled=telnetAccessEnabled, dataBridgingStatusAlarm=dataBridgingStatusAlarm, syncESlavePort=syncESlavePort, portAllocationMismatch=portAllocationMismatch, configurationInstancedTableNumber=configurationInstancedTableNumber, mABTransmissionInterval=mABTransmissionInterval, unitIdentificationGroup=unitIdentificationGroup, ethernetInstancedTableNumber=ethernetInstancedTableNumber, remoteInternetAddress=remoteInternetAddress, smtp=smtp, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tDMEnabledChannels=tDMEnabledChannels, routerProtocols=routerProtocols, licenseSyncESupport=licenseSyncESupport, installationMode=installationMode, hTTPSPortNumber=hTTPSPortNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, transmitPower=transmitPower, cableDiagPair3Results=cableDiagPair3Results, userRole=userRole, dfsTableIndex=dfsTableIndex, hCMPLinkSymmetry=hCMPLinkSymmetry, iPDSCPPriorityTable=iPDSCPPriorityTable, dfs=dfs, sNMPTrapTableEntry=sNMPTrapTableEntry, tDMInterfaceControl=tDMInterfaceControl, wirelessOutAllOctets=wirelessOutAllOctets, license=license, ethernetPriorityTable=ethernetPriorityTable, receivePower=receivePower, capacityVariantMismatchTrap=capacityVariantMismatchTrap, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, tdmTable=tdmTable, signalStrengthRatioLinked=signalStrengthRatioLinked, qOSPriorityScheme=qOSPriorityScheme, dataPortPauseFrames=dataPortPauseFrames, installStatus=installStatus, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, syncETracking=syncETracking, lowestDataModulationMode=lowestDataModulationMode, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, blacklistRMMacAddress=blacklistRMMacAddress, apc=apc, dNSServerPortNumber=dNSServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, tDMChannelStatus=tDMChannelStatus, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, subnetMask=subnetMask, tFTPServerInternetAddressType=tFTPServerInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPVersion=iPVersion, longitude=longitude, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unitIdentification=unitIdentification, dNS=dNS, auxPortQLTx=auxPortQLTx, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, whitelistRMMacAddress=whitelistRMMacAddress, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, supplementary=supplementary, apcGroup=apcGroup, remoteMACAddressLinked=remoteMACAddressLinked, supplementaryGroup=supplementaryGroup, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, regulatoryBand=regulatoryBand, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNTPServerInternetAddress=sNTPServerInternetAddress, userTable=userTable, groupID=groupID, maximumNumberOfSlaves=maximumNumberOfSlaves, tDM=tDM, mgmtInstancedTableNumber=mgmtInstancedTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitFreqMHz=transmitFreqMHz, auxPortStatusTrap=auxPortStatusTrap, authorizationMethod=authorizationMethod, channelBandwidth=channelBandwidth, authorizationControlTableEntry=authorizationControlTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseUnitSerialNumber=licenseUnitSerialNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, wirelessOutOctets=wirelessOutOctets, syncEEquipmentClock=syncEEquipmentClock, mABProtocolVLANPriority=mABProtocolVLANPriority, cableDiagPair4Distance=cableDiagPair4Distance, mABNominalModulationMode=mABNominalModulationMode, lowestTDMModulationMode=lowestTDMModulationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitterChannels=transmitterChannels, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseSecurityLevel=licenseSecurityLevel, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTable=sNMPTrapTable, licenseTrialPeriod=licenseTrialPeriod, daylightSaving=daylightSaving, sNTPLastSync=sNTPLastSync, configurationInstancedTableIndex=configurationInstancedTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, mainPSUPortQLRx=mainPSUPortQLRx, oOBPriorityQueueMapping=oOBPriorityQueueMapping, transparentClockVID=transparentClockVID, erroredSeconds=erroredSeconds, licenseOOBManagementSupport=licenseOOBManagementSupport, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mPLSTCPriorityTable=mPLSTCPriorityTable, sFPPortDisabledWarning=sFPPortDisabledWarning, alarmInstancedTableEntry=alarmInstancedTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, alarms=alarms, hTTPPortNumber=hTTPPortNumber, transmitDataRate=transmitDataRate, vLANManagementPriority=vLANManagementPriority, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, mABHoldoffPeriod=mABHoldoffPeriod, userTableNumber=userTableNumber, authorizationControlTableIndex=authorizationControlTableIndex, productVariant=productVariant, licenseBandwidthCap=licenseBandwidthCap, mainPSUPortAllocation=mainPSUPortAllocation, byteErrorRatio=byteErrorRatio, mABMaintenanceLevel=mABMaintenanceLevel, nIDULanPortAutoMdix=nIDULanPortAutoMdix, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, installArmStateTrap=installArmStateTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerPortNumber=sNTPServerPortNumber, ethernetGroup=ethernetGroup, sNMPTrapVersion=sNMPTrapVersion, remoteUnitNameLinked=remoteUnitNameLinked, tDMChannelLoopback=tDMChannelLoopback, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, localPacketFiltering=localPacketFiltering, installStatusLinked=installStatusLinked, tDMGroup=tDMGroup, dfsTableNumber=dfsTableNumber, licenseIPv6Support=licenseIPv6Support, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, portAllocationMismatchTrap=portAllocationMismatchTrap, cableDiagPair2Distance=cableDiagPair2Distance, phyControlInstancedTableEntry=phyControlInstancedTableEntry, deviceMACAddress=deviceMACAddress, phyControlInstancedTableIndex=phyControlInstancedTableIndex, dNSPrimaryServer=dNSPrimaryServer, secureModeAlarmTrap=secureModeAlarmTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, ptpTraps=ptpTraps, configurationGroup=configurationGroup, secureModeAlarm=secureModeAlarm, linkSymmetry=linkSymmetry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementNetworkAccessEnabled=managementNetworkAccessEnabled, notificationsGroup=notificationsGroup, receiveChannel=receiveChannel, userEnabled=userEnabled, installArmState=installArmState, mABProtocolVID=mABProtocolVID)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ptmp=ptmp, snmpControlGroup=snmpControlGroup, routerProtocolsGroup=routerProtocolsGroup, licenseIEEE1588Support=licenseIEEE1588Support, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, range=range, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, cableDiagPair3Distance=cableDiagPair3Distance, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tFTPServerInternetAddress=tFTPServerInternetAddress, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, bootVersion=bootVersion, deviceESN=deviceESN, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, systemClock=systemClock, sFPPortSSMTx=sFPPortSSMTx, transmitModulationModeLinked=transmitModulationModeLinked, nIDULanPortStatus=nIDULanPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPAccessEnabled=hTTPAccessEnabled, resetGroup=resetGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogControl=syslogControl, dNSServerInternetAddress=dNSServerInternetAddress, dNSResolver=dNSResolver, versionsGroup=versionsGroup, auxPortSSMTx=auxPortSSMTx, PYSNMP_MODULE_ID=cambium, auxPortConfigurationMismatch=auxPortConfigurationMismatch, searchStateLinked=searchStateLinked, syslogLocalWrappedTrap=syslogLocalWrappedTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, ptpTrapPrefix=ptpTrapPrefix, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseInstancedTableNumber=licenseInstancedTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetStatisticsDataSource=ethernetStatisticsDataSource, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, timeZone=timeZone, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, l2CPPriorityTableEntry=l2CPPriorityTableEntry, authorizationControlGroup=authorizationControlGroup, sFPPortSyncERxStatus=sFPPortSyncERxStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, linkLoss=linkLoss, auxPortAllocation=auxPortAllocation, sNTPSync=sNTPSync, syslogClientTrap=syslogClientTrap, ethernetStatisticsTable=ethernetStatisticsTable, receiveDataRate=receiveDataRate, channelChangeTrap=channelChangeTrap)
