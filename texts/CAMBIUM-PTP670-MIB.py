...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, l2CPPriorityTableEntry=l2CPPriorityTableEntry, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, syncETracking=syncETracking, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, dNSServerInternetAddress=dNSServerInternetAddress, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, mgmtInstancedTableNumber=mgmtInstancedTableNumber, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, receiveDataRateLinked=receiveDataRateLinked, regulatoryBandTrap=regulatoryBandTrap, authorizationMethod=authorizationMethod, installStatusTrap=installStatusTrap, versionsGroup=versionsGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, phyStatus=phyStatus, accessMethod=accessMethod, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mABNominalTransmitCapacity=mABNominalTransmitCapacity, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transmitModulationModeLinked=transmitModulationModeLinked, searchState=searchState, dfsTable=dfsTable, phyControlInstancedTableIndex=phyControlInstancedTableIndex, dNSPrimaryServer=dNSPrimaryServer, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, syncETrackingState=syncETrackingState, secondarySoftwareVersion=secondarySoftwareVersion, severelyErroredSeconds=severelyErroredSeconds, receiveFreqMHz=receiveFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, capacityVariantMismatchLinked=capacityVariantMismatchLinked, auxPortStatusTrap=auxPortStatusTrap, resetGroup=resetGroup, tempPcb=tempPcb, remoteInternetAddress=remoteInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveModulationModeLinked=receiveModulationModeLinked, managementGroup=managementGroup, supplementaryGroup=supplementaryGroup, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, telnetAccessEnabled=telnetAccessEnabled, sFPPortAutoMdix=sFPPortAutoMdix, licenseTLSRekey=licenseTLSRekey, tDMChannelStatus=tDMChannelStatus, rawReceivePower=rawReceivePower, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mABHoldoffPeriod=mABHoldoffPeriod, authorizationControlTableIndex=authorizationControlTableIndex, mainPSUPortAllocation=mainPSUPortAllocation, byteErrorRatio=byteErrorRatio, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mainPSUPortStatusTrap=mainPSUPortStatusTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, apc=apc, regulatoryBand=regulatoryBand, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPSyncTrap=sNTPSyncTrap, dfsPeaks=dfsPeaks, erroredSeconds=erroredSeconds, licenseInstancedTableNumber=licenseInstancedTableNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sFPPortQLRx=sFPPortQLRx, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, wirelessOutEthernetOctets=wirelessOutEthernetOctets, telnetPortNumber=telnetPortNumber, userTableNumber=userTableNumber, bootVersion=bootVersion, pubStats=pubStats, syncESlavePort=syncESlavePort, txColorCode=txColorCode, sMTPServerPortNumber=sMTPServerPortNumber, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, syncEEquipmentClock=syncEEquipmentClock, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, txMABFrames=txMABFrames, signalStrengthRatio=signalStrengthRatio, configurationInstancedTableIndex=configurationInstancedTableIndex, nIDULanPortStatus=nIDULanPortStatus, aAAControlGroup=aAAControlGroup, portAllocationMismatch=portAllocationMismatch, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, dSCPManagementPriority=dSCPManagementPriority, mABState=mABState, installArmState=installArmState, unitIdentification=unitIdentification, dNSServerTable=dNSServerTable, sNMPv3Enable=sNMPv3Enable, transmitPowerLinked=transmitPowerLinked, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, whitelistRMEnabled=whitelistRMEnabled, dfsTableEntry=dfsTableEntry, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, packetsFromInternalStack=packetsFromInternalStack, lowestDataModulationMode=lowestDataModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPAccessEnabled=hTTPAccessEnabled, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mABTransmissionInterval=mABTransmissionInterval, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, management=management, licenseEncryption=licenseEncryption, tDM=tDM, receivePowerLinked=receivePowerLinked, userTableIndex=userTableIndex, dataPortPauseFrames=dataPortPauseFrames, sNMPTrapVersion=sNMPTrapVersion, bridge=bridge, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, cableDiagnosticsPorts=cableDiagnosticsPorts, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, masterSlaveMode=masterSlaveMode, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseSFPPortSupport=licenseSFPPortSupport, alarmInstancedTableIndex=alarmInstancedTableIndex, dNSServerInternetAddressType=dNSServerInternetAddressType, wirelessLinkStatusLinked=wirelessLinkStatusLinked, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, dataBridgingAvailability=dataBridgingAvailability, ethernetInstancedTableEntry=ethernetInstancedTableEntry, daylightSaving=daylightSaving, transmitFreqKHz=transmitFreqKHz, vLANManagementPriority=vLANManagementPriority, hTTPSAccessEnabled=hTTPSAccessEnabled, linkName=linkName, tFTPServerInternetAddressType=tFTPServerInternetAddressType, cableDiagPair4Results=cableDiagPair4Results, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteInternetAddressType=remoteInternetAddressType, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, encryptionAlgorithm=encryptionAlgorithm, altitude=altitude, deviceMACAddress=deviceMACAddress, productName=productName, mABProtocolVLANPriority=mABProtocolVLANPriority, sMTPEnabledMessages=sMTPEnabledMessages, smtpGroup=smtpGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, localPacketFiltering=localPacketFiltering, sFPPortAutoNegotiation=sFPPortAutoNegotiation, auxPortSyncERxStatus=auxPortSyncERxStatus, linkSymmetry=linkSymmetry, secureModeAlarm=secureModeAlarm, tDDSynchronizationStatus=tDDSynchronizationStatus, userName=userName, blacklistRMEnabled=blacklistRMEnabled, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, channelChangeTrap=channelChangeTrap, sNTPPollInterval=sNTPPollInterval, userRole=userRole, ethernetPriorityTableEntry=ethernetPriorityTableEntry, auxPortDisabledWarning=auxPortDisabledWarning, authorizationControl=authorizationControl, sNMPTrapTableIndex=sNMPTrapTableIndex, softwareVersion=softwareVersion, cableDiagnostics=cableDiagnostics, dfsMeans=dfsMeans, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, cableDiagPair2Results=cableDiagPair2Results, tFTPServerPortNumber=tFTPServerPortNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, sNTPServerRetries=sNTPServerRetries, licenseIssueNumber=licenseIssueNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, maximumTransmitPower=maximumTransmitPower, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sFPError=sFPError, cableLoss=cableLoss, whitelistRMMacAddress=whitelistRMMacAddress, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, auxPortSSMTx=auxPortSSMTx, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, sMTPServerInternetAddress=sMTPServerInternetAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installArmStateTrap=installArmStateTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, authorizationControlTableEntry=authorizationControlTableEntry, apcGroup=apcGroup, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, searchStateLinked=searchStateLinked, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, configurationGroup=configurationGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, dfs=dfs, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, cableDiagnosticsControl=cableDiagnosticsControl, mainPSUPortSSMTx=mainPSUPortSSMTx, cableDiagPair1Results=cableDiagPair1Results, encryptionGroup=encryptionGroup, ptpCompliance=ptpCompliance, tDMEnabledChannels=tDMEnabledChannels, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, reset=reset, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsGroup=dfsGroup, dNSServerTableNumber=dNSServerTableNumber, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, tDDControl=tDDControl, routerProtocolsGroup=routerProtocolsGroup, userTable=userTable, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, aggregateDataRateLinked=aggregateDataRateLinked, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sNTPServerTable=sNTPServerTable, sNMPTrapTable=sNMPTrapTable, packetsToInternalStack=packetsToInternalStack, configurationInstancedTable=configurationInstancedTable, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseGroup=licenseGroup, iPv4Address=iPv4Address, authorizationControlGroup=authorizationControlGroup, cableDiagPair4Distance=cableDiagPair4Distance, systemClock=systemClock, configurationInstancedTableEntry=configurationInstancedTableEntry, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, remoteMACAddressLinked=remoteMACAddressLinked, authorizationControlTable=authorizationControlTable, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, userEnabled=userEnabled, ethernetInstancedTable=ethernetInstancedTable, remoteUnitName=remoteUnitName, userPassword=userPassword, licenseInstancedTableIndex=licenseInstancedTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sFPPortStatusTrap=sFPPortStatusTrap, ethernetPriorityTable=ethernetPriorityTable)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDMChannelLineCode=tDMChannelLineCode, incompatibleRegulatoryBands=incompatibleRegulatoryBands, gatewayIPAddress=gatewayIPAddress, mainPSUPortQLRx=mainPSUPortQLRx, phyControlInstancedTableNumber=phyControlInstancedTableNumber, receiveFreqKHz=receiveFreqKHz, tdmTableIndex=tdmTableIndex, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, subbandHighestFrequency=subbandHighestFrequency, syslogClient=syslogClient, ethernet=ethernet, phyStatusGroup=phyStatusGroup, cableDiagPair3Results=cableDiagPair3Results, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, authorizationControlTableNumber=authorizationControlTableNumber, sNTPServerStatus=sNTPServerStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPv6Address=iPv6Address, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPClient=tFTPClient, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, aggregateDataRate=aggregateDataRate, wirelessLinkAvailability=wirelessLinkAvailability, enableTransmission=enableTransmission, licenseGroupAccess=licenseGroupAccess, linkModeOptimization=linkModeOptimization, licenseVersion=licenseVersion, vectorErrorLinked=vectorErrorLinked, mainPSUPortQLTx=mainPSUPortQLTx, configurationInstancedTableNumber=configurationInstancedTableNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, receiveModulationMode=receiveModulationMode, unavailableSeconds=unavailableSeconds, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cableDiagPair1Distance=cableDiagPair1Distance, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mPLSTCPriorityTable=mPLSTCPriorityTable, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, encryption=encryption, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, ptp670=ptp670, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, portAllocationMismatchLinked=portAllocationMismatchLinked, installationMode=installationMode, productVariant=productVariant, transmitterChannels=transmitterChannels, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ptpTrapPrefix=ptpTrapPrefix, supplementary=supplementary, sFPErrorTrap=sFPErrorTrap, licenseBandwidthCap=licenseBandwidthCap, byteErrorRatioLinked=byteErrorRatioLinked, tDMGroup=tDMGroup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sFPPortSSMTx=sFPPortSSMTx, receiveDataRate=receiveDataRate, capacityVariantMismatchTrap=capacityVariantMismatchTrap, licenseIEEE1588Support=licenseIEEE1588Support, phyInstancedStatusTable=phyInstancedStatusTable, sFPPortAllocation=sFPPortAllocation, mABNominalModulationMode=mABNominalModulationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitFreqMHz=transmitFreqMHz, tDMInterfaceControl=tDMInterfaceControl, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, auxPortAcceptedQLRx=auxPortAcceptedQLRx, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, transparentClockVID=transparentClockVID, deviceMSN=deviceMSN, dfsTableIndex=dfsTableIndex, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, unitIdentificationGroup=unitIdentificationGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, dNSServerTableIndex=dNSServerTableIndex, hTTPSPortNumber=hTTPSPortNumber, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, snmpControlGroup=snmpControlGroup, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dNS=dNS, subbandLowestFrequency=subbandLowestFrequency, sNTPServerTableEntry=sNTPServerTableEntry, capacityVariantMismatch=capacityVariantMismatch, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, wirelessTopology=wirelessTopology, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sMTPServerInternetAddressType=sMTPServerInternetAddressType, userTableEntry=userTableEntry, cambium=cambium, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNTPLastSync=sNTPLastSync, useVLANForMABProtocol=useVLANForMABProtocol, mgmtInstancedTableIndex=mgmtInstancedTableIndex, smtp=smtp, phyControlInstancedTableEntry=phyControlInstancedTableEntry, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, secureModeAlarmTrap=secureModeAlarmTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDMConfigurationMismatch=tDMConfigurationMismatch, sNTPPrimaryServer=sNTPPrimaryServer, licenseCapacity=licenseCapacity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, versions=versions, remoteUnitNameLinked=remoteUnitNameLinked, licenseSyncESupport=licenseSyncESupport, dNSServerTableEntry=dNSServerTableEntry, transparentClock=transparentClock, cableDiagnosticsWarning=cableDiagnosticsWarning, dNSResolver=dNSResolver, sNTPServerTimeout=sNTPServerTimeout, sFPPortQLTx=sFPPortQLTx, channelBandwidth=channelBandwidth, pubStatsGroup=pubStatsGroup, hCMPLinkSymmetry=hCMPLinkSymmetry, license=license, rawReceivePowerLinked=rawReceivePowerLinked, receivePower=receivePower, siteName=siteName, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, phyControlGroup=phyControlGroup, wirelessOutOctets=wirelessOutOctets, alarmInstancedTable=alarmInstancedTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, installStatus=installStatus, rxColorCode=rxColorCode, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, deviceESN=deviceESN, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, range=range, longitude=longitude, unitOutOfCalibration=unitOutOfCalibration, extendedSpectrumScanning=extendedSpectrumScanning, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, oOBPriorityQueueMapping=oOBPriorityQueueMapping, transparentClockPort=transparentClockPort, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, hCMPMaximumLinkRange=hCMPMaximumLinkRange, antennaSelection=antennaSelection, hardwareVersion=hardwareVersion, wirelessOutAllOctets=wirelessOutAllOctets, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseRARSupport=licenseRARSupport, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, systemReset=systemReset, rangingMode=rangingMode, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogClientTrap=syslogClientTrap, sMTPEmailAlert=sMTPEmailAlert, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, groupID=groupID, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, iPv6PrefixLength=iPv6PrefixLength, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sntp=sntp, auxPortAllocation=auxPortAllocation, antennaGain=antennaGain, qOSPriorityScheme=qOSPriorityScheme, tDMChannelCableLength=tDMChannelCableLength, vectorError=vectorError, licenseCountry=licenseCountry, transmitDataRateLinked=transmitDataRateLinked, mABMaintenanceLevel=mABMaintenanceLevel, dNSGroup=dNSGroup, blacklistRMMacAddress=blacklistRMMacAddress, dfsTableNumber=dfsTableNumber, pubInstancedStatsTable=pubInstancedStatsTable, targetMACAddress=targetMACAddress, eIRP=eIRP, auxPortQLTx=auxPortQLTx, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, licenseTDDSyncSupport=licenseTDDSyncSupport, configuration=configuration, remoteInternetAddressLinked=remoteInternetAddressLinked, signalStrengthRatioLinked=signalStrengthRatioLinked, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, notificationsGroup=notificationsGroup, auxPortStatus=auxPortStatus, licenseSecurityLevel=licenseSecurityLevel, l2CPPriorityTable=l2CPPriorityTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installStatusLinked=installStatusLinked, transmitChannel=transmitChannel, timeZone=timeZone, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, routerProtocols=routerProtocols, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, alarmInstancedTableNumber=alarmInstancedTableNumber, mgmtInstancedTable=mgmtInstancedTable, sNTPServerTableNumber=sNTPServerTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, tdmTableEntry=tdmTableEntry, cableDiagnosticsGroup=cableDiagnosticsGroup, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, syslogControl=syslogControl, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, wirelessLinkStatus=wirelessLinkStatus, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, subnetMask=subnetMask, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tDMChannelLoopback=tDMChannelLoopback, sNTPServerInternetAddress=sNTPServerInternetAddress, iPVersion=iPVersion, lowestTDMModulationMode=lowestTDMModulationMode, phyControl=phyControl, sNTPSync=sNTPSync, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, cableDiagPair2Distance=cableDiagPair2Distance, portAllocationMismatchTrap=portAllocationMismatchTrap, unitName=unitName, licenseInstancedTable=licenseInstancedTable, nIDULanPortStatusTrap=nIDULanPortStatusTrap, auxPortQLRx=auxPortQLRx, frequencyVariant=frequencyVariant, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, phyControlInstancedTable=phyControlInstancedTable, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, linkLossLinked=linkLossLinked, mainPSUPortStatus=mainPSUPortStatus, transmitModulationMode=transmitModulationMode, ptp=ptp, syslogStateTrap=syslogStateTrap, alarmsGroup=alarmsGroup, ethernetGroup=ethernetGroup, receiveChannel=receiveChannel, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenseTrialPeriod=licenseTrialPeriod, mgmtInstancedTableEntry=mgmtInstancedTableEntry, tdmTable=tdmTable, dataBridgingStatusLinked=dataBridgingStatusLinked, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tDDControlGroup=tDDControlGroup, sFPPortStatus=sFPPortStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPPortNumber=hTTPPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetStatisticsDataSource=ethernetStatisticsDataSource, remoteMACAddress=remoteMACAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptpTraps=ptpTraps, licenseIPv6Support=licenseIPv6Support, ptmp=ptmp, syslogControlGroup=syslogControlGroup, mABProtocolVID=mABProtocolVID, tdmTableNumber=tdmTableNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, alarms=alarms, bridgeGroup=bridgeGroup, sNTPState=sNTPState, sntpGroup=sntpGroup, targetRange=targetRange, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseMaxLinkRange=licenseMaxLinkRange, dNSServerPortNumber=dNSServerPortNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, snmpControl=snmpControl, syslogState=syslogState, dataBridgingStatus=dataBridgingStatus, licenseGasGroup=licenseGasGroup, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tDMInterfaceStatus=tDMInterfaceStatus, cableDiagPair3Distance=cableDiagPair3Distance, latitude=latitude, transmitDataRate=transmitDataRate, ptpGroups=ptpGroups, transparentClockVLAN=transparentClockVLAN, receiveModulationModeDetail=receiveModulationModeDetail, lbtDetectedTrap=lbtDetectedTrap, vLANManagementVID=vLANManagementVID, sNTPServerInternetAddressType=sNTPServerInternetAddressType, maximumNumberOfSlaves=maximumNumberOfSlaves, sNMPCommunityString=sNMPCommunityString, iPv6GatewayAddress=iPv6GatewayAddress, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, PYSNMP_MODULE_ID=cambium, sNMPPortNumber=sNMPPortNumber, linkLoss=linkLoss, rangeLinked=rangeLinked, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseInstancedTableEntry=licenseInstancedTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitPower=transmitPower, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ethernetStatisticsTable=ethernetStatisticsTable, aAAControl=aAAControl, licenseHCMPSupport=licenseHCMPSupport, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, ethernetInstancedTableIndex=ethernetInstancedTableIndex)
