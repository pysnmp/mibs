...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", erroredSeconds=erroredSeconds, cambium=cambium, tdmTableNumber=tdmTableNumber, licenseTrialPeriod=licenseTrialPeriod, channelBandwidth=channelBandwidth, sNTPServerTableNumber=sNTPServerTableNumber, dataBridgingAvailability=dataBridgingAvailability, licenseSFPPortSupport=licenseSFPPortSupport, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, dfsTableEntry=dfsTableEntry, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, sNMPPortNumber=sNMPPortNumber, license=license, supplementaryGroup=supplementaryGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementary=supplementary, apcGroup=apcGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptp=ptp, mainPSUPortQLTx=mainPSUPortQLTx, tDMInterfaceControl=tDMInterfaceControl, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, managementNetworkAccessEnabled=managementNetworkAccessEnabled, transparentClockVID=transparentClockVID, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, versionsGroup=versionsGroup, sNTPServerTable=sNTPServerTable, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mainPSUPortAllocation=mainPSUPortAllocation, hTTPAccessEnabled=hTTPAccessEnabled, installArmStateTrap=installArmStateTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessOutOctets=wirelessOutOctets, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, licenseTDDSyncSupport=licenseTDDSyncSupport, linkModeOptimization=linkModeOptimization, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, receiveModulationMode=receiveModulationMode, whitelistRMMacAddress=whitelistRMMacAddress, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, deviceMSN=deviceMSN, ptmp=ptmp, deviceESN=deviceESN, ethernetPriorityTable=ethernetPriorityTable, cableDiagPair2Distance=cableDiagPair2Distance, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseInstancedTableEntry=licenseInstancedTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, sNTPSyncTrap=sNTPSyncTrap, versions=versions, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, alarms=alarms, resetGroup=resetGroup, userTableNumber=userTableNumber, dfs=dfs, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseVersion=licenseVersion, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, mABState=mABState, PYSNMP_MODULE_ID=cambium, dNSResolver=dNSResolver, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sNTPServerTimeout=sNTPServerTimeout, auxPortConfigurationMismatch=auxPortConfigurationMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDControlGroup=tDDControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteUnitName=remoteUnitName, tDMChannelLineCode=tDMChannelLineCode, ethernetStatisticsTable=ethernetStatisticsTable, portAllocationMismatchLinked=portAllocationMismatchLinked, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, receiveFreqKHz=receiveFreqKHz, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, encryptionAlgorithm=encryptionAlgorithm, mgmtInstancedTableIndex=mgmtInstancedTableIndex, licenseSyncESupport=licenseSyncESupport, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, packetsFromInternalStack=packetsFromInternalStack, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, phyControlInstancedTableEntry=phyControlInstancedTableEntry, maximumNumberOfSlaves=maximumNumberOfSlaves, dNSServerTableEntry=dNSServerTableEntry, byteErrorRatio=byteErrorRatio, alarmInstancedTableNumber=alarmInstancedTableNumber, transparentClockVLAN=transparentClockVLAN, smtp=smtp, sntp=sntp, sNMPEnabledTraps=sNMPEnabledTraps, transmitDataRate=transmitDataRate, telnetAccessEnabled=telnetAccessEnabled, phyControlInstancedTableNumber=phyControlInstancedTableNumber, pubStatsGroup=pubStatsGroup, transmitModulationMode=transmitModulationMode, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, cableDiagnosticsGroup=cableDiagnosticsGroup, dataBridgingStatusAlarm=dataBridgingStatusAlarm, hCMPMaximumLinkRange=hCMPMaximumLinkRange, reset=reset, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, phyControlInstancedTable=phyControlInstancedTable, vLANManagementVID=vLANManagementVID, authorizationControlTableIndex=authorizationControlTableIndex, subbandLowestFrequency=subbandLowestFrequency, sNMPTrapTable=sNMPTrapTable, installStatus=installStatus, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, ptpTraps=ptpTraps, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, licenseHCMPSupport=licenseHCMPSupport, encryption=encryption, linkLossLinked=linkLossLinked, receivePower=receivePower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerRetries=sNTPServerRetries, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, signalStrengthRatio=signalStrengthRatio, tdmTable=tdmTable, wirelessOutAllOctets=wirelessOutAllOctets, cableDiagPair4Distance=cableDiagPair4Distance, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sFPErrorTrap=sFPErrorTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogControl=syslogControl, pubStats=pubStats, sNTPServerTableEntry=sNTPServerTableEntry, tFTPClient=tFTPClient, sFPPortStatus=sFPPortStatus, configurationInstancedTableIndex=configurationInstancedTableIndex, sNTPLastSync=sNTPLastSync, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, bridgeGroup=bridgeGroup, sFPPortAllocation=sFPPortAllocation, mgmtInstancedTable=mgmtInstancedTable, tDMConfigurationMismatch=tDMConfigurationMismatch, installStatusLinked=installStatusLinked, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mgmtInstancedTableNumber=mgmtInstancedTableNumber, phyControl=phyControl, cableDiagnostics=cableDiagnostics, receiveModulationModeDetail=receiveModulationModeDetail, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseCountry=licenseCountry, syncETracking=syncETracking, severelyErroredSeconds=severelyErroredSeconds, cableDiagnosticsPorts=cableDiagnosticsPorts, remoteUnitNameLinked=remoteUnitNameLinked, ethernetPriorityTableNumber=ethernetPriorityTableNumber, regulatoryBand=regulatoryBand, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseInstancedTable=licenseInstancedTable, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tDMChannelStatusTrap=tDMChannelStatusTrap, iPVersion=iPVersion, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, remoteInternetAddress=remoteInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPv6Address=iPv6Address, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, unitIdentification=unitIdentification, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseIssueNumber=licenseIssueNumber, ethernetInstancedTable=ethernetInstancedTable, sNTPServerInternetAddress=sNTPServerInternetAddress, routerProtocolsGroup=routerProtocolsGroup, eIRP=eIRP, sFPPortStatusTrap=sFPPortStatusTrap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, lowestTDMModulationMode=lowestTDMModulationMode, rangingMode=rangingMode, phyStatusGroup=phyStatusGroup, licenseCapacity=licenseCapacity, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, maximumTransmitPower=maximumTransmitPower, transmitPowerLinked=transmitPowerLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sntpGroup=sntpGroup, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tDMGroup=tDMGroup, vectorError=vectorError, unitIdentificationGroup=unitIdentificationGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, bridge=bridge, mPLSTCPriorityTable=mPLSTCPriorityTable, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, bootVersion=bootVersion, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetGroup=ethernetGroup, groupID=groupID, licenseGasGroup=licenseGasGroup, localPacketFiltering=localPacketFiltering, searchState=searchState, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, snmpControlGroup=snmpControlGroup, targetMACAddress=targetMACAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPv3Enable=sNMPv3Enable, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, blacklistRMEnabled=blacklistRMEnabled, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, subnetMask=subnetMask, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, routerProtocols=routerProtocols, cableDiagnosticsControl=cableDiagnosticsControl, licenseGroupAccess=licenseGroupAccess, userTableIndex=userTableIndex, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, transmitChannel=transmitChannel, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, tDDSynchronizationStatus=tDDSynchronizationStatus, txMABFrames=txMABFrames, licenseTLSRekey=licenseTLSRekey, authorizationControl=authorizationControl, cableDiagPair1Distance=cableDiagPair1Distance, auxPortStatus=auxPortStatus, phyControlInstancedTableIndex=phyControlInstancedTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, lbtDetectedTrap=lbtDetectedTrap, auxPortSSMTx=auxPortSSMTx, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseRARSupport=licenseRARSupport, auxPortQLTx=auxPortQLTx, linkModeOptimizationMismatch=linkModeOptimizationMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseMaxLinkRange=licenseMaxLinkRange, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, blacklistRMMacAddress=blacklistRMMacAddress, licenseInstancedTableNumber=licenseInstancedTableNumber, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, rawReceivePowerLinked=rawReceivePowerLinked, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, receiveFreqMHz=receiveFreqMHz, receivePowerLinked=receivePowerLinked, transmitModulationModeLinked=transmitModulationModeLinked, vLANManagementPriority=vLANManagementPriority, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, apc=apc, authorizationControlGroup=authorizationControlGroup, alarmInstancedTable=alarmInstancedTable, unitName=unitName, enableTransmission=enableTransmission, sMTPEnabledMessages=sMTPEnabledMessages, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, iPv6GatewayAddress=iPv6GatewayAddress, remoteMACAddress=remoteMACAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveDataRate=receiveDataRate, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseBandwidthCap=licenseBandwidthCap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, syslogControlGroup=syslogControlGroup, antennaGain=antennaGain, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, hCMPLinkSymmetry=hCMPLinkSymmetry, tDMChannelCableLength=tDMChannelCableLength, hTTPPortNumber=hTTPPortNumber, altitude=altitude, licenseGroup=licenseGroup, lowestDataModulationMode=lowestDataModulationMode, syslogClient=syslogClient, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, remoteMACAddressLinked=remoteMACAddressLinked, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, linkLoss=linkLoss, secureModeAlarmTrap=secureModeAlarmTrap, transparentClock=transparentClock, portAllocationMismatchTrap=portAllocationMismatchTrap, snmpControl=snmpControl, ethernet=ethernet, packetsToInternalStack=packetsToInternalStack, tFTPServerInternetAddress=tFTPServerInternetAddress, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, configurationGroup=configurationGroup, sFPPortQLTx=sFPPortQLTx, smtpGroup=smtpGroup, remoteInternetAddressType=remoteInternetAddressType, licenseUnitSerialNumber=licenseUnitSerialNumber, ptpGroups=ptpGroups, tFTPServerPortNumber=tFTPServerPortNumber, userName=userName, maxLinkRangeExceeded=maxLinkRangeExceeded, alarmInstancedTableIndex=alarmInstancedTableIndex, oOBPriorityQueueMapping=oOBPriorityQueueMapping, systemReset=systemReset, tDDSynchronizationMode=tDDSynchronizationMode, phyInstancedStatusTable=phyInstancedStatusTable, softwareVersion=softwareVersion, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sFPError=sFPError, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dNSServerInternetAddressType=dNSServerInternetAddressType, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNMPTrapVersion=sNMPTrapVersion, mABMaintenanceLevel=mABMaintenanceLevel, sNMPTrapInternetAddress=sNMPTrapInternetAddress, regulatoryBandTrap=regulatoryBandTrap, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tDDControl=tDDControl, tempPcb=tempPcb, dfsMeans=dfsMeans, subbandHighestFrequency=subbandHighestFrequency, aggregateDataRateLinked=aggregateDataRateLinked, tDMInterfaceStatus=tDMInterfaceStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDMChannelLoopback=tDMChannelLoopback, mABHoldoffPeriod=mABHoldoffPeriod, syslogStateTrap=syslogStateTrap, siteName=siteName, hardwareVersion=hardwareVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mainPSUPortQLRx=mainPSUPortQLRx, licenseInstancedTableIndex=licenseInstancedTableIndex, productVariant=productVariant, dNSPrimaryServer=dNSPrimaryServer, licenseOOBManagementSupport=licenseOOBManagementSupport, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sMTPEmailAlert=sMTPEmailAlert, receiveModulationModeLinked=receiveModulationModeLinked, notificationsGroup=notificationsGroup, configurationInstancedTable=configurationInstancedTable, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, pubInstancedStatsTable=pubInstancedStatsTable, frequencyVariant=frequencyVariant, sFPPortAutoNegotiation=sFPPortAutoNegotiation, dataBridgingStatus=dataBridgingStatus, searchStateLinked=searchStateLinked, transmitPower=transmitPower, secureModeAlarm=secureModeAlarm, dfsPeaks=dfsPeaks, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, capacityVariantMismatch=capacityVariantMismatch, userRole=userRole, encryptionGroup=encryptionGroup, range=range, rangeLinked=rangeLinked, syncEEquipmentClock=syncEEquipmentClock, userTable=userTable, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, aAAControl=aAAControl, alarmsGroup=alarmsGroup, mABProtocolVLANPriority=mABProtocolVLANPriority, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, txColorCode=txColorCode, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortStatusTrap=auxPortStatusTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, rxColorCode=rxColorCode, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPv6PrefixLength=iPv6PrefixLength, installArmState=installArmState, nIDULanPortStatus=nIDULanPortStatus, cableDiagPair2Results=cableDiagPair2Results, managementGroup=managementGroup, wirelessLinkStatus=wirelessLinkStatus, deviceMACAddress=deviceMACAddress, management=management, tdmTableEntry=tdmTableEntry, portAllocationMismatch=portAllocationMismatch, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, iPv4Address=iPv4Address, byteErrorRatioLinked=byteErrorRatioLinked, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ptp670=ptp670, sNMPTrapTableNumber=sNMPTrapTableNumber, installStatusTrap=installStatusTrap, transmitFreqKHz=transmitFreqKHz, l2CPPriorityTable=l2CPPriorityTable, sNMPCommunityString=sNMPCommunityString, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, signalStrengthRatioLinked=signalStrengthRatioLinked, receiveChannel=receiveChannel, tDMChannelStatus=tDMChannelStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unitOutOfCalibration=unitOutOfCalibration, mainPSUPortSSMTx=mainPSUPortSSMTx, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemClock=systemClock, sFPPortAutoMdix=sFPPortAutoMdix, licenseEncryption=licenseEncryption, mgmtInstancedTableEntry=mgmtInstancedTableEntry, dfsGroup=dfsGroup, userEnabled=userEnabled, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sNTPServerStatus=sNTPServerStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDM=tDM, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogState=syslogState, mainPSUPortStatusTrap=mainPSUPortStatusTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, vectorErrorLinked=vectorErrorLinked, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licenseIEEE1588Support=licenseIEEE1588Support, wirelessLinkStatusLinked=wirelessLinkStatusLinked, licenseSecurityLevel=licenseSecurityLevel, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, authorizationControlTableNumber=authorizationControlTableNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, syslogClientTrap=syslogClientTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, dNSServerTableIndex=dNSServerTableIndex, productName=productName, sMTPServerInternetAddressType=sMTPServerInternetAddressType, configurationInstancedTableNumber=configurationInstancedTableNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dNSServerTableNumber=dNSServerTableNumber, tdmTableIndex=tdmTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, whitelistRMEnabled=whitelistRMEnabled, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, authorizationMethod=authorizationMethod, sNTPPollInterval=sNTPPollInterval, mABNominalModulationMode=mABNominalModulationMode, mABProtocolVID=mABProtocolVID, dNSServerTable=dNSServerTable, auxPortAcceptedQLRx=auxPortAcceptedQLRx, dfsTableIndex=dfsTableIndex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sFPPortSSMTx=sFPPortSSMTx, sFPPortQLRx=sFPPortQLRx, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, transmitFreqMHz=transmitFreqMHz, alarmInstancedTableEntry=alarmInstancedTableEntry, antennaSelection=antennaSelection, qOSPriorityScheme=qOSPriorityScheme, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ptpCompliance=ptpCompliance, userPassword=userPassword, transmitDataRateLinked=transmitDataRateLinked, cableDiagPair4Results=cableDiagPair4Results, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, longitude=longitude, userTableEntry=userTableEntry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, syncETrackingState=syncETrackingState, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetInstancedTableNumber=ethernetInstancedTableNumber, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mainPSUPortStatus=mainPSUPortStatus, authorizationControlTable=authorizationControlTable, dfsTable=dfsTable, incompatibleRegulatoryBands=incompatibleRegulatoryBands, dNS=dNS, masterSlaveMode=masterSlaveMode, aggregateDataRate=aggregateDataRate, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, timeZone=timeZone, aAAControlGroup=aAAControlGroup, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, licenseIPv6Support=licenseIPv6Support, installationMode=installationMode, ptpTrapPrefix=ptpTrapPrefix, gatewayIPAddress=gatewayIPAddress, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, rawReceivePower=rawReceivePower, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, linkSymmetry=linkSymmetry, dSCPManagementPriority=dSCPManagementPriority)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", remoteInternetAddressLinked=remoteInternetAddressLinked, auxPortQLRx=auxPortQLRx, receiveDataRateLinked=receiveDataRateLinked, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, configuration=configuration, useVLANForMABProtocol=useVLANForMABProtocol, cableDiagPair3Distance=cableDiagPair3Distance, phyControlGroup=phyControlGroup, targetRange=targetRange, sNTPSync=sNTPSync, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetPriorityTableEntry=ethernetPriorityTableEntry, daylightSaving=daylightSaving, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sFPPortDisabledWarning=sFPPortDisabledWarning, dataPortPauseFrames=dataPortPauseFrames, telnetPortNumber=telnetPortNumber, mABTransmissionInterval=mABTransmissionInterval, dfsTableNumber=dfsTableNumber, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagPair3Results=cableDiagPair3Results, dNSGroup=dNSGroup, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelChangeTrap=channelChangeTrap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, l2CPPriorityTableIndex=l2CPPriorityTableIndex, cableLoss=cableLoss, latitude=latitude, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, dNSServerInternetAddress=dNSServerInternetAddress, dNSServerPortNumber=dNSServerPortNumber, syncESlavePort=syncESlavePort, ethernetInstancedTableIndex=ethernetInstancedTableIndex, auxPortAllocation=auxPortAllocation, sNTPServerPortNumber=sNTPServerPortNumber, wirelessTopology=wirelessTopology, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, phyStatus=phyStatus, transmitterChannels=transmitterChannels, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, wirelessLinkAvailability=wirelessLinkAvailability, accessMethod=accessMethod, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, noWirelessChannelAvailable=noWirelessChannelAvailable, authorizationControlTableEntry=authorizationControlTableEntry, unavailableSeconds=unavailableSeconds, tDMEnabledChannels=tDMEnabledChannels, linkName=linkName, sNTPState=sNTPState, cableDiagPair1Results=cableDiagPair1Results, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, transparentClockPort=transparentClockPort, managementPortWirelessDownAlert=managementPortWirelessDownAlert)
