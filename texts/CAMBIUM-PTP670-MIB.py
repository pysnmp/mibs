...
# Produced by pysmi-1.1.12 at Wed Jul  3 13:26:53 2024
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dfsTableEntry=dfsTableEntry, authorizationControlTable=authorizationControlTable, dNSServerTable=dNSServerTable, sNTPPrimaryServer=sNTPPrimaryServer, auxPortQLRx=auxPortQLRx, receiveModulationMode=receiveModulationMode, portAllocationMismatchLinked=portAllocationMismatchLinked, tempPcb=tempPcb, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, remoteUnitNameLinked=remoteUnitNameLinked, installStatusTrap=installStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, enableTransmission=enableTransmission, cableLoss=cableLoss, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, frequencyVariant=frequencyVariant, installArmStateTrap=installArmStateTrap, cableDiagPair1Results=cableDiagPair1Results, receiveModulationModeLinked=receiveModulationModeLinked, auxPortStatus=auxPortStatus, sNMPv3Enable=sNMPv3Enable, mgmtInstancedTableIndex=mgmtInstancedTableIndex, rawReceivePower=rawReceivePower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, linkLoss=linkLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPSyncTrap=sNTPSyncTrap, txColorCode=txColorCode, licenseInstancedTableEntry=licenseInstancedTableEntry, wirelessOutAllOctets=wirelessOutAllOctets, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mABTransmissionInterval=mABTransmissionInterval, ethernetStatisticsTable=ethernetStatisticsTable, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, apcGroup=apcGroup, hCMPLinkSymmetry=hCMPLinkSymmetry, iPv6Address=iPv6Address, receiveFreqKHz=receiveFreqKHz, sNTPState=sNTPState, sNTPServerRetries=sNTPServerRetries, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, masterSlaveMode=masterSlaveMode, mABNominalModulationMode=mABNominalModulationMode, snmpControlGroup=snmpControlGroup, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tDMChannelStatus=tDMChannelStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, subnetMask=subnetMask, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sNTPServerTimeout=sNTPServerTimeout, transmitPowerLinked=transmitPowerLinked, hTTPAccessEnabled=hTTPAccessEnabled, auxPortSSMTx=auxPortSSMTx, licenseGroupAccess=licenseGroupAccess, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, wirelessLinkStatusLinked=wirelessLinkStatusLinked, dataBridgingAvailability=dataBridgingAvailability, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, alarmsGroup=alarmsGroup, configurationGroup=configurationGroup, phyStatus=phyStatus, rxColorCode=rxColorCode, aggregateDataRateLinked=aggregateDataRateLinked, phyInstancedStatusTable=phyInstancedStatusTable, sMTPEnabledMessages=sMTPEnabledMessages, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, alarmInstancedTableIndex=alarmInstancedTableIndex, syslogClient=syslogClient, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, hardwareVersion=hardwareVersion, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, authorizationControl=authorizationControl, licenseInstancedTable=licenseInstancedTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, authorizationControlGroup=authorizationControlGroup, hTTPSPortNumber=hTTPSPortNumber, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, dSCPManagementPriority=dSCPManagementPriority, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tFTPClient=tFTPClient, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, systemClock=systemClock, tDMChannelLoopback=tDMChannelLoopback, dNSServerTableNumber=dNSServerTableNumber, siteName=siteName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseCapacity=licenseCapacity, sntp=sntp, cableDiagnostics=cableDiagnostics, transmitDataRate=transmitDataRate, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, l2CPPriorityTableNumber=l2CPPriorityTableNumber, pubStats=pubStats, linkName=linkName, syslogControl=syslogControl, cableDiagnosticsGroup=cableDiagnosticsGroup, remoteMACAddressLinked=remoteMACAddressLinked, alarmInstancedTable=alarmInstancedTable, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, receiveModulationModeDetail=receiveModulationModeDetail, transmitFreqKHz=transmitFreqKHz, portAllocationMismatch=portAllocationMismatch, sFPPortSyncERxStatus=sFPPortSyncERxStatus, receivePower=receivePower, auxPortAcceptedQLRx=auxPortAcceptedQLRx, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDMGroup=tDMGroup, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, eIRP=eIRP, maximumTransmitPower=maximumTransmitPower, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mABProtocolVID=mABProtocolVID, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mainPSUPortAutoMdix=mainPSUPortAutoMdix, maxLinkRangeExceeded=maxLinkRangeExceeded, targetRange=targetRange, tdmTableIndex=tdmTableIndex, managementNetworkAccessEnabled=managementNetworkAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, regulatoryBandTrap=regulatoryBandTrap, erroredSeconds=erroredSeconds, severelyErroredSeconds=severelyErroredSeconds, mABState=mABState, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, phyControlInstancedTableNumber=phyControlInstancedTableNumber, userTableIndex=userTableIndex, transparentClockPort=transparentClockPort, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sNMPTrapTable=sNMPTrapTable, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, packetsToInternalStack=packetsToInternalStack, authorizationMethod=authorizationMethod, management=management, transparentClockVID=transparentClockVID, licenseInstancedTableNumber=licenseInstancedTableNumber, linkLossLinked=linkLossLinked, cableDiagPair2Results=cableDiagPair2Results, sNTPServerTableNumber=sNTPServerTableNumber, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv6PrefixLength=iPv6PrefixLength, aAAControlGroup=aAAControlGroup, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tDMChannelLineCode=tDMChannelLineCode, configurationInstancedTableIndex=configurationInstancedTableIndex, dNSServerInternetAddress=dNSServerInternetAddress, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, configuration=configuration, sNTPServerTableEntry=sNTPServerTableEntry, ptp=ptp, remoteUnitName=remoteUnitName, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, license=license, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, packetsFromInternalStack=packetsFromInternalStack, syslogControlGroup=syslogControlGroup, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, wirelessTopology=wirelessTopology, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimization=linkModeOptimization, encryptionGroup=encryptionGroup, transmitFreqMHz=transmitFreqMHz, userTable=userTable, linkSymmetry=linkSymmetry, useVLANForMABProtocol=useVLANForMABProtocol, authorizationControlTableEntry=authorizationControlTableEntry, sFPPortAllocation=sFPPortAllocation, licenseTrialPeriod=licenseTrialPeriod, ptp670=ptp670, dfs=dfs, licenseRARSupport=licenseRARSupport, tFTPServerInternetAddressType=tFTPServerInternetAddressType, noWirelessChannelAvailable=noWirelessChannelAvailable, vectorErrorLinked=vectorErrorLinked, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, capacityVariantMismatchLinked=capacityVariantMismatchLinked, tdmTableEntry=tdmTableEntry, searchStateLinked=searchStateLinked, installStatusLinked=installStatusLinked, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, mainPSUPortQLTx=mainPSUPortQLTx, licenseSyncESupport=licenseSyncESupport, licenseSFPPortSupport=licenseSFPPortSupport, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mainPSUPortStatus=mainPSUPortStatus, supplementary=supplementary, sFPPortStatus=sFPPortStatus, hTTPPortNumber=hTTPPortNumber, supplementaryGroup=supplementaryGroup, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseInstancedTableIndex=licenseInstancedTableIndex, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, userPassword=userPassword, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNTPServerPortNumber=sNTPServerPortNumber, dfsTableIndex=dfsTableIndex, remoteInternetAddress=remoteInternetAddress, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, routerProtocols=routerProtocols, sMTPEmailAlert=sMTPEmailAlert, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, cableDiagnosticsPorts=cableDiagnosticsPorts, installArmState=installArmState, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, localPacketFiltering=localPacketFiltering, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDControlGroup=tDDControlGroup, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ethernetInstancedTableEntry=ethernetInstancedTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, antennaGain=antennaGain, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, phyControlInstancedTable=phyControlInstancedTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerTableIndex=sNTPServerTableIndex, transparentClockVLAN=transparentClockVLAN, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, cableDiagnosticsControl=cableDiagnosticsControl, dNSGroup=dNSGroup, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, resetGroup=resetGroup, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, range=range, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, versions=versions, licenseEncryption=licenseEncryption, cableDiagPair1Distance=cableDiagPair1Distance, targetMACAddress=targetMACAddress, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseIPv6Support=licenseIPv6Support, routerProtocolsGroup=routerProtocolsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, systemReset=systemReset, syncETracking=syncETracking, cableDiagPair4Distance=cableDiagPair4Distance, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, installStatus=installStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, userTableEntry=userTableEntry, timeZone=timeZone, authorizationControlTableIndex=authorizationControlTableIndex, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, pubInstancedStatsTable=pubInstancedStatsTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarmInstancedTableEntry=alarmInstancedTableEntry, auxPortAllocation=auxPortAllocation, secureModeAlarm=secureModeAlarm, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dNSServerPortNumber=dNSServerPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPSync=sNTPSync, sFPPortDisabledWarning=sFPPortDisabledWarning, smtp=smtp, subbandHighestFrequency=subbandHighestFrequency, dNS=dNS, blacklistRMEnabled=blacklistRMEnabled, dNSPrimaryServer=dNSPrimaryServer, licenseCountry=licenseCountry, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, mgmtInstancedTable=mgmtInstancedTable, wirelessOutOctets=wirelessOutOctets, unitIdentification=unitIdentification, licenseIssueNumber=licenseIssueNumber, incompatibleRegulatoryBands=incompatibleRegulatoryBands, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDMInterfaceControl=tDMInterfaceControl, licenseVersion=licenseVersion, receiveFreqMHz=receiveFreqMHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, syslogStateTrap=syslogStateTrap, transmitChannel=transmitChannel, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, secureModeAlarmTrap=secureModeAlarmTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, apc=apc, ethernetGroup=ethernetGroup, telnetPortNumber=telnetPortNumber, tdmTableNumber=tdmTableNumber, mainPSUPortQLRx=mainPSUPortQLRx, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortPauseFrames=dataPortPauseFrames, phyControlInstancedTableIndex=phyControlInstancedTableIndex, tDDControl=tDDControl, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTable=l2CPPriorityTable, licenseTDDSyncSupport=licenseTDDSyncSupport, syslogClientTrap=syslogClientTrap, mainPSUPortAllocation=mainPSUPortAllocation, lowestDataModulationMode=lowestDataModulationMode, bridge=bridge, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ptpTraps=ptpTraps, maximumNumberOfSlaves=maximumNumberOfSlaves, installationMode=installationMode, cambium=cambium, unitOutOfCalibration=unitOutOfCalibration, notificationsGroup=notificationsGroup, cableDiagPair3Distance=cableDiagPair3Distance, dNSServerTableIndex=dNSServerTableIndex, productVariant=productVariant, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, ethernetInstancedTableIndex=ethernetInstancedTableIndex, pubStatsGroup=pubStatsGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mgmtInstancedTableNumber=mgmtInstancedTableNumber, licenseTLSRekey=licenseTLSRekey, remoteInternetAddressType=remoteInternetAddressType, licenseHCMPSupport=licenseHCMPSupport, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, qOSPriorityScheme=qOSPriorityScheme, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, ethernetPriorityTable=ethernetPriorityTable, ptpCompliance=ptpCompliance, channelBandwidth=channelBandwidth, auxPortQLTx=auxPortQLTx, receiveChannel=receiveChannel, antennaSelection=antennaSelection, dfsTable=dfsTable, altitude=altitude, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userRole=userRole, licenseGasGroup=licenseGasGroup, bootVersion=bootVersion, alarms=alarms, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, bridgeGroup=bridgeGroup, transmitterChannels=transmitterChannels, receiveDataRate=receiveDataRate, phyControl=phyControl, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, groupID=groupID, wirelessLinkStatus=wirelessLinkStatus, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, capacityVariantMismatch=capacityVariantMismatch, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveDataRateLinked=receiveDataRateLinked, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rangingMode=rangingMode, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, auxPortConfigurationMismatch=auxPortConfigurationMismatch, ptmp=ptmp, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, mABHoldoffPeriod=mABHoldoffPeriod, phyStatusGroup=phyStatusGroup, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseRegulatoryBandsList=licenseRegulatoryBandsList, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, reset=reset, accessMethod=accessMethod, vectorError=vectorError, alarmInstancedTableNumber=alarmInstancedTableNumber, signalStrengthRatioLinked=signalStrengthRatioLinked, dfsMeans=dfsMeans, licenseBandwidthCap=licenseBandwidthCap, sNMPPortNumber=sNMPPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, syncESlavePort=syncESlavePort, transmitModulationModeLinked=transmitModulationModeLinked, smtpGroup=smtpGroup, auxPortStatusTrap=auxPortStatusTrap, aggregateDataRate=aggregateDataRate, tDM=tDM, dfsTableNumber=dfsTableNumber, aAAControl=aAAControl, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, byteErrorRatio=byteErrorRatio, licenseGroup=licenseGroup, lowestTDMModulationMode=lowestTDMModulationMode, rawReceivePowerLinked=rawReceivePowerLinked, subbandLowestFrequency=subbandLowestFrequency, licenseIEEE1588Support=licenseIEEE1588Support, configurationInstancedTableEntry=configurationInstancedTableEntry, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, capacityVariantMismatchTrap=capacityVariantMismatchTrap, configurationInstancedTableNumber=configurationInstancedTableNumber, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, dfsGroup=dfsGroup, encryptionAlgorithm=encryptionAlgorithm, sNTPServerStatus=sNTPServerStatus, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, productName=productName, telnetAccessEnabled=telnetAccessEnabled, signalStrengthRatio=signalStrengthRatio, remoteMACAddress=remoteMACAddress, ethernetStatisticsDataSource=ethernetStatisticsDataSource, ptpGroups=ptpGroups, whitelistRMMacAddress=whitelistRMMacAddress, cableDiagPair3Results=cableDiagPair3Results, channelChangeTrap=channelChangeTrap, dNSResolver=dNSResolver, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sFPPortAutoMdix=sFPPortAutoMdix, dNSServerInternetAddressType=dNSServerInternetAddressType, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sFPError=sFPError, regulatoryBand=regulatoryBand, cableDiagnosticsWarning=cableDiagnosticsWarning, ethernetInstancedTable=ethernetInstancedTable, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNTPServerInternetAddress=sNTPServerInternetAddress, whitelistRMEnabled=whitelistRMEnabled, dataBridgingStatus=dataBridgingStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, mainPSUPortSSMTx=mainPSUPortSSMTx, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, rangeLinked=rangeLinked, transparentClock=transparentClock, sNMPCommunityString=sNMPCommunityString, syslogState=syslogState, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sMTPServerPortNumber=sMTPServerPortNumber, encryption=encryption, dNSServerTableEntry=dNSServerTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, authorizationControlTableNumber=authorizationControlTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, sFPPortAutoNegotiation=sFPPortAutoNegotiation, syncETrackingState=syncETrackingState, ethernet=ethernet, tFTPServerPortNumber=tFTPServerPortNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, phyControlInstancedTableEntry=phyControlInstancedTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapVersion=sNMPTrapVersion, sNTPLastSync=sNTPLastSync, userEnabled=userEnabled, tDMChannelCableLength=tDMChannelCableLength, sNMPTrapTableIndex=sNMPTrapTableIndex, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, phyControlGroup=phyControlGroup, longitude=longitude, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, transmitDataRateLinked=transmitDataRateLinked, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, vLANManagementPriority=vLANManagementPriority, snmpControl=snmpControl, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, deviceMSN=deviceMSN, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, configurationInstancedTable=configurationInstancedTable, tDMEnabledChannels=tDMEnabledChannels, blacklistRMMacAddress=blacklistRMMacAddress, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, gatewayIPAddress=gatewayIPAddress, tDMInterfaceStatus=tDMInterfaceStatus, deviceESN=deviceESN, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sFPPortQLRx=sFPPortQLRx)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", managementPortWirelessDownAlert=managementPortWirelessDownAlert, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mABMaintenanceLevel=mABMaintenanceLevel, remoteInternetAddressLinked=remoteInternetAddressLinked, transmitPower=transmitPower, sNMPEnabledTraps=sNMPEnabledTraps, cableDiagPair2Distance=cableDiagPair2Distance, vLANManagementVID=vLANManagementVID, latitude=latitude, transmitModulationMode=transmitModulationMode, managementGroup=managementGroup, unavailableSeconds=unavailableSeconds, sFPErrorTrap=sFPErrorTrap, unitName=unitName, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, auxPortDisabledWarning=auxPortDisabledWarning, sFPPortQLTx=sFPPortQLTx, txMABFrames=txMABFrames, iPVersion=iPVersion, extendedSpectrumScanning=extendedSpectrumScanning, mainPSUPortStatusTrap=mainPSUPortStatusTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sFPPortStatusTrap=sFPPortStatusTrap, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseSecurityLevel=licenseSecurityLevel, iPv4Address=iPv4Address, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sntpGroup=sntpGroup, unitIdentificationGroup=unitIdentificationGroup, searchState=searchState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sFPPortSSMTx=sFPPortSSMTx, userTableNumber=userTableNumber, mgmtInstancedTableEntry=mgmtInstancedTableEntry, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, lbtDetectedTrap=lbtDetectedTrap, cableDiagPair4Results=cableDiagPair4Results, deviceMACAddress=deviceMACAddress, dfsPeaks=dfsPeaks, byteErrorRatioLinked=byteErrorRatioLinked, sNTPPollInterval=sNTPPollInterval, sNTPServerTable=sNTPServerTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortSyncERxStatus=auxPortSyncERxStatus, receivePowerLinked=receivePowerLinked, tdmTable=tdmTable, userName=userName, syncEEquipmentClock=syncEEquipmentClock, daylightSaving=daylightSaving, sNMPTrapInternetAddress=sNMPTrapInternetAddress, versionsGroup=versionsGroup, wirelessOutEthernetOctets=wirelessOutEthernetOctets, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseMaxLinkRange=licenseMaxLinkRange, nIDULanPortStatus=nIDULanPortStatus, softwareVersion=softwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode)
