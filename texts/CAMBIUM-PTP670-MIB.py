...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagnosticsPorts=cableDiagnosticsPorts, ethernetGroup=ethernetGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, wirelessLinkAvailability=wirelessLinkAvailability, mPLSTCPriorityTable=mPLSTCPriorityTable, sFPErrorTrap=sFPErrorTrap, mABHoldoffPeriod=mABHoldoffPeriod, resetGroup=resetGroup, sNTPSyncTrap=sNTPSyncTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, l2CPPriorityTableIndex=l2CPPriorityTableIndex, regulatoryBand=regulatoryBand, transmitModulationMode=transmitModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aAAControl=aAAControl, unitIdentification=unitIdentification, portAllocationMismatchLinked=portAllocationMismatchLinked, wirelessOutEthernetOctets=wirelessOutEthernetOctets, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, supplementaryGroup=supplementaryGroup, authorizationControlTableEntry=authorizationControlTableEntry, sNTPServerRetries=sNTPServerRetries, tDDControlGroup=tDDControlGroup, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, ethernet=ethernet, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, targetRange=targetRange, ptp=ptp, sFPPortQLRx=sFPPortQLRx, reset=reset, vectorError=vectorError, cableDiagPair3Distance=cableDiagPair3Distance, softwareVersion=softwareVersion, ptp670=ptp670, transmitDataRateLinked=transmitDataRateLinked, rangingMode=rangingMode, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sFPError=sFPError, userEnabled=userEnabled, transparentClockVID=transparentClockVID, dNSPrimaryServer=dNSPrimaryServer, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cambium=cambium, configurationInstancedTableNumber=configurationInstancedTableNumber, auxPortAcceptedQLRx=auxPortAcceptedQLRx, receiveFreqMHz=receiveFreqMHz, transmitDataRate=transmitDataRate, syncESlavePort=syncESlavePort, dfsTableIndex=dfsTableIndex, licenseVersion=licenseVersion, ethernetInstancedTableIndex=ethernetInstancedTableIndex, phyInstancedStatusTable=phyInstancedStatusTable, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, tDMChannelStatusTrap=tDMChannelStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tDM=tDM, wirelessTopology=wirelessTopology, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, byteErrorRatio=byteErrorRatio, smtp=smtp, dataBridgingStatus=dataBridgingStatus, licenseInstancedTableIndex=licenseInstancedTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, dNSServerTable=dNSServerTable, transparentClockPort=transparentClockPort, l2CPPriorityTable=l2CPPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, receiveDataRateLinked=receiveDataRateLinked, dataBridgingAvailability=dataBridgingAvailability, systemReset=systemReset, timeZone=timeZone, dSCPManagementPriority=dSCPManagementPriority, tFTPServerPortNumber=tFTPServerPortNumber, cableDiagPair1Results=cableDiagPair1Results, licenseGroupAccess=licenseGroupAccess, transmitterChannels=transmitterChannels, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, dfs=dfs, license=license, sNTPSync=sNTPSync, subbandHighestFrequency=subbandHighestFrequency, aAAControlGroup=aAAControlGroup, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, configurationGroup=configurationGroup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, whitelistRMMacAddress=whitelistRMMacAddress, versionsGroup=versionsGroup, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, daylightSaving=daylightSaving, wirelessOutOctets=wirelessOutOctets, rangeLinked=rangeLinked, maximumNumberOfSlaves=maximumNumberOfSlaves, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, regulatoryBandTrap=regulatoryBandTrap, sNMPEnabledTraps=sNMPEnabledTraps, alarmInstancedTable=alarmInstancedTable, productVariant=productVariant, receiveModulationModeLinked=receiveModulationModeLinked, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, dNS=dNS, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagnostics=cableDiagnostics, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, packetsToInternalStack=packetsToInternalStack, iPv6PrefixLength=iPv6PrefixLength, alarmInstancedTableNumber=alarmInstancedTableNumber, installationMode=installationMode, configurationInstancedTableIndex=configurationInstancedTableIndex, transmitPowerLinked=transmitPowerLinked, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, remoteInternetAddress=remoteInternetAddress, linkLossLinked=linkLossLinked, deviceESN=deviceESN, installStatusLinked=installStatusLinked, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, linkSymmetry=linkSymmetry, byteErrorRatioLinked=byteErrorRatioLinked, frequencyVariant=frequencyVariant, syslogClientTrap=syslogClientTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, bridgeGroup=bridgeGroup, tdmTableEntry=tdmTableEntry, licenseSFPPortSupport=licenseSFPPortSupport, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, nIDULanPortAutoMdix=nIDULanPortAutoMdix, auxPortSSMTx=auxPortSSMTx, maximumTransmitPower=maximumTransmitPower, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, auxPortConfigurationMismatch=auxPortConfigurationMismatch, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tDDControl=tDDControl, licenseSyncESupport=licenseSyncESupport, channelBandwidth=channelBandwidth, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, hTTPSPortNumber=hTTPSPortNumber, tDMChannelStatus=tDMChannelStatus, sFPPortAutoMdix=sFPPortAutoMdix, snmpControl=snmpControl, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, authorizationControlTable=authorizationControlTable, qOSPriorityScheme=qOSPriorityScheme, receivePowerLinked=receivePowerLinked, cableDiagnosticsGroup=cableDiagnosticsGroup, smtpGroup=smtpGroup, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, nIDULanPortStatus=nIDULanPortStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPClient=tFTPClient, syncETrackingState=syncETrackingState, licenseInstancedTable=licenseInstancedTable, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseSecurityLevel=licenseSecurityLevel, telnetAccessEnabled=telnetAccessEnabled, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, iPVersion=iPVersion, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteInternetAddressType=remoteInternetAddressType, wirelessLinkStatusLinked=wirelessLinkStatusLinked, licenseIssueNumber=licenseIssueNumber, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, productName=productName, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, dataBridgingStatusAlarm=dataBridgingStatusAlarm, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dfsGroup=dfsGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, versions=versions, tempPcb=tempPcb, sNMPTrapPortNumber=sNMPTrapPortNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, hTTPAccessEnabled=hTTPAccessEnabled, authorizationControlTableIndex=authorizationControlTableIndex, routerProtocolsGroup=routerProtocolsGroup, signalStrengthRatio=signalStrengthRatio, cableLoss=cableLoss, receiveChannel=receiveChannel, hCMPMaximumLinkRange=hCMPMaximumLinkRange, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, cableDiagPair3Results=cableDiagPair3Results, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, ethernetInstancedTable=ethernetInstancedTable, mABProtocolVLANPriority=mABProtocolVLANPriority, mABNominalModulationMode=mABNominalModulationMode, remoteMACAddress=remoteMACAddress, hardwareVersion=hardwareVersion, licenseCountry=licenseCountry, ethernetInstancedTableEntry=ethernetInstancedTableEntry, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, mainPSUPortQLTx=mainPSUPortQLTx, syslogLocalWrappedTrap=syslogLocalWrappedTrap, txColorCode=txColorCode, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, installStatusTrap=installStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, unitIdentificationGroup=unitIdentificationGroup, lowestTDMModulationMode=lowestTDMModulationMode, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, syncETracking=syncETracking, mainPSUPortStatus=mainPSUPortStatus, secureModeAlarm=secureModeAlarm, unavailableSeconds=unavailableSeconds, linkName=linkName, tDMConfigurationMismatch=tDMConfigurationMismatch, vLANManagementVID=vLANManagementVID, enableTransmission=enableTransmission, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, targetMACAddress=targetMACAddress, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, iPv6GatewayAddress=iPv6GatewayAddress, routerProtocols=routerProtocols, ethernetStatisticsDataSource=ethernetStatisticsDataSource, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, phyStatusGroup=phyStatusGroup, sNTPServerTableNumber=sNTPServerTableNumber, cableDiagPair4Results=cableDiagPair4Results, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, pubStatsGroup=pubStatsGroup, auxPortAllocation=auxPortAllocation, signalStrengthRatioLinked=signalStrengthRatioLinked, useVLANForMABProtocol=useVLANForMABProtocol, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, transmitFreqMHz=transmitFreqMHz, dfsTableEntry=dfsTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, eIRP=eIRP, transparentClock=transparentClock, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ptpTraps=ptpTraps, installStatus=installStatus, sNTPServerPortNumber=sNTPServerPortNumber, auxPortSyncERxStatus=auxPortSyncERxStatus, syslogStateTrap=syslogStateTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, remoteMACAddressLinked=remoteMACAddressLinked, userRole=userRole, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, packetsFromInternalStack=packetsFromInternalStack, rawReceivePower=rawReceivePower, licenseRegulatoryBandsList=licenseRegulatoryBandsList, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, whitelistRMEnabled=whitelistRMEnabled, mABState=mABState, auxPortStatus=auxPortStatus, syslogControl=syslogControl, receiveDataRate=receiveDataRate, dNSGroup=dNSGroup, lowestDataModulationMode=lowestDataModulationMode, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, longitude=longitude, deviceMSN=deviceMSN, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, tDMChannelLineCode=tDMChannelLineCode, remoteUnitNameLinked=remoteUnitNameLinked, altitude=altitude, ethernetStatisticsTable=ethernetStatisticsTable, sntpGroup=sntpGroup, syncEEquipmentClock=syncEEquipmentClock, blacklistRMEnabled=blacklistRMEnabled, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, encryption=encryption, authorizationControl=authorizationControl, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, mABNominalTransmitCapacity=mABNominalTransmitCapacity, range=range, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableNumber=userTableNumber, portAllocationMismatch=portAllocationMismatch, ptmp=ptmp, remoteInternetAddressLinked=remoteInternetAddressLinked, mABMaintenanceLevel=mABMaintenanceLevel, antennaSelection=antennaSelection, licenseBandwidthCap=licenseBandwidthCap, aggregateDataRateLinked=aggregateDataRateLinked, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, unitName=unitName, aggregateDataRate=aggregateDataRate, iPv6Address=iPv6Address, sNTPPrimaryServer=sNTPPrimaryServer, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sFPPortAllocation=sFPPortAllocation, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPv3Enable=sNMPv3Enable, sNTPServerStatus=sNTPServerStatus, cableDiagnosticsResultTable=cableDiagnosticsResultTable, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sntp=sntp, managementGroup=managementGroup, subnetMask=subnetMask, licenseGasGroup=licenseGasGroup, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, alarmInstancedTableIndex=alarmInstancedTableIndex, sNTPServerTable=sNTPServerTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, maxLinkRangeExceeded=maxLinkRangeExceeded, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, syslogControlGroup=syslogControlGroup, sMTPEnabledMessages=sMTPEnabledMessages, hTTPPortNumber=hTTPPortNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseCapacity=licenseCapacity, searchStateLinked=searchStateLinked, userPassword=userPassword, receiveFreqKHz=receiveFreqKHz, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mgmtInstancedTableIndex=mgmtInstancedTableIndex, wirelessOutAllOctets=wirelessOutAllOctets, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, supplementary=supplementary, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, tdmTableIndex=tdmTableIndex, transmitModulationModeLinked=transmitModulationModeLinked, transmitFreqKHz=transmitFreqKHz, pubInstancedStatsTable=pubInstancedStatsTable, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, latitude=latitude, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, PYSNMP_MODULE_ID=cambium, licenseIPv6Support=licenseIPv6Support, userTableEntry=userTableEntry, vLANManagementPriority=vLANManagementPriority, userTableIndex=userTableIndex, masterSlaveMode=masterSlaveMode, sNMPTrapTable=sNMPTrapTable, subbandLowestFrequency=subbandLowestFrequency, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseUnitSerialNumber=licenseUnitSerialNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, oOBPriorityQueueMapping=oOBPriorityQueueMapping, mainPSUPortSSMTx=mainPSUPortSSMTx, sNTPState=sNTPState, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, ptpCompliance=ptpCompliance, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, bootVersion=bootVersion, installArmStateTrap=installArmStateTrap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mABTransmissionInterval=mABTransmissionInterval, dNSServerTableIndex=dNSServerTableIndex, licenseGroup=licenseGroup, sFPPortStatus=sFPPortStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, systemClock=systemClock, erroredSeconds=erroredSeconds, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNTPServerTimeout=sNTPServerTimeout, enabledDiagnosticAlarms=enabledDiagnosticAlarms, pubStats=pubStats, alarmsGroup=alarmsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, dNSServerTableNumber=dNSServerTableNumber, sFPPortStatusTrap=sFPPortStatusTrap, auxPortQLRx=auxPortQLRx, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsMeans=dfsMeans, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, snmpControlGroup=snmpControlGroup, siteName=siteName, tdmTable=tdmTable, installArmState=installArmState, cableDiagPair2Results=cableDiagPair2Results, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, licenseTrialPeriod=licenseTrialPeriod, cableDiagPair2Distance=cableDiagPair2Distance, receiveModulationMode=receiveModulationMode, mgmtInstancedTable=mgmtInstancedTable, userTable=userTable, ptpGroups=ptpGroups, mgmtInstancedTableEntry=mgmtInstancedTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sFPPortDisabledWarning=sFPPortDisabledWarning, authorizationControlGroup=authorizationControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseRARSupport=licenseRARSupport, antennaGain=antennaGain, alarms=alarms, apc=apc, dNSServerPortNumber=dNSServerPortNumber, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sFPPortSSMTx=sFPPortSSMTx, mainPSUPortStatusTrap=mainPSUPortStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, auxPortDisabledWarning=auxPortDisabledWarning, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseHCMPSupport=licenseHCMPSupport, receiveModulationModeDetail=receiveModulationModeDetail, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, channelChangeTrap=channelChangeTrap, telnetPortNumber=telnetPortNumber, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sMTPEmailAlert=sMTPEmailAlert, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, blacklistRMMacAddress=blacklistRMMacAddress, rxColorCode=rxColorCode, iPv4Address=iPv4Address, encryptionGroup=encryptionGroup, tDMChannelLoopback=tDMChannelLoopback, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataBridgingStatusLinked=dataBridgingStatusLinked, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, vectorErrorLinked=vectorErrorLinked, searchState=searchState, hCMPLinkSymmetry=hCMPLinkSymmetry, severelyErroredSeconds=severelyErroredSeconds, sNMPPortNumber=sNMPPortNumber, notificationsGroup=notificationsGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, capacityVariantMismatch=capacityVariantMismatch, configurationInstancedTable=configurationInstancedTable, ethernetPriorityTable=ethernetPriorityTable, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, apcGroup=apcGroup, groupID=groupID, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, dfsPeaks=dfsPeaks, secondarySoftwareVersion=secondarySoftwareVersion, cableDiagPair1Distance=cableDiagPair1Distance, tDMInterfaceControl=tDMInterfaceControl, iPDSCPPriorityTable=iPDSCPPriorityTable, auxPortStatusTrap=auxPortStatusTrap, dNSServerInternetAddress=dNSServerInternetAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, extendedSpectrumScanning=extendedSpectrumScanning, licenseTLSRekey=licenseTLSRekey, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNTPLastSync=sNTPLastSync, encryptionAlgorithm=encryptionAlgorithm, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, dNSServerInternetAddressType=dNSServerInternetAddressType, capacityVariantMismatchTrap=capacityVariantMismatchTrap, txMABFrames=txMABFrames, tDMChannelCableLength=tDMChannelCableLength, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, tDDSynchronizationMode=tDDSynchronizationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, secureModeAlarmTrap=secureModeAlarmTrap, lbtDetectedTrap=lbtDetectedTrap, management=management, sMTPServerInternetAddressType=sMTPServerInternetAddressType, accessMethod=accessMethod, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsTable=dfsTable)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNMPCommunityString=sNMPCommunityString, remoteUnitName=remoteUnitName, transparentClockVLAN=transparentClockVLAN, phyControlInstancedTableEntry=phyControlInstancedTableEntry, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, syslogState=syslogState, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sFPPortQLTx=sFPPortQLTx, mainPSUPortAllocation=mainPSUPortAllocation, tdmTableNumber=tdmTableNumber, mABProtocolVID=mABProtocolVID, userName=userName, receivePower=receivePower, licenseEncryption=licenseEncryption, tFTPServerInternetAddressType=tFTPServerInternetAddressType, phyControlGroup=phyControlGroup, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, configuration=configuration, dataPortPauseFrames=dataPortPauseFrames, capacityVariantMismatchLinked=capacityVariantMismatchLinked, tDMInterfaceStatus=tDMInterfaceStatus, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, authorizationMethod=authorizationMethod, authorizationControlTableNumber=authorizationControlTableNumber, sNTPServerTableEntry=sNTPServerTableEntry, dNSResolver=dNSResolver, tDMEnabledChannels=tDMEnabledChannels, licenseIEEE1588Support=licenseIEEE1588Support, sNTPPollInterval=sNTPPollInterval, licenseMaxLinkRange=licenseMaxLinkRange, bridge=bridge, linkLoss=linkLoss, dNSServerTableEntry=dNSServerTableEntry, phyControl=phyControl, cableDiagnosticsControl=cableDiagnosticsControl, phyControlInstancedTable=phyControlInstancedTable, phyStatus=phyStatus, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, sNTPServerTableIndex=sNTPServerTableIndex, auxPortQLTx=auxPortQLTx, licenseInstancedTableEntry=licenseInstancedTableEntry, transmitChannel=transmitChannel, cableDiagPair4Distance=cableDiagPair4Distance, deviceMACAddress=deviceMACAddress, mgmtInstancedTableNumber=mgmtInstancedTableNumber, dfsTableNumber=dfsTableNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sMTPServerPortNumber=sMTPServerPortNumber, rawReceivePowerLinked=rawReceivePowerLinked, tDMGroup=tDMGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseInstancedTableNumber=licenseInstancedTableNumber, transmitPower=transmitPower, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimization=linkModeOptimization, localPacketFiltering=localPacketFiltering, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames)
