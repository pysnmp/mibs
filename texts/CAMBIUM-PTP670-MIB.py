...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDMGroup=tDMGroup, installStatus=installStatus, alarmInstancedTable=alarmInstancedTable, dNSServerPortNumber=dNSServerPortNumber, mgmtInstancedTable=mgmtInstancedTable, cableDiagnosticsGroup=cableDiagnosticsGroup, mainPSUPortAllocation=mainPSUPortAllocation, receiveFreqMHz=receiveFreqMHz, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, authorizationControlTableNumber=authorizationControlTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, phyStatus=phyStatus, cableDiagPair2Distance=cableDiagPair2Distance, receiveModulationModeLinked=receiveModulationModeLinked, apc=apc, phyControl=phyControl, encryption=encryption, auxPortDisabledWarning=auxPortDisabledWarning, groupID=groupID, installationMode=installationMode, transmitModulationModeLinked=transmitModulationModeLinked, dNSServerInternetAddress=dNSServerInternetAddress, txMABFrames=txMABFrames, qOSPriorityScheme=qOSPriorityScheme, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPState=sNTPState, authorizationControlTableEntry=authorizationControlTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPClient=tFTPClient, ptpTraps=ptpTraps, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, syslogState=syslogState, notificationsGroup=notificationsGroup, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPPollInterval=sNTPPollInterval, transparentClockPort=transparentClockPort, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, byteErrorRatio=byteErrorRatio, licenseCapacity=licenseCapacity, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sFPPortQLRx=sFPPortQLRx, sNTPServerInternetAddressType=sNTPServerInternetAddressType, phyInstancedStatusTable=phyInstancedStatusTable, sNMPTrapTableNumber=sNMPTrapTableNumber, txColorCode=txColorCode, unitIdentificationGroup=unitIdentificationGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation, iPDSCPPriorityTable=iPDSCPPriorityTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mgmtInstancedTableIndex=mgmtInstancedTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteUnitNameLinked=remoteUnitNameLinked, mABProtocolVID=mABProtocolVID, mABNominalTransmitCapacity=mABNominalTransmitCapacity, phyControlInstancedTableIndex=phyControlInstancedTableIndex, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, cableDiagPair3Distance=cableDiagPair3Distance, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, tdmTable=tdmTable, hTTPAccessEnabled=hTTPAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dNS=dNS, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, useVLANForMABProtocol=useVLANForMABProtocol, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, transparentClockVID=transparentClockVID, systemReset=systemReset, oOBPriorityQueueMapping=oOBPriorityQueueMapping, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, linkModeOptimization=linkModeOptimization, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, configurationInstancedTable=configurationInstancedTable, licenseSFPPortSupport=licenseSFPPortSupport, subnetMask=subnetMask, syncESlavePort=syncESlavePort, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, wirelessOutEthernetOctets=wirelessOutEthernetOctets, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, rangeLinked=rangeLinked, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseRegulatoryBandsList=licenseRegulatoryBandsList, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseMaxLinkRange=licenseMaxLinkRange, signalStrengthRatio=signalStrengthRatio, linkName=linkName, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, iPVersion=iPVersion, iPv6PrefixLength=iPv6PrefixLength, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, dataBridgingStatusLinked=dataBridgingStatusLinked, ethernetInstancedTableIndex=ethernetInstancedTableIndex, licenseTLSRekey=licenseTLSRekey, ptpCompliance=ptpCompliance, transmitPower=transmitPower, cableDiagnosticsControl=cableDiagnosticsControl, alarmInstancedTableEntry=alarmInstancedTableEntry, signalStrengthRatioLinked=signalStrengthRatioLinked, sNMPTrapVersion=sNMPTrapVersion, alarms=alarms, auxPortAllocation=auxPortAllocation, longitude=longitude, sMTPEmailAlert=sMTPEmailAlert, auxPortConfigurationMismatch=auxPortConfigurationMismatch, wirelessLinkStatusLinked=wirelessLinkStatusLinked, alarmsGroup=alarmsGroup, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, bridge=bridge, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, userName=userName, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, auxPortStatus=auxPortStatus, telnetPortNumber=telnetPortNumber, licenseGroupAccess=licenseGroupAccess, tDMConfigurationMismatch=tDMConfigurationMismatch, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, receiveModulationMode=receiveModulationMode, cableDiagnosticsResultTable=cableDiagnosticsResultTable, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, altitude=altitude, licenseSecurityLevel=licenseSecurityLevel, configuration=configuration, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, transmitFreqMHz=transmitFreqMHz, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tFTPServerInternetAddressType=tFTPServerInternetAddressType, hardwareVersion=hardwareVersion, maximumNumberOfSlaves=maximumNumberOfSlaves, syslogControlGroup=syslogControlGroup, remoteMACAddressLinked=remoteMACAddressLinked, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, byteErrorRatioLinked=byteErrorRatioLinked, maximumTransmitPower=maximumTransmitPower, ethernetInstancedTableEntry=ethernetInstancedTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, deviceMSN=deviceMSN, ethernetPriorityTableIndex=ethernetPriorityTableIndex, installStatusLinked=installStatusLinked, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPLastSync=sNTPLastSync, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataBridgingAvailability=dataBridgingAvailability, licenseInstancedTable=licenseInstancedTable, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, receiveDataRate=receiveDataRate, authorizationControlGroup=authorizationControlGroup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, authorizationMethod=authorizationMethod, userTable=userTable, licenseCountry=licenseCountry, capacityVariantMismatchTrap=capacityVariantMismatchTrap, versionsGroup=versionsGroup, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, mABProtocolVLANPriority=mABProtocolVLANPriority, cableDiagPair4Results=cableDiagPair4Results, unitIdentification=unitIdentification, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, installArmState=installArmState, gatewayIPAddress=gatewayIPAddress, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDMEnabledChannels=tDMEnabledChannels, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPServerInternetAddress=tFTPServerInternetAddress, tDMChannelCableLength=tDMChannelCableLength, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, transmitFreqKHz=transmitFreqKHz, secureModeAlarm=secureModeAlarm, sNTPSync=sNTPSync, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyControlInstancedTable=phyControlInstancedTable, wirelessTopology=wirelessTopology, dSCPManagementPriority=dSCPManagementPriority, phyControlInstancedTableEntry=phyControlInstancedTableEntry, rxColorCode=rxColorCode, regulatoryBandTrap=regulatoryBandTrap, transmitDataRateLinked=transmitDataRateLinked, authorizationControlTable=authorizationControlTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationMode=tDDSynchronizationMode, dfsTable=dfsTable, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, dfsMeans=dfsMeans, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPv3Enable=sNMPv3Enable, tFTPServerPortNumber=tFTPServerPortNumber, mainPSUPortStatus=mainPSUPortStatus, vectorErrorLinked=vectorErrorLinked, remoteInternetAddress=remoteInternetAddress, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPPortNumber=sNMPPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, tDMChannelStatusTrap=tDMChannelStatusTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, cableLoss=cableLoss, unitOutOfCalibration=unitOutOfCalibration, tDM=tDM, nIDULanPortStatus=nIDULanPortStatus, hCMPLinkSymmetry=hCMPLinkSymmetry, eIRP=eIRP, transmitChannel=transmitChannel, secureModeAlarmTrap=secureModeAlarmTrap, pubStats=pubStats, sNTPServerTable=sNTPServerTable, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mainPSUPortAutoMdix=mainPSUPortAutoMdix, smtpGroup=smtpGroup, sNTPServerStatus=sNTPServerStatus, phyControlGroup=phyControlGroup, tDMChannelStatus=tDMChannelStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPv6GatewayAddress=iPv6GatewayAddress, dNSPrimaryServer=dNSPrimaryServer, sNMPTrapPortNumber=sNMPTrapPortNumber, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sFPPortSSMTx=sFPPortSSMTx, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receivePowerLinked=receivePowerLinked, sNTPServerTableIndex=sNTPServerTableIndex, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTimeout=sNTPServerTimeout, dfs=dfs, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, installArmStateTrap=installArmStateTrap, receivePower=receivePower)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", versions=versions, encryptionGroup=encryptionGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, channelChangeTrap=channelChangeTrap, bootVersion=bootVersion, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, auxPortStatusTrap=auxPortStatusTrap, dNSResolver=dNSResolver, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, alarmInstancedTableNumber=alarmInstancedTableNumber, sFPErrorTrap=sFPErrorTrap, cambium=cambium, dNSServerTableIndex=dNSServerTableIndex, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, licenseInstancedTableEntry=licenseInstancedTableEntry, siteName=siteName, productVariant=productVariant, useVLANForManagementInterfaces=useVLANForManagementInterfaces, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tDDControlGroup=tDDControlGroup, pubInstancedStatsTable=pubInstancedStatsTable, licenseVersion=licenseVersion, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sFPPortAutoMdix=sFPPortAutoMdix, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, remoteMACAddress=remoteMACAddress, licenseEncryption=licenseEncryption, syslogClient=syslogClient, searchState=searchState, installStatusTrap=installStatusTrap, management=management, encryptionAlgorithm=encryptionAlgorithm, sFPPortStatusTrap=sFPPortStatusTrap, deviceESN=deviceESN, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, license=license, lbtDetectedTrap=lbtDetectedTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, dNSGroup=dNSGroup, regulatoryBand=regulatoryBand, antennaSelection=antennaSelection, transmitterChannels=transmitterChannels, ethernetGroup=ethernetGroup, ptmp=ptmp, ethernetPriorityTableNumber=ethernetPriorityTableNumber, portAllocationMismatchLinked=portAllocationMismatchLinked, sNTPServerRetries=sNTPServerRetries, sNTPServerPortNumber=sNTPServerPortNumber, severelyErroredSeconds=severelyErroredSeconds, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dNSServerInternetAddressType=dNSServerInternetAddressType, dfsTableEntry=dfsTableEntry, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, supplementary=supplementary, transmitDataRate=transmitDataRate, syslogClientTrap=syslogClientTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsTableNumber=dfsTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, incompatibleRegulatoryBands=incompatibleRegulatoryBands, ptp=ptp, hTTPSAccessEnabled=hTTPSAccessEnabled, range=range, deviceMACAddress=deviceMACAddress, configurationGroup=configurationGroup, masterSlaveMode=masterSlaveMode, userTableIndex=userTableIndex, ptpGroups=ptpGroups, rawReceivePowerLinked=rawReceivePowerLinked, iPv4Address=iPv4Address, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, remoteUnitName=remoteUnitName, hTTPSPortNumber=hTTPSPortNumber, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sFPPortQLTx=sFPPortQLTx, mABNominalModulationMode=mABNominalModulationMode, tdmTableNumber=tdmTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortPauseFrames=dataPortPauseFrames, receiveFreqKHz=receiveFreqKHz, configurationInstancedTableIndex=configurationInstancedTableIndex, auxPortSyncERxStatus=auxPortSyncERxStatus, unitName=unitName, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, aAAControl=aAAControl, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, cableDiagPair1Results=cableDiagPair1Results, managementGroup=managementGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsTableIndex=dfsTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dNSServerTableEntry=dNSServerTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tempPcb=tempPcb, syncETrackingState=syncETrackingState, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, searchStateLinked=searchStateLinked, licenseUnitSerialNumber=licenseUnitSerialNumber, sNTPPrimaryServer=sNTPPrimaryServer, aggregateDataRateLinked=aggregateDataRateLinked, rawReceivePower=rawReceivePower, packetsFromInternalStack=packetsFromInternalStack, dNSServerTable=dNSServerTable, linkSymmetry=linkSymmetry, whitelistRMEnabled=whitelistRMEnabled, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPSyncTrap=sNTPSyncTrap, mainPSUPortQLRx=mainPSUPortQLRx, tdmTableIndex=tdmTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mABHoldoffPeriod=mABHoldoffPeriod, targetMACAddress=targetMACAddress, secondarySoftwareVersion=secondarySoftwareVersion, linkLossLinked=linkLossLinked, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, subbandLowestFrequency=subbandLowestFrequency, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sNTPServerInternetAddress=sNTPServerInternetAddress, supplementaryGroup=supplementaryGroup, licenseIPv6Support=licenseIPv6Support, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, whitelistRMMacAddress=whitelistRMMacAddress, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, accessMethod=accessMethod, auxPortSSMTx=auxPortSSMTx, targetRange=targetRange, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, userTableEntry=userTableEntry, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNMPTrapTableIndex=sNMPTrapTableIndex, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, blacklistRMEnabled=blacklistRMEnabled, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, dNSServerTableNumber=dNSServerTableNumber, transparentClockVLAN=transparentClockVLAN, telnetAccessEnabled=telnetAccessEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, authorizationControl=authorizationControl, licenseBandwidthCap=licenseBandwidthCap, sFPPortAllocation=sFPPortAllocation, wirelessOutAllOctets=wirelessOutAllOctets, licenseOOBManagementSupport=licenseOOBManagementSupport, ethernetPriorityTable=ethernetPriorityTable, alarmInstancedTableIndex=alarmInstancedTableIndex, ethernetStatisticsTable=ethernetStatisticsTable, vLANManagementPriority=vLANManagementPriority, resetGroup=resetGroup, phyControlInstancedTableNumber=phyControlInstancedTableNumber, ethernetInstancedTable=ethernetInstancedTable, receiveModulationModeDetail=receiveModulationModeDetail, mPLSTCPriorityTable=mPLSTCPriorityTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, hCMPMaximumLinkRange=hCMPMaximumLinkRange, remoteInternetAddressLinked=remoteInternetAddressLinked, sNMPTrapTable=sNMPTrapTable, productName=productName, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, portAllocationMismatch=portAllocationMismatch, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, capacityVariantMismatch=capacityVariantMismatch, iPv6Address=iPv6Address, tDMChannelLoopback=tDMChannelLoopback, dataBridgingStatusAlarm=dataBridgingStatusAlarm, userTableNumber=userTableNumber, lowestDataModulationMode=lowestDataModulationMode, mgmtInstancedTableEntry=mgmtInstancedTableEntry, licenseGasGroup=licenseGasGroup, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, wirelessLinkAvailability=wirelessLinkAvailability, extendedSpectrumScanning=extendedSpectrumScanning, licenseTrialPeriod=licenseTrialPeriod, authorizationControlTableIndex=authorizationControlTableIndex, ethernet=ethernet, auxPortAcceptedQLRx=auxPortAcceptedQLRx, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, cableDiagnosticsWarning=cableDiagnosticsWarning, auxPortQLRx=auxPortQLRx, enableTransmission=enableTransmission, phyStatusGroup=phyStatusGroup, userEnabled=userEnabled, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mABTransmissionInterval=mABTransmissionInterval, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mABMaintenanceLevel=mABMaintenanceLevel, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, daylightSaving=daylightSaving, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, wirelessOutOctets=wirelessOutOctets, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, userRole=userRole, remoteInternetAddressType=remoteInternetAddressType, systemClock=systemClock, cableDiagPair1Distance=cableDiagPair1Distance, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseHCMPSupport=licenseHCMPSupport, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, configurationInstancedTableEntry=configurationInstancedTableEntry, sNMPCommunityString=sNMPCommunityString, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sFPPortDisabledWarning=sFPPortDisabledWarning, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sntpGroup=sntpGroup, frequencyVariant=frequencyVariant, sMTPEnabledMessages=sMTPEnabledMessages, blacklistRMMacAddress=blacklistRMMacAddress, userPassword=userPassword, snmpControl=snmpControl, mgmtInstancedTableNumber=mgmtInstancedTableNumber, PYSNMP_MODULE_ID=cambium, lowestTDMModulationMode=lowestTDMModulationMode, snmpControlGroup=snmpControlGroup, packetsToInternalStack=packetsToInternalStack, transmitModulationMode=transmitModulationMode, dfsPeaks=dfsPeaks, ptpTrapPrefix=ptpTrapPrefix, licenseIssueNumber=licenseIssueNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, softwareVersion=softwareVersion, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, tDMInterfaceStatus=tDMInterfaceStatus, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, syslogControl=syslogControl, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, receiveChannel=receiveChannel, tdmTableEntry=tdmTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, licenseSyncESupport=licenseSyncESupport, tDMInterfaceControl=tDMInterfaceControl, unavailableSeconds=unavailableSeconds, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, portAllocationMismatchTrap=portAllocationMismatchTrap, smtp=smtp, syncEEquipmentClock=syncEEquipmentClock, sMTPServerPortNumber=sMTPServerPortNumber, licenseRARSupport=licenseRARSupport, latitude=latitude, rangingMode=rangingMode, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dfsGroup=dfsGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagnosticsPorts=cableDiagnosticsPorts, routerProtocols=routerProtocols, routerProtocolsGroup=routerProtocolsGroup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, erroredSeconds=erroredSeconds, bridgeGroup=bridgeGroup, apcGroup=apcGroup, aggregateDataRate=aggregateDataRate, sNMPTrapInternetAddress=sNMPTrapInternetAddress, subbandHighestFrequency=subbandHighestFrequency, antennaGain=antennaGain, configurationInstancedTableNumber=configurationInstancedTableNumber, hTTPPortNumber=hTTPPortNumber, receiveDataRateLinked=receiveDataRateLinked, sntp=sntp, ethernetInstancedTableNumber=ethernetInstancedTableNumber, reset=reset, tDMChannelLineCode=tDMChannelLineCode, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, mABState=mABState, cableDiagnostics=cableDiagnostics, licenseInstancedTableIndex=licenseInstancedTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, licenseGroup=licenseGroup, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sFPPortStatus=sFPPortStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sNTPServerTableNumber=sNTPServerTableNumber, channelBandwidth=channelBandwidth, ptp670=ptp670, dataBridgingStatus=dataBridgingStatus, transparentClock=transparentClock, vectorError=vectorError, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagPair3Results=cableDiagPair3Results, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, pubStatsGroup=pubStatsGroup, auxPortQLTx=auxPortQLTx, cableDiagPair2Results=cableDiagPair2Results, licenseInstancedTableNumber=licenseInstancedTableNumber, timeZone=timeZone, syslogStateTrap=syslogStateTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, vLANManagementVID=vLANManagementVID, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tDDControl=tDDControl, transmitPowerLinked=transmitPowerLinked, wirelessLinkStatus=wirelessLinkStatus, l2CPPriorityTable=l2CPPriorityTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, syncETracking=syncETracking, licenseTDDSyncSupport=licenseTDDSyncSupport, sFPError=sFPError, linkLoss=linkLoss, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, localPacketFiltering=localPacketFiltering, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, aAAControlGroup=aAAControlGroup)
