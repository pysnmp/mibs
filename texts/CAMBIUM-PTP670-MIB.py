...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", hCMPLinkSymmetry=hCMPLinkSymmetry, ethernetInstancedTableIndex=ethernetInstancedTableIndex, userRole=userRole, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, cableDiagPair4Distance=cableDiagPair4Distance, mPLSTCPriorityTable=mPLSTCPriorityTable, cableDiagnosticsWarning=cableDiagnosticsWarning, capacityVariantMismatchTrap=capacityVariantMismatchTrap, ptp670=ptp670, receiveModulationMode=receiveModulationMode, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, apcGroup=apcGroup, linkName=linkName, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mainPSUPortSSMTx=mainPSUPortSSMTx, regulatoryBand=regulatoryBand, maxLinkRangeExceeded=maxLinkRangeExceeded, authorizationControlTableNumber=authorizationControlTableNumber, iPv6PrefixLength=iPv6PrefixLength, sNTPSync=sNTPSync, hardwareVersion=hardwareVersion, alarms=alarms, vLANManagementVID=vLANManagementVID, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkStatusLinked=wirelessLinkStatusLinked, smtpGroup=smtpGroup, dfsTableIndex=dfsTableIndex, supplementaryGroup=supplementaryGroup, dNSPrimaryServer=dNSPrimaryServer, cableDiagPair3Results=cableDiagPair3Results, severelyErroredSeconds=severelyErroredSeconds, byteErrorRatio=byteErrorRatio, apc=apc, routerProtocols=routerProtocols, pubStats=pubStats, tDDControlGroup=tDDControlGroup, sFPPortStatusTrap=sFPPortStatusTrap, licenseMaxLinkRange=licenseMaxLinkRange, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogClient=syslogClient, dNSServerTableNumber=dNSServerTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, capacityVariantMismatch=capacityVariantMismatch, eIRP=eIRP, phyControlInstancedTableEntry=phyControlInstancedTableEntry, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, iPv6Address=iPv6Address, userTable=userTable, productVariant=productVariant, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, authorizationControlGroup=authorizationControlGroup, softwareVersion=softwareVersion, alarmInstancedTableIndex=alarmInstancedTableIndex, sNMPTrapTable=sNMPTrapTable, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, transmitPower=transmitPower, subbandHighestFrequency=subbandHighestFrequency, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, phyStatusGroup=phyStatusGroup, transmitFreqKHz=transmitFreqKHz, receiveFreqMHz=receiveFreqMHz, deviceMSN=deviceMSN, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, linkLossLinked=linkLossLinked, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, receiveChannel=receiveChannel, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tDMChannelCableLength=tDMChannelCableLength, latitude=latitude, rawReceivePower=rawReceivePower, ethernetStatisticsTable=ethernetStatisticsTable, localPacketFiltering=localPacketFiltering, tDMChannelLineCode=tDMChannelLineCode, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, smtp=smtp, licenseTLSRekey=licenseTLSRekey, transmitPowerLinked=transmitPowerLinked, sNMPTrapVersion=sNMPTrapVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mgmtInstancedTableEntry=mgmtInstancedTableEntry, authorizationControl=authorizationControl, dataPortPauseFrames=dataPortPauseFrames, receivePowerLinked=receivePowerLinked, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, vLANManagementPriority=vLANManagementPriority, tDMInterfaceStatus=tDMInterfaceStatus, userPassword=userPassword, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPSyncTrap=sNTPSyncTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, ptpTrapPrefix=ptpTrapPrefix, sNMPEnabledTraps=sNMPEnabledTraps, dNSServerTableEntry=dNSServerTableEntry, l2CPPriorityTable=l2CPPriorityTable, licenseVersion=licenseVersion, receiveModulationModeDetail=receiveModulationModeDetail, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ethernetPriorityTableEntry=ethernetPriorityTableEntry, encryption=encryption, installStatus=installStatus, alarmInstancedTableNumber=alarmInstancedTableNumber, tDMChannelLoopback=tDMChannelLoopback, receivePower=receivePower, sFPPortSSMTx=sFPPortSSMTx, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mainPSUPortAutoMdix=mainPSUPortAutoMdix, transparentClockVLAN=transparentClockVLAN, tDDSynchronizationMode=tDDSynchronizationMode, altitude=altitude, phyInstancedStatusTable=phyInstancedStatusTable, channelBandwidth=channelBandwidth, licenseCapacity=licenseCapacity, encryptionAlgorithm=encryptionAlgorithm, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, byteErrorRatioLinked=byteErrorRatioLinked, sNTPServerInternetAddress=sNTPServerInternetAddress, configuration=configuration, siteName=siteName, sNTPServerStatus=sNTPServerStatus, mABProtocolVID=mABProtocolVID, portAllocationMismatch=portAllocationMismatch, cableDiagPair4Results=cableDiagPair4Results, licenseEncryption=licenseEncryption, transmitFreqMHz=transmitFreqMHz, secureModeAlarm=secureModeAlarm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseBandwidthCap=licenseBandwidthCap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, l2CPPriorityTableNumber=l2CPPriorityTableNumber, cableDiagPair3Distance=cableDiagPair3Distance, dSCPManagementPriority=dSCPManagementPriority, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogStateTrap=syslogStateTrap, tDMGroup=tDMGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, alarmsGroup=alarmsGroup, capacityVariantMismatchLinked=capacityVariantMismatchLinked, dataBridgingStatus=dataBridgingStatus, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, nIDULanPortStatus=nIDULanPortStatus, telnetAccessEnabled=telnetAccessEnabled, ethernetGroup=ethernetGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sMTPServerPortNumber=sMTPServerPortNumber, bootVersion=bootVersion, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, syslogClientTrap=syslogClientTrap, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableDiagPair2Distance=cableDiagPair2Distance, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPSAccessEnabled=hTTPSAccessEnabled, maximumTransmitPower=maximumTransmitPower, licenseUnitSerialNumber=licenseUnitSerialNumber, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, receiveDataRate=receiveDataRate, extendedSpectrumScanning=extendedSpectrumScanning, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseRARSupport=licenseRARSupport, syslogControl=syslogControl, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, cableDiagPair2Results=cableDiagPair2Results, regulatoryBandTrap=regulatoryBandTrap, searchStateLinked=searchStateLinked, authorizationMethod=authorizationMethod, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tDMInterfaceControl=tDMInterfaceControl, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, rangingMode=rangingMode, transmitDataRateLinked=transmitDataRateLinked, mABNominalModulationMode=mABNominalModulationMode, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNMPv3Enable=sNMPv3Enable, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, range=range, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, bridgeGroup=bridgeGroup, licenseIPv6Support=licenseIPv6Support, lowestDataModulationMode=lowestDataModulationMode, tempPcb=tempPcb, whitelistRMEnabled=whitelistRMEnabled, ptpCompliance=ptpCompliance, PYSNMP_MODULE_ID=cambium, subbandLowestFrequency=subbandLowestFrequency, authorizationControlTableIndex=authorizationControlTableIndex, linkLoss=linkLoss, userTableIndex=userTableIndex, transparentClock=transparentClock, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, ethernet=ethernet, rxColorCode=rxColorCode, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, dNSServerInternetAddressType=dNSServerInternetAddressType, userName=userName, ethernetPriorityTable=ethernetPriorityTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataBridgingStatusLinked=dataBridgingStatusLinked, installArmStateTrap=installArmStateTrap, notificationsGroup=notificationsGroup, qOSPriorityScheme=qOSPriorityScheme, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, antennaGain=antennaGain, receiveModulationModeLinked=receiveModulationModeLinked, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, auxPortQLTx=auxPortQLTx, tDMConfigurationMismatch=tDMConfigurationMismatch, antennaSelection=antennaSelection, daylightSaving=daylightSaving, iPVersion=iPVersion, sMTPServerInternetAddress=sMTPServerInternetAddress, sFPPortAutoNegotiation=sFPPortAutoNegotiation, dataBridgingStatusAlarm=dataBridgingStatusAlarm, transmitModulationMode=transmitModulationMode, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, remoteMaximumTransmitPower=remoteMaximumTransmitPower, auxPortSSMTx=auxPortSSMTx, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", productName=productName, sNTPLastSync=sNTPLastSync, sFPPortAutoMdix=sFPPortAutoMdix, portAllocationMismatchTrap=portAllocationMismatchTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, transmitChannel=transmitChannel, sNMPPortNumber=sNMPPortNumber, userTableNumber=userTableNumber, transmitModulationModeLinked=transmitModulationModeLinked, auxPortStatusTrap=auxPortStatusTrap, txColorCode=txColorCode, cableDiagnosticsControl=cableDiagnosticsControl, licenseGasGroup=licenseGasGroup, syslogState=syslogState, dNSGroup=dNSGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, phyControlInstancedTable=phyControlInstancedTable, wirelessLinkAvailability=wirelessLinkAvailability, licenseInstancedTableNumber=licenseInstancedTableNumber, sFPPortStatus=sFPPortStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessOutOctets=wirelessOutOctets, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sFPError=sFPError, authorizationControlTable=authorizationControlTable, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, bridge=bridge, resetGroup=resetGroup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, wirelessOutEthernetOctets=wirelessOutEthernetOctets, mABHoldoffPeriod=mABHoldoffPeriod, nIDULanPortAutoMdix=nIDULanPortAutoMdix, dataBridgingAvailability=dataBridgingAvailability, groupID=groupID, cableDiagPair1Distance=cableDiagPair1Distance, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tDMChannelStatusTrap=tDMChannelStatusTrap, syncETrackingState=syncETrackingState, telnetPortNumber=telnetPortNumber, dfsTableNumber=dfsTableNumber, encryptionGroup=encryptionGroup, receiveFreqKHz=receiveFreqKHz, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, deviceESN=deviceESN, installStatusTrap=installStatusTrap, auxPortSyncERxStatus=auxPortSyncERxStatus, sFPPortQLRx=sFPPortQLRx, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTable=dfsTable, mgmtInstancedTableNumber=mgmtInstancedTableNumber, tFTPClient=tFTPClient, incompatibleRegulatoryBands=incompatibleRegulatoryBands, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mainPSUPortQLTx=mainPSUPortQLTx, managementNetworkAccessEnabled=managementNetworkAccessEnabled, remoteMACAddressLinked=remoteMACAddressLinked, accessMethod=accessMethod, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseIssueNumber=licenseIssueNumber, remoteInternetAddressType=remoteInternetAddressType, erroredSeconds=erroredSeconds, masterSlaveMode=masterSlaveMode, lbtDetectedTrap=lbtDetectedTrap, longitude=longitude, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rangeLinked=rangeLinked, aAAControl=aAAControl, mainPSUPortAllocation=mainPSUPortAllocation, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, secondarySoftwareVersion=secondarySoftwareVersion, dNSServerPortNumber=dNSServerPortNumber, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, reset=reset, auxPortQLRx=auxPortQLRx, tDMEnabledChannels=tDMEnabledChannels, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, transmitterChannels=transmitterChannels, versions=versions, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, supplementary=supplementary, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, syslogControlGroup=syslogControlGroup, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, phyControlGroup=phyControlGroup, mABMaintenanceLevel=mABMaintenanceLevel, tDM=tDM, tDDControl=tDDControl, sNTPServerPortNumber=sNTPServerPortNumber, syncESlavePort=syncESlavePort, sFPPortQLTx=sFPPortQLTx, transmitDataRate=transmitDataRate, userEnabled=userEnabled, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, vectorErrorLinked=vectorErrorLinked, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseGroup=licenseGroup, syncETracking=syncETracking, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, transparentClockPort=transparentClockPort, pubStatsGroup=pubStatsGroup, portAllocationMismatchLinked=portAllocationMismatchLinked, dNSServerTable=dNSServerTable, auxPortStatus=auxPortStatus, sFPPortAllocation=sFPPortAllocation, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tdmTable=tdmTable, sNTPServerTableNumber=sNTPServerTableNumber, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, unitIdentification=unitIdentification, tDDSynchronizationStatus=tDDSynchronizationStatus, configurationInstancedTable=configurationInstancedTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetInstancedTableEntry=ethernetInstancedTableEntry, ptp=ptp, management=management, timeZone=timeZone, sNTPServerTableEntry=sNTPServerTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyStatus=phyStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, dfsGroup=dfsGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkModeOptimization=linkModeOptimization, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, ptpTraps=ptpTraps, auxPortConfigurationMismatch=auxPortConfigurationMismatch, versionsGroup=versionsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, dfs=dfs, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mABState=mABState, remoteUnitNameLinked=remoteUnitNameLinked, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, ethernetInstancedTable=ethernetInstancedTable, useVLANForMABProtocol=useVLANForMABProtocol, pubInstancedStatsTable=pubInstancedStatsTable, txMABFrames=txMABFrames, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, aggregateDataRate=aggregateDataRate, sNTPPrimaryServer=sNTPPrimaryServer, sNMPCommunityString=sNMPCommunityString, iPDSCPPriorityTable=iPDSCPPriorityTable, installationMode=installationMode, dNS=dNS, configurationInstancedTableIndex=configurationInstancedTableIndex, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, unitIdentificationGroup=unitIdentificationGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, authorizationControlTableEntry=authorizationControlTableEntry, managementGroup=managementGroup, sNTPPollInterval=sNTPPollInterval, remoteMACAddress=remoteMACAddress, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remoteInternetAddress=remoteInternetAddress, receiveDataRateLinked=receiveDataRateLinked, phyControlInstancedTableIndex=phyControlInstancedTableIndex, systemClock=systemClock, frequencyVariant=frequencyVariant, licenseRegulatoryBandsList=licenseRegulatoryBandsList, linkSymmetry=linkSymmetry, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, aggregateDataRateLinked=aggregateDataRateLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, dNSServerInternetAddress=dNSServerInternetAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, hTTPPortNumber=hTTPPortNumber, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, signalStrengthRatio=signalStrengthRatio, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseHCMPSupport=licenseHCMPSupport, licenseTrialPeriod=licenseTrialPeriod, licenseSecurityLevel=licenseSecurityLevel, maximumNumberOfSlaves=maximumNumberOfSlaves, alarmInstancedTableEntry=alarmInstancedTableEntry, tdmTableIndex=tdmTableIndex, sntpGroup=sntpGroup, configurationGroup=configurationGroup, dfsTableEntry=dfsTableEntry, iPv4Address=iPv4Address, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, unitName=unitName, secureModeAlarmTrap=secureModeAlarmTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, systemReset=systemReset, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetStatisticsDataSource=ethernetStatisticsDataSource, wirelessTopology=wirelessTopology, mainPSUPortQLRx=mainPSUPortQLRx, unavailableSeconds=unavailableSeconds, cableDiagnostics=cableDiagnostics, sNTPServerTableIndex=sNTPServerTableIndex, installStatusLinked=installStatusLinked, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, enableTransmission=enableTransmission, remoteUnitName=remoteUnitName, ptpGroups=ptpGroups, nIDULanPortStatusTrap=nIDULanPortStatusTrap, ptmp=ptmp, tdmTableEntry=tdmTableEntry, wirelessLinkStatus=wirelessLinkStatus, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, licenseInstancedTable=licenseInstancedTable, noWirelessChannelAvailable=noWirelessChannelAvailable, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, oOBPriorityQueueMapping=oOBPriorityQueueMapping, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseInstancedTableEntry=licenseInstancedTableEntry, aAAControlGroup=aAAControlGroup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, rawReceivePowerLinked=rawReceivePowerLinked, blacklistRMMacAddress=blacklistRMMacAddress, installArmState=installArmState, deviceMACAddress=deviceMACAddress, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, license=license, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, licenseCountry=licenseCountry, licenseSFPPortSupport=licenseSFPPortSupport, sNTPServerTimeout=sNTPServerTimeout, whitelistRMMacAddress=whitelistRMMacAddress, sNTPServerTable=sNTPServerTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, alarmInstancedTable=alarmInstancedTable, hCMPMaximumLinkRange=hCMPMaximumLinkRange, phyControl=phyControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableEntry=userTableEntry, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dNSServerTableIndex=dNSServerTableIndex, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, subnetMask=subnetMask, sFPErrorTrap=sFPErrorTrap, dfsPeaks=dfsPeaks, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, mgmtInstancedTable=mgmtInstancedTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mainPSUPortStatus=mainPSUPortStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortDisabledWarning=auxPortDisabledWarning, targetRange=targetRange, targetMACAddress=targetMACAddress, wirelessOutAllOctets=wirelessOutAllOctets, cableDiagPair1Results=cableDiagPair1Results, dfsMeans=dfsMeans, auxPortAllocation=auxPortAllocation, licenseTDDSyncSupport=licenseTDDSyncSupport, sntp=sntp, blacklistRMEnabled=blacklistRMEnabled, ethernetInstancedTableNumber=ethernetInstancedTableNumber, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, packetsToInternalStack=packetsToInternalStack, gatewayIPAddress=gatewayIPAddress, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, signalStrengthRatioLinked=signalStrengthRatioLinked, sNTPState=sNTPState, packetsFromInternalStack=packetsFromInternalStack, vectorError=vectorError, searchState=searchState, tDMChannelStatus=tDMChannelStatus, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseGroupAccess=licenseGroupAccess, licenseIEEE1588Support=licenseIEEE1588Support, licenseInstancedTableIndex=licenseInstancedTableIndex, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, mABTransmissionInterval=mABTransmissionInterval, transparentClockVID=transparentClockVID, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mgmtInstancedTableIndex=mgmtInstancedTableIndex, cambium=cambium, configurationInstancedTableNumber=configurationInstancedTableNumber, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, snmpControlGroup=snmpControlGroup, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, snmpControl=snmpControl, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, cableLoss=cableLoss, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerRetries=sNTPServerRetries, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syncEEquipmentClock=syncEEquipmentClock, dNSResolver=dNSResolver, mABProtocolVLANPriority=mABProtocolVLANPriority, tdmTableNumber=tdmTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseSyncESupport=licenseSyncESupport, cableDiagnosticsResultTable=cableDiagnosticsResultTable, lowestTDMModulationMode=lowestTDMModulationMode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, routerProtocolsGroup=routerProtocolsGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, sMTPEnabledMessages=sMTPEnabledMessages, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelChangeTrap=channelChangeTrap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, mainPSUPortStatusTrap=mainPSUPortStatusTrap)
