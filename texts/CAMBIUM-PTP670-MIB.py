...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseEncryption=licenseEncryption, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, softwareVersion=softwareVersion, dNS=dNS, tDDControlGroup=tDDControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, sFPPortDisabledWarning=sFPPortDisabledWarning, auxPortConfigurationMismatch=auxPortConfigurationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, receiveFreqMHz=receiveFreqMHz, authorizationControlTableEntry=authorizationControlTableEntry, phyControl=phyControl, receiveFreqKHz=receiveFreqKHz, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, phyControlInstancedTable=phyControlInstancedTable, phyControlInstancedTableIndex=phyControlInstancedTableIndex, configurationInstancedTableNumber=configurationInstancedTableNumber, receiveModulationModeLinked=receiveModulationModeLinked, remoteInternetAddress=remoteInternetAddress, sFPErrorTrap=sFPErrorTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, aAAControl=aAAControl, hCMPMaximumLinkRange=hCMPMaximumLinkRange, tDMInterfaceStatus=tDMInterfaceStatus, lowestTDMModulationMode=lowestTDMModulationMode, transparentClockVID=transparentClockVID, ptmp=ptmp, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, licenseIEEE1588Support=licenseIEEE1588Support, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, iPDSCPPriorityTable=iPDSCPPriorityTable, severelyErroredSeconds=severelyErroredSeconds, ptp670=ptp670, installStatusTrap=installStatusTrap, nIDULanPortStatus=nIDULanPortStatus, mABState=mABState, mainPSUPortQLRx=mainPSUPortQLRx, dNSPrimaryServer=dNSPrimaryServer, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANManagementVID=vLANManagementVID, receivePowerLinked=receivePowerLinked, alarmInstancedTableNumber=alarmInstancedTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tdmTableNumber=tdmTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseIPv6Support=licenseIPv6Support, ethernetStatisticsDataSource=ethernetStatisticsDataSource, ethernetPriorityTableNumber=ethernetPriorityTableNumber, linkLossLinked=linkLossLinked, tFTPServerPortNumber=tFTPServerPortNumber, tFTPClient=tFTPClient, ethernetGroup=ethernetGroup, transparentClock=transparentClock, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sFPPortAllocation=sFPPortAllocation, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortSSMTx=sFPPortSSMTx, sFPPortSyncERxStatus=sFPPortSyncERxStatus, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, alarmInstancedTableEntry=alarmInstancedTableEntry, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sNMPTrapTableIndex=sNMPTrapTableIndex, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, dfsTable=dfsTable, licenseTrialPeriod=licenseTrialPeriod, installationMode=installationMode, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNMPTrapTable=sNMPTrapTable, channelBandwidth=channelBandwidth, sNMPTrapPortNumber=sNMPTrapPortNumber, authorizationControl=authorizationControl, dNSServerTableEntry=dNSServerTableEntry, siteName=siteName, dNSServerInternetAddressType=dNSServerInternetAddressType, licenseUnitSerialNumber=licenseUnitSerialNumber, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, lowestDataModulationMode=lowestDataModulationMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, installArmStateTrap=installArmStateTrap, transmitPowerLinked=transmitPowerLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sFPPortQLTx=sFPPortQLTx, resetGroup=resetGroup, iPv6PrefixLength=iPv6PrefixLength, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sNTPSyncTrap=sNTPSyncTrap, licenseCapacity=licenseCapacity, ethernet=ethernet, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receivePower=receivePower, sNMPv3Enable=sNMPv3Enable, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, installArmState=installArmState, mPLSTCPriorityTable=mPLSTCPriorityTable, mABProtocolVID=mABProtocolVID, qOSPriorityScheme=qOSPriorityScheme, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, whitelistRMMacAddress=whitelistRMMacAddress, packetsFromInternalStack=packetsFromInternalStack, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, transmitterChannels=transmitterChannels, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessOutOctets=wirelessOutOctets, daylightSaving=daylightSaving, ethernetInstancedTableNumber=ethernetInstancedTableNumber, dfsGroup=dfsGroup, dfsTableIndex=dfsTableIndex, cableDiagnosticsResultTable=cableDiagnosticsResultTable, receiveModulationMode=receiveModulationMode, configurationGroup=configurationGroup, tempPcb=tempPcb, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, hTTPPortNumber=hTTPPortNumber, syslogControlGroup=syslogControlGroup, secureModeAlarm=secureModeAlarm, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, phyControlGroup=phyControlGroup, cableDiagPair2Distance=cableDiagPair2Distance, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, lbtDetectedTrap=lbtDetectedTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, managementPortWirelessDownAlert=managementPortWirelessDownAlert, auxPortQLRx=auxPortQLRx, ptpTraps=ptpTraps, ethernetStatisticsTable=ethernetStatisticsTable, mABNominalTransmitCapacity=mABNominalTransmitCapacity, auxPortSyncERxStatus=auxPortSyncERxStatus, cableDiagnosticsPorts=cableDiagnosticsPorts, rangingMode=rangingMode, byteErrorRatioLinked=byteErrorRatioLinked, licenseInstancedTableEntry=licenseInstancedTableEntry, transmitModulationMode=transmitModulationMode, licenseSFPPortSupport=licenseSFPPortSupport, installStatusLinked=installStatusLinked, sNMPTrapVersion=sNMPTrapVersion, licenseBandwidthCap=licenseBandwidthCap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataBridgingStatusAlarm=dataBridgingStatusAlarm, tDMChannelStatus=tDMChannelStatus, timeZone=timeZone, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, regulatoryBand=regulatoryBand, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, licenseInstancedTableIndex=licenseInstancedTableIndex, mainPSUPortQLTx=mainPSUPortQLTx, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPEnabledMessages=sMTPEnabledMessages, authorizationMethod=authorizationMethod, telnetAccessEnabled=telnetAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, regulatoryBandTrap=regulatoryBandTrap, supplementary=supplementary, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, userTable=userTable, ethernetPriorityTable=ethernetPriorityTable, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteMACAddress=remoteMACAddress, authorizationControlTableIndex=authorizationControlTableIndex, tDMChannelStatusTrap=tDMChannelStatusTrap, tDMInterfaceControl=tDMInterfaceControl, snmpControl=snmpControl, tdmTableEntry=tdmTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, maxLinkRangeExceeded=maxLinkRangeExceeded, cableDiagPair3Results=cableDiagPair3Results, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tdmTableIndex=tdmTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableLoss=cableLoss, userTableEntry=userTableEntry, dfsTableEntry=dfsTableEntry, tdmTable=tdmTable, tDMChannelCableLength=tDMChannelCableLength, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, dNSServerTableIndex=dNSServerTableIndex, syslogState=syslogState, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, maximumTransmitPower=maximumTransmitPower, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mABProtocolVLANPriority=mABProtocolVLANPriority, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, iPVersion=iPVersion, iPv6GatewayAddress=iPv6GatewayAddress, useVLANForMABProtocol=useVLANForMABProtocol, sMTPServerPortNumber=sMTPServerPortNumber, rxColorCode=rxColorCode, transmitChannel=transmitChannel, syslogStateTrap=syslogStateTrap, sNTPServerTableEntry=sNTPServerTableEntry, syncEEquipmentClock=syncEEquipmentClock, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, configurationInstancedTableEntry=configurationInstancedTableEntry, mainPSUPortStatus=mainPSUPortStatus, auxPortStatus=auxPortStatus, eIRP=eIRP, cableDiagPair2Results=cableDiagPair2Results, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, smtpGroup=smtpGroup, bridge=bridge, maximumNumberOfSlaves=maximumNumberOfSlaves, sFPPortAutoNegotiation=sFPPortAutoNegotiation, ptpGroups=ptpGroups, transmitFreqKHz=transmitFreqKHz, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, blacklistRMMacAddress=blacklistRMMacAddress, smtp=smtp, supplementaryGroup=supplementaryGroup, signalStrengthRatioLinked=signalStrengthRatioLinked, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, cableDiagPair1Distance=cableDiagPair1Distance, userTableIndex=userTableIndex, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, bootVersion=bootVersion, masterSlaveMode=masterSlaveMode, txColorCode=txColorCode, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagPair4Distance=cableDiagPair4Distance, dfsTableNumber=dfsTableNumber, mABTransmissionInterval=mABTransmissionInterval, cambium=cambium, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseGasGroup=licenseGasGroup, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, blacklistRMEnabled=blacklistRMEnabled, hCMPLinkSymmetry=hCMPLinkSymmetry, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, auxPortDisabledWarning=auxPortDisabledWarning, systemClock=systemClock, mgmtInstancedTableNumber=mgmtInstancedTableNumber, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, phyStatusGroup=phyStatusGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetInstancedTableIndex=ethernetInstancedTableIndex, secureModeAlarmTrap=secureModeAlarmTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseIssueNumber=licenseIssueNumber, encryption=encryption, rangeLinked=rangeLinked, license=license, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPPortNumber=sNMPPortNumber, signalStrengthRatio=signalStrengthRatio, auxPortSSMTx=auxPortSSMTx, sNTPServerTable=sNTPServerTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDMChannelLineCode=tDMChannelLineCode, userRole=userRole, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, rawReceivePower=rawReceivePower, accessMethod=accessMethod, ethernetInstancedTableEntry=ethernetInstancedTableEntry, subbandHighestFrequency=subbandHighestFrequency, syncESlavePort=syncESlavePort, byteErrorRatio=byteErrorRatio, apcGroup=apcGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, receiveModulationModeDetail=receiveModulationModeDetail, licenseMaxLinkRange=licenseMaxLinkRange, telnetPortNumber=telnetPortNumber, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, systemReset=systemReset, syslogClientTrap=syslogClientTrap, sMTPEmailAlert=sMTPEmailAlert, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, targetRange=targetRange, reset=reset, PYSNMP_MODULE_ID=cambium, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, tDMEnabledChannels=tDMEnabledChannels, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, aAAControlGroup=aAAControlGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, subnetMask=subnetMask, dNSGroup=dNSGroup, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, alarmInstancedTable=alarmInstancedTable, sntpGroup=sntpGroup, managementGroup=managementGroup, licenseInstancedTable=licenseInstancedTable, hTTPSPortNumber=hTTPSPortNumber, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, userEnabled=userEnabled, capacityVariantMismatchLinked=capacityVariantMismatchLinked, dSCPManagementPriority=dSCPManagementPriority, installStatus=installStatus, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tDDSynchronizationStatus=tDDSynchronizationStatus, mABMaintenanceLevel=mABMaintenanceLevel, licenseSecurityLevel=licenseSecurityLevel, antennaGain=antennaGain, sFPPortStatus=sFPPortStatus, authorizationControlTable=authorizationControlTable, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, wirelessOutAllOctets=wirelessOutAllOctets, alarmsGroup=alarmsGroup, phyControlInstancedTableEntry=phyControlInstancedTableEntry, cableDiagnosticsControl=cableDiagnosticsControl, mgmtInstancedTableIndex=mgmtInstancedTableIndex, tDMConfigurationMismatch=tDMConfigurationMismatch, cableDiagnosticsWarning=cableDiagnosticsWarning, dNSServerTableNumber=dNSServerTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, ptp=ptp, apc=apc, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteUnitNameLinked=remoteUnitNameLinked, longitude=longitude, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, dNSServerPortNumber=dNSServerPortNumber, sNTPPollInterval=sNTPPollInterval, sNTPSync=sNTPSync, licenseGroupAccess=licenseGroupAccess, notificationsGroup=notificationsGroup, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, tDDControl=tDDControl, transparentClockPort=transparentClockPort, snmpControlGroup=snmpControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, targetMACAddress=targetMACAddress, productName=productName, linkLoss=linkLoss, remoteMACAddressLinked=remoteMACAddressLinked, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetInstancedTable=ethernetInstancedTable, mgmtInstancedTableEntry=mgmtInstancedTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkName=linkName, authorizationControlTableNumber=authorizationControlTableNumber, sNTPServerTimeout=sNTPServerTimeout, dNSResolver=dNSResolver, erroredSeconds=erroredSeconds, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNTPServerRetries=sNTPServerRetries, ptpTrapPrefix=ptpTrapPrefix, syncETrackingState=syncETrackingState, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, capacityVariantMismatchTrap=capacityVariantMismatchTrap, deviceMSN=deviceMSN, subbandLowestFrequency=subbandLowestFrequency, receiveDataRateLinked=receiveDataRateLinked, sNTPPrimaryServer=sNTPPrimaryServer, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, linkSymmetry=linkSymmetry, userPassword=userPassword, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, alarmInstancedTableIndex=alarmInstancedTableIndex, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, routerProtocolsGroup=routerProtocolsGroup, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, transmitFreqMHz=transmitFreqMHz, auxPortStatusTrap=auxPortStatusTrap, mABHoldoffPeriod=mABHoldoffPeriod, cableDiagPair1Results=cableDiagPair1Results, configurationInstancedTable=configurationInstancedTable, auxPortQLTx=auxPortQLTx, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, routerProtocols=routerProtocols, whitelistRMEnabled=whitelistRMEnabled, transmitDataRate=transmitDataRate, auxPortAllocation=auxPortAllocation, pubStatsGroup=pubStatsGroup, sNTPServerTableNumber=sNTPServerTableNumber, vectorError=vectorError, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseRARSupport=licenseRARSupport, dataBridgingStatusLinked=dataBridgingStatusLinked, sNTPServerPortNumber=sNTPServerPortNumber, syslogClient=syslogClient, phyStatus=phyStatus, syslogControl=syslogControl, licenseGroup=licenseGroup, unitName=unitName, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, licenseSyncESupport=licenseSyncESupport, hardwareVersion=hardwareVersion, sFPPortStatusTrap=sFPPortStatusTrap, remoteInternetAddressType=remoteInternetAddressType, authorizationControlGroup=authorizationControlGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, pubInstancedStatsTable=pubInstancedStatsTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenseInstancedTableNumber=licenseInstancedTableNumber, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, hTTPAccessEnabled=hTTPAccessEnabled, wirelessTopology=wirelessTopology, tDM=tDM, receiveDataRate=receiveDataRate, sNTPState=sNTPState, mgmtInstancedTable=mgmtInstancedTable, sNMPTrapTableNumber=sNMPTrapTableNumber, dataBridgingStatus=dataBridgingStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, encryptionGroup=encryptionGroup, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, tDMChannelLoopback=tDMChannelLoopback, tDDSynchronizationMode=tDDSynchronizationMode, latitude=latitude, unitOutOfCalibration=unitOutOfCalibration, sNMPCommunityString=sNMPCommunityString, hTTPSAccessEnabled=hTTPSAccessEnabled, sntp=sntp, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, groupID=groupID, wirelessLinkStatus=wirelessLinkStatus, aggregateDataRate=aggregateDataRate, dataBridgingAvailability=dataBridgingAvailability, portAllocationMismatchTrap=portAllocationMismatchTrap, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, dataPortPauseFrames=dataPortPauseFrames, cableDiagnosticsGroup=cableDiagnosticsGroup, dNSServerTable=dNSServerTable, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseHCMPSupport=licenseHCMPSupport, userTableNumber=userTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, deviceMACAddress=deviceMACAddress, transmitDataRateLinked=transmitDataRateLinked, cableDiagnostics=cableDiagnostics, frequencyVariant=frequencyVariant, nIDULanPortAutoMdix=nIDULanPortAutoMdix, licenseTDDSyncSupport=licenseTDDSyncSupport, ethernetPriorityTableEntry=ethernetPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, managementNetworkAccessEnabled=managementNetworkAccessEnabled, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, encryptionAlgorithm=encryptionAlgorithm, phyInstancedStatusTable=phyInstancedStatusTable, dfsMeans=dfsMeans, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sFPPortAutoMdix=sFPPortAutoMdix, auxPortAcceptedQLRx=auxPortAcceptedQLRx, versionsGroup=versionsGroup, range=range, dNSServerInternetAddress=dNSServerInternetAddress, extendedSpectrumScanning=extendedSpectrumScanning, l2CPPriorityTable=l2CPPriorityTable, sNTPServerTableIndex=sNTPServerTableIndex, iPv4Address=iPv4Address, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, unitIdentificationGroup=unitIdentificationGroup, syncETracking=syncETracking, sFPPortQLRx=sFPPortQLRx, aggregateDataRateLinked=aggregateDataRateLinked, channelChangeTrap=channelChangeTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, localPacketFiltering=localPacketFiltering, sFPError=sFPError, vectorErrorLinked=vectorErrorLinked, sNTPServerStatus=sNTPServerStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, txMABFrames=txMABFrames, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, management=management, alarms=alarms, bridgeGroup=bridgeGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, configuration=configuration, userName=userName, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, vLANManagementPriority=vLANManagementPriority, wirelessLinkStatusLinked=wirelessLinkStatusLinked, transmitPower=transmitPower, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, transmitModulationModeLinked=transmitModulationModeLinked, mABNominalModulationMode=mABNominalModulationMode, altitude=altitude, iPv6Address=iPv6Address, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, oOBPriorityQueueMapping=oOBPriorityQueueMapping, mainPSUPortSSMTx=mainPSUPortSSMTx, productVariant=productVariant, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, licenseCountry=licenseCountry, capacityVariantMismatch=capacityVariantMismatch, ptpCompliance=ptpCompliance, unitIdentification=unitIdentification, unavailableSeconds=unavailableSeconds, cableDiagPair4Results=cableDiagPair4Results, versions=versions, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sMTPServerInternetAddress=sMTPServerInternetAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dfsPeaks=dfsPeaks, searchState=searchState, searchStateLinked=searchStateLinked, sNTPLastSync=sNTPLastSync, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseVersion=licenseVersion, linkModeOptimization=linkModeOptimization, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licenseTLSRekey=licenseTLSRekey, rawReceivePowerLinked=rawReceivePowerLinked, portAllocationMismatch=portAllocationMismatch, deviceESN=deviceESN, dfs=dfs, remoteUnitName=remoteUnitName, licenseOOBManagementSupport=licenseOOBManagementSupport, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveChannel=receiveChannel, portAllocationMismatchLinked=portAllocationMismatchLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessOutEthernetOctets=wirelessOutEthernetOctets, enableTransmission=enableTransmission, packetsToInternalStack=packetsToInternalStack, antennaSelection=antennaSelection, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, transparentClockVLAN=transparentClockVLAN, cableDiagPair3Distance=cableDiagPair3Distance, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDMGroup=tDMGroup, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles)
