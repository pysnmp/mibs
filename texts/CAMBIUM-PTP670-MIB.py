...
ModuleIdentity, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Bits, Gauge32, Unsigned32, MibIdentifier, NotificationType, iso, ObjectIdentity, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Bits", "Gauge32", "Unsigned32", "MibIdentifier", "NotificationType", "iso", "ObjectIdentity", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, ptpTraps=ptpTraps, severelyErroredSeconds=severelyErroredSeconds, l2CPPriorityTableIndex=l2CPPriorityTableIndex, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, dNSServerInternetAddress=dNSServerInternetAddress, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, authorizationControl=authorizationControl, licenseGroup=licenseGroup, aAAControl=aAAControl, sFPPortQLTx=sFPPortQLTx, portAllocationMismatchLinked=portAllocationMismatchLinked, licenseSyncESupport=licenseSyncESupport, sNTPServerPortNumber=sNTPServerPortNumber, dataBridgingAvailability=dataBridgingAvailability, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryption=encryption, subnetMask=subnetMask, rxColorCode=rxColorCode, licenseGroupAccess=licenseGroupAccess, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sntpGroup=sntpGroup, licenseCapacity=licenseCapacity, dfsTableNumber=dfsTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, authorizationControlGroup=authorizationControlGroup, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, unitIdentification=unitIdentification, dNSServerTableEntry=dNSServerTableEntry, subbandLowestFrequency=subbandLowestFrequency, cableDiagnosticsControl=cableDiagnosticsControl, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, transmitChannel=transmitChannel, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, iPv6Address=iPv6Address, pubStats=pubStats, mABProtocolVID=mABProtocolVID, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, byteErrorRatio=byteErrorRatio, tDMChannelLineCode=tDMChannelLineCode, resetGroup=resetGroup, sFPPortStatus=sFPPortStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mgmtInstancedTableNumber=mgmtInstancedTableNumber, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, bridge=bridge, dNSGroup=dNSGroup, sFPError=sFPError, sMTPEmailAlert=sMTPEmailAlert, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, configurationGroup=configurationGroup, tDMChannelCableLength=tDMChannelCableLength, configurationInstancedTableNumber=configurationInstancedTableNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortSSMTx=sFPPortSSMTx, telnetPortNumber=telnetPortNumber, localPacketFiltering=localPacketFiltering, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseTrialPeriod=licenseTrialPeriod, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, maxLinkRangeExceeded=maxLinkRangeExceeded, transmitModulationMode=transmitModulationMode, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, iPv4Address=iPv4Address, sFPPortAutoMdix=sFPPortAutoMdix, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, vLANManagementPriority=vLANManagementPriority, receiveModulationModeLinked=receiveModulationModeLinked, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, phyControlInstancedTable=phyControlInstancedTable, syslogState=syslogState, nIDULanPortAutoMdix=nIDULanPortAutoMdix, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, latitude=latitude, licenseUnitSerialNumber=licenseUnitSerialNumber, sNTPServerTableIndex=sNTPServerTableIndex, ethernetPriorityTable=ethernetPriorityTable, installStatusTrap=installStatusTrap, systemClock=systemClock, txColorCode=txColorCode, ptmp=ptmp, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, cableDiagnosticsGroup=cableDiagnosticsGroup, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, targetRange=targetRange, altitude=altitude, dSCPManagementPriority=dSCPManagementPriority, erroredSeconds=erroredSeconds, licenseInstancedTableEntry=licenseInstancedTableEntry, phyStatusGroup=phyStatusGroup, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNMPCommunityString=sNMPCommunityString, syncETrackingState=syncETrackingState, tDMChannelStatus=tDMChannelStatus, phyControlGroup=phyControlGroup, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, wirelessOutAllOctets=wirelessOutAllOctets, iPVersion=iPVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, transmitDataRate=transmitDataRate, license=license, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, mABTransmissionInterval=mABTransmissionInterval, ethernetStatisticsDataSource=ethernetStatisticsDataSource, receivePower=receivePower, extendedSpectrumScanning=extendedSpectrumScanning, auxPortStatusTrap=auxPortStatusTrap, cableDiagPair2Results=cableDiagPair2Results, mainPSUPortStatus=mainPSUPortStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, apc=apc, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, transmitModulationModeLinked=transmitModulationModeLinked, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sFPPortDisabledWarning=sFPPortDisabledWarning, accessMethod=accessMethod, wirelessOutOctets=wirelessOutOctets, byteErrorRatioLinked=byteErrorRatioLinked, sNMPTrapVersion=sNMPTrapVersion, authorizationControlTableIndex=authorizationControlTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, tempPcb=tempPcb, encryptionGroup=encryptionGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, hCMPMaximumLinkRange=hCMPMaximumLinkRange, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, lowestDataModulationMode=lowestDataModulationMode, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseIssueNumber=licenseIssueNumber, remoteInternetAddressLinked=remoteInternetAddressLinked, ethernetInstancedTableIndex=ethernetInstancedTableIndex, syslogControl=syslogControl, l2CPPriorityTable=l2CPPriorityTable, blacklistRMMacAddress=blacklistRMMacAddress, sNTPLastSync=sNTPLastSync, authorizationControlTable=authorizationControlTable, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, syslogStateTrap=syslogStateTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mainPSUPortAutoMdix=mainPSUPortAutoMdix, alarmsGroup=alarmsGroup, transmitDataRateLinked=transmitDataRateLinked, mABHoldoffPeriod=mABHoldoffPeriod, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEnabledMessages=sMTPEnabledMessages, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseSFPPortSupport=licenseSFPPortSupport, tdmTableEntry=tdmTableEntry, packetsFromInternalStack=packetsFromInternalStack, phyStatus=phyStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, syncESlavePort=syncESlavePort, linkLoss=linkLoss, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, userRole=userRole, configurationInstancedTable=configurationInstancedTable, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tdmTableNumber=tdmTableNumber, licenseRARSupport=licenseRARSupport, userEnabled=userEnabled, licenseGasGroup=licenseGasGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, auxPortQLRx=auxPortQLRx, timeZone=timeZone, licenseCountry=licenseCountry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, txMABFrames=txMABFrames, dNS=dNS, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, syslogClient=syslogClient, ptpCompliance=ptpCompliance, wirelessTopology=wirelessTopology, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, userTableNumber=userTableNumber, supplementary=supplementary, installStatusLinked=installStatusLinked, receivePowerLinked=receivePowerLinked, maximumNumberOfSlaves=maximumNumberOfSlaves, whitelistRMMacAddress=whitelistRMMacAddress, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, ptpGroups=ptpGroups, syncETracking=syncETracking, noWirelessChannelAvailable=noWirelessChannelAvailable, capacityVariantMismatch=capacityVariantMismatch, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveFreqKHz=receiveFreqKHz, auxPortSSMTx=auxPortSSMTx, auxPortConfigurationMismatch=auxPortConfigurationMismatch, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, receiveDataRate=receiveDataRate, ethernetGroup=ethernetGroup, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, dfsPeaks=dfsPeaks, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, nIDULanPortStatus=nIDULanPortStatus, installArmState=installArmState, remoteMACAddress=remoteMACAddress, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, authorizationControlTableEntry=authorizationControlTableEntry, systemReset=systemReset, licenseInstancedTable=licenseInstancedTable, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, vectorError=vectorError, tDDSynchronizationMode=tDDSynchronizationMode, portAllocationMismatchTrap=portAllocationMismatchTrap, sFPErrorTrap=sFPErrorTrap, alarmInstancedTableNumber=alarmInstancedTableNumber, groupID=groupID, reset=reset, cambium=cambium, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, aAAControlGroup=aAAControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, transparentClockVID=transparentClockVID, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, authorizationMethod=authorizationMethod, sNTPServerTable=sNTPServerTable, mPLSTCPriorityTable=mPLSTCPriorityTable, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mgmtInstancedTable=mgmtInstancedTable, remoteUnitNameLinked=remoteUnitNameLinked, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortAllocation=sFPPortAllocation)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", regulatoryBand=regulatoryBand, iPv6PrefixLength=iPv6PrefixLength, configurationInstancedTableEntry=configurationInstancedTableEntry, dfsGroup=dfsGroup, productVariant=productVariant, cableDiagPair4Distance=cableDiagPair4Distance, receiveDataRateLinked=receiveDataRateLinked, antennaGain=antennaGain, phyControlInstancedTableIndex=phyControlInstancedTableIndex, versionsGroup=versionsGroup, sntp=sntp, dNSPrimaryServer=dNSPrimaryServer, licenseHCMPSupport=licenseHCMPSupport, tDMEnabledChannels=tDMEnabledChannels, aggregateDataRate=aggregateDataRate, tdmTable=tdmTable, auxPortSyncERxStatus=auxPortSyncERxStatus, regulatoryBandTrap=regulatoryBandTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, auxPortDisabledWarning=auxPortDisabledWarning, ethernet=ethernet, frequencyVariant=frequencyVariant, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sNTPServerTableEntry=sNTPServerTableEntry, userName=userName, softwareVersion=softwareVersion, vLANManagementVID=vLANManagementVID, userTableEntry=userTableEntry, dNSResolver=dNSResolver, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sNTPState=sNTPState, ethernetStatisticsTable=ethernetStatisticsTable, userTableIndex=userTableIndex, mABState=mABState, cableDiagPair4Results=cableDiagPair4Results, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseVersion=licenseVersion, hTTPAccessEnabled=hTTPAccessEnabled, enabledDiagnosticAlarms=enabledDiagnosticAlarms, subbandHighestFrequency=subbandHighestFrequency, auxPortStatus=auxPortStatus, dataBridgingStatusAlarm=dataBridgingStatusAlarm, transparentClockVLAN=transparentClockVLAN, syslogClientTrap=syslogClientTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mainPSUPortQLTx=mainPSUPortQLTx, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transparentClock=transparentClock, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, linkName=linkName, pubInstancedStatsTable=pubInstancedStatsTable, mainPSUPortAllocation=mainPSUPortAllocation, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, bridgeGroup=bridgeGroup, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, telnetAccessEnabled=telnetAccessEnabled, dfsTable=dfsTable, mainPSUPortStatusTrap=mainPSUPortStatusTrap, transmitFreqKHz=transmitFreqKHz, portAllocationMismatch=portAllocationMismatch, auxPortAllocation=auxPortAllocation, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPSync=sNTPSync, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sFPPortStatusTrap=sFPPortStatusTrap, tFTPClient=tFTPClient, oOBPriorityQueueMapping=oOBPriorityQueueMapping, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseInstancedTableNumber=licenseInstancedTableNumber, enableTransmission=enableTransmission, tDMChannelLoopback=tDMChannelLoopback, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aggregateDataRateLinked=aggregateDataRateLinked, dNSServerTable=dNSServerTable, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNMPTrapTableNumber=sNMPTrapTableNumber, useVLANForMABProtocol=useVLANForMABProtocol, smtpGroup=smtpGroup, cableDiagPair3Results=cableDiagPair3Results, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dNSServerPortNumber=dNSServerPortNumber, unitName=unitName, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, masterSlaveMode=masterSlaveMode, signalStrengthRatio=signalStrengthRatio, searchStateLinked=searchStateLinked, licenseIPv6Support=licenseIPv6Support, mgmtInstancedTableEntry=mgmtInstancedTableEntry, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseTLSRekey=licenseTLSRekey, cableDiagPair3Distance=cableDiagPair3Distance, ethernetInstancedTableNumber=ethernetInstancedTableNumber, daylightSaving=daylightSaving, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, range=range, alarms=alarms, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, longitude=longitude, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfs=dfs, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, dfsTableIndex=dfsTableIndex, ptpTrapPrefix=ptpTrapPrefix, sNMPEnabledTraps=sNMPEnabledTraps, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, unitIdentificationGroup=unitIdentificationGroup, rangeLinked=rangeLinked, licenseOOBManagementSupport=licenseOOBManagementSupport, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, packetsToInternalStack=packetsToInternalStack, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseEncryption=licenseEncryption, phyControl=phyControl, auxPortQLTx=auxPortQLTx, userPassword=userPassword, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteInternetAddressType=remoteInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, wirelessLinkAvailability=wirelessLinkAvailability, notificationsGroup=notificationsGroup, supplementaryGroup=supplementaryGroup, siteName=siteName, cableDiagPair2Distance=cableDiagPair2Distance, signalStrengthRatioLinked=signalStrengthRatioLinked, dNSServerTableNumber=dNSServerTableNumber, searchState=searchState, configuration=configuration, receiveModulationMode=receiveModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, cableDiagPair1Results=cableDiagPair1Results, mABNominalTransmitCapacity=mABNominalTransmitCapacity, transmitterChannels=transmitterChannels, PYSNMP_MODULE_ID=cambium, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, installArmStateTrap=installArmStateTrap, rawReceivePower=rawReceivePower, tFTPServerInternetAddressType=tFTPServerInternetAddressType, lbtDetectedTrap=lbtDetectedTrap, apcGroup=apcGroup, alarmInstancedTableIndex=alarmInstancedTableIndex, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, blacklistRMEnabled=blacklistRMEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dNSServerTableIndex=dNSServerTableIndex, managementGroup=managementGroup, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sMTPServerPortNumber=sMTPServerPortNumber, tDM=tDM, phyInstancedStatusTable=phyInstancedStatusTable, ptp670=ptp670, installStatus=installStatus, authorizationControlTableNumber=authorizationControlTableNumber, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptp=ptp, tDDControl=tDDControl, tDMInterfaceStatus=tDMInterfaceStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, linkSymmetry=linkSymmetry, tdmTableIndex=tdmTableIndex, wirelessLinkStatus=wirelessLinkStatus, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, dfsMeans=dfsMeans, transmitPowerLinked=transmitPowerLinked, syncEEquipmentClock=syncEEquipmentClock, sNTPPrimaryServer=sNTPPrimaryServer, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDMGroup=tDMGroup, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, remoteUnitName=remoteUnitName, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseSecurityLevel=licenseSecurityLevel, deviceESN=deviceESN, linkLossLinked=linkLossLinked, wirelessLinkStatusLinked=wirelessLinkStatusLinked, syslogControlGroup=syslogControlGroup, snmpControlGroup=snmpControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, versions=versions, routerProtocolsGroup=routerProtocolsGroup, remoteInternetAddress=remoteInternetAddress, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, secureModeAlarmTrap=secureModeAlarmTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mABMaintenanceLevel=mABMaintenanceLevel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, configurationInstancedTableIndex=configurationInstancedTableIndex, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, ethernetInstancedTableEntry=ethernetInstancedTableEntry, secureModeAlarm=secureModeAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, whitelistRMEnabled=whitelistRMEnabled, licenseIEEE1588Support=licenseIEEE1588Support, bootVersion=bootVersion, mainPSUPortQLRx=mainPSUPortQLRx, dataPortPauseFrames=dataPortPauseFrames, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, receiveFreqMHz=receiveFreqMHz, deviceMACAddress=deviceMACAddress, cableDiagPair1Distance=cableDiagPair1Distance, hardwareVersion=hardwareVersion, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseMaxLinkRange=licenseMaxLinkRange, installationMode=installationMode, eIRP=eIRP, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, gatewayIPAddress=gatewayIPAddress, wirelessOutEthernetOctets=wirelessOutEthernetOctets, iPDSCPPriorityTable=iPDSCPPriorityTable, dataBridgingStatus=dataBridgingStatus, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagnostics=cableDiagnostics, rangingMode=rangingMode, lowestTDMModulationMode=lowestTDMModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, rawReceivePowerLinked=rawReceivePowerLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dfsTableEntry=dfsTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", encryptionAlgorithm=encryptionAlgorithm, antennaSelection=antennaSelection, sFPPortQLRx=sFPPortQLRx, tDMInterfaceControl=tDMInterfaceControl, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, transmitFreqMHz=transmitFreqMHz, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, unavailableSeconds=unavailableSeconds, sNTPServerRetries=sNTPServerRetries, routerProtocols=routerProtocols, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mainPSUPortSSMTx=mainPSUPortSSMTx, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, snmpControl=snmpControl, ethernetInstancedTable=ethernetInstancedTable, cableDiagnosticsResultTable=cableDiagnosticsResultTable, remoteMACAddressLinked=remoteMACAddressLinked, mABNominalModulationMode=mABNominalModulationMode, dataBridgingStatusLinked=dataBridgingStatusLinked, sNTPServerTimeout=sNTPServerTimeout, receiveChannel=receiveChannel, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tDDControlGroup=tDDControlGroup, management=management, sNMPv3Enable=sNMPv3Enable, capacityVariantMismatchTrap=capacityVariantMismatchTrap, maximumTransmitPower=maximumTransmitPower, productName=productName, vectorErrorLinked=vectorErrorLinked, deviceMSN=deviceMSN, cableLoss=cableLoss, smtp=smtp, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, channelBandwidth=channelBandwidth, sNTPPollInterval=sNTPPollInterval, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, userTable=userTable, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, qOSPriorityScheme=qOSPriorityScheme, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mABProtocolVLANPriority=mABProtocolVLANPriority, cableDiagnosticsPorts=cableDiagnosticsPorts, linkModeOptimization=linkModeOptimization, targetMACAddress=targetMACAddress, sNTPServerStatus=sNTPServerStatus, transmitPower=transmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseBandwidthCap=licenseBandwidthCap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, channelChangeTrap=channelChangeTrap, pubStatsGroup=pubStatsGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseInstancedTableIndex=licenseInstancedTableIndex, sNMPTrapTable=sNMPTrapTable, alarmInstancedTable=alarmInstancedTable, transparentClockPort=transparentClockPort, licenseRegulatoryBandsList=licenseRegulatoryBandsList, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup)
