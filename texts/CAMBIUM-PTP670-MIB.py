...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", byteErrorRatioLinked=byteErrorRatioLinked, sNTPServerStatus=sNTPServerStatus, receiveModulationModeDetail=receiveModulationModeDetail, receiveFreqMHz=receiveFreqMHz, blacklistRMEnabled=blacklistRMEnabled, tDMConfigurationMismatch=tDMConfigurationMismatch, cableDiagPair2Distance=cableDiagPair2Distance, auxPortAcceptedQLRx=auxPortAcceptedQLRx, l2CPPriorityTableNumber=l2CPPriorityTableNumber, receivePower=receivePower, cableDiagnosticsGroup=cableDiagnosticsGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, license=license, routerProtocols=routerProtocols, configuration=configuration, phyStatusGroup=phyStatusGroup, packetsFromInternalStack=packetsFromInternalStack, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsMeans=dfsMeans, sFPPortStatusTrap=sFPPortStatusTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tDMChannelCableLength=tDMChannelCableLength, unitOutOfCalibration=unitOutOfCalibration, eIRP=eIRP, transparentClockVLAN=transparentClockVLAN, dfsTableIndex=dfsTableIndex, tDMGroup=tDMGroup, sNTPServerTimeout=sNTPServerTimeout, cableDiagPair1Distance=cableDiagPair1Distance, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, transmitChannel=transmitChannel, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, phyControlInstancedTableEntry=phyControlInstancedTableEntry, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, productName=productName, sNMPTrapTable=sNMPTrapTable, portAllocationMismatchTrap=portAllocationMismatchTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, ptpCompliance=ptpCompliance, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, auxPortAllocation=auxPortAllocation, lowestDataModulationMode=lowestDataModulationMode, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseGroup=licenseGroup, mABState=mABState, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, mainPSUPortSSMTx=mainPSUPortSSMTx, installArmState=installArmState, sFPError=sFPError, snmpControlGroup=snmpControlGroup, alarmInstancedTableEntry=alarmInstancedTableEntry, bootVersion=bootVersion, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mABTransmissionInterval=mABTransmissionInterval, configurationGroup=configurationGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, tDMChannelStatus=tDMChannelStatus, receiveModulationMode=receiveModulationMode, targetRange=targetRange, transmitPowerLinked=transmitPowerLinked, wirelessOutAllOctets=wirelessOutAllOctets, phyControlInstancedTableNumber=phyControlInstancedTableNumber, secureModeAlarm=secureModeAlarm, licenseTrialPeriod=licenseTrialPeriod, linkLossLinked=linkLossLinked, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, remoteUnitNameLinked=remoteUnitNameLinked, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernetInstancedTableNumber=ethernetInstancedTableNumber, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, mainPSUPortAutoMdix=mainPSUPortAutoMdix, wirelessOutOctets=wirelessOutOctets, licenseInstancedTableNumber=licenseInstancedTableNumber, dNSResolver=dNSResolver, searchState=searchState, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, syslogClientTrap=syslogClientTrap, tDM=tDM, dataBridgingAvailability=dataBridgingAvailability, tDDSynchronizationMode=tDDSynchronizationMode, secondarySoftwareVersion=secondarySoftwareVersion, maxLinkRangeExceeded=maxLinkRangeExceeded, unavailableSeconds=unavailableSeconds, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tDDControlGroup=tDDControlGroup, tdmTableIndex=tdmTableIndex, userEnabled=userEnabled, severelyErroredSeconds=severelyErroredSeconds, tDMChannelLineCode=tDMChannelLineCode, authorizationControlTable=authorizationControlTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptmp=ptmp, licenseEncryption=licenseEncryption, linkModeOptimization=linkModeOptimization, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, auxPortSSMTx=auxPortSSMTx, dNSServerTableEntry=dNSServerTableEntry, ethernetInstancedTableIndex=ethernetInstancedTableIndex, PYSNMP_MODULE_ID=cambium, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mainPSUPortQLRx=mainPSUPortQLRx, systemClock=systemClock, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseInstancedTableIndex=licenseInstancedTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, managementPortWirelessDownAlert=managementPortWirelessDownAlert, aggregateDataRate=aggregateDataRate, dataPortPauseFrames=dataPortPauseFrames, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, lowestTDMModulationMode=lowestTDMModulationMode, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mainPSUPortAllocation=mainPSUPortAllocation, authorizationControl=authorizationControl, cableDiagPair3Results=cableDiagPair3Results, dNSServerTableNumber=dNSServerTableNumber, syncESlavePort=syncESlavePort, licenseRARSupport=licenseRARSupport, hTTPSAccessEnabled=hTTPSAccessEnabled, masterSlaveMode=masterSlaveMode, cableDiagnosticsWarning=cableDiagnosticsWarning, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseSyncESupport=licenseSyncESupport, tDMEnabledChannels=tDMEnabledChannels, remoteInternetAddressLinked=remoteInternetAddressLinked, iPDSCPPriorityTable=iPDSCPPriorityTable, smtpGroup=smtpGroup, sFPPortSSMTx=sFPPortSSMTx, mPLSTCPriorityTable=mPLSTCPriorityTable, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, encryptionGroup=encryptionGroup, dNS=dNS, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, auxPortConfigurationMismatch=auxPortConfigurationMismatch, gatewayIPAddress=gatewayIPAddress, vLANManagementVID=vLANManagementVID, hCMPLinkSymmetry=hCMPLinkSymmetry, dNSServerPortNumber=dNSServerPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTableEntry=sNTPServerTableEntry, timeZone=timeZone, antennaSelection=antennaSelection, ptpTraps=ptpTraps, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, l2CPPriorityTable=l2CPPriorityTable, installArmStateTrap=installArmStateTrap, telnetAccessEnabled=telnetAccessEnabled, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ptp670=ptp670, extendedSpectrumScanning=extendedSpectrumScanning, ethernetStatisticsTable=ethernetStatisticsTable, rangeLinked=rangeLinked, sFPPortStatus=sFPPortStatus, cableDiagnosticsPorts=cableDiagnosticsPorts, sntpGroup=sntpGroup, linkName=linkName, dfsGroup=dfsGroup, syslogControlGroup=syslogControlGroup, transmitterChannels=transmitterChannels, ethernetInstancedTableEntry=ethernetInstancedTableEntry, tDMChannelLoopback=tDMChannelLoopback, transparentClockVID=transparentClockVID, transmitModulationModeLinked=transmitModulationModeLinked, encryptionAlgorithm=encryptionAlgorithm, apcGroup=apcGroup, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sNMPTrapTableIndex=sNMPTrapTableIndex, tdmTableEntry=tdmTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableNumber=userTableNumber, notificationsGroup=notificationsGroup, linkLoss=linkLoss, sNTPSyncTrap=sNTPSyncTrap, hardwareVersion=hardwareVersion, alarms=alarms, maximumTransmitPower=maximumTransmitPower, licenseUnitSerialNumber=licenseUnitSerialNumber, dfs=dfs, licenseMaxLinkRange=licenseMaxLinkRange, transmitDataRateLinked=transmitDataRateLinked, licenseIEEE1588Support=licenseIEEE1588Support, phyControlInstancedTable=phyControlInstancedTable, rxColorCode=rxColorCode, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sMTPEmailAlert=sMTPEmailAlert, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, transparentClockPort=transparentClockPort, signalStrengthRatioLinked=signalStrengthRatioLinked, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receiveModulationModeLinked=receiveModulationModeLinked, phyControl=phyControl, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, qOSPriorityScheme=qOSPriorityScheme, mABNominalModulationMode=mABNominalModulationMode, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, syslogStateTrap=syslogStateTrap, productVariant=productVariant, cableDiagPair3Distance=cableDiagPair3Distance, antennaGain=antennaGain, sFPPortAllocation=sFPPortAllocation, dfsTable=dfsTable, ethernetStatisticsDataSource=ethernetStatisticsDataSource, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, configurationInstancedTable=configurationInstancedTable, sNTPServerRetries=sNTPServerRetries, installStatusLinked=installStatusLinked, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, cableDiagnostics=cableDiagnostics, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, auxPortStatus=auxPortStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, targetMACAddress=targetMACAddress, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPLastSync=sNTPLastSync, deviceMACAddress=deviceMACAddress, altitude=altitude, dNSServerInternetAddressType=dNSServerInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, signalStrengthRatio=signalStrengthRatio, sNTPServerPortNumber=sNTPServerPortNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, authorizationMethod=authorizationMethod, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, authorizationControlTableIndex=authorizationControlTableIndex, licenseOOBManagementSupport=licenseOOBManagementSupport, sNMPEnabledTraps=sNMPEnabledTraps, configurationInstancedTableNumber=configurationInstancedTableNumber, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, ptp=ptp, hTTPSPortNumber=hTTPSPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, sFPPortQLRx=sFPPortQLRx, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, versionsGroup=versionsGroup, userPassword=userPassword, packetsToInternalStack=packetsToInternalStack, wirelessOutEthernetOctets=wirelessOutEthernetOctets, accessMethod=accessMethod, apc=apc)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", pubStatsGroup=pubStatsGroup, receiveChannel=receiveChannel, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sFPPortQLTx=sFPPortQLTx, receiveDataRateLinked=receiveDataRateLinked, cableDiagPair1Results=cableDiagPair1Results, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, regulatoryBandTrap=regulatoryBandTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, sNTPState=sNTPState, licenseHCMPSupport=licenseHCMPSupport, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, supplementaryGroup=supplementaryGroup, tDDControl=tDDControl, l2CPPriorityTableIndex=l2CPPriorityTableIndex, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, managementGroup=managementGroup, userTableIndex=userTableIndex, installStatus=installStatus, rawReceivePowerLinked=rawReceivePowerLinked, alarmInstancedTableNumber=alarmInstancedTableNumber, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, daylightSaving=daylightSaving, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, snmpControl=snmpControl, txColorCode=txColorCode, erroredSeconds=erroredSeconds, cableLoss=cableLoss, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, hCMPMaximumLinkRange=hCMPMaximumLinkRange, dataBridgingStatusAlarm=dataBridgingStatusAlarm, authorizationControlGroup=authorizationControlGroup, licenseGasGroup=licenseGasGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, management=management, mABMaintenanceLevel=mABMaintenanceLevel, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tempPcb=tempPcb, tDDSynchronizationStatus=tDDSynchronizationStatus, phyInstancedStatusTable=phyInstancedStatusTable, unitName=unitName, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, bridge=bridge, maximumNumberOfSlaves=maximumNumberOfSlaves, vectorErrorLinked=vectorErrorLinked, tdmTableNumber=tdmTableNumber, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, unitIdentificationGroup=unitIdentificationGroup, receiveFreqKHz=receiveFreqKHz, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mainPSUPortStatus=mainPSUPortStatus, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNTPPollInterval=sNTPPollInterval, cableDiagPair4Results=cableDiagPair4Results, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseSFPPortSupport=licenseSFPPortSupport, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitFreqKHz=transmitFreqKHz, userTableEntry=userTableEntry, mABHoldoffPeriod=mABHoldoffPeriod, txMABFrames=txMABFrames, remoteUnitName=remoteUnitName, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, dfsTableNumber=dfsTableNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, syncETrackingState=syncETrackingState, sntp=sntp, transmitFreqMHz=transmitFreqMHz, sFPPortAutoMdix=sFPPortAutoMdix, whitelistRMMacAddress=whitelistRMMacAddress, resetGroup=resetGroup, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, authorizationControlTableEntry=authorizationControlTableEntry, sNMPPortNumber=sNMPPortNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, cableDiagnosticsControl=cableDiagnosticsControl, sNMPv3Enable=sNMPv3Enable, licenseSecurityLevel=licenseSecurityLevel, wirelessTopology=wirelessTopology, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tFTPClient=tFTPClient, installStatusTrap=installStatusTrap, smtp=smtp, latitude=latitude, remoteMACAddress=remoteMACAddress, ethernetGroup=ethernetGroup, auxPortQLRx=auxPortQLRx, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, dataBridgingStatusLinked=dataBridgingStatusLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPv4Address=iPv4Address, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, remoteInternetAddress=remoteInternetAddress, sNTPServerTable=sNTPServerTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, lbtDetectedTrap=lbtDetectedTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, dfsTableEntry=dfsTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, configurationInstancedTableEntry=configurationInstancedTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, syslogState=syslogState, installationMode=installationMode, versions=versions, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNTPPrimaryServer=sNTPPrimaryServer, capacityVariantMismatch=capacityVariantMismatch, userRole=userRole, auxPortQLTx=auxPortQLTx, syncEEquipmentClock=syncEEquipmentClock, iPv6GatewayAddress=iPv6GatewayAddress, wirelessLinkAvailability=wirelessLinkAvailability, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, pubInstancedStatsTable=pubInstancedStatsTable, enableTransmission=enableTransmission, hTTPPortNumber=hTTPPortNumber, unitIdentification=unitIdentification, dNSServerInternetAddress=dNSServerInternetAddress, rangingMode=rangingMode, vLANManagementPriority=vLANManagementPriority, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNMPCommunityString=sNMPCommunityString, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, searchStateLinked=searchStateLinked, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, configurationInstancedTableIndex=configurationInstancedTableIndex, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, systemReset=systemReset, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, regulatoryBand=regulatoryBand, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseInstancedTableEntry=licenseInstancedTableEntry, sNTPSync=sNTPSync, sMTPSourceEmailAddress=sMTPSourceEmailAddress, frequencyVariant=frequencyVariant, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, range=range, dNSServerTable=dNSServerTable, groupID=groupID, deviceESN=deviceESN, licenseCapacity=licenseCapacity, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseTLSRekey=licenseTLSRekey, portAllocationMismatch=portAllocationMismatch, sNTPServerTableNumber=sNTPServerTableNumber, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, dNSServerTableIndex=dNSServerTableIndex, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, dataBridgingStatus=dataBridgingStatus, channelChangeTrap=channelChangeTrap, phyControlGroup=phyControlGroup, sNMPTrapVersion=sNMPTrapVersion, pubStats=pubStats, transmitDataRate=transmitDataRate, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseRegulatoryBandsList=licenseRegulatoryBandsList, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptpGroups=ptpGroups, ethernet=ethernet, licenseIPv6Support=licenseIPv6Support, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, bridgeGroup=bridgeGroup, wirelessLinkStatusLinked=wirelessLinkStatusLinked, siteName=siteName, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mgmtInstancedTableIndex=mgmtInstancedTableIndex, licenseBandwidthCap=licenseBandwidthCap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userTable=userTable, encryption=encryption, syslogControl=syslogControl, tDMInterfaceStatus=tDMInterfaceStatus, auxPortStatusTrap=auxPortStatusTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, alarmInstancedTable=alarmInstancedTable, remoteMACAddressLinked=remoteMACAddressLinked, subbandLowestFrequency=subbandLowestFrequency, authorizationControlTableNumber=authorizationControlTableNumber, iPVersion=iPVersion, telnetPortNumber=telnetPortNumber, auxPortDisabledWarning=auxPortDisabledWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseGroupAccess=licenseGroupAccess, reset=reset, dNSGroup=dNSGroup, iPv6Address=iPv6Address, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitPower=transmitPower, aAAControl=aAAControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveDataRate=receiveDataRate, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, aggregateDataRateLinked=aggregateDataRateLinked, subbandHighestFrequency=subbandHighestFrequency, incompatibleMasterAndSlave=incompatibleMasterAndSlave, byteErrorRatio=byteErrorRatio, syslogClient=syslogClient, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, ethernetPriorityTable=ethernetPriorityTable, alarmsGroup=alarmsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mABProtocolVID=mABProtocolVID, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, linkSymmetry=linkSymmetry, transparentClock=transparentClock, remoteInternetAddressType=remoteInternetAddressType, syncETracking=syncETracking, licenseVersion=licenseVersion, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, channelBandwidth=channelBandwidth, managementNetworkAccessEnabled=managementNetworkAccessEnabled, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, phyStatus=phyStatus, vectorError=vectorError, cableDiagPair4Distance=cableDiagPair4Distance, portAllocationMismatchLinked=portAllocationMismatchLinked, licenseInstancedTable=licenseInstancedTable, tFTPServerPortNumber=tFTPServerPortNumber, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, userName=userName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dSCPManagementPriority=dSCPManagementPriority)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPErrorTrap=sFPErrorTrap, licenseIssueNumber=licenseIssueNumber, deviceMSN=deviceMSN, supplementary=supplementary, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, iPv6PrefixLength=iPv6PrefixLength, mgmtInstancedTable=mgmtInstancedTable, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPServerPortNumber=sMTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitModulationMode=transmitModulationMode, oOBPriorityQueueMapping=oOBPriorityQueueMapping, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, blacklistRMMacAddress=blacklistRMMacAddress, licenseCountry=licenseCountry, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, localPacketFiltering=localPacketFiltering, cableDiagPair2Results=cableDiagPair2Results, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, rawReceivePower=rawReceivePower, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, tDMInterfaceControl=tDMInterfaceControl, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, aAAControlGroup=aAAControlGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, dNSPrimaryServer=dNSPrimaryServer, tdmTable=tdmTable, subnetMask=subnetMask, softwareVersion=softwareVersion, nIDULanPortStatus=nIDULanPortStatus, capacityVariantMismatchLinked=capacityVariantMismatchLinked, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetInstancedTable=ethernetInstancedTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, whitelistRMEnabled=whitelistRMEnabled, nIDULanPortAutoMdix=nIDULanPortAutoMdix, longitude=longitude, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, alarmInstancedTableIndex=alarmInstancedTableIndex, receivePowerLinked=receivePowerLinked, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailable=noWirelessChannelAvailable, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, dfsPeaks=dfsPeaks, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, useVLANForMABProtocol=useVLANForMABProtocol, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, cambium=cambium, routerProtocolsGroup=routerProtocolsGroup, wirelessLinkStatus=wirelessLinkStatus, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite)
