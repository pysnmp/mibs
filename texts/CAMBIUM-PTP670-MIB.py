...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tDMChannelStatus=tDMChannelStatus, linkLossLinked=linkLossLinked, configurationInstancedTableEntry=configurationInstancedTableEntry, installationMode=installationMode, alarmInstancedTable=alarmInstancedTable, auxPortStatus=auxPortStatus, bridgeGroup=bridgeGroup, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseGroup=licenseGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, unavailableSeconds=unavailableSeconds, installStatusLinked=installStatusLinked, sNTPServerTableEntry=sNTPServerTableEntry, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, userEnabled=userEnabled, mgmtInstancedTable=mgmtInstancedTable, unitOutOfCalibration=unitOutOfCalibration, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, vLANManagementVID=vLANManagementVID, auxPortSyncERxStatus=auxPortSyncERxStatus, alarmInstancedTableIndex=alarmInstancedTableIndex, wirelessLinkStatusLinked=wirelessLinkStatusLinked, installStatusTrap=installStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, licenseIssueNumber=licenseIssueNumber, byteErrorRatio=byteErrorRatio, PYSNMP_MODULE_ID=cambium, alarmsGroup=alarmsGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, auxPortStatusTrap=auxPortStatusTrap, pubStatsGroup=pubStatsGroup, dNSGroup=dNSGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, whitelistRMMacAddress=whitelistRMMacAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dNSServerTable=dNSServerTable, tDMChannelCableLength=tDMChannelCableLength, sNTPPollInterval=sNTPPollInterval, dataBridgingStatusLinked=dataBridgingStatusLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, iPv6Address=iPv6Address, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, dataBridgingAvailability=dataBridgingAvailability, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, encryption=encryption, sFPPortAllocation=sFPPortAllocation, remoteUnitNameLinked=remoteUnitNameLinked, licenseRARSupport=licenseRARSupport, antennaSelection=antennaSelection, wirelessTopology=wirelessTopology, sNTPPrimaryServer=sNTPPrimaryServer, configurationInstancedTableNumber=configurationInstancedTableNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, syncETrackingState=syncETrackingState, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, licenseMaxLinkRange=licenseMaxLinkRange, severelyErroredSeconds=severelyErroredSeconds, receivePowerLinked=receivePowerLinked, vectorErrorLinked=vectorErrorLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, targetMACAddress=targetMACAddress, transparentClockVLAN=transparentClockVLAN, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, configurationInstancedTable=configurationInstancedTable, wirelessLinkAvailability=wirelessLinkAvailability, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, authorizationControl=authorizationControl, rawReceivePowerLinked=rawReceivePowerLinked, productName=productName, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseIPv6Support=licenseIPv6Support, signalStrengthRatioLinked=signalStrengthRatioLinked, targetRange=targetRange, receiveChannel=receiveChannel, tdmTableNumber=tdmTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, longitude=longitude, lowestTDMModulationMode=lowestTDMModulationMode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, regulatoryBand=regulatoryBand, frequencyVariant=frequencyVariant, auxPortAcceptedQLRx=auxPortAcceptedQLRx, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, maximumTransmitPower=maximumTransmitPower, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, dfs=dfs, authorizationControlGroup=authorizationControlGroup, ptp=ptp, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseHCMPSupport=licenseHCMPSupport, dataBridgingStatus=dataBridgingStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveModulationMode=receiveModulationMode, searchState=searchState, auxPortDisabledWarning=auxPortDisabledWarning, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, snmpControl=snmpControl, aAAControlGroup=aAAControlGroup, groupID=groupID, hCMPLinkSymmetry=hCMPLinkSymmetry, versionsGroup=versionsGroup, mABProtocolVID=mABProtocolVID, deviceMSN=deviceMSN, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, dataPortWirelessDownAlert=dataPortWirelessDownAlert, blacklistRMMacAddress=blacklistRMMacAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogState=syslogState, alarms=alarms, rxColorCode=rxColorCode, userTable=userTable, searchStateLinked=searchStateLinked, ptpGroups=ptpGroups, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, lowestDataModulationMode=lowestDataModulationMode, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, portAllocationMismatchLinked=portAllocationMismatchLinked, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, syslogControlGroup=syslogControlGroup, auxPortSSMTx=auxPortSSMTx, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, installArmState=installArmState, iPVersion=iPVersion, remoteUnitName=remoteUnitName, transparentClock=transparentClock, maximumNumberOfSlaves=maximumNumberOfSlaves, daylightSaving=daylightSaving, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerStatus=sNTPServerStatus, licenseTrialPeriod=licenseTrialPeriod, enableTransmission=enableTransmission, hardwareVersion=hardwareVersion, sNMPTrapVersion=sNMPTrapVersion, rangeLinked=rangeLinked, dfsGroup=dfsGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mABHoldoffPeriod=mABHoldoffPeriod, unitName=unitName, mainPSUPortAutoMdix=mainPSUPortAutoMdix, iPDSCPPriorityTable=iPDSCPPriorityTable, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, transmitPower=transmitPower, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tDMEnabledChannels=tDMEnabledChannels, licenseCountry=licenseCountry, noWirelessChannelAvailable=noWirelessChannelAvailable, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, transmitDataRateLinked=transmitDataRateLinked, channelBandwidth=channelBandwidth, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, linkLoss=linkLoss, mPLSTCPriorityTable=mPLSTCPriorityTable, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, remoteInternetAddress=remoteInternetAddress, phyControlGroup=phyControlGroup, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseSFPPortSupport=licenseSFPPortSupport, cableDiagnosticsWarning=cableDiagnosticsWarning, managementPortWirelessDownAlert=managementPortWirelessDownAlert, packetsToInternalStack=packetsToInternalStack, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sntp=sntp, apc=apc, licenseIEEE1588Support=licenseIEEE1588Support, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, sNTPServerTable=sNTPServerTable, cableLoss=cableLoss, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, ptpTraps=ptpTraps, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, versions=versions, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNTPState=sNTPState, transparentClockPort=transparentClockPort, rangingMode=rangingMode, transmitModulationMode=transmitModulationMode, licenseCapacity=licenseCapacity, nIDULanPortAutoMdix=nIDULanPortAutoMdix, mABNominalTransmitCapacity=mABNominalTransmitCapacity, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, dNSServerTableIndex=dNSServerTableIndex, licenseInstancedTable=licenseInstancedTable, licenseOOBManagementSupport=licenseOOBManagementSupport, syslogClientTrap=syslogClientTrap, installArmStateTrap=installArmStateTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sFPPortDisabledWarning=sFPPortDisabledWarning, gatewayIPAddress=gatewayIPAddress, remoteInternetAddressType=remoteInternetAddressType, configurationInstancedTableIndex=configurationInstancedTableIndex, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, packetsFromInternalStack=packetsFromInternalStack, tdmTableEntry=tdmTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userName=userName, dfsTableEntry=dfsTableEntry, bridge=bridge, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mABTransmissionInterval=mABTransmissionInterval, tDDControl=tDDControl, subnetMask=subnetMask, sFPPortQLRx=sFPPortQLRx, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, receiveModulationModeLinked=receiveModulationModeLinked, vLANManagementPriority=vLANManagementPriority, subbandLowestFrequency=subbandLowestFrequency, nIDULanPortStatus=nIDULanPortStatus, wirelessOutOctets=wirelessOutOctets, sFPPortStatusTrap=sFPPortStatusTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, transmitFreqKHz=transmitFreqKHz, transparentClockVID=transparentClockVID, cableDiagPair2Distance=cableDiagPair2Distance, resetGroup=resetGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPErrorTrap=sFPErrorTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, ethernetInstancedTableEntry=ethernetInstancedTableEntry, dNSServerTableNumber=dNSServerTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortQLTx=mainPSUPortQLTx, cableDiagPair4Results=cableDiagPair4Results, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receivePower=receivePower, localPacketFiltering=localPacketFiltering, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, unitIdentification=unitIdentification, ptp670=ptp670, ethernetStatisticsTable=ethernetStatisticsTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, alarmInstancedTableNumber=alarmInstancedTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, receiveFreqKHz=receiveFreqKHz, iPv6PrefixLength=iPv6PrefixLength, ethernetInstancedTable=ethernetInstancedTable, authorizationControlTableNumber=authorizationControlTableNumber, phyControlInstancedTable=phyControlInstancedTable, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, management=management, ptpTrapPrefix=ptpTrapPrefix, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, notificationsGroup=notificationsGroup, sFPPortQLTx=sFPPortQLTx, aAAControl=aAAControl, sNMPTrapTableNumber=sNMPTrapTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, cableDiagnosticsResultTable=cableDiagnosticsResultTable, antennaGain=antennaGain, licenseTLSRekey=licenseTLSRekey, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sNTPServerTimeout=sNTPServerTimeout, transmitModulationModeLinked=transmitModulationModeLinked, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTable=dfsTable, useVLANForMABProtocol=useVLANForMABProtocol, mABState=mABState, license=license, tDMChannelLineCode=tDMChannelLineCode, transmitChannel=transmitChannel, reset=reset, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitDataRate=transmitDataRate, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, sMTPEmailAlert=sMTPEmailAlert, tDMInterfaceStatus=tDMInterfaceStatus, sMTPEnabledMessages=sMTPEnabledMessages, licenseBandwidthCap=licenseBandwidthCap, tDMChannelLoopback=tDMChannelLoopback, auxPortQLTx=auxPortQLTx, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, timeZone=timeZone, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerTableIndex=sNTPServerTableIndex, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, aggregateDataRate=aggregateDataRate, whitelistRMEnabled=whitelistRMEnabled, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rawReceivePower=rawReceivePower, configurationGroup=configurationGroup, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dNSPrimaryServer=dNSPrimaryServer, remoteMACAddressLinked=remoteMACAddressLinked, routerProtocols=routerProtocols, userTableEntry=userTableEntry, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, systemReset=systemReset, licenseInstancedTableIndex=licenseInstancedTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, siteName=siteName, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseSyncESupport=licenseSyncESupport, erroredSeconds=erroredSeconds, tDM=tDM, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, remoteMaximumTransmitPower=remoteMaximumTransmitPower, lbtDetectedTrap=lbtDetectedTrap, pubStats=pubStats, latitude=latitude, sNTPServerRetries=sNTPServerRetries, licenseGasGroup=licenseGasGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPv3Enable=sNMPv3Enable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDMInterfaceControl=tDMInterfaceControl, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTableNumber=sNTPServerTableNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, byteErrorRatioLinked=byteErrorRatioLinked, syslogStateTrap=syslogStateTrap, auxPortQLRx=auxPortQLRx, phyInstancedStatusTable=phyInstancedStatusTable, cableDiagPair3Results=cableDiagPair3Results, cableDiagPair1Distance=cableDiagPair1Distance, sFPPortStatus=sFPPortStatus, authorizationControlTableIndex=authorizationControlTableIndex, systemClock=systemClock, tDDSynchronizationMode=tDDSynchronizationMode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, authorizationMethod=authorizationMethod, cableDiagnosticsPorts=cableDiagnosticsPorts, transmitterChannels=transmitterChannels, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, receiveModulationModeDetail=receiveModulationModeDetail, vectorError=vectorError, ptmp=ptmp, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, licenseTDDSyncSupport=licenseTDDSyncSupport, userTableNumber=userTableNumber, ptpCompliance=ptpCompliance, dNSServerInternetAddressType=dNSServerInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, supplementaryGroup=supplementaryGroup, dNSResolver=dNSResolver, productVariant=productVariant, tDMChannelStatusTrap=tDMChannelStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, cambium=cambium, managementGroup=managementGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPLastSync=sNTPLastSync, licenseInstancedTableEntry=licenseInstancedTableEntry, qOSPriorityScheme=qOSPriorityScheme, encryptionGroup=encryptionGroup, txColorCode=txColorCode, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mgmtInstancedTableIndex=mgmtInstancedTableIndex, licenseInstancedTableNumber=licenseInstancedTableNumber, linkModeOptimization=linkModeOptimization, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, hTTPPortNumber=hTTPPortNumber, apcGroup=apcGroup, wirelessOutEthernetOctets=wirelessOutEthernetOctets, snmpControlGroup=snmpControlGroup, licenseVersion=licenseVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, auxPortAllocation=auxPortAllocation, syncESlavePort=syncESlavePort, syslogControl=syslogControl, transmitFreqMHz=transmitFreqMHz, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sNTPSync=sNTPSync, sFPPortSSMTx=sFPPortSSMTx, authorizationControlTable=authorizationControlTable, sNTPSyncTrap=sNTPSyncTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, syncEEquipmentClock=syncEEquipmentClock, aggregateDataRateLinked=aggregateDataRateLinked, transmitPowerLinked=transmitPowerLinked, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, eIRP=eIRP, licenseUnitSerialNumber=licenseUnitSerialNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, receiveFreqMHz=receiveFreqMHz, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNTPServerPortNumber=sNTPServerPortNumber, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dNSServerPortNumber=dNSServerPortNumber, remoteMACAddress=remoteMACAddress, mainPSUPortQLRx=mainPSUPortQLRx, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, auxPortConfigurationMismatch=auxPortConfigurationMismatch, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, installStatus=installStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, phyControlInstancedTableEntry=phyControlInstancedTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetStatisticsDataSource=ethernetStatisticsDataSource, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, userPassword=userPassword, iPv6GatewayAddress=iPv6GatewayAddress, tdmTable=tdmTable, dfsMeans=dfsMeans, phyStatusGroup=phyStatusGroup, mABMaintenanceLevel=mABMaintenanceLevel, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hCMPMaximumLinkRange=hCMPMaximumLinkRange, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetPriorityTable=ethernetPriorityTable, capacityVariantMismatchLinked=capacityVariantMismatchLinked, unitIdentificationGroup=unitIdentificationGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, licenseGroupAccess=licenseGroupAccess, capacityVariantMismatch=capacityVariantMismatch, range=range, cableDiagPair4Distance=cableDiagPair4Distance, portAllocationMismatch=portAllocationMismatch, cableDiagnosticsControl=cableDiagnosticsControl, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tDMGroup=tDMGroup, userRole=userRole, mgmtInstancedTableNumber=mgmtInstancedTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, routerProtocolsGroup=routerProtocolsGroup, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mainPSUPortStatus=mainPSUPortStatus, channelChangeTrap=channelChangeTrap, deviceESN=deviceESN, authorizationControlTableEntry=authorizationControlTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, txMABFrames=txMABFrames, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, dNS=dNS, smtpGroup=smtpGroup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, mainPSUPortSSMTx=mainPSUPortSSMTx, mABNominalModulationMode=mABNominalModulationMode, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseEncryption=licenseEncryption, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessOutAllOctets=wirelessOutAllOctets, dSCPManagementPriority=dSCPManagementPriority, sFPError=sFPError, mainPSUPortAllocation=mainPSUPortAllocation, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mABProtocolVLANPriority=mABProtocolVLANPriority, ethernetGroup=ethernetGroup, supplementary=supplementary, secureModeAlarm=secureModeAlarm, signalStrengthRatio=signalStrengthRatio, subbandHighestFrequency=subbandHighestFrequency, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, cableDiagPair2Results=cableDiagPair2Results, phyStatus=phyStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", phyControl=phyControl, telnetPortNumber=telnetPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsPeaks=dfsPeaks, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, licenseRegulatoryBandsList=licenseRegulatoryBandsList, smtp=smtp, dataPortPauseFrames=dataPortPauseFrames, tDDSynchronizationStatus=tDDSynchronizationStatus, altitude=altitude, tFTPServerPortNumber=tFTPServerPortNumber, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, iPv4Address=iPv4Address, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, deviceMACAddress=deviceMACAddress, dNSServerTableEntry=dNSServerTableEntry, dataBridgingStatusAlarm=dataBridgingStatusAlarm, ethernet=ethernet, linkSymmetry=linkSymmetry, syslogClient=syslogClient, dNSServerInternetAddress=dNSServerInternetAddress, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, cableDiagPair3Distance=cableDiagPair3Distance, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, bootVersion=bootVersion, alarmInstancedTableEntry=alarmInstancedTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, licenseSecurityLevel=licenseSecurityLevel, pubInstancedStatsTable=pubInstancedStatsTable, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userTableIndex=userTableIndex, ethernetInstancedTableIndex=ethernetInstancedTableIndex, tdmTableIndex=tdmTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, accessMethod=accessMethod, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sNMPPortNumber=sNMPPortNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, extendedSpectrumScanning=extendedSpectrumScanning, tempPcb=tempPcb, incompatibleRegulatoryBands=incompatibleRegulatoryBands, blacklistRMEnabled=blacklistRMEnabled, cableDiagnostics=cableDiagnostics, receiveDataRate=receiveDataRate, dfsTableNumber=dfsTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveDataRateLinked=receiveDataRateLinked, linkName=linkName, regulatoryBandTrap=regulatoryBandTrap, syncETracking=syncETracking, dfsTableIndex=dfsTableIndex, sFPPortAutoMdix=sFPPortAutoMdix, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tFTPClient=tFTPClient, configuration=configuration, cableDiagPair1Results=cableDiagPair1Results, softwareVersion=softwareVersion, l2CPPriorityTable=l2CPPriorityTable)
