...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", receiveModulationModeDetail=receiveModulationModeDetail, lowestTDMModulationMode=lowestTDMModulationMode, cableLoss=cableLoss, dSCPManagementPriority=dSCPManagementPriority, dNSGroup=dNSGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, rxColorCode=rxColorCode, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, nIDULanPortAutoMdix=nIDULanPortAutoMdix, licenseUnitSerialNumber=licenseUnitSerialNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, unavailableSeconds=unavailableSeconds, syslogState=syslogState, byteErrorRatioLinked=byteErrorRatioLinked, licenseGroupAccess=licenseGroupAccess, tempPcb=tempPcb, dNSServerPortNumber=dNSServerPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hCMPLinkSymmetry=hCMPLinkSymmetry, sNTPServerInternetAddress=sNTPServerInternetAddress, hTTPSPortNumber=hTTPSPortNumber, sFPErrorTrap=sFPErrorTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, authorizationControlTableEntry=authorizationControlTableEntry, ptpTraps=ptpTraps, sFPPortStatusTrap=sFPPortStatusTrap, dNSServerTableIndex=dNSServerTableIndex, signalStrengthRatio=signalStrengthRatio, syslogControlGroup=syslogControlGroup, sFPPortQLTx=sFPPortQLTx, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, phyInstancedStatusTable=phyInstancedStatusTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDControlGroup=tDDControlGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, targetRange=targetRange, installArmState=installArmState, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, transparentClockPort=transparentClockPort, linkName=linkName, dNSResolver=dNSResolver, latitude=latitude, syslogControl=syslogControl, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetPriorityTable=ethernetPriorityTable, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, linkSymmetry=linkSymmetry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, dNSServerTableEntry=dNSServerTableEntry, byteErrorRatio=byteErrorRatio, tDMInterfaceControl=tDMInterfaceControl, bridge=bridge, sMTPServerPortNumber=sMTPServerPortNumber, accessMethod=accessMethod, dfsTableIndex=dfsTableIndex, cableDiagPair1Results=cableDiagPair1Results, mgmtInstancedTableNumber=mgmtInstancedTableNumber, portAllocationMismatchTrap=portAllocationMismatchTrap, remoteMACAddress=remoteMACAddress, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, secureModeAlarm=secureModeAlarm, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dataBridgingStatus=dataBridgingStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptp=ptp, wirelessTopology=wirelessTopology, phyControlGroup=phyControlGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, l2CPPriorityTable=l2CPPriorityTable, licenseRegulatoryBandsList=licenseRegulatoryBandsList, hCMPMaximumLinkRange=hCMPMaximumLinkRange, userName=userName, altitude=altitude, antennaSelection=antennaSelection, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, ethernetInstancedTableIndex=ethernetInstancedTableIndex, authorizationMethod=authorizationMethod, tFTPServerInternetAddress=tFTPServerInternetAddress, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, ptpGroups=ptpGroups, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sNTPServerStatus=sNTPServerStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mainPSUPortAllocation=mainPSUPortAllocation, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, erroredSeconds=erroredSeconds, receiveChannel=receiveChannel, wirelessOutOctets=wirelessOutOctets, supplementary=supplementary, licenseInstancedTableIndex=licenseInstancedTableIndex, rawReceivePowerLinked=rawReceivePowerLinked, packetsFromInternalStack=packetsFromInternalStack, licenseGroup=licenseGroup, syslogStateTrap=syslogStateTrap, tdmTable=tdmTable, remoteInternetAddressLinked=remoteInternetAddressLinked, aAAControl=aAAControl, authorizationControlTableNumber=authorizationControlTableNumber, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, productName=productName, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, txMABFrames=txMABFrames, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, mABProtocolVLANPriority=mABProtocolVLANPriority, frequencyVariant=frequencyVariant, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, installArmStateTrap=installArmStateTrap, sNMPTrapVersion=sNMPTrapVersion, cableDiagPair2Distance=cableDiagPair2Distance, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, nIDULanPortStatus=nIDULanPortStatus, sFPPortDisabledWarning=sFPPortDisabledWarning, licenseSecurityLevel=licenseSecurityLevel, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitFreqKHz=transmitFreqKHz, sNTPServerPortNumber=sNTPServerPortNumber, resetGroup=resetGroup, phyStatusGroup=phyStatusGroup, dataBridgingStatusLinked=dataBridgingStatusLinked, management=management, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, portAllocationMismatchLinked=portAllocationMismatchLinked, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, managementGroup=managementGroup, mABHoldoffPeriod=mABHoldoffPeriod, encryptionGroup=encryptionGroup, smtp=smtp, licenseSyncESupport=licenseSyncESupport, ethernetInstancedTable=ethernetInstancedTable, softwareVersion=softwareVersion, auxPortSSMTx=auxPortSSMTx, licenseTLSRekey=licenseTLSRekey, wirelessOutEthernetOctets=wirelessOutEthernetOctets, encryption=encryption, receiveModulationMode=receiveModulationMode, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, receivePower=receivePower, configurationInstancedTableNumber=configurationInstancedTableNumber, channelChangeTrap=channelChangeTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerTimeout=sNTPServerTimeout, auxPortAllocation=auxPortAllocation, dfsTable=dfsTable, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, alarmInstancedTableEntry=alarmInstancedTableEntry, sNTPServerTable=sNTPServerTable, tDMChannelLineCode=tDMChannelLineCode, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsTableNumber=dfsTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseInstancedTableNumber=licenseInstancedTableNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseIEEE1588Support=licenseIEEE1588Support, licenseGasGroup=licenseGasGroup, installStatusLinked=installStatusLinked, licenseCountry=licenseCountry, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, enableTransmission=enableTransmission, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, useVLANForMABProtocol=useVLANForMABProtocol, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, lowestDataModulationMode=lowestDataModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, subbandLowestFrequency=subbandLowestFrequency, tDMGroup=tDMGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, maximumTransmitPower=maximumTransmitPower, antennaGain=antennaGain, userTableEntry=userTableEntry, iPv4Address=iPv4Address, ethernet=ethernet, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, auxPortQLRx=auxPortQLRx, licenseTrialPeriod=licenseTrialPeriod, wirelessOutAllOctets=wirelessOutAllOctets, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, installStatusTrap=installStatusTrap, userTableIndex=userTableIndex, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tDM=tDM, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sFPPortQLRx=sFPPortQLRx, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, transmitterChannels=transmitterChannels, remoteUnitNameLinked=remoteUnitNameLinked, authorizationControlTable=authorizationControlTable, authorizationControlGroup=authorizationControlGroup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mABProtocolVID=mABProtocolVID, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sNMPPortNumber=sNMPPortNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, siteName=siteName, licenseInstancedTableEntry=licenseInstancedTableEntry, deviceMACAddress=deviceMACAddress, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseIssueNumber=licenseIssueNumber, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, ptpCompliance=ptpCompliance, cambium=cambium, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, dataBridgingAvailability=dataBridgingAvailability, longitude=longitude, receivePowerLinked=receivePowerLinked, tDDControl=tDDControl, cableDiagnosticsGroup=cableDiagnosticsGroup, deviceESN=deviceESN, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyControlInstancedTable=phyControlInstancedTable, eIRP=eIRP, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, mABNominalModulationMode=mABNominalModulationMode, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, PYSNMP_MODULE_ID=cambium, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syncESlavePort=syncESlavePort, searchStateLinked=searchStateLinked, subbandHighestFrequency=subbandHighestFrequency, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, tDMChannelLoopback=tDMChannelLoopback, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, phyStatus=phyStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, supplementaryGroup=supplementaryGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseEncryption=licenseEncryption, sFPPortSSMTx=sFPPortSSMTx, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, txColorCode=txColorCode, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, pubInstancedStatsTable=pubInstancedStatsTable, licenseRARSupport=licenseRARSupport, auxPortAcceptedQLRx=auxPortAcceptedQLRx, tDDSynchronizationStatus=tDDSynchronizationStatus, auxPortDisabledWarning=auxPortDisabledWarning, routerProtocolsGroup=routerProtocolsGroup, unitIdentification=unitIdentification, iPVersion=iPVersion, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNMPCommunityString=sNMPCommunityString, receiveDataRate=receiveDataRate, installationMode=installationMode, cableDiagnostics=cableDiagnostics, timeZone=timeZone, bootVersion=bootVersion, licenseSFPPortSupport=licenseSFPPortSupport, groupID=groupID, ethernetInstancedTableEntry=ethernetInstancedTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, vLANManagementPriority=vLANManagementPriority, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, telnetAccessEnabled=telnetAccessEnabled, alarmsGroup=alarmsGroup, ptpTrapPrefix=ptpTrapPrefix, transmitModulationMode=transmitModulationMode, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, deviceMSN=deviceMSN, mainPSUPortStatusTrap=mainPSUPortStatusTrap, linkLoss=linkLoss, sFPPortSyncERxStatus=sFPPortSyncERxStatus, dfsPeaks=dfsPeaks, severelyErroredSeconds=severelyErroredSeconds, iPv6GatewayAddress=iPv6GatewayAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, regulatoryBand=regulatoryBand, syncETrackingState=syncETrackingState, routerProtocols=routerProtocols, dNSServerTable=dNSServerTable, secureModeAlarmTrap=secureModeAlarmTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, sNTPServerTableEntry=sNTPServerTableEntry, localPacketFiltering=localPacketFiltering, smtpGroup=smtpGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, auxPortConfigurationMismatch=auxPortConfigurationMismatch, aggregateDataRateLinked=aggregateDataRateLinked, sNTPState=sNTPState, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, configurationInstancedTableIndex=configurationInstancedTableIndex, transmitPower=transmitPower, rangingMode=rangingMode, cableDiagPair4Distance=cableDiagPair4Distance, alarmInstancedTable=alarmInstancedTable, encryptionAlgorithm=encryptionAlgorithm, authorizationControl=authorizationControl, transmitChannel=transmitChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, auxPortSyncERxStatus=auxPortSyncERxStatus, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNTPSync=sNTPSync, telnetPortNumber=telnetPortNumber, productVariant=productVariant, authorizationControlTableIndex=authorizationControlTableIndex, vectorError=vectorError, masterSlaveMode=masterSlaveMode, sNMPTrapTableEntry=sNMPTrapTableEntry, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, transparentClockVLAN=transparentClockVLAN, portAllocationMismatch=portAllocationMismatch, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, unitIdentificationGroup=unitIdentificationGroup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, capacityVariantMismatch=capacityVariantMismatch, mainPSUPortStatus=mainPSUPortStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, sFPPortStatus=sFPPortStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, subnetMask=subnetMask, syslogClient=syslogClient, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sntp=sntp, auxPortStatusTrap=auxPortStatusTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, snmpControl=snmpControl, sNTPLastSync=sNTPLastSync, extendedSpectrumScanning=extendedSpectrumScanning, tFTPServerInternetAddressType=tFTPServerInternetAddressType, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, receiveFreqKHz=receiveFreqKHz, whitelistRMMacAddress=whitelistRMMacAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, linkModeOptimization=linkModeOptimization, rawReceivePower=rawReceivePower, phyControl=phyControl, tDDSynchronizationMode=tDDSynchronizationMode, transmitModulationModeLinked=transmitModulationModeLinked, alarmInstancedTableIndex=alarmInstancedTableIndex, unitOutOfCalibration=unitOutOfCalibration, dfs=dfs, dfsTableEntry=dfsTableEntry, channelBandwidth=channelBandwidth, licenseMaxLinkRange=licenseMaxLinkRange, sFPPortAllocation=sFPPortAllocation, licenseTDDSyncSupport=licenseTDDSyncSupport, blacklistRMMacAddress=blacklistRMMacAddress, configurationGroup=configurationGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPSyncTrap=sNTPSyncTrap, apc=apc, licenseHCMPSupport=licenseHCMPSupport, versionsGroup=versionsGroup, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseInstancedTable=licenseInstancedTable, apcGroup=apcGroup, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseIPv6Support=licenseIPv6Support, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sFPError=sFPError, bridgeGroup=bridgeGroup, userEnabled=userEnabled, mainPSUPortQLRx=mainPSUPortQLRx, transmitDataRateLinked=transmitDataRateLinked, tDMInterfaceStatus=tDMInterfaceStatus, cableDiagPair3Results=cableDiagPair3Results, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mABTransmissionInterval=mABTransmissionInterval, noWirelessChannelAvailable=noWirelessChannelAvailable, remoteInternetAddressType=remoteInternetAddressType, installStatus=installStatus, vectorErrorLinked=vectorErrorLinked, tdmTableIndex=tdmTableIndex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, configuration=configuration, ptmp=ptmp, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, phyControlInstancedTableNumber=phyControlInstancedTableNumber, nIDULanPortStatusTrap=nIDULanPortStatusTrap, daylightSaving=daylightSaving, hTTPAccessEnabled=hTTPAccessEnabled, licenseVersion=licenseVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, transparentClock=transparentClock, userPassword=userPassword, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, snmpControlGroup=snmpControlGroup, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sNMPTrapPortNumber=sNMPTrapPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dNSPrimaryServer=dNSPrimaryServer, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, syncEEquipmentClock=syncEEquipmentClock, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, versions=versions, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, qOSPriorityScheme=qOSPriorityScheme, dfsGroup=dfsGroup, cableDiagnosticsControl=cableDiagnosticsControl, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernetStatisticsDataSource=ethernetStatisticsDataSource, lbtDetectedTrap=lbtDetectedTrap, remoteUnitName=remoteUnitName, tFTPClient=tFTPClient, remoteMACAddressLinked=remoteMACAddressLinked, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerRetries=sNTPServerRetries, license=license, whitelistRMEnabled=whitelistRMEnabled, mABMaintenanceLevel=mABMaintenanceLevel, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mABState=mABState, oOBPriorityQueueMapping=oOBPriorityQueueMapping, auxPortQLTx=auxPortQLTx, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, phyControlInstancedTableEntry=phyControlInstancedTableEntry, transmitPowerLinked=transmitPowerLinked, packetsToInternalStack=packetsToInternalStack, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dNSServerTableNumber=dNSServerTableNumber, cableDiagPair2Results=cableDiagPair2Results, dNSServerInternetAddress=dNSServerInternetAddress, mABNominalTransmitCapacity=mABNominalTransmitCapacity, ptp670=ptp670, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, useVLANForManagementInterfaces=useVLANForManagementInterfaces, configurationInstancedTable=configurationInstancedTable, unitName=unitName, dfsMeans=dfsMeans, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tDMChannelCableLength=tDMChannelCableLength, dataBridgingStatusAlarm=dataBridgingStatusAlarm, gatewayIPAddress=gatewayIPAddress, sntpGroup=sntpGroup, ethernetGroup=ethernetGroup, receiveDataRateLinked=receiveDataRateLinked, tDMChannelStatus=tDMChannelStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, userTable=userTable, range=range, sNMPv3Enable=sNMPv3Enable, sFPPortAutoMdix=sFPPortAutoMdix, tdmTableEntry=tdmTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licenseOOBManagementSupport=licenseOOBManagementSupport, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPv6Address=iPv6Address, cableDiagPair3Distance=cableDiagPair3Distance, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dNS=dNS, reset=reset, blacklistRMEnabled=blacklistRMEnabled, linkLossLinked=linkLossLinked, cableDiagPair4Results=cableDiagPair4Results, aggregateDataRate=aggregateDataRate, userRole=userRole, mgmtInstancedTableEntry=mgmtInstancedTableEntry, cableDiagnosticsResultTable=cableDiagnosticsResultTable, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, wirelessLinkStatus=wirelessLinkStatus, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPPollInterval=sNTPPollInterval, sMTPEmailAlert=sMTPEmailAlert, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerPortNumber=tFTPServerPortNumber, remoteInternetAddress=remoteInternetAddress, systemReset=systemReset, dataPortPauseFrames=dataPortPauseFrames, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseBandwidthCap=licenseBandwidthCap, rangeLinked=rangeLinked, syslogClientTrap=syslogClientTrap, receiveFreqMHz=receiveFreqMHz, ethernetInstancedTableNumber=ethernetInstancedTableNumber, signalStrengthRatioLinked=signalStrengthRatioLinked, capacityVariantMismatchLinked=capacityVariantMismatchLinked, secondarySoftwareVersion=secondarySoftwareVersion, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mainPSUPortQLTx=mainPSUPortQLTx, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, transparentClockVID=transparentClockVID, tDMEnabledChannels=tDMEnabledChannels, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseCapacity=licenseCapacity, tdmTableNumber=tdmTableNumber, mgmtInstancedTable=mgmtInstancedTable, aAAControlGroup=aAAControlGroup, alarmInstancedTableNumber=alarmInstancedTableNumber, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mainPSUPortSSMTx=mainPSUPortSSMTx, vLANManagementVID=vLANManagementVID, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, userTableNumber=userTableNumber, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sNTPServerTableIndex=sNTPServerTableIndex, pubStats=pubStats, cableDiagPair1Distance=cableDiagPair1Distance, notificationsGroup=notificationsGroup, hTTPPortNumber=hTTPPortNumber, targetMACAddress=targetMACAddress, regulatoryBandTrap=regulatoryBandTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, transmitFreqMHz=transmitFreqMHz, dNSServerInternetAddressType=dNSServerInternetAddressType, pubStatsGroup=pubStatsGroup, configurationInstancedTableEntry=configurationInstancedTableEntry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, iPv6PrefixLength=iPv6PrefixLength, hardwareVersion=hardwareVersion, searchState=searchState, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, transmitDataRate=transmitDataRate, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, auxPortStatus=auxPortStatus, alarms=alarms, ethernetStatisticsTable=ethernetStatisticsTable, syncETracking=syncETracking, receiveModulationModeLinked=receiveModulationModeLinked)
