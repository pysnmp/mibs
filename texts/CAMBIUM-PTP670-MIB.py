...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, smtp=smtp, tDMEnabledChannels=tDMEnabledChannels, accessMethod=accessMethod, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, cableDiagnostics=cableDiagnostics, mainPSUPortSSMTx=mainPSUPortSSMTx, whitelistRMEnabled=whitelistRMEnabled, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, iPv6Address=iPv6Address, incompatibleMasterAndSlave=incompatibleMasterAndSlave, aAAControlGroup=aAAControlGroup, dNSServerTable=dNSServerTable, phyControl=phyControl, versionsGroup=versionsGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, encryptionAlgorithm=encryptionAlgorithm, sNMPCommunityString=sNMPCommunityString, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sNTPSyncTrap=sNTPSyncTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, installStatusTrap=installStatusTrap, auxPortStatus=auxPortStatus, managementGroup=managementGroup, userEnabled=userEnabled, licenseSecurityLevel=licenseSecurityLevel, ethernetInstancedTableEntry=ethernetInstancedTableEntry, management=management, sNMPTrapTable=sNMPTrapTable, sNTPServerTableIndex=sNTPServerTableIndex, txMABFrames=txMABFrames, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dNS=dNS, mainPSUPortQLRx=mainPSUPortQLRx, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, pubStats=pubStats, authorizationControlGroup=authorizationControlGroup, dNSGroup=dNSGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagPair2Results=cableDiagPair2Results, mABNominalModulationMode=mABNominalModulationMode, antennaSelection=antennaSelection, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tempPcb=tempPcb, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, routerProtocols=routerProtocols, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseCapacity=licenseCapacity, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mainPSUPortStatus=mainPSUPortStatus, licenseTrialPeriod=licenseTrialPeriod, iPVersion=iPVersion, phyStatus=phyStatus, transmitPowerLinked=transmitPowerLinked, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, tDMGroup=tDMGroup, PYSNMP_MODULE_ID=cambium, useVLANForMABProtocol=useVLANForMABProtocol, syslogClient=syslogClient, alarmsGroup=alarmsGroup, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, authorizationControlTable=authorizationControlTable, transparentClockVID=transparentClockVID, transmitModulationModeLinked=transmitModulationModeLinked, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, dNSPrimaryServer=dNSPrimaryServer, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transparentClock=transparentClock, longitude=longitude, frequencyVariant=frequencyVariant, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, phyControlInstancedTableIndex=phyControlInstancedTableIndex, alarmInstancedTableIndex=alarmInstancedTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataBridgingStatus=dataBridgingStatus, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, vLANManagementPriority=vLANManagementPriority, lbtDetectedTrap=lbtDetectedTrap, sntpGroup=sntpGroup, auxPortQLRx=auxPortQLRx, tDM=tDM, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, mainPSUPortQLTx=mainPSUPortQLTx, tDDSynchronizationMode=tDDSynchronizationMode, secureModeAlarmTrap=secureModeAlarmTrap, sFPPortStatus=sFPPortStatus, latitude=latitude, regulatoryBandTrap=regulatoryBandTrap, tFTPServerPortNumber=tFTPServerPortNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, receiveFreqMHz=receiveFreqMHz, auxPortConfigurationMismatch=auxPortConfigurationMismatch, phyControlGroup=phyControlGroup, dfsTableIndex=dfsTableIndex, remoteUnitNameLinked=remoteUnitNameLinked, searchStateLinked=searchStateLinked, syslogControl=syslogControl, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, configuration=configuration, rxColorCode=rxColorCode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, userTableNumber=userTableNumber, transmitChannel=transmitChannel, secondarySoftwareVersion=secondarySoftwareVersion, daylightSaving=daylightSaving, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, pubStatsGroup=pubStatsGroup, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transparentClockPort=transparentClockPort, deviceESN=deviceESN, bridgeGroup=bridgeGroup, sFPErrorTrap=sFPErrorTrap, remoteInternetAddressType=remoteInternetAddressType, sFPPortSSMTx=sFPPortSSMTx, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, cableDiagPair2Distance=cableDiagPair2Distance, dNSServerInternetAddressType=dNSServerInternetAddressType, targetRange=targetRange, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, regulatoryBand=regulatoryBand, blacklistRMMacAddress=blacklistRMMacAddress, productVariant=productVariant, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, blacklistRMEnabled=blacklistRMEnabled, sMTPEmailAlert=sMTPEmailAlert, ptmp=ptmp, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dNSServerTableEntry=dNSServerTableEntry, syncETracking=syncETracking, licenseIPv6Support=licenseIPv6Support, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, alarmInstancedTableEntry=alarmInstancedTableEntry, channelBandwidth=channelBandwidth, licenseCountry=licenseCountry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, authorizationControlTableEntry=authorizationControlTableEntry, maximumNumberOfSlaves=maximumNumberOfSlaves, groupID=groupID, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, tDMChannelStatus=tDMChannelStatus, transmitFreqKHz=transmitFreqKHz, secureModeAlarm=secureModeAlarm, sNTPServerRetries=sNTPServerRetries, iPv4Address=iPv4Address, maxLinkRangeExceeded=maxLinkRangeExceeded, mgmtInstancedTableEntry=mgmtInstancedTableEntry, syncEEquipmentClock=syncEEquipmentClock, systemReset=systemReset, hTTPSAccessEnabled=hTTPSAccessEnabled, tDMChannelStatusTrap=tDMChannelStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, sNTPSync=sNTPSync, apc=apc, cableDiagPair1Results=cableDiagPair1Results, portAllocationMismatchTrap=portAllocationMismatchTrap, subbandHighestFrequency=subbandHighestFrequency, hardwareVersion=hardwareVersion, dfs=dfs, tDDControlGroup=tDDControlGroup, ptp=ptp, rawReceivePowerLinked=rawReceivePowerLinked, linkModeOptimization=linkModeOptimization, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, receivePower=receivePower, sMTPServerPortNumber=sMTPServerPortNumber, licenseMaxLinkRange=licenseMaxLinkRange, wirelessLinkStatus=wirelessLinkStatus, sntp=sntp, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dfsTableNumber=dfsTableNumber, tFTPClient=tFTPClient, tdmTableNumber=tdmTableNumber, sFPPortQLRx=sFPPortQLRx, auxPortStatusTrap=auxPortStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, cableDiagnosticsGroup=cableDiagnosticsGroup, linkLoss=linkLoss, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, dfsGroup=dfsGroup, alarmInstancedTableNumber=alarmInstancedTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, enabledDiagnosticAlarms=enabledDiagnosticAlarms, softwareVersion=softwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, apcGroup=apcGroup, extendedSpectrumScanning=extendedSpectrumScanning, packetsToInternalStack=packetsToInternalStack, eIRP=eIRP, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, remoteInternetAddressLinked=remoteInternetAddressLinked, dataBridgingStatusLinked=dataBridgingStatusLinked, auxPortSSMTx=auxPortSSMTx, transmitFreqMHz=transmitFreqMHz, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, cableDiagPair3Results=cableDiagPair3Results, configurationInstancedTable=configurationInstancedTable, vectorError=vectorError, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installationMode=installationMode, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, subnetMask=subnetMask, auxPortQLTx=auxPortQLTx, vectorErrorLinked=vectorErrorLinked, dataPortPauseFrames=dataPortPauseFrames, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseTLSRekey=licenseTLSRekey, iPv6GatewayAddress=iPv6GatewayAddress, supplementaryGroup=supplementaryGroup, dNSServerPortNumber=dNSServerPortNumber, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, cableDiagPair4Distance=cableDiagPair4Distance, transmitDataRate=transmitDataRate, remoteMaximumTransmitPower=remoteMaximumTransmitPower, unavailableSeconds=unavailableSeconds, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, rawReceivePower=rawReceivePower, sNMPPortNumber=sNMPPortNumber, dataBridgingAvailability=dataBridgingAvailability, ethernetPriorityTable=ethernetPriorityTable, dSCPManagementPriority=dSCPManagementPriority, lowestTDMModulationMode=lowestTDMModulationMode, whitelistRMMacAddress=whitelistRMMacAddress, deviceMACAddress=deviceMACAddress, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", unitName=unitName, licenseRegulatoryBandsList=licenseRegulatoryBandsList, erroredSeconds=erroredSeconds, ethernetPriorityTableIndex=ethernetPriorityTableIndex, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, cableDiagnosticsControl=cableDiagnosticsControl, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, snmpControl=snmpControl, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, telnetAccessEnabled=telnetAccessEnabled, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseInstancedTableIndex=licenseInstancedTableIndex, tdmTable=tdmTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDMChannelLineCode=tDMChannelLineCode, ptp670=ptp670, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, targetMACAddress=targetMACAddress, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, userName=userName, receiveDataRate=receiveDataRate, receiveModulationModeDetail=receiveModulationModeDetail, channelChangeTrap=channelChangeTrap, linkSymmetry=linkSymmetry, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, rangeLinked=rangeLinked, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerStatus=sNTPServerStatus, tDMChannelLoopback=tDMChannelLoopback, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryptionGroup=encryptionGroup, syslogClientTrap=syslogClientTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, mABTransmissionInterval=mABTransmissionInterval, syslogControlGroup=syslogControlGroup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitterChannels=transmitterChannels, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, portAllocationMismatchLinked=portAllocationMismatchLinked, syslogStateTrap=syslogStateTrap, receivePowerLinked=receivePowerLinked, capacityVariantMismatchTrap=capacityVariantMismatchTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseGroupAccess=licenseGroupAccess, dNSServerInternetAddress=dNSServerInternetAddress, incompatibleRegulatoryBands=incompatibleRegulatoryBands, configurationInstancedTableEntry=configurationInstancedTableEntry, licenseGroup=licenseGroup, ethernetGroup=ethernetGroup, userTableIndex=userTableIndex, mainPSUPortAutoMdix=mainPSUPortAutoMdix, deviceMSN=deviceMSN, range=range, phyControlInstancedTableEntry=phyControlInstancedTableEntry, tDMChannelCableLength=tDMChannelCableLength, authorizationControl=authorizationControl, sFPPortAutoNegotiation=sFPPortAutoNegotiation, syslogState=syslogState, sNTPServerTable=sNTPServerTable, tdmTableIndex=tdmTableIndex, mABHoldoffPeriod=mABHoldoffPeriod, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, rangingMode=rangingMode, licenseEncryption=licenseEncryption, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, txColorCode=txColorCode, licenseSyncESupport=licenseSyncESupport, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, signalStrengthRatio=signalStrengthRatio, tDMInterfaceStatus=tDMInterfaceStatus, mABState=mABState, sNTPServerTimeout=sNTPServerTimeout, hCMPLinkSymmetry=hCMPLinkSymmetry, receiveModulationMode=receiveModulationMode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, configurationInstancedTableNumber=configurationInstancedTableNumber, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, transmitModulationMode=transmitModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, signalStrengthRatioLinked=signalStrengthRatioLinked, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenseVersion=licenseVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveModulationModeLinked=receiveModulationModeLinked, sFPError=sFPError, tDDControl=tDDControl, nIDULanPortStatus=nIDULanPortStatus, sNMPv3Enable=sNMPv3Enable, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, pubInstancedStatsTable=pubInstancedStatsTable, cableDiagPair4Results=cableDiagPair4Results, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, smtpGroup=smtpGroup, wirelessOutEthernetOctets=wirelessOutEthernetOctets, ethernetStatisticsTable=ethernetStatisticsTable, sFPPortQLTx=sFPPortQLTx, userRole=userRole, altitude=altitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cableDiagPair3Distance=cableDiagPair3Distance, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, syncESlavePort=syncESlavePort, linkModeOptimizationMismatch=linkModeOptimizationMismatch, unitIdentificationGroup=unitIdentificationGroup, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sFPPortAutoMdix=sFPPortAutoMdix, receiveFreqKHz=receiveFreqKHz, authorizationControlTableNumber=authorizationControlTableNumber, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, aAAControl=aAAControl, dataBridgingStatusAlarm=dataBridgingStatusAlarm, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, gatewayIPAddress=gatewayIPAddress, licenseSFPPortSupport=licenseSFPPortSupport, sNMPTrapTableNumber=sNMPTrapTableNumber, unitIdentification=unitIdentification, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, ptpTraps=ptpTraps, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, dfsTableEntry=dfsTableEntry, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, byteErrorRatioLinked=byteErrorRatioLinked, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, reset=reset, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sFPPortAllocation=sFPPortAllocation, mgmtInstancedTableNumber=mgmtInstancedTableNumber, transparentClockVLAN=transparentClockVLAN, tDDSynchronizationStatus=tDDSynchronizationStatus, authorizationMethod=authorizationMethod, sNTPPollInterval=sNTPPollInterval, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, configurationGroup=configurationGroup, phyStatusGroup=phyStatusGroup, receiveChannel=receiveChannel, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, vLANManagementVID=vLANManagementVID, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, transmitPower=transmitPower, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, severelyErroredSeconds=severelyErroredSeconds, auxPortAllocation=auxPortAllocation, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, dNSServerTableNumber=dNSServerTableNumber, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, managementPortWirelessDownAlert=managementPortWirelessDownAlert, bridge=bridge, ethernetInstancedTable=ethernetInstancedTable, wirelessOutOctets=wirelessOutOctets, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsPeaks=dfsPeaks, versions=versions, hTTPPortNumber=hTTPPortNumber, remoteInternetAddress=remoteInternetAddress, wirelessTopology=wirelessTopology, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, hCMPMaximumLinkRange=hCMPMaximumLinkRange, ethernetStatisticsDataSource=ethernetStatisticsDataSource, timeZone=timeZone, qOSPriorityScheme=qOSPriorityScheme, aggregateDataRateLinked=aggregateDataRateLinked, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, byteErrorRatio=byteErrorRatio, cableLoss=cableLoss, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, mABNominalTransmitCapacity=mABNominalTransmitCapacity, userPassword=userPassword, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, dNSServerTableIndex=dNSServerTableIndex, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, lowestDataModulationMode=lowestDataModulationMode, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, remoteMACAddressLinked=remoteMACAddressLinked, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, localPacketFiltering=localPacketFiltering, auxPortSyncERxStatus=auxPortSyncERxStatus, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mainPSUPortStatusTrap=mainPSUPortStatusTrap, licenseGasGroup=licenseGasGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, capacityVariantMismatch=capacityVariantMismatch, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, ethernetInstancedTableIndex=ethernetInstancedTableIndex, encryption=encryption, mABProtocolVID=mABProtocolVID, dfsMeans=dfsMeans, installStatus=installStatus, dfsTable=dfsTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, alarms=alarms, cableDiagPair1Distance=cableDiagPair1Distance, sNTPLastSync=sNTPLastSync, ptpGroups=ptpGroups, installArmState=installArmState, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, resetGroup=resetGroup, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, enableTransmission=enableTransmission, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseIssueNumber=licenseIssueNumber, auxPortAcceptedQLRx=auxPortAcceptedQLRx, cableDiagnosticsWarning=cableDiagnosticsWarning, mABProtocolVLANPriority=mABProtocolVLANPriority, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, linkName=linkName, cableDiagnosticsResultTable=cableDiagnosticsResultTable, linkLossLinked=linkLossLinked, authorizationControlTableIndex=authorizationControlTableIndex, masterSlaveMode=masterSlaveMode, licenseHCMPSupport=licenseHCMPSupport, ptpCompliance=ptpCompliance, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, aggregateDataRate=aggregateDataRate, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, l2CPPriorityTable=l2CPPriorityTable, ethernetInstancedTableNumber=ethernetInstancedTableNumber, mgmtInstancedTable=mgmtInstancedTable, wirelessOutAllOctets=wirelessOutAllOctets, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, productName=productName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, systemClock=systemClock, installArmStateTrap=installArmStateTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseBandwidthCap=licenseBandwidthCap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", snmpControlGroup=snmpControlGroup, sFPPortSyncERxStatus=sFPPortSyncERxStatus, license=license, iPv6PrefixLength=iPv6PrefixLength, licenseOOBManagementSupport=licenseOOBManagementSupport, dNSResolver=dNSResolver, phyControlInstancedTable=phyControlInstancedTable, nIDULanPortAutoMdix=nIDULanPortAutoMdix, configurationInstancedTableIndex=configurationInstancedTableIndex, remoteUnitName=remoteUnitName, syncETrackingState=syncETrackingState, ptpTrapPrefix=ptpTrapPrefix, phyInstancedStatusTable=phyInstancedStatusTable, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPState=sNTPState, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, ethernet=ethernet, transmitDataRateLinked=transmitDataRateLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, routerProtocolsGroup=routerProtocolsGroup, mABMaintenanceLevel=mABMaintenanceLevel, remoteMACAddress=remoteMACAddress, tDMInterfaceControl=tDMInterfaceControl, licenseRARSupport=licenseRARSupport, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receiveDataRateLinked=receiveDataRateLinked, notificationsGroup=notificationsGroup, cambium=cambium, tdmTableEntry=tdmTableEntry, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, licenseInstancedTableNumber=licenseInstancedTableNumber, telnetPortNumber=telnetPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, cableDiagnosticsPorts=cableDiagnosticsPorts, userTableEntry=userTableEntry, portAllocationMismatch=portAllocationMismatch, packetsFromInternalStack=packetsFromInternalStack, sNMPTrapVersion=sNMPTrapVersion, sNTPServerTableNumber=sNTPServerTableNumber, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, hTTPAccessEnabled=hTTPAccessEnabled, supplementary=supplementary, alarmInstancedTable=alarmInstancedTable, licenseInstancedTable=licenseInstancedTable, userTable=userTable, searchState=searchState, antennaGain=antennaGain, installStatusLinked=installStatusLinked, sFPPortStatusTrap=sFPPortStatusTrap, siteName=siteName, tFTPServerInternetAddress=tFTPServerInternetAddress, subbandLowestFrequency=subbandLowestFrequency, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, auxPortDisabledWarning=auxPortDisabledWarning, capacityVariantMismatchLinked=capacityVariantMismatchLinked, maximumTransmitPower=maximumTransmitPower, licenseIEEE1588Support=licenseIEEE1588Support)
