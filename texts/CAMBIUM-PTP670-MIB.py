...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", authorizationControlGroup=authorizationControlGroup, phyControlInstancedTableIndex=phyControlInstancedTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfs=dfs, transparentClockPort=transparentClockPort, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseOOBManagementSupport=licenseOOBManagementSupport, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, linkName=linkName, managementGroup=managementGroup, sNTPServerRetries=sNTPServerRetries, capacityVariantMismatchTrap=capacityVariantMismatchTrap, syslogClientTrap=syslogClientTrap, syncEEquipmentClock=syncEEquipmentClock, mainPSUPortQLRx=mainPSUPortQLRx, licenseGasGroup=licenseGasGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseInstancedTable=licenseInstancedTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, dNSServerTable=dNSServerTable, sNTPPollInterval=sNTPPollInterval, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, transmitDataRateLinked=transmitDataRateLinked, supplementary=supplementary, vectorError=vectorError, routerProtocols=routerProtocols, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syncETrackingState=syncETrackingState, receiveFreqKHz=receiveFreqKHz, aAAControl=aAAControl, unitOutOfCalibration=unitOutOfCalibration, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cableDiagPair4Results=cableDiagPair4Results, dfsTableNumber=dfsTableNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, cableDiagPair1Distance=cableDiagPair1Distance, syslogControlGroup=syslogControlGroup, syncETracking=syncETracking, transmitFreqKHz=transmitFreqKHz, phyStatus=phyStatus, sNTPSyncTrap=sNTPSyncTrap, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableNumber=sNMPTrapTableNumber, sFPPortStatus=sFPPortStatus, aggregateDataRate=aggregateDataRate, transmitterChannels=transmitterChannels, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, wirelessTopology=wirelessTopology, tdmTableNumber=tdmTableNumber, licenseVersion=licenseVersion, daylightSaving=daylightSaving, cableDiagPair2Distance=cableDiagPair2Distance, cableDiagPair1Results=cableDiagPair1Results, accessMethod=accessMethod, tFTPServerInternetAddressType=tFTPServerInternetAddressType, userTableIndex=userTableIndex, whitelistRMMacAddress=whitelistRMMacAddress, receiveChannel=receiveChannel, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, ethernetInstancedTableNumber=ethernetInstancedTableNumber, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, signalStrengthRatioLinked=signalStrengthRatioLinked, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, installationMode=installationMode, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, dfsTableIndex=dfsTableIndex, ptpGroups=ptpGroups, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseIssueNumber=licenseIssueNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, whitelistRMEnabled=whitelistRMEnabled, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, dfsPeaks=dfsPeaks, secureModeAlarmTrap=secureModeAlarmTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sNMPCommunityString=sNMPCommunityString, authorizationControlTableEntry=authorizationControlTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, cableDiagnostics=cableDiagnostics, alarms=alarms, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, syslogControl=syslogControl, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDMChannelStatusTrap=tDMChannelStatusTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aAAControlGroup=aAAControlGroup, cableLoss=cableLoss, licenseSyncESupport=licenseSyncESupport, userRole=userRole, userName=userName, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dSCPManagementPriority=dSCPManagementPriority, transmitDataRate=transmitDataRate, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseTDDSyncSupport=licenseTDDSyncSupport, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataBridgingStatusLinked=dataBridgingStatusLinked, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mgmtInstancedTable=mgmtInstancedTable, txColorCode=txColorCode, iPv6PrefixLength=iPv6PrefixLength, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, enableTransmission=enableTransmission, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, txMABFrames=txMABFrames, licenseSFPPortSupport=licenseSFPPortSupport, tDMEnabledChannels=tDMEnabledChannels, apcGroup=apcGroup, sFPErrorTrap=sFPErrorTrap, alarmInstancedTable=alarmInstancedTable, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, vLANManagementVID=vLANManagementVID, licenseIPv6Support=licenseIPv6Support, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, wirelessOutOctets=wirelessOutOctets, blacklistRMMacAddress=blacklistRMMacAddress, snmpControl=snmpControl, sNTPState=sNTPState, dataBridgingStatusAlarm=dataBridgingStatusAlarm, packetsToInternalStack=packetsToInternalStack, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDControlGroup=tDDControlGroup, vectorErrorLinked=vectorErrorLinked, tDMGroup=tDMGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sFPError=sFPError, linkSymmetry=linkSymmetry, tempPcb=tempPcb, userTableNumber=userTableNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseInstancedTableNumber=licenseInstancedTableNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, wirelessOutAllOctets=wirelessOutAllOctets, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receivePowerLinked=receivePowerLinked, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPPortStatusTrap=sFPPortStatusTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseGroupAccess=licenseGroupAccess, dNSGroup=dNSGroup, ethernetInstancedTableIndex=ethernetInstancedTableIndex, rawReceivePowerLinked=rawReceivePowerLinked, signalStrengthRatio=signalStrengthRatio, deviceMACAddress=deviceMACAddress, installStatusLinked=installStatusLinked, configurationInstancedTable=configurationInstancedTable, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, configurationGroup=configurationGroup, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, transparentClockVID=transparentClockVID, mainPSUPortAllocation=mainPSUPortAllocation, dNSServerInternetAddress=dNSServerInternetAddress, capacityVariantMismatch=capacityVariantMismatch, frequencyVariant=frequencyVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, eIRP=eIRP, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, mainPSUPortStatus=mainPSUPortStatus, mABNominalModulationMode=mABNominalModulationMode, dNSServerTableNumber=dNSServerTableNumber, dNSServerInternetAddressType=dNSServerInternetAddressType, licenseRegulatoryBandsList=licenseRegulatoryBandsList, licenseRARSupport=licenseRARSupport, iPv6GatewayAddress=iPv6GatewayAddress, syncESlavePort=syncESlavePort, tFTPServerPortNumber=tFTPServerPortNumber, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseTLSRekey=licenseTLSRekey, remoteMACAddressLinked=remoteMACAddressLinked, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, remoteMACAddress=remoteMACAddress, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, wirelessLinkStatusLinked=wirelessLinkStatusLinked, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tDMChannelLineCode=tDMChannelLineCode, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, regulatoryBandTrap=regulatoryBandTrap, iPv6Address=iPv6Address, auxPortQLTx=auxPortQLTx, cableDiagnosticsPorts=cableDiagnosticsPorts, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNTPServerInternetAddress=sNTPServerInternetAddress, management=management, latitude=latitude, licenseEncryption=licenseEncryption, incompatibleRegulatoryBands=incompatibleRegulatoryBands, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, remoteInternetAddressType=remoteInternetAddressType, transmitFreqMHz=transmitFreqMHz, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, hTTPSPortNumber=hTTPSPortNumber, auxPortStatusTrap=auxPortStatusTrap, dfsTable=dfsTable, bridge=bridge, auxPortDisabledWarning=auxPortDisabledWarning, mABState=mABState, tFTPClient=tFTPClient, lowestTDMModulationMode=lowestTDMModulationMode, tdmTable=tdmTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, linkLossLinked=linkLossLinked, phyInstancedStatusTable=phyInstancedStatusTable, dfsTableEntry=dfsTableEntry, cableDiagnosticsGroup=cableDiagnosticsGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortPauseFrames=dataPortPauseFrames, tDMInterfaceControl=tDMInterfaceControl, licenseCapacity=licenseCapacity, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, severelyErroredSeconds=severelyErroredSeconds, auxPortStatus=auxPortStatus, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, dNS=dNS, sNTPServerPortNumber=sNTPServerPortNumber, remoteUnitName=remoteUnitName, ethernet=ethernet, phyControlInstancedTableEntry=phyControlInstancedTableEntry, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, portAllocationMismatchTrap=portAllocationMismatchTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, licenseGroup=licenseGroup, dfsMeans=dfsMeans)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, systemReset=systemReset, localPacketFiltering=localPacketFiltering, notificationsGroup=notificationsGroup, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, configurationInstancedTableIndex=configurationInstancedTableIndex, pubStats=pubStats, resetGroup=resetGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, installArmStateTrap=installArmStateTrap, byteErrorRatio=byteErrorRatio, secureModeAlarm=secureModeAlarm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rangeLinked=rangeLinked, alarmInstancedTableEntry=alarmInstancedTableEntry, syslogClient=syslogClient, installStatus=installStatus, sFPPortAllocation=sFPPortAllocation, cableDiagPair3Results=cableDiagPair3Results, ethernetPriorityTableEntry=ethernetPriorityTableEntry, useVLANForMABProtocol=useVLANForMABProtocol, unitName=unitName, cableDiagnosticsResultTable=cableDiagnosticsResultTable, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, lowestDataModulationMode=lowestDataModulationMode, alarmsGroup=alarmsGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, altitude=altitude, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, phyControlGroup=phyControlGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sMTPEnabledMessages=sMTPEnabledMessages, sFPPortQLRx=sFPPortQLRx, regulatoryBand=regulatoryBand, licenseCountry=licenseCountry, auxPortAllocation=auxPortAllocation, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, syslogState=syslogState, licenseHCMPSupport=licenseHCMPSupport, sNTPPrimaryServer=sNTPPrimaryServer, tDMChannelLoopback=tDMChannelLoopback, configuration=configuration, groupID=groupID, unitIdentification=unitIdentification, configurationInstancedTableNumber=configurationInstancedTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, pubStatsGroup=pubStatsGroup, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, supplementaryGroup=supplementaryGroup, ptpCompliance=ptpCompliance, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, telnetAccessEnabled=telnetAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, channelChangeTrap=channelChangeTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, noWirelessChannelAvailable=noWirelessChannelAvailable, dNSServerPortNumber=dNSServerPortNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rangingMode=rangingMode, dataBridgingStatus=dataBridgingStatus, sNTPServerTimeout=sNTPServerTimeout, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveDataRateLinked=receiveDataRateLinked, dNSPrimaryServer=dNSPrimaryServer, masterSlaveMode=masterSlaveMode, authorizationControlTable=authorizationControlTable, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, unavailableSeconds=unavailableSeconds, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, bridgeGroup=bridgeGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, aggregateDataRateLinked=aggregateDataRateLinked, cableDiagnosticsControl=cableDiagnosticsControl, vLANManagementPriority=vLANManagementPriority, blacklistRMEnabled=blacklistRMEnabled, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, maximumNumberOfSlaves=maximumNumberOfSlaves, transmitPowerLinked=transmitPowerLinked, l2CPPriorityTableIndex=l2CPPriorityTableIndex, byteErrorRatioLinked=byteErrorRatioLinked, apc=apc, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, erroredSeconds=erroredSeconds, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDSynchronizationMode=tDDSynchronizationMode, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mABMaintenanceLevel=mABMaintenanceLevel, sNMPv3Enable=sNMPv3Enable, transmitPower=transmitPower, subnetMask=subnetMask, ptmp=ptmp, tdmTableIndex=tdmTableIndex, channelBandwidth=channelBandwidth, receiveDataRate=receiveDataRate, range=range, deviceESN=deviceESN, sNTPSync=sNTPSync, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, phyControlInstancedTable=phyControlInstancedTable, rxColorCode=rxColorCode, mainPSUPortQLTx=mainPSUPortQLTx, authorizationControl=authorizationControl, mainPSUPortSSMTx=mainPSUPortSSMTx, mainPSUPortAutoMdix=mainPSUPortAutoMdix, subbandLowestFrequency=subbandLowestFrequency, wirelessLinkAvailability=wirelessLinkAvailability, systemClock=systemClock, licenseIEEE1588Support=licenseIEEE1588Support, tFTPServerInternetAddress=tFTPServerInternetAddress, sntpGroup=sntpGroup, antennaGain=antennaGain, targetRange=targetRange, ptp=ptp, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersion=softwareVersion, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, alarmInstancedTableNumber=alarmInstancedTableNumber, licenseInstancedTableIndex=licenseInstancedTableIndex, ethernetInstancedTable=ethernetInstancedTable, reset=reset, bootVersion=bootVersion, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, transparentClockVLAN=transparentClockVLAN, ethernetGroup=ethernetGroup, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, nIDULanPortStatusTrap=nIDULanPortStatusTrap, remoteUnitNameLinked=remoteUnitNameLinked, sNMPTrapTable=sNMPTrapTable, searchStateLinked=searchStateLinked, l2CPPriorityTable=l2CPPriorityTable, licenseSecurityLevel=licenseSecurityLevel, dfsGroup=dfsGroup, deviceMSN=deviceMSN, linkLoss=linkLoss, userTableEntry=userTableEntry, nIDULanPortStatus=nIDULanPortStatus, longitude=longitude, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryptionAlgorithm=encryptionAlgorithm, mABHoldoffPeriod=mABHoldoffPeriod, sNTPServerStatus=sNTPServerStatus, smtpGroup=smtpGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, portAllocationMismatchLinked=portAllocationMismatchLinked, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortStatusTrap=mainPSUPortStatusTrap, telnetPortNumber=telnetPortNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, licenseTrialPeriod=licenseTrialPeriod, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, tDMInterfaceStatus=tDMInterfaceStatus, targetMACAddress=targetMACAddress, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, auxPortAcceptedQLRx=auxPortAcceptedQLRx, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, configurationInstancedTableEntry=configurationInstancedTableEntry, licenseBandwidthCap=licenseBandwidthCap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dataBridgingAvailability=dataBridgingAvailability, snmpControlGroup=snmpControlGroup, tdmTableEntry=tdmTableEntry, userPassword=userPassword, phyStatusGroup=phyStatusGroup, authorizationControlTableNumber=authorizationControlTableNumber, productVariant=productVariant, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, tDM=tDM, PYSNMP_MODULE_ID=cambium, sMTPSourceEmailAddress=sMTPSourceEmailAddress, portAllocationMismatch=portAllocationMismatch, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, productName=productName, cableDiagPair3Distance=cableDiagPair3Distance, mgmtInstancedTableNumber=mgmtInstancedTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPVersion=iPVersion, sNTPServerTableIndex=sNTPServerTableIndex, sNTPLastSync=sNTPLastSync, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, auxPortConfigurationMismatch=auxPortConfigurationMismatch, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sNMPPortNumber=sNMPPortNumber, alarmInstancedTableIndex=alarmInstancedTableIndex, receivePower=receivePower, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, transmitModulationModeLinked=transmitModulationModeLinked, userTable=userTable, qOSPriorityScheme=qOSPriorityScheme, transparentClock=transparentClock, authorizationControlTableIndex=authorizationControlTableIndex, receiveFreqMHz=receiveFreqMHz, sntp=sntp, sFPPortQLTx=sFPPortQLTx, versionsGroup=versionsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, hardwareVersion=hardwareVersion, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, hCMPMaximumLinkRange=hCMPMaximumLinkRange, encryption=encryption, ethernetPriorityTable=ethernetPriorityTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, cableDiagPair4Distance=cableDiagPair4Distance, hCMPLinkSymmetry=hCMPLinkSymmetry, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, transmitChannel=transmitChannel, sFPPortAutoMdix=sFPPortAutoMdix, smtp=smtp, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, timeZone=timeZone, receiveModulationMode=receiveModulationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sFPPortDisabledWarning=sFPPortDisabledWarning, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, dNSServerTableEntry=dNSServerTableEntry, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sNMPTrapVersion=sNMPTrapVersion, ptp670=ptp670, dNSResolver=dNSResolver)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPServerTableNumber=sNTPServerTableNumber, userEnabled=userEnabled, dNSServerTableIndex=dNSServerTableIndex, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, tDDControl=tDDControl, rawReceivePower=rawReceivePower, syslogStateTrap=syslogStateTrap, license=license, mABProtocolVID=mABProtocolVID, cableDiagPair2Results=cableDiagPair2Results, sFPPortSSMTx=sFPPortSSMTx, tDMChannelCableLength=tDMChannelCableLength, wirelessLinkStatus=wirelessLinkStatus, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sMTPServerInternetAddress=sMTPServerInternetAddress, iPv4Address=iPv4Address, auxPortQLRx=auxPortQLRx, licenseInstancedTableEntry=licenseInstancedTableEntry, phyControl=phyControl, packetsFromInternalStack=packetsFromInternalStack, receiveModulationModeLinked=receiveModulationModeLinked, maximumTransmitPower=maximumTransmitPower, sNTPServerTable=sNTPServerTable, antennaSelection=antennaSelection, unitIdentificationGroup=unitIdentificationGroup, mgmtInstancedTableIndex=mgmtInstancedTableIndex, cambium=cambium, searchState=searchState, encryptionGroup=encryptionGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, ptpTrapPrefix=ptpTrapPrefix, extendedSpectrumScanning=extendedSpectrumScanning, authorizationMethod=authorizationMethod, remoteInternetAddress=remoteInternetAddress, tDMChannelStatus=tDMChannelStatus, linkModeOptimization=linkModeOptimization, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, installArmState=installArmState, sNTPServerTableEntry=sNTPServerTableEntry, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, siteName=siteName, licenseMaxLinkRange=licenseMaxLinkRange, ethernetInstancedTableEntry=ethernetInstancedTableEntry, transmitModulationMode=transmitModulationMode, sFPPortSyncERxStatus=sFPPortSyncERxStatus, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, hTTPPortNumber=hTTPPortNumber, lbtDetectedTrap=lbtDetectedTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, pubInstancedStatsTable=pubInstancedStatsTable, cableDiagnosticsWarning=cableDiagnosticsWarning, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernetStatisticsTable=ethernetStatisticsTable, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mABTransmissionInterval=mABTransmissionInterval, linkModeOptimizationMismatch=linkModeOptimizationMismatch, routerProtocolsGroup=routerProtocolsGroup, versions=versions, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, installStatusTrap=installStatusTrap, auxPortSSMTx=auxPortSSMTx)
