...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, receivePower=receivePower, iPDSCPPriorityTable=iPDSCPPriorityTable, management=management, sFPPortQLRx=sFPPortQLRx, targetMACAddress=targetMACAddress, tDDControlGroup=tDDControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, qOSPriorityScheme=qOSPriorityScheme, aggregateDataRateLinked=aggregateDataRateLinked, wirelessOutOctets=wirelessOutOctets, dNSServerTableIndex=dNSServerTableIndex, pubInstancedStatsTable=pubInstancedStatsTable, cableDiagPair2Distance=cableDiagPair2Distance, phyControlGroup=phyControlGroup, encryptionGroup=encryptionGroup, daylightSaving=daylightSaving, cableDiagPair3Results=cableDiagPair3Results, userName=userName, searchState=searchState, maxLinkRangeExceeded=maxLinkRangeExceeded, ptpTraps=ptpTraps, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, packetsToInternalStack=packetsToInternalStack, receiveModulationModeDetail=receiveModulationModeDetail, managementPortWirelessDownAlert=managementPortWirelessDownAlert, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, remoteUnitNameLinked=remoteUnitNameLinked, tDMEnabledChannels=tDMEnabledChannels, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, cableDiagnosticsControl=cableDiagnosticsControl, tempPcb=tempPcb, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mgmtInstancedTableIndex=mgmtInstancedTableIndex, dfsTable=dfsTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPPortNumber=sNMPPortNumber, dfsMeans=dfsMeans, licenseBandwidthCap=licenseBandwidthCap, antennaSelection=antennaSelection, licenseSyncESupport=licenseSyncESupport, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tDDSynchronizationStatus=tDDSynchronizationStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseInstancedTableNumber=licenseInstancedTableNumber, dataBridgingStatus=dataBridgingStatus, remoteInternetAddressType=remoteInternetAddressType, userTableIndex=userTableIndex, dNSGroup=dNSGroup, userTable=userTable, authorizationControlTableEntry=authorizationControlTableEntry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, ethernetPriorityTableNumber=ethernetPriorityTableNumber, syncESlavePort=syncESlavePort, sNMPTrapPortNumber=sNMPTrapPortNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, extendedSpectrumScanning=extendedSpectrumScanning, syncEEquipmentClock=syncEEquipmentClock, licenseMaxLinkRange=licenseMaxLinkRange, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, cableDiagnosticsGroup=cableDiagnosticsGroup, installStatus=installStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mABProtocolVID=mABProtocolVID, mABState=mABState, mABTransmissionInterval=mABTransmissionInterval, unitIdentification=unitIdentification, targetRange=targetRange, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, licenseHCMPSupport=licenseHCMPSupport, tDMInterfaceControl=tDMInterfaceControl, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, maximumTransmitPower=maximumTransmitPower, alarmsGroup=alarmsGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, transmitDataRateLinked=transmitDataRateLinked, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, cableDiagPair1Results=cableDiagPair1Results, configurationInstancedTableIndex=configurationInstancedTableIndex, subbandHighestFrequency=subbandHighestFrequency, ethernetInstancedTableIndex=ethernetInstancedTableIndex, mABProtocolVLANPriority=mABProtocolVLANPriority, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, vectorErrorLinked=vectorErrorLinked, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, eIRP=eIRP, rawReceivePowerLinked=rawReceivePowerLinked, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, remoteInternetAddress=remoteInternetAddress, userTableEntry=userTableEntry, transmitPowerLinked=transmitPowerLinked, ethernetGroup=ethernetGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, rangeLinked=rangeLinked, userTableNumber=userTableNumber, sNTPServerRetries=sNTPServerRetries, supplementaryGroup=supplementaryGroup, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, txMABFrames=txMABFrames, phyControlInstancedTableNumber=phyControlInstancedTableNumber, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, syslogControlGroup=syslogControlGroup, tDDSynchronizationMode=tDDSynchronizationMode, tDMChannelCableLength=tDMChannelCableLength, signalStrengthRatio=signalStrengthRatio, wirelessTopology=wirelessTopology, encryptionAlgorithm=encryptionAlgorithm, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, telnetAccessEnabled=telnetAccessEnabled, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userPassword=userPassword, ethernetPriorityTable=ethernetPriorityTable, dNSServerTable=dNSServerTable, ptpGroups=ptpGroups, cableDiagPair4Distance=cableDiagPair4Distance, secureModeAlarm=secureModeAlarm, capacityVariantMismatchTrap=capacityVariantMismatchTrap, dfsTableEntry=dfsTableEntry, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, cableDiagPair1Distance=cableDiagPair1Distance, sFPPortSSMTx=sFPPortSSMTx, licenseTDDSyncSupport=licenseTDDSyncSupport, enableTransmission=enableTransmission, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfs=dfs, whitelistRMMacAddress=whitelistRMMacAddress, transparentClockVLAN=transparentClockVLAN, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, smtp=smtp, telnetPortNumber=telnetPortNumber, auxPortConfigurationMismatch=auxPortConfigurationMismatch, licenseSFPPortSupport=licenseSFPPortSupport, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, cableDiagPair3Distance=cableDiagPair3Distance, tDMChannelLineCode=tDMChannelLineCode, phyControlInstancedTable=phyControlInstancedTable, aggregateDataRate=aggregateDataRate, alarmInstancedTableNumber=alarmInstancedTableNumber, licenseRARSupport=licenseRARSupport, licenseTLSRekey=licenseTLSRekey, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNTPServerTableIndex=sNTPServerTableIndex, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, mABMaintenanceLevel=mABMaintenanceLevel, cableLoss=cableLoss, rangingMode=rangingMode, mainPSUPortSSMTx=mainPSUPortSSMTx, configurationInstancedTableEntry=configurationInstancedTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, ptpCompliance=ptpCompliance, configuration=configuration, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, nIDULanPortStatus=nIDULanPortStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, productVariant=productVariant, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sFPPortStatusTrap=sFPPortStatusTrap, remoteMACAddress=remoteMACAddress, channelBandwidth=channelBandwidth, deviceMACAddress=deviceMACAddress, mainPSUPortStatus=mainPSUPortStatus, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, range=range, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDMChannelStatus=tDMChannelStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, maximumNumberOfSlaves=maximumNumberOfSlaves, auxPortStatusTrap=auxPortStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, regulatoryBandTrap=regulatoryBandTrap, hardwareVersion=hardwareVersion, authorizationControl=authorizationControl, ethernetInstancedTable=ethernetInstancedTable, linkLossLinked=linkLossLinked, auxPortSSMTx=auxPortSSMTx, mABHoldoffPeriod=mABHoldoffPeriod, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, longitude=longitude, capacityVariantMismatchLinked=capacityVariantMismatchLinked, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, transmitFreqMHz=transmitFreqMHz, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, dfsGroup=dfsGroup, sFPErrorTrap=sFPErrorTrap, aAAControlGroup=aAAControlGroup, phyInstancedStatusTable=phyInstancedStatusTable, ethernet=ethernet, dfsPeaks=dfsPeaks, sNMPv3Enable=sNMPv3Enable, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, systemReset=systemReset, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, apc=apc, secureModeAlarmTrap=secureModeAlarmTrap, remoteMACAddressLinked=remoteMACAddressLinked, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mainPSUPortQLRx=mainPSUPortQLRx, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, searchStateLinked=searchStateLinked, sNTPServerPortNumber=sNTPServerPortNumber, receiveChannel=receiveChannel, versionsGroup=versionsGroup, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, dataPortPauseFrames=dataPortPauseFrames, transmitPower=transmitPower, licenseIPv6Support=licenseIPv6Support, sNMPCommunityString=sNMPCommunityString, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, deviceMSN=deviceMSN, installStatusTrap=installStatusTrap, aAAControl=aAAControl, tDMGroup=tDMGroup, txColorCode=txColorCode, tDMChannelStatusTrap=tDMChannelStatusTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, dNSServerInternetAddress=dNSServerInternetAddress, ethernetInstancedTableEntry=ethernetInstancedTableEntry, routerProtocols=routerProtocols, dNSServerTableEntry=dNSServerTableEntry, versions=versions, installArmStateTrap=installArmStateTrap, licenseGroup=licenseGroup, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementary=supplementary, whitelistRMEnabled=whitelistRMEnabled, cableDiagnostics=cableDiagnostics)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transmitterChannels=transmitterChannels, sNTPServerTimeout=sNTPServerTimeout, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, channelChangeTrap=channelChangeTrap, notificationsGroup=notificationsGroup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, syslogControl=syslogControl, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenseInstancedTableIndex=licenseInstancedTableIndex, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tdmTableIndex=tdmTableIndex, receiveFreqKHz=receiveFreqKHz, localPacketFiltering=localPacketFiltering, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, secondarySoftwareVersion=secondarySoftwareVersion, portAllocationMismatchLinked=portAllocationMismatchLinked, syslogStateTrap=syslogStateTrap, transmitModulationModeLinked=transmitModulationModeLinked, auxPortAllocation=auxPortAllocation, lowestDataModulationMode=lowestDataModulationMode, userEnabled=userEnabled, timeZone=timeZone, phyControlInstancedTableEntry=phyControlInstancedTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, cableDiagPair2Results=cableDiagPair2Results, sNTPPollInterval=sNTPPollInterval, wirelessOutEthernetOctets=wirelessOutEthernetOctets, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, dataBridgingStatusLinked=dataBridgingStatusLinked, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, l2CPPriorityTable=l2CPPriorityTable, alarmInstancedTable=alarmInstancedTable, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, linkSymmetry=linkSymmetry, managementGroup=managementGroup, sNMPTrapVersion=sNMPTrapVersion, nIDULanPortAutoMdix=nIDULanPortAutoMdix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitModulationMode=transmitModulationMode, sNTPServerStatus=sNTPServerStatus, tDMInterfaceStatus=tDMInterfaceStatus, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, rawReceivePower=rawReceivePower, altitude=altitude, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, licenseOOBManagementSupport=licenseOOBManagementSupport, antennaGain=antennaGain, sNTPSync=sNTPSync, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, bridge=bridge, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, hCMPMaximumLinkRange=hCMPMaximumLinkRange, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, remoteUnitName=remoteUnitName, PYSNMP_MODULE_ID=cambium, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, auxPortQLRx=auxPortQLRx, sNTPState=sNTPState, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, ptmp=ptmp, licenseUnitSerialNumber=licenseUnitSerialNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, groupID=groupID, packetsFromInternalStack=packetsFromInternalStack, hTTPPortNumber=hTTPPortNumber, licenseEncryption=licenseEncryption, sFPError=sFPError, iPv6GatewayAddress=iPv6GatewayAddress, sMTPEmailAlert=sMTPEmailAlert, cableDiagPair4Results=cableDiagPair4Results, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, cambium=cambium, unitName=unitName, sMTPEnabledMessages=sMTPEnabledMessages, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, siteName=siteName, unitIdentificationGroup=unitIdentificationGroup, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, wirelessOutAllOctets=wirelessOutAllOctets, latitude=latitude, ptp=ptp, bootVersion=bootVersion, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, dataBridgingAvailability=dataBridgingAvailability, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, encryption=encryption, auxPortQLTx=auxPortQLTx, iPVersion=iPVersion, smtpGroup=smtpGroup, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, cableDiagnosticsWarning=cableDiagnosticsWarning, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tdmTableEntry=tdmTableEntry, ethernetStatisticsTable=ethernetStatisticsTable, rxColorCode=rxColorCode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, unavailableSeconds=unavailableSeconds, auxPortStatus=auxPortStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, byteErrorRatioLinked=byteErrorRatioLinked, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, iPv4Address=iPv4Address, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, l2CPPriorityTableIndex=l2CPPriorityTableIndex, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, alarmInstancedTableIndex=alarmInstancedTableIndex, cableDiagnosticsResultTable=cableDiagnosticsResultTable, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, accessMethod=accessMethod, tFTPServerInternetAddress=tFTPServerInternetAddress, nIDULanPortStatusTrap=nIDULanPortStatusTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, productName=productName, iPv6PrefixLength=iPv6PrefixLength, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, vectorError=vectorError, sFPPortStatus=sFPPortStatus, dNSServerInternetAddressType=dNSServerInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dNSResolver=dNSResolver, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, tDMChannelLoopback=tDMChannelLoopback, phyControlInstancedTableIndex=phyControlInstancedTableIndex, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseIssueNumber=licenseIssueNumber, lbtDetectedTrap=lbtDetectedTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, authorizationControlTable=authorizationControlTable, sNTPPrimaryServer=sNTPPrimaryServer, signalStrengthRatioLinked=signalStrengthRatioLinked, linkModeOptimization=linkModeOptimization, alarmInstancedTableEntry=alarmInstancedTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, mABNominalModulationMode=mABNominalModulationMode, unitOutOfCalibration=unitOutOfCalibration, licenseSecurityLevel=licenseSecurityLevel, license=license, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseIEEE1588Support=licenseIEEE1588Support, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPv6Address=iPv6Address, dNSServerTableNumber=dNSServerTableNumber, syncETrackingState=syncETrackingState, tFTPClient=tFTPClient, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sntp=sntp, routerProtocolsGroup=routerProtocolsGroup, vLANManagementPriority=vLANManagementPriority, syncETracking=syncETracking, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, lowestTDMModulationMode=lowestTDMModulationMode, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, cableDiagnosticsPorts=cableDiagnosticsPorts, transmitFreqKHz=transmitFreqKHz, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, phyControl=phyControl, ethernetStatisticsDataSource=ethernetStatisticsDataSource, installStatusLinked=installStatusLinked, sFPPortAllocation=sFPPortAllocation, subbandLowestFrequency=subbandLowestFrequency, hTTPSPortNumber=hTTPSPortNumber, tDDControl=tDDControl, tdmTable=tdmTable, tDM=tDM, incompatibleRegulatoryBands=incompatibleRegulatoryBands, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarms=alarms, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dNSServerPortNumber=dNSServerPortNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, linkLoss=linkLoss, authorizationControlTableNumber=authorizationControlTableNumber, snmpControlGroup=snmpControlGroup, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sFPPortAutoMdix=sFPPortAutoMdix, installArmState=installArmState, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sFPPortDisabledWarning=sFPPortDisabledWarning, subnetMask=subnetMask, licenseInstancedTableEntry=licenseInstancedTableEntry, receiveModulationModeLinked=receiveModulationModeLinked, syslogState=syslogState, masterSlaveMode=masterSlaveMode, vLANManagementVID=vLANManagementVID, auxPortDisabledWarning=auxPortDisabledWarning, transparentClockVID=transparentClockVID, sntpGroup=sntpGroup, receivePowerLinked=receivePowerLinked, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseGroupAccess=licenseGroupAccess, receiveDataRate=receiveDataRate, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, hCMPLinkSymmetry=hCMPLinkSymmetry, dNSPrimaryServer=dNSPrimaryServer, mainPSUPortAllocation=mainPSUPortAllocation, pubStats=pubStats, receiveModulationMode=receiveModulationMode, capacityVariantMismatch=capacityVariantMismatch, softwareVersion=softwareVersion, receiveFreqMHz=receiveFreqMHz, configurationInstancedTableNumber=configurationInstancedTableNumber, systemClock=systemClock, byteErrorRatio=byteErrorRatio, sNTPLastSync=sNTPLastSync, portAllocationMismatchTrap=portAllocationMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, blacklistRMEnabled=blacklistRMEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPSyncTrap=sNTPSyncTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNMPTrapTable=sNMPTrapTable, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNTPServerTableEntry=sNTPServerTableEntry, phyStatus=phyStatus, portAllocationMismatch=portAllocationMismatch, auxPortSyncERxStatus=auxPortSyncERxStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", frequencyVariant=frequencyVariant, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, blacklistRMMacAddress=blacklistRMMacAddress, erroredSeconds=erroredSeconds, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sMTPServerPortNumber=sMTPServerPortNumber, licenseCountry=licenseCountry, transmitChannel=transmitChannel, sNTPServerTable=sNTPServerTable, authorizationMethod=authorizationMethod, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, installationMode=installationMode, resetGroup=resetGroup, mgmtInstancedTableNumber=mgmtInstancedTableNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, apcGroup=apcGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, licenseVersion=licenseVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mainPSUPortQLTx=mainPSUPortQLTx, linkName=linkName, sNTPServerTableNumber=sNTPServerTableNumber, sFPPortQLTx=sFPPortQLTx, regulatoryBand=regulatoryBand, authorizationControlGroup=authorizationControlGroup, receiveDataRateLinked=receiveDataRateLinked, dfsTableIndex=dfsTableIndex, transparentClockPort=transparentClockPort, ptpTrapPrefix=ptpTrapPrefix, licenseGasGroup=licenseGasGroup, syslogClient=syslogClient, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, bridgeGroup=bridgeGroup, dNS=dNS, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tdmTableNumber=tdmTableNumber, licenseTrialPeriod=licenseTrialPeriod, deviceESN=deviceESN, licenseInstancedTable=licenseInstancedTable, snmpControl=snmpControl, configurationGroup=configurationGroup, severelyErroredSeconds=severelyErroredSeconds, useVLANForMABProtocol=useVLANForMABProtocol, authorizationControlTableIndex=authorizationControlTableIndex, transparentClock=transparentClock, configurationInstancedTable=configurationInstancedTable, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, syslogClientTrap=syslogClientTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableNumber=dfsTableNumber, licenseCapacity=licenseCapacity, transmitDataRate=transmitDataRate, userRole=userRole, ethernetInstancedTableNumber=ethernetInstancedTableNumber, mgmtInstancedTable=mgmtInstancedTable, ptp670=ptp670, reset=reset)
