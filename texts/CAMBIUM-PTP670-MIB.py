...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", authorizationControl=authorizationControl, receiveModulationMode=receiveModulationMode, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, dfsTableNumber=dfsTableNumber, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sFPErrorTrap=sFPErrorTrap, vLANManagementVID=vLANManagementVID, remoteInternetAddressLinked=remoteInternetAddressLinked, nIDULanPortStatusTrap=nIDULanPortStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, txColorCode=txColorCode, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, cableDiagPair4Distance=cableDiagPair4Distance, mPLSTCPriorityTable=mPLSTCPriorityTable, cableDiagPair2Distance=cableDiagPair2Distance, deviceMSN=deviceMSN, qOSPriorityScheme=qOSPriorityScheme, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, auxPortStatusTrap=auxPortStatusTrap, sNTPServerRetries=sNTPServerRetries, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, tdmTableIndex=tdmTableIndex, auxPortSyncERxStatus=auxPortSyncERxStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, cableDiagPair3Distance=cableDiagPair3Distance, iPv6Address=iPv6Address, dfsGroup=dfsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDM=tDM, incompatibleRegulatoryBands=incompatibleRegulatoryBands, dfsMeans=dfsMeans, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sNMPv3Enable=sNMPv3Enable, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, cableDiagPair3Results=cableDiagPair3Results, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPv6PrefixLength=iPv6PrefixLength, ethernet=ethernet, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, wirelessTopology=wirelessTopology, licenseSecurityLevel=licenseSecurityLevel, licenseGroupAccess=licenseGroupAccess, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, signalStrengthRatioLinked=signalStrengthRatioLinked, installationMode=installationMode, aggregateDataRate=aggregateDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, alarms=alarms, secureModeAlarm=secureModeAlarm, portAllocationMismatchTrap=portAllocationMismatchTrap, eIRP=eIRP, regulatoryBandTrap=regulatoryBandTrap, tDMInterfaceStatus=tDMInterfaceStatus, syslogClient=syslogClient, syslogControl=syslogControl, mgmtInstancedTable=mgmtInstancedTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, smtpGroup=smtpGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, dNSServerInternetAddressType=dNSServerInternetAddressType, licenseInstancedTable=licenseInstancedTable, licenseBandwidthCap=licenseBandwidthCap, linkSymmetry=linkSymmetry, gatewayIPAddress=gatewayIPAddress, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, syslogControlGroup=syslogControlGroup, licenseVersion=licenseVersion, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, configurationInstancedTableEntry=configurationInstancedTableEntry, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, mABProtocolVID=mABProtocolVID, telnetPortNumber=telnetPortNumber, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseSFPPortSupport=licenseSFPPortSupport, phyControlInstancedTableEntry=phyControlInstancedTableEntry, erroredSeconds=erroredSeconds, licenseTLSRekey=licenseTLSRekey, mainPSUPortAllocation=mainPSUPortAllocation, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, receivePowerLinked=receivePowerLinked, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sFPPortAutoNegotiation=sFPPortAutoNegotiation, ethernetInstancedTableIndex=ethernetInstancedTableIndex, ethernetPriorityTable=ethernetPriorityTable, sMTPServerInternetAddress=sMTPServerInternetAddress, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, dfs=dfs, pubInstancedStatsTable=pubInstancedStatsTable, transmitterChannels=transmitterChannels, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sFPPortSSMTx=sFPPortSSMTx, sNTPSyncTrap=sNTPSyncTrap, pubStats=pubStats, wirelessOutEthernetOctets=wirelessOutEthernetOctets, rangeLinked=rangeLinked, auxPortStatus=auxPortStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, cambium=cambium, severelyErroredSeconds=severelyErroredSeconds, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, transmitModulationModeLinked=transmitModulationModeLinked, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, dataBridgingStatus=dataBridgingStatus, enableTransmission=enableTransmission, apcGroup=apcGroup, antennaGain=antennaGain, iPVersion=iPVersion, dNS=dNS, sFPPortDisabledWarning=sFPPortDisabledWarning, unitName=unitName, productName=productName, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, aAAControl=aAAControl, encryption=encryption, mainPSUPortSSMTx=mainPSUPortSSMTx, ethernetStatisticsTable=ethernetStatisticsTable, sntpGroup=sntpGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseTrialPeriod=licenseTrialPeriod, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, tdmTableEntry=tdmTableEntry, sFPPortQLTx=sFPPortQLTx, transparentClock=transparentClock, managementNetworkAccessEnabled=managementNetworkAccessEnabled, hTTPSPortNumber=hTTPSPortNumber, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, maximumNumberOfSlaves=maximumNumberOfSlaves, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, syncEEquipmentClock=syncEEquipmentClock, routerProtocolsGroup=routerProtocolsGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, authorizationControlTableEntry=authorizationControlTableEntry, tFTPClient=tFTPClient, mABNominalTransmitCapacity=mABNominalTransmitCapacity, alarmInstancedTableEntry=alarmInstancedTableEntry, rxColorCode=rxColorCode, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteUnitName=remoteUnitName, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dNSServerTableIndex=dNSServerTableIndex, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitFreqKHz=transmitFreqKHz, licenseInstancedTableEntry=licenseInstancedTableEntry, syncESlavePort=syncESlavePort, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, maxLinkRangeExceeded=maxLinkRangeExceeded, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyControlInstancedTableNumber=phyControlInstancedTableNumber, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, dataBridgingStatusAlarm=dataBridgingStatusAlarm, cableDiagnosticsGroup=cableDiagnosticsGroup, mABProtocolVLANPriority=mABProtocolVLANPriority, softwareVersion=softwareVersion, management=management, searchState=searchState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapVersion=sNMPTrapVersion, dNSServerInternetAddress=dNSServerInternetAddress, hardwareVersion=hardwareVersion, cableDiagnosticsResultTable=cableDiagnosticsResultTable, auxPortAllocation=auxPortAllocation, transparentClockPort=transparentClockPort, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, rangingMode=rangingMode, telnetAccessEnabled=telnetAccessEnabled, sNTPLastSync=sNTPLastSync, licenseOOBManagementSupport=licenseOOBManagementSupport, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, extendedSpectrumScanning=extendedSpectrumScanning, reset=reset, vectorError=vectorError, snmpControlGroup=snmpControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, dNSServerTableNumber=dNSServerTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, receiveFreqKHz=receiveFreqKHz, configurationInstancedTable=configurationInstancedTable, subbandLowestFrequency=subbandLowestFrequency, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sNTPServerTableIndex=sNTPServerTableIndex, tDDControl=tDDControl, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, licenseInstancedTableIndex=licenseInstancedTableIndex, userPassword=userPassword, dataBridgingStatusLinked=dataBridgingStatusLinked, cableLoss=cableLoss, linkName=linkName, remoteInternetAddressType=remoteInternetAddressType, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogState=syslogState, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, installArmState=installArmState, alarmInstancedTableNumber=alarmInstancedTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, tDMChannelStatus=tDMChannelStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, aAAControlGroup=aAAControlGroup, tdmTable=tdmTable, encryptionGroup=encryptionGroup, linkModeOptimization=linkModeOptimization, portAllocationMismatchLinked=portAllocationMismatchLinked, auxPortDisabledWarning=auxPortDisabledWarning, deviceESN=deviceESN, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, installStatusLinked=installStatusLinked, capacityVariantMismatch=capacityVariantMismatch, userTableEntry=userTableEntry, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, authorizationControlTableNumber=authorizationControlTableNumber, auxPortQLTx=auxPortQLTx, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPPollInterval=sNTPPollInterval, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, vectorErrorLinked=vectorErrorLinked, linkLossLinked=linkLossLinked, tDMChannelLoopback=tDMChannelLoopback, sNTPPrimaryServer=sNTPPrimaryServer, sMTPServerPortNumber=sMTPServerPortNumber, dNSServerTableEntry=dNSServerTableEntry, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, cableDiagPair1Results=cableDiagPair1Results, installStatus=installStatus, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, regulatoryBand=regulatoryBand, tDMConfigurationMismatch=tDMConfigurationMismatch, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, rawReceivePower=rawReceivePower)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", channelBandwidth=channelBandwidth, longitude=longitude, alarmInstancedTableIndex=alarmInstancedTableIndex, tDMChannelStatusTrap=tDMChannelStatusTrap, accessMethod=accessMethod, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, configurationGroup=configurationGroup, phyControlInstancedTableIndex=phyControlInstancedTableIndex, ptpTraps=ptpTraps, licenseMaxLinkRange=licenseMaxLinkRange, userEnabled=userEnabled, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, lowestTDMModulationMode=lowestTDMModulationMode, installStatusTrap=installStatusTrap, searchStateLinked=searchStateLinked, ethernetInstancedTable=ethernetInstancedTable, wirelessLinkStatusLinked=wirelessLinkStatusLinked, receiveDataRateLinked=receiveDataRateLinked, licenseInstancedTableNumber=licenseInstancedTableNumber, hCMPLinkSymmetry=hCMPLinkSymmetry, license=license, receiveModulationModeLinked=receiveModulationModeLinked, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dfsTableEntry=dfsTableEntry, authorizationControlTableIndex=authorizationControlTableIndex, tDMChannelCableLength=tDMChannelCableLength, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, targetMACAddress=targetMACAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, sntp=sntp, licenseHCMPSupport=licenseHCMPSupport, range=range, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sFPError=sFPError, wirelessOutAllOctets=wirelessOutAllOctets, apc=apc, receiveChannel=receiveChannel, subnetMask=subnetMask, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, useVLANForMABProtocol=useVLANForMABProtocol, userTableIndex=userTableIndex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, blacklistRMEnabled=blacklistRMEnabled, mainPSUPortQLTx=mainPSUPortQLTx, subbandHighestFrequency=subbandHighestFrequency, wirelessLinkAvailability=wirelessLinkAvailability, sFPPortQLRx=sFPPortQLRx, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dNSGroup=dNSGroup, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sNMPTrapInternetAddress=sNMPTrapInternetAddress, nIDULanPortStatus=nIDULanPortStatus, mainPSUPortStatus=mainPSUPortStatus, cableDiagnosticsControl=cableDiagnosticsControl, licenseUnitSerialNumber=licenseUnitSerialNumber, unitIdentificationGroup=unitIdentificationGroup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, masterSlaveMode=masterSlaveMode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitDataRateLinked=transmitDataRateLinked, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, syslogClientTrap=syslogClientTrap, transmitPowerLinked=transmitPowerLinked, receiveFreqMHz=receiveFreqMHz, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, dNSResolver=dNSResolver, mgmtInstancedTableIndex=mgmtInstancedTableIndex, remoteUnitNameLinked=remoteUnitNameLinked, configurationInstancedTableNumber=configurationInstancedTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sNTPServerTable=sNTPServerTable, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNMPTrapTable=sNMPTrapTable, groupID=groupID, txMABFrames=txMABFrames, transmitPower=transmitPower, phyStatus=phyStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, mABMaintenanceLevel=mABMaintenanceLevel, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, mgmtInstancedTableEntry=mgmtInstancedTableEntry, tDMInterfaceControl=tDMInterfaceControl, licenseRARSupport=licenseRARSupport, sFPPortStatus=sFPPortStatus, remoteMACAddressLinked=remoteMACAddressLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch, bootVersion=bootVersion, maximumTransmitPower=maximumTransmitPower, secureModeAlarmTrap=secureModeAlarmTrap, licenseEncryption=licenseEncryption, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, cableDiagPair1Distance=cableDiagPair1Distance, userRole=userRole, hTTPAccessEnabled=hTTPAccessEnabled, auxPortAcceptedQLRx=auxPortAcceptedQLRx, remoteInternetAddress=remoteInternetAddress, sNMPEnabledTraps=sNMPEnabledTraps, byteErrorRatio=byteErrorRatio, dNSServerPortNumber=dNSServerPortNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, ptpTrapPrefix=ptpTrapPrefix, routerProtocols=routerProtocols, alarmInstancedTable=alarmInstancedTable, authorizationControlGroup=authorizationControlGroup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, PYSNMP_MODULE_ID=cambium, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControl=phyControl, ethernetInstancedTableEntry=ethernetInstancedTableEntry, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, userName=userName, authorizationMethod=authorizationMethod, transparentClockVID=transparentClockVID, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, transparentClockVLAN=transparentClockVLAN, supplementaryGroup=supplementaryGroup, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPv4Address=iPv4Address, sNTPSync=sNTPSync, systemReset=systemReset, sNTPServerPortNumber=sNTPServerPortNumber, sFPPortAutoMdix=sFPPortAutoMdix, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementGroup=managementGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetGroup=ethernetGroup, mABHoldoffPeriod=mABHoldoffPeriod, transmitChannel=transmitChannel, dfsTableIndex=dfsTableIndex, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, mABTransmissionInterval=mABTransmissionInterval, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, capacityVariantMismatchTrap=capacityVariantMismatchTrap, licenseIssueNumber=licenseIssueNumber, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, rawReceivePowerLinked=rawReceivePowerLinked, secondarySoftwareVersion=secondarySoftwareVersion, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, licenseIEEE1588Support=licenseIEEE1588Support, lowestDataModulationMode=lowestDataModulationMode, portAllocationMismatch=portAllocationMismatch, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogStateTrap=syslogStateTrap, vLANManagementPriority=vLANManagementPriority, dSCPManagementPriority=dSCPManagementPriority, dfsPeaks=dfsPeaks, transmitDataRate=transmitDataRate, licenseTDDSyncSupport=licenseTDDSyncSupport, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseIPv6Support=licenseIPv6Support, mABState=mABState, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, antennaSelection=antennaSelection, syncETracking=syncETracking, sNMPCommunityString=sNMPCommunityString, sNTPServerInternetAddressType=sNTPServerInternetAddressType, snmpControl=snmpControl, bridge=bridge, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, whitelistRMEnabled=whitelistRMEnabled, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDMGroup=tDMGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, dataPortPauseFrames=dataPortPauseFrames, unitOutOfCalibration=unitOutOfCalibration, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, timeZone=timeZone, ptmp=ptmp, unitIdentification=unitIdentification, userTable=userTable, notificationsGroup=notificationsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, blacklistRMMacAddress=blacklistRMMacAddress, mgmtInstancedTableNumber=mgmtInstancedTableNumber, receiveDataRate=receiveDataRate, pubStatsGroup=pubStatsGroup, licenseGroup=licenseGroup, channelChangeTrap=channelChangeTrap, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, mainPSUPortQLRx=mainPSUPortQLRx, syncETrackingState=syncETrackingState, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, signalStrengthRatio=signalStrengthRatio, tempPcb=tempPcb, lbtDetectedTrap=lbtDetectedTrap, phyControlGroup=phyControlGroup, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sNTPServerTimeout=sNTPServerTimeout, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, altitude=altitude, latitude=latitude, tDDSynchronizationAlarm=tDDSynchronizationAlarm, localPacketFiltering=localPacketFiltering, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkLoss=linkLoss, sFPPortStatusTrap=sFPPortStatusTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerPortNumber=tFTPServerPortNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, bridgeGroup=bridgeGroup, sMTPEmailAlert=sMTPEmailAlert, wirelessOutOctets=wirelessOutOctets, sNTPServerStatus=sNTPServerStatus, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNTPServerTableEntry=sNTPServerTableEntry, dNSServerTable=dNSServerTable, encryptionAlgorithm=encryptionAlgorithm, ptp670=ptp670, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cableDiagnostics=cableDiagnostics, phyInstancedStatusTable=phyInstancedStatusTable, sFPPortAllocation=sFPPortAllocation, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dNSPrimaryServer=dNSPrimaryServer, resetGroup=resetGroup, whitelistRMMacAddress=whitelistRMMacAddress, ptpGroups=ptpGroups, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, supplementary=supplementary, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagPair2Results=cableDiagPair2Results, productVariant=productVariant, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, systemClock=systemClock, ptp=ptp, userTableNumber=userTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagnosticsPorts=cableDiagnosticsPorts, sNTPState=sNTPState, tdmTableNumber=tdmTableNumber, licenseGasGroup=licenseGasGroup, mABNominalModulationMode=mABNominalModulationMode, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseCountry=licenseCountry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, versions=versions, packetsToInternalStack=packetsToInternalStack, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, packetsFromInternalStack=packetsFromInternalStack, tDMChannelLineCode=tDMChannelLineCode, remoteMACAddress=remoteMACAddress, targetRange=targetRange, licenseCapacity=licenseCapacity, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, wirelessLinkStatus=wirelessLinkStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, dfsTable=dfsTable, licenseSyncESupport=licenseSyncESupport, alarmsGroup=alarmsGroup, siteName=siteName, cableDiagPair4Results=cableDiagPair4Results, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, aggregateDataRateLinked=aggregateDataRateLinked, smtp=smtp, phyControlInstancedTable=phyControlInstancedTable, auxPortQLRx=auxPortQLRx, authorizationControlTable=authorizationControlTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, tDDControlGroup=tDDControlGroup, configuration=configuration, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, installArmStateTrap=installArmStateTrap, tDMEnabledChannels=tDMEnabledChannels, unavailableSeconds=unavailableSeconds, daylightSaving=daylightSaving, hTTPPortNumber=hTTPPortNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, versionsGroup=versionsGroup, deviceMACAddress=deviceMACAddress, receivePower=receivePower, transmitModulationMode=transmitModulationMode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortSSMTx=auxPortSSMTx, sMTPEnabledMessages=sMTPEnabledMessages, dataBridgingAvailability=dataBridgingAvailability, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, receiveModulationModeDetail=receiveModulationModeDetail, nIDULanPortAutoMdix=nIDULanPortAutoMdix, phyStatusGroup=phyStatusGroup, frequencyVariant=frequencyVariant, capacityVariantMismatchLinked=capacityVariantMismatchLinked, byteErrorRatioLinked=byteErrorRatioLinked, sNMPPortNumber=sNMPPortNumber, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry)
