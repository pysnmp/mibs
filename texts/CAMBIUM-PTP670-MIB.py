...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortDisabledWarning=sFPPortDisabledWarning, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, secondarySoftwareVersion=secondarySoftwareVersion, rawReceivePower=rawReceivePower, dNS=dNS, licenseInstancedTableNumber=licenseInstancedTableNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, packetsFromInternalStack=packetsFromInternalStack, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, rawReceivePowerLinked=rawReceivePowerLinked, transparentClockVLAN=transparentClockVLAN, sNTPSyncTrap=sNTPSyncTrap, ethernetGroup=ethernetGroup, phyControlInstancedTable=phyControlInstancedTable, userTableIndex=userTableIndex, installationMode=installationMode, sNTPSync=sNTPSync, sFPPortAllocation=sFPPortAllocation, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, maximumNumberOfSlaves=maximumNumberOfSlaves, dNSServerInternetAddressType=dNSServerInternetAddressType, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, versionsGroup=versionsGroup, signalStrengthRatio=signalStrengthRatio, sMTPServerPortNumber=sMTPServerPortNumber, licenseHCMPSupport=licenseHCMPSupport, supplementary=supplementary, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, tDMInterfaceStatus=tDMInterfaceStatus, packetsToInternalStack=packetsToInternalStack, sMTPEnabledMessages=sMTPEnabledMessages, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, transmitPowerLinked=transmitPowerLinked, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receivePowerLinked=receivePowerLinked, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, notificationsGroup=notificationsGroup, unitName=unitName, configurationInstancedTableNumber=configurationInstancedTableNumber, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseIssueNumber=licenseIssueNumber, syslogClient=syslogClient, configurationInstancedTable=configurationInstancedTable, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseSyncESupport=licenseSyncESupport, telnetPortNumber=telnetPortNumber, dataBridgingStatusAlarm=dataBridgingStatusAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, auxPortDisabledWarning=auxPortDisabledWarning, syslogControl=syslogControl, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, auxPortStatusTrap=auxPortStatusTrap, licenseGroupAccess=licenseGroupAccess, lowestTDMModulationMode=lowestTDMModulationMode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receivePower=receivePower, receiveFreqMHz=receiveFreqMHz, cableDiagPair3Results=cableDiagPair3Results, subnetMask=subnetMask, wirelessTopology=wirelessTopology, sFPPortQLTx=sFPPortQLTx, cableDiagPair3Distance=cableDiagPair3Distance, dfsPeaks=dfsPeaks, sNMPTrapTable=sNMPTrapTable, encryption=encryption, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, vectorError=vectorError, transmitFreqKHz=transmitFreqKHz, sNMPv3Enable=sNMPv3Enable, routerProtocolsGroup=routerProtocolsGroup, resetGroup=resetGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, userName=userName, dNSServerInternetAddress=dNSServerInternetAddress, ptmp=ptmp, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, syslogControlGroup=syslogControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessOutOctets=wirelessOutOctets, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, ethernetInstancedTableIndex=ethernetInstancedTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitDataRateLinked=transmitDataRateLinked, tDM=tDM, sFPPortQLRx=sFPPortQLRx, dNSPrimaryServer=dNSPrimaryServer, unavailableSeconds=unavailableSeconds, blacklistRMEnabled=blacklistRMEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, groupID=groupID, hardwareVersion=hardwareVersion, snmpControl=snmpControl, systemClock=systemClock, ethernetPriorityTableIndex=ethernetPriorityTableIndex, byteErrorRatio=byteErrorRatio, remoteInternetAddressType=remoteInternetAddressType, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, whitelistRMEnabled=whitelistRMEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, cableDiagPair1Distance=cableDiagPair1Distance, dataBridgingAvailability=dataBridgingAvailability, licenseTrialPeriod=licenseTrialPeriod, hCMPLinkSymmetry=hCMPLinkSymmetry, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, installStatus=installStatus, deviceMSN=deviceMSN, wirelessLinkAvailability=wirelessLinkAvailability, extendedSpectrumScanning=extendedSpectrumScanning, mABProtocolVLANPriority=mABProtocolVLANPriority, portAllocationMismatchTrap=portAllocationMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, range=range, eIRP=eIRP, localPacketFiltering=localPacketFiltering, aAAControlGroup=aAAControlGroup, mABTransmissionInterval=mABTransmissionInterval, syncETrackingState=syncETrackingState, tDDSynchronizationStatus=tDDSynchronizationStatus, tDMChannelCableLength=tDMChannelCableLength, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, remoteInternetAddressLinked=remoteInternetAddressLinked, alarmInstancedTable=alarmInstancedTable, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, transparentClock=transparentClock, phyControlInstancedTableEntry=phyControlInstancedTableEntry, auxPortQLTx=auxPortQLTx, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, auxPortSyncERxStatus=auxPortSyncERxStatus, phyControl=phyControl, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, ptp670=ptp670, auxPortQLRx=auxPortQLRx, sNMPCommunityString=sNMPCommunityString, deviceMACAddress=deviceMACAddress, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mABProtocolVID=mABProtocolVID, remoteMACAddress=remoteMACAddress, maximumTransmitPower=maximumTransmitPower, vLANManagementVID=vLANManagementVID, remoteMACAddressLinked=remoteMACAddressLinked, sFPPortStatus=sFPPortStatus, ptp=ptp, ethernetInstancedTableNumber=ethernetInstancedTableNumber, dfsTableIndex=dfsTableIndex, phyControlInstancedTableIndex=phyControlInstancedTableIndex, mgmtInstancedTable=mgmtInstancedTable, auxPortAllocation=auxPortAllocation, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitChannel=transmitChannel, tDMGroup=tDMGroup, tDMChannelStatus=tDMChannelStatus, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, transmitPower=transmitPower, dataPortPauseFrames=dataPortPauseFrames, authorizationControlTableNumber=authorizationControlTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sFPError=sFPError, channelChangeTrap=channelChangeTrap, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseSecurityLevel=licenseSecurityLevel, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, syncETracking=syncETracking, ethernetPriorityTable=ethernetPriorityTable, userRole=userRole, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, aAAControl=aAAControl, vectorErrorLinked=vectorErrorLinked, wirelessOutEthernetOctets=wirelessOutEthernetOctets, deviceESN=deviceESN, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tdmTableEntry=tdmTableEntry, tDDControlGroup=tDDControlGroup, dataBridgingStatus=dataBridgingStatus, txColorCode=txColorCode, receiveDataRateLinked=receiveDataRateLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, iPVersion=iPVersion, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tFTPServerPortNumber=tFTPServerPortNumber, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, transmitDataRate=transmitDataRate, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, subbandLowestFrequency=subbandLowestFrequency, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteInternetAddress=remoteInternetAddress, licenseCountry=licenseCountry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, searchState=searchState, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseCapacity=licenseCapacity, aggregateDataRateLinked=aggregateDataRateLinked, userTableNumber=userTableNumber, targetRange=targetRange, dSCPManagementPriority=dSCPManagementPriority, nIDULanPortAutoMdix=nIDULanPortAutoMdix, transmitFreqMHz=transmitFreqMHz, linkLoss=linkLoss, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, iPv6GatewayAddress=iPv6GatewayAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dfsMeans=dfsMeans, aggregateDataRate=aggregateDataRate, ethernet=ethernet, dNSGroup=dNSGroup, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, ptpTraps=ptpTraps, mABMaintenanceLevel=mABMaintenanceLevel, configuration=configuration, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseGasGroup=licenseGasGroup, licenseEncryption=licenseEncryption, frequencyVariant=frequencyVariant, licenseRegulatoryBandsList=licenseRegulatoryBandsList, unitOutOfCalibration=unitOutOfCalibration, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, timeZone=timeZone, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, signalStrengthRatioLinked=signalStrengthRatioLinked, dNSServerPortNumber=dNSServerPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetStatisticsTable=ethernetStatisticsTable, snmpControlGroup=snmpControlGroup, dNSServerTableNumber=dNSServerTableNumber, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, wirelessLinkStatusLinked=wirelessLinkStatusLinked, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, alarmsGroup=alarmsGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, systemReset=systemReset, configurationGroup=configurationGroup, portAllocationMismatchLinked=portAllocationMismatchLinked, sFPPortSyncERxStatus=sFPPortSyncERxStatus, softwareVersion=softwareVersion, wirelessLinkStatus=wirelessLinkStatus, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, receiveFreqKHz=receiveFreqKHz, authorizationControlTableIndex=authorizationControlTableIndex, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, phyInstancedStatusTable=phyInstancedStatusTable, rxColorCode=rxColorCode, smtp=smtp, alarms=alarms, mainPSUPortStatus=mainPSUPortStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, installArmStateTrap=installArmStateTrap, ethernetInstancedTable=ethernetInstancedTable, apc=apc, unitIdentification=unitIdentification, authorizationControlGroup=authorizationControlGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dfs=dfs, dfsGroup=dfsGroup, management=management, auxPortStatus=auxPortStatus, bridge=bridge, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sFPPortAutoNegotiation=sFPPortAutoNegotiation, cableDiagnostics=cableDiagnostics, sNMPEnabledTraps=sNMPEnabledTraps, linkModeOptimization=linkModeOptimization, receiveDataRate=receiveDataRate, licenseRARSupport=licenseRARSupport, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatusGroup=phyStatusGroup, mABHoldoffPeriod=mABHoldoffPeriod, cableDiagnosticsWarning=cableDiagnosticsWarning, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, pubInstancedStatsTable=pubInstancedStatsTable, alarmInstancedTableNumber=alarmInstancedTableNumber, phyStatus=phyStatus, hTTPPortNumber=hTTPPortNumber, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseSFPPortSupport=licenseSFPPortSupport, ptpTrapPrefix=ptpTrapPrefix, authorizationControlTable=authorizationControlTable, userEnabled=userEnabled, lowestDataModulationMode=lowestDataModulationMode, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, txMABFrames=txMABFrames, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, PYSNMP_MODULE_ID=cambium, latitude=latitude, regulatoryBand=regulatoryBand, routerProtocols=routerProtocols, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, cableDiagPair4Distance=cableDiagPair4Distance, tDMConfigurationMismatch=tDMConfigurationMismatch, versions=versions, hTTPAccessEnabled=hTTPAccessEnabled, licenseInstancedTableIndex=licenseInstancedTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, linkSymmetry=linkSymmetry, sNTPServerTimeout=sNTPServerTimeout, lbtDetectedTrap=lbtDetectedTrap, transparentClockVID=transparentClockVID, l2CPPriorityTable=l2CPPriorityTable, tFTPClient=tFTPClient, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, masterSlaveMode=masterSlaveMode, cableDiagPair2Results=cableDiagPair2Results, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sNTPPollInterval=sNTPPollInterval, authorizationControl=authorizationControl, dfsTableEntry=dfsTableEntry, licenseUnitSerialNumber=licenseUnitSerialNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableLoss=cableLoss, receiveChannel=receiveChannel, secureModeAlarmTrap=secureModeAlarmTrap, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, cableDiagPair1Results=cableDiagPair1Results, apcGroup=apcGroup, antennaSelection=antennaSelection, sNMPTrapTableNumber=sNMPTrapTableNumber, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseIPv6Support=licenseIPv6Support, regulatoryBandTrap=regulatoryBandTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, longitude=longitude, sntp=sntp, channelBandwidth=channelBandwidth, syslogState=syslogState, nIDULanPortStatusTrap=nIDULanPortStatusTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, mainPSUPortQLRx=mainPSUPortQLRx, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, dataBridgingStatusLinked=dataBridgingStatusLinked, sntpGroup=sntpGroup, portAllocationMismatch=portAllocationMismatch, mainPSUPortAllocation=mainPSUPortAllocation, mainPSUPortQLTx=mainPSUPortQLTx, sNTPServerTableIndex=sNTPServerTableIndex, syncESlavePort=syncESlavePort, unitIdentificationGroup=unitIdentificationGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, enableTransmission=enableTransmission, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, tDMChannelLineCode=tDMChannelLineCode, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, telnetAccessEnabled=telnetAccessEnabled, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, subbandHighestFrequency=subbandHighestFrequency, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, useVLANForMABProtocol=useVLANForMABProtocol, l2CPPriorityTableNumber=l2CPPriorityTableNumber, maxLinkRangeExceeded=maxLinkRangeExceeded, ptpGroups=ptpGroups, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, configurationInstancedTableIndex=configurationInstancedTableIndex, dfsTable=dfsTable, incompatibleRegulatoryBands=incompatibleRegulatoryBands, license=license, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseMaxLinkRange=licenseMaxLinkRange, syslogLocalWrappedTrap=syslogLocalWrappedTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, dfsTableNumber=dfsTableNumber, productName=productName, encryptionAlgorithm=encryptionAlgorithm, cableDiagPair2Distance=cableDiagPair2Distance, qOSPriorityScheme=qOSPriorityScheme, userPassword=userPassword, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tempPcb=tempPcb, licenseIEEE1588Support=licenseIEEE1588Support, licenseVersion=licenseVersion, iPDSCPPriorityTable=iPDSCPPriorityTable, tDDSynchronizationMode=tDDSynchronizationMode, transparentClockPort=transparentClockPort, licenseOOBManagementSupport=licenseOOBManagementSupport, wirelessOutAllOctets=wirelessOutAllOctets, syslogStateTrap=syslogStateTrap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, nIDULanPortStatus=nIDULanPortStatus, tDMChannelStatusTrap=tDMChannelStatusTrap, bridgeGroup=bridgeGroup, syslogClientTrap=syslogClientTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, alarmInstancedTableIndex=alarmInstancedTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, licenseGroup=licenseGroup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sNMPPortNumber=sNMPPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, tDDControl=tDDControl, dNSServerTable=dNSServerTable, capacityVariantMismatch=capacityVariantMismatch, whitelistRMMacAddress=whitelistRMMacAddress, mainPSUPortSSMTx=mainPSUPortSSMTx, byteErrorRatioLinked=byteErrorRatioLinked, managementNetworkAccessEnabled=managementNetworkAccessEnabled, daylightSaving=daylightSaving, sFPErrorTrap=sFPErrorTrap, installStatusLinked=installStatusLinked, tDMEnabledChannels=tDMEnabledChannels, cableDiagnosticsControl=cableDiagnosticsControl, remoteUnitNameLinked=remoteUnitNameLinked, productVariant=productVariant, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mainPSUPortStatusTrap=mainPSUPortStatusTrap, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitModulationModeLinked=transmitModulationModeLinked, userTable=userTable, cambium=cambium, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteUnitName=remoteUnitName, configurationInstancedTableEntry=configurationInstancedTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseTLSRekey=licenseTLSRekey, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tdmTableIndex=tdmTableIndex, receiveModulationModeLinked=receiveModulationModeLinked, searchStateLinked=searchStateLinked, sFPPortStatusTrap=sFPPortStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, blacklistRMMacAddress=blacklistRMMacAddress, mgmtInstancedTableNumber=mgmtInstancedTableNumber, smtpGroup=smtpGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dNSResolver=dNSResolver, supplementaryGroup=supplementaryGroup, phyControlGroup=phyControlGroup, siteName=siteName, iPv6PrefixLength=iPv6PrefixLength, targetMACAddress=targetMACAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, auxPortAcceptedQLRx=auxPortAcceptedQLRx, tdmTable=tdmTable, linkLossLinked=linkLossLinked, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, altitude=altitude, licenseTDDSyncSupport=licenseTDDSyncSupport, mgmtInstancedTableIndex=mgmtInstancedTableIndex, bootVersion=bootVersion, ptpCompliance=ptpCompliance, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, auxPortSSMTx=auxPortSSMTx, hTTPSPortNumber=hTTPSPortNumber, userTableEntry=userTableEntry, ethernetInstancedTableEntry=ethernetInstancedTableEntry, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tDMInterfaceControl=tDMInterfaceControl, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, syncEEquipmentClock=syncEEquipmentClock, sMTPEmailAlert=sMTPEmailAlert, accessMethod=accessMethod, tDDSynchronizationAlarm=tDDSynchronizationAlarm)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", receiveModulationMode=receiveModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, capacityVariantMismatchLinked=capacityVariantMismatchLinked, gatewayIPAddress=gatewayIPAddress, mABState=mABState, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseBandwidthCap=licenseBandwidthCap, sFPPortAutoMdix=sFPPortAutoMdix, mABNominalModulationMode=mABNominalModulationMode, sNTPPrimaryServer=sNTPPrimaryServer, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, cableDiagPair4Results=cableDiagPair4Results, iPv6Address=iPv6Address, reset=reset, rangeLinked=rangeLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sNTPServerTable=sNTPServerTable, dNSServerTableEntry=dNSServerTableEntry, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, authorizationControlTableEntry=authorizationControlTableEntry, tdmTableNumber=tdmTableNumber, dNSServerTableIndex=dNSServerTableIndex, iPv4Address=iPv4Address, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitterChannels=transmitterChannels, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPLastSync=sNTPLastSync, sNTPServerStatus=sNTPServerStatus, pubStatsGroup=pubStatsGroup, linkName=linkName, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, severelyErroredSeconds=severelyErroredSeconds, sNTPServerRetries=sNTPServerRetries, sNMPTrapTableIndex=sNMPTrapTableIndex, installStatusTrap=installStatusTrap, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, installArmState=installArmState, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, antennaGain=antennaGain, sNTPState=sNTPState, authorizationMethod=authorizationMethod, licenseInstancedTable=licenseInstancedTable, rangingMode=rangingMode, secureModeAlarm=secureModeAlarm, erroredSeconds=erroredSeconds, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, pubStats=pubStats, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, tDMChannelLoopback=tDMChannelLoopback, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, encryptionGroup=encryptionGroup, managementGroup=managementGroup, sFPPortSSMTx=sFPPortSSMTx)
