...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", hTTPAccessEnabled=hTTPAccessEnabled, authorizationControlTableNumber=authorizationControlTableNumber, cableDiagnosticsResultTable=cableDiagnosticsResultTable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sFPError=sFPError, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sFPPortQLTx=sFPPortQLTx, ethernetGroup=ethernetGroup, encryptionGroup=encryptionGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mABTransmissionInterval=mABTransmissionInterval, management=management, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, sNTPPollInterval=sNTPPollInterval, userName=userName, syslogControlGroup=syslogControlGroup, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, antennaGain=antennaGain, remoteInternetAddress=remoteInternetAddress, dNSServerTable=dNSServerTable, tempPcb=tempPcb, licenseIEEE1588Support=licenseIEEE1588Support, sNMPv3Enable=sNMPv3Enable, mgmtInstancedTableIndex=mgmtInstancedTableIndex, configuration=configuration, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, auxPortSSMTx=auxPortSSMTx, linkModeOptimization=linkModeOptimization, lowestTDMModulationMode=lowestTDMModulationMode, secureModeAlarmTrap=secureModeAlarmTrap, syncETracking=syncETracking, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, userTableNumber=userTableNumber, portAllocationMismatchTrap=portAllocationMismatchTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNTPSync=sNTPSync, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNTPServerTableNumber=sNTPServerTableNumber, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, iPv4Address=iPv4Address, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableNumber=dfsTableNumber, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, tDDControl=tDDControl, dfsMeans=dfsMeans, iPDSCPPriorityTable=iPDSCPPriorityTable, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, transmitDataRate=transmitDataRate, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, accessMethod=accessMethod, versionsGroup=versionsGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, subnetMask=subnetMask, alarmInstancedTableIndex=alarmInstancedTableIndex, portAllocationMismatch=portAllocationMismatch, alarmInstancedTableNumber=alarmInstancedTableNumber, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, phyControl=phyControl, targetRange=targetRange, txMABFrames=txMABFrames, siteName=siteName, altitude=altitude, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptp=ptp, mABNominalModulationMode=mABNominalModulationMode, sNMPCommunityString=sNMPCommunityString, installStatus=installStatus, mgmtInstancedTable=mgmtInstancedTable, transmitPowerLinked=transmitPowerLinked, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, installArmStateTrap=installArmStateTrap, phyStatus=phyStatus, dNS=dNS, tFTPServerPortNumber=tFTPServerPortNumber, dataPortPauseFrames=dataPortPauseFrames, ethernetStatisticsTable=ethernetStatisticsTable, sNMPTrapTable=sNMPTrapTable, licenseMaxLinkRange=licenseMaxLinkRange, sNTPState=sNTPState, systemClock=systemClock, dataBridgingStatus=dataBridgingStatus, rawReceivePower=rawReceivePower, capacityVariantMismatch=capacityVariantMismatch, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sMTPServerPortNumber=sMTPServerPortNumber, dNSServerInternetAddressType=dNSServerInternetAddressType, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseGasGroup=licenseGasGroup, txColorCode=txColorCode, tDM=tDM, sNMPTrapTableNumber=sNMPTrapTableNumber, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, mainPSUPortAutoMdix=mainPSUPortAutoMdix, lowestDataModulationMode=lowestDataModulationMode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telnetPortNumber=telnetPortNumber, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, encryption=encryption, installStatusTrap=installStatusTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, PYSNMP_MODULE_ID=cambium, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, supplementaryGroup=supplementaryGroup, capacityVariantMismatchTrap=capacityVariantMismatchTrap, configurationGroup=configurationGroup, licenseInstancedTableEntry=licenseInstancedTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ptpTrapPrefix=ptpTrapPrefix, wirelessTopology=wirelessTopology, severelyErroredSeconds=severelyErroredSeconds, mABMaintenanceLevel=mABMaintenanceLevel, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, syslogLocalWrappedTrap=syslogLocalWrappedTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, transparentClockVID=transparentClockVID, targetMACAddress=targetMACAddress, dNSResolver=dNSResolver, packetsToInternalStack=packetsToInternalStack, tDMEnabledChannels=tDMEnabledChannels, ethernetInstancedTableEntry=ethernetInstancedTableEntry, dfsTable=dfsTable, unitName=unitName, searchStateLinked=searchStateLinked, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, mABHoldoffPeriod=mABHoldoffPeriod, ethernetInstancedTableNumber=ethernetInstancedTableNumber, receiveFreqKHz=receiveFreqKHz, hCMPMaximumLinkRange=hCMPMaximumLinkRange, tdmTableIndex=tdmTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, erroredSeconds=erroredSeconds, authorizationControlTable=authorizationControlTable, packetsFromInternalStack=packetsFromInternalStack, productName=productName, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, tdmTableEntry=tdmTableEntry, receiveModulationModeLinked=receiveModulationModeLinked, licenseInstancedTableNumber=licenseInstancedTableNumber, licenseTDDSyncSupport=licenseTDDSyncSupport, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, receiveDataRateLinked=receiveDataRateLinked, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, syslogStateTrap=syslogStateTrap, ptpCompliance=ptpCompliance, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, alarmInstancedTableEntry=alarmInstancedTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, dataBridgingStatusLinked=dataBridgingStatusLinked, secondarySoftwareVersion=secondarySoftwareVersion, sFPPortAllocation=sFPPortAllocation, remoteUnitNameLinked=remoteUnitNameLinked, cableDiagnostics=cableDiagnostics, regulatoryBandTrap=regulatoryBandTrap, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, linkName=linkName, qOSPriorityScheme=qOSPriorityScheme, linkSymmetry=linkSymmetry, supplementary=supplementary, authorizationControl=authorizationControl, vectorError=vectorError, reset=reset, tFTPClient=tFTPClient, remoteMACAddressLinked=remoteMACAddressLinked, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tDDControlGroup=tDDControlGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, configurationInstancedTableIndex=configurationInstancedTableIndex, dfsGroup=dfsGroup, lbtDetectedTrap=lbtDetectedTrap, dfsTableIndex=dfsTableIndex, sFPErrorTrap=sFPErrorTrap, vLANManagementVID=vLANManagementVID, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, encryptionAlgorithm=encryptionAlgorithm, auxPortConfigurationMismatch=auxPortConfigurationMismatch, pubStatsGroup=pubStatsGroup, tdmTable=tdmTable, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, tDDSynchronizationStatus=tDDSynchronizationStatus, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, deviceESN=deviceESN, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseCountry=licenseCountry, userEnabled=userEnabled, portAllocationMismatchLinked=portAllocationMismatchLinked, unitOutOfCalibration=unitOutOfCalibration, unitIdentificationGroup=unitIdentificationGroup, licenseRARSupport=licenseRARSupport, hTTPSAccessEnabled=hTTPSAccessEnabled, iPVersion=iPVersion, userRole=userRole, dataBridgingStatusAlarm=dataBridgingStatusAlarm, alarmsGroup=alarmsGroup, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sFPPortQLRx=sFPPortQLRx, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerRetries=sNTPServerRetries, transparentClockVLAN=transparentClockVLAN, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, auxPortAcceptedQLRx=auxPortAcceptedQLRx, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, dSCPManagementPriority=dSCPManagementPriority, incompatibleMasterAndSlave=incompatibleMasterAndSlave, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tdmTableNumber=tdmTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, transmitDataRateLinked=transmitDataRateLinked, sntp=sntp, licenseSyncESupport=licenseSyncESupport, deviceMACAddress=deviceMACAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userPassword=userPassword, ptp670=ptp670, vectorErrorLinked=vectorErrorLinked, iPv6PrefixLength=iPv6PrefixLength, auxPortAllocation=auxPortAllocation, cambium=cambium, phyControlInstancedTableEntry=phyControlInstancedTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sFPPortDisabledWarning=sFPPortDisabledWarning, transmitModulationMode=transmitModulationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mainPSUPortAllocation=mainPSUPortAllocation, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, rangeLinked=rangeLinked, bridgeGroup=bridgeGroup, receiveFreqMHz=receiveFreqMHz, licenseVersion=licenseVersion, ptpTraps=ptpTraps, licenseHCMPSupport=licenseHCMPSupport, licenseTrialPeriod=licenseTrialPeriod, cableDiagPair3Distance=cableDiagPair3Distance, mABProtocolVLANPriority=mABProtocolVLANPriority, ethernetPriorityTable=ethernetPriorityTable, cableDiagnosticsControl=cableDiagnosticsControl, vLANManagementPriority=vLANManagementPriority, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, l2CPPriorityTable=l2CPPriorityTable, licenseIssueNumber=licenseIssueNumber, pubInstancedStatsTable=pubInstancedStatsTable, routerProtocolsGroup=routerProtocolsGroup, range=range, signalStrengthRatio=signalStrengthRatio, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, receiveModulationModeDetail=receiveModulationModeDetail, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, syslogClient=syslogClient, receiveModulationMode=receiveModulationMode, transparentClock=transparentClock, licenseOOBManagementSupport=licenseOOBManagementSupport, receivePower=receivePower, tDMChannelLineCode=tDMChannelLineCode, smtpGroup=smtpGroup, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, dNSServerInternetAddress=dNSServerInternetAddress, transmitModulationModeLinked=transmitModulationModeLinked, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, installArmState=installArmState, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, productVariant=productVariant, subbandLowestFrequency=subbandLowestFrequency, licenseEncryption=licenseEncryption, groupID=groupID, systemReset=systemReset, licenseCapacity=licenseCapacity, blacklistRMEnabled=blacklistRMEnabled, channelChangeTrap=channelChangeTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, cableDiagPair4Results=cableDiagPair4Results, pubStats=pubStats, searchState=searchState, syncEEquipmentClock=syncEEquipmentClock, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, useVLANForMABProtocol=useVLANForMABProtocol, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessOutOctets=wirelessOutOctets, aggregateDataRateLinked=aggregateDataRateLinked, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, unavailableSeconds=unavailableSeconds, sFPPortSSMTx=sFPPortSSMTx, license=license, wirelessOutEthernetOctets=wirelessOutEthernetOctets, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkAvailability=wirelessLinkAvailability, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, frequencyVariant=frequencyVariant, cableDiagPair2Distance=cableDiagPair2Distance, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, dNSGroup=dNSGroup, regulatoryBand=regulatoryBand, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, ethernet=ethernet, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installationMode=installationMode, licenseInstancedTable=licenseInstancedTable, mABProtocolVID=mABProtocolVID, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, auxPortStatusTrap=auxPortStatusTrap, latitude=latitude, dfsPeaks=dfsPeaks, rawReceivePowerLinked=rawReceivePowerLinked, notificationsGroup=notificationsGroup, resetGroup=resetGroup, remoteUnitName=remoteUnitName, smtp=smtp, hTTPSPortNumber=hTTPSPortNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, transmitPower=transmitPower, remoteMACAddress=remoteMACAddress, ethernetInstancedTable=ethernetInstancedTable, dNSPrimaryServer=dNSPrimaryServer, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hardwareVersion=hardwareVersion, iPv6Address=iPv6Address, tDMInterfaceStatus=tDMInterfaceStatus, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, nIDULanPortStatus=nIDULanPortStatus, mgmtInstancedTableNumber=mgmtInstancedTableNumber, secureModeAlarm=secureModeAlarm, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, userTableIndex=userTableIndex, licenseInstancedTableIndex=licenseInstancedTableIndex, rangingMode=rangingMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDMChannelLoopback=tDMChannelLoopback, licenseIPv6Support=licenseIPv6Support, configurationInstancedTableNumber=configurationInstancedTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sMTPEnabledMessages=sMTPEnabledMessages, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetInstancedTableIndex=ethernetInstancedTableIndex, authorizationMethod=authorizationMethod, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNTPSyncTrap=sNTPSyncTrap, authorizationControlTableEntry=authorizationControlTableEntry, apc=apc, sNTPServerPortNumber=sNTPServerPortNumber, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sFPPortAutoMdix=sFPPortAutoMdix, unitIdentification=unitIdentification, phyControlInstancedTableNumber=phyControlInstancedTableNumber, signalStrengthRatioLinked=signalStrengthRatioLinked, antennaSelection=antennaSelection, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDMInterfaceControl=tDMInterfaceControl, sntpGroup=sntpGroup, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerTable=sNTPServerTable, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, blacklistRMMacAddress=blacklistRMMacAddress, cableDiagPair1Results=cableDiagPair1Results, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, rxColorCode=rxColorCode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dNSServerTableNumber=dNSServerTableNumber, telnetAccessEnabled=telnetAccessEnabled, sFPPortAutoNegotiation=sFPPortAutoNegotiation, maximumNumberOfSlaves=maximumNumberOfSlaves, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, versions=versions, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, maximumTransmitPower=maximumTransmitPower, dfsTableEntry=dfsTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, phyControlInstancedTable=phyControlInstancedTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, cableDiagPair2Results=cableDiagPair2Results, tDMChannelStatusTrap=tDMChannelStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, syslogClientTrap=syslogClientTrap, tDMChannelStatus=tDMChannelStatus, eIRP=eIRP, auxPortQLRx=auxPortQLRx, tDMConfigurationMismatch=tDMConfigurationMismatch, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableEntry=userTableEntry, localPacketFiltering=localPacketFiltering, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sFPPortStatus=sFPPortStatus, configurationInstancedTable=configurationInstancedTable, mainPSUPortSSMTx=mainPSUPortSSMTx, transmitFreqMHz=transmitFreqMHz, snmpControl=snmpControl, maxLinkRangeExceeded=maxLinkRangeExceeded, sNTPServerTimeout=sNTPServerTimeout, apcGroup=apcGroup, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, transmitChannel=transmitChannel, dataBridgingAvailability=dataBridgingAvailability, sNTPPrimaryServer=sNTPPrimaryServer, syncESlavePort=syncESlavePort, timeZone=timeZone, gatewayIPAddress=gatewayIPAddress, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dNSServerTableIndex=dNSServerTableIndex, hTTPPortNumber=hTTPPortNumber, licenseGroupAccess=licenseGroupAccess, tDMGroup=tDMGroup, licenseBandwidthCap=licenseBandwidthCap, channelBandwidth=channelBandwidth, daylightSaving=daylightSaving, phyControlInstancedTableIndex=phyControlInstancedTableIndex, transmitterChannels=transmitterChannels, aAAControl=aAAControl, masterSlaveMode=masterSlaveMode, sNMPPortNumber=sNMPPortNumber, transparentClockPort=transparentClockPort, transmitFreqKHz=transmitFreqKHz, authorizationControlTableIndex=authorizationControlTableIndex, phyInstancedStatusTable=phyInstancedStatusTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptpGroups=ptpGroups, byteErrorRatioLinked=byteErrorRatioLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, linkLoss=linkLoss, dfs=dfs, ptmp=ptmp, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, syncETrackingState=syncETrackingState, dNSServerTableEntry=dNSServerTableEntry, tDMChannelCableLength=tDMChannelCableLength, subbandHighestFrequency=subbandHighestFrequency, whitelistRMMacAddress=whitelistRMMacAddress, cableDiagnosticsPorts=cableDiagnosticsPorts, sNTPLastSync=sNTPLastSync, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sFPPortStatusTrap=sFPPortStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, wirelessLinkStatus=wirelessLinkStatus, managementGroup=managementGroup, capacityVariantMismatchLinked=capacityVariantMismatchLinked, whitelistRMEnabled=whitelistRMEnabled, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyControlGroup=phyControlGroup, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, syslogState=syslogState, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userTable=userTable, byteErrorRatio=byteErrorRatio)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, hCMPLinkSymmetry=hCMPLinkSymmetry, cableDiagPair4Distance=cableDiagPair4Distance, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, alarms=alarms, aAAControlGroup=aAAControlGroup, alarmInstancedTable=alarmInstancedTable, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, dNSServerPortNumber=dNSServerPortNumber, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseGroup=licenseGroup, softwareVersion=softwareVersion, auxPortStatus=auxPortStatus, deviceMSN=deviceMSN, routerProtocols=routerProtocols, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, ethernetStatisticsDataSource=ethernetStatisticsDataSource, snmpControlGroup=snmpControlGroup, wirelessOutAllOctets=wirelessOutAllOctets, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableDiagPair3Results=cableDiagPair3Results, linkLossLinked=linkLossLinked, remoteInternetAddressType=remoteInternetAddressType, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, syslogControl=syslogControl, bridge=bridge, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, phyStatusGroup=phyStatusGroup, receiveDataRate=receiveDataRate, sNTPServerStatus=sNTPServerStatus, extendedSpectrumScanning=extendedSpectrumScanning, licenseSecurityLevel=licenseSecurityLevel, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, enableTransmission=enableTransmission, auxPortQLTx=auxPortQLTx, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, auxPortDisabledWarning=auxPortDisabledWarning, licenseSFPPortSupport=licenseSFPPortSupport, authorizationControlGroup=authorizationControlGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, aggregateDataRate=aggregateDataRate, mainPSUPortStatus=mainPSUPortStatus, installStatusLinked=installStatusLinked, licenseUnitSerialNumber=licenseUnitSerialNumber, receivePowerLinked=receivePowerLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, cableDiagPair1Distance=cableDiagPair1Distance, mainPSUPortQLRx=mainPSUPortQLRx, longitude=longitude, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mABState=mABState, licenseTLSRekey=licenseTLSRekey, sNMPTrapVersion=sNMPTrapVersion, receiveChannel=receiveChannel)
