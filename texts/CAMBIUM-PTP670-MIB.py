...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", wirelessOutEthernetOctets=wirelessOutEthernetOctets, telnetPortNumber=telnetPortNumber, receiveModulationMode=receiveModulationMode, unitOutOfCalibration=unitOutOfCalibration, managementGroup=managementGroup, authorizationControlTableEntry=authorizationControlTableEntry, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, mABMaintenanceLevel=mABMaintenanceLevel, receiveChannel=receiveChannel, tFTPServerInternetAddressType=tFTPServerInternetAddressType, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, mABProtocolVID=mABProtocolVID, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, range=range, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, dfsMeans=dfsMeans, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mABProtocolVLANPriority=mABProtocolVLANPriority, mainPSUPortQLRx=mainPSUPortQLRx, pubStatsGroup=pubStatsGroup, eIRP=eIRP, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, cableDiagnostics=cableDiagnostics, unitIdentification=unitIdentification, vLANManagementPriority=vLANManagementPriority, secureModeAlarm=secureModeAlarm, tDDSynchronizationStatus=tDDSynchronizationStatus, tDMGroup=tDMGroup, mABState=mABState, aAAControl=aAAControl, authorizationControlGroup=authorizationControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetPriorityTable=ethernetPriorityTable, tDMChannelLoopback=tDMChannelLoopback, licenseGasGroup=licenseGasGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataBridgingAvailability=dataBridgingAvailability, iPv6Address=iPv6Address, licenseSFPPortSupport=licenseSFPPortSupport, receiveDataRate=receiveDataRate, cableDiagPair1Results=cableDiagPair1Results, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, syncETracking=syncETracking, remoteUnitName=remoteUnitName, sNTPServerTimeout=sNTPServerTimeout, dfsTable=dfsTable, altitude=altitude, transmitDataRateLinked=transmitDataRateLinked, transparentClock=transparentClock, licenseTLSRekey=licenseTLSRekey, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cableDiagPair4Distance=cableDiagPair4Distance, longitude=longitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseEncryption=licenseEncryption, cableDiagnosticsWarning=cableDiagnosticsWarning, userTableIndex=userTableIndex, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseGroupAccess=licenseGroupAccess, installArmStateTrap=installArmStateTrap, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, auxPortQLTx=auxPortQLTx, sFPPortQLRx=sFPPortQLRx, receiveDataRateLinked=receiveDataRateLinked, licenseInstancedTable=licenseInstancedTable, sFPPortDisabledWarning=sFPPortDisabledWarning, alarmInstancedTableNumber=alarmInstancedTableNumber, licenseRARSupport=licenseRARSupport, mainPSUPortSSMTx=mainPSUPortSSMTx, timeZone=timeZone, unavailableSeconds=unavailableSeconds, routerProtocolsGroup=routerProtocolsGroup, portAllocationMismatch=portAllocationMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, capacityVariantMismatchTrap=capacityVariantMismatchTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, routerProtocols=routerProtocols, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, hTTPSPortNumber=hTTPSPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, wirelessLinkStatus=wirelessLinkStatus, ptp670=ptp670, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseCountry=licenseCountry, sNMPTrapTableIndex=sNMPTrapTableIndex, txMABFrames=txMABFrames, dfsGroup=dfsGroup, subnetMask=subnetMask, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, management=management, iPv6GatewayAddress=iPv6GatewayAddress, productName=productName, sNTPSync=sNTPSync, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, configurationGroup=configurationGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, alarmInstancedTable=alarmInstancedTable, userTableNumber=userTableNumber, resetGroup=resetGroup, installStatusLinked=installStatusLinked, dataBridgingStatus=dataBridgingStatus, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitDataRate=transmitDataRate, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, userName=userName, iPVersion=iPVersion, dNSPrimaryServer=dNSPrimaryServer, maxLinkRangeExceeded=maxLinkRangeExceeded, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, byteErrorRatioLinked=byteErrorRatioLinked, receiveFreqKHz=receiveFreqKHz, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, versions=versions, supplementaryGroup=supplementaryGroup, wirelessTopology=wirelessTopology, dataPortPauseFrames=dataPortPauseFrames, receivePower=receivePower, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, channelBandwidth=channelBandwidth, dfsPeaks=dfsPeaks, softwareVersion=softwareVersion, reset=reset, sNTPServerRetries=sNTPServerRetries, phyControlInstancedTable=phyControlInstancedTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, daylightSaving=daylightSaving, sNMPTrapTable=sNMPTrapTable, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, portAllocationMismatchLinked=portAllocationMismatchLinked, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteInternetAddress=remoteInternetAddress, antennaSelection=antennaSelection, dfs=dfs, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, phyControlInstancedTableNumber=phyControlInstancedTableNumber, ethernetInstancedTableEntry=ethernetInstancedTableEntry, licenseInstancedTableNumber=licenseInstancedTableNumber, subbandLowestFrequency=subbandLowestFrequency, userPassword=userPassword, sNMPTrapVersion=sNMPTrapVersion, phyInstancedStatusTable=phyInstancedStatusTable, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, snmpControlGroup=snmpControlGroup, syslogControl=syslogControl, aggregateDataRateLinked=aggregateDataRateLinked, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortAllocation=auxPortAllocation, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, systemClock=systemClock, unitName=unitName, sNMPTrapPortNumber=sNMPTrapPortNumber, notificationsGroup=notificationsGroup, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNTPState=sNTPState, blacklistRMMacAddress=blacklistRMMacAddress, ethernetInstancedTableNumber=ethernetInstancedTableNumber, syslogClientTrap=syslogClientTrap, dNSServerTableNumber=dNSServerTableNumber, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, sNTPServerTableIndex=sNTPServerTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, ptpTrapPrefix=ptpTrapPrefix, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, ptp=ptp, sNMPv3Enable=sNMPv3Enable, cableLoss=cableLoss, transparentClockVID=transparentClockVID, nIDULanPortStatus=nIDULanPortStatus, blacklistRMEnabled=blacklistRMEnabled, installArmState=installArmState, installationMode=installationMode, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, vLANManagementVID=vLANManagementVID, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, auxPortDisabledWarning=auxPortDisabledWarning, alarmsGroup=alarmsGroup, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseMaxLinkRange=licenseMaxLinkRange, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tdmTableIndex=tdmTableIndex, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, hCMPMaximumLinkRange=hCMPMaximumLinkRange, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, tFTPClient=tFTPClient, groupID=groupID, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sFPPortAllocation=sFPPortAllocation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mainPSUPortStatus=mainPSUPortStatus, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, tDMChannelStatus=tDMChannelStatus, alarmInstancedTableEntry=alarmInstancedTableEntry, supplementary=supplementary, syncESlavePort=syncESlavePort, licenseOOBManagementSupport=licenseOOBManagementSupport, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, targetRange=targetRange, transparentClockPort=transparentClockPort, lowestDataModulationMode=lowestDataModulationMode, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, syncETrackingState=syncETrackingState, snmpControl=snmpControl, accessMethod=accessMethod, l2CPPriorityTable=l2CPPriorityTable, PYSNMP_MODULE_ID=cambium, subbandHighestFrequency=subbandHighestFrequency, remoteMACAddressLinked=remoteMACAddressLinked, mgmtInstancedTable=mgmtInstancedTable, secureModeAlarmTrap=secureModeAlarmTrap, phyStatus=phyStatus, systemReset=systemReset, smtp=smtp, ethernetInstancedTable=ethernetInstancedTable, dataBridgingStatusLinked=dataBridgingStatusLinked, smtpGroup=smtpGroup, mABHoldoffPeriod=mABHoldoffPeriod, lbtDetectedTrap=lbtDetectedTrap, dfsTableEntry=dfsTableEntry, iPv6PrefixLength=iPv6PrefixLength, iPv4Address=iPv4Address)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", configuration=configuration, rangeLinked=rangeLinked, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, hTTPPortNumber=hTTPPortNumber, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, dNSServerInternetAddress=dNSServerInternetAddress, dNS=dNS, latitude=latitude, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, maximumNumberOfSlaves=maximumNumberOfSlaves, cableDiagnosticsControl=cableDiagnosticsControl, productVariant=productVariant, dNSServerTableIndex=dNSServerTableIndex, transparentClockVLAN=transparentClockVLAN, remoteInternetAddressLinked=remoteInternetAddressLinked, tDDControlGroup=tDDControlGroup, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, mABTransmissionInterval=mABTransmissionInterval, cableDiagPair4Results=cableDiagPair4Results, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, linkLoss=linkLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sFPPortAutoMdix=sFPPortAutoMdix, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, auxPortStatusTrap=auxPortStatusTrap, wirelessOutOctets=wirelessOutOctets, deviceMACAddress=deviceMACAddress, authorizationControlTableNumber=authorizationControlTableNumber, configurationInstancedTable=configurationInstancedTable, authorizationControl=authorizationControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDMChannelCableLength=tDMChannelCableLength, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, remoteInternetAddressType=remoteInternetAddressType, cableDiagPair2Results=cableDiagPair2Results, rawReceivePowerLinked=rawReceivePowerLinked, licenseBandwidthCap=licenseBandwidthCap, authorizationMethod=authorizationMethod, sNMPEnabledTraps=sNMPEnabledTraps, licenseGroup=licenseGroup, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dfsTableIndex=dfsTableIndex, encryptionAlgorithm=encryptionAlgorithm, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, cableDiagPair2Distance=cableDiagPair2Distance, phyStatusGroup=phyStatusGroup, sFPPortSSMTx=sFPPortSSMTx, apcGroup=apcGroup, regulatoryBandTrap=regulatoryBandTrap, receiveModulationModeDetail=receiveModulationModeDetail, qOSPriorityScheme=qOSPriorityScheme, licenseHCMPSupport=licenseHCMPSupport, whitelistRMMacAddress=whitelistRMMacAddress, userRole=userRole, packetsToInternalStack=packetsToInternalStack, apc=apc, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogStateTrap=syslogStateTrap, rxColorCode=rxColorCode, licenseInstancedTableEntry=licenseInstancedTableEntry, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, ptpGroups=ptpGroups, wirelessOutAllOctets=wirelessOutAllOctets, telnetAccessEnabled=telnetAccessEnabled, transmitModulationMode=transmitModulationMode, tDMInterfaceStatus=tDMInterfaceStatus, phyControl=phyControl, receiveFreqMHz=receiveFreqMHz, configurationInstancedTableNumber=configurationInstancedTableNumber, tDMInterfaceControl=tDMInterfaceControl, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseIPv6Support=licenseIPv6Support, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, vectorErrorLinked=vectorErrorLinked, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPServerPortNumber=sMTPServerPortNumber, licenseSyncESupport=licenseSyncESupport, hCMPLinkSymmetry=hCMPLinkSymmetry, sFPPortStatusTrap=sFPPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, mainPSUPortQLTx=mainPSUPortQLTx, licenseTrialPeriod=licenseTrialPeriod, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cableDiagPair1Distance=cableDiagPair1Distance, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versionsGroup=versionsGroup, transmitFreqKHz=transmitFreqKHz, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPSAccessEnabled=hTTPSAccessEnabled, extendedSpectrumScanning=extendedSpectrumScanning, licenseTDDSyncSupport=licenseTDDSyncSupport, linkSymmetry=linkSymmetry, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, nIDULanPortStatusTrap=nIDULanPortStatusTrap, encryptionGroup=encryptionGroup, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, userTable=userTable, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, linkLossLinked=linkLossLinked, l2CPPriorityTableIndex=l2CPPriorityTableIndex, masterSlaveMode=masterSlaveMode, cableDiagnosticsGroup=cableDiagnosticsGroup, vectorError=vectorError, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTable=sNTPServerTable, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, aggregateDataRate=aggregateDataRate, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, txColorCode=txColorCode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dNSServerPortNumber=dNSServerPortNumber, sFPErrorTrap=sFPErrorTrap, hTTPAccessEnabled=hTTPAccessEnabled, encryption=encryption, noWirelessChannelAvailable=noWirelessChannelAvailable, phyControlInstancedTableIndex=phyControlInstancedTableIndex, syslogControlGroup=syslogControlGroup, transmitPowerLinked=transmitPowerLinked, sFPError=sFPError, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, syslogState=syslogState, auxPortStatus=auxPortStatus, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sNTPServerStatus=sNTPServerStatus, auxPortConfigurationMismatch=auxPortConfigurationMismatch, rangingMode=rangingMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityString=sNMPCommunityString, cambium=cambium, alarmInstancedTableIndex=alarmInstancedTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, licenseCapacity=licenseCapacity, ptpTraps=ptpTraps, transmitPower=transmitPower, searchState=searchState, transmitterChannels=transmitterChannels, capacityVariantMismatchLinked=capacityVariantMismatchLinked, severelyErroredSeconds=severelyErroredSeconds, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sntpGroup=sntpGroup, maximumTransmitPower=maximumTransmitPower, linkName=linkName, tDMChannelStatusTrap=tDMChannelStatusTrap, frequencyVariant=frequencyVariant, portAllocationMismatchTrap=portAllocationMismatchTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, auxPortSSMTx=auxPortSSMTx, configurationInstancedTableIndex=configurationInstancedTableIndex, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, dNSServerTable=dNSServerTable, dNSServerInternetAddressType=dNSServerInternetAddressType, ethernetStatisticsTable=ethernetStatisticsTable, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, deviceESN=deviceESN, userEnabled=userEnabled, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, auxPortQLRx=auxPortQLRx, aAAControlGroup=aAAControlGroup, sNTPServerTableNumber=sNTPServerTableNumber, tempPcb=tempPcb, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sNTPPollInterval=sNTPPollInterval, capacityVariantMismatch=capacityVariantMismatch, transmitModulationModeLinked=transmitModulationModeLinked, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sMTPServerInternetAddressType=sMTPServerInternetAddressType, byteErrorRatio=byteErrorRatio, incompatibleMasterAndSlave=incompatibleMasterAndSlave, localPacketFiltering=localPacketFiltering, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tdmTableNumber=tdmTableNumber, tDDControl=tDDControl, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ptmp=ptmp, installStatusTrap=installStatusTrap, enableTransmission=enableTransmission, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, dSCPManagementPriority=dSCPManagementPriority, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, authorizationControlTableIndex=authorizationControlTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sFPPortQLTx=sFPPortQLTx, mainPSUPortAllocation=mainPSUPortAllocation, searchStateLinked=searchStateLinked, lowestTDMModulationMode=lowestTDMModulationMode, bridge=bridge, dNSServerTableEntry=dNSServerTableEntry, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseUnitSerialNumber=licenseUnitSerialNumber, bootVersion=bootVersion, transmitFreqMHz=transmitFreqMHz, ethernet=ethernet, useVLANForMABProtocol=useVLANForMABProtocol, sNMPPortNumber=sNMPPortNumber, dNSGroup=dNSGroup, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubInstancedStatsTable=pubInstancedStatsTable, syncEEquipmentClock=syncEEquipmentClock, auxPortSyncERxStatus=auxPortSyncERxStatus, tDMChannelLineCode=tDMChannelLineCode, secondarySoftwareVersion=secondarySoftwareVersion, tdmTable=tdmTable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, syslogClient=syslogClient, tDM=tDM, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseIEEE1588Support=licenseIEEE1588Support, transmitChannel=transmitChannel, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dNSResolver=dNSResolver, tDMConfigurationMismatch=tDMConfigurationMismatch, ptpCompliance=ptpCompliance, licenseVersion=licenseVersion, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sFPPortStatus=sFPPortStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, regulatoryBand=regulatoryBand, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sNTPLastSync=sNTPLastSync, gatewayIPAddress=gatewayIPAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, configurationInstancedTableEntry=configurationInstancedTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimization=linkModeOptimization)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, antennaGain=antennaGain, mgmtInstancedTableNumber=mgmtInstancedTableNumber, signalStrengthRatio=signalStrengthRatio, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, erroredSeconds=erroredSeconds, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, ethernetGroup=ethernetGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTableEntry=userTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sntp=sntp, licenseSecurityLevel=licenseSecurityLevel, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mgmtInstancedTableIndex=mgmtInstancedTableIndex, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tdmTableEntry=tdmTableEntry, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, receivePowerLinked=receivePowerLinked, deviceMSN=deviceMSN, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mainPSUPortStatusTrap=mainPSUPortStatusTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, phyControlGroup=phyControlGroup, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tDMEnabledChannels=tDMEnabledChannels, authorizationControlTable=authorizationControlTable, channelChangeTrap=channelChangeTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, cableDiagPair3Results=cableDiagPair3Results, licenseIssueNumber=licenseIssueNumber, dfsTableNumber=dfsTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeLinked=receiveModulationModeLinked, whitelistRMEnabled=whitelistRMEnabled, siteName=siteName, license=license, unitIdentificationGroup=unitIdentificationGroup, packetsFromInternalStack=packetsFromInternalStack, auxPortAcceptedQLRx=auxPortAcceptedQLRx, licenseInstancedTableIndex=licenseInstancedTableIndex, remoteMACAddress=remoteMACAddress, installStatus=installStatus, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, rawReceivePower=rawReceivePower, wirelessLinkStatusLinked=wirelessLinkStatusLinked, alarms=alarms, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, targetMACAddress=targetMACAddress, remoteUnitNameLinked=remoteUnitNameLinked, bridgeGroup=bridgeGroup, cableDiagPair3Distance=cableDiagPair3Distance, hardwareVersion=hardwareVersion, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mABNominalModulationMode=mABNominalModulationMode, pubStats=pubStats)
