...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", regulatoryBandTrap=regulatoryBandTrap, userTableIndex=userTableIndex, cableLoss=cableLoss, antennaSelection=antennaSelection, syslogClient=syslogClient, accessMethod=accessMethod, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, signalStrengthRatio=signalStrengthRatio, oOBPriorityQueueMapping=oOBPriorityQueueMapping, dataBridgingStatusAlarm=dataBridgingStatusAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, useVLANForMABProtocol=useVLANForMABProtocol, encryptionGroup=encryptionGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, tDMChannelStatus=tDMChannelStatus, versionsGroup=versionsGroup, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, ptpGroups=ptpGroups, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, transparentClockVLAN=transparentClockVLAN, auxPortAcceptedQLRx=auxPortAcceptedQLRx, authorizationControlGroup=authorizationControlGroup, supplementary=supplementary, licenseUnitSerialNumber=licenseUnitSerialNumber, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, cableDiagnosticsGroup=cableDiagnosticsGroup, dNSPrimaryServer=dNSPrimaryServer, auxPortQLTx=auxPortQLTx, licenseIEEE1588Support=licenseIEEE1588Support, phyStatus=phyStatus, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, tempPcb=tempPcb, configurationInstancedTableEntry=configurationInstancedTableEntry, packetsToInternalStack=packetsToInternalStack, ethernet=ethernet, l2CPPriorityTable=l2CPPriorityTable, licenseHCMPSupport=licenseHCMPSupport, syslogState=syslogState, ethernetStatisticsDataSource=ethernetStatisticsDataSource, transmitDataRate=transmitDataRate, mABProtocolVID=mABProtocolVID, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, whitelistRMMacAddress=whitelistRMMacAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installationMode=installationMode, tDMConfigurationMismatch=tDMConfigurationMismatch, snmpControlGroup=snmpControlGroup, userRole=userRole, iPv6Address=iPv6Address, telnetPortNumber=telnetPortNumber, remoteUnitNameLinked=remoteUnitNameLinked, ptpTrapPrefix=ptpTrapPrefix, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, dfsTableNumber=dfsTableNumber, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, resetGroup=resetGroup, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, configurationGroup=configurationGroup, regulatoryBand=regulatoryBand, remoteMACAddressLinked=remoteMACAddressLinked, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, timeZone=timeZone, dataBridgingStatus=dataBridgingStatus, tdmTableEntry=tdmTableEntry, signalStrengthRatioLinked=signalStrengthRatioLinked, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, ptmp=ptmp, hTTPSPortNumber=hTTPSPortNumber, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, userEnabled=userEnabled, mainPSUPortQLTx=mainPSUPortQLTx, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, routerProtocolsGroup=routerProtocolsGroup, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, vectorError=vectorError, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseSFPPortSupport=licenseSFPPortSupport, frequencyVariant=frequencyVariant, encryptionAlgorithm=encryptionAlgorithm, configurationInstancedTableIndex=configurationInstancedTableIndex, vLANManagementVID=vLANManagementVID, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, productVariant=productVariant, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mgmtInstancedTableIndex=mgmtInstancedTableIndex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogClientTrap=syslogClientTrap, apcGroup=apcGroup, dfsGroup=dfsGroup, sFPPortSSMTx=sFPPortSSMTx, searchState=searchState, dNSServerTableIndex=dNSServerTableIndex, reset=reset, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNTPServerRetries=sNTPServerRetries, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseInstancedTableIndex=licenseInstancedTableIndex, sNMPPortNumber=sNMPPortNumber, mgmtInstancedTable=mgmtInstancedTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sntpGroup=sntpGroup, tDM=tDM, hardwareVersion=hardwareVersion, management=management, iPv4Address=iPv4Address, antennaGain=antennaGain, unitName=unitName, ethernetStatisticsTable=ethernetStatisticsTable, sNTPServerTimeout=sNTPServerTimeout, nIDULanPortStatus=nIDULanPortStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, phyStatusGroup=phyStatusGroup, rxColorCode=rxColorCode, sFPPortAutoMdix=sFPPortAutoMdix, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, lbtDetectedTrap=lbtDetectedTrap, sNTPServerStatus=sNTPServerStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dNSServerInternetAddress=dNSServerInternetAddress, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, aggregateDataRateLinked=aggregateDataRateLinked, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, portAllocationMismatchTrap=portAllocationMismatchTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortPauseFrames=dataPortPauseFrames, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sMTPServerInternetAddress=sMTPServerInternetAddress, dNSServerTableNumber=dNSServerTableNumber, groupID=groupID, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, smtpGroup=smtpGroup, dNSServerInternetAddressType=dNSServerInternetAddressType, aggregateDataRate=aggregateDataRate, installArmStateTrap=installArmStateTrap, alarmsGroup=alarmsGroup, phyControlGroup=phyControlGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetPriorityTable=ethernetPriorityTable, cableDiagPair2Results=cableDiagPair2Results, hTTPAccessEnabled=hTTPAccessEnabled, tDMInterfaceControl=tDMInterfaceControl, receiveFreqMHz=receiveFreqMHz, wirelessOutAllOctets=wirelessOutAllOctets, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, dataBridgingStatusLinked=dataBridgingStatusLinked, latitude=latitude, licenseIPv6Support=licenseIPv6Support, bootVersion=bootVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, extendedSpectrumScanning=extendedSpectrumScanning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, installStatus=installStatus, iPVersion=iPVersion, licenseSyncESupport=licenseSyncESupport, installStatusTrap=installStatusTrap, sNTPSync=sNTPSync, receiveModulationMode=receiveModulationMode, receiveFreqKHz=receiveFreqKHz, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, receivePowerLinked=receivePowerLinked, receiveDataRateLinked=receiveDataRateLinked, systemClock=systemClock, targetRange=targetRange, licenseIssueNumber=licenseIssueNumber, licenseTDDSyncSupport=licenseTDDSyncSupport, routerProtocols=routerProtocols, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, systemReset=systemReset, mainPSUPortStatusTrap=mainPSUPortStatusTrap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, txColorCode=txColorCode, licenseTrialPeriod=licenseTrialPeriod, transmitPower=transmitPower, range=range, capacityVariantMismatch=capacityVariantMismatch, sFPPortStatus=sFPPortStatus, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseCountry=licenseCountry, channelChangeTrap=channelChangeTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, transmitModulationModeLinked=transmitModulationModeLinked, portAllocationMismatchLinked=portAllocationMismatchLinked, transparentClock=transparentClock, dfs=dfs, deviceMACAddress=deviceMACAddress, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tFTPServerInternetAddress=tFTPServerInternetAddress, mABTransmissionInterval=mABTransmissionInterval, sFPPortQLTx=sFPPortQLTx, receiveChannel=receiveChannel, alarmInstancedTableNumber=alarmInstancedTableNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, licenseGroupAccess=licenseGroupAccess, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mABNominalModulationMode=mABNominalModulationMode, supplementaryGroup=supplementaryGroup, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, notificationsGroup=notificationsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, siteName=siteName, mABState=mABState, dNSResolver=dNSResolver, sntp=sntp, dfsTableEntry=dfsTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, authorizationControlTableIndex=authorizationControlTableIndex, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sNMPTrapPortNumber=sNMPTrapPortNumber, auxPortStatusTrap=auxPortStatusTrap, tDMEnabledChannels=tDMEnabledChannels, ptp670=ptp670, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, hTTPSAccessEnabled=hTTPSAccessEnabled, apc=apc, mPLSTCPriorityTable=mPLSTCPriorityTable, userTable=userTable, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, eIRP=eIRP, dfsMeans=dfsMeans, lowestTDMModulationMode=lowestTDMModulationMode, localPacketFiltering=localPacketFiltering, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, hCMPLinkSymmetry=hCMPLinkSymmetry, ethernetInstancedTable=ethernetInstancedTable, licenseOOBManagementSupport=licenseOOBManagementSupport, transmitFreqKHz=transmitFreqKHz)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", authorizationMethod=authorizationMethod, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, portAllocationMismatch=portAllocationMismatch, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, cableDiagPair4Distance=cableDiagPair4Distance, managementGroup=managementGroup, dataBridgingAvailability=dataBridgingAvailability, receiveModulationModeLinked=receiveModulationModeLinked, lowestDataModulationMode=lowestDataModulationMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, telnetAccessEnabled=telnetAccessEnabled, dNSServerTableEntry=dNSServerTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, bridgeGroup=bridgeGroup, transmitFreqMHz=transmitFreqMHz, linkLoss=linkLoss, remoteInternetAddressType=remoteInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseRARSupport=licenseRARSupport, tDMChannelLoopback=tDMChannelLoopback, licenseSecurityLevel=licenseSecurityLevel, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, remoteInternetAddress=remoteInternetAddress, vectorErrorLinked=vectorErrorLinked, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sFPError=sFPError, tdmTableIndex=tdmTableIndex, hTTPPortNumber=hTTPPortNumber, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, syncETrackingState=syncETrackingState, unitIdentification=unitIdentification, secureModeAlarmTrap=secureModeAlarmTrap, auxPortAllocation=auxPortAllocation, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, gatewayIPAddress=gatewayIPAddress, licenseCapacity=licenseCapacity, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPClient=tFTPClient, aAAControlGroup=aAAControlGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, maxLinkRangeExceeded=maxLinkRangeExceeded, snmpControl=snmpControl, licenseInstancedTableEntry=licenseInstancedTableEntry, vLANManagementPriority=vLANManagementPriority, sNTPPollInterval=sNTPPollInterval, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, linkModeOptimization=linkModeOptimization, versions=versions, mABProtocolVLANPriority=mABProtocolVLANPriority, syslogControlGroup=syslogControlGroup, ethernetInstancedTableEntry=ethernetInstancedTableEntry, transmitChannel=transmitChannel, iPv6PrefixLength=iPv6PrefixLength, deviceESN=deviceESN, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mABMaintenanceLevel=mABMaintenanceLevel, tDMChannelStatusTrap=tDMChannelStatusTrap, blacklistRMEnabled=blacklistRMEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, smtp=smtp, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, rangingMode=rangingMode, aAAControl=aAAControl, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, mainPSUPortSSMTx=mainPSUPortSSMTx, sFPPortQLRx=sFPPortQLRx, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, installStatusLinked=installStatusLinked, transmitPowerLinked=transmitPowerLinked, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syncEEquipmentClock=syncEEquipmentClock, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, wirelessTopology=wirelessTopology, hCMPMaximumLinkRange=hCMPMaximumLinkRange, byteErrorRatioLinked=byteErrorRatioLinked, altitude=altitude, transmitModulationMode=transmitModulationMode, rangeLinked=rangeLinked, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, phyControl=phyControl, maximumTransmitPower=maximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, remoteUnitName=remoteUnitName, tDDControl=tDDControl, auxPortQLRx=auxPortQLRx, enableTransmission=enableTransmission, alarmInstancedTableEntry=alarmInstancedTableEntry, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, wirelessLinkStatusLinked=wirelessLinkStatusLinked, cableDiagPair3Results=cableDiagPair3Results, dNS=dNS, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, wirelessLinkAvailability=wirelessLinkAvailability, bridge=bridge, dNSServerPortNumber=dNSServerPortNumber, syncESlavePort=syncESlavePort, nIDULanPortAutoMdix=nIDULanPortAutoMdix, licenseBandwidthCap=licenseBandwidthCap, encryption=encryption, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, whitelistRMEnabled=whitelistRMEnabled, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseGasGroup=licenseGasGroup, sNTPServerTable=sNTPServerTable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, linkLossLinked=linkLossLinked, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transparentClockPort=transparentClockPort, tDDControlGroup=tDDControlGroup, dfsTableIndex=dfsTableIndex, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, syslogStateTrap=syslogStateTrap, installArmState=installArmState, alarmInstancedTable=alarmInstancedTable, sNMPTrapTable=sNMPTrapTable, tDMInterfaceStatus=tDMInterfaceStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rawReceivePower=rawReceivePower, linkName=linkName, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sFPPortStatusTrap=sFPPortStatusTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, subbandLowestFrequency=subbandLowestFrequency, packetsFromInternalStack=packetsFromInternalStack, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, erroredSeconds=erroredSeconds, license=license, mainPSUPortQLRx=mainPSUPortQLRx, authorizationControlTable=authorizationControlTable, licenseMaxLinkRange=licenseMaxLinkRange, byteErrorRatio=byteErrorRatio, syncETracking=syncETracking, licenseTLSRekey=licenseTLSRekey, authorizationControlTableEntry=authorizationControlTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, searchStateLinked=searchStateLinked, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, receiveDataRate=receiveDataRate, phyControlInstancedTable=phyControlInstancedTable, dNSGroup=dNSGroup, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sNTPLastSync=sNTPLastSync, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, phyControlInstancedTableIndex=phyControlInstancedTableIndex, licenseEncryption=licenseEncryption, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, severelyErroredSeconds=severelyErroredSeconds, cableDiagPair3Distance=cableDiagPair3Distance, userTableNumber=userTableNumber, sNTPSyncTrap=sNTPSyncTrap, softwareVersion=softwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, phyControlInstancedTableEntry=phyControlInstancedTableEntry, mainPSUPortAllocation=mainPSUPortAllocation, tDMChannelLineCode=tDMChannelLineCode, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessOutOctets=wirelessOutOctets, linkModeOptimizationMismatch=linkModeOptimizationMismatch, auxPortConfigurationMismatch=auxPortConfigurationMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPPrimaryServer=sNTPPrimaryServer, productName=productName, transmitDataRateLinked=transmitDataRateLinked, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, unavailableSeconds=unavailableSeconds, PYSNMP_MODULE_ID=cambium, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, userPassword=userPassword, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sMTPEmailAlert=sMTPEmailAlert, daylightSaving=daylightSaving, sNMPv3Enable=sNMPv3Enable, ethernetGroup=ethernetGroup, capacityVariantMismatchLinked=capacityVariantMismatchLinked, wirelessLinkStatus=wirelessLinkStatus, tDMGroup=tDMGroup, licenseVersion=licenseVersion, tDMChannelCableLength=tDMChannelCableLength, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, cambium=cambium, licenseGroup=licenseGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, cableDiagPair1Results=cableDiagPair1Results, ethernetPriorityTableIndex=ethernetPriorityTableIndex, configurationInstancedTableNumber=configurationInstancedTableNumber, configuration=configuration, sFPPortAllocation=sFPPortAllocation, remoteMACAddress=remoteMACAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, auxPortSyncERxStatus=auxPortSyncERxStatus, cableDiagnosticsPorts=cableDiagnosticsPorts, dfsPeaks=dfsPeaks, subnetMask=subnetMask, secureModeAlarm=secureModeAlarm, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cableDiagPair2Distance=cableDiagPair2Distance, mABHoldoffPeriod=mABHoldoffPeriod, tdmTableNumber=tdmTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyInstancedStatusTable=phyInstancedStatusTable, ptpTraps=ptpTraps, auxPortSSMTx=auxPortSSMTx, ethernetPriorityTableEntry=ethernetPriorityTableEntry, auxPortStatus=auxPortStatus, dSCPManagementPriority=dSCPManagementPriority, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, deviceMSN=deviceMSN, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPCommunityString=sNMPCommunityString, rawReceivePowerLinked=rawReceivePowerLinked, blacklistRMMacAddress=blacklistRMMacAddress, longitude=longitude, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ptpCompliance=ptpCompliance, syslogControl=syslogControl, receivePower=receivePower, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, dNSServerTable=dNSServerTable, authorizationControlTableNumber=authorizationControlTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cableDiagPair1Distance=cableDiagPair1Distance, linkSymmetry=linkSymmetry, alarms=alarms, sNTPServerPortNumber=sNTPServerPortNumber, authorizationControl=authorizationControl, licenseInstancedTable=licenseInstancedTable)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tdmTable=tdmTable, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, receiveModulationModeDetail=receiveModulationModeDetail, sMTPEnabledMessages=sMTPEnabledMessages, licenseInstancedTableNumber=licenseInstancedTableNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNTPServerTableNumber=sNTPServerTableNumber, nIDULanPortStatusTrap=nIDULanPortStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, pubInstancedStatsTable=pubInstancedStatsTable, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetInstancedTableIndex=ethernetInstancedTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, channelBandwidth=channelBandwidth, alarmInstancedTableIndex=alarmInstancedTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, unitOutOfCalibration=unitOutOfCalibration, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, txMABFrames=txMABFrames, dfsTable=dfsTable, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sNTPServerTableIndex=sNTPServerTableIndex, mgmtInstancedTableEntry=mgmtInstancedTableEntry, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, pubStats=pubStats, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, transparentClockVID=transparentClockVID, mainPSUPortStatus=mainPSUPortStatus, userTableEntry=userTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, sFPErrorTrap=sFPErrorTrap, cableDiagPair4Results=cableDiagPair4Results, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, wirelessOutEthernetOctets=wirelessOutEthernetOctets, cableDiagnosticsControl=cableDiagnosticsControl, ptp=ptp, configurationInstancedTable=configurationInstancedTable, sNTPServerTableEntry=sNTPServerTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userName=userName, sNTPState=sNTPState, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ethernetInstancedTableNumber=ethernetInstancedTableNumber, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, transmitterChannels=transmitterChannels, cableDiagnostics=cableDiagnostics, targetMACAddress=targetMACAddress, unitIdentificationGroup=unitIdentificationGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, phyControlInstancedTableNumber=phyControlInstancedTableNumber)
