...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, dataBridgingStatus=dataBridgingStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseInstancedTableIndex=licenseInstancedTableIndex, sNTPState=sNTPState, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tDDControlGroup=tDDControlGroup, sNTPLastSync=sNTPLastSync, sFPPortQLRx=sFPPortQLRx, l2CPPriorityTable=l2CPPriorityTable, ptpGroups=ptpGroups, pubStatsGroup=pubStatsGroup, aAAControlGroup=aAAControlGroup, configuration=configuration, vLANManagementVID=vLANManagementVID, receivePowerLinked=receivePowerLinked, channelChangeTrap=channelChangeTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseEncryption=licenseEncryption, targetMACAddress=targetMACAddress, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, dfsTable=dfsTable, capacityVariantMismatchTrap=capacityVariantMismatchTrap, signalStrengthRatio=signalStrengthRatio, transmitPowerLinked=transmitPowerLinked, ptmp=ptmp, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, management=management, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, pubInstancedStatsTable=pubInstancedStatsTable, linkLoss=linkLoss, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, ethernetStatisticsTable=ethernetStatisticsTable, maximumNumberOfSlaves=maximumNumberOfSlaves, tDDControl=tDDControl, syslogControl=syslogControl, licenseBandwidthCap=licenseBandwidthCap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, hardwareVersion=hardwareVersion, syslogClientTrap=syslogClientTrap, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mgmtInstancedTable=mgmtInstancedTable, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, dNSServerTableEntry=dNSServerTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, tdmTable=tdmTable, dNSServerTable=dNSServerTable, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sNMPCommunityString=sNMPCommunityString, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenseInstancedTableEntry=licenseInstancedTableEntry, tdmTableNumber=tdmTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sntpGroup=sntpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmInstancedTableIndex=alarmInstancedTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTrapPrefix=ptpTrapPrefix, mainPSUPortQLRx=mainPSUPortQLRx, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, ethernetGroup=ethernetGroup, subbandHighestFrequency=subbandHighestFrequency, sNMPPortNumber=sNMPPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, tDMInterfaceStatus=tDMInterfaceStatus, wirelessOutAllOctets=wirelessOutAllOctets, productVariant=productVariant, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseGasGroup=licenseGasGroup, licenseSFPPortSupport=licenseSFPPortSupport, tFTPServerInternetAddress=tFTPServerInternetAddress, secureModeAlarm=secureModeAlarm, snmpControlGroup=snmpControlGroup, sNTPServerTimeout=sNTPServerTimeout, cableDiagPair2Distance=cableDiagPair2Distance, remoteMACAddressLinked=remoteMACAddressLinked, mABHoldoffPeriod=mABHoldoffPeriod, licenseGroup=licenseGroup, sNTPPrimaryServer=sNTPPrimaryServer, sMTPServerInternetAddressType=sMTPServerInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, transparentClockPort=transparentClockPort, configurationInstancedTableIndex=configurationInstancedTableIndex, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sNMPTrapTableEntry=sNMPTrapTableEntry, tdmTableIndex=tdmTableIndex, mABProtocolVID=mABProtocolVID, userRole=userRole, unitOutOfCalibration=unitOutOfCalibration, sNTPServerTable=sNTPServerTable, dNS=dNS, alarms=alarms, noWirelessChannelAvailable=noWirelessChannelAvailable, txMABFrames=txMABFrames, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, cableDiagPair3Distance=cableDiagPair3Distance, accessMethod=accessMethod, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, transmitterChannels=transmitterChannels, notificationsGroup=notificationsGroup, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, siteName=siteName, cableLoss=cableLoss, sNTPServerInternetAddressType=sNTPServerInternetAddressType, deviceMSN=deviceMSN, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerRetries=sNTPServerRetries, masterSlaveMode=masterSlaveMode, mainPSUPortAllocation=mainPSUPortAllocation, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, dNSServerInternetAddressType=dNSServerInternetAddressType, tempPcb=tempPcb, subbandLowestFrequency=subbandLowestFrequency, sNTPPollInterval=sNTPPollInterval, phyControl=phyControl, tDMChannelStatus=tDMChannelStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsTableIndex=dfsTableIndex, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, dNSServerTableNumber=dNSServerTableNumber, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mainPSUPortStatus=mainPSUPortStatus, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, authorizationControlTableEntry=authorizationControlTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, syslogState=syslogState, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, alarmInstancedTable=alarmInstancedTable, iPDSCPPriorityTable=iPDSCPPriorityTable, ptpCompliance=ptpCompliance, license=license, dfsMeans=dfsMeans, sNTPServerPortNumber=sNTPServerPortNumber, softwareVersion=softwareVersion, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, nIDULanPortStatus=nIDULanPortStatus, receiveFreqMHz=receiveFreqMHz, sNMPTrapInternetAddress=sNMPTrapInternetAddress, installArmState=installArmState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, cableDiagnosticsGroup=cableDiagnosticsGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, subnetMask=subnetMask, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, aggregateDataRateLinked=aggregateDataRateLinked, regulatoryBand=regulatoryBand, auxPortConfigurationMismatch=auxPortConfigurationMismatch, auxPortQLTx=auxPortQLTx, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfsGroup=dfsGroup, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNMPTrapVersion=sNMPTrapVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transparentClockVLAN=transparentClockVLAN, iPv6GatewayAddress=iPv6GatewayAddress, antennaSelection=antennaSelection, nIDULanPortAutoMdix=nIDULanPortAutoMdix, cableDiagnosticsPorts=cableDiagnosticsPorts, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDMInterfaceControl=tDMInterfaceControl, iPv6Address=iPv6Address, telnetPortNumber=telnetPortNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, mainPSUPortStatusTrap=mainPSUPortStatusTrap, lowestTDMModulationMode=lowestTDMModulationMode, installArmStateTrap=installArmStateTrap, timeZone=timeZone, sFPPortSSMTx=sFPPortSSMTx, licenseCapacity=licenseCapacity, auxPortSSMTx=auxPortSSMTx, sFPPortStatus=sFPPortStatus, alarmsGroup=alarmsGroup, remoteInternetAddressType=remoteInternetAddressType, receiveChannel=receiveChannel, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, antennaGain=antennaGain, frequencyVariant=frequencyVariant, dNSPrimaryServer=dNSPrimaryServer, dataPortPauseFrames=dataPortPauseFrames, auxPortQLRx=auxPortQLRx, blacklistRMMacAddress=blacklistRMMacAddress, syncEEquipmentClock=syncEEquipmentClock, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, installStatusTrap=installStatusTrap, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tdmTableEntry=tdmTableEntry, PYSNMP_MODULE_ID=cambium, apc=apc, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sFPPortSyncERxStatus=sFPPortSyncERxStatus, phyControlInstancedTableEntry=phyControlInstancedTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, blacklistRMEnabled=blacklistRMEnabled, licenseIssueNumber=licenseIssueNumber, productName=productName, mgmtInstancedTableNumber=mgmtInstancedTableNumber, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, cableDiagPair1Distance=cableDiagPair1Distance, syncETracking=syncETracking, ethernetPriorityTableEntry=ethernetPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, installStatusLinked=installStatusLinked, authorizationControlGroup=authorizationControlGroup, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, licenseOOBManagementSupport=licenseOOBManagementSupport, mgmtInstancedTableIndex=mgmtInstancedTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, altitude=altitude, configurationInstancedTableEntry=configurationInstancedTableEntry, userEnabled=userEnabled, syncESlavePort=syncESlavePort, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transmitModulationModeLinked=transmitModulationModeLinked, systemClock=systemClock, remoteInternetAddress=remoteInternetAddress, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, bridgeGroup=bridgeGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, regulatoryBandTrap=regulatoryBandTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, unitIdentification=unitIdentification, configurationInstancedTable=configurationInstancedTable, routerProtocolsGroup=routerProtocolsGroup, unitIdentificationGroup=unitIdentificationGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseMaxLinkRange=licenseMaxLinkRange, cambium=cambium, range=range, transparentClock=transparentClock, wirelessOutEthernetOctets=wirelessOutEthernetOctets, deviceMACAddress=deviceMACAddress, tDMGroup=tDMGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, installationMode=installationMode, hTTPPortNumber=hTTPPortNumber, sMTPEmailAlert=sMTPEmailAlert, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, iPVersion=iPVersion, tDMChannelCableLength=tDMChannelCableLength, sNMPEnabledTraps=sNMPEnabledTraps, dataBridgingAvailability=dataBridgingAvailability, snmpControl=snmpControl, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, phyStatusGroup=phyStatusGroup, transmitModulationMode=transmitModulationMode, licenseTrialPeriod=licenseTrialPeriod, vectorError=vectorError, bridge=bridge, capacityVariantMismatch=capacityVariantMismatch, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, dNSServerInternetAddress=dNSServerInternetAddress, oOBPriorityQueueMapping=oOBPriorityQueueMapping, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerStatus=sNTPServerStatus, encryptionGroup=encryptionGroup, sNMPv3Enable=sNMPv3Enable, routerProtocols=routerProtocols, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, systemReset=systemReset, channelBandwidth=channelBandwidth, sNTPServerTableIndex=sNTPServerTableIndex, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sNMPTrapTable=sNMPTrapTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ptp670=ptp670, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, tFTPClient=tFTPClient, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, bootVersion=bootVersion, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, daylightSaving=daylightSaving, linkModeOptimization=linkModeOptimization, receiveModulationMode=receiveModulationMode, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, unitName=unitName, syslogClient=syslogClient, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsTableEntry=dfsTableEntry, licenseTLSRekey=licenseTLSRekey, dNSServerPortNumber=dNSServerPortNumber, ptp=ptp, searchState=searchState, portAllocationMismatchTrap=portAllocationMismatchTrap, ethernetPriorityTable=ethernetPriorityTable, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, searchStateLinked=searchStateLinked, sNTPSync=sNTPSync, receiveDataRateLinked=receiveDataRateLinked, dfsPeaks=dfsPeaks, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, userTableNumber=userTableNumber, userTable=userTable, ptpTraps=ptpTraps, lowestDataModulationMode=lowestDataModulationMode, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, transmitDataRateLinked=transmitDataRateLinked, apcGroup=apcGroup, linkLossLinked=linkLossLinked, vectorErrorLinked=vectorErrorLinked, remoteUnitNameLinked=remoteUnitNameLinked, receiveModulationModeLinked=receiveModulationModeLinked, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, authorizationControl=authorizationControl, iPv4Address=iPv4Address, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, phyInstancedStatusTable=phyInstancedStatusTable, tDMChannelLineCode=tDMChannelLineCode, mABNominalTransmitCapacity=mABNominalTransmitCapacity, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, longitude=longitude, latitude=latitude, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, useVLANForMABProtocol=useVLANForMABProtocol, gatewayIPAddress=gatewayIPAddress, transmitFreqMHz=transmitFreqMHz, supplementaryGroup=supplementaryGroup, phyStatus=phyStatus, alarmInstancedTableNumber=alarmInstancedTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessOutOctets=wirelessOutOctets, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sFPError=sFPError, lbtDetectedTrap=lbtDetectedTrap, userName=userName, sNTPSyncTrap=sNTPSyncTrap, telnetAccessEnabled=telnetAccessEnabled, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseIPv6Support=licenseIPv6Support, cableDiagPair4Distance=cableDiagPair4Distance, auxPortStatus=auxPortStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, receivePower=receivePower, tDM=tDM, txColorCode=txColorCode, eIRP=eIRP, sFPPortQLTx=sFPPortQLTx, wirelessLinkAvailability=wirelessLinkAvailability, sFPPortStatusTrap=sFPPortStatusTrap, packetsToInternalStack=packetsToInternalStack, wirelessLinkStatus=wirelessLinkStatus, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, configurationInstancedTableNumber=configurationInstancedTableNumber, extendedSpectrumScanning=extendedSpectrumScanning, transmitFreqKHz=transmitFreqKHz, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, transmitPower=transmitPower, receiveFreqKHz=receiveFreqKHz, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, tDMChannelLoopback=tDMChannelLoopback, enabledDiagnosticAlarms=enabledDiagnosticAlarms, smtp=smtp, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseVersion=licenseVersion, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, installStatus=installStatus, portAllocationMismatchLinked=portAllocationMismatchLinked, mABMaintenanceLevel=mABMaintenanceLevel, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogControlGroup=syslogControlGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, rangingMode=rangingMode, authorizationControlTableNumber=authorizationControlTableNumber, qOSPriorityScheme=qOSPriorityScheme, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, byteErrorRatio=byteErrorRatio, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dfs=dfs, rawReceivePowerLinked=rawReceivePowerLinked, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, pubStats=pubStats, maximumTransmitPower=maximumTransmitPower, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, groupID=groupID, ethernetInstancedTableIndex=ethernetInstancedTableIndex, whitelistRMEnabled=whitelistRMEnabled, auxPortAllocation=auxPortAllocation, authorizationControlTable=authorizationControlTable, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, erroredSeconds=erroredSeconds, licenseSyncESupport=licenseSyncESupport, rxColorCode=rxColorCode, dfsTableNumber=dfsTableNumber, maxLinkRangeExceeded=maxLinkRangeExceeded, vLANManagementPriority=vLANManagementPriority, licenseInstancedTable=licenseInstancedTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dNSServerTableIndex=dNSServerTableIndex, mainPSUPortSSMTx=mainPSUPortSSMTx, versions=versions, hCMPLinkSymmetry=hCMPLinkSymmetry, cableDiagPair3Results=cableDiagPair3Results, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, ethernetInstancedTable=ethernetInstancedTable, portAllocationMismatch=portAllocationMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, reset=reset, managementGroup=managementGroup, mABState=mABState, cableDiagPair2Results=cableDiagPair2Results, enableTransmission=enableTransmission, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, userTableEntry=userTableEntry, supplementary=supplementary, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, localPacketFiltering=localPacketFiltering, syncETrackingState=syncETrackingState, aAAControl=aAAControl, versionsGroup=versionsGroup, sFPErrorTrap=sFPErrorTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, phyControlInstancedTable=phyControlInstancedTable, transmitDataRate=transmitDataRate, remoteMACAddress=remoteMACAddress, cableDiagPair1Results=cableDiagPair1Results, phyControlGroup=phyControlGroup, linkName=linkName, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, unavailableSeconds=unavailableSeconds, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, linkSymmetry=linkSymmetry, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, wirelessLinkStatusLinked=wirelessLinkStatusLinked, capacityVariantMismatchLinked=capacityVariantMismatchLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, wirelessTopology=wirelessTopology, cableDiagnosticsControl=cableDiagnosticsControl, mABNominalModulationMode=mABNominalModulationMode, sFPPortAllocation=sFPPortAllocation, dSCPManagementPriority=dSCPManagementPriority, auxPortSyncERxStatus=auxPortSyncERxStatus, dataBridgingStatusAlarm=dataBridgingStatusAlarm, auxPortAcceptedQLRx=auxPortAcceptedQLRx, authorizationControlTableIndex=authorizationControlTableIndex, remoteUnitName=remoteUnitName, ethernet=ethernet, deviceESN=deviceESN, tFTPServerPortNumber=tFTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, cableDiagnostics=cableDiagnostics, configurationGroup=configurationGroup, dataBridgingStatusLinked=dataBridgingStatusLinked, rawReceivePower=rawReceivePower, byteErrorRatioLinked=byteErrorRatioLinked, mABTransmissionInterval=mABTransmissionInterval, dNSResolver=dNSResolver, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, userPassword=userPassword, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tDMEnabledChannels=tDMEnabledChannels)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPServerTableEntry=sNTPServerTableEntry, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mgmtInstancedTableEntry=mgmtInstancedTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseHCMPSupport=licenseHCMPSupport, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, cableDiagPair4Results=cableDiagPair4Results, encryption=encryption, dNSGroup=dNSGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableIndex=userTableIndex, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, secureModeAlarmTrap=secureModeAlarmTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetInstancedTableEntry=ethernetInstancedTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogStateTrap=syslogStateTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, iPv6PrefixLength=iPv6PrefixLength, sNTPServerTableNumber=sNTPServerTableNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, packetsFromInternalStack=packetsFromInternalStack, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, authorizationMethod=authorizationMethod, rangeLinked=rangeLinked, licenseGroupAccess=licenseGroupAccess, whitelistRMMacAddress=whitelistRMMacAddress, aggregateDataRate=aggregateDataRate, licenseInstancedTableNumber=licenseInstancedTableNumber, targetRange=targetRange, ethernetStatisticsDataSource=ethernetStatisticsDataSource, licenseIEEE1588Support=licenseIEEE1588Support, phyControlInstancedTableIndex=phyControlInstancedTableIndex, transmitChannel=transmitChannel, licenseSecurityLevel=licenseSecurityLevel, hTTPAccessEnabled=hTTPAccessEnabled, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveDataRate=receiveDataRate, licenseCountry=licenseCountry, sntp=sntp, auxPortDisabledWarning=auxPortDisabledWarning, ethernetInstancedTableNumber=ethernetInstancedTableNumber, transparentClockVID=transparentClockVID, auxPortStatusTrap=auxPortStatusTrap, mainPSUPortQLTx=mainPSUPortQLTx, l2CPPriorityTableIndex=l2CPPriorityTableIndex, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, licenseRARSupport=licenseRARSupport, severelyErroredSeconds=severelyErroredSeconds, resetGroup=resetGroup, sMTPServerPortNumber=sMTPServerPortNumber, sFPPortAutoMdix=sFPPortAutoMdix, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber)
