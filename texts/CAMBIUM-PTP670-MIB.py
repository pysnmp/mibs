...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", pubInstancedStatsTable=pubInstancedStatsTable, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, ptp670=ptp670, routerProtocolsGroup=routerProtocolsGroup, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, severelyErroredSeconds=severelyErroredSeconds, encryptionGroup=encryptionGroup, dfsGroup=dfsGroup, licenseInstancedTableIndex=licenseInstancedTableIndex, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, transmitModulationMode=transmitModulationMode, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, cambium=cambium, authorizationControlGroup=authorizationControlGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tDDControl=tDDControl, hCMPMaximumLinkRange=hCMPMaximumLinkRange, dfsTable=dfsTable, configurationInstancedTableNumber=configurationInstancedTableNumber, authorizationControlTableNumber=authorizationControlTableNumber, sNTPServerStatus=sNTPServerStatus, syncEEquipmentClock=syncEEquipmentClock, snmpControlGroup=snmpControlGroup, sNTPLastSync=sNTPLastSync, transmitDataRateLinked=transmitDataRateLinked, linkName=linkName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, apcGroup=apcGroup, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sNTPServerTable=sNTPServerTable, dataPortPauseFrames=dataPortPauseFrames, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNTPPrimaryServer=sNTPPrimaryServer, tFTPServerPortNumber=tFTPServerPortNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, packetsToInternalStack=packetsToInternalStack, telnetAccessEnabled=telnetAccessEnabled, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenseEncryption=licenseEncryption, receiveDataRate=receiveDataRate, phyControlInstancedTable=phyControlInstancedTable, configurationInstancedTableEntry=configurationInstancedTableEntry, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNMPPortNumber=sNMPPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rangingMode=rangingMode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dNS=dNS, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveChannel=receiveChannel, whitelistRMEnabled=whitelistRMEnabled, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, authorizationControlTableEntry=authorizationControlTableEntry, transparentClockVLAN=transparentClockVLAN, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sFPPortQLTx=sFPPortQLTx, tDMEnabledChannels=tDMEnabledChannels, searchStateLinked=searchStateLinked, erroredSeconds=erroredSeconds, tdmTableIndex=tdmTableIndex, ethernetInstancedTable=ethernetInstancedTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitChannel=transmitChannel, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, dNSGroup=dNSGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, configuration=configuration, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sMTPEnabledMessages=sMTPEnabledMessages, mABProtocolVID=mABProtocolVID, dNSServerTableIndex=dNSServerTableIndex, ethernetGroup=ethernetGroup, systemClock=systemClock, licenseGasGroup=licenseGasGroup, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, gatewayIPAddress=gatewayIPAddress, sFPPortSSMTx=sFPPortSSMTx, sFPPortDisabledWarning=sFPPortDisabledWarning, sNTPState=sNTPState, sNTPServerRetries=sNTPServerRetries, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sFPErrorTrap=sFPErrorTrap, dNSServerTableEntry=dNSServerTableEntry, tDMChannelCableLength=tDMChannelCableLength, sFPError=sFPError, tDMChannelStatusTrap=tDMChannelStatusTrap, remoteUnitNameLinked=remoteUnitNameLinked, installStatusTrap=installStatusTrap, blacklistRMEnabled=blacklistRMEnabled, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, bridge=bridge, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControl=phyControl, configurationInstancedTableIndex=configurationInstancedTableIndex, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNMPTrapVersion=sNMPTrapVersion, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dataBridgingStatus=dataBridgingStatus, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, dSCPManagementPriority=dSCPManagementPriority, licenseCapacity=licenseCapacity, transmitModulationModeLinked=transmitModulationModeLinked, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userTable=userTable, dNSServerPortNumber=dNSServerPortNumber, installStatusLinked=installStatusLinked, remoteInternetAddressType=remoteInternetAddressType, eIRP=eIRP, vLANManagementPriority=vLANManagementPriority, syslogClient=syslogClient, timeZone=timeZone, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptpCompliance=ptpCompliance, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, snmpControl=snmpControl, ethernetInstancedTableNumber=ethernetInstancedTableNumber, longitude=longitude, syncETracking=syncETracking, licenseBandwidthCap=licenseBandwidthCap, tDMChannelLineCode=tDMChannelLineCode, sNTPSync=sNTPSync, phyStatus=phyStatus, regulatoryBand=regulatoryBand, sFPPortAllocation=sFPPortAllocation, hardwareVersion=hardwareVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, capacityVariantMismatchTrap=capacityVariantMismatchTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, cableDiagPair4Results=cableDiagPair4Results, mABHoldoffPeriod=mABHoldoffPeriod, antennaSelection=antennaSelection, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, mainPSUPortQLRx=mainPSUPortQLRx, nIDULanPortAutoMdix=nIDULanPortAutoMdix, transparentClockPort=transparentClockPort, regulatoryBandTrap=regulatoryBandTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetInstancedTableIndex=ethernetInstancedTableIndex, cableDiagPair2Distance=cableDiagPair2Distance, wirelessOutEthernetOctets=wirelessOutEthernetOctets, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sFPPortStatus=sFPPortStatus, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sMTPServerPortNumber=sMTPServerPortNumber, mgmtInstancedTable=mgmtInstancedTable, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, transmitterChannels=transmitterChannels, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, subbandLowestFrequency=subbandLowestFrequency, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, subnetMask=subnetMask, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, userTableEntry=userTableEntry, remoteMACAddress=remoteMACAddress, licenseGroupAccess=licenseGroupAccess, ethernetPriorityTableEntry=ethernetPriorityTableEntry, license=license, capacityVariantMismatch=capacityVariantMismatch, qOSPriorityScheme=qOSPriorityScheme, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dNSPrimaryServer=dNSPrimaryServer, auxPortQLTx=auxPortQLTx, auxPortSSMTx=auxPortSSMTx, rxColorCode=rxColorCode, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, dfsTableIndex=dfsTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licenseInstancedTableEntry=licenseInstancedTableEntry, groupID=groupID, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, phyControlInstancedTableEntry=phyControlInstancedTableEntry, syslogControlGroup=syslogControlGroup, dfsTableEntry=dfsTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTableNumber=dfsTableNumber, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sFPPortStatusTrap=sFPPortStatusTrap, secureModeAlarm=secureModeAlarm, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, lowestDataModulationMode=lowestDataModulationMode, aggregateDataRate=aggregateDataRate, dNSResolver=dNSResolver, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sntpGroup=sntpGroup, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ethernet=ethernet, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, cableDiagPair2Results=cableDiagPair2Results, tDMInterfaceControl=tDMInterfaceControl, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, rawReceivePower=rawReceivePower, tdmTableNumber=tdmTableNumber, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, unitName=unitName, sNTPServerTableEntry=sNTPServerTableEntry, hTTPPortNumber=hTTPPortNumber, sFPPortQLRx=sFPPortQLRx, cableLoss=cableLoss, versions=versions, rawReceivePowerLinked=rawReceivePowerLinked, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tDMConfigurationMismatch=tDMConfigurationMismatch, apc=apc, ptpTraps=ptpTraps, alarmInstancedTableEntry=alarmInstancedTableEntry, reset=reset, cableDiagPair1Distance=cableDiagPair1Distance, mainPSUPortStatusTrap=mainPSUPortStatusTrap, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, userTableIndex=userTableIndex, ethernetStatisticsTable=ethernetStatisticsTable, licenseTLSRekey=licenseTLSRekey, transmitDataRate=transmitDataRate, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, supplementaryGroup=supplementaryGroup, deviceMACAddress=deviceMACAddress, secondarySoftwareVersion=secondarySoftwareVersion, localPacketFiltering=localPacketFiltering, hCMPLinkSymmetry=hCMPLinkSymmetry, signalStrengthRatio=signalStrengthRatio, phyInstancedStatusTable=phyInstancedStatusTable, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, antennaGain=antennaGain, telnetPortNumber=telnetPortNumber, channelBandwidth=channelBandwidth, sNMPTrapTable=sNMPTrapTable, sMTPEmailAlert=sMTPEmailAlert, tempPcb=tempPcb, portAllocationMismatchLinked=portAllocationMismatchLinked, unitIdentification=unitIdentification, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userEnabled=userEnabled, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortSSMTx=mainPSUPortSSMTx, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, enabledDiagnosticAlarms=enabledDiagnosticAlarms, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, linkModeOptimization=linkModeOptimization, tFTPClient=tFTPClient, licenseSecurityLevel=licenseSecurityLevel)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sMTPServerInternetAddressType=sMTPServerInternetAddressType, aggregateDataRateLinked=aggregateDataRateLinked, tDMGroup=tDMGroup, mgmtInstancedTableNumber=mgmtInstancedTableNumber, licenseIssueNumber=licenseIssueNumber, nIDULanPortStatus=nIDULanPortStatus, receiveFreqMHz=receiveFreqMHz, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, mgmtInstancedTableIndex=mgmtInstancedTableIndex, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, whitelistRMMacAddress=whitelistRMMacAddress, linkLossLinked=linkLossLinked, linkSymmetry=linkSymmetry, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, resetGroup=resetGroup, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ptp=ptp, ptpTrapPrefix=ptpTrapPrefix, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagPair3Distance=cableDiagPair3Distance, notificationsGroup=notificationsGroup, receivePowerLinked=receivePowerLinked, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, phyControlGroup=phyControlGroup, portAllocationMismatchTrap=portAllocationMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, alarms=alarms, alarmInstancedTable=alarmInstancedTable, dNSServerInternetAddress=dNSServerInternetAddress, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, lbtDetectedTrap=lbtDetectedTrap, dfsMeans=dfsMeans, cableDiagPair1Results=cableDiagPair1Results, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, routerProtocols=routerProtocols, targetRange=targetRange, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, tDM=tDM, mABNominalModulationMode=mABNominalModulationMode, transparentClock=transparentClock, signalStrengthRatioLinked=signalStrengthRatioLinked, mABNominalTransmitCapacity=mABNominalTransmitCapacity, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, frequencyVariant=frequencyVariant, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagnosticsControl=cableDiagnosticsControl, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, bootVersion=bootVersion, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, deviceMSN=deviceMSN, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, latitude=latitude, auxPortQLRx=auxPortQLRx, installationMode=installationMode, syslogStateTrap=syslogStateTrap, packetsFromInternalStack=packetsFromInternalStack, licenseMaxLinkRange=licenseMaxLinkRange, channelChangeTrap=channelChangeTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, syslogControl=syslogControl, altitude=altitude, auxPortSyncERxStatus=auxPortSyncERxStatus, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, receiveDataRateLinked=receiveDataRateLinked, licenseUnitSerialNumber=licenseUnitSerialNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, encryption=encryption, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, installArmState=installArmState, installArmStateTrap=installArmStateTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, installStatus=installStatus, unitIdentificationGroup=unitIdentificationGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, receiveModulationModeLinked=receiveModulationModeLinked, daylightSaving=daylightSaving, syncETrackingState=syncETrackingState, sNTPSyncTrap=sNTPSyncTrap, vectorError=vectorError, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, productVariant=productVariant, licenseVersion=licenseVersion, licenseIPv6Support=licenseIPv6Support, dfsPeaks=dfsPeaks, authorizationControlTable=authorizationControlTable, phyStatusGroup=phyStatusGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, auxPortAllocation=auxPortAllocation, receivePower=receivePower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogState=syslogState, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseInstancedTable=licenseInstancedTable, vLANManagementVID=vLANManagementVID, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetPriorityTable=ethernetPriorityTable, receiveFreqKHz=receiveFreqKHz, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sNTPServerTimeout=sNTPServerTimeout, searchState=searchState, pubStats=pubStats, authorizationControl=authorizationControl, rangeLinked=rangeLinked, enableTransmission=enableTransmission, range=range, deviceESN=deviceESN, siteName=siteName, productName=productName, dataBridgingAvailability=dataBridgingAvailability, wirelessTopology=wirelessTopology, secureModeAlarmTrap=secureModeAlarmTrap, cableDiagnostics=cableDiagnostics, aAAControl=aAAControl, managementGroup=managementGroup, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, userTableNumber=userTableNumber, unitOutOfCalibration=unitOutOfCalibration, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, dataBridgingStatusLinked=dataBridgingStatusLinked, lowestTDMModulationMode=lowestTDMModulationMode, wirelessLinkStatusLinked=wirelessLinkStatusLinked, auxPortStatusTrap=auxPortStatusTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, encryptionAlgorithm=encryptionAlgorithm, extendedSpectrumScanning=extendedSpectrumScanning, alarmInstancedTableNumber=alarmInstancedTableNumber, ptpGroups=ptpGroups, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseSFPPortSupport=licenseSFPPortSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqMHz=transmitFreqMHz, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, iPv4Address=iPv4Address, useVLANForMABProtocol=useVLANForMABProtocol, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNTPServerTableNumber=sNTPServerTableNumber, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sNTPServerPortNumber=sNTPServerPortNumber, dNSServerTable=dNSServerTable, transparentClockVID=transparentClockVID, ethernetPriorityTableNumber=ethernetPriorityTableNumber, pubStatsGroup=pubStatsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkStatus=wirelessLinkStatus, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, configurationInstancedTable=configurationInstancedTable, txMABFrames=txMABFrames, mABMaintenanceLevel=mABMaintenanceLevel, mABProtocolVLANPriority=mABProtocolVLANPriority, sFPPortAutoMdix=sFPPortAutoMdix, smtp=smtp, sNTPServerTableIndex=sNTPServerTableIndex, byteErrorRatio=byteErrorRatio, iPv6PrefixLength=iPv6PrefixLength, accessMethod=accessMethod, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, subbandHighestFrequency=subbandHighestFrequency, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, ptmp=ptmp, hTTPSPortNumber=hTTPSPortNumber, mABTransmissionInterval=mABTransmissionInterval, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, alarmInstancedTableIndex=alarmInstancedTableIndex, masterSlaveMode=masterSlaveMode, incompatibleRegulatoryBands=incompatibleRegulatoryBands, syncESlavePort=syncESlavePort, licenseRARSupport=licenseRARSupport, syslogClientTrap=syslogClientTrap, mainPSUPortQLTx=mainPSUPortQLTx, userPassword=userPassword, wirelessOutAllOctets=wirelessOutAllOctets, mABState=mABState, bridgeGroup=bridgeGroup, cableDiagPair3Results=cableDiagPair3Results, licenseSyncESupport=licenseSyncESupport, sNTPPollInterval=sNTPPollInterval, wirelessOutOctets=wirelessOutOctets, userName=userName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, cableDiagnosticsWarning=cableDiagnosticsWarning, remoteUnitName=remoteUnitName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseHCMPSupport=licenseHCMPSupport, tDDSynchronizationMode=tDDSynchronizationMode, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, userRole=userRole, tdmTable=tdmTable, tDDSynchronizationStatus=tDDSynchronizationStatus, auxPortStatus=auxPortStatus, mainPSUPortStatus=mainPSUPortStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, configurationGroup=configurationGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, dfs=dfs, txColorCode=txColorCode, sntp=sntp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, targetMACAddress=targetMACAddress, portAllocationMismatch=portAllocationMismatch, capacityVariantMismatchLinked=capacityVariantMismatchLinked, dNSServerTableNumber=dNSServerTableNumber, tDMInterfaceStatus=tDMInterfaceStatus, maximumTransmitPower=maximumTransmitPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseIEEE1588Support=licenseIEEE1588Support, systemReset=systemReset, tDMChannelLoopback=tDMChannelLoopback, phyControlInstancedTableNumber=phyControlInstancedTableNumber, aAAControlGroup=aAAControlGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortDisabledWarning=auxPortDisabledWarning, iPv6Address=iPv6Address, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseTrialPeriod=licenseTrialPeriod, smtpGroup=smtpGroup, management=management, sNMPv3Enable=sNMPv3Enable, transmitPowerLinked=transmitPowerLinked, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, authorizationControlTableIndex=authorizationControlTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseCountry=licenseCountry, dNSServerInternetAddressType=dNSServerInternetAddressType, licenseOOBManagementSupport=licenseOOBManagementSupport, transmitPower=transmitPower)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, softwareVersion=softwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, l2CPPriorityTable=l2CPPriorityTable, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, byteErrorRatioLinked=byteErrorRatioLinked, iPv6GatewayAddress=iPv6GatewayAddress, linkLoss=linkLoss, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyControlInstancedTableIndex=phyControlInstancedTableIndex, blacklistRMMacAddress=blacklistRMMacAddress, tDDControlGroup=tDDControlGroup, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, cableDiagPair4Distance=cableDiagPair4Distance, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, supplementary=supplementary, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tDMChannelStatus=tDMChannelStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, authorizationMethod=authorizationMethod, mgmtInstancedTableEntry=mgmtInstancedTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, ethernetInstancedTableEntry=ethernetInstancedTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, versionsGroup=versionsGroup, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNMPEnabledTraps=sNMPEnabledTraps, cableDiagnosticsResultTable=cableDiagnosticsResultTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseGroup=licenseGroup, remoteInternetAddressLinked=remoteInternetAddressLinked, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPVersion=iPVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, unavailableSeconds=unavailableSeconds, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkAvailability=wirelessLinkAvailability, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, cableDiagnosticsPorts=cableDiagnosticsPorts, vectorErrorLinked=vectorErrorLinked, licenseInstancedTableNumber=licenseInstancedTableNumber, tdmTableEntry=tdmTableEntry, remoteInternetAddress=remoteInternetAddress, remoteMACAddressLinked=remoteMACAddressLinked, hTTPSAccessEnabled=hTTPSAccessEnabled, mainPSUPortAllocation=mainPSUPortAllocation, PYSNMP_MODULE_ID=cambium)
