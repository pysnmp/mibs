...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", syslogState=syslogState, searchStateLinked=searchStateLinked, wirelessLinkStatusLinked=wirelessLinkStatusLinked, configurationInstancedTable=configurationInstancedTable, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, snmpControlGroup=snmpControlGroup, dNS=dNS, encryptionGroup=encryptionGroup, bridgeGroup=bridgeGroup, smtp=smtp, siteName=siteName, cableDiagPair4Distance=cableDiagPair4Distance, remoteInternetAddressType=remoteInternetAddressType, sFPPortSyncERxStatus=sFPPortSyncERxStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, licenseIPv6Support=licenseIPv6Support, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseIEEE1588Support=licenseIEEE1588Support, authorizationControlGroup=authorizationControlGroup, dNSPrimaryServer=dNSPrimaryServer, sNTPServerPortNumber=sNTPServerPortNumber, tdmTableIndex=tdmTableIndex, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, oOBPriorityQueueMapping=oOBPriorityQueueMapping, syncESlavePort=syncESlavePort, licenseTrialPeriod=licenseTrialPeriod, transmitModulationModeLinked=transmitModulationModeLinked, syncETracking=syncETracking, sNTPPrimaryServer=sNTPPrimaryServer, blacklistRMEnabled=blacklistRMEnabled, wirelessLinkStatus=wirelessLinkStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, linkName=linkName, useVLANForMABProtocol=useVLANForMABProtocol, dNSServerTableIndex=dNSServerTableIndex, frequencyVariant=frequencyVariant, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, whitelistRMMacAddress=whitelistRMMacAddress, management=management, dfsGroup=dfsGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, dataBridgingAvailability=dataBridgingAvailability, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mgmtInstancedTableEntry=mgmtInstancedTableEntry, authorizationControlTableEntry=authorizationControlTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, phyControlInstancedTableEntry=phyControlInstancedTableEntry, pubStatsGroup=pubStatsGroup, signalStrengthRatio=signalStrengthRatio, systemReset=systemReset, mABState=mABState, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, rawReceivePower=rawReceivePower, mABProtocolVID=mABProtocolVID, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, sNTPPollInterval=sNTPPollInterval, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerPortNumber=tFTPServerPortNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, licenseInstancedTableIndex=licenseInstancedTableIndex, linkLossLinked=linkLossLinked, cambium=cambium, receivePowerLinked=receivePowerLinked, secondarySoftwareVersion=secondarySoftwareVersion, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tDDControl=tDDControl, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerRetries=sNTPServerRetries, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, cableDiagPair1Distance=cableDiagPair1Distance, whitelistRMEnabled=whitelistRMEnabled, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, linkLoss=linkLoss, mgmtInstancedTableIndex=mgmtInstancedTableIndex, routerProtocolsGroup=routerProtocolsGroup, auxPortQLRx=auxPortQLRx, hardwareVersion=hardwareVersion, snmpControl=snmpControl, txColorCode=txColorCode, sFPPortSSMTx=sFPPortSSMTx, notificationsGroup=notificationsGroup, ethernetInstancedTableIndex=ethernetInstancedTableIndex, licenseTDDSyncSupport=licenseTDDSyncSupport, wirelessOutAllOctets=wirelessOutAllOctets, mgmtInstancedTable=mgmtInstancedTable, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sFPPortAutoMdix=sFPPortAutoMdix, remoteMACAddress=remoteMACAddress, unavailableSeconds=unavailableSeconds, targetRange=targetRange, managementNetworkAccessEnabled=managementNetworkAccessEnabled, searchState=searchState, dfs=dfs, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, pubStats=pubStats, alarmsGroup=alarmsGroup, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, capacityVariantMismatchTrap=capacityVariantMismatchTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, rangingMode=rangingMode, sNTPState=sNTPState, maximumTransmitPower=maximumTransmitPower, sFPPortQLTx=sFPPortQLTx, regulatoryBand=regulatoryBand, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, ethernetInstancedTableNumber=ethernetInstancedTableNumber, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, licenseOOBManagementSupport=licenseOOBManagementSupport, authorizationMethod=authorizationMethod, userTable=userTable, sNTPSync=sNTPSync, ptpTrapPrefix=ptpTrapPrefix, masterSlaveMode=masterSlaveMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telnetPortNumber=telnetPortNumber, resetGroup=resetGroup, sNMPv3Enable=sNMPv3Enable, tDMChannelCableLength=tDMChannelCableLength, installationMode=installationMode, transmitDataRateLinked=transmitDataRateLinked, ethernetInstancedTableEntry=ethernetInstancedTableEntry, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, managementGroup=managementGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, installStatus=installStatus, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, syslogControlGroup=syslogControlGroup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, licenseGroup=licenseGroup, subbandLowestFrequency=subbandLowestFrequency, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, installArmStateTrap=installArmStateTrap, packetsToInternalStack=packetsToInternalStack, licenseBandwidthCap=licenseBandwidthCap, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteMACAddressLinked=remoteMACAddressLinked, receiveChannel=receiveChannel, sMTPServerInternetAddress=sMTPServerInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, blacklistRMMacAddress=blacklistRMMacAddress, tDMChannelLineCode=tDMChannelLineCode, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, syslogControl=syslogControl, accessMethod=accessMethod, licenseSFPPortSupport=licenseSFPPortSupport, rawReceivePowerLinked=rawReceivePowerLinked, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dNSResolver=dNSResolver, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, aggregateDataRate=aggregateDataRate, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tDMGroup=tDMGroup, productName=productName, bridge=bridge, userEnabled=userEnabled, range=range, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, unitOutOfCalibration=unitOutOfCalibration, licenseRARSupport=licenseRARSupport, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, transmitDataRate=transmitDataRate, authorizationControlTable=authorizationControlTable, linkModeOptimization=linkModeOptimization, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, dNSServerInternetAddress=dNSServerInternetAddress, systemClock=systemClock, receiveModulationMode=receiveModulationMode, tDMChannelStatus=tDMChannelStatus, licenseCapacity=licenseCapacity, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPVersion=iPVersion, dataBridgingStatus=dataBridgingStatus, subnetMask=subnetMask, vectorErrorLinked=vectorErrorLinked, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseTLSRekey=licenseTLSRekey, auxPortAllocation=auxPortAllocation, mainPSUPortAllocation=mainPSUPortAllocation, receiveFreqKHz=receiveFreqKHz, sNTPServerInternetAddressType=sNTPServerInternetAddressType, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, iPDSCPPriorityTable=iPDSCPPriorityTable, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, installStatusLinked=installStatusLinked, pubInstancedStatsTable=pubInstancedStatsTable, configurationInstancedTableIndex=configurationInstancedTableIndex, sNTPLastSync=sNTPLastSync, localPacketFiltering=localPacketFiltering, smtpGroup=smtpGroup, installStatusTrap=installStatusTrap, iPv6PrefixLength=iPv6PrefixLength, syncEEquipmentClock=syncEEquipmentClock, sNMPTrapTable=sNMPTrapTable, vLANManagementVID=vLANManagementVID, sNTPServerTimeout=sNTPServerTimeout, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortWirelessDownAlert=managementPortWirelessDownAlert, maxLinkRangeExceeded=maxLinkRangeExceeded, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, cableDiagPair2Distance=cableDiagPair2Distance, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDM=tDM, userTableEntry=userTableEntry, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, byteErrorRatio=byteErrorRatio, sMTPEmailAlert=sMTPEmailAlert, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, tDMInterfaceControl=tDMInterfaceControl, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, wirelessOutOctets=wirelessOutOctets, encryption=encryption, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, l2CPPriorityTableNumber=l2CPPriorityTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, auxPortDisabledWarning=auxPortDisabledWarning, licenseGroupAccess=licenseGroupAccess, linkSymmetry=linkSymmetry, lbtDetectedTrap=lbtDetectedTrap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseInstancedTableEntry=licenseInstancedTableEntry, ptp670=ptp670, licenseGasGroup=licenseGasGroup, erroredSeconds=erroredSeconds, license=license, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, remoteInternetAddress=remoteInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPPortNumber=sNMPPortNumber, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, supplementaryGroup=supplementaryGroup, hCMPMaximumLinkRange=hCMPMaximumLinkRange, phyControl=phyControl, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, nIDULanPortStatus=nIDULanPortStatus, latitude=latitude, auxPortStatus=auxPortStatus, vLANManagementPriority=vLANManagementPriority, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tdmTableEntry=tdmTableEntry, transparentClock=transparentClock, userPassword=userPassword, aAAControl=aAAControl, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sntpGroup=sntpGroup, cableDiagPair4Results=cableDiagPair4Results, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseVersion=licenseVersion, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, ethernetGroup=ethernetGroup, ptpGroups=ptpGroups, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, phyStatus=phyStatus, cableDiagnosticsResultTable=cableDiagnosticsResultTable, authorizationControl=authorizationControl, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, targetMACAddress=targetMACAddress, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, unitIdentification=unitIdentification, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, lowestDataModulationMode=lowestDataModulationMode, sNTPServerTableIndex=sNTPServerTableIndex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, extendedSpectrumScanning=extendedSpectrumScanning, licenseInstancedTable=licenseInstancedTable, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, auxPortQLTx=auxPortQLTx, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, groupID=groupID, userName=userName, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, daylightSaving=daylightSaving, transmitterChannels=transmitterChannels, sNTPServerTableEntry=sNTPServerTableEntry, cableLoss=cableLoss, alarmInstancedTableNumber=alarmInstancedTableNumber, receiveDataRate=receiveDataRate, wirelessLinkAvailability=wirelessLinkAvailability, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogClientTrap=syslogClientTrap, apcGroup=apcGroup, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, receiveModulationModeDetail=receiveModulationModeDetail, deviceESN=deviceESN, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, authorizationControlTableNumber=authorizationControlTableNumber, antennaGain=antennaGain, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseUnitSerialNumber=licenseUnitSerialNumber, tdmTable=tdmTable, receiveModulationModeLinked=receiveModulationModeLinked, capacityVariantMismatch=capacityVariantMismatch, cableDiagnosticsControl=cableDiagnosticsControl, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dfsMeans=dfsMeans, l2CPPriorityTable=l2CPPriorityTable, unitName=unitName, txMABFrames=txMABFrames, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, aggregateDataRateLinked=aggregateDataRateLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, phyControlGroup=phyControlGroup, byteErrorRatioLinked=byteErrorRatioLinked, packetsFromInternalStack=packetsFromInternalStack, mgmtInstancedTableNumber=mgmtInstancedTableNumber, dNSServerInternetAddressType=dNSServerInternetAddressType, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessTopology=wirelessTopology, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mABNominalTransmitCapacity=mABNominalTransmitCapacity, secureModeAlarm=secureModeAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, qOSPriorityScheme=qOSPriorityScheme, timeZone=timeZone, versions=versions, enableTransmission=enableTransmission, alarms=alarms, subbandHighestFrequency=subbandHighestFrequency, ptpTraps=ptpTraps, ptp=ptp, licenseCountry=licenseCountry, mainPSUPortStatus=mainPSUPortStatus, dfsTable=dfsTable, dNSServerPortNumber=dNSServerPortNumber, sFPErrorTrap=sFPErrorTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, cableDiagPair2Results=cableDiagPair2Results, alarmInstancedTableIndex=alarmInstancedTableIndex, bootVersion=bootVersion, eIRP=eIRP, tDMChannelLoopback=tDMChannelLoopback, hTTPAccessEnabled=hTTPAccessEnabled, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, configurationInstancedTableEntry=configurationInstancedTableEntry, channelBandwidth=channelBandwidth, remoteUnitNameLinked=remoteUnitNameLinked, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transparentClockVID=transparentClockVID, remoteUnitName=remoteUnitName, mABHoldoffPeriod=mABHoldoffPeriod, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, syslogStateTrap=syslogStateTrap, ethernet=ethernet, iPv4Address=iPv4Address, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, ptpCompliance=ptpCompliance, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, dfsTableNumber=dfsTableNumber, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, vectorError=vectorError, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortAllocation=sFPPortAllocation, transmitFreqMHz=transmitFreqMHz, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, dSCPManagementPriority=dSCPManagementPriority, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, tDDSynchronizationMode=tDDSynchronizationMode, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, rxColorCode=rxColorCode, tFTPClient=tFTPClient, authorizationControlTableIndex=authorizationControlTableIndex, versionsGroup=versionsGroup, unitIdentificationGroup=unitIdentificationGroup, configurationGroup=configurationGroup, apc=apc, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, portAllocationMismatch=portAllocationMismatch, mABTransmissionInterval=mABTransmissionInterval, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagnostics=cableDiagnostics, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, receiveFreqMHz=receiveFreqMHz, licenseMaxLinkRange=licenseMaxLinkRange, hTTPPortNumber=hTTPPortNumber, sNTPServerStatus=sNTPServerStatus, syslogClient=syslogClient, channelChangeTrap=channelChangeTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDControlGroup=tDDControlGroup, syncETrackingState=syncETrackingState, auxPortSSMTx=auxPortSSMTx, ptmp=ptmp, phyInstancedStatusTable=phyInstancedStatusTable, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNMPCommunityString=sNMPCommunityString, userTableNumber=userTableNumber, sntp=sntp, tempPcb=tempPcb, receivePower=receivePower, sFPError=sFPError, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPv6Address=iPv6Address, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, configuration=configuration, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, tDMEnabledChannels=tDMEnabledChannels, cableDiagPair3Results=cableDiagPair3Results, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortPauseFrames=dataPortPauseFrames, remoteInternetAddressLinked=remoteInternetAddressLinked, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, altitude=altitude, transmitFreqKHz=transmitFreqKHz, mainPSUPortQLTx=mainPSUPortQLTx, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, auxPortStatusTrap=auxPortStatusTrap, sFPPortStatusTrap=sFPPortStatusTrap, transparentClockPort=transparentClockPort, ethernetStatisticsTable=ethernetStatisticsTable, ethernetPriorityTable=ethernetPriorityTable, ethernetInstancedTable=ethernetInstancedTable, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, cableDiagPair1Results=cableDiagPair1Results, deviceMSN=deviceMSN, transmitPower=transmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, configurationInstancedTableNumber=configurationInstancedTableNumber, dfsPeaks=dfsPeaks, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sFPPortQLRx=sFPPortQLRx, licenseEncryption=licenseEncryption, mABNominalModulationMode=mABNominalModulationMode, tdmTableNumber=tdmTableNumber, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, phyControlInstancedTable=phyControlInstancedTable, installArmState=installArmState, portAllocationMismatchLinked=portAllocationMismatchLinked, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mainPSUPortStatusTrap=mainPSUPortStatusTrap, lowestTDMModulationMode=lowestTDMModulationMode, licenseSyncESupport=licenseSyncESupport, mainPSUPortSSMTx=mainPSUPortSSMTx, regulatoryBandTrap=regulatoryBandTrap, supplementary=supplementary, sNMPTrapTableIndex=sNMPTrapTableIndex, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, ethernetPriorityTableIndex=ethernetPriorityTableIndex, deviceMACAddress=deviceMACAddress, dNSServerTableEntry=dNSServerTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortSyncERxStatus=auxPortSyncERxStatus, cableDiagPair3Distance=cableDiagPair3Distance, licenseInstancedTableNumber=licenseInstancedTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, transmitChannel=transmitChannel, sFPPortDisabledWarning=sFPPortDisabledWarning, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, auxPortConfigurationMismatch=auxPortConfigurationMismatch, dfsTableEntry=dfsTableEntry, sNTPServerTable=sNTPServerTable, transmitModulationMode=transmitModulationMode, alarmInstancedTable=alarmInstancedTable, tDMInterfaceStatus=tDMInterfaceStatus, aAAControlGroup=aAAControlGroup, dataBridgingStatusLinked=dataBridgingStatusLinked, receiveDataRateLinked=receiveDataRateLinked, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, longitude=longitude, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseSecurityLevel=licenseSecurityLevel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, routerProtocols=routerProtocols, productVariant=productVariant, userTableIndex=userTableIndex, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, encryptionAlgorithm=encryptionAlgorithm, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPTrapInternetAddress=sNMPTrapInternetAddress, severelyErroredSeconds=severelyErroredSeconds, sNTPSyncTrap=sNTPSyncTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogLocalWrappedTrap=syslogLocalWrappedTrap, antennaSelection=antennaSelection, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, userRole=userRole, transmitPowerLinked=transmitPowerLinked, rangeLinked=rangeLinked, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, dfsTableIndex=dfsTableIndex, licenseIssueNumber=licenseIssueNumber, dNSServerTable=dNSServerTable, dNSServerTableNumber=dNSServerTableNumber, licenseHCMPSupport=licenseHCMPSupport, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sFPPortStatus=sFPPortStatus, reset=reset, softwareVersion=softwareVersion, mABMaintenanceLevel=mABMaintenanceLevel, mainPSUPortAutoMdix=mainPSUPortAutoMdix, secureModeAlarmTrap=secureModeAlarmTrap, phyStatusGroup=phyStatusGroup, hCMPLinkSymmetry=hCMPLinkSymmetry, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, PYSNMP_MODULE_ID=cambium, sMTPServerInternetAddressType=sMTPServerInternetAddressType, cableDiagnosticsWarning=cableDiagnosticsWarning, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dNSGroup=dNSGroup, transparentClockVLAN=transparentClockVLAN, licenseRegulatoryBandsList=licenseRegulatoryBandsList)
