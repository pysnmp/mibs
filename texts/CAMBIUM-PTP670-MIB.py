...
enterprises, NotificationType, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, iso, Counter32, Counter64, TimeTicks, Unsigned32, IpAddress, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "iso", "Counter32", "Counter64", "TimeTicks", "Unsigned32", "IpAddress", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortDisabledWarning=sFPPortDisabledWarning, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, hTTPAccessEnabled=hTTPAccessEnabled, deviceMACAddress=deviceMACAddress, mainPSUPortAutoMdix=mainPSUPortAutoMdix, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mgmtInstancedTable=mgmtInstancedTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tdmTableEntry=tdmTableEntry, sNMPCommunityString=sNMPCommunityString, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, linkName=linkName, authorizationControlGroup=authorizationControlGroup, mainPSUPortSSMTx=mainPSUPortSSMTx, ethernetStatisticsDataSource=ethernetStatisticsDataSource, rangingMode=rangingMode, phyStatus=phyStatus, auxPortQLTx=auxPortQLTx, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseInstancedTableIndex=licenseInstancedTableIndex, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, dSCPManagementPriority=dSCPManagementPriority, encryptionGroup=encryptionGroup, whitelistRMEnabled=whitelistRMEnabled, tDDControl=tDDControl, dfsPeaks=dfsPeaks, userTableNumber=userTableNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sFPPortQLTx=sFPPortQLTx, licenseIPv6Support=licenseIPv6Support, dataBridgingStatusAlarm=dataBridgingStatusAlarm, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, routerProtocols=routerProtocols, cambium=cambium, alarmInstancedTableIndex=alarmInstancedTableIndex, channelChangeTrap=channelChangeTrap, apc=apc, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseEncryption=licenseEncryption, tdmTable=tdmTable, licenseBandwidthCap=licenseBandwidthCap, vectorError=vectorError, iPVersion=iPVersion, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, iPv6GatewayAddress=iPv6GatewayAddress, licenseCapacity=licenseCapacity, linkLoss=linkLoss, versions=versions, unitIdentificationGroup=unitIdentificationGroup, syslogClient=syslogClient, transparentClockVID=transparentClockVID, deviceMSN=deviceMSN, sFPPortStatus=sFPPortStatus, packetsFromInternalStack=packetsFromInternalStack, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, linkSymmetry=linkSymmetry, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, longitude=longitude, ethernet=ethernet, vectorErrorLinked=vectorErrorLinked, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, aggregateDataRate=aggregateDataRate, sFPErrorTrap=sFPErrorTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControl=aAAControl, userEnabled=userEnabled, aAAControlGroup=aAAControlGroup, bridge=bridge, sNMPTrapTableNumber=sNMPTrapTableNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, phyControlGroup=phyControlGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, packetsToInternalStack=packetsToInternalStack, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkStatus=wirelessLinkStatus, tDM=tDM, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, configuration=configuration, syncETrackingState=syncETrackingState, receiveModulationModeDetail=receiveModulationModeDetail, tDMChannelStatus=tDMChannelStatus, tFTPServerPortNumber=tFTPServerPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetPriorityTable=ethernetPriorityTable, auxPortAcceptedQLRx=auxPortAcceptedQLRx, nIDULanPortStatusTrap=nIDULanPortStatusTrap, lowestDataModulationMode=lowestDataModulationMode, routerProtocolsGroup=routerProtocolsGroup, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, remoteInternetAddressType=remoteInternetAddressType, dNSResolver=dNSResolver, tDMGroup=tDMGroup, sNTPPrimaryServer=sNTPPrimaryServer, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mABNominalModulationMode=mABNominalModulationMode, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, authorizationMethod=authorizationMethod, localPacketFiltering=localPacketFiltering, receivePower=receivePower, subnetMask=subnetMask, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, userPassword=userPassword, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, lbtDetectedTrap=lbtDetectedTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tDMChannelCableLength=tDMChannelCableLength, unitIdentification=unitIdentification, remoteUnitNameLinked=remoteUnitNameLinked, tFTPServerInternetAddressType=tFTPServerInternetAddressType, PYSNMP_MODULE_ID=cambium, mABProtocolVID=mABProtocolVID, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, apcGroup=apcGroup, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerPortNumber=sMTPServerPortNumber, receiveDataRateLinked=receiveDataRateLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, mABTransmissionInterval=mABTransmissionInterval, remoteMACAddress=remoteMACAddress, receiveModulationMode=receiveModulationMode, mABState=mABState, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, syncETracking=syncETracking, transmitPowerLinked=transmitPowerLinked, sNTPServerTable=sNTPServerTable, cableDiagPair1Distance=cableDiagPair1Distance, userRole=userRole, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mgmtInstancedTableNumber=mgmtInstancedTableNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, incompatibleMasterAndSlave=incompatibleMasterAndSlave, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, regulatoryBand=regulatoryBand, ptpGroups=ptpGroups, maximumNumberOfSlaves=maximumNumberOfSlaves, configurationInstancedTableIndex=configurationInstancedTableIndex, cableDiagnosticsPorts=cableDiagnosticsPorts, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimization=linkModeOptimization, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPv4Address=iPv4Address, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, altitude=altitude, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, configurationGroup=configurationGroup, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortQLRx=sFPPortQLRx, tDMChannelLineCode=tDMChannelLineCode, licenseRARSupport=licenseRARSupport, range=range, licenseVersion=licenseVersion, authorizationControlTableNumber=authorizationControlTableNumber, licenseTrialPeriod=licenseTrialPeriod, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mABProtocolVLANPriority=mABProtocolVLANPriority, sNTPPollInterval=sNTPPollInterval, transmitterChannels=transmitterChannels, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, dataPortPauseFrames=dataPortPauseFrames, tDMInterfaceControl=tDMInterfaceControl, syslogControl=syslogControl, masterSlaveMode=masterSlaveMode, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, signalStrengthRatioLinked=signalStrengthRatioLinked, sNTPServerStatus=sNTPServerStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, license=license, cableDiagnostics=cableDiagnostics, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, subbandLowestFrequency=subbandLowestFrequency, mgmtInstancedTableEntry=mgmtInstancedTableEntry, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, maximumTransmitPower=maximumTransmitPower, aggregateDataRateLinked=aggregateDataRateLinked, wirelessTopology=wirelessTopology, telnetAccessEnabled=telnetAccessEnabled, receiveDataRate=receiveDataRate, userTable=userTable, dataBridgingStatusLinked=dataBridgingStatusLinked, receiveChannel=receiveChannel, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNTPLastSync=sNTPLastSync, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, remoteInternetAddress=remoteInternetAddress, alarmInstancedTableEntry=alarmInstancedTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseTDDSyncSupport=licenseTDDSyncSupport, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, searchState=searchState, whitelistRMMacAddress=whitelistRMMacAddress, userName=userName, enableTransmission=enableTransmission, syslogState=syslogState, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, tDDSynchronizationAlarm=tDDSynchronizationAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, subbandHighestFrequency=subbandHighestFrequency, sNTPServerInternetAddress=sNTPServerInternetAddress, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, remoteInternetAddressLinked=remoteInternetAddressLinked, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetInstancedTableEntry=ethernetInstancedTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transparentClockPort=transparentClockPort, portAllocationMismatchTrap=portAllocationMismatchTrap, sNTPServerRetries=sNTPServerRetries, syslogStateTrap=syslogStateTrap, rangeLinked=rangeLinked, dNSGroup=dNSGroup, licenseSyncESupport=licenseSyncESupport, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ethernetInstancedTableIndex=ethernetInstancedTableIndex, nIDULanPortStatus=nIDULanPortStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, signalStrengthRatio=signalStrengthRatio, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, cableDiagPair2Distance=cableDiagPair2Distance, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, syncEEquipmentClock=syncEEquipmentClock, configurationInstancedTable=configurationInstancedTable, licenseCountry=licenseCountry, systemClock=systemClock, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, txMABFrames=txMABFrames, transmitDataRate=transmitDataRate, extendedSpectrumScanning=extendedSpectrumScanning, bridgeGroup=bridgeGroup, rxColorCode=rxColorCode, alarmInstancedTableNumber=alarmInstancedTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetInstancedTable=ethernetInstancedTable, secureModeAlarmTrap=secureModeAlarmTrap, regulatoryBandTrap=regulatoryBandTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bootVersion=bootVersion, sNTPServerTableIndex=sNTPServerTableIndex, mainPSUPortQLTx=mainPSUPortQLTx, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, encryptionAlgorithm=encryptionAlgorithm, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, licenseIEEE1588Support=licenseIEEE1588Support, portAllocationMismatch=portAllocationMismatch, licenseUnitSerialNumber=licenseUnitSerialNumber, transmitFreqMHz=transmitFreqMHz, phyInstancedStatusTable=phyInstancedStatusTable, sFPError=sFPError, licenseIssueNumber=licenseIssueNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, systemReset=systemReset, installationMode=installationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, dNSServerInternetAddressType=dNSServerInternetAddressType, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, receiveFreqKHz=receiveFreqKHz, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sntpGroup=sntpGroup, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, smtpGroup=smtpGroup, auxPortAllocation=auxPortAllocation, telnetPortNumber=telnetPortNumber, mainPSUPortStatus=mainPSUPortStatus, sNMPv3Enable=sNMPv3Enable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userTableEntry=userTableEntry, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, vLANManagementVID=vLANManagementVID, rawReceivePowerLinked=rawReceivePowerLinked, userTableIndex=userTableIndex, cableDiagPair4Distance=cableDiagPair4Distance, cableDiagPair2Results=cableDiagPair2Results, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, authorizationControlTable=authorizationControlTable, pubInstancedStatsTable=pubInstancedStatsTable, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseSFPPortSupport=licenseSFPPortSupport, snmpControlGroup=snmpControlGroup, alarmInstancedTable=alarmInstancedTable, receiveFreqMHz=receiveFreqMHz, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, alarms=alarms, mainPSUPortAllocation=mainPSUPortAllocation, tDDSynchronizationMode=tDDSynchronizationMode, dNSServerTable=dNSServerTable, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, useVLANForMABProtocol=useVLANForMABProtocol, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sMTPEnabledMessages=sMTPEnabledMessages, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsGroup=dfsGroup, iPv6PrefixLength=iPv6PrefixLength, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, latitude=latitude, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sMTPEmailAlert=sMTPEmailAlert, byteErrorRatio=byteErrorRatio, targetMACAddress=targetMACAddress, siteName=siteName, sFPPortAutoMdix=sFPPortAutoMdix, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, wirelessLinkAvailability=wirelessLinkAvailability, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, reset=reset, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mgmtInstancedTableIndex=mgmtInstancedTableIndex, nIDULanPortAutoMdix=nIDULanPortAutoMdix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mABMaintenanceLevel=mABMaintenanceLevel, mainPSUPortStatusTrap=mainPSUPortStatusTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dNS=dNS, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, receiveModulationModeLinked=receiveModulationModeLinked, secondarySoftwareVersion=secondarySoftwareVersion, ptpTrapPrefix=ptpTrapPrefix, installStatus=installStatus, tdmTableNumber=tdmTableNumber, tempPcb=tempPcb, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, authorizationControlTableIndex=authorizationControlTableIndex, blacklistRMEnabled=blacklistRMEnabled, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, unitName=unitName, auxPortSyncERxStatus=auxPortSyncERxStatus, dfsTableEntry=dfsTableEntry, sNTPServerTableNumber=sNTPServerTableNumber, managementGroup=managementGroup, sFPPortStatusTrap=sFPPortStatusTrap, authorizationControlTableEntry=authorizationControlTableEntry, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableLoss=cableLoss, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, management=management, dfsTableNumber=dfsTableNumber, sNTPSync=sNTPSync, dNSServerTableNumber=dNSServerTableNumber, receivePowerLinked=receivePowerLinked, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, remoteMACAddressLinked=remoteMACAddressLinked, tFTPClient=tFTPClient, productVariant=productVariant, installStatusLinked=installStatusLinked, managementNetworkAccessEnabled=managementNetworkAccessEnabled, remoteUnitName=remoteUnitName, deviceESN=deviceESN, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, severelyErroredSeconds=severelyErroredSeconds, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, transmitChannel=transmitChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataBridgingStatus=dataBridgingStatus, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, auxPortStatusTrap=auxPortStatusTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseSecurityLevel=licenseSecurityLevel, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, alarmsGroup=alarmsGroup, transparentClockVLAN=transparentClockVLAN, transparentClock=transparentClock, pubStats=pubStats, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, dNSServerTableIndex=dNSServerTableIndex, timeZone=timeZone, cableDiagPair4Results=cableDiagPair4Results, mABHoldoffPeriod=mABHoldoffPeriod, versionsGroup=versionsGroup, groupID=groupID, unitOutOfCalibration=unitOutOfCalibration, blacklistRMMacAddress=blacklistRMMacAddress, antennaGain=antennaGain, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, auxPortStatus=auxPortStatus, supplementary=supplementary, pubStatsGroup=pubStatsGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseGroupAccess=licenseGroupAccess, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, unavailableSeconds=unavailableSeconds, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortQLRx=auxPortQLRx, dfsTable=dfsTable, phyControlInstancedTable=phyControlInstancedTable, auxPortConfigurationMismatch=auxPortConfigurationMismatch, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, dfsTableIndex=dfsTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, auxPortDisabledWarning=auxPortDisabledWarning, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, frequencyVariant=frequencyVariant, installStatusTrap=installStatusTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sNTPServerTableEntry=sNTPServerTableEntry, syncESlavePort=syncESlavePort, licenseOOBManagementSupport=licenseOOBManagementSupport, hCMPMaximumLinkRange=hCMPMaximumLinkRange, wirelessLinkStatusLinked=wirelessLinkStatusLinked, vLANManagementPriority=vLANManagementPriority, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, productName=productName, tDMChannelLoopback=tDMChannelLoopback, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, phyControl=phyControl, mPLSTCPriorityTable=mPLSTCPriorityTable, daylightSaving=daylightSaving, ethernetGroup=ethernetGroup, ptmp=ptmp, transmitDataRateLinked=transmitDataRateLinked, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, secureModeAlarm=secureModeAlarm, hCMPLinkSymmetry=hCMPLinkSymmetry, capacityVariantMismatch=capacityVariantMismatch, dNSPrimaryServer=dNSPrimaryServer, iPv6Address=iPv6Address, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sFPPortSSMTx=sFPPortSSMTx, syslogControlGroup=syslogControlGroup, wirelessOutEthernetOctets=wirelessOutEthernetOctets, transmitPower=transmitPower, tDMEnabledChannels=tDMEnabledChannels, dNSServerPortNumber=dNSServerPortNumber, ethernetStatisticsTable=ethernetStatisticsTable, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, linkLossLinked=linkLossLinked, sNTPServerTimeout=sNTPServerTimeout, sFPPortAutoNegotiation=sFPPortAutoNegotiation, cableDiagPair3Results=cableDiagPair3Results, cableDiagnosticsControl=cableDiagnosticsControl, sFPPortAllocation=sFPPortAllocation, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPSyncTrap=sNTPSyncTrap, txColorCode=txColorCode, authorizationControl=authorizationControl, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, phyStatusGroup=phyStatusGroup, tDMConfigurationMismatch=tDMConfigurationMismatch, auxPortSSMTx=auxPortSSMTx, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseInstancedTableNumber=licenseInstancedTableNumber, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sNMPPortNumber=sNMPPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseInstancedTable=licenseInstancedTable, erroredSeconds=erroredSeconds, supplementaryGroup=supplementaryGroup, licenseMaxLinkRange=licenseMaxLinkRange, cableDiagPair3Distance=cableDiagPair3Distance, transmitModulationModeLinked=transmitModulationModeLinked, softwareVersion=softwareVersion, snmpControl=snmpControl, transmitFreqKHz=transmitFreqKHz, phyControlInstancedTableEntry=phyControlInstancedTableEntry, ptpCompliance=ptpCompliance, phyControlInstancedTableNumber=phyControlInstancedTableNumber, licenseGroup=licenseGroup, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, capacityVariantMismatchTrap=capacityVariantMismatchTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, wirelessOutOctets=wirelessOutOctets, encryption=encryption, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagPair1Results=cableDiagPair1Results, tDMInterfaceStatus=tDMInterfaceStatus, licenseGasGroup=licenseGasGroup, dfsMeans=dfsMeans, eIRP=eIRP, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, smtp=smtp, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, hTTPSPortNumber=hTTPSPortNumber, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hTTPPortNumber=hTTPPortNumber, notificationsGroup=notificationsGroup, channelBandwidth=channelBandwidth, gatewayIPAddress=gatewayIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mainPSUPortQLRx=mainPSUPortQLRx, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sntp=sntp, licenseTLSRekey=licenseTLSRekey, mABNominalTransmitCapacity=mABNominalTransmitCapacity, installArmState=installArmState, ptp=ptp, sNTPState=sNTPState, lowestTDMModulationMode=lowestTDMModulationMode, syslogClientTrap=syslogClientTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, accessMethod=accessMethod, ptpTraps=ptpTraps, tDDControlGroup=tDDControlGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, qOSPriorityScheme=qOSPriorityScheme, wirelessOutAllOctets=wirelessOutAllOctets, hardwareVersion=hardwareVersion, phyControlInstancedTableIndex=phyControlInstancedTableIndex, targetRange=targetRange, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tdmTableIndex=tdmTableIndex, configurationInstancedTableNumber=configurationInstancedTableNumber, installArmStateTrap=installArmStateTrap, rawReceivePower=rawReceivePower, licenseHCMPSupport=licenseHCMPSupport, sNMPTrapVersion=sNMPTrapVersion, ptp670=ptp670, resetGroup=resetGroup, dNSServerTableEntry=dNSServerTableEntry, portAllocationMismatchLinked=portAllocationMismatchLinked, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, dfs=dfs, dataBridgingAvailability=dataBridgingAvailability, byteErrorRatioLinked=byteErrorRatioLinked, antennaSelection=antennaSelection, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTable=l2CPPriorityTable, searchStateLinked=searchStateLinked, dNSServerInternetAddress=dNSServerInternetAddress)
