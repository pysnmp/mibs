...
Unsigned32, IpAddress, Counter64, Bits, Counter32, NotificationType, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, Integer32, MibIdentifier, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Counter64", "Bits", "Counter32", "NotificationType", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "Integer32", "MibIdentifier", "Gauge32", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", encryptionAlgorithm=encryptionAlgorithm, mABHoldoffPeriod=mABHoldoffPeriod, mainPSUPortAllocation=mainPSUPortAllocation, dNSServerTableNumber=dNSServerTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transparentClockVLAN=transparentClockVLAN, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, iPv4Address=iPv4Address, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, syslogStateTrap=syslogStateTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, antennaSelection=antennaSelection, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseInstancedTable=licenseInstancedTable, targetMACAddress=targetMACAddress, cableDiagPair4Results=cableDiagPair4Results, userPassword=userPassword, dfs=dfs, authorizationMethod=authorizationMethod, dNSServerTableIndex=dNSServerTableIndex, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, receiveModulationModeLinked=receiveModulationModeLinked, pubStatsGroup=pubStatsGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, softwareVersion=softwareVersion, ethernetPriorityTable=ethernetPriorityTable, licenseSecurityLevel=licenseSecurityLevel, tempPcb=tempPcb, alarmInstancedTable=alarmInstancedTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetStatisticsTable=ethernetStatisticsTable, remoteUnitNameLinked=remoteUnitNameLinked, dataBridgingAvailability=dataBridgingAvailability, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, configuration=configuration, phyStatus=phyStatus, lowestTDMModulationMode=lowestTDMModulationMode, userTable=userTable, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sntpGroup=sntpGroup, ptp=ptp, transmitDataRate=transmitDataRate, sFPPortSyncERxStatus=sFPPortSyncERxStatus, vLANManagementVID=vLANManagementVID, licenseEncryption=licenseEncryption, tdmTableNumber=tdmTableNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, managementGroup=managementGroup, byteErrorRatio=byteErrorRatio, licenseTLSRekey=licenseTLSRekey, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, dataPortPauseFrames=dataPortPauseFrames, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sFPErrorTrap=sFPErrorTrap, configurationInstancedTableNumber=configurationInstancedTableNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortQLTx=sFPPortQLTx, capacityVariantMismatch=capacityVariantMismatch, hardwareVersion=hardwareVersion, daylightSaving=daylightSaving, sNTPSyncTrap=sNTPSyncTrap, signalStrengthRatio=signalStrengthRatio, productName=productName, dfsTableNumber=dfsTableNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, smtpGroup=smtpGroup, rawReceivePowerLinked=rawReceivePowerLinked, licenseGroupAccess=licenseGroupAccess, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, masterSlaveMode=masterSlaveMode, regulatoryBandTrap=regulatoryBandTrap, remoteInternetAddressType=remoteInternetAddressType, licenseRARSupport=licenseRARSupport, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, portAllocationMismatch=portAllocationMismatch, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, linkName=linkName, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, phyControlInstancedTable=phyControlInstancedTable, aAAControlGroup=aAAControlGroup, transmitterChannels=transmitterChannels, cableLoss=cableLoss, hCMPLinkSymmetry=hCMPLinkSymmetry, tDMGroup=tDMGroup, sFPError=sFPError, remoteInternetAddress=remoteInternetAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tdmTable=tdmTable, hTTPSAccessEnabled=hTTPSAccessEnabled, telnetAccessEnabled=telnetAccessEnabled, txMABFrames=txMABFrames, licenseIPv6Support=licenseIPv6Support, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, lowestDataModulationMode=lowestDataModulationMode, byteErrorRatioLinked=byteErrorRatioLinked, cableDiagnosticsResultTable=cableDiagnosticsResultTable, secondarySoftwareVersion=secondarySoftwareVersion, transmitFreqMHz=transmitFreqMHz, sFPPortSSMTx=sFPPortSSMTx, txColorCode=txColorCode, sMTPServerPortNumber=sMTPServerPortNumber, auxPortStatusTrap=auxPortStatusTrap, tDM=tDM, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sNTPState=sNTPState, tDMChannelStatus=tDMChannelStatus, unitIdentification=unitIdentification, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, severelyErroredSeconds=severelyErroredSeconds, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, receivePower=receivePower, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, cableDiagnosticsPorts=cableDiagnosticsPorts, cambium=cambium, hTTPAccessEnabled=hTTPAccessEnabled, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, groupID=groupID, unavailableSeconds=unavailableSeconds, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, tDMConfigurationMismatch=tDMConfigurationMismatch, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dNSServerPortNumber=dNSServerPortNumber, mainPSUPortStatus=mainPSUPortStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, receiveDataRate=receiveDataRate, ethernet=ethernet, licenseMaxLinkRange=licenseMaxLinkRange, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNTPServerTableEntry=sNTPServerTableEntry, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, unitIdentificationGroup=unitIdentificationGroup, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sNMPPortNumber=sNMPPortNumber, licenseVersion=licenseVersion, mABProtocolVLANPriority=mABProtocolVLANPriority, installStatusLinked=installStatusLinked, maximumNumberOfSlaves=maximumNumberOfSlaves, userEnabled=userEnabled, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, productVariant=productVariant, smtp=smtp, syslogClient=syslogClient, dataBridgingStatus=dataBridgingStatus, unitName=unitName, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTable=l2CPPriorityTable, tDMEnabledChannels=tDMEnabledChannels, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, management=management, sNTPSync=sNTPSync, wirelessLinkStatus=wirelessLinkStatus, tDMChannelLoopback=tDMChannelLoopback, aAAControl=aAAControl, licenseIssueNumber=licenseIssueNumber, sFPPortAllocation=sFPPortAllocation, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, transmitChannel=transmitChannel, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dfsTableIndex=dfsTableIndex, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, licenseTrialPeriod=licenseTrialPeriod, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitFreqKHz=transmitFreqKHz, sNTPServerInternetAddress=sNTPServerInternetAddress, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, syncETracking=syncETracking, dNSResolver=dNSResolver, transparentClockVID=transparentClockVID, dNSServerTableEntry=dNSServerTableEntry, authorizationControl=authorizationControl, cableDiagnosticsControl=cableDiagnosticsControl, pubInstancedStatsTable=pubInstancedStatsTable, telnetPortNumber=telnetPortNumber, ethernetInstancedTable=ethernetInstancedTable, hTTPSPortNumber=hTTPSPortNumber, unitOutOfCalibration=unitOutOfCalibration, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dNSGroup=dNSGroup, sNMPv3Enable=sNMPv3Enable, managementNetworkAccessEnabled=managementNetworkAccessEnabled, syncETrackingState=syncETrackingState, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, supplementaryGroup=supplementaryGroup, iPVersion=iPVersion, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sMTPSourceEmailAddress=sMTPSourceEmailAddress, packetsToInternalStack=packetsToInternalStack, dfsGroup=dfsGroup, dfsPeaks=dfsPeaks, ethernetPriorityTableEntry=ethernetPriorityTableEntry, useVLANForMABProtocol=useVLANForMABProtocol, altitude=altitude, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, dNSPrimaryServer=dNSPrimaryServer, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, mABTransmissionInterval=mABTransmissionInterval, cableDiagPair2Results=cableDiagPair2Results, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, gatewayIPAddress=gatewayIPAddress, tDMChannelStatusTrap=tDMChannelStatusTrap, apcGroup=apcGroup, eIRP=eIRP, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, subbandHighestFrequency=subbandHighestFrequency, capacityVariantMismatchLinked=capacityVariantMismatchLinked, alarms=alarms, aggregateDataRateLinked=aggregateDataRateLinked, mainPSUPortSSMTx=mainPSUPortSSMTx, linkModeOptimization=linkModeOptimization, configurationInstancedTable=configurationInstancedTable, sFPPortStatusTrap=sFPPortStatusTrap, syslogState=syslogState, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, blacklistRMMacAddress=blacklistRMMacAddress, enableTransmission=enableTransmission, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, auxPortAllocation=auxPortAllocation, userName=userName, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, versions=versions, transmitPower=transmitPower, sMTPServerInternetAddressType=sMTPServerInternetAddressType)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDControlGroup=tDDControlGroup, phyControl=phyControl, alarmInstancedTableIndex=alarmInstancedTableIndex, tDDControl=tDDControl, ptpTraps=ptpTraps, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, ptpGroups=ptpGroups, licenseInstancedTableEntry=licenseInstancedTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, deviceESN=deviceESN, hCMPMaximumLinkRange=hCMPMaximumLinkRange, packetsFromInternalStack=packetsFromInternalStack, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, ptpTrapPrefix=ptpTrapPrefix, secureModeAlarm=secureModeAlarm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntp=sntp, alarmInstancedTableNumber=alarmInstancedTableNumber, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, ptmp=ptmp, syncEEquipmentClock=syncEEquipmentClock, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, portAllocationMismatchLinked=portAllocationMismatchLinked, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, vectorError=vectorError, encryption=encryption, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, accessMethod=accessMethod, mainPSUPortQLRx=mainPSUPortQLRx, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, iPv6Address=iPv6Address, tdmTableEntry=tdmTableEntry, dfsTableEntry=dfsTableEntry, remoteInternetAddressLinked=remoteInternetAddressLinked, PYSNMP_MODULE_ID=cambium, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch, cableDiagPair1Results=cableDiagPair1Results, dSCPManagementPriority=dSCPManagementPriority, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPLastSync=sNTPLastSync, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mABNominalModulationMode=mABNominalModulationMode, dNSServerInternetAddress=dNSServerInternetAddress, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, syncESlavePort=syncESlavePort, sNTPServerTable=sNTPServerTable, rangeLinked=rangeLinked, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, signalStrengthRatioLinked=signalStrengthRatioLinked, tdmTableIndex=tdmTableIndex, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseCountry=licenseCountry, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, bridge=bridge, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, dfsTable=dfsTable, userTableEntry=userTableEntry, sNTPServerRetries=sNTPServerRetries, auxPortSSMTx=auxPortSSMTx, licenseUnitSerialNumber=licenseUnitSerialNumber, cableDiagPair3Results=cableDiagPair3Results, subbandLowestFrequency=subbandLowestFrequency, licenseSFPPortSupport=licenseSFPPortSupport, tFTPClient=tFTPClient, secureModeAlarmTrap=secureModeAlarmTrap, phyControlGroup=phyControlGroup, installArmStateTrap=installArmStateTrap, mABMaintenanceLevel=mABMaintenanceLevel, deviceMSN=deviceMSN, lbtDetectedTrap=lbtDetectedTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, antennaGain=antennaGain, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, encryptionGroup=encryptionGroup, bootVersion=bootVersion, iPv6PrefixLength=iPv6PrefixLength, userTableIndex=userTableIndex, licenseInstancedTableIndex=licenseInstancedTableIndex, ethernetGroup=ethernetGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, reset=reset, whitelistRMMacAddress=whitelistRMMacAddress, mainPSUPortStatusTrap=mainPSUPortStatusTrap, transmitDataRateLinked=transmitDataRateLinked, channelChangeTrap=channelChangeTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, ethernetInstancedTableNumber=ethernetInstancedTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, nIDULanPortStatusTrap=nIDULanPortStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, license=license, licenseHCMPSupport=licenseHCMPSupport, linkSymmetry=linkSymmetry, whitelistRMEnabled=whitelistRMEnabled, licenseInstancedTableNumber=licenseInstancedTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, routerProtocolsGroup=routerProtocolsGroup, transparentClockPort=transparentClockPort, authorizationControlGroup=authorizationControlGroup, transmitPowerLinked=transmitPowerLinked, transparentClock=transparentClock, dNSServerTable=dNSServerTable, wirelessOutAllOctets=wirelessOutAllOctets, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sFPPortStatus=sFPPortStatus, cableDiagPair2Distance=cableDiagPair2Distance, licenseSyncESupport=licenseSyncESupport, cableDiagnosticsWarning=cableDiagnosticsWarning, syslogControlGroup=syslogControlGroup, routerProtocols=routerProtocols, ethernetStatisticsDataSource=ethernetStatisticsDataSource, installStatusTrap=installStatusTrap, localPacketFiltering=localPacketFiltering, authorizationControlTableNumber=authorizationControlTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPPortNumber=hTTPPortNumber, tDMChannelLineCode=tDMChannelLineCode, linkLossLinked=linkLossLinked, channelBandwidth=channelBandwidth, installArmState=installArmState, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseTDDSyncSupport=licenseTDDSyncSupport, snmpControl=snmpControl, tDDSynchronizationStatus=tDDSynchronizationStatus, searchStateLinked=searchStateLinked, authorizationControlTableIndex=authorizationControlTableIndex, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, searchState=searchState, cableDiagPair4Distance=cableDiagPair4Distance, sFPPortDisabledWarning=sFPPortDisabledWarning, dataPortWirelessDownAlert=dataPortWirelessDownAlert, supplementary=supplementary, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dfsMeans=dfsMeans, dataBridgingStatusLinked=dataBridgingStatusLinked, auxPortDisabledWarning=auxPortDisabledWarning, rxColorCode=rxColorCode, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseGasGroup=licenseGasGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, remoteMACAddressLinked=remoteMACAddressLinked, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, regulatoryBand=regulatoryBand, timeZone=timeZone, transmitModulationMode=transmitModulationMode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userTableNumber=userTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, sFPPortAutoMdix=sFPPortAutoMdix, linkLoss=linkLoss, installationMode=installationMode, sNMPTrapTable=sNMPTrapTable, maxLinkRangeExceeded=maxLinkRangeExceeded, remoteMACAddress=remoteMACAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, resetGroup=resetGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseCapacity=licenseCapacity, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerTableNumber=sNTPServerTableNumber, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receivePowerLinked=receivePowerLinked, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, siteName=siteName, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, ptp670=ptp670, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, authorizationControlTable=authorizationControlTable, portAllocationMismatchTrap=portAllocationMismatchTrap, tDMChannelCableLength=tDMChannelCableLength, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNTPPollInterval=sNTPPollInterval, sNTPPrimaryServer=sNTPPrimaryServer, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, remoteUnitName=remoteUnitName, mgmtInstancedTable=mgmtInstancedTable, phyStatusGroup=phyStatusGroup, qOSPriorityScheme=qOSPriorityScheme, receiveFreqMHz=receiveFreqMHz, rawReceivePower=rawReceivePower, mainPSUPortQLTx=mainPSUPortQLTx, userRole=userRole, licenseIEEE1588Support=licenseIEEE1588Support, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, wirelessOutEthernetOctets=wirelessOutEthernetOctets, mPLSTCPriorityTable=mPLSTCPriorityTable, receiveFreqKHz=receiveFreqKHz, sNTPServerTimeout=sNTPServerTimeout, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, transmitModulationModeLinked=transmitModulationModeLinked, wirelessTopology=wirelessTopology, licenseBandwidthCap=licenseBandwidthCap, dNSServerInternetAddressType=dNSServerInternetAddressType, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, auxPortQLTx=auxPortQLTx, receiveModulationModeDetail=receiveModulationModeDetail, tFTPServerInternetAddressType=tFTPServerInternetAddressType, wirelessOutOctets=wirelessOutOctets, systemReset=systemReset, erroredSeconds=erroredSeconds, enabledDiagnosticAlarms=enabledDiagnosticAlarms, blacklistRMEnabled=blacklistRMEnabled, syslogControl=syslogControl, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, configurationInstancedTableIndex=configurationInstancedTableIndex, pubStats=pubStats, auxPortAcceptedQLRx=auxPortAcceptedQLRx, tDMInterfaceControl=tDMInterfaceControl, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseGroup=licenseGroup, longitude=longitude, auxPortQLRx=auxPortQLRx, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, deviceMACAddress=deviceMACAddress, vectorErrorLinked=vectorErrorLinked, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sNTPServerStatus=sNTPServerStatus, cableDiagPair1Distance=cableDiagPair1Distance, auxPortConfigurationMismatch=auxPortConfigurationMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyInstancedStatusTable=phyInstancedStatusTable, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, receiveChannel=receiveChannel, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControlGroup=snmpControlGroup, sNMPTrapVersion=sNMPTrapVersion, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, vLANManagementPriority=vLANManagementPriority, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationInstancedTableEntry=configurationInstancedTableEntry, ptpCompliance=ptpCompliance, authorizationControlTableEntry=authorizationControlTableEntry, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, range=range, systemClock=systemClock, receiveModulationMode=receiveModulationMode, extendedSpectrumScanning=extendedSpectrumScanning, frequencyVariant=frequencyVariant, receiveDataRateLinked=receiveDataRateLinked, sFPPortQLRx=sFPPortQLRx, subnetMask=subnetMask, dNS=dNS, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, bridgeGroup=bridgeGroup, sNMPEnabledTraps=sNMPEnabledTraps, rangingMode=rangingMode, installStatus=installStatus, syslogClientTrap=syslogClientTrap, notificationsGroup=notificationsGroup, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagnostics=cableDiagnostics, mgmtInstancedTableNumber=mgmtInstancedTableNumber, cableDiagnosticsGroup=cableDiagnosticsGroup, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, configurationGroup=configurationGroup, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortSyncERxStatus=auxPortSyncERxStatus, aggregateDataRate=aggregateDataRate, targetRange=targetRange, ethernetInstancedTableIndex=ethernetInstancedTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mABState=mABState, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sMTPEmailAlert=sMTPEmailAlert, maximumTransmitPower=maximumTransmitPower, mABProtocolVID=mABProtocolVID, useVLANForManagementInterfaces=useVLANForManagementInterfaces, latitude=latitude, alarmsGroup=alarmsGroup, auxPortStatus=auxPortStatus, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, apc=apc, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tDMInterfaceStatus=tDMInterfaceStatus, nIDULanPortStatus=nIDULanPortStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, cableDiagPair3Distance=cableDiagPair3Distance)
