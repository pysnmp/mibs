...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", alarmsGroup=alarmsGroup, managementNetworkAccessEnabled=managementNetworkAccessEnabled, gatewayIPAddress=gatewayIPAddress, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, syncEEquipmentClock=syncEEquipmentClock, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dNSServerTable=dNSServerTable, userTable=userTable, rangingMode=rangingMode, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sFPPortQLTx=sFPPortQLTx, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, linkName=linkName, tDMChannelStatusTrap=tDMChannelStatusTrap, sFPPortAllocation=sFPPortAllocation, cableDiagPair2Results=cableDiagPair2Results, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, dataPortPauseFrames=dataPortPauseFrames, unitOutOfCalibration=unitOutOfCalibration, subnetMask=subnetMask, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sNTPLastSync=sNTPLastSync, authorizationControlTableEntry=authorizationControlTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transparentClockVLAN=transparentClockVLAN, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, cableDiagnosticsGroup=cableDiagnosticsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitFreqMHz=transmitFreqMHz, ptpGroups=ptpGroups, ptpTrapPrefix=ptpTrapPrefix, licenseInstancedTableIndex=licenseInstancedTableIndex, lbtDetectedTrap=lbtDetectedTrap, cableLoss=cableLoss, capacityVariantMismatch=capacityVariantMismatch, txColorCode=txColorCode, aggregateDataRateLinked=aggregateDataRateLinked, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, aggregateDataRate=aggregateDataRate, cableDiagPair4Distance=cableDiagPair4Distance, antennaGain=antennaGain, sNMPCommunityString=sNMPCommunityString, softwareVersion=softwareVersion, userTableEntry=userTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, nIDULanPortStatusTrap=nIDULanPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, smtpGroup=smtpGroup, tDDControlGroup=tDDControlGroup, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNTPSyncTrap=sNTPSyncTrap, notificationsGroup=notificationsGroup, telnetPortNumber=telnetPortNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, maximumTransmitPower=maximumTransmitPower, alarmInstancedTableEntry=alarmInstancedTableEntry, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, nIDULanPortStatus=nIDULanPortStatus, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, dNSGroup=dNSGroup, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, alarmInstancedTableIndex=alarmInstancedTableIndex, sFPErrorTrap=sFPErrorTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, mgmtInstancedTableNumber=mgmtInstancedTableNumber, frequencyVariant=frequencyVariant, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cableDiagPair3Results=cableDiagPair3Results, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, transmitChannel=transmitChannel, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, mABNominalTransmitCapacity=mABNominalTransmitCapacity, blacklistRMMacAddress=blacklistRMMacAddress, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, userName=userName, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, hCMPLinkSymmetry=hCMPLinkSymmetry, licenseTDDSyncSupport=licenseTDDSyncSupport, ethernetPriorityTableEntry=ethernetPriorityTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, syslogClient=syslogClient, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerTableIndex=sNTPServerTableIndex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, lowestDataModulationMode=lowestDataModulationMode, licenseCountry=licenseCountry, installStatusTrap=installStatusTrap, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, searchState=searchState, routerProtocols=routerProtocols, deviceESN=deviceESN, licenseTLSRekey=licenseTLSRekey, localPacketFiltering=localPacketFiltering, authorizationControlTable=authorizationControlTable, tDMChannelLineCode=tDMChannelLineCode, dfsTable=dfsTable, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, userRole=userRole, alarmInstancedTable=alarmInstancedTable, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, tdmTableEntry=tdmTableEntry, configurationInstancedTableNumber=configurationInstancedTableNumber, signalStrengthRatioLinked=signalStrengthRatioLinked, sNTPSync=sNTPSync, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, dfsTableIndex=dfsTableIndex, receiveDataRate=receiveDataRate, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, ptpCompliance=ptpCompliance, accessMethod=accessMethod, sMTPEmailAlert=sMTPEmailAlert, pubInstancedStatsTable=pubInstancedStatsTable, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseBandwidthCap=licenseBandwidthCap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, encryption=encryption, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPError=sFPError, snmpControl=snmpControl, receiveDataRateLinked=receiveDataRateLinked, dfsTableNumber=dfsTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveModulationModeLinked=receiveModulationModeLinked, siteName=siteName, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sNTPState=sNTPState, licenseRARSupport=licenseRARSupport, encryptionAlgorithm=encryptionAlgorithm, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, productName=productName, sNMPEnabledTraps=sNMPEnabledTraps, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, authorizationControlTableIndex=authorizationControlTableIndex, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, bridgeGroup=bridgeGroup, sNTPPrimaryServer=sNTPPrimaryServer, regulatoryBand=regulatoryBand, portAllocationMismatchLinked=portAllocationMismatchLinked, wirelessOutEthernetOctets=wirelessOutEthernetOctets, cableDiagPair1Distance=cableDiagPair1Distance, antennaSelection=antennaSelection, PYSNMP_MODULE_ID=cambium, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, aAAControlGroup=aAAControlGroup, timeZone=timeZone, sMTPEnabledMessages=sMTPEnabledMessages, regulatoryBandTrap=regulatoryBandTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, channelBandwidth=channelBandwidth, syncESlavePort=syncESlavePort, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, transmitModulationModeLinked=transmitModulationModeLinked, dfsPeaks=dfsPeaks, maxLinkRangeExceeded=maxLinkRangeExceeded, phyControlInstancedTable=phyControlInstancedTable, sNTPServerTableNumber=sNTPServerTableNumber, license=license, licenseSyncESupport=licenseSyncESupport, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sNMPTrapVersion=sNMPTrapVersion, cambium=cambium, installArmStateTrap=installArmStateTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, dNS=dNS, targetMACAddress=targetMACAddress, syslogControl=syslogControl, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseTrialPeriod=licenseTrialPeriod, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, remoteMACAddress=remoteMACAddress, mABHoldoffPeriod=mABHoldoffPeriod, vectorErrorLinked=vectorErrorLinked, userEnabled=userEnabled, sFPPortAutoMdix=sFPPortAutoMdix, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityTable=ethernetPriorityTable, mABMaintenanceLevel=mABMaintenanceLevel, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, eIRP=eIRP, whitelistRMMacAddress=whitelistRMMacAddress, sNTPServerRetries=sNTPServerRetries, byteErrorRatioLinked=byteErrorRatioLinked, sNTPServerTable=sNTPServerTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sFPPortDisabledWarning=sFPPortDisabledWarning, linkModeOptimization=linkModeOptimization, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, packetsToInternalStack=packetsToInternalStack, enableTransmission=enableTransmission, transmitModulationMode=transmitModulationMode, portAllocationMismatch=portAllocationMismatch, remoteInternetAddressType=remoteInternetAddressType, erroredSeconds=erroredSeconds, signalStrengthRatio=signalStrengthRatio, remoteInternetAddressLinked=remoteInternetAddressLinked, ptmp=ptmp, configurationGroup=configurationGroup, licenseHCMPSupport=licenseHCMPSupport, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, dfsTableEntry=dfsTableEntry, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tdmTable=tdmTable, dNSServerTableIndex=dNSServerTableIndex, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNTPServerTimeout=sNTPServerTimeout, hTTPSPortNumber=hTTPSPortNumber, altitude=altitude, ethernetStatisticsTable=ethernetStatisticsTable, severelyErroredSeconds=severelyErroredSeconds, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sFPPortSyncERxStatus=sFPPortSyncERxStatus, pubStats=pubStats, syslogStateTrap=syslogStateTrap, capacityVariantMismatchLinked=capacityVariantMismatchLinked, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, iPv6GatewayAddress=iPv6GatewayAddress, sNMPv3Enable=sNMPv3Enable, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, alarms=alarms, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, rangeLinked=rangeLinked, unitIdentificationGroup=unitIdentificationGroup, mABState=mABState, encryptionGroup=encryptionGroup, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, syncETracking=syncETracking, mgmtInstancedTableEntry=mgmtInstancedTableEntry, authorizationControlGroup=authorizationControlGroup, dNSResolver=dNSResolver, vLANManagementVID=vLANManagementVID, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, mainPSUPortQLTx=mainPSUPortQLTx, installStatusLinked=installStatusLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNMPTrapTableNumber=sNMPTrapTableNumber, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, useVLANForMABProtocol=useVLANForMABProtocol, tDMConfigurationMismatch=tDMConfigurationMismatch, subbandLowestFrequency=subbandLowestFrequency, hTTPSAccessEnabled=hTTPSAccessEnabled, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mABNominalModulationMode=mABNominalModulationMode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, supplementaryGroup=supplementaryGroup, receiveModulationMode=receiveModulationMode, iPv4Address=iPv4Address, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPVersion=iPVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, mainPSUPortAllocation=mainPSUPortAllocation, auxPortQLRx=auxPortQLRx, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, iPv6Address=iPv6Address, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, range=range, tdmTableNumber=tdmTableNumber, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, syslogLocalWrappedTrap=syslogLocalWrappedTrap, secureModeAlarm=secureModeAlarm, dfsGroup=dfsGroup, management=management, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseGroupAccess=licenseGroupAccess, configurationInstancedTable=configurationInstancedTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, receivePower=receivePower, unitIdentification=unitIdentification, receiveFreqKHz=receiveFreqKHz, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, bootVersion=bootVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, wirelessLinkStatus=wirelessLinkStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, transmitPowerLinked=transmitPowerLinked, transparentClockPort=transparentClockPort, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetInstancedTableEntry=ethernetInstancedTableEntry, supplementary=supplementary, nIDULanPortAutoMdix=nIDULanPortAutoMdix, remoteInternetAddress=remoteInternetAddress, tdmTableIndex=tdmTableIndex, sFPPortAutoNegotiation=sFPPortAutoNegotiation, phyStatus=phyStatus, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, phyStatusGroup=phyStatusGroup, apcGroup=apcGroup, ptp670=ptp670, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, lowestTDMModulationMode=lowestTDMModulationMode, ethernetInstancedTable=ethernetInstancedTable, installArmState=installArmState, ptpTraps=ptpTraps, wirelessLinkStatusLinked=wirelessLinkStatusLinked, licenseRegulatoryBandsList=licenseRegulatoryBandsList, cableDiagnosticsWarning=cableDiagnosticsWarning, sFPPortStatusTrap=sFPPortStatusTrap, dfs=dfs, sNTPPollInterval=sNTPPollInterval, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, masterSlaveMode=masterSlaveMode, auxPortQLTx=auxPortQLTx, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, deviceMSN=deviceMSN, dNSServerPortNumber=dNSServerPortNumber, receiveFreqMHz=receiveFreqMHz, blacklistRMEnabled=blacklistRMEnabled, tDM=tDM, mPLSTCPriorityTable=mPLSTCPriorityTable, auxPortStatus=auxPortStatus, cableDiagnosticsControl=cableDiagnosticsControl, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, auxPortAllocation=auxPortAllocation, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sntp=sntp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, searchStateLinked=searchStateLinked, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, transmitDataRate=transmitDataRate, sFPPortQLRx=sFPPortQLRx, sNTPServerStatus=sNTPServerStatus, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapTableEntry=sNMPTrapTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyControlGroup=phyControlGroup, tFTPClient=tFTPClient, reset=reset, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetGroup=ethernetGroup, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, l2CPPriorityTableEntry=l2CPPriorityTableEntry, unitName=unitName, sNMPTrapTableIndex=sNMPTrapTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, resetGroup=resetGroup, apc=apc, ethernetPriorityTableIndex=ethernetPriorityTableIndex, longitude=longitude, auxPortSyncERxStatus=auxPortSyncERxStatus, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDMChannelStatus=tDMChannelStatus, licenseSFPPortSupport=licenseSFPPortSupport, secureModeAlarmTrap=secureModeAlarmTrap, vectorError=vectorError, versions=versions, rawReceivePowerLinked=rawReceivePowerLinked, portAllocationMismatchTrap=portAllocationMismatchTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, tDMGroup=tDMGroup, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, installStatus=installStatus, mgmtInstancedTable=mgmtInstancedTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, auxPortConfigurationMismatch=auxPortConfigurationMismatch, hTTPPortNumber=hTTPPortNumber, phyControlInstancedTableIndex=phyControlInstancedTableIndex, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, userPassword=userPassword, licenseSecurityLevel=licenseSecurityLevel, l2CPPriorityTableIndex=l2CPPriorityTableIndex, auxPortStatusTrap=auxPortStatusTrap, syslogState=syslogState, tDMInterfaceControl=tDMInterfaceControl, phyControlInstancedTableEntry=phyControlInstancedTableEntry, cableDiagPair3Distance=cableDiagPair3Distance, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseInstancedTable=licenseInstancedTable, channelChangeTrap=channelChangeTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, userTableIndex=userTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseGroup=licenseGroup, bridge=bridge, tDDSynchronizationMode=tDDSynchronizationMode, licenseUnitSerialNumber=licenseUnitSerialNumber, cableDiagPair4Results=cableDiagPair4Results, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, wirelessOutOctets=wirelessOutOctets, smtp=smtp, dataBridgingAvailability=dataBridgingAvailability, authorizationMethod=authorizationMethod, licenseOOBManagementSupport=licenseOOBManagementSupport, mainPSUPortAutoMdix=mainPSUPortAutoMdix, pubStatsGroup=pubStatsGroup, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sNMPPortNumber=sNMPPortNumber, groupID=groupID, tDMChannelCableLength=tDMChannelCableLength, installationMode=installationMode, mainPSUPortSSMTx=mainPSUPortSSMTx, iPv6PrefixLength=iPv6PrefixLength, transparentClockVID=transparentClockVID, licenseMaxLinkRange=licenseMaxLinkRange, linkSymmetry=linkSymmetry, dataBridgingStatus=dataBridgingStatus, configurationInstancedTableEntry=configurationInstancedTableEntry, transparentClock=transparentClock, l2CPPriorityTable=l2CPPriorityTable, phyControl=phyControl, hardwareVersion=hardwareVersion, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, ptp=ptp, syslogControlGroup=syslogControlGroup, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseCapacity=licenseCapacity, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, managementGroup=managementGroup, phyInstancedStatusTable=phyInstancedStatusTable, subbandHighestFrequency=subbandHighestFrequency, wirelessTopology=wirelessTopology, tDMEnabledChannels=tDMEnabledChannels, ethernetInstancedTableIndex=ethernetInstancedTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, userTableNumber=userTableNumber, mABProtocolVID=mABProtocolVID, tDMChannelLoopback=tDMChannelLoopback, txMABFrames=txMABFrames, ethernet=ethernet, syncETrackingState=syncETrackingState, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, cableDiagPair2Distance=cableDiagPair2Distance, whitelistRMEnabled=whitelistRMEnabled, productVariant=productVariant, sFPPortSSMTx=sFPPortSSMTx, dfsMeans=dfsMeans, sNTPServerPortNumber=sNTPServerPortNumber, wirelessOutAllOctets=wirelessOutAllOctets, tempPcb=tempPcb, snmpControlGroup=snmpControlGroup, cableDiagPair1Results=cableDiagPair1Results, configuration=configuration, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, transmitPower=transmitPower, transmitDataRateLinked=transmitDataRateLinked, sMTPServerPortNumber=sMTPServerPortNumber, licenseIssueNumber=licenseIssueNumber, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, extendedSpectrumScanning=extendedSpectrumScanning, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, receiveChannel=receiveChannel, auxPortSSMTx=auxPortSSMTx, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseVersion=licenseVersion, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, dNSServerInternetAddressType=dNSServerInternetAddressType, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, receivePowerLinked=receivePowerLinked, packetsFromInternalStack=packetsFromInternalStack, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, cableDiagnostics=cableDiagnostics, sNMPTrapPortNumber=sNMPTrapPortNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, mainPSUPortStatus=mainPSUPortStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, oOBPriorityQueueMapping=oOBPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mainPSUPortQLRx=mainPSUPortQLRx, vLANManagementPriority=vLANManagementPriority, sFPPortStatus=sFPPortStatus, sNMPTrapTable=sNMPTrapTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveModulationModeDetail=receiveModulationModeDetail, latitude=latitude, dNSPrimaryServer=dNSPrimaryServer, targetRange=targetRange, remoteMACAddressLinked=remoteMACAddressLinked, authorizationControlTableNumber=authorizationControlTableNumber, mABTransmissionInterval=mABTransmissionInterval, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, authorizationControl=authorizationControl, linkLossLinked=linkLossLinked, hTTPAccessEnabled=hTTPAccessEnabled, tDMInterfaceStatus=tDMInterfaceStatus, licenseGasGroup=licenseGasGroup, remoteUnitNameLinked=remoteUnitNameLinked, syslogClientTrap=syslogClientTrap, transmitterChannels=transmitterChannels, cableDiagnosticsPorts=cableDiagnosticsPorts, deviceMACAddress=deviceMACAddress, dNSServerInternetAddress=dNSServerInternetAddress, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, daylightSaving=daylightSaving, transmitFreqKHz=transmitFreqKHz, remoteUnitName=remoteUnitName, licenseIPv6Support=licenseIPv6Support, linkLoss=linkLoss, sntpGroup=sntpGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, rxColorCode=rxColorCode, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dNSServerTableEntry=dNSServerTableEntry, unavailableSeconds=unavailableSeconds, licenseInstancedTableNumber=licenseInstancedTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tDDControl=tDDControl, aAAControl=aAAControl, dNSServerTableNumber=dNSServerTableNumber, licenseEncryption=licenseEncryption, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ethernetStatisticsDataSource=ethernetStatisticsDataSource, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, routerProtocolsGroup=routerProtocolsGroup, rawReceivePower=rawReceivePower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseInstancedTableEntry=licenseInstancedTableEntry, systemClock=systemClock, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, alarmInstancedTableNumber=alarmInstancedTableNumber, systemReset=systemReset, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap)
