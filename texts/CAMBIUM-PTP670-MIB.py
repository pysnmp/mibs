...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, iPVersion=iPVersion, license=license, sFPPortStatusTrap=sFPPortStatusTrap, transmitDataRate=transmitDataRate, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseGroupAccess=licenseGroupAccess, licenseSyncESupport=licenseSyncESupport, syncEEquipmentClock=syncEEquipmentClock, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, systemReset=systemReset, antennaGain=antennaGain, sNMPTrapTableNumber=sNMPTrapTableNumber, lowestDataModulationMode=lowestDataModulationMode, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseIPv6Support=licenseIPv6Support, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, licenseRARSupport=licenseRARSupport, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, syslogClientTrap=syslogClientTrap, installationMode=installationMode, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dNS=dNS, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, installArmStateTrap=installArmStateTrap, cableDiagPair1Results=cableDiagPair1Results, licenseInstancedTableIndex=licenseInstancedTableIndex, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, pubStats=pubStats, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, rangingMode=rangingMode, encryptionGroup=encryptionGroup, cambium=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mABMaintenanceLevel=mABMaintenanceLevel, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, aggregateDataRateLinked=aggregateDataRateLinked, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, transmitFreqMHz=transmitFreqMHz, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, syslogStateTrap=syslogStateTrap, transmitFreqKHz=transmitFreqKHz, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, masterSlaveMode=masterSlaveMode, byteErrorRatio=byteErrorRatio, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tDMGroup=tDMGroup, cableDiagPair3Results=cableDiagPair3Results, productName=productName, sFPPortSSMTx=sFPPortSSMTx, alarmInstancedTableNumber=alarmInstancedTableNumber, routerProtocols=routerProtocols, sNTPServerTableEntry=sNTPServerTableEntry, transmitModulationMode=transmitModulationMode, snmpControlGroup=snmpControlGroup, phyControlInstancedTableIndex=phyControlInstancedTableIndex, gatewayIPAddress=gatewayIPAddress, ethernetInstancedTableNumber=ethernetInstancedTableNumber, whitelistRMMacAddress=whitelistRMMacAddress, licenseInstancedTableNumber=licenseInstancedTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sNTPServerTimeout=sNTPServerTimeout, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, remoteMACAddress=remoteMACAddress, licenseRegulatoryBandsList=licenseRegulatoryBandsList, transparentClockVID=transparentClockVID, noWirelessChannelAvailable=noWirelessChannelAvailable, sFPPortDisabledWarning=sFPPortDisabledWarning, unitIdentification=unitIdentification, sNMPPortNumber=sNMPPortNumber, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, hCMPLinkSymmetry=hCMPLinkSymmetry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, bridge=bridge, syncETrackingState=syncETrackingState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sFPPortQLRx=sFPPortQLRx, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, byteErrorRatioLinked=byteErrorRatioLinked, sNMPEnabledTraps=sNMPEnabledTraps, ptpTraps=ptpTraps, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDMChannelStatus=tDMChannelStatus, configurationGroup=configurationGroup, dNSServerTableIndex=dNSServerTableIndex, erroredSeconds=erroredSeconds, portAllocationMismatchLinked=portAllocationMismatchLinked, managementPortWirelessDownAlert=managementPortWirelessDownAlert, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, dfsTableIndex=dfsTableIndex, licenseIEEE1588Support=licenseIEEE1588Support, rangeLinked=rangeLinked, eIRP=eIRP, ethernetGroup=ethernetGroup, rawReceivePowerLinked=rawReceivePowerLinked, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mABProtocolVID=mABProtocolVID, remoteUnitNameLinked=remoteUnitNameLinked, auxPortStatus=auxPortStatus, cableDiagnosticsControl=cableDiagnosticsControl, extendedSpectrumScanning=extendedSpectrumScanning, tDMChannelCableLength=tDMChannelCableLength, syncESlavePort=syncESlavePort, auxPortSyncERxStatus=auxPortSyncERxStatus, tdmTableEntry=tdmTableEntry, dfs=dfs, mABHoldoffPeriod=mABHoldoffPeriod, ethernetStatisticsTable=ethernetStatisticsTable, hTTPAccessEnabled=hTTPAccessEnabled, latitude=latitude, useVLANForMABProtocol=useVLANForMABProtocol, installStatus=installStatus, alarmInstancedTableIndex=alarmInstancedTableIndex, userTable=userTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveChannel=receiveChannel, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, vLANManagementVID=vLANManagementVID, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rawReceivePower=rawReceivePower, sFPPortAutoNegotiation=sFPPortAutoNegotiation, tempPcb=tempPcb, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, userTableNumber=userTableNumber, auxPortDisabledWarning=auxPortDisabledWarning, vLANManagementPriority=vLANManagementPriority, receiveFreqMHz=receiveFreqMHz, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfsMeans=dfsMeans, targetRange=targetRange, syslogClient=syslogClient, tFTPServerPortNumber=tFTPServerPortNumber, sNTPLastSync=sNTPLastSync, licenseVersion=licenseVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableDiagPair2Distance=cableDiagPair2Distance, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseGroup=licenseGroup, supplementary=supplementary, wirelessOutOctets=wirelessOutOctets, channelChangeTrap=channelChangeTrap, channelBandwidth=channelBandwidth, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, transmitPowerLinked=transmitPowerLinked, cableDiagnostics=cableDiagnostics, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, versions=versions, tdmTable=tdmTable, apcGroup=apcGroup, linkLoss=linkLoss, nIDULanPortStatusTrap=nIDULanPortStatusTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tDMChannelLoopback=tDMChannelLoopback, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, deviceMACAddress=deviceMACAddress, licenseHCMPSupport=licenseHCMPSupport, siteName=siteName, ethernetPriorityTable=ethernetPriorityTable, snmpControl=snmpControl, licenseSFPPortSupport=licenseSFPPortSupport, hardwareVersion=hardwareVersion, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, phyControlGroup=phyControlGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, wirelessLinkStatus=wirelessLinkStatus, tdmTableNumber=tdmTableNumber, remoteInternetAddressLinked=remoteInternetAddressLinked, management=management, cableDiagPair4Distance=cableDiagPair4Distance, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sMTPServerPortNumber=sMTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, oOBPriorityQueueMapping=oOBPriorityQueueMapping, dNSServerTableEntry=dNSServerTableEntry, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNTPServerPortNumber=sNTPServerPortNumber, alarms=alarms, bridgeGroup=bridgeGroup, bootVersion=bootVersion, mABState=mABState, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, configurationInstancedTable=configurationInstancedTable, auxPortStatusTrap=auxPortStatusTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, auxPortQLRx=auxPortQLRx, sNTPPrimaryServer=sNTPPrimaryServer, transmitChannel=transmitChannel, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, authorizationControlTableEntry=authorizationControlTableEntry, sNTPServerTable=sNTPServerTable, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, sNTPPollInterval=sNTPPollInterval, authorizationControlTableIndex=authorizationControlTableIndex, sNTPSync=sNTPSync, mainPSUPortStatus=mainPSUPortStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, auxPortConfigurationMismatch=auxPortConfigurationMismatch, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, maximumTransmitPower=maximumTransmitPower, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogState=syslogState, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sFPErrorTrap=sFPErrorTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, reset=reset, mABTransmissionInterval=mABTransmissionInterval, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, dataBridgingAvailability=dataBridgingAvailability, sNMPCommunityString=sNMPCommunityString, alarmInstancedTable=alarmInstancedTable, mainPSUPortQLRx=mainPSUPortQLRx, sNTPServerRetries=sNTPServerRetries, sFPPortAutoMdix=sFPPortAutoMdix, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, encryption=encryption, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mgmtInstancedTableNumber=mgmtInstancedTableNumber, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, wirelessLinkStatusLinked=wirelessLinkStatusLinked, ptpCompliance=ptpCompliance, longitude=longitude, smtpGroup=smtpGroup, lowestTDMModulationMode=lowestTDMModulationMode, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, installStatusLinked=installStatusLinked, secondarySoftwareVersion=secondarySoftwareVersion, cableLoss=cableLoss)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", altitude=altitude, incompatibleMasterAndSlave=incompatibleMasterAndSlave, softwareVersion=softwareVersion, portAllocationMismatchTrap=portAllocationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptmp=ptmp, dNSPrimaryServer=dNSPrimaryServer, cableDiagnosticsGroup=cableDiagnosticsGroup, sFPPortSyncERxStatus=sFPPortSyncERxStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseEncryption=licenseEncryption, wirelessLinkAvailability=wirelessLinkAvailability, configuration=configuration, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, deviceMSN=deviceMSN, dNSServerTableNumber=dNSServerTableNumber, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, routerProtocolsGroup=routerProtocolsGroup, receiveFreqKHz=receiveFreqKHz, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, transparentClock=transparentClock, localPacketFiltering=localPacketFiltering, vectorError=vectorError, timeZone=timeZone, receiveModulationModeLinked=receiveModulationModeLinked, installStatusTrap=installStatusTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, licenseCapacity=licenseCapacity, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, antennaSelection=antennaSelection, remoteInternetAddress=remoteInternetAddress, txColorCode=txColorCode, targetMACAddress=targetMACAddress, userTableEntry=userTableEntry, sFPPortAllocation=sFPPortAllocation, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dNSGroup=dNSGroup, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, cableDiagnosticsWarning=cableDiagnosticsWarning, ptpGroups=ptpGroups, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, cableDiagnosticsResultTable=cableDiagnosticsResultTable, tDMInterfaceStatus=tDMInterfaceStatus, licenseTLSRekey=licenseTLSRekey, nIDULanPortStatus=nIDULanPortStatus, subnetMask=subnetMask, pubInstancedStatsTable=pubInstancedStatsTable, sFPError=sFPError, cableDiagPair3Distance=cableDiagPair3Distance, licenseInstancedTable=licenseInstancedTable, phyControlInstancedTable=phyControlInstancedTable, tdmTableIndex=tdmTableIndex, versionsGroup=versionsGroup, iPv6PrefixLength=iPv6PrefixLength, sNTPState=sNTPState, dataBridgingStatus=dataBridgingStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, receivePower=receivePower, userEnabled=userEnabled, linkLossLinked=linkLossLinked, mainPSUPortSSMTx=mainPSUPortSSMTx, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, regulatoryBandTrap=regulatoryBandTrap, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNMPTrapTable=sNMPTrapTable, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, packetsToInternalStack=packetsToInternalStack, vectorErrorLinked=vectorErrorLinked, remoteUnitName=remoteUnitName, dNSResolver=dNSResolver, iPv6GatewayAddress=iPv6GatewayAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, signalStrengthRatioLinked=signalStrengthRatioLinked, authorizationControlTable=authorizationControlTable, dataBridgingStatusLinked=dataBridgingStatusLinked, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveModulationModeDetail=receiveModulationModeDetail, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, enableTransmission=enableTransmission, dfsPeaks=dfsPeaks, tDDControlGroup=tDDControlGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, receivePowerLinked=receivePowerLinked, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, alarmsGroup=alarmsGroup, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, cableDiagPair2Results=cableDiagPair2Results, dNSServerInternetAddress=dNSServerInternetAddress, tDMEnabledChannels=tDMEnabledChannels, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, qOSPriorityScheme=qOSPriorityScheme, resetGroup=resetGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerTableIndex=sNTPServerTableIndex, userPassword=userPassword, licenseSecurityLevel=licenseSecurityLevel, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseOOBManagementSupport=licenseOOBManagementSupport, accessMethod=accessMethod, auxPortAllocation=auxPortAllocation, sMTPEnabledMessages=sMTPEnabledMessages, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, searchState=searchState, tDMInterfaceControl=tDMInterfaceControl, signalStrengthRatio=signalStrengthRatio, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPEmailAlert=sMTPEmailAlert, syncETracking=syncETracking, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mgmtInstancedTableEntry=mgmtInstancedTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, aAAControl=aAAControl, ethernetInstancedTableIndex=ethernetInstancedTableIndex, blacklistRMEnabled=blacklistRMEnabled, hTTPSPortNumber=hTTPSPortNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, capacityVariantMismatchTrap=capacityVariantMismatchTrap, installArmState=installArmState, blacklistRMMacAddress=blacklistRMMacAddress, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ethernet=ethernet, subbandHighestFrequency=subbandHighestFrequency, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sNTPServerStatus=sNTPServerStatus, cableDiagPair4Results=cableDiagPair4Results, phyControlInstancedTableNumber=phyControlInstancedTableNumber, userName=userName, authorizationControlTableNumber=authorizationControlTableNumber, unitName=unitName, remoteInternetAddressType=remoteInternetAddressType, ethernetInstancedTableEntry=ethernetInstancedTableEntry, dfsGroup=dfsGroup, daylightSaving=daylightSaving, whitelistRMEnabled=whitelistRMEnabled, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, dNSServerTable=dNSServerTable, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, licenseTDDSyncSupport=licenseTDDSyncSupport, productVariant=productVariant, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, maximumNumberOfSlaves=maximumNumberOfSlaves, telnetAccessEnabled=telnetAccessEnabled, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, ptp670=ptp670, tDMChannelLineCode=tDMChannelLineCode, syslogControlGroup=syslogControlGroup, unitOutOfCalibration=unitOutOfCalibration, licenseTrialPeriod=licenseTrialPeriod, ptp=ptp, supplementaryGroup=supplementaryGroup, authorizationControlGroup=authorizationControlGroup, ptpTrapPrefix=ptpTrapPrefix, dSCPManagementPriority=dSCPManagementPriority, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, aggregateDataRate=aggregateDataRate, groupID=groupID, auxPortQLTx=auxPortQLTx, portAllocationMismatch=portAllocationMismatch, phyStatusGroup=phyStatusGroup, secureModeAlarm=secureModeAlarm, telnetPortNumber=telnetPortNumber, searchStateLinked=searchStateLinked, configurationInstancedTableNumber=configurationInstancedTableNumber, unavailableSeconds=unavailableSeconds, sNTPServerInternetAddressType=sNTPServerInternetAddressType, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, auxPortSSMTx=auxPortSSMTx, dfsTableNumber=dfsTableNumber, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, linkModeOptimization=linkModeOptimization, userRole=userRole, tDDControl=tDDControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, range=range, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, receiveDataRate=receiveDataRate, dfsTable=dfsTable, PYSNMP_MODULE_ID=cambium, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rxColorCode=rxColorCode, managementGroup=managementGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mABNominalModulationMode=mABNominalModulationMode, receiveDataRateLinked=receiveDataRateLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, transparentClockPort=transparentClockPort, sNTPSyncTrap=sNTPSyncTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyInstancedStatusTable=phyInstancedStatusTable, packetsFromInternalStack=packetsFromInternalStack, tFTPServerInternetAddressType=tFTPServerInternetAddressType, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, transparentClockVLAN=transparentClockVLAN, linkName=linkName, smtp=smtp, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, authorizationControl=authorizationControl, iPv6Address=iPv6Address, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPServerInternetAddress=sMTPServerInternetAddress, nIDULanPortAutoMdix=nIDULanPortAutoMdix, authorizationMethod=authorizationMethod, licenseMaxLinkRange=licenseMaxLinkRange, alarmInstancedTableEntry=alarmInstancedTableEntry, userTableIndex=userTableIndex, sNMPv3Enable=sNMPv3Enable, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, transmitterChannels=transmitterChannels, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, aAAControlGroup=aAAControlGroup, transmitModulationModeLinked=transmitModulationModeLinked, tDMConfigurationMismatch=tDMConfigurationMismatch, secureModeAlarmTrap=secureModeAlarmTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, cableDiagPair1Distance=cableDiagPair1Distance, txMABFrames=txMABFrames, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sFPPortQLTx=sFPPortQLTx, mgmtInstancedTable=mgmtInstancedTable, hCMPMaximumLinkRange=hCMPMaximumLinkRange, wirelessOutEthernetOctets=wirelessOutEthernetOctets)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapPortNumber=sNMPTrapPortNumber, pubStatsGroup=pubStatsGroup, hTTPPortNumber=hTTPPortNumber, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseCountry=licenseCountry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDMChannelStatusTrap=tDMChannelStatusTrap, capacityVariantMismatch=capacityVariantMismatch, remoteMACAddressLinked=remoteMACAddressLinked, apc=apc, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, syslogControl=syslogControl, mABProtocolVLANPriority=mABProtocolVLANPriority, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, tFTPClient=tFTPClient, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyControl=phyControl, licenseIssueNumber=licenseIssueNumber, mainPSUPortQLTx=mainPSUPortQLTx, licenseBandwidthCap=licenseBandwidthCap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, dataPortPauseFrames=dataPortPauseFrames, systemClock=systemClock, sNTPServerTableNumber=sNTPServerTableNumber, ethernetInstancedTable=ethernetInstancedTable, lbtDetectedTrap=lbtDetectedTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tDM=tDM, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, severelyErroredSeconds=severelyErroredSeconds, dNSServerPortNumber=dNSServerPortNumber, wirelessOutAllOctets=wirelessOutAllOctets, regulatoryBand=regulatoryBand, transmitPower=transmitPower, licenseGasGroup=licenseGasGroup, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, linkSymmetry=linkSymmetry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, l2CPPriorityTable=l2CPPriorityTable, wirelessTopology=wirelessTopology, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, unitIdentificationGroup=unitIdentificationGroup, subbandLowestFrequency=subbandLowestFrequency, phyStatus=phyStatus, configurationInstancedTableEntry=configurationInstancedTableEntry, frequencyVariant=frequencyVariant, iPDSCPPriorityTable=iPDSCPPriorityTable, iPv4Address=iPv4Address, sFPPortStatus=sFPPortStatus, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, transmitDataRateLinked=transmitDataRateLinked, receiveModulationMode=receiveModulationMode, notificationsGroup=notificationsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sntp=sntp, deviceESN=deviceESN, mainPSUPortStatusTrap=mainPSUPortStatusTrap)
