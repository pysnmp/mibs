...
# Produced by pysmi-1.1.8 at Fri Jul  8 09:13:58 2022
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, accessMethod=accessMethod, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementGroup=managementGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sNTPServerRetries=sNTPServerRetries, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, alarmInstancedTableIndex=alarmInstancedTableIndex, oOBPriorityQueueMapping=oOBPriorityQueueMapping, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, dataBridgingAvailability=dataBridgingAvailability, auxPortAcceptedQLRx=auxPortAcceptedQLRx, iPv4Address=iPv4Address, capacityVariantMismatchLinked=capacityVariantMismatchLinked, phyControlInstancedTableNumber=phyControlInstancedTableNumber, systemClock=systemClock, targetRange=targetRange, dNSServerTableNumber=dNSServerTableNumber, routerProtocolsGroup=routerProtocolsGroup, installArmStateTrap=installArmStateTrap, rxColorCode=rxColorCode, mABProtocolVID=mABProtocolVID, masterSlaveMode=masterSlaveMode, syslogClientTrap=syslogClientTrap, phyControl=phyControl, tDMGroup=tDMGroup, configurationInstancedTableIndex=configurationInstancedTableIndex, wirelessOutOctets=wirelessOutOctets, licenseSFPPortSupport=licenseSFPPortSupport, dNSGroup=dNSGroup, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, transmitModulationMode=transmitModulationMode, lowestDataModulationMode=lowestDataModulationMode, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, linkName=linkName, sNTPServerTableEntry=sNTPServerTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, encryption=encryption, auxPortSyncERxStatus=auxPortSyncERxStatus, phyControlInstancedTable=phyControlInstancedTable, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, encryptionGroup=encryptionGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, supplementary=supplementary, vLANManagementPriority=vLANManagementPriority, wirelessLinkStatusLinked=wirelessLinkStatusLinked, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, ptpTraps=ptpTraps, userTableIndex=userTableIndex, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, nIDULanPortStatusTrap=nIDULanPortStatusTrap, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, wirelessLinkAvailability=wirelessLinkAvailability, tDMChannelStatus=tDMChannelStatus, tDM=tDM, receiveModulationMode=receiveModulationMode, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sNMPTrapVersion=sNMPTrapVersion, mgmtInstancedTable=mgmtInstancedTable, mgmtInstancedTableNumber=mgmtInstancedTableNumber, mABMaintenanceLevel=mABMaintenanceLevel, sFPPortStatus=sFPPortStatus, rangeLinked=rangeLinked, bridgeGroup=bridgeGroup, txMABFrames=txMABFrames, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseTLSRekey=licenseTLSRekey, phyControlGroup=phyControlGroup, dfsTableIndex=dfsTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, tempPcb=tempPcb, cableDiagPair4Results=cableDiagPair4Results, mgmtInstancedTableEntry=mgmtInstancedTableEntry, dNSServerTable=dNSServerTable, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, apc=apc, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseInstancedTableIndex=licenseInstancedTableIndex, cableDiagPair2Results=cableDiagPair2Results, licenseEncryption=licenseEncryption, localPacketFiltering=localPacketFiltering, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tdmTableNumber=tdmTableNumber, antennaGain=antennaGain, sFPPortDisabledWarning=sFPPortDisabledWarning, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, telnetPortNumber=telnetPortNumber, mABNominalModulationMode=mABNominalModulationMode, syncESlavePort=syncESlavePort, PYSNMP_MODULE_ID=cambium, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortStatus=auxPortStatus, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dNSServerTableEntry=dNSServerTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPSPortNumber=hTTPSPortNumber, pubStats=pubStats, tDMChannelLoopback=tDMChannelLoopback, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transmitChannel=transmitChannel, userName=userName, alarmInstancedTableNumber=alarmInstancedTableNumber, dataBridgingStatusAlarm=dataBridgingStatusAlarm, smtp=smtp, transmitFreqMHz=transmitFreqMHz, byteErrorRatio=byteErrorRatio, userTable=userTable, extendedSpectrumScanning=extendedSpectrumScanning, licenseGroup=licenseGroup, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sFPPortAutoMdix=sFPPortAutoMdix, receiveDataRate=receiveDataRate, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, configuration=configuration, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, ptp=ptp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenseTrialPeriod=licenseTrialPeriod, resetGroup=resetGroup, userTableNumber=userTableNumber, latitude=latitude, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mPLSTCPriorityTable=mPLSTCPriorityTable, rawReceivePowerLinked=rawReceivePowerLinked, sntpGroup=sntpGroup, licenseBandwidthCap=licenseBandwidthCap, transmitPower=transmitPower, unavailableSeconds=unavailableSeconds, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, lowestTDMModulationMode=lowestTDMModulationMode, altitude=altitude, hTTPPortNumber=hTTPPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenseVersion=licenseVersion, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, snmpControl=snmpControl, deviceMACAddress=deviceMACAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerTableNumber=sNTPServerTableNumber, dSCPManagementPriority=dSCPManagementPriority, licenseGasGroup=licenseGasGroup, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, cableDiagnostics=cableDiagnostics, alarmInstancedTableEntry=alarmInstancedTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, pubStatsGroup=pubStatsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, siteName=siteName, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, subbandLowestFrequency=subbandLowestFrequency, sNTPServerInternetAddress=sNTPServerInternetAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, snmpControlGroup=snmpControlGroup, subbandHighestFrequency=subbandHighestFrequency, cableDiagPair4Distance=cableDiagPair4Distance, dataPortPauseFrames=dataPortPauseFrames, mABHoldoffPeriod=mABHoldoffPeriod, receivePower=receivePower, ptpGroups=ptpGroups, installStatusLinked=installStatusLinked, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, alarms=alarms, range=range, cableDiagnosticsResultTable=cableDiagnosticsResultTable, capacityVariantMismatch=capacityVariantMismatch, ptpTrapPrefix=ptpTrapPrefix, tDMChannelLineCode=tDMChannelLineCode, tFTPServerPortNumber=tFTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagPair1Results=cableDiagPair1Results, qOSPriorityScheme=qOSPriorityScheme, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseIssueNumber=licenseIssueNumber, licenseGroupAccess=licenseGroupAccess, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, maximumTransmitPower=maximumTransmitPower, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, cableDiagnosticsPorts=cableDiagnosticsPorts, unitIdentification=unitIdentification, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, authorizationControlTableEntry=authorizationControlTableEntry, iPVersion=iPVersion, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, apcGroup=apcGroup, licenseInstancedTableNumber=licenseInstancedTableNumber, ethernetStatisticsTable=ethernetStatisticsTable, dNSServerInternetAddressType=dNSServerInternetAddressType, sFPErrorTrap=sFPErrorTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, licenseInstancedTableEntry=licenseInstancedTableEntry, iPv6PrefixLength=iPv6PrefixLength, nIDULanPortAutoMdix=nIDULanPortAutoMdix, phyControlInstancedTableIndex=phyControlInstancedTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPPortNumber=sNMPPortNumber, timeZone=timeZone, versionsGroup=versionsGroup, userRole=userRole, licenseIEEE1588Support=licenseIEEE1588Support, lbtDetectedTrap=lbtDetectedTrap, installStatusTrap=installStatusTrap, transmitPowerLinked=transmitPowerLinked, longitude=longitude, deviceESN=deviceESN, productName=productName, packetsToInternalStack=packetsToInternalStack, cableDiagnosticsControl=cableDiagnosticsControl, tdmTableEntry=tdmTableEntry, gatewayIPAddress=gatewayIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, mABTransmissionInterval=mABTransmissionInterval, auxPortSSMTx=auxPortSSMTx, userTableEntry=userTableEntry, transparentClockVID=transparentClockVID, dfsTable=dfsTable, ethernet=ethernet, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatus=phyStatus, sNTPServerTableIndex=sNTPServerTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemReset=systemReset)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, hCMPLinkSymmetry=hCMPLinkSymmetry, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sFPPortQLRx=sFPPortQLRx, vectorErrorLinked=vectorErrorLinked, iPv6GatewayAddress=iPv6GatewayAddress, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, signalStrengthRatio=signalStrengthRatio, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, configurationGroup=configurationGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, transmitterChannels=transmitterChannels, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, dNSPrimaryServer=dNSPrimaryServer, channelBandwidth=channelBandwidth, transmitModulationModeLinked=transmitModulationModeLinked, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dfsGroup=dfsGroup, installStatus=installStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, dNSServerInternetAddress=dNSServerInternetAddress, license=license, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, receiveFreqKHz=receiveFreqKHz, dNSServerTableIndex=dNSServerTableIndex, sFPPortAutoNegotiation=sFPPortAutoNegotiation, cableDiagPair3Distance=cableDiagPair3Distance, sNTPSync=sNTPSync, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, deviceMSN=deviceMSN, blacklistRMEnabled=blacklistRMEnabled, licenseInstancedTable=licenseInstancedTable, mainPSUPortSSMTx=mainPSUPortSSMTx, mainPSUPortStatusTrap=mainPSUPortStatusTrap, receiveFreqMHz=receiveFreqMHz, mainPSUPortQLTx=mainPSUPortQLTx, mgmtInstancedTableIndex=mgmtInstancedTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, cableDiagnosticsGroup=cableDiagnosticsGroup, remoteMACAddress=remoteMACAddress, antennaSelection=antennaSelection, auxPortAllocation=auxPortAllocation, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tdmTableIndex=tdmTableIndex, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dataBridgingStatusLinked=dataBridgingStatusLinked, sFPPortSSMTx=sFPPortSSMTx, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, groupID=groupID, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, bridge=bridge, sFPPortAllocation=sFPPortAllocation, ethernetStatisticsDataSource=ethernetStatisticsDataSource, transmitDataRateLinked=transmitDataRateLinked, searchStateLinked=searchStateLinked, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, routerProtocols=routerProtocols, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, licenseSyncESupport=licenseSyncESupport, sFPError=sFPError, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, txColorCode=txColorCode, licenseCountry=licenseCountry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dNS=dNS, auxPortDisabledWarning=auxPortDisabledWarning, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, portAllocationMismatch=portAllocationMismatch, mABState=mABState, dfsTableEntry=dfsTableEntry, ethernetGroup=ethernetGroup, syslogClient=syslogClient, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, notificationsGroup=notificationsGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPServerStatus=sNTPServerStatus, incompatibleRegulatoryBands=incompatibleRegulatoryBands, authorizationControlTableIndex=authorizationControlTableIndex, installationMode=installationMode, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, aAAControlGroup=aAAControlGroup, unitOutOfCalibration=unitOutOfCalibration, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, cambium=cambium, cableDiagnosticsWarning=cableDiagnosticsWarning, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNTPState=sNTPState, cableDiagPair2Distance=cableDiagPair2Distance, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tdmTable=tdmTable, telnetAccessEnabled=telnetAccessEnabled, licenseTDDSyncSupport=licenseTDDSyncSupport, wirelessTopology=wirelessTopology, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPv6Address=iPv6Address, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, cableLoss=cableLoss, phyStatusGroup=phyStatusGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hardwareVersion=hardwareVersion, configurationInstancedTableNumber=configurationInstancedTableNumber, vectorError=vectorError, authorizationControlGroup=authorizationControlGroup, daylightSaving=daylightSaving, unitIdentificationGroup=unitIdentificationGroup, syslogControlGroup=syslogControlGroup, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, phyInstancedStatusTable=phyInstancedStatusTable, unitName=unitName, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseSecurityLevel=licenseSecurityLevel, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, byteErrorRatioLinked=byteErrorRatioLinked, configurationInstancedTableEntry=configurationInstancedTableEntry, eIRP=eIRP, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, transparentClockVLAN=transparentClockVLAN, transparentClockPort=transparentClockPort, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, alarmInstancedTable=alarmInstancedTable, searchState=searchState, transmitDataRate=transmitDataRate, nIDULanPortStatus=nIDULanPortStatus, dfsTableNumber=dfsTableNumber, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, cableDiagPair3Results=cableDiagPair3Results, syslogControl=syslogControl, regulatoryBandTrap=regulatoryBandTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, whitelistRMEnabled=whitelistRMEnabled, syslogState=syslogState, tFTPClient=tFTPClient, installArmState=installArmState, supplementaryGroup=supplementaryGroup, tDMChannelCableLength=tDMChannelCableLength, authorizationControlTable=authorizationControlTable, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, userPassword=userPassword, linkLoss=linkLoss, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, wirelessOutEthernetOctets=wirelessOutEthernetOctets, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerTimeout=sNTPServerTimeout, enableTransmission=enableTransmission, remoteInternetAddressLinked=remoteInternetAddressLinked, aAAControl=aAAControl, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, subnetMask=subnetMask, incompatibleMasterAndSlave=incompatibleMasterAndSlave, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, targetMACAddress=targetMACAddress, maximumNumberOfSlaves=maximumNumberOfSlaves, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, signalStrengthRatioLinked=signalStrengthRatioLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, syncETrackingState=syncETrackingState, licenseRARSupport=licenseRARSupport, ptmp=ptmp, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, pubInstancedStatsTable=pubInstancedStatsTable, portAllocationMismatchLinked=portAllocationMismatchLinked, managementPortWirelessDownAlert=managementPortWirelessDownAlert, linkSymmetry=linkSymmetry, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, secureModeAlarmTrap=secureModeAlarmTrap, remoteMACAddressLinked=remoteMACAddressLinked, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseIPv6Support=licenseIPv6Support, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortQLTx=sFPPortQLTx, syncEEquipmentClock=syncEEquipmentClock, tDMChannelStatusTrap=tDMChannelStatusTrap, remoteInternetAddress=remoteInternetAddress, syncETracking=syncETracking, auxPortQLRx=auxPortQLRx, licenseHCMPSupport=licenseHCMPSupport, dNSServerPortNumber=dNSServerPortNumber, authorizationControlTableNumber=authorizationControlTableNumber, ethernetInstancedTableEntry=ethernetInstancedTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, smtpGroup=smtpGroup, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tDMInterfaceControl=tDMInterfaceControl, remoteUnitNameLinked=remoteUnitNameLinked, licenseMaxLinkRange=licenseMaxLinkRange, ptp670=ptp670, dfsPeaks=dfsPeaks, tDMInterfaceStatus=tDMInterfaceStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, severelyErroredSeconds=severelyErroredSeconds, sntp=sntp, auxPortStatusTrap=auxPortStatusTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, wirelessOutAllOctets=wirelessOutAllOctets, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagPair1Distance=cableDiagPair1Distance, secureModeAlarm=secureModeAlarm, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ethernetPriorityTable=ethernetPriorityTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveDataRateLinked=receiveDataRateLinked, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, userEnabled=userEnabled, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, ethernetInstancedTableIndex=ethernetInstancedTableIndex, alarmsGroup=alarmsGroup, wirelessLinkStatus=wirelessLinkStatus, aggregateDataRateLinked=aggregateDataRateLinked, transmitFreqKHz=transmitFreqKHz, whitelistRMMacAddress=whitelistRMMacAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDDControl=tDDControl, dfs=dfs, ptpCompliance=ptpCompliance, sNTPServerTable=sNTPServerTable, sNMPTrapTable=sNMPTrapTable, ethernetInstancedTableNumber=ethernetInstancedTableNumber, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTableEntry=sNMPTrapTableEntry, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, useVLANForMABProtocol=useVLANForMABProtocol, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, authorizationMethod=authorizationMethod, tDDControlGroup=tDDControlGroup, authorizationControl=authorizationControl, sNMPv3Enable=sNMPv3Enable, capacityVariantMismatchTrap=capacityVariantMismatchTrap, channelChangeTrap=channelChangeTrap, rawReceivePower=rawReceivePower, erroredSeconds=erroredSeconds, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mainPSUPortAllocation=mainPSUPortAllocation)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", packetsFromInternalStack=packetsFromInternalStack, remoteInternetAddressType=remoteInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, reset=reset, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, ethernetInstancedTable=ethernetInstancedTable, vLANManagementVID=vLANManagementVID, licenseOOBManagementSupport=licenseOOBManagementSupport, sNTPLastSync=sNTPLastSync, receiveModulationModeDetail=receiveModulationModeDetail, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, receivePowerLinked=receivePowerLinked, aggregateDataRate=aggregateDataRate, dNSResolver=dNSResolver, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, versions=versions, dataBridgingStatus=dataBridgingStatus, sFPPortStatusTrap=sFPPortStatusTrap, linkLossLinked=linkLossLinked, productVariant=productVariant, l2CPPriorityTable=l2CPPriorityTable, tDMConfigurationMismatch=tDMConfigurationMismatch, sNMPCommunityString=sNMPCommunityString, frequencyVariant=frequencyVariant, rangingMode=rangingMode, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tDMEnabledChannels=tDMEnabledChannels, syslogStateTrap=syslogStateTrap, dfsMeans=dfsMeans, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseUnitSerialNumber=licenseUnitSerialNumber, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, bootVersion=bootVersion, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mainPSUPortStatus=mainPSUPortStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, regulatoryBand=regulatoryBand, blacklistRMMacAddress=blacklistRMMacAddress, linkModeOptimization=linkModeOptimization, licenseCapacity=licenseCapacity, remoteUnitName=remoteUnitName, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, transparentClock=transparentClock, auxPortQLTx=auxPortQLTx, receiveModulationModeLinked=receiveModulationModeLinked, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPSyncTrap=sNTPSyncTrap, configurationInstancedTable=configurationInstancedTable, managementNetworkAccessEnabled=managementNetworkAccessEnabled, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, management=management, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mABProtocolVLANPriority=mABProtocolVLANPriority, receiveChannel=receiveChannel)
