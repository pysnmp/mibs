...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetStatisticsTable=ethernetStatisticsTable, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, dNSServerInternetAddress=dNSServerInternetAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sFPError=sFPError, tdmTableNumber=tdmTableNumber, PYSNMP_MODULE_ID=cambium, whitelistRMEnabled=whitelistRMEnabled, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, userPassword=userPassword, transparentClock=transparentClock, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, licenseSyncESupport=licenseSyncESupport, versions=versions, transmitFreqKHz=transmitFreqKHz, userTableEntry=userTableEntry, licenseIssueNumber=licenseIssueNumber, cableLoss=cableLoss, dfs=dfs, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, tDM=tDM, configurationInstancedTableEntry=configurationInstancedTableEntry, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, tDMInterfaceControl=tDMInterfaceControl, installStatus=installStatus, deviceMACAddress=deviceMACAddress, installStatusLinked=installStatusLinked, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseInstancedTableNumber=licenseInstancedTableNumber, dataBridgingStatus=dataBridgingStatus, searchState=searchState, sNTPLastSync=sNTPLastSync, encryption=encryption, ptpGroups=ptpGroups, latitude=latitude, unitOutOfCalibration=unitOutOfCalibration, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, iPv6Address=iPv6Address, rangingMode=rangingMode, aggregateDataRate=aggregateDataRate, licenseIPv6Support=licenseIPv6Support, sNMPEnabledTraps=sNMPEnabledTraps, syncESlavePort=syncESlavePort, ptpCompliance=ptpCompliance, auxPortStatusTrap=auxPortStatusTrap, tDMChannelStatus=tDMChannelStatus, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, txColorCode=txColorCode, mgmtInstancedTable=mgmtInstancedTable, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, linkSymmetry=linkSymmetry, ptp670=ptp670, sNMPTrapTableIndex=sNMPTrapTableIndex, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, managementPortWirelessDownAlert=managementPortWirelessDownAlert, antennaSelection=antennaSelection, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, cableDiagPair1Distance=cableDiagPair1Distance, dNSResolver=dNSResolver, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sFPPortSyncERxStatus=sFPPortSyncERxStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, mainPSUPortQLRx=mainPSUPortQLRx, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syncETracking=syncETracking, severelyErroredSeconds=severelyErroredSeconds, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, dNS=dNS, syslogControlGroup=syslogControlGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, tDDSynchronizationMode=tDDSynchronizationMode, secureModeAlarmTrap=secureModeAlarmTrap, gatewayIPAddress=gatewayIPAddress, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, transmitPowerLinked=transmitPowerLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ptp=ptp, packetsToInternalStack=packetsToInternalStack, unitName=unitName, sFPPortStatusTrap=sFPPortStatusTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, configurationInstancedTable=configurationInstancedTable, authorizationControlTableNumber=authorizationControlTableNumber, dfsTable=dfsTable, localPacketFiltering=localPacketFiltering, auxPortQLRx=auxPortQLRx, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseGroupAccess=licenseGroupAccess, accessMethod=accessMethod, ethernetPriorityTable=ethernetPriorityTable, transparentClockVLAN=transparentClockVLAN, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tempPcb=tempPcb, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dNSServerTable=dNSServerTable, encryptionAlgorithm=encryptionAlgorithm, smtpGroup=smtpGroup, wirelessOutEthernetOctets=wirelessOutEthernetOctets, aAAControl=aAAControl, pubInstancedStatsTable=pubInstancedStatsTable, packetsFromInternalStack=packetsFromInternalStack, auxPortStatus=auxPortStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hCMPMaximumLinkRange=hCMPMaximumLinkRange, transmitModulationModeLinked=transmitModulationModeLinked, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTraps=ptpTraps, transmitDataRate=transmitDataRate, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, regulatoryBandTrap=regulatoryBandTrap, telnetAccessEnabled=telnetAccessEnabled, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, configurationInstancedTableNumber=configurationInstancedTableNumber, managementGroup=managementGroup, hardwareVersion=hardwareVersion, signalStrengthRatioLinked=signalStrengthRatioLinked, phyStatus=phyStatus, sNTPServerPortNumber=sNTPServerPortNumber, lowestTDMModulationMode=lowestTDMModulationMode, telnetPortNumber=telnetPortNumber, licenseInstancedTableEntry=licenseInstancedTableEntry, remoteInternetAddressType=remoteInternetAddressType, mainPSUPortAutoMdix=mainPSUPortAutoMdix, dfsTableNumber=dfsTableNumber, sMTPEmailAlert=sMTPEmailAlert, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, authorizationControlTableEntry=authorizationControlTableEntry, alarms=alarms, iPv6GatewayAddress=iPv6GatewayAddress, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, ptmp=ptmp, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, daylightSaving=daylightSaving, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, iPVersion=iPVersion, licenseBandwidthCap=licenseBandwidthCap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, linkName=linkName, receiveModulationModeDetail=receiveModulationModeDetail, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cableDiagPair2Results=cableDiagPair2Results, licenseSFPPortSupport=licenseSFPPortSupport, sntp=sntp, dfsGroup=dfsGroup, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, lbtDetectedTrap=lbtDetectedTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, cableDiagPair1Results=cableDiagPair1Results, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, dNSPrimaryServer=dNSPrimaryServer, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, unavailableSeconds=unavailableSeconds, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mainPSUPortSSMTx=mainPSUPortSSMTx, useVLANForMABProtocol=useVLANForMABProtocol, rxColorCode=rxColorCode, cableDiagPair3Results=cableDiagPair3Results, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, resetGroup=resetGroup, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, supplementaryGroup=supplementaryGroup, supplementary=supplementary, alarmsGroup=alarmsGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, linkLossLinked=linkLossLinked, maximumNumberOfSlaves=maximumNumberOfSlaves, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseCapacity=licenseCapacity, sNTPServerTimeout=sNTPServerTimeout, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, deviceMSN=deviceMSN, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, versionsGroup=versionsGroup, transmitPower=transmitPower, longitude=longitude, linkModeOptimization=linkModeOptimization, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, channelBandwidth=channelBandwidth, aggregateDataRateLinked=aggregateDataRateLinked, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, userRole=userRole, tdmTableIndex=tdmTableIndex, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, licenseGasGroup=licenseGasGroup, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mABNominalModulationMode=mABNominalModulationMode, l2CPPriorityTable=l2CPPriorityTable, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, cableDiagnostics=cableDiagnostics, dataBridgingStatusAlarm=dataBridgingStatusAlarm, alarmInstancedTable=alarmInstancedTable, sNTPPrimaryServer=sNTPPrimaryServer, sFPPortQLRx=sFPPortQLRx, bridgeGroup=bridgeGroup, wirelessOutOctets=wirelessOutOctets, iPv4Address=iPv4Address, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, regulatoryBand=regulatoryBand, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sFPPortAllocation=sFPPortAllocation, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, cambium=cambium, sFPPortAutoNegotiation=sFPPortAutoNegotiation, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, cableDiagPair2Distance=cableDiagPair2Distance, phyControlGroup=phyControlGroup, dNSGroup=dNSGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, cableDiagnosticsWarning=cableDiagnosticsWarning, wirelessTopology=wirelessTopology, capacityVariantMismatch=capacityVariantMismatch, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sFPPortSSMTx=sFPPortSSMTx, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, qOSPriorityScheme=qOSPriorityScheme, phyControl=phyControl, licenseIEEE1588Support=licenseIEEE1588Support, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, hCMPLinkSymmetry=hCMPLinkSymmetry, blacklistRMMacAddress=blacklistRMMacAddress, sNTPServerTableIndex=sNTPServerTableIndex, whitelistRMMacAddress=whitelistRMMacAddress, cableDiagnosticsControl=cableDiagnosticsControl, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, receiveDataRateLinked=receiveDataRateLinked, systemReset=systemReset, receiveChannel=receiveChannel, range=range, tDMGroup=tDMGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, license=license, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sNTPSync=sNTPSync, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, txMABFrames=txMABFrames, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPPortNumber=sNMPPortNumber, receiveModulationModeLinked=receiveModulationModeLinked, rawReceivePower=rawReceivePower, tDMInterfaceStatus=tDMInterfaceStatus, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mABState=mABState, enableTransmission=enableTransmission, licenseMaxLinkRange=licenseMaxLinkRange, tDMChannelCableLength=tDMChannelCableLength, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, secureModeAlarm=secureModeAlarm, alarmInstancedTableNumber=alarmInstancedTableNumber, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, syslogControl=syslogControl, sFPPortAutoMdix=sFPPortAutoMdix, tDMChannelLoopback=tDMChannelLoopback, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, syslogStateTrap=syslogStateTrap, dfsMeans=dfsMeans, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sFPPortDisabledWarning=sFPPortDisabledWarning, cableDiagnosticsPorts=cableDiagnosticsPorts, dfsPeaks=dfsPeaks, sNTPSyncTrap=sNTPSyncTrap, siteName=siteName, smtp=smtp, licenseGroup=licenseGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseInstancedTable=licenseInstancedTable, sNTPState=sNTPState, mABProtocolVID=mABProtocolVID, lowestDataModulationMode=lowestDataModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseTLSRekey=licenseTLSRekey, transmitModulationMode=transmitModulationMode, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveDataRate=receiveDataRate, remoteInternetAddress=remoteInternetAddress, targetMACAddress=targetMACAddress, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, auxPortAllocation=auxPortAllocation, installStatusTrap=installStatusTrap, auxPortSSMTx=auxPortSSMTx, dNSServerTableNumber=dNSServerTableNumber, deviceESN=deviceESN, maximumTransmitPower=maximumTransmitPower, subbandLowestFrequency=subbandLowestFrequency, rawReceivePowerLinked=rawReceivePowerLinked, sNMPv3Enable=sNMPv3Enable, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, extendedSpectrumScanning=extendedSpectrumScanning, apc=apc, sMTPServerPortNumber=sMTPServerPortNumber, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sNTPServerStatus=sNTPServerStatus, sFPPortStatus=sFPPortStatus, tDDControl=tDDControl, remoteUnitName=remoteUnitName, dNSServerPortNumber=dNSServerPortNumber, licenseCountry=licenseCountry, sFPPortQLTx=sFPPortQLTx, maxLinkRangeExceeded=maxLinkRangeExceeded, subnetMask=subnetMask, oOBPriorityQueueMapping=oOBPriorityQueueMapping, portAllocationMismatchLinked=portAllocationMismatchLinked, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dSCPManagementPriority=dSCPManagementPriority, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mgmtInstancedTableNumber=mgmtInstancedTableNumber, cableDiagPair4Distance=cableDiagPair4Distance, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, ethernetInstancedTableIndex=ethernetInstancedTableIndex, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, portAllocationMismatch=portAllocationMismatch, receiveModulationMode=receiveModulationMode, licenseVersion=licenseVersion, mABHoldoffPeriod=mABHoldoffPeriod, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, vLANManagementVID=vLANManagementVID, phyStatusGroup=phyStatusGroup, searchStateLinked=searchStateLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortSyncERxStatus=auxPortSyncERxStatus, wirelessOutAllOctets=wirelessOutAllOctets, licenseRARSupport=licenseRARSupport, ethernetGroup=ethernetGroup, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, capacityVariantMismatchLinked=capacityVariantMismatchLinked, targetRange=targetRange, licenseHCMPSupport=licenseHCMPSupport, receivePowerLinked=receivePowerLinked, syslogClientTrap=syslogClientTrap, erroredSeconds=erroredSeconds, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mABTransmissionInterval=mABTransmissionInterval, mainPSUPortQLTx=mainPSUPortQLTx, blacklistRMEnabled=blacklistRMEnabled, phyControlInstancedTableEntry=phyControlInstancedTableEntry, masterSlaveMode=masterSlaveMode, nIDULanPortStatus=nIDULanPortStatus, dataBridgingStatusLinked=dataBridgingStatusLinked, authorizationControlTable=authorizationControlTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, softwareVersion=softwareVersion, tDDControlGroup=tDDControlGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, configuration=configuration, mABProtocolVLANPriority=mABProtocolVLANPriority, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sNTPServerTableNumber=sNTPServerTableNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, installArmStateTrap=installArmStateTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, unitIdentificationGroup=unitIdentificationGroup, tDMEnabledChannels=tDMEnabledChannels, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, incompatibleRegulatoryBands=incompatibleRegulatoryBands, byteErrorRatio=byteErrorRatio, licenseSecurityLevel=licenseSecurityLevel, sNTPServerTable=sNTPServerTable, authorizationControl=authorizationControl, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sNTPPollInterval=sNTPPollInterval, productName=productName, licenseRegulatoryBandsList=licenseRegulatoryBandsList, signalStrengthRatio=signalStrengthRatio, licenseUnitSerialNumber=licenseUnitSerialNumber, dNSServerTableEntry=dNSServerTableEntry, tDMChannelLineCode=tDMChannelLineCode, sNTPServerRetries=sNTPServerRetries, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sFPErrorTrap=sFPErrorTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, snmpControlGroup=snmpControlGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, unitIdentification=unitIdentification, licenseInstancedTableIndex=licenseInstancedTableIndex, wirelessLinkStatus=wirelessLinkStatus, cableDiagPair4Results=cableDiagPair4Results, ethernetPriorityTableIndex=ethernetPriorityTableIndex, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, transmitDataRateLinked=transmitDataRateLinked, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, transparentClockPort=transparentClockPort, installationMode=installationMode, installArmState=installArmState, vectorError=vectorError, remoteMACAddressLinked=remoteMACAddressLinked, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, systemClock=systemClock, altitude=altitude, apcGroup=apcGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tdmTable=tdmTable, dfsTableIndex=dfsTableIndex, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, syncEEquipmentClock=syncEEquipmentClock, configurationGroup=configurationGroup, syslogClient=syslogClient, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, dNSServerTableIndex=dNSServerTableIndex, subbandHighestFrequency=subbandHighestFrequency, sNTPServerInternetAddress=sNTPServerInternetAddress, phyInstancedStatusTable=phyInstancedStatusTable, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, ethernetInstancedTable=ethernetInstancedTable, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, pubStats=pubStats, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, ethernetStatisticsDataSource=ethernetStatisticsDataSource, userName=userName, configurationInstancedTableIndex=configurationInstancedTableIndex, tDMConfigurationMismatch=tDMConfigurationMismatch, remoteUnitNameLinked=remoteUnitNameLinked, receivePower=receivePower, syslogState=syslogState, licenseTrialPeriod=licenseTrialPeriod, nIDULanPortAutoMdix=nIDULanPortAutoMdix, mABMaintenanceLevel=mABMaintenanceLevel, dfsTableEntry=dfsTableEntry, ethernetInstancedTableEntry=ethernetInstancedTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseOOBManagementSupport=licenseOOBManagementSupport, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, byteErrorRatioLinked=byteErrorRatioLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, eIRP=eIRP, sntpGroup=sntpGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, frequencyVariant=frequencyVariant, licenseEncryption=licenseEncryption, bootVersion=bootVersion, snmpControl=snmpControl, groupID=groupID, tFTPClient=tFTPClient, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, antennaGain=antennaGain, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, alarmInstancedTableIndex=alarmInstancedTableIndex, reset=reset, bridge=bridge, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, userTableNumber=userTableNumber, authorizationMethod=authorizationMethod, userTableIndex=userTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, cableDiagPair3Distance=cableDiagPair3Distance)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", rangeLinked=rangeLinked, hTTPPortNumber=hTTPPortNumber, phyControlInstancedTable=phyControlInstancedTable, vLANManagementPriority=vLANManagementPriority, licenseTDDSyncSupport=licenseTDDSyncSupport, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, routerProtocolsGroup=routerProtocolsGroup, auxPortDisabledWarning=auxPortDisabledWarning, remoteInternetAddressLinked=remoteInternetAddressLinked, authorizationControlGroup=authorizationControlGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, phyControlInstancedTableIndex=phyControlInstancedTableIndex, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, vectorErrorLinked=vectorErrorLinked, sNMPCommunityString=sNMPCommunityString, channelChangeTrap=channelChangeTrap, secondarySoftwareVersion=secondarySoftwareVersion, tdmTableEntry=tdmTableEntry, receiveFreqMHz=receiveFreqMHz, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, routerProtocols=routerProtocols, management=management, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, pubStatsGroup=pubStatsGroup, timeZone=timeZone, iPv6PrefixLength=iPv6PrefixLength, dataPortPauseFrames=dataPortPauseFrames, notificationsGroup=notificationsGroup, userTable=userTable, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernet=ethernet, portAllocationMismatchTrap=portAllocationMismatchTrap, auxPortQLTx=auxPortQLTx, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, transmitterChannels=transmitterChannels, syncETrackingState=syncETrackingState, encryptionGroup=encryptionGroup, dataBridgingAvailability=dataBridgingAvailability, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, transmitChannel=transmitChannel, aAAControlGroup=aAAControlGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, userEnabled=userEnabled, mainPSUPortAllocation=mainPSUPortAllocation, authorizationControlTableIndex=authorizationControlTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, productVariant=productVariant, transparentClockVID=transparentClockVID, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, linkLoss=linkLoss, mainPSUPortStatus=mainPSUPortStatus, receiveFreqKHz=receiveFreqKHz)
