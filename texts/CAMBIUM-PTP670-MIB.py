...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", blacklistRMMacAddress=blacklistRMMacAddress, sFPPortSyncERxStatus=sFPPortSyncERxStatus, reset=reset, sNTPServerTimeout=sNTPServerTimeout, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sFPPortStatus=sFPPortStatus, linkLossLinked=linkLossLinked, syslogClient=syslogClient, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, regulatoryBand=regulatoryBand, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPState=sNTPState, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, lowestDataModulationMode=lowestDataModulationMode, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mainPSUPortQLRx=mainPSUPortQLRx, tDDControl=tDDControl, productName=productName, configurationInstancedTableEntry=configurationInstancedTableEntry, syslogControl=syslogControl, userTableNumber=userTableNumber, packetsFromInternalStack=packetsFromInternalStack, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, dNSPrimaryServer=dNSPrimaryServer, portAllocationMismatchTrap=portAllocationMismatchTrap, sNMPPortNumber=sNMPPortNumber, tDMGroup=tDMGroup, syslogState=syslogState, mABProtocolVID=mABProtocolVID, whitelistRMEnabled=whitelistRMEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, hTTPPortNumber=hTTPPortNumber, extendedSpectrumScanning=extendedSpectrumScanning, auxPortAllocation=auxPortAllocation, l2CPPriorityTable=l2CPPriorityTable, licenseInstancedTable=licenseInstancedTable, ethernetInstancedTableEntry=ethernetInstancedTableEntry, licenseSFPPortSupport=licenseSFPPortSupport, sFPPortQLTx=sFPPortQLTx, notificationsGroup=notificationsGroup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sFPPortAutoNegotiation=sFPPortAutoNegotiation, dfsTableIndex=dfsTableIndex, ethernetStatisticsDataSource=ethernetStatisticsDataSource, receiveFreqMHz=receiveFreqMHz, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, syncESlavePort=syncESlavePort, packetsToInternalStack=packetsToInternalStack, targetRange=targetRange, sNTPServerTable=sNTPServerTable, licenseTrialPeriod=licenseTrialPeriod, cableDiagPair1Results=cableDiagPair1Results, qOSPriorityScheme=qOSPriorityScheme, PYSNMP_MODULE_ID=cambium, licenseRegulatoryBandsList=licenseRegulatoryBandsList, authorizationControlTableNumber=authorizationControlTableNumber, bridge=bridge, dNSServerInternetAddress=dNSServerInternetAddress, licenseSyncESupport=licenseSyncESupport, tDMInterfaceControl=tDMInterfaceControl, licenseBandwidthCap=licenseBandwidthCap, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, systemReset=systemReset, longitude=longitude, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, cableDiagPair3Distance=cableDiagPair3Distance, dNSServerInternetAddressType=dNSServerInternetAddressType, userRole=userRole, byteErrorRatioLinked=byteErrorRatioLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, timeZone=timeZone, auxPortQLRx=auxPortQLRx, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, alarmsGroup=alarmsGroup, sFPErrorTrap=sFPErrorTrap, hTTPAccessEnabled=hTTPAccessEnabled, iPDSCPPriorityTable=iPDSCPPriorityTable, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, installStatus=installStatus, siteName=siteName, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseIEEE1588Support=licenseIEEE1588Support, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerStatus=sNTPServerStatus, maximumTransmitPower=maximumTransmitPower, auxPortStatus=auxPortStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mABTransmissionInterval=mABTransmissionInterval, remoteInternetAddress=remoteInternetAddress, phyControlInstancedTableIndex=phyControlInstancedTableIndex, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, alarmInstancedTable=alarmInstancedTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernet=ethernet, mPLSTCPriorityTable=mPLSTCPriorityTable, userTableEntry=userTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, txMABFrames=txMABFrames, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userPassword=userPassword, licenseCountry=licenseCountry, authorizationControlTableEntry=authorizationControlTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, userTableIndex=userTableIndex, altitude=altitude, tdmTableEntry=tdmTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseIssueNumber=licenseIssueNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptpGroups=ptpGroups, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, resetGroup=resetGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTable=dfsTable, cableDiagPair4Results=cableDiagPair4Results, phyStatusGroup=phyStatusGroup, mgmtInstancedTableNumber=mgmtInstancedTableNumber, bootVersion=bootVersion, tDDControlGroup=tDDControlGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerTableIndex=sNTPServerTableIndex, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, vLANManagementVID=vLANManagementVID, ethernetPriorityTable=ethernetPriorityTable, hCMPMaximumLinkRange=hCMPMaximumLinkRange, receiveDataRateLinked=receiveDataRateLinked, dNS=dNS, smtp=smtp, dNSServerTableEntry=dNSServerTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, license=license, smtpGroup=smtpGroup, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, licenseRARSupport=licenseRARSupport, subnetMask=subnetMask, sMTPServerPortNumber=sMTPServerPortNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortSSMTx=auxPortSSMTx, mgmtInstancedTableIndex=mgmtInstancedTableIndex, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, configurationInstancedTableIndex=configurationInstancedTableIndex, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, alarms=alarms, sFPPortDisabledWarning=sFPPortDisabledWarning, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, channelChangeTrap=channelChangeTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, receiveDataRate=receiveDataRate, lbtDetectedTrap=lbtDetectedTrap, apcGroup=apcGroup, secureModeAlarm=secureModeAlarm, gatewayIPAddress=gatewayIPAddress, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, signalStrengthRatioLinked=signalStrengthRatioLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessOutEthernetOctets=wirelessOutEthernetOctets, ethernetPriorityTableIndex=ethernetPriorityTableIndex, whitelistRMMacAddress=whitelistRMMacAddress, alarmInstancedTableEntry=alarmInstancedTableEntry, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, cambium=cambium, configurationInstancedTable=configurationInstancedTable, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, tDMChannelLoopback=tDMChannelLoopback, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tDMChannelStatus=tDMChannelStatus, encryptionGroup=encryptionGroup, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, alarmInstancedTableIndex=alarmInstancedTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataBridgingAvailability=dataBridgingAvailability, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, mABState=mABState, deviceESN=deviceESN, mABNominalModulationMode=mABNominalModulationMode, tdmTableNumber=tdmTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, systemClock=systemClock, transmitPowerLinked=transmitPowerLinked, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, ethernetStatisticsTable=ethernetStatisticsTable, transmitModulationMode=transmitModulationMode, aggregateDataRate=aggregateDataRate, authorizationControl=authorizationControl, installArmState=installArmState, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, mgmtInstancedTable=mgmtInstancedTable, licenseVersion=licenseVersion, blacklistRMEnabled=blacklistRMEnabled, iPv6Address=iPv6Address, ptp670=ptp670, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installStatusTrap=installStatusTrap, ptp=ptp, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, encryption=encryption, authorizationMethod=authorizationMethod, dNSServerTableIndex=dNSServerTableIndex, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, subbandHighestFrequency=subbandHighestFrequency, txColorCode=txColorCode, syncEEquipmentClock=syncEEquipmentClock, licenseInstancedTableNumber=licenseInstancedTableNumber, antennaSelection=antennaSelection, transparentClockVLAN=transparentClockVLAN, receivePower=receivePower, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, rangingMode=rangingMode, sNTPSync=sNTPSync, tDM=tDM, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, eIRP=eIRP, rawReceivePowerLinked=rawReceivePowerLinked, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, routerProtocolsGroup=routerProtocolsGroup, hCMPLinkSymmetry=hCMPLinkSymmetry, phyControlGroup=phyControlGroup, dNSServerPortNumber=dNSServerPortNumber, telnetPortNumber=telnetPortNumber, receiveModulationMode=receiveModulationMode, mainPSUPortAutoMdix=mainPSUPortAutoMdix, management=management, transmitFreqKHz=transmitFreqKHz, dataPortPauseFrames=dataPortPauseFrames, tdmTableIndex=tdmTableIndex, unitIdentification=unitIdentification, l2CPPriorityTableIndex=l2CPPriorityTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, licenseSecurityLevel=licenseSecurityLevel, accessMethod=accessMethod, daylightSaving=daylightSaving, linkName=linkName, authorizationControlTableIndex=authorizationControlTableIndex, latitude=latitude, unitName=unitName, sFPPortSSMTx=sFPPortSSMTx, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, cableDiagPair2Results=cableDiagPair2Results, versionsGroup=versionsGroup, routerProtocols=routerProtocols, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagnosticsPorts=cableDiagnosticsPorts, syslogStateTrap=syslogStateTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tFTPClient=tFTPClient, searchStateLinked=searchStateLinked, capacityVariantMismatchLinked=capacityVariantMismatchLinked, authorizationControlTable=authorizationControlTable, sNTPLastSync=sNTPLastSync, deviceMACAddress=deviceMACAddress, ethernetInstancedTable=ethernetInstancedTable, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, useVLANForManagementInterfaces=useVLANForManagementInterfaces, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, phyControlInstancedTable=phyControlInstancedTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, phyControlInstancedTableNumber=phyControlInstancedTableNumber, iPv6GatewayAddress=iPv6GatewayAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sFPPortQLRx=sFPPortQLRx, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, rxColorCode=rxColorCode, remoteUnitName=remoteUnitName, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerRetries=sNTPServerRetries, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetInstancedTableIndex=ethernetInstancedTableIndex, nIDULanPortStatus=nIDULanPortStatus, subbandLowestFrequency=subbandLowestFrequency, groupID=groupID, transmitModulationModeLinked=transmitModulationModeLinked, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsTableEntry=dfsTableEntry, userName=userName, sMTPServerInternetAddress=sMTPServerInternetAddress, sntp=sntp, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dfs=dfs, wirelessOutOctets=wirelessOutOctets, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cableDiagnosticsGroup=cableDiagnosticsGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, sNTPServerPortNumber=sNTPServerPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkSymmetry=linkSymmetry, portAllocationMismatchLinked=portAllocationMismatchLinked, cableDiagPair1Distance=cableDiagPair1Distance, syslogClientTrap=syslogClientTrap, masterSlaveMode=masterSlaveMode, dfsMeans=dfsMeans, dNSResolver=dNSResolver, phyStatus=phyStatus, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, pubInstancedStatsTable=pubInstancedStatsTable, sNTPPollInterval=sNTPPollInterval, useVLANForMABProtocol=useVLANForMABProtocol, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, unitIdentificationGroup=unitIdentificationGroup, apc=apc, phyControlInstancedTableEntry=phyControlInstancedTableEntry, ptpTraps=ptpTraps, wirelessLinkStatus=wirelessLinkStatus, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, linkModeOptimization=linkModeOptimization, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, iPv4Address=iPv4Address, licenseGasGroup=licenseGasGroup, licenseInstancedTableIndex=licenseInstancedTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, snmpControlGroup=snmpControlGroup, sNMPv3Enable=sNMPv3Enable, licenseMaxLinkRange=licenseMaxLinkRange, userEnabled=userEnabled, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, installStatusLinked=installStatusLinked, sNMPTrapTableIndex=sNMPTrapTableIndex, sFPPortAllocation=sFPPortAllocation, licenseCapacity=licenseCapacity, vLANManagementPriority=vLANManagementPriority, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTableEntry=sNTPServerTableEntry, unitOutOfCalibration=unitOutOfCalibration, transmitFreqMHz=transmitFreqMHz, sNMPEnabledTraps=sNMPEnabledTraps, targetMACAddress=targetMACAddress, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogControlGroup=syslogControlGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, tdmTable=tdmTable, transmitPower=transmitPower, auxPortDisabledWarning=auxPortDisabledWarning, productVariant=productVariant, mainPSUPortQLTx=mainPSUPortQLTx, mABHoldoffPeriod=mABHoldoffPeriod, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, wirelessOutAllOctets=wirelessOutAllOctets, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, dfsPeaks=dfsPeaks, authorizationControlGroup=authorizationControlGroup, vectorErrorLinked=vectorErrorLinked, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, alarmInstancedTableNumber=alarmInstancedTableNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, wirelessTopology=wirelessTopology, secureModeAlarmTrap=secureModeAlarmTrap, vectorError=vectorError, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, capacityVariantMismatch=capacityVariantMismatch, cableDiagnostics=cableDiagnostics, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, searchState=searchState, sNMPCommunityString=sNMPCommunityString, sNTPSyncTrap=sNTPSyncTrap, dataBridgingStatus=dataBridgingStatus, configurationGroup=configurationGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ptpTrapPrefix=ptpTrapPrefix, licenseUnitSerialNumber=licenseUnitSerialNumber, auxPortConfigurationMismatch=auxPortConfigurationMismatch, cableDiagnosticsResultTable=cableDiagnosticsResultTable, cableDiagnosticsControl=cableDiagnosticsControl, dfsTableNumber=dfsTableNumber, syncETrackingState=syncETrackingState, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, supplementaryGroup=supplementaryGroup, configurationInstancedTableNumber=configurationInstancedTableNumber, sFPPortAutoMdix=sFPPortAutoMdix, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, receiveFreqKHz=receiveFreqKHz, sntpGroup=sntpGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteMACAddress=remoteMACAddress, hardwareVersion=hardwareVersion, capacityVariantMismatchTrap=capacityVariantMismatchTrap, linkLoss=linkLoss, licenseTDDSyncSupport=licenseTDDSyncSupport, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ethernetGroup=ethernetGroup, dNSGroup=dNSGroup, managementGroup=managementGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, severelyErroredSeconds=severelyErroredSeconds, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerTableNumber=sNTPServerTableNumber, byteErrorRatio=byteErrorRatio, sFPError=sFPError, encryptionAlgorithm=encryptionAlgorithm, snmpControl=snmpControl, userTable=userTable, supplementary=supplementary, installationMode=installationMode, bridgeGroup=bridgeGroup, transparentClockVID=transparentClockVID, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, enableTransmission=enableTransmission, versions=versions, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, receiveModulationModeDetail=receiveModulationModeDetail, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tDMChannelCableLength=tDMChannelCableLength, transmitDataRate=transmitDataRate, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, tFTPServerInternetAddressType=tFTPServerInternetAddressType, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receivePowerLinked=receivePowerLinked, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, phyControl=phyControl, configuration=configuration, cableDiagPair2Distance=cableDiagPair2Distance, transmitDataRateLinked=transmitDataRateLinked, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, incompatibleRegulatoryBands=incompatibleRegulatoryBands, erroredSeconds=erroredSeconds, dSCPManagementPriority=dSCPManagementPriority, rangeLinked=rangeLinked, aAAControl=aAAControl, cableDiagPair3Results=cableDiagPair3Results, tDMEnabledChannels=tDMEnabledChannels, maximumNumberOfSlaves=maximumNumberOfSlaves, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, unavailableSeconds=unavailableSeconds, cableDiagnosticsWarning=cableDiagnosticsWarning, channelBandwidth=channelBandwidth, dNSServerTableNumber=dNSServerTableNumber, dNSServerTable=dNSServerTable, remoteMACAddressLinked=remoteMACAddressLinked, iPv6PrefixLength=iPv6PrefixLength, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerPortNumber=tFTPServerPortNumber, dataBridgingStatusLinked=dataBridgingStatusLinked, remoteInternetAddressLinked=remoteInternetAddressLinked, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, localPacketFiltering=localPacketFiltering, hTTPSAccessEnabled=hTTPSAccessEnabled, mABProtocolVLANPriority=mABProtocolVLANPriority, tempPcb=tempPcb, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, aAAControlGroup=aAAControlGroup, tDMInterfaceStatus=tDMInterfaceStatus, antennaGain=antennaGain, ptmp=ptmp, transmitChannel=transmitChannel, sNMPTrapTable=sNMPTrapTable, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseEncryption=licenseEncryption, iPVersion=iPVersion, tDMConfigurationMismatch=tDMConfigurationMismatch, ptpCompliance=ptpCompliance, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, lowestTDMModulationMode=lowestTDMModulationMode, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseTLSRekey=licenseTLSRekey, transparentClock=transparentClock)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", deviceMSN=deviceMSN, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, pubStatsGroup=pubStatsGroup, mainPSUPortAllocation=mainPSUPortAllocation, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, portAllocationMismatch=portAllocationMismatch, sFPPortStatusTrap=sFPPortStatusTrap, cableLoss=cableLoss, licenseGroupAccess=licenseGroupAccess, licenseGroup=licenseGroup, receiveModulationModeLinked=receiveModulationModeLinked, auxPortStatusTrap=auxPortStatusTrap, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, rawReceivePower=rawReceivePower, auxPortQLTx=auxPortQLTx, remoteUnitNameLinked=remoteUnitNameLinked, tDMChannelLineCode=tDMChannelLineCode, signalStrengthRatio=signalStrengthRatio, regulatoryBandTrap=regulatoryBandTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, installArmStateTrap=installArmStateTrap, softwareVersion=softwareVersion, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseHCMPSupport=licenseHCMPSupport, cableDiagPair4Distance=cableDiagPair4Distance, managementPortWirelessDownAlert=managementPortWirelessDownAlert, aggregateDataRateLinked=aggregateDataRateLinked, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, receiveChannel=receiveChannel, wirelessLinkAvailability=wirelessLinkAvailability, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, licenseInstancedTableEntry=licenseInstancedTableEntry, syncETracking=syncETracking, frequencyVariant=frequencyVariant, dfsGroup=dfsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, phyInstancedStatusTable=phyInstancedStatusTable, tDDSynchronizationMode=tDDSynchronizationMode, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mABMaintenanceLevel=mABMaintenanceLevel, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, remoteInternetAddressType=remoteInternetAddressType, secondarySoftwareVersion=secondarySoftwareVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mainPSUPortStatus=mainPSUPortStatus, transparentClockPort=transparentClockPort, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, pubStats=pubStats, sMTPServerInternetAddressType=sMTPServerInternetAddressType, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, range=range, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseIPv6Support=licenseIPv6Support, transmitterChannels=transmitterChannels)
