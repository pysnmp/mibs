...
Integer32, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, iso, Counter32, Unsigned32, Gauge32, MibIdentifier, NotificationType, Bits, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "iso", "Counter32", "Unsigned32", "Gauge32", "MibIdentifier", "NotificationType", "Bits", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, authorizationControlTableNumber=authorizationControlTableNumber, alarmsGroup=alarmsGroup, iPv6GatewayAddress=iPv6GatewayAddress, transmitFreqMHz=transmitFreqMHz, pubInstancedStatsTable=pubInstancedStatsTable, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNMPEnabledTraps=sNMPEnabledTraps, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receiveFreqKHz=receiveFreqKHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerTable=sNTPServerTable, syslogState=syslogState, ptpGroups=ptpGroups, tdmTableNumber=tdmTableNumber, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, useVLANForMABProtocol=useVLANForMABProtocol, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseCountry=licenseCountry, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, auxPortAllocation=auxPortAllocation, wirelessLinkStatus=wirelessLinkStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, remoteMACAddressLinked=remoteMACAddressLinked, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, vectorErrorLinked=vectorErrorLinked, userTable=userTable, transmitChannel=transmitChannel, nIDULanPortStatus=nIDULanPortStatus, cableDiagPair4Results=cableDiagPair4Results, phyControl=phyControl, userTableNumber=userTableNumber, dfs=dfs, sMTPEnabledMessages=sMTPEnabledMessages, ptpTrapPrefix=ptpTrapPrefix, configurationInstancedTableEntry=configurationInstancedTableEntry, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, rangingMode=rangingMode, linkModeOptimization=linkModeOptimization, sFPPortDisabledWarning=sFPPortDisabledWarning, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPPortNumber=sNMPPortNumber, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, configurationInstancedTable=configurationInstancedTable, tDMConfigurationMismatch=tDMConfigurationMismatch, tFTPServerPortNumber=tFTPServerPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataBridgingStatusLinked=dataBridgingStatusLinked, installStatusLinked=installStatusLinked, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, packetsToInternalStack=packetsToInternalStack, sNTPSync=sNTPSync, wirelessLinkAvailability=wirelessLinkAvailability, dataPortWirelessDownAlert=dataPortWirelessDownAlert, cableDiagPair3Results=cableDiagPair3Results, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, aggregateDataRate=aggregateDataRate, tdmTableIndex=tdmTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, auxPortStatus=auxPortStatus, auxPortAcceptedQLRx=auxPortAcceptedQLRx, dNSServerInternetAddress=dNSServerInternetAddress, remoteUnitName=remoteUnitName, reset=reset, userPassword=userPassword, mainPSUPortAllocation=mainPSUPortAllocation, ethernetStatisticsTable=ethernetStatisticsTable, mainPSUPortSSMTx=mainPSUPortSSMTx, authorizationControlGroup=authorizationControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, aAAControl=aAAControl, installArmStateTrap=installArmStateTrap, rangeLinked=rangeLinked, telnetAccessEnabled=telnetAccessEnabled, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tDMChannelStatus=tDMChannelStatus, siteName=siteName, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, userRole=userRole, routerProtocols=routerProtocols, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, versionsGroup=versionsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, apcGroup=apcGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, phyControlInstancedTable=phyControlInstancedTable, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, installStatus=installStatus, ptpTraps=ptpTraps, secureModeAlarm=secureModeAlarm, sMTPServerPortNumber=sMTPServerPortNumber, licenseBandwidthCap=licenseBandwidthCap, sFPPortStatusTrap=sFPPortStatusTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tFTPServerInternetAddress=tFTPServerInternetAddress, systemReset=systemReset, dataPortPauseFrames=dataPortPauseFrames, rawReceivePower=rawReceivePower, auxPortSSMTx=auxPortSSMTx, dfsMeans=dfsMeans, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, mABHoldoffPeriod=mABHoldoffPeriod, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, tempPcb=tempPcb, routerProtocolsGroup=routerProtocolsGroup, dfsTable=dfsTable, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerRetries=sNTPServerRetries, mABProtocolVLANPriority=mABProtocolVLANPriority, mainPSUPortQLTx=mainPSUPortQLTx, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, receiveDataRateLinked=receiveDataRateLinked, unitIdentificationGroup=unitIdentificationGroup, receivePowerLinked=receivePowerLinked, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, blacklistRMEnabled=blacklistRMEnabled, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, targetRange=targetRange, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, searchStateLinked=searchStateLinked, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sNTPServerTableEntry=sNTPServerTableEntry, installationMode=installationMode, mgmtInstancedTable=mgmtInstancedTable, sNTPServerPortNumber=sNTPServerPortNumber, syncETracking=syncETracking, masterSlaveMode=masterSlaveMode, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, sFPError=sFPError, sNTPLastSync=sNTPLastSync, receiveDataRate=receiveDataRate, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, supplementary=supplementary, syslogClient=syslogClient, syslogStateTrap=syslogStateTrap, enableTransmission=enableTransmission, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licenseInstancedTable=licenseInstancedTable, licenseGroupAccess=licenseGroupAccess, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, auxPortSyncERxStatus=auxPortSyncERxStatus, whitelistRMEnabled=whitelistRMEnabled, remoteInternetAddressLinked=remoteInternetAddressLinked, syslogControl=syslogControl, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, mABState=mABState, mgmtInstancedTableIndex=mgmtInstancedTableIndex, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, licenseSecurityLevel=licenseSecurityLevel, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, alarmInstancedTable=alarmInstancedTable, tDDControl=tDDControl, maximumTransmitPower=maximumTransmitPower, ethernetGroup=ethernetGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, phyInstancedStatusTable=phyInstancedStatusTable, sNTPSyncTrap=sNTPSyncTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, cableDiagPair2Results=cableDiagPair2Results, signalStrengthRatio=signalStrengthRatio, linkModeOptimizationMismatch=linkModeOptimizationMismatch, daylightSaving=daylightSaving, capacityVariantMismatchTrap=capacityVariantMismatchTrap, receivePower=receivePower, timeZone=timeZone, bridgeGroup=bridgeGroup, licenseIPv6Support=licenseIPv6Support, licenseGasGroup=licenseGasGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, remoteUnitNameLinked=remoteUnitNameLinked, encryptionGroup=encryptionGroup, productVariant=productVariant, tFTPClient=tFTPClient, maxLinkRangeExceeded=maxLinkRangeExceeded, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenseSFPPortSupport=licenseSFPPortSupport, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, l2CPPriorityTable=l2CPPriorityTable, dNS=dNS, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDSynchronizationStatus=tDDSynchronizationStatus, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, dfsTableNumber=dfsTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, iPVersion=iPVersion, licenseIssueNumber=licenseIssueNumber, transmitModulationModeLinked=transmitModulationModeLinked, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tdmTable=tdmTable, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, cableDiagnostics=cableDiagnostics, remoteInternetAddress=remoteInternetAddress, cableDiagPair2Distance=cableDiagPair2Distance, transmitFreqKHz=transmitFreqKHz, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, altitude=altitude, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, channelChangeTrap=channelChangeTrap, portAllocationMismatchLinked=portAllocationMismatchLinked, sNTPServerStatus=sNTPServerStatus, cableDiagnosticsControl=cableDiagnosticsControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableDiagnosticsPorts=cableDiagnosticsPorts, dNSServerInternetAddressType=dNSServerInternetAddressType, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, regulatoryBand=regulatoryBand, deviceMACAddress=deviceMACAddress, dNSResolver=dNSResolver, wirelessOutEthernetOctets=wirelessOutEthernetOctets, secondarySoftwareVersion=secondarySoftwareVersion, encryptionAlgorithm=encryptionAlgorithm, cambium=cambium, txMABFrames=txMABFrames, portAllocationMismatch=portAllocationMismatch, ethernetPriorityTable=ethernetPriorityTable, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mgmtInstancedTableNumber=mgmtInstancedTableNumber, subnetMask=subnetMask, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, lbtDetectedTrap=lbtDetectedTrap, authorizationControlTableIndex=authorizationControlTableIndex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, groupID=groupID, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dfsTableIndex=dfsTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNMPTrapTable=sNMPTrapTable, sNTPServerInternetAddress=sNTPServerInternetAddress, whitelistRMMacAddress=whitelistRMMacAddress, sFPPortQLRx=sFPPortQLRx, remoteInternetAddressType=remoteInternetAddressType, transmitPowerLinked=transmitPowerLinked, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, secureModeAlarmTrap=secureModeAlarmTrap, transparentClockPort=transparentClockPort, sFPPortAutoMdix=sFPPortAutoMdix, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, ethernetInstancedTable=ethernetInstancedTable, managementGroup=managementGroup, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sNTPPollInterval=sNTPPollInterval, alarmInstancedTableEntry=alarmInstancedTableEntry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, lowestDataModulationMode=lowestDataModulationMode, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sFPPortAllocation=sFPPortAllocation, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseInstancedTableIndex=licenseInstancedTableIndex, maximumNumberOfSlaves=maximumNumberOfSlaves, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, snmpControlGroup=snmpControlGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, syncETrackingState=syncETrackingState, ethernet=ethernet, sNTPServerTimeout=sNTPServerTimeout, cableDiagPair4Distance=cableDiagPair4Distance, versions=versions, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, linkLoss=linkLoss, targetMACAddress=targetMACAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, smtp=smtp, signalStrengthRatioLinked=signalStrengthRatioLinked, sFPPortStatus=sFPPortStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, softwareVersion=softwareVersion, tDMInterfaceControl=tDMInterfaceControl, cableDiagPair3Distance=cableDiagPair3Distance, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, userName=userName, licenseVersion=licenseVersion, sFPPortAutoNegotiation=sFPPortAutoNegotiation, frequencyVariant=frequencyVariant, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, hTTPSPortNumber=hTTPSPortNumber, transmitDataRate=transmitDataRate, dSCPManagementPriority=dSCPManagementPriority, transparentClock=transparentClock, installStatusTrap=installStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, sFPErrorTrap=sFPErrorTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitIdentification=unitIdentification, eIRP=eIRP, ethernetStatisticsDataSource=ethernetStatisticsDataSource, longitude=longitude, gatewayIPAddress=gatewayIPAddress, mABMaintenanceLevel=mABMaintenanceLevel, hCMPLinkSymmetry=hCMPLinkSymmetry, capacityVariantMismatch=capacityVariantMismatch, antennaSelection=antennaSelection, alarms=alarms, supplementaryGroup=supplementaryGroup, pubStatsGroup=pubStatsGroup, vLANManagementVID=vLANManagementVID, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, pubStats=pubStats, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, management=management, qOSPriorityScheme=qOSPriorityScheme, phyStatus=phyStatus, transparentClockVLAN=transparentClockVLAN, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sntp=sntp, unitOutOfCalibration=unitOutOfCalibration, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, cableDiagPair1Results=cableDiagPair1Results, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cableLoss=cableLoss, tDMGroup=tDMGroup, deviceMSN=deviceMSN, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, txColorCode=txColorCode, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, unavailableSeconds=unavailableSeconds, transmitPower=transmitPower, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, accessMethod=accessMethod, sNMPv3Enable=sNMPv3Enable, erroredSeconds=erroredSeconds, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, licenseHCMPSupport=licenseHCMPSupport, sMTPEmailAlert=sMTPEmailAlert, dfsGroup=dfsGroup, bootVersion=bootVersion, apc=apc, sMTPServerInternetAddressType=sMTPServerInternetAddressType, antennaGain=antennaGain, receiveModulationMode=receiveModulationMode, mainPSUPortQLRx=mainPSUPortQLRx, sNMPTrapTableEntry=sNMPTrapTableEntry, dNSServerTableNumber=dNSServerTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, latitude=latitude, byteErrorRatioLinked=byteErrorRatioLinked, localPacketFiltering=localPacketFiltering, transparentClockVID=transparentClockVID, channelBandwidth=channelBandwidth, dataBridgingStatus=dataBridgingStatus, sNMPTrapVersion=sNMPTrapVersion, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remoteMACAddress=remoteMACAddress, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vectorError=vectorError, sFPPortSyncERxStatus=sFPPortSyncERxStatus, subbandLowestFrequency=subbandLowestFrequency, licenseCapacity=licenseCapacity, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, rxColorCode=rxColorCode, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sFPPortSSMTx=sFPPortSSMTx, licenseTrialPeriod=licenseTrialPeriod, syslogClientTrap=syslogClientTrap, cableDiagPair1Distance=cableDiagPair1Distance, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseOOBManagementSupport=licenseOOBManagementSupport, authorizationControl=authorizationControl, mPLSTCPriorityTable=mPLSTCPriorityTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, auxPortStatusTrap=auxPortStatusTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, wirelessOutAllOctets=wirelessOutAllOctets, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, authorizationMethod=authorizationMethod, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, extendedSpectrumScanning=extendedSpectrumScanning, sNMPTrapTableNumber=sNMPTrapTableNumber, tDMInterfaceStatus=tDMInterfaceStatus, userEnabled=userEnabled, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, iPv6PrefixLength=iPv6PrefixLength, incompatibleMasterAndSlave=incompatibleMasterAndSlave, aggregateDataRateLinked=aggregateDataRateLinked, iPDSCPPriorityTable=iPDSCPPriorityTable, configuration=configuration, syncESlavePort=syncESlavePort, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDM=tDM, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mABTransmissionInterval=mABTransmissionInterval, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, phyControlInstancedTableIndex=phyControlInstancedTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mABNominalTransmitCapacity=mABNominalTransmitCapacity, unitName=unitName, hTTPPortNumber=hTTPPortNumber, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sNMPCommunityString=sNMPCommunityString, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, userTableEntry=userTableEntry, vLANManagementPriority=vLANManagementPriority, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sntpGroup=sntpGroup, mainPSUPortStatusTrap=mainPSUPortStatusTrap, PYSNMP_MODULE_ID=cambium, ptp=ptp, wirelessTopology=wirelessTopology, lowestTDMModulationMode=lowestTDMModulationMode, installArmState=installArmState, licenseEncryption=licenseEncryption, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, packetsFromInternalStack=packetsFromInternalStack, aAAControlGroup=aAAControlGroup, mABNominalModulationMode=mABNominalModulationMode, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseTLSRekey=licenseTLSRekey, encryption=encryption, byteErrorRatio=byteErrorRatio, configurationInstancedTableIndex=configurationInstancedTableIndex, tDDControlGroup=tDDControlGroup, rawReceivePowerLinked=rawReceivePowerLinked, alarmInstancedTableIndex=alarmInstancedTableIndex, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, syncEEquipmentClock=syncEEquipmentClock, phyStatusGroup=phyStatusGroup, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseSyncESupport=licenseSyncESupport, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, resetGroup=resetGroup, ethernetInstancedTableNumber=ethernetInstancedTableNumber, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, searchState=searchState, syslogControlGroup=syslogControlGroup, notificationsGroup=notificationsGroup, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, productName=productName, licenseIEEE1588Support=licenseIEEE1588Support, alarmInstancedTableNumber=alarmInstancedTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, tDMChannelLineCode=tDMChannelLineCode, bridge=bridge, configurationGroup=configurationGroup, systemClock=systemClock, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkName=linkName, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseUnitSerialNumber=licenseUnitSerialNumber, dataBridgingStatusAlarm=dataBridgingStatusAlarm, auxPortQLRx=auxPortQLRx, tdmTableEntry=tdmTableEntry, dNSServerTableIndex=dNSServerTableIndex, ptmp=ptmp, ptp670=ptp670, deviceESN=deviceESN, tDMEnabledChannels=tDMEnabledChannels, licenseInstancedTableEntry=licenseInstancedTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, dNSPrimaryServer=dNSPrimaryServer, hCMPMaximumLinkRange=hCMPMaximumLinkRange, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfsPeaks=dfsPeaks, sFPPortQLTx=sFPPortQLTx, license=license, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, receiveModulationModeLinked=receiveModulationModeLinked, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", telnetPortNumber=telnetPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseTDDSyncSupport=licenseTDDSyncSupport, transmitModulationMode=transmitModulationMode, dNSServerTable=dNSServerTable, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, receiveFreqMHz=receiveFreqMHz, auxPortQLTx=auxPortQLTx, dataBridgingAvailability=dataBridgingAvailability, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, snmpControl=snmpControl, hardwareVersion=hardwareVersion, smtpGroup=smtpGroup, licenseInstancedTableNumber=licenseInstancedTableNumber, capacityVariantMismatchLinked=capacityVariantMismatchLinked, userTableIndex=userTableIndex, mABProtocolVID=mABProtocolVID, dfsTableEntry=dfsTableEntry, configurationInstancedTableNumber=configurationInstancedTableNumber, licenseRARSupport=licenseRARSupport, authorizationControlTable=authorizationControlTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, authorizationControlTableEntry=authorizationControlTableEntry, linkSymmetry=linkSymmetry, severelyErroredSeconds=severelyErroredSeconds, range=range, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, licenseMaxLinkRange=licenseMaxLinkRange, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, regulatoryBandTrap=regulatoryBandTrap, subbandHighestFrequency=subbandHighestFrequency, receiveChannel=receiveChannel, dNSGroup=dNSGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPv6Address=iPv6Address, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, hTTPAccessEnabled=hTTPAccessEnabled, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, transmitDataRateLinked=transmitDataRateLinked, mainPSUPortStatus=mainPSUPortStatus, dNSServerPortNumber=dNSServerPortNumber, licenseGroup=licenseGroup, sNTPState=sNTPState, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, iPv4Address=iPv4Address, ethernetInstancedTableEntry=ethernetInstancedTableEntry, ptpCompliance=ptpCompliance, blacklistRMMacAddress=blacklistRMMacAddress, dNSServerTableEntry=dNSServerTableEntry, linkLossLinked=linkLossLinked, wirelessOutOctets=wirelessOutOctets, tDMChannelCableLength=tDMChannelCableLength, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitterChannels=transmitterChannels, tDMChannelLoopback=tDMChannelLoopback, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, phyControlGroup=phyControlGroup)
