...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", l2CPPriorityTable=l2CPPriorityTable, dNSServerTableEntry=dNSServerTableEntry, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userPassword=userPassword, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogClientTrap=syslogClientTrap, auxPortAllocation=auxPortAllocation, nIDULanPortStatusTrap=nIDULanPortStatusTrap, dNSPrimaryServer=dNSPrimaryServer, auxPortDisabledWarning=auxPortDisabledWarning, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseSecurityLevel=licenseSecurityLevel, maxLinkRangeExceeded=maxLinkRangeExceeded, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, dfsTable=dfsTable, hTTPAccessEnabled=hTTPAccessEnabled, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPv6PrefixLength=iPv6PrefixLength, frequencyVariant=frequencyVariant, ethernet=ethernet, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, transmitFreqKHz=transmitFreqKHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, wirelessLinkStatusLinked=wirelessLinkStatusLinked, latitude=latitude, bridgeGroup=bridgeGroup, eIRP=eIRP, mABProtocolVLANPriority=mABProtocolVLANPriority, encryption=encryption, packetsToInternalStack=packetsToInternalStack, ptpTrapPrefix=ptpTrapPrefix, hTTPSPortNumber=hTTPSPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, channelBandwidth=channelBandwidth, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, transmitModulationMode=transmitModulationMode, lowestTDMModulationMode=lowestTDMModulationMode, dataPortPauseFrames=dataPortPauseFrames, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, subnetMask=subnetMask, tdmTableEntry=tdmTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerStatus=sNTPServerStatus, sNTPServerTable=sNTPServerTable, deviceMSN=deviceMSN, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDMEnabledChannels=tDMEnabledChannels, authorizationControlTableNumber=authorizationControlTableNumber, ethernetInstancedTableEntry=ethernetInstancedTableEntry, dfsMeans=dfsMeans, authorizationControlGroup=authorizationControlGroup, tDDSynchronizationMode=tDDSynchronizationMode, erroredSeconds=erroredSeconds, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, transmitModulationModeLinked=transmitModulationModeLinked, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, vectorError=vectorError, capacityVariantMismatch=capacityVariantMismatch, licenseGroupAccess=licenseGroupAccess, ptpCompliance=ptpCompliance, tFTPServerPortNumber=tFTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rangingMode=rangingMode, transmitterChannels=transmitterChannels, dfsTableIndex=dfsTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, dNSServerTable=dNSServerTable, ethernetStatisticsTable=ethernetStatisticsTable, syncESlavePort=syncESlavePort, auxPortSSMTx=auxPortSSMTx, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPollInterval=sNTPPollInterval, auxPortQLTx=auxPortQLTx, productVariant=productVariant, transparentClockPort=transparentClockPort, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, targetMACAddress=targetMACAddress, mgmtInstancedTableEntry=mgmtInstancedTableEntry, receiveModulationMode=receiveModulationMode, regulatoryBandTrap=regulatoryBandTrap, tempPcb=tempPcb, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sntpGroup=sntpGroup, phyControlInstancedTableEntry=phyControlInstancedTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, portAllocationMismatchTrap=portAllocationMismatchTrap, iPVersion=iPVersion, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, cableDiagnosticsControl=cableDiagnosticsControl, cableDiagnosticsGroup=cableDiagnosticsGroup, sFPPortQLTx=sFPPortQLTx, mABNominalModulationMode=mABNominalModulationMode, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, transmitPowerLinked=transmitPowerLinked, tdmTableNumber=tdmTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, useVLANForMABProtocol=useVLANForMABProtocol, licenseOOBManagementSupport=licenseOOBManagementSupport, mainPSUPortSSMTx=mainPSUPortSSMTx, blacklistRMEnabled=blacklistRMEnabled, authorizationControlTableIndex=authorizationControlTableIndex, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseEncryption=licenseEncryption, sFPPortStatusTrap=sFPPortStatusTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, qOSPriorityScheme=qOSPriorityScheme, pubStatsGroup=pubStatsGroup, reset=reset, syncETrackingState=syncETrackingState, longitude=longitude, ethernetPriorityTableEntry=ethernetPriorityTableEntry, cableDiagPair4Results=cableDiagPair4Results, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, alarmInstancedTable=alarmInstancedTable, remoteUnitName=remoteUnitName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sFPPortStatus=sFPPortStatus, sNMPv3Enable=sNMPv3Enable, ptp=ptp, sNTPServerRetries=sNTPServerRetries, portAllocationMismatch=portAllocationMismatch, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerTimeout=sNTPServerTimeout, notificationsGroup=notificationsGroup, syncETracking=syncETracking, wirelessOutOctets=wirelessOutOctets, mABState=mABState, sNTPSync=sNTPSync, mABTransmissionInterval=mABTransmissionInterval, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, cableDiagPair1Distance=cableDiagPair1Distance, versions=versions, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, dNSServerTableIndex=dNSServerTableIndex, userTableIndex=userTableIndex, supplementaryGroup=supplementaryGroup, hardwareVersion=hardwareVersion, linkSymmetry=linkSymmetry, txMABFrames=txMABFrames, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, rxColorCode=rxColorCode, dNSServerTableNumber=dNSServerTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, licenseInstancedTableIndex=licenseInstancedTableIndex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, transmitDataRateLinked=transmitDataRateLinked, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapVersion=sNMPTrapVersion, linkLossLinked=linkLossLinked, userName=userName, configurationInstancedTable=configurationInstancedTable, configuration=configuration, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, antennaSelection=antennaSelection, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, authorizationControlTableEntry=authorizationControlTableEntry, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, routerProtocols=routerProtocols, aggregateDataRate=aggregateDataRate, routerProtocolsGroup=routerProtocolsGroup, tFTPClient=tFTPClient, sNMPCommunityString=sNMPCommunityString, lbtDetectedTrap=lbtDetectedTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, userTable=userTable, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, bridge=bridge, accessMethod=accessMethod, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, phyControl=phyControl, licenseInstancedTableEntry=licenseInstancedTableEntry, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, syslogClient=syslogClient, tDM=tDM, softwareVersion=softwareVersion, dataBridgingAvailability=dataBridgingAvailability, mainPSUPortAutoMdix=mainPSUPortAutoMdix, portAllocationMismatchLinked=portAllocationMismatchLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tDMChannelCableLength=tDMChannelCableLength, syslogControlGroup=syslogControlGroup, packetsFromInternalStack=packetsFromInternalStack, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, phyInstancedStatusTable=phyInstancedStatusTable, remoteInternetAddressType=remoteInternetAddressType, licenseGroup=licenseGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, iPv6GatewayAddress=iPv6GatewayAddress, mainPSUPortQLTx=mainPSUPortQLTx, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sNTPState=sNTPState, alarmInstancedTableIndex=alarmInstancedTableIndex, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, capacityVariantMismatchTrap=capacityVariantMismatchTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, searchStateLinked=searchStateLinked, unitIdentificationGroup=unitIdentificationGroup, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, phyStatusGroup=phyStatusGroup, receiveChannel=receiveChannel, licenseGasGroup=licenseGasGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, sFPPortSSMTx=sFPPortSSMTx, ethernetStatisticsDataSource=ethernetStatisticsDataSource, extendedSpectrumScanning=extendedSpectrumScanning, alarmsGroup=alarmsGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vectorErrorLinked=vectorErrorLinked, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteMACAddress=remoteMACAddress, subbandHighestFrequency=subbandHighestFrequency, sFPPortSyncERxStatus=sFPPortSyncERxStatus, localPacketFiltering=localPacketFiltering, licenseIssueNumber=licenseIssueNumber, altitude=altitude, tdmTable=tdmTable, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, syslogState=syslogState)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", unitOutOfCalibration=unitOutOfCalibration, sFPErrorTrap=sFPErrorTrap, pubStats=pubStats, installStatus=installStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPEnabledMessages=sMTPEnabledMessages, deviceESN=deviceESN, apcGroup=apcGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, lowestDataModulationMode=lowestDataModulationMode, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, unitName=unitName, managementGroup=managementGroup, groupID=groupID, dNSResolver=dNSResolver, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, linkName=linkName, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyStatus=phyStatus, signalStrengthRatio=signalStrengthRatio, authorizationControlTable=authorizationControlTable, remoteUnitNameLinked=remoteUnitNameLinked, userTableEntry=userTableEntry, txColorCode=txColorCode, sFPError=sFPError, aAAControl=aAAControl, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cableDiagPair3Results=cableDiagPair3Results, auxPortStatus=auxPortStatus, byteErrorRatioLinked=byteErrorRatioLinked, licenseInstancedTableNumber=licenseInstancedTableNumber, management=management, phyControlInstancedTable=phyControlInstancedTable, tdmTableIndex=tdmTableIndex, sNMPTrapTable=sNMPTrapTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfsTableNumber=dfsTableNumber, cableDiagPair2Distance=cableDiagPair2Distance, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, deviceMACAddress=deviceMACAddress, cableDiagnostics=cableDiagnostics, licenseTLSRekey=licenseTLSRekey, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, iPv6Address=iPv6Address, ethernetPriorityTable=ethernetPriorityTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, timeZone=timeZone, sFPPortQLRx=sFPPortQLRx, ptp670=ptp670, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, ptpGroups=ptpGroups, tDDControl=tDDControl, dNSServerPortNumber=dNSServerPortNumber, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, userTableNumber=userTableNumber, supplementary=supplementary, licenseHCMPSupport=licenseHCMPSupport, tDMChannelStatusTrap=tDMChannelStatusTrap, dNSServerInternetAddressType=dNSServerInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseCapacity=licenseCapacity, sNMPPortNumber=sNMPPortNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, apc=apc, cableDiagPair2Results=cableDiagPair2Results, licenseCountry=licenseCountry, installArmStateTrap=installArmStateTrap, authorizationControl=authorizationControl, sMTPServerPortNumber=sMTPServerPortNumber, alarms=alarms, tDMInterfaceControl=tDMInterfaceControl, transmitChannel=transmitChannel, syslogControl=syslogControl, receiveModulationModeDetail=receiveModulationModeDetail, tDMInterfaceStatus=tDMInterfaceStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveFreqMHz=receiveFreqMHz, mainPSUPortQLRx=mainPSUPortQLRx, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteInternetAddress=remoteInternetAddress, tDDControlGroup=tDDControlGroup, secureModeAlarmTrap=secureModeAlarmTrap, linkLoss=linkLoss, sFPPortAutoMdix=sFPPortAutoMdix, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, nIDULanPortStatus=nIDULanPortStatus, searchState=searchState, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, masterSlaveMode=masterSlaveMode, tDMConfigurationMismatch=tDMConfigurationMismatch, severelyErroredSeconds=severelyErroredSeconds, licenseVersion=licenseVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, rawReceivePowerLinked=rawReceivePowerLinked, transparentClockVLAN=transparentClockVLAN, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dfsGroup=dfsGroup, authorizationMethod=authorizationMethod, installArmState=installArmState, receiveModulationModeLinked=receiveModulationModeLinked, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNTPLastSync=sNTPLastSync, regulatoryBand=regulatoryBand, licenseSFPPortSupport=licenseSFPPortSupport, iPv4Address=iPv4Address, systemClock=systemClock, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cableDiagPair1Results=cableDiagPair1Results, transparentClock=transparentClock, mainPSUPortStatusTrap=mainPSUPortStatusTrap, ptpTraps=ptpTraps, dSCPManagementPriority=dSCPManagementPriority, remoteMACAddressLinked=remoteMACAddressLinked, sntp=sntp, iPDSCPPriorityTable=iPDSCPPriorityTable, aggregateDataRateLinked=aggregateDataRateLinked, whitelistRMMacAddress=whitelistRMMacAddress, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, dNSGroup=dNSGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseIEEE1588Support=licenseIEEE1588Support, ethernetGroup=ethernetGroup, sFPPortAllocation=sFPPortAllocation, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, cableDiagPair3Distance=cableDiagPair3Distance, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseBandwidthCap=licenseBandwidthCap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, capacityVariantMismatchLinked=capacityVariantMismatchLinked, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dataBridgingStatus=dataBridgingStatus, telnetPortNumber=telnetPortNumber, mABHoldoffPeriod=mABHoldoffPeriod, blacklistRMMacAddress=blacklistRMMacAddress, sNTPServerTableEntry=sNTPServerTableEntry, smtpGroup=smtpGroup, cambium=cambium, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, alarmInstancedTableNumber=alarmInstancedTableNumber, alarmInstancedTableEntry=alarmInstancedTableEntry, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sNTPServerTableIndex=sNTPServerTableIndex, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tDMChannelLineCode=tDMChannelLineCode, mABMaintenanceLevel=mABMaintenanceLevel, sNTPPrimaryServer=sNTPPrimaryServer, transmitDataRate=transmitDataRate, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitFreqMHz=transmitFreqMHz, siteName=siteName, transparentClockVID=transparentClockVID, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseMaxLinkRange=licenseMaxLinkRange, configurationInstancedTableEntry=configurationInstancedTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, daylightSaving=daylightSaving, linkModeOptimization=linkModeOptimization, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mgmtInstancedTable=mgmtInstancedTable, licenseInstancedTable=licenseInstancedTable, ptmp=ptmp, receivePower=receivePower, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sNTPServerPortNumber=sNTPServerPortNumber, licenseRARSupport=licenseRARSupport, enableTransmission=enableTransmission, configurationInstancedTableNumber=configurationInstancedTableNumber, sNTPSyncTrap=sNTPSyncTrap, mainPSUPortStatus=mainPSUPortStatus, encryptionAlgorithm=encryptionAlgorithm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, maximumTransmitPower=maximumTransmitPower, unavailableSeconds=unavailableSeconds, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, encryptionGroup=encryptionGroup, bootVersion=bootVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, syncEEquipmentClock=syncEEquipmentClock, sFPPortDisabledWarning=sFPPortDisabledWarning, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dNS=dNS, vLANManagementPriority=vLANManagementPriority, tDMGroup=tDMGroup, wirelessTopology=wirelessTopology, configurationGroup=configurationGroup, subbandLowestFrequency=subbandLowestFrequency, tDMChannelLoopback=tDMChannelLoopback, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, auxPortQLRx=auxPortQLRx, targetRange=targetRange, PYSNMP_MODULE_ID=cambium, systemReset=systemReset, vLANManagementVID=vLANManagementVID, sNMPEnabledTraps=sNMPEnabledTraps, transmitPower=transmitPower, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, hTTPPortNumber=hTTPPortNumber, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, hCMPMaximumLinkRange=hCMPMaximumLinkRange, ethernetInstancedTableIndex=ethernetInstancedTableIndex, auxPortStatusTrap=auxPortStatusTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, channelChangeTrap=channelChangeTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, noWirelessChannelAvailable=noWirelessChannelAvailable, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tDDSynchronizationStatus=tDDSynchronizationStatus, dataBridgingStatusLinked=dataBridgingStatusLinked, maximumNumberOfSlaves=maximumNumberOfSlaves, dNSServerInternetAddress=dNSServerInternetAddress, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, range=range, unitIdentification=unitIdentification, wirelessLinkAvailability=wirelessLinkAvailability, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, snmpControlGroup=snmpControlGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, mgmtInstancedTableIndex=mgmtInstancedTableIndex, installationMode=installationMode, signalStrengthRatioLinked=signalStrengthRatioLinked, rangeLinked=rangeLinked, installStatusLinked=installStatusLinked, phyControlInstancedTableIndex=phyControlInstancedTableIndex, receivePowerLinked=receivePowerLinked, syslogStateTrap=syslogStateTrap, mgmtInstancedTableNumber=mgmtInstancedTableNumber, versionsGroup=versionsGroup, rawReceivePower=rawReceivePower, antennaGain=antennaGain, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mABProtocolVID=mABProtocolVID, ethernetInstancedTable=ethernetInstancedTable, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userEnabled=userEnabled, receiveDataRate=receiveDataRate, userRole=userRole, dfs=dfs, license=license, dfsPeaks=dfsPeaks, hCMPLinkSymmetry=hCMPLinkSymmetry, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, receiveFreqKHz=receiveFreqKHz, pubInstancedStatsTable=pubInstancedStatsTable, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseTrialPeriod=licenseTrialPeriod, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, secureModeAlarm=secureModeAlarm, smtp=smtp, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, auxPortAcceptedQLRx=auxPortAcceptedQLRx, tDMChannelStatus=tDMChannelStatus, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, configurationInstancedTableIndex=configurationInstancedTableIndex, wirelessOutAllOctets=wirelessOutAllOctets, aAAControlGroup=aAAControlGroup, dfsTableEntry=dfsTableEntry, productName=productName, sMTPServerInternetAddress=sMTPServerInternetAddress, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, snmpControl=snmpControl, licenseIPv6Support=licenseIPv6Support, telnetAccessEnabled=telnetAccessEnabled, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, byteErrorRatio=byteErrorRatio, whitelistRMEnabled=whitelistRMEnabled, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseSyncESupport=licenseSyncESupport, installStatusTrap=installStatusTrap, phyControlGroup=phyControlGroup, resetGroup=resetGroup, receiveDataRateLinked=receiveDataRateLinked, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked)
