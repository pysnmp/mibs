...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, aAAControlGroup=aAAControlGroup, syncETrackingState=syncETrackingState, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataBridgingStatusLinked=dataBridgingStatusLinked, transmitDataRate=transmitDataRate, mABProtocolVID=mABProtocolVID, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, rangingMode=rangingMode, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNTPPrimaryServer=sNTPPrimaryServer, sntpGroup=sntpGroup, pubStatsGroup=pubStatsGroup, configurationInstancedTableNumber=configurationInstancedTableNumber, phyControl=phyControl, cableDiagnosticsWarning=cableDiagnosticsWarning, alarmInstancedTableIndex=alarmInstancedTableIndex, wirelessLinkStatus=wirelessLinkStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, configuration=configuration, tDDControl=tDDControl, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sFPPortQLRx=sFPPortQLRx, telnetAccessEnabled=telnetAccessEnabled, unitIdentificationGroup=unitIdentificationGroup, sMTPEnabledMessages=sMTPEnabledMessages, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, hCMPLinkSymmetry=hCMPLinkSymmetry, mABTransmissionInterval=mABTransmissionInterval, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNTPLastSync=sNTPLastSync, licenseInstancedTableNumber=licenseInstancedTableNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, phyControlGroup=phyControlGroup, sNTPServerTable=sNTPServerTable, licenseSecurityLevel=licenseSecurityLevel, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, managementGroup=managementGroup, routerProtocolsGroup=routerProtocolsGroup, mainPSUPortQLRx=mainPSUPortQLRx, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapVersion=sNMPTrapVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tempPcb=tempPcb, bridge=bridge, syncESlavePort=syncESlavePort, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sNTPSyncTrap=sNTPSyncTrap, installStatusLinked=installStatusLinked, cableDiagPair4Results=cableDiagPair4Results, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPv6GatewayAddress=iPv6GatewayAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, dNSServerInternetAddress=dNSServerInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, reset=reset, sNMPCommunityString=sNMPCommunityString, unavailableSeconds=unavailableSeconds, hTTPPortNumber=hTTPPortNumber, mainPSUPortSSMTx=mainPSUPortSSMTx, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, capacityVariantMismatch=capacityVariantMismatch, severelyErroredSeconds=severelyErroredSeconds, phyControlInstancedTable=phyControlInstancedTable, unitOutOfCalibration=unitOutOfCalibration, apc=apc, auxPortSyncERxStatus=auxPortSyncERxStatus, authorizationControlTableEntry=authorizationControlTableEntry, syncEEquipmentClock=syncEEquipmentClock, channelChangeTrap=channelChangeTrap, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, tdmTable=tdmTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sFPPortSSMTx=sFPPortSSMTx, transmitPowerLinked=transmitPowerLinked, transparentClockVID=transparentClockVID, vectorErrorLinked=vectorErrorLinked, iPVersion=iPVersion, dNSServerTable=dNSServerTable, cableDiagnostics=cableDiagnostics, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, lbtDetectedTrap=lbtDetectedTrap, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNTPState=sNTPState, dataPortPauseFrames=dataPortPauseFrames, versions=versions, tDMChannelLoopback=tDMChannelLoopback, productVariant=productVariant, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, ptp670=ptp670, targetRange=targetRange, enableTransmission=enableTransmission, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, useVLANForMABProtocol=useVLANForMABProtocol, subbandLowestFrequency=subbandLowestFrequency, receivePowerLinked=receivePowerLinked, tDMGroup=tDMGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, portAllocationMismatch=portAllocationMismatch, licenseInstancedTableIndex=licenseInstancedTableIndex, maximumNumberOfSlaves=maximumNumberOfSlaves, receivePower=receivePower, sFPPortAllocation=sFPPortAllocation, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, ethernetStatisticsTable=ethernetStatisticsTable, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, cableDiagPair1Results=cableDiagPair1Results, dataBridgingStatus=dataBridgingStatus, transmitFreqMHz=transmitFreqMHz, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, auxPortSSMTx=auxPortSSMTx, licenseGroupAccess=licenseGroupAccess, unitName=unitName, userRole=userRole, licenseTrialPeriod=licenseTrialPeriod, ethernetInstancedTable=ethernetInstancedTable, receiveDataRateLinked=receiveDataRateLinked, channelBandwidth=channelBandwidth, ptmp=ptmp, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, dfsTable=dfsTable, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, phyStatus=phyStatus, linkModeOptimization=linkModeOptimization, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, versionsGroup=versionsGroup, phyControlInstancedTableEntry=phyControlInstancedTableEntry, antennaGain=antennaGain, blacklistRMMacAddress=blacklistRMMacAddress, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, masterSlaveMode=masterSlaveMode, dfsPeaks=dfsPeaks, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, encryptionGroup=encryptionGroup, ptpCompliance=ptpCompliance, licenseInstancedTableEntry=licenseInstancedTableEntry, pubInstancedStatsTable=pubInstancedStatsTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sFPErrorTrap=sFPErrorTrap, transparentClockPort=transparentClockPort, txColorCode=txColorCode, auxPortStatusTrap=auxPortStatusTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tDMChannelCableLength=tDMChannelCableLength, latitude=latitude, wirelessOutEthernetOctets=wirelessOutEthernetOctets, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, cableDiagnosticsControl=cableDiagnosticsControl, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, alarms=alarms, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, aAAControl=aAAControl, dfsTableEntry=dfsTableEntry, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, ethernetInstancedTableEntry=ethernetInstancedTableEntry, longitude=longitude, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, authorizationMethod=authorizationMethod, pubStats=pubStats, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagPair4Distance=cableDiagPair4Distance, frequencyVariant=frequencyVariant, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, receiveFreqKHz=receiveFreqKHz, authorizationControl=authorizationControl, remoteUnitNameLinked=remoteUnitNameLinked, iPDSCPPriorityTable=iPDSCPPriorityTable, regulatoryBand=regulatoryBand, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dataBridgingStatusAlarm=dataBridgingStatusAlarm, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, installStatusTrap=installStatusTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, syslogStateTrap=syslogStateTrap, productName=productName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, rawReceivePowerLinked=rawReceivePowerLinked, receiveDataRate=receiveDataRate, mainPSUPortQLTx=mainPSUPortQLTx, wirelessLinkAvailability=wirelessLinkAvailability, secureModeAlarmTrap=secureModeAlarmTrap, txMABFrames=txMABFrames, range=range, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sNTPServerTimeout=sNTPServerTimeout, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseGasGroup=licenseGasGroup, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ptpTraps=ptpTraps, snmpControl=snmpControl, PYSNMP_MODULE_ID=cambium, tDDSynchronizationMode=tDDSynchronizationMode, tDMChannelStatus=tDMChannelStatus, syslogControl=syslogControl, sFPPortQLTx=sFPPortQLTx, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tDM=tDM, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, linkLossLinked=linkLossLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, packetsToInternalStack=packetsToInternalStack, userEnabled=userEnabled, sNMPEnabledTraps=sNMPEnabledTraps, secondarySoftwareVersion=secondarySoftwareVersion, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, deviceMACAddress=deviceMACAddress, dfsTableIndex=dfsTableIndex, ethernetPriorityTable=ethernetPriorityTable, rxColorCode=rxColorCode, tdmTableNumber=tdmTableNumber, tDMInterfaceStatus=tDMInterfaceStatus, byteErrorRatio=byteErrorRatio, hCMPMaximumLinkRange=hCMPMaximumLinkRange, bootVersion=bootVersion, wirelessLinkStatusLinked=wirelessLinkStatusLinked, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, ethernet=ethernet, dfsGroup=dfsGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, notificationsGroup=notificationsGroup, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, phyInstancedStatusTable=phyInstancedStatusTable, cableDiagPair2Results=cableDiagPair2Results, syncETracking=syncETracking, deviceMSN=deviceMSN, whitelistRMMacAddress=whitelistRMMacAddress, licenseTDDSyncSupport=licenseTDDSyncSupport, management=management, transmitPower=transmitPower, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, gatewayIPAddress=gatewayIPAddress, ptp=ptp, mgmtInstancedTableNumber=mgmtInstancedTableNumber, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dNSPrimaryServer=dNSPrimaryServer, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, bridgeGroup=bridgeGroup, syslogState=syslogState, byteErrorRatioLinked=byteErrorRatioLinked, sNTPServerTableIndex=sNTPServerTableIndex, ethernetGroup=ethernetGroup, userTable=userTable, configurationInstancedTableEntry=configurationInstancedTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mgmtInstancedTable=mgmtInstancedTable, iPv4Address=iPv4Address, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, authorizationControlTableNumber=authorizationControlTableNumber, nIDULanPortAutoMdix=nIDULanPortAutoMdix, iPv6PrefixLength=iPv6PrefixLength, mABNominalModulationMode=mABNominalModulationMode, portAllocationMismatchTrap=portAllocationMismatchTrap, authorizationControlGroup=authorizationControlGroup, vLANManagementPriority=vLANManagementPriority, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, erroredSeconds=erroredSeconds, tDDControlGroup=tDDControlGroup, dNSServerInternetAddressType=dNSServerInternetAddressType, alarmInstancedTableEntry=alarmInstancedTableEntry, userName=userName, remoteInternetAddressType=remoteInternetAddressType, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseIPv6Support=licenseIPv6Support, userTableEntry=userTableEntry, subnetMask=subnetMask, receiveModulationModeLinked=receiveModulationModeLinked, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseTLSRekey=licenseTLSRekey, installArmState=installArmState, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, cambium=cambium, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTableEntry=sNTPServerTableEntry, dNS=dNS, encryptionAlgorithm=encryptionAlgorithm, secureModeAlarm=secureModeAlarm, linkLoss=linkLoss, mgmtInstancedTableIndex=mgmtInstancedTableIndex, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, licenseCountry=licenseCountry, mABState=mABState, sntp=sntp, remoteInternetAddress=remoteInternetAddress, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, syslogClientTrap=syslogClientTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sFPError=sFPError, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, eIRP=eIRP, daylightSaving=daylightSaving, remoteMACAddressLinked=remoteMACAddressLinked, sNTPServerRetries=sNTPServerRetries, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, accessMethod=accessMethod, snmpControlGroup=snmpControlGroup, whitelistRMEnabled=whitelistRMEnabled, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteMACAddress=remoteMACAddress, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, syslogClient=syslogClient, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, alarmInstancedTableNumber=alarmInstancedTableNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, phyControlInstancedTableIndex=phyControlInstancedTableIndex, localPacketFiltering=localPacketFiltering, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, l2CPPriorityTable=l2CPPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPClient=tFTPClient, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, routerProtocols=routerProtocols, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sNMPPortNumber=sNMPPortNumber, sFPPortStatus=sFPPortStatus, alarmInstancedTable=alarmInstancedTable, aggregateDataRateLinked=aggregateDataRateLinked, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, wirelessTopology=wirelessTopology, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, transmitDataRateLinked=transmitDataRateLinked, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, dNSServerTableIndex=dNSServerTableIndex, transmitFreqKHz=transmitFreqKHz, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, tDMChannelStatusTrap=tDMChannelStatusTrap, remoteUnitName=remoteUnitName, licenseIssueNumber=licenseIssueNumber, searchState=searchState, mainPSUPortAllocation=mainPSUPortAllocation, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, auxPortQLRx=auxPortQLRx, auxPortQLTx=auxPortQLTx, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, portAllocationMismatchLinked=portAllocationMismatchLinked, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, licenseSFPPortSupport=licenseSFPPortSupport, siteName=siteName, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, iPv6Address=iPv6Address, softwareVersion=softwareVersion, dNSGroup=dNSGroup, cableLoss=cableLoss, alarmsGroup=alarmsGroup, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, altitude=altitude, cableDiagPair2Distance=cableDiagPair2Distance, sFPPortStatusTrap=sFPPortStatusTrap, rangeLinked=rangeLinked, sNMPTrapTable=sNMPTrapTable, maxLinkRangeExceeded=maxLinkRangeExceeded, license=license, licenseRARSupport=licenseRARSupport, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, vLANManagementVID=vLANManagementVID, antennaSelection=antennaSelection, configurationInstancedTable=configurationInstancedTable, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitModulationModeLinked=transmitModulationModeLinked, resetGroup=resetGroup, sFPPortAutoMdix=sFPPortAutoMdix, lowestTDMModulationMode=lowestTDMModulationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, mABMaintenanceLevel=mABMaintenanceLevel, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, linkSymmetry=linkSymmetry, timeZone=timeZone, sNTPServerStatus=sNTPServerStatus, maximumTransmitPower=maximumTransmitPower, ethernetStatisticsDataSource=ethernetStatisticsDataSource, supplementaryGroup=supplementaryGroup, systemClock=systemClock, tdmTableIndex=tdmTableIndex, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, nIDULanPortStatus=nIDULanPortStatus, tDMEnabledChannels=tDMEnabledChannels, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, packetsFromInternalStack=packetsFromInternalStack, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, installationMode=installationMode, smtp=smtp, authorizationControlTable=authorizationControlTable, sNTPPollInterval=sNTPPollInterval, userTableNumber=userTableNumber, auxPortAllocation=auxPortAllocation, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, dfsTableNumber=dfsTableNumber, licenseIEEE1588Support=licenseIEEE1588Support, extendedSpectrumScanning=extendedSpectrumScanning, transmitModulationMode=transmitModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mABNominalTransmitCapacity=mABNominalTransmitCapacity, transmitterChannels=transmitterChannels, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, signalStrengthRatio=signalStrengthRatio, deviceESN=deviceESN, regulatoryBandTrap=regulatoryBandTrap, signalStrengthRatioLinked=signalStrengthRatioLinked, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseSyncESupport=licenseSyncESupport, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, dfs=dfs, dfsMeans=dfsMeans, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userPassword=userPassword, authorizationControlTableIndex=authorizationControlTableIndex, sNTPSync=sNTPSync, dataBridgingAvailability=dataBridgingAvailability, userTableIndex=userTableIndex, auxPortStatus=auxPortStatus, wirelessOutAllOctets=wirelessOutAllOctets, phyControlInstancedTableNumber=phyControlInstancedTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseGroup=licenseGroup, tDMInterfaceControl=tDMInterfaceControl, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, supplementary=supplementary, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, wirelessOutOctets=wirelessOutOctets, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, aggregateDataRate=aggregateDataRate, cableDiagPair1Distance=cableDiagPair1Distance, groupID=groupID, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, licenseBandwidthCap=licenseBandwidthCap, licenseVersion=licenseVersion, receiveChannel=receiveChannel, mABProtocolVLANPriority=mABProtocolVLANPriority, dNSServerTableNumber=dNSServerTableNumber, installArmStateTrap=installArmStateTrap, licenseMaxLinkRange=licenseMaxLinkRange, cableDiagPair3Distance=cableDiagPair3Distance, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseCapacity=licenseCapacity, encryption=encryption, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseHCMPSupport=licenseHCMPSupport, searchStateLinked=searchStateLinked, systemReset=systemReset, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTable=mPLSTCPriorityTable, apcGroup=apcGroup, transparentClock=transparentClock, syslogControlGroup=syslogControlGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDMConfigurationMismatch=tDMConfigurationMismatch, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPv3Enable=sNMPv3Enable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, qOSPriorityScheme=qOSPriorityScheme, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, ptpTrapPrefix=ptpTrapPrefix, mainPSUPortStatus=mainPSUPortStatus, unitIdentification=unitIdentification, telnetPortNumber=telnetPortNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, tdmTableEntry=tdmTableEntry, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, transmitChannel=transmitChannel, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, blacklistRMEnabled=blacklistRMEnabled, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, receiveModulationMode=receiveModulationMode, installStatus=installStatus, receiveFreqMHz=receiveFreqMHz, mABHoldoffPeriod=mABHoldoffPeriod, capacityVariantMismatchTrap=capacityVariantMismatchTrap, configurationGroup=configurationGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, transparentClockVLAN=transparentClockVLAN, oOBPriorityQueueMapping=oOBPriorityQueueMapping, smtpGroup=smtpGroup, tDMChannelLineCode=tDMChannelLineCode, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sFPPortDisabledWarning=sFPPortDisabledWarning, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, cableDiagPair3Results=cableDiagPair3Results, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, phyStatusGroup=phyStatusGroup, subbandHighestFrequency=subbandHighestFrequency, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dNSServerPortNumber=dNSServerPortNumber, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, licenseInstancedTable=licenseInstancedTable, targetMACAddress=targetMACAddress, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, dNSResolver=dNSResolver, ptpGroups=ptpGroups, lowestDataModulationMode=lowestDataModulationMode, rawReceivePower=rawReceivePower, vectorError=vectorError, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, hTTPAccessEnabled=hTTPAccessEnabled, dNSServerTableEntry=dNSServerTableEntry, linkName=linkName, dSCPManagementPriority=dSCPManagementPriority, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseEncryption=licenseEncryption, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber)
