...
ModuleIdentity, Counter64, Bits, TimeTicks, Counter32, NotificationType, enterprises, ObjectIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Bits", "TimeTicks", "Counter32", "NotificationType", "enterprises", "ObjectIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", noWirelessChannelAvailable=noWirelessChannelAvailable, cableDiagPair3Results=cableDiagPair3Results, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, auxPortStatusTrap=auxPortStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseVersion=licenseVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementGroup=managementGroup, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, tdmTableIndex=tdmTableIndex, apc=apc, transmitFreqMHz=transmitFreqMHz, alarmInstancedTableIndex=alarmInstancedTableIndex, userTable=userTable, tDDControlGroup=tDDControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, phyControlInstancedTableEntry=phyControlInstancedTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, tFTPServerPortNumber=tFTPServerPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, cableDiagPair1Distance=cableDiagPair1Distance, routerProtocols=routerProtocols, hTTPSAccessEnabled=hTTPSAccessEnabled, antennaSelection=antennaSelection, vLANManagementVID=vLANManagementVID, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerTable=sNTPServerTable, receiveModulationModeDetail=receiveModulationModeDetail, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userName=userName, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNTPServerRetries=sNTPServerRetries, aggregateDataRate=aggregateDataRate, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTable=sNMPTrapTable, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mABTransmissionInterval=mABTransmissionInterval, dfs=dfs, accessMethod=accessMethod, transparentClockVLAN=transparentClockVLAN, transparentClockPort=transparentClockPort, receiveFreqKHz=receiveFreqKHz, dSCPManagementPriority=dSCPManagementPriority, productVariant=productVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, secondarySoftwareVersion=secondarySoftwareVersion, pubStats=pubStats, mainPSUPortAllocation=mainPSUPortAllocation, configurationInstancedTableIndex=configurationInstancedTableIndex, remoteInternetAddressType=remoteInternetAddressType, targetRange=targetRange, frequencyVariant=frequencyVariant, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableEntry=userTableEntry, mABHoldoffPeriod=mABHoldoffPeriod, sNTPServerTimeout=sNTPServerTimeout, userTableNumber=userTableNumber, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessOutAllOctets=wirelessOutAllOctets, encryption=encryption, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, packetsToInternalStack=packetsToInternalStack, transparentClock=transparentClock, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tDDSynchronizationMode=tDDSynchronizationMode, auxPortAcceptedQLRx=auxPortAcceptedQLRx, licenseSyncESupport=licenseSyncESupport, dNSServerInternetAddress=dNSServerInternetAddress, capacityVariantMismatch=capacityVariantMismatch, licenseSFPPortSupport=licenseSFPPortSupport, extendedSpectrumScanning=extendedSpectrumScanning, tdmTableEntry=tdmTableEntry, remoteUnitNameLinked=remoteUnitNameLinked, tDMGroup=tDMGroup, sNTPServerStatus=sNTPServerStatus, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, licenseOOBManagementSupport=licenseOOBManagementSupport, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sFPPortStatusTrap=sFPPortStatusTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, ethernetInstancedTableIndex=ethernetInstancedTableIndex, whitelistRMEnabled=whitelistRMEnabled, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tDMChannelLineCode=tDMChannelLineCode, management=management, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, maximumTransmitPower=maximumTransmitPower, licenseSecurityLevel=licenseSecurityLevel, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, lowestDataModulationMode=lowestDataModulationMode, iPVersion=iPVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, smtp=smtp, useVLANForMABProtocol=useVLANForMABProtocol, phyControlGroup=phyControlGroup, tdmTableNumber=tdmTableNumber, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sFPPortSyncERxStatus=sFPPortSyncERxStatus, dNSServerTable=dNSServerTable, transmitDataRateLinked=transmitDataRateLinked, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, unitOutOfCalibration=unitOutOfCalibration, licenseGroupAccess=licenseGroupAccess, systemClock=systemClock, byteErrorRatioLinked=byteErrorRatioLinked, license=license, versions=versions, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, rawReceivePower=rawReceivePower, linkSymmetry=linkSymmetry, wirelessLinkStatus=wirelessLinkStatus, sFPPortDisabledWarning=sFPPortDisabledWarning, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, syslogControlGroup=syslogControlGroup, deviceMACAddress=deviceMACAddress, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sFPError=sFPError, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tDMChannelLoopback=tDMChannelLoopback, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, receiveFreqMHz=receiveFreqMHz, mABProtocolVID=mABProtocolVID, installStatusTrap=installStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseCountry=licenseCountry, deviceMSN=deviceMSN, remoteMACAddressLinked=remoteMACAddressLinked, longitude=longitude, iPv6Address=iPv6Address, phyControl=phyControl, authorizationControlTableNumber=authorizationControlTableNumber, remoteMACAddress=remoteMACAddress, groupID=groupID, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, oOBPriorityQueueMapping=oOBPriorityQueueMapping, hardwareVersion=hardwareVersion, cableDiagPair4Results=cableDiagPair4Results, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNMPv3Enable=sNMPv3Enable, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sNTPPollInterval=sNTPPollInterval, authorizationControlGroup=authorizationControlGroup, rxColorCode=rxColorCode, rawReceivePowerLinked=rawReceivePowerLinked, hTTPAccessEnabled=hTTPAccessEnabled, ptpCompliance=ptpCompliance, syslogStateTrap=syslogStateTrap, targetMACAddress=targetMACAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, linkLoss=linkLoss, unitName=unitName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, portAllocationMismatchTrap=portAllocationMismatchTrap, secureModeAlarm=secureModeAlarm, nIDULanPortStatus=nIDULanPortStatus, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, encryptionGroup=encryptionGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, eIRP=eIRP, receivePowerLinked=receivePowerLinked, phyControlInstancedTable=phyControlInstancedTable, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, aggregateDataRateLinked=aggregateDataRateLinked, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sNTPServerTableNumber=sNTPServerTableNumber, blacklistRMEnabled=blacklistRMEnabled, cableLoss=cableLoss, systemReset=systemReset, tDMChannelCableLength=tDMChannelCableLength, licenseIssueNumber=licenseIssueNumber, ptp670=ptp670, configurationInstancedTableEntry=configurationInstancedTableEntry, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, txMABFrames=txMABFrames, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, reset=reset, mainPSUPortSSMTx=mainPSUPortSSMTx, unavailableSeconds=unavailableSeconds, receiveChannel=receiveChannel, licenseInstancedTableIndex=licenseInstancedTableIndex, mgmtInstancedTable=mgmtInstancedTable, dfsTableEntry=dfsTableEntry, transmitModulationMode=transmitModulationMode, bootVersion=bootVersion, cableDiagPair3Distance=cableDiagPair3Distance, sNTPServerInternetAddressType=sNTPServerInternetAddressType, aAAControl=aAAControl, licenseInstancedTable=licenseInstancedTable, dNS=dNS, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, transmitPower=transmitPower, phyControlInstancedTableNumber=phyControlInstancedTableNumber, dNSServerTableNumber=dNSServerTableNumber, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, linkModeOptimization=linkModeOptimization, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, txColorCode=txColorCode, tFTPClient=tFTPClient, sntpGroup=sntpGroup, sNMPTrapVersion=sNMPTrapVersion, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, auxPortSSMTx=auxPortSSMTx, sNTPServerTableIndex=sNTPServerTableIndex, maxLinkRangeExceeded=maxLinkRangeExceeded, authorizationControlTableEntry=authorizationControlTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, snmpControl=snmpControl, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseUnitSerialNumber=licenseUnitSerialNumber, receiveModulationMode=receiveModulationMode, ptpTraps=ptpTraps, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, configurationGroup=configurationGroup, ethernetStatisticsTable=ethernetStatisticsTable, sMTPEmailAlert=sMTPEmailAlert, dNSPrimaryServer=dNSPrimaryServer, userRole=userRole, sNTPServerInternetAddress=sNTPServerInternetAddress, apcGroup=apcGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transmitDataRate=transmitDataRate, packetsFromInternalStack=packetsFromInternalStack, tDDSynchronizationAlarm=tDDSynchronizationAlarm, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, deviceESN=deviceESN, syncETracking=syncETracking, ethernet=ethernet, authorizationControlTable=authorizationControlTable, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sFPPortStatus=sFPPortStatus, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sNMPEnabledTraps=sNMPEnabledTraps, antennaGain=antennaGain, licenseTDDSyncSupport=licenseTDDSyncSupport, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, aAAControlGroup=aAAControlGroup, resetGroup=resetGroup, userTableIndex=userTableIndex, transmitModulationModeLinked=transmitModulationModeLinked, configurationInstancedTableNumber=configurationInstancedTableNumber, subnetMask=subnetMask, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, linkLossLinked=linkLossLinked, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, subbandLowestFrequency=subbandLowestFrequency, portAllocationMismatch=portAllocationMismatch, dNSServerInternetAddressType=dNSServerInternetAddressType, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installArmState=installArmState, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, syncESlavePort=syncESlavePort, bridgeGroup=bridgeGroup, userPassword=userPassword, range=range, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sFPPortSSMTx=sFPPortSSMTx, licenseInstancedTableEntry=licenseInstancedTableEntry, sntp=sntp, tDMEnabledChannels=tDMEnabledChannels, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseIEEE1588Support=licenseIEEE1588Support, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, siteName=siteName, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseGasGroup=licenseGasGroup, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sFPPortQLTx=sFPPortQLTx, userEnabled=userEnabled, ptpGroups=ptpGroups, authorizationMethod=authorizationMethod, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, ptmp=ptmp, auxPortQLRx=auxPortQLRx, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, cambium=cambium, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ptpTrapPrefix=ptpTrapPrefix, licenseIPv6Support=licenseIPv6Support, ethernetInstancedTable=ethernetInstancedTable, mainPSUPortQLTx=mainPSUPortQLTx, subbandHighestFrequency=subbandHighestFrequency, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitterChannels=transmitterChannels, mABNominalTransmitCapacity=mABNominalTransmitCapacity, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sMTPEnabledMessages=sMTPEnabledMessages, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mABState=mABState, wirelessOutEthernetOctets=wirelessOutEthernetOctets, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sNTPState=sNTPState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPowerLinked=transmitPowerLinked, mABMaintenanceLevel=mABMaintenanceLevel, wirelessLinkStatusLinked=wirelessLinkStatusLinked, cableDiagPair4Distance=cableDiagPair4Distance, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, vectorErrorLinked=vectorErrorLinked, severelyErroredSeconds=severelyErroredSeconds, rangeLinked=rangeLinked, localPacketFiltering=localPacketFiltering, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseTrialPeriod=licenseTrialPeriod, timeZone=timeZone, pubInstancedStatsTable=pubInstancedStatsTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveDataRate=receiveDataRate, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, unitIdentification=unitIdentification, sMTPServerPortNumber=sMTPServerPortNumber, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, auxPortConfigurationMismatch=auxPortConfigurationMismatch, regulatoryBand=regulatoryBand, authorizationControlTableIndex=authorizationControlTableIndex, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableEntry=sNMPTrapTableEntry, dNSServerTableIndex=dNSServerTableIndex, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, tempPcb=tempPcb, syslogControl=syslogControl, cableDiagPair2Distance=cableDiagPair2Distance, telnetPortNumber=telnetPortNumber, dfsGroup=dfsGroup, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dfsTable=dfsTable, altitude=altitude, remoteInternetAddress=remoteInternetAddress, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, authorizationControl=authorizationControl, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, unitIdentificationGroup=unitIdentificationGroup, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, ethernetPriorityTable=ethernetPriorityTable, iPDSCPPriorityTable=iPDSCPPriorityTable, tdmTable=tdmTable, channelBandwidth=channelBandwidth, linkName=linkName, installArmStateTrap=installArmStateTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, auxPortDisabledWarning=auxPortDisabledWarning, lowestTDMModulationMode=lowestTDMModulationMode, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, capacityVariantMismatchLinked=capacityVariantMismatchLinked, supplementary=supplementary, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseTLSRekey=licenseTLSRekey, byteErrorRatio=byteErrorRatio, tDM=tDM, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseInstancedTableNumber=licenseInstancedTableNumber, alarms=alarms, masterSlaveMode=masterSlaveMode, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, syncEEquipmentClock=syncEEquipmentClock, enableTransmission=enableTransmission, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receivePower=receivePower, configuration=configuration, lbtDetectedTrap=lbtDetectedTrap, wirelessTopology=wirelessTopology, signalStrengthRatioLinked=signalStrengthRatioLinked, receiveDataRateLinked=receiveDataRateLinked, syslogState=syslogState, cableDiagnosticsWarning=cableDiagnosticsWarning, sNTPSyncTrap=sNTPSyncTrap, sNTPPrimaryServer=sNTPPrimaryServer, licenseHCMPSupport=licenseHCMPSupport, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseCapacity=licenseCapacity, remoteUnitName=remoteUnitName, alarmsGroup=alarmsGroup, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, searchStateLinked=searchStateLinked, ethernetStatisticsDataSource=ethernetStatisticsDataSource, softwareVersion=softwareVersion, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, phyControlInstancedTableIndex=phyControlInstancedTableIndex, qOSPriorityScheme=qOSPriorityScheme, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, transmitChannel=transmitChannel, auxPortAllocation=auxPortAllocation, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, phyStatusGroup=phyStatusGroup, dfsMeans=dfsMeans, cableDiagnosticsControl=cableDiagnosticsControl, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mainPSUPortQLRx=mainPSUPortQLRx, versionsGroup=versionsGroup, syncETrackingState=syncETrackingState, licenseRARSupport=licenseRARSupport, signalStrengthRatio=signalStrengthRatio, vLANManagementPriority=vLANManagementPriority, ptp=ptp, cableDiagPair1Results=cableDiagPair1Results, ethernetGroup=ethernetGroup, PYSNMP_MODULE_ID=cambium, sFPPortAllocation=sFPPortAllocation, hCMPLinkSymmetry=hCMPLinkSymmetry, installStatus=installStatus, tDMInterfaceStatus=tDMInterfaceStatus, receiveModulationModeLinked=receiveModulationModeLinked, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagnosticsPorts=cableDiagnosticsPorts, dataPortPauseFrames=dataPortPauseFrames, wirelessOutOctets=wirelessOutOctets, maximumNumberOfSlaves=maximumNumberOfSlaves, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, portAllocationMismatchLinked=portAllocationMismatchLinked, licenseGroup=licenseGroup, dataBridgingAvailability=dataBridgingAvailability, cableDiagPair2Results=cableDiagPair2Results, remoteInternetAddressLinked=remoteInternetAddressLinked, gatewayIPAddress=gatewayIPAddress, ethernetInstancedTableNumber=ethernetInstancedTableNumber, tDDControl=tDDControl, dataBridgingStatus=dataBridgingStatus, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseBandwidthCap=licenseBandwidthCap, syslogClientTrap=syslogClientTrap, l2CPPriorityTable=l2CPPriorityTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDMInterfaceControl=tDMInterfaceControl, daylightSaving=daylightSaving, alarmInstancedTable=alarmInstancedTable, hTTPSPortNumber=hTTPSPortNumber, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, phyStatus=phyStatus, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, transmitFreqKHz=transmitFreqKHz, configurationInstancedTable=configurationInstancedTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, alarmInstancedTableEntry=alarmInstancedTableEntry, sNTPSync=sNTPSync, dNSServerPortNumber=dNSServerPortNumber, vectorError=vectorError, auxPortQLTx=auxPortQLTx, regulatoryBandTrap=regulatoryBandTrap, dfsTableNumber=dfsTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, ethernetPriorityTableEntry=ethernetPriorityTableEntry, bridge=bridge, rangingMode=rangingMode, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installationMode=installationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mABNominalModulationMode=mABNominalModulationMode, licenseEncryption=licenseEncryption, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortAutoNegotiation=sFPPortAutoNegotiation, dNSGroup=dNSGroup, tDMChannelStatus=tDMChannelStatus, auxPortStatus=auxPortStatus, mgmtInstancedTableNumber=mgmtInstancedTableNumber, transparentClockVID=transparentClockVID, dfsPeaks=dfsPeaks, iPv4Address=iPv4Address, licenseMaxLinkRange=licenseMaxLinkRange, useVLANForManagementInterfaces=useVLANForManagementInterfaces, nIDULanPortAutoMdix=nIDULanPortAutoMdix, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, encryptionAlgorithm=encryptionAlgorithm, whitelistRMMacAddress=whitelistRMMacAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, erroredSeconds=erroredSeconds, sFPPortAutoMdix=sFPPortAutoMdix, sNTPLastSync=sNTPLastSync, hTTPPortNumber=hTTPPortNumber, dNSResolver=dNSResolver, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ethernetInstancedTableEntry=ethernetInstancedTableEntry, blacklistRMMacAddress=blacklistRMMacAddress, searchState=searchState, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sFPPortQLRx=sFPPortQLRx, dfsTableIndex=dfsTableIndex, routerProtocolsGroup=routerProtocolsGroup, phyInstancedStatusTable=phyInstancedStatusTable, alarmInstancedTableNumber=alarmInstancedTableNumber, capacityVariantMismatchTrap=capacityVariantMismatchTrap, productName=productName, pubStatsGroup=pubStatsGroup, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sFPErrorTrap=sFPErrorTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dNSServerTableEntry=dNSServerTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, supplementaryGroup=supplementaryGroup, mainPSUPortStatus=mainPSUPortStatus, notificationsGroup=notificationsGroup, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sNMPPortNumber=sNMPPortNumber, syslogClient=syslogClient, dataBridgingStatusLinked=dataBridgingStatusLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tDMChannelStatusTrap=tDMChannelStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, latitude=latitude, channelChangeTrap=channelChangeTrap, iPv6PrefixLength=iPv6PrefixLength, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sNMPTrapInternetAddress=sNMPTrapInternetAddress, installStatusLinked=installStatusLinked, sNTPServerPortNumber=sNTPServerPortNumber, cableDiagnostics=cableDiagnostics)
