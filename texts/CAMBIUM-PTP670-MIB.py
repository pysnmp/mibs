...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, PYSNMP_MODULE_ID=cambium, userTableNumber=userTableNumber, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, apcGroup=apcGroup, alarmInstancedTable=alarmInstancedTable, useVLANForMABProtocol=useVLANForMABProtocol, ptp670=ptp670, mABMaintenanceLevel=mABMaintenanceLevel, auxPortStatus=auxPortStatus, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, deviceMACAddress=deviceMACAddress, systemReset=systemReset, sNTPServerTableEntry=sNTPServerTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, severelyErroredSeconds=severelyErroredSeconds, ethernetInstancedTableEntry=ethernetInstancedTableEntry, tDMConfigurationMismatch=tDMConfigurationMismatch, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, userName=userName, signalStrengthRatio=signalStrengthRatio, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, authorizationControlGroup=authorizationControlGroup, tDMChannelCableLength=tDMChannelCableLength, frequencyVariant=frequencyVariant, aggregateDataRate=aggregateDataRate, transmitterChannels=transmitterChannels, cableDiagPair1Distance=cableDiagPair1Distance, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, linkLossLinked=linkLossLinked, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, channelBandwidth=channelBandwidth, tDMChannelStatus=tDMChannelStatus, capacityVariantMismatchLinked=capacityVariantMismatchLinked, unitName=unitName, dataBridgingStatusAlarm=dataBridgingStatusAlarm, tdmTable=tdmTable, licenseInstancedTableIndex=licenseInstancedTableIndex, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, productVariant=productVariant, receiveFreqMHz=receiveFreqMHz, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, tDMChannelLineCode=tDMChannelLineCode, tdmTableEntry=tdmTableEntry, syslogState=syslogState, remoteInternetAddressLinked=remoteInternetAddressLinked, mainPSUPortQLTx=mainPSUPortQLTx, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, maxLinkRangeExceeded=maxLinkRangeExceeded, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tDMInterfaceStatus=tDMInterfaceStatus, cableDiagnosticsWarning=cableDiagnosticsWarning, secureModeAlarmTrap=secureModeAlarmTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, ethernetPriorityTableEntry=ethernetPriorityTableEntry, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, siteName=siteName, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, authorizationControlTableEntry=authorizationControlTableEntry, iPv6Address=iPv6Address, supplementaryGroup=supplementaryGroup, mainPSUPortSSMTx=mainPSUPortSSMTx, sNMPTrapTableIndex=sNMPTrapTableIndex, ptmp=ptmp, ethernetStatisticsTable=ethernetStatisticsTable, licenseGasGroup=licenseGasGroup, dNSServerTableIndex=dNSServerTableIndex, linkModeOptimization=linkModeOptimization, dfsTableEntry=dfsTableEntry, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, cableLoss=cableLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, localPacketFiltering=localPacketFiltering, l2CPPriorityTable=l2CPPriorityTable, phyControl=phyControl, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, configurationInstancedTableEntry=configurationInstancedTableEntry, unavailableSeconds=unavailableSeconds, authorizationControlTable=authorizationControlTable, ethernetPriorityTable=ethernetPriorityTable, iPv6GatewayAddress=iPv6GatewayAddress, licenseMaxLinkRange=licenseMaxLinkRange, regulatoryBand=regulatoryBand, licenseSecurityLevel=licenseSecurityLevel, cableDiagPair4Distance=cableDiagPair4Distance, encryptionGroup=encryptionGroup, sFPPortQLTx=sFPPortQLTx, mABProtocolVID=mABProtocolVID, maximumTransmitPower=maximumTransmitPower, alarmInstancedTableNumber=alarmInstancedTableNumber, extendedSpectrumScanning=extendedSpectrumScanning, sNMPTrapTable=sNMPTrapTable, transparentClockVID=transparentClockVID, tFTPClient=tFTPClient, userPassword=userPassword, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerInternetAddress=tFTPServerInternetAddress, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkName=linkName, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, masterSlaveMode=masterSlaveMode, licenseTrialPeriod=licenseTrialPeriod, cableDiagnosticsResultTable=cableDiagnosticsResultTable, vLANManagementVID=vLANManagementVID, snmpControlGroup=snmpControlGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, phyStatusGroup=phyStatusGroup, transmitModulationModeLinked=transmitModulationModeLinked, routerProtocols=routerProtocols, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sNTPServerTableNumber=sNTPServerTableNumber, nIDULanPortStatusTrap=nIDULanPortStatusTrap, packetsFromInternalStack=packetsFromInternalStack, cableDiagnosticsGroup=cableDiagnosticsGroup, authorizationControlTableIndex=authorizationControlTableIndex, license=license, portAllocationMismatchTrap=portAllocationMismatchTrap, unitOutOfCalibration=unitOutOfCalibration, vectorError=vectorError, groupID=groupID, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, dataBridgingStatusLinked=dataBridgingStatusLinked, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, dNSServerTableEntry=dNSServerTableEntry, configurationInstancedTableNumber=configurationInstancedTableNumber, sMTPEmailAlert=sMTPEmailAlert, transparentClockPort=transparentClockPort, wirelessLinkStatusLinked=wirelessLinkStatusLinked, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, accessMethod=accessMethod, tdmTableNumber=tdmTableNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseIssueNumber=licenseIssueNumber, transmitPowerLinked=transmitPowerLinked, licenseInstancedTable=licenseInstancedTable, hCMPLinkSymmetry=hCMPLinkSymmetry, searchState=searchState, transmitModulationMode=transmitModulationMode, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, regulatoryBandTrap=regulatoryBandTrap, ptpGroups=ptpGroups, productName=productName, cableDiagPair4Results=cableDiagPair4Results, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, antennaSelection=antennaSelection, syncEEquipmentClock=syncEEquipmentClock, sNMPPortNumber=sNMPPortNumber, sFPPortStatus=sFPPortStatus, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, management=management, sFPPortDisabledWarning=sFPPortDisabledWarning, configurationInstancedTable=configurationInstancedTable, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, hCMPMaximumLinkRange=hCMPMaximumLinkRange, qOSPriorityScheme=qOSPriorityScheme, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, wirelessOutEthernetOctets=wirelessOutEthernetOctets, antennaGain=antennaGain, receiveChannel=receiveChannel, byteErrorRatio=byteErrorRatio, remoteInternetAddress=remoteInternetAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, resetGroup=resetGroup, licenseIPv6Support=licenseIPv6Support, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, licenseHCMPSupport=licenseHCMPSupport, sFPErrorTrap=sFPErrorTrap, sFPPortAllocation=sFPPortAllocation, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sNMPv3Enable=sNMPv3Enable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, tDDControlGroup=tDDControlGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, syncESlavePort=syncESlavePort, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseCapacity=licenseCapacity, licenseInstancedTableEntry=licenseInstancedTableEntry, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseRegulatoryBandsList=licenseRegulatoryBandsList, eIRP=eIRP, telnetPortNumber=telnetPortNumber, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, transparentClock=transparentClock, licenseRARSupport=licenseRARSupport, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mainPSUPortAllocation=mainPSUPortAllocation, licenseInstancedTableNumber=licenseInstancedTableNumber, dfsTableNumber=dfsTableNumber, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, ethernetInstancedTable=ethernetInstancedTable, byteErrorRatioLinked=byteErrorRatioLinked, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, latitude=latitude, phyControlGroup=phyControlGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, auxPortStatusTrap=auxPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, range=range, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, bridgeGroup=bridgeGroup, phyControlInstancedTableNumber=phyControlInstancedTableNumber, authorizationMethod=authorizationMethod, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, dfs=dfs, cableDiagnosticsPorts=cableDiagnosticsPorts, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, phyInstancedStatusTable=phyInstancedStatusTable, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseGroupAccess=licenseGroupAccess, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, targetRange=targetRange, blacklistRMEnabled=blacklistRMEnabled, dNSServerInternetAddressType=dNSServerInternetAddressType, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailable=noWirelessChannelAvailable, smtp=smtp, ethernet=ethernet)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", daylightSaving=daylightSaving, sNTPSync=sNTPSync, iPDSCPPriorityTable=iPDSCPPriorityTable, transmitDataRateLinked=transmitDataRateLinked, tDMChannelLoopback=tDMChannelLoopback, cableDiagnostics=cableDiagnostics, dataBridgingAvailability=dataBridgingAvailability, receiveFreqKHz=receiveFreqKHz, mABHoldoffPeriod=mABHoldoffPeriod, userEnabled=userEnabled, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseBandwidthCap=licenseBandwidthCap, alarmsGroup=alarmsGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, phyStatus=phyStatus, hardwareVersion=hardwareVersion, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetGroup=ethernetGroup, deviceESN=deviceESN, mgmtInstancedTableEntry=mgmtInstancedTableEntry, lbtDetectedTrap=lbtDetectedTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ptpTrapPrefix=ptpTrapPrefix, txMABFrames=txMABFrames, mABState=mABState, dNSServerPortNumber=dNSServerPortNumber, sNTPServerTimeout=sNTPServerTimeout, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sFPPortAutoMdix=sFPPortAutoMdix, tDDSynchronizationMode=tDDSynchronizationMode, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, wirelessOutOctets=wirelessOutOctets, configurationInstancedTableIndex=configurationInstancedTableIndex, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sntpGroup=sntpGroup, searchStateLinked=searchStateLinked, iPVersion=iPVersion, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortPauseFrames=dataPortPauseFrames, portAllocationMismatch=portAllocationMismatch, wirelessOutAllOctets=wirelessOutAllOctets, oOBPriorityQueueMapping=oOBPriorityQueueMapping, auxPortAcceptedQLRx=auxPortAcceptedQLRx, licenseSFPPortSupport=licenseSFPPortSupport, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, mABNominalTransmitCapacity=mABNominalTransmitCapacity, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, userRole=userRole, whitelistRMEnabled=whitelistRMEnabled, licenseSyncESupport=licenseSyncESupport, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, receiveModulationModeDetail=receiveModulationModeDetail, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, lowestDataModulationMode=lowestDataModulationMode, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mABTransmissionInterval=mABTransmissionInterval, mainPSUPortStatus=mainPSUPortStatus, sntp=sntp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, timeZone=timeZone, pubStatsGroup=pubStatsGroup, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, installArmState=installArmState, notificationsGroup=notificationsGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sFPError=sFPError, cambium=cambium, supplementary=supplementary, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, transmitFreqMHz=transmitFreqMHz, tDMGroup=tDMGroup, rawReceivePower=rawReceivePower, syslogControlGroup=syslogControlGroup, auxPortQLTx=auxPortQLTx, transmitChannel=transmitChannel, aAAControlGroup=aAAControlGroup, iPv4Address=iPv4Address, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tDMChannelStatusTrap=tDMChannelStatusTrap, alarmInstancedTableIndex=alarmInstancedTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagPair1Results=cableDiagPair1Results, mgmtInstancedTableIndex=mgmtInstancedTableIndex, auxPortConfigurationMismatch=auxPortConfigurationMismatch, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, longitude=longitude, remoteMACAddressLinked=remoteMACAddressLinked, blacklistRMMacAddress=blacklistRMMacAddress, tDM=tDM, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsMeans=dfsMeans, remoteMACAddress=remoteMACAddress, enableTransmission=enableTransmission, rawReceivePowerLinked=rawReceivePowerLinked, tDDSynchronizationAlarm=tDDSynchronizationAlarm, whitelistRMMacAddress=whitelistRMMacAddress, receivePowerLinked=receivePowerLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, transmitFreqKHz=transmitFreqKHz, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, dfsGroup=dfsGroup, versionsGroup=versionsGroup, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, cableDiagPair3Distance=cableDiagPair3Distance, ptp=ptp, capacityVariantMismatch=capacityVariantMismatch, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, syslogClient=syslogClient, tDMEnabledChannels=tDMEnabledChannels, syslogClientTrap=syslogClientTrap, smtpGroup=smtpGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, unitIdentification=unitIdentification, auxPortAllocation=auxPortAllocation, dNSServerTableNumber=dNSServerTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsTable=dfsTable, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, auxPortSSMTx=auxPortSSMTx, tDMInterfaceControl=tDMInterfaceControl, licenseVersion=licenseVersion, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sFPPortQLRx=sFPPortQLRx, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortDisabledWarning=auxPortDisabledWarning, dNSServerTable=dNSServerTable, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mgmtInstancedTableNumber=mgmtInstancedTableNumber, wirelessTopology=wirelessTopology, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, receiveDataRate=receiveDataRate, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, mABNominalModulationMode=mABNominalModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, aggregateDataRateLinked=aggregateDataRateLinked, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, transmitDataRate=transmitDataRate, deviceMSN=deviceMSN, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, alarmInstancedTableEntry=alarmInstancedTableEntry, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, phyControlInstancedTable=phyControlInstancedTable, cableDiagPair2Results=cableDiagPair2Results, ptpCompliance=ptpCompliance, installStatus=installStatus, ptpTraps=ptpTraps, receiveModulationModeLinked=receiveModulationModeLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, syncETrackingState=syncETrackingState, iPv6PrefixLength=iPv6PrefixLength, tdmTableIndex=tdmTableIndex, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, managementGroup=managementGroup, telnetAccessEnabled=telnetAccessEnabled, receivePower=receivePower, transmitPower=transmitPower, tDDControl=tDDControl, versions=versions, licenseOOBManagementSupport=licenseOOBManagementSupport, hTTPPortNumber=hTTPPortNumber, aAAControl=aAAControl, receiveDataRateLinked=receiveDataRateLinked, gatewayIPAddress=gatewayIPAddress, syncETracking=syncETracking, sFPPortSSMTx=sFPPortSSMTx, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPPollInterval=sNTPPollInterval, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, routerProtocolsGroup=routerProtocolsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, alarms=alarms, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, remoteUnitName=remoteUnitName, sNTPServerRetries=sNTPServerRetries, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dNSPrimaryServer=dNSPrimaryServer, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sNTPState=sNTPState, linkLoss=linkLoss, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, encryption=encryption, l2CPPriorityTableIndex=l2CPPriorityTableIndex, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, installStatusLinked=installStatusLinked, receiveModulationMode=receiveModulationMode, authorizationControl=authorizationControl, apc=apc, dfsPeaks=dfsPeaks, installationMode=installationMode, phyControlInstancedTableEntry=phyControlInstancedTableEntry, packetsToInternalStack=packetsToInternalStack, capacityVariantMismatchTrap=capacityVariantMismatchTrap, licenseTLSRekey=licenseTLSRekey, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, altitude=altitude, sNTPPrimaryServer=sNTPPrimaryServer, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, mainPSUPortQLRx=mainPSUPortQLRx, dfsTableIndex=dfsTableIndex, installStatusTrap=installStatusTrap, dNS=dNS, cableDiagnosticsControl=cableDiagnosticsControl, pubInstancedStatsTable=pubInstancedStatsTable, pubStats=pubStats, vectorErrorLinked=vectorErrorLinked, cableDiagPair3Results=cableDiagPair3Results, dNSGroup=dNSGroup, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, systemClock=systemClock, targetMACAddress=targetMACAddress, licenseIEEE1588Support=licenseIEEE1588Support, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, snmpControl=snmpControl, licenseCountry=licenseCountry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseEncryption=licenseEncryption, userTableIndex=userTableIndex, dNSResolver=dNSResolver, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, cableDiagPair2Distance=cableDiagPair2Distance, bootVersion=bootVersion, authorizationControlTableNumber=authorizationControlTableNumber, syslogStateTrap=syslogStateTrap, reset=reset, userTableEntry=userTableEntry, sNTPLastSync=sNTPLastSync, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortStatus=nIDULanPortStatus, secureModeAlarm=secureModeAlarm, subnetMask=subnetMask, sFPPortStatusTrap=sFPPortStatusTrap, tempPcb=tempPcb, subbandLowestFrequency=subbandLowestFrequency, softwareVersion=softwareVersion, auxPortQLRx=auxPortQLRx, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dNSServerInternetAddress=dNSServerInternetAddress, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, remoteInternetAddressType=remoteInternetAddressType, lowestTDMModulationMode=lowestTDMModulationMode, channelChangeTrap=channelChangeTrap, unitIdentificationGroup=unitIdentificationGroup, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sNTPServerStatus=sNTPServerStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, installArmStateTrap=installArmStateTrap, sNTPServerPortNumber=sNTPServerPortNumber, ethernetInstancedTableIndex=ethernetInstancedTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, userTable=userTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, maximumNumberOfSlaves=maximumNumberOfSlaves, syslogControl=syslogControl, rangingMode=rangingMode, dataBridgingStatus=dataBridgingStatus, bridge=bridge, vLANManagementPriority=vLANManagementPriority, configurationGroup=configurationGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseGroup=licenseGroup, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, subbandHighestFrequency=subbandHighestFrequency, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, txColorCode=txColorCode, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, erroredSeconds=erroredSeconds, sFPPortSyncERxStatus=sFPPortSyncERxStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, wirelessLinkStatus=wirelessLinkStatus, portAllocationMismatchLinked=portAllocationMismatchLinked, mainPSUPortStatusTrap=mainPSUPortStatusTrap, transparentClockVLAN=transparentClockVLAN, sNTPSyncTrap=sNTPSyncTrap, hTTPAccessEnabled=hTTPAccessEnabled, incompatibleRegulatoryBands=incompatibleRegulatoryBands, rxColorCode=rxColorCode, remoteUnitNameLinked=remoteUnitNameLinked, configuration=configuration, rangeLinked=rangeLinked, mgmtInstancedTable=mgmtInstancedTable, sNTPServerTable=sNTPServerTable, auxPortSyncERxStatus=auxPortSyncERxStatus, linkSymmetry=linkSymmetry)
