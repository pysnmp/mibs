...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", routerProtocolsGroup=routerProtocolsGroup, sFPPortAllocation=sFPPortAllocation, tDMConfigurationMismatch=tDMConfigurationMismatch, sNMPTrapVersion=sNMPTrapVersion, installArmState=installArmState, dNSServerTableNumber=dNSServerTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, cableLoss=cableLoss, receiveModulationMode=receiveModulationMode, unitIdentification=unitIdentification, linkLoss=linkLoss, transparentClockVID=transparentClockVID, nIDULanPortAutoMdix=nIDULanPortAutoMdix, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseSyncESupport=licenseSyncESupport, apc=apc, apcGroup=apcGroup, sNMPPortNumber=sNMPPortNumber, phyControlInstancedTableEntry=phyControlInstancedTableEntry, ptp=ptp, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataBridgingAvailability=dataBridgingAvailability, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, frequencyVariant=frequencyVariant, ethernetPriorityTableNumber=ethernetPriorityTableNumber, linkSymmetry=linkSymmetry, authorizationControlTableEntry=authorizationControlTableEntry, remoteMACAddressLinked=remoteMACAddressLinked, cableDiagPair1Results=cableDiagPair1Results, lowestTDMModulationMode=lowestTDMModulationMode, iPv6Address=iPv6Address, receiveChannel=receiveChannel, aAAControlGroup=aAAControlGroup, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, dfsTable=dfsTable, maximumNumberOfSlaves=maximumNumberOfSlaves, tFTPServerInternetAddress=tFTPServerInternetAddress, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, qOSPriorityScheme=qOSPriorityScheme, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, alarmsGroup=alarmsGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, encryptionAlgorithm=encryptionAlgorithm, licenseMaxLinkRange=licenseMaxLinkRange, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, tDDControl=tDDControl, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, hCMPMaximumLinkRange=hCMPMaximumLinkRange, searchStateLinked=searchStateLinked, hCMPLinkSymmetry=hCMPLinkSymmetry, unavailableSeconds=unavailableSeconds, aAAControl=aAAControl, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mainPSUPortStatus=mainPSUPortStatus, configurationInstancedTableIndex=configurationInstancedTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, mainPSUPortAllocation=mainPSUPortAllocation, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseInstancedTable=licenseInstancedTable, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dNSServerInternetAddressType=dNSServerInternetAddressType, remoteInternetAddress=remoteInternetAddress, licenseInstancedTableNumber=licenseInstancedTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, nIDULanPortStatusTrap=nIDULanPortStatusTrap, alarms=alarms, phyInstancedStatusTable=phyInstancedStatusTable, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, antennaSelection=antennaSelection, tDMEnabledChannels=tDMEnabledChannels, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, secondarySoftwareVersion=secondarySoftwareVersion, blacklistRMEnabled=blacklistRMEnabled, aggregateDataRateLinked=aggregateDataRateLinked, vLANManagementVID=vLANManagementVID, installStatusTrap=installStatusTrap, encryption=encryption, notificationsGroup=notificationsGroup, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, ptpTraps=ptpTraps, vLANManagementPriority=vLANManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementaryGroup=supplementaryGroup, mABHoldoffPeriod=mABHoldoffPeriod, latitude=latitude, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, iPv6GatewayAddress=iPv6GatewayAddress, altitude=altitude, whitelistRMMacAddress=whitelistRMMacAddress, capacityVariantMismatch=capacityVariantMismatch, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, syncEEquipmentClock=syncEEquipmentClock, syncETrackingState=syncETrackingState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, groupID=groupID, dNSGroup=dNSGroup, licenseGroup=licenseGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, linkModeOptimization=linkModeOptimization, ptpTrapPrefix=ptpTrapPrefix, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseRARSupport=licenseRARSupport, secureModeAlarmTrap=secureModeAlarmTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPVersion=iPVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, deviceMACAddress=deviceMACAddress, transparentClockPort=transparentClockPort, licenseInstancedTableEntry=licenseInstancedTableEntry, mainPSUPortQLRx=mainPSUPortQLRx, tDMChannelLineCode=tDMChannelLineCode, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, managementGroup=managementGroup, channelBandwidth=channelBandwidth, tFTPServerInternetAddressType=tFTPServerInternetAddressType, channelChangeTrap=channelChangeTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, regulatoryBand=regulatoryBand, authorizationControlTableIndex=authorizationControlTableIndex, cableDiagnosticsControl=cableDiagnosticsControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, regulatoryBandTrap=regulatoryBandTrap, receivePower=receivePower, signalStrengthRatioLinked=signalStrengthRatioLinked, transmitPower=transmitPower, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, supplementary=supplementary, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTable=userTable, linkLossLinked=linkLossLinked, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transmitterChannels=transmitterChannels, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mABTransmissionInterval=mABTransmissionInterval, sntp=sntp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptpGroups=ptpGroups, deviceMSN=deviceMSN, pubStatsGroup=pubStatsGroup, dataBridgingStatus=dataBridgingStatus, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, range=range, dNSServerTableEntry=dNSServerTableEntry, wirelessOutAllOctets=wirelessOutAllOctets, transparentClockVLAN=transparentClockVLAN, authorizationControlGroup=authorizationControlGroup, tDDSynchronizationMode=tDDSynchronizationMode, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, authorizationMethod=authorizationMethod, sFPPortStatus=sFPPortStatus, userEnabled=userEnabled, remoteUnitNameLinked=remoteUnitNameLinked, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dSCPManagementPriority=dSCPManagementPriority, wirelessLinkStatus=wirelessLinkStatus, remoteInternetAddressLinked=remoteInternetAddressLinked, rxColorCode=rxColorCode, management=management, noWirelessChannelAvailable=noWirelessChannelAvailable, blacklistRMMacAddress=blacklistRMMacAddress, reset=reset, useVLANForMABProtocol=useVLANForMABProtocol, ptp670=ptp670, authorizationControl=authorizationControl, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, syslogClient=syslogClient, longitude=longitude, phyStatus=phyStatus, enableTransmission=enableTransmission, searchState=searchState, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mABMaintenanceLevel=mABMaintenanceLevel, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tDDControlGroup=tDDControlGroup, wirelessOutEthernetOctets=wirelessOutEthernetOctets, tFTPClient=tFTPClient, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, receiveFreqMHz=receiveFreqMHz, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, capacityVariantMismatchTrap=capacityVariantMismatchTrap, receiveFreqKHz=receiveFreqKHz, masterSlaveMode=masterSlaveMode, transmitFreqMHz=transmitFreqMHz, licenseIPv6Support=licenseIPv6Support, cableDiagPair3Results=cableDiagPair3Results, alarmInstancedTable=alarmInstancedTable, cableDiagnostics=cableDiagnostics, configurationInstancedTableNumber=configurationInstancedTableNumber, sFPPortStatusTrap=sFPPortStatusTrap, portAllocationMismatchTrap=portAllocationMismatchTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, subbandHighestFrequency=subbandHighestFrequency, syslogClientTrap=syslogClientTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, siteName=siteName, sNTPState=sNTPState, installStatusLinked=installStatusLinked, smtpGroup=smtpGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, auxPortDisabledWarning=auxPortDisabledWarning, cableDiagnosticsWarning=cableDiagnosticsWarning, daylightSaving=daylightSaving, licenseHCMPSupport=licenseHCMPSupport, telnetPortNumber=telnetPortNumber, byteErrorRatio=byteErrorRatio, smtp=smtp, cableDiagnosticsGroup=cableDiagnosticsGroup, receivePowerLinked=receivePowerLinked, userRole=userRole, vectorError=vectorError, tDDSynchronizationStatus=tDDSynchronizationStatus, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, ethernetPriorityTable=ethernetPriorityTable, capacityVariantMismatchLinked=capacityVariantMismatchLinked, dNSPrimaryServer=dNSPrimaryServer, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, transmitPowerLinked=transmitPowerLinked, licenseCountry=licenseCountry, ethernetInstancedTable=ethernetInstancedTable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDMGroup=tDMGroup, remoteUnitName=remoteUnitName, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mgmtInstancedTableIndex=mgmtInstancedTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rawReceivePower=rawReceivePower, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dNSServerPortNumber=dNSServerPortNumber, iPv6PrefixLength=iPv6PrefixLength, ptpCompliance=ptpCompliance, cableDiagnosticsPorts=cableDiagnosticsPorts, alarmInstancedTableNumber=alarmInstancedTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", targetMACAddress=targetMACAddress, cableDiagnosticsResultTable=cableDiagnosticsResultTable, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, eIRP=eIRP, tdmTableNumber=tdmTableNumber, tDMInterfaceControl=tDMInterfaceControl, auxPortStatus=auxPortStatus, sntpGroup=sntpGroup, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, tDM=tDM, licenseTLSRekey=licenseTLSRekey, sNMPv3Enable=sNMPv3Enable, cableDiagPair1Distance=cableDiagPair1Distance, tFTPServerPortNumber=tFTPServerPortNumber, alarmInstancedTableIndex=alarmInstancedTableIndex, whitelistRMEnabled=whitelistRMEnabled, ethernetInstancedTableEntry=ethernetInstancedTableEntry, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, syslogStateTrap=syslogStateTrap, ptmp=ptmp, configuration=configuration, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseSFPPortSupport=licenseSFPPortSupport, userName=userName, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPDSCPPriorityTable=iPDSCPPriorityTable, erroredSeconds=erroredSeconds, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDMChannelStatus=tDMChannelStatus, sNTPServerStatus=sNTPServerStatus, tDMChannelCableLength=tDMChannelCableLength, bridge=bridge, phyControlGroup=phyControlGroup, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, dNSResolver=dNSResolver, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, unitOutOfCalibration=unitOutOfCalibration, packetsToInternalStack=packetsToInternalStack, auxPortConfigurationMismatch=auxPortConfigurationMismatch, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, receiveModulationModeLinked=receiveModulationModeLinked, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mABProtocolVLANPriority=mABProtocolVLANPriority, deviceESN=deviceESN, configurationInstancedTableEntry=configurationInstancedTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tempPcb=tempPcb, licenseTDDSyncSupport=licenseTDDSyncSupport, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseSecurityLevel=licenseSecurityLevel, wirelessLinkStatusLinked=wirelessLinkStatusLinked, dfsGroup=dfsGroup, aggregateDataRate=aggregateDataRate, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, lowestDataModulationMode=lowestDataModulationMode, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, auxPortAllocation=auxPortAllocation, syncETracking=syncETracking, remoteMaximumTransmitPower=remoteMaximumTransmitPower, configurationInstancedTable=configurationInstancedTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, transparentClock=transparentClock, sNMPCommunityString=sNMPCommunityString, mainPSUPortSSMTx=mainPSUPortSSMTx, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, installationMode=installationMode, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dNS=dNS, phyStatusGroup=phyStatusGroup, sNTPServerTable=sNTPServerTable, sNTPPollInterval=sNTPPollInterval, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, phyControlInstancedTableIndex=phyControlInstancedTableIndex, dfsTableNumber=dfsTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPSyncTrap=sNTPSyncTrap, txMABFrames=txMABFrames, auxPortQLRx=auxPortQLRx, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, licenseEncryption=licenseEncryption, versionsGroup=versionsGroup, byteErrorRatioLinked=byteErrorRatioLinked, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, systemClock=systemClock, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, ethernetPriorityTableEntry=ethernetPriorityTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogControlGroup=syslogControlGroup, transmitChannel=transmitChannel, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tDMInterfaceStatus=tDMInterfaceStatus, hTTPAccessEnabled=hTTPAccessEnabled, transmitDataRateLinked=transmitDataRateLinked, remoteInternetAddressType=remoteInternetAddressType, severelyErroredSeconds=severelyErroredSeconds, routerProtocols=routerProtocols, targetRange=targetRange, authorizationControlTable=authorizationControlTable, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, rangingMode=rangingMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, oOBPriorityQueueMapping=oOBPriorityQueueMapping, vectorErrorLinked=vectorErrorLinked, rawReceivePowerLinked=rawReceivePowerLinked, timeZone=timeZone, encryptionGroup=encryptionGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, productName=productName, resetGroup=resetGroup, phyControl=phyControl, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telnetAccessEnabled=telnetAccessEnabled, cableDiagPair4Results=cableDiagPair4Results, dfsTableIndex=dfsTableIndex, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetStatisticsDataSource=ethernetStatisticsDataSource, gatewayIPAddress=gatewayIPAddress, dNSServerTable=dNSServerTable, mgmtInstancedTableEntry=mgmtInstancedTableEntry, l2CPPriorityTable=l2CPPriorityTable, auxPortSyncERxStatus=auxPortSyncERxStatus, ethernetInstancedTableIndex=ethernetInstancedTableIndex, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mgmtInstancedTableNumber=mgmtInstancedTableNumber, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, ethernetGroup=ethernetGroup, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tdmTableIndex=tdmTableIndex, transmitModulationModeLinked=transmitModulationModeLinked, localPacketFiltering=localPacketFiltering, wirelessOutOctets=wirelessOutOctets, sFPErrorTrap=sFPErrorTrap, portAllocationMismatchLinked=portAllocationMismatchLinked, configurationGroup=configurationGroup, sMTPEmailAlert=sMTPEmailAlert, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, userTableIndex=userTableIndex, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mABProtocolVID=mABProtocolVID, licenseGasGroup=licenseGasGroup, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, secureModeAlarm=secureModeAlarm, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, userTableEntry=userTableEntry, antennaGain=antennaGain, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, receiveDataRateLinked=receiveDataRateLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, pubInstancedStatsTable=pubInstancedStatsTable, remoteMACAddress=remoteMACAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapTable=sNMPTrapTable, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mainPSUPortQLTx=mainPSUPortQLTx, sFPPortQLTx=sFPPortQLTx, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, hTTPPortNumber=hTTPPortNumber, tdmTableEntry=tdmTableEntry, userPassword=userPassword, sFPPortQLRx=sFPPortQLRx, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, dNSServerInternetAddress=dNSServerInternetAddress, licenseInstancedTableIndex=licenseInstancedTableIndex, cambium=cambium, sNTPServerTableEntry=sNTPServerTableEntry, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, txColorCode=txColorCode, mABState=mABState, dfsPeaks=dfsPeaks, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, mainPSUPortStatusTrap=mainPSUPortStatusTrap, productVariant=productVariant, licenseCapacity=licenseCapacity, transmitModulationMode=transmitModulationMode, subbandLowestFrequency=subbandLowestFrequency, licenseUnitSerialNumber=licenseUnitSerialNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, snmpControlGroup=snmpControlGroup, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sFPError=sFPError, auxPortAcceptedQLRx=auxPortAcceptedQLRx, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, bridgeGroup=bridgeGroup, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, hTTPSPortNumber=hTTPSPortNumber, lbtDetectedTrap=lbtDetectedTrap, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sNTPSync=sNTPSync, incompatibleMasterAndSlave=incompatibleMasterAndSlave, unitIdentificationGroup=unitIdentificationGroup, syslogControl=syslogControl, hardwareVersion=hardwareVersion, rangeLinked=rangeLinked, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, licenseIssueNumber=licenseIssueNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sFPPortSSMTx=sFPPortSSMTx, licenseIEEE1588Support=licenseIEEE1588Support, sNMPTrapTableIndex=sNMPTrapTableIndex, nIDULanPortStatus=nIDULanPortStatus, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, versions=versions, softwareVersion=softwareVersion, extendedSpectrumScanning=extendedSpectrumScanning, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDMChannelLoopback=tDMChannelLoopback, licenseOOBManagementSupport=licenseOOBManagementSupport, authorizationControlTableNumber=authorizationControlTableNumber, tdmTable=tdmTable, cableDiagPair2Results=cableDiagPair2Results, unitName=unitName, receiveDataRate=receiveDataRate, userTableNumber=userTableNumber, sFPPortAutoMdix=sFPPortAutoMdix, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sMTPServerInternetAddress=sMTPServerInternetAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTableEntry=dfsTableEntry, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, ethernetStatisticsTable=ethernetStatisticsTable, PYSNMP_MODULE_ID=cambium, sNTPServerPortNumber=sNTPServerPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseVersion=licenseVersion, iPv4Address=iPv4Address, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sNTPLastSync=sNTPLastSync, licenseBandwidthCap=licenseBandwidthCap, dNSServerTableIndex=dNSServerTableIndex, transmitFreqKHz=transmitFreqKHz, maximumTransmitPower=maximumTransmitPower, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, phyControlInstancedTable=phyControlInstancedTable, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, syncESlavePort=syncESlavePort, wirelessTopology=wirelessTopology, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, license=license, mgmtInstancedTable=mgmtInstancedTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, dfs=dfs, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, bootVersion=bootVersion, sNTPServerTimeout=sNTPServerTimeout, licenseGroupAccess=licenseGroupAccess, enabledDiagnosticAlarms=enabledDiagnosticAlarms, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, cableDiagPair3Distance=cableDiagPair3Distance, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, portAllocationMismatch=portAllocationMismatch, dataPortPauseFrames=dataPortPauseFrames, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, cableDiagPair2Distance=cableDiagPair2Distance, subnetMask=subnetMask, pubStats=pubStats, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNTPPrimaryServer=sNTPPrimaryServer, auxPortStatusTrap=auxPortStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, transmitDataRate=transmitDataRate, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, cableDiagPair4Distance=cableDiagPair4Distance, systemReset=systemReset, syslogState=syslogState, accessMethod=accessMethod, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, installArmStateTrap=installArmStateTrap, dfsMeans=dfsMeans, packetsFromInternalStack=packetsFromInternalStack, installStatus=installStatus, auxPortSSMTx=auxPortSSMTx, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, snmpControl=snmpControl, linkName=linkName, sNTPServerTableNumber=sNTPServerTableNumber, ethernet=ethernet, mABNominalModulationMode=mABNominalModulationMode, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerRetries=sNTPServerRetries, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, auxPortQLTx=auxPortQLTx)
