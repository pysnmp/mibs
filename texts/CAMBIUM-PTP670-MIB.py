...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mABHoldoffPeriod=mABHoldoffPeriod, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sNTPSync=sNTPSync, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, license=license, licenseInstancedTable=licenseInstancedTable, byteErrorRatio=byteErrorRatio, incompatibleMasterAndSlave=incompatibleMasterAndSlave, byteErrorRatioLinked=byteErrorRatioLinked, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mainPSUPortStatusTrap=mainPSUPortStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerStatus=sNTPServerStatus, unitName=unitName, tDMConfigurationMismatch=tDMConfigurationMismatch, sNMPTrapTableEntry=sNMPTrapTableEntry, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseGroup=licenseGroup, authorizationControlTableNumber=authorizationControlTableNumber, receiveFreqMHz=receiveFreqMHz, transmitModulationMode=transmitModulationMode, cableDiagPair1Distance=cableDiagPair1Distance, licenseRARSupport=licenseRARSupport, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, softwareVersion=softwareVersion, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenseGroupAccess=licenseGroupAccess, ethernetInstancedTable=ethernetInstancedTable, linkName=linkName, phyControlInstancedTableIndex=phyControlInstancedTableIndex, ptp=ptp, mABState=mABState, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, cableDiagnostics=cableDiagnostics, alarmsGroup=alarmsGroup, sNTPServerTable=sNTPServerTable, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, targetRange=targetRange, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, cableDiagnosticsResultTable=cableDiagnosticsResultTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vectorErrorLinked=vectorErrorLinked, cableDiagnosticsGroup=cableDiagnosticsGroup, sMTPEnabledMessages=sMTPEnabledMessages, cableDiagPair4Results=cableDiagPair4Results, userTable=userTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, transmitDataRateLinked=transmitDataRateLinked, smtpGroup=smtpGroup, dNSPrimaryServer=dNSPrimaryServer, sFPPortSSMTx=sFPPortSSMTx, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, ptpTraps=ptpTraps, licenseSFPPortSupport=licenseSFPPortSupport, routerProtocols=routerProtocols, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sFPPortQLRx=sFPPortQLRx, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNMPTrapVersion=sNMPTrapVersion, hCMPMaximumLinkRange=hCMPMaximumLinkRange, installArmState=installArmState, tdmTable=tdmTable, licenseTrialPeriod=licenseTrialPeriod, licenseInstancedTableNumber=licenseInstancedTableNumber, transmitPowerLinked=transmitPowerLinked, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, unavailableSeconds=unavailableSeconds, mPLSTCPriorityTable=mPLSTCPriorityTable, tDMChannelLineCode=tDMChannelLineCode, transparentClockVLAN=transparentClockVLAN, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, ptpCompliance=ptpCompliance, deviceMACAddress=deviceMACAddress, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, channelChangeTrap=channelChangeTrap, dNSServerTableIndex=dNSServerTableIndex, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, transparentClock=transparentClock, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityTable=ethernetPriorityTable, searchStateLinked=searchStateLinked, phyControlInstancedTable=phyControlInstancedTable, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseBandwidthCap=licenseBandwidthCap, dataBridgingStatus=dataBridgingStatus, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveModulationMode=receiveModulationMode, l2CPPriorityTable=l2CPPriorityTable, transmitModulationModeLinked=transmitModulationModeLinked, dfsTableEntry=dfsTableEntry, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, mABTransmissionInterval=mABTransmissionInterval, dNSServerTableNumber=dNSServerTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, whitelistRMMacAddress=whitelistRMMacAddress, dataPortPauseFrames=dataPortPauseFrames, productName=productName, iPv4Address=iPv4Address, configurationInstancedTableNumber=configurationInstancedTableNumber, auxPortDisabledWarning=auxPortDisabledWarning, phyControlGroup=phyControlGroup, regulatoryBand=regulatoryBand, authorizationMethod=authorizationMethod, sNMPEnabledTraps=sNMPEnabledTraps, ethernetStatisticsTable=ethernetStatisticsTable, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, searchState=searchState, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagPair3Results=cableDiagPair3Results, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, configurationInstancedTable=configurationInstancedTable, licenseUnitSerialNumber=licenseUnitSerialNumber, transmitChannel=transmitChannel, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, transmitFreqKHz=transmitFreqKHz, licenseGasGroup=licenseGasGroup, hardwareVersion=hardwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sntpGroup=sntpGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, installStatusTrap=installStatusTrap, erroredSeconds=erroredSeconds, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, portAllocationMismatchTrap=portAllocationMismatchTrap, dNSResolver=dNSResolver, telnetAccessEnabled=telnetAccessEnabled, tFTPClient=tFTPClient, cableDiagPair2Distance=cableDiagPair2Distance, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mgmtInstancedTableIndex=mgmtInstancedTableIndex, installStatusLinked=installStatusLinked, targetMACAddress=targetMACAddress, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, dfsTableIndex=dfsTableIndex, syncEEquipmentClock=syncEEquipmentClock, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpGroups=ptpGroups, resetGroup=resetGroup, accessMethod=accessMethod, tDMEnabledChannels=tDMEnabledChannels, dfsTableNumber=dfsTableNumber, capacityVariantMismatch=capacityVariantMismatch, auxPortQLTx=auxPortQLTx, txColorCode=txColorCode, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mainPSUPortQLTx=mainPSUPortQLTx, sFPPortDisabledWarning=sFPPortDisabledWarning, configurationInstancedTableIndex=configurationInstancedTableIndex, syslogClientTrap=syslogClientTrap, licenseCountry=licenseCountry, wirelessTopology=wirelessTopology, management=management, subnetMask=subnetMask, authorizationControlTable=authorizationControlTable, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, installationMode=installationMode, siteName=siteName, secondarySoftwareVersion=secondarySoftwareVersion, signalStrengthRatio=signalStrengthRatio, userTableEntry=userTableEntry, alarmInstancedTableNumber=alarmInstancedTableNumber, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, systemReset=systemReset, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDM=tDM, cableDiagPair4Distance=cableDiagPair4Distance, sFPPortAutoMdix=sFPPortAutoMdix, useVLANForMABProtocol=useVLANForMABProtocol, dfsMeans=dfsMeans, qOSPriorityScheme=qOSPriorityScheme, capacityVariantMismatchLinked=capacityVariantMismatchLinked, tDMChannelCableLength=tDMChannelCableLength, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseIPv6Support=licenseIPv6Support, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mainPSUPortQLRx=mainPSUPortQLRx, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mainPSUPortStatus=mainPSUPortStatus, licenseTLSRekey=licenseTLSRekey, wirelessOutAllOctets=wirelessOutAllOctets, channelBandwidth=channelBandwidth, receiveDataRateLinked=receiveDataRateLinked, tDMInterfaceControl=tDMInterfaceControl, dfsGroup=dfsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveDataRate=receiveDataRate, encryptionGroup=encryptionGroup, syslogControl=syslogControl, dNSServerInternetAddress=dNSServerInternetAddress, remoteUnitName=remoteUnitName, dNS=dNS, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, pubStatsGroup=pubStatsGroup, smtp=smtp, mgmtInstancedTableNumber=mgmtInstancedTableNumber, linkLossLinked=linkLossLinked, dNSServerPortNumber=dNSServerPortNumber, subbandLowestFrequency=subbandLowestFrequency, mainPSUPortSSMTx=mainPSUPortSSMTx, range=range, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, unitIdentification=unitIdentification, phyInstancedStatusTable=phyInstancedStatusTable, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, cableDiagPair2Results=cableDiagPair2Results, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dNSServerTable=dNSServerTable, auxPortStatus=auxPortStatus, reset=reset, sMTPServerInternetAddressType=sMTPServerInternetAddressType, nIDULanPortStatus=nIDULanPortStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, managementGroup=managementGroup, latitude=latitude, maxLinkRangeExceeded=maxLinkRangeExceeded, tDMChannelStatus=tDMChannelStatus, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, dNSServerInternetAddressType=dNSServerInternetAddressType, mABMaintenanceLevel=mABMaintenanceLevel, packetsFromInternalStack=packetsFromInternalStack, licenseVersion=licenseVersion, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, auxPortSyncERxStatus=auxPortSyncERxStatus, sFPError=sFPError, wirelessLinkStatus=wirelessLinkStatus, pubInstancedStatsTable=pubInstancedStatsTable, phyStatus=phyStatus, versions=versions, sNTPServerInternetAddressType=sNTPServerInternetAddressType, aggregateDataRateLinked=aggregateDataRateLinked, hTTPSAccessEnabled=hTTPSAccessEnabled, auxPortAllocation=auxPortAllocation, sNTPServerTableNumber=sNTPServerTableNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, auxPortStatusTrap=auxPortStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, secureModeAlarmTrap=secureModeAlarmTrap, receivePower=receivePower, licenseEncryption=licenseEncryption, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, versionsGroup=versionsGroup, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ptmp=ptmp, masterSlaveMode=masterSlaveMode, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, hTTPPortNumber=hTTPPortNumber, authorizationControl=authorizationControl, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, wirelessOutEthernetOctets=wirelessOutEthernetOctets, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, cableDiagPair1Results=cableDiagPair1Results, syslogControlGroup=syslogControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogClient=syslogClient, configurationInstancedTableEntry=configurationInstancedTableEntry, phyControlInstancedTableEntry=phyControlInstancedTableEntry, productVariant=productVariant, whitelistRMEnabled=whitelistRMEnabled, nIDULanPortAutoMdix=nIDULanPortAutoMdix, dfsTable=dfsTable, licenseCapacity=licenseCapacity, phyControl=phyControl, severelyErroredSeconds=severelyErroredSeconds, iPv6Address=iPv6Address, sNTPPollInterval=sNTPPollInterval, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, sFPErrorTrap=sFPErrorTrap, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tDMChannelLoopback=tDMChannelLoopback, portAllocationMismatch=portAllocationMismatch, cableDiagPair3Distance=cableDiagPair3Distance, sMTPServerInternetAddress=sMTPServerInternetAddress, pubStats=pubStats, licenseMaxLinkRange=licenseMaxLinkRange, unitOutOfCalibration=unitOutOfCalibration, tempPcb=tempPcb, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, subbandHighestFrequency=subbandHighestFrequency, rawReceivePowerLinked=rawReceivePowerLinked, dataBridgingStatusAlarm=dataBridgingStatusAlarm, telnetPortNumber=telnetPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationModeLinked=receiveModulationModeLinked, mainPSUPortAutoMdix=mainPSUPortAutoMdix, supplementaryGroup=supplementaryGroup, tdmTableIndex=tdmTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, alarmInstancedTable=alarmInstancedTable, remoteInternetAddressType=remoteInternetAddressType, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, rxColorCode=rxColorCode, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, tdmTableNumber=tdmTableNumber, groupID=groupID, tDDSynchronizationMode=tDDSynchronizationMode, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, gatewayIPAddress=gatewayIPAddress, altitude=altitude, licenseOOBManagementSupport=licenseOOBManagementSupport, sNMPCommunityString=sNMPCommunityString, userRole=userRole, oOBPriorityQueueMapping=oOBPriorityQueueMapping, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, linkModeOptimization=linkModeOptimization, receiveChannel=receiveChannel, ethernetPriorityTableIndex=ethernetPriorityTableIndex, notificationsGroup=notificationsGroup, frequencyVariant=frequencyVariant, timeZone=timeZone, transparentClockPort=transparentClockPort, bootVersion=bootVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, encryptionAlgorithm=encryptionAlgorithm, rangeLinked=rangeLinked, vLANManagementVID=vLANManagementVID, hTTPSPortNumber=hTTPSPortNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, regulatoryBandTrap=regulatoryBandTrap, authorizationControlTableIndex=authorizationControlTableIndex, lbtDetectedTrap=lbtDetectedTrap, deviceMSN=deviceMSN, licenseTDDSyncSupport=licenseTDDSyncSupport, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transparentClockVID=transparentClockVID, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ethernetGroup=ethernetGroup, syncETrackingState=syncETrackingState, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, licenseSyncESupport=licenseSyncESupport, deviceESN=deviceESN, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetInstancedTableEntry=ethernetInstancedTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sFPPortSyncERxStatus=sFPPortSyncERxStatus, installArmStateTrap=installArmStateTrap, vectorError=vectorError, wirelessOutOctets=wirelessOutOctets, phyStatusGroup=phyStatusGroup, unitIdentificationGroup=unitIdentificationGroup, licenseHCMPSupport=licenseHCMPSupport, sFPPortAutoNegotiation=sFPPortAutoNegotiation, syncETracking=syncETracking, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, vLANManagementPriority=vLANManagementPriority, blacklistRMEnabled=blacklistRMEnabled, tFTPServerPortNumber=tFTPServerPortNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, transmitDataRate=transmitDataRate, snmpControlGroup=snmpControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, dfsPeaks=dfsPeaks, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseIEEE1588Support=licenseIEEE1588Support, licenseInstancedTableEntry=licenseInstancedTableEntry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, aAAControlGroup=aAAControlGroup, lowestDataModulationMode=lowestDataModulationMode, iPVersion=iPVersion, sNMPTrapTable=sNMPTrapTable, tDDControlGroup=tDDControlGroup, ethernetInstancedTableIndex=ethernetInstancedTableIndex, systemClock=systemClock, cambium=cambium, tdmTableEntry=tdmTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, ethernetStatisticsDataSource=ethernetStatisticsDataSource, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, PYSNMP_MODULE_ID=cambium, licenseRegulatoryBandsList=licenseRegulatoryBandsList, userName=userName, encryption=encryption, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, syslogState=syslogState, lowestTDMModulationMode=lowestTDMModulationMode, syslogStateTrap=syslogStateTrap, ptpTrapPrefix=ptpTrapPrefix, daylightSaving=daylightSaving, ptp670=ptp670, cableDiagnosticsControl=cableDiagnosticsControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, bridge=bridge, portAllocationMismatchLinked=portAllocationMismatchLinked, transmitFreqMHz=transmitFreqMHz, packetsToInternalStack=packetsToInternalStack, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitPower=transmitPower, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitterChannels=transmitterChannels, remoteUnitNameLinked=remoteUnitNameLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseSecurityLevel=licenseSecurityLevel, bridgeGroup=bridgeGroup, maximumNumberOfSlaves=maximumNumberOfSlaves, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerTimeout=sNTPServerTimeout, dNSGroup=dNSGroup, apc=apc, sNTPServerTableIndex=sNTPServerTableIndex, aggregateDataRate=aggregateDataRate, wirelessLinkAvailability=wirelessLinkAvailability, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, rangingMode=rangingMode, ethernet=ethernet, cableDiagnosticsPorts=cableDiagnosticsPorts, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseInstancedTableIndex=licenseInstancedTableIndex, tDDControl=tDDControl, snmpControl=snmpControl, iPDSCPPriorityTable=iPDSCPPriorityTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, localPacketFiltering=localPacketFiltering, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, remoteMACAddress=remoteMACAddress, configuration=configuration, auxPortQLRx=auxPortQLRx, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, wirelessLinkStatusLinked=wirelessLinkStatusLinked, syncESlavePort=syncESlavePort, mABProtocolVID=mABProtocolVID, sNMPPortNumber=sNMPPortNumber, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, authorizationControlTableEntry=authorizationControlTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, configurationGroup=configurationGroup, secureModeAlarm=secureModeAlarm, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sFPPortStatus=sFPPortStatus, mABNominalModulationMode=mABNominalModulationMode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mgmtInstancedTable=mgmtInstancedTable, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, dfs=dfs, antennaSelection=antennaSelection, sNTPServerInternetAddress=sNTPServerInternetAddress, auxPortSSMTx=auxPortSSMTx, rawReceivePower=rawReceivePower, hTTPAccessEnabled=hTTPAccessEnabled, userTableNumber=userTableNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sFPPortStatusTrap=sFPPortStatusTrap, dNSServerTableEntry=dNSServerTableEntry, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, userPassword=userPassword)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", installStatus=installStatus, tDMGroup=tDMGroup, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, userEnabled=userEnabled, sNTPSyncTrap=sNTPSyncTrap, alarmInstancedTableIndex=alarmInstancedTableIndex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, signalStrengthRatioLinked=signalStrengthRatioLinked, dataBridgingStatusLinked=dataBridgingStatusLinked, dataBridgingAvailability=dataBridgingAvailability, tDMInterfaceStatus=tDMInterfaceStatus, authorizationControlGroup=authorizationControlGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, receiveFreqKHz=receiveFreqKHz, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sMTPEmailAlert=sMTPEmailAlert, receivePowerLinked=receivePowerLinked, aAAControl=aAAControl, dSCPManagementPriority=dSCPManagementPriority, licenseIssueNumber=licenseIssueNumber, remoteMACAddressLinked=remoteMACAddressLinked, sNTPServerRetries=sNTPServerRetries, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, enableTransmission=enableTransmission, sNTPLastSync=sNTPLastSync, apcGroup=apcGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, linkSymmetry=linkSymmetry, sntp=sntp, routerProtocolsGroup=routerProtocolsGroup, sNTPState=sNTPState, supplementary=supplementary, linkLoss=linkLoss, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, maximumTransmitPower=maximumTransmitPower, userTableIndex=userTableIndex, eIRP=eIRP, remoteInternetAddressLinked=remoteInternetAddressLinked, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, cableLoss=cableLoss, txMABFrames=txMABFrames, antennaGain=antennaGain, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, longitude=longitude, tDMChannelStatusTrap=tDMChannelStatusTrap, remoteInternetAddress=remoteInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, blacklistRMMacAddress=blacklistRMMacAddress, mABProtocolVLANPriority=mABProtocolVLANPriority, sNMPv3Enable=sNMPv3Enable, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sFPPortQLTx=sFPPortQLTx, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, alarms=alarms, sFPPortAllocation=sFPPortAllocation)
