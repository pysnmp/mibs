...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDDSynchronizationAlarm=tDDSynchronizationAlarm, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, tDM=tDM, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mABNominalModulationMode=mABNominalModulationMode, licenseGroup=licenseGroup, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, cableDiagnosticsPorts=cableDiagnosticsPorts, sNMPPortNumber=sNMPPortNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mABTransmissionInterval=mABTransmissionInterval, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, tdmTable=tdmTable, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, mainPSUPortQLRx=mainPSUPortQLRx, syncETrackingState=syncETrackingState, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ethernetInstancedTableEntry=ethernetInstancedTableEntry, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, vectorErrorLinked=vectorErrorLinked, smtp=smtp, receiveDataRate=receiveDataRate, deviceMSN=deviceMSN, receiveModulationModeLinked=receiveModulationModeLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, pubStatsGroup=pubStatsGroup, vLANManagementVID=vLANManagementVID, sFPPortStatusTrap=sFPPortStatusTrap, timeZone=timeZone, receivePowerLinked=receivePowerLinked, lowestTDMModulationMode=lowestTDMModulationMode, phyStatus=phyStatus, licenseEncryption=licenseEncryption, resetGroup=resetGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortPauseFrames=dataPortPauseFrames, dNSServerPortNumber=dNSServerPortNumber, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, supplementary=supplementary, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tdmTableIndex=tdmTableIndex, rxColorCode=rxColorCode, tDMChannelLoopback=tDMChannelLoopback, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, siteName=siteName, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, syncESlavePort=syncESlavePort, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sFPError=sFPError, licenseOOBManagementSupport=licenseOOBManagementSupport, phyControlGroup=phyControlGroup, configuration=configuration, sNMPEnabledTraps=sNMPEnabledTraps, ethernet=ethernet, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, phyControlInstancedTableEntry=phyControlInstancedTableEntry, dfsGroup=dfsGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataBridgingStatusLinked=dataBridgingStatusLinked, dNSServerInternetAddress=dNSServerInternetAddress, versions=versions, dNSServerTableNumber=dNSServerTableNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, authorizationMethod=authorizationMethod, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseInstancedTableEntry=licenseInstancedTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, installStatusLinked=installStatusLinked, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, authorizationControlTable=authorizationControlTable, sNTPSyncTrap=sNTPSyncTrap, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, cableDiagPair2Results=cableDiagPair2Results, unavailableSeconds=unavailableSeconds, linkLoss=linkLoss, sNTPServerTimeout=sNTPServerTimeout, sFPPortSSMTx=sFPPortSSMTx, sNTPServerTable=sNTPServerTable, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mgmtInstancedTableIndex=mgmtInstancedTableIndex, ptmp=ptmp, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, receiveFreqKHz=receiveFreqKHz, hCMPLinkSymmetry=hCMPLinkSymmetry, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sFPPortAutoMdix=sFPPortAutoMdix, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitFreqMHz=transmitFreqMHz, useVLANForMABProtocol=useVLANForMABProtocol, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseTDDSyncSupport=licenseTDDSyncSupport, userTableEntry=userTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseRARSupport=licenseRARSupport, lbtDetectedTrap=lbtDetectedTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, ptpTrapPrefix=ptpTrapPrefix, versionsGroup=versionsGroup, syncETracking=syncETracking, capacityVariantMismatchTrap=capacityVariantMismatchTrap, apcGroup=apcGroup, licenseSyncESupport=licenseSyncESupport, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseMaxLinkRange=licenseMaxLinkRange, licenseRegulatoryBandsList=licenseRegulatoryBandsList, severelyErroredSeconds=severelyErroredSeconds, ethernetInstancedTableIndex=ethernetInstancedTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, range=range, userTableNumber=userTableNumber, maxLinkRangeExceeded=maxLinkRangeExceeded, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, cableDiagnostics=cableDiagnostics, transmitPowerLinked=transmitPowerLinked, authorizationControlTableEntry=authorizationControlTableEntry, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPLastSync=sNTPLastSync, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, dNSGroup=dNSGroup, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, wirelessLinkStatusLinked=wirelessLinkStatusLinked, authorizationControlTableNumber=authorizationControlTableNumber, subbandHighestFrequency=subbandHighestFrequency, snmpControlGroup=snmpControlGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, l2CPPriorityTable=l2CPPriorityTable, systemReset=systemReset, ptp=ptp, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, bootVersion=bootVersion, sMTPEnabledMessages=sMTPEnabledMessages, hTTPSPortNumber=hTTPSPortNumber, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, auxPortQLRx=auxPortQLRx, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, rangeLinked=rangeLinked, hTTPPortNumber=hTTPPortNumber, apc=apc, licenseCapacity=licenseCapacity, dNSPrimaryServer=dNSPrimaryServer, cableDiagPair1Results=cableDiagPair1Results, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPState=sNTPState, transmitFreqKHz=transmitFreqKHz, channelChangeTrap=channelChangeTrap, tDMEnabledChannels=tDMEnabledChannels, unitOutOfCalibration=unitOutOfCalibration, deviceESN=deviceESN, licenseGasGroup=licenseGasGroup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, masterSlaveMode=masterSlaveMode, sMTPServerInternetAddress=sMTPServerInternetAddress, dNSServerTableEntry=dNSServerTableEntry, blacklistRMMacAddress=blacklistRMMacAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, maximumTransmitPower=maximumTransmitPower, mPLSTCPriorityTable=mPLSTCPriorityTable, aAAControl=aAAControl, phyControlInstancedTableIndex=phyControlInstancedTableIndex, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sNMPCommunityString=sNMPCommunityString, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, remoteMACAddress=remoteMACAddress, dataBridgingStatusAlarm=dataBridgingStatusAlarm, auxPortAllocation=auxPortAllocation, transparentClockVID=transparentClockVID, hTTPAccessEnabled=hTTPAccessEnabled, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, remoteUnitName=remoteUnitName, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, tDDControl=tDDControl, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, auxPortSSMTx=auxPortSSMTx, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sFPPortStatus=sFPPortStatus, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, routerProtocolsGroup=routerProtocolsGroup, configurationInstancedTableEntry=configurationInstancedTableEntry, mainPSUPortSSMTx=mainPSUPortSSMTx, whitelistRMEnabled=whitelistRMEnabled, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, sNTPServerRetries=sNTPServerRetries, wirelessTopology=wirelessTopology, portAllocationMismatchTrap=portAllocationMismatchTrap, packetsFromInternalStack=packetsFromInternalStack, auxPortQLTx=auxPortQLTx, licenseCountry=licenseCountry, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, capacityVariantMismatch=capacityVariantMismatch, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseVersion=licenseVersion, authorizationControl=authorizationControl, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, aAAControlGroup=aAAControlGroup, targetRange=targetRange, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userTable=userTable, gatewayIPAddress=gatewayIPAddress, ethernetInstancedTable=ethernetInstancedTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, transparentClockVLAN=transparentClockVLAN, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseInstancedTableNumber=licenseInstancedTableNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, authorizationControlTableIndex=authorizationControlTableIndex, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, frequencyVariant=frequencyVariant, altitude=altitude, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, management=management, transmitterChannels=transmitterChannels, mainPSUPortStatus=mainPSUPortStatus, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseInstancedTableIndex=licenseInstancedTableIndex, regulatoryBandTrap=regulatoryBandTrap, remoteInternetAddress=remoteInternetAddress, receiveDataRateLinked=receiveDataRateLinked, wirelessOutOctets=wirelessOutOctets, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfsTable=dfsTable, bridge=bridge, localPacketFiltering=localPacketFiltering, encryption=encryption, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpGroups=ptpGroups, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mainPSUPortAllocation=mainPSUPortAllocation, aggregateDataRate=aggregateDataRate, tFTPClient=tFTPClient, managementPortWirelessDownAlert=managementPortWirelessDownAlert, searchStateLinked=searchStateLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, qOSPriorityScheme=qOSPriorityScheme, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogClientTrap=syslogClientTrap, wirelessOutEthernetOctets=wirelessOutEthernetOctets, systemClock=systemClock, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, blacklistRMEnabled=blacklistRMEnabled, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, pubInstancedStatsTable=pubInstancedStatsTable, cableDiagnosticsControl=cableDiagnosticsControl, subnetMask=subnetMask, mABProtocolVID=mABProtocolVID, dfsTableNumber=dfsTableNumber, channelBandwidth=channelBandwidth, maximumNumberOfSlaves=maximumNumberOfSlaves, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, receiveModulationMode=receiveModulationMode, cableDiagPair1Distance=cableDiagPair1Distance, licenseIEEE1588Support=licenseIEEE1588Support, installationMode=installationMode, byteErrorRatioLinked=byteErrorRatioLinked, ethernetPriorityTable=ethernetPriorityTable, mABMaintenanceLevel=mABMaintenanceLevel, telnetAccessEnabled=telnetAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dNSServerTable=dNSServerTable, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, enableTransmission=enableTransmission, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, portAllocationMismatch=portAllocationMismatch, sNTPServerTableEntry=sNTPServerTableEntry, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, cableDiagPair3Distance=cableDiagPair3Distance, iPv6Address=iPv6Address, mainPSUPortQLTx=mainPSUPortQLTx, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, tdmTableEntry=tdmTableEntry, tDMChannelStatusTrap=tDMChannelStatusTrap, transmitPower=transmitPower, sntp=sntp, configurationInstancedTableIndex=configurationInstancedTableIndex, transmitModulationModeLinked=transmitModulationModeLinked, supplementaryGroup=supplementaryGroup, alarmInstancedTableEntry=alarmInstancedTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mainPSUPortStatusTrap=mainPSUPortStatusTrap, smtpGroup=smtpGroup, ethernetGroup=ethernetGroup, erroredSeconds=erroredSeconds, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogClient=syslogClient, transmitChannel=transmitChannel, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, configurationInstancedTableNumber=configurationInstancedTableNumber, tDMChannelStatus=tDMChannelStatus, dNS=dNS, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, vectorError=vectorError, secureModeAlarm=secureModeAlarm, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, hardwareVersion=hardwareVersion, transparentClock=transparentClock, iPDSCPPriorityTable=iPDSCPPriorityTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, encryptionAlgorithm=encryptionAlgorithm, dfsTableIndex=dfsTableIndex, installStatus=installStatus, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, dfsTableEntry=dfsTableEntry, license=license, capacityVariantMismatchLinked=capacityVariantMismatchLinked, alarmInstancedTableNumber=alarmInstancedTableNumber, deviceMACAddress=deviceMACAddress, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, unitIdentification=unitIdentification, portAllocationMismatchLinked=portAllocationMismatchLinked, linkSymmetry=linkSymmetry, sntpGroup=sntpGroup, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, tDDControlGroup=tDDControlGroup, ethernetStatisticsTable=ethernetStatisticsTable, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, aggregateDataRateLinked=aggregateDataRateLinked, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitDataRateLinked=transmitDataRateLinked, syslogControl=syslogControl, phyStatusGroup=phyStatusGroup, licenseSecurityLevel=licenseSecurityLevel, sNTPServerTableIndex=sNTPServerTableIndex, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, userTableIndex=userTableIndex, rangingMode=rangingMode, sFPPortAllocation=sFPPortAllocation, searchState=searchState, remoteInternetAddressLinked=remoteInternetAddressLinked, sNTPSync=sNTPSync, cableDiagnosticsWarning=cableDiagnosticsWarning, softwareVersion=softwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, auxPortStatusTrap=auxPortStatusTrap, userName=userName, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, alarmInstancedTableIndex=alarmInstancedTableIndex, byteErrorRatio=byteErrorRatio, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, mgmtInstancedTableNumber=mgmtInstancedTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, bridgeGroup=bridgeGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, snmpControl=snmpControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, phyInstancedStatusTable=phyInstancedStatusTable, PYSNMP_MODULE_ID=cambium, iPv6PrefixLength=iPv6PrefixLength, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, groupID=groupID, wirelessLinkStatus=wirelessLinkStatus, receiveFreqMHz=receiveFreqMHz, receiveChannel=receiveChannel, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, transmitDataRate=transmitDataRate, tDDSynchronizationMode=tDDSynchronizationMode, sFPErrorTrap=sFPErrorTrap, dNSResolver=dNSResolver, linkLossLinked=linkLossLinked, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseHCMPSupport=licenseHCMPSupport, ptpCompliance=ptpCompliance, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transmitModulationMode=transmitModulationMode, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, rawReceivePower=rawReceivePower, unitIdentificationGroup=unitIdentificationGroup, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, wirelessOutAllOctets=wirelessOutAllOctets, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, daylightSaving=daylightSaving, cableDiagPair4Results=cableDiagPair4Results, routerProtocols=routerProtocols, accessMethod=accessMethod, syslogControlGroup=syslogControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapTable=sNMPTrapTable, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, packetsToInternalStack=packetsToInternalStack, sNTPServerTableNumber=sNTPServerTableNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, remoteUnitNameLinked=remoteUnitNameLinked, linkModeOptimization=linkModeOptimization, sMTPEmailAlert=sMTPEmailAlert, licenseTLSRekey=licenseTLSRekey, sNTPPrimaryServer=sNTPPrimaryServer, lowestDataModulationMode=lowestDataModulationMode, userRole=userRole, extendedSpectrumScanning=extendedSpectrumScanning, userEnabled=userEnabled, cambium=cambium, cableLoss=cableLoss, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, productName=productName, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, eIRP=eIRP, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mABNominalTransmitCapacity=mABNominalTransmitCapacity, ptp670=ptp670, tDMChannelLineCode=tDMChannelLineCode, tFTPServerPortNumber=tFTPServerPortNumber, tempPcb=tempPcb, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, longitude=longitude, dataBridgingStatus=dataBridgingStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, vLANManagementPriority=vLANManagementPriority, remoteInternetAddressType=remoteInternetAddressType, dNSServerInternetAddressType=dNSServerInternetAddressType, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, installStatusTrap=installStatusTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseGroupAccess=licenseGroupAccess, licenseSFPPortSupport=licenseSFPPortSupport, sNMPv3Enable=sNMPv3Enable, nIDULanPortStatus=nIDULanPortStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNMPTrapTableNumber=sNMPTrapTableNumber, phyControlInstancedTable=phyControlInstancedTable, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortStatus=auxPortStatus, licenseIssueNumber=licenseIssueNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfs=dfs, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, alarms=alarms, remoteMACAddressLinked=remoteMACAddressLinked, sFPPortQLTx=sFPPortQLTx, rawReceivePowerLinked=rawReceivePowerLinked, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, regulatoryBand=regulatoryBand, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, antennaGain=antennaGain, cableDiagPair4Distance=cableDiagPair4Distance, antennaSelection=antennaSelection, cableDiagPair2Distance=cableDiagPair2Distance, sFPPortDisabledWarning=sFPPortDisabledWarning, dSCPManagementPriority=dSCPManagementPriority, alarmInstancedTable=alarmInstancedTable, sNMPTrapTableIndex=sNMPTrapTableIndex, mgmtInstancedTable=mgmtInstancedTable, unitName=unitName, signalStrengthRatioLinked=signalStrengthRatioLinked, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNMPTrapInternetAddress=sNMPTrapInternetAddress, whitelistRMMacAddress=whitelistRMMacAddress, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, phyControl=phyControl, licenseIPv6Support=licenseIPv6Support, cableDiagPair3Results=cableDiagPair3Results, installArmState=installArmState, hTTPSAccessEnabled=hTTPSAccessEnabled, iPVersion=iPVersion, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, ethernetStatisticsDataSource=ethernetStatisticsDataSource)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPPollInterval=sNTPPollInterval, auxPortAcceptedQLRx=auxPortAcceptedQLRx, subbandLowestFrequency=subbandLowestFrequency, txColorCode=txColorCode, syncEEquipmentClock=syncEEquipmentClock, tDMInterfaceControl=tDMInterfaceControl, mABState=mABState, dataBridgingAvailability=dataBridgingAvailability, licenseBandwidthCap=licenseBandwidthCap, txMABFrames=txMABFrames, transparentClockPort=transparentClockPort, mABHoldoffPeriod=mABHoldoffPeriod, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tdmTableNumber=tdmTableNumber, iPv4Address=iPv4Address, sNTPServerStatus=sNTPServerStatus, userPassword=userPassword, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, nIDULanPortStatusTrap=nIDULanPortStatusTrap, encryptionGroup=encryptionGroup, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, alarmsGroup=alarmsGroup, sFPPortQLRx=sFPPortQLRx, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, authorizationControlGroup=authorizationControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, dfsMeans=dfsMeans, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, dfsPeaks=dfsPeaks, secureModeAlarmTrap=secureModeAlarmTrap, tDMInterfaceStatus=tDMInterfaceStatus, secondarySoftwareVersion=secondarySoftwareVersion, managementGroup=managementGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, syslogStateTrap=syslogStateTrap, auxPortDisabledWarning=auxPortDisabledWarning, configurationInstancedTable=configurationInstancedTable, receiveModulationModeDetail=receiveModulationModeDetail, licenseTrialPeriod=licenseTrialPeriod, syslogState=syslogState, auxPortConfigurationMismatch=auxPortConfigurationMismatch, dNSServerTableIndex=dNSServerTableIndex, telnetPortNumber=telnetPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tDMGroup=tDMGroup, latitude=latitude, targetMACAddress=targetMACAddress, productVariant=productVariant, tDMChannelCableLength=tDMChannelCableLength, licenseInstancedTable=licenseInstancedTable, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, signalStrengthRatio=signalStrengthRatio, reset=reset, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, pubStats=pubStats)
