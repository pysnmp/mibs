...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortStatus=sFPPortStatus, useVLANForMABProtocol=useVLANForMABProtocol, tDMChannelLoopback=tDMChannelLoopback, receiveFreqMHz=receiveFreqMHz, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseCapacity=licenseCapacity, dfsTableNumber=dfsTableNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, cableDiagPair2Results=cableDiagPair2Results, wirelessOutAllOctets=wirelessOutAllOctets, longitude=longitude, tDDControlGroup=tDDControlGroup, cableDiagPair4Distance=cableDiagPair4Distance, sNTPServerTableIndex=sNTPServerTableIndex, syslogClient=syslogClient, alarmsGroup=alarmsGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, configurationInstancedTable=configurationInstancedTable, wirelessLinkAvailability=wirelessLinkAvailability, wirelessLinkStatusLinked=wirelessLinkStatusLinked, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dfsPeaks=dfsPeaks, linkSymmetry=linkSymmetry, PYSNMP_MODULE_ID=cambium, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, dfsTableIndex=dfsTableIndex, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, alarmInstancedTableIndex=alarmInstancedTableIndex, authorizationControlTableIndex=authorizationControlTableIndex, tDMConfigurationMismatch=tDMConfigurationMismatch, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, tDMInterfaceControl=tDMInterfaceControl, managementGroup=managementGroup, supplementaryGroup=supplementaryGroup, masterSlaveMode=masterSlaveMode, phyControlGroup=phyControlGroup, linkLossLinked=linkLossLinked, transmitModulationMode=transmitModulationMode, notificationsGroup=notificationsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, cableDiagnostics=cableDiagnostics, blacklistRMMacAddress=blacklistRMMacAddress, ethernetStatisticsTable=ethernetStatisticsTable, rawReceivePower=rawReceivePower, aAAControl=aAAControl, userTableEntry=userTableEntry, tDMInterfaceStatus=tDMInterfaceStatus, capacityVariantMismatchLinked=capacityVariantMismatchLinked, receiveDataRate=receiveDataRate, tdmTable=tdmTable, dNSServerPortNumber=dNSServerPortNumber, dataBridgingStatusLinked=dataBridgingStatusLinked, ethernetPriorityTableNumber=ethernetPriorityTableNumber, eIRP=eIRP, licenseIPv6Support=licenseIPv6Support, transparentClockPort=transparentClockPort, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, range=range, sFPPortAutoNegotiation=sFPPortAutoNegotiation, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, rawReceivePowerLinked=rawReceivePowerLinked, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, receiveChannel=receiveChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyControl=phyControl, unitIdentification=unitIdentification, sNMPEnabledTraps=sNMPEnabledTraps, unavailableSeconds=unavailableSeconds, licenseMaxLinkRange=licenseMaxLinkRange, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, phyControlInstancedTableIndex=phyControlInstancedTableIndex, vectorError=vectorError, ptmp=ptmp, vLANManagementPriority=vLANManagementPriority, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetInstancedTableIndex=ethernetInstancedTableIndex, userTable=userTable, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, noWirelessChannelAvailable=noWirelessChannelAvailable, syncESlavePort=syncESlavePort, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, remoteUnitNameLinked=remoteUnitNameLinked, mainPSUPortSSMTx=mainPSUPortSSMTx, remoteMACAddressLinked=remoteMACAddressLinked, licenseInstancedTableEntry=licenseInstancedTableEntry, snmpControlGroup=snmpControlGroup, licenseIssueNumber=licenseIssueNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dNSServerInternetAddressType=dNSServerInternetAddressType, targetRange=targetRange, installStatusLinked=installStatusLinked, auxPortStatusTrap=auxPortStatusTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, transparentClockVID=transparentClockVID, configurationInstancedTableEntry=configurationInstancedTableEntry, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPTrapTable=sNMPTrapTable, iPv6Address=iPv6Address, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, packetsToInternalStack=packetsToInternalStack, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, authorizationControlTable=authorizationControlTable, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerInternetAddressType=sNTPServerInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveFreqKHz=receiveFreqKHz, licenseGroupAccess=licenseGroupAccess, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, authorizationControlTableNumber=authorizationControlTableNumber, cambium=cambium, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, installStatus=installStatus, reset=reset, nIDULanPortAutoMdix=nIDULanPortAutoMdix, wirelessLinkStatus=wirelessLinkStatus, capacityVariantMismatch=capacityVariantMismatch, mABMaintenanceLevel=mABMaintenanceLevel, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mgmtInstancedTableNumber=mgmtInstancedTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseCountry=licenseCountry, packetsFromInternalStack=packetsFromInternalStack, hTTPAccessEnabled=hTTPAccessEnabled, cableDiagPair1Results=cableDiagPair1Results, l2CPPriorityTableIndex=l2CPPriorityTableIndex, accessMethod=accessMethod, regulatoryBandTrap=regulatoryBandTrap, sNTPLastSync=sNTPLastSync, l2CPPriorityTable=l2CPPriorityTable, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, subbandHighestFrequency=subbandHighestFrequency, sFPPortDisabledWarning=sFPPortDisabledWarning, transparentClockVLAN=transparentClockVLAN, tDMChannelStatus=tDMChannelStatus, transmitDataRateLinked=transmitDataRateLinked, phyControlInstancedTableEntry=phyControlInstancedTableEntry, auxPortAllocation=auxPortAllocation, syslogClientTrap=syslogClientTrap, severelyErroredSeconds=severelyErroredSeconds, dNSServerTable=dNSServerTable, aAAControlGroup=aAAControlGroup, ptpTrapPrefix=ptpTrapPrefix, sNTPState=sNTPState, hardwareVersion=hardwareVersion, encryption=encryption, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, phyStatus=phyStatus, sFPErrorTrap=sFPErrorTrap, altitude=altitude, vLANManagementVID=vLANManagementVID, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, supplementary=supplementary, alarmInstancedTableNumber=alarmInstancedTableNumber, userRole=userRole, daylightSaving=daylightSaving, pubStats=pubStats, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, linkName=linkName, tDDControl=tDDControl, byteErrorRatioLinked=byteErrorRatioLinked, auxPortDisabledWarning=auxPortDisabledWarning, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, transparentClock=transparentClock, iPv4Address=iPv4Address, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, apc=apc, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, transmitFreqKHz=transmitFreqKHz, cableDiagPair3Results=cableDiagPair3Results, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, iPv6PrefixLength=iPv6PrefixLength, dataPortPauseFrames=dataPortPauseFrames, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetInstancedTableNumber=ethernetInstancedTableNumber, tDM=tDM, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transmitFreqMHz=transmitFreqMHz, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, softwareVersion=softwareVersion, mainPSUPortQLTx=mainPSUPortQLTx, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dSCPManagementPriority=dSCPManagementPriority, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseGroup=licenseGroup, sFPPortAllocation=sFPPortAllocation, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPPortNumber=sNMPPortNumber, dataBridgingAvailability=dataBridgingAvailability, alarmInstancedTable=alarmInstancedTable, targetMACAddress=targetMACAddress, sNTPServerRetries=sNTPServerRetries, channelChangeTrap=channelChangeTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitDataRate=transmitDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableLoss=cableLoss, sFPError=sFPError, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, auxPortConfigurationMismatch=auxPortConfigurationMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, telnetPortNumber=telnetPortNumber, encryptionGroup=encryptionGroup, versionsGroup=versionsGroup, receivePower=receivePower, dfs=dfs, systemClock=systemClock, syslogState=syslogState, phyStatusGroup=phyStatusGroup, erroredSeconds=erroredSeconds, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenseInstancedTableNumber=licenseInstancedTableNumber, wirelessOutOctets=wirelessOutOctets, bridge=bridge, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, siteName=siteName, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, cableDiagPair4Results=cableDiagPair4Results, sFPPortAutoMdix=sFPPortAutoMdix, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNMPTrapTableEntry=sNMPTrapTableEntry, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tFTPServerInternetAddress=tFTPServerInternetAddress, maximumTransmitPower=maximumTransmitPower, qOSPriorityScheme=qOSPriorityScheme, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, licenseBandwidthCap=licenseBandwidthCap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, receiveDataRateLinked=receiveDataRateLinked, tDMChannelStatusTrap=tDMChannelStatusTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, channelBandwidth=channelBandwidth, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mABNominalModulationMode=mABNominalModulationMode, unitIdentificationGroup=unitIdentificationGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, authorizationControlTableEntry=authorizationControlTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, license=license, lowestTDMModulationMode=lowestTDMModulationMode, sMTPEmailAlert=sMTPEmailAlert, tDMEnabledChannels=tDMEnabledChannels, tDMChannelLineCode=tDMChannelLineCode, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, searchState=searchState, dNSGroup=dNSGroup, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, rangeLinked=rangeLinked, transmitPowerLinked=transmitPowerLinked, licenseIEEE1588Support=licenseIEEE1588Support, management=management, enableTransmission=enableTransmission, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNTPSync=sNTPSync, sNMPTrapTableIndex=sNMPTrapTableIndex, mABTransmissionInterval=mABTransmissionInterval, phyInstancedStatusTable=phyInstancedStatusTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, productName=productName, blacklistRMEnabled=blacklistRMEnabled, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, cableDiagPair2Distance=cableDiagPair2Distance, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, searchStateLinked=searchStateLinked, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseOOBManagementSupport=licenseOOBManagementSupport, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, unitOutOfCalibration=unitOutOfCalibration, sMTPEnabledMessages=sMTPEnabledMessages, deviceESN=deviceESN, ethernetInstancedTableEntry=ethernetInstancedTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, tdmTableIndex=tdmTableIndex, sNTPServerTimeout=sNTPServerTimeout, mgmtInstancedTableIndex=mgmtInstancedTableIndex, licenseSyncESupport=licenseSyncESupport, smtpGroup=smtpGroup, rangingMode=rangingMode, auxPortSyncERxStatus=auxPortSyncERxStatus, dfsTableEntry=dfsTableEntry, antennaGain=antennaGain, sFPPortQLTx=sFPPortQLTx, receiveModulationModeDetail=receiveModulationModeDetail, hCMPLinkSymmetry=hCMPLinkSymmetry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, ptp=ptp, remoteInternetAddressLinked=remoteInternetAddressLinked, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, linkLoss=linkLoss, configuration=configuration, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, cableDiagPair3Distance=cableDiagPair3Distance, userTableIndex=userTableIndex, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, hCMPMaximumLinkRange=hCMPMaximumLinkRange, auxPortQLTx=auxPortQLTx, receivePowerLinked=receivePowerLinked, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, configurationGroup=configurationGroup, remoteMACAddress=remoteMACAddress, cableDiagPair1Distance=cableDiagPair1Distance, userName=userName, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, ethernet=ethernet, mgmtInstancedTable=mgmtInstancedTable, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, dataBridgingStatus=dataBridgingStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dfsGroup=dfsGroup, licenseSecurityLevel=licenseSecurityLevel, signalStrengthRatioLinked=signalStrengthRatioLinked, ethernetInstancedTable=ethernetInstancedTable, ethernetPriorityTable=ethernetPriorityTable, bridgeGroup=bridgeGroup, aggregateDataRateLinked=aggregateDataRateLinked, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseSFPPortSupport=licenseSFPPortSupport, incompatibleRegulatoryBands=incompatibleRegulatoryBands, deviceMACAddress=deviceMACAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, nIDULanPortStatus=nIDULanPortStatus, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseInstancedTable=licenseInstancedTable, mainPSUPortStatus=mainPSUPortStatus, sntp=sntp, remoteInternetAddressType=remoteInternetAddressType, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, ptpCompliance=ptpCompliance, groupID=groupID, configurationInstancedTableNumber=configurationInstancedTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, dNSResolver=dNSResolver, dfsMeans=dfsMeans, txColorCode=txColorCode, portAllocationMismatchTrap=portAllocationMismatchTrap, iPv6GatewayAddress=iPv6GatewayAddress, configurationInstancedTableIndex=configurationInstancedTableIndex, deviceMSN=deviceMSN, regulatoryBand=regulatoryBand, routerProtocols=routerProtocols, syncETrackingState=syncETrackingState, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, resetGroup=resetGroup, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, ptpTraps=ptpTraps, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, userTableNumber=userTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, portAllocationMismatch=portAllocationMismatch, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mainPSUPortAutoMdix=mainPSUPortAutoMdix, txMABFrames=txMABFrames, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, routerProtocolsGroup=routerProtocolsGroup, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sFPPortQLRx=sFPPortQLRx, tDMChannelCableLength=tDMChannelCableLength, sNTPServerPortNumber=sNTPServerPortNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, remoteUnitName=remoteUnitName, mABNominalTransmitCapacity=mABNominalTransmitCapacity, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, licenseHCMPSupport=licenseHCMPSupport, transmitChannel=transmitChannel, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sNTPPrimaryServer=sNTPPrimaryServer, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, secureModeAlarm=secureModeAlarm, syslogStateTrap=syslogStateTrap, tdmTableEntry=tdmTableEntry, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, tFTPServerInternetAddressType=tFTPServerInternetAddressType, licenseTDDSyncSupport=licenseTDDSyncSupport, syncETracking=syncETracking, sNTPServerTableNumber=sNTPServerTableNumber, whitelistRMEnabled=whitelistRMEnabled, apcGroup=apcGroup, linkModeOptimization=linkModeOptimization, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, phyControlInstancedTableNumber=phyControlInstancedTableNumber, antennaSelection=antennaSelection, syncEEquipmentClock=syncEEquipmentClock, pubInstancedStatsTable=pubInstancedStatsTable, ptpGroups=ptpGroups, receiveModulationModeLinked=receiveModulationModeLinked, mABState=mABState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, wirelessTopology=wirelessTopology, licenseRARSupport=licenseRARSupport, byteErrorRatio=byteErrorRatio, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, localPacketFiltering=localPacketFiltering, dNSPrimaryServer=dNSPrimaryServer, dNSServerTableIndex=dNSServerTableIndex, mainPSUPortQLRx=mainPSUPortQLRx, licenseGasGroup=licenseGasGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telnetAccessEnabled=telnetAccessEnabled, ethernetStatisticsDataSource=ethernetStatisticsDataSource, dNSServerTableEntry=dNSServerTableEntry, auxPortSSMTx=auxPortSSMTx, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, mainPSUPortAllocation=mainPSUPortAllocation, sNTPPollInterval=sNTPPollInterval, ptp670=ptp670, cableDiagnosticsResultTable=cableDiagnosticsResultTable, oOBPriorityQueueMapping=oOBPriorityQueueMapping, portAllocationMismatchLinked=portAllocationMismatchLinked, userPassword=userPassword, hTTPSPortNumber=hTTPSPortNumber, sNTPServerTable=sNTPServerTable, remoteInternetAddress=remoteInternetAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mABHoldoffPeriod=mABHoldoffPeriod, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, installStatusTrap=installStatusTrap, sFPPortStatusTrap=sFPPortStatusTrap, subnetMask=subnetMask, auxPortStatus=auxPortStatus, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, tDMGroup=tDMGroup, versions=versions, licenseTrialPeriod=licenseTrialPeriod, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tdmTableNumber=tdmTableNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, installArmState=installArmState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, smtp=smtp, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseEncryption=licenseEncryption, lbtDetectedTrap=lbtDetectedTrap, secondarySoftwareVersion=secondarySoftwareVersion, signalStrengthRatio=signalStrengthRatio, capacityVariantMismatchTrap=capacityVariantMismatchTrap, hTTPPortNumber=hTTPPortNumber, extendedSpectrumScanning=extendedSpectrumScanning, phyControlInstancedTable=phyControlInstancedTable, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, cableDiagnosticsWarning=cableDiagnosticsWarning, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerStatus=sNTPServerStatus, unitName=unitName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, transmitterChannels=transmitterChannels, transmitPower=transmitPower, sNTPServerInternetAddress=sNTPServerInternetAddress, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sFPPortSSMTx=sFPPortSSMTx, rxColorCode=rxColorCode, licenseVersion=licenseVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, subbandLowestFrequency=subbandLowestFrequency, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, gatewayIPAddress=gatewayIPAddress, licenseTLSRekey=licenseTLSRekey, authorizationControlGroup=authorizationControlGroup, wirelessOutEthernetOctets=wirelessOutEthernetOctets, maximumNumberOfSlaves=maximumNumberOfSlaves, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, alarmInstancedTableEntry=alarmInstancedTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, ethernetGroup=ethernetGroup, sntpGroup=sntpGroup, tFTPClient=tFTPClient, cableDiagnosticsControl=cableDiagnosticsControl, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, installArmStateTrap=installArmStateTrap, installationMode=installationMode, pubStatsGroup=pubStatsGroup, tempPcb=tempPcb, syslogControl=syslogControl, iPVersion=iPVersion, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, vectorErrorLinked=vectorErrorLinked, authorizationMethod=authorizationMethod, transmitModulationModeLinked=transmitModulationModeLinked, encryptionAlgorithm=encryptionAlgorithm, dNSServerInternetAddress=dNSServerInternetAddress, sNMPCommunityString=sNMPCommunityString, licenseInstancedTableIndex=licenseInstancedTableIndex, sNMPv3Enable=sNMPv3Enable, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, timeZone=timeZone, userEnabled=userEnabled, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, aggregateDataRate=aggregateDataRate, frequencyVariant=frequencyVariant, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, dfsTable=dfsTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, whitelistRMMacAddress=whitelistRMMacAddress, dNSServerTableNumber=dNSServerTableNumber, systemReset=systemReset, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, authorizationControl=authorizationControl, mgmtInstancedTableEntry=mgmtInstancedTableEntry, snmpControl=snmpControl, lowestDataModulationMode=lowestDataModulationMode, latitude=latitude, dNS=dNS, productVariant=productVariant, alarms=alarms, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mABProtocolVID=mABProtocolVID, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, auxPortQLRx=auxPortQLRx, sFPPortSyncERxStatus=sFPPortSyncERxStatus, syslogControlGroup=syslogControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap)
