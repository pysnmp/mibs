...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", smtp=smtp, sNTPServerTableNumber=sNTPServerTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, transparentClock=transparentClock, blacklistRMEnabled=blacklistRMEnabled, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sNMPPortNumber=sNMPPortNumber, supplementary=supplementary, aggregateDataRate=aggregateDataRate, tdmTableNumber=tdmTableNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cableDiagPair1Results=cableDiagPair1Results, encryption=encryption, txMABFrames=txMABFrames, sNTPServerStatus=sNTPServerStatus, sntp=sntp, qOSPriorityScheme=qOSPriorityScheme, dNSServerTableEntry=dNSServerTableEntry, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, cableDiagPair2Distance=cableDiagPair2Distance, localPacketFiltering=localPacketFiltering, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, whitelistRMMacAddress=whitelistRMMacAddress, lbtDetectedTrap=lbtDetectedTrap, dNSServerTable=dNSServerTable, sNTPServerTimeout=sNTPServerTimeout, sFPPortStatus=sFPPortStatus, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, routerProtocolsGroup=routerProtocolsGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, transparentClockVID=transparentClockVID, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, cableDiagnosticsPorts=cableDiagnosticsPorts, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataBridgingStatusAlarm=dataBridgingStatusAlarm, wirelessLinkStatusLinked=wirelessLinkStatusLinked, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cableDiagPair4Distance=cableDiagPair4Distance, cableDiagnosticsWarning=cableDiagnosticsWarning, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telnetPortNumber=telnetPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, syncEEquipmentClock=syncEEquipmentClock, mABProtocolVID=mABProtocolVID, targetRange=targetRange, transmitDataRateLinked=transmitDataRateLinked, sFPPortQLTx=sFPPortQLTx, deviceMSN=deviceMSN, regulatoryBandTrap=regulatoryBandTrap, mABHoldoffPeriod=mABHoldoffPeriod, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, configurationInstancedTableEntry=configurationInstancedTableEntry, blacklistRMMacAddress=blacklistRMMacAddress, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, sNTPPollInterval=sNTPPollInterval, mainPSUPortStatus=mainPSUPortStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, mABProtocolVLANPriority=mABProtocolVLANPriority, transmitterChannels=transmitterChannels, sMTPEnabledMessages=sMTPEnabledMessages, ethernetPriorityTable=ethernetPriorityTable, userTableIndex=userTableIndex, ethernet=ethernet, alarms=alarms, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, auxPortConfigurationMismatch=auxPortConfigurationMismatch, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, accessMethod=accessMethod, vectorErrorLinked=vectorErrorLinked, lowestTDMModulationMode=lowestTDMModulationMode, cableDiagnosticsResultTable=cableDiagnosticsResultTable, eIRP=eIRP, licenseGroup=licenseGroup, dNSServerInternetAddressType=dNSServerInternetAddressType, licenseOOBManagementSupport=licenseOOBManagementSupport, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, licenseHCMPSupport=licenseHCMPSupport, dNSServerTableIndex=dNSServerTableIndex, licenseMaxLinkRange=licenseMaxLinkRange, authorizationControlTableNumber=authorizationControlTableNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mainPSUPortQLTx=mainPSUPortQLTx, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tdmTableEntry=tdmTableEntry, receiveDataRateLinked=receiveDataRateLinked, licenseSyncESupport=licenseSyncESupport, hardwareVersion=hardwareVersion, ptmp=ptmp, channelChangeTrap=channelChangeTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tDDSynchronizationStatus=tDDSynchronizationStatus, packetsFromInternalStack=packetsFromInternalStack, dfsTableEntry=dfsTableEntry, remoteUnitNameLinked=remoteUnitNameLinked, cableDiagPair4Results=cableDiagPair4Results, maximumNumberOfSlaves=maximumNumberOfSlaves, phyStatusGroup=phyStatusGroup, iPVersion=iPVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitFreqMHz=transmitFreqMHz, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, antennaSelection=antennaSelection, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, vLANManagementPriority=vLANManagementPriority, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, versionsGroup=versionsGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, mABNominalModulationMode=mABNominalModulationMode, sFPPortQLRx=sFPPortQLRx, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerTableIndex=sNTPServerTableIndex, dfsTableIndex=dfsTableIndex, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sNTPSync=sNTPSync, userRole=userRole, sMTPServerInternetAddressType=sMTPServerInternetAddressType, receiveModulationMode=receiveModulationMode, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tDMChannelLoopback=tDMChannelLoopback, softwareVersion=softwareVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseCountry=licenseCountry, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, tDMEnabledChannels=tDMEnabledChannels, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, ethernetInstancedTableNumber=ethernetInstancedTableNumber, auxPortStatus=auxPortStatus, dfsMeans=dfsMeans, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, hTTPSAccessEnabled=hTTPSAccessEnabled, apc=apc, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, encryptionAlgorithm=encryptionAlgorithm, receiveModulationModeLinked=receiveModulationModeLinked, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, versions=versions, transmitPower=transmitPower, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, extendedSpectrumScanning=extendedSpectrumScanning, authorizationControl=authorizationControl, sNTPServerTable=sNTPServerTable, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, hTTPSPortNumber=hTTPSPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, sntpGroup=sntpGroup, txColorCode=txColorCode, linkModeOptimization=linkModeOptimization, dfs=dfs, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sFPPortSyncERxStatus=sFPPortSyncERxStatus, capacityVariantMismatchTrap=capacityVariantMismatchTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, portAllocationMismatch=portAllocationMismatch, licenseUnitSerialNumber=licenseUnitSerialNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, syslogClient=syslogClient, auxPortDisabledWarning=auxPortDisabledWarning, receiveChannel=receiveChannel, altitude=altitude, mABState=mABState, syslogStateTrap=syslogStateTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ethernetInstancedTableIndex=ethernetInstancedTableIndex, licenseBandwidthCap=licenseBandwidthCap, reset=reset, vectorError=vectorError, linkLoss=linkLoss, snmpControl=snmpControl, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dataBridgingStatus=dataBridgingStatus, ethernetGroup=ethernetGroup, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sNTPServerRetries=sNTPServerRetries, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDMGroup=tDMGroup, searchState=searchState, syslogControlGroup=syslogControlGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTableNumber=userTableNumber, dNSServerTableNumber=dNSServerTableNumber, apcGroup=apcGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseInstancedTable=licenseInstancedTable, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, tDMChannelLineCode=tDMChannelLineCode, configurationInstancedTableIndex=configurationInstancedTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, unitIdentification=unitIdentification, range=range, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, remoteUnitName=remoteUnitName, tDMInterfaceStatus=tDMInterfaceStatus, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, ptp=ptp, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, frequencyVariant=frequencyVariant, userPassword=userPassword, syncETracking=syncETracking, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtpGroup=smtpGroup, ptpTraps=ptpTraps, ethernetInstancedTableEntry=ethernetInstancedTableEntry, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseIEEE1588Support=licenseIEEE1588Support, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, subbandLowestFrequency=subbandLowestFrequency, erroredSeconds=erroredSeconds, alarmInstancedTableEntry=alarmInstancedTableEntry, cableDiagnostics=cableDiagnostics, mABTransmissionInterval=mABTransmissionInterval, bridgeGroup=bridgeGroup, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, targetMACAddress=targetMACAddress, sNTPSyncTrap=sNTPSyncTrap, tDMChannelStatus=tDMChannelStatus, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, l2CPPriorityTable=l2CPPriorityTable, iPDSCPPriorityTable=iPDSCPPriorityTable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, cableDiagnosticsGroup=cableDiagnosticsGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transparentClockPort=transparentClockPort, rxColorCode=rxColorCode, deviceMACAddress=deviceMACAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, installArmStateTrap=installArmStateTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, byteErrorRatio=byteErrorRatio, license=license, iPv6Address=iPv6Address, capacityVariantMismatch=capacityVariantMismatch, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, cableDiagPair3Distance=cableDiagPair3Distance, wirelessLinkStatus=wirelessLinkStatus, installationMode=installationMode, wirelessTopology=wirelessTopology, enabledDiagnosticAlarms=enabledDiagnosticAlarms, productVariant=productVariant, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, daylightSaving=daylightSaving, phyControlInstancedTableNumber=phyControlInstancedTableNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, dataBridgingAvailability=dataBridgingAvailability, phyControlInstancedTableIndex=phyControlInstancedTableIndex, dfsGroup=dfsGroup, tdmTable=tdmTable, licenseSecurityLevel=licenseSecurityLevel, rawReceivePowerLinked=rawReceivePowerLinked, auxPortQLRx=auxPortQLRx, sFPPortSSMTx=sFPPortSSMTx, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hTTPAccessEnabled=hTTPAccessEnabled, sNTPState=sNTPState, mgmtInstancedTable=mgmtInstancedTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, receiveDataRate=receiveDataRate, userTableEntry=userTableEntry, productName=productName, sMTPEmailAlert=sMTPEmailAlert, useVLANForManagementInterfaces=useVLANForManagementInterfaces, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortAcceptedQLRx=auxPortAcceptedQLRx, userTable=userTable, dNS=dNS, routerProtocols=routerProtocols, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sFPPortAllocation=sFPPortAllocation, encryptionGroup=encryptionGroup, aAAControlGroup=aAAControlGroup, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, secureModeAlarm=secureModeAlarm, whitelistRMEnabled=whitelistRMEnabled, pubStats=pubStats, syncETrackingState=syncETrackingState, auxPortSSMTx=auxPortSSMTx, oOBPriorityQueueMapping=oOBPriorityQueueMapping, ptpTrapPrefix=ptpTrapPrefix, tDMInterfaceControl=tDMInterfaceControl, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseIssueNumber=licenseIssueNumber, dataPortPauseFrames=dataPortPauseFrames, tFTPServerInternetAddress=tFTPServerInternetAddress, dNSPrimaryServer=dNSPrimaryServer, byteErrorRatioLinked=byteErrorRatioLinked, wirelessOutEthernetOctets=wirelessOutEthernetOctets, severelyErroredSeconds=severelyErroredSeconds, sNMPTrapTableEntry=sNMPTrapTableEntry, dNSServerPortNumber=dNSServerPortNumber, mainPSUPortQLRx=mainPSUPortQLRx, installStatus=installStatus, transmitModulationMode=transmitModulationMode, cableDiagPair1Distance=cableDiagPair1Distance, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, receiveFreqMHz=receiveFreqMHz, tempPcb=tempPcb, receiveFreqKHz=receiveFreqKHz, linkLossLinked=linkLossLinked, sNMPv3Enable=sNMPv3Enable, alarmsGroup=alarmsGroup, alarmInstancedTable=alarmInstancedTable, licenseInstancedTableIndex=licenseInstancedTableIndex, licenseCapacity=licenseCapacity, sFPPortDisabledWarning=sFPPortDisabledWarning, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, receivePower=receivePower, userEnabled=userEnabled, mainPSUPortStatusTrap=mainPSUPortStatusTrap, tdmTableIndex=tdmTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, subbandHighestFrequency=subbandHighestFrequency, aAAControl=aAAControl, sFPPortAutoNegotiation=sFPPortAutoNegotiation, dfsTableNumber=dfsTableNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, phyInstancedStatusTable=phyInstancedStatusTable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPEnabledTraps=sNMPEnabledTraps, unitName=unitName, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPServerTableEntry=sNTPServerTableEntry, supplementaryGroup=supplementaryGroup, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, phyControlInstancedTable=phyControlInstancedTable, mPLSTCPriorityTable=mPLSTCPriorityTable, bootVersion=bootVersion, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sNTPServerPortNumber=sNTPServerPortNumber, transmitModulationModeLinked=transmitModulationModeLinked, cableDiagnosticsControl=cableDiagnosticsControl, ptpGroups=ptpGroups, sFPError=sFPError, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, PYSNMP_MODULE_ID=cambium, systemClock=systemClock, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dNSGroup=dNSGroup, pubStatsGroup=pubStatsGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, userName=userName, tDMConfigurationMismatch=tDMConfigurationMismatch, cableLoss=cableLoss, licenseInstancedTableNumber=licenseInstancedTableNumber, iPv4Address=iPv4Address, phyControlGroup=phyControlGroup, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, ethernetInstancedTable=ethernetInstancedTable, channelBandwidth=channelBandwidth, telnetAccessEnabled=telnetAccessEnabled, groupID=groupID, vLANManagementVID=vLANManagementVID, managementNetworkAccessEnabled=managementNetworkAccessEnabled, auxPortAllocation=auxPortAllocation, signalStrengthRatioLinked=signalStrengthRatioLinked, ethernetStatisticsDataSource=ethernetStatisticsDataSource, linkModeOptimizationMismatch=linkModeOptimizationMismatch, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, secondarySoftwareVersion=secondarySoftwareVersion, useVLANForMABProtocol=useVLANForMABProtocol, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, dataBridgingStatusLinked=dataBridgingStatusLinked, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, phyControl=phyControl, sMTPServerInternetAddress=sMTPServerInternetAddress, tDM=tDM, licenseVersion=licenseVersion, sNMPTrapTable=sNMPTrapTable, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, installArmState=installArmState, syslogClientTrap=syslogClientTrap, licenseGasGroup=licenseGasGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, dNSResolver=dNSResolver, ptpCompliance=ptpCompliance, authorizationControlGroup=authorizationControlGroup, licenseRegulatoryBandsList=licenseRegulatoryBandsList, unitOutOfCalibration=unitOutOfCalibration, tDMChannelCableLength=tDMChannelCableLength, regulatoryBand=regulatoryBand, managementGroup=managementGroup, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mainPSUPortAllocation=mainPSUPortAllocation, cableDiagPair3Results=cableDiagPair3Results, configurationInstancedTable=configurationInstancedTable, dfsTable=dfsTable, licenseSFPPortSupport=licenseSFPPortSupport, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sFPPortStatusTrap=sFPPortStatusTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseTrialPeriod=licenseTrialPeriod, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNTPServerInternetAddress=sNTPServerInternetAddress, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, siteName=siteName, dfsPeaks=dfsPeaks, authorizationMethod=authorizationMethod, licenseGroupAccess=licenseGroupAccess, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, installStatusTrap=installStatusTrap, lowestDataModulationMode=lowestDataModulationMode, authorizationControlTable=authorizationControlTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubInstancedStatsTable=pubInstancedStatsTable, tFTPClient=tFTPClient, wirelessOutOctets=wirelessOutOctets, sNTPPrimaryServer=sNTPPrimaryServer, unavailableSeconds=unavailableSeconds, longitude=longitude, auxPortQLTx=auxPortQLTx, mABNominalTransmitCapacity=mABNominalTransmitCapacity, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, remoteMACAddressLinked=remoteMACAddressLinked, transmitChannel=transmitChannel, sFPErrorTrap=sFPErrorTrap, cambium=cambium, rangingMode=rangingMode, wirelessOutAllOctets=wirelessOutAllOctets, configuration=configuration, resetGroup=resetGroup, management=management, signalStrengthRatio=signalStrengthRatio, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapTableIndex=sNMPTrapTableIndex, alarmInstancedTableIndex=alarmInstancedTableIndex, snmpControlGroup=snmpControlGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, rangeLinked=rangeLinked, alarmInstancedTableNumber=alarmInstancedTableNumber, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, timeZone=timeZone, remoteInternetAddress=remoteInternetAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteInternetAddressType=remoteInternetAddressType, dNSServerInternetAddress=dNSServerInternetAddress, transmitPowerLinked=transmitPowerLinked, unitIdentificationGroup=unitIdentificationGroup, syslogState=syslogState, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, systemReset=systemReset, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, linkSymmetry=linkSymmetry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, authorizationControlTableEntry=authorizationControlTableEntry, sNMPCommunityString=sNMPCommunityString, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenseTLSRekey=licenseTLSRekey, notificationsGroup=notificationsGroup, ethernetStatisticsTable=ethernetStatisticsTable, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, licenseRARSupport=licenseRARSupport, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, maximumTransmitPower=maximumTransmitPower, ptp670=ptp670, remoteMACAddress=remoteMACAddress, licenseEncryption=licenseEncryption, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, syslogControl=syslogControl, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, syncESlavePort=syncESlavePort, secureModeAlarmTrap=secureModeAlarmTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", antennaGain=antennaGain, subnetMask=subnetMask, portAllocationMismatchTrap=portAllocationMismatchTrap, iPv6PrefixLength=iPv6PrefixLength, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNTPLastSync=sNTPLastSync, hTTPPortNumber=hTTPPortNumber, linkName=linkName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, gatewayIPAddress=gatewayIPAddress, mainPSUPortSSMTx=mainPSUPortSSMTx, nIDULanPortStatus=nIDULanPortStatus, searchStateLinked=searchStateLinked, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyStatus=phyStatus, hCMPMaximumLinkRange=hCMPMaximumLinkRange, deviceESN=deviceESN, configurationGroup=configurationGroup, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, latitude=latitude, hCMPLinkSymmetry=hCMPLinkSymmetry, authorizationControlTableIndex=authorizationControlTableIndex, portAllocationMismatchLinked=portAllocationMismatchLinked, licenseTDDSyncSupport=licenseTDDSyncSupport, transparentClockVLAN=transparentClockVLAN, mgmtInstancedTableEntry=mgmtInstancedTableEntry, auxPortStatusTrap=auxPortStatusTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sNMPTrapVersion=sNMPTrapVersion, transmitDataRate=transmitDataRate, cableDiagPair2Results=cableDiagPair2Results, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, receivePowerLinked=receivePowerLinked, tDDControl=tDDControl, mgmtInstancedTableIndex=mgmtInstancedTableIndex, aggregateDataRateLinked=aggregateDataRateLinked, masterSlaveMode=masterSlaveMode, transmitFreqKHz=transmitFreqKHz, bridge=bridge, licenseInstancedTableEntry=licenseInstancedTableEntry, packetsToInternalStack=packetsToInternalStack, installStatusLinked=installStatusLinked, rawReceivePower=rawReceivePower, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, enableTransmission=enableTransmission, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mABMaintenanceLevel=mABMaintenanceLevel, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, configurationInstancedTableNumber=configurationInstancedTableNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tDDControlGroup=tDDControlGroup, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sFPPortAutoMdix=sFPPortAutoMdix, licenseIPv6Support=licenseIPv6Support)
