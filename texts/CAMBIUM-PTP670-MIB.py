...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", configurationInstancedTable=configurationInstancedTable, license=license, alarmInstancedTable=alarmInstancedTable, remoteMACAddress=remoteMACAddress, authorizationMethod=authorizationMethod, licenseTLSRekey=licenseTLSRekey, tDMInterfaceStatus=tDMInterfaceStatus, sNTPLastSync=sNTPLastSync, siteName=siteName, phyControl=phyControl, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sNMPTrapPortNumber=sNMPTrapPortNumber, cableDiagnosticsResultTable=cableDiagnosticsResultTable, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNTPServerTableNumber=sNTPServerTableNumber, tdmTableIndex=tdmTableIndex, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, cableDiagPair3Distance=cableDiagPair3Distance, antennaGain=antennaGain, receiveFreqKHz=receiveFreqKHz, bridge=bridge, erroredSeconds=erroredSeconds, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseCountry=licenseCountry, phyInstancedStatusTable=phyInstancedStatusTable, receiveModulationModeLinked=receiveModulationModeLinked, mgmtInstancedTable=mgmtInstancedTable, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, remoteInternetAddressLinked=remoteInternetAddressLinked, mainPSUPortAutoMdix=mainPSUPortAutoMdix, receiveDataRateLinked=receiveDataRateLinked, telnetPortNumber=telnetPortNumber, tDDControlGroup=tDDControlGroup, auxPortDisabledWarning=auxPortDisabledWarning, useVLANForMABProtocol=useVLANForMABProtocol, syncETrackingState=syncETrackingState, dfsGroup=dfsGroup, ethernetInstancedTableEntry=ethernetInstancedTableEntry, wirelessTopology=wirelessTopology, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, installationMode=installationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tDMChannelLoopback=tDMChannelLoopback, dNSServerTableIndex=dNSServerTableIndex, tempPcb=tempPcb, wirelessLinkAvailability=wirelessLinkAvailability, pubStatsGroup=pubStatsGroup, subbandLowestFrequency=subbandLowestFrequency, licenseMaxLinkRange=licenseMaxLinkRange, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNTPServerStatus=sNTPServerStatus, targetMACAddress=targetMACAddress, wirelessLinkStatus=wirelessLinkStatus, byteErrorRatioLinked=byteErrorRatioLinked, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, pubInstancedStatsTable=pubInstancedStatsTable, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mABNominalTransmitCapacity=mABNominalTransmitCapacity, hardwareVersion=hardwareVersion, managementNetworkAccessEnabled=managementNetworkAccessEnabled, smtpGroup=smtpGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDControl=tDDControl, dfsPeaks=dfsPeaks, iPVersion=iPVersion, whitelistRMMacAddress=whitelistRMMacAddress, tDMChannelLineCode=tDMChannelLineCode, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, tFTPClient=tFTPClient, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, receiveFreqMHz=receiveFreqMHz, dNSServerInternetAddressType=dNSServerInternetAddressType, signalStrengthRatio=signalStrengthRatio, ethernetStatisticsTable=ethernetStatisticsTable, iPv6Address=iPv6Address, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, linkName=linkName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mABNominalModulationMode=mABNominalModulationMode, transparentClockVLAN=transparentClockVLAN, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, alarmInstancedTableNumber=alarmInstancedTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, wirelessLinkStatusLinked=wirelessLinkStatusLinked, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, dNSResolver=dNSResolver, supplementaryGroup=supplementaryGroup, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, linkSymmetry=linkSymmetry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyControlInstancedTableIndex=phyControlInstancedTableIndex, capacityVariantMismatchLinked=capacityVariantMismatchLinked, snmpControl=snmpControl, systemReset=systemReset, hCMPLinkSymmetry=hCMPLinkSymmetry, dNS=dNS, syncETracking=syncETracking, sNTPServerTimeout=sNTPServerTimeout, byteErrorRatio=byteErrorRatio, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, regulatoryBand=regulatoryBand, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, hCMPMaximumLinkRange=hCMPMaximumLinkRange, managementPortWirelessDownAlert=managementPortWirelessDownAlert, portAllocationMismatchLinked=portAllocationMismatchLinked, incompatibleMasterAndSlave=incompatibleMasterAndSlave, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDMChannelStatusTrap=tDMChannelStatusTrap, vectorErrorLinked=vectorErrorLinked, configuration=configuration, tDMGroup=tDMGroup, auxPortStatus=auxPortStatus, auxPortSSMTx=auxPortSSMTx, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, accessMethod=accessMethod, remoteUnitName=remoteUnitName, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, deviceMACAddress=deviceMACAddress, tdmTableNumber=tdmTableNumber, licenseSecurityLevel=licenseSecurityLevel, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, rawReceivePower=rawReceivePower, txColorCode=txColorCode, cableDiagnosticsPorts=cableDiagnosticsPorts, transmitterChannels=transmitterChannels, authorizationControlGroup=authorizationControlGroup, auxPortStatusTrap=auxPortStatusTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, capacityVariantMismatch=capacityVariantMismatch, sntp=sntp, unitIdentification=unitIdentification, mgmtInstancedTableEntry=mgmtInstancedTableEntry, versionsGroup=versionsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syncESlavePort=syncESlavePort, transmitFreqKHz=transmitFreqKHz, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, unitIdentificationGroup=unitIdentificationGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation, dfs=dfs, auxPortQLRx=auxPortQLRx, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sFPPortQLTx=sFPPortQLTx, authorizationControlTable=authorizationControlTable, receiveModulationMode=receiveModulationMode, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, unavailableSeconds=unavailableSeconds, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, packetsToInternalStack=packetsToInternalStack, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, remoteInternetAddress=remoteInternetAddress, sFPPortAutoMdix=sFPPortAutoMdix, tDMConfigurationMismatch=tDMConfigurationMismatch, sFPPortQLRx=sFPPortQLRx, ptmp=ptmp, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, reset=reset, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogClient=syslogClient, productVariant=productVariant, licenseIEEE1588Support=licenseIEEE1588Support, tDMEnabledChannels=tDMEnabledChannels, transmitPowerLinked=transmitPowerLinked, deviceESN=deviceESN, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, rangeLinked=rangeLinked, antennaSelection=antennaSelection, iPv4Address=iPv4Address, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, phyControlInstancedTable=phyControlInstancedTable, ptpGroups=ptpGroups, licenseCapacity=licenseCapacity, hTTPSAccessEnabled=hTTPSAccessEnabled, longitude=longitude, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, dfsTableEntry=dfsTableEntry, sFPPortSSMTx=sFPPortSSMTx, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, authorizationControlTableIndex=authorizationControlTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptp670=ptp670, timeZone=timeZone, ethernetInstancedTable=ethernetInstancedTable, signalStrengthRatioLinked=signalStrengthRatioLinked, transmitChannel=transmitChannel, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mainPSUPortStatus=mainPSUPortStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, mainPSUPortQLRx=mainPSUPortQLRx, dNSGroup=dNSGroup, transmitDataRateLinked=transmitDataRateLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, alarmInstancedTableEntry=alarmInstancedTableEntry, mABState=mABState, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ptpTrapPrefix=ptpTrapPrefix, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, enableTransmission=enableTransmission, sNTPServerTableIndex=sNTPServerTableIndex, dNSServerTableNumber=dNSServerTableNumber, remoteMACAddressLinked=remoteMACAddressLinked, licenseTDDSyncSupport=licenseTDDSyncSupport, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, mABTransmissionInterval=mABTransmissionInterval, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, ethernet=ethernet, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mABHoldoffPeriod=mABHoldoffPeriod, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, pubStats=pubStats, l2CPPriorityTableNumber=l2CPPriorityTableNumber, nIDULanPortAutoMdix=nIDULanPortAutoMdix, lowestDataModulationMode=lowestDataModulationMode, userName=userName, cableDiagPair2Distance=cableDiagPair2Distance, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, authorizationControl=authorizationControl, installStatusTrap=installStatusTrap, smtp=smtp, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dataPortPauseFrames=dataPortPauseFrames, receivePowerLinked=receivePowerLinked, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, receiveDataRate=receiveDataRate, sNTPPrimaryServer=sNTPPrimaryServer, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseEncryption=licenseEncryption, cableDiagPair4Results=cableDiagPair4Results, unitName=unitName, lbtDetectedTrap=lbtDetectedTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, userTableIndex=userTableIndex, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTraps=ptpTraps, apcGroup=apcGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userEnabled=userEnabled, encryptionGroup=encryptionGroup, tDDSynchronizationMode=tDDSynchronizationMode, txMABFrames=txMABFrames, tdmTableEntry=tdmTableEntry, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, cambium=cambium, linkLoss=linkLoss, installStatusLinked=installStatusLinked, cableDiagPair1Results=cableDiagPair1Results, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, authorizationControlTableEntry=authorizationControlTableEntry, tDMChannelCableLength=tDMChannelCableLength, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, hTTPPortNumber=hTTPPortNumber, transmitFreqMHz=transmitFreqMHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseRARSupport=licenseRARSupport, sntpGroup=sntpGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, remoteUnitNameLinked=remoteUnitNameLinked, productName=productName, tFTPServerPortNumber=tFTPServerPortNumber, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tDMInterfaceControl=tDMInterfaceControl, managementGroup=managementGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatus=phyStatus, dfsMeans=dfsMeans, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userRole=userRole, ethernetPriorityTable=ethernetPriorityTable, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, maxLinkRangeExceeded=maxLinkRangeExceeded, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDM=tDM, l2CPPriorityTable=l2CPPriorityTable, sNTPState=sNTPState, supplementary=supplementary, resetGroup=resetGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, severelyErroredSeconds=severelyErroredSeconds, rxColorCode=rxColorCode, sNTPServerInternetAddress=sNTPServerInternetAddress, aAAControl=aAAControl, sNMPEnabledTraps=sNMPEnabledTraps, sFPPortStatus=sFPPortStatus, rawReceivePowerLinked=rawReceivePowerLinked, userTable=userTable, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseSyncESupport=licenseSyncESupport, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, transmitModulationModeLinked=transmitModulationModeLinked, masterSlaveMode=masterSlaveMode, searchState=searchState, snmpControlGroup=snmpControlGroup, linkLossLinked=linkLossLinked, sNMPv3Enable=sNMPv3Enable, apc=apc, ethernetInstancedTableIndex=ethernetInstancedTableIndex, eIRP=eIRP, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sNTPPollInterval=sNTPPollInterval, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, lowestTDMModulationMode=lowestTDMModulationMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogClientTrap=syslogClientTrap, rangingMode=rangingMode, alarms=alarms, versions=versions, softwareVersion=softwareVersion, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, configurationInstancedTableEntry=configurationInstancedTableEntry, latitude=latitude, tFTPServerInternetAddressType=tFTPServerInternetAddressType, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, blacklistRMMacAddress=blacklistRMMacAddress, portAllocationMismatch=portAllocationMismatch, bootVersion=bootVersion, dfsTable=dfsTable, sFPErrorTrap=sFPErrorTrap, cableLoss=cableLoss, cableDiagnostics=cableDiagnostics, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNMPCommunityString=sNMPCommunityString, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, alarmInstancedTableIndex=alarmInstancedTableIndex, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNTPSync=sNTPSync, dNSServerInternetAddress=dNSServerInternetAddress, mainPSUPortQLTx=mainPSUPortQLTx, wirelessOutEthernetOctets=wirelessOutEthernetOctets, installArmState=installArmState, noWirelessChannelAvailable=noWirelessChannelAvailable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mainPSUPortStatusTrap=mainPSUPortStatusTrap, aAAControlGroup=aAAControlGroup, sFPPortStatusTrap=sFPPortStatusTrap, vectorError=vectorError, localPacketFiltering=localPacketFiltering, subbandHighestFrequency=subbandHighestFrequency, cableDiagnosticsWarning=cableDiagnosticsWarning, mABMaintenanceLevel=mABMaintenanceLevel, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, ethernetGroup=ethernetGroup, phyControlGroup=phyControlGroup, licenseHCMPSupport=licenseHCMPSupport, sNMPPortNumber=sNMPPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseInstancedTableIndex=licenseInstancedTableIndex, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseInstancedTableEntry=licenseInstancedTableEntry, packetsFromInternalStack=packetsFromInternalStack, maximumTransmitPower=maximumTransmitPower, groupID=groupID, cableDiagPair2Results=cableDiagPair2Results, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, hTTPSPortNumber=hTTPSPortNumber, wirelessOutAllOctets=wirelessOutAllOctets, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteInternetAddressType=remoteInternetAddressType, searchStateLinked=searchStateLinked, sNMPTrapTableEntry=sNMPTrapTableEntry, dataBridgingAvailability=dataBridgingAvailability, licenseVersion=licenseVersion, mABProtocolVID=mABProtocolVID, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, targetRange=targetRange, encryption=encryption, iPv6PrefixLength=iPv6PrefixLength, cableDiagPair4Distance=cableDiagPair4Distance, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, installArmStateTrap=installArmStateTrap, tDMChannelStatus=tDMChannelStatus, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, alarmsGroup=alarmsGroup, vLANManagementPriority=vLANManagementPriority, configurationInstancedTableNumber=configurationInstancedTableNumber, encryptionAlgorithm=encryptionAlgorithm, nIDULanPortStatus=nIDULanPortStatus, dNSServerPortNumber=dNSServerPortNumber, licenseInstancedTable=licenseInstancedTable, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPv6GatewayAddress=iPv6GatewayAddress, sMTPEmailAlert=sMTPEmailAlert, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortAllocation=mainPSUPortAllocation, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseSFPPortSupport=licenseSFPPortSupport, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseUnitSerialNumber=licenseUnitSerialNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, frequencyVariant=frequencyVariant, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, aggregateDataRateLinked=aggregateDataRateLinked, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, subnetMask=subnetMask, regulatoryBandTrap=regulatoryBandTrap, userTableEntry=userTableEntry, cableDiagPair1Distance=cableDiagPair1Distance, receivePower=receivePower, mgmtInstancedTableIndex=mgmtInstancedTableIndex, notificationsGroup=notificationsGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transparentClock=transparentClock, linkModeOptimization=linkModeOptimization, licenseIPv6Support=licenseIPv6Support, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerRetries=sNTPServerRetries, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, syslogState=syslogState, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, channelBandwidth=channelBandwidth, systemClock=systemClock, portAllocationMismatchTrap=portAllocationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, syncEEquipmentClock=syncEEquipmentClock, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSyncTrap=sNTPSyncTrap, sFPError=sFPError, routerProtocols=routerProtocols, sNTPServerTable=sNTPServerTable, mgmtInstancedTableNumber=mgmtInstancedTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, blacklistRMEnabled=blacklistRMEnabled, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, configurationGroup=configurationGroup, dNSServerTable=dNSServerTable, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, dSCPManagementPriority=dSCPManagementPriority, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, routerProtocolsGroup=routerProtocolsGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, PYSNMP_MODULE_ID=cambium, auxPortSyncERxStatus=auxPortSyncERxStatus, secondarySoftwareVersion=secondarySoftwareVersion, auxPortAllocation=auxPortAllocation, channelChangeTrap=channelChangeTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userPassword=userPassword, licenseGasGroup=licenseGasGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, cableDiagPair3Results=cableDiagPair3Results, licenseRegulatoryBandsList=licenseRegulatoryBandsList, whitelistRMEnabled=whitelistRMEnabled, licenseGroup=licenseGroup, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, userTableNumber=userTableNumber, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, installStatus=installStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, daylightSaving=daylightSaving, dfsTableNumber=dfsTableNumber, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, syslogStateTrap=syslogStateTrap, transmitDataRate=transmitDataRate, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dNSServerTableEntry=dNSServerTableEntry, vLANManagementVID=vLANManagementVID, ethernetStatisticsDataSource=ethernetStatisticsDataSource)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortStatusTrap=nIDULanPortStatusTrap, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, dfsTableIndex=dfsTableIndex, receiveChannel=receiveChannel, transparentClockPort=transparentClockPort, ptpCompliance=ptpCompliance, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tDDSynchronizationStatus=tDDSynchronizationStatus, telnetAccessEnabled=telnetAccessEnabled, phyStatusGroup=phyStatusGroup, wirelessOutOctets=wirelessOutOctets, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, authorizationControlTableNumber=authorizationControlTableNumber, licenseGroupAccess=licenseGroupAccess, extendedSpectrumScanning=extendedSpectrumScanning, qOSPriorityScheme=qOSPriorityScheme, management=management, syslogControlGroup=syslogControlGroup, licenseBandwidthCap=licenseBandwidthCap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, syslogControl=syslogControl, ptp=ptp, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sFPPortAllocation=sFPPortAllocation, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseInstancedTableNumber=licenseInstancedTableNumber, licenseIssueNumber=licenseIssueNumber, cableDiagnosticsControl=cableDiagnosticsControl, transmitModulationMode=transmitModulationMode, range=range, sFPPortDisabledWarning=sFPPortDisabledWarning, aggregateDataRate=aggregateDataRate, dNSPrimaryServer=dNSPrimaryServer, sNMPTrapTable=sNMPTrapTable, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transparentClockVID=transparentClockVID, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, bridgeGroup=bridgeGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, altitude=altitude, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, auxPortQLTx=auxPortQLTx, tFTPServerInternetAddress=tFTPServerInternetAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, secureModeAlarm=secureModeAlarm, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tdmTable=tdmTable, sFPPortSyncERxStatus=sFPPortSyncERxStatus, dataBridgingStatusLinked=dataBridgingStatusLinked, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, deviceMSN=deviceMSN, dataBridgingStatus=dataBridgingStatus)
