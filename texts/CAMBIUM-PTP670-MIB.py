...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPServerTableEntry=sNTPServerTableEntry, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapInternetAddress=sNMPTrapInternetAddress, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, ptpTraps=ptpTraps, remoteUnitName=remoteUnitName, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, dfsGroup=dfsGroup, transmitDataRateLinked=transmitDataRateLinked, antennaGain=antennaGain, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, cableDiagPair1Distance=cableDiagPair1Distance, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveFreqMHz=receiveFreqMHz, sFPPortStatusTrap=sFPPortStatusTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, tDMChannelLineCode=tDMChannelLineCode, encryptionGroup=encryptionGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, supplementaryGroup=supplementaryGroup, alarms=alarms, dfsTableIndex=dfsTableIndex, sntpGroup=sntpGroup, licenseTDDSyncSupport=licenseTDDSyncSupport, softwareVersion=softwareVersion, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, alarmInstancedTable=alarmInstancedTable, userTableIndex=userTableIndex, portAllocationMismatchLinked=portAllocationMismatchLinked, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, aAAControlGroup=aAAControlGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitPowerLinked=transmitPowerLinked, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, erroredSeconds=erroredSeconds, syncESlavePort=syncESlavePort, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vectorErrorLinked=vectorErrorLinked, mABProtocolVID=mABProtocolVID, dNSResolver=dNSResolver, sNTPState=sNTPState, packetsToInternalStack=packetsToInternalStack, sFPPortStatus=sFPPortStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tDDControl=tDDControl, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, PYSNMP_MODULE_ID=cambium, installStatusLinked=installStatusLinked, syslogClientTrap=syslogClientTrap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, routerProtocolsGroup=routerProtocolsGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ptp=ptp, transmitFreqKHz=transmitFreqKHz, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, syslogControlGroup=syslogControlGroup, licenseInstancedTable=licenseInstancedTable, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, ptmp=ptmp, transmitterChannels=transmitterChannels, ethernetStatisticsTable=ethernetStatisticsTable, tDM=tDM, cableDiagnostics=cableDiagnostics, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, apc=apc, tFTPClient=tFTPClient, timeZone=timeZone, configuration=configuration, cableDiagnosticsControl=cableDiagnosticsControl, auxPortDisabledWarning=auxPortDisabledWarning, auxPortSSMTx=auxPortSSMTx, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, deviceESN=deviceESN, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ptpCompliance=ptpCompliance, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, masterSlaveMode=masterSlaveMode, tdmTableIndex=tdmTableIndex, nIDULanPortStatus=nIDULanPortStatus, userTableEntry=userTableEntry, daylightSaving=daylightSaving, severelyErroredSeconds=severelyErroredSeconds, hTTPAccessEnabled=hTTPAccessEnabled, transparentClockVLAN=transparentClockVLAN, ethernetInstancedTable=ethernetInstancedTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptp670=ptp670, receiveModulationModeDetail=receiveModulationModeDetail, iPv6PrefixLength=iPv6PrefixLength, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sFPErrorTrap=sFPErrorTrap, secureModeAlarm=secureModeAlarm, pubStats=pubStats, tDDControlGroup=tDDControlGroup, wirelessOutEthernetOctets=wirelessOutEthernetOctets, linkLossLinked=linkLossLinked, licenseTrialPeriod=licenseTrialPeriod, cableDiagPair2Distance=cableDiagPair2Distance, l2CPPriorityTable=l2CPPriorityTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, pubInstancedStatsTable=pubInstancedStatsTable, tDMEnabledChannels=tDMEnabledChannels, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerInternetAddressType=sNTPServerInternetAddressType, hCMPLinkSymmetry=hCMPLinkSymmetry, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, sNMPEnabledTraps=sNMPEnabledTraps, phyControlInstancedTableEntry=phyControlInstancedTableEntry, cableDiagPair1Results=cableDiagPair1Results, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mainPSUPortQLRx=mainPSUPortQLRx, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseGroupAccess=licenseGroupAccess, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, userPassword=userPassword, transmitPower=transmitPower, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, tdmTableNumber=tdmTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteUnitNameLinked=remoteUnitNameLinked, wirelessLinkStatus=wirelessLinkStatus, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseMaxLinkRange=licenseMaxLinkRange, sMTPServerPortNumber=sMTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, dataPortPauseFrames=dataPortPauseFrames, dNSPrimaryServer=dNSPrimaryServer, wirelessOutAllOctets=wirelessOutAllOctets, authorizationMethod=authorizationMethod, lowestTDMModulationMode=lowestTDMModulationMode, receivePower=receivePower, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mgmtInstancedTable=mgmtInstancedTable, dataBridgingStatusLinked=dataBridgingStatusLinked, rangingMode=rangingMode, targetRange=targetRange, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, auxPortStatus=auxPortStatus, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, productVariant=productVariant, iPv4Address=iPv4Address, subnetMask=subnetMask, mABMaintenanceLevel=mABMaintenanceLevel, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, vectorError=vectorError, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, userTableNumber=userTableNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, transparentClockVID=transparentClockVID, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, alarmInstancedTableNumber=alarmInstancedTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, userTable=userTable, phyStatus=phyStatus, productName=productName, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, auxPortSyncERxStatus=auxPortSyncERxStatus, installStatus=installStatus, unitIdentification=unitIdentification, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenseCapacity=licenseCapacity, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, bridgeGroup=bridgeGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, accessMethod=accessMethod, licenseUnitSerialNumber=licenseUnitSerialNumber, phyStatusGroup=phyStatusGroup, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installStatusTrap=installStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, smtp=smtp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, whitelistRMEnabled=whitelistRMEnabled, aggregateDataRateLinked=aggregateDataRateLinked, byteErrorRatio=byteErrorRatio, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, configurationInstancedTableIndex=configurationInstancedTableIndex, mainPSUPortStatusTrap=mainPSUPortStatusTrap, aggregateDataRate=aggregateDataRate, licenseSFPPortSupport=licenseSFPPortSupport, bridge=bridge, mABProtocolVLANPriority=mABProtocolVLANPriority, auxPortQLRx=auxPortQLRx, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, cableDiagPair2Results=cableDiagPair2Results, antennaSelection=antennaSelection, nIDULanPortAutoMdix=nIDULanPortAutoMdix, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, alarmInstancedTableIndex=alarmInstancedTableIndex, licenseCountry=licenseCountry, tDMChannelStatusTrap=tDMChannelStatusTrap, rawReceivePowerLinked=rawReceivePowerLinked, gatewayIPAddress=gatewayIPAddress, transmitFreqMHz=transmitFreqMHz, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, dfsMeans=dfsMeans, receiveChannel=receiveChannel, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sNTPPollInterval=sNTPPollInterval, cableDiagnosticsWarning=cableDiagnosticsWarning, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, transparentClock=transparentClock, iPVersion=iPVersion, iPv6Address=iPv6Address, supplementary=supplementary, subbandLowestFrequency=subbandLowestFrequency, range=range, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, auxPortQLTx=auxPortQLTx, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, mainPSUPortAllocation=mainPSUPortAllocation, vLANManagementVID=vLANManagementVID, phyControlGroup=phyControlGroup, tDDSynchronizationMode=tDDSynchronizationMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, linkName=linkName, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, userName=userName, capacityVariantMismatchTrap=capacityVariantMismatchTrap, syslogControl=syslogControl, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, longitude=longitude)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mABTransmissionInterval=mABTransmissionInterval, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sFPPortQLRx=sFPPortQLRx, linkModeOptimization=linkModeOptimization, routerProtocols=routerProtocols, configurationInstancedTableEntry=configurationInstancedTableEntry, lowestDataModulationMode=lowestDataModulationMode, dfsTable=dfsTable, receiveFreqKHz=receiveFreqKHz, encryptionAlgorithm=encryptionAlgorithm, dNSServerPortNumber=dNSServerPortNumber, dfsTableEntry=dfsTableEntry, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, incompatibleRegulatoryBands=incompatibleRegulatoryBands, dataBridgingStatusAlarm=dataBridgingStatusAlarm, lbtDetectedTrap=lbtDetectedTrap, groupID=groupID, sNMPPortNumber=sNMPPortNumber, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, auxPortStatusTrap=auxPortStatusTrap, syslogState=syslogState, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, apcGroup=apcGroup, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mainPSUPortQLTx=mainPSUPortQLTx, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sNTPSync=sNTPSync, userEnabled=userEnabled, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, tFTPServerPortNumber=tFTPServerPortNumber, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNTPServerRetries=sNTPServerRetries, oOBPriorityQueueMapping=oOBPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseVersion=licenseVersion, linkSymmetry=linkSymmetry, sNTPLastSync=sNTPLastSync, unitName=unitName, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerPortNumber=sNTPServerPortNumber, useVLANForMABProtocol=useVLANForMABProtocol, authorizationControlTableNumber=authorizationControlTableNumber, installArmStateTrap=installArmStateTrap, tDMGroup=tDMGroup, pubStatsGroup=pubStatsGroup, wirelessOutOctets=wirelessOutOctets, ptpGroups=ptpGroups, configurationInstancedTableNumber=configurationInstancedTableNumber, sFPPortQLTx=sFPPortQLTx, remoteMACAddressLinked=remoteMACAddressLinked, bootVersion=bootVersion, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sFPPortAllocation=sFPPortAllocation, regulatoryBandTrap=regulatoryBandTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sFPPortDisabledWarning=sFPPortDisabledWarning, transmitModulationModeLinked=transmitModulationModeLinked, encryption=encryption, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, packetsFromInternalStack=packetsFromInternalStack, blacklistRMEnabled=blacklistRMEnabled, unitOutOfCalibration=unitOutOfCalibration, receiveDataRate=receiveDataRate, licenseTLSRekey=licenseTLSRekey, syslogStateTrap=syslogStateTrap, linkLoss=linkLoss, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, capacityVariantMismatch=capacityVariantMismatch, mgmtInstancedTableEntry=mgmtInstancedTableEntry, rxColorCode=rxColorCode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, cableDiagPair3Distance=cableDiagPair3Distance, regulatoryBand=regulatoryBand, targetMACAddress=targetMACAddress, qOSPriorityScheme=qOSPriorityScheme, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, aAAControl=aAAControl, receiveDataRateLinked=receiveDataRateLinked, licenseSecurityLevel=licenseSecurityLevel, telnetPortNumber=telnetPortNumber, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, syncETracking=syncETracking, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, cableDiagPair3Results=cableDiagPair3Results, dNS=dNS, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNMPCommunityString=sNMPCommunityString, authorizationControlTableEntry=authorizationControlTableEntry, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tDMInterfaceControl=tDMInterfaceControl, ethernetPriorityTable=ethernetPriorityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyInstancedStatusTable=phyInstancedStatusTable, rawReceivePower=rawReceivePower, systemReset=systemReset, portAllocationMismatch=portAllocationMismatch, notificationsGroup=notificationsGroup, deviceMSN=deviceMSN, enableTransmission=enableTransmission, dSCPManagementPriority=dSCPManagementPriority, sNTPServerTable=sNTPServerTable, signalStrengthRatioLinked=signalStrengthRatioLinked, installationMode=installationMode, altitude=altitude, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseEncryption=licenseEncryption, dataBridgingStatus=dataBridgingStatus, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, authorizationControlGroup=authorizationControlGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dfs=dfs, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, signalStrengthRatio=signalStrengthRatio, unitIdentificationGroup=unitIdentificationGroup, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNTPSyncTrap=sNTPSyncTrap, receiveModulationMode=receiveModulationMode, capacityVariantMismatchLinked=capacityVariantMismatchLinked, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, ptpTrapPrefix=ptpTrapPrefix, transmitChannel=transmitChannel, remoteInternetAddressType=remoteInternetAddressType, licenseRARSupport=licenseRARSupport, versions=versions, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, authorizationControl=authorizationControl, sNMPTrapTable=sNMPTrapTable, receivePowerLinked=receivePowerLinked, cambium=cambium, mABHoldoffPeriod=mABHoldoffPeriod, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dNSServerTable=dNSServerTable, noWirelessChannelAvailable=noWirelessChannelAvailable, maxLinkRangeExceeded=maxLinkRangeExceeded, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dNSServerInternetAddress=dNSServerInternetAddress, mABNominalModulationMode=mABNominalModulationMode, tDMChannelLoopback=tDMChannelLoopback, hTTPSPortNumber=hTTPSPortNumber, licenseInstancedTableNumber=licenseInstancedTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, reset=reset, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, wirelessLinkAvailability=wirelessLinkAvailability, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, portAllocationMismatchTrap=portAllocationMismatchTrap, dNSGroup=dNSGroup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sNMPTrapPortNumber=sNMPTrapPortNumber, frequencyVariant=frequencyVariant, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, tdmTable=tdmTable, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dNSServerTableIndex=dNSServerTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hCMPMaximumLinkRange=hCMPMaximumLinkRange, installArmState=installArmState, licenseHCMPSupport=licenseHCMPSupport, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, txColorCode=txColorCode, snmpControl=snmpControl, ethernet=ethernet, sFPError=sFPError, cableLoss=cableLoss, dNSServerTableEntry=dNSServerTableEntry, vLANManagementPriority=vLANManagementPriority, syncETrackingState=syncETrackingState, licenseIPv6Support=licenseIPv6Support, receiveModulationModeLinked=receiveModulationModeLinked, wirelessTopology=wirelessTopology, sMTPEmailAlert=sMTPEmailAlert, unavailableSeconds=unavailableSeconds, cableDiagPair4Results=cableDiagPair4Results, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, wirelessLinkStatusLinked=wirelessLinkStatusLinked, phyControl=phyControl, extendedSpectrumScanning=extendedSpectrumScanning, cableDiagPair4Distance=cableDiagPair4Distance, byteErrorRatioLinked=byteErrorRatioLinked, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseIssueNumber=licenseIssueNumber, rangeLinked=rangeLinked, license=license, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, localPacketFiltering=localPacketFiltering, ethernetInstancedTableNumber=ethernetInstancedTableNumber, remoteMACAddress=remoteMACAddress, transparentClockPort=transparentClockPort, mainPSUPortStatus=mainPSUPortStatus, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDMConfigurationMismatch=tDMConfigurationMismatch, mABState=mABState, versionsGroup=versionsGroup, dfsTableNumber=dfsTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, eIRP=eIRP, channelBandwidth=channelBandwidth, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseGasGroup=licenseGasGroup, licenseInstancedTableIndex=licenseInstancedTableIndex, configurationInstancedTable=configurationInstancedTable, telnetAccessEnabled=telnetAccessEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseSyncESupport=licenseSyncESupport, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, maximumTransmitPower=maximumTransmitPower, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, deviceMACAddress=deviceMACAddress, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, ethernetGroup=ethernetGroup, tdmTableEntry=tdmTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, ethernetStatisticsDataSource=ethernetStatisticsDataSource)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sntp=sntp, dfsPeaks=dfsPeaks, dNSServerTableNumber=dNSServerTableNumber, tDMChannelCableLength=tDMChannelCableLength, licenseGroup=licenseGroup, dataBridgingAvailability=dataBridgingAvailability, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteInternetAddressLinked=remoteInternetAddressLinked, blacklistRMMacAddress=blacklistRMMacAddress, whitelistRMMacAddress=whitelistRMMacAddress, subbandHighestFrequency=subbandHighestFrequency, alarmsGroup=alarmsGroup, licenseBandwidthCap=licenseBandwidthCap, iPDSCPPriorityTable=iPDSCPPriorityTable, licenseOOBManagementSupport=licenseOOBManagementSupport, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, syslogClient=syslogClient, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteInternetAddress=remoteInternetAddress, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dNSServerInternetAddressType=dNSServerInternetAddressType, authorizationControlTableIndex=authorizationControlTableIndex, licenseIEEE1588Support=licenseIEEE1588Support, latitude=latitude, resetGroup=resetGroup, managementGroup=managementGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tDMInterfaceStatus=tDMInterfaceStatus, phyControlInstancedTable=phyControlInstancedTable, management=management, sFPPortAutoMdix=sFPPortAutoMdix, channelChangeTrap=channelChangeTrap, authorizationControlTable=authorizationControlTable, tempPcb=tempPcb, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, systemClock=systemClock, alarmInstancedTableEntry=alarmInstancedTableEntry, maximumNumberOfSlaves=maximumNumberOfSlaves, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, txMABFrames=txMABFrames, sNMPv3Enable=sNMPv3Enable, syncEEquipmentClock=syncEEquipmentClock, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sNTPServerStatus=sNTPServerStatus, auxPortAllocation=auxPortAllocation, searchStateLinked=searchStateLinked, hardwareVersion=hardwareVersion, tDMChannelStatus=tDMChannelStatus, userRole=userRole, smtpGroup=smtpGroup, sNTPServerTableIndex=sNTPServerTableIndex, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sFPPortSSMTx=sFPPortSSMTx, sNMPTrapVersion=sNMPTrapVersion, sNTPServerTimeout=sNTPServerTimeout, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, transmitDataRate=transmitDataRate, searchState=searchState)
