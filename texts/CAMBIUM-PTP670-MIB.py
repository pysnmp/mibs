...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, cableDiagnosticsResultTable=cableDiagnosticsResultTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsTable=dfsTable, hCMPLinkSymmetry=hCMPLinkSymmetry, configurationGroup=configurationGroup, deviceESN=deviceESN, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, subnetMask=subnetMask, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, cableDiagPair2Distance=cableDiagPair2Distance, sNMPPortNumber=sNMPPortNumber, dSCPManagementPriority=dSCPManagementPriority, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, cableDiagPair3Distance=cableDiagPair3Distance, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, enableTransmission=enableTransmission, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitPowerLinked=transmitPowerLinked, deviceMACAddress=deviceMACAddress, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, siteName=siteName, ptp670=ptp670, licenseIssueNumber=licenseIssueNumber, licenseSecurityLevel=licenseSecurityLevel, wirelessLinkAvailability=wirelessLinkAvailability, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseTrialPeriod=licenseTrialPeriod, sNMPTrapTable=sNMPTrapTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDControlGroup=tDDControlGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, transmitDataRateLinked=transmitDataRateLinked, dfsPeaks=dfsPeaks, sntp=sntp, configurationInstancedTableEntry=configurationInstancedTableEntry, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, targetRange=targetRange, ethernetGroup=ethernetGroup, whitelistRMMacAddress=whitelistRMMacAddress, lbtDetectedTrap=lbtDetectedTrap, dNSServerPortNumber=dNSServerPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dNSPrimaryServer=dNSPrimaryServer, tDMConfigurationMismatch=tDMConfigurationMismatch, receiveModulationMode=receiveModulationMode, dNSServerTableNumber=dNSServerTableNumber, systemClock=systemClock, sNMPv3Enable=sNMPv3Enable, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseCapacity=licenseCapacity, dataBridgingStatus=dataBridgingStatus, cableDiagPair2Results=cableDiagPair2Results, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, snmpControl=snmpControl, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, dNSServerInternetAddressType=dNSServerInternetAddressType, tdmTable=tdmTable, ethernetInstancedTableIndex=ethernetInstancedTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDMInterfaceControl=tDMInterfaceControl, portAllocationMismatchLinked=portAllocationMismatchLinked, subbandHighestFrequency=subbandHighestFrequency, versions=versions, phyControlGroup=phyControlGroup, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ptmp=ptmp, timeZone=timeZone, secureModeAlarm=secureModeAlarm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, aAAControlGroup=aAAControlGroup, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, longitude=longitude, notificationsGroup=notificationsGroup, bridge=bridge, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, deviceMSN=deviceMSN, transparentClockVLAN=transparentClockVLAN, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, iPv6Address=iPv6Address, tDMGroup=tDMGroup, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, remoteMACAddress=remoteMACAddress, tDDControl=tDDControl, dNSResolver=dNSResolver, PYSNMP_MODULE_ID=cambium, sFPError=sFPError, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, transmitModulationModeLinked=transmitModulationModeLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, sFPPortQLTx=sFPPortQLTx, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, aAAControl=aAAControl, transmitModulationMode=transmitModulationMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, byteErrorRatioLinked=byteErrorRatioLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, remoteUnitNameLinked=remoteUnitNameLinked, installStatus=installStatus, ethernetInstancedTableEntry=ethernetInstancedTableEntry, auxPortStatus=auxPortStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, cableDiagPair4Results=cableDiagPair4Results, userTableNumber=userTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, receiveFreqKHz=receiveFreqKHz, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, receiveDataRateLinked=receiveDataRateLinked, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, authorizationControlGroup=authorizationControlGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, dfsMeans=dfsMeans, mABProtocolVID=mABProtocolVID, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseGasGroup=licenseGasGroup, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, cableLoss=cableLoss, receivePowerLinked=receivePowerLinked, syncETracking=syncETracking, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, regulatoryBandTrap=regulatoryBandTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, byteErrorRatio=byteErrorRatio, reset=reset, oOBPriorityQueueMapping=oOBPriorityQueueMapping, unitName=unitName, qOSPriorityScheme=qOSPriorityScheme, receiveFreqMHz=receiveFreqMHz, ethernetStatisticsTable=ethernetStatisticsTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortDisabledWarning=auxPortDisabledWarning, syncETrackingState=syncETrackingState, vLANManagementPriority=vLANManagementPriority, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, routerProtocols=routerProtocols, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPPollInterval=sNTPPollInterval, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseRARSupport=licenseRARSupport, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, smtp=smtp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, linkName=linkName, auxPortConfigurationMismatch=auxPortConfigurationMismatch, routerProtocolsGroup=routerProtocolsGroup, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNTPServerRetries=sNTPServerRetries, cableDiagnosticsGroup=cableDiagnosticsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseIPv6Support=licenseIPv6Support, dNSServerTableEntry=dNSServerTableEntry, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerTimeout=sNTPServerTimeout, supplementary=supplementary, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, authorizationControlTable=authorizationControlTable, authorizationControlTableIndex=authorizationControlTableIndex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, aggregateDataRate=aggregateDataRate, licenseTLSRekey=licenseTLSRekey, wirelessOutAllOctets=wirelessOutAllOctets, transmitDataRate=transmitDataRate, maxLinkRangeExceeded=maxLinkRangeExceeded, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetPriorityTable=ethernetPriorityTable, dfsTableNumber=dfsTableNumber, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, installStatusTrap=installStatusTrap, ptpGroups=ptpGroups, vLANManagementVID=vLANManagementVID, daylightSaving=daylightSaving, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, mABTransmissionInterval=mABTransmissionInterval, sNTPServerPortNumber=sNTPServerPortNumber, receiveDataRate=receiveDataRate, licenseIEEE1588Support=licenseIEEE1588Support, transparentClockVID=transparentClockVID, searchStateLinked=searchStateLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, rangingMode=rangingMode, iPv4Address=iPv4Address, syslogClientTrap=syslogClientTrap, localPacketFiltering=localPacketFiltering, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteMACAddressLinked=remoteMACAddressLinked, txMABFrames=txMABFrames, sFPPortDisabledWarning=sFPPortDisabledWarning, sMTPServerInternetAddressType=sMTPServerInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, targetMACAddress=targetMACAddress, rawReceivePower=rawReceivePower, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, regulatoryBand=regulatoryBand, ptpTraps=ptpTraps, sFPErrorTrap=sFPErrorTrap, userName=userName, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, packetsToInternalStack=packetsToInternalStack, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tFTPServerPortNumber=tFTPServerPortNumber, dfs=dfs, telnetPortNumber=telnetPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mainPSUPortQLTx=mainPSUPortQLTx, tDMChannelCableLength=tDMChannelCableLength, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, searchState=searchState, tDDSynchronizationMode=tDDSynchronizationMode, pubInstancedStatsTable=pubInstancedStatsTable)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", apcGroup=apcGroup, apc=apc, tdmTableNumber=tdmTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, unitIdentification=unitIdentification, userRole=userRole, dNSServerInternetAddress=dNSServerInternetAddress, sFPPortSyncERxStatus=sFPPortSyncERxStatus, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseRegulatoryBandsList=licenseRegulatoryBandsList, cableDiagnosticsPorts=cableDiagnosticsPorts, unitIdentificationGroup=unitIdentificationGroup, lowestTDMModulationMode=lowestTDMModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitPower=transmitPower, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, capacityVariantMismatchLinked=capacityVariantMismatchLinked, installArmStateTrap=installArmStateTrap, tDMChannelLineCode=tDMChannelLineCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dNSGroup=dNSGroup, telnetAccessEnabled=telnetAccessEnabled, sNTPServerTableIndex=sNTPServerTableIndex, mABNominalTransmitCapacity=mABNominalTransmitCapacity, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sFPPortAutoNegotiation=sFPPortAutoNegotiation, whitelistRMEnabled=whitelistRMEnabled, subbandLowestFrequency=subbandLowestFrequency, licenseInstancedTableIndex=licenseInstancedTableIndex, managementGroup=managementGroup, authorizationControl=authorizationControl, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPState=sNTPState, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, productName=productName, sNTPLastSync=sNTPLastSync, auxPortStatusTrap=auxPortStatusTrap, remoteInternetAddress=remoteInternetAddress, encryptionAlgorithm=encryptionAlgorithm, auxPortQLTx=auxPortQLTx, phyControlInstancedTableEntry=phyControlInstancedTableEntry, auxPortQLRx=auxPortQLRx, sNTPSyncTrap=sNTPSyncTrap, alarmInstancedTableNumber=alarmInstancedTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cableDiagPair3Results=cableDiagPair3Results, packetsFromInternalStack=packetsFromInternalStack, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, tDMChannelLoopback=tDMChannelLoopback, tFTPClient=tFTPClient, iPv6PrefixLength=iPv6PrefixLength, receiveModulationModeDetail=receiveModulationModeDetail, portAllocationMismatchTrap=portAllocationMismatchTrap, dataBridgingAvailability=dataBridgingAvailability, aggregateDataRateLinked=aggregateDataRateLinked, tDMInterfaceStatus=tDMInterfaceStatus, sMTPEmailAlert=sMTPEmailAlert, channelBandwidth=channelBandwidth, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, cambium=cambium, pubStats=pubStats, masterSlaveMode=masterSlaveMode, licenseInstancedTableNumber=licenseInstancedTableNumber, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagnostics=cableDiagnostics, sNTPServerTable=sNTPServerTable, syslogControlGroup=syslogControlGroup, supplementaryGroup=supplementaryGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, userTable=userTable, licenseVersion=licenseVersion, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tdmTableEntry=tdmTableEntry, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mainPSUPortSSMTx=mainPSUPortSSMTx, mABProtocolVLANPriority=mABProtocolVLANPriority, installationMode=installationMode, dataBridgingStatusAlarm=dataBridgingStatusAlarm, authorizationControlTableNumber=authorizationControlTableNumber, dNSServerTableIndex=dNSServerTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tDM=tDM, dfsTableEntry=dfsTableEntry, hardwareVersion=hardwareVersion, mainPSUPortAllocation=mainPSUPortAllocation, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sNMPCommunityString=sNMPCommunityString, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortPauseFrames=dataPortPauseFrames, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sFPPortStatus=sFPPortStatus, txColorCode=txColorCode, linkLossLinked=linkLossLinked, tDDSynchronizationAlarm=tDDSynchronizationAlarm, rawReceivePowerLinked=rawReceivePowerLinked, cableDiagPair1Distance=cableDiagPair1Distance, pubStatsGroup=pubStatsGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, transmitFreqMHz=transmitFreqMHz, portAllocationMismatch=portAllocationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenseGroupAccess=licenseGroupAccess, hCMPMaximumLinkRange=hCMPMaximumLinkRange, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, wirelessLinkStatus=wirelessLinkStatus, transparentClock=transparentClock, resetGroup=resetGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, unavailableSeconds=unavailableSeconds, installArmState=installArmState, authorizationControlTableEntry=authorizationControlTableEntry, bridgeGroup=bridgeGroup, eIRP=eIRP, managementNetworkAccessEnabled=managementNetworkAccessEnabled, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, remoteUnitName=remoteUnitName, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, phyControl=phyControl, userTableIndex=userTableIndex, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, userPassword=userPassword, alarmsGroup=alarmsGroup, ethernetInstancedTableNumber=ethernetInstancedTableNumber, erroredSeconds=erroredSeconds, mainPSUPortQLRx=mainPSUPortQLRx, authorizationMethod=authorizationMethod, licenseUnitSerialNumber=licenseUnitSerialNumber, signalStrengthRatio=signalStrengthRatio, altitude=altitude, mgmtInstancedTableEntry=mgmtInstancedTableEntry, ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, licenseMaxLinkRange=licenseMaxLinkRange, vectorError=vectorError, tempPcb=tempPcb, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, cableDiagnosticsControl=cableDiagnosticsControl, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tDMEnabledChannels=tDMEnabledChannels, l2CPPriorityTable=l2CPPriorityTable, tdmTableIndex=tdmTableIndex, management=management, license=license, configurationInstancedTableNumber=configurationInstancedTableNumber, receiveChannel=receiveChannel, extendedSpectrumScanning=extendedSpectrumScanning, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, auxPortSyncERxStatus=auxPortSyncERxStatus, capacityVariantMismatchTrap=capacityVariantMismatchTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, configurationInstancedTable=configurationInstancedTable, sNMPTrapTableNumber=sNMPTrapTableNumber, sFPPortStatusTrap=sFPPortStatusTrap, auxPortAllocation=auxPortAllocation, mgmtInstancedTableIndex=mgmtInstancedTableIndex, dfsTableIndex=dfsTableIndex, frequencyVariant=frequencyVariant, rangeLinked=rangeLinked, cableDiagPair4Distance=cableDiagPair4Distance, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, antennaGain=antennaGain, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDMChannelStatus=tDMChannelStatus, licenseInstancedTableEntry=licenseInstancedTableEntry, auxPortSSMTx=auxPortSSMTx, maximumTransmitPower=maximumTransmitPower, licenseBandwidthCap=licenseBandwidthCap, licenseSFPPortSupport=licenseSFPPortSupport, sNTPServerStatus=sNTPServerStatus, sFPPortAllocation=sFPPortAllocation, licenseSyncESupport=licenseSyncESupport, sNTPServerTableNumber=sNTPServerTableNumber, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, dataBridgingStatusLinked=dataBridgingStatusLinked, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseHCMPSupport=licenseHCMPSupport, alarmInstancedTableEntry=alarmInstancedTableEntry, ethernetInstancedTable=ethernetInstancedTable, licenseGroup=licenseGroup, wirelessTopology=wirelessTopology, dNS=dNS, incompatibleRegulatoryBands=incompatibleRegulatoryBands, wirelessOutOctets=wirelessOutOctets, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mABHoldoffPeriod=mABHoldoffPeriod, bootVersion=bootVersion, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, transmitFreqKHz=transmitFreqKHz, softwareVersion=softwareVersion, hTTPPortNumber=hTTPPortNumber, iPVersion=iPVersion, syncEEquipmentClock=syncEEquipmentClock, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemReset=systemReset, transparentClockPort=transparentClockPort, hTTPAccessEnabled=hTTPAccessEnabled, ptpCompliance=ptpCompliance, sFPPortQLRx=sFPPortQLRx, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatusGroup=phyStatusGroup, unitOutOfCalibration=unitOutOfCalibration, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPrimaryServer=sNTPPrimaryServer, rxColorCode=rxColorCode, severelyErroredSeconds=severelyErroredSeconds, syncESlavePort=syncESlavePort, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sntpGroup=sntpGroup, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, snmpControlGroup=snmpControlGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveModulationModeLinked=receiveModulationModeLinked, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, encryption=encryption, configuration=configuration, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, gatewayIPAddress=gatewayIPAddress, range=range, useVLANForMABProtocol=useVLANForMABProtocol, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPServerPortNumber=sMTPServerPortNumber, syslogClient=syslogClient, mABState=mABState, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, secondarySoftwareVersion=secondarySoftwareVersion, phyControlInstancedTableNumber=phyControlInstancedTableNumber, ethernet=ethernet, capacityVariantMismatch=capacityVariantMismatch, antennaSelection=antennaSelection, mainPSUPortStatus=mainPSUPortStatus, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mgmtInstancedTableNumber=mgmtInstancedTableNumber, licenseCountry=licenseCountry, linkSymmetry=linkSymmetry, mgmtInstancedTable=mgmtInstancedTable, channelChangeTrap=channelChangeTrap, vectorErrorLinked=vectorErrorLinked, blacklistRMMacAddress=blacklistRMMacAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", blacklistRMEnabled=blacklistRMEnabled, lowestDataModulationMode=lowestDataModulationMode, productVariant=productVariant, iPDSCPPriorityTable=iPDSCPPriorityTable, phyControlInstancedTable=phyControlInstancedTable, dNSServerTable=dNSServerTable, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, installStatusLinked=installStatusLinked, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userEnabled=userEnabled, configurationInstancedTableIndex=configurationInstancedTableIndex, syslogStateTrap=syslogStateTrap, mABMaintenanceLevel=mABMaintenanceLevel, accessMethod=accessMethod, encryptionGroup=encryptionGroup, licenseEncryption=licenseEncryption, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, alarmInstancedTableIndex=alarmInstancedTableIndex, linkModeOptimization=linkModeOptimization, versionsGroup=versionsGroup, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, smtpGroup=smtpGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, phyStatus=phyStatus, alarms=alarms, phyInstancedStatusTable=phyInstancedStatusTable, latitude=latitude, licenseInstancedTable=licenseInstancedTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, mABNominalModulationMode=mABNominalModulationMode, phyControlInstancedTableIndex=phyControlInstancedTableIndex, linkLoss=linkLoss, userTableEntry=userTableEntry, transmitChannel=transmitChannel, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, syslogState=syslogState, syslogControl=syslogControl, alarmInstancedTable=alarmInstancedTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortSSMTx=sFPPortSSMTx, sNTPSync=sNTPSync, cableDiagPair1Results=cableDiagPair1Results, groupID=groupID, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, dfsGroup=dfsGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, remoteInternetAddressType=remoteInternetAddressType, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ptp=ptp, iPv6GatewayAddress=iPv6GatewayAddress, sFPPortAutoMdix=sFPPortAutoMdix, nIDULanPortStatus=nIDULanPortStatus, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, transmitterChannels=transmitterChannels)
