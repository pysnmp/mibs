...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagnosticsGroup=cableDiagnosticsGroup, sNMPPortNumber=sNMPPortNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, snmpControlGroup=snmpControlGroup, txColorCode=txColorCode, mABHoldoffPeriod=mABHoldoffPeriod, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dNSPrimaryServer=dNSPrimaryServer, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, installArmState=installArmState, dNSServerInternetAddress=dNSServerInternetAddress, sNTPSync=sNTPSync, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, encryption=encryption, subnetMask=subnetMask, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, vLANManagementPriority=vLANManagementPriority, lbtDetectedTrap=lbtDetectedTrap, qOSPriorityScheme=qOSPriorityScheme, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, deviceMSN=deviceMSN, licenseEncryption=licenseEncryption, sFPPortAutoMdix=sFPPortAutoMdix, tDDSynchronizationAlarm=tDDSynchronizationAlarm, wirelessOutAllOctets=wirelessOutAllOctets, userTableNumber=userTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tempPcb=tempPcb, ethernetStatisticsTable=ethernetStatisticsTable, ptpGroups=ptpGroups, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, sNTPServerTableNumber=sNTPServerTableNumber, frequencyVariant=frequencyVariant, secureModeAlarm=secureModeAlarm, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dNSResolver=dNSResolver, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDControl=tDDControl, incompatibleRegulatoryBands=incompatibleRegulatoryBands, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, vectorError=vectorError, tDMEnabledChannels=tDMEnabledChannels, transmitterChannels=transmitterChannels, accessMethod=accessMethod, tDDSynchronizationStatus=tDDSynchronizationStatus, aggregateDataRateLinked=aggregateDataRateLinked, auxPortStatusTrap=auxPortStatusTrap, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDMChannelLoopback=tDMChannelLoopback, systemClock=systemClock, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, ethernetInstancedTable=ethernetInstancedTable, transmitFreqKHz=transmitFreqKHz, auxPortQLRx=auxPortQLRx, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, dfsTable=dfsTable, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNTPServerRetries=sNTPServerRetries, supplementary=supplementary, dfsTableNumber=dfsTableNumber, sFPError=sFPError, sMTPServerPortNumber=sMTPServerPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, PYSNMP_MODULE_ID=cambium, alarmInstancedTableNumber=alarmInstancedTableNumber, transparentClockPort=transparentClockPort, licenseSFPPortSupport=licenseSFPPortSupport, remoteMACAddress=remoteMACAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataBridgingStatusAlarm=dataBridgingStatusAlarm, signalStrengthRatioLinked=signalStrengthRatioLinked, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, license=license, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, syslogClientTrap=syslogClientTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, daylightSaving=daylightSaving, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPv6GatewayAddress=iPv6GatewayAddress, dataPortPauseFrames=dataPortPauseFrames, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, syslogControl=syslogControl, licenseGroup=licenseGroup, syncETrackingState=syncETrackingState, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, configurationInstancedTableNumber=configurationInstancedTableNumber, receiveFreqMHz=receiveFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, authorizationMethod=authorizationMethod, sNTPServerTable=sNTPServerTable, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseUnitSerialNumber=licenseUnitSerialNumber, transmitFreqMHz=transmitFreqMHz, dfsMeans=dfsMeans, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, timeZone=timeZone, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, receiveFreqKHz=receiveFreqKHz, sNTPServerPortNumber=sNTPServerPortNumber, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNTPServerTableIndex=sNTPServerTableIndex, cableDiagnosticsPorts=cableDiagnosticsPorts, tDMChannelLineCode=tDMChannelLineCode, secureModeAlarmTrap=secureModeAlarmTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, unitName=unitName, tdmTableIndex=tdmTableIndex, dNSServerTableNumber=dNSServerTableNumber, remoteUnitNameLinked=remoteUnitNameLinked, dataBridgingStatus=dataBridgingStatus, masterSlaveMode=masterSlaveMode, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, dataBridgingStatusLinked=dataBridgingStatusLinked, capacityVariantMismatchTrap=capacityVariantMismatchTrap, wirelessTopology=wirelessTopology, versions=versions, receiveDataRate=receiveDataRate, mABState=mABState, hTTPSPortNumber=hTTPSPortNumber, ethernet=ethernet, range=range, productName=productName, useVLANForMABProtocol=useVLANForMABProtocol, antennaSelection=antennaSelection, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, dfsTableEntry=dfsTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitPower=transmitPower, enableTransmission=enableTransmission, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseOOBManagementSupport=licenseOOBManagementSupport, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sNMPTrapTableIndex=sNMPTrapTableIndex, sFPPortSSMTx=sFPPortSSMTx, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, whitelistRMEnabled=whitelistRMEnabled, dfs=dfs, sntp=sntp, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, lowestDataModulationMode=lowestDataModulationMode, telnetAccessEnabled=telnetAccessEnabled, localPacketFiltering=localPacketFiltering, managementGroup=managementGroup, remoteUnitName=remoteUnitName, mainPSUPortQLTx=mainPSUPortQLTx, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, antennaGain=antennaGain, dNSServerTableEntry=dNSServerTableEntry, mainPSUPortStatus=mainPSUPortStatus, cableDiagPair2Results=cableDiagPair2Results, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, phyStatus=phyStatus, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, transmitChannel=transmitChannel, latitude=latitude, regulatoryBandTrap=regulatoryBandTrap, smtp=smtp, cableDiagnosticsControl=cableDiagnosticsControl, rawReceivePowerLinked=rawReceivePowerLinked, portAllocationMismatchLinked=portAllocationMismatchLinked, tdmTableNumber=tdmTableNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, transparentClock=transparentClock, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibration=unitOutOfCalibration, licenseVersion=licenseVersion, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tdmTable=tdmTable, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, licenseInstancedTableNumber=licenseInstancedTableNumber, cableLoss=cableLoss, lowestTDMModulationMode=lowestTDMModulationMode, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, dNSServerTableIndex=dNSServerTableIndex, alarmsGroup=alarmsGroup, licenseInstancedTable=licenseInstancedTable, mgmtInstancedTableEntry=mgmtInstancedTableEntry, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mgmtInstancedTable=mgmtInstancedTable, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, auxPortSyncERxStatus=auxPortSyncERxStatus, hCMPLinkSymmetry=hCMPLinkSymmetry, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, userEnabled=userEnabled, remoteMACAddressLinked=remoteMACAddressLinked, wirelessLinkStatus=wirelessLinkStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, cableDiagnostics=cableDiagnostics, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, transparentClockVLAN=transparentClockVLAN, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, unavailableSeconds=unavailableSeconds, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, wirelessOutEthernetOctets=wirelessOutEthernetOctets, remoteInternetAddressType=remoteInternetAddressType, productVariant=productVariant, linkName=linkName, sNMPTrapVersion=sNMPTrapVersion, auxPortQLTx=auxPortQLTx, blacklistRMEnabled=blacklistRMEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dSCPManagementPriority=dSCPManagementPriority, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syncESlavePort=syncESlavePort, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, bridgeGroup=bridgeGroup, targetMACAddress=targetMACAddress, mgmtInstancedTableIndex=mgmtInstancedTableIndex, systemReset=systemReset, auxPortConfigurationMismatch=auxPortConfigurationMismatch, management=management, phyControlInstancedTableNumber=phyControlInstancedTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receivePowerLinked=receivePowerLinked, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, iPDSCPPriorityTable=iPDSCPPriorityTable, portAllocationMismatch=portAllocationMismatch, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, txMABFrames=txMABFrames, ptpTraps=ptpTraps, wirelessLinkAvailability=wirelessLinkAvailability, cableDiagPair4Results=cableDiagPair4Results, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, bridge=bridge, tDM=tDM)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, channelBandwidth=channelBandwidth, dfsGroup=dfsGroup, sNMPTrapTable=sNMPTrapTable, receiveModulationModeLinked=receiveModulationModeLinked, ptpTrapPrefix=ptpTrapPrefix, transmitDataRate=transmitDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, softwareVersion=softwareVersion, userTable=userTable, extendedSpectrumScanning=extendedSpectrumScanning, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sNTPPollInterval=sNTPPollInterval, subbandHighestFrequency=subbandHighestFrequency, targetRange=targetRange, wirelessLinkStatusLinked=wirelessLinkStatusLinked, altitude=altitude, sFPPortQLTx=sFPPortQLTx, hTTPPortNumber=hTTPPortNumber, installStatus=installStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, linkModeOptimization=linkModeOptimization, linkLossLinked=linkLossLinked, cambium=cambium, siteName=siteName, authorizationControlTableEntry=authorizationControlTableEntry, authorizationControlTable=authorizationControlTable, syslogStateTrap=syslogStateTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, encryptionGroup=encryptionGroup, licenseGasGroup=licenseGasGroup, apcGroup=apcGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mABNominalModulationMode=mABNominalModulationMode, linkLoss=linkLoss, mABTransmissionInterval=mABTransmissionInterval, signalStrengthRatio=signalStrengthRatio, licenseHCMPSupport=licenseHCMPSupport, maximumNumberOfSlaves=maximumNumberOfSlaves, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, noWirelessChannelAvailable=noWirelessChannelAvailable, versionsGroup=versionsGroup, remoteInternetAddress=remoteInternetAddress, transparentClockVID=transparentClockVID, sFPErrorTrap=sFPErrorTrap, userPassword=userPassword, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, whitelistRMMacAddress=whitelistRMMacAddress, ptp=ptp, syslogControlGroup=syslogControlGroup, sFPPortQLRx=sFPPortQLRx, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseCountry=licenseCountry, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, installArmStateTrap=installArmStateTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseInstancedTableEntry=licenseInstancedTableEntry, iPVersion=iPVersion, hardwareVersion=hardwareVersion, l2CPPriorityTableEntry=l2CPPriorityTableEntry, unitIdentificationGroup=unitIdentificationGroup, sFPPortAllocation=sFPPortAllocation, receivePower=receivePower, mainPSUPortAutoMdix=mainPSUPortAutoMdix, bootVersion=bootVersion, tDMChannelCableLength=tDMChannelCableLength, userName=userName, nIDULanPortAutoMdix=nIDULanPortAutoMdix, channelChangeTrap=channelChangeTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, alarmInstancedTable=alarmInstancedTable, regulatoryBand=regulatoryBand, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, hTTPAccessEnabled=hTTPAccessEnabled, auxPortDisabledWarning=auxPortDisabledWarning, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, routerProtocols=routerProtocols, iPv4Address=iPv4Address, auxPortSSMTx=auxPortSSMTx, searchState=searchState, smtpGroup=smtpGroup, packetsToInternalStack=packetsToInternalStack, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, supplementaryGroup=supplementaryGroup, ethernetGroup=ethernetGroup, configuration=configuration, byteErrorRatio=byteErrorRatio, hTTPSAccessEnabled=hTTPSAccessEnabled, authorizationControlTableNumber=authorizationControlTableNumber, tDMChannelStatusTrap=tDMChannelStatusTrap, dfsPeaks=dfsPeaks, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDControlGroup=tDDControlGroup, capacityVariantMismatch=capacityVariantMismatch, sNTPLastSync=sNTPLastSync, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sMTPEmailAlert=sMTPEmailAlert, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, cableDiagPair1Results=cableDiagPair1Results, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, deviceESN=deviceESN, nIDULanPortStatus=nIDULanPortStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkSymmetry=linkSymmetry, subbandLowestFrequency=subbandLowestFrequency, l2CPPriorityTable=l2CPPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseMaxLinkRange=licenseMaxLinkRange, pubInstancedStatsTable=pubInstancedStatsTable, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, ptmp=ptmp, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNTPServerStatus=sNTPServerStatus, alarmInstancedTableIndex=alarmInstancedTableIndex, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, aAAControlGroup=aAAControlGroup, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, resetGroup=resetGroup, sNMPCommunityString=sNMPCommunityString, configurationInstancedTable=configurationInstancedTable, iPv6Address=iPv6Address, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, phyInstancedStatusTable=phyInstancedStatusTable, rangingMode=rangingMode, syncETracking=syncETracking, severelyErroredSeconds=severelyErroredSeconds, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, licenseRARSupport=licenseRARSupport, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, authorizationControlGroup=authorizationControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, l2CPPriorityTableIndex=l2CPPriorityTableIndex, auxPortStatus=auxPortStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, receiveModulationMode=receiveModulationMode, sntpGroup=sntpGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, transmitModulationModeLinked=transmitModulationModeLinked, dNSServerPortNumber=dNSServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rangeLinked=rangeLinked, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, receiveChannel=receiveChannel, mABMaintenanceLevel=mABMaintenanceLevel, ethernetInstancedTableEntry=ethernetInstancedTableEntry, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataBridgingAvailability=dataBridgingAvailability, notificationsGroup=notificationsGroup, vLANManagementVID=vLANManagementVID, phyControl=phyControl, cableDiagPair3Distance=cableDiagPair3Distance, rawReceivePower=rawReceivePower, phyStatusGroup=phyStatusGroup, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortStatusTrap=sFPPortStatusTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, sNMPv3Enable=sNMPv3Enable, pubStats=pubStats, portAllocationMismatchTrap=portAllocationMismatchTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, apc=apc, aAAControl=aAAControl, ethernetPriorityTable=ethernetPriorityTable, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, installationMode=installationMode, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, cableDiagPair2Distance=cableDiagPair2Distance, configurationInstancedTableEntry=configurationInstancedTableEntry, sFPPortAutoNegotiation=sFPPortAutoNegotiation, snmpControl=snmpControl, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseTrialPeriod=licenseTrialPeriod, configurationGroup=configurationGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, dNSServerInternetAddressType=dNSServerInternetAddressType, alarms=alarms, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitModulationMode=transmitModulationMode, tDMConfigurationMismatch=tDMConfigurationMismatch, transmitPowerLinked=transmitPowerLinked, syncEEquipmentClock=syncEEquipmentClock, tFTPClient=tFTPClient, userTableIndex=userTableIndex, transmitDataRateLinked=transmitDataRateLinked, vectorErrorLinked=vectorErrorLinked, licenseTLSRekey=licenseTLSRekey, searchStateLinked=searchStateLinked, secondarySoftwareVersion=secondarySoftwareVersion, licenseIPv6Support=licenseIPv6Support, groupID=groupID, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptp670=ptp670, licenseIssueNumber=licenseIssueNumber, userTableEntry=userTableEntry, mainPSUPortSSMTx=mainPSUPortSSMTx, erroredSeconds=erroredSeconds, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, auxPortAllocation=auxPortAllocation, mABProtocolVLANPriority=mABProtocolVLANPriority, aggregateDataRate=aggregateDataRate, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, telnetPortNumber=telnetPortNumber, installStatusLinked=installStatusLinked, tDMGroup=tDMGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetInstancedTableIndex=ethernetInstancedTableIndex, rxColorCode=rxColorCode, licenseGroupAccess=licenseGroupAccess, tDMInterfaceStatus=tDMInterfaceStatus, sNTPServerTimeout=sNTPServerTimeout, alarmInstancedTableEntry=alarmInstancedTableEntry, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mABProtocolVID=mABProtocolVID, licenseBandwidthCap=licenseBandwidthCap, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, installStatusTrap=installStatusTrap, reset=reset, configurationInstancedTableIndex=configurationInstancedTableIndex, authorizationControlTableIndex=authorizationControlTableIndex, dfsTableIndex=dfsTableIndex, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagPair1Distance=cableDiagPair1Distance, syslogState=syslogState, eIRP=eIRP, dNSGroup=dNSGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPv6PrefixLength=iPv6PrefixLength, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sFPPortStatus=sFPPortStatus, phyControlInstancedTableEntry=phyControlInstancedTableEntry, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, cableDiagnosticsWarning=cableDiagnosticsWarning, blacklistRMMacAddress=blacklistRMMacAddress, cableDiagPair3Results=cableDiagPair3Results, deviceMACAddress=deviceMACAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, wirelessOutOctets=wirelessOutOctets, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, unitIdentification=unitIdentification, sNTPState=sNTPState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, byteErrorRatioLinked=byteErrorRatioLinked, licenseInstancedTableIndex=licenseInstancedTableIndex, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, longitude=longitude, encryptionAlgorithm=encryptionAlgorithm, mainPSUPortAllocation=mainPSUPortAllocation, tDMInterfaceControl=tDMInterfaceControl, maximumTransmitPower=maximumTransmitPower, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, dNSServerTable=dNSServerTable, licenseSecurityLevel=licenseSecurityLevel, sNTPServerTableEntry=sNTPServerTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveDataRateLinked=receiveDataRateLinked, tDMChannelStatus=tDMChannelStatus, dNS=dNS, packetsFromInternalStack=packetsFromInternalStack, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tdmTableEntry=tdmTableEntry, phyControlInstancedTable=phyControlInstancedTable, sNTPPrimaryServer=sNTPPrimaryServer, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, routerProtocolsGroup=routerProtocolsGroup, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, mainPSUPortQLRx=mainPSUPortQLRx, mgmtInstancedTableNumber=mgmtInstancedTableNumber, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, userRole=userRole, receiveModulationModeDetail=receiveModulationModeDetail, phyControlGroup=phyControlGroup, licenseIEEE1588Support=licenseIEEE1588Support, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogClient=syslogClient, authorizationControl=authorizationControl, licenseCapacity=licenseCapacity, ptpCompliance=ptpCompliance, licenseSyncESupport=licenseSyncESupport)
