...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", regulatoryBand=regulatoryBand, sNTPServerInternetAddress=sNTPServerInternetAddress, aAAControlGroup=aAAControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, dfsGroup=dfsGroup, sFPPortSyncERxStatus=sFPPortSyncERxStatus, installStatusLinked=installStatusLinked, tFTPClient=tFTPClient, mgmtInstancedTableEntry=mgmtInstancedTableEntry, userTableIndex=userTableIndex, dNS=dNS, secureModeAlarmTrap=secureModeAlarmTrap, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, cableDiagPair3Distance=cableDiagPair3Distance, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sNMPv3Enable=sNMPv3Enable, tdmTable=tdmTable, ethernetStatisticsTable=ethernetStatisticsTable, bridge=bridge, vLANManagementPriority=vLANManagementPriority, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNMPTrapTable=sNMPTrapTable, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseSFPPortSupport=licenseSFPPortSupport, versions=versions, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, transmitDataRate=transmitDataRate, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, mABNominalTransmitCapacity=mABNominalTransmitCapacity, phyInstancedStatusTable=phyInstancedStatusTable, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, cableDiagnostics=cableDiagnostics, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sFPPortStatusTrap=sFPPortStatusTrap, licenseCapacity=licenseCapacity, mgmtInstancedTableNumber=mgmtInstancedTableNumber, remoteMACAddress=remoteMACAddress, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, sNMPEnabledTraps=sNMPEnabledTraps, routerProtocols=routerProtocols, portAllocationMismatch=portAllocationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseInstancedTableIndex=licenseInstancedTableIndex, licenseIssueNumber=licenseIssueNumber, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, installStatus=installStatus, linkLoss=linkLoss, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, managementNetworkAccessEnabled=managementNetworkAccessEnabled, syslogClient=syslogClient, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, rangeLinked=rangeLinked, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sNTPServerInternetAddressType=sNTPServerInternetAddressType, subnetMask=subnetMask, aAAControl=aAAControl, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, receiveChannel=receiveChannel, receiveDataRate=receiveDataRate, licenseOOBManagementSupport=licenseOOBManagementSupport, mABMaintenanceLevel=mABMaintenanceLevel, searchState=searchState, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseInstancedTable=licenseInstancedTable, configurationInstancedTable=configurationInstancedTable, capacityVariantMismatch=capacityVariantMismatch, sNTPPrimaryServer=sNTPPrimaryServer, packetsToInternalStack=packetsToInternalStack, sNMPCommunityString=sNMPCommunityString, encryptionAlgorithm=encryptionAlgorithm, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, iPv6Address=iPv6Address, authorizationControlGroup=authorizationControlGroup, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, transmitChannel=transmitChannel, sNTPState=sNTPState, tDMInterfaceControl=tDMInterfaceControl, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDControlGroup=tDDControlGroup, channelBandwidth=channelBandwidth, licenseRARSupport=licenseRARSupport, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, phyControlGroup=phyControlGroup, eIRP=eIRP, tDDControl=tDDControl, sNMPTrapTableIndex=sNMPTrapTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, cableDiagPair2Results=cableDiagPair2Results, unitIdentificationGroup=unitIdentificationGroup, authorizationControl=authorizationControl, rangingMode=rangingMode, secureModeAlarm=secureModeAlarm, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, notificationsGroup=notificationsGroup, ptpTraps=ptpTraps, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, channelChangeTrap=channelChangeTrap, ethernetInstancedTableIndex=ethernetInstancedTableIndex, productVariant=productVariant, tFTPServerInternetAddressType=tFTPServerInternetAddressType, licenseHCMPSupport=licenseHCMPSupport, useVLANForMABProtocol=useVLANForMABProtocol, range=range, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transparentClock=transparentClock, licenseGasGroup=licenseGasGroup, management=management, licenseInstancedTableNumber=licenseInstancedTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sFPPortAllocation=sFPPortAllocation, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mainPSUPortSSMTx=mainPSUPortSSMTx, resetGroup=resetGroup, tDMConfigurationMismatch=tDMConfigurationMismatch, lowestTDMModulationMode=lowestTDMModulationMode, ethernetPriorityTable=ethernetPriorityTable, tDMChannelStatus=tDMChannelStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNTPSync=sNTPSync, iPv4Address=iPv4Address, syslogStateTrap=syslogStateTrap, unitIdentification=unitIdentification, remoteUnitName=remoteUnitName, hTTPPortNumber=hTTPPortNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNTPServerTable=sNTPServerTable, erroredSeconds=erroredSeconds, dataBridgingAvailability=dataBridgingAvailability, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tDMInterfaceStatus=tDMInterfaceStatus, telnetAccessEnabled=telnetAccessEnabled, cableDiagPair1Distance=cableDiagPair1Distance, userName=userName, ethernetPriorityTableIndex=ethernetPriorityTableIndex, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, vectorError=vectorError, tDDSynchronizationMode=tDDSynchronizationMode, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, signalStrengthRatio=signalStrengthRatio, mABTransmissionInterval=mABTransmissionInterval, iPDSCPPriorityTable=iPDSCPPriorityTable, mABProtocolVLANPriority=mABProtocolVLANPriority, regulatoryBandTrap=regulatoryBandTrap, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sFPPortAutoMdix=sFPPortAutoMdix, dataPortWirelessDownAlert=dataPortWirelessDownAlert, auxPortStatusTrap=auxPortStatusTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, cableDiagPair4Distance=cableDiagPair4Distance, sNTPServerTableNumber=sNTPServerTableNumber, linkName=linkName, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, telnetPortNumber=telnetPortNumber, portAllocationMismatchLinked=portAllocationMismatchLinked, nIDULanPortStatus=nIDULanPortStatus, licenseIPv6Support=licenseIPv6Support, tDMChannelCableLength=tDMChannelCableLength, dNSServerTable=dNSServerTable, lbtDetectedTrap=lbtDetectedTrap, licenseSyncESupport=licenseSyncESupport, cambium=cambium, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfs=dfs, licenseGroup=licenseGroup, ethernet=ethernet, bridgeGroup=bridgeGroup, cableDiagPair2Distance=cableDiagPair2Distance, authorizationControlTableIndex=authorizationControlTableIndex, pubInstancedStatsTable=pubInstancedStatsTable, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseCountry=licenseCountry, receiveFreqKHz=receiveFreqKHz, dataBridgingStatusAlarm=dataBridgingStatusAlarm, transmitterChannels=transmitterChannels, remoteInternetAddressType=remoteInternetAddressType, syncETrackingState=syncETrackingState, rxColorCode=rxColorCode, wirelessLinkAvailability=wirelessLinkAvailability, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sFPPortQLTx=sFPPortQLTx, smtp=smtp, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, secondarySoftwareVersion=secondarySoftwareVersion, remoteMACAddressLinked=remoteMACAddressLinked, ptpTrapPrefix=ptpTrapPrefix, timeZone=timeZone, mABNominalModulationMode=mABNominalModulationMode, sFPErrorTrap=sFPErrorTrap, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, searchStateLinked=searchStateLinked, smtpGroup=smtpGroup, configurationInstancedTableIndex=configurationInstancedTableIndex, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, syncESlavePort=syncESlavePort, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, auxPortQLTx=auxPortQLTx, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, dSCPManagementPriority=dSCPManagementPriority, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mABProtocolVID=mABProtocolVID, sNTPSyncTrap=sNTPSyncTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, cableLoss=cableLoss, receiveFreqMHz=receiveFreqMHz, deviceESN=deviceESN, auxPortQLRx=auxPortQLRx, licenseIEEE1588Support=licenseIEEE1588Support, tDM=tDM, tDMChannelStatusTrap=tDMChannelStatusTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, systemReset=systemReset, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dNSPrimaryServer=dNSPrimaryServer, versionsGroup=versionsGroup, dfsTableIndex=dfsTableIndex, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, mABHoldoffPeriod=mABHoldoffPeriod, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, remoteInternetAddressLinked=remoteInternetAddressLinked, syslogClientTrap=syslogClientTrap, sNMPPortNumber=sNMPPortNumber, apc=apc, byteErrorRatioLinked=byteErrorRatioLinked, mgmtInstancedTable=mgmtInstancedTable, siteName=siteName, alarmInstancedTableNumber=alarmInstancedTableNumber, maximumNumberOfSlaves=maximumNumberOfSlaves, dNSServerInternetAddress=dNSServerInternetAddress, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, ptpGroups=ptpGroups)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", targetMACAddress=targetMACAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tdmTableIndex=tdmTableIndex, licenseBandwidthCap=licenseBandwidthCap, license=license, apcGroup=apcGroup, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sFPPortQLRx=sFPPortQLRx, licenseMaxLinkRange=licenseMaxLinkRange, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userRole=userRole, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, authorizationControlTableNumber=authorizationControlTableNumber, maximumTransmitPower=maximumTransmitPower, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, transmitFreqKHz=transmitFreqKHz, sNTPServerRetries=sNTPServerRetries, txColorCode=txColorCode, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, hardwareVersion=hardwareVersion, transmitModulationMode=transmitModulationMode, auxPortStatus=auxPortStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, authorizationControlTableEntry=authorizationControlTableEntry, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, remoteUnitNameLinked=remoteUnitNameLinked, sNTPServerTimeout=sNTPServerTimeout, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, dNSResolver=dNSResolver, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dataPortPauseFrames=dataPortPauseFrames, syslogControl=syslogControl, cableDiagPair1Results=cableDiagPair1Results, encryptionGroup=encryptionGroup, authorizationControlTable=authorizationControlTable, syncEEquipmentClock=syncEEquipmentClock, dfsPeaks=dfsPeaks, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tdmTableEntry=tdmTableEntry, receiveModulationModeLinked=receiveModulationModeLinked, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseTrialPeriod=licenseTrialPeriod, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, phyStatus=phyStatus, iPv6GatewayAddress=iPv6GatewayAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mainPSUPortAllocation=mainPSUPortAllocation, phyControl=phyControl, sNTPServerPortNumber=sNTPServerPortNumber, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sFPPortSSMTx=sFPPortSSMTx, supplementary=supplementary, lowestDataModulationMode=lowestDataModulationMode, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, configurationGroup=configurationGroup, syslogControlGroup=syslogControlGroup, dfsTable=dfsTable, unavailableSeconds=unavailableSeconds, installStatusTrap=installStatusTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, localPacketFiltering=localPacketFiltering, antennaSelection=antennaSelection, snmpControl=snmpControl, licenseVersion=licenseVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, routerProtocolsGroup=routerProtocolsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, managementGroup=managementGroup, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, cableDiagnosticsWarning=cableDiagnosticsWarning, syslogLocalWrappedTrap=syslogLocalWrappedTrap, softwareVersion=softwareVersion, extendedSpectrumScanning=extendedSpectrumScanning, hTTPSPortNumber=hTTPSPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseEncryption=licenseEncryption, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, supplementaryGroup=supplementaryGroup, auxPortSyncERxStatus=auxPortSyncERxStatus, qOSPriorityScheme=qOSPriorityScheme, systemClock=systemClock, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, transmitPower=transmitPower, subbandHighestFrequency=subbandHighestFrequency, transparentClockVID=transparentClockVID, syslogState=syslogState, tDMChannelLoopback=tDMChannelLoopback, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, tempPcb=tempPcb, mABState=mABState, tDDSynchronizationAlarm=tDDSynchronizationAlarm, signalStrengthRatioLinked=signalStrengthRatioLinked, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, deviceMACAddress=deviceMACAddress, vectorErrorLinked=vectorErrorLinked, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, receivePowerLinked=receivePowerLinked, sFPPortDisabledWarning=sFPPortDisabledWarning, linkSymmetry=linkSymmetry, remoteInternetAddress=remoteInternetAddress, dfsTableNumber=dfsTableNumber, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dNSServerTableEntry=dNSServerTableEntry, installArmStateTrap=installArmStateTrap, userEnabled=userEnabled, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, auxPortSSMTx=auxPortSSMTx, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNTPPollInterval=sNTPPollInterval, userTableNumber=userTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aggregateDataRate=aggregateDataRate, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, hCMPLinkSymmetry=hCMPLinkSymmetry, masterSlaveMode=masterSlaveMode, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitDataRateLinked=transmitDataRateLinked, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ptpCompliance=ptpCompliance, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, mainPSUPortStatusTrap=mainPSUPortStatusTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mainPSUPortStatus=mainPSUPortStatus, licenseGroupAccess=licenseGroupAccess, longitude=longitude, ethernetInstancedTable=ethernetInstancedTable, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, unitName=unitName, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, wirelessOutAllOctets=wirelessOutAllOctets, licenseSecurityLevel=licenseSecurityLevel, sNTPLastSync=sNTPLastSync, cableDiagnosticsPorts=cableDiagnosticsPorts, remoteMaximumTransmitPower=remoteMaximumTransmitPower, antennaGain=antennaGain, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, targetRange=targetRange, subbandLowestFrequency=subbandLowestFrequency, auxPortConfigurationMismatch=auxPortConfigurationMismatch, blacklistRMEnabled=blacklistRMEnabled, gatewayIPAddress=gatewayIPAddress, whitelistRMEnabled=whitelistRMEnabled, bootVersion=bootVersion, altitude=altitude, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, unitOutOfCalibration=unitOutOfCalibration, wirelessTopology=wirelessTopology, tDMChannelLineCode=tDMChannelLineCode, linkLossLinked=linkLossLinked, ethernetGroup=ethernetGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, auxPortAcceptedQLRx=auxPortAcceptedQLRx, wirelessOutOctets=wirelessOutOctets, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, iPv6PrefixLength=iPv6PrefixLength, dataBridgingStatusLinked=dataBridgingStatusLinked, mPLSTCPriorityTable=mPLSTCPriorityTable, enableTransmission=enableTransmission, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, ptp670=ptp670, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPServerInternetAddress=sMTPServerInternetAddress, receivePower=receivePower, transparentClockVLAN=transparentClockVLAN, productName=productName, dNSServerTableNumber=dNSServerTableNumber, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, snmpControlGroup=snmpControlGroup, userPassword=userPassword, vLANManagementVID=vLANManagementVID, sntp=sntp, dNSGroup=dNSGroup, dfsMeans=dfsMeans, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, aggregateDataRateLinked=aggregateDataRateLinked, pubStats=pubStats, sFPPortStatus=sFPPortStatus, dNSServerTableIndex=dNSServerTableIndex, authorizationMethod=authorizationMethod, transmitPowerLinked=transmitPowerLinked, severelyErroredSeconds=severelyErroredSeconds, groupID=groupID, mainPSUPortQLRx=mainPSUPortQLRx, ethernetInstancedTableEntry=ethernetInstancedTableEntry, phyControlInstancedTableEntry=phyControlInstancedTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, pubStatsGroup=pubStatsGroup, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, daylightSaving=daylightSaving, mgmtInstancedTableIndex=mgmtInstancedTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, deviceMSN=deviceMSN, sMTPEmailAlert=sMTPEmailAlert, tDMEnabledChannels=tDMEnabledChannels, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, l2CPPriorityTable=l2CPPriorityTable, installationMode=installationMode, alarmsGroup=alarmsGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, cableDiagPair3Results=cableDiagPair3Results, rawReceivePower=rawReceivePower, receiveModulationMode=receiveModulationMode, sNTPServerTableIndex=sNTPServerTableIndex, encryption=encryption, licenseTLSRekey=licenseTLSRekey, sNTPServerTableEntry=sNTPServerTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNTPServerStatus=sNTPServerStatus, blacklistRMMacAddress=blacklistRMMacAddress, mainPSUPortQLTx=mainPSUPortQLTx, wirelessOutEthernetOctets=wirelessOutEthernetOctets, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tdmTableNumber=tdmTableNumber, alarmInstancedTableIndex=alarmInstancedTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkStatusLinked=wirelessLinkStatusLinked, packetsFromInternalStack=packetsFromInternalStack, auxPortDisabledWarning=auxPortDisabledWarning)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, configurationInstancedTableNumber=configurationInstancedTableNumber, phyStatusGroup=phyStatusGroup, frequencyVariant=frequencyVariant, txMABFrames=txMABFrames, dataBridgingStatus=dataBridgingStatus, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, transmitModulationModeLinked=transmitModulationModeLinked, phyControlInstancedTableIndex=phyControlInstancedTableIndex, rawReceivePowerLinked=rawReceivePowerLinked, transmitFreqMHz=transmitFreqMHz, receiveDataRateLinked=receiveDataRateLinked, cableDiagPair4Results=cableDiagPair4Results, alarmInstancedTable=alarmInstancedTable, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, PYSNMP_MODULE_ID=cambium, tDMGroup=tDMGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, userTableEntry=userTableEntry, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationStatus=tDDSynchronizationStatus, accessMethod=accessMethod, reset=reset, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, alarms=alarms, configurationInstancedTableEntry=configurationInstancedTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sFPError=sFPError, ethernetStatisticsDataSource=ethernetStatisticsDataSource, whitelistRMMacAddress=whitelistRMMacAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, syncETracking=syncETracking, dNSServerInternetAddressType=dNSServerInternetAddressType, ptp=ptp, auxPortAllocation=auxPortAllocation, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptmp=ptmp, userTable=userTable, cableDiagnosticsControl=cableDiagnosticsControl, sntpGroup=sntpGroup, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, phyControlInstancedTable=phyControlInstancedTable, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseInstancedTableEntry=licenseInstancedTableEntry, iPVersion=iPVersion, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, dfsTableEntry=dfsTableEntry, dNSServerPortNumber=dNSServerPortNumber, transparentClockPort=transparentClockPort, linkModeOptimization=linkModeOptimization, byteErrorRatio=byteErrorRatio, configuration=configuration, latitude=latitude, l2CPPriorityTableNumber=l2CPPriorityTableNumber, portAllocationMismatchTrap=portAllocationMismatchTrap)
