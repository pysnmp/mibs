...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, transmitDataRateLinked=transmitDataRateLinked, rawReceivePower=rawReceivePower, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, managementGroup=managementGroup, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, rangeLinked=rangeLinked, searchState=searchState, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, auxPortAllocation=auxPortAllocation, receiveDataRateLinked=receiveDataRateLinked, userEnabled=userEnabled, tFTPClient=tFTPClient, productVariant=productVariant, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, receiveDataRate=receiveDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, encryption=encryption, userTableNumber=userTableNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, supplementaryGroup=supplementaryGroup, lowestTDMModulationMode=lowestTDMModulationMode, ptpTrapPrefix=ptpTrapPrefix, sNTPServerTimeout=sNTPServerTimeout, transmitFreqMHz=transmitFreqMHz, masterSlaveMode=masterSlaveMode, syslogClient=syslogClient, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, capacityVariantMismatch=capacityVariantMismatch, mgmtInstancedTableNumber=mgmtInstancedTableNumber, sFPError=sFPError, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseTLSRekey=licenseTLSRekey, frequencyVariant=frequencyVariant, sFPPortQLTx=sFPPortQLTx, softwareVersion=softwareVersion, authorizationControl=authorizationControl, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, targetRange=targetRange, auxPortQLRx=auxPortQLRx, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, mABTransmissionInterval=mABTransmissionInterval, tdmTableIndex=tdmTableIndex, wirelessOutOctets=wirelessOutOctets, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, deviceMACAddress=deviceMACAddress, tDMChannelCableLength=tDMChannelCableLength, subnetMask=subnetMask, transmitFreqKHz=transmitFreqKHz, phyControlGroup=phyControlGroup, antennaGain=antennaGain, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseIPv6Support=licenseIPv6Support, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitDataRate=transmitDataRate, sMTPServerPortNumber=sMTPServerPortNumber, mABHoldoffPeriod=mABHoldoffPeriod, receiveFreqKHz=receiveFreqKHz, portAllocationMismatchLinked=portAllocationMismatchLinked, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, capacityVariantMismatchLinked=capacityVariantMismatchLinked, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, installArmState=installArmState, daylightSaving=daylightSaving, cableDiagPair1Results=cableDiagPair1Results, regulatoryBand=regulatoryBand, authorizationControlTableNumber=authorizationControlTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, dNSServerTableEntry=dNSServerTableEntry, tDMChannelLineCode=tDMChannelLineCode, latitude=latitude, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sntpGroup=sntpGroup, remoteInternetAddress=remoteInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, licenseVersion=licenseVersion, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, tDMInterfaceControl=tDMInterfaceControl, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsTableIndex=dfsTableIndex, dNSServerTableNumber=dNSServerTableNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, tDMGroup=tDMGroup, linkLossLinked=linkLossLinked, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, receiveFreqMHz=receiveFreqMHz, unitOutOfCalibration=unitOutOfCalibration, configurationInstancedTableNumber=configurationInstancedTableNumber, dataPortPauseFrames=dataPortPauseFrames, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, dNSServerInternetAddress=dNSServerInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, cableLoss=cableLoss, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, dfsMeans=dfsMeans, txColorCode=txColorCode, l2CPPriorityTable=l2CPPriorityTable, tDMChannelLoopback=tDMChannelLoopback, configurationGroup=configurationGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, userTableEntry=userTableEntry, receiveModulationModeLinked=receiveModulationModeLinked, dfsTableNumber=dfsTableNumber, nIDULanPortAutoMdix=nIDULanPortAutoMdix, signalStrengthRatio=signalStrengthRatio, receivePower=receivePower, whitelistRMMacAddress=whitelistRMMacAddress, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseEncryption=licenseEncryption, antennaSelection=antennaSelection, transparentClockPort=transparentClockPort, unitIdentification=unitIdentification, secondarySoftwareVersion=secondarySoftwareVersion, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, resetGroup=resetGroup, transmitModulationModeLinked=transmitModulationModeLinked, sNTPServerTableNumber=sNTPServerTableNumber, licenseCapacity=licenseCapacity, installStatus=installStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPSync=sNTPSync, iPv6Address=iPv6Address, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseTDDSyncSupport=licenseTDDSyncSupport, dataBridgingAvailability=dataBridgingAvailability, ptp670=ptp670, transmitPower=transmitPower, pubInstancedStatsTable=pubInstancedStatsTable, dfsTableEntry=dfsTableEntry, versions=versions, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationInstancedTable=configurationInstancedTable, localPacketFiltering=localPacketFiltering, cableDiagnostics=cableDiagnostics, authorizationMethod=authorizationMethod, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, hTTPAccessEnabled=hTTPAccessEnabled, cableDiagPair3Distance=cableDiagPair3Distance, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, supplementary=supplementary, sMTPServerInternetAddress=sMTPServerInternetAddress, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseTrialPeriod=licenseTrialPeriod, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, management=management, tdmTableNumber=tdmTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, bridge=bridge, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, maxLinkRangeExceeded=maxLinkRangeExceeded, installationMode=installationMode, auxPortQLTx=auxPortQLTx, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseMaxLinkRange=licenseMaxLinkRange, hTTPSAccessEnabled=hTTPSAccessEnabled, subbandHighestFrequency=subbandHighestFrequency, userName=userName, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, iPDSCPPriorityTable=iPDSCPPriorityTable, dfsTable=dfsTable, phyStatus=phyStatus, sNMPCommunityString=sNMPCommunityString, cableDiagnosticsControl=cableDiagnosticsControl, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sNMPv3Enable=sNMPv3Enable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, remoteInternetAddressLinked=remoteInternetAddressLinked, notificationsGroup=notificationsGroup, packetsToInternalStack=packetsToInternalStack, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, hCMPMaximumLinkRange=hCMPMaximumLinkRange, linkLoss=linkLoss, cableDiagnosticsWarning=cableDiagnosticsWarning, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPSPortNumber=hTTPSPortNumber, receivePowerLinked=receivePowerLinked, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDM=tDM, syncETracking=syncETracking, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernet=ethernet, syslogControlGroup=syslogControlGroup, userTable=userTable, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dNSServerTable=dNSServerTable, transparentClock=transparentClock, licenseCountry=licenseCountry, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, authorizationControlTable=authorizationControlTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, deviceESN=deviceESN, sFPPortSyncERxStatus=sFPPortSyncERxStatus, aggregateDataRate=aggregateDataRate, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, vectorErrorLinked=vectorErrorLinked, sNTPSyncTrap=sNTPSyncTrap, routerProtocols=routerProtocols, accessMethod=accessMethod, licenseOOBManagementSupport=licenseOOBManagementSupport, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANManagementPriority=vLANManagementPriority, systemClock=systemClock, licenseSFPPortSupport=licenseSFPPortSupport, remoteInternetAddressType=remoteInternetAddressType, altitude=altitude, incompatibleRegulatoryBands=incompatibleRegulatoryBands, cableDiagnosticsPorts=cableDiagnosticsPorts, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mainPSUPortStatus=mainPSUPortStatus, alarms=alarms, installStatusTrap=installStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mABNominalModulationMode=mABNominalModulationMode, encryptionGroup=encryptionGroup, tDMInterfaceStatus=tDMInterfaceStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, searchStateLinked=searchStateLinked, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, hTTPPortNumber=hTTPPortNumber, maximumNumberOfSlaves=maximumNumberOfSlaves, hCMPLinkSymmetry=hCMPLinkSymmetry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, unitIdentificationGroup=unitIdentificationGroup, licenseInstancedTableNumber=licenseInstancedTableNumber, longitude=longitude, dSCPManagementPriority=dSCPManagementPriority)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", systemReset=systemReset, syslogControl=syslogControl, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, apcGroup=apcGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, timeZone=timeZone, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, maximumTransmitPower=maximumTransmitPower, dfs=dfs, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, lbtDetectedTrap=lbtDetectedTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, alarmsGroup=alarmsGroup, dNSPrimaryServer=dNSPrimaryServer, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPState=sNTPState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtpGroup=smtpGroup, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseGroupAccess=licenseGroupAccess, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, deviceMSN=deviceMSN, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, mgmtInstancedTable=mgmtInstancedTable, sMTPEmailAlert=sMTPEmailAlert, installStatusLinked=installStatusLinked, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, dNSServerTableIndex=dNSServerTableIndex, gatewayIPAddress=gatewayIPAddress, sFPPortQLRx=sFPPortQLRx, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseIEEE1588Support=licenseIEEE1588Support, wirelessLinkStatus=wirelessLinkStatus, snmpControlGroup=snmpControlGroup, byteErrorRatioLinked=byteErrorRatioLinked, bootVersion=bootVersion, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, cableDiagPair4Distance=cableDiagPair4Distance, licenseSecurityLevel=licenseSecurityLevel, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNTPServerTableIndex=sNTPServerTableIndex, ethernetStatisticsDataSource=ethernetStatisticsDataSource, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDMConfigurationMismatch=tDMConfigurationMismatch, erroredSeconds=erroredSeconds, l2CPPriorityTableNumber=l2CPPriorityTableNumber, portAllocationMismatchTrap=portAllocationMismatchTrap, auxPortStatusTrap=auxPortStatusTrap, sFPPortDisabledWarning=sFPPortDisabledWarning, encryptionAlgorithm=encryptionAlgorithm, receiveModulationModeDetail=receiveModulationModeDetail, mPLSTCPriorityTable=mPLSTCPriorityTable, syslogStateTrap=syslogStateTrap, sNTPServerRetries=sNTPServerRetries, rxColorCode=rxColorCode, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, transmitPowerLinked=transmitPowerLinked, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mainPSUPortStatusTrap=mainPSUPortStatusTrap, ethernetPriorityTable=ethernetPriorityTable, groupID=groupID, transparentClockVLAN=transparentClockVLAN, userTableIndex=userTableIndex, useVLANForMABProtocol=useVLANForMABProtocol, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNTPServerTable=sNTPServerTable, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseGroup=licenseGroup, phyControlInstancedTable=phyControlInstancedTable, rawReceivePowerLinked=rawReceivePowerLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPServerInternetAddressType=tFTPServerInternetAddressType, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sNMPTrapVersion=sNMPTrapVersion, enableTransmission=enableTransmission, ptmp=ptmp, severelyErroredSeconds=severelyErroredSeconds, mABMaintenanceLevel=mABMaintenanceLevel, sFPErrorTrap=sFPErrorTrap, tDDSynchronizationMode=tDDSynchronizationMode, bridgeGroup=bridgeGroup, licenseInstancedTableEntry=licenseInstancedTableEntry, secureModeAlarm=secureModeAlarm, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, tDDControl=tDDControl, transparentClockVID=transparentClockVID, regulatoryBandTrap=regulatoryBandTrap, cableDiagPair2Distance=cableDiagPair2Distance, linkName=linkName, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, pubStats=pubStats, ptp=ptp, pubStatsGroup=pubStatsGroup, tdmTableEntry=tdmTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, PYSNMP_MODULE_ID=cambium, alarmInstancedTable=alarmInstancedTable, cableDiagPair2Results=cableDiagPair2Results, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, tDMChannelStatusTrap=tDMChannelStatusTrap, dataBridgingStatus=dataBridgingStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpGroups=ptpGroups, mgmtInstancedTableEntry=mgmtInstancedTableEntry, linkSymmetry=linkSymmetry, auxPortDisabledWarning=auxPortDisabledWarning, dNSResolver=dNSResolver, siteName=siteName, remoteMACAddress=remoteMACAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sFPPortAutoNegotiation=sFPPortAutoNegotiation, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, wirelessTopology=wirelessTopology, phyControlInstancedTableEntry=phyControlInstancedTableEntry, cableDiagPair1Distance=cableDiagPair1Distance, channelChangeTrap=channelChangeTrap, productName=productName, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, licenseHCMPSupport=licenseHCMPSupport, sFPPortAutoMdix=sFPPortAutoMdix, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sFPPortStatus=sFPPortStatus, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tdmTable=tdmTable, whitelistRMEnabled=whitelistRMEnabled, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetStatisticsTable=ethernetStatisticsTable, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNMPTrapTable=sNMPTrapTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mABProtocolVLANPriority=mABProtocolVLANPriority, mainPSUPortSSMTx=mainPSUPortSSMTx, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tDMChannelStatus=tDMChannelStatus, blacklistRMMacAddress=blacklistRMMacAddress, remoteUnitNameLinked=remoteUnitNameLinked, auxPortSyncERxStatus=auxPortSyncERxStatus, cableDiagPair3Results=cableDiagPair3Results, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, vLANManagementVID=vLANManagementVID, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, portAllocationMismatch=portAllocationMismatch, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, extendedSpectrumScanning=extendedSpectrumScanning, sntp=sntp, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, phyStatusGroup=phyStatusGroup, linkModeOptimization=linkModeOptimization, configurationInstancedTableEntry=configurationInstancedTableEntry, apc=apc, wirelessLinkAvailability=wirelessLinkAvailability, licenseBandwidthCap=licenseBandwidthCap, licenseSyncESupport=licenseSyncESupport, phyControl=phyControl, dNSServerPortNumber=dNSServerPortNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, auxPortStatus=auxPortStatus, nIDULanPortStatus=nIDULanPortStatus, configurationInstancedTableIndex=configurationInstancedTableIndex, transmitterChannels=transmitterChannels, sFPPortAllocation=sFPPortAllocation, userRole=userRole, cableDiagPair4Results=cableDiagPair4Results, transmitModulationMode=transmitModulationMode, dNSGroup=dNSGroup, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, iPVersion=iPVersion, hardwareVersion=hardwareVersion, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, alarmInstancedTableIndex=alarmInstancedTableIndex, ethernetInstancedTable=ethernetInstancedTable, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseInstancedTableIndex=licenseInstancedTableIndex, telnetPortNumber=telnetPortNumber, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, dfsPeaks=dfsPeaks, cableDiagnosticsResultTable=cableDiagnosticsResultTable, cambium=cambium, sNTPServerTableEntry=sNTPServerTableEntry, rangingMode=rangingMode, unavailableSeconds=unavailableSeconds, lowestDataModulationMode=lowestDataModulationMode, aAAControlGroup=aAAControlGroup, byteErrorRatio=byteErrorRatio, syslogState=syslogState, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, license=license, syncETrackingState=syncETrackingState, authorizationControlTableEntry=authorizationControlTableEntry, syslogClientTrap=syslogClientTrap, userPassword=userPassword, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, packetsFromInternalStack=packetsFromInternalStack, alarmInstancedTableNumber=alarmInstancedTableNumber, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, blacklistRMEnabled=blacklistRMEnabled, versionsGroup=versionsGroup, ethernetGroup=ethernetGroup, ptpCompliance=ptpCompliance, sNMPEnabledTraps=sNMPEnabledTraps, subbandLowestFrequency=subbandLowestFrequency, channelBandwidth=channelBandwidth, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, sNMPPortNumber=sNMPPortNumber, smtp=smtp, dNS=dNS, aggregateDataRateLinked=aggregateDataRateLinked, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dNSServerInternetAddressType=dNSServerInternetAddressType, sFPPortSSMTx=sFPPortSSMTx, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, signalStrengthRatioLinked=signalStrengthRatioLinked, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, receiveChannel=receiveChannel, sNTPServerStatus=sNTPServerStatus, auxPortAcceptedQLRx=auxPortAcceptedQLRx, aAAControl=aAAControl, ethernetPriorityTableEntry=ethernetPriorityTableEntry, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, configuration=configuration, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, tDDControlGroup=tDDControlGroup, sNTPPollInterval=sNTPPollInterval, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, iPv6PrefixLength=iPv6PrefixLength, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, auxPortSSMTx=auxPortSSMTx, sNMPTrapPortNumber=sNMPTrapPortNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mABProtocolVID=mABProtocolVID, iPv4Address=iPv4Address, mainPSUPortQLTx=mainPSUPortQLTx, range=range, unitName=unitName, ethernetInstancedTableEntry=ethernetInstancedTableEntry, ethernetInstancedTableIndex=ethernetInstancedTableIndex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, auxPortConfigurationMismatch=auxPortConfigurationMismatch, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, licenseRARSupport=licenseRARSupport, wirelessLinkStatusLinked=wirelessLinkStatusLinked, alarmInstancedTableEntry=alarmInstancedTableEntry, qOSPriorityScheme=qOSPriorityScheme, dataBridgingStatusLinked=dataBridgingStatusLinked, mainPSUPortQLRx=mainPSUPortQLRx, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, syncESlavePort=syncESlavePort, authorizationControlGroup=authorizationControlGroup, tDMEnabledChannels=tDMEnabledChannels, telnetAccessEnabled=telnetAccessEnabled, mainPSUPortAllocation=mainPSUPortAllocation, sNTPLastSync=sNTPLastSync, dfsGroup=dfsGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, authorizationControlTableIndex=authorizationControlTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, syncEEquipmentClock=syncEEquipmentClock, sFPPortStatusTrap=sFPPortStatusTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, licenseInstancedTable=licenseInstancedTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveModulationMode=receiveModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, routerProtocolsGroup=routerProtocolsGroup, transmitChannel=transmitChannel, snmpControl=snmpControl, vectorError=vectorError, wirelessOutEthernetOctets=wirelessOutEthernetOctets, reset=reset, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, licenseIssueNumber=licenseIssueNumber, tempPcb=tempPcb, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, remoteUnitName=remoteUnitName, targetMACAddress=targetMACAddress, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, txMABFrames=txMABFrames, ptpTraps=ptpTraps, licenseGasGroup=licenseGasGroup, secureModeAlarmTrap=secureModeAlarmTrap, mABNominalTransmitCapacity=mABNominalTransmitCapacity, remoteMACAddressLinked=remoteMACAddressLinked, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mABState=mABState, installArmStateTrap=installArmStateTrap, phyInstancedStatusTable=phyInstancedStatusTable, wirelessOutAllOctets=wirelessOutAllOctets, eIRP=eIRP, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm)
