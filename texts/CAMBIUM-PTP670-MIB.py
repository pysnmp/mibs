...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortStatusTrap=nIDULanPortStatusTrap, dNSServerTable=dNSServerTable, supplementaryGroup=supplementaryGroup, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, dataBridgingStatusAlarm=dataBridgingStatusAlarm, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, wirelessLinkStatusLinked=wirelessLinkStatusLinked, secondarySoftwareVersion=secondarySoftwareVersion, alarmInstancedTableEntry=alarmInstancedTableEntry, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDMGroup=tDMGroup, authorizationControlGroup=authorizationControlGroup, ptp=ptp, transmitModulationMode=transmitModulationMode, tDDSynchronizationMode=tDDSynchronizationMode, packetsFromInternalStack=packetsFromInternalStack, installationMode=installationMode, receiveModulationMode=receiveModulationMode, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, wirelessLinkStatus=wirelessLinkStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenseIPv6Support=licenseIPv6Support, installStatusLinked=installStatusLinked, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mABMaintenanceLevel=mABMaintenanceLevel, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, phyControlGroup=phyControlGroup, authorizationControlTable=authorizationControlTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmInstancedTableNumber=alarmInstancedTableNumber, wirelessOutOctets=wirelessOutOctets, secureModeAlarmTrap=secureModeAlarmTrap, auxPortDisabledWarning=auxPortDisabledWarning, licenseHCMPSupport=licenseHCMPSupport, alarmInstancedTableIndex=alarmInstancedTableIndex, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, iPv6Address=iPv6Address, tempPcb=tempPcb, sFPPortSSMTx=sFPPortSSMTx, altitude=altitude, systemReset=systemReset, maximumNumberOfSlaves=maximumNumberOfSlaves, portAllocationMismatch=portAllocationMismatch, dataBridgingAvailability=dataBridgingAvailability, tDMChannelStatus=tDMChannelStatus, remoteUnitNameLinked=remoteUnitNameLinked, licenseGroup=licenseGroup, licenseEncryption=licenseEncryption, sNMPTrapPortNumber=sNMPTrapPortNumber, gatewayIPAddress=gatewayIPAddress, transmitPowerLinked=transmitPowerLinked, linkLossLinked=linkLossLinked, sFPPortStatusTrap=sFPPortStatusTrap, rangeLinked=rangeLinked, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sNTPServerPortNumber=sNTPServerPortNumber, licenseCountry=licenseCountry, antennaSelection=antennaSelection, linkLoss=linkLoss, userPassword=userPassword, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sFPPortAllocation=sFPPortAllocation, extendedSpectrumScanning=extendedSpectrumScanning, tDDSynchronizationStatus=tDDSynchronizationStatus, linkName=linkName, antennaGain=antennaGain, sNMPCommunityString=sNMPCommunityString, aAAControlGroup=aAAControlGroup, alarmsGroup=alarmsGroup, transmitDataRateLinked=transmitDataRateLinked, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPServerInternetAddress=tFTPServerInternetAddress, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, syslogClient=syslogClient, dNSResolver=dNSResolver, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseGasGroup=licenseGasGroup, syslogState=syslogState, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, deviceESN=deviceESN, versionsGroup=versionsGroup, hTTPPortNumber=hTTPPortNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, phyStatusGroup=phyStatusGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, configurationInstancedTable=configurationInstancedTable, licenseCapacity=licenseCapacity, syslogClientTrap=syslogClientTrap, resetGroup=resetGroup, userTableEntry=userTableEntry, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNTPPrimaryServer=sNTPPrimaryServer, snmpControlGroup=snmpControlGroup, sFPPortQLTx=sFPPortQLTx, snmpControl=snmpControl, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, linkModeOptimizationMismatch=linkModeOptimizationMismatch, lbtDetectedTrap=lbtDetectedTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPEmailAlert=sMTPEmailAlert, capacityVariantMismatchTrap=capacityVariantMismatchTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, channelChangeTrap=channelChangeTrap, wirelessOutAllOctets=wirelessOutAllOctets, erroredSeconds=erroredSeconds, iPv4Address=iPv4Address, auxPortSSMTx=auxPortSSMTx, tFTPClient=tFTPClient, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkSymmetry=linkSymmetry, authorizationControlTableIndex=authorizationControlTableIndex, tDMInterfaceControl=tDMInterfaceControl, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseSyncESupport=licenseSyncESupport, hTTPAccessEnabled=hTTPAccessEnabled, dNSServerTableIndex=dNSServerTableIndex, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, maxLinkRangeExceeded=maxLinkRangeExceeded, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, ptmp=ptmp, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cableDiagnostics=cableDiagnostics, sNMPTrapTable=sNMPTrapTable, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, transparentClock=transparentClock, installArmStateTrap=installArmStateTrap, qOSPriorityScheme=qOSPriorityScheme, sntp=sntp, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, portAllocationMismatchLinked=portAllocationMismatchLinked, transmitterChannels=transmitterChannels, smtp=smtp, auxPortSyncERxStatus=auxPortSyncERxStatus, aAAControl=aAAControl, masterSlaveMode=masterSlaveMode, userRole=userRole, blacklistRMMacAddress=blacklistRMMacAddress, mgmtInstancedTableNumber=mgmtInstancedTableNumber, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, userEnabled=userEnabled, pubStats=pubStats, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, mainPSUPortAllocation=mainPSUPortAllocation, cableDiagPair4Results=cableDiagPair4Results, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, iPv6GatewayAddress=iPv6GatewayAddress, ethernetInstancedTableNumber=ethernetInstancedTableNumber, userTableNumber=userTableNumber, receivePowerLinked=receivePowerLinked, iPVersion=iPVersion, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, vLANManagementVID=vLANManagementVID, sFPErrorTrap=sFPErrorTrap, remoteInternetAddress=remoteInternetAddress, cableLoss=cableLoss, tDMConfigurationMismatch=tDMConfigurationMismatch, txColorCode=txColorCode, syslogControl=syslogControl, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, ethernetStatisticsDataSource=ethernetStatisticsDataSource, secureModeAlarm=secureModeAlarm, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseBandwidthCap=licenseBandwidthCap, ethernetStatisticsTable=ethernetStatisticsTable, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, useVLANForMABProtocol=useVLANForMABProtocol, licenseIEEE1588Support=licenseIEEE1588Support, capacityVariantMismatch=capacityVariantMismatch, tFTPServerPortNumber=tFTPServerPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseMaxLinkRange=licenseMaxLinkRange, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTable=sNTPServerTable, dNS=dNS, transparentClockVID=transparentClockVID, transparentClockPort=transparentClockPort, ethernetPriorityTableIndex=ethernetPriorityTableIndex, regulatoryBandTrap=regulatoryBandTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, bootVersion=bootVersion, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, smtpGroup=smtpGroup, managementGroup=managementGroup, dNSServerInternetAddress=dNSServerInternetAddress, tDDControlGroup=tDDControlGroup, mABProtocolVLANPriority=mABProtocolVLANPriority, routerProtocols=routerProtocols, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, cableDiagPair2Results=cableDiagPair2Results, tdmTable=tdmTable, iPDSCPPriorityTable=iPDSCPPriorityTable, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mABProtocolVID=mABProtocolVID, syncESlavePort=syncESlavePort, tFTPServerInternetAddressType=tFTPServerInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPState=sNTPState, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, mainPSUPortQLRx=mainPSUPortQLRx, localPacketFiltering=localPacketFiltering, iPv6PrefixLength=iPv6PrefixLength, dfsTableNumber=dfsTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortPauseFrames=dataPortPauseFrames, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNTPServerTimeout=sNTPServerTimeout, mainPSUPortAutoMdix=mainPSUPortAutoMdix, dSCPManagementPriority=dSCPManagementPriority, licenseSFPPortSupport=licenseSFPPortSupport, linkModeOptimization=linkModeOptimization, capacityVariantMismatchLinked=capacityVariantMismatchLinked, dfsGroup=dfsGroup, syslogControlGroup=syslogControlGroup, mABTransmissionInterval=mABTransmissionInterval, unitOutOfCalibration=unitOutOfCalibration, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sMTPServerInternetAddress=sMTPServerInternetAddress, sMTPEnabledMessages=sMTPEnabledMessages, unitIdentification=unitIdentification, mainPSUPortStatusTrap=mainPSUPortStatusTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, configurationGroup=configurationGroup, dNSServerTableNumber=dNSServerTableNumber, mgmtInstancedTable=mgmtInstancedTable, siteName=siteName, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", byteErrorRatioLinked=byteErrorRatioLinked, cambium=cambium, sNTPServerTableEntry=sNTPServerTableEntry, tDMInterfaceStatus=tDMInterfaceStatus, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, tDMChannelLineCode=tDMChannelLineCode, severelyErroredSeconds=severelyErroredSeconds, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseRegulatoryBandsList=licenseRegulatoryBandsList, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, subnetMask=subnetMask, l2CPPriorityTable=l2CPPriorityTable, targetMACAddress=targetMACAddress, dNSPrimaryServer=dNSPrimaryServer, cableDiagnosticsResultTable=cableDiagnosticsResultTable, PYSNMP_MODULE_ID=cambium, ethernetPriorityTable=ethernetPriorityTable, enableTransmission=enableTransmission, dNSServerPortNumber=dNSServerPortNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, dataBridgingStatusLinked=dataBridgingStatusLinked, sNTPServerInternetAddress=sNTPServerInternetAddress, authorizationMethod=authorizationMethod, mABState=mABState, eIRP=eIRP, licenseTrialPeriod=licenseTrialPeriod, management=management, sFPPortDisabledWarning=sFPPortDisabledWarning, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sNTPSyncTrap=sNTPSyncTrap, syncETracking=syncETracking, phyInstancedStatusTable=phyInstancedStatusTable, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, dNSGroup=dNSGroup, sFPError=sFPError, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, syslogStateTrap=syslogStateTrap, transmitPower=transmitPower, authorizationControlTableEntry=authorizationControlTableEntry, licenseInstancedTableNumber=licenseInstancedTableNumber, supplementary=supplementary, sNMPTrapVersion=sNMPTrapVersion, authorizationControl=authorizationControl, syncEEquipmentClock=syncEEquipmentClock, ptpGroups=ptpGroups, searchState=searchState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, bridgeGroup=bridgeGroup, cableDiagnosticsWarning=cableDiagnosticsWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsPeaks=dfsPeaks, sFPPortSyncERxStatus=sFPPortSyncERxStatus, pubInstancedStatsTable=pubInstancedStatsTable, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, remoteMACAddressLinked=remoteMACAddressLinked, licenseVersion=licenseVersion, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rawReceivePower=rawReceivePower, auxPortStatusTrap=auxPortStatusTrap, configurationInstancedTableNumber=configurationInstancedTableNumber, tDMEnabledChannels=tDMEnabledChannels, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNMPPortNumber=sNMPPortNumber, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, userName=userName, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, byteErrorRatio=byteErrorRatio, licenseGroupAccess=licenseGroupAccess, receiveModulationModeDetail=receiveModulationModeDetail, userTableIndex=userTableIndex, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, lowestDataModulationMode=lowestDataModulationMode, dNSServerTableEntry=dNSServerTableEntry, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, licenseTLSRekey=licenseTLSRekey, transmitFreqKHz=transmitFreqKHz, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, auxPortStatus=auxPortStatus, range=range, ethernetInstancedTableEntry=ethernetInstancedTableEntry, transmitDataRate=transmitDataRate, accessMethod=accessMethod, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, reset=reset, encryption=encryption, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpCompliance=ptpCompliance, transmitFreqMHz=transmitFreqMHz, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sFPPortAutoMdix=sFPPortAutoMdix, channelBandwidth=channelBandwidth, nIDULanPortStatus=nIDULanPortStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, vectorErrorLinked=vectorErrorLinked, remoteMACAddress=remoteMACAddress, configuration=configuration, cableDiagPair3Results=cableDiagPair3Results, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, frequencyVariant=frequencyVariant, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, encryptionGroup=encryptionGroup, configurationInstancedTableIndex=configurationInstancedTableIndex, sNTPPollInterval=sNTPPollInterval, latitude=latitude, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerRetries=sNTPServerRetries, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, license=license, unitName=unitName, apc=apc, cableDiagnosticsControl=cableDiagnosticsControl, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, maximumTransmitPower=maximumTransmitPower, groupID=groupID, incompatibleRegulatoryBands=incompatibleRegulatoryBands, softwareVersion=softwareVersion, ptpTrapPrefix=ptpTrapPrefix, vectorError=vectorError, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, receiveModulationModeLinked=receiveModulationModeLinked, dfs=dfs, hCMPMaximumLinkRange=hCMPMaximumLinkRange, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, cableDiagPair3Distance=cableDiagPair3Distance, installArmState=installArmState, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sNTPSync=sNTPSync, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortQLRx=auxPortQLRx, sFPPortAutoNegotiation=sFPPortAutoNegotiation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseSecurityLevel=licenseSecurityLevel, systemClock=systemClock, hTTPSPortNumber=hTTPSPortNumber, receiveDataRate=receiveDataRate, installStatus=installStatus, receiveDataRateLinked=receiveDataRateLinked, sNTPLastSync=sNTPLastSync, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernetInstancedTableIndex=ethernetInstancedTableIndex, licenseInstancedTableIndex=licenseInstancedTableIndex, tdmTableEntry=tdmTableEntry, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, productVariant=productVariant, transparentClockVLAN=transparentClockVLAN, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, cableDiagPair1Results=cableDiagPair1Results, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, phyControlInstancedTable=phyControlInstancedTable, sNMPv3Enable=sNMPv3Enable, tdmTableNumber=tdmTableNumber, aggregateDataRateLinked=aggregateDataRateLinked, receivePower=receivePower, tDDControl=tDDControl, sFPPortQLRx=sFPPortQLRx, mainPSUPortStatus=mainPSUPortStatus, rawReceivePowerLinked=rawReceivePowerLinked, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, tDM=tDM, dfsTableIndex=dfsTableIndex, versions=versions, licenseOOBManagementSupport=licenseOOBManagementSupport, installStatusTrap=installStatusTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, dfsTableEntry=dfsTableEntry, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, hardwareVersion=hardwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, cableDiagPair1Distance=cableDiagPair1Distance, whitelistRMEnabled=whitelistRMEnabled, apcGroup=apcGroup, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, wirelessTopology=wirelessTopology, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, subbandLowestFrequency=subbandLowestFrequency, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, subbandHighestFrequency=subbandHighestFrequency, cableDiagnosticsPorts=cableDiagnosticsPorts, hCMPLinkSymmetry=hCMPLinkSymmetry, auxPortAllocation=auxPortAllocation, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitChannel=transmitChannel, aggregateDataRate=aggregateDataRate, timeZone=timeZone, auxPortQLTx=auxPortQLTx, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveChannel=receiveChannel, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, searchStateLinked=searchStateLinked, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, auxPortConfigurationMismatch=auxPortConfigurationMismatch, userTable=userTable, pubStatsGroup=pubStatsGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mABNominalModulationMode=mABNominalModulationMode, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, unavailableSeconds=unavailableSeconds, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseIssueNumber=licenseIssueNumber, telnetPortNumber=telnetPortNumber, remoteUnitName=remoteUnitName, tDMChannelCableLength=tDMChannelCableLength, ethernetGroup=ethernetGroup, packetsToInternalStack=packetsToInternalStack, whitelistRMMacAddress=whitelistRMMacAddress, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, receiveFreqMHz=receiveFreqMHz, rxColorCode=rxColorCode, tDMChannelLoopback=tDMChannelLoopback, signalStrengthRatioLinked=signalStrengthRatioLinked, telnetAccessEnabled=telnetAccessEnabled, txMABFrames=txMABFrames, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, cableDiagPair4Distance=cableDiagPair4Distance, routerProtocolsGroup=routerProtocolsGroup, phyControlInstancedTableIndex=phyControlInstancedTableIndex, alarms=alarms, remoteInternetAddressType=remoteInternetAddressType, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, daylightSaving=daylightSaving, licenseInstancedTable=licenseInstancedTable, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, ethernetInstancedTable=ethernetInstancedTable, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, portAllocationMismatchTrap=portAllocationMismatchTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", authorizationControlTableNumber=authorizationControlTableNumber, unitIdentificationGroup=unitIdentificationGroup, phyStatus=phyStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPEnabledTraps=sNMPEnabledTraps, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, cableDiagnosticsGroup=cableDiagnosticsGroup, regulatoryBand=regulatoryBand, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, deviceMACAddress=deviceMACAddress, receiveFreqKHz=receiveFreqKHz, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, blacklistRMEnabled=blacklistRMEnabled, mainPSUPortQLTx=mainPSUPortQLTx, dNSServerInternetAddressType=dNSServerInternetAddressType, l2CPPriorityTableIndex=l2CPPriorityTableIndex, longitude=longitude, licenseInstancedTableEntry=licenseInstancedTableEntry, transmitModulationModeLinked=transmitModulationModeLinked, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, mainPSUPortSSMTx=mainPSUPortSSMTx, tdmTableIndex=tdmTableIndex, targetRange=targetRange, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDMChannelStatusTrap=tDMChannelStatusTrap, rangingMode=rangingMode, bridge=bridge, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, sFPPortStatus=sFPPortStatus, sntpGroup=sntpGroup, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, ptp670=ptp670, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dfsMeans=dfsMeans, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, syncETrackingState=syncETrackingState, dataBridgingStatus=dataBridgingStatus, licenseUnitSerialNumber=licenseUnitSerialNumber, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, lowestTDMModulationMode=lowestTDMModulationMode, productName=productName, phyControl=phyControl, notificationsGroup=notificationsGroup, dfsTable=dfsTable, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, ptpTraps=ptpTraps, deviceMSN=deviceMSN, vLANManagementPriority=vLANManagementPriority, phyControlInstancedTableEntry=phyControlInstancedTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, cableDiagPair2Distance=cableDiagPair2Distance, licenseRARSupport=licenseRARSupport, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sNTPServerStatus=sNTPServerStatus, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, mABHoldoffPeriod=mABHoldoffPeriod, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, alarmInstancedTable=alarmInstancedTable, encryptionAlgorithm=encryptionAlgorithm)
