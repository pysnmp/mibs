...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDMGroup=tDMGroup, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, linkSymmetry=linkSymmetry, cableDiagnostics=cableDiagnostics, ethernetStatisticsDataSource=ethernetStatisticsDataSource, transparentClockVID=transparentClockVID, nIDULanPortStatus=nIDULanPortStatus, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, dataBridgingStatusLinked=dataBridgingStatusLinked, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, syslogStateTrap=syslogStateTrap, ptp670=ptp670, receiveModulationModeDetail=receiveModulationModeDetail, syslogClient=syslogClient, installStatusTrap=installStatusTrap, licenseSFPPortSupport=licenseSFPPortSupport, incompatibleRegulatoryBands=incompatibleRegulatoryBands, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, snmpControl=snmpControl, deviceMSN=deviceMSN, qOSPriorityScheme=qOSPriorityScheme, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseSecurityLevel=licenseSecurityLevel, authorizationControlTableEntry=authorizationControlTableEntry, eIRP=eIRP, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPSyncTrap=sNTPSyncTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, dfsTableEntry=dfsTableEntry, snmpControlGroup=snmpControlGroup, syncESlavePort=syncESlavePort, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, ptp=ptp, authorizationControlTableNumber=authorizationControlTableNumber, subbandLowestFrequency=subbandLowestFrequency, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, configurationInstancedTableNumber=configurationInstancedTableNumber, unavailableSeconds=unavailableSeconds, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ethernetInstancedTable=ethernetInstancedTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, tDDControl=tDDControl, phyInstancedStatusTable=phyInstancedStatusTable, tDDSynchronizationMode=tDDSynchronizationMode, mainPSUPortStatusTrap=mainPSUPortStatusTrap, aggregateDataRate=aggregateDataRate, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, mABNominalModulationMode=mABNominalModulationMode, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarmsGroup=alarmsGroup, longitude=longitude, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, cableDiagPair4Results=cableDiagPair4Results, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, phyControlInstancedTable=phyControlInstancedTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, productVariant=productVariant, tDMChannelStatus=tDMChannelStatus, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, unitIdentificationGroup=unitIdentificationGroup, ethernet=ethernet, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, transmitFreqKHz=transmitFreqKHz, txColorCode=txColorCode, gatewayIPAddress=gatewayIPAddress, ethernetPriorityTable=ethernetPriorityTable, masterSlaveMode=masterSlaveMode, mgmtInstancedTableNumber=mgmtInstancedTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installArmStateTrap=installArmStateTrap, smtp=smtp, receiveModulationModeLinked=receiveModulationModeLinked, secondarySoftwareVersion=secondarySoftwareVersion, tempPcb=tempPcb, antennaGain=antennaGain, licenseRARSupport=licenseRARSupport, useVLANForManagementInterfaces=useVLANForManagementInterfaces, antennaSelection=antennaSelection, cableDiagPair1Distance=cableDiagPair1Distance, tDMInterfaceControl=tDMInterfaceControl, capacityVariantMismatchTrap=capacityVariantMismatchTrap, byteErrorRatioLinked=byteErrorRatioLinked, ptpCompliance=ptpCompliance, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, linkName=linkName, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sMTPServerInternetAddressType=sMTPServerInternetAddressType, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, wirelessOutAllOctets=wirelessOutAllOctets, groupID=groupID, secureModeAlarmTrap=secureModeAlarmTrap, userTableEntry=userTableEntry, nIDULanPortAutoMdix=nIDULanPortAutoMdix, licenseBandwidthCap=licenseBandwidthCap, sNMPTrapPortNumber=sNMPTrapPortNumber, siteName=siteName, aAAControlGroup=aAAControlGroup, bootVersion=bootVersion, whitelistRMMacAddress=whitelistRMMacAddress, sNTPServerPortNumber=sNTPServerPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyStatusGroup=phyStatusGroup, rawReceivePower=rawReceivePower, routerProtocols=routerProtocols, maximumTransmitPower=maximumTransmitPower, productName=productName, licenseInstancedTableEntry=licenseInstancedTableEntry, iPVersion=iPVersion, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, versionsGroup=versionsGroup, mABState=mABState, authorizationControlTable=authorizationControlTable, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, syncETrackingState=syncETrackingState, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, portAllocationMismatch=portAllocationMismatch, notificationsGroup=notificationsGroup, mgmtInstancedTableIndex=mgmtInstancedTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, mABNominalTransmitCapacity=mABNominalTransmitCapacity, localPacketFiltering=localPacketFiltering, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, transparentClockVLAN=transparentClockVLAN, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, useVLANForMABProtocol=useVLANForMABProtocol, unitOutOfCalibration=unitOutOfCalibration, sFPPortStatus=sFPPortStatus, transmitterChannels=transmitterChannels, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, mainPSUPortStatus=mainPSUPortStatus, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseCountry=licenseCountry, lbtDetectedTrap=lbtDetectedTrap, mainPSUPortAllocation=mainPSUPortAllocation, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, authorizationControlGroup=authorizationControlGroup, tDMChannelCableLength=tDMChannelCableLength, aAAControl=aAAControl, linkLossLinked=linkLossLinked, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, auxPortQLTx=auxPortQLTx, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, range=range, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, cableDiagPair4Distance=cableDiagPair4Distance, mgmtInstancedTable=mgmtInstancedTable, txMABFrames=txMABFrames, authorizationMethod=authorizationMethod, license=license, vectorError=vectorError, mainPSUPortQLRx=mainPSUPortQLRx, alarmInstancedTableNumber=alarmInstancedTableNumber, tdmTableEntry=tdmTableEntry, auxPortStatusTrap=auxPortStatusTrap, phyStatus=phyStatus, configurationGroup=configurationGroup, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, sFPPortAutoNegotiation=sFPPortAutoNegotiation, alarmInstancedTableIndex=alarmInstancedTableIndex, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, dNS=dNS, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userPassword=userPassword, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagnosticsResultTable=cableDiagnosticsResultTable, regulatoryBandTrap=regulatoryBandTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tdmTableNumber=tdmTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sFPPortStatusTrap=sFPPortStatusTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, userEnabled=userEnabled, vLANManagementVID=vLANManagementVID, licenseInstancedTableIndex=licenseInstancedTableIndex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitDataRateLinked=transmitDataRateLinked, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dNSPrimaryServer=dNSPrimaryServer, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, remoteInternetAddressLinked=remoteInternetAddressLinked, ethernetPriorityTableIndex=ethernetPriorityTableIndex, transparentClockPort=transparentClockPort, iPv4Address=iPv4Address, vLANManagementPriority=vLANManagementPriority, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseCapacity=licenseCapacity, mABProtocolVID=mABProtocolVID, sNMPTrapVersion=sNMPTrapVersion, remoteUnitNameLinked=remoteUnitNameLinked, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, linkModeOptimization=linkModeOptimization, syslogControl=syslogControl, ptpTrapPrefix=ptpTrapPrefix, cableLoss=cableLoss, remoteInternetAddressType=remoteInternetAddressType, targetMACAddress=targetMACAddress, syncETracking=syncETracking, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRateLinked=aggregateDataRateLinked, sFPPortAutoMdix=sFPPortAutoMdix, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sFPPortDisabledWarning=sFPPortDisabledWarning, licenseGroupAccess=licenseGroupAccess, configurationInstancedTableIndex=configurationInstancedTableIndex, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, lowestDataModulationMode=lowestDataModulationMode, mABHoldoffPeriod=mABHoldoffPeriod, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, syncEEquipmentClock=syncEEquipmentClock, remoteUnitName=remoteUnitName, licenseInstancedTableNumber=licenseInstancedTableNumber, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, wirelessTopology=wirelessTopology, wirelessLinkStatusLinked=wirelessLinkStatusLinked, pubInstancedStatsTable=pubInstancedStatsTable, licenseIEEE1588Support=licenseIEEE1588Support, licenseSyncESupport=licenseSyncESupport, sNMPTrapTableNumber=sNMPTrapTableNumber, userName=userName, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTable=sNMPTrapTable, ptpTraps=ptpTraps, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, installationMode=installationMode, sNTPServerTableEntry=sNTPServerTableEntry, tDMEnabledChannels=tDMEnabledChannels, channelChangeTrap=channelChangeTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receivePower=receivePower, mPLSTCPriorityTable=mPLSTCPriorityTable, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, deviceMACAddress=deviceMACAddress, remoteInternetAddress=remoteInternetAddress, auxPortStatus=auxPortStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dNSServerTableIndex=dNSServerTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dNSServerInternetAddressType=dNSServerInternetAddressType, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sFPError=sFPError, erroredSeconds=erroredSeconds, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, dfsPeaks=dfsPeaks, subbandHighestFrequency=subbandHighestFrequency, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerInternetAddress=tFTPServerInternetAddress, auxPortAllocation=auxPortAllocation, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sFPPortSyncERxStatus=sFPPortSyncERxStatus, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTimeout=sNTPServerTimeout, capacityVariantMismatch=capacityVariantMismatch, encryptionGroup=encryptionGroup, dfsGroup=dfsGroup, telnetAccessEnabled=telnetAccessEnabled, dataPortPauseFrames=dataPortPauseFrames, resetGroup=resetGroup, alarmInstancedTable=alarmInstancedTable, syslogControlGroup=syslogControlGroup, mABMaintenanceLevel=mABMaintenanceLevel, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, supplementaryGroup=supplementaryGroup, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, rangeLinked=rangeLinked, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, maxLinkRangeExceeded=maxLinkRangeExceeded, deviceESN=deviceESN, mainPSUPortSSMTx=mainPSUPortSSMTx, sMTPServerPortNumber=sMTPServerPortNumber, receiveModulationMode=receiveModulationMode, phyControl=phyControl, ptpGroups=ptpGroups, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyControlInstancedTableIndex=phyControlInstancedTableIndex, remoteMACAddress=remoteMACAddress, wirelessLinkAvailability=wirelessLinkAvailability, systemReset=systemReset, licenseIssueNumber=licenseIssueNumber, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, portAllocationMismatchTrap=portAllocationMismatchTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, dfsTableIndex=dfsTableIndex, bridge=bridge, licenseUnitSerialNumber=licenseUnitSerialNumber, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, cableDiagnosticsPorts=cableDiagnosticsPorts, userTableIndex=userTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitModulationMode=transmitModulationMode, maximumNumberOfSlaves=maximumNumberOfSlaves, latitude=latitude, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tDMChannelLineCode=tDMChannelLineCode, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, cambium=cambium, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, userRole=userRole, managementGroup=managementGroup, receiveDataRate=receiveDataRate, pubStatsGroup=pubStatsGroup, blacklistRMEnabled=blacklistRMEnabled, bridgeGroup=bridgeGroup, sNTPServerTableIndex=sNTPServerTableIndex, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogState=syslogState, cableDiagPair3Distance=cableDiagPair3Distance, sFPPortQLTx=sFPPortQLTx, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, dNSServerTable=dNSServerTable, installArmState=installArmState, licenseGroup=licenseGroup, encryption=encryption, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseIPv6Support=licenseIPv6Support, sNTPServerStatus=sNTPServerStatus, authorizationControl=authorizationControl, portAllocationMismatchLinked=portAllocationMismatchLinked, dNSServerTableNumber=dNSServerTableNumber, hTTPPortNumber=hTTPPortNumber, cableDiagnosticsControl=cableDiagnosticsControl, whitelistRMEnabled=whitelistRMEnabled, systemClock=systemClock, unitName=unitName, sNMPv3Enable=sNMPv3Enable, mABProtocolVLANPriority=mABProtocolVLANPriority, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, apc=apc, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, tDMInterfaceStatus=tDMInterfaceStatus, userTable=userTable, auxPortDisabledWarning=auxPortDisabledWarning, dfsMeans=dfsMeans, ptmp=ptmp, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, alarms=alarms, supplementary=supplementary, licenseTDDSyncSupport=licenseTDDSyncSupport, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, tDM=tDM, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, oOBPriorityQueueMapping=oOBPriorityQueueMapping, configuration=configuration, tDMChannelLoopback=tDMChannelLoopback, dSCPManagementPriority=dSCPManagementPriority, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, enableTransmission=enableTransmission, transparentClock=transparentClock, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyControlGroup=phyControlGroup, hardwareVersion=hardwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, receiveChannel=receiveChannel, cableDiagPair2Distance=cableDiagPair2Distance, cableDiagPair2Results=cableDiagPair2Results, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sNTPPollInterval=sNTPPollInterval, wirelessOutOctets=wirelessOutOctets, targetRange=targetRange, subnetMask=subnetMask, accessMethod=accessMethod, wirelessOutEthernetOctets=wirelessOutEthernetOctets, dataBridgingStatusAlarm=dataBridgingStatusAlarm, transmitModulationModeLinked=transmitModulationModeLinked, alarmInstancedTableEntry=alarmInstancedTableEntry, userTableNumber=userTableNumber, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, configurationInstancedTable=configurationInstancedTable, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, hCMPMaximumLinkRange=hCMPMaximumLinkRange, softwareVersion=softwareVersion, capacityVariantMismatchLinked=capacityVariantMismatchLinked, iPv6GatewayAddress=iPv6GatewayAddress, altitude=altitude, linkLoss=linkLoss, packetsFromInternalStack=packetsFromInternalStack, licenseEncryption=licenseEncryption, remoteMACAddressLinked=remoteMACAddressLinked, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogClientTrap=syslogClientTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseTrialPeriod=licenseTrialPeriod, tDDControlGroup=tDDControlGroup, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, l2CPPriorityTable=l2CPPriorityTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfsTableNumber=dfsTableNumber, management=management, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, iPv6PrefixLength=iPv6PrefixLength, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseInstancedTable=licenseInstancedTable, licenseTLSRekey=licenseTLSRekey, sFPPortSSMTx=sFPPortSSMTx, tdmTableIndex=tdmTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitDataRate=transmitDataRate, ethernetStatisticsTable=ethernetStatisticsTable, extendedSpectrumScanning=extendedSpectrumScanning, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, rawReceivePowerLinked=rawReceivePowerLinked, auxPortSSMTx=auxPortSSMTx, transmitPower=transmitPower, configurationInstancedTableEntry=configurationInstancedTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telnetPortNumber=telnetPortNumber, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sNTPState=sNTPState, dNSServerInternetAddress=dNSServerInternetAddress, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, transmitPowerLinked=transmitPowerLinked, frequencyVariant=frequencyVariant, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, versions=versions, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, timeZone=timeZone, reset=reset, rangingMode=rangingMode, dfs=dfs, vectorErrorLinked=vectorErrorLinked, PYSNMP_MODULE_ID=cambium, dataBridgingAvailability=dataBridgingAvailability, apcGroup=apcGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTable=sNTPServerTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, phyControlInstancedTableNumber=phyControlInstancedTableNumber, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, rxColorCode=rxColorCode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, signalStrengthRatioLinked=signalStrengthRatioLinked, transmitFreqMHz=transmitFreqMHz, licenseGasGroup=licenseGasGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, cableDiagPair3Results=cableDiagPair3Results, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagPair1Results=cableDiagPair1Results, licenseHCMPSupport=licenseHCMPSupport, regulatoryBand=regulatoryBand, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, byteErrorRatio=byteErrorRatio, sNTPLastSync=sNTPLastSync, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, severelyErroredSeconds=severelyErroredSeconds, auxPortSyncERxStatus=auxPortSyncERxStatus, daylightSaving=daylightSaving)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dfsTable=dfsTable, receivePowerLinked=receivePowerLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, transmitChannel=transmitChannel, receiveDataRateLinked=receiveDataRateLinked, installStatus=installStatus, unitIdentification=unitIdentification, signalStrengthRatio=signalStrengthRatio, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, encryptionAlgorithm=encryptionAlgorithm, cableDiagnosticsWarning=cableDiagnosticsWarning, dataBridgingStatus=dataBridgingStatus, dNSGroup=dNSGroup, blacklistRMMacAddress=blacklistRMMacAddress, iPv6Address=iPv6Address, dNSServerPortNumber=dNSServerPortNumber, sntp=sntp, channelBandwidth=channelBandwidth, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, packetsToInternalStack=packetsToInternalStack, secureModeAlarm=secureModeAlarm, hTTPSPortNumber=hTTPSPortNumber, authorizationControlTableIndex=authorizationControlTableIndex, hCMPLinkSymmetry=hCMPLinkSymmetry, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, dNSServerTableEntry=dNSServerTableEntry, smtpGroup=smtpGroup, sFPPortAllocation=sFPPortAllocation, sFPErrorTrap=sFPErrorTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, routerProtocolsGroup=routerProtocolsGroup, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNTPServerTableNumber=sNTPServerTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, ethernetGroup=ethernetGroup, tDMConfigurationMismatch=tDMConfigurationMismatch, installStatusLinked=installStatusLinked, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tFTPClient=tFTPClient, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, lowestTDMModulationMode=lowestTDMModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dNSResolver=dNSResolver, receiveFreqMHz=receiveFreqMHz, l2CPPriorityTableIndex=l2CPPriorityTableIndex, licenseVersion=licenseVersion, searchStateLinked=searchStateLinked, mABTransmissionInterval=mABTransmissionInterval, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, tdmTable=tdmTable, auxPortQLRx=auxPortQLRx, sFPPortQLRx=sFPPortQLRx, sNTPServerRetries=sNTPServerRetries, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sntpGroup=sntpGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime)
