...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", qOSPriorityScheme=qOSPriorityScheme, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityString=sNMPCommunityString, sFPPortStatusTrap=sFPPortStatusTrap, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, daylightSaving=daylightSaving, maxLinkRangeExceeded=maxLinkRangeExceeded, snmpControl=snmpControl, licenseIPv6Support=licenseIPv6Support, dfsTableNumber=dfsTableNumber, aggregateDataRate=aggregateDataRate, ethernetPriorityTableEntry=ethernetPriorityTableEntry, softwareVersion=softwareVersion, authorizationControlTableIndex=authorizationControlTableIndex, portAllocationMismatchLinked=portAllocationMismatchLinked, rawReceivePower=rawReceivePower, licenseGroupAccess=licenseGroupAccess, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPEnabledTraps=sNMPEnabledTraps, configuration=configuration, remoteInternetAddress=remoteInternetAddress, wirelessOutAllOctets=wirelessOutAllOctets, vLANManagementVID=vLANManagementVID, dataPortPauseFrames=dataPortPauseFrames, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, mABState=mABState, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, managementGroup=managementGroup, linkName=linkName, encryption=encryption, hCMPLinkSymmetry=hCMPLinkSymmetry, dNSServerTableIndex=dNSServerTableIndex, sFPPortQLRx=sFPPortQLRx, accessMethod=accessMethod, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, aAAControlGroup=aAAControlGroup, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, mainPSUPortQLRx=mainPSUPortQLRx, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tDDControl=tDDControl, encryptionAlgorithm=encryptionAlgorithm, mainPSUPortAutoMdix=mainPSUPortAutoMdix, linkSymmetry=linkSymmetry, remoteMACAddress=remoteMACAddress, receiveModulationModeDetail=receiveModulationModeDetail, dNSServerTableNumber=dNSServerTableNumber, txMABFrames=txMABFrames, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mABTransmissionInterval=mABTransmissionInterval, enableTransmission=enableTransmission, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, smtp=smtp, mgmtInstancedTableIndex=mgmtInstancedTableIndex, dfsPeaks=dfsPeaks, tDMChannelStatusTrap=tDMChannelStatusTrap, bridge=bridge, tDDSynchronizationAlarm=tDDSynchronizationAlarm, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sntp=sntp, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernet=ethernet, capacityVariantMismatch=capacityVariantMismatch, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptpTraps=ptpTraps, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, userRole=userRole, unitIdentification=unitIdentification, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, supplementaryGroup=supplementaryGroup, alarmInstancedTable=alarmInstancedTable, vectorErrorLinked=vectorErrorLinked, dataBridgingStatusLinked=dataBridgingStatusLinked, wirelessTopology=wirelessTopology, auxPortDisabledWarning=auxPortDisabledWarning, blacklistRMEnabled=blacklistRMEnabled, whitelistRMEnabled=whitelistRMEnabled, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tDMChannelStatus=tDMChannelStatus, hTTPAccessEnabled=hTTPAccessEnabled, maximumTransmitPower=maximumTransmitPower, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, routerProtocolsGroup=routerProtocolsGroup, capacityVariantMismatchTrap=capacityVariantMismatchTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, userTableEntry=userTableEntry, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, channelBandwidth=channelBandwidth, alarmsGroup=alarmsGroup, alarmInstancedTableNumber=alarmInstancedTableNumber, packetsFromInternalStack=packetsFromInternalStack, installStatusLinked=installStatusLinked, aggregateDataRateLinked=aggregateDataRateLinked, erroredSeconds=erroredSeconds, reset=reset, userTable=userTable, cableDiagPair4Results=cableDiagPair4Results, tFTPServerPortNumber=tFTPServerPortNumber, transparentClockVID=transparentClockVID, syslogState=syslogState, receiveFreqMHz=receiveFreqMHz, phyInstancedStatusTable=phyInstancedStatusTable, userTableIndex=userTableIndex, licenseCapacity=licenseCapacity, sFPPortSSMTx=sFPPortSSMTx, dataBridgingStatus=dataBridgingStatus, ptmp=ptmp, sNTPSyncTrap=sNTPSyncTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, noWirelessChannelAvailable=noWirelessChannelAvailable, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, encryptionGroup=encryptionGroup, dSCPManagementPriority=dSCPManagementPriority, ethernetInstancedTableIndex=ethernetInstancedTableIndex, notificationsGroup=notificationsGroup, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, hTTPPortNumber=hTTPPortNumber, linkLoss=linkLoss, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerTable=sNTPServerTable, tDMConfigurationMismatch=tDMConfigurationMismatch, tDMInterfaceStatus=tDMInterfaceStatus, supplementary=supplementary, portAllocationMismatch=portAllocationMismatch, dfs=dfs, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPDSCPPriorityTable=iPDSCPPriorityTable, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, userName=userName, receivePower=receivePower, syslogClientTrap=syslogClientTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, smtpGroup=smtpGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, transmitDataRate=transmitDataRate, ethernetGroup=ethernetGroup, licenseTDDSyncSupport=licenseTDDSyncSupport, cableDiagPair1Results=cableDiagPair1Results, systemClock=systemClock, syslogClient=syslogClient, auxPortConfigurationMismatch=auxPortConfigurationMismatch, phyControlInstancedTableEntry=phyControlInstancedTableEntry, auxPortSSMTx=auxPortSSMTx, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, useVLANForManagementInterfaces=useVLANForManagementInterfaces, frequencyVariant=frequencyVariant, gatewayIPAddress=gatewayIPAddress, localPacketFiltering=localPacketFiltering, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, syncEEquipmentClock=syncEEquipmentClock, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseSyncESupport=licenseSyncESupport, sNMPTrapTableIndex=sNMPTrapTableIndex, groupID=groupID, auxPortStatus=auxPortStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, secureModeAlarm=secureModeAlarm, transparentClockPort=transparentClockPort, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, txColorCode=txColorCode, userEnabled=userEnabled, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, authorizationControlTableNumber=authorizationControlTableNumber, licenseHCMPSupport=licenseHCMPSupport, ethernetStatisticsDataSource=ethernetStatisticsDataSource, iPv6PrefixLength=iPv6PrefixLength, phyControl=phyControl, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, pubInstancedStatsTable=pubInstancedStatsTable, userTableNumber=userTableNumber, ptpCompliance=ptpCompliance, iPv6Address=iPv6Address, configurationInstancedTableNumber=configurationInstancedTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, management=management, cableDiagPair3Results=cableDiagPair3Results, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, rangingMode=rangingMode, tdmTableIndex=tdmTableIndex, licenseSFPPortSupport=licenseSFPPortSupport, hCMPMaximumLinkRange=hCMPMaximumLinkRange, dfsTableIndex=dfsTableIndex, mainPSUPortAllocation=mainPSUPortAllocation, l2CPPriorityTableEntry=l2CPPriorityTableEntry, syslogControlGroup=syslogControlGroup, antennaSelection=antennaSelection, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, altitude=altitude, ethernetPriorityTable=ethernetPriorityTable, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, mainPSUPortStatusTrap=mainPSUPortStatusTrap, licenseRARSupport=licenseRARSupport, antennaGain=antennaGain, mgmtInstancedTableEntry=mgmtInstancedTableEntry, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, dfsGroup=dfsGroup, channelChangeTrap=channelChangeTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseIssueNumber=licenseIssueNumber, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPollInterval=sNTPPollInterval, pubStats=pubStats, wirelessLinkAvailability=wirelessLinkAvailability, dfsMeans=dfsMeans, sMTPEmailAlert=sMTPEmailAlert, range=range, ethernetStatisticsTable=ethernetStatisticsTable, licenseCountry=licenseCountry, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sNMPPortNumber=sNMPPortNumber, transparentClockVLAN=transparentClockVLAN, routerProtocols=routerProtocols, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, installArmState=installArmState, iPVersion=iPVersion, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dNSServerPortNumber=dNSServerPortNumber, snmpControlGroup=snmpControlGroup, tdmTableNumber=tdmTableNumber, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, secureModeAlarmTrap=secureModeAlarmTrap, authorizationControlGroup=authorizationControlGroup, configurationInstancedTableIndex=configurationInstancedTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDControlGroup=tDDControlGroup, phyStatusGroup=phyStatusGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, cableDiagPair1Distance=cableDiagPair1Distance, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, configurationInstancedTable=configurationInstancedTable, transmitPower=transmitPower, syslogControl=syslogControl, licenseInstancedTable=licenseInstancedTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, rangeLinked=rangeLinked, maximumNumberOfSlaves=maximumNumberOfSlaves, cableDiagPair3Distance=cableDiagPair3Distance, timeZone=timeZone)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ptp670=ptp670, linkModeOptimization=linkModeOptimization, configurationGroup=configurationGroup, systemReset=systemReset, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, PYSNMP_MODULE_ID=cambium, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, whitelistRMMacAddress=whitelistRMMacAddress, licenseIEEE1588Support=licenseIEEE1588Support, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sNTPServerTableIndex=sNTPServerTableIndex, ptpTrapPrefix=ptpTrapPrefix, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, mgmtInstancedTableNumber=mgmtInstancedTableNumber, transparentClock=transparentClock, unitOutOfCalibration=unitOutOfCalibration, cableLoss=cableLoss, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sMTPServerPortNumber=sMTPServerPortNumber, receiveDataRate=receiveDataRate, dNSResolver=dNSResolver, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, phyControlGroup=phyControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseVersion=licenseVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkStatusLinked=wirelessLinkStatusLinked, dataBridgingAvailability=dataBridgingAvailability, rawReceivePowerLinked=rawReceivePowerLinked, mPLSTCPriorityTable=mPLSTCPriorityTable, cableDiagnosticsPorts=cableDiagnosticsPorts, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, cableDiagnosticsGroup=cableDiagnosticsGroup, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sNTPLastSync=sNTPLastSync, useVLANForMABProtocol=useVLANForMABProtocol, mainPSUPortStatus=mainPSUPortStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNTPServerStatus=sNTPServerStatus, targetRange=targetRange, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, managementPortWirelessDownAlert=managementPortWirelessDownAlert, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, deviceMSN=deviceMSN, sNTPServerTableEntry=sNTPServerTableEntry, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseGasGroup=licenseGasGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkLossLinked=linkLossLinked, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sFPPortAutoNegotiation=sFPPortAutoNegotiation, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tdmTable=tdmTable, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, phyStatus=phyStatus, capacityVariantMismatchLinked=capacityVariantMismatchLinked, syncETracking=syncETracking, packetsToInternalStack=packetsToInternalStack, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, iPv4Address=iPv4Address, transmitPowerLinked=transmitPowerLinked, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, subbandHighestFrequency=subbandHighestFrequency, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, cableDiagnostics=cableDiagnostics, receiveDataRateLinked=receiveDataRateLinked, dNSPrimaryServer=dNSPrimaryServer, iPv6GatewayAddress=iPv6GatewayAddress, targetMACAddress=targetMACAddress, authorizationMethod=authorizationMethod, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, receiveChannel=receiveChannel, licenseTLSRekey=licenseTLSRekey, sMTPServerInternetAddressType=sMTPServerInternetAddressType, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, wirelessOutOctets=wirelessOutOctets, pubStatsGroup=pubStatsGroup, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseBandwidthCap=licenseBandwidthCap, sFPPortStatus=sFPPortStatus, sntpGroup=sntpGroup, ethernetInstancedTableEntry=ethernetInstancedTableEntry, masterSlaveMode=masterSlaveMode, dNSServerTableEntry=dNSServerTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dNSServerInternetAddress=dNSServerInternetAddress, aAAControl=aAAControl, tDMChannelLoopback=tDMChannelLoopback, alarms=alarms, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, tdmTableEntry=tdmTableEntry, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, auxPortAcceptedQLRx=auxPortAcceptedQLRx, versions=versions, receiveModulationModeLinked=receiveModulationModeLinked, transmitModulationMode=transmitModulationMode, userPassword=userPassword, productVariant=productVariant, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, installStatusTrap=installStatusTrap, l2CPPriorityTable=l2CPPriorityTable, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPClient=tFTPClient, licenseTrialPeriod=licenseTrialPeriod, tempPcb=tempPcb, installArmStateTrap=installArmStateTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, phyControlInstancedTable=phyControlInstancedTable, eIRP=eIRP, ethernetInstancedTable=ethernetInstancedTable, syncETrackingState=syncETrackingState, auxPortQLTx=auxPortQLTx, mABNominalTransmitCapacity=mABNominalTransmitCapacity, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, mABProtocolVLANPriority=mABProtocolVLANPriority, longitude=longitude, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, regulatoryBand=regulatoryBand, lbtDetectedTrap=lbtDetectedTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sMTPServerInternetAddress=sMTPServerInternetAddress, unitIdentificationGroup=unitIdentificationGroup, siteName=siteName, mABProtocolVID=mABProtocolVID, sFPErrorTrap=sFPErrorTrap, authorizationControl=authorizationControl, auxPortAllocation=auxPortAllocation, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, alarmInstancedTableIndex=alarmInstancedTableIndex, auxPortQLRx=auxPortQLRx, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, unitName=unitName, mABNominalModulationMode=mABNominalModulationMode, searchStateLinked=searchStateLinked, licenseRegulatoryBandsList=licenseRegulatoryBandsList, tDDSynchronizationMode=tDDSynchronizationMode, licenseSecurityLevel=licenseSecurityLevel, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, subnetMask=subnetMask, vLANManagementPriority=vLANManagementPriority, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNTPState=sNTPState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, byteErrorRatioLinked=byteErrorRatioLinked, byteErrorRatio=byteErrorRatio, remoteInternetAddressLinked=remoteInternetAddressLinked, blacklistRMMacAddress=blacklistRMMacAddress, deviceMACAddress=deviceMACAddress, tDMGroup=tDMGroup, remoteUnitName=remoteUnitName, mainPSUPortSSMTx=mainPSUPortSSMTx, receivePowerLinked=receivePowerLinked, phyControlInstancedTableIndex=phyControlInstancedTableIndex, remoteInternetAddressType=remoteInternetAddressType, remoteMACAddressLinked=remoteMACAddressLinked, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sFPPortQLTx=sFPPortQLTx, severelyErroredSeconds=severelyErroredSeconds, tDMChannelLineCode=tDMChannelLineCode, vectorError=vectorError, secondarySoftwareVersion=secondarySoftwareVersion, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hardwareVersion=hardwareVersion, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, authorizationControlTable=authorizationControlTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, cableDiagPair2Distance=cableDiagPair2Distance, resetGroup=resetGroup, installStatus=installStatus, dNSServerInternetAddressType=dNSServerInternetAddressType, latitude=latitude, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseInstancedTableNumber=licenseInstancedTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cableDiagPair4Distance=cableDiagPair4Distance, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortStatusTrap=auxPortStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mgmtInstancedTable=mgmtInstancedTable, cableDiagnosticsControl=cableDiagnosticsControl, sMTPEnabledMessages=sMTPEnabledMessages, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dNSGroup=dNSGroup, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, license=license, mABHoldoffPeriod=mABHoldoffPeriod, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, rxColorCode=rxColorCode, licenseUnitSerialNumber=licenseUnitSerialNumber, transmitterChannels=transmitterChannels, sFPError=sFPError, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, cableDiagnosticsResultTable=cableDiagnosticsResultTable, lowestDataModulationMode=lowestDataModulationMode, receiveFreqKHz=receiveFreqKHz, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sNTPServerTimeout=sNTPServerTimeout, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tDMInterfaceControl=tDMInterfaceControl, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, alarmInstancedTableEntry=alarmInstancedTableEntry, searchState=searchState, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, tDM=tDM, telnetPortNumber=telnetPortNumber, sNTPServerRetries=sNTPServerRetries, licenseEncryption=licenseEncryption, authorizationControlTableEntry=authorizationControlTableEntry, hTTPSPortNumber=hTTPSPortNumber, deviceESN=deviceESN, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogStateTrap=syslogStateTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, regulatoryBandTrap=regulatoryBandTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, wirelessLinkStatus=wirelessLinkStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenseInstancedTableEntry=licenseInstancedTableEntry, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, bridgeGroup=bridgeGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, licenseInstancedTableIndex=licenseInstancedTableIndex, licenseGroup=licenseGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPTrapTable=sNMPTrapTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, signalStrengthRatioLinked=signalStrengthRatioLinked, transmitFreqKHz=transmitFreqKHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDMChannelCableLength=tDMChannelCableLength, dNS=dNS, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tDMEnabledChannels=tDMEnabledChannels, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, productName=productName, dfsTableEntry=dfsTableEntry, ptpGroups=ptpGroups, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, transmitChannel=transmitChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPSync=sNTPSync, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, wirelessOutEthernetOctets=wirelessOutEthernetOctets, unavailableSeconds=unavailableSeconds, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, extendedSpectrumScanning=extendedSpectrumScanning, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, dNSServerTable=dNSServerTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortAllocation=sFPPortAllocation, syncESlavePort=syncESlavePort, transmitModulationModeLinked=transmitModulationModeLinked, ptp=ptp, mainPSUPortQLTx=mainPSUPortQLTx, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, nIDULanPortStatus=nIDULanPortStatus, incompatibleRegulatoryBands=incompatibleRegulatoryBands, remoteUnitNameLinked=remoteUnitNameLinked, installationMode=installationMode, cambium=cambium, versionsGroup=versionsGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, sNMPv3Enable=sNMPv3Enable, sNMPTrapVersion=sNMPTrapVersion, sNTPServerPortNumber=sNTPServerPortNumber, apc=apc, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagPair2Results=cableDiagPair2Results, dfsTable=dfsTable, signalStrengthRatio=signalStrengthRatio, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, apcGroup=apcGroup, transmitDataRateLinked=transmitDataRateLinked, subbandLowestFrequency=subbandLowestFrequency, sFPPortAutoMdix=sFPPortAutoMdix, mABMaintenanceLevel=mABMaintenanceLevel, lowestTDMModulationMode=lowestTDMModulationMode, receiveModulationMode=receiveModulationMode, nIDULanPortStatusTrap=nIDULanPortStatusTrap)
