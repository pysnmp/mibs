...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", unitName=unitName, installArmStateTrap=installArmStateTrap, licenseTrialPeriod=licenseTrialPeriod, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, subnetMask=subnetMask, dataPortPauseFrames=dataPortPauseFrames, receivePower=receivePower, wirelessLinkStatus=wirelessLinkStatus, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, encryptionAlgorithm=encryptionAlgorithm, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mainPSUPortSSMTx=mainPSUPortSSMTx, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, unavailableSeconds=unavailableSeconds, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, tDMGroup=tDMGroup, configuration=configuration, licenseSecurityLevel=licenseSecurityLevel, iPv6PrefixLength=iPv6PrefixLength, licenseGasGroup=licenseGasGroup, transmitterChannels=transmitterChannels, transmitPowerLinked=transmitPowerLinked, deviceESN=deviceESN, lowestDataModulationMode=lowestDataModulationMode, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sFPPortQLTx=sFPPortQLTx, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, channelChangeTrap=channelChangeTrap, accessMethod=accessMethod, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, maximumNumberOfSlaves=maximumNumberOfSlaves, frequencyVariant=frequencyVariant, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, pubStatsGroup=pubStatsGroup, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, tDMChannelLineCode=tDMChannelLineCode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, rawReceivePower=rawReceivePower, userTable=userTable, linkName=linkName, licenseHCMPSupport=licenseHCMPSupport, sNMPPortNumber=sNMPPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, hTTPPortNumber=hTTPPortNumber, licenseMaxLinkRange=licenseMaxLinkRange, deviceMSN=deviceMSN, auxPortQLTx=auxPortQLTx, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, notificationsGroup=notificationsGroup, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sFPPortSSMTx=sFPPortSSMTx, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, snmpControlGroup=snmpControlGroup, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, syncETracking=syncETracking, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, receiveDataRateLinked=receiveDataRateLinked, lowestTDMModulationMode=lowestTDMModulationMode, sNTPPollInterval=sNTPPollInterval, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkLoss=linkLoss, eIRP=eIRP, transparentClock=transparentClock, sFPPortStatusTrap=sFPPortStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, authorizationControlGroup=authorizationControlGroup, mABProtocolVID=mABProtocolVID, phyControlGroup=phyControlGroup, tDMConfigurationMismatch=tDMConfigurationMismatch, sFPPortAllocation=sFPPortAllocation, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtpGroup=smtpGroup, longitude=longitude, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, tDDControlGroup=tDDControlGroup, installStatusTrap=installStatusTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, cambium=cambium, remoteInternetAddressType=remoteInternetAddressType, tdmTableNumber=tdmTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, targetMACAddress=targetMACAddress, resetGroup=resetGroup, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, syncESlavePort=syncESlavePort, cableDiagPair2Results=cableDiagPair2Results, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetPriorityTableEntry=ethernetPriorityTableEntry, cableDiagnosticsWarning=cableDiagnosticsWarning, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mgmtInstancedTable=mgmtInstancedTable, mABNominalTransmitCapacity=mABNominalTransmitCapacity, ptpGroups=ptpGroups, dfs=dfs, userEnabled=userEnabled, txMABFrames=txMABFrames, byteErrorRatio=byteErrorRatio, wirelessTopology=wirelessTopology, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, enableTransmission=enableTransmission, dNS=dNS, tDDControl=tDDControl, configurationInstancedTableIndex=configurationInstancedTableIndex, tdmTableEntry=tdmTableEntry, snmpControl=snmpControl, auxPortAllocation=auxPortAllocation, licenseUnitSerialNumber=licenseUnitSerialNumber, authorizationMethod=authorizationMethod, alarmInstancedTableIndex=alarmInstancedTableIndex, mainPSUPortAutoMdix=mainPSUPortAutoMdix, wirelessLinkStatusLinked=wirelessLinkStatusLinked, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, transmitDataRateLinked=transmitDataRateLinked, cableDiagPair4Results=cableDiagPair4Results, nIDULanPortStatus=nIDULanPortStatus, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, nIDULanPortAutoMdix=nIDULanPortAutoMdix, dNSServerPortNumber=dNSServerPortNumber, sNTPServerRetries=sNTPServerRetries, phyControlInstancedTableEntry=phyControlInstancedTableEntry, vLANManagementVID=vLANManagementVID, gatewayIPAddress=gatewayIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6GatewayAddress=iPv6GatewayAddress, wirelessLinkAvailability=wirelessLinkAvailability, ethernetStatisticsTable=ethernetStatisticsTable, bridge=bridge, transparentClockPort=transparentClockPort, managementGroup=managementGroup, tFTPServerPortNumber=tFTPServerPortNumber, remoteMACAddress=remoteMACAddress, syslogClient=syslogClient, noWirelessChannelAvailable=noWirelessChannelAvailable, auxPortDisabledWarning=auxPortDisabledWarning, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, alarmsGroup=alarmsGroup, ethernetPriorityTable=ethernetPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseInstancedTableNumber=licenseInstancedTableNumber, groupID=groupID, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerPortNumber=sNTPServerPortNumber, syslogStateTrap=syslogStateTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tempPcb=tempPcb, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, configurationInstancedTableNumber=configurationInstancedTableNumber, masterSlaveMode=masterSlaveMode, remoteUnitName=remoteUnitName, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, encryption=encryption, dfsTableNumber=dfsTableNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseBandwidthCap=licenseBandwidthCap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, versionsGroup=versionsGroup, transmitDataRate=transmitDataRate, secondarySoftwareVersion=secondarySoftwareVersion, mABState=mABState, signalStrengthRatioLinked=signalStrengthRatioLinked, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMACAddressLinked=remoteMACAddressLinked, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sFPErrorTrap=sFPErrorTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, nIDULanPortStatusTrap=nIDULanPortStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, iPv6Address=iPv6Address, licenseVersion=licenseVersion, iPVersion=iPVersion, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, systemClock=systemClock, cableDiagnosticsGroup=cableDiagnosticsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, regulatoryBand=regulatoryBand, auxPortSSMTx=auxPortSSMTx, ethernet=ethernet, dNSServerInternetAddressType=dNSServerInternetAddressType, phyControlInstancedTableIndex=phyControlInstancedTableIndex, range=range, ethernetGroup=ethernetGroup, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mABMaintenanceLevel=mABMaintenanceLevel, phyStatusGroup=phyStatusGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, antennaGain=antennaGain, authorizationControlTableEntry=authorizationControlTableEntry, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, receiveDataRate=receiveDataRate, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, wirelessOutAllOctets=wirelessOutAllOctets, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tDMInterfaceControl=tDMInterfaceControl, packetsFromInternalStack=packetsFromInternalStack, subbandLowestFrequency=subbandLowestFrequency, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dfsPeaks=dfsPeaks, mainPSUPortAllocation=mainPSUPortAllocation, dNSServerTableEntry=dNSServerTableEntry, mABTransmissionInterval=mABTransmissionInterval, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, telnetAccessEnabled=telnetAccessEnabled, tFTPClient=tFTPClient, oOBPriorityQueueMapping=oOBPriorityQueueMapping, configurationInstancedTable=configurationInstancedTable, routerProtocols=routerProtocols, deviceMACAddress=deviceMACAddress, receiveFreqMHz=receiveFreqMHz, sNTPLastSync=sNTPLastSync, dNSPrimaryServer=dNSPrimaryServer, cableDiagPair3Results=cableDiagPair3Results, userTableEntry=userTableEntry, userPassword=userPassword, portAllocationMismatchTrap=portAllocationMismatchTrap, syncETrackingState=syncETrackingState, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, phyControl=phyControl, dfsGroup=dfsGroup, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, installationMode=installationMode, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, cableDiagPair4Distance=cableDiagPair4Distance, receiveModulationModeLinked=receiveModulationModeLinked, extendedSpectrumScanning=extendedSpectrumScanning, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, severelyErroredSeconds=severelyErroredSeconds, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, dfsTableIndex=dfsTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, blacklistRMMacAddress=blacklistRMMacAddress, mABProtocolVLANPriority=mABProtocolVLANPriority, rangeLinked=rangeLinked, subbandHighestFrequency=subbandHighestFrequency, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sntp=sntp, alarmInstancedTable=alarmInstancedTable, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sFPError=sFPError, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aggregateDataRate=aggregateDataRate, licenseTDDSyncSupport=licenseTDDSyncSupport, unitIdentification=unitIdentification, erroredSeconds=erroredSeconds, dNSServerTable=dNSServerTable, tDMChannelLoopback=tDMChannelLoopback, dfsMeans=dfsMeans, hTTPSPortNumber=hTTPSPortNumber, auxPortStatusTrap=auxPortStatusTrap, wirelessOutOctets=wirelessOutOctets, sNMPTrapTable=sNMPTrapTable, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, cableDiagPair1Results=cableDiagPair1Results, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, mgmtInstancedTableNumber=mgmtInstancedTableNumber, encryptionGroup=encryptionGroup, rangingMode=rangingMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataBridgingStatus=dataBridgingStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, mABHoldoffPeriod=mABHoldoffPeriod, iPDSCPPriorityTable=iPDSCPPriorityTable, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sMTPEnabledMessages=sMTPEnabledMessages, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, aAAControl=aAAControl, auxPortSyncERxStatus=auxPortSyncERxStatus, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, lbtDetectedTrap=lbtDetectedTrap, auxPortStatus=auxPortStatus, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, ptmp=ptmp, searchState=searchState, dataBridgingStatusLinked=dataBridgingStatusLinked, tdmTableIndex=tdmTableIndex, incompatibleRegulatoryBands=incompatibleRegulatoryBands, userName=userName, secureModeAlarmTrap=secureModeAlarmTrap, channelBandwidth=channelBandwidth, mainPSUPortStatus=mainPSUPortStatus, licenseTLSRekey=licenseTLSRekey, receiveFreqKHz=receiveFreqKHz, ethernetInstancedTableIndex=ethernetInstancedTableIndex, managementNetworkAccessEnabled=managementNetworkAccessEnabled, remoteInternetAddressLinked=remoteInternetAddressLinked, alarms=alarms, sFPPortAutoNegotiation=sFPPortAutoNegotiation, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, smtp=smtp, sNTPServerTableIndex=sNTPServerTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rawReceivePowerLinked=rawReceivePowerLinked, transmitFreqMHz=transmitFreqMHz, mABNominalModulationMode=mABNominalModulationMode, mainPSUPortQLTx=mainPSUPortQLTx, dNSServerInternetAddress=dNSServerInternetAddress, whitelistRMEnabled=whitelistRMEnabled, licenseSFPPortSupport=licenseSFPPortSupport, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogClientTrap=syslogClientTrap, maximumTransmitPower=maximumTransmitPower, pubInstancedStatsTable=pubInstancedStatsTable, ethernetStatisticsDataSource=ethernetStatisticsDataSource, licenseGroupAccess=licenseGroupAccess, vectorErrorLinked=vectorErrorLinked, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tdmTable=tdmTable, sMTPServerPortNumber=sMTPServerPortNumber, sNMPv3Enable=sNMPv3Enable, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, authorizationControl=authorizationControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, secureModeAlarm=secureModeAlarm, vectorError=vectorError, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, dataBridgingAvailability=dataBridgingAvailability, sNTPServerTableEntry=sNTPServerTableEntry, cableDiagPair1Distance=cableDiagPair1Distance, licenseCapacity=licenseCapacity, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, sNTPSyncTrap=sNTPSyncTrap, unitIdentificationGroup=unitIdentificationGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, management=management, ptpCompliance=ptpCompliance, capacityVariantMismatchLinked=capacityVariantMismatchLinked, signalStrengthRatio=signalStrengthRatio, sNTPServerInternetAddressType=sNTPServerInternetAddressType, authorizationControlTable=authorizationControlTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortAcceptedQLRx=auxPortAcceptedQLRx, supplementaryGroup=supplementaryGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, portAllocationMismatchLinked=portAllocationMismatchLinked, sntpGroup=sntpGroup, aAAControlGroup=aAAControlGroup, apcGroup=apcGroup, receiveChannel=receiveChannel, mainPSUPortQLRx=mainPSUPortQLRx, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, antennaSelection=antennaSelection, transmitModulationMode=transmitModulationMode, cableDiagnosticsControl=cableDiagnosticsControl, remoteUnitNameLinked=remoteUnitNameLinked, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dNSGroup=dNSGroup, transmitPower=transmitPower, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, supplementary=supplementary, latitude=latitude, cableDiagPair2Distance=cableDiagPair2Distance, licenseIssueNumber=licenseIssueNumber, bridgeGroup=bridgeGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, mgmtInstancedTableIndex=mgmtInstancedTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, linkLossLinked=linkLossLinked, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPCommunityString=sNMPCommunityString, blacklistRMEnabled=blacklistRMEnabled, tDMChannelCableLength=tDMChannelCableLength, alarmInstancedTableNumber=alarmInstancedTableNumber, sFPPortStatus=sFPPortStatus, phyStatus=phyStatus, telnetPortNumber=telnetPortNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, receivePowerLinked=receivePowerLinked, sNTPServerStatus=sNTPServerStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenseInstancedTable=licenseInstancedTable, transparentClockVLAN=transparentClockVLAN, txColorCode=txColorCode, rxColorCode=rxColorCode, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, ptp=ptp, cableDiagnostics=cableDiagnostics, dNSResolver=dNSResolver, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapTableEntry=sNMPTrapTableEntry, cableDiagnosticsPorts=cableDiagnosticsPorts, sNMPTrapVersion=sNMPTrapVersion, iPv4Address=iPv4Address, dNSServerTableIndex=dNSServerTableIndex, licenseEncryption=licenseEncryption, ethernetInstancedTable=ethernetInstancedTable, siteName=siteName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkSymmetry=linkSymmetry, phyInstancedStatusTable=phyInstancedStatusTable, licenseRARSupport=licenseRARSupport, license=license, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, tDM=tDM, licenseGroup=licenseGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, timeZone=timeZone, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, remoteInternetAddress=remoteInternetAddress, altitude=altitude, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, portAllocationMismatch=portAllocationMismatch, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, capacityVariantMismatch=capacityVariantMismatch, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receiveModulationMode=receiveModulationMode, syncEEquipmentClock=syncEEquipmentClock, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseIPv6Support=licenseIPv6Support, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, regulatoryBandTrap=regulatoryBandTrap, productVariant=productVariant, sMTPEmailAlert=sMTPEmailAlert, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, daylightSaving=daylightSaving, mPLSTCPriorityTable=mPLSTCPriorityTable, phyControlInstancedTable=phyControlInstancedTable, alarmInstancedTableEntry=alarmInstancedTableEntry, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, packetsToInternalStack=packetsToInternalStack, vLANManagementPriority=vLANManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptp670=ptp670, cableLoss=cableLoss, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, dNSServerTableNumber=dNSServerTableNumber, licenseInstancedTableIndex=licenseInstancedTableIndex, aggregateDataRateLinked=aggregateDataRateLinked, licenseIEEE1588Support=licenseIEEE1588Support, productName=productName, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, transmitChannel=transmitChannel, licenseCountry=licenseCountry, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, wirelessOutEthernetOctets=wirelessOutEthernetOctets, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sFPPortDisabledWarning=sFPPortDisabledWarning, apc=apc, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, PYSNMP_MODULE_ID=cambium, l2CPPriorityTable=l2CPPriorityTable, transmitFreqKHz=transmitFreqKHz, searchStateLinked=searchStateLinked, syslogControl=syslogControl, tDDSynchronizationMode=tDDSynchronizationMode, sMTPServerInternetAddress=sMTPServerInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", versions=versions, sMTPServerInternetAddressType=sMTPServerInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userRole=userRole, installStatus=installStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, tDMEnabledChannels=tDMEnabledChannels, sFPPortQLRx=sFPPortQLRx, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, whitelistRMMacAddress=whitelistRMMacAddress, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, auxPortQLRx=auxPortQLRx, sNTPSync=sNTPSync, cableDiagPair3Distance=cableDiagPair3Distance, configurationGroup=configurationGroup, sNTPServerTable=sNTPServerTable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTrapPrefix=ptpTrapPrefix, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseInstancedTableEntry=licenseInstancedTableEntry, tDMChannelStatus=tDMChannelStatus, installArmState=installArmState, syslogState=syslogState, sFPPortAutoMdix=sFPPortAutoMdix, useVLANForMABProtocol=useVLANForMABProtocol, dfsTable=dfsTable, installStatusLinked=installStatusLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transparentClockVID=transparentClockVID, syslogControlGroup=syslogControlGroup, byteErrorRatioLinked=byteErrorRatioLinked, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, targetRange=targetRange, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, pubStats=pubStats, routerProtocolsGroup=routerProtocolsGroup, dfsTableEntry=dfsTableEntry, sNTPServerInternetAddress=sNTPServerInternetAddress, authorizationControlTableIndex=authorizationControlTableIndex, userTableNumber=userTableNumber, tDMInterfaceStatus=tDMInterfaceStatus, transmitModulationModeLinked=transmitModulationModeLinked, ethernetInstancedTableEntry=ethernetInstancedTableEntry, localPacketFiltering=localPacketFiltering, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableIndex=userTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTraps=ptpTraps, sNTPState=sNTPState, reset=reset, linkModeOptimization=linkModeOptimization, hCMPLinkSymmetry=hCMPLinkSymmetry, capacityVariantMismatchTrap=capacityVariantMismatchTrap, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseSyncESupport=licenseSyncESupport, authorizationControlTableNumber=authorizationControlTableNumber, systemReset=systemReset, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, bootVersion=bootVersion)
