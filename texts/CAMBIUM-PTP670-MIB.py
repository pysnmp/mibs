...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", linkSymmetry=linkSymmetry, tDDSynchronizationMode=tDDSynchronizationMode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mABMaintenanceLevel=mABMaintenanceLevel, phyStatus=phyStatus, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, subbandHighestFrequency=subbandHighestFrequency, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagPair3Distance=cableDiagPair3Distance, altitude=altitude, packetsToInternalStack=packetsToInternalStack, mgmtInstancedTable=mgmtInstancedTable, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, userPassword=userPassword, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, dataPortPauseFrames=dataPortPauseFrames, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNTPServerTableEntry=sNTPServerTableEntry, mABHoldoffPeriod=mABHoldoffPeriod, licenseInstancedTableNumber=licenseInstancedTableNumber, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, supplementaryGroup=supplementaryGroup, erroredSeconds=erroredSeconds, targetRange=targetRange, userTableEntry=userTableEntry, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, range=range, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, ethernetInstancedTableNumber=ethernetInstancedTableNumber, receiveModulationMode=receiveModulationMode, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, iPv6PrefixLength=iPv6PrefixLength, tFTPServerPortNumber=tFTPServerPortNumber, sFPPortStatusTrap=sFPPortStatusTrap, blacklistRMEnabled=blacklistRMEnabled, alarmsGroup=alarmsGroup, sNTPServerTableIndex=sNTPServerTableIndex, licenseRegulatoryBandsList=licenseRegulatoryBandsList, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPState=sNTPState, siteName=siteName, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dNSGroup=dNSGroup, transparentClockPort=transparentClockPort, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, wirelessOutAllOctets=wirelessOutAllOctets, iPDSCPPriorityTable=iPDSCPPriorityTable, telnetPortNumber=telnetPortNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, dfsPeaks=dfsPeaks, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, userName=userName, mainPSUPortAutoMdix=mainPSUPortAutoMdix, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, transmitterChannels=transmitterChannels, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, rangeLinked=rangeLinked, latitude=latitude, licenseGroupAccess=licenseGroupAccess, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagPair2Distance=cableDiagPair2Distance, aAAControl=aAAControl, whitelistRMEnabled=whitelistRMEnabled, alarmInstancedTableIndex=alarmInstancedTableIndex, eIRP=eIRP, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPServerStatus=sNTPServerStatus, antennaGain=antennaGain, cableDiagnosticsPorts=cableDiagnosticsPorts, transmitFreqKHz=transmitFreqKHz, productName=productName, syncEEquipmentClock=syncEEquipmentClock, bridgeGroup=bridgeGroup, ptpTrapPrefix=ptpTrapPrefix, hTTPSPortNumber=hTTPSPortNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, authorizationControlGroup=authorizationControlGroup, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tDMChannelLoopback=tDMChannelLoopback, mainPSUPortQLRx=mainPSUPortQLRx, alarmInstancedTableEntry=alarmInstancedTableEntry, severelyErroredSeconds=severelyErroredSeconds, auxPortAllocation=auxPortAllocation, licenseCapacity=licenseCapacity, licenseInstancedTableEntry=licenseInstancedTableEntry, configuration=configuration, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, receiveModulationModeLinked=receiveModulationModeLinked, wirelessOutEthernetOctets=wirelessOutEthernetOctets, groupID=groupID, licenseTrialPeriod=licenseTrialPeriod, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, transmitChannel=transmitChannel, secureModeAlarm=secureModeAlarm, installStatusLinked=installStatusLinked, sNTPServerRetries=sNTPServerRetries, receiveChannel=receiveChannel, bootVersion=bootVersion, sFPPortSSMTx=sFPPortSSMTx, snmpControl=snmpControl, capacityVariantMismatch=capacityVariantMismatch, l2CPPriorityTable=l2CPPriorityTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dNSPrimaryServer=dNSPrimaryServer, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mABProtocolVID=mABProtocolVID, subbandLowestFrequency=subbandLowestFrequency, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, licenseInstancedTableIndex=licenseInstancedTableIndex, sFPPortQLTx=sFPPortQLTx, extendedSpectrumScanning=extendedSpectrumScanning, auxPortAcceptedQLRx=auxPortAcceptedQLRx, alarms=alarms, ethernetPriorityTableIndex=ethernetPriorityTableIndex, wirelessOutOctets=wirelessOutOctets, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseSFPPortSupport=licenseSFPPortSupport, reset=reset, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryptionGroup=encryptionGroup, sNTPServerTable=sNTPServerTable, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, incompatibleMasterAndSlave=incompatibleMasterAndSlave, hTTPAccessEnabled=hTTPAccessEnabled, apc=apc, phyControlInstancedTableEntry=phyControlInstancedTableEntry, syslogClientTrap=syslogClientTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, management=management, configurationInstancedTableNumber=configurationInstancedTableNumber, installStatus=installStatus, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, configurationInstancedTableEntry=configurationInstancedTableEntry, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseSecurityLevel=licenseSecurityLevel, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, syslogClient=syslogClient, routerProtocolsGroup=routerProtocolsGroup, enableTransmission=enableTransmission, tDMChannelLineCode=tDMChannelLineCode, dNSServerInternetAddress=dNSServerInternetAddress, transmitModulationModeLinked=transmitModulationModeLinked, tDMChannelStatusTrap=tDMChannelStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, longitude=longitude, sNMPPortNumber=sNMPPortNumber, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, iPVersion=iPVersion, ethernetInstancedTable=ethernetInstancedTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, remoteInternetAddressType=remoteInternetAddressType, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, channelChangeTrap=channelChangeTrap, ethernetInstancedTableEntry=ethernetInstancedTableEntry, snmpControlGroup=snmpControlGroup, routerProtocols=routerProtocols, remoteUnitNameLinked=remoteUnitNameLinked, tempPcb=tempPcb, portAllocationMismatch=portAllocationMismatch, licenseIPv6Support=licenseIPv6Support, installStatusTrap=installStatusTrap, ethernetStatisticsTable=ethernetStatisticsTable, apcGroup=apcGroup, transmitPower=transmitPower, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, blacklistRMMacAddress=blacklistRMMacAddress, tdmTableNumber=tdmTableNumber, ptp=ptp, sMTPServerInternetAddress=sMTPServerInternetAddress, lowestTDMModulationMode=lowestTDMModulationMode, cableDiagPair4Results=cableDiagPair4Results, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveFreqKHz=receiveFreqKHz, sNTPLastSync=sNTPLastSync, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, authorizationControlTableEntry=authorizationControlTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapVersion=sNMPTrapVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, txMABFrames=txMABFrames, pubStatsGroup=pubStatsGroup, dNSServerTable=dNSServerTable, ethernetPriorityTable=ethernetPriorityTable, tDMEnabledChannels=tDMEnabledChannels, mainPSUPortSSMTx=mainPSUPortSSMTx, dfsGroup=dfsGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, cableDiagPair3Results=cableDiagPair3Results, dataBridgingAvailability=dataBridgingAvailability, auxPortStatus=auxPortStatus, masterSlaveMode=masterSlaveMode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, tFTPClient=tFTPClient, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, capacityVariantMismatchTrap=capacityVariantMismatchTrap, versions=versions, licenseSyncESupport=licenseSyncESupport, signalStrengthRatio=signalStrengthRatio, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, vLANManagementPriority=vLANManagementPriority, licenseVersion=licenseVersion, vectorErrorLinked=vectorErrorLinked, cableLoss=cableLoss, license=license, auxPortDisabledWarning=auxPortDisabledWarning, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, iPv6Address=iPv6Address, frequencyVariant=frequencyVariant, resetGroup=resetGroup, remoteInternetAddress=remoteInternetAddress, installationMode=installationMode, secondarySoftwareVersion=secondarySoftwareVersion, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, pubStats=pubStats, tDMChannelStatus=tDMChannelStatus, aggregateDataRate=aggregateDataRate, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseGasGroup=licenseGasGroup, receiveDataRateLinked=receiveDataRateLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, unavailableSeconds=unavailableSeconds, phyStatusGroup=phyStatusGroup, authorizationControlTableNumber=authorizationControlTableNumber, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, hardwareVersion=hardwareVersion, supplementary=supplementary, authorizationControlTableIndex=authorizationControlTableIndex, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", wirelessTopology=wirelessTopology, cableDiagnosticsControl=cableDiagnosticsControl, dNSServerTableIndex=dNSServerTableIndex, linkName=linkName, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, nIDULanPortStatusTrap=nIDULanPortStatusTrap, deviceESN=deviceESN, transparentClockVID=transparentClockVID, linkLossLinked=linkLossLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, secureModeAlarmTrap=secureModeAlarmTrap, syslogControlGroup=syslogControlGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tFTPServerInternetAddressType=tFTPServerInternetAddressType, licenseInstancedTable=licenseInstancedTable, sFPPortAllocation=sFPPortAllocation, cableDiagnosticsGroup=cableDiagnosticsGroup, phyInstancedStatusTable=phyInstancedStatusTable, wirelessLinkAvailability=wirelessLinkAvailability, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userTable=userTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cableDiagnosticsResultTable=cableDiagnosticsResultTable, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, authorizationControl=authorizationControl, mainPSUPortStatusTrap=mainPSUPortStatusTrap, vLANManagementVID=vLANManagementVID, dSCPManagementPriority=dSCPManagementPriority, iPv6GatewayAddress=iPv6GatewayAddress, ethernet=ethernet, mPLSTCPriorityTable=mPLSTCPriorityTable, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sFPPortDisabledWarning=sFPPortDisabledWarning, auxPortStatusTrap=auxPortStatusTrap, rangingMode=rangingMode, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, dfsTable=dfsTable, maximumTransmitPower=maximumTransmitPower, tDDControl=tDDControl, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, aggregateDataRateLinked=aggregateDataRateLinked, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mABState=mABState, dfsMeans=dfsMeans, regulatoryBandTrap=regulatoryBandTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, systemClock=systemClock, cableDiagnosticsWarning=cableDiagnosticsWarning, syncETracking=syncETracking, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, rawReceivePower=rawReceivePower, vectorError=vectorError, configurationGroup=configurationGroup, unitIdentification=unitIdentification, licenseCountry=licenseCountry, syncETrackingState=syncETrackingState, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dNS=dNS, cambium=cambium, userTableNumber=userTableNumber, licenseHCMPSupport=licenseHCMPSupport, remoteUnitName=remoteUnitName, transmitDataRateLinked=transmitDataRateLinked, PYSNMP_MODULE_ID=cambium, tDMInterfaceControl=tDMInterfaceControl, portAllocationMismatchLinked=portAllocationMismatchLinked, auxPortQLRx=auxPortQLRx, cableDiagPair2Results=cableDiagPair2Results, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sMTPEmailAlert=sMTPEmailAlert, unitIdentificationGroup=unitIdentificationGroup, sNTPPollInterval=sNTPPollInterval, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, licenseMaxLinkRange=licenseMaxLinkRange, searchState=searchState, sNTPSync=sNTPSync, maximumNumberOfSlaves=maximumNumberOfSlaves, transmitFreqMHz=transmitFreqMHz, sFPPortStatus=sFPPortStatus, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, licenseBandwidthCap=licenseBandwidthCap, receiveModulationModeDetail=receiveModulationModeDetail, mgmtInstancedTableNumber=mgmtInstancedTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, ethernetInstancedTableIndex=ethernetInstancedTableIndex, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, deviceMACAddress=deviceMACAddress, phyControlGroup=phyControlGroup, smtp=smtp, remoteMACAddressLinked=remoteMACAddressLinked, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, gatewayIPAddress=gatewayIPAddress, aAAControlGroup=aAAControlGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, subnetMask=subnetMask, telnetAccessEnabled=telnetAccessEnabled, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ptmp=ptmp, userTableIndex=userTableIndex, unitOutOfCalibration=unitOutOfCalibration, configurationInstancedTable=configurationInstancedTable, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, managementGroup=managementGroup, rxColorCode=rxColorCode, licenseTLSRekey=licenseTLSRekey, encryption=encryption, sFPError=sFPError, linkLoss=linkLoss, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, byteErrorRatioLinked=byteErrorRatioLinked, sNMPEnabledTraps=sNMPEnabledTraps, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNTPSyncTrap=sNTPSyncTrap, pubInstancedStatsTable=pubInstancedStatsTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, timeZone=timeZone, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, dNSServerPortNumber=dNSServerPortNumber, transmitDataRate=transmitDataRate, hTTPSAccessEnabled=hTTPSAccessEnabled, installArmStateTrap=installArmStateTrap, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, linkModeOptimization=linkModeOptimization, iPv4Address=iPv4Address, sNTPServerTimeout=sNTPServerTimeout, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tdmTableEntry=tdmTableEntry, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, receivePower=receivePower, regulatoryBand=regulatoryBand, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, transmitModulationMode=transmitModulationMode, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, dNSServerTableNumber=dNSServerTableNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, installArmState=installArmState, systemReset=systemReset, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, dNSServerTableEntry=dNSServerTableEntry, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, licenseEncryption=licenseEncryption, auxPortSSMTx=auxPortSSMTx, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, useVLANForMABProtocol=useVLANForMABProtocol, tDMChannelCableLength=tDMChannelCableLength, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, accessMethod=accessMethod, packetsFromInternalStack=packetsFromInternalStack, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, syslogStateTrap=syslogStateTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sNMPTrapTable=sNMPTrapTable, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, deviceMSN=deviceMSN, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, daylightSaving=daylightSaving, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, auxPortSyncERxStatus=auxPortSyncERxStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, configurationInstancedTableIndex=configurationInstancedTableIndex, rawReceivePowerLinked=rawReceivePowerLinked, cableDiagnostics=cableDiagnostics, syslogControl=syslogControl, mABNominalTransmitCapacity=mABNominalTransmitCapacity, transparentClockVLAN=transparentClockVLAN, targetMACAddress=targetMACAddress, antennaSelection=antennaSelection, receiveDataRate=receiveDataRate, tDMGroup=tDMGroup, licenseIssueNumber=licenseIssueNumber, byteErrorRatio=byteErrorRatio, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitPowerLinked=transmitPowerLinked, softwareVersion=softwareVersion, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, tDMConfigurationMismatch=tDMConfigurationMismatch, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, smtpGroup=smtpGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tDM=tDM, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, channelBandwidth=channelBandwidth, l2CPPriorityTableNumber=l2CPPriorityTableNumber, searchStateLinked=searchStateLinked, ethernetPriorityTableEntry=ethernetPriorityTableEntry, versionsGroup=versionsGroup, encryptionAlgorithm=encryptionAlgorithm, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, syslogState=syslogState, tDMInterfaceStatus=tDMInterfaceStatus, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, tDDControlGroup=tDDControlGroup, alarmInstancedTableNumber=alarmInstancedTableNumber, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, receiveFreqMHz=receiveFreqMHz, dataBridgingStatus=dataBridgingStatus, licenseIEEE1588Support=licenseIEEE1588Support, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sFPPortAutoNegotiation=sFPPortAutoNegotiation, tdmTableIndex=tdmTableIndex, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, phyControlInstancedTable=phyControlInstancedTable, ethernetGroup=ethernetGroup, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, lowestDataModulationMode=lowestDataModulationMode, whitelistRMMacAddress=whitelistRMMacAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sFPPortQLRx=sFPPortQLRx, oOBPriorityQueueMapping=oOBPriorityQueueMapping, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortAllocation=mainPSUPortAllocation, syncESlavePort=syncESlavePort, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTableNumber=sNTPServerTableNumber, hTTPPortNumber=hTTPPortNumber, licenseGroup=licenseGroup, alarmInstancedTable=alarmInstancedTable, ptpGroups=ptpGroups, tDDSynchronizationStatus=tDDSynchronizationStatus, nIDULanPortStatus=nIDULanPortStatus, dfsTableEntry=dfsTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, auxPortQLTx=auxPortQLTx, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseRARSupport=licenseRARSupport, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagPair1Results=cableDiagPair1Results, mABTransmissionInterval=mABTransmissionInterval, bridge=bridge, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sFPPortAutoMdix=sFPPortAutoMdix, mainPSUPortQLTx=mainPSUPortQLTx, mgmtInstancedTableIndex=mgmtInstancedTableIndex, dNSResolver=dNSResolver, userEnabled=userEnabled, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, hCMPMaximumLinkRange=hCMPMaximumLinkRange, mABNominalModulationMode=mABNominalModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, localPacketFiltering=localPacketFiltering, transparentClock=transparentClock, phyControl=phyControl, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNMPv3Enable=sNMPv3Enable, authorizationMethod=authorizationMethod, ptpCompliance=ptpCompliance, dfsTableNumber=dfsTableNumber, dfsTableIndex=dfsTableIndex, lbtDetectedTrap=lbtDetectedTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, txColorCode=txColorCode, hCMPLinkSymmetry=hCMPLinkSymmetry, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, ptp670=ptp670, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productVariant=productVariant, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sFPErrorTrap=sFPErrorTrap, dfs=dfs, sNMPTrapTableEntry=sNMPTrapTableEntry, userRole=userRole, tDDSynchronizationAlarm=tDDSynchronizationAlarm, signalStrengthRatioLinked=signalStrengthRatioLinked, cableDiagPair1Distance=cableDiagPair1Distance, cableDiagPair4Distance=cableDiagPair4Distance, wirelessLinkStatus=wirelessLinkStatus, authorizationControlTable=authorizationControlTable, remoteMACAddress=remoteMACAddress, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, tdmTable=tdmTable, sntp=sntp, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, sntpGroup=sntpGroup, receivePowerLinked=receivePowerLinked, unitName=unitName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mainPSUPortStatus=mainPSUPortStatus)
