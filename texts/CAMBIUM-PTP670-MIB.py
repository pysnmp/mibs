...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortSyncERxStatus=auxPortSyncERxStatus, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, maxLinkRangeExceeded=maxLinkRangeExceeded, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, phyStatus=phyStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortStatus=sFPPortStatus, daylightSaving=daylightSaving, tDDSynchronizationStatus=tDDSynchronizationStatus, routerProtocols=routerProtocols, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, secondarySoftwareVersion=secondarySoftwareVersion, receiveModulationMode=receiveModulationMode, tDMChannelStatusTrap=tDMChannelStatusTrap, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, transparentClock=transparentClock, siteName=siteName, tDMChannelLoopback=tDMChannelLoopback, receivePower=receivePower, licenseMaxLinkRange=licenseMaxLinkRange, auxPortSSMTx=auxPortSSMTx, phyControlInstancedTableEntry=phyControlInstancedTableEntry, transmitterChannels=transmitterChannels, auxPortStatus=auxPortStatus, transmitFreqMHz=transmitFreqMHz, sMTPServerInternetAddress=sMTPServerInternetAddress, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tDDSynchronizationMode=tDDSynchronizationMode, iPv6Address=iPv6Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseRARSupport=licenseRARSupport, wirelessLinkStatus=wirelessLinkStatus, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseTLSRekey=licenseTLSRekey, sntpGroup=sntpGroup, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitModulationModeLinked=transmitModulationModeLinked, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, receiveChannel=receiveChannel, mPLSTCPriorityTable=mPLSTCPriorityTable, cableDiagnostics=cableDiagnostics, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitDataRate=transmitDataRate, remoteInternetAddressLinked=remoteInternetAddressLinked, ethernetGroup=ethernetGroup, linkSymmetry=linkSymmetry, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, systemReset=systemReset, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, ptp=ptp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productName=productName, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, cableDiagnosticsPorts=cableDiagnosticsPorts, capacityVariantMismatchLinked=capacityVariantMismatchLinked, authorizationControlTable=authorizationControlTable, groupID=groupID, sFPPortStatusTrap=sFPPortStatusTrap, rangeLinked=rangeLinked, tdmTableIndex=tdmTableIndex, cableDiagnosticsWarning=cableDiagnosticsWarning, dNSServerTableIndex=dNSServerTableIndex, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, deviceESN=deviceESN, ethernetPriorityTable=ethernetPriorityTable, aggregateDataRateLinked=aggregateDataRateLinked, wirelessLinkStatusLinked=wirelessLinkStatusLinked, auxPortQLRx=auxPortQLRx, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, bootVersion=bootVersion, licenseTDDSyncSupport=licenseTDDSyncSupport, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerTableNumber=sNTPServerTableNumber, erroredSeconds=erroredSeconds, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteUnitName=remoteUnitName, versionsGroup=versionsGroup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, licenseInstancedTable=licenseInstancedTable, dNSServerTableEntry=dNSServerTableEntry, sNMPTrapVersion=sNMPTrapVersion, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rangingMode=rangingMode, ptpTraps=ptpTraps, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, receiveDataRateLinked=receiveDataRateLinked, transmitChannel=transmitChannel, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationModeLinked=receiveModulationModeLinked, dfsGroup=dfsGroup, phyStatusGroup=phyStatusGroup, dfsTable=dfsTable, packetsToInternalStack=packetsToInternalStack, licenseSFPPortSupport=licenseSFPPortSupport, l2CPPriorityTable=l2CPPriorityTable, tDMInterfaceControl=tDMInterfaceControl, regulatoryBand=regulatoryBand, receiveModulationModeDetail=receiveModulationModeDetail, channelChangeTrap=channelChangeTrap, alarms=alarms, smtp=smtp, sFPPortAutoMdix=sFPPortAutoMdix, cableLoss=cableLoss, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sFPPortQLTx=sFPPortQLTx, dataBridgingAvailability=dataBridgingAvailability, unitIdentification=unitIdentification, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDMEnabledChannels=tDMEnabledChannels, authorizationControlTableEntry=authorizationControlTableEntry, userTableNumber=userTableNumber, vectorError=vectorError, management=management, remoteInternetAddress=remoteInternetAddress, severelyErroredSeconds=severelyErroredSeconds, hardwareVersion=hardwareVersion, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, reset=reset, configuration=configuration, unavailableSeconds=unavailableSeconds, dNSGroup=dNSGroup, ptpTrapPrefix=ptpTrapPrefix, mABNominalModulationMode=mABNominalModulationMode, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, channelBandwidth=channelBandwidth, dNSServerTableNumber=dNSServerTableNumber, packetsFromInternalStack=packetsFromInternalStack, cableDiagPair1Results=cableDiagPair1Results, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, licenseIPv6Support=licenseIPv6Support, tFTPServerPortNumber=tFTPServerPortNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, dfsTableEntry=dfsTableEntry, lowestDataModulationMode=lowestDataModulationMode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, supplementaryGroup=supplementaryGroup, productVariant=productVariant, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tFTPServerInternetAddressType=tFTPServerInternetAddressType, notificationsGroup=notificationsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, installStatusLinked=installStatusLinked, nIDULanPortStatus=nIDULanPortStatus, capacityVariantMismatch=capacityVariantMismatch, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, subbandHighestFrequency=subbandHighestFrequency, receivePowerLinked=receivePowerLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, authorizationControlGroup=authorizationControlGroup, sNMPv3Enable=sNMPv3Enable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, iPv6PrefixLength=iPv6PrefixLength, subbandLowestFrequency=subbandLowestFrequency, txMABFrames=txMABFrames, sNTPPrimaryServer=sNTPPrimaryServer, userRole=userRole, dNSServerInternetAddressType=dNSServerInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, localPacketFiltering=localPacketFiltering, linkModeOptimizationMismatch=linkModeOptimizationMismatch, subnetMask=subnetMask, mainPSUPortQLTx=mainPSUPortQLTx, userTable=userTable, pubStats=pubStats, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, iPv6GatewayAddress=iPv6GatewayAddress, mABState=mABState, linkModeOptimization=linkModeOptimization, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, cableDiagPair4Results=cableDiagPair4Results, blacklistRMMacAddress=blacklistRMMacAddress, linkLoss=linkLoss, tDM=tDM, qOSPriorityScheme=qOSPriorityScheme, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, latitude=latitude, ethernetInstancedTableEntry=ethernetInstancedTableEntry, deviceMSN=deviceMSN, installStatusTrap=installStatusTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, authorizationControlTableNumber=authorizationControlTableNumber, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, transmitModulationMode=transmitModulationMode, sNTPState=sNTPState, routerProtocolsGroup=routerProtocolsGroup, antennaSelection=antennaSelection, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dNSServerInternetAddress=dNSServerInternetAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, aAAControl=aAAControl, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sNMPTrapTableNumber=sNMPTrapTableNumber, targetRange=targetRange, transparentClockVID=transparentClockVID, configurationInstancedTableNumber=configurationInstancedTableNumber, dfsTableNumber=dfsTableNumber, licenseSyncESupport=licenseSyncESupport, blacklistRMEnabled=blacklistRMEnabled, PYSNMP_MODULE_ID=cambium, sMTPServerPortNumber=sMTPServerPortNumber, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, linkName=linkName, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, cableDiagPair2Distance=cableDiagPair2Distance, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, aAAControlGroup=aAAControlGroup, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortAllocation=sFPPortAllocation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveFreqMHz=receiveFreqMHz, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPEnabledMessages=sMTPEnabledMessages, licenseSecurityLevel=licenseSecurityLevel, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tFTPClient=tFTPClient, whitelistRMEnabled=whitelistRMEnabled, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, vectorErrorLinked=vectorErrorLinked, sNTPLastSync=sNTPLastSync, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmInstancedTable=alarmInstancedTable, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, hCMPLinkSymmetry=hCMPLinkSymmetry, licenseEncryption=licenseEncryption, licenseInstancedTableNumber=licenseInstancedTableNumber, byteErrorRatioLinked=byteErrorRatioLinked, userEnabled=userEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, txColorCode=txColorCode, telnetAccessEnabled=telnetAccessEnabled, whitelistRMMacAddress=whitelistRMMacAddress, mainPSUPortStatus=mainPSUPortStatus, mgmtInstancedTableNumber=mgmtInstancedTableNumber, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, cableDiagPair1Distance=cableDiagPair1Distance, apc=apc, searchStateLinked=searchStateLinked, receiveDataRate=receiveDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetStatisticsDataSource=ethernetStatisticsDataSource, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNTPServerTimeout=sNTPServerTimeout, dNSResolver=dNSResolver, sNTPServerRetries=sNTPServerRetries, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, syncESlavePort=syncESlavePort, mABProtocolVID=mABProtocolVID, licenseCapacity=licenseCapacity, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, cableDiagnosticsControl=cableDiagnosticsControl, encryption=encryption, searchState=searchState, tdmTable=tdmTable, telnetPortNumber=telnetPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mgmtInstancedTableIndex=mgmtInstancedTableIndex, authorizationControlTableIndex=authorizationControlTableIndex, configurationInstancedTableEntry=configurationInstancedTableEntry, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, auxPortDisabledWarning=auxPortDisabledWarning, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, syncEEquipmentClock=syncEEquipmentClock, ptmp=ptmp, supplementary=supplementary, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, frequencyVariant=frequencyVariant, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, unitIdentificationGroup=unitIdentificationGroup, sNTPSyncTrap=sNTPSyncTrap, dfsPeaks=dfsPeaks, userPassword=userPassword, pubStatsGroup=pubStatsGroup, mABMaintenanceLevel=mABMaintenanceLevel, systemClock=systemClock, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tempPcb=tempPcb, maximumTransmitPower=maximumTransmitPower, cableDiagPair4Distance=cableDiagPair4Distance, sNTPSync=sNTPSync, sFPPortQLRx=sFPPortQLRx, eIRP=eIRP, installStatus=installStatus, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, hTTPPortNumber=hTTPPortNumber, licenseIEEE1588Support=licenseIEEE1588Support, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDMGroup=tDMGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sNMPTrapInternetAddress=sNMPTrapInternetAddress, enableTransmission=enableTransmission, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sNMPPortNumber=sNMPPortNumber, mgmtInstancedTable=mgmtInstancedTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogStateTrap=syslogStateTrap, wirelessOutOctets=wirelessOutOctets, deviceMACAddress=deviceMACAddress, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, transmitPowerLinked=transmitPowerLinked, versions=versions, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tDDControl=tDDControl, mainPSUPortStatusTrap=mainPSUPortStatusTrap, bridge=bridge, useVLANForMABProtocol=useVLANForMABProtocol, tDMChannelStatus=tDMChannelStatus, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sNMPTrapTable=sNMPTrapTable, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, snmpControl=snmpControl, ptp670=ptp670, licenseVersion=licenseVersion, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, licenseTrialPeriod=licenseTrialPeriod, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, licenseGasGroup=licenseGasGroup, licenseGroupAccess=licenseGroupAccess, auxPortConfigurationMismatch=auxPortConfigurationMismatch, secureModeAlarmTrap=secureModeAlarmTrap, dfs=dfs, dNS=dNS, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sntp=sntp, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tDDControlGroup=tDDControlGroup, licenseInstancedTableIndex=licenseInstancedTableIndex, encryptionAlgorithm=encryptionAlgorithm, licenseOOBManagementSupport=licenseOOBManagementSupport, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseGroup=licenseGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transparentClockVLAN=transparentClockVLAN, transparentClockPort=transparentClockPort, lowestTDMModulationMode=lowestTDMModulationMode, maximumNumberOfSlaves=maximumNumberOfSlaves, targetMACAddress=targetMACAddress, regulatoryBandTrap=regulatoryBandTrap, ptpCompliance=ptpCompliance, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, installationMode=installationMode, auxPortAcceptedQLRx=auxPortAcceptedQLRx, phyInstancedStatusTable=phyInstancedStatusTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, licenseBandwidthCap=licenseBandwidthCap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userTableIndex=userTableIndex, tdmTableEntry=tdmTableEntry, sNTPServerStatus=sNTPServerStatus, userTableEntry=userTableEntry, tDMChannelCableLength=tDMChannelCableLength, alarmsGroup=alarmsGroup, altitude=altitude, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, extendedSpectrumScanning=extendedSpectrumScanning, snmpControlGroup=snmpControlGroup, remoteInternetAddressType=remoteInternetAddressType, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, syncETrackingState=syncETrackingState, rawReceivePower=rawReceivePower, accessMethod=accessMethod, licenseInstancedTableEntry=licenseInstancedTableEntry, dNSServerPortNumber=dNSServerPortNumber, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, licenseCountry=licenseCountry, auxPortStatusTrap=auxPortStatusTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, syncETracking=syncETracking, cableDiagPair3Distance=cableDiagPair3Distance, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, linkLossLinked=linkLossLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transmitDataRateLinked=transmitDataRateLinked, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataBridgingStatusLinked=dataBridgingStatusLinked, syslogClient=syslogClient, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, gatewayIPAddress=gatewayIPAddress, phyControlInstancedTable=phyControlInstancedTable, dataPortPauseFrames=dataPortPauseFrames, oOBPriorityQueueMapping=oOBPriorityQueueMapping, dNSPrimaryServer=dNSPrimaryServer, alarmInstancedTableIndex=alarmInstancedTableIndex, range=range, encryptionGroup=encryptionGroup, smtpGroup=smtpGroup, unitName=unitName, antennaGain=antennaGain, userName=userName, sFPPortSyncERxStatus=sFPPortSyncERxStatus, installArmStateTrap=installArmStateTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPCommunityString=sNMPCommunityString, timeZone=timeZone, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, mainPSUPortQLRx=mainPSUPortQLRx, alarmInstancedTableEntry=alarmInstancedTableEntry, unitOutOfCalibration=unitOutOfCalibration, remoteUnitNameLinked=remoteUnitNameLinked, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, tdmTableNumber=tdmTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, bridgeGroup=bridgeGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rxColorCode=rxColorCode, sNMPEnabledTraps=sNMPEnabledTraps, hTTPAccessEnabled=hTTPAccessEnabled, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, auxPortQLTx=auxPortQLTx, mABTransmissionInterval=mABTransmissionInterval, resetGroup=resetGroup, dSCPManagementPriority=dSCPManagementPriority, signalStrengthRatio=signalStrengthRatio, receiveFreqKHz=receiveFreqKHz, vLANManagementPriority=vLANManagementPriority, remoteMACAddress=remoteMACAddress, syslogControl=syslogControl, syslogControlGroup=syslogControlGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dNSServerTable=dNSServerTable, mABProtocolVLANPriority=mABProtocolVLANPriority, mABHoldoffPeriod=mABHoldoffPeriod, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsMeans=dfsMeans, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sFPPortSSMTx=sFPPortSSMTx, tDMConfigurationMismatch=tDMConfigurationMismatch, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, portAllocationMismatchLinked=portAllocationMismatchLinked, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEmailAlert=sMTPEmailAlert, alarmInstancedTableNumber=alarmInstancedTableNumber, remoteMACAddressLinked=remoteMACAddressLinked, dataBridgingStatusAlarm=dataBridgingStatusAlarm, tDMChannelLineCode=tDMChannelLineCode, sNMPTrapTableIndex=sNMPTrapTableIndex, hCMPMaximumLinkRange=hCMPMaximumLinkRange, ethernetInstancedTableIndex=ethernetInstancedTableIndex, transmitFreqKHz=transmitFreqKHz, ethernetInstancedTableNumber=ethernetInstancedTableNumber, lbtDetectedTrap=lbtDetectedTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, capacityVariantMismatchTrap=capacityVariantMismatchTrap, configurationInstancedTable=configurationInstancedTable, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, tDMInterfaceStatus=tDMInterfaceStatus, syslogState=syslogState, nIDULanPortAutoMdix=nIDULanPortAutoMdix, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, configurationInstancedTableIndex=configurationInstancedTableIndex, iPVersion=iPVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernet=ethernet, licenseIssueNumber=licenseIssueNumber, wirelessOutAllOctets=wirelessOutAllOctets, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseHCMPSupport=licenseHCMPSupport, authorizationMethod=authorizationMethod, portAllocationMismatch=portAllocationMismatch, authorizationControl=authorizationControl, sFPError=sFPError, mgmtInstancedTableEntry=mgmtInstancedTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, softwareVersion=softwareVersion, cambium=cambium, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, cableDiagPair3Results=cableDiagPair3Results, sNTPServerTable=sNTPServerTable, ethernetInstancedTable=ethernetInstancedTable, masterSlaveMode=masterSlaveMode, secureModeAlarm=secureModeAlarm, wirelessTopology=wirelessTopology, installArmState=installArmState, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, phyControl=phyControl, syslogClientTrap=syslogClientTrap, iPv4Address=iPv4Address, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, ethernetStatisticsTable=ethernetStatisticsTable, configurationGroup=configurationGroup, dataBridgingStatus=dataBridgingStatus, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, vLANManagementVID=vLANManagementVID, longitude=longitude, rawReceivePowerLinked=rawReceivePowerLinked, portAllocationMismatchTrap=portAllocationMismatchTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, aggregateDataRate=aggregateDataRate, phyControlGroup=phyControlGroup, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, auxPortAllocation=auxPortAllocation, mainPSUPortAutoMdix=mainPSUPortAutoMdix, license=license, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, pubInstancedStatsTable=pubInstancedStatsTable, sNTPPollInterval=sNTPPollInterval, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, byteErrorRatio=byteErrorRatio, dfsTableIndex=dfsTableIndex, cableDiagPair2Results=cableDiagPair2Results, apcGroup=apcGroup, sFPErrorTrap=sFPErrorTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, l2CPPriorityTableIndex=l2CPPriorityTableIndex, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mainPSUPortAllocation=mainPSUPortAllocation, sFPPortDisabledWarning=sFPPortDisabledWarning, ptpGroups=ptpGroups)
