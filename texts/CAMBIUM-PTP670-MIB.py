...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortSyncERxStatus=auxPortSyncERxStatus, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tDMChannelCableLength=tDMChannelCableLength, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, incompatibleMasterAndSlave=incompatibleMasterAndSlave, pubStats=pubStats, cableDiagPair4Results=cableDiagPair4Results, regulatoryBandTrap=regulatoryBandTrap, txColorCode=txColorCode, alarmInstancedTable=alarmInstancedTable, sNTPServerTimeout=sNTPServerTimeout, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, cableDiagnostics=cableDiagnostics, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, wirelessLinkStatusLinked=wirelessLinkStatusLinked, licenseHCMPSupport=licenseHCMPSupport, altitude=altitude, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, dataBridgingAvailability=dataBridgingAvailability, groupID=groupID, ptp670=ptp670, alarmsGroup=alarmsGroup, portAllocationMismatchLinked=portAllocationMismatchLinked, sMTPEmailAlert=sMTPEmailAlert, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, dfsTableNumber=dfsTableNumber, tDMChannelStatusTrap=tDMChannelStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, hTTPAccessEnabled=hTTPAccessEnabled, licenseGroup=licenseGroup, receiveDataRate=receiveDataRate, unitName=unitName, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNTPServerPortNumber=sNTPServerPortNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, dNSGroup=dNSGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataBridgingStatus=dataBridgingStatus, sNTPState=sNTPState, tDMChannelLineCode=tDMChannelLineCode, searchStateLinked=searchStateLinked, auxPortStatus=auxPortStatus, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mABTransmissionInterval=mABTransmissionInterval, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, authorizationControlTableNumber=authorizationControlTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, authorizationControlTableEntry=authorizationControlTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, supplementaryGroup=supplementaryGroup, transmitModulationMode=transmitModulationMode, tDMChannelLoopback=tDMChannelLoopback, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, dNSServerTableIndex=dNSServerTableIndex, userRole=userRole, wirelessOutAllOctets=wirelessOutAllOctets, regulatoryBand=regulatoryBand, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, unitIdentification=unitIdentification, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetInstancedTable=ethernetInstancedTable, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sFPPortAutoMdix=sFPPortAutoMdix, wirelessLinkAvailability=wirelessLinkAvailability, snmpControl=snmpControl, mABHoldoffPeriod=mABHoldoffPeriod, mABMaintenanceLevel=mABMaintenanceLevel, userTable=userTable, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cableDiagnosticsControl=cableDiagnosticsControl, auxPortQLTx=auxPortQLTx, licenseMaxLinkRange=licenseMaxLinkRange, dNSServerInternetAddressType=dNSServerInternetAddressType, dNSPrimaryServer=dNSPrimaryServer, subbandHighestFrequency=subbandHighestFrequency, longitude=longitude, sntp=sntp, hardwareVersion=hardwareVersion, extendedSpectrumScanning=extendedSpectrumScanning, tdmTableIndex=tdmTableIndex, sFPPortQLTx=sFPPortQLTx, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, wirelessOutEthernetOctets=wirelessOutEthernetOctets, syslogClientTrap=syslogClientTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mgmtInstancedTableNumber=mgmtInstancedTableNumber, frequencyVariant=frequencyVariant, sNMPTrapInternetAddress=sNMPTrapInternetAddress, mainPSUPortAllocation=mainPSUPortAllocation, phyControlInstancedTableNumber=phyControlInstancedTableNumber, signalStrengthRatioLinked=signalStrengthRatioLinked, tDM=tDM, cableDiagnosticsPorts=cableDiagnosticsPorts, transparentClockPort=transparentClockPort, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, deviceMACAddress=deviceMACAddress, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, blacklistRMEnabled=blacklistRMEnabled, dSCPManagementPriority=dSCPManagementPriority, targetMACAddress=targetMACAddress, phyInstancedStatusTable=phyInstancedStatusTable, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, remoteMACAddressLinked=remoteMACAddressLinked, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, cableDiagnosticsResultTable=cableDiagnosticsResultTable, aAAControlGroup=aAAControlGroup, cableDiagPair2Results=cableDiagPair2Results, l2CPPriorityTableNumber=l2CPPriorityTableNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, dNSServerInternetAddress=dNSServerInternetAddress, cableDiagPair4Distance=cableDiagPair4Distance, qOSPriorityScheme=qOSPriorityScheme, dataBridgingStatusAlarm=dataBridgingStatusAlarm, cableDiagPair3Results=cableDiagPair3Results, mgmtInstancedTable=mgmtInstancedTable, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, tDMChannelStatus=tDMChannelStatus, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tempPcb=tempPcb, phyControlInstancedTableEntry=phyControlInstancedTableEntry, syncEEquipmentClock=syncEEquipmentClock, gatewayIPAddress=gatewayIPAddress, syncETrackingState=syncETrackingState, softwareVersion=softwareVersion, licenseGasGroup=licenseGasGroup, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, syncESlavePort=syncESlavePort, sNTPServerTableNumber=sNTPServerTableNumber, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, versionsGroup=versionsGroup, phyControlGroup=phyControlGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, aAAControl=aAAControl, userTableNumber=userTableNumber, configurationInstancedTable=configurationInstancedTable, ptpCompliance=ptpCompliance, channelBandwidth=channelBandwidth, sNTPServerTable=sNTPServerTable, dataPortPauseFrames=dataPortPauseFrames, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dfsMeans=dfsMeans, licenseInstancedTableIndex=licenseInstancedTableIndex, syslogControlGroup=syslogControlGroup, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, phyControl=phyControl, authorizationControlTable=authorizationControlTable, ptpTraps=ptpTraps, dfsPeaks=dfsPeaks, phyControlInstancedTable=phyControlInstancedTable, iPVersion=iPVersion, auxPortSSMTx=auxPortSSMTx, receiveModulationModeDetail=receiveModulationModeDetail, sMTPServerPortNumber=sMTPServerPortNumber, packetsToInternalStack=packetsToInternalStack, tDDControlGroup=tDDControlGroup, rxColorCode=rxColorCode, sFPPortDisabledWarning=sFPPortDisabledWarning, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, linkLossLinked=linkLossLinked, telnetPortNumber=telnetPortNumber, remoteInternetAddress=remoteInternetAddress, syslogState=syslogState, phyStatus=phyStatus, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, latitude=latitude, dfsTableIndex=dfsTableIndex, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, configuration=configuration, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, whitelistRMMacAddress=whitelistRMMacAddress, tDDSynchronizationMode=tDDSynchronizationMode, mABProtocolVID=mABProtocolVID, licenseTLSRekey=licenseTLSRekey, rangingMode=rangingMode, cableDiagPair3Distance=cableDiagPair3Distance, snmpControlGroup=snmpControlGroup, linkLoss=linkLoss, tdmTableNumber=tdmTableNumber, configurationInstancedTableEntry=configurationInstancedTableEntry, unitIdentificationGroup=unitIdentificationGroup, phyControlInstancedTableIndex=phyControlInstancedTableIndex, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, portAllocationMismatch=portAllocationMismatch, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, tFTPServerInternetAddress=tFTPServerInternetAddress, sFPPortQLRx=sFPPortQLRx, authorizationControlTableIndex=authorizationControlTableIndex, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sFPPortStatus=sFPPortStatus, receivePower=receivePower, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPrimaryServer=sNTPPrimaryServer, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortAutoMdix=mainPSUPortAutoMdix, apc=apc, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dNSServerTable=dNSServerTable, wirelessLinkStatus=wirelessLinkStatus, licenseTrialPeriod=licenseTrialPeriod, blacklistRMMacAddress=blacklistRMMacAddress, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sFPError=sFPError, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, ethernet=ethernet, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseTDDSyncSupport=licenseTDDSyncSupport, syslogStateTrap=syslogStateTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortAllocation=auxPortAllocation, sNMPCommunityString=sNMPCommunityString, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installArmStateTrap=installArmStateTrap, transmitChannel=transmitChannel, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, maxLinkRangeExceeded=maxLinkRangeExceeded, ptpTrapPrefix=ptpTrapPrefix, receiveDataRateLinked=receiveDataRateLinked, ethernetStatisticsTable=ethernetStatisticsTable, smtp=smtp, mainPSUPortSSMTx=mainPSUPortSSMTx, secureModeAlarm=secureModeAlarm, userEnabled=userEnabled, tDDControl=tDDControl, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, installStatusTrap=installStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseRegulatoryBandsList=licenseRegulatoryBandsList, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, unitOutOfCalibration=unitOutOfCalibration, sNTPSyncTrap=sNTPSyncTrap, secureModeAlarmTrap=secureModeAlarmTrap, userTableIndex=userTableIndex, auxPortStatusTrap=auxPortStatusTrap, sNMPTrapVersion=sNMPTrapVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dNSResolver=dNSResolver, remoteUnitNameLinked=remoteUnitNameLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, capacityVariantMismatchLinked=capacityVariantMismatchLinked, tDMEnabledChannels=tDMEnabledChannels, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDMInterfaceControl=tDMInterfaceControl, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, iPDSCPPriorityTable=iPDSCPPriorityTable, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, packetsFromInternalStack=packetsFromInternalStack, notificationsGroup=notificationsGroup, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mgmtInstancedTableIndex=mgmtInstancedTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenseSecurityLevel=licenseSecurityLevel, bridgeGroup=bridgeGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerTableIndex=sNTPServerTableIndex, management=management, installStatusLinked=installStatusLinked, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, nIDULanPortStatus=nIDULanPortStatus, licenseSFPPortSupport=licenseSFPPortSupport, cambium=cambium, installArmState=installArmState, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, transmitPower=transmitPower, receiveModulationMode=receiveModulationMode, lowestDataModulationMode=lowestDataModulationMode, rangeLinked=rangeLinked, sNMPEnabledTraps=sNMPEnabledTraps, ethernetPriorityTable=ethernetPriorityTable, licenseSyncESupport=licenseSyncESupport, tdmTable=tdmTable, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, capacityVariantMismatch=capacityVariantMismatch, tDMInterfaceStatus=tDMInterfaceStatus, mgmtInstancedTableEntry=mgmtInstancedTableEntry, txMABFrames=txMABFrames, ethernetInstancedTableIndex=ethernetInstancedTableIndex, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, ethernetPriorityTableIndex=ethernetPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, apcGroup=apcGroup, smtpGroup=smtpGroup, licenseInstancedTableNumber=licenseInstancedTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, systemClock=systemClock, auxPortDisabledWarning=auxPortDisabledWarning, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, transmitFreqMHz=transmitFreqMHz, accessMethod=accessMethod, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, authorizationControl=authorizationControl, transmitDataRate=transmitDataRate, whitelistRMEnabled=whitelistRMEnabled, syncETracking=syncETracking, lowestTDMModulationMode=lowestTDMModulationMode, tDMConfigurationMismatch=tDMConfigurationMismatch, remoteMACAddress=remoteMACAddress, configurationGroup=configurationGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, deviceESN=deviceESN, iPv6GatewayAddress=iPv6GatewayAddress, useVLANForMABProtocol=useVLANForMABProtocol, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseCapacity=licenseCapacity, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, severelyErroredSeconds=severelyErroredSeconds, cableLoss=cableLoss, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseVersion=licenseVersion, license=license, ptp=ptp, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, mABProtocolVLANPriority=mABProtocolVLANPriority, vLANManagementPriority=vLANManagementPriority, cableDiagPair1Results=cableDiagPair1Results, sNTPSync=sNTPSync, sMTPEnabledMessages=sMTPEnabledMessages, hTTPPortNumber=hTTPPortNumber, licenseIssueNumber=licenseIssueNumber, transparentClock=transparentClock, licenseRARSupport=licenseRARSupport, eIRP=eIRP, transmitterChannels=transmitterChannels, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sFPErrorTrap=sFPErrorTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, transmitFreqKHz=transmitFreqKHz, sNTPPollInterval=sNTPPollInterval, secondarySoftwareVersion=secondarySoftwareVersion, configurationInstancedTableNumber=configurationInstancedTableNumber, tFTPClient=tFTPClient, dfs=dfs, dNS=dNS, sNTPServerStatus=sNTPServerStatus, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, channelChangeTrap=channelChangeTrap, localPacketFiltering=localPacketFiltering, unavailableSeconds=unavailableSeconds, productName=productName, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, range=range, searchState=searchState, timeZone=timeZone, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, byteErrorRatio=byteErrorRatio, enableTransmission=enableTransmission, installationMode=installationMode, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, receiveChannel=receiveChannel, ethernetGroup=ethernetGroup, ethernetInstancedTableNumber=ethernetInstancedTableNumber, rawReceivePowerLinked=rawReceivePowerLinked, mainPSUPortStatus=mainPSUPortStatus, remoteUnitName=remoteUnitName, mainPSUPortQLTx=mainPSUPortQLTx, authorizationControlGroup=authorizationControlGroup, cableDiagPair2Distance=cableDiagPair2Distance, routerProtocols=routerProtocols, targetRange=targetRange, transmitPowerLinked=transmitPowerLinked, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseEncryption=licenseEncryption, receiveModulationModeLinked=receiveModulationModeLinked, sNTPLastSync=sNTPLastSync, encryptionAlgorithm=encryptionAlgorithm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, bootVersion=bootVersion, dfsTable=dfsTable, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, bridge=bridge, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortSSMTx=sFPPortSSMTx, supplementary=supplementary, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, licenseInstancedTable=licenseInstancedTable, alarmInstancedTableIndex=alarmInstancedTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, hCMPLinkSymmetry=hCMPLinkSymmetry, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, phyStatusGroup=phyStatusGroup, mABState=mABState, resetGroup=resetGroup, masterSlaveMode=masterSlaveMode, cableDiagnosticsGroup=cableDiagnosticsGroup, vectorError=vectorError, remoteInternetAddressType=remoteInternetAddressType, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, tdmTableEntry=tdmTableEntry, deviceMSN=deviceMSN, auxPortQLRx=auxPortQLRx, subbandLowestFrequency=subbandLowestFrequency, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transparentClockVLAN=transparentClockVLAN, licenseUnitSerialNumber=licenseUnitSerialNumber, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, installStatus=installStatus, hTTPSPortNumber=hTTPSPortNumber, productVariant=productVariant, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, versions=versions, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, encryption=encryption, oOBPriorityQueueMapping=oOBPriorityQueueMapping, userPassword=userPassword, antennaSelection=antennaSelection, antennaGain=antennaGain, sFPPortAllocation=sFPPortAllocation, linkName=linkName, byteErrorRatioLinked=byteErrorRatioLinked, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, iPv6Address=iPv6Address, tFTPServerPortNumber=tFTPServerPortNumber, alarms=alarms, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, dfsGroup=dfsGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPv4Address=iPv4Address, ethernetInstancedTableEntry=ethernetInstancedTableEntry, licenseInstancedTableEntry=licenseInstancedTableEntry, signalStrengthRatio=signalStrengthRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseIPv6Support=licenseIPv6Support, dNSServerTableEntry=dNSServerTableEntry, ptpGroups=ptpGroups, configurationInstancedTableIndex=configurationInstancedTableIndex, sMTPServerInternetAddressType=sMTPServerInternetAddressType, linkModeOptimizationMismatch=linkModeOptimizationMismatch, pubInstancedStatsTable=pubInstancedStatsTable, vectorErrorLinked=vectorErrorLinked, licenseIEEE1588Support=licenseIEEE1588Support, licenseGroupAccess=licenseGroupAccess, auxPortAcceptedQLRx=auxPortAcceptedQLRx, tFTPServerInternetAddressType=tFTPServerInternetAddressType, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, wirelessOutOctets=wirelessOutOctets, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mPLSTCPriorityTable=mPLSTCPriorityTable, ptmp=ptmp, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, incompatibleRegulatoryBands=incompatibleRegulatoryBands, userName=userName, managementGroup=managementGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, PYSNMP_MODULE_ID=cambium, authorizationMethod=authorizationMethod, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogControl=syslogControl, licenseBandwidthCap=licenseBandwidthCap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, pubStatsGroup=pubStatsGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", syslogClient=syslogClient, subnetMask=subnetMask, daylightSaving=daylightSaving, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, transmitDataRateLinked=transmitDataRateLinked, sFPPortSyncERxStatus=sFPPortSyncERxStatus, receiveFreqMHz=receiveFreqMHz, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, dfsTableEntry=dfsTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, aggregateDataRate=aggregateDataRate, linkModeOptimization=linkModeOptimization, sNMPTrapTable=sNMPTrapTable, receiveFreqKHz=receiveFreqKHz, l2CPPriorityTable=l2CPPriorityTable, dNSServerPortNumber=dNSServerPortNumber, receivePowerLinked=receivePowerLinked, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, maximumTransmitPower=maximumTransmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, alarmInstancedTableNumber=alarmInstancedTableNumber, userTableEntry=userTableEntry, cableDiagPair1Distance=cableDiagPair1Distance, sntpGroup=sntpGroup, sNMPv3Enable=sNMPv3Enable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, siteName=siteName, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, vLANManagementVID=vLANManagementVID, transparentClockVID=transparentClockVID, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sFPPortStatusTrap=sFPPortStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNMPPortNumber=sNMPPortNumber, encryptionGroup=encryptionGroup, linkSymmetry=linkSymmetry, aggregateDataRateLinked=aggregateDataRateLinked, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, transmitModulationModeLinked=transmitModulationModeLinked, tDMGroup=tDMGroup, dNSServerTableNumber=dNSServerTableNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, iPv6PrefixLength=iPv6PrefixLength, wirelessTopology=wirelessTopology, rawReceivePower=rawReceivePower, hCMPMaximumLinkRange=hCMPMaximumLinkRange, alarmInstancedTableEntry=alarmInstancedTableEntry, routerProtocolsGroup=routerProtocolsGroup, mainPSUPortQLRx=mainPSUPortQLRx, licenseCountry=licenseCountry, lbtDetectedTrap=lbtDetectedTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mABNominalModulationMode=mABNominalModulationMode, systemReset=systemReset, erroredSeconds=erroredSeconds)
