...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", management=management, txMABFrames=txMABFrames, sFPPortStatus=sFPPortStatus, smtp=smtp, tDMConfigurationMismatch=tDMConfigurationMismatch, syslogClientTrap=syslogClientTrap, signalStrengthRatio=signalStrengthRatio, aAAControl=aAAControl, wirelessLinkStatusLinked=wirelessLinkStatusLinked, encryption=encryption, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerTable=sNTPServerTable, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, smtpGroup=smtpGroup, bridge=bridge, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, frequencyVariant=frequencyVariant, localPacketFiltering=localPacketFiltering, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sMTPEmailAlert=sMTPEmailAlert, sNTPServerRetries=sNTPServerRetries, packetsToInternalStack=packetsToInternalStack, snmpControlGroup=snmpControlGroup, whitelistRMEnabled=whitelistRMEnabled, tDDSynchronizationStatus=tDDSynchronizationStatus, auxPortConfigurationMismatch=auxPortConfigurationMismatch, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, tDDSynchronizationMode=tDDSynchronizationMode, phyControlInstancedTable=phyControlInstancedTable, mABMaintenanceLevel=mABMaintenanceLevel, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPState=sNTPState, channelChangeTrap=channelChangeTrap, extendedSpectrumScanning=extendedSpectrumScanning, PYSNMP_MODULE_ID=cambium, licenseGasGroup=licenseGasGroup, remoteInternetAddressType=remoteInternetAddressType, l2CPPriorityTableNumber=l2CPPriorityTableNumber, txColorCode=txColorCode, tDMEnabledChannels=tDMEnabledChannels, gatewayIPAddress=gatewayIPAddress, channelBandwidth=channelBandwidth, hTTPAccessEnabled=hTTPAccessEnabled, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveDataRate=receiveDataRate, phyControl=phyControl, deviceMSN=deviceMSN, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sNTPPollInterval=sNTPPollInterval, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortQLTx=mainPSUPortQLTx, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, remoteMACAddress=remoteMACAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, masterSlaveMode=masterSlaveMode, l2CPPriorityTable=l2CPPriorityTable, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sFPPortDisabledWarning=sFPPortDisabledWarning, licenseIssueNumber=licenseIssueNumber, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, unitIdentification=unitIdentification, configurationInstancedTableNumber=configurationInstancedTableNumber, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, whitelistRMMacAddress=whitelistRMMacAddress, receivePowerLinked=receivePowerLinked, vLANManagementVID=vLANManagementVID, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, licenseInstancedTable=licenseInstancedTable, iPVersion=iPVersion, receiveFreqKHz=receiveFreqKHz, mABState=mABState, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDDControlGroup=tDDControlGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, cableDiagnosticsControl=cableDiagnosticsControl, tdmTableEntry=tdmTableEntry, alarmInstancedTable=alarmInstancedTable, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sFPPortQLTx=sFPPortQLTx, dNSPrimaryServer=dNSPrimaryServer, rawReceivePowerLinked=rawReceivePowerLinked, auxPortSyncERxStatus=auxPortSyncERxStatus, sNMPTrapVersion=sNMPTrapVersion, qOSPriorityScheme=qOSPriorityScheme, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, hTTPSPortNumber=hTTPSPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, syncESlavePort=syncESlavePort, altitude=altitude, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, nIDULanPortStatus=nIDULanPortStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, transmitChannel=transmitChannel, syslogControl=syslogControl, lowestDataModulationMode=lowestDataModulationMode, tDDControl=tDDControl, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, receiveDataRateLinked=receiveDataRateLinked, ethernetInstancedTable=ethernetInstancedTable, encryptionAlgorithm=encryptionAlgorithm, tDMChannelLoopback=tDMChannelLoopback, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableDiagPair1Results=cableDiagPair1Results, bridgeGroup=bridgeGroup, linkName=linkName, installStatusLinked=installStatusLinked, cableDiagPair4Results=cableDiagPair4Results, capacityVariantMismatch=capacityVariantMismatch, sMTPServerInternetAddress=sMTPServerInternetAddress, searchState=searchState, dfsTableNumber=dfsTableNumber, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, deviceMACAddress=deviceMACAddress, blacklistRMMacAddress=blacklistRMMacAddress, mainPSUPortSSMTx=mainPSUPortSSMTx, sFPPortSSMTx=sFPPortSSMTx, sntp=sntp, eIRP=eIRP, tdmTable=tdmTable, mgmtInstancedTableNumber=mgmtInstancedTableNumber, longitude=longitude, targetRange=targetRange, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, reset=reset, dfsTable=dfsTable, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, ethernetGroup=ethernetGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, linkModeOptimization=linkModeOptimization, productVariant=productVariant, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, authorizationControlTableNumber=authorizationControlTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sFPPortQLRx=sFPPortQLRx, sNMPTrapTableIndex=sNMPTrapTableIndex, mainPSUPortStatus=mainPSUPortStatus, licenseHCMPSupport=licenseHCMPSupport, installationMode=installationMode, licenseSyncESupport=licenseSyncESupport, tDMChannelStatusTrap=tDMChannelStatusTrap, transmitModulationMode=transmitModulationMode, vLANManagementPriority=vLANManagementPriority, mABNominalModulationMode=mABNominalModulationMode, latitude=latitude, tDMInterfaceControl=tDMInterfaceControl, sFPPortStatusTrap=sFPPortStatusTrap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sFPError=sFPError, sNMPEnabledTraps=sNMPEnabledTraps, vectorErrorLinked=vectorErrorLinked, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseCountry=licenseCountry, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, wirelessOutOctets=wirelessOutOctets, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPv3Enable=sNMPv3Enable, cableLoss=cableLoss, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, enableTransmission=enableTransmission, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, ptmp=ptmp, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseEncryption=licenseEncryption, sNTPSyncTrap=sNTPSyncTrap, syslogClient=syslogClient, licenseTDDSyncSupport=licenseTDDSyncSupport, hardwareVersion=hardwareVersion, syncETrackingState=syncETrackingState, transmitDataRate=transmitDataRate, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, versionsGroup=versionsGroup, portAllocationMismatchTrap=portAllocationMismatchTrap, mABProtocolVID=mABProtocolVID, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, tDMGroup=tDMGroup, phyInstancedStatusTable=phyInstancedStatusTable, capacityVariantMismatchLinked=capacityVariantMismatchLinked, dNSServerTable=dNSServerTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, sFPPortAllocation=sFPPortAllocation, tDMChannelStatus=tDMChannelStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, phyControlGroup=phyControlGroup, dNSServerTableIndex=dNSServerTableIndex, dNSServerPortNumber=dNSServerPortNumber, remoteUnitNameLinked=remoteUnitNameLinked, authorizationControlTable=authorizationControlTable, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, rangingMode=rangingMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, authorizationControlGroup=authorizationControlGroup, aggregateDataRateLinked=aggregateDataRateLinked, managementPortWirelessDownAlert=managementPortWirelessDownAlert, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, receivePower=receivePower, apc=apc, tDMChannelCableLength=tDMChannelCableLength, sNTPSync=sNTPSync, installArmStateTrap=installArmStateTrap, resetGroup=resetGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, configurationInstancedTableEntry=configurationInstancedTableEntry, unitName=unitName, licenseBandwidthCap=licenseBandwidthCap, sNTPServerTableEntry=sNTPServerTableEntry, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseInstancedTableNumber=licenseInstancedTableNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, ethernetInstancedTableNumber=ethernetInstancedTableNumber, alarmInstancedTableIndex=alarmInstancedTableIndex, authorizationControlTableIndex=authorizationControlTableIndex, tdmTableNumber=tdmTableNumber, mgmtInstancedTable=mgmtInstancedTable, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, unavailableSeconds=unavailableSeconds, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tempPcb=tempPcb, secondarySoftwareVersion=secondarySoftwareVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, configuration=configuration, sNMPTrapInternetAddress=sNMPTrapInternetAddress, regulatoryBand=regulatoryBand, ptp=ptp, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, dfsGroup=dfsGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, vectorError=vectorError, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, syslogStateTrap=syslogStateTrap, linkLoss=linkLoss, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataBridgingStatusAlarm=dataBridgingStatusAlarm, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, unitOutOfCalibration=unitOutOfCalibration, routerProtocols=routerProtocols, transmitModulationModeLinked=transmitModulationModeLinked, searchStateLinked=searchStateLinked, range=range, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, dataBridgingAvailability=dataBridgingAvailability, enabledDiagnosticAlarms=enabledDiagnosticAlarms, alarms=alarms, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, aAAControlGroup=aAAControlGroup, antennaSelection=antennaSelection, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, groupID=groupID, notificationsGroup=notificationsGroup, encryptionGroup=encryptionGroup, maximumNumberOfSlaves=maximumNumberOfSlaves, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, dNSServerTableEntry=dNSServerTableEntry, transparentClock=transparentClock, dataBridgingStatus=dataBridgingStatus, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, pubInstancedStatsTable=pubInstancedStatsTable, regulatoryBandTrap=regulatoryBandTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagnosticsResultTable=cableDiagnosticsResultTable, nIDULanPortStatusTrap=nIDULanPortStatusTrap, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseUnitSerialNumber=licenseUnitSerialNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, transparentClockVLAN=transparentClockVLAN, pubStats=pubStats, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, syslogControlGroup=syslogControlGroup, userRole=userRole, subnetMask=subnetMask, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, userEnabled=userEnabled, installStatus=installStatus, accessMethod=accessMethod, dfsMeans=dfsMeans, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licenseMaxLinkRange=licenseMaxLinkRange, ethernetStatisticsDataSource=ethernetStatisticsDataSource, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, linkSymmetry=linkSymmetry, licenseTLSRekey=licenseTLSRekey, targetMACAddress=targetMACAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, versions=versions, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, dfs=dfs, remoteMACAddressLinked=remoteMACAddressLinked, portAllocationMismatchLinked=portAllocationMismatchLinked, ptpCompliance=ptpCompliance, transmitterChannels=transmitterChannels, auxPortQLTx=auxPortQLTx, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, dNSGroup=dNSGroup, deviceESN=deviceESN, transmitFreqKHz=transmitFreqKHz, erroredSeconds=erroredSeconds, subbandHighestFrequency=subbandHighestFrequency, userTableIndex=userTableIndex, cambium=cambium, userName=userName, telnetAccessEnabled=telnetAccessEnabled, licenseRARSupport=licenseRARSupport, syncEEquipmentClock=syncEEquipmentClock, dfsTableEntry=dfsTableEntry, cableDiagnosticsPorts=cableDiagnosticsPorts, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, bootVersion=bootVersion, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, userTable=userTable, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, receiveChannel=receiveChannel, wirelessTopology=wirelessTopology, licenseInstancedTableIndex=licenseInstancedTableIndex, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, auxPortStatus=auxPortStatus, mainPSUPortQLRx=mainPSUPortQLRx, dNSServerInternetAddressType=dNSServerInternetAddressType, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, dNSServerInternetAddress=dNSServerInternetAddress, antennaGain=antennaGain, userPassword=userPassword, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, telnetPortNumber=telnetPortNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, receiveModulationMode=receiveModulationMode, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tDM=tDM, cableDiagnosticsGroup=cableDiagnosticsGroup, sMTPEnabledMessages=sMTPEnabledMessages, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, transmitFreqMHz=transmitFreqMHz, iPv4Address=iPv4Address, apcGroup=apcGroup, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, aggregateDataRate=aggregateDataRate, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortAutoNegotiation=sFPPortAutoNegotiation, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ptp670=ptp670, licenseInstancedTableEntry=licenseInstancedTableEntry, ethernetStatisticsTable=ethernetStatisticsTable, licenseRegulatoryBandsList=licenseRegulatoryBandsList, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetPriorityTable=ethernetPriorityTable, hTTPSAccessEnabled=hTTPSAccessEnabled, authorizationControlTableEntry=authorizationControlTableEntry, useVLANForMABProtocol=useVLANForMABProtocol, iPv6PrefixLength=iPv6PrefixLength, remoteUnitName=remoteUnitName, transmitDataRateLinked=transmitDataRateLinked, sFPPortSyncERxStatus=sFPPortSyncERxStatus, transmitPowerLinked=transmitPowerLinked, auxPortStatusTrap=auxPortStatusTrap, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, userTableEntry=userTableEntry, transparentClockVID=transparentClockVID, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sNTPServerStatus=sNTPServerStatus, severelyErroredSeconds=severelyErroredSeconds, ethernetInstancedTableEntry=ethernetInstancedTableEntry, snmpControl=snmpControl, tDMInterfaceStatus=tDMInterfaceStatus, rawReceivePower=rawReceivePower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, transparentClockPort=transparentClockPort, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, ethernetPriorityTableNumber=ethernetPriorityTableNumber, signalStrengthRatioLinked=signalStrengthRatioLinked, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sntpGroup=sntpGroup, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, syslogState=syslogState, auxPortSSMTx=auxPortSSMTx, wirelessLinkAvailability=wirelessLinkAvailability, sNTPServerTableNumber=sNTPServerTableNumber, pubStatsGroup=pubStatsGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installArmState=installArmState, auxPortAllocation=auxPortAllocation, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, ethernet=ethernet, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, receiveFreqMHz=receiveFreqMHz, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, byteErrorRatioLinked=byteErrorRatioLinked, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, phyStatus=phyStatus, productName=productName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTableNumber=userTableNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, systemReset=systemReset, timeZone=timeZone, dfsTableIndex=dfsTableIndex, cableDiagPair2Distance=cableDiagPair2Distance, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mPLSTCPriorityTable=mPLSTCPriorityTable, supplementary=supplementary, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, configurationInstancedTable=configurationInstancedTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, licenseSFPPortSupport=licenseSFPPortSupport, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, lbtDetectedTrap=lbtDetectedTrap, ethernetInstancedTableIndex=ethernetInstancedTableIndex, mABProtocolVLANPriority=mABProtocolVLANPriority, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, transmitPower=transmitPower, remoteInternetAddress=remoteInternetAddress, cableDiagPair1Distance=cableDiagPair1Distance, licenseGroupAccess=licenseGroupAccess, hCMPMaximumLinkRange=hCMPMaximumLinkRange, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, receiveModulationModeDetail=receiveModulationModeDetail, cableDiagPair3Distance=cableDiagPair3Distance, sNTPLastSync=sNTPLastSync, hTTPPortNumber=hTTPPortNumber, alarmInstancedTableEntry=alarmInstancedTableEntry, phyControlInstancedTableIndex=phyControlInstancedTableIndex, siteName=siteName, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPv6Address=iPv6Address, alarmInstancedTableNumber=alarmInstancedTableNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkLossLinked=linkLossLinked, licenseVersion=licenseVersion, receiveModulationModeLinked=receiveModulationModeLinked, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sNMPPortNumber=sNMPPortNumber, phyStatusGroup=phyStatusGroup, cableDiagnostics=cableDiagnostics, licenseIPv6Support=licenseIPv6Support, tFTPServerPortNumber=tFTPServerPortNumber, authorizationControl=authorizationControl, authorizationMethod=authorizationMethod, wirelessLinkStatus=wirelessLinkStatus, dNSResolver=dNSResolver, licenseGroup=licenseGroup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, configurationGroup=configurationGroup, licenseSecurityLevel=licenseSecurityLevel, hCMPLinkSymmetry=hCMPLinkSymmetry, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, daylightSaving=daylightSaving, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, secureModeAlarm=secureModeAlarm, blacklistRMEnabled=blacklistRMEnabled, softwareVersion=softwareVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", maximumTransmitPower=maximumTransmitPower, tFTPClient=tFTPClient, auxPortAcceptedQLRx=auxPortAcceptedQLRx, wirelessOutEthernetOctets=wirelessOutEthernetOctets, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseIEEE1588Support=licenseIEEE1588Support, systemClock=systemClock, sFPPortAutoMdix=sFPPortAutoMdix, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, managementGroup=managementGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, dNS=dNS, routerProtocolsGroup=routerProtocolsGroup, capacityVariantMismatchTrap=capacityVariantMismatchTrap, syncETracking=syncETracking, dSCPManagementPriority=dSCPManagementPriority, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, rxColorCode=rxColorCode, sNTPServerTimeout=sNTPServerTimeout, byteErrorRatio=byteErrorRatio, dataPortPauseFrames=dataPortPauseFrames, cableDiagPair3Results=cableDiagPair3Results, wirelessOutAllOctets=wirelessOutAllOctets, auxPortQLRx=auxPortQLRx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, dfsPeaks=dfsPeaks, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mABTransmissionInterval=mABTransmissionInterval, cableDiagPair4Distance=cableDiagPair4Distance, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tDMChannelLineCode=tDMChannelLineCode, sNMPCommunityString=sNMPCommunityString, license=license, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mABHoldoffPeriod=mABHoldoffPeriod, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dNSServerTableNumber=dNSServerTableNumber, supplementaryGroup=supplementaryGroup, packetsFromInternalStack=packetsFromInternalStack, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, alarmsGroup=alarmsGroup, portAllocationMismatch=portAllocationMismatch, licenseCapacity=licenseCapacity, ptpGroups=ptpGroups, auxPortDisabledWarning=auxPortDisabledWarning, ptpTraps=ptpTraps, unitIdentificationGroup=unitIdentificationGroup, installStatusTrap=installStatusTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, cableDiagPair2Results=cableDiagPair2Results, subbandLowestFrequency=subbandLowestFrequency, sFPErrorTrap=sFPErrorTrap, lowestTDMModulationMode=lowestTDMModulationMode, tdmTableIndex=tdmTableIndex, rangeLinked=rangeLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, iPv6GatewayAddress=iPv6GatewayAddress)
