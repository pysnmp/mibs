...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dataBridgingStatusAlarm=dataBridgingStatusAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, antennaSelection=antennaSelection, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseSecurityLevel=licenseSecurityLevel, installationMode=installationMode, transmitFreqKHz=transmitFreqKHz, aAAControl=aAAControl, licenseInstancedTableIndex=licenseInstancedTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tdmTableIndex=tdmTableIndex, tempPcb=tempPcb, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, transparentClockPort=transparentClockPort, localPacketFiltering=localPacketFiltering, iPv6Address=iPv6Address, licenseMaxLinkRange=licenseMaxLinkRange, installArmStateTrap=installArmStateTrap, versions=versions, pubInstancedStatsTable=pubInstancedStatsTable, masterSlaveMode=masterSlaveMode, wirelessLinkStatusLinked=wirelessLinkStatusLinked, transparentClockVID=transparentClockVID, gatewayIPAddress=gatewayIPAddress, ethernet=ethernet, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mABTransmissionInterval=mABTransmissionInterval, ethernetInstancedTable=ethernetInstancedTable, licenseTLSRekey=licenseTLSRekey, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsGroup=dfsGroup, auxPortDisabledWarning=auxPortDisabledWarning, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tdmTableNumber=tdmTableNumber, sNTPServerTable=sNTPServerTable, sNMPTrapTableNumber=sNMPTrapTableNumber, mABMaintenanceLevel=mABMaintenanceLevel, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, auxPortStatusTrap=auxPortStatusTrap, tDMChannelCableLength=tDMChannelCableLength, authorizationControl=authorizationControl, versionsGroup=versionsGroup, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, receiveDataRateLinked=receiveDataRateLinked, sNMPEnabledTraps=sNMPEnabledTraps, authorizationControlTableEntry=authorizationControlTableEntry, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, altitude=altitude, mainPSUPortQLTx=mainPSUPortQLTx, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tDMEnabledChannels=tDMEnabledChannels, systemReset=systemReset, sNTPState=sNTPState, channelChangeTrap=channelChangeTrap, deviceMACAddress=deviceMACAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, antennaGain=antennaGain, rawReceivePower=rawReceivePower, hCMPLinkSymmetry=hCMPLinkSymmetry, tdmTableEntry=tdmTableEntry, syncESlavePort=syncESlavePort, syslogStateTrap=syslogStateTrap, txColorCode=txColorCode, packetsFromInternalStack=packetsFromInternalStack, sNMPTrapPortNumber=sNMPTrapPortNumber, mABProtocolVID=mABProtocolVID, licenseCountry=licenseCountry, transparentClockVLAN=transparentClockVLAN, sNTPLastSync=sNTPLastSync, maximumTransmitPower=maximumTransmitPower, sNMPCommunityString=sNMPCommunityString, installArmState=installArmState, severelyErroredSeconds=severelyErroredSeconds, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, alarmInstancedTable=alarmInstancedTable, snmpControlGroup=snmpControlGroup, groupID=groupID, sNTPServerTableIndex=sNTPServerTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, bridgeGroup=bridgeGroup, remoteUnitNameLinked=remoteUnitNameLinked, signalStrengthRatioLinked=signalStrengthRatioLinked, dNSServerInternetAddress=dNSServerInternetAddress, txMABFrames=txMABFrames, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, rangeLinked=rangeLinked, licenseInstancedTableEntry=licenseInstancedTableEntry, installStatusTrap=installStatusTrap, sFPPortAllocation=sFPPortAllocation, licenseInstancedTableNumber=licenseInstancedTableNumber, ptpTrapPrefix=ptpTrapPrefix, unitIdentificationGroup=unitIdentificationGroup, wirelessLinkStatus=wirelessLinkStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, whitelistRMEnabled=whitelistRMEnabled, lbtDetectedTrap=lbtDetectedTrap, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, dfsTableEntry=dfsTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, auxPortSSMTx=auxPortSSMTx, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mABNominalTransmitCapacity=mABNominalTransmitCapacity, latitude=latitude, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPPollInterval=sNTPPollInterval, cableDiagPair2Distance=cableDiagPair2Distance, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nIDULanPortStatus=nIDULanPortStatus, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, syslogControlGroup=syslogControlGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mgmtInstancedTableEntry=mgmtInstancedTableEntry, licenseIssueNumber=licenseIssueNumber, subbandHighestFrequency=subbandHighestFrequency, dNSServerTable=dNSServerTable, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, hTTPAccessEnabled=hTTPAccessEnabled, bootVersion=bootVersion, linkLossLinked=linkLossLinked, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dNSServerInternetAddressType=dNSServerInternetAddressType, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dfsPeaks=dfsPeaks, reset=reset, licenseIEEE1588Support=licenseIEEE1588Support, tDDControlGroup=tDDControlGroup, authorizationControlTable=authorizationControlTable, mABHoldoffPeriod=mABHoldoffPeriod, licenseEncryption=licenseEncryption, dNSGroup=dNSGroup, hTTPPortNumber=hTTPPortNumber, notificationsGroup=notificationsGroup, dNSServerTableIndex=dNSServerTableIndex, daylightSaving=daylightSaving, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPVersion=iPVersion, portAllocationMismatchLinked=portAllocationMismatchLinked, subbandLowestFrequency=subbandLowestFrequency, alarmInstancedTableIndex=alarmInstancedTableIndex, whitelistRMMacAddress=whitelistRMMacAddress, remoteInternetAddressType=remoteInternetAddressType, sMTPServerPortNumber=sMTPServerPortNumber, alarms=alarms, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, targetRange=targetRange, phyControlInstancedTableEntry=phyControlInstancedTableEntry, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sNMPPortNumber=sNMPPortNumber, alarmsGroup=alarmsGroup, sNMPTrapVersion=sNMPTrapVersion, cableDiagnosticsControl=cableDiagnosticsControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsTableIndex=dfsTableIndex, licenseGroup=licenseGroup, userTable=userTable, dSCPManagementPriority=dSCPManagementPriority, secureModeAlarm=secureModeAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dNS=dNS, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, blacklistRMMacAddress=blacklistRMMacAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, erroredSeconds=erroredSeconds, transmitPowerLinked=transmitPowerLinked, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, authorizationControlTableNumber=authorizationControlTableNumber, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, deviceESN=deviceESN, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDMChannelLoopback=tDMChannelLoopback, sNMPv3Enable=sNMPv3Enable, sFPError=sFPError, receiveDataRate=receiveDataRate, authorizationControlGroup=authorizationControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, iPDSCPPriorityTable=iPDSCPPriorityTable, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, auxPortSyncERxStatus=auxPortSyncERxStatus, portAllocationMismatch=portAllocationMismatch, transmitChannel=transmitChannel, syncETrackingState=syncETrackingState, transmitDataRate=transmitDataRate, dNSServerTableNumber=dNSServerTableNumber, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, channelBandwidth=channelBandwidth, phyControlInstancedTable=phyControlInstancedTable, licenseOOBManagementSupport=licenseOOBManagementSupport, linkName=linkName, encryption=encryption, cableDiagnosticsResultTable=cableDiagnosticsResultTable, PYSNMP_MODULE_ID=cambium, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseSFPPortSupport=licenseSFPPortSupport, auxPortQLTx=auxPortQLTx, auxPortStatus=auxPortStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tDDControl=tDDControl, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sntpGroup=sntpGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, productVariant=productVariant, ptp670=ptp670, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseGasGroup=licenseGasGroup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPErrorTrap=sFPErrorTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, range=range, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, ptp=ptp, oOBPriorityQueueMapping=oOBPriorityQueueMapping, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, phyStatusGroup=phyStatusGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mABProtocolVLANPriority=mABProtocolVLANPriority, syslogClientTrap=syslogClientTrap, aggregateDataRateLinked=aggregateDataRateLinked, mABState=mABState, ethernetGroup=ethernetGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, auxPortQLRx=auxPortQLRx)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", configuration=configuration, phyControlInstancedTableNumber=phyControlInstancedTableNumber, transmitFreqMHz=transmitFreqMHz, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, wirelessLinkAvailability=wirelessLinkAvailability, mainPSUPortQLRx=mainPSUPortQLRx, userTableIndex=userTableIndex, ethernetPriorityTable=ethernetPriorityTable, tFTPClient=tFTPClient, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, receivePowerLinked=receivePowerLinked, telnetPortNumber=telnetPortNumber, signalStrengthRatio=signalStrengthRatio, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, cableDiagnostics=cableDiagnostics, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableDiagPair4Distance=cableDiagPair4Distance, blacklistRMEnabled=blacklistRMEnabled, searchStateLinked=searchStateLinked, sNTPPrimaryServer=sNTPPrimaryServer, syslogClient=syslogClient, ptpGroups=ptpGroups, configurationInstancedTable=configurationInstancedTable, lowestDataModulationMode=lowestDataModulationMode, ethernetInstancedTableEntry=ethernetInstancedTableEntry, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, dfsTable=dfsTable, transparentClock=transparentClock, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, deviceMSN=deviceMSN, sNTPServerTableNumber=sNTPServerTableNumber, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, authorizationMethod=authorizationMethod, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sFPPortSyncERxStatus=sFPPortSyncERxStatus, l2CPPriorityTable=l2CPPriorityTable, cambium=cambium, syslogState=syslogState, cableDiagPair3Results=cableDiagPair3Results, auxPortConfigurationMismatch=auxPortConfigurationMismatch, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tdmTable=tdmTable, unitOutOfCalibration=unitOutOfCalibration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cableDiagPair4Results=cableDiagPair4Results, extendedSpectrumScanning=extendedSpectrumScanning, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, licenseGroupAccess=licenseGroupAccess, enableTransmission=enableTransmission, remoteInternetAddress=remoteInternetAddress, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, dNSServerTableEntry=dNSServerTableEntry, receiveFreqKHz=receiveFreqKHz, wirelessOutEthernetOctets=wirelessOutEthernetOctets, supplementary=supplementary, installStatusLinked=installStatusLinked, phyControlGroup=phyControlGroup, productName=productName, accessMethod=accessMethod, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sFPPortDisabledWarning=sFPPortDisabledWarning, smtpGroup=smtpGroup, systemClock=systemClock, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, hardwareVersion=hardwareVersion, dfs=dfs, tDMChannelStatusTrap=tDMChannelStatusTrap, unitIdentification=unitIdentification, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, receiveChannel=receiveChannel, alarmInstancedTableEntry=alarmInstancedTableEntry, transmitPower=transmitPower, subnetMask=subnetMask, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseCapacity=licenseCapacity, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, eIRP=eIRP, dNSServerPortNumber=dNSServerPortNumber, sntp=sntp, cableLoss=cableLoss, portAllocationMismatchTrap=portAllocationMismatchTrap, configurationInstancedTableNumber=configurationInstancedTableNumber, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseInstancedTable=licenseInstancedTable, apc=apc, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyInstancedStatusTable=phyInstancedStatusTable, transmitterChannels=transmitterChannels, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, ethernetInstancedTableNumber=ethernetInstancedTableNumber, dfsTableNumber=dfsTableNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, remoteMACAddressLinked=remoteMACAddressLinked, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDM=tDM, dNSPrimaryServer=dNSPrimaryServer, license=license, smtp=smtp, userPassword=userPassword, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mgmtInstancedTableIndex=mgmtInstancedTableIndex, frequencyVariant=frequencyVariant, rawReceivePowerLinked=rawReceivePowerLinked, cableDiagPair1Distance=cableDiagPair1Distance, ethernetStatisticsTable=ethernetStatisticsTable, nIDULanPortAutoMdix=nIDULanPortAutoMdix, dNSResolver=dNSResolver, syncETracking=syncETracking, useVLANForMABProtocol=useVLANForMABProtocol, receivePower=receivePower, cableDiagPair3Distance=cableDiagPair3Distance, tDMChannelStatus=tDMChannelStatus, sNTPServerRetries=sNTPServerRetries, licenseRegulatoryBandsList=licenseRegulatoryBandsList, rxColorCode=rxColorCode, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, remoteUnitName=remoteUnitName, ptmp=ptmp, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sFPPortQLTx=sFPPortQLTx, userEnabled=userEnabled, dataBridgingStatus=dataBridgingStatus, apcGroup=apcGroup, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, lowestTDMModulationMode=lowestTDMModulationMode, vectorErrorLinked=vectorErrorLinked, remoteMACAddress=remoteMACAddress, tDMGroup=tDMGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerTimeout=sNTPServerTimeout, mainPSUPortAllocation=mainPSUPortAllocation, unitName=unitName, encryptionGroup=encryptionGroup, licenseBandwidthCap=licenseBandwidthCap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, supplementaryGroup=supplementaryGroup, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userTableEntry=userTableEntry, installStatus=installStatus, unavailableSeconds=unavailableSeconds, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNTPServerInternetAddress=sNTPServerInternetAddress, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, aAAControlGroup=aAAControlGroup, routerProtocolsGroup=routerProtocolsGroup, wirelessOutOctets=wirelessOutOctets, sNTPServerPortNumber=sNTPServerPortNumber, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, searchState=searchState, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, capacityVariantMismatchTrap=capacityVariantMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitDataRateLinked=transmitDataRateLinked, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ptpTraps=ptpTraps, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortPauseFrames=dataPortPauseFrames, capacityVariantMismatchLinked=capacityVariantMismatchLinked, cableDiagPair1Results=cableDiagPair1Results, sMTPServerInternetAddress=sMTPServerInternetAddress, tDDSynchronizationMode=tDDSynchronizationMode, mgmtInstancedTable=mgmtInstancedTable, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseVersion=licenseVersion, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tDMInterfaceControl=tDMInterfaceControl, userRole=userRole, cableDiagnosticsGroup=cableDiagnosticsGroup, authorizationControlTableIndex=authorizationControlTableIndex, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, packetsToInternalStack=packetsToInternalStack, pubStatsGroup=pubStatsGroup, cableDiagnosticsWarning=cableDiagnosticsWarning, longitude=longitude, licenseSyncESupport=licenseSyncESupport, bridge=bridge, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, linkLoss=linkLoss, userName=userName, userTableNumber=userTableNumber, capacityVariantMismatch=capacityVariantMismatch, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, routerProtocols=routerProtocols, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, secureModeAlarmTrap=secureModeAlarmTrap, wirelessOutAllOctets=wirelessOutAllOctets, sNTPSyncTrap=sNTPSyncTrap, syslogControl=syslogControl, sFPPortStatus=sFPPortStatus, alarmInstancedTableNumber=alarmInstancedTableNumber, resetGroup=resetGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ethernetInstancedTableIndex=ethernetInstancedTableIndex, vLANManagementPriority=vLANManagementPriority, syncEEquipmentClock=syncEEquipmentClock, phyControlInstancedTableIndex=phyControlInstancedTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, receiveModulationMode=receiveModulationMode, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, siteName=siteName, cableDiagPair2Results=cableDiagPair2Results, licenseTrialPeriod=licenseTrialPeriod, transmitModulationModeLinked=transmitModulationModeLinked, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANManagementVID=vLANManagementVID, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, byteErrorRatio=byteErrorRatio, regulatoryBandTrap=regulatoryBandTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, iPv4Address=iPv4Address, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, dfsMeans=dfsMeans, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, cableDiagnosticsPorts=cableDiagnosticsPorts, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, vectorError=vectorError, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, softwareVersion=softwareVersion, pubStats=pubStats, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, dataBridgingAvailability=dataBridgingAvailability, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, licenseIPv6Support=licenseIPv6Support, auxPortAllocation=auxPortAllocation, mABNominalModulationMode=mABNominalModulationMode, licenseRARSupport=licenseRARSupport, aggregateDataRate=aggregateDataRate, hCMPMaximumLinkRange=hCMPMaximumLinkRange, tDDSynchronizationStatus=tDDSynchronizationStatus, sFPPortStatusTrap=sFPPortStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerStatus=sNTPServerStatus, regulatoryBand=regulatoryBand, sNTPSync=sNTPSync, configurationGroup=configurationGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sFPPortAutoMdix=sFPPortAutoMdix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDMInterfaceStatus=tDMInterfaceStatus, mgmtInstancedTableNumber=mgmtInstancedTableNumber, transmitModulationMode=transmitModulationMode, sFPPortAutoNegotiation=sFPPortAutoNegotiation, management=management, tFTPServerPortNumber=tFTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, ptpCompliance=ptpCompliance, phyControl=phyControl, mainPSUPortStatus=mainPSUPortStatus, targetMACAddress=targetMACAddress, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, maximumNumberOfSlaves=maximumNumberOfSlaves, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, rangingMode=rangingMode, linkModeOptimization=linkModeOptimization, licenseHCMPSupport=licenseHCMPSupport, wirelessTopology=wirelessTopology, receiveFreqMHz=receiveFreqMHz, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, phyStatus=phyStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, sMTPEmailAlert=sMTPEmailAlert, tDMChannelLineCode=tDMChannelLineCode, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sFPPortSSMTx=sFPPortSSMTx, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, receiveModulationModeLinked=receiveModulationModeLinked, configurationInstancedTableEntry=configurationInstancedTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, qOSPriorityScheme=qOSPriorityScheme, sFPPortQLRx=sFPPortQLRx, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, iPv6PrefixLength=iPv6PrefixLength, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, managementGroup=managementGroup, timeZone=timeZone, byteErrorRatioLinked=byteErrorRatioLinked, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber)
