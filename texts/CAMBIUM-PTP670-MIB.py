...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", rangeLinked=rangeLinked, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, phyControlInstancedTableIndex=phyControlInstancedTableIndex, licenseGroupAccess=licenseGroupAccess, receiveDataRate=receiveDataRate, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, signalStrengthRatio=signalStrengthRatio, linkLossLinked=linkLossLinked, tDDControl=tDDControl, incompatibleRegulatoryBands=incompatibleRegulatoryBands, ptp670=ptp670, tDMGroup=tDMGroup, tdmTableNumber=tdmTableNumber, targetMACAddress=targetMACAddress, ethernetInstancedTable=ethernetInstancedTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, routerProtocols=routerProtocols, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sFPPortStatusTrap=sFPPortStatusTrap, remoteMACAddressLinked=remoteMACAddressLinked, wirelessLinkStatus=wirelessLinkStatus, maximumTransmitPower=maximumTransmitPower, mABNominalTransmitCapacity=mABNominalTransmitCapacity, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, unitOutOfCalibration=unitOutOfCalibration, sNMPCommunityString=sNMPCommunityString, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, secondarySoftwareVersion=secondarySoftwareVersion, encryptionGroup=encryptionGroup, alarmInstancedTable=alarmInstancedTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataBridgingStatus=dataBridgingStatus, byteErrorRatio=byteErrorRatio, dNSServerTableNumber=dNSServerTableNumber, wirelessTopology=wirelessTopology, phyControl=phyControl, syncEEquipmentClock=syncEEquipmentClock, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPServerStatus=sNTPServerStatus, cableDiagPair2Distance=cableDiagPair2Distance, ethernetInstancedTableIndex=ethernetInstancedTableIndex, license=license, regulatoryBandTrap=regulatoryBandTrap, licenseSFPPortSupport=licenseSFPPortSupport, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, mABState=mABState, licenseInstancedTableEntry=licenseInstancedTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, licenseEncryption=licenseEncryption, l2CPPriorityTableIndex=l2CPPriorityTableIndex, unitIdentification=unitIdentification, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, transparentClock=transparentClock, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, cableDiagPair2Results=cableDiagPair2Results, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, signalStrengthRatioLinked=signalStrengthRatioLinked, tdmTableEntry=tdmTableEntry, installArmStateTrap=installArmStateTrap, receivePower=receivePower, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, transmitChannel=transmitChannel, timeZone=timeZone, authorizationControlTableEntry=authorizationControlTableEntry, transmitModulationModeLinked=transmitModulationModeLinked, tDMEnabledChannels=tDMEnabledChannels, mABProtocolVLANPriority=mABProtocolVLANPriority, transparentClockPort=transparentClockPort, sNTPPrimaryServer=sNTPPrimaryServer, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPSyncTrap=sNTPSyncTrap, nIDULanPortStatus=nIDULanPortStatus, sFPErrorTrap=sFPErrorTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, authorizationControlGroup=authorizationControlGroup, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tDDControlGroup=tDDControlGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, userName=userName, dNSResolver=dNSResolver, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, aggregateDataRate=aggregateDataRate, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, managementGroup=managementGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, systemClock=systemClock, transparentClockVID=transparentClockVID, sNTPServerTableNumber=sNTPServerTableNumber, licenseSyncESupport=licenseSyncESupport, alarmInstancedTableNumber=alarmInstancedTableNumber, licenseIEEE1588Support=licenseIEEE1588Support, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, aAAControl=aAAControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, regulatoryBand=regulatoryBand, ethernet=ethernet, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNTPLastSync=sNTPLastSync, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, productVariant=productVariant, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, configuration=configuration, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTimeout=sNTPServerTimeout, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDMConfigurationMismatch=tDMConfigurationMismatch, tFTPServerInternetAddress=tFTPServerInternetAddress, antennaGain=antennaGain, sNMPTrapInternetAddress=sNMPTrapInternetAddress, mainPSUPortStatus=mainPSUPortStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseIPv6Support=licenseIPv6Support, mainPSUPortSSMTx=mainPSUPortSSMTx, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, ptmp=ptmp, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, alarmsGroup=alarmsGroup, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, apcGroup=apcGroup, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, sFPPortQLTx=sFPPortQLTx, portAllocationMismatchTrap=portAllocationMismatchTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, dNSServerPortNumber=dNSServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, tDMInterfaceControl=tDMInterfaceControl, cableDiagPair1Distance=cableDiagPair1Distance, syncETracking=syncETracking, supplementary=supplementary, receivePowerLinked=receivePowerLinked, bootVersion=bootVersion, deviceMSN=deviceMSN, syslogControlGroup=syslogControlGroup, sNTPPollInterval=sNTPPollInterval, sNTPServerTableIndex=sNTPServerTableIndex, mABProtocolVID=mABProtocolVID, tDMChannelCableLength=tDMChannelCableLength, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, userTableEntry=userTableEntry, sMTPEmailAlert=sMTPEmailAlert, snmpControlGroup=snmpControlGroup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, ptpTraps=ptpTraps, sNTPServerTable=sNTPServerTable, rxColorCode=rxColorCode, dataPortPauseFrames=dataPortPauseFrames, ptpCompliance=ptpCompliance, tFTPClient=tFTPClient, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, dataBridgingAvailability=dataBridgingAvailability, alarms=alarms, blacklistRMEnabled=blacklistRMEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, portAllocationMismatch=portAllocationMismatch, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, antennaSelection=antennaSelection, licenseInstancedTableIndex=licenseInstancedTableIndex, syncESlavePort=syncESlavePort, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sFPPortAllocation=sFPPortAllocation, wirelessLinkStatusLinked=wirelessLinkStatusLinked, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mgmtInstancedTableIndex=mgmtInstancedTableIndex, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsTableIndex=dfsTableIndex, licenseCapacity=licenseCapacity, dfs=dfs, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, daylightSaving=daylightSaving, sFPPortDisabledWarning=sFPPortDisabledWarning, syslogClient=syslogClient, maxLinkRangeExceeded=maxLinkRangeExceeded, systemReset=systemReset, unavailableSeconds=unavailableSeconds, ptpTrapPrefix=ptpTrapPrefix, reset=reset, mABMaintenanceLevel=mABMaintenanceLevel, ethernetPriorityTable=ethernetPriorityTable, sFPPortSSMTx=sFPPortSSMTx, ethernetPriorityTableNumber=ethernetPriorityTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, userRole=userRole, whitelistRMEnabled=whitelistRMEnabled, licenseIssueNumber=licenseIssueNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, notificationsGroup=notificationsGroup, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, alarmInstancedTableIndex=alarmInstancedTableIndex, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mgmtInstancedTableNumber=mgmtInstancedTableNumber, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, rangingMode=rangingMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseGroup=licenseGroup, tdmTable=tdmTable, dfsTableNumber=dfsTableNumber, longitude=longitude, nIDULanPortStatusTrap=nIDULanPortStatusTrap, dNSServerTableEntry=dNSServerTableEntry, wirelessOutEthernetOctets=wirelessOutEthernetOctets, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, maximumNumberOfSlaves=maximumNumberOfSlaves, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, iPv4Address=iPv4Address, auxPortQLRx=auxPortQLRx, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, searchStateLinked=searchStateLinked, syslogClientTrap=syslogClientTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, remoteInternetAddressType=remoteInternetAddressType, cableDiagnosticsControl=cableDiagnosticsControl, mainPSUPortAllocation=mainPSUPortAllocation, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataBridgingStatusAlarm=dataBridgingStatusAlarm, licenseTDDSyncSupport=licenseTDDSyncSupport, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortAllocation=auxPortAllocation, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDM=tDM, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseRARSupport=licenseRARSupport, packetsToInternalStack=packetsToInternalStack, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, management=management, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessOutAllOctets=wirelessOutAllOctets, userPassword=userPassword, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, routerProtocolsGroup=routerProtocolsGroup, alarmInstancedTableEntry=alarmInstancedTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, lbtDetectedTrap=lbtDetectedTrap, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, receiveFreqMHz=receiveFreqMHz, sntp=sntp, transmitModulationMode=transmitModulationMode, dNSServerTableIndex=dNSServerTableIndex, mABHoldoffPeriod=mABHoldoffPeriod, sNMPv3Enable=sNMPv3Enable, productName=productName, transparentClockVLAN=transparentClockVLAN, aAAControlGroup=aAAControlGroup, licenseSecurityLevel=licenseSecurityLevel, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, deviceMACAddress=deviceMACAddress, dfsPeaks=dfsPeaks, lowestTDMModulationMode=lowestTDMModulationMode, syslogStateTrap=syslogStateTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, vectorErrorLinked=vectorErrorLinked, receiveModulationMode=receiveModulationMode, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, dNSServerTable=dNSServerTable, eIRP=eIRP, sNMPTrapTableNumber=sNMPTrapTableNumber, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, searchState=searchState, licenseHCMPSupport=licenseHCMPSupport, blacklistRMMacAddress=blacklistRMMacAddress, hCMPLinkSymmetry=hCMPLinkSymmetry, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, lowestDataModulationMode=lowestDataModulationMode, transmitPowerLinked=transmitPowerLinked, ethernetStatisticsTable=ethernetStatisticsTable, ptpGroups=ptpGroups, subnetMask=subnetMask, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseVersion=licenseVersion, licenseMaxLinkRange=licenseMaxLinkRange, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sNMPTrapTable=sNMPTrapTable, linkSymmetry=linkSymmetry, iPv6GatewayAddress=iPv6GatewayAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkName=linkName, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, resetGroup=resetGroup, vectorError=vectorError, sNMPTrapPortNumber=sNMPTrapPortNumber, capacityVariantMismatch=capacityVariantMismatch, mABTransmissionInterval=mABTransmissionInterval, sFPPortQLRx=sFPPortQLRx, sNTPServerRetries=sNTPServerRetries, tDMChannelStatus=tDMChannelStatus, sNMPEnabledTraps=sNMPEnabledTraps, receiveChannel=receiveChannel, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNTPServerInternetAddressType=sNTPServerInternetAddressType, versions=versions, wirelessLinkAvailability=wirelessLinkAvailability, enabledDiagnosticAlarms=enabledDiagnosticAlarms, auxPortAcceptedQLRx=auxPortAcceptedQLRx, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, linkModeOptimization=linkModeOptimization, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, dNSGroup=dNSGroup, cambium=cambium, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, dfsTable=dfsTable, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, smtp=smtp, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userTableIndex=userTableIndex, cableDiagnosticsResultTable=cableDiagnosticsResultTable, auxPortSSMTx=auxPortSSMTx, rawReceivePower=rawReceivePower, cableDiagPair4Distance=cableDiagPair4Distance, encryption=encryption, gatewayIPAddress=gatewayIPAddress, bridge=bridge, syslogControl=syslogControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mgmtInstancedTable=mgmtInstancedTable, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyInstancedStatusTable=phyInstancedStatusTable, phyStatus=phyStatus, useVLANForMABProtocol=useVLANForMABProtocol, configurationInstancedTableNumber=configurationInstancedTableNumber, hTTPSPortNumber=hTTPSPortNumber, versionsGroup=versionsGroup, enableTransmission=enableTransmission, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mainPSUPortQLRx=mainPSUPortQLRx, remoteInternetAddressLinked=remoteInternetAddressLinked, ethernetStatisticsDataSource=ethernetStatisticsDataSource, installArmState=installArmState, licenseRegulatoryBandsList=licenseRegulatoryBandsList, wirelessOutOctets=wirelessOutOctets, latitude=latitude, l2CPPriorityTable=l2CPPriorityTable, byteErrorRatioLinked=byteErrorRatioLinked, sFPError=sFPError, accessMethod=accessMethod, encryptionAlgorithm=encryptionAlgorithm, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sFPPortAutoMdix=sFPPortAutoMdix, cableDiagnostics=cableDiagnostics, ptp=ptp, userEnabled=userEnabled, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, channelChangeTrap=channelChangeTrap, iPv6Address=iPv6Address, dfsGroup=dfsGroup, telnetPortNumber=telnetPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, tDDSynchronizationStatus=tDDSynchronizationStatus, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, authorizationControl=authorizationControl, erroredSeconds=erroredSeconds, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, pubStatsGroup=pubStatsGroup, authorizationControlTableNumber=authorizationControlTableNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, siteName=siteName, frequencyVariant=frequencyVariant, groupID=groupID, licenseInstancedTableNumber=licenseInstancedTableNumber, auxPortStatus=auxPortStatus, tDMChannelStatusTrap=tDMChannelStatusTrap, authorizationMethod=authorizationMethod, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sNMPTrapVersion=sNMPTrapVersion, pubInstancedStatsTable=pubInstancedStatsTable, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControl=snmpControl, licenseUnitSerialNumber=licenseUnitSerialNumber, PYSNMP_MODULE_ID=cambium, configurationInstancedTable=configurationInstancedTable, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, auxPortStatusTrap=auxPortStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, localPacketFiltering=localPacketFiltering, rawReceivePowerLinked=rawReceivePowerLinked, sNMPTrapTableIndex=sNMPTrapTableIndex, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sFPPortStatus=sFPPortStatus, mainPSUPortQLTx=mainPSUPortQLTx, remoteUnitNameLinked=remoteUnitNameLinked, qOSPriorityScheme=qOSPriorityScheme, licenseInstancedTable=licenseInstancedTable, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseTLSRekey=licenseTLSRekey, remoteMACAddress=remoteMACAddress, sMTPEnabledMessages=sMTPEnabledMessages, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, dNSServerInternetAddressType=dNSServerInternetAddressType, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, installStatus=installStatus, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sntpGroup=sntpGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDMChannelLoopback=tDMChannelLoopback, licenseOOBManagementSupport=licenseOOBManagementSupport, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, hCMPMaximumLinkRange=hCMPMaximumLinkRange, userTableNumber=userTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteUnitName=remoteUnitName, whitelistRMMacAddress=whitelistRMMacAddress, cableDiagPair1Results=cableDiagPair1Results, secureModeAlarmTrap=secureModeAlarmTrap, cableDiagPair4Results=cableDiagPair4Results, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, installStatusTrap=installStatusTrap, cableLoss=cableLoss, dNS=dNS, ethernetGroup=ethernetGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, range=range, sNMPPortNumber=sNMPPortNumber, transmitFreqKHz=transmitFreqKHz, configurationInstancedTableEntry=configurationInstancedTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, transmitFreqMHz=transmitFreqMHz, authorizationControlTable=authorizationControlTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPSync=sNTPSync, iPv6PrefixLength=iPv6PrefixLength, hardwareVersion=hardwareVersion, deviceESN=deviceESN, pubStats=pubStats, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, cableDiagPair3Results=cableDiagPair3Results, licenseCountry=licenseCountry, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, phyStatusGroup=phyStatusGroup, secureModeAlarm=secureModeAlarm, tDMInterfaceStatus=tDMInterfaceStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, subbandLowestFrequency=subbandLowestFrequency, extendedSpectrumScanning=extendedSpectrumScanning, unitIdentificationGroup=unitIdentificationGroup, smtpGroup=smtpGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, portAllocationMismatchLinked=portAllocationMismatchLinked, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitterChannels=transmitterChannels, txColorCode=txColorCode, auxPortSyncERxStatus=auxPortSyncERxStatus, syslogState=syslogState, targetRange=targetRange, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, receiveFreqKHz=receiveFreqKHz, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseGasGroup=licenseGasGroup, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, iPVersion=iPVersion, installationMode=installationMode, auxPortQLTx=auxPortQLTx, receiveModulationModeDetail=receiveModulationModeDetail, cableDiagPair3Distance=cableDiagPair3Distance, dfsTableEntry=dfsTableEntry, tdmTableIndex=tdmTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", receiveDataRateLinked=receiveDataRateLinked, linkLoss=linkLoss, phyControlGroup=phyControlGroup, bridgeGroup=bridgeGroup, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, installStatusLinked=installStatusLinked, auxPortDisabledWarning=auxPortDisabledWarning, vLANManagementPriority=vLANManagementPriority, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, dSCPManagementPriority=dSCPManagementPriority, tDMChannelLineCode=tDMChannelLineCode, licenseBandwidthCap=licenseBandwidthCap, dfsMeans=dfsMeans, telnetAccessEnabled=telnetAccessEnabled, licenseTrialPeriod=licenseTrialPeriod, mABNominalModulationMode=mABNominalModulationMode, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, packetsFromInternalStack=packetsFromInternalStack, masterSlaveMode=masterSlaveMode, transmitPower=transmitPower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, subbandHighestFrequency=subbandHighestFrequency, remoteInternetAddress=remoteInternetAddress, aggregateDataRateLinked=aggregateDataRateLinked, configurationGroup=configurationGroup, altitude=altitude, dNSServerInternetAddress=dNSServerInternetAddress, channelBandwidth=channelBandwidth, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, dNSPrimaryServer=dNSPrimaryServer, transmitDataRate=transmitDataRate, unitName=unitName, sNTPState=sNTPState, configurationInstancedTableIndex=configurationInstancedTableIndex, userTable=userTable, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, cableDiagnosticsPorts=cableDiagnosticsPorts, vLANManagementVID=vLANManagementVID, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, txMABFrames=txMABFrames, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, hTTPPortNumber=hTTPPortNumber, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, syncETrackingState=syncETrackingState, authorizationControlTableIndex=authorizationControlTableIndex, receiveModulationModeLinked=receiveModulationModeLinked, transmitDataRateLinked=transmitDataRateLinked, severelyErroredSeconds=severelyErroredSeconds, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tempPcb=tempPcb, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, apc=apc, dataBridgingStatusLinked=dataBridgingStatusLinked, phyControlInstancedTable=phyControlInstancedTable)
