...
Bits, TimeTicks, Gauge32, ObjectIdentity, MibIdentifier, Integer32, Unsigned32, ModuleIdentity, enterprises, iso, Counter32, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Gauge32", "ObjectIdentity", "MibIdentifier", "Integer32", "Unsigned32", "ModuleIdentity", "enterprises", "iso", "Counter32", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, pubInstancedStatsTable=pubInstancedStatsTable, versionsGroup=versionsGroup, syncETrackingState=syncETrackingState, capacityVariantMismatchLinked=capacityVariantMismatchLinked, targetRange=targetRange, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenseIEEE1588Support=licenseIEEE1588Support, transmitModulationMode=transmitModulationMode, mABProtocolVLANPriority=mABProtocolVLANPriority, wirelessLinkStatus=wirelessLinkStatus, aggregateDataRateLinked=aggregateDataRateLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, tDMGroup=tDMGroup, userRole=userRole, deviceMSN=deviceMSN, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sMTPEnabledMessages=sMTPEnabledMessages, subbandHighestFrequency=subbandHighestFrequency, transmitFreqKHz=transmitFreqKHz, sNTPServerTable=sNTPServerTable, dNSServerTableIndex=dNSServerTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, userTableEntry=userTableEntry, syncEEquipmentClock=syncEEquipmentClock, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, ptpTraps=ptpTraps, apcGroup=apcGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, unitOutOfCalibration=unitOutOfCalibration, unitIdentification=unitIdentification, tDDSynchronizationStatus=tDDSynchronizationStatus, unavailableSeconds=unavailableSeconds, smtpGroup=smtpGroup, routerProtocols=routerProtocols, packetsToInternalStack=packetsToInternalStack, gatewayIPAddress=gatewayIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userPassword=userPassword, authorizationControlGroup=authorizationControlGroup, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, severelyErroredSeconds=severelyErroredSeconds, transparentClockVID=transparentClockVID, dNSServerTableEntry=dNSServerTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveChannel=receiveChannel, telnetPortNumber=telnetPortNumber, linkLoss=linkLoss, sFPPortQLRx=sFPPortQLRx, portAllocationMismatchLinked=portAllocationMismatchLinked, auxPortAcceptedQLRx=auxPortAcceptedQLRx, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseBandwidthCap=licenseBandwidthCap, vectorError=vectorError, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortStatusTrap=mainPSUPortStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, txColorCode=txColorCode, rawReceivePower=rawReceivePower, alarmInstancedTable=alarmInstancedTable, sFPPortSSMTx=sFPPortSSMTx, licenseTDDSyncSupport=licenseTDDSyncSupport, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, unitIdentificationGroup=unitIdentificationGroup, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, receiveDataRate=receiveDataRate, sNMPTrapTable=sNMPTrapTable, portAllocationMismatchTrap=portAllocationMismatchTrap, sNTPServerStatus=sNTPServerStatus, maximumTransmitPower=maximumTransmitPower, installationMode=installationMode, configuration=configuration, phyStatus=phyStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, tDMChannelLoopback=tDMChannelLoopback, pubStats=pubStats, lbtDetectedTrap=lbtDetectedTrap, sNTPServerTimeout=sNTPServerTimeout, encryptionGroup=encryptionGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, softwareVersion=softwareVersion, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, iPv4Address=iPv4Address, maxLinkRangeExceeded=maxLinkRangeExceeded, sNMPPortNumber=sNMPPortNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, versions=versions, apc=apc, mgmtInstancedTableIndex=mgmtInstancedTableIndex, channelBandwidth=channelBandwidth, licenseInstancedTableIndex=licenseInstancedTableIndex, mainPSUPortStatus=mainPSUPortStatus, tDMInterfaceControl=tDMInterfaceControl, regulatoryBand=regulatoryBand, incompatibleRegulatoryBands=incompatibleRegulatoryBands, ethernetPriorityTableIndex=ethernetPriorityTableIndex, txMABFrames=txMABFrames, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, hTTPPortNumber=hTTPPortNumber, sNTPState=sNTPState, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, dfsTable=dfsTable, wirelessOutAllOctets=wirelessOutAllOctets, remoteMACAddressLinked=remoteMACAddressLinked, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sFPPortAutoNegotiation=sFPPortAutoNegotiation, siteName=siteName, dNSServerTable=dNSServerTable, sFPPortStatus=sFPPortStatus, latitude=latitude, sNTPPrimaryServer=sNTPPrimaryServer, secondarySoftwareVersion=secondarySoftwareVersion, hTTPSPortNumber=hTTPSPortNumber, systemClock=systemClock, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, transmitChannel=transmitChannel, sMTPEmailAlert=sMTPEmailAlert, phyStatusGroup=phyStatusGroup, ethernetInstancedTable=ethernetInstancedTable, mainPSUPortSSMTx=mainPSUPortSSMTx, ethernetInstancedTableEntry=ethernetInstancedTableEntry, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseInstancedTableNumber=licenseInstancedTableNumber, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, blacklistRMEnabled=blacklistRMEnabled, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, userTableIndex=userTableIndex, nIDULanPortStatus=nIDULanPortStatus, searchStateLinked=searchStateLinked, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, reset=reset, sFPPortDisabledWarning=sFPPortDisabledWarning, tDM=tDM, dfsPeaks=dfsPeaks, whitelistRMMacAddress=whitelistRMMacAddress, antennaGain=antennaGain, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessOutOctets=wirelessOutOctets, authorizationControl=authorizationControl, authorizationControlTable=authorizationControlTable, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aAAControl=aAAControl, dataBridgingStatusLinked=dataBridgingStatusLinked, range=range, whitelistRMEnabled=whitelistRMEnabled, installArmStateTrap=installArmStateTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, routerProtocolsGroup=routerProtocolsGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, targetMACAddress=targetMACAddress, installStatus=installStatus, byteErrorRatioLinked=byteErrorRatioLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, iPv6Address=iPv6Address, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, snmpControlGroup=snmpControlGroup, lowestTDMModulationMode=lowestTDMModulationMode, productVariant=productVariant, linkModeOptimization=linkModeOptimization, capacityVariantMismatchTrap=capacityVariantMismatchTrap, auxPortAllocation=auxPortAllocation, supplementary=supplementary, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessOutEthernetOctets=wirelessOutEthernetOctets, deviceESN=deviceESN, managementGroup=managementGroup, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, licenseSFPPortSupport=licenseSFPPortSupport, mABNominalModulationMode=mABNominalModulationMode, cableDiagPair3Results=cableDiagPair3Results, installStatusTrap=installStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseTLSRekey=licenseTLSRekey, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, cableDiagnosticsResultTable=cableDiagnosticsResultTable, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, auxPortQLRx=auxPortQLRx, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, installArmState=installArmState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyControl=phyControl, licenseSyncESupport=licenseSyncESupport, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, authorizationControlTableIndex=authorizationControlTableIndex, productName=productName, phyInstancedStatusTable=phyInstancedStatusTable, eIRP=eIRP, mgmtInstancedTableNumber=mgmtInstancedTableNumber, alarmInstancedTableEntry=alarmInstancedTableEntry, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNTPSyncTrap=sNTPSyncTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, managementNetworkAccessEnabled=managementNetworkAccessEnabled, configurationInstancedTable=configurationInstancedTable, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortStatusTrap=auxPortStatusTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, ptp670=ptp670, transmitDataRate=transmitDataRate, tDDControl=tDDControl, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseCountry=licenseCountry, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteInternetAddress=remoteInternetAddress, licenseMaxLinkRange=licenseMaxLinkRange, cableDiagnostics=cableDiagnostics, localPacketFiltering=localPacketFiltering, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dNSServerTableNumber=dNSServerTableNumber, iPVersion=iPVersion, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, authorizationMethod=authorizationMethod, auxPortStatus=auxPortStatus, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, vLANManagementPriority=vLANManagementPriority, sFPPortAutoMdix=sFPPortAutoMdix, linkSymmetry=linkSymmetry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPClient=tFTPClient, transparentClock=transparentClock, configurationGroup=configurationGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", aAAControlGroup=aAAControlGroup, daylightSaving=daylightSaving, transmitterChannels=transmitterChannels, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogClientTrap=syslogClientTrap, sFPPortStatusTrap=sFPPortStatusTrap, rangeLinked=rangeLinked, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, mainPSUPortAutoMdix=mainPSUPortAutoMdix, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dNSServerInternetAddress=dNSServerInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, groupID=groupID, sFPPortSyncERxStatus=sFPPortSyncERxStatus, packetsFromInternalStack=packetsFromInternalStack, dfsMeans=dfsMeans, timeZone=timeZone, sNMPEnabledTraps=sNMPEnabledTraps, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, byteErrorRatio=byteErrorRatio, cableDiagPair2Results=cableDiagPair2Results, receiveModulationModeDetail=receiveModulationModeDetail, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, regulatoryBandTrap=regulatoryBandTrap, linkName=linkName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syncETracking=syncETracking, mainPSUPortQLTx=mainPSUPortQLTx, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, extendedSpectrumScanning=extendedSpectrumScanning, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mainPSUPortAllocation=mainPSUPortAllocation, licenseGroup=licenseGroup, transmitDataRateLinked=transmitDataRateLinked, phyControlInstancedTable=phyControlInstancedTable, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseGroupAccess=licenseGroupAccess, tdmTableEntry=tdmTableEntry, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, cableDiagPair4Distance=cableDiagPair4Distance, alarmsGroup=alarmsGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userName=userName, dataPortPauseFrames=dataPortPauseFrames, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNTPServerTableEntry=sNTPServerTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, syslogState=syslogState, sNMPTrapTableEntry=sNMPTrapTableEntry, resetGroup=resetGroup, dataBridgingStatus=dataBridgingStatus, sntpGroup=sntpGroup, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, PYSNMP_MODULE_ID=cambium, licenseCapacity=licenseCapacity, sNTPServerPortNumber=sNTPServerPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseInstancedTableEntry=licenseInstancedTableEntry, dSCPManagementPriority=dSCPManagementPriority, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetStatisticsTable=ethernetStatisticsTable, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mABProtocolVID=mABProtocolVID, configurationInstancedTableEntry=configurationInstancedTableEntry, remoteInternetAddressType=remoteInternetAddressType, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, dfsTableNumber=dfsTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userTable=userTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, transmitModulationModeLinked=transmitModulationModeLinked, transparentClockVLAN=transparentClockVLAN, antennaSelection=antennaSelection, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseGasGroup=licenseGasGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, sNTPLastSync=sNTPLastSync, receivePowerLinked=receivePowerLinked, syslogStateTrap=syslogStateTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfsTableIndex=dfsTableIndex, tDMChannelStatus=tDMChannelStatus, sMTPServerPortNumber=sMTPServerPortNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, syslogClient=syslogClient, sFPPortAllocation=sFPPortAllocation, auxPortQLTx=auxPortQLTx, smtp=smtp, configurationInstancedTableIndex=configurationInstancedTableIndex, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, receiveDataRateLinked=receiveDataRateLinked, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, signalStrengthRatio=signalStrengthRatio, installStatusLinked=installStatusLinked, tFTPServerPortNumber=tFTPServerPortNumber, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sNMPTrapInternetAddress=sNMPTrapInternetAddress, cableLoss=cableLoss, tDMChannelCableLength=tDMChannelCableLength, sNTPServerTableNumber=sNTPServerTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfs=dfs, qOSPriorityScheme=qOSPriorityScheme, dfsTableEntry=dfsTableEntry, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sNMPCommunityString=sNMPCommunityString, authorizationControlTableNumber=authorizationControlTableNumber, configurationInstancedTableNumber=configurationInstancedTableNumber, tdmTable=tdmTable, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, notificationsGroup=notificationsGroup, cableDiagPair2Distance=cableDiagPair2Distance, ptmp=ptmp, receivePower=receivePower, receiveModulationModeLinked=receiveModulationModeLinked, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, deviceMACAddress=deviceMACAddress, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, tempPcb=tempPcb, userTableNumber=userTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, mgmtInstancedTable=mgmtInstancedTable, licenseRARSupport=licenseRARSupport, encryption=encryption, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transparentClockPort=transparentClockPort, subbandLowestFrequency=subbandLowestFrequency, sNMPTrapTableIndex=sNMPTrapTableIndex, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, cableDiagPair3Distance=cableDiagPair3Distance, alarmInstancedTableIndex=alarmInstancedTableIndex, dataBridgingAvailability=dataBridgingAvailability, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPv3Enable=sNMPv3Enable, lowestDataModulationMode=lowestDataModulationMode, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, hCMPMaximumLinkRange=hCMPMaximumLinkRange, hCMPLinkSymmetry=hCMPLinkSymmetry, sntp=sntp, mABTransmissionInterval=mABTransmissionInterval, transmitFreqMHz=transmitFreqMHz, longitude=longitude, syslogControlGroup=syslogControlGroup, maximumNumberOfSlaves=maximumNumberOfSlaves, tDDControlGroup=tDDControlGroup, accessMethod=accessMethod, tdmTableNumber=tdmTableNumber, bridgeGroup=bridgeGroup, erroredSeconds=erroredSeconds, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogLocalWrappedTrap=syslogLocalWrappedTrap, alarmInstancedTableNumber=alarmInstancedTableNumber, phyControlGroup=phyControlGroup, licenseIPv6Support=licenseIPv6Support, ethernet=ethernet, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, ethernetGroup=ethernetGroup, tDDSynchronizationMode=tDDSynchronizationMode, cableDiagPair4Results=cableDiagPair4Results, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, vectorErrorLinked=vectorErrorLinked, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataBridgingStatusAlarm=dataBridgingStatusAlarm, frequencyVariant=frequencyVariant, dNS=dNS, remoteInternetAddressLinked=remoteInternetAddressLinked, auxPortSyncERxStatus=auxPortSyncERxStatus, license=license, channelChangeTrap=channelChangeTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, management=management, linkLossLinked=linkLossLinked, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, auxPortSSMTx=auxPortSSMTx, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, useVLANForMABProtocol=useVLANForMABProtocol, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNTPSync=sNTPSync, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPPollInterval=sNTPPollInterval, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, subnetMask=subnetMask, transmitPowerLinked=transmitPowerLinked, sNTPServerTableIndex=sNTPServerTableIndex, receiveFreqKHz=receiveFreqKHz, mABHoldoffPeriod=mABHoldoffPeriod, nIDULanPortStatusTrap=nIDULanPortStatusTrap, masterSlaveMode=masterSlaveMode, tdmTableIndex=tdmTableIndex, cableDiagPair1Results=cableDiagPair1Results, iPv6GatewayAddress=iPv6GatewayAddress, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseVersion=licenseVersion, rawReceivePowerLinked=rawReceivePowerLinked, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteUnitNameLinked=remoteUnitNameLinked, licenseIssueNumber=licenseIssueNumber, cableDiagnosticsControl=cableDiagnosticsControl, altitude=altitude, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, portAllocationMismatch=portAllocationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseSecurityLevel=licenseSecurityLevel, snmpControl=snmpControl, licenseOOBManagementSupport=licenseOOBManagementSupport, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sFPPortQLTx=sFPPortQLTx, syncESlavePort=syncESlavePort, ptpCompliance=ptpCompliance, searchState=searchState, userEnabled=userEnabled, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, capacityVariantMismatch=capacityVariantMismatch, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, transmitPower=transmitPower, bootVersion=bootVersion, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, dNSResolver=dNSResolver, secureModeAlarm=secureModeAlarm, signalStrengthRatioLinked=signalStrengthRatioLinked, ethernetStatisticsDataSource=ethernetStatisticsDataSource, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, authorizationControlTableEntry=authorizationControlTableEntry, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseHCMPSupport=licenseHCMPSupport, phyControlInstancedTableIndex=phyControlInstancedTableIndex, unitName=unitName, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, mABMaintenanceLevel=mABMaintenanceLevel, useVLANForManagementInterfaces=useVLANForManagementInterfaces, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tDMChannelLineCode=tDMChannelLineCode, encryptionAlgorithm=encryptionAlgorithm, enableTransmission=enableTransmission)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityTable=l2CPPriorityTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, remoteUnitName=remoteUnitName, receiveFreqMHz=receiveFreqMHz, vLANManagementVID=vLANManagementVID, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, wirelessTopology=wirelessTopology, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sNTPServerRetries=sNTPServerRetries, licenseTrialPeriod=licenseTrialPeriod, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, receiveModulationMode=receiveModulationMode, dNSServerPortNumber=dNSServerPortNumber, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, dNSGroup=dNSGroup, mgmtInstancedTableEntry=mgmtInstancedTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, dfsGroup=dfsGroup, bridge=bridge, cambium=cambium, cableDiagnosticsPorts=cableDiagnosticsPorts, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseEncryption=licenseEncryption, dNSPrimaryServer=dNSPrimaryServer, iPv6PrefixLength=iPv6PrefixLength, blacklistRMMacAddress=blacklistRMMacAddress, tDMInterfaceStatus=tDMInterfaceStatus, auxPortDisabledWarning=auxPortDisabledWarning, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tDMEnabledChannels=tDMEnabledChannels, sFPError=sFPError, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, ptp=ptp, mainPSUPortQLRx=mainPSUPortQLRx, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, licenseInstancedTable=licenseInstancedTable, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, rxColorCode=rxColorCode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetInstancedTableIndex=ethernetInstancedTableIndex, systemReset=systemReset, aggregateDataRate=aggregateDataRate, hardwareVersion=hardwareVersion, rangingMode=rangingMode, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, cableDiagPair1Distance=cableDiagPair1Distance, licenseUnitSerialNumber=licenseUnitSerialNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, ptpGroups=ptpGroups, remoteMACAddress=remoteMACAddress, sFPErrorTrap=sFPErrorTrap, supplementaryGroup=supplementaryGroup, alarms=alarms, ptpTrapPrefix=ptpTrapPrefix, syslogControl=syslogControl, mABState=mABState)
