...
# Produced by pysmi-1.1.8 at Thu Jan 27 21:31:57 2022
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", vectorError=vectorError, licenseCountry=licenseCountry, receiveDataRateLinked=receiveDataRateLinked, targetMACAddress=targetMACAddress, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sFPError=sFPError, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dNSGroup=dNSGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dfsMeans=dfsMeans, pubInstancedStatsTable=pubInstancedStatsTable, searchState=searchState, timeZone=timeZone, transmitPower=transmitPower, routerProtocols=routerProtocols, mgmtInstancedTableIndex=mgmtInstancedTableIndex, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, smtpGroup=smtpGroup, ethernetInstancedTableIndex=ethernetInstancedTableIndex, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, rangingMode=rangingMode, aAAControl=aAAControl, transparentClockPort=transparentClockPort, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, tDDControl=tDDControl, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, mainPSUPortSSMTx=mainPSUPortSSMTx, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aAAControlGroup=aAAControlGroup, notificationsGroup=notificationsGroup, rxColorCode=rxColorCode, licenseGroup=licenseGroup, sFPPortQLTx=sFPPortQLTx, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, license=license, syncEEquipmentClock=syncEEquipmentClock, tFTPServerPortNumber=tFTPServerPortNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, phyStatusGroup=phyStatusGroup, configurationInstancedTable=configurationInstancedTable, mABMaintenanceLevel=mABMaintenanceLevel, packetsToInternalStack=packetsToInternalStack, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, dNSServerTableEntry=dNSServerTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelBandwidth=channelBandwidth, nIDULanPortStatus=nIDULanPortStatus, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, authorizationControl=authorizationControl, cableDiagnosticsGroup=cableDiagnosticsGroup, phyControlInstancedTableNumber=phyControlInstancedTableNumber, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, versionsGroup=versionsGroup, licenseGasGroup=licenseGasGroup, vectorErrorLinked=vectorErrorLinked, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, transmitModulationModeLinked=transmitModulationModeLinked, licenseRARSupport=licenseRARSupport, qOSPriorityScheme=qOSPriorityScheme, unitOutOfCalibration=unitOutOfCalibration, managementGroup=managementGroup, alarmInstancedTableEntry=alarmInstancedTableEntry, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, longitude=longitude, tDMInterfaceControl=tDMInterfaceControl, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, dNSServerTable=dNSServerTable, capacityVariantMismatch=capacityVariantMismatch, alarms=alarms, userTableIndex=userTableIndex, ptmp=ptmp, authorizationMethod=authorizationMethod, licenseSFPPortSupport=licenseSFPPortSupport, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPPrimaryServer=sNTPPrimaryServer, licenseTrialPeriod=licenseTrialPeriod, phyControl=phyControl, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseEncryption=licenseEncryption, auxPortSSMTx=auxPortSSMTx, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, dfsTableNumber=dfsTableNumber, sNTPServerTimeout=sNTPServerTimeout, phyStatus=phyStatus, tdmTableIndex=tdmTableIndex, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sNMPTrapTableNumber=sNMPTrapTableNumber, ptp670=ptp670, installStatusTrap=installStatusTrap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, cableDiagPair4Distance=cableDiagPair4Distance, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, unitName=unitName, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, rangeLinked=rangeLinked, auxPortDisabledWarning=auxPortDisabledWarning, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, ptpCompliance=ptpCompliance, tDMChannelLoopback=tDMChannelLoopback, unitIdentificationGroup=unitIdentificationGroup, syslogClient=syslogClient, dataPortPauseFrames=dataPortPauseFrames, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dNSServerPortNumber=dNSServerPortNumber, signalStrengthRatio=signalStrengthRatio, receiveModulationModeLinked=receiveModulationModeLinked, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, cableDiagnosticsControl=cableDiagnosticsControl, telnetPortNumber=telnetPortNumber, auxPortStatusTrap=auxPortStatusTrap, tDDSynchronizationMode=tDDSynchronizationMode, cambium=cambium, ethernetStatisticsDataSource=ethernetStatisticsDataSource, mABProtocolVLANPriority=mABProtocolVLANPriority, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, auxPortAllocation=auxPortAllocation, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, mainPSUPortQLTx=mainPSUPortQLTx, transmitPowerLinked=transmitPowerLinked, licenseIssueNumber=licenseIssueNumber, tDDControlGroup=tDDControlGroup, licenseRegulatoryBandsList=licenseRegulatoryBandsList, authorizationControlTableIndex=authorizationControlTableIndex, lowestTDMModulationMode=lowestTDMModulationMode, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, userRole=userRole, alarmInstancedTable=alarmInstancedTable, installArmState=installArmState, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, hTTPPortNumber=hTTPPortNumber, vLANManagementPriority=vLANManagementPriority, cableDiagPair4Results=cableDiagPair4Results, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cableDiagnosticsPorts=cableDiagnosticsPorts, receivePower=receivePower, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, remoteInternetAddress=remoteInternetAddress, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ethernetPriorityTable=ethernetPriorityTable, syslogControl=syslogControl, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseBandwidthCap=licenseBandwidthCap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkAvailability=wirelessLinkAvailability, remoteMACAddress=remoteMACAddress, receiveModulationMode=receiveModulationMode, subbandLowestFrequency=subbandLowestFrequency, dataBridgingStatus=dataBridgingStatus, daylightSaving=daylightSaving, transparentClock=transparentClock, licenseCapacity=licenseCapacity, portAllocationMismatch=portAllocationMismatch, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sMTPServerPortNumber=sMTPServerPortNumber, sFPPortAllocation=sFPPortAllocation, supplementaryGroup=supplementaryGroup, licenseInstancedTable=licenseInstancedTable, transmitterChannels=transmitterChannels, mABNominalModulationMode=mABNominalModulationMode, remoteUnitNameLinked=remoteUnitNameLinked, encryption=encryption, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, frequencyVariant=frequencyVariant, PYSNMP_MODULE_ID=cambium, aggregateDataRate=aggregateDataRate, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sFPPortSyncERxStatus=sFPPortSyncERxStatus, whitelistRMMacAddress=whitelistRMMacAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userEnabled=userEnabled, regulatoryBandTrap=regulatoryBandTrap, mABState=mABState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, masterSlaveMode=masterSlaveMode, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, dNSResolver=dNSResolver, alarmInstancedTableNumber=alarmInstancedTableNumber, userName=userName, mABHoldoffPeriod=mABHoldoffPeriod, encryptionAlgorithm=encryptionAlgorithm, rawReceivePowerLinked=rawReceivePowerLinked, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, linkModeOptimization=linkModeOptimization, transmitChannel=transmitChannel, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNTPServerRetries=sNTPServerRetries, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, linkLossLinked=linkLossLinked, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, userTable=userTable, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, transmitFreqMHz=transmitFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, erroredSeconds=erroredSeconds, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerTable=sNTPServerTable, blacklistRMMacAddress=blacklistRMMacAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableEntry=userTableEntry, alarmsGroup=alarmsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receivePowerLinked=receivePowerLinked, dNS=dNS, dfsTableIndex=dfsTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, byteErrorRatio=byteErrorRatio, configurationInstancedTableEntry=configurationInstancedTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, sntpGroup=sntpGroup, portAllocationMismatchTrap=portAllocationMismatchTrap, sNMPCommunityString=sNMPCommunityString, subnetMask=subnetMask, authorizationControlTableEntry=authorizationControlTableEntry, tempPcb=tempPcb, transmitDataRate=transmitDataRate, syslogState=syslogState, auxPortQLTx=auxPortQLTx, bridgeGroup=bridgeGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mgmtInstancedTableEntry=mgmtInstancedTableEntry, deviceMACAddress=deviceMACAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mABProtocolVID=mABProtocolVID, sMTPServerInternetAddressType=sMTPServerInternetAddressType, wirelessLinkStatusLinked=wirelessLinkStatusLinked, linkSymmetry=linkSymmetry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, ptpTrapPrefix=ptpTrapPrefix, mainPSUPortAllocation=mainPSUPortAllocation, syslogClientTrap=syslogClientTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", bridge=bridge, transmitFreqKHz=transmitFreqKHz, whitelistRMEnabled=whitelistRMEnabled, dNSServerInternetAddressType=dNSServerInternetAddressType, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, iPv6PrefixLength=iPv6PrefixLength, transmitModulationMode=transmitModulationMode, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, secondarySoftwareVersion=secondarySoftwareVersion, licenseOOBManagementSupport=licenseOOBManagementSupport, sNMPTrapTable=sNMPTrapTable, receiveFreqMHz=receiveFreqMHz, phyControlGroup=phyControlGroup, dataBridgingAvailability=dataBridgingAvailability, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseIPv6Support=licenseIPv6Support, sNMPEnabledTraps=sNMPEnabledTraps, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, configuration=configuration, iPv6GatewayAddress=iPv6GatewayAddress, subbandHighestFrequency=subbandHighestFrequency, remoteMACAddressLinked=remoteMACAddressLinked, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mABNominalTransmitCapacity=mABNominalTransmitCapacity, unitIdentification=unitIdentification, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, management=management, channelChangeTrap=channelChangeTrap, licenseTLSRekey=licenseTLSRekey, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, latitude=latitude, sNTPState=sNTPState, productVariant=productVariant, installArmStateTrap=installArmStateTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, syslogControlGroup=syslogControlGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseTDDSyncSupport=licenseTDDSyncSupport, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sNTPServerPortNumber=sNTPServerPortNumber, secureModeAlarm=secureModeAlarm, configurationInstancedTableIndex=configurationInstancedTableIndex, sNMPPortNumber=sNMPPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, localPacketFiltering=localPacketFiltering, tDMGroup=tDMGroup, mainPSUPortStatus=mainPSUPortStatus, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, resetGroup=resetGroup, tDMChannelCableLength=tDMChannelCableLength, wirelessTopology=wirelessTopology, oOBPriorityQueueMapping=oOBPriorityQueueMapping, enableTransmission=enableTransmission, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, systemClock=systemClock, ptp=ptp, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dfsTable=dfsTable, antennaGain=antennaGain, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, dNSServerInternetAddress=dNSServerInternetAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, cableDiagnosticsResultTable=cableDiagnosticsResultTable, ethernet=ethernet, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, alarmInstancedTableIndex=alarmInstancedTableIndex, dNSServerTableIndex=dNSServerTableIndex, remoteInternetAddressType=remoteInternetAddressType, syslogStateTrap=syslogStateTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, auxPortSyncERxStatus=auxPortSyncERxStatus, snmpControlGroup=snmpControlGroup, blacklistRMEnabled=blacklistRMEnabled, snmpControl=snmpControl, phyControlInstancedTableIndex=phyControlInstancedTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, signalStrengthRatioLinked=signalStrengthRatioLinked, sNTPServerTableEntry=sNTPServerTableEntry, installationMode=installationMode, cableDiagPair3Results=cableDiagPair3Results, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sFPPortAutoMdix=sFPPortAutoMdix, sNTPServerInternetAddress=sNTPServerInternetAddress, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, mainPSUPortQLRx=mainPSUPortQLRx, useVLANForManagementInterfaces=useVLANForManagementInterfaces, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, hardwareVersion=hardwareVersion, configurationGroup=configurationGroup, maximumTransmitPower=maximumTransmitPower, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, hCMPMaximumLinkRange=hCMPMaximumLinkRange, packetsFromInternalStack=packetsFromInternalStack, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, dfs=dfs, dfsGroup=dfsGroup, licenseUnitSerialNumber=licenseUnitSerialNumber, userPassword=userPassword, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tDMChannelLineCode=tDMChannelLineCode, tDMInterfaceStatus=tDMInterfaceStatus, syncETracking=syncETracking, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, iPv4Address=iPv4Address, ethernetPriorityTableEntry=ethernetPriorityTableEntry, wirelessOutAllOctets=wirelessOutAllOctets, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sNMPv3Enable=sNMPv3Enable, wirelessOutOctets=wirelessOutOctets, wirelessOutEthernetOctets=wirelessOutEthernetOctets, dSCPManagementPriority=dSCPManagementPriority, sFPPortDisabledWarning=sFPPortDisabledWarning, sFPPortStatus=sFPPortStatus, telnetAccessEnabled=telnetAccessEnabled, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, dNSPrimaryServer=dNSPrimaryServer, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, encryptionGroup=encryptionGroup, tDMEnabledChannels=tDMEnabledChannels, pubStatsGroup=pubStatsGroup, vLANManagementVID=vLANManagementVID, tdmTableNumber=tdmTableNumber, authorizationControlTable=authorizationControlTable, systemReset=systemReset, sntp=sntp, hCMPLinkSymmetry=hCMPLinkSymmetry, lowestDataModulationMode=lowestDataModulationMode, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, searchStateLinked=searchStateLinked, accessMethod=accessMethod, licenseInstancedTableIndex=licenseInstancedTableIndex, receiveChannel=receiveChannel, iPVersion=iPVersion, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNTPPollInterval=sNTPPollInterval, useVLANForMABProtocol=useVLANForMABProtocol, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, transparentClockVLAN=transparentClockVLAN, cableDiagPair2Results=cableDiagPair2Results, cableDiagPair3Distance=cableDiagPair3Distance, sNTPSyncTrap=sNTPSyncTrap, sNTPServerTableIndex=sNTPServerTableIndex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, installStatusLinked=installStatusLinked, configurationInstancedTableNumber=configurationInstancedTableNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, productName=productName, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sFPPortStatusTrap=sFPPortStatusTrap, hTTPSPortNumber=hTTPSPortNumber, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, secureModeAlarmTrap=secureModeAlarmTrap, dNSServerTableNumber=dNSServerTableNumber, iPv6Address=iPv6Address, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerTableNumber=sNTPServerTableNumber, cableDiagnostics=cableDiagnostics, tdmTable=tdmTable, sFPPortSSMTx=sFPPortSSMTx, versions=versions, syncESlavePort=syncESlavePort, apcGroup=apcGroup, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, range=range, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableLoss=cableLoss, cableDiagPair1Distance=cableDiagPair1Distance, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, pubStats=pubStats, sNTPServerStatus=sNTPServerStatus, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, userTableNumber=userTableNumber, tDM=tDM, mgmtInstancedTable=mgmtInstancedTable, wirelessLinkStatus=wirelessLinkStatus, ptpGroups=ptpGroups, antennaSelection=antennaSelection, sFPPortQLRx=sFPPortQLRx, ethernetGroup=ethernetGroup, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mgmtInstancedTableNumber=mgmtInstancedTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, authorizationControlGroup=authorizationControlGroup, transparentClockVID=transparentClockVID, deviceMSN=deviceMSN, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, cableDiagPair1Results=cableDiagPair1Results, tFTPClient=tFTPClient, bootVersion=bootVersion, txColorCode=txColorCode, licenseGroupAccess=licenseGroupAccess, reset=reset, receiveDataRate=receiveDataRate, authorizationControlTableNumber=authorizationControlTableNumber, l2CPPriorityTable=l2CPPriorityTable, ptpTraps=ptpTraps, dfsPeaks=dfsPeaks, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syncETrackingState=syncETrackingState, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, licenseInstancedTableNumber=licenseInstancedTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hTTPAccessEnabled=hTTPAccessEnabled, softwareVersion=softwareVersion, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, txMABFrames=txMABFrames, phyInstancedStatusTable=phyInstancedStatusTable, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, targetRange=targetRange, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, altitude=altitude, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataBridgingStatusLinked=dataBridgingStatusLinked, routerProtocolsGroup=routerProtocolsGroup, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableDiagPair2Distance=cableDiagPair2Distance, ethernetStatisticsTable=ethernetStatisticsTable, unavailableSeconds=unavailableSeconds, siteName=siteName, phyControlInstancedTable=phyControlInstancedTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDMChannelStatus=tDMChannelStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", deviceESN=deviceESN, syslogLocalWrappedTrap=syslogLocalWrappedTrap, apc=apc, sNTPSync=sNTPSync, ethernetInstancedTable=ethernetInstancedTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, receiveModulationModeDetail=receiveModulationModeDetail, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseSecurityLevel=licenseSecurityLevel, sFPErrorTrap=sFPErrorTrap, tdmTableEntry=tdmTableEntry, ethernetInstancedTableEntry=ethernetInstancedTableEntry, linkName=linkName, severelyErroredSeconds=severelyErroredSeconds, capacityVariantMismatchLinked=capacityVariantMismatchLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, auxPortQLRx=auxPortQLRx, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mABTransmissionInterval=mABTransmissionInterval, licenseVersion=licenseVersion, licenseHCMPSupport=licenseHCMPSupport, linkLoss=linkLoss, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, installStatus=installStatus, groupID=groupID, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitDataRateLinked=transmitDataRateLinked, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rawReceivePower=rawReceivePower, aggregateDataRateLinked=aggregateDataRateLinked, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, lbtDetectedTrap=lbtDetectedTrap, licenseSyncESupport=licenseSyncESupport, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, maxLinkRangeExceeded=maxLinkRangeExceeded, byteErrorRatioLinked=byteErrorRatioLinked, remoteUnitName=remoteUnitName, dfsTableEntry=dfsTableEntry, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, gatewayIPAddress=gatewayIPAddress, extendedSpectrumScanning=extendedSpectrumScanning, portAllocationMismatchLinked=portAllocationMismatchLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, smtp=smtp, phyControlInstancedTableEntry=phyControlInstancedTableEntry, auxPortConfigurationMismatch=auxPortConfigurationMismatch, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, incompatibleRegulatoryBands=incompatibleRegulatoryBands, regulatoryBand=regulatoryBand, sFPPortAutoNegotiation=sFPPortAutoNegotiation, eIRP=eIRP, licenseIEEE1588Support=licenseIEEE1588Support, auxPortStatus=auxPortStatus, sNTPLastSync=sNTPLastSync)
