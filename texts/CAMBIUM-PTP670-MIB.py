...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNMPTrapInternetAddress=sNMPTrapInternetAddress, authorizationControlTableIndex=authorizationControlTableIndex, unitIdentification=unitIdentification, sNMPTrapTableEntry=sNMPTrapTableEntry, configuration=configuration, alarmInstancedTable=alarmInstancedTable, sNTPSyncTrap=sNTPSyncTrap, authorizationControl=authorizationControl, remoteMACAddressLinked=remoteMACAddressLinked, configurationInstancedTableNumber=configurationInstancedTableNumber, tDMChannelStatusTrap=tDMChannelStatusTrap, qOSPriorityScheme=qOSPriorityScheme, supplementaryGroup=supplementaryGroup, auxPortStatus=auxPortStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, userPassword=userPassword, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, whitelistRMMacAddress=whitelistRMMacAddress, auxPortConfigurationMismatch=auxPortConfigurationMismatch, pubInstancedStatsTable=pubInstancedStatsTable, smtp=smtp, tdmTableNumber=tdmTableNumber, licenseTrialPeriod=licenseTrialPeriod, licenseInstancedTableIndex=licenseInstancedTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mainPSUPortAutoMdix=mainPSUPortAutoMdix, dNSResolver=dNSResolver, telnetPortNumber=telnetPortNumber, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mABNominalTransmitCapacity=mABNominalTransmitCapacity, transmitFreqMHz=transmitFreqMHz, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, signalStrengthRatio=signalStrengthRatio, alarmInstancedTableNumber=alarmInstancedTableNumber, linkModeOptimization=linkModeOptimization, portAllocationMismatchTrap=portAllocationMismatchTrap, sNTPPrimaryServer=sNTPPrimaryServer, licenseHCMPSupport=licenseHCMPSupport, nIDULanPortStatus=nIDULanPortStatus, versions=versions, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, routerProtocolsGroup=routerProtocolsGroup, mainPSUPortAllocation=mainPSUPortAllocation, userTableNumber=userTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, hCMPMaximumLinkRange=hCMPMaximumLinkRange, blacklistRMMacAddress=blacklistRMMacAddress, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, routerProtocols=routerProtocols, syslogClient=syslogClient, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, snmpControl=snmpControl, timeZone=timeZone, phyStatusGroup=phyStatusGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, remoteMACAddress=remoteMACAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortAutoNegotiation=sFPPortAutoNegotiation, hardwareVersion=hardwareVersion, remoteUnitName=remoteUnitName, l2CPPriorityTableNumber=l2CPPriorityTableNumber, nIDULanPortAutoMdix=nIDULanPortAutoMdix, authorizationControlGroup=authorizationControlGroup, regulatoryBandTrap=regulatoryBandTrap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, licenseSFPPortSupport=licenseSFPPortSupport, deviceMSN=deviceMSN, tDDControlGroup=tDDControlGroup, sNTPServerTableEntry=sNTPServerTableEntry, transmitChannel=transmitChannel, mABTransmissionInterval=mABTransmissionInterval, secureModeAlarmTrap=secureModeAlarmTrap, authorizationControlTableEntry=authorizationControlTableEntry, transmitterChannels=transmitterChannels, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, blacklistRMEnabled=blacklistRMEnabled, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, txColorCode=txColorCode, cableDiagnosticsPorts=cableDiagnosticsPorts, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, authorizationControlTable=authorizationControlTable, rxColorCode=rxColorCode, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, ptp670=ptp670, linkName=linkName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANManagementPriority=vLANManagementPriority, supplementary=supplementary, receiveModulationModeDetail=receiveModulationModeDetail, tempPcb=tempPcb, pubStats=pubStats, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, oOBPriorityQueueMapping=oOBPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, sNTPServerTableNumber=sNTPServerTableNumber, authorizationControlTableNumber=authorizationControlTableNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseOOBManagementSupport=licenseOOBManagementSupport, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, capacityVariantMismatchTrap=capacityVariantMismatchTrap, siteName=siteName, capacityVariantMismatchLinked=capacityVariantMismatchLinked, channelBandwidth=channelBandwidth, tDDSynchronizationMode=tDDSynchronizationMode, receivePowerLinked=receivePowerLinked, dNSPrimaryServer=dNSPrimaryServer, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sFPPortAllocation=sFPPortAllocation, sFPPortQLRx=sFPPortQLRx, tDDControl=tDDControl, sFPError=sFPError, groupID=groupID, auxPortSyncERxStatus=auxPortSyncERxStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPSync=sNTPSync, cableDiagnosticsGroup=cableDiagnosticsGroup, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, hTTPSPortNumber=hTTPSPortNumber, installationMode=installationMode, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sNTPPollInterval=sNTPPollInterval, cableDiagPair2Results=cableDiagPair2Results, sntp=sntp, sNMPEnabledTraps=sNMPEnabledTraps, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, iPVersion=iPVersion, remoteInternetAddressLinked=remoteInternetAddressLinked, antennaSelection=antennaSelection, transparentClockVID=transparentClockVID, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPPortNumber=hTTPPortNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, userTableEntry=userTableEntry, apcGroup=apcGroup, encryptionAlgorithm=encryptionAlgorithm, dataBridgingStatusAlarm=dataBridgingStatusAlarm, smtpGroup=smtpGroup, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, encryption=encryption, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, capacityVariantMismatch=capacityVariantMismatch, transmitPower=transmitPower, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, ptp=ptp, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tDDSynchronizationStatus=tDDSynchronizationStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, iPv6PrefixLength=iPv6PrefixLength, licenseGasGroup=licenseGasGroup, localPacketFiltering=localPacketFiltering, sNTPServerStatus=sNTPServerStatus, syslogControl=syslogControl, versionsGroup=versionsGroup, hCMPLinkSymmetry=hCMPLinkSymmetry, secureModeAlarm=secureModeAlarm, dfsTableIndex=dfsTableIndex, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, ptmp=ptmp, searchStateLinked=searchStateLinked, sNMPv3Enable=sNMPv3Enable, maximumTransmitPower=maximumTransmitPower, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseGroupAccess=licenseGroupAccess, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, tDMChannelCableLength=tDMChannelCableLength, management=management, cableDiagnosticsWarning=cableDiagnosticsWarning, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, transparentClockVLAN=transparentClockVLAN, dNS=dNS, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsTable=dfsTable, receiveModulationModeLinked=receiveModulationModeLinked, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mainPSUPortQLRx=mainPSUPortQLRx, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userRole=userRole, phyControl=phyControl, erroredSeconds=erroredSeconds, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, lowestTDMModulationMode=lowestTDMModulationMode, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, phyControlInstancedTableEntry=phyControlInstancedTableEntry, notificationsGroup=notificationsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerInternetAddress=sNTPServerInternetAddress, receiveChannel=receiveChannel, targetMACAddress=targetMACAddress, phyControlInstancedTable=phyControlInstancedTable, sntpGroup=sntpGroup, licenseInstancedTableNumber=licenseInstancedTableNumber, frequencyVariant=frequencyVariant, resetGroup=resetGroup, mABProtocolVID=mABProtocolVID, dSCPManagementPriority=dSCPManagementPriority, phyStatus=phyStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, alarmInstancedTableEntry=alarmInstancedTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDMChannelStatus=tDMChannelStatus, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tDMInterfaceControl=tDMInterfaceControl, auxPortAllocation=auxPortAllocation, tDMChannelLineCode=tDMChannelLineCode, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, subbandHighestFrequency=subbandHighestFrequency, installArmStateTrap=installArmStateTrap, mainPSUPortQLTx=mainPSUPortQLTx, txMABFrames=txMABFrames, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, mABProtocolVLANPriority=mABProtocolVLANPriority, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, transparentClock=transparentClock, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, packetsFromInternalStack=packetsFromInternalStack, transmitFreqKHz=transmitFreqKHz, dfs=dfs, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseIEEE1588Support=licenseIEEE1588Support, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseGroup=licenseGroup, dataBridgingStatusLinked=dataBridgingStatusLinked, tDMGroup=tDMGroup, sFPPortStatusTrap=sFPPortStatusTrap, bridgeGroup=bridgeGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", linkLossLinked=linkLossLinked, systemClock=systemClock, dataBridgingAvailability=dataBridgingAvailability, lbtDetectedTrap=lbtDetectedTrap, receiveModulationMode=receiveModulationMode, mgmtInstancedTable=mgmtInstancedTable, userName=userName, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapVersion=sNMPTrapVersion, dNSServerInternetAddress=dNSServerInternetAddress, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sNMPCommunityString=sNMPCommunityString, ptpTrapPrefix=ptpTrapPrefix, cableDiagPair4Distance=cableDiagPair4Distance, iPv4Address=iPv4Address, licenseTDDSyncSupport=licenseTDDSyncSupport, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mainPSUPortStatus=mainPSUPortStatus, altitude=altitude, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseTLSRekey=licenseTLSRekey, ethernetGroup=ethernetGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, encryptionGroup=encryptionGroup, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, ethernetInstancedTableNumber=ethernetInstancedTableNumber, deviceMACAddress=deviceMACAddress, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseMaxLinkRange=licenseMaxLinkRange, syslogState=syslogState, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, range=range, wirelessOutAllOctets=wirelessOutAllOctets, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, sFPErrorTrap=sFPErrorTrap, dNSServerTableEntry=dNSServerTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, aAAControlGroup=aAAControlGroup, softwareVersion=softwareVersion, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dfsTableEntry=dfsTableEntry, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, installStatusTrap=installStatusTrap, auxPortSSMTx=auxPortSSMTx, mABState=mABState, vLANManagementVID=vLANManagementVID, alarms=alarms, subnetMask=subnetMask, ptpGroups=ptpGroups, dNSServerTable=dNSServerTable, vectorErrorLinked=vectorErrorLinked, sNTPLastSync=sNTPLastSync, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, rangeLinked=rangeLinked, dataBridgingStatus=dataBridgingStatus, iPv6GatewayAddress=iPv6GatewayAddress, receiveFreqKHz=receiveFreqKHz, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, tDMConfigurationMismatch=tDMConfigurationMismatch, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, bridge=bridge, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, ethernetStatisticsTable=ethernetStatisticsTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, auxPortQLRx=auxPortQLRx, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transparentClockPort=transparentClockPort, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessOutEthernetOctets=wirelessOutEthernetOctets, managementPortWirelessDownAlert=managementPortWirelessDownAlert, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, transmitModulationModeLinked=transmitModulationModeLinked, remoteUnitNameLinked=remoteUnitNameLinked, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, rangingMode=rangingMode, auxPortQLTx=auxPortQLTx, cableDiagPair4Results=cableDiagPair4Results, sMTPEmailAlert=sMTPEmailAlert, auxPortStatusTrap=auxPortStatusTrap, mABNominalModulationMode=mABNominalModulationMode, portAllocationMismatchLinked=portAllocationMismatchLinked, alarmsGroup=alarmsGroup, dNSServerTableNumber=dNSServerTableNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, regulatoryBand=regulatoryBand, transmitDataRate=transmitDataRate, configurationInstancedTable=configurationInstancedTable, receivePower=receivePower, syncETrackingState=syncETrackingState, searchState=searchState, maxLinkRangeExceeded=maxLinkRangeExceeded, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, severelyErroredSeconds=severelyErroredSeconds, syslogClientTrap=syslogClientTrap, sFPPortQLTx=sFPPortQLTx, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, aggregateDataRateLinked=aggregateDataRateLinked, targetRange=targetRange, l2CPPriorityTableIndex=l2CPPriorityTableIndex, license=license, dNSServerTableIndex=dNSServerTableIndex, cambium=cambium, transmitPowerLinked=transmitPowerLinked, userEnabled=userEnabled, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, deviceESN=deviceESN, longitude=longitude, signalStrengthRatioLinked=signalStrengthRatioLinked, phyControlGroup=phyControlGroup, mainPSUPortSSMTx=mainPSUPortSSMTx, ethernetInstancedTableIndex=ethernetInstancedTableIndex, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, accessMethod=accessMethod, tDMChannelLoopback=tDMChannelLoopback, dNSGroup=dNSGroup, masterSlaveMode=masterSlaveMode, sNMPTrapTable=sNMPTrapTable, productName=productName, rawReceivePowerLinked=rawReceivePowerLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, packetsToInternalStack=packetsToInternalStack, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNTPServerTable=sNTPServerTable, enableTransmission=enableTransmission, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, auxPortDisabledWarning=auxPortDisabledWarning, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tdmTableEntry=tdmTableEntry, configurationInstancedTableIndex=configurationInstancedTableIndex, mABHoldoffPeriod=mABHoldoffPeriod, licenseEncryption=licenseEncryption, licenseCapacity=licenseCapacity, sMTPEnabledMessages=sMTPEnabledMessages, configurationInstancedTableEntry=configurationInstancedTableEntry, unavailableSeconds=unavailableSeconds, sNTPServerPortNumber=sNTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, installStatus=installStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, cableDiagnosticsControl=cableDiagnosticsControl, tdmTableIndex=tdmTableIndex, sNTPState=sNTPState, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessTopology=wirelessTopology, configurationGroup=configurationGroup, bootVersion=bootVersion, sFPPortSSMTx=sFPPortSSMTx, receiveDataRateLinked=receiveDataRateLinked, PYSNMP_MODULE_ID=cambium, licenseVersion=licenseVersion, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tFTPServerPortNumber=tFTPServerPortNumber, ethernetPriorityTable=ethernetPriorityTable, ethernet=ethernet, licenseIPv6Support=licenseIPv6Support, mgmtInstancedTableIndex=mgmtInstancedTableIndex, aggregateDataRate=aggregateDataRate, ptpTraps=ptpTraps, sNTPServerTableIndex=sNTPServerTableIndex, sFPPortDisabledWarning=sFPPortDisabledWarning, wirelessOutOctets=wirelessOutOctets, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, linkSymmetry=linkSymmetry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseBandwidthCap=licenseBandwidthCap, rawReceivePower=rawReceivePower, cableLoss=cableLoss, sFPPortStatus=sFPPortStatus, syslogControlGroup=syslogControlGroup, unitOutOfCalibration=unitOutOfCalibration, dfsPeaks=dfsPeaks, lowestDataModulationMode=lowestDataModulationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installArmState=installArmState, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, telnetAccessEnabled=telnetAccessEnabled, channelChangeTrap=channelChangeTrap, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, unitName=unitName, tFTPClient=tFTPClient, sNTPServerRetries=sNTPServerRetries, iPDSCPPriorityTable=iPDSCPPriorityTable, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, licenseSecurityLevel=licenseSecurityLevel, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseRARSupport=licenseRARSupport, sMTPServerPortNumber=sMTPServerPortNumber, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, gatewayIPAddress=gatewayIPAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, l2CPPriorityTable=l2CPPriorityTable, syncESlavePort=syncESlavePort, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagnostics=cableDiagnostics, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tDMInterfaceStatus=tDMInterfaceStatus, ethernetInstancedTable=ethernetInstancedTable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, userTableIndex=userTableIndex, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, tDMEnabledChannels=tDMEnabledChannels, authorizationMethod=authorizationMethod, cableDiagPair3Distance=cableDiagPair3Distance, transmitModulationMode=transmitModulationMode, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, remoteInternetAddress=remoteInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPAccessEnabled=hTTPAccessEnabled, pubStatsGroup=pubStatsGroup, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, productVariant=productVariant, byteErrorRatio=byteErrorRatio, byteErrorRatioLinked=byteErrorRatioLinked, licenseInstancedTable=licenseInstancedTable, dfsTableNumber=dfsTableNumber, cableDiagPair1Distance=cableDiagPair1Distance, cableDiagPair2Distance=cableDiagPair2Distance, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, remoteInternetAddressType=remoteInternetAddressType, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, ethernetPriorityTableNumber=ethernetPriorityTableNumber, wirelessLinkStatusLinked=wirelessLinkStatusLinked, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, syncETracking=syncETracking, portAllocationMismatch=portAllocationMismatch, phyControlInstancedTableIndex=phyControlInstancedTableIndex, cableDiagPair1Results=cableDiagPair1Results, syncEEquipmentClock=syncEEquipmentClock, useVLANForManagementInterfaces=useVLANForManagementInterfaces)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", whitelistRMEnabled=whitelistRMEnabled, sNTPServerTimeout=sNTPServerTimeout, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsMeans=dfsMeans, reset=reset, installStatusLinked=installStatusLinked, antennaGain=antennaGain, userTable=userTable, licenseCountry=licenseCountry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitDataRateLinked=transmitDataRateLinked, extendedSpectrumScanning=extendedSpectrumScanning, alarmInstancedTableIndex=alarmInstancedTableIndex, sFPPortAutoMdix=sFPPortAutoMdix, subbandLowestFrequency=subbandLowestFrequency, dataPortPauseFrames=dataPortPauseFrames, tDM=tDM, mainPSUPortStatusTrap=mainPSUPortStatusTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, daylightSaving=daylightSaving, receiveDataRate=receiveDataRate, ptpCompliance=ptpCompliance, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPServerInternetAddressType=sMTPServerInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sNMPPortNumber=sNMPPortNumber, iPv6Address=iPv6Address, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cableDiagPair3Results=cableDiagPair3Results, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, apc=apc, ethernetStatisticsDataSource=ethernetStatisticsDataSource, latitude=latitude, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, aAAControl=aAAControl, secondarySoftwareVersion=secondarySoftwareVersion, useVLANForMABProtocol=useVLANForMABProtocol, eIRP=eIRP, snmpControlGroup=snmpControlGroup, tdmTable=tdmTable, linkLoss=linkLoss, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, mABMaintenanceLevel=mABMaintenanceLevel, syslogStateTrap=syslogStateTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, unitIdentificationGroup=unitIdentificationGroup, dNSServerInternetAddressType=dNSServerInternetAddressType, phyInstancedStatusTable=phyInstancedStatusTable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, receiveFreqMHz=receiveFreqMHz, wirelessLinkAvailability=wirelessLinkAvailability, dfsGroup=dfsGroup, dNSServerPortNumber=dNSServerPortNumber, systemReset=systemReset, managementGroup=managementGroup, licenseSyncESupport=licenseSyncESupport, licenseIssueNumber=licenseIssueNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, vectorError=vectorError)
