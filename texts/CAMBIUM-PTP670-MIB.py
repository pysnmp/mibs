...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tDMInterfaceStatus=tDMInterfaceStatus, installStatus=installStatus, masterSlaveMode=masterSlaveMode, userPassword=userPassword, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, remoteMACAddressLinked=remoteMACAddressLinked, installationMode=installationMode, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, receiveDataRate=receiveDataRate, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseHCMPSupport=licenseHCMPSupport, deviceMSN=deviceMSN, licenseSecurityLevel=licenseSecurityLevel, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, aggregateDataRate=aggregateDataRate, targetMACAddress=targetMACAddress, tDMChannelCableLength=tDMChannelCableLength, sFPPortQLTx=sFPPortQLTx, range=range, frequencyVariant=frequencyVariant, deviceMACAddress=deviceMACAddress, remoteUnitNameLinked=remoteUnitNameLinked, pubStatsGroup=pubStatsGroup, cableDiagPair2Distance=cableDiagPair2Distance, sntpGroup=sntpGroup, nIDULanPortStatus=nIDULanPortStatus, sNMPPortNumber=sNMPPortNumber, configuration=configuration, erroredSeconds=erroredSeconds, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, phyControlInstancedTable=phyControlInstancedTable, dfsPeaks=dfsPeaks, lowestDataModulationMode=lowestDataModulationMode, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, notificationsGroup=notificationsGroup, hCMPMaximumLinkRange=hCMPMaximumLinkRange, auxPortSSMTx=auxPortSSMTx, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, apc=apc, cableDiagPair1Results=cableDiagPair1Results, iPv4Address=iPv4Address, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, blacklistRMEnabled=blacklistRMEnabled, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseEncryption=licenseEncryption, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, dataBridgingAvailability=dataBridgingAvailability, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, phyControl=phyControl, alarmInstancedTableEntry=alarmInstancedTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tDMChannelStatusTrap=tDMChannelStatusTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, rawReceivePowerLinked=rawReceivePowerLinked, supplementaryGroup=supplementaryGroup, ptpGroups=ptpGroups, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, syncEEquipmentClock=syncEEquipmentClock, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, reset=reset, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDMGroup=tDMGroup, hardwareVersion=hardwareVersion, aggregateDataRateLinked=aggregateDataRateLinked, alarms=alarms, dNSPrimaryServer=dNSPrimaryServer, licenseVersion=licenseVersion, licenseCountry=licenseCountry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, phyStatusGroup=phyStatusGroup, licenseTLSRekey=licenseTLSRekey, mainPSUPortStatusTrap=mainPSUPortStatusTrap, license=license, installArmStateTrap=installArmStateTrap, mABTransmissionInterval=mABTransmissionInterval, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, secureModeAlarmTrap=secureModeAlarmTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sFPPortQLRx=sFPPortQLRx, auxPortSyncERxStatus=auxPortSyncERxStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userRole=userRole, hTTPSAccessEnabled=hTTPSAccessEnabled, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, tDM=tDM, ptpCompliance=ptpCompliance, dfsTableEntry=dfsTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsMeans=dfsMeans, vectorErrorLinked=vectorErrorLinked, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetInstancedTable=ethernetInstancedTable, tDMConfigurationMismatch=tDMConfigurationMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dNSGroup=dNSGroup, sFPPortAllocation=sFPPortAllocation, tdmTableIndex=tdmTableIndex, ethernetInstancedTableIndex=ethernetInstancedTableIndex, groupID=groupID, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPCommunityString=sNMPCommunityString, encryption=encryption, dNSServerInternetAddressType=dNSServerInternetAddressType, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dNSServerTableEntry=dNSServerTableEntry, useVLANForMABProtocol=useVLANForMABProtocol, oOBPriorityQueueMapping=oOBPriorityQueueMapping, timeZone=timeZone, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, encryptionAlgorithm=encryptionAlgorithm, rangingMode=rangingMode, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, transmitChannel=transmitChannel, licenseMaxLinkRange=licenseMaxLinkRange, supplementary=supplementary, mABNominalTransmitCapacity=mABNominalTransmitCapacity, portAllocationMismatch=portAllocationMismatch, syncETracking=syncETracking, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, configurationInstancedTableEntry=configurationInstancedTableEntry, auxPortAllocation=auxPortAllocation, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationMode=tDDSynchronizationMode, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ethernetGroup=ethernetGroup, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, altitude=altitude, ptp670=ptp670, iPv6PrefixLength=iPv6PrefixLength, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, hTTPPortNumber=hTTPPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, subnetMask=subnetMask, productName=productName, linkSymmetry=linkSymmetry, installStatusLinked=installStatusLinked, qOSPriorityScheme=qOSPriorityScheme, installArmState=installArmState, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, userTableIndex=userTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, cambium=cambium, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sFPPortSSMTx=sFPPortSSMTx, tDDControl=tDDControl, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, linkLoss=linkLoss, mainPSUPortSSMTx=mainPSUPortSSMTx, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, searchState=searchState, gatewayIPAddress=gatewayIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, rawReceivePower=rawReceivePower, phyControlInstancedTableIndex=phyControlInstancedTableIndex, authorizationControlTableNumber=authorizationControlTableNumber, auxPortQLRx=auxPortQLRx, sMTPServerInternetAddress=sMTPServerInternetAddress, dfs=dfs, subbandHighestFrequency=subbandHighestFrequency, dataBridgingStatusAlarm=dataBridgingStatusAlarm, licenseSFPPortSupport=licenseSFPPortSupport, tDDSynchronizationAlarm=tDDSynchronizationAlarm, daylightSaving=daylightSaving, dNSServerInternetAddress=dNSServerInternetAddress, syslogControlGroup=syslogControlGroup, pubStats=pubStats, maximumTransmitPower=maximumTransmitPower, ptpTrapPrefix=ptpTrapPrefix, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapTable=sNMPTrapTable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNTPPollInterval=sNTPPollInterval, receivePower=receivePower, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, wirelessLinkStatusLinked=wirelessLinkStatusLinked, authorizationMethod=authorizationMethod, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, signalStrengthRatioLinked=signalStrengthRatioLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cableLoss=cableLoss, licenseGasGroup=licenseGasGroup, licenseRARSupport=licenseRARSupport, aAAControl=aAAControl, linkModeOptimization=linkModeOptimization, severelyErroredSeconds=severelyErroredSeconds, mainPSUPortQLTx=mainPSUPortQLTx, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, alarmInstancedTableIndex=alarmInstancedTableIndex, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, smtpGroup=smtpGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sntp=sntp, tDMChannelLineCode=tDMChannelLineCode, sNTPServerTable=sNTPServerTable, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, rxColorCode=rxColorCode, sNTPServerTableIndex=sNTPServerTableIndex, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, wirelessLinkStatus=wirelessLinkStatus, packetsToInternalStack=packetsToInternalStack, sFPPortAutoNegotiation=sFPPortAutoNegotiation, ethernetInstancedTableEntry=ethernetInstancedTableEntry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sMTPEmailAlert=sMTPEmailAlert, wirelessOutEthernetOctets=wirelessOutEthernetOctets, softwareVersion=softwareVersion, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, bridgeGroup=bridgeGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, tDMChannelStatus=tDMChannelStatus, configurationInstancedTable=configurationInstancedTable, encryptionGroup=encryptionGroup, portAllocationMismatchLinked=portAllocationMismatchLinked, mABProtocolVID=mABProtocolVID, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, wirelessOutOctets=wirelessOutOctets, transparentClockVLAN=transparentClockVLAN, ethernetPriorityTableNumber=ethernetPriorityTableNumber, authorizationControlTableIndex=authorizationControlTableIndex, phyStatus=phyStatus, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitterChannels=transmitterChannels, dNSServerTable=dNSServerTable, secureModeAlarm=secureModeAlarm, byteErrorRatio=byteErrorRatio, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveChannel=receiveChannel, regulatoryBandTrap=regulatoryBandTrap, packetsFromInternalStack=packetsFromInternalStack, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, remoteUnitName=remoteUnitName, sNTPServerTimeout=sNTPServerTimeout, sNTPServerTableNumber=sNTPServerTableNumber, phyControlGroup=phyControlGroup, syslogClient=syslogClient, blacklistRMMacAddress=blacklistRMMacAddress, unitIdentification=unitIdentification, cableDiagnosticsControl=cableDiagnosticsControl, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPSyncTrap=sNTPSyncTrap, licenseCapacity=licenseCapacity, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sNTPServerRetries=sNTPServerRetries, vLANManagementVID=vLANManagementVID, receivePowerLinked=receivePowerLinked, tDMInterfaceControl=tDMInterfaceControl, sFPPortStatusTrap=sFPPortStatusTrap, versions=versions, sMTPServerPortNumber=sMTPServerPortNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mainPSUPortStatus=mainPSUPortStatus, systemReset=systemReset, mABNominalModulationMode=mABNominalModulationMode, PYSNMP_MODULE_ID=cambium, cableDiagPair3Results=cableDiagPair3Results, managementGroup=managementGroup, transparentClock=transparentClock, auxPortStatus=auxPortStatus, userName=userName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dNSResolver=dNSResolver, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, capacityVariantMismatchLinked=capacityVariantMismatchLinked, unitOutOfCalibration=unitOutOfCalibration, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ptp=ptp, sFPPortDisabledWarning=sFPPortDisabledWarning, enableTransmission=enableTransmission, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, productVariant=productVariant, antennaSelection=antennaSelection, userEnabled=userEnabled, wirelessLinkAvailability=wirelessLinkAvailability, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, userTableEntry=userTableEntry, regulatoryBand=regulatoryBand, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseIEEE1588Support=licenseIEEE1588Support, installStatusTrap=installStatusTrap, cableDiagPair1Distance=cableDiagPair1Distance, versionsGroup=versionsGroup, alarmsGroup=alarmsGroup, txMABFrames=txMABFrames, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sNMPv3Enable=sNMPv3Enable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, cableDiagnosticsWarning=cableDiagnosticsWarning, alarmInstancedTableNumber=alarmInstancedTableNumber, rangeLinked=rangeLinked, searchStateLinked=searchStateLinked, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, receiveFreqKHz=receiveFreqKHz, dNSServerTableIndex=dNSServerTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, authorizationControl=authorizationControl, resetGroup=resetGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, portAllocationMismatchTrap=portAllocationMismatchTrap, apcGroup=apcGroup, dNS=dNS, mABProtocolVLANPriority=mABProtocolVLANPriority, mainPSUPortQLRx=mainPSUPortQLRx, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mABState=mABState, licenseTDDSyncSupport=licenseTDDSyncSupport, hCMPLinkSymmetry=hCMPLinkSymmetry, longitude=longitude, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cableDiagnosticsPorts=cableDiagnosticsPorts, antennaGain=antennaGain, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelChangeTrap=channelChangeTrap, txColorCode=txColorCode, transmitModulationModeLinked=transmitModulationModeLinked, wirelessTopology=wirelessTopology, vectorError=vectorError, signalStrengthRatio=signalStrengthRatio, licenseInstancedTableNumber=licenseInstancedTableNumber, mABHoldoffPeriod=mABHoldoffPeriod, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sFPPortStatus=sFPPortStatus, transmitFreqMHz=transmitFreqMHz, bridge=bridge, transmitDataRateLinked=transmitDataRateLinked, tdmTableEntry=tdmTableEntry, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, ethernet=ethernet, targetRange=targetRange, linkLossLinked=linkLossLinked, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ptpTraps=ptpTraps, authorizationControlTable=authorizationControlTable, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, configurationInstancedTableNumber=configurationInstancedTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteInternetAddressLinked=remoteInternetAddressLinked, l2CPPriorityTableNumber=l2CPPriorityTableNumber, vLANManagementPriority=vLANManagementPriority, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sNTPState=sNTPState, deviceESN=deviceESN, ptmp=ptmp, accessMethod=accessMethod, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseInstancedTableIndex=licenseInstancedTableIndex, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, eIRP=eIRP, mgmtInstancedTableNumber=mgmtInstancedTableNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, syncESlavePort=syncESlavePort, sNMPTrapTableNumber=sNMPTrapTableNumber, dNSServerTableNumber=dNSServerTableNumber, tDMEnabledChannels=tDMEnabledChannels, management=management, sNTPPrimaryServer=sNTPPrimaryServer, remoteMACAddress=remoteMACAddress, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, maximumNumberOfSlaves=maximumNumberOfSlaves, l2CPPriorityTable=l2CPPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationMode=receiveModulationMode, auxPortAcceptedQLRx=auxPortAcceptedQLRx, syslogControl=syslogControl, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, receiveModulationModeLinked=receiveModulationModeLinked, siteName=siteName, mainPSUPortAllocation=mainPSUPortAllocation, sNTPServerStatus=sNTPServerStatus, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, auxPortConfigurationMismatch=auxPortConfigurationMismatch, unavailableSeconds=unavailableSeconds, iPv6Address=iPv6Address, latitude=latitude, smtp=smtp, whitelistRMMacAddress=whitelistRMMacAddress, transparentClockVID=transparentClockVID, localPacketFiltering=localPacketFiltering, dfsTableIndex=dfsTableIndex, receiveDataRateLinked=receiveDataRateLinked, managementNetworkAccessEnabled=managementNetworkAccessEnabled, snmpControl=snmpControl, licenseTrialPeriod=licenseTrialPeriod, authorizationControlGroup=authorizationControlGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mgmtInstancedTableIndex=mgmtInstancedTableIndex, cableDiagnostics=cableDiagnostics, mgmtInstancedTable=mgmtInstancedTable, byteErrorRatioLinked=byteErrorRatioLinked, ethernetStatisticsDataSource=ethernetStatisticsDataSource, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, auxPortStatusTrap=auxPortStatusTrap, dNSServerPortNumber=dNSServerPortNumber, capacityVariantMismatch=capacityVariantMismatch, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, linkName=linkName, dataPortPauseFrames=dataPortPauseFrames, alarmInstancedTable=alarmInstancedTable, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerInternetAddressType=sMTPServerInternetAddressType, phyInstancedStatusTable=phyInstancedStatusTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPClient=tFTPClient, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, cableDiagnosticsResultTable=cableDiagnosticsResultTable, dataBridgingStatusLinked=dataBridgingStatusLinked, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, dSCPManagementPriority=dSCPManagementPriority, licenseIPv6Support=licenseIPv6Support, sNTPServerTableEntry=sNTPServerTableEntry, iPVersion=iPVersion, extendedSpectrumScanning=extendedSpectrumScanning, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, userTable=userTable, transparentClockPort=transparentClockPort, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, dfsTable=dfsTable, licenseUnitSerialNumber=licenseUnitSerialNumber, maxLinkRangeExceeded=maxLinkRangeExceeded, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, transmitDataRate=transmitDataRate, mABMaintenanceLevel=mABMaintenanceLevel, dataBridgingStatus=dataBridgingStatus, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, transmitPower=transmitPower, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, bootVersion=bootVersion, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, licenseIssueNumber=licenseIssueNumber, sNMPEnabledTraps=sNMPEnabledTraps, licenseInstancedTable=licenseInstancedTable, cableDiagPair2Results=cableDiagPair2Results, unitName=unitName, telnetPortNumber=telnetPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sFPErrorTrap=sFPErrorTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, unitIdentificationGroup=unitIdentificationGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tempPcb=tempPcb, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, transmitPowerLinked=transmitPowerLinked, routerProtocols=routerProtocols, syslogState=syslogState, auxPortQLTx=auxPortQLTx, tdmTableNumber=tdmTableNumber, userTableNumber=userTableNumber, dfsTableNumber=dfsTableNumber, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, cableDiagPair4Distance=cableDiagPair4Distance, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseGroup=licenseGroup, sFPPortAutoMdix=sFPPortAutoMdix, tFTPServerInternetAddress=tFTPServerInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, remoteInternetAddress=remoteInternetAddress, lbtDetectedTrap=lbtDetectedTrap, remoteInternetAddressType=remoteInternetAddressType, sNTPLastSync=sNTPLastSync, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogStateTrap=syslogStateTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, configurationGroup=configurationGroup, routerProtocolsGroup=routerProtocolsGroup, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNTPSync=sNTPSync, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, transmitFreqKHz=transmitFreqKHz, sNMPTrapInternetAddress=sNMPTrapInternetAddress, lowestTDMModulationMode=lowestTDMModulationMode, dfsGroup=dfsGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tdmTable=tdmTable, ethernetPriorityTable=ethernetPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, authorizationControlTableEntry=authorizationControlTableEntry, licenseGroupAccess=licenseGroupAccess, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, tDMChannelLoopback=tDMChannelLoopback, subbandLowestFrequency=subbandLowestFrequency, iPv6GatewayAddress=iPv6GatewayAddress, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, auxPortDisabledWarning=auxPortDisabledWarning, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDControlGroup=tDDControlGroup, systemClock=systemClock, iPDSCPPriorityTable=iPDSCPPriorityTable, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, receiveFreqMHz=receiveFreqMHz, cableDiagPair4Results=cableDiagPair4Results, aAAControlGroup=aAAControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telnetAccessEnabled=telnetAccessEnabled, wirelessOutAllOctets=wirelessOutAllOctets, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syncETrackingState=syncETrackingState, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, pubInstancedStatsTable=pubInstancedStatsTable, licenseSyncESupport=licenseSyncESupport, sNMPTrapTableIndex=sNMPTrapTableIndex, capacityVariantMismatchTrap=capacityVariantMismatchTrap, syslogClientTrap=syslogClientTrap, ethernetStatisticsTable=ethernetStatisticsTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPError=sFPError, whitelistRMEnabled=whitelistRMEnabled, cableDiagPair3Distance=cableDiagPair3Distance, licenseBandwidthCap=licenseBandwidthCap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry)
