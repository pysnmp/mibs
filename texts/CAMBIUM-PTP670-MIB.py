...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dNSServerTableNumber=dNSServerTableNumber, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, productVariant=productVariant, installArmStateTrap=installArmStateTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mABNominalModulationMode=mABNominalModulationMode, latitude=latitude, sNTPState=sNTPState, vLANManagementPriority=vLANManagementPriority, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteMACAddress=remoteMACAddress, sNTPPollInterval=sNTPPollInterval, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, userTableNumber=userTableNumber, linkModeOptimization=linkModeOptimization, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, signalStrengthRatioLinked=signalStrengthRatioLinked, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, cableDiagPair4Results=cableDiagPair4Results, dfsGroup=dfsGroup, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, syslogStateTrap=syslogStateTrap, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseBandwidthCap=licenseBandwidthCap, auxPortAllocation=auxPortAllocation, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseInstancedTableNumber=licenseInstancedTableNumber, ethernetInstancedTableIndex=ethernetInstancedTableIndex, licenseSFPPortSupport=licenseSFPPortSupport, gatewayIPAddress=gatewayIPAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseOOBManagementSupport=licenseOOBManagementSupport, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, antennaSelection=antennaSelection, remoteUnitNameLinked=remoteUnitNameLinked, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, secureModeAlarm=secureModeAlarm, sNMPCommunityString=sNMPCommunityString, userTableEntry=userTableEntry, auxPortSyncERxStatus=auxPortSyncERxStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, auxPortStatus=auxPortStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseGroupAccess=licenseGroupAccess, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, transmitPower=transmitPower, hTTPSAccessEnabled=hTTPSAccessEnabled, resetGroup=resetGroup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, tempPcb=tempPcb, vectorError=vectorError, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, systemClock=systemClock, productName=productName, auxPortStatusTrap=auxPortStatusTrap, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, alarmInstancedTableNumber=alarmInstancedTableNumber, cableDiagnostics=cableDiagnostics, cableDiagPair4Distance=cableDiagPair4Distance, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationStatus=tDDSynchronizationStatus, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, linkLoss=linkLoss, aAAControlGroup=aAAControlGroup, ptpTrapPrefix=ptpTrapPrefix, syslogState=syslogState, receivePowerLinked=receivePowerLinked, mABState=mABState, antennaGain=antennaGain, ptpTraps=ptpTraps, syncEEquipmentClock=syncEEquipmentClock, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, longitude=longitude, packetsToInternalStack=packetsToInternalStack, sFPPortDisabledWarning=sFPPortDisabledWarning, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, installStatusTrap=installStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, bootVersion=bootVersion, mainPSUPortQLRx=mainPSUPortQLRx, whitelistRMEnabled=whitelistRMEnabled, ethernetPriorityTable=ethernetPriorityTable, cableDiagnosticsGroup=cableDiagnosticsGroup, tDDControl=tDDControl, hTTPAccessEnabled=hTTPAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, bridge=bridge, noWirelessChannelAvailable=noWirelessChannelAvailable, phyControlInstancedTable=phyControlInstancedTable, reset=reset, licenseVersion=licenseVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, tDMChannelLoopback=tDMChannelLoopback, authorizationControl=authorizationControl, licenseSyncESupport=licenseSyncESupport, portAllocationMismatch=portAllocationMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, tdmTableNumber=tdmTableNumber, alarms=alarms, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, receiveFreqKHz=receiveFreqKHz, searchState=searchState, sNTPPrimaryServer=sNTPPrimaryServer, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, l2CPPriorityTableEntry=l2CPPriorityTableEntry, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, pubStats=pubStats, dNSServerInternetAddressType=dNSServerInternetAddressType, aAAControl=aAAControl, encryptionAlgorithm=encryptionAlgorithm, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sMTPEmailAlert=sMTPEmailAlert, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tDMInterfaceControl=tDMInterfaceControl, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, versionsGroup=versionsGroup, dfs=dfs, notificationsGroup=notificationsGroup, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseInstancedTableIndex=licenseInstancedTableIndex, sNMPTrapVersion=sNMPTrapVersion, cableDiagPair3Distance=cableDiagPair3Distance, linkName=linkName, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mABProtocolVLANPriority=mABProtocolVLANPriority, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, capacityVariantMismatchLinked=capacityVariantMismatchLinked, dataBridgingAvailability=dataBridgingAvailability, dataPortWirelessDownAlert=dataPortWirelessDownAlert, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, supplementaryGroup=supplementaryGroup, byteErrorRatioLinked=byteErrorRatioLinked, tdmTableIndex=tdmTableIndex, masterSlaveMode=masterSlaveMode, tDMChannelLineCode=tDMChannelLineCode, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, tDM=tDM, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNTPLastSync=sNTPLastSync, receiveModulationModeDetail=receiveModulationModeDetail, transmitDataRate=transmitDataRate, sFPPortAllocation=sFPPortAllocation, mainPSUPortStatus=mainPSUPortStatus, userTable=userTable, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, remoteInternetAddressType=remoteInternetAddressType, dataBridgingStatusAlarm=dataBridgingStatusAlarm, aggregateDataRateLinked=aggregateDataRateLinked, tDMEnabledChannels=tDMEnabledChannels, licenseIEEE1588Support=licenseIEEE1588Support, transmitChannel=transmitChannel, transparentClockVLAN=transparentClockVLAN, apcGroup=apcGroup, syncETrackingState=syncETrackingState, rangingMode=rangingMode, receiveFreqMHz=receiveFreqMHz, ethernetStatisticsDataSource=ethernetStatisticsDataSource, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, targetRange=targetRange, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, secureModeAlarmTrap=secureModeAlarmTrap, ptp670=ptp670, channelBandwidth=channelBandwidth, transparentClockPort=transparentClockPort, syncETracking=syncETracking, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, nIDULanPortStatus=nIDULanPortStatus, tDDSynchronizationMode=tDDSynchronizationMode, altitude=altitude, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, cableDiagPair3Results=cableDiagPair3Results, wirelessTopology=wirelessTopology, snmpControlGroup=snmpControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, daylightSaving=daylightSaving, tDMChannelCableLength=tDMChannelCableLength, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseTrialPeriod=licenseTrialPeriod, dNSServerInternetAddress=dNSServerInternetAddress, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, configurationInstancedTable=configurationInstancedTable, wirelessOutEthernetOctets=wirelessOutEthernetOctets, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, transmitFreqKHz=transmitFreqKHz, iPv4Address=iPv4Address, dfsTableEntry=dfsTableEntry, installStatus=installStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, ptmp=ptmp, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, l2CPPriorityTable=l2CPPriorityTable, vectorErrorLinked=vectorErrorLinked, syslogClient=syslogClient, sNTPServerTable=sNTPServerTable, sFPPortQLTx=sFPPortQLTx, tFTPServerInternetAddress=tFTPServerInternetAddress, phyControlInstancedTableEntry=phyControlInstancedTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, phyStatusGroup=phyStatusGroup, dfsTable=dfsTable, dfsTableIndex=dfsTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortSSMTx=sFPPortSSMTx, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, bridgeGroup=bridgeGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, sNTPServerTimeout=sNTPServerTimeout, lowestDataModulationMode=lowestDataModulationMode, licenseSecurityLevel=licenseSecurityLevel, regulatoryBandTrap=regulatoryBandTrap, phyInstancedStatusTable=phyInstancedStatusTable, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, transmitDataRateLinked=transmitDataRateLinked, hCMPLinkSymmetry=hCMPLinkSymmetry, syncESlavePort=syncESlavePort, maximumTransmitPower=maximumTransmitPower, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sNMPTrapTable=sNMPTrapTable, installStatusLinked=installStatusLinked, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernet=ethernet, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sNMPEnabledTraps=sNMPEnabledTraps, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sMTPEnabledMessages=sMTPEnabledMessages)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseEncryption=licenseEncryption, ethernetGroup=ethernetGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, cableDiagPair2Results=cableDiagPair2Results, ptpCompliance=ptpCompliance, routerProtocolsGroup=routerProtocolsGroup, hardwareVersion=hardwareVersion, channelChangeTrap=channelChangeTrap, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, rangeLinked=rangeLinked, cambium=cambium, deviceESN=deviceESN, dNSServerTableIndex=dNSServerTableIndex, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sFPPortAutoNegotiation=sFPPortAutoNegotiation, remoteUnitName=remoteUnitName, mainPSUPortAllocation=mainPSUPortAllocation, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseGasGroup=licenseGasGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, alarmInstancedTableIndex=alarmInstancedTableIndex, blacklistRMMacAddress=blacklistRMMacAddress, mABMaintenanceLevel=mABMaintenanceLevel, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, useVLANForManagementInterfaces=useVLANForManagementInterfaces, capacityVariantMismatch=capacityVariantMismatch, aggregateDataRate=aggregateDataRate, mABProtocolVID=mABProtocolVID, licenseInstancedTable=licenseInstancedTable, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, portAllocationMismatchLinked=portAllocationMismatchLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, authorizationControlGroup=authorizationControlGroup, iPv6PrefixLength=iPv6PrefixLength, tDMChannelStatusTrap=tDMChannelStatusTrap, eIRP=eIRP, sNTPServerTableIndex=sNTPServerTableIndex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, configurationInstancedTableNumber=configurationInstancedTableNumber, userTableIndex=userTableIndex, alarmInstancedTableEntry=alarmInstancedTableEntry, dfsTableNumber=dfsTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, authorizationControlTableNumber=authorizationControlTableNumber, encryption=encryption, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, configurationInstancedTableEntry=configurationInstancedTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, rawReceivePower=rawReceivePower, tDMInterfaceStatus=tDMInterfaceStatus, unitName=unitName, severelyErroredSeconds=severelyErroredSeconds, alarmsGroup=alarmsGroup, phyStatus=phyStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, accessMethod=accessMethod, erroredSeconds=erroredSeconds, cableDiagPair2Distance=cableDiagPair2Distance, licenseTDDSyncSupport=licenseTDDSyncSupport, cableLoss=cableLoss, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mainPSUPortQLTx=mainPSUPortQLTx, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, userRole=userRole, userEnabled=userEnabled, ptpGroups=ptpGroups, versions=versions, management=management, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, authorizationMethod=authorizationMethod, rxColorCode=rxColorCode, portAllocationMismatchTrap=portAllocationMismatchTrap, transparentClock=transparentClock, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, ethernetInstancedTable=ethernetInstancedTable, transmitModulationModeLinked=transmitModulationModeLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, auxPortQLRx=auxPortQLRx, licenseIPv6Support=licenseIPv6Support, lowestTDMModulationMode=lowestTDMModulationMode, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, alarmInstancedTable=alarmInstancedTable, PYSNMP_MODULE_ID=cambium, license=license, routerProtocols=routerProtocols, mPLSTCPriorityTable=mPLSTCPriorityTable, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, cableDiagPair1Distance=cableDiagPair1Distance, apc=apc, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitFreqMHz=transmitFreqMHz, sNMPv3Enable=sNMPv3Enable, dNSServerTable=dNSServerTable, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dNSServerTableEntry=dNSServerTableEntry, syslogControlGroup=syslogControlGroup, syslogClientTrap=syslogClientTrap, secondarySoftwareVersion=secondarySoftwareVersion, deviceMACAddress=deviceMACAddress, phyControlGroup=phyControlGroup, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, telnetAccessEnabled=telnetAccessEnabled, signalStrengthRatio=signalStrengthRatio, configurationInstancedTableIndex=configurationInstancedTableIndex, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, rawReceivePowerLinked=rawReceivePowerLinked, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dNSPrimaryServer=dNSPrimaryServer, hCMPMaximumLinkRange=hCMPMaximumLinkRange, regulatoryBand=regulatoryBand, groupID=groupID, sNTPServerInternetAddress=sNTPServerInternetAddress, receiveDataRate=receiveDataRate, mgmtInstancedTableNumber=mgmtInstancedTableNumber, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, tDDControlGroup=tDDControlGroup, subbandHighestFrequency=subbandHighestFrequency, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, managementGroup=managementGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, cableDiagPair1Results=cableDiagPair1Results, wirelessLinkStatusLinked=wirelessLinkStatusLinked, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, unitIdentificationGroup=unitIdentificationGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseCountry=licenseCountry, licenseInstancedTableEntry=licenseInstancedTableEntry, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, encryptionGroup=encryptionGroup, packetsFromInternalStack=packetsFromInternalStack, enableTransmission=enableTransmission, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, sFPErrorTrap=sFPErrorTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tFTPServerPortNumber=tFTPServerPortNumber, configuration=configuration, mgmtInstancedTableIndex=mgmtInstancedTableIndex, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, wirelessOutOctets=wirelessOutOctets, supplementary=supplementary, ethernetPriorityTableIndex=ethernetPriorityTableIndex, remoteInternetAddress=remoteInternetAddress, tDMConfigurationMismatch=tDMConfigurationMismatch, txColorCode=txColorCode, timeZone=timeZone, targetMACAddress=targetMACAddress, sFPPortQLRx=sFPPortQLRx, mgmtInstancedTable=mgmtInstancedTable, sNMPPortNumber=sNMPPortNumber, dNSGroup=dNSGroup, pubStatsGroup=pubStatsGroup, ethernetInstancedTableEntry=ethernetInstancedTableEntry, transparentClockVID=transparentClockVID, frequencyVariant=frequencyVariant, sFPPortAutoMdix=sFPPortAutoMdix, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, licenseHCMPSupport=licenseHCMPSupport, byteErrorRatio=byteErrorRatio, receivePower=receivePower, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, pubInstancedStatsTable=pubInstancedStatsTable, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sntpGroup=sntpGroup, authorizationControlTableEntry=authorizationControlTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, smtpGroup=smtpGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, hTTPPortNumber=hTTPPortNumber, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sNTPServerRetries=sNTPServerRetries, remoteMACAddressLinked=remoteMACAddressLinked, mABTransmissionInterval=mABTransmissionInterval, txMABFrames=txMABFrames, ptp=ptp, transmitModulationMode=transmitModulationMode, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, vLANManagementVID=vLANManagementVID, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mABHoldoffPeriod=mABHoldoffPeriod, blacklistRMEnabled=blacklistRMEnabled, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, auxPortDisabledWarning=auxPortDisabledWarning, userPassword=userPassword, installationMode=installationMode, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dNS=dNS, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, transmitPowerLinked=transmitPowerLinked, sNTPServerTableNumber=sNTPServerTableNumber, dNSServerPortNumber=dNSServerPortNumber, sNTPSyncTrap=sNTPSyncTrap, sNTPServerStatus=sNTPServerStatus, sFPPortStatusTrap=sFPPortStatusTrap, receiveDataRateLinked=receiveDataRateLinked, tdmTable=tdmTable, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, syslogControl=syslogControl, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sntp=sntp, snmpControl=snmpControl, iPDSCPPriorityTable=iPDSCPPriorityTable, tDMGroup=tDMGroup, phyControl=phyControl, useVLANForMABProtocol=useVLANForMABProtocol, lbtDetectedTrap=lbtDetectedTrap, unitIdentification=unitIdentification, licenseMaxLinkRange=licenseMaxLinkRange, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, authorizationControlTableIndex=authorizationControlTableIndex, dfsPeaks=dfsPeaks, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sFPError=sFPError, systemReset=systemReset, tFTPClient=tFTPClient, wirelessOutAllOctets=wirelessOutAllOctets, tFTPServerInternetAddressType=tFTPServerInternetAddressType, range=range, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, searchStateLinked=searchStateLinked, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseIssueNumber=licenseIssueNumber, receiveChannel=receiveChannel, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, userName=userName, configurationGroup=configurationGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, authorizationControlTable=authorizationControlTable, localPacketFiltering=localPacketFiltering, extendedSpectrumScanning=extendedSpectrumScanning, dataPortPauseFrames=dataPortPauseFrames, licenseUnitSerialNumber=licenseUnitSerialNumber, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPVersion=iPVersion, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sFPPortStatus=sFPPortStatus, hTTPSPortNumber=hTTPSPortNumber, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sNMPTrapInternetAddress=sNMPTrapInternetAddress, subbandLowestFrequency=subbandLowestFrequency, auxPortQLTx=auxPortQLTx, capacityVariantMismatchTrap=capacityVariantMismatchTrap, cableDiagnosticsControl=cableDiagnosticsControl, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, licenseCapacity=licenseCapacity, transmitterChannels=transmitterChannels, dfsMeans=dfsMeans, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkLossLinked=linkLossLinked, sNTPSync=sNTPSync, oOBPriorityQueueMapping=oOBPriorityQueueMapping, mainPSUPortAutoMdix=mainPSUPortAutoMdix, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, smtp=smtp, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDMChannelStatus=tDMChannelStatus, licenseGroup=licenseGroup, nIDULanPortStatusTrap=nIDULanPortStatusTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, ethernetStatisticsTable=ethernetStatisticsTable, softwareVersion=softwareVersion, iPv6GatewayAddress=iPv6GatewayAddress, dNSResolver=dNSResolver, sNTPServerTableEntry=sNTPServerTableEntry, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, dataBridgingStatus=dataBridgingStatus, licenseTLSRekey=licenseTLSRekey, tdmTableEntry=tdmTableEntry, telnetPortNumber=telnetPortNumber, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, iPv6Address=iPv6Address, auxPortSSMTx=auxPortSSMTx, licenseRARSupport=licenseRARSupport, receiveModulationModeLinked=receiveModulationModeLinked, remoteInternetAddressLinked=remoteInternetAddressLinked, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, deviceMSN=deviceMSN, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, unavailableSeconds=unavailableSeconds, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, whitelistRMMacAddress=whitelistRMMacAddress, linkSymmetry=linkSymmetry, subnetMask=subnetMask, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, siteName=siteName, maximumNumberOfSlaves=maximumNumberOfSlaves, cableDiagnosticsWarning=cableDiagnosticsWarning)
