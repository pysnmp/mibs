...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, Gauge32, TimeTicks, enterprises, Bits, MibIdentifier, IpAddress, iso, NotificationType, ObjectIdentity, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "Gauge32", "TimeTicks", "enterprises", "Bits", "MibIdentifier", "IpAddress", "iso", "NotificationType", "ObjectIdentity", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", receiveModulationModeDetail=receiveModulationModeDetail, cableDiagnosticsPorts=cableDiagnosticsPorts, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, cableDiagPair2Results=cableDiagPair2Results, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, vectorError=vectorError, deviceMSN=deviceMSN, sntp=sntp, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseIEEE1588Support=licenseIEEE1588Support, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNMPCommunityString=sNMPCommunityString, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, receiveModulationModeLinked=receiveModulationModeLinked, deviceMACAddress=deviceMACAddress, channelBandwidth=channelBandwidth, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, accessMethod=accessMethod, systemReset=systemReset, ptmp=ptmp, versions=versions, mABNominalTransmitCapacity=mABNominalTransmitCapacity, syslogStateTrap=syslogStateTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tdmTableNumber=tdmTableNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, maximumNumberOfSlaves=maximumNumberOfSlaves, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, capacityVariantMismatch=capacityVariantMismatch, whitelistRMMacAddress=whitelistRMMacAddress, phyControlInstancedTableIndex=phyControlInstancedTableIndex, groupID=groupID, mainPSUPortQLRx=mainPSUPortQLRx, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, userTableIndex=userTableIndex, syncEEquipmentClock=syncEEquipmentClock, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, blacklistRMEnabled=blacklistRMEnabled, dNSResolver=dNSResolver, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, routerProtocols=routerProtocols, hTTPSPortNumber=hTTPSPortNumber, transmitPowerLinked=transmitPowerLinked, remoteMACAddress=remoteMACAddress, linkModeOptimization=linkModeOptimization, licenseCountry=licenseCountry, dataBridgingStatusAlarm=dataBridgingStatusAlarm, ethernetGroup=ethernetGroup, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, pubInstancedStatsTable=pubInstancedStatsTable, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseEncryption=licenseEncryption, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDMChannelLineCode=tDMChannelLineCode, licenseMaxLinkRange=licenseMaxLinkRange, auxPortAllocation=auxPortAllocation, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, managementNetworkAccessEnabled=managementNetworkAccessEnabled, dataBridgingAvailability=dataBridgingAvailability, tDDSynchronizationMode=tDDSynchronizationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, syncESlavePort=syncESlavePort, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseInstancedTableIndex=licenseInstancedTableIndex, transmitChannel=transmitChannel, licenseRegulatoryBandsList=licenseRegulatoryBandsList, deviceESN=deviceESN, rawReceivePower=rawReceivePower, managementGroup=managementGroup, phyControlInstancedTableNumber=phyControlInstancedTableNumber, transmitDataRateLinked=transmitDataRateLinked, sFPPortQLRx=sFPPortQLRx, eIRP=eIRP, channelChangeTrap=channelChangeTrap, ethernetInstancedTableEntry=ethernetInstancedTableEntry, regulatoryBandTrap=regulatoryBandTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitFreqKHz=transmitFreqKHz, cableDiagPair2Distance=cableDiagPair2Distance, dNSPrimaryServer=dNSPrimaryServer, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseVersion=licenseVersion, masterSlaveMode=masterSlaveMode, unitIdentification=unitIdentification, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, secureModeAlarm=secureModeAlarm, byteErrorRatio=byteErrorRatio, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, longitude=longitude, dfsPeaks=dfsPeaks, versionsGroup=versionsGroup, dfsGroup=dfsGroup, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, auxPortAcceptedQLRx=auxPortAcceptedQLRx, alarmInstancedTableNumber=alarmInstancedTableNumber, subbandLowestFrequency=subbandLowestFrequency, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetInstancedTableIndex=ethernetInstancedTableIndex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, userName=userName, unitOutOfCalibration=unitOutOfCalibration, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseOOBManagementSupport=licenseOOBManagementSupport, targetMACAddress=targetMACAddress, dfsTableEntry=dfsTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, transmitterChannels=transmitterChannels, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, installStatusTrap=installStatusTrap, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, routerProtocolsGroup=routerProtocolsGroup, dfsTableNumber=dfsTableNumber, vectorErrorLinked=vectorErrorLinked, auxPortQLRx=auxPortQLRx, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sFPPortAutoMdix=sFPPortAutoMdix, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNMPTrapTable=sNMPTrapTable, enableTransmission=enableTransmission, apcGroup=apcGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPState=sNTPState, softwareVersion=softwareVersion, mABProtocolVID=mABProtocolVID, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPv6GatewayAddress=iPv6GatewayAddress, hTTPAccessEnabled=hTTPAccessEnabled, transmitModulationModeLinked=transmitModulationModeLinked, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, syslogState=syslogState, tFTPServerInternetAddress=tFTPServerInternetAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, sFPPortAllocation=sFPPortAllocation, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, unitName=unitName, sMTPEmailAlert=sMTPEmailAlert, whitelistRMEnabled=whitelistRMEnabled, ethernetPriorityTableEntry=ethernetPriorityTableEntry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, hardwareVersion=hardwareVersion, userEnabled=userEnabled, packetsFromInternalStack=packetsFromInternalStack, sFPErrorTrap=sFPErrorTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, receiveFreqMHz=receiveFreqMHz, configurationInstancedTable=configurationInstancedTable, aggregateDataRate=aggregateDataRate, licenseTrialPeriod=licenseTrialPeriod, sNTPServerTableNumber=sNTPServerTableNumber, mABNominalModulationMode=mABNominalModulationMode, iPv6Address=iPv6Address, gatewayIPAddress=gatewayIPAddress, mgmtInstancedTableNumber=mgmtInstancedTableNumber, receiveDataRateLinked=receiveDataRateLinked, qOSPriorityScheme=qOSPriorityScheme, blacklistRMMacAddress=blacklistRMMacAddress, unitIdentificationGroup=unitIdentificationGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, alarms=alarms, sNTPServerTableIndex=sNTPServerTableIndex, dfsTableIndex=dfsTableIndex, mABHoldoffPeriod=mABHoldoffPeriod, dNSServerPortNumber=dNSServerPortNumber, dfsMeans=dfsMeans, transmitFreqMHz=transmitFreqMHz, auxPortStatus=auxPortStatus, encryptionAlgorithm=encryptionAlgorithm, pubStatsGroup=pubStatsGroup, sNMPEnabledTraps=sNMPEnabledTraps, tDMChannelLoopback=tDMChannelLoopback, remoteInternetAddressLinked=remoteInternetAddressLinked, dNSServerTableNumber=dNSServerTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemClock=systemClock, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, receiveModulationMode=receiveModulationMode, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, transparentClockPort=transparentClockPort, ptpCompliance=ptpCompliance, hTTPPortNumber=hTTPPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, byteErrorRatioLinked=byteErrorRatioLinked, wirelessOutAllOctets=wirelessOutAllOctets, tDMInterfaceControl=tDMInterfaceControl, tDMChannelCableLength=tDMChannelCableLength, mgmtInstancedTableIndex=mgmtInstancedTableIndex, iPVersion=iPVersion, lowestDataModulationMode=lowestDataModulationMode, auxPortStatusTrap=auxPortStatusTrap, sNMPTrapVersion=sNMPTrapVersion, sMTPEnabledMessages=sMTPEnabledMessages, licenseIssueNumber=licenseIssueNumber, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, remoteUnitName=remoteUnitName, licenseInstancedTableEntry=licenseInstancedTableEntry, packetsToInternalStack=packetsToInternalStack, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, alarmInstancedTable=alarmInstancedTable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, secondarySoftwareVersion=secondarySoftwareVersion, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, bootVersion=bootVersion, tdmTableIndex=tdmTableIndex, alarmInstancedTableEntry=alarmInstancedTableEntry, telnetPortNumber=telnetPortNumber, tDMInterfaceStatus=tDMInterfaceStatus, ethernet=ethernet, ethernetStatisticsTable=ethernetStatisticsTable, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortAllocation=mainPSUPortAllocation, bridgeGroup=bridgeGroup, useVLANForMABProtocol=useVLANForMABProtocol, sNMPTrapTableNumber=sNMPTrapTableNumber, tDMChannelStatus=tDMChannelStatus, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, tempPcb=tempPcb, rangeLinked=rangeLinked, userTableNumber=userTableNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseGroupAccess=licenseGroupAccess, dNSServerInternetAddress=dNSServerInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", syncETracking=syncETracking, encryptionGroup=encryptionGroup, tDMConfigurationMismatch=tDMConfigurationMismatch, installArmState=installArmState, transmitModulationMode=transmitModulationMode, timeZone=timeZone, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aAAControlGroup=aAAControlGroup, regulatoryBand=regulatoryBand, installStatus=installStatus, linkLossLinked=linkLossLinked, userTable=userTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, syslogClientTrap=syslogClientTrap, reset=reset, sNTPServerStatus=sNTPServerStatus, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, nIDULanPortStatusTrap=nIDULanPortStatusTrap, phyControlGroup=phyControlGroup, rangingMode=rangingMode, authorizationControl=authorizationControl, tDMChannelStatusTrap=tDMChannelStatusTrap, capacityVariantMismatchLinked=capacityVariantMismatchLinked, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, wirelessOutOctets=wirelessOutOctets, mABState=mABState, authorizationControlTableEntry=authorizationControlTableEntry, configurationGroup=configurationGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkSymmetry=linkSymmetry, unavailableSeconds=unavailableSeconds, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tFTPClient=tFTPClient, phyStatusGroup=phyStatusGroup, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, auxPortSSMTx=auxPortSSMTx, siteName=siteName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transparentClockVID=transparentClockVID, configurationInstancedTableEntry=configurationInstancedTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, phyControl=phyControl, snmpControlGroup=snmpControlGroup, mainPSUPortQLTx=mainPSUPortQLTx, cableDiagPair3Distance=cableDiagPair3Distance, configuration=configuration, receiveFreqKHz=receiveFreqKHz, wirelessLinkAvailability=wirelessLinkAvailability, userPassword=userPassword, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, altitude=altitude, supplementary=supplementary, cableDiagPair1Distance=cableDiagPair1Distance, auxPortDisabledWarning=auxPortDisabledWarning, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, aggregateDataRateLinked=aggregateDataRateLinked, cableDiagPair4Results=cableDiagPair4Results, receivePowerLinked=receivePowerLinked, sNTPPollInterval=sNTPPollInterval, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNTPLastSync=sNTPLastSync, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, productVariant=productVariant, tDDControl=tDDControl, cableDiagPair3Results=cableDiagPair3Results, configurationInstancedTableNumber=configurationInstancedTableNumber, pubStats=pubStats, sFPPortDisabledWarning=sFPPortDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerPortNumber=sNTPServerPortNumber, nIDULanPortStatus=nIDULanPortStatus, licenseInstancedTableNumber=licenseInstancedTableNumber, licenseRARSupport=licenseRARSupport, licenseGasGroup=licenseGasGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitPower=transmitPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, alarmInstancedTableIndex=alarmInstancedTableIndex, erroredSeconds=erroredSeconds, productName=productName, range=range, supplementaryGroup=supplementaryGroup, phyStatus=phyStatus, cableDiagnosticsWarning=cableDiagnosticsWarning, dNSServerTableEntry=dNSServerTableEntry, resetGroup=resetGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPv6PrefixLength=iPv6PrefixLength, telnetAccessEnabled=telnetAccessEnabled, daylightSaving=daylightSaving, mainPSUPortStatusTrap=mainPSUPortStatusTrap, alarmsGroup=alarmsGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, l2CPPriorityTableNumber=l2CPPriorityTableNumber, wirelessTopology=wirelessTopology, licenseGroup=licenseGroup, ptp670=ptp670, frequencyVariant=frequencyVariant, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, userTableEntry=userTableEntry, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, syncETrackingState=syncETrackingState, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sNMPPortNumber=sNMPPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sNMPTrapTableEntry=sNMPTrapTableEntry, installStatusLinked=installStatusLinked, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, dNS=dNS, tdmTable=tdmTable, dfs=dfs, ptpTraps=ptpTraps, tDMGroup=tDMGroup, licenseTDDSyncSupport=licenseTDDSyncSupport, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseTLSRekey=licenseTLSRekey, cableLoss=cableLoss, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, antennaSelection=antennaSelection, sFPPortStatusTrap=sFPPortStatusTrap, sNTPServerTimeout=sNTPServerTimeout, portAllocationMismatch=portAllocationMismatch, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseHCMPSupport=licenseHCMPSupport, dNSServerInternetAddressType=dNSServerInternetAddressType, ptpTrapPrefix=ptpTrapPrefix, mABProtocolVLANPriority=mABProtocolVLANPriority, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, mainPSUPortStatus=mainPSUPortStatus, transparentClockVLAN=transparentClockVLAN, licenseSFPPortSupport=licenseSFPPortSupport, cableDiagnosticsControl=cableDiagnosticsControl, oOBPriorityQueueMapping=oOBPriorityQueueMapping, latitude=latitude, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, syslogControl=syslogControl, txColorCode=txColorCode, remoteInternetAddressType=remoteInternetAddressType, sFPPortSSMTx=sFPPortSSMTx, severelyErroredSeconds=severelyErroredSeconds, tDDControlGroup=tDDControlGroup, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dNSServerTableIndex=dNSServerTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveDataRate=receiveDataRate, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, portAllocationMismatchTrap=portAllocationMismatchTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sNTPServerRetries=sNTPServerRetries, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sNTPPrimaryServer=sNTPPrimaryServer, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, dNSServerTable=dNSServerTable, rawReceivePowerLinked=rawReceivePowerLinked, sMTPSourceEmailAddress=sMTPSourceEmailAddress, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, receivePower=receivePower, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, installArmStateTrap=installArmStateTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseSecurityLevel=licenseSecurityLevel, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, linkName=linkName, extendedSpectrumScanning=extendedSpectrumScanning, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, portAllocationMismatchLinked=portAllocationMismatchLinked, snmpControl=snmpControl, mgmtInstancedTableEntry=mgmtInstancedTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sFPPortStatus=sFPPortStatus, wirelessLinkStatusLinked=wirelessLinkStatusLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseSyncESupport=licenseSyncESupport, useVLANForManagementInterfaces=useVLANForManagementInterfaces, searchStateLinked=searchStateLinked, syslogControlGroup=syslogControlGroup, aAAControl=aAAControl, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, authorizationControlTableNumber=authorizationControlTableNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, notificationsGroup=notificationsGroup, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, authorizationControlTableIndex=authorizationControlTableIndex, hCMPLinkSymmetry=hCMPLinkSymmetry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tdmTableEntry=tdmTableEntry, tDM=tDM, sNMPv3Enable=sNMPv3Enable, wirelessLinkStatus=wirelessLinkStatus, phyInstancedStatusTable=phyInstancedStatusTable, management=management, remoteUnitNameLinked=remoteUnitNameLinked, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNTPServerTable=sNTPServerTable, vLANManagementPriority=vLANManagementPriority, l2CPPriorityTableIndex=l2CPPriorityTableIndex, vLANManagementVID=vLANManagementVID, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, installationMode=installationMode, smtp=smtp, mABMaintenanceLevel=mABMaintenanceLevel, licenseBandwidthCap=licenseBandwidthCap, phyControlInstancedTable=phyControlInstancedTable, maximumTransmitPower=maximumTransmitPower, transparentClock=transparentClock, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNTPSync=sNTPSync, ptpGroups=ptpGroups, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, iPv4Address=iPv4Address, dNSGroup=dNSGroup, sNTPServerTableEntry=sNTPServerTableEntry, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, license=license, signalStrengthRatioLinked=signalStrengthRatioLinked, mABTransmissionInterval=mABTransmissionInterval, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, lbtDetectedTrap=lbtDetectedTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, cableDiagPair1Results=cableDiagPair1Results, ethernetPriorityTable=ethernetPriorityTable, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, antennaGain=antennaGain, remoteMACAddressLinked=remoteMACAddressLinked, subnetMask=subnetMask, searchState=searchState, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, dataBridgingStatus=dataBridgingStatus, localPacketFiltering=localPacketFiltering, secureModeAlarmTrap=secureModeAlarmTrap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, receiveChannel=receiveChannel, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, remoteInternetAddress=remoteInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, signalStrengthRatio=signalStrengthRatio, wirelessOutEthernetOctets=wirelessOutEthernetOctets, cableDiagnostics=cableDiagnostics, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tDMEnabledChannels=tDMEnabledChannels, apc=apc, licenseIPv6Support=licenseIPv6Support, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, targetRange=targetRange, licenseInstancedTable=licenseInstancedTable, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, txMABFrames=txMABFrames, mainPSUPortSSMTx=mainPSUPortSSMTx, nIDULanPortAutoMdix=nIDULanPortAutoMdix, configurationInstancedTableIndex=configurationInstancedTableIndex, PYSNMP_MODULE_ID=cambium, sNTPSyncTrap=sNTPSyncTrap, bridge=bridge, sNMPTrapTableIndex=sNMPTrapTableIndex, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userRole=userRole, capacityVariantMismatchTrap=capacityVariantMismatchTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetInstancedTable=ethernetInstancedTable, auxPortQLTx=auxPortQLTx, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTable=dfsTable, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sntpGroup=sntpGroup, sFPError=sFPError, authorizationControlGroup=authorizationControlGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, dSCPManagementPriority=dSCPManagementPriority, syslogClient=syslogClient, mgmtInstancedTable=mgmtInstancedTable, lowestTDMModulationMode=lowestTDMModulationMode, rxColorCode=rxColorCode, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, encryption=encryption, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dataPortPauseFrames=dataPortPauseFrames, authorizationMethod=authorizationMethod, cambium=cambium, sFPPortQLTx=sFPPortQLTx, l2CPPriorityTable=l2CPPriorityTable, authorizationControlTable=authorizationControlTable, linkLoss=linkLoss, ptp=ptp, transmitDataRate=transmitDataRate, smtpGroup=smtpGroup, subbandHighestFrequency=subbandHighestFrequency, licenseCapacity=licenseCapacity, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets)
