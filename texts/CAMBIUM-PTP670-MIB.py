...
# Produced by pysmi-1.1.12 at Tue May 28 12:32:14 2024
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", configurationInstancedTable=configurationInstancedTable, receiveModulationMode=receiveModulationMode, syslogControl=syslogControl, auxPortQLRx=auxPortQLRx, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, apc=apc, ptpCompliance=ptpCompliance, latitude=latitude, wirelessLinkStatusLinked=wirelessLinkStatusLinked, dNSPrimaryServer=dNSPrimaryServer, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseCountry=licenseCountry, remoteMACAddress=remoteMACAddress, sNMPTrapTable=sNMPTrapTable, authorizationControlTable=authorizationControlTable, tDMEnabledChannels=tDMEnabledChannels, daylightSaving=daylightSaving, auxPortStatus=auxPortStatus, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, phyStatus=phyStatus, linkName=linkName, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, iPVersion=iPVersion, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syncETracking=syncETracking, byteErrorRatioLinked=byteErrorRatioLinked, dNS=dNS, txMABFrames=txMABFrames, authorizationControlTableEntry=authorizationControlTableEntry, deviceMACAddress=deviceMACAddress, mgmtInstancedTableNumber=mgmtInstancedTableNumber, whitelistRMEnabled=whitelistRMEnabled, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseTrialPeriod=licenseTrialPeriod, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, cableDiagPair3Distance=cableDiagPair3Distance, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, signalStrengthRatio=signalStrengthRatio, receiveDataRate=receiveDataRate, packetsFromInternalStack=packetsFromInternalStack, authorizationControlTableNumber=authorizationControlTableNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNTPServerStatus=sNTPServerStatus, routerProtocolsGroup=routerProtocolsGroup, lowestDataModulationMode=lowestDataModulationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, regulatoryBand=regulatoryBand, auxPortStatusTrap=auxPortStatusTrap, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sFPPortAllocation=sFPPortAllocation, configuration=configuration, userTableNumber=userTableNumber, licenseSFPPortSupport=licenseSFPPortSupport, tDMChannelStatusTrap=tDMChannelStatusTrap, signalStrengthRatioLinked=signalStrengthRatioLinked, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogStateTrap=syslogStateTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sNTPServerTableIndex=sNTPServerTableIndex, tdmTable=tdmTable, sFPErrorTrap=sFPErrorTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, mainPSUPortStatus=mainPSUPortStatus, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableDiagnosticsControl=cableDiagnosticsControl, auxPortDisabledWarning=auxPortDisabledWarning, sntpGroup=sntpGroup, linkSymmetry=linkSymmetry, dfsTableIndex=dfsTableIndex, ethernetInstancedTableIndex=ethernetInstancedTableIndex, hTTPPortNumber=hTTPPortNumber, deviceESN=deviceESN, alarms=alarms, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNTPServerTimeout=sNTPServerTimeout, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, blacklistRMEnabled=blacklistRMEnabled, ethernet=ethernet, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, alarmInstancedTableNumber=alarmInstancedTableNumber, byteErrorRatio=byteErrorRatio, telnetAccessEnabled=telnetAccessEnabled, ethernetGroup=ethernetGroup, ethernetInstancedTable=ethernetInstancedTable, licenseOOBManagementSupport=licenseOOBManagementSupport, mABProtocolVLANPriority=mABProtocolVLANPriority, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, eIRP=eIRP, bridge=bridge, sFPPortStatus=sFPPortStatus, apcGroup=apcGroup, rawReceivePowerLinked=rawReceivePowerLinked, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, vLANManagementVID=vLANManagementVID, ptpTraps=ptpTraps, encryptionGroup=encryptionGroup, dNSResolver=dNSResolver, bridgeGroup=bridgeGroup, portAllocationMismatch=portAllocationMismatch, cableLoss=cableLoss, capacityVariantMismatchTrap=capacityVariantMismatchTrap, timeZone=timeZone, cableDiagnosticsGroup=cableDiagnosticsGroup, versionsGroup=versionsGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation, authorizationControlGroup=authorizationControlGroup, aggregateDataRateLinked=aggregateDataRateLinked, dfsGroup=dfsGroup, tdmTableNumber=tdmTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, aAAControlGroup=aAAControlGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, blacklistRMMacAddress=blacklistRMMacAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, linkLossLinked=linkLossLinked, sNTPPrimaryServer=sNTPPrimaryServer, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tdmTableIndex=tdmTableIndex, dNSServerTableEntry=dNSServerTableEntry, nIDULanPortStatus=nIDULanPortStatus, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, userName=userName, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, unitName=unitName, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, installationMode=installationMode, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mgmtInstancedTableEntry=mgmtInstancedTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPPortQLRx=sFPPortQLRx, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, channelChangeTrap=channelChangeTrap, dataBridgingAvailability=dataBridgingAvailability, supplementaryGroup=supplementaryGroup, management=management, mgmtInstancedTableIndex=mgmtInstancedTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkLoss=linkLoss, dataBridgingStatus=dataBridgingStatus, secondarySoftwareVersion=secondarySoftwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, frequencyVariant=frequencyVariant, cambium=cambium, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mainPSUPortAutoMdix=mainPSUPortAutoMdix, rawReceivePower=rawReceivePower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseIPv6Support=licenseIPv6Support, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, installStatusLinked=installStatusLinked, wirelessOutAllOctets=wirelessOutAllOctets, dfsTableEntry=dfsTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, sNTPPollInterval=sNTPPollInterval, tdmTableEntry=tdmTableEntry, ptmp=ptmp, pubStatsGroup=pubStatsGroup, wirelessOutEthernetOctets=wirelessOutEthernetOctets, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, cableDiagnostics=cableDiagnostics, hCMPMaximumLinkRange=hCMPMaximumLinkRange, authorizationControlTableIndex=authorizationControlTableIndex, secureModeAlarm=secureModeAlarm, softwareVersion=softwareVersion, configurationInstancedTableNumber=configurationInstancedTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, phyControlInstancedTableEntry=phyControlInstancedTableEntry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mABHoldoffPeriod=mABHoldoffPeriod, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseGroup=licenseGroup, dNSServerPortNumber=dNSServerPortNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, capacityVariantMismatch=capacityVariantMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, ptp=ptp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hCMPLinkSymmetry=hCMPLinkSymmetry, telnetPortNumber=telnetPortNumber, dataPortPauseFrames=dataPortPauseFrames, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, groupID=groupID, phyControlInstancedTableNumber=phyControlInstancedTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, portAllocationMismatchTrap=portAllocationMismatchTrap, transmitChannel=transmitChannel, routerProtocols=routerProtocols, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, encryptionAlgorithm=encryptionAlgorithm, license=license, rangingMode=rangingMode, siteName=siteName, syncESlavePort=syncESlavePort, sFPPortQLTx=sFPPortQLTx, auxPortAllocation=auxPortAllocation, sNTPState=sNTPState, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, qOSPriorityScheme=qOSPriorityScheme, auxPortQLTx=auxPortQLTx, cableDiagPair4Results=cableDiagPair4Results, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, syncEEquipmentClock=syncEEquipmentClock, aAAControl=aAAControl, ethernetInstancedTableNumber=ethernetInstancedTableNumber, productName=productName, mainPSUPortQLRx=mainPSUPortQLRx, accessMethod=accessMethod, searchStateLinked=searchStateLinked, sNMPPortNumber=sNMPPortNumber, installStatusTrap=installStatusTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tDMGroup=tDMGroup, remoteInternetAddress=remoteInternetAddress, cableDiagPair3Results=cableDiagPair3Results, mABProtocolVID=mABProtocolVID, mABMaintenanceLevel=mABMaintenanceLevel, bootVersion=bootVersion, auxPortSSMTx=auxPortSSMTx, sFPPortDisabledWarning=sFPPortDisabledWarning, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, tDMChannelStatus=tDMChannelStatus, mABTransmissionInterval=mABTransmissionInterval, sNTPServerTable=sNTPServerTable, licenseBandwidthCap=licenseBandwidthCap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transmitPower=transmitPower, snmpControl=snmpControl, remoteMACAddressLinked=remoteMACAddressLinked, phyControlInstancedTable=phyControlInstancedTable, tDMConfigurationMismatch=tDMConfigurationMismatch, PYSNMP_MODULE_ID=cambium, cableDiagPair1Results=cableDiagPair1Results, licenseIEEE1588Support=licenseIEEE1588Support, dfsMeans=dfsMeans, transmitModulationMode=transmitModulationMode, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, ethernetPriorityTable=ethernetPriorityTable, wirelessLinkStatus=wirelessLinkStatus, transmitterChannels=transmitterChannels, alarmInstancedTable=alarmInstancedTable, hTTPSPortNumber=hTTPSPortNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, transmitDataRate=transmitDataRate, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, auxPortSyncERxStatus=auxPortSyncERxStatus, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, receiveDataRateLinked=receiveDataRateLinked, userEnabled=userEnabled, pubInstancedStatsTable=pubInstancedStatsTable, transparentClockVLAN=transparentClockVLAN, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseVersion=licenseVersion, resetGroup=resetGroup, regulatoryBandTrap=regulatoryBandTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, useVLANForMABProtocol=useVLANForMABProtocol, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, vLANManagementPriority=vLANManagementPriority, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sFPPortStatusTrap=sFPPortStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControlGroup=phyControlGroup, licenseGroupAccess=licenseGroupAccess, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, authorizationControl=authorizationControl, transparentClockVID=transparentClockVID, remoteUnitNameLinked=remoteUnitNameLinked, transmitModulationModeLinked=transmitModulationModeLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPv6PrefixLength=iPv6PrefixLength, erroredSeconds=erroredSeconds, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, installArmStateTrap=installArmStateTrap, sMTPEmailAlert=sMTPEmailAlert, sNMPEnabledTraps=sNMPEnabledTraps, licenseInstancedTableNumber=licenseInstancedTableNumber, dfsTable=dfsTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveModulationModeDetail=receiveModulationModeDetail, dNSServerTableIndex=dNSServerTableIndex, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, userTable=userTable, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableNumber=dfsTableNumber, antennaGain=antennaGain, sFPPortSyncERxStatus=sFPPortSyncERxStatus, dfs=dfs, transparentClockPort=transparentClockPort, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, dNSServerTable=dNSServerTable, tDMInterfaceControl=tDMInterfaceControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, gatewayIPAddress=gatewayIPAddress, configurationGroup=configurationGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveChannel=receiveChannel, tFTPClient=tFTPClient, sFPPortAutoMdix=sFPPortAutoMdix, range=range, tFTPServerInternetAddressType=tFTPServerInternetAddressType, extendedSpectrumScanning=extendedSpectrumScanning, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, incompatibleRegulatoryBands=incompatibleRegulatoryBands, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, managementGroup=managementGroup, sNTPServerPortNumber=sNTPServerPortNumber, sNMPv3Enable=sNMPv3Enable, packetsToInternalStack=packetsToInternalStack, sNTPServerRetries=sNTPServerRetries, altitude=altitude, l2CPPriorityTable=l2CPPriorityTable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, alarmInstancedTableIndex=alarmInstancedTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, notificationsGroup=notificationsGroup, tDMInterfaceStatus=tDMInterfaceStatus, sNTPServerTableNumber=sNTPServerTableNumber, iPv6GatewayAddress=iPv6GatewayAddress, alarmsGroup=alarmsGroup, whitelistRMMacAddress=whitelistRMMacAddress, licenseSyncESupport=licenseSyncESupport, receivePower=receivePower, linkModeOptimization=linkModeOptimization, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDDControl=tDDControl, tDM=tDM, sMTPEnabledMessages=sMTPEnabledMessages, remoteInternetAddressType=remoteInternetAddressType, supplementary=supplementary, phyControl=phyControl, auxPortAcceptedQLRx=auxPortAcceptedQLRx, txColorCode=txColorCode, ethernetInstancedTableEntry=ethernetInstancedTableEntry, wirelessTopology=wirelessTopology, configurationInstancedTableEntry=configurationInstancedTableEntry, localPacketFiltering=localPacketFiltering, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, userRole=userRole, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, transmitFreqMHz=transmitFreqMHz, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sntp=sntp, tDMChannelLoopback=tDMChannelLoopback, maximumNumberOfSlaves=maximumNumberOfSlaves, transmitPowerLinked=transmitPowerLinked, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableDiagPair2Distance=cableDiagPair2Distance, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, deviceMSN=deviceMSN, licenseRARSupport=licenseRARSupport, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseIssueNumber=licenseIssueNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, licenseInstancedTableIndex=licenseInstancedTableIndex, userPassword=userPassword, installStatus=installStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableEntry=userTableEntry, rxColorCode=rxColorCode, authorizationMethod=authorizationMethod, transparentClock=transparentClock, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, remoteUnitName=remoteUnitName, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, syslogClientTrap=syslogClientTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, dNSGroup=dNSGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, channelBandwidth=channelBandwidth, pubStats=pubStats, vectorErrorLinked=vectorErrorLinked, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, maximumTransmitPower=maximumTransmitPower, portAllocationMismatchLinked=portAllocationMismatchLinked, lbtDetectedTrap=lbtDetectedTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, systemClock=systemClock, receiveFreqMHz=receiveFreqMHz, cableDiagPair2Results=cableDiagPair2Results, nIDULanPortAutoMdix=nIDULanPortAutoMdix, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, ethernetPriorityTableEntry=ethernetPriorityTableEntry, targetMACAddress=targetMACAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, systemReset=systemReset, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, receiveFreqKHz=receiveFreqKHz, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, lowestTDMModulationMode=lowestTDMModulationMode, sNTPSync=sNTPSync, licenseHCMPSupport=licenseHCMPSupport, iPv6Address=iPv6Address, hTTPAccessEnabled=hTTPAccessEnabled, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, longitude=longitude, dataBridgingStatusLinked=dataBridgingStatusLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, ptpGroups=ptpGroups, nIDULanPortStatusTrap=nIDULanPortStatusTrap, searchState=searchState, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sNTPLastSync=sNTPLastSync, hardwareVersion=hardwareVersion, unavailableSeconds=unavailableSeconds, mainPSUPortQLTx=mainPSUPortQLTx, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDMChannelCableLength=tDMChannelCableLength, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteInternetAddressLinked=remoteInternetAddressLinked, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, tDMChannelLineCode=tDMChannelLineCode, receiveModulationModeLinked=receiveModulationModeLinked, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, dfsPeaks=dfsPeaks, dSCPManagementPriority=dSCPManagementPriority, licenseSecurityLevel=licenseSecurityLevel, transmitFreqKHz=transmitFreqKHz, mABNominalTransmitCapacity=mABNominalTransmitCapacity, syslogControlGroup=syslogControlGroup, userTableIndex=userTableIndex, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, severelyErroredSeconds=severelyErroredSeconds, smtpGroup=smtpGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sFPError=sFPError, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, licenseEncryption=licenseEncryption, snmpControlGroup=snmpControlGroup, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseTLSRekey=licenseTLSRekey, capacityVariantMismatchLinked=capacityVariantMismatchLinked, phyControlInstancedTableIndex=phyControlInstancedTableIndex, unitIdentification=unitIdentification, tDDSynchronizationMode=tDDSynchronizationMode, ethernetStatisticsTable=ethernetStatisticsTable, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, dNSServerTableNumber=dNSServerTableNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, cableDiagPair4Distance=cableDiagPair4Distance, unitOutOfCalibration=unitOutOfCalibration)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortAllocation=mainPSUPortAllocation, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, reset=reset, iPv4Address=iPv4Address, licenseGasGroup=licenseGasGroup, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, targetRange=targetRange, syslogClient=syslogClient, ptp670=ptp670, phyInstancedStatusTable=phyInstancedStatusTable, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, alarmInstancedTableEntry=alarmInstancedTableEntry, enableTransmission=enableTransmission, tempPcb=tempPcb, installArmState=installArmState, productVariant=productVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, aggregateDataRate=aggregateDataRate, licenseInstancedTable=licenseInstancedTable, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mABState=mABState, dNSServerInternetAddressType=dNSServerInternetAddressType, smtp=smtp, licenseMaxLinkRange=licenseMaxLinkRange, sNMPCommunityString=sNMPCommunityString, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, wirelessOutOctets=wirelessOutOctets, sFPPortSSMTx=sFPPortSSMTx, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTrapPrefix=ptpTrapPrefix, dNSServerInternetAddress=dNSServerInternetAddress, transmitDataRateLinked=transmitDataRateLinked, syslogState=syslogState, cableDiagPair1Distance=cableDiagPair1Distance, syncETrackingState=syncETrackingState, subbandHighestFrequency=subbandHighestFrequency, versions=versions, encryption=encryption, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, antennaSelection=antennaSelection, rangeLinked=rangeLinked, mABNominalModulationMode=mABNominalModulationMode, unitIdentificationGroup=unitIdentificationGroup, licenseCapacity=licenseCapacity, masterSlaveMode=masterSlaveMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sNMPTrapVersion=sNMPTrapVersion, ethernetStatisticsDataSource=ethernetStatisticsDataSource, vectorError=vectorError, licenseTDDSyncSupport=licenseTDDSyncSupport, receivePowerLinked=receivePowerLinked, mgmtInstancedTable=mgmtInstancedTable, sNTPSyncTrap=sNTPSyncTrap, subnetMask=subnetMask, subbandLowestFrequency=subbandLowestFrequency)
