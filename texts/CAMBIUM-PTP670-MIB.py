...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", versions=versions, ethernetInstancedTableEntry=ethernetInstancedTableEntry, phyStatusGroup=phyStatusGroup, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationMode=receiveModulationMode, latitude=latitude, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, receiveDataRate=receiveDataRate, phyControlInstancedTableIndex=phyControlInstancedTableIndex, configuration=configuration, tDDControlGroup=tDDControlGroup, capacityVariantMismatchTrap=capacityVariantMismatchTrap, ethernetGroup=ethernetGroup, configurationInstancedTable=configurationInstancedTable, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, wirelessTopology=wirelessTopology, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, tDDControl=tDDControl, sMTPServerPortNumber=sMTPServerPortNumber, deviceMSN=deviceMSN, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tDM=tDM, tDMChannelLineCode=tDMChannelLineCode, routerProtocols=routerProtocols, txMABFrames=txMABFrames, l2CPPriorityTable=l2CPPriorityTable, cableDiagnostics=cableDiagnostics, sntp=sntp, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, ptpCompliance=ptpCompliance, smtpGroup=smtpGroup, dfsMeans=dfsMeans, rawReceivePowerLinked=rawReceivePowerLinked, ethernetInstancedTableIndex=ethernetInstancedTableIndex, linkLoss=linkLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, rangeLinked=rangeLinked, regulatoryBand=regulatoryBand, cableDiagPair1Results=cableDiagPair1Results, sFPPortStatusTrap=sFPPortStatusTrap, iPv4Address=iPv4Address, tDDSynchronizationStatus=tDDSynchronizationStatus, encryptionAlgorithm=encryptionAlgorithm, transmitDataRateLinked=transmitDataRateLinked, aAAControlGroup=aAAControlGroup, cableDiagnosticsWarning=cableDiagnosticsWarning, pubInstancedStatsTable=pubInstancedStatsTable, mABState=mABState, sFPPortStatus=sFPPortStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, installArmStateTrap=installArmStateTrap, vLANManagementVID=vLANManagementVID, tDMChannelStatus=tDMChannelStatus, sNTPServerStatus=sNTPServerStatus, authorizationControlTableEntry=authorizationControlTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, auxPortSSMTx=auxPortSSMTx, mgmtInstancedTableNumber=mgmtInstancedTableNumber, configurationGroup=configurationGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, tFTPServerInternetAddress=tFTPServerInternetAddress, sFPPortAutoMdix=sFPPortAutoMdix, receiveChannel=receiveChannel, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPSync=sNTPSync, licenseInstancedTableEntry=licenseInstancedTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, authorizationControlGroup=authorizationControlGroup, sNTPState=sNTPState, hCMPLinkSymmetry=hCMPLinkSymmetry, tFTPServerPortNumber=tFTPServerPortNumber, ptmp=ptmp, transparentClock=transparentClock, syslogClient=syslogClient, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, cableDiagnosticsResultTable=cableDiagnosticsResultTable, smtp=smtp, notificationsGroup=notificationsGroup, byteErrorRatioLinked=byteErrorRatioLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, dNSPrimaryServer=dNSPrimaryServer, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, accessMethod=accessMethod, tdmTableEntry=tdmTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, resetGroup=resetGroup, sNTPServerRetries=sNTPServerRetries, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseIEEE1588Support=licenseIEEE1588Support, dSCPManagementPriority=dSCPManagementPriority, subnetMask=subnetMask, sNTPServerInternetAddress=sNTPServerInternetAddress, sFPPortAutoNegotiation=sFPPortAutoNegotiation, tDMEnabledChannels=tDMEnabledChannels, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, snmpControl=snmpControl, byteErrorRatio=byteErrorRatio, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, vectorErrorLinked=vectorErrorLinked, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, userTable=userTable, licenseInstancedTable=licenseInstancedTable, licenseUnitSerialNumber=licenseUnitSerialNumber, unitOutOfCalibration=unitOutOfCalibration, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelBandwidth=channelBandwidth, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, dNSServerInternetAddressType=dNSServerInternetAddressType, ptp=ptp, authorizationMethod=authorizationMethod, alarmInstancedTableIndex=alarmInstancedTableIndex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tDMChannelCableLength=tDMChannelCableLength, severelyErroredSeconds=severelyErroredSeconds, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseGasGroup=licenseGasGroup, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, pubStatsGroup=pubStatsGroup, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mainPSUPortAutoMdix=mainPSUPortAutoMdix, auxPortStatus=auxPortStatus, aAAControl=aAAControl, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, auxPortDisabledWarning=auxPortDisabledWarning, authorizationControlTable=authorizationControlTable, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mABProtocolVLANPriority=mABProtocolVLANPriority, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, phyControlInstancedTableNumber=phyControlInstancedTableNumber, gatewayIPAddress=gatewayIPAddress, tDMInterfaceStatus=tDMInterfaceStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableDiagPair3Distance=cableDiagPair3Distance, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, phyControlGroup=phyControlGroup, subbandHighestFrequency=subbandHighestFrequency, licenseSFPPortSupport=licenseSFPPortSupport, searchStateLinked=searchStateLinked, syncESlavePort=syncESlavePort, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementGroup=managementGroup, channelChangeTrap=channelChangeTrap, bridgeGroup=bridgeGroup, blacklistRMEnabled=blacklistRMEnabled, installStatusLinked=installStatusLinked, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tDMInterfaceControl=tDMInterfaceControl, sNTPServerTableEntry=sNTPServerTableEntry, linkModeOptimization=linkModeOptimization, qOSPriorityScheme=qOSPriorityScheme, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, ptpGroups=ptpGroups, secureModeAlarmTrap=secureModeAlarmTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, mainPSUPortStatus=mainPSUPortStatus, configurationInstancedTableNumber=configurationInstancedTableNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, syncEEquipmentClock=syncEEquipmentClock, secureModeAlarm=secureModeAlarm, installationMode=installationMode, sFPPortQLRx=sFPPortQLRx, auxPortQLTx=auxPortQLTx, sNTPServerTableIndex=sNTPServerTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, mainPSUPortAllocation=mainPSUPortAllocation, telnetPortNumber=telnetPortNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, tDMChannelStatusTrap=tDMChannelStatusTrap, frequencyVariant=frequencyVariant, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dfs=dfs, transmitModulationMode=transmitModulationMode, routerProtocolsGroup=routerProtocolsGroup, snmpControlGroup=snmpControlGroup, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, hTTPPortNumber=hTTPPortNumber, cableLoss=cableLoss, sNMPTrapTable=sNMPTrapTable, installArmState=installArmState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, managementNetworkAccessEnabled=managementNetworkAccessEnabled, systemClock=systemClock, mgmtInstancedTableIndex=mgmtInstancedTableIndex, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sMTPEnabledMessages=sMTPEnabledMessages, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, noWirelessChannelAvailable=noWirelessChannelAvailable, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseHCMPSupport=licenseHCMPSupport, licenseCountry=licenseCountry, licenseEncryption=licenseEncryption, sNTPServerTimeout=sNTPServerTimeout, license=license, configurationInstancedTableIndex=configurationInstancedTableIndex, deviceESN=deviceESN, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, auxPortAcceptedQLRx=auxPortAcceptedQLRx, linkName=linkName, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, transmitterChannels=transmitterChannels, hTTPAccessEnabled=hTTPAccessEnabled, syslogStateTrap=syslogStateTrap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, rangingMode=rangingMode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transparentClockPort=transparentClockPort, aggregateDataRateLinked=aggregateDataRateLinked, eIRP=eIRP, tFTPClient=tFTPClient, txColorCode=txColorCode, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sNTPServerTableNumber=sNTPServerTableNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, rawReceivePower=rawReceivePower, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, nIDULanPortAutoMdix=nIDULanPortAutoMdix, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogState=syslogState, licenseTDDSyncSupport=licenseTDDSyncSupport, linkModeOptimizationMismatch=linkModeOptimizationMismatch, longitude=longitude)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, alarmInstancedTableNumber=alarmInstancedTableNumber, mainPSUPortSSMTx=mainPSUPortSSMTx, cableDiagPair3Results=cableDiagPair3Results, erroredSeconds=erroredSeconds, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, reset=reset, sFPPortAllocation=sFPPortAllocation, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, iPv6PrefixLength=iPv6PrefixLength, phyControlInstancedTable=phyControlInstancedTable, oOBPriorityQueueMapping=oOBPriorityQueueMapping, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, mABHoldoffPeriod=mABHoldoffPeriod, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, timeZone=timeZone, altitude=altitude, deviceMACAddress=deviceMACAddress, receiveDataRateLinked=receiveDataRateLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userTableIndex=userTableIndex, transparentClockVID=transparentClockVID, phyStatus=phyStatus, unitIdentification=unitIdentification, hTTPSPortNumber=hTTPSPortNumber, ptpTrapPrefix=ptpTrapPrefix, wirelessOutAllOctets=wirelessOutAllOctets, ethernetStatisticsDataSource=ethernetStatisticsDataSource, dfsTable=dfsTable, lbtDetectedTrap=lbtDetectedTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, transmitPower=transmitPower, portAllocationMismatchLinked=portAllocationMismatchLinked, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sNMPTrapVersion=sNMPTrapVersion, auxPortStatusTrap=auxPortStatusTrap, management=management, dNSServerTableEntry=dNSServerTableEntry, installStatus=installStatus, phyControlInstancedTableEntry=phyControlInstancedTableEntry, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, portAllocationMismatchTrap=portAllocationMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dNSServerInternetAddress=dNSServerInternetAddress, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, syslogControlGroup=syslogControlGroup, vLANManagementPriority=vLANManagementPriority, auxPortQLRx=auxPortQLRx, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, versionsGroup=versionsGroup, capacityVariantMismatchLinked=capacityVariantMismatchLinked, packetsToInternalStack=packetsToInternalStack, cableDiagPair2Distance=cableDiagPair2Distance, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, apcGroup=apcGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receivePower=receivePower, unitIdentificationGroup=unitIdentificationGroup, targetMACAddress=targetMACAddress, dataBridgingStatus=dataBridgingStatus, licenseSecurityLevel=licenseSecurityLevel, rxColorCode=rxColorCode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, softwareVersion=softwareVersion, dNSServerPortNumber=dNSServerPortNumber, sMTPEmailAlert=sMTPEmailAlert, cableDiagPair4Results=cableDiagPair4Results, licenseIssueNumber=licenseIssueNumber, localPacketFiltering=localPacketFiltering, antennaGain=antennaGain, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, alarmsGroup=alarmsGroup, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPSyncTrap=sNTPSyncTrap, tDMGroup=tDMGroup, sFPError=sFPError, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userName=userName, nIDULanPortStatus=nIDULanPortStatus, licenseGroupAccess=licenseGroupAccess, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, signalStrengthRatio=signalStrengthRatio, PYSNMP_MODULE_ID=cambium, extendedSpectrumScanning=extendedSpectrumScanning, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, whitelistRMEnabled=whitelistRMEnabled, remoteInternetAddressLinked=remoteInternetAddressLinked, vectorError=vectorError, searchState=searchState, alarms=alarms, bootVersion=bootVersion, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseTrialPeriod=licenseTrialPeriod, cableDiagnosticsControl=cableDiagnosticsControl, remoteMACAddress=remoteMACAddress, mgmtInstancedTable=mgmtInstancedTable, unavailableSeconds=unavailableSeconds, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, phyInstancedStatusTable=phyInstancedStatusTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPv3Enable=sNMPv3Enable, sNMPCommunityString=sNMPCommunityString, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseGroup=licenseGroup, auxPortSyncERxStatus=auxPortSyncERxStatus, auxPortConfigurationMismatch=auxPortConfigurationMismatch, dNS=dNS, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, userTableEntry=userTableEntry, pubStats=pubStats, tdmTableIndex=tdmTableIndex, tDMChannelLoopback=tDMChannelLoopback, sNTPPollInterval=sNTPPollInterval, cableDiagPair1Distance=cableDiagPair1Distance, transmitFreqMHz=transmitFreqMHz, signalStrengthRatioLinked=signalStrengthRatioLinked, sNTPPrimaryServer=sNTPPrimaryServer, dNSServerTableNumber=dNSServerTableNumber, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, sFPErrorTrap=sFPErrorTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tdmTableNumber=tdmTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitChannel=transmitChannel, l2CPPriorityTableEntry=l2CPPriorityTableEntry, maximumNumberOfSlaves=maximumNumberOfSlaves, licenseOOBManagementSupport=licenseOOBManagementSupport, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, unitName=unitName, licenseRARSupport=licenseRARSupport, encryptionGroup=encryptionGroup, dNSResolver=dNSResolver, whitelistRMMacAddress=whitelistRMMacAddress, dfsTableNumber=dfsTableNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseIPv6Support=licenseIPv6Support, regulatoryBandTrap=regulatoryBandTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, dNSServerTable=dNSServerTable, secondarySoftwareVersion=secondarySoftwareVersion, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, cambium=cambium, syslogClientTrap=syslogClientTrap, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, auxPortAllocation=auxPortAllocation, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, bridge=bridge, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, dfsTableEntry=dfsTableEntry, iPv6Address=iPv6Address, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, linkLossLinked=linkLossLinked, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, remoteInternetAddress=remoteInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, licenseBandwidthCap=licenseBandwidthCap, targetRange=targetRange, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, ptp670=ptp670, masterSlaveMode=masterSlaveMode, licenseMaxLinkRange=licenseMaxLinkRange, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userPassword=userPassword, iPVersion=iPVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sNMPPortNumber=sNMPPortNumber, receiveFreqMHz=receiveFreqMHz, lowestTDMModulationMode=lowestTDMModulationMode, licenseInstancedTableIndex=licenseInstancedTableIndex, enableTransmission=enableTransmission, dataPortPauseFrames=dataPortPauseFrames, syncETrackingState=syncETrackingState, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteInternetAddressType=remoteInternetAddressType, mABTransmissionInterval=mABTransmissionInterval, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, daylightSaving=daylightSaving, ethernetStatisticsTable=ethernetStatisticsTable, receiveFreqKHz=receiveFreqKHz, cableDiagPair2Results=cableDiagPair2Results, supplementary=supplementary, dNSGroup=dNSGroup, sNTPLastSync=sNTPLastSync, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagPair4Distance=cableDiagPair4Distance, mABProtocolVID=mABProtocolVID, transmitFreqKHz=transmitFreqKHz, sFPPortSSMTx=sFPPortSSMTx, wirelessLinkStatusLinked=wirelessLinkStatusLinked, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseInstancedTableNumber=licenseInstancedTableNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, transmitPowerLinked=transmitPowerLinked, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sNTPServerPortNumber=sNTPServerPortNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, userRole=userRole, mgmtInstancedTableEntry=mgmtInstancedTableEntry, remoteMACAddressLinked=remoteMACAddressLinked, licenseVersion=licenseVersion, mainPSUPortQLTx=mainPSUPortQLTx, antennaSelection=antennaSelection, phyControl=phyControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transmitModulationModeLinked=transmitModulationModeLinked, maxLinkRangeExceeded=maxLinkRangeExceeded, dNSServerTableIndex=dNSServerTableIndex, dfsPeaks=dfsPeaks, remoteUnitNameLinked=remoteUnitNameLinked, subbandLowestFrequency=subbandLowestFrequency, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, authorizationControlTableIndex=authorizationControlTableIndex, authorizationControlTableNumber=authorizationControlTableNumber, productName=productName, apc=apc, linkSymmetry=linkSymmetry, tdmTable=tdmTable, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, range=range, systemReset=systemReset, supplementaryGroup=supplementaryGroup, groupID=groupID, transparentClockVLAN=transparentClockVLAN, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mPLSTCPriorityTable=mPLSTCPriorityTable, packetsFromInternalStack=packetsFromInternalStack, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetPriorityTable=ethernetPriorityTable, mainPSUPortQLRx=mainPSUPortQLRx, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mABNominalModulationMode=mABNominalModulationMode, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, licenseTLSRekey=licenseTLSRekey)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sFPPortQLTx=sFPPortQLTx, dfsGroup=dfsGroup, hCMPMaximumLinkRange=hCMPMaximumLinkRange, userEnabled=userEnabled, ptpTraps=ptpTraps, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, useVLANForMABProtocol=useVLANForMABProtocol, syncETracking=syncETracking, encryption=encryption, mABMaintenanceLevel=mABMaintenanceLevel, alarmInstancedTable=alarmInstancedTable, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, iPv6GatewayAddress=iPv6GatewayAddress, ethernet=ethernet, syslogControl=syslogControl, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, productVariant=productVariant, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, userTableNumber=userTableNumber, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, receiveModulationModeLinked=receiveModulationModeLinked, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, ethernetInstancedTable=ethernetInstancedTable, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataBridgingAvailability=dataBridgingAvailability, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, dataBridgingStatusAlarm=dataBridgingStatusAlarm, maximumTransmitPower=maximumTransmitPower, hardwareVersion=hardwareVersion, capacityVariantMismatch=capacityVariantMismatch, tDMConfigurationMismatch=tDMConfigurationMismatch, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, siteName=siteName, transmitDataRate=transmitDataRate, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tempPcb=tempPcb, authorizationControl=authorizationControl, sNTPServerTable=sNTPServerTable, sNMPEnabledTraps=sNMPEnabledTraps, licenseCapacity=licenseCapacity, aggregateDataRate=aggregateDataRate, installStatusTrap=installStatusTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, portAllocationMismatch=portAllocationMismatch, blacklistRMMacAddress=blacklistRMMacAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, licenseSyncESupport=licenseSyncESupport, dfsTableIndex=dfsTableIndex, remoteUnitName=remoteUnitName, cableDiagnosticsPorts=cableDiagnosticsPorts, wirelessOutOctets=wirelessOutOctets, lowestDataModulationMode=lowestDataModulationMode, receivePowerLinked=receivePowerLinked, sntpGroup=sntpGroup)
