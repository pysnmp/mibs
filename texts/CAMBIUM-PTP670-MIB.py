...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tdmTable=tdmTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, transmitPowerLinked=transmitPowerLinked, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, hTTPAccessEnabled=hTTPAccessEnabled, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syncETrackingState=syncETrackingState, transmitFreqMHz=transmitFreqMHz, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseInstancedTableNumber=licenseInstancedTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, severelyErroredSeconds=severelyErroredSeconds, userRole=userRole, lowestDataModulationMode=lowestDataModulationMode, mgmtInstancedTableNumber=mgmtInstancedTableNumber, tDDControl=tDDControl, byteErrorRatioLinked=byteErrorRatioLinked, licenseInstancedTable=licenseInstancedTable, dNSServerInternetAddress=dNSServerInternetAddress, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, auxPortDisabledWarning=auxPortDisabledWarning, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, useVLANForMABProtocol=useVLANForMABProtocol, sFPPortQLTx=sFPPortQLTx, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPLastSync=sNTPLastSync, userName=userName, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, aAAControlGroup=aAAControlGroup, maximumTransmitPower=maximumTransmitPower, nIDULanPortStatus=nIDULanPortStatus, linkLoss=linkLoss, tdmTableIndex=tdmTableIndex, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, ptpGroups=ptpGroups, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sNTPServerTimeout=sNTPServerTimeout, searchState=searchState, unitName=unitName, transparentClockVID=transparentClockVID, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, localPacketFiltering=localPacketFiltering, tDDControlGroup=tDDControlGroup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configurationGroup=configurationGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTable=sNTPServerTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, byteErrorRatio=byteErrorRatio, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseIssueNumber=licenseIssueNumber, apc=apc, licenseTDDSyncSupport=licenseTDDSyncSupport, sNTPServerInternetAddress=sNTPServerInternetAddress, receiveDataRateLinked=receiveDataRateLinked, remoteInternetAddress=remoteInternetAddress, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, linkModeOptimization=linkModeOptimization, vLANManagementVID=vLANManagementVID, syslogClientTrap=syslogClientTrap, searchStateLinked=searchStateLinked, dfs=dfs, syslogState=syslogState, dfsGroup=dfsGroup, phyStatus=phyStatus, configurationInstancedTableEntry=configurationInstancedTableEntry, iPv4Address=iPv4Address, PYSNMP_MODULE_ID=cambium, range=range, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, auxPortQLRx=auxPortQLRx, maximumNumberOfSlaves=maximumNumberOfSlaves, licenseRegulatoryBandsList=licenseRegulatoryBandsList, lowestTDMModulationMode=lowestTDMModulationMode, snmpControlGroup=snmpControlGroup, phyControlInstancedTable=phyControlInstancedTable, versions=versions, userTableIndex=userTableIndex, subnetMask=subnetMask, sNMPv3Enable=sNMPv3Enable, transmitFreqKHz=transmitFreqKHz, wirelessTopology=wirelessTopology, mainPSUPortQLTx=mainPSUPortQLTx, authorizationMethod=authorizationMethod, auxPortStatusTrap=auxPortStatusTrap, mABNominalModulationMode=mABNominalModulationMode, eIRP=eIRP, receiveChannel=receiveChannel, phyInstancedStatusTable=phyInstancedStatusTable, transmitPower=transmitPower, iPv6Address=iPv6Address, oOBPriorityQueueMapping=oOBPriorityQueueMapping, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, dNSResolver=dNSResolver, groupID=groupID, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mgmtInstancedTable=mgmtInstancedTable, notificationsGroup=notificationsGroup, remoteUnitNameLinked=remoteUnitNameLinked, userTable=userTable, unavailableSeconds=unavailableSeconds, rangeLinked=rangeLinked, receiveDataRate=receiveDataRate, dNSGroup=dNSGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, linkLossLinked=linkLossLinked, cableDiagnosticsControl=cableDiagnosticsControl, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, tDMConfigurationMismatch=tDMConfigurationMismatch, whitelistRMEnabled=whitelistRMEnabled, gatewayIPAddress=gatewayIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetPriorityTable=ethernetPriorityTable, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortAllocation=sFPPortAllocation, bridgeGroup=bridgeGroup, signalStrengthRatio=signalStrengthRatio, transparentClockPort=transparentClockPort, tDMChannelLoopback=tDMChannelLoopback, sMTPEnabledMessages=sMTPEnabledMessages, userTableEntry=userTableEntry, qOSPriorityScheme=qOSPriorityScheme, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, deviceESN=deviceESN, tFTPServerPortNumber=tFTPServerPortNumber, syslogStateTrap=syslogStateTrap, pubStatsGroup=pubStatsGroup, rawReceivePowerLinked=rawReceivePowerLinked, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNTPServerRetries=sNTPServerRetries, versionsGroup=versionsGroup, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, phyControlGroup=phyControlGroup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sFPError=sFPError, lbtDetectedTrap=lbtDetectedTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, auxPortAllocation=auxPortAllocation, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, licenseHCMPSupport=licenseHCMPSupport, whitelistRMMacAddress=whitelistRMMacAddress, daylightSaving=daylightSaving, dNSServerTableNumber=dNSServerTableNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, auxPortSSMTx=auxPortSSMTx, licenseMaxLinkRange=licenseMaxLinkRange, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tDM=tDM, smtp=smtp, tempPcb=tempPcb, altitude=altitude, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mainPSUPortAllocation=mainPSUPortAllocation, signalStrengthRatioLinked=signalStrengthRatioLinked, alarmInstancedTableNumber=alarmInstancedTableNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseCountry=licenseCountry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptp=ptp, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, tDMEnabledChannels=tDMEnabledChannels, auxPortSyncERxStatus=auxPortSyncERxStatus, phyStatusGroup=phyStatusGroup, ethernetInstancedTableEntry=ethernetInstancedTableEntry, snmpControl=snmpControl, mABHoldoffPeriod=mABHoldoffPeriod, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, remoteMACAddress=remoteMACAddress, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, bootVersion=bootVersion, authorizationControlTable=authorizationControlTable, tDMInterfaceControl=tDMInterfaceControl, timeZone=timeZone, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, configuration=configuration, ethernet=ethernet, aAAControl=aAAControl, mABTransmissionInterval=mABTransmissionInterval, linkName=linkName, licenseSyncESupport=licenseSyncESupport, routerProtocolsGroup=routerProtocolsGroup, extendedSpectrumScanning=extendedSpectrumScanning, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, alarmInstancedTable=alarmInstancedTable, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mgmtInstancedTableIndex=mgmtInstancedTableIndex, cableLoss=cableLoss, hTTPPortNumber=hTTPPortNumber, hCMPLinkSymmetry=hCMPLinkSymmetry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseSecurityLevel=licenseSecurityLevel, alarmInstancedTableIndex=alarmInstancedTableIndex, phyControlInstancedTableEntry=phyControlInstancedTableEntry, transmitDataRate=transmitDataRate, ptpTraps=ptpTraps, auxPortAcceptedQLRx=auxPortAcceptedQLRx, cableDiagPair3Results=cableDiagPair3Results, wirelessLinkStatusLinked=wirelessLinkStatusLinked, ethernetStatisticsTable=ethernetStatisticsTable, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sNTPServerTableNumber=sNTPServerTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagnostics=cableDiagnostics, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, antennaGain=antennaGain, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, packetsFromInternalStack=packetsFromInternalStack, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseVersion=licenseVersion, targetMACAddress=targetMACAddress, longitude=longitude, dfsTableIndex=dfsTableIndex, dNSServerTableIndex=dNSServerTableIndex, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseEncryption=licenseEncryption, userPassword=userPassword, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sNTPPrimaryServer=sNTPPrimaryServer, remoteMACAddressLinked=remoteMACAddressLinked, transmitModulationModeLinked=transmitModulationModeLinked, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, channelBandwidth=channelBandwidth, dNS=dNS, sNTPServerTableEntry=sNTPServerTableEntry, targetRange=targetRange, dfsTable=dfsTable, telnetPortNumber=telnetPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, receivePower=receivePower, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, installArmState=installArmState, ethernetPriorityTableNumber=ethernetPriorityTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetGroup=ethernetGroup, dNSServerTableEntry=dNSServerTableEntry, transmitterChannels=transmitterChannels, portAllocationMismatchLinked=portAllocationMismatchLinked, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, alarms=alarms, licenseIEEE1588Support=licenseIEEE1588Support, licenseTLSRekey=licenseTLSRekey, tDMChannelStatus=tDMChannelStatus, remoteInternetAddressType=remoteInternetAddressType, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseIPv6Support=licenseIPv6Support, dfsTableEntry=dfsTableEntry, transmitModulationMode=transmitModulationMode, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, secureModeAlarm=secureModeAlarm, supplementaryGroup=supplementaryGroup, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, incompatibleRegulatoryBands=incompatibleRegulatoryBands, authorizationControlTableEntry=authorizationControlTableEntry, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ethernetInstancedTableIndex=ethernetInstancedTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, productVariant=productVariant, tFTPClient=tFTPClient, txMABFrames=txMABFrames, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, subbandLowestFrequency=subbandLowestFrequency, configurationInstancedTable=configurationInstancedTable, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, tDMChannelLineCode=tDMChannelLineCode, wirelessOutOctets=wirelessOutOctets, userTableNumber=userTableNumber, antennaSelection=antennaSelection, resetGroup=resetGroup, regulatoryBand=regulatoryBand, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, installArmStateTrap=installArmStateTrap, mainPSUPortQLRx=mainPSUPortQLRx, rangingMode=rangingMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDMChannelCableLength=tDMChannelCableLength, receivePowerLinked=receivePowerLinked, masterSlaveMode=masterSlaveMode, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, installationMode=installationMode, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, cableDiagPair1Results=cableDiagPair1Results, licenseInstancedTableIndex=licenseInstancedTableIndex, mABState=mABState, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, unitIdentification=unitIdentification, l2CPPriorityTable=l2CPPriorityTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, tDMInterfaceStatus=tDMInterfaceStatus, licenseRARSupport=licenseRARSupport, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, ptpTrapPrefix=ptpTrapPrefix, receiveModulationModeLinked=receiveModulationModeLinked, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, hardwareVersion=hardwareVersion, erroredSeconds=erroredSeconds, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, cableDiagnosticsGroup=cableDiagnosticsGroup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sMTPServerPortNumber=sMTPServerPortNumber, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, blacklistRMEnabled=blacklistRMEnabled, tDDSynchronizationStatus=tDDSynchronizationStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerTableIndex=sNTPServerTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, unitIdentificationGroup=unitIdentificationGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitDataRateLinked=transmitDataRateLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sFPPortQLRx=sFPPortQLRx, sNMPPortNumber=sNMPPortNumber, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, installStatusLinked=installStatusLinked, rxColorCode=rxColorCode, licenseTrialPeriod=licenseTrialPeriod, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerPortNumber=sNTPServerPortNumber, dfsTableNumber=dfsTableNumber, enableTransmission=enableTransmission, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, syncEEquipmentClock=syncEEquipmentClock, mABProtocolVLANPriority=mABProtocolVLANPriority, systemClock=systemClock, tDMGroup=tDMGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, deviceMSN=deviceMSN, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, userEnabled=userEnabled, blacklistRMMacAddress=blacklistRMMacAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, systemReset=systemReset, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseGroup=licenseGroup, sNTPServerStatus=sNTPServerStatus, portAllocationMismatch=portAllocationMismatch, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataBridgingStatusAlarm=dataBridgingStatusAlarm, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, management=management, syncESlavePort=syncESlavePort, pubInstancedStatsTable=pubInstancedStatsTable, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, cambium=cambium, dataBridgingAvailability=dataBridgingAvailability, sFPPortDisabledWarning=sFPPortDisabledWarning, mainPSUPortStatusTrap=mainPSUPortStatusTrap, hCMPMaximumLinkRange=hCMPMaximumLinkRange, installStatusTrap=installStatusTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, dNSPrimaryServer=dNSPrimaryServer, regulatoryBandTrap=regulatoryBandTrap, configurationInstancedTableNumber=configurationInstancedTableNumber, syslogControl=syslogControl, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, auxPortQLTx=auxPortQLTx, sFPPortStatusTrap=sFPPortStatusTrap, syslogControlGroup=syslogControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, softwareVersion=softwareVersion, maxLinkRangeExceeded=maxLinkRangeExceeded, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, subbandHighestFrequency=subbandHighestFrequency, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sFPPortSSMTx=sFPPortSSMTx, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, cableDiagPair4Results=cableDiagPair4Results, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, mainPSUPortAutoMdix=mainPSUPortAutoMdix, frequencyVariant=frequencyVariant, sNMPTrapTableEntry=sNMPTrapTableEntry, mABMaintenanceLevel=mABMaintenanceLevel, vLANManagementPriority=vLANManagementPriority, encryption=encryption, syslogClient=syslogClient, licenseInstancedTableEntry=licenseInstancedTableEntry, smtpGroup=smtpGroup, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, managementGroup=managementGroup, wirelessOutEthernetOctets=wirelessOutEthernetOctets, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cableDiagPair2Distance=cableDiagPair2Distance, sNMPTrapVersion=sNMPTrapVersion, transmitChannel=transmitChannel, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, linkSymmetry=linkSymmetry, licenseUnitSerialNumber=licenseUnitSerialNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsPeaks=dfsPeaks, enabledDiagnosticAlarms=enabledDiagnosticAlarms, packetsToInternalStack=packetsToInternalStack, iPVersion=iPVersion, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, l2CPPriorityTableIndex=l2CPPriorityTableIndex, siteName=siteName, supplementary=supplementary, iPv6PrefixLength=iPv6PrefixLength, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, productName=productName, channelChangeTrap=channelChangeTrap, licenseSFPPortSupport=licenseSFPPortSupport, cableDiagPair1Distance=cableDiagPair1Distance, routerProtocols=routerProtocols, dataPortPauseFrames=dataPortPauseFrames, unitOutOfCalibration=unitOutOfCalibration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installStatus=installStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerInternetAddressType=sNTPServerInternetAddressType, aggregateDataRateLinked=aggregateDataRateLinked, telnetAccessEnabled=telnetAccessEnabled, vectorError=vectorError, apcGroup=apcGroup, vectorErrorLinked=vectorErrorLinked, sNMPCommunityString=sNMPCommunityString, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transparentClockVLAN=transparentClockVLAN, dataBridgingStatusLinked=dataBridgingStatusLinked, cableDiagnosticsPorts=cableDiagnosticsPorts, cableDiagnosticsWarning=cableDiagnosticsWarning, dfsMeans=dfsMeans, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, portAllocationMismatchTrap=portAllocationMismatchTrap, ptmp=ptmp, deviceMACAddress=deviceMACAddress, encryptionGroup=encryptionGroup, sNMPTrapTable=sNMPTrapTable, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mainPSUPortStatus=mainPSUPortStatus, phyControl=phyControl, dNSServerPortNumber=dNSServerPortNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, transparentClock=transparentClock, bridge=bridge, phyControlInstancedTableNumber=phyControlInstancedTableNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, license=license, remoteInternetAddressLinked=remoteInternetAddressLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataBridgingStatus=dataBridgingStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, wirelessLinkStatus=wirelessLinkStatus, sNTPState=sNTPState, encryptionAlgorithm=encryptionAlgorithm, authorizationControlTableNumber=authorizationControlTableNumber, sMTPEmailAlert=sMTPEmailAlert, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseGroupAccess=licenseGroupAccess, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tdmTableEntry=tdmTableEntry, cableDiagPair2Results=cableDiagPair2Results, ethernetInstancedTable=ethernetInstancedTable, aggregateDataRate=aggregateDataRate, sNTPSync=sNTPSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, alarmsGroup=alarmsGroup, cableDiagPair3Distance=cableDiagPair3Distance, nIDULanPortAutoMdix=nIDULanPortAutoMdix, reset=reset, sFPPortAutoMdix=sFPPortAutoMdix, rawReceivePower=rawReceivePower, receiveFreqKHz=receiveFreqKHz, dNSServerTable=dNSServerTable, remoteUnitName=remoteUnitName, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, accessMethod=accessMethod, pubStats=pubStats, sNMPTrapInternetAddress=sNMPTrapInternetAddress, receiveFreqMHz=receiveFreqMHz, txColorCode=txColorCode, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseGasGroup=licenseGasGroup, sntp=sntp, ptpCompliance=ptpCompliance, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, tDMChannelStatusTrap=tDMChannelStatusTrap, authorizationControlGroup=authorizationControlGroup, sNTPSyncTrap=sNTPSyncTrap, dSCPManagementPriority=dSCPManagementPriority, capacityVariantMismatch=capacityVariantMismatch, ptp670=ptp670, tdmTableNumber=tdmTableNumber, sFPErrorTrap=sFPErrorTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syncETracking=syncETracking, mABNominalTransmitCapacity=mABNominalTransmitCapacity, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseCapacity=licenseCapacity, authorizationControl=authorizationControl, sNTPPollInterval=sNTPPollInterval, auxPortStatus=auxPortStatus, secureModeAlarmTrap=secureModeAlarmTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, receiveModulationMode=receiveModulationMode, mABProtocolVID=mABProtocolVID, latitude=latitude, wirelessOutAllOctets=wirelessOutAllOctets, sFPPortStatus=sFPPortStatus, capacityVariantMismatchLinked=capacityVariantMismatchLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, authorizationControlTableIndex=authorizationControlTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseBandwidthCap=licenseBandwidthCap, sntpGroup=sntpGroup)
