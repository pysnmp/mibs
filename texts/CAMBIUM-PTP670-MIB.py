...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTableEntry=userTableEntry, snmpControl=snmpControl, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, mABMaintenanceLevel=mABMaintenanceLevel, ethernetGroup=ethernetGroup, installStatus=installStatus, cableDiagPair3Results=cableDiagPair3Results, dNSServerTableIndex=dNSServerTableIndex, tDMChannelLineCode=tDMChannelLineCode, apcGroup=apcGroup, transmitPowerLinked=transmitPowerLinked, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseTrialPeriod=licenseTrialPeriod, sNTPServerRetries=sNTPServerRetries, alarmInstancedTableEntry=alarmInstancedTableEntry, masterSlaveMode=masterSlaveMode, sFPPortStatus=sFPPortStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerPortNumber=sNTPServerPortNumber, wirelessTopology=wirelessTopology, auxPortQLTx=auxPortQLTx, phyControlInstancedTableIndex=phyControlInstancedTableIndex, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, hCMPMaximumLinkRange=hCMPMaximumLinkRange, bridgeGroup=bridgeGroup, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseTLSRekey=licenseTLSRekey, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseOOBManagementSupport=licenseOOBManagementSupport, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, ethernetInstancedTable=ethernetInstancedTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataBridgingAvailability=dataBridgingAvailability, userTable=userTable, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, remoteUnitName=remoteUnitName, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, severelyErroredSeconds=severelyErroredSeconds, transparentClock=transparentClock, ptmp=ptmp, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tDMChannelLoopback=tDMChannelLoopback, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, altitude=altitude, licenseEncryption=licenseEncryption, byteErrorRatio=byteErrorRatio, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, wirelessOutOctets=wirelessOutOctets, systemReset=systemReset, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cableDiagPair1Results=cableDiagPair1Results, ptpCompliance=ptpCompliance, configurationInstancedTable=configurationInstancedTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, unitIdentificationGroup=unitIdentificationGroup, syncESlavePort=syncESlavePort, cableDiagPair4Results=cableDiagPair4Results, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, vLANManagementVID=vLANManagementVID, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteInternetAddressLinked=remoteInternetAddressLinked, sMTPServerPortNumber=sMTPServerPortNumber, configurationInstancedTableEntry=configurationInstancedTableEntry, receiveChannel=receiveChannel, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, longitude=longitude, ethernetPriorityTableEntry=ethernetPriorityTableEntry, cableDiagPair1Distance=cableDiagPair1Distance, bridge=bridge, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseHCMPSupport=licenseHCMPSupport, tdmTable=tdmTable, mABHoldoffPeriod=mABHoldoffPeriod, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, whitelistRMMacAddress=whitelistRMMacAddress, ptpGroups=ptpGroups, license=license, licenseCapacity=licenseCapacity, routerProtocolsGroup=routerProtocolsGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseUnitSerialNumber=licenseUnitSerialNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, licenseRARSupport=licenseRARSupport, installStatusLinked=installStatusLinked, syncEEquipmentClock=syncEEquipmentClock, pubInstancedStatsTable=pubInstancedStatsTable, dataPortPauseFrames=dataPortPauseFrames, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, ptpTraps=ptpTraps, sNTPServerTableIndex=sNTPServerTableIndex, receivePowerLinked=receivePowerLinked, licenseInstancedTable=licenseInstancedTable, configuration=configuration, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, mainPSUPortAutoMdix=mainPSUPortAutoMdix, accessMethod=accessMethod, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, nIDULanPortStatus=nIDULanPortStatus, smtp=smtp, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, syslogControlGroup=syslogControlGroup, rxColorCode=rxColorCode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, maximumNumberOfSlaves=maximumNumberOfSlaves, iPVersion=iPVersion, tdmTableNumber=tdmTableNumber, rangeLinked=rangeLinked, aAAControlGroup=aAAControlGroup, notificationsGroup=notificationsGroup, licenseCountry=licenseCountry, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, alarms=alarms, portAllocationMismatchLinked=portAllocationMismatchLinked, sNMPTrapVersion=sNMPTrapVersion, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sNTPSyncTrap=sNTPSyncTrap, tDM=tDM, receiveModulationModeLinked=receiveModulationModeLinked, incompatibleRegulatoryBands=incompatibleRegulatoryBands, transparentClockPort=transparentClockPort, whitelistRMEnabled=whitelistRMEnabled, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, unitIdentification=unitIdentification, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sNTPLastSync=sNTPLastSync, txColorCode=txColorCode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, ptp=ptp, transparentClockVID=transparentClockVID, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, routerProtocols=routerProtocols, licenseIssueNumber=licenseIssueNumber, auxPortDisabledWarning=auxPortDisabledWarning, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, licenseIPv6Support=licenseIPv6Support, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitChannel=transmitChannel, syslogState=syslogState, sFPPortStatusTrap=sFPPortStatusTrap, transmitterChannels=transmitterChannels, hTTPSAccessEnabled=hTTPSAccessEnabled, alarmInstancedTableIndex=alarmInstancedTableIndex, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, tdmTableEntry=tdmTableEntry, auxPortAllocation=auxPortAllocation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, unitName=unitName, telnetPortNumber=telnetPortNumber, packetsToInternalStack=packetsToInternalStack, dNSServerInternetAddress=dNSServerInternetAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkName=linkName, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, syslogClientTrap=syslogClientTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, encryptionGroup=encryptionGroup, antennaSelection=antennaSelection, remoteUnitNameLinked=remoteUnitNameLinked, remoteInternetAddressType=remoteInternetAddressType, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, dSCPManagementPriority=dSCPManagementPriority, licenseBandwidthCap=licenseBandwidthCap, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagPair4Distance=cableDiagPair4Distance, useVLANForMABProtocol=useVLANForMABProtocol, receivePower=receivePower, tDMChannelCableLength=tDMChannelCableLength, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, authorizationControlTable=authorizationControlTable, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapInternetAddress=sNMPTrapInternetAddress, linkSymmetry=linkSymmetry, wirelessLinkStatus=wirelessLinkStatus, tFTPClient=tFTPClient, lowestDataModulationMode=lowestDataModulationMode, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, phyStatusGroup=phyStatusGroup, auxPortSSMTx=auxPortSSMTx, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetInstancedTableIndex=ethernetInstancedTableIndex, signalStrengthRatioLinked=signalStrengthRatioLinked, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPEmailAlert=sMTPEmailAlert, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, capacityVariantMismatch=capacityVariantMismatch, iPv4Address=iPv4Address, linkModeOptimization=linkModeOptimization, range=range, userTableIndex=userTableIndex, licenseTDDSyncSupport=licenseTDDSyncSupport, syslogControl=syslogControl, sNMPTrapTableNumber=sNMPTrapTableNumber, cableDiagnosticsControl=cableDiagnosticsControl, authorizationMethod=authorizationMethod, searchState=searchState, tDMGroup=tDMGroup, cableDiagPair2Results=cableDiagPair2Results, unavailableSeconds=unavailableSeconds, subbandHighestFrequency=subbandHighestFrequency, transmitModulationMode=transmitModulationMode, cableDiagnosticsResultTable=cableDiagnosticsResultTable, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, authorizationControlTableEntry=authorizationControlTableEntry, transmitModulationModeLinked=transmitModulationModeLinked, portAllocationMismatch=portAllocationMismatch, receiveModulationModeDetail=receiveModulationModeDetail, sFPPortQLRx=sFPPortQLRx, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, phyStatus=phyStatus, authorizationControlTableNumber=authorizationControlTableNumber, sNTPSync=sNTPSync, dNSServerPortNumber=dNSServerPortNumber, systemClock=systemClock, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseSFPPortSupport=licenseSFPPortSupport, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTableIndex=dfsTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mainPSUPortAllocation=mainPSUPortAllocation, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, auxPortSyncERxStatus=auxPortSyncERxStatus, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tdmTableIndex=tdmTableIndex, dfsPeaks=dfsPeaks, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveModulationMode=receiveModulationMode, authorizationControlTableIndex=authorizationControlTableIndex, auxPortStatus=auxPortStatus, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseGroupAccess=licenseGroupAccess, secondarySoftwareVersion=secondarySoftwareVersion, deviceMACAddress=deviceMACAddress, mABState=mABState, syslogStateTrap=syslogStateTrap, hardwareVersion=hardwareVersion, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, capacityVariantMismatchLinked=capacityVariantMismatchLinked, qOSPriorityScheme=qOSPriorityScheme, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dNSServerTable=dNSServerTable, secureModeAlarmTrap=secureModeAlarmTrap, mgmtInstancedTable=mgmtInstancedTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, alarmsGroup=alarmsGroup, aggregateDataRate=aggregateDataRate, mgmtInstancedTableEntry=mgmtInstancedTableEntry, licenseGroup=licenseGroup, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, siteName=siteName, receiveDataRateLinked=receiveDataRateLinked, tFTPServerInternetAddress=tFTPServerInternetAddress, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, mABProtocolVID=mABProtocolVID, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, supplementary=supplementary, pubStats=pubStats, phyControl=phyControl, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseInstancedTableEntry=licenseInstancedTableEntry, sFPPortAllocation=sFPPortAllocation, transmitFreqKHz=transmitFreqKHz, wirelessOutAllOctets=wirelessOutAllOctets, sMTPServerInternetAddressType=sMTPServerInternetAddressType, deviceESN=deviceESN, sNTPServerTable=sNTPServerTable, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, licenseIEEE1588Support=licenseIEEE1588Support, ptp670=ptp670, dNSGroup=dNSGroup, hCMPLinkSymmetry=hCMPLinkSymmetry, authorizationControl=authorizationControl, erroredSeconds=erroredSeconds, mABTransmissionInterval=mABTransmissionInterval, mABNominalModulationMode=mABNominalModulationMode, tDDControl=tDDControl, sNTPServerTimeout=sNTPServerTimeout, phyControlInstancedTableEntry=phyControlInstancedTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, transmitDataRateLinked=transmitDataRateLinked, sntp=sntp, sNMPTrapPortNumber=sNMPTrapPortNumber, frequencyVariant=frequencyVariant, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, phyControlInstancedTable=phyControlInstancedTable, targetRange=targetRange, byteErrorRatioLinked=byteErrorRatioLinked, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mainPSUPortStatusTrap=mainPSUPortStatusTrap, licenseInstancedTableNumber=licenseInstancedTableNumber, dfsGroup=dfsGroup, reset=reset, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, groupID=groupID, sFPPortAutoMdix=sFPPortAutoMdix, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, capacityVariantMismatchTrap=capacityVariantMismatchTrap, configurationGroup=configurationGroup, sNTPServerTableEntry=sNTPServerTableEntry, transmitFreqMHz=transmitFreqMHz, versionsGroup=versionsGroup, wirelessLinkStatusLinked=wirelessLinkStatusLinked, dfsTable=dfsTable, ethernetPriorityTable=ethernetPriorityTable, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseInstancedTableIndex=licenseInstancedTableIndex, userEnabled=userEnabled, hTTPSPortNumber=hTTPSPortNumber, softwareVersion=softwareVersion, latitude=latitude, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDMEnabledChannels=tDMEnabledChannels, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDMChannelStatusTrap=tDMChannelStatusTrap, channelBandwidth=channelBandwidth, receiveDataRate=receiveDataRate, linkLossLinked=linkLossLinked, mainPSUPortStatus=mainPSUPortStatus, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installationMode=installationMode, licenseMaxLinkRange=licenseMaxLinkRange, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, userPassword=userPassword, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sFPPortSSMTx=sFPPortSSMTx, cambium=cambium, licenseGasGroup=licenseGasGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, auxPortQLRx=auxPortQLRx, dNSPrimaryServer=dNSPrimaryServer, antennaGain=antennaGain, signalStrengthRatio=signalStrengthRatio, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, regulatoryBandTrap=regulatoryBandTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, tDDControlGroup=tDDControlGroup, licenseSyncESupport=licenseSyncESupport, tDMChannelStatus=tDMChannelStatus, lbtDetectedTrap=lbtDetectedTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hTTPPortNumber=hTTPPortNumber, sFPError=sFPError, dNSResolver=dNSResolver, l2CPPriorityTable=l2CPPriorityTable, apc=apc, subbandLowestFrequency=subbandLowestFrequency, nIDULanPortAutoMdix=nIDULanPortAutoMdix, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, ethernetStatisticsTable=ethernetStatisticsTable, cableLoss=cableLoss, ethernetInstancedTableEntry=ethernetInstancedTableEntry, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, remoteInternetAddress=remoteInternetAddress, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mgmtInstancedTableIndex=mgmtInstancedTableIndex, gatewayIPAddress=gatewayIPAddress, blacklistRMEnabled=blacklistRMEnabled, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, rangingMode=rangingMode, portAllocationMismatchTrap=portAllocationMismatchTrap, alarmInstancedTable=alarmInstancedTable, productName=productName, tDMInterfaceControl=tDMInterfaceControl, mainPSUPortSSMTx=mainPSUPortSSMTx, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vectorErrorLinked=vectorErrorLinked, mainPSUPortQLRx=mainPSUPortQLRx, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, phyControlInstancedTableNumber=phyControlInstancedTableNumber, ptpTrapPrefix=ptpTrapPrefix, dataBridgingStatus=dataBridgingStatus, vectorError=vectorError, authorizationControlGroup=authorizationControlGroup, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, PYSNMP_MODULE_ID=cambium, localPacketFiltering=localPacketFiltering, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseVersion=licenseVersion, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPv3Enable=sNMPv3Enable, encryptionAlgorithm=encryptionAlgorithm, transparentClockVLAN=transparentClockVLAN, userTableNumber=userTableNumber, dfs=dfs, userRole=userRole, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, auxPortConfigurationMismatch=auxPortConfigurationMismatch, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsTableEntry=dfsTableEntry, bootVersion=bootVersion, iPv6GatewayAddress=iPv6GatewayAddress, enableTransmission=enableTransmission, tDMConfigurationMismatch=tDMConfigurationMismatch, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, blacklistRMMacAddress=blacklistRMMacAddress, regulatoryBand=regulatoryBand, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, tDMInterfaceStatus=tDMInterfaceStatus, receiveFreqKHz=receiveFreqKHz, sFPPortSyncERxStatus=sFPPortSyncERxStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, cableDiagnostics=cableDiagnostics, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, phyInstancedStatusTable=phyInstancedStatusTable, iPv6Address=iPv6Address, sNMPPortNumber=sNMPPortNumber, dNSServerTableNumber=dNSServerTableNumber, rawReceivePower=rawReceivePower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, productVariant=productVariant, syncETrackingState=syncETrackingState, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, remoteMACAddressLinked=remoteMACAddressLinked, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, configurationInstancedTableNumber=configurationInstancedTableNumber, sNTPPollInterval=sNTPPollInterval, sNTPPrimaryServer=sNTPPrimaryServer, aAAControl=aAAControl, installStatusTrap=installStatusTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, sntpGroup=sntpGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mainPSUPortQLTx=mainPSUPortQLTx, snmpControlGroup=snmpControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, vLANManagementPriority=vLANManagementPriority, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, management=management, deviceMSN=deviceMSN, subnetMask=subnetMask, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sNTPState=sNTPState, secureModeAlarm=secureModeAlarm, cableDiagPair2Distance=cableDiagPair2Distance, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteMACAddress=remoteMACAddress, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, timeZone=timeZone, resetGroup=resetGroup, versions=versions, auxPortStatusTrap=auxPortStatusTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, syslogClient=syslogClient, userName=userName, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, supplementaryGroup=supplementaryGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", extendedSpectrumScanning=extendedSpectrumScanning, searchStateLinked=searchStateLinked, sNMPEnabledTraps=sNMPEnabledTraps, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, pubStatsGroup=pubStatsGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, daylightSaving=daylightSaving, sNMPCommunityString=sNMPCommunityString, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dfsTableNumber=dfsTableNumber, transmitPower=transmitPower, dfsMeans=dfsMeans, licenseSecurityLevel=licenseSecurityLevel, eIRP=eIRP, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, alarmInstancedTableNumber=alarmInstancedTableNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dNS=dNS, encryption=encryption, installArmState=installArmState, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, sFPPortQLTx=sFPPortQLTx, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRateLinked=aggregateDataRateLinked, phyControlGroup=phyControlGroup, smtpGroup=smtpGroup, packetsFromInternalStack=packetsFromInternalStack, syncETracking=syncETracking, receiveFreqMHz=receiveFreqMHz, lowestTDMModulationMode=lowestTDMModulationMode, targetMACAddress=targetMACAddress, channelChangeTrap=channelChangeTrap, iPv6PrefixLength=iPv6PrefixLength, txMABFrames=txMABFrames, transmitDataRate=transmitDataRate, tempPcb=tempPcb, maximumTransmitPower=maximumTransmitPower, sNTPServerStatus=sNTPServerStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, rawReceivePowerLinked=rawReceivePowerLinked, sFPErrorTrap=sFPErrorTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, managementGroup=managementGroup, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, dNSServerTableEntry=dNSServerTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cableDiagPair3Distance=cableDiagPair3Distance)
