...
# Produced by pysmi-1.1.12 at Wed Oct  9 02:17:04 2024
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", notificationsGroup=notificationsGroup, encryption=encryption, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, sFPErrorTrap=sFPErrorTrap, supplementaryGroup=supplementaryGroup, sNMPPortNumber=sNMPPortNumber, dataPortPauseFrames=dataPortPauseFrames, remoteInternetAddressType=remoteInternetAddressType, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelBandwidth=channelBandwidth, licenseInstancedTable=licenseInstancedTable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, accessMethod=accessMethod, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, softwareVersion=softwareVersion, bridge=bridge, receiveModulationMode=receiveModulationMode, ethernetStatisticsDataSource=ethernetStatisticsDataSource, ethernet=ethernet, antennaGain=antennaGain, licenseIEEE1588Support=licenseIEEE1588Support, rawReceivePower=rawReceivePower, whitelistRMEnabled=whitelistRMEnabled, snmpControl=snmpControl, tDDControl=tDDControl, bridgeGroup=bridgeGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, mainPSUPortQLTx=mainPSUPortQLTx, syslogState=syslogState, licenseSyncESupport=licenseSyncESupport, sNTPLastSync=sNTPLastSync, useVLANForMABProtocol=useVLANForMABProtocol, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, lowestTDMModulationMode=lowestTDMModulationMode, iPVersion=iPVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mABNominalTransmitCapacity=mABNominalTransmitCapacity, managementNetworkAccessEnabled=managementNetworkAccessEnabled, auxPortStatus=auxPortStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, cableDiagPair4Results=cableDiagPair4Results, erroredSeconds=erroredSeconds, licenseUnitSerialNumber=licenseUnitSerialNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, userRole=userRole, license=license, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mABTransmissionInterval=mABTransmissionInterval, licenseIssueNumber=licenseIssueNumber, licenseCountry=licenseCountry, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, installStatus=installStatus, ethernetStatisticsTable=ethernetStatisticsTable, authorizationMethod=authorizationMethod, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tDMChannelStatusTrap=tDMChannelStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, byteErrorRatioLinked=byteErrorRatioLinked, regulatoryBand=regulatoryBand, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, vectorErrorLinked=vectorErrorLinked, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPPrimaryServer=sNTPPrimaryServer, lbtDetectedTrap=lbtDetectedTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseTLSRekey=licenseTLSRekey, sNTPSync=sNTPSync, ptpGroups=ptpGroups, sNTPServerRetries=sNTPServerRetries, longitude=longitude, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sNTPServerTimeout=sNTPServerTimeout, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, sNTPServerPortNumber=sNTPServerPortNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sNTPServerTable=sNTPServerTable, deviceMACAddress=deviceMACAddress, auxPortConfigurationMismatch=auxPortConfigurationMismatch, aggregateDataRateLinked=aggregateDataRateLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, aAAControl=aAAControl, licenseTrialPeriod=licenseTrialPeriod, lowestDataModulationMode=lowestDataModulationMode, nIDULanPortStatusTrap=nIDULanPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cambium=cambium, dNSServerInternetAddressType=dNSServerInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsGroup=dfsGroup, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, phyControlInstancedTableNumber=phyControlInstancedTableNumber, auxPortQLTx=auxPortQLTx, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitPowerLinked=transmitPowerLinked, transparentClock=transparentClock, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, authorizationControlTableEntry=authorizationControlTableEntry, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, authorizationControlTableNumber=authorizationControlTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPv4Address=iPv4Address, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, unavailableSeconds=unavailableSeconds, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, ptpTrapPrefix=ptpTrapPrefix, transparentClockVID=transparentClockVID, smtpGroup=smtpGroup, sFPError=sFPError, licenseRegulatoryBandsList=licenseRegulatoryBandsList, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, alarmsGroup=alarmsGroup, installationMode=installationMode, licenseCapacity=licenseCapacity, ethernetInstancedTableIndex=ethernetInstancedTableIndex, syncEEquipmentClock=syncEEquipmentClock, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetPriorityTable=ethernetPriorityTable, tDMInterfaceStatus=tDMInterfaceStatus, configurationInstancedTableEntry=configurationInstancedTableEntry, transmitModulationModeLinked=transmitModulationModeLinked, mainPSUPortAutoMdix=mainPSUPortAutoMdix, telnetPortNumber=telnetPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, licenseRARSupport=licenseRARSupport, auxPortAllocation=auxPortAllocation, mABMaintenanceLevel=mABMaintenanceLevel, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, iPv6GatewayAddress=iPv6GatewayAddress, portAllocationMismatchTrap=portAllocationMismatchTrap, cableDiagPair1Distance=cableDiagPair1Distance, receiveModulationModeDetail=receiveModulationModeDetail, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, cableDiagnosticsGroup=cableDiagnosticsGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseVersion=licenseVersion, licenseHCMPSupport=licenseHCMPSupport, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sFPPortQLTx=sFPPortQLTx, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, receiveDataRateLinked=receiveDataRateLinked, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, timeZone=timeZone, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sFPPortSSMTx=sFPPortSSMTx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, syslogClientTrap=syslogClientTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, targetRange=targetRange, transmitterChannels=transmitterChannels, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControlGroup=phyControlGroup, licenseInstancedTableNumber=licenseInstancedTableNumber, snmpControlGroup=snmpControlGroup, tDMChannelLoopback=tDMChannelLoopback, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, sntp=sntp, dfsTableEntry=dfsTableEntry, auxPortAcceptedQLRx=auxPortAcceptedQLRx, syncESlavePort=syncESlavePort, licenseMaxLinkRange=licenseMaxLinkRange, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, productVariant=productVariant, hTTPSPortNumber=hTTPSPortNumber, licenseInstancedTableEntry=licenseInstancedTableEntry, tDM=tDM, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sntpGroup=sntpGroup, aggregateDataRate=aggregateDataRate, sNMPTrapVersion=sNMPTrapVersion, byteErrorRatio=byteErrorRatio, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, apc=apc, sNTPServerStatus=sNTPServerStatus, userPassword=userPassword, cableDiagPair1Results=cableDiagPair1Results, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, severelyErroredSeconds=severelyErroredSeconds, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, altitude=altitude, ptpCompliance=ptpCompliance, rangingMode=rangingMode, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, receiveDataRate=receiveDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPServerPortNumber=tFTPServerPortNumber, alarmInstancedTable=alarmInstancedTable, licenseGasGroup=licenseGasGroup, sNTPSyncTrap=sNTPSyncTrap, ptp670=ptp670, sMTPEmailAlert=sMTPEmailAlert, transmitFreqKHz=transmitFreqKHz, extendedSpectrumScanning=extendedSpectrumScanning, linkName=linkName, ethernetGroup=ethernetGroup, receiveChannel=receiveChannel, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPClient=tFTPClient, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sMTPServerPortNumber=sMTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, dNSServerInternetAddress=dNSServerInternetAddress, wirelessLinkStatus=wirelessLinkStatus, wirelessOutAllOctets=wirelessOutAllOctets, transmitFreqMHz=transmitFreqMHz, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, gatewayIPAddress=gatewayIPAddress, tDMChannelCableLength=tDMChannelCableLength, secureModeAlarm=secureModeAlarm, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, versions=versions, searchStateLinked=searchStateLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, secureModeAlarmTrap=secureModeAlarmTrap, versionsGroup=versionsGroup, mainPSUPortStatusTrap=mainPSUPortStatusTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, rawReceivePowerLinked=rawReceivePowerLinked, configurationInstancedTable=configurationInstancedTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessTopology=wirelessTopology, mainPSUPortSSMTx=mainPSUPortSSMTx, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, tdmTableIndex=tdmTableIndex, hCMPLinkSymmetry=hCMPLinkSymmetry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, mABNominalModulationMode=mABNominalModulationMode, phyStatus=phyStatus, enableTransmission=enableTransmission, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, pubStatsGroup=pubStatsGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseGroup=licenseGroup, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, alarmInstancedTableNumber=alarmInstancedTableNumber, cableDiagnostics=cableDiagnostics, portAllocationMismatchLinked=portAllocationMismatchLinked, managementGroup=managementGroup, dfsTable=dfsTable, sNTPServerInternetAddress=sNTPServerInternetAddress, mainPSUPortQLRx=mainPSUPortQLRx, syncETracking=syncETracking, whitelistRMMacAddress=whitelistRMMacAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dfsTableNumber=dfsTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, userTable=userTable, capacityVariantMismatchTrap=capacityVariantMismatchTrap, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, tDMEnabledChannels=tDMEnabledChannels, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, maximumTransmitPower=maximumTransmitPower, receiveFreqKHz=receiveFreqKHz, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, userTableEntry=userTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, routerProtocols=routerProtocols, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sFPPortAllocation=sFPPortAllocation, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, wirelessOutOctets=wirelessOutOctets, mABProtocolVID=mABProtocolVID, sNMPCommunityString=sNMPCommunityString, ptmp=ptmp, tDDControlGroup=tDDControlGroup, hardwareVersion=hardwareVersion, cableDiagPair3Distance=cableDiagPair3Distance, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, configuration=configuration, unitIdentification=unitIdentification, receivePowerLinked=receivePowerLinked, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, linkLossLinked=linkLossLinked, auxPortDisabledWarning=auxPortDisabledWarning, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, reset=reset, aAAControlGroup=aAAControlGroup, phyInstancedStatusTable=phyInstancedStatusTable, receiveFreqMHz=receiveFreqMHz, syslogStateTrap=syslogStateTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, apcGroup=apcGroup, pubInstancedStatsTable=pubInstancedStatsTable, range=range, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, userName=userName, remoteInternetAddressLinked=remoteInternetAddressLinked, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dNS=dNS, dNSServerTableEntry=dNSServerTableEntry, sFPPortStatus=sFPPortStatus, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, dNSResolver=dNSResolver, targetMACAddress=targetMACAddress, dfsTableIndex=dfsTableIndex, mgmtInstancedTableIndex=mgmtInstancedTableIndex, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, auxPortSyncERxStatus=auxPortSyncERxStatus, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, tDMGroup=tDMGroup, tempPcb=tempPcb, dNSServerTable=dNSServerTable, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, transmitDataRateLinked=transmitDataRateLinked, phyStatusGroup=phyStatusGroup, dNSServerPortNumber=dNSServerPortNumber, vectorError=vectorError, transparentClockPort=transparentClockPort, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, antennaSelection=antennaSelection, dfsPeaks=dfsPeaks, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ethernetInstancedTable=ethernetInstancedTable, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sNMPv3Enable=sNMPv3Enable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, l2CPPriorityTable=l2CPPriorityTable, capacityVariantMismatch=capacityVariantMismatch, transmitDataRate=transmitDataRate, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rangeLinked=rangeLinked, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, latitude=latitude, hCMPMaximumLinkRange=hCMPMaximumLinkRange, rxColorCode=rxColorCode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, PYSNMP_MODULE_ID=cambium, vLANManagementPriority=vLANManagementPriority, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, tdmTable=tdmTable, packetsFromInternalStack=packetsFromInternalStack, auxPortQLRx=auxPortQLRx, pubStats=pubStats, unitName=unitName, linkLoss=linkLoss, receivePower=receivePower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, productName=productName, transmitModulationMode=transmitModulationMode, phyControlInstancedTable=phyControlInstancedTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, wirelessLinkStatusLinked=wirelessLinkStatusLinked, licenseTDDSyncSupport=licenseTDDSyncSupport, ethernetInstancedTableEntry=ethernetInstancedTableEntry, vLANManagementVID=vLANManagementVID, maxLinkRangeExceeded=maxLinkRangeExceeded, systemReset=systemReset, installStatusLinked=installStatusLinked, tDMChannelLineCode=tDMChannelLineCode, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, cableDiagPair4Distance=cableDiagPair4Distance, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, ptpTraps=ptpTraps, licenseBandwidthCap=licenseBandwidthCap, tdmTableNumber=tdmTableNumber, licenseSFPPortSupport=licenseSFPPortSupport, sNMPTrapPortNumber=sNMPTrapPortNumber, iPv6Address=iPv6Address, mainPSUPortAllocation=mainPSUPortAllocation, dNSServerTableIndex=dNSServerTableIndex, authorizationControl=authorizationControl, smtp=smtp, syncETrackingState=syncETrackingState, mABState=mABState, subnetMask=subnetMask, licenseOOBManagementSupport=licenseOOBManagementSupport, alarmInstancedTableEntry=alarmInstancedTableEntry, dataBridgingAvailability=dataBridgingAvailability, syslogClient=syslogClient, daylightSaving=daylightSaving, transmitPower=transmitPower, phyControl=phyControl, signalStrengthRatio=signalStrengthRatio, authorizationControlTable=authorizationControlTable, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, userTableNumber=userTableNumber, unitIdentificationGroup=unitIdentificationGroup, configurationGroup=configurationGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userEnabled=userEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installArmStateTrap=installArmStateTrap, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, dataBridgingStatusLinked=dataBridgingStatusLinked, txColorCode=txColorCode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, resetGroup=resetGroup, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, receiveModulationModeLinked=receiveModulationModeLinked, syslogControlGroup=syslogControlGroup, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, auxPortSSMTx=auxPortSSMTx, licenseEncryption=licenseEncryption, sFPPortAutoMdix=sFPPortAutoMdix, phyControlInstancedTableEntry=phyControlInstancedTableEntry, linkModeOptimization=linkModeOptimization, deviceMSN=deviceMSN, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, packetsToInternalStack=packetsToInternalStack, regulatoryBandTrap=regulatoryBandTrap, tDDSynchronizationMode=tDDSynchronizationMode, maximumNumberOfSlaves=maximumNumberOfSlaves, blacklistRMMacAddress=blacklistRMMacAddress, transparentClockVLAN=transparentClockVLAN, managementPortWirelessDownAlert=managementPortWirelessDownAlert, searchState=searchState, configurationInstancedTableIndex=configurationInstancedTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, cableDiagnosticsControl=cableDiagnosticsControl, sNTPPollInterval=sNTPPollInterval, unitOutOfCalibration=unitOutOfCalibration, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, wirelessOutEthernetOctets=wirelessOutEthernetOctets, installStatusTrap=installStatusTrap, tDMInterfaceControl=tDMInterfaceControl, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfs=dfs, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteUnitNameLinked=remoteUnitNameLinked, tDMConfigurationMismatch=tDMConfigurationMismatch, sFPPortDisabledWarning=sFPPortDisabledWarning, qOSPriorityScheme=qOSPriorityScheme, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, licenseIPv6Support=licenseIPv6Support, sNTPServerTableIndex=sNTPServerTableIndex, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, phyControlInstancedTableIndex=phyControlInstancedTableIndex, ptp=ptp, systemClock=systemClock, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, syslogControl=syslogControl, sFPPortStatusTrap=sFPPortStatusTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, hTTPPortNumber=hTTPPortNumber, eIRP=eIRP, nIDULanPortStatus=nIDULanPortStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, linkSymmetry=linkSymmetry, transmitChannel=transmitChannel, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, configurationInstancedTableNumber=configurationInstancedTableNumber, remoteMACAddress=remoteMACAddress, siteName=siteName, subbandLowestFrequency=subbandLowestFrequency, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, encryptionAlgorithm=encryptionAlgorithm, licenseInstancedTableIndex=licenseInstancedTableIndex, tDMChannelStatus=tDMChannelStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableDiagPair3Results=cableDiagPair3Results, blacklistRMEnabled=blacklistRMEnabled, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, management=management, dNSServerTableNumber=dNSServerTableNumber, frequencyVariant=frequencyVariant, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseGroupAccess=licenseGroupAccess, dNSPrimaryServer=dNSPrimaryServer, iPv6PrefixLength=iPv6PrefixLength, userTableIndex=userTableIndex, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, alarmInstancedTableIndex=alarmInstancedTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, txMABFrames=txMABFrames, telnetAccessEnabled=telnetAccessEnabled, deviceESN=deviceESN, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, auxPortStatusTrap=auxPortStatusTrap, installArmState=installArmState, routerProtocolsGroup=routerProtocolsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, masterSlaveMode=masterSlaveMode, cableLoss=cableLoss, groupID=groupID, remoteMACAddressLinked=remoteMACAddressLinked, portAllocationMismatch=portAllocationMismatch, channelChangeTrap=channelChangeTrap, supplementary=supplementary, alarms=alarms, oOBPriorityQueueMapping=oOBPriorityQueueMapping, dNSGroup=dNSGroup, encryptionGroup=encryptionGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseSecurityLevel=licenseSecurityLevel, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mgmtInstancedTable=mgmtInstancedTable, ethernetInstancedTableNumber=ethernetInstancedTableNumber, authorizationControlTableIndex=authorizationControlTableIndex, mgmtInstancedTableNumber=mgmtInstancedTableNumber, remoteUnitName=remoteUnitName, authorizationControlGroup=authorizationControlGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, remoteInternetAddress=remoteInternetAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, capacityVariantMismatchLinked=capacityVariantMismatchLinked, nIDULanPortAutoMdix=nIDULanPortAutoMdix, cableDiagPair2Distance=cableDiagPair2Distance, mABHoldoffPeriod=mABHoldoffPeriod, tdmTableEntry=tdmTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, sNTPState=sNTPState, localPacketFiltering=localPacketFiltering, dfsMeans=dfsMeans, cableDiagPair2Results=cableDiagPair2Results, hTTPAccessEnabled=hTTPAccessEnabled, mgmtInstancedTableEntry=mgmtInstancedTableEntry, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, dataBridgingStatus=dataBridgingStatus, mainPSUPortStatus=mainPSUPortStatus, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sFPPortQLRx=sFPPortQLRx, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNMPTrapTable=sNMPTrapTable)
