...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:25:58 2023
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transmitFreqMHz=transmitFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, managementPortWirelessDownAlert=managementPortWirelessDownAlert, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, accessMethod=accessMethod, severelyErroredSeconds=severelyErroredSeconds, ethernetPriorityTable=ethernetPriorityTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseTrialPeriod=licenseTrialPeriod, subbandLowestFrequency=subbandLowestFrequency, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTimeout=sNTPServerTimeout, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syncEEquipmentClock=syncEEquipmentClock, tDMEnabledChannels=tDMEnabledChannels, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, gatewayIPAddress=gatewayIPAddress, rawReceivePowerLinked=rawReceivePowerLinked, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, wirelessOutOctets=wirelessOutOctets, linkName=linkName, remoteInternetAddressLinked=remoteInternetAddressLinked, secureModeAlarm=secureModeAlarm, tDMChannelStatus=tDMChannelStatus, dfsPeaks=dfsPeaks, configurationInstancedTableNumber=configurationInstancedTableNumber, ethernetStatisticsDataSource=ethernetStatisticsDataSource, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, telnetAccessEnabled=telnetAccessEnabled, mgmtInstancedTableIndex=mgmtInstancedTableIndex, transmitPowerLinked=transmitPowerLinked, regulatoryBandTrap=regulatoryBandTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortSSMTx=auxPortSSMTx, mABState=mABState, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tDDControlGroup=tDDControlGroup, dNS=dNS, remoteMACAddress=remoteMACAddress, ethernetGroup=ethernetGroup, managementNetworkAccessEnabled=managementNetworkAccessEnabled, authorizationControlGroup=authorizationControlGroup, licenseHCMPSupport=licenseHCMPSupport, cambium=cambium, phyControlInstancedTable=phyControlInstancedTable, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, auxPortQLTx=auxPortQLTx, transmitFreqKHz=transmitFreqKHz, transmitDataRate=transmitDataRate, rawReceivePower=rawReceivePower, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, snmpControlGroup=snmpControlGroup, phyControlInstancedTableEntry=phyControlInstancedTableEntry, phyStatus=phyStatus, searchStateLinked=searchStateLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, siteName=siteName, userTable=userTable, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sNTPServerInternetAddressType=sNTPServerInternetAddressType, aAAControl=aAAControl, authorizationControlTable=authorizationControlTable, smtp=smtp, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sFPErrorTrap=sFPErrorTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sFPPortSSMTx=sFPPortSSMTx, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mainPSUPortQLRx=mainPSUPortQLRx, tDDSynchronizationStatus=tDDSynchronizationStatus, eIRP=eIRP, iPv6Address=iPv6Address, dfsTableEntry=dfsTableEntry, dNSServerTableNumber=dNSServerTableNumber, productVariant=productVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, receiveModulationMode=receiveModulationMode, dataBridgingStatus=dataBridgingStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTrapPrefix=ptpTrapPrefix, nIDULanPortStatus=nIDULanPortStatus, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, installStatusLinked=installStatusLinked, smtpGroup=smtpGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, transmitModulationMode=transmitModulationMode, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sFPPortDisabledWarning=sFPPortDisabledWarning, iPDSCPPriorityTable=iPDSCPPriorityTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, byteErrorRatioLinked=byteErrorRatioLinked, receiveFreqMHz=receiveFreqMHz, encryptionGroup=encryptionGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tdmTableNumber=tdmTableNumber, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseTLSRekey=licenseTLSRekey, sFPPortAllocation=sFPPortAllocation, useVLANForMABProtocol=useVLANForMABProtocol, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerRetries=sNTPServerRetries, alarmInstancedTableEntry=alarmInstancedTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transparentClockPort=transparentClockPort, linkLossLinked=linkLossLinked, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseIssueNumber=licenseIssueNumber, range=range, dfsGroup=dfsGroup, wirelessTopology=wirelessTopology, syncESlavePort=syncESlavePort, cableDiagPair1Distance=cableDiagPair1Distance, tdmTable=tdmTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerTableEntry=sNTPServerTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseIPv6Support=licenseIPv6Support, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, configurationInstancedTable=configurationInstancedTable, userTableEntry=userTableEntry, phyControlGroup=phyControlGroup, syslogClientTrap=syslogClientTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sFPPortQLRx=sFPPortQLRx, productName=productName, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, localPacketFiltering=localPacketFiltering, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, packetsFromInternalStack=packetsFromInternalStack, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitModulationModeLinked=transmitModulationModeLinked, alarms=alarms, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, userTableIndex=userTableIndex, hCMPLinkSymmetry=hCMPLinkSymmetry, tDDControl=tDDControl, mABProtocolVID=mABProtocolVID, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, vLANManagementVID=vLANManagementVID, cableDiagPair3Distance=cableDiagPair3Distance, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControlGroup=syslogControlGroup, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, l2CPPriorityTableIndex=l2CPPriorityTableIndex, configurationGroup=configurationGroup, versionsGroup=versionsGroup, license=license, targetMACAddress=targetMACAddress, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, dataBridgingAvailability=dataBridgingAvailability, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPollInterval=sNTPPollInterval, tDMGroup=tDMGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, apcGroup=apcGroup, cableLoss=cableLoss, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tDMChannelStatusTrap=tDMChannelStatusTrap, tdmTableEntry=tdmTableEntry, cableDiagnosticsGroup=cableDiagnosticsGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, syncETrackingState=syncETrackingState, licenseInstancedTableIndex=licenseInstancedTableIndex, sntpGroup=sntpGroup, dNSServerInternetAddress=dNSServerInternetAddress, linkModeOptimization=linkModeOptimization, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, deviceESN=deviceESN, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, authorizationControl=authorizationControl, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, apc=apc, searchState=searchState, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, remoteUnitNameLinked=remoteUnitNameLinked, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, altitude=altitude, ptp670=ptp670, alarmInstancedTableNumber=alarmInstancedTableNumber, licenseSecurityLevel=licenseSecurityLevel, userTableNumber=userTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, signalStrengthRatio=signalStrengthRatio, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, dfs=dfs, iPv6PrefixLength=iPv6PrefixLength, receiveFreqKHz=receiveFreqKHz, latitude=latitude, management=management, auxPortStatus=auxPortStatus, licenseInstancedTableNumber=licenseInstancedTableNumber, unitName=unitName, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseInstancedTable=licenseInstancedTable, userPassword=userPassword, ethernetStatisticsTable=ethernetStatisticsTable, dataPortPauseFrames=dataPortPauseFrames, daylightSaving=daylightSaving, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, aggregateDataRate=aggregateDataRate, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, whitelistRMEnabled=whitelistRMEnabled, ethernetInstancedTableEntry=ethernetInstancedTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, userName=userName, licenseInstancedTableEntry=licenseInstancedTableEntry, iPVersion=iPVersion, syslogState=syslogState, dNSPrimaryServer=dNSPrimaryServer, phyStatusGroup=phyStatusGroup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, auxPortQLRx=auxPortQLRx, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, auxPortAllocation=auxPortAllocation, oOBPriorityQueueMapping=oOBPriorityQueueMapping, aAAControlGroup=aAAControlGroup, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dNSGroup=dNSGroup, iPv4Address=iPv4Address, licenseOOBManagementSupport=licenseOOBManagementSupport, transmitDataRateLinked=transmitDataRateLinked, portAllocationMismatch=portAllocationMismatch, packetsToInternalStack=packetsToInternalStack, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, dfsMeans=dfsMeans, licenseRARSupport=licenseRARSupport, sFPError=sFPError, alarmInstancedTable=alarmInstancedTable, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, blacklistRMMacAddress=blacklistRMMacAddress, hTTPPortNumber=hTTPPortNumber, vectorError=vectorError, syslogLocalWrappedTrap=syslogLocalWrappedTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mABNominalModulationMode=mABNominalModulationMode, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, ptpCompliance=ptpCompliance, targetRange=targetRange, receiveChannel=receiveChannel, ptp=ptp, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, bootVersion=bootVersion, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, erroredSeconds=erroredSeconds, dfsTableIndex=dfsTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, licenseVersion=licenseVersion, remoteInternetAddressType=remoteInternetAddressType, dSCPManagementPriority=dSCPManagementPriority, licenseUnitSerialNumber=licenseUnitSerialNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPPortStatusTrap=sFPPortStatusTrap, remoteInternetAddress=remoteInternetAddress, unavailableSeconds=unavailableSeconds, secondarySoftwareVersion=secondarySoftwareVersion, sNTPServerInternetAddress=sNTPServerInternetAddress, syncETracking=syncETracking, routerProtocols=routerProtocols, auxPortSyncERxStatus=auxPortSyncERxStatus, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, managementGroup=managementGroup, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseSFPPortSupport=licenseSFPPortSupport, transmitChannel=transmitChannel, userRole=userRole, installArmStateTrap=installArmStateTrap, vectorErrorLinked=vectorErrorLinked, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mainPSUPortSSMTx=mainPSUPortSSMTx, unitIdentificationGroup=unitIdentificationGroup, portAllocationMismatchTrap=portAllocationMismatchTrap, installStatus=installStatus, signalStrengthRatioLinked=signalStrengthRatioLinked, telnetPortNumber=telnetPortNumber, mABHoldoffPeriod=mABHoldoffPeriod, sntp=sntp, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseGasGroup=licenseGasGroup, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, systemReset=systemReset, installationMode=installationMode, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sNMPTrapTable=sNMPTrapTable, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseMaxLinkRange=licenseMaxLinkRange, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, dfsTableNumber=dfsTableNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, syslogControl=syslogControl, versions=versions, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, lowestTDMModulationMode=lowestTDMModulationMode, whitelistRMMacAddress=whitelistRMMacAddress, syslogStateTrap=syslogStateTrap, l2CPPriorityTable=l2CPPriorityTable, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkStatus=wirelessLinkStatus, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, lowestDataModulationMode=lowestDataModulationMode, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, extendedSpectrumScanning=extendedSpectrumScanning, mABMaintenanceLevel=mABMaintenanceLevel, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, mgmtInstancedTable=mgmtInstancedTable, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, deviceMACAddress=deviceMACAddress, phyControlInstancedTableIndex=phyControlInstancedTableIndex, authorizationMethod=authorizationMethod, tDMChannelCableLength=tDMChannelCableLength, sNTPServerTableIndex=sNTPServerTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkLoss=linkLoss, ethernetInstancedTableIndex=ethernetInstancedTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, subbandHighestFrequency=subbandHighestFrequency, maxLinkRangeExceeded=maxLinkRangeExceeded, systemClock=systemClock, mPLSTCPriorityTable=mPLSTCPriorityTable, dataBridgingStatusLinked=dataBridgingStatusLinked, receiveDataRateLinked=receiveDataRateLinked, wirelessLinkAvailability=wirelessLinkAvailability, hardwareVersion=hardwareVersion, softwareVersion=softwareVersion, maximumTransmitPower=maximumTransmitPower, sFPPortStatus=sFPPortStatus, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, supplementary=supplementary, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, deviceMSN=deviceMSN, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, remoteMACAddressLinked=remoteMACAddressLinked, resetGroup=resetGroup, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mainPSUPortStatus=mainPSUPortStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tDMChannelLoopback=tDMChannelLoopback, transparentClockVID=transparentClockVID, cableDiagPair4Results=cableDiagPair4Results, tDMConfigurationMismatch=tDMConfigurationMismatch, cableDiagPair4Distance=cableDiagPair4Distance, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, routerProtocolsGroup=routerProtocolsGroup, phyControlInstancedTableNumber=phyControlInstancedTableNumber, subnetMask=subnetMask, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, installArmState=installArmState, receiveModulationModeLinked=receiveModulationModeLinked, bridge=bridge, ptpGroups=ptpGroups, licenseIEEE1588Support=licenseIEEE1588Support, licenseTDDSyncSupport=licenseTDDSyncSupport, rangeLinked=rangeLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, wirelessOutEthernetOctets=wirelessOutEthernetOctets, syslogClient=syslogClient, sFPPortQLTx=sFPPortQLTx, linkSymmetry=linkSymmetry, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, mABProtocolVLANPriority=mABProtocolVLANPriority, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, configuration=configuration, cableDiagnosticsResultTable=cableDiagnosticsResultTable, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tFTPClient=tFTPClient, licenseCapacity=licenseCapacity, antennaGain=antennaGain, dNSServerPortNumber=dNSServerPortNumber, tempPcb=tempPcb, tDMInterfaceStatus=tDMInterfaceStatus, bridgeGroup=bridgeGroup, sNMPv3Enable=sNMPv3Enable, licenseGroupAccess=licenseGroupAccess, licenseSyncESupport=licenseSyncESupport, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetInstancedTable=ethernetInstancedTable, transmitPower=transmitPower, tDMChannelLineCode=tDMChannelLineCode, alarmInstancedTableIndex=alarmInstancedTableIndex, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, regulatoryBand=regulatoryBand, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerTableNumber=sNTPServerTableNumber, configurationInstancedTableEntry=configurationInstancedTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, authorizationControlTableEntry=authorizationControlTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, encryptionAlgorithm=encryptionAlgorithm, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, cableDiagPair3Results=cableDiagPair3Results, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, masterSlaveMode=masterSlaveMode, groupID=groupID, userEnabled=userEnabled, licenseGroup=licenseGroup, dNSResolver=dNSResolver, portAllocationMismatchLinked=portAllocationMismatchLinked, rxColorCode=rxColorCode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licenseCountry=licenseCountry, sNMPPortNumber=sNMPPortNumber, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNMPCommunityString=sNMPCommunityString, dNSServerTable=dNSServerTable, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, frequencyVariant=frequencyVariant, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mgmtInstancedTableNumber=mgmtInstancedTableNumber, wirelessOutAllOctets=wirelessOutAllOctets, cableDiagnosticsPorts=cableDiagnosticsPorts, auxPortDisabledWarning=auxPortDisabledWarning, txMABFrames=txMABFrames, receivePowerLinked=receivePowerLinked, configurationInstancedTableIndex=configurationInstancedTableIndex, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sFPPortAutoMdix=sFPPortAutoMdix, transparentClock=transparentClock, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, unitOutOfCalibration=unitOutOfCalibration, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, unitIdentification=unitIdentification, reset=reset, licenseEncryption=licenseEncryption, sNTPSyncTrap=sNTPSyncTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tDMInterfaceControl=tDMInterfaceControl, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNTPState=sNTPState, snmpControl=snmpControl, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, receiveDataRate=receiveDataRate, lbtDetectedTrap=lbtDetectedTrap, auxPortStatusTrap=auxPortStatusTrap, notificationsGroup=notificationsGroup, PYSNMP_MODULE_ID=cambium, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tdmTableIndex=tdmTableIndex, blacklistRMEnabled=blacklistRMEnabled, ptmp=ptmp, dNSServerInternetAddressType=dNSServerInternetAddressType, phyControl=phyControl, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, antennaSelection=antennaSelection, transmitterChannels=transmitterChannels, channelChangeTrap=channelChangeTrap, phyInstancedStatusTable=phyInstancedStatusTable, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, cableDiagnostics=cableDiagnostics, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, alarmsGroup=alarmsGroup, dNSServerTableEntry=dNSServerTableEntry, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, auxPortConfigurationMismatch=auxPortConfigurationMismatch, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableDiagPair1Results=cableDiagPair1Results, enableTransmission=enableTransmission, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, receiveModulationModeDetail=receiveModulationModeDetail, mainPSUPortQLTx=mainPSUPortQLTx, wirelessLinkStatusLinked=wirelessLinkStatusLinked, licenseBandwidthCap=licenseBandwidthCap, cableDiagPair2Distance=cableDiagPair2Distance, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPSync=sNTPSync, aggregateDataRateLinked=aggregateDataRateLinked, channelBandwidth=channelBandwidth, sNTPServerTable=sNTPServerTable, longitude=longitude, ptpTraps=ptpTraps, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, timeZone=timeZone, tDM=tDM, qOSPriorityScheme=qOSPriorityScheme, dNSServerTableIndex=dNSServerTableIndex, authorizationControlTableIndex=authorizationControlTableIndex, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, remoteUnitName=remoteUnitName, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, pubInstancedStatsTable=pubInstancedStatsTable, cableDiagnosticsWarning=cableDiagnosticsWarning, receivePower=receivePower, maximumNumberOfSlaves=maximumNumberOfSlaves, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dfsTable=dfsTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, hTTPAccessEnabled=hTTPAccessEnabled, transparentClockVLAN=transparentClockVLAN, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, cableDiagnosticsControl=cableDiagnosticsControl, encryption=encryption, sNTPServerStatus=sNTPServerStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, hTTPSPortNumber=hTTPSPortNumber, vLANManagementPriority=vLANManagementPriority, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, installStatusTrap=installStatusTrap, hCMPMaximumLinkRange=hCMPMaximumLinkRange, authorizationControlTableNumber=authorizationControlTableNumber, txColorCode=txColorCode, rangingMode=rangingMode, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, sNTPPrimaryServer=sNTPPrimaryServer, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, capacityVariantMismatch=capacityVariantMismatch, ethernet=ethernet, supplementaryGroup=supplementaryGroup, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerPortNumber=sNTPServerPortNumber, mABTransmissionInterval=mABTransmissionInterval, mgmtInstancedTableEntry=mgmtInstancedTableEntry, pubStats=pubStats, incompatibleRegulatoryBands=incompatibleRegulatoryBands, cableDiagPair2Results=cableDiagPair2Results, pubStatsGroup=pubStatsGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch)
