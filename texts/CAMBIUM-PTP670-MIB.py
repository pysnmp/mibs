...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, telnetPortNumber=telnetPortNumber, packetsToInternalStack=packetsToInternalStack, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, transparentClock=transparentClock, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sNTPServerTable=sNTPServerTable, auxPortStatus=auxPortStatus, l2CPPriorityTable=l2CPPriorityTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, capacityVariantMismatch=capacityVariantMismatch, syncETrackingState=syncETrackingState, rawReceivePower=rawReceivePower, sMTPServerPortNumber=sMTPServerPortNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, wirelessOutAllOctets=wirelessOutAllOctets, vLANManagementPriority=vLANManagementPriority, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortAllocation=mainPSUPortAllocation, ethernetInstancedTable=ethernetInstancedTable, sntpGroup=sntpGroup, licenseInstancedTableNumber=licenseInstancedTableNumber, linkSymmetry=linkSymmetry, userName=userName, sNTPPollInterval=sNTPPollInterval, mABState=mABState, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, localPacketFiltering=localPacketFiltering, hardwareVersion=hardwareVersion, configurationInstancedTableIndex=configurationInstancedTableIndex, tdmTableNumber=tdmTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionAlgorithm=encryptionAlgorithm, blacklistRMMacAddress=blacklistRMMacAddress, installationMode=installationMode, txColorCode=txColorCode, mainPSUPortQLRx=mainPSUPortQLRx, tDMEnabledChannels=tDMEnabledChannels, wirelessLinkStatus=wirelessLinkStatus, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, versions=versions, siteName=siteName, syncETracking=syncETracking, hTTPPortNumber=hTTPPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPCommunityString=sNMPCommunityString, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, syslogState=syslogState, managementGroup=managementGroup, groupID=groupID, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syncESlavePort=syncESlavePort, aAAControl=aAAControl, sNMPEnabledTraps=sNMPEnabledTraps, mainPSUPortStatus=mainPSUPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, phyControlInstancedTable=phyControlInstancedTable, lowestTDMModulationMode=lowestTDMModulationMode, secureModeAlarm=secureModeAlarm, cableDiagPair3Distance=cableDiagPair3Distance, iPv6PrefixLength=iPv6PrefixLength, licenseCapacity=licenseCapacity, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, enableTransmission=enableTransmission, txMABFrames=txMABFrames, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortDisabledWarning=auxPortDisabledWarning, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, userRole=userRole, remoteMACAddress=remoteMACAddress, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseInstancedTableIndex=licenseInstancedTableIndex, userTableNumber=userTableNumber, authorizationControlTableIndex=authorizationControlTableIndex, tdmTableIndex=tdmTableIndex, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, remoteUnitName=remoteUnitName, signalStrengthRatio=signalStrengthRatio, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseBandwidthCap=licenseBandwidthCap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelChangeTrap=channelChangeTrap, dfsGroup=dfsGroup, sFPError=sFPError, licenseTDDSyncSupport=licenseTDDSyncSupport, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, transmitDataRateLinked=transmitDataRateLinked, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, maxLinkRangeExceeded=maxLinkRangeExceeded, syslogClientTrap=syslogClientTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyControlInstancedTableEntry=phyControlInstancedTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, byteErrorRatio=byteErrorRatio, mainPSUPortAutoMdix=mainPSUPortAutoMdix, incompatibleRegulatoryBands=incompatibleRegulatoryBands, transmitPowerLinked=transmitPowerLinked, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, whitelistRMMacAddress=whitelistRMMacAddress, tDMChannelLineCode=tDMChannelLineCode, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, snmpControl=snmpControl, syslogControlGroup=syslogControlGroup, wirelessOutOctets=wirelessOutOctets, regulatoryBand=regulatoryBand, versionsGroup=versionsGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteInternetAddressType=remoteInternetAddressType, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, ethernetStatisticsTable=ethernetStatisticsTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, cableDiagnosticsControl=cableDiagnosticsControl, dNSResolver=dNSResolver, cableDiagPair2Results=cableDiagPair2Results, phyStatusGroup=phyStatusGroup, userTable=userTable, tempPcb=tempPcb, tdmTableEntry=tdmTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productVariant=productVariant, installStatusLinked=installStatusLinked, licenseSecurityLevel=licenseSecurityLevel, licenseGasGroup=licenseGasGroup, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, notificationsGroup=notificationsGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, aggregateDataRate=aggregateDataRate, apc=apc, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, mgmtInstancedTableNumber=mgmtInstancedTableNumber, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, qOSPriorityScheme=qOSPriorityScheme, signalStrengthRatioLinked=signalStrengthRatioLinked, dNSServerTableEntry=dNSServerTableEntry, remoteMACAddressLinked=remoteMACAddressLinked, installArmState=installArmState, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteUnitNameLinked=remoteUnitNameLinked, mgmtInstancedTableIndex=mgmtInstancedTableIndex, transmitterChannels=transmitterChannels, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, linkLossLinked=linkLossLinked, dataBridgingStatus=dataBridgingStatus, dfs=dfs, tFTPServerInternetAddress=tFTPServerInternetAddress, transmitModulationModeLinked=transmitModulationModeLinked, deviceMSN=deviceMSN, smtpGroup=smtpGroup, dNSServerInternetAddress=dNSServerInternetAddress, resetGroup=resetGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, configuration=configuration, sNTPPrimaryServer=sNTPPrimaryServer, dfsTable=dfsTable, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sFPPortAutoMdix=sFPPortAutoMdix, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, alarmInstancedTableIndex=alarmInstancedTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, auxPortSSMTx=auxPortSSMTx, searchState=searchState, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, channelBandwidth=channelBandwidth, dataPortPauseFrames=dataPortPauseFrames, ptp=ptp, daylightSaving=daylightSaving, supplementary=supplementary, sFPPortStatus=sFPPortStatus, dNSServerTableIndex=dNSServerTableIndex, cableDiagPair1Results=cableDiagPair1Results, rawReceivePowerLinked=rawReceivePowerLinked, tDMGroup=tDMGroup, targetMACAddress=targetMACAddress, dNSServerTable=dNSServerTable, reset=reset, auxPortQLRx=auxPortQLRx, phyControlInstancedTableIndex=phyControlInstancedTableIndex, wirelessLinkStatusLinked=wirelessLinkStatusLinked, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseGroup=licenseGroup, telnetAccessEnabled=telnetAccessEnabled, userEnabled=userEnabled, whitelistRMEnabled=whitelistRMEnabled, auxPortQLTx=auxPortQLTx, sNTPSync=sNTPSync, mABTransmissionInterval=mABTransmissionInterval, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseEncryption=licenseEncryption, phyControl=phyControl, wirelessOutEthernetOctets=wirelessOutEthernetOctets, unitName=unitName, transparentClockVLAN=transparentClockVLAN, dNSServerPortNumber=dNSServerPortNumber, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sMTPEmailAlert=sMTPEmailAlert, transparentClockVID=transparentClockVID, tDMInterfaceStatus=tDMInterfaceStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, systemClock=systemClock, sFPPortSSMTx=sFPPortSSMTx, sFPPortDisabledWarning=sFPPortDisabledWarning, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, hTTPSPortNumber=hTTPSPortNumber, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, eIRP=eIRP, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPState=sNTPState, licenseIEEE1588Support=licenseIEEE1588Support, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tDMChannelLoopback=tDMChannelLoopback, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, tDDControlGroup=tDDControlGroup, dfsTableIndex=dfsTableIndex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, nIDULanPortAutoMdix=nIDULanPortAutoMdix, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, ethernetInstancedTableEntry=ethernetInstancedTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, targetRange=targetRange, vectorErrorLinked=vectorErrorLinked, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, smtp=smtp, bridgeGroup=bridgeGroup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, installArmStateTrap=installArmStateTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, longitude=longitude, tDDSynchronizationStatus=tDDSynchronizationStatus, iPv4Address=iPv4Address, ethernetPriorityTableIndex=ethernetPriorityTableIndex, severelyErroredSeconds=severelyErroredSeconds)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", encryptionGroup=encryptionGroup, mgmtInstancedTable=mgmtInstancedTable, hCMPLinkSymmetry=hCMPLinkSymmetry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, authorizationControlGroup=authorizationControlGroup, authorizationControlTableEntry=authorizationControlTableEntry, dfsPeaks=dfsPeaks, syncEEquipmentClock=syncEEquipmentClock, mABHoldoffPeriod=mABHoldoffPeriod, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, syslogStateTrap=syslogStateTrap, phyInstancedStatusTable=phyInstancedStatusTable, linkLoss=linkLoss, auxPortAllocation=auxPortAllocation, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mABProtocolVLANPriority=mABProtocolVLANPriority, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, tDDSynchronizationMode=tDDSynchronizationMode, supplementaryGroup=supplementaryGroup, range=range, portAllocationMismatchLinked=portAllocationMismatchLinked, frequencyVariant=frequencyVariant, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sNMPTrapInternetAddress=sNMPTrapInternetAddress, latitude=latitude, phyStatus=phyStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, authorizationControlTable=authorizationControlTable, timeZone=timeZone, ptp670=ptp670, accessMethod=accessMethod, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mABNominalModulationMode=mABNominalModulationMode, mABNominalTransmitCapacity=mABNominalTransmitCapacity, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, remoteInternetAddressLinked=remoteInternetAddressLinked, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ethernet=ethernet, sNMPTrapVersion=sNMPTrapVersion, cableDiagPair1Distance=cableDiagPair1Distance, transmitFreqKHz=transmitFreqKHz, transmitPower=transmitPower, productName=productName, tDMChannelCableLength=tDMChannelCableLength, licenseSyncESupport=licenseSyncESupport, useVLANForMABProtocol=useVLANForMABProtocol, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseTrialPeriod=licenseTrialPeriod, receiveModulationModeDetail=receiveModulationModeDetail, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseInstancedTable=licenseInstancedTable, installStatus=installStatus, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, ptpCompliance=ptpCompliance, ptpTraps=ptpTraps, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, PYSNMP_MODULE_ID=cambium, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, dNSPrimaryServer=dNSPrimaryServer, sNTPServerTableNumber=sNTPServerTableNumber, ethernetPriorityTable=ethernetPriorityTable, byteErrorRatioLinked=byteErrorRatioLinked, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, blacklistRMEnabled=blacklistRMEnabled, tDMInterfaceControl=tDMInterfaceControl, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dfsMeans=dfsMeans, wirelessTopology=wirelessTopology, sNTPServerTableEntry=sNTPServerTableEntry, configurationInstancedTableNumber=configurationInstancedTableNumber, extendedSpectrumScanning=extendedSpectrumScanning, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, subnetMask=subnetMask, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dNSServerTableNumber=dNSServerTableNumber, unitIdentificationGroup=unitIdentificationGroup, sNTPServerPortNumber=sNTPServerPortNumber, pubStats=pubStats, aAAControlGroup=aAAControlGroup, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, systemReset=systemReset, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, antennaSelection=antennaSelection, vectorError=vectorError, phyControlGroup=phyControlGroup, dataBridgingAvailability=dataBridgingAvailability, ethernetInstancedTableNumber=ethernetInstancedTableNumber, cableLoss=cableLoss, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mABProtocolVID=mABProtocolVID, regulatoryBandTrap=regulatoryBandTrap, portAllocationMismatchTrap=portAllocationMismatchTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, vLANManagementVID=vLANManagementVID, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPErrorTrap=sFPErrorTrap, transmitDataRate=transmitDataRate, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, configurationInstancedTable=configurationInstancedTable, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sNMPPortNumber=sNMPPortNumber, receiveFreqKHz=receiveFreqKHz, receivePowerLinked=receivePowerLinked, sNTPSyncTrap=sNTPSyncTrap, routerProtocolsGroup=routerProtocolsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseInstancedTableEntry=licenseInstancedTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, antennaGain=antennaGain, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, gatewayIPAddress=gatewayIPAddress, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sFPPortQLTx=sFPPortQLTx, snmpControlGroup=snmpControlGroup, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, ptpGroups=ptpGroups, mainPSUPortStatusTrap=mainPSUPortStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, cableDiagPair2Distance=cableDiagPair2Distance, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, rxColorCode=rxColorCode, licenseCountry=licenseCountry, transparentClockPort=transparentClockPort, management=management, iPVersion=iPVersion, iPv6GatewayAddress=iPv6GatewayAddress, hCMPMaximumLinkRange=hCMPMaximumLinkRange, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, maximumTransmitPower=maximumTransmitPower, ethernetGroup=ethernetGroup, sFPPortAllocation=sFPPortAllocation, licenseVersion=licenseVersion, dfsTableNumber=dfsTableNumber, alarms=alarms, aggregateDataRateLinked=aggregateDataRateLinked, sFPPortQLRx=sFPPortQLRx, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, rangingMode=rangingMode, receiveModulationMode=receiveModulationMode, tdmTable=tdmTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, dataBridgingStatusLinked=dataBridgingStatusLinked, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, apcGroup=apcGroup, dSCPManagementPriority=dSCPManagementPriority, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, l2CPPriorityTableIndex=l2CPPriorityTableIndex, authorizationMethod=authorizationMethod, configurationInstancedTableEntry=configurationInstancedTableEntry, remoteInternetAddress=remoteInternetAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, masterSlaveMode=masterSlaveMode, alarmInstancedTable=alarmInstancedTable, deviceMACAddress=deviceMACAddress, linkModeOptimization=linkModeOptimization, receiveChannel=receiveChannel, ethernetInstancedTableIndex=ethernetInstancedTableIndex, cableDiagPair4Results=cableDiagPair4Results, sNTPServerStatus=sNTPServerStatus, secondarySoftwareVersion=secondarySoftwareVersion, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, erroredSeconds=erroredSeconds, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, receiveDataRateLinked=receiveDataRateLinked, deviceESN=deviceESN, tFTPClient=tFTPClient, licenseIPv6Support=licenseIPv6Support, nIDULanPortStatusTrap=nIDULanPortStatusTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, rangeLinked=rangeLinked, sNMPv3Enable=sNMPv3Enable, sNTPLastSync=sNTPLastSync, hTTPAccessEnabled=hTTPAccessEnabled, licenseMaxLinkRange=licenseMaxLinkRange, userPassword=userPassword, licenseUnitSerialNumber=licenseUnitSerialNumber, linkName=linkName, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, transmitChannel=transmitChannel, dataBridgingStatusAlarm=dataBridgingStatusAlarm, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, routerProtocols=routerProtocols, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, iPDSCPPriorityTable=iPDSCPPriorityTable, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, dNSServerInternetAddressType=dNSServerInternetAddressType, licenseIssueNumber=licenseIssueNumber, syslogClient=syslogClient, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseHCMPSupport=licenseHCMPSupport, receivePower=receivePower, tDM=tDM, alarmInstancedTableNumber=alarmInstancedTableNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, ptpTrapPrefix=ptpTrapPrefix, sNTPServerRetries=sNTPServerRetries, bootVersion=bootVersion, subbandLowestFrequency=subbandLowestFrequency, authorizationControl=authorizationControl, sNTPServerTimeout=sNTPServerTimeout, lowestDataModulationMode=lowestDataModulationMode, sNTPServerInternetAddress=sNTPServerInternetAddress, receiveModulationModeLinked=receiveModulationModeLinked, tFTPServerInternetAddressType=tFTPServerInternetAddressType, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sntp=sntp, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubInstancedStatsTable=pubInstancedStatsTable, userTableEntry=userTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, softwareVersion=softwareVersion, encryption=encryption, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, subbandHighestFrequency=subbandHighestFrequency, iPv6Address=iPv6Address, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, auxPortConfigurationMismatch=auxPortConfigurationMismatch, ptmp=ptmp, unavailableSeconds=unavailableSeconds, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, syslogControl=syslogControl, tDMConfigurationMismatch=tDMConfigurationMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, authorizationControlTableNumber=authorizationControlTableNumber, sFPPortStatusTrap=sFPPortStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDControl=tDDControl, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapPortNumber=sNMPTrapPortNumber, installStatusTrap=installStatusTrap, mainPSUPortQLTx=mainPSUPortQLTx, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licenseGroupAccess=licenseGroupAccess, lbtDetectedTrap=lbtDetectedTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, nIDULanPortStatus=nIDULanPortStatus, dNSGroup=dNSGroup, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mABMaintenanceLevel=mABMaintenanceLevel, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, receiveFreqMHz=receiveFreqMHz, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, tDMChannelStatus=tDMChannelStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, auxPortStatusTrap=auxPortStatusTrap, licenseTLSRekey=licenseTLSRekey, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, cableDiagnosticsPorts=cableDiagnosticsPorts, cableDiagPair3Results=cableDiagPair3Results, userTableIndex=userTableIndex, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, altitude=altitude, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, searchStateLinked=searchStateLinked, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, ethernetStatisticsDataSource=ethernetStatisticsDataSource, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dfsTableEntry=dfsTableEntry, alarmsGroup=alarmsGroup, receiveDataRate=receiveDataRate, transmitModulationMode=transmitModulationMode, secureModeAlarmTrap=secureModeAlarmTrap, bridge=bridge, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, cambium=cambium, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, dNS=dNS, licenseSFPPortSupport=licenseSFPPortSupport, license=license, sNMPTrapTable=sNMPTrapTable, unitOutOfCalibration=unitOutOfCalibration, packetsFromInternalStack=packetsFromInternalStack, unitIdentification=unitIdentification, cableDiagnostics=cableDiagnostics, portAllocationMismatch=portAllocationMismatch, pubStatsGroup=pubStatsGroup, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, configurationGroup=configurationGroup, licenseRARSupport=licenseRARSupport)
