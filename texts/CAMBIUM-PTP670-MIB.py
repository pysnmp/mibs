...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortStatus=nIDULanPortStatus, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNTPServerTableNumber=sNTPServerTableNumber, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, rawReceivePowerLinked=rawReceivePowerLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, ethernetInstancedTable=ethernetInstancedTable, sNMPv3Enable=sNMPv3Enable, syncESlavePort=syncESlavePort, sNTPSyncTrap=sNTPSyncTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, syslogState=syslogState, transmitPower=transmitPower, unitName=unitName, txColorCode=txColorCode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, wirelessTopology=wirelessTopology, cableDiagnosticsControl=cableDiagnosticsControl, ethernetPriorityTable=ethernetPriorityTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sNTPServerRetries=sNTPServerRetries, ethernetStatisticsTable=ethernetStatisticsTable, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, receiveModulationModeDetail=receiveModulationModeDetail, qOSPriorityScheme=qOSPriorityScheme, receivePower=receivePower, notificationsGroup=notificationsGroup, configuration=configuration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, antennaSelection=antennaSelection, packetsToInternalStack=packetsToInternalStack, ptpTraps=ptpTraps, installStatus=installStatus, dfsGroup=dfsGroup, dNSServerTableNumber=dNSServerTableNumber, dNSServerInternetAddress=dNSServerInternetAddress, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, bridgeGroup=bridgeGroup, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, regulatoryBandTrap=regulatoryBandTrap, l2CPPriorityTable=l2CPPriorityTable, receiveFreqKHz=receiveFreqKHz, receiveChannel=receiveChannel, linkModeOptimization=linkModeOptimization, userName=userName, sNMPTrapTable=sNMPTrapTable, phyStatusGroup=phyStatusGroup, sNTPLastSync=sNTPLastSync, cableDiagPair3Results=cableDiagPair3Results, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, linkLossLinked=linkLossLinked, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, cambium=cambium, versionsGroup=versionsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, apcGroup=apcGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, alarmInstancedTableNumber=alarmInstancedTableNumber, capacityVariantMismatch=capacityVariantMismatch, managementNetworkAccessEnabled=managementNetworkAccessEnabled, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, transmitChannel=transmitChannel, dfsTableEntry=dfsTableEntry, sFPPortQLTx=sFPPortQLTx, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, auxPortStatus=auxPortStatus, ethernetInstancedTableEntry=ethernetInstancedTableEntry, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, transparentClockVID=transparentClockVID, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableDiagnosticsPorts=cableDiagnosticsPorts, mABNominalTransmitCapacity=mABNominalTransmitCapacity, capacityVariantMismatchLinked=capacityVariantMismatchLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, configurationGroup=configurationGroup, mainPSUPortAllocation=mainPSUPortAllocation, extendedSpectrumScanning=extendedSpectrumScanning, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, vectorError=vectorError, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licenseInstancedTableEntry=licenseInstancedTableEntry, userTableEntry=userTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerInternetAddressType=sMTPServerInternetAddressType, auxPortQLTx=auxPortQLTx, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseBandwidthCap=licenseBandwidthCap, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, ethernetGroup=ethernetGroup, hTTPAccessEnabled=hTTPAccessEnabled, byteErrorRatio=byteErrorRatio, configurationInstancedTableEntry=configurationInstancedTableEntry, sNTPState=sNTPState, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, vectorErrorLinked=vectorErrorLinked, wirelessLinkStatus=wirelessLinkStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, receiveModulationMode=receiveModulationMode, phyControlGroup=phyControlGroup, tFTPClient=tFTPClient, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, reset=reset, antennaGain=antennaGain, sMTPServerPortNumber=sMTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortSyncERxStatus=auxPortSyncERxStatus, iPv6Address=iPv6Address, configurationInstancedTableNumber=configurationInstancedTableNumber, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, ethernetInstancedTableIndex=ethernetInstancedTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userRole=userRole, secondarySoftwareVersion=secondarySoftwareVersion, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, softwareVersion=softwareVersion, tDDControlGroup=tDDControlGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, vLANManagementPriority=vLANManagementPriority, ethernet=ethernet, channelBandwidth=channelBandwidth, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseInstancedTableNumber=licenseInstancedTableNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tDMGroup=tDMGroup, phyControlInstancedTableEntry=phyControlInstancedTableEntry, dfs=dfs, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sNMPTrapTableEntry=sNMPTrapTableEntry, tDMEnabledChannels=tDMEnabledChannels, tDMChannelLoopback=tDMChannelLoopback, aggregateDataRate=aggregateDataRate, licenseCapacity=licenseCapacity, transparentClock=transparentClock, aAAControlGroup=aAAControlGroup, hardwareVersion=hardwareVersion, tDMChannelStatusTrap=tDMChannelStatusTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, tdmTableIndex=tdmTableIndex, signalStrengthRatioLinked=signalStrengthRatioLinked, erroredSeconds=erroredSeconds, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, daylightSaving=daylightSaving, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, installArmState=installArmState, localPacketFiltering=localPacketFiltering, maximumNumberOfSlaves=maximumNumberOfSlaves, rawReceivePower=rawReceivePower, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, licenseRARSupport=licenseRARSupport, licenseMaxLinkRange=licenseMaxLinkRange, encryptionGroup=encryptionGroup, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, iPv4Address=iPv4Address, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, dfsTableNumber=dfsTableNumber, longitude=longitude, sntpGroup=sntpGroup, receiveModulationModeLinked=receiveModulationModeLinked, managementPortWirelessDownAlert=managementPortWirelessDownAlert, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tDMInterfaceControl=tDMInterfaceControl, productName=productName, secureModeAlarmTrap=secureModeAlarmTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, userEnabled=userEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataBridgingStatusAlarm=dataBridgingStatusAlarm, licenseUnitSerialNumber=licenseUnitSerialNumber, latitude=latitude, management=management, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, unitIdentification=unitIdentification, smtpGroup=smtpGroup, alarms=alarms, sNMPCommunityString=sNMPCommunityString, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, authorizationControlTableEntry=authorizationControlTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, authorizationControlTableIndex=authorizationControlTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelChangeTrap=channelChangeTrap, sFPError=sFPError, alarmInstancedTableEntry=alarmInstancedTableEntry, sFPPortStatusTrap=sFPPortStatusTrap, dataBridgingAvailability=dataBridgingAvailability, transmitterChannels=transmitterChannels, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userTableIndex=userTableIndex, deviceMACAddress=deviceMACAddress, subnetMask=subnetMask, dfsTable=dfsTable, remoteMACAddress=remoteMACAddress, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, mainPSUPortStatus=mainPSUPortStatus, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, useVLANForMABProtocol=useVLANForMABProtocol, mABProtocolVLANPriority=mABProtocolVLANPriority, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseTLSRekey=licenseTLSRekey, transmitPowerLinked=transmitPowerLinked, tempPcb=tempPcb, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseEncryption=licenseEncryption, encryptionAlgorithm=encryptionAlgorithm, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, pubInstancedStatsTable=pubInstancedStatsTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, masterSlaveMode=masterSlaveMode, aAAControl=aAAControl, mainPSUPortQLRx=mainPSUPortQLRx, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mABProtocolVID=mABProtocolVID, frequencyVariant=frequencyVariant, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, telnetAccessEnabled=telnetAccessEnabled, sNTPServerTable=sNTPServerTable, licenseSFPPortSupport=licenseSFPPortSupport, tDMChannelStatus=tDMChannelStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseIssueNumber=licenseIssueNumber, authorizationControlTable=authorizationControlTable, mABState=mABState, routerProtocolsGroup=routerProtocolsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, mABMaintenanceLevel=mABMaintenanceLevel, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, dataPortPauseFrames=dataPortPauseFrames)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseInstancedTable=licenseInstancedTable, byteErrorRatioLinked=byteErrorRatioLinked, mgmtInstancedTable=mgmtInstancedTable, oOBPriorityQueueMapping=oOBPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerStatus=sNTPServerStatus, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, hCMPMaximumLinkRange=hCMPMaximumLinkRange, mainPSUPortAutoMdix=mainPSUPortAutoMdix, systemClock=systemClock, licenseSecurityLevel=licenseSecurityLevel, sFPPortSyncERxStatus=sFPPortSyncERxStatus, transmitDataRate=transmitDataRate, snmpControl=snmpControl, sFPErrorTrap=sFPErrorTrap, tDMChannelCableLength=tDMChannelCableLength, sNTPPollInterval=sNTPPollInterval, sFPPortAllocation=sFPPortAllocation, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, cableDiagnostics=cableDiagnostics, portAllocationMismatchLinked=portAllocationMismatchLinked, sFPPortQLRx=sFPPortQLRx, syncETrackingState=syncETrackingState, remoteUnitName=remoteUnitName, systemReset=systemReset, dfsTableIndex=dfsTableIndex, cableDiagPair1Distance=cableDiagPair1Distance, dNSServerTable=dNSServerTable, installationMode=installationMode, sntp=sntp, configurationInstancedTableIndex=configurationInstancedTableIndex, auxPortAcceptedQLRx=auxPortAcceptedQLRx, subbandHighestFrequency=subbandHighestFrequency, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, ptpCompliance=ptpCompliance, auxPortDisabledWarning=auxPortDisabledWarning, alarmsGroup=alarmsGroup, phyControlInstancedTableIndex=phyControlInstancedTableIndex, cableDiagPair4Distance=cableDiagPair4Distance, syslogClientTrap=syslogClientTrap, pubStatsGroup=pubStatsGroup, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, syncEEquipmentClock=syncEEquipmentClock, unavailableSeconds=unavailableSeconds, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNMPPortNumber=sNMPPortNumber, ptpGroups=ptpGroups, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogControl=syslogControl, iPDSCPPriorityTable=iPDSCPPriorityTable, licenseGasGroup=licenseGasGroup, tDDSynchronizationMode=tDDSynchronizationMode, authorizationControlTableNumber=authorizationControlTableNumber, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, installArmStateTrap=installArmStateTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, versions=versions, phyControlInstancedTable=phyControlInstancedTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, packetsFromInternalStack=packetsFromInternalStack, dNSServerInternetAddressType=dNSServerInternetAddressType, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkLoss=linkLoss, sNTPPrimaryServer=sNTPPrimaryServer, auxPortStatusTrap=auxPortStatusTrap, txMABFrames=txMABFrames, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, groupID=groupID, accessMethod=accessMethod, subbandLowestFrequency=subbandLowestFrequency, licenseIPv6Support=licenseIPv6Support, mABNominalModulationMode=mABNominalModulationMode, licenseSyncESupport=licenseSyncESupport, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sFPPortAutoMdix=sFPPortAutoMdix, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagPair4Results=cableDiagPair4Results, telnetPortNumber=telnetPortNumber, enableTransmission=enableTransmission, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, linkSymmetry=linkSymmetry, receivePowerLinked=receivePowerLinked, dfsPeaks=dfsPeaks, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptmp=ptmp, noWirelessChannelAvailable=noWirelessChannelAvailable, bootVersion=bootVersion, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, ptpTrapPrefix=ptpTrapPrefix, syncETracking=syncETracking, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, license=license, routerProtocols=routerProtocols, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationModeLinked=transmitModulationModeLinked, syslogStateTrap=syslogStateTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseTrialPeriod=licenseTrialPeriod, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNTPSync=sNTPSync, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, managementGroup=managementGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, userTableNumber=userTableNumber, userPassword=userPassword, incompatibleMasterAndSlave=incompatibleMasterAndSlave, auxPortSSMTx=auxPortSSMTx, severelyErroredSeconds=severelyErroredSeconds, userTable=userTable, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, targetRange=targetRange, transmitModulationMode=transmitModulationMode, transparentClockVLAN=transparentClockVLAN, lowestTDMModulationMode=lowestTDMModulationMode, dNSServerPortNumber=dNSServerPortNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, searchStateLinked=searchStateLinked, cableDiagPair2Results=cableDiagPair2Results, resetGroup=resetGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, supplementary=supplementary, transparentClockPort=transparentClockPort, licenseInstancedTableIndex=licenseInstancedTableIndex, ptp670=ptp670, tDDSynchronizationStatus=tDDSynchronizationStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, supplementaryGroup=supplementaryGroup, sFPPortSSMTx=sFPPortSSMTx, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dNS=dNS, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseOOBManagementSupport=licenseOOBManagementSupport, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, tDMInterfaceStatus=tDMInterfaceStatus, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNMPTrapVersion=sNMPTrapVersion, ethernetStatisticsDataSource=ethernetStatisticsDataSource, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, auxPortQLRx=auxPortQLRx, mainPSUPortSSMTx=mainPSUPortSSMTx, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteUnitNameLinked=remoteUnitNameLinked, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, tdmTableEntry=tdmTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, dfsMeans=dfsMeans, cableDiagPair1Results=cableDiagPair1Results, apc=apc, rxColorCode=rxColorCode, dSCPManagementPriority=dSCPManagementPriority, regulatoryBand=regulatoryBand, lbtDetectedTrap=lbtDetectedTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, licenseGroup=licenseGroup, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, wirelessLinkStatusLinked=wirelessLinkStatusLinked, pubStats=pubStats, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, encryption=encryption, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, lowestDataModulationMode=lowestDataModulationMode, vLANManagementVID=vLANManagementVID, sFPPortStatus=sFPPortStatus, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sMTPEmailAlert=sMTPEmailAlert, transmitFreqMHz=transmitFreqMHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, phyInstancedStatusTable=phyInstancedStatusTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mABHoldoffPeriod=mABHoldoffPeriod, wirelessOutAllOctets=wirelessOutAllOctets, blacklistRMEnabled=blacklistRMEnabled, alarmInstancedTable=alarmInstancedTable, eIRP=eIRP, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, installStatusTrap=installStatusTrap, dNSGroup=dNSGroup, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ptp=ptp, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitFreqKHz=transmitFreqKHz, mainPSUPortStatusTrap=mainPSUPortStatusTrap, cableDiagPair2Distance=cableDiagPair2Distance, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseHCMPSupport=licenseHCMPSupport, sMTPServerInternetAddress=sMTPServerInternetAddress, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, blacklistRMMacAddress=blacklistRMMacAddress, altitude=altitude, tdmTableNumber=tdmTableNumber, sNTPServerTableEntry=sNTPServerTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, licenseGroupAccess=licenseGroupAccess, PYSNMP_MODULE_ID=cambium, dNSResolver=dNSResolver, rangeLinked=rangeLinked, dNSServerTableEntry=dNSServerTableEntry, siteName=siteName, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, tdmTable=tdmTable, portAllocationMismatch=portAllocationMismatch, timeZone=timeZone, aggregateDataRateLinked=aggregateDataRateLinked, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mABTransmissionInterval=mABTransmissionInterval, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseVersion=licenseVersion, receiveDataRateLinked=receiveDataRateLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, unitIdentificationGroup=unitIdentificationGroup, configurationInstancedTable=configurationInstancedTable, tDMChannelLineCode=tDMChannelLineCode, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, deviceESN=deviceESN, sNTPServerTimeout=sNTPServerTimeout, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, authorizationControl=authorizationControl, dNSServerTableIndex=dNSServerTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, maximumTransmitPower=maximumTransmitPower, whitelistRMEnabled=whitelistRMEnabled, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sNMPTrapInternetAddress=sNMPTrapInternetAddress, unitOutOfCalibration=unitOutOfCalibration, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyControl=phyControl, secureModeAlarm=secureModeAlarm, cableLoss=cableLoss, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, syslogClient=syslogClient, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitDataRateLinked=transmitDataRateLinked, linkName=linkName)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mgmtInstancedTableNumber=mgmtInstancedTableNumber, dNSPrimaryServer=dNSPrimaryServer, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, deviceMSN=deviceMSN, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, bridge=bridge, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, searchState=searchState, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mgmtInstancedTableEntry=mgmtInstancedTableEntry, smtp=smtp, tDDControl=tDDControl, receiveFreqMHz=receiveFreqMHz, remoteMACAddressLinked=remoteMACAddressLinked, tDM=tDM, cableDiagPair3Distance=cableDiagPair3Distance, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sFPPortAutoNegotiation=sFPPortAutoNegotiation, alarmInstancedTableIndex=alarmInstancedTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, dataBridgingStatus=dataBridgingStatus, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mgmtInstancedTableIndex=mgmtInstancedTableIndex, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, phyControlInstancedTableNumber=phyControlInstancedTableNumber, whitelistRMMacAddress=whitelistRMMacAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, targetMACAddress=targetMACAddress, licenseCountry=licenseCountry, remoteInternetAddressType=remoteInternetAddressType, iPVersion=iPVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, rangingMode=rangingMode, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteInternetAddress=remoteInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogControlGroup=syslogControlGroup, authorizationControlGroup=authorizationControlGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, wirelessOutOctets=wirelessOutOctets, authorizationMethod=authorizationMethod, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, signalStrengthRatio=signalStrengthRatio, receiveDataRate=receiveDataRate, phyStatus=phyStatus, hTTPSPortNumber=hTTPSPortNumber, range=range, auxPortAllocation=auxPortAllocation, installStatusLinked=installStatusLinked)
