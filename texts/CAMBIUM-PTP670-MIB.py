...
Gauge32, Bits, Counter32, MibIdentifier, ObjectIdentity, NotificationType, TimeTicks, enterprises, Integer32, iso, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "Counter32", "MibIdentifier", "ObjectIdentity", "NotificationType", "TimeTicks", "enterprises", "Integer32", "iso", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", subnetMask=subnetMask, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rxColorCode=rxColorCode, sMTPServerInternetAddress=sMTPServerInternetAddress, rawReceivePowerLinked=rawReceivePowerLinked, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, versions=versions, capacityVariantMismatchTrap=capacityVariantMismatchTrap, routerProtocols=routerProtocols, byteErrorRatioLinked=byteErrorRatioLinked, tDDSynchronizationMode=tDDSynchronizationMode, blacklistRMMacAddress=blacklistRMMacAddress, dataBridgingStatusAlarm=dataBridgingStatusAlarm, oOBPriorityQueueMapping=oOBPriorityQueueMapping, linkLossLinked=linkLossLinked, tDMInterfaceControl=tDMInterfaceControl, userTableNumber=userTableNumber, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, packetsToInternalStack=packetsToInternalStack, tdmTable=tdmTable, range=range, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, cableDiagnosticsControl=cableDiagnosticsControl, antennaGain=antennaGain, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aggregateDataRateLinked=aggregateDataRateLinked, tDMGroup=tDMGroup, softwareVersion=softwareVersion, supplementary=supplementary, groupID=groupID, sNTPState=sNTPState, licenseInstancedTable=licenseInstancedTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetStatisticsTable=ethernetStatisticsTable, linkModeOptimization=linkModeOptimization, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkStatusLinked=wirelessLinkStatusLinked, hCMPLinkSymmetry=hCMPLinkSymmetry, transmitModulationModeLinked=transmitModulationModeLinked, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, blacklistRMEnabled=blacklistRMEnabled, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseCapacity=licenseCapacity, nIDULanPortStatusTrap=nIDULanPortStatusTrap, userRole=userRole, installArmStateTrap=installArmStateTrap, tFTPClient=tFTPClient, mainPSUPortSSMTx=mainPSUPortSSMTx, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelBandwidth=channelBandwidth, sMTPEmailAlert=sMTPEmailAlert, cableDiagnostics=cableDiagnostics, configurationInstancedTableIndex=configurationInstancedTableIndex, siteName=siteName, dfsGroup=dfsGroup, longitude=longitude, rangeLinked=rangeLinked, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, tFTPServerInternetAddressType=tFTPServerInternetAddressType, alarmsGroup=alarmsGroup, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ptpCompliance=ptpCompliance, targetRange=targetRange, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, bootVersion=bootVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, receivePower=receivePower, sMTPServerPortNumber=sMTPServerPortNumber, dNSServerTableEntry=dNSServerTableEntry, pubStats=pubStats, enableTransmission=enableTransmission, lowestDataModulationMode=lowestDataModulationMode, licenseSyncESupport=licenseSyncESupport, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseGasGroup=licenseGasGroup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, vectorError=vectorError, configurationInstancedTable=configurationInstancedTable, alarmInstancedTable=alarmInstancedTable, altitude=altitude, remoteUnitName=remoteUnitName, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, license=license, aAAControlGroup=aAAControlGroup, sNMPTrapTable=sNMPTrapTable, tDMChannelLoopback=tDMChannelLoopback, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, cableDiagPair1Results=cableDiagPair1Results, sNTPServerRetries=sNTPServerRetries, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, channelChangeTrap=channelChangeTrap, receivePowerLinked=receivePowerLinked, alarmInstancedTableNumber=alarmInstancedTableNumber, sFPPortStatus=sFPPortStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, mABProtocolVLANPriority=mABProtocolVLANPriority, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagPair1Distance=cableDiagPair1Distance, dSCPManagementPriority=dSCPManagementPriority, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, dfsPeaks=dfsPeaks, cableDiagnosticsGroup=cableDiagnosticsGroup, sFPPortStatusTrap=sFPPortStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, qOSPriorityScheme=qOSPriorityScheme, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, tDMEnabledChannels=tDMEnabledChannels, productName=productName, userPassword=userPassword, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, portAllocationMismatch=portAllocationMismatch, mABProtocolVID=mABProtocolVID, sNMPEnabledTraps=sNMPEnabledTraps, iPVersion=iPVersion, txMABFrames=txMABFrames, sNTPServerTableNumber=sNTPServerTableNumber, deviceESN=deviceESN, dNSServerPortNumber=dNSServerPortNumber, encryption=encryption, deviceMSN=deviceMSN, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, whitelistRMEnabled=whitelistRMEnabled, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, incompatibleRegulatoryBands=incompatibleRegulatoryBands, transmitDataRateLinked=transmitDataRateLinked, routerProtocolsGroup=routerProtocolsGroup, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseInstancedTableIndex=licenseInstancedTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, phyControlGroup=phyControlGroup, tDDControlGroup=tDDControlGroup, unitOutOfCalibration=unitOutOfCalibration, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, userEnabled=userEnabled, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sFPPortQLRx=sFPPortQLRx, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, cableDiagPair3Results=cableDiagPair3Results, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, productVariant=productVariant, dNSServerInternetAddressType=dNSServerInternetAddressType, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, transmitterChannels=transmitterChannels, rangingMode=rangingMode, alarms=alarms, transparentClockPort=transparentClockPort, transmitFreqKHz=transmitFreqKHz, iPv4Address=iPv4Address, transparentClockVID=transparentClockVID, transmitChannel=transmitChannel, mainPSUPortAutoMdix=mainPSUPortAutoMdix, unavailableSeconds=unavailableSeconds, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, ptp=ptp, iPv6GatewayAddress=iPv6GatewayAddress, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, smtp=smtp, ethernetInstancedTable=ethernetInstancedTable, ptpGroups=ptpGroups, aggregateDataRate=aggregateDataRate, receiveFreqKHz=receiveFreqKHz, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPPollInterval=sNTPPollInterval, dfsTableIndex=dfsTableIndex, searchStateLinked=searchStateLinked, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, useVLANForMABProtocol=useVLANForMABProtocol, dNSServerTableNumber=dNSServerTableNumber, packetsFromInternalStack=packetsFromInternalStack, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, alarmInstancedTableIndex=alarmInstancedTableIndex, sFPPortSSMTx=sFPPortSSMTx, configurationInstancedTableNumber=configurationInstancedTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDMChannelLineCode=tDMChannelLineCode, syslogControl=syslogControl, installStatus=installStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenseEncryption=licenseEncryption, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, vectorErrorLinked=vectorErrorLinked, tDDSynchronizationAlarm=tDDSynchronizationAlarm, erroredSeconds=erroredSeconds, installStatusTrap=installStatusTrap, authorizationControlTableEntry=authorizationControlTableEntry, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, latitude=latitude, hTTPAccessEnabled=hTTPAccessEnabled, notificationsGroup=notificationsGroup, auxPortSSMTx=auxPortSSMTx, mgmtInstancedTableIndex=mgmtInstancedTableIndex, unitIdentification=unitIdentification, auxPortConfigurationMismatch=auxPortConfigurationMismatch, dataBridgingAvailability=dataBridgingAvailability, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseVersion=licenseVersion, sntp=sntp, syslogClientTrap=syslogClientTrap, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sNTPSync=sNTPSync, tDM=tDM, subbandLowestFrequency=subbandLowestFrequency, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, receiveChannel=receiveChannel, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sFPErrorTrap=sFPErrorTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, txColorCode=txColorCode, licenseTDDSyncSupport=licenseTDDSyncSupport, syncETrackingState=syncETrackingState, bridge=bridge, managementGroup=managementGroup, auxPortStatus=auxPortStatus, deviceMACAddress=deviceMACAddress, linkSymmetry=linkSymmetry, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, secureModeAlarm=secureModeAlarm, nIDULanPortStatus=nIDULanPortStatus, wirelessOutOctets=wirelessOutOctets, transparentClock=transparentClock, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationMode=receiveModulationMode, maximumNumberOfSlaves=maximumNumberOfSlaves, dNSResolver=dNSResolver, rawReceivePower=rawReceivePower, syslogStateTrap=syslogStateTrap, tDMInterfaceStatus=tDMInterfaceStatus, transmitPowerLinked=transmitPowerLinked, phyControlInstancedTable=phyControlInstancedTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, accessMethod=accessMethod, dNSServerInternetAddress=dNSServerInternetAddress, mainPSUPortQLTx=mainPSUPortQLTx)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, mainPSUPortQLRx=mainPSUPortQLRx, linkName=linkName, frequencyVariant=frequencyVariant, encryptionAlgorithm=encryptionAlgorithm, configurationGroup=configurationGroup, mABMaintenanceLevel=mABMaintenanceLevel, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseTLSRekey=licenseTLSRekey, cableDiagPair2Results=cableDiagPair2Results, vLANManagementPriority=vLANManagementPriority, wirelessOutAllOctets=wirelessOutAllOctets, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, cableLoss=cableLoss, dfsTable=dfsTable, licenseSecurityLevel=licenseSecurityLevel, syncEEquipmentClock=syncEEquipmentClock, searchState=searchState, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPEnabledMessages=sMTPEnabledMessages, ethernet=ethernet, userName=userName, l2CPPriorityTableNumber=l2CPPriorityTableNumber, phyStatusGroup=phyStatusGroup, alarmInstancedTableEntry=alarmInstancedTableEntry, authorizationControlTable=authorizationControlTable, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, dNSGroup=dNSGroup, userTableEntry=userTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, apcGroup=apcGroup, unitName=unitName, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNMPv3Enable=sNMPv3Enable, dfsMeans=dfsMeans, transmitPower=transmitPower, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, aAAControl=aAAControl, ptpTraps=ptpTraps, ptp670=ptp670, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, remoteUnitNameLinked=remoteUnitNameLinked, syslogState=syslogState, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, transmitFreqMHz=transmitFreqMHz, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, iPv6Address=iPv6Address, wirelessLinkAvailability=wirelessLinkAvailability, mainPSUPortStatus=mainPSUPortStatus, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, ptmp=ptmp, phyInstancedStatusTable=phyInstancedStatusTable, masterSlaveMode=masterSlaveMode, targetMACAddress=targetMACAddress, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseMaxLinkRange=licenseMaxLinkRange, sFPPortSyncERxStatus=sFPPortSyncERxStatus, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, systemClock=systemClock, localPacketFiltering=localPacketFiltering, versionsGroup=versionsGroup, systemReset=systemReset, sNMPTrapVersion=sNMPTrapVersion, sMTPServerInternetAddressType=sMTPServerInternetAddressType, transmitModulationMode=transmitModulationMode, bridgeGroup=bridgeGroup, timeZone=timeZone, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cableDiagPair4Distance=cableDiagPair4Distance, portAllocationMismatchTrap=portAllocationMismatchTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, sNTPPrimaryServer=sNTPPrimaryServer, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, smtpGroup=smtpGroup, dfsTableEntry=dfsTableEntry, tdmTableEntry=tdmTableEntry, cableDiagPair4Results=cableDiagPair4Results, hTTPSAccessEnabled=hTTPSAccessEnabled, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, ethernetGroup=ethernetGroup, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sNTPLastSync=sNTPLastSync, licenseSFPPortSupport=licenseSFPPortSupport, remoteInternetAddress=remoteInternetAddress, managementNetworkAccessEnabled=managementNetworkAccessEnabled, phyControlInstancedTableEntry=phyControlInstancedTableEntry, configuration=configuration, dataPortPauseFrames=dataPortPauseFrames, installArmState=installArmState, whitelistRMMacAddress=whitelistRMMacAddress, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseCountry=licenseCountry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatusLinked=installStatusLinked, dNS=dNS, transmitDataRate=transmitDataRate, tdmTableNumber=tdmTableNumber, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseTrialPeriod=licenseTrialPeriod, mABNominalModulationMode=mABNominalModulationMode, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerStatus=sNTPServerStatus, licenseRARSupport=licenseRARSupport, wirelessLinkStatus=wirelessLinkStatus, mgmtInstancedTableEntry=mgmtInstancedTableEntry, receiveDataRateLinked=receiveDataRateLinked, mainPSUPortStatusTrap=mainPSUPortStatusTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, secureModeAlarmTrap=secureModeAlarmTrap, regulatoryBandTrap=regulatoryBandTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, remoteMACAddressLinked=remoteMACAddressLinked, ethernetInstancedTableNumber=ethernetInstancedTableNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, userTableIndex=userTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDControl=tDDControl, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, subbandHighestFrequency=subbandHighestFrequency, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, pubInstancedStatsTable=pubInstancedStatsTable, licenseGroup=licenseGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tempPcb=tempPcb, tDMChannelStatusTrap=tDMChannelStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyControlInstancedTableNumber=phyControlInstancedTableNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortSyncERxStatus=auxPortSyncERxStatus, sNTPSyncTrap=sNTPSyncTrap, receiveDataRate=receiveDataRate, ethernetStatisticsDataSource=ethernetStatisticsDataSource, cableDiagPair2Distance=cableDiagPair2Distance, incompatibleMasterAndSlave=incompatibleMasterAndSlave, l2CPPriorityTable=l2CPPriorityTable, licenseIssueNumber=licenseIssueNumber, wirelessTopology=wirelessTopology, auxPortQLRx=auxPortQLRx, hTTPSPortNumber=hTTPSPortNumber, mainPSUPortAllocation=mainPSUPortAllocation, unitIdentificationGroup=unitIdentificationGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, mABTransmissionInterval=mABTransmissionInterval, sFPPortAutoMdix=sFPPortAutoMdix, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, auxPortDisabledWarning=auxPortDisabledWarning, daylightSaving=daylightSaving, phyControlInstancedTableIndex=phyControlInstancedTableIndex, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, remoteInternetAddressType=remoteInternetAddressType, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, ethernetPriorityTable=ethernetPriorityTable, lbtDetectedTrap=lbtDetectedTrap, auxPortStatusTrap=auxPortStatusTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, dNSServerTableIndex=dNSServerTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, authorizationControl=authorizationControl, licenseInstancedTableNumber=licenseInstancedTableNumber, authorizationControlTableNumber=authorizationControlTableNumber, dNSServerTable=dNSServerTable, hTTPPortNumber=hTTPPortNumber, sNMPCommunityString=sNMPCommunityString, auxPortQLTx=auxPortQLTx, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, antennaSelection=antennaSelection, resetGroup=resetGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, receiveFreqMHz=receiveFreqMHz, authorizationControlGroup=authorizationControlGroup, tDMChannelStatus=tDMChannelStatus, telnetAccessEnabled=telnetAccessEnabled, mgmtInstancedTableNumber=mgmtInstancedTableNumber, transparentClockVLAN=transparentClockVLAN, dfsTableNumber=dfsTableNumber, licenseIPv6Support=licenseIPv6Support, supplementaryGroup=supplementaryGroup, authorizationMethod=authorizationMethod, licenseBandwidthCap=licenseBandwidthCap, sFPPortAllocation=sFPPortAllocation, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, cableDiagPair3Distance=cableDiagPair3Distance, cableDiagnosticsWarning=cableDiagnosticsWarning, portAllocationMismatchLinked=portAllocationMismatchLinked, ethernetInstancedTableIndex=ethernetInstancedTableIndex, syncETracking=syncETracking, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, userTable=userTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, mgmtInstancedTable=mgmtInstancedTable, snmpControl=snmpControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, extendedSpectrumScanning=extendedSpectrumScanning, dataBridgingStatus=dataBridgingStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sNTPServerTableEntry=sNTPServerTableEntry, linkLoss=linkLoss, installationMode=installationMode, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sNMPPortNumber=sNMPPortNumber, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mABHoldoffPeriod=mABHoldoffPeriod, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, signalStrengthRatioLinked=signalStrengthRatioLinked, regulatoryBand=regulatoryBand, eIRP=eIRP, remoteMACAddress=remoteMACAddress, phyControl=phyControl, mABNominalTransmitCapacity=mABNominalTransmitCapacity, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDMConfigurationMismatch=tDMConfigurationMismatch, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, pubStatsGroup=pubStatsGroup, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tdmTableIndex=tdmTableIndex, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sntpGroup=sntpGroup, dfs=dfs, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sFPPortDisabledWarning=sFPPortDisabledWarning, mABState=mABState, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogControlGroup=syslogControlGroup, severelyErroredSeconds=severelyErroredSeconds, vLANManagementVID=vLANManagementVID)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", receiveModulationModeDetail=receiveModulationModeDetail, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseInstancedTableEntry=licenseInstancedTableEntry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, capacityVariantMismatch=capacityVariantMismatch, syslogClient=syslogClient, configurationInstancedTableEntry=configurationInstancedTableEntry, licenseHCMPSupport=licenseHCMPSupport, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, cambium=cambium, byteErrorRatio=byteErrorRatio, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, lowestTDMModulationMode=lowestTDMModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dNSPrimaryServer=dNSPrimaryServer, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, gatewayIPAddress=gatewayIPAddress, auxPortAllocation=auxPortAllocation, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTimeout=sNTPServerTimeout, sFPPortQLTx=sFPPortQLTx, management=management, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseGroupAccess=licenseGroupAccess, syncESlavePort=syncESlavePort, maxLinkRangeExceeded=maxLinkRangeExceeded, signalStrengthRatio=signalStrengthRatio, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, encryptionGroup=encryptionGroup, sNTPServerTable=sNTPServerTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, reset=reset, sNTPServerInternetAddress=sNTPServerInternetAddress, ptpTrapPrefix=ptpTrapPrefix, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sFPError=sFPError, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPv6PrefixLength=iPv6PrefixLength, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, tDMChannelCableLength=tDMChannelCableLength, telnetPortNumber=telnetPortNumber, PYSNMP_MODULE_ID=cambium, phyStatus=phyStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, snmpControlGroup=snmpControlGroup, apc=apc, licenseRegulatoryBandsList=licenseRegulatoryBandsList, maximumTransmitPower=maximumTransmitPower, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, authorizationControlTableIndex=authorizationControlTableIndex, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, hardwareVersion=hardwareVersion, receiveModulationModeLinked=receiveModulationModeLinked, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, sNMPTrapTableNumber=sNMPTrapTableNumber)
