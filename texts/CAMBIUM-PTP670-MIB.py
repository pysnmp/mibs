...
enterprises, Counter32, Gauge32, NotificationType, TimeTicks, iso, IpAddress, Unsigned32, Counter64, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Gauge32", "NotificationType", "TimeTicks", "iso", "IpAddress", "Unsigned32", "Counter64", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sntpGroup=sntpGroup, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNTPState=sNTPState, cableDiagnosticsResultTable=cableDiagnosticsResultTable, range=range, transmitPower=transmitPower, mABProtocolVLANPriority=mABProtocolVLANPriority, remoteUnitName=remoteUnitName, userTableIndex=userTableIndex, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, linkName=linkName, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, dataBridgingStatusLinked=dataBridgingStatusLinked, masterSlaveMode=masterSlaveMode, whitelistRMMacAddress=whitelistRMMacAddress, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, userPassword=userPassword, packetsFromInternalStack=packetsFromInternalStack, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, timeZone=timeZone, mABHoldoffPeriod=mABHoldoffPeriod, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, configurationInstancedTableNumber=configurationInstancedTableNumber, licenseTDDSyncSupport=licenseTDDSyncSupport, systemReset=systemReset, licenseTrialPeriod=licenseTrialPeriod, phyControlInstancedTableNumber=phyControlInstancedTableNumber, remoteUnitNameLinked=remoteUnitNameLinked, licenseInstancedTableNumber=licenseInstancedTableNumber, targetMACAddress=targetMACAddress, linkModeOptimization=linkModeOptimization, dfsTable=dfsTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, versions=versions, cableDiagnostics=cableDiagnostics, aAAControlGroup=aAAControlGroup, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseTLSRekey=licenseTLSRekey, sNTPServerStatus=sNTPServerStatus, licenseSFPPortSupport=licenseSFPPortSupport, linkSymmetry=linkSymmetry, wirelessOutAllOctets=wirelessOutAllOctets, tDMChannelLineCode=tDMChannelLineCode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rawReceivePowerLinked=rawReceivePowerLinked, useVLANForMABProtocol=useVLANForMABProtocol, secureModeAlarmTrap=secureModeAlarmTrap, dfs=dfs, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, dNSServerPortNumber=dNSServerPortNumber, unavailableSeconds=unavailableSeconds, hTTPSPortNumber=hTTPSPortNumber, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sMTPEmailAlert=sMTPEmailAlert, ethernetPriorityTable=ethernetPriorityTable, wirelessLinkAvailability=wirelessLinkAvailability, sNTPPollInterval=sNTPPollInterval, auxPortSSMTx=auxPortSSMTx, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dSCPManagementPriority=dSCPManagementPriority, licenseGroupAccess=licenseGroupAccess, tDDControlGroup=tDDControlGroup, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, receivePowerLinked=receivePowerLinked, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dNSPrimaryServer=dNSPrimaryServer, tDMInterfaceStatus=tDMInterfaceStatus, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, aAAControl=aAAControl, userRole=userRole, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableDiagPair4Results=cableDiagPair4Results, ptpTraps=ptpTraps, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, alarmInstancedTableIndex=alarmInstancedTableIndex, altitude=altitude, syslogControl=syslogControl, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, capacityVariantMismatchLinked=capacityVariantMismatchLinked, unitIdentificationGroup=unitIdentificationGroup, enableTransmission=enableTransmission, wirelessTopology=wirelessTopology, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mABState=mABState, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dNS=dNS, lowestDataModulationMode=lowestDataModulationMode, transmitFreqKHz=transmitFreqKHz, ptmp=ptmp, tDMInterfaceControl=tDMInterfaceControl, phyControlInstancedTable=phyControlInstancedTable, transmitChannel=transmitChannel, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, ptpTrapPrefix=ptpTrapPrefix, maximumNumberOfSlaves=maximumNumberOfSlaves, sFPPortStatusTrap=sFPPortStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetInstancedTable=ethernetInstancedTable, authorizationControlTable=authorizationControlTable, configurationInstancedTable=configurationInstancedTable, blacklistRMEnabled=blacklistRMEnabled, transparentClockVID=transparentClockVID, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, auxPortAllocation=auxPortAllocation, phyInstancedStatusTable=phyInstancedStatusTable, sNMPTrapTableIndex=sNMPTrapTableIndex, bridge=bridge, dataBridgingAvailability=dataBridgingAvailability, nIDULanPortStatus=nIDULanPortStatus, dNSServerTable=dNSServerTable, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, dfsTableEntry=dfsTableEntry, regulatoryBand=regulatoryBand, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syncETracking=syncETracking, receivePower=receivePower, cableDiagPair3Distance=cableDiagPair3Distance, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, userEnabled=userEnabled, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mgmtInstancedTableEntry=mgmtInstancedTableEntry, targetRange=targetRange, configurationGroup=configurationGroup, licenseEncryption=licenseEncryption, auxPortStatus=auxPortStatus, aggregateDataRate=aggregateDataRate, signalStrengthRatio=signalStrengthRatio, iPv6PrefixLength=iPv6PrefixLength, tDMConfigurationMismatch=tDMConfigurationMismatch, sNTPPrimaryServer=sNTPPrimaryServer, sFPPortSSMTx=sFPPortSSMTx, ethernetStatisticsTable=ethernetStatisticsTable, siteName=siteName, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, license=license, cableDiagnosticsWarning=cableDiagnosticsWarning, installArmStateTrap=installArmStateTrap, remoteInternetAddressType=remoteInternetAddressType, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, userName=userName, secureModeAlarm=secureModeAlarm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseSecurityLevel=licenseSecurityLevel, capacityVariantMismatchTrap=capacityVariantMismatchTrap, searchStateLinked=searchStateLinked, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sFPPortQLTx=sFPPortQLTx, receiveChannel=receiveChannel, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPv3Enable=sNMPv3Enable, extendedSpectrumScanning=extendedSpectrumScanning, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, alarmsGroup=alarmsGroup, dfsTableNumber=dfsTableNumber, cambium=cambium, ethernetPriorityTableNumber=ethernetPriorityTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, licenseVersion=licenseVersion, cableDiagPair2Distance=cableDiagPair2Distance, licenseInstancedTableIndex=licenseInstancedTableIndex, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, alarmInstancedTableNumber=alarmInstancedTableNumber, localPacketFiltering=localPacketFiltering, deviceMACAddress=deviceMACAddress, cableDiagPair1Results=cableDiagPair1Results, transmitModulationMode=transmitModulationMode, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, ethernetStatisticsDataSource=ethernetStatisticsDataSource, capacityVariantMismatch=capacityVariantMismatch, whitelistRMEnabled=whitelistRMEnabled, subbandLowestFrequency=subbandLowestFrequency, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, linkLossLinked=linkLossLinked, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, notificationsGroup=notificationsGroup, rangingMode=rangingMode, ptp670=ptp670, tDMChannelLoopback=tDMChannelLoopback, sFPPortStatus=sFPPortStatus, reset=reset, configuration=configuration, installStatusTrap=installStatusTrap, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, deviceESN=deviceESN, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, receiveDataRateLinked=receiveDataRateLinked, byteErrorRatio=byteErrorRatio, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, tempPcb=tempPcb, mgmtInstancedTableNumber=mgmtInstancedTableNumber, authorizationMethod=authorizationMethod, licenseGasGroup=licenseGasGroup, snmpControlGroup=snmpControlGroup, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, dfsMeans=dfsMeans, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, supplementaryGroup=supplementaryGroup, signalStrengthRatioLinked=signalStrengthRatioLinked, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, receiveFreqKHz=receiveFreqKHz, configurationInstancedTableIndex=configurationInstancedTableIndex, smtpGroup=smtpGroup, licenseHCMPSupport=licenseHCMPSupport, secondarySoftwareVersion=secondarySoftwareVersion, tDMChannelCableLength=tDMChannelCableLength, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, accessMethod=accessMethod, sFPPortAutoMdix=sFPPortAutoMdix, cableDiagPair2Results=cableDiagPair2Results, vLANManagementVID=vLANManagementVID, alarms=alarms, sNTPServerTableNumber=sNTPServerTableNumber, dfsGroup=dfsGroup, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, managementNetworkAccessEnabled=managementNetworkAccessEnabled)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", userTableNumber=userTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, sNTPSyncTrap=sNTPSyncTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dataPortPauseFrames=dataPortPauseFrames, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, vectorErrorLinked=vectorErrorLinked, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dNSServerTableIndex=dNSServerTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, transmitPowerLinked=transmitPowerLinked, syslogStateTrap=syslogStateTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, tDM=tDM, sMTPServerInternetAddressType=sMTPServerInternetAddressType, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sntp=sntp, sNMPTrapTableNumber=sNMPTrapTableNumber, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sFPPortAutoNegotiation=sFPPortAutoNegotiation, portAllocationMismatch=portAllocationMismatch, iPVersion=iPVersion, telnetAccessEnabled=telnetAccessEnabled, transmitDataRateLinked=transmitDataRateLinked, receiveFreqMHz=receiveFreqMHz, licenseBandwidthCap=licenseBandwidthCap, dNSServerTableNumber=dNSServerTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkStatus=wirelessLinkStatus, supplementary=supplementary, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, sFPPortQLRx=sFPPortQLRx, alarmInstancedTable=alarmInstancedTable, authorizationControlTableEntry=authorizationControlTableEntry, antennaGain=antennaGain, tdmTableIndex=tdmTableIndex, sNTPLastSync=sNTPLastSync, authorizationControlTableIndex=authorizationControlTableIndex, systemClock=systemClock, cableDiagPair1Distance=cableDiagPair1Distance, longitude=longitude, groupID=groupID, tDDSynchronizationMode=tDDSynchronizationMode, sFPPortDisabledWarning=sFPPortDisabledWarning, mainPSUPortQLTx=mainPSUPortQLTx, sNMPCommunityString=sNMPCommunityString, byteErrorRatioLinked=byteErrorRatioLinked, dNSResolver=dNSResolver, rangeLinked=rangeLinked, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, subnetMask=subnetMask, latitude=latitude, pubStatsGroup=pubStatsGroup, maximumTransmitPower=maximumTransmitPower, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControl=phyControl, pubInstancedStatsTable=pubInstancedStatsTable, mainPSUPortStatus=mainPSUPortStatus, eIRP=eIRP, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, bootVersion=bootVersion, mainPSUPortStatusTrap=mainPSUPortStatusTrap, encryption=encryption, receiveModulationMode=receiveModulationMode, receiveModulationModeLinked=receiveModulationModeLinked, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, blacklistRMMacAddress=blacklistRMMacAddress, licenseOOBManagementSupport=licenseOOBManagementSupport, productName=productName, portAllocationMismatchLinked=portAllocationMismatchLinked, syncESlavePort=syncESlavePort, encryptionAlgorithm=encryptionAlgorithm, unitIdentification=unitIdentification, sNMPTrapTable=sNMPTrapTable, vLANManagementPriority=vLANManagementPriority, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, PYSNMP_MODULE_ID=cambium, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPEnabledTraps=sNMPEnabledTraps, transmitModulationModeLinked=transmitModulationModeLinked, productVariant=productVariant, linkLoss=linkLoss, maxLinkRangeExceeded=maxLinkRangeExceeded, wirelessOutOctets=wirelessOutOctets, transmitterChannels=transmitterChannels, cableDiagnosticsPorts=cableDiagnosticsPorts, mABProtocolVID=mABProtocolVID, dNSGroup=dNSGroup, phyStatusGroup=phyStatusGroup, rawReceivePower=rawReceivePower, sNTPSync=sNTPSync, lbtDetectedTrap=lbtDetectedTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, txMABFrames=txMABFrames, hardwareVersion=hardwareVersion, encryptionGroup=encryptionGroup, licenseSyncESupport=licenseSyncESupport, syslogClientTrap=syslogClientTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseInstancedTableEntry=licenseInstancedTableEntry, ethernet=ethernet, packetsToInternalStack=packetsToInternalStack, cableDiagPair4Distance=cableDiagPair4Distance, receiveModulationModeDetail=receiveModulationModeDetail, licenseIssueNumber=licenseIssueNumber, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, mainPSUPortAllocation=mainPSUPortAllocation, channelChangeTrap=channelChangeTrap, mainPSUPortQLRx=mainPSUPortQLRx, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, lowestTDMModulationMode=lowestTDMModulationMode, cableDiagPair3Results=cableDiagPair3Results, tdmTableEntry=tdmTableEntry, management=management, unitName=unitName, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, auxPortQLTx=auxPortQLTx, tFTPServerInternetAddress=tFTPServerInternetAddress, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, dNSServerInternetAddressType=dNSServerInternetAddressType, syslogClient=syslogClient, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, regulatoryBandTrap=regulatoryBandTrap, ptpCompliance=ptpCompliance, tDDSynchronizationStatus=tDDSynchronizationStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, frequencyVariant=frequencyVariant, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, rxColorCode=rxColorCode, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, phyControlGroup=phyControlGroup, installArmState=installArmState, qOSPriorityScheme=qOSPriorityScheme, licenseUnitSerialNumber=licenseUnitSerialNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, transparentClockVLAN=transparentClockVLAN, dNSServerInternetAddress=dNSServerInternetAddress, antennaSelection=antennaSelection, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sNMPTrapVersion=sNMPTrapVersion, tDMGroup=tDMGroup, transmitDataRate=transmitDataRate, licenseRARSupport=licenseRARSupport, wirelessLinkStatusLinked=wirelessLinkStatusLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, iPv6Address=iPv6Address, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, syslogControlGroup=syslogControlGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, syslogState=syslogState, mABTransmissionInterval=mABTransmissionInterval, installationMode=installationMode, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, severelyErroredSeconds=severelyErroredSeconds, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, deviceMSN=deviceMSN, auxPortQLRx=auxPortQLRx, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, nIDULanPortAutoMdix=nIDULanPortAutoMdix, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tDDControl=tDDControl, mainPSUPortSSMTx=mainPSUPortSSMTx, iPv6GatewayAddress=iPv6GatewayAddress, managementGroup=managementGroup, cableDiagnosticsControl=cableDiagnosticsControl, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, unitOutOfCalibration=unitOutOfCalibration, gatewayIPAddress=gatewayIPAddress, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerInternetAddress=sNTPServerInternetAddress, ptpGroups=ptpGroups, mgmtInstancedTableIndex=mgmtInstancedTableIndex, auxPortStatusTrap=auxPortStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, l2CPPriorityTable=l2CPPriorityTable, installStatusLinked=installStatusLinked, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, ptp=ptp, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseInstancedTable=licenseInstancedTable, licenseIPv6Support=licenseIPv6Support, userTable=userTable, versionsGroup=versionsGroup, licenseGroup=licenseGroup, sNTPServerRetries=sNTPServerRetries, dNSServerTableEntry=dNSServerTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, remoteMACAddress=remoteMACAddress, remoteInternetAddress=remoteInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, txColorCode=txColorCode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, channelBandwidth=channelBandwidth, transparentClockPort=transparentClockPort, apcGroup=apcGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, snmpControl=snmpControl, sFPErrorTrap=sFPErrorTrap, licenseIEEE1588Support=licenseIEEE1588Support, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDMEnabledChannels=tDMEnabledChannels, sNMPTrapTableEntry=sNMPTrapTableEntry, daylightSaving=daylightSaving, sNMPTrapPortNumber=sNMPTrapPortNumber, authorizationControl=authorizationControl, smtp=smtp, transmitFreqMHz=transmitFreqMHz, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, bridgeGroup=bridgeGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, searchState=searchState, sNTPServerPortNumber=sNTPServerPortNumber, mgmtInstancedTable=mgmtInstancedTable, installStatus=installStatus, syncEEquipmentClock=syncEEquipmentClock, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sNTPServerTableIndex=sNTPServerTableIndex, receiveDataRate=receiveDataRate, softwareVersion=softwareVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mPLSTCPriorityTable=mPLSTCPriorityTable, syncETrackingState=syncETrackingState, sNMPPortNumber=sNMPPortNumber, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ethernetInstancedTableEntry=ethernetInstancedTableEntry, routerProtocolsGroup=routerProtocolsGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, ethernetGroup=ethernetGroup, dfsTableIndex=dfsTableIndex, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sNTPServerTableEntry=sNTPServerTableEntry, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sFPPortAllocation=sFPPortAllocation, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, tdmTable=tdmTable, phyStatus=phyStatus, sFPError=sFPError, mABMaintenanceLevel=mABMaintenanceLevel, sNTPServerTimeout=sNTPServerTimeout, cableDiagnosticsGroup=cableDiagnosticsGroup, remoteMACAddressLinked=remoteMACAddressLinked, mABNominalModulationMode=mABNominalModulationMode, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tdmTableNumber=tdmTableNumber, licenseCapacity=licenseCapacity, sMTPServerInternetAddress=sMTPServerInternetAddress, erroredSeconds=erroredSeconds, routerProtocols=routerProtocols, telnetPortNumber=telnetPortNumber, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, portAllocationMismatchTrap=portAllocationMismatchTrap, tFTPClient=tFTPClient, resetGroup=resetGroup, iPv4Address=iPv4Address, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, authorizationControlGroup=authorizationControlGroup, ethernetInstancedTableNumber=ethernetInstancedTableNumber, dfsPeaks=dfsPeaks, dataBridgingStatus=dataBridgingStatus, tDMChannelStatus=tDMChannelStatus, apc=apc, sNTPServerTable=sNTPServerTable, authorizationControlTableNumber=authorizationControlTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userTableEntry=userTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aggregateDataRateLinked=aggregateDataRateLinked, noWirelessChannelAvailable=noWirelessChannelAvailable, hCMPLinkSymmetry=hCMPLinkSymmetry, subbandHighestFrequency=subbandHighestFrequency, vectorError=vectorError, transparentClock=transparentClock, ethernetInstancedTableIndex=ethernetInstancedTableIndex, licenseCountry=licenseCountry, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sFPPortSyncERxStatus=sFPPortSyncERxStatus)
