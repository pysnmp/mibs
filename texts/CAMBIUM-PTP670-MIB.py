...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", enableTransmission=enableTransmission, mABProtocolVLANPriority=mABProtocolVLANPriority, cableDiagnosticsControl=cableDiagnosticsControl, licenseTLSRekey=licenseTLSRekey, routerProtocols=routerProtocols, alarmInstancedTableNumber=alarmInstancedTableNumber, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, auxPortConfigurationMismatch=auxPortConfigurationMismatch, lbtDetectedTrap=lbtDetectedTrap, transmitDataRateLinked=transmitDataRateLinked, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, receiveDataRate=receiveDataRate, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetInstancedTableEntry=ethernetInstancedTableEntry, licenseUnitSerialNumber=licenseUnitSerialNumber, authorizationMethod=authorizationMethod, authorizationControlGroup=authorizationControlGroup, licenseGroup=licenseGroup, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, softwareVersion=softwareVersion, mainPSUPortStatus=mainPSUPortStatus, aggregateDataRate=aggregateDataRate, ptpCompliance=ptpCompliance, hTTPPortNumber=hTTPPortNumber, regulatoryBandTrap=regulatoryBandTrap, telnetPortNumber=telnetPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetInstancedTableNumber=ethernetInstancedTableNumber, cableDiagPair3Distance=cableDiagPair3Distance, alarmInstancedTableEntry=alarmInstancedTableEntry, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPServerTable=sNTPServerTable, rangingMode=rangingMode, linkLossLinked=linkLossLinked, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transparentClockVID=transparentClockVID, phyControlInstancedTableIndex=phyControlInstancedTableIndex, systemClock=systemClock, linkSymmetry=linkSymmetry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, alarmInstancedTable=alarmInstancedTable, sFPPortDisabledWarning=sFPPortDisabledWarning, secureModeAlarm=secureModeAlarm, sNMPEnabledTraps=sNMPEnabledTraps, sFPPortQLTx=sFPPortQLTx, mainPSUPortSSMTx=mainPSUPortSSMTx, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mainPSUPortQLRx=mainPSUPortQLRx, searchStateLinked=searchStateLinked, alarmInstancedTableIndex=alarmInstancedTableIndex, aggregateDataRateLinked=aggregateDataRateLinked, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, qOSPriorityScheme=qOSPriorityScheme, rawReceivePower=rawReceivePower, ethernetInstancedTable=ethernetInstancedTable, phyControlInstancedTableEntry=phyControlInstancedTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, bridge=bridge, sNTPServerTimeout=sNTPServerTimeout, tDMChannelLineCode=tDMChannelLineCode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, configurationInstancedTableEntry=configurationInstancedTableEntry, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, accessMethod=accessMethod, auxPortSSMTx=auxPortSSMTx, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseInstancedTableNumber=licenseInstancedTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogState=syslogState, receivePower=receivePower, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDMChannelStatus=tDMChannelStatus, iPv4Address=iPv4Address, whitelistRMEnabled=whitelistRMEnabled, capacityVariantMismatch=capacityVariantMismatch, smtpGroup=smtpGroup, lowestTDMModulationMode=lowestTDMModulationMode, vectorErrorLinked=vectorErrorLinked, cableLoss=cableLoss, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, dNSServerTableEntry=dNSServerTableEntry, siteName=siteName, licenseBandwidthCap=licenseBandwidthCap, remoteMACAddress=remoteMACAddress, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, dfsTableEntry=dfsTableEntry, dfsPeaks=dfsPeaks, transparentClockVLAN=transparentClockVLAN, hCMPLinkSymmetry=hCMPLinkSymmetry, ethernetGroup=ethernetGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, remoteUnitName=remoteUnitName, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mgmtInstancedTable=mgmtInstancedTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, receiveFreqMHz=receiveFreqMHz, byteErrorRatio=byteErrorRatio, sMTPEmailAlert=sMTPEmailAlert, rxColorCode=rxColorCode, longitude=longitude, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataBridgingStatus=dataBridgingStatus, syncEEquipmentClock=syncEEquipmentClock, syncETracking=syncETracking, ethernetInstancedTableIndex=ethernetInstancedTableIndex, searchState=searchState, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortQLRx=sFPPortQLRx, cableDiagPair1Results=cableDiagPair1Results, masterSlaveMode=masterSlaveMode, authorizationControlTableEntry=authorizationControlTableEntry, sFPError=sFPError, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitIdentificationGroup=unitIdentificationGroup, phyInstancedStatusTable=phyInstancedStatusTable, nIDULanPortStatus=nIDULanPortStatus, tdmTableEntry=tdmTableEntry, apc=apc, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, configurationInstancedTableIndex=configurationInstancedTableIndex, userTableNumber=userTableNumber, tDMGroup=tDMGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userEnabled=userEnabled, licenseEncryption=licenseEncryption, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, transmitModulationModeLinked=transmitModulationModeLinked, sFPPortStatus=sFPPortStatus, signalStrengthRatio=signalStrengthRatio, syslogControl=syslogControl, dfsGroup=dfsGroup, sNMPTrapVersion=sNMPTrapVersion, phyControlInstancedTableNumber=phyControlInstancedTableNumber, subbandHighestFrequency=subbandHighestFrequency, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortPauseFrames=dataPortPauseFrames, licenseHCMPSupport=licenseHCMPSupport, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dNSGroup=dNSGroup, sNTPLastSync=sNTPLastSync, linkModeOptimization=linkModeOptimization, ptpTrapPrefix=ptpTrapPrefix, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, whitelistRMMacAddress=whitelistRMMacAddress, sFPPortAllocation=sFPPortAllocation, ptpTraps=ptpTraps, signalStrengthRatioLinked=signalStrengthRatioLinked, portAllocationMismatchLinked=portAllocationMismatchLinked, dataBridgingAvailability=dataBridgingAvailability, dNSServerInternetAddress=dNSServerInternetAddress, sNTPSyncTrap=sNTPSyncTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, deviceMACAddress=deviceMACAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, transmitDataRate=transmitDataRate, pubStatsGroup=pubStatsGroup, unitOutOfCalibration=unitOutOfCalibration, sFPPortStatusTrap=sFPPortStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, cableDiagnostics=cableDiagnostics, wirelessLinkStatusLinked=wirelessLinkStatusLinked, userName=userName, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, timeZone=timeZone, mABMaintenanceLevel=mABMaintenanceLevel, useVLANForMABProtocol=useVLANForMABProtocol, mainPSUPortQLTx=mainPSUPortQLTx, cableDiagnosticsGroup=cableDiagnosticsGroup, alarms=alarms, mainPSUPortStatusTrap=mainPSUPortStatusTrap, deviceESN=deviceESN, unitName=unitName, userPassword=userPassword, mABNominalTransmitCapacity=mABNominalTransmitCapacity, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ptpGroups=ptpGroups, auxPortQLTx=auxPortQLTx, licenseSecurityLevel=licenseSecurityLevel, channelBandwidth=channelBandwidth, range=range, targetRange=targetRange, cableDiagnosticsResultTable=cableDiagnosticsResultTable, tDMInterfaceStatus=tDMInterfaceStatus, vLANManagementPriority=vLANManagementPriority, antennaGain=antennaGain, antennaSelection=antennaSelection, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, dNSServerInternetAddressType=dNSServerInternetAddressType, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNTPServerPortNumber=sNTPServerPortNumber, snmpControlGroup=snmpControlGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseCapacity=licenseCapacity, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementGroup=managementGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, unavailableSeconds=unavailableSeconds, licenseTDDSyncSupport=licenseTDDSyncSupport, tempPcb=tempPcb, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, userTable=userTable, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, auxPortAllocation=auxPortAllocation, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessOutEthernetOctets=wirelessOutEthernetOctets, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, authorizationControlTableNumber=authorizationControlTableNumber, snmpControl=snmpControl, sNTPSync=sNTPSync, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, targetMACAddress=targetMACAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hardwareVersion=hardwareVersion, licenseGasGroup=licenseGasGroup, versions=versions, configurationInstancedTableNumber=configurationInstancedTableNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, tdmTableNumber=tdmTableNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, wirelessTopology=wirelessTopology, dNSServerTableNumber=dNSServerTableNumber, dNSServerTableIndex=dNSServerTableIndex, ethernetStatisticsDataSource=ethernetStatisticsDataSource, mPLSTCPriorityTable=mPLSTCPriorityTable, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPPortNumber=sNMPPortNumber, auxPortDisabledWarning=auxPortDisabledWarning, tDDControlGroup=tDDControlGroup, sFPPortAutoMdix=sFPPortAutoMdix, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, encryptionGroup=encryptionGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernet=ethernet, cableDiagnosticsWarning=cableDiagnosticsWarning)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tFTPServerInternetAddress=tFTPServerInternetAddress, resetGroup=resetGroup, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, installStatus=installStatus, license=license, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, wirelessOutAllOctets=wirelessOutAllOctets, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseGroupAccess=licenseGroupAccess, syslogClient=syslogClient, installStatusLinked=installStatusLinked, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, remoteInternetAddressType=remoteInternetAddressType, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, routerProtocolsGroup=routerProtocolsGroup, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, latitude=latitude, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, transmitPowerLinked=transmitPowerLinked, auxPortStatus=auxPortStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, syncETrackingState=syncETrackingState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dNSServerTable=dNSServerTable, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, configuration=configuration, tDDControl=tDDControl, sNTPState=sNTPState, syncESlavePort=syncESlavePort, licenseTrialPeriod=licenseTrialPeriod, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, mainPSUPortAllocation=mainPSUPortAllocation, ptp670=ptp670, oOBPriorityQueueMapping=oOBPriorityQueueMapping, mABProtocolVID=mABProtocolVID, byteErrorRatioLinked=byteErrorRatioLinked, capacityVariantMismatchTrap=capacityVariantMismatchTrap, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, alarmsGroup=alarmsGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, telnetAccessEnabled=telnetAccessEnabled, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, tDMChannelStatusTrap=tDMChannelStatusTrap, productVariant=productVariant, sFPPortSSMTx=sFPPortSSMTx, licenseRARSupport=licenseRARSupport, sNMPCommunityString=sNMPCommunityString, ptp=ptp, cableDiagPair4Distance=cableDiagPair4Distance, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, aAAControl=aAAControl, nIDULanPortAutoMdix=nIDULanPortAutoMdix, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, syslogClientTrap=syslogClientTrap, vLANManagementVID=vLANManagementVID, sNMPTrapTable=sNMPTrapTable, capacityVariantMismatchLinked=capacityVariantMismatchLinked, tdmTable=tdmTable, authorizationControl=authorizationControl, receiveFreqKHz=receiveFreqKHz, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, configurationInstancedTable=configurationInstancedTable, blacklistRMMacAddress=blacklistRMMacAddress, licenseMaxLinkRange=licenseMaxLinkRange, sMTPServerPortNumber=sMTPServerPortNumber, cableDiagPair4Results=cableDiagPair4Results, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, iPVersion=iPVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dfsTableIndex=dfsTableIndex, userTableIndex=userTableIndex, rawReceivePowerLinked=rawReceivePowerLinked, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseVersion=licenseVersion, mgmtInstancedTableEntry=mgmtInstancedTableEntry, groupID=groupID, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNMPv3Enable=sNMPv3Enable, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, tDDSynchronizationMode=tDDSynchronizationMode, receivePowerLinked=receivePowerLinked, ptmp=ptmp, receiveModulationModeDetail=receiveModulationModeDetail, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, installStatusTrap=installStatusTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, transparentClockPort=transparentClockPort, managementNetworkAccessEnabled=managementNetworkAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagPair3Results=cableDiagPair3Results, receiveModulationMode=receiveModulationMode, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, dNSServerPortNumber=dNSServerPortNumber, rangeLinked=rangeLinked, wirelessOutOctets=wirelessOutOctets, lowestDataModulationMode=lowestDataModulationMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, hTTPAccessEnabled=hTTPAccessEnabled, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, frequencyVariant=frequencyVariant, tDMChannelCableLength=tDMChannelCableLength, transmitPower=transmitPower, portAllocationMismatchTrap=portAllocationMismatchTrap, txColorCode=txColorCode, deviceMSN=deviceMSN, mABTransmissionInterval=mABTransmissionInterval, notificationsGroup=notificationsGroup, licenseInstancedTable=licenseInstancedTable, mABState=mABState, dNS=dNS, auxPortQLRx=auxPortQLRx, incompatibleMasterAndSlave=incompatibleMasterAndSlave, severelyErroredSeconds=severelyErroredSeconds, hCMPMaximumLinkRange=hCMPMaximumLinkRange, installArmStateTrap=installArmStateTrap, linkLoss=linkLoss, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, transparentClock=transparentClock, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, tDMInterfaceControl=tDMInterfaceControl, bridgeGroup=bridgeGroup, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tDMEnabledChannels=tDMEnabledChannels, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, supplementaryGroup=supplementaryGroup, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sNTPServerRetries=sNTPServerRetries, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, blacklistRMEnabled=blacklistRMEnabled, mABHoldoffPeriod=mABHoldoffPeriod, phyControl=phyControl, userTableEntry=userTableEntry, erroredSeconds=erroredSeconds, cambium=cambium, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, receiveDataRateLinked=receiveDataRateLinked, syslogControlGroup=syslogControlGroup, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, dfsMeans=dfsMeans, dSCPManagementPriority=dSCPManagementPriority, authorizationControlTable=authorizationControlTable, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tDDSynchronizationAlarm=tDDSynchronizationAlarm, versionsGroup=versionsGroup, pubInstancedStatsTable=pubInstancedStatsTable, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseSyncESupport=licenseSyncESupport, iPv6GatewayAddress=iPv6GatewayAddress, secondarySoftwareVersion=secondarySoftwareVersion, sntpGroup=sntpGroup, dNSPrimaryServer=dNSPrimaryServer, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, maximumNumberOfSlaves=maximumNumberOfSlaves, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, dfsTable=dfsTable, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, supplementary=supplementary, cableDiagPair2Distance=cableDiagPair2Distance, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, phyStatusGroup=phyStatusGroup, transmitFreqKHz=transmitFreqKHz, l2CPPriorityTable=l2CPPriorityTable, eIRP=eIRP, wirelessLinkAvailability=wirelessLinkAvailability, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, dfsTableNumber=dfsTableNumber, sNTPServerStatus=sNTPServerStatus, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitModulationMode=transmitModulationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, ethernetPriorityTable=ethernetPriorityTable, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, encryptionAlgorithm=encryptionAlgorithm, txMABFrames=txMABFrames, authorizationControlTableIndex=authorizationControlTableIndex, dNSResolver=dNSResolver, packetsToInternalStack=packetsToInternalStack, subbandLowestFrequency=subbandLowestFrequency, configurationGroup=configurationGroup, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, cableDiagPair1Distance=cableDiagPair1Distance, sntp=sntp, tdmTableIndex=tdmTableIndex, apcGroup=apcGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, portAllocationMismatch=portAllocationMismatch, receiveModulationModeLinked=receiveModulationModeLinked, mABNominalModulationMode=mABNominalModulationMode, localPacketFiltering=localPacketFiltering, wirelessLinkStatus=wirelessLinkStatus, transmitFreqMHz=transmitFreqMHz, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, extendedSpectrumScanning=extendedSpectrumScanning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, pubStats=pubStats, cableDiagPair2Results=cableDiagPair2Results, sFPErrorTrap=sFPErrorTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, transmitChannel=transmitChannel, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, phyControlGroup=phyControlGroup, userRole=userRole, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, secureModeAlarmTrap=secureModeAlarmTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, packetsFromInternalStack=packetsFromInternalStack, vectorError=vectorError, licenseInstancedTableIndex=licenseInstancedTableIndex, hTTPSPortNumber=hTTPSPortNumber, installationMode=installationMode, licenseIPv6Support=licenseIPv6Support, encryption=encryption, management=management, maximumTransmitPower=maximumTransmitPower, syslogStateTrap=syslogStateTrap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, licenseIEEE1588Support=licenseIEEE1588Support)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", regulatoryBand=regulatoryBand, unitIdentification=unitIdentification, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, subnetMask=subnetMask, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, transmitterChannels=transmitterChannels, reset=reset, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, remoteInternetAddress=remoteInternetAddress, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, linkName=linkName, ethernetPriorityTableNumber=ethernetPriorityTableNumber, altitude=altitude, l2CPPriorityTableNumber=l2CPPriorityTableNumber, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, tDMChannelLoopback=tDMChannelLoopback, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licenseIssueNumber=licenseIssueNumber, smtp=smtp, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, phyControlInstancedTable=phyControlInstancedTable, PYSNMP_MODULE_ID=cambium, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, phyStatus=phyStatus, daylightSaving=daylightSaving, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, iPv6Address=iPv6Address, licenseOOBManagementSupport=licenseOOBManagementSupport, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, licenseSFPPortSupport=licenseSFPPortSupport, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, bootVersion=bootVersion, dfs=dfs, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, tFTPClient=tFTPClient, remoteUnitNameLinked=remoteUnitNameLinked, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, receiveChannel=receiveChannel, auxPortStatusTrap=auxPortStatusTrap, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sNTPServerInternetAddress=sNTPServerInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, installArmState=installArmState, iPv6PrefixLength=iPv6PrefixLength, sNTPServerTableNumber=sNTPServerTableNumber, tDM=tDM, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseCountry=licenseCountry, productName=productName, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, remoteMACAddressLinked=remoteMACAddressLinked, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, aAAControlGroup=aAAControlGroup, channelChangeTrap=channelChangeTrap, ethernetStatisticsTable=ethernetStatisticsTable)
