...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", searchState=searchState, ethernetInstancedTable=ethernetInstancedTable, subnetMask=subnetMask, cableDiagPair3Results=cableDiagPair3Results, maximumNumberOfSlaves=maximumNumberOfSlaves, sNMPTrapTable=sNMPTrapTable, enableTransmission=enableTransmission, sFPPortSSMTx=sFPPortSSMTx, cableDiagPair1Results=cableDiagPair1Results, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, rangeLinked=rangeLinked, whitelistRMMacAddress=whitelistRMMacAddress, ethernetGroup=ethernetGroup, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNTPServerRetries=sNTPServerRetries, tDDControlGroup=tDDControlGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, alarmInstancedTableEntry=alarmInstancedTableEntry, mABHoldoffPeriod=mABHoldoffPeriod, sFPPortDisabledWarning=sFPPortDisabledWarning, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, l2CPPriorityTable=l2CPPriorityTable, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sNTPLastSync=sNTPLastSync, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, transmitPowerLinked=transmitPowerLinked, transmitDataRate=transmitDataRate, ptpGroups=ptpGroups, licenseIEEE1588Support=licenseIEEE1588Support, wirelessOutOctets=wirelessOutOctets, syncETracking=syncETracking, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, authorizationControlGroup=authorizationControlGroup, linkName=linkName, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, regulatoryBand=regulatoryBand, channelChangeTrap=channelChangeTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, qOSPriorityScheme=qOSPriorityScheme, tdmTableEntry=tdmTableEntry, unitName=unitName, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, siteName=siteName, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, targetMACAddress=targetMACAddress, vectorError=vectorError, antennaGain=antennaGain, ethernetStatisticsDataSource=ethernetStatisticsDataSource, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPErrorTrap=sFPErrorTrap, sNTPServerTableIndex=sNTPServerTableIndex, receiveChannel=receiveChannel, dNS=dNS, erroredSeconds=erroredSeconds, auxPortSSMTx=auxPortSSMTx, rangingMode=rangingMode, portAllocationMismatchTrap=portAllocationMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mABMaintenanceLevel=mABMaintenanceLevel, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveFreqMHz=receiveFreqMHz, mgmtInstancedTable=mgmtInstancedTable, receiveFreqKHz=receiveFreqKHz, ptpTrapPrefix=ptpTrapPrefix, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, productName=productName, tempPcb=tempPcb, cableDiagnosticsResultTable=cableDiagnosticsResultTable, antennaSelection=antennaSelection, transparentClockVID=transparentClockVID, userTableNumber=userTableNumber, remoteUnitNameLinked=remoteUnitNameLinked, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, syslogControlGroup=syslogControlGroup, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, syslogClient=syslogClient, deviceMACAddress=deviceMACAddress, wirelessLinkAvailability=wirelessLinkAvailability, lowestDataModulationMode=lowestDataModulationMode, licenseRARSupport=licenseRARSupport, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, rawReceivePowerLinked=rawReceivePowerLinked, installStatusTrap=installStatusTrap, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, alarmInstancedTableIndex=alarmInstancedTableIndex, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, installationMode=installationMode, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, txColorCode=txColorCode, encryption=encryption, auxPortQLTx=auxPortQLTx, receiveModulationMode=receiveModulationMode, remoteInternetAddressType=remoteInternetAddressType, licenseUnitSerialNumber=licenseUnitSerialNumber, sNTPState=sNTPState, gatewayIPAddress=gatewayIPAddress, iPv6Address=iPv6Address, dfsGroup=dfsGroup, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseIPv6Support=licenseIPv6Support, systemReset=systemReset, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpCompliance=ptpCompliance, cableDiagPair2Results=cableDiagPair2Results, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNMPCommunityString=sNMPCommunityString, capacityVariantMismatchLinked=capacityVariantMismatchLinked, linkSymmetry=linkSymmetry, syslogStateTrap=syslogStateTrap, transparentClockPort=transparentClockPort, tDMInterfaceStatus=tDMInterfaceStatus, authorizationControlTableNumber=authorizationControlTableNumber, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, phyControlInstancedTable=phyControlInstancedTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dNSServerTableNumber=dNSServerTableNumber, supplementaryGroup=supplementaryGroup, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, altitude=altitude, channelBandwidth=channelBandwidth, mgmtInstancedTableIndex=mgmtInstancedTableIndex, tDMEnabledChannels=tDMEnabledChannels, receiveModulationModeLinked=receiveModulationModeLinked, ethernetStatisticsTable=ethernetStatisticsTable, dataBridgingStatus=dataBridgingStatus, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, dataBridgingAvailability=dataBridgingAvailability, daylightSaving=daylightSaving, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkStatus=wirelessLinkStatus, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, licenseCapacity=licenseCapacity, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseGasGroup=licenseGasGroup, aggregateDataRateLinked=aggregateDataRateLinked, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, receivePower=receivePower, auxPortStatusTrap=auxPortStatusTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mainPSUPortAllocation=mainPSUPortAllocation, cableDiagPair4Distance=cableDiagPair4Distance, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataBridgingStatusLinked=dataBridgingStatusLinked, hCMPLinkSymmetry=hCMPLinkSymmetry, sMTPServerInternetAddress=sMTPServerInternetAddress, cableDiagnosticsControl=cableDiagnosticsControl, licenseHCMPSupport=licenseHCMPSupport, sNMPv3Enable=sNMPv3Enable, phyControlInstancedTableEntry=phyControlInstancedTableEntry, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, apcGroup=apcGroup, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, auxPortStatus=auxPortStatus, tdmTable=tdmTable, ptpTraps=ptpTraps, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, userRole=userRole, signalStrengthRatio=signalStrengthRatio, installStatusLinked=installStatusLinked, whitelistRMEnabled=whitelistRMEnabled, sNTPSyncTrap=sNTPSyncTrap, receiveDataRateLinked=receiveDataRateLinked, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, cableLoss=cableLoss, auxPortConfigurationMismatch=auxPortConfigurationMismatch, regulatoryBandTrap=regulatoryBandTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, smtp=smtp, ptmp=ptmp, portAllocationMismatch=portAllocationMismatch, tDM=tDM, licenseInstancedTableIndex=licenseInstancedTableIndex, installArmStateTrap=installArmStateTrap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, vectorErrorLinked=vectorErrorLinked, mainPSUPortQLRx=mainPSUPortQLRx, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, signalStrengthRatioLinked=signalStrengthRatioLinked, rawReceivePower=rawReceivePower, receivePowerLinked=receivePowerLinked, auxPortQLRx=auxPortQLRx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, hTTPSAccessEnabled=hTTPSAccessEnabled, nIDULanPortStatus=nIDULanPortStatus, alarmInstancedTable=alarmInstancedTable, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, wirelessOutEthernetOctets=wirelessOutEthernetOctets, tDDSynchronizationMode=tDDSynchronizationMode, licenseInstancedTableEntry=licenseInstancedTableEntry, routerProtocolsGroup=routerProtocolsGroup, sNTPPrimaryServer=sNTPPrimaryServer, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, mABProtocolVLANPriority=mABProtocolVLANPriority, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, smtpGroup=smtpGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, productVariant=productVariant, ethernetPriorityTableEntry=ethernetPriorityTableEntry, versionsGroup=versionsGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, hTTPPortNumber=hTTPPortNumber, tdmTableNumber=tdmTableNumber, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, licenseEncryption=licenseEncryption, managementNetworkAccessEnabled=managementNetworkAccessEnabled, subbandLowestFrequency=subbandLowestFrequency, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetPriorityTable=ethernetPriorityTable, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, dfsTableIndex=dfsTableIndex, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, alarmInstancedTableNumber=alarmInstancedTableNumber, dfsMeans=dfsMeans, sNMPPortNumber=sNMPPortNumber, sNTPSync=sNTPSync, sNTPServerTableNumber=sNTPServerTableNumber, syslogClientTrap=syslogClientTrap, linkLossLinked=linkLossLinked, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, hTTPAccessEnabled=hTTPAccessEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, routerProtocols=routerProtocols, accessMethod=accessMethod, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, wirelessTopology=wirelessTopology, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, dfsPeaks=dfsPeaks, sMTPEnabledMessages=sMTPEnabledMessages)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", blacklistRMEnabled=blacklistRMEnabled, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, lbtDetectedTrap=lbtDetectedTrap, alarmsGroup=alarmsGroup, dNSServerPortNumber=dNSServerPortNumber, masterSlaveMode=masterSlaveMode, transparentClockVLAN=transparentClockVLAN, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sFPPortQLTx=sFPPortQLTx, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, telnetPortNumber=telnetPortNumber, cableDiagPair3Distance=cableDiagPair3Distance, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPv6GatewayAddress=iPv6GatewayAddress, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, secureModeAlarm=secureModeAlarm, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, management=management, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, capacityVariantMismatch=capacityVariantMismatch, unitIdentification=unitIdentification, blacklistRMMacAddress=blacklistRMMacAddress, phyStatus=phyStatus, managementGroup=managementGroup, wirelessOutAllOctets=wirelessOutAllOctets, mainPSUPortQLTx=mainPSUPortQLTx, linkModeOptimizationMismatch=linkModeOptimizationMismatch, supplementary=supplementary, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, userName=userName, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, hardwareVersion=hardwareVersion, PYSNMP_MODULE_ID=cambium, licenseTDDSyncSupport=licenseTDDSyncSupport, mainPSUPortSSMTx=mainPSUPortSSMTx, sNMPTrapTableNumber=sNMPTrapTableNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, sFPPortStatusTrap=sFPPortStatusTrap, tDMChannelStatus=tDMChannelStatus, userEnabled=userEnabled, nIDULanPortAutoMdix=nIDULanPortAutoMdix, linkLoss=linkLoss, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dataPortPauseFrames=dataPortPauseFrames, mABProtocolVID=mABProtocolVID, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernetInstancedTableNumber=ethernetInstancedTableNumber, iPVersion=iPVersion, searchStateLinked=searchStateLinked, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDMGroup=tDMGroup, byteErrorRatioLinked=byteErrorRatioLinked, vLANManagementPriority=vLANManagementPriority, licenseIssueNumber=licenseIssueNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitModulationMode=transmitModulationMode, severelyErroredSeconds=severelyErroredSeconds, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseOOBManagementSupport=licenseOOBManagementSupport, unitOutOfCalibration=unitOutOfCalibration, licenseVersion=licenseVersion, reset=reset, packetsFromInternalStack=packetsFromInternalStack, licenseInstancedTableNumber=licenseInstancedTableNumber, longitude=longitude, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licenseTrialPeriod=licenseTrialPeriod, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, transparentClock=transparentClock, cableDiagnostics=cableDiagnostics, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tDMInterfaceControl=tDMInterfaceControl, dNSServerInternetAddressType=dNSServerInternetAddressType, tFTPServerPortNumber=tFTPServerPortNumber, licenseBandwidthCap=licenseBandwidthCap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyControl=phyControl, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControlGroup=aAAControlGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseSecurityLevel=licenseSecurityLevel, dNSServerTableIndex=dNSServerTableIndex, sFPPortStatus=sFPPortStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, remoteMACAddress=remoteMACAddress, configuration=configuration, licenseGroup=licenseGroup, licenseCountry=licenseCountry, vLANManagementVID=vLANManagementVID, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, userTableIndex=userTableIndex, authorizationMethod=authorizationMethod, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitChannel=transmitChannel, licenseSyncESupport=licenseSyncESupport, tDDControl=tDDControl, syncEEquipmentClock=syncEEquipmentClock, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, maxLinkRangeExceeded=maxLinkRangeExceeded, groupID=groupID, dNSServerTableEntry=dNSServerTableEntry, installArmState=installArmState, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, notificationsGroup=notificationsGroup, lowestTDMModulationMode=lowestTDMModulationMode, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, receiveDataRate=receiveDataRate, ethernet=ethernet, phyInstancedStatusTable=phyInstancedStatusTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogState=syslogState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, remoteInternetAddressLinked=remoteInternetAddressLinked, sNTPServerTable=sNTPServerTable, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tFTPClient=tFTPClient, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, oOBPriorityQueueMapping=oOBPriorityQueueMapping, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, pubStatsGroup=pubStatsGroup, byteErrorRatio=byteErrorRatio, frequencyVariant=frequencyVariant, cableDiagPair1Distance=cableDiagPair1Distance, tDMChannelLoopback=tDMChannelLoopback, linkModeOptimization=linkModeOptimization, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, installStatus=installStatus, sFPPortAutoMdix=sFPPortAutoMdix, phyControlGroup=phyControlGroup, remoteInternetAddress=remoteInternetAddress, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, dNSResolver=dNSResolver, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, snmpControlGroup=snmpControlGroup, mABState=mABState, ethernetInstancedTableEntry=ethernetInstancedTableEntry, timeZone=timeZone, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, userPassword=userPassword, syslogControl=syslogControl, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, cambium=cambium, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, configurationInstancedTableNumber=configurationInstancedTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, authorizationControlTableEntry=authorizationControlTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortStatusTrap=mainPSUPortStatusTrap, iPv6PrefixLength=iPv6PrefixLength, transmitPower=transmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, resetGroup=resetGroup, sNTPServerStatus=sNTPServerStatus, softwareVersion=softwareVersion, remoteMACAddressLinked=remoteMACAddressLinked, transmitDataRateLinked=transmitDataRateLinked, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, transmitFreqMHz=transmitFreqMHz, nIDULanPortStatusTrap=nIDULanPortStatusTrap, license=license, syncESlavePort=syncESlavePort, dfsTable=dfsTable, dfs=dfs, capacityVariantMismatchTrap=capacityVariantMismatchTrap, configurationGroup=configurationGroup, receiveModulationModeDetail=receiveModulationModeDetail, unitIdentificationGroup=unitIdentificationGroup, portAllocationMismatchLinked=portAllocationMismatchLinked, configurationInstancedTableIndex=configurationInstancedTableIndex, pubStats=pubStats, licenseSFPPortSupport=licenseSFPPortSupport, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitModulationModeLinked=transmitModulationModeLinked, deviceMSN=deviceMSN, versions=versions, dfsTableEntry=dfsTableEntry, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rxColorCode=rxColorCode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, tdmTableIndex=tdmTableIndex, authorizationControlTable=authorizationControlTable, pubInstancedStatsTable=pubInstancedStatsTable, mgmtInstancedTableNumber=mgmtInstancedTableNumber, unavailableSeconds=unavailableSeconds, userTableEntry=userTableEntry, mABNominalModulationMode=mABNominalModulationMode, subbandHighestFrequency=subbandHighestFrequency, sNMPTrapTableIndex=sNMPTrapTableIndex, targetRange=targetRange, tDMChannelStatusTrap=tDMChannelStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, maximumTransmitPower=maximumTransmitPower, bridgeGroup=bridgeGroup, dSCPManagementPriority=dSCPManagementPriority, syncETrackingState=syncETrackingState, phyStatusGroup=phyStatusGroup, sNTPServerTimeout=sNTPServerTimeout, latitude=latitude, sFPPortAllocation=sFPPortAllocation, encryptionAlgorithm=encryptionAlgorithm, dfsTableNumber=dfsTableNumber, aggregateDataRate=aggregateDataRate, dNSServerInternetAddress=dNSServerInternetAddress, remoteUnitName=remoteUnitName, dNSServerTable=dNSServerTable, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseGroupAccess=licenseGroupAccess, ptp670=ptp670, hTTPSPortNumber=hTTPSPortNumber, snmpControl=snmpControl, sMTPServerPortNumber=sMTPServerPortNumber, transmitterChannels=transmitterChannels, licenseMaxLinkRange=licenseMaxLinkRange, dataBridgingStatusAlarm=dataBridgingStatusAlarm, tDMChannelCableLength=tDMChannelCableLength, deviceESN=deviceESN, sFPPortQLRx=sFPPortQLRx, userTable=userTable, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, tFTPServerInternetAddressType=tFTPServerInternetAddressType, packetsToInternalStack=packetsToInternalStack, bootVersion=bootVersion, telnetAccessEnabled=telnetAccessEnabled, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sMTPEmailAlert=sMTPEmailAlert)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", useVLANForMABProtocol=useVLANForMABProtocol, licenseTLSRekey=licenseTLSRekey, range=range, dNSGroup=dNSGroup, iPv4Address=iPv4Address, eIRP=eIRP, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, aAAControl=aAAControl, wirelessLinkStatusLinked=wirelessLinkStatusLinked, systemClock=systemClock, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, txMABFrames=txMABFrames, auxPortAllocation=auxPortAllocation, ptp=ptp, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, cableDiagPair4Results=cableDiagPair4Results, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagnosticsPorts=cableDiagnosticsPorts, sNMPTrapVersion=sNMPTrapVersion, configurationInstancedTable=configurationInstancedTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, extendedSpectrumScanning=extendedSpectrumScanning, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, transmitFreqKHz=transmitFreqKHz, bridge=bridge, alarms=alarms, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPDSCPPriorityTable=iPDSCPPriorityTable, licenseInstancedTable=licenseInstancedTable, sNTPPollInterval=sNTPPollInterval, sFPError=sFPError, encryptionGroup=encryptionGroup, mainPSUPortStatus=mainPSUPortStatus, tDMChannelLineCode=tDMChannelLineCode, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, auxPortSyncERxStatus=auxPortSyncERxStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, l2CPPriorityTableEntry=l2CPPriorityTableEntry, authorizationControlTableIndex=authorizationControlTableIndex, mABTransmissionInterval=mABTransmissionInterval, dNSPrimaryServer=dNSPrimaryServer, secureModeAlarmTrap=secureModeAlarmTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sntpGroup=sntpGroup, authorizationControl=authorizationControl, sNTPServerTableEntry=sNTPServerTableEntry, apc=apc, sntp=sntp, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, cableDiagPair2Distance=cableDiagPair2Distance, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, localPacketFiltering=localPacketFiltering)
