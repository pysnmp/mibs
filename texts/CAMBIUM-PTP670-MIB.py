...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tdmTableEntry=tdmTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, wirelessOutOctets=wirelessOutOctets, licenseGroup=licenseGroup, dfsTableNumber=dfsTableNumber, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mABProtocolVLANPriority=mABProtocolVLANPriority, l2CPPriorityTableNumber=l2CPPriorityTableNumber, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, rangeLinked=rangeLinked, tFTPServerPortNumber=tFTPServerPortNumber, userRole=userRole, transparentClockVLAN=transparentClockVLAN, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, pubStatsGroup=pubStatsGroup, longitude=longitude, sMTPSourceEmailAddress=sMTPSourceEmailAddress, unitOutOfCalibration=unitOutOfCalibration, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataBridgingStatusAlarm=dataBridgingStatusAlarm, systemClock=systemClock, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNMPTrapTableEntry=sNMPTrapTableEntry, alarmInstancedTableEntry=alarmInstancedTableEntry, receiveModulationModeLinked=receiveModulationModeLinked, maximumNumberOfSlaves=maximumNumberOfSlaves, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseGasGroup=licenseGasGroup, userTableEntry=userTableEntry, productVariant=productVariant, txMABFrames=txMABFrames, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, authorizationControlGroup=authorizationControlGroup, sFPPortQLTx=sFPPortQLTx, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sFPError=sFPError, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telnetPortNumber=telnetPortNumber, installArmState=installArmState, cableDiagPair2Distance=cableDiagPair2Distance, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, phyStatusGroup=phyStatusGroup, cableDiagPair3Results=cableDiagPair3Results, nIDULanPortStatus=nIDULanPortStatus, authorizationControl=authorizationControl, lbtDetectedTrap=lbtDetectedTrap, sNTPSyncTrap=sNTPSyncTrap, cableDiagPair2Results=cableDiagPair2Results, tDMConfigurationMismatch=tDMConfigurationMismatch, sNMPTrapTable=sNMPTrapTable, mainPSUPortQLRx=mainPSUPortQLRx, sFPPortAutoNegotiation=sFPPortAutoNegotiation, tDMChannelStatusTrap=tDMChannelStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, signalStrengthRatio=signalStrengthRatio, dNSServerTableNumber=dNSServerTableNumber, capacityVariantMismatchTrap=capacityVariantMismatchTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, secureModeAlarm=secureModeAlarm, dfsTable=dfsTable, receiveChannel=receiveChannel, sNMPEnabledTraps=sNMPEnabledTraps, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, cableDiagPair4Results=cableDiagPair4Results, sFPPortStatusTrap=sFPPortStatusTrap, licenseTLSRekey=licenseTLSRekey, licenseHCMPSupport=licenseHCMPSupport, ethernetStatisticsTable=ethernetStatisticsTable, portAllocationMismatch=portAllocationMismatch, configurationInstancedTableIndex=configurationInstancedTableIndex, alarmInstancedTableNumber=alarmInstancedTableNumber, syslogControl=syslogControl, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, mgmtInstancedTable=mgmtInstancedTable, ptp670=ptp670, tdmTableNumber=tdmTableNumber, userTableNumber=userTableNumber, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, syncEEquipmentClock=syncEEquipmentClock, targetMACAddress=targetMACAddress, portAllocationMismatchTrap=portAllocationMismatchTrap, unavailableSeconds=unavailableSeconds, transparentClock=transparentClock, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationMode=receiveModulationMode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transmitDataRateLinked=transmitDataRateLinked, syslogStateTrap=syslogStateTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitPowerLinked=transmitPowerLinked, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, dfsTableEntry=dfsTableEntry, subbandHighestFrequency=subbandHighestFrequency, sNMPTrapTableIndex=sNMPTrapTableIndex, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dfsMeans=dfsMeans, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, transmitPower=transmitPower, licenseCountry=licenseCountry, targetRange=targetRange, alarms=alarms, unitIdentificationGroup=unitIdentificationGroup, sNTPState=sNTPState, cableDiagPair1Results=cableDiagPair1Results, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, configurationInstancedTableNumber=configurationInstancedTableNumber, encryptionGroup=encryptionGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, masterSlaveMode=masterSlaveMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, deviceMACAddress=deviceMACAddress, linkModeOptimization=linkModeOptimization, dNS=dNS, ptp=ptp, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, capacityVariantMismatchLinked=capacityVariantMismatchLinked, tDMInterfaceControl=tDMInterfaceControl, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, packetsToInternalStack=packetsToInternalStack, channelBandwidth=channelBandwidth, telnetAccessEnabled=telnetAccessEnabled, linkSymmetry=linkSymmetry, sNTPServerTableIndex=sNTPServerTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, qOSPriorityScheme=qOSPriorityScheme, licenseIEEE1588Support=licenseIEEE1588Support, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, licenseIPv6Support=licenseIPv6Support, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, routerProtocols=routerProtocols, mainPSUPortQLTx=mainPSUPortQLTx, hCMPMaximumLinkRange=hCMPMaximumLinkRange, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, smtpGroup=smtpGroup, sNTPServerRetries=sNTPServerRetries, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRateLinked=aggregateDataRateLinked, dataBridgingAvailability=dataBridgingAvailability, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, antennaGain=antennaGain, dataPortPauseFrames=dataPortPauseFrames, dNSServerTableIndex=dNSServerTableIndex, dNSPrimaryServer=dNSPrimaryServer, tDDControlGroup=tDDControlGroup, rxColorCode=rxColorCode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, hCMPLinkSymmetry=hCMPLinkSymmetry, syslogState=syslogState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, auxPortAllocation=auxPortAllocation, dNSServerTable=dNSServerTable, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, licenseTrialPeriod=licenseTrialPeriod, apcGroup=apcGroup, vLANManagementPriority=vLANManagementPriority, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, searchState=searchState, aAAControl=aAAControl, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, subnetMask=subnetMask, dataBridgingStatus=dataBridgingStatus, receiveFreqMHz=receiveFreqMHz, aAAControlGroup=aAAControlGroup, range=range, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, encryption=encryption, ethernetInstancedTableIndex=ethernetInstancedTableIndex, remoteMACAddressLinked=remoteMACAddressLinked, authorizationControlTable=authorizationControlTable, auxPortSSMTx=auxPortSSMTx, wirelessLinkStatusLinked=wirelessLinkStatusLinked, cableDiagnostics=cableDiagnostics, tDMChannelStatus=tDMChannelStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tdmTable=tdmTable, mgmtInstancedTableIndex=mgmtInstancedTableIndex, timeZone=timeZone, altitude=altitude, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sFPPortQLRx=sFPPortQLRx, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, installStatusTrap=installStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, aggregateDataRate=aggregateDataRate, alarmsGroup=alarmsGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, subbandLowestFrequency=subbandLowestFrequency, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, ptmp=ptmp, cableDiagPair1Distance=cableDiagPair1Distance, deviceMSN=deviceMSN, tDMEnabledChannels=tDMEnabledChannels, PYSNMP_MODULE_ID=cambium, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, transparentClockPort=transparentClockPort, syncETracking=syncETracking, dNSServerInternetAddress=dNSServerInternetAddress, vectorError=vectorError, mABTransmissionInterval=mABTransmissionInterval, ethernetInstancedTableNumber=ethernetInstancedTableNumber, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sFPPortDisabledWarning=sFPPortDisabledWarning, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, linkLoss=linkLoss, byteErrorRatioLinked=byteErrorRatioLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, hardwareVersion=hardwareVersion, licenseInstancedTableNumber=licenseInstancedTableNumber, cableLoss=cableLoss, phyControlGroup=phyControlGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, pubStats=pubStats, licenseInstancedTableEntry=licenseInstancedTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, sNTPPollInterval=sNTPPollInterval, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, supplementary=supplementary)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", authorizationControlTableEntry=authorizationControlTableEntry, localPacketFiltering=localPacketFiltering, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, siteName=siteName, pubInstancedStatsTable=pubInstancedStatsTable, installStatusLinked=installStatusLinked, licenseOOBManagementSupport=licenseOOBManagementSupport, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsGroup=dfsGroup, syslogClient=syslogClient, linkLossLinked=linkLossLinked, mABProtocolVID=mABProtocolVID, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, hTTPSAccessEnabled=hTTPSAccessEnabled, sntpGroup=sntpGroup, tDM=tDM, auxPortDisabledWarning=auxPortDisabledWarning, severelyErroredSeconds=severelyErroredSeconds, unitName=unitName, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, regulatoryBand=regulatoryBand, authorizationMethod=authorizationMethod, installArmStateTrap=installArmStateTrap, sNTPServerStatus=sNTPServerStatus, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, cableDiagnosticsControl=cableDiagnosticsControl, wirelessLinkAvailability=wirelessLinkAvailability, remoteInternetAddressType=remoteInternetAddressType, licenseMaxLinkRange=licenseMaxLinkRange, transmitChannel=transmitChannel, ptpCompliance=ptpCompliance, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sNTPServerTable=sNTPServerTable, mainPSUPortStatus=mainPSUPortStatus, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, licenseSFPPortSupport=licenseSFPPortSupport, signalStrengthRatioLinked=signalStrengthRatioLinked, cableDiagnosticsWarning=cableDiagnosticsWarning, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, cableDiagPair3Distance=cableDiagPair3Distance, bridge=bridge, configurationInstancedTable=configurationInstancedTable, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, userTableIndex=userTableIndex, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, unitIdentification=unitIdentification, ethernetInstancedTable=ethernetInstancedTable, phyControl=phyControl, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ethernet=ethernet, dataBridgingStatusLinked=dataBridgingStatusLinked, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, configurationGroup=configurationGroup, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetStatisticsDataSource=ethernetStatisticsDataSource, managementGroup=managementGroup, hTTPAccessEnabled=hTTPAccessEnabled, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, erroredSeconds=erroredSeconds, latitude=latitude, mainPSUPortStatusTrap=mainPSUPortStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, enableTransmission=enableTransmission, groupID=groupID, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, dNSServerInternetAddressType=dNSServerInternetAddressType, auxPortAcceptedQLRx=auxPortAcceptedQLRx, licenseRegulatoryBandsList=licenseRegulatoryBandsList, blacklistRMEnabled=blacklistRMEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, receiveFreqKHz=receiveFreqKHz, authorizationControlTableIndex=authorizationControlTableIndex, configuration=configuration, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, userEnabled=userEnabled, mgmtInstancedTableEntry=mgmtInstancedTableEntry, linkName=linkName, tDMChannelCableLength=tDMChannelCableLength, cableDiagnosticsGroup=cableDiagnosticsGroup, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, auxPortStatus=auxPortStatus, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, lowestTDMModulationMode=lowestTDMModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, useVLANForManagementInterfaces=useVLANForManagementInterfaces, alarmInstancedTable=alarmInstancedTable, license=license, licenseIssueNumber=licenseIssueNumber, whitelistRMMacAddress=whitelistRMMacAddress, portAllocationMismatchLinked=portAllocationMismatchLinked, maxLinkRangeExceeded=maxLinkRangeExceeded, sNMPPortNumber=sNMPPortNumber, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, apc=apc, sNTPServerTimeout=sNTPServerTimeout, antennaSelection=antennaSelection, remoteMACAddress=remoteMACAddress, dNSServerTableEntry=dNSServerTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemReset=systemReset, dNSResolver=dNSResolver, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sFPPortStatus=sFPPortStatus, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, regulatoryBandTrap=regulatoryBandTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, smtp=smtp, productName=productName, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseGroupAccess=licenseGroupAccess, sNTPSync=sNTPSync, byteErrorRatio=byteErrorRatio, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, ptpTraps=ptpTraps, licenseInstancedTableIndex=licenseInstancedTableIndex, versionsGroup=versionsGroup, licenseRARSupport=licenseRARSupport, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, transmitDataRate=transmitDataRate, transmitterChannels=transmitterChannels, snmpControlGroup=snmpControlGroup, syslogClientTrap=syslogClientTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTable=l2CPPriorityTable, mgmtInstancedTableNumber=mgmtInstancedTableNumber, auxPortQLRx=auxPortQLRx, tDMInterfaceStatus=tDMInterfaceStatus, snmpControl=snmpControl, phyControlInstancedTableEntry=phyControlInstancedTableEntry, softwareVersion=softwareVersion, licenseCapacity=licenseCapacity, dfsPeaks=dfsPeaks, mABNominalModulationMode=mABNominalModulationMode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseSyncESupport=licenseSyncESupport, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, remoteInternetAddress=remoteInternetAddress, receiveDataRateLinked=receiveDataRateLinked, wirelessTopology=wirelessTopology, supplementaryGroup=supplementaryGroup, remoteUnitNameLinked=remoteUnitNameLinked, lowestDataModulationMode=lowestDataModulationMode, reset=reset, secureModeAlarmTrap=secureModeAlarmTrap, cambium=cambium, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, rawReceivePowerLinked=rawReceivePowerLinked, transmitModulationModeLinked=transmitModulationModeLinked, ethernetPriorityTable=ethernetPriorityTable, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, licenseSecurityLevel=licenseSecurityLevel, channelChangeTrap=channelChangeTrap, sNMPCommunityString=sNMPCommunityString, auxPortStatusTrap=auxPortStatusTrap, syncETrackingState=syncETrackingState, tDMGroup=tDMGroup, licenseVersion=licenseVersion, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, packetsFromInternalStack=packetsFromInternalStack, tDDControl=tDDControl, installStatus=installStatus, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, phyControlInstancedTableNumber=phyControlInstancedTableNumber, deviceESN=deviceESN, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, tDDSynchronizationMode=tDDSynchronizationMode, transparentClockVID=transparentClockVID, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, dNSServerPortNumber=dNSServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, iPv4Address=iPv4Address, bootVersion=bootVersion, cableDiagnosticsPorts=cableDiagnosticsPorts, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPSPortNumber=hTTPSPortNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mABHoldoffPeriod=mABHoldoffPeriod, ethernetInstancedTableEntry=ethernetInstancedTableEntry, hTTPPortNumber=hTTPPortNumber, licenseBandwidthCap=licenseBandwidthCap, rawReceivePower=rawReceivePower, sNMPv3Enable=sNMPv3Enable, auxPortConfigurationMismatch=auxPortConfigurationMismatch, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkStatus=wirelessLinkStatus, transmitFreqKHz=transmitFreqKHz, mABMaintenanceLevel=mABMaintenanceLevel, tDMChannelLineCode=tDMChannelLineCode, phyControlInstancedTable=phyControlInstancedTable, notificationsGroup=notificationsGroup, iPVersion=iPVersion, ptpTrapPrefix=ptpTrapPrefix, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitModulationMode=transmitModulationMode, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseInstancedTable=licenseInstancedTable, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, management=management, ptpGroups=ptpGroups, vLANManagementVID=vLANManagementVID, phyInstancedStatusTable=phyInstancedStatusTable, whitelistRMEnabled=whitelistRMEnabled, userName=userName, dfs=dfs, oOBPriorityQueueMapping=oOBPriorityQueueMapping, receivePower=receivePower, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, syncESlavePort=syncESlavePort, frequencyVariant=frequencyVariant, mainPSUPortSSMTx=mainPSUPortSSMTx, sntp=sntp, licenseTDDSyncSupport=licenseTDDSyncSupport, cableDiagPair4Distance=cableDiagPair4Distance, sFPPortSSMTx=sFPPortSSMTx, sNTPServerTableNumber=sNTPServerTableNumber, searchStateLinked=searchStateLinked, sNTPPrimaryServer=sNTPPrimaryServer, tempPcb=tempPcb, blacklistRMMacAddress=blacklistRMMacAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerInternetAddressType=sMTPServerInternetAddressType, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, useVLANForMABProtocol=useVLANForMABProtocol, capacityVariantMismatch=capacityVariantMismatch, vectorErrorLinked=vectorErrorLinked, receivePowerLinked=receivePowerLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, rangingMode=rangingMode, dSCPManagementPriority=dSCPManagementPriority, transmitFreqMHz=transmitFreqMHz, sFPErrorTrap=sFPErrorTrap, ethernetGroup=ethernetGroup, resetGroup=resetGroup, syslogControlGroup=syslogControlGroup, mainPSUPortAllocation=mainPSUPortAllocation, bridgeGroup=bridgeGroup, daylightSaving=daylightSaving, txColorCode=txColorCode, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, auxPortQLTx=auxPortQLTx, sNTPServerTableEntry=sNTPServerTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mABState=mABState, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tdmTableIndex=tdmTableIndex, versions=versions, remoteUnitName=remoteUnitName, licenseEncryption=licenseEncryption, phyStatus=phyStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, secondarySoftwareVersion=secondarySoftwareVersion, tDMChannelLoopback=tDMChannelLoopback, accessMethod=accessMethod, iPv6Address=iPv6Address, tFTPClient=tFTPClient, alarmInstancedTableIndex=alarmInstancedTableIndex, wirelessOutAllOctets=wirelessOutAllOctets, maximumTransmitPower=maximumTransmitPower, sFPPortAutoMdix=sFPPortAutoMdix, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, userPassword=userPassword, eIRP=eIRP, sNTPLastSync=sNTPLastSync, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, authorizationControlTableNumber=authorizationControlTableNumber, installationMode=installationMode, iPv6PrefixLength=iPv6PrefixLength, userTable=userTable, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, receiveDataRate=receiveDataRate, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sFPPortAllocation=sFPPortAllocation, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, routerProtocolsGroup=routerProtocolsGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteInternetAddressLinked=remoteInternetAddressLinked, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, dfsTableIndex=dfsTableIndex, dNSGroup=dNSGroup)
