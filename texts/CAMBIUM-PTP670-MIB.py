...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseSFPPortSupport=licenseSFPPortSupport, altitude=altitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, tDMChannelLoopback=tDMChannelLoopback, hTTPAccessEnabled=hTTPAccessEnabled, cableDiagnosticsResultTable=cableDiagnosticsResultTable, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, tFTPServerInternetAddressType=tFTPServerInternetAddressType, maxLinkRangeExceeded=maxLinkRangeExceeded, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, userRole=userRole, sFPPortAutoNegotiation=sFPPortAutoNegotiation, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, sNTPPollInterval=sNTPPollInterval, wirelessLinkStatus=wirelessLinkStatus, mABTransmissionInterval=mABTransmissionInterval, deviceMACAddress=deviceMACAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sFPPortQLRx=sFPPortQLRx, mainPSUPortQLRx=mainPSUPortQLRx, userTableEntry=userTableEntry, dataBridgingStatus=dataBridgingStatus, cableDiagPair4Distance=cableDiagPair4Distance, aAAControl=aAAControl, lowestTDMModulationMode=lowestTDMModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, telnetPortNumber=telnetPortNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, ethernetPriorityTableEntry=ethernetPriorityTableEntry, snmpControlGroup=snmpControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dNSServerTable=dNSServerTable, management=management, dataBridgingAvailability=dataBridgingAvailability, ptp670=ptp670, remoteInternetAddressLinked=remoteInternetAddressLinked, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telnetAccessEnabled=telnetAccessEnabled, phyControlInstancedTableIndex=phyControlInstancedTableIndex, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, useVLANForMABProtocol=useVLANForMABProtocol, unitIdentification=unitIdentification, pubStats=pubStats, syncESlavePort=syncESlavePort, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, routerProtocolsGroup=routerProtocolsGroup, receiveModulationMode=receiveModulationMode, tDMEnabledChannels=tDMEnabledChannels, ethernetStatisticsTable=ethernetStatisticsTable, rawReceivePower=rawReceivePower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPSPortNumber=hTTPSPortNumber, ethernetGroup=ethernetGroup, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, cableDiagnostics=cableDiagnostics, sNTPServerTableEntry=sNTPServerTableEntry, cableDiagnosticsGroup=cableDiagnosticsGroup, mgmtInstancedTable=mgmtInstancedTable, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, linkModeOptimization=linkModeOptimization, dNSServerTableEntry=dNSServerTableEntry, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, vLANManagementVID=vLANManagementVID, cableDiagnosticsWarning=cableDiagnosticsWarning, notificationsGroup=notificationsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, receivePowerLinked=receivePowerLinked, userEnabled=userEnabled, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, localPacketFiltering=localPacketFiltering, sNTPServerStatus=sNTPServerStatus, mABProtocolVLANPriority=mABProtocolVLANPriority, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsPeaks=dfsPeaks, bridgeGroup=bridgeGroup, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseCapacity=licenseCapacity, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, syslogControlGroup=syslogControlGroup, userTableIndex=userTableIndex, authorizationControl=authorizationControl, eIRP=eIRP, sMTPEnabledMessages=sMTPEnabledMessages, dfsTable=dfsTable, hCMPMaximumLinkRange=hCMPMaximumLinkRange, dfs=dfs, cableDiagPair3Distance=cableDiagPair3Distance, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, configurationInstancedTableEntry=configurationInstancedTableEntry, sFPError=sFPError, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseTLSRekey=licenseTLSRekey, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, latitude=latitude, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseCountry=licenseCountry, transmitChannel=transmitChannel, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, unitName=unitName, licenseInstancedTableIndex=licenseInstancedTableIndex, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, smtp=smtp, sFPErrorTrap=sFPErrorTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mABProtocolVID=mABProtocolVID, encryption=encryption, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, receivePower=receivePower, byteErrorRatio=byteErrorRatio, aggregateDataRateLinked=aggregateDataRateLinked, aggregateDataRate=aggregateDataRate, sNTPServerTimeout=sNTPServerTimeout, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, dNSGroup=dNSGroup, nIDULanPortStatus=nIDULanPortStatus, dNS=dNS, transparentClockVID=transparentClockVID, sNTPSyncTrap=sNTPSyncTrap, linkName=linkName, licenseUnitSerialNumber=licenseUnitSerialNumber, receiveFreqMHz=receiveFreqMHz, signalStrengthRatio=signalStrengthRatio, l2CPPriorityTable=l2CPPriorityTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, auxPortQLTx=auxPortQLTx, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ptpTraps=ptpTraps, maximumTransmitPower=maximumTransmitPower, sNTPServerPortNumber=sNTPServerPortNumber, tdmTableIndex=tdmTableIndex, syncEEquipmentClock=syncEEquipmentClock, sNTPServerTable=sNTPServerTable, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sntp=sntp, dNSServerTableIndex=dNSServerTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, remoteInternetAddressType=remoteInternetAddressType, transmitFreqKHz=transmitFreqKHz, sNTPServerRetries=sNTPServerRetries, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, phyControlGroup=phyControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transparentClockVLAN=transparentClockVLAN, mABNominalModulationMode=mABNominalModulationMode, packetsFromInternalStack=packetsFromInternalStack, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteInternetAddress=remoteInternetAddress, vectorError=vectorError, authorizationControlTableIndex=authorizationControlTableIndex, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, installStatus=installStatus, ptpGroups=ptpGroups, phyStatusGroup=phyStatusGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, authorizationControlTable=authorizationControlTable, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sNTPPrimaryServer=sNTPPrimaryServer, ethernetInstancedTableIndex=ethernetInstancedTableIndex, wirelessOutAllOctets=wirelessOutAllOctets, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPServerPortNumber=tFTPServerPortNumber, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, cableDiagPair1Distance=cableDiagPair1Distance, auxPortStatus=auxPortStatus, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, bridge=bridge, receiveModulationModeDetail=receiveModulationModeDetail, dfsTableNumber=dfsTableNumber, transmitModulationMode=transmitModulationMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseInstancedTable=licenseInstancedTable, unavailableSeconds=unavailableSeconds, auxPortSyncERxStatus=auxPortSyncERxStatus, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sFPPortStatusTrap=sFPPortStatusTrap, configurationInstancedTableNumber=configurationInstancedTableNumber, longitude=longitude, wirelessLinkStatusLinked=wirelessLinkStatusLinked, licenseBandwidthCap=licenseBandwidthCap, deviceESN=deviceESN, encryptionAlgorithm=encryptionAlgorithm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, gatewayIPAddress=gatewayIPAddress, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, auxPortSSMTx=auxPortSSMTx, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMACAddressLinked=remoteMACAddressLinked, licenseMaxLinkRange=licenseMaxLinkRange, remoteMACAddress=remoteMACAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hCMPLinkSymmetry=hCMPLinkSymmetry, capacityVariantMismatch=capacityVariantMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, tDMChannelCableLength=tDMChannelCableLength, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tdmTable=tdmTable, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, dfsMeans=dfsMeans, wirelessLinkAvailability=wirelessLinkAvailability, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mABMaintenanceLevel=mABMaintenanceLevel, installStatusLinked=installStatusLinked, configurationInstancedTable=configurationInstancedTable, licenseRARSupport=licenseRARSupport, linkLoss=linkLoss, sNMPEnabledTraps=sNMPEnabledTraps, ptp=ptp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, deviceMSN=deviceMSN, sntpGroup=sntpGroup, encryptionGroup=encryptionGroup, installArmStateTrap=installArmStateTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, supplementaryGroup=supplementaryGroup, syncETracking=syncETracking, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, pubStatsGroup=pubStatsGroup, cableDiagPair4Results=cableDiagPair4Results, receiveDataRateLinked=receiveDataRateLinked, signalStrengthRatioLinked=signalStrengthRatioLinked, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseIPv6Support=licenseIPv6Support, auxPortAllocation=auxPortAllocation, targetRange=targetRange, installationMode=installationMode, searchStateLinked=searchStateLinked, apc=apc)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sMTPServerPortNumber=sMTPServerPortNumber, sFPPortAutoMdix=sFPPortAutoMdix, txMABFrames=txMABFrames, ethernet=ethernet, receiveDataRate=receiveDataRate, sNTPLastSync=sNTPLastSync, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, dNSServerInternetAddressType=dNSServerInternetAddressType, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessOutOctets=wirelessOutOctets, lowestDataModulationMode=lowestDataModulationMode, regulatoryBandTrap=regulatoryBandTrap, dNSResolver=dNSResolver, cableDiagPair3Results=cableDiagPair3Results, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, byteErrorRatioLinked=byteErrorRatioLinked, packetsToInternalStack=packetsToInternalStack, cableDiagPair2Results=cableDiagPair2Results, tDMInterfaceControl=tDMInterfaceControl, apcGroup=apcGroup, cableDiagPair2Distance=cableDiagPair2Distance, auxPortQLRx=auxPortQLRx, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, phyControl=phyControl, systemReset=systemReset, sNTPServerTableNumber=sNTPServerTableNumber, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, transmitDataRateLinked=transmitDataRateLinked, managementGroup=managementGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, masterSlaveMode=masterSlaveMode, alarmInstancedTableNumber=alarmInstancedTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, rangingMode=rangingMode, groupID=groupID, licenseTrialPeriod=licenseTrialPeriod, phyInstancedStatusTable=phyInstancedStatusTable, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, transmitDataRate=transmitDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, whitelistRMMacAddress=whitelistRMMacAddress, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tDMInterfaceStatus=tDMInterfaceStatus, licenseEncryption=licenseEncryption, whitelistRMEnabled=whitelistRMEnabled, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, softwareVersion=softwareVersion, versionsGroup=versionsGroup, auxPortDisabledWarning=auxPortDisabledWarning, iPv4Address=iPv4Address, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, configurationInstancedTableIndex=configurationInstancedTableIndex, tFTPClient=tFTPClient, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, authorizationControlGroup=authorizationControlGroup, dfsGroup=dfsGroup, smtpGroup=smtpGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, productName=productName, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseGasGroup=licenseGasGroup, tDMChannelLineCode=tDMChannelLineCode, enableTransmission=enableTransmission, syslogState=syslogState, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, ethernetStatisticsDataSource=ethernetStatisticsDataSource, productVariant=productVariant, wirelessTopology=wirelessTopology, linkLossLinked=linkLossLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogStateTrap=syslogStateTrap, licenseHCMPSupport=licenseHCMPSupport, ethernetInstancedTable=ethernetInstancedTable, sFPPortQLTx=sFPPortQLTx, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, cableDiagnosticsControl=cableDiagnosticsControl, rxColorCode=rxColorCode, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, PYSNMP_MODULE_ID=cambium, tDDControl=tDDControl, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, tempPcb=tempPcb, tDDControlGroup=tDDControlGroup, vectorErrorLinked=vectorErrorLinked, timeZone=timeZone, antennaGain=antennaGain, auxPortStatusTrap=auxPortStatusTrap, syslogClient=syslogClient, alarmInstancedTable=alarmInstancedTable, userName=userName, licenseTDDSyncSupport=licenseTDDSyncSupport, searchState=searchState, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, phyControlInstancedTable=phyControlInstancedTable, channelBandwidth=channelBandwidth, remoteUnitNameLinked=remoteUnitNameLinked, rawReceivePowerLinked=rawReceivePowerLinked, sNTPServerInternetAddressType=sNTPServerInternetAddressType, aAAControlGroup=aAAControlGroup, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mainPSUPortStatusTrap=mainPSUPortStatusTrap, systemClock=systemClock, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sNMPCommunityString=sNMPCommunityString, erroredSeconds=erroredSeconds, configurationGroup=configurationGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, mPLSTCPriorityTable=mPLSTCPriorityTable, iPVersion=iPVersion, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, syslogClientTrap=syslogClientTrap, authorizationMethod=authorizationMethod, incompatibleMasterAndSlave=incompatibleMasterAndSlave, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sNTPServerTableIndex=sNTPServerTableIndex, userTable=userTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, subbandHighestFrequency=subbandHighestFrequency, userPassword=userPassword, receiveModulationModeLinked=receiveModulationModeLinked, sNTPServerInternetAddress=sNTPServerInternetAddress, secureModeAlarm=secureModeAlarm, snmpControl=snmpControl, dNSServerPortNumber=dNSServerPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, alarmsGroup=alarmsGroup, reset=reset, blacklistRMMacAddress=blacklistRMMacAddress, cableDiagPair1Results=cableDiagPair1Results, maximumNumberOfSlaves=maximumNumberOfSlaves, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, ptmp=ptmp, iPv6GatewayAddress=iPv6GatewayAddress, phyControlInstancedTableEntry=phyControlInstancedTableEntry, dfsTableIndex=dfsTableIndex, alarms=alarms, dNSServerTableNumber=dNSServerTableNumber, daylightSaving=daylightSaving, hardwareVersion=hardwareVersion, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, installStatusTrap=installStatusTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, licenseGroupAccess=licenseGroupAccess, unitOutOfCalibration=unitOutOfCalibration, receiveChannel=receiveChannel, configuration=configuration, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, transmitterChannels=transmitterChannels, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, dfsTableEntry=dfsTableEntry, ethernetInstancedTableNumber=ethernetInstancedTableNumber, tDMChannelStatus=tDMChannelStatus, licenseInstancedTableNumber=licenseInstancedTableNumber, auxPortConfigurationMismatch=auxPortConfigurationMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dSCPManagementPriority=dSCPManagementPriority, iPv6Address=iPv6Address, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, ptpCompliance=ptpCompliance, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, regulatoryBand=regulatoryBand, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, extendedSpectrumScanning=extendedSpectrumScanning, mainPSUPortQLTx=mainPSUPortQLTx, installArmState=installArmState, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sFPPortDisabledWarning=sFPPortDisabledWarning, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mABHoldoffPeriod=mABHoldoffPeriod, tDMChannelStatusTrap=tDMChannelStatusTrap, authorizationControlTableEntry=authorizationControlTableEntry, targetMACAddress=targetMACAddress, tdmTableNumber=tdmTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rangeLinked=rangeLinked, license=license, sFPPortStatus=sFPPortStatus, wirelessOutEthernetOctets=wirelessOutEthernetOctets, mainPSUPortAllocation=mainPSUPortAllocation, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, alarmInstancedTableIndex=alarmInstancedTableIndex, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenseIEEE1588Support=licenseIEEE1588Support, mgmtInstancedTableIndex=mgmtInstancedTableIndex, subnetMask=subnetMask, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, alarmInstancedTableEntry=alarmInstancedTableEntry, syslogControl=syslogControl, receiveFreqKHz=receiveFreqKHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPPortSSMTx=sFPPortSSMTx, cambium=cambium, qOSPriorityScheme=qOSPriorityScheme, licenseSecurityLevel=licenseSecurityLevel, tdmTableEntry=tdmTableEntry, vLANManagementPriority=vLANManagementPriority, siteName=siteName, transmitPower=transmitPower, secureModeAlarmTrap=secureModeAlarmTrap, accessMethod=accessMethod, mainPSUPortStatus=mainPSUPortStatus, mABState=mABState, syncETrackingState=syncETrackingState, licenseIssueNumber=licenseIssueNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ethernetInstancedTableEntry=ethernetInstancedTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, unitIdentificationGroup=unitIdentificationGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sNMPTrapTable=sNMPTrapTable, subbandLowestFrequency=subbandLowestFrequency, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ethernetPriorityTable=ethernetPriorityTable, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, antennaSelection=antennaSelection, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, dataPortPauseFrames=dataPortPauseFrames)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transmitModulationModeLinked=transmitModulationModeLinked, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, portAllocationMismatchLinked=portAllocationMismatchLinked, channelChangeTrap=channelChangeTrap, lbtDetectedTrap=lbtDetectedTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, transmitPowerLinked=transmitPowerLinked, bootVersion=bootVersion, sFPPortSyncERxStatus=sFPPortSyncERxStatus, severelyErroredSeconds=severelyErroredSeconds, sNTPState=sNTPState, versions=versions, useVLANForManagementInterfaces=useVLANForManagementInterfaces, routerProtocols=routerProtocols, authorizationControlTableNumber=authorizationControlTableNumber, sNMPPortNumber=sNMPPortNumber, resetGroup=resetGroup, iPv6PrefixLength=iPv6PrefixLength, blacklistRMEnabled=blacklistRMEnabled, capacityVariantMismatchTrap=capacityVariantMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transparentClock=transparentClock, remoteUnitName=remoteUnitName, ethernetPriorityTableNumber=ethernetPriorityTableNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, frequencyVariant=frequencyVariant, licenseSyncESupport=licenseSyncESupport, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, tDMGroup=tDMGroup, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, userTableNumber=userTableNumber, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, licenseGroup=licenseGroup, linkSymmetry=linkSymmetry, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseVersion=licenseVersion, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, ptpTrapPrefix=ptpTrapPrefix, pubInstancedStatsTable=pubInstancedStatsTable, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNMPv3Enable=sNMPv3Enable, tDM=tDM, txColorCode=txColorCode, dNSPrimaryServer=dNSPrimaryServer, portAllocationMismatch=portAllocationMismatch, cableLoss=cableLoss, sNMPTrapVersion=sNMPTrapVersion, supplementary=supplementary, auxPortAcceptedQLRx=auxPortAcceptedQLRx, range=range, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transparentClockPort=transparentClockPort, tFTPServerInternetAddress=tFTPServerInternetAddress, sFPPortAllocation=sFPPortAllocation, secondarySoftwareVersion=secondarySoftwareVersion, transmitFreqMHz=transmitFreqMHz, dNSServerInternetAddress=dNSServerInternetAddress, phyStatus=phyStatus)
