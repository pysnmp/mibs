...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sntp=sntp, sFPPortQLRx=sFPPortQLRx, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, bridge=bridge, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, phyControlInstancedTableIndex=phyControlInstancedTableIndex, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, transparentClockVID=transparentClockVID, managementGroup=managementGroup, tempPcb=tempPcb, maximumTransmitPower=maximumTransmitPower, licenseSyncESupport=licenseSyncESupport, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, unitOutOfCalibration=unitOutOfCalibration, tDMChannelStatusTrap=tDMChannelStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, mABProtocolVID=mABProtocolVID, installStatusTrap=installStatusTrap, encryptionGroup=encryptionGroup, rangingMode=rangingMode, phyControl=phyControl, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, remoteUnitNameLinked=remoteUnitNameLinked, blacklistRMMacAddress=blacklistRMMacAddress, auxPortSyncERxStatus=auxPortSyncERxStatus, sMTPServerPortNumber=sMTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessOutEthernetOctets=wirelessOutEthernetOctets, authorizationControlTableNumber=authorizationControlTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, subbandLowestFrequency=subbandLowestFrequency, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, capacityVariantMismatch=capacityVariantMismatch, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transparentClockPort=transparentClockPort, installArmState=installArmState, receiveFreqMHz=receiveFreqMHz, alarmsGroup=alarmsGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, cableDiagnosticsControl=cableDiagnosticsControl, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, mABNominalTransmitCapacity=mABNominalTransmitCapacity, managementPortWirelessDownAlert=managementPortWirelessDownAlert, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseTDDSyncSupport=licenseTDDSyncSupport, erroredSeconds=erroredSeconds, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, cableDiagPair3Results=cableDiagPair3Results, dNSServerPortNumber=dNSServerPortNumber, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, syncETrackingState=syncETrackingState, routerProtocols=routerProtocols, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sNMPEnabledTraps=sNMPEnabledTraps, userEnabled=userEnabled, managementNetworkAccessEnabled=managementNetworkAccessEnabled, deviceESN=deviceESN, auxPortQLTx=auxPortQLTx, dfsTableNumber=dfsTableNumber, dNSGroup=dNSGroup, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, cableDiagPair4Results=cableDiagPair4Results, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, PYSNMP_MODULE_ID=cambium, transparentClockVLAN=transparentClockVLAN, configurationInstancedTableNumber=configurationInstancedTableNumber, iPv6PrefixLength=iPv6PrefixLength, antennaGain=antennaGain, sNTPSyncTrap=sNTPSyncTrap, tDM=tDM, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, reset=reset, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetStatisticsTable=ethernetStatisticsTable, sNTPServerStatus=sNTPServerStatus, configurationGroup=configurationGroup, latitude=latitude, authorizationControlTable=authorizationControlTable, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, encryption=encryption, remoteMaximumTransmitPower=remoteMaximumTransmitPower, authorizationControlGroup=authorizationControlGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, secondarySoftwareVersion=secondarySoftwareVersion, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseEncryption=licenseEncryption, dataPortPauseFrames=dataPortPauseFrames, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, wirelessTopology=wirelessTopology, lowestTDMModulationMode=lowestTDMModulationMode, licenseSecurityLevel=licenseSecurityLevel, noWirelessChannelAvailable=noWirelessChannelAvailable, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receiveDataRate=receiveDataRate, sMTPEnabledMessages=sMTPEnabledMessages, dataBridgingStatusLinked=dataBridgingStatusLinked, productName=productName, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, phyControlInstancedTable=phyControlInstancedTable, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, longitude=longitude, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, unitName=unitName, dfsTableIndex=dfsTableIndex, dfsMeans=dfsMeans, sNTPPollInterval=sNTPPollInterval, dNSServerTable=dNSServerTable, smtpGroup=smtpGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, targetMACAddress=targetMACAddress, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseOOBManagementSupport=licenseOOBManagementSupport, signalStrengthRatio=signalStrengthRatio, pubStatsGroup=pubStatsGroup, masterSlaveMode=masterSlaveMode, supplementaryGroup=supplementaryGroup, mainPSUPortSSMTx=mainPSUPortSSMTx, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, remoteMACAddress=remoteMACAddress, alarmInstancedTableIndex=alarmInstancedTableIndex, wirelessOutOctets=wirelessOutOctets, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseGroupAccess=licenseGroupAccess, transmitFreqMHz=transmitFreqMHz, oOBPriorityQueueMapping=oOBPriorityQueueMapping, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteInternetAddressType=remoteInternetAddressType, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortDisabledWarning=sFPPortDisabledWarning, ethernetInstancedTableNumber=ethernetInstancedTableNumber, wirelessLinkStatus=wirelessLinkStatus, userTableNumber=userTableNumber, dNSServerInternetAddressType=dNSServerInternetAddressType, dNSServerTableNumber=dNSServerTableNumber, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tDMChannelLineCode=tDMChannelLineCode, searchStateLinked=searchStateLinked, mgmtInstancedTableNumber=mgmtInstancedTableNumber, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, cableDiagPair3Distance=cableDiagPair3Distance, dataBridgingStatus=dataBridgingStatus, installationMode=installationMode, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, linkLossLinked=linkLossLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, receiveModulationMode=receiveModulationMode, sNTPLastSync=sNTPLastSync, portAllocationMismatchTrap=portAllocationMismatchTrap, dNSServerTableIndex=dNSServerTableIndex, qOSPriorityScheme=qOSPriorityScheme, mABProtocolVLANPriority=mABProtocolVLANPriority, tDDSynchronizationMode=tDDSynchronizationMode, vLANManagementPriority=vLANManagementPriority, useVLANForMABProtocol=useVLANForMABProtocol, unitIdentification=unitIdentification, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, mABState=mABState, cableDiagPair2Results=cableDiagPair2Results, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, syncESlavePort=syncESlavePort, sFPPortStatusTrap=sFPPortStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDDControl=tDDControl, sNTPState=sNTPState, pubInstancedStatsTable=pubInstancedStatsTable, productVariant=productVariant, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, cableDiagPair4Distance=cableDiagPair4Distance, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetInstancedTable=ethernetInstancedTable, transmitPower=transmitPower, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sntpGroup=sntpGroup, authorizationControlTableEntry=authorizationControlTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mainPSUPortQLRx=mainPSUPortQLRx, userName=userName, whitelistRMEnabled=whitelistRMEnabled, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mainPSUPortQLTx=mainPSUPortQLTx, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, wirelessLinkStatusLinked=wirelessLinkStatusLinked, hTTPAccessEnabled=hTTPAccessEnabled, sFPError=sFPError, hTTPSPortNumber=hTTPSPortNumber, transmitModulationModeLinked=transmitModulationModeLinked, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, tDMGroup=tDMGroup, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, wirelessOutAllOctets=wirelessOutAllOctets, cableDiagnosticsGroup=cableDiagnosticsGroup, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sNMPTrapTable=sNMPTrapTable, ptmp=ptmp, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapVersion=sNMPTrapVersion, apcGroup=apcGroup, unitIdentificationGroup=unitIdentificationGroup, licenseCapacity=licenseCapacity, licenseSFPPortSupport=licenseSFPPortSupport, blacklistRMEnabled=blacklistRMEnabled, wirelessLinkAvailability=wirelessLinkAvailability, tdmTableIndex=tdmTableIndex, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, syslogClient=syslogClient, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, userTableIndex=userTableIndex, phyControlGroup=phyControlGroup, byteErrorRatio=byteErrorRatio, receivePower=receivePower, transmitModulationMode=transmitModulationMode, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, userPassword=userPassword, iPv4Address=iPv4Address, ethernetInstancedTableEntry=ethernetInstancedTableEntry, rangeLinked=rangeLinked, receiveModulationModeDetail=receiveModulationModeDetail, accessMethod=accessMethod, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, transmitDataRateLinked=transmitDataRateLinked, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syslogState=syslogState, tdmTable=tdmTable, mainPSUPortStatusTrap=mainPSUPortStatusTrap, notificationsGroup=notificationsGroup, dNSServerTableEntry=dNSServerTableEntry, licenseInstancedTableIndex=licenseInstancedTableIndex, tDMInterfaceStatus=tDMInterfaceStatus, licenseCountry=licenseCountry, portAllocationMismatch=portAllocationMismatch, dNSResolver=dNSResolver, packetsToInternalStack=packetsToInternalStack, timeZone=timeZone, nIDULanPortStatusTrap=nIDULanPortStatusTrap, alarmInstancedTable=alarmInstancedTable, sMTPEmailAlert=sMTPEmailAlert, syslogControl=syslogControl, altitude=altitude, regulatoryBand=regulatoryBand, lowestDataModulationMode=lowestDataModulationMode, frequencyVariant=frequencyVariant, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mABHoldoffPeriod=mABHoldoffPeriod, tDMChannelStatus=tDMChannelStatus, phyStatus=phyStatus, mABMaintenanceLevel=mABMaintenanceLevel, bridgeGroup=bridgeGroup, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, telnetAccessEnabled=telnetAccessEnabled, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, installStatus=installStatus, severelyErroredSeconds=severelyErroredSeconds, licenseHCMPSupport=licenseHCMPSupport, sNMPv3Enable=sNMPv3Enable, pubStats=pubStats, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mainPSUPortAllocation=mainPSUPortAllocation, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, mainPSUPortStatus=mainPSUPortStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ptpCompliance=ptpCompliance, authorizationControlTableIndex=authorizationControlTableIndex, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, hardwareVersion=hardwareVersion, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, transmitDataRate=transmitDataRate, auxPortQLRx=auxPortQLRx, auxPortDisabledWarning=auxPortDisabledWarning, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sNMPCommunityString=sNMPCommunityString, licenseTLSRekey=licenseTLSRekey, telnetPortNumber=telnetPortNumber, remoteUnitName=remoteUnitName, remoteInternetAddress=remoteInternetAddress, ptpGroups=ptpGroups, subnetMask=subnetMask, linkName=linkName, receivePowerLinked=receivePowerLinked, cableLoss=cableLoss, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, transmitPowerLinked=transmitPowerLinked, syslogStateTrap=syslogStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetGroup=ethernetGroup, vectorErrorLinked=vectorErrorLinked, sMTPSourceEmailAddress=sMTPSourceEmailAddress, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, ptpTraps=ptpTraps, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseIPv6Support=licenseIPv6Support, alarms=alarms, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseGasGroup=licenseGasGroup, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, daylightSaving=daylightSaving, transmitterChannels=transmitterChannels, phyInstancedStatusTable=phyInstancedStatusTable, ethernetPriorityTable=ethernetPriorityTable, mABTransmissionInterval=mABTransmissionInterval, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, configuration=configuration, sNTPServerTimeout=sNTPServerTimeout, deviceMSN=deviceMSN, configurationInstancedTable=configurationInstancedTable, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, whitelistRMMacAddress=whitelistRMMacAddress, auxPortStatus=auxPortStatus, cableDiagPair1Distance=cableDiagPair1Distance, dfs=dfs, phyStatusGroup=phyStatusGroup, license=license, aggregateDataRateLinked=aggregateDataRateLinked, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, rawReceivePowerLinked=rawReceivePowerLinked, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, l2CPPriorityTable=l2CPPriorityTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dNSPrimaryServer=dNSPrimaryServer, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dataBridgingAvailability=dataBridgingAvailability, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sFPErrorTrap=sFPErrorTrap, tFTPServerPortNumber=tFTPServerPortNumber, cableDiagPair1Results=cableDiagPair1Results, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, transparentClock=transparentClock, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPv6Address=iPv6Address, dfsPeaks=dfsPeaks, cableDiagPair2Distance=cableDiagPair2Distance, groupID=groupID, versionsGroup=versionsGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseIEEE1588Support=licenseIEEE1588Support, dNSServerInternetAddress=dNSServerInternetAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveFreqKHz=receiveFreqKHz, alarmInstancedTableNumber=alarmInstancedTableNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tDMInterfaceControl=tDMInterfaceControl, systemReset=systemReset, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, dSCPManagementPriority=dSCPManagementPriority, ptpTrapPrefix=ptpTrapPrefix, siteName=siteName, licenseGroup=licenseGroup, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, iPv6GatewayAddress=iPv6GatewayAddress, authorizationMethod=authorizationMethod, portAllocationMismatchLinked=portAllocationMismatchLinked, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, syslogClientTrap=syslogClientTrap, capacityVariantMismatchLinked=capacityVariantMismatchLinked, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, syncETracking=syncETracking, installStatusLinked=installStatusLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, ethernetStatisticsDataSource=ethernetStatisticsDataSource, txMABFrames=txMABFrames, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseUnitSerialNumber=licenseUnitSerialNumber, phyControlInstancedTableEntry=phyControlInstancedTableEntry, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseMaxLinkRange=licenseMaxLinkRange, maximumNumberOfSlaves=maximumNumberOfSlaves, hCMPLinkSymmetry=hCMPLinkSymmetry, licenseTrialPeriod=licenseTrialPeriod, dfsTable=dfsTable, byteErrorRatioLinked=byteErrorRatioLinked, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, iPVersion=iPVersion, userRole=userRole, sNMPPortNumber=sNMPPortNumber, licenseInstancedTableNumber=licenseInstancedTableNumber, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, secureModeAlarm=secureModeAlarm, targetRange=targetRange, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerTableEntry=sNTPServerTableEntry, authorizationControl=authorizationControl, licenseVersion=licenseVersion, auxPortSSMTx=auxPortSSMTx, tDDSynchronizationStatus=tDDSynchronizationStatus, cableDiagnostics=cableDiagnostics, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, regulatoryBandTrap=regulatoryBandTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sFPPortStatus=sFPPortStatus, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vLANManagementVID=vLANManagementVID, sFPPortQLTx=sFPPortQLTx, searchState=searchState, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sMTPServerInternetAddressType=sMTPServerInternetAddressType, receiveDataRateLinked=receiveDataRateLinked, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, versions=versions, snmpControl=snmpControl, cambium=cambium, eIRP=eIRP, txColorCode=txColorCode, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, range=range, supplementary=supplementary, tDMEnabledChannels=tDMEnabledChannels, syncEEquipmentClock=syncEEquipmentClock, ptp=ptp, sNTPServerRetries=sNTPServerRetries, gatewayIPAddress=gatewayIPAddress, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, antennaSelection=antennaSelection, management=management, sFPPortSSMTx=sFPPortSSMTx, sNTPServerTableNumber=sNTPServerTableNumber, userTableEntry=userTableEntry, routerProtocolsGroup=routerProtocolsGroup, channelChangeTrap=channelChangeTrap, aAAControlGroup=aAAControlGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sMTPServerInternetAddress=sMTPServerInternetAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDMConfigurationMismatch=tDMConfigurationMismatch, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, apc=apc, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerTable=sNTPServerTable, lbtDetectedTrap=lbtDetectedTrap, sFPPortAllocation=sFPPortAllocation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDMChannelCableLength=tDMChannelCableLength, licenseInstancedTable=licenseInstancedTable, linkLoss=linkLoss, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cableDiagnosticsWarning=cableDiagnosticsWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, tFTPClient=tFTPClient, receiveChannel=receiveChannel, linkSymmetry=linkSymmetry, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sNTPSync=sNTPSync, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, aAAControl=aAAControl, dfsGroup=dfsGroup, tdmTableEntry=tdmTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseBandwidthCap=licenseBandwidthCap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, channelBandwidth=channelBandwidth, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, remoteMACAddressLinked=remoteMACAddressLinked, deviceMACAddress=deviceMACAddress, auxPortAllocation=auxPortAllocation, snmpControlGroup=snmpControlGroup, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseIssueNumber=licenseIssueNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, unavailableSeconds=unavailableSeconds, dNS=dNS, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, enableTransmission=enableTransmission, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, smtp=smtp, signalStrengthRatioLinked=signalStrengthRatioLinked, auxPortStatusTrap=auxPortStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogControlGroup=syslogControlGroup, tDDControlGroup=tDDControlGroup, mABNominalModulationMode=mABNominalModulationMode, extendedSpectrumScanning=extendedSpectrumScanning, dfsTableEntry=dfsTableEntry, transmitFreqKHz=transmitFreqKHz, tdmTableNumber=tdmTableNumber, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptp670=ptp670, softwareVersion=softwareVersion, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, packetsFromInternalStack=packetsFromInternalStack, tDMChannelLoopback=tDMChannelLoopback, auxPortConfigurationMismatch=auxPortConfigurationMismatch, subbandHighestFrequency=subbandHighestFrequency, rawReceivePower=rawReceivePower, ethernet=ethernet, nIDULanPortAutoMdix=nIDULanPortAutoMdix, transmitChannel=transmitChannel, rxColorCode=rxColorCode, installArmStateTrap=installArmStateTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, localPacketFiltering=localPacketFiltering, mgmtInstancedTable=mgmtInstancedTable, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, bootVersion=bootVersion, userTable=userTable, nIDULanPortStatus=nIDULanPortStatus, resetGroup=resetGroup, linkModeOptimization=linkModeOptimization, receiveModulationModeLinked=receiveModulationModeLinked, licenseRARSupport=licenseRARSupport, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sFPPortAutoMdix=sFPPortAutoMdix, systemClock=systemClock, ethernetPriorityTableEntry=ethernetPriorityTableEntry, maxLinkRangeExceeded=maxLinkRangeExceeded, vectorError=vectorError)
