...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", secondarySoftwareVersion=secondarySoftwareVersion, iPv6PrefixLength=iPv6PrefixLength, tDDSynchronizationMode=tDDSynchronizationMode, licenseIPv6Support=licenseIPv6Support, installStatusLinked=installStatusLinked, phyControlInstancedTableNumber=phyControlInstancedTableNumber, nIDULanPortStatus=nIDULanPortStatus, ethernetInstancedTable=ethernetInstancedTable, ptp670=ptp670, bridgeGroup=bridgeGroup, sNTPServerTimeout=sNTPServerTimeout, sMTPEnabledMessages=sMTPEnabledMessages, licenseSyncESupport=licenseSyncESupport, tempPcb=tempPcb, cableDiagnosticsControl=cableDiagnosticsControl, channelChangeTrap=channelChangeTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, ethernetStatisticsTable=ethernetStatisticsTable, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, productName=productName, transmitFreqMHz=transmitFreqMHz, transmitDataRateLinked=transmitDataRateLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyStatusGroup=phyStatusGroup, managementGroup=managementGroup, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, smtp=smtp, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, accessMethod=accessMethod, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, userTableNumber=userTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, supplementaryGroup=supplementaryGroup, dataBridgingStatus=dataBridgingStatus, searchStateLinked=searchStateLinked, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, dfsTable=dfsTable, mgmtInstancedTableIndex=mgmtInstancedTableIndex, wirelessOutEthernetOctets=wirelessOutEthernetOctets, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, productVariant=productVariant, syslogControlGroup=syslogControlGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ptpGroups=ptpGroups, transmitModulationMode=transmitModulationMode, tFTPClient=tFTPClient, cableDiagnostics=cableDiagnostics, userName=userName, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sntp=sntp, unitIdentification=unitIdentification, sNMPCommunityString=sNMPCommunityString, mainPSUPortAutoMdix=mainPSUPortAutoMdix, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, whitelistRMMacAddress=whitelistRMMacAddress, mgmtInstancedTable=mgmtInstancedTable, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, cableDiagPair2Distance=cableDiagPair2Distance, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, syncETracking=syncETracking, cableDiagPair4Distance=cableDiagPair4Distance, mABMaintenanceLevel=mABMaintenanceLevel, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, rxColorCode=rxColorCode, cableDiagnosticsGroup=cableDiagnosticsGroup, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mABProtocolVID=mABProtocolVID, licenseInstancedTable=licenseInstancedTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, linkSymmetry=linkSymmetry, dataBridgingStatusLinked=dataBridgingStatusLinked, telnetAccessEnabled=telnetAccessEnabled, phyControlInstancedTable=phyControlInstancedTable, dNSServerTable=dNSServerTable, auxPortAllocation=auxPortAllocation, transmitFreqKHz=transmitFreqKHz, syslogControl=syslogControl, authorizationControl=authorizationControl, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, transmitChannel=transmitChannel, receivePower=receivePower, configurationInstancedTable=configurationInstancedTable, auxPortQLRx=auxPortQLRx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, severelyErroredSeconds=severelyErroredSeconds, licenseInstancedTableEntry=licenseInstancedTableEntry, txColorCode=txColorCode, tDDSynchronizationStatus=tDDSynchronizationStatus, tDMChannelStatus=tDMChannelStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, versionsGroup=versionsGroup, installationMode=installationMode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteUnitNameLinked=remoteUnitNameLinked, cableDiagPair2Results=cableDiagPair2Results, tDDControl=tDDControl, snmpControl=snmpControl, extendedSpectrumScanning=extendedSpectrumScanning, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, txMABFrames=txMABFrames, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cableDiagPair3Results=cableDiagPair3Results, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, antennaSelection=antennaSelection, routerProtocolsGroup=routerProtocolsGroup, qOSPriorityScheme=qOSPriorityScheme, portAllocationMismatchTrap=portAllocationMismatchTrap, ethernetPriorityTable=ethernetPriorityTable, userRole=userRole, sntpGroup=sntpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPState=sNTPState, vLANManagementPriority=vLANManagementPriority, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, syslogClient=syslogClient, licenseRARSupport=licenseRARSupport, PYSNMP_MODULE_ID=cambium, userTable=userTable, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, hCMPMaximumLinkRange=hCMPMaximumLinkRange, latitude=latitude, sNTPServerRetries=sNTPServerRetries, secureModeAlarm=secureModeAlarm, sFPPortAutoNegotiation=sFPPortAutoNegotiation, auxPortQLTx=auxPortQLTx, packetsFromInternalStack=packetsFromInternalStack, sMTPEmailAlert=sMTPEmailAlert, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mainPSUPortSSMTx=mainPSUPortSSMTx, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, lowestTDMModulationMode=lowestTDMModulationMode, licenseVersion=licenseVersion, dNSServerInternetAddress=dNSServerInternetAddress, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, daylightSaving=daylightSaving, phyControlGroup=phyControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, l2CPPriorityTableEntry=l2CPPriorityTableEntry, routerProtocols=routerProtocols, enableTransmission=enableTransmission, phyStatus=phyStatus, sNTPLastSync=sNTPLastSync, sNTPServerTableNumber=sNTPServerTableNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, notificationsGroup=notificationsGroup, dNSServerTableEntry=dNSServerTableEntry, ptpCompliance=ptpCompliance, encryption=encryption, systemClock=systemClock, encryptionAlgorithm=encryptionAlgorithm, cableDiagPair4Results=cableDiagPair4Results, tFTPServerPortNumber=tFTPServerPortNumber, licenseHCMPSupport=licenseHCMPSupport, licenseTDDSyncSupport=licenseTDDSyncSupport, sNTPSyncTrap=sNTPSyncTrap, deviceESN=deviceESN, sFPPortStatus=sFPPortStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNMPTrapTable=sNMPTrapTable, gatewayIPAddress=gatewayIPAddress, receiveDataRateLinked=receiveDataRateLinked, mainPSUPortStatus=mainPSUPortStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDMChannelLoopback=tDMChannelLoopback, ethernetInstancedTableNumber=ethernetInstancedTableNumber, ptp=ptp, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, transparentClockPort=transparentClockPort, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syncESlavePort=syncESlavePort, tDMEnabledChannels=tDMEnabledChannels, syslogState=syslogState, useVLANForMABProtocol=useVLANForMABProtocol, mainPSUPortQLRx=mainPSUPortQLRx, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, blacklistRMEnabled=blacklistRMEnabled, smtpGroup=smtpGroup, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sNMPPortNumber=sNMPPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, authorizationControlTable=authorizationControlTable, encryptionGroup=encryptionGroup, pubStats=pubStats, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, byteErrorRatioLinked=byteErrorRatioLinked, configurationInstancedTableIndex=configurationInstancedTableIndex, linkModeOptimization=linkModeOptimization, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDMChannelStatusTrap=tDMChannelStatusTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, longitude=longitude, sMTPServerInternetAddress=sMTPServerInternetAddress, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, packetsToInternalStack=packetsToInternalStack, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, maximumNumberOfSlaves=maximumNumberOfSlaves, unitOutOfCalibration=unitOutOfCalibration, authorizationMethod=authorizationMethod, ptmp=ptmp, remoteMACAddress=remoteMACAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNTPSync=sNTPSync, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubInstancedStatsTable=pubInstancedStatsTable, sFPError=sFPError, hTTPAccessEnabled=hTTPAccessEnabled, remoteMACAddressLinked=remoteMACAddressLinked, alarmInstancedTableIndex=alarmInstancedTableIndex, dNSServerInternetAddressType=dNSServerInternetAddressType, regulatoryBand=regulatoryBand, channelBandwidth=channelBandwidth, apc=apc, sNTPServerTableIndex=sNTPServerTableIndex, linkName=linkName, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNTPServerStatus=sNTPServerStatus, transmitterChannels=transmitterChannels, localPacketFiltering=localPacketFiltering, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sNTPServerTable=sNTPServerTable, byteErrorRatio=byteErrorRatio, cableDiagPair1Distance=cableDiagPair1Distance, syncEEquipmentClock=syncEEquipmentClock, tDM=tDM, dfsTableNumber=dfsTableNumber, auxPortSyncERxStatus=auxPortSyncERxStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, bridge=bridge, softwareVersion=softwareVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, alarmInstancedTable=alarmInstancedTable)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, searchState=searchState, deviceMACAddress=deviceMACAddress, configuration=configuration, configurationInstancedTableEntry=configurationInstancedTableEntry, licenseUnitSerialNumber=licenseUnitSerialNumber, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, signalStrengthRatioLinked=signalStrengthRatioLinked, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, unitIdentificationGroup=unitIdentificationGroup, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, linkLoss=linkLoss, alarmInstancedTableNumber=alarmInstancedTableNumber, auxPortStatus=auxPortStatus, aAAControl=aAAControl, altitude=altitude, timeZone=timeZone, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkLossLinked=linkLossLinked, syslogClientTrap=syslogClientTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, capacityVariantMismatchLinked=capacityVariantMismatchLinked, management=management, mgmtInstancedTableNumber=mgmtInstancedTableNumber, tdmTableIndex=tdmTableIndex, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, userPassword=userPassword, transmitDataRate=transmitDataRate, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mABTransmissionInterval=mABTransmissionInterval, dNSServerTableNumber=dNSServerTableNumber, apcGroup=apcGroup, telnetPortNumber=telnetPortNumber, sFPPortSSMTx=sFPPortSSMTx, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, secureModeAlarmTrap=secureModeAlarmTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseSFPPortSupport=licenseSFPPortSupport, lowestDataModulationMode=lowestDataModulationMode, transparentClockVLAN=transparentClockVLAN, targetMACAddress=targetMACAddress, mainPSUPortQLTx=mainPSUPortQLTx, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, aggregateDataRate=aggregateDataRate, dfsTableEntry=dfsTableEntry, installStatus=installStatus, dNSPrimaryServer=dNSPrimaryServer, phyInstancedStatusTable=phyInstancedStatusTable, sNTPPollInterval=sNTPPollInterval, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receiveChannel=receiveChannel, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, receiveFreqKHz=receiveFreqKHz, receiveDataRate=receiveDataRate, mgmtInstancedTableEntry=mgmtInstancedTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, unavailableSeconds=unavailableSeconds, sFPPortAllocation=sFPPortAllocation, wirelessLinkAvailability=wirelessLinkAvailability, tDMInterfaceStatus=tDMInterfaceStatus, aAAControlGroup=aAAControlGroup, receiveModulationModeLinked=receiveModulationModeLinked, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sFPPortDisabledWarning=sFPPortDisabledWarning, userTableEntry=userTableEntry, tDMGroup=tDMGroup, reset=reset, tDDControlGroup=tDDControlGroup, resetGroup=resetGroup, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, supplementary=supplementary, wirelessOutOctets=wirelessOutOctets, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, frequencyVariant=frequencyVariant, bootVersion=bootVersion, groupID=groupID, eIRP=eIRP, unitName=unitName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, rangeLinked=rangeLinked, tFTPServerInternetAddress=tFTPServerInternetAddress, dNS=dNS, sNMPv3Enable=sNMPv3Enable, erroredSeconds=erroredSeconds, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseOOBManagementSupport=licenseOOBManagementSupport, sNMPTrapTableNumber=sNMPTrapTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, sNTPPrimaryServer=sNTPPrimaryServer, aggregateDataRateLinked=aggregateDataRateLinked, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, cableLoss=cableLoss, dNSResolver=dNSResolver, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, dSCPManagementPriority=dSCPManagementPriority, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfsTableIndex=dfsTableIndex, capacityVariantMismatchTrap=capacityVariantMismatchTrap, installStatusTrap=installStatusTrap, installArmStateTrap=installArmStateTrap, dfs=dfs, authorizationControlTableEntry=authorizationControlTableEntry, configurationGroup=configurationGroup, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseTrialPeriod=licenseTrialPeriod, snmpControlGroup=snmpControlGroup, mABNominalModulationMode=mABNominalModulationMode, tdmTableEntry=tdmTableEntry, dNSServerPortNumber=dNSServerPortNumber, sFPPortStatusTrap=sFPPortStatusTrap, authorizationControlGroup=authorizationControlGroup, vLANManagementVID=vLANManagementVID, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, sFPPortQLTx=sFPPortQLTx, oOBPriorityQueueMapping=oOBPriorityQueueMapping, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, nIDULanPortAutoMdix=nIDULanPortAutoMdix, transmitModulationModeLinked=transmitModulationModeLinked, cableDiagPair1Results=cableDiagPair1Results, licenseInstancedTableNumber=licenseInstancedTableNumber, targetRange=targetRange, dataPortWirelessDownAlert=dataPortWirelessDownAlert, subnetMask=subnetMask, cableDiagnosticsResultTable=cableDiagnosticsResultTable, phyControlInstancedTableEntry=phyControlInstancedTableEntry, rawReceivePowerLinked=rawReceivePowerLinked, sNTPServerTableEntry=sNTPServerTableEntry, dfsGroup=dfsGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, vectorErrorLinked=vectorErrorLinked, userEnabled=userEnabled, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, auxPortSSMTx=auxPortSSMTx, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tdmTableNumber=tdmTableNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, iPv4Address=iPv4Address, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetInstancedTableEntry=ethernetInstancedTableEntry, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, regulatoryBandTrap=regulatoryBandTrap, ethernet=ethernet, licenseBandwidthCap=licenseBandwidthCap, sFPErrorTrap=sFPErrorTrap, licenseGroup=licenseGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, l2CPPriorityTable=l2CPPriorityTable, licenseInstancedTableIndex=licenseInstancedTableIndex, rawReceivePower=rawReceivePower, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, range=range, authorizationControlTableNumber=authorizationControlTableNumber, wirelessOutAllOctets=wirelessOutAllOctets, licenseTLSRekey=licenseTLSRekey, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteInternetAddressType=remoteInternetAddressType, maximumTransmitPower=maximumTransmitPower, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseGroupAccess=licenseGroupAccess, syncETrackingState=syncETrackingState, phyControl=phyControl, auxPortStatusTrap=auxPortStatusTrap, licenseIssueNumber=licenseIssueNumber, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, phyControlInstancedTableIndex=phyControlInstancedTableIndex, cableDiagnosticsWarning=cableDiagnosticsWarning, authorizationControlTableIndex=authorizationControlTableIndex, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNMPTrapTableIndex=sNMPTrapTableIndex, vectorError=vectorError, whitelistRMEnabled=whitelistRMEnabled, subbandHighestFrequency=subbandHighestFrequency, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseCapacity=licenseCapacity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, alarmsGroup=alarmsGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mPLSTCPriorityTable=mPLSTCPriorityTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, remoteInternetAddress=remoteInternetAddress, wirelessLinkStatus=wirelessLinkStatus, hCMPLinkSymmetry=hCMPLinkSymmetry, cambium=cambium, configurationInstancedTableNumber=configurationInstancedTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dfsMeans=dfsMeans, deviceMSN=deviceMSN, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, receivePowerLinked=receivePowerLinked, tDMInterfaceControl=tDMInterfaceControl, ethernetGroup=ethernetGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseIEEE1588Support=licenseIEEE1588Support, ptpTraps=ptpTraps, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseGasGroup=licenseGasGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sFPPortAutoMdix=sFPPortAutoMdix, sNTPServerInternetAddressType=sNTPServerInternetAddressType, auxPortAcceptedQLRx=auxPortAcceptedQLRx, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, portAllocationMismatch=portAllocationMismatch, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, antennaGain=antennaGain, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, versions=versions, mABNominalTransmitCapacity=mABNominalTransmitCapacity, transmitPower=transmitPower, receiveModulationMode=receiveModulationMode, signalStrengthRatio=signalStrengthRatio, systemReset=systemReset, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseCountry=licenseCountry, mainPSUPortStatusTrap=mainPSUPortStatusTrap, iPv6Address=iPv6Address, hardwareVersion=hardwareVersion, tDMChannelCableLength=tDMChannelCableLength, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transmitPowerLinked=transmitPowerLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, iPv6GatewayAddress=iPv6GatewayAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortQLRx=sFPPortQLRx, capacityVariantMismatch=capacityVariantMismatch, tDMChannelLineCode=tDMChannelLineCode, mABState=mABState, installArmState=installArmState, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, userTableIndex=userTableIndex, rangingMode=rangingMode, pubStatsGroup=pubStatsGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, mABHoldoffPeriod=mABHoldoffPeriod, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataBridgingAvailability=dataBridgingAvailability, blacklistRMMacAddress=blacklistRMMacAddress, wirelessTopology=wirelessTopology, dNSGroup=dNSGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseSecurityLevel=licenseSecurityLevel, dataPortPauseFrames=dataPortPauseFrames, hTTPSPortNumber=hTTPSPortNumber, syslogStateTrap=syslogStateTrap, receiveFreqMHz=receiveFreqMHz, siteName=siteName, transparentClock=transparentClock, iPVersion=iPVersion, ethernetStatisticsDataSource=ethernetStatisticsDataSource, license=license, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, lbtDetectedTrap=lbtDetectedTrap, subbandLowestFrequency=subbandLowestFrequency, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteUnitName=remoteUnitName, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, alarms=alarms, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagPair3Distance=cableDiagPair3Distance, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dNSServerTableIndex=dNSServerTableIndex, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, transparentClockVID=transparentClockVID, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, masterSlaveMode=masterSlaveMode, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tdmTable=tdmTable, licenseEncryption=licenseEncryption, hTTPPortNumber=hTTPPortNumber, dfsPeaks=dfsPeaks, portAllocationMismatchLinked=portAllocationMismatchLinked)
