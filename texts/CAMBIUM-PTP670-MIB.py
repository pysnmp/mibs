...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", pubStats=pubStats, linkModeOptimization=linkModeOptimization, alarmInstancedTable=alarmInstancedTable, sNMPTrapTableNumber=sNMPTrapTableNumber, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sMTPServerInternetAddressType=sMTPServerInternetAddressType, notificationsGroup=notificationsGroup, receiveModulationMode=receiveModulationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dfsTableNumber=dfsTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, portAllocationMismatchLinked=portAllocationMismatchLinked, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, cableDiagnostics=cableDiagnostics, managementPortWirelessDownAlert=managementPortWirelessDownAlert, cableDiagnosticsPorts=cableDiagnosticsPorts, installStatusTrap=installStatusTrap, regulatoryBandTrap=regulatoryBandTrap, unitOutOfCalibration=unitOutOfCalibration, gatewayIPAddress=gatewayIPAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, tDMEnabledChannels=tDMEnabledChannels, tDMChannelLineCode=tDMChannelLineCode, accessMethod=accessMethod, licenseTLSRekey=licenseTLSRekey, systemReset=systemReset, ethernetInstancedTableNumber=ethernetInstancedTableNumber, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, dNSServerTableEntry=dNSServerTableEntry, remoteUnitName=remoteUnitName, ptpTraps=ptpTraps, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetInstancedTableIndex=ethernetInstancedTableIndex, altitude=altitude, dNSServerTable=dNSServerTable, cableDiagPair4Results=cableDiagPair4Results, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, deviceMACAddress=deviceMACAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, nIDULanPortStatus=nIDULanPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, cambium=cambium, cableDiagPair3Distance=cableDiagPair3Distance, transmitterChannels=transmitterChannels, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, versions=versions, licenseOOBManagementSupport=licenseOOBManagementSupport, dfsTableIndex=dfsTableIndex, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, transparentClock=transparentClock, iPv4Address=iPv4Address, tDM=tDM, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, receiveDataRateLinked=receiveDataRateLinked, phyStatusGroup=phyStatusGroup, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, dfsTableEntry=dfsTableEntry, tdmTableNumber=tdmTableNumber, syncETrackingState=syncETrackingState, ptp=ptp, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPEnabledTraps=sNMPEnabledTraps, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagnosticsGroup=cableDiagnosticsGroup, routerProtocols=routerProtocols, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dNSServerTableIndex=dNSServerTableIndex, mABHoldoffPeriod=mABHoldoffPeriod, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortSyncERxStatus=auxPortSyncERxStatus, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, transmitDataRate=transmitDataRate, transmitModulationModeLinked=transmitModulationModeLinked, authorizationControlTableNumber=authorizationControlTableNumber, encryptionAlgorithm=encryptionAlgorithm, license=license, tDMChannelStatus=tDMChannelStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, transparentClockPort=transparentClockPort, receiveFreqKHz=receiveFreqKHz, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, searchStateLinked=searchStateLinked, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseMaxLinkRange=licenseMaxLinkRange, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rangingMode=rangingMode, authorizationControlTableIndex=authorizationControlTableIndex, hCMPMaximumLinkRange=hCMPMaximumLinkRange, productVariant=productVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTableIndex=sNMPTrapTableIndex, tDMChannelCableLength=tDMChannelCableLength, timeZone=timeZone, versionsGroup=versionsGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transparentClockVLAN=transparentClockVLAN, userTableNumber=userTableNumber, useVLANForMABProtocol=useVLANForMABProtocol, smtp=smtp, rawReceivePowerLinked=rawReceivePowerLinked, mABProtocolVID=mABProtocolVID, sNTPServerTableEntry=sNTPServerTableEntry, apc=apc, lowestDataModulationMode=lowestDataModulationMode, dNSServerInternetAddress=dNSServerInternetAddress, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, dNSGroup=dNSGroup, ethernetStatisticsTable=ethernetStatisticsTable, aggregateDataRateLinked=aggregateDataRateLinked, mainPSUPortAutoMdix=mainPSUPortAutoMdix, phyControlInstancedTableIndex=phyControlInstancedTableIndex, dfsTable=dfsTable, configurationInstancedTable=configurationInstancedTable, mainPSUPortStatusTrap=mainPSUPortStatusTrap, signalStrengthRatioLinked=signalStrengthRatioLinked, vLANManagementPriority=vLANManagementPriority, licenseInstancedTableNumber=licenseInstancedTableNumber, wirelessOutOctets=wirelessOutOctets, portAllocationMismatch=portAllocationMismatch, licenseIssueNumber=licenseIssueNumber, resetGroup=resetGroup, sNMPv3Enable=sNMPv3Enable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, licenseCapacity=licenseCapacity, tdmTableIndex=tdmTableIndex, receiveChannel=receiveChannel, sFPError=sFPError, blacklistRMEnabled=blacklistRMEnabled, frequencyVariant=frequencyVariant, whitelistRMMacAddress=whitelistRMMacAddress, mgmtInstancedTableEntry=mgmtInstancedTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sntpGroup=sntpGroup, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, vectorError=vectorError, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cableDiagPair1Distance=cableDiagPair1Distance, alarmInstancedTableIndex=alarmInstancedTableIndex, ethernetInstancedTableEntry=ethernetInstancedTableEntry, blacklistRMMacAddress=blacklistRMMacAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sFPPortAutoMdix=sFPPortAutoMdix, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, wirelessTopology=wirelessTopology, ptpGroups=ptpGroups, rxColorCode=rxColorCode, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sNTPServerTable=sNTPServerTable, dfs=dfs, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, dNSResolver=dNSResolver, tDMInterfaceControl=tDMInterfaceControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortStatusTrap=sFPPortStatusTrap, dataBridgingStatus=dataBridgingStatus, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, syslogClientTrap=syslogClientTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, syslogClient=syslogClient, wirelessOutEthernetOctets=wirelessOutEthernetOctets, dfsMeans=dfsMeans, authorizationMethod=authorizationMethod, mgmtInstancedTableIndex=mgmtInstancedTableIndex, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, lbtDetectedTrap=lbtDetectedTrap, userTableIndex=userTableIndex, auxPortAcceptedQLRx=auxPortAcceptedQLRx, linkLoss=linkLoss, syslogControlGroup=syslogControlGroup, auxPortStatusTrap=auxPortStatusTrap, userTable=userTable, regulatoryBand=regulatoryBand, ptmp=ptmp, sNTPServerTimeout=sNTPServerTimeout, licenseEncryption=licenseEncryption, dSCPManagementPriority=dSCPManagementPriority, linkLossLinked=linkLossLinked, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, tempPcb=tempPcb, softwareVersion=softwareVersion, sMTPEmailAlert=sMTPEmailAlert, phyControlGroup=phyControlGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, syncESlavePort=syncESlavePort, sMTPServerPortNumber=sMTPServerPortNumber, telnetPortNumber=telnetPortNumber, encryption=encryption, mABState=mABState, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, auxPortStatus=auxPortStatus, licenseRARSupport=licenseRARSupport, byteErrorRatio=byteErrorRatio, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, apcGroup=apcGroup, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, packetsFromInternalStack=packetsFromInternalStack, syncETracking=syncETracking, tFTPClient=tFTPClient, encryptionGroup=encryptionGroup, dataBridgingStatusAlarm=dataBridgingStatusAlarm, licenseVersion=licenseVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, authorizationControl=authorizationControl, licenseSecurityLevel=licenseSecurityLevel, iPVersion=iPVersion, range=range, unitName=unitName, mABProtocolVLANPriority=mABProtocolVLANPriority, cableDiagPair4Distance=cableDiagPair4Distance, dNSServerInternetAddressType=dNSServerInternetAddressType, wirelessOutAllOctets=wirelessOutAllOctets, ptpCompliance=ptpCompliance, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, licenseIEEE1588Support=licenseIEEE1588Support, PYSNMP_MODULE_ID=cambium, ethernetPriorityTableIndex=ethernetPriorityTableIndex, capacityVariantMismatchLinked=capacityVariantMismatchLinked, latitude=latitude, licenseTrialPeriod=licenseTrialPeriod, siteName=siteName, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, dNSPrimaryServer=dNSPrimaryServer)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityString=sNMPCommunityString, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, eIRP=eIRP, licenseHCMPSupport=licenseHCMPSupport, sFPPortAutoNegotiation=sFPPortAutoNegotiation, configuration=configuration, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNMPPortNumber=sNMPPortNumber, cableDiagPair2Distance=cableDiagPair2Distance, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tFTPServerPortNumber=tFTPServerPortNumber, antennaGain=antennaGain, bridge=bridge, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, receiveDataRate=receiveDataRate, tFTPServerInternetAddressType=tFTPServerInternetAddressType, bridgeGroup=bridgeGroup, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementNetworkAccessEnabled=managementNetworkAccessEnabled, aAAControlGroup=aAAControlGroup, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, smtpGroup=smtpGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, hTTPAccessEnabled=hTTPAccessEnabled, systemClock=systemClock, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, subnetMask=subnetMask, licenseCountry=licenseCountry, targetMACAddress=targetMACAddress, dNSServerTableNumber=dNSServerTableNumber, dataPortPauseFrames=dataPortPauseFrames, ethernetGroup=ethernetGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNMPTrapTable=sNMPTrapTable, auxPortConfigurationMismatch=auxPortConfigurationMismatch, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteUnitNameLinked=remoteUnitNameLinked, dNS=dNS, mainPSUPortSSMTx=mainPSUPortSSMTx, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, transmitModulationMode=transmitModulationMode, capacityVariantMismatch=capacityVariantMismatch, tdmTable=tdmTable, auxPortQLTx=auxPortQLTx, whitelistRMEnabled=whitelistRMEnabled, maximumTransmitPower=maximumTransmitPower, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, deviceMSN=deviceMSN, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sntp=sntp, remoteMACAddressLinked=remoteMACAddressLinked, channelBandwidth=channelBandwidth, managementGroup=managementGroup, tDMGroup=tDMGroup, phyInstancedStatusTable=phyInstancedStatusTable, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, installStatusLinked=installStatusLinked, pubStatsGroup=pubStatsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, pubInstancedStatsTable=pubInstancedStatsTable, sNTPSync=sNTPSync, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, daylightSaving=daylightSaving, sNMPTrapInternetAddress=sNMPTrapInternetAddress, authorizationControlTableEntry=authorizationControlTableEntry, ethernetStatisticsDataSource=ethernetStatisticsDataSource, receiveFreqMHz=receiveFreqMHz, snmpControlGroup=snmpControlGroup, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sFPPortDisabledWarning=sFPPortDisabledWarning, sFPPortAllocation=sFPPortAllocation, auxPortSSMTx=auxPortSSMTx, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, phyControl=phyControl, aAAControl=aAAControl, mainPSUPortStatus=mainPSUPortStatus, tDMChannelStatusTrap=tDMChannelStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, extendedSpectrumScanning=extendedSpectrumScanning, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseInstancedTableIndex=licenseInstancedTableIndex, sNTPSyncTrap=sNTPSyncTrap, sNTPLastSync=sNTPLastSync, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPPollInterval=sNTPPollInterval, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, longitude=longitude, sFPErrorTrap=sFPErrorTrap, sFPPortQLTx=sFPPortQLTx, licenseSyncESupport=licenseSyncESupport, licenseGroup=licenseGroup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, hardwareVersion=hardwareVersion, licenseSFPPortSupport=licenseSFPPortSupport, antennaSelection=antennaSelection, syslogState=syslogState, mainPSUPortAllocation=mainPSUPortAllocation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, l2CPPriorityTable=l2CPPriorityTable, phyStatus=phyStatus, mainPSUPortQLTx=mainPSUPortQLTx, auxPortDisabledWarning=auxPortDisabledWarning, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, licenseGasGroup=licenseGasGroup, ethernet=ethernet, portAllocationMismatchTrap=portAllocationMismatchTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, linkName=linkName, routerProtocolsGroup=routerProtocolsGroup, authorizationControlTable=authorizationControlTable, transmitPowerLinked=transmitPowerLinked, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, cableDiagPair1Results=cableDiagPair1Results, transmitDataRateLinked=transmitDataRateLinked, phyControlInstancedTableNumber=phyControlInstancedTableNumber, packetsToInternalStack=packetsToInternalStack, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, sNTPServerPortNumber=sNTPServerPortNumber, tDMInterfaceStatus=tDMInterfaceStatus, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, phyControlInstancedTableEntry=phyControlInstancedTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, auxPortAllocation=auxPortAllocation, iPv6Address=iPv6Address, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, vLANManagementVID=vLANManagementVID, installationMode=installationMode, remoteMACAddress=remoteMACAddress, severelyErroredSeconds=severelyErroredSeconds, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, nIDULanPortStatusTrap=nIDULanPortStatusTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, transmitPower=transmitPower, mainPSUPortQLRx=mainPSUPortQLRx, subbandHighestFrequency=subbandHighestFrequency, remoteInternetAddressType=remoteInternetAddressType, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, vectorErrorLinked=vectorErrorLinked, cableDiagnosticsResultTable=cableDiagnosticsResultTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, searchState=searchState, userName=userName, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sNTPServerRetries=sNTPServerRetries, management=management, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, syncEEquipmentClock=syncEEquipmentClock, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, txColorCode=txColorCode, hTTPPortNumber=hTTPPortNumber, iPv6PrefixLength=iPv6PrefixLength, alarmInstancedTableEntry=alarmInstancedTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sFPPortStatus=sFPPortStatus, tDDControlGroup=tDDControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, unitIdentificationGroup=unitIdentificationGroup, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sFPPortQLRx=sFPPortQLRx, iPv6GatewayAddress=iPv6GatewayAddress, qOSPriorityScheme=qOSPriorityScheme, mABNominalTransmitCapacity=mABNominalTransmitCapacity, groupID=groupID, licenseInstancedTable=licenseInstancedTable, tDDSynchronizationStatus=tDDSynchronizationStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, alarmInstancedTableNumber=alarmInstancedTableNumber, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, transmitFreqMHz=transmitFreqMHz, syslogStateTrap=syslogStateTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, userEnabled=userEnabled, hTTPSPortNumber=hTTPSPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkSymmetry=linkSymmetry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, signalStrengthRatio=signalStrengthRatio, masterSlaveMode=masterSlaveMode, localPacketFiltering=localPacketFiltering, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, lowestTDMModulationMode=lowestTDMModulationMode, transmitFreqKHz=transmitFreqKHz, secureModeAlarm=secureModeAlarm, aggregateDataRate=aggregateDataRate, erroredSeconds=erroredSeconds, receivePower=receivePower, userTableEntry=userTableEntry, alarmsGroup=alarmsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapVersion=sNMPTrapVersion, productName=productName, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, channelChangeTrap=channelChangeTrap, sNTPState=sNTPState, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, txMABFrames=txMABFrames, installArmState=installArmState, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetInstancedTable=ethernetInstancedTable, installStatus=installStatus, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, mgmtInstancedTableNumber=mgmtInstancedTableNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sNTPPrimaryServer=sNTPPrimaryServer, rawReceivePower=rawReceivePower, incompatibleRegulatoryBands=incompatibleRegulatoryBands, remoteInternetAddress=remoteInternetAddress, unavailableSeconds=unavailableSeconds, tDDSynchronizationMode=tDDSynchronizationMode, dNSServerPortNumber=dNSServerPortNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, auxPortQLRx=auxPortQLRx, alarms=alarms, licenseIPv6Support=licenseIPv6Support, wirelessLinkStatus=wirelessLinkStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, byteErrorRatioLinked=byteErrorRatioLinked, mABNominalModulationMode=mABNominalModulationMode, configurationInstancedTableNumber=configurationInstancedTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataBridgingAvailability=dataBridgingAvailability, licenseBandwidthCap=licenseBandwidthCap, userPassword=userPassword, rangeLinked=rangeLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagnosticsWarning=cableDiagnosticsWarning, reset=reset, capacityVariantMismatchTrap=capacityVariantMismatchTrap, enableTransmission=enableTransmission, supplementary=supplementary, remoteInternetAddressLinked=remoteInternetAddressLinked, noWirelessChannelAvailable=noWirelessChannelAvailable, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tDMChannelLoopback=tDMChannelLoopback, phyControlInstancedTable=phyControlInstancedTable, receiveModulationModeLinked=receiveModulationModeLinked, cableDiagPair2Results=cableDiagPair2Results, snmpControl=snmpControl, mABTransmissionInterval=mABTransmissionInterval, licenseGroupAccess=licenseGroupAccess, ptp670=ptp670, authorizationControlGroup=authorizationControlGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, supplementaryGroup=supplementaryGroup, userRole=userRole, syslogControl=syslogControl, ethernetPriorityTable=ethernetPriorityTable, sNTPServerStatus=sNTPServerStatus, secureModeAlarmTrap=secureModeAlarmTrap, receivePowerLinked=receivePowerLinked, bootVersion=bootVersion, ptpTrapPrefix=ptpTrapPrefix, cableDiagnosticsControl=cableDiagnosticsControl, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortSSMTx=sFPPortSSMTx, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, cableDiagPair3Results=cableDiagPair3Results, telnetAccessEnabled=telnetAccessEnabled, cableLoss=cableLoss, targetRange=targetRange, deviceESN=deviceESN, sNTPServerTableIndex=sNTPServerTableIndex, subbandLowestFrequency=subbandLowestFrequency, unitIdentification=unitIdentification, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, configurationGroup=configurationGroup, wirelessLinkAvailability=wirelessLinkAvailability, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tDDControl=tDDControl, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dfsGroup=dfsGroup, sNTPServerTableNumber=sNTPServerTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tdmTableEntry=tdmTableEntry, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, mgmtInstancedTable=mgmtInstancedTable, receiveModulationModeDetail=receiveModulationModeDetail, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, transmitChannel=transmitChannel, transparentClockVID=transparentClockVID, mABMaintenanceLevel=mABMaintenanceLevel, dfsPeaks=dfsPeaks, licenseUnitSerialNumber=licenseUnitSerialNumber)
