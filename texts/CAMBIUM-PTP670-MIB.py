...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, lowestDataModulationMode=lowestDataModulationMode, l2CPPriorityTable=l2CPPriorityTable, encryption=encryption, dataBridgingStatusAlarm=dataBridgingStatusAlarm, installStatus=installStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, txMABFrames=txMABFrames, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, cableDiagPair1Results=cableDiagPair1Results, mainPSUPortAllocation=mainPSUPortAllocation, installArmStateTrap=installArmStateTrap, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, transmitDataRate=transmitDataRate, alarms=alarms, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPSync=sNTPSync, encryptionAlgorithm=encryptionAlgorithm, dNSServerTable=dNSServerTable, sNMPEnabledTraps=sNMPEnabledTraps, userTableNumber=userTableNumber, latitude=latitude, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hardwareVersion=hardwareVersion, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, userRole=userRole, lowestTDMModulationMode=lowestTDMModulationMode, ethernetInstancedTableIndex=ethernetInstancedTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, ptmp=ptmp, ptpGroups=ptpGroups, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mABTransmissionInterval=mABTransmissionInterval, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, byteErrorRatio=byteErrorRatio, cableDiagPair3Distance=cableDiagPair3Distance, iPv6PrefixLength=iPv6PrefixLength, ethernet=ethernet, licenseBandwidthCap=licenseBandwidthCap, licenseSFPPortSupport=licenseSFPPortSupport, eIRP=eIRP, dNSPrimaryServer=dNSPrimaryServer, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNMPTrapVersion=sNMPTrapVersion, mABState=mABState, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, blacklistRMEnabled=blacklistRMEnabled, authorizationControlGroup=authorizationControlGroup, ptp=ptp, sNTPSyncTrap=sNTPSyncTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, installStatusLinked=installStatusLinked, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, regulatoryBandTrap=regulatoryBandTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitModulationMode=transmitModulationMode, sFPPortQLTx=sFPPortQLTx, licenseGasGroup=licenseGasGroup, wirelessOutOctets=wirelessOutOctets, tFTPServerInternetAddress=tFTPServerInternetAddress, portAllocationMismatchTrap=portAllocationMismatchTrap, antennaSelection=antennaSelection, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rangeLinked=rangeLinked, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseInstancedTableNumber=licenseInstancedTableNumber, mainPSUPortQLTx=mainPSUPortQLTx, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, tDMEnabledChannels=tDMEnabledChannels, wirelessLinkStatusLinked=wirelessLinkStatusLinked, dfsPeaks=dfsPeaks, sMTPServerInternetAddressType=sMTPServerInternetAddressType, unitName=unitName, ethernetStatisticsDataSource=ethernetStatisticsDataSource, receiveDataRateLinked=receiveDataRateLinked, unitIdentification=unitIdentification, deviceMSN=deviceMSN, phyInstancedStatusTable=phyInstancedStatusTable, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, auxPortSSMTx=auxPortSSMTx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, aAAControl=aAAControl, pubStatsGroup=pubStatsGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, smtpGroup=smtpGroup, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, sNTPServerTimeout=sNTPServerTimeout, sMTPEmailAlert=sMTPEmailAlert, cableDiagPair3Results=cableDiagPair3Results, nIDULanPortStatusTrap=nIDULanPortStatusTrap, authorizationControl=authorizationControl, whitelistRMEnabled=whitelistRMEnabled, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, license=license, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, dfsMeans=dfsMeans, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, dfsTable=dfsTable, sMTPEnabledMessages=sMTPEnabledMessages, pubInstancedStatsTable=pubInstancedStatsTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receivePowerLinked=receivePowerLinked, receiveModulationModeLinked=receiveModulationModeLinked, alarmsGroup=alarmsGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNTPServerTableEntry=sNTPServerTableEntry, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, remoteUnitNameLinked=remoteUnitNameLinked, cableLoss=cableLoss, sFPPortDisabledWarning=sFPPortDisabledWarning, longitude=longitude, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, iPv6Address=iPv6Address, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sntp=sntp, mgmtInstancedTableIndex=mgmtInstancedTableIndex, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, licenseIEEE1588Support=licenseIEEE1588Support, localPacketFiltering=localPacketFiltering, erroredSeconds=erroredSeconds, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, secureModeAlarm=secureModeAlarm, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, hTTPAccessEnabled=hTTPAccessEnabled, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tFTPClient=tFTPClient, userTable=userTable, dNSGroup=dNSGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptp670=ptp670, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sFPPortStatusTrap=sFPPortStatusTrap, dNS=dNS, accessMethod=accessMethod, licenseGroupAccess=licenseGroupAccess, phyStatusGroup=phyStatusGroup, secondarySoftwareVersion=secondarySoftwareVersion, sNTPPrimaryServer=sNTPPrimaryServer, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogStateTrap=syslogStateTrap, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tdmTableNumber=tdmTableNumber, telnetAccessEnabled=telnetAccessEnabled, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, searchState=searchState, vectorErrorLinked=vectorErrorLinked, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, configurationInstancedTableEntry=configurationInstancedTableEntry, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, configurationGroup=configurationGroup, groupID=groupID, syslogClientTrap=syslogClientTrap, snmpControl=snmpControl, softwareVersion=softwareVersion, versionsGroup=versionsGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vectorError=vectorError, wirelessTopology=wirelessTopology, incompatibleMasterAndSlave=incompatibleMasterAndSlave, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseCountry=licenseCountry, capacityVariantMismatchTrap=capacityVariantMismatchTrap, txColorCode=txColorCode, subnetMask=subnetMask, targetRange=targetRange, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseInstancedTable=licenseInstancedTable, capacityVariantMismatch=capacityVariantMismatch, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, alarmInstancedTableIndex=alarmInstancedTableIndex, aggregateDataRate=aggregateDataRate, syslogControl=syslogControl, useVLANForMABProtocol=useVLANForMABProtocol, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, mABProtocolVID=mABProtocolVID, productName=productName, tDMChannelLoopback=tDMChannelLoopback, subbandHighestFrequency=subbandHighestFrequency, licenseSecurityLevel=licenseSecurityLevel, sFPPortStatus=sFPPortStatus, tDDControl=tDDControl, configurationInstancedTableIndex=configurationInstancedTableIndex, oOBPriorityQueueMapping=oOBPriorityQueueMapping, systemReset=systemReset, linkLossLinked=linkLossLinked, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, enableTransmission=enableTransmission, blacklistRMMacAddress=blacklistRMMacAddress, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tDMChannelStatusTrap=tDMChannelStatusTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, aggregateDataRateLinked=aggregateDataRateLinked, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, channelBandwidth=channelBandwidth, configurationInstancedTableNumber=configurationInstancedTableNumber, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortQLTx=auxPortQLTx, installStatusTrap=installStatusTrap, tempPcb=tempPcb, qOSPriorityScheme=qOSPriorityScheme, gatewayIPAddress=gatewayIPAddress, hTTPPortNumber=hTTPPortNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, cableDiagPair4Distance=cableDiagPair4Distance, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenseInstancedTableIndex=licenseInstancedTableIndex, userPassword=userPassword, cableDiagnosticsResultTable=cableDiagnosticsResultTable, cableDiagPair4Results=cableDiagPair4Results, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rawReceivePowerLinked=rawReceivePowerLinked, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, cableDiagnosticsGroup=cableDiagnosticsGroup, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNTPPollInterval=sNTPPollInterval, alarmInstancedTableEntry=alarmInstancedTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, auxPortDisabledWarning=auxPortDisabledWarning, receivePower=receivePower, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tFTPServerInternetAddressType=tFTPServerInternetAddressType, alarmInstancedTableNumber=alarmInstancedTableNumber, licenseHCMPSupport=licenseHCMPSupport, telnetPortNumber=telnetPortNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, syncETracking=syncETracking, transparentClockVID=transparentClockVID, mgmtInstancedTable=mgmtInstancedTable, installArmState=installArmState, sFPPortAutoNegotiation=sFPPortAutoNegotiation, tDMInterfaceStatus=tDMInterfaceStatus, sntpGroup=sntpGroup, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sNTPServerTableNumber=sNTPServerTableNumber, dNSServerInternetAddress=dNSServerInternetAddress, managementGroup=managementGroup, syslogState=syslogState, unitOutOfCalibration=unitOutOfCalibration, ptpTrapPrefix=ptpTrapPrefix, auxPortStatus=auxPortStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, routerProtocols=routerProtocols, sFPError=sFPError, subbandLowestFrequency=subbandLowestFrequency, smtp=smtp, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, unitIdentificationGroup=unitIdentificationGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, authorizationControlTableIndex=authorizationControlTableIndex, ethernetPriorityTable=ethernetPriorityTable, range=range, mainPSUPortQLRx=mainPSUPortQLRx, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogControlGroup=syslogControlGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sFPErrorTrap=sFPErrorTrap, searchStateLinked=searchStateLinked, auxPortQLRx=auxPortQLRx, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, dfsTableIndex=dfsTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, encryptionGroup=encryptionGroup, tDMChannelLineCode=tDMChannelLineCode, mABNominalModulationMode=mABNominalModulationMode, licenseIssueNumber=licenseIssueNumber, dNSServerTableEntry=dNSServerTableEntry, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, cableDiagnosticsControl=cableDiagnosticsControl, sNTPServerTable=sNTPServerTable, masterSlaveMode=masterSlaveMode, signalStrengthRatioLinked=signalStrengthRatioLinked, timeZone=timeZone, licenseEncryption=licenseEncryption, licenseRARSupport=licenseRARSupport, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, transparentClockPort=transparentClockPort, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, transmitFreqMHz=transmitFreqMHz, siteName=siteName, mainPSUPortStatusTrap=mainPSUPortStatusTrap, userEnabled=userEnabled, byteErrorRatioLinked=byteErrorRatioLinked, ethernetGroup=ethernetGroup, regulatoryBand=regulatoryBand, receiveFreqMHz=receiveFreqMHz, bootVersion=bootVersion, systemClock=systemClock, sNMPCommunityString=sNMPCommunityString, antennaGain=antennaGain, dfs=dfs, syncETrackingState=syncETrackingState, authorizationControlTableEntry=authorizationControlTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, phyControlInstancedTableEntry=phyControlInstancedTableEntry, sNTPState=sNTPState, severelyErroredSeconds=severelyErroredSeconds, phyControlInstancedTable=phyControlInstancedTable, mgmtInstancedTableNumber=mgmtInstancedTableNumber, licenseVersion=licenseVersion, supplementary=supplementary, transparentClockVLAN=transparentClockVLAN, packetsFromInternalStack=packetsFromInternalStack, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sNTPServerStatus=sNTPServerStatus, pubStats=pubStats, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerRetries=sNTPServerRetries, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, licenseUnitSerialNumber=licenseUnitSerialNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNTPServerTableIndex=sNTPServerTableIndex, transmitChannel=transmitChannel, management=management, tDM=tDM, ptpCompliance=ptpCompliance, dNSServerPortNumber=dNSServerPortNumber, userTableEntry=userTableEntry, signalStrengthRatio=signalStrengthRatio, apcGroup=apcGroup, authorizationControlTable=authorizationControlTable, ptpTraps=ptpTraps, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, aAAControlGroup=aAAControlGroup, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, cableDiagPair2Results=cableDiagPair2Results, sNTPLastSync=sNTPLastSync, sFPPortAllocation=sFPPortAllocation, mainPSUPortStatus=mainPSUPortStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDMChannelCableLength=tDMChannelCableLength, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, rangingMode=rangingMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, cableDiagPair2Distance=cableDiagPair2Distance, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, portAllocationMismatchLinked=portAllocationMismatchLinked, deviceMACAddress=deviceMACAddress, remoteInternetAddressType=remoteInternetAddressType, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, routerProtocolsGroup=routerProtocolsGroup, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, tdmTableEntry=tdmTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, supplementaryGroup=supplementaryGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, versions=versions, packetsToInternalStack=packetsToInternalStack, licenseTrialPeriod=licenseTrialPeriod, licenseSyncESupport=licenseSyncESupport, productVariant=productVariant, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseGroup=licenseGroup, ethernetInstancedTableEntry=ethernetInstancedTableEntry, resetGroup=resetGroup, remoteInternetAddressLinked=remoteInternetAddressLinked, rxColorCode=rxColorCode, syslogClient=syslogClient, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, channelChangeTrap=channelChangeTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, ethernetStatisticsTable=ethernetStatisticsTable, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, phyControlGroup=phyControlGroup, sFPPortQLRx=sFPPortQLRx, licenseInstancedTableEntry=licenseInstancedTableEntry, wirelessLinkStatus=wirelessLinkStatus, remoteMACAddress=remoteMACAddress, userTableIndex=userTableIndex, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, dNSResolver=dNSResolver, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, mABProtocolVLANPriority=mABProtocolVLANPriority, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, apc=apc, sNMPTrapTable=sNMPTrapTable, frequencyVariant=frequencyVariant, altitude=altitude, phyControl=phyControl, linkLoss=linkLoss, licenseMaxLinkRange=licenseMaxLinkRange, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitModulationModeLinked=transmitModulationModeLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, sMTPServerPortNumber=sMTPServerPortNumber, mABHoldoffPeriod=mABHoldoffPeriod, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, deviceESN=deviceESN, dNSServerTableIndex=dNSServerTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyStatus=phyStatus, cableDiagnosticsPorts=cableDiagnosticsPorts, userName=userName, dataPortPauseFrames=dataPortPauseFrames, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, targetMACAddress=targetMACAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, auxPortAcceptedQLRx=auxPortAcceptedQLRx, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNMPPortNumber=sNMPPortNumber, auxPortAllocation=auxPortAllocation, licenseTDDSyncSupport=licenseTDDSyncSupport, ethernetPriorityTableIndex=ethernetPriorityTableIndex, remoteInternetAddress=remoteInternetAddress, syncEEquipmentClock=syncEEquipmentClock, tDMGroup=tDMGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortAutoMdix=sFPPortAutoMdix, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessOutAllOctets=wirelessOutAllOctets, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, dSCPManagementPriority=dSCPManagementPriority, transmitPowerLinked=transmitPowerLinked, licenseCapacity=licenseCapacity, syncESlavePort=syncESlavePort, remoteMACAddressLinked=remoteMACAddressLinked, dfsTableNumber=dfsTableNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, lbtDetectedTrap=lbtDetectedTrap, extendedSpectrumScanning=extendedSpectrumScanning, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mainPSUPortAutoMdix=mainPSUPortAutoMdix, authorizationControlTableNumber=authorizationControlTableNumber, linkModeOptimization=linkModeOptimization, alarmInstancedTable=alarmInstancedTable, vLANManagementVID=vLANManagementVID, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, receiveChannel=receiveChannel, sFPPortSSMTx=sFPPortSSMTx, dfsTableEntry=dfsTableEntry, bridge=bridge, dataBridgingStatus=dataBridgingStatus, cambium=cambium, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, linkSymmetry=linkSymmetry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, tDMChannelStatus=tDMChannelStatus, dNSServerTableNumber=dNSServerTableNumber, transmitFreqKHz=transmitFreqKHz, snmpControlGroup=snmpControlGroup, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, transmitDataRateLinked=transmitDataRateLinked, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, whitelistRMMacAddress=whitelistRMMacAddress, receiveDataRate=receiveDataRate, transparentClock=transparentClock, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkName=linkName, tDDSynchronizationMode=tDDSynchronizationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", managementNetworkAccessEnabled=managementNetworkAccessEnabled, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseRegulatoryBandsList=licenseRegulatoryBandsList, installationMode=installationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, bridgeGroup=bridgeGroup, licenseIPv6Support=licenseIPv6Support, reset=reset, authorizationMethod=authorizationMethod, licenseOOBManagementSupport=licenseOOBManagementSupport, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, rawReceivePower=rawReceivePower, nIDULanPortAutoMdix=nIDULanPortAutoMdix, portAllocationMismatch=portAllocationMismatch, ethernetInstancedTable=ethernetInstancedTable, receiveFreqKHz=receiveFreqKHz, maximumTransmitPower=maximumTransmitPower, sNMPv3Enable=sNMPv3Enable, auxPortStatusTrap=auxPortStatusTrap, licenseTLSRekey=licenseTLSRekey, tdmTable=tdmTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mABMaintenanceLevel=mABMaintenanceLevel, iPVersion=iPVersion, vLANManagementPriority=vLANManagementPriority, dataBridgingAvailability=dataBridgingAvailability, sNTPServerPortNumber=sNTPServerPortNumber, tDDControlGroup=tDDControlGroup, auxPortSyncERxStatus=auxPortSyncERxStatus, unavailableSeconds=unavailableSeconds, dfsGroup=dfsGroup, iPv4Address=iPv4Address, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, transmitterChannels=transmitterChannels, nIDULanPortStatus=nIDULanPortStatus, notificationsGroup=notificationsGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, daylightSaving=daylightSaving, maxLinkRangeExceeded=maxLinkRangeExceeded, receiveModulationMode=receiveModulationMode, configurationInstancedTable=configurationInstancedTable, configuration=configuration, transmitPower=transmitPower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, hCMPLinkSymmetry=hCMPLinkSymmetry, cableDiagPair1Distance=cableDiagPair1Distance, cableDiagnostics=cableDiagnostics, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, hTTPSPortNumber=hTTPSPortNumber, iPv6GatewayAddress=iPv6GatewayAddress, tdmTableIndex=tdmTableIndex, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, PYSNMP_MODULE_ID=cambium, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, remoteUnitName=remoteUnitName, tDMInterfaceControl=tDMInterfaceControl)
