...
# Produced by pysmi-1.1.12 at Tue May 28 12:04:01 2024
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, authorizationControl=authorizationControl, tDMChannelStatus=tDMChannelStatus, licenseGasGroup=licenseGasGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, configuration=configuration, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, txColorCode=txColorCode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessOutEthernetOctets=wirelessOutEthernetOctets, qOSPriorityScheme=qOSPriorityScheme, tDMChannelLoopback=tDMChannelLoopback, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagnosticsControl=cableDiagnosticsControl, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, ethernetInstancedTableNumber=ethernetInstancedTableNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, transparentClock=transparentClock, dNSResolver=dNSResolver, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, remoteInternetAddress=remoteInternetAddress, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, productName=productName, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dNS=dNS, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dfsPeaks=dfsPeaks, license=license, dNSServerTableEntry=dNSServerTableEntry, subnetMask=subnetMask, unitIdentificationGroup=unitIdentificationGroup, tDMEnabledChannels=tDMEnabledChannels, userTableIndex=userTableIndex, tDDControl=tDDControl, cableDiagPair4Results=cableDiagPair4Results, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkSymmetry=linkSymmetry, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, groupID=groupID, transparentClockVLAN=transparentClockVLAN, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, cableDiagPair2Distance=cableDiagPair2Distance, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfs=dfs, timeZone=timeZone, softwareVersion=softwareVersion, licenseGroup=licenseGroup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, regulatoryBandTrap=regulatoryBandTrap, auxPortAllocation=auxPortAllocation, wirelessOutOctets=wirelessOutOctets, syncETracking=syncETracking, sMTPServerInternetAddress=sMTPServerInternetAddress, siteName=siteName, wirelessLinkAvailability=wirelessLinkAvailability, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPSync=sNTPSync, cableDiagPair1Distance=cableDiagPair1Distance, transmitFreqKHz=transmitFreqKHz, transmitterChannels=transmitterChannels, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, bridgeGroup=bridgeGroup, sNTPLastSync=sNTPLastSync, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNTPServerPortNumber=sNTPServerPortNumber, licenseEncryption=licenseEncryption, unitOutOfCalibration=unitOutOfCalibration, hTTPPortNumber=hTTPPortNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, iPv6Address=iPv6Address, sNTPSyncTrap=sNTPSyncTrap, iPv6PrefixLength=iPv6PrefixLength, lowestDataModulationMode=lowestDataModulationMode, sNTPPrimaryServer=sNTPPrimaryServer, cableDiagnostics=cableDiagnostics, rawReceivePower=rawReceivePower, iPDSCPPriorityTable=iPDSCPPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, phyControl=phyControl, signalStrengthRatio=signalStrengthRatio, alarms=alarms, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, remoteInternetAddressLinked=remoteInternetAddressLinked, cableDiagnosticsWarning=cableDiagnosticsWarning, receivePowerLinked=receivePowerLinked, aAAControlGroup=aAAControlGroup, licenseMaxLinkRange=licenseMaxLinkRange, dfsTableNumber=dfsTableNumber, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, portAllocationMismatch=portAllocationMismatch, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, apcGroup=apcGroup, configurationInstancedTable=configurationInstancedTable, mainPSUPortStatusTrap=mainPSUPortStatusTrap, useVLANForMABProtocol=useVLANForMABProtocol, receiveDataRate=receiveDataRate, mgmtInstancedTableIndex=mgmtInstancedTableIndex, alarmInstancedTableNumber=alarmInstancedTableNumber, masterSlaveMode=masterSlaveMode, resetGroup=resetGroup, iPv6GatewayAddress=iPv6GatewayAddress, userName=userName, transmitModulationModeLinked=transmitModulationModeLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch, versions=versions, receiveFreqKHz=receiveFreqKHz, licenseIssueNumber=licenseIssueNumber, linkName=linkName, transmitFreqMHz=transmitFreqMHz, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, signalStrengthRatioLinked=signalStrengthRatioLinked, transmitDataRateLinked=transmitDataRateLinked, remoteMACAddress=remoteMACAddress, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, cableDiagPair2Results=cableDiagPair2Results, hTTPSPortNumber=hTTPSPortNumber, mainPSUPortStatus=mainPSUPortStatus, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mABMaintenanceLevel=mABMaintenanceLevel, cableDiagPair4Distance=cableDiagPair4Distance, rxColorCode=rxColorCode, secureModeAlarm=secureModeAlarm, ethernetStatisticsDataSource=ethernetStatisticsDataSource, mainPSUPortQLRx=mainPSUPortQLRx, alarmInstancedTableEntry=alarmInstancedTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, licenseHCMPSupport=licenseHCMPSupport, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, auxPortStatus=auxPortStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTrapPrefix=ptpTrapPrefix, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveFreqMHz=receiveFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataBridgingAvailability=dataBridgingAvailability, sNTPServerTable=sNTPServerTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseInstancedTableIndex=licenseInstancedTableIndex, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, sNTPServerTableEntry=sNTPServerTableEntry, sFPPortQLTx=sFPPortQLTx, syslogControlGroup=syslogControlGroup, linkLossLinked=linkLossLinked, transmitPowerLinked=transmitPowerLinked, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tDMChannelStatusTrap=tDMChannelStatusTrap, hCMPMaximumLinkRange=hCMPMaximumLinkRange, rawReceivePowerLinked=rawReceivePowerLinked, sNMPTrapTableEntry=sNMPTrapTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDMGroup=tDMGroup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tDMChannelLineCode=tDMChannelLineCode, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, transmitModulationMode=transmitModulationMode, nIDULanPortAutoMdix=nIDULanPortAutoMdix, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, packetsFromInternalStack=packetsFromInternalStack, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, ptpTraps=ptpTraps, portAllocationMismatchLinked=portAllocationMismatchLinked, altitude=altitude, searchState=searchState, maxLinkRangeExceeded=maxLinkRangeExceeded, tDDSynchronizationAlarm=tDDSynchronizationAlarm, wirelessLinkStatusLinked=wirelessLinkStatusLinked, capacityVariantMismatchTrap=capacityVariantMismatchTrap, l2CPPriorityTable=l2CPPriorityTable, tDDControlGroup=tDDControlGroup, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortAllocation=mainPSUPortAllocation, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, phyStatus=phyStatus, licenseUnitSerialNumber=licenseUnitSerialNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetStatisticsTable=ethernetStatisticsTable, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, ptpGroups=ptpGroups, linkLoss=linkLoss, dNSServerTableNumber=dNSServerTableNumber, deviceESN=deviceESN, auxPortSSMTx=auxPortSSMTx, dNSServerTable=dNSServerTable, auxPortStatusTrap=auxPortStatusTrap, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sFPPortAllocation=sFPPortAllocation, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, syslogControl=syslogControl, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, alarmInstancedTableIndex=alarmInstancedTableIndex, antennaSelection=antennaSelection, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mABProtocolVID=mABProtocolVID, authorizationControlTableNumber=authorizationControlTableNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sFPError=sFPError, phyControlInstancedTableEntry=phyControlInstancedTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, dfsGroup=dfsGroup, transmitDataRate=transmitDataRate, wirelessLinkStatus=wirelessLinkStatus, sFPPortQLRx=sFPPortQLRx, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseIEEE1588Support=licenseIEEE1588Support, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteInternetAddressType=remoteInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, ptp670=ptp670, dataBridgingStatusLinked=dataBridgingStatusLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, dataBridgingStatus=dataBridgingStatus, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, managementGroup=managementGroup, vectorErrorLinked=vectorErrorLinked, enableTransmission=enableTransmission, hardwareVersion=hardwareVersion, installStatusLinked=installStatusLinked, dfsTableIndex=dfsTableIndex, oOBPriorityQueueMapping=oOBPriorityQueueMapping, erroredSeconds=erroredSeconds, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sNTPServerStatus=sNTPServerStatus, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tdmTableIndex=tdmTableIndex, ethernet=ethernet, sNTPServerInternetAddressType=sNTPServerInternetAddressType, vLANManagementVID=vLANManagementVID, sFPPortAutoMdix=sFPPortAutoMdix, dNSGroup=dNSGroup, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sFPPortSSMTx=sFPPortSSMTx, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sNMPCommunityString=sNMPCommunityString, bridge=bridge, authorizationControlTable=authorizationControlTable, sntpGroup=sntpGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, lowestTDMModulationMode=lowestTDMModulationMode, alarmInstancedTable=alarmInstancedTable, licenseSyncESupport=licenseSyncESupport, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTableEntry=userTableEntry, auxPortAcceptedQLRx=auxPortAcceptedQLRx, phyInstancedStatusTable=phyInstancedStatusTable, licenseOOBManagementSupport=licenseOOBManagementSupport, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, whitelistRMMacAddress=whitelistRMMacAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseTLSRekey=licenseTLSRekey, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, deviceMSN=deviceMSN, cableDiagnosticsGroup=cableDiagnosticsGroup, longitude=longitude, authorizationControlGroup=authorizationControlGroup, ethernetInstancedTableEntry=ethernetInstancedTableEntry, auxPortQLRx=auxPortQLRx, tdmTableNumber=tdmTableNumber, channelBandwidth=channelBandwidth, tdmTable=tdmTable, maximumTransmitPower=maximumTransmitPower, wirelessTopology=wirelessTopology, encryptionGroup=encryptionGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, syslogClient=syslogClient, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, capacityVariantMismatch=capacityVariantMismatch, sNTPServerTimeout=sNTPServerTimeout, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, notificationsGroup=notificationsGroup, licenseIPv6Support=licenseIPv6Support, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptmp=ptmp, txMABFrames=txMABFrames, routerProtocolsGroup=routerProtocolsGroup, maximumNumberOfSlaves=maximumNumberOfSlaves, syncEEquipmentClock=syncEEquipmentClock, systemReset=systemReset, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNMPTrapTable=sNMPTrapTable, blacklistRMEnabled=blacklistRMEnabled, hCMPLinkSymmetry=hCMPLinkSymmetry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mgmtInstancedTableEntry=mgmtInstancedTableEntry, encryption=encryption, unitName=unitName, sNTPServerTableNumber=sNTPServerTableNumber, transmitChannel=transmitChannel, regulatoryBand=regulatoryBand, receiveChannel=receiveChannel, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, auxPortDisabledWarning=auxPortDisabledWarning, sMTPServerPortNumber=sMTPServerPortNumber, authorizationControlTableIndex=authorizationControlTableIndex, tDMChannelCableLength=tDMChannelCableLength, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, auxPortQLTx=auxPortQLTx, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, routerProtocols=routerProtocols, range=range, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, reset=reset, management=management, dataBridgingStatusAlarm=dataBridgingStatusAlarm, cableDiagPair1Results=cableDiagPair1Results, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, pubStatsGroup=pubStatsGroup, sFPErrorTrap=sFPErrorTrap, receiveDataRateLinked=receiveDataRateLinked, mgmtInstancedTable=mgmtInstancedTable, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, licenseSFPPortSupport=licenseSFPPortSupport, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, mainPSUPortSSMTx=mainPSUPortSSMTx, productVariant=productVariant, authorizationControlTableEntry=authorizationControlTableEntry, tdmTableEntry=tdmTableEntry, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tDMInterfaceControl=tDMInterfaceControl, supplementaryGroup=supplementaryGroup, capacityVariantMismatchLinked=capacityVariantMismatchLinked, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syncESlavePort=syncESlavePort, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, mABTransmissionInterval=mABTransmissionInterval, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, ethernetInstancedTableIndex=ethernetInstancedTableIndex, mABProtocolVLANPriority=mABProtocolVLANPriority, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sntp=sntp, dfsMeans=dfsMeans, sFPPortSyncERxStatus=sFPPortSyncERxStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dNSServerTableIndex=dNSServerTableIndex, licenseTrialPeriod=licenseTrialPeriod, ptpCompliance=ptpCompliance, PYSNMP_MODULE_ID=cambium, nIDULanPortStatus=nIDULanPortStatus, tFTPServerPortNumber=tFTPServerPortNumber, apc=apc, secureModeAlarmTrap=secureModeAlarmTrap, dNSPrimaryServer=dNSPrimaryServer, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, receiveModulationMode=receiveModulationMode, rangeLinked=rangeLinked, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, daylightSaving=daylightSaving, secondarySoftwareVersion=secondarySoftwareVersion, smtp=smtp, hTTPSAccessEnabled=hTTPSAccessEnabled, mainPSUPortAutoMdix=mainPSUPortAutoMdix, receiveModulationModeLinked=receiveModulationModeLinked, sNMPTrapPortNumber=sNMPTrapPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, iPv4Address=iPv4Address, mABHoldoffPeriod=mABHoldoffPeriod, l2CPPriorityTableNumber=l2CPPriorityTableNumber, remoteUnitNameLinked=remoteUnitNameLinked, packetsToInternalStack=packetsToInternalStack, whitelistRMEnabled=whitelistRMEnabled, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, installArmState=installArmState, vectorError=vectorError, wirelessOutAllOctets=wirelessOutAllOctets, licenseSecurityLevel=licenseSecurityLevel, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, telnetPortNumber=telnetPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, systemClock=systemClock, dNSServerInternetAddress=dNSServerInternetAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, byteErrorRatio=byteErrorRatio, severelyErroredSeconds=severelyErroredSeconds, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installationMode=installationMode, installStatusTrap=installStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTableIndex=sNMPTrapTableIndex, dNSServerPortNumber=dNSServerPortNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseInstancedTable=licenseInstancedTable, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sFPPortStatusTrap=sFPPortStatusTrap, telnetAccessEnabled=telnetAccessEnabled, configurationGroup=configurationGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mainPSUPortQLTx=mainPSUPortQLTx, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licenseGroupAccess=licenseGroupAccess, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNMPv3Enable=sNMPv3Enable, authorizationMethod=authorizationMethod, extendedSpectrumScanning=extendedSpectrumScanning, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, transparentClockPort=transparentClockPort, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receivePower=receivePower, versionsGroup=versionsGroup, pubInstancedStatsTable=pubInstancedStatsTable, tFTPClient=tFTPClient, snmpControlGroup=snmpControlGroup, sMTPEmailAlert=sMTPEmailAlert, tDM=tDM, ptp=ptp, smtpGroup=smtpGroup, installStatus=installStatus, ethernetPriorityTable=ethernetPriorityTable, subbandLowestFrequency=subbandLowestFrequency, licenseInstancedTableNumber=licenseInstancedTableNumber, deviceMACAddress=deviceMACAddress, snmpControl=snmpControl, userPassword=userPassword, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dSCPManagementPriority=dSCPManagementPriority, rangingMode=rangingMode, sMTPEnabledMessages=sMTPEnabledMessages, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, phyControlInstancedTable=phyControlInstancedTable, phyStatusGroup=phyStatusGroup, transmitPower=transmitPower, pubStats=pubStats, bootVersion=bootVersion, licenseTDDSyncSupport=licenseTDDSyncSupport, syslogClientTrap=syslogClientTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, targetMACAddress=targetMACAddress, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, cableDiagPair3Distance=cableDiagPair3Distance, unitIdentification=unitIdentification, syncETrackingState=syncETrackingState, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableLoss=cableLoss, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ethernetInstancedTable=ethernetInstancedTable, unavailableSeconds=unavailableSeconds, phyControlGroup=phyControlGroup, phyControlInstancedTableIndex=phyControlInstancedTableIndex, remoteUnitName=remoteUnitName, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, syslogState=syslogState, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, eIRP=eIRP, blacklistRMMacAddress=blacklistRMMacAddress, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteMACAddressLinked=remoteMACAddressLinked, mABState=mABState, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseVersion=licenseVersion, dfsTableEntry=dfsTableEntry, sNTPServerTableIndex=sNTPServerTableIndex, byteErrorRatioLinked=byteErrorRatioLinked, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, targetRange=targetRange, gatewayIPAddress=gatewayIPAddress, licenseInstancedTableEntry=licenseInstancedTableEntry, tempPcb=tempPcb, tDDSynchronizationStatus=tDDSynchronizationStatus, userRole=userRole, userTable=userTable, aggregateDataRate=aggregateDataRate)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNTPState=sNTPState, configurationInstancedTableNumber=configurationInstancedTableNumber, alarmsGroup=alarmsGroup, userEnabled=userEnabled, sNMPTrapVersion=sNMPTrapVersion, vLANManagementPriority=vLANManagementPriority, frequencyVariant=frequencyVariant, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, userTableNumber=userTableNumber, localPacketFiltering=localPacketFiltering, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, channelChangeTrap=channelChangeTrap, latitude=latitude, licenseCountry=licenseCountry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseRARSupport=licenseRARSupport, tDDSynchronizationMode=tDDSynchronizationMode, licenseCapacity=licenseCapacity, dNSServerInternetAddressType=dNSServerInternetAddressType, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogStateTrap=syslogStateTrap, aggregateDataRateLinked=aggregateDataRateLinked, ethernetGroup=ethernetGroup, configurationInstancedTableEntry=configurationInstancedTableEntry, iPVersion=iPVersion, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, cableDiagPair3Results=cableDiagPair3Results, sNTPPollInterval=sNTPPollInterval, ethernetPriorityTableEntry=ethernetPriorityTableEntry, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, dataPortPauseFrames=dataPortPauseFrames, antennaGain=antennaGain, aAAControl=aAAControl, sNTPServerRetries=sNTPServerRetries, linkModeOptimization=linkModeOptimization, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sFPPortStatus=sFPPortStatus, supplementary=supplementary, transparentClockVID=transparentClockVID, cambium=cambium, installArmStateTrap=installArmStateTrap, licenseBandwidthCap=licenseBandwidthCap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tDMInterfaceStatus=tDMInterfaceStatus, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, searchStateLinked=searchStateLinked, lbtDetectedTrap=lbtDetectedTrap, sNMPPortNumber=sNMPPortNumber, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, dfsTable=dfsTable, mABNominalModulationMode=mABNominalModulationMode)
