...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPState=sNTPState, licenseInstancedTable=licenseInstancedTable, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, searchState=searchState, sFPError=sFPError, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sFPPortStatusTrap=sFPPortStatusTrap, sNTPPollInterval=sNTPPollInterval, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, linkLossLinked=linkLossLinked, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapTableIndex=sNMPTrapTableIndex, softwareVersion=softwareVersion, authorizationMethod=authorizationMethod, ptpTrapPrefix=ptpTrapPrefix, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, packetsFromInternalStack=packetsFromInternalStack, sNMPTrapTableNumber=sNMPTrapTableNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, pubInstancedStatsTable=pubInstancedStatsTable, localPacketFiltering=localPacketFiltering, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, unitIdentificationGroup=unitIdentificationGroup, cableDiagPair2Results=cableDiagPair2Results, signalStrengthRatio=signalStrengthRatio, licenseInstancedTableEntry=licenseInstancedTableEntry, cableDiagnostics=cableDiagnostics, byteErrorRatio=byteErrorRatio, tFTPClient=tFTPClient, mABNominalModulationMode=mABNominalModulationMode, mABProtocolVID=mABProtocolVID, cableLoss=cableLoss, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPPortNumber=sNMPPortNumber, unitName=unitName, resetGroup=resetGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aAAControlGroup=aAAControlGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, managementGroup=managementGroup, authorizationControlTable=authorizationControlTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rxColorCode=rxColorCode, secureModeAlarmTrap=secureModeAlarmTrap, apcGroup=apcGroup, linkLoss=linkLoss, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, sNMPv3Enable=sNMPv3Enable, dataBridgingStatus=dataBridgingStatus, ethernetInstancedTable=ethernetInstancedTable, syslogControlGroup=syslogControlGroup, transmitPowerLinked=transmitPowerLinked, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, txMABFrames=txMABFrames, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, accessMethod=accessMethod, licenseCapacity=licenseCapacity, maximumTransmitPower=maximumTransmitPower, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, installArmState=installArmState, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mABTransmissionInterval=mABTransmissionInterval, tDDControl=tDDControl, rangingMode=rangingMode, ethernetPriorityTableEntry=ethernetPriorityTableEntry, subbandHighestFrequency=subbandHighestFrequency, dfs=dfs, eIRP=eIRP, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, aAAControl=aAAControl, transmitFreqKHz=transmitFreqKHz, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, altitude=altitude, snmpControlGroup=snmpControlGroup, unavailableSeconds=unavailableSeconds, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, rangeLinked=rangeLinked, managementNetworkAccessEnabled=managementNetworkAccessEnabled, cableDiagPair1Results=cableDiagPair1Results, qOSPriorityScheme=qOSPriorityScheme, dNSServerInternetAddressType=dNSServerInternetAddressType, installStatusLinked=installStatusLinked, dataBridgingStatusLinked=dataBridgingStatusLinked, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableDiagPair4Distance=cableDiagPair4Distance, receivePowerLinked=receivePowerLinked, maximumNumberOfSlaves=maximumNumberOfSlaves, whitelistRMEnabled=whitelistRMEnabled, ptp670=ptp670, dfsGroup=dfsGroup, regulatoryBand=regulatoryBand, productName=productName, aggregateDataRate=aggregateDataRate, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagPair3Results=cableDiagPair3Results, receivePower=receivePower, receiveModulationModeLinked=receiveModulationModeLinked, management=management, transmitModulationMode=transmitModulationMode, dNSServerInternetAddress=dNSServerInternetAddress, auxPortStatus=auxPortStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, ethernetPriorityTable=ethernetPriorityTable, packetsToInternalStack=packetsToInternalStack, auxPortSSMTx=auxPortSSMTx, alarmInstancedTableIndex=alarmInstancedTableIndex, snmpControl=snmpControl, license=license, sFPPortQLRx=sFPPortQLRx, portAllocationMismatchTrap=portAllocationMismatchTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseTrialPeriod=licenseTrialPeriod, sNTPLastSync=sNTPLastSync, mainPSUPortAllocation=mainPSUPortAllocation, deviceESN=deviceESN, mainPSUPortSSMTx=mainPSUPortSSMTx, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sFPPortStatus=sFPPortStatus, sMTPEnabledMessages=sMTPEnabledMessages, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, mABHoldoffPeriod=mABHoldoffPeriod, licenseSyncESupport=licenseSyncESupport, authorizationControlTableEntry=authorizationControlTableEntry, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetInstancedTableEntry=ethernetInstancedTableEntry, tDDControlGroup=tDDControlGroup, unitIdentification=unitIdentification, lowestDataModulationMode=lowestDataModulationMode, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, dfsTableNumber=dfsTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mgmtInstancedTableIndex=mgmtInstancedTableIndex, mainPSUPortStatus=mainPSUPortStatus, licenseSFPPortSupport=licenseSFPPortSupport, cambium=cambium, cableDiagnosticsResultTable=cableDiagnosticsResultTable, cableDiagnosticsPorts=cableDiagnosticsPorts, userEnabled=userEnabled, syslogClientTrap=syslogClientTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, subbandLowestFrequency=subbandLowestFrequency, vectorErrorLinked=vectorErrorLinked, sntp=sntp, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, l2CPPriorityTable=l2CPPriorityTable, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, telnetPortNumber=telnetPortNumber, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseInstancedTableNumber=licenseInstancedTableNumber, auxPortQLTx=auxPortQLTx, installStatusTrap=installStatusTrap, tDDSynchronizationMode=tDDSynchronizationMode, authorizationControlGroup=authorizationControlGroup, sNMPTrapTable=sNMPTrapTable, mgmtInstancedTableEntry=mgmtInstancedTableEntry, syslogState=syslogState, pubStats=pubStats, dNSServerTable=dNSServerTable, sNTPServerTimeout=sNTPServerTimeout, installArmStateTrap=installArmStateTrap, licenseGasGroup=licenseGasGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteUnitNameLinked=remoteUnitNameLinked, transmitDataRateLinked=transmitDataRateLinked, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, cableDiagnosticsControl=cableDiagnosticsControl, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, unitOutOfCalibration=unitOutOfCalibration, longitude=longitude, cableDiagPair2Distance=cableDiagPair2Distance, wirelessLinkStatus=wirelessLinkStatus, dNSServerPortNumber=dNSServerPortNumber, auxPortDisabledWarning=auxPortDisabledWarning, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerTableNumber=sNTPServerTableNumber, sFPPortSyncERxStatus=sFPPortSyncERxStatus, ptmp=ptmp, licenseCountry=licenseCountry, phyControlInstancedTable=phyControlInstancedTable, searchStateLinked=searchStateLinked, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dNSPrimaryServer=dNSPrimaryServer, remoteInternetAddressLinked=remoteInternetAddressLinked, hTTPPortNumber=hTTPPortNumber, systemClock=systemClock, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, alarmsGroup=alarmsGroup, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, routerProtocols=routerProtocols, lbtDetectedTrap=lbtDetectedTrap, ethernet=ethernet, sMTPEmailAlert=sMTPEmailAlert, authorizationControlTableNumber=authorizationControlTableNumber, tDM=tDM, tDMChannelStatusTrap=tDMChannelStatusTrap, versions=versions, sFPPortAutoNegotiation=sFPPortAutoNegotiation, receiveModulationMode=receiveModulationMode, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, phyStatus=phyStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, iPv6PrefixLength=iPv6PrefixLength, receiveFreqMHz=receiveFreqMHz, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, deviceMSN=deviceMSN, iPVersion=iPVersion, sNMPTrapVersion=sNMPTrapVersion, authorizationControlTableIndex=authorizationControlTableIndex, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, transmitPower=transmitPower, encryption=encryption, configurationInstancedTable=configurationInstancedTable, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tDMChannelLoopback=tDMChannelLoopback, antennaSelection=antennaSelection, rawReceivePowerLinked=rawReceivePowerLinked, syncETrackingState=syncETrackingState, timeZone=timeZone, transparentClockPort=transparentClockPort, pubStatsGroup=pubStatsGroup, phyStatusGroup=phyStatusGroup, tdmTableEntry=tdmTableEntry, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, txColorCode=txColorCode, ethernetStatisticsDataSource=ethernetStatisticsDataSource, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, encryptionGroup=encryptionGroup, tempPcb=tempPcb, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", syslogStateTrap=syslogStateTrap, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, dNSResolver=dNSResolver, licenseIEEE1588Support=licenseIEEE1588Support, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, userTableEntry=userTableEntry, licenseInstancedTableIndex=licenseInstancedTableIndex, smtp=smtp, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, cableDiagPair1Distance=cableDiagPair1Distance, sFPPortAutoMdix=sFPPortAutoMdix, configurationInstancedTableIndex=configurationInstancedTableIndex, sFPPortQLTx=sFPPortQLTx, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseIssueNumber=licenseIssueNumber, subnetMask=subnetMask, licenseIPv6Support=licenseIPv6Support, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteUnitName=remoteUnitName, groupID=groupID, capacityVariantMismatch=capacityVariantMismatch, supplementaryGroup=supplementaryGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vectorError=vectorError, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, extendedSpectrumScanning=extendedSpectrumScanning, linkName=linkName, auxPortAllocation=auxPortAllocation, licenseTDDSyncSupport=licenseTDDSyncSupport, dfsMeans=dfsMeans, sNTPServerTableIndex=sNTPServerTableIndex, hCMPLinkSymmetry=hCMPLinkSymmetry, userName=userName, auxPortSyncERxStatus=auxPortSyncERxStatus, authorizationControl=authorizationControl, cableDiagPair4Results=cableDiagPair4Results, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, channelChangeTrap=channelChangeTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, installStatus=installStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, tDMChannelStatus=tDMChannelStatus, dfsTableEntry=dfsTableEntry, tDMChannelLineCode=tDMChannelLineCode, licenseRARSupport=licenseRARSupport, masterSlaveMode=masterSlaveMode, licenseOOBManagementSupport=licenseOOBManagementSupport, configuration=configuration, alarmInstancedTableEntry=alarmInstancedTableEntry, dfsPeaks=dfsPeaks, erroredSeconds=erroredSeconds, alarms=alarms, smtpGroup=smtpGroup, mainPSUPortQLTx=mainPSUPortQLTx, alarmInstancedTable=alarmInstancedTable, apc=apc, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, alarmInstancedTableNumber=alarmInstancedTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitChannel=transmitChannel, secondarySoftwareVersion=secondarySoftwareVersion, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, tDMGroup=tDMGroup, sNMPEnabledTraps=sNMPEnabledTraps, phyControlInstancedTableEntry=phyControlInstancedTableEntry, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, remoteMACAddress=remoteMACAddress, iPv6Address=iPv6Address, whitelistRMMacAddress=whitelistRMMacAddress, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, antennaGain=antennaGain, transparentClockVID=transparentClockVID, iPv6GatewayAddress=iPv6GatewayAddress, siteName=siteName, ptpCompliance=ptpCompliance, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseMaxLinkRange=licenseMaxLinkRange, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tdmTable=tdmTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPSyncTrap=sNTPSyncTrap, secureModeAlarm=secureModeAlarm, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tDMChannelCableLength=tDMChannelCableLength, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, userTableNumber=userTableNumber, wirelessOutOctets=wirelessOutOctets, licenseTLSRekey=licenseTLSRekey, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionAlgorithm=encryptionAlgorithm, transparentClockVLAN=transparentClockVLAN, sFPPortSSMTx=sFPPortSSMTx, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, capacityVariantMismatchLinked=capacityVariantMismatchLinked, mgmtInstancedTable=mgmtInstancedTable, PYSNMP_MODULE_ID=cambium, versionsGroup=versionsGroup, bootVersion=bootVersion, transparentClock=transparentClock, blacklistRMMacAddress=blacklistRMMacAddress, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sFPErrorTrap=sFPErrorTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, targetRange=targetRange, dNSServerTableIndex=dNSServerTableIndex, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, telnetAccessEnabled=telnetAccessEnabled, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, signalStrengthRatioLinked=signalStrengthRatioLinked, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, portAllocationMismatch=portAllocationMismatch, dfsTableIndex=dfsTableIndex, rawReceivePower=rawReceivePower, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, mABMaintenanceLevel=mABMaintenanceLevel, daylightSaving=daylightSaving, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptp=ptp, dataBridgingAvailability=dataBridgingAvailability, ethernetInstancedTableNumber=ethernetInstancedTableNumber, syncETracking=syncETracking, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, gatewayIPAddress=gatewayIPAddress, dSCPManagementPriority=dSCPManagementPriority, userTableIndex=userTableIndex, licenseBandwidthCap=licenseBandwidthCap, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, userTable=userTable, transmitFreqMHz=transmitFreqMHz, configurationGroup=configurationGroup, receiveDataRateLinked=receiveDataRateLinked, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, vLANManagementVID=vLANManagementVID, wirelessOutEthernetOctets=wirelessOutEthernetOctets, bridge=bridge, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, capacityVariantMismatchTrap=capacityVariantMismatchTrap, syncEEquipmentClock=syncEEquipmentClock, byteErrorRatioLinked=byteErrorRatioLinked, receiveFreqKHz=receiveFreqKHz, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, frequencyVariant=frequencyVariant, useVLANForMABProtocol=useVLANForMABProtocol, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, configurationInstancedTableEntry=configurationInstancedTableEntry, sNMPCommunityString=sNMPCommunityString, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sFPPortDisabledWarning=sFPPortDisabledWarning, transmitterChannels=transmitterChannels, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNTPServerRetries=sNTPServerRetries, channelBandwidth=channelBandwidth, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, l2CPPriorityTableIndex=l2CPPriorityTableIndex, routerProtocolsGroup=routerProtocolsGroup, syncESlavePort=syncESlavePort, receiveModulationModeDetail=receiveModulationModeDetail, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, deviceMACAddress=deviceMACAddress, ptpGroups=ptpGroups, regulatoryBandTrap=regulatoryBandTrap, remoteInternetAddress=remoteInternetAddress, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, vLANManagementPriority=vLANManagementPriority, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, tDMInterfaceControl=tDMInterfaceControl, transmitDataRate=transmitDataRate, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseSecurityLevel=licenseSecurityLevel, licenseGroupAccess=licenseGroupAccess, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, hTTPAccessEnabled=hTTPAccessEnabled, ethernetGroup=ethernetGroup, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dNS=dNS, phyControlGroup=phyControlGroup, tdmTableIndex=tdmTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPv4Address=iPv4Address, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, remoteMACAddressLinked=remoteMACAddressLinked, nIDULanPortStatus=nIDULanPortStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, auxPortQLRx=auxPortQLRx, ethernetStatisticsTable=ethernetStatisticsTable, configurationInstancedTableNumber=configurationInstancedTableNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseHCMPSupport=licenseHCMPSupport, cableDiagnosticsGroup=cableDiagnosticsGroup, blacklistRMEnabled=blacklistRMEnabled, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cableDiagnosticsWarning=cableDiagnosticsWarning, range=range, reset=reset, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseEncryption=licenseEncryption, syslogClient=syslogClient, dNSServerTableEntry=dNSServerTableEntry, linkModeOptimization=linkModeOptimization, targetMACAddress=targetMACAddress, phyControl=phyControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, syslogControl=syslogControl, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tdmTableNumber=tdmTableNumber, wirelessTopology=wirelessTopology, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, supplementary=supplementary, sNTPSync=sNTPSync, sNTPPrimaryServer=sNTPPrimaryServer, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNTPServerPortNumber=sNTPServerPortNumber, licenseGroup=licenseGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, auxPortStatusTrap=auxPortStatusTrap, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, cableDiagPair3Distance=cableDiagPair3Distance, userPassword=userPassword, systemReset=systemReset, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleRegulatoryBands=incompatibleRegulatoryBands, userRole=userRole, installationMode=installationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", portAllocationMismatchLinked=portAllocationMismatchLinked, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dNSServerTableNumber=dNSServerTableNumber, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, ptpTraps=ptpTraps, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mABState=mABState, wirelessLinkStatusLinked=wirelessLinkStatusLinked, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, hardwareVersion=hardwareVersion, sNTPServerStatus=sNTPServerStatus, notificationsGroup=notificationsGroup, enableTransmission=enableTransmission, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, productVariant=productVariant, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sntpGroup=sntpGroup, transmitModulationModeLinked=transmitModulationModeLinked, remoteInternetAddressType=remoteInternetAddressType, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, aggregateDataRateLinked=aggregateDataRateLinked, wirelessOutAllOctets=wirelessOutAllOctets, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, phyInstancedStatusTable=phyInstancedStatusTable, mainPSUPortAutoMdix=mainPSUPortAutoMdix, tFTPServerInternetAddress=tFTPServerInternetAddress, sFPPortAllocation=sFPPortAllocation, licenseVersion=licenseVersion, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tFTPServerPortNumber=tFTPServerPortNumber, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, latitude=latitude, dNSGroup=dNSGroup, bridgeGroup=bridgeGroup, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sMTPServerPortNumber=sMTPServerPortNumber, maxLinkRangeExceeded=maxLinkRangeExceeded, linkSymmetry=linkSymmetry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, tDMInterfaceStatus=tDMInterfaceStatus, sNTPServerTable=sNTPServerTable, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTable=dfsTable, lowestTDMModulationMode=lowestTDMModulationMode, receiveDataRate=receiveDataRate, receiveChannel=receiveChannel, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, hTTPSPortNumber=hTTPSPortNumber, severelyErroredSeconds=severelyErroredSeconds, mgmtInstancedTableNumber=mgmtInstancedTableNumber, tDMEnabledChannels=tDMEnabledChannels, dataPortPauseFrames=dataPortPauseFrames, wirelessLinkAvailability=wirelessLinkAvailability)
