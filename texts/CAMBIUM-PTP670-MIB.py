...
# Produced by pysmi-1.1.12 at Tue Jun  4 14:09:23 2024
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", localPacketFiltering=localPacketFiltering, licenseInstancedTable=licenseInstancedTable, sNTPPrimaryServer=sNTPPrimaryServer, auxPortSyncERxStatus=auxPortSyncERxStatus, sFPPortStatusTrap=sFPPortStatusTrap, iPv4Address=iPv4Address, sntpGroup=sntpGroup, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, configurationInstancedTableIndex=configurationInstancedTableIndex, cableDiagPair1Results=cableDiagPair1Results, siteName=siteName, tDMGroup=tDMGroup, l2CPPriorityTable=l2CPPriorityTable, transmitModulationModeLinked=transmitModulationModeLinked, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, searchState=searchState, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, auxPortStatus=auxPortStatus, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, telnetPortNumber=telnetPortNumber, searchStateLinked=searchStateLinked, eIRP=eIRP, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, deviceMSN=deviceMSN, routerProtocolsGroup=routerProtocolsGroup, useVLANForMABProtocol=useVLANForMABProtocol, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseUnitSerialNumber=licenseUnitSerialNumber, sNTPSyncTrap=sNTPSyncTrap, dNSServerInternetAddressType=dNSServerInternetAddressType, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, unitIdentification=unitIdentification, ethernetPriorityTable=ethernetPriorityTable, unavailableSeconds=unavailableSeconds, deviceESN=deviceESN, blacklistRMEnabled=blacklistRMEnabled, tempPcb=tempPcb, dNSPrimaryServer=dNSPrimaryServer, tdmTableNumber=tdmTableNumber, authorizationControlTableNumber=authorizationControlTableNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, linkSymmetry=linkSymmetry, sFPPortSSMTx=sFPPortSSMTx, licenseTDDSyncSupport=licenseTDDSyncSupport, mainPSUPortAllocation=mainPSUPortAllocation, auxPortAllocation=auxPortAllocation, syncESlavePort=syncESlavePort, smtpGroup=smtpGroup, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseGroup=licenseGroup, ptpTraps=ptpTraps, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogControlGroup=syslogControlGroup, syncETracking=syncETracking, mgmtInstancedTableNumber=mgmtInstancedTableNumber, receiveFreqKHz=receiveFreqKHz, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, syncEEquipmentClock=syncEEquipmentClock, nIDULanPortStatusTrap=nIDULanPortStatusTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, txColorCode=txColorCode, remoteUnitNameLinked=remoteUnitNameLinked, softwareVersion=softwareVersion, dfsTableIndex=dfsTableIndex, licenseTLSRekey=licenseTLSRekey, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, lowestTDMModulationMode=lowestTDMModulationMode, iPDSCPPriorityTable=iPDSCPPriorityTable, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNTPState=sNTPState, vLANManagementPriority=vLANManagementPriority, routerProtocols=routerProtocols, dataPortPauseFrames=dataPortPauseFrames, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sNTPServerTable=sNTPServerTable, sNTPSync=sNTPSync, hTTPSPortNumber=hTTPSPortNumber, tDMInterfaceStatus=tDMInterfaceStatus, productName=productName, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, unitOutOfCalibration=unitOutOfCalibration, tDMChannelStatusTrap=tDMChannelStatusTrap, dataBridgingAvailability=dataBridgingAvailability, channelBandwidth=channelBandwidth, resetGroup=resetGroup, tFTPServerPortNumber=tFTPServerPortNumber, versions=versions, dNSServerTableEntry=dNSServerTableEntry, productVariant=productVariant, licenseInstancedTableIndex=licenseInstancedTableIndex, licenseSecurityLevel=licenseSecurityLevel, dataPortWirelessDownAlert=dataPortWirelessDownAlert, auxPortSSMTx=auxPortSSMTx, syslogClient=syslogClient, byteErrorRatioLinked=byteErrorRatioLinked, dfsTable=dfsTable, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dNSGroup=dNSGroup, latitude=latitude, dfs=dfs, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, pubStats=pubStats, dNSServerTableNumber=dNSServerTableNumber, apcGroup=apcGroup, targetRange=targetRange, iPv6Address=iPv6Address, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mABHoldoffPeriod=mABHoldoffPeriod, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, userEnabled=userEnabled, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogState=syslogState, cableDiagPair4Results=cableDiagPair4Results, transmitterChannels=transmitterChannels, regulatoryBandTrap=regulatoryBandTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseGasGroup=licenseGasGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, cableDiagnosticsControl=cableDiagnosticsControl, rawReceivePower=rawReceivePower, gatewayIPAddress=gatewayIPAddress, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, dNSServerTableIndex=dNSServerTableIndex, alarmInstancedTableIndex=alarmInstancedTableIndex, sFPPortDisabledWarning=sFPPortDisabledWarning, signalStrengthRatio=signalStrengthRatio, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, alarmInstancedTableNumber=alarmInstancedTableNumber, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, channelChangeTrap=channelChangeTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, dfsTableNumber=dfsTableNumber, longitude=longitude, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syncETrackingState=syncETrackingState, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, phyInstancedStatusTable=phyInstancedStatusTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, cableDiagPair2Results=cableDiagPair2Results, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, configurationInstancedTableEntry=configurationInstancedTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, configurationInstancedTableNumber=configurationInstancedTableNumber, licenseVersion=licenseVersion, transmitPowerLinked=transmitPowerLinked, licenseIssueNumber=licenseIssueNumber, sNTPServerStatus=sNTPServerStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tFTPClient=tFTPClient, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, auxPortConfigurationMismatch=auxPortConfigurationMismatch, PYSNMP_MODULE_ID=cambium, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, rawReceivePowerLinked=rawReceivePowerLinked, accessMethod=accessMethod, encryption=encryption, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, incompatibleRegulatoryBands=incompatibleRegulatoryBands, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tdmTableIndex=tdmTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, mABState=mABState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sFPError=sFPError, userRole=userRole, licenseBandwidthCap=licenseBandwidthCap, mABTransmissionInterval=mABTransmissionInterval, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, rangeLinked=rangeLinked, dataBridgingStatusLinked=dataBridgingStatusLinked, authorizationControlGroup=authorizationControlGroup, cableDiagnostics=cableDiagnostics, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, groupID=groupID, auxPortQLRx=auxPortQLRx, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, userPassword=userPassword, portAllocationMismatchTrap=portAllocationMismatchTrap, ptpCompliance=ptpCompliance, altitude=altitude, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNTPServerTableEntry=sNTPServerTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, authorizationControl=authorizationControl, ptpGroups=ptpGroups, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, rangingMode=rangingMode, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, configurationInstancedTable=configurationInstancedTable, userTableEntry=userTableEntry, authorizationControlTableIndex=authorizationControlTableIndex, license=license, bridgeGroup=bridgeGroup, linkModeOptimization=linkModeOptimization, secureModeAlarm=secureModeAlarm, installStatusTrap=installStatusTrap, capacityVariantMismatch=capacityVariantMismatch, signalStrengthRatioLinked=signalStrengthRatioLinked, linkName=linkName, pubStatsGroup=pubStatsGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, ptmp=ptmp, linkLoss=linkLoss, receiveModulationModeLinked=receiveModulationModeLinked, iPv6PrefixLength=iPv6PrefixLength, vectorError=vectorError, lbtDetectedTrap=lbtDetectedTrap, portAllocationMismatchLinked=portAllocationMismatchLinked, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, phyStatusGroup=phyStatusGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNMPTrapVersion=sNMPTrapVersion, sFPPortQLRx=sFPPortQLRx, apc=apc, cableDiagPair3Distance=cableDiagPair3Distance, licenseIPv6Support=licenseIPv6Support, transmitFreqMHz=transmitFreqMHz, maximumNumberOfSlaves=maximumNumberOfSlaves, systemReset=systemReset, receiveDataRateLinked=receiveDataRateLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tdmTableEntry=tdmTableEntry, mgmtInstancedTable=mgmtInstancedTable, ethernetInstancedTableNumber=ethernetInstancedTableNumber, subnetMask=subnetMask, dfsPeaks=dfsPeaks, tdmTable=tdmTable, wirelessOutEthernetOctets=wirelessOutEthernetOctets, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, range=range, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, alarmInstancedTableEntry=alarmInstancedTableEntry, ethernetGroup=ethernetGroup, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, dataBridgingStatusAlarm=dataBridgingStatusAlarm, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tFTPServerInternetAddressType=tFTPServerInternetAddressType, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, mABMaintenanceLevel=mABMaintenanceLevel, portAllocationMismatch=portAllocationMismatch, secureModeAlarmTrap=secureModeAlarmTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, cableDiagPair4Distance=cableDiagPair4Distance, receivePower=receivePower, wirelessLinkStatus=wirelessLinkStatus, unitName=unitName, linkLossLinked=linkLossLinked, transmitDataRateLinked=transmitDataRateLinked, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, installationMode=installationMode, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sFPPortQLTx=sFPPortQLTx, mainPSUPortQLRx=mainPSUPortQLRx, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mainPSUPortAutoMdix=mainPSUPortAutoMdix, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mgmtInstancedTableEntry=mgmtInstancedTableEntry, blacklistRMMacAddress=blacklistRMMacAddress, snmpControlGroup=snmpControlGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, supplementaryGroup=supplementaryGroup, dNSServerInternetAddress=dNSServerInternetAddress, licenseSFPPortSupport=licenseSFPPortSupport, sNTPServerInternetAddress=sNTPServerInternetAddress, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, severelyErroredSeconds=severelyErroredSeconds, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, frequencyVariant=frequencyVariant, installArmStateTrap=installArmStateTrap, versionsGroup=versionsGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, auxPortQLTx=auxPortQLTx, tDDSynchronizationStatus=tDDSynchronizationStatus, sFPPortAllocation=sFPPortAllocation, auxPortAcceptedQLRx=auxPortAcceptedQLRx, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, wirelessOutOctets=wirelessOutOctets, sNMPv3Enable=sNMPv3Enable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mABProtocolVLANPriority=mABProtocolVLANPriority, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableDiagPair1Distance=cableDiagPair1Distance, telnetAccessEnabled=telnetAccessEnabled, sMTPEnabledMessages=sMTPEnabledMessages, cableDiagPair2Distance=cableDiagPair2Distance, installStatusLinked=installStatusLinked, dfsTableEntry=dfsTableEntry, phyStatus=phyStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sntp=sntp, licenseInstancedTableNumber=licenseInstancedTableNumber, receivePowerLinked=receivePowerLinked, notificationsGroup=notificationsGroup, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, alarms=alarms, ptpTrapPrefix=ptpTrapPrefix, txMABFrames=txMABFrames, licenseOOBManagementSupport=licenseOOBManagementSupport, sNMPEnabledTraps=sNMPEnabledTraps, daylightSaving=daylightSaving, syslogClientTrap=syslogClientTrap, dSCPManagementPriority=dSCPManagementPriority, configuration=configuration, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, enableTransmission=enableTransmission, sFPPortAutoNegotiation=sFPPortAutoNegotiation, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ethernetStatisticsTable=ethernetStatisticsTable, licenseSyncESupport=licenseSyncESupport, userTableIndex=userTableIndex, timeZone=timeZone, bootVersion=bootVersion, cambium=cambium, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sFPPortSyncERxStatus=sFPPortSyncERxStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, whitelistRMMacAddress=whitelistRMMacAddress, installStatus=installStatus, unitIdentificationGroup=unitIdentificationGroup, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, transparentClock=transparentClock, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPollInterval=sNTPPollInterval, qOSPriorityScheme=qOSPriorityScheme, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, phyControlInstancedTable=phyControlInstancedTable, supplementary=supplementary, tDMChannelCableLength=tDMChannelCableLength, syslogControl=syslogControl, vLANManagementVID=vLANManagementVID, tDMConfigurationMismatch=tDMConfigurationMismatch, ethernetInstancedTable=ethernetInstancedTable, userTableNumber=userTableNumber, tDMChannelStatus=tDMChannelStatus, aggregateDataRateLinked=aggregateDataRateLinked, transmitChannel=transmitChannel, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, packetsFromInternalStack=packetsFromInternalStack, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mainPSUPortStatus=mainPSUPortStatus, masterSlaveMode=masterSlaveMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, management=management, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, authorizationControlTable=authorizationControlTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, remoteMACAddress=remoteMACAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPServerRetries=sNTPServerRetries, antennaSelection=antennaSelection, dfsGroup=dfsGroup, lowestDataModulationMode=lowestDataModulationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, encryptionGroup=encryptionGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNTPServerTableNumber=sNTPServerTableNumber, hCMPLinkSymmetry=hCMPLinkSymmetry, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sFPPortStatus=sFPPortStatus, remoteInternetAddress=remoteInternetAddress, dNSServerTable=dNSServerTable, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, transparentClockVID=transparentClockVID, ptp670=ptp670, licenseRARSupport=licenseRARSupport, nIDULanPortStatus=nIDULanPortStatus, wirelessLinkStatusLinked=wirelessLinkStatusLinked, tDM=tDM, managementNetworkAccessEnabled=managementNetworkAccessEnabled, iPVersion=iPVersion, licenseGroupAccess=licenseGroupAccess, smtp=smtp, pubInstancedStatsTable=pubInstancedStatsTable, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, deviceMACAddress=deviceMACAddress, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sNTPServerTableIndex=sNTPServerTableIndex, cableDiagnosticsGroup=cableDiagnosticsGroup, configurationGroup=configurationGroup, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, dNS=dNS, licenseEncryption=licenseEncryption, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mABProtocolVID=mABProtocolVID, dNSResolver=dNSResolver, alarmsGroup=alarmsGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, tDMEnabledChannels=tDMEnabledChannels, hCMPMaximumLinkRange=hCMPMaximumLinkRange, receiveModulationModeDetail=receiveModulationModeDetail, subbandLowestFrequency=subbandLowestFrequency, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseIEEE1588Support=licenseIEEE1588Support, systemClock=systemClock, receiveFreqMHz=receiveFreqMHz, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, snmpControl=snmpControl, transmitFreqKHz=transmitFreqKHz, erroredSeconds=erroredSeconds, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, userTable=userTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transparentClockPort=transparentClockPort, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, whitelistRMEnabled=whitelistRMEnabled, regulatoryBand=regulatoryBand, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseTrialPeriod=licenseTrialPeriod, installArmState=installArmState, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tDDControl=tDDControl, wirelessOutAllOctets=wirelessOutAllOctets, sNTPServerTimeout=sNTPServerTimeout, tDDControlGroup=tDDControlGroup, sNMPCommunityString=sNMPCommunityString, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, ptp=ptp, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, hardwareVersion=hardwareVersion, maxLinkRangeExceeded=maxLinkRangeExceeded, tDMInterfaceControl=tDMInterfaceControl, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, packetsToInternalStack=packetsToInternalStack, alarmInstancedTable=alarmInstancedTable, phyControlInstancedTableEntry=phyControlInstancedTableEntry, aAAControlGroup=aAAControlGroup, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, ethernetInstancedTableEntry=ethernetInstancedTableEntry, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, antennaGain=antennaGain, authorizationMethod=authorizationMethod, remoteInternetAddressType=remoteInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, receiveDataRate=receiveDataRate, sFPPortAutoMdix=sFPPortAutoMdix, cableDiagnosticsWarning=cableDiagnosticsWarning, iPv6GatewayAddress=iPv6GatewayAddress, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortStatusTrap=auxPortStatusTrap, reset=reset, receiveChannel=receiveChannel, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, dfsMeans=dfsMeans, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, transparentClockVLAN=transparentClockVLAN, authorizationControlTableEntry=authorizationControlTableEntry, userName=userName, managementGroup=managementGroup, remoteMACAddressLinked=remoteMACAddressLinked, licenseHCMPSupport=licenseHCMPSupport, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mainPSUPortStatusTrap=mainPSUPortStatusTrap, tDMChannelLoopback=tDMChannelLoopback, licenseMaxLinkRange=licenseMaxLinkRange, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, hTTPAccessEnabled=hTTPAccessEnabled, sFPErrorTrap=sFPErrorTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, licenseCountry=licenseCountry, sMTPEmailAlert=sMTPEmailAlert, transmitDataRate=transmitDataRate, wirelessTopology=wirelessTopology, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, aggregateDataRate=aggregateDataRate, remoteUnitName=remoteUnitName, cableLoss=cableLoss, ethernet=ethernet, ethernetPriorityTableIndex=ethernetPriorityTableIndex, vectorErrorLinked=vectorErrorLinked, phyControl=phyControl, hTTPPortNumber=hTTPPortNumber, tDMChannelLineCode=tDMChannelLineCode, tFTPServerInternetAddress=tFTPServerInternetAddress, dNSServerPortNumber=dNSServerPortNumber, auxPortDisabledWarning=auxPortDisabledWarning, ethernetInstancedTableIndex=ethernetInstancedTableIndex, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, targetMACAddress=targetMACAddress, aAAControl=aAAControl, cableDiagPair3Results=cableDiagPair3Results, phyControlGroup=phyControlGroup, dataBridgingStatus=dataBridgingStatus, subbandHighestFrequency=subbandHighestFrequency, bridge=bridge, licenseCapacity=licenseCapacity, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mABNominalModulationMode=mABNominalModulationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveModulationMode=receiveModulationMode, syslogStateTrap=syslogStateTrap, rxColorCode=rxColorCode, transmitPower=transmitPower, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, maximumTransmitPower=maximumTransmitPower)
