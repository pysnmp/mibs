...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseGasGroup=licenseGasGroup, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, auxPortQLTx=auxPortQLTx, longitude=longitude, configurationGroup=configurationGroup, portAllocationMismatch=portAllocationMismatch, timeZone=timeZone, daylightSaving=daylightSaving, linkModeOptimization=linkModeOptimization, transparentClock=transparentClock, unitName=unitName, subbandLowestFrequency=subbandLowestFrequency, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tFTPServerPortNumber=tFTPServerPortNumber, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, dfsTableNumber=dfsTableNumber, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, vLANManagementPriority=vLANManagementPriority, transparentClockVID=transparentClockVID, managementGroup=managementGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ptmp=ptmp, dfsPeaks=dfsPeaks, lowestDataModulationMode=lowestDataModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenseInstancedTableEntry=licenseInstancedTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogControl=syslogControl, routerProtocolsGroup=routerProtocolsGroup, installStatus=installStatus, receiveDataRate=receiveDataRate, cableDiagPair2Results=cableDiagPair2Results, cableDiagnosticsWarning=cableDiagnosticsWarning, searchState=searchState, antennaGain=antennaGain, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, severelyErroredSeconds=severelyErroredSeconds, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, targetMACAddress=targetMACAddress, vectorErrorLinked=vectorErrorLinked, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sFPPortStatusTrap=sFPPortStatusTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerTable=sNTPServerTable, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetInstancedTable=ethernetInstancedTable, wirelessLinkAvailability=wirelessLinkAvailability, cableDiagPair3Distance=cableDiagPair3Distance, bootVersion=bootVersion, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, qOSPriorityScheme=qOSPriorityScheme, alarms=alarms, sNMPTrapTableIndex=sNMPTrapTableIndex, linkSymmetry=linkSymmetry, licenseCountry=licenseCountry, hardwareVersion=hardwareVersion, dNSResolver=dNSResolver, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, resetGroup=resetGroup, transmitChannel=transmitChannel, mABMaintenanceLevel=mABMaintenanceLevel, signalStrengthRatio=signalStrengthRatio, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, eIRP=eIRP, blacklistRMMacAddress=blacklistRMMacAddress, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNMPv3Enable=sNMPv3Enable, dfsTable=dfsTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataBridgingAvailability=dataBridgingAvailability, cableDiagnosticsPorts=cableDiagnosticsPorts, cableDiagnosticsResultTable=cableDiagnosticsResultTable, auxPortDisabledWarning=auxPortDisabledWarning, dataBridgingStatusAlarm=dataBridgingStatusAlarm, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, syncEEquipmentClock=syncEEquipmentClock, dNSServerInternetAddressType=dNSServerInternetAddressType, sFPPortQLTx=sFPPortQLTx, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mainPSUPortQLTx=mainPSUPortQLTx, reset=reset, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, receivePowerLinked=receivePowerLinked, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, capacityVariantMismatchLinked=capacityVariantMismatchLinked, bridge=bridge, iPDSCPPriorityTable=iPDSCPPriorityTable, accessMethod=accessMethod, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, phyControlInstancedTableIndex=phyControlInstancedTableIndex, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, whitelistRMEnabled=whitelistRMEnabled, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, transparentClockVLAN=transparentClockVLAN, license=license, remoteInternetAddressType=remoteInternetAddressType, groupID=groupID, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, range=range, sNTPServerRetries=sNTPServerRetries, encryptionAlgorithm=encryptionAlgorithm, productName=productName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, snmpControl=snmpControl, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, wirelessOutEthernetOctets=wirelessOutEthernetOctets, userPassword=userPassword, nIDULanPortStatus=nIDULanPortStatus, systemClock=systemClock, aAAControl=aAAControl, tempPcb=tempPcb, cambium=cambium, receiveModulationMode=receiveModulationMode, phyStatus=phyStatus, gatewayIPAddress=gatewayIPAddress, capacityVariantMismatch=capacityVariantMismatch, installStatusLinked=installStatusLinked, dataBridgingStatus=dataBridgingStatus, transmitPowerLinked=transmitPowerLinked, authorizationControlTableNumber=authorizationControlTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortQLRx=auxPortQLRx, userEnabled=userEnabled, telnetPortNumber=telnetPortNumber, siteName=siteName, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, cableLoss=cableLoss, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sFPPortAutoMdix=sFPPortAutoMdix, pubStatsGroup=pubStatsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mABProtocolVLANPriority=mABProtocolVLANPriority, sNMPEnabledTraps=sNMPEnabledTraps, deviceESN=deviceESN, transmitFreqMHz=transmitFreqMHz, syslogState=syslogState, ethernetPriorityTableEntry=ethernetPriorityTableEntry, subbandHighestFrequency=subbandHighestFrequency, licenseIssueNumber=licenseIssueNumber, userTableEntry=userTableEntry, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseTLSRekey=licenseTLSRekey, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, linkName=linkName, receiveDataRateLinked=receiveDataRateLinked, packetsToInternalStack=packetsToInternalStack, portAllocationMismatchTrap=portAllocationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, txColorCode=txColorCode, hCMPMaximumLinkRange=hCMPMaximumLinkRange, dfsTableEntry=dfsTableEntry, ptp=ptp, ptp670=ptp670, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, tDDSynchronizationMode=tDDSynchronizationMode, lowestTDMModulationMode=lowestTDMModulationMode, userTable=userTable, licenseSecurityLevel=licenseSecurityLevel, ptpTrapPrefix=ptpTrapPrefix, rangingMode=rangingMode, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, packetsFromInternalStack=packetsFromInternalStack, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseSyncESupport=licenseSyncESupport, regulatoryBand=regulatoryBand, maximumNumberOfSlaves=maximumNumberOfSlaves, dataPortPauseFrames=dataPortPauseFrames, mgmtInstancedTableIndex=mgmtInstancedTableIndex, transmitFreqKHz=transmitFreqKHz, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mABHoldoffPeriod=mABHoldoffPeriod, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseEncryption=licenseEncryption, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, whitelistRMMacAddress=whitelistRMMacAddress, sFPPortAutoNegotiation=sFPPortAutoNegotiation, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseRegulatoryBandsList=licenseRegulatoryBandsList, tDMInterfaceStatus=tDMInterfaceStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, authorizationControlTable=authorizationControlTable, auxPortStatusTrap=auxPortStatusTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, syslogControlGroup=syslogControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, subnetMask=subnetMask, dSCPManagementPriority=dSCPManagementPriority, localPacketFiltering=localPacketFiltering, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, mainPSUPortQLRx=mainPSUPortQLRx, remoteInternetAddress=remoteInternetAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dNSServerTableIndex=dNSServerTableIndex, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseTrialPeriod=licenseTrialPeriod, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPVersion=iPVersion, notificationsGroup=notificationsGroup, auxPortSSMTx=auxPortSSMTx, ethernetInstancedTableNumber=ethernetInstancedTableNumber, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, l2CPPriorityTable=l2CPPriorityTable, remoteUnitNameLinked=remoteUnitNameLinked, phyControlInstancedTable=phyControlInstancedTable, versions=versions, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, apc=apc, receiveFreqKHz=receiveFreqKHz, hTTPAccessEnabled=hTTPAccessEnabled, signalStrengthRatioLinked=signalStrengthRatioLinked, phyControl=phyControl, versionsGroup=versionsGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, softwareVersion=softwareVersion, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseMaxLinkRange=licenseMaxLinkRange, sNTPSyncTrap=sNTPSyncTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, transmitModulationModeLinked=transmitModulationModeLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, wirelessOutOctets=wirelessOutOctets, dNS=dNS, tDMConfigurationMismatch=tDMConfigurationMismatch, sNTPPollInterval=sNTPPollInterval, configurationInstancedTableNumber=configurationInstancedTableNumber, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, erroredSeconds=erroredSeconds, transparentClockPort=transparentClockPort, receiveChannel=receiveChannel, tDMChannelCableLength=tDMChannelCableLength, alarmInstancedTableIndex=alarmInstancedTableIndex, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, wirelessLinkStatusLinked=wirelessLinkStatusLinked, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, dNSServerTableNumber=dNSServerTableNumber, tdmTable=tdmTable, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPPrimaryServer=sNTPPrimaryServer, useVLANForMABProtocol=useVLANForMABProtocol, l2CPPriorityTableIndex=l2CPPriorityTableIndex, licenseRARSupport=licenseRARSupport, dNSServerTableEntry=dNSServerTableEntry, receiveFreqMHz=receiveFreqMHz, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, alarmsGroup=alarmsGroup, sNTPServerTableIndex=sNTPServerTableIndex, auxPortConfigurationMismatch=auxPortConfigurationMismatch, dfsMeans=dfsMeans, licenseCapacity=licenseCapacity, mainPSUPortSSMTx=mainPSUPortSSMTx, PYSNMP_MODULE_ID=cambium, licenseGroupAccess=licenseGroupAccess, wirelessOutAllOctets=wirelessOutAllOctets, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sMTPServerInternetAddressType=sMTPServerInternetAddressType, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, encryption=encryption, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, installArmState=installArmState, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sFPPortAllocation=sFPPortAllocation, mainPSUPortAllocation=mainPSUPortAllocation, tDMChannelStatusTrap=tDMChannelStatusTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ethernetGroup=ethernetGroup, userName=userName, cableDiagnosticsGroup=cableDiagnosticsGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cableDiagPair4Results=cableDiagPair4Results, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, configuration=configuration, licenseTDDSyncSupport=licenseTDDSyncSupport, latitude=latitude, rawReceivePower=rawReceivePower, licenseIEEE1588Support=licenseIEEE1588Support, portAllocationMismatchLinked=portAllocationMismatchLinked, alarmInstancedTable=alarmInstancedTable, rangeLinked=rangeLinked, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tdmTableEntry=tdmTableEntry, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, vectorError=vectorError, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, tDMInterfaceControl=tDMInterfaceControl, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseGroup=licenseGroup, tDDControlGroup=tDDControlGroup, antennaSelection=antennaSelection, authorizationControlTableEntry=authorizationControlTableEntry, cableDiagPair1Results=cableDiagPair1Results, mABTransmissionInterval=mABTransmissionInterval, receivePower=receivePower, hCMPLinkSymmetry=hCMPLinkSymmetry, auxPortSyncERxStatus=auxPortSyncERxStatus, extendedSpectrumScanning=extendedSpectrumScanning, sNMPTrapTable=sNMPTrapTable, pubInstancedStatsTable=pubInstancedStatsTable, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, mgmtInstancedTableNumber=mgmtInstancedTableNumber, rxColorCode=rxColorCode, sFPError=sFPError, unitIdentification=unitIdentification, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mPLSTCPriorityTable=mPLSTCPriorityTable, wirelessLinkStatus=wirelessLinkStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, syncETrackingState=syncETrackingState, pubStats=pubStats, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mainPSUPortAutoMdix=mainPSUPortAutoMdix, deviceMSN=deviceMSN, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, byteErrorRatioLinked=byteErrorRatioLinked, dNSGroup=dNSGroup, licenseBandwidthCap=licenseBandwidthCap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tFTPClient=tFTPClient, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cableDiagPair4Distance=cableDiagPair4Distance, receiveModulationModeDetail=receiveModulationModeDetail, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerTableNumber=sNTPServerTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfs=dfs, sNTPServerStatus=sNTPServerStatus, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPLastSync=sNTPLastSync, ethernetPriorityTable=ethernetPriorityTable, syslogClient=syslogClient, channelBandwidth=channelBandwidth, authorizationControl=authorizationControl, maximumTransmitPower=maximumTransmitPower, syslogStateTrap=syslogStateTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aggregateDataRate=aggregateDataRate, authorizationControlGroup=authorizationControlGroup, dfsGroup=dfsGroup, frequencyVariant=frequencyVariant, sFPPortSyncERxStatus=sFPPortSyncERxStatus, byteErrorRatio=byteErrorRatio, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, mABNominalTransmitCapacity=mABNominalTransmitCapacity, supplementaryGroup=supplementaryGroup, searchStateLinked=searchStateLinked, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, supplementary=supplementary, mABNominalModulationMode=mABNominalModulationMode, installArmStateTrap=installArmStateTrap, transmitDataRateLinked=transmitDataRateLinked, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, capacityVariantMismatchTrap=capacityVariantMismatchTrap, auxPortAllocation=auxPortAllocation, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, dNSPrimaryServer=dNSPrimaryServer, syncESlavePort=syncESlavePort, ptpCompliance=ptpCompliance, tdmTableNumber=tdmTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, installationMode=installationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetInstancedTableEntry=ethernetInstancedTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, txMABFrames=txMABFrames, tDM=tDM, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tDMEnabledChannels=tDMEnabledChannels, sFPPortSSMTx=sFPPortSSMTx, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNTPSync=sNTPSync, sNTPServerPortNumber=sNTPServerPortNumber, syncETracking=syncETracking, enableTransmission=enableTransmission, tDMGroup=tDMGroup, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ptpTraps=ptpTraps, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dfsTableIndex=dfsTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, rawReceivePowerLinked=rawReceivePowerLinked, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, unitOutOfCalibration=unitOutOfCalibration, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sNMPTrapInternetAddress=sNMPTrapInternetAddress, cableDiagPair3Results=cableDiagPair3Results, dNSServerTable=dNSServerTable, channelChangeTrap=channelChangeTrap, licenseSFPPortSupport=licenseSFPPortSupport, licenseInstancedTableNumber=licenseInstancedTableNumber, transmitterChannels=transmitterChannels, nIDULanPortStatusTrap=nIDULanPortStatusTrap, iPv6PrefixLength=iPv6PrefixLength, userTableNumber=userTableNumber, masterSlaveMode=masterSlaveMode, sNMPTrapTableEntry=sNMPTrapTableEntry, dNSServerInternetAddress=dNSServerInternetAddress, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessTopology=wirelessTopology, remoteUnitName=remoteUnitName, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, remoteMACAddress=remoteMACAddress, targetRange=targetRange, bridgeGroup=bridgeGroup, mainPSUPortStatusTrap=mainPSUPortStatusTrap, licenseInstancedTable=licenseInstancedTable, licenseOOBManagementSupport=licenseOOBManagementSupport, lbtDetectedTrap=lbtDetectedTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNTPServerTimeout=sNTPServerTimeout, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, blacklistRMEnabled=blacklistRMEnabled, auxPortStatus=auxPortStatus, cableDiagnosticsControl=cableDiagnosticsControl, cableDiagPair1Distance=cableDiagPair1Distance, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseHCMPSupport=licenseHCMPSupport, licenseVersion=licenseVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, productVariant=productVariant, systemReset=systemReset, installStatusTrap=installStatusTrap, encryptionGroup=encryptionGroup, secureModeAlarm=secureModeAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, maxLinkRangeExceeded=maxLinkRangeExceeded, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, transmitDataRate=transmitDataRate, mainPSUPortStatus=mainPSUPortStatus, transmitPower=transmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, phyStatusGroup=phyStatusGroup, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagPair2Distance=cableDiagPair2Distance, regulatoryBandTrap=regulatoryBandTrap, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sntp=sntp, hTTPSPortNumber=hTTPSPortNumber, ethernet=ethernet, deviceMACAddress=deviceMACAddress, userRole=userRole, linkLoss=linkLoss, configurationInstancedTableEntry=configurationInstancedTableEntry, remoteMACAddressLinked=remoteMACAddressLinked, syslogClientTrap=syslogClientTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, mABProtocolVID=mABProtocolVID, smtp=smtp, linkLossLinked=linkLossLinked, apcGroup=apcGroup, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, altitude=altitude, phyControlGroup=phyControlGroup, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, unavailableSeconds=unavailableSeconds)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", configurationInstancedTable=configurationInstancedTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, unitIdentificationGroup=unitIdentificationGroup, aAAControlGroup=aAAControlGroup, sNTPState=sNTPState, authorizationControlTableIndex=authorizationControlTableIndex, cableDiagnostics=cableDiagnostics, authorizationMethod=authorizationMethod, tdmTableIndex=tdmTableIndex, tDMChannelLineCode=tDMChannelLineCode, tDMChannelLoopback=tDMChannelLoopback, hTTPPortNumber=hTTPPortNumber, licenseInstancedTableIndex=licenseInstancedTableIndex, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sFPPortStatus=sFPPortStatus, sntpGroup=sntpGroup, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sMTPServerPortNumber=sMTPServerPortNumber, vLANManagementVID=vLANManagementVID, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, ethernetStatisticsTable=ethernetStatisticsTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPErrorTrap=sFPErrorTrap, userTableIndex=userTableIndex, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sNMPCommunityString=sNMPCommunityString, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, management=management, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, tDDControl=tDDControl, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, smtpGroup=smtpGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dNSServerPortNumber=dNSServerPortNumber, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, aggregateDataRateLinked=aggregateDataRateLinked, routerProtocols=routerProtocols, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseIPv6Support=licenseIPv6Support, snmpControlGroup=snmpControlGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, transmitModulationMode=transmitModulationMode, tDMChannelStatus=tDMChannelStatus, configurationInstancedTableIndex=configurationInstancedTableIndex, sFPPortQLRx=sFPPortQLRx, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, iPv4Address=iPv4Address, ethernetInstancedTableIndex=ethernetInstancedTableIndex, receiveModulationModeLinked=receiveModulationModeLinked, mgmtInstancedTable=mgmtInstancedTable, hTTPSAccessEnabled=hTTPSAccessEnabled, iPv6Address=iPv6Address, phyInstancedStatusTable=phyInstancedStatusTable, mABState=mABState, alarmInstancedTableNumber=alarmInstancedTableNumber)
