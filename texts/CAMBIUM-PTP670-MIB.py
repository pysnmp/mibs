...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", cableDiagPair2Distance=cableDiagPair2Distance, userTable=userTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, unavailableSeconds=unavailableSeconds, routerProtocols=routerProtocols, rangeLinked=rangeLinked, licenseGasGroup=licenseGasGroup, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, remoteInternetAddressType=remoteInternetAddressType, transmitModulationModeLinked=transmitModulationModeLinked, cableDiagPair3Distance=cableDiagPair3Distance, lowestTDMModulationMode=lowestTDMModulationMode, dNS=dNS, licenseGroupAccess=licenseGroupAccess, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, capacityVariantMismatch=capacityVariantMismatch, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, auxPortSyncERxStatus=auxPortSyncERxStatus, tDDControlGroup=tDDControlGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, siteName=siteName, sNMPTrapTable=sNMPTrapTable, ethernetStatisticsTable=ethernetStatisticsTable, encryption=encryption, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sNTPServerRetries=sNTPServerRetries, localPacketFiltering=localPacketFiltering, receiveDataRate=receiveDataRate, deviceESN=deviceESN, dNSGroup=dNSGroup, regulatoryBandTrap=regulatoryBandTrap, receiveDataRateLinked=receiveDataRateLinked, userTableEntry=userTableEntry, mainPSUPortSSMTx=mainPSUPortSSMTx, txMABFrames=txMABFrames, linkName=linkName, tDMInterfaceControl=tDMInterfaceControl, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, userPassword=userPassword, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, auxPortQLRx=auxPortQLRx, cableDiagPair4Results=cableDiagPair4Results, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableLoss=cableLoss, authorizationControlTableNumber=authorizationControlTableNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, licenseInstancedTableNumber=licenseInstancedTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, sFPPortQLRx=sFPPortQLRx, unitName=unitName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, syslogState=syslogState, sNTPServerTable=sNTPServerTable, reset=reset, cableDiagnosticsPorts=cableDiagnosticsPorts, nIDULanPortStatus=nIDULanPortStatus, aggregateDataRateLinked=aggregateDataRateLinked, searchStateLinked=searchStateLinked, wirelessOutAllOctets=wirelessOutAllOctets, l2CPPriorityTable=l2CPPriorityTable, ptpCompliance=ptpCompliance, tempPcb=tempPcb, hCMPLinkSymmetry=hCMPLinkSymmetry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, vectorErrorLinked=vectorErrorLinked, timeZone=timeZone, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sNTPServerTableEntry=sNTPServerTableEntry, userTableNumber=userTableNumber, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, unitOutOfCalibration=unitOutOfCalibration, sMTPEnabledMessages=sMTPEnabledMessages, syslogClientTrap=syslogClientTrap, alarms=alarms, dfs=dfs, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, enableTransmission=enableTransmission, ethernetInstancedTableEntry=ethernetInstancedTableEntry, supplementaryGroup=supplementaryGroup, tDDControl=tDDControl, dfsMeans=dfsMeans, capacityVariantMismatchTrap=capacityVariantMismatchTrap, syncETrackingState=syncETrackingState, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, rawReceivePower=rawReceivePower, tDMChannelStatusTrap=tDMChannelStatusTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseSFPPortSupport=licenseSFPPortSupport, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mgmtInstancedTable=mgmtInstancedTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, extendedSpectrumScanning=extendedSpectrumScanning, iPv4Address=iPv4Address, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, packetsToInternalStack=packetsToInternalStack, mABNominalTransmitCapacity=mABNominalTransmitCapacity, transmitFreqKHz=transmitFreqKHz, secureModeAlarm=secureModeAlarm, mainPSUPortAllocation=mainPSUPortAllocation, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNTPPrimaryServer=sNTPPrimaryServer, linkSymmetry=linkSymmetry, remoteUnitName=remoteUnitName, rawReceivePowerLinked=rawReceivePowerLinked, licenseEncryption=licenseEncryption, cableDiagPair3Results=cableDiagPair3Results, wirelessOutEthernetOctets=wirelessOutEthernetOctets, lbtDetectedTrap=lbtDetectedTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, configurationGroup=configurationGroup, transparentClock=transparentClock, snmpControl=snmpControl, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, phyStatusGroup=phyStatusGroup, configurationInstancedTableIndex=configurationInstancedTableIndex, erroredSeconds=erroredSeconds, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sFPPortQLTx=sFPPortQLTx, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, authorizationControl=authorizationControl, licenseRARSupport=licenseRARSupport, dfsTableEntry=dfsTableEntry, auxPortDisabledWarning=auxPortDisabledWarning, sNTPSync=sNTPSync, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, ptp=ptp, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dNSServerInternetAddress=dNSServerInternetAddress, tdmTableIndex=tdmTableIndex, tdmTableNumber=tdmTableNumber, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, licenseIPv6Support=licenseIPv6Support, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, blacklistRMMacAddress=blacklistRMMacAddress, routerProtocolsGroup=routerProtocolsGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, management=management, phyControl=phyControl, auxPortStatus=auxPortStatus, tdmTableEntry=tdmTableEntry, maximumTransmitPower=maximumTransmitPower, alarmInstancedTableEntry=alarmInstancedTableEntry, configuration=configuration, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, cableDiagnosticsControl=cableDiagnosticsControl, sMTPServerInternetAddress=sMTPServerInternetAddress, incompatibleRegulatoryBands=incompatibleRegulatoryBands, altitude=altitude, cambium=cambium, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, tdmTable=tdmTable, sMTPServerPortNumber=sMTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, userName=userName, linkLossLinked=linkLossLinked, authorizationControlGroup=authorizationControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPState=sNTPState, notificationsGroup=notificationsGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, gatewayIPAddress=gatewayIPAddress, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, licenseIssueNumber=licenseIssueNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, configurationInstancedTableNumber=configurationInstancedTableNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, mABMaintenanceLevel=mABMaintenanceLevel, txColorCode=txColorCode, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, transmitFreqMHz=transmitFreqMHz, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPSPortNumber=hTTPSPortNumber, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, mgmtInstancedTableEntry=mgmtInstancedTableEntry, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, syslogClient=syslogClient, licenseSecurityLevel=licenseSecurityLevel, syslogControlGroup=syslogControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, auxPortQLTx=auxPortQLTx, auxPortAcceptedQLRx=auxPortAcceptedQLRx, licenseTDDSyncSupport=licenseTDDSyncSupport, hardwareVersion=hardwareVersion, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, dfsTableIndex=dfsTableIndex, versionsGroup=versionsGroup, dataBridgingStatusAlarm=dataBridgingStatusAlarm, maxLinkRangeExceeded=maxLinkRangeExceeded, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, bootVersion=bootVersion, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sntp=sntp, tDMChannelLineCode=tDMChannelLineCode, licenseVersion=licenseVersion, sNMPTrapInternetAddress=sNMPTrapInternetAddress, receivePowerLinked=receivePowerLinked, severelyErroredSeconds=severelyErroredSeconds, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, alarmInstancedTableIndex=alarmInstancedTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, cableDiagnosticsResultTable=cableDiagnosticsResultTable, aAAControlGroup=aAAControlGroup, deviceMACAddress=deviceMACAddress, versions=versions, managementGroup=managementGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, mABProtocolVLANPriority=mABProtocolVLANPriority, sNTPServerStatus=sNTPServerStatus, rangingMode=rangingMode, maximumNumberOfSlaves=maximumNumberOfSlaves, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, tDMEnabledChannels=tDMEnabledChannels, remoteUnitNameLinked=remoteUnitNameLinked, ethernetInstancedTable=ethernetInstancedTable, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, byteErrorRatio=byteErrorRatio, pubInstancedStatsTable=pubInstancedStatsTable, installationMode=installationMode, sNTPSyncTrap=sNTPSyncTrap, secureModeAlarmTrap=secureModeAlarmTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transmitChannel=transmitChannel, auxPortSSMTx=auxPortSSMTx, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, installArmState=installArmState, dNSServerPortNumber=dNSServerPortNumber, userEnabled=userEnabled, mABHoldoffPeriod=mABHoldoffPeriod, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, installArmStateTrap=installArmStateTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, authorizationControlTableIndex=authorizationControlTableIndex, dNSPrimaryServer=dNSPrimaryServer, linkModeOptimization=linkModeOptimization, signalStrengthRatioLinked=signalStrengthRatioLinked, subbandLowestFrequency=subbandLowestFrequency, iPv6GatewayAddress=iPv6GatewayAddress, phyControlInstancedTableNumber=phyControlInstancedTableNumber, range=range, licenseHCMPSupport=licenseHCMPSupport, license=license, unitIdentificationGroup=unitIdentificationGroup, hCMPMaximumLinkRange=hCMPMaximumLinkRange, dNSServerTableIndex=dNSServerTableIndex, licenseGroup=licenseGroup, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, dNSServerTableEntry=dNSServerTableEntry, receiveChannel=receiveChannel, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, remoteInternetAddress=remoteInternetAddress, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tDMChannelStatus=tDMChannelStatus, mABState=mABState, syncETracking=syncETracking, receivePower=receivePower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, blacklistRMEnabled=blacklistRMEnabled, transmitDataRate=transmitDataRate, dataBridgingAvailability=dataBridgingAvailability, phyStatus=phyStatus, sNTPLastSync=sNTPLastSync, transmitPower=transmitPower, cableDiagnosticsGroup=cableDiagnosticsGroup, phyControlGroup=phyControlGroup, bridge=bridge, snmpControlGroup=snmpControlGroup, ethernetGroup=ethernetGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, aggregateDataRate=aggregateDataRate, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, licenseUnitSerialNumber=licenseUnitSerialNumber, subnetMask=subnetMask, licenseOOBManagementSupport=licenseOOBManagementSupport, rxColorCode=rxColorCode, tFTPServerPortNumber=tFTPServerPortNumber, sFPErrorTrap=sFPErrorTrap, dNSServerTableNumber=dNSServerTableNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sFPPortSyncERxStatus=sFPPortSyncERxStatus, dfsTable=dfsTable, alarmsGroup=alarmsGroup, bridgeGroup=bridgeGroup, syncEEquipmentClock=syncEEquipmentClock, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, tDMChannelLoopback=tDMChannelLoopback, apc=apc, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, groupID=groupID, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, ethernet=ethernet, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, packetsFromInternalStack=packetsFromInternalStack, softwareVersion=softwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, channelChangeTrap=channelChangeTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, antennaSelection=antennaSelection, remoteMACAddress=remoteMACAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogControl=syslogControl, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, linkLoss=linkLoss, encryptionGroup=encryptionGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, transparentClockVLAN=transparentClockVLAN, unitIdentification=unitIdentification, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, wirelessTopology=wirelessTopology, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dataBridgingStatusLinked=dataBridgingStatusLinked, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, iPv6Address=iPv6Address, iPv6PrefixLength=iPv6PrefixLength, remoteMACAddressLinked=remoteMACAddressLinked, auxPortStatusTrap=auxPortStatusTrap, sFPPortAllocation=sFPPortAllocation, mainPSUPortQLTx=mainPSUPortQLTx, authorizationControlTable=authorizationControlTable, telnetPortNumber=telnetPortNumber, receiveModulationMode=receiveModulationMode, tDM=tDM, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, wirelessLinkStatusLinked=wirelessLinkStatusLinked, auxPortAllocation=auxPortAllocation, phyInstancedStatusTable=phyInstancedStatusTable, accessMethod=accessMethod, regulatoryBand=regulatoryBand, tDMChannelCableLength=tDMChannelCableLength, phyControlInstancedTableIndex=phyControlInstancedTableIndex, licenseInstancedTable=licenseInstancedTable, mABProtocolVID=mABProtocolVID, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, portAllocationMismatch=portAllocationMismatch, systemReset=systemReset, qOSPriorityScheme=qOSPriorityScheme, receiveFreqMHz=receiveFreqMHz, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, syncESlavePort=syncESlavePort, channelBandwidth=channelBandwidth, longitude=longitude, iPVersion=iPVersion, sNMPTrapVersion=sNMPTrapVersion, authorizationControlTableEntry=authorizationControlTableEntry, licenseCapacity=licenseCapacity, ptp670=ptp670, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, mainPSUPortAutoMdix=mainPSUPortAutoMdix, transmitModulationMode=transmitModulationMode, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, pubStats=pubStats, resetGroup=resetGroup, cableDiagPair4Distance=cableDiagPair4Distance, dNSResolver=dNSResolver, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, useVLANForMABProtocol=useVLANForMABProtocol, eIRP=eIRP, cableDiagPair1Results=cableDiagPair1Results, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, cableDiagPair2Results=cableDiagPair2Results, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sNMPCommunityString=sNMPCommunityString, dfsPeaks=dfsPeaks, smtpGroup=smtpGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, frequencyVariant=frequencyVariant, sNMPv3Enable=sNMPv3Enable, cableDiagnosticsWarning=cableDiagnosticsWarning, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, dfsTableNumber=dfsTableNumber, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, nIDULanPortStatusTrap=nIDULanPortStatusTrap, latitude=latitude, byteErrorRatioLinked=byteErrorRatioLinked, ptpGroups=ptpGroups, transmitPowerLinked=transmitPowerLinked, ethernetInstancedTableIndex=ethernetInstancedTableIndex, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sMTPEmailAlert=sMTPEmailAlert, smtp=smtp, lowestDataModulationMode=lowestDataModulationMode, portAllocationMismatchTrap=portAllocationMismatchTrap, vLANManagementVID=vLANManagementVID, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sFPPortAutoMdix=sFPPortAutoMdix, ptpTraps=ptpTraps, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, vectorError=vectorError, installStatusTrap=installStatusTrap, transparentClockPort=transparentClockPort, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, authorizationMethod=authorizationMethod, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, iPDSCPPriorityTable=iPDSCPPriorityTable, sFPPortDisabledWarning=sFPPortDisabledWarning, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, pubStatsGroup=pubStatsGroup, subbandHighestFrequency=subbandHighestFrequency, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPEnabledTraps=sNMPEnabledTraps, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseCountry=licenseCountry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataBridgingStatus=dataBridgingStatus, masterSlaveMode=masterSlaveMode, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sNTPServerTableIndex=sNTPServerTableIndex, tFTPClient=tFTPClient, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sFPError=sFPError, licenseTrialPeriod=licenseTrialPeriod, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sFPPortStatusTrap=sFPPortStatusTrap, hTTPPortNumber=hTTPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, mABTransmissionInterval=mABTransmissionInterval, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, alarmInstancedTable=alarmInstancedTable, productName=productName, apcGroup=apcGroup, targetRange=targetRange, ethernetPriorityTable=ethernetPriorityTable, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, wirelessLinkStatus=wirelessLinkStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, aAAControl=aAAControl, mainPSUPortStatus=mainPSUPortStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkAvailability=wirelessLinkAvailability, sntpGroup=sntpGroup, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, whitelistRMEnabled=whitelistRMEnabled, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dSCPManagementPriority=dSCPManagementPriority, antennaGain=antennaGain, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveModulationModeLinked=receiveModulationModeLinked, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, targetMACAddress=targetMACAddress, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, phyControlInstancedTableEntry=phyControlInstancedTableEntry, tDMGroup=tDMGroup, telnetAccessEnabled=telnetAccessEnabled, tDMInterfaceStatus=tDMInterfaceStatus, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, installStatusLinked=installStatusLinked, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableIndex=userTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mainPSUPortQLRx=mainPSUPortQLRx, sNTPServerTimeout=sNTPServerTimeout, dataPortPauseFrames=dataPortPauseFrames, licenseIEEE1588Support=licenseIEEE1588Support, receiveModulationModeDetail=receiveModulationModeDetail, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, userRole=userRole, dfsGroup=dfsGroup, remoteInternetAddressLinked=remoteInternetAddressLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, licenseSyncESupport=licenseSyncESupport, systemClock=systemClock, licenseBandwidthCap=licenseBandwidthCap, phyControlInstancedTable=phyControlInstancedTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, PYSNMP_MODULE_ID=cambium, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, configurationInstancedTable=configurationInstancedTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, cableDiagnostics=cableDiagnostics, capacityVariantMismatchLinked=capacityVariantMismatchLinked, transmitDataRateLinked=transmitDataRateLinked, mABNominalModulationMode=mABNominalModulationMode, ethernetInstancedTableNumber=ethernetInstancedTableNumber, dNSServerInternetAddressType=dNSServerInternetAddressType, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseMaxLinkRange=licenseMaxLinkRange, dNSServerTable=dNSServerTable, sNMPPortNumber=sNMPPortNumber, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, deviceMSN=deviceMSN, daylightSaving=daylightSaving, searchState=searchState, vLANManagementPriority=vLANManagementPriority, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sFPPortSSMTx=sFPPortSSMTx, wirelessOutOctets=wirelessOutOctets, tFTPServerInternetAddress=tFTPServerInternetAddress, alarmInstancedTableNumber=alarmInstancedTableNumber, portAllocationMismatchLinked=portAllocationMismatchLinked, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseInstancedTableIndex=licenseInstancedTableIndex, transparentClockVID=transparentClockVID, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, productVariant=productVariant, transmitterChannels=transmitterChannels, receiveFreqKHz=receiveFreqKHz, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sFPPortStatus=sFPPortStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, installStatus=installStatus, signalStrengthRatio=signalStrengthRatio, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, syslogStateTrap=syslogStateTrap, cableDiagPair1Distance=cableDiagPair1Distance, whitelistRMMacAddress=whitelistRMMacAddress, licenseTLSRekey=licenseTLSRekey)
