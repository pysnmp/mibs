...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortAcceptedQLRx=auxPortAcceptedQLRx, configurationGroup=configurationGroup, dfsMeans=dfsMeans, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tFTPClient=tFTPClient, localPacketFiltering=localPacketFiltering, encryptionGroup=encryptionGroup, alarmInstancedTableEntry=alarmInstancedTableEntry, byteErrorRatio=byteErrorRatio, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tdmTableIndex=tdmTableIndex, receiveModulationMode=receiveModulationMode, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sNTPState=sNTPState, configuration=configuration, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, dataBridgingAvailability=dataBridgingAvailability, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, resetGroup=resetGroup, licenseInstancedTableEntry=licenseInstancedTableEntry, encryptionAlgorithm=encryptionAlgorithm, authorizationControl=authorizationControl, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userRole=userRole, tDMConfigurationMismatch=tDMConfigurationMismatch, smtpGroup=smtpGroup, sFPPortStatusTrap=sFPPortStatusTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, tDDControl=tDDControl, auxPortQLRx=auxPortQLRx, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, dfsTable=dfsTable, sntpGroup=sntpGroup, licenseVersion=licenseVersion, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, tempPcb=tempPcb, phyInstancedStatusTable=phyInstancedStatusTable, receiveFreqKHz=receiveFreqKHz, licenseIEEE1588Support=licenseIEEE1588Support, syslogStateTrap=syslogStateTrap, dNSResolver=dNSResolver, phyStatus=phyStatus, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNMPTrapVersion=sNMPTrapVersion, dfsGroup=dfsGroup, mABTransmissionInterval=mABTransmissionInterval, licenseRARSupport=licenseRARSupport, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, versions=versions, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, authorizationMethod=authorizationMethod, lowestDataModulationMode=lowestDataModulationMode, userTableNumber=userTableNumber, dataBridgingStatusLinked=dataBridgingStatusLinked, frequencyVariant=frequencyVariant, licenseIssueNumber=licenseIssueNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANManagementPriority=vLANManagementPriority, cableDiagnosticsPorts=cableDiagnosticsPorts, hTTPSPortNumber=hTTPSPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, syslogClient=syslogClient, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, maximumNumberOfSlaves=maximumNumberOfSlaves, syncETracking=syncETracking, vectorError=vectorError, systemReset=systemReset, deviceMSN=deviceMSN, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, phyStatusGroup=phyStatusGroup, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dSCPManagementPriority=dSCPManagementPriority, mABNominalModulationMode=mABNominalModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, lowestTDMModulationMode=lowestTDMModulationMode, portAllocationMismatchLinked=portAllocationMismatchLinked, reset=reset, rawReceivePower=rawReceivePower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dNSServerTableNumber=dNSServerTableNumber, sntp=sntp, snmpControl=snmpControl, dfsPeaks=dfsPeaks, wirelessOutOctets=wirelessOutOctets, l2CPPriorityTable=l2CPPriorityTable, licenseCapacity=licenseCapacity, sMTPServerPortNumber=sMTPServerPortNumber, txColorCode=txColorCode, licenseSecurityLevel=licenseSecurityLevel, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerTable=sNTPServerTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tDMChannelStatus=tDMChannelStatus, configurationInstancedTable=configurationInstancedTable, transparentClock=transparentClock, pubStatsGroup=pubStatsGroup, sFPPortAllocation=sFPPortAllocation, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitFreqMHz=transmitFreqMHz, remoteInternetAddressLinked=remoteInternetAddressLinked, supplementaryGroup=supplementaryGroup, linkModeOptimization=linkModeOptimization, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, nIDULanPortAutoMdix=nIDULanPortAutoMdix, deviceMACAddress=deviceMACAddress, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, severelyErroredSeconds=severelyErroredSeconds, authorizationControlTableNumber=authorizationControlTableNumber, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, capacityVariantMismatchTrap=capacityVariantMismatchTrap, linkName=linkName, packetsToInternalStack=packetsToInternalStack, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, ptpTrapPrefix=ptpTrapPrefix, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfsTableNumber=dfsTableNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, unitOutOfCalibration=unitOutOfCalibration, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, whitelistRMEnabled=whitelistRMEnabled, cableDiagPair4Distance=cableDiagPair4Distance, telnetAccessEnabled=telnetAccessEnabled, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, management=management, unitName=unitName, dNSServerTableIndex=dNSServerTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, notificationsGroup=notificationsGroup, alarmInstancedTableNumber=alarmInstancedTableNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, subnetMask=subnetMask, transparentClockPort=transparentClockPort, licenseInstancedTable=licenseInstancedTable, auxPortStatus=auxPortStatus, routerProtocols=routerProtocols, ethernetPriorityTableIndex=ethernetPriorityTableIndex, auxPortAllocation=auxPortAllocation, timeZone=timeZone, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, capacityVariantMismatchLinked=capacityVariantMismatchLinked, extendedSpectrumScanning=extendedSpectrumScanning, hTTPSAccessEnabled=hTTPSAccessEnabled, hTTPAccessEnabled=hTTPAccessEnabled, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseGroupAccess=licenseGroupAccess, installStatusLinked=installStatusLinked, channelChangeTrap=channelChangeTrap, transmitModulationMode=transmitModulationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseHCMPSupport=licenseHCMPSupport, receivePower=receivePower, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, cableDiagnostics=cableDiagnostics, installStatusTrap=installStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, bootVersion=bootVersion, licenseIPv6Support=licenseIPv6Support, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveModulationModeDetail=receiveModulationModeDetail, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseTrialPeriod=licenseTrialPeriod, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, portAllocationMismatch=portAllocationMismatch, aAAControl=aAAControl, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDControlGroup=tDDControlGroup, cableDiagPair4Results=cableDiagPair4Results, accessMethod=accessMethod, rxColorCode=rxColorCode, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, transparentClockVID=transparentClockVID, transmitterChannels=transmitterChannels, regulatoryBand=regulatoryBand, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telnetPortNumber=telnetPortNumber, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, apcGroup=apcGroup, userEnabled=userEnabled, antennaSelection=antennaSelection, sNTPPollInterval=sNTPPollInterval, qOSPriorityScheme=qOSPriorityScheme, phyControl=phyControl, signalStrengthRatioLinked=signalStrengthRatioLinked, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, maxLinkRangeExceeded=maxLinkRangeExceeded, sNTPServerTableNumber=sNTPServerTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, productVariant=productVariant, remoteUnitNameLinked=remoteUnitNameLinked, remoteInternetAddress=remoteInternetAddress, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, unitIdentificationGroup=unitIdentificationGroup, ptp670=ptp670, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseInstancedTableIndex=licenseInstancedTableIndex, transmitFreqKHz=transmitFreqKHz, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, masterSlaveMode=masterSlaveMode, cableDiagnosticsWarning=cableDiagnosticsWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitPower=transmitPower, mainPSUPortQLRx=mainPSUPortQLRx, authorizationControlTableIndex=authorizationControlTableIndex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, secondarySoftwareVersion=secondarySoftwareVersion, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, productName=productName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, mABMaintenanceLevel=mABMaintenanceLevel, sNMPTrapTable=sNMPTrapTable, packetsFromInternalStack=packetsFromInternalStack, iPv6Address=iPv6Address, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, ethernetGroup=ethernetGroup, regulatoryBandTrap=regulatoryBandTrap, sFPPortAutoMdix=sFPPortAutoMdix, ptpTraps=ptpTraps, dNSServerInternetAddressType=dNSServerInternetAddressType, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, snmpControlGroup=snmpControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, byteErrorRatioLinked=byteErrorRatioLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseMaxLinkRange=licenseMaxLinkRange, alarms=alarms, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mABHoldoffPeriod=mABHoldoffPeriod, lbtDetectedTrap=lbtDetectedTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mainPSUPortQLTx=mainPSUPortQLTx, subbandHighestFrequency=subbandHighestFrequency, tdmTable=tdmTable, syncEEquipmentClock=syncEEquipmentClock, iPDSCPPriorityTable=iPDSCPPriorityTable, licenseSFPPortSupport=licenseSFPPortSupport, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, cableDiagPair2Results=cableDiagPair2Results, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPSyncTrap=sNTPSyncTrap, pubInstancedStatsTable=pubInstancedStatsTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, auxPortSyncERxStatus=auxPortSyncERxStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseCountry=licenseCountry, tDMInterfaceControl=tDMInterfaceControl, auxPortQLTx=auxPortQLTx, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, cableDiagPair2Distance=cableDiagPair2Distance, rangeLinked=rangeLinked, l2CPPriorityTableEntry=l2CPPriorityTableEntry, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, userPassword=userPassword, receiveDataRateLinked=receiveDataRateLinked, alarmInstancedTable=alarmInstancedTable, sNTPServerInternetAddress=sNTPServerInternetAddress, bridge=bridge, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mgmtInstancedTableIndex=mgmtInstancedTableIndex, softwareVersion=softwareVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, tDMChannelStatusTrap=tDMChannelStatusTrap, systemClock=systemClock, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseBandwidthCap=licenseBandwidthCap, eIRP=eIRP, txMABFrames=txMABFrames, range=range, tDMChannelLoopback=tDMChannelLoopback, linkSymmetry=linkSymmetry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, alarmInstancedTableIndex=alarmInstancedTableIndex, groupID=groupID, linkLoss=linkLoss, authorizationControlGroup=authorizationControlGroup, authorizationControlTableEntry=authorizationControlTableEntry, ethernetPriorityTable=ethernetPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, aAAControlGroup=aAAControlGroup, configurationInstancedTableEntry=configurationInstancedTableEntry, dNSServerInternetAddress=dNSServerInternetAddress, ethernetInstancedTable=ethernetInstancedTable, transparentClockVLAN=transparentClockVLAN, dNSServerPortNumber=dNSServerPortNumber, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, targetMACAddress=targetMACAddress, cambium=cambium, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, searchStateLinked=searchStateLinked, daylightSaving=daylightSaving, dfsTableEntry=dfsTableEntry, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, remoteMACAddress=remoteMACAddress, dataPortPauseFrames=dataPortPauseFrames, ethernet=ethernet, cableLoss=cableLoss, useVLANForMABProtocol=useVLANForMABProtocol, wirelessTopology=wirelessTopology, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, licenseTDDSyncSupport=licenseTDDSyncSupport, sFPPortStatus=sFPPortStatus, userTableEntry=userTableEntry, remoteMACAddressLinked=remoteMACAddressLinked, cableDiagnosticsResultTable=cableDiagnosticsResultTable, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, longitude=longitude, remoteUnitName=remoteUnitName, ethernetInstancedTableIndex=ethernetInstancedTableIndex, syncETrackingState=syncETrackingState, licenseInstancedTableNumber=licenseInstancedTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPv4Address=iPv4Address, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPLastSync=sNTPLastSync, hardwareVersion=hardwareVersion, dataBridgingStatus=dataBridgingStatus, licenseOOBManagementSupport=licenseOOBManagementSupport, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, configurationInstancedTableNumber=configurationInstancedTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, enableTransmission=enableTransmission, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, dataBridgingStatusAlarm=dataBridgingStatusAlarm, phyControlInstancedTableNumber=phyControlInstancedTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, managementGroup=managementGroup, syncESlavePort=syncESlavePort, sFPPortDisabledWarning=sFPPortDisabledWarning, transmitDataRateLinked=transmitDataRateLinked, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseSyncESupport=licenseSyncESupport, capacityVariantMismatch=capacityVariantMismatch, iPv6PrefixLength=iPv6PrefixLength, sNMPEnabledTraps=sNMPEnabledTraps, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, ethernetInstancedTableEntry=ethernetInstancedTableEntry, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, installArmState=installArmState, linkLossLinked=linkLossLinked, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, licenseGasGroup=licenseGasGroup, altitude=altitude, bridgeGroup=bridgeGroup, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, hCMPLinkSymmetry=hCMPLinkSymmetry, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sNMPv3Enable=sNMPv3Enable, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, licenseGroup=licenseGroup, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tDMChannelLineCode=tDMChannelLineCode, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, syslogClientTrap=syslogClientTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, receiveDataRate=receiveDataRate, sMTPEmailAlert=sMTPEmailAlert, authorizationControlTable=authorizationControlTable, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, tDM=tDM, targetRange=targetRange, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, license=license, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANManagementVID=vLANManagementVID, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, installArmStateTrap=installArmStateTrap, userTable=userTable, mainPSUPortAllocation=mainPSUPortAllocation, remoteInternetAddressType=remoteInternetAddressType, alarmsGroup=alarmsGroup, pubStats=pubStats, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, antennaGain=antennaGain, subbandLowestFrequency=subbandLowestFrequency, auxPortSSMTx=auxPortSSMTx, transmitDataRate=transmitDataRate, iPv6GatewayAddress=iPv6GatewayAddress, tdmTableEntry=tdmTableEntry, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, encryption=encryption, cableDiagPair1Results=cableDiagPair1Results, supplementary=supplementary, ptmp=ptmp, mABState=mABState, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, receiveChannel=receiveChannel, dNSGroup=dNSGroup, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, cableDiagPair3Results=cableDiagPair3Results, receivePowerLinked=receivePowerLinked, syslogControlGroup=syslogControlGroup, ethernetStatisticsTable=ethernetStatisticsTable, smtp=smtp, receiveFreqMHz=receiveFreqMHz, tDMInterfaceStatus=tDMInterfaceStatus, phyControlGroup=phyControlGroup, sNTPSync=sNTPSync, sNTPServerTimeout=sNTPServerTimeout, gatewayIPAddress=gatewayIPAddress, iPVersion=iPVersion, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, cableDiagnosticsGroup=cableDiagnosticsGroup, transmitChannel=transmitChannel, dNSPrimaryServer=dNSPrimaryServer, channelBandwidth=channelBandwidth, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, maximumTransmitPower=maximumTransmitPower, tDMChannelCableLength=tDMChannelCableLength, ptp=ptp, aggregateDataRate=aggregateDataRate, unitIdentification=unitIdentification, routerProtocolsGroup=routerProtocolsGroup, sNMPPortNumber=sNMPPortNumber, cableDiagnosticsControl=cableDiagnosticsControl, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mgmtInstancedTableNumber=mgmtInstancedTableNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dNSServerTableEntry=dNSServerTableEntry, tDMEnabledChannels=tDMEnabledChannels, cableDiagPair3Distance=cableDiagPair3Distance, userName=userName, whitelistRMMacAddress=whitelistRMMacAddress, rangingMode=rangingMode, blacklistRMMacAddress=blacklistRMMacAddress, siteName=siteName, ethernetStatisticsDataSource=ethernetStatisticsDataSource, wirelessOutEthernetOctets=wirelessOutEthernetOctets, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installStatus=installStatus, sFPError=sFPError, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rawReceivePowerLinked=rawReceivePowerLinked, transmitPowerLinked=transmitPowerLinked, nIDULanPortStatus=nIDULanPortStatus, mainPSUPortSSMTx=mainPSUPortSSMTx, wirelessLinkAvailability=wirelessLinkAvailability, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, blacklistRMEnabled=blacklistRMEnabled, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, dNS=dNS, latitude=latitude, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tdmTableNumber=tdmTableNumber, sFPErrorTrap=sFPErrorTrap, signalStrengthRatio=signalStrengthRatio, mainPSUPortStatus=mainPSUPortStatus, searchState=searchState, tDMGroup=tDMGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, hTTPPortNumber=hTTPPortNumber, transmitModulationModeLinked=transmitModulationModeLinked, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, deviceESN=deviceESN, apc=apc, tFTPServerPortNumber=tFTPServerPortNumber, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, mABProtocolVLANPriority=mABProtocolVLANPriority, phyControlInstancedTable=phyControlInstancedTable, sNTPServerRetries=sNTPServerRetries, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsTableIndex=dfsTableIndex, userTableIndex=userTableIndex, licenseEncryption=licenseEncryption, ptpGroups=ptpGroups, sNTPServerStatus=sNTPServerStatus, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, receiveModulationModeLinked=receiveModulationModeLinked, auxPortDisabledWarning=auxPortDisabledWarning, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sFPPortSSMTx=sFPPortSSMTx, PYSNMP_MODULE_ID=cambium, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mgmtInstancedTable=mgmtInstancedTable, unavailableSeconds=unavailableSeconds, sFPPortAutoNegotiation=sFPPortAutoNegotiation, tDDSynchronizationMode=tDDSynchronizationMode, wirelessOutAllOctets=wirelessOutAllOctets, installationMode=installationMode, cableDiagPair1Distance=cableDiagPair1Distance, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityString=sNMPCommunityString, versionsGroup=versionsGroup, aggregateDataRateLinked=aggregateDataRateLinked, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, portAllocationMismatchTrap=portAllocationMismatchTrap, dNSServerTable=dNSServerTable, vectorErrorLinked=vectorErrorLinked, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, dfs=dfs, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogControl=syslogControl, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sFPPortQLRx=sFPPortQLRx, ethernetPriorityTableEntry=ethernetPriorityTableEntry, nIDULanPortStatusTrap=nIDULanPortStatusTrap, syslogState=syslogState, auxPortStatusTrap=auxPortStatusTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseTLSRekey=licenseTLSRekey, sFPPortQLTx=sFPPortQLTx, mABProtocolVID=mABProtocolVID, secureModeAlarm=secureModeAlarm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, erroredSeconds=erroredSeconds)
