...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, syslogControlGroup=syslogControlGroup, vLANManagementVID=vLANManagementVID, ethernet=ethernet, transparentClockPort=transparentClockPort, lowestDataModulationMode=lowestDataModulationMode, licenseGroupAccess=licenseGroupAccess, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mgmtInstancedTableIndex=mgmtInstancedTableIndex, deviceMACAddress=deviceMACAddress, packetsFromInternalStack=packetsFromInternalStack, dfsTableEntry=dfsTableEntry, userTableNumber=userTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, iPv6GatewayAddress=iPv6GatewayAddress, syncETrackingState=syncETrackingState, dfsTableIndex=dfsTableIndex, l2CPPriorityTable=l2CPPriorityTable, mainPSUPortQLTx=mainPSUPortQLTx, hTTPAccessEnabled=hTTPAccessEnabled, sNTPLastSync=sNTPLastSync, regulatoryBandTrap=regulatoryBandTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productVariant=productVariant, rawReceivePower=rawReceivePower, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sNTPServerTableEntry=sNTPServerTableEntry, sFPPortStatus=sFPPortStatus, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, auxPortQLTx=auxPortQLTx, vLANManagementPriority=vLANManagementPriority, configurationInstancedTableEntry=configurationInstancedTableEntry, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, syncESlavePort=syncESlavePort, aAAControlGroup=aAAControlGroup, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, tDM=tDM, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, authorizationControlTableNumber=authorizationControlTableNumber, dNSServerTable=dNSServerTable, phyControlInstancedTableEntry=phyControlInstancedTableEntry, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, secureModeAlarm=secureModeAlarm, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, auxPortConfigurationMismatch=auxPortConfigurationMismatch, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsTable=dfsTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenseGasGroup=licenseGasGroup, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, receivePowerLinked=receivePowerLinked, byteErrorRatio=byteErrorRatio, configurationGroup=configurationGroup, subbandLowestFrequency=subbandLowestFrequency, dataPortPauseFrames=dataPortPauseFrames, severelyErroredSeconds=severelyErroredSeconds, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sMTPEmailAlert=sMTPEmailAlert, syncETracking=syncETracking, wirelessOutOctets=wirelessOutOctets, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPPollInterval=sNTPPollInterval, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, capacityVariantMismatch=capacityVariantMismatch, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, auxPortQLRx=auxPortQLRx, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, accessMethod=accessMethod, alarms=alarms, ptpCompliance=ptpCompliance, portAllocationMismatchTrap=portAllocationMismatchTrap, tdmTableEntry=tdmTableEntry, txMABFrames=txMABFrames, dfsPeaks=dfsPeaks, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userRole=userRole, transmitPowerLinked=transmitPowerLinked, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, remoteInternetAddressLinked=remoteInternetAddressLinked, useVLANForMABProtocol=useVLANForMABProtocol, aAAControl=aAAControl, searchState=searchState, configurationInstancedTableNumber=configurationInstancedTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, auxPortDisabledWarning=auxPortDisabledWarning, sNMPTrapTable=sNMPTrapTable, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, daylightSaving=daylightSaving, remoteInternetAddressType=remoteInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNTPServerTableIndex=sNTPServerTableIndex, dNSPrimaryServer=dNSPrimaryServer, receiveModulationModeLinked=receiveModulationModeLinked, tFTPClient=tFTPClient, receiveDataRateLinked=receiveDataRateLinked, sNMPPortNumber=sNMPPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTimeout=sNTPServerTimeout, alarmInstancedTableNumber=alarmInstancedTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, userEnabled=userEnabled, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, groupID=groupID, nIDULanPortStatus=nIDULanPortStatus, iPv6Address=iPv6Address, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, systemReset=systemReset, transmitDataRateLinked=transmitDataRateLinked, routerProtocols=routerProtocols, unitName=unitName, mainPSUPortAllocation=mainPSUPortAllocation, installStatusLinked=installStatusLinked, wirelessOutAllOctets=wirelessOutAllOctets, wirelessLinkStatusLinked=wirelessLinkStatusLinked, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, resetGroup=resetGroup, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, vectorError=vectorError, erroredSeconds=erroredSeconds, apcGroup=apcGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, alarmInstancedTableIndex=alarmInstancedTableIndex, tDMEnabledChannels=tDMEnabledChannels, authorizationControlTable=authorizationControlTable, notificationsGroup=notificationsGroup, hardwareVersion=hardwareVersion, linkLoss=linkLoss, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userTable=userTable, regulatoryBand=regulatoryBand, rxColorCode=rxColorCode, qOSPriorityScheme=qOSPriorityScheme, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dNS=dNS, auxPortSSMTx=auxPortSSMTx, mABMaintenanceLevel=mABMaintenanceLevel, installArmState=installArmState, dfs=dfs, syslogClientTrap=syslogClientTrap, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sNMPTrapPortNumber=sNMPTrapPortNumber, configuration=configuration, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, targetRange=targetRange, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, unitOutOfCalibration=unitOutOfCalibration, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rangeLinked=rangeLinked, sNTPServerStatus=sNTPServerStatus, sFPPortSSMTx=sFPPortSSMTx, cableDiagnostics=cableDiagnostics, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, siteName=siteName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sFPPortQLRx=sFPPortQLRx, syslogStateTrap=syslogStateTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseTLSRekey=licenseTLSRekey, sntp=sntp, receiveModulationModeDetail=receiveModulationModeDetail, encryptionGroup=encryptionGroup, dNSServerInternetAddressType=dNSServerInternetAddressType, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapVersion=sNMPTrapVersion, licenseOOBManagementSupport=licenseOOBManagementSupport, mABProtocolVID=mABProtocolVID, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseRegulatoryBandsList=licenseRegulatoryBandsList, licenseSecurityLevel=licenseSecurityLevel, ethernetGroup=ethernetGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, cableDiagPair3Distance=cableDiagPair3Distance, tDMInterfaceStatus=tDMInterfaceStatus, routerProtocolsGroup=routerProtocolsGroup, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, hTTPSPortNumber=hTTPSPortNumber, dNSServerPortNumber=dNSServerPortNumber, userTableEntry=userTableEntry, supplementary=supplementary, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tDDControl=tDDControl, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, eIRP=eIRP, sMTPEnabledMessages=sMTPEnabledMessages, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sFPPortAutoMdix=sFPPortAutoMdix, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, nIDULanPortStatusTrap=nIDULanPortStatusTrap, versions=versions, iPVersion=iPVersion, tdmTableIndex=tdmTableIndex, sntpGroup=sntpGroup, managementGroup=managementGroup, transmitModulationModeLinked=transmitModulationModeLinked, cableDiagnosticsWarning=cableDiagnosticsWarning, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, unavailableSeconds=unavailableSeconds, syslogState=syslogState, tDMConfigurationMismatch=tDMConfigurationMismatch, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitFreqMHz=transmitFreqMHz, linkModeOptimization=linkModeOptimization, frequencyVariant=frequencyVariant, transparentClock=transparentClock, licenseIEEE1588Support=licenseIEEE1588Support, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseHCMPSupport=licenseHCMPSupport, enableTransmission=enableTransmission, reset=reset, lowestTDMModulationMode=lowestTDMModulationMode, licenseCapacity=licenseCapacity, tDMChannelStatus=tDMChannelStatus, telnetPortNumber=telnetPortNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, cableDiagPair4Results=cableDiagPair4Results, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, dSCPManagementPriority=dSCPManagementPriority, auxPortStatus=auxPortStatus, license=license, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, subnetMask=subnetMask, tempPcb=tempPcb, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, PYSNMP_MODULE_ID=cambium, cambium=cambium, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, remoteMACAddressLinked=remoteMACAddressLinked, installArmStateTrap=installArmStateTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, dataBridgingAvailability=dataBridgingAvailability)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", installStatusTrap=installStatusTrap, mainPSUPortQLRx=mainPSUPortQLRx, dNSServerTableIndex=dNSServerTableIndex, authorizationControlTableEntry=authorizationControlTableEntry, tdmTableNumber=tdmTableNumber, supplementaryGroup=supplementaryGroup, authorizationControlTableIndex=authorizationControlTableIndex, tDMChannelStatusTrap=tDMChannelStatusTrap, hTTPPortNumber=hTTPPortNumber, transmitDataRate=transmitDataRate, licenseEncryption=licenseEncryption, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationMode=receiveModulationMode, blacklistRMEnabled=blacklistRMEnabled, sMTPServerInternetAddressType=sMTPServerInternetAddressType, installStatus=installStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptpGroups=ptpGroups, auxPortStatusTrap=auxPortStatusTrap, aggregateDataRate=aggregateDataRate, ptp670=ptp670, userName=userName, sFPPortAllocation=sFPPortAllocation, ptmp=ptmp, apc=apc, tDMGroup=tDMGroup, dNSGroup=dNSGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sFPError=sFPError, licenseIssueNumber=licenseIssueNumber, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, systemClock=systemClock, tDDSynchronizationStatus=tDDSynchronizationStatus, hCMPMaximumLinkRange=hCMPMaximumLinkRange, ptp=ptp, ethernetStatisticsTable=ethernetStatisticsTable, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, transmitModulationMode=transmitModulationMode, licenseInstancedTable=licenseInstancedTable, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, remoteUnitName=remoteUnitName, mABNominalModulationMode=mABNominalModulationMode, capacityVariantMismatchTrap=capacityVariantMismatchTrap, syslogControl=syslogControl, dataBridgingStatusAlarm=dataBridgingStatusAlarm, userPassword=userPassword, sMTPServerInternetAddress=sMTPServerInternetAddress, maximumTransmitPower=maximumTransmitPower, pubInstancedStatsTable=pubInstancedStatsTable, licenseBandwidthCap=licenseBandwidthCap, mainPSUPortStatus=mainPSUPortStatus, tDDControlGroup=tDDControlGroup, phyInstancedStatusTable=phyInstancedStatusTable, wirelessTopology=wirelessTopology, sNMPEnabledTraps=sNMPEnabledTraps, sFPPortStatusTrap=sFPPortStatusTrap, transmitPower=transmitPower, phyStatus=phyStatus, timeZone=timeZone, vectorErrorLinked=vectorErrorLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dNSResolver=dNSResolver, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, lbtDetectedTrap=lbtDetectedTrap, dfsGroup=dfsGroup, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, ethernetPriorityTable=ethernetPriorityTable, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tFTPServerInternetAddress=tFTPServerInternetAddress, iPv4Address=iPv4Address, linkName=linkName, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseInstancedTableIndex=licenseInstancedTableIndex, ethernetInstancedTableEntry=ethernetInstancedTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, bridgeGroup=bridgeGroup, auxPortSyncERxStatus=auxPortSyncERxStatus, hCMPLinkSymmetry=hCMPLinkSymmetry, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, auxPortAllocation=auxPortAllocation, managementNetworkAccessEnabled=managementNetworkAccessEnabled, dataBridgingStatusLinked=dataBridgingStatusLinked, antennaSelection=antennaSelection, productName=productName, rangingMode=rangingMode, pubStats=pubStats, cableDiagPair2Results=cableDiagPair2Results, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, secureModeAlarmTrap=secureModeAlarmTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteInternetAddress=remoteInternetAddress, maxLinkRangeExceeded=maxLinkRangeExceeded, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitChannel=transmitChannel, phyControlInstancedTable=phyControlInstancedTable, cableDiagPair1Distance=cableDiagPair1Distance, maximumNumberOfSlaves=maximumNumberOfSlaves, byteErrorRatioLinked=byteErrorRatioLinked, mgmtInstancedTableEntry=mgmtInstancedTableEntry, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, txColorCode=txColorCode, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseInstancedTableNumber=licenseInstancedTableNumber, mainPSUPortSSMTx=mainPSUPortSSMTx, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteMACAddress=remoteMACAddress, sFPPortDisabledWarning=sFPPortDisabledWarning, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, versionsGroup=versionsGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, bridge=bridge, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mABState=mABState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, secondarySoftwareVersion=secondarySoftwareVersion, range=range, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, receiveFreqMHz=receiveFreqMHz, licenseCountry=licenseCountry, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, whitelistRMMacAddress=whitelistRMMacAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, masterSlaveMode=masterSlaveMode, sNTPServerTableNumber=sNTPServerTableNumber, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, encryptionAlgorithm=encryptionAlgorithm, ethernetPriorityTableNumber=ethernetPriorityTableNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mgmtInstancedTable=mgmtInstancedTable, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, deviceESN=deviceESN, antennaGain=antennaGain, licenseRARSupport=licenseRARSupport, blacklistRMMacAddress=blacklistRMMacAddress, snmpControl=snmpControl, tDMChannelLineCode=tDMChannelLineCode, syslogClient=syslogClient, sNTPPrimaryServer=sNTPPrimaryServer, wirelessOutEthernetOctets=wirelessOutEthernetOctets, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, iPv6PrefixLength=iPv6PrefixLength, ptpTrapPrefix=ptpTrapPrefix, unitIdentificationGroup=unitIdentificationGroup, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dfsMeans=dfsMeans, licenseTDDSyncSupport=licenseTDDSyncSupport, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, encryption=encryption, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, smtpGroup=smtpGroup, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, configurationInstancedTable=configurationInstancedTable, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tdmTable=tdmTable, licenseTrialPeriod=licenseTrialPeriod, tDDSynchronizationMode=tDDSynchronizationMode, cableDiagnosticsControl=cableDiagnosticsControl, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, alarmInstancedTable=alarmInstancedTable, authorizationControl=authorizationControl, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, latitude=latitude, sNTPState=sNTPState, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseVersion=licenseVersion, sNTPServerRetries=sNTPServerRetries, userTableIndex=userTableIndex, mABHoldoffPeriod=mABHoldoffPeriod, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, snmpControlGroup=snmpControlGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseIPv6Support=licenseIPv6Support, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitFreqKHz=transmitFreqKHz, cableLoss=cableLoss, dataBridgingStatus=dataBridgingStatus, tDMChannelLoopback=tDMChannelLoopback, bootVersion=bootVersion, altitude=altitude, sFPPortQLTx=sFPPortQLTx, transparentClockVID=transparentClockVID, telnetAccessEnabled=telnetAccessEnabled, cableDiagPair1Results=cableDiagPair1Results, unitIdentification=unitIdentification, tDMInterfaceControl=tDMInterfaceControl, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, channelBandwidth=channelBandwidth, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, rawReceivePowerLinked=rawReceivePowerLinked, sFPErrorTrap=sFPErrorTrap, ethernetInstancedTableIndex=ethernetInstancedTableIndex, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, licenseGroup=licenseGroup, alarmsGroup=alarmsGroup, licenseMaxLinkRange=licenseMaxLinkRange, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, installationMode=installationMode, portAllocationMismatch=portAllocationMismatch, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, authorizationMethod=authorizationMethod, dNSServerTableNumber=dNSServerTableNumber, dfsTableNumber=dfsTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, deviceMSN=deviceMSN, licenseSyncESupport=licenseSyncESupport, searchStateLinked=searchStateLinked, remoteUnitNameLinked=remoteUnitNameLinked, ptpTraps=ptpTraps, phyControlGroup=phyControlGroup, licenseInstancedTableEntry=licenseInstancedTableEntry, sNMPv3Enable=sNMPv3Enable, tDMChannelCableLength=tDMChannelCableLength, longitude=longitude, management=management, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sNTPSync=sNTPSync, cableDiagPair3Results=cableDiagPair3Results, receiveChannel=receiveChannel, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, pubStatsGroup=pubStatsGroup, packetsToInternalStack=packetsToInternalStack, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syncEEquipmentClock=syncEEquipmentClock)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", phyControlInstancedTableNumber=phyControlInstancedTableNumber, whitelistRMEnabled=whitelistRMEnabled, signalStrengthRatio=signalStrengthRatio, ethernetInstancedTable=ethernetInstancedTable, cableDiagPair2Distance=cableDiagPair2Distance, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, dNSServerTableEntry=dNSServerTableEntry, aggregateDataRateLinked=aggregateDataRateLinked, subbandHighestFrequency=subbandHighestFrequency, transparentClockVLAN=transparentClockVLAN, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitterChannels=transmitterChannels, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mgmtInstancedTableNumber=mgmtInstancedTableNumber, receiveFreqKHz=receiveFreqKHz, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatusGroup=phyStatusGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, wirelessLinkAvailability=wirelessLinkAvailability, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mainPSUPortStatusTrap=mainPSUPortStatusTrap, cableDiagPair4Distance=cableDiagPair4Distance, smtp=smtp, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, portAllocationMismatchLinked=portAllocationMismatchLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, softwareVersion=softwareVersion, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, authorizationControlGroup=authorizationControlGroup, linkLossLinked=linkLossLinked, licenseSFPPortSupport=licenseSFPPortSupport, ethernetStatisticsDataSource=ethernetStatisticsDataSource, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, alarmInstancedTableEntry=alarmInstancedTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dNSServerInternetAddress=dNSServerInternetAddress, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, phyControl=phyControl, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, wirelessLinkStatus=wirelessLinkStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, cableDiagnosticsPorts=cableDiagnosticsPorts, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, localPacketFiltering=localPacketFiltering, gatewayIPAddress=gatewayIPAddress, targetMACAddress=targetMACAddress, receiveDataRate=receiveDataRate, signalStrengthRatioLinked=signalStrengthRatioLinked, linkSymmetry=linkSymmetry, sNTPServerTable=sNTPServerTable, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, receivePower=receivePower, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mABTransmissionInterval=mABTransmissionInterval, channelChangeTrap=channelChangeTrap)
