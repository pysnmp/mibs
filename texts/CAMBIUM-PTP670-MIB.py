...
ObjectIdentity, MibIdentifier, Counter32, Unsigned32, NotificationType, ModuleIdentity, IpAddress, Counter64, iso, Bits, Gauge32, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Counter32", "Unsigned32", "NotificationType", "ModuleIdentity", "IpAddress", "Counter64", "iso", "Bits", "Gauge32", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPv3Enable=sNMPv3Enable, dfs=dfs, ethernetPriorityTableIndex=ethernetPriorityTableIndex, cableLoss=cableLoss, accessMethod=accessMethod, subbandHighestFrequency=subbandHighestFrequency, hTTPPortNumber=hTTPPortNumber, cableDiagPair1Results=cableDiagPair1Results, remoteMACAddressLinked=remoteMACAddressLinked, dataBridgingAvailability=dataBridgingAvailability, severelyErroredSeconds=severelyErroredSeconds, l2CPPriorityTable=l2CPPriorityTable, vectorError=vectorError, wirelessLinkStatus=wirelessLinkStatus, phyControlGroup=phyControlGroup, productVariant=productVariant, packetsToInternalStack=packetsToInternalStack, receiveModulationMode=receiveModulationMode, sNMPCommunityString=sNMPCommunityString, erroredSeconds=erroredSeconds, mgmtInstancedTableNumber=mgmtInstancedTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, auxPortConfigurationMismatch=auxPortConfigurationMismatch, channelBandwidth=channelBandwidth, receiveChannel=receiveChannel, licenseIPv6Support=licenseIPv6Support, userRole=userRole, receiveFreqKHz=receiveFreqKHz, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, authorizationMethod=authorizationMethod, phyControl=phyControl, lowestDataModulationMode=lowestDataModulationMode, linkLoss=linkLoss, sNMPPortNumber=sNMPPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, mainPSUPortStatus=mainPSUPortStatus, authorizationControlTableNumber=authorizationControlTableNumber, snmpControl=snmpControl, tDMInterfaceControl=tDMInterfaceControl, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, vLANManagementVID=vLANManagementVID, sNTPState=sNTPState, sFPPortAutoMdix=sFPPortAutoMdix, phyStatus=phyStatus, dfsTableEntry=dfsTableEntry, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sNTPSyncTrap=sNTPSyncTrap, dataPortPauseFrames=dataPortPauseFrames, sFPPortDisabledWarning=sFPPortDisabledWarning, enableTransmission=enableTransmission, tdmTable=tdmTable, dataBridgingStatusLinked=dataBridgingStatusLinked, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, unitName=unitName, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, wirelessOutOctets=wirelessOutOctets, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseInstancedTableNumber=licenseInstancedTableNumber, tDM=tDM, receiveDataRateLinked=receiveDataRateLinked, licenseInstancedTableIndex=licenseInstancedTableIndex, apc=apc, sNMPTrapPortNumber=sNMPTrapPortNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseSyncESupport=licenseSyncESupport, sNTPServerInternetAddress=sNTPServerInternetAddress, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, remoteUnitName=remoteUnitName, transmitPowerLinked=transmitPowerLinked, sFPPortStatus=sFPPortStatus, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mABState=mABState, licenseInstancedTable=licenseInstancedTable, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPSync=sNTPSync, linkName=linkName, authorizationControlTableIndex=authorizationControlTableIndex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseTrialPeriod=licenseTrialPeriod, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, secureModeAlarm=secureModeAlarm, remoteInternetAddressType=remoteInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, dfsPeaks=dfsPeaks, syncETracking=syncETracking, regulatoryBand=regulatoryBand, maximumNumberOfSlaves=maximumNumberOfSlaves, userTableIndex=userTableIndex, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, byteErrorRatioLinked=byteErrorRatioLinked, sntp=sntp, lbtDetectedTrap=lbtDetectedTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, transparentClockVLAN=transparentClockVLAN, dfsMeans=dfsMeans, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, phyControlInstancedTable=phyControlInstancedTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, cableDiagnosticsControl=cableDiagnosticsControl, licenseIssueNumber=licenseIssueNumber, ethernet=ethernet, licenseTDDSyncSupport=licenseTDDSyncSupport, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitterChannels=transmitterChannels, dfsTableIndex=dfsTableIndex, alarmInstancedTable=alarmInstancedTable, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, cableDiagPair1Distance=cableDiagPair1Distance, installStatusLinked=installStatusLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tDDControl=tDDControl, rawReceivePowerLinked=rawReceivePowerLinked, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitPower=transmitPower, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mainPSUPortAllocation=mainPSUPortAllocation, snmpControlGroup=snmpControlGroup, groupID=groupID, sNMPTrapTable=sNMPTrapTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mABMaintenanceLevel=mABMaintenanceLevel, auxPortQLRx=auxPortQLRx, transmitDataRate=transmitDataRate, cableDiagnosticsWarning=cableDiagnosticsWarning, rxColorCode=rxColorCode, useVLANForMABProtocol=useVLANForMABProtocol, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, dNSServerInternetAddressType=dNSServerInternetAddressType, tDMConfigurationMismatch=tDMConfigurationMismatch, routerProtocolsGroup=routerProtocolsGroup, mABHoldoffPeriod=mABHoldoffPeriod, capacityVariantMismatchLinked=capacityVariantMismatchLinked, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sFPError=sFPError, iPVersion=iPVersion, vectorErrorLinked=vectorErrorLinked, ptmp=ptmp, alarmsGroup=alarmsGroup, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDMInterfaceStatus=tDMInterfaceStatus, aggregateDataRateLinked=aggregateDataRateLinked, encryptionGroup=encryptionGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, supplementaryGroup=supplementaryGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rawReceivePower=rawReceivePower, ptpCompliance=ptpCompliance, remoteMACAddress=remoteMACAddress, auxPortSSMTx=auxPortSSMTx, rangeLinked=rangeLinked, receiveFreqMHz=receiveFreqMHz, systemReset=systemReset, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, configurationInstancedTableNumber=configurationInstancedTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, auxPortSyncERxStatus=auxPortSyncERxStatus, remoteInternetAddressLinked=remoteInternetAddressLinked, sFPPortSyncERxStatus=sFPPortSyncERxStatus, phyControlInstancedTableIndex=phyControlInstancedTableIndex, channelChangeTrap=channelChangeTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, frequencyVariant=frequencyVariant, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mABNominalModulationMode=mABNominalModulationMode, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, timeZone=timeZone, mainPSUPortSSMTx=mainPSUPortSSMTx, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, iPDSCPPriorityTable=iPDSCPPriorityTable, mABNominalTransmitCapacity=mABNominalTransmitCapacity, nIDULanPortStatusTrap=nIDULanPortStatusTrap, masterSlaveMode=masterSlaveMode, ethernetInstancedTable=ethernetInstancedTable, cableDiagnosticsResultTable=cableDiagnosticsResultTable, txColorCode=txColorCode, unavailableSeconds=unavailableSeconds, deviceESN=deviceESN, licenseGroupAccess=licenseGroupAccess, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, installationMode=installationMode, licenseSFPPortSupport=licenseSFPPortSupport, tDMChannelCableLength=tDMChannelCableLength, alarmInstancedTableEntry=alarmInstancedTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syncETrackingState=syncETrackingState, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, unitOutOfCalibration=unitOutOfCalibration, portAllocationMismatch=portAllocationMismatch, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tdmTableNumber=tdmTableNumber, blacklistRMMacAddress=blacklistRMMacAddress, targetRange=targetRange, maxLinkRangeExceeded=maxLinkRangeExceeded, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerPortNumber=sNTPServerPortNumber, bridge=bridge, dfsTable=dfsTable, alarms=alarms, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, dNSServerTableNumber=dNSServerTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, nIDULanPortStatus=nIDULanPortStatus, syslogControl=syslogControl, authorizationControlTable=authorizationControlTable, dNSServerTable=dNSServerTable, dNSResolver=dNSResolver, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, alarmInstancedTableIndex=alarmInstancedTableIndex, latitude=latitude, antennaGain=antennaGain, dataBridgingStatus=dataBridgingStatus, cableDiagPair4Results=cableDiagPair4Results, installStatus=installStatus, sFPPortAllocation=sFPPortAllocation, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortDisabledWarning=auxPortDisabledWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mABProtocolVID=mABProtocolVID, auxPortAllocation=auxPortAllocation, productName=productName, dNSServerInternetAddress=dNSServerInternetAddress, transmitFreqKHz=transmitFreqKHz, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseCapacity=licenseCapacity, managementGroup=managementGroup, ethernetPriorityTable=ethernetPriorityTable, ptpTraps=ptpTraps, tDMChannelLineCode=tDMChannelLineCode, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, transmitFreqMHz=transmitFreqMHz, transmitChannel=transmitChannel, licenseRARSupport=licenseRARSupport, licenseSecurityLevel=licenseSecurityLevel, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, subnetMask=subnetMask, remoteInternetAddress=remoteInternetAddress, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dNS=dNS, hCMPMaximumLinkRange=hCMPMaximumLinkRange, smtp=smtp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configurationGroup=configurationGroup, versionsGroup=versionsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hCMPLinkSymmetry=hCMPLinkSymmetry, unitIdentificationGroup=unitIdentificationGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, blacklistRMEnabled=blacklistRMEnabled, PYSNMP_MODULE_ID=cambium, wirelessLinkStatusLinked=wirelessLinkStatusLinked, installArmState=installArmState, iPv6Address=iPv6Address, tDMChannelStatus=tDMChannelStatus, vLANManagementPriority=vLANManagementPriority, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, l2CPPriorityTableIndex=l2CPPriorityTableIndex, whitelistRMMacAddress=whitelistRMMacAddress, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, portAllocationMismatchLinked=portAllocationMismatchLinked, phyControlInstancedTableEntry=phyControlInstancedTableEntry, aggregateDataRate=aggregateDataRate, installArmStateTrap=installArmStateTrap, tDMChannelLoopback=tDMChannelLoopback, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, unitIdentification=unitIdentification, eIRP=eIRP, notificationsGroup=notificationsGroup, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTableEntry=sNTPServerTableEntry, deviceMSN=deviceMSN, receivePower=receivePower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, iPv6GatewayAddress=iPv6GatewayAddress, searchStateLinked=searchStateLinked, licenseHCMPSupport=licenseHCMPSupport, cableDiagnosticsGroup=cableDiagnosticsGroup, cableDiagPair3Distance=cableDiagPair3Distance, sNTPPrimaryServer=sNTPPrimaryServer, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, userPassword=userPassword, syslogState=syslogState, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, authorizationControlTableEntry=authorizationControlTableEntry, licenseGasGroup=licenseGasGroup, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortQLTx=auxPortQLTx, routerProtocols=routerProtocols, nIDULanPortAutoMdix=nIDULanPortAutoMdix, maximumTransmitPower=maximumTransmitPower, dNSPrimaryServer=dNSPrimaryServer, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, wirelessTopology=wirelessTopology, licenseEncryption=licenseEncryption, softwareVersion=softwareVersion, deviceMACAddress=deviceMACAddress, receiveModulationModeLinked=receiveModulationModeLinked, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, configurationInstancedTable=configurationInstancedTable, remoteUnitNameLinked=remoteUnitNameLinked, cableDiagPair3Results=cableDiagPair3Results, rangingMode=rangingMode, transmitModulationMode=transmitModulationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ethernetStatisticsDataSource=ethernetStatisticsDataSource, authorizationControl=authorizationControl, installStatusTrap=installStatusTrap, cambium=cambium, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, ethernetInstancedTableIndex=ethernetInstancedTableIndex, supplementary=supplementary, packetsFromInternalStack=packetsFromInternalStack, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, pubStatsGroup=pubStatsGroup, secureModeAlarmTrap=secureModeAlarmTrap, sntpGroup=sntpGroup, wirelessOutAllOctets=wirelessOutAllOctets, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, tFTPServerInternetAddressType=tFTPServerInternetAddressType, resetGroup=resetGroup, syncEEquipmentClock=syncEEquipmentClock, incompatibleRegulatoryBands=incompatibleRegulatoryBands, txMABFrames=txMABFrames, aAAControl=aAAControl, licenseTLSRekey=licenseTLSRekey, sFPPortStatusTrap=sFPPortStatusTrap, ethernetGroup=ethernetGroup, licenseInstancedTableEntry=licenseInstancedTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, localPacketFiltering=localPacketFiltering, encryptionAlgorithm=encryptionAlgorithm, sMTPEmailAlert=sMTPEmailAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sFPPortQLTx=sFPPortQLTx, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNTPLastSync=sNTPLastSync, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, signalStrengthRatioLinked=signalStrengthRatioLinked, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNTPServerTableNumber=sNTPServerTableNumber, bootVersion=bootVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, sFPPortQLRx=sFPPortQLRx, licenseUnitSerialNumber=licenseUnitSerialNumber, sNTPServerTableIndex=sNTPServerTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, auxPortStatus=auxPortStatus, sNTPServerTable=sNTPServerTable, userName=userName, ethernetStatisticsTable=ethernetStatisticsTable, oOBPriorityQueueMapping=oOBPriorityQueueMapping, range=range, configurationInstancedTableEntry=configurationInstancedTableEntry, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, syslogClientTrap=syslogClientTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, transmitDataRateLinked=transmitDataRateLinked, encryption=encryption, transparentClock=transparentClock, licenseBandwidthCap=licenseBandwidthCap, byteErrorRatio=byteErrorRatio, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, ptp670=ptp670, iPv6PrefixLength=iPv6PrefixLength, tDMEnabledChannels=tDMEnabledChannels, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, portAllocationMismatchTrap=portAllocationMismatchTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, aAAControlGroup=aAAControlGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sFPErrorTrap=sFPErrorTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, phyStatusGroup=phyStatusGroup, capacityVariantMismatch=capacityVariantMismatch, wirelessOutEthernetOctets=wirelessOutEthernetOctets, license=license, cableDiagnosticsPorts=cableDiagnosticsPorts, hardwareVersion=hardwareVersion, daylightSaving=daylightSaving, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, iPv4Address=iPv4Address, telnetAccessEnabled=telnetAccessEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, userTableEntry=userTableEntry, hTTPSPortNumber=hTTPSPortNumber, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mainPSUPortQLTx=mainPSUPortQLTx, dNSServerPortNumber=dNSServerPortNumber, subbandLowestFrequency=subbandLowestFrequency, cableDiagPair4Distance=cableDiagPair4Distance, dNSServerTableEntry=dNSServerTableEntry, userTableNumber=userTableNumber, tFTPClient=tFTPClient, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tempPcb=tempPcb, auxPortStatusTrap=auxPortStatusTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, telnetPortNumber=telnetPortNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mgmtInstancedTable=mgmtInstancedTable, receiveModulationModeDetail=receiveModulationModeDetail, ptpTrapPrefix=ptpTrapPrefix, targetMACAddress=targetMACAddress, mainPSUPortQLRx=mainPSUPortQLRx, tDMGroup=tDMGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, transparentClockPort=transparentClockPort, syslogClient=syslogClient, dNSServerTableIndex=dNSServerTableIndex, transmitModulationModeLinked=transmitModulationModeLinked, management=management, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, bridgeGroup=bridgeGroup, syncESlavePort=syncESlavePort, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, receivePowerLinked=receivePowerLinked, searchState=searchState, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, licenseGroup=licenseGroup, regulatoryBandTrap=regulatoryBandTrap, userTable=userTable, licenseIEEE1588Support=licenseIEEE1588Support, smtpGroup=smtpGroup, ethernetInstancedTableNumber=ethernetInstancedTableNumber, dfsTableNumber=dfsTableNumber, sNTPServerTimeout=sNTPServerTimeout, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpGroups=ptpGroups, antennaSelection=antennaSelection, alarmInstancedTableNumber=alarmInstancedTableNumber, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, authorizationControlGroup=authorizationControlGroup, userEnabled=userEnabled, licenseMaxLinkRange=licenseMaxLinkRange, sNMPTrapVersion=sNMPTrapVersion, pubStats=pubStats, syslogControlGroup=syslogControlGroup, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, tDDSynchronizationMode=tDDSynchronizationMode, siteName=siteName, auxPortAcceptedQLRx=auxPortAcceptedQLRx)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, transparentClockVID=transparentClockVID, sNMPTrapInternetAddress=sNMPTrapInternetAddress, linkSymmetry=linkSymmetry, sNMPEnabledTraps=sNMPEnabledTraps, pubInstancedStatsTable=pubInstancedStatsTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, apcGroup=apcGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseVersion=licenseVersion, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mgmtInstancedTableIndex=mgmtInstancedTableIndex, dNSGroup=dNSGroup, signalStrengthRatio=signalStrengthRatio, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sNTPServerStatus=sNTPServerStatus, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, systemClock=systemClock, configuration=configuration, lowestTDMModulationMode=lowestTDMModulationMode, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, mABTransmissionInterval=mABTransmissionInterval, licenseCountry=licenseCountry, cableDiagnostics=cableDiagnostics, phyInstancedStatusTable=phyInstancedStatusTable, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, longitude=longitude, ptp=ptp, reset=reset, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, dSCPManagementPriority=dSCPManagementPriority, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, extendedSpectrumScanning=extendedSpectrumScanning, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, cableDiagPair2Distance=cableDiagPair2Distance, syslogStateTrap=syslogStateTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sMTPServerPortNumber=sMTPServerPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sFPPortSSMTx=sFPPortSSMTx, receiveDataRate=receiveDataRate, tdmTableIndex=tdmTableIndex, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, tDDControlGroup=tDDControlGroup, whitelistRMEnabled=whitelistRMEnabled, altitude=altitude, dfsGroup=dfsGroup, cableDiagPair2Results=cableDiagPair2Results, tdmTableEntry=tdmTableEntry, linkModeOptimization=linkModeOptimization, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, sNTPPollInterval=sNTPPollInterval, versions=versions, linkLossLinked=linkLossLinked)
