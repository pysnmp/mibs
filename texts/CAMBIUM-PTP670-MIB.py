...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, regulatoryBandTrap=regulatoryBandTrap, ptpTraps=ptpTraps, dfsTableEntry=dfsTableEntry, auxPortAcceptedQLRx=auxPortAcceptedQLRx, syncEEquipmentClock=syncEEquipmentClock, sNTPState=sNTPState, hTTPSPortNumber=hTTPSPortNumber, alarmInstancedTableIndex=alarmInstancedTableIndex, groupID=groupID, ethernetStatisticsTable=ethernetStatisticsTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, deviceMSN=deviceMSN, altitude=altitude, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, linkName=linkName, syslogState=syslogState, auxPortDisabledWarning=auxPortDisabledWarning, receiveChannel=receiveChannel, targetRange=targetRange, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, txColorCode=txColorCode, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, secureModeAlarm=secureModeAlarm, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, supplementary=supplementary, cableDiagPair4Distance=cableDiagPair4Distance, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, channelChangeTrap=channelChangeTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseInstancedTable=licenseInstancedTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortQLRx=sFPPortQLRx, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerTableNumber=sNTPServerTableNumber, snmpControl=snmpControl, pubStats=pubStats, receiveModulationMode=receiveModulationMode, sFPPortAutoNegotiation=sFPPortAutoNegotiation, wirelessLinkAvailability=wirelessLinkAvailability, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, noWirelessChannelAvailable=noWirelessChannelAvailable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tdmTableIndex=tdmTableIndex, bootVersion=bootVersion, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, systemClock=systemClock, nIDULanPortStatus=nIDULanPortStatus, remoteMACAddress=remoteMACAddress, userTableEntry=userTableEntry, alarms=alarms, mABState=mABState, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, txMABFrames=txMABFrames, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, supplementaryGroup=supplementaryGroup, aAAControlGroup=aAAControlGroup, mABNominalTransmitCapacity=mABNominalTransmitCapacity, syslogClientTrap=syslogClientTrap, severelyErroredSeconds=severelyErroredSeconds, tdmTableEntry=tdmTableEntry, portAllocationMismatchTrap=portAllocationMismatchTrap, routerProtocols=routerProtocols, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, aggregateDataRate=aggregateDataRate, notificationsGroup=notificationsGroup, dNSServerInternetAddressType=dNSServerInternetAddressType, encryptionGroup=encryptionGroup, phyControl=phyControl, licenseMaxLinkRange=licenseMaxLinkRange, receivePower=receivePower, dNSGroup=dNSGroup, mainPSUPortAllocation=mainPSUPortAllocation, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, masterSlaveMode=masterSlaveMode, sNTPLastSync=sNTPLastSync, dNSPrimaryServer=dNSPrimaryServer, tDMInterfaceControl=tDMInterfaceControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, whitelistRMMacAddress=whitelistRMMacAddress, byteErrorRatio=byteErrorRatio, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, cambium=cambium, syncETracking=syncETracking, sFPPortStatus=sFPPortStatus, tDMEnabledChannels=tDMEnabledChannels, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mABHoldoffPeriod=mABHoldoffPeriod, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, transparentClock=transparentClock, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPClient=tFTPClient, cableDiagPair4Results=cableDiagPair4Results, licenseTLSRekey=licenseTLSRekey, receiveModulationModeDetail=receiveModulationModeDetail, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, dSCPManagementPriority=dSCPManagementPriority, cableDiagnostics=cableDiagnostics, tDMInterfaceStatus=tDMInterfaceStatus, installStatusTrap=installStatusTrap, vLANManagementPriority=vLANManagementPriority, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transparentClockVLAN=transparentClockVLAN, extendedSpectrumScanning=extendedSpectrumScanning, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tDM=tDM, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseRARSupport=licenseRARSupport, tDDControlGroup=tDDControlGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, unitName=unitName, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseCountry=licenseCountry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitFreqKHz=transmitFreqKHz, installStatus=installStatus, telnetAccessEnabled=telnetAccessEnabled, sNTPServerTimeout=sNTPServerTimeout, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, receiveModulationModeLinked=receiveModulationModeLinked, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, rangeLinked=rangeLinked, phyControlInstancedTableIndex=phyControlInstancedTableIndex, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, erroredSeconds=erroredSeconds, unitIdentification=unitIdentification, transparentClockVID=transparentClockVID, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseSyncESupport=licenseSyncESupport, tDMChannelLineCode=tDMChannelLineCode, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, transmitterChannels=transmitterChannels, vLANManagementVID=vLANManagementVID, hCMPLinkSymmetry=hCMPLinkSymmetry, auxPortSSMTx=auxPortSSMTx, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, ethernetInstancedTableEntry=ethernetInstancedTableEntry, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, secureModeAlarmTrap=secureModeAlarmTrap, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, antennaGain=antennaGain, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mPLSTCPriorityTable=mPLSTCPriorityTable, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, userTableIndex=userTableIndex, receiveDataRate=receiveDataRate, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, licenseSecurityLevel=licenseSecurityLevel, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, aAAControl=aAAControl, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, productName=productName, ethernetInstancedTableIndex=ethernetInstancedTableIndex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, mABMaintenanceLevel=mABMaintenanceLevel, ethernetGroup=ethernetGroup, dataPortPauseFrames=dataPortPauseFrames, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseInstancedTableNumber=licenseInstancedTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseInstancedTableEntry=licenseInstancedTableEntry, sFPPortDisabledWarning=sFPPortDisabledWarning, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userName=userName, ptp670=ptp670, softwareVersion=softwareVersion, licenseVersion=licenseVersion, sNMPv3Enable=sNMPv3Enable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataBridgingStatus=dataBridgingStatus, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, unitOutOfCalibration=unitOutOfCalibration, regulatoryBand=regulatoryBand, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, channelBandwidth=channelBandwidth, mABNominalModulationMode=mABNominalModulationMode, cableLoss=cableLoss, incompatibleRegulatoryBands=incompatibleRegulatoryBands, installationMode=installationMode, authorizationControlTableNumber=authorizationControlTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessOutEthernetOctets=wirelessOutEthernetOctets, iPv4Address=iPv4Address, authorizationMethod=authorizationMethod, vectorErrorLinked=vectorErrorLinked, signalStrengthRatioLinked=signalStrengthRatioLinked, rawReceivePowerLinked=rawReceivePowerLinked, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dNS=dNS, cableDiagPair2Distance=cableDiagPair2Distance, searchStateLinked=searchStateLinked, apcGroup=apcGroup, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseInstancedTableIndex=licenseInstancedTableIndex, unavailableSeconds=unavailableSeconds, subbandHighestFrequency=subbandHighestFrequency, blacklistRMEnabled=blacklistRMEnabled, ethernetStatisticsDataSource=ethernetStatisticsDataSource, telnetPortNumber=telnetPortNumber, eIRP=eIRP, alarmInstancedTableNumber=alarmInstancedTableNumber, portAllocationMismatch=portAllocationMismatch, hTTPAccessEnabled=hTTPAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, longitude=longitude, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, transmitModulationMode=transmitModulationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, pubInstancedStatsTable=pubInstancedStatsTable, secondarySoftwareVersion=secondarySoftwareVersion, licenseIPv6Support=licenseIPv6Support, iPDSCPPriorityTable=iPDSCPPriorityTable, iPv6GatewayAddress=iPv6GatewayAddress, accessMethod=accessMethod, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, pubStatsGroup=pubStatsGroup, linkModeOptimization=linkModeOptimization, transmitFreqMHz=transmitFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mainPSUPortQLTx=mainPSUPortQLTx, cableDiagPair3Results=cableDiagPair3Results, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, iPv6PrefixLength=iPv6PrefixLength)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseCapacity=licenseCapacity, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mABProtocolVID=mABProtocolVID, ptpGroups=ptpGroups, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tDDSynchronizationMode=tDDSynchronizationMode, ethernetInstancedTable=ethernetInstancedTable, sntpGroup=sntpGroup, receiveFreqMHz=receiveFreqMHz, mgmtInstancedTableEntry=mgmtInstancedTableEntry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, tdmTableNumber=tdmTableNumber, blacklistRMMacAddress=blacklistRMMacAddress, configurationGroup=configurationGroup, userTable=userTable, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, userTableNumber=userTableNumber, installArmState=installArmState, sNTPServerRetries=sNTPServerRetries, timeZone=timeZone, configuration=configuration, licenseBandwidthCap=licenseBandwidthCap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseGroupAccess=licenseGroupAccess, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, smtpGroup=smtpGroup, sMTPEmailAlert=sMTPEmailAlert, gatewayIPAddress=gatewayIPAddress, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, tDMChannelLoopback=tDMChannelLoopback, dataBridgingAvailability=dataBridgingAvailability, sFPPortStatusTrap=sFPPortStatusTrap, authorizationControlTable=authorizationControlTable, unitIdentificationGroup=unitIdentificationGroup, smtp=smtp, searchState=searchState, receiveDataRateLinked=receiveDataRateLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, cableDiagPair1Distance=cableDiagPair1Distance, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, phyStatus=phyStatus, installArmStateTrap=installArmStateTrap, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, authorizationControlGroup=authorizationControlGroup, receiveFreqKHz=receiveFreqKHz, licenseGasGroup=licenseGasGroup, tDMGroup=tDMGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, wirelessTopology=wirelessTopology, transparentClockPort=transparentClockPort, dNSServerTableNumber=dNSServerTableNumber, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, enableTransmission=enableTransmission, sFPPortAllocation=sFPPortAllocation, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, authorizationControl=authorizationControl, dNSServerInternetAddress=dNSServerInternetAddress, bridge=bridge, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, ethernet=ethernet, useVLANForMABProtocol=useVLANForMABProtocol, cableDiagnosticsPorts=cableDiagnosticsPorts, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, nIDULanPortStatusTrap=nIDULanPortStatusTrap, frequencyVariant=frequencyVariant, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseEncryption=licenseEncryption, latitude=latitude, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, capacityVariantMismatchLinked=capacityVariantMismatchLinked, reset=reset, tDDSynchronizationStatus=tDDSynchronizationStatus, userRole=userRole, sFPError=sFPError, siteName=siteName, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, phyControlGroup=phyControlGroup, authorizationControlTableEntry=authorizationControlTableEntry, auxPortQLRx=auxPortQLRx, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, snmpControlGroup=snmpControlGroup, phyControlInstancedTableEntry=phyControlInstancedTableEntry, portAllocationMismatchLinked=portAllocationMismatchLinked, phyStatusGroup=phyStatusGroup, syslogControlGroup=syslogControlGroup, wirelessLinkStatusLinked=wirelessLinkStatusLinked, licenseOOBManagementSupport=licenseOOBManagementSupport, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, userEnabled=userEnabled, auxPortStatusTrap=auxPortStatusTrap, sNTPSync=sNTPSync, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, dfsGroup=dfsGroup, mainPSUPortQLRx=mainPSUPortQLRx, bridgeGroup=bridgeGroup, sNMPCommunityString=sNMPCommunityString, deviceESN=deviceESN, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, alarmInstancedTable=alarmInstancedTable, wirelessOutAllOctets=wirelessOutAllOctets, cableDiagnosticsResultTable=cableDiagnosticsResultTable, auxPortStatus=auxPortStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, versions=versions, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, qOSPriorityScheme=qOSPriorityScheme, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, transmitChannel=transmitChannel, configurationInstancedTable=configurationInstancedTable, sNTPPollInterval=sNTPPollInterval, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, syncETrackingState=syncETrackingState, vectorError=vectorError, tDMChannelStatus=tDMChannelStatus, tdmTable=tdmTable, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, iPv6Address=iPv6Address, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, mABProtocolVLANPriority=mABProtocolVLANPriority, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, linkLoss=linkLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteUnitNameLinked=remoteUnitNameLinked, dfs=dfs, cableDiagPair2Results=cableDiagPair2Results, management=management, licenseTrialPeriod=licenseTrialPeriod, incompatibleMasterAndSlave=incompatibleMasterAndSlave, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, syslogControl=syslogControl, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, phyControlInstancedTable=phyControlInstancedTable, transmitPowerLinked=transmitPowerLinked, alarmsGroup=alarmsGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, cableDiagnosticsWarning=cableDiagnosticsWarning, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, mainPSUPortSSMTx=mainPSUPortSSMTx, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, dNSServerTable=dNSServerTable, wirelessOutOctets=wirelessOutOctets, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapTable=sNMPTrapTable, sFPErrorTrap=sFPErrorTrap, l2CPPriorityTable=l2CPPriorityTable, sntp=sntp, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, cableDiagPair3Distance=cableDiagPair3Distance, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTableIndex=dfsTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, apc=apc, rxColorCode=rxColorCode, sFPPortSSMTx=sFPPortSSMTx, remoteMaximumTransmitPower=remoteMaximumTransmitPower, capacityVariantMismatch=capacityVariantMismatch, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, syncESlavePort=syncESlavePort, linkLossLinked=linkLossLinked, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tDMConfigurationMismatch=tDMConfigurationMismatch, sNTPServerStatus=sNTPServerStatus, userPassword=userPassword, authorizationControlTableIndex=authorizationControlTableIndex, managementGroup=managementGroup, ethernetPriorityTable=ethernetPriorityTable, mgmtInstancedTable=mgmtInstancedTable, aggregateDataRateLinked=aggregateDataRateLinked, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, productVariant=productVariant, sNMPPortNumber=sNMPPortNumber, syslogStateTrap=syslogStateTrap, PYSNMP_MODULE_ID=cambium, sFPPortAutoMdix=sFPPortAutoMdix, versionsGroup=versionsGroup, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseSFPPortSupport=licenseSFPPortSupport, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dNSServerPortNumber=dNSServerPortNumber, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseGroup=licenseGroup, installStatusLinked=installStatusLinked, encryptionAlgorithm=encryptionAlgorithm, ptpCompliance=ptpCompliance, auxPortAllocation=auxPortAllocation, sNMPTrapPortNumber=sNMPTrapPortNumber, rangingMode=rangingMode, hardwareVersion=hardwareVersion, whitelistRMEnabled=whitelistRMEnabled, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, remoteInternetAddressType=remoteInternetAddressType, lbtDetectedTrap=lbtDetectedTrap, sNTPServerTable=sNTPServerTable, mgmtInstancedTableNumber=mgmtInstancedTableNumber, antennaSelection=antennaSelection, receivePowerLinked=receivePowerLinked, dfsTableNumber=dfsTableNumber, auxPortConfigurationMismatch=auxPortConfigurationMismatch, dfsTable=dfsTable, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationInstancedTableNumber=configurationInstancedTableNumber, sFPPortQLTx=sFPPortQLTx, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, rawReceivePower=rawReceivePower, routerProtocolsGroup=routerProtocolsGroup, remoteMACAddressLinked=remoteMACAddressLinked, byteErrorRatioLinked=byteErrorRatioLinked, remoteInternetAddress=remoteInternetAddress, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, remoteUnitName=remoteUnitName, wirelessLinkStatus=wirelessLinkStatus, transmitModulationModeLinked=transmitModulationModeLinked, cableDiagnosticsGroup=cableDiagnosticsGroup, systemReset=systemReset, hTTPSAccessEnabled=hTTPSAccessEnabled, encryption=encryption, hCMPMaximumLinkRange=hCMPMaximumLinkRange, dNSResolver=dNSResolver, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpTrapPrefix=ptpTrapPrefix, cableDiagnosticsControl=cableDiagnosticsControl, phyInstancedStatusTable=phyInstancedStatusTable, licenseIEEE1588Support=licenseIEEE1588Support, maximumTransmitPower=maximumTransmitPower, license=license, subbandLowestFrequency=subbandLowestFrequency, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, auxPortSyncERxStatus=auxPortSyncERxStatus, sNTPServerPortNumber=sNTPServerPortNumber, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, mgmtInstancedTableIndex=mgmtInstancedTableIndex, maximumNumberOfSlaves=maximumNumberOfSlaves, targetMACAddress=targetMACAddress, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sNMPEnabledTraps=sNMPEnabledTraps, dfsPeaks=dfsPeaks, tDDControl=tDDControl, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dNSServerTableEntry=dNSServerTableEntry, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, lowestTDMModulationMode=lowestTDMModulationMode, licenseUnitSerialNumber=licenseUnitSerialNumber, cableDiagPair1Results=cableDiagPair1Results, packetsFromInternalStack=packetsFromInternalStack, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, range=range, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, nIDULanPortAutoMdix=nIDULanPortAutoMdix, resetGroup=resetGroup, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, tDMChannelCableLength=tDMChannelCableLength, transmitPower=transmitPower, ptp=ptp, deviceMACAddress=deviceMACAddress, auxPortQLTx=auxPortQLTx, iPVersion=iPVersion, signalStrengthRatio=signalStrengthRatio, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, syslogClient=syslogClient, subnetMask=subnetMask, mainPSUPortStatus=mainPSUPortStatus, sNTPPrimaryServer=sNTPPrimaryServer, mABTransmissionInterval=mABTransmissionInterval, daylightSaving=daylightSaving, licenseHCMPSupport=licenseHCMPSupport, linkSymmetry=linkSymmetry, sNTPSyncTrap=sNTPSyncTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, packetsToInternalStack=packetsToInternalStack, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapVersion=sNMPTrapVersion, tempPcb=tempPcb, licenseTDDSyncSupport=licenseTDDSyncSupport, ptmp=ptmp, licenseIssueNumber=licenseIssueNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, dfsMeans=dfsMeans, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, lowestDataModulationMode=lowestDataModulationMode, hTTPPortNumber=hTTPPortNumber, localPacketFiltering=localPacketFiltering, transmitDataRate=transmitDataRate, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, transmitDataRateLinked=transmitDataRateLinked, dNSServerTableIndex=dNSServerTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
