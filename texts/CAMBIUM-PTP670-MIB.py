...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sNTPSyncTrap=sNTPSyncTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, deviceMACAddress=deviceMACAddress, licenseVersion=licenseVersion, cableDiagPair1Results=cableDiagPair1Results, apcGroup=apcGroup, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, gatewayIPAddress=gatewayIPAddress, wirelessLinkStatusLinked=wirelessLinkStatusLinked, incompatibleRegulatoryBands=incompatibleRegulatoryBands, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receivePowerLinked=receivePowerLinked, sNTPServerRetries=sNTPServerRetries, dfsMeans=dfsMeans, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, supplementaryGroup=supplementaryGroup, licenseSFPPortSupport=licenseSFPPortSupport, mainPSUPortQLRx=mainPSUPortQLRx, searchStateLinked=searchStateLinked, range=range, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, phyInstancedStatusTable=phyInstancedStatusTable, useVLANForMABProtocol=useVLANForMABProtocol, tDMEnabledChannels=tDMEnabledChannels, userTable=userTable, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, tDDControlGroup=tDDControlGroup, ethernet=ethernet, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNTPLastSync=sNTPLastSync, cableLoss=cableLoss, wirelessOutEthernetOctets=wirelessOutEthernetOctets, snmpControl=snmpControl, smtpGroup=smtpGroup, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, unitName=unitName, tDMChannelCableLength=tDMChannelCableLength, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPClient=tFTPClient, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseHCMPSupport=licenseHCMPSupport, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, transparentClockVLAN=transparentClockVLAN, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, licenseIPv6Support=licenseIPv6Support, tFTPServerInternetAddress=tFTPServerInternetAddress, systemClock=systemClock, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNTPServerTableEntry=sNTPServerTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, mABProtocolVLANPriority=mABProtocolVLANPriority, mABTransmissionInterval=mABTransmissionInterval, auxPortConfigurationMismatch=auxPortConfigurationMismatch, cableDiagnosticsWarning=cableDiagnosticsWarning, transmitterChannels=transmitterChannels, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, subbandLowestFrequency=subbandLowestFrequency, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, encryptionGroup=encryptionGroup, dfsTable=dfsTable, wirelessOutOctets=wirelessOutOctets, syncETracking=syncETracking, syncEEquipmentClock=syncEEquipmentClock, transmitPower=transmitPower, targetMACAddress=targetMACAddress, phyControlInstancedTableIndex=phyControlInstancedTableIndex, userRole=userRole, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, auxPortSSMTx=auxPortSSMTx, cableDiagnosticsPorts=cableDiagnosticsPorts, cableDiagPair4Results=cableDiagPair4Results, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dNSPrimaryServer=dNSPrimaryServer, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mgmtInstancedTableEntry=mgmtInstancedTableEntry, phyControlInstancedTableNumber=phyControlInstancedTableNumber, remoteInternetAddressType=remoteInternetAddressType, dfsGroup=dfsGroup, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, userTableEntry=userTableEntry, tdmTableNumber=tdmTableNumber, hCMPLinkSymmetry=hCMPLinkSymmetry, sNMPEnabledTraps=sNMPEnabledTraps, configurationInstancedTableIndex=configurationInstancedTableIndex, userTableNumber=userTableNumber, unitIdentificationGroup=unitIdentificationGroup, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, dNSServerInternetAddressType=dNSServerInternetAddressType, subnetMask=subnetMask, l2CPPriorityTableEntry=l2CPPriorityTableEntry, daylightSaving=daylightSaving, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPSync=sNTPSync, licenseTDDSyncSupport=licenseTDDSyncSupport, ptpGroups=ptpGroups, notificationsGroup=notificationsGroup, dNSServerTableEntry=dNSServerTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, hardwareVersion=hardwareVersion, mainPSUPortStatusTrap=mainPSUPortStatusTrap, byteErrorRatio=byteErrorRatio, remoteMACAddress=remoteMACAddress, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseIEEE1588Support=licenseIEEE1588Support, ptp670=ptp670, packetsToInternalStack=packetsToInternalStack, userTableIndex=userTableIndex, authorizationControlTableNumber=authorizationControlTableNumber, licenseInstancedTable=licenseInstancedTable, wirelessLinkAvailability=wirelessLinkAvailability, transparentClockVID=transparentClockVID, dNS=dNS, enabledDiagnosticAlarms=enabledDiagnosticAlarms, versionsGroup=versionsGroup, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, receiveModulationMode=receiveModulationMode, auxPortAllocation=auxPortAllocation, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, groupID=groupID, transmitDataRateLinked=transmitDataRateLinked, rawReceivePowerLinked=rawReceivePowerLinked, tDMChannelStatusTrap=tDMChannelStatusTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortStatus=auxPortStatus, wirelessOutAllOctets=wirelessOutAllOctets, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, vLANManagementPriority=vLANManagementPriority, masterSlaveMode=masterSlaveMode, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tDMGroup=tDMGroup, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, extendedSpectrumScanning=extendedSpectrumScanning, useVLANForManagementInterfaces=useVLANForManagementInterfaces, lowestTDMModulationMode=lowestTDMModulationMode, dfs=dfs, sNTPServerInternetAddress=sNTPServerInternetAddress, txColorCode=txColorCode, alarmInstancedTableIndex=alarmInstancedTableIndex, mgmtInstancedTableIndex=mgmtInstancedTableIndex, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNMPTrapVersion=sNMPTrapVersion, iPv6PrefixLength=iPv6PrefixLength, sFPPortQLTx=sFPPortQLTx, hTTPSAccessEnabled=hTTPSAccessEnabled, tdmTable=tdmTable, phyControl=phyControl, authorizationControlGroup=authorizationControlGroup, bootVersion=bootVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptp=ptp, pubInstancedStatsTable=pubInstancedStatsTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sNMPTrapInternetAddress=sNMPTrapInternetAddress, secureModeAlarmTrap=secureModeAlarmTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, signalStrengthRatioLinked=signalStrengthRatioLinked, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, installStatusLinked=installStatusLinked, vLANManagementVID=vLANManagementVID, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenseUnitSerialNumber=licenseUnitSerialNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, auxPortQLTx=auxPortQLTx, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, vectorError=vectorError, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, linkSymmetry=linkSymmetry, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, sntpGroup=sntpGroup, iPVersion=iPVersion, maximumTransmitPower=maximumTransmitPower, altitude=altitude, licenseGroup=licenseGroup, sFPPortAutoMdix=sFPPortAutoMdix, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogState=syslogState, dfsTableNumber=dfsTableNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, pubStats=pubStats, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, receiveFreqKHz=receiveFreqKHz, licenseTLSRekey=licenseTLSRekey, transmitFreqMHz=transmitFreqMHz, sNTPServerPortNumber=sNTPServerPortNumber, supplementary=supplementary, aAAControlGroup=aAAControlGroup, maximumNumberOfSlaves=maximumNumberOfSlaves, licenseCountry=licenseCountry, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, smtp=smtp, remoteMACAddressLinked=remoteMACAddressLinked, latitude=latitude, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dSCPManagementPriority=dSCPManagementPriority, transmitChannel=transmitChannel, cambium=cambium, hTTPAccessEnabled=hTTPAccessEnabled, transmitModulationModeLinked=transmitModulationModeLinked, maxLinkRangeExceeded=maxLinkRangeExceeded, dNSGroup=dNSGroup, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableDiagPair1Distance=cableDiagPair1Distance, licenseBandwidthCap=licenseBandwidthCap, ptmp=ptmp, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mgmtInstancedTable=mgmtInstancedTable, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, vectorErrorLinked=vectorErrorLinked, erroredSeconds=erroredSeconds, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, PYSNMP_MODULE_ID=cambium, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, auxPortDisabledWarning=auxPortDisabledWarning, versions=versions, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sFPPortQLRx=sFPPortQLRx, licenseEncryption=licenseEncryption, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitFreqKHz=transmitFreqKHz, management=management, receiveDataRate=receiveDataRate, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, transparentClock=transparentClock, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseTrialPeriod=licenseTrialPeriod, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sFPPortSyncERxStatus=sFPPortSyncERxStatus, bridgeGroup=bridgeGroup, telnetAccessEnabled=telnetAccessEnabled)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, aggregateDataRateLinked=aggregateDataRateLinked, encryptionAlgorithm=encryptionAlgorithm, productVariant=productVariant, tDDSynchronizationMode=tDDSynchronizationMode, sFPErrorTrap=sFPErrorTrap, syslogClient=syslogClient, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNMPv3Enable=sNMPv3Enable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetInstancedTableNumber=ethernetInstancedTableNumber, userPassword=userPassword, license=license, blacklistRMEnabled=blacklistRMEnabled, aAAControl=aAAControl, sntp=sntp, timeZone=timeZone, authorizationControl=authorizationControl, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, nIDULanPortStatus=nIDULanPortStatus, sNTPState=sNTPState, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, dataBridgingAvailability=dataBridgingAvailability, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, licenseSecurityLevel=licenseSecurityLevel, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNMPPortNumber=sNMPPortNumber, hCMPMaximumLinkRange=hCMPMaximumLinkRange, tdmTableEntry=tdmTableEntry, bridge=bridge, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dataPortPauseFrames=dataPortPauseFrames, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, unitOutOfCalibration=unitOutOfCalibration, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, configurationInstancedTable=configurationInstancedTable, installArmStateTrap=installArmStateTrap, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, auxPortAcceptedQLRx=auxPortAcceptedQLRx, remoteUnitNameLinked=remoteUnitNameLinked, alarmsGroup=alarmsGroup, userEnabled=userEnabled, cableDiagPair3Distance=cableDiagPair3Distance, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, dfsTableEntry=dfsTableEntry, lbtDetectedTrap=lbtDetectedTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataBridgingStatusLinked=dataBridgingStatusLinked, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernetInstancedTableIndex=ethernetInstancedTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, transmitModulationMode=transmitModulationMode, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, lowestDataModulationMode=lowestDataModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseCapacity=licenseCapacity, sNTPServerTableNumber=sNTPServerTableNumber, authorizationMethod=authorizationMethod, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationAlarm=tDDSynchronizationAlarm, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseInstancedTableNumber=licenseInstancedTableNumber, installStatus=installStatus, sMTPEmailAlert=sMTPEmailAlert, mainPSUPortStatus=mainPSUPortStatus, sNTPPrimaryServer=sNTPPrimaryServer, siteName=siteName, licenseGasGroup=licenseGasGroup, sMTPServerPortNumber=sMTPServerPortNumber, unavailableSeconds=unavailableSeconds, telnetPortNumber=telnetPortNumber, resetGroup=resetGroup, dataBridgingStatusAlarm=dataBridgingStatusAlarm, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, ethernetInstancedTable=ethernetInstancedTable, systemReset=systemReset, phyStatusGroup=phyStatusGroup, localPacketFiltering=localPacketFiltering, dNSServerInternetAddress=dNSServerInternetAddress, blacklistRMMacAddress=blacklistRMMacAddress, severelyErroredSeconds=severelyErroredSeconds, enableTransmission=enableTransmission, byteErrorRatioLinked=byteErrorRatioLinked, licenseMaxLinkRange=licenseMaxLinkRange, linkLoss=linkLoss, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sFPPortDisabledWarning=sFPPortDisabledWarning, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteInternetAddress=remoteInternetAddress, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, dNSResolver=dNSResolver, mainPSUPortQLTx=mainPSUPortQLTx, cableDiagnosticsControl=cableDiagnosticsControl, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, rangeLinked=rangeLinked, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagPair4Distance=cableDiagPair4Distance, cableDiagPair2Distance=cableDiagPair2Distance, portAllocationMismatch=portAllocationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, ptpCompliance=ptpCompliance, ptpTraps=ptpTraps, licenseRARSupport=licenseRARSupport, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, capacityVariantMismatch=capacityVariantMismatch, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tDDControl=tDDControl, longitude=longitude, dNSServerPortNumber=dNSServerPortNumber, cableDiagnosticsResultTable=cableDiagnosticsResultTable, wirelessTopology=wirelessTopology, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, antennaSelection=antennaSelection, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, receiveChannel=receiveChannel, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNMPCommunityString=sNMPCommunityString, ethernetStatisticsTable=ethernetStatisticsTable, regulatoryBandTrap=regulatoryBandTrap, sNMPTrapTable=sNMPTrapTable, licenseInstancedTableIndex=licenseInstancedTableIndex, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, syncESlavePort=syncESlavePort, licenseInstancedTableEntry=licenseInstancedTableEntry, tDMConfigurationMismatch=tDMConfigurationMismatch, snmpControlGroup=snmpControlGroup, eIRP=eIRP, dNSServerTableIndex=dNSServerTableIndex, dNSServerTableNumber=dNSServerTableNumber, sFPPortStatusTrap=sFPPortStatusTrap, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, installStatusTrap=installStatusTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, authorizationControlTableEntry=authorizationControlTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, whitelistRMEnabled=whitelistRMEnabled, sMTPEnabledMessages=sMTPEnabledMessages, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, softwareVersion=softwareVersion, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortAllocation=mainPSUPortAllocation, rxColorCode=rxColorCode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, deviceESN=deviceESN, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortStatusTrap=auxPortStatusTrap, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mABProtocolVID=mABProtocolVID, receivePower=receivePower, phyControlGroup=phyControlGroup, phyStatus=phyStatus, linkName=linkName, mABState=mABState, alarmInstancedTable=alarmInstancedTable, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, ethernetGroup=ethernetGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, authorizationControlTableIndex=authorizationControlTableIndex, receiveModulationModeLinked=receiveModulationModeLinked, tDMInterfaceControl=tDMInterfaceControl, portAllocationMismatchLinked=portAllocationMismatchLinked, targetRange=targetRange, secureModeAlarm=secureModeAlarm, l2CPPriorityTable=l2CPPriorityTable, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sFPPortSSMTx=sFPPortSSMTx, alarmInstancedTableNumber=alarmInstancedTableNumber, ethernetStatisticsDataSource=ethernetStatisticsDataSource, cableDiagPair3Results=cableDiagPair3Results, deviceMSN=deviceMSN, accessMethod=accessMethod, routerProtocolsGroup=routerProtocolsGroup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, iPv6Address=iPv6Address, sFPPortAutoNegotiation=sFPPortAutoNegotiation, portAllocationMismatchTrap=portAllocationMismatchTrap, transmitPowerLinked=transmitPowerLinked, alarms=alarms, userName=userName, alarmInstancedTableEntry=alarmInstancedTableEntry, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, syslogClientTrap=syslogClientTrap, syslogStateTrap=syslogStateTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, signalStrengthRatio=signalStrengthRatio, sNTPServerInternetAddressType=sNTPServerInternetAddressType, channelChangeTrap=channelChangeTrap, mABHoldoffPeriod=mABHoldoffPeriod, encryption=encryption, remoteMaximumTransmitPower=remoteMaximumTransmitPower, productName=productName, ethernetPriorityTable=ethernetPriorityTable, tDMChannelLineCode=tDMChannelLineCode, phyControlInstancedTable=phyControlInstancedTable, sNTPPollInterval=sNTPPollInterval, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, searchState=searchState, authorizationControlTable=authorizationControlTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, frequencyVariant=frequencyVariant, mgmtInstancedTableNumber=mgmtInstancedTableNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, antennaGain=antennaGain, configurationInstancedTableNumber=configurationInstancedTableNumber, aggregateDataRate=aggregateDataRate, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseGroupAccess=licenseGroupAccess, syslogControl=syslogControl, qOSPriorityScheme=qOSPriorityScheme, dataBridgingStatus=dataBridgingStatus, reset=reset, licenseSyncESupport=licenseSyncESupport, dfsTableIndex=dfsTableIndex, transparentClockPort=transparentClockPort, rangingMode=rangingMode, unitIdentification=unitIdentification, sFPPortAllocation=sFPPortAllocation, tDMChannelStatus=tDMChannelStatus, tDM=tDM, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, installArmState=installArmState, managementGroup=managementGroup, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, configurationGroup=configurationGroup, routerProtocols=routerProtocols)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, packetsFromInternalStack=packetsFromInternalStack, sNTPServerStatus=sNTPServerStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerTable=sNTPServerTable, iPv4Address=iPv4Address, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkModeOptimization=linkModeOptimization, cableDiagnostics=cableDiagnostics, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tempPcb=tempPcb, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDMInterfaceStatus=tDMInterfaceStatus, mainPSUPortAutoMdix=mainPSUPortAutoMdix, pubStatsGroup=pubStatsGroup, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dNSServerTable=dNSServerTable, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagPair2Results=cableDiagPair2Results, channelBandwidth=channelBandwidth, syslogControlGroup=syslogControlGroup, syncETrackingState=syncETrackingState, hTTPSPortNumber=hTTPSPortNumber, linkLossLinked=linkLossLinked, receiveDataRateLinked=receiveDataRateLinked, ptpTrapPrefix=ptpTrapPrefix, tDMChannelLoopback=tDMChannelLoopback, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, configuration=configuration, receiveFreqMHz=receiveFreqMHz, txMABFrames=txMABFrames, rawReceivePower=rawReceivePower, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, auxPortQLRx=auxPortQLRx, licenseIssueNumber=licenseIssueNumber, hTTPPortNumber=hTTPPortNumber, remoteUnitName=remoteUnitName, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, apc=apc, mABMaintenanceLevel=mABMaintenanceLevel, mABNominalModulationMode=mABNominalModulationMode, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitDataRate=transmitDataRate, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sNTPServerTimeout=sNTPServerTimeout, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sFPError=sFPError, dfsPeaks=dfsPeaks, sFPPortStatus=sFPPortStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, regulatoryBand=regulatoryBand, installationMode=installationMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tdmTableIndex=tdmTableIndex, whitelistRMMacAddress=whitelistRMMacAddress)
