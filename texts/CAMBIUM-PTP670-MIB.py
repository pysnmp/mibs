...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tFTPServerInternetAddressType=tFTPServerInternetAddressType, targetMACAddress=targetMACAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, unavailableSeconds=unavailableSeconds, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNMPCommunityString=sNMPCommunityString, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, tdmTable=tdmTable, byteErrorRatioLinked=byteErrorRatioLinked, tDMChannelLineCode=tDMChannelLineCode, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dataBridgingStatus=dataBridgingStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, transmitDataRateLinked=transmitDataRateLinked, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, remoteInternetAddressType=remoteInternetAddressType, cableDiagnosticsResultTable=cableDiagnosticsResultTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseInstancedTableIndex=licenseInstancedTableIndex, notificationsGroup=notificationsGroup, channelBandwidth=channelBandwidth, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, softwareVersion=softwareVersion, maximumNumberOfSlaves=maximumNumberOfSlaves, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenseInstancedTable=licenseInstancedTable, wirelessTopology=wirelessTopology, frequencyVariant=frequencyVariant, licenseGroupAccess=licenseGroupAccess, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetStatisticsTable=ethernetStatisticsTable, auxPortStatus=auxPortStatus, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, userTableEntry=userTableEntry, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, aAAControlGroup=aAAControlGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tdmTableNumber=tdmTableNumber, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, gatewayIPAddress=gatewayIPAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, syncEEquipmentClock=syncEEquipmentClock, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPv4Address=iPv4Address, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, auxPortAcceptedQLRx=auxPortAcceptedQLRx, cableDiagPair3Distance=cableDiagPair3Distance, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, dNSServerPortNumber=dNSServerPortNumber, authorizationMethod=authorizationMethod, enableTransmission=enableTransmission, sMTPServerInternetAddressType=sMTPServerInternetAddressType, extendedSpectrumScanning=extendedSpectrumScanning, configuration=configuration, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, smtp=smtp, rangingMode=rangingMode, wirelessOutOctets=wirelessOutOctets, dNSResolver=dNSResolver, sFPPortAutoMdix=sFPPortAutoMdix, licenseInstancedTableNumber=licenseInstancedTableNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, aAAControl=aAAControl, remoteUnitNameLinked=remoteUnitNameLinked, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, whitelistRMMacAddress=whitelistRMMacAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mainPSUPortQLRx=mainPSUPortQLRx, apcGroup=apcGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, productName=productName, maxLinkRangeExceeded=maxLinkRangeExceeded, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableDiagnosticsWarning=cableDiagnosticsWarning, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, dSCPManagementPriority=dSCPManagementPriority, regulatoryBand=regulatoryBand, transmitterChannels=transmitterChannels, sFPPortQLRx=sFPPortQLRx, receivePower=receivePower, sFPError=sFPError, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sFPPortQLTx=sFPPortQLTx, eIRP=eIRP, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, deviceESN=deviceESN, hTTPSAccessEnabled=hTTPSAccessEnabled, smtpGroup=smtpGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, unitIdentification=unitIdentification, whitelistRMEnabled=whitelistRMEnabled, sMTPServerInternetAddress=sMTPServerInternetAddress, syncESlavePort=syncESlavePort, groupID=groupID, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ptp=ptp, configurationInstancedTableNumber=configurationInstancedTableNumber, dfsGroup=dfsGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, versionsGroup=versionsGroup, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, routerProtocolsGroup=routerProtocolsGroup, transmitPower=transmitPower, aggregateDataRate=aggregateDataRate, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, transmitChannel=transmitChannel, mainPSUPortStatus=mainPSUPortStatus, cableDiagPair2Distance=cableDiagPair2Distance, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, configurationInstancedTableEntry=configurationInstancedTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, configurationGroup=configurationGroup, linkSymmetry=linkSymmetry, dNS=dNS, supplementary=supplementary, portAllocationMismatchLinked=portAllocationMismatchLinked, mainPSUPortAllocation=mainPSUPortAllocation, searchStateLinked=searchStateLinked, ethernetPriorityTableEntry=ethernetPriorityTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, antennaGain=antennaGain, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, transparentClock=transparentClock, sNMPTrapTableEntry=sNMPTrapTableEntry, tDMInterfaceControl=tDMInterfaceControl, remoteUnitName=remoteUnitName, lbtDetectedTrap=lbtDetectedTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, qOSPriorityScheme=qOSPriorityScheme, resetGroup=resetGroup, licenseRARSupport=licenseRARSupport, byteErrorRatio=byteErrorRatio, licenseOOBManagementSupport=licenseOOBManagementSupport, ethernet=ethernet, sFPErrorTrap=sFPErrorTrap, userTableNumber=userTableNumber, sNTPServerTable=sNTPServerTable, authorizationControlTableIndex=authorizationControlTableIndex, tDMGroup=tDMGroup, dfsTableEntry=dfsTableEntry, erroredSeconds=erroredSeconds, linkLossLinked=linkLossLinked, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortSSMTx=mainPSUPortSSMTx, maximumTransmitPower=maximumTransmitPower, sNTPPollInterval=sNTPPollInterval, licenseGroup=licenseGroup, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sFPPortAutoNegotiation=sFPPortAutoNegotiation, PYSNMP_MODULE_ID=cambium, hTTPPortNumber=hTTPPortNumber, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, mABHoldoffPeriod=mABHoldoffPeriod, vLANManagementVID=vLANManagementVID, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, userRole=userRole, altitude=altitude, alarmsGroup=alarmsGroup, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, cambium=cambium, signalStrengthRatio=signalStrengthRatio, sNTPLastSync=sNTPLastSync, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cableDiagnostics=cableDiagnostics, pubInstancedStatsTable=pubInstancedStatsTable, licenseEncryption=licenseEncryption, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, installStatusTrap=installStatusTrap, nIDULanPortStatus=nIDULanPortStatus, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, sNTPServerRetries=sNTPServerRetries, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, configurationInstancedTableIndex=configurationInstancedTableIndex, accessMethod=accessMethod, userPassword=userPassword, managementGroup=managementGroup, hTTPSPortNumber=hTTPSPortNumber, management=management, sFPPortStatusTrap=sFPPortStatusTrap, l2CPPriorityTable=l2CPPriorityTable, sNTPState=sNTPState, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sFPPortDisabledWarning=sFPPortDisabledWarning, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, systemReset=systemReset, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, authorizationControlTable=authorizationControlTable, dfsTable=dfsTable, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, sNTPServerTableIndex=sNTPServerTableIndex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, receiveDataRateLinked=receiveDataRateLinked, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transparentClockPort=transparentClockPort, receiveFreqMHz=receiveFreqMHz, dNSServerInternetAddressType=dNSServerInternetAddressType, iPv6PrefixLength=iPv6PrefixLength, longitude=longitude, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, sNMPv3Enable=sNMPv3Enable, nIDULanPortStatusTrap=nIDULanPortStatusTrap, dfs=dfs, sFPPortStatus=sFPPortStatus, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sMTPEmailAlert=sMTPEmailAlert, licenseInstancedTableEntry=licenseInstancedTableEntry, authorizationControlGroup=authorizationControlGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telnetAccessEnabled=telnetAccessEnabled, linkLoss=linkLoss, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, hCMPMaximumLinkRange=hCMPMaximumLinkRange, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseSFPPortSupport=licenseSFPPortSupport, authorizationControl=authorizationControl, transmitModulationMode=transmitModulationMode, alarmInstancedTable=alarmInstancedTable, portAllocationMismatch=portAllocationMismatch, syslogClientTrap=syslogClientTrap, sNMPTrapTable=sNMPTrapTable)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", encryptionGroup=encryptionGroup, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, authorizationControlTableEntry=authorizationControlTableEntry, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, rawReceivePowerLinked=rawReceivePowerLinked, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseSecurityLevel=licenseSecurityLevel, bootVersion=bootVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, auxPortQLRx=auxPortQLRx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, tDMConfigurationMismatch=tDMConfigurationMismatch, rangeLinked=rangeLinked, installArmStateTrap=installArmStateTrap, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, dNSServerTableEntry=dNSServerTableEntry, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, dfsTableIndex=dfsTableIndex, hardwareVersion=hardwareVersion, packetsFromInternalStack=packetsFromInternalStack, managementNetworkAccessEnabled=managementNetworkAccessEnabled, configurationInstancedTable=configurationInstancedTable, linkName=linkName, phyStatusGroup=phyStatusGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, subnetMask=subnetMask, tDMInterfaceStatus=tDMInterfaceStatus, licenseMaxLinkRange=licenseMaxLinkRange, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, dataBridgingStatusLinked=dataBridgingStatusLinked, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, masterSlaveMode=masterSlaveMode, dNSServerTableIndex=dNSServerTableIndex, hCMPLinkSymmetry=hCMPLinkSymmetry, cableDiagPair3Results=cableDiagPair3Results, ethernetGroup=ethernetGroup, aggregateDataRateLinked=aggregateDataRateLinked, auxPortSSMTx=auxPortSSMTx, linkModeOptimization=linkModeOptimization, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, cableDiagPair4Results=cableDiagPair4Results, dataPortPauseFrames=dataPortPauseFrames, transmitDataRate=transmitDataRate, licenseTLSRekey=licenseTLSRekey, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, cableDiagPair1Distance=cableDiagPair1Distance, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dNSServerTableNumber=dNSServerTableNumber, transparentClockVLAN=transparentClockVLAN, txColorCode=txColorCode, remoteMACAddressLinked=remoteMACAddressLinked, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, dataBridgingAvailability=dataBridgingAvailability, syncETracking=syncETracking, range=range, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseSyncESupport=licenseSyncESupport, signalStrengthRatioLinked=signalStrengthRatioLinked, packetsToInternalStack=packetsToInternalStack, sNTPServerTableNumber=sNTPServerTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, receiveChannel=receiveChannel, ethernetPriorityTable=ethernetPriorityTable, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseIPv6Support=licenseIPv6Support, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, mgmtInstancedTableNumber=mgmtInstancedTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, dNSServerInternetAddress=dNSServerInternetAddress, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, transmitPowerLinked=transmitPowerLinked, snmpControl=snmpControl, dfsTableNumber=dfsTableNumber, alarmInstancedTableIndex=alarmInstancedTableIndex, encryptionAlgorithm=encryptionAlgorithm, antennaSelection=antennaSelection, installStatus=installStatus, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vectorErrorLinked=vectorErrorLinked, ptmp=ptmp, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, ethernetStatisticsDataSource=ethernetStatisticsDataSource, ptpGroups=ptpGroups, licenseIEEE1588Support=licenseIEEE1588Support, wirelessLinkStatusLinked=wirelessLinkStatusLinked, unitIdentificationGroup=unitIdentificationGroup, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, nIDULanPortAutoMdix=nIDULanPortAutoMdix, cableDiagnosticsPorts=cableDiagnosticsPorts, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, installationMode=installationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mainPSUPortQLTx=mainPSUPortQLTx, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, ptpTraps=ptpTraps, unitOutOfCalibration=unitOutOfCalibration, phyControlInstancedTable=phyControlInstancedTable, phyInstancedStatusTable=phyInstancedStatusTable, licenseCountry=licenseCountry, ptp670=ptp670, wirelessLinkAvailability=wirelessLinkAvailability, versions=versions, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, apc=apc, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mainPSUPortStatusTrap=mainPSUPortStatusTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, installStatusLinked=installStatusLinked, alarmInstancedTableNumber=alarmInstancedTableNumber, ethernetInstancedTableIndex=ethernetInstancedTableIndex, auxPortQLTx=auxPortQLTx, installArmState=installArmState, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, auxPortAllocation=auxPortAllocation, daylightSaving=daylightSaving, lowestTDMModulationMode=lowestTDMModulationMode, pubStats=pubStats, receivePowerLinked=receivePowerLinked, capacityVariantMismatchLinked=capacityVariantMismatchLinked, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, transmitModulationModeLinked=transmitModulationModeLinked, sNTPPrimaryServer=sNTPPrimaryServer, receiveModulationModeDetail=receiveModulationModeDetail, sNMPEnabledTraps=sNMPEnabledTraps, bridge=bridge, authorizationControlTableNumber=authorizationControlTableNumber, tDM=tDM, tDDControl=tDDControl, rawReceivePower=rawReceivePower, receiveModulationModeLinked=receiveModulationModeLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, tFTPServerPortNumber=tFTPServerPortNumber, encryption=encryption, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, snmpControlGroup=snmpControlGroup, syslogStateTrap=syslogStateTrap, capacityVariantMismatch=capacityVariantMismatch, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPSyncTrap=sNTPSyncTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, remoteInternetAddressLinked=remoteInternetAddressLinked, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, mABNominalModulationMode=mABNominalModulationMode, cableDiagPair1Results=cableDiagPair1Results, routerProtocols=routerProtocols, txMABFrames=txMABFrames, deviceMSN=deviceMSN, iPVersion=iPVersion, secureModeAlarmTrap=secureModeAlarmTrap, sFPPortAllocation=sFPPortAllocation, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyControlGroup=phyControlGroup, remoteInternetAddress=remoteInternetAddress, severelyErroredSeconds=severelyErroredSeconds, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, blacklistRMMacAddress=blacklistRMMacAddress, dNSPrimaryServer=dNSPrimaryServer, mgmtInstancedTable=mgmtInstancedTable, licenseGasGroup=licenseGasGroup, channelChangeTrap=channelChangeTrap, auxPortDisabledWarning=auxPortDisabledWarning, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, mABProtocolVLANPriority=mABProtocolVLANPriority, rxColorCode=rxColorCode, wirelessOutAllOctets=wirelessOutAllOctets, tDDSynchronizationMode=tDDSynchronizationMode, telnetPortNumber=telnetPortNumber, sNMPTrapVersion=sNMPTrapVersion, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, phyStatus=phyStatus, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, userName=userName, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, ptpTrapPrefix=ptpTrapPrefix, timeZone=timeZone, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveDataRate=receiveDataRate, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, wirelessLinkStatus=wirelessLinkStatus, capacityVariantMismatchTrap=capacityVariantMismatchTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseIssueNumber=licenseIssueNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, syslogControl=syslogControl, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, siteName=siteName, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, tFTPServerInternetAddress=tFTPServerInternetAddress, tempPcb=tempPcb, blacklistRMEnabled=blacklistRMEnabled, mABProtocolVID=mABProtocolVID, tDMChannelLoopback=tDMChannelLoopback, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, userEnabled=userEnabled, cableDiagPair4Distance=cableDiagPair4Distance, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerStatus=sNTPServerStatus, supplementaryGroup=supplementaryGroup, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, ptpCompliance=ptpCompliance, latitude=latitude, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dNSServerTable=dNSServerTable, phyControlInstancedTableEntry=phyControlInstancedTableEntry, systemClock=systemClock, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, tdmTableEntry=tdmTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv6Address=iPv6Address, bridgeGroup=bridgeGroup, receiveFreqKHz=receiveFreqKHz, tFTPClient=tFTPClient, tDMChannelCableLength=tDMChannelCableLength, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNTPServerTableEntry=sNTPServerTableEntry, cableLoss=cableLoss, alarms=alarms, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, syslogClient=syslogClient, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, productVariant=productVariant, dNSGroup=dNSGroup, ethernetInstancedTable=ethernetInstancedTable, syslogState=syslogState, targetRange=targetRange, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, userTableIndex=userTableIndex, mgmtInstancedTableIndex=mgmtInstancedTableIndex, reset=reset, tDMEnabledChannels=tDMEnabledChannels)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortSyncERxStatus=sFPPortSyncERxStatus, secondarySoftwareVersion=secondarySoftwareVersion, license=license, cableDiagPair2Results=cableDiagPair2Results, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, tdmTableIndex=tdmTableIndex, licenseBandwidthCap=licenseBandwidthCap, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNTPSync=sNTPSync, licenseCapacity=licenseCapacity, sNTPServerTimeout=sNTPServerTimeout, lowestDataModulationMode=lowestDataModulationMode, licenseHCMPSupport=licenseHCMPSupport, mABMaintenanceLevel=mABMaintenanceLevel, secureModeAlarm=secureModeAlarm, dfsPeaks=dfsPeaks, pubStatsGroup=pubStatsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, deviceMACAddress=deviceMACAddress, iPv6GatewayAddress=iPv6GatewayAddress, sntpGroup=sntpGroup, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseVersion=licenseVersion, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, auxPortStatusTrap=auxPortStatusTrap, receiveModulationMode=receiveModulationMode, userTable=userTable, syslogControlGroup=syslogControlGroup, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, vLANManagementPriority=vLANManagementPriority, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, remoteMACAddress=remoteMACAddress, dfsMeans=dfsMeans, transmitFreqMHz=transmitFreqMHz, localPacketFiltering=localPacketFiltering, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, syncETrackingState=syncETrackingState, mABTransmissionInterval=mABTransmissionInterval, mABState=mABState, searchState=searchState, sntp=sntp, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vectorError=vectorError, cableDiagnosticsControl=cableDiagnosticsControl, tDMChannelStatus=tDMChannelStatus, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mainPSUPortAutoMdix=mainPSUPortAutoMdix, tDDControlGroup=tDDControlGroup, phyControl=phyControl, useVLANForMABProtocol=useVLANForMABProtocol, transparentClockVID=transparentClockVID, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, iPDSCPPriorityTable=iPDSCPPriorityTable, unitName=unitName, sFPPortSSMTx=sFPPortSSMTx, regulatoryBandTrap=regulatoryBandTrap, subbandLowestFrequency=subbandLowestFrequency, sNMPPortNumber=sNMPPortNumber)
