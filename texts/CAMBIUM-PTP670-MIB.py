...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, dNSServerInternetAddress=dNSServerInternetAddress, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sntpGroup=sntpGroup, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, wirelessTopology=wirelessTopology, mABNominalModulationMode=mABNominalModulationMode, masterSlaveMode=masterSlaveMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, productName=productName, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteMACAddress=remoteMACAddress, licenseEncryption=licenseEncryption, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, phyControlInstancedTable=phyControlInstancedTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetGroup=ethernetGroup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, wirelessLinkStatusLinked=wirelessLinkStatusLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, blacklistRMMacAddress=blacklistRMMacAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, iPVersion=iPVersion, dNSResolver=dNSResolver, tDMChannelStatus=tDMChannelStatus, cableDiagPair1Distance=cableDiagPair1Distance, installStatus=installStatus, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sNMPCommunityString=sNMPCommunityString, encryptionAlgorithm=encryptionAlgorithm, licenseIEEE1588Support=licenseIEEE1588Support, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernet=ethernet, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tDMChannelCableLength=tDMChannelCableLength, sNMPTrapTable=sNMPTrapTable, receiveModulationModeDetail=receiveModulationModeDetail, tdmTableIndex=tdmTableIndex, notificationsGroup=notificationsGroup, sMTPEmailAlert=sMTPEmailAlert, siteName=siteName, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, userPassword=userPassword, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, transmitFreqKHz=transmitFreqKHz, installStatusTrap=installStatusTrap, unavailableSeconds=unavailableSeconds, license=license, linkModeOptimization=linkModeOptimization, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sNMPv3Enable=sNMPv3Enable, telnetAccessEnabled=telnetAccessEnabled, dNSServerTableIndex=dNSServerTableIndex, authorizationControl=authorizationControl, ethernetInstancedTableEntry=ethernetInstancedTableEntry, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseInstancedTable=licenseInstancedTable, sFPPortDisabledWarning=sFPPortDisabledWarning, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataBridgingStatusAlarm=dataBridgingStatusAlarm, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, dNSGroup=dNSGroup, authorizationControlTable=authorizationControlTable, phyStatusGroup=phyStatusGroup, receivePower=receivePower, cableDiagPair4Results=cableDiagPair4Results, ptpGroups=ptpGroups, ptmp=ptmp, tdmTableNumber=tdmTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mABNominalTransmitCapacity=mABNominalTransmitCapacity, antennaSelection=antennaSelection, managementNetworkAccessEnabled=managementNetworkAccessEnabled, range=range, apcGroup=apcGroup, transparentClock=transparentClock, blacklistRMEnabled=blacklistRMEnabled, ptpCompliance=ptpCompliance, userEnabled=userEnabled, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, systemReset=systemReset, secondarySoftwareVersion=secondarySoftwareVersion, dSCPManagementPriority=dSCPManagementPriority, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ptpTraps=ptpTraps, hardwareVersion=hardwareVersion, wirelessOutAllOctets=wirelessOutAllOctets, receiveFreqKHz=receiveFreqKHz, syslogControl=syslogControl, sMTPServerPortNumber=sMTPServerPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, subbandHighestFrequency=subbandHighestFrequency, dNSServerPortNumber=dNSServerPortNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tDMGroup=tDMGroup, licenseIssueNumber=licenseIssueNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, productVariant=productVariant, secureModeAlarmTrap=secureModeAlarmTrap, authorizationControlTableEntry=authorizationControlTableEntry, userName=userName, sNTPServerTable=sNTPServerTable, tDMInterfaceControl=tDMInterfaceControl, snmpControl=snmpControl, dfsTableIndex=dfsTableIndex, mainPSUPortQLRx=mainPSUPortQLRx, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, qOSPriorityScheme=qOSPriorityScheme, reset=reset, tFTPServerInternetAddressType=tFTPServerInternetAddressType, syslogClientTrap=syslogClientTrap, licenseIPv6Support=licenseIPv6Support, syslogStateTrap=syslogStateTrap, byteErrorRatioLinked=byteErrorRatioLinked, snmpControlGroup=snmpControlGroup, phyControlInstancedTableNumber=phyControlInstancedTableNumber, phyControlInstancedTableIndex=phyControlInstancedTableIndex, licenseVersion=licenseVersion, licenseInstancedTableIndex=licenseInstancedTableIndex, installArmState=installArmState, licenseTDDSyncSupport=licenseTDDSyncSupport, cableDiagnosticsGroup=cableDiagnosticsGroup, cableDiagPair2Distance=cableDiagPair2Distance, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortAcceptedQLRx=auxPortAcceptedQLRx, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dNSServerTable=dNSServerTable, routerProtocolsGroup=routerProtocolsGroup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, mgmtInstancedTable=mgmtInstancedTable, cableLoss=cableLoss, userTableNumber=userTableNumber, sNTPSyncTrap=sNTPSyncTrap, transmitDataRate=transmitDataRate, licenseInstancedTableNumber=licenseInstancedTableNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, softwareVersion=softwareVersion, cableDiagPair3Distance=cableDiagPair3Distance, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelChangeTrap=channelChangeTrap, whitelistRMEnabled=whitelistRMEnabled, tDMInterfaceStatus=tDMInterfaceStatus, syncETracking=syncETracking, gatewayIPAddress=gatewayIPAddress, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, authorizationControlTableIndex=authorizationControlTableIndex, subbandLowestFrequency=subbandLowestFrequency, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerRetries=sNTPServerRetries, severelyErroredSeconds=severelyErroredSeconds, auxPortDisabledWarning=auxPortDisabledWarning, sNTPServerTableEntry=sNTPServerTableEntry, cambium=cambium, smtp=smtp, subnetMask=subnetMask, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, cableDiagPair1Results=cableDiagPair1Results, ethernetPriorityTable=ethernetPriorityTable, mainPSUPortStatus=mainPSUPortStatus, alarms=alarms, sNTPServerPortNumber=sNTPServerPortNumber, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tempPcb=tempPcb, configurationInstancedTableNumber=configurationInstancedTableNumber, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, dfsMeans=dfsMeans, pubStats=pubStats, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, transmitFreqMHz=transmitFreqMHz, cableDiagPair3Results=cableDiagPair3Results, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseRARSupport=licenseRARSupport, rawReceivePowerLinked=rawReceivePowerLinked, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, unitName=unitName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseHCMPSupport=licenseHCMPSupport, licenseBandwidthCap=licenseBandwidthCap, signalStrengthRatio=signalStrengthRatio, phyControlGroup=phyControlGroup, ethernetInstancedTableNumber=ethernetInstancedTableNumber, iPv4Address=iPv4Address, wirelessOutEthernetOctets=wirelessOutEthernetOctets, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, unitOutOfCalibration=unitOutOfCalibration, licenseSecurityLevel=licenseSecurityLevel, hCMPLinkSymmetry=hCMPLinkSymmetry, secureModeAlarm=secureModeAlarm, management=management, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControlGroup=syslogControlGroup, nIDULanPortStatusTrap=nIDULanPortStatusTrap, syncETrackingState=syncETrackingState, frequencyVariant=frequencyVariant, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, smtpGroup=smtpGroup, installArmStateTrap=installArmStateTrap, aAAControlGroup=aAAControlGroup, transmitModulationMode=transmitModulationMode, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, alarmInstancedTable=alarmInstancedTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseTrialPeriod=licenseTrialPeriod, phyControl=phyControl, alarmInstancedTableIndex=alarmInstancedTableIndex, vectorError=vectorError, maximumNumberOfSlaves=maximumNumberOfSlaves, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, mainPSUPortQLTx=mainPSUPortQLTx, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sFPError=sFPError, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, transmitPower=transmitPower, accessMethod=accessMethod, sMTPServerInternetAddress=sMTPServerInternetAddress, configurationGroup=configurationGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, authorizationControlGroup=authorizationControlGroup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, linkName=linkName, licenseMaxLinkRange=licenseMaxLinkRange, tDMChannelLoopback=tDMChannelLoopback, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", telnetPortNumber=telnetPortNumber, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tFTPServerPortNumber=tFTPServerPortNumber, versions=versions, remoteUnitName=remoteUnitName, sFPErrorTrap=sFPErrorTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, PYSNMP_MODULE_ID=cambium, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPPortNumber=sNMPPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPServerInternetAddress=tFTPServerInternetAddress, remoteMACAddressLinked=remoteMACAddressLinked, licenseGroup=licenseGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, mainPSUPortStatusTrap=mainPSUPortStatusTrap, installStatusLinked=installStatusLinked, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, vLANManagementVID=vLANManagementVID, alarmInstancedTableEntry=alarmInstancedTableEntry, altitude=altitude, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vectorErrorLinked=vectorErrorLinked, licenseCapacity=licenseCapacity, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, whitelistRMMacAddress=whitelistRMMacAddress, transparentClockVLAN=transparentClockVLAN, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regulatoryBandTrap=regulatoryBandTrap, syncESlavePort=syncESlavePort, sNTPServerTableNumber=sNTPServerTableNumber, rangeLinked=rangeLinked, unitIdentificationGroup=unitIdentificationGroup, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseSFPPortSupport=licenseSFPPortSupport, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, maximumTransmitPower=maximumTransmitPower, remoteUnitNameLinked=remoteUnitNameLinked, linkLoss=linkLoss, hCMPMaximumLinkRange=hCMPMaximumLinkRange, transparentClockVID=transparentClockVID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, regulatoryBand=regulatoryBand, receiveChannel=receiveChannel, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, rxColorCode=rxColorCode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sNTPServerTimeout=sNTPServerTimeout, licenseUnitSerialNumber=licenseUnitSerialNumber, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseSyncESupport=licenseSyncESupport, tDDSynchronizationMode=tDDSynchronizationMode, aAAControl=aAAControl, userRole=userRole, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sFPPortSSMTx=sFPPortSSMTx, remoteMaximumTransmitPower=remoteMaximumTransmitPower, auxPortQLTx=auxPortQLTx, longitude=longitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTable=dfsTable, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, localPacketFiltering=localPacketFiltering, timeZone=timeZone, alarmsGroup=alarmsGroup, dNS=dNS, sFPPortStatusTrap=sFPPortStatusTrap, txMABFrames=txMABFrames, phyInstancedStatusTable=phyInstancedStatusTable, sNMPTrapTableEntry=sNMPTrapTableEntry, mainPSUPortAllocation=mainPSUPortAllocation, tDM=tDM, supplementaryGroup=supplementaryGroup, dNSServerTableEntry=dNSServerTableEntry, groupID=groupID, targetRange=targetRange, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, mABMaintenanceLevel=mABMaintenanceLevel, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, txColorCode=txColorCode, wirelessLinkAvailability=wirelessLinkAvailability, iPv6PrefixLength=iPv6PrefixLength, vLANManagementPriority=vLANManagementPriority, sFPPortQLTx=sFPPortQLTx, tFTPClient=tFTPClient, portAllocationMismatchTrap=portAllocationMismatchTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, cableDiagnosticsPorts=cableDiagnosticsPorts, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, receiveDataRateLinked=receiveDataRateLinked, cableDiagnostics=cableDiagnostics, cableDiagPair4Distance=cableDiagPair4Distance, daylightSaving=daylightSaving, configuration=configuration, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, transmitPowerLinked=transmitPowerLinked, deviceMSN=deviceMSN, phyStatus=phyStatus, sFPPortAutoMdix=sFPPortAutoMdix, sNTPPrimaryServer=sNTPPrimaryServer, searchState=searchState, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tDDControlGroup=tDDControlGroup, tdmTableEntry=tdmTableEntry, tDMChannelStatusTrap=tDMChannelStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, capacityVariantMismatch=capacityVariantMismatch, sNTPPollInterval=sNTPPollInterval, licenseOOBManagementSupport=licenseOOBManagementSupport, authorizationMethod=authorizationMethod, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, configurationInstancedTable=configurationInstancedTable, l2CPPriorityTable=l2CPPriorityTable, dataBridgingAvailability=dataBridgingAvailability, sntp=sntp, channelBandwidth=channelBandwidth, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnosticsWarning=cableDiagnosticsWarning, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, syncEEquipmentClock=syncEEquipmentClock, hTTPSPortNumber=hTTPSPortNumber, dataBridgingStatusLinked=dataBridgingStatusLinked, lbtDetectedTrap=lbtDetectedTrap, ptp670=ptp670, ethernetPriorityTableNumber=ethernetPriorityTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mABState=mABState, useVLANForMABProtocol=useVLANForMABProtocol, licenseGasGroup=licenseGasGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, byteErrorRatio=byteErrorRatio, auxPortStatus=auxPortStatus, tdmTable=tdmTable, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, dfsGroup=dfsGroup, rangingMode=rangingMode, tDMChannelLineCode=tDMChannelLineCode, iPv6GatewayAddress=iPv6GatewayAddress, mABHoldoffPeriod=mABHoldoffPeriod, userTable=userTable, versionsGroup=versionsGroup, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, bridgeGroup=bridgeGroup, sFPPortStatus=sFPPortStatus, apc=apc, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPState=sNTPState, licenseTLSRekey=licenseTLSRekey, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, tDDSynchronizationStatus=tDDSynchronizationStatus, mgmtInstancedTableNumber=mgmtInstancedTableNumber, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, installationMode=installationMode, antennaGain=antennaGain, iPv6Address=iPv6Address, auxPortSyncERxStatus=auxPortSyncERxStatus, sNTPServerTableIndex=sNTPServerTableIndex, nIDULanPortStatus=nIDULanPortStatus, remoteInternetAddressLinked=remoteInternetAddressLinked, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, configurationInstancedTableEntry=configurationInstancedTableEntry, cableDiagnosticsControl=cableDiagnosticsControl, enableTransmission=enableTransmission, wirelessOutOctets=wirelessOutOctets, managementGroup=managementGroup, receiveModulationModeLinked=receiveModulationModeLinked, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, auxPortSSMTx=auxPortSSMTx, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, phyControlInstancedTableEntry=phyControlInstancedTableEntry, linkLossLinked=linkLossLinked, pubStatsGroup=pubStatsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetStatisticsDataSource=ethernetStatisticsDataSource, mgmtInstancedTableEntry=mgmtInstancedTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseGroupAccess=licenseGroupAccess, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetStatisticsTable=ethernetStatisticsTable, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, authorizationControlTableNumber=authorizationControlTableNumber, mainPSUPortSSMTx=mainPSUPortSSMTx, hTTPAccessEnabled=hTTPAccessEnabled, auxPortStatusTrap=auxPortStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, unitIdentification=unitIdentification, dNSServerInternetAddressType=dNSServerInternetAddressType, aggregateDataRate=aggregateDataRate, encryption=encryption, licenseInstancedTableEntry=licenseInstancedTableEntry, eIRP=eIRP, deviceESN=deviceESN, targetMACAddress=targetMACAddress, bridge=bridge, mgmtInstancedTableIndex=mgmtInstancedTableIndex, rawReceivePower=rawReceivePower, transmitDataRateLinked=transmitDataRateLinked, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, ptp=ptp, syslogState=syslogState, remoteInternetAddress=remoteInternetAddress, supplementary=supplementary, receiveModulationMode=receiveModulationMode, nIDULanPortAutoMdix=nIDULanPortAutoMdix, signalStrengthRatioLinked=signalStrengthRatioLinked, dNSServerTableNumber=dNSServerTableNumber, dataPortPauseFrames=dataPortPauseFrames, cableDiagPair2Results=cableDiagPair2Results, systemClock=systemClock, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortAllocation=sFPPortAllocation, auxPortQLRx=auxPortQLRx, transparentClockPort=transparentClockPort, mABProtocolVID=mABProtocolVID, portAllocationMismatch=portAllocationMismatch, userTableIndex=userTableIndex, encryptionGroup=encryptionGroup, ptpTrapPrefix=ptpTrapPrefix, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, searchStateLinked=searchStateLinked, erroredSeconds=erroredSeconds, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, tDMEnabledChannels=tDMEnabledChannels, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, linkSymmetry=linkSymmetry, tDDControl=tDDControl, transmitterChannels=transmitterChannels, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfs=dfs, dfsTableNumber=dfsTableNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", alarmInstancedTableNumber=alarmInstancedTableNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, extendedSpectrumScanning=extendedSpectrumScanning, sNTPServerStatus=sNTPServerStatus, latitude=latitude, packetsToInternalStack=packetsToInternalStack, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityTable=mPLSTCPriorityTable, pubInstancedStatsTable=pubInstancedStatsTable, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, dfsTableEntry=dfsTableEntry, lowestDataModulationMode=lowestDataModulationMode, ethernetInstancedTable=ethernetInstancedTable, lowestTDMModulationMode=lowestTDMModulationMode, bootVersion=bootVersion, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseCountry=licenseCountry, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, transmitModulationModeLinked=transmitModulationModeLinked, sNTPSync=sNTPSync, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sFPPortQLRx=sFPPortQLRx, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mABTransmissionInterval=mABTransmissionInterval, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dNSPrimaryServer=dNSPrimaryServer, resetGroup=resetGroup, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, userTableEntry=userTableEntry, packetsFromInternalStack=packetsFromInternalStack, auxPortAllocation=auxPortAllocation, receiveFreqMHz=receiveFreqMHz, aggregateDataRateLinked=aggregateDataRateLinked, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveDataRate=receiveDataRate, tDMConfigurationMismatch=tDMConfigurationMismatch, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNTPLastSync=sNTPLastSync, dataBridgingStatus=dataBridgingStatus, receivePowerLinked=receivePowerLinked, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, dfsPeaks=dfsPeaks, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, syslogClient=syslogClient, wirelessLinkStatus=wirelessLinkStatus, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, portAllocationMismatchLinked=portAllocationMismatchLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, routerProtocols=routerProtocols, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, deviceMACAddress=deviceMACAddress, transmitChannel=transmitChannel)
