...
enterprises, Counter64, Bits, Unsigned32, iso, TimeTicks, Counter32, Integer32, ModuleIdentity, Gauge32, NotificationType, IpAddress, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "Bits", "Unsigned32", "iso", "TimeTicks", "Counter32", "Integer32", "ModuleIdentity", "Gauge32", "NotificationType", "IpAddress", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, antennaGain=antennaGain, tempPcb=tempPcb, mPLSTCPriorityTable=mPLSTCPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataBridgingStatus=dataBridgingStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, configurationInstancedTableIndex=configurationInstancedTableIndex, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, aggregateDataRate=aggregateDataRate, reset=reset, mainPSUPortQLRx=mainPSUPortQLRx, transparentClockPort=transparentClockPort, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, licenseGasGroup=licenseGasGroup, targetRange=targetRange, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mainPSUPortSSMTx=mainPSUPortSSMTx, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseRARSupport=licenseRARSupport, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, secureModeAlarmTrap=secureModeAlarmTrap, mABMaintenanceLevel=mABMaintenanceLevel, cableDiagnosticsPorts=cableDiagnosticsPorts, systemClock=systemClock, rangingMode=rangingMode, sntpGroup=sntpGroup, sFPPortAutoMdix=sFPPortAutoMdix, iPv6Address=iPv6Address, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, rangeLinked=rangeLinked, receiveDataRate=receiveDataRate, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, receiveFreqKHz=receiveFreqKHz, subnetMask=subnetMask, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userTableIndex=userTableIndex, cableDiagPair1Distance=cableDiagPair1Distance, vLANManagementVID=vLANManagementVID, tDDControl=tDDControl, sFPPortAllocation=sFPPortAllocation, receiveModulationModeDetail=receiveModulationModeDetail, remoteUnitNameLinked=remoteUnitNameLinked, licenseIPv6Support=licenseIPv6Support, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cableDiagnostics=cableDiagnostics, tFTPServerInternetAddress=tFTPServerInternetAddress, apc=apc, secondarySoftwareVersion=secondarySoftwareVersion, mainPSUPortQLTx=mainPSUPortQLTx, cableLoss=cableLoss, pubStats=pubStats, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mABNominalModulationMode=mABNominalModulationMode, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, whitelistRMEnabled=whitelistRMEnabled, alarmInstancedTable=alarmInstancedTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syncESlavePort=syncESlavePort, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vectorError=vectorError, bridge=bridge, transparentClockVLAN=transparentClockVLAN, linkName=linkName, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, phyControlGroup=phyControlGroup, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, phyInstancedStatusTable=phyInstancedStatusTable, licenseIssueNumber=licenseIssueNumber, remoteInternetAddress=remoteInternetAddress, timeZone=timeZone, licenseBandwidthCap=licenseBandwidthCap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, tdmTableEntry=tdmTableEntry, channelBandwidth=channelBandwidth, ethernetPriorityTable=ethernetPriorityTable, mgmtInstancedTable=mgmtInstancedTable, portAllocationMismatch=portAllocationMismatch, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, userTable=userTable, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, supplementary=supplementary, dNSPrimaryServer=dNSPrimaryServer, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseTLSRekey=licenseTLSRekey, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, regulatoryBand=regulatoryBand, tFTPServerPortNumber=tFTPServerPortNumber, syncETrackingState=syncETrackingState, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, maximumTransmitPower=maximumTransmitPower, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, antennaSelection=antennaSelection, useVLANForMABProtocol=useVLANForMABProtocol, sNMPEnabledTraps=sNMPEnabledTraps, systemReset=systemReset, l2CPPriorityTable=l2CPPriorityTable, severelyErroredSeconds=severelyErroredSeconds, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, frequencyVariant=frequencyVariant, remoteMACAddress=remoteMACAddress, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, productVariant=productVariant, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, tDMGroup=tDMGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, cambium=cambium, transmitDataRateLinked=transmitDataRateLinked, dfsGroup=dfsGroup, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortAllocation=auxPortAllocation, mABProtocolVID=mABProtocolVID, nIDULanPortAutoMdix=nIDULanPortAutoMdix, cableDiagPair2Results=cableDiagPair2Results, dfsPeaks=dfsPeaks, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, lbtDetectedTrap=lbtDetectedTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, phyControl=phyControl, tDMEnabledChannels=tDMEnabledChannels, transmitDataRate=transmitDataRate, siteName=siteName, userName=userName, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, rawReceivePower=rawReceivePower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, groupID=groupID, tDMInterfaceControl=tDMInterfaceControl, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, bootVersion=bootVersion, sNTPServerTableNumber=sNTPServerTableNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, wirelessTopology=wirelessTopology, mainPSUPortStatus=mainPSUPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, configurationInstancedTable=configurationInstancedTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogControlGroup=syslogControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, range=range, unitIdentification=unitIdentification, licenseTrialPeriod=licenseTrialPeriod, remoteInternetAddressLinked=remoteInternetAddressLinked, phyControlInstancedTableEntry=phyControlInstancedTableEntry, sMTPEmailAlert=sMTPEmailAlert, masterSlaveMode=masterSlaveMode, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, alarmInstancedTableNumber=alarmInstancedTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseMaxLinkRange=licenseMaxLinkRange, licenseInstancedTable=licenseInstancedTable, bridgeGroup=bridgeGroup, auxPortQLTx=auxPortQLTx, searchStateLinked=searchStateLinked, erroredSeconds=erroredSeconds, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, transmitModulationModeLinked=transmitModulationModeLinked, phyControlInstancedTableNumber=phyControlInstancedTableNumber, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, alarms=alarms, wirelessLinkStatusLinked=wirelessLinkStatusLinked, wirelessOutOctets=wirelessOutOctets, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, ethernetStatisticsTable=ethernetStatisticsTable, dfsTableIndex=dfsTableIndex, dNSServerTableEntry=dNSServerTableEntry, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, sNTPPollInterval=sNTPPollInterval, sNTPServerTableIndex=sNTPServerTableIndex, iPv6PrefixLength=iPv6PrefixLength, licenseCountry=licenseCountry, tDMInterfaceStatus=tDMInterfaceStatus, rawReceivePowerLinked=rawReceivePowerLinked, authorizationMethod=authorizationMethod, mABNominalTransmitCapacity=mABNominalTransmitCapacity, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseGroupAccess=licenseGroupAccess, sNMPTrapTableIndex=sNMPTrapTableIndex, transparentClockVID=transparentClockVID, dfs=dfs, pubStatsGroup=pubStatsGroup, supplementaryGroup=supplementaryGroup, receivePowerLinked=receivePowerLinked, receiveFreqMHz=receiveFreqMHz, licenseInstancedTableEntry=licenseInstancedTableEntry, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sNTPServerTable=sNTPServerTable, hTTPSPortNumber=hTTPSPortNumber, licenseEncryption=licenseEncryption, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseVersion=licenseVersion, vLANManagementPriority=vLANManagementPriority, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseInstancedTableNumber=licenseInstancedTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, cableDiagnosticsGroup=cableDiagnosticsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, portAllocationMismatchTrap=portAllocationMismatchTrap, installArmStateTrap=installArmStateTrap, dNSServerTableNumber=dNSServerTableNumber, userEnabled=userEnabled, channelChangeTrap=channelChangeTrap, managementGroup=managementGroup, ptpGroups=ptpGroups, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPTrapVersion=sNMPTrapVersion, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tFTPServerInternetAddressType=tFTPServerInternetAddressType, hardwareVersion=hardwareVersion, packetsToInternalStack=packetsToInternalStack, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sMTPServerInternetAddress=sMTPServerInternetAddress, phyStatus=phyStatus, dataPortPauseFrames=dataPortPauseFrames, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hCMPMaximumLinkRange=hCMPMaximumLinkRange, syslogStateTrap=syslogStateTrap, authorizationControlTableNumber=authorizationControlTableNumber, cableDiagPair4Distance=cableDiagPair4Distance, tDMConfigurationMismatch=tDMConfigurationMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, smtp=smtp, iPv6GatewayAddress=iPv6GatewayAddress, sNTPSync=sNTPSync, remoteUnitName=remoteUnitName, syslogControl=syslogControl, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseSyncESupport=licenseSyncESupport, transmitPowerLinked=transmitPowerLinked, syslogClientTrap=syslogClientTrap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, management=management, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, dNSServerPortNumber=dNSServerPortNumber, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dNS=dNS, sNTPLastSync=sNTPLastSync, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sNTPServerRetries=sNTPServerRetries, accessMethod=accessMethod, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, noWirelessChannelAvailable=noWirelessChannelAvailable, byteErrorRatioLinked=byteErrorRatioLinked, sFPPortDisabledWarning=sFPPortDisabledWarning, txColorCode=txColorCode, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, installationMode=installationMode, tDMChannelCableLength=tDMChannelCableLength, sNMPTrapTable=sNMPTrapTable, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, versions=versions, tDMChannelLoopback=tDMChannelLoopback, capacityVariantMismatch=capacityVariantMismatch, secureModeAlarm=secureModeAlarm, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, cableDiagPair4Results=cableDiagPair4Results, mgmtInstancedTableEntry=mgmtInstancedTableEntry, installArmState=installArmState, userTableNumber=userTableNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, dNSResolver=dNSResolver, sFPPortQLRx=sFPPortQLRx, receiveModulationMode=receiveModulationMode, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, searchState=searchState, licenseSecurityLevel=licenseSecurityLevel, tdmTableNumber=tdmTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPError=sFPError, configuration=configuration, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, nIDULanPortStatus=nIDULanPortStatus, unitOutOfCalibration=unitOutOfCalibration, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, subbandLowestFrequency=subbandLowestFrequency, lowestTDMModulationMode=lowestTDMModulationMode, auxPortSyncERxStatus=auxPortSyncERxStatus, phyStatusGroup=phyStatusGroup, transmitModulationMode=transmitModulationMode, iPDSCPPriorityTable=iPDSCPPriorityTable, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, txMABFrames=txMABFrames, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, daylightSaving=daylightSaving, signalStrengthRatioLinked=signalStrengthRatioLinked, resetGroup=resetGroup, tDMChannelStatus=tDMChannelStatus, configurationInstancedTableEntry=configurationInstancedTableEntry, signalStrengthRatio=signalStrengthRatio, versionsGroup=versionsGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPVersion=iPVersion, sFPPortStatusTrap=sFPPortStatusTrap, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, dfsTableNumber=dfsTableNumber, ptp670=ptp670, cableDiagPair2Distance=cableDiagPair2Distance, dNSServerInternetAddress=dNSServerInternetAddress, authorizationControlTableEntry=authorizationControlTableEntry, dSCPManagementPriority=dSCPManagementPriority, mABTransmissionInterval=mABTransmissionInterval, dNSServerTable=dNSServerTable, ethernetInstancedTableIndex=ethernetInstancedTableIndex, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, eIRP=eIRP, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitterChannels=transmitterChannels, receiveChannel=receiveChannel, userTableEntry=userTableEntry, authorizationControlTable=authorizationControlTable, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, cableDiagPair1Results=cableDiagPair1Results, apcGroup=apcGroup, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, linkLoss=linkLoss, mABProtocolVLANPriority=mABProtocolVLANPriority, dfsMeans=dfsMeans, whitelistRMMacAddress=whitelistRMMacAddress, licenseCapacity=licenseCapacity, transparentClock=transparentClock, ptp=ptp, managementPortWirelessDownAlert=managementPortWirelessDownAlert, deviceMACAddress=deviceMACAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hCMPLinkSymmetry=hCMPLinkSymmetry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, authorizationControlGroup=authorizationControlGroup, linkLossLinked=linkLossLinked, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptpTraps=ptpTraps, regulatoryBandTrap=regulatoryBandTrap, dNSServerTableIndex=dNSServerTableIndex, sFPErrorTrap=sFPErrorTrap, mABState=mABState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryption=encryption, encryptionAlgorithm=encryptionAlgorithm, sNTPState=sNTPState, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, remoteMACAddressLinked=remoteMACAddressLinked, extendedSpectrumScanning=extendedSpectrumScanning, licenseHCMPSupport=licenseHCMPSupport, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syncEEquipmentClock=syncEEquipmentClock, blacklistRMMacAddress=blacklistRMMacAddress, transmitChannel=transmitChannel, ptpCompliance=ptpCompliance, sNMPTrapTableEntry=sNMPTrapTableEntry, linkSymmetry=linkSymmetry, sntp=sntp, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, targetMACAddress=targetMACAddress, routerProtocolsGroup=routerProtocolsGroup, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, linkModeOptimization=linkModeOptimization, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, deviceESN=deviceESN, sNTPServerStatus=sNTPServerStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseSFPPortSupport=licenseSFPPortSupport, ptmp=ptmp, licenseIEEE1588Support=licenseIEEE1588Support, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, aAAControlGroup=aAAControlGroup, wirelessLinkAvailability=wirelessLinkAvailability, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, remoteInternetAddressType=remoteInternetAddressType, notificationsGroup=notificationsGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, pubInstancedStatsTable=pubInstancedStatsTable, unitIdentificationGroup=unitIdentificationGroup, configurationInstancedTableNumber=configurationInstancedTableNumber, tDDControlGroup=tDDControlGroup, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, syslogState=syslogState, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNMPPortNumber=sNMPPortNumber, maximumNumberOfSlaves=maximumNumberOfSlaves, sFPPortSyncERxStatus=sFPPortSyncERxStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, authorizationControl=authorizationControl, ethernetInstancedTable=ethernetInstancedTable, tFTPClient=tFTPClient, auxPortSSMTx=auxPortSSMTx, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, hTTPPortNumber=hTTPPortNumber, ethernetGroup=ethernetGroup, sNTPSyncTrap=sNTPSyncTrap, transmitFreqMHz=transmitFreqMHz, receivePower=receivePower, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, snmpControl=snmpControl, portAllocationMismatchLinked=portAllocationMismatchLinked, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, PYSNMP_MODULE_ID=cambium, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, auxPortAcceptedQLRx=auxPortAcceptedQLRx, snmpControlGroup=snmpControlGroup, userRole=userRole, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, configurationGroup=configurationGroup, license=license, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, telnetPortNumber=telnetPortNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, cableDiagnosticsControl=cableDiagnosticsControl, rxColorCode=rxColorCode, sFPPortStatus=sFPPortStatus, tDMChannelStatusTrap=tDMChannelStatusTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortStatus=auxPortStatus, blacklistRMEnabled=blacklistRMEnabled, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mainPSUPortAutoMdix=mainPSUPortAutoMdix, tDMChannelLineCode=tDMChannelLineCode, mgmtInstancedTableIndex=mgmtInstancedTableIndex, auxPortStatusTrap=auxPortStatusTrap, encryptionGroup=encryptionGroup, deviceMSN=deviceMSN, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, syncETracking=syncETracking, sNMPv3Enable=sNMPv3Enable, transmitPower=transmitPower, cableDiagPair3Distance=cableDiagPair3Distance, tdmTableIndex=tdmTableIndex, longitude=longitude, unitName=unitName, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, phyControlInstancedTable=phyControlInstancedTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, unavailableSeconds=unavailableSeconds, syslogClient=syslogClient, tdmTable=tdmTable, enableTransmission=enableTransmission, softwareVersion=softwareVersion, sNTPServerTimeout=sNTPServerTimeout, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetInstancedTableEntry=ethernetInstancedTableEntry, licenseInstancedTableIndex=licenseInstancedTableIndex, altitude=altitude, dataBridgingStatusLinked=dataBridgingStatusLinked, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sFPPortSSMTx=sFPPortSSMTx, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, auxPortQLRx=auxPortQLRx, userPassword=userPassword, cableDiagPair3Results=cableDiagPair3Results, productName=productName, installStatusTrap=installStatusTrap, mABHoldoffPeriod=mABHoldoffPeriod, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, dNSServerInternetAddressType=dNSServerInternetAddressType, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetPriorityTableIndex=ethernetPriorityTableIndex, localPacketFiltering=localPacketFiltering)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dNSGroup=dNSGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, lowestDataModulationMode=lowestDataModulationMode, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sNMPCommunityString=sNMPCommunityString, licenseGroup=licenseGroup, routerProtocols=routerProtocols, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, aggregateDataRateLinked=aggregateDataRateLinked, mainPSUPortStatusTrap=mainPSUPortStatusTrap, aAAControl=aAAControl, receiveModulationModeLinked=receiveModulationModeLinked, tDM=tDM, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, licenseTDDSyncSupport=licenseTDDSyncSupport, phyControlInstancedTableIndex=phyControlInstancedTableIndex, dfsTable=dfsTable, tDDSynchronizationMode=tDDSynchronizationMode, qOSPriorityScheme=qOSPriorityScheme, transmitFreqKHz=transmitFreqKHz, alarmInstancedTableIndex=alarmInstancedTableIndex, receiveDataRateLinked=receiveDataRateLinked, packetsFromInternalStack=packetsFromInternalStack, installStatus=installStatus, sFPPortQLTx=sFPPortQLTx, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, latitude=latitude, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, mgmtInstancedTableNumber=mgmtInstancedTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataBridgingAvailability=dataBridgingAvailability, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, vectorErrorLinked=vectorErrorLinked, auxPortDisabledWarning=auxPortDisabledWarning, licenseOOBManagementSupport=licenseOOBManagementSupport, byteErrorRatio=byteErrorRatio, wirelessOutAllOctets=wirelessOutAllOctets, capacityVariantMismatchTrap=capacityVariantMismatchTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, gatewayIPAddress=gatewayIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, cableDiagnosticsWarning=cableDiagnosticsWarning, incompatibleRegulatoryBands=incompatibleRegulatoryBands, authorizationControlTableIndex=authorizationControlTableIndex, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPAccessEnabled=hTTPAccessEnabled, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPv4Address=iPv4Address, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, alarmsGroup=alarmsGroup, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installStatusLinked=installStatusLinked, dfsTableEntry=dfsTableEntry)
