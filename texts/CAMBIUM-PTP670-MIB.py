...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNMPPortNumber=sNMPPortNumber, management=management, authorizationMethod=authorizationMethod, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortStatusTrap=auxPortStatusTrap, aAAControl=aAAControl, mainPSUPortSSMTx=mainPSUPortSSMTx, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, iPv6Address=iPv6Address, supplementary=supplementary, qOSPriorityScheme=qOSPriorityScheme, receiveModulationModeDetail=receiveModulationModeDetail, userRole=userRole, sFPPortSSMTx=sFPPortSSMTx, licenseIssueNumber=licenseIssueNumber, versionsGroup=versionsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseBandwidthCap=licenseBandwidthCap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, pubInstancedStatsTable=pubInstancedStatsTable, rangeLinked=rangeLinked, tDMChannelStatusTrap=tDMChannelStatusTrap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, syslogControlGroup=syslogControlGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, telnetPortNumber=telnetPortNumber, licenseInstancedTable=licenseInstancedTable, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sFPPortAutoMdix=sFPPortAutoMdix, phyStatusGroup=phyStatusGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dNSServerTable=dNSServerTable, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetInstancedTable=ethernetInstancedTable, timeZone=timeZone, ethernet=ethernet, phyInstancedStatusTable=phyInstancedStatusTable, supplementaryGroup=supplementaryGroup, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, maximumTransmitPower=maximumTransmitPower, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, gatewayIPAddress=gatewayIPAddress, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, receiveFreqMHz=receiveFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, dataBridgingStatusLinked=dataBridgingStatusLinked, transmitChannel=transmitChannel, iPv6GatewayAddress=iPv6GatewayAddress, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, remoteUnitNameLinked=remoteUnitNameLinked, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseGroupAccess=licenseGroupAccess, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, whitelistRMMacAddress=whitelistRMMacAddress, channelChangeTrap=channelChangeTrap, dNSGroup=dNSGroup, targetMACAddress=targetMACAddress, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPServerTable=sNTPServerTable, portAllocationMismatchLinked=portAllocationMismatchLinked, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, encryptionGroup=encryptionGroup, versions=versions, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseInstancedTableNumber=licenseInstancedTableNumber, userTableEntry=userTableEntry, sNMPTrapVersion=sNMPTrapVersion, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, cableDiagnosticsPorts=cableDiagnosticsPorts, longitude=longitude, linkSymmetry=linkSymmetry, wirelessLinkStatusLinked=wirelessLinkStatusLinked, dNSResolver=dNSResolver, hTTPSPortNumber=hTTPSPortNumber, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, snmpControlGroup=snmpControlGroup, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, cableDiagnostics=cableDiagnostics, productName=productName, sNTPServerTableIndex=sNTPServerTableIndex, masterSlaveMode=masterSlaveMode, hCMPMaximumLinkRange=hCMPMaximumLinkRange, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveModulationModeLinked=receiveModulationModeLinked, tDMChannelLoopback=tDMChannelLoopback, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dNSServerPortNumber=dNSServerPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, ethernetPriorityTable=ethernetPriorityTable, tDMInterfaceControl=tDMInterfaceControl, deviceMSN=deviceMSN, tFTPServerInternetAddress=tFTPServerInternetAddress, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, dNSServerTableNumber=dNSServerTableNumber, tDMEnabledChannels=tDMEnabledChannels, remoteInternetAddressType=remoteInternetAddressType, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNTPServerPortNumber=sNTPServerPortNumber, ethernetInstancedTableIndex=ethernetInstancedTableIndex, ptp=ptp, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, authorizationControlGroup=authorizationControlGroup, dNS=dNS, licenseTDDSyncSupport=licenseTDDSyncSupport, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseCapacity=licenseCapacity, phyControlInstancedTableIndex=phyControlInstancedTableIndex, resetGroup=resetGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, installArmState=installArmState, receiveFreqKHz=receiveFreqKHz, nIDULanPortStatus=nIDULanPortStatus, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, wirelessOutEthernetOctets=wirelessOutEthernetOctets, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, vectorError=vectorError, sFPPortDisabledWarning=sFPPortDisabledWarning, configuration=configuration, capacityVariantMismatch=capacityVariantMismatch, alarmInstancedTableEntry=alarmInstancedTableEntry, tdmTableIndex=tdmTableIndex, softwareVersion=softwareVersion, mainPSUPortStatus=mainPSUPortStatus, bridge=bridge, whitelistRMEnabled=whitelistRMEnabled, unavailableSeconds=unavailableSeconds, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, dataBridgingStatus=dataBridgingStatus, sNTPPollInterval=sNTPPollInterval, secureModeAlarm=secureModeAlarm, routerProtocols=routerProtocols, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, vLANManagementPriority=vLANManagementPriority, configurationInstancedTableNumber=configurationInstancedTableNumber, syslogClientTrap=syslogClientTrap, iPv6PrefixLength=iPv6PrefixLength, mainPSUPortQLRx=mainPSUPortQLRx, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, hardwareVersion=hardwareVersion, configurationInstancedTableEntry=configurationInstancedTableEntry, dNSServerTableIndex=dNSServerTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, tFTPClient=tFTPClient, licenseTrialPeriod=licenseTrialPeriod, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNMPEnabledTraps=sNMPEnabledTraps, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, routerProtocolsGroup=routerProtocolsGroup, syncETracking=syncETracking, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteMACAddress=remoteMACAddress, sNMPCommunityString=sNMPCommunityString, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, licenseEncryption=licenseEncryption, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sntpGroup=sntpGroup, mgmtInstancedTable=mgmtInstancedTable, authorizationControlTable=authorizationControlTable, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, linkLoss=linkLoss, licenseIEEE1588Support=licenseIEEE1588Support, dfsTableNumber=dfsTableNumber, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseSecurityLevel=licenseSecurityLevel, installStatus=installStatus, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, wirelessOutOctets=wirelessOutOctets, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, blacklistRMMacAddress=blacklistRMMacAddress, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, deviceMACAddress=deviceMACAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sFPPortAllocation=sFPPortAllocation, aggregateDataRateLinked=aggregateDataRateLinked, remoteMACAddressLinked=remoteMACAddressLinked, dfsTableEntry=dfsTableEntry, installationMode=installationMode, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, managementGroup=managementGroup, deviceESN=deviceESN, wirelessTopology=wirelessTopology, alarms=alarms, cableDiagPair1Distance=cableDiagPair1Distance, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortSSMTx=auxPortSSMTx, sFPPortStatus=sFPPortStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, productVariant=productVariant, wirelessLinkAvailability=wirelessLinkAvailability, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, packetsToInternalStack=packetsToInternalStack, transparentClockVLAN=transparentClockVLAN, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, byteErrorRatioLinked=byteErrorRatioLinked, channelBandwidth=channelBandwidth, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableNumber=sNMPTrapTableNumber, dNSServerTableEntry=dNSServerTableEntry, licenseCountry=licenseCountry, notificationsGroup=notificationsGroup, sNTPServerStatus=sNTPServerStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseMaxLinkRange=licenseMaxLinkRange, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyControl=phyControl, byteErrorRatio=byteErrorRatio, installArmStateTrap=installArmStateTrap, smtpGroup=smtpGroup, transparentClockVID=transparentClockVID, userEnabled=userEnabled, useVLANForMABProtocol=useVLANForMABProtocol, linkLossLinked=linkLossLinked, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, transmitDataRate=transmitDataRate, tDMChannelLineCode=tDMChannelLineCode, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, encryption=encryption)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", incompatibleRegulatoryBands=incompatibleRegulatoryBands, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, tDDControl=tDDControl, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mABProtocolVLANPriority=mABProtocolVLANPriority, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tDMInterfaceStatus=tDMInterfaceStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, mABMaintenanceLevel=mABMaintenanceLevel, licenseRARSupport=licenseRARSupport, PYSNMP_MODULE_ID=cambium, auxPortQLTx=auxPortQLTx, phyControlInstancedTableNumber=phyControlInstancedTableNumber, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, lbtDetectedTrap=lbtDetectedTrap, transmitDataRateLinked=transmitDataRateLinked, userTableIndex=userTableIndex, tDMChannelStatus=tDMChannelStatus, userPassword=userPassword, receivePowerLinked=receivePowerLinked, mainPSUPortAutoMdix=mainPSUPortAutoMdix, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, ptpTraps=ptpTraps, dSCPManagementPriority=dSCPManagementPriority, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, snmpControl=snmpControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerTimeout=sNTPServerTimeout, bridgeGroup=bridgeGroup, ptpCompliance=ptpCompliance, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, mgmtInstancedTableEntry=mgmtInstancedTableEntry, licenseTLSRekey=licenseTLSRekey, auxPortAcceptedQLRx=auxPortAcceptedQLRx, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, severelyErroredSeconds=severelyErroredSeconds, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDMChannelCableLength=tDMChannelCableLength, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, blacklistRMEnabled=blacklistRMEnabled, mPLSTCPriorityTable=mPLSTCPriorityTable, auxPortAllocation=auxPortAllocation, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, transmitPower=transmitPower, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, hTTPPortNumber=hTTPPortNumber, sFPPortStatusTrap=sFPPortStatusTrap, vLANManagementVID=vLANManagementVID, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, capacityVariantMismatchLinked=capacityVariantMismatchLinked, altitude=altitude, regulatoryBand=regulatoryBand, hTTPAccessEnabled=hTTPAccessEnabled, licenseHCMPSupport=licenseHCMPSupport, authorizationControlTableIndex=authorizationControlTableIndex, daylightSaving=daylightSaving, receiveModulationMode=receiveModulationMode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPv3Enable=sNMPv3Enable, aggregateDataRate=aggregateDataRate, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, telnetAccessEnabled=telnetAccessEnabled, unitName=unitName, receiveDataRate=receiveDataRate, licenseVersion=licenseVersion, secondarySoftwareVersion=secondarySoftwareVersion, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, subbandLowestFrequency=subbandLowestFrequency, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sntp=sntp, licenseUnitSerialNumber=licenseUnitSerialNumber, mainPSUPortAllocation=mainPSUPortAllocation, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, cableDiagnosticsControl=cableDiagnosticsControl, dfsTable=dfsTable, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tDM=tDM, tdmTableEntry=tdmTableEntry, rangingMode=rangingMode, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, cableDiagPair1Results=cableDiagPair1Results, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tDDControlGroup=tDDControlGroup, encryptionAlgorithm=encryptionAlgorithm, secureModeAlarmTrap=secureModeAlarmTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, syncEEquipmentClock=syncEEquipmentClock, sNTPServerRetries=sNTPServerRetries, phyControlInstancedTableEntry=phyControlInstancedTableEntry, transmitterChannels=transmitterChannels, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mABHoldoffPeriod=mABHoldoffPeriod, alarmInstancedTableNumber=alarmInstancedTableNumber, syslogState=syslogState, tdmTable=tdmTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mABProtocolVID=mABProtocolVID, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationAlarm=tDDSynchronizationAlarm, l2CPPriorityTable=l2CPPriorityTable, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, alarmInstancedTable=alarmInstancedTable, tdmTableNumber=tdmTableNumber, syslogClient=syslogClient, rxColorCode=rxColorCode, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mABNominalModulationMode=mABNominalModulationMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, sFPPortQLTx=sFPPortQLTx, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mgmtInstancedTableIndex=mgmtInstancedTableIndex, portAllocationMismatch=portAllocationMismatch, signalStrengthRatio=signalStrengthRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, dNSPrimaryServer=dNSPrimaryServer, cableDiagPair4Distance=cableDiagPair4Distance, lowestTDMModulationMode=lowestTDMModulationMode, mABTransmissionInterval=mABTransmissionInterval, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, pubStatsGroup=pubStatsGroup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, frequencyVariant=frequencyVariant, enableTransmission=enableTransmission, auxPortQLRx=auxPortQLRx, erroredSeconds=erroredSeconds, txColorCode=txColorCode, cambium=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, portAllocationMismatchTrap=portAllocationMismatchTrap, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, dfsGroup=dfsGroup, sFPErrorTrap=sFPErrorTrap, accessMethod=accessMethod, unitIdentificationGroup=unitIdentificationGroup, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, hTTPSAccessEnabled=hTTPSAccessEnabled, groupID=groupID, userTable=userTable, sNTPPrimaryServer=sNTPPrimaryServer, unitIdentification=unitIdentification, rawReceivePower=rawReceivePower, systemClock=systemClock, license=license, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configurationInstancedTable=configurationInstancedTable, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, transmitFreqKHz=transmitFreqKHz, iPv4Address=iPv4Address, txMABFrames=txMABFrames, installStatusTrap=installStatusTrap, ptmp=ptmp, packetsFromInternalStack=packetsFromInternalStack, ethernetPriorityTableNumber=ethernetPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, cableLoss=cableLoss, phyControlGroup=phyControlGroup, dataPortPauseFrames=dataPortPauseFrames, tDMConfigurationMismatch=tDMConfigurationMismatch, sNTPLastSync=sNTPLastSync, dataBridgingStatusAlarm=dataBridgingStatusAlarm, syslogStateTrap=syslogStateTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, apcGroup=apcGroup, sNMPTrapTable=sNMPTrapTable, latitude=latitude, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, dfsTableIndex=dfsTableIndex, localPacketFiltering=localPacketFiltering, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyControlInstancedTable=phyControlInstancedTable, linkName=linkName, userTableNumber=userTableNumber, auxPortSyncERxStatus=auxPortSyncERxStatus, userName=userName, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, auxPortStatus=auxPortStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transparentClockPort=transparentClockPort, reset=reset, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sFPPortSyncERxStatus=sFPPortSyncERxStatus, apc=apc, targetRange=targetRange, licenseGroup=licenseGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receivePower=receivePower, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, iPVersion=iPVersion, licenseInstancedTableIndex=licenseInstancedTableIndex, dfs=dfs, vectorErrorLinked=vectorErrorLinked, receiveChannel=receiveChannel, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, cableDiagPair2Distance=cableDiagPair2Distance, subnetMask=subnetMask, syslogControl=syslogControl, transparentClock=transparentClock, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNTPSync=sNTPSync, tDMGroup=tDMGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, nIDULanPortAutoMdix=nIDULanPortAutoMdix, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receiveDataRateLinked=receiveDataRateLinked, regulatoryBandTrap=regulatoryBandTrap, tempPcb=tempPcb, extendedSpectrumScanning=extendedSpectrumScanning, configurationInstancedTableIndex=configurationInstancedTableIndex, aAAControlGroup=aAAControlGroup, dNSServerInternetAddress=dNSServerInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, authorizationControlTableEntry=authorizationControlTableEntry, searchState=searchState, linkModeOptimization=linkModeOptimization, unitOutOfCalibration=unitOutOfCalibration, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, tDDSynchronizationMode=tDDSynchronizationMode, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseSyncESupport=licenseSyncESupport, sMTPServerPortNumber=sMTPServerPortNumber, smtp=smtp, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, maxLinkRangeExceeded=maxLinkRangeExceeded, cableDiagnosticsWarning=cableDiagnosticsWarning, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, remoteUnitName=remoteUnitName, tFTPServerPortNumber=tFTPServerPortNumber, transmitModulationMode=transmitModulationMode, ptpTrapPrefix=ptpTrapPrefix, range=range, bootVersion=bootVersion, lowestDataModulationMode=lowestDataModulationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", searchStateLinked=searchStateLinked, siteName=siteName, wirelessOutAllOctets=wirelessOutAllOctets, mgmtInstancedTableNumber=mgmtInstancedTableNumber, remoteInternetAddressLinked=remoteInternetAddressLinked, transmitPowerLinked=transmitPowerLinked, rawReceivePowerLinked=rawReceivePowerLinked, systemReset=systemReset, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, alarmsGroup=alarmsGroup, cableDiagPair2Results=cableDiagPair2Results, authorizationControl=authorizationControl, remoteInternetAddress=remoteInternetAddress, phyStatus=phyStatus, alarmInstancedTableIndex=alarmInstancedTableIndex, licenseInstancedTableEntry=licenseInstancedTableEntry, syncESlavePort=syncESlavePort, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sFPError=sFPError, dfsMeans=dfsMeans, transmitModulationModeLinked=transmitModulationModeLinked, sNTPServerTableEntry=sNTPServerTableEntry, dataBridgingAvailability=dataBridgingAvailability, sNTPState=sNTPState, ethernetStatisticsTable=ethernetStatisticsTable, installStatusLinked=installStatusLinked, managementNetworkAccessEnabled=managementNetworkAccessEnabled, ptpGroups=ptpGroups, configurationGroup=configurationGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, syncETrackingState=syncETrackingState, hCMPLinkSymmetry=hCMPLinkSymmetry, antennaSelection=antennaSelection, ptp670=ptp670, antennaGain=antennaGain, licenseIPv6Support=licenseIPv6Support, cableDiagPair3Distance=cableDiagPair3Distance, subbandHighestFrequency=subbandHighestFrequency, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, sFPPortQLRx=sFPPortQLRx, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, dNSServerInternetAddressType=dNSServerInternetAddressType, auxPortDisabledWarning=auxPortDisabledWarning, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, ethernetGroup=ethernetGroup, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseSFPPortSupport=licenseSFPPortSupport, cableDiagPair4Results=cableDiagPair4Results, cableDiagPair3Results=cableDiagPair3Results, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, authorizationControlTableNumber=authorizationControlTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, eIRP=eIRP, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseGasGroup=licenseGasGroup, mABState=mABState, dfsPeaks=dfsPeaks, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade)
