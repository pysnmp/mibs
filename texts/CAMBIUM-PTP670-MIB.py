...
TimeTicks, NotificationType, ObjectIdentity, ModuleIdentity, Counter64, Bits, Unsigned32, IpAddress, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Counter64", "Bits", "Unsigned32", "IpAddress", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "enterprises", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPState=sNTPState, pubStatsGroup=pubStatsGroup, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tDMChannelLoopback=tDMChannelLoopback, dNSServerInternetAddressType=dNSServerInternetAddressType, transmitDataRateLinked=transmitDataRateLinked, tdmTableEntry=tdmTableEntry, sFPPortAllocation=sFPPortAllocation, authorizationControlTableEntry=authorizationControlTableEntry, bridgeGroup=bridgeGroup, transparentClockVID=transparentClockVID, phyInstancedStatusTable=phyInstancedStatusTable, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, cableDiagPair1Results=cableDiagPair1Results, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, dNS=dNS, secureModeAlarm=secureModeAlarm, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, iPv4Address=iPv4Address, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, configuration=configuration, licenseRegulatoryBandsList=licenseRegulatoryBandsList, groupID=groupID, cableDiagPair2Distance=cableDiagPair2Distance, siteName=siteName, timeZone=timeZone, antennaSelection=antennaSelection, supplementaryGroup=supplementaryGroup, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, receivePowerLinked=receivePowerLinked, sFPError=sFPError, sMTPServerPortNumber=sMTPServerPortNumber, dfsTable=dfsTable, byteErrorRatioLinked=byteErrorRatioLinked, sNMPTrapVersion=sNMPTrapVersion, regulatoryBandTrap=regulatoryBandTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, regulatoryBand=regulatoryBand, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userTableIndex=userTableIndex, installArmState=installArmState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, dNSPrimaryServer=dNSPrimaryServer, secureModeAlarmTrap=secureModeAlarmTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, tdmTableIndex=tdmTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, mgmtInstancedTable=mgmtInstancedTable, accessMethod=accessMethod, transmitterChannels=transmitterChannels, wirelessLinkStatus=wirelessLinkStatus, tDMInterfaceControl=tDMInterfaceControl, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, softwareVersion=softwareVersion, dSCPManagementPriority=dSCPManagementPriority, enableTransmission=enableTransmission, unitName=unitName, dataBridgingAvailability=dataBridgingAvailability, maximumTransmitPower=maximumTransmitPower, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseOOBManagementSupport=licenseOOBManagementSupport, erroredSeconds=erroredSeconds, phyControlInstancedTable=phyControlInstancedTable, dfs=dfs, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, dfsTableEntry=dfsTableEntry, auxPortDisabledWarning=auxPortDisabledWarning, ethernetInstancedTable=ethernetInstancedTable, secondarySoftwareVersion=secondarySoftwareVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, maximumNumberOfSlaves=maximumNumberOfSlaves, hCMPLinkSymmetry=hCMPLinkSymmetry, latitude=latitude, userTableNumber=userTableNumber, snmpControl=snmpControl, alarmsGroup=alarmsGroup, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, wirelessLinkAvailability=wirelessLinkAvailability, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseSyncESupport=licenseSyncESupport, linkLossLinked=linkLossLinked, tDMInterfaceStatus=tDMInterfaceStatus, unavailableSeconds=unavailableSeconds, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sFPPortQLTx=sFPPortQLTx, auxPortStatusTrap=auxPortStatusTrap, transparentClockPort=transparentClockPort, installArmStateTrap=installArmStateTrap, authorizationControl=authorizationControl, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mainPSUPortQLRx=mainPSUPortQLRx, linkSymmetry=linkSymmetry, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, hardwareVersion=hardwareVersion, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, sntpGroup=sntpGroup, dataPortPauseFrames=dataPortPauseFrames, installationMode=installationMode, receiveDataRateLinked=receiveDataRateLinked, cableDiagPair4Distance=cableDiagPair4Distance, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, ethernetPriorityTable=ethernetPriorityTable, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, pubStats=pubStats, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dNSServerTableIndex=dNSServerTableIndex, dNSGroup=dNSGroup, systemClock=systemClock, authorizationControlGroup=authorizationControlGroup, smtp=smtp, ethernet=ethernet, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, tempPcb=tempPcb, unitIdentificationGroup=unitIdentificationGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sFPPortDisabledWarning=sFPPortDisabledWarning, sNTPLastSync=sNTPLastSync, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseCountry=licenseCountry, sNTPSyncTrap=sNTPSyncTrap, receiveFreqMHz=receiveFreqMHz, ptp=ptp, mainPSUPortStatus=mainPSUPortStatus, authorizationMethod=authorizationMethod, dataBridgingStatus=dataBridgingStatus, licenseGroupAccess=licenseGroupAccess, ptpGroups=ptpGroups, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, aggregateDataRateLinked=aggregateDataRateLinked, transmitChannel=transmitChannel, tDMChannelStatusTrap=tDMChannelStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, installStatusLinked=installStatusLinked, transmitFreqKHz=transmitFreqKHz, dNSServerTableEntry=dNSServerTableEntry, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, capacityVariantMismatch=capacityVariantMismatch, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mABNominalModulationMode=mABNominalModulationMode, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, licenseUnitSerialNumber=licenseUnitSerialNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, deviceESN=deviceESN, receivePower=receivePower, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, syncETracking=syncETracking, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, syslogState=syslogState, cableDiagPair3Results=cableDiagPair3Results, userName=userName, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, sFPPortAutoMdix=sFPPortAutoMdix, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remoteInternetAddressLinked=remoteInternetAddressLinked, productName=productName, licenseTLSRekey=licenseTLSRekey, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, routerProtocols=routerProtocols, syslogClientTrap=syslogClientTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, daylightSaving=daylightSaving, auxPortStatus=auxPortStatus, longitude=longitude, sNMPPortNumber=sNMPPortNumber, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sNMPv3Enable=sNMPv3Enable, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, subbandLowestFrequency=subbandLowestFrequency, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseGroup=licenseGroup, sNTPServerRetries=sNTPServerRetries, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, tDMChannelStatus=tDMChannelStatus, cableDiagPair3Distance=cableDiagPair3Distance, mainPSUPortStatusTrap=mainPSUPortStatusTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, linkName=linkName, iPDSCPPriorityTable=iPDSCPPriorityTable, frequencyVariant=frequencyVariant, severelyErroredSeconds=severelyErroredSeconds, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transparentClockVLAN=transparentClockVLAN, syncESlavePort=syncESlavePort, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseRARSupport=licenseRARSupport, remoteUnitName=remoteUnitName, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, oOBPriorityQueueMapping=oOBPriorityQueueMapping, routerProtocolsGroup=routerProtocolsGroup, eIRP=eIRP, sNMPCommunityString=sNMPCommunityString, subbandHighestFrequency=subbandHighestFrequency, authorizationControlTable=authorizationControlTable, auxPortSSMTx=auxPortSSMTx, wirelessOutAllOctets=wirelessOutAllOctets, signalStrengthRatioLinked=signalStrengthRatioLinked, mainPSUPortSSMTx=mainPSUPortSSMTx, txMABFrames=txMABFrames, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, userTableEntry=userTableEntry, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseHCMPSupport=licenseHCMPSupport, alarmInstancedTableNumber=alarmInstancedTableNumber, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, alarmInstancedTableIndex=alarmInstancedTableIndex, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, encryption=encryption, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syncETrackingState=syncETrackingState, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseInstancedTable=licenseInstancedTable, ptpCompliance=ptpCompliance, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, signalStrengthRatio=signalStrengthRatio, searchState=searchState, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, whitelistRMMacAddress=whitelistRMMacAddress, sNTPPollInterval=sNTPPollInterval, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenseSecurityLevel=licenseSecurityLevel, iPv6GatewayAddress=iPv6GatewayAddress, syslogClient=syslogClient, apc=apc, auxPortQLRx=auxPortQLRx, lowestTDMModulationMode=lowestTDMModulationMode, userEnabled=userEnabled, cableDiagPair4Results=cableDiagPair4Results, ptp670=ptp670, portAllocationMismatch=portAllocationMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseTDDSyncSupport=licenseTDDSyncSupport, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, PYSNMP_MODULE_ID=cambium, hCMPMaximumLinkRange=hCMPMaximumLinkRange, lbtDetectedTrap=lbtDetectedTrap, sMTPEnabledMessages=sMTPEnabledMessages, unitIdentification=unitIdentification, snmpControlGroup=snmpControlGroup, sNTPServerStatus=sNTPServerStatus, userPassword=userPassword, dfsTableIndex=dfsTableIndex, installStatus=installStatus, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, deviceMSN=deviceMSN, vLANManagementPriority=vLANManagementPriority, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sntp=sntp, ptpTrapPrefix=ptpTrapPrefix, receiveModulationModeLinked=receiveModulationModeLinked, noWirelessChannelAvailable=noWirelessChannelAvailable, bridge=bridge, sFPPortQLRx=sFPPortQLRx, dfsMeans=dfsMeans, vectorErrorLinked=vectorErrorLinked, licenseSFPPortSupport=licenseSFPPortSupport, sNMPTrapTableNumber=sNMPTrapTableNumber, subnetMask=subnetMask, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, auxPortQLTx=auxPortQLTx, rxColorCode=rxColorCode, configurationInstancedTableNumber=configurationInstancedTableNumber, syslogControl=syslogControl, mainPSUPortQLTx=mainPSUPortQLTx, iPVersion=iPVersion, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, dNSServerPortNumber=dNSServerPortNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNMPTrapTableEntry=sNMPTrapTableEntry, configurationInstancedTableEntry=configurationInstancedTableEntry, smtpGroup=smtpGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mPLSTCPriorityTable=mPLSTCPriorityTable, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, receiveModulationMode=receiveModulationMode, useVLANForMABProtocol=useVLANForMABProtocol, licenseBandwidthCap=licenseBandwidthCap, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseVersion=licenseVersion, remoteUnitNameLinked=remoteUnitNameLinked, targetRange=targetRange, alarmInstancedTableEntry=alarmInstancedTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mABTransmissionInterval=mABTransmissionInterval, cableDiagnosticsControl=cableDiagnosticsControl, sMTPServerInternetAddressType=sMTPServerInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, targetMACAddress=targetMACAddress, dfsTableNumber=dfsTableNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, blacklistRMMacAddress=blacklistRMMacAddress, management=management, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, hTTPAccessEnabled=hTTPAccessEnabled, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, transmitDataRate=transmitDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, configurationInstancedTableIndex=configurationInstancedTableIndex, dNSServerTable=dNSServerTable, cableDiagPair2Results=cableDiagPair2Results, whitelistRMEnabled=whitelistRMEnabled, linkModeOptimization=linkModeOptimization, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, pubInstancedStatsTable=pubInstancedStatsTable, cambium=cambium, reset=reset, channelChangeTrap=channelChangeTrap, ptpTraps=ptpTraps, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, receiveModulationModeDetail=receiveModulationModeDetail, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, licenseInstancedTableEntry=licenseInstancedTableEntry, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mABMaintenanceLevel=mABMaintenanceLevel, l2CPPriorityTable=l2CPPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, licenseTrialPeriod=licenseTrialPeriod, auxPortAcceptedQLRx=auxPortAcceptedQLRx, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sFPPortSSMTx=sFPPortSSMTx, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitPower=transmitPower, licenseEncryption=licenseEncryption, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, licenseCapacity=licenseCapacity, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, configurationGroup=configurationGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, tdmTable=tdmTable, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, license=license, vectorError=vectorError, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, linkLoss=linkLoss, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, mABProtocolVLANPriority=mABProtocolVLANPriority, configurationInstancedTable=configurationInstancedTable, aggregateDataRate=aggregateDataRate, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, resetGroup=resetGroup, mABState=mABState, managementGroup=managementGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseInstancedTableNumber=licenseInstancedTableNumber, dfsPeaks=dfsPeaks, sNTPServerTable=sNTPServerTable, versionsGroup=versionsGroup, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, rawReceivePower=rawReceivePower, transparentClock=transparentClock, masterSlaveMode=masterSlaveMode, hTTPPortNumber=hTTPPortNumber, phyControlGroup=phyControlGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tDMGroup=tDMGroup, localPacketFiltering=localPacketFiltering, tDMChannelLineCode=tDMChannelLineCode, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, tDMConfigurationMismatch=tDMConfigurationMismatch, phyControlInstancedTableIndex=phyControlInstancedTableIndex, extendedSpectrumScanning=extendedSpectrumScanning, transmitModulationMode=transmitModulationMode, phyControl=phyControl, ethernetGroup=ethernetGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetStatisticsTable=ethernetStatisticsTable, remoteMACAddressLinked=remoteMACAddressLinked, licenseIssueNumber=licenseIssueNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, remoteInternetAddressType=remoteInternetAddressType, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tDMChannelCableLength=tDMChannelCableLength, sNTPServerPortNumber=sNTPServerPortNumber, antennaGain=antennaGain, auxPortAllocation=auxPortAllocation, ptmp=ptmp, cableDiagnosticsGroup=cableDiagnosticsGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, vLANManagementVID=vLANManagementVID, rawReceivePowerLinked=rawReceivePowerLinked, rangingMode=rangingMode, blacklistRMEnabled=blacklistRMEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, apcGroup=apcGroup, licenseIEEE1588Support=licenseIEEE1588Support, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitPowerLinked=transmitPowerLinked, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseMaxLinkRange=licenseMaxLinkRange, receiveFreqKHz=receiveFreqKHz, installStatusTrap=installStatusTrap, alarmInstancedTable=alarmInstancedTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mgmtInstancedTableNumber=mgmtInstancedTableNumber, dfsGroup=dfsGroup, ethernetInstancedTableIndex=ethernetInstancedTableIndex, receiveChannel=receiveChannel, transmitModulationModeLinked=transmitModulationModeLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, iPv6Address=iPv6Address, remoteInternetAddress=remoteInternetAddress, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, txColorCode=txColorCode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sFPPortStatusTrap=sFPPortStatusTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, cableDiagnostics=cableDiagnostics, qOSPriorityScheme=qOSPriorityScheme, unitOutOfCalibration=unitOutOfCalibration, deviceMACAddress=deviceMACAddress, channelBandwidth=channelBandwidth, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, portAllocationMismatchTrap=portAllocationMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, mgmtInstancedTableIndex=mgmtInstancedTableIndex, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, tDMEnabledChannels=tDMEnabledChannels, nIDULanPortStatus=nIDULanPortStatus, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, iPv6PrefixLength=iPv6PrefixLength, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sFPPortStatus=sFPPortStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPSync=sNTPSync, supplementary=supplementary, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, bootVersion=bootVersion, hTTPSPortNumber=hTTPSPortNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, systemReset=systemReset, mainPSUPortAutoMdix=mainPSUPortAutoMdix, remoteMACAddress=remoteMACAddress, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, receiveDataRate=receiveDataRate, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, aAAControlGroup=aAAControlGroup, syslogControlGroup=syslogControlGroup, searchStateLinked=searchStateLinked, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPPrimaryServer=sNTPPrimaryServer, telnetPortNumber=telnetPortNumber, nIDULanPortAutoMdix=nIDULanPortAutoMdix, capacityVariantMismatchLinked=capacityVariantMismatchLinked, encryptionGroup=encryptionGroup, wirelessOutOctets=wirelessOutOctets, mainPSUPortAllocation=mainPSUPortAllocation, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sFPErrorTrap=sFPErrorTrap, sNTPServerTableIndex=sNTPServerTableIndex, wirelessTopology=wirelessTopology, aAAControl=aAAControl, packetsToInternalStack=packetsToInternalStack, tdmTableNumber=tdmTableNumber, maxLinkRangeExceeded=maxLinkRangeExceeded, userRole=userRole, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, range=range, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, syslogStateTrap=syslogStateTrap, syncEEquipmentClock=syncEEquipmentClock)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tFTPClient=tFTPClient, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerTableNumber=sNTPServerTableNumber, byteErrorRatio=byteErrorRatio, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, alarms=alarms, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, notificationsGroup=notificationsGroup, licenseGasGroup=licenseGasGroup, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dNSServerTableNumber=dNSServerTableNumber, tDDControlGroup=tDDControlGroup, wirelessLinkStatusLinked=wirelessLinkStatusLinked, packetsFromInternalStack=packetsFromInternalStack, mgmtInstancedTableEntry=mgmtInstancedTableEntry, lowestDataModulationMode=lowestDataModulationMode, mABProtocolVID=mABProtocolVID, cableLoss=cableLoss, tDDControl=tDDControl, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataBridgingStatusLinked=dataBridgingStatusLinked, authorizationControlTableNumber=authorizationControlTableNumber, licenseIPv6Support=licenseIPv6Support, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, portAllocationMismatchLinked=portAllocationMismatchLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, productVariant=productVariant, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseInstancedTableIndex=licenseInstancedTableIndex, mABHoldoffPeriod=mABHoldoffPeriod, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, ethernetInstancedTableNumber=ethernetInstancedTableNumber, altitude=altitude, rangeLinked=rangeLinked, cableDiagnosticsPorts=cableDiagnosticsPorts, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, authorizationControlTableIndex=authorizationControlTableIndex, versions=versions, telnetAccessEnabled=telnetAccessEnabled, transmitFreqMHz=transmitFreqMHz, ethernetInstancedTableEntry=ethernetInstancedTableEntry, cableDiagnosticsResultTable=cableDiagnosticsResultTable, userTable=userTable, sNTPServerTimeout=sNTPServerTimeout, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, nIDULanPortStatusTrap=nIDULanPortStatusTrap, dNSResolver=dNSResolver, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, auxPortSyncERxStatus=auxPortSyncERxStatus, tDM=tDM, cableDiagPair1Distance=cableDiagPair1Distance, gatewayIPAddress=gatewayIPAddress, dNSServerInternetAddress=dNSServerInternetAddress, phyStatusGroup=phyStatusGroup, phyStatus=phyStatus)
