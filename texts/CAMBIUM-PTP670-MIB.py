...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, syslogControlGroup=syslogControlGroup, phyInstancedStatusTable=phyInstancedStatusTable, transparentClock=transparentClock, auxPortSyncERxStatus=auxPortSyncERxStatus, remoteMACAddress=remoteMACAddress, receiveModulationModeDetail=receiveModulationModeDetail, packetsToInternalStack=packetsToInternalStack, tDMEnabledChannels=tDMEnabledChannels, userTableEntry=userTableEntry, tDM=tDM, auxPortQLTx=auxPortQLTx, licenseOOBManagementSupport=licenseOOBManagementSupport, configurationGroup=configurationGroup, targetMACAddress=targetMACAddress, ptp670=ptp670, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, licenseInstancedTableIndex=licenseInstancedTableIndex, licenseGroup=licenseGroup, mABMaintenanceLevel=mABMaintenanceLevel, vLANManagementVID=vLANManagementVID, authorizationControlGroup=authorizationControlGroup, rawReceivePower=rawReceivePower, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, bootVersion=bootVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, versions=versions, iPv6GatewayAddress=iPv6GatewayAddress, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, dNSResolver=dNSResolver, dNSServerPortNumber=dNSServerPortNumber, dNSServerTableIndex=dNSServerTableIndex, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, cableDiagnostics=cableDiagnostics, range=range, telnetPortNumber=telnetPortNumber, installationMode=installationMode, rangingMode=rangingMode, receivePowerLinked=receivePowerLinked, tDMChannelStatusTrap=tDMChannelStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkLossLinked=linkLossLinked, mainPSUPortQLRx=mainPSUPortQLRx, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, linkName=linkName, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementGroup=managementGroup, ptp=ptp, transmitFreqMHz=transmitFreqMHz, mABProtocolVLANPriority=mABProtocolVLANPriority, mainPSUPortAllocation=mainPSUPortAllocation, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sFPPortStatusTrap=sFPPortStatusTrap, sNTPState=sNTPState, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, installArmState=installArmState, license=license, sFPPortStatus=sFPPortStatus, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, regulatoryBandTrap=regulatoryBandTrap, dNSServerTableNumber=dNSServerTableNumber, qOSPriorityScheme=qOSPriorityScheme, hCMPMaximumLinkRange=hCMPMaximumLinkRange, tempPcb=tempPcb, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, licenseIEEE1588Support=licenseIEEE1588Support, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, remoteUnitName=remoteUnitName, txMABFrames=txMABFrames, deviceMACAddress=deviceMACAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveDataRateLinked=receiveDataRateLinked, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, blacklistRMEnabled=blacklistRMEnabled, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, dataBridgingStatus=dataBridgingStatus, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, syslogClient=syslogClient, mgmtInstancedTableEntry=mgmtInstancedTableEntry, alarmInstancedTable=alarmInstancedTable, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, remoteInternetAddress=remoteInternetAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dSCPManagementPriority=dSCPManagementPriority, cableDiagPair1Distance=cableDiagPair1Distance, dfsTableIndex=dfsTableIndex, ptpTrapPrefix=ptpTrapPrefix, receiveModulationModeLinked=receiveModulationModeLinked, auxPortSSMTx=auxPortSSMTx, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sNTPServerInternetAddress=sNTPServerInternetAddress, encryption=encryption, ethernetPriorityTable=ethernetPriorityTable, dfsGroup=dfsGroup, secureModeAlarm=secureModeAlarm, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, productVariant=productVariant, daylightSaving=daylightSaving, dNSServerInternetAddressType=dNSServerInternetAddressType, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, configurationInstancedTableEntry=configurationInstancedTableEntry, aAAControl=aAAControl, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sFPPortQLRx=sFPPortQLRx, accessMethod=accessMethod, auxPortConfigurationMismatch=auxPortConfigurationMismatch, iPVersion=iPVersion, cableDiagPair4Results=cableDiagPair4Results, mainPSUPortSSMTx=mainPSUPortSSMTx, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tDDControl=tDDControl, receiveDataRate=receiveDataRate, syncEEquipmentClock=syncEEquipmentClock, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, snmpControlGroup=snmpControlGroup, dNSServerTable=dNSServerTable, licenseHCMPSupport=licenseHCMPSupport, installStatusTrap=installStatusTrap, notificationsGroup=notificationsGroup, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, remoteUnitNameLinked=remoteUnitNameLinked, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, tDDControlGroup=tDDControlGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, phyControlInstancedTableIndex=phyControlInstancedTableIndex, installArmStateTrap=installArmStateTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sFPErrorTrap=sFPErrorTrap, cambium=cambium, sNTPLastSync=sNTPLastSync, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sMTPServerInternetAddress=sMTPServerInternetAddress, signalStrengthRatioLinked=signalStrengthRatioLinked, linkLoss=linkLoss, transmitFreqKHz=transmitFreqKHz, receiveModulationMode=receiveModulationMode, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, transmitPowerLinked=transmitPowerLinked, hTTPAccessEnabled=hTTPAccessEnabled, blacklistRMMacAddress=blacklistRMMacAddress, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, timeZone=timeZone, iPDSCPPriorityTable=iPDSCPPriorityTable, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, authorizationControlTable=authorizationControlTable, PYSNMP_MODULE_ID=cambium, portAllocationMismatch=portAllocationMismatch, managementNetworkAccessEnabled=managementNetworkAccessEnabled, snmpControl=snmpControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, lbtDetectedTrap=lbtDetectedTrap, softwareVersion=softwareVersion, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, phyStatus=phyStatus, configurationInstancedTableNumber=configurationInstancedTableNumber, userTableIndex=userTableIndex, lowestTDMModulationMode=lowestTDMModulationMode, latitude=latitude, sNTPServerPortNumber=sNTPServerPortNumber, cableDiagnosticsGroup=cableDiagnosticsGroup, authorizationControl=authorizationControl, phyControl=phyControl, antennaGain=antennaGain, lowestDataModulationMode=lowestDataModulationMode, nIDULanPortStatus=nIDULanPortStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, dataBridgingAvailability=dataBridgingAvailability, transmitChannel=transmitChannel, sNMPTrapTableEntry=sNMPTrapTableEntry, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, byteErrorRatioLinked=byteErrorRatioLinked, cableDiagPair2Distance=cableDiagPair2Distance, licenseCountry=licenseCountry, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, wirelessLinkStatus=wirelessLinkStatus, bridge=bridge, tdmTableNumber=tdmTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mABProtocolVID=mABProtocolVID, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsPeaks=dfsPeaks, syncETrackingState=syncETrackingState, vectorErrorLinked=vectorErrorLinked, ethernetStatisticsDataSource=ethernetStatisticsDataSource, tFTPServerInternetAddressType=tFTPServerInternetAddressType, userTable=userTable, wirelessOutOctets=wirelessOutOctets, dataPortPauseFrames=dataPortPauseFrames, vectorError=vectorError, sFPPortAllocation=sFPPortAllocation, incompatibleRegulatoryBands=incompatibleRegulatoryBands, whitelistRMEnabled=whitelistRMEnabled, sNTPServerTableNumber=sNTPServerTableNumber, ptpTraps=ptpTraps, localPacketFiltering=localPacketFiltering, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, tDDSynchronizationMode=tDDSynchronizationMode, sntp=sntp, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, licenseMaxLinkRange=licenseMaxLinkRange, nIDULanPortStatusTrap=nIDULanPortStatusTrap, userName=userName, syslogStateTrap=syslogStateTrap, licenseBandwidthCap=licenseBandwidthCap, mainPSUPortQLTx=mainPSUPortQLTx, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, versionsGroup=versionsGroup, ptmp=ptmp, alarms=alarms, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, dNSGroup=dNSGroup, pubStats=pubStats, cableDiagnosticsResultTable=cableDiagnosticsResultTable, hCMPLinkSymmetry=hCMPLinkSymmetry, auxPortQLRx=auxPortQLRx, mABTransmissionInterval=mABTransmissionInterval, oOBPriorityQueueMapping=oOBPriorityQueueMapping, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, longitude=longitude, authorizationControlTableNumber=authorizationControlTableNumber, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseTLSRekey=licenseTLSRekey, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, authorizationMethod=authorizationMethod, ethernetInstancedTable=ethernetInstancedTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, mgmtInstancedTableNumber=mgmtInstancedTableNumber, maxLinkRangeExceeded=maxLinkRangeExceeded, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogState=syslogState, transmitterChannels=transmitterChannels, useVLANForMABProtocol=useVLANForMABProtocol, reset=reset, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, syslogClientTrap=syslogClientTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, remoteInternetAddressType=remoteInternetAddressType, aggregateDataRateLinked=aggregateDataRateLinked, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, capacityVariantMismatchTrap=capacityVariantMismatchTrap, smtp=smtp, sNTPPollInterval=sNTPPollInterval, sNTPSyncTrap=sNTPSyncTrap, dfs=dfs, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseEncryption=licenseEncryption, licenseInstancedTableEntry=licenseInstancedTableEntry, tDMChannelCableLength=tDMChannelCableLength, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, sFPPortSSMTx=sFPPortSSMTx, licenseInstancedTable=licenseInstancedTable, tDMChannelLoopback=tDMChannelLoopback, pubInstancedStatsTable=pubInstancedStatsTable, sFPPortSyncERxStatus=sFPPortSyncERxStatus, linkModeOptimization=linkModeOptimization, sNTPServerInternetAddressType=sNTPServerInternetAddressType, phyControlInstancedTableEntry=phyControlInstancedTableEntry, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, phyControlGroup=phyControlGroup, wirelessLinkStatusLinked=wirelessLinkStatusLinked, ptpCompliance=ptpCompliance, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, antennaSelection=antennaSelection, cableDiagnosticsPorts=cableDiagnosticsPorts, phyStatusGroup=phyStatusGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, cableDiagPair3Results=cableDiagPair3Results, deviceMSN=deviceMSN, channelBandwidth=channelBandwidth, configuration=configuration, sNMPPortNumber=sNMPPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rangeLinked=rangeLinked, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, unitIdentificationGroup=unitIdentificationGroup, tDMInterfaceStatus=tDMInterfaceStatus, supplementary=supplementary, searchStateLinked=searchStateLinked, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortStatus=mainPSUPortStatus, licenseRARSupport=licenseRARSupport, dNSServerTableEntry=dNSServerTableEntry, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, secureModeAlarmTrap=secureModeAlarmTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, ethernetInstancedTableNumber=ethernetInstancedTableNumber, syncETracking=syncETracking, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, capacityVariantMismatch=capacityVariantMismatch, licenseSyncESupport=licenseSyncESupport, tdmTableEntry=tdmTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, maximumNumberOfSlaves=maximumNumberOfSlaves, regulatoryBand=regulatoryBand, management=management, userPassword=userPassword, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseSFPPortSupport=licenseSFPPortSupport, tFTPClient=tFTPClient, sntpGroup=sntpGroup, unitName=unitName, aggregateDataRate=aggregateDataRate, dfsTableEntry=dfsTableEntry, resetGroup=resetGroup, tdmTableIndex=tdmTableIndex, tDMChannelStatus=tDMChannelStatus, licenseGroupAccess=licenseGroupAccess, smtpGroup=smtpGroup, encryptionGroup=encryptionGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, installStatus=installStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, deviceESN=deviceESN, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, cableDiagPair2Results=cableDiagPair2Results, licenseVersion=licenseVersion, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseCapacity=licenseCapacity, licenseTrialPeriod=licenseTrialPeriod, groupID=groupID, sNMPv3Enable=sNMPv3Enable, masterSlaveMode=masterSlaveMode, cableDiagnosticsControl=cableDiagnosticsControl, userEnabled=userEnabled, portAllocationMismatchTrap=portAllocationMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibration=unitOutOfCalibration, receiveFreqKHz=receiveFreqKHz, dfsMeans=dfsMeans, subbandHighestFrequency=subbandHighestFrequency, sMTPEmailAlert=sMTPEmailAlert, severelyErroredSeconds=severelyErroredSeconds, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerPortNumber=sMTPServerPortNumber, maximumTransmitPower=maximumTransmitPower, ethernetInstancedTableIndex=ethernetInstancedTableIndex, subnetMask=subnetMask, portAllocationMismatchLinked=portAllocationMismatchLinked, licenseInstancedTableNumber=licenseInstancedTableNumber, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sFPPortDisabledWarning=sFPPortDisabledWarning, linkSymmetry=linkSymmetry, mABState=mABState, sNTPServerStatus=sNTPServerStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, auxPortStatus=auxPortStatus, authorizationControlTableIndex=authorizationControlTableIndex, sFPPortAutoMdix=sFPPortAutoMdix, dNS=dNS, productName=productName, cableDiagPair3Distance=cableDiagPair3Distance, l2CPPriorityTableIndex=l2CPPriorityTableIndex, configurationInstancedTable=configurationInstancedTable, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, systemClock=systemClock, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, mainPSUPortAutoMdix=mainPSUPortAutoMdix, aAAControlGroup=aAAControlGroup, userRole=userRole, phyControlInstancedTableNumber=phyControlInstancedTableNumber, transmitPower=transmitPower, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, enableTransmission=enableTransmission, secondarySoftwareVersion=secondarySoftwareVersion, ethernetInstancedTableEntry=ethernetInstancedTableEntry, unavailableSeconds=unavailableSeconds, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, subbandLowestFrequency=subbandLowestFrequency, sNTPServerTableIndex=sNTPServerTableIndex, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, wirelessOutAllOctets=wirelessOutAllOctets, apcGroup=apcGroup, hardwareVersion=hardwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerTable=sNTPServerTable, routerProtocolsGroup=routerProtocolsGroup, mgmtInstancedTable=mgmtInstancedTable, vLANManagementPriority=vLANManagementPriority, receiveChannel=receiveChannel, telnetAccessEnabled=telnetAccessEnabled, targetRange=targetRange, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, ethernet=ethernet, transmitModulationModeLinked=transmitModulationModeLinked, transmitModulationMode=transmitModulationMode, txColorCode=txColorCode, auxPortAllocation=auxPortAllocation, unitIdentification=unitIdentification, pubStatsGroup=pubStatsGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, channelChangeTrap=channelChangeTrap, alarmInstancedTableIndex=alarmInstancedTableIndex, byteErrorRatio=byteErrorRatio, mainPSUPortStatusTrap=mainPSUPortStatusTrap, bridgeGroup=bridgeGroup, routerProtocols=routerProtocols, licenseIPv6Support=licenseIPv6Support, packetsFromInternalStack=packetsFromInternalStack, dNSPrimaryServer=dNSPrimaryServer, tDMConfigurationMismatch=tDMConfigurationMismatch, transmitDataRateLinked=transmitDataRateLinked, tdmTable=tdmTable, transparentClockVLAN=transparentClockVLAN, sFPPortQLTx=sFPPortQLTx, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tDMGroup=tDMGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapTable=sNMPTrapTable, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sFPError=sFPError, apc=apc, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, syslogControl=syslogControl, sFPPortAutoNegotiation=sFPPortAutoNegotiation, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, rawReceivePowerLinked=rawReceivePowerLinked, sNMPEnabledTraps=sNMPEnabledTraps, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseGasGroup=licenseGasGroup, cableLoss=cableLoss, mABHoldoffPeriod=mABHoldoffPeriod, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, remoteMACAddressLinked=remoteMACAddressLinked, whitelistRMMacAddress=whitelistRMMacAddress, sNTPPrimaryServer=sNTPPrimaryServer, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, dfsTableNumber=dfsTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, authorizationControlTableEntry=authorizationControlTableEntry, ptpGroups=ptpGroups, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, cableDiagPair1Results=cableDiagPair1Results, sNTPSync=sNTPSync, alarmsGroup=alarmsGroup, receiveFreqMHz=receiveFreqMHz, alarmInstancedTableEntry=alarmInstancedTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseIssueNumber=licenseIssueNumber, licenseSecurityLevel=licenseSecurityLevel, sNTPServerTimeout=sNTPServerTimeout, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receivePower=receivePower, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, useVLANForManagementInterfaces=useVLANForManagementInterfaces, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, installStatusLinked=installStatusLinked, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, cableDiagPair4Distance=cableDiagPair4Distance, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, searchState=searchState, userTableNumber=userTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, transparentClockVID=transparentClockVID, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, frequencyVariant=frequencyVariant, encryptionAlgorithm=encryptionAlgorithm, iPv4Address=iPv4Address, dfsTable=dfsTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, alarmInstancedTableNumber=alarmInstancedTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTableEntry=sNTPServerTableEntry, systemReset=systemReset, auxPortDisabledWarning=auxPortDisabledWarning, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ethernetGroup=ethernetGroup, transparentClockPort=transparentClockPort, iPv6Address=iPv6Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerRetries=sNTPServerRetries, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTable=l2CPPriorityTable, licenseRegulatoryBandsList=licenseRegulatoryBandsList, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, cableDiagnosticsWarning=cableDiagnosticsWarning, rxColorCode=rxColorCode, ethernetStatisticsTable=ethernetStatisticsTable, signalStrengthRatio=signalStrengthRatio, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, altitude=altitude, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, nIDULanPortAutoMdix=nIDULanPortAutoMdix, erroredSeconds=erroredSeconds, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, gatewayIPAddress=gatewayIPAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, extendedSpectrumScanning=extendedSpectrumScanning, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, transmitDataRate=transmitDataRate, wirelessTopology=wirelessTopology, eIRP=eIRP, tDMInterfaceControl=tDMInterfaceControl, phyControlInstancedTable=phyControlInstancedTable, siteName=siteName, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tDMChannelLineCode=tDMChannelLineCode, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, syncESlavePort=syncESlavePort, auxPortStatusTrap=auxPortStatusTrap, supplementaryGroup=supplementaryGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, dNSServerInternetAddress=dNSServerInternetAddress, mABNominalModulationMode=mABNominalModulationMode, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
