...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPServerTable=sNTPServerTable, transparentClockPort=transparentClockPort, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, bridgeGroup=bridgeGroup, licenseCountry=licenseCountry, phyControlGroup=phyControlGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, versionsGroup=versionsGroup, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, transmitDataRateLinked=transmitDataRateLinked, phyControlInstancedTableEntry=phyControlInstancedTableEntry, auxPortStatusTrap=auxPortStatusTrap, transmitModulationMode=transmitModulationMode, licenseHCMPSupport=licenseHCMPSupport, syslogState=syslogState, syncESlavePort=syncESlavePort, configuration=configuration, phyControlInstancedTableIndex=phyControlInstancedTableIndex, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, ethernetInstancedTable=ethernetInstancedTable, ptmp=ptmp, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, blacklistRMEnabled=blacklistRMEnabled, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, reset=reset, configurationInstancedTableIndex=configurationInstancedTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityTable=l2CPPriorityTable, eIRP=eIRP, subbandHighestFrequency=subbandHighestFrequency, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, phyStatusGroup=phyStatusGroup, transmitFreqMHz=transmitFreqMHz, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, receivePowerLinked=receivePowerLinked, configurationGroup=configurationGroup, dNSServerPortNumber=dNSServerPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseInstancedTableNumber=licenseInstancedTableNumber, sntpGroup=sntpGroup, receiveFreqKHz=receiveFreqKHz, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, userTableIndex=userTableIndex, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, dSCPManagementPriority=dSCPManagementPriority, remoteMACAddress=remoteMACAddress, ethernetPriorityTable=ethernetPriorityTable, transmitPower=transmitPower, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, installArmState=installArmState, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, cableDiagPair2Distance=cableDiagPair2Distance, secureModeAlarm=secureModeAlarm, tdmTableNumber=tdmTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPServerPortNumber=tFTPServerPortNumber, deviceMSN=deviceMSN, incompatibleRegulatoryBands=incompatibleRegulatoryBands, vectorError=vectorError, mABHoldoffPeriod=mABHoldoffPeriod, nIDULanPortAutoMdix=nIDULanPortAutoMdix, routerProtocolsGroup=routerProtocolsGroup, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, smtpGroup=smtpGroup, ethernetInstancedTableIndex=ethernetInstancedTableIndex, auxPortQLTx=auxPortQLTx, rangeLinked=rangeLinked, cableDiagPair1Results=cableDiagPair1Results, ethernetGroup=ethernetGroup, softwareVersion=softwareVersion, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tDDSynchronizationMode=tDDSynchronizationMode, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, qOSPriorityScheme=qOSPriorityScheme, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitModulationModeLinked=transmitModulationModeLinked, ptpCompliance=ptpCompliance, latitude=latitude, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ptp=ptp, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, ethernetInstancedTableNumber=ethernetInstancedTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerTableNumber=sNTPServerTableNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, snmpControl=snmpControl, cableDiagnostics=cableDiagnostics, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapTableEntry=sNMPTrapTableEntry, blacklistRMMacAddress=blacklistRMMacAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, cableDiagPair4Results=cableDiagPair4Results, sNTPState=sNTPState, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sFPPortQLRx=sFPPortQLRx, whitelistRMMacAddress=whitelistRMMacAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, authorizationControlTableIndex=authorizationControlTableIndex, managementNetworkAccessEnabled=managementNetworkAccessEnabled, receiveDataRateLinked=receiveDataRateLinked, tDMChannelLoopback=tDMChannelLoopback, hCMPLinkSymmetry=hCMPLinkSymmetry, userRole=userRole, sntp=sntp, signalStrengthRatio=signalStrengthRatio, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mgmtInstancedTableEntry=mgmtInstancedTableEntry, encryptionGroup=encryptionGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, regulatoryBandTrap=regulatoryBandTrap, tDM=tDM, iPv6PrefixLength=iPv6PrefixLength, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, auxPortStatus=auxPortStatus, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tdmTableEntry=tdmTableEntry, capacityVariantMismatchLinked=capacityVariantMismatchLinked, txMABFrames=txMABFrames, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, receiveModulationModeDetail=receiveModulationModeDetail, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ethernetStatisticsTable=ethernetStatisticsTable, dfsTableNumber=dfsTableNumber, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseInstancedTableIndex=licenseInstancedTableIndex, dNSServerTableNumber=dNSServerTableNumber, authorizationMethod=authorizationMethod, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, dfsTable=dfsTable, wirelessLinkAvailability=wirelessLinkAvailability, licenseGroupAccess=licenseGroupAccess, tDDSynchronizationStatus=tDDSynchronizationStatus, dataBridgingStatusLinked=dataBridgingStatusLinked, l2CPPriorityTableIndex=l2CPPriorityTableIndex, enableTransmission=enableTransmission, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, userEnabled=userEnabled, ptpTrapPrefix=ptpTrapPrefix, licenseTLSRekey=licenseTLSRekey, tempPcb=tempPcb, alarms=alarms, ptpGroups=ptpGroups, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, unitName=unitName, smtp=smtp, maximumTransmitPower=maximumTransmitPower, wirelessOutAllOctets=wirelessOutAllOctets, userTableNumber=userTableNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, wirelessOutEthernetOctets=wirelessOutEthernetOctets, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sNTPServerStatus=sNTPServerStatus, sNMPEnabledTraps=sNMPEnabledTraps, dfsTableEntry=dfsTableEntry, cambium=cambium, mainPSUPortStatus=mainPSUPortStatus, sNMPPortNumber=sNMPPortNumber, auxPortConfigurationMismatch=auxPortConfigurationMismatch, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sMTPSourceEmailAddress=sMTPSourceEmailAddress, lowestTDMModulationMode=lowestTDMModulationMode, sFPPortAllocation=sFPPortAllocation, linkLossLinked=linkLossLinked, telnetPortNumber=telnetPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tdmTable=tdmTable, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, systemReset=systemReset, remoteInternetAddress=remoteInternetAddress, auxPortSSMTx=auxPortSSMTx, auxPortDisabledWarning=auxPortDisabledWarning, vLANManagementVID=vLANManagementVID, telnetAccessEnabled=telnetAccessEnabled, licenseMaxLinkRange=licenseMaxLinkRange, vectorErrorLinked=vectorErrorLinked, packetsToInternalStack=packetsToInternalStack, auxPortAllocation=auxPortAllocation, phyControlInstancedTable=phyControlInstancedTable, linkName=linkName, cableDiagnosticsWarning=cableDiagnosticsWarning, mABTransmissionInterval=mABTransmissionInterval, tDDControlGroup=tDDControlGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, capacityVariantMismatch=capacityVariantMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, alarmInstancedTable=alarmInstancedTable, sNTPSync=sNTPSync, configurationInstancedTableEntry=configurationInstancedTableEntry, signalStrengthRatioLinked=signalStrengthRatioLinked, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, searchStateLinked=searchStateLinked, subnetMask=subnetMask, frequencyVariant=frequencyVariant, antennaGain=antennaGain, sNTPServerRetries=sNTPServerRetries, receiveDataRate=receiveDataRate, longitude=longitude, l2CPPriorityTableNumber=l2CPPriorityTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseRARSupport=licenseRARSupport, range=range, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortSSMTx=mainPSUPortSSMTx, pubStats=pubStats, ptpTraps=ptpTraps, syncETrackingState=syncETrackingState, regulatoryBand=regulatoryBand, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, syslogClientTrap=syslogClientTrap, receiveFreqMHz=receiveFreqMHz, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sFPPortStatus=sFPPortStatus, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, licenseSecurityLevel=licenseSecurityLevel, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transparentClockVID=transparentClockVID, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, installStatus=installStatus, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, rxColorCode=rxColorCode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mABProtocolVID=mABProtocolVID, transmitDataRate=transmitDataRate, remoteInternetAddressLinked=remoteInternetAddressLinked, lowestDataModulationMode=lowestDataModulationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, tDMInterfaceControl=tDMInterfaceControl, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tdmTableIndex=tdmTableIndex, txColorCode=txColorCode, bridge=bridge, pubStatsGroup=pubStatsGroup, authorizationControlTable=authorizationControlTable, bootVersion=bootVersion, dNSServerInternetAddress=dNSServerInternetAddress, versions=versions, sNTPServerTimeout=sNTPServerTimeout, mainPSUPortAllocation=mainPSUPortAllocation, extendedSpectrumScanning=extendedSpectrumScanning, packetsFromInternalStack=packetsFromInternalStack, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, transparentClockVLAN=transparentClockVLAN, receiveModulationModeLinked=receiveModulationModeLinked, masterSlaveMode=masterSlaveMode, licenseVersion=licenseVersion, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, remoteUnitNameLinked=remoteUnitNameLinked, aAAControl=aAAControl, remoteUnitName=remoteUnitName, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, dNSServerInternetAddressType=dNSServerInternetAddressType, accessMethod=accessMethod, dfsGroup=dfsGroup, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, sNMPCommunityString=sNMPCommunityString, licenseIPv6Support=licenseIPv6Support, resetGroup=resetGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation, lbtDetectedTrap=lbtDetectedTrap, userTableEntry=userTableEntry, deviceESN=deviceESN, tDDSynchronizationAlarm=tDDSynchronizationAlarm, localPacketFiltering=localPacketFiltering, tDMEnabledChannels=tDMEnabledChannels, iPDSCPPriorityTable=iPDSCPPriorityTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, antennaSelection=antennaSelection, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseBandwidthCap=licenseBandwidthCap, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, authorizationControlGroup=authorizationControlGroup, dfsPeaks=dfsPeaks, sNTPServerTableEntry=sNTPServerTableEntry, tFTPClient=tFTPClient, iPv4Address=iPv4Address, useVLANForMABProtocol=useVLANForMABProtocol, wirelessLinkStatus=wirelessLinkStatus, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, syslogStateTrap=syslogStateTrap, configurationInstancedTable=configurationInstancedTable, licenseIEEE1588Support=licenseIEEE1588Support, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, dNSResolver=dNSResolver, tDMChannelStatus=tDMChannelStatus, installationMode=installationMode, transmitChannel=transmitChannel, sNTPServerTableIndex=sNTPServerTableIndex, productVariant=productVariant, capacityVariantMismatchTrap=capacityVariantMismatchTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sFPPortStatusTrap=sFPPortStatusTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNTPLastSync=sNTPLastSync, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNMPTrapVersion=sNMPTrapVersion, tDMChannelStatusTrap=tDMChannelStatusTrap, dfsMeans=dfsMeans, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, productName=productName, ptp670=ptp670, dataBridgingAvailability=dataBridgingAvailability, pubInstancedStatsTable=pubInstancedStatsTable, remoteInternetAddressType=remoteInternetAddressType, snmpControlGroup=snmpControlGroup, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseSFPPortSupport=licenseSFPPortSupport, transparentClock=transparentClock, tFTPServerInternetAddressType=tFTPServerInternetAddressType, aAAControlGroup=aAAControlGroup, rawReceivePowerLinked=rawReceivePowerLinked, tDMChannelLineCode=tDMChannelLineCode, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sFPPortAutoMdix=sFPPortAutoMdix, transmitFreqKHz=transmitFreqKHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseIssueNumber=licenseIssueNumber, installStatusLinked=installStatusLinked, targetRange=targetRange, receiveModulationMode=receiveModulationMode, ethernet=ethernet, tDMChannelCableLength=tDMChannelCableLength, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tDMInterfaceStatus=tDMInterfaceStatus, groupID=groupID, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogClient=syslogClient, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, cableDiagPair4Distance=cableDiagPair4Distance, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, channelChangeTrap=channelChangeTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, phyStatus=phyStatus, maximumNumberOfSlaves=maximumNumberOfSlaves, wirelessTopology=wirelessTopology, linkLoss=linkLoss, installStatusTrap=installStatusTrap, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, auxPortSyncERxStatus=auxPortSyncERxStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitPowerLinked=transmitPowerLinked, siteName=siteName, subbandLowestFrequency=subbandLowestFrequency, sFPPortSSMTx=sFPPortSSMTx, apc=apc, mainPSUPortQLTx=mainPSUPortQLTx, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, tDMGroup=tDMGroup, hardwareVersion=hardwareVersion, licenseCapacity=licenseCapacity, notificationsGroup=notificationsGroup, nIDULanPortStatus=nIDULanPortStatus, syslogControlGroup=syslogControlGroup, dNSPrimaryServer=dNSPrimaryServer, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseGroup=licenseGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, mABNominalModulationMode=mABNominalModulationMode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syncEEquipmentClock=syncEEquipmentClock, unavailableSeconds=unavailableSeconds, licenseSyncESupport=licenseSyncESupport, syncETracking=syncETracking, sFPPortQLTx=sFPPortQLTx, licenseEncryption=licenseEncryption, syslogControl=syslogControl, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, licenseInstancedTableEntry=licenseInstancedTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mABProtocolVLANPriority=mABProtocolVLANPriority, iPv6Address=iPv6Address, sFPError=sFPError, sMTPEnabledMessages=sMTPEnabledMessages, sNTPPollInterval=sNTPPollInterval, aggregateDataRateLinked=aggregateDataRateLinked, userName=userName, sNMPTrapTable=sNMPTrapTable, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, installArmStateTrap=installArmStateTrap, iPVersion=iPVersion, mgmtInstancedTable=mgmtInstancedTable, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, cableDiagPair3Results=cableDiagPair3Results, authorizationControlTableEntry=authorizationControlTableEntry, vLANManagementPriority=vLANManagementPriority, licenseGasGroup=licenseGasGroup, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, licenseTrialPeriod=licenseTrialPeriod, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, cableDiagPair3Distance=cableDiagPair3Distance, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, supplementary=supplementary, dfs=dfs, searchState=searchState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, severelyErroredSeconds=severelyErroredSeconds, mABMaintenanceLevel=mABMaintenanceLevel, PYSNMP_MODULE_ID=cambium, dfsTableIndex=dfsTableIndex, userTable=userTable, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, auxPortQLRx=auxPortQLRx, erroredSeconds=erroredSeconds, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, aggregateDataRate=aggregateDataRate, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, cableDiagnosticsControl=cableDiagnosticsControl, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, deviceMACAddress=deviceMACAddress, cableDiagnosticsPorts=cableDiagnosticsPorts, userPassword=userPassword, mgmtInstancedTableNumber=mgmtInstancedTableNumber, alarmInstancedTableNumber=alarmInstancedTableNumber, sFPPortSyncERxStatus=sFPPortSyncERxStatus, receiveChannel=receiveChannel, license=license, phyControlInstancedTableNumber=phyControlInstancedTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableLoss=cableLoss, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, phyControl=phyControl, managementGroup=managementGroup, mABState=mABState, dataPortPauseFrames=dataPortPauseFrames, linkModeOptimization=linkModeOptimization, dataBridgingStatus=dataBridgingStatus, altitude=altitude, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, byteErrorRatioLinked=byteErrorRatioLinked, encryptionAlgorithm=encryptionAlgorithm, targetMACAddress=targetMACAddress, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, dNSServerTable=dNSServerTable, hTTPSAccessEnabled=hTTPSAccessEnabled, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, systemClock=systemClock, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseRegulatoryBandsList=licenseRegulatoryBandsList, hTTPPortNumber=hTTPPortNumber, dNS=dNS, sNTPSyncTrap=sNTPSyncTrap, licenseInstancedTable=licenseInstancedTable, daylightSaving=daylightSaving, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, alarmInstancedTableEntry=alarmInstancedTableEntry, wirelessOutOctets=wirelessOutOctets, secondarySoftwareVersion=secondarySoftwareVersion, cableDiagPair2Results=cableDiagPair2Results, tDDControl=tDDControl, alarmsGroup=alarmsGroup, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, dNSGroup=dNSGroup, dataBridgingStatusAlarm=dataBridgingStatusAlarm, channelBandwidth=channelBandwidth)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", linkSymmetry=linkSymmetry, authorizationControl=authorizationControl, routerProtocols=routerProtocols, mainPSUPortQLRx=mainPSUPortQLRx, licenseUnitSerialNumber=licenseUnitSerialNumber, unitIdentification=unitIdentification, rangingMode=rangingMode, authorizationControlTableNumber=authorizationControlTableNumber, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mgmtInstancedTableIndex=mgmtInstancedTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sFPPortDisabledWarning=sFPPortDisabledWarning, cableDiagnosticsGroup=cableDiagnosticsGroup, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, portAllocationMismatchLinked=portAllocationMismatchLinked, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tDMConfigurationMismatch=tDMConfigurationMismatch, dNSServerTableEntry=dNSServerTableEntry, configurationInstancedTableNumber=configurationInstancedTableNumber, rawReceivePower=rawReceivePower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, management=management, mainPSUPortAutoMdix=mainPSUPortAutoMdix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, encryption=encryption, ethernetPriorityTableNumber=ethernetPriorityTableNumber, portAllocationMismatch=portAllocationMismatch, portAllocationMismatchTrap=portAllocationMismatchTrap, transmitterChannels=transmitterChannels, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, supplementaryGroup=supplementaryGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, maxLinkRangeExceeded=maxLinkRangeExceeded, sNMPTrapPortNumber=sNMPTrapPortNumber, byteErrorRatio=byteErrorRatio, cableDiagnosticsResultTable=cableDiagnosticsResultTable, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sFPErrorTrap=sFPErrorTrap, unitIdentificationGroup=unitIdentificationGroup, cableDiagPair1Distance=cableDiagPair1Distance, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, apcGroup=apcGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerPortNumber=sNTPServerPortNumber, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, dNSServerTableIndex=dNSServerTableIndex, sNMPv3Enable=sNMPv3Enable, whitelistRMEnabled=whitelistRMEnabled, alarmInstancedTableIndex=alarmInstancedTableIndex, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, remoteMACAddressLinked=remoteMACAddressLinked, secureModeAlarmTrap=secureModeAlarmTrap, timeZone=timeZone, phyInstancedStatusTable=phyInstancedStatusTable)
