...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", management=management, ptp=ptp, sFPPortSyncERxStatus=sFPPortSyncERxStatus, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, ethernetGroup=ethernetGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, versions=versions, whitelistRMMacAddress=whitelistRMMacAddress, ethernetStatisticsTable=ethernetStatisticsTable, hCMPMaximumLinkRange=hCMPMaximumLinkRange, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNTPSyncTrap=sNTPSyncTrap, linkLoss=linkLoss, auxPortQLRx=auxPortQLRx, receiveDataRate=receiveDataRate, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ptp670=ptp670, productVariant=productVariant, mainPSUPortAllocation=mainPSUPortAllocation, smtp=smtp, receiveModulationMode=receiveModulationMode, unitOutOfCalibration=unitOutOfCalibration, phyStatus=phyStatus, routerProtocolsGroup=routerProtocolsGroup, transparentClockPort=transparentClockPort, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, configurationInstancedTableEntry=configurationInstancedTableEntry, sFPPortAllocation=sFPPortAllocation, linkModeOptimization=linkModeOptimization, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, remoteMACAddressLinked=remoteMACAddressLinked, ethernetInstancedTableIndex=ethernetInstancedTableIndex, dfsTableIndex=dfsTableIndex, dataBridgingStatusAlarm=dataBridgingStatusAlarm, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userName=userName, erroredSeconds=erroredSeconds, alarmInstancedTable=alarmInstancedTable, mgmtInstancedTableNumber=mgmtInstancedTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, dNSServerInternetAddress=dNSServerInternetAddress, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, licenseGroupAccess=licenseGroupAccess, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, smtpGroup=smtpGroup, PYSNMP_MODULE_ID=cambium, reset=reset, transmitFreqKHz=transmitFreqKHz, sMTPServerInternetAddress=sMTPServerInternetAddress, resetGroup=resetGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dfsMeans=dfsMeans, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sNMPTrapTableEntry=sNMPTrapTableEntry, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, dNSServerTableEntry=dNSServerTableEntry, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mABHoldoffPeriod=mABHoldoffPeriod, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, userTableEntry=userTableEntry, sNTPSync=sNTPSync, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, auxPortAcceptedQLRx=auxPortAcceptedQLRx, useVLANForManagementInterfaces=useVLANForManagementInterfaces, eIRP=eIRP, licenseTLSRekey=licenseTLSRekey, txColorCode=txColorCode, alarmInstancedTableIndex=alarmInstancedTableIndex, licenseUnitSerialNumber=licenseUnitSerialNumber, mgmtInstancedTableIndex=mgmtInstancedTableIndex, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, remoteInternetAddressType=remoteInternetAddressType, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseInstancedTableNumber=licenseInstancedTableNumber, deviceESN=deviceESN, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, latitude=latitude, aggregateDataRate=aggregateDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, authorizationControlTableNumber=authorizationControlTableNumber, dNSServerTableIndex=dNSServerTableIndex, licenseIPv6Support=licenseIPv6Support, dNSServerTable=dNSServerTable, remoteInternetAddressLinked=remoteInternetAddressLinked, sNMPEnabledTraps=sNMPEnabledTraps, cableDiagPair4Results=cableDiagPair4Results, iPVersion=iPVersion, syslogState=syslogState, dataPortPauseFrames=dataPortPauseFrames, tDMConfigurationMismatch=tDMConfigurationMismatch, cableDiagnosticsControl=cableDiagnosticsControl, linkSymmetry=linkSymmetry, tdmTableIndex=tdmTableIndex, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, dNSServerTableNumber=dNSServerTableNumber, transparentClockVID=transparentClockVID, lowestDataModulationMode=lowestDataModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, syslogControl=syslogControl, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rangeLinked=rangeLinked, licenseTDDSyncSupport=licenseTDDSyncSupport, transmitterChannels=transmitterChannels, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sFPPortSSMTx=sFPPortSSMTx, configurationGroup=configurationGroup, authorizationControlTableIndex=authorizationControlTableIndex, hTTPPortNumber=hTTPPortNumber, timeZone=timeZone, sNMPTrapVersion=sNMPTrapVersion, receiveFreqMHz=receiveFreqMHz, encryptionGroup=encryptionGroup, tDMInterfaceStatus=tDMInterfaceStatus, bootVersion=bootVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveFreqKHz=receiveFreqKHz, transparentClock=transparentClock, antennaSelection=antennaSelection, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerStatus=sNTPServerStatus, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, subbandLowestFrequency=subbandLowestFrequency, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, sMTPSourceEmailAddress=sMTPSourceEmailAddress, authorizationControlTable=authorizationControlTable, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tDMInterfaceControl=tDMInterfaceControl, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, installStatusTrap=installStatusTrap, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, dNSGroup=dNSGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, dNS=dNS, licenseHCMPSupport=licenseHCMPSupport, remoteInternetAddress=remoteInternetAddress, aggregateDataRateLinked=aggregateDataRateLinked, tDMChannelStatusTrap=tDMChannelStatusTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, iPv6Address=iPv6Address, portAllocationMismatch=portAllocationMismatch, wirelessOutOctets=wirelessOutOctets, alarmInstancedTableNumber=alarmInstancedTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseRARSupport=licenseRARSupport, longitude=longitude, vLANManagementVID=vLANManagementVID, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, unitName=unitName, transmitChannel=transmitChannel, auxPortStatus=auxPortStatus, pubStatsGroup=pubStatsGroup, auxPortDisabledWarning=auxPortDisabledWarning, phyControlInstancedTableEntry=phyControlInstancedTableEntry, apcGroup=apcGroup, licenseCountry=licenseCountry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, wirelessOutAllOctets=wirelessOutAllOctets, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, channelChangeTrap=channelChangeTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, ptpGroups=ptpGroups, auxPortSyncERxStatus=auxPortSyncERxStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, portAllocationMismatchTrap=portAllocationMismatchTrap, sFPPortQLTx=sFPPortQLTx, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, userPassword=userPassword, tDM=tDM, receiveModulationModeLinked=receiveModulationModeLinked, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tdmTableEntry=tdmTableEntry, encryptionAlgorithm=encryptionAlgorithm, ptpTrapPrefix=ptpTrapPrefix, tFTPServerPortNumber=tFTPServerPortNumber, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sNTPServerRetries=sNTPServerRetries, rawReceivePower=rawReceivePower, wirelessLinkStatus=wirelessLinkStatus, bridgeGroup=bridgeGroup, authorizationControl=authorizationControl, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, userRole=userRole, systemClock=systemClock, receiveModulationModeDetail=receiveModulationModeDetail, dfsTableNumber=dfsTableNumber, sNTPServerTableEntry=sNTPServerTableEntry, userTableNumber=userTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, tDDControl=tDDControl, licenseGroup=licenseGroup, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, aAAControl=aAAControl, ethernetInstancedTableEntry=ethernetInstancedTableEntry, siteName=siteName, dataBridgingAvailability=dataBridgingAvailability, vLANManagementPriority=vLANManagementPriority, sFPError=sFPError, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarms=alarms, syncETrackingState=syncETrackingState, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, lowestTDMModulationMode=lowestTDMModulationMode, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, daylightSaving=daylightSaving, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, systemReset=systemReset, syslogClientTrap=syslogClientTrap, auxPortAllocation=auxPortAllocation, channelBandwidth=channelBandwidth, linkLossLinked=linkLossLinked, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseGasGroup=licenseGasGroup, apc=apc, licenseTrialPeriod=licenseTrialPeriod, dSCPManagementPriority=dSCPManagementPriority, sFPPortStatus=sFPPortStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, byteErrorRatio=byteErrorRatio, cableDiagPair4Distance=cableDiagPair4Distance, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transmitPowerLinked=transmitPowerLinked, installStatusLinked=installStatusLinked, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, secureModeAlarmTrap=secureModeAlarmTrap, licenseVersion=licenseVersion, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", tFTPClient=tFTPClient, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, qOSPriorityScheme=qOSPriorityScheme, signalStrengthRatio=signalStrengthRatio, cableDiagnosticsWarning=cableDiagnosticsWarning, mABProtocolVID=mABProtocolVID, sntpGroup=sntpGroup, cableDiagPair2Distance=cableDiagPair2Distance, dNSPrimaryServer=dNSPrimaryServer, packetsFromInternalStack=packetsFromInternalStack, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, masterSlaveMode=masterSlaveMode, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, syncESlavePort=syncESlavePort, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, encryption=encryption, blacklistRMEnabled=blacklistRMEnabled, cableDiagPair1Distance=cableDiagPair1Distance, sNMPv3Enable=sNMPv3Enable, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sFPPortQLRx=sFPPortQLRx, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, licenseIEEE1588Support=licenseIEEE1588Support, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDMChannelCableLength=tDMChannelCableLength, frequencyVariant=frequencyVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, notificationsGroup=notificationsGroup, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseEncryption=licenseEncryption, hTTPSPortNumber=hTTPSPortNumber, telnetAccessEnabled=telnetAccessEnabled, ethernetStatisticsDataSource=ethernetStatisticsDataSource, transmitDataRate=transmitDataRate, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseSFPPortSupport=licenseSFPPortSupport, maximumTransmitPower=maximumTransmitPower, authorizationMethod=authorizationMethod, linkName=linkName, range=range, regulatoryBand=regulatoryBand, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, pubInstancedStatsTable=pubInstancedStatsTable, licenseRegulatoryBandsList=licenseRegulatoryBandsList, tempPcb=tempPcb, sMTPEnabledMessages=sMTPEnabledMessages, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sNTPState=sNTPState, remoteUnitNameLinked=remoteUnitNameLinked, noWirelessChannelAvailable=noWirelessChannelAvailable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, supplementary=supplementary, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, receiveChannel=receiveChannel, mABNominalModulationMode=mABNominalModulationMode, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sFPPortAutoMdix=sFPPortAutoMdix, tDMChannelLoopback=tDMChannelLoopback, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, auxPortStatusTrap=auxPortStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmsGroup=alarmsGroup, dfsPeaks=dfsPeaks, antennaGain=antennaGain, sNMPTrapTableNumber=sNMPTrapTableNumber, sFPPortStatusTrap=sFPPortStatusTrap, unavailableSeconds=unavailableSeconds, extendedSpectrumScanning=extendedSpectrumScanning, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, tdmTableNumber=tdmTableNumber, capacityVariantMismatchTrap=capacityVariantMismatchTrap, deviceMSN=deviceMSN, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, targetMACAddress=targetMACAddress, mABMaintenanceLevel=mABMaintenanceLevel, receivePower=receivePower, cableDiagPair1Results=cableDiagPair1Results, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfs=dfs, whitelistRMEnabled=whitelistRMEnabled, remoteMACAddress=remoteMACAddress, cambium=cambium, txMABFrames=txMABFrames, phyStatusGroup=phyStatusGroup, wirelessTopology=wirelessTopology, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mABState=mABState, subbandHighestFrequency=subbandHighestFrequency, regulatoryBandTrap=regulatoryBandTrap, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, signalStrengthRatioLinked=signalStrengthRatioLinked, deviceMACAddress=deviceMACAddress, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, incompatibleRegulatoryBands=incompatibleRegulatoryBands, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, packetsToInternalStack=packetsToInternalStack, searchStateLinked=searchStateLinked, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, l2CPPriorityTableEntry=l2CPPriorityTableEntry, targetRange=targetRange, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tFTPServerInternetAddressType=tFTPServerInternetAddressType, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, softwareVersion=softwareVersion, mgmtInstancedTableEntry=mgmtInstancedTableEntry, rxColorCode=rxColorCode, mgmtInstancedTable=mgmtInstancedTable, userTableIndex=userTableIndex, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, dNSServerPortNumber=dNSServerPortNumber, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNTPServerTable=sNTPServerTable, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, altitude=altitude, ptmp=ptmp, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsGroup=dfsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, unitIdentificationGroup=unitIdentificationGroup, transparentClockVLAN=transparentClockVLAN, byteErrorRatioLinked=byteErrorRatioLinked, dNSResolver=dNSResolver, configurationInstancedTableNumber=configurationInstancedTableNumber, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mainPSUPortQLTx=mainPSUPortQLTx, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, installArmState=installArmState, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, cableDiagnosticsGroup=cableDiagnosticsGroup, mABProtocolVLANPriority=mABProtocolVLANPriority, sNTPServerInternetAddress=sNTPServerInternetAddress, rawReceivePowerLinked=rawReceivePowerLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyControl=phyControl, tDMChannelStatus=tDMChannelStatus, ethernetInstancedTable=ethernetInstancedTable, portAllocationMismatchLinked=portAllocationMismatchLinked, tDMChannelLineCode=tDMChannelLineCode, secondarySoftwareVersion=secondarySoftwareVersion, tDMGroup=tDMGroup, sNMPCommunityString=sNMPCommunityString, licenseMaxLinkRange=licenseMaxLinkRange, tDDControlGroup=tDDControlGroup, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, tdmTable=tdmTable, oOBPriorityQueueMapping=oOBPriorityQueueMapping, telnetPortNumber=telnetPortNumber, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, transmitDataRateLinked=transmitDataRateLinked, syncEEquipmentClock=syncEEquipmentClock, configurationInstancedTable=configurationInstancedTable, bridge=bridge, authorizationControlGroup=authorizationControlGroup, rangingMode=rangingMode, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNMPPortNumber=sNMPPortNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, syslogClient=syslogClient, routerProtocols=routerProtocols, sFPPortDisabledWarning=sFPPortDisabledWarning, transmitModulationMode=transmitModulationMode, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, transmitFreqMHz=transmitFreqMHz, transmitModulationModeLinked=transmitModulationModeLinked, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, capacityVariantMismatchLinked=capacityVariantMismatchLinked, searchState=searchState, receiveDataRateLinked=receiveDataRateLinked, syslogStateTrap=syslogStateTrap, iPv6PrefixLength=iPv6PrefixLength, hardwareVersion=hardwareVersion, phyControlGroup=phyControlGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, vectorErrorLinked=vectorErrorLinked, cableDiagPair3Distance=cableDiagPair3Distance, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagnosticsPorts=cableDiagnosticsPorts, enableTransmission=enableTransmission, licenseSecurityLevel=licenseSecurityLevel, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, managementGroup=managementGroup, secureModeAlarm=secureModeAlarm, dataPortWirelessDownAlert=dataPortWirelessDownAlert, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, transmitPower=transmitPower, ptpCompliance=ptpCompliance, installStatus=installStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, receivePowerLinked=receivePowerLinked, syncETracking=syncETracking, licenseBandwidthCap=licenseBandwidthCap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetInstancedTableNumber=ethernetInstancedTableNumber, dNSServerInternetAddressType=dNSServerInternetAddressType, cableDiagPair2Results=cableDiagPair2Results, managementPortWirelessDownAlert=managementPortWirelessDownAlert, syslogControlGroup=syslogControlGroup, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, vectorError=vectorError, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, licenseOOBManagementSupport=licenseOOBManagementSupport, groupID=groupID, licenseInstancedTable=licenseInstancedTable, auxPortSSMTx=auxPortSSMTx, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPPollInterval=sNTPPollInterval, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, maxLinkRangeExceeded=maxLinkRangeExceeded, severelyErroredSeconds=severelyErroredSeconds, iPv6GatewayAddress=iPv6GatewayAddress, aAAControlGroup=aAAControlGroup, productName=productName, localPacketFiltering=localPacketFiltering, licenseCapacity=licenseCapacity, sNTPPrimaryServer=sNTPPrimaryServer, capacityVariantMismatch=capacityVariantMismatch, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, remoteUnitName=remoteUnitName, authorizationControlTableEntry=authorizationControlTableEntry, license=license, tDMEnabledChannels=tDMEnabledChannels, unitIdentification=unitIdentification, ethernet=ethernet, hTTPAccessEnabled=hTTPAccessEnabled, dataBridgingStatus=dataBridgingStatus, subnetMask=subnetMask, tDDSynchronizationMode=tDDSynchronizationMode, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseSyncESupport=licenseSyncESupport)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", installArmStateTrap=installArmStateTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sntp=sntp, supplementaryGroup=supplementaryGroup, sNTPServerTimeout=sNTPServerTimeout, phyControlInstancedTable=phyControlInstancedTable, iPv4Address=iPv4Address, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sFPErrorTrap=sFPErrorTrap, sMTPServerPortNumber=sMTPServerPortNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sNTPLastSync=sNTPLastSync, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, pubStats=pubStats, cableDiagPair3Results=cableDiagPair3Results, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, accessMethod=accessMethod, snmpControl=snmpControl, auxPortQLTx=auxPortQLTx, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTable=userTable, installationMode=installationMode, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, configuration=configuration, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, versionsGroup=versionsGroup, phyInstancedStatusTable=phyInstancedStatusTable, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, mainPSUPortStatus=mainPSUPortStatus, licenseIssueNumber=licenseIssueNumber, useVLANForMABProtocol=useVLANForMABProtocol, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ptpTraps=ptpTraps, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, l2CPPriorityTable=l2CPPriorityTable, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userEnabled=userEnabled, auxPortConfigurationMismatch=auxPortConfigurationMismatch, nIDULanPortStatus=nIDULanPortStatus, nIDULanPortStatusTrap=nIDULanPortStatusTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, licenseInstancedTableEntry=licenseInstancedTableEntry, dfsTableEntry=dfsTableEntry, licenseInstancedTableIndex=licenseInstancedTableIndex, cableDiagnostics=cableDiagnostics, dfsTable=dfsTable, mABTransmissionInterval=mABTransmissionInterval, snmpControlGroup=snmpControlGroup, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, blacklistRMMacAddress=blacklistRMMacAddress, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, lbtDetectedTrap=lbtDetectedTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mainPSUPortQLRx=mainPSUPortQLRx)
