...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dfsTableNumber=dfsTableNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, management=management, l2CPPriorityTableIndex=l2CPPriorityTableIndex, syncESlavePort=syncESlavePort, tDM=tDM, range=range, ptmp=ptmp, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, transmitDataRate=transmitDataRate, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, alarmsGroup=alarmsGroup, sFPPortSyncERxStatus=sFPPortSyncERxStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, whitelistRMMacAddress=whitelistRMMacAddress, hTTPPortNumber=hTTPPortNumber, targetMACAddress=targetMACAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, installStatusTrap=installStatusTrap, tdmTableNumber=tdmTableNumber, ethernetStatisticsDataSource=ethernetStatisticsDataSource, capacityVariantMismatch=capacityVariantMismatch, vLANManagementPriority=vLANManagementPriority, deviceMSN=deviceMSN, dataBridgingStatus=dataBridgingStatus, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, encryption=encryption, sNTPState=sNTPState, sFPErrorTrap=sFPErrorTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mgmtInstancedTableIndex=mgmtInstancedTableIndex, ethernetGroup=ethernetGroup, sNTPPrimaryServer=sNTPPrimaryServer, portAllocationMismatchTrap=portAllocationMismatchTrap, authorizationControlGroup=authorizationControlGroup, dNSServerPortNumber=dNSServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, sFPPortAutoNegotiation=sFPPortAutoNegotiation, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseUnitSerialNumber=licenseUnitSerialNumber, dNSServerInternetAddress=dNSServerInternetAddress, dataBridgingAvailability=dataBridgingAvailability, cableDiagPair3Distance=cableDiagPair3Distance, dfsTable=dfsTable, installationMode=installationMode, cableDiagnosticsGroup=cableDiagnosticsGroup, remoteMACAddressLinked=remoteMACAddressLinked, userEnabled=userEnabled, receiveModulationMode=receiveModulationMode, ethernetStatisticsTable=ethernetStatisticsTable, auxPortAcceptedQLRx=auxPortAcceptedQLRx, hTTPSAccessEnabled=hTTPSAccessEnabled, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, portAllocationMismatchLinked=portAllocationMismatchLinked, bootVersion=bootVersion, licenseInstancedTableIndex=licenseInstancedTableIndex, subbandHighestFrequency=subbandHighestFrequency, deviceMACAddress=deviceMACAddress, dataBridgingStatusLinked=dataBridgingStatusLinked, sNTPServerStatus=sNTPServerStatus, linkLossLinked=linkLossLinked, linkName=linkName, erroredSeconds=erroredSeconds, receiveChannel=receiveChannel, tdmTableEntry=tdmTableEntry, sNMPPortNumber=sNMPPortNumber, dNS=dNS, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, auxPortStatus=auxPortStatus, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, receiveFreqKHz=receiveFreqKHz, sMTPEmailAlert=sMTPEmailAlert, apc=apc, tDDSynchronizationStatus=tDDSynchronizationStatus, ptp=ptp, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, secureModeAlarmTrap=secureModeAlarmTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installStatus=installStatus, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, vectorErrorLinked=vectorErrorLinked, ethernetPriorityTable=ethernetPriorityTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, linkLoss=linkLoss, alarmInstancedTableIndex=alarmInstancedTableIndex, capacityVariantMismatchTrap=capacityVariantMismatchTrap, userPassword=userPassword, cableDiagnostics=cableDiagnostics, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, alarms=alarms, rawReceivePowerLinked=rawReceivePowerLinked, ptpTrapPrefix=ptpTrapPrefix, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, auxPortDisabledWarning=auxPortDisabledWarning, licenseGroup=licenseGroup, wirelessLinkAvailability=wirelessLinkAvailability, transmitModulationModeLinked=transmitModulationModeLinked, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cableDiagnosticsPorts=cableDiagnosticsPorts, tdmTable=tdmTable, managementNetworkAccessEnabled=managementNetworkAccessEnabled, longitude=longitude, incompatibleMasterAndSlave=incompatibleMasterAndSlave, configurationInstancedTableNumber=configurationInstancedTableNumber, iPv4Address=iPv4Address, receivePower=receivePower, licenseIPv6Support=licenseIPv6Support, remoteUnitNameLinked=remoteUnitNameLinked, systemReset=systemReset, smtp=smtp, channelBandwidth=channelBandwidth, subbandLowestFrequency=subbandLowestFrequency, masterSlaveMode=masterSlaveMode, telnetPortNumber=telnetPortNumber, lowestDataModulationMode=lowestDataModulationMode, auxPortSyncERxStatus=auxPortSyncERxStatus, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, hTTPSPortNumber=hTTPSPortNumber, ptpGroups=ptpGroups, sNTPServerTimeout=sNTPServerTimeout, latitude=latitude, cableDiagPair1Distance=cableDiagPair1Distance, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNMPCommunityString=sNMPCommunityString, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dSCPManagementPriority=dSCPManagementPriority, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dNSServerInternetAddressType=dNSServerInternetAddressType, syslogControlGroup=syslogControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, dfsPeaks=dfsPeaks, whitelistRMEnabled=whitelistRMEnabled, nIDULanPortAutoMdix=nIDULanPortAutoMdix, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tDMGroup=tDMGroup, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sFPPortStatusTrap=sFPPortStatusTrap, regulatoryBandTrap=regulatoryBandTrap, sFPPortAutoMdix=sFPPortAutoMdix, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, nIDULanPortStatus=nIDULanPortStatus, notificationsGroup=notificationsGroup, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseTLSRekey=licenseTLSRekey, secureModeAlarm=secureModeAlarm, licenseInstancedTableNumber=licenseInstancedTableNumber, phyControlInstancedTable=phyControlInstancedTable, cableDiagnosticsWarning=cableDiagnosticsWarning, subnetMask=subnetMask, sNTPServerRetries=sNTPServerRetries, portAllocationMismatch=portAllocationMismatch, softwareVersion=softwareVersion, phyControl=phyControl, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, PYSNMP_MODULE_ID=cambium, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, license=license, phyControlInstancedTableEntry=phyControlInstancedTableEntry, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, dNSResolver=dNSResolver, mgmtInstancedTableEntry=mgmtInstancedTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, unavailableSeconds=unavailableSeconds, pubStats=pubStats, packetsToInternalStack=packetsToInternalStack, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessOutOctets=wirelessOutOctets, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNTPSync=sNTPSync, encryptionGroup=encryptionGroup, hardwareVersion=hardwareVersion, antennaSelection=antennaSelection, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, wirelessOutAllOctets=wirelessOutAllOctets, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, cableLoss=cableLoss, dfsMeans=dfsMeans, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, apcGroup=apcGroup, authorizationControlTableIndex=authorizationControlTableIndex, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, signalStrengthRatioLinked=signalStrengthRatioLinked, rangeLinked=rangeLinked, licenseTrialPeriod=licenseTrialPeriod, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, syslogControl=syslogControl, sFPPortQLRx=sFPPortQLRx, routerProtocols=routerProtocols, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, lowestTDMModulationMode=lowestTDMModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitPower=transmitPower, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseMaxLinkRange=licenseMaxLinkRange, mABNominalTransmitCapacity=mABNominalTransmitCapacity, gatewayIPAddress=gatewayIPAddress, userTableNumber=userTableNumber, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, syncEEquipmentClock=syncEEquipmentClock, licenseRARSupport=licenseRARSupport, wirelessOutEthernetOctets=wirelessOutEthernetOctets, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, snmpControl=snmpControl, groupID=groupID, sFPPortSSMTx=sFPPortSSMTx, licenseOOBManagementSupport=licenseOOBManagementSupport, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPv6GatewayAddress=iPv6GatewayAddress, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, mABState=mABState, linkModeOptimization=linkModeOptimization, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortSSMTx=mainPSUPortSSMTx, auxPortConfigurationMismatch=auxPortConfigurationMismatch, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, cableDiagPair4Distance=cableDiagPair4Distance, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, iPv6PrefixLength=iPv6PrefixLength, alarmInstancedTableNumber=alarmInstancedTableNumber, remoteInternetAddressType=remoteInternetAddressType, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPPollInterval=sNTPPollInterval, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTableNumber=sNMPTrapTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseInstancedTable=licenseInstancedTable, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, phyInstancedStatusTable=phyInstancedStatusTable, productName=productName, tDMChannelCableLength=tDMChannelCableLength, sNTPSyncTrap=sNTPSyncTrap, mABHoldoffPeriod=mABHoldoffPeriod, deviceESN=deviceESN, userTable=userTable, mABNominalModulationMode=mABNominalModulationMode, cableDiagPair1Results=cableDiagPair1Results, userName=userName, sFPError=sFPError, licenseGasGroup=licenseGasGroup, l2CPPriorityTable=l2CPPriorityTable, tDMChannelStatusTrap=tDMChannelStatusTrap, localPacketFiltering=localPacketFiltering, transmitModulationMode=transmitModulationMode, auxPortQLRx=auxPortQLRx, userTableIndex=userTableIndex, maxLinkRangeExceeded=maxLinkRangeExceeded, iPv6Address=iPv6Address, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, configuration=configuration, mgmtInstancedTable=mgmtInstancedTable, licenseHCMPSupport=licenseHCMPSupport, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, authorizationControlTableNumber=authorizationControlTableNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfsTableIndex=dfsTableIndex, txColorCode=txColorCode, syslogStateTrap=syslogStateTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, phyStatus=phyStatus, dNSGroup=dNSGroup, siteName=siteName, auxPortStatusTrap=auxPortStatusTrap, supplementary=supplementary, installStatusLinked=installStatusLinked, receiveFreqMHz=receiveFreqMHz, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, aAAControl=aAAControl, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, licenseGroupAccess=licenseGroupAccess, ethernetInstancedTableNumber=ethernetInstancedTableNumber, phyControlGroup=phyControlGroup, dataPortPauseFrames=dataPortPauseFrames, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPLastSync=sNTPLastSync, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, severelyErroredSeconds=severelyErroredSeconds, transparentClockVLAN=transparentClockVLAN, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPv3Enable=sNMPv3Enable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, maximumNumberOfSlaves=maximumNumberOfSlaves, receiveModulationModeLinked=receiveModulationModeLinked, phyStatusGroup=phyStatusGroup, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tFTPServerInternetAddress=tFTPServerInternetAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mainPSUPortQLTx=mainPSUPortQLTx, installArmStateTrap=installArmStateTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, blacklistRMMacAddress=blacklistRMMacAddress, remoteInternetAddressLinked=remoteInternetAddressLinked, cableDiagPair4Results=cableDiagPair4Results, mABProtocolVID=mABProtocolVID, cableDiagnosticsResultTable=cableDiagnosticsResultTable, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, dNSServerTableIndex=dNSServerTableIndex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, remoteInternetAddress=remoteInternetAddress, enableTransmission=enableTransmission, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sMTPServerInternetAddressType=sMTPServerInternetAddressType, auxPortQLTx=auxPortQLTx, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsGroup=dfsGroup, transmitDataRateLinked=transmitDataRateLinked, licenseSFPPortSupport=licenseSFPPortSupport, qOSPriorityScheme=qOSPriorityScheme, tDMConfigurationMismatch=tDMConfigurationMismatch, cableDiagnosticsControl=cableDiagnosticsControl, mainPSUPortStatus=mainPSUPortStatus, tDMChannelLoopback=tDMChannelLoopback, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, extendedSpectrumScanning=extendedSpectrumScanning, productVariant=productVariant, sNTPServerPortNumber=sNTPServerPortNumber, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, configurationGroup=configurationGroup, rxColorCode=rxColorCode, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, licenseSyncESupport=licenseSyncESupport, transmitChannel=transmitChannel, hTTPAccessEnabled=hTTPAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, accessMethod=accessMethod, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, bridge=bridge, vLANManagementVID=vLANManagementVID, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, configurationInstancedTable=configurationInstancedTable, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseTDDSyncSupport=licenseTDDSyncSupport, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, authorizationControlTable=authorizationControlTable, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, mABTransmissionInterval=mABTransmissionInterval, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, cableDiagPair2Distance=cableDiagPair2Distance, targetRange=targetRange, versionsGroup=versionsGroup, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, pubInstancedStatsTable=pubInstancedStatsTable, transparentClock=transparentClock, useVLANForMABProtocol=useVLANForMABProtocol, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, lbtDetectedTrap=lbtDetectedTrap, licenseSecurityLevel=licenseSecurityLevel, byteErrorRatioLinked=byteErrorRatioLinked, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dNSServerTable=dNSServerTable, sFPPortQLTx=sFPPortQLTx, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPServerInternetAddress=sMTPServerInternetAddress, bridgeGroup=bridgeGroup, tdmTableIndex=tdmTableIndex, eIRP=eIRP, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, sNMPTrapVersion=sNMPTrapVersion, routerProtocolsGroup=routerProtocolsGroup, sntp=sntp, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, unitOutOfCalibration=unitOutOfCalibration, systemClock=systemClock, iPVersion=iPVersion, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, smtpGroup=smtpGroup, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, ethernetInstancedTableIndex=ethernetInstancedTableIndex, ethernetInstancedTableEntry=ethernetInstancedTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, blacklistRMEnabled=blacklistRMEnabled, unitIdentificationGroup=unitIdentificationGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkStatus=wirelessLinkStatus, tDMInterfaceControl=tDMInterfaceControl, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, antennaGain=antennaGain, hCMPLinkSymmetry=hCMPLinkSymmetry, configurationInstancedTableEntry=configurationInstancedTableEntry, phyControlInstancedTableIndex=phyControlInstancedTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, auxPortAllocation=auxPortAllocation, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, mABProtocolVLANPriority=mABProtocolVLANPriority, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mgmtInstancedTableNumber=mgmtInstancedTableNumber, maximumTransmitPower=maximumTransmitPower, licenseInstancedTableEntry=licenseInstancedTableEntry, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, telnetAccessEnabled=telnetAccessEnabled, managementGroup=managementGroup, tDDControl=tDDControl, resetGroup=resetGroup, authorizationControlTableEntry=authorizationControlTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, signalStrengthRatio=signalStrengthRatio, daylightSaving=daylightSaving, mainPSUPortQLRx=mainPSUPortQLRx, ptpCompliance=ptpCompliance, packetsFromInternalStack=packetsFromInternalStack, tDMInterfaceStatus=tDMInterfaceStatus, tDMChannelLineCode=tDMChannelLineCode, timeZone=timeZone, hCMPMaximumLinkRange=hCMPMaximumLinkRange, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, configurationInstancedTableIndex=configurationInstancedTableIndex, ethernetInstancedTable=ethernetInstancedTable, searchState=searchState, cableDiagPair3Results=cableDiagPair3Results, regulatoryBand=regulatoryBand, rangingMode=rangingMode, transmitFreqMHz=transmitFreqMHz, authorizationMethod=authorizationMethod, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, auxPortSSMTx=auxPortSSMTx, installArmState=installArmState, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, snmpControlGroup=snmpControlGroup, tFTPClient=tFTPClient, sFPPortDisabledWarning=sFPPortDisabledWarning, linkSymmetry=linkSymmetry, sNTPServerTableEntry=sNTPServerTableEntry, alarmInstancedTable=alarmInstancedTable, wirelessTopology=wirelessTopology, tempPcb=tempPcb, mainPSUPortAllocation=mainPSUPortAllocation, sNMPTrapTableIndex=sNMPTrapTableIndex, searchStateLinked=searchStateLinked, sNTPServerTable=sNTPServerTable, vectorError=vectorError, versions=versions, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkStatusLinked=wirelessLinkStatusLinked, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, licenseIssueNumber=licenseIssueNumber, licenseCapacity=licenseCapacity, capacityVariantMismatchLinked=capacityVariantMismatchLinked, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, licenseIEEE1588Support=licenseIEEE1588Support, pubStatsGroup=pubStatsGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsTableEntry=dfsTableEntry, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, authorizationControl=authorizationControl, syslogClientTrap=syslogClientTrap, dNSPrimaryServer=dNSPrimaryServer, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, tDMChannelStatus=tDMChannelStatus, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, rawReceivePower=rawReceivePower, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, remoteUnitName=remoteUnitName, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, transmitPowerLinked=transmitPowerLinked, licenseBandwidthCap=licenseBandwidthCap, licenseVersion=licenseVersion, dNSServerTableNumber=dNSServerTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNMPTrapInternetAddress=sNMPTrapInternetAddress, alarmInstancedTableEntry=alarmInstancedTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, cableDiagPair2Results=cableDiagPair2Results, aggregateDataRateLinked=aggregateDataRateLinked, unitIdentification=unitIdentification, cambium=cambium, userTableEntry=userTableEntry, syncETracking=syncETracking, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, userRole=userRole, supplementaryGroup=supplementaryGroup, ptp670=ptp670, syncETrackingState=syncETrackingState, receiveDataRateLinked=receiveDataRateLinked, tDMEnabledChannels=tDMEnabledChannels, aggregateDataRate=aggregateDataRate, transparentClockVID=transparentClockVID, licenseCountry=licenseCountry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationMode=tDDSynchronizationMode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, unitName=unitName, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remoteMACAddress=remoteMACAddress, syslogClient=syslogClient, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, dNSServerTableEntry=dNSServerTableEntry, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, altitude=altitude, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, reset=reset, txMABFrames=txMABFrames, sntpGroup=sntpGroup, sFPPortStatus=sFPPortStatus, receiveDataRate=receiveDataRate, mABMaintenanceLevel=mABMaintenanceLevel, frequencyVariant=frequencyVariant, licenseEncryption=licenseEncryption, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tDDControlGroup=tDDControlGroup, aAAControlGroup=aAAControlGroup, syslogState=syslogState, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, transmitterChannels=transmitterChannels, transparentClockPort=transparentClockPort, receivePowerLinked=receivePowerLinked, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ethernet=ethernet, ptpTraps=ptpTraps, sNMPTrapTable=sNMPTrapTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, byteErrorRatio=byteErrorRatio, dfs=dfs, secondarySoftwareVersion=secondarySoftwareVersion, channelChangeTrap=channelChangeTrap, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sFPPortAllocation=sFPPortAllocation, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry)
