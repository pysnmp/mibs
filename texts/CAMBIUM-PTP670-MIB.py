...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", productName=productName, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, reset=reset, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tDMInterfaceStatus=tDMInterfaceStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, dNSGroup=dNSGroup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, installationMode=installationMode, licenseBandwidthCap=licenseBandwidthCap, cambium=cambium, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sntp=sntp, cableDiagPair4Results=cableDiagPair4Results, dfsPeaks=dfsPeaks, alarmInstancedTableNumber=alarmInstancedTableNumber, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, capacityVariantMismatch=capacityVariantMismatch, ptpTraps=ptpTraps, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, unitOutOfCalibration=unitOutOfCalibration, tDMChannelCableLength=tDMChannelCableLength, auxPortQLTx=auxPortQLTx, telnetAccessEnabled=telnetAccessEnabled, oOBPriorityQueueMapping=oOBPriorityQueueMapping, softwareVersion=softwareVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseIssueNumber=licenseIssueNumber, phyControlInstancedTableIndex=phyControlInstancedTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, auxPortAllocation=auxPortAllocation, encryptionAlgorithm=encryptionAlgorithm, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, PYSNMP_MODULE_ID=cambium, dataBridgingStatusLinked=dataBridgingStatusLinked, syncEEquipmentClock=syncEEquipmentClock, licenseRARSupport=licenseRARSupport, searchState=searchState, portAllocationMismatch=portAllocationMismatch, licenseGroup=licenseGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, sFPPortAutoMdix=sFPPortAutoMdix, managementNetworkAccessEnabled=managementNetworkAccessEnabled, ptpCompliance=ptpCompliance, hCMPLinkSymmetry=hCMPLinkSymmetry, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syncESlavePort=syncESlavePort, lowestTDMModulationMode=lowestTDMModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installArmState=installArmState, auxPortStatus=auxPortStatus, managementGroup=managementGroup, ethernetInstancedTableEntry=ethernetInstancedTableEntry, authorizationControlGroup=authorizationControlGroup, accessMethod=accessMethod, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkLoss=linkLoss, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapVersion=sNMPTrapVersion, authorizationControlTableNumber=authorizationControlTableNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, bridge=bridge, configurationInstancedTableEntry=configurationInstancedTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, versions=versions, portAllocationMismatchTrap=portAllocationMismatchTrap, deviceESN=deviceESN, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sNTPPrimaryServer=sNTPPrimaryServer, phyInstancedStatusTable=phyInstancedStatusTable, auxPortSyncERxStatus=auxPortSyncERxStatus, vectorError=vectorError, licenseTrialPeriod=licenseTrialPeriod, auxPortQLRx=auxPortQLRx, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, linkSymmetry=linkSymmetry, sNTPPollInterval=sNTPPollInterval, iPDSCPPriorityTable=iPDSCPPriorityTable, userRole=userRole, licenseSyncESupport=licenseSyncESupport, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, vLANManagementPriority=vLANManagementPriority, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, cableDiagnosticsPorts=cableDiagnosticsPorts, receiveDataRateLinked=receiveDataRateLinked, userTableEntry=userTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transmitDataRate=transmitDataRate, ptpTrapPrefix=ptpTrapPrefix, siteName=siteName, sNTPSyncTrap=sNTPSyncTrap, smtp=smtp, dfsGroup=dfsGroup, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, dNSPrimaryServer=dNSPrimaryServer, signalStrengthRatioLinked=signalStrengthRatioLinked, rangeLinked=rangeLinked, alarmsGroup=alarmsGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, cableDiagnosticsWarning=cableDiagnosticsWarning, transmitChannel=transmitChannel, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, cableDiagnosticsGroup=cableDiagnosticsGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNTPLastSync=sNTPLastSync, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseRegulatoryBandsList=licenseRegulatoryBandsList, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, searchStateLinked=searchStateLinked, tDMGroup=tDMGroup, useVLANForMABProtocol=useVLANForMABProtocol, pubStats=pubStats, lowestDataModulationMode=lowestDataModulationMode, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, syncETracking=syncETracking, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sFPPortSyncERxStatus=sFPPortSyncERxStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sFPPortDisabledWarning=sFPPortDisabledWarning, userPassword=userPassword, wirelessOutOctets=wirelessOutOctets, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, phyControlInstancedTable=phyControlInstancedTable, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, localPacketFiltering=localPacketFiltering, snmpControlGroup=snmpControlGroup, licenseInstancedTableNumber=licenseInstancedTableNumber, licenseVersion=licenseVersion, licenseHCMPSupport=licenseHCMPSupport, auxPortAcceptedQLRx=auxPortAcceptedQLRx, cableDiagPair1Results=cableDiagPair1Results, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, transparentClockPort=transparentClockPort, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sNMPCommunityString=sNMPCommunityString, transparentClock=transparentClock, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseMaxLinkRange=licenseMaxLinkRange, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tDMInterfaceControl=tDMInterfaceControl, userTableNumber=userTableNumber, licenseInstancedTable=licenseInstancedTable, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, transparentClockVID=transparentClockVID, remoteUnitName=remoteUnitName, mgmtInstancedTableNumber=mgmtInstancedTableNumber, linkName=linkName, regulatoryBand=regulatoryBand, systemClock=systemClock, sFPErrorTrap=sFPErrorTrap, management=management, phyControlInstancedTableNumber=phyControlInstancedTableNumber, cableDiagPair4Distance=cableDiagPair4Distance, configurationInstancedTable=configurationInstancedTable, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sNTPServerTable=sNTPServerTable, ptpGroups=ptpGroups, eIRP=eIRP, installStatusLinked=installStatusLinked, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, secondarySoftwareVersion=secondarySoftwareVersion, latitude=latitude, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, l2CPPriorityTableEntry=l2CPPriorityTableEntry, configurationInstancedTableIndex=configurationInstancedTableIndex, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, authorizationMethod=authorizationMethod, sFPPortStatusTrap=sFPPortStatusTrap, txMABFrames=txMABFrames, iPVersion=iPVersion, sNTPServerPortNumber=sNTPServerPortNumber, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, mABTransmissionInterval=mABTransmissionInterval, mABState=mABState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPv4Address=iPv4Address, dNSServerInternetAddress=dNSServerInternetAddress, timeZone=timeZone, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, unitIdentification=unitIdentification, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, antennaGain=antennaGain, smtpGroup=smtpGroup, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userName=userName, lbtDetectedTrap=lbtDetectedTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, masterSlaveMode=masterSlaveMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, l2CPPriorityTable=l2CPPriorityTable, receivePower=receivePower, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, configurationGroup=configurationGroup, channelBandwidth=channelBandwidth, sNTPState=sNTPState, authorizationControl=authorizationControl, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, transmitterChannels=transmitterChannels, syslogClientTrap=syslogClientTrap, notificationsGroup=notificationsGroup, rxColorCode=rxColorCode, sNMPTrapTableEntry=sNMPTrapTableEntry, authorizationControlTableEntry=authorizationControlTableEntry, sNTPServerRetries=sNTPServerRetries, mABHoldoffPeriod=mABHoldoffPeriod, apcGroup=apcGroup, tDM=tDM, transmitPowerLinked=transmitPowerLinked, subbandLowestFrequency=subbandLowestFrequency, bootVersion=bootVersion, byteErrorRatioLinked=byteErrorRatioLinked, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, dNSServerTableNumber=dNSServerTableNumber, licenseIEEE1588Support=licenseIEEE1588Support, tdmTableNumber=tdmTableNumber, sNTPServerStatus=sNTPServerStatus, tDDSynchronizationMode=tDDSynchronizationMode, auxPortDisabledWarning=auxPortDisabledWarning, aggregateDataRate=aggregateDataRate, tDMChannelLoopback=tDMChannelLoopback, sNTPServerTableIndex=sNTPServerTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortSSMTx=mainPSUPortSSMTx, hTTPSAccessEnabled=hTTPSAccessEnabled, auxPortSSMTx=auxPortSSMTx, cableDiagPair2Results=cableDiagPair2Results, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortQLRx=mainPSUPortQLRx, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, aggregateDataRateLinked=aggregateDataRateLinked, syslogControlGroup=syslogControlGroup, auxPortStatusTrap=auxPortStatusTrap, dNSResolver=dNSResolver, syslogControl=syslogControl, license=license, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, blacklistRMMacAddress=blacklistRMMacAddress, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, dNS=dNS, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mABProtocolVLANPriority=mABProtocolVLANPriority, secureModeAlarmTrap=secureModeAlarmTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, wirelessLinkStatusLinked=wirelessLinkStatusLinked, remoteMaximumTransmitPower=remoteMaximumTransmitPower, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, transmitPower=transmitPower, cableDiagPair2Distance=cableDiagPair2Distance, mgmtInstancedTableEntry=mgmtInstancedTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogStateTrap=syslogStateTrap, sMTPEnabledMessages=sMTPEnabledMessages, licenseTLSRekey=licenseTLSRekey, sNTPServerTimeout=sNTPServerTimeout, sFPPortStatus=sFPPortStatus, remoteMACAddressLinked=remoteMACAddressLinked, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mainPSUPortQLTx=mainPSUPortQLTx, tDDControl=tDDControl, deviceMSN=deviceMSN, licenseEncryption=licenseEncryption, phyControlInstancedTableEntry=phyControlInstancedTableEntry, productVariant=productVariant, sNMPTrapInternetAddress=sNMPTrapInternetAddress, blacklistRMEnabled=blacklistRMEnabled, versionsGroup=versionsGroup, dfsTable=dfsTable, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, capacityVariantMismatchLinked=capacityVariantMismatchLinked, phyStatusGroup=phyStatusGroup, nIDULanPortStatus=nIDULanPortStatus, receiveFreqMHz=receiveFreqMHz, phyStatus=phyStatus, sFPPortQLTx=sFPPortQLTx, ptp=ptp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessOutEthernetOctets=wirelessOutEthernetOctets, routerProtocols=routerProtocols, unavailableSeconds=unavailableSeconds, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userEnabled=userEnabled, tDDControlGroup=tDDControlGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, cableDiagPair3Results=cableDiagPair3Results, tdmTableEntry=tdmTableEntry, aAAControlGroup=aAAControlGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, subnetMask=subnetMask, ptmp=ptmp, licenseSecurityLevel=licenseSecurityLevel, remoteInternetAddress=remoteInternetAddress, licenseOOBManagementSupport=licenseOOBManagementSupport, noWirelessChannelAvailable=noWirelessChannelAvailable, encryptionGroup=encryptionGroup, transmitModulationMode=transmitModulationMode, secureModeAlarm=secureModeAlarm, authorizationControlTable=authorizationControlTable, sMTPServerPortNumber=sMTPServerPortNumber, remoteInternetAddressLinked=remoteInternetAddressLinked, mPLSTCPriorityTable=mPLSTCPriorityTable, alarmInstancedTableIndex=alarmInstancedTableIndex, sFPPortQLRx=sFPPortQLRx, wirelessOutAllOctets=wirelessOutAllOctets, tDMChannelStatus=tDMChannelStatus, wirelessLinkAvailability=wirelessLinkAvailability, groupID=groupID, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, alarms=alarms, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNMPTrapTable=sNMPTrapTable, userTable=userTable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, receiveModulationModeDetail=receiveModulationModeDetail, linkLossLinked=linkLossLinked, bridgeGroup=bridgeGroup, antennaSelection=antennaSelection, frequencyVariant=frequencyVariant, licenseGasGroup=licenseGasGroup, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tdmTableIndex=tdmTableIndex, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, linkModeOptimization=linkModeOptimization, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, pubInstancedStatsTable=pubInstancedStatsTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, targetMACAddress=targetMACAddress, dNSServerTableIndex=dNSServerTableIndex, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, deviceMACAddress=deviceMACAddress, mainPSUPortAllocation=mainPSUPortAllocation, ethernetInstancedTableIndex=ethernetInstancedTableIndex, dfsTableEntry=dfsTableEntry, dNSServerInternetAddressType=dNSServerInternetAddressType, ethernetGroup=ethernetGroup, sFPError=sFPError, licenseIPv6Support=licenseIPv6Support, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, cableDiagPair1Distance=cableDiagPair1Distance, whitelistRMEnabled=whitelistRMEnabled, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, dNSServerTable=dNSServerTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptp670=ptp670, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataBridgingStatus=dataBridgingStatus, receivePowerLinked=receivePowerLinked, rawReceivePower=rawReceivePower, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sFPPortAllocation=sFPPortAllocation, snmpControl=snmpControl, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, installStatus=installStatus, receiveFreqKHz=receiveFreqKHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPAccessEnabled=hTTPAccessEnabled, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, supplementary=supplementary, authorizationControlTableIndex=authorizationControlTableIndex, sMTPEmailAlert=sMTPEmailAlert, transmitModulationModeLinked=transmitModulationModeLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, targetRange=targetRange, sNTPServerTableEntry=sNTPServerTableEntry, sNMPv3Enable=sNMPv3Enable, dfsTableNumber=dfsTableNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, vectorErrorLinked=vectorErrorLinked, cableLoss=cableLoss, tempPcb=tempPcb, phyControl=phyControl, unitName=unitName, rangingMode=rangingMode, syslogState=syslogState, phyControlGroup=phyControlGroup, qOSPriorityScheme=qOSPriorityScheme, dNSServerPortNumber=dNSServerPortNumber, dataPortPauseFrames=dataPortPauseFrames, licenseGroupAccess=licenseGroupAccess, cableDiagnostics=cableDiagnostics, tDMEnabledChannels=tDMEnabledChannels, dNSServerTableEntry=dNSServerTableEntry, pubStatsGroup=pubStatsGroup, remoteMACAddress=remoteMACAddress, supplementaryGroup=supplementaryGroup, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, tDMChannelLineCode=tDMChannelLineCode, syslogClient=syslogClient, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, receiveModulationMode=receiveModulationMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, enableTransmission=enableTransmission, resetGroup=resetGroup, ethernetStatisticsTable=ethernetStatisticsTable, maximumNumberOfSlaves=maximumNumberOfSlaves, wirelessLinkStatus=wirelessLinkStatus, tDMChannelStatusTrap=tDMChannelStatusTrap, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, daylightSaving=daylightSaving, alarmInstancedTable=alarmInstancedTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, regulatoryBandTrap=regulatoryBandTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, licenseUnitSerialNumber=licenseUnitSerialNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfs=dfs, systemReset=systemReset, transmitFreqKHz=transmitFreqKHz, aAAControl=aAAControl, sNMPTrapTableIndex=sNMPTrapTableIndex, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sNMPPortNumber=sNMPPortNumber, capacityVariantMismatchTrap=capacityVariantMismatchTrap, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, tdmTable=tdmTable, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, tFTPClient=tFTPClient, syncETrackingState=syncETrackingState, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, telnetPortNumber=telnetPortNumber, remoteInternetAddressType=remoteInternetAddressType, licenseSFPPortSupport=licenseSFPPortSupport, txColorCode=txColorCode, vLANManagementVID=vLANManagementVID, configurationInstancedTableNumber=configurationInstancedTableNumber, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, receiveModulationModeLinked=receiveModulationModeLinked, tDDSynchronizationStatus=tDDSynchronizationStatus, iPv6GatewayAddress=iPv6GatewayAddress, sNMPEnabledTraps=sNMPEnabledTraps, sntpGroup=sntpGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, hardwareVersion=hardwareVersion, whitelistRMMacAddress=whitelistRMMacAddress, sFPPortSSMTx=sFPPortSSMTx, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cableDiagPair3Distance=cableDiagPair3Distance, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseCapacity=licenseCapacity, receiveChannel=receiveChannel, l2CPPriorityTableNumber=l2CPPriorityTableNumber, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, cableDiagnosticsControl=cableDiagnosticsControl, maximumTransmitPower=maximumTransmitPower, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mABNominalModulationMode=mABNominalModulationMode, mABProtocolVID=mABProtocolVID, mABMaintenanceLevel=mABMaintenanceLevel, wirelessTopology=wirelessTopology, licenseCountry=licenseCountry, dfsTableIndex=dfsTableIndex, configuration=configuration, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNTPSync=sNTPSync, installStatusTrap=installStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", unitIdentificationGroup=unitIdentificationGroup, transmitDataRateLinked=transmitDataRateLinked, routerProtocolsGroup=routerProtocolsGroup, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, ethernetInstancedTable=ethernetInstancedTable, packetsToInternalStack=packetsToInternalStack, hTTPSPortNumber=hTTPSPortNumber, longitude=longitude, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, subbandHighestFrequency=subbandHighestFrequency, remoteUnitNameLinked=remoteUnitNameLinked, sMTPServerInternetAddressType=sMTPServerInternetAddressType, cableDiagnosticsResultTable=cableDiagnosticsResultTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, erroredSeconds=erroredSeconds, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, licenseInstancedTableIndex=licenseInstancedTableIndex, ethernet=ethernet, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, channelChangeTrap=channelChangeTrap, mgmtInstancedTable=mgmtInstancedTable, dfsMeans=dfsMeans, dataBridgingAvailability=dataBridgingAvailability, transparentClockVLAN=transparentClockVLAN, severelyErroredSeconds=severelyErroredSeconds, iPv6PrefixLength=iPv6PrefixLength, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, installArmStateTrap=installArmStateTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, userTableIndex=userTableIndex, iPv6Address=iPv6Address, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, receiveDataRate=receiveDataRate, hTTPPortNumber=hTTPPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, alarmInstancedTableEntry=alarmInstancedTableEntry, packetsFromInternalStack=packetsFromInternalStack, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, rawReceivePowerLinked=rawReceivePowerLinked, encryption=encryption, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, extendedSpectrumScanning=extendedSpectrumScanning, apc=apc, signalStrengthRatio=signalStrengthRatio, portAllocationMismatchLinked=portAllocationMismatchLinked, mainPSUPortStatus=mainPSUPortStatus, byteErrorRatio=byteErrorRatio, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, ethernetInstancedTableNumber=ethernetInstancedTableNumber, range=range, altitude=altitude, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mgmtInstancedTableIndex=mgmtInstancedTableIndex)
