...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", channelChangeTrap=channelChangeTrap, sFPPortStatusTrap=sFPPortStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, PYSNMP_MODULE_ID=cambium, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, licenseBandwidthCap=licenseBandwidthCap, systemReset=systemReset, mABTransmissionInterval=mABTransmissionInterval, hardwareVersion=hardwareVersion, incompatibleRegulatoryBands=incompatibleRegulatoryBands, notificationsGroup=notificationsGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, signalStrengthRatioLinked=signalStrengthRatioLinked, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, capacityVariantMismatchLinked=capacityVariantMismatchLinked, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, auxPortAcceptedQLRx=auxPortAcceptedQLRx, aAAControl=aAAControl, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, unitIdentification=unitIdentification, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dNSServerTableIndex=dNSServerTableIndex, tDMChannelLoopback=tDMChannelLoopback, tDMChannelStatus=tDMChannelStatus, searchStateLinked=searchStateLinked, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, authorizationControlTable=authorizationControlTable, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ethernetPriorityTable=ethernetPriorityTable, transmitterChannels=transmitterChannels, tdmTableNumber=tdmTableNumber, antennaGain=antennaGain, wirelessOutEthernetOctets=wirelessOutEthernetOctets, aggregateDataRate=aggregateDataRate, licenseInstancedTableEntry=licenseInstancedTableEntry, unitIdentificationGroup=unitIdentificationGroup, subbandLowestFrequency=subbandLowestFrequency, transmitModulationModeLinked=transmitModulationModeLinked, bootVersion=bootVersion, versions=versions, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, userRole=userRole, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, wirelessOutOctets=wirelessOutOctets, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, antennaSelection=antennaSelection, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, dNSServerPortNumber=dNSServerPortNumber, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, transparentClockPort=transparentClockPort, transmitChannel=transmitChannel, licenseInstancedTableIndex=licenseInstancedTableIndex, sNTPServerStatus=sNTPServerStatus, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, dfsTableIndex=dfsTableIndex, tDMChannelCableLength=tDMChannelCableLength, l2CPPriorityTable=l2CPPriorityTable, remoteInternetAddressType=remoteInternetAddressType, frequencyVariant=frequencyVariant, ptpGroups=ptpGroups, mABNominalTransmitCapacity=mABNominalTransmitCapacity, remoteMACAddressLinked=remoteMACAddressLinked, ethernetGroup=ethernetGroup, capacityVariantMismatch=capacityVariantMismatch, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cableDiagPair2Distance=cableDiagPair2Distance, qOSPriorityScheme=qOSPriorityScheme, licenseMaxLinkRange=licenseMaxLinkRange, licenseOOBManagementSupport=licenseOOBManagementSupport, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNTPSyncTrap=sNTPSyncTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, lbtDetectedTrap=lbtDetectedTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rangeLinked=rangeLinked, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, management=management, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, dNSPrimaryServer=dNSPrimaryServer, encryptionAlgorithm=encryptionAlgorithm, configurationInstancedTableEntry=configurationInstancedTableEntry, dfsPeaks=dfsPeaks, dNSGroup=dNSGroup, dNSServerTable=dNSServerTable, receiveFreqMHz=receiveFreqMHz, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sMTPEnabledMessages=sMTPEnabledMessages, sNMPEnabledTraps=sNMPEnabledTraps, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, deviceMSN=deviceMSN, iPv6PrefixLength=iPv6PrefixLength, rxColorCode=rxColorCode, useVLANForMABProtocol=useVLANForMABProtocol, alarmInstancedTableNumber=alarmInstancedTableNumber, deviceMACAddress=deviceMACAddress, configurationGroup=configurationGroup, dfs=dfs, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPVersion=iPVersion, license=license, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerRetries=sNTPServerRetries, tDDControlGroup=tDDControlGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, capacityVariantMismatchTrap=capacityVariantMismatchTrap, versionsGroup=versionsGroup, ptp=ptp, alarms=alarms, phyControlInstancedTableNumber=phyControlInstancedTableNumber, ethernetInstancedTableIndex=ethernetInstancedTableIndex, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, remoteUnitName=remoteUnitName, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, daylightSaving=daylightSaving, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, smtpGroup=smtpGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, supplementary=supplementary, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, txMABFrames=txMABFrames, linkSymmetry=linkSymmetry, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, dSCPManagementPriority=dSCPManagementPriority, sntp=sntp, ethernetInstancedTable=ethernetInstancedTable, hCMPMaximumLinkRange=hCMPMaximumLinkRange, userPassword=userPassword, cableDiagPair3Results=cableDiagPair3Results, ethernetInstancedTableEntry=ethernetInstancedTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsMeans=dfsMeans, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, reset=reset, licenseEncryption=licenseEncryption, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sFPPortQLTx=sFPPortQLTx, syncETrackingState=syncETrackingState, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, receivePowerLinked=receivePowerLinked, tDMGroup=tDMGroup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, secureModeAlarm=secureModeAlarm, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, tDMChannelStatusTrap=tDMChannelStatusTrap, cambium=cambium, receivePower=receivePower, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, auxPortSSMTx=auxPortSSMTx, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, rawReceivePowerLinked=rawReceivePowerLinked, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseIPv6Support=licenseIPv6Support, sMTPSourceEmailAddress=sMTPSourceEmailAddress, whitelistRMMacAddress=whitelistRMMacAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseIEEE1588Support=licenseIEEE1588Support, phyStatusGroup=phyStatusGroup, licenseIssueNumber=licenseIssueNumber, range=range, linkLoss=linkLoss, tDDControl=tDDControl, tdmTableEntry=tdmTableEntry, ptmp=ptmp, installArmStateTrap=installArmStateTrap, iPv6Address=iPv6Address, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, iPv4Address=iPv4Address, cableDiagnosticsPorts=cableDiagnosticsPorts, transmitPowerLinked=transmitPowerLinked, cableDiagnosticsResultTable=cableDiagnosticsResultTable, syslogState=syslogState, pubStats=pubStats, tDMChannelLineCode=tDMChannelLineCode, sNMPTrapTable=sNMPTrapTable, mainPSUPortStatus=mainPSUPortStatus, userTableEntry=userTableEntry, hTTPSPortNumber=hTTPSPortNumber, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sNTPState=sNTPState, masterSlaveMode=masterSlaveMode, mainPSUPortSSMTx=mainPSUPortSSMTx, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, syslogControl=syslogControl, remoteInternetAddressLinked=remoteInternetAddressLinked, installArmState=installArmState, userTableNumber=userTableNumber, byteErrorRatioLinked=byteErrorRatioLinked, mABProtocolVID=mABProtocolVID, cableDiagnosticsControl=cableDiagnosticsControl, dNS=dNS, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogStateTrap=syslogStateTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, dataPortWirelessDownAlert=dataPortWirelessDownAlert, groupID=groupID, configuration=configuration, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, receiveDataRate=receiveDataRate, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseRARSupport=licenseRARSupport, licenseGroupAccess=licenseGroupAccess, sNMPTrapTableNumber=sNMPTrapTableNumber, cableLoss=cableLoss, licenseTDDSyncSupport=licenseTDDSyncSupport, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, vectorError=vectorError, receiveChannel=receiveChannel, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseRegulatoryBandsList=licenseRegulatoryBandsList, iPDSCPPriorityTable=iPDSCPPriorityTable, blacklistRMMacAddress=blacklistRMMacAddress, enableTransmission=enableTransmission, sntpGroup=sntpGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", searchState=searchState, timeZone=timeZone, dNSServerTableNumber=dNSServerTableNumber, auxPortConfigurationMismatch=auxPortConfigurationMismatch, ptp670=ptp670, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, blacklistRMEnabled=blacklistRMEnabled, maximumNumberOfSlaves=maximumNumberOfSlaves, alarmInstancedTableIndex=alarmInstancedTableIndex, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, productName=productName, transmitDataRate=transmitDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, targetMACAddress=targetMACAddress, vectorErrorLinked=vectorErrorLinked, authorizationControlTableEntry=authorizationControlTableEntry, unitName=unitName, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, authorizationControl=authorizationControl, receiveModulationMode=receiveModulationMode, byteErrorRatio=byteErrorRatio, deviceESN=deviceESN, sNMPv3Enable=sNMPv3Enable, snmpControl=snmpControl, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, gatewayIPAddress=gatewayIPAddress, dNSServerInternetAddress=dNSServerInternetAddress, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, transmitDataRateLinked=transmitDataRateLinked, syslogLocalWrappedTrap=syslogLocalWrappedTrap, packetsFromInternalStack=packetsFromInternalStack, phyControl=phyControl, sFPPortSSMTx=sFPPortSSMTx, linkName=linkName, whitelistRMEnabled=whitelistRMEnabled, maximumTransmitPower=maximumTransmitPower, cableDiagnosticsGroup=cableDiagnosticsGroup, hTTPPortNumber=hTTPPortNumber, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, wirelessLinkStatus=wirelessLinkStatus, mgmtInstancedTableNumber=mgmtInstancedTableNumber, transmitModulationMode=transmitModulationMode, sFPPortDisabledWarning=sFPPortDisabledWarning, erroredSeconds=erroredSeconds, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataBridgingAvailability=dataBridgingAvailability, userTable=userTable, snmpControlGroup=snmpControlGroup, mainPSUPortAllocation=mainPSUPortAllocation, resetGroup=resetGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitFreqKHz=transmitFreqKHz, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, alarmInstancedTableEntry=alarmInstancedTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, systemClock=systemClock, configurationInstancedTable=configurationInstancedTable, licenseUnitSerialNumber=licenseUnitSerialNumber, txColorCode=txColorCode, mainPSUPortQLRx=mainPSUPortQLRx, syslogControlGroup=syslogControlGroup, longitude=longitude, hTTPAccessEnabled=hTTPAccessEnabled, licenseCountry=licenseCountry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseGasGroup=licenseGasGroup, sFPPortQLRx=sFPPortQLRx, mainPSUPortQLTx=mainPSUPortQLTx, localPacketFiltering=localPacketFiltering, remoteMACAddress=remoteMACAddress, wirelessLinkStatusLinked=wirelessLinkStatusLinked, vLANManagementPriority=vLANManagementPriority, phyControlGroup=phyControlGroup, transmitPower=transmitPower, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, eIRP=eIRP, linkLossLinked=linkLossLinked, vLANManagementVID=vLANManagementVID, nIDULanPortAutoMdix=nIDULanPortAutoMdix, userTableIndex=userTableIndex, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dfsTableEntry=dfsTableEntry, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, hTTPSAccessEnabled=hTTPSAccessEnabled, sFPError=sFPError, aggregateDataRateLinked=aggregateDataRateLinked, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNTPLastSync=sNTPLastSync, cableDiagPair1Distance=cableDiagPair1Distance, managementGroup=managementGroup, mainPSUPortStatusTrap=mainPSUPortStatusTrap, channelBandwidth=channelBandwidth, dfsGroup=dfsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, severelyErroredSeconds=severelyErroredSeconds, alarmsGroup=alarmsGroup, sNTPPrimaryServer=sNTPPrimaryServer, alarmInstancedTable=alarmInstancedTable, syncEEquipmentClock=syncEEquipmentClock, cableDiagPair4Results=cableDiagPair4Results, installStatus=installStatus, ethernetStatisticsDataSource=ethernetStatisticsDataSource, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, secureModeAlarmTrap=secureModeAlarmTrap, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sFPPortAllocation=sFPPortAllocation, portAllocationMismatchTrap=portAllocationMismatchTrap, ethernet=ethernet, receiveDataRateLinked=receiveDataRateLinked, installStatusLinked=installStatusLinked, dataPortPauseFrames=dataPortPauseFrames, targetRange=targetRange, userEnabled=userEnabled, mgmtInstancedTableEntry=mgmtInstancedTableEntry, dNSServerInternetAddressType=dNSServerInternetAddressType, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, mABState=mABState, licenseVersion=licenseVersion, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableDiagnosticsWarning=cableDiagnosticsWarning, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, siteName=siteName, pubInstancedStatsTable=pubInstancedStatsTable, sNTPSync=sNTPSync, cableDiagPair1Results=cableDiagPair1Results, tdmTable=tdmTable, apcGroup=apcGroup, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tFTPClient=tFTPClient, ptpCompliance=ptpCompliance, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, auxPortQLRx=auxPortQLRx, mABNominalModulationMode=mABNominalModulationMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, bridge=bridge, encryption=encryption, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, receiveModulationModeLinked=receiveModulationModeLinked, syslogClient=syslogClient, licenseTrialPeriod=licenseTrialPeriod, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, rawReceivePower=rawReceivePower, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, mgmtInstancedTableIndex=mgmtInstancedTableIndex, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, auxPortDisabledWarning=auxPortDisabledWarning, sNTPServerTableIndex=sNTPServerTableIndex, ptpTrapPrefix=ptpTrapPrefix, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mgmtInstancedTable=mgmtInstancedTable, sNMPCommunityString=sNMPCommunityString, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, unavailableSeconds=unavailableSeconds, sFPPortAutoNegotiation=sFPPortAutoNegotiation, routerProtocols=routerProtocols, cableDiagPair4Distance=cableDiagPair4Distance, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, smtp=smtp, transparentClock=transparentClock, auxPortSyncERxStatus=auxPortSyncERxStatus, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mABMaintenanceLevel=mABMaintenanceLevel, mABHoldoffPeriod=mABHoldoffPeriod, tDMInterfaceStatus=tDMInterfaceStatus, configurationInstancedTableNumber=configurationInstancedTableNumber, sMTPEmailAlert=sMTPEmailAlert, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitFreqMHz=transmitFreqMHz, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, licenseInstancedTable=licenseInstancedTable, tDMConfigurationMismatch=tDMConfigurationMismatch, phyInstancedStatusTable=phyInstancedStatusTable, sFPErrorTrap=sFPErrorTrap, routerProtocolsGroup=routerProtocolsGroup, telnetPortNumber=telnetPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, remoteUnitNameLinked=remoteUnitNameLinked, authorizationControlTableIndex=authorizationControlTableIndex, supplementaryGroup=supplementaryGroup, phyControlInstancedTableEntry=phyControlInstancedTableEntry, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sFPPortAutoMdix=sFPPortAutoMdix, dNSServerTableEntry=dNSServerTableEntry, tempPcb=tempPcb, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseCapacity=licenseCapacity, portAllocationMismatchLinked=portAllocationMismatchLinked, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseHCMPSupport=licenseHCMPSupport, extendedSpectrumScanning=extendedSpectrumScanning, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sFPPortStatus=sFPPortStatus, tdmTableIndex=tdmTableIndex, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tDMEnabledChannels=tDMEnabledChannels, authorizationMethod=authorizationMethod, tDMInterfaceControl=tDMInterfaceControl, bridgeGroup=bridgeGroup, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPPortNumber=sNMPPortNumber, phyControlInstancedTable=phyControlInstancedTable, packetsToInternalStack=packetsToInternalStack, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseSFPPortSupport=licenseSFPPortSupport, signalStrengthRatio=signalStrengthRatio, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementPortWirelessDownAlert=managementPortWirelessDownAlert, altitude=altitude, productVariant=productVariant, syslogClientTrap=syslogClientTrap, licenseSecurityLevel=licenseSecurityLevel, licenseTLSRekey=licenseTLSRekey, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, lowestTDMModulationMode=lowestTDMModulationMode, sNTPServerTableEntry=sNTPServerTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, authorizationControlTableNumber=authorizationControlTableNumber, iPv6GatewayAddress=iPv6GatewayAddress, licenseInstancedTableNumber=licenseInstancedTableNumber, aAAControlGroup=aAAControlGroup, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, syncESlavePort=syncESlavePort, unitOutOfCalibration=unitOutOfCalibration, phyStatus=phyStatus, sNTPServerTimeout=sNTPServerTimeout, transparentClockVLAN=transparentClockVLAN, tDDSynchronizationMode=tDDSynchronizationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortStatus=auxPortStatus, apc=apc, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryptionGroup=encryptionGroup, sNMPTrapVersion=sNMPTrapVersion, regulatoryBand=regulatoryBand, transparentClockVID=transparentClockVID, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNTPPollInterval=sNTPPollInterval, dNSResolver=dNSResolver, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, lowestDataModulationMode=lowestDataModulationMode, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, auxPortQLTx=auxPortQLTx, syncETracking=syncETracking, rangingMode=rangingMode, ethernetStatisticsTable=ethernetStatisticsTable, subnetMask=subnetMask, licenseSyncESupport=licenseSyncESupport, softwareVersion=softwareVersion, nIDULanPortStatus=nIDULanPortStatus, dfsTableNumber=dfsTableNumber, dfsTable=dfsTable, cableDiagPair3Distance=cableDiagPair3Distance, linkModeOptimization=linkModeOptimization, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, configurationInstancedTableIndex=configurationInstancedTableIndex, authorizationControlGroup=authorizationControlGroup, remoteInternetAddress=remoteInternetAddress, cableDiagPair2Results=cableDiagPair2Results, phyControlInstancedTableIndex=phyControlInstancedTableIndex, mABProtocolVLANPriority=mABProtocolVLANPriority, ptpTraps=ptpTraps, cableDiagnostics=cableDiagnostics, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, auxPortStatusTrap=auxPortStatusTrap, pubStatsGroup=pubStatsGroup, accessMethod=accessMethod, regulatoryBandTrap=regulatoryBandTrap, installationMode=installationMode, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tDM=tDM, dataBridgingStatus=dataBridgingStatus, userName=userName, installStatusTrap=installStatusTrap, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseGroup=licenseGroup, wirelessTopology=wirelessTopology, receiveFreqKHz=receiveFreqKHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataBridgingStatusAlarm=dataBridgingStatusAlarm, portAllocationMismatch=portAllocationMismatch, sNTPServerTable=sNTPServerTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkAvailability=wirelessLinkAvailability, auxPortAllocation=auxPortAllocation, sFPPortSyncERxStatus=sFPPortSyncERxStatus, wirelessOutAllOctets=wirelessOutAllOctets, latitude=latitude)
