...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, transparentClockPort=transparentClockPort, daylightSaving=daylightSaving, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, phyStatusGroup=phyStatusGroup, alarmInstancedTable=alarmInstancedTable, authorizationControlGroup=authorizationControlGroup, sNTPServerTableEntry=sNTPServerTableEntry, severelyErroredSeconds=severelyErroredSeconds, aAAControlGroup=aAAControlGroup, phyControlInstancedTableEntry=phyControlInstancedTableEntry, mainPSUPortAllocation=mainPSUPortAllocation, alarmInstancedTableEntry=alarmInstancedTableEntry, qOSPriorityScheme=qOSPriorityScheme, dNSServerTableEntry=dNSServerTableEntry, capacityVariantMismatchTrap=capacityVariantMismatchTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sFPPortQLTx=sFPPortQLTx, tDMChannelLineCode=tDMChannelLineCode, packetsToInternalStack=packetsToInternalStack, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, portAllocationMismatch=portAllocationMismatch, rawReceivePower=rawReceivePower, cableDiagnosticsControl=cableDiagnosticsControl, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, cableDiagnosticsWarning=cableDiagnosticsWarning, auxPortSSMTx=auxPortSSMTx, vLANManagementPriority=vLANManagementPriority, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, lbtDetectedTrap=lbtDetectedTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, licenseOOBManagementSupport=licenseOOBManagementSupport, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, transmitChannel=transmitChannel, incompatibleRegulatoryBands=incompatibleRegulatoryBands, dfsTableIndex=dfsTableIndex, licenseGasGroup=licenseGasGroup, cableDiagPair2Results=cableDiagPair2Results, sFPPortQLRx=sFPPortQLRx, wirelessLinkAvailability=wirelessLinkAvailability, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseIssueNumber=licenseIssueNumber, pubStats=pubStats, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, l2CPPriorityTable=l2CPPriorityTable, sNTPSync=sNTPSync, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogClient=syslogClient, mABMaintenanceLevel=mABMaintenanceLevel, tempPcb=tempPcb, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteInternetAddress=remoteInternetAddress, linkName=linkName, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, receiveFreqKHz=receiveFreqKHz, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, userName=userName, mainPSUPortStatusTrap=mainPSUPortStatusTrap, receiveModulationMode=receiveModulationMode, syncEEquipmentClock=syncEEquipmentClock, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6Address=iPv6Address, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, deviceMACAddress=deviceMACAddress, mainPSUPortStatus=mainPSUPortStatus, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, rxColorCode=rxColorCode, encryption=encryption, sNTPServerRetries=sNTPServerRetries, licenseUnitSerialNumber=licenseUnitSerialNumber, sNTPSyncTrap=sNTPSyncTrap, phyStatus=phyStatus, linkLossLinked=linkLossLinked, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dNSServerTable=dNSServerTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, antennaSelection=antennaSelection, userTable=userTable, receivePowerLinked=receivePowerLinked, transmitPower=transmitPower, transmitPowerLinked=transmitPowerLinked, dNSServerInternetAddress=dNSServerInternetAddress, cableDiagPair3Distance=cableDiagPair3Distance, userTableNumber=userTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, hCMPLinkSymmetry=hCMPLinkSymmetry, subbandLowestFrequency=subbandLowestFrequency, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sFPPortAutoNegotiation=sFPPortAutoNegotiation, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, sntpGroup=sntpGroup, receiveChannel=receiveChannel, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerPortNumber=sNTPServerPortNumber, licenseInstancedTableEntry=licenseInstancedTableEntry, sNMPTrapVersion=sNMPTrapVersion, auxPortStatus=auxPortStatus, systemClock=systemClock, dNSPrimaryServer=dNSPrimaryServer, dataBridgingStatusAlarm=dataBridgingStatusAlarm, txMABFrames=txMABFrames, bootVersion=bootVersion, portAllocationMismatchTrap=portAllocationMismatchTrap, mABProtocolVLANPriority=mABProtocolVLANPriority, sNMPTrapTableEntry=sNMPTrapTableEntry, transparentClockVID=transparentClockVID, licenseCapacity=licenseCapacity, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, sntp=sntp, sNTPServerTable=sNTPServerTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerTableNumber=sNTPServerTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, syncETrackingState=syncETrackingState, sFPPortAutoMdix=sFPPortAutoMdix, remoteInternetAddressLinked=remoteInternetAddressLinked, wirelessTopology=wirelessTopology, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, remoteUnitNameLinked=remoteUnitNameLinked, licenseTLSRekey=licenseTLSRekey, deviceESN=deviceESN, cableDiagPair2Distance=cableDiagPair2Distance, sNMPCommunityString=sNMPCommunityString, latitude=latitude, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, smtpGroup=smtpGroup, authorizationControlTableIndex=authorizationControlTableIndex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, antennaGain=antennaGain, licenseInstancedTableNumber=licenseInstancedTableNumber, sNMPv3Enable=sNMPv3Enable, installStatusLinked=installStatusLinked, encryptionGroup=encryptionGroup, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sFPPortSyncERxStatus=sFPPortSyncERxStatus, ethernetGroup=ethernetGroup, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, byteErrorRatio=byteErrorRatio, tDMChannelLoopback=tDMChannelLoopback, receivePower=receivePower, cableDiagnosticsGroup=cableDiagnosticsGroup, tDMInterfaceStatus=tDMInterfaceStatus, authorizationControlTableEntry=authorizationControlTableEntry, cableDiagPair4Results=cableDiagPair4Results, notificationsGroup=notificationsGroup, tFTPServerPortNumber=tFTPServerPortNumber, tDMGroup=tDMGroup, regulatoryBandTrap=regulatoryBandTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, dNSServerPortNumber=dNSServerPortNumber, tDMChannelStatusTrap=tDMChannelStatusTrap, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, iPVersion=iPVersion, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, searchState=searchState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, mgmtInstancedTableIndex=mgmtInstancedTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, secureModeAlarm=secureModeAlarm, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseMaxLinkRange=licenseMaxLinkRange, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, tDDSynchronizationStatus=tDDSynchronizationStatus, userEnabled=userEnabled, tDMChannelStatus=tDMChannelStatus, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, rangingMode=rangingMode, apcGroup=apcGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagPair1Results=cableDiagPair1Results, mainPSUPortQLTx=mainPSUPortQLTx, unitOutOfCalibration=unitOutOfCalibration, apc=apc, licenseHCMPSupport=licenseHCMPSupport, transparentClock=transparentClock, routerProtocolsGroup=routerProtocolsGroup, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, iPv6PrefixLength=iPv6PrefixLength, altitude=altitude, remoteInternetAddressType=remoteInternetAddressType, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpCompliance=ptpCompliance, phyControlGroup=phyControlGroup, dfsTableNumber=dfsTableNumber, unitName=unitName, lowestTDMModulationMode=lowestTDMModulationMode, hardwareVersion=hardwareVersion, configurationGroup=configurationGroup, authorizationControlTable=authorizationControlTable, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernet=ethernet, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, iPv4Address=iPv4Address, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNTPPollInterval=sNTPPollInterval, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sFPErrorTrap=sFPErrorTrap, channelChangeTrap=channelChangeTrap, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, snmpControlGroup=snmpControlGroup, tDMChannelCableLength=tDMChannelCableLength, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, productName=productName, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, vLANManagementVID=vLANManagementVID, hTTPSPortNumber=hTTPSPortNumber, productVariant=productVariant, authorizationControlTableNumber=authorizationControlTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyControl=phyControl, sFPPortSSMTx=sFPPortSSMTx, remoteMACAddressLinked=remoteMACAddressLinked, sNTPPrimaryServer=sNTPPrimaryServer, subbandHighestFrequency=subbandHighestFrequency, tDMConfigurationMismatch=tDMConfigurationMismatch, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, versionsGroup=versionsGroup, licenseEncryption=licenseEncryption, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, ethernetInstancedTableIndex=ethernetInstancedTableIndex, ptmp=ptmp, versions=versions, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, userTableIndex=userTableIndex, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, vectorErrorLinked=vectorErrorLinked, dfs=dfs, licenseRegulatoryBandsList=licenseRegulatoryBandsList)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", remoteUnitName=remoteUnitName, channelBandwidth=channelBandwidth, cableDiagnosticsResultTable=cableDiagnosticsResultTable, alarmsGroup=alarmsGroup, dNSServerInternetAddressType=dNSServerInternetAddressType, signalStrengthRatio=signalStrengthRatio, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, dataBridgingStatusLinked=dataBridgingStatusLinked, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, syslogStateTrap=syslogStateTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, useVLANForMABProtocol=useVLANForMABProtocol, longitude=longitude, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyControlInstancedTableIndex=phyControlInstancedTableIndex, transmitterChannels=transmitterChannels, managementNetworkAccessEnabled=managementNetworkAccessEnabled, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, packetsFromInternalStack=packetsFromInternalStack, auxPortDisabledWarning=auxPortDisabledWarning, maximumTransmitPower=maximumTransmitPower, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, licenseIEEE1588Support=licenseIEEE1588Support, cableDiagPair3Results=cableDiagPair3Results, transmitDataRate=transmitDataRate, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, range=range, licenseTrialPeriod=licenseTrialPeriod, receiveDataRateLinked=receiveDataRateLinked, syslogControl=syslogControl, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, licenseSFPPortSupport=licenseSFPPortSupport, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, tDM=tDM, receiveFreqMHz=receiveFreqMHz, configurationInstancedTableEntry=configurationInstancedTableEntry, authorizationMethod=authorizationMethod, tDDSynchronizationMode=tDDSynchronizationMode, reset=reset, receiveDataRate=receiveDataRate, sNMPEnabledTraps=sNMPEnabledTraps, dfsTable=dfsTable, PYSNMP_MODULE_ID=cambium, sNTPServerTimeout=sNTPServerTimeout, syslogClientTrap=syslogClientTrap, licenseInstancedTableIndex=licenseInstancedTableIndex, auxPortQLTx=auxPortQLTx, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, lowestDataModulationMode=lowestDataModulationMode, hTTPPortNumber=hTTPPortNumber, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, dNSServerTableIndex=dNSServerTableIndex, supplementaryGroup=supplementaryGroup, authorizationControl=authorizationControl, wirelessOutOctets=wirelessOutOctets, dfsGroup=dfsGroup, mgmtInstancedTableNumber=mgmtInstancedTableNumber, installStatus=installStatus, sNMPTrapTable=sNMPTrapTable, vectorError=vectorError, routerProtocols=routerProtocols, localPacketFiltering=localPacketFiltering, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, transparentClockVLAN=transparentClockVLAN, regulatoryBand=regulatoryBand, ptpTrapPrefix=ptpTrapPrefix, portAllocationMismatchLinked=portAllocationMismatchLinked, dfsMeans=dfsMeans, enableTransmission=enableTransmission, groupID=groupID, nIDULanPortAutoMdix=nIDULanPortAutoMdix, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDControl=tDDControl, sFPPortAllocation=sFPPortAllocation, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, linkLoss=linkLoss, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, bridgeGroup=bridgeGroup, encryptionAlgorithm=encryptionAlgorithm, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, hCMPMaximumLinkRange=hCMPMaximumLinkRange, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, installStatusTrap=installStatusTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, licenseIPv6Support=licenseIPv6Support, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetInstancedTable=ethernetInstancedTable, telnetPortNumber=telnetPortNumber, licenseGroupAccess=licenseGroupAccess, configurationInstancedTable=configurationInstancedTable, smtp=smtp, dNS=dNS, tDMEnabledChannels=tDMEnabledChannels, mABTransmissionInterval=mABTransmissionInterval, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mABProtocolVID=mABProtocolVID, deviceMSN=deviceMSN, rangeLinked=rangeLinked, aAAControl=aAAControl, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, pubStatsGroup=pubStatsGroup, sFPPortStatusTrap=sFPPortStatusTrap, accessMethod=accessMethod, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dfsTableEntry=dfsTableEntry, ptp670=ptp670, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, whitelistRMMacAddress=whitelistRMMacAddress, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, oOBPriorityQueueMapping=oOBPriorityQueueMapping, syslogControlGroup=syslogControlGroup, auxPortQLRx=auxPortQLRx, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dataBridgingAvailability=dataBridgingAvailability, installArmState=installArmState, rawReceivePowerLinked=rawReceivePowerLinked, masterSlaveMode=masterSlaveMode, syslogState=syslogState, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, wirelessOutAllOctets=wirelessOutAllOctets, sNMPTrapTableIndex=sNMPTrapTableIndex, userRole=userRole, telnetAccessEnabled=telnetAccessEnabled, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, aggregateDataRateLinked=aggregateDataRateLinked, transmitFreqKHz=transmitFreqKHz, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mPLSTCPriorityTable=mPLSTCPriorityTable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tdmTableNumber=tdmTableNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseInstancedTable=licenseInstancedTable, secondarySoftwareVersion=secondarySoftwareVersion, subnetMask=subnetMask, licenseGroup=licenseGroup, configurationInstancedTableNumber=configurationInstancedTableNumber, transmitDataRateLinked=transmitDataRateLinked, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, cambium=cambium, tDDControlGroup=tDDControlGroup, tFTPClient=tFTPClient, mgmtInstancedTableEntry=mgmtInstancedTableEntry, cableDiagnostics=cableDiagnostics, siteName=siteName, configurationInstancedTableIndex=configurationInstancedTableIndex, frequencyVariant=frequencyVariant, tdmTableIndex=tdmTableIndex, extendedSpectrumScanning=extendedSpectrumScanning, installationMode=installationMode, transmitModulationMode=transmitModulationMode, bridge=bridge, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptp=ptp, dNSGroup=dNSGroup, eIRP=eIRP, userPassword=userPassword, licenseBandwidthCap=licenseBandwidthCap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sFPPortStatus=sFPPortStatus, targetRange=targetRange, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, dNSResolver=dNSResolver, licenseCountry=licenseCountry, alarmInstancedTableIndex=alarmInstancedTableIndex, phyInstancedStatusTable=phyInstancedStatusTable, transmitFreqMHz=transmitFreqMHz, licenseTDDSyncSupport=licenseTDDSyncSupport, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, remoteMACAddress=remoteMACAddress, installArmStateTrap=installArmStateTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseRARSupport=licenseRARSupport, userTableEntry=userTableEntry, receiveModulationModeLinked=receiveModulationModeLinked, mABNominalModulationMode=mABNominalModulationMode, hTTPAccessEnabled=hTTPAccessEnabled, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nIDULanPortStatus=nIDULanPortStatus, byteErrorRatioLinked=byteErrorRatioLinked, wirelessOutEthernetOctets=wirelessOutEthernetOctets, dNSServerTableNumber=dNSServerTableNumber, capacityVariantMismatchLinked=capacityVariantMismatchLinked, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControlInstancedTableNumber=phyControlInstancedTableNumber, ptpTraps=ptpTraps, blacklistRMEnabled=blacklistRMEnabled, ethernetPriorityTable=ethernetPriorityTable, auxPortSyncERxStatus=auxPortSyncERxStatus, auxPortStatusTrap=auxPortStatusTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerTableIndex=sNTPServerTableIndex, alarms=alarms, licenseSecurityLevel=licenseSecurityLevel, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, aggregateDataRate=aggregateDataRate, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkModeOptimization=linkModeOptimization, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNTPServerStatus=sNTPServerStatus, secureModeAlarmTrap=secureModeAlarmTrap, license=license, erroredSeconds=erroredSeconds, ptpGroups=ptpGroups, maxLinkRangeExceeded=maxLinkRangeExceeded, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, cableDiagPair1Distance=cableDiagPair1Distance, transmitModulationModeLinked=transmitModulationModeLinked, syncETracking=syncETracking, dSCPManagementPriority=dSCPManagementPriority, searchStateLinked=searchStateLinked, alarmInstancedTableNumber=alarmInstancedTableNumber, unavailableSeconds=unavailableSeconds, blacklistRMMacAddress=blacklistRMMacAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPLastSync=sNTPLastSync, linkSymmetry=linkSymmetry, tdmTableEntry=tdmTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, tDMInterfaceControl=tDMInterfaceControl)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", configuration=configuration, tdmTable=tdmTable, wirelessLinkStatusLinked=wirelessLinkStatusLinked, whitelistRMEnabled=whitelistRMEnabled, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, gatewayIPAddress=gatewayIPAddress, management=management, phyControlInstancedTable=phyControlInstancedTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortPauseFrames=dataPortPauseFrames, mABState=mABState, ethernetStatisticsTable=ethernetStatisticsTable, pubInstancedStatsTable=pubInstancedStatsTable, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, auxPortConfigurationMismatch=auxPortConfigurationMismatch, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, linkModeOptimizationMismatch=linkModeOptimizationMismatch, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, wirelessLinkStatus=wirelessLinkStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syncESlavePort=syncESlavePort, mABHoldoffPeriod=mABHoldoffPeriod, resetGroup=resetGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortDisabledWarning=sFPPortDisabledWarning, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, dataBridgingStatus=dataBridgingStatus, txColorCode=txColorCode, timeZone=timeZone, systemReset=systemReset, managementGroup=managementGroup, cableLoss=cableLoss, licenseVersion=licenseVersion, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, supplementary=supplementary, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, unitIdentification=unitIdentification, sNMPTrapTableNumber=sNMPTrapTableNumber, auxPortAllocation=auxPortAllocation, dfsPeaks=dfsPeaks, softwareVersion=softwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, cableDiagPair4Distance=cableDiagPair4Distance, sFPError=sFPError, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, mgmtInstancedTable=mgmtInstancedTable, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sNTPState=sNTPState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, snmpControl=snmpControl, unitIdentificationGroup=unitIdentificationGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, licenseSyncESupport=licenseSyncESupport, targetMACAddress=targetMACAddress, capacityVariantMismatch=capacityVariantMismatch)
