...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", iPv6Address=iPv6Address, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerStatus=sNTPServerStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, iPv4Address=iPv4Address, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, aggregateDataRateLinked=aggregateDataRateLinked, versions=versions, encryption=encryption, receiveDataRate=receiveDataRate, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, packetsFromInternalStack=packetsFromInternalStack, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, pubStats=pubStats, altitude=altitude, pubInstancedStatsTable=pubInstancedStatsTable, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, ptp=ptp, mgmtInstancedTableEntry=mgmtInstancedTableEntry, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseGroupAccess=licenseGroupAccess, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, receiveChannel=receiveChannel, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, reset=reset, encryptionGroup=encryptionGroup, searchStateLinked=searchStateLinked, licenseInstancedTableIndex=licenseInstancedTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, alarms=alarms, dataPortPauseFrames=dataPortPauseFrames, authorizationControlTableIndex=authorizationControlTableIndex, cableDiagnosticsControl=cableDiagnosticsControl, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, deviceMSN=deviceMSN, ptpTrapPrefix=ptpTrapPrefix, cableDiagPair4Distance=cableDiagPair4Distance, auxPortQLRx=auxPortQLRx, linkName=linkName, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sNMPTrapTableEntry=sNMPTrapTableEntry, hCMPMaximumLinkRange=hCMPMaximumLinkRange, configurationInstancedTableNumber=configurationInstancedTableNumber, installArmStateTrap=installArmStateTrap, linkLossLinked=linkLossLinked, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPv3Enable=sNMPv3Enable, cableDiagnostics=cableDiagnostics, dNS=dNS, sNTPServerTableNumber=sNTPServerTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, range=range, dNSResolver=dNSResolver, ethernetInstancedTable=ethernetInstancedTable, iPDSCPPriorityTable=iPDSCPPriorityTable, installStatusTrap=installStatusTrap, targetMACAddress=targetMACAddress, versionsGroup=versionsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkModeOptimization=linkModeOptimization, wirelessLinkAvailability=wirelessLinkAvailability, ptpTraps=ptpTraps, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tDMChannelCableLength=tDMChannelCableLength, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDDSynchronizationStatus=tDDSynchronizationStatus, tDM=tDM, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, subnetMask=subnetMask, userRole=userRole, rawReceivePowerLinked=rawReceivePowerLinked, dfsTableIndex=dfsTableIndex, portAllocationMismatchLinked=portAllocationMismatchLinked, transmitFreqMHz=transmitFreqMHz, routerProtocols=routerProtocols, sFPError=sFPError, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, bridgeGroup=bridgeGroup, subbandHighestFrequency=subbandHighestFrequency, receivePower=receivePower, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, hTTPSPortNumber=hTTPSPortNumber, ethernetStatisticsDataSource=ethernetStatisticsDataSource, mABState=mABState, tDMChannelStatusTrap=tDMChannelStatusTrap, sntp=sntp, transparentClockVID=transparentClockVID, sNMPTrapTableIndex=sNMPTrapTableIndex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, userTableEntry=userTableEntry, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sNMPEnabledTraps=sNMPEnabledTraps, aAAControl=aAAControl, sFPPortAllocation=sFPPortAllocation, sFPPortStatusTrap=sFPPortStatusTrap, hTTPPortNumber=hTTPPortNumber, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, nIDULanPortAutoMdix=nIDULanPortAutoMdix, transparentClockPort=transparentClockPort, deviceMACAddress=deviceMACAddress, rawReceivePower=rawReceivePower, phyControlInstancedTableEntry=phyControlInstancedTableEntry, alarmInstancedTable=alarmInstancedTable, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, wirelessOutOctets=wirelessOutOctets, capacityVariantMismatchTrap=capacityVariantMismatchTrap, transmitModulationMode=transmitModulationMode, installationMode=installationMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mgmtInstancedTableNumber=mgmtInstancedTableNumber, localPacketFiltering=localPacketFiltering, cableDiagPair3Results=cableDiagPair3Results, ethernet=ethernet, authorizationControlTableEntry=authorizationControlTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, auxPortQLTx=auxPortQLTx, supplementaryGroup=supplementaryGroup, whitelistRMEnabled=whitelistRMEnabled, packetsToInternalStack=packetsToInternalStack, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, phyControl=phyControl, cableDiagPair2Distance=cableDiagPair2Distance, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, phyStatus=phyStatus, sntpGroup=sntpGroup, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, byteErrorRatio=byteErrorRatio, erroredSeconds=erroredSeconds, licenseSyncESupport=licenseSyncESupport, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, txMABFrames=txMABFrames, mABHoldoffPeriod=mABHoldoffPeriod, ptpGroups=ptpGroups, sFPPortAutoNegotiation=sFPPortAutoNegotiation, deviceESN=deviceESN, mainPSUPortStatusTrap=mainPSUPortStatusTrap, nIDULanPortStatus=nIDULanPortStatus, dataBridgingAvailability=dataBridgingAvailability, signalStrengthRatio=signalStrengthRatio, remoteMACAddress=remoteMACAddress, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, ethernetInstancedTableEntry=ethernetInstancedTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseBandwidthCap=licenseBandwidthCap, dNSServerInternetAddressType=dNSServerInternetAddressType, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, cableDiagPair4Results=cableDiagPair4Results, installArmState=installArmState, dataBridgingStatus=dataBridgingStatus, lowestTDMModulationMode=lowestTDMModulationMode, licenseSFPPortSupport=licenseSFPPortSupport, transmitDataRateLinked=transmitDataRateLinked, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, productVariant=productVariant, channelChangeTrap=channelChangeTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, vectorError=vectorError, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, cableLoss=cableLoss, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, alarmInstancedTableIndex=alarmInstancedTableIndex, authorizationControlGroup=authorizationControlGroup, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, linkSymmetry=linkSymmetry, wirelessOutAllOctets=wirelessOutAllOctets, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseCountry=licenseCountry, incompatibleRegulatoryBands=incompatibleRegulatoryBands, useVLANForMABProtocol=useVLANForMABProtocol, cambium=cambium, notificationsGroup=notificationsGroup, tDMInterfaceControl=tDMInterfaceControl, l2CPPriorityTable=l2CPPriorityTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenseEncryption=licenseEncryption, accessMethod=accessMethod, rangeLinked=rangeLinked, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, smtp=smtp, iPv6GatewayAddress=iPv6GatewayAddress, daylightSaving=daylightSaving, enableTransmission=enableTransmission, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aAAControlGroup=aAAControlGroup, byteErrorRatioLinked=byteErrorRatioLinked, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteMACAddressLinked=remoteMACAddressLinked, mainPSUPortAllocation=mainPSUPortAllocation, dfsTable=dfsTable, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationMode=tDDSynchronizationMode, dSCPManagementPriority=dSCPManagementPriority, lowestDataModulationMode=lowestDataModulationMode, receiveFreqMHz=receiveFreqMHz, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, licenseIPv6Support=licenseIPv6Support, transparentClockVLAN=transparentClockVLAN, encryptionAlgorithm=encryptionAlgorithm, authorizationControlTableNumber=authorizationControlTableNumber, licenseVersion=licenseVersion, ethernetStatisticsTable=ethernetStatisticsTable, remoteUnitNameLinked=remoteUnitNameLinked, licenseTrialPeriod=licenseTrialPeriod, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sFPPortSyncERxStatus=sFPPortSyncERxStatus, installStatus=installStatus, phyControlInstancedTableIndex=phyControlInstancedTableIndex, supplementary=supplementary, unitName=unitName, configurationGroup=configurationGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mainPSUPortQLTx=mainPSUPortQLTx, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, authorizationControl=authorizationControl, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, lbtDetectedTrap=lbtDetectedTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, gatewayIPAddress=gatewayIPAddress, mABNominalModulationMode=mABNominalModulationMode, configurationInstancedTable=configurationInstancedTable, ethernetPriorityTable=ethernetPriorityTable, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sNTPLastSync=sNTPLastSync, auxPortAcceptedQLRx=auxPortAcceptedQLRx, resetGroup=resetGroup, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, productName=productName, receiveModulationMode=receiveModulationMode, regulatoryBand=regulatoryBand)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", syslogControl=syslogControl, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, remoteInternetAddressType=remoteInternetAddressType, apcGroup=apcGroup, remoteInternetAddressLinked=remoteInternetAddressLinked, timeZone=timeZone, l2CPPriorityTableIndex=l2CPPriorityTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, auxPortDisabledWarning=auxPortDisabledWarning, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPSync=sNTPSync, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, regulatoryBandTrap=regulatoryBandTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, groupID=groupID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, searchState=searchState, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, mABTransmissionInterval=mABTransmissionInterval, vLANManagementVID=vLANManagementVID, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, wirelessLinkStatusLinked=wirelessLinkStatusLinked, cableDiagnosticsWarning=cableDiagnosticsWarning, mgmtInstancedTable=mgmtInstancedTable, maximumNumberOfSlaves=maximumNumberOfSlaves, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseInstancedTableEntry=licenseInstancedTableEntry, blacklistRMMacAddress=blacklistRMMacAddress, tdmTableEntry=tdmTableEntry, transparentClock=transparentClock, sFPErrorTrap=sFPErrorTrap, tdmTable=tdmTable, configurationInstancedTableIndex=configurationInstancedTableIndex, sMTPEmailAlert=sMTPEmailAlert, sNMPCommunityString=sNMPCommunityString, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, installStatusLinked=installStatusLinked, dfsMeans=dfsMeans, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPPollInterval=sNTPPollInterval, hCMPLinkSymmetry=hCMPLinkSymmetry, mainPSUPortAutoMdix=mainPSUPortAutoMdix, frequencyVariant=frequencyVariant, sNMPTrapTable=sNMPTrapTable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, auxPortSSMTx=auxPortSSMTx, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, signalStrengthRatioLinked=signalStrengthRatioLinked, secureModeAlarm=secureModeAlarm, sFPPortStatus=sFPPortStatus, sNMPTrapVersion=sNMPTrapVersion, mABProtocolVLANPriority=mABProtocolVLANPriority, auxPortAllocation=auxPortAllocation, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, userEnabled=userEnabled, userTable=userTable, sFPPortQLTx=sFPPortQLTx, mgmtInstancedTableIndex=mgmtInstancedTableIndex, dfsTableEntry=dfsTableEntry, cableDiagnosticsResultTable=cableDiagnosticsResultTable, authorizationMethod=authorizationMethod, bridge=bridge, rangingMode=rangingMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, phyControlInstancedTable=phyControlInstancedTable, dfs=dfs, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogControlGroup=syslogControlGroup, pubStatsGroup=pubStatsGroup, sNTPServerTable=sNTPServerTable, blacklistRMEnabled=blacklistRMEnabled, qOSPriorityScheme=qOSPriorityScheme, licenseHCMPSupport=licenseHCMPSupport, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, vectorErrorLinked=vectorErrorLinked, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, softwareVersion=softwareVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPVersion=iPVersion, sNTPServerTableEntry=sNTPServerTableEntry, phyControlInstancedTableNumber=phyControlInstancedTableNumber, syslogState=syslogState, dfsGroup=dfsGroup, receivePowerLinked=receivePowerLinked, portAllocationMismatchTrap=portAllocationMismatchTrap, transmitChannel=transmitChannel, oOBPriorityQueueMapping=oOBPriorityQueueMapping, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, telnetPortNumber=telnetPortNumber, licenseGasGroup=licenseGasGroup, configuration=configuration, phyControlGroup=phyControlGroup, cableDiagPair1Results=cableDiagPair1Results, tDDControlGroup=tDDControlGroup, sNMPPortNumber=sNMPPortNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, mainPSUPortStatus=mainPSUPortStatus, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, receiveModulationModeLinked=receiveModulationModeLinked, licenseIEEE1588Support=licenseIEEE1588Support, iPv6PrefixLength=iPv6PrefixLength, licenseInstancedTable=licenseInstancedTable, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sNTPState=sNTPState, ethernetPriorityTableNumber=ethernetPriorityTableNumber, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, managementNetworkAccessEnabled=managementNetworkAccessEnabled, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, unitIdentification=unitIdentification, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsPeaks=dfsPeaks, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, tempPcb=tempPcb, nIDULanPortStatusTrap=nIDULanPortStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, tDMInterfaceStatus=tDMInterfaceStatus, tDDControl=tDDControl, sNTPServerTimeout=sNTPServerTimeout, latitude=latitude, targetRange=targetRange, dNSServerTableIndex=dNSServerTableIndex, smtpGroup=smtpGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, tFTPServerInternetAddress=tFTPServerInternetAddress, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, dNSServerPortNumber=dNSServerPortNumber, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, unitOutOfCalibration=unitOutOfCalibration, snmpControlGroup=snmpControlGroup, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, ptmp=ptmp, bootVersion=bootVersion, syncETracking=syncETracking, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, unavailableSeconds=unavailableSeconds, cableDiagPair3Distance=cableDiagPair3Distance, dfsTableNumber=dfsTableNumber, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, portAllocationMismatch=portAllocationMismatch, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, extendedSpectrumScanning=extendedSpectrumScanning, vLANManagementPriority=vLANManagementPriority, mABProtocolVID=mABProtocolVID, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteUnitName=remoteUnitName, apc=apc, sMTPEnabledMessages=sMTPEnabledMessages, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, rxColorCode=rxColorCode, tDMEnabledChannels=tDMEnabledChannels, maxLinkRangeExceeded=maxLinkRangeExceeded, syncEEquipmentClock=syncEEquipmentClock, channelBandwidth=channelBandwidth, dNSServerInternetAddress=dNSServerInternetAddress, licenseMaxLinkRange=licenseMaxLinkRange, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, longitude=longitude, licenseSecurityLevel=licenseSecurityLevel, userName=userName, auxPortStatus=auxPortStatus, whitelistRMMacAddress=whitelistRMMacAddress, remoteInternetAddress=remoteInternetAddress, ethernetGroup=ethernetGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licenseInstancedTableNumber=licenseInstancedTableNumber, snmpControl=snmpControl, transmitPowerLinked=transmitPowerLinked, ptpCompliance=ptpCompliance, auxPortSyncERxStatus=auxPortSyncERxStatus, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, dNSGroup=dNSGroup, licenseRARSupport=licenseRARSupport, syslogClientTrap=syslogClientTrap, cableDiagPair1Distance=cableDiagPair1Distance, ethernetInstancedTableNumber=ethernetInstancedTableNumber, capacityVariantMismatchLinked=capacityVariantMismatchLinked, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, userTableNumber=userTableNumber, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, antennaSelection=antennaSelection, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, licenseIssueNumber=licenseIssueNumber, wirelessTopology=wirelessTopology, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, tDDSynchronizationAlarm=tDDSynchronizationAlarm, eIRP=eIRP, transmitterChannels=transmitterChannels, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, hardwareVersion=hardwareVersion, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tDMGroup=tDMGroup, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, tDMChannelStatus=tDMChannelStatus, syncESlavePort=syncESlavePort, dNSServerTableEntry=dNSServerTableEntry, receiveDataRateLinked=receiveDataRateLinked, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cableDiagPair2Results=cableDiagPair2Results, userTableIndex=userTableIndex, mABMaintenanceLevel=mABMaintenanceLevel, tFTPServerPortNumber=tFTPServerPortNumber, unitIdentificationGroup=unitIdentificationGroup, alarmInstancedTableEntry=alarmInstancedTableEntry, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, dNSPrimaryServer=dNSPrimaryServer, licenseTLSRekey=licenseTLSRekey, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tDMChannelLoopback=tDMChannelLoopback, severelyErroredSeconds=severelyErroredSeconds, alarmInstancedTableNumber=alarmInstancedTableNumber, sNTPServerRetries=sNTPServerRetries, subbandLowestFrequency=subbandLowestFrequency, mainPSUPortSSMTx=mainPSUPortSSMTx, cableDiagnosticsPorts=cableDiagnosticsPorts, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, siteName=siteName, phyStatusGroup=phyStatusGroup, configurationInstancedTableEntry=configurationInstancedTableEntry, tFTPClient=tFTPClient, sFPPortQLRx=sFPPortQLRx, sNTPServerTableIndex=sNTPServerTableIndex, routerProtocolsGroup=routerProtocolsGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, secondarySoftwareVersion=secondarySoftwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tdmTableIndex=tdmTableIndex, dNSServerTableNumber=dNSServerTableNumber, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, receiveFreqKHz=receiveFreqKHz, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, aggregateDataRate=aggregateDataRate, capacityVariantMismatch=capacityVariantMismatch, licenseTDDSyncSupport=licenseTDDSyncSupport, license=license, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, alarmsGroup=alarmsGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPServerInternetAddressType=sNTPServerInternetAddressType, phyInstancedStatusTable=phyInstancedStatusTable, managementGroup=managementGroup, telnetAccessEnabled=telnetAccessEnabled, syslogClient=syslogClient, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, systemClock=systemClock, antennaGain=antennaGain, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mainPSUPortQLRx=mainPSUPortQLRx, syslogStateTrap=syslogStateTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, userPassword=userPassword, ethernetPriorityTableEntry=ethernetPriorityTableEntry, auxPortStatusTrap=auxPortStatusTrap, transmitDataRate=transmitDataRate, masterSlaveMode=masterSlaveMode, transmitFreqKHz=transmitFreqKHz, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, sFPPortDisabledWarning=sFPPortDisabledWarning, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, txColorCode=txColorCode, sFPPortSSMTx=sFPPortSSMTx, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, management=management, dataBridgingStatusAlarm=dataBridgingStatusAlarm, ptp670=ptp670, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dNSServerTable=dNSServerTable, authorizationControlTable=authorizationControlTable, wirelessLinkStatus=wirelessLinkStatus, syncETrackingState=syncETrackingState, PYSNMP_MODULE_ID=cambium, linkLoss=linkLoss, l2CPPriorityTableEntry=l2CPPriorityTableEntry, maximumTransmitPower=maximumTransmitPower, ethernetInstancedTableIndex=ethernetInstancedTableIndex, licenseGroup=licenseGroup, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, tDMChannelLineCode=tDMChannelLineCode, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, wirelessOutEthernetOctets=wirelessOutEthernetOctets, sNTPSyncTrap=sNTPSyncTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, systemReset=systemReset, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sFPPortAutoMdix=sFPPortAutoMdix, transmitPower=transmitPower, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, transmitModulationModeLinked=transmitModulationModeLinked, sMTPServerPortNumber=sMTPServerPortNumber, tdmTableNumber=tdmTableNumber, licenseCapacity=licenseCapacity)
