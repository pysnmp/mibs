...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", installArmState=installArmState, pubInstancedStatsTable=pubInstancedStatsTable, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, auxPortAllocation=auxPortAllocation, dfsTable=dfsTable, tDMInterfaceStatus=tDMInterfaceStatus, sNTPPollInterval=sNTPPollInterval, localPacketFiltering=localPacketFiltering, gatewayIPAddress=gatewayIPAddress, syslogClientTrap=syslogClientTrap, smtpGroup=smtpGroup, dNSResolver=dNSResolver, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mABTransmissionInterval=mABTransmissionInterval, sFPError=sFPError, cableDiagPair4Distance=cableDiagPair4Distance, licenseIEEE1588Support=licenseIEEE1588Support, dNSServerPortNumber=dNSServerPortNumber, linkSymmetry=linkSymmetry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenseRARSupport=licenseRARSupport, remoteUnitNameLinked=remoteUnitNameLinked, sNTPServerTableIndex=sNTPServerTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, tDMChannelStatus=tDMChannelStatus, transmitPowerLinked=transmitPowerLinked, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mABMaintenanceLevel=mABMaintenanceLevel, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseSecurityLevel=licenseSecurityLevel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mABProtocolVID=mABProtocolVID, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, cableDiagnosticsControl=cableDiagnosticsControl, ethernetInstancedTableIndex=ethernetInstancedTableIndex, enableTransmission=enableTransmission, tFTPServerPortNumber=tFTPServerPortNumber, ethernetPriorityTable=ethernetPriorityTable, installArmStateTrap=installArmStateTrap, authorizationControlTableEntry=authorizationControlTableEntry, hardwareVersion=hardwareVersion, mABNominalModulationMode=mABNominalModulationMode, sNTPServerTable=sNTPServerTable, sFPPortQLTx=sFPPortQLTx, cableDiagnostics=cableDiagnostics, wirelessTopology=wirelessTopology, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, sNTPServerTableNumber=sNTPServerTableNumber, syslogControlGroup=syslogControlGroup, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, transmitDataRateLinked=transmitDataRateLinked, userTable=userTable, sNTPPrimaryServer=sNTPPrimaryServer, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseHCMPSupport=licenseHCMPSupport, auxPortStatusTrap=auxPortStatusTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, licenseUnitSerialNumber=licenseUnitSerialNumber, sNTPLastSync=sNTPLastSync, dataBridgingAvailability=dataBridgingAvailability, rangeLinked=rangeLinked, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mainPSUPortStatus=mainPSUPortStatus, sFPPortSSMTx=sFPPortSSMTx, syncESlavePort=syncESlavePort, maximumTransmitPower=maximumTransmitPower, transparentClockVLAN=transparentClockVLAN, extendedSpectrumScanning=extendedSpectrumScanning, ethernet=ethernet, licenseRegulatoryBandsList=licenseRegulatoryBandsList, installationMode=installationMode, bridgeGroup=bridgeGroup, vectorErrorLinked=vectorErrorLinked, tDMEnabledChannels=tDMEnabledChannels, authorizationControlTableIndex=authorizationControlTableIndex, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dSCPManagementPriority=dSCPManagementPriority, softwareVersion=softwareVersion, licenseBandwidthCap=licenseBandwidthCap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transmitModulationMode=transmitModulationMode, syslogState=syslogState, bootVersion=bootVersion, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, transmitFreqKHz=transmitFreqKHz, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dNSServerTableNumber=dNSServerTableNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, longitude=longitude, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseTDDSyncSupport=licenseTDDSyncSupport, sMTPEmailAlert=sMTPEmailAlert, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, ethernetInstancedTableNumber=ethernetInstancedTableNumber, receivePower=receivePower, portAllocationMismatchTrap=portAllocationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, auxPortConfigurationMismatch=auxPortConfigurationMismatch, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseTrialPeriod=licenseTrialPeriod, tdmTable=tdmTable, bridge=bridge, altitude=altitude, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, snmpControlGroup=snmpControlGroup, phyInstancedStatusTable=phyInstancedStatusTable, userName=userName, iPv4Address=iPv4Address, vectorError=vectorError, targetRange=targetRange, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, signalStrengthRatio=signalStrengthRatio, apcGroup=apcGroup, wirelessLinkStatus=wirelessLinkStatus, auxPortSyncERxStatus=auxPortSyncERxStatus, encryptionAlgorithm=encryptionAlgorithm, pubStats=pubStats, ptp=ptp, rawReceivePowerLinked=rawReceivePowerLinked, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDMChannelCableLength=tDMChannelCableLength, licenseInstancedTable=licenseInstancedTable, mgmtInstancedTableNumber=mgmtInstancedTableNumber, remoteInternetAddressType=remoteInternetAddressType, whitelistRMEnabled=whitelistRMEnabled, dfsTableIndex=dfsTableIndex, hCMPLinkSymmetry=hCMPLinkSymmetry, alarmInstancedTable=alarmInstancedTable, phyControlGroup=phyControlGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetStatisticsTable=ethernetStatisticsTable, tDM=tDM, authorizationMethod=authorizationMethod, dNSGroup=dNSGroup, syncETrackingState=syncETrackingState, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, auxPortQLTx=auxPortQLTx, unavailableSeconds=unavailableSeconds, packetsFromInternalStack=packetsFromInternalStack, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sntpGroup=sntpGroup, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rawReceivePower=rawReceivePower, sNTPState=sNTPState, ethernetInstancedTable=ethernetInstancedTable, mainPSUPortSSMTx=mainPSUPortSSMTx, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortPauseFrames=dataPortPauseFrames, iPVersion=iPVersion, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, receivePowerLinked=receivePowerLinked, deviceESN=deviceESN, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseInstancedTableNumber=licenseInstancedTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseInstancedTableEntry=licenseInstancedTableEntry, auxPortStatus=auxPortStatus, iPv6PrefixLength=iPv6PrefixLength, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mgmtInstancedTableEntry=mgmtInstancedTableEntry, ptpGroups=ptpGroups, sNMPTrapTable=sNMPTrapTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rangingMode=rangingMode, authorizationControlTableNumber=authorizationControlTableNumber, capacityVariantMismatchLinked=capacityVariantMismatchLinked, tFTPClient=tFTPClient, syslogClient=syslogClient, cableDiagPair4Results=cableDiagPair4Results, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, alarmInstancedTableEntry=alarmInstancedTableEntry, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, regulatoryBandTrap=regulatoryBandTrap, channelChangeTrap=channelChangeTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, licenseTLSRekey=licenseTLSRekey, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementaryGroup=supplementaryGroup, transmitPower=transmitPower, phyStatus=phyStatus, timeZone=timeZone, ptp670=ptp670, encryptionGroup=encryptionGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpTraps=ptpTraps, authorizationControlTable=authorizationControlTable, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dfsMeans=dfsMeans, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, installStatusLinked=installStatusLinked, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, syslogStateTrap=syslogStateTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, hTTPPortNumber=hTTPPortNumber, versions=versions, systemClock=systemClock, licenseInstancedTableIndex=licenseInstancedTableIndex, routerProtocolsGroup=routerProtocolsGroup, alarmsGroup=alarmsGroup, dNSServerTableEntry=dNSServerTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, dNSServerInternetAddress=dNSServerInternetAddress, managementGroup=managementGroup, secureModeAlarmTrap=secureModeAlarmTrap, tDMChannelLineCode=tDMChannelLineCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, telnetAccessEnabled=telnetAccessEnabled, targetMACAddress=targetMACAddress, telnetPortNumber=telnetPortNumber, cableDiagPair3Distance=cableDiagPair3Distance, ethernetGroup=ethernetGroup, cableDiagPair1Distance=cableDiagPair1Distance, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, alarms=alarms, snmpControl=snmpControl, phyControl=phyControl, tDDControl=tDDControl, accessMethod=accessMethod, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, routerProtocols=routerProtocols, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetInstancedTableEntry=ethernetInstancedTableEntry, licenseGroupAccess=licenseGroupAccess, antennaSelection=antennaSelection)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPErrorTrap=sFPErrorTrap, userEnabled=userEnabled, tdmTableNumber=tdmTableNumber, searchState=searchState, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, latitude=latitude, cableDiagPair1Results=cableDiagPair1Results, signalStrengthRatioLinked=signalStrengthRatioLinked, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, unitIdentificationGroup=unitIdentificationGroup, cableDiagPair2Results=cableDiagPair2Results, aggregateDataRate=aggregateDataRate, syslogControl=syslogControl, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, phyControlInstancedTable=phyControlInstancedTable, portAllocationMismatch=portAllocationMismatch, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseGroup=licenseGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, remoteInternetAddress=remoteInternetAddress, sNMPv3Enable=sNMPv3Enable, productVariant=productVariant, sMTPServerInternetAddressType=sMTPServerInternetAddressType, license=license, sFPPortQLRx=sFPPortQLRx, rxColorCode=rxColorCode, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sFPPortStatusTrap=sFPPortStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseIssueNumber=licenseIssueNumber, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, ptpTrapPrefix=ptpTrapPrefix, wirelessOutOctets=wirelessOutOctets, sFPPortAutoMdix=sFPPortAutoMdix, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, daylightSaving=daylightSaving, aAAControl=aAAControl, smtp=smtp, aAAControlGroup=aAAControlGroup, linkName=linkName, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, siteName=siteName, auxPortDisabledWarning=auxPortDisabledWarning, cableDiagnosticsGroup=cableDiagnosticsGroup, antennaGain=antennaGain, transparentClock=transparentClock, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, authorizationControlGroup=authorizationControlGroup, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, deviceMACAddress=deviceMACAddress, hTTPSPortNumber=hTTPSPortNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, reset=reset, configurationGroup=configurationGroup, auxPortSSMTx=auxPortSSMTx, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, dNSServerTable=dNSServerTable, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, mABHoldoffPeriod=mABHoldoffPeriod, receiveModulationModeLinked=receiveModulationModeLinked, mgmtInstancedTable=mgmtInstancedTable, unitIdentification=unitIdentification, remoteInternetAddressLinked=remoteInternetAddressLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryption=encryption, receiveFreqMHz=receiveFreqMHz, secureModeAlarm=secureModeAlarm, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, management=management, mainPSUPortAllocation=mainPSUPortAllocation, userPassword=userPassword, transmitterChannels=transmitterChannels, cableDiagPair2Distance=cableDiagPair2Distance, installStatusTrap=installStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, phyControlInstancedTableIndex=phyControlInstancedTableIndex, wirelessLinkStatusLinked=wirelessLinkStatusLinked, versionsGroup=versionsGroup, portAllocationMismatchLinked=portAllocationMismatchLinked, dNS=dNS, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, cableLoss=cableLoss, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, receiveModulationModeDetail=receiveModulationModeDetail, remoteMACAddressLinked=remoteMACAddressLinked, cambium=cambium, maximumNumberOfSlaves=maximumNumberOfSlaves, auxPortQLRx=auxPortQLRx, vLANManagementVID=vLANManagementVID, sNTPSyncTrap=sNTPSyncTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseVersion=licenseVersion, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, l2CPPriorityTableEntry=l2CPPriorityTableEntry, phyControlInstancedTableEntry=phyControlInstancedTableEntry, receiveChannel=receiveChannel, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelBandwidth=channelBandwidth, linkLossLinked=linkLossLinked, sNTPSync=sNTPSync, sNMPPortNumber=sNMPPortNumber, userRole=userRole, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, installStatus=installStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, secondarySoftwareVersion=secondarySoftwareVersion, unitOutOfCalibration=unitOutOfCalibration, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, auxPortAcceptedQLRx=auxPortAcceptedQLRx, tdmTableEntry=tdmTableEntry, userTableNumber=userTableNumber, dNSServerTableIndex=dNSServerTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mainPSUPortQLRx=mainPSUPortQLRx, lbtDetectedTrap=lbtDetectedTrap, sFPPortAllocation=sFPPortAllocation, dfsTableEntry=dfsTableEntry, l2CPPriorityTable=l2CPPriorityTable, vLANManagementPriority=vLANManagementPriority, sNMPCommunityString=sNMPCommunityString, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, remoteUnitName=remoteUnitName, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, incompatibleRegulatoryBands=incompatibleRegulatoryBands, whitelistRMMacAddress=whitelistRMMacAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveDataRateLinked=receiveDataRateLinked, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, pubStatsGroup=pubStatsGroup, transmitModulationModeLinked=transmitModulationModeLinked, tDMChannelStatusTrap=tDMChannelStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, tDMInterfaceControl=tDMInterfaceControl, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, syncEEquipmentClock=syncEEquipmentClock, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, unitName=unitName, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mABState=mABState, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sMTPEnabledMessages=sMTPEnabledMessages, dfsGroup=dfsGroup, transmitChannel=transmitChannel, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, lowestTDMModulationMode=lowestTDMModulationMode, receiveModulationMode=receiveModulationMode, configurationInstancedTableEntry=configurationInstancedTableEntry, notificationsGroup=notificationsGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataBridgingStatus=dataBridgingStatus, blacklistRMEnabled=blacklistRMEnabled, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, qOSPriorityScheme=qOSPriorityScheme, receiveFreqKHz=receiveFreqKHz, supplementary=supplementary, hCMPMaximumLinkRange=hCMPMaximumLinkRange, capacityVariantMismatchTrap=capacityVariantMismatchTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, configurationInstancedTableIndex=configurationInstancedTableIndex, range=range, licenseSyncESupport=licenseSyncESupport, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, configuration=configuration, transmitDataRate=transmitDataRate, dataBridgingStatusLinked=dataBridgingStatusLinked, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseGasGroup=licenseGasGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, wirelessOutAllOctets=wirelessOutAllOctets, cableDiagPair3Results=cableDiagPair3Results, packetsToInternalStack=packetsToInternalStack, sNMPTrapTableIndex=sNMPTrapTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptpCompliance=ptpCompliance, nIDULanPortStatus=nIDULanPortStatus, sFPPortDisabledWarning=sFPPortDisabledWarning, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, subbandLowestFrequency=subbandLowestFrequency, tDMChannelLoopback=tDMChannelLoopback, regulatoryBand=regulatoryBand, dNSServerInternetAddressType=dNSServerInternetAddressType, eIRP=eIRP, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDMGroup=tDMGroup, sNTPServerStatus=sNTPServerStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sFPPortAutoNegotiation=sFPPortAutoNegotiation, groupID=groupID, licenseEncryption=licenseEncryption, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, iPv6GatewayAddress=iPv6GatewayAddress, authorizationControl=authorizationControl, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, linkModeOptimization=linkModeOptimization, phyStatusGroup=phyStatusGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteMACAddress=remoteMACAddress, dfsPeaks=dfsPeaks, licenseIPv6Support=licenseIPv6Support, useVLANForMABProtocol=useVLANForMABProtocol, aggregateDataRateLinked=aggregateDataRateLinked, dfsTableNumber=dfsTableNumber, txMABFrames=txMABFrames, dfs=dfs, PYSNMP_MODULE_ID=cambium, configurationInstancedTableNumber=configurationInstancedTableNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseCountry=licenseCountry, frequencyVariant=frequencyVariant, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, licenseCapacity=licenseCapacity, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, transmitFreqMHz=transmitFreqMHz, erroredSeconds=erroredSeconds, productName=productName, sNMPTrapVersion=sNMPTrapVersion, tdmTableIndex=tdmTableIndex, alarmInstancedTableIndex=alarmInstancedTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", apc=apc, transparentClockPort=transparentClockPort, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, deviceMSN=deviceMSN, ptmp=ptmp, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, blacklistRMMacAddress=blacklistRMMacAddress, masterSlaveMode=masterSlaveMode, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, wirelessOutEthernetOctets=wirelessOutEthernetOctets, licenseMaxLinkRange=licenseMaxLinkRange, resetGroup=resetGroup, sntp=sntp, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mABProtocolVLANPriority=mABProtocolVLANPriority, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, sFPPortStatus=sFPPortStatus, subnetMask=subnetMask, severelyErroredSeconds=severelyErroredSeconds, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseOOBManagementSupport=licenseOOBManagementSupport, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, configurationInstancedTable=configurationInstancedTable, cableDiagnosticsPorts=cableDiagnosticsPorts, linkLoss=linkLoss, receiveDataRate=receiveDataRate, tDDSynchronizationStatus=tDDSynchronizationStatus, syncETracking=syncETracking, capacityVariantMismatch=capacityVariantMismatch, userTableIndex=userTableIndex, alarmInstancedTableNumber=alarmInstancedTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, wirelessLinkAvailability=wirelessLinkAvailability, tempPcb=tempPcb, txColorCode=txColorCode, sNTPServerPortNumber=sNTPServerPortNumber, tDDControlGroup=tDDControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, userTableEntry=userTableEntry, sNTPServerTimeout=sNTPServerTimeout, subbandHighestFrequency=subbandHighestFrequency, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, iPv6Address=iPv6Address, transparentClockVID=transparentClockVID, byteErrorRatioLinked=byteErrorRatioLinked, sNTPServerRetries=sNTPServerRetries, licenseSFPPortSupport=licenseSFPPortSupport, lowestDataModulationMode=lowestDataModulationMode, searchStateLinked=searchStateLinked, byteErrorRatio=byteErrorRatio, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, systemReset=systemReset, nIDULanPortStatusTrap=nIDULanPortStatusTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mainPSUPortQLTx=mainPSUPortQLTx, dNSPrimaryServer=dNSPrimaryServer, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch)
