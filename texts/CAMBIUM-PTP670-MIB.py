...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dNSPrimaryServer=dNSPrimaryServer, tDMGroup=tDMGroup, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, transmitFreqKHz=transmitFreqKHz, useVLANForMABProtocol=useVLANForMABProtocol, sNMPPortNumber=sNMPPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityTable=ethernetPriorityTable, dNSServerTable=dNSServerTable, dfsPeaks=dfsPeaks, blacklistRMEnabled=blacklistRMEnabled, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, searchStateLinked=searchStateLinked, licenseVersion=licenseVersion, licenseTDDSyncSupport=licenseTDDSyncSupport, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, gatewayIPAddress=gatewayIPAddress, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, encryption=encryption, sFPError=sFPError, siteName=siteName, bootVersion=bootVersion, licenseCountry=licenseCountry, alarmInstancedTableIndex=alarmInstancedTableIndex, receivePower=receivePower, alarmInstancedTableNumber=alarmInstancedTableNumber, receiveDataRateLinked=receiveDataRateLinked, aggregateDataRate=aggregateDataRate, authorizationControl=authorizationControl, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, l2CPPriorityTableIndex=l2CPPriorityTableIndex, routerProtocolsGroup=routerProtocolsGroup, secondarySoftwareVersion=secondarySoftwareVersion, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sFPPortQLRx=sFPPortQLRx, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, transparentClockVLAN=transparentClockVLAN, sNTPPrimaryServer=sNTPPrimaryServer, tFTPServerInternetAddress=tFTPServerInternetAddress, wirelessLinkStatus=wirelessLinkStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, dataBridgingAvailability=dataBridgingAvailability, dfsTableIndex=dfsTableIndex, sNTPSyncTrap=sNTPSyncTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, auxPortQLRx=auxPortQLRx, packetsToInternalStack=packetsToInternalStack, managementPortWirelessDownAlert=managementPortWirelessDownAlert, versionsGroup=versionsGroup, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mABNominalModulationMode=mABNominalModulationMode, linkName=linkName, syncETrackingState=syncETrackingState, lowestDataModulationMode=lowestDataModulationMode, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, sNTPServerPortNumber=sNTPServerPortNumber, userTableEntry=userTableEntry, subbandLowestFrequency=subbandLowestFrequency, dfsTable=dfsTable, licenseInstancedTableIndex=licenseInstancedTableIndex, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, phyControlInstancedTable=phyControlInstancedTable, transmitChannel=transmitChannel, aggregateDataRateLinked=aggregateDataRateLinked, sNTPState=sNTPState, packetsFromInternalStack=packetsFromInternalStack, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyInstancedStatusTable=phyInstancedStatusTable, remoteUnitName=remoteUnitName, sNMPv3Enable=sNMPv3Enable, vectorError=vectorError, receiveDataRate=receiveDataRate, timeZone=timeZone, hCMPLinkSymmetry=hCMPLinkSymmetry, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mainPSUPortAllocation=mainPSUPortAllocation, aAAControl=aAAControl, dfs=dfs, cableDiagPair4Results=cableDiagPair4Results, syslogClientTrap=syslogClientTrap, vLANManagementVID=vLANManagementVID, licenseIPv6Support=licenseIPv6Support, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, remoteInternetAddressLinked=remoteInternetAddressLinked, encryptionAlgorithm=encryptionAlgorithm, authorizationControlTableIndex=authorizationControlTableIndex, supplementary=supplementary, mABHoldoffPeriod=mABHoldoffPeriod, syslogStateTrap=syslogStateTrap, signalStrengthRatio=signalStrengthRatio, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, syslogState=syslogState, altitude=altitude, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, byteErrorRatioLinked=byteErrorRatioLinked, systemClock=systemClock, transmitModulationMode=transmitModulationMode, secureModeAlarmTrap=secureModeAlarmTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, configurationInstancedTableIndex=configurationInstancedTableIndex, txColorCode=txColorCode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, deviceESN=deviceESN, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, ethernetStatisticsDataSource=ethernetStatisticsDataSource, dNS=dNS, ptmp=ptmp, l2CPPriorityTableEntry=l2CPPriorityTableEntry, erroredSeconds=erroredSeconds, installStatusTrap=installStatusTrap, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, range=range, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, licenseSFPPortSupport=licenseSFPPortSupport, userTable=userTable, mPLSTCPriorityTable=mPLSTCPriorityTable, syncESlavePort=syncESlavePort, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, accessMethod=accessMethod, dNSServerInternetAddress=dNSServerInternetAddress, licenseIssueNumber=licenseIssueNumber, transmitPower=transmitPower, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, searchState=searchState, sFPPortStatusTrap=sFPPortStatusTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, regulatoryBandTrap=regulatoryBandTrap, auxPortSyncERxStatus=auxPortSyncERxStatus, managementGroup=managementGroup, ethernet=ethernet, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, nIDULanPortStatus=nIDULanPortStatus, qOSPriorityScheme=qOSPriorityScheme, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, auxPortConfigurationMismatch=auxPortConfigurationMismatch, phyControlInstancedTableEntry=phyControlInstancedTableEntry, wirelessTopology=wirelessTopology, ptpTrapPrefix=ptpTrapPrefix, tDM=tDM, sNMPTrapPortNumber=sNMPTrapPortNumber, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, alarms=alarms, encryptionGroup=encryptionGroup, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, alarmInstancedTableEntry=alarmInstancedTableEntry, receiveChannel=receiveChannel, mABNominalTransmitCapacity=mABNominalTransmitCapacity, snmpControlGroup=snmpControlGroup, licenseInstancedTable=licenseInstancedTable, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, installArmState=installArmState, unavailableSeconds=unavailableSeconds, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, linkModeOptimization=linkModeOptimization, installArmStateTrap=installArmStateTrap, subbandHighestFrequency=subbandHighestFrequency, sNMPCommunityString=sNMPCommunityString, tDDSynchronizationMode=tDDSynchronizationMode, mainPSUPortStatus=mainPSUPortStatus, licenseHCMPSupport=licenseHCMPSupport, txMABFrames=txMABFrames, remoteInternetAddress=remoteInternetAddress, mainPSUPortSSMTx=mainPSUPortSSMTx, sFPPortAutoMdix=sFPPortAutoMdix, syslogControlGroup=syslogControlGroup, cableDiagnosticsControl=cableDiagnosticsControl, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, transmitDataRate=transmitDataRate, iPv6GatewayAddress=iPv6GatewayAddress, hTTPSPortNumber=hTTPSPortNumber, auxPortStatusTrap=auxPortStatusTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, userRole=userRole, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, tDDControlGroup=tDDControlGroup, dSCPManagementPriority=dSCPManagementPriority, sMTPServerInternetAddressType=sMTPServerInternetAddressType, capacityVariantMismatchLinked=capacityVariantMismatchLinked, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, authorizationControlGroup=authorizationControlGroup, receivePowerLinked=receivePowerLinked, sNTPServerStatus=sNTPServerStatus, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, rxColorCode=rxColorCode, cableDiagnosticsPorts=cableDiagnosticsPorts, tDMChannelLineCode=tDMChannelLineCode, vectorErrorLinked=vectorErrorLinked, iPv4Address=iPv4Address, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, cableDiagnosticsResultTable=cableDiagnosticsResultTable, auxPortStatus=auxPortStatus, syncEEquipmentClock=syncEEquipmentClock, transparentClockVID=transparentClockVID, rawReceivePowerLinked=rawReceivePowerLinked, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, transmitDataRateLinked=transmitDataRateLinked, sNMPTrapTable=sNMPTrapTable, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, iPVersion=iPVersion, phyStatusGroup=phyStatusGroup, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, antennaSelection=antennaSelection, whitelistRMMacAddress=whitelistRMMacAddress, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, iPv6PrefixLength=iPv6PrefixLength, licenseGroup=licenseGroup, licenseSyncESupport=licenseSyncESupport, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sntp=sntp, bridge=bridge, softwareVersion=softwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, tdmTableNumber=tdmTableNumber, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNMPEnabledTraps=sNMPEnabledTraps, licenseIEEE1588Support=licenseIEEE1588Support, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitterChannels=transmitterChannels, userTableNumber=userTableNumber, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, authorizationControlTable=authorizationControlTable, eIRP=eIRP, wirelessOutEthernetOctets=wirelessOutEthernetOctets, deviceMSN=deviceMSN, alarmsGroup=alarmsGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, targetRange=targetRange, channelChangeTrap=channelChangeTrap, phyControlInstancedTableIndex=phyControlInstancedTableIndex, cableDiagnostics=cableDiagnostics, supplementaryGroup=supplementaryGroup, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, receiveModulationModeLinked=receiveModulationModeLinked, aAAControlGroup=aAAControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, userTableIndex=userTableIndex, tDMChannelCableLength=tDMChannelCableLength, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerInternetAddress=sNTPServerInternetAddress, mgmtInstancedTableIndex=mgmtInstancedTableIndex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dNSServerTableNumber=dNSServerTableNumber, l2CPPriorityTable=l2CPPriorityTable, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, dNSResolver=dNSResolver, configuration=configuration, pubStats=pubStats, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, cableDiagPair2Distance=cableDiagPair2Distance, phyControl=phyControl, noWirelessChannelAvailable=noWirelessChannelAvailable, remoteInternetAddressType=remoteInternetAddressType, cambium=cambium, targetMACAddress=targetMACAddress, licenseEncryption=licenseEncryption, phyControlGroup=phyControlGroup, configurationInstancedTable=configurationInstancedTable, apcGroup=apcGroup, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, receiveFreqKHz=receiveFreqKHz, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsTableNumber=dfsTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mABTransmissionInterval=mABTransmissionInterval, pubInstancedStatsTable=pubInstancedStatsTable, severelyErroredSeconds=severelyErroredSeconds, antennaGain=antennaGain, ptpCompliance=ptpCompliance, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mainPSUPortStatusTrap=mainPSUPortStatusTrap, rangingMode=rangingMode, maximumNumberOfSlaves=maximumNumberOfSlaves, wirelessLinkAvailability=wirelessLinkAvailability, telnetAccessEnabled=telnetAccessEnabled, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, licenseGroupAccess=licenseGroupAccess, unitIdentificationGroup=unitIdentificationGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetInstancedTableEntry=ethernetInstancedTableEntry, ethernetInstancedTableNumber=ethernetInstancedTableNumber, cableDiagnosticsGroup=cableDiagnosticsGroup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, enableTransmission=enableTransmission, tempPcb=tempPcb, mABMaintenanceLevel=mABMaintenanceLevel, sMTPServerPortNumber=sMTPServerPortNumber, transparentClock=transparentClock, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, frequencyVariant=frequencyVariant, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, sNTPLastSync=sNTPLastSync, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetPortNumber=telnetPortNumber, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, iPv6Address=iPv6Address, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, remoteMACAddress=remoteMACAddress, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, reset=reset, cableDiagPair4Distance=cableDiagPair4Distance, transparentClockPort=transparentClockPort, authorizationControlTableNumber=authorizationControlTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortSSMTx=auxPortSSMTx, configurationGroup=configurationGroup, licenseInstancedTableEntry=licenseInstancedTableEntry, rangeLinked=rangeLinked, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, dataBridgingStatusLinked=dataBridgingStatusLinked, installationMode=installationMode, cableDiagPair1Results=cableDiagPair1Results, versions=versions, systemReset=systemReset, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, daylightSaving=daylightSaving, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, sNTPServerTimeout=sNTPServerTimeout, secureModeAlarm=secureModeAlarm, licenseMaxLinkRange=licenseMaxLinkRange, remoteMACAddressLinked=remoteMACAddressLinked, sNTPServerRetries=sNTPServerRetries, nIDULanPortAutoMdix=nIDULanPortAutoMdix, wirelessLinkStatusLinked=wirelessLinkStatusLinked, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, lowestTDMModulationMode=lowestTDMModulationMode, sFPPortStatus=sFPPortStatus, tdmTableIndex=tdmTableIndex, licenseSecurityLevel=licenseSecurityLevel, dataPortPauseFrames=dataPortPauseFrames, userName=userName, ethernetStatisticsTable=ethernetStatisticsTable, sNTPPollInterval=sNTPPollInterval, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tFTPServerPortNumber=tFTPServerPortNumber, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapVersion=sNMPTrapVersion, dfsTableEntry=dfsTableEntry, management=management, mgmtInstancedTableEntry=mgmtInstancedTableEntry, ptpGroups=ptpGroups, syslogClient=syslogClient, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, receiveFreqMHz=receiveFreqMHz, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, tDMInterfaceControl=tDMInterfaceControl, hTTPPortNumber=hTTPPortNumber, portAllocationMismatch=portAllocationMismatch, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dNSServerInternetAddressType=dNSServerInternetAddressType, notificationsGroup=notificationsGroup, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseBandwidthCap=licenseBandwidthCap, sNTPServerTable=sNTPServerTable, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, tDMChannelStatus=tDMChannelStatus, capacityVariantMismatch=capacityVariantMismatch, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, tdmTableEntry=tdmTableEntry, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNTPSync=sNTPSync, latitude=latitude, sFPErrorTrap=sFPErrorTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetInstancedTableIndex=ethernetInstancedTableIndex, tDMChannelLoopback=tDMChannelLoopback, sMTPEnabledMessages=sMTPEnabledMessages, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, phyControlInstancedTableNumber=phyControlInstancedTableNumber, dNSGroup=dNSGroup, sFPPortQLTx=sFPPortQLTx, sFPPortSyncERxStatus=sFPPortSyncERxStatus, linkSymmetry=linkSymmetry, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mABState=mABState, snmpControl=snmpControl, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, receiveModulationMode=receiveModulationMode, unitIdentification=unitIdentification, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, longitude=longitude, tDMInterfaceStatus=tDMInterfaceStatus, tdmTable=tdmTable, wirelessOutOctets=wirelessOutOctets, capacityVariantMismatchTrap=capacityVariantMismatchTrap, ptpTraps=ptpTraps, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, masterSlaveMode=masterSlaveMode, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, maximumTransmitPower=maximumTransmitPower, auxPortAllocation=auxPortAllocation, mainPSUPortQLRx=mainPSUPortQLRx, sFPPortSSMTx=sFPPortSSMTx, sFPPortDisabledWarning=sFPPortDisabledWarning, cableDiagPair2Results=cableDiagPair2Results, sFPPortAllocation=sFPPortAllocation, tFTPClient=tFTPClient, dataBridgingStatus=dataBridgingStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogControl=syslogControl, dfsMeans=dfsMeans, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mainPSUPortQLTx=mainPSUPortQLTx, auxPortQLTx=auxPortQLTx, unitName=unitName, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, groupID=groupID, deviceMACAddress=deviceMACAddress, cableLoss=cableLoss, dNSServerTableIndex=dNSServerTableIndex, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sNTPServerTableEntry=sNTPServerTableEntry, whitelistRMEnabled=whitelistRMEnabled, phyStatus=phyStatus, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, productVariant=productVariant, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, mgmtInstancedTable=mgmtInstancedTable, hTTPSAccessEnabled=hTTPSAccessEnabled, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, mABProtocolVID=mABProtocolVID, linkLoss=linkLoss, linkLossLinked=linkLossLinked, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dNSServerTableEntry=dNSServerTableEntry, rawReceivePower=rawReceivePower, authorizationControlTableEntry=authorizationControlTableEntry, portAllocationMismatchTrap=portAllocationMismatchTrap, installStatusLinked=installStatusLinked, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseTLSRekey=licenseTLSRekey, sMTPEmailAlert=sMTPEmailAlert, userEnabled=userEnabled, installStatus=installStatus, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, receiveModulationModeDetail=receiveModulationModeDetail, transmitModulationModeLinked=transmitModulationModeLinked, smtpGroup=smtpGroup, dNSServerPortNumber=dNSServerPortNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, cableDiagPair3Results=cableDiagPair3Results, licenseTrialPeriod=licenseTrialPeriod, oOBPriorityQueueMapping=oOBPriorityQueueMapping, authorizationMethod=authorizationMethod, licenseCapacity=licenseCapacity, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, unitOutOfCalibration=unitOutOfCalibration, maxLinkRangeExceeded=maxLinkRangeExceeded, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, wirelessOutAllOctets=wirelessOutAllOctets, ethernetGroup=ethernetGroup, bridgeGroup=bridgeGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, regulatoryBand=regulatoryBand, transmitPowerLinked=transmitPowerLinked, apc=apc, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, hTTPAccessEnabled=hTTPAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, configurationInstancedTableNumber=configurationInstancedTableNumber, subnetMask=subnetMask, dfsGroup=dfsGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, blacklistRMMacAddress=blacklistRMMacAddress, cableDiagPair1Distance=cableDiagPair1Distance, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, userPassword=userPassword, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementPriority=vLANManagementPriority, alarmInstancedTable=alarmInstancedTable, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseGasGroup=licenseGasGroup, licenseInstancedTableNumber=licenseInstancedTableNumber, cableDiagPair3Distance=cableDiagPair3Distance, cableDiagnosticsWarning=cableDiagnosticsWarning, ptp670=ptp670, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, hardwareVersion=hardwareVersion, smtp=smtp, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseRARSupport=licenseRARSupport, ethernetInstancedTable=ethernetInstancedTable, productName=productName, sntpGroup=sntpGroup, localPacketFiltering=localPacketFiltering, ethernetPriorityTableIndex=ethernetPriorityTableIndex, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, pubStatsGroup=pubStatsGroup, tDDControl=tDDControl, resetGroup=resetGroup, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, ptp=ptp, byteErrorRatio=byteErrorRatio, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, signalStrengthRatioLinked=signalStrengthRatioLinked, license=license, portAllocationMismatchLinked=portAllocationMismatchLinked, syncETracking=syncETracking, managementNetworkAccessEnabled=managementNetworkAccessEnabled, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, lbtDetectedTrap=lbtDetectedTrap, extendedSpectrumScanning=extendedSpectrumScanning, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, remoteUnitNameLinked=remoteUnitNameLinked, channelBandwidth=channelBandwidth, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, tDMEnabledChannels=tDMEnabledChannels, routerProtocols=routerProtocols, auxPortDisabledWarning=auxPortDisabledWarning)
