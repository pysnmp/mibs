...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", receivePower=receivePower, blacklistRMMacAddress=blacklistRMMacAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mainPSUPortQLTx=mainPSUPortQLTx, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, cableDiagPair1Distance=cableDiagPair1Distance, tDMChannelStatusTrap=tDMChannelStatusTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dfsGroup=dfsGroup, receiveModulationModeLinked=receiveModulationModeLinked, sNTPPrimaryServer=sNTPPrimaryServer, tdmTableEntry=tdmTableEntry, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, encryptionGroup=encryptionGroup, mainPSUPortQLRx=mainPSUPortQLRx, snmpControl=snmpControl, severelyErroredSeconds=severelyErroredSeconds, transmitModulationMode=transmitModulationMode, erroredSeconds=erroredSeconds, linkLossLinked=linkLossLinked, cambium=cambium, sNMPCommunityString=sNMPCommunityString, mABHoldoffPeriod=mABHoldoffPeriod, ethernetInstancedTableEntry=ethernetInstancedTableEntry, pubInstancedStatsTable=pubInstancedStatsTable, cableDiagPair4Distance=cableDiagPair4Distance, txColorCode=txColorCode, sNTPServerStatus=sNTPServerStatus, tdmTable=tdmTable, tDDSynchronizationMode=tDDSynchronizationMode, authorizationControlGroup=authorizationControlGroup, secureModeAlarmTrap=secureModeAlarmTrap, managementGroup=managementGroup, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, smtpGroup=smtpGroup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sFPPortQLTx=sFPPortQLTx, sNTPServerTableIndex=sNTPServerTableIndex, installArmStateTrap=installArmStateTrap, alarmInstancedTable=alarmInstancedTable, remoteInternetAddressLinked=remoteInternetAddressLinked, phyControlInstancedTableIndex=phyControlInstancedTableIndex, licenseSyncESupport=licenseSyncESupport, hTTPPortNumber=hTTPPortNumber, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tDMInterfaceControl=tDMInterfaceControl, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, licenseGroupAccess=licenseGroupAccess, mainPSUPortSSMTx=mainPSUPortSSMTx, mABProtocolVLANPriority=mABProtocolVLANPriority, capacityVariantMismatch=capacityVariantMismatch, iPVersion=iPVersion, rawReceivePowerLinked=rawReceivePowerLinked, rxColorCode=rxColorCode, alarmInstancedTableIndex=alarmInstancedTableIndex, sFPError=sFPError, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, cableDiagnosticsControl=cableDiagnosticsControl, groupID=groupID, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, notificationsGroup=notificationsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, cableDiagnosticsGroup=cableDiagnosticsGroup, sNTPPollInterval=sNTPPollInterval, snmpControlGroup=snmpControlGroup, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, pubStats=pubStats, linkModeOptimization=linkModeOptimization, telnetAccessEnabled=telnetAccessEnabled, rangeLinked=rangeLinked, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, sNMPTrapTable=sNMPTrapTable, sFPPortStatusTrap=sFPPortStatusTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, smtp=smtp, byteErrorRatioLinked=byteErrorRatioLinked, range=range, pubStatsGroup=pubStatsGroup, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, unitName=unitName, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, targetRange=targetRange, sNTPSync=sNTPSync, subnetMask=subnetMask, phyControlInstancedTable=phyControlInstancedTable, configurationInstancedTableNumber=configurationInstancedTableNumber, dataBridgingStatusLinked=dataBridgingStatusLinked, l2CPPriorityTableNumber=l2CPPriorityTableNumber, portAllocationMismatchTrap=portAllocationMismatchTrap, sNTPServerRetries=sNTPServerRetries, dfsPeaks=dfsPeaks, incompatibleRegulatoryBands=incompatibleRegulatoryBands, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, accessMethod=accessMethod, mainPSUPortStatus=mainPSUPortStatus, sNTPServerTimeout=sNTPServerTimeout, tempPcb=tempPcb, receiveDataRateLinked=receiveDataRateLinked, ethernetPriorityTableNumber=ethernetPriorityTableNumber, management=management, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNTPServerTable=sNTPServerTable, licenseIssueNumber=licenseIssueNumber, licenseSecurityLevel=licenseSecurityLevel, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, iPv4Address=iPv4Address, sMTPServerPortNumber=sMTPServerPortNumber, subbandLowestFrequency=subbandLowestFrequency, configuration=configuration, resetGroup=resetGroup, dfsTableNumber=dfsTableNumber, rangingMode=rangingMode, sNTPServerTableNumber=sNTPServerTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, subbandHighestFrequency=subbandHighestFrequency, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, authorizationControlTableEntry=authorizationControlTableEntry, deviceMACAddress=deviceMACAddress, secureModeAlarm=secureModeAlarm, regulatoryBand=regulatoryBand, syncETracking=syncETracking, syslogClient=syslogClient, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cableDiagnosticsWarning=cableDiagnosticsWarning, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, mABState=mABState, authorizationControl=authorizationControl, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseMaxLinkRange=licenseMaxLinkRange, dNSServerTableNumber=dNSServerTableNumber, remoteMACAddress=remoteMACAddress, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, ethernetInstancedTableNumber=ethernetInstancedTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sFPPortStatus=sFPPortStatus, licenseCapacity=licenseCapacity, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, cableDiagPair3Results=cableDiagPair3Results, sNTPServerTableEntry=sNTPServerTableEntry, maximumNumberOfSlaves=maximumNumberOfSlaves, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ptp670=ptp670, hTTPAccessEnabled=hTTPAccessEnabled, auxPortStatusTrap=auxPortStatusTrap, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, transmitFreqMHz=transmitFreqMHz, tDMChannelStatus=tDMChannelStatus, dNSServerPortNumber=dNSServerPortNumber, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ptmp=ptmp, timeZone=timeZone, daylightSaving=daylightSaving, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sMTPEmailAlert=sMTPEmailAlert, phyControl=phyControl, searchState=searchState, cableDiagPair3Distance=cableDiagPair3Distance, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mABNominalTransmitCapacity=mABNominalTransmitCapacity, bootVersion=bootVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, regulatoryBandTrap=regulatoryBandTrap, whitelistRMEnabled=whitelistRMEnabled, frequencyVariant=frequencyVariant, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, auxPortAllocation=auxPortAllocation, authorizationMethod=authorizationMethod, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, mABTransmissionInterval=mABTransmissionInterval, transmitChannel=transmitChannel, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, supplementaryGroup=supplementaryGroup, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerInternetAddress=sNTPServerInternetAddress, mgmtInstancedTableIndex=mgmtInstancedTableIndex, aggregateDataRateLinked=aggregateDataRateLinked, wirelessLinkStatusLinked=wirelessLinkStatusLinked, alarmInstancedTableEntry=alarmInstancedTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseInstancedTableIndex=licenseInstancedTableIndex, remoteUnitName=remoteUnitName, targetMACAddress=targetMACAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, l2CPPriorityTableEntry=l2CPPriorityTableEntry, auxPortDisabledWarning=auxPortDisabledWarning, apc=apc, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ethernetPriorityTableIndex=ethernetPriorityTableIndex, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, vectorError=vectorError, eIRP=eIRP, installStatus=installStatus, transparentClockPort=transparentClockPort, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, longitude=longitude, mPLSTCPriorityTable=mPLSTCPriorityTable, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ptpCompliance=ptpCompliance, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteMACAddressLinked=remoteMACAddressLinked, remoteUnitNameLinked=remoteUnitNameLinked, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, noWirelessChannelAvailable=noWirelessChannelAvailable, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sMTPServerInternetAddress=sMTPServerInternetAddress, phyStatus=phyStatus, cableDiagnosticsPorts=cableDiagnosticsPorts, apcGroup=apcGroup, receiveFreqMHz=receiveFreqMHz, hCMPMaximumLinkRange=hCMPMaximumLinkRange, phyControlInstancedTableEntry=phyControlInstancedTableEntry, transparentClock=transparentClock, phyControlGroup=phyControlGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sNMPTrapPortNumber=sNMPTrapPortNumber, nIDULanPortStatus=nIDULanPortStatus, ptpTraps=ptpTraps, tDMEnabledChannels=tDMEnabledChannels, nIDULanPortStatusTrap=nIDULanPortStatusTrap, supplementary=supplementary, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPSAccessEnabled=hTTPSAccessEnabled)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", syncETrackingState=syncETrackingState, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, blacklistRMEnabled=blacklistRMEnabled, auxPortSyncERxStatus=auxPortSyncERxStatus, sNTPState=sNTPState, tDDControl=tDDControl, iPv6Address=iPv6Address, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, oOBPriorityQueueMapping=oOBPriorityQueueMapping, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, bridge=bridge, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, dNSGroup=dNSGroup, packetsToInternalStack=packetsToInternalStack, receiveFreqKHz=receiveFreqKHz, licenseRegulatoryBandsList=licenseRegulatoryBandsList, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableDiagPair2Results=cableDiagPair2Results, syslogStateTrap=syslogStateTrap, sNTPLastSync=sNTPLastSync, syslogControlGroup=syslogControlGroup, configurationInstancedTableIndex=configurationInstancedTableIndex, rawReceivePower=rawReceivePower, vectorErrorLinked=vectorErrorLinked, remoteInternetAddressType=remoteInternetAddressType, softwareVersion=softwareVersion, ethernetInstancedTable=ethernetInstancedTable, licenseInstancedTableNumber=licenseInstancedTableNumber, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, portAllocationMismatch=portAllocationMismatch, enableTransmission=enableTransmission, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, alarmInstancedTableNumber=alarmInstancedTableNumber, mABProtocolVID=mABProtocolVID, phyControlInstancedTableNumber=phyControlInstancedTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableNumber=userTableNumber, configurationGroup=configurationGroup, sFPPortSSMTx=sFPPortSSMTx, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDMChannelLoopback=tDMChannelLoopback, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, mABMaintenanceLevel=mABMaintenanceLevel, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPClient=tFTPClient, transmitModulationModeLinked=transmitModulationModeLinked, dataBridgingStatus=dataBridgingStatus, dNSResolver=dNSResolver, sntpGroup=sntpGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseIEEE1588Support=licenseIEEE1588Support, ptpGroups=ptpGroups, sMTPEnabledMessages=sMTPEnabledMessages, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenseSFPPortSupport=licenseSFPPortSupport, dfsTable=dfsTable, vLANManagementPriority=vLANManagementPriority, tDMChannelLineCode=tDMChannelLineCode, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, linkSymmetry=linkSymmetry, unitIdentificationGroup=unitIdentificationGroup, ethernetInstancedTableIndex=ethernetInstancedTableIndex, mainPSUPortStatusTrap=mainPSUPortStatusTrap, userTable=userTable, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, dfsTableEntry=dfsTableEntry, alarmsGroup=alarmsGroup, encryptionAlgorithm=encryptionAlgorithm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, wirelessOutOctets=wirelessOutOctets, tDMInterfaceStatus=tDMInterfaceStatus, licenseEncryption=licenseEncryption, maxLinkRangeExceeded=maxLinkRangeExceeded, transmitDataRateLinked=transmitDataRateLinked, cableDiagnostics=cableDiagnostics, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseGasGroup=licenseGasGroup, dNSServerInternetAddressType=dNSServerInternetAddressType, managementNetworkAccessEnabled=managementNetworkAccessEnabled, syslogClientTrap=syslogClientTrap, sFPPortAutoMdix=sFPPortAutoMdix, userName=userName, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, licenseHCMPSupport=licenseHCMPSupport, sNMPTrapTableIndex=sNMPTrapTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, iPDSCPPriorityTable=iPDSCPPriorityTable, licenseVersion=licenseVersion, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, byteErrorRatio=byteErrorRatio, linkName=linkName, receiveDataRate=receiveDataRate, licenseIPv6Support=licenseIPv6Support, wirelessLinkAvailability=wirelessLinkAvailability, telnetPortNumber=telnetPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, signalStrengthRatio=signalStrengthRatio, tdmTableNumber=tdmTableNumber, licenseGroup=licenseGroup, ptp=ptp, dSCPManagementPriority=dSCPManagementPriority, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, installationMode=installationMode, sFPPortDisabledWarning=sFPPortDisabledWarning, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, phyStatusGroup=phyStatusGroup, mABNominalModulationMode=mABNominalModulationMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, receiveModulationMode=receiveModulationMode, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, aAAControlGroup=aAAControlGroup, routerProtocolsGroup=routerProtocolsGroup, dfsMeans=dfsMeans, gatewayIPAddress=gatewayIPAddress, syslogControl=syslogControl, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, lowestDataModulationMode=lowestDataModulationMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, syslogState=syslogState, ethernetStatisticsDataSource=ethernetStatisticsDataSource, licenseTrialPeriod=licenseTrialPeriod, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, lbtDetectedTrap=lbtDetectedTrap, ethernetGroup=ethernetGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dNSServerTableEntry=dNSServerTableEntry, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tDMChannelCableLength=tDMChannelCableLength, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, authorizationControlTableNumber=authorizationControlTableNumber, useVLANForMABProtocol=useVLANForMABProtocol, sNTPSyncTrap=sNTPSyncTrap, installStatusLinked=installStatusLinked, unitIdentification=unitIdentification, mgmtInstancedTableNumber=mgmtInstancedTableNumber, transmitPowerLinked=transmitPowerLinked, auxPortSSMTx=auxPortSSMTx, cableDiagPair2Distance=cableDiagPair2Distance, transparentClockVID=transparentClockVID, wirelessTopology=wirelessTopology, cableLoss=cableLoss, userPassword=userPassword, licenseTLSRekey=licenseTLSRekey, latitude=latitude, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, licenseUnitSerialNumber=licenseUnitSerialNumber, transmitPower=transmitPower, auxPortQLRx=auxPortQLRx, mgmtInstancedTableEntry=mgmtInstancedTableEntry, tdmTableIndex=tdmTableIndex, lowestTDMModulationMode=lowestTDMModulationMode, extendedSpectrumScanning=extendedSpectrumScanning, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, systemClock=systemClock, wirelessOutEthernetOctets=wirelessOutEthernetOctets, dataBridgingStatusAlarm=dataBridgingStatusAlarm, installArmState=installArmState, sFPPortAutoNegotiation=sFPPortAutoNegotiation, channelChangeTrap=channelChangeTrap, tDDControlGroup=tDDControlGroup, reset=reset, ethernet=ethernet, authorizationControlTable=authorizationControlTable, cableDiagPair1Results=cableDiagPair1Results, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, txMABFrames=txMABFrames, wirelessOutAllOctets=wirelessOutAllOctets, tDMGroup=tDMGroup, transparentClockVLAN=transparentClockVLAN, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, dNSServerTable=dNSServerTable, licenseInstancedTable=licenseInstancedTable, antennaGain=antennaGain, deviceESN=deviceESN, encryption=encryption, transmitFreqKHz=transmitFreqKHz, sFPErrorTrap=sFPErrorTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, dfs=dfs, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sFPPortAllocation=sFPPortAllocation, receivePowerLinked=receivePowerLinked, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, userRole=userRole, linkLoss=linkLoss, portAllocationMismatchLinked=portAllocationMismatchLinked, unavailableSeconds=unavailableSeconds, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, aggregateDataRate=aggregateDataRate, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, dfsTableIndex=dfsTableIndex, licenseRARSupport=licenseRARSupport, license=license, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, localPacketFiltering=localPacketFiltering, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, dNSPrimaryServer=dNSPrimaryServer, versionsGroup=versionsGroup, syncESlavePort=syncESlavePort, installStatusTrap=installStatusTrap, auxPortStatus=auxPortStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, dNSServerInternetAddress=dNSServerInternetAddress, bridgeGroup=bridgeGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mgmtInstancedTable=mgmtInstancedTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, authorizationControlTableIndex=authorizationControlTableIndex, configurationInstancedTableEntry=configurationInstancedTableEntry, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sFPPortQLRx=sFPPortQLRx, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, vLANManagementVID=vLANManagementVID, channelBandwidth=channelBandwidth, tDMConfigurationMismatch=tDMConfigurationMismatch, signalStrengthRatioLinked=signalStrengthRatioLinked, secondarySoftwareVersion=secondarySoftwareVersion, tDM=tDM, l2CPPriorityTable=l2CPPriorityTable, capacityVariantMismatchLinked=capacityVariantMismatchLinked, siteName=siteName, unitOutOfCalibration=unitOutOfCalibration, licenseCountry=licenseCountry, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, transmitDataRate=transmitDataRate, sNMPv3Enable=sNMPv3Enable, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, iPv6PrefixLength=iPv6PrefixLength, transmitterChannels=transmitterChannels, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, ethernetPriorityTable=ethernetPriorityTable, cableDiagPair4Results=cableDiagPair4Results, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, dNSServerTableIndex=dNSServerTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sntp=sntp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenseBandwidthCap=licenseBandwidthCap, configurationInstancedTable=configurationInstancedTable, ethernetStatisticsTable=ethernetStatisticsTable, userTableIndex=userTableIndex, syncEEquipmentClock=syncEEquipmentClock, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, alarms=alarms, userEnabled=userEnabled, dataPortPauseFrames=dataPortPauseFrames, auxPortQLTx=auxPortQLTx, packetsFromInternalStack=packetsFromInternalStack, remoteInternetAddress=remoteInternetAddress, systemReset=systemReset, phyInstancedStatusTable=phyInstancedStatusTable, deviceMSN=deviceMSN, antennaSelection=antennaSelection, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, hCMPLinkSymmetry=hCMPLinkSymmetry, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, auxPortConfigurationMismatch=auxPortConfigurationMismatch, ptpTrapPrefix=ptpTrapPrefix, searchStateLinked=searchStateLinked, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, maximumTransmitPower=maximumTransmitPower, routerProtocols=routerProtocols, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, sNMPTrapTableNumber=sNMPTrapTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, productName=productName, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, qOSPriorityScheme=qOSPriorityScheme, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, productVariant=productVariant, hTTPSPortNumber=hTTPSPortNumber, PYSNMP_MODULE_ID=cambium, aAAControl=aAAControl, sNMPPortNumber=sNMPPortNumber, hardwareVersion=hardwareVersion, dataBridgingAvailability=dataBridgingAvailability, altitude=altitude, dNS=dNS, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, whitelistRMMacAddress=whitelistRMMacAddress, receiveChannel=receiveChannel, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userTableEntry=userTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, versions=versions, remoteMaximumTransmitPower=remoteMaximumTransmitPower, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, masterSlaveMode=masterSlaveMode, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus)
