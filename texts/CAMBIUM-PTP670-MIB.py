...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", txMABFrames=txMABFrames, configurationGroup=configurationGroup, configurationInstancedTable=configurationInstancedTable, wirelessLinkStatus=wirelessLinkStatus, tFTPServerPortNumber=tFTPServerPortNumber, licenseInstancedTableIndex=licenseInstancedTableIndex, sFPPortStatus=sFPPortStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, PYSNMP_MODULE_ID=cambium, transmitModulationMode=transmitModulationMode, cableDiagnosticsResultTable=cableDiagnosticsResultTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, auxPortDisabledWarning=auxPortDisabledWarning, userTableNumber=userTableNumber, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, wirelessLinkAvailability=wirelessLinkAvailability, syslogClient=syslogClient, aAAControl=aAAControl, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, dfsTableEntry=dfsTableEntry, rangeLinked=rangeLinked, transparentClockPort=transparentClockPort, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, auxPortSSMTx=auxPortSSMTx, ptmp=ptmp, linkLossLinked=linkLossLinked, unitOutOfCalibration=unitOutOfCalibration, remoteInternetAddressType=remoteInternetAddressType, versionsGroup=versionsGroup, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userTableIndex=userTableIndex, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataBridgingStatusAlarm=dataBridgingStatusAlarm, capacityVariantMismatchLinked=capacityVariantMismatchLinked, dataPortPauseFrames=dataPortPauseFrames, tDMGroup=tDMGroup, ethernetInstancedTableIndex=ethernetInstancedTableIndex, transmitPowerLinked=transmitPowerLinked, frequencyVariant=frequencyVariant, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tDMInterfaceStatus=tDMInterfaceStatus, remoteInternetAddressLinked=remoteInternetAddressLinked, searchStateLinked=searchStateLinked, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sMTPEmailAlert=sMTPEmailAlert, dNSGroup=dNSGroup, bridge=bridge, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mABNominalModulationMode=mABNominalModulationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, rawReceivePower=rawReceivePower, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, alarmInstancedTableNumber=alarmInstancedTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hTTPAccessEnabled=hTTPAccessEnabled, tDMConfigurationMismatch=tDMConfigurationMismatch, transmitDataRateLinked=transmitDataRateLinked, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, syslogControlGroup=syslogControlGroup, whitelistRMMacAddress=whitelistRMMacAddress, groupID=groupID, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, siteName=siteName, aAAControlGroup=aAAControlGroup, remoteMACAddressLinked=remoteMACAddressLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, phyInstancedStatusTable=phyInstancedStatusTable, subnetMask=subnetMask, tdmTableEntry=tdmTableEntry, antennaGain=antennaGain, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, transparentClockVLAN=transparentClockVLAN, licenseEncryption=licenseEncryption, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ethernetInstancedTableNumber=ethernetInstancedTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mABState=mABState, capacityVariantMismatch=capacityVariantMismatch, alarmInstancedTableEntry=alarmInstancedTableEntry, licenseSFPPortSupport=licenseSFPPortSupport, auxPortQLRx=auxPortQLRx, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, extendedSpectrumScanning=extendedSpectrumScanning, searchState=searchState, signalStrengthRatioLinked=signalStrengthRatioLinked, enableTransmission=enableTransmission, cableDiagPair3Distance=cableDiagPair3Distance, productName=productName, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, license=license, cableDiagnosticsWarning=cableDiagnosticsWarning, userTable=userTable, licenseCountry=licenseCountry, sNTPServerTimeout=sNTPServerTimeout, smtp=smtp, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tDMInterfaceControl=tDMInterfaceControl, auxPortAllocation=auxPortAllocation, syslogState=syslogState, dfsTableNumber=dfsTableNumber, bridgeGroup=bridgeGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, phyControlInstancedTableIndex=phyControlInstancedTableIndex, phyControl=phyControl, transmitFreqKHz=transmitFreqKHz, resetGroup=resetGroup, byteErrorRatioLinked=byteErrorRatioLinked, dataBridgingAvailability=dataBridgingAvailability, licenseGroup=licenseGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, tFTPClient=tFTPClient, hardwareVersion=hardwareVersion, syncEEquipmentClock=syncEEquipmentClock, authorizationMethod=authorizationMethod, dSCPManagementPriority=dSCPManagementPriority, sFPPortAllocation=sFPPortAllocation, localPacketFiltering=localPacketFiltering, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, mainPSUPortSSMTx=mainPSUPortSSMTx, aggregateDataRateLinked=aggregateDataRateLinked, tDDSynchronizationStatus=tDDSynchronizationStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, receivePower=receivePower, deviceMSN=deviceMSN, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, phyControlInstancedTable=phyControlInstancedTable, alarms=alarms, dataBridgingStatusLinked=dataBridgingStatusLinked, sNMPv3Enable=sNMPv3Enable, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tDMChannelStatus=tDMChannelStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPPrimaryServer=sNTPPrimaryServer, tDMChannelStatusTrap=tDMChannelStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortQLTx=sFPPortQLTx, sNMPEnabledTraps=sNMPEnabledTraps, transmitModulationModeLinked=transmitModulationModeLinked, nIDULanPortStatusTrap=nIDULanPortStatusTrap, syncESlavePort=syncESlavePort, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, regulatoryBand=regulatoryBand, receiveModulationModeLinked=receiveModulationModeLinked, portAllocationMismatch=portAllocationMismatch, sFPPortStatusTrap=sFPPortStatusTrap, sNTPServerStatus=sNTPServerStatus, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, hTTPSPortNumber=hTTPSPortNumber, authorizationControlTable=authorizationControlTable, sNTPSync=sNTPSync, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mainPSUPortQLRx=mainPSUPortQLRx, licenseIPv6Support=licenseIPv6Support, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, iPDSCPPriorityTable=iPDSCPPriorityTable, deviceMACAddress=deviceMACAddress, sFPErrorTrap=sFPErrorTrap, dfsPeaks=dfsPeaks, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, dNSServerTableIndex=dNSServerTableIndex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, latitude=latitude, telnetAccessEnabled=telnetAccessEnabled, sNTPServerRetries=sNTPServerRetries, hTTPSAccessEnabled=hTTPSAccessEnabled, rangingMode=rangingMode, gatewayIPAddress=gatewayIPAddress, mainPSUPortQLTx=mainPSUPortQLTx, targetMACAddress=targetMACAddress, mgmtInstancedTableEntry=mgmtInstancedTableEntry, linkLoss=linkLoss, configurationInstancedTableIndex=configurationInstancedTableIndex, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, snmpControlGroup=snmpControlGroup, sNMPPortNumber=sNMPPortNumber, dataBridgingStatus=dataBridgingStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, auxPortStatus=auxPortStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, subbandLowestFrequency=subbandLowestFrequency, vectorErrorLinked=vectorErrorLinked, nIDULanPortStatus=nIDULanPortStatus, ptp670=ptp670, dNSServerTableNumber=dNSServerTableNumber, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ptp=ptp, routerProtocolsGroup=routerProtocolsGroup, sNTPServerPortNumber=sNTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, authorizationControlGroup=authorizationControlGroup, sFPPortQLRx=sFPPortQLRx, supplementary=supplementary, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userPassword=userPassword, tdmTable=tdmTable, tempPcb=tempPcb, blacklistRMEnabled=blacklistRMEnabled, licenseTLSRekey=licenseTLSRekey, sNTPState=sNTPState, iPv4Address=iPv4Address, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, packetsFromInternalStack=packetsFromInternalStack, authorizationControlTableEntry=authorizationControlTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, ethernet=ethernet, maxLinkRangeExceeded=maxLinkRangeExceeded, packetsToInternalStack=packetsToInternalStack, linkName=linkName, sFPPortDisabledWarning=sFPPortDisabledWarning, cableLoss=cableLoss, tFTPServerInternetAddress=tFTPServerInternetAddress, iPv6Address=iPv6Address, wirelessTopology=wirelessTopology, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mgmtInstancedTable=mgmtInstancedTable, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, useVLANForMABProtocol=useVLANForMABProtocol, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, installStatus=installStatus, blacklistRMMacAddress=blacklistRMMacAddress, authorizationControlTableIndex=authorizationControlTableIndex, tdmTableIndex=tdmTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, auxPortAcceptedQLRx=auxPortAcceptedQLRx, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", unitIdentificationGroup=unitIdentificationGroup, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, userRole=userRole, installArmStateTrap=installArmStateTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, encryptionAlgorithm=encryptionAlgorithm, transmitDataRate=transmitDataRate, dNSServerTable=dNSServerTable, secondarySoftwareVersion=secondarySoftwareVersion, licenseInstancedTableEntry=licenseInstancedTableEntry, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, routerProtocols=routerProtocols, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseCapacity=licenseCapacity, installStatusTrap=installStatusTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, installationMode=installationMode, versions=versions, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, configurationInstancedTableNumber=configurationInstancedTableNumber, sNTPLastSync=sNTPLastSync, mABProtocolVLANPriority=mABProtocolVLANPriority, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, management=management, whitelistRMEnabled=whitelistRMEnabled, unitIdentification=unitIdentification, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatus=phyStatus, l2CPPriorityTable=l2CPPriorityTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, receiveFreqMHz=receiveFreqMHz, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, ethernetPriorityTable=ethernetPriorityTable, altitude=altitude, installArmState=installArmState, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, notificationsGroup=notificationsGroup, sNMPCommunityString=sNMPCommunityString, maximumNumberOfSlaves=maximumNumberOfSlaves, cableDiagPair1Distance=cableDiagPair1Distance, range=range, snmpControl=snmpControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, authorizationControl=authorizationControl, l2CPPriorityTableIndex=l2CPPriorityTableIndex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, configurationInstancedTableEntry=configurationInstancedTableEntry, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, transmitPower=transmitPower, encryptionGroup=encryptionGroup, apcGroup=apcGroup, configuration=configuration, transmitFreqMHz=transmitFreqMHz, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sntpGroup=sntpGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, tDMChannelLoopback=tDMChannelLoopback, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, syncETracking=syncETracking, phyControlInstancedTableEntry=phyControlInstancedTableEntry, mgmtInstancedTableNumber=mgmtInstancedTableNumber, transmitChannel=transmitChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userEnabled=userEnabled, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sNTPServerTableEntry=sNTPServerTableEntry, tDDControlGroup=tDDControlGroup, hTTPPortNumber=hTTPPortNumber, deviceESN=deviceESN, unitName=unitName, rawReceivePowerLinked=rawReceivePowerLinked, sNTPServerTableIndex=sNTPServerTableIndex, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sFPPortSSMTx=sFPPortSSMTx, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseInstancedTable=licenseInstancedTable, qOSPriorityScheme=qOSPriorityScheme, channelChangeTrap=channelChangeTrap, cableDiagPair2Results=cableDiagPair2Results, cableDiagPair3Results=cableDiagPair3Results, licenseBandwidthCap=licenseBandwidthCap, userName=userName, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sFPPortAutoMdix=sFPPortAutoMdix, transparentClockVID=transparentClockVID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dNSPrimaryServer=dNSPrimaryServer, userTableEntry=userTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sFPError=sFPError, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, mABHoldoffPeriod=mABHoldoffPeriod, licenseSecurityLevel=licenseSecurityLevel, vLANManagementVID=vLANManagementVID, transparentClock=transparentClock, receiveDataRateLinked=receiveDataRateLinked, licenseSyncESupport=licenseSyncESupport, rxColorCode=rxColorCode, sNTPServerTableNumber=sNTPServerTableNumber, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mainPSUPortStatus=mainPSUPortStatus, mABProtocolVID=mABProtocolVID, cableDiagPair1Results=cableDiagPair1Results, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, ethernetInstancedTable=ethernetInstancedTable, mainPSUPortAllocation=mainPSUPortAllocation, nIDULanPortAutoMdix=nIDULanPortAutoMdix, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, pubStatsGroup=pubStatsGroup, sNTPPollInterval=sNTPPollInterval, wirelessOutAllOctets=wirelessOutAllOctets, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPVersion=iPVersion, tDDSynchronizationMode=tDDSynchronizationMode, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, receiveFreqKHz=receiveFreqKHz, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, portAllocationMismatchTrap=portAllocationMismatchTrap, remoteInternetAddress=remoteInternetAddress, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, pubStats=pubStats, ptpGroups=ptpGroups, remoteMACAddress=remoteMACAddress, cableDiagnosticsControl=cableDiagnosticsControl, pubInstancedStatsTable=pubInstancedStatsTable, sNMPTrapPortNumber=sNMPTrapPortNumber, linkSymmetry=linkSymmetry, cableDiagnosticsPorts=cableDiagnosticsPorts, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseIssueNumber=licenseIssueNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, encryption=encryption, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sNTPServerInternetAddress=sNTPServerInternetAddress, dNSServerPortNumber=dNSServerPortNumber, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, dNS=dNS, phyControlGroup=phyControlGroup, antennaSelection=antennaSelection, tDMEnabledChannels=tDMEnabledChannels, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, receiveChannel=receiveChannel, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dNSServerInternetAddressType=dNSServerInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mABMaintenanceLevel=mABMaintenanceLevel, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, licenseHCMPSupport=licenseHCMPSupport, receivePowerLinked=receivePowerLinked, licenseIEEE1588Support=licenseIEEE1588Support, cambium=cambium, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, productVariant=productVariant, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, byteErrorRatio=byteErrorRatio, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dNSServerInternetAddress=dNSServerInternetAddress, mABTransmissionInterval=mABTransmissionInterval, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tdmTableNumber=tdmTableNumber, licenseGroupAccess=licenseGroupAccess, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseMaxLinkRange=licenseMaxLinkRange, licenseInstancedTableNumber=licenseInstancedTableNumber, ethernetGroup=ethernetGroup, phyStatusGroup=phyStatusGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, channelBandwidth=channelBandwidth, longitude=longitude, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, targetRange=targetRange, receiveModulationModeDetail=receiveModulationModeDetail, dfsGroup=dfsGroup, syslogControl=syslogControl, iPv6PrefixLength=iPv6PrefixLength, softwareVersion=softwareVersion, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sMTPServerInternetAddressType=sMTPServerInternetAddressType, accessMethod=accessMethod, tDM=tDM, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteUnitName=remoteUnitName, dfsTable=dfsTable, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, receiveModulationMode=receiveModulationMode, portAllocationMismatchLinked=portAllocationMismatchLinked, lowestTDMModulationMode=lowestTDMModulationMode, daylightSaving=daylightSaving, ptpCompliance=ptpCompliance, receiveDataRate=receiveDataRate, alarmInstancedTable=alarmInstancedTable, sFPPortSyncERxStatus=sFPPortSyncERxStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, cableDiagPair2Distance=cableDiagPair2Distance, dNSResolver=dNSResolver, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, timeZone=timeZone, cableDiagPair4Results=cableDiagPair4Results, remoteUnitNameLinked=remoteUnitNameLinked, licenseTDDSyncSupport=licenseTDDSyncSupport, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, systemClock=systemClock, dNSServerTableEntry=dNSServerTableEntry, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, bootVersion=bootVersion, sntp=sntp, ptpTraps=ptpTraps, managementGroup=managementGroup, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, sNTPServerTable=sNTPServerTable, regulatoryBandTrap=regulatoryBandTrap, transmitterChannels=transmitterChannels, auxPortQLTx=auxPortQLTx, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tDDControl=tDDControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, vectorError=vectorError, syncETrackingState=syncETrackingState, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, installStatusLinked=installStatusLinked, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, hCMPMaximumLinkRange=hCMPMaximumLinkRange, tDMChannelCableLength=tDMChannelCableLength, supplementaryGroup=supplementaryGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dfsTableIndex=dfsTableIndex, authorizationControlTableNumber=authorizationControlTableNumber, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, lbtDetectedTrap=lbtDetectedTrap, eIRP=eIRP, wirelessOutEthernetOctets=wirelessOutEthernetOctets, erroredSeconds=erroredSeconds, dfsMeans=dfsMeans, cableDiagPair4Distance=cableDiagPair4Distance, linkModeOptimization=linkModeOptimization, licenseGasGroup=licenseGasGroup, txColorCode=txColorCode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, ethernetStatisticsTable=ethernetStatisticsTable, alarmsGroup=alarmsGroup, severelyErroredSeconds=severelyErroredSeconds, systemReset=systemReset, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseUnitSerialNumber=licenseUnitSerialNumber, apc=apc, wirelessOutOctets=wirelessOutOctets, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, secureModeAlarmTrap=secureModeAlarmTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, tDMChannelLineCode=tDMChannelLineCode, sNMPTrapTableNumber=sNMPTrapTableNumber, lowestDataModulationMode=lowestDataModulationMode, capacityVariantMismatchTrap=capacityVariantMismatchTrap, alarmInstancedTableIndex=alarmInstancedTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, cableDiagnostics=cableDiagnostics, unavailableSeconds=unavailableSeconds, telnetPortNumber=telnetPortNumber, licenseVersion=licenseVersion, reset=reset, auxPortSyncERxStatus=auxPortSyncERxStatus, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, syslogStateTrap=syslogStateTrap, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mgmtInstancedTableIndex=mgmtInstancedTableIndex, signalStrengthRatio=signalStrengthRatio, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseRARSupport=licenseRARSupport, secureModeAlarm=secureModeAlarm, sNTPSyncTrap=sNTPSyncTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mainPSUPortAutoMdix=mainPSUPortAutoMdix, maximumTransmitPower=maximumTransmitPower, dfs=dfs, auxPortStatusTrap=auxPortStatusTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseTrialPeriod=licenseTrialPeriod, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch)
