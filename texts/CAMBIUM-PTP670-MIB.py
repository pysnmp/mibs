...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mABNominalTransmitCapacity=mABNominalTransmitCapacity, transmitPowerLinked=transmitPowerLinked, transmitDataRate=transmitDataRate, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, nIDULanPortStatus=nIDULanPortStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, cableDiagnosticsPorts=cableDiagnosticsPorts, txMABFrames=txMABFrames, channelChangeTrap=channelChangeTrap, sFPPortDisabledWarning=sFPPortDisabledWarning, secureModeAlarmTrap=secureModeAlarmTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, subnetMask=subnetMask, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, authorizationControlTableNumber=authorizationControlTableNumber, remoteUnitName=remoteUnitName, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, productVariant=productVariant, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sNTPSync=sNTPSync, hCMPMaximumLinkRange=hCMPMaximumLinkRange, aAAControl=aAAControl, tFTPServerInternetAddressType=tFTPServerInternetAddressType, unavailableSeconds=unavailableSeconds, sNTPLastSync=sNTPLastSync, licenseSyncESupport=licenseSyncESupport, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, linkModeOptimization=linkModeOptimization, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sFPPortAutoMdix=sFPPortAutoMdix, installArmState=installArmState, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, licenseHCMPSupport=licenseHCMPSupport, sMTPEnabledMessages=sMTPEnabledMessages, mgmtInstancedTableEntry=mgmtInstancedTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receivePowerLinked=receivePowerLinked, sntp=sntp, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, ptp=ptp, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, tDDSynchronizationMode=tDDSynchronizationMode, userTable=userTable, hTTPPortNumber=hTTPPortNumber, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, dataBridgingAvailability=dataBridgingAvailability, dNSGroup=dNSGroup, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, capacityVariantMismatch=capacityVariantMismatch, alarmInstancedTableIndex=alarmInstancedTableIndex, license=license, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseGroup=licenseGroup, tDMGroup=tDMGroup, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, receiveModulationMode=receiveModulationMode, wirelessLinkStatusLinked=wirelessLinkStatusLinked, mainPSUPortQLTx=mainPSUPortQLTx, dfsTableIndex=dfsTableIndex, transmitFreqKHz=transmitFreqKHz, regulatoryBandTrap=regulatoryBandTrap, transparentClockPort=transparentClockPort, mainPSUPortQLRx=mainPSUPortQLRx, licenseGasGroup=licenseGasGroup, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mABProtocolVLANPriority=mABProtocolVLANPriority, mainPSUPortSSMTx=mainPSUPortSSMTx, encryption=encryption, cambium=cambium, masterSlaveMode=masterSlaveMode, dfsTable=dfsTable, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, blacklistRMMacAddress=blacklistRMMacAddress, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, notificationsGroup=notificationsGroup, sNTPServerPortNumber=sNTPServerPortNumber, transparentClockVID=transparentClockVID, dNSServerTableIndex=dNSServerTableIndex, linkLoss=linkLoss, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, licenseIPv6Support=licenseIPv6Support, siteName=siteName, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, configurationInstancedTableEntry=configurationInstancedTableEntry, wirelessTopology=wirelessTopology, resetGroup=resetGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, maximumTransmitPower=maximumTransmitPower, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, syslogControl=syslogControl, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, incompatibleRegulatoryBands=incompatibleRegulatoryBands, configurationInstancedTableIndex=configurationInstancedTableIndex, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapVersion=sNMPTrapVersion, userRole=userRole, licenseInstancedTable=licenseInstancedTable, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, hCMPLinkSymmetry=hCMPLinkSymmetry, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, receiveFreqMHz=receiveFreqMHz, licenseSFPPortSupport=licenseSFPPortSupport, smtpGroup=smtpGroup, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, phyControlInstancedTableNumber=phyControlInstancedTableNumber, rxColorCode=rxColorCode, syslogClient=syslogClient, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hardwareVersion=hardwareVersion, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, licenseSecurityLevel=licenseSecurityLevel, transmitterChannels=transmitterChannels, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, unitIdentificationGroup=unitIdentificationGroup, authorizationControlTableIndex=authorizationControlTableIndex, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, syslogStateTrap=syslogStateTrap, licenseIssueNumber=licenseIssueNumber, softwareVersion=softwareVersion, bridge=bridge, pubStats=pubStats, unitOutOfCalibration=unitOutOfCalibration, telnetAccessEnabled=telnetAccessEnabled, aAAControlGroup=aAAControlGroup, transparentClock=transparentClock, licenseInstancedTableEntry=licenseInstancedTableEntry, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, dNSServerTableNumber=dNSServerTableNumber, extendedSpectrumScanning=extendedSpectrumScanning, ethernetStatisticsTable=ethernetStatisticsTable, phyControlInstancedTable=phyControlInstancedTable, mainPSUPortAutoMdix=mainPSUPortAutoMdix, authorizationMethod=authorizationMethod, hTTPAccessEnabled=hTTPAccessEnabled, auxPortStatusTrap=auxPortStatusTrap, iPVersion=iPVersion, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, configurationInstancedTable=configurationInstancedTable, dNSPrimaryServer=dNSPrimaryServer, apc=apc, sNTPServerTableNumber=sNTPServerTableNumber, routerProtocolsGroup=routerProtocolsGroup, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, mainPSUPortStatus=mainPSUPortStatus, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, configurationGroup=configurationGroup, antennaSelection=antennaSelection, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, tDMChannelLineCode=tDMChannelLineCode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tDMEnabledChannels=tDMEnabledChannels, tDDControl=tDDControl, phyControlGroup=phyControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, timeZone=timeZone, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnosticsWarning=cableDiagnosticsWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetGroup=ethernetGroup, syncEEquipmentClock=syncEEquipmentClock, sNMPPortNumber=sNMPPortNumber, configurationInstancedTableNumber=configurationInstancedTableNumber, vLANManagementVID=vLANManagementVID, phyInstancedStatusTable=phyInstancedStatusTable, wirelessOutEthernetOctets=wirelessOutEthernetOctets, authorizationControlTable=authorizationControlTable, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, ethernetPriorityTable=ethernetPriorityTable, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseCapacity=licenseCapacity, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, cableLoss=cableLoss, mABTransmissionInterval=mABTransmissionInterval, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tdmTableEntry=tdmTableEntry, whitelistRMEnabled=whitelistRMEnabled, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, byteErrorRatioLinked=byteErrorRatioLinked, useVLANForMABProtocol=useVLANForMABProtocol, sNTPServerInternetAddress=sNTPServerInternetAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, antennaGain=antennaGain, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetInstancedTableIndex=ethernetInstancedTableIndex, tdmTableIndex=tdmTableIndex, sNTPSyncTrap=sNTPSyncTrap, searchState=searchState, cableDiagnostics=cableDiagnostics, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, supplementaryGroup=supplementaryGroup, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, daylightSaving=daylightSaving, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDMChannelCableLength=tDMChannelCableLength, dataBridgingStatusAlarm=dataBridgingStatusAlarm, lowestTDMModulationMode=lowestTDMModulationMode, sNTPState=sNTPState, deviceMACAddress=deviceMACAddress, phyControl=phyControl, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTable=sNMPTrapTable, auxPortStatus=auxPortStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, iPv4Address=iPv4Address, licenseVersion=licenseVersion, syncETracking=syncETracking, transmitModulationModeLinked=transmitModulationModeLinked, userTableNumber=userTableNumber, packetsToInternalStack=packetsToInternalStack, iPDSCPPriorityTable=iPDSCPPriorityTable, sFPPortAutoNegotiation=sFPPortAutoNegotiation, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, syncESlavePort=syncESlavePort, receiveChannel=receiveChannel, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityTableNumber=ethernetPriorityTableNumber, receiveModulationModeLinked=receiveModulationModeLinked, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, receiveModulationModeDetail=receiveModulationModeDetail, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkAvailability=wirelessLinkAvailability, secondarySoftwareVersion=secondarySoftwareVersion, frequencyVariant=frequencyVariant)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", remoteInternetAddress=remoteInternetAddress, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, productName=productName, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, range=range, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, phyStatus=phyStatus, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, licenseTrialPeriod=licenseTrialPeriod, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseTDDSyncSupport=licenseTDDSyncSupport, sFPErrorTrap=sFPErrorTrap, sFPPortQLTx=sFPPortQLTx, tDMChannelLoopback=tDMChannelLoopback, lowestDataModulationMode=lowestDataModulationMode, syslogClientTrap=syslogClientTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, userTableIndex=userTableIndex, licenseInstancedTableNumber=licenseInstancedTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, dfsTableEntry=dfsTableEntry, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, rawReceivePowerLinked=rawReceivePowerLinked, dNSServerPortNumber=dNSServerPortNumber, configuration=configuration, cableDiagnosticsGroup=cableDiagnosticsGroup, searchStateLinked=searchStateLinked, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, managementGroup=managementGroup, tDMConfigurationMismatch=tDMConfigurationMismatch, aggregateDataRate=aggregateDataRate, userTableEntry=userTableEntry, dfsGroup=dfsGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, ptpTraps=ptpTraps, capacityVariantMismatchTrap=capacityVariantMismatchTrap, unitIdentification=unitIdentification, dNSServerTable=dNSServerTable, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, byteErrorRatio=byteErrorRatio, tDMInterfaceControl=tDMInterfaceControl, cableDiagPair2Distance=cableDiagPair2Distance, installationMode=installationMode, reset=reset, sNTPServerTableEntry=sNTPServerTableEntry, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, transmitDataRateLinked=transmitDataRateLinked, longitude=longitude, ethernetPriorityTableEntry=ethernetPriorityTableEntry, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, ptpGroups=ptpGroups, tdmTable=tdmTable, sMTPServerPortNumber=sMTPServerPortNumber, cableDiagPair3Results=cableDiagPair3Results, sNTPServerTable=sNTPServerTable, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, supplementary=supplementary, cableDiagPair4Results=cableDiagPair4Results, ptp670=ptp670, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, auxPortSSMTx=auxPortSSMTx, rangingMode=rangingMode, installArmStateTrap=installArmStateTrap, sFPPortStatus=sFPPortStatus, targetRange=targetRange, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDMChannelStatus=tDMChannelStatus, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cableDiagPair4Distance=cableDiagPair4Distance, rangeLinked=rangeLinked, auxPortAllocation=auxPortAllocation, smtp=smtp, versionsGroup=versionsGroup, pubInstancedStatsTable=pubInstancedStatsTable, licenseIEEE1588Support=licenseIEEE1588Support, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerTableIndex=sNTPServerTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installStatus=installStatus, sFPPortAllocation=sFPPortAllocation, noWirelessChannelAvailable=noWirelessChannelAvailable, erroredSeconds=erroredSeconds, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sNTPServerStatus=sNTPServerStatus, receiveDataRateLinked=receiveDataRateLinked, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rawReceivePower=rawReceivePower, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortQLRx=auxPortQLRx, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPv6GatewayAddress=iPv6GatewayAddress, snmpControlGroup=snmpControlGroup, altitude=altitude, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vectorErrorLinked=vectorErrorLinked, licenseInstancedTableIndex=licenseInstancedTableIndex, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, tFTPServerInternetAddress=tFTPServerInternetAddress, linkLossLinked=linkLossLinked, mainPSUPortAllocation=mainPSUPortAllocation, iPv6Address=iPv6Address, unitName=unitName, syslogState=syslogState, channelBandwidth=channelBandwidth, l2CPPriorityTable=l2CPPriorityTable, dfs=dfs, dataBridgingStatusLinked=dataBridgingStatusLinked, pubStatsGroup=pubStatsGroup, capacityVariantMismatchLinked=capacityVariantMismatchLinked, versions=versions, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sNMPEnabledTraps=sNMPEnabledTraps, remoteUnitNameLinked=remoteUnitNameLinked, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, secureModeAlarm=secureModeAlarm, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, regulatoryBand=regulatoryBand, enableTransmission=enableTransmission, licenseRARSupport=licenseRARSupport, ethernet=ethernet, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, lbtDetectedTrap=lbtDetectedTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, auxPortQLTx=auxPortQLTx, remoteInternetAddressType=remoteInternetAddressType, mgmtInstancedTableNumber=mgmtInstancedTableNumber, authorizationControlTableEntry=authorizationControlTableEntry, transmitModulationMode=transmitModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, accessMethod=accessMethod, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, ptpTrapPrefix=ptpTrapPrefix, authorizationControl=authorizationControl, vectorError=vectorError, cableDiagnosticsControl=cableDiagnosticsControl, alarmInstancedTableEntry=alarmInstancedTableEntry, sFPPortQLRx=sFPPortQLRx, severelyErroredSeconds=severelyErroredSeconds, iPv6PrefixLength=iPv6PrefixLength, whitelistRMMacAddress=whitelistRMMacAddress, encryptionAlgorithm=encryptionAlgorithm, dNS=dNS, l2CPPriorityTableEntry=l2CPPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, dataPortPauseFrames=dataPortPauseFrames, mainPSUPortStatusTrap=mainPSUPortStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receiveFreqKHz=receiveFreqKHz, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, alarmInstancedTable=alarmInstancedTable, latitude=latitude, mgmtInstancedTable=mgmtInstancedTable, tDMChannelStatusTrap=tDMChannelStatusTrap, mABMaintenanceLevel=mABMaintenanceLevel, userEnabled=userEnabled, sFPError=sFPError, nIDULanPortStatusTrap=nIDULanPortStatusTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseBandwidthCap=licenseBandwidthCap, subbandHighestFrequency=subbandHighestFrequency, tempPcb=tempPcb, signalStrengthRatioLinked=signalStrengthRatioLinked, phyStatusGroup=phyStatusGroup, licenseTLSRekey=licenseTLSRekey, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseEncryption=licenseEncryption, deviceMSN=deviceMSN, syncETrackingState=syncETrackingState, tDM=tDM, sNTPServerRetries=sNTPServerRetries, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, groupID=groupID, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, remoteMACAddress=remoteMACAddress, sNMPv3Enable=sNMPv3Enable, portAllocationMismatch=portAllocationMismatch, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, telnetPortNumber=telnetPortNumber, systemClock=systemClock, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, remoteInternetAddressLinked=remoteInternetAddressLinked, bootVersion=bootVersion, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, installStatusLinked=installStatusLinked, sNTPServerTimeout=sNTPServerTimeout, ptmp=ptmp, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cableDiagPair2Results=cableDiagPair2Results, routerProtocols=routerProtocols, tFTPClient=tFTPClient, sFPPortSSMTx=sFPPortSSMTx, wirelessOutAllOctets=wirelessOutAllOctets, deviceESN=deviceESN, linkName=linkName, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, qOSPriorityScheme=qOSPriorityScheme, wirelessLinkStatus=wirelessLinkStatus, ethernetInstancedTable=ethernetInstancedTable, alarms=alarms, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sFPPortStatusTrap=sFPPortStatusTrap, dataBridgingStatus=dataBridgingStatus, mgmtInstancedTableIndex=mgmtInstancedTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseCountry=licenseCountry, alarmInstancedTableNumber=alarmInstancedTableNumber, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, snmpControl=snmpControl, dNSResolver=dNSResolver, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ethernetStatisticsDataSource=ethernetStatisticsDataSource, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dNSServerTableEntry=dNSServerTableEntry, management=management, txColorCode=txColorCode, wirelessOutOctets=wirelessOutOctets, mABProtocolVID=mABProtocolVID, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, alarmsGroup=alarmsGroup, dfsMeans=dfsMeans, vLANManagementPriority=vLANManagementPriority)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", apcGroup=apcGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptpCompliance=ptpCompliance, dNSServerInternetAddress=dNSServerInternetAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPCommunityString=sNMPCommunityString, auxPortDisabledWarning=auxPortDisabledWarning, licenseOOBManagementSupport=licenseOOBManagementSupport, dNSServerInternetAddressType=dNSServerInternetAddressType, subbandLowestFrequency=subbandLowestFrequency, transmitChannel=transmitChannel, localPacketFiltering=localPacketFiltering, licenseRegulatoryBandsList=licenseRegulatoryBandsList, linkSymmetry=linkSymmetry, userPassword=userPassword, remoteMACAddressLinked=remoteMACAddressLinked, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, dSCPManagementPriority=dSCPManagementPriority, licenseGroupAccess=licenseGroupAccess, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, eIRP=eIRP, tFTPServerPortNumber=tFTPServerPortNumber, installStatusTrap=installStatusTrap, aggregateDataRateLinked=aggregateDataRateLinked, transparentClockVLAN=transparentClockVLAN, receivePower=receivePower, transmitPower=transmitPower, dfsPeaks=dfsPeaks, phyControlInstancedTableIndex=phyControlInstancedTableIndex, packetsFromInternalStack=packetsFromInternalStack, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mABNominalModulationMode=mABNominalModulationMode, tdmTableNumber=tdmTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, maximumNumberOfSlaves=maximumNumberOfSlaves, blacklistRMEnabled=blacklistRMEnabled, cableDiagPair1Distance=cableDiagPair1Distance, mABState=mABState, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, authorizationControlGroup=authorizationControlGroup, transmitFreqMHz=transmitFreqMHz, portAllocationMismatchLinked=portAllocationMismatchLinked, targetMACAddress=targetMACAddress, ethernetInstancedTableNumber=ethernetInstancedTableNumber, mABHoldoffPeriod=mABHoldoffPeriod, sntpGroup=sntpGroup, licenseUnitSerialNumber=licenseUnitSerialNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, PYSNMP_MODULE_ID=cambium, userName=userName, bridgeGroup=bridgeGroup, receiveDataRate=receiveDataRate, syslogControlGroup=syslogControlGroup, cableDiagPair3Distance=cableDiagPair3Distance, tDMInterfaceStatus=tDMInterfaceStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, portAllocationMismatchTrap=portAllocationMismatchTrap, cableDiagPair1Results=cableDiagPair1Results)
