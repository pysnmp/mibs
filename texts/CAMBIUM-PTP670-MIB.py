...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseInstancedTableIndex=licenseInstancedTableIndex, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, tDMChannelCableLength=tDMChannelCableLength, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, hTTPSPortNumber=hTTPSPortNumber, dSCPManagementPriority=dSCPManagementPriority, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, nIDULanPortStatusTrap=nIDULanPortStatusTrap, aAAControl=aAAControl, tDM=tDM, timeZone=timeZone, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPErrorTrap=sFPErrorTrap, dNSServerTableIndex=dNSServerTableIndex, tDMChannelLoopback=tDMChannelLoopback, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationMode=tDDSynchronizationMode, licenseSecurityLevel=licenseSecurityLevel, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, signalStrengthRatio=signalStrengthRatio, bootVersion=bootVersion, productVariant=productVariant, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, aggregateDataRateLinked=aggregateDataRateLinked, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, auxPortAllocation=auxPortAllocation, gatewayIPAddress=gatewayIPAddress, configuration=configuration, auxPortDisabledWarning=auxPortDisabledWarning, licenseTrialPeriod=licenseTrialPeriod, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseInstancedTable=licenseInstancedTable, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, userRole=userRole, licenseCountry=licenseCountry, tFTPClient=tFTPClient, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, systemClock=systemClock, transmitterChannels=transmitterChannels, byteErrorRatioLinked=byteErrorRatioLinked, dNSResolver=dNSResolver, ethernetInstancedTableEntry=ethernetInstancedTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, cableDiagPair4Distance=cableDiagPair4Distance, auxPortSSMTx=auxPortSSMTx, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, alarmInstancedTableNumber=alarmInstancedTableNumber, snmpControl=snmpControl, sNTPServerTable=sNTPServerTable, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, deviceESN=deviceESN, phyControlInstancedTableEntry=phyControlInstancedTableEntry, dataBridgingStatus=dataBridgingStatus, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, apcGroup=apcGroup, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, authorizationMethod=authorizationMethod, regulatoryBand=regulatoryBand, syncETrackingState=syncETrackingState, licenseCapacity=licenseCapacity, whitelistRMMacAddress=whitelistRMMacAddress, regulatoryBandTrap=regulatoryBandTrap, management=management, tFTPServerPortNumber=tFTPServerPortNumber, secureModeAlarm=secureModeAlarm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, searchStateLinked=searchStateLinked, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sNTPServerTableIndex=sNTPServerTableIndex, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, authorizationControlTableIndex=authorizationControlTableIndex, receiveFreqMHz=receiveFreqMHz, remoteUnitName=remoteUnitName, syncETracking=syncETracking, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, encryption=encryption, l2CPPriorityTableIndex=l2CPPriorityTableIndex, syslogClientTrap=syslogClientTrap, receivePowerLinked=receivePowerLinked, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, vectorErrorLinked=vectorErrorLinked, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, auxPortAcceptedQLRx=auxPortAcceptedQLRx, phyStatusGroup=phyStatusGroup, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mgmtInstancedTable=mgmtInstancedTable, iPv6Address=iPv6Address, licenseSFPPortSupport=licenseSFPPortSupport, resetGroup=resetGroup, transmitPower=transmitPower, tDDControlGroup=tDDControlGroup, license=license, ethernetInstancedTableIndex=ethernetInstancedTableIndex, installationMode=installationMode, snmpControlGroup=snmpControlGroup, extendedSpectrumScanning=extendedSpectrumScanning, phyInstancedStatusTable=phyInstancedStatusTable, configurationInstancedTable=configurationInstancedTable, mainPSUPortSSMTx=mainPSUPortSSMTx, rangingMode=rangingMode, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, remoteInternetAddressLinked=remoteInternetAddressLinked, linkLossLinked=linkLossLinked, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, wirelessOutEthernetOctets=wirelessOutEthernetOctets, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, configurationInstancedTableNumber=configurationInstancedTableNumber, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, userPassword=userPassword, unitOutOfCalibration=unitOutOfCalibration, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, channelBandwidth=channelBandwidth, ptp=ptp, systemReset=systemReset, cableDiagPair3Distance=cableDiagPair3Distance, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, deviceMACAddress=deviceMACAddress, useVLANForMABProtocol=useVLANForMABProtocol, dNSServerInternetAddressType=dNSServerInternetAddressType, dfsTableIndex=dfsTableIndex, configurationGroup=configurationGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, transmitChannel=transmitChannel, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tdmTableIndex=tdmTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mABProtocolVLANPriority=mABProtocolVLANPriority, wirelessLinkAvailability=wirelessLinkAvailability, altitude=altitude, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, tDMInterfaceStatus=tDMInterfaceStatus, cambium=cambium, txColorCode=txColorCode, pubStats=pubStats, sNTPLastSync=sNTPLastSync, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sMTPServerPortNumber=sMTPServerPortNumber, lbtDetectedTrap=lbtDetectedTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNMPTrapTable=sNMPTrapTable, phyControlInstancedTableIndex=phyControlInstancedTableIndex, mABNominalTransmitCapacity=mABNominalTransmitCapacity, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, whitelistRMEnabled=whitelistRMEnabled, hTTPAccessEnabled=hTTPAccessEnabled, syslogControlGroup=syslogControlGroup, wirelessOutAllOctets=wirelessOutAllOctets, transmitFreqKHz=transmitFreqKHz, sFPError=sFPError, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, licenseOOBManagementSupport=licenseOOBManagementSupport, receiveDataRate=receiveDataRate, cableDiagPair1Results=cableDiagPair1Results, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, wirelessTopology=wirelessTopology, mABHoldoffPeriod=mABHoldoffPeriod, ethernetInstancedTable=ethernetInstancedTable, transparentClockVID=transparentClockVID, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, packetsFromInternalStack=packetsFromInternalStack, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, aAAControlGroup=aAAControlGroup, licenseVersion=licenseVersion, auxPortConfigurationMismatch=auxPortConfigurationMismatch, iPv6PrefixLength=iPv6PrefixLength, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receivePower=receivePower, sNMPTrapVersion=sNMPTrapVersion, vLANManagementPriority=vLANManagementPriority, licenseIssueNumber=licenseIssueNumber, severelyErroredSeconds=severelyErroredSeconds, versionsGroup=versionsGroup, lowestTDMModulationMode=lowestTDMModulationMode, dfsPeaks=dfsPeaks, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, userEnabled=userEnabled, ptp670=ptp670, smtpGroup=smtpGroup, unavailableSeconds=unavailableSeconds, rawReceivePowerLinked=rawReceivePowerLinked, useVLANForManagementInterfaces=useVLANForManagementInterfaces, auxPortQLTx=auxPortQLTx, installStatusLinked=installStatusLinked, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sNTPServerRetries=sNTPServerRetries, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, PYSNMP_MODULE_ID=cambium, dataPortPauseFrames=dataPortPauseFrames, alarmInstancedTableIndex=alarmInstancedTableIndex, ethernetStatisticsTable=ethernetStatisticsTable, sNMPCommunityString=sNMPCommunityString, sFPPortDisabledWarning=sFPPortDisabledWarning, dataBridgingStatusAlarm=dataBridgingStatusAlarm, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, antennaGain=antennaGain, apc=apc, rxColorCode=rxColorCode, transmitModulationMode=transmitModulationMode, smtp=smtp, receiveModulationModeDetail=receiveModulationModeDetail, dNS=dNS, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, tdmTable=tdmTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, eIRP=eIRP, phyControl=phyControl, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, phyControlInstancedTableNumber=phyControlInstancedTableNumber, syncEEquipmentClock=syncEEquipmentClock, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, transparentClock=transparentClock, pubInstancedStatsTable=pubInstancedStatsTable, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, ethernetStatisticsDataSource=ethernetStatisticsDataSource, auxPortSyncERxStatus=auxPortSyncERxStatus, notificationsGroup=notificationsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, subbandLowestFrequency=subbandLowestFrequency, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mainPSUPortQLTx=mainPSUPortQLTx, tDMEnabledChannels=tDMEnabledChannels, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, dfs=dfs, licenseHCMPSupport=licenseHCMPSupport, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, wirelessOutOctets=wirelessOutOctets, dNSServerTableEntry=dNSServerTableEntry, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, masterSlaveMode=masterSlaveMode, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mgmtInstancedTableNumber=mgmtInstancedTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, licenseIEEE1588Support=licenseIEEE1588Support, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteInternetAddressType=remoteInternetAddressType, sFPPortStatus=sFPPortStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, authorizationControlTableEntry=authorizationControlTableEntry, channelChangeTrap=channelChangeTrap, reset=reset, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, alarmsGroup=alarmsGroup, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortQLRx=auxPortQLRx, targetMACAddress=targetMACAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetPriorityTable=ethernetPriorityTable, dfsGroup=dfsGroup, syncESlavePort=syncESlavePort, licenseMaxLinkRange=licenseMaxLinkRange, auxPortStatus=auxPortStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, telnetPortNumber=telnetPortNumber, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, vLANManagementVID=vLANManagementVID, dNSGroup=dNSGroup, mainPSUPortAllocation=mainPSUPortAllocation, sFPPortQLRx=sFPPortQLRx, licenseUnitSerialNumber=licenseUnitSerialNumber, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, iPv6GatewayAddress=iPv6GatewayAddress, remoteUnitNameLinked=remoteUnitNameLinked, phyControlInstancedTable=phyControlInstancedTable, mABTransmissionInterval=mABTransmissionInterval, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, transparentClockPort=transparentClockPort, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, authorizationControlTableNumber=authorizationControlTableNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, installArmState=installArmState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, enableTransmission=enableTransmission, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, linkName=linkName, wirelessLinkStatus=wirelessLinkStatus, receiveDataRateLinked=receiveDataRateLinked, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sFPPortAutoMdix=sFPPortAutoMdix, mainPSUPortAutoMdix=mainPSUPortAutoMdix, hardwareVersion=hardwareVersion, searchState=searchState, ethernetInstancedTableNumber=ethernetInstancedTableNumber, ptmp=ptmp, wirelessLinkStatusLinked=wirelessLinkStatusLinked, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, userTableIndex=userTableIndex, versions=versions, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tDMChannelStatus=tDMChannelStatus, bridge=bridge, blacklistRMMacAddress=blacklistRMMacAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitDataRate=transmitDataRate, hCMPLinkSymmetry=hCMPLinkSymmetry, dNSServerTableNumber=dNSServerTableNumber, licenseGasGroup=licenseGasGroup, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, latitude=latitude, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, userTable=userTable, antennaSelection=antennaSelection, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, unitName=unitName, licenseInstancedTableEntry=licenseInstancedTableEntry, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, nIDULanPortStatus=nIDULanPortStatus, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, signalStrengthRatioLinked=signalStrengthRatioLinked, portAllocationMismatchLinked=portAllocationMismatchLinked, mABNominalModulationMode=mABNominalModulationMode, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, transmitPowerLinked=transmitPowerLinked, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, portAllocationMismatch=portAllocationMismatch, cableLoss=cableLoss, oOBPriorityQueueMapping=oOBPriorityQueueMapping, maximumTransmitPower=maximumTransmitPower, phyStatus=phyStatus, remoteInternetAddress=remoteInternetAddress, encryptionAlgorithm=encryptionAlgorithm, deviceMSN=deviceMSN, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mABState=mABState, phyControlGroup=phyControlGroup, userTableEntry=userTableEntry, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, daylightSaving=daylightSaving, tDMGroup=tDMGroup, alarms=alarms, remoteMACAddressLinked=remoteMACAddressLinked, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, managementGroup=managementGroup, linkModeOptimization=linkModeOptimization, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, cableDiagPair2Results=cableDiagPair2Results, sNTPSyncTrap=sNTPSyncTrap, sntp=sntp, cableDiagPair3Results=cableDiagPair3Results, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, cableDiagPair4Results=cableDiagPair4Results, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, lowestDataModulationMode=lowestDataModulationMode, mABProtocolVID=mABProtocolVID, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, supplementary=supplementary, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, routerProtocolsGroup=routerProtocolsGroup, mainPSUPortQLRx=mainPSUPortQLRx, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, vectorError=vectorError, cableDiagPair2Distance=cableDiagPair2Distance, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernet=ethernet, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, remoteMaximumTransmitPower=remoteMaximumTransmitPower, byteErrorRatio=byteErrorRatio, cableDiagnosticsResultTable=cableDiagnosticsResultTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sFPPortSSMTx=sFPPortSSMTx, transmitModulationModeLinked=transmitModulationModeLinked, hCMPMaximumLinkRange=hCMPMaximumLinkRange, dfsMeans=dfsMeans, receiveModulationMode=receiveModulationMode, remoteMACAddress=remoteMACAddress, sNMPv3Enable=sNMPv3Enable, cableDiagnosticsControl=cableDiagnosticsControl, tDDControl=tDDControl, configurationInstancedTableEntry=configurationInstancedTableEntry, transparentClockVLAN=transparentClockVLAN, tdmTableNumber=tdmTableNumber, licenseInstancedTableNumber=licenseInstancedTableNumber, blacklistRMEnabled=blacklistRMEnabled, ethernetGroup=ethernetGroup, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, routerProtocols=routerProtocols, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, iPDSCPPriorityTable=iPDSCPPriorityTable, authorizationControlTable=authorizationControlTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, secondarySoftwareVersion=secondarySoftwareVersion, bridgeGroup=bridgeGroup, sNMPPortNumber=sNMPPortNumber, userTableNumber=userTableNumber, rawReceivePower=rawReceivePower, pubStatsGroup=pubStatsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseGroupAccess=licenseGroupAccess, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNTPServerTableNumber=sNTPServerTableNumber, receiveModulationModeLinked=receiveModulationModeLinked, unitIdentification=unitIdentification, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNTPServerStatus=sNTPServerStatus, capacityVariantMismatch=capacityVariantMismatch, ptpCompliance=ptpCompliance, licenseGroup=licenseGroup, sFPPortStatusTrap=sFPPortStatusTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, txMABFrames=txMABFrames, tdmTableEntry=tdmTableEntry, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, cableDiagPair1Distance=cableDiagPair1Distance, sNTPSync=sNTPSync, dNSServerTable=dNSServerTable, linkSymmetry=linkSymmetry, targetRange=targetRange, unitIdentificationGroup=unitIdentificationGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseTDDSyncSupport=licenseTDDSyncSupport, maxLinkRangeExceeded=maxLinkRangeExceeded, sMTPServerInternetAddress=sMTPServerInternetAddress, installStatus=installStatus, dfsTableEntry=dfsTableEntry, alarmInstancedTable=alarmInstancedTable, accessMethod=accessMethod, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortWirelessDownAlert=managementPortWirelessDownAlert, frequencyVariant=frequencyVariant, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, installArmStateTrap=installArmStateTrap, packetsToInternalStack=packetsToInternalStack, licenseBandwidthCap=licenseBandwidthCap, tempPcb=tempPcb, softwareVersion=softwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, longitude=longitude, alarmInstancedTableEntry=alarmInstancedTableEntry, range=range, rangeLinked=rangeLinked, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, tDMInterfaceControl=tDMInterfaceControl, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, dNSServerInternetAddress=dNSServerInternetAddress, authorizationControl=authorizationControl, transmitDataRateLinked=transmitDataRateLinked, iPVersion=iPVersion, syslogControl=syslogControl, dfsTable=dfsTable, sFPPortQLTx=sFPPortQLTx, productName=productName, syslogStateTrap=syslogStateTrap, dNSPrimaryServer=dNSPrimaryServer, cableDiagnosticsWarning=cableDiagnosticsWarning, ptpGroups=ptpGroups, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, supplementaryGroup=supplementaryGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, mABMaintenanceLevel=mABMaintenanceLevel, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, sMTPServerInternetAddressType=sMTPServerInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, sNTPPollInterval=sNTPPollInterval, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ptpTraps=ptpTraps, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataBridgingAvailability=dataBridgingAvailability, sntpGroup=sntpGroup, aggregateDataRate=aggregateDataRate, syslogState=syslogState, sNTPServerInternetAddress=sNTPServerInternetAddress, capacityVariantMismatchLinked=capacityVariantMismatchLinked, tDMConfigurationMismatch=tDMConfigurationMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sFPPortAllocation=sFPPortAllocation, receiveFreqKHz=receiveFreqKHz, sNMPEnabledTraps=sNMPEnabledTraps, ptpTrapPrefix=ptpTrapPrefix, tDMChannelStatusTrap=tDMChannelStatusTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, telnetAccessEnabled=telnetAccessEnabled, authorizationControlGroup=authorizationControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hTTPPortNumber=hTTPPortNumber, dataBridgingStatusLinked=dataBridgingStatusLinked, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sMTPEmailAlert=sMTPEmailAlert, licenseSyncESupport=licenseSyncESupport, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDMChannelLineCode=tDMChannelLineCode, cableDiagnosticsPorts=cableDiagnosticsPorts, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseEncryption=licenseEncryption, licenseTLSRekey=licenseTLSRekey, cableDiagnostics=cableDiagnostics, installStatusTrap=installStatusTrap, syslogClient=syslogClient, linkLoss=linkLoss, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, dNSServerPortNumber=dNSServerPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, tFTPServerInternetAddress=tFTPServerInternetAddress, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, dfsTableNumber=dfsTableNumber, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, transmitFreqMHz=transmitFreqMHz, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseRARSupport=licenseRARSupport, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveChannel=receiveChannel, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNTPServerTableEntry=sNTPServerTableEntry, sNTPState=sNTPState, subbandHighestFrequency=subbandHighestFrequency, groupID=groupID, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mainPSUPortStatus=mainPSUPortStatus, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, auxPortStatusTrap=auxPortStatusTrap, siteName=siteName, userName=userName, licenseIPv6Support=licenseIPv6Support, iPv4Address=iPv4Address, erroredSeconds=erroredSeconds, sNTPServerTimeout=sNTPServerTimeout, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, portAllocationMismatchTrap=portAllocationMismatchTrap, localPacketFiltering=localPacketFiltering, encryptionGroup=encryptionGroup)
