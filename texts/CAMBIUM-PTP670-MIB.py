...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, extendedSpectrumScanning=extendedSpectrumScanning, wirelessLinkStatus=wirelessLinkStatus, lowestDataModulationMode=lowestDataModulationMode, sNMPCommunityString=sNMPCommunityString, sNMPTrapTable=sNMPTrapTable, notificationsGroup=notificationsGroup, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, dNS=dNS, receivePowerLinked=receivePowerLinked, pubInstancedStatsTable=pubInstancedStatsTable, sNTPLastSync=sNTPLastSync, managementNetworkAccessEnabled=managementNetworkAccessEnabled, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mABHoldoffPeriod=mABHoldoffPeriod, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, masterSlaveMode=masterSlaveMode, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, iPv6Address=iPv6Address, linkLoss=linkLoss, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, mainPSUPortQLTx=mainPSUPortQLTx, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sMTPEmailAlert=sMTPEmailAlert, configurationInstancedTableNumber=configurationInstancedTableNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, transmitDataRate=transmitDataRate, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, installStatus=installStatus, tDMInterfaceControl=tDMInterfaceControl, byteErrorRatio=byteErrorRatio, iPv6PrefixLength=iPv6PrefixLength, licenseVersion=licenseVersion, dfs=dfs, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseMaxLinkRange=licenseMaxLinkRange, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mgmtInstancedTableEntry=mgmtInstancedTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transparentClock=transparentClock, apcGroup=apcGroup, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sntpGroup=sntpGroup, tdmTableNumber=tdmTableNumber, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataBridgingStatus=dataBridgingStatus, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sFPPortAllocation=sFPPortAllocation, supplementaryGroup=supplementaryGroup, auxPortSyncERxStatus=auxPortSyncERxStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, pubStatsGroup=pubStatsGroup, hCMPLinkSymmetry=hCMPLinkSymmetry, auxPortQLTx=auxPortQLTx, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelChangeTrap=channelChangeTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tDMInterfaceStatus=tDMInterfaceStatus, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tDMEnabledChannels=tDMEnabledChannels, subbandLowestFrequency=subbandLowestFrequency, capacityVariantMismatchLinked=capacityVariantMismatchLinked, sFPPortQLTx=sFPPortQLTx, remoteInternetAddress=remoteInternetAddress, remoteInternetAddressLinked=remoteInternetAddressLinked, vLANManagementPriority=vLANManagementPriority, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sFPPortQLRx=sFPPortQLRx, auxPortQLRx=auxPortQLRx, aggregateDataRate=aggregateDataRate, phyControlInstancedTableIndex=phyControlInstancedTableIndex, linkModeOptimization=linkModeOptimization, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, authorizationControlTable=authorizationControlTable, dNSServerPortNumber=dNSServerPortNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseTLSRekey=licenseTLSRekey, transmitModulationModeLinked=transmitModulationModeLinked, auxPortSSMTx=auxPortSSMTx, versionsGroup=versionsGroup, licenseCountry=licenseCountry, licenseInstancedTable=licenseInstancedTable, sMTPServerPortNumber=sMTPServerPortNumber, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, range=range, sMTPServerInternetAddressType=sMTPServerInternetAddressType, bootVersion=bootVersion, userName=userName, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, cambium=cambium, severelyErroredSeconds=severelyErroredSeconds, licenseTrialPeriod=licenseTrialPeriod, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sFPPortSyncERxStatus=sFPPortSyncERxStatus, transmitChannel=transmitChannel, alarmInstancedTableEntry=alarmInstancedTableEntry, smtpGroup=smtpGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, systemReset=systemReset, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, useVLANForMABProtocol=useVLANForMABProtocol, sntp=sntp, packetsToInternalStack=packetsToInternalStack, sNTPSync=sNTPSync, nIDULanPortAutoMdix=nIDULanPortAutoMdix, mainPSUPortAutoMdix=mainPSUPortAutoMdix, txColorCode=txColorCode, regulatoryBand=regulatoryBand, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, rawReceivePowerLinked=rawReceivePowerLinked, lowestTDMModulationMode=lowestTDMModulationMode, cableDiagPair3Distance=cableDiagPair3Distance, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, transmitDataRateLinked=transmitDataRateLinked, tDDControlGroup=tDDControlGroup, licenseIPv6Support=licenseIPv6Support, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sFPError=sFPError, userTable=userTable, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tDDSynchronizationMode=tDDSynchronizationMode, cableDiagPair2Distance=cableDiagPair2Distance, configurationInstancedTable=configurationInstancedTable, byteErrorRatioLinked=byteErrorRatioLinked, tdmTableIndex=tdmTableIndex, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseBandwidthCap=licenseBandwidthCap, syncEEquipmentClock=syncEEquipmentClock, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, installArmState=installArmState, licenseSyncESupport=licenseSyncESupport, sNTPServerTable=sNTPServerTable, localPacketFiltering=localPacketFiltering, receiveFreqKHz=receiveFreqKHz, authorizationControl=authorizationControl, tdmTableEntry=tdmTableEntry, linkSymmetry=linkSymmetry, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, alarmInstancedTable=alarmInstancedTable, nIDULanPortStatus=nIDULanPortStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, iPVersion=iPVersion, sMTPServerInternetAddress=sMTPServerInternetAddress, aggregateDataRateLinked=aggregateDataRateLinked, vLANManagementVID=vLANManagementVID, phyStatus=phyStatus, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, auxPortAcceptedQLRx=auxPortAcceptedQLRx, subbandHighestFrequency=subbandHighestFrequency, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, latitude=latitude, maxLinkRangeExceeded=maxLinkRangeExceeded, productVariant=productVariant, mABProtocolVLANPriority=mABProtocolVLANPriority, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, accessMethod=accessMethod, phyControlGroup=phyControlGroup, tDMGroup=tDMGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, unavailableSeconds=unavailableSeconds, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, ethernetStatisticsTable=ethernetStatisticsTable, deviceMSN=deviceMSN, tFTPServerPortNumber=tFTPServerPortNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, syncETrackingState=syncETrackingState, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetStatisticsDataSource=ethernetStatisticsDataSource, mABTransmissionInterval=mABTransmissionInterval, cableDiagPair2Results=cableDiagPair2Results, tDDControl=tDDControl, cableDiagPair3Results=cableDiagPair3Results, alarmInstancedTableIndex=alarmInstancedTableIndex, telnetAccessEnabled=telnetAccessEnabled, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, wirelessOutAllOctets=wirelessOutAllOctets, deviceESN=deviceESN, authorizationControlTableIndex=authorizationControlTableIndex, erroredSeconds=erroredSeconds, dNSPrimaryServer=dNSPrimaryServer, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, blacklistRMMacAddress=blacklistRMMacAddress, dNSServerTableEntry=dNSServerTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, regulatoryBandTrap=regulatoryBandTrap, syslogClientTrap=syslogClientTrap, dNSServerTableNumber=dNSServerTableNumber, tempPcb=tempPcb, licenseGroupAccess=licenseGroupAccess, vectorError=vectorError, phyControl=phyControl, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, dfsTableIndex=dfsTableIndex, transmitPower=transmitPower, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, telnetPortNumber=telnetPortNumber, targetMACAddress=targetMACAddress, secureModeAlarm=secureModeAlarm, sFPPortStatus=sFPPortStatus, licenseEncryption=licenseEncryption, unitName=unitName, authorizationMethod=authorizationMethod, mainPSUPortStatusTrap=mainPSUPortStatusTrap, tdmTable=tdmTable, transmitPowerLinked=transmitPowerLinked, systemClock=systemClock, management=management, auxPortStatusTrap=auxPortStatusTrap, siteName=siteName, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ptp=ptp, userTableEntry=userTableEntry, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, snmpControlGroup=snmpControlGroup, iPv4Address=iPv4Address, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNTPServerStatus=sNTPServerStatus, configuration=configuration, sNMPTrapTableNumber=sNMPTrapTableNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, productName=productName, oOBPriorityQueueMapping=oOBPriorityQueueMapping, wirelessOutOctets=wirelessOutOctets)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", remoteUnitNameLinked=remoteUnitNameLinked, installationMode=installationMode, syslogState=syslogState, dNSServerInternetAddressType=dNSServerInternetAddressType, configurationInstancedTableEntry=configurationInstancedTableEntry, sNTPServerRetries=sNTPServerRetries, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, wirelessLinkStatusLinked=wirelessLinkStatusLinked, licenseHCMPSupport=licenseHCMPSupport, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, wirelessTopology=wirelessTopology, channelBandwidth=channelBandwidth, mABNominalModulationMode=mABNominalModulationMode, sFPPortStatusTrap=sFPPortStatusTrap, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mgmtInstancedTableNumber=mgmtInstancedTableNumber, hCMPMaximumLinkRange=hCMPMaximumLinkRange, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, phyInstancedStatusTable=phyInstancedStatusTable, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, secureModeAlarmTrap=secureModeAlarmTrap, remoteMACAddressLinked=remoteMACAddressLinked, auxPortStatus=auxPortStatus, auxPortConfigurationMismatch=auxPortConfigurationMismatch, rangeLinked=rangeLinked, useVLANForManagementInterfaces=useVLANForManagementInterfaces, apc=apc, searchStateLinked=searchStateLinked, frequencyVariant=frequencyVariant, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, tDMChannelLoopback=tDMChannelLoopback, license=license, mgmtInstancedTable=mgmtInstancedTable, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, dNSGroup=dNSGroup, mABProtocolVID=mABProtocolVID, pubStats=pubStats, tFTPServerInternetAddressType=tFTPServerInternetAddressType, wirelessOutEthernetOctets=wirelessOutEthernetOctets, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, ethernetInstancedTableIndex=ethernetInstancedTableIndex, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, phyControlInstancedTable=phyControlInstancedTable, tDMChannelStatus=tDMChannelStatus, mgmtInstancedTableIndex=mgmtInstancedTableIndex, portAllocationMismatchLinked=portAllocationMismatchLinked, ptmp=ptmp, l2CPPriorityTable=l2CPPriorityTable, transparentClockPort=transparentClockPort, tDMConfigurationMismatch=tDMConfigurationMismatch, incompatibleRegulatoryBands=incompatibleRegulatoryBands, cableDiagnostics=cableDiagnostics, sNMPPortNumber=sNMPPortNumber, smtp=smtp, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, transmitModulationMode=transmitModulationMode, timeZone=timeZone, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, tFTPClient=tFTPClient, rxColorCode=rxColorCode, capacityVariantMismatch=capacityVariantMismatch, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseTDDSyncSupport=licenseTDDSyncSupport, rangingMode=rangingMode, tDM=tDM, gatewayIPAddress=gatewayIPAddress, sFPPortAutoNegotiation=sFPPortAutoNegotiation, cableDiagnosticsWarning=cableDiagnosticsWarning, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, hTTPPortNumber=hTTPPortNumber, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, linkLossLinked=linkLossLinked, sNTPServerTableNumber=sNTPServerTableNumber, tDMChannelStatusTrap=tDMChannelStatusTrap, alarmInstancedTableNumber=alarmInstancedTableNumber, tDMChannelLineCode=tDMChannelLineCode, rawReceivePower=rawReceivePower, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, deviceMACAddress=deviceMACAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, syncESlavePort=syncESlavePort, cableDiagnosticsControl=cableDiagnosticsControl, daylightSaving=daylightSaving, auxPortAllocation=auxPortAllocation, authorizationControlTableEntry=authorizationControlTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseInstancedTableEntry=licenseInstancedTableEntry, antennaSelection=antennaSelection, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, userTableNumber=userTableNumber, configurationGroup=configurationGroup, aAAControl=aAAControl, mainPSUPortQLRx=mainPSUPortQLRx, altitude=altitude, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, whitelistRMEnabled=whitelistRMEnabled, syslogControlGroup=syslogControlGroup, userRole=userRole, longitude=longitude, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sFPPortAutoMdix=sFPPortAutoMdix, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, userPassword=userPassword, versions=versions, PYSNMP_MODULE_ID=cambium, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sFPPortDisabledWarning=sFPPortDisabledWarning, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, dfsTable=dfsTable, dfsPeaks=dfsPeaks, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mABState=mABState, dataBridgingStatusLinked=dataBridgingStatusLinked, cableDiagnosticsGroup=cableDiagnosticsGroup, installStatusTrap=installStatusTrap, dfsTableEntry=dfsTableEntry, routerProtocols=routerProtocols, licenseIEEE1588Support=licenseIEEE1588Support, receiveDataRateLinked=receiveDataRateLinked, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetGroup=ethernetGroup, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, txMABFrames=txMABFrames, l2CPPriorityTableIndex=l2CPPriorityTableIndex, transparentClockVID=transparentClockVID, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, licenseCapacity=licenseCapacity, licenseUnitSerialNumber=licenseUnitSerialNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogStateTrap=syslogStateTrap, ethernetInstancedTable=ethernetInstancedTable, sNTPServerTimeout=sNTPServerTimeout, packetsFromInternalStack=packetsFromInternalStack, phyControlInstancedTableEntry=phyControlInstancedTableEntry, userEnabled=userEnabled, iPv6GatewayAddress=iPv6GatewayAddress, dataBridgingAvailability=dataBridgingAvailability, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, targetRange=targetRange, dNSServerTable=dNSServerTable, softwareVersion=softwareVersion, licenseGasGroup=licenseGasGroup, mainPSUPortAllocation=mainPSUPortAllocation, unitIdentification=unitIdentification, sNMPv3Enable=sNMPv3Enable, receiveModulationModeLinked=receiveModulationModeLinked, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, aAAControlGroup=aAAControlGroup, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseOOBManagementSupport=licenseOOBManagementSupport, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, cableLoss=cableLoss, sNTPServerTableIndex=sNTPServerTableIndex, dfsMeans=dfsMeans, tDMChannelCableLength=tDMChannelCableLength, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sFPErrorTrap=sFPErrorTrap, ethernetInstancedTableEntry=ethernetInstancedTableEntry, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, hTTPSPortNumber=hTTPSPortNumber, encryptionAlgorithm=encryptionAlgorithm, linkName=linkName, installArmStateTrap=installArmStateTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseSFPPortSupport=licenseSFPPortSupport, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPSyncTrap=sNTPSyncTrap, portAllocationMismatchTrap=portAllocationMismatchTrap, ethernet=ethernet, signalStrengthRatioLinked=signalStrengthRatioLinked, dataBridgingStatusAlarm=dataBridgingStatusAlarm, qOSPriorityScheme=qOSPriorityScheme, remoteMACAddress=remoteMACAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, supplementary=supplementary, dSCPManagementPriority=dSCPManagementPriority, auxPortDisabledWarning=auxPortDisabledWarning, alarmsGroup=alarmsGroup, ptpTrapPrefix=ptpTrapPrefix, enableTransmission=enableTransmission, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, alarms=alarms, cableDiagPair1Results=cableDiagPair1Results, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, whitelistRMMacAddress=whitelistRMMacAddress, blacklistRMEnabled=blacklistRMEnabled, transparentClockVLAN=transparentClockVLAN, authorizationControlGroup=authorizationControlGroup, sNTPServerTableEntry=sNTPServerTableEntry, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveChannel=receiveChannel, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, dataPortPauseFrames=dataPortPauseFrames, nIDULanPortStatusTrap=nIDULanPortStatusTrap, syncETracking=syncETracking, dfsGroup=dfsGroup, configurationInstancedTableIndex=configurationInstancedTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, ptp670=ptp670, snmpControl=snmpControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mABMaintenanceLevel=mABMaintenanceLevel, lbtDetectedTrap=lbtDetectedTrap, phyControlInstancedTableNumber=phyControlInstancedTableNumber, routerProtocolsGroup=routerProtocolsGroup, groupID=groupID, authorizationControlTableNumber=authorizationControlTableNumber, cableDiagPair1Distance=cableDiagPair1Distance, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, signalStrengthRatio=signalStrengthRatio, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitterChannels=transmitterChannels, userTableIndex=userTableIndex, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, portAllocationMismatch=portAllocationMismatch, mainPSUPortStatus=mainPSUPortStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNTPServerPortNumber=sNTPServerPortNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, eIRP=eIRP, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseInstancedTableNumber=licenseInstancedTableNumber, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, reset=reset, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ptpTraps=ptpTraps)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseRARSupport=licenseRARSupport, ethernetPriorityTable=ethernetPriorityTable, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, ptpCompliance=ptpCompliance, syslogClient=syslogClient, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vectorErrorLinked=vectorErrorLinked, hardwareVersion=hardwareVersion, sNMPEnabledTraps=sNMPEnabledTraps, receiveFreqMHz=receiveFreqMHz, maximumNumberOfSlaves=maximumNumberOfSlaves, licenseInstancedTableIndex=licenseInstancedTableIndex, phyStatusGroup=phyStatusGroup, dNSServerInternetAddress=dNSServerInternetAddress, dfsTableNumber=dfsTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ptpGroups=ptpGroups, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, receiveModulationModeDetail=receiveModulationModeDetail, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNMPTrapVersion=sNMPTrapVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dNSServerTableIndex=dNSServerTableIndex, installStatusLinked=installStatusLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch, subnetMask=subnetMask, receiveModulationMode=receiveModulationMode, licenseGroup=licenseGroup, managementGroup=managementGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, encryptionGroup=encryptionGroup, remoteUnitName=remoteUnitName, unitIdentificationGroup=unitIdentificationGroup, resetGroup=resetGroup, bridgeGroup=bridgeGroup, sFPPortSSMTx=sFPPortSSMTx, syslogControl=syslogControl, licenseIssueNumber=licenseIssueNumber, receivePower=receivePower, searchState=searchState, receiveDataRate=receiveDataRate, sNTPState=sNTPState, licenseSecurityLevel=licenseSecurityLevel, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, encryption=encryption, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, cableDiagPair4Results=cableDiagPair4Results, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, remoteInternetAddressType=remoteInternetAddressType, transmitFreqKHz=transmitFreqKHz, cableDiagnosticsResultTable=cableDiagnosticsResultTable, bridge=bridge, maximumTransmitPower=maximumTransmitPower, antennaGain=antennaGain, unitOutOfCalibration=unitOutOfCalibration, dNSResolver=dNSResolver, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm)
