...
Bits, NotificationType, Integer32, enterprises, Unsigned32, MibIdentifier, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, iso, Counter32, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Integer32", "enterprises", "Unsigned32", "MibIdentifier", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "iso", "Counter32", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", phyInstancedStatusTable=phyInstancedStatusTable, licenseGroupAccess=licenseGroupAccess, erroredSeconds=erroredSeconds, productVariant=productVariant, linkName=linkName, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseInstancedTableIndex=licenseInstancedTableIndex, syncESlavePort=syncESlavePort, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ethernetPriorityTable=ethernetPriorityTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tempPcb=tempPcb, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, qOSPriorityScheme=qOSPriorityScheme, sFPPortAllocation=sFPPortAllocation, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataBridgingStatusAlarm=dataBridgingStatusAlarm, hTTPPortNumber=hTTPPortNumber, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerTableEntry=sNTPServerTableEntry, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, mABTransmissionInterval=mABTransmissionInterval, sFPPortQLRx=sFPPortQLRx, bridgeGroup=bridgeGroup, searchState=searchState, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mABState=mABState, wirelessTopology=wirelessTopology, nIDULanPortAutoMdix=nIDULanPortAutoMdix, hCMPLinkSymmetry=hCMPLinkSymmetry, mABHoldoffPeriod=mABHoldoffPeriod, tdmTableEntry=tdmTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, remoteInternetAddress=remoteInternetAddress, vLANManagementPriority=vLANManagementPriority, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hCMPMaximumLinkRange=hCMPMaximumLinkRange, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sFPError=sFPError, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, tDMGroup=tDMGroup, sMTPEmailAlert=sMTPEmailAlert, iPv4Address=iPv4Address, auxPortQLTx=auxPortQLTx, supplementary=supplementary, versions=versions, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, pubStats=pubStats, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, l2CPPriorityTable=l2CPPriorityTable, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, byteErrorRatioLinked=byteErrorRatioLinked, sFPPortDisabledWarning=sFPPortDisabledWarning, searchStateLinked=searchStateLinked, auxPortAllocation=auxPortAllocation, accessMethod=accessMethod, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, installStatusLinked=installStatusLinked, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, versionsGroup=versionsGroup, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, nIDULanPortStatus=nIDULanPortStatus, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, bridge=bridge, phyControlInstancedTable=phyControlInstancedTable, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseSFPPortSupport=licenseSFPPortSupport, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, licenseTDDSyncSupport=licenseTDDSyncSupport, portAllocationMismatchTrap=portAllocationMismatchTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, channelBandwidth=channelBandwidth, maximumTransmitPower=maximumTransmitPower, notificationsGroup=notificationsGroup, sNTPServerPortNumber=sNTPServerPortNumber, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseRegulatoryBandsList=licenseRegulatoryBandsList, altitude=altitude, mABProtocolVLANPriority=mABProtocolVLANPriority, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleRegulatoryBands=incompatibleRegulatoryBands, whitelistRMMacAddress=whitelistRMMacAddress, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseBandwidthCap=licenseBandwidthCap, auxPortDisabledWarning=auxPortDisabledWarning, reset=reset, dataBridgingStatus=dataBridgingStatus, remoteMACAddressLinked=remoteMACAddressLinked, supplementaryGroup=supplementaryGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, deviceMACAddress=deviceMACAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, transparentClock=transparentClock, tDMInterfaceStatus=tDMInterfaceStatus, mgmtInstancedTableEntry=mgmtInstancedTableEntry, receiveDataRate=receiveDataRate, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, tDMChannelStatus=tDMChannelStatus, linkSymmetry=linkSymmetry, auxPortStatusTrap=auxPortStatusTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, ptpCompliance=ptpCompliance, wirelessLinkAvailability=wirelessLinkAvailability, ethernetInstancedTableNumber=ethernetInstancedTableNumber, capacityVariantMismatchLinked=capacityVariantMismatchLinked, txColorCode=txColorCode, transparentClockVLAN=transparentClockVLAN, packetsFromInternalStack=packetsFromInternalStack, txMABFrames=txMABFrames, authorizationControlTableEntry=authorizationControlTableEntry, licenseHCMPSupport=licenseHCMPSupport, dNSGroup=dNSGroup, iPv6PrefixLength=iPv6PrefixLength, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTableIndex=userTableIndex, remoteMACAddress=remoteMACAddress, cableLoss=cableLoss, unitOutOfCalibration=unitOutOfCalibration, ptp670=ptp670, eIRP=eIRP, dNSServerTable=dNSServerTable, transmitPowerLinked=transmitPowerLinked, dataBridgingStatusLinked=dataBridgingStatusLinked, sFPPortQLTx=sFPPortQLTx, dNSResolver=dNSResolver, tDDSynchronizationMode=tDDSynchronizationMode, licenseGroup=licenseGroup, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, dataPortPauseFrames=dataPortPauseFrames, masterSlaveMode=masterSlaveMode, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, gatewayIPAddress=gatewayIPAddress, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, mainPSUPortAllocation=mainPSUPortAllocation, sFPPortSyncERxStatus=sFPPortSyncERxStatus, wirelessOutOctets=wirelessOutOctets, managementPortWirelessDownAlert=managementPortWirelessDownAlert, wirelessOutEthernetOctets=wirelessOutEthernetOctets, auxPortSSMTx=auxPortSSMTx, transmitFreqKHz=transmitFreqKHz, transmitPower=transmitPower, capacityVariantMismatch=capacityVariantMismatch, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, authorizationControlGroup=authorizationControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDControlGroup=tDDControlGroup, sFPPortStatus=sFPPortStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, alarmInstancedTableEntry=alarmInstancedTableEntry, dSCPManagementPriority=dSCPManagementPriority, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dNSServerTableEntry=dNSServerTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptmp=ptmp, capacityVariantMismatchTrap=capacityVariantMismatchTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, useVLANForMABProtocol=useVLANForMABProtocol, phyControlInstancedTableIndex=phyControlInstancedTableIndex, licenseSecurityLevel=licenseSecurityLevel, maxLinkRangeExceeded=maxLinkRangeExceeded, mABProtocolVID=mABProtocolVID, licenseCountry=licenseCountry, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sFPPortStatusTrap=sFPPortStatusTrap, linkLossLinked=linkLossLinked, sNMPCommunityString=sNMPCommunityString, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpTraps=ptpTraps, tDMChannelCableLength=tDMChannelCableLength, sFPPortAutoMdix=sFPPortAutoMdix, aggregateDataRateLinked=aggregateDataRateLinked, remoteUnitNameLinked=remoteUnitNameLinked, rangingMode=rangingMode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, alarmInstancedTable=alarmInstancedTable, sNMPTrapPortNumber=sNMPTrapPortNumber, deviceESN=deviceESN, tDM=tDM, cableDiagPair4Distance=cableDiagPair4Distance, sNMPPortNumber=sNMPPortNumber, dfsTable=dfsTable, sNTPServerTableNumber=sNTPServerTableNumber, phyControlInstancedTableEntry=phyControlInstancedTableEntry, blacklistRMEnabled=blacklistRMEnabled, ethernetInstancedTable=ethernetInstancedTable, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseIEEE1588Support=licenseIEEE1588Support, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, antennaSelection=antennaSelection, configurationGroup=configurationGroup, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, receivePowerLinked=receivePowerLinked, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, phyStatusGroup=phyStatusGroup, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, alarmInstancedTableNumber=alarmInstancedTableNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, ptpGroups=ptpGroups, syncETracking=syncETracking, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, rawReceivePowerLinked=rawReceivePowerLinked, licenseIssueNumber=licenseIssueNumber, channelChangeTrap=channelChangeTrap, configurationInstancedTableIndex=configurationInstancedTableIndex, userTable=userTable, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, transmitDataRate=transmitDataRate, pubStatsGroup=pubStatsGroup, transparentClockVID=transparentClockVID, transmitModulationModeLinked=transmitModulationModeLinked, tDMInterfaceControl=tDMInterfaceControl, sNTPServerTimeout=sNTPServerTimeout, mABMaintenanceLevel=mABMaintenanceLevel, transparentClockPort=transparentClockPort, antennaGain=antennaGain, licenseMaxLinkRange=licenseMaxLinkRange, remoteUnitName=remoteUnitName, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, mgmtInstancedTableNumber=mgmtInstancedTableNumber, syncEEquipmentClock=syncEEquipmentClock, vLANManagementVID=vLANManagementVID, targetMACAddress=targetMACAddress, dfsTableIndex=dfsTableIndex, aAAControlGroup=aAAControlGroup, unitIdentification=unitIdentification, linkLoss=linkLoss, regulatoryBand=regulatoryBand, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", configuration=configuration, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, licenseCapacity=licenseCapacity, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, subnetMask=subnetMask, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetStatisticsTable=ethernetStatisticsTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfs=dfs, licenseRARSupport=licenseRARSupport, authorizationControl=authorizationControl, frequencyVariant=frequencyVariant, timeZone=timeZone, dataBridgingAvailability=dataBridgingAvailability, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, sNTPServerTableIndex=sNTPServerTableIndex, tDMChannelLineCode=tDMChannelLineCode, userTableEntry=userTableEntry, management=management, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, userPassword=userPassword, configurationInstancedTableNumber=configurationInstancedTableNumber, receiveFreqKHz=receiveFreqKHz, ptpTrapPrefix=ptpTrapPrefix, licenseTLSRekey=licenseTLSRekey, ethernetInstancedTableIndex=ethernetInstancedTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, secureModeAlarm=secureModeAlarm, sNTPSyncTrap=sNTPSyncTrap, dfsGroup=dfsGroup, receiveDataRateLinked=receiveDataRateLinked, ethernetStatisticsDataSource=ethernetStatisticsDataSource, mABNominalModulationMode=mABNominalModulationMode, mainPSUPortAutoMdix=mainPSUPortAutoMdix, whitelistRMEnabled=whitelistRMEnabled, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, authorizationMethod=authorizationMethod, unitName=unitName, syslogClientTrap=syslogClientTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseEncryption=licenseEncryption, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, syslogStateTrap=syslogStateTrap, packetsToInternalStack=packetsToInternalStack, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetGroup=ethernetGroup, installationMode=installationMode, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, ptp=ptp, sNTPSync=sNTPSync, cableDiagnosticsWarning=cableDiagnosticsWarning, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, linkModeOptimizationMismatch=linkModeOptimizationMismatch, latitude=latitude, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tdmTableNumber=tdmTableNumber, rawReceivePower=rawReceivePower, apc=apc, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseSyncESupport=licenseSyncESupport, unavailableSeconds=unavailableSeconds, groupID=groupID, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNMPv3Enable=sNMPv3Enable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, cableDiagnostics=cableDiagnostics, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, mainPSUPortQLTx=mainPSUPortQLTx, dNSServerInternetAddressType=dNSServerInternetAddressType, systemReset=systemReset, auxPortStatus=auxPortStatus, licenseGasGroup=licenseGasGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, cableDiagPair2Distance=cableDiagPair2Distance, maximumNumberOfSlaves=maximumNumberOfSlaves, deviceMSN=deviceMSN, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, smtpGroup=smtpGroup, signalStrengthRatio=signalStrengthRatio, dfsTableNumber=dfsTableNumber, targetRange=targetRange, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, localPacketFiltering=localPacketFiltering, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, receiveModulationModeDetail=receiveModulationModeDetail, mABNominalTransmitCapacity=mABNominalTransmitCapacity, dNSServerTableNumber=dNSServerTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, dNSServerInternetAddress=dNSServerInternetAddress, encryptionAlgorithm=encryptionAlgorithm, mainPSUPortStatus=mainPSUPortStatus, receivePower=receivePower, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, iPDSCPPriorityTable=iPDSCPPriorityTable, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, syncETrackingState=syncETrackingState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installArmState=installArmState, sNTPServerRetries=sNTPServerRetries, dNS=dNS, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, receiveFreqMHz=receiveFreqMHz, dfsTableEntry=dfsTableEntry, sntpGroup=sntpGroup, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, rangeLinked=rangeLinked, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, phyControl=phyControl, transmitModulationMode=transmitModulationMode, licenseIPv6Support=licenseIPv6Support, installArmStateTrap=installArmStateTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, subbandHighestFrequency=subbandHighestFrequency, license=license, vectorError=vectorError, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNTPPollInterval=sNTPPollInterval, sMTPSourceEmailAddress=sMTPSourceEmailAddress, managementGroup=managementGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, telnetPortNumber=telnetPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, licenseInstancedTableNumber=licenseInstancedTableNumber, authorizationControlTableNumber=authorizationControlTableNumber, phyControlGroup=phyControlGroup, secondarySoftwareVersion=secondarySoftwareVersion, authorizationControlTable=authorizationControlTable, cableDiagnosticsResultTable=cableDiagnosticsResultTable, regulatoryBandTrap=regulatoryBandTrap, linkModeOptimization=linkModeOptimization, lowestDataModulationMode=lowestDataModulationMode, sNTPServerTable=sNTPServerTable, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, userTableNumber=userTableNumber, iPVersion=iPVersion, authorizationControlTableIndex=authorizationControlTableIndex, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, apcGroup=apcGroup, mainPSUPortQLRx=mainPSUPortQLRx, enableTransmission=enableTransmission, softwareVersion=softwareVersion, cableDiagPair3Distance=cableDiagPair3Distance, lowestTDMModulationMode=lowestTDMModulationMode, PYSNMP_MODULE_ID=cambium, signalStrengthRatioLinked=signalStrengthRatioLinked, portAllocationMismatchLinked=portAllocationMismatchLinked, cableDiagPair3Results=cableDiagPair3Results, dfsPeaks=dfsPeaks, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernet=ethernet, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, transmitDataRateLinked=transmitDataRateLinked, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, configurationInstancedTable=configurationInstancedTable, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseOOBManagementSupport=licenseOOBManagementSupport, sFPPortSSMTx=sFPPortSSMTx, licenseTrialPeriod=licenseTrialPeriod, portAllocationMismatch=portAllocationMismatch, subbandLowestFrequency=subbandLowestFrequency, encryptionGroup=encryptionGroup, alarmInstancedTableIndex=alarmInstancedTableIndex, auxPortQLRx=auxPortQLRx, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, cableDiagPair1Distance=cableDiagPair1Distance, telnetAccessEnabled=telnetAccessEnabled, mgmtInstancedTableIndex=mgmtInstancedTableIndex, tdmTable=tdmTable, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, tDDControl=tDDControl, rxColorCode=rxColorCode, severelyErroredSeconds=severelyErroredSeconds, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, auxPortAcceptedQLRx=auxPortAcceptedQLRx, pubInstancedStatsTable=pubInstancedStatsTable, tFTPServerPortNumber=tFTPServerPortNumber, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mgmtInstancedTable=mgmtInstancedTable, tDMChannelStatusTrap=tDMChannelStatusTrap, sFPErrorTrap=sFPErrorTrap, userRole=userRole, l2CPPriorityTableIndex=l2CPPriorityTableIndex, byteErrorRatio=byteErrorRatio, dNSServerPortNumber=dNSServerPortNumber, tdmTableIndex=tdmTableIndex, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, snmpControlGroup=snmpControlGroup, lbtDetectedTrap=lbtDetectedTrap, transmitFreqMHz=transmitFreqMHz, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, bootVersion=bootVersion, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sFPPortAutoNegotiation=sFPPortAutoNegotiation, installStatus=installStatus, blacklistRMMacAddress=blacklistRMMacAddress, cableDiagPair4Results=cableDiagPair4Results, unitIdentificationGroup=unitIdentificationGroup, cableDiagPair2Results=cableDiagPair2Results, installStatusTrap=installStatusTrap, tDMEnabledChannels=tDMEnabledChannels, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseVersion=licenseVersion, resetGroup=resetGroup, userName=userName, productName=productName, receiveModulationMode=receiveModulationMode, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, tDMChannelLoopback=tDMChannelLoopback, licenseUnitSerialNumber=licenseUnitSerialNumber, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, remoteInternetAddressType=remoteInternetAddressType, dNSServerTableIndex=dNSServerTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, longitude=longitude, routerProtocolsGroup=routerProtocolsGroup, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleMasterAndSlave=incompatibleMasterAndSlave, auxPortSyncERxStatus=auxPortSyncERxStatus, aAAControl=aAAControl, receiveChannel=receiveChannel, alarms=alarms, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mainPSUPortSSMTx=mainPSUPortSSMTx, configurationInstancedTableEntry=configurationInstancedTableEntry, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPLastSync=sNTPLastSync, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, hTTPSPortNumber=hTTPSPortNumber, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, cambium=cambium, extendedSpectrumScanning=extendedSpectrumScanning, remoteMaximumTransmitPower=remoteMaximumTransmitPower, aggregateDataRate=aggregateDataRate, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, syslogState=syslogState, dfsMeans=dfsMeans, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, transmitterChannels=transmitterChannels, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, snmpControl=snmpControl, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, dNSPrimaryServer=dNSPrimaryServer, phyControlInstancedTableNumber=phyControlInstancedTableNumber, siteName=siteName, tDMConfigurationMismatch=tDMConfigurationMismatch, sntp=sntp, range=range, sNTPState=sNTPState, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, wirelessLinkStatusLinked=wirelessLinkStatusLinked, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogControl=syslogControl, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, encryption=encryption, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessOutAllOctets=wirelessOutAllOctets, smtp=smtp, userEnabled=userEnabled, systemClock=systemClock, vectorErrorLinked=vectorErrorLinked, receiveModulationModeLinked=receiveModulationModeLinked, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, cableDiagPair1Results=cableDiagPair1Results, sNMPTrapTableIndex=sNMPTrapTableIndex, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, cableDiagnosticsControl=cableDiagnosticsControl, daylightSaving=daylightSaving, ethernetInstancedTableEntry=ethernetInstancedTableEntry, licenseInstancedTable=licenseInstancedTable, tFTPClient=tFTPClient, sNTPServerStatus=sNTPServerStatus, alarmsGroup=alarmsGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogClient=syslogClient, phyStatus=phyStatus, syslogControlGroup=syslogControlGroup, iPv6Address=iPv6Address, routerProtocols=routerProtocols, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, hardwareVersion=hardwareVersion, transmitChannel=transmitChannel)
