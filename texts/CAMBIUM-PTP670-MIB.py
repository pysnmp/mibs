...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", sNTPServerTable=sNTPServerTable, authorizationControlTableNumber=authorizationControlTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteInternetAddress=remoteInternetAddress, dataBridgingStatusAlarm=dataBridgingStatusAlarm, ethernetPriorityTableNumber=ethernetPriorityTableNumber, resetGroup=resetGroup, blacklistRMEnabled=blacklistRMEnabled, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, licenseEncryption=licenseEncryption, regulatoryBandTrap=regulatoryBandTrap, targetMACAddress=targetMACAddress, alarmInstancedTableEntry=alarmInstancedTableEntry, tDMChannelLoopback=tDMChannelLoopback, ptp670=ptp670, aggregateDataRateLinked=aggregateDataRateLinked, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, lowestDataModulationMode=lowestDataModulationMode, packetsFromInternalStack=packetsFromInternalStack, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unavailableSeconds=unavailableSeconds, pubStatsGroup=pubStatsGroup, tempPcb=tempPcb, dNSPrimaryServer=dNSPrimaryServer, erroredSeconds=erroredSeconds, eIRP=eIRP, sMTPServerInternetAddressType=sMTPServerInternetAddressType, phyControlInstancedTableIndex=phyControlInstancedTableIndex, mainPSUPortStatusTrap=mainPSUPortStatusTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, userPassword=userPassword, tFTPServerPortNumber=tFTPServerPortNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sFPPortSyncERxStatus=sFPPortSyncERxStatus, ethernetStatisticsTable=ethernetStatisticsTable, installStatus=installStatus, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityTable=l2CPPriorityTable, licenseTDDSyncSupport=licenseTDDSyncSupport, cableDiagnosticsControl=cableDiagnosticsControl, dSCPManagementPriority=dSCPManagementPriority, receiveDataRateLinked=receiveDataRateLinked, useVLANForMABProtocol=useVLANForMABProtocol, regulatoryBand=regulatoryBand, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, maximumNumberOfSlaves=maximumNumberOfSlaves, sNMPTrapTableNumber=sNMPTrapTableNumber, dNSServerInternetAddress=dNSServerInternetAddress, extendedSpectrumScanning=extendedSpectrumScanning, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sFPPortAutoMdix=sFPPortAutoMdix, tDM=tDM, management=management, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, configurationInstancedTableIndex=configurationInstancedTableIndex, phyControlInstancedTableNumber=phyControlInstancedTableNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, linkModeOptimization=linkModeOptimization, mainPSUPortSSMTx=mainPSUPortSSMTx, qOSPriorityScheme=qOSPriorityScheme, maxLinkRangeExceeded=maxLinkRangeExceeded, subbandHighestFrequency=subbandHighestFrequency, cableDiagPair4Results=cableDiagPair4Results, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, sFPPortStatus=sFPPortStatus, hCMPMaximumLinkRange=hCMPMaximumLinkRange, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseInstancedTableNumber=licenseInstancedTableNumber, versionsGroup=versionsGroup, sNTPServerTableIndex=sNTPServerTableIndex, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mABProtocolVID=mABProtocolVID, dNSServerPortNumber=dNSServerPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, wirelessLinkStatusLinked=wirelessLinkStatusLinked, mainPSUPortAllocation=mainPSUPortAllocation, aAAControlGroup=aAAControlGroup, licenseCountry=licenseCountry, licenseRARSupport=licenseRARSupport, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, ptpCompliance=ptpCompliance, phyControlInstancedTableEntry=phyControlInstancedTableEntry, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, notificationsGroup=notificationsGroup, userTableIndex=userTableIndex, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, vectorErrorLinked=vectorErrorLinked, unitName=unitName, cableDiagPair4Distance=cableDiagPair4Distance, auxPortSyncERxStatus=auxPortSyncERxStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, configurationInstancedTableNumber=configurationInstancedTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, license=license, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseIssueNumber=licenseIssueNumber, ethernetGroup=ethernetGroup, cambium=cambium, syslogState=syslogState, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, apc=apc, sNMPPortNumber=sNMPPortNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, licenseGroupAccess=licenseGroupAccess, sNMPCommunityString=sNMPCommunityString, aAAControl=aAAControl, tDMChannelStatusTrap=tDMChannelStatusTrap, capacityVariantMismatch=capacityVariantMismatch, sNTPPollInterval=sNTPPollInterval, txMABFrames=txMABFrames, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, remoteMACAddressLinked=remoteMACAddressLinked, softwareVersion=softwareVersion, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessTopology=wirelessTopology, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, dNSGroup=dNSGroup, rawReceivePowerLinked=rawReceivePowerLinked, enableTransmission=enableTransmission, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPv6Address=iPv6Address, subbandLowestFrequency=subbandLowestFrequency, licenseGroup=licenseGroup, channelBandwidth=channelBandwidth, apcGroup=apcGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mainPSUPortQLTx=mainPSUPortQLTx, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPv4Address=iPv4Address, tdmTableEntry=tdmTableEntry, latitude=latitude, transmitFreqKHz=transmitFreqKHz, remoteUnitName=remoteUnitName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveFreqMHz=receiveFreqMHz, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, mgmtInstancedTable=mgmtInstancedTable, hTTPSPortNumber=hTTPSPortNumber, lbtDetectedTrap=lbtDetectedTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, auxPortAllocation=auxPortAllocation, groupID=groupID, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, ethernetPriorityTable=ethernetPriorityTable, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, syslogClient=syslogClient, phyStatusGroup=phyStatusGroup, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, wirelessLinkStatus=wirelessLinkStatus, authorizationControlTable=authorizationControlTable, txColorCode=txColorCode, sMTPEnabledMessages=sMTPEnabledMessages, cableDiagPair3Distance=cableDiagPair3Distance, licenseInstancedTableEntry=licenseInstancedTableEntry, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, frequencyVariant=frequencyVariant, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, hCMPLinkSymmetry=hCMPLinkSymmetry, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDMConfigurationMismatch=tDMConfigurationMismatch, syslogControlGroup=syslogControlGroup, secureModeAlarmTrap=secureModeAlarmTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, tdmTableIndex=tdmTableIndex, dataBridgingAvailability=dataBridgingAvailability, noWirelessChannelAvailable=noWirelessChannelAvailable, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, userEnabled=userEnabled, sNMPTrapTableIndex=sNMPTrapTableIndex, sFPPortStatusTrap=sFPPortStatusTrap, routerProtocolsGroup=routerProtocolsGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, dfsTableIndex=dfsTableIndex, receiveModulationModeLinked=receiveModulationModeLinked, signalStrengthRatioLinked=signalStrengthRatioLinked, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, transmitModulationMode=transmitModulationMode, ethernetPriorityTableEntry=ethernetPriorityTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, authorizationControl=authorizationControl, telnetAccessEnabled=telnetAccessEnabled, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, transmitterChannels=transmitterChannels, tFTPClient=tFTPClient, transmitPowerLinked=transmitPowerLinked, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, routerProtocols=routerProtocols, portAllocationMismatchLinked=portAllocationMismatchLinked, iPDSCPPriorityTable=iPDSCPPriorityTable, userTable=userTable, managementGroup=managementGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, auxPortQLTx=auxPortQLTx, licenseUnitSerialNumber=licenseUnitSerialNumber, tDMInterfaceControl=tDMInterfaceControl, encryption=encryption, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, capacityVariantMismatchTrap=capacityVariantMismatchTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, altitude=altitude, syslogControl=syslogControl, alarmsGroup=alarmsGroup, auxPortStatus=auxPortStatus, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, rangingMode=rangingMode, remoteInternetAddressLinked=remoteInternetAddressLinked, auxPortDisabledWarning=auxPortDisabledWarning, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, blacklistRMMacAddress=blacklistRMMacAddress, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, signalStrengthRatio=signalStrengthRatio, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, remoteInternetAddressType=remoteInternetAddressType, licenseTLSRekey=licenseTLSRekey, gatewayIPAddress=gatewayIPAddress, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, transparentClockVID=transparentClockVID, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagnosticsWarning=cableDiagnosticsWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, portAllocationMismatch=portAllocationMismatch, mgmtInstancedTableNumber=mgmtInstancedTableNumber, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, unitOutOfCalibration=unitOutOfCalibration, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, licenseSecurityLevel=licenseSecurityLevel, hTTPAccessEnabled=hTTPAccessEnabled, transmitModulationModeLinked=transmitModulationModeLinked)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, sNMPTrapVersion=sNMPTrapVersion, nIDULanPortStatusTrap=nIDULanPortStatusTrap, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, dfs=dfs, dNSServerTableNumber=dNSServerTableNumber, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, systemReset=systemReset, transmitDataRateLinked=transmitDataRateLinked, tDDSynchronizationStatus=tDDSynchronizationStatus, tdmTableNumber=tdmTableNumber, sNTPState=sNTPState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseMaxLinkRange=licenseMaxLinkRange, remoteMACAddress=remoteMACAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsMeans=dfsMeans, accessMethod=accessMethod, lowestTDMModulationMode=lowestTDMModulationMode, linkLossLinked=linkLossLinked, timeZone=timeZone, dfsTableEntry=dfsTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tdmTable=tdmTable, sNMPEnabledTraps=sNMPEnabledTraps, vLANManagementPriority=vLANManagementPriority, syslogStateTrap=syslogStateTrap, cableDiagPair1Results=cableDiagPair1Results, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, bootVersion=bootVersion, productVariant=productVariant, whitelistRMMacAddress=whitelistRMMacAddress, licenseIPv6Support=licenseIPv6Support, phyControlInstancedTable=phyControlInstancedTable, daylightSaving=daylightSaving, linkSymmetry=linkSymmetry, transmitChannel=transmitChannel, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, unitIdentification=unitIdentification, tDDControl=tDDControl, ethernetStatisticsDataSource=ethernetStatisticsDataSource, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mABNominalModulationMode=mABNominalModulationMode, sNTPServerInternetAddress=sNTPServerInternetAddress, telnetPortNumber=telnetPortNumber, nIDULanPortStatus=nIDULanPortStatus, ethernetInstancedTableIndex=ethernetInstancedTableIndex, phyControl=phyControl, userName=userName, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, auxPortStatusTrap=auxPortStatusTrap, smtp=smtp, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, dNSServerTableIndex=dNSServerTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, authorizationControlTableEntry=authorizationControlTableEntry, syslogClientTrap=syslogClientTrap, userRole=userRole, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, maximumTransmitPower=maximumTransmitPower, receivePowerLinked=receivePowerLinked, tDDControlGroup=tDDControlGroup, sNTPSyncTrap=sNTPSyncTrap, cableLoss=cableLoss, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, ptmp=ptmp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseInstancedTable=licenseInstancedTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, cableDiagnosticsResultTable=cableDiagnosticsResultTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableDiagPair1Distance=cableDiagPair1Distance, licenseGasGroup=licenseGasGroup, dataPortPauseFrames=dataPortPauseFrames, byteErrorRatio=byteErrorRatio, phyStatus=phyStatus, syncETrackingState=syncETrackingState, authorizationControlGroup=authorizationControlGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sntpGroup=sntpGroup, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, searchState=searchState, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, sFPErrorTrap=sFPErrorTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, cableDiagPair2Distance=cableDiagPair2Distance, sNTPServerPortNumber=sNTPServerPortNumber, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sntp=sntp, sNTPSync=sNTPSync, antennaGain=antennaGain, sNMPTrapInternetAddress=sNMPTrapInternetAddress, secureModeAlarm=secureModeAlarm, transparentClock=transparentClock, sMTPServerPortNumber=sMTPServerPortNumber, licenseVersion=licenseVersion, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, deviceMACAddress=deviceMACAddress, auxPortQLRx=auxPortQLRx, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, linkModeOptimizationMismatch=linkModeOptimizationMismatch, searchStateLinked=searchStateLinked, sNTPServerTableEntry=sNTPServerTableEntry, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, alarmInstancedTable=alarmInstancedTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkLoss=linkLoss, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, encryptionAlgorithm=encryptionAlgorithm, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, deviceMSN=deviceMSN, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, snmpControl=snmpControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transmitFreqMHz=transmitFreqMHz, tDMChannelStatus=tDMChannelStatus, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, auxPortSSMTx=auxPortSSMTx, receiveChannel=receiveChannel, dNS=dNS, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, versions=versions, systemClock=systemClock, wirelessOutAllOctets=wirelessOutAllOctets, linkName=linkName, pubStats=pubStats, receivePower=receivePower, dfsGroup=dfsGroup, bridgeGroup=bridgeGroup, sFPPortAllocation=sFPPortAllocation, remoteUnitNameLinked=remoteUnitNameLinked, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, aggregateDataRate=aggregateDataRate, licenseIEEE1588Support=licenseIEEE1588Support, antennaSelection=antennaSelection, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, mABProtocolVLANPriority=mABProtocolVLANPriority, receiveDataRate=receiveDataRate, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, range=range, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseSFPPortSupport=licenseSFPPortSupport, installStatusLinked=installStatusLinked, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, smtpGroup=smtpGroup, licenseCapacity=licenseCapacity, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, dataBridgingStatusLinked=dataBridgingStatusLinked, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, reset=reset, iPv6PrefixLength=iPv6PrefixLength, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, configurationInstancedTableEntry=configurationInstancedTableEntry, masterSlaveMode=masterSlaveMode, phyControlGroup=phyControlGroup, sFPPortQLRx=sFPPortQLRx, mABTransmissionInterval=mABTransmissionInterval, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, dataBridgingStatus=dataBridgingStatus, transmitPower=transmitPower, mABMaintenanceLevel=mABMaintenanceLevel, ptp=ptp, rawReceivePower=rawReceivePower, rxColorCode=rxColorCode, licenseInstancedTableIndex=licenseInstancedTableIndex, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, licenseHCMPSupport=licenseHCMPSupport, transparentClockVLAN=transparentClockVLAN, severelyErroredSeconds=severelyErroredSeconds, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNTPLastSync=sNTPLastSync, configurationInstancedTable=configurationInstancedTable, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ethernetInstancedTable=ethernetInstancedTable, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, userTableNumber=userTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPError=sFPError, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, ptpGroups=ptpGroups, tDMEnabledChannels=tDMEnabledChannels, mainPSUPortQLRx=mainPSUPortQLRx, ptpTraps=ptpTraps, byteErrorRatioLinked=byteErrorRatioLinked, installArmState=installArmState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cableDiagPair3Results=cableDiagPair3Results, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseBandwidthCap=licenseBandwidthCap, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, pubInstancedStatsTable=pubInstancedStatsTable, sFPPortSSMTx=sFPPortSSMTx, mgmtInstancedTableIndex=mgmtInstancedTableIndex, longitude=longitude, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, cableDiagnosticsPorts=cableDiagnosticsPorts, bridge=bridge, authorizationMethod=authorizationMethod, productName=productName, mgmtInstancedTableEntry=mgmtInstancedTableEntry, supplementary=supplementary, mainPSUPortStatus=mainPSUPortStatus, syncETracking=syncETracking, sFPPortQLTx=sFPPortQLTx, sMTPEmailAlert=sMTPEmailAlert, installArmStateTrap=installArmStateTrap, dNSServerTable=dNSServerTable, sNTPServerTableNumber=sNTPServerTableNumber, deviceESN=deviceESN, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, wirelessOutOctets=wirelessOutOctets, ethernet=ethernet, userTableEntry=userTableEntry, licenseSyncESupport=licenseSyncESupport, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dNSServerTableEntry=dNSServerTableEntry, mABState=mABState, alarmInstancedTableNumber=alarmInstancedTableNumber, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, supplementaryGroup=supplementaryGroup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, transparentClockPort=transparentClockPort, iPVersion=iPVersion, mABHoldoffPeriod=mABHoldoffPeriod, configuration=configuration, vLANManagementVID=vLANManagementVID, tDMChannelLineCode=tDMChannelLineCode, cableDiagnostics=cableDiagnostics, vectorError=vectorError, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNTPServerStatus=sNTPServerStatus, unitIdentificationGroup=unitIdentificationGroup, sNTPPrimaryServer=sNTPPrimaryServer, dNSResolver=dNSResolver, dfsTableNumber=dfsTableNumber, rangeLinked=rangeLinked, subnetMask=subnetMask)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, alarmInstancedTableIndex=alarmInstancedTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dNSServerInternetAddressType=dNSServerInternetAddressType, installStatusTrap=installStatusTrap, sNMPv3Enable=sNMPv3Enable, packetsToInternalStack=packetsToInternalStack, receiveFreqKHz=receiveFreqKHz, encryptionGroup=encryptionGroup, receiveModulationMode=receiveModulationMode, siteName=siteName, cableDiagPair2Results=cableDiagPair2Results, licenseTrialPeriod=licenseTrialPeriod, ptpTrapPrefix=ptpTrapPrefix, syncEEquipmentClock=syncEEquipmentClock, sNTPServerRetries=sNTPServerRetries, tDMInterfaceStatus=tDMInterfaceStatus, tDMChannelCableLength=tDMChannelCableLength, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, sNTPServerTimeout=sNTPServerTimeout, wirelessOutEthernetOctets=wirelessOutEthernetOctets, installationMode=installationMode, mABNominalTransmitCapacity=mABNominalTransmitCapacity, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsPeaks=dfsPeaks, localPacketFiltering=localPacketFiltering, configurationGroup=configurationGroup, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, dfsTable=dfsTable, capacityVariantMismatchLinked=capacityVariantMismatchLinked, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, snmpControlGroup=snmpControlGroup, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, syncESlavePort=syncESlavePort, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDMGroup=tDMGroup, phyInstancedStatusTable=phyInstancedStatusTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, targetRange=targetRange, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, mPLSTCPriorityTable=mPLSTCPriorityTable, receiveModulationModeDetail=receiveModulationModeDetail, transmitDataRate=transmitDataRate, authorizationControlTableIndex=authorizationControlTableIndex, channelChangeTrap=channelChangeTrap, hardwareVersion=hardwareVersion, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, whitelistRMEnabled=whitelistRMEnabled, sNMPTrapTable=sNMPTrapTable, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, alarms=alarms, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, hTTPPortNumber=hTTPPortNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime)
