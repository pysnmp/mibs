...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", telnetAccessEnabled=telnetAccessEnabled, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, productVariant=productVariant, sNTPSyncTrap=sNTPSyncTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, regulatoryBand=regulatoryBand, systemReset=systemReset, receiveFreqKHz=receiveFreqKHz, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, lowestTDMModulationMode=lowestTDMModulationMode, authorizationControlGroup=authorizationControlGroup, syslogControl=syslogControl, iPv4Address=iPv4Address, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, userPassword=userPassword, licenseGasGroup=licenseGasGroup, searchStateLinked=searchStateLinked, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveDataRate=receiveDataRate, sntp=sntp, tDDControl=tDDControl, ethernetStatisticsTable=ethernetStatisticsTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, frequencyVariant=frequencyVariant, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, auxPortAcceptedQLRx=auxPortAcceptedQLRx, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteMACAddress=remoteMACAddress, syslogState=syslogState, sNMPv3Enable=sNMPv3Enable, tDDControlGroup=tDDControlGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPTrapTableEntry=sNMPTrapTableEntry, capacityVariantMismatchLinked=capacityVariantMismatchLinked, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, altitude=altitude, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, dNSServerTableIndex=dNSServerTableIndex, tDMChannelLoopback=tDMChannelLoopback, portAllocationMismatchLinked=portAllocationMismatchLinked, remoteMACAddressLinked=remoteMACAddressLinked, smtpGroup=smtpGroup, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, licenseCapacity=licenseCapacity, ethernetPriorityTableNumber=ethernetPriorityTableNumber, maximumTransmitPower=maximumTransmitPower, receiveModulationMode=receiveModulationMode, transmitDataRate=transmitDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetInstancedTable=ethernetInstancedTable, dfsTable=dfsTable, packetsFromInternalStack=packetsFromInternalStack, wirelessOutOctets=wirelessOutOctets, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, rangingMode=rangingMode, dfsTableEntry=dfsTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, configurationInstancedTableIndex=configurationInstancedTableIndex, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, phyControlGroup=phyControlGroup, linkSymmetry=linkSymmetry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mgmtInstancedTableNumber=mgmtInstancedTableNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, alarms=alarms, ethernet=ethernet, cableDiagPair4Results=cableDiagPair4Results, hTTPSPortNumber=hTTPSPortNumber, iPVersion=iPVersion, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, hCMPLinkSymmetry=hCMPLinkSymmetry, licenseInstancedTableIndex=licenseInstancedTableIndex, secureModeAlarmTrap=secureModeAlarmTrap, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, mainPSUPortQLTx=mainPSUPortQLTx, licenseIPv6Support=licenseIPv6Support, cableDiagnosticsPorts=cableDiagnosticsPorts, pubStatsGroup=pubStatsGroup, cableDiagPair4Distance=cableDiagPair4Distance, sNMPEnabledTraps=sNMPEnabledTraps, dataBridgingStatusAlarm=dataBridgingStatusAlarm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseMaxLinkRange=licenseMaxLinkRange, extendedSpectrumScanning=extendedSpectrumScanning, authorizationControlTableNumber=authorizationControlTableNumber, antennaSelection=antennaSelection, pubInstancedStatsTable=pubInstancedStatsTable, subbandLowestFrequency=subbandLowestFrequency, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sNTPPollInterval=sNTPPollInterval, license=license, mABHoldoffPeriod=mABHoldoffPeriod, mgmtInstancedTableIndex=mgmtInstancedTableIndex, licenseCountry=licenseCountry, syncEEquipmentClock=syncEEquipmentClock, transmitterChannels=transmitterChannels, sFPPortStatus=sFPPortStatus, linkLossLinked=linkLossLinked, installArmState=installArmState, sNMPTrapVersion=sNMPTrapVersion, syslogClientTrap=syslogClientTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, userRole=userRole, unitOutOfCalibration=unitOutOfCalibration, incompatibleMasterAndSlave=incompatibleMasterAndSlave, remoteInternetAddressLinked=remoteInternetAddressLinked, alarmInstancedTableEntry=alarmInstancedTableEntry, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNTPState=sNTPState, licenseVersion=licenseVersion, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, ethernetGroup=ethernetGroup, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseTLSRekey=licenseTLSRekey, syslogLocalWrappedTrap=syslogLocalWrappedTrap, auxPortStatus=auxPortStatus, syslogControlGroup=syslogControlGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, byteErrorRatio=byteErrorRatio, syncESlavePort=syncESlavePort, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, signalStrengthRatio=signalStrengthRatio, licenseInstancedTable=licenseInstancedTable, hardwareVersion=hardwareVersion, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sFPPortQLRx=sFPPortQLRx, receivePowerLinked=receivePowerLinked, linkLoss=linkLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, installStatus=installStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, authorizationControl=authorizationControl, sNTPSync=sNTPSync, siteName=siteName, mABProtocolVID=mABProtocolVID, phyControl=phyControl, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, authorizationControlTableEntry=authorizationControlTableEntry, receivePower=receivePower, unitName=unitName, vectorErrorLinked=vectorErrorLinked, sNMPPortNumber=sNMPPortNumber, sNTPServerStatus=sNTPServerStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, portAllocationMismatch=portAllocationMismatch, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, sFPPortAutoMdix=sFPPortAutoMdix, transmitDataRateLinked=transmitDataRateLinked, userTableIndex=userTableIndex, unitIdentificationGroup=unitIdentificationGroup, bootVersion=bootVersion, accessMethod=accessMethod, blacklistRMEnabled=blacklistRMEnabled, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDMEnabledChannels=tDMEnabledChannels, iPv6PrefixLength=iPv6PrefixLength, maximumNumberOfSlaves=maximumNumberOfSlaves, iPv6GatewayAddress=iPv6GatewayAddress, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, userEnabled=userEnabled, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, userName=userName, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, encryptionGroup=encryptionGroup, installationMode=installationMode, tFTPServerInternetAddress=tFTPServerInternetAddress, regulatoryBandTrap=regulatoryBandTrap, txMABFrames=txMABFrames, auxPortStatusTrap=auxPortStatusTrap, channelChangeTrap=channelChangeTrap, tdmTableIndex=tdmTableIndex, wirelessLinkStatusLinked=wirelessLinkStatusLinked, transparentClock=transparentClock, installStatusTrap=installStatusTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, productName=productName, userTable=userTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, masterSlaveMode=masterSlaveMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, tDMConfigurationMismatch=tDMConfigurationMismatch, dNSServerPortNumber=dNSServerPortNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationMode=tDDSynchronizationMode, capacityVariantMismatchTrap=capacityVariantMismatchTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, versionsGroup=versionsGroup, authorizationMethod=authorizationMethod, bridge=bridge, ethernetPriorityTable=ethernetPriorityTable, ptpGroups=ptpGroups, licenseIssueNumber=licenseIssueNumber, cableDiagPair1Results=cableDiagPair1Results, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseOOBManagementSupport=licenseOOBManagementSupport, byteErrorRatioLinked=byteErrorRatioLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, encryption=encryption, txColorCode=txColorCode, dNSServerTable=dNSServerTable, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, receiveModulationModeLinked=receiveModulationModeLinked, encryptionAlgorithm=encryptionAlgorithm, packetsToInternalStack=packetsToInternalStack, licenseInstancedTableNumber=licenseInstancedTableNumber, licenseHCMPSupport=licenseHCMPSupport, whitelistRMEnabled=whitelistRMEnabled, dNSServerTableNumber=dNSServerTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tDMChannelStatus=tDMChannelStatus, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNTPServerTableNumber=sNTPServerTableNumber, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, channelBandwidth=channelBandwidth, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTable=l2CPPriorityTable, dataPortPauseFrames=dataPortPauseFrames, hCMPMaximumLinkRange=hCMPMaximumLinkRange, transparentClockVID=transparentClockVID, versions=versions, tdmTableNumber=tdmTableNumber, tFTPClient=tFTPClient, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNTPServerRetries=sNTPServerRetries, dSCPManagementPriority=dSCPManagementPriority, linkModeOptimization=linkModeOptimization, managementGroup=managementGroup, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mABState=mABState, resetGroup=resetGroup, licenseSFPPortSupport=licenseSFPPortSupport, systemClock=systemClock, licenseTrialPeriod=licenseTrialPeriod, dfsTableIndex=dfsTableIndex, mainPSUPortStatusTrap=mainPSUPortStatusTrap, ptpTrapPrefix=ptpTrapPrefix, dfsGroup=dfsGroup, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, configurationInstancedTableNumber=configurationInstancedTableNumber, syncETrackingState=syncETrackingState, licenseUnitSerialNumber=licenseUnitSerialNumber, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rxColorCode=rxColorCode, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, dNSServerInternetAddressType=dNSServerInternetAddressType, userTableNumber=userTableNumber, remoteInternetAddressType=remoteInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, licenseGroup=licenseGroup, management=management, tDMInterfaceStatus=tDMInterfaceStatus, wirelessOutEthernetOctets=wirelessOutEthernetOctets, cableDiagPair1Distance=cableDiagPair1Distance, cableDiagPair3Distance=cableDiagPair3Distance, configuration=configuration, dNSPrimaryServer=dNSPrimaryServer, mgmtInstancedTableEntry=mgmtInstancedTableEntry, cableDiagnosticsGroup=cableDiagnosticsGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, phyControlInstancedTable=phyControlInstancedTable, dNSServerTableEntry=dNSServerTableEntry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, antennaGain=antennaGain, tDMChannelLineCode=tDMChannelLineCode, portAllocationMismatchTrap=portAllocationMismatchTrap, sNTPPrimaryServer=sNTPPrimaryServer, tDMInterfaceControl=tDMInterfaceControl, apc=apc, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, wirelessTopology=wirelessTopology, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, hTTPPortNumber=hTTPPortNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, ptp=ptp, sFPPortAutoNegotiation=sFPPortAutoNegotiation, phyControlInstancedTableIndex=phyControlInstancedTableIndex, sNMPCommunityString=sNMPCommunityString, transmitChannel=transmitChannel, cableLoss=cableLoss, qOSPriorityScheme=qOSPriorityScheme, reset=reset, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, tDMGroup=tDMGroup, telnetPortNumber=telnetPortNumber, routerProtocolsGroup=routerProtocolsGroup, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, ethernetInstancedTableEntry=ethernetInstancedTableEntry, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, timeZone=timeZone, syslogStateTrap=syslogStateTrap, deviceESN=deviceESN, deviceMSN=deviceMSN, transmitModulationModeLinked=transmitModulationModeLinked, aAAControl=aAAControl, authorizationControlTableIndex=authorizationControlTableIndex, licenseGroupAccess=licenseGroupAccess, blacklistRMMacAddress=blacklistRMMacAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, pubStats=pubStats, rawReceivePower=rawReceivePower, wirelessOutAllOctets=wirelessOutAllOctets, licenseSyncESupport=licenseSyncESupport, receiveDataRateLinked=receiveDataRateLinked, iPv6Address=iPv6Address, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyControlInstancedTableEntry=phyControlInstancedTableEntry, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sFPPortStatusTrap=sFPPortStatusTrap, transmitPower=transmitPower, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, dataBridgingStatus=dataBridgingStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, subnetMask=subnetMask, secureModeAlarm=secureModeAlarm, dNS=dNS, sMTPEmailAlert=sMTPEmailAlert, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, authorizationControlTable=authorizationControlTable, sFPPortQLTx=sFPPortQLTx, erroredSeconds=erroredSeconds, apcGroup=apcGroup, alarmsGroup=alarmsGroup, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseInstancedTableEntry=licenseInstancedTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableEntry=userTableEntry, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagPair3Results=cableDiagPair3Results, sNMPTrapTableIndex=sNMPTrapTableIndex, eIRP=eIRP, phyInstancedStatusTable=phyInstancedStatusTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkStatus=wirelessLinkStatus, receiveChannel=receiveChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mainPSUPortStatus=mainPSUPortStatus, dataBridgingAvailability=dataBridgingAvailability, alarmInstancedTable=alarmInstancedTable, tdmTable=tdmTable, phyControlInstancedTableNumber=phyControlInstancedTableNumber, ptp670=ptp670, syslogClient=syslogClient, sNTPServerTimeout=sNTPServerTimeout, aggregateDataRateLinked=aggregateDataRateLinked, longitude=longitude, cambium=cambium, remoteUnitNameLinked=remoteUnitNameLinked, remoteMaximumTransmitPower=remoteMaximumTransmitPower, subbandHighestFrequency=subbandHighestFrequency, licenseBandwidthCap=licenseBandwidthCap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, tDM=tDM, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseSecurityLevel=licenseSecurityLevel, targetRange=targetRange, transmitModulationMode=transmitModulationMode, ptpTraps=ptpTraps, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, syncETracking=syncETracking, configurationInstancedTable=configurationInstancedTable, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, notificationsGroup=notificationsGroup, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, routerProtocols=routerProtocols, sFPErrorTrap=sFPErrorTrap, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, transparentClockVLAN=transparentClockVLAN, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, dfsMeans=dfsMeans, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, snmpControlGroup=snmpControlGroup, mainPSUPortAllocation=mainPSUPortAllocation, remoteInternetAddress=remoteInternetAddress, receiveFreqMHz=receiveFreqMHz, auxPortQLTx=auxPortQLTx, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, alarmInstancedTableNumber=alarmInstancedTableNumber, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, useVLANForMABProtocol=useVLANForMABProtocol, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, rangeLinked=rangeLinked, daylightSaving=daylightSaving, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, configurationGroup=configurationGroup, dataBridgingStatusLinked=dataBridgingStatusLinked, groupID=groupID, transmitPowerLinked=transmitPowerLinked, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, localPacketFiltering=localPacketFiltering, ptmp=ptmp, sNTPLastSync=sNTPLastSync, l2CPPriorityTableNumber=l2CPPriorityTableNumber, latitude=latitude, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, mABTransmissionInterval=mABTransmissionInterval, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, dfs=dfs, licenseIEEE1588Support=licenseIEEE1588Support, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, ptpCompliance=ptpCompliance, installArmStateTrap=installArmStateTrap, mABMaintenanceLevel=mABMaintenanceLevel, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, severelyErroredSeconds=severelyErroredSeconds, sNMPTrapInternetAddress=sNMPTrapInternetAddress, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsPeaks=dfsPeaks, rawReceivePowerLinked=rawReceivePowerLinked, ethernetInstancedTableIndex=ethernetInstancedTableIndex, unavailableSeconds=unavailableSeconds, dNSResolver=dNSResolver, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDMChannelCableLength=tDMChannelCableLength, transmitFreqMHz=transmitFreqMHz, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseEncryption=licenseEncryption, cableDiagnostics=cableDiagnostics, auxPortDisabledWarning=auxPortDisabledWarning, sMTPServerInternetAddressType=sMTPServerInternetAddressType, deviceMACAddress=deviceMACAddress, tdmTableEntry=tdmTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tempPcb=tempPcb, softwareVersion=softwareVersion, ethernetStatisticsDataSource=ethernetStatisticsDataSource, dNSGroup=dNSGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, ethernetInstancedTableNumber=ethernetInstancedTableNumber, auxPortSSMTx=auxPortSSMTx, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, installStatusLinked=installStatusLinked, snmpControl=snmpControl, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, vectorError=vectorError, configurationInstancedTableEntry=configurationInstancedTableEntry, sFPPortAllocation=sFPPortAllocation, sNTPServerPortNumber=sNTPServerPortNumber, nIDULanPortStatus=nIDULanPortStatus, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, linkModeOptimizationMismatch=linkModeOptimizationMismatch, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyStatus=phyStatus, dfsTableNumber=dfsTableNumber, sFPError=sFPError, alarmInstancedTableIndex=alarmInstancedTableIndex, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", lbtDetectedTrap=lbtDetectedTrap, transmitFreqKHz=transmitFreqKHz, dNSServerInternetAddress=dNSServerInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, bridgeGroup=bridgeGroup, sFPPortSSMTx=sFPPortSSMTx, capacityVariantMismatch=capacityVariantMismatch, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, cableDiagnosticsControl=cableDiagnosticsControl, unitIdentification=unitIdentification, mABNominalModulationMode=mABNominalModulationMode, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, searchState=searchState, aAAControlGroup=aAAControlGroup, sNTPServerTableEntry=sNTPServerTableEntry, auxPortQLRx=auxPortQLRx, tFTPServerInternetAddressType=tFTPServerInternetAddressType, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, targetMACAddress=targetMACAddress, phyStatusGroup=phyStatusGroup, licenseRARSupport=licenseRARSupport, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, whitelistRMMacAddress=whitelistRMMacAddress, auxPortAllocation=auxPortAllocation, enableTransmission=enableTransmission, vLANManagementVID=vLANManagementVID, PYSNMP_MODULE_ID=cambium, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagPair2Results=cableDiagPair2Results, range=range, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, supplementary=supplementary, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, linkName=linkName, receiveModulationModeDetail=receiveModulationModeDetail, cableDiagPair2Distance=cableDiagPair2Distance, signalStrengthRatioLinked=signalStrengthRatioLinked, lowestDataModulationMode=lowestDataModulationMode, mainPSUPortQLRx=mainPSUPortQLRx, sntpGroup=sntpGroup, remoteUnitName=remoteUnitName, smtp=smtp, transparentClockPort=transparentClockPort, aggregateDataRate=aggregateDataRate, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerTable=sNTPServerTable, mgmtInstancedTable=mgmtInstancedTable, vLANManagementPriority=vLANManagementPriority, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, incompatibleRegulatoryBands=incompatibleRegulatoryBands, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, supplementaryGroup=supplementaryGroup, sNMPTrapTable=sNMPTrapTable, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError)
