...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, Counter64, enterprises, TimeTicks, Counter32, Gauge32, iso, MibIdentifier, NotificationType, Integer32, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "Counter64", "enterprises", "TimeTicks", "Counter32", "Gauge32", "iso", "MibIdentifier", "NotificationType", "Integer32", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", license=license, transmitModulationModeLinked=transmitModulationModeLinked, mainPSUPortQLRx=mainPSUPortQLRx, sNMPPortNumber=sNMPPortNumber, ptp670=ptp670, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, userEnabled=userEnabled, syslogControlGroup=syslogControlGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, configurationInstancedTableEntry=configurationInstancedTableEntry, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, authorizationControlTableIndex=authorizationControlTableIndex, ethernet=ethernet, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, dNSPrimaryServer=dNSPrimaryServer, useVLANForMABProtocol=useVLANForMABProtocol, capacityVariantMismatch=capacityVariantMismatch, dNSServerTableIndex=dNSServerTableIndex, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetPriorityTableEntry=ethernetPriorityTableEntry, whitelistRMMacAddress=whitelistRMMacAddress, encryption=encryption, nIDULanPortStatusTrap=nIDULanPortStatusTrap, enableTransmission=enableTransmission, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDMConfigurationMismatch=tDMConfigurationMismatch, antennaSelection=antennaSelection, tFTPClient=tFTPClient, licenseTLSRekey=licenseTLSRekey, syslogControl=syslogControl, encryptionAlgorithm=encryptionAlgorithm, portAllocationMismatchTrap=portAllocationMismatchTrap, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, subnetMask=subnetMask, ethernetPriorityTable=ethernetPriorityTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, range=range, dfsTableIndex=dfsTableIndex, dSCPManagementPriority=dSCPManagementPriority, syncETracking=syncETracking, tDMChannelCableLength=tDMChannelCableLength, sNMPTrapTableNumber=sNMPTrapTableNumber, maximumTransmitPower=maximumTransmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, auxPortQLRx=auxPortQLRx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, PYSNMP_MODULE_ID=cambium, vectorError=vectorError, lbtDetectedTrap=lbtDetectedTrap, searchState=searchState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rangingMode=rangingMode, mainPSUPortQLTx=mainPSUPortQLTx, telnetPortNumber=telnetPortNumber, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, linkModeOptimizationMismatch=linkModeOptimizationMismatch, alarmInstancedTableEntry=alarmInstancedTableEntry, vLANManagementPriority=vLANManagementPriority, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, signalStrengthRatio=signalStrengthRatio, dNS=dNS, mgmtInstancedTableEntry=mgmtInstancedTableEntry, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPLastSync=sNTPLastSync, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, bootVersion=bootVersion, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mABProtocolVLANPriority=mABProtocolVLANPriority, blacklistRMEnabled=blacklistRMEnabled, tDMEnabledChannels=tDMEnabledChannels, cableDiagnostics=cableDiagnostics, dfsTableNumber=dfsTableNumber, licenseTDDSyncSupport=licenseTDDSyncSupport, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseCapacity=licenseCapacity, deviceMACAddress=deviceMACAddress, licenseVersion=licenseVersion, sNTPPrimaryServer=sNTPPrimaryServer, cambium=cambium, mgmtInstancedTableNumber=mgmtInstancedTableNumber, dataPortPauseFrames=dataPortPauseFrames, portAllocationMismatch=portAllocationMismatch, authorizationControlTableNumber=authorizationControlTableNumber, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, packetsFromInternalStack=packetsFromInternalStack, sFPPortQLTx=sFPPortQLTx, receiveFreqKHz=receiveFreqKHz, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, transmitDataRateLinked=transmitDataRateLinked, receiveDataRate=receiveDataRate, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, phyControlInstancedTableEntry=phyControlInstancedTableEntry, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, unitName=unitName, lowestDataModulationMode=lowestDataModulationMode, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, syslogStateTrap=syslogStateTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogState=syslogState, pubStats=pubStats, sFPPortAllocation=sFPPortAllocation, mPLSTCPriorityTable=mPLSTCPriorityTable, userTableEntry=userTableEntry, dNSResolver=dNSResolver, subbandLowestFrequency=subbandLowestFrequency, ethernetStatisticsDataSource=ethernetStatisticsDataSource, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, wirelessLinkStatus=wirelessLinkStatus, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, userTableIndex=userTableIndex, cableDiagnosticsResultTable=cableDiagnosticsResultTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, management=management, syncEEquipmentClock=syncEEquipmentClock, licenseRegulatoryBandsList=licenseRegulatoryBandsList, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, alarmInstancedTableIndex=alarmInstancedTableIndex, pubInstancedStatsTable=pubInstancedStatsTable, accessMethod=accessMethod, transmitFreqKHz=transmitFreqKHz, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, ptpCompliance=ptpCompliance, mainPSUPortAllocation=mainPSUPortAllocation, sNTPServerRetries=sNTPServerRetries, ptpTrapPrefix=ptpTrapPrefix, sNTPServerTableEntry=sNTPServerTableEntry, bridgeGroup=bridgeGroup, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, systemClock=systemClock, receiveChannel=receiveChannel, receiveModulationModeDetail=receiveModulationModeDetail, transparentClockVID=transparentClockVID, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sNTPState=sNTPState, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, sNTPServerTableNumber=sNTPServerTableNumber, blacklistRMMacAddress=blacklistRMMacAddress, remoteMACAddressLinked=remoteMACAddressLinked, wirelessLinkStatusLinked=wirelessLinkStatusLinked, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tDMInterfaceControl=tDMInterfaceControl, softwareVersion=softwareVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, dataBridgingStatusLinked=dataBridgingStatusLinked, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mainPSUPortStatus=mainPSUPortStatus, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, dfsMeans=dfsMeans, longitude=longitude, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, remoteInternetAddressType=remoteInternetAddressType, cableDiagPair2Distance=cableDiagPair2Distance, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, targetMACAddress=targetMACAddress, snmpControl=snmpControl, managementGroup=managementGroup, sNMPv3Enable=sNMPv3Enable, licenseGroup=licenseGroup, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, unitIdentification=unitIdentification, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sMTPEnabledMessages=sMTPEnabledMessages, authorizationControlGroup=authorizationControlGroup, extendedSpectrumScanning=extendedSpectrumScanning, installArmStateTrap=installArmStateTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, authorizationControl=authorizationControl, auxPortStatusTrap=auxPortStatusTrap, phyControlInstancedTable=phyControlInstancedTable, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseHCMPSupport=licenseHCMPSupport, cableDiagnosticsControl=cableDiagnosticsControl, dNSServerTableNumber=dNSServerTableNumber, cableDiagPair3Results=cableDiagPair3Results, receivePower=receivePower, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, routerProtocols=routerProtocols, iPv4Address=iPv4Address, smtpGroup=smtpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPErrorTrap=sFPErrorTrap, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, phyInstancedStatusTable=phyInstancedStatusTable, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, secureModeAlarm=secureModeAlarm, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNTPServerTable=sNTPServerTable, dNSServerTable=dNSServerTable, daylightSaving=daylightSaving, wirelessOutAllOctets=wirelessOutAllOctets, dNSGroup=dNSGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, searchStateLinked=searchStateLinked, dfs=dfs, aAAControl=aAAControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, auxPortConfigurationMismatch=auxPortConfigurationMismatch, signalStrengthRatioLinked=signalStrengthRatioLinked, licenseRARSupport=licenseRARSupport, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, aggregateDataRate=aggregateDataRate, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, masterSlaveMode=masterSlaveMode, rawReceivePower=rawReceivePower, productName=productName, licenseInstancedTableEntry=licenseInstancedTableEntry, dfsTable=dfsTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, portAllocationMismatchLinked=portAllocationMismatchLinked, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, siteName=siteName, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, transmitChannel=transmitChannel, licenseOOBManagementSupport=licenseOOBManagementSupport)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", nIDULanPortAutoMdix=nIDULanPortAutoMdix, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseEncryption=licenseEncryption, ptp=ptp, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, deviceMSN=deviceMSN, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, cableDiagPair2Results=cableDiagPair2Results, ethernetInstancedTableNumber=ethernetInstancedTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerTimeout=sNTPServerTimeout, cableDiagPair4Distance=cableDiagPair4Distance, remoteUnitName=remoteUnitName, authorizationMethod=authorizationMethod, ptpGroups=ptpGroups, iPv6Address=iPv6Address, mgmtInstancedTable=mgmtInstancedTable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, encryptionGroup=encryptionGroup, userRole=userRole, gatewayIPAddress=gatewayIPAddress, ptpTraps=ptpTraps, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, userTable=userTable, wirelessLinkAvailability=wirelessLinkAvailability, hTTPAccessEnabled=hTTPAccessEnabled, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tDMChannelLoopback=tDMChannelLoopback, phyControlInstancedTableIndex=phyControlInstancedTableIndex, snmpControlGroup=snmpControlGroup, bridge=bridge, sNTPSync=sNTPSync, userPassword=userPassword, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitPower=transmitPower, alarmInstancedTable=alarmInstancedTable, localPacketFiltering=localPacketFiltering, sNMPTrapTable=sNMPTrapTable, cableLoss=cableLoss, sFPPortQLRx=sFPPortQLRx, sNTPPollInterval=sNTPPollInterval, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, mABTransmissionInterval=mABTransmissionInterval, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, dNSServerInternetAddressType=dNSServerInternetAddressType, iPv6PrefixLength=iPv6PrefixLength, antennaGain=antennaGain, phyControl=phyControl, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, iPv6GatewayAddress=iPv6GatewayAddress, productVariant=productVariant, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, licenseSecurityLevel=licenseSecurityLevel, transmitFreqMHz=transmitFreqMHz, transparentClockVLAN=transparentClockVLAN, ethernetInstancedTableEntry=ethernetInstancedTableEntry, authorizationControlTable=authorizationControlTable, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, hCMPMaximumLinkRange=hCMPMaximumLinkRange, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagPair4Results=cableDiagPair4Results, mainPSUPortStatusTrap=mainPSUPortStatusTrap, transmitterChannels=transmitterChannels, licenseBandwidthCap=licenseBandwidthCap, reset=reset, sNTPServerStatus=sNTPServerStatus, sMTPEmailAlert=sMTPEmailAlert, syncETrackingState=syncETrackingState, tDDSynchronizationStatus=tDDSynchronizationStatus, resetGroup=resetGroup, tDDControlGroup=tDDControlGroup, configuration=configuration, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPServerPortNumber=tFTPServerPortNumber, tdmTableIndex=tdmTableIndex, unitIdentificationGroup=unitIdentificationGroup, linkModeOptimization=linkModeOptimization, receiveModulationMode=receiveModulationMode, receiveModulationModeLinked=receiveModulationModeLinked, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tdmTable=tdmTable, frequencyVariant=frequencyVariant, noWirelessChannelAvailable=noWirelessChannelAvailable, sntpGroup=sntpGroup, txMABFrames=txMABFrames, sFPPortAutoMdix=sFPPortAutoMdix, cableDiagPair1Results=cableDiagPair1Results, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, tDM=tDM, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, systemReset=systemReset, mABNominalModulationMode=mABNominalModulationMode, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, mABState=mABState, licenseInstancedTableIndex=licenseInstancedTableIndex, alarmsGroup=alarmsGroup, phyStatus=phyStatus, transparentClock=transparentClock, receiveDataRateLinked=receiveDataRateLinked, installStatusTrap=installStatusTrap, licenseMaxLinkRange=licenseMaxLinkRange, sFPError=sFPError, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, lowestTDMModulationMode=lowestTDMModulationMode, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseCountry=licenseCountry, linkLossLinked=linkLossLinked, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tDMInterfaceStatus=tDMInterfaceStatus, versionsGroup=versionsGroup, tDDSynchronizationMode=tDDSynchronizationMode, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, deviceESN=deviceESN, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mABHoldoffPeriod=mABHoldoffPeriod, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, ptmp=ptmp, licenseInstancedTableNumber=licenseInstancedTableNumber, supplementary=supplementary, licenseSyncESupport=licenseSyncESupport, sNMPEnabledTraps=sNMPEnabledTraps, nIDULanPortStatus=nIDULanPortStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, phyStatusGroup=phyStatusGroup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, auxPortAllocation=auxPortAllocation, eIRP=eIRP, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tempPcb=tempPcb, alarmInstancedTableNumber=alarmInstancedTableNumber, tdmTableEntry=tdmTableEntry, licenseIPv6Support=licenseIPv6Support, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, byteErrorRatio=byteErrorRatio, dataPortWirelessDownAlert=dataPortWirelessDownAlert, regulatoryBand=regulatoryBand, iPVersion=iPVersion, rawReceivePowerLinked=rawReceivePowerLinked, capacityVariantMismatchLinked=capacityVariantMismatchLinked, configurationGroup=configurationGroup, remoteUnitNameLinked=remoteUnitNameLinked, cableDiagPair1Distance=cableDiagPair1Distance, qOSPriorityScheme=qOSPriorityScheme, licenseIEEE1588Support=licenseIEEE1588Support, severelyErroredSeconds=severelyErroredSeconds, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tdmTableNumber=tdmTableNumber, dNSServerPortNumber=dNSServerPortNumber, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, dNSServerInternetAddress=dNSServerInternetAddress, licenseGasGroup=licenseGasGroup, alarms=alarms, tDMChannelStatus=tDMChannelStatus, mABMaintenanceLevel=mABMaintenanceLevel, cableDiagPair3Distance=cableDiagPair3Distance, tDMGroup=tDMGroup, altitude=altitude, apcGroup=apcGroup, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, txColorCode=txColorCode, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, smtp=smtp, sntp=sntp, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNTPSyncTrap=sNTPSyncTrap, installStatus=installStatus, licenseUnitSerialNumber=licenseUnitSerialNumber, remoteMACAddress=remoteMACAddress, wirelessOutEthernetOctets=wirelessOutEthernetOctets, hardwareVersion=hardwareVersion, latitude=latitude, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, userName=userName, regulatoryBandTrap=regulatoryBandTrap, auxPortStatus=auxPortStatus, tDDControl=tDDControl, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, configurationInstancedTable=configurationInstancedTable, remoteInternetAddressLinked=remoteInternetAddressLinked, sFPPortStatus=sFPPortStatus, transmitPowerLinked=transmitPowerLinked, channelChangeTrap=channelChangeTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, authorizationControlTableEntry=authorizationControlTableEntry, l2CPPriorityTable=l2CPPriorityTable, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, hCMPLinkSymmetry=hCMPLinkSymmetry, groupID=groupID, hTTPPortNumber=hTTPPortNumber, ethernetStatisticsTable=ethernetStatisticsTable, telnetAccessEnabled=telnetAccessEnabled, licenseIssueNumber=licenseIssueNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDMChannelStatusTrap=tDMChannelStatusTrap, aggregateDataRateLinked=aggregateDataRateLinked, supplementaryGroup=supplementaryGroup, sFPPortStatusTrap=sFPPortStatusTrap, dfsPeaks=dfsPeaks, licenseTrialPeriod=licenseTrialPeriod, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, linkName=linkName, apc=apc, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, auxPortQLTx=auxPortQLTx, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, auxPortSyncERxStatus=auxPortSyncERxStatus, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, installArmState=installArmState, licenseInstancedTable=licenseInstancedTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControlInstancedTableNumber=phyControlInstancedTableNumber, linkSymmetry=linkSymmetry, pubStatsGroup=pubStatsGroup, sNMPCommunityString=sNMPCommunityString, channelBandwidth=channelBandwidth, tDMChannelLineCode=tDMChannelLineCode, dataBridgingAvailability=dataBridgingAvailability, aAAControlGroup=aAAControlGroup, syncESlavePort=syncESlavePort, sFPPortSyncERxStatus=sFPPortSyncERxStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dfsGroup=dfsGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessOutOctets=wirelessOutOctets, erroredSeconds=erroredSeconds, mainPSUPortSSMTx=mainPSUPortSSMTx, auxPortAcceptedQLRx=auxPortAcceptedQLRx, cableDiagnosticsPorts=cableDiagnosticsPorts, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, timeZone=timeZone, ethernetPriorityTableIndex=ethernetPriorityTableIndex, auxPortSSMTx=auxPortSSMTx, whitelistRMEnabled=whitelistRMEnabled, secureModeAlarmTrap=secureModeAlarmTrap, unitOutOfCalibration=unitOutOfCalibration, configurationInstancedTableNumber=configurationInstancedTableNumber, remoteInternetAddress=remoteInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", notificationsGroup=notificationsGroup, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, licenseGroupAccess=licenseGroupAccess, sNTPServerTableIndex=sNTPServerTableIndex, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, managementNetworkAccessEnabled=managementNetworkAccessEnabled, packetsToInternalStack=packetsToInternalStack, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sMTPServerInternetAddress=sMTPServerInternetAddress, installStatusLinked=installStatusLinked, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, transmitDataRate=transmitDataRate, installationMode=installationMode, routerProtocolsGroup=routerProtocolsGroup, sMTPServerPortNumber=sMTPServerPortNumber, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rangeLinked=rangeLinked, maximumNumberOfSlaves=maximumNumberOfSlaves, mABNominalTransmitCapacity=mABNominalTransmitCapacity, rxColorCode=rxColorCode, sFPPortDisabledWarning=sFPPortDisabledWarning, wirelessTopology=wirelessTopology, sNTPServerPortNumber=sNTPServerPortNumber, linkLoss=linkLoss, transparentClockPort=transparentClockPort, syslogClient=syslogClient, targetRange=targetRange, receiveFreqMHz=receiveFreqMHz, mABProtocolVID=mABProtocolVID, ethernetGroup=ethernetGroup, dfsTableEntry=dfsTableEntry, unavailableSeconds=unavailableSeconds, hTTPSPortNumber=hTTPSPortNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, vectorErrorLinked=vectorErrorLinked, auxPortDisabledWarning=auxPortDisabledWarning, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernetInstancedTable=ethernetInstancedTable, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, subbandHighestFrequency=subbandHighestFrequency, dNSServerTableEntry=dNSServerTableEntry, syslogClientTrap=syslogClientTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dataBridgingStatus=dataBridgingStatus, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, receivePowerLinked=receivePowerLinked, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, userTableNumber=userTableNumber, phyControlGroup=phyControlGroup, ethernetInstancedTableIndex=ethernetInstancedTableIndex, byteErrorRatioLinked=byteErrorRatioLinked, vLANManagementVID=vLANManagementVID, sFPPortSSMTx=sFPPortSSMTx, licenseSFPPortSupport=licenseSFPPortSupport, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, versions=versions)
