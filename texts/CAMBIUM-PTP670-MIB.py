...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", mABNominalModulationMode=mABNominalModulationMode, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, authorizationMethod=authorizationMethod, cableDiagPair2Distance=cableDiagPair2Distance, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sFPPortAllocation=sFPPortAllocation, remoteInternetAddressType=remoteInternetAddressType, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, dNSServerPortNumber=dNSServerPortNumber, tempPcb=tempPcb, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, syncESlavePort=syncESlavePort, tDMChannelLineCode=tDMChannelLineCode, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, longitude=longitude, extendedSpectrumScanning=extendedSpectrumScanning, phyInstancedStatusTable=phyInstancedStatusTable, auxPortDisabledWarning=auxPortDisabledWarning, auxPortAllocation=auxPortAllocation, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, sMTPEnabledMessages=sMTPEnabledMessages, configuration=configuration, configurationInstancedTableNumber=configurationInstancedTableNumber, portAllocationMismatch=portAllocationMismatch, syslogControlGroup=syslogControlGroup, targetRange=targetRange, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, phyControlInstancedTableEntry=phyControlInstancedTableEntry, antennaSelection=antennaSelection, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, alarmInstancedTableIndex=alarmInstancedTableIndex, userTableEntry=userTableEntry, ptp670=ptp670, packetsToInternalStack=packetsToInternalStack, tdmTableNumber=tdmTableNumber, licenseSecurityLevel=licenseSecurityLevel, licenseInstancedTableIndex=licenseInstancedTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, transmitModulationModeLinked=transmitModulationModeLinked, licenseCountry=licenseCountry, alarmInstancedTable=alarmInstancedTable, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, ethernetInstancedTable=ethernetInstancedTable, encryptionAlgorithm=encryptionAlgorithm, signalStrengthRatioLinked=signalStrengthRatioLinked, alarmInstancedTableNumber=alarmInstancedTableNumber, erroredSeconds=erroredSeconds, ethernetPriorityTableEntry=ethernetPriorityTableEntry, transmitFreqMHz=transmitFreqMHz, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sNMPTrapTable=sNMPTrapTable, mainPSUPortSSMTx=mainPSUPortSSMTx, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, siteName=siteName, cableLoss=cableLoss, dfsTableNumber=dfsTableNumber, tDDControlGroup=tDDControlGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mainPSUPortAllocation=mainPSUPortAllocation, dfsGroup=dfsGroup, ethernetStatisticsDataSource=ethernetStatisticsDataSource, tDMConfigurationMismatch=tDMConfigurationMismatch, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, hTTPAccessEnabled=hTTPAccessEnabled, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, authorizationControlTableIndex=authorizationControlTableIndex, tDMInterfaceControl=tDMInterfaceControl, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, receivePowerLinked=receivePowerLinked, sNMPv3Enable=sNMPv3Enable, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, useVLANForMABProtocol=useVLANForMABProtocol, enableTransmission=enableTransmission, vLANManagementPriority=vLANManagementPriority, dNSServerInternetAddress=dNSServerInternetAddress, dNSPrimaryServer=dNSPrimaryServer, versionsGroup=versionsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseIPv6Support=licenseIPv6Support, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, blacklistRMEnabled=blacklistRMEnabled, sNTPSync=sNTPSync, dataPortPauseFrames=dataPortPauseFrames, unitIdentificationGroup=unitIdentificationGroup, authorizationControlTable=authorizationControlTable, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, masterSlaveMode=masterSlaveMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sFPPortQLTx=sFPPortQLTx, systemClock=systemClock, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseHCMPSupport=licenseHCMPSupport, transparentClockPort=transparentClockPort, managementGroup=managementGroup, versions=versions, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogControl=syslogControl, userRole=userRole, sFPError=sFPError, systemReset=systemReset, tDDControl=tDDControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rangingMode=rangingMode, vLANManagementVID=vLANManagementVID, sFPPortStatus=sFPPortStatus, searchStateLinked=searchStateLinked, mABState=mABState, oOBPriorityQueueMapping=oOBPriorityQueueMapping, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapVersion=sNMPTrapVersion, phyControlInstancedTableNumber=phyControlInstancedTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, lowestDataModulationMode=lowestDataModulationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, authorizationControlTableEntry=authorizationControlTableEntry, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, iPv4Address=iPv4Address, management=management, licenseBandwidthCap=licenseBandwidthCap, byteErrorRatio=byteErrorRatio, ptpCompliance=ptpCompliance, dNSResolver=dNSResolver, receiveFreqKHz=receiveFreqKHz, syncETrackingState=syncETrackingState, incompatibleRegulatoryBands=incompatibleRegulatoryBands, reset=reset, licenseUnitSerialNumber=licenseUnitSerialNumber, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, auxPortStatus=auxPortStatus, ethernetStatisticsTable=ethernetStatisticsTable, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, whitelistRMEnabled=whitelistRMEnabled, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, mgmtInstancedTableNumber=mgmtInstancedTableNumber, syncEEquipmentClock=syncEEquipmentClock, mgmtInstancedTable=mgmtInstancedTable, sNTPSyncTrap=sNTPSyncTrap, cableDiagPair4Distance=cableDiagPair4Distance, transmitFreqKHz=transmitFreqKHz, sFPErrorTrap=sFPErrorTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNTPServerInternetAddressType=sNTPServerInternetAddressType, linkLoss=linkLoss, dfsPeaks=dfsPeaks, smtp=smtp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, transparentClock=transparentClock, sNMPTrapPortNumber=sNMPTrapPortNumber, authorizationControlTableNumber=authorizationControlTableNumber, severelyErroredSeconds=severelyErroredSeconds, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, txColorCode=txColorCode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, supplementaryGroup=supplementaryGroup, antennaGain=antennaGain, dfsMeans=dfsMeans, sNTPPollInterval=sNTPPollInterval, userTableNumber=userTableNumber, licenseVersion=licenseVersion, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sMTPEmailAlert=sMTPEmailAlert, timeZone=timeZone, altitude=altitude, alarmsGroup=alarmsGroup, licenseGroupAccess=licenseGroupAccess, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, maximumTransmitPower=maximumTransmitPower, receiveDataRateLinked=receiveDataRateLinked, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseSFPPortSupport=licenseSFPPortSupport, qOSPriorityScheme=qOSPriorityScheme, userTableIndex=userTableIndex, aAAControlGroup=aAAControlGroup, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, capacityVariantMismatch=capacityVariantMismatch, regulatoryBandTrap=regulatoryBandTrap, wirelessLinkStatusLinked=wirelessLinkStatusLinked, license=license, secureModeAlarmTrap=secureModeAlarmTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, snmpControlGroup=snmpControlGroup, lowestTDMModulationMode=lowestTDMModulationMode, mainPSUPortStatus=mainPSUPortStatus, configurationGroup=configurationGroup, subnetMask=subnetMask, installStatus=installStatus, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseTrialPeriod=licenseTrialPeriod, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, l2CPPriorityTable=l2CPPriorityTable, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, configurationInstancedTable=configurationInstancedTable, aAAControl=aAAControl, bridgeGroup=bridgeGroup, dNSServerTable=dNSServerTable, ptpTrapPrefix=ptpTrapPrefix, licenseRARSupport=licenseRARSupport, dNSGroup=dNSGroup, eIRP=eIRP, sFPPortQLRx=sFPPortQLRx, mainPSUPortQLRx=mainPSUPortQLRx, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, iPv6Address=iPv6Address, ethernetPriorityTableIndex=ethernetPriorityTableIndex, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, dNSServerTableNumber=dNSServerTableNumber, productVariant=productVariant, unitIdentification=unitIdentification, syncETracking=syncETracking, configurationInstancedTableEntry=configurationInstancedTableEntry, dfs=dfs, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNMPCommunityString=sNMPCommunityString, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, nIDULanPortAutoMdix=nIDULanPortAutoMdix, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControlGroup=phyControlGroup, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, mABMaintenanceLevel=mABMaintenanceLevel, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, portAllocationMismatchTrap=portAllocationMismatchTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseGasGroup=licenseGasGroup, ethernetInstancedTableIndex=ethernetInstancedTableIndex, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, sntpGroup=sntpGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, bridge=bridge, wirelessOutOctets=wirelessOutOctets)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", pubStats=pubStats, snmpControl=snmpControl, tdmTable=tdmTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, dNSServerTableEntry=dNSServerTableEntry, transmitChannel=transmitChannel, nIDULanPortStatus=nIDULanPortStatus, phyControl=phyControl, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hTTPPortNumber=hTTPPortNumber, tDM=tDM, syslogClientTrap=syslogClientTrap, hCMPLinkSymmetry=hCMPLinkSymmetry, mABProtocolVID=mABProtocolVID, ethernetInstancedTableNumber=ethernetInstancedTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, syslogStateTrap=syslogStateTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, deviceMACAddress=deviceMACAddress, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, tDDSynchronizationMode=tDDSynchronizationMode, dNS=dNS, userTable=userTable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, receiveModulationModeLinked=receiveModulationModeLinked, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, pubStatsGroup=pubStatsGroup, transmitModulationMode=transmitModulationMode, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, ptmp=ptmp, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telnetPortNumber=telnetPortNumber, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseGroup=licenseGroup, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, sNTPServerRetries=sNTPServerRetries, alarmInstancedTableEntry=alarmInstancedTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteUnitName=remoteUnitName, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPLastSync=sNTPLastSync, unitName=unitName, cambium=cambium, cableDiagnosticsWarning=cableDiagnosticsWarning, ptp=ptp, ethernet=ethernet, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tDMChannelStatus=tDMChannelStatus, ptpGroups=ptpGroups, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDMGroup=tDMGroup, mgmtInstancedTableEntry=mgmtInstancedTableEntry, linkModeOptimization=linkModeOptimization, secureModeAlarm=secureModeAlarm, sNTPState=sNTPState, configurationInstancedTableIndex=configurationInstancedTableIndex, licenseOOBManagementSupport=licenseOOBManagementSupport, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sntp=sntp, hTTPSPortNumber=hTTPSPortNumber, transparentClockVLAN=transparentClockVLAN, hardwareVersion=hardwareVersion, transmitPower=transmitPower, alarms=alarms, cableDiagnosticsControl=cableDiagnosticsControl, phyControlInstancedTableIndex=phyControlInstancedTableIndex, licenseSyncESupport=licenseSyncESupport, targetMACAddress=targetMACAddress, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, installStatusLinked=installStatusLinked, dataBridgingAvailability=dataBridgingAvailability, smtpGroup=smtpGroup, cableDiagPair3Distance=cableDiagPair3Distance, installationMode=installationMode, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, routerProtocols=routerProtocols, frequencyVariant=frequencyVariant, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, encryptionGroup=encryptionGroup, receiveModulationMode=receiveModulationMode, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, channelBandwidth=channelBandwidth, phyControlInstancedTable=phyControlInstancedTable, mABHoldoffPeriod=mABHoldoffPeriod, phyStatus=phyStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, receiveChannel=receiveChannel, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, gatewayIPAddress=gatewayIPAddress, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sMTPServerInternetAddress=sMTPServerInternetAddress, resetGroup=resetGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, unavailableSeconds=unavailableSeconds, cableDiagPair4Results=cableDiagPair4Results, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, cableDiagPair2Results=cableDiagPair2Results, productName=productName, auxPortSSMTx=auxPortSSMTx, dfsTableEntry=dfsTableEntry, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, localPacketFiltering=localPacketFiltering, tDMChannelCableLength=tDMChannelCableLength, wirelessTopology=wirelessTopology, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, portAllocationMismatchLinked=portAllocationMismatchLinked, blacklistRMMacAddress=blacklistRMMacAddress, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseInstancedTableEntry=licenseInstancedTableEntry, licenseEncryption=licenseEncryption, sFPPortStatusTrap=sFPPortStatusTrap, remoteInternetAddress=remoteInternetAddress, regulatoryBand=regulatoryBand, installArmState=installArmState, deviceMSN=deviceMSN, receivePower=receivePower, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, subbandLowestFrequency=subbandLowestFrequency, txMABFrames=txMABFrames, licenseInstancedTableNumber=licenseInstancedTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, rawReceivePowerLinked=rawReceivePowerLinked, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sNTPPrimaryServer=sNTPPrimaryServer, sFPPortAutoMdix=sFPPortAutoMdix, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, range=range, auxPortQLTx=auxPortQLTx, licenseIEEE1588Support=licenseIEEE1588Support, ethernetPriorityTable=ethernetPriorityTable, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, accessMethod=accessMethod, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mainPSUPortQLTx=mainPSUPortQLTx, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, PYSNMP_MODULE_ID=cambium, userEnabled=userEnabled, tDMChannelLoopback=tDMChannelLoopback, secondarySoftwareVersion=secondarySoftwareVersion, syslogState=syslogState, unitOutOfCalibration=unitOutOfCalibration, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, remoteMACAddress=remoteMACAddress, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, sFPPortSyncERxStatus=sFPPortSyncERxStatus, installStatusTrap=installStatusTrap, maximumNumberOfSlaves=maximumNumberOfSlaves, lbtDetectedTrap=lbtDetectedTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseIssueNumber=licenseIssueNumber, channelChangeTrap=channelChangeTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteMACAddressLinked=remoteMACAddressLinked, supplementary=supplementary, wirelessOutEthernetOctets=wirelessOutEthernetOctets, encryption=encryption, dataBridgingStatus=dataBridgingStatus, tDMEnabledChannels=tDMEnabledChannels, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sMTPServerPortNumber=sMTPServerPortNumber, licenseCapacity=licenseCapacity, iPVersion=iPVersion, apc=apc, dNSServerTableIndex=dNSServerTableIndex, authorizationControl=authorizationControl, licenseRegulatoryBandsList=licenseRegulatoryBandsList, vectorError=vectorError, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, tdmTableEntry=tdmTableEntry, bootVersion=bootVersion, mgmtInstancedTableIndex=mgmtInstancedTableIndex, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, apcGroup=apcGroup, auxPortQLRx=auxPortQLRx, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, sFPPortSSMTx=sFPPortSSMTx, tdmTableIndex=tdmTableIndex, authorizationControlGroup=authorizationControlGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerTimeout=sNTPServerTimeout, aggregateDataRate=aggregateDataRate, cableDiagnostics=cableDiagnostics, sNTPServerTableNumber=sNTPServerTableNumber, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, cableDiagnosticsResultTable=cableDiagnosticsResultTable, vectorErrorLinked=vectorErrorLinked, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, deviceESN=deviceESN, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, cableDiagPair3Results=cableDiagPair3Results, routerProtocolsGroup=routerProtocolsGroup, groupID=groupID, ptpTraps=ptpTraps, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, rxColorCode=rxColorCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hCMPMaximumLinkRange=hCMPMaximumLinkRange, tFTPClient=tFTPClient, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cableDiagPair1Distance=cableDiagPair1Distance, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, rawReceivePower=rawReceivePower, softwareVersion=softwareVersion, transmitDataRate=transmitDataRate, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, receiveFreqMHz=receiveFreqMHz, sNTPServerTableIndex=sNTPServerTableIndex, auxPortAcceptedQLRx=auxPortAcceptedQLRx, linkName=linkName, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, ethernetGroup=ethernetGroup, dfsTableIndex=dfsTableIndex, wirelessOutAllOctets=wirelessOutAllOctets, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, dSCPManagementPriority=dSCPManagementPriority, cableDiagPair1Results=cableDiagPair1Results, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, byteErrorRatioLinked=byteErrorRatioLinked, dfsTable=dfsTable, tDMInterfaceStatus=tDMInterfaceStatus, transmitDataRateLinked=transmitDataRateLinked, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, searchState=searchState)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", linkSymmetry=linkSymmetry, transparentClockVID=transparentClockVID, licenseMaxLinkRange=licenseMaxLinkRange, daylightSaving=daylightSaving, dataBridgingStatusAlarm=dataBridgingStatusAlarm, licenseInstancedTable=licenseInstancedTable, transmitterChannels=transmitterChannels, capacityVariantMismatchLinked=capacityVariantMismatchLinked, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, rangeLinked=rangeLinked, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, remoteUnitNameLinked=remoteUnitNameLinked, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, pubInstancedStatsTable=pubInstancedStatsTable, userName=userName, syslogClient=syslogClient, mABProtocolVLANPriority=mABProtocolVLANPriority, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, whitelistRMMacAddress=whitelistRMMacAddress, subbandHighestFrequency=subbandHighestFrequency, receiveDataRate=receiveDataRate, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, auxPortSyncERxStatus=auxPortSyncERxStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, aggregateDataRateLinked=aggregateDataRateLinked, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sNTPServerTable=sNTPServerTable, receiveModulationModeDetail=receiveModulationModeDetail, iPv6PrefixLength=iPv6PrefixLength, cableDiagnosticsGroup=cableDiagnosticsGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telnetAccessEnabled=telnetAccessEnabled, iPv6GatewayAddress=iPv6GatewayAddress, installArmStateTrap=installArmStateTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, licenseTLSRekey=licenseTLSRekey, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerTableEntry=sNTPServerTableEntry, auxPortStatusTrap=auxPortStatusTrap, latitude=latitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, packetsFromInternalStack=packetsFromInternalStack, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, linkLossLinked=linkLossLinked, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNTPServerStatus=sNTPServerStatus, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, sNMPPortNumber=sNMPPortNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, transmitPowerLinked=transmitPowerLinked, ethernetInstancedTableEntry=ethernetInstancedTableEntry, dNSServerInternetAddressType=dNSServerInternetAddressType, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userPassword=userPassword, mABTransmissionInterval=mABTransmissionInterval)
