...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, wirelessLinkStatusLinked=wirelessLinkStatusLinked, resetGroup=resetGroup, antennaGain=antennaGain, remoteMACAddress=remoteMACAddress, ptp670=ptp670, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, auxPortStatusTrap=auxPortStatusTrap, dfsTable=dfsTable, vLANManagementVID=vLANManagementVID, wirelessOutAllOctets=wirelessOutAllOctets, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseInstancedTable=licenseInstancedTable, dfsGroup=dfsGroup, mgmtInstancedTableIndex=mgmtInstancedTableIndex, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, ethernetPriorityTableEntry=ethernetPriorityTableEntry, hCMPLinkSymmetry=hCMPLinkSymmetry, cableDiagnosticsWarning=cableDiagnosticsWarning, alarms=alarms, cableDiagnostics=cableDiagnostics, sNTPPrimaryServer=sNTPPrimaryServer, sNTPPollInterval=sNTPPollInterval, phyControlInstancedTableNumber=phyControlInstancedTableNumber, ptpTrapPrefix=ptpTrapPrefix, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, phyControlInstancedTableIndex=phyControlInstancedTableIndex, licenseRegulatoryBandsList=licenseRegulatoryBandsList, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mABMaintenanceLevel=mABMaintenanceLevel, erroredSeconds=erroredSeconds, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, receivePowerLinked=receivePowerLinked, hardwareVersion=hardwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkAvailability=wirelessLinkAvailability, mgmtInstancedTableEntry=mgmtInstancedTableEntry, ptp=ptp, licenseCountry=licenseCountry, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseGroupAccess=licenseGroupAccess, mABProtocolVLANPriority=mABProtocolVLANPriority, dataPortPauseFrames=dataPortPauseFrames, l2CPPriorityTable=l2CPPriorityTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseSyncESupport=licenseSyncESupport, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, cableDiagPair1Results=cableDiagPair1Results, iPv6PrefixLength=iPv6PrefixLength, telnetAccessEnabled=telnetAccessEnabled, supplementary=supplementary, sFPPortDisabledWarning=sFPPortDisabledWarning, syslogClientTrap=syslogClientTrap, licenseMaxLinkRange=licenseMaxLinkRange, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, remoteInternetAddress=remoteInternetAddress, auxPortQLRx=auxPortQLRx, dfsTableEntry=dfsTableEntry, dfsTableNumber=dfsTableNumber, tdmTableEntry=tdmTableEntry, snmpControlGroup=snmpControlGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, gatewayIPAddress=gatewayIPAddress, cableDiagPair2Distance=cableDiagPair2Distance, secondarySoftwareVersion=secondarySoftwareVersion, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mABHoldoffPeriod=mABHoldoffPeriod, installationMode=installationMode, bridgeGroup=bridgeGroup, hTTPSPortNumber=hTTPSPortNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, sNTPServerTable=sNTPServerTable, tDMInterfaceStatus=tDMInterfaceStatus, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, systemReset=systemReset, daylightSaving=daylightSaving, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, searchStateLinked=searchStateLinked, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetStatisticsTable=ethernetStatisticsTable, portAllocationMismatchLinked=portAllocationMismatchLinked, transparentClockPort=transparentClockPort, cableDiagPair4Distance=cableDiagPair4Distance, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, remoteUnitNameLinked=remoteUnitNameLinked, sFPPortAutoNegotiation=sFPPortAutoNegotiation, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, hCMPMaximumLinkRange=hCMPMaximumLinkRange, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, whitelistRMEnabled=whitelistRMEnabled, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNTPServerTimeout=sNTPServerTimeout, tDM=tDM, syslogState=syslogState, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, license=license, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, alarmInstancedTableIndex=alarmInstancedTableIndex, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNTPServerTableEntry=sNTPServerTableEntry, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, signalStrengthRatioLinked=signalStrengthRatioLinked, subbandHighestFrequency=subbandHighestFrequency, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mgmtInstancedTable=mgmtInstancedTable, versionsGroup=versionsGroup, sNMPPortNumber=sNMPPortNumber, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseSFPPortSupport=licenseSFPPortSupport, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, ethernetInstancedTableEntry=ethernetInstancedTableEntry, dfsTableIndex=dfsTableIndex, installStatus=installStatus, sFPPortStatus=sFPPortStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, frequencyVariant=frequencyVariant, txColorCode=txColorCode, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, cambium=cambium, aAAControl=aAAControl, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telnetPortNumber=telnetPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, phyStatus=phyStatus, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, targetMACAddress=targetMACAddress, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, receivePower=receivePower, mainPSUPortStatusTrap=mainPSUPortStatusTrap, deviceESN=deviceESN, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, transmitPower=transmitPower, dataBridgingAvailability=dataBridgingAvailability, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerInternetAddressType=sNTPServerInternetAddressType, productName=productName, aggregateDataRateLinked=aggregateDataRateLinked, mgmtInstancedTableNumber=mgmtInstancedTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, dataBridgingStatusLinked=dataBridgingStatusLinked, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, transparentClock=transparentClock, sNMPv3Enable=sNMPv3Enable, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, authorizationMethod=authorizationMethod, sFPErrorTrap=sFPErrorTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANManagementPriority=vLANManagementPriority, pubStats=pubStats, sNTPSyncTrap=sNTPSyncTrap, tdmTableNumber=tdmTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseTLSRekey=licenseTLSRekey, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sFPPortStatusTrap=sFPPortStatusTrap, lbtDetectedTrap=lbtDetectedTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, installArmStateTrap=installArmStateTrap, whitelistRMMacAddress=whitelistRMMacAddress, linkLoss=linkLoss, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, dNSServerTable=dNSServerTable, mainPSUPortStatus=mainPSUPortStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, phyControlInstancedTableEntry=phyControlInstancedTableEntry, severelyErroredSeconds=severelyErroredSeconds, licenseHCMPSupport=licenseHCMPSupport, syslogStateTrap=syslogStateTrap, apcGroup=apcGroup, notificationsGroup=notificationsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, smtpGroup=smtpGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, alarmInstancedTableEntry=alarmInstancedTableEntry, mABTransmissionInterval=mABTransmissionInterval, mainPSUPortQLRx=mainPSUPortQLRx, dNSServerInternetAddressType=dNSServerInternetAddressType, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dNSGroup=dNSGroup, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sFPError=sFPError, rawReceivePowerLinked=rawReceivePowerLinked, userEnabled=userEnabled, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, maximumNumberOfSlaves=maximumNumberOfSlaves, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogControlGroup=syslogControlGroup, versions=versions, userPassword=userPassword, auxPortStatus=auxPortStatus, syncETracking=syncETracking, packetsToInternalStack=packetsToInternalStack, ethernetGroup=ethernetGroup, management=management, remoteUnitName=remoteUnitName, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, hTTPAccessEnabled=hTTPAccessEnabled, range=range, ptpCompliance=ptpCompliance, l2CPPriorityTableIndex=l2CPPriorityTableIndex, authorizationControlTable=authorizationControlTable, aAAControlGroup=aAAControlGroup, sNTPServerRetries=sNTPServerRetries, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, groupID=groupID, licenseSecurityLevel=licenseSecurityLevel, iPDSCPPriorityTable=iPDSCPPriorityTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, siteName=siteName, unitName=unitName, syncETrackingState=syncETrackingState, supplementaryGroup=supplementaryGroup, rangingMode=rangingMode, licenseInstancedTableIndex=licenseInstancedTableIndex, sNTPLastSync=sNTPLastSync, syslogLocalWrappedTrap=syslogLocalWrappedTrap, antennaSelection=antennaSelection, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installStatusLinked=installStatusLinked, configurationInstancedTableEntry=configurationInstancedTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseEncryption=licenseEncryption, routerProtocols=routerProtocols, bootVersion=bootVersion, transmitModulationMode=transmitModulationMode, iPv6Address=iPv6Address, tDMGroup=tDMGroup, licenseGroup=licenseGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", userName=userName, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, syslogClient=syslogClient, productVariant=productVariant, rawReceivePower=rawReceivePower, tDMChannelLoopback=tDMChannelLoopback, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, linkModeOptimization=linkModeOptimization, mABNominalTransmitCapacity=mABNominalTransmitCapacity, iPv4Address=iPv4Address, eIRP=eIRP, deviceMACAddress=deviceMACAddress, localPacketFiltering=localPacketFiltering, tFTPServerInternetAddress=tFTPServerInternetAddress, dataBridgingStatusAlarm=dataBridgingStatusAlarm, alarmInstancedTable=alarmInstancedTable, sMTPEnabledMessages=sMTPEnabledMessages, syslogControl=syslogControl, softwareVersion=softwareVersion, licenseCapacity=licenseCapacity, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, userTable=userTable, tFTPClient=tFTPClient, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sFPPortSSMTx=sFPPortSSMTx, PYSNMP_MODULE_ID=cambium, sNTPServerTableNumber=sNTPServerTableNumber, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tDMChannelStatus=tDMChannelStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, transmitPowerLinked=transmitPowerLinked, ethernetInstancedTable=ethernetInstancedTable, txMABFrames=txMABFrames, receiveDataRate=receiveDataRate, apc=apc, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, vectorError=vectorError, routerProtocolsGroup=routerProtocolsGroup, pubInstancedStatsTable=pubInstancedStatsTable, packetsFromInternalStack=packetsFromInternalStack, licenseTDDSyncSupport=licenseTDDSyncSupport, sntp=sntp, sFPPortAllocation=sFPPortAllocation, channelBandwidth=channelBandwidth, licenseInstancedTableEntry=licenseInstancedTableEntry, unavailableSeconds=unavailableSeconds, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installStatusTrap=installStatusTrap, unitIdentificationGroup=unitIdentificationGroup, phyControlGroup=phyControlGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, tempPcb=tempPcb, transparentClockVLAN=transparentClockVLAN, cableDiagPair4Results=cableDiagPair4Results, dfs=dfs, enableTransmission=enableTransmission, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, altitude=altitude, mainPSUPortSSMTx=mainPSUPortSSMTx, dNS=dNS, dNSServerTableEntry=dNSServerTableEntry, byteErrorRatio=byteErrorRatio, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPSync=sNTPSync, vectorErrorLinked=vectorErrorLinked, sNTPServerTableIndex=sNTPServerTableIndex, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, nIDULanPortAutoMdix=nIDULanPortAutoMdix, transmitChannel=transmitChannel, regulatoryBandTrap=regulatoryBandTrap, capacityVariantMismatch=capacityVariantMismatch, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mABProtocolVID=mABProtocolVID, unitOutOfCalibration=unitOutOfCalibration, authorizationControl=authorizationControl, tDDControlGroup=tDDControlGroup, configuration=configuration, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sntpGroup=sntpGroup, iPVersion=iPVersion, signalStrengthRatio=signalStrengthRatio, hTTPPortNumber=hTTPPortNumber, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, cableDiagPair3Results=cableDiagPair3Results, masterSlaveMode=masterSlaveMode, sNMPCommunityString=sNMPCommunityString, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, configurationInstancedTableNumber=configurationInstancedTableNumber, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, cableDiagPair3Distance=cableDiagPair3Distance, receiveModulationMode=receiveModulationMode, sFPPortAutoMdix=sFPPortAutoMdix, sNTPState=sNTPState, phyControl=phyControl, tDMChannelCableLength=tDMChannelCableLength, ethernet=ethernet, ptmp=ptmp, auxPortSyncERxStatus=auxPortSyncERxStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, dfsMeans=dfsMeans, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, cableDiagnosticsControl=cableDiagnosticsControl, nIDULanPortStatusTrap=nIDULanPortStatusTrap, ptpGroups=ptpGroups, remoteInternetAddressType=remoteInternetAddressType, incompatibleMasterAndSlave=incompatibleMasterAndSlave, blacklistRMEnabled=blacklistRMEnabled, unitIdentification=unitIdentification, sMTPServerInternetAddressType=sMTPServerInternetAddressType, alarmInstancedTableNumber=alarmInstancedTableNumber, mABState=mABState, tDMChannelStatusTrap=tDMChannelStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, timeZone=timeZone, phyStatusGroup=phyStatusGroup, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, capacityVariantMismatchLinked=capacityVariantMismatchLinked, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, cableDiagnosticsGroup=cableDiagnosticsGroup, mainPSUPortQLTx=mainPSUPortQLTx, dNSServerPortNumber=dNSServerPortNumber, wirelessTopology=wirelessTopology, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteInternetAddressLinked=remoteInternetAddressLinked, syncESlavePort=syncESlavePort, sFPPortQLTx=sFPPortQLTx, receiveDataRateLinked=receiveDataRateLinked, dNSServerTableIndex=dNSServerTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rxColorCode=rxColorCode, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, tdmTableIndex=tdmTableIndex, smtp=smtp, authorizationControlTableEntry=authorizationControlTableEntry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, configurationGroup=configurationGroup, encryptionGroup=encryptionGroup, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, remoteMACAddressLinked=remoteMACAddressLinked, dNSResolver=dNSResolver, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tDDSynchronizationStatus=tDDSynchronizationStatus, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, aggregateDataRate=aggregateDataRate, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, userTableNumber=userTableNumber, linkLossLinked=linkLossLinked, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, dNSServerInternetAddress=dNSServerInternetAddress, managementGroup=managementGroup, ethernetPriorityTable=ethernetPriorityTable, lowestTDMModulationMode=lowestTDMModulationMode, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mPLSTCPriorityTable=mPLSTCPriorityTable, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, wirelessOutEthernetOctets=wirelessOutEthernetOctets, rangeLinked=rangeLinked, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sNMPTrapVersion=sNMPTrapVersion, userTableEntry=userTableEntry, portAllocationMismatchTrap=portAllocationMismatchTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sMTPEmailAlert=sMTPEmailAlert, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, capacityVariantMismatchTrap=capacityVariantMismatchTrap, ethernetInstancedTableIndex=ethernetInstancedTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, tDMInterfaceControl=tDMInterfaceControl, transmitDataRateLinked=transmitDataRateLinked, receiveFreqKHz=receiveFreqKHz, sFPPortQLRx=sFPPortQLRx, licenseIPv6Support=licenseIPv6Support, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, transmitFreqKHz=transmitFreqKHz, tFTPServerPortNumber=tFTPServerPortNumber, userRole=userRole, dfsPeaks=dfsPeaks, linkName=linkName, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, authorizationControlTableIndex=authorizationControlTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, bridge=bridge, licenseVersion=licenseVersion, transmitModulationModeLinked=transmitModulationModeLinked, tdmTable=tdmTable, blacklistRMMacAddress=blacklistRMMacAddress, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, maximumTransmitPower=maximumTransmitPower, snmpControl=snmpControl, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, ethernetInstancedTableNumber=ethernetInstancedTableNumber, licenseIEEE1588Support=licenseIEEE1588Support, longitude=longitude, receiveFreqMHz=receiveFreqMHz, wirelessLinkStatus=wirelessLinkStatus, dNSServerTableNumber=dNSServerTableNumber, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, deviceMSN=deviceMSN, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, auxPortQLTx=auxPortQLTx, configurationInstancedTable=configurationInstancedTable, oOBPriorityQueueMapping=oOBPriorityQueueMapping, qOSPriorityScheme=qOSPriorityScheme, searchState=searchState, accessMethod=accessMethod, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mainPSUPortAllocation=mainPSUPortAllocation, alarmsGroup=alarmsGroup, sNMPTrapTable=sNMPTrapTable, ethernetStatisticsDataSource=ethernetStatisticsDataSource, transmitDataRate=transmitDataRate, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, byteErrorRatioLinked=byteErrorRatioLinked, installArmState=installArmState, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, transmitFreqMHz=transmitFreqMHz, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cableLoss=cableLoss, authorizationControlGroup=authorizationControlGroup, linkSymmetry=linkSymmetry, sNTPServerStatus=sNTPServerStatus, cableDiagPair1Distance=cableDiagPair1Distance, ptpTraps=ptpTraps, reset=reset, systemClock=systemClock, mainPSUPortAutoMdix=mainPSUPortAutoMdix, channelChangeTrap=channelChangeTrap, licenseRARSupport=licenseRARSupport, iPv6GatewayAddress=iPv6GatewayAddress, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, dNSPrimaryServer=dNSPrimaryServer)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", dSCPManagementPriority=dSCPManagementPriority, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, noWirelessChannelAvailable=noWirelessChannelAvailable, transparentClockVID=transparentClockVID, extendedSpectrumScanning=extendedSpectrumScanning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyControlInstancedTable=phyControlInstancedTable, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, lowestDataModulationMode=lowestDataModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveChannel=receiveChannel, pubStatsGroup=pubStatsGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseBandwidthCap=licenseBandwidthCap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, licenseInstancedTableNumber=licenseInstancedTableNumber, tDMEnabledChannels=tDMEnabledChannels, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, userTableIndex=userTableIndex, licenseGasGroup=licenseGasGroup, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, secureModeAlarm=secureModeAlarm, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, phyInstancedStatusTable=phyInstancedStatusTable, targetRange=targetRange, encryption=encryption, syncEEquipmentClock=syncEEquipmentClock, latitude=latitude, dataBridgingStatus=dataBridgingStatus, mABNominalModulationMode=mABNominalModulationMode, licenseIssueNumber=licenseIssueNumber, transmitterChannels=transmitterChannels, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, wirelessOutOctets=wirelessOutOctets, cableDiagPair2Results=cableDiagPair2Results, subnetMask=subnetMask, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, subbandLowestFrequency=subbandLowestFrequency, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, regulatoryBand=regulatoryBand, auxPortAllocation=auxPortAllocation, authorizationControlTableNumber=authorizationControlTableNumber, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, tDDSynchronizationMode=tDDSynchronizationMode, auxPortSSMTx=auxPortSSMTx, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, licenseTrialPeriod=licenseTrialPeriod, auxPortConfigurationMismatch=auxPortConfigurationMismatch, configurationInstancedTableIndex=configurationInstancedTableIndex, nIDULanPortStatus=nIDULanPortStatus, tDDControl=tDDControl, useVLANForMABProtocol=useVLANForMABProtocol, receiveModulationModeLinked=receiveModulationModeLinked, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, portAllocationMismatch=portAllocationMismatch, tDMChannelLineCode=tDMChannelLineCode)
