...
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", authorizationControlTableNumber=authorizationControlTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, authorizationMethod=authorizationMethod, alarmInstancedTable=alarmInstancedTable, nIDULanPortStatus=nIDULanPortStatus, licenseRARSupport=licenseRARSupport, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dNSServerTable=dNSServerTable, mABState=mABState, antennaSelection=antennaSelection, configurationInstancedTableNumber=configurationInstancedTableNumber, receiveModulationMode=receiveModulationMode, ethernet=ethernet, linkModeOptimizationMismatchLinked=linkModeOptimizationMismatchLinked, sNTPServerAuthenticationProtocol=sNTPServerAuthenticationProtocol, remoteInternetAddressLinked=remoteInternetAddressLinked, receiveModulationModeLinked=receiveModulationModeLinked, licenseIEEE1588Support=licenseIEEE1588Support, phyStatusGroup=phyStatusGroup, cableDiagnostics=cableDiagnostics, pubStats=pubStats, installStatusLinked=installStatusLinked, managementPortWirelessDownAlert=managementPortWirelessDownAlert, accessMethod=accessMethod, sNTPServerResolvedInternetAddress=sNTPServerResolvedInternetAddress, localPacketFiltering=localPacketFiltering, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receiveFreqMHz=receiveFreqMHz, smtp=smtp, tdmTableNumber=tdmTableNumber, tFTPClient=tFTPClient, sMTPEmailAlert=sMTPEmailAlert, dfsTable=dfsTable, licenseSFPPortSupport=licenseSFPPortSupport, ptpCompliance=ptpCompliance, authorizationControl=authorizationControl, tDMGroup=tDMGroup, licenseIPv6Support=licenseIPv6Support, sNMPTrapTable=sNMPTrapTable, ethernetStatisticsRxOctets=ethernetStatisticsRxOctets, sNMPEnabledTraps=sNMPEnabledTraps, tDDControlGroup=tDDControlGroup, softwareVersion=softwareVersion, linkLoss=linkLoss, regulatoryBand=regulatoryBand, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseTrialPeriod=licenseTrialPeriod, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsTableIndex=dfsTableIndex, ethernetStatisticsRxFrames=ethernetStatisticsRxFrames, licenseInstancedTableEntry=licenseInstancedTableEntry, portAllocationMismatch=portAllocationMismatch, wirelessOutAllOctets=wirelessOutAllOctets, capacityVariantMismatchLinked=capacityVariantMismatchLinked, erroredSeconds=erroredSeconds, sNTPServerRetries=sNTPServerRetries, apcGroup=apcGroup, deviceMACAddress=deviceMACAddress, sNTPPrimaryServer=sNTPPrimaryServer, phyControlInstancedTableNumber=phyControlInstancedTableNumber, tDMInterfaceStatus=tDMInterfaceStatus, licenseMaxLinkRange=licenseMaxLinkRange, capacityVariantMismatchTrap=capacityVariantMismatchTrap, receivePowerLinked=receivePowerLinked, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerPortNumber=sNTPServerPortNumber, subnetMask=subnetMask, severelyErroredSeconds=severelyErroredSeconds, snmpControl=snmpControl, packetsFromInternalStack=packetsFromInternalStack, sFPPortSSMTx=sFPPortSSMTx, dNSServerInternetAddressType=dNSServerInternetAddressType, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, eIRP=eIRP, cableDiagnosticsControl=cableDiagnosticsControl, syslogStateTrap=syslogStateTrap, iPv6Address=iPv6Address, extendedSpectrumScanning=extendedSpectrumScanning, portAllocationMismatchTrap=portAllocationMismatchTrap, targetRange=targetRange, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, subbandHighestFrequency=subbandHighestFrequency, vectorErrorLinked=vectorErrorLinked, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, byteErrorRatioLinked=byteErrorRatioLinked, iPv6PrefixLength=iPv6PrefixLength, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, mgmtInstancedTableIndex=mgmtInstancedTableIndex, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseUnitSerialNumber=licenseUnitSerialNumber, mABProtocolVID=mABProtocolVID, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, auxPortAcceptedQLRx=auxPortAcceptedQLRx, smtpGroup=smtpGroup, vLANManagementPriority=vLANManagementPriority, installArmStateTrap=installArmStateTrap, phyControlInstancedTable=phyControlInstancedTable, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, pubInstancedStatsTable=pubInstancedStatsTable, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cambium=cambium, linkName=linkName, productVariant=productVariant, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, wirelessLinkStatus=wirelessLinkStatus, sFPPortQLTx=sFPPortQLTx, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseLongMinimumFirmwareVersion=licenseLongMinimumFirmwareVersion, licenseGroup=licenseGroup, tFTPServerResolvedInternetAddress=tFTPServerResolvedInternetAddress, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, supplementary=supplementary, hCMPMaximumLinkRange=hCMPMaximumLinkRange, mPLSTCPriorityTable=mPLSTCPriorityTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, deviceMSN=deviceMSN, tdmTableIndex=tdmTableIndex, maxLinkRangeExceeded=maxLinkRangeExceeded, maxLinkRangeExceededLinked=maxLinkRangeExceededLinked, mABTransmissionInterval=mABTransmissionInterval, dataBridgingAvailability=dataBridgingAvailability, frequencyVariant=frequencyVariant, sNMPTrapResolvedInternetAddress=sNMPTrapResolvedInternetAddress, rangeLinked=rangeLinked, userTable=userTable, unavailableSeconds=unavailableSeconds, receiveChannel=receiveChannel, dNSServerTableNumber=dNSServerTableNumber, sNMPPortNumber=sNMPPortNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, configurationGroup=configurationGroup, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, transparentClock=transparentClock, telnetPortNumber=telnetPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syncETracking=syncETracking, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, qOSPriorityScheme=qOSPriorityScheme, subbandLowestFrequency=subbandLowestFrequency, ethernetGroup=ethernetGroup, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNTPServerStatus=sNTPServerStatus, sMTPServerPortNumber=sMTPServerPortNumber, mgmtInstancedTable=mgmtInstancedTable, range=range, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userPassword=userPassword, ptpTrapPrefix=ptpTrapPrefix, incompatibleRegulatoryBandsLinked=incompatibleRegulatoryBandsLinked, dNSServerTableEntry=dNSServerTableEntry, configurationInstancedTable=configurationInstancedTable, licenseCapacity=licenseCapacity, managementNetworkAccessEnabled=managementNetworkAccessEnabled, channelBandwidth=channelBandwidth, dNSGroup=dNSGroup, syslogControlGroup=syslogControlGroup, remoteMaximumTransmitPowerLinked=remoteMaximumTransmitPowerLinked, ethernetInstancedTableIndex=ethernetInstancedTableIndex, dfsTableNumber=dfsTableNumber, alarmInstancedTableNumber=alarmInstancedTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sMTPEnabledMessages=sMTPEnabledMessages, lowestDataModulationMode=lowestDataModulationMode, tdmTableEntry=tdmTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, maximumNumberOfSlaves=maximumNumberOfSlaves, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, cableDiagPair3Results=cableDiagPair3Results, ethernetPriorityTableNumber=ethernetPriorityTableNumber, routerProtocolsGroup=routerProtocolsGroup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNTPServerTimeout=sNTPServerTimeout, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, iPv4Address=iPv4Address, transmitModulationMode=transmitModulationMode, transmitModulationModeLinked=transmitModulationModeLinked, sFPPortAutoNegotiation=sFPPortAutoNegotiation, dNS=dNS, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteUnitName=remoteUnitName, byteErrorRatio=byteErrorRatio, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPCommunityString=sNMPCommunityString, alarmsGroup=alarmsGroup, phyControl=phyControl, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, receivePower=receivePower, tDMChannelLoopback=tDMChannelLoopback, productName=productName, mainPSUPortStatus=mainPSUPortStatus, aggregateDataRate=aggregateDataRate, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, wirelessOutOctets=wirelessOutOctets, alarmInstancedTableIndex=alarmInstancedTableIndex, dataBridgingAvailabilityLinked=dataBridgingAvailabilityLinked, aggregateDataRateLinked=aggregateDataRateLinked, licenseTDDSyncSupport=licenseTDDSyncSupport, tDDSynchronizationStatus=tDDSynchronizationStatus, dataBridgingStatusLinked=dataBridgingStatusLinked, vectorError=vectorError, cableDiagnosticsWarning=cableDiagnosticsWarning, mainPSUPortQLTx=mainPSUPortQLTx, signalStrengthRatioLinked=signalStrengthRatioLinked, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogControl=syslogControl, managementGroup=managementGroup, auxPortStatusTrap=auxPortStatusTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transparentClockVID=transparentClockVID, phyControlInstancedTableIndex=phyControlInstancedTableIndex, transmitFreqKHz=transmitFreqKHz, pubInstancedStatsTableEntry=pubInstancedStatsTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, sFPPortStatusTrap=sFPPortStatusTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sFPPortSyncERxStatus=sFPPortSyncERxStatus, blacklistRMMacAddress=blacklistRMMacAddress, ethernetStatisticsRxBroadcasts=ethernetStatisticsRxBroadcasts, lowestTDMModulationMode=lowestTDMModulationMode, encryption=encryption, auxPortQLTx=auxPortQLTx, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimization=linkModeOptimization, ptp=ptp, ethernetInstancedTableNumber=ethernetInstancedTableNumber, PYSNMP_MODULE_ID=cambium, hTTPAccessEnabled=hTTPAccessEnabled, rawReceivePower=rawReceivePower, licenseGroupAccess=licenseGroupAccess, authorizationControlTable=authorizationControlTable, cableDiagnosticsGroup=cableDiagnosticsGroup, syslogClient=syslogClient, sFPPortDisabledWarning=sFPPortDisabledWarning, bridgeGroup=bridgeGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, configurationInstancedTableEntry=configurationInstancedTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDSynchronizationMode=tDDSynchronizationMode, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseInstancedTableIndex=licenseInstancedTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", apc=apc, maximumTransmitPower=maximumTransmitPower, sNTPSyncTrap=sNTPSyncTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, iPVersion=iPVersion, cableLoss=cableLoss, sNTPServerKeyIdentifier=sNTPServerKeyIdentifier, licenseVersion=licenseVersion, ptp670=ptp670, hTTPSAccessEnabled=hTTPSAccessEnabled, userRole=userRole, syncESlavePort=syncESlavePort, aAAControl=aAAControl, remoteInternetAddressTypeLinked=remoteInternetAddressTypeLinked, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, dNSServerTableIndex=dNSServerTableIndex, bootVersion=bootVersion, daylightSaving=daylightSaving, userName=userName, snmpControlGroup=snmpControlGroup, userTableNumber=userTableNumber, wirelessOutEthernetOctets=wirelessOutEthernetOctets, lbtDetectedTrap=lbtDetectedTrap, linkLossLinked=linkLossLinked, systemReset=systemReset, sNTPServerTableNumber=sNTPServerTableNumber, sFPPortQLRxOverwrite=sFPPortQLRxOverwrite, sNTPServerInternetAddress=sNTPServerInternetAddress, versionsGroup=versionsGroup, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, nIDULanPortStatusTrap=nIDULanPortStatusTrap, notificationsGroup=notificationsGroup, tDMChannelCableLength=tDMChannelCableLength, ethernetStatisticsTableNumber=ethernetStatisticsTableNumber, resetGroup=resetGroup, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, receiveDataRateLinked=receiveDataRateLinked, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, transmitDataRate=transmitDataRate, ethernetStatisticsRxFramesOversize=ethernetStatisticsRxFramesOversize, ptpTraps=ptpTraps, tempPcb=tempPcb, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDMEnabledChannels=tDMEnabledChannels, authorizationControlGroup=authorizationControlGroup, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, secureModeAlarmTrap=secureModeAlarmTrap, sFPPortAutoMdix=sFPPortAutoMdix, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, txMABFrames=txMABFrames, tFTPServerPortNumber=tFTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkStatusAlarmTrap=wirelessLinkStatusAlarmTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, unitName=unitName, configurationInstancedTableIndex=configurationInstancedTableIndex, sNTPLastSync=sNTPLastSync, sNMPTrapInternetAddress=sNMPTrapInternetAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseInstancedTable=licenseInstancedTable, mainPSUPortAutoMdix=mainPSUPortAutoMdix, auxPortSyncERxStatus=auxPortSyncERxStatus, sFPError=sFPError, tDMChannelStatusTrap=tDMChannelStatusTrap, pubInstancedStatsTableNumber=pubInstancedStatsTableNumber, ethernetStatisticsTxFrames=ethernetStatisticsTxFrames, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, blacklistRMEnabled=blacklistRMEnabled, mABMaintenanceLevel=mABMaintenanceLevel, latitude=latitude, wirelessTopology=wirelessTopology, sNTPSync=sNTPSync, hardwareVersion=hardwareVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseTLSRekey=licenseTLSRekey, mABNominalModulationMode=mABNominalModulationMode, tDDControl=tDDControl, ethernetInstancedTableEntry=ethernetInstancedTableEntry, sFPPortAllocation=sFPPortAllocation, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPServerInternetAddress=sMTPServerInternetAddress, unitOutOfCalibration=unitOutOfCalibration, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, unitIdentification=unitIdentification, dfsMeans=dfsMeans, userTableEntry=userTableEntry, mABHoldoffPeriod=mABHoldoffPeriod, portAllocationMismatchLinked=portAllocationMismatchLinked, syslogClientTrap=syslogClientTrap, reset=reset, licenseAdvanceHCMPSupport=licenseAdvanceHCMPSupport, phyInstancedStatusTableIndex=phyInstancedStatusTableIndex, incompatibleMasterAndSlaveLinked=incompatibleMasterAndSlaveLinked, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dSCPManagementPriority=dSCPManagementPriority, sNTPServerTable=sNTPServerTable, dataPortPauseFrames=dataPortPauseFrames, sFPPortQLRx=sFPPortQLRx, wirelessLinkStatusAlarm=wirelessLinkStatusAlarm, authorizationControlTableEntry=authorizationControlTableEntry, remoteInternetAddress=remoteInternetAddress, rawReceivePowerLinked=rawReceivePowerLinked, licenseMinFirmwareVersionPTP650Emulation=licenseMinFirmwareVersionPTP650Emulation, auxPortDisabledWarning=auxPortDisabledWarning, telnetAccessEnabled=telnetAccessEnabled, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, transmitterChannels=transmitterChannels, installStatusTrap=installStatusTrap, regulatoryBandTrap=regulatoryBandTrap, alarms=alarms, tdmTable=tdmTable, vLANManagementVID=vLANManagementVID, hCMPLinkSymmetry=hCMPLinkSymmetry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, targetMACAddress=targetMACAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, auxPortQLRx=auxPortQLRx, whitelistRMEnabled=whitelistRMEnabled, sFPErrorTrap=sFPErrorTrap, ethernetInstancedTable=ethernetInstancedTable, dfsPeaks=dfsPeaks, licenseInstancedTableNumber=licenseInstancedTableNumber, altitude=altitude, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, wirelessLinkStatusLinked=wirelessLinkStatusLinked, encryptionGroup=encryptionGroup, phyInstancedStatusTable=phyInstancedStatusTable, dNSResolver=dNSResolver, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sMTPServerResolvedInternetAddress=sMTPServerResolvedInternetAddress, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, atpcHcmpMasterTxPower=atpcHcmpMasterTxPower, mABNominalTransmitCapacity=mABNominalTransmitCapacity, masterSlaveMode=masterSlaveMode, sntpGroup=sntpGroup, tDMChannelLineCode=tDMChannelLineCode, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseBandwidthCap=licenseBandwidthCap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, auxPortAllocation=auxPortAllocation, sNMPTrapVersion=sNMPTrapVersion, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sNTPServerTableEntry=sNTPServerTableEntry, systemClock=systemClock, syslogState=syslogState, remoteMACAddress=remoteMACAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitPower=transmitPower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installArmState=installArmState, bridge=bridge, configuration=configuration, pubStatsGroup=pubStatsGroup, searchState=searchState, secureModeAlarm=secureModeAlarm, licenseIssueNumber=licenseIssueNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, siteName=siteName, phyStatus=phyStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, receiveModulationModeDetailLinked=receiveModulationModeDetailLinked, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, mABProtocolVLANPriority=mABProtocolVLANPriority, transmitPowerLinked=transmitPowerLinked, capacityVariantMismatch=capacityVariantMismatch, sFPPortStatus=sFPPortStatus, syncETrackingState=syncETrackingState, ptpGroups=ptpGroups, pubInstancedStatsTableIndex=pubInstancedStatsTableIndex, userEnabled=userEnabled, management=management, syncEEquipmentClock=syncEEquipmentClock, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseHCMPSupport=licenseHCMPSupport, wirelessLinkAvailabilityLinked=wirelessLinkAvailabilityLinked, ethernetStatisticsTable=ethernetStatisticsTable, cableDiagPair2Distance=cableDiagPair2Distance, hTTPPortNumber=hTTPPortNumber, aAAControlGroup=aAAControlGroup, phyControlInstancedTableEntry=phyControlInstancedTableEntry, hTTPSPortNumber=hTTPSPortNumber, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dfsTableEntry=dfsTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqKHz=receiveFreqKHz, phyInstancedStatusTableEntry=phyInstancedStatusTableEntry, licenseEncryption=licenseEncryption, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, dfsGroup=dfsGroup, searchStateLinked=searchStateLinked, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, oOBPriorityQueueMapping=oOBPriorityQueueMapping, ethernetStatisticsTxBroadcasts=ethernetStatisticsTxBroadcasts, installationMode=installationMode, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, secureLicenseSignatureAlarm=secureLicenseSignatureAlarm, secondarySoftwareVersion=secondarySoftwareVersion, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tDMChannelStatus=tDMChannelStatus, longitude=longitude, remoteMACAddressLinked=remoteMACAddressLinked, txColorCode=txColorCode, signalStrengthRatio=signalStrengthRatio, remoteUnitNameLinked=remoteUnitNameLinked, l2CPPriorityTable=l2CPPriorityTable, transmitFreqMHz=transmitFreqMHz, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, versions=versions, sNTPState=sNTPState, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, timeZone=timeZone, noWirelessChannelAvailable=noWirelessChannelAvailable, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dNSPrimaryServer=dNSPrimaryServer, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, cableDiagPair2Results=cableDiagPair2Results, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerTableIndex=sNTPServerTableIndex, ethernetStatisticsRxFramesWithError=ethernetStatisticsRxFramesWithError, enableTransmission=enableTransmission, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, linkSymmetry=linkSymmetry, licenseCountry=licenseCountry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, cableDiagPair1Distance=cableDiagPair1Distance, whitelistRMMacAddress=whitelistRMMacAddress, alarmInstancedTableEntry=alarmInstancedTableEntry, dataBridgingStatusAlarmLinked=dataBridgingStatusAlarmLinked, transparentClockVLAN=transparentClockVLAN, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, authorizationControlTableIndex=authorizationControlTableIndex, mgmtInstancedTableNumber=mgmtInstancedTableNumber, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, useVLANForMABProtocol=useVLANForMABProtocol, receiveDataRate=receiveDataRate, supplementaryGroup=supplementaryGroup, tDMInterfaceControl=tDMInterfaceControl, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, auxPortStatus=auxPortStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP670-MIB", atpcHcmpMasterTargetRxPower=atpcHcmpMasterTargetRxPower, sntp=sntp, licenseSyncESupport=licenseSyncESupport, dNSServerInternetAddress=dNSServerInternetAddress, phyInstancedStatusTableNumber=phyInstancedStatusTableNumber, licenseGasGroup=licenseGasGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, ethernetStatisticsRxFramesUndersize=ethernetStatisticsRxFramesUndersize, deviceESN=deviceESN, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, groupID=groupID, rangingMode=rangingMode, userTableIndex=userTableIndex, dataBridgingStatus=dataBridgingStatus, channelChangeTrap=channelChangeTrap, license=license, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, packetsToInternalStack=packetsToInternalStack, auxPortSSMTx=auxPortSSMTx, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetStatisticsDataSource=ethernetStatisticsDataSource, antennaGain=antennaGain, dNSServerPortNumber=dNSServerPortNumber, remoteInternetAddressType=remoteInternetAddressType, cableDiagnosticsPorts=cableDiagnosticsPorts, cableDiagPair3Distance=cableDiagPair3Distance, installStatus=installStatus, ethernetStatisticsTableIndex=ethernetStatisticsTableIndex, licenseOOBManagementSupport=licenseOOBManagementSupport, sNTPPollInterval=sNTPPollInterval, ethernetStatisticsTxOctets=ethernetStatisticsTxOctets, rxColorCode=rxColorCode, dataBridgingStatusAlarm=dataBridgingStatusAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, cableDiagPair4Results=cableDiagPair4Results, transmitChannel=transmitChannel, tDM=tDM, unitIdentificationGroup=unitIdentificationGroup, mainPSUPortQLRx=mainPSUPortQLRx, ethernetPriorityTable=ethernetPriorityTable, tLSMinimumSecurityLevel=tLSMinimumSecurityLevel, l2CPPriorityTableIndex=l2CPPriorityTableIndex, gatewayIPAddress=gatewayIPAddress, licenseSecurityLevel=licenseSecurityLevel, ethernetStatisticsTableEntry=ethernetStatisticsTableEntry, cableDiagPair4Distance=cableDiagPair4Distance, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, routerProtocols=routerProtocols, cableDiagPair1Results=cableDiagPair1Results, mgmtInstancedTableEntry=mgmtInstancedTableEntry, mainPSUPortAllocation=mainPSUPortAllocation, secureLicenseSignatureAlarmTrap=secureLicenseSignatureAlarmTrap, ptmp=ptmp, sNMPv3Enable=sNMPv3Enable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transparentClockPort=transparentClockPort, transmitDataRateLinked=transmitDataRateLinked, dfs=dfs)
