...
iso, Unsigned32, Counter64, TimeTicks, Integer32, Counter32, IpAddress, ObjectIdentity, ModuleIdentity, Bits, MibIdentifier, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Counter64", "TimeTicks", "Integer32", "Counter32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Bits", "MibIdentifier", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CADANT-TC", CardSubType=CardSubType, SchedMinute=SchedMinute, CadBridgePortType=CadBridgePortType, MacPortIdWithInvalid=MacPortIdWithInvalid, VlanId=VlanId, CardType=CardType, CadIfDirection=CadIfDirection, PortMode=PortMode, CadIpTosMask=CadIpTosMask, AdminState=AdminState, CadProtocolType=CadProtocolType, UnknownState=UnknownState, CadExtAclCondition=CadExtAclCondition, PortType=PortType, FirmwareSource=FirmwareSource, PicType=PicType, ShelfId=ShelfId, CardId=CardId, DiskVolumeUsageLevel=DiskVolumeUsageLevel, CadBridgeGroupId=CadBridgeGroupId, PortId=PortId, FlowActivityState=FlowActivityState, ServerType=ServerType, CardSubId=CardSubId, CadIpPort=CadIpPort, SchedWeekDay=SchedWeekDay, AAAmethod=AAAmethod, SshAuthMethod=SshAuthMethod, SecondaryState=SecondaryState, MacChlPortType=MacChlPortType, AccountingType=AccountingType, CadTcpFlags=CadTcpFlags, LineType=LineType, SshService=SshService, PortDetectedMode=PortDetectedMode, SchedDay=SchedDay, FlowControlMode=FlowControlMode, CadIpTos=CadIpTos, PrimaryState=PrimaryState, OUIAddress=OUIAddress, SshCipherType=SshCipherType, EqActionType=EqActionType, SshCipher=SshCipher, SchedMonth=SchedMonth, DuplexStatus=DuplexStatus, MacPortId=MacPortId, SshProtocol=SshProtocol, CadAclString=CadAclString, InetAddressIPv4or6=InetAddressIPv4or6, SshMacAlg=SshMacAlg, PYSNMP_MODULE_ID=cadTextualConventions, CadAclType=CadAclType, OverloadStatus=OverloadStatus, SchedHour=SchedHour, CadCpeDeviceTypes=CadCpeDeviceTypes, CadDouble=CadDouble, cadTextualConventions=cadTextualConventions)
