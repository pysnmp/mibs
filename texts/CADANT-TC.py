...
Counter64, ModuleIdentity, Integer32, NotificationType, IpAddress, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, Gauge32, iso, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Integer32", "NotificationType", "IpAddress", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "Gauge32", "iso", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("CADANT-TC", FlowControlMode=FlowControlMode, SchedMonth=SchedMonth, MacPortIdWithInvalid=MacPortIdWithInvalid, DiskVolumeUsageLevel=DiskVolumeUsageLevel, SchedWeekDay=SchedWeekDay, FirmwareSource=FirmwareSource, SchedHour=SchedHour, PortType=PortType, SshCipherType=SshCipherType, VlanId=VlanId, CadDouble=CadDouble, SshMacAlg=SshMacAlg, CardType=CardType, CadProtocolType=CadProtocolType, OUIAddress=OUIAddress, CadExtAclCondition=CadExtAclCondition, SchedDay=SchedDay, CadCpeDeviceTypes=CadCpeDeviceTypes, AccountingType=AccountingType, PicType=PicType, InetAddressIPv4or6=InetAddressIPv4or6, MacPortId=MacPortId, PortMode=PortMode, SecondaryState=SecondaryState, ServerType=ServerType, CadIfDirection=CadIfDirection, PYSNMP_MODULE_ID=cadTextualConventions, MacChlPortType=MacChlPortType, CardSubId=CardSubId, PortId=PortId, OverloadStatus=OverloadStatus, CadIpTosMask=CadIpTosMask, CadIpPort=CadIpPort, SshAuthMethod=SshAuthMethod, LineType=LineType, SchedMinute=SchedMinute, SshProtocol=SshProtocol, ShelfId=ShelfId, DuplexStatus=DuplexStatus, CardId=CardId, cadTextualConventions=cadTextualConventions, CadIpTos=CadIpTos, SshService=SshService, FlowActivityState=FlowActivityState, PortDetectedMode=PortDetectedMode, CadAclString=CadAclString, AdminState=AdminState, CadTcpFlags=CadTcpFlags, SshCipher=SshCipher, CadBridgePortType=CadBridgePortType, AAAmethod=AAAmethod, CardSubType=CardSubType, CadAclType=CadAclType, PrimaryState=PrimaryState, UnknownState=UnknownState, EqActionType=EqActionType, CadBridgeGroupId=CadBridgeGroupId)
