...
TimeTicks, Unsigned32, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, MibIdentifier, ObjectIdentity, Counter64, Integer32, IpAddress, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "MibIdentifier", "ObjectIdentity", "Counter64", "Integer32", "IpAddress", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("CADANT-TC", CadIfDirection=CadIfDirection, SshCipher=SshCipher, EqActionType=EqActionType, PortId=PortId, SshService=SshService, SchedDay=SchedDay, VlanId=VlanId, CadCpeDeviceTypes=CadCpeDeviceTypes, DiskVolumeUsageLevel=DiskVolumeUsageLevel, SshCipherType=SshCipherType, MacPortIdWithInvalid=MacPortIdWithInvalid, ShelfId=ShelfId, SchedWeekDay=SchedWeekDay, SecondaryState=SecondaryState, SshAuthMethod=SshAuthMethod, InetAddressIPv4or6=InetAddressIPv4or6, CadDouble=CadDouble, CardSubType=CardSubType, LineType=LineType, FirmwareSource=FirmwareSource, FlowControlMode=FlowControlMode, SshMacAlg=SshMacAlg, SshProtocol=SshProtocol, FlowActivityState=FlowActivityState, CadIpTos=CadIpTos, PicType=PicType, PortMode=PortMode, PortDetectedMode=PortDetectedMode, CadExtAclCondition=CadExtAclCondition, cadTextualConventions=cadTextualConventions, CardId=CardId, OverloadStatus=OverloadStatus, AdminState=AdminState, SchedHour=SchedHour, CadBridgePortType=CadBridgePortType, CadIpTosMask=CadIpTosMask, CadAclString=CadAclString, MacChlPortType=MacChlPortType, AccountingType=AccountingType, SchedMonth=SchedMonth, CadTcpFlags=CadTcpFlags, CardSubId=CardSubId, CadProtocolType=CadProtocolType, AAAmethod=AAAmethod, PYSNMP_MODULE_ID=cadTextualConventions, UnknownState=UnknownState, DuplexStatus=DuplexStatus, CadBridgeGroupId=CadBridgeGroupId, CadIpPort=CadIpPort, ServerType=ServerType, MacPortId=MacPortId, CardType=CardType, SchedMinute=SchedMinute, OUIAddress=OUIAddress, PrimaryState=PrimaryState, CadAclType=CadAclType, PortType=PortType)
