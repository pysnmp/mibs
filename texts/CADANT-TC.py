...
Bits, Counter32, iso, MibIdentifier, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, NotificationType, Gauge32, Unsigned32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "iso", "MibIdentifier", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "NotificationType", "Gauge32", "Unsigned32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("CADANT-TC", SshCipherType=SshCipherType, ServerType=ServerType, AccountingType=AccountingType, CadBridgePortType=CadBridgePortType, DuplexStatus=DuplexStatus, AdminState=AdminState, PrimaryState=PrimaryState, InetAddressIPv4or6=InetAddressIPv4or6, MacPortIdWithInvalid=MacPortIdWithInvalid, FlowControlMode=FlowControlMode, FlowActivityState=FlowActivityState, CadTcpFlags=CadTcpFlags, CadIpPort=CadIpPort, SchedMinute=SchedMinute, SshProtocol=SshProtocol, MacPortId=MacPortId, UnknownState=UnknownState, CadAclType=CadAclType, CadIpTos=CadIpTos, CadBridgeGroupId=CadBridgeGroupId, CadDouble=CadDouble, CadExtAclCondition=CadExtAclCondition, CadProtocolType=CadProtocolType, SshMacAlg=SshMacAlg, SchedMonth=SchedMonth, CardSubType=CardSubType, CadCpeDeviceTypes=CadCpeDeviceTypes, PortDetectedMode=PortDetectedMode, MacChlPortType=MacChlPortType, VlanId=VlanId, EqActionType=EqActionType, SshAuthMethod=SshAuthMethod, ShelfId=ShelfId, LineType=LineType, FirmwareSource=FirmwareSource, SchedDay=SchedDay, CardType=CardType, SecondaryState=SecondaryState, cadTextualConventions=cadTextualConventions, PortMode=PortMode, PortId=PortId, PYSNMP_MODULE_ID=cadTextualConventions, SshService=SshService, CadIpTosMask=CadIpTosMask, CadAclString=CadAclString, DiskVolumeUsageLevel=DiskVolumeUsageLevel, SchedHour=SchedHour, OverloadStatus=OverloadStatus, CadIfDirection=CadIfDirection, OUIAddress=OUIAddress, PicType=PicType, AAAmethod=AAAmethod, SshCipher=SshCipher, CardId=CardId, PortType=PortType, SchedWeekDay=SchedWeekDay, CardSubId=CardSubId)
