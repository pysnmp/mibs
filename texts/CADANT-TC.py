...
IpAddress, Counter64, Counter32, ModuleIdentity, Bits, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Integer32, Unsigned32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "Counter32", "ModuleIdentity", "Bits", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Integer32", "Unsigned32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("CADANT-TC", CadIpTos=CadIpTos, SchedHour=SchedHour, CadExtAclCondition=CadExtAclCondition, CardSubType=CardSubType, MacChlPortType=MacChlPortType, CadAclType=CadAclType, CadCpeDeviceTypes=CadCpeDeviceTypes, EqActionType=EqActionType, FlowActivityState=FlowActivityState, CadDouble=CadDouble, CardType=CardType, PortMode=PortMode, AccountingType=AccountingType, CadTcpFlags=CadTcpFlags, InetAddressIPv4or6=InetAddressIPv4or6, ShelfId=ShelfId, PortType=PortType, CadAclString=CadAclString, cadTextualConventions=cadTextualConventions, CardSubId=CardSubId, FirmwareSource=FirmwareSource, PortDetectedMode=PortDetectedMode, DiskVolumeUsageLevel=DiskVolumeUsageLevel, AAAmethod=AAAmethod, DuplexStatus=DuplexStatus, SchedWeekDay=SchedWeekDay, SshCipher=SshCipher, SchedDay=SchedDay, SshProtocol=SshProtocol, MacPortIdWithInvalid=MacPortIdWithInvalid, LineType=LineType, SshMacAlg=SshMacAlg, OUIAddress=OUIAddress, PYSNMP_MODULE_ID=cadTextualConventions, FlowControlMode=FlowControlMode, SecondaryState=SecondaryState, SchedMinute=SchedMinute, SchedMonth=SchedMonth, SshService=SshService, CadIpTosMask=CadIpTosMask, SshCipherType=SshCipherType, CadProtocolType=CadProtocolType, PortId=PortId, MacPortId=MacPortId, OverloadStatus=OverloadStatus, UnknownState=UnknownState, ServerType=ServerType, CadBridgePortType=CadBridgePortType, VlanId=VlanId, PrimaryState=PrimaryState, PicType=PicType, CadIfDirection=CadIfDirection, CadIpPort=CadIpPort, CadBridgeGroupId=CadBridgeGroupId, CardId=CardId, SshAuthMethod=SshAuthMethod, AdminState=AdminState)
