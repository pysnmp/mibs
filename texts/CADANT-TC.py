...
Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Bits, MibIdentifier, Integer32, NotificationType, Gauge32, Counter32, Counter64, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Bits", "MibIdentifier", "Integer32", "NotificationType", "Gauge32", "Counter32", "Counter64", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("CADANT-TC", SshAuthMethod=SshAuthMethod, DuplexStatus=DuplexStatus, MacPortIdWithInvalid=MacPortIdWithInvalid, CadIpPort=CadIpPort, SecondaryState=SecondaryState, CadTcpFlags=CadTcpFlags, SshMacAlg=SshMacAlg, CadAclType=CadAclType, SchedDay=SchedDay, CadAclString=CadAclString, MacChlPortType=MacChlPortType, AccountingType=AccountingType, UnknownState=UnknownState, CardType=CardType, DiskVolumeUsageLevel=DiskVolumeUsageLevel, SchedMonth=SchedMonth, CadIfDirection=CadIfDirection, PortId=PortId, SshService=SshService, CadExtAclCondition=CadExtAclCondition, SshCipherType=SshCipherType, LineType=LineType, FlowActivityState=FlowActivityState, SchedWeekDay=SchedWeekDay, FlowControlMode=FlowControlMode, CadCpeDeviceTypes=CadCpeDeviceTypes, AdminState=AdminState, FirmwareSource=FirmwareSource, EqActionType=EqActionType, PortDetectedMode=PortDetectedMode, CardId=CardId, AAAmethod=AAAmethod, SshCipher=SshCipher, PortMode=PortMode, InetAddressIPv4or6=InetAddressIPv4or6, PYSNMP_MODULE_ID=cadTextualConventions, CardSubType=CardSubType, PicType=PicType, SshProtocol=SshProtocol, SchedMinute=SchedMinute, CadIpTosMask=CadIpTosMask, MacPortId=MacPortId, ShelfId=ShelfId, CadBridgeGroupId=CadBridgeGroupId, CadIpTos=CadIpTos, CadProtocolType=CadProtocolType, ServerType=ServerType, PortType=PortType, PrimaryState=PrimaryState, SchedHour=SchedHour, OUIAddress=OUIAddress, VlanId=VlanId, OverloadStatus=OverloadStatus, CadBridgePortType=CadBridgePortType, cadTextualConventions=cadTextualConventions, CadDouble=CadDouble, CardSubId=CardSubId)
