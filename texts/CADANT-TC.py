...
TimeTicks, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Counter32, Bits, Unsigned32, MibIdentifier, Integer32, iso, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Counter32", "Bits", "Unsigned32", "MibIdentifier", "Integer32", "iso", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("CADANT-TC", SshService=SshService, CardId=CardId, ShelfId=ShelfId, OUIAddress=OUIAddress, AAAmethod=AAAmethod, FlowActivityState=FlowActivityState, CadIpTosMask=CadIpTosMask, PortMode=PortMode, SchedMinute=SchedMinute, SchedDay=SchedDay, PicType=PicType, SshCipher=SshCipher, PortId=PortId, FirmwareSource=FirmwareSource, CadTcpFlags=CadTcpFlags, CadAclType=CadAclType, SchedHour=SchedHour, VlanId=VlanId, SecondaryState=SecondaryState, ServerType=ServerType, MacPortIdWithInvalid=MacPortIdWithInvalid, CadDouble=CadDouble, CadIfDirection=CadIfDirection, CadIpTos=CadIpTos, CardSubId=CardSubId, CardType=CardType, CadBridgeGroupId=CadBridgeGroupId, SshMacAlg=SshMacAlg, CadExtAclCondition=CadExtAclCondition, AccountingType=AccountingType, SchedWeekDay=SchedWeekDay, PortDetectedMode=PortDetectedMode, CadAclString=CadAclString, MacChlPortType=MacChlPortType, CadBridgePortType=CadBridgePortType, CadIpPort=CadIpPort, cadTextualConventions=cadTextualConventions, CadProtocolType=CadProtocolType, SshProtocol=SshProtocol, DuplexStatus=DuplexStatus, CardSubType=CardSubType, FlowControlMode=FlowControlMode, SshAuthMethod=SshAuthMethod, MacPortId=MacPortId, LineType=LineType, SchedMonth=SchedMonth, InetAddressIPv4or6=InetAddressIPv4or6, SshCipherType=SshCipherType, EqActionType=EqActionType, PrimaryState=PrimaryState, DiskVolumeUsageLevel=DiskVolumeUsageLevel, CadCpeDeviceTypes=CadCpeDeviceTypes, PortType=PortType, PYSNMP_MODULE_ID=cadTextualConventions, UnknownState=UnknownState, OverloadStatus=OverloadStatus, AdminState=AdminState)
