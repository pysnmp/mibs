...
ObjectIdentity, Counter64, iso, TimeTicks, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, MibIdentifier, Bits, NotificationType, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "iso", "TimeTicks", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "MibIdentifier", "Bits", "NotificationType", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("CADANT-TC", CadIpTos=CadIpTos, FlowControlMode=FlowControlMode, SshMacAlg=SshMacAlg, AccountingType=AccountingType, AdminState=AdminState, FlowActivityState=FlowActivityState, InetAddressIPv4or6=InetAddressIPv4or6, CadDouble=CadDouble, OUIAddress=OUIAddress, CadCpeDeviceTypes=CadCpeDeviceTypes, UnknownState=UnknownState, SecondaryState=SecondaryState, CadExtAclCondition=CadExtAclCondition, LineType=LineType, SshAuthMethod=SshAuthMethod, DuplexStatus=DuplexStatus, PrimaryState=PrimaryState, MacChlPortType=MacChlPortType, CadIpTosMask=CadIpTosMask, SchedMinute=SchedMinute, CardId=CardId, CadIfDirection=CadIfDirection, CadProtocolType=CadProtocolType, SshCipherType=SshCipherType, SshCipher=SshCipher, ServerType=ServerType, PortId=PortId, CadAclString=CadAclString, MacPortId=MacPortId, CadBridgePortType=CadBridgePortType, AAAmethod=AAAmethod, CadTcpFlags=CadTcpFlags, DiskVolumeUsageLevel=DiskVolumeUsageLevel, SchedDay=SchedDay, SshService=SshService, SchedHour=SchedHour, CadIpPort=CadIpPort, PicType=PicType, SchedWeekDay=SchedWeekDay, OverloadStatus=OverloadStatus, VlanId=VlanId, CardType=CardType, MacPortIdWithInvalid=MacPortIdWithInvalid, PYSNMP_MODULE_ID=cadTextualConventions, ShelfId=ShelfId, CadBridgeGroupId=CadBridgeGroupId, SchedMonth=SchedMonth, CardSubId=CardSubId, SshProtocol=SshProtocol, CardSubType=CardSubType, PortType=PortType, PortMode=PortMode, CadAclType=CadAclType, FirmwareSource=FirmwareSource, EqActionType=EqActionType, PortDetectedMode=PortDetectedMode, cadTextualConventions=cadTextualConventions)
