...
ModuleIdentity, MibIdentifier, Gauge32, Unsigned32, Integer32, ObjectIdentity, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Counter64, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "Gauge32", "Unsigned32", "Integer32", "ObjectIdentity", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Counter64", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("CADANT-TC", CadBridgeGroupId=CadBridgeGroupId, AdminState=AdminState, EqActionType=EqActionType, CardSubId=CardSubId, MacPortIdWithInvalid=MacPortIdWithInvalid, CadBridgePortType=CadBridgePortType, CadTcpFlags=CadTcpFlags, SchedHour=SchedHour, DiskVolumeUsageLevel=DiskVolumeUsageLevel, CardType=CardType, CadIpTosMask=CadIpTosMask, InetAddressIPv4or6=InetAddressIPv4or6, CadIfDirection=CadIfDirection, PYSNMP_MODULE_ID=cadTextualConventions, CadProtocolType=CadProtocolType, PortMode=PortMode, OUIAddress=OUIAddress, CadCpeDeviceTypes=CadCpeDeviceTypes, SshCipher=SshCipher, FlowControlMode=FlowControlMode, CadExtAclCondition=CadExtAclCondition, AccountingType=AccountingType, PortId=PortId, AAAmethod=AAAmethod, VlanId=VlanId, SchedWeekDay=SchedWeekDay, OverloadStatus=OverloadStatus, CardId=CardId, MacChlPortType=MacChlPortType, LineType=LineType, SchedDay=SchedDay, ShelfId=ShelfId, CardSubType=CardSubType, cadTextualConventions=cadTextualConventions, SshMacAlg=SshMacAlg, CadDouble=CadDouble, PortType=PortType, DuplexStatus=DuplexStatus, CadAclType=CadAclType, CadIpPort=CadIpPort, FirmwareSource=FirmwareSource, SchedMinute=SchedMinute, UnknownState=UnknownState, SchedMonth=SchedMonth, PrimaryState=PrimaryState, SecondaryState=SecondaryState, SshProtocol=SshProtocol, PicType=PicType, FlowActivityState=FlowActivityState, ServerType=ServerType, SshService=SshService, CadAclString=CadAclString, CadIpTos=CadIpTos, MacPortId=MacPortId, SshAuthMethod=SshAuthMethod, SshCipherType=SshCipherType, PortDetectedMode=PortDetectedMode)
