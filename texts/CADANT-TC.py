...
NotificationType, ModuleIdentity, iso, Counter64, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, ObjectIdentity, TimeTicks, MibIdentifier, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "iso", "Counter64", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("CADANT-TC", CadDouble=CadDouble, FlowControlMode=FlowControlMode, CadBridgeGroupId=CadBridgeGroupId, ShelfId=ShelfId, SshService=SshService, CadBridgePortType=CadBridgePortType, PortDetectedMode=PortDetectedMode, PYSNMP_MODULE_ID=cadTextualConventions, ServerType=ServerType, SchedMonth=SchedMonth, SchedMinute=SchedMinute, CadIpTos=CadIpTos, LineType=LineType, PrimaryState=PrimaryState, CadCpeDeviceTypes=CadCpeDeviceTypes, SchedWeekDay=SchedWeekDay, SshCipherType=SshCipherType, MacPortIdWithInvalid=MacPortIdWithInvalid, CadAclType=CadAclType, CardSubType=CardSubType, FirmwareSource=FirmwareSource, CadIpTosMask=CadIpTosMask, CadAclString=CadAclString, DiskVolumeUsageLevel=DiskVolumeUsageLevel, MacPortId=MacPortId, PortId=PortId, OUIAddress=OUIAddress, SshMacAlg=SshMacAlg, PicType=PicType, DuplexStatus=DuplexStatus, InetAddressIPv4or6=InetAddressIPv4or6, SchedHour=SchedHour, AAAmethod=AAAmethod, CadIpPort=CadIpPort, SchedDay=SchedDay, VlanId=VlanId, FlowActivityState=FlowActivityState, CadTcpFlags=CadTcpFlags, CadIfDirection=CadIfDirection, EqActionType=EqActionType, PortMode=PortMode, OverloadStatus=OverloadStatus, CadExtAclCondition=CadExtAclCondition, AccountingType=AccountingType, CadProtocolType=CadProtocolType, MacChlPortType=MacChlPortType, CardSubId=CardSubId, UnknownState=UnknownState, CardType=CardType, cadTextualConventions=cadTextualConventions, SecondaryState=SecondaryState, PortType=PortType, SshAuthMethod=SshAuthMethod, AdminState=AdminState, SshProtocol=SshProtocol, SshCipher=SshCipher, CardId=CardId)
