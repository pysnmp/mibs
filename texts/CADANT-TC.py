...
Counter32, Gauge32, ObjectIdentity, NotificationType, Counter64, Bits, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, MibIdentifier, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ObjectIdentity", "NotificationType", "Counter64", "Bits", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "MibIdentifier", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("CADANT-TC", InetAddressIPv4or6=InetAddressIPv4or6, OverloadStatus=OverloadStatus, MacPortId=MacPortId, SshCipherType=SshCipherType, CadCpeDeviceTypes=CadCpeDeviceTypes, AccountingType=AccountingType, CardType=CardType, CardSubType=CardSubType, CadIpTosMask=CadIpTosMask, CadTcpFlags=CadTcpFlags, SshAuthMethod=SshAuthMethod, DiskVolumeUsageLevel=DiskVolumeUsageLevel, AdminState=AdminState, CardSubId=CardSubId, EqActionType=EqActionType, VlanId=VlanId, CadAclType=CadAclType, PicType=PicType, CadIfDirection=CadIfDirection, CardId=CardId, MacChlPortType=MacChlPortType, MacPortIdWithInvalid=MacPortIdWithInvalid, DuplexStatus=DuplexStatus, PortType=PortType, SshProtocol=SshProtocol, SshService=SshService, CadExtAclCondition=CadExtAclCondition, CadAclString=CadAclString, PortMode=PortMode, AAAmethod=AAAmethod, ServerType=ServerType, PYSNMP_MODULE_ID=cadTextualConventions, CadDouble=CadDouble, ShelfId=ShelfId, CadProtocolType=CadProtocolType, PortDetectedMode=PortDetectedMode, SshCipher=SshCipher, CadIpPort=CadIpPort, CadBridgePortType=CadBridgePortType, PrimaryState=PrimaryState, UnknownState=UnknownState, SchedWeekDay=SchedWeekDay, PortId=PortId, FirmwareSource=FirmwareSource, CadBridgeGroupId=CadBridgeGroupId, FlowActivityState=FlowActivityState, CadIpTos=CadIpTos, LineType=LineType, SchedMonth=SchedMonth, SchedMinute=SchedMinute, OUIAddress=OUIAddress, SchedHour=SchedHour, SecondaryState=SecondaryState, FlowControlMode=FlowControlMode, SshMacAlg=SshMacAlg, cadTextualConventions=cadTextualConventions, SchedDay=SchedDay)
