...
NotificationType, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Counter32, IpAddress, Gauge32, ObjectIdentity, Bits, ModuleIdentity, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Counter32", "IpAddress", "Gauge32", "ObjectIdentity", "Bits", "ModuleIdentity", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("CADANT-TC", CardId=CardId, cadTextualConventions=cadTextualConventions, OverloadStatus=OverloadStatus, CadDouble=CadDouble, CadAclString=CadAclString, OUIAddress=OUIAddress, CardType=CardType, AdminState=AdminState, InetAddressIPv4or6=InetAddressIPv4or6, CadIpPort=CadIpPort, PortMode=PortMode, MacChlPortType=MacChlPortType, ServerType=ServerType, CadExtAclCondition=CadExtAclCondition, DuplexStatus=DuplexStatus, EqActionType=EqActionType, FirmwareSource=FirmwareSource, CardSubType=CardSubType, PortDetectedMode=PortDetectedMode, LineType=LineType, SchedWeekDay=SchedWeekDay, CadCpeDeviceTypes=CadCpeDeviceTypes, CadTcpFlags=CadTcpFlags, DiskVolumeUsageLevel=DiskVolumeUsageLevel, PortType=PortType, ShelfId=ShelfId, SchedDay=SchedDay, CadIpTosMask=CadIpTosMask, VlanId=VlanId, SshCipher=SshCipher, AAAmethod=AAAmethod, CadIfDirection=CadIfDirection, MacPortId=MacPortId, PYSNMP_MODULE_ID=cadTextualConventions, SecondaryState=SecondaryState, SshService=SshService, SshCipherType=SshCipherType, PicType=PicType, FlowActivityState=FlowActivityState, CardSubId=CardSubId, MacPortIdWithInvalid=MacPortIdWithInvalid, AccountingType=AccountingType, CadProtocolType=CadProtocolType, UnknownState=UnknownState, SshAuthMethod=SshAuthMethod, CadAclType=CadAclType, SshProtocol=SshProtocol, FlowControlMode=FlowControlMode, PortId=PortId, CadBridgePortType=CadBridgePortType, PrimaryState=PrimaryState, SchedMonth=SchedMonth, CadIpTos=CadIpTos, SchedHour=SchedHour, SchedMinute=SchedMinute, CadBridgeGroupId=CadBridgeGroupId, SshMacAlg=SshMacAlg)
