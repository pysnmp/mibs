...
iso, MibIdentifier, Gauge32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, ModuleIdentity, Counter64, Integer32, Bits, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Gauge32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Counter64", "Integer32", "Bits", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("CADANT-TC", InetAddressIPv4or6=InetAddressIPv4or6, ShelfId=ShelfId, CadIpTosMask=CadIpTosMask, SchedMonth=SchedMonth, PortMode=PortMode, DiskVolumeUsageLevel=DiskVolumeUsageLevel, SshProtocol=SshProtocol, AAAmethod=AAAmethod, CadTcpFlags=CadTcpFlags, SchedMinute=SchedMinute, PYSNMP_MODULE_ID=cadTextualConventions, CadAclString=CadAclString, PortType=PortType, MacPortId=MacPortId, OverloadStatus=OverloadStatus, SshCipherType=SshCipherType, SshMacAlg=SshMacAlg, DuplexStatus=DuplexStatus, FlowActivityState=FlowActivityState, AccountingType=AccountingType, CadIpTos=CadIpTos, CardSubId=CardSubId, PortDetectedMode=PortDetectedMode, VlanId=VlanId, FlowControlMode=FlowControlMode, SchedDay=SchedDay, CadIfDirection=CadIfDirection, CardSubType=CardSubType, ServerType=ServerType, cadTextualConventions=cadTextualConventions, FirmwareSource=FirmwareSource, CadAclType=CadAclType, CardId=CardId, SshAuthMethod=SshAuthMethod, CadCpeDeviceTypes=CadCpeDeviceTypes, CardType=CardType, CadDouble=CadDouble, CadProtocolType=CadProtocolType, CadBridgeGroupId=CadBridgeGroupId, OUIAddress=OUIAddress, MacChlPortType=MacChlPortType, PrimaryState=PrimaryState, CadIpPort=CadIpPort, UnknownState=UnknownState, EqActionType=EqActionType, CadExtAclCondition=CadExtAclCondition, SecondaryState=SecondaryState, LineType=LineType, SshService=SshService, SchedWeekDay=SchedWeekDay, MacPortIdWithInvalid=MacPortIdWithInvalid, SchedHour=SchedHour, PortId=PortId, PicType=PicType, SshCipher=SshCipher, CadBridgePortType=CadBridgePortType, AdminState=AdminState)
