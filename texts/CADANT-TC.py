...
ObjectIdentity, ModuleIdentity, Counter32, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, TimeTicks, Bits, IpAddress, Unsigned32, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Counter32", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "TimeTicks", "Bits", "IpAddress", "Unsigned32", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("CADANT-TC", MacPortId=MacPortId, CardSubId=CardSubId, CadIfDirection=CadIfDirection, SshService=SshService, VlanId=VlanId, CadExtAclCondition=CadExtAclCondition, SchedDay=SchedDay, CadCpeDeviceTypes=CadCpeDeviceTypes, CardType=CardType, MacChlPortType=MacChlPortType, OUIAddress=OUIAddress, ServerType=ServerType, PYSNMP_MODULE_ID=cadTextualConventions, DuplexStatus=DuplexStatus, CadIpTos=CadIpTos, LineType=LineType, OverloadStatus=OverloadStatus, CadBridgePortType=CadBridgePortType, FlowActivityState=FlowActivityState, SshAuthMethod=SshAuthMethod, CadBridgeGroupId=CadBridgeGroupId, CadDouble=CadDouble, ShelfId=ShelfId, AccountingType=AccountingType, SchedMinute=SchedMinute, InetAddressIPv4or6=InetAddressIPv4or6, DiskVolumeUsageLevel=DiskVolumeUsageLevel, CardSubType=CardSubType, PrimaryState=PrimaryState, PortMode=PortMode, SchedWeekDay=SchedWeekDay, SshProtocol=SshProtocol, SchedHour=SchedHour, cadTextualConventions=cadTextualConventions, SshCipher=SshCipher, CadProtocolType=CadProtocolType, FirmwareSource=FirmwareSource, CadIpTosMask=CadIpTosMask, SshMacAlg=SshMacAlg, AAAmethod=AAAmethod, CadAclType=CadAclType, PicType=PicType, PortType=PortType, PortId=PortId, SchedMonth=SchedMonth, CardId=CardId, MacPortIdWithInvalid=MacPortIdWithInvalid, CadTcpFlags=CadTcpFlags, PortDetectedMode=PortDetectedMode, AdminState=AdminState, CadIpPort=CadIpPort, CadAclString=CadAclString, SecondaryState=SecondaryState, FlowControlMode=FlowControlMode, UnknownState=UnknownState, SshCipherType=SshCipherType, EqActionType=EqActionType)
