...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrStorageDescr=hrStorageDescr, hrSWRunType=hrSWRunType, hrPartitionSize=hrPartitionSize, hrSWInstalledName=hrSWInstalledName, hrDeviceErrors=hrDeviceErrors, hrDiskStorageAccess=hrDiskStorageAccess, hrSWInstalledGroup=hrSWInstalledGroup, hrMIBCompliances=hrMIBCompliances, hrSWInstalledDate=hrSWInstalledDate, hrFSBootable=hrFSBootable, hrStorageGroup=hrStorageGroup, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrDeviceID=hrDeviceID, hrDeviceStatus=hrDeviceStatus, hrSWRunPerfGroup=hrSWRunPerfGroup, hrSWInstalledType=hrSWInstalledType, hrSWRunTable=hrSWRunTable, hrFSIndex=hrFSIndex, hrDeviceType=hrDeviceType, hrSWRunPerfMem=hrSWRunPerfMem, hrSWRunIndex=hrSWRunIndex, hrStorageType=hrStorageType, hrSWRunID=hrSWRunID, hrPartitionTable=hrPartitionTable, hrDiskStorageCapacity=hrDiskStorageCapacity, hrPartitionFSIndex=hrPartitionFSIndex, hrSWRunName=hrSWRunName, hrStorageTypes=hrStorageTypes, hrStorageIndex=hrStorageIndex, hrNetworkIfIndex=hrNetworkIfIndex, hrSWRunStatus=hrSWRunStatus, hrFSTable=hrFSTable, hrDevice=hrDevice, hrPartitionEntry=hrPartitionEntry, hrSystemNumUsers=hrSystemNumUsers, hrSWInstalledTable=hrSWInstalledTable, hrSWRun=hrSWRun, hrDeviceGroup=hrDeviceGroup, hrStorageTable=hrStorageTable, host=host, hrSystemDate=hrSystemDate, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrStorage=hrStorage, hrProcessorFrwID=hrProcessorFrwID, hrStorageUsed=hrStorageUsed, hrSystemUptime=hrSystemUptime, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, KBytes=KBytes, hrSystemProcesses=hrSystemProcesses, hrPrinterTable=hrPrinterTable, hrSWInstalledLastChange=hrSWInstalledLastChange, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrStorageEntry=hrStorageEntry, hrProcessorLoad=hrProcessorLoad, hrFSType=hrFSType, PYSNMP_MODULE_ID=hostResourcesMibModule, ProductID=ProductID, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSWInstalledIndex=hrSWInstalledIndex, hrDeviceIndex=hrDeviceIndex, hrDiskStorageMedia=hrDiskStorageMedia, hrDeviceTypes=hrDeviceTypes, hrSWRunPath=hrSWRunPath, hrDeviceEntry=hrDeviceEntry, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrMIBAdminInfo=hrMIBAdminInfo, hrNetworkEntry=hrNetworkEntry, hrPrinterEntry=hrPrinterEntry, hrDiskStorageEntry=hrDiskStorageEntry, hrPartitionID=hrPartitionID, hrFSTypes=hrFSTypes, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrFSStorageIndex=hrFSStorageIndex, hrDeviceDescr=hrDeviceDescr, hrMIBGroups=hrMIBGroups, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hostResourcesMibModule=hostResourcesMibModule, hrSystem=hrSystem, hrMIBCompliance=hrMIBCompliance, hrDeviceTable=hrDeviceTable, hrDiskStorageTable=hrDiskStorageTable, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSWInstalled=hrSWInstalled, hrMemorySize=hrMemorySize, hrSWRunPerfTable=hrSWRunPerfTable, hrSWRunPerfEntry=hrSWRunPerfEntry, hrPartitionIndex=hrPartitionIndex, hrSWRunEntry=hrSWRunEntry, hrFSAccess=hrFSAccess, hrSWRunGroup=hrSWRunGroup, hrFSMountPoint=hrFSMountPoint, hrSWInstalledEntry=hrSWInstalledEntry, hrSWRunParameters=hrSWRunParameters, InternationalDisplayString=InternationalDisplayString, hrProcessorEntry=hrProcessorEntry, hrStorageSize=hrStorageSize, hrSystemMaxProcesses=hrSystemMaxProcesses, hrFSEntry=hrFSEntry, hrNetworkTable=hrNetworkTable, hrProcessorTable=hrProcessorTable, hrSWOSIndex=hrSWOSIndex, hrSWRunPerf=hrSWRunPerf, hrStorageAllocationFailures=hrStorageAllocationFailures, hrSystemGroup=hrSystemGroup, hrPartitionLabel=hrPartitionLabel, hrSWInstalledID=hrSWInstalledID, hrPrinterStatus=hrPrinterStatus, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState)
