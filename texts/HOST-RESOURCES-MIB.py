...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", ProductID=ProductID, hrSWInstalledType=hrSWInstalledType, hrSystemMaxProcesses=hrSystemMaxProcesses, PYSNMP_MODULE_ID=hostResourcesMibModule, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSWInstalledName=hrSWInstalledName, hrSystemNumUsers=hrSystemNumUsers, hrSWRunStatus=hrSWRunStatus, hrMIBAdminInfo=hrMIBAdminInfo, hrPartitionLabel=hrPartitionLabel, hrStorageType=hrStorageType, hrPartitionEntry=hrPartitionEntry, hrSWRunPerfCPU=hrSWRunPerfCPU, hrPartitionFSIndex=hrPartitionFSIndex, hrDiskStorageMedia=hrDiskStorageMedia, hrFSType=hrFSType, hrSWRunPath=hrSWRunPath, hrStorage=hrStorage, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSWOSIndex=hrSWOSIndex, hrStorageTypes=hrStorageTypes, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrStorageDescr=hrStorageDescr, hrSWInstalledIndex=hrSWInstalledIndex, hrFSMountPoint=hrFSMountPoint, InternationalDisplayString=InternationalDisplayString, hrDiskStorageTable=hrDiskStorageTable, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSWRunPerfEntry=hrSWRunPerfEntry, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrFSEntry=hrFSEntry, hrSWRunPerfTable=hrSWRunPerfTable, hrMIBCompliance=hrMIBCompliance, hrPartitionIndex=hrPartitionIndex, hrSWRunIndex=hrSWRunIndex, hrPrinterEntry=hrPrinterEntry, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrPrinterStatus=hrPrinterStatus, hrDeviceType=hrDeviceType, hrFSTable=hrFSTable, hrSystemDate=hrSystemDate, hrStorageTable=hrStorageTable, hrSWRunName=hrSWRunName, hrFSIndex=hrFSIndex, hrSWRunGroup=hrSWRunGroup, hrSystemProcesses=hrSystemProcesses, hrSWInstalledDate=hrSWInstalledDate, hrSWInstalled=hrSWInstalled, hrStorageIndex=hrStorageIndex, hrDeviceTable=hrDeviceTable, hrProcessorTable=hrProcessorTable, host=host, hrNetworkEntry=hrNetworkEntry, hrPartitionTable=hrPartitionTable, hrFSAccess=hrFSAccess, hrSystemGroup=hrSystemGroup, hrProcessorFrwID=hrProcessorFrwID, hrStorageEntry=hrStorageEntry, hrSWRunTable=hrSWRunTable, hrPartitionSize=hrPartitionSize, hrStorageUsed=hrStorageUsed, hrStorageGroup=hrStorageGroup, hrStorageAllocationFailures=hrStorageAllocationFailures, hrFSBootable=hrFSBootable, hrSWInstalledTable=hrSWInstalledTable, hrDevice=hrDevice, hrDeviceStatus=hrDeviceStatus, hrDeviceGroup=hrDeviceGroup, hrDeviceErrors=hrDeviceErrors, hrDeviceID=hrDeviceID, hrDeviceEntry=hrDeviceEntry, hrSWRunEntry=hrSWRunEntry, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrDiskStorageEntry=hrDiskStorageEntry, hrSWRunType=hrSWRunType, hrSWRunID=hrSWRunID, KBytes=KBytes, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrMemorySize=hrMemorySize, hrSWRun=hrSWRun, hrSystem=hrSystem, hrSWRunPerfGroup=hrSWRunPerfGroup, hrDeviceDescr=hrDeviceDescr, hrStorageSize=hrStorageSize, hrSystemUptime=hrSystemUptime, hrDiskStorageAccess=hrDiskStorageAccess, hrNetworkTable=hrNetworkTable, hrDiskStorageCapacity=hrDiskStorageCapacity, hrNetworkIfIndex=hrNetworkIfIndex, hrSWRunPerfMem=hrSWRunPerfMem, hrFSTypes=hrFSTypes, hrDeviceTypes=hrDeviceTypes, hrPartitionID=hrPartitionID, hostResourcesMibModule=hostResourcesMibModule, hrProcessorEntry=hrProcessorEntry, hrSWInstalledGroup=hrSWInstalledGroup, hrMIBCompliances=hrMIBCompliances, hrSWInstalledLastChange=hrSWInstalledLastChange, hrSWRunPerf=hrSWRunPerf, hrPrinterTable=hrPrinterTable, hrSWInstalledEntry=hrSWInstalledEntry, hrDeviceIndex=hrDeviceIndex, hrMIBGroups=hrMIBGroups, hrFSStorageIndex=hrFSStorageIndex, hrSWInstalledID=hrSWInstalledID, hrProcessorLoad=hrProcessorLoad, hrSWRunParameters=hrSWRunParameters)
