...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrDiskStorageEntry=hrDiskStorageEntry, hrProcessorEntry=hrProcessorEntry, hrSWRun=hrSWRun, hrDeviceErrors=hrDeviceErrors, PYSNMP_MODULE_ID=hostResourcesMibModule, hrFSBootable=hrFSBootable, hrSWOSIndex=hrSWOSIndex, ProductID=ProductID, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, KBytes=KBytes, hrSWInstalled=hrSWInstalled, hrDeviceIndex=hrDeviceIndex, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrStorageGroup=hrStorageGroup, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSWRunEntry=hrSWRunEntry, hrDevice=hrDevice, hrSWRunPerf=hrSWRunPerf, hrStorageIndex=hrStorageIndex, hrPartitionID=hrPartitionID, hrSWRunID=hrSWRunID, hrSWInstalledTable=hrSWInstalledTable, hrSWInstalledEntry=hrSWInstalledEntry, hrFSType=hrFSType, hrPartitionFSIndex=hrPartitionFSIndex, hrDeviceDescr=hrDeviceDescr, hrNetworkIfIndex=hrNetworkIfIndex, hrPartitionIndex=hrPartitionIndex, hrFSTable=hrFSTable, hrSWRunTable=hrSWRunTable, hrSWRunPerfCPU=hrSWRunPerfCPU, host=host, hrMIBCompliance=hrMIBCompliance, hrPartitionLabel=hrPartitionLabel, hrSWInstalledDate=hrSWInstalledDate, hrSWRunPath=hrSWRunPath, hrDeviceGroup=hrDeviceGroup, hrSWRunPerfMem=hrSWRunPerfMem, hrPrinterStatus=hrPrinterStatus, hrDiskStorageMedia=hrDiskStorageMedia, hrSystemMaxProcesses=hrSystemMaxProcesses, hrStorageEntry=hrStorageEntry, hrFSMountPoint=hrFSMountPoint, hrDeviceStatus=hrDeviceStatus, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, InternationalDisplayString=InternationalDisplayString, hrProcessorTable=hrProcessorTable, hrSWRunIndex=hrSWRunIndex, hrSWRunPerfEntry=hrSWRunPerfEntry, hrPrinterEntry=hrPrinterEntry, hrSWInstalledIndex=hrSWInstalledIndex, hrSystem=hrSystem, hrSWRunStatus=hrSWRunStatus, hrSystemUptime=hrSystemUptime, hrStorageAllocationFailures=hrStorageAllocationFailures, hrDeviceID=hrDeviceID, hrDeviceTypes=hrDeviceTypes, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrSWInstalledType=hrSWInstalledType, hrSWRunPerfTable=hrSWRunPerfTable, hrFSIndex=hrFSIndex, hrSWInstalledGroup=hrSWInstalledGroup, hrPartitionTable=hrPartitionTable, hrSWRunName=hrSWRunName, hrMemorySize=hrMemorySize, hrDeviceTable=hrDeviceTable, hrStorageUsed=hrStorageUsed, hrStorageDescr=hrStorageDescr, hrSWRunParameters=hrSWRunParameters, hrStorageSize=hrStorageSize, hrSystemDate=hrSystemDate, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSWInstalledLastChange=hrSWInstalledLastChange, hrFSTypes=hrFSTypes, hrProcessorLoad=hrProcessorLoad, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSWRunPerfGroup=hrSWRunPerfGroup, hrSWInstalledName=hrSWInstalledName, hostResourcesMibModule=hostResourcesMibModule, hrMIBAdminInfo=hrMIBAdminInfo, hrSWInstalledID=hrSWInstalledID, hrNetworkEntry=hrNetworkEntry, hrFSAccess=hrFSAccess, hrSystemNumUsers=hrSystemNumUsers, hrStorageTypes=hrStorageTypes, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSWRunGroup=hrSWRunGroup, hrStorageTable=hrStorageTable, hrStorageType=hrStorageType, hrDiskStorageTable=hrDiskStorageTable, hrDeviceType=hrDeviceType, hrPartitionEntry=hrPartitionEntry, hrPrinterTable=hrPrinterTable, hrDiskStorageAccess=hrDiskStorageAccess, hrSystemGroup=hrSystemGroup, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrNetworkTable=hrNetworkTable, hrPartitionSize=hrPartitionSize, hrFSEntry=hrFSEntry, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrMIBGroups=hrMIBGroups, hrStorage=hrStorage, hrSystemProcesses=hrSystemProcesses, hrSWRunType=hrSWRunType, hrFSStorageIndex=hrFSStorageIndex, hrDeviceEntry=hrDeviceEntry, hrMIBCompliances=hrMIBCompliances, hrProcessorFrwID=hrProcessorFrwID)
