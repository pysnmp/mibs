...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", InternationalDisplayString=InternationalDisplayString, hrStorageTable=hrStorageTable, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrSWRunEntry=hrSWRunEntry, hrPartitionIndex=hrPartitionIndex, hrDeviceEntry=hrDeviceEntry, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSWInstalled=hrSWInstalled, hrDeviceDescr=hrDeviceDescr, hrSystem=hrSystem, hrNetworkTable=hrNetworkTable, hrPartitionFSIndex=hrPartitionFSIndex, hrSWRunPerf=hrSWRunPerf, hrDeviceTable=hrDeviceTable, hrDeviceType=hrDeviceType, hrStorageType=hrStorageType, hrDeviceErrors=hrDeviceErrors, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSWInstalledGroup=hrSWInstalledGroup, hrPrinterStatus=hrPrinterStatus, hrSystemUptime=hrSystemUptime, hrProcessorLoad=hrProcessorLoad, hrFSType=hrFSType, hrPartitionLabel=hrPartitionLabel, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrDiskStorageAccess=hrDiskStorageAccess, hrSWRunPerfTable=hrSWRunPerfTable, hrSWInstalledTable=hrSWInstalledTable, hrSWRunTable=hrSWRunTable, hrFSStorageIndex=hrFSStorageIndex, hrFSMountPoint=hrFSMountPoint, hrSWRunParameters=hrSWRunParameters, hrSystemGroup=hrSystemGroup, hrProcessorFrwID=hrProcessorFrwID, hrDeviceGroup=hrDeviceGroup, hrSystemProcesses=hrSystemProcesses, hrStorageGroup=hrStorageGroup, hrMemorySize=hrMemorySize, hrStorageDescr=hrStorageDescr, hrPartitionEntry=hrPartitionEntry, hrDiskStorageTable=hrDiskStorageTable, hrFSAccess=hrFSAccess, hrSystemNumUsers=hrSystemNumUsers, hrFSTypes=hrFSTypes, hrPrinterEntry=hrPrinterEntry, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSWRunPerfEntry=hrSWRunPerfEntry, hrSWInstalledDate=hrSWInstalledDate, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrStorageIndex=hrStorageIndex, hrSWRunPerfGroup=hrSWRunPerfGroup, hrStorageUsed=hrStorageUsed, hrDiskStorageMedia=hrDiskStorageMedia, hrStorageAllocationUnits=hrStorageAllocationUnits, hrPartitionID=hrPartitionID, hrSWRunStatus=hrSWRunStatus, hrFSBootable=hrFSBootable, KBytes=KBytes, hrSWInstalledLastChange=hrSWInstalledLastChange, hrStorageSize=hrStorageSize, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSWInstalledIndex=hrSWInstalledIndex, host=host, hrMIBCompliances=hrMIBCompliances, hrSWOSIndex=hrSWOSIndex, hrMIBGroups=hrMIBGroups, hrSWRunID=hrSWRunID, ProductID=ProductID, hrSWRun=hrSWRun, hrSWRunType=hrSWRunType, hrDeviceTypes=hrDeviceTypes, hrProcessorTable=hrProcessorTable, hrSWRunPath=hrSWRunPath, hrPrinterTable=hrPrinterTable, hrPartitionSize=hrPartitionSize, hrSWRunName=hrSWRunName, hrPartitionTable=hrPartitionTable, hrSWRunIndex=hrSWRunIndex, hrProcessorEntry=hrProcessorEntry, hrStorageTypes=hrStorageTypes, hrFSTable=hrFSTable, hrSWInstalledID=hrSWInstalledID, hrDeviceStatus=hrDeviceStatus, hrSWRunGroup=hrSWRunGroup, hostResourcesMibModule=hostResourcesMibModule, hrSystemDate=hrSystemDate, hrStorageEntry=hrStorageEntry, hrNetworkEntry=hrNetworkEntry, hrNetworkIfIndex=hrNetworkIfIndex, hrMIBCompliance=hrMIBCompliance, hrFSIndex=hrFSIndex, hrDevice=hrDevice, PYSNMP_MODULE_ID=hostResourcesMibModule, hrSWRunPerfMem=hrSWRunPerfMem, hrStorageAllocationFailures=hrStorageAllocationFailures, hrMIBAdminInfo=hrMIBAdminInfo, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrFSEntry=hrFSEntry, hrSWInstalledType=hrSWInstalledType, hrSystemMaxProcesses=hrSystemMaxProcesses, hrDeviceIndex=hrDeviceIndex, hrDiskStorageEntry=hrDiskStorageEntry, hrSWInstalledEntry=hrSWInstalledEntry, hrSWInstalledName=hrSWInstalledName, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrStorage=hrStorage, hrDeviceID=hrDeviceID)
