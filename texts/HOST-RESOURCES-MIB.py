...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrNetworkEntry=hrNetworkEntry, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSWRunID=hrSWRunID, hrSWRun=hrSWRun, hrDeviceStatus=hrDeviceStatus, host=host, hrSWInstalledLastChange=hrSWInstalledLastChange, hrDeviceType=hrDeviceType, hrSWInstalledType=hrSWInstalledType, PYSNMP_MODULE_ID=hostResourcesMibModule, hrPartitionLabel=hrPartitionLabel, hrStorageTable=hrStorageTable, hrNetworkIfIndex=hrNetworkIfIndex, hrSWRunIndex=hrSWRunIndex, hrDiskStorageTable=hrDiskStorageTable, hrStorageDescr=hrStorageDescr, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrDiskStorageMedia=hrDiskStorageMedia, hrProcessorTable=hrProcessorTable, hrStorageType=hrStorageType, hrStorageGroup=hrStorageGroup, hrPrinterStatus=hrPrinterStatus, hrPartitionTable=hrPartitionTable, hrSWRunPath=hrSWRunPath, hrSWInstalledGroup=hrSWInstalledGroup, hrSystemNumUsers=hrSystemNumUsers, hrDeviceIndex=hrDeviceIndex, hrSWRunParameters=hrSWRunParameters, hrMIBGroups=hrMIBGroups, hrPrinterEntry=hrPrinterEntry, hrStorageTypes=hrStorageTypes, hrFSTypes=hrFSTypes, hrFSAccess=hrFSAccess, hrPartitionSize=hrPartitionSize, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSWInstalledDate=hrSWInstalledDate, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrDiskStorageAccess=hrDiskStorageAccess, hrSWInstalledID=hrSWInstalledID, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrStorageUsed=hrStorageUsed, hrSystemDate=hrSystemDate, hrDeviceEntry=hrDeviceEntry, hrFSStorageIndex=hrFSStorageIndex, hrSWRunStatus=hrSWRunStatus, hrSWInstalledEntry=hrSWInstalledEntry, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSWRunType=hrSWRunType, hrSystemGroup=hrSystemGroup, hrStorageAllocationFailures=hrStorageAllocationFailures, hrSWRunPerfTable=hrSWRunPerfTable, hrDevice=hrDevice, KBytes=KBytes, hrSWInstalledIndex=hrSWInstalledIndex, hrDeviceErrors=hrDeviceErrors, InternationalDisplayString=InternationalDisplayString, hrPartitionEntry=hrPartitionEntry, hrSWInstalledTable=hrSWInstalledTable, hrDeviceID=hrDeviceID, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrMIBAdminInfo=hrMIBAdminInfo, hrFSType=hrFSType, hrSWRunPerfMem=hrSWRunPerfMem, hrFSIndex=hrFSIndex, hrDiskStorageEntry=hrDiskStorageEntry, hrSystemMaxProcesses=hrSystemMaxProcesses, hrProcessorLoad=hrProcessorLoad, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrSystemUptime=hrSystemUptime, hostResourcesMibModule=hostResourcesMibModule, hrSWInstalled=hrSWInstalled, hrSWRunPerf=hrSWRunPerf, hrPrinterTable=hrPrinterTable, hrStorageEntry=hrStorageEntry, hrMIBCompliances=hrMIBCompliances, hrSystem=hrSystem, hrProcessorFrwID=hrProcessorFrwID, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrFSTable=hrFSTable, hrSWRunGroup=hrSWRunGroup, hrSWRunPerfEntry=hrSWRunPerfEntry, hrSWOSIndex=hrSWOSIndex, hrNetworkTable=hrNetworkTable, hrFSMountPoint=hrFSMountPoint, hrSWInstalledName=hrSWInstalledName, hrPartitionIndex=hrPartitionIndex, hrFSBootable=hrFSBootable, hrMemorySize=hrMemorySize, hrFSEntry=hrFSEntry, hrDeviceGroup=hrDeviceGroup, hrSWRunTable=hrSWRunTable, hrStorage=hrStorage, hrDeviceDescr=hrDeviceDescr, hrStorageIndex=hrStorageIndex, hrSWRunName=hrSWRunName, hrDeviceTable=hrDeviceTable, hrSystemProcesses=hrSystemProcesses, hrPartitionFSIndex=hrPartitionFSIndex, ProductID=ProductID, hrStorageSize=hrStorageSize, hrPartitionID=hrPartitionID, hrDeviceTypes=hrDeviceTypes, hrSWRunEntry=hrSWRunEntry, hrMIBCompliance=hrMIBCompliance, hrSWRunPerfGroup=hrSWRunPerfGroup, hrProcessorEntry=hrProcessorEntry)
