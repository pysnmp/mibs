...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrStorageAllocationFailures=hrStorageAllocationFailures, hrDeviceErrors=hrDeviceErrors, hrStorage=hrStorage, ProductID=ProductID, hrStorageSize=hrStorageSize, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrSWInstalledGroup=hrSWInstalledGroup, hrStorageTable=hrStorageTable, hrSWRunGroup=hrSWRunGroup, hrSWRun=hrSWRun, hrProcessorLoad=hrProcessorLoad, hrSWRunEntry=hrSWRunEntry, hrFSAccess=hrFSAccess, hrDeviceID=hrDeviceID, hrStorageAllocationUnits=hrStorageAllocationUnits, hrStorageDescr=hrStorageDescr, hrFSBootable=hrFSBootable, hrStorageType=hrStorageType, hrProcessorEntry=hrProcessorEntry, hrSWInstalledLastChange=hrSWInstalledLastChange, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSystemUptime=hrSystemUptime, hrNetworkEntry=hrNetworkEntry, hrSWRunType=hrSWRunType, hrProcessorFrwID=hrProcessorFrwID, hrStorageTypes=hrStorageTypes, hrSWRunPerf=hrSWRunPerf, hrNetworkTable=hrNetworkTable, hrStorageUsed=hrStorageUsed, hrMIBGroups=hrMIBGroups, hrSWOSIndex=hrSWOSIndex, hrSystemGroup=hrSystemGroup, hrDeviceIndex=hrDeviceIndex, hrPartitionSize=hrPartitionSize, hrSWRunIndex=hrSWRunIndex, hrDiskStorageAccess=hrDiskStorageAccess, hrPartitionID=hrPartitionID, hrSystemDate=hrSystemDate, hrDeviceStatus=hrDeviceStatus, hrMemorySize=hrMemorySize, hrSWRunParameters=hrSWRunParameters, hostResourcesMibModule=hostResourcesMibModule, hrStorageGroup=hrStorageGroup, hrSWRunStatus=hrSWRunStatus, hrSWInstalled=hrSWInstalled, hrSWRunPerfCPU=hrSWRunPerfCPU, hrStorageIndex=hrStorageIndex, hrDiskStorageTable=hrDiskStorageTable, hrFSTypes=hrFSTypes, hrPrinterStatus=hrPrinterStatus, hrSWRunPerfGroup=hrSWRunPerfGroup, hrPrinterEntry=hrPrinterEntry, hrMIBAdminInfo=hrMIBAdminInfo, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrDeviceType=hrDeviceType, hrFSLastFullBackupDate=hrFSLastFullBackupDate, InternationalDisplayString=InternationalDisplayString, hrSWRunID=hrSWRunID, hrFSTable=hrFSTable, hrSWInstalledName=hrSWInstalledName, hrPrinterTable=hrPrinterTable, hrPartitionTable=hrPartitionTable, hrDeviceEntry=hrDeviceEntry, host=host, hrDeviceDescr=hrDeviceDescr, hrProcessorTable=hrProcessorTable, hrSWInstalledID=hrSWInstalledID, hrSWInstalledType=hrSWInstalledType, hrSWInstalledIndex=hrSWInstalledIndex, hrPartitionIndex=hrPartitionIndex, hrSystemProcesses=hrSystemProcesses, hrSWRunTable=hrSWRunTable, hrDevice=hrDevice, hrFSStorageIndex=hrFSStorageIndex, hrSystemNumUsers=hrSystemNumUsers, hrPartitionEntry=hrPartitionEntry, hrDiskStorageMedia=hrDiskStorageMedia, hrSWRunPath=hrSWRunPath, hrSWRunPerfEntry=hrSWRunPerfEntry, hrPartitionFSIndex=hrPartitionFSIndex, hrFSIndex=hrFSIndex, hrMIBCompliances=hrMIBCompliances, hrSWInstalledDate=hrSWInstalledDate, PYSNMP_MODULE_ID=hostResourcesMibModule, hrDeviceGroup=hrDeviceGroup, hrSWRunPerfMem=hrSWRunPerfMem, hrSWRunPerfTable=hrSWRunPerfTable, hrMIBCompliance=hrMIBCompliance, hrFSEntry=hrFSEntry, hrFSMountPoint=hrFSMountPoint, KBytes=KBytes, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrFSType=hrFSType, hrSystem=hrSystem, hrStorageEntry=hrStorageEntry, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrNetworkIfIndex=hrNetworkIfIndex, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrDeviceTypes=hrDeviceTypes, hrDiskStorageEntry=hrDiskStorageEntry, hrPartitionLabel=hrPartitionLabel, hrSWRunName=hrSWRunName, hrSystemMaxProcesses=hrSystemMaxProcesses, hrDeviceTable=hrDeviceTable, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSWInstalledEntry=hrSWInstalledEntry, hrSWInstalledTable=hrSWInstalledTable)
