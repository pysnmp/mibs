...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrSystemMaxProcesses=hrSystemMaxProcesses, hrStorageAllocationFailures=hrStorageAllocationFailures, hrPartitionEntry=hrPartitionEntry, hrStorageTypes=hrStorageTypes, PYSNMP_MODULE_ID=hostResourcesMibModule, hrSystemDate=hrSystemDate, hrDeviceEntry=hrDeviceEntry, hrNetworkEntry=hrNetworkEntry, hrFSTable=hrFSTable, hrNetworkIfIndex=hrNetworkIfIndex, hrProcessorFrwID=hrProcessorFrwID, hrSWRunPerfCPU=hrSWRunPerfCPU, hrDeviceStatus=hrDeviceStatus, hrProcessorLoad=hrProcessorLoad, hrStorageEntry=hrStorageEntry, hrMemorySize=hrMemorySize, hrFSAccess=hrFSAccess, hrSWRunPerfEntry=hrSWRunPerfEntry, hrDeviceTable=hrDeviceTable, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrFSIndex=hrFSIndex, hrSystemProcesses=hrSystemProcesses, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrStorageSize=hrStorageSize, hrSWRunName=hrSWRunName, hrSystemGroup=hrSystemGroup, hrMIBCompliance=hrMIBCompliance, hrPartitionLabel=hrPartitionLabel, hrMIBGroups=hrMIBGroups, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrDeviceErrors=hrDeviceErrors, hrSWInstalledEntry=hrSWInstalledEntry, hrSWRun=hrSWRun, hrDeviceGroup=hrDeviceGroup, hrPrinterStatus=hrPrinterStatus, hrSWRunIndex=hrSWRunIndex, hrFSTypes=hrFSTypes, hrPartitionSize=hrPartitionSize, hrDevice=hrDevice, hrDiskStorageEntry=hrDiskStorageEntry, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSystem=hrSystem, hrMIBCompliances=hrMIBCompliances, hrPrinterTable=hrPrinterTable, hrFSType=hrFSType, hrFSStorageIndex=hrFSStorageIndex, ProductID=ProductID, hrSWRunParameters=hrSWRunParameters, hrNetworkTable=hrNetworkTable, hrDiskStorageCapacity=hrDiskStorageCapacity, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrSWInstalled=hrSWInstalled, hrSWInstalledIndex=hrSWInstalledIndex, hrSWInstalledName=hrSWInstalledName, hrFSMountPoint=hrFSMountPoint, hrProcessorEntry=hrProcessorEntry, hrDiskStorageMedia=hrDiskStorageMedia, hrSystemUptime=hrSystemUptime, hrSWRunID=hrSWRunID, hrFSEntry=hrFSEntry, hrSWRunPerfTable=hrSWRunPerfTable, host=host, hrSWInstalledID=hrSWInstalledID, InternationalDisplayString=InternationalDisplayString, hrPrinterEntry=hrPrinterEntry, hrPartitionID=hrPartitionID, hostResourcesMibModule=hostResourcesMibModule, hrStorageDescr=hrStorageDescr, hrStorageType=hrStorageType, hrSWRunPerfMem=hrSWRunPerfMem, hrSWRunPerfGroup=hrSWRunPerfGroup, hrProcessorTable=hrProcessorTable, hrSWRunTable=hrSWRunTable, hrDeviceID=hrDeviceID, hrStorage=hrStorage, hrSWInstalledDate=hrSWInstalledDate, hrSWRunPerf=hrSWRunPerf, hrSWRunStatus=hrSWRunStatus, hrDeviceIndex=hrDeviceIndex, hrStorageUsed=hrStorageUsed, hrDeviceTypes=hrDeviceTypes, hrStorageGroup=hrStorageGroup, hrSWOSIndex=hrSWOSIndex, hrPartitionIndex=hrPartitionIndex, hrDiskStorageTable=hrDiskStorageTable, hrDiskStorageAccess=hrDiskStorageAccess, KBytes=KBytes, hrSWRunGroup=hrSWRunGroup, hrFSBootable=hrFSBootable, hrSWInstalledGroup=hrSWInstalledGroup, hrSWInstalledType=hrSWInstalledType, hrSystemNumUsers=hrSystemNumUsers, hrSWRunPath=hrSWRunPath, hrSWRunEntry=hrSWRunEntry, hrStorageIndex=hrStorageIndex, hrStorageTable=hrStorageTable, hrSWRunType=hrSWRunType, hrStorageAllocationUnits=hrStorageAllocationUnits, hrDeviceDescr=hrDeviceDescr, hrSWInstalledTable=hrSWInstalledTable, hrMIBAdminInfo=hrMIBAdminInfo, hrSWInstalledLastChange=hrSWInstalledLastChange, hrPartitionFSIndex=hrPartitionFSIndex, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrDeviceType=hrDeviceType, hrPartitionTable=hrPartitionTable)
