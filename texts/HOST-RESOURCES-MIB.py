...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrFSTable=hrFSTable, hrSWInstalledDate=hrSWInstalledDate, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSWRunPath=hrSWRunPath, hrSWRunPerfMem=hrSWRunPerfMem, hrSystemDate=hrSystemDate, InternationalDisplayString=InternationalDisplayString, hrProcessorTable=hrProcessorTable, hrProcessorFrwID=hrProcessorFrwID, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrProcessorEntry=hrProcessorEntry, hrFSMountPoint=hrFSMountPoint, hrDevice=hrDevice, hrSWInstalledID=hrSWInstalledID, hrSWOSIndex=hrSWOSIndex, hrPartitionIndex=hrPartitionIndex, hrSWInstalledType=hrSWInstalledType, hrStorageType=hrStorageType, hrFSStorageIndex=hrFSStorageIndex, hrDeviceDescr=hrDeviceDescr, hrPartitionTable=hrPartitionTable, hrDiskStorageEntry=hrDiskStorageEntry, hrSWRunID=hrSWRunID, hrSWRunPerf=hrSWRunPerf, hrNetworkEntry=hrNetworkEntry, hrFSIndex=hrFSIndex, hrSystem=hrSystem, hrNetworkIfIndex=hrNetworkIfIndex, hostResourcesMibModule=hostResourcesMibModule, hrPrinterTable=hrPrinterTable, hrDiskStorageMedia=hrDiskStorageMedia, ProductID=ProductID, hrStorageDescr=hrStorageDescr, hrNetworkTable=hrNetworkTable, hrFSType=hrFSType, hrStorageAllocationFailures=hrStorageAllocationFailures, hrSWRunPerfEntry=hrSWRunPerfEntry, PYSNMP_MODULE_ID=hostResourcesMibModule, hrSWRunIndex=hrSWRunIndex, host=host, hrStorageTypes=hrStorageTypes, hrSWInstalledGroup=hrSWInstalledGroup, hrMIBAdminInfo=hrMIBAdminInfo, hrDeviceEntry=hrDeviceEntry, hrSWRunStatus=hrSWRunStatus, hrSWInstalled=hrSWInstalled, hrStorageTable=hrStorageTable, hrFSTypes=hrFSTypes, hrSWRunPerfGroup=hrSWRunPerfGroup, hrSystemUptime=hrSystemUptime, hrStorageGroup=hrStorageGroup, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSWInstalledEntry=hrSWInstalledEntry, KBytes=KBytes, hrStorageUsed=hrStorageUsed, hrPartitionFSIndex=hrPartitionFSIndex, hrSystemMaxProcesses=hrSystemMaxProcesses, hrSWRunPerfTable=hrSWRunPerfTable, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrDiskStorageCapacity=hrDiskStorageCapacity, hrDeviceErrors=hrDeviceErrors, hrStorageEntry=hrStorageEntry, hrFSAccess=hrFSAccess, hrPartitionID=hrPartitionID, hrFSBootable=hrFSBootable, hrStorageAllocationUnits=hrStorageAllocationUnits, hrDiskStorageAccess=hrDiskStorageAccess, hrSWRunGroup=hrSWRunGroup, hrMIBCompliance=hrMIBCompliance, hrMemorySize=hrMemorySize, hrSWRun=hrSWRun, hrStorageSize=hrStorageSize, hrFSEntry=hrFSEntry, hrSWRunName=hrSWRunName, hrSWInstalledLastChange=hrSWInstalledLastChange, hrPrinterEntry=hrPrinterEntry, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSWRunEntry=hrSWRunEntry, hrSWInstalledTable=hrSWInstalledTable, hrPartitionLabel=hrPartitionLabel, hrDiskStorageTable=hrDiskStorageTable, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrSWInstalledName=hrSWInstalledName, hrDeviceType=hrDeviceType, hrSWRunTable=hrSWRunTable, hrDeviceIndex=hrDeviceIndex, hrStorage=hrStorage, hrDeviceTypes=hrDeviceTypes, hrMIBCompliances=hrMIBCompliances, hrSWRunParameters=hrSWRunParameters, hrDeviceStatus=hrDeviceStatus, hrDeviceTable=hrDeviceTable, hrProcessorLoad=hrProcessorLoad, hrMIBGroups=hrMIBGroups, hrPartitionEntry=hrPartitionEntry, hrPartitionSize=hrPartitionSize, hrSystemNumUsers=hrSystemNumUsers, hrStorageIndex=hrStorageIndex, hrSystemGroup=hrSystemGroup, hrDeviceGroup=hrDeviceGroup, hrDeviceID=hrDeviceID, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSWInstalledIndex=hrSWInstalledIndex, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrPrinterStatus=hrPrinterStatus, hrSWRunType=hrSWRunType, hrSystemProcesses=hrSystemProcesses)
