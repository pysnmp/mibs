...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrStorageDescr=hrStorageDescr, hrProcessorEntry=hrProcessorEntry, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrDeviceStatus=hrDeviceStatus, hrSWRunPath=hrSWRunPath, hrSWRunPerfEntry=hrSWRunPerfEntry, hrDeviceGroup=hrDeviceGroup, hrNetworkIfIndex=hrNetworkIfIndex, hrSWRunParameters=hrSWRunParameters, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrSystemNumUsers=hrSystemNumUsers, hrPrinterTable=hrPrinterTable, hrFSAccess=hrFSAccess, hrSWRunIndex=hrSWRunIndex, hostResourcesMibModule=hostResourcesMibModule, hrStorageEntry=hrStorageEntry, hrFSTable=hrFSTable, hrFSStorageIndex=hrFSStorageIndex, hrMIBCompliances=hrMIBCompliances, hrStorageTypes=hrStorageTypes, hrMIBAdminInfo=hrMIBAdminInfo, hrSWInstalledGroup=hrSWInstalledGroup, hrFSTypes=hrFSTypes, hrStorageType=hrStorageType, hrDiskStorageEntry=hrDiskStorageEntry, hrSWInstalledName=hrSWInstalledName, hrSWRunID=hrSWRunID, hrMemorySize=hrMemorySize, KBytes=KBytes, hrPartitionIndex=hrPartitionIndex, hrSWRunGroup=hrSWRunGroup, hrDiskStorageCapacity=hrDiskStorageCapacity, hrFSType=hrFSType, hrPartitionTable=hrPartitionTable, hrMIBCompliance=hrMIBCompliance, hrSWRunPerfMem=hrSWRunPerfMem, hrDiskStorageMedia=hrDiskStorageMedia, hrSystemMaxProcesses=hrSystemMaxProcesses, hrPrinterEntry=hrPrinterEntry, hrStorageTable=hrStorageTable, hrFSIndex=hrFSIndex, hrSWRunPerf=hrSWRunPerf, hrStorage=hrStorage, hrSWRunType=hrSWRunType, hrDevice=hrDevice, hrDiskStorageTable=hrDiskStorageTable, hrSWInstalledEntry=hrSWInstalledEntry, hrDeviceEntry=hrDeviceEntry, hrNetworkTable=hrNetworkTable, hrPartitionSize=hrPartitionSize, hrSWInstalledDate=hrSWInstalledDate, hrSWRun=hrSWRun, host=host, hrStorageIndex=hrStorageIndex, hrSWInstalledIndex=hrSWInstalledIndex, hrSWInstalledID=hrSWInstalledID, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrProcessorTable=hrProcessorTable, hrDeviceTable=hrDeviceTable, hrSWRunEntry=hrSWRunEntry, hrStorageAllocationUnits=hrStorageAllocationUnits, hrPartitionID=hrPartitionID, hrStorageGroup=hrStorageGroup, hrSWOSIndex=hrSWOSIndex, hrProcessorLoad=hrProcessorLoad, hrStorageSize=hrStorageSize, hrDeviceType=hrDeviceType, hrNetworkEntry=hrNetworkEntry, hrStorageUsed=hrStorageUsed, hrFSMountPoint=hrFSMountPoint, hrSWRunPerfTable=hrSWRunPerfTable, hrSWInstalledTable=hrSWInstalledTable, hrProcessorFrwID=hrProcessorFrwID, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrSWRunPerfCPU=hrSWRunPerfCPU, hrFSBootable=hrFSBootable, hrSystemUptime=hrSystemUptime, hrStorageAllocationFailures=hrStorageAllocationFailures, hrFSEntry=hrFSEntry, hrSystemProcesses=hrSystemProcesses, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrPartitionLabel=hrPartitionLabel, hrSWInstalledType=hrSWInstalledType, hrSWRunPerfGroup=hrSWRunPerfGroup, hrPartitionEntry=hrPartitionEntry, hrSWRunTable=hrSWRunTable, hrSystem=hrSystem, hrSystemDate=hrSystemDate, hrSWInstalled=hrSWInstalled, hrDiskStorageAccess=hrDiskStorageAccess, PYSNMP_MODULE_ID=hostResourcesMibModule, hrSWRunStatus=hrSWRunStatus, hrDeviceDescr=hrDeviceDescr, hrDeviceID=hrDeviceID, hrSWRunName=hrSWRunName, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrDeviceErrors=hrDeviceErrors, hrSWInstalledLastChange=hrSWInstalledLastChange, hrMIBGroups=hrMIBGroups, InternationalDisplayString=InternationalDisplayString, ProductID=ProductID, hrPartitionFSIndex=hrPartitionFSIndex, hrDeviceTypes=hrDeviceTypes, hrPrinterStatus=hrPrinterStatus, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrDeviceIndex=hrDeviceIndex, hrSystemGroup=hrSystemGroup)
