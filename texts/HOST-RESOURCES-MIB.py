...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrSWInstalledEntry=hrSWInstalledEntry, hrSystemNumUsers=hrSystemNumUsers, hrNetworkTable=hrNetworkTable, hrStorageSize=hrStorageSize, hrDeviceErrors=hrDeviceErrors, hrProcessorTable=hrProcessorTable, hrFSEntry=hrFSEntry, hrSystem=hrSystem, hrSystemDate=hrSystemDate, hrSWRunEntry=hrSWRunEntry, hrSWRunPerfGroup=hrSWRunPerfGroup, hrDeviceID=hrDeviceID, hrSWInstalledIndex=hrSWInstalledIndex, hrPartitionSize=hrPartitionSize, hrDiskStorageMedia=hrDiskStorageMedia, hrDeviceTable=hrDeviceTable, hrSWRunName=hrSWRunName, hrStorageTable=hrStorageTable, KBytes=KBytes, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSWInstalledType=hrSWInstalledType, hrDevice=hrDevice, hrSWRunStatus=hrSWRunStatus, hostResourcesMibModule=hostResourcesMibModule, hrFSType=hrFSType, hrSWRun=hrSWRun, hrFSBootable=hrFSBootable, hrFSTable=hrFSTable, hrNetworkIfIndex=hrNetworkIfIndex, hrStorageIndex=hrStorageIndex, hrDeviceDescr=hrDeviceDescr, hrSWRunType=hrSWRunType, hrPrinterEntry=hrPrinterEntry, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrProcessorEntry=hrProcessorEntry, host=host, hrDiskStorageCapacity=hrDiskStorageCapacity, hrFSIndex=hrFSIndex, hrStorageAllocationUnits=hrStorageAllocationUnits, hrFSMountPoint=hrFSMountPoint, hrProcessorLoad=hrProcessorLoad, hrDiskStorageEntry=hrDiskStorageEntry, hrSWRunPerfTable=hrSWRunPerfTable, hrSWRunParameters=hrSWRunParameters, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSWRunTable=hrSWRunTable, hrStorageEntry=hrStorageEntry, PYSNMP_MODULE_ID=hostResourcesMibModule, InternationalDisplayString=InternationalDisplayString, hrDeviceType=hrDeviceType, hrPartitionLabel=hrPartitionLabel, hrSWInstalledLastChange=hrSWInstalledLastChange, hrSWRunPath=hrSWRunPath, hrSystemProcesses=hrSystemProcesses, hrProcessorFrwID=hrProcessorFrwID, hrStorageAllocationFailures=hrStorageAllocationFailures, hrSWInstalledGroup=hrSWInstalledGroup, hrSWRunGroup=hrSWRunGroup, hrPartitionIndex=hrPartitionIndex, hrPartitionTable=hrPartitionTable, hrDeviceStatus=hrDeviceStatus, hrMIBGroups=hrMIBGroups, hrPrinterStatus=hrPrinterStatus, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrDeviceTypes=hrDeviceTypes, hrDiskStorageTable=hrDiskStorageTable, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrMIBAdminInfo=hrMIBAdminInfo, hrSystemMaxProcesses=hrSystemMaxProcesses, hrSWInstalled=hrSWInstalled, hrStorageTypes=hrStorageTypes, hrSWRunPerfEntry=hrSWRunPerfEntry, hrSystemUptime=hrSystemUptime, hrStorage=hrStorage, hrSWRunPerf=hrSWRunPerf, hrSWRunID=hrSWRunID, hrDiskStorageAccess=hrDiskStorageAccess, hrMemorySize=hrMemorySize, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrPartitionFSIndex=hrPartitionFSIndex, hrDeviceGroup=hrDeviceGroup, hrMIBCompliances=hrMIBCompliances, hrPartitionID=hrPartitionID, hrDeviceIndex=hrDeviceIndex, hrStorageUsed=hrStorageUsed, hrPrinterTable=hrPrinterTable, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrMIBCompliance=hrMIBCompliance, hrSWOSIndex=hrSWOSIndex, hrSWInstalledID=hrSWInstalledID, hrSWInstalledName=hrSWInstalledName, hrSWRunPerfCPU=hrSWRunPerfCPU, hrStorageDescr=hrStorageDescr, hrStorageType=hrStorageType, hrSWRunPerfMem=hrSWRunPerfMem, hrNetworkEntry=hrNetworkEntry, hrSystemGroup=hrSystemGroup, hrPartitionEntry=hrPartitionEntry, hrSWInstalledTable=hrSWInstalledTable, hrSWInstalledDate=hrSWInstalledDate, hrDeviceEntry=hrDeviceEntry, hrStorageGroup=hrStorageGroup, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrFSTypes=hrFSTypes, hrFSStorageIndex=hrFSStorageIndex, ProductID=ProductID, hrFSAccess=hrFSAccess, hrSWRunIndex=hrSWRunIndex)
