...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", KBytes=KBytes, hrDeviceID=hrDeviceID, hrDeviceErrors=hrDeviceErrors, hrNetworkTable=hrNetworkTable, hrFSStorageIndex=hrFSStorageIndex, hrSWRunPerfEntry=hrSWRunPerfEntry, hrMIBAdminInfo=hrMIBAdminInfo, hrMIBGroups=hrMIBGroups, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSWRunTable=hrSWRunTable, InternationalDisplayString=InternationalDisplayString, hrSWOSIndex=hrSWOSIndex, hrMemorySize=hrMemorySize, hrDeviceIndex=hrDeviceIndex, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrProcessorFrwID=hrProcessorFrwID, hrDiskStorageMedia=hrDiskStorageMedia, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrSWRunID=hrSWRunID, hrSWRunPerfTable=hrSWRunPerfTable, hrPartitionFSIndex=hrPartitionFSIndex, hrSWRun=hrSWRun, hrSystemProcesses=hrSystemProcesses, hrPartitionLabel=hrPartitionLabel, hrFSAccess=hrFSAccess, hrStorageGroup=hrStorageGroup, hrSWInstalledGroup=hrSWInstalledGroup, hrSWRunPerfMem=hrSWRunPerfMem, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSWInstalledLastChange=hrSWInstalledLastChange, hrStorageAllocationFailures=hrStorageAllocationFailures, hrSystemMaxProcesses=hrSystemMaxProcesses, hrSWRunIndex=hrSWRunIndex, hrPrinterEntry=hrPrinterEntry, hrSWInstalledType=hrSWInstalledType, hrSystem=hrSystem, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSWRunParameters=hrSWRunParameters, hrSWRunStatus=hrSWRunStatus, hrSWInstalledTable=hrSWInstalledTable, hrSWInstalled=hrSWInstalled, hrMIBCompliances=hrMIBCompliances, hrStorageTypes=hrStorageTypes, hrStorageDescr=hrStorageDescr, hrSystemDate=hrSystemDate, hrSWRunGroup=hrSWRunGroup, hrSWRunPath=hrSWRunPath, hostResourcesMibModule=hostResourcesMibModule, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrStorage=hrStorage, hrStorageType=hrStorageType, PYSNMP_MODULE_ID=hostResourcesMibModule, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSWRunPerf=hrSWRunPerf, hrPrinterStatus=hrPrinterStatus, hrDeviceGroup=hrDeviceGroup, host=host, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSystemNumUsers=hrSystemNumUsers, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrPartitionIndex=hrPartitionIndex, hrSWInstalledIndex=hrSWInstalledIndex, hrStorageIndex=hrStorageIndex, hrNetworkIfIndex=hrNetworkIfIndex, hrFSTypes=hrFSTypes, hrFSIndex=hrFSIndex, hrStorageEntry=hrStorageEntry, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrDeviceDescr=hrDeviceDescr, hrFSBootable=hrFSBootable, hrStorageTable=hrStorageTable, hrProcessorLoad=hrProcessorLoad, hrDeviceType=hrDeviceType, hrPartitionTable=hrPartitionTable, hrSystemUptime=hrSystemUptime, hrProcessorTable=hrProcessorTable, hrDiskStorageEntry=hrDiskStorageEntry, hrDeviceEntry=hrDeviceEntry, hrDevice=hrDevice, hrStorageUsed=hrStorageUsed, hrPartitionEntry=hrPartitionEntry, hrSWInstalledDate=hrSWInstalledDate, hrPartitionID=hrPartitionID, hrDeviceTypes=hrDeviceTypes, hrDeviceStatus=hrDeviceStatus, hrPrinterTable=hrPrinterTable, hrFSMountPoint=hrFSMountPoint, hrSWInstalledEntry=hrSWInstalledEntry, hrStorageSize=hrStorageSize, hrSystemGroup=hrSystemGroup, hrPartitionSize=hrPartitionSize, hrMIBCompliance=hrMIBCompliance, hrSWRunEntry=hrSWRunEntry, hrSWRunPerfGroup=hrSWRunPerfGroup, hrNetworkEntry=hrNetworkEntry, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrFSEntry=hrFSEntry, hrProcessorEntry=hrProcessorEntry, hrFSTable=hrFSTable, hrSWInstalledName=hrSWInstalledName, hrSWRunName=hrSWRunName, hrFSType=hrFSType, hrDiskStorageAccess=hrDiskStorageAccess, hrDiskStorageTable=hrDiskStorageTable, hrSWRunType=hrSWRunType, hrDeviceTable=hrDeviceTable, ProductID=ProductID, hrSWInstalledID=hrSWInstalledID)
