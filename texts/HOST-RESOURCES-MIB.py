...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrSWInstalledType=hrSWInstalledType, hrSWInstalledID=hrSWInstalledID, hrSWInstalledGroup=hrSWInstalledGroup, hrStorageGroup=hrStorageGroup, hrDiskStorageMedia=hrDiskStorageMedia, hrSWInstalled=hrSWInstalled, hrSWInstalledDate=hrSWInstalledDate, hrNetworkTable=hrNetworkTable, hrPartitionFSIndex=hrPartitionFSIndex, hrSWRunTable=hrSWRunTable, hrFSEntry=hrFSEntry, hrSWRunName=hrSWRunName, hrSystemGroup=hrSystemGroup, hrStorageEntry=hrStorageEntry, hrSWRunPerfTable=hrSWRunPerfTable, hrSWRunPath=hrSWRunPath, hrSWInstalledTable=hrSWInstalledTable, hrPartitionEntry=hrPartitionEntry, host=host, hrFSAccess=hrFSAccess, hrStorageTypes=hrStorageTypes, hrFSBootable=hrFSBootable, hrFSMountPoint=hrFSMountPoint, hrSWOSIndex=hrSWOSIndex, hrSWRunIndex=hrSWRunIndex, hrSWRunParameters=hrSWRunParameters, hrStorageIndex=hrStorageIndex, hrSystemUptime=hrSystemUptime, hrDevice=hrDevice, hrDeviceType=hrDeviceType, hrPartitionID=hrPartitionID, hrDeviceDescr=hrDeviceDescr, hrPartitionSize=hrPartitionSize, hrMIBCompliance=hrMIBCompliance, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSystemProcesses=hrSystemProcesses, hrStorageDescr=hrStorageDescr, hrPartitionTable=hrPartitionTable, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrSWRunType=hrSWRunType, hrSWRun=hrSWRun, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSWInstalledLastChange=hrSWInstalledLastChange, InternationalDisplayString=InternationalDisplayString, ProductID=ProductID, hrSWRunEntry=hrSWRunEntry, hrProcessorTable=hrProcessorTable, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrPartitionLabel=hrPartitionLabel, hrSystemDate=hrSystemDate, hrStorage=hrStorage, hrPrinterEntry=hrPrinterEntry, hrSystemMaxProcesses=hrSystemMaxProcesses, hrSWRunPerf=hrSWRunPerf, hrStorageAllocationFailures=hrStorageAllocationFailures, hrFSTable=hrFSTable, hrDiskStorageEntry=hrDiskStorageEntry, hrSWRunID=hrSWRunID, hrStorageSize=hrStorageSize, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrFSStorageIndex=hrFSStorageIndex, hrSWInstalledIndex=hrSWInstalledIndex, hrProcessorFrwID=hrProcessorFrwID, hrDeviceStatus=hrDeviceStatus, hrSystem=hrSystem, hrSWInstalledEntry=hrSWInstalledEntry, hrStorageAllocationUnits=hrStorageAllocationUnits, hrStorageType=hrStorageType, hrProcessorLoad=hrProcessorLoad, hrSWRunGroup=hrSWRunGroup, hrSWRunPerfMem=hrSWRunPerfMem, hrSWRunPerfCPU=hrSWRunPerfCPU, KBytes=KBytes, hrDiskStorageTable=hrDiskStorageTable, hrSWRunPerfEntry=hrSWRunPerfEntry, hrFSType=hrFSType, hrMIBCompliances=hrMIBCompliances, hrDiskStorageAccess=hrDiskStorageAccess, hrFSTypes=hrFSTypes, hrFSIndex=hrFSIndex, PYSNMP_MODULE_ID=hostResourcesMibModule, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrMIBAdminInfo=hrMIBAdminInfo, hrDeviceEntry=hrDeviceEntry, hrSWInstalledName=hrSWInstalledName, hrNetworkEntry=hrNetworkEntry, hrDeviceTable=hrDeviceTable, hrProcessorEntry=hrProcessorEntry, hrStorageUsed=hrStorageUsed, hrMemorySize=hrMemorySize, hrDeviceErrors=hrDeviceErrors, hrDeviceIndex=hrDeviceIndex, hrDeviceGroup=hrDeviceGroup, hrSystemNumUsers=hrSystemNumUsers, hrSWRunPerfGroup=hrSWRunPerfGroup, hrSWRunStatus=hrSWRunStatus, hrDeviceID=hrDeviceID, hrDeviceTypes=hrDeviceTypes, hrStorageTable=hrStorageTable, hrPrinterStatus=hrPrinterStatus, hrNetworkIfIndex=hrNetworkIfIndex, hrPrinterTable=hrPrinterTable, hrMIBGroups=hrMIBGroups, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hostResourcesMibModule=hostResourcesMibModule, hrDiskStorageCapacity=hrDiskStorageCapacity, hrPartitionIndex=hrPartitionIndex)
