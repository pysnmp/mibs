...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrDiskStorageTable=hrDiskStorageTable, hrFSBootable=hrFSBootable, hrStorageTable=hrStorageTable, hrPartitionFSIndex=hrPartitionFSIndex, hrFSTable=hrFSTable, hrSWOSIndex=hrSWOSIndex, hrMIBCompliance=hrMIBCompliance, hrSystemDate=hrSystemDate, hrSWInstalledGroup=hrSWInstalledGroup, hrSystemGroup=hrSystemGroup, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrSWRunPerfCPU=hrSWRunPerfCPU, hrDiskStorageAccess=hrDiskStorageAccess, hrSWRunPerfTable=hrSWRunPerfTable, hrStorageUsed=hrStorageUsed, hrDeviceType=hrDeviceType, hrSystemMaxProcesses=hrSystemMaxProcesses, hrNetworkIfIndex=hrNetworkIfIndex, hrSWRunPerfEntry=hrSWRunPerfEntry, hrProcessorTable=hrProcessorTable, hrSWRunType=hrSWRunType, hrProcessorLoad=hrProcessorLoad, hrStorageTypes=hrStorageTypes, hrSystemProcesses=hrSystemProcesses, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrSystemNumUsers=hrSystemNumUsers, hrPrinterTable=hrPrinterTable, hrSWInstalledName=hrSWInstalledName, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSWRunPerfMem=hrSWRunPerfMem, hrPartitionLabel=hrPartitionLabel, hrPartitionIndex=hrPartitionIndex, hrDeviceDescr=hrDeviceDescr, hrPartitionTable=hrPartitionTable, hrSWRunTable=hrSWRunTable, hrDevice=hrDevice, hrSystemUptime=hrSystemUptime, hrStorageGroup=hrStorageGroup, hrSWInstalledTable=hrSWInstalledTable, hrStorageType=hrStorageType, hrSWInstalled=hrSWInstalled, hrSWInstalledEntry=hrSWInstalledEntry, hrPartitionEntry=hrPartitionEntry, hrDeviceEntry=hrDeviceEntry, hrSWRunPath=hrSWRunPath, host=host, hrPartitionSize=hrPartitionSize, hrDiskStorageCapacity=hrDiskStorageCapacity, hrDeviceGroup=hrDeviceGroup, hrSWRunGroup=hrSWRunGroup, InternationalDisplayString=InternationalDisplayString, hrSWRunName=hrSWRunName, hrSWRunPerf=hrSWRunPerf, hrSWRunEntry=hrSWRunEntry, hrStorageAllocationFailures=hrStorageAllocationFailures, hrMIBAdminInfo=hrMIBAdminInfo, hrDeviceStatus=hrDeviceStatus, hrSWInstalledID=hrSWInstalledID, hrSWInstalledDate=hrSWInstalledDate, hrStorageSize=hrStorageSize, hrFSEntry=hrFSEntry, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrDeviceIndex=hrDeviceIndex, hrSWRunStatus=hrSWRunStatus, hrSWRunIndex=hrSWRunIndex, hrFSIndex=hrFSIndex, ProductID=ProductID, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrStorageEntry=hrStorageEntry, hrStorageDescr=hrStorageDescr, hrSWRunParameters=hrSWRunParameters, hrSWRunPerfGroup=hrSWRunPerfGroup, hrStorageIndex=hrStorageIndex, hrPrinterEntry=hrPrinterEntry, hrFSTypes=hrFSTypes, hrNetworkTable=hrNetworkTable, hrMemorySize=hrMemorySize, hrDiskStorageMedia=hrDiskStorageMedia, hrSWRun=hrSWRun, hrDeviceID=hrDeviceID, hrFSType=hrFSType, hrProcessorFrwID=hrProcessorFrwID, hrStorage=hrStorage, hrDeviceTypes=hrDeviceTypes, PYSNMP_MODULE_ID=hostResourcesMibModule, hrFSMountPoint=hrFSMountPoint, hrSWInstalledType=hrSWInstalledType, hrFSStorageIndex=hrFSStorageIndex, hrPartitionID=hrPartitionID, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, KBytes=KBytes, hrMIBGroups=hrMIBGroups, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrPrinterStatus=hrPrinterStatus, hrNetworkEntry=hrNetworkEntry, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrDeviceErrors=hrDeviceErrors, hrFSAccess=hrFSAccess, hrDeviceTable=hrDeviceTable, hrStorageAllocationUnits=hrStorageAllocationUnits, hrSystem=hrSystem, hrSWRunID=hrSWRunID, hrDiskStorageEntry=hrDiskStorageEntry, hrProcessorEntry=hrProcessorEntry, hrSWInstalledLastChange=hrSWInstalledLastChange, hostResourcesMibModule=hostResourcesMibModule, hrMIBCompliances=hrMIBCompliances, hrSWInstalledIndex=hrSWInstalledIndex)
