...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrDeviceTypes=hrDeviceTypes, hrFSEntry=hrFSEntry, hrDiskStorageEntry=hrDiskStorageEntry, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrSystemUptime=hrSystemUptime, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSWInstalledDate=hrSWInstalledDate, hrMIBAdminInfo=hrMIBAdminInfo, hrSystem=hrSystem, hrFSMountPoint=hrFSMountPoint, hrSWInstalledIndex=hrSWInstalledIndex, InternationalDisplayString=InternationalDisplayString, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSWRunTable=hrSWRunTable, hrSWInstalledID=hrSWInstalledID, hrProcessorLoad=hrProcessorLoad, hrSWRunPerfCPU=hrSWRunPerfCPU, PYSNMP_MODULE_ID=hostResourcesMibModule, hrStorageUsed=hrStorageUsed, hrSWInstalledTable=hrSWInstalledTable, KBytes=KBytes, hrDeviceDescr=hrDeviceDescr, hrSWRunGroup=hrSWRunGroup, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSWRunType=hrSWRunType, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrPrinterStatus=hrPrinterStatus, hrDeviceErrors=hrDeviceErrors, hrMemorySize=hrMemorySize, hostResourcesMibModule=hostResourcesMibModule, hrSWInstalledGroup=hrSWInstalledGroup, hrSWRunName=hrSWRunName, hrDiskStorageAccess=hrDiskStorageAccess, hrMIBGroups=hrMIBGroups, hrPartitionTable=hrPartitionTable, hrSWInstalledType=hrSWInstalledType, hrFSAccess=hrFSAccess, hrSWRunStatus=hrSWRunStatus, hrProcessorEntry=hrProcessorEntry, hrFSTable=hrFSTable, hrSystemProcesses=hrSystemProcesses, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSWInstalled=hrSWInstalled, hrSystemDate=hrSystemDate, hrFSIndex=hrFSIndex, hrDiskStorageMedia=hrDiskStorageMedia, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrFSType=hrFSType, hrNetworkTable=hrNetworkTable, ProductID=ProductID, hrSWInstalledLastChange=hrSWInstalledLastChange, hrSWRunPerfEntry=hrSWRunPerfEntry, hrFSBootable=hrFSBootable, hrSWRunEntry=hrSWRunEntry, hrFSTypes=hrFSTypes, hrDevice=hrDevice, hrStorageTypes=hrStorageTypes, hrSystemMaxProcesses=hrSystemMaxProcesses, hrSWRunPerfGroup=hrSWRunPerfGroup, hrStorageIndex=hrStorageIndex, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSWOSIndex=hrSWOSIndex, hrSWInstalledName=hrSWInstalledName, hrDeviceID=hrDeviceID, hrStorageTable=hrStorageTable, hrSystemGroup=hrSystemGroup, hrStorageAllocationFailures=hrStorageAllocationFailures, hrStorageGroup=hrStorageGroup, hrStorageDescr=hrStorageDescr, hrDeviceEntry=hrDeviceEntry, hrSystemNumUsers=hrSystemNumUsers, hrDeviceType=hrDeviceType, hrNetworkEntry=hrNetworkEntry, hrPrinterTable=hrPrinterTable, host=host, hrDeviceGroup=hrDeviceGroup, hrPartitionID=hrPartitionID, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrNetworkIfIndex=hrNetworkIfIndex, hrSWRunParameters=hrSWRunParameters, hrDeviceTable=hrDeviceTable, hrSWRunIndex=hrSWRunIndex, hrPartitionLabel=hrPartitionLabel, hrFSStorageIndex=hrFSStorageIndex, hrStorageEntry=hrStorageEntry, hrDeviceStatus=hrDeviceStatus, hrSWRunPerfMem=hrSWRunPerfMem, hrSWRunPerf=hrSWRunPerf, hrPartitionFSIndex=hrPartitionFSIndex, hrSWInstalledEntry=hrSWInstalledEntry, hrMIBCompliance=hrMIBCompliance, hrStorageType=hrStorageType, hrDeviceIndex=hrDeviceIndex, hrStorageSize=hrStorageSize, hrMIBCompliances=hrMIBCompliances, hrStorageAllocationUnits=hrStorageAllocationUnits, hrPrinterEntry=hrPrinterEntry, hrDiskStorageTable=hrDiskStorageTable, hrProcessorFrwID=hrProcessorFrwID, hrSWRunPath=hrSWRunPath, hrProcessorTable=hrProcessorTable, hrPartitionIndex=hrPartitionIndex, hrSWRunID=hrSWRunID, hrSWRunPerfTable=hrSWRunPerfTable, hrPartitionEntry=hrPartitionEntry, hrSWRun=hrSWRun, hrPartitionSize=hrPartitionSize, hrStorage=hrStorage)
