...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", InternationalDisplayString=InternationalDisplayString, hrSWInstalledName=hrSWInstalledName, hrDiskStorageAccess=hrDiskStorageAccess, hrSWRunPerfCPU=hrSWRunPerfCPU, hrFSTable=hrFSTable, hrDiskStorageTable=hrDiskStorageTable, hrDevice=hrDevice, hrDeviceTable=hrDeviceTable, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrSystemUptime=hrSystemUptime, hrSystemMaxProcesses=hrSystemMaxProcesses, hrStorageUsed=hrStorageUsed, hrSWRunParameters=hrSWRunParameters, hrStorageEntry=hrStorageEntry, hrDeviceDescr=hrDeviceDescr, hrSWRunPath=hrSWRunPath, hrStorageIndex=hrStorageIndex, hrProcessorEntry=hrProcessorEntry, hrDeviceType=hrDeviceType, hrSWInstalledGroup=hrSWInstalledGroup, hrPrinterEntry=hrPrinterEntry, hrSWRunIndex=hrSWRunIndex, hrSWOSIndex=hrSWOSIndex, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrMemorySize=hrMemorySize, hrSWRunPerfEntry=hrSWRunPerfEntry, hostResourcesMibModule=hostResourcesMibModule, hrDeviceTypes=hrDeviceTypes, host=host, hrFSBootable=hrFSBootable, hrSWInstalledID=hrSWInstalledID, hrMIBGroups=hrMIBGroups, hrSWRunID=hrSWRunID, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrSystemGroup=hrSystemGroup, hrProcessorTable=hrProcessorTable, hrStorage=hrStorage, hrProcessorLoad=hrProcessorLoad, hrStorageDescr=hrStorageDescr, hrDiskStorageEntry=hrDiskStorageEntry, hrSWRunPerf=hrSWRunPerf, hrSWRunTable=hrSWRunTable, hrStorageTable=hrStorageTable, hrProcessorFrwID=hrProcessorFrwID, hrPartitionLabel=hrPartitionLabel, PYSNMP_MODULE_ID=hostResourcesMibModule, hrSWRunPerfGroup=hrSWRunPerfGroup, hrFSAccess=hrFSAccess, hrFSMountPoint=hrFSMountPoint, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrStorageAllocationUnits=hrStorageAllocationUnits, hrDeviceEntry=hrDeviceEntry, hrSWInstalledEntry=hrSWInstalledEntry, hrNetworkIfIndex=hrNetworkIfIndex, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrSWInstalled=hrSWInstalled, hrMIBCompliances=hrMIBCompliances, KBytes=KBytes, hrPrinterStatus=hrPrinterStatus, hrStorageSize=hrStorageSize, hrDeviceID=hrDeviceID, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSWRunGroup=hrSWRunGroup, hrStorageAllocationFailures=hrStorageAllocationFailures, hrMIBAdminInfo=hrMIBAdminInfo, hrPartitionID=hrPartitionID, hrFSTypes=hrFSTypes, hrPartitionEntry=hrPartitionEntry, hrPartitionFSIndex=hrPartitionFSIndex, hrSWRunName=hrSWRunName, hrFSStorageIndex=hrFSStorageIndex, hrPartitionSize=hrPartitionSize, hrNetworkTable=hrNetworkTable, hrSWInstalledTable=hrSWInstalledTable, hrDeviceGroup=hrDeviceGroup, hrSystemDate=hrSystemDate, hrPartitionTable=hrPartitionTable, hrDeviceIndex=hrDeviceIndex, hrSWInstalledIndex=hrSWInstalledIndex, hrDiskStorageMedia=hrDiskStorageMedia, hrNetworkEntry=hrNetworkEntry, hrStorageType=hrStorageType, hrSystem=hrSystem, hrSWRunPerfTable=hrSWRunPerfTable, hrFSRemoteMountPoint=hrFSRemoteMountPoint, ProductID=ProductID, hrSystemProcesses=hrSystemProcesses, hrSWRunStatus=hrSWRunStatus, hrPartitionIndex=hrPartitionIndex, hrSWInstalledType=hrSWInstalledType, hrPrinterTable=hrPrinterTable, hrSWInstalledDate=hrSWInstalledDate, hrStorageGroup=hrStorageGroup, hrSWRunEntry=hrSWRunEntry, hrDeviceStatus=hrDeviceStatus, hrSWInstalledLastChange=hrSWInstalledLastChange, hrSWRunType=hrSWRunType, hrDiskStorageCapacity=hrDiskStorageCapacity, hrFSType=hrFSType, hrSWRun=hrSWRun, hrSystemNumUsers=hrSystemNumUsers, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrMIBCompliance=hrMIBCompliance, hrSWRunPerfMem=hrSWRunPerfMem, hrDeviceErrors=hrDeviceErrors, hrFSIndex=hrFSIndex, hrStorageTypes=hrStorageTypes, hrFSEntry=hrFSEntry)
