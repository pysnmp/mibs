...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrProcessorLoad=hrProcessorLoad, hrSystemMaxProcesses=hrSystemMaxProcesses, hrStorageAllocationFailures=hrStorageAllocationFailures, hrDeviceID=hrDeviceID, hrSWRunEntry=hrSWRunEntry, hrSystemGroup=hrSystemGroup, hrStorageAllocationUnits=hrStorageAllocationUnits, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrPartitionTable=hrPartitionTable, hrFSStorageIndex=hrFSStorageIndex, hostResourcesMibModule=hostResourcesMibModule, hrNetworkIfIndex=hrNetworkIfIndex, hrProcessorTable=hrProcessorTable, hrSWRunPerfGroup=hrSWRunPerfGroup, InternationalDisplayString=InternationalDisplayString, hrProcessorFrwID=hrProcessorFrwID, hrSystemDate=hrSystemDate, hrPartitionSize=hrPartitionSize, hrPartitionFSIndex=hrPartitionFSIndex, hrFSTypes=hrFSTypes, hrDeviceTable=hrDeviceTable, hrSWInstalledIndex=hrSWInstalledIndex, hrDiskStorageEntry=hrDiskStorageEntry, hrSWInstalledDate=hrSWInstalledDate, hrMIBCompliances=hrMIBCompliances, hrDeviceDescr=hrDeviceDescr, hrNetworkEntry=hrNetworkEntry, hrSWInstalled=hrSWInstalled, hrSystemProcesses=hrSystemProcesses, hrPartitionLabel=hrPartitionLabel, hrSystem=hrSystem, hrSWInstalledTable=hrSWInstalledTable, hrSystemNumUsers=hrSystemNumUsers, hrSWRunPerfMem=hrSWRunPerfMem, hrDeviceTypes=hrDeviceTypes, hrDeviceIndex=hrDeviceIndex, hrMIBCompliance=hrMIBCompliance, hrStorageType=hrStorageType, PYSNMP_MODULE_ID=hostResourcesMibModule, hrSWInstalledLastChange=hrSWInstalledLastChange, hrSWRunGroup=hrSWRunGroup, hrDeviceType=hrDeviceType, hrDeviceErrors=hrDeviceErrors, hrSystemUptime=hrSystemUptime, hrDiskStorageAccess=hrDiskStorageAccess, hrSWInstalledEntry=hrSWInstalledEntry, hrStorageGroup=hrStorageGroup, hrStorageEntry=hrStorageEntry, hrPartitionIndex=hrPartitionIndex, host=host, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrNetworkTable=hrNetworkTable, hrSWRunIndex=hrSWRunIndex, hrPrinterEntry=hrPrinterEntry, hrStorageTable=hrStorageTable, hrDeviceStatus=hrDeviceStatus, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrSWRunID=hrSWRunID, hrDeviceEntry=hrDeviceEntry, hrSWOSIndex=hrSWOSIndex, hrSWRunPerfEntry=hrSWRunPerfEntry, KBytes=KBytes, hrFSAccess=hrFSAccess, hrSWRunTable=hrSWRunTable, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrPartitionEntry=hrPartitionEntry, hrSWRunName=hrSWRunName, hrDeviceGroup=hrDeviceGroup, hrStorage=hrStorage, hrStorageTypes=hrStorageTypes, hrSWRunPerf=hrSWRunPerf, hrPartitionID=hrPartitionID, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSWRunPath=hrSWRunPath, hrStorageUsed=hrStorageUsed, ProductID=ProductID, hrSWRunPerfTable=hrSWRunPerfTable, hrMIBGroups=hrMIBGroups, hrStorageIndex=hrStorageIndex, hrSWInstalledName=hrSWInstalledName, hrSWInstalledType=hrSWInstalledType, hrPrinterStatus=hrPrinterStatus, hrSWRunPerfCPU=hrSWRunPerfCPU, hrFSType=hrFSType, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrStorageDescr=hrStorageDescr, hrDiskStorageMedia=hrDiskStorageMedia, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrFSEntry=hrFSEntry, hrDevice=hrDevice, hrMIBAdminInfo=hrMIBAdminInfo, hrStorageSize=hrStorageSize, hrSWRunStatus=hrSWRunStatus, hrMemorySize=hrMemorySize, hrSWRunType=hrSWRunType, hrProcessorEntry=hrProcessorEntry, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrSWRunParameters=hrSWRunParameters, hrPrinterTable=hrPrinterTable, hrSWInstalledID=hrSWInstalledID, hrDiskStorageTable=hrDiskStorageTable, hrFSMountPoint=hrFSMountPoint, hrSWRun=hrSWRun, hrFSBootable=hrFSBootable, hrFSIndex=hrFSIndex, hrFSTable=hrFSTable, hrSWInstalledGroup=hrSWInstalledGroup)
