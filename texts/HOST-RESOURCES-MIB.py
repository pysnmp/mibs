...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrProcessorFrwID=hrProcessorFrwID, hrMIBAdminInfo=hrMIBAdminInfo, hrNetworkTable=hrNetworkTable, hrStorageIndex=hrStorageIndex, hrStorage=hrStorage, hrNetworkIfIndex=hrNetworkIfIndex, hrPartitionSize=hrPartitionSize, hrProcessorEntry=hrProcessorEntry, hrPrinterTable=hrPrinterTable, hrSWRunGroup=hrSWRunGroup, hrSWRunPath=hrSWRunPath, host=host, hrProcessorTable=hrProcessorTable, hrSystemProcesses=hrSystemProcesses, hrStorageSize=hrStorageSize, hrFSMountPoint=hrFSMountPoint, hrSWRunEntry=hrSWRunEntry, hrFSEntry=hrFSEntry, hrFSType=hrFSType, hrNetworkEntry=hrNetworkEntry, hrMIBGroups=hrMIBGroups, hrDeviceTypes=hrDeviceTypes, hrSWRunIndex=hrSWRunIndex, hrStorageGroup=hrStorageGroup, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSWRunType=hrSWRunType, hrSWInstalledIndex=hrSWInstalledIndex, hrSWInstalledDate=hrSWInstalledDate, hostResourcesMibModule=hostResourcesMibModule, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSWOSIndex=hrSWOSIndex, InternationalDisplayString=InternationalDisplayString, hrSystemMaxProcesses=hrSystemMaxProcesses, hrDeviceStatus=hrDeviceStatus, hrDeviceErrors=hrDeviceErrors, hrProcessorLoad=hrProcessorLoad, PYSNMP_MODULE_ID=hostResourcesMibModule, hrPartitionIndex=hrPartitionIndex, hrMemorySize=hrMemorySize, hrFSTypes=hrFSTypes, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSWRunPerf=hrSWRunPerf, hrPartitionLabel=hrPartitionLabel, hrDevice=hrDevice, hrFSStorageIndex=hrFSStorageIndex, hrSWRunTable=hrSWRunTable, hrStorageDescr=hrStorageDescr, hrDeviceType=hrDeviceType, hrStorageEntry=hrStorageEntry, hrStorageAllocationFailures=hrStorageAllocationFailures, hrFSIndex=hrFSIndex, hrSWRunParameters=hrSWRunParameters, hrSWRunName=hrSWRunName, hrSWRunPerfGroup=hrSWRunPerfGroup, hrDeviceTable=hrDeviceTable, hrSWRunPerfEntry=hrSWRunPerfEntry, hrSWInstalledName=hrSWInstalledName, hrSystemUptime=hrSystemUptime, hrPartitionEntry=hrPartitionEntry, hrDiskStorageEntry=hrDiskStorageEntry, hrSWInstalledLastChange=hrSWInstalledLastChange, hrSWInstalledID=hrSWInstalledID, hrSWInstalledType=hrSWInstalledType, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrMIBCompliance=hrMIBCompliance, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrStorageAllocationUnits=hrStorageAllocationUnits, hrDiskStorageMedia=hrDiskStorageMedia, ProductID=ProductID, hrPrinterStatus=hrPrinterStatus, hrPartitionTable=hrPartitionTable, hrFSAccess=hrFSAccess, hrStorageType=hrStorageType, hrSWRun=hrSWRun, hrStorageUsed=hrStorageUsed, hrSWInstalledTable=hrSWInstalledTable, hrStorageTypes=hrStorageTypes, hrSystemDate=hrSystemDate, hrSWInstalled=hrSWInstalled, hrDiskStorageTable=hrDiskStorageTable, hrPartitionID=hrPartitionID, hrSystemGroup=hrSystemGroup, hrSWRunStatus=hrSWRunStatus, KBytes=KBytes, hrStorageTable=hrStorageTable, hrDeviceDescr=hrDeviceDescr, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrDeviceEntry=hrDeviceEntry, hrSystemNumUsers=hrSystemNumUsers, hrDiskStorageAccess=hrDiskStorageAccess, hrSWRunPerfTable=hrSWRunPerfTable, hrPartitionFSIndex=hrPartitionFSIndex, hrSWRunPerfMem=hrSWRunPerfMem, hrMIBCompliances=hrMIBCompliances, hrSystem=hrSystem, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrDeviceID=hrDeviceID, hrSWInstalledEntry=hrSWInstalledEntry, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrDeviceGroup=hrDeviceGroup, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSWRunID=hrSWRunID, hrDeviceIndex=hrDeviceIndex, hrPrinterEntry=hrPrinterEntry, hrFSBootable=hrFSBootable, hrSWInstalledGroup=hrSWInstalledGroup, hrDiskStorageCapacity=hrDiskStorageCapacity, hrFSTable=hrFSTable)
