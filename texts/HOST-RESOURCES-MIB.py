...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrSystemDate=hrSystemDate, hrSystem=hrSystem, hrSystemProcesses=hrSystemProcesses, hrProcessorLoad=hrProcessorLoad, hrFSIndex=hrFSIndex, hrSWInstalledID=hrSWInstalledID, hrStorageIndex=hrStorageIndex, hrMIBAdminInfo=hrMIBAdminInfo, hrSWRunPerfTable=hrSWRunPerfTable, hrPrinterTable=hrPrinterTable, hrSWRunParameters=hrSWRunParameters, hrDeviceType=hrDeviceType, hrProcessorTable=hrProcessorTable, hrPrinterEntry=hrPrinterEntry, hrDevice=hrDevice, hrPartitionLabel=hrPartitionLabel, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrStorageAllocationUnits=hrStorageAllocationUnits, hrStorageAllocationFailures=hrStorageAllocationFailures, hrStorageTable=hrStorageTable, hrMIBCompliances=hrMIBCompliances, hrFSType=hrFSType, hrFSBootable=hrFSBootable, hrSWRunPerf=hrSWRunPerf, KBytes=KBytes, hrMemorySize=hrMemorySize, hrPartitionIndex=hrPartitionIndex, hrSWRunGroup=hrSWRunGroup, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrFSTable=hrFSTable, hrDeviceStatus=hrDeviceStatus, hrSWInstalledEntry=hrSWInstalledEntry, hrDeviceGroup=hrDeviceGroup, hrSystemNumUsers=hrSystemNumUsers, hrStorageTypes=hrStorageTypes, hrStorageType=hrStorageType, hrNetworkTable=hrNetworkTable, hrSWRunStatus=hrSWRunStatus, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrDeviceIndex=hrDeviceIndex, hrSWRun=hrSWRun, hrDeviceDescr=hrDeviceDescr, hrStorage=hrStorage, hrPrinterStatus=hrPrinterStatus, hrProcessorFrwID=hrProcessorFrwID, hrDiskStorageAccess=hrDiskStorageAccess, PYSNMP_MODULE_ID=hostResourcesMibModule, hrDiskStorageTable=hrDiskStorageTable, hrStorageSize=hrStorageSize, hrPartitionSize=hrPartitionSize, hrPartitionTable=hrPartitionTable, hrFSTypes=hrFSTypes, hrSWInstalled=hrSWInstalled, hrSWInstalledLastChange=hrSWInstalledLastChange, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrSystemMaxProcesses=hrSystemMaxProcesses, hrStorageEntry=hrStorageEntry, hrSWInstalledDate=hrSWInstalledDate, hrMIBCompliance=hrMIBCompliance, hrSWRunPerfGroup=hrSWRunPerfGroup, hrStorageUsed=hrStorageUsed, hrFSStorageIndex=hrFSStorageIndex, hrSystemUptime=hrSystemUptime, hrSWInstalledName=hrSWInstalledName, hrSWRunName=hrSWRunName, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrSWOSIndex=hrSWOSIndex, hrSWInstalledIndex=hrSWInstalledIndex, hrDeviceID=hrDeviceID, hrNetworkEntry=hrNetworkEntry, InternationalDisplayString=InternationalDisplayString, hrSWRunType=hrSWRunType, hrNetworkIfIndex=hrNetworkIfIndex, hostResourcesMibModule=hostResourcesMibModule, hrDiskStorageEntry=hrDiskStorageEntry, hrDeviceEntry=hrDeviceEntry, hrStorageGroup=hrStorageGroup, hrSystemGroup=hrSystemGroup, hrDeviceErrors=hrDeviceErrors, hrPartitionEntry=hrPartitionEntry, hrDeviceTypes=hrDeviceTypes, hrFSMountPoint=hrFSMountPoint, hrSWInstalledType=hrSWInstalledType, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrStorageDescr=hrStorageDescr, hrSWRunTable=hrSWRunTable, hrDiskStorageMedia=hrDiskStorageMedia, hrSWInstalledGroup=hrSWInstalledGroup, hrFSAccess=hrFSAccess, hrPartitionID=hrPartitionID, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSWRunID=hrSWRunID, ProductID=ProductID, hrSWRunIndex=hrSWRunIndex, hrFSEntry=hrFSEntry, hrProcessorEntry=hrProcessorEntry, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSWRunPerfEntry=hrSWRunPerfEntry, hrPartitionFSIndex=hrPartitionFSIndex, hrSWRunPerfMem=hrSWRunPerfMem, hrSWInstalledTable=hrSWInstalledTable, hrDeviceTable=hrDeviceTable, hrSWRunPath=hrSWRunPath, host=host, hrSWRunEntry=hrSWRunEntry, hrMIBGroups=hrMIBGroups)
