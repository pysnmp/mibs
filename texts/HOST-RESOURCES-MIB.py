...
# ASN.1 source file:///home/runner/work/mibs/mibs/src/standard/HOST-RESOURCES-MIB
...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrMIBGroups=hrMIBGroups, hrProcessorFrwID=hrProcessorFrwID, hrDeviceTypes=hrDeviceTypes, hrSWRunID=hrSWRunID, hrSWInstalledTable=hrSWInstalledTable, hrDeviceIndex=hrDeviceIndex, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrDeviceGroup=hrDeviceGroup, hrSystem=hrSystem, hrFSStorageIndex=hrFSStorageIndex, PYSNMP_MODULE_ID=hostResourcesMibModule, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrSWRunPerfCPU=hrSWRunPerfCPU, hrPartitionID=hrPartitionID, hrMIBAdminInfo=hrMIBAdminInfo, hrStorageAllocationUnits=hrStorageAllocationUnits, hrFSEntry=hrFSEntry, hrSWInstalledName=hrSWInstalledName, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrMemorySize=hrMemorySize, hrDiskStorageTable=hrDiskStorageTable, hrStorage=hrStorage, hrDeviceStatus=hrDeviceStatus, hrPartitionFSIndex=hrPartitionFSIndex, hrSWRunPerfMem=hrSWRunPerfMem, hrStorageIndex=hrStorageIndex, hrStorageTypes=hrStorageTypes, hrFSBootable=hrFSBootable, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrSystemNumUsers=hrSystemNumUsers, hrProcessorLoad=hrProcessorLoad, hrSystemMaxProcesses=hrSystemMaxProcesses, hrSWRunPerfEntry=hrSWRunPerfEntry, hrDeviceID=hrDeviceID, hrStorageSize=hrStorageSize, hrStorageEntry=hrStorageEntry, hrDeviceEntry=hrDeviceEntry, hrSystemDate=hrSystemDate, host=host, hrFSTable=hrFSTable, hostResourcesMibModule=hostResourcesMibModule, hrSWRunStatus=hrSWRunStatus, hrStorageDescr=hrStorageDescr, hrStorageAllocationFailures=hrStorageAllocationFailures, hrFSAccess=hrFSAccess, hrSWRunEntry=hrSWRunEntry, hrSWRunPerf=hrSWRunPerf, hrDeviceTable=hrDeviceTable, hrSWRunName=hrSWRunName, hrNetworkEntry=hrNetworkEntry, hrNetworkIfIndex=hrNetworkIfIndex, hrSWRunPerfGroup=hrSWRunPerfGroup, hrPrinterTable=hrPrinterTable, hrNetworkTable=hrNetworkTable, ProductID=ProductID, hrMIBCompliances=hrMIBCompliances, hrSWInstalled=hrSWInstalled, hrSWRunParameters=hrSWRunParameters, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrProcessorEntry=hrProcessorEntry, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrSWRunType=hrSWRunType, hrSWInstalledDate=hrSWInstalledDate, hrFSIndex=hrFSIndex, hrSWRun=hrSWRun, hrMIBCompliance=hrMIBCompliance, hrDevice=hrDevice, hrPrinterStatus=hrPrinterStatus, hrSWInstalledGroup=hrSWInstalledGroup, hrPrinterEntry=hrPrinterEntry, hrStorageGroup=hrStorageGroup, InternationalDisplayString=InternationalDisplayString, hrPartitionEntry=hrPartitionEntry, KBytes=KBytes, hrFSType=hrFSType, hrSWOSIndex=hrSWOSIndex, hrSWRunPerfTable=hrSWRunPerfTable, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSystemGroup=hrSystemGroup, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrSWInstalledIndex=hrSWInstalledIndex, hrSWInstalledEntry=hrSWInstalledEntry, hrDiskStorageEntry=hrDiskStorageEntry, hrPartitionIndex=hrPartitionIndex, hrSWInstalledID=hrSWInstalledID, hrFSTypes=hrFSTypes, hrDeviceErrors=hrDeviceErrors, hrSWInstalledLastChange=hrSWInstalledLastChange, hrStorageUsed=hrStorageUsed, hrSystemProcesses=hrSystemProcesses, hrSWRunIndex=hrSWRunIndex, hrSWRunGroup=hrSWRunGroup, hrPartitionTable=hrPartitionTable, hrSystemUptime=hrSystemUptime, hrDiskStorageAccess=hrDiskStorageAccess, hrFSMountPoint=hrFSMountPoint, hrPartitionLabel=hrPartitionLabel, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrPartitionSize=hrPartitionSize, hrSWRunPath=hrSWRunPath, hrDeviceDescr=hrDeviceDescr, hrStorageType=hrStorageType, hrDiskStorageMedia=hrDiskStorageMedia, hrDeviceType=hrDeviceType, hrProcessorTable=hrProcessorTable, hrSWRunTable=hrSWRunTable, hrSWInstalledType=hrSWInstalledType, hrStorageTable=hrStorageTable)
