...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrSWRunPerfCPU=hrSWRunPerfCPU, hrPrinterTable=hrPrinterTable, InternationalDisplayString=InternationalDisplayString, hrDeviceTable=hrDeviceTable, hrSWInstalledTable=hrSWInstalledTable, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrPartitionIndex=hrPartitionIndex, hrSWRun=hrSWRun, hrDeviceTypes=hrDeviceTypes, hrSWRunPerf=hrSWRunPerf, hrStorageTypes=hrStorageTypes, hrPartitionLabel=hrPartitionLabel, hrFSLastFullBackupDate=hrFSLastFullBackupDate, hrSWRunEntry=hrSWRunEntry, hrDeviceID=hrDeviceID, hrNetworkTable=hrNetworkTable, hrDevice=hrDevice, hrDiskStorageCapacity=hrDiskStorageCapacity, hrSystemUptime=hrSystemUptime, hrFSTypes=hrFSTypes, hrSWRunPerfMem=hrSWRunPerfMem, hrSWInstalled=hrSWInstalled, hrDeviceStatus=hrDeviceStatus, hrSWInstalledName=hrSWInstalledName, hrFSAccess=hrFSAccess, hrMIBCompliances=hrMIBCompliances, hrPartitionSize=hrPartitionSize, hrSystemProcesses=hrSystemProcesses, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrStorageType=hrStorageType, hrSWInstalledIndex=hrSWInstalledIndex, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrSWInstalledLastChange=hrSWInstalledLastChange, hrPartitionID=hrPartitionID, hrSWRunPerfTable=hrSWRunPerfTable, ProductID=ProductID, hrSystem=hrSystem, hrSWInstalledGroup=hrSWInstalledGroup, hrSWRunType=hrSWRunType, hrSystemGroup=hrSystemGroup, hrFSBootable=hrFSBootable, hrStorageUsed=hrStorageUsed, hrProcessorEntry=hrProcessorEntry, hrFSStorageIndex=hrFSStorageIndex, hrSWRunPerfGroup=hrSWRunPerfGroup, hrDeviceDescr=hrDeviceDescr, host=host, hrPartitionFSIndex=hrPartitionFSIndex, hrFSMountPoint=hrFSMountPoint, hrSWRunStatus=hrSWRunStatus, hrSystemNumUsers=hrSystemNumUsers, hrStorageSize=hrStorageSize, hrFSIndex=hrFSIndex, hrStorageDescr=hrStorageDescr, hrDiskStorageAccess=hrDiskStorageAccess, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrSystemMaxProcesses=hrSystemMaxProcesses, hrStorageIndex=hrStorageIndex, hrSWRunGroup=hrSWRunGroup, hrFSType=hrFSType, hrNetworkIfIndex=hrNetworkIfIndex, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrDeviceIndex=hrDeviceIndex, hrSWRunParameters=hrSWRunParameters, hrSWRunIndex=hrSWRunIndex, hrStorage=hrStorage, hrMIBAdminInfo=hrMIBAdminInfo, hrSWRunTable=hrSWRunTable, hrStorageAllocationFailures=hrStorageAllocationFailures, hrMIBCompliance=hrMIBCompliance, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrDeviceEntry=hrDeviceEntry, hrProcessorLoad=hrProcessorLoad, hrDiskStorageTable=hrDiskStorageTable, hrPartitionTable=hrPartitionTable, hrProcessorTable=hrProcessorTable, hrStorageAllocationUnits=hrStorageAllocationUnits, hrDeviceType=hrDeviceType, hrSWInstalledID=hrSWInstalledID, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrDeviceGroup=hrDeviceGroup, hrPartitionEntry=hrPartitionEntry, hrPrinterEntry=hrPrinterEntry, PYSNMP_MODULE_ID=hostResourcesMibModule, hrSWOSIndex=hrSWOSIndex, hrNetworkEntry=hrNetworkEntry, hrSWRunPath=hrSWRunPath, hrSWRunName=hrSWRunName, hrProcessorFrwID=hrProcessorFrwID, hrStorageTable=hrStorageTable, hrDiskStorageMedia=hrDiskStorageMedia, hrSWInstalledDate=hrSWInstalledDate, hrSWRunPerfEntry=hrSWRunPerfEntry, hrMemorySize=hrMemorySize, hrFSTable=hrFSTable, hrMIBGroups=hrMIBGroups, hrPrinterStatus=hrPrinterStatus, hostResourcesMibModule=hostResourcesMibModule, hrSystemDate=hrSystemDate, hrSWInstalledType=hrSWInstalledType, hrDiskStorageEntry=hrDiskStorageEntry, KBytes=KBytes, hrStorageEntry=hrStorageEntry, hrFSEntry=hrFSEntry, hrDeviceErrors=hrDeviceErrors, hrStorageGroup=hrStorageGroup, hrSWInstalledEntry=hrSWInstalledEntry, hrSWRunID=hrSWRunID)
