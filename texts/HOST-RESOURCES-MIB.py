...
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrDeviceStatus=hrDeviceStatus, hrMIBGroups=hrMIBGroups, hrSystemInitialLoadParameters=hrSystemInitialLoadParameters, hrStorageUsed=hrStorageUsed, hrFSEntry=hrFSEntry, hrSWRunPerfTable=hrSWRunPerfTable, hrSWInstalledTable=hrSWInstalledTable, hrSWRunPerfMem=hrSWRunPerfMem, hrNetworkTable=hrNetworkTable, hrSWOSIndex=hrSWOSIndex, hrDiskStorageRemoveble=hrDiskStorageRemoveble, hrSWRunEntry=hrSWRunEntry, hrPartitionEntry=hrPartitionEntry, hrSWInstalledLastUpdateTime=hrSWInstalledLastUpdateTime, hrPrinterEntry=hrPrinterEntry, InternationalDisplayString=InternationalDisplayString, hrFSLastPartialBackupDate=hrFSLastPartialBackupDate, hrDiskStorageEntry=hrDiskStorageEntry, hrSystem=hrSystem, hrStorageType=hrStorageType, hrDiskStorageAccess=hrDiskStorageAccess, hrSWInstalledLastChange=hrSWInstalledLastChange, hrDeviceDescr=hrDeviceDescr, hrFSAccess=hrFSAccess, hostResourcesMibModule=hostResourcesMibModule, hrFSLastFullBackupDate=hrFSLastFullBackupDate, PYSNMP_MODULE_ID=hostResourcesMibModule, hrStorageAllocationFailures=hrStorageAllocationFailures, hrStorage=hrStorage, hrNetworkIfIndex=hrNetworkIfIndex, hrStorageTable=hrStorageTable, hrSWRunPerf=hrSWRunPerf, hrSWInstalledName=hrSWInstalledName, hrPartitionID=hrPartitionID, hrSWInstalledGroup=hrSWInstalledGroup, hrSystemProcesses=hrSystemProcesses, hrSWRunName=hrSWRunName, hrProcessorLoad=hrProcessorLoad, hrSWRunPerfGroup=hrSWRunPerfGroup, hrPartitionSize=hrPartitionSize, hrSWRunGroup=hrSWRunGroup, hrSystemGroup=hrSystemGroup, hrStorageAllocationUnits=hrStorageAllocationUnits, hrStorageGroup=hrStorageGroup, hrFSBootable=hrFSBootable, hrStorageEntry=hrStorageEntry, hrDiskStorageMedia=hrDiskStorageMedia, hrDeviceIndex=hrDeviceIndex, hrSystemDate=hrSystemDate, hrDiskStorageCapacity=hrDiskStorageCapacity, hrProcessorTable=hrProcessorTable, hrDevice=hrDevice, hrSWInstalledType=hrSWInstalledType, hrFSType=hrFSType, hrMIBCompliance=hrMIBCompliance, hrDeviceErrors=hrDeviceErrors, hrStorageDescr=hrStorageDescr, hrNetworkEntry=hrNetworkEntry, hrSWRunTable=hrSWRunTable, hrPartitionTable=hrPartitionTable, hrPartitionFSIndex=hrPartitionFSIndex, hrSWInstalledIndex=hrSWInstalledIndex, hrMemorySize=hrMemorySize, hrFSRemoteMountPoint=hrFSRemoteMountPoint, hrDeviceType=hrDeviceType, hrStorageIndex=hrStorageIndex, hrStorageSize=hrStorageSize, hrSystemUptime=hrSystemUptime, hrFSMountPoint=hrFSMountPoint, hrFSIndex=hrFSIndex, hrFSStorageIndex=hrFSStorageIndex, hrSWRunIndex=hrSWRunIndex, hrPartitionLabel=hrPartitionLabel, hrSystemMaxProcesses=hrSystemMaxProcesses, hrPrinterTable=hrPrinterTable, hrSWInstalledID=hrSWInstalledID, hrPrinterStatus=hrPrinterStatus, hrStorageTypes=hrStorageTypes, hrSWRunPath=hrSWRunPath, hrSWRunType=hrSWRunType, hrDeviceTypes=hrDeviceTypes, hrPartitionIndex=hrPartitionIndex, hrMIBAdminInfo=hrMIBAdminInfo, hrProcessorEntry=hrProcessorEntry, hrProcessorFrwID=hrProcessorFrwID, hrFSTypes=hrFSTypes, hrSWRunPerfEntry=hrSWRunPerfEntry, hrSWRunPerfCPU=hrSWRunPerfCPU, hrSWInstalledEntry=hrSWInstalledEntry, hrDeviceEntry=hrDeviceEntry, hrSWRunID=hrSWRunID, host=host, hrSWRunParameters=hrSWRunParameters, hrDeviceID=hrDeviceID, hrMIBCompliances=hrMIBCompliances, hrFSTable=hrFSTable, hrSystemInitialLoadDevice=hrSystemInitialLoadDevice, hrDeviceGroup=hrDeviceGroup, hrSWInstalled=hrSWInstalled, hrSystemNumUsers=hrSystemNumUsers, hrPrinterDetectedErrorState=hrPrinterDetectedErrorState, hrSWRunStatus=hrSWRunStatus, KBytes=KBytes, hrSWInstalledDate=hrSWInstalledDate, hrDeviceTable=hrDeviceTable, hrDiskStorageTable=hrDiskStorageTable, ProductID=ProductID, hrSWRun=hrSWRun)
