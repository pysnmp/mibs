...
IpAddress, Unsigned32, TimeTicks, Bits, Counter64, Integer32, NotificationType, ModuleIdentity, Counter32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "TimeTicks", "Bits", "Counter64", "Integer32", "NotificationType", "ModuleIdentity", "Counter32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("MPIOS-MIB", cpuUtilTotalTimes=cpuUtilTotalTimes, sysIfOutOctets=sysIfOutOctets, rtrJitterRowStatus=rtrJitterRowStatus, rtrGroupInterval=rtrGroupInterval, taskPriority=taskPriority, rtrFlStaInputMinFlow=rtrFlStaInputMinFlow, cpuTaskCurrentUtil=cpuTaskCurrentUtil, sysRtrUdpechoEntry=sysRtrUdpechoEntry, sysCpuStatus=sysCpuStatus, sysRtrUdpechoTable=sysRtrUdpechoTable, rtrJitterSdMax=rtrJitterSdMax, rtrIcmpEchoSchInterval=rtrIcmpEchoSchInterval, rtrFlStaTmInputMinFlow=rtrFlStaTmInputMinFlow, sysIfOutNUcastPkts=sysIfOutNUcastPkts, taskTable=taskTable, sysCpuAlertTemper=sysCpuAlertTemper, rtrUdpechoTos=rtrUdpechoTos, sysRtrResponder=sysRtrResponder, rtrJitterMaxRtt=rtrJitterMaxRtt, cpuUtilTotalTicks=cpuUtilTotalTicks, sysRtrGroupTable=sysRtrGroupTable, rtrScheduleType=rtrScheduleType, rtrFlStaTmInputMaxFlow=rtrFlStaTmInputMaxFlow, sysCpu=sysCpu, rtrFlStaTmOutputMinFlow=rtrFlStaTmOutputMinFlow, cpuUtilDeltaTimes=cpuUtilDeltaTimes, taskStackBase=taskStackBase, rtrEntityType=rtrEntityType, sysRtrScheduleTable=sysRtrScheduleTable, sysRtrIcmpEchoEntry=sysRtrIcmpEchoEntry, sysRtrFlowStatisticsTable=sysRtrFlowStatisticsTable, numBlocksAlloc=numBlocksAlloc, sysRtrCtrl=sysRtrCtrl, sysRtrIcmpEchoMgt=sysRtrIcmpEchoMgt, rtrJitterPktInterval=rtrJitterPktInterval, rtrScheduleLifeFlag=rtrScheduleLifeFlag, sysAlertTrapInt=sysAlertTrapInt, rtrJitterTos=rtrJitterTos, sysIfInErrors=sysIfInErrors, cpuUtilAverageUtil=cpuUtilAverageUtil, rtrEntityId=rtrEntityId, sysRtrUdpechoMgt=sysRtrUdpechoMgt, maxBlockSizeFree=maxBlockSizeFree, rtrIcmpEchoSuccessRate=rtrIcmpEchoSuccessRate, taskStackFree=taskStackFree, rtrJitterSdMin=rtrJitterSdMin, sysIfStatistic=sysIfStatistic, rtrJitterVrfName=rtrJitterVrfName, rtrUdpechoPktSucc=rtrUdpechoPktSucc, sysIfOutUcastPkts=sysIfOutUcastPkts, sysRtrGroupEntry=sysRtrGroupEntry, EnabledStatus=EnabledStatus, cpuUtilDeltaUtil=cpuUtilDeltaUtil, rtrIcmpEchoExtendFlag=rtrIcmpEchoExtendFlag, cpuUtilDeltaUsedTicks=cpuUtilDeltaUsedTicks, rtrIcmpEchoTimeout=rtrIcmpEchoTimeout, rtrIcmpEchoSourceIp=rtrIcmpEchoSourceIp, rtrFlStatisticsEntityId=rtrFlStatisticsEntityId, rtrJitterDelayDsMax=rtrJitterDelayDsMax, rtrFlStaTmInputMinPkts=rtrFlStaTmInputMinPkts, rtrUdpechoDelay=rtrUdpechoDelay, rtrJitterPktLossDs=rtrJitterPktLossDs, cpuTaskDeltaTicks=cpuTaskDeltaTicks, sysTask=sysTask, rtrUdpechoTargetIp=rtrUdpechoTargetIp, sysRtrEntityMgt=sysRtrEntityMgt, sysRtrEntityEntry=sysRtrEntityEntry, cpuTaskEntry=cpuTaskEntry, cpuUtilDeltaTicks=cpuUtilDeltaTicks, rtrIcmpEchoSetDf=rtrIcmpEchoSetDf, rtrJitterPktLen=rtrJitterPktLen, rtrJitterDsMax=rtrJitterDsMax, rtrJitterIcpifMin=rtrJitterIcpifMin, sysTemperature=sysTemperature, rtrIcmpEchoTos=rtrIcmpEchoTos, rtrUdpechoTargetPort=rtrUdpechoTargetPort, sysNFI=sysNFI, rtrScheduleId=rtrScheduleId, sysRtrJitterMgt=sysRtrJitterMgt, taskErrorStatus=taskErrorStatus, iosSystem=iosSystem, rtrIcmpEchoPktTotalSend=rtrIcmpEchoPktTotalSend, cpuTaskId=cpuTaskId, rtrIcmpEchoRowStatus=rtrIcmpEchoRowStatus, sysIfDesc=sysIfDesc, rtrIcmpEchoTargetIp=rtrIcmpEchoTargetIp, sysRtrScheduleEntry=sysRtrScheduleEntry, numBytesFree=numBytesFree, rtrJitterPktLossSd=rtrJitterPktLossSd, rtrUdpechoEntityId=rtrUdpechoEntityId, rtrIcmpEchoPktLen=rtrIcmpEchoPktLen, rtrUdpechoSchInterval=rtrUdpechoSchInterval, cpuTaskPri=cpuTaskPri, rtrScheduleRepeat=rtrScheduleRepeat, taskStackPtr=taskStackPtr, sysRtrIcmpEchoTable=sysRtrIcmpEchoTable, rtrScheduleRowStatus=rtrScheduleRowStatus, rtrFlStaInputMaxPkts=rtrFlStaInputMaxPkts, rtrJitterTargetPort=rtrJitterTargetPort, rtrGroupEntityMembers=rtrGroupEntityMembers, cpuUtilTotalUsedTicks=cpuUtilTotalUsedTicks, sysIfInNUcastPkts=sysIfInNUcastPkts, rtrUdpechoState=rtrUdpechoState, rtrJitterDsMin=rtrJitterDsMin, sysRtrGbl=sysRtrGbl, taskOptions=taskOptions, rtrFlowStatisticsRowStatus=rtrFlowStatisticsRowStatus, taskStatus=taskStatus, sysIfInDiscards=sysIfInDiscards, rtrEntityThreshold=rtrEntityThreshold, rtrIcmpEchoIsScheduling=rtrIcmpEchoIsScheduling, rtrUdpechoTimeout=rtrUdpechoTimeout, rtrScheduleObjId=rtrScheduleObjId, rtrFlStatisticsIfName=rtrFlStatisticsIfName, rtrFlStaInputMinPkts=rtrFlStaInputMinPkts, sysIfOutErrors=sysIfOutErrors, taskName=taskName, rtrFlStaTmOutputMaxFlow=rtrFlStaTmOutputMaxFlow, cpuUtilTable=cpuUtilTable, rtrFlStatisticsInterval=rtrFlStatisticsInterval, rtrGroupName=rtrGroupName, taskStackSizeUsage=taskStackSizeUsage, rtrEntityRowStatus=rtrEntityRowStatus, rtrIcmpEchoPktTotalRcvd=rtrIcmpEchoPktTotalRcvd, rtrJitterDelaySdMin=rtrJitterDelaySdMin, sysMainBoardTemper=sysMainBoardTemper, iosObjects=iosObjects, rtrFlStaTmInputMaxPkts=rtrFlStaTmInputMaxPkts, rtrJitterSourceIp=rtrJitterSourceIp, rtrJitterTimeout=rtrJitterTimeout, taskStackPos=taskStackPos, sysRtrJitterTable=sysRtrJitterTable, rtrUdpechoPktLoss=rtrUdpechoPktLoss, rtrJitterTargetIp=rtrJitterTargetIp, cpuTaskName=cpuTaskName, rtrScheduleAgeOut=rtrScheduleAgeOut, numBytesAlloc=numBytesAlloc, taskEntry=taskEntry, sysRtrEntityTable=sysRtrEntityTable, rtrEntityLogType=rtrEntityLogType, rtrJitterSchInterval=rtrJitterSchInterval, rtrEntityLogFilter=rtrEntityLogFilter, rtrIcmpEchoVrfName=rtrIcmpEchoVrfName, rtrJitterIcpifMax=rtrJitterIcpifMax, rtrScheduleLifeTime=rtrScheduleLifeTime, rtrFlStaOutputMinFlow=rtrFlStaOutputMinFlow, sysCpuTaskTabView=sysCpuTaskTabView, rtrFlStaInputMaxFlow=rtrFlStaInputMaxFlow, numBlocksFree=numBlocksFree, sysIfPktPriStaEntry=sysIfPktPriStaEntry, rtrEntityLogMaxSize=rtrEntityLogMaxSize, cpuTaskTotalTicks=cpuTaskTotalTicks, rtrFlStaOutputMaxPkts=rtrFlStaOutputMaxPkts, rtrJitterMosMin=rtrJitterMosMin, rtrFlStaOutputMinPkts=rtrFlStaOutputMinPkts, rtrUdpechoDelayMax=rtrUdpechoDelayMax, sysIfInUnkownProtos=sysIfInUnkownProtos, rtrJitterPktNum=rtrJitterPktNum, rtrUdpechoDelayMin=rtrUdpechoDelayMin, rtrJitterSourcePort=rtrJitterSourcePort, rtrIcmpEchoPktNum=rtrIcmpEchoPktNum, checkCpuTimeInterval=checkCpuTimeInterval, rtrJitterEntityId=rtrJitterEntityId, avgBlockSizeAlloc=avgBlockSizeAlloc, rtrUdpechoVrfName=rtrUdpechoVrfName, taskStackEnd=taskStackEnd, sysIfInUcastPkts=sysIfInUcastPkts, rtrFlStaTmOutputMaxPkts=rtrFlStaTmOutputMaxPkts, rtrIcmpEchoEntityId=rtrIcmpEchoEntityId, rtrScheduleAfterTime=rtrScheduleAfterTime, sysIfInOctets=sysIfInOctets, sysRtrFlowStatisticsEntry=sysRtrFlowStatisticsEntry, cpuTaskTable=cpuTaskTable, rtrJitterDelaySdMax=rtrJitterDelaySdMax, allocBytesPercent=allocBytesPercent, sysRtrGroupMgt=sysRtrGroupMgt, rtrJitterMinRtt=rtrJitterMinRtt, sysIfPktPriStaTable=sysIfPktPriStaTable, sysMainBoardAlertTemper=sysMainBoardAlertTemper, sysIfOutDiscards=sysIfOutDiscards, cpuUtilCpuId=cpuUtilCpuId, taskStackMaxUsed=taskStackMaxUsed, rtrUdpechoRowStatus=rtrUdpechoRowStatus, cpuUtilEntry=cpuUtilEntry, rtrGroupRowStatus=rtrGroupRowStatus, rtrJitterMosMax=rtrJitterMosMax, sysIfIndex=sysIfIndex, rtrUdpechoSourceIp=rtrUdpechoSourceIp, PYSNMP_MODULE_ID=mpios, sysMemory=sysMemory, avgBlockSizeFree=avgBlockSizeFree, sysCpuTemper=sysCpuTemper, rtrJitterState=rtrJitterState, mpios=mpios, rtrGroupId=rtrGroupId, sysRtrFlowStatisticsMgt=sysRtrFlowStatisticsMgt, rtrJitterCodec=rtrJitterCodec, sysRtrScheduleMgt=sysRtrScheduleMgt, rtrIcmpEchoVerifyData=rtrIcmpEchoVerifyData, rtrScheduleInterval=rtrScheduleInterval, cpuUtilCurrentUtil=cpuUtilCurrentUtil, rtrEntityName=rtrEntityName, cpuTaskDeltaUtil=cpuTaskDeltaUtil, rtrUdpechoPktLen=rtrUdpechoPktLen, rtrFlStaTmOutputMinPkts=rtrFlStaTmOutputMinPkts, taskId=taskId, sysRtrJitterEntry=sysRtrJitterEntry, sysIfPktPriority=sysIfPktPriority, taskStackSize=taskStackSize, rtrScheduleStartTimeFlag=rtrScheduleStartTimeFlag, cpuTaskAverageUtil=cpuTaskAverageUtil, rtrJitterDelayDsMin=rtrJitterDelayDsMin, taskDescr=taskDescr, memoryTotalBytes=memoryTotalBytes, rtrScheduleStartTime=rtrScheduleStartTime, sysIfPktPriStatistics=sysIfPktPriStatistics, rtrUdpechoSourcePort=rtrUdpechoSourcePort, rtrFlStaOutputMaxFlow=rtrFlStaOutputMaxFlow, taskMain=taskMain)
