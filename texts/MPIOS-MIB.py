...
MibIdentifier, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Counter32, NotificationType, IpAddress, ObjectIdentity, Counter64, Gauge32, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Counter32", "NotificationType", "IpAddress", "ObjectIdentity", "Counter64", "Gauge32", "iso", "Integer32")
...
mibBuilder.exportSymbols("MPIOS-MIB", rtrJitterDelaySdMin=rtrJitterDelaySdMin, rtrEntityName=rtrEntityName, rtrEntityLogMaxSize=rtrEntityLogMaxSize, cpuUtilDeltaUtil=cpuUtilDeltaUtil, sysTemperature=sysTemperature, rtrEntityThreshold=rtrEntityThreshold, rtrScheduleStartTime=rtrScheduleStartTime, sysMemory=sysMemory, rtrJitterState=rtrJitterState, sysRtrGroupMgt=sysRtrGroupMgt, rtrScheduleType=rtrScheduleType, rtrFlStaTmOutputMinPkts=rtrFlStaTmOutputMinPkts, rtrJitterDelaySdMax=rtrJitterDelaySdMax, rtrFlStaOutputMaxPkts=rtrFlStaOutputMaxPkts, sysRtrFlowStatisticsTable=sysRtrFlowStatisticsTable, rtrJitterDelayDsMin=rtrJitterDelayDsMin, rtrScheduleRepeat=rtrScheduleRepeat, sysIfOutUcastPkts=sysIfOutUcastPkts, cpuUtilDeltaTicks=cpuUtilDeltaTicks, taskStackBase=taskStackBase, rtrGroupId=rtrGroupId, cpuUtilTable=cpuUtilTable, sysAlertTrapInt=sysAlertTrapInt, rtrEntityId=rtrEntityId, sysIfPktPriStatistics=sysIfPktPriStatistics, sysIfOutNUcastPkts=sysIfOutNUcastPkts, rtrIcmpEchoTimeout=rtrIcmpEchoTimeout, rtrJitterMosMin=rtrJitterMosMin, rtrUdpechoTimeout=rtrUdpechoTimeout, sysCpuAlertTemper=sysCpuAlertTemper, sysIfInOctets=sysIfInOctets, cpuUtilDeltaUsedTicks=cpuUtilDeltaUsedTicks, rtrIcmpEchoPktTotalSend=rtrIcmpEchoPktTotalSend, rtrUdpechoSourcePort=rtrUdpechoSourcePort, rtrScheduleObjId=rtrScheduleObjId, rtrFlStaTmInputMinPkts=rtrFlStaTmInputMinPkts, sysRtrUdpechoMgt=sysRtrUdpechoMgt, sysIfInUnkownProtos=sysIfInUnkownProtos, rtrFlStaTmOutputMinFlow=rtrFlStaTmOutputMinFlow, sysRtrEntityMgt=sysRtrEntityMgt, sysRtrIcmpEchoEntry=sysRtrIcmpEchoEntry, rtrFlowStatisticsRowStatus=rtrFlowStatisticsRowStatus, sysRtrGbl=sysRtrGbl, rtrGroupRowStatus=rtrGroupRowStatus, rtrIcmpEchoSourceIp=rtrIcmpEchoSourceIp, cpuTaskEntry=cpuTaskEntry, sysCpuTaskTabView=sysCpuTaskTabView, rtrEntityRowStatus=rtrEntityRowStatus, taskOptions=taskOptions, sysRtrScheduleTable=sysRtrScheduleTable, rtrFlStaTmOutputMaxFlow=rtrFlStaTmOutputMaxFlow, sysTask=sysTask, rtrFlStaTmInputMinFlow=rtrFlStaTmInputMinFlow, checkCpuTimeInterval=checkCpuTimeInterval, sysIfInNUcastPkts=sysIfInNUcastPkts, rtrUdpechoPktSucc=rtrUdpechoPktSucc, memoryTotalBytes=memoryTotalBytes, rtrJitterSourceIp=rtrJitterSourceIp, rtrFlStaOutputMinFlow=rtrFlStaOutputMinFlow, sysIfOutDiscards=sysIfOutDiscards, sysRtrGroupEntry=sysRtrGroupEntry, rtrScheduleLifeFlag=rtrScheduleLifeFlag, sysRtrUdpechoTable=sysRtrUdpechoTable, avgBlockSizeFree=avgBlockSizeFree, sysIfInErrors=sysIfInErrors, rtrIcmpEchoPktTotalRcvd=rtrIcmpEchoPktTotalRcvd, cpuTaskAverageUtil=cpuTaskAverageUtil, taskPriority=taskPriority, rtrIcmpEchoVrfName=rtrIcmpEchoVrfName, rtrUdpechoDelayMin=rtrUdpechoDelayMin, sysIfDesc=sysIfDesc, rtrFlStaInputMaxFlow=rtrFlStaInputMaxFlow, rtrUdpechoPktLen=rtrUdpechoPktLen, maxBlockSizeFree=maxBlockSizeFree, rtrJitterPktLen=rtrJitterPktLen, rtrIcmpEchoIsScheduling=rtrIcmpEchoIsScheduling, rtrFlStaOutputMinPkts=rtrFlStaOutputMinPkts, sysRtrFlowStatisticsMgt=sysRtrFlowStatisticsMgt, rtrJitterPktInterval=rtrJitterPktInterval, taskStackSizeUsage=taskStackSizeUsage, rtrJitterVrfName=rtrJitterVrfName, rtrFlStaTmInputMaxFlow=rtrFlStaTmInputMaxFlow, cpuTaskCurrentUtil=cpuTaskCurrentUtil, avgBlockSizeAlloc=avgBlockSizeAlloc, taskStackPtr=taskStackPtr, rtrIcmpEchoRowStatus=rtrIcmpEchoRowStatus, rtrJitterIcpifMax=rtrJitterIcpifMax, sysIfOutErrors=sysIfOutErrors, rtrUdpechoDelay=rtrUdpechoDelay, rtrScheduleAfterTime=rtrScheduleAfterTime, numBytesAlloc=numBytesAlloc, rtrIcmpEchoTos=rtrIcmpEchoTos, rtrJitterDelayDsMax=rtrJitterDelayDsMax, sysMainBoardAlertTemper=sysMainBoardAlertTemper, rtrJitterSdMin=rtrJitterSdMin, rtrEntityType=rtrEntityType, sysIfOutOctets=sysIfOutOctets, rtrJitterIcpifMin=rtrJitterIcpifMin, rtrScheduleStartTimeFlag=rtrScheduleStartTimeFlag, rtrJitterPktLossDs=rtrJitterPktLossDs, rtrJitterDsMin=rtrJitterDsMin, rtrIcmpEchoSchInterval=rtrIcmpEchoSchInterval, sysMainBoardTemper=sysMainBoardTemper, iosSystem=iosSystem, rtrIcmpEchoPktLen=rtrIcmpEchoPktLen, taskTable=taskTable, taskDescr=taskDescr, rtrEntityLogType=rtrEntityLogType, taskId=taskId, rtrScheduleId=rtrScheduleId, rtrFlStaOutputMaxFlow=rtrFlStaOutputMaxFlow, rtrUdpechoVrfName=rtrUdpechoVrfName, rtrIcmpEchoEntityId=rtrIcmpEchoEntityId, rtrJitterCodec=rtrJitterCodec, cpuUtilTotalTimes=cpuUtilTotalTimes, sysRtrCtrl=sysRtrCtrl, rtrJitterSchInterval=rtrJitterSchInterval, sysIfStatistic=sysIfStatistic, sysRtrJitterTable=sysRtrJitterTable, sysIfInDiscards=sysIfInDiscards, numBlocksAlloc=numBlocksAlloc, rtrJitterTargetIp=rtrJitterTargetIp, sysRtrResponder=sysRtrResponder, rtrIcmpEchoTargetIp=rtrIcmpEchoTargetIp, taskErrorStatus=taskErrorStatus, cpuUtilTotalTicks=cpuUtilTotalTicks, rtrScheduleLifeTime=rtrScheduleLifeTime, allocBytesPercent=allocBytesPercent, rtrJitterTargetPort=rtrJitterTargetPort, rtrIcmpEchoVerifyData=rtrIcmpEchoVerifyData, sysCpu=sysCpu, rtrIcmpEchoExtendFlag=rtrIcmpEchoExtendFlag, rtrFlStatisticsEntityId=rtrFlStatisticsEntityId, rtrFlStaInputMaxPkts=rtrFlStaInputMaxPkts, rtrGroupInterval=rtrGroupInterval, rtrIcmpEchoPktNum=rtrIcmpEchoPktNum, rtrJitterSdMax=rtrJitterSdMax, cpuTaskDeltaUtil=cpuTaskDeltaUtil, taskStackPos=taskStackPos, sysCpuTemper=sysCpuTemper, iosObjects=iosObjects, sysRtrIcmpEchoMgt=sysRtrIcmpEchoMgt, rtrJitterTimeout=rtrJitterTimeout, rtrUdpechoTargetPort=rtrUdpechoTargetPort, rtrJitterRowStatus=rtrJitterRowStatus, cpuUtilTotalUsedTicks=cpuUtilTotalUsedTicks, rtrEntityLogFilter=rtrEntityLogFilter, rtrFlStaInputMinFlow=rtrFlStaInputMinFlow, sysRtrGroupTable=sysRtrGroupTable, rtrUdpechoSchInterval=rtrUdpechoSchInterval, sysIfPktPriStaEntry=sysIfPktPriStaEntry, sysRtrEntityTable=sysRtrEntityTable, rtrFlStaInputMinPkts=rtrFlStaInputMinPkts, rtrUdpechoTargetIp=rtrUdpechoTargetIp, cpuUtilCurrentUtil=cpuUtilCurrentUtil, rtrUdpechoTos=rtrUdpechoTos, rtrGroupEntityMembers=rtrGroupEntityMembers, sysIfIndex=sysIfIndex, taskStackSize=taskStackSize, sysRtrJitterMgt=sysRtrJitterMgt, sysRtrScheduleEntry=sysRtrScheduleEntry, rtrGroupName=rtrGroupName, cpuTaskTotalTicks=cpuTaskTotalTicks, cpuTaskPri=cpuTaskPri, rtrUdpechoEntityId=rtrUdpechoEntityId, rtrUdpechoPktLoss=rtrUdpechoPktLoss, rtrJitterMosMax=rtrJitterMosMax, rtrFlStatisticsIfName=rtrFlStatisticsIfName, cpuTaskId=cpuTaskId, cpuTaskTable=cpuTaskTable, taskStackFree=taskStackFree, cpuUtilDeltaTimes=cpuUtilDeltaTimes, sysNFI=sysNFI, rtrJitterSourcePort=rtrJitterSourcePort, rtrJitterPktLossSd=rtrJitterPktLossSd, taskStackEnd=taskStackEnd, rtrFlStatisticsInterval=rtrFlStatisticsInterval, taskEntry=taskEntry, EnabledStatus=EnabledStatus, taskStatus=taskStatus, rtrIcmpEchoSetDf=rtrIcmpEchoSetDf, sysRtrIcmpEchoTable=sysRtrIcmpEchoTable, rtrJitterPktNum=rtrJitterPktNum, rtrFlStaTmOutputMaxPkts=rtrFlStaTmOutputMaxPkts, sysIfPktPriority=sysIfPktPriority, cpuTaskDeltaTicks=cpuTaskDeltaTicks, cpuUtilAverageUtil=cpuUtilAverageUtil, rtrScheduleInterval=rtrScheduleInterval, sysCpuStatus=sysCpuStatus, sysIfInUcastPkts=sysIfInUcastPkts, cpuUtilEntry=cpuUtilEntry, sysRtrFlowStatisticsEntry=sysRtrFlowStatisticsEntry, PYSNMP_MODULE_ID=mpios, rtrJitterEntityId=rtrJitterEntityId, rtrUdpechoDelayMax=rtrUdpechoDelayMax, numBytesFree=numBytesFree, rtrJitterMinRtt=rtrJitterMinRtt, rtrScheduleAgeOut=rtrScheduleAgeOut, numBlocksFree=numBlocksFree, sysRtrEntityEntry=sysRtrEntityEntry, rtrJitterDsMax=rtrJitterDsMax, cpuUtilCpuId=cpuUtilCpuId, rtrUdpechoState=rtrUdpechoState, rtrScheduleRowStatus=rtrScheduleRowStatus, rtrJitterTos=rtrJitterTos, rtrJitterMaxRtt=rtrJitterMaxRtt, taskName=taskName, rtrFlStaTmInputMaxPkts=rtrFlStaTmInputMaxPkts, cpuTaskName=cpuTaskName, taskMain=taskMain, rtrUdpechoRowStatus=rtrUdpechoRowStatus, mpios=mpios, sysRtrJitterEntry=sysRtrJitterEntry, sysRtrUdpechoEntry=sysRtrUdpechoEntry, sysIfPktPriStaTable=sysIfPktPriStaTable, rtrIcmpEchoSuccessRate=rtrIcmpEchoSuccessRate, sysRtrScheduleMgt=sysRtrScheduleMgt, taskStackMaxUsed=taskStackMaxUsed, rtrUdpechoSourceIp=rtrUdpechoSourceIp)
