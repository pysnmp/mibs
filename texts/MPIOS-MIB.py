...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, TimeTicks, MibIdentifier, Bits, IpAddress, ObjectIdentity, Counter32, NotificationType, iso, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "TimeTicks", "MibIdentifier", "Bits", "IpAddress", "ObjectIdentity", "Counter32", "NotificationType", "iso", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("MPIOS-MIB", sysCpuAlertTemper=sysCpuAlertTemper, taskStackSize=taskStackSize, rtrScheduleType=rtrScheduleType, rtrScheduleObjId=rtrScheduleObjId, sysIfStatistic=sysIfStatistic, rtrFlStatisticsEntityId=rtrFlStatisticsEntityId, rtrEntityThreshold=rtrEntityThreshold, rtrFlStaTmOutputMaxFlow=rtrFlStaTmOutputMaxFlow, rtrJitterTargetIp=rtrJitterTargetIp, sysMemory=sysMemory, taskStackPos=taskStackPos, rtrScheduleLifeFlag=rtrScheduleLifeFlag, cpuUtilDeltaUtil=cpuUtilDeltaUtil, rtrJitterPktLossSd=rtrJitterPktLossSd, taskStackEnd=taskStackEnd, sysRtrScheduleTable=sysRtrScheduleTable, rtrIcmpEchoTos=rtrIcmpEchoTos, sysRtrJitterMgt=sysRtrJitterMgt, rtrJitterIcpifMin=rtrJitterIcpifMin, rtrGroupEntityMembers=rtrGroupEntityMembers, rtrUdpechoTargetPort=rtrUdpechoTargetPort, rtrScheduleId=rtrScheduleId, sysIfInUnkownProtos=sysIfInUnkownProtos, rtrEntityLogFilter=rtrEntityLogFilter, cpuTaskCurrentUtil=cpuTaskCurrentUtil, cpuTaskEntry=cpuTaskEntry, sysMainBoardTemper=sysMainBoardTemper, cpuTaskPri=cpuTaskPri, rtrEntityLogMaxSize=rtrEntityLogMaxSize, sysIfPktPriStaTable=sysIfPktPriStaTable, sysNFI=sysNFI, avgBlockSizeFree=avgBlockSizeFree, checkCpuTimeInterval=checkCpuTimeInterval, avgBlockSizeAlloc=avgBlockSizeAlloc, rtrJitterPktLen=rtrJitterPktLen, cpuTaskTotalTicks=cpuTaskTotalTicks, taskStackFree=taskStackFree, sysRtrScheduleEntry=sysRtrScheduleEntry, rtrJitterSchInterval=rtrJitterSchInterval, rtrFlStaTmOutputMinFlow=rtrFlStaTmOutputMinFlow, taskStatus=taskStatus, rtrFlStatisticsInterval=rtrFlStatisticsInterval, rtrJitterMosMin=rtrJitterMosMin, rtrJitterSourceIp=rtrJitterSourceIp, sysRtrJitterEntry=sysRtrJitterEntry, rtrJitterDsMin=rtrJitterDsMin, rtrFlStaTmInputMaxPkts=rtrFlStaTmInputMaxPkts, rtrFlStaInputMinFlow=rtrFlStaInputMinFlow, sysRtrUdpechoTable=sysRtrUdpechoTable, rtrIcmpEchoTargetIp=rtrIcmpEchoTargetIp, taskEntry=taskEntry, rtrJitterDelaySdMin=rtrJitterDelaySdMin, sysIfInNUcastPkts=sysIfInNUcastPkts, rtrIcmpEchoRowStatus=rtrIcmpEchoRowStatus, sysRtrGroupTable=sysRtrGroupTable, rtrGroupName=rtrGroupName, rtrJitterSdMin=rtrJitterSdMin, rtrJitterDsMax=rtrJitterDsMax, rtrJitterDelayDsMax=rtrJitterDelayDsMax, rtrFlStaTmInputMinPkts=rtrFlStaTmInputMinPkts, rtrEntityName=rtrEntityName, rtrIcmpEchoSchInterval=rtrIcmpEchoSchInterval, sysRtrUdpechoMgt=sysRtrUdpechoMgt, rtrScheduleAgeOut=rtrScheduleAgeOut, rtrJitterMaxRtt=rtrJitterMaxRtt, taskStackPtr=taskStackPtr, sysRtrIcmpEchoTable=sysRtrIcmpEchoTable, rtrJitterTos=rtrJitterTos, iosSystem=iosSystem, rtrJitterEntityId=rtrJitterEntityId, rtrUdpechoVrfName=rtrUdpechoVrfName, sysRtrResponder=sysRtrResponder, cpuTaskDeltaUtil=cpuTaskDeltaUtil, sysRtrEntityEntry=sysRtrEntityEntry, cpuUtilCpuId=cpuUtilCpuId, sysAlertTrapInt=sysAlertTrapInt, rtrUdpechoEntityId=rtrUdpechoEntityId, sysIfOutDiscards=sysIfOutDiscards, rtrJitterCodec=rtrJitterCodec, allocBytesPercent=allocBytesPercent, rtrJitterRowStatus=rtrJitterRowStatus, rtrJitterMinRtt=rtrJitterMinRtt, cpuUtilCurrentUtil=cpuUtilCurrentUtil, sysTask=sysTask, sysRtrFlowStatisticsTable=sysRtrFlowStatisticsTable, rtrScheduleAfterTime=rtrScheduleAfterTime, rtrFlStaTmInputMaxFlow=rtrFlStaTmInputMaxFlow, rtrIcmpEchoVrfName=rtrIcmpEchoVrfName, rtrFlStaInputMinPkts=rtrFlStaInputMinPkts, sysCpuStatus=sysCpuStatus, sysRtrFlowStatisticsEntry=sysRtrFlowStatisticsEntry, rtrIcmpEchoSetDf=rtrIcmpEchoSetDf, taskErrorStatus=taskErrorStatus, sysIfOutErrors=sysIfOutErrors, cpuUtilDeltaUsedTicks=cpuUtilDeltaUsedTicks, taskStackMaxUsed=taskStackMaxUsed, rtrGroupRowStatus=rtrGroupRowStatus, rtrScheduleRowStatus=rtrScheduleRowStatus, cpuTaskDeltaTicks=cpuTaskDeltaTicks, rtrJitterPktInterval=rtrJitterPktInterval, sysRtrScheduleMgt=sysRtrScheduleMgt, rtrScheduleRepeat=rtrScheduleRepeat, sysRtrGroupEntry=sysRtrGroupEntry, rtrIcmpEchoVerifyData=rtrIcmpEchoVerifyData, mpios=mpios, sysIfPktPriStatistics=sysIfPktPriStatistics, sysRtrCtrl=sysRtrCtrl, memoryTotalBytes=memoryTotalBytes, rtrUdpechoState=rtrUdpechoState, sysIfInUcastPkts=sysIfInUcastPkts, rtrUdpechoTos=rtrUdpechoTos, taskStackBase=taskStackBase, rtrGroupId=rtrGroupId, taskMain=taskMain, sysIfOutOctets=sysIfOutOctets, cpuUtilDeltaTicks=cpuUtilDeltaTicks, rtrJitterDelaySdMax=rtrJitterDelaySdMax, rtrJitterSdMax=rtrJitterSdMax, rtrUdpechoPktLen=rtrUdpechoPktLen, sysRtrEntityMgt=sysRtrEntityMgt, cpuUtilEntry=cpuUtilEntry, rtrUdpechoDelayMin=rtrUdpechoDelayMin, rtrJitterMosMax=rtrJitterMosMax, rtrFlStaInputMaxPkts=rtrFlStaInputMaxPkts, rtrScheduleStartTime=rtrScheduleStartTime, taskId=taskId, sysRtrIcmpEchoMgt=sysRtrIcmpEchoMgt, rtrIcmpEchoExtendFlag=rtrIcmpEchoExtendFlag, rtrEntityLogType=rtrEntityLogType, rtrUdpechoRowStatus=rtrUdpechoRowStatus, sysIfDesc=sysIfDesc, PYSNMP_MODULE_ID=mpios, rtrJitterTimeout=rtrJitterTimeout, rtrJitterSourcePort=rtrJitterSourcePort, rtrEntityType=rtrEntityType, taskPriority=taskPriority, cpuUtilDeltaTimes=cpuUtilDeltaTimes, rtrJitterTargetPort=rtrJitterTargetPort, cpuTaskTable=cpuTaskTable, sysIfInErrors=sysIfInErrors, taskDescr=taskDescr, rtrEntityId=rtrEntityId, rtrScheduleStartTimeFlag=rtrScheduleStartTimeFlag, sysIfOutNUcastPkts=sysIfOutNUcastPkts, rtrFlStatisticsIfName=rtrFlStatisticsIfName, numBytesFree=numBytesFree, numBlocksFree=numBlocksFree, rtrUdpechoTimeout=rtrUdpechoTimeout, rtrIcmpEchoIsScheduling=rtrIcmpEchoIsScheduling, sysRtrFlowStatisticsMgt=sysRtrFlowStatisticsMgt, rtrFlStaOutputMinFlow=rtrFlStaOutputMinFlow, rtrScheduleInterval=rtrScheduleInterval, iosObjects=iosObjects, rtrIcmpEchoTimeout=rtrIcmpEchoTimeout, sysRtrEntityTable=sysRtrEntityTable, rtrUdpechoPktLoss=rtrUdpechoPktLoss, rtrIcmpEchoPktLen=rtrIcmpEchoPktLen, sysTemperature=sysTemperature, EnabledStatus=EnabledStatus, cpuTaskName=cpuTaskName, cpuUtilTotalTicks=cpuUtilTotalTicks, rtrGroupInterval=rtrGroupInterval, rtrIcmpEchoPktTotalSend=rtrIcmpEchoPktTotalSend, rtrFlStaOutputMaxPkts=rtrFlStaOutputMaxPkts, rtrJitterState=rtrJitterState, rtrUdpechoSourcePort=rtrUdpechoSourcePort, rtrUdpechoDelayMax=rtrUdpechoDelayMax, cpuTaskAverageUtil=cpuTaskAverageUtil, sysRtrGroupMgt=sysRtrGroupMgt, sysIfPktPriStaEntry=sysIfPktPriStaEntry, rtrIcmpEchoPktTotalRcvd=rtrIcmpEchoPktTotalRcvd, cpuUtilTable=cpuUtilTable, sysCpuTaskTabView=sysCpuTaskTabView, rtrIcmpEchoSourceIp=rtrIcmpEchoSourceIp, taskName=taskName, rtrScheduleLifeTime=rtrScheduleLifeTime, numBlocksAlloc=numBlocksAlloc, taskOptions=taskOptions, sysRtrJitterTable=sysRtrJitterTable, rtrJitterPktLossDs=rtrJitterPktLossDs, taskStackSizeUsage=taskStackSizeUsage, rtrUdpechoDelay=rtrUdpechoDelay, rtrJitterDelayDsMin=rtrJitterDelayDsMin, maxBlockSizeFree=maxBlockSizeFree, sysCpuTemper=sysCpuTemper, sysRtrUdpechoEntry=sysRtrUdpechoEntry, rtrUdpechoTargetIp=rtrUdpechoTargetIp, numBytesAlloc=numBytesAlloc, rtrFlowStatisticsRowStatus=rtrFlowStatisticsRowStatus, rtrIcmpEchoSuccessRate=rtrIcmpEchoSuccessRate, rtrIcmpEchoPktNum=rtrIcmpEchoPktNum, rtrEntityRowStatus=rtrEntityRowStatus, rtrFlStaOutputMinPkts=rtrFlStaOutputMinPkts, cpuUtilTotalUsedTicks=cpuUtilTotalUsedTicks, cpuUtilAverageUtil=cpuUtilAverageUtil, sysIfInOctets=sysIfInOctets, cpuTaskId=cpuTaskId, sysMainBoardAlertTemper=sysMainBoardAlertTemper, sysCpu=sysCpu, rtrFlStaTmOutputMinPkts=rtrFlStaTmOutputMinPkts, rtrUdpechoSourceIp=rtrUdpechoSourceIp, rtrJitterIcpifMax=rtrJitterIcpifMax, rtrFlStaTmInputMinFlow=rtrFlStaTmInputMinFlow, rtrFlStaOutputMaxFlow=rtrFlStaOutputMaxFlow, sysRtrGbl=sysRtrGbl, rtrUdpechoPktSucc=rtrUdpechoPktSucc, sysIfOutUcastPkts=sysIfOutUcastPkts, cpuUtilTotalTimes=cpuUtilTotalTimes, rtrIcmpEchoEntityId=rtrIcmpEchoEntityId, sysIfIndex=sysIfIndex, rtrFlStaInputMaxFlow=rtrFlStaInputMaxFlow, rtrJitterVrfName=rtrJitterVrfName, rtrFlStaTmOutputMaxPkts=rtrFlStaTmOutputMaxPkts, sysIfPktPriority=sysIfPktPriority, rtrUdpechoSchInterval=rtrUdpechoSchInterval, taskTable=taskTable, sysRtrIcmpEchoEntry=sysRtrIcmpEchoEntry, rtrJitterPktNum=rtrJitterPktNum, sysIfInDiscards=sysIfInDiscards)
