...
Integer32, Counter32, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, ModuleIdentity, NotificationType, ObjectIdentity, MibIdentifier, Gauge32, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "ModuleIdentity", "NotificationType", "ObjectIdentity", "MibIdentifier", "Gauge32", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("MPIOS-MIB", taskStackFree=taskStackFree, cpuTaskTable=cpuTaskTable, rtrIcmpEchoRowStatus=rtrIcmpEchoRowStatus, sysIfInUcastPkts=sysIfInUcastPkts, sysIfOutOctets=sysIfOutOctets, rtrUdpechoDelayMin=rtrUdpechoDelayMin, cpuUtilTotalTimes=cpuUtilTotalTimes, rtrFlStaInputMinFlow=rtrFlStaInputMinFlow, sysIfIndex=sysIfIndex, rtrScheduleId=rtrScheduleId, sysRtrGroupMgt=sysRtrGroupMgt, rtrIcmpEchoExtendFlag=rtrIcmpEchoExtendFlag, rtrJitterPktLen=rtrJitterPktLen, sysCpu=sysCpu, sysCpuAlertTemper=sysCpuAlertTemper, taskStackSize=taskStackSize, rtrFlStaTmInputMinFlow=rtrFlStaTmInputMinFlow, sysIfPktPriStatistics=sysIfPktPriStatistics, taskDescr=taskDescr, cpuTaskTotalTicks=cpuTaskTotalTicks, cpuUtilDeltaUtil=cpuUtilDeltaUtil, taskStackSizeUsage=taskStackSizeUsage, rtrJitterState=rtrJitterState, cpuTaskId=cpuTaskId, taskStackEnd=taskStackEnd, sysRtrFlowStatisticsMgt=sysRtrFlowStatisticsMgt, cpuUtilEntry=cpuUtilEntry, rtrFlStaTmOutputMaxPkts=rtrFlStaTmOutputMaxPkts, rtrFlStaTmInputMaxPkts=rtrFlStaTmInputMaxPkts, rtrUdpechoVrfName=rtrUdpechoVrfName, cpuUtilCurrentUtil=cpuUtilCurrentUtil, sysRtrScheduleTable=sysRtrScheduleTable, sysCpuTaskTabView=sysCpuTaskTabView, rtrFlStaTmInputMaxFlow=rtrFlStaTmInputMaxFlow, rtrEntityThreshold=rtrEntityThreshold, cpuUtilTotalUsedTicks=cpuUtilTotalUsedTicks, numBlocksFree=numBlocksFree, rtrIcmpEchoPktTotalSend=rtrIcmpEchoPktTotalSend, cpuTaskEntry=cpuTaskEntry, rtrGroupEntityMembers=rtrGroupEntityMembers, rtrJitterTargetIp=rtrJitterTargetIp, allocBytesPercent=allocBytesPercent, rtrJitterTargetPort=rtrJitterTargetPort, rtrGroupName=rtrGroupName, rtrJitterPktInterval=rtrJitterPktInterval, maxBlockSizeFree=maxBlockSizeFree, sysIfPktPriority=sysIfPktPriority, rtrFlStaOutputMaxPkts=rtrFlStaOutputMaxPkts, rtrJitterMosMax=rtrJitterMosMax, rtrIcmpEchoSuccessRate=rtrIcmpEchoSuccessRate, rtrJitterMinRtt=rtrJitterMinRtt, rtrJitterIcpifMax=rtrJitterIcpifMax, iosObjects=iosObjects, rtrUdpechoState=rtrUdpechoState, taskPriority=taskPriority, sysMemory=sysMemory, rtrFlStaInputMaxPkts=rtrFlStaInputMaxPkts, sysIfOutDiscards=sysIfOutDiscards, sysRtrFlowStatisticsTable=sysRtrFlowStatisticsTable, sysIfOutNUcastPkts=sysIfOutNUcastPkts, sysRtrGroupTable=sysRtrGroupTable, mpios=mpios, cpuTaskDeltaTicks=cpuTaskDeltaTicks, cpuUtilTable=cpuUtilTable, sysRtrCtrl=sysRtrCtrl, rtrScheduleObjId=rtrScheduleObjId, sysRtrUdpechoTable=sysRtrUdpechoTable, rtrUdpechoEntityId=rtrUdpechoEntityId, rtrJitterTimeout=rtrJitterTimeout, rtrFlStaTmOutputMinFlow=rtrFlStaTmOutputMinFlow, rtrJitterPktLossDs=rtrJitterPktLossDs, rtrUdpechoSourceIp=rtrUdpechoSourceIp, rtrJitterVrfName=rtrJitterVrfName, cpuTaskPri=cpuTaskPri, sysRtrFlowStatisticsEntry=sysRtrFlowStatisticsEntry, numBytesFree=numBytesFree, avgBlockSizeAlloc=avgBlockSizeAlloc, rtrUdpechoSchInterval=rtrUdpechoSchInterval, sysRtrScheduleMgt=sysRtrScheduleMgt, cpuTaskCurrentUtil=cpuTaskCurrentUtil, rtrScheduleLifeTime=rtrScheduleLifeTime, sysRtrResponder=sysRtrResponder, rtrIcmpEchoTimeout=rtrIcmpEchoTimeout, sysMainBoardAlertTemper=sysMainBoardAlertTemper, rtrIcmpEchoPktNum=rtrIcmpEchoPktNum, sysRtrIcmpEchoTable=sysRtrIcmpEchoTable, rtrJitterCodec=rtrJitterCodec, rtrUdpechoTargetIp=rtrUdpechoTargetIp, rtrFlStaInputMinPkts=rtrFlStaInputMinPkts, sysRtrIcmpEchoMgt=sysRtrIcmpEchoMgt, rtrJitterEntityId=rtrJitterEntityId, rtrJitterDsMin=rtrJitterDsMin, rtrJitterMaxRtt=rtrJitterMaxRtt, rtrJitterDelayDsMax=rtrJitterDelayDsMax, rtrGroupId=rtrGroupId, rtrUdpechoTargetPort=rtrUdpechoTargetPort, taskName=taskName, taskTable=taskTable, sysCpuTemper=sysCpuTemper, rtrEntityType=rtrEntityType, sysIfPktPriStaTable=sysIfPktPriStaTable, sysAlertTrapInt=sysAlertTrapInt, sysIfInDiscards=sysIfInDiscards, avgBlockSizeFree=avgBlockSizeFree, rtrJitterMosMin=rtrJitterMosMin, sysRtrJitterTable=sysRtrJitterTable, rtrScheduleRowStatus=rtrScheduleRowStatus, sysRtrJitterEntry=sysRtrJitterEntry, rtrJitterSchInterval=rtrJitterSchInterval, rtrEntityRowStatus=rtrEntityRowStatus, rtrJitterRowStatus=rtrJitterRowStatus, rtrFlStatisticsInterval=rtrFlStatisticsInterval, rtrUdpechoDelay=rtrUdpechoDelay, rtrFlStaOutputMinPkts=rtrFlStaOutputMinPkts, sysRtrUdpechoEntry=sysRtrUdpechoEntry, rtrJitterIcpifMin=rtrJitterIcpifMin, rtrIcmpEchoEntityId=rtrIcmpEchoEntityId, rtrEntityLogMaxSize=rtrEntityLogMaxSize, sysNFI=sysNFI, EnabledStatus=EnabledStatus, rtrFlStaOutputMaxFlow=rtrFlStaOutputMaxFlow, rtrFlStaOutputMinFlow=rtrFlStaOutputMinFlow, sysRtrEntityTable=sysRtrEntityTable, sysRtrScheduleEntry=sysRtrScheduleEntry, rtrScheduleAgeOut=rtrScheduleAgeOut, rtrEntityId=rtrEntityId, taskStackPos=taskStackPos, rtrIcmpEchoSetDf=rtrIcmpEchoSetDf, rtrJitterSourceIp=rtrJitterSourceIp, taskOptions=taskOptions, rtrScheduleInterval=rtrScheduleInterval, rtrUdpechoSourcePort=rtrUdpechoSourcePort, cpuTaskAverageUtil=cpuTaskAverageUtil, rtrIcmpEchoSchInterval=rtrIcmpEchoSchInterval, cpuUtilAverageUtil=cpuUtilAverageUtil, rtrJitterPktNum=rtrJitterPktNum, taskMain=taskMain, taskErrorStatus=taskErrorStatus, cpuUtilCpuId=cpuUtilCpuId, rtrScheduleLifeFlag=rtrScheduleLifeFlag, rtrFlStaTmOutputMaxFlow=rtrFlStaTmOutputMaxFlow, taskEntry=taskEntry, cpuTaskName=cpuTaskName, sysIfInUnkownProtos=sysIfInUnkownProtos, cpuTaskDeltaUtil=cpuTaskDeltaUtil, sysRtrJitterMgt=sysRtrJitterMgt, rtrFlStatisticsEntityId=rtrFlStatisticsEntityId, numBlocksAlloc=numBlocksAlloc, cpuUtilDeltaUsedTicks=cpuUtilDeltaUsedTicks, cpuUtilDeltaTimes=cpuUtilDeltaTimes, sysMainBoardTemper=sysMainBoardTemper, rtrIcmpEchoSourceIp=rtrIcmpEchoSourceIp, memoryTotalBytes=memoryTotalBytes, rtrScheduleStartTimeFlag=rtrScheduleStartTimeFlag, cpuUtilTotalTicks=cpuUtilTotalTicks, rtrEntityName=rtrEntityName, rtrUdpechoTos=rtrUdpechoTos, numBytesAlloc=numBytesAlloc, cpuUtilDeltaTicks=cpuUtilDeltaTicks, taskStackBase=taskStackBase, rtrJitterDelaySdMin=rtrJitterDelaySdMin, rtrJitterSourcePort=rtrJitterSourcePort, rtrUdpechoPktLen=rtrUdpechoPktLen, rtrIcmpEchoTargetIp=rtrIcmpEchoTargetIp, rtrEntityLogFilter=rtrEntityLogFilter, sysTask=sysTask, rtrGroupRowStatus=rtrGroupRowStatus, sysRtrEntityMgt=sysRtrEntityMgt, taskStatus=taskStatus, sysCpuStatus=sysCpuStatus, rtrScheduleType=rtrScheduleType, rtrIcmpEchoPktTotalRcvd=rtrIcmpEchoPktTotalRcvd, rtrUdpechoTimeout=rtrUdpechoTimeout, rtrIcmpEchoTos=rtrIcmpEchoTos, sysRtrGroupEntry=sysRtrGroupEntry, rtrUdpechoDelayMax=rtrUdpechoDelayMax, rtrJitterSdMin=rtrJitterSdMin, rtrUdpechoRowStatus=rtrUdpechoRowStatus, sysIfOutUcastPkts=sysIfOutUcastPkts, sysRtrEntityEntry=sysRtrEntityEntry, sysIfStatistic=sysIfStatistic, rtrFlStaInputMaxFlow=rtrFlStaInputMaxFlow, PYSNMP_MODULE_ID=mpios, rtrJitterDelayDsMin=rtrJitterDelayDsMin, rtrUdpechoPktSucc=rtrUdpechoPktSucc, rtrScheduleStartTime=rtrScheduleStartTime, sysRtrGbl=sysRtrGbl, taskId=taskId, taskStackMaxUsed=taskStackMaxUsed, rtrIcmpEchoPktLen=rtrIcmpEchoPktLen, rtrIcmpEchoVerifyData=rtrIcmpEchoVerifyData, rtrFlStaTmOutputMinPkts=rtrFlStaTmOutputMinPkts, taskStackPtr=taskStackPtr, checkCpuTimeInterval=checkCpuTimeInterval, rtrUdpechoPktLoss=rtrUdpechoPktLoss, rtrScheduleAfterTime=rtrScheduleAfterTime, sysIfInOctets=sysIfInOctets, rtrJitterDsMax=rtrJitterDsMax, sysIfInErrors=sysIfInErrors, sysTemperature=sysTemperature, rtrScheduleRepeat=rtrScheduleRepeat, rtrJitterTos=rtrJitterTos, rtrJitterDelaySdMax=rtrJitterDelaySdMax, sysRtrIcmpEchoEntry=sysRtrIcmpEchoEntry, rtrJitterSdMax=rtrJitterSdMax, sysIfDesc=sysIfDesc, sysIfInNUcastPkts=sysIfInNUcastPkts, rtrIcmpEchoVrfName=rtrIcmpEchoVrfName, rtrIcmpEchoIsScheduling=rtrIcmpEchoIsScheduling, iosSystem=iosSystem, rtrFlStatisticsIfName=rtrFlStatisticsIfName, rtrFlStaTmInputMinPkts=rtrFlStaTmInputMinPkts, sysIfOutErrors=sysIfOutErrors, rtrFlowStatisticsRowStatus=rtrFlowStatisticsRowStatus, rtrJitterPktLossSd=rtrJitterPktLossSd, rtrGroupInterval=rtrGroupInterval, sysIfPktPriStaEntry=sysIfPktPriStaEntry, rtrEntityLogType=rtrEntityLogType, sysRtrUdpechoMgt=sysRtrUdpechoMgt)
