...
iso, Bits, Counter32, IpAddress, NotificationType, enterprises, ObjectIdentity, Gauge32, MibIdentifier, Integer32, Counter64, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Counter32", "IpAddress", "NotificationType", "enterprises", "ObjectIdentity", "Gauge32", "MibIdentifier", "Integer32", "Counter64", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModulePorts=psModulePorts, sysBootTime=sysBootTime, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, psVendorID=psVendorID, psIndex=psIndex, psBaseAddress=psBaseAddress, advantechCommonMIB=advantechCommonMIB, sysModuleID=sysModuleID, psClassCode=psClassCode, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDeviceName=sysDeviceName, psFunctionIndex=psFunctionIndex, sysBootCount=sysBootCount, PYSNMP_MODULE_ID=advantechCommonMIB, sysDescr=sysDescr, sysReleaseDate=sysReleaseDate, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantech=advantech, psDeviceIndex=psDeviceIndex, psLength=psLength, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotEntry=pciSlotEntry, pciConfigObj=pciConfigObj, psDisplayName=psDisplayName, psDescr=psDescr, psDeviceID=psDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, psModuleType=psModuleType, snmpTrapSrvObj=snmpTrapSrvObj, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvPort=snmpTrapSrvPort, atSystem=atSystem, sysImageVersion=sysImageVersion, psSubsysDeviceID=psSubsysDeviceID, psLocation=psLocation, psState=psState, psBusIndex=psBusIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIRQ=psIRQ)
