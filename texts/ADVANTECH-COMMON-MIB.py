...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIP=snmpTrapSrvIP, psVendorID=psVendorID, psState=psState, psClassCode=psClassCode, advantech=advantech, atMgmt=atMgmt, snmpTrapSrvObj=snmpTrapSrvObj, psModuleType=psModuleType, psLocation=psLocation, sysFirstBootTime=sysFirstBootTime, psFunctionIndex=psFunctionIndex, atSystem=atSystem, pciConfigObj=pciConfigObj, psManufacturer=psManufacturer, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, sysDescr=sysDescr, psBaseAddress=psBaseAddress, psLength=psLength, sysReleaseDate=sysReleaseDate, psDeviceID=psDeviceID, sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psNumber=psNumber, psIRQ=psIRQ, psIndex=psIndex, psBusIndex=psBusIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDisplayName=psDisplayName, sysBootCount=sysBootCount, snmpTrapSrvEntry=snmpTrapSrvEntry, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotEntry=pciSlotEntry, psDescr=psDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, psModulePorts=psModulePorts, sysDeviceName=sysDeviceName, advantechCommonMIB=advantechCommonMIB, pciSlotTable=pciSlotTable, snmpTrapSrvIndex=snmpTrapSrvIndex, sysImageVersion=sysImageVersion, psSubsysVendorID=psSubsysVendorID, psDeviceIndex=psDeviceIndex)
