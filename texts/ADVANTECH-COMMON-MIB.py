...
iso, ObjectIdentity, NotificationType, ModuleIdentity, Bits, TimeTicks, Counter64, enterprises, Integer32, MibIdentifier, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Bits", "TimeTicks", "Counter64", "enterprises", "Integer32", "MibIdentifier", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIndex=snmpTrapSrvIndex, advantechCommonMIB=advantechCommonMIB, sysImageVersion=sysImageVersion, psDescr=psDescr, sysDeviceName=sysDeviceName, psDeviceID=psDeviceID, psDisplayName=psDisplayName, psVendorID=psVendorID, psSubsysDeviceID=psSubsysDeviceID, sysBootCount=sysBootCount, psModuleType=psModuleType, snmpTrapSrvPort=snmpTrapSrvPort, advantech=advantech, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotEntry=pciSlotEntry, psState=psState, psModulePorts=psModulePorts, atSystem=atSystem, pciConfigObj=pciConfigObj, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psClassCode=psClassCode, psLength=psLength, sysModuleID=sysModuleID, psSubsysVendorID=psSubsysVendorID, psIRQ=psIRQ, psNumber=psNumber, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, psLocation=psLocation, sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt, sysBootTime=sysBootTime, psFunctionIndex=psFunctionIndex, psBusIndex=psBusIndex, atPciConfig=atPciConfig, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, sysDescr=sysDescr, psDeviceIndex=psDeviceIndex, psBaseAddress=psBaseAddress, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvNumber=snmpTrapSrvNumber)
