...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, NotificationType, ModuleIdentity, iso, Counter64, ObjectIdentity, MibIdentifier, Gauge32, TimeTicks, Unsigned32, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "NotificationType", "ModuleIdentity", "iso", "Counter64", "ObjectIdentity", "MibIdentifier", "Gauge32", "TimeTicks", "Unsigned32", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psState=psState, snmpTrapSrvTable=snmpTrapSrvTable, psBusIndex=psBusIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atSystem=atSystem, sysDescr=sysDescr, sysReleaseDate=sysReleaseDate, atPciConfig=atPciConfig, PYSNMP_MODULE_ID=advantechCommonMIB, sysImageVersion=sysImageVersion, pciConfigObj=pciConfigObj, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, psDescr=psDescr, psFunctionIndex=psFunctionIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, snmpTrapSrvEntry=snmpTrapSrvEntry, advantech=advantech, advantechCommonMIB=advantechCommonMIB, psNumber=psNumber, sysModuleID=sysModuleID, psDeviceID=psDeviceID, sysFirstBootTime=sysFirstBootTime, psManufacturer=psManufacturer, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, pciSlotEntry=pciSlotEntry, atMgmt=atMgmt, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDeviceName=sysDeviceName, psLength=psLength, psIRQ=psIRQ, psModuleType=psModuleType, snmpTrapSrvPort=snmpTrapSrvPort, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psIndex=psIndex, sysBootCount=sysBootCount, psLocation=psLocation)
