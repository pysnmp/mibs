...
enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Integer32, IpAddress, MibIdentifier, TimeTicks, Counter64, Unsigned32, Gauge32, iso, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Integer32", "IpAddress", "MibIdentifier", "TimeTicks", "Counter64", "Unsigned32", "Gauge32", "iso", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModulePorts=psModulePorts, psDeviceID=psDeviceID, pciSlotTable=pciSlotTable, psLength=psLength, psState=psState, psDeviceIndex=psDeviceIndex, sysFirstBootTime=sysFirstBootTime, psIRQ=psIRQ, snmpTrapSrvPort=snmpTrapSrvPort, psDescr=psDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, psModuleType=psModuleType, psNumber=psNumber, sysImageVersion=sysImageVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvEntry=snmpTrapSrvEntry, psFunctionIndex=psFunctionIndex, advantech=advantech, sysDeviceName=sysDeviceName, pciSlotEntry=pciSlotEntry, psClassCode=psClassCode, psSubsysVendorID=psSubsysVendorID, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, psBaseAddress=psBaseAddress, sysModuleID=sysModuleID, sysBootTime=sysBootTime, psDisplayName=psDisplayName, psManufacturer=psManufacturer, sysDescr=sysDescr, sysBootCount=sysBootCount, snmpTrapSrvIndex=snmpTrapSrvIndex, PYSNMP_MODULE_ID=advantechCommonMIB, atMgmt=atMgmt, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, psLocation=psLocation, psBusIndex=psBusIndex, psIndex=psIndex, psVendorID=psVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvObj=snmpTrapSrvObj, atPciConfig=atPciConfig, psSubsysDeviceID=psSubsysDeviceID, atSystem=atSystem, pciConfigObj=pciConfigObj)
