...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModuleType=psModuleType, psLength=psLength, atPciConfig=atPciConfig, pciSlotTable=pciSlotTable, pciConfigObj=pciConfigObj, sysImageVersion=sysImageVersion, atMgmt=atMgmt, sysReleaseDate=sysReleaseDate, snmpTrapVersion=snmpTrapVersion, psIndex=psIndex, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, psNumber=psNumber, psFunctionIndex=psFunctionIndex, sysFirstBootTime=sysFirstBootTime, psManufacturer=psManufacturer, sysBootTime=sysBootTime, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, psState=psState, psModulePorts=psModulePorts, snmpTrapSrvPort=snmpTrapSrvPort, psBaseAddress=psBaseAddress, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDescr=psDescr, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, psClassCode=psClassCode, psDeviceID=psDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysDeviceID=psSubsysDeviceID, pciSlotEntry=pciSlotEntry, sysDescr=sysDescr, sysBootCount=sysBootCount, psDisplayName=psDisplayName, advantechCommonMIB=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, psLocation=psLocation, psIRQ=psIRQ, psBusIndex=psBusIndex, sysModuleID=sysModuleID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantech=advantech)
