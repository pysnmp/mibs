...
iso, Counter64, NotificationType, TimeTicks, Integer32, Gauge32, Unsigned32, ModuleIdentity, Bits, IpAddress, MibIdentifier, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "NotificationType", "TimeTicks", "Integer32", "Gauge32", "Unsigned32", "ModuleIdentity", "Bits", "IpAddress", "MibIdentifier", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantech=advantech, snmpTrapVersion=snmpTrapVersion, psModuleType=psModuleType, psIRQ=psIRQ, snmpTrapSrvIndex=snmpTrapSrvIndex, psLength=psLength, atSystem=atSystem, snmpTrapSrvTable=snmpTrapSrvTable, psClassCode=psClassCode, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, advantechCommonMIB=advantechCommonMIB, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, psDescr=psDescr, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psNumber=psNumber, pciConfigObj=pciConfigObj, psState=psState, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, psIndex=psIndex, psVendorID=psVendorID, pciSlotEntry=pciSlotEntry, psLocation=psLocation, sysModuleID=sysModuleID, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIP=snmpTrapSrvIP, PYSNMP_MODULE_ID=advantechCommonMIB, psManufacturer=psManufacturer, atPciConfig=atPciConfig, snmpTrapSrvPort=snmpTrapSrvPort, psBaseAddress=psBaseAddress, psSubsysDeviceID=psSubsysDeviceID, sysBootTime=sysBootTime, sysReleaseDate=sysReleaseDate, atMgmt=atMgmt, sysBootCount=sysBootCount, psDeviceID=psDeviceID)
