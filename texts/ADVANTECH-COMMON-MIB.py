...
# Produced by pysmi-1.1.8 at Sat Jan 15 16:25:56 2022
...
Bits, Counter64, Gauge32, TimeTicks, iso, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, IpAddress, Unsigned32, NotificationType, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "Gauge32", "TimeTicks", "iso", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "IpAddress", "Unsigned32", "NotificationType", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psVendorID=psVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, atMgmt=atMgmt, psLocation=psLocation, atSystem=atSystem, psIndex=psIndex, sysModuleID=sysModuleID, advantech=advantech, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModuleType=psModuleType, sysDeviceName=sysDeviceName, psDisplayName=psDisplayName, snmpTrapSrvIP=snmpTrapSrvIP, sysFirstBootTime=sysFirstBootTime, psManufacturer=psManufacturer, psDeviceIndex=psDeviceIndex, psSubsysVendorID=psSubsysVendorID, advantechCommonMIB=advantechCommonMIB, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, psClassCode=psClassCode, psLength=psLength, atPciConfig=atPciConfig, sysBootTime=sysBootTime, snmpTrapVersion=snmpTrapVersion, psIRQ=psIRQ, sysBootCount=sysBootCount, sysImageVersion=sysImageVersion, pciSlotTable=pciSlotTable, pciConfigObj=pciConfigObj, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, psBusIndex=psBusIndex, PYSNMP_MODULE_ID=advantechCommonMIB, sysDescr=sysDescr, psBaseAddress=psBaseAddress, psDescr=psDescr, psState=psState, sysReleaseDate=sysReleaseDate, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvPort=snmpTrapSrvPort)
