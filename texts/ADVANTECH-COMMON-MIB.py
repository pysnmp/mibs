...
ModuleIdentity, Counter64, enterprises, Bits, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Unsigned32, NotificationType, iso, MibIdentifier, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "enterprises", "Bits", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Unsigned32", "NotificationType", "iso", "MibIdentifier", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIRQ=psIRQ, snmpTrapSrvEntry=snmpTrapSrvEntry, sysModuleID=sysModuleID, psBaseAddress=psBaseAddress, psLength=psLength, psDeviceIndex=psDeviceIndex, psDisplayName=psDisplayName, atSystem=atSystem, sysReleaseDate=sysReleaseDate, sysDeviceName=sysDeviceName, psNumber=psNumber, atMgmt=atMgmt, pciSlotEntry=pciSlotEntry, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvNumber=snmpTrapSrvNumber, advantechCommonMIB=advantechCommonMIB, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDescr=sysDescr, psManufacturer=psManufacturer, snmpTrapVersion=snmpTrapVersion, psLocation=psLocation, psBusIndex=psBusIndex, atPciConfig=atPciConfig, advantech=advantech, psModulePorts=psModulePorts, psModuleType=psModuleType, sysFirstBootTime=sysFirstBootTime, pciSlotTable=pciSlotTable, psSubsysDeviceID=psSubsysDeviceID, psIndex=psIndex, psVendorID=psVendorID, psDescr=psDescr, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootCount=sysBootCount, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysVendorID=psSubsysVendorID, psClassCode=psClassCode, snmpTrapSrvIndex=snmpTrapSrvIndex, psState=psState, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, pciConfigObj=pciConfigObj, snmpTrapSrvPort=snmpTrapSrvPort)
