...
# Produced by pysmi-1.1.3 at Tue Nov 30 02:55:55 2021
...
ModuleIdentity, Counter32, Unsigned32, iso, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, enterprises, Counter64, Gauge32, Bits, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Unsigned32", "iso", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "enterprises", "Counter64", "Gauge32", "Bits", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBaseAddress=psBaseAddress, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIndex=snmpTrapSrvIndex, atSystem=atSystem, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceIndex=psDeviceIndex, psLocation=psLocation, psModuleType=psModuleType, psModulePorts=psModulePorts, psDeviceID=psDeviceID, sysDescr=sysDescr, advantech=advantech, sysImageVersion=sysImageVersion, psBusIndex=psBusIndex, sysDeviceName=sysDeviceName, psDescr=psDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, psNumber=psNumber, atMgmt=atMgmt, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, psIRQ=psIRQ, snmpTrapVersion=snmpTrapVersion, pciSlotTable=pciSlotTable, snmpTrapSrvIP=snmpTrapSrvIP, atPciConfig=atPciConfig, sysFirstBootTime=sysFirstBootTime, psState=psState, psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootTime=sysBootTime, psManufacturer=psManufacturer, psLength=psLength, sysReleaseDate=sysReleaseDate, sysModuleID=sysModuleID, sysBootCount=sysBootCount, advantechCommonMIB=advantechCommonMIB, pciConfigObj=pciConfigObj, snmpTrapSrvObj=snmpTrapSrvObj, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID)
