...
NotificationType, Counter32, iso, ModuleIdentity, enterprises, TimeTicks, Counter64, Unsigned32, IpAddress, Integer32, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "iso", "ModuleIdentity", "enterprises", "TimeTicks", "Counter64", "Unsigned32", "IpAddress", "Integer32", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atMgmt=atMgmt, psManufacturer=psManufacturer, psDeviceIndex=psDeviceIndex, psDeviceID=psDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, psSubsysDeviceID=psSubsysDeviceID, atSystem=atSystem, snmpTrapSrvNumber=snmpTrapSrvNumber, sysModuleID=sysModuleID, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, psBusIndex=psBusIndex, atPciConfig=atPciConfig, snmpTrapSrvIP=snmpTrapSrvIP, pciConfigObj=pciConfigObj, psIRQ=psIRQ, sysDescr=sysDescr, psClassCode=psClassCode, psModuleType=psModuleType, psIndex=psIndex, psDisplayName=psDisplayName, psVendorID=psVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDeviceName=sysDeviceName, psSubsysVendorID=psSubsysVendorID, pciSlotTable=pciSlotTable, psState=psState, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLocation=psLocation, psLength=psLength, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootCount=sysBootCount, sysBootTime=sysBootTime, psNumber=psNumber, snmpTrapSrvPort=snmpTrapSrvPort, psDescr=psDescr, snmpTrapVersion=snmpTrapVersion, sysReleaseDate=sysReleaseDate, pciSlotEntry=pciSlotEntry, psBaseAddress=psBaseAddress, advantechCommonMIB=advantechCommonMIB, advantech=advantech, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvObj=snmpTrapSrvObj, psModulePorts=psModulePorts, sysImageVersion=sysImageVersion, psFunctionIndex=psFunctionIndex)
