...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Bits, Unsigned32, IpAddress, Gauge32, Integer32, ModuleIdentity, TimeTicks, Counter64, Counter32, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Bits", "Unsigned32", "IpAddress", "Gauge32", "Integer32", "ModuleIdentity", "TimeTicks", "Counter64", "Counter32", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvPort=snmpTrapSrvPort, advantech=advantech, psDeviceID=psDeviceID, psLocation=psLocation, atSystem=atSystem, pciSlotEntry=pciSlotEntry, psIRQ=psIRQ, psClassCode=psClassCode, psNumber=psNumber, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, psDescr=psDescr, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, psManufacturer=psManufacturer, atMgmt=atMgmt, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvNumber=snmpTrapSrvNumber, atPciConfig=atPciConfig, psIndex=psIndex, psBaseAddress=psBaseAddress, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, psState=psState, PYSNMP_MODULE_ID=advantechCommonMIB, sysModuleID=sysModuleID, snmpTrapSrvEntry=snmpTrapSrvEntry, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapVersion=snmpTrapVersion, psDeviceIndex=psDeviceIndex, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, psLength=psLength, pciSlotTable=pciSlotTable, sysBootCount=sysBootCount, sysDeviceName=sysDeviceName, sysReleaseDate=sysReleaseDate, psDisplayName=psDisplayName, psVendorID=psVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootTime=sysBootTime, psBusIndex=psBusIndex)
