...
TimeTicks, Integer32, IpAddress, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, ModuleIdentity, Counter32, Unsigned32, iso, MibIdentifier, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "IpAddress", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "ModuleIdentity", "Counter32", "Unsigned32", "iso", "MibIdentifier", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvPort=snmpTrapSrvPort, advantech=advantech, psDescr=psDescr, psLength=psLength, pciConfigObj=pciConfigObj, psState=psState, psDeviceIndex=psDeviceIndex, atPciConfig=atPciConfig, snmpTrapSrvIP=snmpTrapSrvIP, psBaseAddress=psBaseAddress, sysDescr=sysDescr, atSystem=atSystem, sysReleaseDate=sysReleaseDate, pciSlotEntry=pciSlotEntry, sysFirstBootTime=sysFirstBootTime, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, psModulePorts=psModulePorts, sysBootCount=sysBootCount, sysModuleID=sysModuleID, snmpTrapSrvNumber=snmpTrapSrvNumber, psLocation=psLocation, psModuleType=psModuleType, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, PYSNMP_MODULE_ID=advantechCommonMIB, psIndex=psIndex, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootTime=sysBootTime, psSubsysDeviceID=psSubsysDeviceID, psSubsysVendorID=psSubsysVendorID, sysDeviceName=sysDeviceName, psNumber=psNumber, pciSlotTable=pciSlotTable, psBusIndex=psBusIndex, psManufacturer=psManufacturer, psIRQ=psIRQ, snmpTrapVersion=snmpTrapVersion, psDeviceID=psDeviceID, atMgmt=atMgmt, psClassCode=psClassCode, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName, snmpTrapSrvEntry=snmpTrapSrvEntry)
