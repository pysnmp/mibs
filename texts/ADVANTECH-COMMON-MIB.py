...
ObjectIdentity, ModuleIdentity, NotificationType, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, IpAddress, TimeTicks, Counter64, Unsigned32, enterprises, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "IpAddress", "TimeTicks", "Counter64", "Unsigned32", "enterprises", "Bits", "iso")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIP=snmpTrapSrvIP, psState=psState, sysBootTime=sysBootTime, psFunctionIndex=psFunctionIndex, pciConfigObj=pciConfigObj, psDescr=psDescr, psNumber=psNumber, psBusIndex=psBusIndex, atMgmt=atMgmt, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, psIRQ=psIRQ, sysDescr=sysDescr, psDeviceIndex=psDeviceIndex, atPciConfig=atPciConfig, psLength=psLength, sysFirstBootTime=sysFirstBootTime, sysDeviceName=sysDeviceName, sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate, advantechCommonMIB=advantechCommonMIB, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, sysBootCount=sysBootCount, sysModuleID=sysModuleID, psIndex=psIndex, psClassCode=psClassCode, psManufacturer=psManufacturer, snmpTrapSrvEntry=snmpTrapSrvEntry, psDisplayName=psDisplayName, psVendorID=psVendorID, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, psModuleType=psModuleType, advantech=advantech, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvPort=snmpTrapSrvPort, atSystem=atSystem, pciSlotTable=pciSlotTable)
