...
enterprises, Bits, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, Counter64, Counter32, iso, ObjectIdentity, Unsigned32, NotificationType, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "Counter64", "Counter32", "iso", "ObjectIdentity", "Unsigned32", "NotificationType", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciConfigObj=pciConfigObj, sysBootCount=sysBootCount, sysBootTime=sysBootTime, snmpTrapSrvTable=snmpTrapSrvTable, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, sysDeviceName=sysDeviceName, psDeviceIndex=psDeviceIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psState=psState, psIndex=psIndex, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysVendorID=psSubsysVendorID, psModuleType=psModuleType, atPciConfig=atPciConfig, psDisplayName=psDisplayName, atSystem=atSystem, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotEntry=pciSlotEntry, psVendorID=psVendorID, psDeviceID=psDeviceID, psClassCode=psClassCode, advantech=advantech, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapVersion=snmpTrapVersion, pciSlotTable=pciSlotTable, psBusIndex=psBusIndex, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, psFunctionIndex=psFunctionIndex, atMgmt=atMgmt, sysModuleID=sysModuleID, psIRQ=psIRQ, PYSNMP_MODULE_ID=advantechCommonMIB, psDescr=psDescr, psLocation=psLocation, sysFirstBootTime=sysFirstBootTime, psLength=psLength, sysImageVersion=sysImageVersion, sysDescr=sysDescr, psManufacturer=psManufacturer)
