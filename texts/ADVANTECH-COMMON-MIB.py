...
TimeTicks, Counter64, Unsigned32, enterprises, Bits, NotificationType, Gauge32, Integer32, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Unsigned32", "enterprises", "Bits", "NotificationType", "Gauge32", "Integer32", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootCount=sysBootCount, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate, psVendorID=psVendorID, atPciConfig=atPciConfig, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotTable=pciSlotTable, psLength=psLength, sysFirstBootTime=sysFirstBootTime, sysImageVersion=sysImageVersion, psNumber=psNumber, psSubsysVendorID=psSubsysVendorID, sysDeviceName=sysDeviceName, psLocation=psLocation, PYSNMP_MODULE_ID=advantechCommonMIB, sysDescr=sysDescr, sysBootTime=sysBootTime, psManufacturer=psManufacturer, snmpTrapSrvPort=snmpTrapSrvPort, psFunctionIndex=psFunctionIndex, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psDescr=psDescr, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, snmpTrapVersion=snmpTrapVersion, psModulePorts=psModulePorts, psIRQ=psIRQ, psState=psState, pciConfigObj=pciConfigObj, psModuleType=psModuleType, advantech=advantech, atSystem=atSystem, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIndex=psIndex, snmpTrapSrvTable=snmpTrapSrvTable, psClassCode=psClassCode, psDeviceID=psDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotEntry=pciSlotEntry, psDisplayName=psDisplayName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBaseAddress=psBaseAddress, sysModuleID=sysModuleID)
