...
Counter32, NotificationType, Gauge32, MibIdentifier, Integer32, enterprises, Bits, ObjectIdentity, ModuleIdentity, TimeTicks, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Gauge32", "MibIdentifier", "Integer32", "enterprises", "Bits", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, sysReleaseDate=sysReleaseDate, sysBootTime=sysBootTime, psModuleType=psModuleType, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime, psManufacturer=psManufacturer, snmpTrapSrvNumber=snmpTrapSrvNumber, atSystem=atSystem, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceIndex=psDeviceIndex, advantech=advantech, sysImageVersion=sysImageVersion, sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, psIndex=psIndex, psVendorID=psVendorID, sysModuleID=sysModuleID, psDeviceID=psDeviceID, advantechCommonMIB=advantechCommonMIB, psLocation=psLocation, psState=psState, sysDescr=sysDescr, sysDeviceName=sysDeviceName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotTable=pciSlotTable, psDescr=psDescr, atPciConfig=atPciConfig, psSubsysDeviceID=psSubsysDeviceID, psBaseAddress=psBaseAddress, pciSlotEntry=pciSlotEntry, psSubsysVendorID=psSubsysVendorID, psClassCode=psClassCode, snmpTrapSrvTable=snmpTrapSrvTable, psIRQ=psIRQ, psDisplayName=psDisplayName, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvObj=snmpTrapSrvObj, atMgmt=atMgmt, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvPort=snmpTrapSrvPort, psLength=psLength)
