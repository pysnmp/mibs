...
MibIdentifier, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, iso, NotificationType, Unsigned32, Bits, enterprises, ObjectIdentity, TimeTicks, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "iso", "NotificationType", "Unsigned32", "Bits", "enterprises", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantechCommonMIB=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, pciSlotEntry=pciSlotEntry, snmpTrapSrvPort=snmpTrapSrvPort, psClassCode=psClassCode, pciConfigObj=pciConfigObj, psLength=psLength, snmpTrapVersion=snmpTrapVersion, psVendorID=psVendorID, psLocation=psLocation, sysBootTime=sysBootTime, pciSlotTable=pciSlotTable, psModulePorts=psModulePorts, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysReleaseDate=sysReleaseDate, psManufacturer=psManufacturer, snmpTrapSrvIP=snmpTrapSrvIP, sysBootCount=sysBootCount, sysImageVersion=sysImageVersion, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, psDisplayName=psDisplayName, psBaseAddress=psBaseAddress, psIndex=psIndex, psNumber=psNumber, snmpTrapSrvTable=snmpTrapSrvTable, psState=psState, snmpTrapSrvObj=snmpTrapSrvObj, atSystem=atSystem, psBusIndex=psBusIndex, advantech=advantech, PYSNMP_MODULE_ID=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, sysDeviceName=sysDeviceName, sysModuleID=sysModuleID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIRQ=psIRQ, psDeviceID=psDeviceID, psFunctionIndex=psFunctionIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysDeviceID=psSubsysDeviceID, sysDescr=sysDescr, psDescr=psDescr)
