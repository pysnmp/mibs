...
Counter32, MibIdentifier, Integer32, Gauge32, ModuleIdentity, NotificationType, Counter64, ObjectIdentity, Unsigned32, IpAddress, TimeTicks, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Integer32", "Gauge32", "ModuleIdentity", "NotificationType", "Counter64", "ObjectIdentity", "Unsigned32", "IpAddress", "TimeTicks", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, advantechCommonMIB=advantechCommonMIB, psState=psState, snmpTrapSrvObj=snmpTrapSrvObj, sysBootCount=sysBootCount, psDescr=psDescr, sysBootTime=sysBootTime, snmpTrapVersion=snmpTrapVersion, psLength=psLength, sysImageVersion=sysImageVersion, psFunctionIndex=psFunctionIndex, sysDeviceName=sysDeviceName, psDeviceID=psDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIndex=psIndex, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvPort=snmpTrapSrvPort, atMgmt=atMgmt, psManufacturer=psManufacturer, sysFirstBootTime=sysFirstBootTime, sysDescr=sysDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, pciConfigObj=pciConfigObj, psLocation=psLocation, psNumber=psNumber, psBusIndex=psBusIndex, psDeviceIndex=psDeviceIndex, psModuleType=psModuleType, psBaseAddress=psBaseAddress, pciSlotEntry=pciSlotEntry, psModulePorts=psModulePorts, psSubsysVendorID=psSubsysVendorID, psDisplayName=psDisplayName, atPciConfig=atPciConfig, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, advantech=advantech, sysReleaseDate=sysReleaseDate, psVendorID=psVendorID, psClassCode=psClassCode, PYSNMP_MODULE_ID=advantechCommonMIB, psIRQ=psIRQ, psSubsysDeviceID=psSubsysDeviceID, atSystem=atSystem)
