...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, snmpTrapSrvNumber=snmpTrapSrvNumber, sysFirstBootTime=sysFirstBootTime, psDescr=psDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootCount=sysBootCount, psDeviceIndex=psDeviceIndex, psClassCode=psClassCode, snmpTrapSrvIndex=snmpTrapSrvIndex, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotEntry=pciSlotEntry, psManufacturer=psManufacturer, psLocation=psLocation, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvObj=snmpTrapSrvObj, psIRQ=psIRQ, atPciConfig=atPciConfig, sysBootTime=sysBootTime, sysImageVersion=sysImageVersion, psDisplayName=psDisplayName, psSubsysDeviceID=psSubsysDeviceID, psIndex=psIndex, psLength=psLength, pciSlotTable=pciSlotTable, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, psDeviceID=psDeviceID, sysDescr=sysDescr, psSubsysVendorID=psSubsysVendorID, psVendorID=psVendorID, sysDeviceName=sysDeviceName, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvIP=snmpTrapSrvIP, pciConfigObj=pciConfigObj, advantech=advantech, psFunctionIndex=psFunctionIndex, atMgmt=atMgmt, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, psNumber=psNumber, psState=psState, snmpTrapSrvTable=snmpTrapSrvTable, sysReleaseDate=sysReleaseDate)
