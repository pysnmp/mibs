...
Integer32, Counter32, TimeTicks, iso, enterprises, Counter64, ObjectIdentity, Unsigned32, MibIdentifier, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "TimeTicks", "iso", "enterprises", "Counter64", "ObjectIdentity", "Unsigned32", "MibIdentifier", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysDeviceID=psSubsysDeviceID, psDescr=psDescr, psDeviceID=psDeviceID, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, sysFirstBootTime=sysFirstBootTime, advantechCommonMIB=advantechCommonMIB, sysDescr=sysDescr, psModulePorts=psModulePorts, psState=psState, psIndex=psIndex, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvPort=snmpTrapSrvPort, psLength=psLength, atPciConfig=atPciConfig, psVendorID=psVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atMgmt=atMgmt, pciConfigObj=pciConfigObj, psSubsysVendorID=psSubsysVendorID, sysReleaseDate=sysReleaseDate, psModuleType=psModuleType, pciSlotEntry=pciSlotEntry, psClassCode=psClassCode, PYSNMP_MODULE_ID=advantechCommonMIB, sysModuleID=sysModuleID, psIRQ=psIRQ, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psDisplayName=psDisplayName, psLocation=psLocation, sysBootTime=sysBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, psBusIndex=psBusIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, psBaseAddress=psBaseAddress, sysBootCount=sysBootCount, psFunctionIndex=psFunctionIndex, psNumber=psNumber)
