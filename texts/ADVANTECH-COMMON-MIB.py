...
# Produced by pysmi-1.1.8 at Sat Jan 15 04:10:24 2022
...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, Counter32, NotificationType, IpAddress, ModuleIdentity, enterprises, Integer32, TimeTicks, Counter64, Bits, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "Counter32", "NotificationType", "IpAddress", "ModuleIdentity", "enterprises", "Integer32", "TimeTicks", "Counter64", "Bits", "Gauge32", "iso")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psNumber=psNumber, psSubsysVendorID=psSubsysVendorID, psDisplayName=psDisplayName, pciSlotTable=pciSlotTable, psManufacturer=psManufacturer, sysDescr=sysDescr, psClassCode=psClassCode, snmpTrapSrvPort=snmpTrapSrvPort, psDeviceID=psDeviceID, psModulePorts=psModulePorts, sysImageVersion=sysImageVersion, advantech=advantech, atPciConfig=atPciConfig, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotEntry=pciSlotEntry, psDeviceIndex=psDeviceIndex, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, psDescr=psDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, sysReleaseDate=sysReleaseDate, psBusIndex=psBusIndex, snmpTrapSrvIP=snmpTrapSrvIP, psLength=psLength, sysBootCount=sysBootCount, psVendorID=psVendorID, pciConfigObj=pciConfigObj, psState=psState, psFunctionIndex=psFunctionIndex, atMgmt=atMgmt, sysBootTime=sysBootTime, psIRQ=psIRQ, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, atSystem=atSystem, sysFirstBootTime=sysFirstBootTime, psIndex=psIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, advantechCommonMIB=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, psLocation=psLocation, psBaseAddress=psBaseAddress, snmpTrapSrvTable=snmpTrapSrvTable, sysModuleID=sysModuleID, psModuleType=psModuleType)
