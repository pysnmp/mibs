...
Unsigned32, Counter32, Bits, enterprises, MibIdentifier, ObjectIdentity, iso, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, TimeTicks, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "Bits", "enterprises", "MibIdentifier", "ObjectIdentity", "iso", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "TimeTicks", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvEntry=snmpTrapSrvEntry, sysImageVersion=sysImageVersion, atPciConfig=atPciConfig, psDeviceID=psDeviceID, psBaseAddress=psBaseAddress, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceIndex=psDeviceIndex, psIRQ=psIRQ, psLocation=psLocation, psManufacturer=psManufacturer, psClassCode=psClassCode, psVendorID=psVendorID, sysBootCount=sysBootCount, atSystem=atSystem, sysDeviceName=sysDeviceName, sysBootTime=sysBootTime, pciConfigObj=pciConfigObj, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvNumber=snmpTrapSrvNumber, psFunctionIndex=psFunctionIndex, advantech=advantech, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psNumber=psNumber, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, psLength=psLength, sysDescr=sysDescr, snmpTrapSrvPort=snmpTrapSrvPort, psState=psState, advantechCommonMIB=advantechCommonMIB, psBusIndex=psBusIndex, psIndex=psIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, atMgmt=atMgmt, psDisplayName=psDisplayName, psModuleType=psModuleType, psDescr=psDescr, sysReleaseDate=sysReleaseDate, sysFirstBootTime=sysFirstBootTime, sysModuleID=sysModuleID)
