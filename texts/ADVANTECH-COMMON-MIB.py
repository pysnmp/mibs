...
Unsigned32, IpAddress, TimeTicks, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, NotificationType, Counter32, ObjectIdentity, ModuleIdentity, Counter64, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "TimeTicks", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "NotificationType", "Counter32", "ObjectIdentity", "ModuleIdentity", "Counter64", "iso", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvEntry=snmpTrapSrvEntry, psState=psState, psDisplayName=psDisplayName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, psDescr=psDescr, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, psModulePorts=psModulePorts, snmpTrapVersion=snmpTrapVersion, atSystem=atSystem, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, advantech=advantech, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, psIRQ=psIRQ, sysDescr=sysDescr, PYSNMP_MODULE_ID=advantechCommonMIB, psIndex=psIndex, psModuleType=psModuleType, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psNumber=psNumber, sysBootCount=sysBootCount, psVendorID=psVendorID, psDeviceID=psDeviceID, atMgmt=atMgmt, snmpTrapSrvTable=snmpTrapSrvTable, psBusIndex=psBusIndex, psSubsysVendorID=psSubsysVendorID, psDeviceIndex=psDeviceIndex, psLength=psLength, sysFirstBootTime=sysFirstBootTime, sysBootTime=sysBootTime, atPciConfig=atPciConfig, pciSlotTable=pciSlotTable, sysModuleID=sysModuleID, pciConfigObj=pciConfigObj, psClassCode=psClassCode, psSubsysDeviceID=psSubsysDeviceID, psFunctionIndex=psFunctionIndex, sysDeviceName=sysDeviceName, sysImageVersion=sysImageVersion, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvObj=snmpTrapSrvObj, sysReleaseDate=sysReleaseDate)
