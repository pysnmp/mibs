...
Gauge32, Counter64, ModuleIdentity, Counter32, Unsigned32, Bits, TimeTicks, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, ObjectIdentity, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "ModuleIdentity", "Counter32", "Unsigned32", "Bits", "TimeTicks", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "ObjectIdentity", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDeviceID=psDeviceID, advantech=advantech, psModuleType=psModuleType, PYSNMP_MODULE_ID=advantechCommonMIB, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, psBaseAddress=psBaseAddress, snmpTrapSrvNumber=snmpTrapSrvNumber, atMgmt=atMgmt, sysDescr=sysDescr, psSubsysVendorID=psSubsysVendorID, sysImageVersion=sysImageVersion, sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIRQ=psIRQ, pciSlotEntry=pciSlotEntry, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIndex=snmpTrapSrvIndex, psIndex=psIndex, snmpTrapSrvIP=snmpTrapSrvIP, atPciConfig=atPciConfig, psClassCode=psClassCode, sysDeviceName=sysDeviceName, psDeviceIndex=psDeviceIndex, psManufacturer=psManufacturer, psNumber=psNumber, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysModuleID=sysModuleID, psState=psState, snmpTrapSrvEntry=snmpTrapSrvEntry, pciConfigObj=pciConfigObj, psLength=psLength, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate, advantechCommonMIB=advantechCommonMIB, psVendorID=psVendorID, snmpTrapSrvPort=snmpTrapSrvPort, psDescr=psDescr, psLocation=psLocation, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime, sysBootCount=sysBootCount, snmpTrapVersion=snmpTrapVersion, psFunctionIndex=psFunctionIndex, atSystem=atSystem, psDisplayName=psDisplayName, pciSlotTable=pciSlotTable)
