...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Counter32, TimeTicks, Gauge32, Integer32, IpAddress, NotificationType, Counter64, ModuleIdentity, MibIdentifier, enterprises, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Counter32", "TimeTicks", "Gauge32", "Integer32", "IpAddress", "NotificationType", "Counter64", "ModuleIdentity", "MibIdentifier", "enterprises", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysVendorID=psSubsysVendorID, psManufacturer=psManufacturer, psBaseAddress=psBaseAddress, atMgmt=atMgmt, snmpTrapSrvObj=snmpTrapSrvObj, sysFirstBootTime=sysFirstBootTime, advantechCommonMIB=advantechCommonMIB, psDescr=psDescr, sysDeviceName=sysDeviceName, pciSlotTable=pciSlotTable, psDeviceIndex=psDeviceIndex, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDescr=sysDescr, PYSNMP_MODULE_ID=advantechCommonMIB, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, psModulePorts=psModulePorts, psModuleType=psModuleType, psDeviceID=psDeviceID, psNumber=psNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvTable=snmpTrapSrvTable, atSystem=atSystem, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, pciConfigObj=pciConfigObj, psIndex=psIndex, psClassCode=psClassCode, psLocation=psLocation, sysImageVersion=sysImageVersion, psState=psState, psLength=psLength, snmpTrapSrvEntry=snmpTrapSrvEntry, psVendorID=psVendorID, psDisplayName=psDisplayName, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotEntry=pciSlotEntry, sysModuleID=sysModuleID, sysReleaseDate=sysReleaseDate, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, sysBootTime=sysBootTime, psIRQ=psIRQ, sysBootCount=sysBootCount)
