...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:12:48 2022
...
ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Gauge32, Integer32, iso, TimeTicks, NotificationType, ObjectIdentity, MibIdentifier, enterprises, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Gauge32", "Integer32", "iso", "TimeTicks", "NotificationType", "ObjectIdentity", "MibIdentifier", "enterprises", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psManufacturer=psManufacturer, sysDeviceName=sysDeviceName, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantechCommonMIB=advantechCommonMIB, atPciConfig=atPciConfig, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModuleType=psModuleType, sysBootTime=sysBootTime, psFunctionIndex=psFunctionIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvPort=snmpTrapSrvPort, psClassCode=psClassCode, psState=psState, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, psDisplayName=psDisplayName, psIRQ=psIRQ, psModulePorts=psModulePorts, psDeviceIndex=psDeviceIndex, atSystem=atSystem, psNumber=psNumber, atMgmt=atMgmt, pciSlotTable=pciSlotTable, sysDescr=sysDescr, psSubsysDeviceID=psSubsysDeviceID, psIndex=psIndex, psLength=psLength, sysReleaseDate=sysReleaseDate, psLocation=psLocation, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotEntry=pciSlotEntry, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, psSubsysVendorID=psSubsysVendorID, psDeviceID=psDeviceID, psVendorID=psVendorID, advantech=advantech, pciConfigObj=pciConfigObj, sysBootCount=sysBootCount, snmpTrapVersion=snmpTrapVersion, psBaseAddress=psBaseAddress, sysModuleID=sysModuleID, sysImageVersion=sysImageVersion, psDescr=psDescr)
