...
NotificationType, MibIdentifier, IpAddress, ObjectIdentity, Counter64, TimeTicks, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, enterprises, Unsigned32, Integer32, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "IpAddress", "ObjectIdentity", "Counter64", "TimeTicks", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "enterprises", "Unsigned32", "Integer32", "Counter32", "iso")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysReleaseDate=sysReleaseDate, sysDeviceName=sysDeviceName, psDisplayName=psDisplayName, psFunctionIndex=psFunctionIndex, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootCount=sysBootCount, advantechCommonMIB=advantechCommonMIB, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, psDescr=psDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, psIRQ=psIRQ, advantech=advantech, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvTable=snmpTrapSrvTable, sysDescr=sysDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysModuleID=sysModuleID, psModulePorts=psModulePorts, psBusIndex=psBusIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psManufacturer=psManufacturer, psState=psState, psBaseAddress=psBaseAddress, snmpTrapVersion=snmpTrapVersion, psLocation=psLocation, pciSlotTable=pciSlotTable, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength, pciSlotEntry=pciSlotEntry, snmpTrapSrvObj=snmpTrapSrvObj, psModuleType=psModuleType, atPciConfig=atPciConfig, snmpTrapSrvPort=snmpTrapSrvPort, atSystem=atSystem, sysBootTime=sysBootTime, atMgmt=atMgmt, pciConfigObj=pciConfigObj, psDeviceID=psDeviceID, psVendorID=psVendorID, psIndex=psIndex)
