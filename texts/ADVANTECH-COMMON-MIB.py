...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, NotificationType, ModuleIdentity, Counter32, ObjectIdentity, enterprises, IpAddress, TimeTicks, Gauge32, Unsigned32, Counter64, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "NotificationType", "ModuleIdentity", "Counter32", "ObjectIdentity", "enterprises", "IpAddress", "TimeTicks", "Gauge32", "Unsigned32", "Counter64", "Bits", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psLength=psLength, snmpTrapSrvNumber=snmpTrapSrvNumber, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, psFunctionIndex=psFunctionIndex, psSubsysVendorID=psSubsysVendorID, sysDeviceName=sysDeviceName, sysBootTime=sysBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atSystem=atSystem, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, pciConfigObj=pciConfigObj, advantech=advantech, pciSlotEntry=pciSlotEntry, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, atMgmt=atMgmt, sysBootCount=sysBootCount, sysImageVersion=sysImageVersion, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysFirstBootTime=sysFirstBootTime, psBaseAddress=psBaseAddress, sysReleaseDate=sysReleaseDate, pciSlotTable=pciSlotTable, psIndex=psIndex, psLocation=psLocation, psIRQ=psIRQ, psVendorID=psVendorID, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvObj=snmpTrapSrvObj, psClassCode=psClassCode, psDeviceID=psDeviceID, psModulePorts=psModulePorts, psManufacturer=psManufacturer, psBusIndex=psBusIndex, atPciConfig=atPciConfig, psDisplayName=psDisplayName, psDescr=psDescr, psDeviceIndex=psDeviceIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, psState=psState, snmpTrapSrvIP=snmpTrapSrvIP)
