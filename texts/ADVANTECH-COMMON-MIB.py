...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, iso, Bits, Counter64, enterprises, TimeTicks, Gauge32, ObjectIdentity, Unsigned32, ModuleIdentity, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "iso", "Bits", "Counter64", "enterprises", "TimeTicks", "Gauge32", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psClassCode=psClassCode, psBaseAddress=psBaseAddress, sysModuleID=sysModuleID, sysDescr=sysDescr, psDeviceIndex=psDeviceIndex, psFunctionIndex=psFunctionIndex, pciConfigObj=pciConfigObj, sysReleaseDate=sysReleaseDate, psDeviceID=psDeviceID, psNumber=psNumber, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, advantech=advantech, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, psLocation=psLocation, snmpTrapVersion=snmpTrapVersion, psIRQ=psIRQ, psVendorID=psVendorID, atSystem=atSystem, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psManufacturer=psManufacturer, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIP=snmpTrapSrvIP, psDisplayName=psDisplayName, sysBootCount=sysBootCount, psSubsysVendorID=psSubsysVendorID, psModuleType=psModuleType, sysBootTime=sysBootTime, atPciConfig=atPciConfig, snmpTrapSrvIndex=snmpTrapSrvIndex, sysImageVersion=sysImageVersion, psBusIndex=psBusIndex, atMgmt=atMgmt, psDescr=psDescr, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, psIndex=psIndex, psModulePorts=psModulePorts, sysDeviceName=sysDeviceName, psState=psState, psSubsysDeviceID=psSubsysDeviceID, psLength=psLength, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotTable=pciSlotTable)
