...
Counter64, ObjectIdentity, MibIdentifier, Bits, IpAddress, ModuleIdentity, Counter32, enterprises, Gauge32, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "MibIdentifier", "Bits", "IpAddress", "ModuleIdentity", "Counter32", "enterprises", "Gauge32", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIP=snmpTrapSrvIP, sysReleaseDate=sysReleaseDate, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotTable=pciSlotTable, atSystem=atSystem, advantech=advantech, snmpTrapSrvPort=snmpTrapSrvPort, pciConfigObj=pciConfigObj, psState=psState, psBaseAddress=psBaseAddress, psDeviceID=psDeviceID, psLength=psLength, psModulePorts=psModulePorts, psDisplayName=psDisplayName, atPciConfig=atPciConfig, sysModuleID=sysModuleID, psManufacturer=psManufacturer, psDescr=psDescr, psNumber=psNumber, snmpTrapSrvTable=snmpTrapSrvTable, sysBootCount=sysBootCount, advantechCommonMIB=advantechCommonMIB, pciSlotEntry=pciSlotEntry, psIRQ=psIRQ, sysDeviceName=sysDeviceName, psFunctionIndex=psFunctionIndex, psBusIndex=psBusIndex, sysImageVersion=sysImageVersion, psIndex=psIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceIndex=psDeviceIndex, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, psVendorID=psVendorID, sysDescr=sysDescr, psLocation=psLocation, snmpTrapSrvIndex=snmpTrapSrvIndex, psSubsysDeviceID=psSubsysDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, atMgmt=atMgmt, psSubsysVendorID=psSubsysVendorID, sysFirstBootTime=sysFirstBootTime, sysBootTime=sysBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, psModuleType=psModuleType)
