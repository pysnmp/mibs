...
ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, MibIdentifier, Gauge32, NotificationType, Counter64, Unsigned32, Bits, Counter32, IpAddress, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "MibIdentifier", "Gauge32", "NotificationType", "Counter64", "Unsigned32", "Bits", "Counter32", "IpAddress", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBusIndex=psBusIndex, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapVersion=snmpTrapVersion, psSubsysDeviceID=psSubsysDeviceID, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, psLength=psLength, psDescr=psDescr, psDisplayName=psDisplayName, atPciConfig=atPciConfig, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, pciSlotEntry=pciSlotEntry, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, sysReleaseDate=sysReleaseDate, sysBootTime=sysBootTime, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, atSystem=atSystem, psManufacturer=psManufacturer, snmpTrapSrvEntry=snmpTrapSrvEntry, psState=psState, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootCount=sysBootCount, psBaseAddress=psBaseAddress, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, pciSlotTable=pciSlotTable, psIRQ=psIRQ, atMgmt=atMgmt, advantech=advantech, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceID=psDeviceID, psModuleType=psModuleType, snmpTrapSrvObj=snmpTrapSrvObj, psClassCode=psClassCode, psLocation=psLocation, sysFirstBootTime=sysFirstBootTime, pciConfigObj=pciConfigObj, sysDescr=sysDescr)
