...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, psDeviceIndex=psDeviceIndex, psDescr=psDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciConfigObj=pciConfigObj, sysBootTime=sysBootTime, sysImageVersion=sysImageVersion, sysModuleID=sysModuleID, snmpTrapSrvNumber=snmpTrapSrvNumber, advantech=advantech, psDisplayName=psDisplayName, psNumber=psNumber, advantechCommonMIB=advantechCommonMIB, psManufacturer=psManufacturer, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapVersion=snmpTrapVersion, sysDeviceName=sysDeviceName, psIndex=psIndex, sysReleaseDate=sysReleaseDate, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, psModuleType=psModuleType, psIRQ=psIRQ, atSystem=atSystem, PYSNMP_MODULE_ID=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, psState=psState, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, psBaseAddress=psBaseAddress, atMgmt=atMgmt, psLocation=psLocation, psModulePorts=psModulePorts, atPciConfig=atPciConfig, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceID=psDeviceID, pciSlotEntry=pciSlotEntry, pciSlotTable=pciSlotTable, psLength=psLength, sysBootCount=sysBootCount, psClassCode=psClassCode)
