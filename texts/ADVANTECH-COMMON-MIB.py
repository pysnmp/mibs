...
# Produced by pysmi-1.1.3 at Tue Dec  7 17:28:47 2021
...
TimeTicks, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, NotificationType, Counter64, Counter32, MibIdentifier, IpAddress, Unsigned32, Gauge32, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "NotificationType", "Counter64", "Counter32", "MibIdentifier", "IpAddress", "Unsigned32", "Gauge32", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, sysBootTime=sysBootTime, psModuleType=psModuleType, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, psDeviceID=psDeviceID, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, snmpTrapVersion=snmpTrapVersion, psState=psState, sysDescr=sysDescr, atMgmt=atMgmt, sysImageVersion=sysImageVersion, sysBootCount=sysBootCount, atPciConfig=atPciConfig, pciConfigObj=pciConfigObj, pciSlotEntry=pciSlotEntry, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, psNumber=psNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBusIndex=psBusIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, psFunctionIndex=psFunctionIndex, psLocation=psLocation, atSystem=atSystem, psVendorID=psVendorID, advantechCommonMIB=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, sysDeviceName=sysDeviceName, psIndex=psIndex, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, psLength=psLength, sysModuleID=sysModuleID, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, psDescr=psDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBaseAddress=psBaseAddress, snmpTrapSrvObj=snmpTrapSrvObj, psIRQ=psIRQ, psClassCode=psClassCode, sysReleaseDate=sysReleaseDate)
