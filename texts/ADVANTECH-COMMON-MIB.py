...
Counter64, Gauge32, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Unsigned32, ObjectIdentity, iso, ModuleIdentity, IpAddress, Counter32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Unsigned32", "ObjectIdentity", "iso", "ModuleIdentity", "IpAddress", "Counter32", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBaseAddress=psBaseAddress, sysDescr=sysDescr, advantech=advantech, psNumber=psNumber, sysFirstBootTime=sysFirstBootTime, psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvNumber=snmpTrapSrvNumber, psIndex=psIndex, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, psManufacturer=psManufacturer, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, psIRQ=psIRQ, sysDeviceName=sysDeviceName, sysImageVersion=sysImageVersion, snmpTrapSrvTable=snmpTrapSrvTable, psModulePorts=psModulePorts, pciConfigObj=pciConfigObj, sysBootCount=sysBootCount, psDeviceID=psDeviceID, psClassCode=psClassCode, atSystem=atSystem, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotTable=pciSlotTable, psVendorID=psVendorID, psModuleType=psModuleType, snmpTrapSrvEntry=snmpTrapSrvEntry, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysModuleID=sysModuleID, atPciConfig=atPciConfig, psBusIndex=psBusIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapVersion=snmpTrapVersion, psLength=psLength, atMgmt=atMgmt, sysBootTime=sysBootTime, psDescr=psDescr, sysReleaseDate=sysReleaseDate, psFunctionIndex=psFunctionIndex, psDeviceIndex=psDeviceIndex, psState=psState, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB)
