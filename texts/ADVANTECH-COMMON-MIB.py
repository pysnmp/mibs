...
TimeTicks, Counter32, NotificationType, MibIdentifier, Counter64, ModuleIdentity, iso, Bits, ObjectIdentity, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "NotificationType", "MibIdentifier", "Counter64", "ModuleIdentity", "iso", "Bits", "ObjectIdentity", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psVendorID=psVendorID, atSystem=atSystem, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIP=snmpTrapSrvIP, psClassCode=psClassCode, advantechCommonMIB=advantechCommonMIB, psModulePorts=psModulePorts, psIndex=psIndex, psDescr=psDescr, psManufacturer=psManufacturer, sysImageVersion=sysImageVersion, advantech=advantech, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvPort=snmpTrapSrvPort, pciConfigObj=pciConfigObj, pciSlotEntry=pciSlotEntry, psModuleType=psModuleType, psLocation=psLocation, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotTable=pciSlotTable, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, atPciConfig=atPciConfig, PYSNMP_MODULE_ID=advantechCommonMIB, psState=psState, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootTime=sysBootTime, sysDeviceName=sysDeviceName, sysModuleID=sysModuleID, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime, psNumber=psNumber, psBaseAddress=psBaseAddress, sysBootCount=sysBootCount, sysReleaseDate=sysReleaseDate, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, psIRQ=psIRQ, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceIndex=psDeviceIndex, psDisplayName=psDisplayName, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLength=psLength)
