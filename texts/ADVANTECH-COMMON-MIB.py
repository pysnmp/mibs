...
IpAddress, Counter64, ModuleIdentity, NotificationType, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Integer32, enterprises, Bits, TimeTicks, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "ModuleIdentity", "NotificationType", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Integer32", "enterprises", "Bits", "TimeTicks", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psVendorID=psVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceID=psDeviceID, psManufacturer=psManufacturer, pciConfigObj=pciConfigObj, snmpTrapSrvIP=snmpTrapSrvIP, psDescr=psDescr, snmpTrapVersion=snmpTrapVersion, sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt, sysReleaseDate=sysReleaseDate, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvObj=snmpTrapSrvObj, advantech=advantech, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, pciSlotEntry=pciSlotEntry, sysBootTime=sysBootTime, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, psBaseAddress=psBaseAddress, psIRQ=psIRQ, sysImageVersion=sysImageVersion, atSystem=atSystem, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, snmpTrapSrvPort=snmpTrapSrvPort, psModulePorts=psModulePorts, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, sysModuleID=sysModuleID, psIndex=psIndex, snmpTrapSrvTable=snmpTrapSrvTable, psNumber=psNumber, advantechCommonMIB=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceIndex=psDeviceIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysDeviceID=psSubsysDeviceID, psLength=psLength, psClassCode=psClassCode, psState=psState, psBusIndex=psBusIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psLocation=psLocation, sysBootCount=sysBootCount)
