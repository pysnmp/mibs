...
# Produced by pysmi-1.1.3 at Sun Nov 28 16:29:41 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, MibIdentifier, enterprises, ModuleIdentity, Integer32, NotificationType, ObjectIdentity, iso, Gauge32, IpAddress, TimeTicks, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "MibIdentifier", "enterprises", "ModuleIdentity", "Integer32", "NotificationType", "ObjectIdentity", "iso", "Gauge32", "IpAddress", "TimeTicks", "Counter32", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBusIndex=psBusIndex, psState=psState, pciSlotEntry=pciSlotEntry, sysDeviceName=sysDeviceName, psLocation=psLocation, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysVendorID=psSubsysVendorID, psManufacturer=psManufacturer, psIRQ=psIRQ, psModuleType=psModuleType, atSystem=atSystem, pciSlotTable=pciSlotTable, atPciConfig=atPciConfig, psModulePorts=psModulePorts, sysBootTime=sysBootTime, psDescr=psDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootCount=sysBootCount, psIndex=psIndex, advantech=advantech, snmpTrapSrvPort=snmpTrapSrvPort, sysDescr=sysDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength, pciConfigObj=pciConfigObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psFunctionIndex=psFunctionIndex, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, psDeviceID=psDeviceID, psNumber=psNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, psSubsysDeviceID=psSubsysDeviceID, psDisplayName=psDisplayName, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIP=snmpTrapSrvIP, psClassCode=psClassCode, advantechCommonMIB=advantechCommonMIB, sysModuleID=sysModuleID, snmpTrapSrvTable=snmpTrapSrvTable, sysFirstBootTime=sysFirstBootTime, psVendorID=psVendorID, psBaseAddress=psBaseAddress, atMgmt=atMgmt, sysReleaseDate=sysReleaseDate, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion)
