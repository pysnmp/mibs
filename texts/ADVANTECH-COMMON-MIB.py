...
iso, Counter64, ObjectIdentity, MibIdentifier, ModuleIdentity, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Gauge32, Counter32, TimeTicks, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Gauge32", "Counter32", "TimeTicks", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModuleType=psModuleType, snmpTrapSrvIndex=snmpTrapSrvIndex, psLength=psLength, sysBootCount=sysBootCount, snmpTrapSrvTable=snmpTrapSrvTable, advantechCommonMIB=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, psClassCode=psClassCode, psBaseAddress=psBaseAddress, atSystem=atSystem, psBusIndex=psBusIndex, psIRQ=psIRQ, psVendorID=psVendorID, psDescr=psDescr, sysDescr=sysDescr, psSubsysDeviceID=psSubsysDeviceID, psState=psState, psFunctionIndex=psFunctionIndex, snmpTrapSrvObj=snmpTrapSrvObj, sysModuleID=sysModuleID, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotTable=pciSlotTable, snmpTrapVersion=snmpTrapVersion, psLocation=psLocation, sysReleaseDate=sysReleaseDate, sysBootTime=sysBootTime, atPciConfig=atPciConfig, advantech=advantech, psSubsysVendorID=psSubsysVendorID, pciSlotEntry=pciSlotEntry, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, psNumber=psNumber, psManufacturer=psManufacturer, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvEntry=snmpTrapSrvEntry, pciConfigObj=pciConfigObj, psIndex=psIndex, sysImageVersion=sysImageVersion, atMgmt=atMgmt, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDeviceName=sysDeviceName, psDeviceID=psDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, PYSNMP_MODULE_ID=advantechCommonMIB, psDisplayName=psDisplayName, psModulePorts=psModulePorts)
