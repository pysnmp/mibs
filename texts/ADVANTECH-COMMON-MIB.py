...
Unsigned32, IpAddress, iso, Gauge32, MibIdentifier, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Integer32, ObjectIdentity, enterprises, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "iso", "Gauge32", "MibIdentifier", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Integer32", "ObjectIdentity", "enterprises", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, psDeviceID=psDeviceID, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, advantechCommonMIB=advantechCommonMIB, psDisplayName=psDisplayName, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIP=snmpTrapSrvIP, atSystem=atSystem, psDeviceIndex=psDeviceIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psClassCode=psClassCode, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, psManufacturer=psManufacturer, psDescr=psDescr, snmpTrapSrvObj=snmpTrapSrvObj, atMgmt=atMgmt, sysBootCount=sysBootCount, psModulePorts=psModulePorts, psIRQ=psIRQ, sysReleaseDate=sysReleaseDate, advantech=advantech, psSubsysDeviceID=psSubsysDeviceID, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, psFunctionIndex=psFunctionIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, psState=psState, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, psModuleType=psModuleType, psLength=psLength, pciConfigObj=pciConfigObj, sysModuleID=sysModuleID, atPciConfig=atPciConfig, psLocation=psLocation, sysImageVersion=sysImageVersion, psVendorID=psVendorID, sysDeviceName=sysDeviceName, sysFirstBootTime=sysFirstBootTime, psBusIndex=psBusIndex, sysBootTime=sysBootTime)
