...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, MibIdentifier, Counter32, Gauge32, Unsigned32, iso, ModuleIdentity, Counter64, IpAddress, ObjectIdentity, Integer32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "MibIdentifier", "Counter32", "Gauge32", "Unsigned32", "iso", "ModuleIdentity", "Counter64", "IpAddress", "ObjectIdentity", "Integer32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotEntry=pciSlotEntry, sysModuleID=sysModuleID, sysBootTime=sysBootTime, psClassCode=psClassCode, snmpTrapSrvIndex=snmpTrapSrvIndex, psManufacturer=psManufacturer, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, psNumber=psNumber, psDescr=psDescr, snmpTrapSrvPort=snmpTrapSrvPort, PYSNMP_MODULE_ID=advantechCommonMIB, atSystem=atSystem, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceID=psDeviceID, psModuleType=psModuleType, snmpTrapVersion=snmpTrapVersion, pciSlotTable=pciSlotTable, sysImageVersion=sysImageVersion, snmpTrapSrvTable=snmpTrapSrvTable, psState=psState, snmpTrapSrvIP=snmpTrapSrvIP, psModulePorts=psModulePorts, psIRQ=psIRQ, sysFirstBootTime=sysFirstBootTime, psVendorID=psVendorID, psIndex=psIndex, atMgmt=atMgmt, sysReleaseDate=sysReleaseDate, sysDescr=sysDescr, pciConfigObj=pciConfigObj, psDeviceIndex=psDeviceIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDisplayName=psDisplayName, psBaseAddress=psBaseAddress, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLocation=psLocation, psFunctionIndex=psFunctionIndex, psLength=psLength, psSubsysVendorID=psSubsysVendorID, advantechCommonMIB=advantechCommonMIB, advantech=advantech, psSubsysDeviceID=psSubsysDeviceID, sysBootCount=sysBootCount, psBusIndex=psBusIndex)
