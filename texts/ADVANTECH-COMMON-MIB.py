...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Integer32, TimeTicks, ModuleIdentity, MibIdentifier, Counter64, enterprises, NotificationType, iso, Bits, IpAddress, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Integer32", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Counter64", "enterprises", "NotificationType", "iso", "Bits", "IpAddress", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIRQ=psIRQ, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, psLocation=psLocation, psDeviceIndex=psDeviceIndex, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLength=psLength, psIndex=psIndex, sysReleaseDate=sysReleaseDate, snmpTrapSrvPort=snmpTrapSrvPort, psVendorID=psVendorID, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootTime=sysBootTime, psModulePorts=psModulePorts, PYSNMP_MODULE_ID=advantechCommonMIB, psClassCode=psClassCode, advantech=advantech, pciConfigObj=pciConfigObj, pciSlotTable=pciSlotTable, sysBootCount=sysBootCount, atPciConfig=atPciConfig, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModuleType=psModuleType, atMgmt=atMgmt, sysFirstBootTime=sysFirstBootTime, sysModuleID=sysModuleID, psSubsysVendorID=psSubsysVendorID, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, atSystem=atSystem, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceID=psDeviceID, psBaseAddress=psBaseAddress, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, psState=psState, advantechCommonMIB=advantechCommonMIB, psDisplayName=psDisplayName, sysDeviceName=sysDeviceName, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, psManufacturer=psManufacturer, psDescr=psDescr, sysImageVersion=sysImageVersion)
