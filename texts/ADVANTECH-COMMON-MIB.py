...
iso, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, ObjectIdentity, enterprises, MibIdentifier, Integer32, Bits, Unsigned32, NotificationType, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "ObjectIdentity", "enterprises", "MibIdentifier", "Integer32", "Bits", "Unsigned32", "NotificationType", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, psClassCode=psClassCode, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceIndex=psDeviceIndex, snmpTrapVersion=snmpTrapVersion, psModuleType=psModuleType, atSystem=atSystem, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, psModulePorts=psModulePorts, psIndex=psIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psVendorID=psVendorID, psDeviceID=psDeviceID, snmpTrapSrvIP=snmpTrapSrvIP, psState=psState, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvPort=snmpTrapSrvPort, psNumber=psNumber, snmpTrapSrvTable=snmpTrapSrvTable, psBusIndex=psBusIndex, atMgmt=atMgmt, sysBootCount=sysBootCount, sysDescr=sysDescr, PYSNMP_MODULE_ID=advantechCommonMIB, psDescr=psDescr, psLocation=psLocation, psBaseAddress=psBaseAddress, psLength=psLength, psIRQ=psIRQ, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantech=advantech, psFunctionIndex=psFunctionIndex, sysDeviceName=sysDeviceName, pciConfigObj=pciConfigObj, sysImageVersion=sysImageVersion, psDisplayName=psDisplayName, sysFirstBootTime=sysFirstBootTime, psManufacturer=psManufacturer, sysBootTime=sysBootTime, atPciConfig=atPciConfig, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate)
