...
iso, ModuleIdentity, MibIdentifier, Integer32, Counter64, enterprises, ObjectIdentity, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Gauge32, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "MibIdentifier", "Integer32", "Counter64", "enterprises", "ObjectIdentity", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Gauge32", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysFirstBootTime=sysFirstBootTime, psDeviceID=psDeviceID, snmpTrapVersion=snmpTrapVersion, sysDescr=sysDescr, sysReleaseDate=sysReleaseDate, psNumber=psNumber, advantechCommonMIB=advantechCommonMIB, sysModuleID=sysModuleID, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, pciSlotTable=pciSlotTable, snmpTrapSrvIndex=snmpTrapSrvIndex, psDisplayName=psDisplayName, psFunctionIndex=psFunctionIndex, psBusIndex=psBusIndex, psLength=psLength, psVendorID=psVendorID, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, psDeviceIndex=psDeviceIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLocation=psLocation, pciSlotEntry=pciSlotEntry, sysBootTime=sysBootTime, atPciConfig=atPciConfig, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, psManufacturer=psManufacturer, psBaseAddress=psBaseAddress, snmpTrapSrvPort=snmpTrapSrvPort, psModuleType=psModuleType, psModulePorts=psModulePorts, psIndex=psIndex, psDescr=psDescr, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, sysBootCount=sysBootCount, snmpTrapSrvNumber=snmpTrapSrvNumber, psIRQ=psIRQ, pciConfigObj=pciConfigObj, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, psState=psState, psClassCode=psClassCode, advantech=advantech, sysImageVersion=sysImageVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity)
