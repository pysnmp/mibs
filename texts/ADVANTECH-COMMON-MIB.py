...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvPort=snmpTrapSrvPort, psIRQ=psIRQ, psSubsysDeviceID=psSubsysDeviceID, psLocation=psLocation, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysModuleID=sysModuleID, snmpTrapSrvEntry=snmpTrapSrvEntry, psBusIndex=psBusIndex, psNumber=psNumber, atSystem=atSystem, psVendorID=psVendorID, psFunctionIndex=psFunctionIndex, sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciConfigObj=pciConfigObj, psModulePorts=psModulePorts, psState=psState, sysImageVersion=sysImageVersion, psIndex=psIndex, psModuleType=psModuleType, sysBootCount=sysBootCount, atMgmt=atMgmt, psBaseAddress=psBaseAddress, psSubsysVendorID=psSubsysVendorID, psLength=psLength, psDeviceIndex=psDeviceIndex, psManufacturer=psManufacturer, sysDeviceName=sysDeviceName, snmpTrapSrvIP=snmpTrapSrvIP, psDisplayName=psDisplayName, psDeviceID=psDeviceID, snmpTrapSrvNumber=snmpTrapSrvNumber, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotTable=pciSlotTable, psClassCode=psClassCode, atPciConfig=atPciConfig, sysReleaseDate=sysReleaseDate, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, psDescr=psDescr, advantechCommonMIB=advantechCommonMIB, pciSlotEntry=pciSlotEntry, advantech=advantech, sysBootTime=sysBootTime, snmpTrapSrvTable=snmpTrapSrvTable, sysFirstBootTime=sysFirstBootTime)
