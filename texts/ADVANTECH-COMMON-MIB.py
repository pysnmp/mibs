...
# Produced by pysmi-1.1.3 at Thu Dec  9 14:56:36 2021
...
TimeTicks, ObjectIdentity, iso, IpAddress, Integer32, Unsigned32, NotificationType, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, Counter64, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "iso", "IpAddress", "Integer32", "Unsigned32", "NotificationType", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "Counter64", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, psSubsysDeviceID=psSubsysDeviceID, psBaseAddress=psBaseAddress, snmpTrapSrvIP=snmpTrapSrvIP, psModulePorts=psModulePorts, atSystem=atSystem, advantech=advantech, pciConfigObj=pciConfigObj, psIRQ=psIRQ, psBusIndex=psBusIndex, PYSNMP_MODULE_ID=advantechCommonMIB, psManufacturer=psManufacturer, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotEntry=pciSlotEntry, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysBootCount=sysBootCount, psClassCode=psClassCode, psLength=psLength, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, atPciConfig=atPciConfig, psDescr=psDescr, pciSlotTable=pciSlotTable, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, psIndex=psIndex, sysDeviceName=sysDeviceName, sysModuleID=sysModuleID, snmpTrapSrvPort=snmpTrapSrvPort, psState=psState, psDeviceIndex=psDeviceIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atMgmt=atMgmt, snmpTrapSrvTable=snmpTrapSrvTable, sysBootTime=sysBootTime, psLocation=psLocation, sysFirstBootTime=sysFirstBootTime, psSubsysVendorID=psSubsysVendorID, psDeviceID=psDeviceID, psDisplayName=psDisplayName, advantechCommonMIB=advantechCommonMIB, sysImageVersion=sysImageVersion, sysReleaseDate=sysReleaseDate, psModuleType=psModuleType, snmpTrapVersion=snmpTrapVersion)
