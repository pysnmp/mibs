...
NotificationType, enterprises, IpAddress, Gauge32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, MibIdentifier, TimeTicks, Bits, ModuleIdentity, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "IpAddress", "Gauge32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "MibIdentifier", "TimeTicks", "Bits", "ModuleIdentity", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, sysBootTime=sysBootTime, snmpTrapSrvPort=snmpTrapSrvPort, psClassCode=psClassCode, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDescr=psDescr, psModuleType=psModuleType, psManufacturer=psManufacturer, atSystem=atSystem, sysImageVersion=sysImageVersion, psVendorID=psVendorID, psIndex=psIndex, sysModuleID=sysModuleID, psNumber=psNumber, advantechCommonMIB=advantechCommonMIB, psDisplayName=psDisplayName, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, psState=psState, psBaseAddress=psBaseAddress, snmpTrapSrvTable=snmpTrapSrvTable, sysBootCount=sysBootCount, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, psIRQ=psIRQ, psFunctionIndex=psFunctionIndex, sysDeviceName=sysDeviceName, psLength=psLength, atPciConfig=atPciConfig, sysReleaseDate=sysReleaseDate, psLocation=psLocation, sysFirstBootTime=sysFirstBootTime, advantech=advantech, pciSlotTable=pciSlotTable, atMgmt=atMgmt, pciConfigObj=pciConfigObj, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysDeviceID=psSubsysDeviceID, sysDescr=sysDescr)
