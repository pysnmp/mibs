...
Counter64, Bits, Gauge32, Unsigned32, MibIdentifier, Counter32, Integer32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, ModuleIdentity, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "Gauge32", "Unsigned32", "MibIdentifier", "Counter32", "Integer32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "ModuleIdentity", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psNumber=psNumber, sysReleaseDate=sysReleaseDate, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootCount=sysBootCount, sysDescr=sysDescr, pciConfigObj=pciConfigObj, psBaseAddress=psBaseAddress, psIndex=psIndex, psLength=psLength, sysModuleID=sysModuleID, snmpTrapSrvIndex=snmpTrapSrvIndex, psVendorID=psVendorID, psModuleType=psModuleType, psModulePorts=psModulePorts, psDeviceID=psDeviceID, advantech=advantech, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapVersion=snmpTrapVersion, psClassCode=psClassCode, psFunctionIndex=psFunctionIndex, psIRQ=psIRQ, psDescr=psDescr, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, atSystem=atSystem, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, atMgmt=atMgmt, sysBootTime=sysBootTime, advantechCommonMIB=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, psDeviceIndex=psDeviceIndex, atPciConfig=atPciConfig, psLocation=psLocation, pciSlotEntry=pciSlotEntry, snmpTrapSrvPort=snmpTrapSrvPort, sysFirstBootTime=sysFirstBootTime, psState=psState, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotTable=pciSlotTable, PYSNMP_MODULE_ID=advantechCommonMIB, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, psBusIndex=psBusIndex, psDisplayName=psDisplayName)
