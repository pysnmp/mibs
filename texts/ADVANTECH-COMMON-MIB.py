...
ObjectIdentity, Bits, Counter32, enterprises, ModuleIdentity, MibIdentifier, NotificationType, Gauge32, Unsigned32, Integer32, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Counter32", "enterprises", "ModuleIdentity", "MibIdentifier", "NotificationType", "Gauge32", "Unsigned32", "Integer32", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvObj=snmpTrapSrvObj, psSubsysVendorID=psSubsysVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceID=psDeviceID, sysReleaseDate=sysReleaseDate, sysBootTime=sysBootTime, pciConfigObj=pciConfigObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLength=psLength, atMgmt=atMgmt, psVendorID=psVendorID, psBaseAddress=psBaseAddress, sysBootCount=sysBootCount, sysModuleID=sysModuleID, psModuleType=psModuleType, advantech=advantech, psNumber=psNumber, psBusIndex=psBusIndex, snmpTrapVersion=snmpTrapVersion, psState=psState, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, atPciConfig=atPciConfig, sysImageVersion=sysImageVersion, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psClassCode=psClassCode, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysDeviceID=psSubsysDeviceID, psManufacturer=psManufacturer, psLocation=psLocation, psDescr=psDescr, psIRQ=psIRQ, sysDescr=sysDescr, psIndex=psIndex, psDisplayName=psDisplayName, pciSlotEntry=pciSlotEntry, sysDeviceName=sysDeviceName, psDeviceIndex=psDeviceIndex, atSystem=atSystem, psFunctionIndex=psFunctionIndex)
