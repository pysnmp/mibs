...
Gauge32, Counter32, IpAddress, Unsigned32, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, Integer32, Bits, Counter64, ModuleIdentity, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "IpAddress", "Unsigned32", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "Integer32", "Bits", "Counter64", "ModuleIdentity", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModuleType=psModuleType, psFunctionIndex=psFunctionIndex, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, psManufacturer=psManufacturer, psClassCode=psClassCode, snmpTrapSrvIndex=snmpTrapSrvIndex, sysImageVersion=sysImageVersion, psIRQ=psIRQ, pciSlotEntry=pciSlotEntry, psState=psState, psDeviceID=psDeviceID, psDescr=psDescr, psSubsysVendorID=psSubsysVendorID, psSubsysDeviceID=psSubsysDeviceID, pciConfigObj=pciConfigObj, sysReleaseDate=sysReleaseDate, sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDeviceName=sysDeviceName, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, atSystem=atSystem, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvPort=snmpTrapSrvPort, sysBootCount=sysBootCount, psVendorID=psVendorID, snmpTrapSrvTable=snmpTrapSrvTable, psDeviceIndex=psDeviceIndex, psNumber=psNumber, psBusIndex=psBusIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, advantech=advantech, atMgmt=atMgmt, PYSNMP_MODULE_ID=advantechCommonMIB, psBaseAddress=psBaseAddress, psLength=psLength, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, snmpTrapVersion=snmpTrapVersion, sysDescr=sysDescr, sysModuleID=sysModuleID, psIndex=psIndex, atPciConfig=atPciConfig)
