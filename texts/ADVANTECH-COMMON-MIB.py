...
enterprises, ObjectIdentity, IpAddress, Bits, iso, TimeTicks, Unsigned32, Counter32, Counter64, Gauge32, NotificationType, MibIdentifier, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "IpAddress", "Bits", "iso", "TimeTicks", "Unsigned32", "Counter32", "Counter64", "Gauge32", "NotificationType", "MibIdentifier", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootCount=sysBootCount, sysDeviceName=sysDeviceName, psDeviceID=psDeviceID, sysModuleID=sysModuleID, psVendorID=psVendorID, sysDescr=sysDescr, psClassCode=psClassCode, psIndex=psIndex, snmpTrapSrvObj=snmpTrapSrvObj, psModuleType=psModuleType, sysBootTime=sysBootTime, psNumber=psNumber, advantechCommonMIB=advantechCommonMIB, psLocation=psLocation, atMgmt=atMgmt, snmpTrapSrvCommunity=snmpTrapSrvCommunity, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, psFunctionIndex=psFunctionIndex, psState=psState, psDescr=psDescr, snmpTrapSrvIP=snmpTrapSrvIP, psSubsysDeviceID=psSubsysDeviceID, snmpTrapVersion=snmpTrapVersion, atSystem=atSystem, psManufacturer=psManufacturer, atPciConfig=atPciConfig, psDeviceIndex=psDeviceIndex, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotEntry=pciSlotEntry, psDisplayName=psDisplayName, sysImageVersion=sysImageVersion, psBusIndex=psBusIndex, psIRQ=psIRQ, advantech=advantech, psLength=psLength, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvPort=snmpTrapSrvPort, pciConfigObj=pciConfigObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIndex=snmpTrapSrvIndex, sysFirstBootTime=sysFirstBootTime, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts)
