...
TimeTicks, ModuleIdentity, ObjectIdentity, IpAddress, Unsigned32, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, iso, Counter32, Gauge32, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Unsigned32", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "iso", "Counter32", "Gauge32", "Integer32", "Bits")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, psVendorID=psVendorID, sysFirstBootTime=sysFirstBootTime, psLength=psLength, psBaseAddress=psBaseAddress, psClassCode=psClassCode, sysImageVersion=sysImageVersion, snmpTrapVersion=snmpTrapVersion, pciSlotEntry=pciSlotEntry, psModulePorts=psModulePorts, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceID=psDeviceID, atSystem=atSystem, sysBootTime=sysBootTime, psDeviceIndex=psDeviceIndex, advantechCommonMIB=advantechCommonMIB, psNumber=psNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, atPciConfig=atPciConfig, sysBootCount=sysBootCount, psIRQ=psIRQ, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvIP=snmpTrapSrvIP, advantech=advantech, psIndex=psIndex, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, pciSlotTable=pciSlotTable, psModuleType=psModuleType, psState=psState, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvObj=snmpTrapSrvObj, psLocation=psLocation, sysModuleID=sysModuleID, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysDeviceID=psSubsysDeviceID, psDescr=psDescr, psDisplayName=psDisplayName, sysDeviceName=sysDeviceName, sysReleaseDate=sysReleaseDate)
