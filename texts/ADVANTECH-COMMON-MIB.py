...
MibIdentifier, ModuleIdentity, Gauge32, TimeTicks, NotificationType, Integer32, Bits, Counter32, Unsigned32, Counter64, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Gauge32", "TimeTicks", "NotificationType", "Integer32", "Bits", "Counter32", "Unsigned32", "Counter64", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", PYSNMP_MODULE_ID=advantechCommonMIB, psIRQ=psIRQ, psDisplayName=psDisplayName, atMgmt=atMgmt, sysReleaseDate=sysReleaseDate, psDeviceIndex=psDeviceIndex, psDescr=psDescr, atPciConfig=atPciConfig, psLocation=psLocation, sysModuleID=sysModuleID, atSystem=atSystem, snmpTrapSrvObj=snmpTrapSrvObj, psBaseAddress=psBaseAddress, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModuleType=psModuleType, psSubsysDeviceID=psSubsysDeviceID, sysBootCount=sysBootCount, psDeviceID=psDeviceID, sysBootTime=sysBootTime, psModulePorts=psModulePorts, pciSlotEntry=pciSlotEntry, snmpTrapSrvTable=snmpTrapSrvTable, sysDeviceName=sysDeviceName, psClassCode=psClassCode, sysImageVersion=sysImageVersion, psNumber=psNumber, advantechCommonMIB=advantechCommonMIB, psFunctionIndex=psFunctionIndex, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, advantech=advantech, psIndex=psIndex, psState=psState, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psLength=psLength, psVendorID=psVendorID, psManufacturer=psManufacturer, sysFirstBootTime=sysFirstBootTime, pciConfigObj=pciConfigObj, pciSlotTable=pciSlotTable, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvPort=snmpTrapSrvPort)
