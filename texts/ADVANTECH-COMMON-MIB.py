...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, NotificationType, Unsigned32, ModuleIdentity, iso, enterprises, TimeTicks, Counter32, MibIdentifier, Bits, Counter64, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "NotificationType", "Unsigned32", "ModuleIdentity", "iso", "enterprises", "TimeTicks", "Counter32", "MibIdentifier", "Bits", "Counter64", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysDeviceID=psSubsysDeviceID, psDeviceIndex=psDeviceIndex, advantech=advantech, atPciConfig=atPciConfig, sysBootTime=sysBootTime, psBusIndex=psBusIndex, psLength=psLength, psManufacturer=psManufacturer, psState=psState, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, sysModuleID=sysModuleID, sysReleaseDate=sysReleaseDate, snmpTrapSrvNumber=snmpTrapSrvNumber, psIndex=psIndex, psDeviceID=psDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, atSystem=atSystem, sysFirstBootTime=sysFirstBootTime, psModulePorts=psModulePorts, psVendorID=psVendorID, psFunctionIndex=psFunctionIndex, psDescr=psDescr, atMgmt=atMgmt, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, snmpTrapVersion=snmpTrapVersion, sysDescr=sysDescr, pciSlotTable=pciSlotTable, pciSlotEntry=pciSlotEntry, psLocation=psLocation, snmpTrapSrvTable=snmpTrapSrvTable, psClassCode=psClassCode, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvObj=snmpTrapSrvObj, psSubsysVendorID=psSubsysVendorID, psIRQ=psIRQ, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvEntry=snmpTrapSrvEntry, psDisplayName=psDisplayName, snmpTrapSrvIP=snmpTrapSrvIP, sysDeviceName=sysDeviceName, pciConfigObj=pciConfigObj, psBaseAddress=psBaseAddress, psNumber=psNumber, sysBootCount=sysBootCount)
