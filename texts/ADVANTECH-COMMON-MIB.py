...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBaseAddress=psBaseAddress, psDeviceIndex=psDeviceIndex, atMgmt=atMgmt, psLength=psLength, pciSlotTable=pciSlotTable, psDeviceID=psDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvEntry=snmpTrapSrvEntry, sysImageVersion=sysImageVersion, psIRQ=psIRQ, atPciConfig=atPciConfig, snmpTrapVersion=snmpTrapVersion, psVendorID=psVendorID, advantech=advantech, psModulePorts=psModulePorts, psSubsysDeviceID=psSubsysDeviceID, psIndex=psIndex, psManufacturer=psManufacturer, psLocation=psLocation, psNumber=psNumber, psClassCode=psClassCode, sysBootCount=sysBootCount, snmpTrapSrvTable=snmpTrapSrvTable, psBusIndex=psBusIndex, pciConfigObj=pciConfigObj, psDescr=psDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDeviceName=sysDeviceName, psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysFirstBootTime=sysFirstBootTime, sysModuleID=sysModuleID, sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, advantechCommonMIB=advantechCommonMIB, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, atSystem=atSystem, pciSlotEntry=pciSlotEntry, psFunctionIndex=psFunctionIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psState=psState, psModuleType=psModuleType, sysBootTime=sysBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex)
