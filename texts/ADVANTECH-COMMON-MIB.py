...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, sysFirstBootTime=sysFirstBootTime, psLocation=psLocation, snmpTrapVersion=snmpTrapVersion, sysDescr=sysDescr, psState=psState, psModuleType=psModuleType, psBaseAddress=psBaseAddress, psVendorID=psVendorID, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, sysBootTime=sysBootTime, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceIndex=psDeviceIndex, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, sysReleaseDate=sysReleaseDate, sysImageVersion=sysImageVersion, psDeviceID=psDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, advantech=advantech, atSystem=atSystem, psManufacturer=psManufacturer, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysVendorID=psSubsysVendorID, sysBootCount=sysBootCount, psDisplayName=psDisplayName, sysDeviceName=sysDeviceName, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, psDescr=psDescr, psIRQ=psIRQ, atMgmt=atMgmt, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotTable=pciSlotTable, psClassCode=psClassCode, psNumber=psNumber, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, pciConfigObj=pciConfigObj, advantechCommonMIB=advantechCommonMIB, atPciConfig=atPciConfig, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLength=psLength, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication)
