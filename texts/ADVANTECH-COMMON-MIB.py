...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:01:52 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, Integer32, IpAddress, enterprises, Gauge32, iso, TimeTicks, Bits, Counter64, ObjectIdentity, NotificationType, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "Integer32", "IpAddress", "enterprises", "Gauge32", "iso", "TimeTicks", "Bits", "Counter64", "ObjectIdentity", "NotificationType", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psManufacturer=psManufacturer, sysModuleID=sysModuleID, psModuleType=psModuleType, sysDeviceName=sysDeviceName, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotTable=pciSlotTable, psLocation=psLocation, psIndex=psIndex, psBaseAddress=psBaseAddress, psLength=psLength, advantech=advantech, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvObj=snmpTrapSrvObj, psNumber=psNumber, sysBootTime=sysBootTime, psDescr=psDescr, pciConfigObj=pciConfigObj, psDeviceID=psDeviceID, atSystem=atSystem, psDisplayName=psDisplayName, psClassCode=psClassCode, psFunctionIndex=psFunctionIndex, psState=psState, sysBootCount=sysBootCount, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, snmpTrapSrvIP=snmpTrapSrvIP, sysDescr=sysDescr, sysReleaseDate=sysReleaseDate, snmpTrapVersion=snmpTrapVersion, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, psModulePorts=psModulePorts, pciSlotEntry=pciSlotEntry, psIRQ=psIRQ, snmpTrapSrvEntry=snmpTrapSrvEntry, advantechCommonMIB=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, snmpTrapSrvTable=snmpTrapSrvTable, atPciConfig=atPciConfig, psVendorID=psVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber)
