...
MibIdentifier, Counter64, Integer32, Counter32, Bits, ModuleIdentity, iso, ObjectIdentity, NotificationType, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Integer32", "Counter32", "Bits", "ModuleIdentity", "iso", "ObjectIdentity", "NotificationType", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, psLength=psLength, sysBootCount=sysBootCount, psFunctionIndex=psFunctionIndex, psState=psState, psDescr=psDescr, pciConfigObj=pciConfigObj, psVendorID=psVendorID, sysModuleID=sysModuleID, atMgmt=atMgmt, psManufacturer=psManufacturer, psModuleType=psModuleType, psDeviceIndex=psDeviceIndex, psNumber=psNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvTable=snmpTrapSrvTable, PYSNMP_MODULE_ID=advantechCommonMIB, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, sysDeviceName=sysDeviceName, psLocation=psLocation, sysImageVersion=sysImageVersion, psDeviceID=psDeviceID, psIRQ=psIRQ, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, psClassCode=psClassCode, sysReleaseDate=sysReleaseDate, sysBootTime=sysBootTime, sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atPciConfig=atPciConfig, pciSlotEntry=pciSlotEntry, psIndex=psIndex, psBusIndex=psBusIndex, pciSlotTable=pciSlotTable, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts, psDisplayName=psDisplayName, advantech=advantech)
