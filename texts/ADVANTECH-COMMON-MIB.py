...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModuleType=psModuleType, snmpTrapSrvNumber=snmpTrapSrvNumber, sysReleaseDate=sysReleaseDate, snmpTrapSrvIndex=snmpTrapSrvIndex, psManufacturer=psManufacturer, psState=psState, psSubsysDeviceID=psSubsysDeviceID, sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt, psClassCode=psClassCode, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, sysDescr=sysDescr, sysBootTime=sysBootTime, psLength=psLength, pciSlotEntry=pciSlotEntry, psDisplayName=psDisplayName, psIndex=psIndex, snmpTrapSrvTable=snmpTrapSrvTable, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, psBusIndex=psBusIndex, advantech=advantech, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysBootCount=sysBootCount, atSystem=atSystem, atPciConfig=atPciConfig, pciConfigObj=pciConfigObj, sysModuleID=sysModuleID, psSubsysVendorID=psSubsysVendorID, snmpTrapVersion=snmpTrapVersion, psIRQ=psIRQ, advantechCommonMIB=advantechCommonMIB, psDeviceID=psDeviceID, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, psDescr=psDescr, psBaseAddress=psBaseAddress, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, pciSlotTable=pciSlotTable, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, psLocation=psLocation)
