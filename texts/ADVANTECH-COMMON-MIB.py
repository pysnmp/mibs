...
iso, IpAddress, NotificationType, Integer32, TimeTicks, Unsigned32, Gauge32, ObjectIdentity, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "NotificationType", "Integer32", "TimeTicks", "Unsigned32", "Gauge32", "ObjectIdentity", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIP=snmpTrapSrvIP, psModulePorts=psModulePorts, psBusIndex=psBusIndex, psDisplayName=psDisplayName, snmpTrapSrvNumber=snmpTrapSrvNumber, psIndex=psIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psNumber=psNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, psManufacturer=psManufacturer, sysBootTime=sysBootTime, atPciConfig=atPciConfig, pciConfigObj=pciConfigObj, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapVersion=snmpTrapVersion, psBaseAddress=psBaseAddress, psState=psState, sysImageVersion=sysImageVersion, psDescr=psDescr, atSystem=atSystem, psLength=psLength, sysDescr=sysDescr, advantech=advantech, pciSlotEntry=pciSlotEntry, sysBootCount=sysBootCount, pciSlotTable=pciSlotTable, psVendorID=psVendorID, sysModuleID=sysModuleID, snmpTrapSrvPort=snmpTrapSrvPort, sysDeviceName=sysDeviceName, psModuleType=psModuleType, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceIndex=psDeviceIndex, psFunctionIndex=psFunctionIndex, atMgmt=atMgmt, psDeviceID=psDeviceID, psIRQ=psIRQ, sysFirstBootTime=sysFirstBootTime, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, sysReleaseDate=sysReleaseDate, snmpTrapSrvObj=snmpTrapSrvObj, psLocation=psLocation, psClassCode=psClassCode)
