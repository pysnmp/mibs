...
Unsigned32, Bits, TimeTicks, NotificationType, Integer32, Gauge32, IpAddress, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, Counter32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "TimeTicks", "NotificationType", "Integer32", "Gauge32", "IpAddress", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "Counter32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvObj=snmpTrapSrvObj, sysBootTime=sysBootTime, psState=psState, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDisplayName=psDisplayName, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, pciConfigObj=pciConfigObj, snmpTrapSrvIndex=snmpTrapSrvIndex, psSubsysVendorID=psSubsysVendorID, psLocation=psLocation, psNumber=psNumber, psBusIndex=psBusIndex, psManufacturer=psManufacturer, sysImageVersion=sysImageVersion, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, psDescr=psDescr, psVendorID=psVendorID, pciSlotTable=pciSlotTable, psDeviceIndex=psDeviceIndex, psModuleType=psModuleType, atPciConfig=atPciConfig, sysDescr=sysDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceID=psDeviceID, sysBootCount=sysBootCount, psFunctionIndex=psFunctionIndex, psBaseAddress=psBaseAddress, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, advantech=advantech, pciSlotEntry=pciSlotEntry, snmpTrapVersion=snmpTrapVersion, sysReleaseDate=sysReleaseDate, atMgmt=atMgmt, snmpTrapSrvPort=snmpTrapSrvPort, psClassCode=psClassCode, psIRQ=psIRQ, psIndex=psIndex, psLength=psLength, psModulePorts=psModulePorts, sysDeviceName=sysDeviceName, sysModuleID=sysModuleID)
