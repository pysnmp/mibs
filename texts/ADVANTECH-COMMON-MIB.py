...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, psLocation=psLocation, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, psBaseAddress=psBaseAddress, snmpTrapSrvTable=snmpTrapSrvTable, sysReleaseDate=sysReleaseDate, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, atMgmt=atMgmt, atSystem=atSystem, advantechCommonMIB=advantechCommonMIB, psDeviceIndex=psDeviceIndex, sysDeviceName=sysDeviceName, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, sysImageVersion=sysImageVersion, sysModuleID=sysModuleID, snmpTrapVersion=snmpTrapVersion, psDeviceID=psDeviceID, psNumber=psNumber, psState=psState, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, psFunctionIndex=psFunctionIndex, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIP=snmpTrapSrvIP, psSubsysVendorID=psSubsysVendorID, psClassCode=psClassCode, psBusIndex=psBusIndex, PYSNMP_MODULE_ID=advantechCommonMIB, psLength=psLength, sysDescr=sysDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, psVendorID=psVendorID, sysBootTime=sysBootTime, psModulePorts=psModulePorts, psIRQ=psIRQ, psDescr=psDescr, advantech=advantech, sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, psModuleType=psModuleType)
