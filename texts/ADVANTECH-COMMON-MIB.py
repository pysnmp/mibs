...
enterprises, Bits, Unsigned32, Integer32, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, IpAddress, NotificationType, MibIdentifier, Counter64, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "Unsigned32", "Integer32", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "IpAddress", "NotificationType", "MibIdentifier", "Counter64", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootCount=sysBootCount, sysDeviceName=sysDeviceName, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvTable=snmpTrapSrvTable, psIRQ=psIRQ, psFunctionIndex=psFunctionIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceID=psDeviceID, psDeviceIndex=psDeviceIndex, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvPort=snmpTrapSrvPort, psBusIndex=psBusIndex, psLocation=psLocation, psIndex=psIndex, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, psSubsysVendorID=psSubsysVendorID, psManufacturer=psManufacturer, atSystem=atSystem, snmpTrapSrvObj=snmpTrapSrvObj, psSubsysDeviceID=psSubsysDeviceID, sysModuleID=sysModuleID, psNumber=psNumber, pciSlotTable=pciSlotTable, psModuleType=psModuleType, psClassCode=psClassCode, atMgmt=atMgmt, psDescr=psDescr, psLength=psLength, psModulePorts=psModulePorts, psDisplayName=psDisplayName, sysReleaseDate=sysReleaseDate, snmpTrapSrvEntry=snmpTrapSrvEntry, atPciConfig=atPciConfig, pciSlotEntry=pciSlotEntry, advantech=advantech, sysFirstBootTime=sysFirstBootTime, sysBootTime=sysBootTime, psVendorID=psVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBaseAddress=psBaseAddress, snmpTrapSrvNumber=snmpTrapSrvNumber, pciConfigObj=pciConfigObj, psState=psState, advantechCommonMIB=advantechCommonMIB, PYSNMP_MODULE_ID=advantechCommonMIB, sysImageVersion=sysImageVersion)
