...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, Gauge32, Integer32, ModuleIdentity, Unsigned32, IpAddress, iso, MibIdentifier, TimeTicks, enterprises, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "Gauge32", "Integer32", "ModuleIdentity", "Unsigned32", "IpAddress", "iso", "MibIdentifier", "TimeTicks", "enterprises", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysVendorID=psSubsysVendorID, psLocation=psLocation, psClassCode=psClassCode, psState=psState, sysBootTime=sysBootTime, sysDeviceName=sysDeviceName, psNumber=psNumber, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, sysBootCount=sysBootCount, psBusIndex=psBusIndex, psModulePorts=psModulePorts, advantech=advantech, snmpTrapSrvNumber=snmpTrapSrvNumber, sysModuleID=sysModuleID, psDeviceID=psDeviceID, sysDescr=sysDescr, pciSlotEntry=pciSlotEntry, psBaseAddress=psBaseAddress, psIndex=psIndex, pciSlotTable=pciSlotTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciConfigObj=pciConfigObj, psVendorID=psVendorID, sysReleaseDate=sysReleaseDate, snmpTrapSrvTable=snmpTrapSrvTable, psDeviceIndex=psDeviceIndex, advantechCommonMIB=advantechCommonMIB, atPciConfig=atPciConfig, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, sysImageVersion=sysImageVersion, psIRQ=psIRQ, snmpTrapSrvIP=snmpTrapSrvIP, psSubsysDeviceID=psSubsysDeviceID, atSystem=atSystem, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvObj=snmpTrapSrvObj, sysFirstBootTime=sysFirstBootTime, psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, psFunctionIndex=psFunctionIndex, psLength=psLength, psDescr=psDescr, psModuleType=psModuleType, snmpTrapSrvIndex=snmpTrapSrvIndex, atMgmt=atMgmt)
