...
ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Integer32, IpAddress, TimeTicks, Gauge32, Counter32, enterprises, iso, Bits, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Integer32", "IpAddress", "TimeTicks", "Gauge32", "Counter32", "enterprises", "iso", "Bits", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atMgmt=atMgmt, psNumber=psNumber, psIndex=psIndex, pciConfigObj=pciConfigObj, sysBootCount=sysBootCount, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLocation=psLocation, pciSlotEntry=pciSlotEntry, snmpTrapSrvObj=snmpTrapSrvObj, psDescr=psDescr, snmpTrapVersion=snmpTrapVersion, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvEntry=snmpTrapSrvEntry, psVendorID=psVendorID, psModulePorts=psModulePorts, psDeviceID=psDeviceID, psState=psState, advantechCommonMIB=advantechCommonMIB, sysDeviceName=sysDeviceName, sysFirstBootTime=sysFirstBootTime, sysImageVersion=sysImageVersion, advantech=advantech, psFunctionIndex=psFunctionIndex, psModuleType=psModuleType, pciSlotTable=pciSlotTable, psIRQ=psIRQ, sysModuleID=sysModuleID, atSystem=atSystem, psDeviceIndex=psDeviceIndex, sysDescr=sysDescr, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvPort=snmpTrapSrvPort, psDisplayName=psDisplayName, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, sysReleaseDate=sysReleaseDate, psBaseAddress=psBaseAddress, psLength=psLength, sysBootTime=sysBootTime, atPciConfig=atPciConfig, psClassCode=psClassCode, psManufacturer=psManufacturer)
