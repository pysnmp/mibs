...
iso, MibIdentifier, IpAddress, Gauge32, ModuleIdentity, Counter64, TimeTicks, Integer32, enterprises, Bits, NotificationType, Unsigned32, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "IpAddress", "Gauge32", "ModuleIdentity", "Counter64", "TimeTicks", "Integer32", "enterprises", "Bits", "NotificationType", "Unsigned32", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciConfigObj=pciConfigObj, sysFirstBootTime=sysFirstBootTime, psModuleType=psModuleType, snmpTrapSrvObj=snmpTrapSrvObj, atSystem=atSystem, snmpTrapSrvEntry=snmpTrapSrvEntry, psModulePorts=psModulePorts, psManufacturer=psManufacturer, snmpTrapSrvPort=snmpTrapSrvPort, advantech=advantech, sysModuleID=sysModuleID, advantechCommonMIB=advantechCommonMIB, sysReleaseDate=sysReleaseDate, psSubsysDeviceID=psSubsysDeviceID, psState=psState, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, psClassCode=psClassCode, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, psLocation=psLocation, psBaseAddress=psBaseAddress, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceIndex=psDeviceIndex, sysDeviceName=sysDeviceName, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psNumber=psNumber, pciSlotEntry=pciSlotEntry, psDisplayName=psDisplayName, psDescr=psDescr, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIP=snmpTrapSrvIP, sysImageVersion=sysImageVersion, sysDescr=sysDescr, psBusIndex=psBusIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psLength=psLength, pciSlotTable=pciSlotTable, atMgmt=atMgmt, psIRQ=psIRQ, sysBootCount=sysBootCount, atPciConfig=atPciConfig, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootTime=sysBootTime, psDeviceID=psDeviceID)
