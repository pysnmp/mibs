...
iso, ObjectIdentity, TimeTicks, Gauge32, NotificationType, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, Integer32, ModuleIdentity, MibIdentifier, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "TimeTicks", "Gauge32", "NotificationType", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "Integer32", "ModuleIdentity", "MibIdentifier", "Bits", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, psVendorID=psVendorID, sysFirstBootTime=sysFirstBootTime, psState=psState, psClassCode=psClassCode, psIRQ=psIRQ, sysReleaseDate=sysReleaseDate, psFunctionIndex=psFunctionIndex, sysImageVersion=sysImageVersion, psLocation=psLocation, psDeviceID=psDeviceID, psLength=psLength, atSystem=atSystem, psNumber=psNumber, snmpTrapSrvIP=snmpTrapSrvIP, psBaseAddress=psBaseAddress, psManufacturer=psManufacturer, sysBootTime=sysBootTime, psModuleType=psModuleType, pciConfigObj=pciConfigObj, snmpTrapSrvIndex=snmpTrapSrvIndex, psBusIndex=psBusIndex, advantech=advantech, atMgmt=atMgmt, advantechCommonMIB=advantechCommonMIB, psIndex=psIndex, psDescr=psDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, sysDeviceName=sysDeviceName, snmpTrapVersion=snmpTrapVersion, atPciConfig=atPciConfig, psDeviceIndex=psDeviceIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDisplayName=psDisplayName, pciSlotTable=pciSlotTable, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvPort=snmpTrapSrvPort, sysBootCount=sysBootCount, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotEntry=pciSlotEntry, psModulePorts=psModulePorts, sysModuleID=sysModuleID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB)
