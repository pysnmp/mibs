...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBusIndex=psBusIndex, psSubsysVendorID=psSubsysVendorID, advantech=advantech, sysImageVersion=sysImageVersion, sysDescr=sysDescr, sysBootCount=sysBootCount, psClassCode=psClassCode, sysDeviceName=sysDeviceName, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, psLength=psLength, psDeviceID=psDeviceID, psNumber=psNumber, psDeviceIndex=psDeviceIndex, psBaseAddress=psBaseAddress, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapVersion=snmpTrapVersion, psIndex=psIndex, atMgmt=atMgmt, psIRQ=psIRQ, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvObj=snmpTrapSrvObj, atSystem=atSystem, psManufacturer=psManufacturer, psState=psState, pciSlotTable=pciSlotTable, psVendorID=psVendorID, psModuleType=psModuleType, sysModuleID=sysModuleID, psDisplayName=psDisplayName, psFunctionIndex=psFunctionIndex, sysBootTime=sysBootTime, advantechCommonMIB=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDescr=psDescr, snmpTrapSrvPort=snmpTrapSrvPort, atPciConfig=atPciConfig, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, pciConfigObj=pciConfigObj, sysReleaseDate=sysReleaseDate, pciSlotEntry=pciSlotEntry, psLocation=psLocation)
