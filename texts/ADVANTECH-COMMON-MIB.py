...
Unsigned32, Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, NotificationType, Bits, TimeTicks, Gauge32, MibIdentifier, IpAddress, ObjectIdentity, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "NotificationType", "Bits", "TimeTicks", "Gauge32", "MibIdentifier", "IpAddress", "ObjectIdentity", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysReleaseDate=sysReleaseDate, psDisplayName=psDisplayName, psClassCode=psClassCode, psManufacturer=psManufacturer, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIndex=psIndex, psDeviceIndex=psDeviceIndex, psSubsysVendorID=psSubsysVendorID, sysDeviceName=sysDeviceName, psLength=psLength, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIP=snmpTrapSrvIP, sysImageVersion=sysImageVersion, psBaseAddress=psBaseAddress, psIRQ=psIRQ, sysFirstBootTime=sysFirstBootTime, psState=psState, psBusIndex=psBusIndex, sysDescr=sysDescr, sysBootTime=sysBootTime, sysModuleID=sysModuleID, snmpTrapSrvTable=snmpTrapSrvTable, atSystem=atSystem, pciSlotTable=pciSlotTable, atPciConfig=atPciConfig, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLocation=psLocation, psDeviceID=psDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, psDescr=psDescr, psFunctionIndex=psFunctionIndex, sysBootCount=sysBootCount, psModuleType=psModuleType, pciConfigObj=pciConfigObj, advantech=advantech, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, advantechCommonMIB=advantechCommonMIB, psNumber=psNumber, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, atMgmt=atMgmt, psVendorID=psVendorID, pciSlotEntry=pciSlotEntry, snmpTrapVersion=snmpTrapVersion)
