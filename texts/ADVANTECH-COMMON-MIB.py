...
NotificationType, MibIdentifier, ModuleIdentity, TimeTicks, ObjectIdentity, enterprises, Gauge32, Counter64, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "enterprises", "Gauge32", "Counter64", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModulePorts=psModulePorts, sysImageVersion=sysImageVersion, sysBootTime=sysBootTime, sysReleaseDate=sysReleaseDate, psSubsysDeviceID=psSubsysDeviceID, psModuleType=psModuleType, atSystem=atSystem, psLocation=psLocation, psDeviceID=psDeviceID, psBaseAddress=psBaseAddress, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, pciConfigObj=pciConfigObj, pciSlotEntry=pciSlotEntry, psDescr=psDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIndex=snmpTrapSrvIndex, psClassCode=psClassCode, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotTable=pciSlotTable, psManufacturer=psManufacturer, psFunctionIndex=psFunctionIndex, sysModuleID=sysModuleID, snmpTrapSrvTable=snmpTrapSrvTable, psVendorID=psVendorID, psSubsysVendorID=psSubsysVendorID, psState=psState, sysDeviceName=sysDeviceName, snmpTrapSrvPort=snmpTrapSrvPort, atPciConfig=atPciConfig, psIRQ=psIRQ, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, sysDescr=sysDescr, psDeviceIndex=psDeviceIndex, sysBootCount=sysBootCount, snmpTrapSrvIP=snmpTrapSrvIP, advantech=advantech, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength, psDisplayName=psDisplayName, psNumber=psNumber, advantechCommonMIB=advantechCommonMIB, atMgmt=atMgmt, psIndex=psIndex)
