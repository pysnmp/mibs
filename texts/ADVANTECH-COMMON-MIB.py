...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, IpAddress, Unsigned32, Integer32, Counter64, iso, enterprises, Counter32, NotificationType, ObjectIdentity, MibIdentifier, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "IpAddress", "Unsigned32", "Integer32", "Counter64", "iso", "enterprises", "Counter32", "NotificationType", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, sysReleaseDate=sysReleaseDate, atPciConfig=atPciConfig, psBaseAddress=psBaseAddress, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootTime=sysBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, psModuleType=psModuleType, sysDeviceName=sysDeviceName, psBusIndex=psBusIndex, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, atSystem=atSystem, sysImageVersion=sysImageVersion, advantech=advantech, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, psDescr=psDescr, psFunctionIndex=psFunctionIndex, atMgmt=atMgmt, psManufacturer=psManufacturer, psVendorID=psVendorID, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapVersion=snmpTrapVersion, psIRQ=psIRQ, sysModuleID=sysModuleID, pciSlotEntry=pciSlotEntry, sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, psModulePorts=psModulePorts, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotTable=pciSlotTable, psLength=psLength, psLocation=psLocation, psDisplayName=psDisplayName, psDeviceIndex=psDeviceIndex, psState=psState, psDeviceID=psDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvPort=snmpTrapSrvPort, sysDescr=sysDescr, sysFirstBootTime=sysFirstBootTime, psClassCode=psClassCode, psSubsysDeviceID=psSubsysDeviceID)
