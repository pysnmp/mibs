...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBaseAddress=psBaseAddress, sysReleaseDate=sysReleaseDate, advantechCommonMIB=advantechCommonMIB, psBusIndex=psBusIndex, psLocation=psLocation, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, PYSNMP_MODULE_ID=advantechCommonMIB, psDisplayName=psDisplayName, snmpTrapSrvTable=snmpTrapSrvTable, atPciConfig=atPciConfig, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvNumber=snmpTrapSrvNumber, psManufacturer=psManufacturer, sysBootTime=sysBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, psClassCode=psClassCode, psState=psState, psModuleType=psModuleType, psModulePorts=psModulePorts, psIRQ=psIRQ, psLength=psLength, sysModuleID=sysModuleID, advantech=advantech, psDeviceIndex=psDeviceIndex, psIndex=psIndex, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, sysBootCount=sysBootCount, atSystem=atSystem, snmpTrapSrvObj=snmpTrapSrvObj, sysImageVersion=sysImageVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciConfigObj=pciConfigObj, snmpTrapVersion=snmpTrapVersion, sysDeviceName=sysDeviceName, atMgmt=atMgmt, psSubsysVendorID=psSubsysVendorID, psVendorID=psVendorID, pciSlotTable=pciSlotTable, sysDescr=sysDescr, psDescr=psDescr, psFunctionIndex=psFunctionIndex, sysFirstBootTime=sysFirstBootTime, psNumber=psNumber)
