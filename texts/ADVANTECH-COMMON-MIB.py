...
enterprises, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, NotificationType, Bits, Gauge32, ObjectIdentity, ModuleIdentity, TimeTicks, Counter32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "NotificationType", "Bits", "Gauge32", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Counter32", "Integer32", "iso")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDisplayName=psDisplayName, advantech=advantech, sysBootCount=sysBootCount, psIRQ=psIRQ, sysBootTime=sysBootTime, psDeviceID=psDeviceID, psModuleType=psModuleType, snmpTrapSrvPort=snmpTrapSrvPort, pciConfigObj=pciConfigObj, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate, sysDeviceName=sysDeviceName, psNumber=psNumber, psLocation=psLocation, sysModuleID=sysModuleID, snmpTrapSrvObj=snmpTrapSrvObj, psState=psState, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapVersion=snmpTrapVersion, psIndex=psIndex, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, atSystem=atSystem, psVendorID=psVendorID, psSubsysVendorID=psSubsysVendorID, pciSlotTable=pciSlotTable, snmpTrapSrvIP=snmpTrapSrvIP, psClassCode=psClassCode, snmpTrapSrvNumber=snmpTrapSrvNumber, psManufacturer=psManufacturer, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, psBaseAddress=psBaseAddress, psLength=psLength, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, sysImageVersion=sysImageVersion, sysDescr=sysDescr, psDeviceIndex=psDeviceIndex, psModulePorts=psModulePorts, atMgmt=atMgmt, psDescr=psDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity)
