...
Bits, NotificationType, MibIdentifier, ObjectIdentity, Gauge32, ModuleIdentity, Unsigned32, IpAddress, enterprises, Integer32, Counter32, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "MibIdentifier", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Unsigned32", "IpAddress", "enterprises", "Integer32", "Counter32", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", PYSNMP_MODULE_ID=advantechCommonMIB, psVendorID=psVendorID, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate, snmpTrapSrvNumber=snmpTrapSrvNumber, psClassCode=psClassCode, psFunctionIndex=psFunctionIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantech=advantech, sysBootTime=sysBootTime, psDeviceIndex=psDeviceIndex, psDisplayName=psDisplayName, psIRQ=psIRQ, sysModuleID=sysModuleID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootCount=sysBootCount, atMgmt=atMgmt, snmpTrapSrvIP=snmpTrapSrvIP, psLength=psLength, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, psBaseAddress=psBaseAddress, psDescr=psDescr, snmpTrapSrvPort=snmpTrapSrvPort, psNumber=psNumber, psBusIndex=psBusIndex, psLocation=psLocation, snmpTrapVersion=snmpTrapVersion, sysImageVersion=sysImageVersion, psState=psState, psModulePorts=psModulePorts, psModuleType=psModuleType, atSystem=atSystem, psIndex=psIndex, psManufacturer=psManufacturer, sysFirstBootTime=sysFirstBootTime, psDeviceID=psDeviceID, pciSlotEntry=pciSlotEntry, sysDescr=sysDescr, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, pciConfigObj=pciConfigObj, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvObj=snmpTrapSrvObj)
