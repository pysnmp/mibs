...
ObjectIdentity, Gauge32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Counter32, TimeTicks, MibIdentifier, Bits, IpAddress, ModuleIdentity, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Counter32", "TimeTicks", "MibIdentifier", "Bits", "IpAddress", "ModuleIdentity", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", PYSNMP_MODULE_ID=advantechCommonMIB, psBusIndex=psBusIndex, psDeviceID=psDeviceID, psModuleType=psModuleType, advantech=advantech, psDeviceIndex=psDeviceIndex, atMgmt=atMgmt, sysImageVersion=sysImageVersion, psLocation=psLocation, psSubsysVendorID=psSubsysVendorID, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psClassCode=psClassCode, psDescr=psDescr, psNumber=psNumber, pciSlotEntry=pciSlotEntry, snmpTrapVersion=snmpTrapVersion, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, psBaseAddress=psBaseAddress, psState=psState, psVendorID=psVendorID, sysBootTime=sysBootTime, atSystem=atSystem, snmpTrapSrvObj=snmpTrapSrvObj, psManufacturer=psManufacturer, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotTable=pciSlotTable, psIndex=psIndex, psLength=psLength, snmpTrapSrvTable=snmpTrapSrvTable, psDisplayName=psDisplayName, snmpTrapSrvNumber=snmpTrapSrvNumber, psIRQ=psIRQ, sysModuleID=sysModuleID, pciConfigObj=pciConfigObj, advantechCommonMIB=advantechCommonMIB, atPciConfig=atPciConfig, sysBootCount=sysBootCount, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysDeviceID=psSubsysDeviceID, sysDeviceName=sysDeviceName, snmpTrapSrvEntry=snmpTrapSrvEntry)
