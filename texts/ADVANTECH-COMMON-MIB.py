...
NotificationType, Gauge32, Counter64, MibIdentifier, TimeTicks, iso, Bits, enterprises, ObjectIdentity, Integer32, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Counter64", "MibIdentifier", "TimeTicks", "iso", "Bits", "enterprises", "ObjectIdentity", "Integer32", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvTable=snmpTrapSrvTable, psClassCode=psClassCode, psLength=psLength, psVendorID=psVendorID, pciSlotEntry=pciSlotEntry, snmpTrapSrvEntry=snmpTrapSrvEntry, psLocation=psLocation, advantech=advantech, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, psState=psState, psBusIndex=psBusIndex, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvPort=snmpTrapSrvPort, pciConfigObj=pciConfigObj, psModuleType=psModuleType, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, sysDeviceName=sysDeviceName, sysImageVersion=sysImageVersion, sysBootCount=sysBootCount, snmpTrapSrvIP=snmpTrapSrvIP, psDisplayName=psDisplayName, atPciConfig=atPciConfig, snmpTrapSrvIndex=snmpTrapSrvIndex, advantechCommonMIB=advantechCommonMIB, sysModuleID=sysModuleID, psNumber=psNumber, sysBootTime=sysBootTime, psFunctionIndex=psFunctionIndex, psSubsysVendorID=psSubsysVendorID, psBaseAddress=psBaseAddress, sysFirstBootTime=sysFirstBootTime, PYSNMP_MODULE_ID=advantechCommonMIB, sysReleaseDate=sysReleaseDate, atSystem=atSystem, psDeviceID=psDeviceID, psDeviceIndex=psDeviceIndex, psDescr=psDescr, pciSlotTable=pciSlotTable, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIndex=psIndex, psModulePorts=psModulePorts, psIRQ=psIRQ, psManufacturer=psManufacturer, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication)
