...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, ModuleIdentity, Integer32, ObjectIdentity, Gauge32, Counter32, TimeTicks, MibIdentifier, Bits, NotificationType, IpAddress, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "ModuleIdentity", "Integer32", "ObjectIdentity", "Gauge32", "Counter32", "TimeTicks", "MibIdentifier", "Bits", "NotificationType", "IpAddress", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atMgmt=atMgmt, psBaseAddress=psBaseAddress, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootCount=sysBootCount, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, psDeviceID=psDeviceID, sysModuleID=sysModuleID, psLength=psLength, psVendorID=psVendorID, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, psState=psState, PYSNMP_MODULE_ID=advantechCommonMIB, psDescr=psDescr, psIRQ=psIRQ, atPciConfig=atPciConfig, sysDescr=sysDescr, psModuleType=psModuleType, psManufacturer=psManufacturer, sysReleaseDate=sysReleaseDate, snmpTrapSrvNumber=snmpTrapSrvNumber, advantechCommonMIB=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvTable=snmpTrapSrvTable, sysImageVersion=sysImageVersion, psDisplayName=psDisplayName, psModulePorts=psModulePorts, sysBootTime=sysBootTime, psIndex=psIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvPort=snmpTrapSrvPort, sysFirstBootTime=sysFirstBootTime, psFunctionIndex=psFunctionIndex, psClassCode=psClassCode, psDeviceIndex=psDeviceIndex, advantech=advantech, psBusIndex=psBusIndex, psLocation=psLocation, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atSystem=atSystem, pciSlotEntry=pciSlotEntry, pciConfigObj=pciConfigObj, psSubsysDeviceID=psSubsysDeviceID)
