...
Integer32, Bits, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, IpAddress, Unsigned32, iso, Counter64, ModuleIdentity, MibIdentifier, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "IpAddress", "Unsigned32", "iso", "Counter64", "ModuleIdentity", "MibIdentifier", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysDeviceID=psSubsysDeviceID, psNumber=psNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvObj=snmpTrapSrvObj, psBusIndex=psBusIndex, advantech=advantech, atSystem=atSystem, snmpTrapSrvTable=snmpTrapSrvTable, psDescr=psDescr, psLength=psLength, PYSNMP_MODULE_ID=advantechCommonMIB, sysImageVersion=sysImageVersion, psDeviceIndex=psDeviceIndex, psState=psState, psDisplayName=psDisplayName, psFunctionIndex=psFunctionIndex, psIRQ=psIRQ, psModulePorts=psModulePorts, sysDescr=sysDescr, psManufacturer=psManufacturer, psLocation=psLocation, snmpTrapVersion=snmpTrapVersion, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, psSubsysVendorID=psSubsysVendorID, psClassCode=psClassCode, pciConfigObj=pciConfigObj, psVendorID=psVendorID, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootTime=sysBootTime, pciSlotEntry=pciSlotEntry, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, psIndex=psIndex, atMgmt=atMgmt, sysFirstBootTime=sysFirstBootTime, pciSlotTable=pciSlotTable, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvNumber=snmpTrapSrvNumber, sysReleaseDate=sysReleaseDate, sysModuleID=sysModuleID, psDeviceID=psDeviceID, snmpTrapSrvIP=snmpTrapSrvIP, sysBootCount=sysBootCount)
