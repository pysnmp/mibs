...
TimeTicks, Counter64, MibIdentifier, ModuleIdentity, Bits, iso, IpAddress, Counter32, Unsigned32, Integer32, NotificationType, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "MibIdentifier", "ModuleIdentity", "Bits", "iso", "IpAddress", "Counter32", "Unsigned32", "Integer32", "NotificationType", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIRQ=psIRQ, psLocation=psLocation, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, psDeviceIndex=psDeviceIndex, pciSlotEntry=pciSlotEntry, sysDescr=sysDescr, psNumber=psNumber, psFunctionIndex=psFunctionIndex, psIndex=psIndex, atPciConfig=atPciConfig, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, snmpTrapSrvEntry=snmpTrapSrvEntry, sysModuleID=sysModuleID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIP=snmpTrapSrvIP, atMgmt=atMgmt, sysDeviceName=sysDeviceName, psSubsysVendorID=psSubsysVendorID, psLength=psLength, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, sysImageVersion=sysImageVersion, snmpTrapSrvTable=snmpTrapSrvTable, psVendorID=psVendorID, psState=psState, snmpTrapVersion=snmpTrapVersion, psClassCode=psClassCode, atSystem=atSystem, psDisplayName=psDisplayName, psDescr=psDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvObj=snmpTrapSrvObj, psModulePorts=psModulePorts, sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, sysFirstBootTime=sysFirstBootTime, PYSNMP_MODULE_ID=advantechCommonMIB, advantech=advantech, psDeviceID=psDeviceID, sysBootTime=sysBootTime, psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, psManufacturer=psManufacturer)
