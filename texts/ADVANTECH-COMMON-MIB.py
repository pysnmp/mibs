...
MibIdentifier, NotificationType, Integer32, ObjectIdentity, TimeTicks, IpAddress, enterprises, Bits, ModuleIdentity, Unsigned32, Gauge32, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Integer32", "ObjectIdentity", "TimeTicks", "IpAddress", "enterprises", "Bits", "ModuleIdentity", "Unsigned32", "Gauge32", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atSystem=atSystem, sysBootTime=sysBootTime, psFunctionIndex=psFunctionIndex, psNumber=psNumber, psSubsysVendorID=psSubsysVendorID, psLocation=psLocation, sysBootCount=sysBootCount, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, psIRQ=psIRQ, snmpTrapVersion=snmpTrapVersion, psModulePorts=psModulePorts, sysModuleID=sysModuleID, psBaseAddress=psBaseAddress, snmpTrapSrvObj=snmpTrapSrvObj, psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDeviceName=sysDeviceName, psDeviceID=psDeviceID, sysImageVersion=sysImageVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceIndex=psDeviceIndex, psDisplayName=psDisplayName, psState=psState, pciConfigObj=pciConfigObj, psVendorID=psVendorID, pciSlotTable=pciSlotTable, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, psModuleType=psModuleType, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, PYSNMP_MODULE_ID=advantechCommonMIB, atPciConfig=atPciConfig, advantechCommonMIB=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIP=snmpTrapSrvIP, psLength=psLength, atMgmt=atMgmt, psClassCode=psClassCode, psIndex=psIndex, sysDescr=sysDescr, snmpTrapSrvTable=snmpTrapSrvTable, advantech=advantech)
