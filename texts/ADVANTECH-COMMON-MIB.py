...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, Integer32, Gauge32, ModuleIdentity, MibIdentifier, iso, Counter64, NotificationType, enterprises, TimeTicks, IpAddress, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "Integer32", "Gauge32", "ModuleIdentity", "MibIdentifier", "iso", "Counter64", "NotificationType", "enterprises", "TimeTicks", "IpAddress", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBaseAddress=psBaseAddress, psClassCode=psClassCode, snmpTrapSrvTable=snmpTrapSrvTable, psBusIndex=psBusIndex, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, psSubsysVendorID=psSubsysVendorID, psDescr=psDescr, psIRQ=psIRQ, atSystem=atSystem, sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt, psIndex=psIndex, psNumber=psNumber, snmpTrapVersion=snmpTrapVersion, psFunctionIndex=psFunctionIndex, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, advantechCommonMIB=advantechCommonMIB, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, psVendorID=psVendorID, psState=psState, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvEntry=snmpTrapSrvEntry, sysDescr=sysDescr, psLocation=psLocation, psModulePorts=psModulePorts, psDeviceID=psDeviceID, pciConfigObj=pciConfigObj, psDeviceIndex=psDeviceIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotTable=pciSlotTable, snmpTrapSrvIP=snmpTrapSrvIP, sysModuleID=sysModuleID, psManufacturer=psManufacturer, advantech=advantech, sysBootCount=sysBootCount, psLength=psLength, psModuleType=psModuleType, sysBootTime=sysBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex)
