...
ModuleIdentity, Bits, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Counter32, Counter64, iso, enterprises, NotificationType, ObjectIdentity, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Counter32", "Counter64", "iso", "enterprises", "NotificationType", "ObjectIdentity", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModuleType=psModuleType, psClassCode=psClassCode, pciSlotEntry=pciSlotEntry, atMgmt=atMgmt, psDeviceID=psDeviceID, psModulePorts=psModulePorts, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, sysModuleID=sysModuleID, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDescr=psDescr, psManufacturer=psManufacturer, psSubsysDeviceID=psSubsysDeviceID, psSubsysVendorID=psSubsysVendorID, psLocation=psLocation, psDisplayName=psDisplayName, advantech=advantech, psLength=psLength, psBusIndex=psBusIndex, atSystem=atSystem, psDeviceIndex=psDeviceIndex, atPciConfig=atPciConfig, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootCount=sysBootCount, psIRQ=psIRQ, sysImageVersion=sysImageVersion, pciConfigObj=pciConfigObj, pciSlotTable=pciSlotTable, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, psIndex=psIndex, sysDeviceName=sysDeviceName, psState=psState, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psBaseAddress=psBaseAddress, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, sysBootTime=sysBootTime, sysReleaseDate=sysReleaseDate, psNumber=psNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDescr=sysDescr)
