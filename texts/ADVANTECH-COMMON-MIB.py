...
ObjectIdentity, Unsigned32, IpAddress, Bits, Gauge32, NotificationType, Integer32, ModuleIdentity, Counter64, MibIdentifier, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "IpAddress", "Bits", "Gauge32", "NotificationType", "Integer32", "ModuleIdentity", "Counter64", "MibIdentifier", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, psIRQ=psIRQ, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atPciConfig=atPciConfig, advantech=advantech, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psFunctionIndex=psFunctionIndex, sysDeviceName=sysDeviceName, psSubsysVendorID=psSubsysVendorID, pciSlotTable=pciSlotTable, atMgmt=atMgmt, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysDeviceID=psSubsysDeviceID, psVendorID=psVendorID, sysFirstBootTime=sysFirstBootTime, pciConfigObj=pciConfigObj, psDisplayName=psDisplayName, atSystem=atSystem, psDescr=psDescr, sysModuleID=sysModuleID, sysImageVersion=sysImageVersion, psLength=psLength, psDeviceIndex=psDeviceIndex, psState=psState, snmpTrapSrvTable=snmpTrapSrvTable, sysReleaseDate=sysReleaseDate, sysBootCount=sysBootCount, psBusIndex=psBusIndex, psManufacturer=psManufacturer, snmpTrapSrvObj=snmpTrapSrvObj, sysDescr=sysDescr, advantechCommonMIB=advantechCommonMIB, sysBootTime=sysBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, psIndex=psIndex, psLocation=psLocation, snmpTrapVersion=snmpTrapVersion, psModuleType=psModuleType, psBaseAddress=psBaseAddress, psNumber=psNumber, PYSNMP_MODULE_ID=advantechCommonMIB, psClassCode=psClassCode, psModulePorts=psModulePorts, snmpTrapSrvPort=snmpTrapSrvPort)
