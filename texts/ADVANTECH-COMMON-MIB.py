...
Integer32, enterprises, TimeTicks, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Gauge32, Bits, NotificationType, MibIdentifier, Counter64, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "TimeTicks", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Gauge32", "Bits", "NotificationType", "MibIdentifier", "Counter64", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, pciSlotEntry=pciSlotEntry, snmpTrapSrvIP=snmpTrapSrvIP, psManufacturer=psManufacturer, psDeviceID=psDeviceID, psIRQ=psIRQ, psLength=psLength, psNumber=psNumber, psDescr=psDescr, atPciConfig=atPciConfig, pciConfigObj=pciConfigObj, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotTable=pciSlotTable, psBusIndex=psBusIndex, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, advantech=advantech, atSystem=atSystem, psDisplayName=psDisplayName, psVendorID=psVendorID, psClassCode=psClassCode, psLocation=psLocation, sysImageVersion=sysImageVersion, psSubsysDeviceID=psSubsysDeviceID, sysFirstBootTime=sysFirstBootTime, psModulePorts=psModulePorts, atMgmt=atMgmt, snmpTrapSrvPort=snmpTrapSrvPort, psBaseAddress=psBaseAddress, advantechCommonMIB=advantechCommonMIB, PYSNMP_MODULE_ID=advantechCommonMIB, sysReleaseDate=sysReleaseDate, sysBootTime=sysBootTime, sysDescr=sysDescr, psModuleType=psModuleType, sysBootCount=sysBootCount, sysDeviceName=sysDeviceName, psIndex=psIndex, psFunctionIndex=psFunctionIndex, psState=psState)
