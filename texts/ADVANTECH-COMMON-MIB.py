...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLength=psLength, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, psDescr=psDescr, psModuleType=psModuleType, sysDeviceName=sysDeviceName, atPciConfig=atPciConfig, psBaseAddress=psBaseAddress, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootTime=sysBootTime, psFunctionIndex=psFunctionIndex, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, sysModuleID=sysModuleID, psNumber=psNumber, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapVersion=snmpTrapVersion, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, psModulePorts=psModulePorts, psVendorID=psVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantechCommonMIB=advantechCommonMIB, advantech=advantech, atSystem=atSystem, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, psBusIndex=psBusIndex, pciSlotEntry=pciSlotEntry, psIndex=psIndex, psState=psState, sysBootCount=sysBootCount, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, pciConfigObj=pciConfigObj, psIRQ=psIRQ, psClassCode=psClassCode, psManufacturer=psManufacturer, sysImageVersion=sysImageVersion, psSubsysVendorID=psSubsysVendorID, sysFirstBootTime=sysFirstBootTime, sysDescr=sysDescr, psDeviceID=psDeviceID)
