...
NotificationType, ObjectIdentity, TimeTicks, Counter64, Gauge32, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, ModuleIdentity, IpAddress, Integer32, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "TimeTicks", "Counter64", "Gauge32", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "ModuleIdentity", "IpAddress", "Integer32", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvPort=snmpTrapSrvPort, psBaseAddress=psBaseAddress, psState=psState, snmpTrapSrvTable=snmpTrapSrvTable, psIRQ=psIRQ, psIndex=psIndex, sysBootTime=sysBootTime, sysBootCount=sysBootCount, sysReleaseDate=sysReleaseDate, snmpTrapSrvEntry=snmpTrapSrvEntry, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysVendorID=psSubsysVendorID, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceID=psDeviceID, advantech=advantech, psDisplayName=psDisplayName, pciConfigObj=pciConfigObj, sysDeviceName=sysDeviceName, sysImageVersion=sysImageVersion, psLength=psLength, psNumber=psNumber, psFunctionIndex=psFunctionIndex, sysDescr=sysDescr, psBusIndex=psBusIndex, snmpTrapVersion=snmpTrapVersion, psDeviceIndex=psDeviceIndex, pciSlotTable=pciSlotTable, psSubsysDeviceID=psSubsysDeviceID, psManufacturer=psManufacturer, snmpTrapSrvNumber=snmpTrapSrvNumber, atSystem=atSystem, psVendorID=psVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, sysModuleID=sysModuleID, atPciConfig=atPciConfig, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, psClassCode=psClassCode, pciSlotEntry=pciSlotEntry, psDescr=psDescr, sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt)
