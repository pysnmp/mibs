...
NotificationType, Counter64, ObjectIdentity, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Counter32, IpAddress, Gauge32, MibIdentifier, Integer32, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "ObjectIdentity", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Counter32", "IpAddress", "Gauge32", "MibIdentifier", "Integer32", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDeviceIndex=psDeviceIndex, sysFirstBootTime=sysFirstBootTime, psFunctionIndex=psFunctionIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvObj=snmpTrapSrvObj, pciConfigObj=pciConfigObj, psNumber=psNumber, sysDeviceName=sysDeviceName, snmpTrapSrvEntry=snmpTrapSrvEntry, psDescr=psDescr, psModuleType=psModuleType, sysModuleID=sysModuleID, sysReleaseDate=sysReleaseDate, snmpTrapSrvNumber=snmpTrapSrvNumber, psIndex=psIndex, pciSlotEntry=pciSlotEntry, psIRQ=psIRQ, snmpTrapSrvPort=snmpTrapSrvPort, psModulePorts=psModulePorts, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBaseAddress=psBaseAddress, PYSNMP_MODULE_ID=advantechCommonMIB, advantech=advantech, snmpTrapVersion=snmpTrapVersion, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, atPciConfig=atPciConfig, advantechCommonMIB=advantechCommonMIB, psClassCode=psClassCode, psSubsysVendorID=psSubsysVendorID, sysImageVersion=sysImageVersion, atSystem=atSystem, psVendorID=psVendorID, psDisplayName=psDisplayName, psBusIndex=psBusIndex, atMgmt=atMgmt, psDeviceID=psDeviceID, sysDescr=sysDescr, sysBootCount=sysBootCount, psManufacturer=psManufacturer, sysBootTime=sysBootTime, pciSlotTable=pciSlotTable, psSubsysDeviceID=psSubsysDeviceID, psState=psState, psLength=psLength)
