...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Integer32, Bits, Counter64, enterprises, IpAddress, Unsigned32, ModuleIdentity, TimeTicks, iso, Counter32, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Integer32", "Bits", "Counter64", "enterprises", "IpAddress", "Unsigned32", "ModuleIdentity", "TimeTicks", "iso", "Counter32", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, psModulePorts=psModulePorts, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootCount=sysBootCount, psState=psState, pciSlotEntry=pciSlotEntry, sysFirstBootTime=sysFirstBootTime, advantech=advantech, psBusIndex=psBusIndex, psLength=psLength, sysDeviceName=sysDeviceName, psIRQ=psIRQ, atMgmt=atMgmt, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysDeviceID=psSubsysDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, sysModuleID=sysModuleID, atPciConfig=atPciConfig, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, psDeviceIndex=psDeviceIndex, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, sysImageVersion=sysImageVersion, sysBootTime=sysBootTime, pciConfigObj=pciConfigObj, psIndex=psIndex, psDisplayName=psDisplayName, psDescr=psDescr, psDeviceID=psDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvIndex=snmpTrapSrvIndex, sysReleaseDate=sysReleaseDate, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysVendorID=psSubsysVendorID, psBaseAddress=psBaseAddress, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, psFunctionIndex=psFunctionIndex, psClassCode=psClassCode, psVendorID=psVendorID, psModuleType=psModuleType, psNumber=psNumber, snmpTrapSrvNumber=snmpTrapSrvNumber)
