...
enterprises, NotificationType, iso, Counter64, Counter32, Gauge32, MibIdentifier, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, ModuleIdentity, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "iso", "Counter64", "Counter32", "Gauge32", "MibIdentifier", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciConfigObj=pciConfigObj, atPciConfig=atPciConfig, sysBootTime=sysBootTime, psSubsysVendorID=psSubsysVendorID, psBaseAddress=psBaseAddress, psNumber=psNumber, psFunctionIndex=psFunctionIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceID=psDeviceID, psManufacturer=psManufacturer, psVendorID=psVendorID, sysBootCount=sysBootCount, psDeviceIndex=psDeviceIndex, snmpTrapVersion=snmpTrapVersion, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, psBusIndex=psBusIndex, psModulePorts=psModulePorts, psState=psState, PYSNMP_MODULE_ID=advantechCommonMIB, sysImageVersion=sysImageVersion, atMgmt=atMgmt, sysModuleID=sysModuleID, advantech=advantech, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotTable=pciSlotTable, psSubsysDeviceID=psSubsysDeviceID, atSystem=atSystem, sysReleaseDate=sysReleaseDate, snmpTrapSrvTable=snmpTrapSrvTable, sysFirstBootTime=sysFirstBootTime, sysDescr=sysDescr, pciSlotEntry=pciSlotEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvPort=snmpTrapSrvPort, psIRQ=psIRQ, psLocation=psLocation, psLength=psLength, psClassCode=psClassCode, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDeviceName=sysDeviceName, psDisplayName=psDisplayName, psIndex=psIndex, psModuleType=psModuleType, snmpTrapSrvIP=snmpTrapSrvIP, psDescr=psDescr)
