...
TimeTicks, ObjectIdentity, enterprises, Counter32, iso, Bits, Integer32, Gauge32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "enterprises", "Counter32", "iso", "Bits", "Integer32", "Gauge32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psState=psState, psLocation=psLocation, psLength=psLength, psDisplayName=psDisplayName, psManufacturer=psManufacturer, atMgmt=atMgmt, psDeviceID=psDeviceID, sysBootTime=sysBootTime, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, psFunctionIndex=psFunctionIndex, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, pciConfigObj=pciConfigObj, psDeviceIndex=psDeviceIndex, psBaseAddress=psBaseAddress, sysDescr=sysDescr, sysFirstBootTime=sysFirstBootTime, psVendorID=psVendorID, snmpTrapVersion=snmpTrapVersion, advantechCommonMIB=advantechCommonMIB, psNumber=psNumber, PYSNMP_MODULE_ID=advantechCommonMIB, psIndex=psIndex, sysReleaseDate=sysReleaseDate, psIRQ=psIRQ, psClassCode=psClassCode, pciSlotTable=pciSlotTable, atPciConfig=atPciConfig, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysModuleID=sysModuleID, psDescr=psDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysVendorID=psSubsysVendorID, sysBootCount=sysBootCount, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, advantech=advantech, snmpTrapSrvNumber=snmpTrapSrvNumber, psModuleType=psModuleType, snmpTrapSrvPort=snmpTrapSrvPort, psBusIndex=psBusIndex, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj)
