...
Bits, Counter32, ObjectIdentity, iso, ModuleIdentity, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, MibIdentifier, Counter64, Gauge32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "ObjectIdentity", "iso", "ModuleIdentity", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "MibIdentifier", "Counter64", "Gauge32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDeviceID=psDeviceID, snmpTrapSrvIP=snmpTrapSrvIP, psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, snmpTrapVersion=snmpTrapVersion, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceIndex=psDeviceIndex, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, psManufacturer=psManufacturer, psIndex=psIndex, psBaseAddress=psBaseAddress, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvTable=snmpTrapSrvTable, psModulePorts=psModulePorts, psVendorID=psVendorID, psIRQ=psIRQ, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDescr=sysDescr, atSystem=atSystem, psNumber=psNumber, atMgmt=atMgmt, sysImageVersion=sysImageVersion, snmpTrapSrvObj=snmpTrapSrvObj, sysBootTime=sysBootTime, atPciConfig=atPciConfig, pciSlotTable=pciSlotTable, sysModuleID=sysModuleID, psLength=psLength, psModuleType=psModuleType, snmpTrapSrvEntry=snmpTrapSrvEntry, PYSNMP_MODULE_ID=advantechCommonMIB, sysReleaseDate=sysReleaseDate, sysBootCount=sysBootCount, snmpTrapSrvNumber=snmpTrapSrvNumber, sysFirstBootTime=sysFirstBootTime, psDescr=psDescr, psLocation=psLocation, sysDeviceName=sysDeviceName, psClassCode=psClassCode, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, advantech=advantech, psState=psState)
