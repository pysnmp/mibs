...
Gauge32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Counter32, iso, NotificationType, Unsigned32, MibIdentifier, TimeTicks, Integer32, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Counter32", "iso", "NotificationType", "Unsigned32", "MibIdentifier", "TimeTicks", "Integer32", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", PYSNMP_MODULE_ID=advantechCommonMIB, psBaseAddress=psBaseAddress, sysModuleID=sysModuleID, psDisplayName=psDisplayName, psIRQ=psIRQ, advantechCommonMIB=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, psLength=psLength, psClassCode=psClassCode, psNumber=psNumber, snmpTrapSrvObj=snmpTrapSrvObj, sysDescr=sysDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, psModuleType=psModuleType, sysReleaseDate=sysReleaseDate, sysImageVersion=sysImageVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psFunctionIndex=psFunctionIndex, psSubsysVendorID=psSubsysVendorID, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvPort=snmpTrapSrvPort, psIndex=psIndex, psState=psState, atPciConfig=atPciConfig, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, psVendorID=psVendorID, psModulePorts=psModulePorts, snmpTrapSrvNumber=snmpTrapSrvNumber, sysFirstBootTime=sysFirstBootTime, psLocation=psLocation, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, snmpTrapSrvIP=snmpTrapSrvIP, advantech=advantech, sysBootTime=sysBootTime, pciSlotTable=pciSlotTable, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, atSystem=atSystem, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, psDeviceID=psDeviceID)
