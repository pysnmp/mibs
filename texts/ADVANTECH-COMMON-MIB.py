...
TimeTicks, NotificationType, Gauge32, IpAddress, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, Integer32, ObjectIdentity, Counter32, Counter64, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Gauge32", "IpAddress", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "Integer32", "ObjectIdentity", "Counter32", "Counter64", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDeviceName=sysDeviceName, sysDescr=sysDescr, advantechCommonMIB=advantechCommonMIB, atPciConfig=atPciConfig, psManufacturer=psManufacturer, psIRQ=psIRQ, sysReleaseDate=sysReleaseDate, pciSlotTable=pciSlotTable, sysFirstBootTime=sysFirstBootTime, psIndex=psIndex, psBusIndex=psBusIndex, snmpTrapVersion=snmpTrapVersion, psDeviceID=psDeviceID, atSystem=atSystem, PYSNMP_MODULE_ID=advantechCommonMIB, atMgmt=atMgmt, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysImageVersion=sysImageVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotEntry=pciSlotEntry, psLength=psLength, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootCount=sysBootCount, psDescr=psDescr, psSubsysVendorID=psSubsysVendorID, advantech=advantech, psBaseAddress=psBaseAddress, psClassCode=psClassCode, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, psModuleType=psModuleType, sysBootTime=sysBootTime, sysModuleID=sysModuleID, psState=psState, pciConfigObj=pciConfigObj, psFunctionIndex=psFunctionIndex, psModulePorts=psModulePorts, psNumber=psNumber, psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, psLocation=psLocation, psVendorID=psVendorID)
