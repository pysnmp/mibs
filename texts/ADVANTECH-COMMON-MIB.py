...
Bits, Counter64, NotificationType, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, Integer32, Unsigned32, ModuleIdentity, iso, IpAddress, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "NotificationType", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "Integer32", "Unsigned32", "ModuleIdentity", "iso", "IpAddress", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDeviceID=psDeviceID, psModulePorts=psModulePorts, sysReleaseDate=sysReleaseDate, snmpTrapSrvTable=snmpTrapSrvTable, psLocation=psLocation, pciConfigObj=pciConfigObj, snmpTrapSrvPort=snmpTrapSrvPort, psDisplayName=psDisplayName, sysImageVersion=sysImageVersion, psClassCode=psClassCode, snmpTrapSrvObj=snmpTrapSrvObj, sysModuleID=sysModuleID, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, pciSlotTable=pciSlotTable, sysBootTime=sysBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, psModuleType=psModuleType, psIndex=psIndex, psIRQ=psIRQ, psBaseAddress=psBaseAddress, psDeviceIndex=psDeviceIndex, atMgmt=atMgmt, psManufacturer=psManufacturer, snmpTrapSrvNumber=snmpTrapSrvNumber, atPciConfig=atPciConfig, psDescr=psDescr, snmpTrapSrvIP=snmpTrapSrvIP, sysDescr=sysDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, sysFirstBootTime=sysFirstBootTime, psLength=psLength, advantech=advantech, sysBootCount=sysBootCount, snmpTrapSrvIndex=snmpTrapSrvIndex, advantechCommonMIB=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, psFunctionIndex=psFunctionIndex, psSubsysVendorID=psSubsysVendorID, sysDeviceName=sysDeviceName, psState=psState, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psVendorID=psVendorID)
