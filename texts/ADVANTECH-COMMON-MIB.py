...
Counter32, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Bits, Counter64, iso, ObjectIdentity, enterprises, ModuleIdentity, TimeTicks, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Bits", "Counter64", "iso", "ObjectIdentity", "enterprises", "ModuleIdentity", "TimeTicks", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDescr=psDescr, psBusIndex=psBusIndex, psDeviceID=psDeviceID, advantechCommonMIB=advantechCommonMIB, psIRQ=psIRQ, sysBootTime=sysBootTime, atPciConfig=atPciConfig, psBaseAddress=psBaseAddress, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, psFunctionIndex=psFunctionIndex, snmpTrapSrvPort=snmpTrapSrvPort, sysDeviceName=sysDeviceName, psModulePorts=psModulePorts, psState=psState, sysReleaseDate=sysReleaseDate, psLocation=psLocation, sysModuleID=sysModuleID, psDeviceIndex=psDeviceIndex, psDisplayName=psDisplayName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvNumber=snmpTrapSrvNumber, sysImageVersion=sysImageVersion, sysDescr=sysDescr, sysBootCount=sysBootCount, snmpTrapSrvTable=snmpTrapSrvTable, atMgmt=atMgmt, snmpTrapVersion=snmpTrapVersion, psClassCode=psClassCode, psLength=psLength, snmpTrapSrvObj=snmpTrapSrvObj, psSubsysVendorID=psSubsysVendorID, sysFirstBootTime=sysFirstBootTime, psSubsysDeviceID=psSubsysDeviceID, pciConfigObj=pciConfigObj, psNumber=psNumber, advantech=advantech, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, psIndex=psIndex, psModuleType=psModuleType, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, psVendorID=psVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity)
