...
Unsigned32, IpAddress, Integer32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, Gauge32, ObjectIdentity, Counter64, enterprises, NotificationType, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Integer32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Counter64", "enterprises", "NotificationType", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, psModulePorts=psModulePorts, sysBootCount=sysBootCount, snmpTrapSrvIP=snmpTrapSrvIP, psIRQ=psIRQ, advantechCommonMIB=advantechCommonMIB, psDeviceID=psDeviceID, sysDescr=sysDescr, psLocation=psLocation, psFunctionIndex=psFunctionIndex, pciConfigObj=pciConfigObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atSystem=atSystem, sysImageVersion=sysImageVersion, psClassCode=psClassCode, psVendorID=psVendorID, psSubsysDeviceID=psSubsysDeviceID, sysBootTime=sysBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceIndex=psDeviceIndex, psBaseAddress=psBaseAddress, pciSlotEntry=pciSlotEntry, atMgmt=atMgmt, sysReleaseDate=sysReleaseDate, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, snmpTrapVersion=snmpTrapVersion, psLength=psLength, snmpTrapSrvEntry=snmpTrapSrvEntry, sysModuleID=sysModuleID, psManufacturer=psManufacturer, psDescr=psDescr, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantech=advantech, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotTable=pciSlotTable, psSubsysVendorID=psSubsysVendorID, psState=psState, sysDeviceName=sysDeviceName, psNumber=psNumber, atPciConfig=atPciConfig, psBusIndex=psBusIndex, psIndex=psIndex)
