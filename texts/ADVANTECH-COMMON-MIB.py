...
ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Counter32, NotificationType, Gauge32, MibIdentifier, iso, ObjectIdentity, Integer32, Bits, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Counter32", "NotificationType", "Gauge32", "MibIdentifier", "iso", "ObjectIdentity", "Integer32", "Bits", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciConfigObj=pciConfigObj, sysFirstBootTime=sysFirstBootTime, psIRQ=psIRQ, sysDeviceName=sysDeviceName, pciSlotTable=pciSlotTable, psDeviceID=psDeviceID, psLocation=psLocation, advantechCommonMIB=advantechCommonMIB, PYSNMP_MODULE_ID=advantechCommonMIB, advantech=advantech, sysModuleID=sysModuleID, sysDescr=sysDescr, psLength=psLength, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, psModuleType=psModuleType, psFunctionIndex=psFunctionIndex, psBusIndex=psBusIndex, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvObj=snmpTrapSrvObj, psNumber=psNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, sysBootCount=sysBootCount, atPciConfig=atPciConfig, psDeviceIndex=psDeviceIndex, snmpTrapSrvPort=snmpTrapSrvPort, atMgmt=atMgmt, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, psSubsysDeviceID=psSubsysDeviceID, psDescr=psDescr, sysBootTime=sysBootTime, psDisplayName=psDisplayName, psClassCode=psClassCode, psVendorID=psVendorID, psIndex=psIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModulePorts=psModulePorts, psBaseAddress=psBaseAddress, psState=psState, psManufacturer=psManufacturer, sysReleaseDate=sysReleaseDate)
