...
Bits, IpAddress, Gauge32, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, enterprises, NotificationType, MibIdentifier, TimeTicks, Counter32, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Gauge32", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "enterprises", "NotificationType", "MibIdentifier", "TimeTicks", "Counter32", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psVendorID=psVendorID, pciConfigObj=pciConfigObj, sysImageVersion=sysImageVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIndex=psIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, psModulePorts=psModulePorts, sysBootTime=sysBootTime, snmpTrapSrvPort=snmpTrapSrvPort, sysDescr=sysDescr, pciSlotTable=pciSlotTable, pciSlotEntry=pciSlotEntry, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIP=snmpTrapSrvIP, psLength=psLength, advantechCommonMIB=advantechCommonMIB, advantech=advantech, atMgmt=atMgmt, psDescr=psDescr, psDeviceID=psDeviceID, psIRQ=psIRQ, snmpTrapSrvTable=snmpTrapSrvTable, sysBootCount=sysBootCount, snmpTrapSrvNumber=snmpTrapSrvNumber, psClassCode=psClassCode, sysModuleID=sysModuleID, psDisplayName=psDisplayName, psFunctionIndex=psFunctionIndex, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, psNumber=psNumber, sysReleaseDate=sysReleaseDate, psManufacturer=psManufacturer, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapVersion=snmpTrapVersion, PYSNMP_MODULE_ID=advantechCommonMIB, psLocation=psLocation, psBaseAddress=psBaseAddress, sysDeviceName=sysDeviceName, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atSystem=atSystem, psModuleType=psModuleType, atPciConfig=atPciConfig, psState=psState)
