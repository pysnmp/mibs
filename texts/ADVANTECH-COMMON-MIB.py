...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, ModuleIdentity, enterprises, IpAddress, iso, Counter64, TimeTicks, MibIdentifier, NotificationType, Gauge32, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "enterprises", "IpAddress", "iso", "Counter64", "TimeTicks", "MibIdentifier", "NotificationType", "Gauge32", "Integer32", "Bits")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDeviceIndex=psDeviceIndex, psFunctionIndex=psFunctionIndex, pciConfigObj=pciConfigObj, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapVersion=snmpTrapVersion, psState=psState, psLocation=psLocation, psModulePorts=psModulePorts, psClassCode=psClassCode, psIndex=psIndex, psIRQ=psIRQ, sysImageVersion=sysImageVersion, sysBootCount=sysBootCount, sysDescr=sysDescr, sysBootTime=sysBootTime, psNumber=psNumber, snmpTrapSrvNumber=snmpTrapSrvNumber, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, psDeviceID=psDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvTable=snmpTrapSrvTable, advantech=advantech, PYSNMP_MODULE_ID=advantechCommonMIB, psDisplayName=psDisplayName, psBaseAddress=psBaseAddress, atSystem=atSystem, sysModuleID=sysModuleID, snmpTrapSrvIndex=snmpTrapSrvIndex, psManufacturer=psManufacturer, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, atMgmt=atMgmt, pciSlotTable=pciSlotTable, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotEntry=pciSlotEntry, psLength=psLength, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIP=snmpTrapSrvIP, sysFirstBootTime=sysFirstBootTime, psVendorID=psVendorID, psDescr=psDescr)
