...
Counter32, ModuleIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, IpAddress, Bits, ObjectIdentity, NotificationType, MibIdentifier, iso, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "IpAddress", "Bits", "ObjectIdentity", "NotificationType", "MibIdentifier", "iso", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, psDisplayName=psDisplayName, snmpTrapSrvTable=snmpTrapSrvTable, psManufacturer=psManufacturer, psBaseAddress=psBaseAddress, psVendorID=psVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, psSubsysDeviceID=psSubsysDeviceID, sysDeviceName=sysDeviceName, psDescr=psDescr, sysImageVersion=sysImageVersion, psClassCode=psClassCode, advantech=advantech, psBusIndex=psBusIndex, psLength=psLength, sysBootCount=sysBootCount, snmpTrapSrvPort=snmpTrapSrvPort, psState=psState, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, atMgmt=atMgmt, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceIndex=psDeviceIndex, psIRQ=psIRQ, psDeviceID=psDeviceID, sysBootTime=sysBootTime, psSubsysVendorID=psSubsysVendorID, sysModuleID=sysModuleID, sysReleaseDate=sysReleaseDate, psIndex=psIndex, sysDescr=sysDescr, pciSlotEntry=pciSlotEntry, pciSlotTable=pciSlotTable, sysFirstBootTime=sysFirstBootTime, atPciConfig=atPciConfig, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIndex=snmpTrapSrvIndex, pciConfigObj=pciConfigObj, psModuleType=psModuleType, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication)
