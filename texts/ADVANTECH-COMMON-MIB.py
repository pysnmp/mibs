...
ObjectIdentity, iso, Unsigned32, TimeTicks, Counter64, ModuleIdentity, enterprises, NotificationType, IpAddress, Gauge32, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Unsigned32", "TimeTicks", "Counter64", "ModuleIdentity", "enterprises", "NotificationType", "IpAddress", "Gauge32", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, psClassCode=psClassCode, advantechCommonMIB=advantechCommonMIB, sysBootCount=sysBootCount, psBusIndex=psBusIndex, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, psIRQ=psIRQ, psBaseAddress=psBaseAddress, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysFirstBootTime=sysFirstBootTime, sysModuleID=sysModuleID, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotEntry=pciSlotEntry, psLocation=psLocation, advantech=advantech, psModuleType=psModuleType, psNumber=psNumber, psDescr=psDescr, psDeviceIndex=psDeviceIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength, psManufacturer=psManufacturer, psDeviceID=psDeviceID, psState=psState, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapVersion=snmpTrapVersion, sysReleaseDate=sysReleaseDate, snmpTrapSrvObj=snmpTrapSrvObj, pciConfigObj=pciConfigObj, sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotTable=pciSlotTable, snmpTrapSrvPort=snmpTrapSrvPort, atSystem=atSystem, psIndex=psIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, sysDescr=sysDescr, psVendorID=psVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, psFunctionIndex=psFunctionIndex, psDisplayName=psDisplayName, sysImageVersion=sysImageVersion, psModulePorts=psModulePorts)
