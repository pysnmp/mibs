...
ObjectIdentity, IpAddress, Unsigned32, enterprises, Counter32, MibIdentifier, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Gauge32, Counter64, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Unsigned32", "enterprises", "Counter32", "MibIdentifier", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Gauge32", "Counter64", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysDeviceID=psSubsysDeviceID, psState=psState, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, psBusIndex=psBusIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psVendorID=psVendorID, atMgmt=atMgmt, sysImageVersion=sysImageVersion, psBaseAddress=psBaseAddress, psIRQ=psIRQ, psDeviceIndex=psDeviceIndex, pciSlotTable=pciSlotTable, sysBootCount=sysBootCount, snmpTrapSrvIP=snmpTrapSrvIP, pciConfigObj=pciConfigObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, PYSNMP_MODULE_ID=advantechCommonMIB, psNumber=psNumber, snmpTrapVersion=snmpTrapVersion, atSystem=atSystem, psFunctionIndex=psFunctionIndex, psLength=psLength, psSubsysVendorID=psSubsysVendorID, atPciConfig=atPciConfig, sysBootTime=sysBootTime, psDescr=psDescr, psModulePorts=psModulePorts, psLocation=psLocation, advantech=advantech, sysReleaseDate=sysReleaseDate, psDeviceID=psDeviceID, sysModuleID=sysModuleID, sysDescr=sysDescr, psDisplayName=psDisplayName, snmpTrapSrvObj=snmpTrapSrvObj, psManufacturer=psManufacturer, psModuleType=psModuleType, psClassCode=psClassCode, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, snmpTrapSrvPort=snmpTrapSrvPort, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDeviceName=sysDeviceName, pciSlotEntry=pciSlotEntry, snmpTrapSrvNumber=snmpTrapSrvNumber)
