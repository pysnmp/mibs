...
Counter64, Integer32, iso, NotificationType, Bits, MibIdentifier, Gauge32, IpAddress, enterprises, Unsigned32, TimeTicks, ModuleIdentity, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "iso", "NotificationType", "Bits", "MibIdentifier", "Gauge32", "IpAddress", "enterprises", "Unsigned32", "TimeTicks", "ModuleIdentity", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psLocation=psLocation, psDeviceIndex=psDeviceIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atMgmt=atMgmt, pciConfigObj=pciConfigObj, psDeviceID=psDeviceID, sysDescr=sysDescr, psClassCode=psClassCode, psDisplayName=psDisplayName, atSystem=atSystem, psManufacturer=psManufacturer, snmpTrapSrvEntry=snmpTrapSrvEntry, psBaseAddress=psBaseAddress, psLength=psLength, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, sysBootTime=sysBootTime, sysImageVersion=sysImageVersion, snmpTrapSrvTable=snmpTrapSrvTable, psVendorID=psVendorID, psDescr=psDescr, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, sysModuleID=sysModuleID, psFunctionIndex=psFunctionIndex, snmpTrapSrvObj=snmpTrapSrvObj, psIRQ=psIRQ, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, sysDeviceName=sysDeviceName, atPciConfig=atPciConfig, psSubsysDeviceID=psSubsysDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotTable=pciSlotTable, psState=psState, sysReleaseDate=sysReleaseDate, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootCount=sysBootCount)
