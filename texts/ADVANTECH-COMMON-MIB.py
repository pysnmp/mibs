...
IpAddress, ModuleIdentity, Gauge32, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, ObjectIdentity, MibIdentifier, Bits, Counter32, Unsigned32, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Gauge32", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Bits", "Counter32", "Unsigned32", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIndex=snmpTrapSrvIndex, psState=psState, snmpTrapSrvEntry=snmpTrapSrvEntry, PYSNMP_MODULE_ID=advantechCommonMIB, sysDeviceName=sysDeviceName, psBaseAddress=psBaseAddress, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIP=snmpTrapSrvIP, psFunctionIndex=psFunctionIndex, sysFirstBootTime=sysFirstBootTime, psManufacturer=psManufacturer, psSubsysVendorID=psSubsysVendorID, snmpTrapVersion=snmpTrapVersion, atPciConfig=atPciConfig, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLocation=psLocation, advantechCommonMIB=advantechCommonMIB, sysImageVersion=sysImageVersion, psDescr=psDescr, psIRQ=psIRQ, pciConfigObj=pciConfigObj, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName, sysModuleID=sysModuleID, psBusIndex=psBusIndex, atSystem=atSystem, pciSlotEntry=pciSlotEntry, sysBootTime=sysBootTime, psClassCode=psClassCode, psIndex=psIndex, psVendorID=psVendorID, advantech=advantech, psDeviceIndex=psDeviceIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, sysReleaseDate=sysReleaseDate, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, psDeviceID=psDeviceID, sysDescr=sysDescr, psLength=psLength, sysBootCount=sysBootCount, psModuleType=psModuleType, pciSlotTable=pciSlotTable, psNumber=psNumber, snmpTrapSrvPort=snmpTrapSrvPort)
