...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, TimeTicks, Bits, NotificationType, MibIdentifier, iso, Integer32, ModuleIdentity, Gauge32, Unsigned32, Counter32, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "TimeTicks", "Bits", "NotificationType", "MibIdentifier", "iso", "Integer32", "ModuleIdentity", "Gauge32", "Unsigned32", "Counter32", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, psState=psState, sysDeviceName=sysDeviceName, sysBootTime=sysBootTime, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, psFunctionIndex=psFunctionIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvTable=snmpTrapSrvTable, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, atPciConfig=atPciConfig, snmpTrapSrvEntry=snmpTrapSrvEntry, atSystem=atSystem, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysDeviceID=psSubsysDeviceID, psIndex=psIndex, psDeviceID=psDeviceID, advantech=advantech, psLocation=psLocation, sysBootCount=sysBootCount, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapVersion=snmpTrapVersion, pciSlotTable=pciSlotTable, psClassCode=psClassCode, sysReleaseDate=sysReleaseDate, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotEntry=pciSlotEntry, psManufacturer=psManufacturer, psBaseAddress=psBaseAddress, snmpTrapSrvIP=snmpTrapSrvIP, psVendorID=psVendorID, sysDescr=sysDescr, sysImageVersion=sysImageVersion, psBusIndex=psBusIndex, psDeviceIndex=psDeviceIndex, psIRQ=psIRQ, psNumber=psNumber, psModulePorts=psModulePorts, psLength=psLength)
