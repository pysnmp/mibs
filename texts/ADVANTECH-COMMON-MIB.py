...
# Produced by pysmi-1.1.0 at Fri Nov 19 14:46:09 2021
...
Counter64, ObjectIdentity, Integer32, NotificationType, TimeTicks, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Counter32, iso, enterprises, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "Integer32", "NotificationType", "TimeTicks", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Counter32", "iso", "enterprises", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psState=psState, psVendorID=psVendorID, sysReleaseDate=sysReleaseDate, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, sysImageVersion=sysImageVersion, psFunctionIndex=psFunctionIndex, psDeviceIndex=psDeviceIndex, atSystem=atSystem, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapVersion=snmpTrapVersion, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootTime=sysBootTime, psLocation=psLocation, atPciConfig=atPciConfig, psSubsysVendorID=psSubsysVendorID, psBaseAddress=psBaseAddress, pciSlotEntry=pciSlotEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, psManufacturer=psManufacturer, psIRQ=psIRQ, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, pciConfigObj=pciConfigObj, sysDescr=sysDescr, atMgmt=atMgmt, psClassCode=psClassCode, pciSlotTable=pciSlotTable, psModuleType=psModuleType, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDescr=psDescr, sysFirstBootTime=sysFirstBootTime, psModulePorts=psModulePorts, snmpTrapSrvPort=snmpTrapSrvPort, psBusIndex=psBusIndex, advantech=advantech, psLength=psLength, advantechCommonMIB=advantechCommonMIB, sysBootCount=sysBootCount, psDisplayName=psDisplayName, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIP=snmpTrapSrvIP, psIndex=psIndex, psNumber=psNumber, sysModuleID=sysModuleID)
