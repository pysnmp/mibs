...
enterprises, Counter64, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Gauge32, IpAddress, Bits, Unsigned32, ObjectIdentity, ModuleIdentity, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Gauge32", "IpAddress", "Bits", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, psDescr=psDescr, psBaseAddress=psBaseAddress, atMgmt=atMgmt, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvPort=snmpTrapSrvPort, psVendorID=psVendorID, sysFirstBootTime=sysFirstBootTime, sysBootCount=sysBootCount, psNumber=psNumber, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceID=psDeviceID, psLength=psLength, psLocation=psLocation, snmpTrapSrvNumber=snmpTrapSrvNumber, psIndex=psIndex, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, sysModuleID=sysModuleID, sysImageVersion=sysImageVersion, atSystem=atSystem, pciSlotTable=pciSlotTable, psFunctionIndex=psFunctionIndex, pciSlotEntry=pciSlotEntry, sysReleaseDate=sysReleaseDate, snmpTrapVersion=snmpTrapVersion, psState=psState, psDeviceIndex=psDeviceIndex, psModulePorts=psModulePorts, psClassCode=psClassCode, psBusIndex=psBusIndex, atPciConfig=atPciConfig, psManufacturer=psManufacturer, sysDescr=sysDescr, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvTable=snmpTrapSrvTable, psDisplayName=psDisplayName, psIRQ=psIRQ, snmpTrapSrvEntry=snmpTrapSrvEntry, pciConfigObj=pciConfigObj, psModuleType=psModuleType, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvCommunity=snmpTrapSrvCommunity)
