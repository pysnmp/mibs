...
# Produced by pysmi-1.1.12 at Wed Dec  4 17:50:47 2024
...
ModuleIdentity, Gauge32, Bits, Counter64, MibIdentifier, Unsigned32, Counter32, IpAddress, TimeTicks, iso, NotificationType, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Bits", "Counter64", "MibIdentifier", "Unsigned32", "Counter32", "IpAddress", "TimeTicks", "iso", "NotificationType", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atPciConfig=atPciConfig, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, psIRQ=psIRQ, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvTable=snmpTrapSrvTable, psDeviceID=psDeviceID, sysReleaseDate=sysReleaseDate, psManufacturer=psManufacturer, atMgmt=atMgmt, sysFirstBootTime=sysFirstBootTime, psBaseAddress=psBaseAddress, snmpTrapSrvObj=snmpTrapSrvObj, psDescr=psDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, pciConfigObj=pciConfigObj, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvPort=snmpTrapSrvPort, psIndex=psIndex, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, sysModuleID=sysModuleID, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, psNumber=psNumber, sysDescr=sysDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModulePorts=psModulePorts, psBusIndex=psBusIndex, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, psState=psState, psModuleType=psModuleType, psSubsysDeviceID=psSubsysDeviceID, psDeviceIndex=psDeviceIndex, psLength=psLength, psLocation=psLocation, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psClassCode=psClassCode, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, sysBootTime=sysBootTime, advantech=advantech, sysImageVersion=sysImageVersion)
