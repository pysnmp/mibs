...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, sysImageVersion=sysImageVersion, psBaseAddress=psBaseAddress, psDeviceIndex=psDeviceIndex, psSubsysVendorID=psSubsysVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, psClassCode=psClassCode, advantechCommonMIB=advantechCommonMIB, psDeviceID=psDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atMgmt=atMgmt, psSubsysDeviceID=psSubsysDeviceID, psManufacturer=psManufacturer, sysBootTime=sysBootTime, psLength=psLength, psLocation=psLocation, sysFirstBootTime=sysFirstBootTime, psModulePorts=psModulePorts, psVendorID=psVendorID, atPciConfig=atPciConfig, psModuleType=psModuleType, pciSlotEntry=pciSlotEntry, advantech=advantech, snmpTrapSrvPort=snmpTrapSrvPort, sysDeviceName=sysDeviceName, psFunctionIndex=psFunctionIndex, psNumber=psNumber, psDescr=psDescr, psState=psState, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciConfigObj=pciConfigObj, snmpTrapSrvNumber=snmpTrapSrvNumber, sysModuleID=sysModuleID, psDisplayName=psDisplayName, psIndex=psIndex, psBusIndex=psBusIndex, sysBootCount=sysBootCount, sysReleaseDate=sysReleaseDate, psIRQ=psIRQ, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotTable=pciSlotTable, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvTable=snmpTrapSrvTable)
