...
Bits, Counter32, iso, Counter64, Unsigned32, IpAddress, Gauge32, NotificationType, ObjectIdentity, Integer32, enterprises, TimeTicks, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "iso", "Counter64", "Unsigned32", "IpAddress", "Gauge32", "NotificationType", "ObjectIdentity", "Integer32", "enterprises", "TimeTicks", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvPort=snmpTrapSrvPort, sysBootCount=sysBootCount, sysModuleID=sysModuleID, sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt, sysDeviceName=sysDeviceName, psModuleType=psModuleType, psManufacturer=psManufacturer, psDisplayName=psDisplayName, psIndex=psIndex, sysBootTime=sysBootTime, atPciConfig=atPciConfig, atSystem=atSystem, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysReleaseDate=sysReleaseDate, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysVendorID=psSubsysVendorID, psBaseAddress=psBaseAddress, psState=psState, advantechCommonMIB=advantechCommonMIB, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, sysImageVersion=sysImageVersion, snmpTrapVersion=snmpTrapVersion, psSubsysDeviceID=psSubsysDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, advantech=advantech, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotTable=pciSlotTable, snmpTrapSrvIndex=snmpTrapSrvIndex, psDescr=psDescr, psClassCode=psClassCode, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciConfigObj=pciConfigObj, sysDescr=sysDescr, psIRQ=psIRQ, psLocation=psLocation, psDeviceID=psDeviceID, psModulePorts=psModulePorts, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, psNumber=psNumber, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIP=snmpTrapSrvIP, psLength=psLength, snmpTrapSrvObj=snmpTrapSrvObj)
