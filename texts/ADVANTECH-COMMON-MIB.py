...
ModuleIdentity, Bits, Counter64, MibIdentifier, IpAddress, Gauge32, ObjectIdentity, TimeTicks, iso, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Counter64", "MibIdentifier", "IpAddress", "Gauge32", "ObjectIdentity", "TimeTicks", "iso", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDeviceName=sysDeviceName, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, snmpTrapSrvTable=snmpTrapSrvTable, sysFirstBootTime=sysFirstBootTime, psModulePorts=psModulePorts, atMgmt=atMgmt, psBaseAddress=psBaseAddress, pciConfigObj=pciConfigObj, psClassCode=psClassCode, psNumber=psNumber, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootCount=sysBootCount, sysImageVersion=sysImageVersion, psSubsysDeviceID=psSubsysDeviceID, psLength=psLength, PYSNMP_MODULE_ID=advantechCommonMIB, psState=psState, psModuleType=psModuleType, sysBootTime=sysBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, psIndex=psIndex, psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, psManufacturer=psManufacturer, pciSlotEntry=pciSlotEntry, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, sysReleaseDate=sysReleaseDate, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, advantechCommonMIB=advantechCommonMIB, psLocation=psLocation, psVendorID=psVendorID, atSystem=atSystem, sysModuleID=sysModuleID, psIRQ=psIRQ, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, psSubsysVendorID=psSubsysVendorID, psDescr=psDescr, pciSlotTable=pciSlotTable, advantech=advantech)
