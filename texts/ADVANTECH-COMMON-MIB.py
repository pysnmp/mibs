...
Integer32, NotificationType, iso, Bits, ObjectIdentity, Gauge32, Counter32, enterprises, Unsigned32, ModuleIdentity, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "iso", "Bits", "ObjectIdentity", "Gauge32", "Counter32", "enterprises", "Unsigned32", "ModuleIdentity", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciSlotTable=pciSlotTable, sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, psIndex=psIndex, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceID=psDeviceID, psBaseAddress=psBaseAddress, psBusIndex=psBusIndex, psSubsysVendorID=psSubsysVendorID, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootCount=sysBootCount, sysBootTime=sysBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, psFunctionIndex=psFunctionIndex, sysImageVersion=sysImageVersion, atPciConfig=atPciConfig, psModulePorts=psModulePorts, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvTable=snmpTrapSrvTable, sysReleaseDate=sysReleaseDate, psDescr=psDescr, advantechCommonMIB=advantechCommonMIB, psLocation=psLocation, psLength=psLength, psIRQ=psIRQ, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psState=psState, atMgmt=atMgmt, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, psVendorID=psVendorID, psDisplayName=psDisplayName, sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvNumber=snmpTrapSrvNumber, advantech=advantech, sysModuleID=sysModuleID, pciConfigObj=pciConfigObj, psManufacturer=psManufacturer, psClassCode=psClassCode, atSystem=atSystem, psModuleType=psModuleType, sysDeviceName=sysDeviceName, psNumber=psNumber)
