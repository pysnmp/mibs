...
# Produced by pysmi-1.1.3 at Tue Dec  7 14:18:18 2021
...
Bits, ModuleIdentity, Counter32, ObjectIdentity, iso, Gauge32, Counter64, TimeTicks, enterprises, NotificationType, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Counter32", "ObjectIdentity", "iso", "Gauge32", "Counter64", "TimeTicks", "enterprises", "NotificationType", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysDeviceID=psSubsysDeviceID, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysReleaseDate=sysReleaseDate, psDeviceIndex=psDeviceIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceID=psDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, sysImageVersion=sysImageVersion, pciSlotTable=pciSlotTable, sysDeviceName=sysDeviceName, snmpTrapSrvNumber=snmpTrapSrvNumber, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvTable=snmpTrapSrvTable, atPciConfig=atPciConfig, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIndex=psIndex, psLocation=psLocation, sysModuleID=sysModuleID, sysBootCount=sysBootCount, psVendorID=psVendorID, snmpTrapVersion=snmpTrapVersion, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts, psIRQ=psIRQ, psLength=psLength, snmpTrapSrvIP=snmpTrapSrvIP, psModuleType=psModuleType, psFunctionIndex=psFunctionIndex, sysDescr=sysDescr, psDescr=psDescr, advantech=advantech, psNumber=psNumber, psManufacturer=psManufacturer, psState=psState, atSystem=atSystem, psClassCode=psClassCode, psDisplayName=psDisplayName, pciSlotEntry=pciSlotEntry, advantechCommonMIB=advantechCommonMIB, sysBootTime=sysBootTime, snmpTrapSrvPort=snmpTrapSrvPort, atMgmt=atMgmt, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvObj=snmpTrapSrvObj)
