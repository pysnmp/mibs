...
enterprises, Counter32, IpAddress, Gauge32, ModuleIdentity, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, TimeTicks, MibIdentifier, iso, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "IpAddress", "Gauge32", "ModuleIdentity", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "TimeTicks", "MibIdentifier", "iso", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atSystem=atSystem, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, sysModuleID=sysModuleID, sysImageVersion=sysImageVersion, sysReleaseDate=sysReleaseDate, psFunctionIndex=psFunctionIndex, snmpTrapVersion=snmpTrapVersion, psState=psState, snmpTrapSrvIndex=snmpTrapSrvIndex, psDisplayName=psDisplayName, psLocation=psLocation, sysBootCount=sysBootCount, snmpTrapSrvEntry=snmpTrapSrvEntry, psVendorID=psVendorID, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength, psClassCode=psClassCode, atPciConfig=atPciConfig, psModuleType=psModuleType, atMgmt=atMgmt, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBaseAddress=psBaseAddress, psManufacturer=psManufacturer, psDeviceIndex=psDeviceIndex, psIndex=psIndex, advantech=advantech, advantechCommonMIB=advantechCommonMIB, psModulePorts=psModulePorts, pciSlotTable=pciSlotTable, sysBootTime=sysBootTime, psDescr=psDescr, psSubsysVendorID=psSubsysVendorID, sysDeviceName=sysDeviceName, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, sysDescr=sysDescr, psNumber=psNumber, psDeviceID=psDeviceID, pciConfigObj=pciConfigObj, psIRQ=psIRQ)
