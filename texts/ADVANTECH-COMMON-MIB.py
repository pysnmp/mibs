...
MibIdentifier, Bits, Counter32, NotificationType, enterprises, iso, Counter64, ObjectIdentity, Gauge32, ModuleIdentity, Unsigned32, IpAddress, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Counter32", "NotificationType", "enterprises", "iso", "Counter64", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Unsigned32", "IpAddress", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atPciConfig=atPciConfig, psIndex=psIndex, psModulePorts=psModulePorts, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysModuleID=sysModuleID, sysBootTime=sysBootTime, snmpTrapSrvIP=snmpTrapSrvIP, sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, psModuleType=psModuleType, psNumber=psNumber, atSystem=atSystem, psBusIndex=psBusIndex, psVendorID=psVendorID, psDescr=psDescr, psSubsysVendorID=psSubsysVendorID, snmpTrapVersion=snmpTrapVersion, psDeviceID=psDeviceID, psManufacturer=psManufacturer, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotTable=pciSlotTable, snmpTrapSrvEntry=snmpTrapSrvEntry, psIRQ=psIRQ, psDisplayName=psDisplayName, sysImageVersion=sysImageVersion, sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, psBaseAddress=psBaseAddress, psLength=psLength, pciSlotEntry=pciSlotEntry, advantechCommonMIB=advantechCommonMIB, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, psFunctionIndex=psFunctionIndex, psState=psState, advantech=advantech, sysDeviceName=sysDeviceName, sysReleaseDate=sysReleaseDate, psClassCode=psClassCode, psLocation=psLocation, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvNumber=snmpTrapSrvNumber, sysFirstBootTime=sysFirstBootTime, psSubsysDeviceID=psSubsysDeviceID)
