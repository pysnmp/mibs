...
Integer32, IpAddress, MibIdentifier, Unsigned32, Bits, iso, TimeTicks, NotificationType, Counter64, enterprises, Counter32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "MibIdentifier", "Unsigned32", "Bits", "iso", "TimeTicks", "NotificationType", "Counter64", "enterprises", "Counter32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psLocation=psLocation, psModulePorts=psModulePorts, psDeviceID=psDeviceID, sysDeviceName=sysDeviceName, psManufacturer=psManufacturer, snmpTrapSrvIndex=snmpTrapSrvIndex, sysReleaseDate=sysReleaseDate, psSubsysVendorID=psSubsysVendorID, psDescr=psDescr, snmpTrapSrvIP=snmpTrapSrvIP, sysBootTime=sysBootTime, atMgmt=atMgmt, pciSlotTable=pciSlotTable, psSubsysDeviceID=psSubsysDeviceID, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysModuleID=sysModuleID, psIRQ=psIRQ, atPciConfig=atPciConfig, psNumber=psNumber, snmpTrapSrvPort=snmpTrapSrvPort, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, sysFirstBootTime=sysFirstBootTime, advantech=advantech, sysDescr=sysDescr, pciConfigObj=pciConfigObj, atSystem=atSystem, sysBootCount=sysBootCount, psIndex=psIndex, psState=psState, snmpTrapSrvTable=snmpTrapSrvTable, PYSNMP_MODULE_ID=advantechCommonMIB, psVendorID=psVendorID, psDisplayName=psDisplayName, psClassCode=psClassCode, psDeviceIndex=psDeviceIndex, psLength=psLength, sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotEntry=pciSlotEntry, psBaseAddress=psBaseAddress, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex)
