...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:31:25 2021
...
IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, MibIdentifier, ModuleIdentity, Counter64, enterprises, NotificationType, ObjectIdentity, iso, Unsigned32, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "MibIdentifier", "ModuleIdentity", "Counter64", "enterprises", "NotificationType", "ObjectIdentity", "iso", "Unsigned32", "Counter32", "Bits")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, sysFirstBootTime=sysFirstBootTime, atSystem=atSystem, sysBootCount=sysBootCount, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvObj=snmpTrapSrvObj, psModulePorts=psModulePorts, sysDeviceName=sysDeviceName, psManufacturer=psManufacturer, psNumber=psNumber, psDisplayName=psDisplayName, atPciConfig=atPciConfig, atMgmt=atMgmt, psIndex=psIndex, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBaseAddress=psBaseAddress, psLocation=psLocation, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, psDeviceID=psDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, psModuleType=psModuleType, psLength=psLength, sysDescr=sysDescr, advantech=advantech, pciSlotTable=pciSlotTable, snmpTrapVersion=snmpTrapVersion, psBusIndex=psBusIndex, psClassCode=psClassCode, PYSNMP_MODULE_ID=advantechCommonMIB, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, pciConfigObj=pciConfigObj, pciSlotEntry=pciSlotEntry, snmpTrapSrvTable=snmpTrapSrvTable, psState=psState, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDescr=psDescr, psSubsysVendorID=psSubsysVendorID, sysModuleID=sysModuleID, sysImageVersion=sysImageVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, psIRQ=psIRQ, sysBootTime=sysBootTime, sysReleaseDate=sysReleaseDate)
