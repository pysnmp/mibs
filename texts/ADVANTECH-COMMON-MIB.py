...
ModuleIdentity, Counter32, NotificationType, Gauge32, ObjectIdentity, enterprises, Counter64, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, MibIdentifier, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "NotificationType", "Gauge32", "ObjectIdentity", "enterprises", "Counter64", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "MibIdentifier", "iso", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psVendorID=psVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, sysDeviceName=sysDeviceName, pciSlotTable=pciSlotTable, psManufacturer=psManufacturer, pciConfigObj=pciConfigObj, psBaseAddress=psBaseAddress, snmpTrapVersion=snmpTrapVersion, psIRQ=psIRQ, sysImageVersion=sysImageVersion, psClassCode=psClassCode, sysReleaseDate=sysReleaseDate, psLength=psLength, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, psSubsysVendorID=psSubsysVendorID, psModuleType=psModuleType, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDescr=sysDescr, sysModuleID=sysModuleID, psNumber=psNumber, sysBootCount=sysBootCount, psDeviceIndex=psDeviceIndex, atSystem=atSystem, psIndex=psIndex, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotEntry=pciSlotEntry, atMgmt=atMgmt, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvEntry=snmpTrapSrvEntry, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIndex=snmpTrapSrvIndex, psBusIndex=psBusIndex, advantech=advantech, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psState=psState, sysFirstBootTime=sysFirstBootTime, psDescr=psDescr, advantechCommonMIB=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, atPciConfig=atPciConfig)
