...
TimeTicks, ModuleIdentity, MibIdentifier, Counter64, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Bits, Unsigned32, IpAddress, ObjectIdentity, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Counter64", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Bits", "Unsigned32", "IpAddress", "ObjectIdentity", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psVendorID=psVendorID, snmpTrapVersion=snmpTrapVersion, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, atPciConfig=atPciConfig, psModuleType=psModuleType, snmpTrapSrvTable=snmpTrapSrvTable, psDescr=psDescr, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceIndex=psDeviceIndex, atSystem=atSystem, advantech=advantech, sysDescr=sysDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psState=psState, psLength=psLength, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psNumber=psNumber, sysModuleID=sysModuleID, snmpTrapSrvIndex=snmpTrapSrvIndex, atMgmt=atMgmt, psSubsysVendorID=psSubsysVendorID, psIndex=psIndex, psIRQ=psIRQ, snmpTrapSrvObj=snmpTrapSrvObj, psBaseAddress=psBaseAddress, sysBootCount=sysBootCount, pciSlotTable=pciSlotTable, psSubsysDeviceID=psSubsysDeviceID, advantechCommonMIB=advantechCommonMIB, psManufacturer=psManufacturer, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvPort=snmpTrapSrvPort, sysImageVersion=sysImageVersion, sysDeviceName=sysDeviceName, psModulePorts=psModulePorts, sysReleaseDate=sysReleaseDate, sysBootTime=sysBootTime, psClassCode=psClassCode, psDeviceID=psDeviceID, psFunctionIndex=psFunctionIndex, pciConfigObj=pciConfigObj, psDisplayName=psDisplayName)
