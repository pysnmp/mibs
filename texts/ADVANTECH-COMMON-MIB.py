...
TimeTicks, ObjectIdentity, NotificationType, Integer32, MibIdentifier, Counter64, enterprises, Bits, Gauge32, ModuleIdentity, Unsigned32, IpAddress, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "NotificationType", "Integer32", "MibIdentifier", "Counter64", "enterprises", "Bits", "Gauge32", "ModuleIdentity", "Unsigned32", "IpAddress", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atMgmt=atMgmt, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, sysFirstBootTime=sysFirstBootTime, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, sysReleaseDate=sysReleaseDate, psState=psState, pciConfigObj=pciConfigObj, sysModuleID=sysModuleID, psDeviceID=psDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootCount=sysBootCount, psIRQ=psIRQ, psDescr=psDescr, psModuleType=psModuleType, atPciConfig=atPciConfig, psModulePorts=psModulePorts, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotEntry=pciSlotEntry, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psVendorID=psVendorID, advantech=advantech, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDeviceName=sysDeviceName, psDisplayName=psDisplayName, snmpTrapSrvEntry=snmpTrapSrvEntry, psManufacturer=psManufacturer, psLength=psLength, advantechCommonMIB=advantechCommonMIB, psDeviceIndex=psDeviceIndex, psFunctionIndex=psFunctionIndex, sysBootTime=sysBootTime, psIndex=psIndex, psNumber=psNumber, psClassCode=psClassCode, psLocation=psLocation, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysVendorID=psSubsysVendorID, sysImageVersion=sysImageVersion, pciSlotTable=pciSlotTable, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysDeviceID=psSubsysDeviceID)
