...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Gauge32, Counter64, IpAddress, Bits, ObjectIdentity, MibIdentifier, iso, enterprises, TimeTicks, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Gauge32", "Counter64", "IpAddress", "Bits", "ObjectIdentity", "MibIdentifier", "iso", "enterprises", "TimeTicks", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciSlotTable=pciSlotTable, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvPort=snmpTrapSrvPort, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psNumber=psNumber, atSystem=atSystem, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, psIRQ=psIRQ, psManufacturer=psManufacturer, pciConfigObj=pciConfigObj, psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvObj=snmpTrapSrvObj, sysModuleID=sysModuleID, sysDescr=sysDescr, sysReleaseDate=sysReleaseDate, snmpTrapVersion=snmpTrapVersion, sysBootTime=sysBootTime, psLength=psLength, psModuleType=psModuleType, psVendorID=psVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, psSubsysDeviceID=psSubsysDeviceID, psDeviceID=psDeviceID, psClassCode=psClassCode, psBaseAddress=psBaseAddress, psFunctionIndex=psFunctionIndex, advantech=advantech, psLocation=psLocation, sysImageVersion=sysImageVersion, atMgmt=atMgmt, psState=psState, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, advantechCommonMIB=advantechCommonMIB, psIndex=psIndex, psDescr=psDescr, psModulePorts=psModulePorts, sysBootCount=sysBootCount)
