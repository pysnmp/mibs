...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:06:35 2022
...
MibIdentifier, ModuleIdentity, Counter64, ObjectIdentity, TimeTicks, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, Integer32, IpAddress, iso, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Counter64", "ObjectIdentity", "TimeTicks", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "Integer32", "IpAddress", "iso", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", PYSNMP_MODULE_ID=advantechCommonMIB, psNumber=psNumber, psManufacturer=psManufacturer, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIP=snmpTrapSrvIP, psIRQ=psIRQ, psIndex=psIndex, psSubsysDeviceID=psSubsysDeviceID, pciSlotTable=pciSlotTable, pciSlotEntry=pciSlotEntry, psLength=psLength, atSystem=atSystem, snmpTrapSrvObj=snmpTrapSrvObj, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, psClassCode=psClassCode, psModuleType=psModuleType, sysBootTime=sysBootTime, psLocation=psLocation, atPciConfig=atPciConfig, atMgmt=atMgmt, psBusIndex=psBusIndex, sysDeviceName=sysDeviceName, psFunctionIndex=psFunctionIndex, psBaseAddress=psBaseAddress, sysBootCount=sysBootCount, psState=psState, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvTable=snmpTrapSrvTable, psDescr=psDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysImageVersion=sysImageVersion, psDisplayName=psDisplayName, sysModuleID=sysModuleID, snmpTrapSrvEntry=snmpTrapSrvEntry, advantechCommonMIB=advantechCommonMIB, advantech=advantech, sysReleaseDate=sysReleaseDate, pciConfigObj=pciConfigObj, psVendorID=psVendorID, psDeviceID=psDeviceID, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication)
