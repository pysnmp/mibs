...
ModuleIdentity, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, Gauge32, enterprises, ObjectIdentity, Bits, IpAddress, MibIdentifier, NotificationType, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "Gauge32", "enterprises", "ObjectIdentity", "Bits", "IpAddress", "MibIdentifier", "NotificationType", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceID=psDeviceID, psManufacturer=psManufacturer, psDescr=psDescr, psNumber=psNumber, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate, psBusIndex=psBusIndex, advantech=advantech, snmpTrapSrvObj=snmpTrapSrvObj, atMgmt=atMgmt, psLength=psLength, advantechCommonMIB=advantechCommonMIB, sysBootTime=sysBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIRQ=psIRQ, atSystem=atSystem, psModuleType=psModuleType, psClassCode=psClassCode, psState=psState, psFunctionIndex=psFunctionIndex, sysDeviceName=sysDeviceName, sysDescr=sysDescr, psModulePorts=psModulePorts, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceIndex=psDeviceIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, psBaseAddress=psBaseAddress, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvTable=snmpTrapSrvTable, psLocation=psLocation, atPciConfig=atPciConfig, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, pciConfigObj=pciConfigObj, psVendorID=psVendorID, sysModuleID=sysModuleID, sysBootCount=sysBootCount, psIndex=psIndex, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable)
