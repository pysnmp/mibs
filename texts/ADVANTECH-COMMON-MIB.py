...
Unsigned32, enterprises, ObjectIdentity, ModuleIdentity, Integer32, IpAddress, iso, Gauge32, MibIdentifier, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "ObjectIdentity", "ModuleIdentity", "Integer32", "IpAddress", "iso", "Gauge32", "MibIdentifier", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psState=psState, snmpTrapSrvIndex=snmpTrapSrvIndex, psLength=psLength, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysImageVersion=sysImageVersion, psNumber=psNumber, psManufacturer=psManufacturer, PYSNMP_MODULE_ID=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, psClassCode=psClassCode, snmpTrapSrvNumber=snmpTrapSrvNumber, psBusIndex=psBusIndex, atPciConfig=atPciConfig, psDeviceIndex=psDeviceIndex, psDescr=psDescr, snmpTrapSrvIP=snmpTrapSrvIP, advantech=advantech, sysBootCount=sysBootCount, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvEntry=snmpTrapSrvEntry, sysDescr=sysDescr, atSystem=atSystem, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, snmpTrapVersion=snmpTrapVersion, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts, sysDeviceName=sysDeviceName, pciSlotEntry=pciSlotEntry, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvTable=snmpTrapSrvTable, psFunctionIndex=psFunctionIndex, psLocation=psLocation, psDisplayName=psDisplayName, psDeviceID=psDeviceID, psSubsysVendorID=psSubsysVendorID, sysModuleID=sysModuleID, psSubsysDeviceID=psSubsysDeviceID, pciConfigObj=pciConfigObj, psVendorID=psVendorID, atMgmt=atMgmt, sysBootTime=sysBootTime, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate, psIndex=psIndex, snmpTrapSrvObj=snmpTrapSrvObj, psIRQ=psIRQ)
