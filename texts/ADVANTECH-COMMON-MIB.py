...
enterprises, IpAddress, NotificationType, Integer32, MibIdentifier, iso, Counter64, Bits, ObjectIdentity, Counter32, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "NotificationType", "Integer32", "MibIdentifier", "iso", "Counter64", "Bits", "ObjectIdentity", "Counter32", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvEntry=snmpTrapSrvEntry, sysFirstBootTime=sysFirstBootTime, psBusIndex=psBusIndex, sysModuleID=sysModuleID, psManufacturer=psManufacturer, psClassCode=psClassCode, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModulePorts=psModulePorts, sysReleaseDate=sysReleaseDate, psSubsysDeviceID=psSubsysDeviceID, atPciConfig=atPciConfig, psState=psState, psVendorID=psVendorID, sysImageVersion=sysImageVersion, pciConfigObj=pciConfigObj, psLength=psLength, pciSlotTable=pciSlotTable, psSubsysVendorID=psSubsysVendorID, psLocation=psLocation, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceIndex=psDeviceIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvPort=snmpTrapSrvPort, psIRQ=psIRQ, psModuleType=psModuleType, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName, sysDescr=sysDescr, psNumber=psNumber, snmpTrapVersion=snmpTrapVersion, psBaseAddress=psBaseAddress, snmpTrapSrvIP=snmpTrapSrvIP, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, sysDeviceName=sysDeviceName, psDescr=psDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, atMgmt=atMgmt, atSystem=atSystem, sysBootTime=sysBootTime, advantech=advantech, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantechCommonMIB=advantechCommonMIB, pciSlotEntry=pciSlotEntry, psIndex=psIndex, sysBootCount=sysBootCount)
