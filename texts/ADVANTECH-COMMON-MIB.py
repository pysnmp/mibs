...
# Produced by pysmi-1.1.3 at Sun Nov 21 01:01:32 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, NotificationType, ObjectIdentity, Gauge32, iso, TimeTicks, Bits, IpAddress, Counter32, ModuleIdentity, enterprises, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "NotificationType", "ObjectIdentity", "Gauge32", "iso", "TimeTicks", "Bits", "IpAddress", "Counter32", "ModuleIdentity", "enterprises", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysVendorID=psSubsysVendorID, sysDeviceName=sysDeviceName, psState=psState, psSubsysDeviceID=psSubsysDeviceID, psLocation=psLocation, psManufacturer=psManufacturer, psVendorID=psVendorID, snmpTrapSrvPort=snmpTrapSrvPort, sysImageVersion=sysImageVersion, atMgmt=atMgmt, atPciConfig=atPciConfig, snmpTrapSrvIndex=snmpTrapSrvIndex, advantech=advantech, pciSlotTable=pciSlotTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciConfigObj=pciConfigObj, psBaseAddress=psBaseAddress, psDisplayName=psDisplayName, psBusIndex=psBusIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, snmpTrapSrvObj=snmpTrapSrvObj, sysModuleID=sysModuleID, pciSlotEntry=pciSlotEntry, sysDescr=sysDescr, sysBootCount=sysBootCount, psFunctionIndex=psFunctionIndex, psIRQ=psIRQ, psDescr=psDescr, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, psNumber=psNumber, atSystem=atSystem, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength, snmpTrapSrvIP=snmpTrapSrvIP, sysReleaseDate=sysReleaseDate, psDeviceID=psDeviceID, psModulePorts=psModulePorts, sysBootTime=sysBootTime, sysFirstBootTime=sysFirstBootTime, psModuleType=psModuleType, psDeviceIndex=psDeviceIndex)
