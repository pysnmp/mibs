...
enterprises, ModuleIdentity, Counter32, MibIdentifier, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Bits, ObjectIdentity, IpAddress, iso, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "Counter32", "MibIdentifier", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Bits", "ObjectIdentity", "IpAddress", "iso", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciSlotTable=pciSlotTable, psFunctionIndex=psFunctionIndex, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, sysDescr=sysDescr, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, psModulePorts=psModulePorts, snmpTrapSrvObj=snmpTrapSrvObj, psVendorID=psVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapVersion=snmpTrapVersion, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, sysFirstBootTime=sysFirstBootTime, sysBootTime=sysBootTime, pciConfigObj=pciConfigObj, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotEntry=pciSlotEntry, psIndex=psIndex, sysBootCount=sysBootCount, atSystem=atSystem, sysImageVersion=sysImageVersion, psClassCode=psClassCode, psBaseAddress=psBaseAddress, psBusIndex=psBusIndex, psLocation=psLocation, snmpTrapSrvPort=snmpTrapSrvPort, psModuleType=psModuleType, psManufacturer=psManufacturer, advantechCommonMIB=advantechCommonMIB, psState=psState, psLength=psLength, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvTable=snmpTrapSrvTable, sysDeviceName=sysDeviceName, advantech=advantech, psDisplayName=psDisplayName, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, atPciConfig=atPciConfig, psSubsysDeviceID=psSubsysDeviceID, psIRQ=psIRQ)
