...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDeviceIndex=psDeviceIndex, psManufacturer=psManufacturer, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotTable=pciSlotTable, sysBootCount=sysBootCount, snmpTrapSrvNumber=snmpTrapSrvNumber, atPciConfig=atPciConfig, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, psState=psState, psIRQ=psIRQ, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, psDeviceID=psDeviceID, psLocation=psLocation, psNumber=psNumber, PYSNMP_MODULE_ID=advantechCommonMIB, psDescr=psDescr, sysBootTime=sysBootTime, psLength=psLength, psModulePorts=psModulePorts, sysReleaseDate=sysReleaseDate, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, sysFirstBootTime=sysFirstBootTime, advantechCommonMIB=advantechCommonMIB, psDisplayName=psDisplayName, psVendorID=psVendorID, atSystem=atSystem, psBaseAddress=psBaseAddress, pciConfigObj=pciConfigObj, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapVersion=snmpTrapVersion, psModuleType=psModuleType, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIndex=snmpTrapSrvIndex, psBusIndex=psBusIndex, advantech=advantech, atMgmt=atMgmt, snmpTrapSrvTable=snmpTrapSrvTable, psFunctionIndex=psFunctionIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDescr=sysDescr)
