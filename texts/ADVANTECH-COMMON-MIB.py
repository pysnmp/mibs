...
ModuleIdentity, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, iso, IpAddress, NotificationType, Gauge32, Bits, MibIdentifier, Integer32, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "iso", "IpAddress", "NotificationType", "Gauge32", "Bits", "MibIdentifier", "Integer32", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psManufacturer=psManufacturer, psIRQ=psIRQ, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, psBaseAddress=psBaseAddress, atMgmt=atMgmt, advantech=advantech, snmpTrapSrvEntry=snmpTrapSrvEntry, atPciConfig=atPciConfig, sysModuleID=sysModuleID, snmpTrapSrvTable=snmpTrapSrvTable, psDescr=psDescr, psModuleType=psModuleType, psClassCode=psClassCode, atSystem=atSystem, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psState=psState, psModulePorts=psModulePorts, sysImageVersion=sysImageVersion, pciSlotTable=pciSlotTable, pciSlotEntry=pciSlotEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, psDisplayName=psDisplayName, psIndex=psIndex, sysBootCount=sysBootCount, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psFunctionIndex=psFunctionIndex, psBusIndex=psBusIndex, sysDescr=sysDescr, psLength=psLength, psLocation=psLocation, sysBootTime=sysBootTime, pciConfigObj=pciConfigObj, psDeviceID=psDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, sysReleaseDate=sysReleaseDate, psVendorID=psVendorID, psSubsysVendorID=psSubsysVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, advantechCommonMIB=advantechCommonMIB, psNumber=psNumber, sysDeviceName=sysDeviceName)
