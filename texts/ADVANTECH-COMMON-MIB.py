...
# Produced by pysmi-1.1.3 at Wed Dec  8 21:20:08 2021
...
NotificationType, IpAddress, MibIdentifier, Integer32, Gauge32, ModuleIdentity, Counter32, Counter64, Bits, TimeTicks, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "MibIdentifier", "Integer32", "Gauge32", "ModuleIdentity", "Counter32", "Counter64", "Bits", "TimeTicks", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIRQ=psIRQ, PYSNMP_MODULE_ID=advantechCommonMIB, psBusIndex=psBusIndex, psDeviceIndex=psDeviceIndex, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, sysModuleID=sysModuleID, atMgmt=atMgmt, pciSlotTable=pciSlotTable, advantechCommonMIB=advantechCommonMIB, psDisplayName=psDisplayName, psDescr=psDescr, psSubsysDeviceID=psSubsysDeviceID, psFunctionIndex=psFunctionIndex, sysBootCount=sysBootCount, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIndex=psIndex, psClassCode=psClassCode, sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapVersion=snmpTrapVersion, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psLength=psLength, psModuleType=psModuleType, sysReleaseDate=sysReleaseDate, psNumber=psNumber, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotEntry=pciSlotEntry, advantech=advantech, pciConfigObj=pciConfigObj, atPciConfig=atPciConfig, psSubsysVendorID=psSubsysVendorID, atSystem=atSystem, sysDeviceName=sysDeviceName, snmpTrapSrvIP=snmpTrapSrvIP, psLocation=psLocation, psBaseAddress=psBaseAddress, psState=psState, sysImageVersion=sysImageVersion, psVendorID=psVendorID, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, psManufacturer=psManufacturer)
