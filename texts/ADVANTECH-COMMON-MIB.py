...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBusIndex=psBusIndex, atMgmt=atMgmt, psClassCode=psClassCode, sysBootCount=sysBootCount, psSubsysDeviceID=psSubsysDeviceID, pciSlotTable=pciSlotTable, snmpTrapSrvIP=snmpTrapSrvIP, psFunctionIndex=psFunctionIndex, pciConfigObj=pciConfigObj, psManufacturer=psManufacturer, psVendorID=psVendorID, advantechCommonMIB=advantechCommonMIB, psDeviceID=psDeviceID, psLength=psLength, sysFirstBootTime=sysFirstBootTime, psNumber=psNumber, sysReleaseDate=sysReleaseDate, psDeviceIndex=psDeviceIndex, sysModuleID=sysModuleID, atSystem=atSystem, sysDescr=sysDescr, psIRQ=psIRQ, psState=psState, psSubsysVendorID=psSubsysVendorID, psLocation=psLocation, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDeviceName=sysDeviceName, sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapVersion=snmpTrapVersion, atPciConfig=atPciConfig, psDisplayName=psDisplayName, psModuleType=psModuleType, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, advantech=advantech, psIndex=psIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvObj=snmpTrapSrvObj, psModulePorts=psModulePorts, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvTable=snmpTrapSrvTable, psBaseAddress=psBaseAddress, psDescr=psDescr, snmpTrapSrvNumber=snmpTrapSrvNumber)
