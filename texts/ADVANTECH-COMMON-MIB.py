...
MibIdentifier, Integer32, ObjectIdentity, Counter32, Gauge32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, Counter64, ModuleIdentity, Bits, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "ObjectIdentity", "Counter32", "Gauge32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "Counter64", "ModuleIdentity", "Bits", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt, psFunctionIndex=psFunctionIndex, PYSNMP_MODULE_ID=advantechCommonMIB, sysReleaseDate=sysReleaseDate, psIndex=psIndex, advantechCommonMIB=advantechCommonMIB, sysModuleID=sysModuleID, psLength=psLength, pciConfigObj=pciConfigObj, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psNumber=psNumber, psModulePorts=psModulePorts, psState=psState, psDeviceID=psDeviceID, psSubsysDeviceID=psSubsysDeviceID, psLocation=psLocation, psBusIndex=psBusIndex, pciSlotEntry=pciSlotEntry, psIRQ=psIRQ, psVendorID=psVendorID, sysDeviceName=sysDeviceName, snmpTrapSrvEntry=snmpTrapSrvEntry, psClassCode=psClassCode, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotTable=pciSlotTable, psModuleType=psModuleType, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapVersion=snmpTrapVersion, psBaseAddress=psBaseAddress, advantech=advantech, psDeviceIndex=psDeviceIndex, sysBootCount=sysBootCount, sysDescr=sysDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atPciConfig=atPciConfig, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName, psDescr=psDescr, sysImageVersion=sysImageVersion, sysBootTime=sysBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, atSystem=atSystem)
