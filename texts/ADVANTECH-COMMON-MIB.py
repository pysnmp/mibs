...
# Produced by pysmi-1.1.8 at Sat Jan 15 15:00:53 2022
...
Counter64, iso, TimeTicks, IpAddress, NotificationType, MibIdentifier, Bits, Integer32, enterprises, Counter32, Gauge32, Unsigned32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "TimeTicks", "IpAddress", "NotificationType", "MibIdentifier", "Bits", "Integer32", "enterprises", "Counter32", "Gauge32", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, sysModuleID=sysModuleID, sysReleaseDate=sysReleaseDate, snmpTrapVersion=snmpTrapVersion, pciSlotTable=pciSlotTable, psBusIndex=psBusIndex, psNumber=psNumber, psDeviceIndex=psDeviceIndex, psLength=psLength, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, psManufacturer=psManufacturer, psFunctionIndex=psFunctionIndex, advantech=advantech, advantechCommonMIB=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, sysDeviceName=sysDeviceName, atSystem=atSystem, psIndex=psIndex, psIRQ=psIRQ, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIP=snmpTrapSrvIP, pciConfigObj=pciConfigObj, psDeviceID=psDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, psDescr=psDescr, atPciConfig=atPciConfig, sysBootCount=sysBootCount, sysBootTime=sysBootTime, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, pciSlotEntry=pciSlotEntry, psModulePorts=psModulePorts, psVendorID=psVendorID, sysDescr=sysDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, psState=psState, atMgmt=atMgmt, psBaseAddress=psBaseAddress, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, psLocation=psLocation)
