...
enterprises, NotificationType, Counter64, Gauge32, Unsigned32, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, MibIdentifier, Bits, Integer32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Counter64", "Gauge32", "Unsigned32", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "MibIdentifier", "Bits", "Integer32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, sysDescr=sysDescr, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotTable=pciSlotTable, psDeviceID=psDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysDeviceID=psSubsysDeviceID, sysModuleID=sysModuleID, psClassCode=psClassCode, psBusIndex=psBusIndex, psDescr=psDescr, psFunctionIndex=psFunctionIndex, sysBootTime=sysBootTime, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, sysFirstBootTime=sysFirstBootTime, advantech=advantech, psSubsysVendorID=psSubsysVendorID, psLength=psLength, psState=psState, pciConfigObj=pciConfigObj, psDeviceIndex=psDeviceIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, snmpTrapVersion=snmpTrapVersion, sysReleaseDate=sysReleaseDate, atMgmt=atMgmt, advantechCommonMIB=advantechCommonMIB, atSystem=atSystem, psBaseAddress=psBaseAddress, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName, pciSlotEntry=pciSlotEntry, psIRQ=psIRQ, psLocation=psLocation, psVendorID=psVendorID, psModuleType=psModuleType, psManufacturer=psManufacturer, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootCount=sysBootCount, atPciConfig=atPciConfig, psModulePorts=psModulePorts)
