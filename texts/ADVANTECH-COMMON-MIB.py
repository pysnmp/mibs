...
Unsigned32, iso, Gauge32, Bits, Counter32, TimeTicks, Counter64, MibIdentifier, ObjectIdentity, NotificationType, ModuleIdentity, enterprises, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "Gauge32", "Bits", "Counter32", "TimeTicks", "Counter64", "MibIdentifier", "ObjectIdentity", "NotificationType", "ModuleIdentity", "enterprises", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvEntry=snmpTrapSrvEntry, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, atPciConfig=atPciConfig, advantech=advantech, sysBootCount=sysBootCount, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDescr=sysDescr, psNumber=psNumber, psManufacturer=psManufacturer, snmpTrapSrvObj=snmpTrapSrvObj, sysBootTime=sysBootTime, sysReleaseDate=sysReleaseDate, psBusIndex=psBusIndex, psDisplayName=psDisplayName, psDescr=psDescr, psClassCode=psClassCode, psLocation=psLocation, psLength=psLength, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIndex=psIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psModulePorts=psModulePorts, psDeviceID=psDeviceID, psIRQ=psIRQ, psFunctionIndex=psFunctionIndex, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, psModuleType=psModuleType, sysImageVersion=sysImageVersion, atMgmt=atMgmt, snmpTrapVersion=snmpTrapVersion, psVendorID=psVendorID, pciSlotEntry=pciSlotEntry, psSubsysVendorID=psSubsysVendorID, psState=psState, snmpTrapSrvTable=snmpTrapSrvTable, sysFirstBootTime=sysFirstBootTime, atSystem=atSystem, pciConfigObj=pciConfigObj, psDeviceIndex=psDeviceIndex, psBaseAddress=psBaseAddress)
