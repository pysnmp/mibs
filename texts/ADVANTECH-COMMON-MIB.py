...
Bits, TimeTicks, Counter64, Counter32, ObjectIdentity, NotificationType, ModuleIdentity, MibIdentifier, Integer32, Unsigned32, IpAddress, enterprises, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Counter64", "Counter32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "MibIdentifier", "Integer32", "Unsigned32", "IpAddress", "enterprises", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciSlotEntry=pciSlotEntry, psClassCode=psClassCode, pciSlotTable=pciSlotTable, psFunctionIndex=psFunctionIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceID=psDeviceID, psManufacturer=psManufacturer, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, sysImageVersion=sysImageVersion, psDescr=psDescr, psDisplayName=psDisplayName, psVendorID=psVendorID, atSystem=atSystem, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvEntry=snmpTrapSrvEntry, sysDeviceName=sysDeviceName, atPciConfig=atPciConfig, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, psSubsysVendorID=psSubsysVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, advantech=advantech, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvTable=snmpTrapSrvTable, psNumber=psNumber, psBaseAddress=psBaseAddress, psLength=psLength, psIRQ=psIRQ, psModulePorts=psModulePorts, sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, psIndex=psIndex, psBusIndex=psBusIndex, psState=psState, sysReleaseDate=sysReleaseDate, sysModuleID=sysModuleID, sysFirstBootTime=sysFirstBootTime, psLocation=psLocation, atMgmt=atMgmt, snmpTrapSrvIP=snmpTrapSrvIP, sysBootTime=sysBootTime, pciConfigObj=pciConfigObj, sysBootCount=sysBootCount, psDeviceIndex=psDeviceIndex)
