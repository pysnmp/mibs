...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, TimeTicks, Integer32, Counter64, IpAddress, ObjectIdentity, Unsigned32, MibIdentifier, Bits, enterprises, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "TimeTicks", "Integer32", "Counter64", "IpAddress", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Bits", "enterprises", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvEntry=snmpTrapSrvEntry, advantechCommonMIB=advantechCommonMIB, psDescr=psDescr, sysImageVersion=sysImageVersion, sysModuleID=sysModuleID, pciConfigObj=pciConfigObj, snmpTrapSrvNumber=snmpTrapSrvNumber, psIndex=psIndex, psClassCode=psClassCode, sysBootTime=sysBootTime, psNumber=psNumber, sysBootCount=sysBootCount, psVendorID=psVendorID, psLocation=psLocation, atSystem=atSystem, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atMgmt=atMgmt, psIRQ=psIRQ, psManufacturer=psManufacturer, psModuleType=psModuleType, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvTable=snmpTrapSrvTable, PYSNMP_MODULE_ID=advantechCommonMIB, sysDeviceName=sysDeviceName, psLength=psLength, pciSlotEntry=pciSlotEntry, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psFunctionIndex=psFunctionIndex, psState=psState, psDeviceIndex=psDeviceIndex, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, psBaseAddress=psBaseAddress, psBusIndex=psBusIndex, snmpTrapVersion=snmpTrapVersion, pciSlotTable=pciSlotTable, sysDescr=sysDescr, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, psModulePorts=psModulePorts, atPciConfig=atPciConfig, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceID=psDeviceID, psDisplayName=psDisplayName, psSubsysDeviceID=psSubsysDeviceID)
