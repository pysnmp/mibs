...
Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, Gauge32, ModuleIdentity, ObjectIdentity, NotificationType, iso, enterprises, IpAddress, Counter32, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "Gauge32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "iso", "enterprises", "IpAddress", "Counter32", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvPort=snmpTrapSrvPort, psClassCode=psClassCode, psManufacturer=psManufacturer, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, sysBootCount=sysBootCount, psIRQ=psIRQ, pciSlotTable=pciSlotTable, psLength=psLength, sysBootTime=sysBootTime, psState=psState, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantech=advantech, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atPciConfig=atPciConfig, sysModuleID=sysModuleID, psDeviceID=psDeviceID, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, pciConfigObj=pciConfigObj, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, atMgmt=atMgmt, psNumber=psNumber, psVendorID=psVendorID, snmpTrapSrvTable=snmpTrapSrvTable, PYSNMP_MODULE_ID=advantechCommonMIB, atSystem=atSystem, psBusIndex=psBusIndex, psDisplayName=psDisplayName, psDescr=psDescr, sysDeviceName=sysDeviceName, pciSlotEntry=pciSlotEntry, sysReleaseDate=sysReleaseDate, psBaseAddress=psBaseAddress, psIndex=psIndex, psSubsysDeviceID=psSubsysDeviceID, psDeviceIndex=psDeviceIndex, sysImageVersion=sysImageVersion, psLocation=psLocation, psModulePorts=psModulePorts)
