...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDescr=psDescr, psBaseAddress=psBaseAddress, sysBootTime=sysBootTime, atPciConfig=atPciConfig, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvIP=snmpTrapSrvIP, sysReleaseDate=sysReleaseDate, pciSlotEntry=pciSlotEntry, snmpTrapSrvIndex=snmpTrapSrvIndex, advantech=advantech, sysImageVersion=sysImageVersion, psState=psState, pciConfigObj=pciConfigObj, snmpTrapSrvEntry=snmpTrapSrvEntry, psManufacturer=psManufacturer, psBusIndex=psBusIndex, snmpTrapVersion=snmpTrapVersion, sysDescr=sysDescr, atSystem=atSystem, PYSNMP_MODULE_ID=advantechCommonMIB, psVendorID=psVendorID, psFunctionIndex=psFunctionIndex, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIRQ=psIRQ, snmpTrapSrvTable=snmpTrapSrvTable, sysModuleID=sysModuleID, psSubsysVendorID=psSubsysVendorID, psModulePorts=psModulePorts, psDisplayName=psDisplayName, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvObj=snmpTrapSrvObj, sysBootCount=sysBootCount, sysFirstBootTime=sysFirstBootTime, psIndex=psIndex, psDeviceIndex=psDeviceIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atMgmt=atMgmt, psNumber=psNumber, sysDeviceName=sysDeviceName, psModuleType=psModuleType, pciSlotTable=pciSlotTable, psClassCode=psClassCode, advantechCommonMIB=advantechCommonMIB, psDeviceID=psDeviceID, psLocation=psLocation, psLength=psLength)
