...
iso, TimeTicks, Counter64, Bits, ModuleIdentity, ObjectIdentity, Unsigned32, MibIdentifier, NotificationType, enterprises, IpAddress, Gauge32, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Counter64", "Bits", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "MibIdentifier", "NotificationType", "enterprises", "IpAddress", "Gauge32", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atSystem=atSystem, psDeviceID=psDeviceID, psLength=psLength, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, psModuleType=psModuleType, psSubsysVendorID=psSubsysVendorID, psManufacturer=psManufacturer, snmpTrapVersion=snmpTrapVersion, psModulePorts=psModulePorts, sysBootCount=sysBootCount, psLocation=psLocation, psIRQ=psIRQ, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, sysBootTime=sysBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, pciConfigObj=pciConfigObj, snmpTrapSrvIndex=snmpTrapSrvIndex, psNumber=psNumber, atMgmt=atMgmt, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate, snmpTrapSrvTable=snmpTrapSrvTable, PYSNMP_MODULE_ID=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, sysImageVersion=sysImageVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDeviceName=sysDeviceName, snmpTrapSrvIP=snmpTrapSrvIP, psBaseAddress=psBaseAddress, psClassCode=psClassCode, snmpTrapSrvObj=snmpTrapSrvObj, psIndex=psIndex, psVendorID=psVendorID, atPciConfig=atPciConfig, psDeviceIndex=psDeviceIndex, psState=psState, psDescr=psDescr, psBusIndex=psBusIndex, sysModuleID=sysModuleID, advantech=advantech)
