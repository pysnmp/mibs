...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, enterprises, Counter32, Unsigned32, iso, Counter64, MibIdentifier, IpAddress, Bits, ObjectIdentity, ModuleIdentity, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "enterprises", "Counter32", "Unsigned32", "iso", "Counter64", "MibIdentifier", "IpAddress", "Bits", "ObjectIdentity", "ModuleIdentity", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDisplayName=psDisplayName, PYSNMP_MODULE_ID=advantechCommonMIB, psNumber=psNumber, psManufacturer=psManufacturer, atSystem=atSystem, psBusIndex=psBusIndex, psIRQ=psIRQ, psModuleType=psModuleType, psLength=psLength, sysBootTime=sysBootTime, sysReleaseDate=sysReleaseDate, snmpTrapSrvObj=snmpTrapSrvObj, psFunctionIndex=psFunctionIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psClassCode=psClassCode, sysDeviceName=sysDeviceName, snmpTrapSrvPort=snmpTrapSrvPort, atPciConfig=atPciConfig, psIndex=psIndex, atMgmt=atMgmt, advantech=advantech, psVendorID=psVendorID, psModulePorts=psModulePorts, pciConfigObj=pciConfigObj, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, psDescr=psDescr, psLocation=psLocation, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotTable=pciSlotTable, psDeviceIndex=psDeviceIndex, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, psSubsysVendorID=psSubsysVendorID, psState=psState, advantechCommonMIB=advantechCommonMIB, sysBootCount=sysBootCount, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvNumber=snmpTrapSrvNumber, psBaseAddress=psBaseAddress, sysFirstBootTime=sysFirstBootTime, psSubsysDeviceID=psSubsysDeviceID, sysDescr=sysDescr, sysModuleID=sysModuleID)
