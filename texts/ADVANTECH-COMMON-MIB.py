...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, IpAddress, ModuleIdentity, Unsigned32, Counter32, MibIdentifier, ObjectIdentity, Bits, NotificationType, iso, Gauge32, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "IpAddress", "ModuleIdentity", "Unsigned32", "Counter32", "MibIdentifier", "ObjectIdentity", "Bits", "NotificationType", "iso", "Gauge32", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootCount=sysBootCount, advantechCommonMIB=advantechCommonMIB, atMgmt=atMgmt, psFunctionIndex=psFunctionIndex, psIRQ=psIRQ, psIndex=psIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, psVendorID=psVendorID, psState=psState, atSystem=atSystem, PYSNMP_MODULE_ID=advantechCommonMIB, atPciConfig=atPciConfig, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceID=psDeviceID, psSubsysVendorID=psSubsysVendorID, sysBootTime=sysBootTime, sysFirstBootTime=sysFirstBootTime, psLength=psLength, pciConfigObj=pciConfigObj, psNumber=psNumber, psDeviceIndex=psDeviceIndex, snmpTrapVersion=snmpTrapVersion, sysModuleID=sysModuleID, advantech=advantech, psSubsysDeviceID=psSubsysDeviceID, sysDeviceName=sysDeviceName, psModuleType=psModuleType, psManufacturer=psManufacturer, psLocation=psLocation, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvObj=snmpTrapSrvObj, psBusIndex=psBusIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, sysReleaseDate=sysReleaseDate, pciSlotTable=pciSlotTable, psModulePorts=psModulePorts, psBaseAddress=psBaseAddress, snmpTrapSrvEntry=snmpTrapSrvEntry, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotEntry=pciSlotEntry, psDisplayName=psDisplayName, psDescr=psDescr)
