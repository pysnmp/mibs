...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, IpAddress, NotificationType, ObjectIdentity, Integer32, Counter32, MibIdentifier, iso, ModuleIdentity, TimeTicks, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "IpAddress", "NotificationType", "ObjectIdentity", "Integer32", "Counter32", "MibIdentifier", "iso", "ModuleIdentity", "TimeTicks", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDeviceIndex=psDeviceIndex, psDeviceID=psDeviceID, psVendorID=psVendorID, psNumber=psNumber, atMgmt=atMgmt, sysImageVersion=sysImageVersion, psModulePorts=psModulePorts, advantechCommonMIB=advantechCommonMIB, pciSlotTable=pciSlotTable, snmpTrapSrvIP=snmpTrapSrvIP, advantech=advantech, atPciConfig=atPciConfig, sysReleaseDate=sysReleaseDate, psState=psState, snmpTrapSrvEntry=snmpTrapSrvEntry, psClassCode=psClassCode, psManufacturer=psManufacturer, psIndex=psIndex, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysVendorID=psSubsysVendorID, sysBootCount=sysBootCount, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciConfigObj=pciConfigObj, psBaseAddress=psBaseAddress, psModuleType=psModuleType, sysDescr=sysDescr, psDisplayName=psDisplayName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotEntry=pciSlotEntry, psLength=psLength, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootTime=sysBootTime, psIRQ=psIRQ, snmpTrapSrvTable=snmpTrapSrvTable, atSystem=atSystem, snmpTrapSrvNumber=snmpTrapSrvNumber, psLocation=psLocation, psBusIndex=psBusIndex, psSubsysDeviceID=psSubsysDeviceID, psFunctionIndex=psFunctionIndex, psDescr=psDescr, snmpTrapVersion=snmpTrapVersion)
