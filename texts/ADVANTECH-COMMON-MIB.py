...
Integer32, ModuleIdentity, iso, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Counter32, ObjectIdentity, IpAddress, Counter64, Bits, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "iso", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Counter32", "ObjectIdentity", "IpAddress", "Counter64", "Bits", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapVersion=snmpTrapVersion, psBaseAddress=psBaseAddress, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, pciConfigObj=pciConfigObj, psLength=psLength, psIRQ=psIRQ, sysReleaseDate=sysReleaseDate, psModulePorts=psModulePorts, sysImageVersion=sysImageVersion, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, sysFirstBootTime=sysFirstBootTime, psDescr=psDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, psManufacturer=psManufacturer, advantech=advantech, sysDescr=sysDescr, psIndex=psIndex, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootTime=sysBootTime, pciSlotTable=pciSlotTable, psModuleType=psModuleType, atMgmt=atMgmt, psLocation=psLocation, psClassCode=psClassCode, psFunctionIndex=psFunctionIndex, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvNumber=snmpTrapSrvNumber, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, psNumber=psNumber, psDisplayName=psDisplayName, psState=psState, atPciConfig=atPciConfig, psDeviceID=psDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, sysModuleID=sysModuleID, sysBootCount=sysBootCount, sysDeviceName=sysDeviceName, psBusIndex=psBusIndex)
