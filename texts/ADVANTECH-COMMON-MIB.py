...
enterprises, Gauge32, Bits, NotificationType, iso, ObjectIdentity, Counter64, IpAddress, Unsigned32, TimeTicks, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Bits", "NotificationType", "iso", "ObjectIdentity", "Counter64", "IpAddress", "Unsigned32", "TimeTicks", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvPort=snmpTrapSrvPort, psNumber=psNumber, advantechCommonMIB=advantechCommonMIB, psBaseAddress=psBaseAddress, psModuleType=psModuleType, snmpTrapSrvObj=snmpTrapSrvObj, sysDescr=sysDescr, sysBootTime=sysBootTime, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, snmpTrapVersion=snmpTrapVersion, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvTable=snmpTrapSrvTable, sysDeviceName=sysDeviceName, pciSlotEntry=pciSlotEntry, psDisplayName=psDisplayName, psClassCode=psClassCode, psManufacturer=psManufacturer, sysFirstBootTime=sysFirstBootTime, sysModuleID=sysModuleID, psIRQ=psIRQ, sysReleaseDate=sysReleaseDate, psDescr=psDescr, psDeviceID=psDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLocation=psLocation, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, atSystem=atSystem, psBusIndex=psBusIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciConfigObj=pciConfigObj, psIndex=psIndex, advantech=advantech, snmpTrapSrvEntry=snmpTrapSrvEntry, psModulePorts=psModulePorts, psFunctionIndex=psFunctionIndex, psDeviceIndex=psDeviceIndex, psState=psState, sysBootCount=sysBootCount, psLength=psLength, pciSlotTable=pciSlotTable, sysImageVersion=sysImageVersion, psVendorID=psVendorID)
