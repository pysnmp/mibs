...
# Produced by pysmi-1.1.3 at Sun Nov 28 14:57:36 2021
...
Integer32, enterprises, Gauge32, ObjectIdentity, IpAddress, Counter32, iso, Unsigned32, MibIdentifier, TimeTicks, Counter64, Bits, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "Gauge32", "ObjectIdentity", "IpAddress", "Counter32", "iso", "Unsigned32", "MibIdentifier", "TimeTicks", "Counter64", "Bits", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootCount=sysBootCount, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, advantechCommonMIB=advantechCommonMIB, sysReleaseDate=sysReleaseDate, psModulePorts=psModulePorts, snmpTrapSrvNumber=snmpTrapSrvNumber, psBaseAddress=psBaseAddress, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psNumber=psNumber, psDeviceIndex=psDeviceIndex, psDescr=psDescr, sysModuleID=sysModuleID, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psFunctionIndex=psFunctionIndex, psDeviceID=psDeviceID, psDisplayName=psDisplayName, sysBootTime=sysBootTime, atMgmt=atMgmt, psLength=psLength, psManufacturer=psManufacturer, psLocation=psLocation, psState=psState, snmpTrapSrvPort=snmpTrapSrvPort, PYSNMP_MODULE_ID=advantechCommonMIB, pciConfigObj=pciConfigObj, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotEntry=pciSlotEntry, sysDeviceName=sysDeviceName, atPciConfig=atPciConfig, sysImageVersion=sysImageVersion, atSystem=atSystem, psSubsysVendorID=psSubsysVendorID, psVendorID=psVendorID, psModuleType=psModuleType, pciSlotTable=pciSlotTable, psIndex=psIndex, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, psIRQ=psIRQ, psClassCode=psClassCode, psSubsysDeviceID=psSubsysDeviceID)
