...
IpAddress, Unsigned32, TimeTicks, Integer32, enterprises, Counter64, iso, Gauge32, ObjectIdentity, Bits, ModuleIdentity, MibIdentifier, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "TimeTicks", "Integer32", "enterprises", "Counter64", "iso", "Gauge32", "ObjectIdentity", "Bits", "ModuleIdentity", "MibIdentifier", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDeviceName=sysDeviceName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysVendorID=psSubsysVendorID, advantech=advantech, sysBootTime=sysBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, psSubsysDeviceID=psSubsysDeviceID, psDeviceIndex=psDeviceIndex, snmpTrapSrvIP=snmpTrapSrvIP, pciConfigObj=pciConfigObj, psModuleType=psModuleType, psModulePorts=psModulePorts, sysModuleID=sysModuleID, psLocation=psLocation, sysImageVersion=sysImageVersion, psManufacturer=psManufacturer, psVendorID=psVendorID, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotTable=pciSlotTable, psLength=psLength, psDisplayName=psDisplayName, advantechCommonMIB=advantechCommonMIB, psBaseAddress=psBaseAddress, atMgmt=atMgmt, snmpTrapSrvEntry=snmpTrapSrvEntry, PYSNMP_MODULE_ID=advantechCommonMIB, sysReleaseDate=sysReleaseDate, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvPort=snmpTrapSrvPort, atPciConfig=atPciConfig, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psFunctionIndex=psFunctionIndex, atSystem=atSystem, psIndex=psIndex, psNumber=psNumber, psDescr=psDescr, psDeviceID=psDeviceID, psIRQ=psIRQ, sysFirstBootTime=sysFirstBootTime, psState=psState, pciSlotEntry=pciSlotEntry, psClassCode=psClassCode, sysBootCount=sysBootCount, sysDescr=sysDescr, psBusIndex=psBusIndex)
