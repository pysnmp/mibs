...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, enterprises, iso, Bits, Counter32, Counter64, MibIdentifier, ObjectIdentity, NotificationType, IpAddress, Integer32, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "enterprises", "iso", "Bits", "Counter32", "Counter64", "MibIdentifier", "ObjectIdentity", "NotificationType", "IpAddress", "Integer32", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, snmpTrapSrvIP=snmpTrapSrvIP, psIRQ=psIRQ, sysBootTime=sysBootTime, sysImageVersion=sysImageVersion, psSubsysVendorID=psSubsysVendorID, atSystem=atSystem, sysBootCount=sysBootCount, psLength=psLength, sysFirstBootTime=sysFirstBootTime, psDeviceID=psDeviceID, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvTable=snmpTrapSrvTable, psState=psState, atMgmt=atMgmt, advantechCommonMIB=advantechCommonMIB, psBaseAddress=psBaseAddress, PYSNMP_MODULE_ID=advantechCommonMIB, psLocation=psLocation, psModuleType=psModuleType, snmpTrapSrvObj=snmpTrapSrvObj, advantech=advantech, pciSlotEntry=pciSlotEntry, psDescr=psDescr, pciSlotTable=pciSlotTable, psIndex=psIndex, psVendorID=psVendorID, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, snmpTrapSrvPort=snmpTrapSrvPort, psDisplayName=psDisplayName, snmpTrapVersion=snmpTrapVersion, sysDeviceName=sysDeviceName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceIndex=psDeviceIndex, atPciConfig=atPciConfig, pciConfigObj=pciConfigObj, sysReleaseDate=sysReleaseDate, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModulePorts=psModulePorts, psNumber=psNumber, sysModuleID=sysModuleID, sysDescr=sysDescr)
