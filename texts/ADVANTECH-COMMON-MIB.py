...
IpAddress, TimeTicks, Counter64, Bits, NotificationType, enterprises, Gauge32, Counter32, ObjectIdentity, Unsigned32, iso, MibIdentifier, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Counter64", "Bits", "NotificationType", "enterprises", "Gauge32", "Counter32", "ObjectIdentity", "Unsigned32", "iso", "MibIdentifier", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atSystem=atSystem, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysFirstBootTime=sysFirstBootTime, psDescr=psDescr, psState=psState, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapVersion=snmpTrapVersion, sysDeviceName=sysDeviceName, psClassCode=psClassCode, psModulePorts=psModulePorts, advantech=advantech, psBaseAddress=psBaseAddress, pciSlotEntry=pciSlotEntry, psLength=psLength, psIRQ=psIRQ, sysReleaseDate=sysReleaseDate, psManufacturer=psManufacturer, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvTable=snmpTrapSrvTable, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, psVendorID=psVendorID, psNumber=psNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceID=psDeviceID, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, psSubsysDeviceID=psSubsysDeviceID, sysBootTime=sysBootTime, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, sysImageVersion=sysImageVersion, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, pciConfigObj=pciConfigObj, sysBootCount=sysBootCount, sysDescr=sysDescr, atMgmt=atMgmt, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, psIndex=psIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceIndex=psDeviceIndex, sysModuleID=sysModuleID)
