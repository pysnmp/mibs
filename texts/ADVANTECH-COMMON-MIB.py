...
ObjectIdentity, IpAddress, Counter32, enterprises, Counter64, Gauge32, Unsigned32, TimeTicks, Integer32, ModuleIdentity, NotificationType, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Counter32", "enterprises", "Counter64", "Gauge32", "Unsigned32", "TimeTicks", "Integer32", "ModuleIdentity", "NotificationType", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psClassCode=psClassCode, psSubsysVendorID=psSubsysVendorID, sysDeviceName=sysDeviceName, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, pciSlotEntry=pciSlotEntry, snmpTrapSrvIndex=snmpTrapSrvIndex, atSystem=atSystem, psDeviceIndex=psDeviceIndex, psBaseAddress=psBaseAddress, psLength=psLength, sysImageVersion=sysImageVersion, pciSlotTable=pciSlotTable, advantech=advantech, psIndex=psIndex, psFunctionIndex=psFunctionIndex, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootTime=sysBootTime, psVendorID=psVendorID, psDescr=psDescr, atMgmt=atMgmt, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atPciConfig=atPciConfig, psIRQ=psIRQ, pciConfigObj=pciConfigObj, psState=psState, sysDescr=sysDescr, psModuleType=psModuleType, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, psModulePorts=psModulePorts, advantechCommonMIB=advantechCommonMIB, psLocation=psLocation, sysModuleID=sysModuleID, sysBootCount=sysBootCount, psDeviceID=psDeviceID, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvPort=snmpTrapSrvPort, psManufacturer=psManufacturer, snmpTrapSrvNumber=snmpTrapSrvNumber, sysFirstBootTime=sysFirstBootTime, psDisplayName=psDisplayName)
