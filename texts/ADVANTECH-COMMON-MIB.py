...
iso, Unsigned32, NotificationType, ModuleIdentity, MibIdentifier, TimeTicks, IpAddress, Counter64, Gauge32, ObjectIdentity, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "NotificationType", "ModuleIdentity", "MibIdentifier", "TimeTicks", "IpAddress", "Counter64", "Gauge32", "ObjectIdentity", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIndex=snmpTrapSrvIndex, psBusIndex=psBusIndex, sysDescr=sysDescr, psModulePorts=psModulePorts, psNumber=psNumber, pciConfigObj=pciConfigObj, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, psVendorID=psVendorID, psLength=psLength, psIRQ=psIRQ, snmpTrapSrvEntry=snmpTrapSrvEntry, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysVendorID=psSubsysVendorID, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, psManufacturer=psManufacturer, sysDeviceName=sysDeviceName, psLocation=psLocation, atMgmt=atMgmt, snmpTrapSrvPort=snmpTrapSrvPort, psClassCode=psClassCode, psSubsysDeviceID=psSubsysDeviceID, sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, psState=psState, psFunctionIndex=psFunctionIndex, sysBootTime=sysBootTime, advantech=advantech, psDisplayName=psDisplayName, sysModuleID=sysModuleID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootCount=sysBootCount, psModuleType=psModuleType, sysReleaseDate=sysReleaseDate, pciSlotTable=pciSlotTable, psIndex=psIndex, atSystem=atSystem, sysImageVersion=sysImageVersion, psBaseAddress=psBaseAddress, snmpTrapSrvNumber=snmpTrapSrvNumber, psDescr=psDescr, atPciConfig=atPciConfig)
