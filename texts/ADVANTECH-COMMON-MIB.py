...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Bits, Unsigned32, TimeTicks, ObjectIdentity, iso, Integer32, Gauge32, enterprises, MibIdentifier, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Bits", "Unsigned32", "TimeTicks", "ObjectIdentity", "iso", "Integer32", "Gauge32", "enterprises", "MibIdentifier", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, psBusIndex=psBusIndex, psDeviceIndex=psDeviceIndex, sysFirstBootTime=sysFirstBootTime, pciConfigObj=pciConfigObj, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotEntry=pciSlotEntry, atMgmt=atMgmt, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, psModuleType=psModuleType, psIndex=psIndex, advantechCommonMIB=advantechCommonMIB, psVendorID=psVendorID, psIRQ=psIRQ, psModulePorts=psModulePorts, psBaseAddress=psBaseAddress, psLength=psLength, atPciConfig=atPciConfig, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvObj=snmpTrapSrvObj, psClassCode=psClassCode, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDisplayName=psDisplayName, psLocation=psLocation, sysBootCount=sysBootCount, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, psState=psState, pciSlotTable=pciSlotTable, sysModuleID=sysModuleID, psSubsysVendorID=psSubsysVendorID, advantech=advantech, sysImageVersion=sysImageVersion, sysReleaseDate=sysReleaseDate, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, psManufacturer=psManufacturer, sysBootTime=sysBootTime, psDescr=psDescr, psFunctionIndex=psFunctionIndex, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceID=psDeviceID, snmpTrapSrvPort=snmpTrapSrvPort)
