...
ModuleIdentity, enterprises, iso, Unsigned32, Counter64, NotificationType, MibIdentifier, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, ObjectIdentity, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "iso", "Unsigned32", "Counter64", "NotificationType", "MibIdentifier", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "ObjectIdentity", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDeviceID=psDeviceID, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, psModuleType=psModuleType, sysDeviceName=sysDeviceName, snmpTrapSrvIP=snmpTrapSrvIP, sysReleaseDate=sysReleaseDate, atPciConfig=atPciConfig, sysDescr=sysDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotTable=pciSlotTable, psIRQ=psIRQ, psIndex=psIndex, psDisplayName=psDisplayName, pciConfigObj=pciConfigObj, sysModuleID=sysModuleID, atSystem=atSystem, sysBootTime=sysBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, psNumber=psNumber, psFunctionIndex=psFunctionIndex, psState=psState, psSubsysVendorID=psSubsysVendorID, psBaseAddress=psBaseAddress, snmpTrapVersion=snmpTrapVersion, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLength=psLength, sysBootCount=sysBootCount, psManufacturer=psManufacturer, psModulePorts=psModulePorts, sysImageVersion=sysImageVersion, advantechCommonMIB=advantechCommonMIB, psLocation=psLocation, psVendorID=psVendorID, snmpTrapSrvTable=snmpTrapSrvTable, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotEntry=pciSlotEntry, advantech=advantech, psClassCode=psClassCode, psSubsysDeviceID=psSubsysDeviceID, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvPort=snmpTrapSrvPort)
