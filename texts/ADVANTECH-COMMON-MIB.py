...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootTime=sysBootTime, snmpTrapSrvPort=snmpTrapSrvPort, psFunctionIndex=psFunctionIndex, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotTable=pciSlotTable, snmpTrapSrvTable=snmpTrapSrvTable, sysModuleID=sysModuleID, psBusIndex=psBusIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, advantech=advantech, psState=psState, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysReleaseDate=sysReleaseDate, snmpTrapSrvNumber=snmpTrapSrvNumber, psManufacturer=psManufacturer, psNumber=psNumber, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, psDescr=psDescr, sysFirstBootTime=sysFirstBootTime, psIRQ=psIRQ, snmpTrapVersion=snmpTrapVersion, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, psLength=psLength, advantechCommonMIB=advantechCommonMIB, atSystem=atSystem, sysDescr=sysDescr, sysBootCount=sysBootCount, atMgmt=atMgmt, pciSlotEntry=pciSlotEntry, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, sysDeviceName=sysDeviceName, snmpTrapSrvEntry=snmpTrapSrvEntry, atPciConfig=atPciConfig, snmpTrapSrvIP=snmpTrapSrvIP, sysImageVersion=sysImageVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceID=psDeviceID, psIndex=psIndex, psLocation=psLocation, psDisplayName=psDisplayName, psClassCode=psClassCode)
