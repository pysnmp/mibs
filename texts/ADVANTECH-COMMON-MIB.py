...
enterprises, ModuleIdentity, MibIdentifier, TimeTicks, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, Counter64, Gauge32, NotificationType, IpAddress, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "Counter64", "Gauge32", "NotificationType", "IpAddress", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvNumber=snmpTrapSrvNumber, atPciConfig=atPciConfig, psBusIndex=psBusIndex, atSystem=atSystem, psSubsysVendorID=psSubsysVendorID, sysFirstBootTime=sysFirstBootTime, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, psLocation=psLocation, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceID=psDeviceID, sysReleaseDate=sysReleaseDate, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, pciSlotEntry=pciSlotEntry, psDescr=psDescr, psVendorID=psVendorID, sysModuleID=sysModuleID, psBaseAddress=psBaseAddress, atMgmt=atMgmt, psModuleType=psModuleType, snmpTrapVersion=snmpTrapVersion, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, psFunctionIndex=psFunctionIndex, psState=psState, psManufacturer=psManufacturer, snmpTrapSrvIndex=snmpTrapSrvIndex, psDisplayName=psDisplayName, advantech=advantech, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceIndex=psDeviceIndex, psModulePorts=psModulePorts, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootCount=sysBootCount, sysDescr=sysDescr, psNumber=psNumber, psIRQ=psIRQ, sysBootTime=sysBootTime, pciConfigObj=pciConfigObj, pciSlotTable=pciSlotTable, snmpTrapSrvEntry=snmpTrapSrvEntry, advantechCommonMIB=advantechCommonMIB, psClassCode=psClassCode, psLength=psLength)
