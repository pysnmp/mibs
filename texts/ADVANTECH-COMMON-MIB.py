...
# Produced by pysmi-1.1.3 at Wed Dec  8 21:25:45 2021
...
NotificationType, ObjectIdentity, Integer32, Counter32, Counter64, TimeTicks, iso, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Unsigned32, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Integer32", "Counter32", "Counter64", "TimeTicks", "iso", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Unsigned32", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysDeviceID=psSubsysDeviceID, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, psFunctionIndex=psFunctionIndex, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvNumber=snmpTrapSrvNumber, psVendorID=psVendorID, sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, psState=psState, psModuleType=psModuleType, sysBootTime=sysBootTime, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvEntry=snmpTrapSrvEntry, atSystem=atSystem, pciSlotEntry=pciSlotEntry, psIRQ=psIRQ, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysModuleID=sysModuleID, psDisplayName=psDisplayName, psDeviceID=psDeviceID, psIndex=psIndex, advantech=advantech, psLength=psLength, sysReleaseDate=sysReleaseDate, pciSlotTable=pciSlotTable, sysFirstBootTime=sysFirstBootTime, psModulePorts=psModulePorts, atPciConfig=atPciConfig, sysImageVersion=sysImageVersion, atMgmt=atMgmt, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, psManufacturer=psManufacturer, psLocation=psLocation, psBaseAddress=psBaseAddress, snmpTrapSrvPort=snmpTrapSrvPort, sysDeviceName=sysDeviceName, psClassCode=psClassCode, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, psNumber=psNumber, psDescr=psDescr, psBusIndex=psBusIndex)
