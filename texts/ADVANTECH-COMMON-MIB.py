...
# Produced by pysmi-1.1.3 at Sat Nov 20 21:23:05 2021
...
ModuleIdentity, TimeTicks, Integer32, Gauge32, Counter32, enterprises, NotificationType, IpAddress, ObjectIdentity, Counter64, Bits, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Integer32", "Gauge32", "Counter32", "enterprises", "NotificationType", "IpAddress", "ObjectIdentity", "Counter64", "Bits", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psVendorID=psVendorID, psFunctionIndex=psFunctionIndex, advantech=advantech, atMgmt=atMgmt, pciConfigObj=pciConfigObj, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, snmpTrapSrvNumber=snmpTrapSrvNumber, psIndex=psIndex, psDeviceID=psDeviceID, psModuleType=psModuleType, sysDeviceName=sysDeviceName, snmpTrapSrvTable=snmpTrapSrvTable, sysReleaseDate=sysReleaseDate, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLength=psLength, psClassCode=psClassCode, snmpTrapSrvPort=snmpTrapSrvPort, atSystem=atSystem, atPciConfig=atPciConfig, psIRQ=psIRQ, snmpTrapSrvObj=snmpTrapSrvObj, psState=psState, psSubsysDeviceID=psSubsysDeviceID, advantechCommonMIB=advantechCommonMIB, psDeviceIndex=psDeviceIndex, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, psManufacturer=psManufacturer, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDescr=sysDescr, psLocation=psLocation, psSubsysVendorID=psSubsysVendorID, sysModuleID=sysModuleID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootTime=sysBootTime, psDisplayName=psDisplayName, snmpTrapSrvIP=snmpTrapSrvIP, sysFirstBootTime=sysFirstBootTime, pciSlotEntry=pciSlotEntry, psDescr=psDescr, sysBootCount=sysBootCount, psModulePorts=psModulePorts, pciSlotTable=pciSlotTable, sysImageVersion=sysImageVersion)
