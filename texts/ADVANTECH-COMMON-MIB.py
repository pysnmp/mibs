...
Gauge32, ModuleIdentity, IpAddress, TimeTicks, Counter32, Unsigned32, ObjectIdentity, MibIdentifier, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "IpAddress", "TimeTicks", "Counter32", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "iso", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysDeviceID=psSubsysDeviceID, sysModuleID=sysModuleID, psIRQ=psIRQ, advantech=advantech, psNumber=psNumber, psVendorID=psVendorID, sysBootTime=sysBootTime, sysDeviceName=sysDeviceName, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceID=psDeviceID, psIndex=psIndex, sysReleaseDate=sysReleaseDate, pciConfigObj=pciConfigObj, PYSNMP_MODULE_ID=advantechCommonMIB, psModuleType=psModuleType, atSystem=atSystem, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atPciConfig=atPciConfig, psState=psState, pciSlotEntry=pciSlotEntry, advantechCommonMIB=advantechCommonMIB, psManufacturer=psManufacturer, psClassCode=psClassCode, snmpTrapSrvTable=snmpTrapSrvTable, sysFirstBootTime=sysFirstBootTime, sysBootCount=sysBootCount, psLocation=psLocation, psSubsysVendorID=psSubsysVendorID, psDisplayName=psDisplayName, atMgmt=atMgmt, snmpTrapSrvIP=snmpTrapSrvIP, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, psDeviceIndex=psDeviceIndex, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotTable=pciSlotTable, psFunctionIndex=psFunctionIndex, psDescr=psDescr, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, psLength=psLength, psBaseAddress=psBaseAddress)
