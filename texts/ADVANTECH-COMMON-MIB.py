...
Counter32, Bits, ObjectIdentity, MibIdentifier, TimeTicks, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, Gauge32, Counter64, ModuleIdentity, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "ObjectIdentity", "MibIdentifier", "TimeTicks", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "Gauge32", "Counter64", "ModuleIdentity", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, snmpTrapSrvIP=snmpTrapSrvIP, psFunctionIndex=psFunctionIndex, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, sysFirstBootTime=sysFirstBootTime, advantech=advantech, psSubsysVendorID=psSubsysVendorID, psIRQ=psIRQ, psBaseAddress=psBaseAddress, snmpTrapSrvEntry=snmpTrapSrvEntry, psLength=psLength, pciSlotTable=pciSlotTable, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psNumber=psNumber, psLocation=psLocation, sysBootTime=sysBootTime, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, atMgmt=atMgmt, sysModuleID=sysModuleID, psDescr=psDescr, pciSlotEntry=pciSlotEntry, psClassCode=psClassCode, psVendorID=psVendorID, sysDeviceName=sysDeviceName, snmpTrapSrvPort=snmpTrapSrvPort, psIndex=psIndex, psDeviceID=psDeviceID, psDeviceIndex=psDeviceIndex, sysDescr=sysDescr, atPciConfig=atPciConfig, psModuleType=psModuleType, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName, sysReleaseDate=sysReleaseDate, PYSNMP_MODULE_ID=advantechCommonMIB, sysImageVersion=sysImageVersion, atSystem=atSystem, psState=psState, psSubsysDeviceID=psSubsysDeviceID, psManufacturer=psManufacturer, snmpTrapSrvIndex=snmpTrapSrvIndex)
