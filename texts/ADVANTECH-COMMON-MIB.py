...
Bits, ObjectIdentity, NotificationType, Integer32, Gauge32, Counter32, MibIdentifier, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Counter64, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "NotificationType", "Integer32", "Gauge32", "Counter32", "MibIdentifier", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Counter64", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, sysBootTime=sysBootTime, psFunctionIndex=psFunctionIndex, psBaseAddress=psBaseAddress, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvTable=snmpTrapSrvTable, sysImageVersion=sysImageVersion, psManufacturer=psManufacturer, pciConfigObj=pciConfigObj, snmpTrapSrvEntry=snmpTrapSrvEntry, sysDescr=sysDescr, psSubsysDeviceID=psSubsysDeviceID, psIRQ=psIRQ, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotEntry=pciSlotEntry, psState=psState, psDisplayName=psDisplayName, psModuleType=psModuleType, sysModuleID=sysModuleID, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysVendorID=psSubsysVendorID, psDescr=psDescr, psNumber=psNumber, atMgmt=atMgmt, psDeviceID=psDeviceID, advantech=advantech, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLength=psLength, atPciConfig=atPciConfig, psIndex=psIndex, snmpTrapVersion=snmpTrapVersion, sysBootCount=sysBootCount, sysDeviceName=sysDeviceName, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotTable=pciSlotTable, psDeviceIndex=psDeviceIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psClassCode=psClassCode, psVendorID=psVendorID, psLocation=psLocation, psBusIndex=psBusIndex, atSystem=atSystem, sysReleaseDate=sysReleaseDate)
