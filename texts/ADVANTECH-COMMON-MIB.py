...
ModuleIdentity, iso, NotificationType, IpAddress, enterprises, Counter64, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, Bits, Gauge32, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "NotificationType", "IpAddress", "enterprises", "Counter64", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "Bits", "Gauge32", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvObj=snmpTrapSrvObj, sysBootCount=sysBootCount, psSubsysVendorID=psSubsysVendorID, psSubsysDeviceID=psSubsysDeviceID, psDeviceIndex=psDeviceIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psVendorID=psVendorID, psLength=psLength, psClassCode=psClassCode, psState=psState, atPciConfig=atPciConfig, psIndex=psIndex, atSystem=atSystem, sysModuleID=sysModuleID, psFunctionIndex=psFunctionIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, advantechCommonMIB=advantechCommonMIB, psDeviceID=psDeviceID, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, psBusIndex=psBusIndex, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, pciConfigObj=pciConfigObj, psManufacturer=psManufacturer, psModuleType=psModuleType, psIRQ=psIRQ, pciSlotEntry=pciSlotEntry, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootTime=sysBootTime, snmpTrapVersion=snmpTrapVersion, sysDescr=sysDescr, sysDeviceName=sysDeviceName, psLocation=psLocation, psNumber=psNumber, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIP=snmpTrapSrvIP, advantech=advantech, sysReleaseDate=sysReleaseDate, atMgmt=atMgmt, pciSlotTable=pciSlotTable, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDisplayName=psDisplayName)
