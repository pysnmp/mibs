...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:51:20 2022
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, iso, Integer32, MibIdentifier, NotificationType, Gauge32, Counter64, Bits, TimeTicks, enterprises, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "iso", "Integer32", "MibIdentifier", "NotificationType", "Gauge32", "Counter64", "Bits", "TimeTicks", "enterprises", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDescr=psDescr, sysBootCount=sysBootCount, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciConfigObj=pciConfigObj, pciSlotEntry=pciSlotEntry, psIRQ=psIRQ, psLocation=psLocation, psIndex=psIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, sysImageVersion=sysImageVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvObj=snmpTrapSrvObj, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceID=psDeviceID, advantechCommonMIB=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, psVendorID=psVendorID, atMgmt=atMgmt, snmpTrapSrvTable=snmpTrapSrvTable, sysModuleID=sysModuleID, sysBootTime=sysBootTime, psBusIndex=psBusIndex, psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, psManufacturer=psManufacturer, psNumber=psNumber, psDeviceIndex=psDeviceIndex, sysReleaseDate=sysReleaseDate, psState=psState, psClassCode=psClassCode, snmpTrapVersion=snmpTrapVersion, psFunctionIndex=psFunctionIndex, psLength=psLength, sysFirstBootTime=sysFirstBootTime, sysDeviceName=sysDeviceName, sysDescr=sysDescr, advantech=advantech, atSystem=atSystem, psModuleType=psModuleType, psSubsysVendorID=psSubsysVendorID, psModulePorts=psModulePorts, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atPciConfig=atPciConfig)
