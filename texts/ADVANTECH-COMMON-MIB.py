...
Bits, Counter64, iso, Counter32, ObjectIdentity, enterprises, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Integer32, Gauge32, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "iso", "Counter32", "ObjectIdentity", "enterprises", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Integer32", "Gauge32", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvPort=snmpTrapSrvPort, psLength=psLength, psSubsysDeviceID=psSubsysDeviceID, advantechCommonMIB=advantechCommonMIB, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceID=psDeviceID, psManufacturer=psManufacturer, psDescr=psDescr, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, sysBootTime=sysBootTime, sysBootCount=sysBootCount, snmpTrapSrvIndex=snmpTrapSrvIndex, advantech=advantech, sysDescr=sysDescr, atPciConfig=atPciConfig, psBaseAddress=psBaseAddress, psClassCode=psClassCode, psIRQ=psIRQ, psNumber=psNumber, psModulePorts=psModulePorts, atMgmt=atMgmt, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvObj=snmpTrapSrvObj, psIndex=psIndex, psLocation=psLocation, pciSlotTable=pciSlotTable, psSubsysVendorID=psSubsysVendorID, sysReleaseDate=sysReleaseDate, psDeviceIndex=psDeviceIndex, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, psVendorID=psVendorID, sysDeviceName=sysDeviceName, psModuleType=psModuleType, atSystem=atSystem, sysModuleID=sysModuleID, psState=psState, sysFirstBootTime=sysFirstBootTime, psDisplayName=psDisplayName, pciConfigObj=pciConfigObj, pciSlotEntry=pciSlotEntry)
