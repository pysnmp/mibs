...
Counter64, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, Unsigned32, IpAddress, ObjectIdentity, Counter32, Integer32, Gauge32, iso, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "Unsigned32", "IpAddress", "ObjectIdentity", "Counter32", "Integer32", "Gauge32", "iso", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapVersion=snmpTrapVersion, psLocation=psLocation, pciConfigObj=pciConfigObj, psDisplayName=psDisplayName, psIndex=psIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootTime=sysBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, sysImageVersion=sysImageVersion, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, psLength=psLength, psIRQ=psIRQ, snmpTrapSrvTable=snmpTrapSrvTable, sysDescr=sysDescr, atMgmt=atMgmt, psClassCode=psClassCode, psFunctionIndex=psFunctionIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, psSubsysVendorID=psSubsysVendorID, psNumber=psNumber, psBaseAddress=psBaseAddress, sysDeviceName=sysDeviceName, atPciConfig=atPciConfig, sysReleaseDate=sysReleaseDate, sysBootCount=sysBootCount, psDeviceID=psDeviceID, sysFirstBootTime=sysFirstBootTime, psManufacturer=psManufacturer, psModulePorts=psModulePorts, pciSlotEntry=pciSlotEntry, psState=psState, advantech=advantech, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psDescr=psDescr, psVendorID=psVendorID, pciSlotTable=pciSlotTable, PYSNMP_MODULE_ID=advantechCommonMIB, sysModuleID=sysModuleID, psSubsysDeviceID=psSubsysDeviceID, atSystem=atSystem, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvObj=snmpTrapSrvObj)
