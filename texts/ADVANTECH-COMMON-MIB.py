...
ModuleIdentity, MibIdentifier, enterprises, Integer32, Unsigned32, Counter32, ObjectIdentity, NotificationType, Gauge32, IpAddress, Counter64, Bits, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "enterprises", "Integer32", "Unsigned32", "Counter32", "ObjectIdentity", "NotificationType", "Gauge32", "IpAddress", "Counter64", "Bits", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceID=psDeviceID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDescr=sysDescr, psVendorID=psVendorID, psLength=psLength, psDescr=psDescr, sysDeviceName=sysDeviceName, snmpTrapSrvIP=snmpTrapSrvIP, psModuleType=psModuleType, sysBootTime=sysBootTime, psIRQ=psIRQ, psClassCode=psClassCode, psState=psState, sysModuleID=sysModuleID, psManufacturer=psManufacturer, sysFirstBootTime=sysFirstBootTime, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, pciSlotTable=pciSlotTable, pciSlotEntry=pciSlotEntry, atSystem=atSystem, atPciConfig=atPciConfig, atMgmt=atMgmt, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysDeviceID=psSubsysDeviceID, psBusIndex=psBusIndex, snmpTrapVersion=snmpTrapVersion, advantech=advantech, psLocation=psLocation, pciConfigObj=pciConfigObj, psModulePorts=psModulePorts, sysBootCount=sysBootCount, psNumber=psNumber, sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceIndex=psDeviceIndex, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, psFunctionIndex=psFunctionIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysReleaseDate=sysReleaseDate)
