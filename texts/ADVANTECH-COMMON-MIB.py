...
TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, enterprises, Gauge32, ObjectIdentity, MibIdentifier, Bits, Counter32, ModuleIdentity, Integer32, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "enterprises", "Gauge32", "ObjectIdentity", "MibIdentifier", "Bits", "Counter32", "ModuleIdentity", "Integer32", "Counter64", "iso")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDeviceName=sysDeviceName, psModuleType=psModuleType, psSubsysDeviceID=psSubsysDeviceID, sysBootCount=sysBootCount, sysImageVersion=sysImageVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts, atMgmt=atMgmt, sysReleaseDate=sysReleaseDate, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, atSystem=atSystem, psFunctionIndex=psFunctionIndex, psManufacturer=psManufacturer, advantechCommonMIB=advantechCommonMIB, psClassCode=psClassCode, psBusIndex=psBusIndex, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, pciSlotEntry=pciSlotEntry, psIRQ=psIRQ, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, sysDescr=sysDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvObj=snmpTrapSrvObj, atPciConfig=atPciConfig, snmpTrapVersion=snmpTrapVersion, psDescr=psDescr, psLocation=psLocation, psState=psState, sysFirstBootTime=sysFirstBootTime, psLength=psLength, sysBootTime=sysBootTime, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, psDisplayName=psDisplayName, psNumber=psNumber, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, pciConfigObj=pciConfigObj)
