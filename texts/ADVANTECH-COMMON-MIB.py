...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, Integer32, NotificationType, TimeTicks, IpAddress, ModuleIdentity, Unsigned32, ObjectIdentity, iso, Bits, Counter32, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "Integer32", "NotificationType", "TimeTicks", "IpAddress", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "iso", "Bits", "Counter32", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, psDisplayName=psDisplayName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, psLocation=psLocation, sysFirstBootTime=sysFirstBootTime, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, snmpTrapSrvObj=snmpTrapSrvObj, sysReleaseDate=sysReleaseDate, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, pciSlotEntry=pciSlotEntry, psBaseAddress=psBaseAddress, advantech=advantech, pciSlotTable=pciSlotTable, snmpTrapSrvEntry=snmpTrapSrvEntry, psDescr=psDescr, psDeviceID=psDeviceID, psNumber=psNumber, psFunctionIndex=psFunctionIndex, snmpTrapSrvTable=snmpTrapSrvTable, sysBootTime=sysBootTime, psModulePorts=psModulePorts, sysBootCount=sysBootCount, snmpTrapSrvNumber=snmpTrapSrvNumber, psClassCode=psClassCode, snmpTrapSrvPort=snmpTrapSrvPort, atMgmt=atMgmt, psVendorID=psVendorID, psIRQ=psIRQ, sysDeviceName=sysDeviceName, PYSNMP_MODULE_ID=advantechCommonMIB, atPciConfig=atPciConfig, atSystem=atSystem, sysImageVersion=sysImageVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysModuleID=sysModuleID, psSubsysVendorID=psSubsysVendorID, psLength=psLength, sysDescr=sysDescr, psState=psState, snmpTrapVersion=snmpTrapVersion, psSubsysDeviceID=psSubsysDeviceID)
