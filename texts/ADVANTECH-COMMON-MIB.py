...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Bits, ObjectIdentity, Gauge32, iso, Unsigned32, Counter64, TimeTicks, Counter32, ModuleIdentity, enterprises, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Bits", "ObjectIdentity", "Gauge32", "iso", "Unsigned32", "Counter64", "TimeTicks", "Counter32", "ModuleIdentity", "enterprises", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psState=psState, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotTable=pciSlotTable, psDeviceIndex=psDeviceIndex, psClassCode=psClassCode, sysBootTime=sysBootTime, atSystem=atSystem, psIndex=psIndex, psDeviceID=psDeviceID, snmpTrapSrvNumber=snmpTrapSrvNumber, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, psBusIndex=psBusIndex, advantechCommonMIB=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, psManufacturer=psManufacturer, sysReleaseDate=sysReleaseDate, psBaseAddress=psBaseAddress, sysBootCount=sysBootCount, atMgmt=atMgmt, sysModuleID=sysModuleID, psVendorID=psVendorID, sysDescr=sysDescr, snmpTrapSrvPort=snmpTrapSrvPort, sysDeviceName=sysDeviceName, atPciConfig=atPciConfig, psLocation=psLocation, snmpTrapVersion=snmpTrapVersion, pciConfigObj=pciConfigObj, psIRQ=psIRQ, psLength=psLength, psSubsysVendorID=psSubsysVendorID, psDisplayName=psDisplayName, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotEntry=pciSlotEntry, psDescr=psDescr, psSubsysDeviceID=psSubsysDeviceID, psModuleType=psModuleType, psNumber=psNumber, advantech=advantech, snmpTrapSrvObj=snmpTrapSrvObj, psFunctionIndex=psFunctionIndex, sysImageVersion=sysImageVersion)
