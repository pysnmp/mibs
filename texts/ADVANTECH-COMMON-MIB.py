...
Counter64, iso, Gauge32, ObjectIdentity, enterprises, Counter32, Unsigned32, MibIdentifier, TimeTicks, IpAddress, ModuleIdentity, Bits, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Gauge32", "ObjectIdentity", "enterprises", "Counter32", "Unsigned32", "MibIdentifier", "TimeTicks", "IpAddress", "ModuleIdentity", "Bits", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBusIndex=psBusIndex, pciConfigObj=pciConfigObj, PYSNMP_MODULE_ID=advantechCommonMIB, atSystem=atSystem, pciSlotTable=pciSlotTable, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, psIRQ=psIRQ, snmpTrapVersion=snmpTrapVersion, atMgmt=atMgmt, sysBootCount=sysBootCount, psClassCode=psClassCode, psSubsysVendorID=psSubsysVendorID, psManufacturer=psManufacturer, snmpTrapSrvTable=snmpTrapSrvTable, psModulePorts=psModulePorts, snmpTrapSrvNumber=snmpTrapSrvNumber, psLength=psLength, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, psIndex=psIndex, psSubsysDeviceID=psSubsysDeviceID, psNumber=psNumber, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, sysBootTime=sysBootTime, sysModuleID=sysModuleID, psVendorID=psVendorID, snmpTrapSrvPort=snmpTrapSrvPort, atPciConfig=atPciConfig, psState=psState, psDeviceID=psDeviceID, psLocation=psLocation, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceIndex=psDeviceIndex, psBaseAddress=psBaseAddress, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysReleaseDate=sysReleaseDate, psDisplayName=psDisplayName, psModuleType=psModuleType, advantech=advantech, advantechCommonMIB=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, sysDeviceName=sysDeviceName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication)
