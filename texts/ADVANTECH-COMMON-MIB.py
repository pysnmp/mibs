...
# Produced by pysmi-1.1.8 at Sat Jan 15 19:26:51 2022
...
NotificationType, MibIdentifier, Bits, Unsigned32, IpAddress, ObjectIdentity, iso, Counter32, Counter64, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Bits", "Unsigned32", "IpAddress", "ObjectIdentity", "iso", "Counter32", "Counter64", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantech=advantech, psDisplayName=psDisplayName, sysModuleID=sysModuleID, psClassCode=psClassCode, sysDeviceName=sysDeviceName, psVendorID=psVendorID, psBaseAddress=psBaseAddress, psDeviceID=psDeviceID, advantechCommonMIB=advantechCommonMIB, pciConfigObj=pciConfigObj, psLocation=psLocation, psNumber=psNumber, psLength=psLength, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvNumber=snmpTrapSrvNumber, atSystem=atSystem, sysBootTime=sysBootTime, sysBootCount=sysBootCount, psModuleType=psModuleType, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, sysDescr=sysDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysVendorID=psSubsysVendorID, psIRQ=psIRQ, psSubsysDeviceID=psSubsysDeviceID, psManufacturer=psManufacturer, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, psFunctionIndex=psFunctionIndex, sysFirstBootTime=sysFirstBootTime, psBusIndex=psBusIndex, snmpTrapSrvPort=snmpTrapSrvPort, psState=psState, psDescr=psDescr, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvTable=snmpTrapSrvTable, sysReleaseDate=sysReleaseDate, snmpTrapSrvIndex=snmpTrapSrvIndex, atPciConfig=atPciConfig, psIndex=psIndex, psModulePorts=psModulePorts, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysImageVersion=sysImageVersion, pciSlotTable=pciSlotTable, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotEntry=pciSlotEntry)
