...
# Produced by pysmi-1.1.3 at Tue Dec  7 14:20:55 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, Integer32, Bits, IpAddress, MibIdentifier, TimeTicks, Unsigned32, ObjectIdentity, Counter32, iso, NotificationType, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "Integer32", "Bits", "IpAddress", "MibIdentifier", "TimeTicks", "Unsigned32", "ObjectIdentity", "Counter32", "iso", "NotificationType", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIndex=psIndex, psBusIndex=psBusIndex, psModulePorts=psModulePorts, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapVersion=snmpTrapVersion, pciConfigObj=pciConfigObj, psManufacturer=psManufacturer, psIRQ=psIRQ, psVendorID=psVendorID, sysDescr=sysDescr, psLocation=psLocation, snmpTrapSrvEntry=snmpTrapSrvEntry, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, snmpTrapSrvTable=snmpTrapSrvTable, sysImageVersion=sysImageVersion, sysBootCount=sysBootCount, pciSlotTable=pciSlotTable, psDisplayName=psDisplayName, atMgmt=atMgmt, sysFirstBootTime=sysFirstBootTime, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, snmpTrapSrvIP=snmpTrapSrvIP, sysReleaseDate=sysReleaseDate, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysVendorID=psSubsysVendorID, pciSlotEntry=pciSlotEntry, psDescr=psDescr, psDeviceIndex=psDeviceIndex, atSystem=atSystem, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootTime=sysBootTime, sysModuleID=sysModuleID, psBaseAddress=psBaseAddress, psFunctionIndex=psFunctionIndex, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceID=psDeviceID, psLength=psLength, advantech=advantech, psNumber=psNumber, atPciConfig=atPciConfig, psState=psState)
