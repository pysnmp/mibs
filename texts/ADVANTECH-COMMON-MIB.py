...
IpAddress, NotificationType, TimeTicks, ObjectIdentity, enterprises, Gauge32, MibIdentifier, iso, ModuleIdentity, Counter64, Integer32, Counter32, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "TimeTicks", "ObjectIdentity", "enterprises", "Gauge32", "MibIdentifier", "iso", "ModuleIdentity", "Counter64", "Integer32", "Counter32", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvEntry=snmpTrapSrvEntry, psBaseAddress=psBaseAddress, psDescr=psDescr, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvTable=snmpTrapSrvTable, psDisplayName=psDisplayName, psManufacturer=psManufacturer, psBusIndex=psBusIndex, atMgmt=atMgmt, psFunctionIndex=psFunctionIndex, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, atPciConfig=atPciConfig, sysReleaseDate=sysReleaseDate, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvObj=snmpTrapSrvObj, sysBootTime=sysBootTime, psState=psState, pciSlotEntry=pciSlotEntry, advantech=advantech, psModulePorts=psModulePorts, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotTable=pciSlotTable, psLocation=psLocation, psLength=psLength, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, psIRQ=psIRQ, sysModuleID=sysModuleID, sysImageVersion=sysImageVersion, PYSNMP_MODULE_ID=advantechCommonMIB, pciConfigObj=pciConfigObj, psIndex=psIndex, psDeviceID=psDeviceID, sysFirstBootTime=sysFirstBootTime, psVendorID=psVendorID, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, psNumber=psNumber, psClassCode=psClassCode, psModuleType=psModuleType, psDeviceIndex=psDeviceIndex, sysBootCount=sysBootCount, psSubsysVendorID=psSubsysVendorID)
