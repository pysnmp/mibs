...
ObjectIdentity, ModuleIdentity, MibIdentifier, TimeTicks, Integer32, iso, Unsigned32, Counter32, Gauge32, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Integer32", "iso", "Unsigned32", "Counter32", "Gauge32", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, psClassCode=psClassCode, sysBootCount=sysBootCount, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvTable=snmpTrapSrvTable, advantech=advantech, psModulePorts=psModulePorts, pciConfigObj=pciConfigObj, psBaseAddress=psBaseAddress, psDeviceIndex=psDeviceIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, psDescr=psDescr, PYSNMP_MODULE_ID=advantechCommonMIB, psModuleType=psModuleType, psSubsysVendorID=psSubsysVendorID, psLength=psLength, atPciConfig=atPciConfig, psManufacturer=psManufacturer, snmpTrapVersion=snmpTrapVersion, psIRQ=psIRQ, sysModuleID=sysModuleID, sysBootTime=sysBootTime, pciSlotEntry=pciSlotEntry, psVendorID=psVendorID, psSubsysDeviceID=psSubsysDeviceID, advantechCommonMIB=advantechCommonMIB, psDeviceID=psDeviceID, atSystem=atSystem, sysDeviceName=sysDeviceName, psState=psState, atMgmt=atMgmt, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvObj=snmpTrapSrvObj, psNumber=psNumber, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate, psIndex=psIndex, sysImageVersion=sysImageVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort)
