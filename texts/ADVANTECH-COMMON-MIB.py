...
# Produced by pysmi-1.1.8 at Sat Jan 15 20:08:04 2022
...
Counter32, Integer32, Bits, ObjectIdentity, MibIdentifier, NotificationType, Gauge32, ModuleIdentity, Counter64, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Bits", "ObjectIdentity", "MibIdentifier", "NotificationType", "Gauge32", "ModuleIdentity", "Counter64", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDeviceName=sysDeviceName, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, psNumber=psNumber, psLength=psLength, psIndex=psIndex, psBaseAddress=psBaseAddress, atSystem=atSystem, psState=psState, advantech=advantech, psClassCode=psClassCode, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, psManufacturer=psManufacturer, sysBootCount=sysBootCount, psModuleType=psModuleType, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootTime=sysBootTime, psSubsysVendorID=psSubsysVendorID, atPciConfig=atPciConfig, PYSNMP_MODULE_ID=advantechCommonMIB, pciConfigObj=pciConfigObj, psDeviceID=psDeviceID, psIRQ=psIRQ, snmpTrapSrvEntry=snmpTrapSrvEntry, psDisplayName=psDisplayName, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceIndex=psDeviceIndex, sysReleaseDate=sysReleaseDate, snmpTrapVersion=snmpTrapVersion, psDescr=psDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, sysModuleID=sysModuleID, advantechCommonMIB=advantechCommonMIB, psVendorID=psVendorID, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDescr=sysDescr, psLocation=psLocation, snmpTrapSrvObj=snmpTrapSrvObj, psModulePorts=psModulePorts, atMgmt=atMgmt, sysFirstBootTime=sysFirstBootTime)
