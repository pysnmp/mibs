...
# Produced by pysmi-1.1.8 at Sat Jan 15 04:24:28 2022
...
IpAddress, enterprises, NotificationType, Integer32, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Counter64, TimeTicks, Bits, Counter32, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "NotificationType", "Integer32", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Counter64", "TimeTicks", "Bits", "Counter32", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModuleType=psModuleType, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, sysBootCount=sysBootCount, psFunctionIndex=psFunctionIndex, psManufacturer=psManufacturer, psLocation=psLocation, advantechCommonMIB=advantechCommonMIB, atSystem=atSystem, snmpTrapSrvTable=snmpTrapSrvTable, psBusIndex=psBusIndex, psDisplayName=psDisplayName, snmpTrapSrvEntry=snmpTrapSrvEntry, atMgmt=atMgmt, sysImageVersion=sysImageVersion, psNumber=psNumber, psIRQ=psIRQ, advantech=advantech, psState=psState, psDeviceIndex=psDeviceIndex, pciSlotTable=pciSlotTable, psVendorID=psVendorID, psLength=psLength, pciSlotEntry=pciSlotEntry, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDeviceName=sysDeviceName, sysDescr=sysDescr, psBaseAddress=psBaseAddress, pciConfigObj=pciConfigObj, atPciConfig=atPciConfig, sysReleaseDate=sysReleaseDate, psIndex=psIndex, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysVendorID=psSubsysVendorID, sysFirstBootTime=sysFirstBootTime, psClassCode=psClassCode, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvPort=snmpTrapSrvPort, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceID=psDeviceID, sysModuleID=sysModuleID, sysBootTime=sysBootTime)
