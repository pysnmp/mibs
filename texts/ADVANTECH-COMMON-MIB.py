...
ModuleIdentity, TimeTicks, Gauge32, MibIdentifier, iso, NotificationType, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, enterprises, Integer32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Gauge32", "MibIdentifier", "iso", "NotificationType", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "enterprises", "Integer32", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModuleType=psModuleType, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvTable=snmpTrapSrvTable, psNumber=psNumber, psLocation=psLocation, sysDeviceName=sysDeviceName, psLength=psLength, sysReleaseDate=sysReleaseDate, sysImageVersion=sysImageVersion, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciConfigObj=pciConfigObj, psDeviceIndex=psDeviceIndex, psFunctionIndex=psFunctionIndex, psDescr=psDescr, psState=psState, sysDescr=sysDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDisplayName=psDisplayName, sysBootCount=sysBootCount, snmpTrapVersion=snmpTrapVersion, psIRQ=psIRQ, psBusIndex=psBusIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, atSystem=atSystem, psVendorID=psVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, atPciConfig=atPciConfig, sysBootTime=sysBootTime, psIndex=psIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psManufacturer=psManufacturer, psSubsysVendorID=psSubsysVendorID, psBaseAddress=psBaseAddress, psDeviceID=psDeviceID, psModulePorts=psModulePorts, pciSlotTable=pciSlotTable, atMgmt=atMgmt, sysModuleID=sysModuleID, snmpTrapSrvIP=snmpTrapSrvIP, advantech=advantech, psClassCode=psClassCode, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID)
