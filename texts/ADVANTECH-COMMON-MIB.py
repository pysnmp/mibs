...
Bits, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Unsigned32, Counter64, NotificationType, ModuleIdentity, Counter32, ObjectIdentity, TimeTicks, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Unsigned32", "Counter64", "NotificationType", "ModuleIdentity", "Counter32", "ObjectIdentity", "TimeTicks", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotTable=pciSlotTable, psState=psState, sysFirstBootTime=sysFirstBootTime, psDeviceID=psDeviceID, snmpTrapSrvIndex=snmpTrapSrvIndex, atMgmt=atMgmt, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysVendorID=psSubsysVendorID, psDeviceIndex=psDeviceIndex, psBusIndex=psBusIndex, psSubsysDeviceID=psSubsysDeviceID, psDescr=psDescr, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, advantechCommonMIB=advantechCommonMIB, psBaseAddress=psBaseAddress, pciConfigObj=pciConfigObj, sysBootCount=sysBootCount, psClassCode=psClassCode, psModulePorts=psModulePorts, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psManufacturer=psManufacturer, psLength=psLength, atSystem=atSystem, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvTable=snmpTrapSrvTable, sysDeviceName=sysDeviceName, sysBootTime=sysBootTime, sysReleaseDate=sysReleaseDate, psIndex=psIndex, psNumber=psNumber, psIRQ=psIRQ, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvEntry=snmpTrapSrvEntry, atPciConfig=atPciConfig, snmpTrapVersion=snmpTrapVersion, psLocation=psLocation, psModuleType=psModuleType, advantech=advantech)
