...
IpAddress, enterprises, iso, Bits, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Counter32, ModuleIdentity, MibIdentifier, Integer32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "iso", "Bits", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Counter32", "ModuleIdentity", "MibIdentifier", "Integer32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysReleaseDate=sysReleaseDate, snmpTrapSrvPort=snmpTrapSrvPort, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atMgmt=atMgmt, psIRQ=psIRQ, psLength=psLength, psDeviceID=psDeviceID, psFunctionIndex=psFunctionIndex, psVendorID=psVendorID, sysBootTime=sysBootTime, psModulePorts=psModulePorts, psLocation=psLocation, psManufacturer=psManufacturer, snmpTrapSrvIP=snmpTrapSrvIP, psState=psState, advantech=advantech, psNumber=psNumber, psDescr=psDescr, sysImageVersion=sysImageVersion, psSubsysDeviceID=psSubsysDeviceID, advantechCommonMIB=advantechCommonMIB, pciSlotTable=pciSlotTable, snmpTrapSrvIndex=snmpTrapSrvIndex, atPciConfig=atPciConfig, psSubsysVendorID=psSubsysVendorID, sysModuleID=sysModuleID, pciSlotEntry=pciSlotEntry, pciConfigObj=pciConfigObj, psDeviceIndex=psDeviceIndex, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapVersion=snmpTrapVersion, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootCount=sysBootCount, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName, sysDeviceName=sysDeviceName, psIndex=psIndex, atSystem=atSystem, sysDescr=sysDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, psModuleType=psModuleType, sysFirstBootTime=sysFirstBootTime)
