...
iso, MibIdentifier, enterprises, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, ObjectIdentity, Unsigned32, Bits, Counter64, Counter32, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "enterprises", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "ObjectIdentity", "Unsigned32", "Bits", "Counter64", "Counter32", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, psManufacturer=psManufacturer, psDeviceID=psDeviceID, advantechCommonMIB=advantechCommonMIB, advantech=advantech, sysModuleID=sysModuleID, atSystem=atSystem, psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, psClassCode=psClassCode, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapVersion=snmpTrapVersion, psBaseAddress=psBaseAddress, psVendorID=psVendorID, psFunctionIndex=psFunctionIndex, sysFirstBootTime=sysFirstBootTime, sysBootCount=sysBootCount, psDescr=psDescr, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDeviceName=sysDeviceName, atMgmt=atMgmt, psIndex=psIndex, sysDescr=sysDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysImageVersion=sysImageVersion, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, psModulePorts=psModulePorts, psDeviceIndex=psDeviceIndex, psNumber=psNumber, psLocation=psLocation, psModuleType=psModuleType, atPciConfig=atPciConfig, psSubsysDeviceID=psSubsysDeviceID, psDisplayName=psDisplayName, psIRQ=psIRQ, psLength=psLength, psState=psState, pciSlotTable=pciSlotTable, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotEntry=pciSlotEntry)
