...
ObjectIdentity, Integer32, Counter64, ModuleIdentity, Gauge32, TimeTicks, NotificationType, iso, Unsigned32, IpAddress, Bits, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "Counter64", "ModuleIdentity", "Gauge32", "TimeTicks", "NotificationType", "iso", "Unsigned32", "IpAddress", "Bits", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBusIndex=psBusIndex, sysReleaseDate=sysReleaseDate, psVendorID=psVendorID, psSubsysDeviceID=psSubsysDeviceID, sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psNumber=psNumber, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, psLength=psLength, psFunctionIndex=psFunctionIndex, advantech=advantech, sysBootCount=sysBootCount, psClassCode=psClassCode, atPciConfig=atPciConfig, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvTable=snmpTrapSrvTable, psState=psState, psManufacturer=psManufacturer, atSystem=atSystem, snmpTrapSrvEntry=snmpTrapSrvEntry, atMgmt=atMgmt, sysDescr=sysDescr, psModulePorts=psModulePorts, sysFirstBootTime=sysFirstBootTime, sysImageVersion=sysImageVersion, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvIndex=snmpTrapSrvIndex, psLocation=psLocation, psDeviceIndex=psDeviceIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysModuleID=sysModuleID, psIRQ=psIRQ, snmpTrapSrvNumber=snmpTrapSrvNumber, psDisplayName=psDisplayName, psDescr=psDescr, psBaseAddress=psBaseAddress, psIndex=psIndex, psDeviceID=psDeviceID, snmpTrapVersion=snmpTrapVersion, pciSlotEntry=pciSlotEntry, snmpTrapSrvPort=snmpTrapSrvPort, advantechCommonMIB=advantechCommonMIB, pciSlotTable=pciSlotTable, psModuleType=psModuleType, pciConfigObj=pciConfigObj)
