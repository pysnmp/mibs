...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantechCommonMIB=advantechCommonMIB, pciConfigObj=pciConfigObj, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvTable=snmpTrapSrvTable, psVendorID=psVendorID, psFunctionIndex=psFunctionIndex, sysBootCount=sysBootCount, atMgmt=atMgmt, psLength=psLength, psIRQ=psIRQ, pciSlotEntry=pciSlotEntry, psDisplayName=psDisplayName, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, psManufacturer=psManufacturer, advantech=advantech, sysDescr=sysDescr, sysBootTime=sysBootTime, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIP=snmpTrapSrvIP, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModulePorts=psModulePorts, psNumber=psNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, psBaseAddress=psBaseAddress, pciSlotTable=pciSlotTable, psBusIndex=psBusIndex, psLocation=psLocation, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIndex=psIndex, atPciConfig=atPciConfig, sysModuleID=sysModuleID, atSystem=atSystem, sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, psDeviceIndex=psDeviceIndex, psDeviceID=psDeviceID, sysReleaseDate=sysReleaseDate, psState=psState, sysDeviceName=sysDeviceName, psModuleType=psModuleType, psDescr=psDescr)
