...
Bits, Counter64, NotificationType, MibIdentifier, ModuleIdentity, iso, Integer32, ObjectIdentity, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "NotificationType", "MibIdentifier", "ModuleIdentity", "iso", "Integer32", "ObjectIdentity", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysReleaseDate=sysReleaseDate, sysImageVersion=sysImageVersion, psSubsysDeviceID=psSubsysDeviceID, psLength=psLength, sysDeviceName=sysDeviceName, advantechCommonMIB=advantechCommonMIB, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName, psModuleType=psModuleType, advantech=advantech, psSubsysVendorID=psSubsysVendorID, psDeviceID=psDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, atMgmt=atMgmt, psNumber=psNumber, psState=psState, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvTable=snmpTrapSrvTable, psLocation=psLocation, psFunctionIndex=psFunctionIndex, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, psModulePorts=psModulePorts, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciSlotEntry=pciSlotEntry, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootCount=sysBootCount, snmpTrapSrvIndex=snmpTrapSrvIndex, sysModuleID=sysModuleID, psDeviceIndex=psDeviceIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psBaseAddress=psBaseAddress, psManufacturer=psManufacturer, psIndex=psIndex, psVendorID=psVendorID, psClassCode=psClassCode, psIRQ=psIRQ, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atPciConfig=atPciConfig, snmpTrapSrvIP=snmpTrapSrvIP, atSystem=atSystem, psDescr=psDescr, sysBootTime=sysBootTime, pciSlotTable=pciSlotTable)
