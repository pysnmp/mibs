...
Unsigned32, Bits, IpAddress, enterprises, Counter32, TimeTicks, Gauge32, ModuleIdentity, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "IpAddress", "enterprises", "Counter32", "TimeTicks", "Gauge32", "ModuleIdentity", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psVendorID=psVendorID, sysDescr=sysDescr, sysBootTime=sysBootTime, atSystem=atSystem, psSubsysDeviceID=psSubsysDeviceID, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvTable=snmpTrapSrvTable, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, atMgmt=atMgmt, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, advantechCommonMIB=advantechCommonMIB, psDescr=psDescr, psBaseAddress=psBaseAddress, snmpTrapSrvNumber=snmpTrapSrvNumber, psFunctionIndex=psFunctionIndex, psModuleType=psModuleType, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceID=psDeviceID, sysImageVersion=sysImageVersion, psSubsysVendorID=psSubsysVendorID, psModulePorts=psModulePorts, psManufacturer=psManufacturer, psDisplayName=psDisplayName, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceIndex=psDeviceIndex, psIndex=psIndex, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvPort=snmpTrapSrvPort, pciConfigObj=pciConfigObj, advantech=advantech, psClassCode=psClassCode, snmpTrapSrvIndex=snmpTrapSrvIndex, psState=psState, snmpTrapVersion=snmpTrapVersion, atPciConfig=atPciConfig, sysBootCount=sysBootCount, psLocation=psLocation, psNumber=psNumber, psLength=psLength, pciSlotTable=pciSlotTable, sysDeviceName=sysDeviceName, sysReleaseDate=sysReleaseDate, psIRQ=psIRQ)
