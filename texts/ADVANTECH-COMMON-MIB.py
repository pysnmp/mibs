...
ModuleIdentity, Integer32, Unsigned32, NotificationType, iso, MibIdentifier, ObjectIdentity, TimeTicks, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Unsigned32", "NotificationType", "iso", "MibIdentifier", "ObjectIdentity", "TimeTicks", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psNumber=psNumber, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, advantech=advantech, sysDeviceName=sysDeviceName, psDescr=psDescr, psState=psState, pciSlotTable=pciSlotTable, pciSlotEntry=pciSlotEntry, atMgmt=atMgmt, psClassCode=psClassCode, psBaseAddress=psBaseAddress, snmpTrapVersion=snmpTrapVersion, psDeviceIndex=psDeviceIndex, psDeviceID=psDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psVendorID=psVendorID, psLength=psLength, sysDescr=sysDescr, snmpTrapSrvPort=snmpTrapSrvPort, psBusIndex=psBusIndex, atPciConfig=atPciConfig, pciConfigObj=pciConfigObj, advantechCommonMIB=advantechCommonMIB, sysBootTime=sysBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysBootCount=sysBootCount, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, psModuleType=psModuleType, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvNumber=snmpTrapSrvNumber, psFunctionIndex=psFunctionIndex, psIndex=psIndex, psModulePorts=psModulePorts, psIRQ=psIRQ, psManufacturer=psManufacturer, sysModuleID=sysModuleID, atSystem=atSystem, psDisplayName=psDisplayName, psLocation=psLocation, psSubsysDeviceID=psSubsysDeviceID, sysImageVersion=sysImageVersion)
