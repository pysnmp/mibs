...
enterprises, Bits, Counter32, NotificationType, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Counter64, Gauge32, IpAddress, Unsigned32, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "Counter32", "NotificationType", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Counter64", "Gauge32", "IpAddress", "Unsigned32", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysModuleID=sysModuleID, psDeviceID=psDeviceID, psModulePorts=psModulePorts, pciSlotTable=pciSlotTable, snmpTrapSrvIndex=snmpTrapSrvIndex, psNumber=psNumber, advantechCommonMIB=advantechCommonMIB, psLocation=psLocation, sysBootTime=sysBootTime, sysDeviceName=sysDeviceName, snmpTrapVersion=snmpTrapVersion, psDisplayName=psDisplayName, psBaseAddress=psBaseAddress, sysReleaseDate=sysReleaseDate, psBusIndex=psBusIndex, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvTable=snmpTrapSrvTable, psLength=psLength, PYSNMP_MODULE_ID=advantechCommonMIB, atMgmt=atMgmt, advantech=advantech, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvIP=snmpTrapSrvIP, psVendorID=psVendorID, pciConfigObj=pciConfigObj, psClassCode=psClassCode, psState=psState, pciSlotEntry=pciSlotEntry, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysDeviceID=psSubsysDeviceID, psManufacturer=psManufacturer, psDeviceIndex=psDeviceIndex, psSubsysVendorID=psSubsysVendorID, psIndex=psIndex, snmpTrapSrvObj=snmpTrapSrvObj, atSystem=atSystem, psDescr=psDescr, sysImageVersion=sysImageVersion, sysFirstBootTime=sysFirstBootTime, atPciConfig=atPciConfig, psIRQ=psIRQ, sysBootCount=sysBootCount, psModuleType=psModuleType, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex)
