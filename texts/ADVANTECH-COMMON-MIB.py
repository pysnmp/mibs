...
MibIdentifier, Counter64, Bits, Unsigned32, ObjectIdentity, IpAddress, TimeTicks, Integer32, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Bits", "Unsigned32", "ObjectIdentity", "IpAddress", "TimeTicks", "Integer32", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psBusIndex=psBusIndex, psIndex=psIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootTime=sysBootTime, psSubsysDeviceID=psSubsysDeviceID, psModulePorts=psModulePorts, psDescr=psDescr, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvPort=snmpTrapSrvPort, sysDeviceName=sysDeviceName, psNumber=psNumber, sysReleaseDate=sysReleaseDate, advantech=advantech, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, snmpTrapSrvEntry=snmpTrapSrvEntry, psIRQ=psIRQ, sysImageVersion=sysImageVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atPciConfig=atPciConfig, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvNumber=snmpTrapSrvNumber, atSystem=atSystem, advantechCommonMIB=advantechCommonMIB, pciConfigObj=pciConfigObj, psClassCode=psClassCode, psManufacturer=psManufacturer, psModuleType=psModuleType, sysDescr=sysDescr, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, sysModuleID=sysModuleID, psFunctionIndex=psFunctionIndex, PYSNMP_MODULE_ID=advantechCommonMIB, psVendorID=psVendorID, psSubsysVendorID=psSubsysVendorID, atMgmt=atMgmt, sysFirstBootTime=sysFirstBootTime, snmpTrapVersion=snmpTrapVersion, pciSlotEntry=pciSlotEntry, psLocation=psLocation, psState=psState, sysBootCount=sysBootCount, psLength=psLength, psDisplayName=psDisplayName, psDeviceID=psDeviceID)
