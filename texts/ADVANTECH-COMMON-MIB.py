...
ModuleIdentity, ObjectIdentity, iso, Gauge32, enterprises, TimeTicks, Counter32, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, MibIdentifier, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "iso", "Gauge32", "enterprises", "TimeTicks", "Counter32", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "MibIdentifier", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDisplayName=psDisplayName, psIRQ=psIRQ, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBusIndex=psBusIndex, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, psLength=psLength, snmpTrapSrvTable=snmpTrapSrvTable, psFunctionIndex=psFunctionIndex, atSystem=atSystem, atPciConfig=atPciConfig, sysBootCount=sysBootCount, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceID=psDeviceID, sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, psBaseAddress=psBaseAddress, snmpTrapSrvIP=snmpTrapSrvIP, psState=psState, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, psManufacturer=psManufacturer, psIndex=psIndex, psClassCode=psClassCode, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, psSubsysDeviceID=psSubsysDeviceID, psVendorID=psVendorID, sysReleaseDate=sysReleaseDate, pciSlotEntry=pciSlotEntry, pciSlotTable=pciSlotTable, sysBootTime=sysBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDescr=psDescr, sysDeviceName=sysDeviceName, psNumber=psNumber, snmpTrapVersion=snmpTrapVersion, atMgmt=atMgmt, sysModuleID=sysModuleID, advantech=advantech, snmpTrapSrvPort=snmpTrapSrvPort, sysImageVersion=sysImageVersion, psLocation=psLocation, psModulePorts=psModulePorts, psDeviceIndex=psDeviceIndex)
