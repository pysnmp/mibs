...
Gauge32, Integer32, ObjectIdentity, iso, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, ModuleIdentity, Bits, enterprises, Unsigned32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "ObjectIdentity", "iso", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "ModuleIdentity", "Bits", "enterprises", "Unsigned32", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDescr=sysDescr, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, psDescr=psDescr, psNumber=psNumber, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, psState=psState, atSystem=atSystem, snmpTrapSrvIP=snmpTrapSrvIP, psBaseAddress=psBaseAddress, sysImageVersion=sysImageVersion, sysBootTime=sysBootTime, psModulePorts=psModulePorts, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysVendorID=psSubsysVendorID, psClassCode=psClassCode, sysReleaseDate=sysReleaseDate, psLength=psLength, sysBootCount=sysBootCount, snmpTrapVersion=snmpTrapVersion, atMgmt=atMgmt, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvPort=snmpTrapSrvPort, psDeviceID=psDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, psIndex=psIndex, psSubsysDeviceID=psSubsysDeviceID, sysModuleID=sysModuleID, psFunctionIndex=psFunctionIndex, psDisplayName=psDisplayName, advantech=advantech, snmpTrapSrvObj=snmpTrapSrvObj, pciConfigObj=pciConfigObj, psIRQ=psIRQ, pciSlotTable=pciSlotTable, psVendorID=psVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceIndex=psDeviceIndex, psLocation=psLocation, psManufacturer=psManufacturer, sysDeviceName=sysDeviceName, atPciConfig=atPciConfig)
