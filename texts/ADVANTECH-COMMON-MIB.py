...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, ModuleIdentity, Integer32, Counter64, TimeTicks, Bits, MibIdentifier, ObjectIdentity, Unsigned32, enterprises, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "ModuleIdentity", "Integer32", "Counter64", "TimeTicks", "Bits", "MibIdentifier", "ObjectIdentity", "Unsigned32", "enterprises", "IpAddress", "iso")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysFirstBootTime=sysFirstBootTime, psIndex=psIndex, sysModuleID=sysModuleID, psDisplayName=psDisplayName, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, sysBootCount=sysBootCount, snmpTrapVersion=snmpTrapVersion, sysReleaseDate=sysReleaseDate, snmpTrapSrvNumber=snmpTrapSrvNumber, pciSlotTable=pciSlotTable, sysBootTime=sysBootTime, psBaseAddress=psBaseAddress, snmpTrapSrvTable=snmpTrapSrvTable, psBusIndex=psBusIndex, psLocation=psLocation, psManufacturer=psManufacturer, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvEntry=snmpTrapSrvEntry, psIRQ=psIRQ, atSystem=atSystem, psLength=psLength, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDescr=sysDescr, advantech=advantech, atMgmt=atMgmt, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psNumber=psNumber, psVendorID=psVendorID, sysDeviceName=sysDeviceName, sysImageVersion=sysImageVersion, psDeviceIndex=psDeviceIndex, pciConfigObj=pciConfigObj, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceID=psDeviceID, psModuleType=psModuleType, atPciConfig=atPciConfig, psModulePorts=psModulePorts, psClassCode=psClassCode, snmpTrapSrvIP=snmpTrapSrvIP, psDescr=psDescr, advantechCommonMIB=advantechCommonMIB, psState=psState, psFunctionIndex=psFunctionIndex, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvPort=snmpTrapSrvPort)
