...
iso, ModuleIdentity, IpAddress, TimeTicks, ObjectIdentity, Integer32, Counter32, Unsigned32, Bits, NotificationType, enterprises, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "IpAddress", "TimeTicks", "ObjectIdentity", "Integer32", "Counter32", "Unsigned32", "Bits", "NotificationType", "enterprises", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapVersion=snmpTrapVersion, sysModuleID=sysModuleID, psLength=psLength, psDeviceIndex=psDeviceIndex, psNumber=psNumber, sysDescr=sysDescr, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, psVendorID=psVendorID, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvObj=snmpTrapSrvObj, psDisplayName=psDisplayName, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotTable=pciSlotTable, PYSNMP_MODULE_ID=advantechCommonMIB, sysImageVersion=sysImageVersion, psBusIndex=psBusIndex, sysBootTime=sysBootTime, psIRQ=psIRQ, psDeviceID=psDeviceID, pciConfigObj=pciConfigObj, psState=psState, atSystem=atSystem, psModulePorts=psModulePorts, psClassCode=psClassCode, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvNumber=snmpTrapSrvNumber, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, psFunctionIndex=psFunctionIndex, sysReleaseDate=sysReleaseDate, psBaseAddress=psBaseAddress, sysBootCount=sysBootCount, advantechCommonMIB=advantechCommonMIB, psManufacturer=psManufacturer, atPciConfig=atPciConfig, pciSlotEntry=pciSlotEntry, psLocation=psLocation, sysDeviceName=sysDeviceName, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, advantech=advantech, psDescr=psDescr)
