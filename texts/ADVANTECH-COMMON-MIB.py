...
ModuleIdentity, Integer32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, IpAddress, TimeTicks, Counter32, Counter64, Gauge32, Unsigned32, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "IpAddress", "TimeTicks", "Counter32", "Counter64", "Gauge32", "Unsigned32", "enterprises", "iso")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIndex=psIndex, sysBootTime=sysBootTime, pciSlotEntry=pciSlotEntry, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDeviceName=sysDeviceName, psSubsysDeviceID=psSubsysDeviceID, psFunctionIndex=psFunctionIndex, advantechCommonMIB=advantechCommonMIB, psDeviceIndex=psDeviceIndex, advantech=advantech, psLength=psLength, sysImageVersion=sysImageVersion, PYSNMP_MODULE_ID=advantechCommonMIB, psClassCode=psClassCode, psModuleType=psModuleType, psModulePorts=psModulePorts, atMgmt=atMgmt, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, psVendorID=psVendorID, psManufacturer=psManufacturer, snmpTrapSrvObj=snmpTrapSrvObj, psNumber=psNumber, psBaseAddress=psBaseAddress, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIndex=snmpTrapSrvIndex, psIRQ=psIRQ, psBusIndex=psBusIndex, psSubsysVendorID=psSubsysVendorID, psState=psState, psDisplayName=psDisplayName, atSystem=atSystem, sysDescr=sysDescr, psDeviceID=psDeviceID, sysBootCount=sysBootCount, snmpTrapSrvEntry=snmpTrapSrvEntry, psLocation=psLocation, psDescr=psDescr, snmpTrapSrvPort=snmpTrapSrvPort, sysReleaseDate=sysReleaseDate, snmpTrapSrvNumber=snmpTrapSrvNumber, sysModuleID=sysModuleID, atPciConfig=atPciConfig, pciConfigObj=pciConfigObj)
