...
IpAddress, Counter32, ModuleIdentity, Counter64, Gauge32, MibIdentifier, enterprises, Bits, Integer32, NotificationType, TimeTicks, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "ModuleIdentity", "Counter64", "Gauge32", "MibIdentifier", "enterprises", "Bits", "Integer32", "NotificationType", "TimeTicks", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atMgmt=atMgmt, psVendorID=psVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvTable=snmpTrapSrvTable, psDescr=psDescr, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, psModuleType=psModuleType, psSubsysVendorID=psSubsysVendorID, snmpTrapVersion=snmpTrapVersion, psManufacturer=psManufacturer, psLocation=psLocation, psBaseAddress=psBaseAddress, psIRQ=psIRQ, sysModuleID=sysModuleID, sysBootCount=sysBootCount, snmpTrapSrvIP=snmpTrapSrvIP, advantech=advantech, psModulePorts=psModulePorts, sysDescr=sysDescr, psIndex=psIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotEntry=pciSlotEntry, atPciConfig=atPciConfig, sysImageVersion=sysImageVersion, sysBootTime=sysBootTime, pciSlotTable=pciSlotTable, psNumber=psNumber, sysDeviceName=sysDeviceName, advantechCommonMIB=advantechCommonMIB, psLength=psLength, psState=psState, snmpTrapSrvCommunity=snmpTrapSrvCommunity, PYSNMP_MODULE_ID=advantechCommonMIB, sysReleaseDate=sysReleaseDate, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvPort=snmpTrapSrvPort, psBusIndex=psBusIndex, psFunctionIndex=psFunctionIndex, atSystem=atSystem, psClassCode=psClassCode, pciConfigObj=pciConfigObj, psDisplayName=psDisplayName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication)
