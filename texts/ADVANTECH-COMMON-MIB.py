...
TimeTicks, MibIdentifier, ObjectIdentity, Integer32, enterprises, ModuleIdentity, Bits, Counter32, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Integer32", "enterprises", "ModuleIdentity", "Bits", "Counter32", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "iso", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, psLocation=psLocation, psSubsysVendorID=psSubsysVendorID, psState=psState, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, psManufacturer=psManufacturer, advantech=advantech, atSystem=atSystem, PYSNMP_MODULE_ID=advantechCommonMIB, psBusIndex=psBusIndex, psModulePorts=psModulePorts, sysImageVersion=sysImageVersion, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvPort=snmpTrapSrvPort, pciConfigObj=pciConfigObj, snmpTrapSrvIndex=snmpTrapSrvIndex, pciSlotTable=pciSlotTable, pciSlotEntry=pciSlotEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, psFunctionIndex=psFunctionIndex, psNumber=psNumber, sysModuleID=sysModuleID, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, psClassCode=psClassCode, sysFirstBootTime=sysFirstBootTime, psIRQ=psIRQ, sysBootCount=sysBootCount, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBaseAddress=psBaseAddress, sysReleaseDate=sysReleaseDate, psIndex=psIndex, psLength=psLength, psVendorID=psVendorID, psDeviceID=psDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvEntry=snmpTrapSrvEntry, psModuleType=psModuleType, psDisplayName=psDisplayName, psDescr=psDescr, sysBootTime=sysBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity)
