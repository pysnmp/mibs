...
Integer32, Unsigned32, iso, enterprises, Counter32, IpAddress, NotificationType, Gauge32, Bits, MibIdentifier, TimeTicks, ModuleIdentity, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "iso", "enterprises", "Counter32", "IpAddress", "NotificationType", "Gauge32", "Bits", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psManufacturer=psManufacturer, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDeviceName=sysDeviceName, snmpTrapSrvNumber=snmpTrapSrvNumber, sysModuleID=sysModuleID, snmpTrapSrvIP=snmpTrapSrvIP, psBusIndex=psBusIndex, psBaseAddress=psBaseAddress, psDescr=psDescr, psDeviceID=psDeviceID, advantechCommonMIB=advantechCommonMIB, atSystem=atSystem, psLocation=psLocation, psNumber=psNumber, psModulePorts=psModulePorts, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, PYSNMP_MODULE_ID=advantechCommonMIB, atMgmt=atMgmt, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysVendorID=psSubsysVendorID, psIRQ=psIRQ, pciConfigObj=pciConfigObj, psIndex=psIndex, psModuleType=psModuleType, psState=psState, atPciConfig=atPciConfig, sysImageVersion=sysImageVersion, psVendorID=psVendorID, psFunctionIndex=psFunctionIndex, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotTable=pciSlotTable, sysBootTime=sysBootTime, sysDescr=sysDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLength=psLength, sysBootCount=sysBootCount, pciSlotEntry=pciSlotEntry, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, sysReleaseDate=sysReleaseDate, snmpTrapSrvObj=snmpTrapSrvObj, psClassCode=psClassCode, psDisplayName=psDisplayName)
