...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:21:47 2021
...
Gauge32, Counter32, Unsigned32, enterprises, Counter64, IpAddress, ModuleIdentity, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, TimeTicks, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Unsigned32", "enterprises", "Counter64", "IpAddress", "ModuleIdentity", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "TimeTicks", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, sysDescr=sysDescr, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, psSubsysVendorID=psSubsysVendorID, snmpTrapVersion=snmpTrapVersion, atPciConfig=atPciConfig, psDeviceIndex=psDeviceIndex, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, atSystem=atSystem, psIndex=psIndex, pciSlotTable=pciSlotTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvObj=snmpTrapSrvObj, psLength=psLength, snmpTrapSrvIndex=snmpTrapSrvIndex, sysModuleID=sysModuleID, advantech=advantech, sysDeviceName=sysDeviceName, psDisplayName=psDisplayName, psDescr=psDescr, psModulePorts=psModulePorts, psLocation=psLocation, psBusIndex=psBusIndex, snmpTrapSrvPort=snmpTrapSrvPort, psDeviceID=psDeviceID, advantechCommonMIB=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, psManufacturer=psManufacturer, psBaseAddress=psBaseAddress, psVendorID=psVendorID, psClassCode=psClassCode, snmpTrapSrvTable=snmpTrapSrvTable, atMgmt=atMgmt, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, sysReleaseDate=sysReleaseDate, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysBootCount=sysBootCount, psModuleType=psModuleType, sysFirstBootTime=sysFirstBootTime, psIRQ=psIRQ, snmpTrapSrvEntry=snmpTrapSrvEntry, psState=psState, pciConfigObj=pciConfigObj, sysBootTime=sysBootTime)
