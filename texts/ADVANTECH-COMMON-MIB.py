...
ModuleIdentity, iso, IpAddress, Integer32, Gauge32, Unsigned32, Bits, enterprises, TimeTicks, NotificationType, Counter64, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "IpAddress", "Integer32", "Gauge32", "Unsigned32", "Bits", "enterprises", "TimeTicks", "NotificationType", "Counter64", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDeviceName=sysDeviceName, sysBootTime=sysBootTime, psIRQ=psIRQ, snmpTrapSrvIP=snmpTrapSrvIP, sysImageVersion=sysImageVersion, atPciConfig=atPciConfig, advantech=advantech, sysDescr=sysDescr, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvCommunity=snmpTrapSrvCommunity, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psClassCode=psClassCode, pciConfigObj=pciConfigObj, psBusIndex=psBusIndex, psLength=psLength, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psVendorID=psVendorID, sysModuleID=sysModuleID, psDeviceIndex=psDeviceIndex, sysBootCount=sysBootCount, snmpTrapSrvEntry=snmpTrapSrvEntry, pciSlotTable=pciSlotTable, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, snmpTrapSrvPort=snmpTrapSrvPort, psDescr=psDescr, atSystem=atSystem, psDeviceID=psDeviceID, psSubsysDeviceID=psSubsysDeviceID, psModuleType=psModuleType, psFunctionIndex=psFunctionIndex, psDisplayName=psDisplayName, psLocation=psLocation, psModulePorts=psModulePorts, psSubsysVendorID=psSubsysVendorID, sysFirstBootTime=sysFirstBootTime, pciSlotEntry=pciSlotEntry, psNumber=psNumber, psBaseAddress=psBaseAddress, sysReleaseDate=sysReleaseDate, PYSNMP_MODULE_ID=advantechCommonMIB, psState=psState, atMgmt=atMgmt, psManufacturer=psManufacturer, snmpTrapSrvObj=snmpTrapSrvObj)
