...
iso, Integer32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, enterprises, MibIdentifier, ObjectIdentity, Counter32, Counter64, IpAddress, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "enterprises", "MibIdentifier", "ObjectIdentity", "Counter32", "Counter64", "IpAddress", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciSlotTable=pciSlotTable, psManufacturer=psManufacturer, sysBootTime=sysBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, psVendorID=psVendorID, psNumber=psNumber, psIndex=psIndex, psModuleType=psModuleType, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvEntry=snmpTrapSrvEntry, psModulePorts=psModulePorts, snmpTrapSrvIP=snmpTrapSrvIP, psLength=psLength, sysFirstBootTime=sysFirstBootTime, sysReleaseDate=sysReleaseDate, snmpTrapVersion=snmpTrapVersion, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atMgmt=atMgmt, psDeviceIndex=psDeviceIndex, pciConfigObj=pciConfigObj, psLocation=psLocation, sysBootCount=sysBootCount, psFunctionIndex=psFunctionIndex, sysModuleID=sysModuleID, atPciConfig=atPciConfig, psBusIndex=psBusIndex, psDeviceID=psDeviceID, advantech=advantech, sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, sysImageVersion=sysImageVersion, pciSlotEntry=pciSlotEntry, psState=psState, psBaseAddress=psBaseAddress, psDescr=psDescr, psIRQ=psIRQ, psClassCode=psClassCode, psSubsysDeviceID=psSubsysDeviceID, psDisplayName=psDisplayName, atSystem=atSystem, PYSNMP_MODULE_ID=advantechCommonMIB, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvPort=snmpTrapSrvPort, sysDeviceName=sysDeviceName)
