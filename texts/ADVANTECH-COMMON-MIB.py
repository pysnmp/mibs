...
Gauge32, ModuleIdentity, TimeTicks, IpAddress, Counter32, enterprises, Unsigned32, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Counter64, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "TimeTicks", "IpAddress", "Counter32", "enterprises", "Unsigned32", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Counter64", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psState=psState, psModulePorts=psModulePorts, sysBootCount=sysBootCount, psDisplayName=psDisplayName, sysDeviceName=sysDeviceName, psFunctionIndex=psFunctionIndex, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvTable=snmpTrapSrvTable, psVendorID=psVendorID, psBaseAddress=psBaseAddress, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, psNumber=psNumber, psLocation=psLocation, sysReleaseDate=sysReleaseDate, psSubsysDeviceID=psSubsysDeviceID, psDescr=psDescr, atMgmt=atMgmt, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, psClassCode=psClassCode, sysImageVersion=sysImageVersion, snmpTrapVersion=snmpTrapVersion, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, atPciConfig=atPciConfig, psIRQ=psIRQ, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDescr=sysDescr, psLength=psLength, advantech=advantech, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, atSystem=atSystem, psIndex=psIndex, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvEntry=snmpTrapSrvEntry, psBusIndex=psBusIndex, pciConfigObj=pciConfigObj, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, sysBootTime=sysBootTime)
