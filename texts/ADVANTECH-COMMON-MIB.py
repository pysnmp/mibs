...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysBootTime=sysBootTime, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atSystem=atSystem, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLocation=psLocation, sysReleaseDate=sysReleaseDate, sysImageVersion=sysImageVersion, psModulePorts=psModulePorts, psSubsysDeviceID=psSubsysDeviceID, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvObj=snmpTrapSrvObj, psBusIndex=psBusIndex, sysBootCount=sysBootCount, psIRQ=psIRQ, pciSlotTable=pciSlotTable, snmpTrapSrvEntry=snmpTrapSrvEntry, psBaseAddress=psBaseAddress, psDeviceID=psDeviceID, atPciConfig=atPciConfig, psNumber=psNumber, advantechCommonMIB=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvPort=snmpTrapSrvPort, psVendorID=psVendorID, psSubsysVendorID=psSubsysVendorID, psState=psState, sysModuleID=sysModuleID, psManufacturer=psManufacturer, pciConfigObj=pciConfigObj, PYSNMP_MODULE_ID=advantechCommonMIB, psFunctionIndex=psFunctionIndex, psDescr=psDescr, snmpTrapVersion=snmpTrapVersion, pciSlotEntry=pciSlotEntry, psLength=psLength, psClassCode=psClassCode, psModuleType=psModuleType, psDeviceIndex=psDeviceIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psDisplayName=psDisplayName, advantech=advantech, snmpTrapSrvTable=snmpTrapSrvTable, atMgmt=atMgmt, sysDeviceName=sysDeviceName, psIndex=psIndex)
