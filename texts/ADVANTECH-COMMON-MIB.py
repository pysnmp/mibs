...
Gauge32, Integer32, TimeTicks, Bits, ModuleIdentity, IpAddress, ObjectIdentity, MibIdentifier, Counter64, Counter32, enterprises, Unsigned32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "TimeTicks", "Bits", "ModuleIdentity", "IpAddress", "ObjectIdentity", "MibIdentifier", "Counter64", "Counter32", "enterprises", "Unsigned32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, sysBootTime=sysBootTime, snmpTrapSrvPort=snmpTrapSrvPort, psBaseAddress=psBaseAddress, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotTable=pciSlotTable, psDeviceIndex=psDeviceIndex, psClassCode=psClassCode, psLocation=psLocation, psBusIndex=psBusIndex, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, psNumber=psNumber, sysReleaseDate=sysReleaseDate, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvTable=snmpTrapSrvTable, sysDeviceName=sysDeviceName, psIRQ=psIRQ, psModuleType=psModuleType, psDescr=psDescr, snmpTrapSrvNumber=snmpTrapSrvNumber, advantech=advantech, sysImageVersion=sysImageVersion, psIndex=psIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atMgmt=atMgmt, psSubsysVendorID=psSubsysVendorID, psDisplayName=psDisplayName, psState=psState, sysFirstBootTime=sysFirstBootTime, pciSlotEntry=pciSlotEntry, sysDescr=sysDescr, sysBootCount=sysBootCount, snmpTrapVersion=snmpTrapVersion, psFunctionIndex=psFunctionIndex, psSubsysDeviceID=psSubsysDeviceID, psLength=psLength, psDeviceID=psDeviceID, psManufacturer=psManufacturer, psModulePorts=psModulePorts, atSystem=atSystem, snmpTrapSrvEntry=snmpTrapSrvEntry, psVendorID=psVendorID, pciConfigObj=pciConfigObj, atPciConfig=atPciConfig)
