...
TimeTicks, Bits, Gauge32, Counter32, enterprises, Counter64, NotificationType, ObjectIdentity, Integer32, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Gauge32", "Counter32", "enterprises", "Counter64", "NotificationType", "ObjectIdentity", "Integer32", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvNumber=snmpTrapSrvNumber, psBusIndex=psBusIndex, snmpTrapSrvTable=snmpTrapSrvTable, sysBootTime=sysBootTime, pciSlotEntry=pciSlotEntry, sysBootCount=sysBootCount, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvEntry=snmpTrapSrvEntry, psNumber=psNumber, snmpTrapSrvIP=snmpTrapSrvIP, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, advantechCommonMIB=advantechCommonMIB, psModuleType=psModuleType, psVendorID=psVendorID, atMgmt=atMgmt, sysModuleID=sysModuleID, sysReleaseDate=sysReleaseDate, snmpTrapSrvObj=snmpTrapSrvObj, psManufacturer=psManufacturer, sysDescr=sysDescr, psClassCode=psClassCode, psLocation=psLocation, snmpTrapSrvIndex=snmpTrapSrvIndex, psSubsysDeviceID=psSubsysDeviceID, psDisplayName=psDisplayName, psIndex=psIndex, psBaseAddress=psBaseAddress, psFunctionIndex=psFunctionIndex, advantech=advantech, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapVersion=snmpTrapVersion, atSystem=atSystem, sysFirstBootTime=sysFirstBootTime, sysImageVersion=sysImageVersion, psDeviceID=psDeviceID, psLength=psLength, psModulePorts=psModulePorts, pciSlotTable=pciSlotTable, psIRQ=psIRQ, PYSNMP_MODULE_ID=advantechCommonMIB, psDescr=psDescr, psDeviceIndex=psDeviceIndex, psSubsysVendorID=psSubsysVendorID, psState=psState, snmpTrapSrvPort=snmpTrapSrvPort, pciConfigObj=pciConfigObj)
