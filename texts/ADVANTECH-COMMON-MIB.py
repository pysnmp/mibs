...
ModuleIdentity, Unsigned32, enterprises, Counter32, TimeTicks, ObjectIdentity, Gauge32, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, Counter64, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "enterprises", "Counter32", "TimeTicks", "ObjectIdentity", "Gauge32", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "Counter64", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModuleType=psModuleType, psIRQ=psIRQ, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDeviceName=sysDeviceName, snmpTrapSrvIndex=snmpTrapSrvIndex, psBusIndex=psBusIndex, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvTable=snmpTrapSrvTable, sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, psVendorID=psVendorID, atMgmt=atMgmt, snmpTrapSrvIP=snmpTrapSrvIP, advantech=advantech, psManufacturer=psManufacturer, sysFirstBootTime=sysFirstBootTime, pciConfigObj=pciConfigObj, psDeviceID=psDeviceID, psDeviceIndex=psDeviceIndex, psClassCode=psClassCode, sysModuleID=sysModuleID, psSubsysVendorID=psSubsysVendorID, psState=psState, psIndex=psIndex, psFunctionIndex=psFunctionIndex, psBaseAddress=psBaseAddress, psLocation=psLocation, snmpTrapSrvPort=snmpTrapSrvPort, atSystem=atSystem, advantechCommonMIB=advantechCommonMIB, sysImageVersion=sysImageVersion, sysBootCount=sysBootCount, snmpTrapSrvNumber=snmpTrapSrvNumber, sysReleaseDate=sysReleaseDate, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotEntry=pciSlotEntry, atPciConfig=atPciConfig, psNumber=psNumber, snmpTrapVersion=snmpTrapVersion, psLength=psLength, psDescr=psDescr, sysBootTime=sysBootTime, psSubsysDeviceID=psSubsysDeviceID, psDisplayName=psDisplayName, pciSlotTable=pciSlotTable, PYSNMP_MODULE_ID=advantechCommonMIB)
