...
Bits, IpAddress, Integer32, iso, Counter64, Counter32, NotificationType, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, enterprises, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Integer32", "iso", "Counter64", "Counter32", "NotificationType", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "enterprises", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIRQ=psIRQ, sysBootTime=sysBootTime, psDeviceIndex=psDeviceIndex, psNumber=psNumber, psManufacturer=psManufacturer, psClassCode=psClassCode, snmpTrapSrvPort=snmpTrapSrvPort, psDisplayName=psDisplayName, sysDeviceName=sysDeviceName, psSubsysVendorID=psSubsysVendorID, psBusIndex=psBusIndex, psDeviceID=psDeviceID, psLocation=psLocation, sysImageVersion=sysImageVersion, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciSlotEntry=pciSlotEntry, psDescr=psDescr, psModuleType=psModuleType, psModulePorts=psModulePorts, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, psBaseAddress=psBaseAddress, snmpTrapSrvIndex=snmpTrapSrvIndex, psState=psState, sysBootCount=sysBootCount, atPciConfig=atPciConfig, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, advantech=advantech, atMgmt=atMgmt, psFunctionIndex=psFunctionIndex, sysModuleID=sysModuleID, snmpTrapVersion=snmpTrapVersion, sysReleaseDate=sysReleaseDate, snmpTrapSrvEntry=snmpTrapSrvEntry, psIndex=psIndex, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, sysDescr=sysDescr, pciSlotTable=pciSlotTable, snmpTrapSrvTable=snmpTrapSrvTable, psVendorID=psVendorID, atSystem=atSystem, pciConfigObj=pciConfigObj, psLength=psLength)
