...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", PYSNMP_MODULE_ID=advantechCommonMIB, advantech=advantech, snmpTrapSrvTable=snmpTrapSrvTable, atSystem=atSystem, psIndex=psIndex, sysDeviceName=sysDeviceName, psDeviceIndex=psDeviceIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psState=psState, sysFirstBootTime=sysFirstBootTime, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, psDeviceID=psDeviceID, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, advantechCommonMIB=advantechCommonMIB, psClassCode=psClassCode, sysDescr=sysDescr, psBaseAddress=psBaseAddress, psDisplayName=psDisplayName, psIRQ=psIRQ, psNumber=psNumber, snmpTrapSrvNumber=snmpTrapSrvNumber, pciConfigObj=pciConfigObj, snmpTrapSrvPort=snmpTrapSrvPort, sysReleaseDate=sysReleaseDate, psModuleType=psModuleType, psLocation=psLocation, pciSlotTable=pciSlotTable, atPciConfig=atPciConfig, sysBootTime=sysBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvIP=snmpTrapSrvIP, psSubsysVendorID=psSubsysVendorID, psFunctionIndex=psFunctionIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModulePorts=psModulePorts, psLength=psLength, psBusIndex=psBusIndex, sysModuleID=sysModuleID, atMgmt=atMgmt, psManufacturer=psManufacturer, psVendorID=psVendorID, sysBootCount=sysBootCount, sysImageVersion=sysImageVersion)
