...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciSlotTable=pciSlotTable, pciSlotEntry=pciSlotEntry, sysBootCount=sysBootCount, advantech=advantech, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psState=psState, psManufacturer=psManufacturer, psNumber=psNumber, snmpTrapSrvTable=snmpTrapSrvTable, sysFirstBootTime=sysFirstBootTime, sysDescr=sysDescr, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootTime=sysBootTime, sysDeviceName=sysDeviceName, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psIndex=psIndex, atPciConfig=atPciConfig, psBaseAddress=psBaseAddress, advantechCommonMIB=advantechCommonMIB, psLength=psLength, psDeviceIndex=psDeviceIndex, pciConfigObj=pciConfigObj, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, sysReleaseDate=sysReleaseDate, PYSNMP_MODULE_ID=advantechCommonMIB, psModuleType=psModuleType, psLocation=psLocation, psModulePorts=psModulePorts, psIRQ=psIRQ, snmpTrapSrvObj=snmpTrapSrvObj, psClassCode=psClassCode, psDisplayName=psDisplayName, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, atMgmt=atMgmt, sysModuleID=sysModuleID, psFunctionIndex=psFunctionIndex, psBusIndex=psBusIndex, snmpTrapSrvIP=snmpTrapSrvIP, psVendorID=psVendorID, psDeviceID=psDeviceID, sysImageVersion=sysImageVersion, psSubsysVendorID=psSubsysVendorID)
