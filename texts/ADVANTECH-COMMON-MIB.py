...
ModuleIdentity, TimeTicks, Bits, ObjectIdentity, Gauge32, Unsigned32, NotificationType, Integer32, MibIdentifier, enterprises, iso, Counter64, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Bits", "ObjectIdentity", "Gauge32", "Unsigned32", "NotificationType", "Integer32", "MibIdentifier", "enterprises", "iso", "Counter64", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atMgmt=atMgmt, snmpTrapVersion=snmpTrapVersion, sysFirstBootTime=sysFirstBootTime, pciSlotEntry=pciSlotEntry, psFunctionIndex=psFunctionIndex, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysBootTime=sysBootTime, PYSNMP_MODULE_ID=advantechCommonMIB, sysReleaseDate=sysReleaseDate, snmpTrapSrvIP=snmpTrapSrvIP, advantech=advantech, psLocation=psLocation, psIRQ=psIRQ, psManufacturer=psManufacturer, psVendorID=psVendorID, pciSlotTable=pciSlotTable, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, psIndex=psIndex, psDeviceID=psDeviceID, pciConfigObj=pciConfigObj, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvPort=snmpTrapSrvPort, psModulePorts=psModulePorts, atSystem=atSystem, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysVendorID=psSubsysVendorID, sysDeviceName=sysDeviceName, psNumber=psNumber, atPciConfig=atPciConfig, psSubsysDeviceID=psSubsysDeviceID, psBusIndex=psBusIndex, psDescr=psDescr, sysImageVersion=sysImageVersion, psDisplayName=psDisplayName, psLength=psLength, psDeviceIndex=psDeviceIndex, psBaseAddress=psBaseAddress, snmpTrapSrvEntry=snmpTrapSrvEntry, sysModuleID=sysModuleID, psClassCode=psClassCode, psModuleType=psModuleType, sysBootCount=sysBootCount, psState=psState)
