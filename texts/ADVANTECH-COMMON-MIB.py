...
Unsigned32, iso, IpAddress, ModuleIdentity, enterprises, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, Integer32, MibIdentifier, Counter32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "IpAddress", "ModuleIdentity", "enterprises", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "Integer32", "MibIdentifier", "Counter32", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysDeviceName=sysDeviceName, psDeviceIndex=psDeviceIndex, psClassCode=psClassCode, PYSNMP_MODULE_ID=advantechCommonMIB, psNumber=psNumber, psManufacturer=psManufacturer, psFunctionIndex=psFunctionIndex, sysModuleID=sysModuleID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvPort=snmpTrapSrvPort, psState=psState, psSubsysVendorID=psSubsysVendorID, sysBootTime=sysBootTime, pciSlotEntry=pciSlotEntry, psLocation=psLocation, psIndex=psIndex, psIRQ=psIRQ, psLength=psLength, psModuleType=psModuleType, atMgmt=atMgmt, advantechCommonMIB=advantechCommonMIB, psDeviceID=psDeviceID, advantech=advantech, psBaseAddress=psBaseAddress, sysReleaseDate=sysReleaseDate, pciSlotTable=pciSlotTable, psDescr=psDescr, sysDescr=sysDescr, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvIP=snmpTrapSrvIP, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, psBusIndex=psBusIndex, sysBootCount=sysBootCount, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, psVendorID=psVendorID, psDisplayName=psDisplayName, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, atPciConfig=atPciConfig, snmpTrapSrvCommunity=snmpTrapSrvCommunity, pciConfigObj=pciConfigObj)
