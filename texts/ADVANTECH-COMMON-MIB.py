...
ModuleIdentity, Gauge32, Unsigned32, IpAddress, MibIdentifier, iso, Bits, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, NotificationType, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Unsigned32", "IpAddress", "MibIdentifier", "iso", "Bits", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "NotificationType", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDisplayName=psDisplayName, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, psState=psState, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvTable=snmpTrapSrvTable, sysReleaseDate=sysReleaseDate, psSubsysVendorID=psSubsysVendorID, sysBootTime=sysBootTime, PYSNMP_MODULE_ID=advantechCommonMIB, advantechCommonMIB=advantechCommonMIB, atPciConfig=atPciConfig, advantech=advantech, psDescr=psDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psVendorID=psVendorID, psIndex=psIndex, psBaseAddress=psBaseAddress, psModulePorts=psModulePorts, psDeviceIndex=psDeviceIndex, atMgmt=atMgmt, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, psNumber=psNumber, sysDescr=sysDescr, psIRQ=psIRQ, psModuleType=psModuleType, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysModuleID=sysModuleID, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvEntry=snmpTrapSrvEntry, psLength=psLength, snmpTrapVersion=snmpTrapVersion, pciConfigObj=pciConfigObj, atSystem=atSystem, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotTable=pciSlotTable, sysBootCount=sysBootCount, psDeviceID=psDeviceID, psLocation=psLocation, psBusIndex=psBusIndex, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, psFunctionIndex=psFunctionIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psManufacturer=psManufacturer)
