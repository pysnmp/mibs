...
ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Gauge32, ObjectIdentity, Unsigned32, MibIdentifier, Integer32, Counter64, IpAddress, NotificationType, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Gauge32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Integer32", "Counter64", "IpAddress", "NotificationType", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModulePorts=psModulePorts, psVendorID=psVendorID, snmpTrapSrvIP=snmpTrapSrvIP, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, advantech=advantech, psLocation=psLocation, sysBootCount=sysBootCount, psFunctionIndex=psFunctionIndex, sysImageVersion=sysImageVersion, psClassCode=psClassCode, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapVersion=snmpTrapVersion, psLength=psLength, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootTime=sysBootTime, pciConfigObj=pciConfigObj, psState=psState, sysDeviceName=sysDeviceName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDescr=psDescr, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, psBusIndex=psBusIndex, pciSlotTable=pciSlotTable, sysModuleID=sysModuleID, atSystem=atSystem, atMgmt=atMgmt, psManufacturer=psManufacturer, atPciConfig=atPciConfig, sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvIndex=snmpTrapSrvIndex, sysReleaseDate=sysReleaseDate, psIRQ=psIRQ, psModuleType=psModuleType, snmpTrapSrvPort=snmpTrapSrvPort, psDisplayName=psDisplayName, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysFirstBootTime=sysFirstBootTime, psNumber=psNumber, PYSNMP_MODULE_ID=advantechCommonMIB, psBaseAddress=psBaseAddress)
