...
ModuleIdentity, ObjectIdentity, MibIdentifier, IpAddress, enterprises, TimeTicks, Counter32, iso, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "IpAddress", "enterprises", "TimeTicks", "Counter32", "iso", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantechCommonMIB=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIP=snmpTrapSrvIP, psNumber=psNumber, psModuleType=psModuleType, atSystem=atSystem, snmpTrapVersion=snmpTrapVersion, psLocation=psLocation, snmpTrapSrvIndex=snmpTrapSrvIndex, sysReleaseDate=sysReleaseDate, psIndex=psIndex, psFunctionIndex=psFunctionIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, psDescr=psDescr, sysDescr=sysDescr, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, psModulePorts=psModulePorts, psDeviceID=psDeviceID, psSubsysDeviceID=psSubsysDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, psVendorID=psVendorID, pciConfigObj=pciConfigObj, atMgmt=atMgmt, psManufacturer=psManufacturer, sysDeviceName=sysDeviceName, atPciConfig=atPciConfig, psBaseAddress=psBaseAddress, snmpTrapSrvNumber=snmpTrapSrvNumber, advantech=advantech, snmpTrapSrvTable=snmpTrapSrvTable, sysModuleID=sysModuleID, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvPort=snmpTrapSrvPort, psLength=psLength, psIRQ=psIRQ, psDeviceIndex=psDeviceIndex, psClassCode=psClassCode, sysImageVersion=sysImageVersion, sysBootCount=sysBootCount, pciSlotTable=pciSlotTable, psState=psState, pciSlotEntry=pciSlotEntry, sysBootTime=sysBootTime)
