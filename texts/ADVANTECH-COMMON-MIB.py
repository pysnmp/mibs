...
ModuleIdentity, ObjectIdentity, NotificationType, Unsigned32, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, enterprises, iso, Bits, MibIdentifier, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Unsigned32", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "enterprises", "iso", "Bits", "MibIdentifier", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psIRQ=psIRQ, psLength=psLength, psFunctionIndex=psFunctionIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysDescr=sysDescr, atMgmt=atMgmt, psIndex=psIndex, psLocation=psLocation, psVendorID=psVendorID, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, sysBootTime=sysBootTime, advantechCommonMIB=advantechCommonMIB, sysModuleID=sysModuleID, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapVersion=snmpTrapVersion, psBusIndex=psBusIndex, advantech=advantech, pciSlotEntry=pciSlotEntry, psDeviceID=psDeviceID, sysFirstBootTime=sysFirstBootTime, pciSlotTable=pciSlotTable, sysBootCount=sysBootCount, snmpTrapSrvObj=snmpTrapSrvObj, sysImageVersion=sysImageVersion, psNumber=psNumber, psDisplayName=psDisplayName, sysDeviceName=sysDeviceName, psModulePorts=psModulePorts, snmpTrapSrvTable=snmpTrapSrvTable, psManufacturer=psManufacturer, atPciConfig=atPciConfig, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysVendorID=psSubsysVendorID, psModuleType=psModuleType, psClassCode=psClassCode, psSubsysDeviceID=psSubsysDeviceID, atSystem=atSystem, psBaseAddress=psBaseAddress, psDescr=psDescr, sysReleaseDate=sysReleaseDate, pciConfigObj=pciConfigObj, psState=psState)
