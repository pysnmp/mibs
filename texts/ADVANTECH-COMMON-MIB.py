...
TimeTicks, ObjectIdentity, MibIdentifier, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, iso, Counter32, Counter64, Gauge32, Integer32, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "iso", "Counter32", "Counter64", "Gauge32", "Integer32", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psFunctionIndex=psFunctionIndex, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, atMgmt=atMgmt, sysModuleID=sysModuleID, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDisplayName=psDisplayName, psBusIndex=psBusIndex, snmpTrapVersion=snmpTrapVersion, pciConfigObj=pciConfigObj, snmpTrapSrvIndex=snmpTrapSrvIndex, advantech=advantech, PYSNMP_MODULE_ID=advantechCommonMIB, psIRQ=psIRQ, psModuleType=psModuleType, snmpTrapSrvNumber=snmpTrapSrvNumber, psBaseAddress=psBaseAddress, psDescr=psDescr, sysBootTime=sysBootTime, advantechCommonMIB=advantechCommonMIB, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, pciSlotTable=pciSlotTable, snmpTrapSrvIP=snmpTrapSrvIP, psModulePorts=psModulePorts, sysImageVersion=sysImageVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atPciConfig=atPciConfig, snmpTrapSrvObj=snmpTrapSrvObj, psState=psState, psNumber=psNumber, psManufacturer=psManufacturer, psIndex=psIndex, atSystem=atSystem, snmpTrapSrvTable=snmpTrapSrvTable, sysDescr=sysDescr, psLength=psLength, sysReleaseDate=sysReleaseDate, psClassCode=psClassCode, psLocation=psLocation, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, psDeviceID=psDeviceID)
