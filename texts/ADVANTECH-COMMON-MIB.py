...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psNumber=psNumber, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atSystem=atSystem, psSubsysVendorID=psSubsysVendorID, psModuleType=psModuleType, psModulePorts=psModulePorts, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapVersion=snmpTrapVersion, psVendorID=psVendorID, psBusIndex=psBusIndex, psIRQ=psIRQ, psState=psState, snmpTrapSrvObj=snmpTrapSrvObj, pciSlotEntry=pciSlotEntry, sysImageVersion=sysImageVersion, psLocation=psLocation, sysBootTime=sysBootTime, snmpTrapSrvEntry=snmpTrapSrvEntry, atPciConfig=atPciConfig, sysReleaseDate=sysReleaseDate, psLength=psLength, sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, psManufacturer=psManufacturer, psDisplayName=psDisplayName, pciSlotTable=pciSlotTable, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDescr=sysDescr, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceID=psDeviceID, psSubsysDeviceID=psSubsysDeviceID, sysDeviceName=sysDeviceName, snmpTrapSrvNumber=snmpTrapSrvNumber, psClassCode=psClassCode, atMgmt=atMgmt, PYSNMP_MODULE_ID=advantechCommonMIB, psFunctionIndex=psFunctionIndex, psBaseAddress=psBaseAddress, advantech=advantech, pciConfigObj=pciConfigObj, psDescr=psDescr, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, sysBootCount=sysBootCount, sysModuleID=sysModuleID)
