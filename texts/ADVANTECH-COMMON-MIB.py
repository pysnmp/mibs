...
Integer32, IpAddress, Bits, MibIdentifier, enterprises, NotificationType, ObjectIdentity, Counter32, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Bits", "MibIdentifier", "enterprises", "NotificationType", "ObjectIdentity", "Counter32", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, psLength=psLength, snmpTrapSrvIP=snmpTrapSrvIP, psDeviceIndex=psDeviceIndex, psVendorID=psVendorID, sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, psDisplayName=psDisplayName, snmpTrapSrvObj=snmpTrapSrvObj, pciConfigObj=pciConfigObj, psIndex=psIndex, psBusIndex=psBusIndex, advantechCommonMIB=advantechCommonMIB, PYSNMP_MODULE_ID=advantechCommonMIB, psSubsysDeviceID=psSubsysDeviceID, snmpTrapVersion=snmpTrapVersion, psNumber=psNumber, sysDeviceName=sysDeviceName, sysModuleID=sysModuleID, atPciConfig=atPciConfig, sysFirstBootTime=sysFirstBootTime, sysReleaseDate=sysReleaseDate, pciSlotTable=pciSlotTable, psDeviceID=psDeviceID, psDescr=psDescr, snmpTrapSrvPort=snmpTrapSrvPort, psModuleType=psModuleType, psLocation=psLocation, sysBootTime=sysBootTime, psFunctionIndex=psFunctionIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIndex=snmpTrapSrvIndex, sysDescr=sysDescr, snmpTrapSrvTable=snmpTrapSrvTable, psModulePorts=psModulePorts, atMgmt=atMgmt, psBaseAddress=psBaseAddress, psClassCode=psClassCode, psManufacturer=psManufacturer, pciSlotEntry=pciSlotEntry, psSubsysVendorID=psSubsysVendorID, psIRQ=psIRQ, psState=psState, atSystem=atSystem, snmpTrapSrvEntry=snmpTrapSrvEntry, advantech=advantech, sysBootCount=sysBootCount)
