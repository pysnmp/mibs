...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Counter32, iso, Unsigned32, ModuleIdentity, ObjectIdentity, enterprises, TimeTicks, Gauge32, Bits, Counter64, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Counter32", "iso", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "enterprises", "TimeTicks", "Gauge32", "Bits", "Counter64", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvNumber=snmpTrapSrvNumber, atPciConfig=atPciConfig, psBusIndex=psBusIndex, psManufacturer=psManufacturer, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, psIndex=psIndex, psBaseAddress=psBaseAddress, atMgmt=atMgmt, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootTime=sysBootTime, psIRQ=psIRQ, advantechCommonMIB=advantechCommonMIB, psLength=psLength, sysReleaseDate=sysReleaseDate, psLocation=psLocation, psFunctionIndex=psFunctionIndex, sysFirstBootTime=sysFirstBootTime, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, sysBootCount=sysBootCount, psNumber=psNumber, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceID=psDeviceID, psVendorID=psVendorID, snmpTrapVersion=snmpTrapVersion, psDisplayName=psDisplayName, PYSNMP_MODULE_ID=advantechCommonMIB, sysImageVersion=sysImageVersion, atSystem=atSystem, psDeviceIndex=psDeviceIndex, psModuleType=psModuleType, psDescr=psDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, advantech=advantech, pciSlotEntry=pciSlotEntry, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psState=psState, sysDescr=sysDescr, sysModuleID=sysModuleID)
