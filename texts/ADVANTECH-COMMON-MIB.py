...
Integer32, ModuleIdentity, Unsigned32, Gauge32, ObjectIdentity, iso, NotificationType, enterprises, Counter32, MibIdentifier, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Unsigned32", "Gauge32", "ObjectIdentity", "iso", "NotificationType", "enterprises", "Counter32", "MibIdentifier", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psNumber=psNumber, pciSlotEntry=pciSlotEntry, psSubsysDeviceID=psSubsysDeviceID, psBaseAddress=psBaseAddress, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, sysImageVersion=sysImageVersion, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootTime=sysBootTime, psSubsysVendorID=psSubsysVendorID, sysModuleID=sysModuleID, snmpTrapSrvObj=snmpTrapSrvObj, pciConfigObj=pciConfigObj, psModuleType=psModuleType, sysReleaseDate=sysReleaseDate, psState=psState, psModulePorts=psModulePorts, psLocation=psLocation, atMgmt=atMgmt, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceIndex=psDeviceIndex, psLength=psLength, psDisplayName=psDisplayName, sysFirstBootTime=sysFirstBootTime, psManufacturer=psManufacturer, pciSlotTable=pciSlotTable, psClassCode=psClassCode, psDescr=psDescr, atSystem=atSystem, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvEntry=snmpTrapSrvEntry, psIRQ=psIRQ, psBusIndex=psBusIndex, snmpTrapSrvPort=snmpTrapSrvPort, advantech=advantech, psDeviceID=psDeviceID, sysDescr=sysDescr, psVendorID=psVendorID, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvTable=snmpTrapSrvTable, advantechCommonMIB=advantechCommonMIB, psFunctionIndex=psFunctionIndex, sysBootCount=sysBootCount, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, psIndex=psIndex)
