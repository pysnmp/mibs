...
MibIdentifier, ModuleIdentity, ObjectIdentity, Unsigned32, iso, Counter64, IpAddress, Integer32, enterprises, Counter32, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "iso", "Counter64", "IpAddress", "Integer32", "enterprises", "Counter32", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciConfigObj=pciConfigObj, pciSlotTable=pciSlotTable, psLocation=psLocation, sysBootCount=sysBootCount, psModuleType=psModuleType, atSystem=atSystem, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysDescr=sysDescr, snmpTrapSrvTable=snmpTrapSrvTable, psBaseAddress=psBaseAddress, sysModuleID=sysModuleID, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, psBusIndex=psBusIndex, psModulePorts=psModulePorts, psState=psState, sysReleaseDate=sysReleaseDate, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDisplayName=psDisplayName, psNumber=psNumber, psVendorID=psVendorID, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysDeviceID=psSubsysDeviceID, advantech=advantech, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvPort=snmpTrapSrvPort, psClassCode=psClassCode, sysBootTime=sysBootTime, sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysVendorID=psSubsysVendorID, psDeviceID=psDeviceID, psManufacturer=psManufacturer, psIRQ=psIRQ, psLength=psLength, sysImageVersion=sysImageVersion, psIndex=psIndex, atMgmt=atMgmt, snmpTrapSrvIP=snmpTrapSrvIP, psFunctionIndex=psFunctionIndex, psDescr=psDescr, pciSlotEntry=pciSlotEntry, PYSNMP_MODULE_ID=advantechCommonMIB, advantechCommonMIB=advantechCommonMIB, atPciConfig=atPciConfig)
