...
Counter64, NotificationType, MibIdentifier, ObjectIdentity, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Bits, Counter32, Gauge32, Integer32, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Bits", "Counter32", "Gauge32", "Integer32", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, sysBootCount=sysBootCount, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapVersion=snmpTrapVersion, psClassCode=psClassCode, sysBootTime=sysBootTime, psState=psState, psManufacturer=psManufacturer, sysImageVersion=sysImageVersion, snmpTrapSrvEntry=snmpTrapSrvEntry, psBaseAddress=psBaseAddress, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModulePorts=psModulePorts, snmpTrapSrvNumber=snmpTrapSrvNumber, advantech=advantech, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotEntry=pciSlotEntry, advantechCommonMIB=advantechCommonMIB, psIndex=psIndex, psLength=psLength, psBusIndex=psBusIndex, pciConfigObj=pciConfigObj, snmpTrapSrvTable=snmpTrapSrvTable, atMgmt=atMgmt, snmpTrapSrvIP=snmpTrapSrvIP, psModuleType=psModuleType, atSystem=atSystem, psSubsysVendorID=psSubsysVendorID, sysReleaseDate=sysReleaseDate, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, psDeviceID=psDeviceID, psLocation=psLocation, psNumber=psNumber, psIRQ=psIRQ, pciSlotTable=pciSlotTable, snmpTrapSrvPort=snmpTrapSrvPort, sysFirstBootTime=sysFirstBootTime, psDisplayName=psDisplayName, psDeviceIndex=psDeviceIndex, psSubsysDeviceID=psSubsysDeviceID, psDescr=psDescr, atPciConfig=atPciConfig, psFunctionIndex=psFunctionIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psVendorID=psVendorID)
