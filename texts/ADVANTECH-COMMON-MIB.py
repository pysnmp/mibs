...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, MibIdentifier, NotificationType, ModuleIdentity, Gauge32, Unsigned32, Counter32, ObjectIdentity, enterprises, iso, IpAddress, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "MibIdentifier", "NotificationType", "ModuleIdentity", "Gauge32", "Unsigned32", "Counter32", "ObjectIdentity", "enterprises", "iso", "IpAddress", "Counter64", "Bits")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapVersion=snmpTrapVersion, sysModuleID=sysModuleID, pciSlotTable=pciSlotTable, psNumber=psNumber, atSystem=atSystem, pciSlotEntry=pciSlotEntry, psSubsysVendorID=psSubsysVendorID, psDescr=psDescr, psDeviceID=psDeviceID, psLength=psLength, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psClassCode=psClassCode, psVendorID=psVendorID, psManufacturer=psManufacturer, psIRQ=psIRQ, psState=psState, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootTime=sysBootTime, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvNumber=snmpTrapSrvNumber, psLocation=psLocation, psSubsysDeviceID=psSubsysDeviceID, atPciConfig=atPciConfig, snmpTrapSrvEntry=snmpTrapSrvEntry, advantech=advantech, sysBootCount=sysBootCount, pciConfigObj=pciConfigObj, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psDeviceIndex=psDeviceIndex, psModulePorts=psModulePorts, sysReleaseDate=sysReleaseDate, atMgmt=atMgmt, psFunctionIndex=psFunctionIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, sysFirstBootTime=sysFirstBootTime, psModuleType=psModuleType, psBusIndex=psBusIndex, psDisplayName=psDisplayName, sysDeviceName=sysDeviceName, sysDescr=sysDescr, psIndex=psIndex, psBaseAddress=psBaseAddress, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvPort=snmpTrapSrvPort, sysImageVersion=sysImageVersion)
