...
Unsigned32, NotificationType, MibIdentifier, IpAddress, Gauge32, enterprises, Counter64, ModuleIdentity, iso, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "MibIdentifier", "IpAddress", "Gauge32", "enterprises", "Counter64", "ModuleIdentity", "iso", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psNumber=psNumber, psLength=psLength, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psModulePorts=psModulePorts, pciSlotTable=pciSlotTable, psVendorID=psVendorID, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceIndex=psDeviceIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psDescr=psDescr, psDeviceID=psDeviceID, psIRQ=psIRQ, sysDescr=sysDescr, psFunctionIndex=psFunctionIndex, advantech=advantech, snmpTrapSrvTable=snmpTrapSrvTable, psManufacturer=psManufacturer, psIndex=psIndex, atSystem=atSystem, atPciConfig=atPciConfig, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootTime=sysBootTime, psDisplayName=psDisplayName, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psClassCode=psClassCode, psModuleType=psModuleType, advantechCommonMIB=advantechCommonMIB, sysModuleID=sysModuleID, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotEntry=pciSlotEntry, psLocation=psLocation, psBaseAddress=psBaseAddress, psState=psState, sysImageVersion=sysImageVersion, pciConfigObj=pciConfigObj, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDeviceName=sysDeviceName, snmpTrapSrvPort=snmpTrapSrvPort, sysBootCount=sysBootCount, psSubsysDeviceID=psSubsysDeviceID, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvObj=snmpTrapSrvObj, sysReleaseDate=sysReleaseDate, atMgmt=atMgmt)
