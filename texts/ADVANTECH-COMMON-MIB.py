...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Counter32, NotificationType, ObjectIdentity, IpAddress, TimeTicks, Gauge32, enterprises, Unsigned32, Bits, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Counter32", "NotificationType", "ObjectIdentity", "IpAddress", "TimeTicks", "Gauge32", "enterprises", "Unsigned32", "Bits", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysDeviceID=psSubsysDeviceID, atSystem=atSystem, sysBootCount=sysBootCount, snmpTrapSrvTable=snmpTrapSrvTable, psIRQ=psIRQ, snmpTrapSrvObj=snmpTrapSrvObj, sysImageVersion=sysImageVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysReleaseDate=sysReleaseDate, psManufacturer=psManufacturer, atMgmt=atMgmt, psDeviceID=psDeviceID, snmpTrapSrvEntry=snmpTrapSrvEntry, sysDeviceName=sysDeviceName, advantechCommonMIB=advantechCommonMIB, atPciConfig=atPciConfig, psState=psState, psNumber=psNumber, snmpTrapSrvPort=snmpTrapSrvPort, psVendorID=psVendorID, psIndex=psIndex, pciSlotEntry=pciSlotEntry, psLocation=psLocation, sysDescr=sysDescr, sysBootTime=sysBootTime, psLength=psLength, psDeviceIndex=psDeviceIndex, psBaseAddress=psBaseAddress, psClassCode=psClassCode, sysFirstBootTime=sysFirstBootTime, psModuleType=psModuleType, psFunctionIndex=psFunctionIndex, snmpTrapVersion=snmpTrapVersion, psBusIndex=psBusIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psSubsysVendorID=psSubsysVendorID, psDisplayName=psDisplayName, pciSlotTable=pciSlotTable, advantech=advantech, sysModuleID=sysModuleID, pciConfigObj=pciConfigObj, psDescr=psDescr, snmpTrapSrvIP=snmpTrapSrvIP, psModulePorts=psModulePorts, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex)
