...
NotificationType, Integer32, IpAddress, Bits, ModuleIdentity, Counter32, Gauge32, Counter64, iso, ObjectIdentity, TimeTicks, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "IpAddress", "Bits", "ModuleIdentity", "Counter32", "Gauge32", "Counter64", "iso", "ObjectIdentity", "TimeTicks", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvTable=snmpTrapSrvTable, atPciConfig=atPciConfig, psVendorID=psVendorID, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootCount=sysBootCount, psLocation=psLocation, advantechCommonMIB=advantechCommonMIB, psBusIndex=psBusIndex, psNumber=psNumber, psSubsysVendorID=psSubsysVendorID, sysDescr=sysDescr, psSubsysDeviceID=psSubsysDeviceID, PYSNMP_MODULE_ID=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModulePorts=psModulePorts, atMgmt=atMgmt, snmpTrapVersion=snmpTrapVersion, psFunctionIndex=psFunctionIndex, psDisplayName=psDisplayName, psIRQ=psIRQ, snmpTrapSrvPort=snmpTrapSrvPort, psBaseAddress=psBaseAddress, sysImageVersion=sysImageVersion, pciSlotEntry=pciSlotEntry, sysModuleID=sysModuleID, psDescr=psDescr, advantech=advantech, pciConfigObj=pciConfigObj, psModuleType=psModuleType, snmpTrapSrvIndex=snmpTrapSrvIndex, psLength=psLength, atSystem=atSystem, sysDeviceName=sysDeviceName, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvObj=snmpTrapSrvObj, psManufacturer=psManufacturer, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDeviceID=psDeviceID, psClassCode=psClassCode, sysReleaseDate=sysReleaseDate, psIndex=psIndex, pciSlotTable=pciSlotTable, psState=psState, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceIndex=psDeviceIndex, sysBootTime=sysBootTime)
