...
# Produced by pysmi-1.1.8 at Fri Jan  7 15:10:23 2022
...
enterprises, TimeTicks, MibIdentifier, IpAddress, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, iso, ObjectIdentity, Unsigned32, ModuleIdentity, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "MibIdentifier", "IpAddress", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "iso", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", atSystem=atSystem, pciSlotTable=pciSlotTable, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psDescr=psDescr, sysFirstBootTime=sysFirstBootTime, psIndex=psIndex, psVendorID=psVendorID, psManufacturer=psManufacturer, sysImageVersion=sysImageVersion, psNumber=psNumber, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvNumber=snmpTrapSrvNumber, sysBootTime=sysBootTime, psModuleType=psModuleType, psBaseAddress=psBaseAddress, psSubsysDeviceID=psSubsysDeviceID, psBusIndex=psBusIndex, sysBootCount=sysBootCount, snmpTrapSrvTable=snmpTrapSrvTable, psSubsysVendorID=psSubsysVendorID, psLength=psLength, sysReleaseDate=sysReleaseDate, advantech=advantech, psState=psState, pciConfigObj=pciConfigObj, psFunctionIndex=psFunctionIndex, sysDescr=sysDescr, PYSNMP_MODULE_ID=advantechCommonMIB, sysDeviceName=sysDeviceName, psLocation=psLocation, psClassCode=psClassCode, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvIndex=snmpTrapSrvIndex, psDisplayName=psDisplayName, psModulePorts=psModulePorts, atPciConfig=atPciConfig, psDeviceIndex=psDeviceIndex, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvPort=snmpTrapSrvPort, sysModuleID=sysModuleID, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvObj=snmpTrapSrvObj, psDeviceID=psDeviceID, pciSlotEntry=pciSlotEntry, psIRQ=psIRQ, atMgmt=atMgmt)
