...
Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, Bits, Counter64, Unsigned32, MibIdentifier, iso, Integer32, NotificationType, ObjectIdentity, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "Bits", "Counter64", "Unsigned32", "MibIdentifier", "iso", "Integer32", "NotificationType", "ObjectIdentity", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvTable=snmpTrapSrvTable, psDeviceID=psDeviceID, psFunctionIndex=psFunctionIndex, psState=psState, atMgmt=atMgmt, sysImageVersion=sysImageVersion, PYSNMP_MODULE_ID=advantechCommonMIB, sysReleaseDate=sysReleaseDate, snmpTrapSrvIndex=snmpTrapSrvIndex, psDescr=psDescr, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapVersion=snmpTrapVersion, psIndex=psIndex, psBaseAddress=psBaseAddress, sysModuleID=sysModuleID, psIRQ=psIRQ, snmpTrapSrvNumber=snmpTrapSrvNumber, psClassCode=psClassCode, snmpTrapSrvEntry=snmpTrapSrvEntry, psDisplayName=psDisplayName, atSystem=atSystem, psSubsysDeviceID=psSubsysDeviceID, sysFirstBootTime=sysFirstBootTime, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciConfigObj=pciConfigObj, psDeviceIndex=psDeviceIndex, psModulePorts=psModulePorts, atPciConfig=atPciConfig, sysDeviceName=sysDeviceName, pciSlotTable=pciSlotTable, sysBootCount=sysBootCount, psNumber=psNumber, pciSlotEntry=pciSlotEntry, psManufacturer=psManufacturer, sysDescr=sysDescr, snmpTrapSrvIP=snmpTrapSrvIP, psVendorID=psVendorID, psLocation=psLocation, sysBootTime=sysBootTime, psLength=psLength, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, advantech=advantech, psModuleType=psModuleType)
