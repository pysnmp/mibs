...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, Integer32, NotificationType, ObjectIdentity, Unsigned32, ModuleIdentity, MibIdentifier, TimeTicks, IpAddress, Gauge32, enterprises, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "Integer32", "NotificationType", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "MibIdentifier", "TimeTicks", "IpAddress", "Gauge32", "enterprises", "Bits", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDescr=psDescr, psDeviceID=psDeviceID, psFunctionIndex=psFunctionIndex, snmpTrapSrvIP=snmpTrapSrvIP, psVendorID=psVendorID, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvObj=snmpTrapSrvObj, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIndex=psIndex, psSubsysDeviceID=psSubsysDeviceID, psDisplayName=psDisplayName, psLocation=psLocation, sysFirstBootTime=sysFirstBootTime, sysBootTime=sysBootTime, atSystem=atSystem, sysReleaseDate=sysReleaseDate, snmpTrapSrvNumber=snmpTrapSrvNumber, pciConfigObj=pciConfigObj, psNumber=psNumber, sysImageVersion=sysImageVersion, pciSlotTable=pciSlotTable, psSubsysVendorID=psSubsysVendorID, psBaseAddress=psBaseAddress, atPciConfig=atPciConfig, snmpTrapVersion=snmpTrapVersion, pciSlotEntry=pciSlotEntry, psState=psState, PYSNMP_MODULE_ID=advantechCommonMIB, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvTable=snmpTrapSrvTable, psManufacturer=psManufacturer, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModuleType=psModuleType, psDeviceIndex=psDeviceIndex, atMgmt=atMgmt, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, psLength=psLength, psClassCode=psClassCode, advantech=advantech, psModulePorts=psModulePorts, sysDescr=sysDescr, sysBootCount=sysBootCount, psBusIndex=psBusIndex, psIRQ=psIRQ, snmpTrapSrvIndex=snmpTrapSrvIndex)
