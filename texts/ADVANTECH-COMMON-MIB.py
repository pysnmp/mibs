...
Integer32, Gauge32, NotificationType, Unsigned32, Counter32, Bits, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, ObjectIdentity, Counter64, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "NotificationType", "Unsigned32", "Counter32", "Bits", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "ObjectIdentity", "Counter64", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, psDisplayName=psDisplayName, sysBootCount=sysBootCount, snmpTrapSrvPort=snmpTrapSrvPort, psModuleType=psModuleType, pciSlotTable=pciSlotTable, psModulePorts=psModulePorts, psIRQ=psIRQ, psVendorID=psVendorID, sysImageVersion=sysImageVersion, atMgmt=atMgmt, advantech=advantech, psSubsysVendorID=psSubsysVendorID, psFunctionIndex=psFunctionIndex, atPciConfig=atPciConfig, psBaseAddress=psBaseAddress, snmpTrapSrvObj=snmpTrapSrvObj, psManufacturer=psManufacturer, sysFirstBootTime=sysFirstBootTime, psLocation=psLocation, psDescr=psDescr, psLength=psLength, psClassCode=psClassCode, snmpTrapSrvEntry=snmpTrapSrvEntry, psState=psState, pciConfigObj=pciConfigObj, pciSlotEntry=pciSlotEntry, sysBootTime=sysBootTime, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapVersion=snmpTrapVersion, sysModuleID=sysModuleID, psSubsysDeviceID=psSubsysDeviceID, sysReleaseDate=sysReleaseDate, psNumber=psNumber, psDeviceIndex=psDeviceIndex, sysDescr=sysDescr, sysDeviceName=sysDeviceName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceID=psDeviceID, atSystem=atSystem, psBusIndex=psBusIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity)
