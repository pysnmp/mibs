...
Counter32, IpAddress, iso, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Unsigned32, ObjectIdentity, enterprises, MibIdentifier, ModuleIdentity, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "iso", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Unsigned32", "ObjectIdentity", "enterprises", "MibIdentifier", "ModuleIdentity", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, pciConfigObj=pciConfigObj, psLength=psLength, sysReleaseDate=sysReleaseDate, advantech=advantech, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapVersion=snmpTrapVersion, psDeviceIndex=psDeviceIndex, snmpTrapSrvObj=snmpTrapSrvObj, psLocation=psLocation, snmpTrapSrvTable=snmpTrapSrvTable, atSystem=atSystem, snmpTrapSrvNumber=snmpTrapSrvNumber, PYSNMP_MODULE_ID=advantechCommonMIB, sysBootTime=sysBootTime, psDisplayName=psDisplayName, psBusIndex=psBusIndex, sysDescr=sysDescr, psNumber=psNumber, snmpTrapSrvIP=snmpTrapSrvIP, sysDeviceName=sysDeviceName, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, psFunctionIndex=psFunctionIndex, pciSlotEntry=pciSlotEntry, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psDescr=psDescr, psModuleType=psModuleType, psModulePorts=psModulePorts, sysModuleID=sysModuleID, psBaseAddress=psBaseAddress, psManufacturer=psManufacturer, atMgmt=atMgmt, psSubsysDeviceID=psSubsysDeviceID, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvPort=snmpTrapSrvPort, sysBootCount=sysBootCount, psIRQ=psIRQ, psClassCode=psClassCode, psState=psState, advantechCommonMIB=advantechCommonMIB, sysImageVersion=sysImageVersion, psVendorID=psVendorID, pciSlotTable=pciSlotTable, atPciConfig=atPciConfig, psDeviceID=psDeviceID)
