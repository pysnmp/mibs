...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", advantechCommonMIB=advantechCommonMIB, pciSlotTable=pciSlotTable, psIRQ=psIRQ, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, psModuleType=psModuleType, snmpTrapSrvTable=snmpTrapSrvTable, psModulePorts=psModulePorts, psLength=psLength, psDisplayName=psDisplayName, sysDeviceName=sysDeviceName, psState=psState, psDeviceID=psDeviceID, atPciConfig=atPciConfig, PYSNMP_MODULE_ID=advantechCommonMIB, pciConfigObj=pciConfigObj, psClassCode=psClassCode, psFunctionIndex=psFunctionIndex, pciSlotEntry=pciSlotEntry, psBusIndex=psBusIndex, snmpTrapSrvObj=snmpTrapSrvObj, sysFirstBootTime=sysFirstBootTime, psDeviceIndex=psDeviceIndex, atMgmt=atMgmt, sysModuleID=sysModuleID, sysImageVersion=sysImageVersion, sysBootCount=sysBootCount, psDescr=psDescr, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psIndex=psIndex, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psVendorID=psVendorID, psLocation=psLocation, snmpTrapSrvNumber=snmpTrapSrvNumber, atSystem=atSystem, snmpTrapSrvEntry=snmpTrapSrvEntry, sysBootTime=sysBootTime, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvPort=snmpTrapSrvPort, psSubsysDeviceID=psSubsysDeviceID, psNumber=psNumber, psManufacturer=psManufacturer, advantech=advantech, psBaseAddress=psBaseAddress, snmpTrapSrvIP=snmpTrapSrvIP, sysReleaseDate=sysReleaseDate)
