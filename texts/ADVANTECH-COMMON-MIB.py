...
TimeTicks, Counter32, NotificationType, Unsigned32, iso, ModuleIdentity, Integer32, MibIdentifier, Gauge32, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "NotificationType", "Unsigned32", "iso", "ModuleIdentity", "Integer32", "MibIdentifier", "Gauge32", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "enterprises")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciSlotEntry=pciSlotEntry, psVendorID=psVendorID, psModuleType=psModuleType, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, psModulePorts=psModulePorts, sysBootCount=sysBootCount, snmpTrapSrvIndex=snmpTrapSrvIndex, sysBootTime=sysBootTime, psManufacturer=psManufacturer, sysImageVersion=sysImageVersion, atSystem=atSystem, atPciConfig=atPciConfig, pciConfigObj=pciConfigObj, psState=psState, psClassCode=psClassCode, psLocation=psLocation, atMgmt=atMgmt, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psSubsysVendorID=psSubsysVendorID, psLength=psLength, psDeviceID=psDeviceID, psNumber=psNumber, psFunctionIndex=psFunctionIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psDescr=psDescr, sysDeviceName=sysDeviceName, advantech=advantech, snmpTrapSrvTable=snmpTrapSrvTable, advantechCommonMIB=advantechCommonMIB, psIRQ=psIRQ, psSubsysDeviceID=psSubsysDeviceID, snmpTrapVersion=snmpTrapVersion, psIndex=psIndex, sysDescr=sysDescr, psBaseAddress=psBaseAddress, snmpTrapSrvEntry=snmpTrapSrvEntry, psBusIndex=psBusIndex, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate, sysFirstBootTime=sysFirstBootTime, psDisplayName=psDisplayName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, sysModuleID=sysModuleID, snmpTrapSrvPort=snmpTrapSrvPort, psDeviceIndex=psDeviceIndex, snmpTrapSrvIP=snmpTrapSrvIP)
