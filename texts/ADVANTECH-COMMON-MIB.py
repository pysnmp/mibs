...
# Produced by pysmi-1.1.3 at Wed Dec  1 15:38:14 2021
...
enterprises, TimeTicks, Bits, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, Integer32, ObjectIdentity, iso, IpAddress, NotificationType, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "Bits", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "Integer32", "ObjectIdentity", "iso", "IpAddress", "NotificationType", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapSrvCommunity=snmpTrapSrvCommunity, psBusIndex=psBusIndex, psVendorID=psVendorID, sysFirstBootTime=sysFirstBootTime, psIndex=psIndex, psDescr=psDescr, pciSlotEntry=pciSlotEntry, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapSrvNumber=snmpTrapSrvNumber, sysImageVersion=sysImageVersion, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapVersion=snmpTrapVersion, psDeviceID=psDeviceID, advantech=advantech, psClassCode=psClassCode, snmpTrapSrvEntry=snmpTrapSrvEntry, atMgmt=atMgmt, pciConfigObj=pciConfigObj, psModulePorts=psModulePorts, psManufacturer=psManufacturer, psBaseAddress=psBaseAddress, psLength=psLength, sysModuleID=sysModuleID, snmpTrapSrvIndex=snmpTrapSrvIndex, advantechCommonMIB=advantechCommonMIB, psFunctionIndex=psFunctionIndex, psIRQ=psIRQ, psNumber=psNumber, pciSlotTable=pciSlotTable, PYSNMP_MODULE_ID=advantechCommonMIB, atPciConfig=atPciConfig, sysBootCount=sysBootCount, psDeviceIndex=psDeviceIndex, psLocation=psLocation, sysReleaseDate=sysReleaseDate, psState=psState, sysDescr=sysDescr, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvIP=snmpTrapSrvIP, psDisplayName=psDisplayName, psSubsysVendorID=psSubsysVendorID, psModuleType=psModuleType, sysBootTime=sysBootTime, sysDeviceName=sysDeviceName, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, atSystem=atSystem, psSubsysDeviceID=psSubsysDeviceID)
