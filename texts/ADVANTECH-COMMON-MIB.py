...
iso, Unsigned32, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, ModuleIdentity, Bits, Integer32, Counter32, Counter64, NotificationType, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Bits", "Integer32", "Counter32", "Counter64", "NotificationType", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", snmpTrapVersion=snmpTrapVersion, psFunctionIndex=psFunctionIndex, psLength=psLength, atSystem=atSystem, sysDeviceName=sysDeviceName, psState=psState, snmpTrapSrvTable=snmpTrapSrvTable, psIndex=psIndex, psModulePorts=psModulePorts, psDeviceID=psDeviceID, psDeviceIndex=psDeviceIndex, pciSlotEntry=pciSlotEntry, pciSlotTable=pciSlotTable, snmpTrapSrvPort=snmpTrapSrvPort, sysModuleID=sysModuleID, sysBootCount=sysBootCount, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysDeviceID=psSubsysDeviceID, sysImageVersion=sysImageVersion, psLocation=psLocation, psSubsysVendorID=psSubsysVendorID, atPciConfig=atPciConfig, psBaseAddress=psBaseAddress, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psNumber=psNumber, snmpTrapSrvIndex=snmpTrapSrvIndex, psManufacturer=psManufacturer, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvNumber=snmpTrapSrvNumber, PYSNMP_MODULE_ID=advantechCommonMIB, advantechCommonMIB=advantechCommonMIB, psIRQ=psIRQ, psClassCode=psClassCode, psVendorID=psVendorID, atMgmt=atMgmt, psBusIndex=psBusIndex, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, pciConfigObj=pciConfigObj, sysReleaseDate=sysReleaseDate, sysBootTime=sysBootTime, psDisplayName=psDisplayName, psModuleType=psModuleType, advantech=advantech, sysDescr=sysDescr, psDescr=psDescr)
