...
Integer32, NotificationType, Counter64, ObjectIdentity, IpAddress, ModuleIdentity, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, Gauge32, TimeTicks, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter64", "ObjectIdentity", "IpAddress", "ModuleIdentity", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "Gauge32", "TimeTicks", "Bits", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciSlotTable=pciSlotTable, psSubsysVendorID=psSubsysVendorID, advantech=advantech, psDeviceID=psDeviceID, psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, psLength=psLength, atSystem=atSystem, psBaseAddress=psBaseAddress, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceIndex=psDeviceIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psVendorID=psVendorID, psBusIndex=psBusIndex, pciSlotEntry=pciSlotEntry, sysModuleID=sysModuleID, psIRQ=psIRQ, psLocation=psLocation, psState=psState, psDescr=psDescr, psIndex=psIndex, sysFirstBootTime=sysFirstBootTime, sysDescr=sysDescr, sysBootTime=sysBootTime, snmpTrapSrvTable=snmpTrapSrvTable, psManufacturer=psManufacturer, atPciConfig=atPciConfig, atMgmt=atMgmt, sysImageVersion=sysImageVersion, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDeviceName=sysDeviceName, sysBootCount=sysBootCount, psModuleType=psModuleType, snmpTrapSrvIP=snmpTrapSrvIP, psFunctionIndex=psFunctionIndex, snmpTrapSrvIndex=snmpTrapSrvIndex, psNumber=psNumber, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModulePorts=psModulePorts, snmpTrapSrvPort=snmpTrapSrvPort, snmpTrapVersion=snmpTrapVersion, pciConfigObj=pciConfigObj, sysReleaseDate=sysReleaseDate, advantechCommonMIB=advantechCommonMIB, psDisplayName=psDisplayName)
