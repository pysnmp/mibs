...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysDeviceID=psSubsysDeviceID, psClassCode=psClassCode, psState=psState, snmpTrapSrvEntry=snmpTrapSrvEntry, psDeviceID=psDeviceID, sysImageVersion=sysImageVersion, psManufacturer=psManufacturer, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysReleaseDate=sysReleaseDate, advantech=advantech, sysBootTime=sysBootTime, sysModuleID=sysModuleID, psLength=psLength, pciSlotEntry=pciSlotEntry, psIRQ=psIRQ, snmpTrapSrvNumber=snmpTrapSrvNumber, snmpTrapSrvIP=snmpTrapSrvIP, psIndex=psIndex, psDeviceIndex=psDeviceIndex, PYSNMP_MODULE_ID=advantechCommonMIB, pciSlotTable=pciSlotTable, psBaseAddress=psBaseAddress, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, psLocation=psLocation, sysFirstBootTime=sysFirstBootTime, psBusIndex=psBusIndex, sysDescr=sysDescr, snmpTrapSrvObj=snmpTrapSrvObj, atSystem=atSystem, psModuleType=psModuleType, psDisplayName=psDisplayName, psNumber=psNumber, advantechCommonMIB=advantechCommonMIB, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, snmpTrapSrvPort=snmpTrapSrvPort, atMgmt=atMgmt, snmpTrapVersion=snmpTrapVersion, psVendorID=psVendorID, sysDeviceName=sysDeviceName, psModulePorts=psModulePorts, psDescr=psDescr, psFunctionIndex=psFunctionIndex, sysBootCount=sysBootCount, snmpTrapSrvIndex=snmpTrapSrvIndex)
