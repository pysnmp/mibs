...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", pciSlotTable=pciSlotTable, snmpTrapSrvIndex=snmpTrapSrvIndex, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapVersion=snmpTrapVersion, sysBootTime=sysBootTime, pciSlotEntry=pciSlotEntry, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvObj=snmpTrapSrvObj, snmpTrapSrvTable=snmpTrapSrvTable, psBaseAddress=psBaseAddress, advantechCommonMIB=advantechCommonMIB, psBusIndex=psBusIndex, psDeviceID=psDeviceID, psLength=psLength, sysDescr=sysDescr, sysBootCount=sysBootCount, atSystem=atSystem, sysReleaseDate=sysReleaseDate, psClassCode=psClassCode, psSubsysDeviceID=psSubsysDeviceID, psModulePorts=psModulePorts, advantech=advantech, snmpTrapSrvEntry=snmpTrapSrvEntry, psIRQ=psIRQ, sysDeviceName=sysDeviceName, psNumber=psNumber, psVendorID=psVendorID, sysModuleID=sysModuleID, snmpTrapSrvNumber=snmpTrapSrvNumber, psLocation=psLocation, psState=psState, psModuleType=psModuleType, psDeviceIndex=psDeviceIndex, psIndex=psIndex, psDescr=psDescr, psFunctionIndex=psFunctionIndex, PYSNMP_MODULE_ID=advantechCommonMIB, psDisplayName=psDisplayName, snmpTrapSrvPort=snmpTrapSrvPort, atMgmt=atMgmt, psManufacturer=psManufacturer, psSubsysVendorID=psSubsysVendorID, pciConfigObj=pciConfigObj, snmpTrapSrvIP=snmpTrapSrvIP, atPciConfig=atPciConfig, sysImageVersion=sysImageVersion)
