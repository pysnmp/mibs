...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psSubsysDeviceID=psSubsysDeviceID, psLength=psLength, psBusIndex=psBusIndex, atPciConfig=atPciConfig, sysReleaseDate=sysReleaseDate, atMgmt=atMgmt, sysFirstBootTime=sysFirstBootTime, psNumber=psNumber, psIndex=psIndex, snmpTrapSrvPort=snmpTrapSrvPort, psFunctionIndex=psFunctionIndex, psModulePorts=psModulePorts, psClassCode=psClassCode, advantechCommonMIB=advantechCommonMIB, snmpTrapSrvIP=snmpTrapSrvIP, psModuleType=psModuleType, snmpTrapSrvNumber=snmpTrapSrvNumber, psDeviceIndex=psDeviceIndex, snmpTrapSrvEntry=snmpTrapSrvEntry, psBaseAddress=psBaseAddress, sysImageVersion=sysImageVersion, pciSlotEntry=pciSlotEntry, snmpTrapSrvTable=snmpTrapSrvTable, psLocation=psLocation, pciSlotTable=pciSlotTable, snmpTrapVersion=snmpTrapVersion, atSystem=atSystem, psIRQ=psIRQ, psSubsysVendorID=psSubsysVendorID, psDisplayName=psDisplayName, advantech=advantech, psVendorID=psVendorID, snmpTrapSrvObj=snmpTrapSrvObj, PYSNMP_MODULE_ID=advantechCommonMIB, sysModuleID=sysModuleID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysBootCount=sysBootCount, snmpTrapSrvIndex=snmpTrapSrvIndex, psDescr=psDescr, pciConfigObj=pciConfigObj, psManufacturer=psManufacturer, psState=psState, sysBootTime=sysBootTime, sysDeviceName=sysDeviceName, sysDescr=sysDescr, psDeviceID=psDeviceID)
