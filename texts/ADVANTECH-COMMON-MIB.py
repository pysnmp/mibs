...
TimeTicks, ModuleIdentity, MibIdentifier, Counter64, Unsigned32, ObjectIdentity, Integer32, NotificationType, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Counter64", "Unsigned32", "ObjectIdentity", "Integer32", "NotificationType", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psDeviceIndex=psDeviceIndex, pciSlotEntry=pciSlotEntry, psModuleType=psModuleType, snmpTrapVersion=snmpTrapVersion, atPciConfig=atPciConfig, psVendorID=psVendorID, sysBootTime=sysBootTime, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceID=psDeviceID, sysImageVersion=sysImageVersion, psState=psState, psSubsysDeviceID=psSubsysDeviceID, sysModuleID=sysModuleID, psIRQ=psIRQ, psBusIndex=psBusIndex, psLocation=psLocation, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvNumber=snmpTrapSrvNumber, psBaseAddress=psBaseAddress, sysBootCount=sysBootCount, psIndex=psIndex, psClassCode=psClassCode, advantech=advantech, snmpTrapSrvTable=snmpTrapSrvTable, pciSlotTable=pciSlotTable, sysDeviceName=sysDeviceName, snmpTrapSrvObj=snmpTrapSrvObj, atMgmt=atMgmt, PYSNMP_MODULE_ID=advantechCommonMIB, psFunctionIndex=psFunctionIndex, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psModulePorts=psModulePorts, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvPort=snmpTrapSrvPort, advantechCommonMIB=advantechCommonMIB, psSubsysVendorID=psSubsysVendorID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psLength=psLength, psManufacturer=psManufacturer, atSystem=atSystem, sysDescr=sysDescr, psNumber=psNumber, sysReleaseDate=sysReleaseDate, psDisplayName=psDisplayName, psDescr=psDescr, pciConfigObj=pciConfigObj, sysFirstBootTime=sysFirstBootTime)
