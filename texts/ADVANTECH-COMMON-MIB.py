...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Integer32, TimeTicks, NotificationType, Bits, Gauge32, Unsigned32, iso, ModuleIdentity, Counter64, IpAddress, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Integer32", "TimeTicks", "NotificationType", "Bits", "Gauge32", "Unsigned32", "iso", "ModuleIdentity", "Counter64", "IpAddress", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModuleType=psModuleType, advantech=advantech, sysReleaseDate=sysReleaseDate, psBaseAddress=psBaseAddress, snmpTrapVersion=snmpTrapVersion, psLength=psLength, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, snmpTrapSrvIP=snmpTrapSrvIP, advantechCommonMIB=advantechCommonMIB, psManufacturer=psManufacturer, psNumber=psNumber, pciConfigObj=pciConfigObj, atMgmt=atMgmt, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvCommunity=snmpTrapSrvCommunity, psVendorID=psVendorID, psModulePorts=psModulePorts, psIndex=psIndex, psBusIndex=psBusIndex, psSubsysDeviceID=psSubsysDeviceID, sysDeviceName=sysDeviceName, atSystem=atSystem, sysBootCount=sysBootCount, psIRQ=psIRQ, snmpTrapSrvIndex=snmpTrapSrvIndex, psDeviceIndex=psDeviceIndex, snmpTrapSrvNumber=snmpTrapSrvNumber, psDescr=psDescr, psLocation=psLocation, PYSNMP_MODULE_ID=advantechCommonMIB, sysModuleID=sysModuleID, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysVendorID=psSubsysVendorID, psDeviceID=psDeviceID, snmpTrapSrvObj=snmpTrapSrvObj, psClassCode=psClassCode, pciSlotTable=pciSlotTable, psState=psState, snmpTrapSrvPort=snmpTrapSrvPort, sysDescr=sysDescr, sysImageVersion=sysImageVersion, psDisplayName=psDisplayName, psFunctionIndex=psFunctionIndex, sysBootTime=sysBootTime, pciSlotEntry=pciSlotEntry, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable)
