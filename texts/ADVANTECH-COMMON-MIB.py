...
MibIdentifier, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, ModuleIdentity, ObjectIdentity, IpAddress, iso, Counter32, TimeTicks, Unsigned32, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "ModuleIdentity", "ObjectIdentity", "IpAddress", "iso", "Counter32", "TimeTicks", "Unsigned32", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psModuleType=psModuleType, sysBootTime=sysBootTime, snmpTrapSrvTable=snmpTrapSrvTable, psDisplayName=psDisplayName, snmpTrapSrvCommunity=snmpTrapSrvCommunity, snmpTrapSrvEntry=snmpTrapSrvEntry, psVendorID=psVendorID, snmpTrapSrvNumber=snmpTrapSrvNumber, sysDescr=sysDescr, advantech=advantech, psFunctionIndex=psFunctionIndex, psLength=psLength, atSystem=atSystem, snmpTrapSrvIndex=snmpTrapSrvIndex, atPciConfig=atPciConfig, psIndex=psIndex, psDeviceIndex=psDeviceIndex, psLocation=psLocation, pciSlotEntry=pciSlotEntry, psDescr=psDescr, atMgmt=atMgmt, PYSNMP_MODULE_ID=advantechCommonMIB, psBusIndex=psBusIndex, psState=psState, psModulePorts=psModulePorts, sysImageVersion=sysImageVersion, snmpTrapSrvPort=snmpTrapSrvPort, pciSlotTable=pciSlotTable, sysReleaseDate=sysReleaseDate, snmpTrapVersion=snmpTrapVersion, psSubsysDeviceID=psSubsysDeviceID, advantechCommonMIB=advantechCommonMIB, sysFirstBootTime=sysFirstBootTime, psClassCode=psClassCode, sysModuleID=sysModuleID, sysDeviceName=sysDeviceName, pciConfigObj=pciConfigObj, psIRQ=psIRQ, psSubsysVendorID=psSubsysVendorID, psDeviceID=psDeviceID, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psBaseAddress=psBaseAddress, psManufacturer=psManufacturer, snmpTrapSrvObj=snmpTrapSrvObj, psNumber=psNumber, snmpTrapSrvIP=snmpTrapSrvIP, sysBootCount=sysBootCount)
