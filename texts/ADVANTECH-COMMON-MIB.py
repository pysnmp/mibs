...
enterprises, TimeTicks, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, NotificationType, Integer32, IpAddress, Unsigned32, Bits, Gauge32, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "NotificationType", "Integer32", "IpAddress", "Unsigned32", "Bits", "Gauge32", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", psNumber=psNumber, psDeviceIndex=psDeviceIndex, psModuleType=psModuleType, psModulePorts=psModulePorts, sysBootTime=sysBootTime, sysBootCount=sysBootCount, psDescr=psDescr, psState=psState, sysDescr=sysDescr, snmpTrapSrvIndex=snmpTrapSrvIndex, psBusIndex=psBusIndex, psManufacturer=psManufacturer, sysModuleID=sysModuleID, snmpTrapVersion=snmpTrapVersion, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, psSubsysVendorID=psSubsysVendorID, advantechCommonMIB=advantechCommonMIB, psDisplayName=psDisplayName, snmpTrapSrvObj=snmpTrapSrvObj, sysDeviceName=sysDeviceName, psClassCode=psClassCode, snmpTrapSrvPort=snmpTrapSrvPort, psFunctionIndex=psFunctionIndex, atSystem=atSystem, psLength=psLength, snmpTrapSrvCommunity=snmpTrapSrvCommunity, sysReleaseDate=sysReleaseDate, atPciConfig=atPciConfig, snmpTrapSrvTable=snmpTrapSrvTable, advantech=advantech, snmpTrapSrvIP=snmpTrapSrvIP, pciSlotTable=pciSlotTable, psLocation=psLocation, atMgmt=atMgmt, psIRQ=psIRQ, psBaseAddress=psBaseAddress, sysImageVersion=sysImageVersion, PYSNMP_MODULE_ID=advantechCommonMIB, psDeviceID=psDeviceID, pciSlotEntry=pciSlotEntry, sysFirstBootTime=sysFirstBootTime, snmpTrapSrvNumber=snmpTrapSrvNumber, psVendorID=psVendorID, snmpTrapSrvEntry=snmpTrapSrvEntry, psSubsysDeviceID=psSubsysDeviceID, pciConfigObj=pciConfigObj, psIndex=psIndex)
