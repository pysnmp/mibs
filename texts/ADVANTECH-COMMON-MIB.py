...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:10:29 2021
...
ModuleIdentity, TimeTicks, Bits, Gauge32, IpAddress, Unsigned32, iso, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Integer32, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Bits", "Gauge32", "IpAddress", "Unsigned32", "iso", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Integer32", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("ADVANTECH-COMMON-MIB", sysModuleID=sysModuleID, psLocation=psLocation, atPciConfig=atPciConfig, snmpTrapSrvAuthentication=snmpTrapSrvAuthentication, PYSNMP_MODULE_ID=advantechCommonMIB, psVendorID=psVendorID, psDeviceID=psDeviceID, psClassCode=psClassCode, snmpTrapSrvNumber=snmpTrapSrvNumber, psNumber=psNumber, psFunctionIndex=psFunctionIndex, sysFirstBootTime=sysFirstBootTime, sysBootCount=sysBootCount, sysDescr=sysDescr, psDeviceIndex=psDeviceIndex, psSubsysVendorID=psSubsysVendorID, snmpTrapVersion=snmpTrapVersion, pciSlotTable=pciSlotTable, psDescr=psDescr, psManufacturer=psManufacturer, psSubsysDeviceID=psSubsysDeviceID, atSystem=atSystem, snmpTrapSrvCommunity=snmpTrapSrvCommunity, atMgmt=atMgmt, snmpTrapSrvIndex=snmpTrapSrvIndex, psDisplayName=psDisplayName, psBusIndex=psBusIndex, snmpTrapSrvIP=snmpTrapSrvIP, snmpTrapSrvPort=snmpTrapSrvPort, advantechCommonMIB=advantechCommonMIB, psBaseAddress=psBaseAddress, psLength=psLength, psIndex=psIndex, sysBootTime=sysBootTime, advantech=advantech, psModuleType=psModuleType, snmpTrapSrvEntry=snmpTrapSrvEntry, snmpTrapSrvTable=snmpTrapSrvTable, sysReleaseDate=sysReleaseDate, pciConfigObj=pciConfigObj, psModulePorts=psModulePorts, psIRQ=psIRQ, psState=psState, pciSlotEntry=pciSlotEntry, sysDeviceName=sysDeviceName, sysImageVersion=sysImageVersion, snmpTrapSrvObj=snmpTrapSrvObj)
