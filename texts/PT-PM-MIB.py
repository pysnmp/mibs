...
# ASN.1 source PT-PM-MIB
# Source digest sha256:78fe823904b71151820f18ecc1799919d72dbcd5c87f0627c5287d1da94787b4
...
if mibBuilder.loadTexts: ptPM.setLastUpdated('2018-08-29 12:30')
...
ptPMTable = MibTable((1, 3, 6, 1, 4, 1, 193, 223, 2, 5, 1), ).setMaxAccess("notaccessible")
...
ptPMEntry = MibTableRow((1, 3, 6, 1, 4, 1, 193, 223, 2, 5, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "PT-PM-MIB", "queueIndex"))
...
queueIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 193, 223, 2, 5, 1, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 2147483647))).setMaxAccess("notaccessible")
...
mibBuilder.exportSymbols("PT-PM-MIB", PYSNMP_MODULE_ID=ptPM, discardOctets=discardOctets, discardPackets=discardPackets, forwardingOctets=forwardingOctets, forwardingPacket=forwardingPacket, inputOctets=inputOctets, inputPackets=inputPackets, ptPM=ptPM, ptPMCompleteGroup=ptPMCompleteGroup, ptPMCompliances=ptPMCompliances, ptPMConformance=ptPMConformance, ptPMEntry=ptPMEntry, ptPMFullCompliance=ptPMFullCompliance, ptPMGroups=ptPMGroups, ptPMTable=ptPMTable, queueIndex=queueIndex)
