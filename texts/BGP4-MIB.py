...
# ASN.1 source BGP4-MIB
# Source digest sha256:d566c185078ee43f0fe587364a57a1423201f60bb481bc4354e050ff1e95ddaa
...
if mibBuilder.loadTexts: bgp.setLastUpdated('2006-01-11 00:00')
...
bgpPeerEntry = MibTableRow((1, 3, 6, 1, 2, 1, 15, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "BGP4-MIB", "bgpPeerRemoteAddr"))
...
bgpPathAttrEntry = MibTableRow((1, 3, 6, 1, 2, 1, 15, 5, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "BGP4-MIB", "bgpPathAttrDestNetwork"), (0, "BGP4-MIB", "bgpPathAttrPeer"))
...
bgp4PathAttrTable = MibTable((1, 3, 6, 1, 2, 1, 15, 6), ).setMaxAccess("notaccessible")
...
bgp4PathAttrEntry = MibTableRow((1, 3, 6, 1, 2, 1, 15, 6, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "BGP4-MIB", "bgp4PathAttrIpAddrPrefix"), (0, "BGP4-MIB", "bgp4PathAttrIpAddrPrefixLen"), (0, "BGP4-MIB", "bgp4PathAttrPeer"))
...
mibBuilder.exportSymbols("BGP4-MIB", PYSNMP_MODULE_ID=bgp, bgp4MIBCompliance=bgp4MIBCompliance, bgp4MIBCompliances=bgp4MIBCompliances, bgp4MIBConformance=bgp4MIBConformance, bgp4MIBDeprecatedCompliances=bgp4MIBDeprecatedCompliances, bgp4MIBGlobalsGroup=bgp4MIBGlobalsGroup, bgp4MIBGroups=bgp4MIBGroups, bgp4MIBNotificationGroup=bgp4MIBNotificationGroup, bgp4MIBObsoleteCompliances=bgp4MIBObsoleteCompliances, bgp4MIBPathAttrGroup=bgp4MIBPathAttrGroup, bgp4MIBPeerGroup=bgp4MIBPeerGroup, bgp4MIBTrapGroup=bgp4MIBTrapGroup, bgp4PathAttrASPathSegment=bgp4PathAttrASPathSegment, bgp4PathAttrAggregatorAS=bgp4PathAttrAggregatorAS, bgp4PathAttrAggregatorAddr=bgp4PathAttrAggregatorAddr, bgp4PathAttrAtomicAggregate=bgp4PathAttrAtomicAggregate, bgp4PathAttrBest=bgp4PathAttrBest, bgp4PathAttrCalcLocalPref=bgp4PathAttrCalcLocalPref, bgp4PathAttrEntry=bgp4PathAttrEntry, bgp4PathAttrIpAddrPrefix=bgp4PathAttrIpAddrPrefix, bgp4PathAttrIpAddrPrefixLen=bgp4PathAttrIpAddrPrefixLen, bgp4PathAttrLocalPref=bgp4PathAttrLocalPref, bgp4PathAttrMultiExitDisc=bgp4PathAttrMultiExitDisc, bgp4PathAttrNextHop=bgp4PathAttrNextHop, bgp4PathAttrOrigin=bgp4PathAttrOrigin, bgp4PathAttrPeer=bgp4PathAttrPeer, bgp4PathAttrTable=bgp4PathAttrTable, bgp4PathAttrUnknown=bgp4PathAttrUnknown, bgp=bgp, bgpBackwardTransNotification=bgpBackwardTransNotification, bgpBackwardTransition=bgpBackwardTransition, bgpEstablished=bgpEstablished, bgpEstablishedNotification=bgpEstablishedNotification, bgpIdentifier=bgpIdentifier, bgpLocalAs=bgpLocalAs, bgpNotification=bgpNotification, bgpPathAttrASPath=bgpPathAttrASPath, bgpPathAttrDestNetwork=bgpPathAttrDestNetwork, bgpPathAttrEntry=bgpPathAttrEntry, bgpPathAttrInterASMetric=bgpPathAttrInterASMetric, bgpPathAttrNextHop=bgpPathAttrNextHop, bgpPathAttrOrigin=bgpPathAttrOrigin, bgpPathAttrPeer=bgpPathAttrPeer, bgpPeerAdminStatus=bgpPeerAdminStatus, bgpPeerConnectRetryInterval=bgpPeerConnectRetryInterval, bgpPeerEntry=bgpPeerEntry, bgpPeerFsmEstablishedTime=bgpPeerFsmEstablishedTime, bgpPeerFsmEstablishedTransitions=bgpPeerFsmEstablishedTransitions, bgpPeerHoldTime=bgpPeerHoldTime, bgpPeerHoldTimeConfigured=bgpPeerHoldTimeConfigured, bgpPeerIdentifier=bgpPeerIdentifier, bgpPeerInTotalMessages=bgpPeerInTotalMessages, bgpPeerInUpdateElapsedTime=bgpPeerInUpdateElapsedTime, bgpPeerInUpdates=bgpPeerInUpdates, bgpPeerKeepAlive=bgpPeerKeepAlive, bgpPeerKeepAliveConfigured=bgpPeerKeepAliveConfigured, bgpPeerLastError=bgpPeerLastError, bgpPeerLocalAddr=bgpPeerLocalAddr, bgpPeerLocalPort=bgpPeerLocalPort, bgpPeerMinASOriginationInterval=bgpPeerMinASOriginationInterval, bgpPeerMinRouteAdvertisementInterval=bgpPeerMinRouteAdvertisementInterval, bgpPeerNegotiatedVersion=bgpPeerNegotiatedVersion, bgpPeerOutTotalMessages=bgpPeerOutTotalMessages, bgpPeerOutUpdates=bgpPeerOutUpdates, bgpPeerRemoteAddr=bgpPeerRemoteAddr, bgpPeerRemoteAs=bgpPeerRemoteAs, bgpPeerRemotePort=bgpPeerRemotePort, bgpPeerState=bgpPeerState, bgpPeerTable=bgpPeerTable, bgpRcvdPathAttrGroup=bgpRcvdPathAttrGroup, bgpRcvdPathAttrTable=bgpRcvdPathAttrTable, bgpTraps=bgpTraps, bgpVersion=bgpVersion)
