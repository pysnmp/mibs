...
Bits, Gauge32, enterprises, Unsigned32, MibIdentifier, Integer32, Counter64, IpAddress, iso, NotificationType, Counter32, ObjectIdentity, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "enterprises", "Unsigned32", "MibIdentifier", "Integer32", "Counter64", "IpAddress", "iso", "NotificationType", "Counter32", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogNumEntries=eventLogNumEntries, powerStatus=powerStatus, physDiskPoolId=physDiskPoolId, physDiskSlot=physDiskSlot, physDiskIndex=physDiskIndex, poolType=poolType, tempStatus=tempStatus, powerTable=powerTable, tempEncPos=tempEncPos, physDiskWWN=physDiskWWN, fanStatus=fanStatus, poolEntry=poolEntry, eventLogTrapLevel=eventLogTrapLevel, tempEntry=tempEntry, tempIndex=tempIndex, physDiskId=physDiskId, unit=unit, fanEntry=fanEntry, powerNumber=powerNumber, datadirect=datadirect, physDiskState=physDiskState, tempNumber=tempNumber, poolNumDisks=poolNumDisks, physicalDiskEntry=physicalDiskEntry, fanIndex=fanIndex, fanTable=fanTable, poolIndex=poolIndex, fanNumber=fanNumber, systemName=systemName, fanEncPos=fanEncPos, powerIndex=powerIndex, eventLog=eventLog, powerEncId=powerEncId, fanEncId=fanEncId, poolTable=poolTable, eventLogEntry=eventLogEntry, eventLogTable=eventLogTable, physDiskEnc=physDiskEnc, physicalDiskTable=physicalDiskTable, powerEntry=powerEntry, tempEncId=tempEncId, poolNumber=poolNumber, poolId=poolId, tempTable=tempTable, eventLogDescr=eventLogDescr, DisplayString=DisplayString, eventLogIndex=eventLogIndex, eventLogLevel=eventLogLevel, powerEncPos=powerEncPos)
