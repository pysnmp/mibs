...
# Produced by pysmi-1.1.12 at Sat Jul  6 01:07:16 2024
...
TimeTicks, Integer32, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, Bits, Counter64, enterprises, Counter32, IpAddress, Gauge32, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "Bits", "Counter64", "enterprises", "Counter32", "IpAddress", "Gauge32", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskPoolId=physDiskPoolId, physDiskSlot=physDiskSlot, fanNumber=fanNumber, powerNumber=powerNumber, eventLog=eventLog, physicalDiskTable=physicalDiskTable, fanIndex=fanIndex, tempIndex=tempIndex, fanEncPos=fanEncPos, poolNumDisks=poolNumDisks, physDiskIndex=physDiskIndex, fanStatus=fanStatus, tempStatus=tempStatus, datadirect=datadirect, poolType=poolType, physDiskState=physDiskState, tempEncId=tempEncId, tempEntry=tempEntry, fanTable=fanTable, poolEntry=poolEntry, eventLogNumEntries=eventLogNumEntries, eventLogLevel=eventLogLevel, poolId=poolId, poolNumber=poolNumber, physDiskEnc=physDiskEnc, eventLogTrapLevel=eventLogTrapLevel, poolTable=poolTable, powerIndex=powerIndex, eventLogEntry=eventLogEntry, powerEncId=powerEncId, eventLogTable=eventLogTable, physDiskWWN=physDiskWWN, fanEntry=fanEntry, systemName=systemName, eventLogIndex=eventLogIndex, tempNumber=tempNumber, poolIndex=poolIndex, DisplayString=DisplayString, powerEncPos=powerEncPos, tempTable=tempTable, physicalDiskEntry=physicalDiskEntry, physDiskId=physDiskId, powerTable=powerTable, powerStatus=powerStatus, eventLogDescr=eventLogDescr, powerEntry=powerEntry, unit=unit, tempEncPos=tempEncPos, fanEncId=fanEncId)
