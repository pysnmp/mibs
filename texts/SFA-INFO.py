...
# Produced by pysmi-1.1.8 at Thu Oct 26 10:12:31 2023
...
mibBuilder.exportSymbols("SFA-INFO", physDiskState=physDiskState, tempStatus=tempStatus, tempEncId=tempEncId, eventLogDescr=eventLogDescr, physicalDiskEntry=physicalDiskEntry, powerStatus=powerStatus, powerNumber=powerNumber, powerEntry=powerEntry, eventLogEntry=eventLogEntry, fanStatus=fanStatus, powerEncId=powerEncId, physicalDiskTable=physicalDiskTable, physDiskIndex=physDiskIndex, tempTable=tempTable, eventLogTrapLevel=eventLogTrapLevel, eventLogTable=eventLogTable, systemName=systemName, fanEntry=fanEntry, powerEncPos=powerEncPos, poolIndex=poolIndex, physDiskId=physDiskId, fanIndex=fanIndex, poolNumDisks=poolNumDisks, fanNumber=fanNumber, fanEncId=fanEncId, tempNumber=tempNumber, physDiskSlot=physDiskSlot, powerTable=powerTable, poolEntry=poolEntry, tempEntry=tempEntry, tempEncPos=tempEncPos, fanEncPos=fanEncPos, poolId=poolId, physDiskEnc=physDiskEnc, powerIndex=powerIndex, eventLogIndex=eventLogIndex, poolNumber=poolNumber, tempIndex=tempIndex, eventLog=eventLog, datadirect=datadirect, poolType=poolType, poolTable=poolTable, fanTable=fanTable, physDiskPoolId=physDiskPoolId, eventLogNumEntries=eventLogNumEntries, eventLogLevel=eventLogLevel, DisplayString=DisplayString, physDiskWWN=physDiskWWN, unit=unit)
