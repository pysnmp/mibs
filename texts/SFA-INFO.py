...
# Produced by pysmi-1.1.12 at Tue Jun  4 11:44:34 2024
...
IpAddress, iso, Counter64, TimeTicks, Counter32, Gauge32, ObjectIdentity, MibIdentifier, Integer32, ModuleIdentity, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "Counter64", "TimeTicks", "Counter32", "Gauge32", "ObjectIdentity", "MibIdentifier", "Integer32", "ModuleIdentity", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("SFA-INFO", fanEncPos=fanEncPos, fanEntry=fanEntry, DisplayString=DisplayString, powerEncPos=powerEncPos, eventLogIndex=eventLogIndex, powerEntry=powerEntry, powerNumber=powerNumber, eventLog=eventLog, powerEncId=powerEncId, physDiskEnc=physDiskEnc, tempEncId=tempEncId, fanTable=fanTable, tempEncPos=tempEncPos, tempIndex=tempIndex, poolTable=poolTable, tempStatus=tempStatus, poolType=poolType, poolNumber=poolNumber, systemName=systemName, fanIndex=fanIndex, powerTable=powerTable, physDiskId=physDiskId, poolIndex=poolIndex, fanStatus=fanStatus, physicalDiskEntry=physicalDiskEntry, poolEntry=poolEntry, physDiskWWN=physDiskWWN, eventLogTable=eventLogTable, physDiskIndex=physDiskIndex, physDiskPoolId=physDiskPoolId, powerIndex=powerIndex, physicalDiskTable=physicalDiskTable, tempNumber=tempNumber, eventLogLevel=eventLogLevel, physDiskState=physDiskState, powerStatus=powerStatus, eventLogTrapLevel=eventLogTrapLevel, tempTable=tempTable, tempEntry=tempEntry, physDiskSlot=physDiskSlot, eventLogNumEntries=eventLogNumEntries, unit=unit, poolNumDisks=poolNumDisks, eventLogDescr=eventLogDescr, eventLogEntry=eventLogEntry, poolId=poolId, fanNumber=fanNumber, datadirect=datadirect, fanEncId=fanEncId)
