...
# Produced by pysmi-1.1.8 at Sun Jan 16 15:50:22 2022
...
NotificationType, MibIdentifier, ObjectIdentity, Counter32, Unsigned32, Integer32, enterprises, ModuleIdentity, Bits, TimeTicks, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "ObjectIdentity", "Counter32", "Unsigned32", "Integer32", "enterprises", "ModuleIdentity", "Bits", "TimeTicks", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso")
...
mibBuilder.exportSymbols("SFA-INFO", powerEncId=powerEncId, eventLog=eventLog, eventLogNumEntries=eventLogNumEntries, physDiskIndex=physDiskIndex, tempNumber=tempNumber, poolTable=poolTable, fanTable=fanTable, tempEncPos=tempEncPos, tempEncId=tempEncId, poolNumDisks=poolNumDisks, powerNumber=powerNumber, fanEncId=fanEncId, fanEncPos=fanEncPos, tempEntry=tempEntry, physDiskId=physDiskId, fanEntry=fanEntry, powerEntry=powerEntry, powerIndex=powerIndex, physicalDiskEntry=physicalDiskEntry, physDiskWWN=physDiskWWN, eventLogTable=eventLogTable, powerTable=powerTable, eventLogDescr=eventLogDescr, eventLogLevel=eventLogLevel, fanStatus=fanStatus, poolEntry=poolEntry, powerStatus=powerStatus, poolId=poolId, eventLogEntry=eventLogEntry, physDiskSlot=physDiskSlot, poolNumber=poolNumber, tempStatus=tempStatus, physicalDiskTable=physicalDiskTable, eventLogTrapLevel=eventLogTrapLevel, tempIndex=tempIndex, poolType=poolType, physDiskEnc=physDiskEnc, fanNumber=fanNumber, fanIndex=fanIndex, systemName=systemName, datadirect=datadirect, DisplayString=DisplayString, powerEncPos=powerEncPos, tempTable=tempTable, physDiskState=physDiskState, eventLogIndex=eventLogIndex, poolIndex=poolIndex, physDiskPoolId=physDiskPoolId, unit=unit)
