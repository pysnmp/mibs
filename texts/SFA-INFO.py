...
# Produced by pysmi-1.1.8 at Thu Sep  8 09:50:46 2022
...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, ModuleIdentity, enterprises, Integer32, Unsigned32, Counter64, NotificationType, Gauge32, iso, IpAddress, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "ModuleIdentity", "enterprises", "Integer32", "Unsigned32", "Counter64", "NotificationType", "Gauge32", "iso", "IpAddress", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", powerTable=powerTable, tempStatus=tempStatus, poolIndex=poolIndex, eventLog=eventLog, physDiskEnc=physDiskEnc, unit=unit, fanEncPos=fanEncPos, powerIndex=powerIndex, tempNumber=tempNumber, eventLogNumEntries=eventLogNumEntries, physDiskSlot=physDiskSlot, fanNumber=fanNumber, eventLogIndex=eventLogIndex, powerNumber=powerNumber, poolTable=poolTable, poolNumDisks=poolNumDisks, powerStatus=powerStatus, powerEncId=powerEncId, tempIndex=tempIndex, fanTable=fanTable, eventLogEntry=eventLogEntry, fanIndex=fanIndex, systemName=systemName, physDiskWWN=physDiskWWN, fanEncId=fanEncId, physicalDiskTable=physicalDiskTable, physDiskPoolId=physDiskPoolId, eventLogDescr=eventLogDescr, poolType=poolType, datadirect=datadirect, powerEntry=powerEntry, tempTable=tempTable, tempEncId=tempEncId, poolEntry=poolEntry, poolId=poolId, DisplayString=DisplayString, eventLogTrapLevel=eventLogTrapLevel, physDiskState=physDiskState, eventLogTable=eventLogTable, tempEncPos=tempEncPos, fanStatus=fanStatus, physDiskIndex=physDiskIndex, powerEncPos=powerEncPos, physicalDiskEntry=physicalDiskEntry, eventLogLevel=eventLogLevel, tempEntry=tempEntry, fanEntry=fanEntry, physDiskId=physDiskId, poolNumber=poolNumber)
