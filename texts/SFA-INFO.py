...
# Produced by pysmi-1.1.8 at Wed Sep 13 07:21:18 2023
...
IpAddress, enterprises, Bits, ModuleIdentity, MibIdentifier, Integer32, Counter32, ObjectIdentity, Counter64, Gauge32, iso, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "Bits", "ModuleIdentity", "MibIdentifier", "Integer32", "Counter32", "ObjectIdentity", "Counter64", "Gauge32", "iso", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskWWN=physDiskWWN, physicalDiskEntry=physicalDiskEntry, physDiskIndex=physDiskIndex, eventLogDescr=eventLogDescr, poolNumber=poolNumber, fanTable=fanTable, tempEncId=tempEncId, powerEncPos=powerEncPos, datadirect=datadirect, poolNumDisks=poolNumDisks, physicalDiskTable=physicalDiskTable, eventLogNumEntries=eventLogNumEntries, physDiskEnc=physDiskEnc, powerTable=powerTable, poolType=poolType, eventLogTable=eventLogTable, poolTable=poolTable, eventLogTrapLevel=eventLogTrapLevel, powerNumber=powerNumber, fanEncId=fanEncId, unit=unit, tempTable=tempTable, fanNumber=fanNumber, poolIndex=poolIndex, tempStatus=tempStatus, physDiskSlot=physDiskSlot, tempEntry=tempEntry, fanEntry=fanEntry, powerEncId=powerEncId, eventLogLevel=eventLogLevel, eventLog=eventLog, fanEncPos=fanEncPos, poolId=poolId, systemName=systemName, powerStatus=powerStatus, tempIndex=tempIndex, powerEntry=powerEntry, physDiskState=physDiskState, fanIndex=fanIndex, fanStatus=fanStatus, eventLogIndex=eventLogIndex, physDiskId=physDiskId, powerIndex=powerIndex, physDiskPoolId=physDiskPoolId, eventLogEntry=eventLogEntry, poolEntry=poolEntry, tempNumber=tempNumber, tempEncPos=tempEncPos, DisplayString=DisplayString)
