...
# Produced by pysmi-1.1.8 at Wed Oct 11 11:24:48 2023
...
ObjectIdentity, MibIdentifier, Integer32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Gauge32, Unsigned32, iso, TimeTicks, Counter64, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Integer32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Gauge32", "Unsigned32", "iso", "TimeTicks", "Counter64", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("SFA-INFO", physicalDiskTable=physicalDiskTable, eventLogDescr=eventLogDescr, powerTable=powerTable, unit=unit, tempEntry=tempEntry, fanEncPos=fanEncPos, powerEncPos=powerEncPos, tempIndex=tempIndex, poolNumber=poolNumber, physDiskId=physDiskId, tempEncId=tempEncId, poolTable=poolTable, physDiskIndex=physDiskIndex, fanNumber=fanNumber, DisplayString=DisplayString, poolType=poolType, fanEncId=fanEncId, tempNumber=tempNumber, physDiskEnc=physDiskEnc, physicalDiskEntry=physicalDiskEntry, tempTable=tempTable, poolIndex=poolIndex, poolId=poolId, eventLogTable=eventLogTable, physDiskSlot=physDiskSlot, datadirect=datadirect, eventLog=eventLog, powerNumber=powerNumber, tempStatus=tempStatus, eventLogNumEntries=eventLogNumEntries, fanStatus=fanStatus, poolNumDisks=poolNumDisks, powerEncId=powerEncId, eventLogIndex=eventLogIndex, poolEntry=poolEntry, physDiskPoolId=physDiskPoolId, fanTable=fanTable, eventLogTrapLevel=eventLogTrapLevel, powerIndex=powerIndex, powerStatus=powerStatus, physDiskState=physDiskState, fanEntry=fanEntry, physDiskWWN=physDiskWWN, systemName=systemName, eventLogLevel=eventLogLevel, fanIndex=fanIndex, eventLogEntry=eventLogEntry, tempEncPos=tempEncPos, powerEntry=powerEntry)
