...
ObjectIdentity, Counter32, Gauge32, Bits, Unsigned32, iso, Integer32, NotificationType, ModuleIdentity, Counter64, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Gauge32", "Bits", "Unsigned32", "iso", "Integer32", "NotificationType", "ModuleIdentity", "Counter64", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", physicalDiskTable=physicalDiskTable, poolEntry=poolEntry, eventLogLevel=eventLogLevel, powerEncPos=powerEncPos, physDiskSlot=physDiskSlot, powerIndex=powerIndex, physDiskIndex=physDiskIndex, eventLogNumEntries=eventLogNumEntries, poolNumDisks=poolNumDisks, eventLog=eventLog, unit=unit, fanStatus=fanStatus, systemName=systemName, poolIndex=poolIndex, poolId=poolId, datadirect=datadirect, powerNumber=powerNumber, poolNumber=poolNumber, powerTable=powerTable, physDiskWWN=physDiskWWN, fanNumber=fanNumber, physicalDiskEntry=physicalDiskEntry, fanEntry=fanEntry, DisplayString=DisplayString, tempStatus=tempStatus, fanEncId=fanEncId, tempIndex=tempIndex, physDiskId=physDiskId, physDiskPoolId=physDiskPoolId, eventLogTable=eventLogTable, powerEncId=powerEncId, eventLogEntry=eventLogEntry, powerEntry=powerEntry, tempEntry=tempEntry, tempEncPos=tempEncPos, fanTable=fanTable, tempTable=tempTable, tempEncId=tempEncId, poolType=poolType, fanIndex=fanIndex, physDiskEnc=physDiskEnc, poolTable=poolTable, eventLogIndex=eventLogIndex, physDiskState=physDiskState, tempNumber=tempNumber, powerStatus=powerStatus, eventLogDescr=eventLogDescr, eventLogTrapLevel=eventLogTrapLevel, fanEncPos=fanEncPos)
