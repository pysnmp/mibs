...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:03:48 2022
...
enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Gauge32, IpAddress, MibIdentifier, Bits, TimeTicks, ModuleIdentity, Counter64, NotificationType, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Gauge32", "IpAddress", "MibIdentifier", "Bits", "TimeTicks", "ModuleIdentity", "Counter64", "NotificationType", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskId=physDiskId, poolNumDisks=poolNumDisks, eventLogIndex=eventLogIndex, eventLogNumEntries=eventLogNumEntries, fanEntry=fanEntry, poolTable=poolTable, poolIndex=poolIndex, eventLog=eventLog, powerIndex=powerIndex, tempEncPos=tempEncPos, tempIndex=tempIndex, physDiskEnc=physDiskEnc, physDiskIndex=physDiskIndex, eventLogTable=eventLogTable, fanEncId=fanEncId, fanNumber=fanNumber, eventLogLevel=eventLogLevel, powerEncId=powerEncId, tempTable=tempTable, physicalDiskEntry=physicalDiskEntry, unit=unit, poolEntry=poolEntry, physDiskSlot=physDiskSlot, tempEncId=tempEncId, DisplayString=DisplayString, powerTable=powerTable, poolId=poolId, fanTable=fanTable, physicalDiskTable=physicalDiskTable, systemName=systemName, fanStatus=fanStatus, tempStatus=tempStatus, physDiskPoolId=physDiskPoolId, fanIndex=fanIndex, powerEncPos=powerEncPos, eventLogEntry=eventLogEntry, eventLogTrapLevel=eventLogTrapLevel, datadirect=datadirect, physDiskState=physDiskState, poolNumber=poolNumber, poolType=poolType, tempNumber=tempNumber, powerStatus=powerStatus, eventLogDescr=eventLogDescr, fanEncPos=fanEncPos, powerEntry=powerEntry, tempEntry=tempEntry, physDiskWWN=physDiskWWN, powerNumber=powerNumber)
