...
Bits, iso, Gauge32, ModuleIdentity, Unsigned32, Integer32, NotificationType, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, MibIdentifier, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "Gauge32", "ModuleIdentity", "Unsigned32", "Integer32", "NotificationType", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "MibIdentifier", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("SFA-INFO", tempEntry=tempEntry, fanIndex=fanIndex, eventLogIndex=eventLogIndex, fanNumber=fanNumber, eventLogNumEntries=eventLogNumEntries, poolNumDisks=poolNumDisks, unit=unit, powerIndex=powerIndex, fanEncPos=fanEncPos, powerEncPos=powerEncPos, DisplayString=DisplayString, powerEntry=powerEntry, poolNumber=poolNumber, tempStatus=tempStatus, physicalDiskEntry=physicalDiskEntry, tempEncId=tempEncId, eventLogTable=eventLogTable, powerTable=powerTable, eventLogDescr=eventLogDescr, poolTable=poolTable, poolEntry=poolEntry, fanEntry=fanEntry, physDiskIndex=physDiskIndex, datadirect=datadirect, poolType=poolType, poolId=poolId, physDiskEnc=physDiskEnc, fanEncId=fanEncId, powerStatus=powerStatus, fanStatus=fanStatus, physicalDiskTable=physicalDiskTable, eventLogLevel=eventLogLevel, eventLogEntry=eventLogEntry, powerEncId=powerEncId, fanTable=fanTable, systemName=systemName, eventLogTrapLevel=eventLogTrapLevel, powerNumber=powerNumber, physDiskPoolId=physDiskPoolId, tempEncPos=tempEncPos, eventLog=eventLog, poolIndex=poolIndex, physDiskSlot=physDiskSlot, tempTable=tempTable, tempIndex=tempIndex, physDiskWWN=physDiskWWN, tempNumber=tempNumber, physDiskId=physDiskId, physDiskState=physDiskState)
