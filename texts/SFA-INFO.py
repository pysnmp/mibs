...
# Produced by pysmi-1.1.12 at Mon Oct  7 02:51:48 2024
...
ObjectIdentity, enterprises, TimeTicks, Counter32, Unsigned32, Counter64, Gauge32, Integer32, ModuleIdentity, IpAddress, Bits, NotificationType, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "TimeTicks", "Counter32", "Unsigned32", "Counter64", "Gauge32", "Integer32", "ModuleIdentity", "IpAddress", "Bits", "NotificationType", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", DisplayString=DisplayString, physDiskEnc=physDiskEnc, unit=unit, physDiskSlot=physDiskSlot, tempEncId=tempEncId, physDiskWWN=physDiskWWN, tempTable=tempTable, eventLog=eventLog, physDiskIndex=physDiskIndex, poolId=poolId, powerEncPos=powerEncPos, poolIndex=poolIndex, fanEntry=fanEntry, systemName=systemName, powerNumber=powerNumber, poolNumDisks=poolNumDisks, eventLogNumEntries=eventLogNumEntries, tempNumber=tempNumber, physDiskId=physDiskId, eventLogLevel=eventLogLevel, poolEntry=poolEntry, fanIndex=fanIndex, poolTable=poolTable, poolType=poolType, powerEncId=powerEncId, eventLogTable=eventLogTable, tempEncPos=tempEncPos, eventLogIndex=eventLogIndex, powerEntry=powerEntry, fanStatus=fanStatus, fanEncId=fanEncId, physicalDiskTable=physicalDiskTable, tempEntry=tempEntry, tempStatus=tempStatus, powerStatus=powerStatus, physDiskPoolId=physDiskPoolId, fanTable=fanTable, eventLogDescr=eventLogDescr, powerIndex=powerIndex, powerTable=powerTable, physicalDiskEntry=physicalDiskEntry, physDiskState=physDiskState, tempIndex=tempIndex, fanNumber=fanNumber, fanEncPos=fanEncPos, datadirect=datadirect, eventLogEntry=eventLogEntry, poolNumber=poolNumber, eventLogTrapLevel=eventLogTrapLevel)
