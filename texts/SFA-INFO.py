...
# Produced by pysmi-1.1.12 at Mon Jun  3 14:00:42 2024
...
ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, ModuleIdentity, Counter64, Gauge32, iso, MibIdentifier, TimeTicks, enterprises, Unsigned32, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "ModuleIdentity", "Counter64", "Gauge32", "iso", "MibIdentifier", "TimeTicks", "enterprises", "Unsigned32", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", fanStatus=fanStatus, physicalDiskTable=physicalDiskTable, physDiskId=physDiskId, powerTable=powerTable, physicalDiskEntry=physicalDiskEntry, eventLogIndex=eventLogIndex, fanEncId=fanEncId, physDiskEnc=physDiskEnc, poolId=poolId, powerEncPos=powerEncPos, physDiskWWN=physDiskWWN, eventLog=eventLog, tempNumber=tempNumber, fanEntry=fanEntry, tempEntry=tempEntry, fanTable=fanTable, poolType=poolType, poolTable=poolTable, eventLogLevel=eventLogLevel, tempEncId=tempEncId, eventLogTable=eventLogTable, powerStatus=powerStatus, powerNumber=powerNumber, fanNumber=fanNumber, fanEncPos=fanEncPos, eventLogNumEntries=eventLogNumEntries, tempStatus=tempStatus, fanIndex=fanIndex, tempEncPos=tempEncPos, powerEntry=powerEntry, poolNumber=poolNumber, poolIndex=poolIndex, eventLogEntry=eventLogEntry, datadirect=datadirect, systemName=systemName, DisplayString=DisplayString, physDiskPoolId=physDiskPoolId, tempTable=tempTable, unit=unit, powerEncId=powerEncId, poolEntry=poolEntry, physDiskIndex=physDiskIndex, physDiskState=physDiskState, eventLogDescr=eventLogDescr, powerIndex=powerIndex, poolNumDisks=poolNumDisks, physDiskSlot=physDiskSlot, eventLogTrapLevel=eventLogTrapLevel, tempIndex=tempIndex)
