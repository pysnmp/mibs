...
mibBuilder.exportSymbols("SFA-INFO", eventLogDescr=eventLogDescr, eventLogNumEntries=eventLogNumEntries, poolNumber=poolNumber, eventLogEntry=eventLogEntry, fanTable=fanTable, fanNumber=fanNumber, tempEncId=tempEncId, fanStatus=fanStatus, poolIndex=poolIndex, eventLogTable=eventLogTable, eventLogIndex=eventLogIndex, unit=unit, powerNumber=powerNumber, DisplayString=DisplayString, physDiskSlot=physDiskSlot, poolType=poolType, physicalDiskEntry=physicalDiskEntry, eventLogLevel=eventLogLevel, powerTable=powerTable, fanEntry=fanEntry, fanEncId=fanEncId, powerEntry=powerEntry, powerEncId=powerEncId, physDiskPoolId=physDiskPoolId, poolId=poolId, physDiskIndex=physDiskIndex, physicalDiskTable=physicalDiskTable, physDiskEnc=physDiskEnc, tempEntry=tempEntry, physDiskWWN=physDiskWWN, poolTable=poolTable, systemName=systemName, physDiskState=physDiskState, poolEntry=poolEntry, tempNumber=tempNumber, powerEncPos=powerEncPos, fanEncPos=fanEncPos, powerStatus=powerStatus, tempIndex=tempIndex, physDiskId=physDiskId, tempTable=tempTable, tempEncPos=tempEncPos, powerIndex=powerIndex, datadirect=datadirect, eventLogTrapLevel=eventLogTrapLevel, fanIndex=fanIndex, eventLog=eventLog, poolNumDisks=poolNumDisks, tempStatus=tempStatus)
