...
ObjectIdentity, ModuleIdentity, Counter64, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Gauge32, NotificationType, Unsigned32, Integer32, enterprises, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Counter64", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Gauge32", "NotificationType", "Unsigned32", "Integer32", "enterprises", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("SFA-INFO", powerEntry=powerEntry, physDiskPoolId=physDiskPoolId, powerEncId=powerEncId, fanNumber=fanNumber, eventLogNumEntries=eventLogNumEntries, eventLogDescr=eventLogDescr, poolNumber=poolNumber, tempStatus=tempStatus, eventLog=eventLog, eventLogEntry=eventLogEntry, powerIndex=powerIndex, fanEncId=fanEncId, physDiskSlot=physDiskSlot, poolNumDisks=poolNumDisks, physDiskIndex=physDiskIndex, fanEncPos=fanEncPos, tempIndex=tempIndex, tempNumber=tempNumber, fanTable=fanTable, physDiskWWN=physDiskWWN, physDiskEnc=physDiskEnc, fanStatus=fanStatus, DisplayString=DisplayString, poolId=poolId, physDiskId=physDiskId, powerStatus=powerStatus, tempEntry=tempEntry, tempEncId=tempEncId, poolType=poolType, tempEncPos=tempEncPos, poolIndex=poolIndex, physDiskState=physDiskState, powerNumber=powerNumber, systemName=systemName, datadirect=datadirect, tempTable=tempTable, fanIndex=fanIndex, physicalDiskEntry=physicalDiskEntry, eventLogTable=eventLogTable, eventLogIndex=eventLogIndex, eventLogLevel=eventLogLevel, unit=unit, powerEncPos=powerEncPos, poolEntry=poolEntry, eventLogTrapLevel=eventLogTrapLevel, physicalDiskTable=physicalDiskTable, poolTable=poolTable, powerTable=powerTable, fanEntry=fanEntry)
