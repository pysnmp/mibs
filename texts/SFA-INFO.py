...
# Produced by pysmi-1.1.12 at Wed Sep 18 06:44:17 2024
...
Gauge32, Unsigned32, enterprises, IpAddress, Integer32, Counter32, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, Bits, Counter64, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "enterprises", "IpAddress", "Integer32", "Counter32", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "Bits", "Counter64", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskSlot=physDiskSlot, poolTable=poolTable, powerNumber=powerNumber, fanIndex=fanIndex, systemName=systemName, fanEntry=fanEntry, DisplayString=DisplayString, poolId=poolId, powerEncPos=powerEncPos, physicalDiskEntry=physicalDiskEntry, unit=unit, fanNumber=fanNumber, tempEntry=tempEntry, physicalDiskTable=physicalDiskTable, physDiskId=physDiskId, tempIndex=tempIndex, tempStatus=tempStatus, poolIndex=poolIndex, powerIndex=powerIndex, physDiskEnc=physDiskEnc, eventLogNumEntries=eventLogNumEntries, fanStatus=fanStatus, fanEncId=fanEncId, poolEntry=poolEntry, poolNumber=poolNumber, tempEncId=tempEncId, powerEncId=powerEncId, eventLogTable=eventLogTable, powerStatus=powerStatus, eventLogEntry=eventLogEntry, tempTable=tempTable, eventLogIndex=eventLogIndex, physDiskPoolId=physDiskPoolId, eventLogDescr=eventLogDescr, powerTable=powerTable, physDiskIndex=physDiskIndex, fanTable=fanTable, fanEncPos=fanEncPos, physDiskWWN=physDiskWWN, eventLog=eventLog, eventLogLevel=eventLogLevel, poolType=poolType, tempEncPos=tempEncPos, datadirect=datadirect, tempNumber=tempNumber, powerEntry=powerEntry, poolNumDisks=poolNumDisks, physDiskState=physDiskState, eventLogTrapLevel=eventLogTrapLevel)
