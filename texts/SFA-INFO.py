...
# Produced by pysmi-1.1.11 at Wed Apr  3 13:57:20 2024
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Integer32, Counter32, NotificationType, MibIdentifier, TimeTicks, IpAddress, enterprises, iso, Bits, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Integer32", "Counter32", "NotificationType", "MibIdentifier", "TimeTicks", "IpAddress", "enterprises", "iso", "Bits", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("SFA-INFO", physicalDiskTable=physicalDiskTable, physDiskIndex=physDiskIndex, physDiskId=physDiskId, eventLog=eventLog, datadirect=datadirect, eventLogNumEntries=eventLogNumEntries, powerEncPos=powerEncPos, physDiskEnc=physDiskEnc, tempNumber=tempNumber, DisplayString=DisplayString, eventLogDescr=eventLogDescr, tempTable=tempTable, tempEncPos=tempEncPos, physicalDiskEntry=physicalDiskEntry, unit=unit, physDiskSlot=physDiskSlot, poolNumDisks=poolNumDisks, tempEntry=tempEntry, poolTable=poolTable, fanEntry=fanEntry, fanNumber=fanNumber, fanTable=fanTable, powerIndex=powerIndex, eventLogTrapLevel=eventLogTrapLevel, physDiskState=physDiskState, powerEncId=powerEncId, poolIndex=poolIndex, poolType=poolType, eventLogLevel=eventLogLevel, tempStatus=tempStatus, powerEntry=powerEntry, eventLogIndex=eventLogIndex, powerStatus=powerStatus, powerNumber=powerNumber, fanStatus=fanStatus, fanEncPos=fanEncPos, tempIndex=tempIndex, fanIndex=fanIndex, systemName=systemName, fanEncId=fanEncId, physDiskWWN=physDiskWWN, poolEntry=poolEntry, eventLogEntry=eventLogEntry, poolNumber=poolNumber, powerTable=powerTable, physDiskPoolId=physDiskPoolId, poolId=poolId, tempEncId=tempEncId, eventLogTable=eventLogTable)
