...
# Produced by pysmi-1.1.8 at Sat Jan 15 16:34:30 2022
...
mibBuilder.exportSymbols("SFA-INFO", datadirect=datadirect, powerIndex=powerIndex, fanNumber=fanNumber, fanIndex=fanIndex, powerNumber=powerNumber, poolEntry=poolEntry, tempTable=tempTable, powerEncId=powerEncId, eventLogTrapLevel=eventLogTrapLevel, poolNumber=poolNumber, poolType=poolType, physicalDiskTable=physicalDiskTable, poolIndex=poolIndex, DisplayString=DisplayString, powerEncPos=powerEncPos, powerEntry=powerEntry, poolTable=poolTable, physDiskIndex=physDiskIndex, physDiskEnc=physDiskEnc, physDiskState=physDiskState, eventLogIndex=eventLogIndex, physicalDiskEntry=physicalDiskEntry, eventLogEntry=eventLogEntry, fanEncPos=fanEncPos, physDiskSlot=physDiskSlot, tempEncPos=tempEncPos, eventLogLevel=eventLogLevel, physDiskWWN=physDiskWWN, physDiskId=physDiskId, eventLog=eventLog, tempNumber=tempNumber, poolNumDisks=poolNumDisks, poolId=poolId, tempEncId=tempEncId, eventLogTable=eventLogTable, unit=unit, fanEntry=fanEntry, eventLogDescr=eventLogDescr, tempStatus=tempStatus, tempIndex=tempIndex, eventLogNumEntries=eventLogNumEntries, fanTable=fanTable, fanStatus=fanStatus, systemName=systemName, fanEncId=fanEncId, powerStatus=powerStatus, powerTable=powerTable, physDiskPoolId=physDiskPoolId, tempEntry=tempEntry)
