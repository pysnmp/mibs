...
MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Counter32, iso, ModuleIdentity, IpAddress, NotificationType, Integer32, TimeTicks, Gauge32, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Counter32", "iso", "ModuleIdentity", "IpAddress", "NotificationType", "Integer32", "TimeTicks", "Gauge32", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogLevel=eventLogLevel, tempStatus=tempStatus, eventLogEntry=eventLogEntry, eventLogDescr=eventLogDescr, eventLogTrapLevel=eventLogTrapLevel, fanIndex=fanIndex, datadirect=datadirect, tempEncPos=tempEncPos, poolEntry=poolEntry, eventLogIndex=eventLogIndex, powerNumber=powerNumber, poolNumDisks=poolNumDisks, fanStatus=fanStatus, systemName=systemName, tempIndex=tempIndex, tempEntry=tempEntry, physicalDiskEntry=physicalDiskEntry, physDiskPoolId=physDiskPoolId, physicalDiskTable=physicalDiskTable, poolTable=poolTable, tempEncId=tempEncId, powerStatus=powerStatus, poolNumber=poolNumber, poolId=poolId, tempTable=tempTable, physDiskWWN=physDiskWWN, powerEncPos=powerEncPos, unit=unit, powerIndex=powerIndex, eventLog=eventLog, fanEntry=fanEntry, fanTable=fanTable, physDiskId=physDiskId, powerEntry=powerEntry, physDiskEnc=physDiskEnc, tempNumber=tempNumber, powerTable=powerTable, fanEncId=fanEncId, poolType=poolType, poolIndex=poolIndex, DisplayString=DisplayString, eventLogNumEntries=eventLogNumEntries, fanEncPos=fanEncPos, eventLogTable=eventLogTable, physDiskIndex=physDiskIndex, fanNumber=fanNumber, physDiskSlot=physDiskSlot, powerEncId=powerEncId, physDiskState=physDiskState)
