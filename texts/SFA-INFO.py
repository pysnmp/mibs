...
# Produced by pysmi-1.1.8 at Thu Jan  5 14:43:13 2023
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, TimeTicks, Counter32, Counter64, ObjectIdentity, Integer32, IpAddress, Bits, NotificationType, enterprises, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "TimeTicks", "Counter32", "Counter64", "ObjectIdentity", "Integer32", "IpAddress", "Bits", "NotificationType", "enterprises", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("SFA-INFO", tempEncPos=tempEncPos, poolId=poolId, eventLogTable=eventLogTable, eventLogNumEntries=eventLogNumEntries, unit=unit, fanStatus=fanStatus, tempTable=tempTable, fanIndex=fanIndex, powerNumber=powerNumber, poolType=poolType, poolTable=poolTable, powerEntry=powerEntry, physicalDiskEntry=physicalDiskEntry, physDiskEnc=physDiskEnc, systemName=systemName, poolIndex=poolIndex, physDiskIndex=physDiskIndex, eventLogLevel=eventLogLevel, eventLogTrapLevel=eventLogTrapLevel, physDiskSlot=physDiskSlot, datadirect=datadirect, fanEncPos=fanEncPos, poolNumber=poolNumber, fanNumber=fanNumber, poolNumDisks=poolNumDisks, physicalDiskTable=physicalDiskTable, powerEncPos=powerEncPos, DisplayString=DisplayString, tempStatus=tempStatus, physDiskPoolId=physDiskPoolId, tempEncId=tempEncId, powerTable=powerTable, powerStatus=powerStatus, powerIndex=powerIndex, poolEntry=poolEntry, tempNumber=tempNumber, fanTable=fanTable, physDiskId=physDiskId, eventLogDescr=eventLogDescr, eventLogEntry=eventLogEntry, eventLogIndex=eventLogIndex, fanEntry=fanEntry, tempIndex=tempIndex, eventLog=eventLog, physDiskWWN=physDiskWWN, powerEncId=powerEncId, fanEncId=fanEncId, physDiskState=physDiskState, tempEntry=tempEntry)
