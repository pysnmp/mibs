...
# Produced by pysmi-1.1.8 at Thu Oct 26 09:58:54 2023
...
mibBuilder.exportSymbols("SFA-INFO", physDiskWWN=physDiskWWN, poolNumDisks=poolNumDisks, tempEncId=tempEncId, DisplayString=DisplayString, powerTable=powerTable, physDiskId=physDiskId, tempNumber=tempNumber, fanEntry=fanEntry, unit=unit, powerNumber=powerNumber, tempTable=tempTable, powerEntry=powerEntry, eventLogIndex=eventLogIndex, physDiskState=physDiskState, powerIndex=powerIndex, fanIndex=fanIndex, powerStatus=powerStatus, fanStatus=fanStatus, physDiskIndex=physDiskIndex, systemName=systemName, tempEncPos=tempEncPos, physDiskPoolId=physDiskPoolId, eventLogTrapLevel=eventLogTrapLevel, poolTable=poolTable, eventLogNumEntries=eventLogNumEntries, poolNumber=poolNumber, physDiskSlot=physDiskSlot, eventLogLevel=eventLogLevel, tempStatus=tempStatus, fanEncPos=fanEncPos, eventLogTable=eventLogTable, poolIndex=poolIndex, poolEntry=poolEntry, fanTable=fanTable, fanEncId=fanEncId, tempEntry=tempEntry, poolType=poolType, powerEncPos=powerEncPos, powerEncId=powerEncId, eventLogDescr=eventLogDescr, physDiskEnc=physDiskEnc, eventLogEntry=eventLogEntry, physicalDiskTable=physicalDiskTable, eventLog=eventLog, datadirect=datadirect, poolId=poolId, tempIndex=tempIndex, physicalDiskEntry=physicalDiskEntry, fanNumber=fanNumber)
