...
# Produced by pysmi-1.1.12 at Tue Sep 17 13:30:13 2024
...
ObjectIdentity, iso, Counter32, TimeTicks, Counter64, enterprises, ModuleIdentity, Integer32, Gauge32, NotificationType, Bits, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Counter32", "TimeTicks", "Counter64", "enterprises", "ModuleIdentity", "Integer32", "Gauge32", "NotificationType", "Bits", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("SFA-INFO", poolTable=poolTable, eventLog=eventLog, powerNumber=powerNumber, physDiskWWN=physDiskWWN, poolNumber=poolNumber, eventLogNumEntries=eventLogNumEntries, eventLogIndex=eventLogIndex, physDiskState=physDiskState, poolType=poolType, unit=unit, fanEncPos=fanEncPos, tempEncId=tempEncId, powerStatus=powerStatus, poolNumDisks=poolNumDisks, physDiskId=physDiskId, powerEncPos=powerEncPos, powerEncId=powerEncId, fanStatus=fanStatus, tempNumber=tempNumber, physicalDiskEntry=physicalDiskEntry, powerIndex=powerIndex, physDiskIndex=physDiskIndex, eventLogDescr=eventLogDescr, powerEntry=powerEntry, physDiskEnc=physDiskEnc, physicalDiskTable=physicalDiskTable, eventLogLevel=eventLogLevel, fanNumber=fanNumber, eventLogEntry=eventLogEntry, poolIndex=poolIndex, DisplayString=DisplayString, systemName=systemName, tempTable=tempTable, tempEncPos=tempEncPos, datadirect=datadirect, tempIndex=tempIndex, eventLogTrapLevel=eventLogTrapLevel, fanTable=fanTable, physDiskPoolId=physDiskPoolId, fanIndex=fanIndex, poolEntry=poolEntry, eventLogTable=eventLogTable, physDiskSlot=physDiskSlot, poolId=poolId, fanEntry=fanEntry, powerTable=powerTable, tempStatus=tempStatus, tempEntry=tempEntry, fanEncId=fanEncId)
