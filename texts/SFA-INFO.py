...
ModuleIdentity, iso, MibIdentifier, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, Gauge32, Bits, NotificationType, IpAddress, Unsigned32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "MibIdentifier", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "Gauge32", "Bits", "NotificationType", "IpAddress", "Unsigned32", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("SFA-INFO", powerEncPos=powerEncPos, fanStatus=fanStatus, tempEntry=tempEntry, physDiskWWN=physDiskWWN, powerStatus=powerStatus, eventLogTrapLevel=eventLogTrapLevel, tempNumber=tempNumber, tempEncId=tempEncId, fanEncId=fanEncId, physDiskIndex=physDiskIndex, physDiskState=physDiskState, fanEncPos=fanEncPos, poolIndex=poolIndex, eventLogLevel=eventLogLevel, physDiskSlot=physDiskSlot, eventLogEntry=eventLogEntry, eventLogNumEntries=eventLogNumEntries, eventLog=eventLog, datadirect=datadirect, powerEncId=powerEncId, fanTable=fanTable, poolNumber=poolNumber, powerTable=powerTable, poolNumDisks=poolNumDisks, physDiskEnc=physDiskEnc, physDiskPoolId=physDiskPoolId, fanNumber=fanNumber, fanEntry=fanEntry, tempIndex=tempIndex, poolTable=poolTable, tempStatus=tempStatus, DisplayString=DisplayString, systemName=systemName, powerNumber=powerNumber, powerIndex=powerIndex, poolEntry=poolEntry, powerEntry=powerEntry, poolType=poolType, unit=unit, physDiskId=physDiskId, eventLogIndex=eventLogIndex, physicalDiskEntry=physicalDiskEntry, eventLogTable=eventLogTable, fanIndex=fanIndex, eventLogDescr=eventLogDescr, poolId=poolId, tempTable=tempTable, physicalDiskTable=physicalDiskTable, tempEncPos=tempEncPos)
