...
# Produced by pysmi-1.1.8 at Thu Sep  7 11:40:47 2023
...
enterprises, NotificationType, IpAddress, TimeTicks, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, Integer32, ObjectIdentity, Bits, Gauge32, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "IpAddress", "TimeTicks", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "Integer32", "ObjectIdentity", "Bits", "Gauge32", "MibIdentifier", "Counter32")
...
mibBuilder.exportSymbols("SFA-INFO", fanIndex=fanIndex, physDiskWWN=physDiskWWN, tempTable=tempTable, powerEntry=powerEntry, poolNumber=poolNumber, poolIndex=poolIndex, physDiskSlot=physDiskSlot, unit=unit, eventLogNumEntries=eventLogNumEntries, physDiskEnc=physDiskEnc, eventLogLevel=eventLogLevel, fanEncId=fanEncId, physicalDiskTable=physicalDiskTable, DisplayString=DisplayString, tempStatus=tempStatus, eventLogTable=eventLogTable, powerTable=powerTable, poolNumDisks=poolNumDisks, physDiskPoolId=physDiskPoolId, physDiskId=physDiskId, poolTable=poolTable, eventLogTrapLevel=eventLogTrapLevel, poolEntry=poolEntry, powerEncId=powerEncId, powerEncPos=powerEncPos, fanEntry=fanEntry, physicalDiskEntry=physicalDiskEntry, tempEncId=tempEncId, physDiskState=physDiskState, tempEntry=tempEntry, fanNumber=fanNumber, tempIndex=tempIndex, eventLogDescr=eventLogDescr, eventLogEntry=eventLogEntry, poolId=poolId, eventLogIndex=eventLogIndex, powerNumber=powerNumber, systemName=systemName, tempEncPos=tempEncPos, fanStatus=fanStatus, powerIndex=powerIndex, powerStatus=powerStatus, physDiskIndex=physDiskIndex, fanTable=fanTable, fanEncPos=fanEncPos, datadirect=datadirect, poolType=poolType, tempNumber=tempNumber, eventLog=eventLog)
