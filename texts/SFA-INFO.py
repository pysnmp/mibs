...
# Produced by pysmi-1.1.10 at Wed Nov 15 02:36:05 2023
...
iso, Integer32, Unsigned32, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, Counter64, IpAddress, NotificationType, Gauge32, Bits, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Unsigned32", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "Counter64", "IpAddress", "NotificationType", "Gauge32", "Bits", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskState=physDiskState, datadirect=datadirect, fanStatus=fanStatus, powerNumber=powerNumber, eventLogNumEntries=eventLogNumEntries, powerEncPos=powerEncPos, poolIndex=poolIndex, physDiskIndex=physDiskIndex, physDiskWWN=physDiskWWN, physDiskSlot=physDiskSlot, powerIndex=powerIndex, powerEntry=powerEntry, eventLogIndex=eventLogIndex, eventLogLevel=eventLogLevel, physDiskId=physDiskId, eventLogEntry=eventLogEntry, physicalDiskTable=physicalDiskTable, fanEncPos=fanEncPos, tempNumber=tempNumber, powerEncId=powerEncId, tempEncPos=tempEncPos, poolNumDisks=poolNumDisks, tempEntry=tempEntry, eventLog=eventLog, poolEntry=poolEntry, fanTable=fanTable, poolType=poolType, poolId=poolId, tempEncId=tempEncId, eventLogTable=eventLogTable, fanNumber=fanNumber, tempTable=tempTable, unit=unit, poolNumber=poolNumber, eventLogTrapLevel=eventLogTrapLevel, powerStatus=powerStatus, DisplayString=DisplayString, tempIndex=tempIndex, poolTable=poolTable, powerTable=powerTable, fanEncId=fanEncId, physDiskPoolId=physDiskPoolId, physicalDiskEntry=physicalDiskEntry, physDiskEnc=physDiskEnc, systemName=systemName, fanIndex=fanIndex, fanEntry=fanEntry, tempStatus=tempStatus, eventLogDescr=eventLogDescr)
