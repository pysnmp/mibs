...
# Produced by pysmi-1.1.8 at Fri Jan 13 13:52:59 2023
...
IpAddress, enterprises, Counter32, ObjectIdentity, NotificationType, MibIdentifier, Integer32, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Bits, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "Counter32", "ObjectIdentity", "NotificationType", "MibIdentifier", "Integer32", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Bits", "Gauge32", "iso")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskSlot=physDiskSlot, physDiskEnc=physDiskEnc, fanEncId=fanEncId, physicalDiskTable=physicalDiskTable, physDiskState=physDiskState, powerStatus=powerStatus, DisplayString=DisplayString, physDiskPoolId=physDiskPoolId, eventLogLevel=eventLogLevel, powerNumber=powerNumber, fanStatus=fanStatus, poolNumDisks=poolNumDisks, powerIndex=powerIndex, poolTable=poolTable, fanIndex=fanIndex, tempNumber=tempNumber, poolIndex=poolIndex, eventLogIndex=eventLogIndex, powerTable=powerTable, fanEncPos=fanEncPos, powerEntry=powerEntry, poolType=poolType, fanNumber=fanNumber, tempEntry=tempEntry, tempEncPos=tempEncPos, poolNumber=poolNumber, eventLogDescr=eventLogDescr, datadirect=datadirect, physDiskId=physDiskId, poolId=poolId, tempStatus=tempStatus, eventLogEntry=eventLogEntry, physDiskWWN=physDiskWWN, unit=unit, eventLogTable=eventLogTable, tempTable=tempTable, physDiskIndex=physDiskIndex, powerEncPos=powerEncPos, eventLogNumEntries=eventLogNumEntries, eventLog=eventLog, tempEncId=tempEncId, poolEntry=poolEntry, eventLogTrapLevel=eventLogTrapLevel, tempIndex=tempIndex, physicalDiskEntry=physicalDiskEntry, systemName=systemName, fanEntry=fanEntry, powerEncId=powerEncId, fanTable=fanTable)
