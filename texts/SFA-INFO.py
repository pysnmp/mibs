...
Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Gauge32, Bits, Integer32, NotificationType, ModuleIdentity, IpAddress, Counter64, iso, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Gauge32", "Bits", "Integer32", "NotificationType", "ModuleIdentity", "IpAddress", "Counter64", "iso", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("SFA-INFO", fanEncPos=fanEncPos, physDiskPoolId=physDiskPoolId, datadirect=datadirect, eventLogLevel=eventLogLevel, physDiskIndex=physDiskIndex, fanEntry=fanEntry, poolTable=poolTable, poolId=poolId, tempTable=tempTable, tempEncPos=tempEncPos, eventLog=eventLog, DisplayString=DisplayString, systemName=systemName, eventLogTrapLevel=eventLogTrapLevel, eventLogEntry=eventLogEntry, tempNumber=tempNumber, fanIndex=fanIndex, powerEncId=powerEncId, physDiskWWN=physDiskWWN, tempStatus=tempStatus, powerStatus=powerStatus, powerNumber=powerNumber, eventLogNumEntries=eventLogNumEntries, poolIndex=poolIndex, unit=unit, physDiskId=physDiskId, physicalDiskEntry=physicalDiskEntry, physicalDiskTable=physicalDiskTable, fanTable=fanTable, poolEntry=poolEntry, physDiskState=physDiskState, powerEntry=powerEntry, fanEncId=fanEncId, eventLogTable=eventLogTable, physDiskSlot=physDiskSlot, tempEntry=tempEntry, powerTable=powerTable, fanStatus=fanStatus, poolNumDisks=poolNumDisks, powerEncPos=powerEncPos, fanNumber=fanNumber, tempIndex=tempIndex, powerIndex=powerIndex, eventLogDescr=eventLogDescr, poolNumber=poolNumber, poolType=poolType, eventLogIndex=eventLogIndex, physDiskEnc=physDiskEnc, tempEncId=tempEncId)
