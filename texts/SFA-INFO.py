...
# Produced by pysmi-1.1.8 at Sat Jan 15 15:08:23 2022
...
Counter64, ModuleIdentity, Counter32, TimeTicks, Integer32, Gauge32, NotificationType, MibIdentifier, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Counter32", "TimeTicks", "Integer32", "Gauge32", "NotificationType", "MibIdentifier", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("SFA-INFO", poolTable=poolTable, eventLog=eventLog, physDiskState=physDiskState, physDiskId=physDiskId, tempStatus=tempStatus, tempTable=tempTable, powerEntry=powerEntry, poolId=poolId, physDiskSlot=physDiskSlot, eventLogNumEntries=eventLogNumEntries, fanIndex=fanIndex, physicalDiskTable=physicalDiskTable, eventLogDescr=eventLogDescr, DisplayString=DisplayString, fanEncPos=fanEncPos, eventLogEntry=eventLogEntry, tempIndex=tempIndex, powerStatus=powerStatus, systemName=systemName, physDiskWWN=physDiskWWN, powerEncId=powerEncId, fanEntry=fanEntry, physDiskEnc=physDiskEnc, poolNumDisks=poolNumDisks, fanStatus=fanStatus, fanTable=fanTable, physicalDiskEntry=physicalDiskEntry, tempNumber=tempNumber, eventLogTable=eventLogTable, poolIndex=poolIndex, physDiskPoolId=physDiskPoolId, powerIndex=powerIndex, eventLogLevel=eventLogLevel, tempEntry=tempEntry, eventLogTrapLevel=eventLogTrapLevel, poolEntry=poolEntry, tempEncId=tempEncId, fanEncId=fanEncId, tempEncPos=tempEncPos, unit=unit, eventLogIndex=eventLogIndex, poolType=poolType, datadirect=datadirect, powerTable=powerTable, powerNumber=powerNumber, fanNumber=fanNumber, poolNumber=poolNumber, powerEncPos=powerEncPos, physDiskIndex=physDiskIndex)
