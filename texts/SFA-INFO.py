...
Counter64, NotificationType, IpAddress, Unsigned32, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, Counter32, MibIdentifier, ObjectIdentity, Gauge32, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "IpAddress", "Unsigned32", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "Counter32", "MibIdentifier", "ObjectIdentity", "Gauge32", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskPoolId=physDiskPoolId, fanNumber=fanNumber, powerTable=powerTable, tempEncPos=tempEncPos, powerIndex=powerIndex, tempIndex=tempIndex, fanTable=fanTable, physicalDiskTable=physicalDiskTable, physicalDiskEntry=physicalDiskEntry, physDiskIndex=physDiskIndex, eventLogIndex=eventLogIndex, powerEncId=powerEncId, physDiskEnc=physDiskEnc, powerNumber=powerNumber, datadirect=datadirect, physDiskState=physDiskState, poolEntry=poolEntry, poolType=poolType, physDiskId=physDiskId, fanEntry=fanEntry, fanStatus=fanStatus, physDiskSlot=physDiskSlot, physDiskWWN=physDiskWWN, eventLogNumEntries=eventLogNumEntries, poolTable=poolTable, poolIndex=poolIndex, powerEntry=powerEntry, eventLogLevel=eventLogLevel, poolNumDisks=poolNumDisks, tempNumber=tempNumber, tempStatus=tempStatus, systemName=systemName, powerStatus=powerStatus, poolNumber=poolNumber, tempEntry=tempEntry, powerEncPos=powerEncPos, eventLogDescr=eventLogDescr, tempTable=tempTable, fanIndex=fanIndex, fanEncPos=fanEncPos, eventLogTable=eventLogTable, eventLogTrapLevel=eventLogTrapLevel, eventLogEntry=eventLogEntry, fanEncId=fanEncId, tempEncId=tempEncId, unit=unit, poolId=poolId, DisplayString=DisplayString, eventLog=eventLog)
