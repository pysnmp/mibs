...
# Produced by pysmi-1.1.12 at Tue Dec  3 09:41:05 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Gauge32, iso, NotificationType, MibIdentifier, ModuleIdentity, ObjectIdentity, Unsigned32, Counter32, enterprises, TimeTicks, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Gauge32", "iso", "NotificationType", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Counter32", "enterprises", "TimeTicks", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", fanNumber=fanNumber, fanEncPos=fanEncPos, eventLogTrapLevel=eventLogTrapLevel, powerEncPos=powerEncPos, fanIndex=fanIndex, poolNumDisks=poolNumDisks, eventLogTable=eventLogTable, tempEntry=tempEntry, datadirect=datadirect, poolNumber=poolNumber, tempTable=tempTable, physDiskWWN=physDiskWWN, powerNumber=powerNumber, powerIndex=powerIndex, powerEncId=powerEncId, poolType=poolType, physDiskId=physDiskId, physDiskEnc=physDiskEnc, eventLog=eventLog, fanEncId=fanEncId, poolTable=poolTable, systemName=systemName, physDiskIndex=physDiskIndex, tempNumber=tempNumber, poolIndex=poolIndex, tempEncId=tempEncId, eventLogIndex=eventLogIndex, eventLogDescr=eventLogDescr, poolEntry=poolEntry, physicalDiskEntry=physicalDiskEntry, eventLogLevel=eventLogLevel, eventLogNumEntries=eventLogNumEntries, physDiskPoolId=physDiskPoolId, DisplayString=DisplayString, eventLogEntry=eventLogEntry, powerStatus=powerStatus, fanTable=fanTable, tempIndex=tempIndex, fanStatus=fanStatus, tempStatus=tempStatus, unit=unit, tempEncPos=tempEncPos, physDiskSlot=physDiskSlot, poolId=poolId, physicalDiskTable=physicalDiskTable, fanEntry=fanEntry, powerEntry=powerEntry, powerTable=powerTable, physDiskState=physDiskState)
