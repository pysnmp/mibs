...
ModuleIdentity, Unsigned32, Integer32, IpAddress, iso, MibIdentifier, Counter32, Gauge32, Counter64, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Integer32", "IpAddress", "iso", "MibIdentifier", "Counter32", "Gauge32", "Counter64", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", physicalDiskTable=physicalDiskTable, tempEncPos=tempEncPos, fanTable=fanTable, powerEncPos=powerEncPos, fanNumber=fanNumber, poolId=poolId, poolNumDisks=poolNumDisks, powerEncId=powerEncId, DisplayString=DisplayString, powerStatus=powerStatus, eventLogNumEntries=eventLogNumEntries, poolTable=poolTable, tempEntry=tempEntry, fanIndex=fanIndex, eventLogTable=eventLogTable, fanEncId=fanEncId, poolIndex=poolIndex, physDiskWWN=physDiskWWN, poolType=poolType, physDiskPoolId=physDiskPoolId, fanStatus=fanStatus, unit=unit, powerNumber=powerNumber, fanEncPos=fanEncPos, tempIndex=tempIndex, powerTable=powerTable, physicalDiskEntry=physicalDiskEntry, fanEntry=fanEntry, tempStatus=tempStatus, physDiskId=physDiskId, physDiskEnc=physDiskEnc, systemName=systemName, tempNumber=tempNumber, eventLogDescr=eventLogDescr, eventLogLevel=eventLogLevel, powerEntry=powerEntry, poolEntry=poolEntry, eventLogIndex=eventLogIndex, physDiskState=physDiskState, eventLogEntry=eventLogEntry, poolNumber=poolNumber, powerIndex=powerIndex, eventLogTrapLevel=eventLogTrapLevel, datadirect=datadirect, tempTable=tempTable, eventLog=eventLog, tempEncId=tempEncId, physDiskIndex=physDiskIndex, physDiskSlot=physDiskSlot)
