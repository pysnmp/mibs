...
Gauge32, iso, ModuleIdentity, MibIdentifier, Unsigned32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, TimeTicks, Counter32, Counter64, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "ModuleIdentity", "MibIdentifier", "Unsigned32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "TimeTicks", "Counter32", "Counter64", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("SFA-INFO", fanEncPos=fanEncPos, physDiskIndex=physDiskIndex, poolEntry=poolEntry, poolNumDisks=poolNumDisks, eventLog=eventLog, tempIndex=tempIndex, eventLogIndex=eventLogIndex, tempEncId=tempEncId, physicalDiskTable=physicalDiskTable, physicalDiskEntry=physicalDiskEntry, powerEncPos=powerEncPos, tempStatus=tempStatus, fanIndex=fanIndex, eventLogNumEntries=eventLogNumEntries, fanStatus=fanStatus, powerTable=powerTable, powerEntry=powerEntry, eventLogTrapLevel=eventLogTrapLevel, physDiskId=physDiskId, tempNumber=tempNumber, eventLogEntry=eventLogEntry, physDiskSlot=physDiskSlot, poolIndex=poolIndex, physDiskState=physDiskState, eventLogTable=eventLogTable, datadirect=datadirect, eventLogDescr=eventLogDescr, fanTable=fanTable, DisplayString=DisplayString, unit=unit, poolNumber=poolNumber, physDiskWWN=physDiskWWN, powerNumber=powerNumber, powerEncId=powerEncId, eventLogLevel=eventLogLevel, fanEntry=fanEntry, powerStatus=powerStatus, fanEncId=fanEncId, systemName=systemName, tempTable=tempTable, poolTable=poolTable, physDiskEnc=physDiskEnc, physDiskPoolId=physDiskPoolId, tempEntry=tempEntry, tempEncPos=tempEncPos, poolType=poolType, poolId=poolId, powerIndex=powerIndex, fanNumber=fanNumber)
