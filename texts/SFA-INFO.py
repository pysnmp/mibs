...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:04:35 2024
...
Bits, Counter64, Counter32, NotificationType, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, MibIdentifier, Gauge32, iso, enterprises, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "Counter32", "NotificationType", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "MibIdentifier", "Gauge32", "iso", "enterprises", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", powerEntry=powerEntry, powerNumber=powerNumber, systemName=systemName, eventLogDescr=eventLogDescr, physDiskState=physDiskState, eventLog=eventLog, tempStatus=tempStatus, poolIndex=poolIndex, eventLogTable=eventLogTable, tempNumber=tempNumber, powerEncPos=powerEncPos, poolEntry=poolEntry, poolNumDisks=poolNumDisks, physicalDiskEntry=physicalDiskEntry, eventLogTrapLevel=eventLogTrapLevel, eventLogIndex=eventLogIndex, physDiskIndex=physDiskIndex, poolType=poolType, physDiskEnc=physDiskEnc, physDiskId=physDiskId, tempIndex=tempIndex, poolNumber=poolNumber, tempEntry=tempEntry, fanStatus=fanStatus, tempEncId=tempEncId, physDiskWWN=physDiskWWN, physDiskPoolId=physDiskPoolId, powerTable=powerTable, unit=unit, eventLogNumEntries=eventLogNumEntries, powerIndex=powerIndex, datadirect=datadirect, powerEncId=powerEncId, physicalDiskTable=physicalDiskTable, fanEntry=fanEntry, eventLogLevel=eventLogLevel, fanNumber=fanNumber, fanEncId=fanEncId, physDiskSlot=physDiskSlot, eventLogEntry=eventLogEntry, tempEncPos=tempEncPos, fanTable=fanTable, tempTable=tempTable, DisplayString=DisplayString, powerStatus=powerStatus, poolTable=poolTable, fanEncPos=fanEncPos, fanIndex=fanIndex, poolId=poolId)
