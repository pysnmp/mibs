...
# Produced by pysmi-1.1.8 at Fri Jan  7 01:03:48 2022
...
Bits, Unsigned32, IpAddress, Counter64, Gauge32, ModuleIdentity, NotificationType, Integer32, Counter32, iso, MibIdentifier, TimeTicks, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "IpAddress", "Counter64", "Gauge32", "ModuleIdentity", "NotificationType", "Integer32", "Counter32", "iso", "MibIdentifier", "TimeTicks", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", poolNumber=poolNumber, physicalDiskTable=physicalDiskTable, physDiskEnc=physDiskEnc, eventLogDescr=eventLogDescr, fanIndex=fanIndex, physDiskState=physDiskState, poolEntry=poolEntry, poolId=poolId, powerTable=powerTable, physDiskWWN=physDiskWWN, tempIndex=tempIndex, powerIndex=powerIndex, eventLogTrapLevel=eventLogTrapLevel, physDiskSlot=physDiskSlot, fanStatus=fanStatus, powerNumber=powerNumber, eventLogNumEntries=eventLogNumEntries, powerEncId=powerEncId, eventLogLevel=eventLogLevel, poolIndex=poolIndex, physDiskId=physDiskId, tempNumber=tempNumber, eventLogTable=eventLogTable, eventLogIndex=eventLogIndex, eventLog=eventLog, poolNumDisks=poolNumDisks, systemName=systemName, tempStatus=tempStatus, poolType=poolType, datadirect=datadirect, powerEntry=powerEntry, fanTable=fanTable, tempEntry=tempEntry, fanEncPos=fanEncPos, powerEncPos=powerEncPos, tempEncId=tempEncId, powerStatus=powerStatus, DisplayString=DisplayString, fanNumber=fanNumber, tempTable=tempTable, unit=unit, physDiskIndex=physDiskIndex, physDiskPoolId=physDiskPoolId, tempEncPos=tempEncPos, fanEncId=fanEncId, eventLogEntry=eventLogEntry, poolTable=poolTable, fanEntry=fanEntry, physicalDiskEntry=physicalDiskEntry)
