...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:37:53 2024
...
Bits, Counter32, Counter64, NotificationType, Integer32, Gauge32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, iso, MibIdentifier, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Counter64", "NotificationType", "Integer32", "Gauge32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "iso", "MibIdentifier", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("SFA-INFO", powerNumber=powerNumber, poolId=poolId, powerStatus=powerStatus, powerEncPos=powerEncPos, poolNumber=poolNumber, fanEncId=fanEncId, fanEncPos=fanEncPos, physDiskEnc=physDiskEnc, physicalDiskTable=physicalDiskTable, physDiskSlot=physDiskSlot, physDiskState=physDiskState, fanStatus=fanStatus, poolEntry=poolEntry, fanIndex=fanIndex, tempStatus=tempStatus, physDiskWWN=physDiskWWN, poolType=poolType, fanTable=fanTable, powerIndex=powerIndex, physDiskPoolId=physDiskPoolId, systemName=systemName, eventLogTable=eventLogTable, eventLogIndex=eventLogIndex, datadirect=datadirect, eventLogTrapLevel=eventLogTrapLevel, physDiskId=physDiskId, DisplayString=DisplayString, eventLogLevel=eventLogLevel, tempEncPos=tempEncPos, eventLogNumEntries=eventLogNumEntries, tempTable=tempTable, physicalDiskEntry=physicalDiskEntry, eventLog=eventLog, powerEntry=powerEntry, eventLogEntry=eventLogEntry, poolTable=poolTable, physDiskIndex=physDiskIndex, tempEntry=tempEntry, poolIndex=poolIndex, powerTable=powerTable, eventLogDescr=eventLogDescr, tempIndex=tempIndex, poolNumDisks=poolNumDisks, tempEncId=tempEncId, fanEntry=fanEntry, unit=unit, fanNumber=fanNumber, powerEncId=powerEncId, tempNumber=tempNumber)
