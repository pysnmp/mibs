...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, NotificationType, TimeTicks, IpAddress, Integer32, iso, MibIdentifier, Bits, ObjectIdentity, enterprises, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "NotificationType", "TimeTicks", "IpAddress", "Integer32", "iso", "MibIdentifier", "Bits", "ObjectIdentity", "enterprises", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("SFA-INFO", tempIndex=tempIndex, fanTable=fanTable, tempStatus=tempStatus, physDiskPoolId=physDiskPoolId, datadirect=datadirect, poolId=poolId, eventLog=eventLog, unit=unit, tempNumber=tempNumber, eventLogEntry=eventLogEntry, poolTable=poolTable, tempTable=tempTable, physDiskWWN=physDiskWWN, systemName=systemName, powerNumber=powerNumber, poolIndex=poolIndex, fanNumber=fanNumber, poolType=poolType, DisplayString=DisplayString, physDiskId=physDiskId, eventLogDescr=eventLogDescr, powerIndex=powerIndex, fanStatus=fanStatus, physicalDiskTable=physicalDiskTable, tempEntry=tempEntry, physDiskState=physDiskState, tempEncId=tempEncId, eventLogTable=eventLogTable, poolNumDisks=poolNumDisks, powerTable=powerTable, fanEncPos=fanEncPos, eventLogNumEntries=eventLogNumEntries, fanEncId=fanEncId, tempEncPos=tempEncPos, powerEncId=powerEncId, powerStatus=powerStatus, physDiskSlot=physDiskSlot, physicalDiskEntry=physicalDiskEntry, eventLogTrapLevel=eventLogTrapLevel, physDiskIndex=physDiskIndex, fanIndex=fanIndex, poolNumber=poolNumber, powerEncPos=powerEncPos, fanEntry=fanEntry, physDiskEnc=physDiskEnc, eventLogIndex=eventLogIndex, poolEntry=poolEntry, powerEntry=powerEntry, eventLogLevel=eventLogLevel)
