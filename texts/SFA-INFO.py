...
# Produced by pysmi-1.1.8 at Thu Jan  5 13:19:19 2023
...
Bits, Integer32, TimeTicks, NotificationType, Gauge32, IpAddress, Counter32, ObjectIdentity, ModuleIdentity, iso, Counter64, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "TimeTicks", "NotificationType", "Gauge32", "IpAddress", "Counter32", "ObjectIdentity", "ModuleIdentity", "iso", "Counter64", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("SFA-INFO", powerEncPos=powerEncPos, tempNumber=tempNumber, datadirect=datadirect, physDiskIndex=physDiskIndex, poolEntry=poolEntry, eventLog=eventLog, eventLogIndex=eventLogIndex, eventLogNumEntries=eventLogNumEntries, tempEncId=tempEncId, DisplayString=DisplayString, powerIndex=powerIndex, physDiskSlot=physDiskSlot, powerTable=powerTable, physDiskId=physDiskId, physicalDiskTable=physicalDiskTable, poolId=poolId, poolNumDisks=poolNumDisks, unit=unit, fanStatus=fanStatus, eventLogEntry=eventLogEntry, physDiskPoolId=physDiskPoolId, powerStatus=powerStatus, poolIndex=poolIndex, poolTable=poolTable, tempTable=tempTable, fanIndex=fanIndex, tempIndex=tempIndex, fanEncId=fanEncId, tempStatus=tempStatus, physicalDiskEntry=physicalDiskEntry, physDiskWWN=physDiskWWN, tempEntry=tempEntry, physDiskEnc=physDiskEnc, fanEntry=fanEntry, eventLogTable=eventLogTable, fanTable=fanTable, physDiskState=physDiskState, poolType=poolType, powerEncId=powerEncId, fanEncPos=fanEncPos, tempEncPos=tempEncPos, poolNumber=poolNumber, powerEntry=powerEntry, eventLogTrapLevel=eventLogTrapLevel, powerNumber=powerNumber, systemName=systemName, eventLogLevel=eventLogLevel, eventLogDescr=eventLogDescr, fanNumber=fanNumber)
