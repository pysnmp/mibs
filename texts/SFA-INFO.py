...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:47:16 2021
...
NotificationType, Counter64, Unsigned32, ModuleIdentity, Bits, iso, Counter32, ObjectIdentity, MibIdentifier, TimeTicks, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Unsigned32", "ModuleIdentity", "Bits", "iso", "Counter32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("SFA-INFO", tempIndex=tempIndex, physDiskPoolId=physDiskPoolId, eventLogDescr=eventLogDescr, fanNumber=fanNumber, eventLogIndex=eventLogIndex, tempEntry=tempEntry, fanEncId=fanEncId, tempStatus=tempStatus, powerTable=powerTable, powerEncId=powerEncId, fanEntry=fanEntry, fanStatus=fanStatus, eventLogNumEntries=eventLogNumEntries, poolNumDisks=poolNumDisks, unit=unit, eventLog=eventLog, tempEncPos=tempEncPos, powerStatus=powerStatus, physDiskWWN=physDiskWWN, physDiskId=physDiskId, powerEncPos=powerEncPos, powerNumber=powerNumber, DisplayString=DisplayString, physDiskEnc=physDiskEnc, eventLogTable=eventLogTable, fanEncPos=fanEncPos, poolType=poolType, physDiskIndex=physDiskIndex, poolTable=poolTable, tempTable=tempTable, tempNumber=tempNumber, physDiskState=physDiskState, physicalDiskEntry=physicalDiskEntry, powerIndex=powerIndex, physDiskSlot=physDiskSlot, datadirect=datadirect, poolIndex=poolIndex, systemName=systemName, powerEntry=powerEntry, physicalDiskTable=physicalDiskTable, fanIndex=fanIndex, fanTable=fanTable, eventLogTrapLevel=eventLogTrapLevel, tempEncId=tempEncId, poolNumber=poolNumber, poolId=poolId, eventLogLevel=eventLogLevel, eventLogEntry=eventLogEntry, poolEntry=poolEntry)
