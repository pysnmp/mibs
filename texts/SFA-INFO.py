...
# Produced by pysmi-1.1.3 at Tue Nov 30 03:09:44 2021
...
iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Gauge32, ModuleIdentity, MibIdentifier, Counter32, IpAddress, Bits, TimeTicks, Integer32, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Gauge32", "ModuleIdentity", "MibIdentifier", "Counter32", "IpAddress", "Bits", "TimeTicks", "Integer32", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("SFA-INFO", fanStatus=fanStatus, poolNumber=poolNumber, eventLogEntry=eventLogEntry, powerEncPos=powerEncPos, tempNumber=tempNumber, eventLogIndex=eventLogIndex, eventLog=eventLog, tempEncPos=tempEncPos, eventLogDescr=eventLogDescr, physDiskSlot=physDiskSlot, physDiskWWN=physDiskWWN, powerIndex=powerIndex, datadirect=datadirect, fanIndex=fanIndex, eventLogTable=eventLogTable, tempEncId=tempEncId, powerEntry=powerEntry, powerStatus=powerStatus, eventLogNumEntries=eventLogNumEntries, fanEncId=fanEncId, poolId=poolId, physDiskIndex=physDiskIndex, fanEncPos=fanEncPos, physicalDiskEntry=physicalDiskEntry, powerEncId=powerEncId, poolEntry=poolEntry, systemName=systemName, fanTable=fanTable, powerNumber=powerNumber, physDiskId=physDiskId, tempStatus=tempStatus, powerTable=powerTable, tempEntry=tempEntry, unit=unit, physDiskPoolId=physDiskPoolId, tempTable=tempTable, poolIndex=poolIndex, fanNumber=fanNumber, poolType=poolType, eventLogTrapLevel=eventLogTrapLevel, fanEntry=fanEntry, physDiskState=physDiskState, physDiskEnc=physDiskEnc, eventLogLevel=eventLogLevel, DisplayString=DisplayString, poolTable=poolTable, poolNumDisks=poolNumDisks, physicalDiskTable=physicalDiskTable, tempIndex=tempIndex)
