...
# Produced by pysmi-1.1.3 at Tue Nov 30 03:06:16 2021
...
ObjectIdentity, NotificationType, Counter32, MibIdentifier, enterprises, TimeTicks, ModuleIdentity, IpAddress, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Counter32", "MibIdentifier", "enterprises", "TimeTicks", "ModuleIdentity", "IpAddress", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "iso", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", tempNumber=tempNumber, tempIndex=tempIndex, fanIndex=fanIndex, fanStatus=fanStatus, eventLogLevel=eventLogLevel, poolNumber=poolNumber, eventLogNumEntries=eventLogNumEntries, poolEntry=poolEntry, fanTable=fanTable, physDiskState=physDiskState, fanEncId=fanEncId, unit=unit, poolId=poolId, eventLogDescr=eventLogDescr, powerIndex=powerIndex, poolNumDisks=poolNumDisks, tempStatus=tempStatus, fanEntry=fanEntry, poolType=poolType, powerEntry=powerEntry, DisplayString=DisplayString, physDiskPoolId=physDiskPoolId, physDiskId=physDiskId, powerTable=powerTable, systemName=systemName, tempEntry=tempEntry, fanNumber=fanNumber, tempEncPos=tempEncPos, physicalDiskTable=physicalDiskTable, tempTable=tempTable, physDiskEnc=physDiskEnc, powerEncPos=powerEncPos, tempEncId=tempEncId, powerNumber=powerNumber, eventLogIndex=eventLogIndex, eventLogTrapLevel=eventLogTrapLevel, eventLog=eventLog, fanEncPos=fanEncPos, physDiskIndex=physDiskIndex, eventLogTable=eventLogTable, physicalDiskEntry=physicalDiskEntry, physDiskWWN=physDiskWWN, physDiskSlot=physDiskSlot, powerStatus=powerStatus, datadirect=datadirect, powerEncId=powerEncId, poolIndex=poolIndex, poolTable=poolTable, eventLogEntry=eventLogEntry)
