...
# Produced by pysmi-1.1.3 at Mon Nov 22 20:06:49 2021
...
Integer32, NotificationType, TimeTicks, enterprises, Counter32, Counter64, Gauge32, ModuleIdentity, ObjectIdentity, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "TimeTicks", "enterprises", "Counter32", "Counter64", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogTrapLevel=eventLogTrapLevel, fanStatus=fanStatus, physDiskState=physDiskState, eventLogNumEntries=eventLogNumEntries, poolId=poolId, physDiskIndex=physDiskIndex, physDiskSlot=physDiskSlot, tempEntry=tempEntry, poolType=poolType, tempEncPos=tempEncPos, physDiskPoolId=physDiskPoolId, powerEncId=powerEncId, DisplayString=DisplayString, fanTable=fanTable, physDiskEnc=physDiskEnc, physicalDiskEntry=physicalDiskEntry, poolNumber=poolNumber, eventLogEntry=eventLogEntry, fanNumber=fanNumber, fanEntry=fanEntry, tempNumber=tempNumber, tempTable=tempTable, unit=unit, tempEncId=tempEncId, poolTable=poolTable, tempIndex=tempIndex, systemName=systemName, physDiskWWN=physDiskWWN, eventLog=eventLog, eventLogDescr=eventLogDescr, eventLogIndex=eventLogIndex, powerEncPos=powerEncPos, powerEntry=powerEntry, fanEncPos=fanEncPos, poolEntry=poolEntry, powerStatus=powerStatus, poolIndex=poolIndex, fanEncId=fanEncId, physDiskId=physDiskId, tempStatus=tempStatus, poolNumDisks=poolNumDisks, powerIndex=powerIndex, eventLogLevel=eventLogLevel, physicalDiskTable=physicalDiskTable, powerNumber=powerNumber, datadirect=datadirect, powerTable=powerTable, eventLogTable=eventLogTable, fanIndex=fanIndex)
