...
# Produced by pysmi-1.1.12 at Fri Nov 22 11:53:59 2024
...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Unsigned32, TimeTicks, Gauge32, Bits, Counter64, MibIdentifier, IpAddress, Counter32, enterprises, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Unsigned32", "TimeTicks", "Gauge32", "Bits", "Counter64", "MibIdentifier", "IpAddress", "Counter32", "enterprises", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", systemName=systemName, fanEntry=fanEntry, fanNumber=fanNumber, powerEncPos=powerEncPos, powerIndex=powerIndex, powerStatus=powerStatus, physDiskId=physDiskId, tempTable=tempTable, eventLogIndex=eventLogIndex, eventLogEntry=eventLogEntry, tempStatus=tempStatus, unit=unit, fanIndex=fanIndex, physDiskIndex=physDiskIndex, datadirect=datadirect, poolEntry=poolEntry, physicalDiskEntry=physicalDiskEntry, physDiskState=physDiskState, powerEntry=powerEntry, fanTable=fanTable, poolId=poolId, DisplayString=DisplayString, eventLogLevel=eventLogLevel, physDiskSlot=physDiskSlot, eventLog=eventLog, eventLogDescr=eventLogDescr, eventLogTrapLevel=eventLogTrapLevel, poolNumber=poolNumber, poolIndex=poolIndex, physicalDiskTable=physicalDiskTable, physDiskPoolId=physDiskPoolId, tempNumber=tempNumber, tempEncPos=tempEncPos, powerEncId=powerEncId, tempEntry=tempEntry, powerNumber=powerNumber, tempIndex=tempIndex, tempEncId=tempEncId, eventLogNumEntries=eventLogNumEntries, fanStatus=fanStatus, eventLogTable=eventLogTable, poolType=poolType, fanEncPos=fanEncPos, physDiskWWN=physDiskWWN, powerTable=powerTable, physDiskEnc=physDiskEnc, poolNumDisks=poolNumDisks, poolTable=poolTable, fanEncId=fanEncId)
