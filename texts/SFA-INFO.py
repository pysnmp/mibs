...
# Produced by pysmi-1.1.12 at Tue May 28 12:47:10 2024
...
Integer32, NotificationType, enterprises, iso, Gauge32, ObjectIdentity, IpAddress, MibIdentifier, ModuleIdentity, Bits, Counter32, Unsigned32, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "enterprises", "iso", "Gauge32", "ObjectIdentity", "IpAddress", "MibIdentifier", "ModuleIdentity", "Bits", "Counter32", "Unsigned32", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", fanEntry=fanEntry, eventLogDescr=eventLogDescr, eventLogEntry=eventLogEntry, tempEncId=tempEncId, poolTable=poolTable, poolNumber=poolNumber, eventLogTable=eventLogTable, physDiskEnc=physDiskEnc, powerEncPos=powerEncPos, poolIndex=poolIndex, eventLogTrapLevel=eventLogTrapLevel, fanTable=fanTable, datadirect=datadirect, poolId=poolId, physDiskIndex=physDiskIndex, eventLog=eventLog, fanStatus=fanStatus, tempNumber=tempNumber, powerStatus=powerStatus, physDiskState=physDiskState, unit=unit, physDiskSlot=physDiskSlot, physicalDiskEntry=physicalDiskEntry, physicalDiskTable=physicalDiskTable, fanEncId=fanEncId, physDiskPoolId=physDiskPoolId, tempEntry=tempEntry, powerEncId=powerEncId, powerTable=powerTable, tempIndex=tempIndex, physDiskId=physDiskId, fanIndex=fanIndex, eventLogNumEntries=eventLogNumEntries, tempTable=tempTable, eventLogIndex=eventLogIndex, powerEntry=powerEntry, powerIndex=powerIndex, physDiskWWN=physDiskWWN, poolNumDisks=poolNumDisks, fanNumber=fanNumber, tempStatus=tempStatus, eventLogLevel=eventLogLevel, systemName=systemName, tempEncPos=tempEncPos, poolType=poolType, DisplayString=DisplayString, fanEncPos=fanEncPos, powerNumber=powerNumber, poolEntry=poolEntry)
