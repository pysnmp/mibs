...
# Produced by pysmi-1.1.10 at Mon Dec 11 02:35:59 2023
...
NotificationType, ModuleIdentity, MibIdentifier, ObjectIdentity, Counter64, Unsigned32, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Integer32, Gauge32, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Counter64", "Unsigned32", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Integer32", "Gauge32", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", fanEncId=fanEncId, physDiskState=physDiskState, systemName=systemName, physDiskEnc=physDiskEnc, physicalDiskTable=physicalDiskTable, poolType=poolType, tempStatus=tempStatus, eventLogEntry=eventLogEntry, fanEntry=fanEntry, powerTable=powerTable, datadirect=datadirect, eventLogIndex=eventLogIndex, eventLog=eventLog, unit=unit, powerEntry=powerEntry, powerStatus=powerStatus, physDiskPoolId=physDiskPoolId, fanEncPos=fanEncPos, tempEntry=tempEntry, fanNumber=fanNumber, physDiskIndex=physDiskIndex, physDiskSlot=physDiskSlot, poolId=poolId, physDiskId=physDiskId, poolNumber=poolNumber, fanIndex=fanIndex, poolEntry=poolEntry, powerEncId=powerEncId, eventLogNumEntries=eventLogNumEntries, powerNumber=powerNumber, fanStatus=fanStatus, tempTable=tempTable, powerEncPos=powerEncPos, eventLogDescr=eventLogDescr, eventLogLevel=eventLogLevel, physDiskWWN=physDiskWWN, tempIndex=tempIndex, tempEncPos=tempEncPos, poolIndex=poolIndex, eventLogTable=eventLogTable, physicalDiskEntry=physicalDiskEntry, fanTable=fanTable, poolNumDisks=poolNumDisks, tempEncId=tempEncId, powerIndex=powerIndex, eventLogTrapLevel=eventLogTrapLevel, tempNumber=tempNumber, poolTable=poolTable, DisplayString=DisplayString)
