...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:12:38 2024
...
enterprises, Counter64, NotificationType, ObjectIdentity, MibIdentifier, IpAddress, Unsigned32, Counter32, TimeTicks, Bits, Gauge32, ModuleIdentity, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "NotificationType", "ObjectIdentity", "MibIdentifier", "IpAddress", "Unsigned32", "Counter32", "TimeTicks", "Bits", "Gauge32", "ModuleIdentity", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", tempIndex=tempIndex, physDiskSlot=physDiskSlot, fanEntry=fanEntry, powerNumber=powerNumber, fanStatus=fanStatus, poolId=poolId, fanNumber=fanNumber, poolIndex=poolIndex, physicalDiskEntry=physicalDiskEntry, physDiskId=physDiskId, eventLogEntry=eventLogEntry, poolEntry=poolEntry, poolType=poolType, eventLogTable=eventLogTable, poolNumDisks=poolNumDisks, physDiskIndex=physDiskIndex, physicalDiskTable=physicalDiskTable, physDiskState=physDiskState, eventLogTrapLevel=eventLogTrapLevel, eventLogDescr=eventLogDescr, fanIndex=fanIndex, physDiskWWN=physDiskWWN, systemName=systemName, tempEntry=tempEntry, fanEncId=fanEncId, powerEntry=powerEntry, powerStatus=powerStatus, tempEncPos=tempEncPos, physDiskEnc=physDiskEnc, powerTable=powerTable, datadirect=datadirect, unit=unit, DisplayString=DisplayString, eventLogIndex=eventLogIndex, powerEncId=powerEncId, poolNumber=poolNumber, fanTable=fanTable, tempStatus=tempStatus, poolTable=poolTable, tempEncId=tempEncId, eventLogLevel=eventLogLevel, tempNumber=tempNumber, powerIndex=powerIndex, fanEncPos=fanEncPos, tempTable=tempTable, eventLogNumEntries=eventLogNumEntries, physDiskPoolId=physDiskPoolId, eventLog=eventLog, powerEncPos=powerEncPos)
