...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:01:01 2022
...
TimeTicks, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, IpAddress, ModuleIdentity, iso, Gauge32, NotificationType, Counter32, Counter64, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "IpAddress", "ModuleIdentity", "iso", "Gauge32", "NotificationType", "Counter32", "Counter64", "enterprises", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogDescr=eventLogDescr, poolEntry=poolEntry, fanEncPos=fanEncPos, tempStatus=tempStatus, eventLogIndex=eventLogIndex, eventLog=eventLog, powerNumber=powerNumber, fanTable=fanTable, physDiskEnc=physDiskEnc, fanStatus=fanStatus, fanEncId=fanEncId, poolTable=poolTable, physDiskPoolId=physDiskPoolId, tempEntry=tempEntry, eventLogNumEntries=eventLogNumEntries, poolNumDisks=poolNumDisks, physDiskSlot=physDiskSlot, powerEncPos=powerEncPos, poolNumber=poolNumber, tempEncId=tempEncId, powerIndex=powerIndex, unit=unit, powerEncId=powerEncId, DisplayString=DisplayString, tempEncPos=tempEncPos, powerEntry=powerEntry, powerTable=powerTable, physDiskId=physDiskId, poolIndex=poolIndex, poolType=poolType, eventLogTable=eventLogTable, datadirect=datadirect, poolId=poolId, physDiskIndex=physDiskIndex, physicalDiskEntry=physicalDiskEntry, tempNumber=tempNumber, fanEntry=fanEntry, fanNumber=fanNumber, powerStatus=powerStatus, eventLogEntry=eventLogEntry, physicalDiskTable=physicalDiskTable, physDiskState=physDiskState, fanIndex=fanIndex, systemName=systemName, physDiskWWN=physDiskWWN, eventLogTrapLevel=eventLogTrapLevel, tempIndex=tempIndex, eventLogLevel=eventLogLevel, tempTable=tempTable)
