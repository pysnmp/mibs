...
# Produced by pysmi-1.1.12 at Thu Apr  4 09:16:36 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Counter32, Counter64, ObjectIdentity, iso, Unsigned32, Gauge32, enterprises, ModuleIdentity, MibIdentifier, TimeTicks, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Counter32", "Counter64", "ObjectIdentity", "iso", "Unsigned32", "Gauge32", "enterprises", "ModuleIdentity", "MibIdentifier", "TimeTicks", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", fanTable=fanTable, physicalDiskTable=physicalDiskTable, fanEntry=fanEntry, powerTable=powerTable, datadirect=datadirect, powerStatus=powerStatus, fanStatus=fanStatus, powerEncId=powerEncId, DisplayString=DisplayString, physDiskState=physDiskState, fanIndex=fanIndex, eventLogEntry=eventLogEntry, poolTable=poolTable, tempNumber=tempNumber, poolType=poolType, tempEntry=tempEntry, eventLogTable=eventLogTable, fanNumber=fanNumber, poolIndex=poolIndex, poolNumber=poolNumber, tempStatus=tempStatus, physDiskId=physDiskId, fanEncPos=fanEncPos, powerIndex=powerIndex, physDiskPoolId=physDiskPoolId, fanEncId=fanEncId, tempEncPos=tempEncPos, eventLogNumEntries=eventLogNumEntries, tempIndex=tempIndex, tempTable=tempTable, powerEncPos=powerEncPos, eventLogDescr=eventLogDescr, poolEntry=poolEntry, eventLog=eventLog, tempEncId=tempEncId, powerNumber=powerNumber, poolId=poolId, eventLogTrapLevel=eventLogTrapLevel, eventLogIndex=eventLogIndex, physDiskSlot=physDiskSlot, systemName=systemName, physDiskWWN=physDiskWWN, physicalDiskEntry=physicalDiskEntry, poolNumDisks=poolNumDisks, eventLogLevel=eventLogLevel, powerEntry=powerEntry, physDiskIndex=physDiskIndex, unit=unit, physDiskEnc=physDiskEnc)
