...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:36:45 2024
...
Counter32, enterprises, ObjectIdentity, TimeTicks, IpAddress, NotificationType, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, Unsigned32, Counter64, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "ObjectIdentity", "TimeTicks", "IpAddress", "NotificationType", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "Unsigned32", "Counter64", "Integer32", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", fanIndex=fanIndex, fanStatus=fanStatus, poolEntry=poolEntry, physDiskIndex=physDiskIndex, tempEncId=tempEncId, tempTable=tempTable, datadirect=datadirect, physDiskState=physDiskState, eventLogLevel=eventLogLevel, powerEncId=powerEncId, eventLogNumEntries=eventLogNumEntries, tempEncPos=tempEncPos, tempNumber=tempNumber, systemName=systemName, powerTable=powerTable, poolIndex=poolIndex, fanEncPos=fanEncPos, powerEncPos=powerEncPos, fanEntry=fanEntry, physDiskId=physDiskId, powerStatus=powerStatus, fanNumber=fanNumber, DisplayString=DisplayString, poolType=poolType, unit=unit, fanTable=fanTable, powerEntry=powerEntry, tempStatus=tempStatus, physicalDiskEntry=physicalDiskEntry, eventLogTable=eventLogTable, eventLog=eventLog, eventLogDescr=eventLogDescr, physicalDiskTable=physicalDiskTable, poolNumDisks=poolNumDisks, powerIndex=powerIndex, tempEntry=tempEntry, powerNumber=powerNumber, eventLogTrapLevel=eventLogTrapLevel, tempIndex=tempIndex, fanEncId=fanEncId, eventLogEntry=eventLogEntry, poolId=poolId, physDiskPoolId=physDiskPoolId, poolTable=poolTable, physDiskSlot=physDiskSlot, physDiskWWN=physDiskWWN, physDiskEnc=physDiskEnc, poolNumber=poolNumber, eventLogIndex=eventLogIndex)
