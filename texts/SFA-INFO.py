...
# Produced by pysmi-1.1.12 at Mon Jun  3 03:02:14 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Counter32, enterprises, Counter64, MibIdentifier, Gauge32, Integer32, TimeTicks, Unsigned32, iso, ModuleIdentity, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Counter32", "enterprises", "Counter64", "MibIdentifier", "Gauge32", "Integer32", "TimeTicks", "Unsigned32", "iso", "ModuleIdentity", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("SFA-INFO", poolType=poolType, unit=unit, eventLogLevel=eventLogLevel, poolNumber=poolNumber, physDiskState=physDiskState, powerNumber=powerNumber, physDiskIndex=physDiskIndex, datadirect=datadirect, physDiskWWN=physDiskWWN, tempEncPos=tempEncPos, powerEncPos=powerEncPos, physDiskId=physDiskId, poolNumDisks=poolNumDisks, fanEntry=fanEntry, tempEntry=tempEntry, fanIndex=fanIndex, tempNumber=tempNumber, powerEntry=powerEntry, systemName=systemName, fanEncId=fanEncId, eventLogDescr=eventLogDescr, fanEncPos=fanEncPos, physDiskPoolId=physDiskPoolId, eventLog=eventLog, eventLogIndex=eventLogIndex, poolTable=poolTable, DisplayString=DisplayString, fanTable=fanTable, powerIndex=powerIndex, powerEncId=powerEncId, physDiskSlot=physDiskSlot, eventLogEntry=eventLogEntry, physicalDiskEntry=physicalDiskEntry, poolIndex=poolIndex, poolId=poolId, physDiskEnc=physDiskEnc, eventLogNumEntries=eventLogNumEntries, tempStatus=tempStatus, eventLogTrapLevel=eventLogTrapLevel, eventLogTable=eventLogTable, powerTable=powerTable, poolEntry=poolEntry, physicalDiskTable=physicalDiskTable, fanNumber=fanNumber, tempTable=tempTable, powerStatus=powerStatus, tempEncId=tempEncId, fanStatus=fanStatus, tempIndex=tempIndex)
