...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:46:22 2022
...
ObjectIdentity, ModuleIdentity, Integer32, Bits, enterprises, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, iso, MibIdentifier, Counter64, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Integer32", "Bits", "enterprises", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "iso", "MibIdentifier", "Counter64", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("SFA-INFO", powerNumber=powerNumber, physicalDiskTable=physicalDiskTable, eventLogDescr=eventLogDescr, poolType=poolType, poolNumber=poolNumber, eventLogTable=eventLogTable, physDiskPoolId=physDiskPoolId, tempNumber=tempNumber, poolIndex=poolIndex, physDiskId=physDiskId, tempEntry=tempEntry, poolTable=poolTable, eventLogLevel=eventLogLevel, powerIndex=powerIndex, physDiskState=physDiskState, fanTable=fanTable, DisplayString=DisplayString, tempEncId=tempEncId, tempEncPos=tempEncPos, physicalDiskEntry=physicalDiskEntry, physDiskEnc=physDiskEnc, eventLogIndex=eventLogIndex, powerEntry=powerEntry, tempTable=tempTable, poolId=poolId, fanEncId=fanEncId, fanIndex=fanIndex, eventLogNumEntries=eventLogNumEntries, eventLogEntry=eventLogEntry, fanEncPos=fanEncPos, powerEncPos=powerEncPos, poolNumDisks=poolNumDisks, poolEntry=poolEntry, eventLog=eventLog, physDiskWWN=physDiskWWN, systemName=systemName, fanStatus=fanStatus, datadirect=datadirect, unit=unit, physDiskIndex=physDiskIndex, eventLogTrapLevel=eventLogTrapLevel, powerEncId=powerEncId, powerStatus=powerStatus, fanEntry=fanEntry, tempStatus=tempStatus, fanNumber=fanNumber, physDiskSlot=physDiskSlot, tempIndex=tempIndex, powerTable=powerTable)
