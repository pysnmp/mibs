...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:17:29 2022
...
Counter32, TimeTicks, Counter64, MibIdentifier, NotificationType, ModuleIdentity, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, Unsigned32, Bits, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "Counter64", "MibIdentifier", "NotificationType", "ModuleIdentity", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "Unsigned32", "Bits", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", fanNumber=fanNumber, poolType=poolType, eventLog=eventLog, eventLogTable=eventLogTable, powerTable=powerTable, powerEncId=powerEncId, poolNumber=poolNumber, datadirect=datadirect, poolNumDisks=poolNumDisks, powerIndex=powerIndex, poolTable=poolTable, tempTable=tempTable, tempEncPos=tempEncPos, powerEntry=powerEntry, tempEntry=tempEntry, physDiskSlot=physDiskSlot, tempStatus=tempStatus, eventLogTrapLevel=eventLogTrapLevel, tempIndex=tempIndex, powerStatus=powerStatus, DisplayString=DisplayString, physDiskWWN=physDiskWWN, fanEncId=fanEncId, poolIndex=poolIndex, poolId=poolId, eventLogEntry=eventLogEntry, powerNumber=powerNumber, systemName=systemName, fanStatus=fanStatus, physDiskEnc=physDiskEnc, powerEncPos=powerEncPos, physicalDiskEntry=physicalDiskEntry, eventLogIndex=eventLogIndex, fanEntry=fanEntry, tempNumber=tempNumber, fanIndex=fanIndex, physDiskState=physDiskState, physDiskIndex=physDiskIndex, fanTable=fanTable, fanEncPos=fanEncPos, eventLogNumEntries=eventLogNumEntries, poolEntry=poolEntry, eventLogDescr=eventLogDescr, physicalDiskTable=physicalDiskTable, physDiskPoolId=physDiskPoolId, physDiskId=physDiskId, tempEncId=tempEncId, eventLogLevel=eventLogLevel, unit=unit)
