...
# Produced by pysmi-1.1.12 at Fri Jul 19 10:00:49 2024
...
mibBuilder.exportSymbols("SFA-INFO", tempEncPos=tempEncPos, tempEntry=tempEntry, eventLogDescr=eventLogDescr, fanEntry=fanEntry, powerEncId=powerEncId, physDiskId=physDiskId, poolNumDisks=poolNumDisks, poolTable=poolTable, eventLogIndex=eventLogIndex, powerNumber=powerNumber, eventLogEntry=eventLogEntry, DisplayString=DisplayString, poolId=poolId, eventLogTrapLevel=eventLogTrapLevel, tempTable=tempTable, fanStatus=fanStatus, physicalDiskTable=physicalDiskTable, eventLogNumEntries=eventLogNumEntries, tempStatus=tempStatus, physDiskSlot=physDiskSlot, eventLog=eventLog, fanNumber=fanNumber, tempEncId=tempEncId, fanEncId=fanEncId, unit=unit, datadirect=datadirect, fanTable=fanTable, poolIndex=poolIndex, eventLogLevel=eventLogLevel, tempIndex=tempIndex, poolNumber=poolNumber, physDiskState=physDiskState, systemName=systemName, physDiskIndex=physDiskIndex, physDiskPoolId=physDiskPoolId, eventLogTable=eventLogTable, physDiskWWN=physDiskWWN, fanIndex=fanIndex, powerStatus=powerStatus, powerEntry=powerEntry, powerTable=powerTable, poolType=poolType, physDiskEnc=physDiskEnc, powerEncPos=powerEncPos, fanEncPos=fanEncPos, powerIndex=powerIndex, tempNumber=tempNumber, physicalDiskEntry=physicalDiskEntry, poolEntry=poolEntry)
