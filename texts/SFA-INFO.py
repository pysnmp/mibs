...
TimeTicks, ObjectIdentity, iso, Gauge32, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, Counter64, NotificationType, Counter32, IpAddress, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "iso", "Gauge32", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "Counter64", "NotificationType", "Counter32", "IpAddress", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", poolEntry=poolEntry, physDiskSlot=physDiskSlot, powerNumber=powerNumber, poolTable=poolTable, physDiskWWN=physDiskWWN, fanEntry=fanEntry, powerEncPos=powerEncPos, poolType=poolType, tempIndex=tempIndex, tempNumber=tempNumber, tempEntry=tempEntry, tempTable=tempTable, eventLogEntry=eventLogEntry, datadirect=datadirect, physDiskId=physDiskId, powerEncId=powerEncId, eventLog=eventLog, poolIndex=poolIndex, poolNumber=poolNumber, eventLogIndex=eventLogIndex, fanEncId=fanEncId, systemName=systemName, eventLogLevel=eventLogLevel, fanIndex=fanIndex, physDiskState=physDiskState, eventLogDescr=eventLogDescr, fanNumber=fanNumber, poolId=poolId, physicalDiskTable=physicalDiskTable, poolNumDisks=poolNumDisks, fanStatus=fanStatus, eventLogNumEntries=eventLogNumEntries, powerStatus=powerStatus, eventLogTable=eventLogTable, powerTable=powerTable, physDiskPoolId=physDiskPoolId, powerEntry=powerEntry, tempEncId=tempEncId, physDiskIndex=physDiskIndex, eventLogTrapLevel=eventLogTrapLevel, tempStatus=tempStatus, unit=unit, physDiskEnc=physDiskEnc, tempEncPos=tempEncPos, physicalDiskEntry=physicalDiskEntry, fanTable=fanTable, fanEncPos=fanEncPos, DisplayString=DisplayString, powerIndex=powerIndex)
