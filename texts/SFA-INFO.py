...
iso, Bits, Integer32, TimeTicks, Counter32, Unsigned32, enterprises, NotificationType, IpAddress, Counter64, MibIdentifier, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Integer32", "TimeTicks", "Counter32", "Unsigned32", "enterprises", "NotificationType", "IpAddress", "Counter64", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("SFA-INFO", tempNumber=tempNumber, fanEntry=fanEntry, fanNumber=fanNumber, physDiskState=physDiskState, poolNumber=poolNumber, tempIndex=tempIndex, fanIndex=fanIndex, datadirect=datadirect, eventLogIndex=eventLogIndex, physDiskId=physDiskId, unit=unit, poolId=poolId, physDiskPoolId=physDiskPoolId, poolType=poolType, physicalDiskTable=physicalDiskTable, poolTable=poolTable, poolNumDisks=poolNumDisks, fanEncId=fanEncId, eventLog=eventLog, powerIndex=powerIndex, poolIndex=poolIndex, powerStatus=powerStatus, powerNumber=powerNumber, eventLogLevel=eventLogLevel, powerEntry=powerEntry, eventLogEntry=eventLogEntry, tempEncId=tempEncId, tempTable=tempTable, tempStatus=tempStatus, tempEncPos=tempEncPos, poolEntry=poolEntry, eventLogDescr=eventLogDescr, fanStatus=fanStatus, physDiskIndex=physDiskIndex, fanEncPos=fanEncPos, tempEntry=tempEntry, physDiskWWN=physDiskWWN, physDiskEnc=physDiskEnc, eventLogNumEntries=eventLogNumEntries, eventLogTable=eventLogTable, fanTable=fanTable, eventLogTrapLevel=eventLogTrapLevel, physDiskSlot=physDiskSlot, physicalDiskEntry=physicalDiskEntry, DisplayString=DisplayString, powerTable=powerTable, systemName=systemName, powerEncPos=powerEncPos, powerEncId=powerEncId)
