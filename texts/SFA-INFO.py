...
# Produced by pysmi-1.1.8 at Fri Jan  7 17:00:45 2022
...
Integer32, ModuleIdentity, iso, Bits, NotificationType, ObjectIdentity, Counter64, IpAddress, enterprises, Unsigned32, MibIdentifier, Counter32, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "iso", "Bits", "NotificationType", "ObjectIdentity", "Counter64", "IpAddress", "enterprises", "Unsigned32", "MibIdentifier", "Counter32", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", fanEncId=fanEncId, eventLog=eventLog, powerStatus=powerStatus, physicalDiskTable=physicalDiskTable, physDiskEnc=physDiskEnc, poolTable=poolTable, physDiskPoolId=physDiskPoolId, eventLogTable=eventLogTable, eventLogTrapLevel=eventLogTrapLevel, powerEncPos=powerEncPos, fanTable=fanTable, eventLogEntry=eventLogEntry, tempStatus=tempStatus, fanIndex=fanIndex, tempTable=tempTable, unit=unit, powerEncId=powerEncId, physDiskIndex=physDiskIndex, DisplayString=DisplayString, eventLogDescr=eventLogDescr, tempEntry=tempEntry, poolEntry=poolEntry, powerNumber=powerNumber, physDiskState=physDiskState, systemName=systemName, fanNumber=fanNumber, fanEncPos=fanEncPos, poolNumDisks=poolNumDisks, poolNumber=poolNumber, eventLogLevel=eventLogLevel, poolType=poolType, tempEncPos=tempEncPos, powerIndex=powerIndex, tempIndex=tempIndex, physDiskSlot=physDiskSlot, physDiskId=physDiskId, eventLogNumEntries=eventLogNumEntries, fanEntry=fanEntry, tempNumber=tempNumber, eventLogIndex=eventLogIndex, powerEntry=powerEntry, tempEncId=tempEncId, physDiskWWN=physDiskWWN, datadirect=datadirect, poolIndex=poolIndex, poolId=poolId, physicalDiskEntry=physicalDiskEntry, fanStatus=fanStatus, powerTable=powerTable)
