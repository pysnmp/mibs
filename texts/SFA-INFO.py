...
ModuleIdentity, ObjectIdentity, enterprises, Integer32, MibIdentifier, iso, Counter32, Gauge32, Unsigned32, IpAddress, TimeTicks, Counter64, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "enterprises", "Integer32", "MibIdentifier", "iso", "Counter32", "Gauge32", "Unsigned32", "IpAddress", "TimeTicks", "Counter64", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", tempEntry=tempEntry, poolId=poolId, tempTable=tempTable, eventLogIndex=eventLogIndex, poolNumber=poolNumber, tempNumber=tempNumber, physDiskIndex=physDiskIndex, physDiskSlot=physDiskSlot, powerEncPos=powerEncPos, systemName=systemName, fanNumber=fanNumber, fanEntry=fanEntry, powerIndex=powerIndex, DisplayString=DisplayString, powerNumber=powerNumber, eventLogTrapLevel=eventLogTrapLevel, physDiskEnc=physDiskEnc, fanEncId=fanEncId, fanIndex=fanIndex, tempIndex=tempIndex, fanStatus=fanStatus, poolEntry=poolEntry, fanTable=fanTable, poolIndex=poolIndex, poolTable=poolTable, unit=unit, physDiskId=physDiskId, poolType=poolType, tempEncId=tempEncId, physDiskPoolId=physDiskPoolId, eventLogEntry=eventLogEntry, physDiskWWN=physDiskWWN, datadirect=datadirect, eventLog=eventLog, tempEncPos=tempEncPos, eventLogDescr=eventLogDescr, powerEncId=powerEncId, powerEntry=powerEntry, eventLogLevel=eventLogLevel, physicalDiskEntry=physicalDiskEntry, tempStatus=tempStatus, powerTable=powerTable, powerStatus=powerStatus, fanEncPos=fanEncPos, poolNumDisks=poolNumDisks, physDiskState=physDiskState, eventLogTable=eventLogTable, eventLogNumEntries=eventLogNumEntries, physicalDiskTable=physicalDiskTable)
