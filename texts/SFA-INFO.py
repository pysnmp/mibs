...
# Produced by pysmi-1.1.12 at Mon Jun  3 10:55:29 2024
...
mibBuilder.exportSymbols("SFA-INFO", powerNumber=powerNumber, poolIndex=poolIndex, physDiskState=physDiskState, eventLogTrapLevel=eventLogTrapLevel, poolTable=poolTable, unit=unit, tempEncPos=tempEncPos, eventLogIndex=eventLogIndex, powerEntry=powerEntry, eventLogNumEntries=eventLogNumEntries, eventLogTable=eventLogTable, physicalDiskEntry=physicalDiskEntry, tempTable=tempTable, physDiskIndex=physDiskIndex, powerEncPos=powerEncPos, eventLogDescr=eventLogDescr, eventLogLevel=eventLogLevel, physDiskEnc=physDiskEnc, physicalDiskTable=physicalDiskTable, poolNumDisks=poolNumDisks, fanEntry=fanEntry, powerIndex=powerIndex, tempStatus=tempStatus, poolNumber=poolNumber, datadirect=datadirect, fanNumber=fanNumber, physDiskPoolId=physDiskPoolId, powerEncId=powerEncId, powerStatus=powerStatus, fanEncId=fanEncId, tempIndex=tempIndex, fanIndex=fanIndex, fanEncPos=fanEncPos, physDiskWWN=physDiskWWN, DisplayString=DisplayString, systemName=systemName, eventLog=eventLog, tempNumber=tempNumber, powerTable=powerTable, poolEntry=poolEntry, poolId=poolId, poolType=poolType, fanStatus=fanStatus, fanTable=fanTable, tempEntry=tempEntry, eventLogEntry=eventLogEntry, physDiskSlot=physDiskSlot, tempEncId=tempEncId, physDiskId=physDiskId)
