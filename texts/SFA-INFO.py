...
mibBuilder.exportSymbols("SFA-INFO", physDiskEnc=physDiskEnc, fanTable=fanTable, eventLogDescr=eventLogDescr, fanEntry=fanEntry, physDiskWWN=physDiskWWN, poolId=poolId, unit=unit, eventLogTable=eventLogTable, powerIndex=powerIndex, fanIndex=fanIndex, physDiskIndex=physDiskIndex, powerEntry=powerEntry, tempStatus=tempStatus, eventLogIndex=eventLogIndex, poolTable=poolTable, DisplayString=DisplayString, powerEncPos=powerEncPos, fanEncPos=fanEncPos, fanStatus=fanStatus, datadirect=datadirect, tempEncPos=tempEncPos, tempTable=tempTable, poolEntry=poolEntry, tempEntry=tempEntry, eventLog=eventLog, powerStatus=powerStatus, tempNumber=tempNumber, systemName=systemName, physicalDiskTable=physicalDiskTable, powerEncId=powerEncId, eventLogNumEntries=eventLogNumEntries, tempIndex=tempIndex, physicalDiskEntry=physicalDiskEntry, eventLogLevel=eventLogLevel, powerNumber=powerNumber, poolIndex=poolIndex, physDiskSlot=physDiskSlot, fanNumber=fanNumber, physDiskPoolId=physDiskPoolId, eventLogEntry=eventLogEntry, poolType=poolType, poolNumber=poolNumber, eventLogTrapLevel=eventLogTrapLevel, poolNumDisks=poolNumDisks, powerTable=powerTable, physDiskId=physDiskId, physDiskState=physDiskState, tempEncId=tempEncId, fanEncId=fanEncId)
