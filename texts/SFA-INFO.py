...
# Produced by pysmi-1.1.12 at Tue May 28 13:07:24 2024
...
IpAddress, Counter64, Unsigned32, Bits, Integer32, Counter32, TimeTicks, Gauge32, iso, ObjectIdentity, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "Unsigned32", "Bits", "Integer32", "Counter32", "TimeTicks", "Gauge32", "iso", "ObjectIdentity", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogTable=eventLogTable, powerNumber=powerNumber, poolType=poolType, physicalDiskTable=physicalDiskTable, physDiskId=physDiskId, datadirect=datadirect, physDiskWWN=physDiskWWN, tempNumber=tempNumber, tempTable=tempTable, tempEncId=tempEncId, tempStatus=tempStatus, fanNumber=fanNumber, eventLogLevel=eventLogLevel, tempEntry=tempEntry, eventLogIndex=eventLogIndex, DisplayString=DisplayString, physicalDiskEntry=physicalDiskEntry, powerStatus=powerStatus, eventLogTrapLevel=eventLogTrapLevel, powerTable=powerTable, tempEncPos=tempEncPos, poolId=poolId, physDiskIndex=physDiskIndex, poolEntry=poolEntry, unit=unit, fanStatus=fanStatus, physDiskState=physDiskState, tempIndex=tempIndex, fanEncPos=fanEncPos, powerEntry=powerEntry, poolTable=poolTable, poolIndex=poolIndex, physDiskEnc=physDiskEnc, fanIndex=fanIndex, poolNumber=poolNumber, eventLogNumEntries=eventLogNumEntries, eventLogDescr=eventLogDescr, eventLog=eventLog, fanEntry=fanEntry, systemName=systemName, fanTable=fanTable, powerEncPos=powerEncPos, powerIndex=powerIndex, physDiskSlot=physDiskSlot, fanEncId=fanEncId, poolNumDisks=poolNumDisks, eventLogEntry=eventLogEntry, physDiskPoolId=physDiskPoolId, powerEncId=powerEncId)
