...
# Produced by pysmi-1.1.8 at Wed Oct 11 10:03:53 2023
...
Unsigned32, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, NotificationType, Counter32, Gauge32, IpAddress, enterprises, ObjectIdentity, ModuleIdentity, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "NotificationType", "Counter32", "Gauge32", "IpAddress", "enterprises", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("SFA-INFO", poolEntry=poolEntry, DisplayString=DisplayString, physDiskPoolId=physDiskPoolId, tempIndex=tempIndex, tempStatus=tempStatus, eventLogTable=eventLogTable, powerEncId=powerEncId, fanStatus=fanStatus, eventLogNumEntries=eventLogNumEntries, poolTable=poolTable, fanTable=fanTable, datadirect=datadirect, physDiskIndex=physDiskIndex, powerEncPos=powerEncPos, fanNumber=fanNumber, unit=unit, powerEntry=powerEntry, eventLogDescr=eventLogDescr, eventLog=eventLog, eventLogIndex=eventLogIndex, physicalDiskEntry=physicalDiskEntry, powerStatus=powerStatus, eventLogTrapLevel=eventLogTrapLevel, tempEncId=tempEncId, tempNumber=tempNumber, fanEntry=fanEntry, fanEncPos=fanEncPos, fanEncId=fanEncId, fanIndex=fanIndex, systemName=systemName, poolNumber=poolNumber, poolType=poolType, powerIndex=powerIndex, tempEncPos=tempEncPos, physDiskState=physDiskState, eventLogLevel=eventLogLevel, tempTable=tempTable, physicalDiskTable=physicalDiskTable, poolId=poolId, tempEntry=tempEntry, physDiskWWN=physDiskWWN, powerNumber=powerNumber, powerTable=powerTable, eventLogEntry=eventLogEntry, physDiskSlot=physDiskSlot, physDiskId=physDiskId, physDiskEnc=physDiskEnc, poolIndex=poolIndex, poolNumDisks=poolNumDisks)
