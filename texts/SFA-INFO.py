...
# Produced by pysmi-1.1.8 at Mon Jan  9 09:50:31 2023
...
NotificationType, Counter32, Bits, ObjectIdentity, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, iso, enterprises, Gauge32, Integer32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Bits", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "iso", "enterprises", "Gauge32", "Integer32", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("SFA-INFO", powerStatus=powerStatus, DisplayString=DisplayString, fanIndex=fanIndex, physDiskState=physDiskState, fanEncId=fanEncId, powerEncId=powerEncId, physDiskWWN=physDiskWWN, eventLogTable=eventLogTable, physDiskId=physDiskId, eventLogLevel=eventLogLevel, poolEntry=poolEntry, fanNumber=fanNumber, physicalDiskEntry=physicalDiskEntry, physDiskPoolId=physDiskPoolId, eventLogDescr=eventLogDescr, fanTable=fanTable, tempStatus=tempStatus, poolNumDisks=poolNumDisks, systemName=systemName, powerTable=powerTable, tempNumber=tempNumber, datadirect=datadirect, eventLogIndex=eventLogIndex, eventLogEntry=eventLogEntry, poolIndex=poolIndex, tempEncId=tempEncId, tempEncPos=tempEncPos, poolTable=poolTable, powerEntry=powerEntry, eventLogTrapLevel=eventLogTrapLevel, tempTable=tempTable, tempIndex=tempIndex, physDiskIndex=physDiskIndex, fanEncPos=fanEncPos, poolNumber=poolNumber, unit=unit, powerNumber=powerNumber, powerIndex=powerIndex, eventLogNumEntries=eventLogNumEntries, physicalDiskTable=physicalDiskTable, tempEntry=tempEntry, poolId=poolId, poolType=poolType, fanEntry=fanEntry, fanStatus=fanStatus, physDiskSlot=physDiskSlot, powerEncPos=powerEncPos, eventLog=eventLog, physDiskEnc=physDiskEnc)
