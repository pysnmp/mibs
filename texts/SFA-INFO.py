...
ModuleIdentity, Integer32, iso, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, TimeTicks, IpAddress, MibIdentifier, Counter32, enterprises, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "iso", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "TimeTicks", "IpAddress", "MibIdentifier", "Counter32", "enterprises", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("SFA-INFO", fanEntry=fanEntry, poolNumber=poolNumber, eventLogDescr=eventLogDescr, powerEncPos=powerEncPos, datadirect=datadirect, tempEncId=tempEncId, fanTable=fanTable, poolTable=poolTable, eventLogEntry=eventLogEntry, tempEntry=tempEntry, poolType=poolType, eventLogIndex=eventLogIndex, DisplayString=DisplayString, powerEncId=powerEncId, systemName=systemName, tempEncPos=tempEncPos, eventLogLevel=eventLogLevel, physicalDiskTable=physicalDiskTable, eventLog=eventLog, tempIndex=tempIndex, poolNumDisks=poolNumDisks, physicalDiskEntry=physicalDiskEntry, fanEncId=fanEncId, fanIndex=fanIndex, eventLogNumEntries=eventLogNumEntries, fanStatus=fanStatus, fanEncPos=fanEncPos, physDiskEnc=physDiskEnc, poolEntry=poolEntry, fanNumber=fanNumber, eventLogTrapLevel=eventLogTrapLevel, eventLogTable=eventLogTable, physDiskSlot=physDiskSlot, physDiskState=physDiskState, powerNumber=powerNumber, physDiskId=physDiskId, tempTable=tempTable, powerEntry=powerEntry, physDiskIndex=physDiskIndex, physDiskWWN=physDiskWWN, tempNumber=tempNumber, unit=unit, powerIndex=powerIndex, tempStatus=tempStatus, poolIndex=poolIndex, poolId=poolId, powerStatus=powerStatus, powerTable=powerTable, physDiskPoolId=physDiskPoolId)
