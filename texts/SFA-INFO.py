...
TimeTicks, ModuleIdentity, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, MibIdentifier, Counter64, Counter32, Unsigned32, iso, ObjectIdentity, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "MibIdentifier", "Counter64", "Counter32", "Unsigned32", "iso", "ObjectIdentity", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("SFA-INFO", unit=unit, tempEncId=tempEncId, eventLogDescr=eventLogDescr, poolNumDisks=poolNumDisks, eventLogTrapLevel=eventLogTrapLevel, eventLogEntry=eventLogEntry, fanNumber=fanNumber, physicalDiskTable=physicalDiskTable, systemName=systemName, poolIndex=poolIndex, powerEncId=powerEncId, physDiskIndex=physDiskIndex, tempEncPos=tempEncPos, tempIndex=tempIndex, eventLogNumEntries=eventLogNumEntries, tempNumber=tempNumber, poolEntry=poolEntry, poolNumber=poolNumber, fanEncPos=fanEncPos, physDiskPoolId=physDiskPoolId, physDiskEnc=physDiskEnc, fanIndex=fanIndex, powerNumber=powerNumber, fanTable=fanTable, powerEntry=powerEntry, physDiskState=physDiskState, fanEncId=fanEncId, physicalDiskEntry=physicalDiskEntry, tempStatus=tempStatus, physDiskSlot=physDiskSlot, eventLog=eventLog, powerStatus=powerStatus, powerTable=powerTable, datadirect=datadirect, powerEncPos=powerEncPos, eventLogTable=eventLogTable, fanEntry=fanEntry, DisplayString=DisplayString, poolType=poolType, powerIndex=powerIndex, fanStatus=fanStatus, physDiskId=physDiskId, poolTable=poolTable, poolId=poolId, eventLogLevel=eventLogLevel, eventLogIndex=eventLogIndex, physDiskWWN=physDiskWWN, tempEntry=tempEntry, tempTable=tempTable)
