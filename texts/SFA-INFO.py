...
# Produced by pysmi-1.1.10 at Fri Oct 27 12:09:17 2023
...
ModuleIdentity, MibIdentifier, Bits, enterprises, Integer32, Unsigned32, Counter64, iso, IpAddress, NotificationType, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "Bits", "enterprises", "Integer32", "Unsigned32", "Counter64", "iso", "IpAddress", "NotificationType", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", powerEntry=powerEntry, eventLogLevel=eventLogLevel, fanTable=fanTable, tempEntry=tempEntry, powerNumber=powerNumber, physDiskPoolId=physDiskPoolId, powerTable=powerTable, fanStatus=fanStatus, physDiskId=physDiskId, tempNumber=tempNumber, eventLogTrapLevel=eventLogTrapLevel, fanIndex=fanIndex, physicalDiskTable=physicalDiskTable, physDiskIndex=physDiskIndex, poolId=poolId, poolNumDisks=poolNumDisks, physDiskState=physDiskState, eventLog=eventLog, fanEncPos=fanEncPos, poolNumber=poolNumber, poolType=poolType, fanNumber=fanNumber, physDiskWWN=physDiskWWN, tempStatus=tempStatus, DisplayString=DisplayString, poolTable=poolTable, unit=unit, physDiskSlot=physDiskSlot, powerEncId=powerEncId, eventLogTable=eventLogTable, poolIndex=poolIndex, powerStatus=powerStatus, physicalDiskEntry=physicalDiskEntry, eventLogDescr=eventLogDescr, systemName=systemName, tempEncId=tempEncId, fanEntry=fanEntry, tempIndex=tempIndex, physDiskEnc=physDiskEnc, eventLogNumEntries=eventLogNumEntries, tempTable=tempTable, powerIndex=powerIndex, eventLogEntry=eventLogEntry, datadirect=datadirect, poolEntry=poolEntry, fanEncId=fanEncId, eventLogIndex=eventLogIndex, powerEncPos=powerEncPos, tempEncPos=tempEncPos)
