...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:38:51 2023
...
Counter32, Counter64, Bits, iso, ObjectIdentity, Unsigned32, Gauge32, ModuleIdentity, NotificationType, Integer32, IpAddress, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Bits", "iso", "ObjectIdentity", "Unsigned32", "Gauge32", "ModuleIdentity", "NotificationType", "Integer32", "IpAddress", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("SFA-INFO", physicalDiskTable=physicalDiskTable, poolType=poolType, tempEncId=tempEncId, eventLogTable=eventLogTable, tempTable=tempTable, physDiskIndex=physDiskIndex, poolNumDisks=poolNumDisks, tempNumber=tempNumber, physDiskPoolId=physDiskPoolId, eventLogTrapLevel=eventLogTrapLevel, powerEncId=powerEncId, eventLogIndex=eventLogIndex, datadirect=datadirect, powerNumber=powerNumber, fanStatus=fanStatus, physDiskSlot=physDiskSlot, eventLogLevel=eventLogLevel, unit=unit, eventLog=eventLog, poolNumber=poolNumber, powerTable=powerTable, tempIndex=tempIndex, tempStatus=tempStatus, physDiskState=physDiskState, physicalDiskEntry=physicalDiskEntry, powerIndex=powerIndex, eventLogEntry=eventLogEntry, tempEncPos=tempEncPos, powerEntry=powerEntry, physDiskId=physDiskId, fanIndex=fanIndex, fanEncId=fanEncId, physDiskEnc=physDiskEnc, physDiskWWN=physDiskWWN, tempEntry=tempEntry, poolEntry=poolEntry, powerStatus=powerStatus, DisplayString=DisplayString, poolIndex=poolIndex, fanEncPos=fanEncPos, eventLogNumEntries=eventLogNumEntries, fanTable=fanTable, systemName=systemName, fanEntry=fanEntry, fanNumber=fanNumber, poolTable=poolTable, powerEncPos=powerEncPos, poolId=poolId, eventLogDescr=eventLogDescr)
