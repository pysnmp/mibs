...
# Produced by pysmi-1.1.12 at Wed Oct  9 02:18:05 2024
...
enterprises, NotificationType, Unsigned32, Counter32, ModuleIdentity, ObjectIdentity, MibIdentifier, Gauge32, Integer32, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Unsigned32", "Counter32", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Gauge32", "Integer32", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", poolEntry=poolEntry, tempEncId=tempEncId, poolType=poolType, physicalDiskTable=physicalDiskTable, unit=unit, tempTable=tempTable, tempNumber=tempNumber, powerEntry=powerEntry, DisplayString=DisplayString, physDiskPoolId=physDiskPoolId, physDiskState=physDiskState, fanNumber=fanNumber, physDiskIndex=physDiskIndex, eventLog=eventLog, fanEncId=fanEncId, tempStatus=tempStatus, powerNumber=powerNumber, powerEncId=powerEncId, eventLogNumEntries=eventLogNumEntries, eventLogTable=eventLogTable, fanEntry=fanEntry, poolTable=poolTable, poolIndex=poolIndex, physicalDiskEntry=physicalDiskEntry, tempIndex=tempIndex, poolNumber=poolNumber, eventLogDescr=eventLogDescr, poolId=poolId, eventLogTrapLevel=eventLogTrapLevel, fanEncPos=fanEncPos, tempEncPos=tempEncPos, powerStatus=powerStatus, powerEncPos=powerEncPos, eventLogLevel=eventLogLevel, systemName=systemName, powerTable=powerTable, tempEntry=tempEntry, physDiskWWN=physDiskWWN, fanIndex=fanIndex, physDiskEnc=physDiskEnc, eventLogEntry=eventLogEntry, fanStatus=fanStatus, poolNumDisks=poolNumDisks, physDiskId=physDiskId, datadirect=datadirect, eventLogIndex=eventLogIndex, physDiskSlot=physDiskSlot, fanTable=fanTable, powerIndex=powerIndex)
