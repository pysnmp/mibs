...
# Produced by pysmi-1.1.8 at Mon Jan  9 11:01:42 2023
...
iso, Gauge32, Counter32, ModuleIdentity, enterprises, Bits, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, MibIdentifier, IpAddress, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Counter32", "ModuleIdentity", "enterprises", "Bits", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "MibIdentifier", "IpAddress", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", tempEncId=tempEncId, eventLogNumEntries=eventLogNumEntries, datadirect=datadirect, eventLogEntry=eventLogEntry, tempNumber=tempNumber, powerIndex=powerIndex, eventLogDescr=eventLogDescr, powerEncId=powerEncId, poolTable=poolTable, physDiskEnc=physDiskEnc, tempEncPos=tempEncPos, eventLog=eventLog, physDiskWWN=physDiskWWN, physicalDiskTable=physicalDiskTable, systemName=systemName, tempIndex=tempIndex, poolId=poolId, fanEncPos=fanEncPos, poolNumDisks=poolNumDisks, eventLogTable=eventLogTable, DisplayString=DisplayString, fanNumber=fanNumber, tempStatus=tempStatus, powerEncPos=powerEncPos, physDiskState=physDiskState, fanTable=fanTable, physDiskId=physDiskId, physDiskSlot=physDiskSlot, powerNumber=powerNumber, physicalDiskEntry=physicalDiskEntry, tempEntry=tempEntry, fanStatus=fanStatus, eventLogTrapLevel=eventLogTrapLevel, tempTable=tempTable, physDiskPoolId=physDiskPoolId, poolEntry=poolEntry, physDiskIndex=physDiskIndex, powerTable=powerTable, eventLogLevel=eventLogLevel, powerStatus=powerStatus, eventLogIndex=eventLogIndex, unit=unit, powerEntry=powerEntry, poolNumber=poolNumber, poolIndex=poolIndex, fanEncId=fanEncId, fanEntry=fanEntry, fanIndex=fanIndex, poolType=poolType)
