...
# Produced by pysmi-1.1.8 at Mon Jan 17 14:55:09 2022
...
Counter32, NotificationType, iso, ModuleIdentity, enterprises, Counter64, MibIdentifier, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Unsigned32, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "iso", "ModuleIdentity", "enterprises", "Counter64", "MibIdentifier", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Unsigned32", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogLevel=eventLogLevel, physDiskId=physDiskId, fanStatus=fanStatus, poolId=poolId, physDiskWWN=physDiskWWN, powerEntry=powerEntry, poolType=poolType, tempNumber=tempNumber, tempTable=tempTable, systemName=systemName, eventLogDescr=eventLogDescr, fanTable=fanTable, DisplayString=DisplayString, poolNumber=poolNumber, physDiskIndex=physDiskIndex, physDiskState=physDiskState, powerIndex=powerIndex, eventLogEntry=eventLogEntry, poolTable=poolTable, powerStatus=powerStatus, unit=unit, physicalDiskTable=physicalDiskTable, fanEncPos=fanEncPos, eventLogTrapLevel=eventLogTrapLevel, powerNumber=powerNumber, tempStatus=tempStatus, powerEncId=powerEncId, tempEntry=tempEntry, tempEncId=tempEncId, poolNumDisks=poolNumDisks, physDiskSlot=physDiskSlot, tempEncPos=tempEncPos, eventLog=eventLog, datadirect=datadirect, powerEncPos=powerEncPos, physicalDiskEntry=physicalDiskEntry, powerTable=powerTable, physDiskEnc=physDiskEnc, physDiskPoolId=physDiskPoolId, fanNumber=fanNumber, eventLogNumEntries=eventLogNumEntries, eventLogTable=eventLogTable, eventLogIndex=eventLogIndex, poolEntry=poolEntry, tempIndex=tempIndex, fanEntry=fanEntry, fanEncId=fanEncId, poolIndex=poolIndex, fanIndex=fanIndex)
