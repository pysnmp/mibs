...
# Produced by pysmi-1.1.8 at Mon Jan 17 17:51:31 2022
...
NotificationType, Gauge32, TimeTicks, iso, Counter32, ModuleIdentity, IpAddress, ObjectIdentity, Integer32, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "TimeTicks", "iso", "Counter32", "ModuleIdentity", "IpAddress", "ObjectIdentity", "Integer32", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("SFA-INFO", tempIndex=tempIndex, powerTable=powerTable, poolEntry=poolEntry, DisplayString=DisplayString, eventLogTable=eventLogTable, systemName=systemName, physicalDiskEntry=physicalDiskEntry, poolId=poolId, eventLogEntry=eventLogEntry, powerNumber=powerNumber, physicalDiskTable=physicalDiskTable, physDiskPoolId=physDiskPoolId, fanIndex=fanIndex, fanStatus=fanStatus, powerEntry=powerEntry, poolIndex=poolIndex, eventLogTrapLevel=eventLogTrapLevel, poolTable=poolTable, physDiskEnc=physDiskEnc, powerEncId=powerEncId, powerEncPos=powerEncPos, physDiskIndex=physDiskIndex, fanEncPos=fanEncPos, eventLogNumEntries=eventLogNumEntries, poolNumDisks=poolNumDisks, eventLog=eventLog, tempEncPos=tempEncPos, poolNumber=poolNumber, powerStatus=powerStatus, fanEncId=fanEncId, unit=unit, tempStatus=tempStatus, tempNumber=tempNumber, poolType=poolType, tempEncId=tempEncId, physDiskWWN=physDiskWWN, physDiskId=physDiskId, fanEntry=fanEntry, eventLogIndex=eventLogIndex, tempTable=tempTable, physDiskSlot=physDiskSlot, physDiskState=physDiskState, eventLogDescr=eventLogDescr, eventLogLevel=eventLogLevel, fanTable=fanTable, fanNumber=fanNumber, tempEntry=tempEntry, powerIndex=powerIndex, datadirect=datadirect)
