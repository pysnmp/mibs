...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, Unsigned32, Bits, IpAddress, iso, Gauge32, NotificationType, TimeTicks, MibIdentifier, ModuleIdentity, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "Unsigned32", "Bits", "IpAddress", "iso", "Gauge32", "NotificationType", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogNumEntries=eventLogNumEntries, tempNumber=tempNumber, powerEncPos=powerEncPos, tempEntry=tempEntry, physDiskState=physDiskState, datadirect=datadirect, powerStatus=powerStatus, fanEncId=fanEncId, powerNumber=powerNumber, physDiskIndex=physDiskIndex, fanEntry=fanEntry, physDiskPoolId=physDiskPoolId, powerTable=powerTable, poolEntry=poolEntry, poolIndex=poolIndex, poolTable=poolTable, physDiskId=physDiskId, fanStatus=fanStatus, powerEntry=powerEntry, eventLogIndex=eventLogIndex, fanTable=fanTable, physDiskEnc=physDiskEnc, systemName=systemName, eventLog=eventLog, powerEncId=powerEncId, eventLogTrapLevel=eventLogTrapLevel, physicalDiskTable=physicalDiskTable, fanNumber=fanNumber, poolId=poolId, eventLogLevel=eventLogLevel, tempIndex=tempIndex, powerIndex=powerIndex, tempTable=tempTable, physDiskSlot=physDiskSlot, eventLogDescr=eventLogDescr, physDiskWWN=physDiskWWN, fanIndex=fanIndex, physicalDiskEntry=physicalDiskEntry, DisplayString=DisplayString, eventLogTable=eventLogTable, tempEncId=tempEncId, poolType=poolType, unit=unit, poolNumDisks=poolNumDisks, poolNumber=poolNumber, eventLogEntry=eventLogEntry, tempEncPos=tempEncPos, fanEncPos=fanEncPos, tempStatus=tempStatus)
