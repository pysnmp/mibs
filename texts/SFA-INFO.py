...
TimeTicks, enterprises, NotificationType, ObjectIdentity, Bits, IpAddress, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, Unsigned32, iso, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "NotificationType", "ObjectIdentity", "Bits", "IpAddress", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "Unsigned32", "iso", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", poolId=poolId, systemName=systemName, powerTable=powerTable, powerStatus=powerStatus, physicalDiskTable=physicalDiskTable, eventLogNumEntries=eventLogNumEntries, eventLogIndex=eventLogIndex, physDiskPoolId=physDiskPoolId, eventLogEntry=eventLogEntry, physDiskSlot=physDiskSlot, physDiskState=physDiskState, fanTable=fanTable, datadirect=datadirect, eventLogTrapLevel=eventLogTrapLevel, unit=unit, tempEncPos=tempEncPos, fanStatus=fanStatus, poolType=poolType, tempTable=tempTable, tempStatus=tempStatus, eventLogDescr=eventLogDescr, tempNumber=tempNumber, physicalDiskEntry=physicalDiskEntry, eventLogLevel=eventLogLevel, physDiskIndex=physDiskIndex, powerNumber=powerNumber, fanEncId=fanEncId, physDiskEnc=physDiskEnc, poolNumDisks=poolNumDisks, DisplayString=DisplayString, eventLogTable=eventLogTable, powerEncPos=powerEncPos, poolNumber=poolNumber, fanEntry=fanEntry, physDiskWWN=physDiskWWN, tempIndex=tempIndex, eventLog=eventLog, fanEncPos=fanEncPos, poolIndex=poolIndex, fanIndex=fanIndex, poolEntry=poolEntry, powerIndex=powerIndex, tempEntry=tempEntry, physDiskId=physDiskId, fanNumber=fanNumber, tempEncId=tempEncId, powerEncId=powerEncId, powerEntry=powerEntry, poolTable=poolTable)
