...
# Produced by pysmi-1.1.12 at Wed May 29 10:20:41 2024
...
Counter64, iso, Counter32, NotificationType, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, TimeTicks, ModuleIdentity, MibIdentifier, IpAddress, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Counter32", "NotificationType", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "TimeTicks", "ModuleIdentity", "MibIdentifier", "IpAddress", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", powerTable=powerTable, tempTable=tempTable, physDiskId=physDiskId, physicalDiskEntry=physicalDiskEntry, fanStatus=fanStatus, powerEntry=powerEntry, poolEntry=poolEntry, physDiskPoolId=physDiskPoolId, eventLogDescr=eventLogDescr, tempEntry=tempEntry, poolTable=poolTable, powerIndex=powerIndex, poolIndex=poolIndex, eventLogEntry=eventLogEntry, physicalDiskTable=physicalDiskTable, eventLogTable=eventLogTable, physDiskState=physDiskState, powerNumber=powerNumber, physDiskWWN=physDiskWWN, poolNumber=poolNumber, fanEncPos=fanEncPos, tempEncPos=tempEncPos, datadirect=datadirect, fanIndex=fanIndex, fanNumber=fanNumber, eventLog=eventLog, poolType=poolType, unit=unit, tempStatus=tempStatus, physDiskIndex=physDiskIndex, systemName=systemName, powerEncId=powerEncId, eventLogNumEntries=eventLogNumEntries, eventLogLevel=eventLogLevel, tempIndex=tempIndex, fanEntry=fanEntry, fanEncId=fanEncId, powerEncPos=powerEncPos, tempNumber=tempNumber, fanTable=fanTable, eventLogIndex=eventLogIndex, eventLogTrapLevel=eventLogTrapLevel, poolNumDisks=poolNumDisks, powerStatus=powerStatus, physDiskSlot=physDiskSlot, poolId=poolId, physDiskEnc=physDiskEnc, tempEncId=tempEncId, DisplayString=DisplayString)
