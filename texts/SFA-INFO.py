...
# Produced by pysmi-1.1.12 at Tue May 28 12:33:17 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, Counter32, Integer32, ObjectIdentity, iso, Gauge32, MibIdentifier, TimeTicks, enterprises, ModuleIdentity, IpAddress, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "Counter32", "Integer32", "ObjectIdentity", "iso", "Gauge32", "MibIdentifier", "TimeTicks", "enterprises", "ModuleIdentity", "IpAddress", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskWWN=physDiskWWN, DisplayString=DisplayString, eventLog=eventLog, poolType=poolType, fanNumber=fanNumber, eventLogTrapLevel=eventLogTrapLevel, physicalDiskEntry=physicalDiskEntry, tempIndex=tempIndex, physicalDiskTable=physicalDiskTable, powerTable=powerTable, physDiskSlot=physDiskSlot, tempEncId=tempEncId, datadirect=datadirect, fanEncPos=fanEncPos, poolNumDisks=poolNumDisks, eventLogDescr=eventLogDescr, fanEntry=fanEntry, physDiskState=physDiskState, tempStatus=tempStatus, physDiskEnc=physDiskEnc, systemName=systemName, powerNumber=powerNumber, physDiskId=physDiskId, fanEncId=fanEncId, tempEncPos=tempEncPos, powerIndex=powerIndex, powerStatus=powerStatus, poolTable=poolTable, tempNumber=tempNumber, poolId=poolId, eventLogNumEntries=eventLogNumEntries, poolNumber=poolNumber, fanTable=fanTable, poolEntry=poolEntry, physDiskPoolId=physDiskPoolId, poolIndex=poolIndex, physDiskIndex=physDiskIndex, powerEntry=powerEntry, fanIndex=fanIndex, tempTable=tempTable, eventLogIndex=eventLogIndex, powerEncPos=powerEncPos, eventLogLevel=eventLogLevel, eventLogTable=eventLogTable, eventLogEntry=eventLogEntry, tempEntry=tempEntry, powerEncId=powerEncId, unit=unit, fanStatus=fanStatus)
