...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:54:52 2024
...
MibIdentifier, iso, Bits, TimeTicks, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, Gauge32, ModuleIdentity, ObjectIdentity, IpAddress, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Bits", "TimeTicks", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "Gauge32", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("SFA-INFO", powerEncId=powerEncId, powerNumber=powerNumber, eventLogLevel=eventLogLevel, DisplayString=DisplayString, poolId=poolId, physDiskEnc=physDiskEnc, physicalDiskTable=physicalDiskTable, poolNumber=poolNumber, tempEntry=tempEntry, eventLogTrapLevel=eventLogTrapLevel, tempEncId=tempEncId, poolTable=poolTable, poolType=poolType, physDiskSlot=physDiskSlot, fanEncId=fanEncId, tempStatus=tempStatus, poolEntry=poolEntry, tempEncPos=tempEncPos, physDiskState=physDiskState, poolIndex=poolIndex, fanStatus=fanStatus, tempNumber=tempNumber, powerEncPos=powerEncPos, powerStatus=powerStatus, powerTable=powerTable, eventLogIndex=eventLogIndex, fanEncPos=fanEncPos, eventLogTable=eventLogTable, eventLogEntry=eventLogEntry, powerIndex=powerIndex, systemName=systemName, physicalDiskEntry=physicalDiskEntry, physDiskWWN=physDiskWWN, fanNumber=fanNumber, powerEntry=powerEntry, eventLog=eventLog, physDiskPoolId=physDiskPoolId, fanIndex=fanIndex, tempIndex=tempIndex, physDiskIndex=physDiskIndex, fanTable=fanTable, tempTable=tempTable, datadirect=datadirect, eventLogDescr=eventLogDescr, unit=unit, fanEntry=fanEntry, eventLogNumEntries=eventLogNumEntries, poolNumDisks=poolNumDisks, physDiskId=physDiskId)
