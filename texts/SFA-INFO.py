...
# Produced by pysmi-1.1.12 at Wed May 29 06:44:27 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, Bits, Integer32, NotificationType, ObjectIdentity, iso, Counter32, Gauge32, IpAddress, MibIdentifier, TimeTicks, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "Bits", "Integer32", "NotificationType", "ObjectIdentity", "iso", "Counter32", "Gauge32", "IpAddress", "MibIdentifier", "TimeTicks", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", powerEntry=powerEntry, physDiskPoolId=physDiskPoolId, poolNumber=poolNumber, physicalDiskEntry=physicalDiskEntry, physDiskState=physDiskState, tempNumber=tempNumber, powerIndex=powerIndex, physDiskWWN=physDiskWWN, physDiskIndex=physDiskIndex, eventLogLevel=eventLogLevel, poolId=poolId, physDiskEnc=physDiskEnc, tempStatus=tempStatus, DisplayString=DisplayString, tempEncId=tempEncId, systemName=systemName, physicalDiskTable=physicalDiskTable, fanEntry=fanEntry, poolEntry=poolEntry, poolIndex=poolIndex, powerStatus=powerStatus, fanEncId=fanEncId, fanStatus=fanStatus, poolTable=poolTable, eventLogNumEntries=eventLogNumEntries, powerTable=powerTable, powerEncPos=powerEncPos, physDiskId=physDiskId, eventLogDescr=eventLogDescr, fanIndex=fanIndex, physDiskSlot=physDiskSlot, powerEncId=powerEncId, powerNumber=powerNumber, eventLogIndex=eventLogIndex, eventLogTable=eventLogTable, eventLogEntry=eventLogEntry, tempEntry=tempEntry, poolType=poolType, eventLogTrapLevel=eventLogTrapLevel, tempIndex=tempIndex, unit=unit, eventLog=eventLog, datadirect=datadirect, fanNumber=fanNumber, fanTable=fanTable, fanEncPos=fanEncPos, tempTable=tempTable, poolNumDisks=poolNumDisks, tempEncPos=tempEncPos)
