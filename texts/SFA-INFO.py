...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:41:50 2021
...
Gauge32, ObjectIdentity, IpAddress, iso, Counter32, Unsigned32, Counter64, Integer32, TimeTicks, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "IpAddress", "iso", "Counter32", "Unsigned32", "Counter64", "Integer32", "TimeTicks", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "enterprises")
...
mibBuilder.exportSymbols("SFA-INFO", eventLog=eventLog, physDiskEnc=physDiskEnc, DisplayString=DisplayString, eventLogDescr=eventLogDescr, tempStatus=tempStatus, fanEntry=fanEntry, powerTable=powerTable, tempEncPos=tempEncPos, physicalDiskTable=physicalDiskTable, tempIndex=tempIndex, powerNumber=powerNumber, systemName=systemName, poolId=poolId, physDiskPoolId=physDiskPoolId, poolTable=poolTable, poolEntry=poolEntry, fanStatus=fanStatus, physDiskSlot=physDiskSlot, poolIndex=poolIndex, eventLogTrapLevel=eventLogTrapLevel, physDiskId=physDiskId, powerEncId=powerEncId, tempEncId=tempEncId, physDiskIndex=physDiskIndex, powerEntry=powerEntry, physDiskState=physDiskState, eventLogIndex=eventLogIndex, datadirect=datadirect, fanTable=fanTable, powerIndex=powerIndex, powerEncPos=powerEncPos, physicalDiskEntry=physicalDiskEntry, poolNumber=poolNumber, poolType=poolType, fanEncPos=fanEncPos, eventLogLevel=eventLogLevel, tempEntry=tempEntry, tempTable=tempTable, fanNumber=fanNumber, fanIndex=fanIndex, powerStatus=powerStatus, physDiskWWN=physDiskWWN, eventLogNumEntries=eventLogNumEntries, eventLogEntry=eventLogEntry, poolNumDisks=poolNumDisks, tempNumber=tempNumber, eventLogTable=eventLogTable, fanEncId=fanEncId, unit=unit)
