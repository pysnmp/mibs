...
MibIdentifier, Bits, TimeTicks, NotificationType, iso, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, IpAddress, Counter32, Integer32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "TimeTicks", "NotificationType", "iso", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "IpAddress", "Counter32", "Integer32", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("SFA-INFO", DisplayString=DisplayString, eventLogNumEntries=eventLogNumEntries, eventLog=eventLog, physDiskIndex=physDiskIndex, fanEntry=fanEntry, physDiskEnc=physDiskEnc, datadirect=datadirect, powerStatus=powerStatus, tempIndex=tempIndex, fanEncId=fanEncId, powerEncPos=powerEncPos, fanNumber=fanNumber, eventLogTable=eventLogTable, tempStatus=tempStatus, poolEntry=poolEntry, physicalDiskEntry=physicalDiskEntry, poolType=poolType, systemName=systemName, poolNumber=poolNumber, poolNumDisks=poolNumDisks, fanTable=fanTable, physDiskPoolId=physDiskPoolId, physDiskSlot=physDiskSlot, physDiskState=physDiskState, eventLogLevel=eventLogLevel, eventLogDescr=eventLogDescr, fanStatus=fanStatus, powerEncId=powerEncId, tempEncPos=tempEncPos, physDiskId=physDiskId, poolId=poolId, tempEntry=tempEntry, physicalDiskTable=physicalDiskTable, powerEntry=powerEntry, eventLogIndex=eventLogIndex, powerTable=powerTable, powerNumber=powerNumber, tempEncId=tempEncId, eventLogEntry=eventLogEntry, fanEncPos=fanEncPos, eventLogTrapLevel=eventLogTrapLevel, poolTable=poolTable, fanIndex=fanIndex, unit=unit, tempTable=tempTable, powerIndex=powerIndex, poolIndex=poolIndex, tempNumber=tempNumber, physDiskWWN=physDiskWWN)
