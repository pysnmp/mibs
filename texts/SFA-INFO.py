...
# Produced by pysmi-1.1.10 at Mon Oct 30 02:17:37 2023
...
Bits, ModuleIdentity, enterprises, Integer32, NotificationType, Counter64, Gauge32, ObjectIdentity, MibIdentifier, TimeTicks, iso, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "enterprises", "Integer32", "NotificationType", "Counter64", "Gauge32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "iso", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("SFA-INFO", poolTable=poolTable, fanNumber=fanNumber, fanIndex=fanIndex, powerTable=powerTable, poolNumDisks=poolNumDisks, physDiskIndex=physDiskIndex, physicalDiskEntry=physicalDiskEntry, eventLogIndex=eventLogIndex, eventLogNumEntries=eventLogNumEntries, powerEntry=powerEntry, eventLogTrapLevel=eventLogTrapLevel, eventLogLevel=eventLogLevel, tempEncId=tempEncId, physDiskEnc=physDiskEnc, fanEncPos=fanEncPos, powerStatus=powerStatus, tempEncPos=tempEncPos, fanStatus=fanStatus, eventLogEntry=eventLogEntry, eventLogDescr=eventLogDescr, tempEntry=tempEntry, physicalDiskTable=physicalDiskTable, datadirect=datadirect, physDiskWWN=physDiskWWN, physDiskState=physDiskState, DisplayString=DisplayString, poolIndex=poolIndex, poolEntry=poolEntry, physDiskPoolId=physDiskPoolId, eventLogTable=eventLogTable, fanEncId=fanEncId, poolType=poolType, tempIndex=tempIndex, fanEntry=fanEntry, systemName=systemName, unit=unit, powerEncPos=powerEncPos, physDiskSlot=physDiskSlot, fanTable=fanTable, powerIndex=powerIndex, tempStatus=tempStatus, poolNumber=poolNumber, tempTable=tempTable, powerNumber=powerNumber, powerEncId=powerEncId, poolId=poolId, physDiskId=physDiskId, tempNumber=tempNumber, eventLog=eventLog)
