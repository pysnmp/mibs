...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:37:47 2021
...
NotificationType, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Counter64, TimeTicks, Unsigned32, Counter32, IpAddress, iso, MibIdentifier, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Counter64", "TimeTicks", "Unsigned32", "Counter32", "IpAddress", "iso", "MibIdentifier", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", physicalDiskEntry=physicalDiskEntry, physDiskPoolId=physDiskPoolId, physDiskEnc=physDiskEnc, systemName=systemName, tempEncId=tempEncId, physDiskState=physDiskState, eventLogIndex=eventLogIndex, eventLogEntry=eventLogEntry, poolTable=poolTable, powerStatus=powerStatus, fanIndex=fanIndex, physicalDiskTable=physicalDiskTable, fanTable=fanTable, tempIndex=tempIndex, eventLogDescr=eventLogDescr, fanEncId=fanEncId, poolEntry=poolEntry, poolIndex=poolIndex, tempEncPos=tempEncPos, powerEncId=powerEncId, poolType=poolType, fanEncPos=fanEncPos, powerEntry=powerEntry, powerTable=powerTable, eventLogTrapLevel=eventLogTrapLevel, eventLog=eventLog, fanStatus=fanStatus, poolId=poolId, powerNumber=powerNumber, tempTable=tempTable, poolNumDisks=poolNumDisks, tempStatus=tempStatus, physDiskId=physDiskId, fanNumber=fanNumber, unit=unit, tempNumber=tempNumber, eventLogTable=eventLogTable, eventLogNumEntries=eventLogNumEntries, powerEncPos=powerEncPos, eventLogLevel=eventLogLevel, fanEntry=fanEntry, physDiskWWN=physDiskWWN, physDiskSlot=physDiskSlot, datadirect=datadirect, powerIndex=powerIndex, DisplayString=DisplayString, tempEntry=tempEntry, poolNumber=poolNumber, physDiskIndex=physDiskIndex)
