...
# Produced by pysmi-1.1.8 at Fri Jan  7 00:16:41 2022
...
ObjectIdentity, MibIdentifier, NotificationType, enterprises, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, Integer32, Unsigned32, Counter64, IpAddress, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "NotificationType", "enterprises", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "Integer32", "Unsigned32", "Counter64", "IpAddress", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", fanIndex=fanIndex, physDiskWWN=physDiskWWN, DisplayString=DisplayString, poolNumber=poolNumber, unit=unit, eventLogTable=eventLogTable, poolEntry=poolEntry, powerEncPos=powerEncPos, fanTable=fanTable, powerIndex=powerIndex, fanEncPos=fanEncPos, tempTable=tempTable, tempIndex=tempIndex, poolId=poolId, eventLogEntry=eventLogEntry, eventLogIndex=eventLogIndex, poolTable=poolTable, tempStatus=tempStatus, tempEntry=tempEntry, physDiskSlot=physDiskSlot, powerEncId=powerEncId, physDiskEnc=physDiskEnc, eventLogDescr=eventLogDescr, tempNumber=tempNumber, powerStatus=powerStatus, poolNumDisks=poolNumDisks, powerNumber=powerNumber, eventLog=eventLog, fanEntry=fanEntry, fanNumber=fanNumber, eventLogTrapLevel=eventLogTrapLevel, powerEntry=powerEntry, powerTable=powerTable, physDiskState=physDiskState, systemName=systemName, eventLogLevel=eventLogLevel, physicalDiskTable=physicalDiskTable, fanEncId=fanEncId, fanStatus=fanStatus, physDiskPoolId=physDiskPoolId, poolType=poolType, physDiskId=physDiskId, datadirect=datadirect, tempEncPos=tempEncPos, eventLogNumEntries=eventLogNumEntries, tempEncId=tempEncId, physicalDiskEntry=physicalDiskEntry, physDiskIndex=physDiskIndex, poolIndex=poolIndex)
