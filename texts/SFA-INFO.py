...
Counter32, ModuleIdentity, enterprises, Counter64, TimeTicks, Bits, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Unsigned32, IpAddress, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "enterprises", "Counter64", "TimeTicks", "Bits", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Unsigned32", "IpAddress", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("SFA-INFO", physicalDiskEntry=physicalDiskEntry, powerStatus=powerStatus, unit=unit, poolType=poolType, DisplayString=DisplayString, datadirect=datadirect, poolTable=poolTable, poolIndex=poolIndex, physDiskIndex=physDiskIndex, systemName=systemName, powerNumber=powerNumber, tempNumber=tempNumber, fanNumber=fanNumber, physDiskWWN=physDiskWWN, physDiskId=physDiskId, eventLogDescr=eventLogDescr, fanEncPos=fanEncPos, eventLogLevel=eventLogLevel, fanIndex=fanIndex, physDiskSlot=physDiskSlot, eventLogEntry=eventLogEntry, tempIndex=tempIndex, physDiskPoolId=physDiskPoolId, tempEncPos=tempEncPos, tempEntry=tempEntry, tempEncId=tempEncId, fanEncId=fanEncId, physDiskEnc=physDiskEnc, eventLog=eventLog, poolId=poolId, fanEntry=fanEntry, poolNumber=poolNumber, poolNumDisks=poolNumDisks, eventLogIndex=eventLogIndex, poolEntry=poolEntry, powerIndex=powerIndex, tempTable=tempTable, powerEncId=powerEncId, tempStatus=tempStatus, physicalDiskTable=physicalDiskTable, eventLogTrapLevel=eventLogTrapLevel, eventLogNumEntries=eventLogNumEntries, eventLogTable=eventLogTable, fanTable=fanTable, powerTable=powerTable, powerEntry=powerEntry, fanStatus=fanStatus, physDiskState=physDiskState, powerEncPos=powerEncPos)
