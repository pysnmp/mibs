...
# Produced by pysmi-1.1.8 at Tue Jan 11 20:33:51 2022
...
Bits, Counter64, NotificationType, ModuleIdentity, Unsigned32, MibIdentifier, iso, Counter32, ObjectIdentity, TimeTicks, enterprises, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "NotificationType", "ModuleIdentity", "Unsigned32", "MibIdentifier", "iso", "Counter32", "ObjectIdentity", "TimeTicks", "enterprises", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", poolEntry=poolEntry, physDiskWWN=physDiskWWN, physicalDiskTable=physicalDiskTable, eventLogLevel=eventLogLevel, powerEntry=powerEntry, eventLogIndex=eventLogIndex, physDiskSlot=physDiskSlot, tempTable=tempTable, poolNumDisks=poolNumDisks, tempNumber=tempNumber, fanEncId=fanEncId, eventLogEntry=eventLogEntry, unit=unit, DisplayString=DisplayString, physDiskEnc=physDiskEnc, datadirect=datadirect, powerNumber=powerNumber, eventLogDescr=eventLogDescr, fanTable=fanTable, fanNumber=fanNumber, powerEncId=powerEncId, fanStatus=fanStatus, fanEntry=fanEntry, physicalDiskEntry=physicalDiskEntry, eventLogTrapLevel=eventLogTrapLevel, physDiskPoolId=physDiskPoolId, physDiskState=physDiskState, tempEncId=tempEncId, poolId=poolId, tempIndex=tempIndex, powerStatus=powerStatus, tempEncPos=tempEncPos, physDiskIndex=physDiskIndex, poolIndex=poolIndex, eventLogNumEntries=eventLogNumEntries, fanIndex=fanIndex, powerIndex=powerIndex, poolNumber=poolNumber, tempEntry=tempEntry, tempStatus=tempStatus, poolType=poolType, physDiskId=physDiskId, systemName=systemName, powerEncPos=powerEncPos, poolTable=poolTable, powerTable=powerTable, fanEncPos=fanEncPos, eventLog=eventLog, eventLogTable=eventLogTable)
