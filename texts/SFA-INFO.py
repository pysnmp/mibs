...
mibBuilder.exportSymbols("SFA-INFO", physDiskEnc=physDiskEnc, eventLogDescr=eventLogDescr, powerNumber=powerNumber, datadirect=datadirect, eventLogTrapLevel=eventLogTrapLevel, poolType=poolType, fanEntry=fanEntry, eventLogLevel=eventLogLevel, fanEncId=fanEncId, tempEncId=tempEncId, tempStatus=tempStatus, eventLogIndex=eventLogIndex, poolNumDisks=poolNumDisks, eventLogNumEntries=eventLogNumEntries, physDiskWWN=physDiskWWN, physDiskIndex=physDiskIndex, fanIndex=fanIndex, physDiskId=physDiskId, physDiskSlot=physDiskSlot, poolId=poolId, powerEncId=powerEncId, eventLogTable=eventLogTable, DisplayString=DisplayString, eventLogEntry=eventLogEntry, unit=unit, tempIndex=tempIndex, fanNumber=fanNumber, tempNumber=tempNumber, fanTable=fanTable, poolTable=poolTable, powerEntry=powerEntry, tempEncPos=tempEncPos, physicalDiskEntry=physicalDiskEntry, tempEntry=tempEntry, systemName=systemName, fanStatus=fanStatus, powerEncPos=powerEncPos, poolEntry=poolEntry, powerIndex=powerIndex, poolIndex=poolIndex, physicalDiskTable=physicalDiskTable, tempTable=tempTable, fanEncPos=fanEncPos, poolNumber=poolNumber, eventLog=eventLog, powerStatus=powerStatus, powerTable=powerTable, physDiskState=physDiskState, physDiskPoolId=physDiskPoolId)
