...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:03:07 2022
...
MibIdentifier, IpAddress, enterprises, NotificationType, iso, ModuleIdentity, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, Unsigned32, Counter32, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "enterprises", "NotificationType", "iso", "ModuleIdentity", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "Unsigned32", "Counter32", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("SFA-INFO", fanTable=fanTable, powerEncId=powerEncId, DisplayString=DisplayString, fanEntry=fanEntry, powerIndex=powerIndex, tempIndex=tempIndex, physicalDiskEntry=physicalDiskEntry, powerTable=powerTable, eventLogEntry=eventLogEntry, tempTable=tempTable, tempEncId=tempEncId, poolTable=poolTable, poolIndex=poolIndex, poolType=poolType, physDiskEnc=physDiskEnc, physDiskSlot=physDiskSlot, powerStatus=powerStatus, physDiskWWN=physDiskWWN, systemName=systemName, tempEntry=tempEntry, poolId=poolId, powerEncPos=powerEncPos, eventLogTrapLevel=eventLogTrapLevel, physicalDiskTable=physicalDiskTable, eventLogLevel=eventLogLevel, powerNumber=powerNumber, poolEntry=poolEntry, eventLogIndex=eventLogIndex, tempStatus=tempStatus, tempNumber=tempNumber, poolNumDisks=poolNumDisks, physDiskState=physDiskState, poolNumber=poolNumber, eventLogNumEntries=eventLogNumEntries, physDiskPoolId=physDiskPoolId, eventLog=eventLog, fanNumber=fanNumber, fanEncId=fanEncId, fanIndex=fanIndex, powerEntry=powerEntry, eventLogDescr=eventLogDescr, eventLogTable=eventLogTable, tempEncPos=tempEncPos, fanEncPos=fanEncPos, unit=unit, physDiskId=physDiskId, fanStatus=fanStatus, datadirect=datadirect, physDiskIndex=physDiskIndex)
