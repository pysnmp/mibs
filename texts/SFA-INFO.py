...
# Produced by pysmi-1.1.12 at Tue Dec  3 10:05:01 2024
...
TimeTicks, NotificationType, iso, Unsigned32, enterprises, Bits, Counter64, MibIdentifier, ObjectIdentity, Counter32, Gauge32, ModuleIdentity, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "iso", "Unsigned32", "enterprises", "Bits", "Counter64", "MibIdentifier", "ObjectIdentity", "Counter32", "Gauge32", "ModuleIdentity", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", poolIndex=poolIndex, poolEntry=poolEntry, powerEncId=powerEncId, physDiskSlot=physDiskSlot, tempNumber=tempNumber, physDiskId=physDiskId, unit=unit, eventLogDescr=eventLogDescr, poolType=poolType, powerTable=powerTable, fanEncId=fanEncId, fanTable=fanTable, tempEncId=tempEncId, tempEntry=tempEntry, tempIndex=tempIndex, physDiskIndex=physDiskIndex, poolTable=poolTable, powerNumber=powerNumber, fanStatus=fanStatus, eventLogLevel=eventLogLevel, physDiskState=physDiskState, powerEntry=powerEntry, poolNumDisks=poolNumDisks, eventLogTable=eventLogTable, systemName=systemName, tempEncPos=tempEncPos, eventLogNumEntries=eventLogNumEntries, physicalDiskEntry=physicalDiskEntry, poolNumber=poolNumber, eventLogTrapLevel=eventLogTrapLevel, physDiskWWN=physDiskWWN, eventLogIndex=eventLogIndex, fanIndex=fanIndex, powerStatus=powerStatus, tempTable=tempTable, fanEncPos=fanEncPos, fanNumber=fanNumber, tempStatus=tempStatus, powerEncPos=powerEncPos, physDiskEnc=physDiskEnc, fanEntry=fanEntry, physDiskPoolId=physDiskPoolId, eventLog=eventLog, eventLogEntry=eventLogEntry, DisplayString=DisplayString, datadirect=datadirect, physicalDiskTable=physicalDiskTable, poolId=poolId, powerIndex=powerIndex)
