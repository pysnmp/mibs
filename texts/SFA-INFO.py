...
enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Bits, NotificationType, Counter32, ModuleIdentity, IpAddress, Unsigned32, MibIdentifier, Counter64, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Bits", "NotificationType", "Counter32", "ModuleIdentity", "IpAddress", "Unsigned32", "MibIdentifier", "Counter64", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskSlot=physDiskSlot, tempEncPos=tempEncPos, tempStatus=tempStatus, eventLogEntry=eventLogEntry, physDiskIndex=physDiskIndex, physDiskState=physDiskState, poolNumber=poolNumber, eventLogTrapLevel=eventLogTrapLevel, poolEntry=poolEntry, fanEncId=fanEncId, physicalDiskEntry=physicalDiskEntry, eventLogNumEntries=eventLogNumEntries, fanNumber=fanNumber, DisplayString=DisplayString, fanTable=fanTable, poolIndex=poolIndex, fanStatus=fanStatus, poolNumDisks=poolNumDisks, powerEntry=powerEntry, poolId=poolId, eventLogIndex=eventLogIndex, tempIndex=tempIndex, tempTable=tempTable, powerTable=powerTable, poolType=poolType, powerEncId=powerEncId, tempEntry=tempEntry, powerStatus=powerStatus, physDiskWWN=physDiskWWN, poolTable=poolTable, powerIndex=powerIndex, physDiskEnc=physDiskEnc, eventLogDescr=eventLogDescr, fanEntry=fanEntry, tempNumber=tempNumber, physDiskId=physDiskId, fanIndex=fanIndex, powerNumber=powerNumber, eventLogLevel=eventLogLevel, eventLogTable=eventLogTable, powerEncPos=powerEncPos, fanEncPos=fanEncPos, datadirect=datadirect, systemName=systemName, physDiskPoolId=physDiskPoolId, eventLog=eventLog, unit=unit, tempEncId=tempEncId, physicalDiskTable=physicalDiskTable)
