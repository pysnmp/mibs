...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:18:11 2022
...
enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Unsigned32, MibIdentifier, iso, Bits, Integer32, IpAddress, Gauge32, ModuleIdentity, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Unsigned32", "MibIdentifier", "iso", "Bits", "Integer32", "IpAddress", "Gauge32", "ModuleIdentity", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", fanEncId=fanEncId, poolType=poolType, physicalDiskTable=physicalDiskTable, eventLogDescr=eventLogDescr, eventLogEntry=eventLogEntry, powerNumber=powerNumber, physDiskPoolId=physDiskPoolId, DisplayString=DisplayString, fanNumber=fanNumber, powerEncId=powerEncId, eventLog=eventLog, physDiskSlot=physDiskSlot, tempStatus=tempStatus, physicalDiskEntry=physicalDiskEntry, poolIndex=poolIndex, physDiskEnc=physDiskEnc, fanStatus=fanStatus, systemName=systemName, poolEntry=poolEntry, tempEntry=tempEntry, poolId=poolId, poolNumber=poolNumber, physDiskState=physDiskState, powerEncPos=powerEncPos, fanEncPos=fanEncPos, tempNumber=tempNumber, tempIndex=tempIndex, tempTable=tempTable, poolNumDisks=poolNumDisks, unit=unit, powerTable=powerTable, physDiskId=physDiskId, fanIndex=fanIndex, fanEntry=fanEntry, tempEncPos=tempEncPos, powerEntry=powerEntry, eventLogNumEntries=eventLogNumEntries, powerIndex=powerIndex, powerStatus=powerStatus, fanTable=fanTable, eventLogIndex=eventLogIndex, datadirect=datadirect, tempEncId=tempEncId, eventLogTrapLevel=eventLogTrapLevel, physDiskIndex=physDiskIndex, physDiskWWN=physDiskWWN, poolTable=poolTable, eventLogLevel=eventLogLevel, eventLogTable=eventLogTable)
