...
# Produced by pysmi-1.1.8 at Sat Jan 15 20:16:12 2022
...
Integer32, ObjectIdentity, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, Counter64, NotificationType, Gauge32, IpAddress, ModuleIdentity, Unsigned32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "Counter64", "NotificationType", "Gauge32", "IpAddress", "ModuleIdentity", "Unsigned32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("SFA-INFO", tempEncId=tempEncId, eventLogEntry=eventLogEntry, physDiskState=physDiskState, physDiskId=physDiskId, poolNumDisks=poolNumDisks, systemName=systemName, eventLogTrapLevel=eventLogTrapLevel, eventLogTable=eventLogTable, datadirect=datadirect, physDiskIndex=physDiskIndex, tempNumber=tempNumber, tempIndex=tempIndex, fanNumber=fanNumber, physDiskEnc=physDiskEnc, fanIndex=fanIndex, physDiskPoolId=physDiskPoolId, fanEntry=fanEntry, powerEncPos=powerEncPos, eventLog=eventLog, tempEncPos=tempEncPos, fanTable=fanTable, powerEncId=powerEncId, powerIndex=powerIndex, physDiskWWN=physDiskWWN, poolTable=poolTable, physicalDiskEntry=physicalDiskEntry, poolNumber=poolNumber, poolEntry=poolEntry, tempTable=tempTable, fanEncId=fanEncId, eventLogDescr=eventLogDescr, tempStatus=tempStatus, powerEntry=powerEntry, eventLogIndex=eventLogIndex, physicalDiskTable=physicalDiskTable, DisplayString=DisplayString, fanEncPos=fanEncPos, poolType=poolType, eventLogLevel=eventLogLevel, powerStatus=powerStatus, physDiskSlot=physDiskSlot, unit=unit, tempEntry=tempEntry, poolIndex=poolIndex, eventLogNumEntries=eventLogNumEntries, fanStatus=fanStatus, poolId=poolId, powerNumber=powerNumber, powerTable=powerTable)
