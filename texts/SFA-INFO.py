...
Counter64, MibIdentifier, ModuleIdentity, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Integer32, TimeTicks, NotificationType, enterprises, Counter32, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "ModuleIdentity", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Integer32", "TimeTicks", "NotificationType", "enterprises", "Counter32", "IpAddress", "iso")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogLevel=eventLogLevel, fanEncId=fanEncId, physicalDiskEntry=physicalDiskEntry, powerEncId=powerEncId, eventLogIndex=eventLogIndex, eventLogDescr=eventLogDescr, fanEncPos=fanEncPos, physDiskId=physDiskId, powerStatus=powerStatus, tempTable=tempTable, physDiskSlot=physDiskSlot, fanTable=fanTable, eventLog=eventLog, fanStatus=fanStatus, fanNumber=fanNumber, tempIndex=tempIndex, physDiskWWN=physDiskWWN, eventLogTable=eventLogTable, physDiskEnc=physDiskEnc, fanEntry=fanEntry, DisplayString=DisplayString, powerTable=powerTable, physDiskState=physDiskState, poolEntry=poolEntry, tempNumber=tempNumber, poolTable=poolTable, physDiskIndex=physDiskIndex, poolId=poolId, poolNumDisks=poolNumDisks, eventLogTrapLevel=eventLogTrapLevel, poolNumber=poolNumber, tempStatus=tempStatus, fanIndex=fanIndex, systemName=systemName, tempEncPos=tempEncPos, eventLogNumEntries=eventLogNumEntries, unit=unit, powerEntry=powerEntry, eventLogEntry=eventLogEntry, physDiskPoolId=physDiskPoolId, physicalDiskTable=physicalDiskTable, poolIndex=poolIndex, powerNumber=powerNumber, powerIndex=powerIndex, datadirect=datadirect, poolType=poolType, tempEncId=tempEncId, tempEntry=tempEntry, powerEncPos=powerEncPos)
