...
# Produced by pysmi-1.1.10 at Thu Nov  9 13:45:49 2023
...
ModuleIdentity, Bits, enterprises, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, IpAddress, Counter64, Integer32, Counter32, iso, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "enterprises", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "IpAddress", "Counter64", "Integer32", "Counter32", "iso", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("SFA-INFO", fanTable=fanTable, physDiskPoolId=physDiskPoolId, physicalDiskEntry=physicalDiskEntry, physDiskWWN=physDiskWWN, physDiskId=physDiskId, eventLogTable=eventLogTable, powerIndex=powerIndex, DisplayString=DisplayString, physDiskIndex=physDiskIndex, unit=unit, tempEncPos=tempEncPos, tempNumber=tempNumber, tempStatus=tempStatus, fanEntry=fanEntry, fanNumber=fanNumber, poolEntry=poolEntry, physDiskEnc=physDiskEnc, eventLogDescr=eventLogDescr, eventLogLevel=eventLogLevel, poolIndex=poolIndex, eventLogEntry=eventLogEntry, poolId=poolId, eventLogNumEntries=eventLogNumEntries, tempEncId=tempEncId, physDiskSlot=physDiskSlot, powerNumber=powerNumber, datadirect=datadirect, powerEncPos=powerEncPos, fanEncPos=fanEncPos, eventLogIndex=eventLogIndex, powerStatus=powerStatus, powerEncId=powerEncId, fanStatus=fanStatus, tempTable=tempTable, tempIndex=tempIndex, fanIndex=fanIndex, eventLog=eventLog, powerEntry=powerEntry, powerTable=powerTable, poolNumDisks=poolNumDisks, physDiskState=physDiskState, poolType=poolType, systemName=systemName, poolNumber=poolNumber, physicalDiskTable=physicalDiskTable, eventLogTrapLevel=eventLogTrapLevel, tempEntry=tempEntry, fanEncId=fanEncId, poolTable=poolTable)
