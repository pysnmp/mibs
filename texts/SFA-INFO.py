...
# Produced by pysmi-1.1.8 at Tue Sep 12 08:02:03 2023
...
NotificationType, ObjectIdentity, Gauge32, Counter64, Bits, ModuleIdentity, Counter32, iso, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Gauge32", "Counter64", "Bits", "ModuleIdentity", "Counter32", "iso", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", tempStatus=tempStatus, fanEntry=fanEntry, powerNumber=powerNumber, fanEncPos=fanEncPos, poolIndex=poolIndex, eventLogTrapLevel=eventLogTrapLevel, eventLog=eventLog, eventLogNumEntries=eventLogNumEntries, poolId=poolId, eventLogLevel=eventLogLevel, tempNumber=tempNumber, powerEntry=powerEntry, tempEncPos=tempEncPos, fanEncId=fanEncId, physDiskState=physDiskState, eventLogIndex=eventLogIndex, unit=unit, physicalDiskTable=physicalDiskTable, physDiskIndex=physDiskIndex, physDiskId=physDiskId, tempTable=tempTable, powerIndex=powerIndex, physDiskSlot=physDiskSlot, fanTable=fanTable, eventLogDescr=eventLogDescr, tempEntry=tempEntry, tempEncId=tempEncId, poolTable=poolTable, powerStatus=powerStatus, poolEntry=poolEntry, powerEncPos=powerEncPos, physDiskWWN=physDiskWWN, fanIndex=fanIndex, poolNumber=poolNumber, powerTable=powerTable, powerEncId=powerEncId, poolNumDisks=poolNumDisks, eventLogTable=eventLogTable, physDiskEnc=physDiskEnc, physicalDiskEntry=physicalDiskEntry, eventLogEntry=eventLogEntry, fanStatus=fanStatus, poolType=poolType, physDiskPoolId=physDiskPoolId, tempIndex=tempIndex, fanNumber=fanNumber, systemName=systemName, DisplayString=DisplayString, datadirect=datadirect)
