...
# Produced by pysmi-1.1.12 at Wed Jul  3 13:27:52 2024
...
iso, MibIdentifier, enterprises, Unsigned32, Gauge32, ObjectIdentity, Counter32, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, IpAddress, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "enterprises", "Unsigned32", "Gauge32", "ObjectIdentity", "Counter32", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "IpAddress", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", tempEncPos=tempEncPos, fanTable=fanTable, fanEncPos=fanEncPos, DisplayString=DisplayString, powerStatus=powerStatus, systemName=systemName, poolType=poolType, physDiskSlot=physDiskSlot, poolNumber=poolNumber, eventLogLevel=eventLogLevel, powerTable=powerTable, tempEntry=tempEntry, datadirect=datadirect, physDiskPoolId=physDiskPoolId, physDiskState=physDiskState, eventLogEntry=eventLogEntry, physicalDiskTable=physicalDiskTable, physDiskIndex=physDiskIndex, eventLogTable=eventLogTable, fanNumber=fanNumber, poolEntry=poolEntry, physDiskId=physDiskId, tempNumber=tempNumber, eventLog=eventLog, fanEntry=fanEntry, powerNumber=powerNumber, physDiskWWN=physDiskWWN, tempTable=tempTable, fanIndex=fanIndex, poolTable=poolTable, physicalDiskEntry=physicalDiskEntry, poolId=poolId, powerIndex=powerIndex, fanEncId=fanEncId, poolIndex=poolIndex, tempIndex=tempIndex, tempStatus=tempStatus, eventLogIndex=eventLogIndex, poolNumDisks=poolNumDisks, physDiskEnc=physDiskEnc, powerEntry=powerEntry, powerEncId=powerEncId, powerEncPos=powerEncPos, eventLogDescr=eventLogDescr, eventLogTrapLevel=eventLogTrapLevel, fanStatus=fanStatus, eventLogNumEntries=eventLogNumEntries, unit=unit, tempEncId=tempEncId)
