...
ModuleIdentity, Counter32, IpAddress, MibIdentifier, Integer32, enterprises, TimeTicks, NotificationType, Bits, Gauge32, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "IpAddress", "MibIdentifier", "Integer32", "enterprises", "TimeTicks", "NotificationType", "Bits", "Gauge32", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogTrapLevel=eventLogTrapLevel, eventLogLevel=eventLogLevel, tempIndex=tempIndex, powerStatus=powerStatus, tempNumber=tempNumber, poolTable=poolTable, tempEntry=tempEntry, systemName=systemName, fanNumber=fanNumber, fanIndex=fanIndex, eventLogEntry=eventLogEntry, tempTable=tempTable, eventLogNumEntries=eventLogNumEntries, poolType=poolType, eventLogTable=eventLogTable, DisplayString=DisplayString, tempStatus=tempStatus, physDiskId=physDiskId, poolNumDisks=poolNumDisks, powerTable=powerTable, physDiskSlot=physDiskSlot, physDiskPoolId=physDiskPoolId, unit=unit, datadirect=datadirect, powerEncId=powerEncId, fanTable=fanTable, physicalDiskTable=physicalDiskTable, physDiskState=physDiskState, poolNumber=poolNumber, poolEntry=poolEntry, tempEncId=tempEncId, fanEncId=fanEncId, physDiskEnc=physDiskEnc, poolIndex=poolIndex, eventLogDescr=eventLogDescr, physDiskWWN=physDiskWWN, powerEncPos=powerEncPos, tempEncPos=tempEncPos, fanEntry=fanEntry, eventLog=eventLog, powerNumber=powerNumber, powerIndex=powerIndex, fanStatus=fanStatus, fanEncPos=fanEncPos, physicalDiskEntry=physicalDiskEntry, poolId=poolId, powerEntry=powerEntry, eventLogIndex=eventLogIndex, physDiskIndex=physDiskIndex)
