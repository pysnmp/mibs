...
Unsigned32, Bits, iso, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, TimeTicks, ModuleIdentity, Gauge32, NotificationType, IpAddress, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "iso", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "TimeTicks", "ModuleIdentity", "Gauge32", "NotificationType", "IpAddress", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("SFA-INFO", tempEncPos=tempEncPos, eventLogTrapLevel=eventLogTrapLevel, physicalDiskTable=physicalDiskTable, physDiskIndex=physDiskIndex, tempEncId=tempEncId, physDiskEnc=physDiskEnc, poolId=poolId, eventLogTable=eventLogTable, physDiskSlot=physDiskSlot, powerIndex=powerIndex, poolIndex=poolIndex, fanEncPos=fanEncPos, physDiskPoolId=physDiskPoolId, unit=unit, systemName=systemName, tempNumber=tempNumber, physDiskState=physDiskState, fanEncId=fanEncId, eventLogEntry=eventLogEntry, fanIndex=fanIndex, tempEntry=tempEntry, poolNumber=poolNumber, fanTable=fanTable, eventLog=eventLog, poolTable=poolTable, powerTable=powerTable, poolType=poolType, powerEncPos=powerEncPos, powerEntry=powerEntry, eventLogLevel=eventLogLevel, physDiskId=physDiskId, fanStatus=fanStatus, eventLogIndex=eventLogIndex, physDiskWWN=physDiskWWN, eventLogDescr=eventLogDescr, poolEntry=poolEntry, poolNumDisks=poolNumDisks, fanEntry=fanEntry, tempIndex=tempIndex, powerStatus=powerStatus, tempStatus=tempStatus, tempTable=tempTable, physicalDiskEntry=physicalDiskEntry, fanNumber=fanNumber, eventLogNumEntries=eventLogNumEntries, powerEncId=powerEncId, powerNumber=powerNumber, DisplayString=DisplayString, datadirect=datadirect)
