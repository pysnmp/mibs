...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:00:59 2022
...
Gauge32, Unsigned32, ModuleIdentity, Counter64, NotificationType, Counter32, Integer32, IpAddress, MibIdentifier, ObjectIdentity, Bits, enterprises, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "ModuleIdentity", "Counter64", "NotificationType", "Counter32", "Integer32", "IpAddress", "MibIdentifier", "ObjectIdentity", "Bits", "enterprises", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", tempTable=tempTable, fanTable=fanTable, physicalDiskTable=physicalDiskTable, eventLogNumEntries=eventLogNumEntries, powerEncId=powerEncId, physDiskEnc=physDiskEnc, physDiskId=physDiskId, poolNumber=poolNumber, systemName=systemName, eventLogDescr=eventLogDescr, fanEncPos=fanEncPos, powerEncPos=powerEncPos, poolType=poolType, physDiskState=physDiskState, datadirect=datadirect, tempEncId=tempEncId, fanStatus=fanStatus, powerEntry=powerEntry, poolId=poolId, physDiskSlot=physDiskSlot, tempNumber=tempNumber, eventLogLevel=eventLogLevel, physDiskWWN=physDiskWWN, tempEntry=tempEntry, poolIndex=poolIndex, physDiskPoolId=physDiskPoolId, fanEncId=fanEncId, unit=unit, poolNumDisks=poolNumDisks, tempStatus=tempStatus, powerIndex=powerIndex, fanNumber=fanNumber, eventLogTable=eventLogTable, tempIndex=tempIndex, DisplayString=DisplayString, powerNumber=powerNumber, tempEncPos=tempEncPos, physicalDiskEntry=physicalDiskEntry, eventLogTrapLevel=eventLogTrapLevel, fanEntry=fanEntry, powerStatus=powerStatus, eventLogEntry=eventLogEntry, fanIndex=fanIndex, eventLog=eventLog, poolTable=poolTable, poolEntry=poolEntry, eventLogIndex=eventLogIndex, physDiskIndex=physDiskIndex, powerTable=powerTable)
