...
# Produced by pysmi-1.1.8 at Mon Jan 17 14:54:36 2022
...
enterprises, Bits, NotificationType, TimeTicks, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, ObjectIdentity, Integer32, iso, Unsigned32, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "NotificationType", "TimeTicks", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "ObjectIdentity", "Integer32", "iso", "Unsigned32", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskEnc=physDiskEnc, fanStatus=fanStatus, tempEncId=tempEncId, eventLogIndex=eventLogIndex, tempEntry=tempEntry, tempStatus=tempStatus, poolIndex=poolIndex, powerIndex=powerIndex, fanEntry=fanEntry, physDiskSlot=physDiskSlot, powerStatus=powerStatus, poolEntry=poolEntry, powerNumber=powerNumber, fanTable=fanTable, fanNumber=fanNumber, powerEntry=powerEntry, eventLogTrapLevel=eventLogTrapLevel, datadirect=datadirect, powerEncId=powerEncId, physicalDiskTable=physicalDiskTable, eventLogEntry=eventLogEntry, poolNumDisks=poolNumDisks, eventLogLevel=eventLogLevel, tempNumber=tempNumber, unit=unit, eventLog=eventLog, eventLogNumEntries=eventLogNumEntries, poolTable=poolTable, tempIndex=tempIndex, DisplayString=DisplayString, poolType=poolType, systemName=systemName, eventLogTable=eventLogTable, physDiskPoolId=physDiskPoolId, fanIndex=fanIndex, powerEncPos=powerEncPos, physDiskIndex=physDiskIndex, physDiskId=physDiskId, eventLogDescr=eventLogDescr, poolNumber=poolNumber, poolId=poolId, physicalDiskEntry=physicalDiskEntry, physDiskState=physDiskState, tempEncPos=tempEncPos, tempTable=tempTable, fanEncPos=fanEncPos, powerTable=powerTable, fanEncId=fanEncId, physDiskWWN=physDiskWWN)
