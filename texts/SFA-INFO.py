...
ModuleIdentity, Integer32, Unsigned32, TimeTicks, NotificationType, Bits, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, iso, MibIdentifier, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Unsigned32", "TimeTicks", "NotificationType", "Bits", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "iso", "MibIdentifier", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("SFA-INFO", fanEncId=fanEncId, powerNumber=powerNumber, fanTable=fanTable, physDiskSlot=physDiskSlot, poolNumDisks=poolNumDisks, poolIndex=poolIndex, datadirect=datadirect, eventLogTable=eventLogTable, powerEntry=powerEntry, fanIndex=fanIndex, powerEncId=powerEncId, systemName=systemName, fanEncPos=fanEncPos, poolNumber=poolNumber, physDiskIndex=physDiskIndex, tempNumber=tempNumber, unit=unit, tempEncPos=tempEncPos, eventLogNumEntries=eventLogNumEntries, eventLogEntry=eventLogEntry, DisplayString=DisplayString, tempTable=tempTable, tempStatus=tempStatus, powerTable=powerTable, tempEntry=tempEntry, physDiskId=physDiskId, poolType=poolType, powerIndex=powerIndex, poolTable=poolTable, eventLogLevel=eventLogLevel, tempIndex=tempIndex, physDiskState=physDiskState, eventLogIndex=eventLogIndex, poolId=poolId, eventLogDescr=eventLogDescr, physDiskPoolId=physDiskPoolId, powerStatus=powerStatus, physDiskWWN=physDiskWWN, poolEntry=poolEntry, eventLog=eventLog, tempEncId=tempEncId, fanNumber=fanNumber, physicalDiskEntry=physicalDiskEntry, physDiskEnc=physDiskEnc, eventLogTrapLevel=eventLogTrapLevel, physicalDiskTable=physicalDiskTable, powerEncPos=powerEncPos, fanEntry=fanEntry, fanStatus=fanStatus)
