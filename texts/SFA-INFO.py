...
# Produced by pysmi-1.1.12 at Fri Jul 19 11:34:16 2024
...
mibBuilder.exportSymbols("SFA-INFO", tempTable=tempTable, physDiskState=physDiskState, powerNumber=powerNumber, poolNumDisks=poolNumDisks, fanEncPos=fanEncPos, powerEntry=powerEntry, powerStatus=powerStatus, tempEncId=tempEncId, tempEncPos=tempEncPos, physDiskEnc=physDiskEnc, tempEntry=tempEntry, eventLogIndex=eventLogIndex, datadirect=datadirect, tempIndex=tempIndex, eventLogTrapLevel=eventLogTrapLevel, poolNumber=poolNumber, poolIndex=poolIndex, systemName=systemName, poolEntry=poolEntry, unit=unit, powerIndex=powerIndex, physDiskId=physDiskId, physicalDiskTable=physicalDiskTable, physDiskWWN=physDiskWWN, fanEntry=fanEntry, DisplayString=DisplayString, fanIndex=fanIndex, physDiskPoolId=physDiskPoolId, eventLogNumEntries=eventLogNumEntries, tempStatus=tempStatus, tempNumber=tempNumber, poolId=poolId, eventLog=eventLog, eventLogEntry=eventLogEntry, fanTable=fanTable, poolTable=poolTable, eventLogDescr=eventLogDescr, fanNumber=fanNumber, eventLogTable=eventLogTable, fanStatus=fanStatus, physDiskIndex=physDiskIndex, powerEncId=powerEncId, eventLogLevel=eventLogLevel, powerEncPos=powerEncPos, physicalDiskEntry=physicalDiskEntry, physDiskSlot=physDiskSlot, poolType=poolType, powerTable=powerTable, fanEncId=fanEncId)
