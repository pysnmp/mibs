...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:03:08 2023
...
enterprises, ObjectIdentity, TimeTicks, IpAddress, Integer32, MibIdentifier, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Counter32, Unsigned32, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "TimeTicks", "IpAddress", "Integer32", "MibIdentifier", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Counter32", "Unsigned32", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", powerNumber=powerNumber, physDiskWWN=physDiskWWN, systemName=systemName, eventLogEntry=eventLogEntry, eventLogDescr=eventLogDescr, physDiskEnc=physDiskEnc, unit=unit, fanStatus=fanStatus, tempIndex=tempIndex, fanEncId=fanEncId, poolNumber=poolNumber, physDiskIndex=physDiskIndex, tempStatus=tempStatus, physDiskState=physDiskState, tempEncId=tempEncId, fanEntry=fanEntry, physDiskPoolId=physDiskPoolId, physicalDiskEntry=physicalDiskEntry, powerTable=powerTable, fanIndex=fanIndex, powerEncPos=powerEncPos, powerStatus=powerStatus, datadirect=datadirect, poolTable=poolTable, poolEntry=poolEntry, eventLogNumEntries=eventLogNumEntries, eventLogLevel=eventLogLevel, physDiskSlot=physDiskSlot, fanTable=fanTable, fanEncPos=fanEncPos, DisplayString=DisplayString, fanNumber=fanNumber, tempEntry=tempEntry, powerIndex=powerIndex, poolType=poolType, poolIndex=poolIndex, poolId=poolId, poolNumDisks=poolNumDisks, physDiskId=physDiskId, eventLogTable=eventLogTable, eventLogIndex=eventLogIndex, powerEntry=powerEntry, tempNumber=tempNumber, tempEncPos=tempEncPos, tempTable=tempTable, eventLogTrapLevel=eventLogTrapLevel, eventLog=eventLog, physicalDiskTable=physicalDiskTable, powerEncId=powerEncId)
