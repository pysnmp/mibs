...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:35:27 2024
...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Unsigned32, iso, NotificationType, Gauge32, Bits, Counter64, ModuleIdentity, ObjectIdentity, TimeTicks, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Unsigned32", "iso", "NotificationType", "Gauge32", "Bits", "Counter64", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", physicalDiskEntry=physicalDiskEntry, physDiskPoolId=physDiskPoolId, eventLogNumEntries=eventLogNumEntries, physDiskId=physDiskId, powerTable=powerTable, powerEncPos=powerEncPos, powerIndex=powerIndex, physicalDiskTable=physicalDiskTable, eventLogDescr=eventLogDescr, fanEntry=fanEntry, tempEncPos=tempEncPos, tempTable=tempTable, fanNumber=fanNumber, powerStatus=powerStatus, fanTable=fanTable, poolNumber=poolNumber, eventLogLevel=eventLogLevel, powerEncId=powerEncId, fanEncId=fanEncId, eventLogEntry=eventLogEntry, DisplayString=DisplayString, poolEntry=poolEntry, eventLogTable=eventLogTable, tempStatus=tempStatus, poolId=poolId, fanEncPos=fanEncPos, poolNumDisks=poolNumDisks, tempEncId=tempEncId, physDiskEnc=physDiskEnc, eventLogTrapLevel=eventLogTrapLevel, datadirect=datadirect, powerNumber=powerNumber, unit=unit, poolTable=poolTable, systemName=systemName, eventLogIndex=eventLogIndex, tempEntry=tempEntry, fanIndex=fanIndex, eventLog=eventLog, poolIndex=poolIndex, powerEntry=powerEntry, fanStatus=fanStatus, physDiskState=physDiskState, tempNumber=tempNumber, physDiskWWN=physDiskWWN, poolType=poolType, physDiskSlot=physDiskSlot, physDiskIndex=physDiskIndex, tempIndex=tempIndex)
