...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, enterprises, Gauge32, ModuleIdentity, ObjectIdentity, NotificationType, Integer32, Bits, Counter32, MibIdentifier, Counter64, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "enterprises", "Gauge32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Integer32", "Bits", "Counter32", "MibIdentifier", "Counter64", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskSlot=physDiskSlot, eventLogTrapLevel=eventLogTrapLevel, physDiskId=physDiskId, powerIndex=powerIndex, powerNumber=powerNumber, eventLog=eventLog, eventLogEntry=eventLogEntry, physicalDiskEntry=physicalDiskEntry, physicalDiskTable=physicalDiskTable, tempNumber=tempNumber, powerStatus=powerStatus, physDiskIndex=physDiskIndex, eventLogLevel=eventLogLevel, tempEncId=tempEncId, fanEntry=fanEntry, powerEntry=powerEntry, tempEncPos=tempEncPos, eventLogIndex=eventLogIndex, poolNumDisks=poolNumDisks, poolNumber=poolNumber, eventLogTable=eventLogTable, fanNumber=fanNumber, DisplayString=DisplayString, powerEncId=powerEncId, fanEncId=fanEncId, datadirect=datadirect, physDiskEnc=physDiskEnc, physDiskState=physDiskState, physDiskPoolId=physDiskPoolId, physDiskWWN=physDiskWWN, tempStatus=tempStatus, powerTable=powerTable, fanTable=fanTable, tempIndex=tempIndex, unit=unit, poolIndex=poolIndex, poolType=poolType, eventLogNumEntries=eventLogNumEntries, tempTable=tempTable, fanIndex=fanIndex, fanStatus=fanStatus, tempEntry=tempEntry, poolTable=poolTable, poolEntry=poolEntry, fanEncPos=fanEncPos, powerEncPos=powerEncPos, poolId=poolId, systemName=systemName, eventLogDescr=eventLogDescr)
