...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:58:46 2022
...
ObjectIdentity, NotificationType, Gauge32, Unsigned32, Bits, TimeTicks, enterprises, Counter32, iso, ModuleIdentity, IpAddress, Integer32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Gauge32", "Unsigned32", "Bits", "TimeTicks", "enterprises", "Counter32", "iso", "ModuleIdentity", "IpAddress", "Integer32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskSlot=physDiskSlot, DisplayString=DisplayString, eventLogNumEntries=eventLogNumEntries, tempEntry=tempEntry, fanTable=fanTable, poolIndex=poolIndex, physDiskIndex=physDiskIndex, eventLogIndex=eventLogIndex, systemName=systemName, eventLogEntry=eventLogEntry, tempTable=tempTable, powerEncPos=powerEncPos, poolId=poolId, physicalDiskEntry=physicalDiskEntry, tempEncPos=tempEncPos, physDiskPoolId=physDiskPoolId, unit=unit, fanEntry=fanEntry, eventLogDescr=eventLogDescr, fanNumber=fanNumber, powerIndex=powerIndex, physDiskState=physDiskState, fanEncPos=fanEncPos, poolNumDisks=poolNumDisks, powerNumber=powerNumber, powerStatus=powerStatus, powerEncId=powerEncId, powerTable=powerTable, fanEncId=fanEncId, physDiskId=physDiskId, datadirect=datadirect, poolNumber=poolNumber, eventLogTrapLevel=eventLogTrapLevel, eventLogTable=eventLogTable, tempIndex=tempIndex, physDiskWWN=physDiskWWN, eventLogLevel=eventLogLevel, poolTable=poolTable, poolType=poolType, tempEncId=tempEncId, tempStatus=tempStatus, powerEntry=powerEntry, poolEntry=poolEntry, eventLog=eventLog, tempNumber=tempNumber, fanStatus=fanStatus, physicalDiskTable=physicalDiskTable, physDiskEnc=physDiskEnc, fanIndex=fanIndex)
