...
enterprises, Integer32, ModuleIdentity, IpAddress, ObjectIdentity, TimeTicks, Unsigned32, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, MibIdentifier, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "ModuleIdentity", "IpAddress", "ObjectIdentity", "TimeTicks", "Unsigned32", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "MibIdentifier", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("SFA-INFO", fanEntry=fanEntry, physDiskPoolId=physDiskPoolId, DisplayString=DisplayString, tempStatus=tempStatus, poolNumDisks=poolNumDisks, datadirect=datadirect, powerNumber=powerNumber, poolId=poolId, poolType=poolType, tempNumber=tempNumber, powerEncId=powerEncId, powerEncPos=powerEncPos, physDiskWWN=physDiskWWN, physDiskSlot=physDiskSlot, physDiskId=physDiskId, fanStatus=fanStatus, powerEntry=powerEntry, fanEncPos=fanEncPos, eventLogEntry=eventLogEntry, fanEncId=fanEncId, physicalDiskTable=physicalDiskTable, physDiskState=physDiskState, tempEncPos=tempEncPos, tempEntry=tempEntry, eventLogTable=eventLogTable, tempIndex=tempIndex, powerIndex=powerIndex, fanIndex=fanIndex, poolTable=poolTable, tempTable=tempTable, physDiskIndex=physDiskIndex, eventLogNumEntries=eventLogNumEntries, poolIndex=poolIndex, poolNumber=poolNumber, poolEntry=poolEntry, systemName=systemName, tempEncId=tempEncId, unit=unit, powerStatus=powerStatus, eventLogDescr=eventLogDescr, eventLogLevel=eventLogLevel, eventLogTrapLevel=eventLogTrapLevel, physDiskEnc=physDiskEnc, powerTable=powerTable, fanTable=fanTable, physicalDiskEntry=physicalDiskEntry, fanNumber=fanNumber, eventLog=eventLog, eventLogIndex=eventLogIndex)
