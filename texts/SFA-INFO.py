...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:43:25 2021
...
ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Unsigned32, Counter32, TimeTicks, MibIdentifier, iso, Integer32, enterprises, Counter64, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Unsigned32", "Counter32", "TimeTicks", "MibIdentifier", "iso", "Integer32", "enterprises", "Counter64", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", fanIndex=fanIndex, powerIndex=powerIndex, eventLog=eventLog, fanEntry=fanEntry, poolTable=poolTable, poolIndex=poolIndex, physicalDiskEntry=physicalDiskEntry, eventLogLevel=eventLogLevel, powerTable=powerTable, fanEncId=fanEncId, tempEncId=tempEncId, fanEncPos=fanEncPos, powerStatus=powerStatus, powerNumber=powerNumber, tempEntry=tempEntry, tempNumber=tempNumber, physDiskEnc=physDiskEnc, powerEncPos=powerEncPos, tempStatus=tempStatus, eventLogTable=eventLogTable, fanStatus=fanStatus, eventLogDescr=eventLogDescr, poolNumber=poolNumber, eventLogIndex=eventLogIndex, physDiskIndex=physDiskIndex, physDiskState=physDiskState, physDiskPoolId=physDiskPoolId, tempEncPos=tempEncPos, poolEntry=poolEntry, poolNumDisks=poolNumDisks, eventLogNumEntries=eventLogNumEntries, physDiskWWN=physDiskWWN, physDiskId=physDiskId, datadirect=datadirect, poolType=poolType, tempTable=tempTable, unit=unit, physDiskSlot=physDiskSlot, eventLogTrapLevel=eventLogTrapLevel, DisplayString=DisplayString, poolId=poolId, systemName=systemName, eventLogEntry=eventLogEntry, powerEntry=powerEntry, physicalDiskTable=physicalDiskTable, fanNumber=fanNumber, fanTable=fanTable, powerEncId=powerEncId, tempIndex=tempIndex)
