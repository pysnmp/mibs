...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:24:24 2022
...
Gauge32, Counter64, Integer32, ObjectIdentity, Counter32, ModuleIdentity, Unsigned32, TimeTicks, Bits, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Integer32", "ObjectIdentity", "Counter32", "ModuleIdentity", "Unsigned32", "TimeTicks", "Bits", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("SFA-INFO", powerNumber=powerNumber, tempEncPos=tempEncPos, physDiskPoolId=physDiskPoolId, fanEntry=fanEntry, tempEntry=tempEntry, fanEncId=fanEncId, poolNumDisks=poolNumDisks, eventLogEntry=eventLogEntry, poolTable=poolTable, eventLogLevel=eventLogLevel, tempStatus=tempStatus, tempIndex=tempIndex, eventLog=eventLog, poolType=poolType, powerEntry=powerEntry, powerStatus=powerStatus, systemName=systemName, tempTable=tempTable, tempNumber=tempNumber, unit=unit, poolNumber=poolNumber, fanEncPos=fanEncPos, eventLogDescr=eventLogDescr, poolId=poolId, physicalDiskEntry=physicalDiskEntry, physDiskIndex=physDiskIndex, eventLogTrapLevel=eventLogTrapLevel, poolIndex=poolIndex, poolEntry=poolEntry, physDiskWWN=physDiskWWN, DisplayString=DisplayString, powerTable=powerTable, physicalDiskTable=physicalDiskTable, fanTable=fanTable, physDiskSlot=physDiskSlot, tempEncId=tempEncId, physDiskState=physDiskState, eventLogTable=eventLogTable, fanStatus=fanStatus, powerEncId=powerEncId, eventLogNumEntries=eventLogNumEntries, datadirect=datadirect, fanIndex=fanIndex, powerIndex=powerIndex, eventLogIndex=eventLogIndex, powerEncPos=powerEncPos, physDiskId=physDiskId, fanNumber=fanNumber, physDiskEnc=physDiskEnc)
