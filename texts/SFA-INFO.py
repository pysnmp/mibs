...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:36:34 2023
...
Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, Counter32, Counter64, iso, Bits, enterprises, IpAddress, ObjectIdentity, TimeTicks, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "Counter32", "Counter64", "iso", "Bits", "enterprises", "IpAddress", "ObjectIdentity", "TimeTicks", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", eventLogDescr=eventLogDescr, datadirect=datadirect, physDiskId=physDiskId, physDiskSlot=physDiskSlot, poolId=poolId, physDiskEnc=physDiskEnc, fanNumber=fanNumber, fanStatus=fanStatus, tempEntry=tempEntry, DisplayString=DisplayString, fanEntry=fanEntry, eventLog=eventLog, systemName=systemName, fanTable=fanTable, powerNumber=powerNumber, tempEncId=tempEncId, powerStatus=powerStatus, powerTable=powerTable, tempEncPos=tempEncPos, eventLogTrapLevel=eventLogTrapLevel, fanEncPos=fanEncPos, tempNumber=tempNumber, eventLogTable=eventLogTable, physDiskState=physDiskState, poolNumber=poolNumber, powerEntry=powerEntry, poolTable=poolTable, physicalDiskEntry=physicalDiskEntry, fanIndex=fanIndex, powerIndex=powerIndex, powerEncId=powerEncId, poolIndex=poolIndex, eventLogEntry=eventLogEntry, physDiskIndex=physDiskIndex, tempIndex=tempIndex, physDiskWWN=physDiskWWN, poolType=poolType, physDiskPoolId=physDiskPoolId, eventLogLevel=eventLogLevel, eventLogNumEntries=eventLogNumEntries, tempStatus=tempStatus, poolNumDisks=poolNumDisks, powerEncPos=powerEncPos, unit=unit, fanEncId=fanEncId, poolEntry=poolEntry, eventLogIndex=eventLogIndex, tempTable=tempTable, physicalDiskTable=physicalDiskTable)
