...
# Produced by pysmi-1.1.8 at Wed Feb  2 17:56:04 2022
...
enterprises, ModuleIdentity, NotificationType, MibIdentifier, ObjectIdentity, Integer32, Unsigned32, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, Bits, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "NotificationType", "MibIdentifier", "ObjectIdentity", "Integer32", "Unsigned32", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "Bits", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskState=physDiskState, eventLogTrapLevel=eventLogTrapLevel, tempTable=tempTable, tempEncPos=tempEncPos, tempStatus=tempStatus, poolType=poolType, physDiskPoolId=physDiskPoolId, tempIndex=tempIndex, tempNumber=tempNumber, powerNumber=powerNumber, fanTable=fanTable, poolId=poolId, fanEncPos=fanEncPos, fanIndex=fanIndex, eventLogDescr=eventLogDescr, poolNumber=poolNumber, physDiskEnc=physDiskEnc, powerTable=powerTable, poolTable=poolTable, physDiskId=physDiskId, fanEntry=fanEntry, physDiskWWN=physDiskWWN, eventLogNumEntries=eventLogNumEntries, physicalDiskTable=physicalDiskTable, poolNumDisks=poolNumDisks, eventLogIndex=eventLogIndex, powerEncId=powerEncId, systemName=systemName, fanStatus=fanStatus, powerEntry=powerEntry, powerEncPos=powerEncPos, poolEntry=poolEntry, tempEncId=tempEncId, eventLogTable=eventLogTable, datadirect=datadirect, poolIndex=poolIndex, DisplayString=DisplayString, physicalDiskEntry=physicalDiskEntry, physDiskSlot=physDiskSlot, eventLog=eventLog, physDiskIndex=physDiskIndex, powerIndex=powerIndex, unit=unit, fanEncId=fanEncId, powerStatus=powerStatus, tempEntry=tempEntry, eventLogEntry=eventLogEntry, fanNumber=fanNumber, eventLogLevel=eventLogLevel)
