...
# Produced by pysmi-1.1.12 at Tue Jun 18 01:37:25 2024
...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Bits, TimeTicks, enterprises, MibIdentifier, iso, Integer32, ModuleIdentity, NotificationType, Counter64, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Bits", "TimeTicks", "enterprises", "MibIdentifier", "iso", "Integer32", "ModuleIdentity", "NotificationType", "Counter64", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("SFA-INFO", physicalDiskTable=physicalDiskTable, eventLogIndex=eventLogIndex, fanIndex=fanIndex, eventLogEntry=eventLogEntry, poolType=poolType, tempEncPos=tempEncPos, poolNumber=poolNumber, fanNumber=fanNumber, tempStatus=tempStatus, fanTable=fanTable, tempEncId=tempEncId, physDiskSlot=physDiskSlot, powerEncId=powerEncId, fanEncId=fanEncId, tempNumber=tempNumber, physDiskId=physDiskId, poolNumDisks=poolNumDisks, powerStatus=powerStatus, physDiskEnc=physDiskEnc, eventLogDescr=eventLogDescr, unit=unit, tempTable=tempTable, powerEncPos=powerEncPos, poolId=poolId, physDiskWWN=physDiskWWN, powerNumber=powerNumber, physDiskState=physDiskState, powerIndex=powerIndex, systemName=systemName, poolTable=poolTable, fanStatus=fanStatus, physicalDiskEntry=physicalDiskEntry, powerTable=powerTable, poolIndex=poolIndex, tempIndex=tempIndex, eventLogTable=eventLogTable, fanEntry=fanEntry, DisplayString=DisplayString, poolEntry=poolEntry, physDiskPoolId=physDiskPoolId, eventLogTrapLevel=eventLogTrapLevel, eventLogLevel=eventLogLevel, powerEntry=powerEntry, tempEntry=tempEntry, fanEncPos=fanEncPos, physDiskIndex=physDiskIndex, datadirect=datadirect, eventLog=eventLog, eventLogNumEntries=eventLogNumEntries)
