...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:52:35 2021
...
Gauge32, Unsigned32, ObjectIdentity, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Integer32, NotificationType, MibIdentifier, Counter32, Counter64, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "ObjectIdentity", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Integer32", "NotificationType", "MibIdentifier", "Counter32", "Counter64", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", powerNumber=powerNumber, powerEncId=powerEncId, eventLogDescr=eventLogDescr, physDiskWWN=physDiskWWN, eventLogTable=eventLogTable, poolId=poolId, poolTable=poolTable, tempNumber=tempNumber, physicalDiskTable=physicalDiskTable, powerStatus=powerStatus, fanIndex=fanIndex, fanEncId=fanEncId, physDiskIndex=physDiskIndex, eventLogEntry=eventLogEntry, poolNumber=poolNumber, fanTable=fanTable, poolType=poolType, tempEncId=tempEncId, eventLogLevel=eventLogLevel, fanEncPos=fanEncPos, physDiskSlot=physDiskSlot, systemName=systemName, DisplayString=DisplayString, eventLog=eventLog, powerTable=powerTable, datadirect=datadirect, fanStatus=fanStatus, tempEntry=tempEntry, unit=unit, physDiskState=physDiskState, physicalDiskEntry=physicalDiskEntry, tempIndex=tempIndex, poolIndex=poolIndex, eventLogTrapLevel=eventLogTrapLevel, eventLogNumEntries=eventLogNumEntries, physDiskId=physDiskId, tempEncPos=tempEncPos, fanNumber=fanNumber, physDiskEnc=physDiskEnc, powerEntry=powerEntry, fanEntry=fanEntry, poolNumDisks=poolNumDisks, eventLogIndex=eventLogIndex, powerIndex=powerIndex, physDiskPoolId=physDiskPoolId, poolEntry=poolEntry, powerEncPos=powerEncPos, tempStatus=tempStatus, tempTable=tempTable)
