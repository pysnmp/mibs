...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:58:16 2021
...
Unsigned32, TimeTicks, enterprises, IpAddress, Counter32, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, ModuleIdentity, Gauge32, Bits, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "enterprises", "IpAddress", "Counter32", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "ModuleIdentity", "Gauge32", "Bits", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", DisplayString=DisplayString, physDiskIndex=physDiskIndex, powerTable=powerTable, powerEntry=powerEntry, powerEncPos=powerEncPos, eventLogTable=eventLogTable, tempIndex=tempIndex, fanEncPos=fanEncPos, fanStatus=fanStatus, physDiskWWN=physDiskWWN, datadirect=datadirect, fanEntry=fanEntry, fanIndex=fanIndex, powerStatus=powerStatus, tempTable=tempTable, eventLogEntry=eventLogEntry, powerIndex=powerIndex, powerEncId=powerEncId, physicalDiskTable=physicalDiskTable, systemName=systemName, fanEncId=fanEncId, eventLogIndex=eventLogIndex, fanTable=fanTable, physicalDiskEntry=physicalDiskEntry, eventLogNumEntries=eventLogNumEntries, poolNumDisks=poolNumDisks, eventLogLevel=eventLogLevel, poolEntry=poolEntry, eventLog=eventLog, eventLogTrapLevel=eventLogTrapLevel, tempEntry=tempEntry, unit=unit, physDiskPoolId=physDiskPoolId, physDiskId=physDiskId, physDiskEnc=physDiskEnc, poolIndex=poolIndex, tempStatus=tempStatus, eventLogDescr=eventLogDescr, poolId=poolId, physDiskSlot=physDiskSlot, tempNumber=tempNumber, tempEncId=tempEncId, poolTable=poolTable, poolNumber=poolNumber, fanNumber=fanNumber, tempEncPos=tempEncPos, physDiskState=physDiskState, poolType=poolType, powerNumber=powerNumber)
