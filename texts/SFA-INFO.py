...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:14:12 2022
...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, ModuleIdentity, TimeTicks, Gauge32, Counter64, iso, NotificationType, Unsigned32, IpAddress, ObjectIdentity, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "ModuleIdentity", "TimeTicks", "Gauge32", "Counter64", "iso", "NotificationType", "Unsigned32", "IpAddress", "ObjectIdentity", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", DisplayString=DisplayString, physDiskIndex=physDiskIndex, physDiskId=physDiskId, eventLogTrapLevel=eventLogTrapLevel, eventLogLevel=eventLogLevel, poolId=poolId, eventLogEntry=eventLogEntry, fanEntry=fanEntry, tempStatus=tempStatus, tempTable=tempTable, physDiskWWN=physDiskWWN, eventLogTable=eventLogTable, eventLogNumEntries=eventLogNumEntries, powerIndex=powerIndex, physDiskEnc=physDiskEnc, systemName=systemName, fanIndex=fanIndex, poolIndex=poolIndex, datadirect=datadirect, physicalDiskTable=physicalDiskTable, powerEntry=powerEntry, physDiskSlot=physDiskSlot, poolNumber=poolNumber, powerTable=powerTable, poolEntry=poolEntry, poolTable=poolTable, poolType=poolType, physDiskPoolId=physDiskPoolId, tempEncPos=tempEncPos, eventLogIndex=eventLogIndex, tempIndex=tempIndex, fanTable=fanTable, physDiskState=physDiskState, fanStatus=fanStatus, tempEncId=tempEncId, fanEncId=fanEncId, powerEncPos=powerEncPos, powerEncId=powerEncId, physicalDiskEntry=physicalDiskEntry, powerNumber=powerNumber, eventLogDescr=eventLogDescr, unit=unit, eventLog=eventLog, tempEntry=tempEntry, poolNumDisks=poolNumDisks, powerStatus=powerStatus, fanNumber=fanNumber, tempNumber=tempNumber, fanEncPos=fanEncPos)
