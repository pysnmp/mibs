...
enterprises, Unsigned32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Integer32, Bits, Counter32, NotificationType, ModuleIdentity, ObjectIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Integer32", "Bits", "Counter32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("SFA-INFO", unit=unit, eventLogNumEntries=eventLogNumEntries, poolIndex=poolIndex, fanTable=fanTable, physDiskEnc=physDiskEnc, eventLogEntry=eventLogEntry, poolTable=poolTable, DisplayString=DisplayString, fanEntry=fanEntry, tempEntry=tempEntry, eventLogLevel=eventLogLevel, systemName=systemName, powerEntry=powerEntry, physicalDiskEntry=physicalDiskEntry, fanEncId=fanEncId, datadirect=datadirect, powerNumber=powerNumber, fanIndex=fanIndex, physicalDiskTable=physicalDiskTable, tempNumber=tempNumber, physDiskId=physDiskId, poolId=poolId, physDiskSlot=physDiskSlot, eventLog=eventLog, physDiskWWN=physDiskWWN, powerTable=powerTable, eventLogTrapLevel=eventLogTrapLevel, tempIndex=tempIndex, fanEncPos=fanEncPos, fanStatus=fanStatus, physDiskIndex=physDiskIndex, poolType=poolType, eventLogTable=eventLogTable, fanNumber=fanNumber, tempStatus=tempStatus, tempEncId=tempEncId, powerEncId=powerEncId, powerEncPos=powerEncPos, tempTable=tempTable, powerStatus=powerStatus, poolNumDisks=poolNumDisks, eventLogDescr=eventLogDescr, poolNumber=poolNumber, powerIndex=powerIndex, physDiskState=physDiskState, physDiskPoolId=physDiskPoolId, tempEncPos=tempEncPos, eventLogIndex=eventLogIndex, poolEntry=poolEntry)
