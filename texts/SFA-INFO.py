...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:16:05 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Counter32, Gauge32, Bits, iso, enterprises, Integer32, ModuleIdentity, Unsigned32, NotificationType, TimeTicks, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Counter32", "Gauge32", "Bits", "iso", "enterprises", "Integer32", "ModuleIdentity", "Unsigned32", "NotificationType", "TimeTicks", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("SFA-INFO", systemName=systemName, powerEntry=powerEntry, poolNumber=poolNumber, eventLogDescr=eventLogDescr, eventLogNumEntries=eventLogNumEntries, poolNumDisks=poolNumDisks, tempNumber=tempNumber, datadirect=datadirect, physDiskWWN=physDiskWWN, eventLogIndex=eventLogIndex, powerEncPos=powerEncPos, fanEncPos=fanEncPos, poolType=poolType, fanIndex=fanIndex, tempTable=tempTable, physicalDiskTable=physicalDiskTable, physDiskSlot=physDiskSlot, powerIndex=powerIndex, tempEntry=tempEntry, eventLogTable=eventLogTable, fanEntry=fanEntry, eventLog=eventLog, physDiskState=physDiskState, poolId=poolId, powerEncId=powerEncId, tempStatus=tempStatus, eventLogEntry=eventLogEntry, tempEncPos=tempEncPos, fanTable=fanTable, poolTable=poolTable, poolIndex=poolIndex, physDiskIndex=physDiskIndex, tempEncId=tempEncId, tempIndex=tempIndex, physicalDiskEntry=physicalDiskEntry, DisplayString=DisplayString, fanEncId=fanEncId, physDiskPoolId=physDiskPoolId, powerStatus=powerStatus, powerTable=powerTable, fanStatus=fanStatus, unit=unit, powerNumber=powerNumber, fanNumber=fanNumber, eventLogLevel=eventLogLevel, physDiskId=physDiskId, eventLogTrapLevel=eventLogTrapLevel, poolEntry=poolEntry, physDiskEnc=physDiskEnc)
