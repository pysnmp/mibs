...
# Produced by pysmi-1.1.8 at Fri Dec  2 17:04:25 2022
...
Bits, NotificationType, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, ModuleIdentity, Integer32, Gauge32, enterprises, IpAddress, Unsigned32, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "ModuleIdentity", "Integer32", "Gauge32", "enterprises", "IpAddress", "Unsigned32", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("SFA-INFO", powerNumber=powerNumber, poolEntry=poolEntry, poolType=poolType, eventLogIndex=eventLogIndex, poolNumber=poolNumber, fanEntry=fanEntry, poolNumDisks=poolNumDisks, physDiskIndex=physDiskIndex, powerEncId=powerEncId, physDiskId=physDiskId, physDiskWWN=physDiskWWN, systemName=systemName, physDiskPoolId=physDiskPoolId, powerEntry=powerEntry, datadirect=datadirect, tempStatus=tempStatus, powerEncPos=powerEncPos, fanEncId=fanEncId, poolIndex=poolIndex, eventLogNumEntries=eventLogNumEntries, fanIndex=fanIndex, unit=unit, tempEncPos=tempEncPos, poolId=poolId, tempIndex=tempIndex, physicalDiskTable=physicalDiskTable, powerStatus=powerStatus, physDiskState=physDiskState, eventLog=eventLog, eventLogEntry=eventLogEntry, fanEncPos=fanEncPos, eventLogLevel=eventLogLevel, fanNumber=fanNumber, tempEntry=tempEntry, eventLogTrapLevel=eventLogTrapLevel, powerTable=powerTable, physDiskSlot=physDiskSlot, fanTable=fanTable, fanStatus=fanStatus, DisplayString=DisplayString, physDiskEnc=physDiskEnc, physicalDiskEntry=physicalDiskEntry, eventLogTable=eventLogTable, tempNumber=tempNumber, eventLogDescr=eventLogDescr, tempEncId=tempEncId, powerIndex=powerIndex, poolTable=poolTable, tempTable=tempTable)
