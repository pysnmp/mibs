...
# Produced by pysmi-1.1.8 at Thu Sep  8 10:14:41 2022
...
enterprises, Bits, iso, IpAddress, TimeTicks, ModuleIdentity, Unsigned32, ObjectIdentity, NotificationType, Integer32, Counter32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "iso", "IpAddress", "TimeTicks", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "NotificationType", "Integer32", "Counter32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("SFA-INFO", fanNumber=fanNumber, powerEncId=powerEncId, physDiskState=physDiskState, tempStatus=tempStatus, physDiskEnc=physDiskEnc, fanEncId=fanEncId, tempEntry=tempEntry, powerIndex=powerIndex, eventLogTable=eventLogTable, poolType=poolType, tempEncId=tempEncId, tempIndex=tempIndex, tempEncPos=tempEncPos, poolNumber=poolNumber, tempTable=tempTable, powerStatus=powerStatus, fanIndex=fanIndex, fanEncPos=fanEncPos, powerNumber=powerNumber, physDiskIndex=physDiskIndex, DisplayString=DisplayString, fanTable=fanTable, powerEncPos=powerEncPos, physicalDiskTable=physicalDiskTable, eventLogLevel=eventLogLevel, eventLogDescr=eventLogDescr, unit=unit, physDiskId=physDiskId, poolId=poolId, systemName=systemName, datadirect=datadirect, powerTable=powerTable, poolEntry=poolEntry, fanEntry=fanEntry, tempNumber=tempNumber, physDiskSlot=physDiskSlot, eventLogEntry=eventLogEntry, poolNumDisks=poolNumDisks, eventLogIndex=eventLogIndex, fanStatus=fanStatus, poolIndex=poolIndex, physicalDiskEntry=physicalDiskEntry, physDiskWWN=physDiskWWN, powerEntry=powerEntry, eventLogTrapLevel=eventLogTrapLevel, poolTable=poolTable, eventLog=eventLog, eventLogNumEntries=eventLogNumEntries, physDiskPoolId=physDiskPoolId)
