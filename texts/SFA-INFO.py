...
# Produced by pysmi-1.1.10 at Mon Feb 12 02:21:03 2024
...
enterprises, iso, Counter32, Counter64, ObjectIdentity, IpAddress, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, ModuleIdentity, Bits, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "Counter32", "Counter64", "ObjectIdentity", "IpAddress", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "ModuleIdentity", "Bits", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("SFA-INFO", poolNumber=poolNumber, fanEncId=fanEncId, tempNumber=tempNumber, powerTable=powerTable, powerEncPos=powerEncPos, powerNumber=powerNumber, unit=unit, physDiskEnc=physDiskEnc, powerEncId=powerEncId, eventLogEntry=eventLogEntry, eventLog=eventLog, poolTable=poolTable, poolId=poolId, physicalDiskEntry=physicalDiskEntry, fanIndex=fanIndex, fanNumber=fanNumber, physicalDiskTable=physicalDiskTable, physDiskSlot=physDiskSlot, systemName=systemName, tempEncPos=tempEncPos, eventLogTrapLevel=eventLogTrapLevel, tempEncId=tempEncId, physDiskState=physDiskState, fanEntry=fanEntry, fanStatus=fanStatus, physDiskIndex=physDiskIndex, eventLogNumEntries=eventLogNumEntries, eventLogTable=eventLogTable, eventLogIndex=eventLogIndex, poolType=poolType, physDiskId=physDiskId, powerIndex=powerIndex, poolIndex=poolIndex, eventLogLevel=eventLogLevel, fanTable=fanTable, fanEncPos=fanEncPos, eventLogDescr=eventLogDescr, physDiskWWN=physDiskWWN, tempTable=tempTable, datadirect=datadirect, tempEntry=tempEntry, tempIndex=tempIndex, tempStatus=tempStatus, poolNumDisks=poolNumDisks, poolEntry=poolEntry, DisplayString=DisplayString, powerEntry=powerEntry, physDiskPoolId=physDiskPoolId, powerStatus=powerStatus)
