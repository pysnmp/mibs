...
# Produced by pysmi-1.1.11 at Wed Apr  3 13:43:17 2024
...
iso, Integer32, IpAddress, NotificationType, enterprises, TimeTicks, Counter64, ObjectIdentity, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "IpAddress", "NotificationType", "enterprises", "TimeTicks", "Counter64", "ObjectIdentity", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Bits", "Counter32")
...
mibBuilder.exportSymbols("SFA-INFO", powerEncId=powerEncId, fanTable=fanTable, tempIndex=tempIndex, poolNumDisks=poolNumDisks, physicalDiskTable=physicalDiskTable, powerEncPos=powerEncPos, eventLogTrapLevel=eventLogTrapLevel, tempNumber=tempNumber, eventLogIndex=eventLogIndex, tempEntry=tempEntry, fanStatus=fanStatus, DisplayString=DisplayString, datadirect=datadirect, physDiskId=physDiskId, fanEntry=fanEntry, physDiskWWN=physDiskWWN, physicalDiskEntry=physicalDiskEntry, tempEncId=tempEncId, physDiskEnc=physDiskEnc, powerStatus=powerStatus, eventLog=eventLog, fanEncPos=fanEncPos, eventLogNumEntries=eventLogNumEntries, eventLogTable=eventLogTable, poolId=poolId, powerNumber=powerNumber, unit=unit, powerEntry=powerEntry, fanNumber=fanNumber, poolTable=poolTable, systemName=systemName, tempEncPos=tempEncPos, fanEncId=fanEncId, physDiskState=physDiskState, fanIndex=fanIndex, physDiskIndex=physDiskIndex, tempStatus=tempStatus, poolType=poolType, physDiskPoolId=physDiskPoolId, poolIndex=poolIndex, eventLogEntry=eventLogEntry, physDiskSlot=physDiskSlot, powerTable=powerTable, poolEntry=poolEntry, tempTable=tempTable, eventLogDescr=eventLogDescr, powerIndex=powerIndex, poolNumber=poolNumber, eventLogLevel=eventLogLevel)
