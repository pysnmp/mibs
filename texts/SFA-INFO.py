...
MibIdentifier, ModuleIdentity, iso, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Counter64, Unsigned32, Integer32, enterprises, Gauge32, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "iso", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Counter64", "Unsigned32", "Integer32", "enterprises", "Gauge32", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("SFA-INFO", poolNumDisks=poolNumDisks, physicalDiskEntry=physicalDiskEntry, datadirect=datadirect, eventLogNumEntries=eventLogNumEntries, eventLogEntry=eventLogEntry, powerNumber=powerNumber, poolNumber=poolNumber, powerEntry=powerEntry, tempEncId=tempEncId, eventLog=eventLog, unit=unit, tempStatus=tempStatus, powerIndex=powerIndex, systemName=systemName, eventLogDescr=eventLogDescr, fanStatus=fanStatus, physDiskIndex=physDiskIndex, poolEntry=poolEntry, fanTable=fanTable, tempTable=tempTable, fanEncPos=fanEncPos, tempEncPos=tempEncPos, powerStatus=powerStatus, fanNumber=fanNumber, poolIndex=poolIndex, physDiskId=physDiskId, powerEncPos=powerEncPos, physDiskSlot=physDiskSlot, powerTable=powerTable, physDiskEnc=physDiskEnc, eventLogIndex=eventLogIndex, poolTable=poolTable, tempNumber=tempNumber, fanIndex=fanIndex, tempIndex=tempIndex, physDiskWWN=physDiskWWN, powerEncId=powerEncId, fanEncId=fanEncId, fanEntry=fanEntry, DisplayString=DisplayString, eventLogTrapLevel=eventLogTrapLevel, poolType=poolType, physicalDiskTable=physicalDiskTable, tempEntry=tempEntry, physDiskState=physDiskState, eventLogTable=eventLogTable, poolId=poolId, physDiskPoolId=physDiskPoolId, eventLogLevel=eventLogLevel)
