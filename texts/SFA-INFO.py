...
ObjectIdentity, Counter64, Gauge32, MibIdentifier, IpAddress, iso, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, NotificationType, enterprises, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Gauge32", "MibIdentifier", "IpAddress", "iso", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "NotificationType", "enterprises", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", poolType=poolType, eventLogTable=eventLogTable, DisplayString=DisplayString, physDiskIndex=physDiskIndex, physDiskPoolId=physDiskPoolId, eventLogEntry=eventLogEntry, eventLogDescr=eventLogDescr, datadirect=datadirect, physDiskSlot=physDiskSlot, tempTable=tempTable, tempNumber=tempNumber, eventLogTrapLevel=eventLogTrapLevel, physDiskWWN=physDiskWWN, powerEncId=powerEncId, poolEntry=poolEntry, tempIndex=tempIndex, poolIndex=poolIndex, poolId=poolId, physDiskState=physDiskState, tempStatus=tempStatus, powerIndex=powerIndex, poolNumDisks=poolNumDisks, powerStatus=powerStatus, physDiskEnc=physDiskEnc, systemName=systemName, tempEncId=tempEncId, eventLog=eventLog, fanIndex=fanIndex, powerEntry=powerEntry, powerTable=powerTable, physDiskId=physDiskId, unit=unit, poolTable=poolTable, tempEncPos=tempEncPos, fanEncId=fanEncId, fanNumber=fanNumber, physicalDiskEntry=physicalDiskEntry, powerEncPos=powerEncPos, tempEntry=tempEntry, fanStatus=fanStatus, fanEntry=fanEntry, fanEncPos=fanEncPos, powerNumber=powerNumber, poolNumber=poolNumber, eventLogNumEntries=eventLogNumEntries, eventLogIndex=eventLogIndex, fanTable=fanTable, physicalDiskTable=physicalDiskTable, eventLogLevel=eventLogLevel)
