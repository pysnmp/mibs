...
ModuleIdentity, Unsigned32, Integer32, TimeTicks, ObjectIdentity, Counter64, Counter32, IpAddress, MibIdentifier, NotificationType, enterprises, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Integer32", "TimeTicks", "ObjectIdentity", "Counter64", "Counter32", "IpAddress", "MibIdentifier", "NotificationType", "enterprises", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("SFA-INFO", powerStatus=powerStatus, fanEncPos=fanEncPos, poolNumber=poolNumber, poolEntry=poolEntry, tempEncPos=tempEncPos, eventLogEntry=eventLogEntry, powerTable=powerTable, tempIndex=tempIndex, physDiskWWN=physDiskWWN, eventLogLevel=eventLogLevel, tempStatus=tempStatus, DisplayString=DisplayString, fanIndex=fanIndex, powerEntry=powerEntry, physDiskPoolId=physDiskPoolId, eventLogTrapLevel=eventLogTrapLevel, eventLogTable=eventLogTable, physicalDiskEntry=physicalDiskEntry, eventLog=eventLog, poolTable=poolTable, fanEntry=fanEntry, physDiskState=physDiskState, physDiskSlot=physDiskSlot, fanEncId=fanEncId, powerIndex=powerIndex, powerEncPos=powerEncPos, physDiskId=physDiskId, tempTable=tempTable, physicalDiskTable=physicalDiskTable, poolType=poolType, eventLogDescr=eventLogDescr, unit=unit, powerNumber=powerNumber, poolNumDisks=poolNumDisks, fanStatus=fanStatus, eventLogIndex=eventLogIndex, fanTable=fanTable, tempEncId=tempEncId, poolId=poolId, physDiskEnc=physDiskEnc, physDiskIndex=physDiskIndex, tempNumber=tempNumber, fanNumber=fanNumber, tempEntry=tempEntry, poolIndex=poolIndex, systemName=systemName, datadirect=datadirect, powerEncId=powerEncId, eventLogNumEntries=eventLogNumEntries)
