...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:08:02 2021
...
Counter32, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity, iso, NotificationType, IpAddress, TimeTicks, Gauge32, MibIdentifier, Counter64, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity", "iso", "NotificationType", "IpAddress", "TimeTicks", "Gauge32", "MibIdentifier", "Counter64", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskId=physDiskId, fanEncId=fanEncId, eventLog=eventLog, physicalDiskEntry=physicalDiskEntry, eventLogDescr=eventLogDescr, tempEncPos=tempEncPos, systemName=systemName, eventLogNumEntries=eventLogNumEntries, tempTable=tempTable, tempEntry=tempEntry, fanEncPos=fanEncPos, fanStatus=fanStatus, fanNumber=fanNumber, powerNumber=powerNumber, powerEncId=powerEncId, physDiskPoolId=physDiskPoolId, tempNumber=tempNumber, physDiskSlot=physDiskSlot, unit=unit, poolTable=poolTable, fanIndex=fanIndex, physDiskIndex=physDiskIndex, DisplayString=DisplayString, eventLogIndex=eventLogIndex, powerTable=powerTable, poolType=poolType, powerStatus=powerStatus, eventLogTrapLevel=eventLogTrapLevel, fanTable=fanTable, poolNumber=poolNumber, physDiskState=physDiskState, tempEncId=tempEncId, physDiskWWN=physDiskWWN, eventLogTable=eventLogTable, physDiskEnc=physDiskEnc, tempIndex=tempIndex, fanEntry=fanEntry, datadirect=datadirect, poolIndex=poolIndex, physicalDiskTable=physicalDiskTable, poolEntry=poolEntry, tempStatus=tempStatus, powerEncPos=powerEncPos, eventLogEntry=eventLogEntry, eventLogLevel=eventLogLevel, powerIndex=powerIndex, poolNumDisks=poolNumDisks, poolId=poolId, powerEntry=powerEntry)
