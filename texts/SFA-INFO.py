...
# Produced by pysmi-1.1.8 at Thu Oct 26 11:03:33 2023
...
ObjectIdentity, Unsigned32, Counter32, NotificationType, Counter64, IpAddress, ModuleIdentity, Bits, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Counter32", "NotificationType", "Counter64", "IpAddress", "ModuleIdentity", "Bits", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("SFA-INFO", tempEntry=tempEntry, poolType=poolType, tempNumber=tempNumber, poolId=poolId, physDiskWWN=physDiskWWN, tempIndex=tempIndex, fanIndex=fanIndex, fanEncId=fanEncId, powerEncId=powerEncId, tempTable=tempTable, unit=unit, fanEncPos=fanEncPos, powerEncPos=powerEncPos, poolIndex=poolIndex, eventLogTrapLevel=eventLogTrapLevel, powerTable=powerTable, physDiskSlot=physDiskSlot, datadirect=datadirect, tempStatus=tempStatus, fanEntry=fanEntry, fanStatus=fanStatus, physDiskState=physDiskState, eventLogLevel=eventLogLevel, DisplayString=DisplayString, tempEncPos=tempEncPos, powerIndex=powerIndex, poolNumber=poolNumber, eventLogEntry=eventLogEntry, poolNumDisks=poolNumDisks, poolTable=poolTable, eventLogNumEntries=eventLogNumEntries, fanNumber=fanNumber, physicalDiskEntry=physicalDiskEntry, powerEntry=powerEntry, eventLogDescr=eventLogDescr, eventLog=eventLog, physDiskId=physDiskId, physDiskEnc=physDiskEnc, physicalDiskTable=physicalDiskTable, systemName=systemName, eventLogIndex=eventLogIndex, physDiskIndex=physDiskIndex, powerNumber=powerNumber, physDiskPoolId=physDiskPoolId, tempEncId=tempEncId, fanTable=fanTable, eventLogTable=eventLogTable, powerStatus=powerStatus, poolEntry=poolEntry)
