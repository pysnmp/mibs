...
# Produced by pysmi-1.1.10 at Fri Nov 10 07:39:58 2023
...
Bits, ObjectIdentity, TimeTicks, enterprises, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, IpAddress, Counter64, Gauge32, iso, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "TimeTicks", "enterprises", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "IpAddress", "Counter64", "Gauge32", "iso", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("SFA-INFO", tempIndex=tempIndex, poolEntry=poolEntry, physicalDiskTable=physicalDiskTable, eventLogLevel=eventLogLevel, tempEntry=tempEntry, physDiskSlot=physDiskSlot, tempTable=tempTable, fanTable=fanTable, powerEncId=powerEncId, poolIndex=poolIndex, DisplayString=DisplayString, powerEncPos=powerEncPos, poolNumber=poolNumber, eventLogEntry=eventLogEntry, eventLogIndex=eventLogIndex, tempEncId=tempEncId, physDiskEnc=physDiskEnc, tempStatus=tempStatus, powerEntry=powerEntry, fanEntry=fanEntry, eventLogNumEntries=eventLogNumEntries, eventLog=eventLog, powerTable=powerTable, eventLogTable=eventLogTable, datadirect=datadirect, fanEncPos=fanEncPos, systemName=systemName, physicalDiskEntry=physicalDiskEntry, unit=unit, poolId=poolId, physDiskId=physDiskId, powerNumber=powerNumber, eventLogTrapLevel=eventLogTrapLevel, tempEncPos=tempEncPos, physDiskIndex=physDiskIndex, fanNumber=fanNumber, eventLogDescr=eventLogDescr, poolType=poolType, physDiskWWN=physDiskWWN, fanIndex=fanIndex, powerStatus=powerStatus, poolTable=poolTable, powerIndex=powerIndex, fanEncId=fanEncId, poolNumDisks=poolNumDisks, physDiskState=physDiskState, fanStatus=fanStatus, physDiskPoolId=physDiskPoolId, tempNumber=tempNumber)
