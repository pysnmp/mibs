...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:39:19 2023
...
iso, Gauge32, Bits, NotificationType, Integer32, Counter32, Counter64, Unsigned32, enterprises, ModuleIdentity, MibIdentifier, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Bits", "NotificationType", "Integer32", "Counter32", "Counter64", "Unsigned32", "enterprises", "ModuleIdentity", "MibIdentifier", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", poolTable=poolTable, eventLogEntry=eventLogEntry, fanIndex=fanIndex, fanEncPos=fanEncPos, physDiskSlot=physDiskSlot, poolEntry=poolEntry, datadirect=datadirect, powerEncPos=powerEncPos, fanStatus=fanStatus, poolId=poolId, poolNumber=poolNumber, powerIndex=powerIndex, tempNumber=tempNumber, fanNumber=fanNumber, eventLogTrapLevel=eventLogTrapLevel, fanEncId=fanEncId, powerNumber=powerNumber, physDiskPoolId=physDiskPoolId, DisplayString=DisplayString, powerStatus=powerStatus, systemName=systemName, eventLogNumEntries=eventLogNumEntries, physDiskWWN=physDiskWWN, poolIndex=poolIndex, poolNumDisks=poolNumDisks, tempEncId=tempEncId, eventLogLevel=eventLogLevel, powerTable=powerTable, physDiskEnc=physDiskEnc, physDiskIndex=physDiskIndex, physDiskState=physDiskState, tempEntry=tempEntry, eventLog=eventLog, tempEncPos=tempEncPos, eventLogIndex=eventLogIndex, eventLogDescr=eventLogDescr, fanEntry=fanEntry, physDiskId=physDiskId, tempStatus=tempStatus, eventLogTable=eventLogTable, unit=unit, physicalDiskTable=physicalDiskTable, tempTable=tempTable, poolType=poolType, tempIndex=tempIndex, physicalDiskEntry=physicalDiskEntry, powerEncId=powerEncId, powerEntry=powerEntry, fanTable=fanTable)
