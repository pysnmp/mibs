...
MibIdentifier, NotificationType, ObjectIdentity, Counter64, enterprises, TimeTicks, Gauge32, IpAddress, Bits, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "ObjectIdentity", "Counter64", "enterprises", "TimeTicks", "Gauge32", "IpAddress", "Bits", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", fanEncPos=fanEncPos, poolEntry=poolEntry, systemName=systemName, poolNumber=poolNumber, tempNumber=tempNumber, powerEntry=powerEntry, physDiskIndex=physDiskIndex, fanTable=fanTable, poolId=poolId, tempStatus=tempStatus, fanEncId=fanEncId, poolTable=poolTable, physicalDiskTable=physicalDiskTable, eventLogNumEntries=eventLogNumEntries, tempEntry=tempEntry, tempTable=tempTable, eventLog=eventLog, powerTable=powerTable, eventLogTable=eventLogTable, tempIndex=tempIndex, eventLogEntry=eventLogEntry, powerEncPos=powerEncPos, poolIndex=poolIndex, eventLogLevel=eventLogLevel, tempEncId=tempEncId, physDiskPoolId=physDiskPoolId, unit=unit, DisplayString=DisplayString, fanIndex=fanIndex, eventLogTrapLevel=eventLogTrapLevel, eventLogDescr=eventLogDescr, tempEncPos=tempEncPos, powerEncId=powerEncId, powerIndex=powerIndex, powerNumber=powerNumber, physDiskWWN=physDiskWWN, physDiskEnc=physDiskEnc, fanEntry=fanEntry, physicalDiskEntry=physicalDiskEntry, powerStatus=powerStatus, physDiskId=physDiskId, eventLogIndex=eventLogIndex, poolType=poolType, physDiskSlot=physDiskSlot, fanNumber=fanNumber, fanStatus=fanStatus, physDiskState=physDiskState, poolNumDisks=poolNumDisks, datadirect=datadirect)
