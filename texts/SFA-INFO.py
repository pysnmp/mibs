...
# Produced by pysmi-1.1.12 at Mon Jun  3 14:04:51 2024
...
TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Integer32, ModuleIdentity, ObjectIdentity, enterprises, Unsigned32, IpAddress, MibIdentifier, iso, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Integer32", "ModuleIdentity", "ObjectIdentity", "enterprises", "Unsigned32", "IpAddress", "MibIdentifier", "iso", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("SFA-INFO", poolType=poolType, powerNumber=powerNumber, tempTable=tempTable, eventLogDescr=eventLogDescr, physicalDiskTable=physicalDiskTable, powerEntry=powerEntry, eventLogNumEntries=eventLogNumEntries, physDiskWWN=physDiskWWN, tempNumber=tempNumber, poolTable=poolTable, fanStatus=fanStatus, tempEncId=tempEncId, powerEncId=powerEncId, physDiskIndex=physDiskIndex, datadirect=datadirect, systemName=systemName, eventLogTrapLevel=eventLogTrapLevel, poolNumber=poolNumber, tempEntry=tempEntry, fanEntry=fanEntry, fanEncId=fanEncId, powerEncPos=powerEncPos, poolEntry=poolEntry, eventLogTable=eventLogTable, unit=unit, physDiskSlot=physDiskSlot, eventLogEntry=eventLogEntry, powerTable=powerTable, tempIndex=tempIndex, physDiskId=physDiskId, poolIndex=poolIndex, poolId=poolId, fanNumber=fanNumber, eventLogIndex=eventLogIndex, eventLog=eventLog, poolNumDisks=poolNumDisks, fanEncPos=fanEncPos, tempStatus=tempStatus, DisplayString=DisplayString, powerIndex=powerIndex, physDiskEnc=physDiskEnc, powerStatus=powerStatus, physDiskState=physDiskState, fanIndex=fanIndex, physDiskPoolId=physDiskPoolId, tempEncPos=tempEncPos, fanTable=fanTable, eventLogLevel=eventLogLevel, physicalDiskEntry=physicalDiskEntry)
