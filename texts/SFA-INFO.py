...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:09:58 2024
...
mibBuilder.exportSymbols("SFA-INFO", fanTable=fanTable, powerNumber=powerNumber, physDiskSlot=physDiskSlot, tempEncPos=tempEncPos, systemName=systemName, eventLogEntry=eventLogEntry, fanEntry=fanEntry, poolNumDisks=poolNumDisks, powerEntry=powerEntry, poolEntry=poolEntry, powerTable=powerTable, physDiskEnc=physDiskEnc, fanNumber=fanNumber, powerEncPos=powerEncPos, powerStatus=powerStatus, eventLogIndex=eventLogIndex, powerEncId=powerEncId, powerIndex=powerIndex, DisplayString=DisplayString, poolIndex=poolIndex, poolNumber=poolNumber, fanIndex=fanIndex, eventLog=eventLog, physicalDiskTable=physicalDiskTable, physDiskIndex=physDiskIndex, tempEncId=tempEncId, poolTable=poolTable, eventLogTable=eventLogTable, eventLogDescr=eventLogDescr, fanEncId=fanEncId, tempNumber=tempNumber, tempStatus=tempStatus, tempTable=tempTable, eventLogTrapLevel=eventLogTrapLevel, fanEncPos=fanEncPos, tempEntry=tempEntry, physicalDiskEntry=physicalDiskEntry, physDiskWWN=physDiskWWN, physDiskState=physDiskState, physDiskId=physDiskId, eventLogNumEntries=eventLogNumEntries, fanStatus=fanStatus, tempIndex=tempIndex, datadirect=datadirect, physDiskPoolId=physDiskPoolId, unit=unit, poolId=poolId, eventLogLevel=eventLogLevel, poolType=poolType)
