...
Gauge32, IpAddress, enterprises, ModuleIdentity, Unsigned32, iso, Counter64, Integer32, NotificationType, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "enterprises", "ModuleIdentity", "Unsigned32", "iso", "Counter64", "Integer32", "NotificationType", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("SFA-INFO", powerStatus=powerStatus, tempEntry=tempEntry, fanStatus=fanStatus, physicalDiskTable=physicalDiskTable, physDiskSlot=physDiskSlot, physDiskId=physDiskId, poolNumber=poolNumber, systemName=systemName, tempStatus=tempStatus, eventLog=eventLog, powerEncId=powerEncId, eventLogTable=eventLogTable, tempNumber=tempNumber, eventLogIndex=eventLogIndex, eventLogTrapLevel=eventLogTrapLevel, datadirect=datadirect, fanTable=fanTable, poolTable=poolTable, physicalDiskEntry=physicalDiskEntry, powerEncPos=powerEncPos, tempTable=tempTable, powerNumber=powerNumber, eventLogNumEntries=eventLogNumEntries, eventLogEntry=eventLogEntry, powerTable=powerTable, tempEncPos=tempEncPos, fanEntry=fanEntry, eventLogLevel=eventLogLevel, powerIndex=powerIndex, tempEncId=tempEncId, physDiskEnc=physDiskEnc, poolId=poolId, physDiskState=physDiskState, physDiskIndex=physDiskIndex, fanIndex=fanIndex, tempIndex=tempIndex, poolEntry=poolEntry, fanEncId=fanEncId, physDiskPoolId=physDiskPoolId, unit=unit, poolType=poolType, eventLogDescr=eventLogDescr, poolIndex=poolIndex, DisplayString=DisplayString, fanEncPos=fanEncPos, poolNumDisks=poolNumDisks, physDiskWWN=physDiskWWN, powerEntry=powerEntry, fanNumber=fanNumber)
