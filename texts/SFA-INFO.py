...
# Produced by pysmi-1.1.8 at Fri Jan  7 17:42:26 2022
...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, ModuleIdentity, Unsigned32, Integer32, IpAddress, ObjectIdentity, MibIdentifier, iso, Bits, Counter32, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "ModuleIdentity", "Unsigned32", "Integer32", "IpAddress", "ObjectIdentity", "MibIdentifier", "iso", "Bits", "Counter32", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("SFA-INFO", poolNumber=poolNumber, physDiskPoolId=physDiskPoolId, powerEntry=powerEntry, physDiskIndex=physDiskIndex, powerTable=powerTable, physDiskSlot=physDiskSlot, physDiskWWN=physDiskWWN, eventLogNumEntries=eventLogNumEntries, tempNumber=tempNumber, datadirect=datadirect, eventLogLevel=eventLogLevel, eventLogTable=eventLogTable, fanNumber=fanNumber, poolEntry=poolEntry, eventLogEntry=eventLogEntry, tempStatus=tempStatus, fanEntry=fanEntry, powerStatus=powerStatus, powerEncPos=powerEncPos, physDiskState=physDiskState, tempEncId=tempEncId, fanStatus=fanStatus, fanEncPos=fanEncPos, physDiskEnc=physDiskEnc, tempEncPos=tempEncPos, fanIndex=fanIndex, tempIndex=tempIndex, eventLog=eventLog, systemName=systemName, poolType=poolType, fanTable=fanTable, tempTable=tempTable, poolIndex=poolIndex, physicalDiskEntry=physicalDiskEntry, eventLogDescr=eventLogDescr, powerEncId=powerEncId, eventLogIndex=eventLogIndex, physicalDiskTable=physicalDiskTable, physDiskId=physDiskId, tempEntry=tempEntry, powerNumber=powerNumber, eventLogTrapLevel=eventLogTrapLevel, fanEncId=fanEncId, poolId=poolId, poolTable=poolTable, poolNumDisks=poolNumDisks, powerIndex=powerIndex, DisplayString=DisplayString, unit=unit)
