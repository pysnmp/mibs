...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:17:15 2023
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, TimeTicks, Bits, IpAddress, MibIdentifier, ObjectIdentity, Gauge32, iso, ModuleIdentity, Counter32, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "TimeTicks", "Bits", "IpAddress", "MibIdentifier", "ObjectIdentity", "Gauge32", "iso", "ModuleIdentity", "Counter32", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", physicalDiskTable=physicalDiskTable, tempEncPos=tempEncPos, poolId=poolId, powerEncPos=powerEncPos, physDiskPoolId=physDiskPoolId, tempStatus=tempStatus, poolTable=poolTable, datadirect=datadirect, tempEntry=tempEntry, systemName=systemName, eventLogNumEntries=eventLogNumEntries, tempTable=tempTable, fanNumber=fanNumber, fanEncPos=fanEncPos, powerStatus=powerStatus, fanEncId=fanEncId, powerEntry=powerEntry, eventLogEntry=eventLogEntry, poolNumDisks=poolNumDisks, unit=unit, DisplayString=DisplayString, eventLogIndex=eventLogIndex, eventLogLevel=eventLogLevel, physDiskWWN=physDiskWWN, tempIndex=tempIndex, powerIndex=powerIndex, tempEncId=tempEncId, tempNumber=tempNumber, poolEntry=poolEntry, fanStatus=fanStatus, eventLogDescr=eventLogDescr, eventLog=eventLog, powerEncId=powerEncId, poolIndex=poolIndex, eventLogTrapLevel=eventLogTrapLevel, physDiskEnc=physDiskEnc, physDiskSlot=physDiskSlot, physDiskIndex=physDiskIndex, powerNumber=powerNumber, physDiskId=physDiskId, powerTable=powerTable, poolNumber=poolNumber, poolType=poolType, physicalDiskEntry=physicalDiskEntry, fanEntry=fanEntry, physDiskState=physDiskState, fanTable=fanTable, fanIndex=fanIndex, eventLogTable=eventLogTable)
