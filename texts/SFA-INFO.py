...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:13:01 2023
...
Unsigned32, NotificationType, ModuleIdentity, Gauge32, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Counter32, iso, TimeTicks, enterprises, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "ModuleIdentity", "Gauge32", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Counter32", "iso", "TimeTicks", "enterprises", "Bits", "Counter64")
...
mibBuilder.exportSymbols("SFA-INFO", poolNumber=poolNumber, physicalDiskTable=physicalDiskTable, physDiskPoolId=physDiskPoolId, physDiskEnc=physDiskEnc, unit=unit, physDiskWWN=physDiskWWN, eventLogLevel=eventLogLevel, datadirect=datadirect, powerEncPos=powerEncPos, eventLogTrapLevel=eventLogTrapLevel, fanEncPos=fanEncPos, fanIndex=fanIndex, tempTable=tempTable, physDiskSlot=physDiskSlot, systemName=systemName, fanTable=fanTable, poolId=poolId, fanStatus=fanStatus, fanEncId=fanEncId, physDiskIndex=physDiskIndex, tempNumber=tempNumber, tempIndex=tempIndex, physDiskState=physDiskState, fanEntry=fanEntry, powerEntry=powerEntry, powerTable=powerTable, poolEntry=poolEntry, eventLogTable=eventLogTable, eventLogIndex=eventLogIndex, tempStatus=tempStatus, powerEncId=powerEncId, powerStatus=powerStatus, poolIndex=poolIndex, poolTable=poolTable, poolType=poolType, physDiskId=physDiskId, tempEntry=tempEntry, eventLogNumEntries=eventLogNumEntries, powerNumber=powerNumber, eventLog=eventLog, eventLogEntry=eventLogEntry, tempEncPos=tempEncPos, eventLogDescr=eventLogDescr, tempEncId=tempEncId, powerIndex=powerIndex, fanNumber=fanNumber, DisplayString=DisplayString, poolNumDisks=poolNumDisks, physicalDiskEntry=physicalDiskEntry)
