...
MibIdentifier, enterprises, Counter64, Counter32, ModuleIdentity, iso, TimeTicks, NotificationType, Unsigned32, Gauge32, ObjectIdentity, Integer32, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "Counter64", "Counter32", "ModuleIdentity", "iso", "TimeTicks", "NotificationType", "Unsigned32", "Gauge32", "ObjectIdentity", "Integer32", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SFA-INFO", poolEntry=poolEntry, fanEntry=fanEntry, powerTable=powerTable, fanEncId=fanEncId, physDiskEnc=physDiskEnc, fanNumber=fanNumber, eventLogLevel=eventLogLevel, datadirect=datadirect, physicalDiskEntry=physicalDiskEntry, powerIndex=powerIndex, eventLog=eventLog, tempEncId=tempEncId, powerEncPos=powerEncPos, poolNumber=poolNumber, tempTable=tempTable, fanTable=fanTable, poolId=poolId, tempNumber=tempNumber, DisplayString=DisplayString, tempEntry=tempEntry, powerEncId=powerEncId, systemName=systemName, eventLogTable=eventLogTable, eventLogEntry=eventLogEntry, poolTable=poolTable, poolIndex=poolIndex, physDiskPoolId=physDiskPoolId, powerStatus=powerStatus, powerEntry=powerEntry, eventLogDescr=eventLogDescr, physicalDiskTable=physicalDiskTable, powerNumber=powerNumber, physDiskId=physDiskId, fanIndex=fanIndex, fanEncPos=fanEncPos, physDiskSlot=physDiskSlot, fanStatus=fanStatus, physDiskState=physDiskState, poolNumDisks=poolNumDisks, eventLogTrapLevel=eventLogTrapLevel, physDiskWWN=physDiskWWN, eventLogNumEntries=eventLogNumEntries, tempIndex=tempIndex, unit=unit, physDiskIndex=physDiskIndex, tempEncPos=tempEncPos, eventLogIndex=eventLogIndex, tempStatus=tempStatus, poolType=poolType)
