...
# Produced by pysmi-1.1.12 at Tue Jun  4 14:10:19 2024
...
TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, Gauge32, IpAddress, MibIdentifier, ObjectIdentity, ModuleIdentity, Bits, iso, Counter32, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "Gauge32", "IpAddress", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Bits", "iso", "Counter32", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskSlot=physDiskSlot, fanTable=fanTable, eventLogEntry=eventLogEntry, eventLogLevel=eventLogLevel, physicalDiskEntry=physicalDiskEntry, poolEntry=poolEntry, tempTable=tempTable, eventLogIndex=eventLogIndex, physDiskPoolId=physDiskPoolId, poolIndex=poolIndex, poolTable=poolTable, poolType=poolType, tempEncId=tempEncId, poolId=poolId, tempEncPos=tempEncPos, eventLogDescr=eventLogDescr, fanEncPos=fanEncPos, physDiskState=physDiskState, physDiskIndex=physDiskIndex, datadirect=datadirect, powerEncPos=powerEncPos, tempStatus=tempStatus, powerStatus=powerStatus, poolNumber=poolNumber, DisplayString=DisplayString, powerTable=powerTable, eventLogNumEntries=eventLogNumEntries, fanNumber=fanNumber, powerEntry=powerEntry, poolNumDisks=poolNumDisks, physDiskId=physDiskId, powerEncId=powerEncId, fanIndex=fanIndex, systemName=systemName, fanEncId=fanEncId, fanEntry=fanEntry, fanStatus=fanStatus, physDiskWWN=physDiskWWN, tempEntry=tempEntry, physDiskEnc=physDiskEnc, unit=unit, physicalDiskTable=physicalDiskTable, eventLogTrapLevel=eventLogTrapLevel, powerIndex=powerIndex, tempIndex=tempIndex, eventLog=eventLog, powerNumber=powerNumber, tempNumber=tempNumber, eventLogTable=eventLogTable)
