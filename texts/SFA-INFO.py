...
# Produced by pysmi-1.1.8 at Thu Sep 29 12:42:38 2022
...
Counter64, TimeTicks, Unsigned32, MibIdentifier, Bits, Gauge32, ObjectIdentity, ModuleIdentity, IpAddress, enterprises, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Unsigned32", "MibIdentifier", "Bits", "Gauge32", "ObjectIdentity", "ModuleIdentity", "IpAddress", "enterprises", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("SFA-INFO", tempTable=tempTable, unit=unit, powerStatus=powerStatus, eventLogEntry=eventLogEntry, tempEncId=tempEncId, fanStatus=fanStatus, poolType=poolType, tempNumber=tempNumber, DisplayString=DisplayString, poolTable=poolTable, poolNumDisks=poolNumDisks, fanTable=fanTable, eventLogTable=eventLogTable, tempEncPos=tempEncPos, powerIndex=powerIndex, eventLogNumEntries=eventLogNumEntries, physDiskSlot=physDiskSlot, eventLogIndex=eventLogIndex, powerNumber=powerNumber, tempEntry=tempEntry, physDiskPoolId=physDiskPoolId, eventLogLevel=eventLogLevel, eventLogDescr=eventLogDescr, poolNumber=poolNumber, eventLog=eventLog, powerEncId=powerEncId, powerEncPos=powerEncPos, fanEntry=fanEntry, fanEncId=fanEncId, fanNumber=fanNumber, systemName=systemName, physicalDiskTable=physicalDiskTable, tempStatus=tempStatus, physDiskEnc=physDiskEnc, powerTable=powerTable, fanIndex=fanIndex, physicalDiskEntry=physicalDiskEntry, poolId=poolId, poolEntry=poolEntry, datadirect=datadirect, fanEncPos=fanEncPos, tempIndex=tempIndex, eventLogTrapLevel=eventLogTrapLevel, physDiskIndex=physDiskIndex, powerEntry=powerEntry, physDiskState=physDiskState, physDiskWWN=physDiskWWN, poolIndex=poolIndex, physDiskId=physDiskId)
