...
# Produced by pysmi-1.1.8 at Thu Jan  6 20:10:24 2022
...
NotificationType, iso, Gauge32, Unsigned32, Counter32, ObjectIdentity, Integer32, ModuleIdentity, Bits, enterprises, Counter64, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Gauge32", "Unsigned32", "Counter32", "ObjectIdentity", "Integer32", "ModuleIdentity", "Bits", "enterprises", "Counter64", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("SFA-INFO", physDiskEnc=physDiskEnc, eventLogIndex=eventLogIndex, systemName=systemName, tempIndex=tempIndex, physDiskSlot=physDiskSlot, fanIndex=fanIndex, eventLog=eventLog, physDiskId=physDiskId, fanStatus=fanStatus, powerEntry=powerEntry, tempStatus=tempStatus, eventLogLevel=eventLogLevel, tempTable=tempTable, physDiskPoolId=physDiskPoolId, poolId=poolId, powerNumber=powerNumber, tempEntry=tempEntry, poolTable=poolTable, datadirect=datadirect, powerEncId=powerEncId, powerStatus=powerStatus, fanEncPos=fanEncPos, fanEncId=fanEncId, physicalDiskTable=physicalDiskTable, powerIndex=powerIndex, poolIndex=poolIndex, fanNumber=fanNumber, poolType=poolType, poolNumDisks=poolNumDisks, tempNumber=tempNumber, physicalDiskEntry=physicalDiskEntry, powerTable=powerTable, tempEncId=tempEncId, tempEncPos=tempEncPos, eventLogNumEntries=eventLogNumEntries, physDiskWWN=physDiskWWN, fanEntry=fanEntry, poolNumber=poolNumber, eventLogDescr=eventLogDescr, powerEncPos=powerEncPos, physDiskIndex=physDiskIndex, physDiskState=physDiskState, eventLogEntry=eventLogEntry, poolEntry=poolEntry, unit=unit, DisplayString=DisplayString, eventLogTrapLevel=eventLogTrapLevel, eventLogTable=eventLogTable, fanTable=fanTable)
