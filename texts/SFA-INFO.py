...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:07:34 2023
...
Counter32, enterprises, MibIdentifier, TimeTicks, ModuleIdentity, Unsigned32, NotificationType, ObjectIdentity, iso, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Unsigned32", "NotificationType", "ObjectIdentity", "iso", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("SFA-INFO", powerEncId=powerEncId, poolId=poolId, eventLog=eventLog, fanEncPos=fanEncPos, eventLogEntry=eventLogEntry, physDiskIndex=physDiskIndex, tempTable=tempTable, powerStatus=powerStatus, eventLogIndex=eventLogIndex, powerTable=powerTable, eventLogTable=eventLogTable, physDiskWWN=physDiskWWN, tempNumber=tempNumber, fanStatus=fanStatus, powerEncPos=powerEncPos, systemName=systemName, poolEntry=poolEntry, eventLogLevel=eventLogLevel, powerIndex=powerIndex, tempEncId=tempEncId, poolType=poolType, tempEntry=tempEntry, eventLogTrapLevel=eventLogTrapLevel, powerNumber=powerNumber, datadirect=datadirect, eventLogDescr=eventLogDescr, fanNumber=fanNumber, eventLogNumEntries=eventLogNumEntries, physDiskSlot=physDiskSlot, fanTable=fanTable, physicalDiskTable=physicalDiskTable, tempIndex=tempIndex, powerEntry=powerEntry, fanIndex=fanIndex, tempEncPos=tempEncPos, DisplayString=DisplayString, poolTable=poolTable, physDiskPoolId=physDiskPoolId, unit=unit, poolIndex=poolIndex, poolNumDisks=poolNumDisks, physDiskId=physDiskId, physDiskEnc=physDiskEnc, poolNumber=poolNumber, tempStatus=tempStatus, fanEncId=fanEncId, physDiskState=physDiskState, physicalDiskEntry=physicalDiskEntry, fanEntry=fanEntry)
