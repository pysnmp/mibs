...
# Produced by pysmi-1.1.10 at Mon Feb 19 02:55:39 2024
...
Unsigned32, Bits, enterprises, IpAddress, TimeTicks, ObjectIdentity, MibIdentifier, ModuleIdentity, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "enterprises", "IpAddress", "TimeTicks", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("SFA-INFO", DisplayString=DisplayString, physDiskWWN=physDiskWWN, tempNumber=tempNumber, poolEntry=poolEntry, tempEntry=tempEntry, fanIndex=fanIndex, powerEncPos=powerEncPos, poolIndex=poolIndex, eventLogTable=eventLogTable, fanEncPos=fanEncPos, poolNumDisks=poolNumDisks, tempEncId=tempEncId, eventLogNumEntries=eventLogNumEntries, tempEncPos=tempEncPos, powerEncId=powerEncId, eventLogTrapLevel=eventLogTrapLevel, physicalDiskEntry=physicalDiskEntry, unit=unit, poolTable=poolTable, powerNumber=powerNumber, physDiskState=physDiskState, eventLogEntry=eventLogEntry, physDiskPoolId=physDiskPoolId, datadirect=datadirect, powerEntry=powerEntry, poolNumber=poolNumber, poolId=poolId, poolType=poolType, powerIndex=powerIndex, fanStatus=fanStatus, physDiskIndex=physDiskIndex, fanEntry=fanEntry, eventLogDescr=eventLogDescr, physDiskEnc=physDiskEnc, fanTable=fanTable, eventLog=eventLog, powerTable=powerTable, physDiskSlot=physDiskSlot, fanNumber=fanNumber, tempIndex=tempIndex, physDiskId=physDiskId, fanEncId=fanEncId, eventLogLevel=eventLogLevel, eventLogIndex=eventLogIndex, tempTable=tempTable, systemName=systemName, tempStatus=tempStatus, powerStatus=powerStatus, physicalDiskTable=physicalDiskTable)
