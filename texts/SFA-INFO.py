...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:55:48 2021
...
Counter32, IpAddress, ObjectIdentity, Unsigned32, ModuleIdentity, Counter64, Bits, enterprises, NotificationType, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Counter64", "Bits", "enterprises", "NotificationType", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("SFA-INFO", powerIndex=powerIndex, fanEncPos=fanEncPos, tempEncPos=tempEncPos, physDiskEnc=physDiskEnc, powerNumber=powerNumber, tempTable=tempTable, fanEncId=fanEncId, physDiskIndex=physDiskIndex, eventLogEntry=eventLogEntry, eventLogTable=eventLogTable, eventLogIndex=eventLogIndex, tempEncId=tempEncId, powerTable=powerTable, poolNumDisks=poolNumDisks, physDiskState=physDiskState, powerEntry=powerEntry, tempStatus=tempStatus, poolType=poolType, physicalDiskTable=physicalDiskTable, unit=unit, tempIndex=tempIndex, powerEncPos=powerEncPos, tempNumber=tempNumber, tempEntry=tempEntry, DisplayString=DisplayString, physDiskWWN=physDiskWWN, fanIndex=fanIndex, fanStatus=fanStatus, eventLogLevel=eventLogLevel, datadirect=datadirect, eventLogNumEntries=eventLogNumEntries, poolNumber=poolNumber, eventLogTrapLevel=eventLogTrapLevel, fanTable=fanTable, powerStatus=powerStatus, physDiskPoolId=physDiskPoolId, eventLog=eventLog, poolEntry=poolEntry, poolIndex=poolIndex, systemName=systemName, poolTable=poolTable, physDiskSlot=physDiskSlot, powerEncId=powerEncId, physicalDiskEntry=physicalDiskEntry, eventLogDescr=eventLogDescr, physDiskId=physDiskId, fanEntry=fanEntry, poolId=poolId, fanNumber=fanNumber)
