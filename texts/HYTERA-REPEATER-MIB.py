...
# Produced by pysmi-1.1.12 at Tue May 28 12:49:39 2024
...
private, Integer32, IpAddress, Gauge32, NotificationType, MibIdentifier, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Counter32, ObjectIdentity, Counter64, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "private", "Integer32", "IpAddress", "Gauge32", "NotificationType", "MibIdentifier", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Counter32", "ObjectIdentity", "Counter64", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("HYTERA-REPEATER-MIB", analogTransmitFrequency=analogTransmitFrequency, groupCallHangTime=groupCallHangTime, rptTemperatureAlarm=rptTemperatureAlarm, accessManagement=accessManagement, product=product, callId=callId, privateCallHangTime=privateCallHangTime, analogPreEmp=analogPreEmp, mixedColorCode=mixedColorCode, microphone=microphone, mixedIpMultisiteConnect=mixedIpMultisiteConnect, actChannelAlias=actChannelAlias, multisiteAccessManageEntry=multisiteAccessManageEntry, rptRcdbVersion=rptRcdbVersion, rptKnockdown=rptKnockdown, logTable=logTable, digitalChnEntry=digitalChnEntry, contactCallType=contactCallType, rptTxPowerLevel=rptTxPowerLevel, rptBatteryVoltageAlarm=rptBatteryVoltageAlarm, rptMixedChannelSetting=rptMixedChannelSetting, rptSnmpTrapIp=rptSnmpTrapIp, mixedCarrierSquelchLevel=mixedCarrierSquelchLevel, rptModelName=rptModelName, rptRxPllAlarm=rptRxPllAlarm, rerepeatTOTTime=rerepeatTOTTime, multiCTCCDCEntry=multiCTCCDCEntry, designatedPowerOnChn=designatedPowerOnChn, emergencyCallHangTime=emergencyCallHangTime, rptVoltageAlarm=rptVoltageAlarm, contactIndex=contactIndex, multiCTCCDCTable=multiCTCCDCTable, txCtcssType=txCtcssType, rptTxRefPower=rptTxRefPower, rptBatteryVoltage=rptBatteryVoltage, rptChannelNumber=rptChannelNumber, mixedChnTable=mixedChnTable, multisiteAccessCallType=multisiteAccessCallType, analogRxCdcss=analogRxCdcss, rptSlot1Rssi=rptSlot1Rssi, alarmStatus=alarmStatus, mixedTxCdcss=mixedTxCdcss, rptWorkState=rptWorkState, startId=startId, analogTxCtcCdcType=analogTxCtcCdcType, rptFirmwareVersion=rptFirmwareVersion, rptSlot2Rssi=rptSlot2Rssi, beaconDuration=beaconDuration, rxCtcssType=rxCtcssType, rptPaTemprature=rptPaTemprature, rptFanAlarm=rptFanAlarm, pathPriority=pathPriority, contactEntry=contactEntry, externalMicGain=externalMicGain, callAlias=callAlias, rptCurChannelType=rptCurChannelType, accessManageTable=accessManageTable, multisiteAccessManageIndex=multisiteAccessManageIndex, rptVoltage=rptVoltage, rptBatteryConnect=rptBatteryConnect, rptTxFwdPower=rptTxFwdPower, actChannelNo=actChannelNo, mixedFlatAudio=mixedFlatAudio, rptAlarmInfo=rptAlarmInfo, rptBasicSetting=rptBasicSetting, txCtcssFrequency=txCtcssFrequency, beaconInterval=beaconInterval, recordCount=recordCount, contactTable=contactTable, digitalTxContactName=digitalTxContactName, analogRxCtcss=analogRxCtcss, rptCurRxFreq=rptCurRxFreq, rptVswrAlarm=rptVswrAlarm, actChannelType=actChannelType, beaconTxMode=beaconTxMode, rptCurZoneAlias=rptCurZoneAlias, rptControlObjBak1=rptControlObjBak1, mixedTxCtcCdcType=mixedTxCtcCdcType, analogScrambler=analogScrambler, analogTxCtcss=analogTxCtcss, mixedTxContactName=mixedTxContactName, rptSystemInfo=rptSystemInfo, idLength=idLength, actChannelSubNo=actChannelSubNo, accessManageEntry=accessManageEntry, digitalReceiveFrequency=digitalReceiveFrequency, txPreambleDuration=txPreambleDuration, rptControl=rptControl, rptSerialNo=rptSerialNo, channelParaIndex=channelParaIndex, multisiteStartId=multisiteStartId, pttPriority=pttPriority, logIndex=logIndex, rptDigitalChannelSetting=rptDigitalChannelSetting, digitalChnIndex=digitalChnIndex, powerOnChannelNo=powerOnChannelNo, logTime=logTime, rptForwardAlarm=rptForwardAlarm, alarmName=alarmName, latestRecordPosition=latestRecordPosition, mixedPreEmp=mixedPreEmp, hyteraRepeaterMIB=hyteraRepeaterMIB, rptCurTxFreq=rptCurTxFreq, mixedRxCtcss=mixedRxCtcss, actTxPower=actTxPower, analogCallHangTime=analogCallHangTime, repeater=repeater, rptChannelName=rptChannelName, repeatRequestPriority=repeatRequestPriority, logEntry=logEntry, analogChnTable=analogChnTable, multisiteAccessManageTable=multisiteAccessManageTable, clearLog=clearLog, powerOn=powerOn, accessManageIndex=accessManageIndex, mixedChnEntry=mixedChnEntry, rptSnmpTrapPort=rptSnmpTrapPort, analogReceiveFrequency=analogReceiveFrequency, audioPriority=audioPriority, rptConfiguration=rptConfiguration, rptRealTimeInfo=rptRealTimeInfo, mixedMultiCtcCdc=mixedMultiCtcCdc, digitalChnTable=digitalChnTable, multisiteIdLength=multisiteIdLength, rptTxPllAlarm=rptTxPllAlarm, rptDataInfoBak2=rptDataInfoBak2, analogChnIndex=analogChnIndex, sit=sit, mixedTxCtcss=mixedTxCtcss, analogRxCtcCdcType=analogRxCtcCdcType, multisiteAccessManagement=multisiteAccessManagement, rptDataInfoBak1=rptDataInfoBak1, digitalTransmitFrequency=digitalTransmitFrequency, rptchannelParaTable=rptchannelParaTable, ctcssIndex=ctcssIndex, analogTxCdcss=analogTxCdcss, rxCtcssFrequency=rxCtcssFrequency, rptChannelType=rptChannelType, rptFanSpeed=rptFanSpeed, mixedRxCdcss=mixedRxCdcss, digitalIpMultisiteConnect=digitalIpMultisiteConnect, analogChnEntry=analogChnEntry, mixedRxCtcCdcType=mixedRxCtcCdcType, rptRestart=rptRestart, rptForbid=rptForbid, rptAnalogChannelSetting=rptAnalogChannelSetting, mixedChnIndex=mixedChnIndex, rptSupplyPowerType=rptSupplyPowerType, rptModelNo=rptModelNo, rptReflectedAlarm=rptReflectedAlarm, rptRadioState=rptRadioState, rptRadioAlias=rptRadioAlias, jitterBufferLenth=jitterBufferLenth, mixedTransmitFrequency=mixedTransmitFrequency, rptServiceSetting=rptServiceSetting, internalMicGain=internalMicGain, rptDataInfo=rptDataInfo, channelParaEntry=channelParaEntry, rptRadioID=rptRadioID, analogMultiCtcCdc=analogMultiCtcCdc, mixedScrambler=mixedScrambler, analogCarrierSquelchLevel=analogCarrierSquelchLevel, rptLog=rptLog, mixedTxChannelType=mixedTxChannelType, repeatTOTTime=repeatTOTTime, rptVswr=rptVswr, mixedReceiveFrequency=mixedReceiveFrequency, analogFlatAudio=analogFlatAudio, digitalColorCode=digitalColorCode)
