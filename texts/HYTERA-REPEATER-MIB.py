...
mibBuilder.exportSymbols("HYTERA-REPEATER-MIB", rptFanSpeed=rptFanSpeed, powerOnChannelNo=powerOnChannelNo, digitalChnEntry=digitalChnEntry, mixedMultiCtcCdc=mixedMultiCtcCdc, actChannelType=actChannelType, rptMixedChannelSetting=rptMixedChannelSetting, ctcssIndex=ctcssIndex, analogRxCdcss=analogRxCdcss, latestRecordPosition=latestRecordPosition, mixedColorCode=mixedColorCode, analogScrambler=analogScrambler, contactCallType=contactCallType, digitalReceiveFrequency=digitalReceiveFrequency, actChannelSubNo=actChannelSubNo, rptVswrAlarm=rptVswrAlarm, actChannelNo=actChannelNo, txPreambleDuration=txPreambleDuration, multisiteAccessManageIndex=multisiteAccessManageIndex, rptSnmpTrapIp=rptSnmpTrapIp, rptForbid=rptForbid, product=product, rptChannelName=rptChannelName, repeater=repeater, logIndex=logIndex, rptSlot2Rssi=rptSlot2Rssi, rxCtcssType=rxCtcssType, emergencyCallHangTime=emergencyCallHangTime, rptBatteryVoltage=rptBatteryVoltage, audioPriority=audioPriority, mixedIpMultisiteConnect=mixedIpMultisiteConnect, rptDataInfoBak1=rptDataInfoBak1, rerepeatTOTTime=rerepeatTOTTime, mixedChnIndex=mixedChnIndex, mixedTxChannelType=mixedTxChannelType, rptAnalogChannelSetting=rptAnalogChannelSetting, rptCurTxFreq=rptCurTxFreq, alarmName=alarmName, actTxPower=actTxPower, mixedChnTable=mixedChnTable, digitalTxContactName=digitalTxContactName, multiCTCCDCTable=multiCTCCDCTable, rptChannelNumber=rptChannelNumber, digitalColorCode=digitalColorCode, mixedTxContactName=mixedTxContactName, accessManageEntry=accessManageEntry, hyteraRepeaterMIB=hyteraRepeaterMIB, jitterBufferLenth=jitterBufferLenth, rptControlObjBak1=rptControlObjBak1, multisiteAccessManageEntry=multisiteAccessManageEntry, rptWorkState=rptWorkState, analogCallHangTime=analogCallHangTime, contactEntry=contactEntry, analogReceiveFrequency=analogReceiveFrequency, accessManagement=accessManagement, logTime=logTime, beaconInterval=beaconInterval, logTable=logTable, rptCurRxFreq=rptCurRxFreq, rptRadioAlias=rptRadioAlias, sit=sit, alarmStatus=alarmStatus, rptLog=rptLog, rptDataInfoBak2=rptDataInfoBak2, mixedTxCtcCdcType=mixedTxCtcCdcType, channelParaIndex=channelParaIndex, multiCTCCDCEntry=multiCTCCDCEntry, repeatRequestPriority=repeatRequestPriority, rptChannelType=rptChannelType, rptForwardAlarm=rptForwardAlarm, clearLog=clearLog, multisiteStartId=multisiteStartId, idLength=idLength, rptFirmwareVersion=rptFirmwareVersion, rptSlot1Rssi=rptSlot1Rssi, txCtcssFrequency=txCtcssFrequency, privateCallHangTime=privateCallHangTime, rptTxRefPower=rptTxRefPower, rptVswr=rptVswr, rptVoltageAlarm=rptVoltageAlarm, microphone=microphone, beaconTxMode=beaconTxMode, rptDigitalChannelSetting=rptDigitalChannelSetting, rptRadioID=rptRadioID, mixedPreEmp=mixedPreEmp, rptTemperatureAlarm=rptTemperatureAlarm, analogChnEntry=analogChnEntry, rptControl=rptControl, callAlias=callAlias, rptTxPllAlarm=rptTxPllAlarm, digitalChnIndex=digitalChnIndex, contactTable=contactTable, mixedRxCdcss=mixedRxCdcss, actChannelAlias=actChannelAlias, txCtcssType=txCtcssType, digitalTransmitFrequency=digitalTransmitFrequency, recordCount=recordCount, rptRadioState=rptRadioState, analogFlatAudio=analogFlatAudio, multisiteIdLength=multisiteIdLength, mixedScrambler=mixedScrambler, multisiteAccessCallType=multisiteAccessCallType, rptPaTemprature=rptPaTemprature, powerOn=powerOn, rptReflectedAlarm=rptReflectedAlarm, mixedTransmitFrequency=mixedTransmitFrequency, groupCallHangTime=groupCallHangTime, rptFanAlarm=rptFanAlarm, rptCurZoneAlias=rptCurZoneAlias, rptRealTimeInfo=rptRealTimeInfo, analogTxCtcCdcType=analogTxCtcCdcType, analogPreEmp=analogPreEmp, rptBasicSetting=rptBasicSetting, digitalChnTable=digitalChnTable, rptKnockdown=rptKnockdown, rptDataInfo=rptDataInfo, mixedTxCtcss=mixedTxCtcss, accessManageTable=accessManageTable, rptModelName=rptModelName, rptModelNo=rptModelNo, pathPriority=pathPriority, multisiteAccessManagement=multisiteAccessManagement, externalMicGain=externalMicGain, rptSupplyPowerType=rptSupplyPowerType, designatedPowerOnChn=designatedPowerOnChn, rptRcdbVersion=rptRcdbVersion, internalMicGain=internalMicGain, analogTxCtcss=analogTxCtcss, pttPriority=pttPriority, analogRxCtcss=analogRxCtcss, logEntry=logEntry, digitalIpMultisiteConnect=digitalIpMultisiteConnect, rptSnmpTrapPort=rptSnmpTrapPort, analogTxCdcss=analogTxCdcss, accessManageIndex=accessManageIndex, rptCurChannelType=rptCurChannelType, mixedFlatAudio=mixedFlatAudio, rptVoltage=rptVoltage, analogMultiCtcCdc=analogMultiCtcCdc, multisiteAccessManageTable=multisiteAccessManageTable, rptSystemInfo=rptSystemInfo, mixedCarrierSquelchLevel=mixedCarrierSquelchLevel, contactIndex=contactIndex, beaconDuration=beaconDuration, rptRxPllAlarm=rptRxPllAlarm, mixedRxCtcss=mixedRxCtcss, rxCtcssFrequency=rxCtcssFrequency, rptSerialNo=rptSerialNo, rptchannelParaTable=rptchannelParaTable, analogChnTable=analogChnTable, callId=callId, rptConfiguration=rptConfiguration, analogCarrierSquelchLevel=analogCarrierSquelchLevel, mixedReceiveFrequency=mixedReceiveFrequency, startId=startId, analogTransmitFrequency=analogTransmitFrequency, rptRestart=rptRestart, channelParaEntry=channelParaEntry, rptTxFwdPower=rptTxFwdPower, mixedRxCtcCdcType=mixedRxCtcCdcType, repeatTOTTime=repeatTOTTime, analogChnIndex=analogChnIndex, analogRxCtcCdcType=analogRxCtcCdcType, mixedChnEntry=mixedChnEntry, mixedTxCdcss=mixedTxCdcss, rptServiceSetting=rptServiceSetting, rptAlarmInfo=rptAlarmInfo, rptBatteryConnect=rptBatteryConnect, rptTxPowerLevel=rptTxPowerLevel, rptBatteryVoltageAlarm=rptBatteryVoltageAlarm)
