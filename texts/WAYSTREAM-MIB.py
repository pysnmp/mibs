...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourState=wsNeighbourState, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPBitrate=wsSFPBitrate, wsFanEntry=wsFanEntry, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPEntry=wsSFPEntry, wsAsrRevision=wsAsrRevision, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPIndex=wsXFPIndex, wsSFPConnector=wsSFPConnector, wsSFPTempStatus=wsSFPTempStatus, wsVoltStatus=wsVoltStatus, wsNeighbourHostname=wsNeighbourHostname, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsFanRPM=wsFanRPM, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyCookie=wsPolicyCookie, wsXFPTemp=wsXFPTemp, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortName=wsNeighbourPortName, wsPolicyIfName=wsPolicyIfName, wsTempTable=wsTempTable, wsTempThresholdLow=wsTempThresholdLow, wsTempMeasured=wsTempMeasured, wsTempTHYST=wsTempTHYST, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsWritedummy=wsWritedummy, wsSFPVolt=wsSFPVolt, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPPartNumber=wsSFPPartNumber, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyTable=wsPolicyTable, wsSFPTable=wsSFPTable, wsPolicyName=wsPolicyName, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsTempEntry=wsTempEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourLocalIf=wsNeighbourLocalIf, wsVoltEntry=wsVoltEntry, wsVoltTable=wsVoltTable, wsSFPCopperLen=wsSFPCopperLen, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourCreated=wsNeighbourCreated, wsIbosTempHigh=wsIbosTempHigh, wsNeighboursTable=wsNeighboursTable, wsPolicyOutPkts=wsPolicyOutPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsFanNumber=wsFanNumber, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPRXPower=wsXFPRXPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTemp=wsSFPTemp, wsSystem=wsSystem, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPTable=wsXFPTable, wsVoltChannel=wsVoltChannel, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsVersionString=wsVersionString, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsTempSensor=wsTempSensor, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPTempStatus=wsXFPTempStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPTransceiver=wsXFPTransceiver, wsReload=wsReload, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPEntry=wsXFPEntry, wsNeighbourModel=wsNeighbourModel, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPCopperLen=wsXFPCopperLen, wsPolicyInDrops=wsPolicyInDrops, wsSFPStatus=wsSFPStatus, wsXFPEncoding=wsXFPEncoding, wsXFPConnector=wsXFPConnector, wsNeighbourPortsTable=wsNeighbourPortsTable, PYSNMP_MODULE_ID=ibos, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsEnvironment=wsEnvironment, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPSingleModeLen=wsSFPSingleModeLen, wsFanTable=wsFanTable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyInBytes=wsPolicyInBytes, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXPower=wsSFPTXPower, wsFanVoltage=wsFanVoltage, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyOutBytes=wsPolicyOutBytes, wsIbosVoltLow=wsIbosVoltLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTXCurrent=wsXFPTXCurrent, wsIbosTempLow=wsIbosTempLow, wsVersion=wsVersion, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPEncoding=wsSFPEncoding, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortState=wsNeighbourPortState, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXdBmPower=wsSFPTXdBmPower, wsVoltNominal=wsVoltNominal, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPStatus=wsXFPStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPIndex=wsSFPIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltMeasured=wsVoltMeasured, wsPolicyEntry=wsPolicyEntry, wsXFPTXPower=wsXFPTXPower, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempTOS=wsTempTOS, wsAccounting=wsAccounting, wsTempStatus=wsTempStatus, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPFDP=wsPFDP, wsSFPTempWarningLow=wsSFPTempWarningLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, ibos=ibos)
