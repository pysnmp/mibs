...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPIndex=wsSFPIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyTable=wsPolicyTable, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighboursEntry=wsNeighboursEntry, wsSFPTemp=wsSFPTemp, wsVoltThresholdHigh=wsVoltThresholdHigh, wsFanRPM=wsFanRPM, wsXFPTXCurrent=wsXFPTXCurrent, wsTempTable=wsTempTable, wsFanTable=wsFanTable, wsPolicyInBytes=wsPolicyInBytes, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPMultiMode50Len=wsSFPMultiMode50Len, PYSNMP_MODULE_ID=ibos, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsFanNumber=wsFanNumber, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourModel=wsNeighbourModel, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPPartNumber=wsSFPPartNumber, wsXFPRXPower=wsXFPRXPower, wsWritedummy=wsWritedummy, wsNeighbourUptime=wsNeighbourUptime, wsEnvironment=wsEnvironment, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsTempMeasured=wsTempMeasured, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosTempHigh=wsIbosTempHigh, wsTempTHYST=wsTempTHYST, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsAsrRevision=wsAsrRevision, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsAccounting=wsAccounting, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourState=wsNeighbourState, wsFanEntry=wsFanEntry, wsTempEntry=wsTempEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPCopperLen=wsSFPCopperLen, wsXFPCopperLen=wsXFPCopperLen, wsVoltEntry=wsVoltEntry, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsVoltChannel=wsVoltChannel, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPBitrate=wsSFPBitrate, ibos=ibos, wsPolicyName=wsPolicyName, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPConnector=wsXFPConnector, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyCookie=wsPolicyCookie, wsNeighbourHostname=wsNeighbourHostname, wsXFPTXPower=wsXFPTXPower, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPEntry=wsXFPEntry, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsPolicyEntry=wsPolicyEntry, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsReload=wsReload, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsTempThresholdLow=wsTempThresholdLow, wsTempTOS=wsTempTOS, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsVoltTable=wsVoltTable, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPConnector=wsSFPConnector, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTransceiver=wsSFPTransceiver, wsTempSensor=wsTempSensor, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsFanVoltage=wsFanVoltage, wsXFPIndex=wsXFPIndex, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPStatus=wsSFPStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsVoltNominal=wsVoltNominal, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTempStatus=wsSFPTempStatus, wsPolicyIfName=wsPolicyIfName, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyInPkts=wsPolicyInPkts, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPTable=wsXFPTable, wsNeighbourPortName=wsNeighbourPortName, wsVersion=wsVersion, wsIbosTempLow=wsIbosTempLow, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsTempStatus=wsTempStatus, wsPFDP=wsPFDP, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourCreated=wsNeighbourCreated, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXPower=wsSFPTXPower, wsSFPRXPower=wsSFPRXPower, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsVoltStatus=wsVoltStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPEntry=wsSFPEntry, wsSFPTable=wsSFPTable, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPTemp=wsXFPTemp, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPolicyIfIndex=wsPolicyIfIndex, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSystem=wsSystem, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPStatus=wsXFPStatus, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsVersionString=wsVersionString, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts)
