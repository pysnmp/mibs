...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsTempMeasured=wsTempMeasured, wsSFPTXdBmPower=wsSFPTXdBmPower, wsPolicyTable=wsPolicyTable, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPIndex=wsXFPIndex, wsXFPCopperLen=wsXFPCopperLen, ibos=ibos, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourUptime=wsNeighbourUptime, wsPolicyIfName=wsPolicyIfName, wsVoltMeasured=wsVoltMeasured, wsFanRPM=wsFanRPM, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyCookie=wsPolicyCookie, wsSFPBitrate=wsSFPBitrate, wsFanVoltage=wsFanVoltage, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyName=wsPolicyName, wsVersion=wsVersion, wsPolicyInPkts=wsPolicyInPkts, wsVoltStatus=wsVoltStatus, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsTempEntry=wsTempEntry, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTempWarningHigh=wsSFPTempWarningHigh, PYSNMP_MODULE_ID=ibos, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPConnector=wsXFPConnector, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsTempSensor=wsTempSensor, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVoltNominal=wsVoltNominal, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsWritedummy=wsWritedummy, wsPolicyUsedCnt=wsPolicyUsedCnt, wsVoltThresholdLow=wsVoltThresholdLow, wsTempTable=wsTempTable, wsNeighbourState=wsNeighbourState, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsTempStatus=wsTempStatus, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsFanNumber=wsFanNumber, wsSFPTable=wsSFPTable, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSystem=wsSystem, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPFDP=wsPFDP, wsSFPCopperLen=wsSFPCopperLen, wsXFPBitrateMin=wsXFPBitrateMin, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPEntry=wsSFPEntry, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPEntry=wsXFPEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPStatus=wsSFPStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTemp=wsSFPTemp, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPTemp=wsXFPTemp, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPStatus=wsXFPStatus, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyInBytes=wsPolicyInBytes, wsPolicyEntry=wsPolicyEntry, wsVoltTable=wsVoltTable, wsPolicyOutPkts=wsPolicyOutPkts, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsTempTOS=wsTempTOS, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsFanEntry=wsFanEntry, wsVersionString=wsVersionString, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsReload=wsReload, wsSFPVolt=wsSFPVolt, wsSFPConnector=wsSFPConnector, wsSFPSingleModeLen=wsSFPSingleModeLen, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTable=wsXFPTable, wsAccounting=wsAccounting, wsNeighbourCreated=wsNeighbourCreated, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXPower=wsSFPTXPower, wsXFPTempStatus=wsXFPTempStatus, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsFanTable=wsFanTable, wsTempTHYST=wsTempTHYST, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPEncoding=wsXFPEncoding, wsNeighboursTable=wsNeighboursTable, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPEncoding=wsSFPEncoding, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsEnvironment=wsEnvironment, wsSFPIndex=wsSFPIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourModel=wsNeighbourModel, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPTransceiver=wsXFPTransceiver, wsXFPTXPower=wsXFPTXPower, wsVoltEntry=wsVoltEntry)
