...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsFanNumber=wsFanNumber, wsSFPEncoding=wsSFPEncoding, wsSFPTempStatus=wsSFPTempStatus, wsSFPVoltStatus=wsSFPVoltStatus, ibos=ibos, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPStatus=wsSFPStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPEncoding=wsXFPEncoding, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsVoltThresholdHigh=wsVoltThresholdHigh, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPTable=wsXFPTable, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsIbosTempLow=wsIbosTempLow, wsNeighbourModel=wsNeighbourModel, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsVersion=wsVersion, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPRXPower=wsSFPRXPower, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPIndex=wsSFPIndex, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTransceiver=wsSFPTransceiver, wsXFPIndex=wsXFPIndex, wsXFPTXPower=wsXFPTXPower, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXPower=wsSFPTXPower, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsTempMeasured=wsTempMeasured, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyCookie=wsPolicyCookie, wsSFPTXdBmPower=wsSFPTXdBmPower, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsVoltStatus=wsVoltStatus, wsNeighbourUptime=wsNeighbourUptime, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPVolt=wsSFPVolt, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourDBCount=wsNeighbourDBCount, wsTempStatus=wsTempStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsFanVoltage=wsFanVoltage, wsVersionString=wsVersionString, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltChannel=wsVoltChannel, PYSNMP_MODULE_ID=ibos, wsXFPRXPower=wsXFPRXPower, wsTempSensor=wsTempSensor, wsNeighbourSNPA=wsNeighbourSNPA, wsPolicyInDrops=wsPolicyInDrops, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSystem=wsSystem, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyTable=wsPolicyTable, wsTempTOS=wsTempTOS, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPFDP=wsPFDP, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsVoltNominal=wsVoltNominal, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsFanTable=wsFanTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsAccounting=wsAccounting, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPEntry=wsSFPEntry, wsTempEntry=wsTempEntry, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPBitrate=wsSFPBitrate, wsEnvironment=wsEnvironment, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourState=wsNeighbourState, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsReload=wsReload, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsFanEntry=wsFanEntry, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsTempTHYST=wsTempTHYST, wsPolicyName=wsPolicyName, wsFanRPM=wsFanRPM, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPEntry=wsXFPEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortState=wsNeighbourPortState, wsXFPConnector=wsXFPConnector, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourHostname=wsNeighbourHostname, wsXFPTransceiver=wsXFPTransceiver, wsTempThresholdLow=wsTempThresholdLow, wsPolicyInPkts=wsPolicyInPkts, wsWritedummy=wsWritedummy, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVoltTable=wsVoltTable, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPStatus=wsXFPStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPTemp=wsXFPTemp, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTemp=wsSFPTemp, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsVoltEntry=wsVoltEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPConnector=wsSFPConnector, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsPolicyIfName=wsPolicyIfName, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTable=wsSFPTable, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsTempTable=wsTempTable, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPTXCurrent=wsXFPTXCurrent, wsIbosTempHigh=wsIbosTempHigh)
