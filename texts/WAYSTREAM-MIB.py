...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVoltTable=wsVoltTable, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsTempTable=wsTempTable, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPEntry=wsXFPEntry, wsNeighbourState=wsNeighbourState, wsFanTable=wsFanTable, wsPolicyTable=wsPolicyTable, wsNeighbourUptime=wsNeighbourUptime, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPCopperLen=wsSFPCopperLen, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsTempTHYST=wsTempTHYST, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsSystem=wsSystem, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortName=wsNeighbourPortName, wsXFPTemp=wsXFPTemp, wsNeighbourHostname=wsNeighbourHostname, wsXFPEncoding=wsXFPEncoding, wsReload=wsReload, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyIfName=wsPolicyIfName, wsSFPTemp=wsSFPTemp, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTable=wsSFPTable, wsAsrRevision=wsAsrRevision, wsXFPRXPower=wsXFPRXPower, wsSFPBitrate=wsSFPBitrate, wsPFDP=wsPFDP, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyInBytes=wsPolicyInBytes, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPIndex=wsSFPIndex, wsVoltStatus=wsVoltStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsEnvironment=wsEnvironment, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPTXPower=wsXFPTXPower, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, ibos=ibos, wsVoltEntry=wsVoltEntry, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsTempSensor=wsTempSensor, wsPolicyName=wsPolicyName, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsVersionString=wsVersionString, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyInDrops=wsPolicyInDrops, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPTable=wsXFPTable, wsFanRPM=wsFanRPM, wsNeighboursTable=wsNeighboursTable, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXdBmPower=wsSFPTXdBmPower, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVolt=wsSFPVolt, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTransceiverExt=wsSFPTransceiverExt, wsFanVoltage=wsFanVoltage, wsSFPStatus=wsSFPStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsTempThresholdLow=wsTempThresholdLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsTempTOS=wsTempTOS, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempEntry=wsTempEntry, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsFanEntry=wsFanEntry, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPEncoding=wsSFPEncoding, wsIbosVoltHigh=wsIbosVoltHigh, PYSNMP_MODULE_ID=ibos, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTempWarningLow=wsSFPTempWarningLow, wsAccounting=wsAccounting, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTransceiver=wsXFPTransceiver, wsPolicyCookie=wsPolicyCookie, wsXFPTempStatus=wsXFPTempStatus, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPEntry=wsSFPEntry, wsSFPRXPower=wsSFPRXPower, wsIbosTempLow=wsIbosTempLow, wsVoltNominal=wsVoltNominal, wsFanNumber=wsFanNumber, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVoltChannel=wsVoltChannel, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourModel=wsNeighbourModel, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPIndex=wsXFPIndex, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPConnector=wsXFPConnector, wsXFPStatus=wsXFPStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsVersion=wsVersion, wsSFPPartNumber=wsSFPPartNumber, wsTempStatus=wsTempStatus, wsWritedummy=wsWritedummy, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsIbosVoltLow=wsIbosVoltLow, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTransceiver=wsSFPTransceiver)
