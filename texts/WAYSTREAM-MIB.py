...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsTempTHYST=wsTempTHYST, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPFDP=wsPFDP, wsVoltChannel=wsVoltChannel, wsSFPTemp=wsSFPTemp, wsPolicyInBytes=wsPolicyInBytes, wsXFPStatus=wsXFPStatus, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsPolicyEntry=wsPolicyEntry, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourCreated=wsNeighbourCreated, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPPartNumber=wsSFPPartNumber, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyInPkts=wsPolicyInPkts, wsXFPCopperLen=wsXFPCopperLen, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsVoltTable=wsVoltTable, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyInDrops=wsPolicyInDrops, wsSFPConnector=wsSFPConnector, wsFanRPM=wsFanRPM, wsSFPRXPower=wsSFPRXPower, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXPower=wsSFPTXPower, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, ibos=ibos, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsVoltEntry=wsVoltEntry, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourState=wsNeighbourState, wsFanEntry=wsFanEntry, wsXFPEntry=wsXFPEntry, wsTempThresholdLow=wsTempThresholdLow, wsPolicyOutBytes=wsPolicyOutBytes, wsVoltNominal=wsVoltNominal, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsTempStatus=wsTempStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsAccounting=wsAccounting, wsVoltMeasured=wsVoltMeasured, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourSNPA=wsNeighbourSNPA, wsSystem=wsSystem, wsSFPVolt=wsSFPVolt, wsSFPTXCurrent=wsSFPTXCurrent, wsReload=wsReload, PYSNMP_MODULE_ID=ibos, wsTempEntry=wsTempEntry, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPTransceiver=wsXFPTransceiver, wsIbosVoltLow=wsIbosVoltLow, wsTempTOS=wsTempTOS, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPRXPower=wsXFPRXPower, wsFanTable=wsFanTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsVersion=wsVersion, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTempStatus=wsSFPTempStatus, wsWritedummy=wsWritedummy, wsNeighbourHostname=wsNeighbourHostname, wsSFPStatus=wsSFPStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPTemp=wsXFPTemp, wsSFPIndex=wsSFPIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsTempMeasured=wsTempMeasured, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTransceiver=wsSFPTransceiver, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyIfName=wsPolicyIfName, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTable=wsXFPTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsFanNumber=wsFanNumber, wsPolicyName=wsPolicyName, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPEntry=wsSFPEntry, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsFanVoltage=wsFanVoltage, wsSFPEncoding=wsSFPEncoding, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPConnector=wsXFPConnector, wsXFPTempStatus=wsXFPTempStatus, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsTempTable=wsTempTable, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortName=wsNeighbourPortName, wsXFPIndex=wsXFPIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTable=wsSFPTable, wsEnvironment=wsEnvironment, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsVersionString=wsVersionString, wsVoltStatus=wsVoltStatus, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, wsAsrRevision=wsAsrRevision, wsPolicyTable=wsPolicyTable, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPCopperLen=wsSFPCopperLen, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsTempSensor=wsTempSensor, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPEncoding=wsXFPEncoding)
