...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsTempTHYST=wsTempTHYST, wsPolicyIfIndex=wsPolicyIfIndex, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsVoltChannel=wsVoltChannel, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPRXdBmPower=wsSFPRXdBmPower, wsTempTOS=wsTempTOS, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsPolicyOutDrops=wsPolicyOutDrops, wsPolicyInPkts=wsPolicyInPkts, wsReload=wsReload, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsFanNumber=wsFanNumber, wsSFPTXPower=wsSFPTXPower, wsTempMeasured=wsTempMeasured, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPBitrate=wsSFPBitrate, wsFanTable=wsFanTable, wsIbosVoltLow=wsIbosVoltLow, wsSFPTable=wsSFPTable, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, PYSNMP_MODULE_ID=ibos, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsFanVoltage=wsFanVoltage, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyInBytes=wsPolicyInBytes, wsVoltEntry=wsVoltEntry, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPEncoding=wsXFPEncoding, wsSFPCopperLen=wsSFPCopperLen, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPTempStatus=wsXFPTempStatus, wsPolicyUsedCnt=wsPolicyUsedCnt, wsIbosTempHigh=wsIbosTempHigh, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPStatus=wsSFPStatus, wsTempStatus=wsTempStatus, wsNeighboursTable=wsNeighboursTable, wsSFPEntry=wsSFPEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPEntry=wsXFPEntry, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSystem=wsSystem, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempThresholdHigh=wsTempThresholdHigh, wsVersionString=wsVersionString, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPStatus=wsXFPStatus, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPRXPower=wsSFPRXPower, wsXFPIndex=wsXFPIndex, wsPolicyInDrops=wsPolicyInDrops, wsSFPEncoding=wsSFPEncoding, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPFDP=wsPFDP, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortState=wsNeighbourPortState, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPConnector=wsSFPConnector, wsXFPTXCurrent=wsXFPTXCurrent, wsVoltNominal=wsVoltNominal, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsIbosTempLow=wsIbosTempLow, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsWritedummy=wsWritedummy, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsTempSensor=wsTempSensor, wsSFPVoltStatus=wsSFPVoltStatus, wsVersion=wsVersion, wsNeighbourModel=wsNeighbourModel, wsPolicyName=wsPolicyName, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyCookie=wsPolicyCookie, wsVoltStatus=wsVoltStatus, wsNeighbourHostname=wsNeighbourHostname, wsSFPTempNormalHigh=wsSFPTempNormalHigh, ibos=ibos, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPTable=wsXFPTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourState=wsNeighbourState, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPTXPower=wsXFPTXPower, wsNeighbourSNPA=wsNeighbourSNPA, wsAccounting=wsAccounting, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsTempTable=wsTempTable, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyTable=wsPolicyTable, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsFanRPM=wsFanRPM, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPCopperLen=wsXFPCopperLen, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVoltTable=wsVoltTable, wsFanEntry=wsFanEntry, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPTemp=wsXFPTemp, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTempStatus=wsSFPTempStatus, wsTempEntry=wsTempEntry, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsVoltMeasured=wsVoltMeasured, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsEnvironment=wsEnvironment, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPIndex=wsSFPIndex, wsSFPPartNumber=wsSFPPartNumber, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTempWarningLow=wsSFPTempWarningLow, wsAsrRevision=wsAsrRevision, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPVolt=wsSFPVolt, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortName=wsNeighbourPortName, wsXFPConnector=wsXFPConnector, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTempNormalLow=wsSFPTempNormalLow, wsPolicyIfName=wsPolicyIfName)
