...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPCopperLen=wsXFPCopperLen, wsTempSensor=wsTempSensor, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVersion=wsVersion, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsTempTOS=wsTempTOS, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsFanNumber=wsFanNumber, wsXFPEncoding=wsXFPEncoding, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsTempStatus=wsTempStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTemp=wsXFPTemp, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourModel=wsNeighbourModel, wsPolicyTable=wsPolicyTable, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPStatus=wsXFPStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsEnvironment=wsEnvironment, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsTempMeasured=wsTempMeasured, wsXFPTXPower=wsXFPTXPower, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortState=wsNeighbourPortState, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXPower=wsSFPRXPower, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsWritedummy=wsWritedummy, wsSystem=wsSystem, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPEntry=wsXFPEntry, wsSFPBitrate=wsSFPBitrate, wsXFPTable=wsXFPTable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTransceiverExt=wsSFPTransceiverExt, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsVersionString=wsVersionString, wsNeighbourUptime=wsNeighbourUptime, wsTempEntry=wsTempEntry, wsNeighbourState=wsNeighbourState, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPEncoding=wsSFPEncoding, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXPower=wsSFPTXPower, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyName=wsPolicyName, wsFanVoltage=wsFanVoltage, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPStatus=wsSFPStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPPartNumber=wsSFPPartNumber, wsTempTable=wsTempTable, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsTempTHYST=wsTempTHYST, wsSFPConnector=wsSFPConnector, wsXFPRXPower=wsXFPRXPower, wsVoltNominal=wsVoltNominal, wsPFDP=wsPFDP, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsAccounting=wsAccounting, wsSFPTable=wsSFPTable, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTransceiver=wsSFPTransceiver, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsFanRPM=wsFanRPM, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyCookie=wsPolicyCookie, wsXFPTempStatus=wsXFPTempStatus, wsNeighboursTable=wsNeighboursTable, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTempStatus=wsSFPTempStatus, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsReload=wsReload, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsAsrRevision=wsAsrRevision, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsPolicyInPkts=wsPolicyInPkts, wsVoltTable=wsVoltTable, wsSFPCopperLen=wsSFPCopperLen, wsSFPTemp=wsSFPTemp, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPEntry=wsSFPEntry, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsVoltStatus=wsVoltStatus, wsFanTable=wsFanTable, wsPolicyOutBytes=wsPolicyOutBytes, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourHostname=wsNeighbourHostname, PYSNMP_MODULE_ID=ibos, ibos=ibos, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPIndex=wsXFPIndex, wsVoltEntry=wsVoltEntry, wsFanEntry=wsFanEntry, wsSFPIndex=wsSFPIndex, wsSFPVolt=wsSFPVolt, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyInDrops=wsPolicyInDrops, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsPolicyEntry=wsPolicyEntry, wsVoltChannel=wsVoltChannel)
