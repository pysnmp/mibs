...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPStatus=wsXFPStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPTable=wsXFPTable, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPTempStatus=wsXFPTempStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTempNormalLow=wsSFPTempNormalLow, wsVoltTable=wsVoltTable, wsNeighbourUptime=wsNeighbourUptime, wsSFPStatus=wsSFPStatus, wsFanEntry=wsFanEntry, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsAccounting=wsAccounting, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsVoltNominal=wsVoltNominal, wsAsrRevision=wsAsrRevision, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPPartNumber=wsSFPPartNumber, PYSNMP_MODULE_ID=ibos, wsSFPEncoding=wsSFPEncoding, wsVoltMeasured=wsVoltMeasured, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsPolicyIfName=wsPolicyIfName, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPIndex=wsSFPIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPTemp=wsXFPTemp, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsTempStatus=wsTempStatus, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsFanVoltage=wsFanVoltage, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPEncoding=wsXFPEncoding, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsTempSensor=wsTempSensor, wsVersion=wsVersion, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsTempMeasured=wsTempMeasured, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortName=wsNeighbourPortName, wsSFPConnector=wsSFPConnector, wsSFPTemp=wsSFPTemp, wsEnvironment=wsEnvironment, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPTransceiver=wsXFPTransceiver, wsSFPTransceiver=wsSFPTransceiver, wsSFPTempNormalHigh=wsSFPTempNormalHigh, ibos=ibos, wsTempThresholdLow=wsTempThresholdLow, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsReload=wsReload, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPRXPower=wsSFPRXPower, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPIndex=wsXFPIndex, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPRXPower=wsXFPRXPower, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsTempTHYST=wsTempTHYST, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsWritedummy=wsWritedummy, wsTempEntry=wsTempEntry, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPEntry=wsSFPEntry, wsPolicyName=wsPolicyName, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsFanTable=wsFanTable, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPFDP=wsPFDP, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPVolt=wsSFPVolt, wsNeighbourLocalIf=wsNeighbourLocalIf, wsXFPBitrateMin=wsXFPBitrateMin, wsSystem=wsSystem, wsFanNumber=wsFanNumber, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsTempTable=wsTempTable, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPCopperLen=wsXFPCopperLen, wsIbosTempHigh=wsIbosTempHigh, wsVoltEntry=wsVoltEntry, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyTable=wsPolicyTable, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsVoltChannel=wsVoltChannel, wsXFPConnector=wsXFPConnector, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPEntry=wsXFPEntry, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyInDrops=wsPolicyInDrops, wsSFPTable=wsSFPTable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsVersionString=wsVersionString, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsTempTOS=wsTempTOS, wsNeighbourLastAct=wsNeighbourLastAct, wsFanRPM=wsFanRPM, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourState=wsNeighbourState, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsIbosFanRPMLow=wsIbosFanRPMLow)
