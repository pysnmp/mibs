...
NotificationType, iso, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, TimeTicks, Bits, Gauge32, Counter32, MibIdentifier, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "TimeTicks", "Bits", "Gauge32", "Counter32", "MibIdentifier", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPVolt=wsSFPVolt, wsNeighbourCreated=wsNeighbourCreated, wsXFPTemp=wsXFPTemp, wsVoltEntry=wsVoltEntry, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTransceiver=wsSFPTransceiver, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPEncoding=wsXFPEncoding, wsSystem=wsSystem, wsTempTOS=wsTempTOS, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyInPkts=wsPolicyInPkts, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPIndex=wsXFPIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsVoltChannel=wsVoltChannel, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsIbosTempLow=wsIbosTempLow, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPEncoding=wsSFPEncoding, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyEntry=wsPolicyEntry, wsNeighbourPacketsIn=wsNeighbourPacketsIn, ibos=ibos, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsReload=wsReload, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsTempTable=wsTempTable, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPConnector=wsXFPConnector, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPEntry=wsSFPEntry, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPConnector=wsSFPConnector, wsTempSensor=wsTempSensor, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPStatus=wsSFPStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVoltTable=wsVoltTable, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourUptime=wsNeighbourUptime, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsFanTable=wsFanTable, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPIndex=wsSFPIndex, wsPolicyIfName=wsPolicyIfName, wsIbosFanRPMLow=wsIbosFanRPMLow, PYSNMP_MODULE_ID=ibos, wsTempThresholdLow=wsTempThresholdLow, wsSFPPartNumber=wsSFPPartNumber, wsPolicyOutDrops=wsPolicyOutDrops, wsWritedummy=wsWritedummy, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourLocalIf=wsNeighbourLocalIf, wsVoltMeasured=wsVoltMeasured, wsTempMeasured=wsTempMeasured, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsTempTHYST=wsTempTHYST, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsFanEntry=wsFanEntry, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPTempStatus=wsXFPTempStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVersionString=wsVersionString, wsFanRPM=wsFanRPM, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighboursTable=wsNeighboursTable, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPStatus=wsXFPStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPTXPower=wsXFPTXPower, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPRXPower=wsSFPRXPower, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPTable=wsXFPTable, wsSFPTable=wsSFPTable, wsSFPTXPower=wsSFPTXPower, wsPolicyInDrops=wsPolicyInDrops, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsTempStatus=wsTempStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTempStatus=wsSFPTempStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPCopperLen=wsSFPCopperLen, wsTempEntry=wsTempEntry, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsFanVoltage=wsFanVoltage, wsPolicyTable=wsPolicyTable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPFDP=wsPFDP, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyName=wsPolicyName, wsXFPRXPower=wsXFPRXPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPEntry=wsXFPEntry, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTempNormalLow=wsSFPTempNormalLow, wsVoltNominal=wsVoltNominal, wsEnvironment=wsEnvironment, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyInBytes=wsPolicyInBytes, wsVersion=wsVersion, wsSFPRXdBmPower=wsSFPRXdBmPower, wsFanNumber=wsFanNumber, wsAccounting=wsAccounting, wsAsrRevision=wsAsrRevision)
