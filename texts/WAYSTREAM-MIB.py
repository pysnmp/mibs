...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPCopperLen=wsSFPCopperLen, wsVoltEntry=wsVoltEntry, wsFanEntry=wsFanEntry, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPIndex=wsXFPIndex, wsXFPTempStatus=wsXFPTempStatus, wsTempTOS=wsTempTOS, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourIfIndex=wsNeighbourIfIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortName=wsNeighbourPortName, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPRXPower=wsXFPRXPower, wsXFPTXCurrent=wsXFPTXCurrent, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsTempEntry=wsTempEntry, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsTempTable=wsTempTable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPStatus=wsXFPStatus, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPBitrate=wsSFPBitrate, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsAccounting=wsAccounting, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyIfName=wsPolicyIfName, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTable=wsSFPTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsIbosVoltHigh=wsIbosVoltHigh, wsPolicyName=wsPolicyName, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsFanNumber=wsFanNumber, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPEncoding=wsXFPEncoding, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsVoltTable=wsVoltTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPRXPower=wsSFPRXPower, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyInPkts=wsPolicyInPkts, wsPolicyInBytes=wsPolicyInBytes, PYSNMP_MODULE_ID=ibos, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyTable=wsPolicyTable, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPCopperLen=wsXFPCopperLen, wsXFPTable=wsXFPTable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyOutBytes=wsPolicyOutBytes, wsIbosTempHigh=wsIbosTempHigh, wsEnvironment=wsEnvironment, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPSingleModeLen=wsSFPSingleModeLen, ibos=ibos, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempStatus=wsTempStatus, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsIbosTempLow=wsIbosTempLow, wsXFPConnector=wsXFPConnector, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPStatus=wsSFPStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPTemp=wsXFPTemp, wsPolicyIfIndex=wsPolicyIfIndex, wsTempSensor=wsTempSensor, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVoltMeasured=wsVoltMeasured, wsNeighbourUptime=wsNeighbourUptime, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsAsrRevision=wsAsrRevision, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPolicyCookie=wsPolicyCookie, wsNeighbourCreated=wsNeighbourCreated, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVersionString=wsVersionString, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsVoltStatus=wsVoltStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsVoltNominal=wsVoltNominal, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXPower=wsSFPTXPower, wsSystem=wsSystem, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsFanVoltage=wsFanVoltage, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsTempMeasured=wsTempMeasured, wsVoltChannel=wsVoltChannel, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsFanTable=wsFanTable, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPEntry=wsSFPEntry, wsWritedummy=wsWritedummy, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPTXPower=wsXFPTXPower, wsTempThresholdLow=wsTempThresholdLow, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPEncoding=wsSFPEncoding, wsSFPTransceiver=wsSFPTransceiver, wsTempTHYST=wsTempTHYST, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPFDP=wsPFDP, wsVoltThresholdLow=wsVoltThresholdLow, wsFanRPM=wsFanRPM, wsPolicyInDrops=wsPolicyInDrops, wsVersion=wsVersion, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXdBmPower=wsSFPTXdBmPower, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsReload=wsReload, wsXFPEntry=wsXFPEntry, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPPartNumber=wsSFPPartNumber, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTemp=wsSFPTemp, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPIndex=wsSFPIndex)
