...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPIndex=wsSFPIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyTable=wsPolicyTable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPConnector=wsSFPConnector, wsTempTOS=wsTempTOS, wsPolicyCookie=wsPolicyCookie, wsFanNumber=wsFanNumber, wsNeighbourModel=wsNeighbourModel, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyInDrops=wsPolicyInDrops, wsXFPEncoding=wsXFPEncoding, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPStatus=wsXFPStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsVoltEntry=wsVoltEntry, wsSystem=wsSystem, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVersion=wsVersion, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPTable=wsXFPTable, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPBitrateMin=wsXFPBitrateMin, wsAccounting=wsAccounting, wsVersionString=wsVersionString, wsTempTable=wsTempTable, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyEntry=wsPolicyEntry, wsNeighbourState=wsNeighbourState, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsVoltStatus=wsVoltStatus, wsSFPEncoding=wsSFPEncoding, wsVoltMeasured=wsVoltMeasured, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourUptime=wsNeighbourUptime, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsFanRPM=wsFanRPM, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourNIndex=wsNeighbourNIndex, wsTempStatus=wsTempStatus, wsVoltNominal=wsVoltNominal, wsXFPRXPower=wsXFPRXPower, wsXFPIndex=wsXFPIndex, wsXFPTemp=wsXFPTemp, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsTempTHYST=wsTempTHYST, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTXPower=wsXFPTXPower, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPBitrate=wsSFPBitrate, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTemp=wsSFPTemp, ibos=ibos, wsAsrRevision=wsAsrRevision, wsSFPEntry=wsSFPEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsIbosTempLow=wsIbosTempLow, wsSFPVolt=wsSFPVolt, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyIfIndex=wsPolicyIfIndex, wsEnvironment=wsEnvironment, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVoltChannel=wsVoltChannel, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTable=wsSFPTable, wsTempMeasured=wsTempMeasured, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTransceiver=wsSFPTransceiver, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsFanVoltage=wsFanVoltage, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPConnector=wsXFPConnector, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPStatus=wsSFPStatus, wsXFPTXCurrent=wsXFPTXCurrent, wsFanEntry=wsFanEntry, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyIfName=wsPolicyIfName, wsPolicyOutDrops=wsPolicyOutDrops, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyName=wsPolicyName, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPRXPower=wsSFPRXPower, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourHostname=wsNeighbourHostname, wsNeighboursEntry=wsNeighboursEntry, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTempNormalLow=wsSFPTempNormalLow, wsReload=wsReload, wsNeighbourPortName=wsNeighbourPortName, wsXFPTempStatus=wsXFPTempStatus, wsTempSensor=wsTempSensor, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsWritedummy=wsWritedummy, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsTempEntry=wsTempEntry, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPCopperLen=wsSFPCopperLen, wsPolicyInPkts=wsPolicyInPkts, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsIbosTempHigh=wsIbosTempHigh, wsXFPCopperLen=wsXFPCopperLen, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourOSVersion=wsNeighbourOSVersion, PYSNMP_MODULE_ID=ibos, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPEntry=wsXFPEntry, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyOutBytes=wsPolicyOutBytes, wsPFDP=wsPFDP, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVoltTable=wsVoltTable, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsFanTable=wsFanTable, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW)
