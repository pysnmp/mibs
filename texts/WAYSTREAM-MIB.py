...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourNIndex=wsNeighbourNIndex, wsFanNumber=wsFanNumber, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsIbosVoltLow=wsIbosVoltLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsVoltNominal=wsVoltNominal, wsSFPRXPower=wsSFPRXPower, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsVoltEntry=wsVoltEntry, wsVersionString=wsVersionString, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsTempThresholdHigh=wsTempThresholdHigh, wsEnvironment=wsEnvironment, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempSensor=wsTempSensor, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPStatus=wsSFPStatus, wsXFPTemp=wsXFPTemp, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPTempStatus=wsXFPTempStatus, wsXFPCopperLen=wsXFPCopperLen, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsPolicyIfName=wsPolicyIfName, wsIbosVoltHigh=wsIbosVoltHigh, wsVoltChannel=wsVoltChannel, wsPFDP=wsPFDP, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPTXCurrent=wsXFPTXCurrent, wsTempMeasured=wsTempMeasured, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPTable=wsXFPTable, wsXFPConnector=wsXFPConnector, wsPolicyInBytes=wsPolicyInBytes, wsReload=wsReload, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPEncoding=wsXFPEncoding, wsNeighboursEntry=wsNeighboursEntry, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsFanEntry=wsFanEntry, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsTempTOS=wsTempTOS, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPolicyName=wsPolicyName, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSystem=wsSystem, wsVersion=wsVersion, wsSFPEncoding=wsSFPEncoding, wsPolicyInPkts=wsPolicyInPkts, wsTempTHYST=wsTempTHYST, wsSFPBitrate=wsSFPBitrate, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourModel=wsNeighbourModel, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPEntry=wsSFPEntry, wsSFPTemp=wsSFPTemp, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyTable=wsPolicyTable, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPVolt=wsSFPVolt, wsNeighbourUptime=wsNeighbourUptime, wsNeighboursTable=wsNeighboursTable, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPSingleModeLen=wsSFPSingleModeLen, wsFanTable=wsFanTable, wsNeighbourPortName=wsNeighbourPortName, wsXFPStatus=wsXFPStatus, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsAccounting=wsAccounting, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempEntry=wsTempEntry, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPIndex=wsSFPIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTempStatus=wsSFPTempStatus, ibos=ibos, wsTempStatus=wsTempStatus, wsAsrRevision=wsAsrRevision, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPConnector=wsSFPConnector, wsXFPRXPower=wsXFPRXPower, PYSNMP_MODULE_ID=ibos, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsFanRPM=wsFanRPM, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortState=wsNeighbourPortState, wsVoltMeasured=wsVoltMeasured, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourSNPA=wsNeighbourSNPA, wsPolicyCookie=wsPolicyCookie, wsXFPIndex=wsXFPIndex, wsVoltTable=wsVoltTable, wsPolicyEntry=wsPolicyEntry, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsTempTable=wsTempTable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTable=wsSFPTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPPartNumber=wsSFPPartNumber, wsXFPEntry=wsXFPEntry, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsWritedummy=wsWritedummy, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPSerialNumber=wsSFPSerialNumber, wsTempThresholdLow=wsTempThresholdLow, wsXFPTransceiver=wsXFPTransceiver, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW)
