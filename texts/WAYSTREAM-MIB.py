...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPolicyEntry=wsPolicyEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyInBytes=wsPolicyInBytes, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXPower=wsSFPTXPower, wsSFPTemp=wsSFPTemp, wsXFPEntry=wsXFPEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsFanEntry=wsFanEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVoltNominal=wsVoltNominal, wsAccounting=wsAccounting, wsVoltThresholdHigh=wsVoltThresholdHigh, ibos=ibos, wsNeighbourPortState=wsNeighbourPortState, wsFanNumber=wsFanNumber, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVoltTable=wsVoltTable, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTransceiver=wsSFPTransceiver, wsXFPTemp=wsXFPTemp, wsNeighbourCreated=wsNeighbourCreated, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourSNPA=wsNeighbourSNPA, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsVersion=wsVersion, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPFDP=wsPFDP, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourState=wsNeighbourState, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsReload=wsReload, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortName=wsNeighbourPortName, wsSFPBitrate=wsSFPBitrate, wsTempMeasured=wsTempMeasured, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPTable=wsXFPTable, PYSNMP_MODULE_ID=ibos, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPIndex=wsSFPIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyInPkts=wsPolicyInPkts, wsFanTable=wsFanTable, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXCurrent=wsSFPTXCurrent, wsVoltChannel=wsVoltChannel, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXPower=wsSFPRXPower, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPEncoding=wsSFPEncoding, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPIndex=wsXFPIndex, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPEncoding=wsXFPEncoding, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsIbosTempHigh=wsIbosTempHigh, wsTempTHYST=wsTempTHYST, wsPolicyIfName=wsPolicyIfName, wsPolicyInDrops=wsPolicyInDrops, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsTempTOS=wsTempTOS, wsTempEntry=wsTempEntry, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSystem=wsSystem, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourNIndex=wsNeighbourNIndex, wsTempSensor=wsTempSensor, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPEntry=wsSFPEntry, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourLocalIf=wsNeighbourLocalIf, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPConnector=wsXFPConnector, wsSFPConnector=wsSFPConnector, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPVolt=wsSFPVolt, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPVoltStatus=wsSFPVoltStatus, wsWritedummy=wsWritedummy, wsNeighbourHostname=wsNeighbourHostname, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPRXPower=wsXFPRXPower, wsSFPTable=wsSFPTable, wsSFPTempWarningLow=wsSFPTempWarningLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsAsrRevision=wsAsrRevision, wsVersionString=wsVersionString, wsPolicyCookie=wsPolicyCookie, wsEnvironment=wsEnvironment, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyName=wsPolicyName, wsNeighbourUptime=wsNeighbourUptime, wsTempTable=wsTempTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyTable=wsPolicyTable, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsVoltThresholdLow=wsVoltThresholdLow, wsVoltStatus=wsVoltStatus, wsFanVoltage=wsFanVoltage, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPStatus=wsSFPStatus, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsFanRPM=wsFanRPM, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsTempStatus=wsTempStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex)
