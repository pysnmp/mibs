...
Counter32, ModuleIdentity, ObjectIdentity, NotificationType, Unsigned32, TimeTicks, MibIdentifier, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Unsigned32", "TimeTicks", "MibIdentifier", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPRXPower=wsXFPRXPower, wsSFPTransceiver=wsSFPTransceiver, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourModel=wsNeighbourModel, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPTempStatus=wsXFPTempStatus, wsFanEntry=wsFanEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsTempThresholdLow=wsTempThresholdLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPVolt=wsSFPVolt, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsFanRPM=wsFanRPM, wsTempTOS=wsTempTOS, wsXFPStatus=wsXFPStatus, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTable=wsXFPTable, wsVersion=wsVersion, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsVersionString=wsVersionString, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPBitrateMin=wsXFPBitrateMin, wsTempTable=wsTempTable, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsIbosTempLow=wsIbosTempLow, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, PYSNMP_MODULE_ID=ibos, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPIndex=wsSFPIndex, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsPolicyInBytes=wsPolicyInBytes, wsReload=wsReload, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPConnector=wsSFPConnector, wsAccounting=wsAccounting, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsEnvironment=wsEnvironment, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyInPkts=wsPolicyInPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyCookie=wsPolicyCookie, wsWritedummy=wsWritedummy, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsFanVoltage=wsFanVoltage, wsFanNumber=wsFanNumber, wsNeighbourUptime=wsNeighbourUptime, wsPolicyInDrops=wsPolicyInDrops, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighboursTable=wsNeighboursTable, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyName=wsPolicyName, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortState=wsNeighbourPortState, wsXFPTemp=wsXFPTemp, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPStatus=wsSFPStatus, wsVoltTable=wsVoltTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTable=wsSFPTable, wsIbosVoltHigh=wsIbosVoltHigh, wsVoltNominal=wsVoltNominal, wsNeighbourNIndex=wsNeighbourNIndex, wsTempSensor=wsTempSensor, wsPolicyEntry=wsPolicyEntry, wsNeighboursEntry=wsNeighboursEntry, wsXFPEncoding=wsXFPEncoding, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTemp=wsSFPTemp, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsTempTHYST=wsTempTHYST, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsTempMeasured=wsTempMeasured, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPEncoding=wsSFPEncoding, wsXFPConnector=wsXFPConnector, wsFanTable=wsFanTable, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPEntry=wsSFPEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosTempHigh=wsIbosTempHigh, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSystem=wsSystem, wsVoltEntry=wsVoltEntry, wsTempEntry=wsTempEntry, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsTempStatus=wsTempStatus, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourDBCount=wsNeighbourDBCount, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPRXPowerStatus=wsXFPRXPowerStatus, ibos=ibos, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPTXPower=wsXFPTXPower, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPPartNumber=wsSFPPartNumber, wsVoltChannel=wsVoltChannel, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPEntry=wsXFPEntry, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPCopperLen=wsSFPCopperLen, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsAsrRevision=wsAsrRevision, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPFDP=wsPFDP, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourState=wsNeighbourState, wsPolicyTable=wsPolicyTable, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus)
