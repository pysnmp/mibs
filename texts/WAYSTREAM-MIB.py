...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighboursTable=wsNeighboursTable, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsWritedummy=wsWritedummy, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPStatus=wsXFPStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsTempEntry=wsTempEntry, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyIfName=wsPolicyIfName, wsXFPTXCurrent=wsXFPTXCurrent, wsFanNumber=wsFanNumber, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyName=wsPolicyName, wsVoltEntry=wsVoltEntry, wsXFPTable=wsXFPTable, wsSFPStatus=wsSFPStatus, wsSFPVolt=wsSFPVolt, wsXFPConnector=wsXFPConnector, wsXFPEntry=wsXFPEntry, wsSFPTable=wsSFPTable, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsIbosVoltLow=wsIbosVoltLow, wsTempTOS=wsTempTOS, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourDBCount=wsNeighbourDBCount, PYSNMP_MODULE_ID=ibos, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPConnector=wsSFPConnector, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVersionString=wsVersionString, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsAsrRevision=wsAsrRevision, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTemp=wsXFPTemp, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourHostname=wsNeighbourHostname, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPRXPower=wsXFPRXPower, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPIndex=wsXFPIndex, wsSFPEntry=wsSFPEntry, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPTXPower=wsXFPTXPower, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortName=wsNeighbourPortName, wsVersion=wsVersion, wsVoltMeasured=wsVoltMeasured, wsXFPBitrateMin=wsXFPBitrateMin, wsAccounting=wsAccounting, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsReload=wsReload, wsTempStatus=wsTempStatus, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXPower=wsSFPRXPower, wsTempTable=wsTempTable, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPIndex=wsSFPIndex, wsPFDP=wsPFDP, wsSystem=wsSystem, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPEncoding=wsXFPEncoding, wsXFPCopperLen=wsXFPCopperLen, wsSFPSerialNumber=wsSFPSerialNumber, wsVoltNominal=wsVoltNominal, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourModel=wsNeighbourModel, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighboursEntry=wsNeighboursEntry, wsPolicyCookie=wsPolicyCookie, wsSFPTemp=wsSFPTemp, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTempWarningLow=wsSFPTempWarningLow, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourState=wsNeighbourState, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyTable=wsPolicyTable, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyInPkts=wsPolicyInPkts, wsFanEntry=wsFanEntry, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyInDrops=wsPolicyInDrops, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsEnvironment=wsEnvironment, wsXFPTransceiver=wsXFPTransceiver, wsIbosVoltHigh=wsIbosVoltHigh, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsTempSensor=wsTempSensor, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsPolicyEntry=wsPolicyEntry, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyInBytes=wsPolicyInBytes, wsFanTable=wsFanTable, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsVoltStatus=wsVoltStatus, wsFanRPM=wsFanRPM, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsTempTHYST=wsTempTHYST, wsVoltTable=wsVoltTable, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, ibos=ibos, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsIbosTempHigh=wsIbosTempHigh, wsIbosTempLow=wsIbosTempLow)
