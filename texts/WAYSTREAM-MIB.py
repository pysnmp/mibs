...
iso, Bits, IpAddress, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, ModuleIdentity, Unsigned32, TimeTicks, Counter64, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "IpAddress", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "TimeTicks", "Counter64", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsTempSensor=wsTempSensor, wsVoltChannel=wsVoltChannel, wsXFPTable=wsXFPTable, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSystem=wsSystem, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourState=wsNeighbourState, wsNeighbourModel=wsNeighbourModel, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPIndex=wsSFPIndex, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsTempTable=wsTempTable, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPolicyEntry=wsPolicyEntry, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPEntry=wsSFPEntry, wsXFPTempStatus=wsXFPTempStatus, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsTempStatus=wsTempStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPEncoding=wsSFPEncoding, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsPolicyCookie=wsPolicyCookie, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVersion=wsVersion, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPEntry=wsXFPEntry, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsAccounting=wsAccounting, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortsTable=wsNeighbourPortsTable, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPTransceiver=wsXFPTransceiver, wsPolicyInDrops=wsPolicyInDrops, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPStatus=wsSFPStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPBitrateMax=wsXFPBitrateMax, ibos=ibos, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsReload=wsReload, wsFanEntry=wsFanEntry, wsSFPTXPower=wsSFPTXPower, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPPartNumber=wsSFPPartNumber, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPConnector=wsSFPConnector, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPVoltStatus=wsSFPVoltStatus, wsPolicyName=wsPolicyName, wsSFPBitrate=wsSFPBitrate, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPEncoding=wsXFPEncoding, wsVoltEntry=wsVoltEntry, wsFanRPM=wsFanRPM, wsVoltNominal=wsVoltNominal, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsFanNumber=wsFanNumber, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighboursTable=wsNeighboursTable, wsPolicyIfName=wsPolicyIfName, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsPolicyOutBytes=wsPolicyOutBytes, wsTempMeasured=wsTempMeasured, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPRXPower=wsSFPRXPower, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVersionString=wsVersionString, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsTempTOS=wsTempTOS, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourUptime=wsNeighbourUptime, wsIbosVoltHigh=wsIbosVoltHigh, wsTempThresholdLow=wsTempThresholdLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyInBytes=wsPolicyInBytes, wsXFPTemp=wsXFPTemp, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighboursEntry=wsNeighboursEntry, wsPolicyTable=wsPolicyTable, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPFDP=wsPFDP, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPSingleModeLen=wsSFPSingleModeLen, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsVoltTable=wsVoltTable, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, PYSNMP_MODULE_ID=ibos, wsTempEntry=wsTempEntry, wsEnvironment=wsEnvironment, wsNeighbourPortState=wsNeighbourPortState, wsXFPConnector=wsXFPConnector, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourCreated=wsNeighbourCreated, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTXPower=wsXFPTXPower, wsSFPVolt=wsSFPVolt, wsXFPStatus=wsXFPStatus, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVoltStatus=wsVoltStatus, wsVoltMeasured=wsVoltMeasured, wsAsrRevision=wsAsrRevision, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsTempTHYST=wsTempTHYST, wsFanTable=wsFanTable, wsSFPTable=wsSFPTable, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTempStatus=wsSFPTempStatus, wsXFPIndex=wsXFPIndex, wsSFPTemp=wsSFPTemp, wsWritedummy=wsWritedummy, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts)
