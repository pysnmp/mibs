...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, ibos=ibos, wsSFPRXdBmPower=wsSFPRXdBmPower, wsAsrRevision=wsAsrRevision, wsWritedummy=wsWritedummy, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsVoltEntry=wsVoltEntry, wsPolicyCookie=wsPolicyCookie, wsXFPEntry=wsXFPEntry, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsFanRPM=wsFanRPM, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPTempStatus=wsXFPTempStatus, wsVersion=wsVersion, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPTXCurrent=wsXFPTXCurrent, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyInDrops=wsPolicyInDrops, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsVoltTable=wsVoltTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourModel=wsNeighbourModel, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPTable=wsXFPTable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsTempTHYST=wsTempTHYST, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsTempTOS=wsTempTOS, wsIbosFanRPMLow=wsIbosFanRPMLow, wsFanEntry=wsFanEntry, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourSNPA=wsNeighbourSNPA, wsFanNumber=wsFanNumber, wsVoltNominal=wsVoltNominal, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPTransceiver=wsXFPTransceiver, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXPower=wsSFPTXPower, wsTempMeasured=wsTempMeasured, wsPolicyInBytes=wsPolicyInBytes, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsIbosTempLow=wsIbosTempLow, wsPolicyIfIndex=wsPolicyIfIndex, wsVersionString=wsVersionString, wsPolicyTable=wsPolicyTable, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortState=wsNeighbourPortState, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPStatus=wsXFPStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourState=wsNeighbourState, wsSFPStatus=wsSFPStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsTempStatus=wsTempStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourUptime=wsNeighbourUptime, wsFanVoltage=wsFanVoltage, wsPolicyIfName=wsPolicyIfName, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsPFDP=wsPFDP, wsTempSensor=wsTempSensor, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourCreated=wsNeighbourCreated, wsVoltChannel=wsVoltChannel, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPTemp=wsXFPTemp, wsSystem=wsSystem, wsReload=wsReload, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, PYSNMP_MODULE_ID=ibos, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsIbosVoltHigh=wsIbosVoltHigh, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPVolt=wsSFPVolt, wsSFPTable=wsSFPTable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPEntry=wsSFPEntry, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTemp=wsSFPTemp, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsTempTable=wsTempTable, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsTempEntry=wsTempEntry, wsEnvironment=wsEnvironment, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsXFPIndex=wsXFPIndex, wsNeighbourIfIndex=wsNeighbourIfIndex, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPEncoding=wsXFPEncoding, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPConnector=wsXFPConnector, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsFanTable=wsFanTable, wsPolicyName=wsPolicyName, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPBitrate=wsSFPBitrate, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTempStatus=wsSFPTempStatus, wsAccounting=wsAccounting, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPCopperLen=wsXFPCopperLen, wsXFPTXPower=wsXFPTXPower, wsNeighboursEntry=wsNeighboursEntry, wsSFPConnector=wsSFPConnector, wsSFPIndex=wsSFPIndex, wsVoltStatus=wsVoltStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors)
