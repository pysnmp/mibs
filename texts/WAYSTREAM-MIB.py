...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsTempEntry=wsTempEntry, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTable=wsSFPTable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPTable=wsXFPTable, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsWritedummy=wsWritedummy, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsVoltThresholdHigh=wsVoltThresholdHigh, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPVoltStatus=wsSFPVoltStatus, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPStatus=wsSFPStatus, wsFanNumber=wsFanNumber, wsVoltTable=wsVoltTable, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighboursTable=wsNeighboursTable, wsFanRPM=wsFanRPM, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsIbosVoltLow=wsIbosVoltLow, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, ibos=ibos, wsTempSensor=wsTempSensor, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPConnector=wsSFPConnector, wsNeighbourLastAct=wsNeighbourLastAct, wsVersion=wsVersion, wsIbosTempLow=wsIbosTempLow, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyTable=wsPolicyTable, wsSFPPartNumber=wsSFPPartNumber, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyIfName=wsPolicyIfName, wsXFPConnector=wsXFPConnector, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempThresholdLow=wsTempThresholdLow, wsAsrRevision=wsAsrRevision, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyInDrops=wsPolicyInDrops, wsEnvironment=wsEnvironment, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyName=wsPolicyName, wsFanTable=wsFanTable, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsAccounting=wsAccounting, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, wsTempTOS=wsTempTOS, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPVolt=wsSFPVolt, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourModel=wsNeighbourModel, wsFanVoltage=wsFanVoltage, wsPFDP=wsPFDP, wsNeighbourUptime=wsNeighbourUptime, wsXFPTXPower=wsXFPTXPower, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsPolicyEntry=wsPolicyEntry, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltChannel=wsVoltChannel, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourState=wsNeighbourState, wsFanEntry=wsFanEntry, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsTempMeasured=wsTempMeasured, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsPolicyCookie=wsPolicyCookie, wsSFPEncoding=wsSFPEncoding, wsXFPEntry=wsXFPEntry, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTemp=wsSFPTemp, wsSFPTempStatus=wsSFPTempStatus, wsVersionString=wsVersionString, wsSystem=wsSystem, wsSFPIndex=wsSFPIndex, wsXFPTemp=wsXFPTemp, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTransceiver=wsSFPTransceiver, wsVoltNominal=wsVoltNominal, wsTempTable=wsTempTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortState=wsNeighbourPortState, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPEntry=wsSFPEntry, wsNeighbourPortName=wsNeighbourPortName, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, PYSNMP_MODULE_ID=ibos, wsReload=wsReload, wsPolicyInBytes=wsPolicyInBytes, wsXFPEncoding=wsXFPEncoding, wsNeighboursEntry=wsNeighboursEntry, wsVoltStatus=wsVoltStatus, wsTempTHYST=wsTempTHYST, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPCopperLen=wsXFPCopperLen, wsVoltEntry=wsVoltEntry, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPStatus=wsXFPStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXPower=wsSFPTXPower, wsIbosTempHigh=wsIbosTempHigh, wsTempStatus=wsTempStatus, wsXFPIndex=wsXFPIndex)
