...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXdBmPower=wsSFPRXdBmPower, wsFanVoltage=wsFanVoltage, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPEntry=wsSFPEntry, wsSFPStatus=wsSFPStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPIndex=wsSFPIndex, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSystem=wsSystem, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyIfName=wsPolicyIfName, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVoltChannel=wsVoltChannel, wsSFPTransceiverExt=wsSFPTransceiverExt, wsEnvironment=wsEnvironment, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsTempStatus=wsTempStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourDBCount=wsNeighbourDBCount, wsTempMeasured=wsTempMeasured, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempTOS=wsTempTOS, wsPolicyInPkts=wsPolicyInPkts, wsXFPTemp=wsXFPTemp, wsIbosVoltHigh=wsIbosVoltHigh, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourModel=wsNeighbourModel, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPConnector=wsSFPConnector, wsReload=wsReload, wsVersion=wsVersion, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsTempTable=wsTempTable, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsTempTHYST=wsTempTHYST, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTempStatus=wsXFPTempStatus, wsAsrRevision=wsAsrRevision, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPConnector=wsXFPConnector, wsSFPTransceiver=wsSFPTransceiver, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsFanNumber=wsFanNumber, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPVolt=wsSFPVolt, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPSingleModeLen=wsXFPSingleModeLen, ibos=ibos, wsPolicyInDrops=wsPolicyInDrops, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTable=wsSFPTable, wsSFPCopperLen=wsSFPCopperLen, wsXFPEntry=wsXFPEntry, wsPolicyCookie=wsPolicyCookie, wsXFPCopperLen=wsXFPCopperLen, wsTempSensor=wsTempSensor, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyTable=wsPolicyTable, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPEncoding=wsSFPEncoding, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPEncoding=wsXFPEncoding, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyName=wsPolicyName, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighboursEntry=wsNeighboursEntry, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsFanEntry=wsFanEntry, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsFanRPM=wsFanRPM, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighboursTable=wsNeighboursTable, wsWritedummy=wsWritedummy, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPPartNumber=wsSFPPartNumber, wsVoltStatus=wsVoltStatus, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTempStatus=wsSFPTempStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXPower=wsSFPTXPower, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPTable=wsXFPTable, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsPolicyIfIndex=wsPolicyIfIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPRXPower=wsXFPRXPower, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortState=wsNeighbourPortState, wsPolicyInBytes=wsPolicyInBytes, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsVoltNominal=wsVoltNominal, wsVoltEntry=wsVoltEntry, wsFanTable=wsFanTable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTemp=wsSFPTemp, wsNeighbourState=wsNeighbourState, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsVersionString=wsVersionString, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVoltMeasured=wsVoltMeasured, wsVoltTable=wsVoltTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXPower=wsSFPRXPower, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, PYSNMP_MODULE_ID=ibos, wsSFPBitrate=wsSFPBitrate, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsPolicyOutPkts=wsPolicyOutPkts, wsAccounting=wsAccounting, wsTempEntry=wsTempEntry, wsPFDP=wsPFDP, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts)
