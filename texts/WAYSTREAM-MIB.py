...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPEntry=wsXFPEntry, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourState=wsNeighbourState, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsFanTable=wsFanTable, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyCookie=wsPolicyCookie, wsXFPIndex=wsXFPIndex, wsVoltTable=wsVoltTable, wsFanNumber=wsFanNumber, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltChannel=wsVoltChannel, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTable=wsSFPTable, wsIbosTempLow=wsIbosTempLow, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyOutDrops=wsPolicyOutDrops, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPRXPower=wsSFPRXPower, wsNeighbourHostname=wsNeighbourHostname, wsAccounting=wsAccounting, wsXFPTemp=wsXFPTemp, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourUptime=wsNeighbourUptime, wsNeighboursEntry=wsNeighboursEntry, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTemp=wsSFPTemp, wsNeighbourPortsTable=wsNeighbourPortsTable, wsVersion=wsVersion, wsSFPEntry=wsSFPEntry, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPRXPower=wsXFPRXPower, wsWritedummy=wsWritedummy, wsTempTOS=wsTempTOS, wsAsrRevision=wsAsrRevision, wsFanRPM=wsFanRPM, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsEnvironment=wsEnvironment, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPBitrate=wsSFPBitrate, wsPolicyEntry=wsPolicyEntry, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, ibos=ibos, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourNIndex=wsNeighbourNIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsTempTable=wsTempTable, wsTempEntry=wsTempEntry, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPFDP=wsPFDP, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourModel=wsNeighbourModel, wsPolicyIfIndex=wsPolicyIfIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyTable=wsPolicyTable, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempStatus=wsTempStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsVoltEntry=wsVoltEntry, wsSFPCopperLen=wsSFPCopperLen, wsSFPStatus=wsSFPStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPConnector=wsSFPConnector, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsPolicyName=wsPolicyName, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPBitrateMin=wsXFPBitrateMin, wsSystem=wsSystem, wsXFPTransceiver=wsXFPTransceiver, wsVoltMeasured=wsVoltMeasured, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsTempTHYST=wsTempTHYST, wsTempThresholdLow=wsTempThresholdLow, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPConnector=wsXFPConnector, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPStatus=wsXFPStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsVersionString=wsVersionString, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsTempSensor=wsTempSensor, wsNeighbourPortNIndex=wsNeighbourPortNIndex, PYSNMP_MODULE_ID=ibos, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPIndex=wsSFPIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighboursTable=wsNeighboursTable, wsSFPTransceiver=wsSFPTransceiver, wsFanEntry=wsFanEntry, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsPolicyIfName=wsPolicyIfName, wsPolicyInPkts=wsPolicyInPkts, wsVoltNominal=wsVoltNominal, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsIbosTempHigh=wsIbosTempHigh, wsVoltStatus=wsVoltStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPEncoding=wsSFPEncoding, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsFanVoltage=wsFanVoltage, wsXFPTable=wsXFPTable, wsSFPVolt=wsSFPVolt, wsReload=wsReload, wsVoltThresholdHigh=wsVoltThresholdHigh)
