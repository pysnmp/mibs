...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPTable=wsXFPTable, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsVersionString=wsVersionString, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourCreated=wsNeighbourCreated, wsSFPEntry=wsSFPEntry, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempTable=wsTempTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsAsrRevision=wsAsrRevision, wsSFPCopperLen=wsSFPCopperLen, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTemp=wsSFPTemp, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyInDrops=wsPolicyInDrops, wsPolicyCookie=wsPolicyCookie, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPIndex=wsSFPIndex, wsXFPEntry=wsXFPEntry, wsXFPTransceiver=wsXFPTransceiver, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTable=wsSFPTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyName=wsPolicyName, wsPolicyTable=wsPolicyTable, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVoltChannel=wsVoltChannel, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempSensor=wsTempSensor, wsNeighbourUptime=wsNeighbourUptime, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPEncoding=wsXFPEncoding, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsFanNumber=wsFanNumber, wsTempMeasured=wsTempMeasured, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsPolicyInBytes=wsPolicyInBytes, wsVoltMeasured=wsVoltMeasured, wsSFPVolt=wsSFPVolt, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsFanRPM=wsFanRPM, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsFanEntry=wsFanEntry, wsTempTOS=wsTempTOS, wsNeighbourOSVersion=wsNeighbourOSVersion, wsPolicyEntry=wsPolicyEntry, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyInPkts=wsPolicyInPkts, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTempStatus=wsSFPTempStatus, wsSFPEncoding=wsSFPEncoding, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourModel=wsNeighbourModel, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsTempStatus=wsTempStatus, wsFanVoltage=wsFanVoltage, wsVoltTable=wsVoltTable, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsVoltNominal=wsVoltNominal, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPStatus=wsSFPStatus, wsEnvironment=wsEnvironment, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsWritedummy=wsWritedummy, wsVoltStatus=wsVoltStatus, wsSFPTransceiver=wsSFPTransceiver, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourState=wsNeighbourState, wsSystem=wsSystem, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, PYSNMP_MODULE_ID=ibos, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourNIndex=wsNeighbourNIndex, wsTempEntry=wsTempEntry, wsPFDP=wsPFDP, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPStatus=wsXFPStatus, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighboursTable=wsNeighboursTable, wsSFPTXdBmPower=wsSFPTXdBmPower, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsFanTable=wsFanTable, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPBitrate=wsSFPBitrate, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPIndex=wsXFPIndex, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosTempLow=wsIbosTempLow, wsXFPTempStatus=wsXFPTempStatus, wsReload=wsReload, wsAccounting=wsAccounting, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPConnector=wsXFPConnector, wsXFPBitrateMin=wsXFPBitrateMin, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTXPower=wsXFPTXPower, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsVersion=wsVersion, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsTempThresholdLow=wsTempThresholdLow, wsXFPTemp=wsXFPTemp, wsIbosTempHigh=wsIbosTempHigh, wsTempTHYST=wsTempTHYST, wsSFPTXPower=wsSFPTXPower, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortNIndex=wsNeighbourPortNIndex, ibos=ibos, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm)
