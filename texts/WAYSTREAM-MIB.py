...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPolicyInBytes=wsPolicyInBytes, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourState=wsNeighbourState, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPConnector=wsXFPConnector, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPStatus=wsSFPStatus, wsPolicyEntry=wsPolicyEntry, wsXFPBitrateMax=wsXFPBitrateMax, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPIndex=wsXFPIndex, wsIbosVoltHigh=wsIbosVoltHigh, wsVersion=wsVersion, wsXFPRXPower=wsXFPRXPower, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsTempMeasured=wsTempMeasured, wsReload=wsReload, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTempNormalLow=wsSFPTempNormalLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsTempTHYST=wsTempTHYST, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPIndex=wsSFPIndex, wsSFPCopperLen=wsSFPCopperLen, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsWritedummy=wsWritedummy, wsXFPTable=wsXFPTable, wsXFPStatus=wsXFPStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsFanEntry=wsFanEntry, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTransceiverExt=wsSFPTransceiverExt, PYSNMP_MODULE_ID=ibos, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPEncoding=wsSFPEncoding, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, ibos=ibos, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPBitrateMin=wsXFPBitrateMin, wsIbosTempHigh=wsIbosTempHigh, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVoltEntry=wsVoltEntry, wsSystem=wsSystem, wsPolicyInDrops=wsPolicyInDrops, wsVoltChannel=wsVoltChannel, wsNeighbourHostname=wsNeighbourHostname, wsPolicyOutBytes=wsPolicyOutBytes, wsFanNumber=wsFanNumber, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVoltTable=wsVoltTable, wsVoltNominal=wsVoltNominal, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortName=wsNeighbourPortName, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPEntry=wsXFPEntry, wsTempStatus=wsTempStatus, wsSFPTemp=wsSFPTemp, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyTable=wsPolicyTable, wsVoltMeasured=wsVoltMeasured, wsNeighbourLocalIf=wsNeighbourLocalIf, wsFanRPM=wsFanRPM, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXPower=wsSFPTXPower, wsSFPSingleModeLen=wsSFPSingleModeLen, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPTXPower=wsXFPTXPower, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsVoltStatus=wsVoltStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTable=wsSFPTable, wsAsrRevision=wsAsrRevision, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighboursTable=wsNeighboursTable, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTempStatus=wsSFPTempStatus, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsPolicyOutDrops=wsPolicyOutDrops, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyName=wsPolicyName, wsIbosTempLow=wsIbosTempLow, wsSFPEntry=wsSFPEntry, wsPolicyOutPkts=wsPolicyOutPkts, wsTempEntry=wsTempEntry, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPConnector=wsSFPConnector, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsFanTable=wsFanTable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsEnvironment=wsEnvironment, wsPolicyCookie=wsPolicyCookie, wsXFPTransceiver=wsXFPTransceiver, wsFanVoltage=wsFanVoltage, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsTempSensor=wsTempSensor, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPPartNumber=wsSFPPartNumber, wsPFDP=wsPFDP, wsTempTOS=wsTempTOS, wsAccounting=wsAccounting, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourModel=wsNeighbourModel, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTemp=wsXFPTemp, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPVolt=wsSFPVolt, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyIfIndex=wsPolicyIfIndex, wsTempTable=wsTempTable, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPCopperLen=wsXFPCopperLen, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsVersionString=wsVersionString, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex)
