...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPVolt=wsSFPVolt, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPTable=wsXFPTable, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTable=wsSFPTable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourModel=wsNeighbourModel, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPSerialNumber=wsSFPSerialNumber, wsVoltMeasured=wsVoltMeasured, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTemp=wsSFPTemp, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsTempThresholdLow=wsTempThresholdLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsTempSensor=wsTempSensor, wsTempTOS=wsTempTOS, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsAccounting=wsAccounting, wsSystem=wsSystem, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVersionString=wsVersionString, wsFanRPM=wsFanRPM, wsNeighbourPortState=wsNeighbourPortState, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighboursTable=wsNeighboursTable, wsFanEntry=wsFanEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPTransceiver=wsXFPTransceiver, wsPolicyInPkts=wsPolicyInPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPStatus=wsXFPStatus, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPTXPower=wsXFPTXPower, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourDBCount=wsNeighbourDBCount, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsWritedummy=wsWritedummy, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsTempEntry=wsTempEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, ibos=ibos, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsFanTable=wsFanTable, wsIbosTempLow=wsIbosTempLow, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltStatus=wsVoltStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsFanNumber=wsFanNumber, wsPFDP=wsPFDP, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsEnvironment=wsEnvironment, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsPolicyName=wsPolicyName, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsVoltEntry=wsVoltEntry, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPBitrate=wsSFPBitrate, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyCookie=wsPolicyCookie, wsPolicyInBytes=wsPolicyInBytes, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPEncoding=wsSFPEncoding, wsNeighbourUptime=wsNeighbourUptime, wsSFPSingleModeLen=wsSFPSingleModeLen, wsReload=wsReload, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPBitrateMax=wsXFPBitrateMax, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsTempTable=wsTempTable, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsIbosTempHigh=wsIbosTempHigh, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourState=wsNeighbourState, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsVoltNominal=wsVoltNominal, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyIfName=wsPolicyIfName, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXdBmPower=wsSFPTXdBmPower, wsPolicyEntry=wsPolicyEntry, wsPolicyTable=wsPolicyTable, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPRXPower=wsSFPRXPower, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsXFPRXPower=wsXFPRXPower, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPConnector=wsSFPConnector, wsXFPEntry=wsXFPEntry, wsTempStatus=wsTempStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsAsrRevision=wsAsrRevision, wsSFPTempStatus=wsSFPTempStatus, wsVoltTable=wsVoltTable, wsSFPEntry=wsSFPEntry, wsXFPSingleModeLen=wsXFPSingleModeLen, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTemp=wsXFPTemp, wsXFPCopperLen=wsXFPCopperLen, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourCreated=wsNeighbourCreated, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVoltChannel=wsVoltChannel, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsTempTHYST=wsTempTHYST, wsSFPStatus=wsSFPStatus, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPCopperLen=wsSFPCopperLen, wsSFPIndex=wsSFPIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsTempMeasured=wsTempMeasured, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsVersion=wsVersion, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsFanVoltage=wsFanVoltage, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts)
