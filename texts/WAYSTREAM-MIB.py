...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPolicyInPkts=wsPolicyInPkts, wsTempThresholdHigh=wsTempThresholdHigh, wsTempTHYST=wsTempTHYST, wsSFPStatus=wsSFPStatus, wsXFPTemp=wsXFPTemp, wsSFPEncoding=wsSFPEncoding, wsWritedummy=wsWritedummy, wsXFPEntry=wsXFPEntry, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPFDP=wsPFDP, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPIndex=wsXFPIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsFanRPM=wsFanRPM, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPCopperLen=wsSFPCopperLen, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourHostname=wsNeighbourHostname, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsTempStatus=wsTempStatus, wsXFPRXPower=wsXFPRXPower, wsIbosVoltHigh=wsIbosVoltHigh, wsPolicyName=wsPolicyName, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempTOS=wsTempTOS, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosTempLow=wsIbosTempLow, wsTempTable=wsTempTable, wsAsrRevision=wsAsrRevision, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPTempStatus=wsXFPTempStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPTXPower=wsXFPTXPower, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsTempThresholdLow=wsTempThresholdLow, wsXFPTable=wsXFPTable, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTable=wsSFPTable, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighboursEntry=wsNeighboursEntry, wsTempSensor=wsTempSensor, wsFanTable=wsFanTable, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsEnvironment=wsEnvironment, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyInBytes=wsPolicyInBytes, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPPartNumber=wsSFPPartNumber, wsPolicyTable=wsPolicyTable, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourCreated=wsNeighbourCreated, wsFanEntry=wsFanEntry, wsSFPTXPower=wsSFPTXPower, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPBitrate=wsSFPBitrate, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTemp=wsSFPTemp, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPEncoding=wsXFPEncoding, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourState=wsNeighbourState, wsFanVoltage=wsFanVoltage, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPSerialNumber=wsSFPSerialNumber, wsVoltTable=wsVoltTable, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVersionString=wsVersionString, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourModel=wsNeighbourModel, wsSFPRXPower=wsSFPRXPower, wsSFPIndex=wsSFPIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyEntry=wsPolicyEntry, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, ibos=ibos, wsXFPConnector=wsXFPConnector, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsVersion=wsVersion, wsTempMeasured=wsTempMeasured, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsTempEntry=wsTempEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsReload=wsReload, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVoltMeasured=wsVoltMeasured, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPConnector=wsSFPConnector, wsSFPEntry=wsSFPEntry, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsVoltEntry=wsVoltEntry, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, PYSNMP_MODULE_ID=ibos, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsFanNumber=wsFanNumber, wsVoltStatus=wsVoltStatus, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsVoltNominal=wsVoltNominal, wsNeighboursTable=wsNeighboursTable, wsSystem=wsSystem, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourDBCount=wsNeighbourDBCount, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortName=wsNeighbourPortName, wsSFPVolt=wsSFPVolt, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourUptime=wsNeighbourUptime, wsAccounting=wsAccounting, wsPolicyIfName=wsPolicyIfName, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourLastAct=wsNeighbourLastAct)
