...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPCopperLen=wsSFPCopperLen, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPPartNumber=wsSFPPartNumber, wsXFPEntry=wsXFPEntry, wsSFPTempStatus=wsSFPTempStatus, wsSFPTable=wsSFPTable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsTempStatus=wsTempStatus, wsVoltNominal=wsVoltNominal, wsXFPCopperLen=wsXFPCopperLen, wsWritedummy=wsWritedummy, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXPower=wsSFPRXPower, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsReload=wsReload, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPIndex=wsXFPIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsVersionString=wsVersionString, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPTemp=wsXFPTemp, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, ibos=ibos, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsVoltTable=wsVoltTable, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighboursTable=wsNeighboursTable, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPEncoding=wsXFPEncoding, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVoltStatus=wsSFPVoltStatus, wsIbosTempHigh=wsIbosTempHigh, wsXFPConnector=wsXFPConnector, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPEncoding=wsSFPEncoding, wsSFPEntry=wsSFPEntry, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsIbosTempLow=wsIbosTempLow, wsTempTHYST=wsTempTHYST, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTransceiver=wsSFPTransceiver, wsVoltMeasured=wsVoltMeasured, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsTempSensor=wsTempSensor, wsSFPVolt=wsSFPVolt, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPBitrate=wsSFPBitrate, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsFanNumber=wsFanNumber, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsFanRPM=wsFanRPM, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourState=wsNeighbourState, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPRXdBmPower=wsSFPRXdBmPower, wsFanEntry=wsFanEntry, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPConnector=wsSFPConnector, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyEntry=wsPolicyEntry, wsXFPStatus=wsXFPStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourUptime=wsNeighbourUptime, PYSNMP_MODULE_ID=ibos, wsEnvironment=wsEnvironment, wsTempEntry=wsTempEntry, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPIndex=wsSFPIndex, wsSFPStatus=wsSFPStatus, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPolicyName=wsPolicyName, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVersion=wsVersion, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortName=wsNeighbourPortName, wsFanVoltage=wsFanVoltage, wsSystem=wsSystem, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTemp=wsSFPTemp, wsXFPTable=wsXFPTable, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPRXPower=wsXFPRXPower, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyUsedCnt=wsPolicyUsedCnt, wsAccounting=wsAccounting, wsVoltEntry=wsVoltEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyInPkts=wsPolicyInPkts, wsPFDP=wsPFDP, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPTempStatus=wsXFPTempStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsTempTOS=wsTempTOS, wsVoltChannel=wsVoltChannel, wsXFPTXPower=wsXFPTXPower, wsVoltStatus=wsVoltStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPTransceiver=wsXFPTransceiver, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyInDrops=wsPolicyInDrops, wsTempTable=wsTempTable, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempMeasured=wsTempMeasured, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPSerialNumber=wsSFPSerialNumber, wsTempThresholdLow=wsTempThresholdLow, wsFanTable=wsFanTable, wsNeighbourModel=wsNeighbourModel, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPBitrateMin=wsXFPBitrateMin)
