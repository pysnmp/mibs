...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPolicyInDrops=wsPolicyInDrops, wsVoltEntry=wsVoltEntry, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPEntry=wsXFPEntry, wsSFPBitrate=wsSFPBitrate, wsFanEntry=wsFanEntry, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPStatus=wsXFPStatus, wsXFPTXCurrent=wsXFPTXCurrent, wsVoltNominal=wsVoltNominal, wsFanNumber=wsFanNumber, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPStatus=wsSFPStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsEnvironment=wsEnvironment, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsPFDP=wsPFDP, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyCookie=wsPolicyCookie, wsXFPTXPower=wsXFPTXPower, wsSFPTable=wsSFPTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVersion=wsVersion, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVersionString=wsVersionString, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsWritedummy=wsWritedummy, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsTempTable=wsTempTable, wsPolicyInBytes=wsPolicyInBytes, wsFanVoltage=wsFanVoltage, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourCreated=wsNeighbourCreated, wsVoltTable=wsVoltTable, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPIndex=wsXFPIndex, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsPolicyInPkts=wsPolicyInPkts, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortName=wsNeighbourPortName, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyTable=wsPolicyTable, wsXFPTemp=wsXFPTemp, wsNeighboursTable=wsNeighboursTable, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPTable=wsXFPTable, wsTempStatus=wsTempStatus, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortState=wsNeighbourPortState, wsSFPTransceiver=wsSFPTransceiver, wsXFPTransceiver=wsXFPTransceiver, wsTempThresholdLow=wsTempThresholdLow, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsTempTOS=wsTempTOS, wsSFPTemp=wsSFPTemp, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyName=wsPolicyName, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXPower=wsSFPRXPower, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsTempSensor=wsTempSensor, wsTempEntry=wsTempEntry, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsFanTable=wsFanTable, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourModel=wsNeighbourModel, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourState=wsNeighbourState, wsSFPTXCurrent=wsSFPTXCurrent, wsVoltStatus=wsVoltStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsAsrRevision=wsAsrRevision, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPConnector=wsXFPConnector, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsVoltChannel=wsVoltChannel, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPConnector=wsSFPConnector, wsSystem=wsSystem, wsXFPRXPower=wsXFPRXPower, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsAccounting=wsAccounting, wsIbosFanRPMLow=wsIbosFanRPMLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXPower=wsSFPTXPower, wsTempMeasured=wsTempMeasured, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPEntry=wsSFPEntry, ibos=ibos, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyIfName=wsPolicyIfName, wsFanRPM=wsFanRPM, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPSerialNumber=wsSFPSerialNumber, wsVoltMeasured=wsVoltMeasured, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPEncoding=wsSFPEncoding, wsPolicyUsedCnt=wsPolicyUsedCnt, PYSNMP_MODULE_ID=ibos, wsReload=wsReload, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyEntry=wsPolicyEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPIndex=wsSFPIndex, wsNeighbourUptime=wsNeighbourUptime, wsSFPVolt=wsSFPVolt)
