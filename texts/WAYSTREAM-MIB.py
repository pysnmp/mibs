...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPTXCurrent=wsXFPTXCurrent, wsVoltStatus=wsVoltStatus, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsAccounting=wsAccounting, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPFDP=wsPFDP, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVoltThresholdHigh=wsVoltThresholdHigh, wsFanRPM=wsFanRPM, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsFanEntry=wsFanEntry, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTemp=wsSFPTemp, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsWritedummy=wsWritedummy, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourUptime=wsNeighbourUptime, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourModel=wsNeighbourModel, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPVolt=wsSFPVolt, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourState=wsNeighbourState, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSystem=wsSystem, ibos=ibos, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPolicyIfName=wsPolicyIfName, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsVersionString=wsVersionString, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPTable=wsXFPTable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsReload=wsReload, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTempNormalLow=wsSFPTempNormalLow, wsVoltTable=wsVoltTable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyInPkts=wsPolicyInPkts, wsFanNumber=wsFanNumber, wsSFPEntry=wsSFPEntry, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsVoltMeasured=wsVoltMeasured, wsSFPRXPower=wsSFPRXPower, wsXFPEncoding=wsXFPEncoding, wsTempTOS=wsTempTOS, wsPolicyTable=wsPolicyTable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortState=wsNeighbourPortState, wsPolicyCookie=wsPolicyCookie, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPTempStatus=wsXFPTempStatus, wsSFPTempWarningLow=wsSFPTempWarningLow, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTransceiver=wsSFPTransceiver, wsNeighboursTable=wsNeighboursTable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPEncoding=wsSFPEncoding, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyName=wsPolicyName, wsXFPIndex=wsXFPIndex, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyInDrops=wsPolicyInDrops, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPConnector=wsSFPConnector, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortName=wsNeighbourPortName, wsAsrRevision=wsAsrRevision, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPRXPower=wsXFPRXPower, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTable=wsSFPTable, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPConnector=wsXFPConnector, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPCopperLen=wsSFPCopperLen, wsTempMeasured=wsTempMeasured, wsSFPTXdBmPower=wsSFPTXdBmPower, wsIbosVoltLow=wsIbosVoltLow, wsEnvironment=wsEnvironment, wsPolicyInBytes=wsPolicyInBytes, wsXFPCopperLen=wsXFPCopperLen, wsFanTable=wsFanTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPBitrate=wsSFPBitrate, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsTempTable=wsTempTable, wsXFPEntry=wsXFPEntry, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsTempSensor=wsTempSensor, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsFanVoltage=wsFanVoltage, wsPolicyEntry=wsPolicyEntry, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsTempStatus=wsTempStatus, wsVoltChannel=wsVoltChannel, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsTempTHYST=wsTempTHYST, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempEntry=wsTempEntry, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPIndex=wsSFPIndex, wsSFPPartNumber=wsSFPPartNumber, wsTempThresholdLow=wsTempThresholdLow, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsVoltEntry=wsVoltEntry, wsVersion=wsVersion, wsVoltNominal=wsVoltNominal, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPStatus=wsSFPStatus, wsXFPTemp=wsXFPTemp, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPStatus=wsXFPStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW)
