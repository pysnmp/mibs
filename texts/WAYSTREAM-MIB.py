...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPVolt=wsSFPVolt, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempMeasured=wsTempMeasured, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPIndex=wsSFPIndex, wsSFPEntry=wsSFPEntry, wsReload=wsReload, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsFanTable=wsFanTable, wsNeighbourPortState=wsNeighbourPortState, wsVoltChannel=wsVoltChannel, wsNeighbourLastAct=wsNeighbourLastAct, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsFanRPM=wsFanRPM, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortName=wsNeighbourPortName, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVersion=wsVersion, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourCreated=wsNeighbourCreated, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPPartNumber=wsSFPPartNumber, wsSFPVoltStatus=wsSFPVoltStatus, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPTXPower=wsXFPTXPower, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsVoltMeasured=wsVoltMeasured, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXPower=wsSFPTXPower, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPConnector=wsXFPConnector, wsSFPTemp=wsSFPTemp, wsSystem=wsSystem, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPRXPower=wsXFPRXPower, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyInPkts=wsPolicyInPkts, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsFanEntry=wsFanEntry, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsTempStatus=wsTempStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsTempTOS=wsTempTOS, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVoltNominal=wsVoltNominal, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVersionString=wsVersionString, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPTable=wsXFPTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsPolicyTable=wsPolicyTable, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyInBytes=wsPolicyInBytes, wsIbosTempLow=wsIbosTempLow, wsAsrRevision=wsAsrRevision, wsTempSensor=wsTempSensor, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsTempTHYST=wsTempTHYST, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPBitrate=wsSFPBitrate, wsNeighbourOSVersion=wsNeighbourOSVersion, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTransceiver=wsSFPTransceiver, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourUptime=wsNeighbourUptime, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPStatus=wsXFPStatus, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortsTable=wsNeighbourPortsTable, ibos=ibos, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyIfName=wsPolicyIfName, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsFanNumber=wsFanNumber, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltTable=wsVoltTable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPConnector=wsSFPConnector, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPIndex=wsXFPIndex, wsNeighbourHostname=wsNeighbourHostname, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPBitrateMin=wsXFPBitrateMin, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighboursTable=wsNeighboursTable, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXPower=wsSFPRXPower, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsTempEntry=wsTempEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsVoltEntry=wsVoltEntry, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPStatus=wsSFPStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyName=wsPolicyName, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsIbosVoltLow=wsIbosVoltLow, wsXFPEntry=wsXFPEntry, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, PYSNMP_MODULE_ID=ibos, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPCopperLen=wsSFPCopperLen, wsPFDP=wsPFDP, wsNeighboursEntry=wsNeighboursEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempThresholdHigh=wsTempThresholdHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourState=wsNeighbourState, wsSFPTable=wsSFPTable, wsXFPTemp=wsXFPTemp, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsTempTable=wsTempTable, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTransceiver=wsXFPTransceiver, wsAccounting=wsAccounting, wsPolicyCookie=wsPolicyCookie, wsPolicyOutBytes=wsPolicyOutBytes, wsWritedummy=wsWritedummy, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsEnvironment=wsEnvironment, wsSFPRXPowerStatus=wsSFPRXPowerStatus)
