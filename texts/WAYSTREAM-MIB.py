...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPStatus=wsXFPStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTransceiver=wsSFPTransceiver, wsPolicyName=wsPolicyName, wsSFPStatus=wsSFPStatus, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPIndex=wsSFPIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPFDP=wsPFDP, wsAccounting=wsAccounting, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPIndex=wsXFPIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsVersionString=wsVersionString, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPVolt=wsSFPVolt, wsVoltTable=wsVoltTable, wsPolicyOutBytes=wsPolicyOutBytes, wsFanRPM=wsFanRPM, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPTXPower=wsXFPTXPower, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVersion=wsVersion, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsIbosTempHigh=wsIbosTempHigh, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyInBytes=wsPolicyInBytes, wsTempThresholdLow=wsTempThresholdLow, wsXFPTempStatus=wsXFPTempStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsReload=wsReload, wsTempEntry=wsTempEntry, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXPower=wsSFPTXPower, wsAsrRevision=wsAsrRevision, wsFanEntry=wsFanEntry, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourLastAct=wsNeighbourLastAct, wsVoltThresholdHigh=wsVoltThresholdHigh, PYSNMP_MODULE_ID=ibos, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPTable=wsXFPTable, wsTempSensor=wsTempSensor, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTable=wsSFPTable, wsFanVoltage=wsFanVoltage, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsFanTable=wsFanTable, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsVoltChannel=wsVoltChannel, wsNeighbourModel=wsNeighbourModel, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyIfName=wsPolicyIfName, wsSystem=wsSystem, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTemp=wsSFPTemp, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPSerialNumber=wsSFPSerialNumber, wsWritedummy=wsWritedummy, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighboursTable=wsNeighboursTable, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPRXPower=wsXFPRXPower, wsVoltEntry=wsVoltEntry, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPConnector=wsSFPConnector, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyInDrops=wsPolicyInDrops, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsIbosVoltLow=wsIbosVoltLow, wsTempTable=wsTempTable, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPEncoding=wsXFPEncoding, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortName=wsNeighbourPortName, wsSFPTempStatus=wsSFPTempStatus, wsEnvironment=wsEnvironment, ibos=ibos, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPEntry=wsXFPEntry, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsIbosTempLow=wsIbosTempLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPConnector=wsXFPConnector, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPCopperLen=wsSFPCopperLen, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyInPkts=wsPolicyInPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyEntry=wsPolicyEntry, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsTempTOS=wsTempTOS, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsTempStatus=wsTempStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPBitrate=wsSFPBitrate, wsVoltStatus=wsVoltStatus, wsNeighbourCreated=wsNeighbourCreated, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyTable=wsPolicyTable, wsTempTHYST=wsTempTHYST, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPBitrateMin=wsXFPBitrateMin, wsFanNumber=wsFanNumber, wsSFPEntry=wsSFPEntry, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts)
