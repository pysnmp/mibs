...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPolicyInPkts=wsPolicyInPkts, wsSFPTransceiver=wsSFPTransceiver, wsPolicyOutBytes=wsPolicyOutBytes, wsIbosVoltLow=wsIbosVoltLow, wsPolicyInDrops=wsPolicyInDrops, wsVersion=wsVersion, wsWritedummy=wsWritedummy, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortState=wsNeighbourPortState, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsTempSensor=wsTempSensor, wsSFPConnector=wsSFPConnector, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPIndex=wsSFPIndex, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, ibos=ibos, wsXFPRXPower=wsXFPRXPower, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTable=wsSFPTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyInBytes=wsPolicyInBytes, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourState=wsNeighbourState, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPEntry=wsXFPEntry, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsEnvironment=wsEnvironment, wsVoltMeasured=wsVoltMeasured, wsFanRPM=wsFanRPM, PYSNMP_MODULE_ID=ibos, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPTempStatus=wsXFPTempStatus, wsAsrRevision=wsAsrRevision, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsVoltNominal=wsVoltNominal, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPTemp=wsXFPTemp, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyOutPkts=wsPolicyOutPkts, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVolt=wsSFPVolt, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourUptime=wsNeighbourUptime, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPConnector=wsXFPConnector, wsNeighbourHostname=wsNeighbourHostname, wsXFPTXPower=wsXFPTXPower, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsVoltChannel=wsVoltChannel, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsTempEntry=wsTempEntry, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsFanTable=wsFanTable, wsNeighbourCreated=wsNeighbourCreated, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPStatus=wsXFPStatus, wsSFPTXPower=wsSFPTXPower, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsFanNumber=wsFanNumber, wsReload=wsReload, wsSystem=wsSystem, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPolicyOutDrops=wsPolicyOutDrops, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPEntry=wsSFPEntry, wsTempStatus=wsTempStatus, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsTempMeasured=wsTempMeasured, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyIfName=wsPolicyIfName, wsXFPIndex=wsXFPIndex, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsFanVoltage=wsFanVoltage, wsXFPTable=wsXFPTable, wsTempThresholdHigh=wsTempThresholdHigh, wsTempThresholdLow=wsTempThresholdLow, wsTempTable=wsTempTable, wsTempTOS=wsTempTOS, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighboursTable=wsNeighboursTable, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTemp=wsSFPTemp, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPolicyName=wsPolicyName, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsAccounting=wsAccounting, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortsTable=wsNeighbourPortsTable, wsFanEntry=wsFanEntry, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsVersionString=wsVersionString, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsTempTHYST=wsTempTHYST, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTempStatus=wsSFPTempStatus, wsPolicyTable=wsPolicyTable, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPStatus=wsSFPStatus, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVoltEntry=wsVoltEntry, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsIbosTempLow=wsIbosTempLow, wsXFPCopperLen=wsXFPCopperLen, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTempNormalLow=wsSFPTempNormalLow, wsVoltTable=wsVoltTable, wsSFPCopperLen=wsSFPCopperLen, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPFDP=wsPFDP, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPBitrate=wsSFPBitrate)
