...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPVoltStatus=wsSFPVoltStatus, wsEnvironment=wsEnvironment, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSystem=wsSystem, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTransceiver=wsSFPTransceiver, wsTempTHYST=wsTempTHYST, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPTable=wsXFPTable, wsXFPRXPower=wsXFPRXPower, wsVoltNominal=wsVoltNominal, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPPartNumber=wsSFPPartNumber, wsSFPCopperLen=wsSFPCopperLen, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyEntry=wsPolicyEntry, wsXFPEntry=wsXFPEntry, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVoltChannel=wsVoltChannel, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsVersion=wsVersion, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyIfName=wsPolicyIfName, wsFanNumber=wsFanNumber, wsVoltEntry=wsVoltEntry, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsIbosTempHigh=wsIbosTempHigh, wsTempTable=wsTempTable, wsPolicyName=wsPolicyName, wsSFPSingleModeLen=wsSFPSingleModeLen, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPTemp=wsXFPTemp, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPTransceiver=wsXFPTransceiver, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPTXPower=wsXFPTXPower, wsTempThresholdLow=wsTempThresholdLow, wsPolicyOutBytes=wsPolicyOutBytes, wsVoltStatus=wsVoltStatus, wsPFDP=wsPFDP, wsTempStatus=wsTempStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPCopperLen=wsXFPCopperLen, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsTempEntry=wsTempEntry, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXPower=wsSFPRXPower, wsSFPTable=wsSFPTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsTempMeasured=wsTempMeasured, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsVoltTable=wsVoltTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyTable=wsPolicyTable, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXdBmPower=wsSFPTXdBmPower, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPStatus=wsXFPStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPVolt=wsSFPVolt, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourUptime=wsNeighbourUptime, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPEntry=wsSFPEntry, wsNeighboursTable=wsNeighboursTable, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXPower=wsSFPTXPower, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVersionString=wsVersionString, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsVoltMeasured=wsVoltMeasured, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, ibos=ibos, wsXFPEncoding=wsXFPEncoding, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsFanTable=wsFanTable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPConnector=wsXFPConnector, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighboursEntry=wsNeighboursEntry, wsWritedummy=wsWritedummy, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourState=wsNeighbourState, wsSFPBitrate=wsSFPBitrate, wsSFPTemp=wsSFPTemp, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPConnector=wsSFPConnector, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsReload=wsReload, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourCreated=wsNeighbourCreated, wsFanRPM=wsFanRPM, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPIndex=wsXFPIndex, wsPolicyInDrops=wsPolicyInDrops, wsTempTOS=wsTempTOS, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyCookie=wsPolicyCookie, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsAccounting=wsAccounting, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsFanVoltage=wsFanVoltage, wsSFPIndex=wsSFPIndex, wsSFPStatus=wsSFPStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPMultiMode50Len=wsSFPMultiMode50Len, PYSNMP_MODULE_ID=ibos, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsFanEntry=wsFanEntry, wsTempSensor=wsTempSensor, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourOSVersion=wsNeighbourOSVersion)
