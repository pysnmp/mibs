...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsFanRPM=wsFanRPM, wsVoltMeasured=wsVoltMeasured, wsIbosTempHigh=wsIbosTempHigh, PYSNMP_MODULE_ID=ibos, wsSystem=wsSystem, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsTempStatus=wsTempStatus, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsVoltThresholdLow=wsVoltThresholdLow, wsEnvironment=wsEnvironment, wsSFPTemp=wsSFPTemp, wsWritedummy=wsWritedummy, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPTXCurrent=wsXFPTXCurrent, wsPolicyIfIndex=wsPolicyIfIndex, wsVersionString=wsVersionString, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPSingleModeLen=wsSFPSingleModeLen, wsPolicyInPkts=wsPolicyInPkts, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPConnector=wsXFPConnector, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPBitrate=wsSFPBitrate, wsNeighbourState=wsNeighbourState, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsVoltStatus=wsVoltStatus, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPVolt=wsSFPVolt, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXPower=wsSFPRXPower, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPStatus=wsXFPStatus, wsSFPPartNumber=wsSFPPartNumber, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPTransceiver=wsXFPTransceiver, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPolicyName=wsPolicyName, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPTempStatus=wsXFPTempStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPEntry=wsSFPEntry, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPStatus=wsSFPStatus, wsTempSensor=wsTempSensor, wsTempEntry=wsTempEntry, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourHostname=wsNeighbourHostname, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPIndex=wsSFPIndex, wsFanTable=wsFanTable, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsVoltTable=wsVoltTable, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPRXPower=wsXFPRXPower, wsPolicyEntry=wsPolicyEntry, wsXFPCopperLen=wsXFPCopperLen, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPTable=wsXFPTable, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPSingleModeLen=wsXFPSingleModeLen, wsTempTable=wsTempTable, wsSFPTempStatus=wsSFPTempStatus, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsReload=wsReload, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsTempTOS=wsTempTOS, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPTemp=wsXFPTemp, wsNeighbourPortName=wsNeighbourPortName, wsTempTHYST=wsTempTHYST, wsAsrRevision=wsAsrRevision, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPConnector=wsSFPConnector, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyOutPkts=wsPolicyOutPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsFanNumber=wsFanNumber, wsNeighboursTable=wsNeighboursTable, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXPower=wsSFPTXPower, wsPolicyInBytes=wsPolicyInBytes, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTable=wsSFPTable, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighboursEntry=wsNeighboursEntry, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsIbosTempLow=wsIbosTempLow, wsAccounting=wsAccounting, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsFanEntry=wsFanEntry, wsXFPEncoding=wsXFPEncoding, wsXFPTXPowerStatus=wsXFPTXPowerStatus, ibos=ibos, wsVoltChannel=wsVoltChannel, wsNeighbourPortState=wsNeighbourPortState, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsVoltNominal=wsVoltNominal, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsVersion=wsVersion, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsFanVoltage=wsFanVoltage, wsSFPEncoding=wsSFPEncoding, wsXFPEntry=wsXFPEntry, wsPolicyUsedCnt=wsPolicyUsedCnt, wsVoltEntry=wsVoltEntry, wsTempMeasured=wsTempMeasured, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPIndex=wsXFPIndex, wsPFDP=wsPFDP)
