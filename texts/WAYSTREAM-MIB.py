...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourState=wsNeighbourState, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPIndex=wsSFPIndex, wsPolicyTable=wsPolicyTable, wsXFPEncoding=wsXFPEncoding, wsSFPEntry=wsSFPEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsFanEntry=wsFanEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsVoltEntry=wsVoltEntry, wsSFPTempStatus=wsSFPTempStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPStatus=wsSFPStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsTempTHYST=wsTempTHYST, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsTempMeasured=wsTempMeasured, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXPower=wsSFPTXPower, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyInDrops=wsPolicyInDrops, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyCookie=wsPolicyCookie, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortName=wsNeighbourPortName, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsReload=wsReload, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourNIndex=wsNeighbourNIndex, wsSystem=wsSystem, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighboursTable=wsNeighboursTable, wsTempStatus=wsTempStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, ibos=ibos, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsFanNumber=wsFanNumber, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyInBytes=wsPolicyInBytes, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPTable=wsXFPTable, wsVersionString=wsVersionString, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourCreated=wsNeighbourCreated, wsXFPCopperLen=wsXFPCopperLen, wsAccounting=wsAccounting, wsAsrRevision=wsAsrRevision, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPEncoding=wsSFPEncoding, wsSFPTransceiver=wsSFPTransceiver, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPTemp=wsXFPTemp, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsTempTable=wsTempTable, wsVersion=wsVersion, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsFanTable=wsFanTable, wsTempSensor=wsTempSensor, wsSFPTempNormalLow=wsSFPTempNormalLow, wsTempEntry=wsTempEntry, wsIbosTempHigh=wsIbosTempHigh, wsVoltStatus=wsVoltStatus, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTemp=wsSFPTemp, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTable=wsSFPTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsTempTOS=wsTempTOS, wsVoltMeasured=wsVoltMeasured, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTXPower=wsXFPTXPower, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsFanRPM=wsFanRPM, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPEntry=wsXFPEntry, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsWritedummy=wsWritedummy, wsSFPCopperLen=wsSFPCopperLen, wsXFPIndex=wsXFPIndex, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourModel=wsNeighbourModel, wsPolicyName=wsPolicyName, wsPFDP=wsPFDP, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPPartNumber=wsSFPPartNumber, wsPolicyInPkts=wsPolicyInPkts, wsVoltTable=wsVoltTable, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsTempThresholdLow=wsTempThresholdLow, wsSFPConnector=wsSFPConnector, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourHostname=wsNeighbourHostname, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPConnector=wsXFPConnector, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTransceiverExt=wsSFPTransceiverExt, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPSerialNumber=wsSFPSerialNumber, wsVoltChannel=wsVoltChannel, wsVoltNominal=wsVoltNominal, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsIbosTempLow=wsIbosTempLow, wsPolicyIfName=wsPolicyIfName, wsXFPStatus=wsXFPStatus, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyEntry=wsPolicyEntry, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPVolt=wsSFPVolt, wsIbosVoltLow=wsIbosVoltLow, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyOutPkts=wsPolicyOutPkts, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsEnvironment=wsEnvironment, wsNeighboursEntry=wsNeighboursEntry)
