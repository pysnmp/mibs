...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPRXPower=wsSFPRXPower, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXdBmPower=wsSFPRXdBmPower, wsFanVoltage=wsFanVoltage, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPTempStatus=wsXFPTempStatus, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTempStatus=wsSFPTempStatus, wsAsrRevision=wsAsrRevision, wsSFPIndex=wsSFPIndex, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTransceiver=wsXFPTransceiver, wsXFPEntry=wsXFPEntry, wsSFPTransceiver=wsSFPTransceiver, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyEntry=wsPolicyEntry, wsVersion=wsVersion, wsSFPVolt=wsSFPVolt, wsNeighboursTable=wsNeighboursTable, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPFDP=wsPFDP, PYSNMP_MODULE_ID=ibos, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPCopperLen=wsXFPCopperLen, wsVoltNominal=wsVoltNominal, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXPower=wsSFPTXPower, wsVoltEntry=wsVoltEntry, wsFanEntry=wsFanEntry, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsTempTable=wsTempTable, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPConnector=wsSFPConnector, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTable=wsSFPTable, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsTempEntry=wsTempEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPStatus=wsSFPStatus, wsPolicyInBytes=wsPolicyInBytes, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsFanTable=wsFanTable, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPIndex=wsXFPIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsFanNumber=wsFanNumber, wsTempTHYST=wsTempTHYST, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsVoltStatus=wsVoltStatus, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPConnector=wsXFPConnector, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsIbosTempHigh=wsIbosTempHigh, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsEnvironment=wsEnvironment, wsPolicyTable=wsPolicyTable, wsTempTOS=wsTempTOS, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourCreated=wsNeighbourCreated, wsSFPEncoding=wsSFPEncoding, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourLocalIf=wsNeighbourLocalIf, ibos=ibos, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsTempMeasured=wsTempMeasured, wsTempThresholdHigh=wsTempThresholdHigh, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsVoltTable=wsVoltTable, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortState=wsNeighbourPortState, wsAccounting=wsAccounting, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsIbosFanRPMLow=wsIbosFanRPMLow, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPStatus=wsXFPStatus, wsNeighbourState=wsNeighbourState, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsTempStatus=wsTempStatus, wsFanRPM=wsFanRPM, wsPolicyInDrops=wsPolicyInDrops, wsXFPTable=wsXFPTable, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighboursEntry=wsNeighboursEntry, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsIbosVoltHigh=wsIbosVoltHigh, wsTempSensor=wsTempSensor, wsNeighbourIfIndex=wsNeighbourIfIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortName=wsNeighbourPortName, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTemp=wsXFPTemp, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPRXPower=wsXFPRXPower, wsSFPTemp=wsSFPTemp, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPEntry=wsSFPEntry, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPTXCurrent=wsXFPTXCurrent, wsReload=wsReload, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyName=wsPolicyName, wsIbosTempLow=wsIbosTempLow, wsVersionString=wsVersionString, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsVoltChannel=wsVoltChannel, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsWritedummy=wsWritedummy, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyOutPkts=wsPolicyOutPkts, wsTempThresholdLow=wsTempThresholdLow, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSystem=wsSystem, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA)
