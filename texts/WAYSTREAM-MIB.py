...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourLocalIf=wsNeighbourLocalIf, PYSNMP_MODULE_ID=ibos, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsTempStatus=wsTempStatus, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsReload=wsReload, wsTempTable=wsTempTable, wsFanNumber=wsFanNumber, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyEntry=wsPolicyEntry, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsAccounting=wsAccounting, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsTempMeasured=wsTempMeasured, wsNeighbourUptime=wsNeighbourUptime, wsVoltStatus=wsVoltStatus, wsFanTable=wsFanTable, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyIfIndex=wsPolicyIfIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourCreated=wsNeighbourCreated, wsPolicyIfName=wsPolicyIfName, wsNeighboursTable=wsNeighboursTable, wsPolicyCookie=wsPolicyCookie, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempTOS=wsTempTOS, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPRXPower=wsSFPRXPower, wsPolicyInDrops=wsPolicyInDrops, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourHostname=wsNeighbourHostname, wsSFPTable=wsSFPTable, wsXFPTable=wsXFPTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPTempStatus=wsXFPTempStatus, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsTempEntry=wsTempEntry, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourState=wsNeighbourState, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsFanEntry=wsFanEntry, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTemp=wsSFPTemp, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPEntry=wsXFPEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsIbosTempLow=wsIbosTempLow, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPRXPower=wsXFPRXPower, wsSFPConnector=wsSFPConnector, wsNeighbourNIndex=wsNeighbourNIndex, wsFanRPM=wsFanRPM, ibos=ibos, wsVoltChannel=wsVoltChannel, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXPower=wsSFPTXPower, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortName=wsNeighbourPortName, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyInBytes=wsPolicyInBytes, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPFDP=wsPFDP, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPStatus=wsSFPStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPTXCurrent=wsXFPTXCurrent, wsWritedummy=wsWritedummy, wsSFPTransceiver=wsSFPTransceiver, wsPolicyOutDrops=wsPolicyOutDrops, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSystem=wsSystem, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsTempTHYST=wsTempTHYST, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsVoltNominal=wsVoltNominal, wsVersion=wsVersion, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsEnvironment=wsEnvironment, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsVoltTable=wsVoltTable, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsTempSensor=wsTempSensor, wsPolicyTable=wsPolicyTable, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPCopperLen=wsSFPCopperLen, wsXFPTemp=wsXFPTemp, wsIbosVoltLow=wsIbosVoltLow, wsXFPIndex=wsXFPIndex, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPEncoding=wsSFPEncoding, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTempStatus=wsSFPTempStatus, wsVoltMeasured=wsVoltMeasured, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPTXPower=wsXFPTXPower, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsIbosTempHigh=wsIbosTempHigh, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyName=wsPolicyName, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsVersionString=wsVersionString, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPTransceiver=wsXFPTransceiver, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPIndex=wsSFPIndex, wsAsrRevision=wsAsrRevision, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortState=wsNeighbourPortState, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh)
