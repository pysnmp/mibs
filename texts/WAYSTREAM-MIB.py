...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTransceiverExt=wsSFPTransceiverExt, wsFanNumber=wsFanNumber, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsFanVoltage=wsFanVoltage, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsTempTHYST=wsTempTHYST, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPRXPower=wsSFPRXPower, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsIbosVoltLow=wsIbosVoltLow, wsVoltStatus=wsVoltStatus, wsFanEntry=wsFanEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPVolt=wsSFPVolt, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPTemp=wsXFPTemp, wsFanRPM=wsFanRPM, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPIndex=wsXFPIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourState=wsNeighbourState, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsTempStatus=wsTempStatus, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXCurrent=wsSFPTXCurrent, wsWritedummy=wsWritedummy, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsReload=wsReload, wsNeighboursEntry=wsNeighboursEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPCopperLen=wsSFPCopperLen, wsXFPTable=wsXFPTable, wsSFPIndex=wsSFPIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsFanTable=wsFanTable, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPEncoding=wsSFPEncoding, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyOutDrops=wsPolicyOutDrops, wsPolicyEntry=wsPolicyEntry, wsTempEntry=wsTempEntry, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsTempTOS=wsTempTOS, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPRXPower=wsXFPRXPower, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPTXPower=wsXFPTXPower, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPPartNumber=wsSFPPartNumber, wsSFPTempWarningLow=wsSFPTempWarningLow, wsEnvironment=wsEnvironment, wsSFPTable=wsSFPTable, wsAsrRevision=wsAsrRevision, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltEntry=wsVoltEntry, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsTempThresholdHigh=wsTempThresholdHigh, ibos=ibos, wsNeighbourHostname=wsNeighbourHostname, wsIbosTempLow=wsIbosTempLow, wsTempMeasured=wsTempMeasured, wsTempSensor=wsTempSensor, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsVoltNominal=wsVoltNominal, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyIfIndex=wsPolicyIfIndex, wsTempTable=wsTempTable, wsPolicyInBytes=wsPolicyInBytes, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourModel=wsNeighbourModel, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPEntry=wsSFPEntry, wsTempThresholdLow=wsTempThresholdLow, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPConnector=wsXFPConnector, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyTable=wsPolicyTable, wsPolicyCookie=wsPolicyCookie, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXPower=wsSFPTXPower, wsSFPTempNormalLow=wsSFPTempNormalLow, wsPolicyIfName=wsPolicyIfName, wsSystem=wsSystem, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPBitrate=wsSFPBitrate, wsVoltTable=wsVoltTable, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyInPkts=wsPolicyInPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPConnector=wsSFPConnector, wsNeighbourPortState=wsNeighbourPortState, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsVoltChannel=wsVoltChannel, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPStatus=wsSFPStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighboursTable=wsNeighboursTable, wsSFPTemp=wsSFPTemp, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPStatus=wsXFPStatus, wsPFDP=wsPFDP, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsAccounting=wsAccounting, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyName=wsPolicyName, wsVoltMeasured=wsVoltMeasured, wsVersionString=wsVersionString, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsXFPEntry=wsXFPEntry, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTransceiver=wsSFPTransceiver, wsXFPTransceiver=wsXFPTransceiver, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVersion=wsVersion, wsNeighbourPortName=wsNeighbourPortName, wsIbosTempHigh=wsIbosTempHigh)
