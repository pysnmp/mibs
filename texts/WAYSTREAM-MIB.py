...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsPolicyInDrops=wsPolicyInDrops, wsSFPRXPower=wsSFPRXPower, wsXFPBitrateMin=wsXFPBitrateMin, wsIbosTempHigh=wsIbosTempHigh, wsReload=wsReload, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsTempTHYST=wsTempTHYST, wsTempEntry=wsTempEntry, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPTransceiver=wsXFPTransceiver, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, ibos=ibos, wsVersion=wsVersion, wsSFPBitrate=wsSFPBitrate, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPEntry=wsSFPEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsAccounting=wsAccounting, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXdBmPower=wsSFPTXdBmPower, wsWritedummy=wsWritedummy, wsFanRPM=wsFanRPM, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, PYSNMP_MODULE_ID=ibos, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourModel=wsNeighbourModel, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPEncoding=wsSFPEncoding, wsXFPEntry=wsXFPEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosTempLow=wsIbosTempLow, wsFanTable=wsFanTable, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsVoltMeasured=wsVoltMeasured, wsFanEntry=wsFanEntry, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsAsrRevision=wsAsrRevision, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempStatus=wsTempStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPConnector=wsSFPConnector, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTemp=wsSFPTemp, wsPolicyInPkts=wsPolicyInPkts, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortState=wsNeighbourPortState, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPTable=wsXFPTable, wsSFPVolt=wsSFPVolt, wsNeighboursTable=wsNeighboursTable, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsVoltThresholdHigh=wsVoltThresholdHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPEncoding=wsXFPEncoding, wsNeighbourOSVersion=wsNeighbourOSVersion, wsPolicyIfName=wsPolicyIfName, wsVersionString=wsVersionString, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPConnector=wsXFPConnector, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPolicyTable=wsPolicyTable, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPFDP=wsPFDP, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPBitrateMax=wsXFPBitrateMax, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTable=wsSFPTable, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsPolicyEntry=wsPolicyEntry, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSystem=wsSystem, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsTempThresholdLow=wsTempThresholdLow, wsTempMeasured=wsTempMeasured, wsPolicyCookie=wsPolicyCookie, wsXFPIndex=wsXFPIndex, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighboursEntry=wsNeighboursEntry, wsSFPTransceiver=wsSFPTransceiver, wsVoltTable=wsVoltTable, wsVoltChannel=wsVoltChannel, wsNeighbourPortName=wsNeighbourPortName, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPStatus=wsSFPStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempTable=wsTempTable, wsXFPTempStatus=wsXFPTempStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsEnvironment=wsEnvironment, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsTempSensor=wsTempSensor, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPStatus=wsXFPStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsFanVoltage=wsFanVoltage, wsPolicyName=wsPolicyName, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsFanNumber=wsFanNumber, wsNeighbourCreated=wsNeighbourCreated, wsXFPRXPower=wsXFPRXPower, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsVoltNominal=wsVoltNominal, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPIndex=wsSFPIndex, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPTemp=wsXFPTemp, wsIbosVoltLow=wsIbosVoltLow, wsSFPCopperLen=wsSFPCopperLen, wsTempTOS=wsTempTOS)
