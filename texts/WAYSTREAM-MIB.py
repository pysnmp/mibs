...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourUptime=wsNeighbourUptime, wsXFPTable=wsXFPTable, wsFanVoltage=wsFanVoltage, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsReload=wsReload, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, ibos=ibos, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsPolicyTable=wsPolicyTable, wsSFPStatus=wsSFPStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsTempMeasured=wsTempMeasured, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPIndex=wsSFPIndex, wsTempTHYST=wsTempTHYST, wsNeighbourState=wsNeighbourState, wsEnvironment=wsEnvironment, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsVoltEntry=wsVoltEntry, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXPower=wsSFPRXPower, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsTempEntry=wsTempEntry, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourLastAct=wsNeighbourLastAct, wsVoltStatus=wsVoltStatus, wsNeighbourHostname=wsNeighbourHostname, wsXFPTemp=wsXFPTemp, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortsTable=wsNeighbourPortsTable, wsTempTable=wsTempTable, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighboursEntry=wsNeighboursEntry, wsSFPEncoding=wsSFPEncoding, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTempStatus=wsSFPTempStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyName=wsPolicyName, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTable=wsSFPTable, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXPower=wsSFPTXPower, wsVoltMeasured=wsVoltMeasured, wsSFPTemp=wsSFPTemp, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsTempThresholdLow=wsTempThresholdLow, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPConnector=wsXFPConnector, wsNeighbourCreated=wsNeighbourCreated, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyInDrops=wsPolicyInDrops, wsTempSensor=wsTempSensor, wsVoltChannel=wsVoltChannel, wsVersion=wsVersion, wsPFDP=wsPFDP, wsSFPVolt=wsSFPVolt, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPCopperLen=wsXFPCopperLen, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPTransceiver=wsXFPTransceiver, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighboursTable=wsNeighboursTable, wsFanNumber=wsFanNumber, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPBitrate=wsSFPBitrate, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPEntry=wsXFPEntry, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsIbosTempLow=wsIbosTempLow, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, PYSNMP_MODULE_ID=ibos, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPSingleModeLen=wsSFPSingleModeLen, wsFanRPM=wsFanRPM, wsAsrRevision=wsAsrRevision, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyIfName=wsPolicyIfName, wsPolicyInPkts=wsPolicyInPkts, wsVersionString=wsVersionString, wsVoltTable=wsVoltTable, wsSystem=wsSystem, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPEncoding=wsXFPEncoding, wsPolicyCookie=wsPolicyCookie, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPCopperLen=wsSFPCopperLen, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPEntry=wsSFPEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsFanTable=wsFanTable, wsTempStatus=wsTempStatus, wsFanEntry=wsFanEntry, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsAccounting=wsAccounting, wsSFPConnector=wsSFPConnector, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyInBytes=wsPolicyInBytes, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPTXPower=wsXFPTXPower, wsTempTOS=wsTempTOS, wsXFPSingleModeLen=wsXFPSingleModeLen, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPRXPower=wsXFPRXPower, wsPolicyEntry=wsPolicyEntry, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPPartNumber=wsSFPPartNumber, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPIndex=wsXFPIndex, wsWritedummy=wsWritedummy)
