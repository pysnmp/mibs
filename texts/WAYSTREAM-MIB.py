...
ModuleIdentity, IpAddress, MibIdentifier, Gauge32, iso, ObjectIdentity, NotificationType, Unsigned32, Integer32, Counter64, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "MibIdentifier", "Gauge32", "iso", "ObjectIdentity", "NotificationType", "Unsigned32", "Integer32", "Counter64", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPolicyInDrops=wsPolicyInDrops, wsSFPStatus=wsSFPStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPConnector=wsXFPConnector, wsTempStatus=wsTempStatus, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsFanEntry=wsFanEntry, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsVoltEntry=wsVoltEntry, wsXFPEntry=wsXFPEntry, wsNeighbourPortName=wsNeighbourPortName, wsXFPEncoding=wsXFPEncoding, wsIbosTempLow=wsIbosTempLow, wsSFPTempNormalLow=wsSFPTempNormalLow, wsReload=wsReload, wsNeighbourIfIndex=wsNeighbourIfIndex, wsFanNumber=wsFanNumber, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTemp=wsSFPTemp, wsAsrRevision=wsAsrRevision, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyInBytes=wsPolicyInBytes, wsIbosVoltHigh=wsIbosVoltHigh, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPCopperLen=wsSFPCopperLen, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsTempTOS=wsTempTOS, wsNeighbourCreated=wsNeighbourCreated, PYSNMP_MODULE_ID=ibos, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourUptime=wsNeighbourUptime, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsTempTHYST=wsTempTHYST, wsPolicyIfIndex=wsPolicyIfIndex, wsTempMeasured=wsTempMeasured, wsVoltTable=wsVoltTable, wsIbosVoltLow=wsIbosVoltLow, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourState=wsNeighbourState, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVoltStatus=wsVoltStatus, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempSensor=wsTempSensor, wsPolicyTable=wsPolicyTable, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPStatus=wsXFPStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPRXPower=wsXFPRXPower, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPPartNumber=wsSFPPartNumber, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPFDP=wsPFDP, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyCookie=wsPolicyCookie, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsTempTable=wsTempTable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPTempStatus=wsXFPTempStatus, wsVoltMeasured=wsVoltMeasured, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyUsedCnt=wsPolicyUsedCnt, wsEnvironment=wsEnvironment, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPBitrate=wsSFPBitrate, wsVersion=wsVersion, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, ibos=ibos, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsFanRPM=wsFanRPM, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyEntry=wsPolicyEntry, wsFanTable=wsFanTable, wsSFPTransceiver=wsSFPTransceiver, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyName=wsPolicyName, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSystem=wsSystem, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortState=wsNeighbourPortState, wsPolicyInPkts=wsPolicyInPkts, wsVersionString=wsVersionString, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsVoltThresholdLow=wsVoltThresholdLow, wsWritedummy=wsWritedummy, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVoltChannel=wsVoltChannel, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsVoltNominal=wsVoltNominal, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsAccounting=wsAccounting, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPVolt=wsSFPVolt, wsXFPTemp=wsXFPTemp, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighboursEntry=wsNeighboursEntry, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTXCurrent=wsXFPTXCurrent, wsTempEntry=wsTempEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTable=wsSFPTable, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsIbosTempHigh=wsIbosTempHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsFanVoltage=wsFanVoltage, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPIndex=wsSFPIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPTXPower=wsXFPTXPower, wsXFPIndex=wsXFPIndex, wsSFPConnector=wsSFPConnector, wsXFPCopperLen=wsXFPCopperLen, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourHostname=wsNeighbourHostname, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPTable=wsXFPTable, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPMultiMode50Len=wsXFPMultiMode50Len)
