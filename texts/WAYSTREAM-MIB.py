...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsTempStatus=wsTempStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPTable=wsXFPTable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourHostname=wsNeighbourHostname, wsNeighboursTable=wsNeighboursTable, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsReload=wsReload, wsFanRPM=wsFanRPM, wsSFPTXPower=wsSFPTXPower, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPBitrateMax=wsXFPBitrateMax, wsVoltNominal=wsVoltNominal, wsSFPCopperLen=wsSFPCopperLen, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyIfName=wsPolicyIfName, wsXFPTemp=wsXFPTemp, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsWritedummy=wsWritedummy, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPEncoding=wsSFPEncoding, ibos=ibos, wsFanVoltage=wsFanVoltage, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPStatus=wsSFPStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsTempTable=wsTempTable, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsFanTable=wsFanTable, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsVoltTable=wsVoltTable, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourModel=wsNeighbourModel, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPolicyName=wsPolicyName, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPRXPower=wsSFPRXPower, wsVoltMeasured=wsVoltMeasured, wsFanNumber=wsFanNumber, wsEnvironment=wsEnvironment, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSystem=wsSystem, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsTempThresholdLow=wsTempThresholdLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPEntry=wsSFPEntry, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempEntry=wsTempEntry, wsXFPIndex=wsXFPIndex, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPFDP=wsPFDP, wsNeighboursEntry=wsNeighboursEntry, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsIbosTempLow=wsIbosTempLow, wsSFPIndex=wsSFPIndex, wsVoltEntry=wsVoltEntry, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVersion=wsVersion, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPEntry=wsXFPEntry, wsFanEntry=wsFanEntry, PYSNMP_MODULE_ID=ibos, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsTempTOS=wsTempTOS, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVoltStatus=wsVoltStatus, wsSFPVolt=wsSFPVolt, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsIbosVoltLow=wsIbosVoltLow, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTemp=wsSFPTemp, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyInBytes=wsPolicyInBytes, wsXFPConnector=wsXFPConnector, wsVoltChannel=wsVoltChannel, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourState=wsNeighbourState, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPConnector=wsSFPConnector, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourLocalIf=wsNeighbourLocalIf, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsAsrRevision=wsAsrRevision, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPEncoding=wsXFPEncoding, wsTempSensor=wsTempSensor, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyTable=wsPolicyTable, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPSingleModeLen=wsXFPSingleModeLen, wsTempTHYST=wsTempTHYST, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsAccounting=wsAccounting, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPBitrate=wsSFPBitrate, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTable=wsSFPTable, wsTempMeasured=wsTempMeasured, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPTXPower=wsXFPTXPower, wsSFPTempStatus=wsSFPTempStatus, wsSFPTransceiver=wsSFPTransceiver, wsVersionString=wsVersionString, wsXFPTempStatus=wsXFPTempStatus, wsPolicyInDrops=wsPolicyInDrops, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts)
