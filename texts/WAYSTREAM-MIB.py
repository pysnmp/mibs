...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTable=wsSFPTable, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsTempEntry=wsTempEntry, wsXFPStatus=wsXFPStatus, wsFanEntry=wsFanEntry, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourModel=wsNeighbourModel, wsVoltMeasured=wsVoltMeasured, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsFanNumber=wsFanNumber, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsEnvironment=wsEnvironment, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighboursTable=wsNeighboursTable, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPTempStatus=wsXFPTempStatus, wsSFPConnector=wsSFPConnector, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsAsrRevision=wsAsrRevision, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsTempTable=wsTempTable, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyTable=wsPolicyTable, wsIbosTempHigh=wsIbosTempHigh, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsReload=wsReload, wsVoltTable=wsVoltTable, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsVersionString=wsVersionString, wsXFPTemp=wsXFPTemp, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsTempSensor=wsTempSensor, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortState=wsNeighbourPortState, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyCookie=wsPolicyCookie, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPEncoding=wsXFPEncoding, wsSFPBitrate=wsSFPBitrate, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPEntry=wsSFPEntry, wsSFPIndex=wsSFPIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsTempTOS=wsTempTOS, wsVoltStatus=wsVoltStatus, wsXFPTXPower=wsXFPTXPower, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPStatus=wsSFPStatus, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTempNormalLow=wsSFPTempNormalLow, wsFanRPM=wsFanRPM, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighboursEntry=wsNeighboursEntry, wsTempStatus=wsTempStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourHostname=wsNeighbourHostname, wsXFPConnector=wsXFPConnector, wsTempThresholdHigh=wsTempThresholdHigh, wsIbosTempLow=wsIbosTempLow, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsAccounting=wsAccounting, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsVersion=wsVersion, wsPolicyName=wsPolicyName, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPRXPower=wsSFPRXPower, wsFanTable=wsFanTable, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyEntry=wsPolicyEntry, wsXFPTable=wsXFPTable, wsVoltEntry=wsVoltEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPIndex=wsXFPIndex, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPEntry=wsXFPEntry, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsFanVoltage=wsFanVoltage, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempMeasured=wsTempMeasured, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyInBytes=wsPolicyInBytes, wsVoltNominal=wsVoltNominal, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTempStatus=wsSFPTempStatus, wsSFPCopperLen=wsSFPCopperLen, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSystem=wsSystem, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsVoltThresholdLow=wsVoltThresholdLow, wsWritedummy=wsWritedummy, wsVoltChannel=wsVoltChannel, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPCopperLen=wsXFPCopperLen, ibos=ibos, PYSNMP_MODULE_ID=ibos, wsPFDP=wsPFDP, wsTempTHYST=wsTempTHYST, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPBitrateMax=wsXFPBitrateMax, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit)
