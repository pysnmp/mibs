...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPFDP=wsPFDP, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPTXPower=wsXFPTXPower, wsTempStatus=wsTempStatus, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsFanRPM=wsFanRPM, wsSFPTable=wsSFPTable, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, PYSNMP_MODULE_ID=ibos, wsNeighboursEntry=wsNeighboursEntry, wsWritedummy=wsWritedummy, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsFanTable=wsFanTable, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsFanEntry=wsFanEntry, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsAsrRevision=wsAsrRevision, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPTemp=wsXFPTemp, wsVoltTable=wsVoltTable, wsNeighbourState=wsNeighbourState, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsIbosVoltLow=wsIbosVoltLow, wsPolicyIfName=wsPolicyIfName, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSystem=wsSystem, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortState=wsNeighbourPortState, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPVolt=wsSFPVolt, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPStatus=wsSFPStatus, wsSFPCopperLen=wsSFPCopperLen, wsPolicyEntry=wsPolicyEntry, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPEntry=wsXFPEntry, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPEncoding=wsXFPEncoding, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyTable=wsPolicyTable, wsNeighboursTable=wsNeighboursTable, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsVoltChannel=wsVoltChannel, wsVoltStatus=wsVoltStatus, wsVersionString=wsVersionString, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXPower=wsSFPRXPower, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourHostname=wsNeighbourHostname, wsPolicyInPkts=wsPolicyInPkts, wsIbosFanRPMLow=wsIbosFanRPMLow, wsTempTHYST=wsTempTHYST, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXPower=wsSFPTXPower, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyInBytes=wsPolicyInBytes, wsTempSensor=wsTempSensor, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsVoltNominal=wsVoltNominal, wsNeighbourIfIndex=wsNeighbourIfIndex, wsTempTOS=wsTempTOS, ibos=ibos, wsAccounting=wsAccounting, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTransceiver=wsSFPTransceiver, wsSFPVoltStatus=wsSFPVoltStatus, wsFanNumber=wsFanNumber, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsTempTable=wsTempTable, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPEncoding=wsSFPEncoding, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPIndex=wsXFPIndex, wsTempMeasured=wsTempMeasured, wsXFPConnector=wsXFPConnector, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPIndex=wsSFPIndex, wsVoltEntry=wsVoltEntry, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourCreated=wsNeighbourCreated, wsXFPBitrateMin=wsXFPBitrateMin, wsVersion=wsVersion, wsXFPTransceiver=wsXFPTransceiver, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourNIndex=wsNeighbourNIndex, wsIbosTempHigh=wsIbosTempHigh, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyName=wsPolicyName, wsSFPEntry=wsSFPEntry, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTable=wsXFPTable, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourUptime=wsNeighbourUptime, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsEnvironment=wsEnvironment, wsXFPTempStatus=wsXFPTempStatus, wsReload=wsReload, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsTempEntry=wsTempEntry, wsSFPConnector=wsSFPConnector, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsVoltMeasured=wsVoltMeasured, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsFanVoltage=wsFanVoltage)
