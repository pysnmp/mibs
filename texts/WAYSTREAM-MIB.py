...
ObjectIdentity, Gauge32, iso, Bits, IpAddress, MibIdentifier, NotificationType, Counter32, ModuleIdentity, Counter64, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "iso", "Bits", "IpAddress", "MibIdentifier", "NotificationType", "Counter32", "ModuleIdentity", "Counter64", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsFanRPM=wsFanRPM, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPEntry=wsSFPEntry, ibos=ibos, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsFanTable=wsFanTable, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourUptime=wsNeighbourUptime, wsPolicyTable=wsPolicyTable, wsSFPCopperLen=wsSFPCopperLen, wsEnvironment=wsEnvironment, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyName=wsPolicyName, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPTXPower=wsXFPTXPower, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTempStatus=wsXFPTempStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortName=wsNeighbourPortName, wsVersion=wsVersion, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTempStatus=wsSFPTempStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPPartNumber=wsSFPPartNumber, wsVersionString=wsVersionString, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPEntry=wsXFPEntry, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsAsrRevision=wsAsrRevision, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPStatus=wsSFPStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPIndex=wsXFPIndex, wsNeighbourState=wsNeighbourState, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPFDP=wsPFDP, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsTempStatus=wsTempStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsFanNumber=wsFanNumber, wsTempSensor=wsTempSensor, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourCreated=wsNeighbourCreated, wsVoltEntry=wsVoltEntry, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPolicyIfName=wsPolicyIfName, wsXFPStatus=wsXFPStatus, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsWritedummy=wsWritedummy, wsTempTHYST=wsTempTHYST, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourHostname=wsNeighbourHostname, wsTempEntry=wsTempEntry, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsPolicyInDrops=wsPolicyInDrops, PYSNMP_MODULE_ID=ibos, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempTOS=wsTempTOS, wsSystem=wsSystem, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPConnector=wsSFPConnector, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsIbosTempLow=wsIbosTempLow, wsXFPTemp=wsXFPTemp, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPBitrate=wsSFPBitrate, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPBitrateMin=wsXFPBitrateMin, wsVoltTable=wsVoltTable, wsReload=wsReload, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXPower=wsSFPTXPower, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsIbosVoltLow=wsIbosVoltLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTable=wsSFPTable, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPVolt=wsSFPVolt, wsTempTable=wsTempTable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPEncoding=wsXFPEncoding, wsSFPTemp=wsSFPTemp, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPConnector=wsXFPConnector, wsVoltMeasured=wsVoltMeasured, wsTempMeasured=wsTempMeasured, wsXFPTable=wsXFPTable, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsVoltNominal=wsVoltNominal, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsVoltChannel=wsVoltChannel, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsAccounting=wsAccounting, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsPolicyOutPkts=wsPolicyOutPkts, wsFanVoltage=wsFanVoltage, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsFanEntry=wsFanEntry, wsVoltStatus=wsVoltStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPIndex=wsSFPIndex, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyEntry=wsPolicyEntry, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyInBytes=wsPolicyInBytes, wsSFPEncoding=wsSFPEncoding, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighboursTable=wsNeighboursTable, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW)
