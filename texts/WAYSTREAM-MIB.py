...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsFanNumber=wsFanNumber, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVoltNominal=wsVoltNominal, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyInDrops=wsPolicyInDrops, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsTempMeasured=wsTempMeasured, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsFanEntry=wsFanEntry, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPolicyCookie=wsPolicyCookie, wsXFPTXPower=wsXFPTXPower, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourUptime=wsNeighbourUptime, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTempStatus=wsSFPTempStatus, PYSNMP_MODULE_ID=ibos, wsNeighboursEntry=wsNeighboursEntry, wsReload=wsReload, wsPolicyTable=wsPolicyTable, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPRXPower=wsXFPRXPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPFDP=wsPFDP, wsSFPTemp=wsSFPTemp, wsNeighbourState=wsNeighbourState, wsNeighboursTable=wsNeighboursTable, wsXFPConnector=wsXFPConnector, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourModel=wsNeighbourModel, wsXFPTable=wsXFPTable, wsSFPVolt=wsSFPVolt, wsXFPTemp=wsXFPTemp, wsTempSensor=wsTempSensor, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXPower=wsSFPTXPower, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsVersion=wsVersion, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVersionString=wsVersionString, wsVoltMeasured=wsVoltMeasured, ibos=ibos, wsAccounting=wsAccounting, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyName=wsPolicyName, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempTable=wsTempTable, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsFanTable=wsFanTable, wsSFPStatus=wsSFPStatus, wsXFPIndex=wsXFPIndex, wsNeighbourPortState=wsNeighbourPortState, wsFanVoltage=wsFanVoltage, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVoltStatus=wsVoltStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyInBytes=wsPolicyInBytes, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSystem=wsSystem, wsWritedummy=wsWritedummy, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsIbosTempLow=wsIbosTempLow, wsVoltTable=wsVoltTable, wsXFPEncoding=wsXFPEncoding, wsAsrRevision=wsAsrRevision, wsEnvironment=wsEnvironment, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPIndex=wsSFPIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsTempTHYST=wsTempTHYST, wsXFPTempStatus=wsXFPTempStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempStatus=wsTempStatus, wsVoltEntry=wsVoltEntry, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPStatus=wsXFPStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourHostname=wsNeighbourHostname, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPTransceiver=wsXFPTransceiver, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsTempEntry=wsTempEntry, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsIbosVoltLow=wsIbosVoltLow, wsFanRPM=wsFanRPM, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyEntry=wsPolicyEntry, wsPolicyIfName=wsPolicyIfName, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTable=wsSFPTable, wsTempTOS=wsTempTOS, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsVoltChannel=wsVoltChannel, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPEncoding=wsSFPEncoding, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPEntry=wsSFPEntry, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPConnector=wsSFPConnector, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXPower=wsSFPRXPower, wsXFPEntry=wsXFPEntry, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourNIndex=wsNeighbourNIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn)
