...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempThresholdLow=wsTempThresholdLow, wsVoltEntry=wsVoltEntry, wsPFDP=wsPFDP, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsWritedummy=wsWritedummy, wsVoltTable=wsVoltTable, wsXFPTXPower=wsXFPTXPower, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsTempMeasured=wsTempMeasured, wsSFPEntry=wsSFPEntry, wsSFPCopperLen=wsSFPCopperLen, wsPolicyName=wsPolicyName, wsPolicyUsedCnt=wsPolicyUsedCnt, wsIbosTempHigh=wsIbosTempHigh, wsSFPTable=wsSFPTable, wsTempEntry=wsTempEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPIndex=wsXFPIndex, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyInDrops=wsPolicyInDrops, wsXFPTemp=wsXFPTemp, wsSFPTempStatus=wsSFPTempStatus, wsFanRPM=wsFanRPM, wsReload=wsReload, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourOSVersion=wsNeighbourOSVersion, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyEntry=wsPolicyEntry, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsAccounting=wsAccounting, wsSFPIndex=wsSFPIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsTempTOS=wsTempTOS, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPConnector=wsXFPConnector, wsTempStatus=wsTempStatus, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsEnvironment=wsEnvironment, wsXFPTempStatus=wsXFPTempStatus, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPConnector=wsSFPConnector, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyInBytes=wsPolicyInBytes, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsTempSensor=wsTempSensor, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsVoltChannel=wsVoltChannel, wsAsrRevision=wsAsrRevision, wsFanVoltage=wsFanVoltage, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsTempTHYST=wsTempTHYST, wsSFPEncoding=wsSFPEncoding, wsVersion=wsVersion, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourNIndex=wsNeighbourNIndex, wsVersionString=wsVersionString, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourUptime=wsNeighbourUptime, wsFanEntry=wsFanEntry, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVoltMeasured=wsVoltMeasured, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTransceiver=wsXFPTransceiver, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXPower=wsSFPTXPower, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPPartNumber=wsSFPPartNumber, wsPolicyTable=wsPolicyTable, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPTable=wsXFPTable, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPEntry=wsXFPEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPCopperLen=wsXFPCopperLen, wsIbosTempLow=wsIbosTempLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsFanNumber=wsFanNumber, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourCreated=wsNeighbourCreated, wsVoltThresholdLow=wsVoltThresholdLow, wsTempTable=wsTempTable, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSystem=wsSystem, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPRXPower=wsXFPRXPower, wsVoltStatus=wsVoltStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPBitrate=wsSFPBitrate, wsXFPStatus=wsXFPStatus, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPVolt=wsSFPVolt, wsXFPEncoding=wsXFPEncoding, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, PYSNMP_MODULE_ID=ibos, wsNeighbourPortState=wsNeighbourPortState, ibos=ibos, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortName=wsNeighbourPortName, wsSFPTemp=wsSFPTemp, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsFanTable=wsFanTable, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPStatus=wsSFPStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPRXPower=wsSFPRXPower, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions)
