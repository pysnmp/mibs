...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsTempThresholdLow=wsTempThresholdLow, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXPower=wsSFPTXPower, wsAsrRevision=wsAsrRevision, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPEncoding=wsXFPEncoding, wsIbosTempLow=wsIbosTempLow, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsFanRPM=wsFanRPM, wsVoltTable=wsVoltTable, wsSFPVolt=wsSFPVolt, wsSFPPartNumber=wsSFPPartNumber, wsPolicyUsedCnt=wsPolicyUsedCnt, wsWritedummy=wsWritedummy, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempSensor=wsTempSensor, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsTempStatus=wsTempStatus, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourState=wsNeighbourState, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourModel=wsNeighbourModel, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourDBCount=wsNeighbourDBCount, wsSystem=wsSystem, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsPolicyTable=wsPolicyTable, wsSFPTable=wsSFPTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPIndex=wsSFPIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsTempTOS=wsTempTOS, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPBitrate=wsSFPBitrate, wsTempTHYST=wsTempTHYST, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPEntry=wsXFPEntry, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTable=wsXFPTable, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsAccounting=wsAccounting, ibos=ibos, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsVoltThresholdLow=wsVoltThresholdLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPStatus=wsSFPStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVoltEntry=wsVoltEntry, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsFanEntry=wsFanEntry, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourCreated=wsNeighbourCreated, wsSFPEntry=wsSFPEntry, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyInDrops=wsPolicyInDrops, wsTempTable=wsTempTable, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsTempEntry=wsTempEntry, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPTemp=wsXFPTemp, PYSNMP_MODULE_ID=ibos, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsIbosTempHigh=wsIbosTempHigh, wsPolicyInPkts=wsPolicyInPkts, wsVersionString=wsVersionString, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourUptime=wsNeighbourUptime, wsPolicyIfName=wsPolicyIfName, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsTempMeasured=wsTempMeasured, wsSFPConnector=wsSFPConnector, wsSFPEncoding=wsSFPEncoding, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighboursTable=wsNeighboursTable, wsXFPConnector=wsXFPConnector, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPTXCurrent=wsXFPTXCurrent, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPCopperLen=wsSFPCopperLen, wsVoltThresholdHigh=wsVoltThresholdHigh, wsEnvironment=wsEnvironment, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPFDP=wsPFDP, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPStatus=wsXFPStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPRXPower=wsXFPRXPower, wsVoltNominal=wsVoltNominal, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTemp=wsSFPTemp, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTempStatus=wsSFPTempStatus, wsSFPVoltStatus=wsSFPVoltStatus, wsVersion=wsVersion, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPIndex=wsXFPIndex, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsFanNumber=wsFanNumber, wsNeighbourNIndex=wsNeighbourNIndex, wsVoltStatus=wsVoltStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsReload=wsReload, wsNeighbourPortState=wsNeighbourPortState, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsFanTable=wsFanTable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyName=wsPolicyName, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTransceiver=wsSFPTransceiver, wsSFPRXPowerStatus=wsSFPRXPowerStatus)
