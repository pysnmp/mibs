...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsTempTOS=wsTempTOS, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyOutPkts=wsPolicyOutPkts, wsTempEntry=wsTempEntry, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTable=wsSFPTable, wsTempMeasured=wsTempMeasured, wsSFPRXPower=wsSFPRXPower, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourHostname=wsNeighbourHostname, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsFanRPM=wsFanRPM, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsVersion=wsVersion, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyTable=wsPolicyTable, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsReload=wsReload, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsVoltEntry=wsVoltEntry, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPEntry=wsXFPEntry, wsNeighbourUptime=wsNeighbourUptime, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVoltChannel=wsVoltChannel, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPIndex=wsSFPIndex, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsVoltStatus=wsVoltStatus, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyName=wsPolicyName, wsXFPRXPower=wsXFPRXPower, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSystem=wsSystem, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPTable=wsXFPTable, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTempStatus=wsSFPTempStatus, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsAccounting=wsAccounting, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPVolt=wsSFPVolt, wsNeighbourNIndex=wsNeighbourNIndex, wsTempThresholdLow=wsTempThresholdLow, wsIbosTempHigh=wsIbosTempHigh, wsXFPTXPower=wsXFPTXPower, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourLastAct=wsNeighbourLastAct, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPCopperLen=wsXFPCopperLen, ibos=ibos, wsXFPConnector=wsXFPConnector, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsAsrRevision=wsAsrRevision, wsXFPStatus=wsXFPStatus, wsSFPTemp=wsSFPTemp, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPIndex=wsXFPIndex, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPSingleModeLen=wsSFPSingleModeLen, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPSerialNumber=wsSFPSerialNumber, wsVoltTable=wsVoltTable, wsEnvironment=wsEnvironment, wsFanEntry=wsFanEntry, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPStatus=wsSFPStatus, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortState=wsNeighbourPortState, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPPartNumber=wsSFPPartNumber, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsTempStatus=wsTempStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourModel=wsNeighbourModel, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortName=wsNeighbourPortName, PYSNMP_MODULE_ID=ibos, wsFanNumber=wsFanNumber, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyInPkts=wsPolicyInPkts, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourState=wsNeighbourState, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsPolicyCookie=wsPolicyCookie, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsFanVoltage=wsFanVoltage, wsTempTable=wsTempTable, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyInBytes=wsPolicyInBytes, wsPolicyIfName=wsPolicyIfName, wsXFPTemp=wsXFPTemp, wsWritedummy=wsWritedummy, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyEntry=wsPolicyEntry, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsTempTHYST=wsTempTHYST, wsVersionString=wsVersionString, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsTempSensor=wsTempSensor, wsPolicyIfIndex=wsPolicyIfIndex, wsFanTable=wsFanTable, wsXFPTXCurrent=wsXFPTXCurrent, wsVoltNominal=wsVoltNominal, wsXFPTempStatus=wsXFPTempStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPEncoding=wsSFPEncoding, wsSFPConnector=wsSFPConnector, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPEntry=wsSFPEntry, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourCreated=wsNeighbourCreated, wsPFDP=wsPFDP, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts)
