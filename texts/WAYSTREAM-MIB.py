...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPBitrate=wsSFPBitrate, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTransceiver=wsSFPTransceiver, wsAsrRevision=wsAsrRevision, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPRXPower=wsXFPRXPower, wsTempSensor=wsTempSensor, wsSFPTXCurrent=wsSFPTXCurrent, wsFanVoltage=wsFanVoltage, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsVoltNominal=wsVoltNominal, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyInBytes=wsPolicyInBytes, wsXFPIndex=wsXFPIndex, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPCopperLen=wsSFPCopperLen, wsIbosTempLow=wsIbosTempLow, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPVolt=wsSFPVolt, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPConnector=wsSFPConnector, wsIbosTempHigh=wsIbosTempHigh, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPTemp=wsXFPTemp, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVersion=wsVersion, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPCopperLen=wsXFPCopperLen, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsFanNumber=wsFanNumber, wsTempThresholdHigh=wsTempThresholdHigh, wsVersionString=wsVersionString, wsEnvironment=wsEnvironment, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPolicyName=wsPolicyName, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsFanEntry=wsFanEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPConnector=wsXFPConnector, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPSerialNumber=wsSFPSerialNumber, wsVoltThresholdLow=wsVoltThresholdLow, wsTempStatus=wsTempStatus, wsTempTOS=wsTempTOS, wsVoltEntry=wsVoltEntry, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXPower=wsSFPRXPower, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPEncoding=wsSFPEncoding, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPTXPower=wsXFPTXPower, wsTempTHYST=wsTempTHYST, wsNeighbourCreated=wsNeighbourCreated, wsSFPIndex=wsSFPIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPTable=wsXFPTable, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourUptime=wsNeighbourUptime, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsAccounting=wsAccounting, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyEntry=wsPolicyEntry, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPSingleModeLen=wsSFPSingleModeLen, wsIbosVoltLow=wsIbosVoltLow, wsSFPStatus=wsSFPStatus, wsReload=wsReload, wsFanTable=wsFanTable, wsSFPTemp=wsSFPTemp, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyIfName=wsPolicyIfName, wsFanRPM=wsFanRPM, wsSFPTable=wsSFPTable, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVoltTable=wsVoltTable, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourModel=wsNeighbourModel, wsPolicyTable=wsPolicyTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPStatus=wsXFPStatus, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVoltChannel=wsVoltChannel, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPEntry=wsXFPEntry, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsPFDP=wsPFDP, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsTempMeasured=wsTempMeasured, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPEncoding=wsXFPEncoding, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPVoltStatus=wsSFPVoltStatus, wsTempThresholdLow=wsTempThresholdLow, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSystem=wsSystem, wsWritedummy=wsWritedummy, wsVoltMeasured=wsVoltMeasured, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPEntry=wsSFPEntry, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempTable=wsTempTable, wsNeighbourState=wsNeighbourState, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, PYSNMP_MODULE_ID=ibos, wsTempEntry=wsTempEntry, wsNeighbourPortName=wsNeighbourPortName, wsVoltStatus=wsVoltStatus, ibos=ibos, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPTempStatus=wsXFPTempStatus)
