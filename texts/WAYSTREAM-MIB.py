...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSystem=wsSystem, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTransceiver=wsSFPTransceiver, wsVoltStatus=wsVoltStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsAccounting=wsAccounting, wsFanTable=wsFanTable, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPTransceiver=wsXFPTransceiver, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPEncoding=wsXFPEncoding, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyName=wsPolicyName, wsPolicyInDrops=wsPolicyInDrops, wsSFPVoltStatus=wsSFPVoltStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPIndex=wsXFPIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyOutDrops=wsPolicyOutDrops, wsVoltTable=wsVoltTable, wsSFPIndex=wsSFPIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPVolt=wsSFPVolt, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourHostname=wsNeighbourHostname, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourLastAct=wsNeighbourLastAct, wsFanNumber=wsFanNumber, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPTXCurrent=wsXFPTXCurrent, wsVoltMeasured=wsVoltMeasured, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPEntry=wsSFPEntry, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyTable=wsPolicyTable, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPStatus=wsXFPStatus, wsVoltChannel=wsVoltChannel, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsVersion=wsVersion, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsTempEntry=wsTempEntry, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighboursEntry=wsNeighboursEntry, wsSFPEncoding=wsSFPEncoding, wsPolicyEntry=wsPolicyEntry, wsSFPConnector=wsSFPConnector, ibos=ibos, wsXFPTempStatus=wsXFPTempStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighboursTable=wsNeighboursTable, wsEnvironment=wsEnvironment, wsSFPTable=wsSFPTable, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsTempStatus=wsTempStatus, wsXFPRXPower=wsXFPRXPower, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXPower=wsSFPTXPower, wsFanEntry=wsFanEntry, wsSFPTemp=wsSFPTemp, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPEntry=wsXFPEntry, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsTempTHYST=wsTempTHYST, wsTempTable=wsTempTable, wsTempTOS=wsTempTOS, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTempWarningLow=wsSFPTempWarningLow, wsVersionString=wsVersionString, wsPFDP=wsPFDP, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsWritedummy=wsWritedummy, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPConnector=wsXFPConnector, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPStatus=wsSFPStatus, wsPolicyIfName=wsPolicyIfName, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPCopperLen=wsXFPCopperLen, wsIbosTempLow=wsIbosTempLow, wsTempThresholdLow=wsTempThresholdLow, wsPolicyInPkts=wsPolicyInPkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyInBytes=wsPolicyInBytes, wsXFPTemp=wsXFPTemp, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourModel=wsNeighbourModel, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempMeasured=wsTempMeasured, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsVoltNominal=wsVoltNominal, wsReload=wsReload, wsFanRPM=wsFanRPM, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPTable=wsXFPTable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPBitrateMin=wsXFPBitrateMin, wsVoltEntry=wsVoltEntry, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourUptime=wsNeighbourUptime, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPBitrate=wsSFPBitrate, wsAsrRevision=wsAsrRevision, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsTempSensor=wsTempSensor, wsSFPPartNumber=wsSFPPartNumber, wsPolicyCookie=wsPolicyCookie, wsVoltThresholdLow=wsVoltThresholdLow, wsFanVoltage=wsFanVoltage, wsIbosFanRPMLow=wsIbosFanRPMLow)
