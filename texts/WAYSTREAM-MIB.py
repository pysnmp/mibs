...
Counter32, NotificationType, MibIdentifier, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Bits, Gauge32, Integer32, Unsigned32, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "MibIdentifier", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Bits", "Gauge32", "Integer32", "Unsigned32", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPIndex=wsSFPIndex, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPTransceiver=wsXFPTransceiver, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsTempStatus=wsTempStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPStatus=wsXFPStatus, wsNeighbourHostname=wsNeighbourHostname, wsFanTable=wsFanTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyInPkts=wsPolicyInPkts, wsNeighboursTable=wsNeighboursTable, wsTempThresholdLow=wsTempThresholdLow, PYSNMP_MODULE_ID=ibos, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPCopperLen=wsXFPCopperLen, wsPolicyOutPkts=wsPolicyOutPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyIfName=wsPolicyIfName, wsXFPSingleModeLen=wsXFPSingleModeLen, wsWritedummy=wsWritedummy, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPTemp=wsXFPTemp, wsSFPVolt=wsSFPVolt, wsVersionString=wsVersionString, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPolicyName=wsPolicyName, wsTempSensor=wsTempSensor, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortName=wsNeighbourPortName, wsVersion=wsVersion, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsVoltTable=wsVoltTable, wsFanRPM=wsFanRPM, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsReload=wsReload, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsEnvironment=wsEnvironment, wsSFPTemp=wsSFPTemp, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTable=wsSFPTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTransceiverExt=wsSFPTransceiverExt, ibos=ibos, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsVoltEntry=wsVoltEntry, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortState=wsNeighbourPortState, wsPolicyEntry=wsPolicyEntry, wsSFPPartNumber=wsSFPPartNumber, wsFanNumber=wsFanNumber, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPStatus=wsSFPStatus, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPEntry=wsSFPEntry, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyTable=wsPolicyTable, wsXFPTable=wsXFPTable, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsTempTOS=wsTempTOS, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPRXPower=wsXFPRXPower, wsSFPCopperLen=wsSFPCopperLen, wsIbosTempLow=wsIbosTempLow, wsTempTable=wsTempTable, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPTempStatus=wsXFPTempStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourCreated=wsNeighbourCreated, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsTempEntry=wsTempEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsAccounting=wsAccounting, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSystem=wsSystem, wsNeighbourModel=wsNeighbourModel, wsSFPTempStatus=wsSFPTempStatus, wsXFPEntry=wsXFPEntry, wsXFPEncoding=wsXFPEncoding, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPFDP=wsPFDP, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourSNPA=wsNeighbourSNPA, wsVoltChannel=wsVoltChannel, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyInBytes=wsPolicyInBytes, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsFanVoltage=wsFanVoltage, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyIfIndex=wsPolicyIfIndex, wsVoltNominal=wsVoltNominal, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPBitrate=wsSFPBitrate, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsFanEntry=wsFanEntry, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPConnector=wsSFPConnector, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsAsrRevision=wsAsrRevision, wsTempMeasured=wsTempMeasured, wsIbosFanRPMLow=wsIbosFanRPMLow, wsTempTHYST=wsTempTHYST, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVoltStatus=wsVoltStatus, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm)
