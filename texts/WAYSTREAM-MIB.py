...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourModel=wsNeighbourModel, wsTempMeasured=wsTempMeasured, wsSFPStatus=wsSFPStatus, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsPolicyName=wsPolicyName, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPTransceiver=wsXFPTransceiver, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsReload=wsReload, wsPolicyInDrops=wsPolicyInDrops, wsFanTable=wsFanTable, wsSFPTempNormalLow=wsSFPTempNormalLow, wsIbosTempLow=wsIbosTempLow, wsPolicyEntry=wsPolicyEntry, wsFanRPM=wsFanRPM, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPTemp=wsXFPTemp, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPConnector=wsSFPConnector, wsPFDP=wsPFDP, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsPolicyInPkts=wsPolicyInPkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPStatus=wsXFPStatus, wsVoltStatus=wsVoltStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTable=wsSFPTable, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTXCurrent=wsXFPTXCurrent, wsIbosTempHigh=wsIbosTempHigh, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourNIndex=wsNeighbourNIndex, wsIbosVoltHigh=wsIbosVoltHigh, ibos=ibos, wsVersionString=wsVersionString, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyCookie=wsPolicyCookie, wsSFPRXdBmPower=wsSFPRXdBmPower, wsVoltChannel=wsVoltChannel, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPIndex=wsXFPIndex, wsSFPCopperLen=wsSFPCopperLen, wsSFPTempStatus=wsSFPTempStatus, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsVoltEntry=wsVoltEntry, wsFanNumber=wsFanNumber, wsXFPTXPower=wsXFPTXPower, wsTempSensor=wsTempSensor, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPSerialNumber=wsSFPSerialNumber, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPRXPower=wsSFPRXPower, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPCopperLen=wsXFPCopperLen, wsXFPEntry=wsXFPEntry, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPTable=wsXFPTable, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPSingleModeLen=wsXFPSingleModeLen, wsFanVoltage=wsFanVoltage, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTemp=wsSFPTemp, wsAsrRevision=wsAsrRevision, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsVoltTable=wsVoltTable, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsAccounting=wsAccounting, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPRXPower=wsXFPRXPower, wsNeighboursTable=wsNeighboursTable, wsEnvironment=wsEnvironment, wsTempStatus=wsTempStatus, wsVersion=wsVersion, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsTempEntry=wsTempEntry, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourCreated=wsNeighbourCreated, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, PYSNMP_MODULE_ID=ibos, wsNeighbourPortName=wsNeighbourPortName, wsPolicyInBytes=wsPolicyInBytes, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPVolt=wsSFPVolt, wsTempTOS=wsTempTOS, wsPolicyTable=wsPolicyTable, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSystem=wsSystem, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsWritedummy=wsWritedummy, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPPartNumber=wsSFPPartNumber, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsTempTable=wsTempTable, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPEncoding=wsSFPEncoding, wsSFPTransceiver=wsSFPTransceiver, wsTempTHYST=wsTempTHYST, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighboursEntry=wsNeighboursEntry, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPConnector=wsXFPConnector, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsFanEntry=wsFanEntry, wsSFPIndex=wsSFPIndex, wsVoltMeasured=wsVoltMeasured)
