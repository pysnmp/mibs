...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourCreated=wsNeighbourCreated, wsWritedummy=wsWritedummy, wsPolicyEntry=wsPolicyEntry, wsPolicyName=wsPolicyName, wsXFPIndex=wsXFPIndex, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTempStatus=wsSFPTempStatus, wsTempTHYST=wsTempTHYST, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTemp=wsSFPTemp, wsFanVoltage=wsFanVoltage, wsSFPIndex=wsSFPIndex, wsTempTOS=wsTempTOS, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPTemp=wsXFPTemp, wsReload=wsReload, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPolicyCookie=wsPolicyCookie, wsNeighbourNIndex=wsNeighbourNIndex, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyIfName=wsPolicyIfName, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPStatus=wsXFPStatus, wsXFPTXPower=wsXFPTXPower, wsPolicyInPkts=wsPolicyInPkts, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPStatus=wsSFPStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsFanRPM=wsFanRPM, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourUptime=wsNeighbourUptime, wsXFPTransceiver=wsXFPTransceiver, wsNeighboursEntry=wsNeighboursEntry, wsSFPVolt=wsSFPVolt, wsVoltChannel=wsVoltChannel, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsTempSensor=wsTempSensor, wsTempThresholdHigh=wsTempThresholdHigh, wsFanTable=wsFanTable, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosVoltHigh=wsIbosVoltHigh, wsVersionString=wsVersionString, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTempWarningLow=wsSFPTempWarningLow, wsFanEntry=wsFanEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsVoltTable=wsVoltTable, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPTempStatus=wsXFPTempStatus, wsSFPEncoding=wsSFPEncoding, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPTable=wsXFPTable, wsNeighboursTable=wsNeighboursTable, wsTempThresholdLow=wsTempThresholdLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsPolicyInDrops=wsPolicyInDrops, wsSystem=wsSystem, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPConnector=wsXFPConnector, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTable=wsSFPTable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsXFPBitrateMax=wsXFPBitrateMax, wsVersion=wsVersion, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPRXPower=wsSFPRXPower, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsAccounting=wsAccounting, wsNeighbourModel=wsNeighbourModel, wsSFPEntry=wsSFPEntry, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPFDP=wsPFDP, wsXFPRXPower=wsXFPRXPower, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortState=wsNeighbourPortState, wsIbosTempLow=wsIbosTempLow, wsFanNumber=wsFanNumber, ibos=ibos, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsTempTable=wsTempTable, wsXFPCopperLen=wsXFPCopperLen, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsTempMeasured=wsTempMeasured, wsVoltEntry=wsVoltEntry, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPBitrate=wsSFPBitrate, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsEnvironment=wsEnvironment, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsVoltMeasured=wsVoltMeasured, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortName=wsNeighbourPortName, wsSFPPartNumber=wsSFPPartNumber, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTransceiver=wsSFPTransceiver, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyOutDrops=wsPolicyOutDrops, wsVoltStatus=wsVoltStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempEntry=wsTempEntry, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPEntry=wsXFPEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsTempStatus=wsTempStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPConnector=wsSFPConnector, wsPolicyTable=wsPolicyTable, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourLocalIf=wsNeighbourLocalIf, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors)
