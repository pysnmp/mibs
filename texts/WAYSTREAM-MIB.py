...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsWritedummy=wsWritedummy, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTransceiver=wsSFPTransceiver, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTemp=wsXFPTemp, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempTHYST=wsTempTHYST, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourSNPA=wsNeighbourSNPA, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsIbosVoltHigh=wsIbosVoltHigh, wsFanTable=wsFanTable, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyOutDrops=wsPolicyOutDrops, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsTempStatus=wsTempStatus, wsNeighbourState=wsNeighbourState, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsTempSensor=wsTempSensor, wsSystem=wsSystem, wsPolicyInBytes=wsPolicyInBytes, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPRXPower=wsSFPRXPower, wsSFPStatus=wsSFPStatus, wsNeighbourUptime=wsNeighbourUptime, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourHostname=wsNeighbourHostname, wsVoltChannel=wsVoltChannel, wsFanEntry=wsFanEntry, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsFanVoltage=wsFanVoltage, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPCopperLen=wsXFPCopperLen, wsSFPVolt=wsSFPVolt, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsVoltMeasured=wsVoltMeasured, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPRXPower=wsXFPRXPower, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighboursEntry=wsNeighboursEntry, wsSFPBitrate=wsSFPBitrate, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPConnector=wsSFPConnector, wsSFPCopperLen=wsSFPCopperLen, wsXFPConnector=wsXFPConnector, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPEncoding=wsXFPEncoding, wsTempTable=wsTempTable, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsEnvironment=wsEnvironment, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsIbosTempHigh=wsIbosTempHigh, wsPFDP=wsPFDP, wsFanRPM=wsFanRPM, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltNominal=wsVoltNominal, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsPolicyCookie=wsPolicyCookie, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsTempTOS=wsTempTOS, wsVersionString=wsVersionString, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsFanNumber=wsFanNumber, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyTable=wsPolicyTable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsAccounting=wsAccounting, wsIbosTempLow=wsIbosTempLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourCreated=wsNeighbourCreated, wsSFPEncoding=wsSFPEncoding, wsXFPTable=wsXFPTable, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPTempStatus=wsXFPTempStatus, wsNeighboursTable=wsNeighboursTable, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsPolicyName=wsPolicyName, wsXFPStatus=wsXFPStatus, wsReload=wsReload, wsVersion=wsVersion, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsVoltThresholdLow=wsVoltThresholdLow, wsTempMeasured=wsTempMeasured, wsVoltTable=wsVoltTable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVoltStatus=wsVoltStatus, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourIfIndex=wsNeighbourIfIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsVoltEntry=wsVoltEntry, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyEntry=wsPolicyEntry, PYSNMP_MODULE_ID=ibos, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPTransceiver=wsXFPTransceiver, wsPolicyOutPkts=wsPolicyOutPkts, wsIbosVoltLow=wsIbosVoltLow, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsTempEntry=wsTempEntry, wsSFPIndex=wsSFPIndex, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTemp=wsSFPTemp, wsPolicyInPkts=wsPolicyInPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPEntry=wsXFPEntry, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, ibos=ibos, wsIbosFanRPMLow=wsIbosFanRPMLow, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTable=wsSFPTable, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsTempThresholdHigh=wsTempThresholdHigh)
