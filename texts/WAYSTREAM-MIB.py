...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsFanRPM=wsFanRPM, wsPolicyName=wsPolicyName, wsFanEntry=wsFanEntry, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsVoltNominal=wsVoltNominal, wsTempTHYST=wsTempTHYST, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsAccounting=wsAccounting, wsWritedummy=wsWritedummy, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPBitrateMin=wsXFPBitrateMin, wsTempStatus=wsTempStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsVoltChannel=wsVoltChannel, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsTempSensor=wsTempSensor, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPEntry=wsXFPEntry, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPEntry=wsSFPEntry, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortState=wsNeighbourPortState, wsXFPTable=wsXFPTable, wsSFPIndex=wsSFPIndex, wsAsrRevision=wsAsrRevision, wsXFPIndex=wsXFPIndex, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPStatus=wsSFPStatus, wsPolicyInDrops=wsPolicyInDrops, wsXFPTXPower=wsXFPTXPower, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsTempThresholdLow=wsTempThresholdLow, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPConnector=wsSFPConnector, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPConnector=wsXFPConnector, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsVersion=wsVersion, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPEncoding=wsSFPEncoding, wsNeighboursTable=wsNeighboursTable, wsNeighbourIfIndex=wsNeighbourIfIndex, ibos=ibos, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXdBmPower=wsSFPTXdBmPower, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, PYSNMP_MODULE_ID=ibos, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyInPkts=wsPolicyInPkts, wsXFPStatus=wsXFPStatus, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPEncoding=wsXFPEncoding, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyTable=wsPolicyTable, wsEnvironment=wsEnvironment, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPTempStatus=wsXFPTempStatus, wsXFPTXCurrent=wsXFPTXCurrent, wsSystem=wsSystem, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTemp=wsSFPTemp, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPBitrate=wsSFPBitrate, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsVoltMeasured=wsVoltMeasured, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosTempLow=wsIbosTempLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTemp=wsXFPTemp, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourSNPA=wsNeighbourSNPA, wsTempEntry=wsTempEntry, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTable=wsSFPTable, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourHostname=wsNeighbourHostname, wsVoltTable=wsVoltTable, wsFanVoltage=wsFanVoltage, wsSFPVoltStatus=wsSFPVoltStatus, wsFanNumber=wsFanNumber, wsSFPVolt=wsSFPVolt, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourState=wsNeighbourState, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsTempTable=wsTempTable, wsVersionString=wsVersionString, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVoltEntry=wsVoltEntry, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsReload=wsReload, wsNeighbourUptime=wsNeighbourUptime, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourDBCount=wsNeighbourDBCount, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighboursEntry=wsNeighboursEntry, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempStatus=wsSFPTempStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPRXPower=wsSFPRXPower, wsIbosVoltHigh=wsIbosVoltHigh, wsTempTOS=wsTempTOS, wsPFDP=wsPFDP, wsFanTable=wsFanTable, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW)
