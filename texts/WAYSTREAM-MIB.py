...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPTemp=wsXFPTemp, wsSFPBitrate=wsSFPBitrate, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPVolt=wsSFPVolt, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsTempThresholdHigh=wsTempThresholdHigh, wsTempThresholdLow=wsTempThresholdLow, wsVoltEntry=wsVoltEntry, wsNeighbourState=wsNeighbourState, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsVoltThresholdLow=wsVoltThresholdLow, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPTable=wsXFPTable, wsNeighboursTable=wsNeighboursTable, wsFanRPM=wsFanRPM, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTemp=wsSFPTemp, wsTempTHYST=wsTempTHYST, wsSFPRXPower=wsSFPRXPower, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPConnector=wsXFPConnector, wsVersionString=wsVersionString, wsXFPTempStatus=wsXFPTempStatus, wsPolicyTable=wsPolicyTable, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighboursEntry=wsNeighboursEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsEnvironment=wsEnvironment, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsAccounting=wsAccounting, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTable=wsSFPTable, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPConnector=wsSFPConnector, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVersion=wsVersion, wsTempTOS=wsTempTOS, wsSFPCopperLen=wsSFPCopperLen, wsFanTable=wsFanTable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsIbosTempLow=wsIbosTempLow, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPEntry=wsXFPEntry, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsVoltStatus=wsVoltStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyEntry=wsPolicyEntry, wsXFPEncoding=wsXFPEncoding, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPIndex=wsSFPIndex, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyName=wsPolicyName, wsXFPTransceiver=wsXFPTransceiver, wsXFPTXCurrent=wsXFPTXCurrent, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyCookie=wsPolicyCookie, wsXFPIndex=wsXFPIndex, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPEncoding=wsSFPEncoding, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyOutDrops=wsPolicyOutDrops, wsTempStatus=wsTempStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourHostname=wsNeighbourHostname, ibos=ibos, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsFanEntry=wsFanEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsFanVoltage=wsFanVoltage, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsFanNumber=wsFanNumber, wsSFPStatus=wsSFPStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsAsrRevision=wsAsrRevision, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyInBytes=wsPolicyInBytes, wsVoltNominal=wsVoltNominal, wsVoltTable=wsVoltTable, wsXFPStatus=wsXFPStatus, wsTempSensor=wsTempSensor, wsWritedummy=wsWritedummy, wsTempTable=wsTempTable, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsReload=wsReload, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourUptime=wsNeighbourUptime, wsXFPRXPower=wsXFPRXPower, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsTempMeasured=wsTempMeasured, wsSystem=wsSystem, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPEntry=wsSFPEntry, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsTempEntry=wsTempEntry, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsVoltChannel=wsVoltChannel, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, PYSNMP_MODULE_ID=ibos, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPFDP=wsPFDP, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyInDrops=wsPolicyInDrops, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXPower=wsSFPTXPower)
