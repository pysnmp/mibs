...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Counter32, ModuleIdentity, TimeTicks, IpAddress, Counter64, Unsigned32, Gauge32, iso, Bits, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Counter32", "ModuleIdentity", "TimeTicks", "IpAddress", "Counter64", "Unsigned32", "Gauge32", "iso", "Bits", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTemp=wsSFPTemp, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsTempStatus=wsTempStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVoltChannel=wsVoltChannel, wsSFPStatus=wsSFPStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXPower=wsSFPTXPower, wsXFPTable=wsXFPTable, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPTXPower=wsXFPTXPower, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPolicyInDrops=wsPolicyInDrops, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourHostname=wsNeighbourHostname, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsTempTOS=wsTempTOS, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSystem=wsSystem, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPConnector=wsSFPConnector, wsAsrRevision=wsAsrRevision, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempSensor=wsTempSensor, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsFanNumber=wsFanNumber, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourCreated=wsNeighbourCreated, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsFanVoltage=wsFanVoltage, wsXFPCopperLen=wsXFPCopperLen, wsSFPTransceiverExt=wsSFPTransceiverExt, wsTempThresholdLow=wsTempThresholdLow, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPIndex=wsXFPIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourModel=wsNeighbourModel, wsSFPVolt=wsSFPVolt, wsVersionString=wsVersionString, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsTempTable=wsTempTable, wsNeighboursTable=wsNeighboursTable, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsVoltEntry=wsVoltEntry, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsTempEntry=wsTempEntry, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyTable=wsPolicyTable, wsPolicyEntry=wsPolicyEntry, wsXFPTransceiver=wsXFPTransceiver, wsEnvironment=wsEnvironment, wsXFPRXPower=wsXFPRXPower, wsVoltThresholdLow=wsVoltThresholdLow, wsVoltNominal=wsVoltNominal, wsVersion=wsVersion, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVoltTable=wsVoltTable, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPConnector=wsXFPConnector, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortName=wsNeighbourPortName, wsXFPEntry=wsXFPEntry, ibos=ibos, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPRXPower=wsSFPRXPower, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPTemp=wsXFPTemp, wsReload=wsReload, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXdBmPower=wsSFPTXdBmPower, wsAccounting=wsAccounting, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPCopperLen=wsSFPCopperLen, wsIbosFanRPMLow=wsIbosFanRPMLow, wsTempMeasured=wsTempMeasured, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPIndex=wsSFPIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyName=wsPolicyName, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPPartNumber=wsSFPPartNumber, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsPolicyCookie=wsPolicyCookie, wsXFPStatus=wsXFPStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPBitrateMax=wsXFPBitrateMax, wsFanEntry=wsFanEntry, wsNeighbourPortState=wsNeighbourPortState, wsIbosTempLow=wsIbosTempLow, wsNeighbourSNPA=wsNeighbourSNPA, wsPolicyInPkts=wsPolicyInPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPEncoding=wsSFPEncoding, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsFanTable=wsFanTable, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsFanRPM=wsFanRPM, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsWritedummy=wsWritedummy, wsIbosTempHigh=wsIbosTempHigh, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTempNormalHigh=wsSFPTempNormalHigh, PYSNMP_MODULE_ID=ibos, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPBitrate=wsSFPBitrate, wsPolicyInBytes=wsPolicyInBytes, wsXFPTempStatus=wsXFPTempStatus, wsSFPTable=wsSFPTable, wsPFDP=wsPFDP, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm)
