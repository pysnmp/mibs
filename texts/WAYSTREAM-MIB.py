...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTable=wsSFPTable, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsEnvironment=wsEnvironment, wsTempTHYST=wsTempTHYST, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsReload=wsReload, wsSFPBitrate=wsSFPBitrate, wsIbosTempLow=wsIbosTempLow, wsXFPTXPower=wsXFPTXPower, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsWritedummy=wsWritedummy, wsSFPEncoding=wsSFPEncoding, wsIbosVoltHigh=wsIbosVoltHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsTempSensor=wsTempSensor, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSystem=wsSystem, wsTempStatus=wsTempStatus, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, ibos=ibos, wsFanNumber=wsFanNumber, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsTempTable=wsTempTable, wsAsrRevision=wsAsrRevision, wsPFDP=wsPFDP, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourNIndex=wsNeighbourNIndex, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVoltTable=wsVoltTable, wsPolicyOutPkts=wsPolicyOutPkts, wsVoltStatus=wsVoltStatus, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempMeasured=wsTempMeasured, wsSFPTemp=wsSFPTemp, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsVoltMeasured=wsVoltMeasured, wsSFPRXPower=wsSFPRXPower, wsXFPIndex=wsXFPIndex, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourUptime=wsNeighbourUptime, wsSFPIndex=wsSFPIndex, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTransceiver=wsSFPTransceiver, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPVolt=wsSFPVolt, wsNeighboursTable=wsNeighboursTable, wsSFPVoltStatus=wsSFPVoltStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourState=wsNeighbourState, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPEncoding=wsXFPEncoding, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsFanVoltage=wsFanVoltage, wsNeighbourModel=wsNeighbourModel, wsPolicyInBytes=wsPolicyInBytes, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyEntry=wsPolicyEntry, wsVoltThresholdLow=wsVoltThresholdLow, wsFanTable=wsFanTable, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyName=wsPolicyName, wsXFPTable=wsXFPTable, wsTempTOS=wsTempTOS, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsVersion=wsVersion, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPRXPower=wsXFPRXPower, wsPolicyInDrops=wsPolicyInDrops, wsVersionString=wsVersionString, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsFanEntry=wsFanEntry, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPPartNumber=wsSFPPartNumber, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsAccounting=wsAccounting, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPConnector=wsXFPConnector, wsPolicyIfName=wsPolicyIfName, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPConnector=wsSFPConnector, wsVoltChannel=wsVoltChannel, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPStatus=wsSFPStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempEntry=wsTempEntry, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourLocalIf=wsNeighbourLocalIf, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPEntry=wsXFPEntry, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyCookie=wsPolicyCookie, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsVoltNominal=wsVoltNominal, wsXFPTemp=wsXFPTemp, wsXFPStatus=wsXFPStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempStatus=wsSFPTempStatus, wsSFPEntry=wsSFPEntry, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsFanRPM=wsFanRPM, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsVoltEntry=wsVoltEntry)
