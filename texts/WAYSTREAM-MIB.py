...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsVoltEntry=wsVoltEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosTempHigh=wsIbosTempHigh, wsSFPCopperLen=wsSFPCopperLen, PYSNMP_MODULE_ID=ibos, wsPolicyOutDrops=wsPolicyOutDrops, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPIndex=wsSFPIndex, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPConnector=wsSFPConnector, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsReload=wsReload, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsTempSensor=wsTempSensor, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXdBmPower=wsSFPTXdBmPower, wsVersionString=wsVersionString, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPPartNumber=wsSFPPartNumber, wsPolicyOutPkts=wsPolicyOutPkts, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsAsrRevision=wsAsrRevision, wsSFPBitrate=wsSFPBitrate, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsXFPTXCurrent=wsXFPTXCurrent, wsPolicyTable=wsPolicyTable, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXPower=wsSFPTXPower, wsTempTOS=wsTempTOS, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortName=wsNeighbourPortName, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsPFDP=wsPFDP, wsVoltTable=wsVoltTable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVersion=wsVersion, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPEntry=wsXFPEntry, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsTempThresholdLow=wsTempThresholdLow, wsVoltMeasured=wsVoltMeasured, wsPolicyInDrops=wsPolicyInDrops, wsIbosTempLow=wsIbosTempLow, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsTempEntry=wsTempEntry, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourOSVersion=wsNeighbourOSVersion, wsFanTable=wsFanTable, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsTempStatus=wsTempStatus, wsAccounting=wsAccounting, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPEncoding=wsXFPEncoding, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPStatus=wsSFPStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPConnector=wsXFPConnector, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsFanRPM=wsFanRPM, wsVoltNominal=wsVoltNominal, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPIndex=wsXFPIndex, wsNeighbourModel=wsNeighbourModel, wsSFPTemp=wsSFPTemp, wsXFPTemp=wsXFPTemp, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsTempTable=wsTempTable, wsPolicyIfName=wsPolicyIfName, wsPolicyInBytes=wsPolicyInBytes, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSystem=wsSystem, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, ibos=ibos, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsFanEntry=wsFanEntry, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsTempMeasured=wsTempMeasured, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPTable=wsXFPTable, wsSFPRXPower=wsSFPRXPower, wsXFPBitrateMin=wsXFPBitrateMin, wsWritedummy=wsWritedummy, wsVoltChannel=wsVoltChannel, wsSFPTransceiver=wsSFPTransceiver, wsSFPVolt=wsSFPVolt, wsXFPStatus=wsXFPStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyName=wsPolicyName, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsPolicyEntry=wsPolicyEntry, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXCurrent=wsSFPTXCurrent, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTempStatus=wsSFPTempStatus, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPEntry=wsSFPEntry, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourLocalIf=wsNeighbourLocalIf, wsTempTHYST=wsTempTHYST, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortState=wsNeighbourPortState, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourDBCount=wsNeighbourDBCount, wsEnvironment=wsEnvironment, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPRXPower=wsXFPRXPower, wsFanNumber=wsFanNumber, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTable=wsSFPTable, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast)
