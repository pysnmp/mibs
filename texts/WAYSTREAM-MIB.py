...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, ibos=ibos, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyInPkts=wsPolicyInPkts, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPConnector=wsXFPConnector, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPStatus=wsXFPStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsFanEntry=wsFanEntry, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsTempStatus=wsTempStatus, wsSFPVoltStatus=wsSFPVoltStatus, wsAccounting=wsAccounting, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTempStatus=wsSFPTempStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsIbosTempHigh=wsIbosTempHigh, wsTempSensor=wsTempSensor, wsNeighbourState=wsNeighbourState, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPEntry=wsXFPEntry, wsAsrRevision=wsAsrRevision, wsFanNumber=wsFanNumber, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTemp=wsSFPTemp, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyCookie=wsPolicyCookie, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPTemp=wsXFPTemp, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPFDP=wsPFDP, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsIbosVoltHigh=wsIbosVoltHigh, wsVoltMeasured=wsVoltMeasured, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsVoltEntry=wsVoltEntry, wsSFPTransceiver=wsSFPTransceiver, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPVolt=wsSFPVolt, wsVersion=wsVersion, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyTable=wsPolicyTable, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPConnector=wsSFPConnector, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSystem=wsSystem, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVoltNominal=wsVoltNominal, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsReload=wsReload, wsFanVoltage=wsFanVoltage, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyInBytes=wsPolicyInBytes, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourModel=wsNeighbourModel, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyEntry=wsPolicyEntry, wsSFPRXPower=wsSFPRXPower, wsNeighboursEntry=wsNeighboursEntry, wsXFPTXCurrent=wsXFPTXCurrent, wsEnvironment=wsEnvironment, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPStatus=wsSFPStatus, wsTempThresholdLow=wsTempThresholdLow, wsTempEntry=wsTempEntry, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsFanRPM=wsFanRPM, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPIndex=wsXFPIndex, wsSFPIndex=wsSFPIndex, wsNeighbourHostname=wsNeighbourHostname, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsTempTOS=wsTempTOS, wsSFPBitrate=wsSFPBitrate, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTable=wsSFPTable, wsSFPPartNumber=wsSFPPartNumber, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourUptime=wsNeighbourUptime, wsVoltChannel=wsVoltChannel, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyOutBytes=wsPolicyOutBytes, wsTempTable=wsTempTable, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPEncoding=wsSFPEncoding, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsFanTable=wsFanTable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPEncoding=wsXFPEncoding, wsVoltTable=wsVoltTable, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsIbosTempLow=wsIbosTempLow, wsPolicyName=wsPolicyName, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsVoltStatus=wsVoltStatus, wsSFPTXPower=wsSFPTXPower, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPTXPower=wsXFPTXPower, wsXFPTransceiver=wsXFPTransceiver, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVoltThresholdLow=wsVoltThresholdLow, wsTempMeasured=wsTempMeasured, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPTable=wsXFPTable, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsWritedummy=wsWritedummy, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, PYSNMP_MODULE_ID=ibos, wsVersionString=wsVersionString, wsNeighbourLastAct=wsNeighbourLastAct, wsPolicyInDrops=wsPolicyInDrops, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets)
