...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyOutDrops=wsPolicyOutDrops, wsFanTable=wsFanTable, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTable=wsSFPTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsVoltStatus=wsVoltStatus, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyTable=wsPolicyTable, wsSFPTemp=wsSFPTemp, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVersionString=wsVersionString, wsXFPTXPower=wsXFPTXPower, wsVoltMeasured=wsVoltMeasured, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTempStatus=wsXFPTempStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVoltEntry=wsVoltEntry, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyIfName=wsPolicyIfName, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPStatus=wsXFPStatus, wsSFPEntry=wsSFPEntry, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosTempLow=wsIbosTempLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyCookie=wsPolicyCookie, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPTable=wsXFPTable, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPRXPower=wsXFPRXPower, wsTempTHYST=wsTempTHYST, wsFanEntry=wsFanEntry, wsNeighbourModel=wsNeighbourModel, wsAsrRevision=wsAsrRevision, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPEncoding=wsXFPEncoding, wsNeighboursTable=wsNeighboursTable, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyOutPkts=wsPolicyOutPkts, wsTempEntry=wsTempEntry, wsTempStatus=wsTempStatus, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPIndex=wsXFPIndex, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsIbosFanRPMLow=wsIbosFanRPMLow, wsReload=wsReload, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsFanVoltage=wsFanVoltage, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyEntry=wsPolicyEntry, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourHostname=wsNeighbourHostname, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPFDP=wsPFDP, wsVoltNominal=wsVoltNominal, wsPolicyInPkts=wsPolicyInPkts, wsPolicyInDrops=wsPolicyInDrops, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsTempSensor=wsTempSensor, wsSFPPartNumber=wsSFPPartNumber, wsXFPTransceiver=wsXFPTransceiver, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsVoltChannel=wsVoltChannel, wsVoltTable=wsVoltTable, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyName=wsPolicyName, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsTempMeasured=wsTempMeasured, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsAccounting=wsAccounting, wsFanRPM=wsFanRPM, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPTXCurrent=wsXFPTXCurrent, wsEnvironment=wsEnvironment, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPIndex=wsSFPIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPEncoding=wsSFPEncoding, wsNeighboursEntry=wsNeighboursEntry, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, ibos=ibos, wsFanNumber=wsFanNumber, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPRXPower=wsSFPRXPower, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsVersion=wsVersion, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPConnector=wsXFPConnector, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsWritedummy=wsWritedummy, wsSFPTempNormalLow=wsSFPTempNormalLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPStatus=wsSFPStatus, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, PYSNMP_MODULE_ID=ibos, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSystem=wsSystem, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPEntry=wsXFPEntry, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTemp=wsXFPTemp, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTempStatus=wsSFPTempStatus, wsTempTable=wsTempTable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPCopperLen=wsSFPCopperLen, wsPolicyInBytes=wsPolicyInBytes, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourCreated=wsNeighbourCreated, wsSFPConnector=wsSFPConnector, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsTempThresholdHigh=wsTempThresholdHigh, wsTempThresholdLow=wsTempThresholdLow, wsSFPTempWarningLow=wsSFPTempWarningLow, wsTempTOS=wsTempTOS)
