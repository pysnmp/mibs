...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPTable=wsXFPTable, PYSNMP_MODULE_ID=ibos, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsTempEntry=wsTempEntry, wsVersionString=wsVersionString, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPTXPower=wsXFPTXPower, wsEnvironment=wsEnvironment, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsTempTable=wsTempTable, wsNeighbourState=wsNeighbourState, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXPower=wsSFPRXPower, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsFanVoltage=wsFanVoltage, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyOutDrops=wsPolicyOutDrops, wsVoltTable=wsVoltTable, wsNeighboursEntry=wsNeighboursEntry, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsFanNumber=wsFanNumber, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyIfName=wsPolicyIfName, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsFanRPM=wsFanRPM, wsSFPTXPower=wsSFPTXPower, wsSFPIndex=wsSFPIndex, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourModel=wsNeighbourModel, wsAsrRevision=wsAsrRevision, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPEntry=wsSFPEntry, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPBitrate=wsSFPBitrate, wsVoltChannel=wsVoltChannel, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPTemp=wsXFPTemp, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyOutPkts=wsPolicyOutPkts, wsReload=wsReload, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsFanEntry=wsFanEntry, wsTempTHYST=wsTempTHYST, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyEntry=wsPolicyEntry, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPConnector=wsSFPConnector, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPStatus=wsSFPStatus, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPTempStatus=wsXFPTempStatus, wsTempTOS=wsTempTOS, wsSystem=wsSystem, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, ibos=ibos, wsTempStatus=wsTempStatus, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsIbosTempLow=wsIbosTempLow, wsPolicyName=wsPolicyName, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPConnector=wsXFPConnector, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyIfIndex=wsPolicyIfIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortName=wsNeighbourPortName, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourUptime=wsNeighbourUptime, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsVoltEntry=wsVoltEntry, wsAccounting=wsAccounting, wsWritedummy=wsWritedummy, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTransceiver=wsSFPTransceiver, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPIndex=wsXFPIndex, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPCopperLen=wsSFPCopperLen, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPBitrateMax=wsXFPBitrateMax, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPEncoding=wsXFPEncoding, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPStatus=wsXFPStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsVoltThresholdHigh=wsVoltThresholdHigh, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourCreated=wsNeighbourCreated, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsTempSensor=wsTempSensor, wsSFPEncoding=wsSFPEncoding, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTemp=wsSFPTemp, wsVersion=wsVersion, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsFanTable=wsFanTable, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPFDP=wsPFDP, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyTable=wsPolicyTable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsTempMeasured=wsTempMeasured, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPVolt=wsSFPVolt, wsSFPTable=wsSFPTable, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPEntry=wsXFPEntry, wsPolicyCookie=wsPolicyCookie)
