...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPRXPower=wsXFPRXPower, wsXFPEntry=wsXFPEntry, wsPolicyIfName=wsPolicyIfName, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPFDP=wsPFDP, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyName=wsPolicyName, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPBitrateMax=wsXFPBitrateMax, wsTempTHYST=wsTempTHYST, wsXFPConnector=wsXFPConnector, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempSensor=wsTempSensor, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourSNPA=wsNeighbourSNPA, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourDBCount=wsNeighbourDBCount, wsReload=wsReload, wsSFPTempWarningLow=wsSFPTempWarningLow, wsVersion=wsVersion, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighboursEntry=wsNeighboursEntry, wsTempTable=wsTempTable, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosTempHigh=wsIbosTempHigh, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXPower=wsSFPTXPower, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsTempMeasured=wsTempMeasured, wsVoltTable=wsVoltTable, wsSFPConnector=wsSFPConnector, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsVersionString=wsVersionString, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsPolicyOutDrops=wsPolicyOutDrops, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTemp=wsXFPTemp, wsSFPEntry=wsSFPEntry, wsNeighbourUptime=wsNeighbourUptime, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsTempTOS=wsTempTOS, wsSystem=wsSystem, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsFanRPM=wsFanRPM, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTempStatus=wsSFPTempStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourIfIndex=wsNeighbourIfIndex, wsFanEntry=wsFanEntry, wsNeighboursTable=wsNeighboursTable, wsXFPTempStatus=wsXFPTempStatus, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsAsrRevision=wsAsrRevision, wsNeighbourModel=wsNeighbourModel, wsIbosVoltLow=wsIbosVoltLow, wsWritedummy=wsWritedummy, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsFanVoltage=wsFanVoltage, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsIbosTempLow=wsIbosTempLow, wsTempEntry=wsTempEntry, wsSFPIndex=wsSFPIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsTempStatus=wsTempStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourLastAct=wsNeighbourLastAct, wsAccounting=wsAccounting, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPIndex=wsXFPIndex, wsEnvironment=wsEnvironment, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyEntry=wsPolicyEntry, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPTable=wsXFPTable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPEncoding=wsXFPEncoding, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyTable=wsPolicyTable, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPEncoding=wsSFPEncoding, wsNeighbourCreated=wsNeighbourCreated, wsSFPTemp=wsSFPTemp, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortState=wsNeighbourPortState, PYSNMP_MODULE_ID=ibos, ibos=ibos, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPCopperLen=wsSFPCopperLen, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsVoltStatus=wsVoltStatus, wsVoltNominal=wsVoltNominal, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsFanNumber=wsFanNumber, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPPartNumber=wsSFPPartNumber, wsSFPStatus=wsSFPStatus, wsSFPTable=wsSFPTable, wsSFPBitrate=wsSFPBitrate, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyInDrops=wsPolicyInDrops, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourState=wsNeighbourState, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPRXPower=wsSFPRXPower, wsXFPStatus=wsXFPStatus, wsXFPTXPower=wsXFPTXPower, wsFanTable=wsFanTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourNIndex=wsNeighbourNIndex)
