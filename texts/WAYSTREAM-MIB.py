...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsVoltNominal=wsVoltNominal, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsTempTHYST=wsTempTHYST, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPIndex=wsXFPIndex, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPConnector=wsXFPConnector, wsTempStatus=wsTempStatus, wsSystem=wsSystem, wsSFPEntry=wsSFPEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPFDP=wsPFDP, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPCopperLen=wsXFPCopperLen, wsSFPIndex=wsSFPIndex, wsXFPStatus=wsXFPStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyEntry=wsPolicyEntry, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsFanTable=wsFanTable, wsSFPTemp=wsSFPTemp, wsNeighbourState=wsNeighbourState, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyTable=wsPolicyTable, wsSFPEncoding=wsSFPEncoding, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsTempEntry=wsTempEntry, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVersionString=wsVersionString, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyCookie=wsPolicyCookie, wsXFPEncoding=wsXFPEncoding, wsSFPTXPower=wsSFPTXPower, wsNeighbourHostname=wsNeighbourHostname, wsTempTable=wsTempTable, wsXFPTemp=wsXFPTemp, wsVoltMeasured=wsVoltMeasured, wsNeighbourUptime=wsNeighbourUptime, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortState=wsNeighbourPortState, wsXFPEntry=wsXFPEntry, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPConnector=wsSFPConnector, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyIfName=wsPolicyIfName, wsEnvironment=wsEnvironment, wsXFPTable=wsXFPTable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosTempLow=wsIbosTempLow, wsFanVoltage=wsFanVoltage, wsTempThresholdLow=wsTempThresholdLow, wsVoltChannel=wsVoltChannel, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsFanRPM=wsFanRPM, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempSensor=wsTempSensor, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPBitrate=wsSFPBitrate, wsNeighbourCreated=wsNeighbourCreated, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPSingleModeLen=wsXFPSingleModeLen, wsFanEntry=wsFanEntry, wsVersion=wsVersion, wsVoltEntry=wsVoltEntry, wsSFPPartNumber=wsSFPPartNumber, wsXFPBitrateMin=wsXFPBitrateMin, PYSNMP_MODULE_ID=ibos, wsReload=wsReload, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTempWarningLow=wsSFPTempWarningLow, wsIbosTempHigh=wsIbosTempHigh, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsFanNumber=wsFanNumber, wsNeighboursTable=wsNeighboursTable, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsVoltStatus=wsVoltStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyIfIndex=wsPolicyIfIndex, wsWritedummy=wsWritedummy, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVoltTable=wsVoltTable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsTempTOS=wsTempTOS, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsAccounting=wsAccounting, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPCopperLen=wsSFPCopperLen, ibos=ibos, wsPolicyOutDrops=wsPolicyOutDrops, wsAsrRevision=wsAsrRevision, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPRXPower=wsSFPRXPower, wsPolicyInPkts=wsPolicyInPkts, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyName=wsPolicyName, wsSFPStatus=wsSFPStatus, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTempStatus=wsSFPTempStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTXPower=wsXFPTXPower, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPTransceiver=wsXFPTransceiver, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTable=wsSFPTable, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortsTable=wsNeighbourPortsTable)
