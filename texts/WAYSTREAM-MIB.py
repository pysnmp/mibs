...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPVoltStatus=wsSFPVoltStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsVoltTable=wsVoltTable, wsXFPTXPower=wsXFPTXPower, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPStatus=wsXFPStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsEnvironment=wsEnvironment, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPTempStatus=wsXFPTempStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, ibos=ibos, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourHostname=wsNeighbourHostname, wsPolicyName=wsPolicyName, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPTXCurrent=wsXFPTXCurrent, wsReload=wsReload, wsVersion=wsVersion, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPRXPower=wsSFPRXPower, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsTempEntry=wsTempEntry, wsSFPVolt=wsSFPVolt, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPTransceiver=wsXFPTransceiver, wsXFPTXPowerStatus=wsXFPTXPowerStatus, PYSNMP_MODULE_ID=ibos, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPConnector=wsXFPConnector, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsVoltEntry=wsVoltEntry, wsVoltChannel=wsVoltChannel, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourSNPA=wsNeighbourSNPA, wsFanNumber=wsFanNumber, wsVoltStatus=wsVoltStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourState=wsNeighbourState, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourCreated=wsNeighbourCreated, wsSFPTempStatus=wsSFPTempStatus, wsSFPTransceiver=wsSFPTransceiver, wsXFPEncoding=wsXFPEncoding, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPTable=wsXFPTable, wsNeighbourModel=wsNeighbourModel, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsFanEntry=wsFanEntry, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsPolicyIfName=wsPolicyIfName, wsXFPCopperLen=wsXFPCopperLen, wsTempThresholdHigh=wsTempThresholdHigh, wsAccounting=wsAccounting, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXdBmPower=wsSFPTXdBmPower, wsVersionString=wsVersionString, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPIndex=wsSFPIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourLocalIf=wsNeighbourLocalIf, wsWritedummy=wsWritedummy, wsTempSensor=wsTempSensor, wsIbosVoltLow=wsIbosVoltLow, wsFanTable=wsFanTable, wsSFPTXPower=wsSFPTXPower, wsXFPEntry=wsXFPEntry, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPBitrate=wsSFPBitrate, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsTempTOS=wsTempTOS, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPTemp=wsXFPTemp, wsSFPTable=wsSFPTable, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSystem=wsSystem, wsTempTHYST=wsTempTHYST, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsFanVoltage=wsFanVoltage, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVoltNominal=wsVoltNominal, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPStatus=wsSFPStatus, wsIbosTempLow=wsIbosTempLow, wsSFPTemp=wsSFPTemp, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyInBytes=wsPolicyInBytes, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsTempMeasured=wsTempMeasured, wsTempThresholdLow=wsTempThresholdLow, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPRXPower=wsXFPRXPower, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPIndex=wsXFPIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyTable=wsPolicyTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPFDP=wsPFDP, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsTempTable=wsTempTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPolicyInPkts=wsPolicyInPkts, wsTempStatus=wsTempStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsFanRPM=wsFanRPM, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPCopperLen=wsSFPCopperLen, wsVoltMeasured=wsVoltMeasured)
