...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPFDP=wsPFDP, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXCurrent=wsSFPTXCurrent, wsFanNumber=wsFanNumber, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVoltMeasured=wsVoltMeasured, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPIndex=wsXFPIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVersion=wsVersion, wsFanRPM=wsFanRPM, wsVersionString=wsVersionString, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsIbosVoltHigh=wsIbosVoltHigh, wsVoltThresholdLow=wsVoltThresholdLow, PYSNMP_MODULE_ID=ibos, wsNeighbourCreated=wsNeighbourCreated, wsSFPTransceiver=wsSFPTransceiver, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighboursEntry=wsNeighboursEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPTXPower=wsXFPTXPower, wsVoltStatus=wsVoltStatus, wsFanTable=wsFanTable, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTable=wsXFPTable, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighboursTable=wsNeighboursTable, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPVolt=wsSFPVolt, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourSNPA=wsNeighbourSNPA, wsFanVoltage=wsFanVoltage, wsSystem=wsSystem, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyInBytes=wsPolicyInBytes, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourState=wsNeighbourState, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsReload=wsReload, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsTempTHYST=wsTempTHYST, wsTempSensor=wsTempSensor, wsFanEntry=wsFanEntry, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPRXPower=wsSFPRXPower, wsTempTOS=wsTempTOS, wsVoltChannel=wsVoltChannel, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPRXPower=wsXFPRXPower, wsSFPEncoding=wsSFPEncoding, wsXFPTempStatus=wsXFPTempStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsIbosTempLow=wsIbosTempLow, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsVoltTable=wsVoltTable, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTemp=wsSFPTemp, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXPower=wsSFPTXPower, wsNeighbourUptime=wsNeighbourUptime, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempEntry=wsTempEntry, wsEnvironment=wsEnvironment, wsAsrRevision=wsAsrRevision, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPConnector=wsSFPConnector, wsPolicyOutBytes=wsPolicyOutBytes, wsTempTable=wsTempTable, wsSFPCopperLen=wsSFPCopperLen, wsPolicyName=wsPolicyName, wsPolicyEntry=wsPolicyEntry, wsXFPEntry=wsXFPEntry, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPEntry=wsSFPEntry, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, ibos=ibos, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsPolicyTable=wsPolicyTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPIndex=wsSFPIndex, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPStatus=wsSFPStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVoltNominal=wsVoltNominal, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPRXdBmPower=wsSFPRXdBmPower, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourHostname=wsNeighbourHostname, wsWritedummy=wsWritedummy, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsAccounting=wsAccounting, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTempStatus=wsSFPTempStatus, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsTempMeasured=wsTempMeasured, wsXFPEncoding=wsXFPEncoding, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortName=wsNeighbourPortName, wsXFPTemp=wsXFPTemp, wsSFPTable=wsSFPTable, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyInDrops=wsPolicyInDrops, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPPartNumber=wsSFPPartNumber, wsSFPSingleModeLen=wsSFPSingleModeLen, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPCopperLen=wsXFPCopperLen, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsTempStatus=wsTempStatus)
