...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPCopperLen=wsXFPCopperLen, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPRXPower=wsXFPRXPower, wsVoltChannel=wsVoltChannel, wsNeighbourModel=wsNeighbourModel, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsAccounting=wsAccounting, wsXFPIndex=wsXFPIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyOutPkts=wsPolicyOutPkts, ibos=ibos, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourHostname=wsNeighbourHostname, wsVoltEntry=wsVoltEntry, wsSFPBitrate=wsSFPBitrate, wsPolicyCookie=wsPolicyCookie, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortName=wsNeighbourPortName, wsIbosTempHigh=wsIbosTempHigh, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPIndex=wsSFPIndex, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourCreated=wsNeighbourCreated, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsFanVoltage=wsFanVoltage, wsPolicyIfName=wsPolicyIfName, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsFanRPM=wsFanRPM, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTransceiverExt=wsSFPTransceiverExt, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPEncoding=wsSFPEncoding, wsTempMeasured=wsTempMeasured, wsXFPStatus=wsXFPStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsReload=wsReload, wsTempEntry=wsTempEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsFanTable=wsFanTable, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyInBytes=wsPolicyInBytes, wsVoltMeasured=wsVoltMeasured, wsSFPTXCurrent=wsSFPTXCurrent, wsTempTHYST=wsTempTHYST, wsPolicyInDrops=wsPolicyInDrops, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTable=wsSFPTable, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsTempThresholdLow=wsTempThresholdLow, wsXFPConnector=wsXFPConnector, wsSFPStatus=wsSFPStatus, wsXFPTable=wsXFPTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsPolicyTable=wsPolicyTable, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsTempTOS=wsTempTOS, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPEntry=wsSFPEntry, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsPolicyEntry=wsPolicyEntry, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourUptime=wsNeighbourUptime, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsVoltThresholdHigh=wsVoltThresholdHigh, wsTempTable=wsTempTable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPVolt=wsSFPVolt, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPEncoding=wsXFPEncoding, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPTemp=wsXFPTemp, wsVersionString=wsVersionString, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourLastAct=wsNeighbourLastAct, wsPolicyInPkts=wsPolicyInPkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPCopperLen=wsSFPCopperLen, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsVoltTable=wsVoltTable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsTempStatus=wsTempStatus, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsWritedummy=wsWritedummy, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTempStatus=wsSFPTempStatus, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsEnvironment=wsEnvironment, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsVoltThresholdLow=wsVoltThresholdLow, wsTempSensor=wsTempSensor, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsFanNumber=wsFanNumber, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPRXPower=wsSFPRXPower, wsSFPConnector=wsSFPConnector, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyName=wsPolicyName, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTransceiver=wsSFPTransceiver, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsIbosVoltLow=wsIbosVoltLow, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPFDP=wsPFDP, wsFanEntry=wsFanEntry, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsVersion=wsVersion, wsAsrRevision=wsAsrRevision, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPEntry=wsXFPEntry, wsNeighbourState=wsNeighbourState, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPPartNumber=wsSFPPartNumber, wsSystem=wsSystem, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTempWarningLow=wsSFPTempWarningLow)
