...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPBitrateMin=wsXFPBitrateMin, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPStatus=wsSFPStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyTable=wsPolicyTable, wsXFPTransceiver=wsXFPTransceiver, wsSFPBitrate=wsSFPBitrate, wsSFPTXdBmPower=wsSFPTXdBmPower, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltTable=wsVoltTable, wsSFPCopperLen=wsSFPCopperLen, wsSFPRXdBmPower=wsSFPRXdBmPower, wsTempThresholdLow=wsTempThresholdLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsVersionString=wsVersionString, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsPolicyEntry=wsPolicyEntry, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPEncoding=wsXFPEncoding, ibos=ibos, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsReload=wsReload, wsFanVoltage=wsFanVoltage, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsTempMeasured=wsTempMeasured, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourOSVersion=wsNeighbourOSVersion, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTemp=wsSFPTemp, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsVoltNominal=wsVoltNominal, wsTempTable=wsTempTable, wsVoltEntry=wsVoltEntry, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPTable=wsXFPTable, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSystem=wsSystem, wsVersion=wsVersion, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourUptime=wsNeighbourUptime, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXPower=wsSFPTXPower, wsIbosTempLow=wsIbosTempLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourState=wsNeighbourState, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPVoltStatus=wsSFPVoltStatus, wsTempEntry=wsTempEntry, wsXFPTXPower=wsXFPTXPower, wsVoltChannel=wsVoltChannel, wsWritedummy=wsWritedummy, wsXFPTXCurrent=wsXFPTXCurrent, wsAsrRevision=wsAsrRevision, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPFDP=wsPFDP, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourModel=wsNeighbourModel, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsAccounting=wsAccounting, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsVoltThresholdLow=wsVoltThresholdLow, wsTempTOS=wsTempTOS, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXPower=wsSFPRXPower, wsPolicyCookie=wsPolicyCookie, wsSFPIndex=wsSFPIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPConnector=wsXFPConnector, wsPolicyInBytes=wsPolicyInBytes, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPStatus=wsXFPStatus, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsTempSensor=wsTempSensor, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTransceiver=wsSFPTransceiver, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourHostname=wsNeighbourHostname, wsTempStatus=wsTempStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVoltStatus=wsVoltStatus, wsSFPTable=wsSFPTable, wsXFPEntry=wsXFPEntry, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsFanNumber=wsFanNumber, wsPolicyName=wsPolicyName, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsVoltMeasured=wsVoltMeasured, wsFanRPM=wsFanRPM, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTempStatus=wsSFPTempStatus, wsSFPConnector=wsSFPConnector, wsEnvironment=wsEnvironment, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighboursEntry=wsNeighboursEntry, wsTempTHYST=wsTempTHYST, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTempStatus=wsXFPTempStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPRXPower=wsXFPRXPower, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyIfName=wsPolicyIfName, wsNeighbourCreated=wsNeighbourCreated, wsNeighboursTable=wsNeighboursTable, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPEntry=wsSFPEntry, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPPartNumber=wsSFPPartNumber, wsPolicyInDrops=wsPolicyInDrops, wsIbosTempHigh=wsIbosTempHigh, wsIbosVoltLow=wsIbosVoltLow, wsFanEntry=wsFanEntry, wsXFPTemp=wsXFPTemp, wsFanTable=wsFanTable, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets)
