...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsTempMeasured=wsTempMeasured, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, PYSNMP_MODULE_ID=ibos, wsFanVoltage=wsFanVoltage, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, ibos=ibos, wsVoltEntry=wsVoltEntry, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsFanNumber=wsFanNumber, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTable=wsSFPTable, wsPolicyInBytes=wsPolicyInBytes, wsAccounting=wsAccounting, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighboursEntry=wsNeighboursEntry, wsXFPTable=wsXFPTable, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsIbosTempHigh=wsIbosTempHigh, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPStatus=wsSFPStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsPolicyInDrops=wsPolicyInDrops, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXPower=wsSFPTXPower, wsSFPIndex=wsSFPIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsFanRPM=wsFanRPM, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsVoltMeasured=wsVoltMeasured, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPTemp=wsXFPTemp, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSystem=wsSystem, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPVoltStatus=wsSFPVoltStatus, wsAsrRevision=wsAsrRevision, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyName=wsPolicyName, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTempStatus=wsSFPTempStatus, wsVoltNominal=wsVoltNominal, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyIfName=wsPolicyIfName, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsFanEntry=wsFanEntry, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempSensor=wsTempSensor, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVersionString=wsVersionString, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPRXPower=wsSFPRXPower, wsXFPIndex=wsXFPIndex, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortName=wsNeighbourPortName, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsEnvironment=wsEnvironment, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsIbosVoltHigh=wsIbosVoltHigh, wsTempEntry=wsTempEntry, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsFanTable=wsFanTable, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsTempTOS=wsTempTOS, wsSFPEntry=wsSFPEntry, wsPolicyCookie=wsPolicyCookie, wsSFPTemp=wsSFPTemp, wsWritedummy=wsWritedummy, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyEntry=wsPolicyEntry, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsTempThresholdLow=wsTempThresholdLow, wsXFPEntry=wsXFPEntry, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPTXCurrent=wsXFPTXCurrent, wsVersion=wsVersion, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsTempStatus=wsTempStatus, wsSFPPartNumber=wsSFPPartNumber, wsVoltTable=wsVoltTable, wsSFPVolt=wsSFPVolt, wsVoltChannel=wsVoltChannel, wsSFPCopperLen=wsSFPCopperLen, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsTempTable=wsTempTable, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsReload=wsReload, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsIbosTempLow=wsIbosTempLow, wsXFPTempStatus=wsXFPTempStatus, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPStatus=wsXFPStatus, wsPolicyTable=wsPolicyTable, wsPFDP=wsPFDP, wsTempTHYST=wsTempTHYST, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsPolicyInPkts=wsPolicyInPkts, wsSFPConnector=wsSFPConnector, wsNeighbourCreated=wsNeighbourCreated, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPEncoding=wsSFPEncoding, wsVoltStatus=wsVoltStatus, wsXFPCopperLen=wsXFPCopperLen)
