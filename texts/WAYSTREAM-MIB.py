...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPEntry=wsXFPEntry, wsPFDP=wsPFDP, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSystem=wsSystem, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTransceiverExt=wsSFPTransceiverExt, wsEnvironment=wsEnvironment, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVersionString=wsVersionString, wsIbosTempHigh=wsIbosTempHigh, wsSFPVolt=wsSFPVolt, wsPolicyInDrops=wsPolicyInDrops, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPConnector=wsXFPConnector, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsTempTable=wsTempTable, wsXFPTemp=wsXFPTemp, wsVoltTable=wsVoltTable, wsTempStatus=wsTempStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyCookie=wsPolicyCookie, wsSFPTempWarningLow=wsSFPTempWarningLow, wsReload=wsReload, wsTempThresholdLow=wsTempThresholdLow, wsFanEntry=wsFanEntry, wsXFPTempStatus=wsXFPTempStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsTempEntry=wsTempEntry, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourCreated=wsNeighbourCreated, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPEntry=wsSFPEntry, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPSerialNumber=wsSFPSerialNumber, wsVersion=wsVersion, wsVoltStatus=wsVoltStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsTempMeasured=wsTempMeasured, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPRXPower=wsXFPRXPower, wsVoltMeasured=wsVoltMeasured, wsPolicyEntry=wsPolicyEntry, wsNeighboursTable=wsNeighboursTable, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsAccounting=wsAccounting, wsSFPPartNumber=wsSFPPartNumber, wsPolicyName=wsPolicyName, wsWritedummy=wsWritedummy, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyTable=wsPolicyTable, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsTempSensor=wsTempSensor, wsNeighbourNIndex=wsNeighbourNIndex, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltChannel=wsVoltChannel, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPConnector=wsSFPConnector, wsFanNumber=wsFanNumber, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsIbosVoltHigh=wsIbosVoltHigh, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighboursEntry=wsNeighboursEntry, wsSFPTable=wsSFPTable, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPIndex=wsXFPIndex, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsTempTHYST=wsTempTHYST, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPCopperLen=wsXFPCopperLen, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPIndex=wsSFPIndex, wsNeighbourHostname=wsNeighbourHostname, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTempNormalLow=wsSFPTempNormalLow, wsPolicyInPkts=wsPolicyInPkts, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, ibos=ibos, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsFanTable=wsFanTable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourModel=wsNeighbourModel, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPRXPower=wsSFPRXPower, wsFanVoltage=wsFanVoltage, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVoltEntry=wsVoltEntry, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTXCurrent=wsSFPTXCurrent, wsAsrRevision=wsAsrRevision, wsPolicyInBytes=wsPolicyInBytes, wsSFPCopperLen=wsSFPCopperLen, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTemp=wsSFPTemp, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPStatus=wsXFPStatus, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortState=wsNeighbourPortState, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsIbosVoltLow=wsIbosVoltLow, wsSFPStatus=wsSFPStatus, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPTable=wsXFPTable, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVoltNominal=wsVoltNominal, wsTempTOS=wsTempTOS, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTempStatus=wsSFPTempStatus, wsFanRPM=wsFanRPM)
