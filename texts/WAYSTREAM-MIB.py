...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsTempThresholdLow=wsTempThresholdLow, wsVersion=wsVersion, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPEntry=wsSFPEntry, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourModel=wsNeighbourModel, wsTempStatus=wsTempStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsAccounting=wsAccounting, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPIndex=wsXFPIndex, wsFanEntry=wsFanEntry, wsReload=wsReload, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourState=wsNeighbourState, wsSFPVolt=wsSFPVolt, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsIbosTempLow=wsIbosTempLow, wsFanTable=wsFanTable, wsSFPTransceiver=wsSFPTransceiver, wsVoltEntry=wsVoltEntry, wsTempTable=wsTempTable, wsXFPEncoding=wsXFPEncoding, wsSystem=wsSystem, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortName=wsNeighbourPortName, wsTempSensor=wsTempSensor, wsPFDP=wsPFDP, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPEntry=wsXFPEntry, wsSFPTable=wsSFPTable, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXPower=wsSFPTXPower, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyInPkts=wsPolicyInPkts, wsVoltNominal=wsVoltNominal, wsXFPConnector=wsXFPConnector, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourDBCount=wsNeighbourDBCount, wsTempMeasured=wsTempMeasured, wsPolicyName=wsPolicyName, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXPower=wsSFPRXPower, wsTempTOS=wsTempTOS, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPRXPower=wsXFPRXPower, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsWritedummy=wsWritedummy, wsAsrRevision=wsAsrRevision, PYSNMP_MODULE_ID=ibos, wsEnvironment=wsEnvironment, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPBitrate=wsSFPBitrate, ibos=ibos, wsNeighboursTable=wsNeighboursTable, wsTempTHYST=wsTempTHYST, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsVersionString=wsVersionString, wsFanVoltage=wsFanVoltage, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPStatus=wsXFPStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsVoltStatus=wsVoltStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsFanNumber=wsFanNumber, wsSFPStatus=wsSFPStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsVoltChannel=wsVoltChannel, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsIbosTempHigh=wsIbosTempHigh, wsPolicyCookie=wsPolicyCookie, wsVoltTable=wsVoltTable, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTemp=wsSFPTemp, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourCreated=wsNeighbourCreated, wsFanRPM=wsFanRPM, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTable=wsXFPTable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPPartNumber=wsSFPPartNumber, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPTransceiver=wsXFPTransceiver, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPCopperLen=wsXFPCopperLen, wsSFPIndex=wsSFPIndex, wsNeighbourHostname=wsNeighbourHostname, wsSFPTempNormalLow=wsSFPTempNormalLow, wsPolicyTable=wsPolicyTable, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPTXPower=wsXFPTXPower, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyIfName=wsPolicyIfName, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsTempEntry=wsTempEntry, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex)
