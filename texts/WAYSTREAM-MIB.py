...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPTemp=wsXFPTemp, wsXFPTable=wsXFPTable, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortState=wsNeighbourPortState, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVoltNominal=wsVoltNominal, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVersionString=wsVersionString, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyInDrops=wsPolicyInDrops, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsAsrRevision=wsAsrRevision, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTable=wsSFPTable, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPConnector=wsSFPConnector, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourNIndex=wsNeighbourNIndex, PYSNMP_MODULE_ID=ibos, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsVoltTable=wsVoltTable, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsReload=wsReload, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsEnvironment=wsEnvironment, wsAccounting=wsAccounting, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPEncoding=wsXFPEncoding, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPStatus=wsSFPStatus, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPTXPower=wsXFPTXPower, wsSFPTempStatus=wsSFPTempStatus, wsVoltEntry=wsVoltEntry, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsFanVoltage=wsFanVoltage, wsNeighbourPortSNPA=wsNeighbourPortSNPA, ibos=ibos, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPTempStatus=wsXFPTempStatus, wsFanNumber=wsFanNumber, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourUptime=wsNeighbourUptime, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPStatus=wsXFPStatus, wsFanRPM=wsFanRPM, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPVolt=wsSFPVolt, wsSFPTXPower=wsSFPTXPower, wsNeighbourState=wsNeighbourState, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsWritedummy=wsWritedummy, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPPartNumber=wsSFPPartNumber, wsFanTable=wsFanTable, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPBitrate=wsSFPBitrate, wsVoltStatus=wsVoltStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPIndex=wsXFPIndex, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourModel=wsNeighbourModel, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPIndex=wsSFPIndex, wsTempTHYST=wsTempTHYST, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyIfName=wsPolicyIfName, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsIbosTempLow=wsIbosTempLow, wsVersion=wsVersion, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPEntry=wsSFPEntry, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPFDP=wsPFDP, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyCookie=wsPolicyCookie, wsSFPTemp=wsSFPTemp, wsSFPRXPower=wsSFPRXPower, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsTempThresholdLow=wsTempThresholdLow, wsTempSensor=wsTempSensor, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyOutPkts=wsPolicyOutPkts, wsTempStatus=wsTempStatus, wsTempTable=wsTempTable, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsTempEntry=wsTempEntry, wsXFPConnector=wsXFPConnector, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPTXCurrent=wsXFPTXCurrent, wsSystem=wsSystem, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsVoltChannel=wsVoltChannel, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPTransceiver=wsXFPTransceiver, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyTable=wsPolicyTable, wsTempTOS=wsTempTOS, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPolicyName=wsPolicyName, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVoltMeasured=wsVoltMeasured, wsSFPSerialNumber=wsSFPSerialNumber, wsFanEntry=wsFanEntry, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPEntry=wsXFPEntry)
