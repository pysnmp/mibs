...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPStatus=wsSFPStatus, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPFDP=wsPFDP, wsFanVoltage=wsFanVoltage, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPTransceiver=wsXFPTransceiver, wsXFPStatus=wsXFPStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsTempTOS=wsTempTOS, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPConnector=wsXFPConnector, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPBitrateMin=wsXFPBitrateMin, wsFanNumber=wsFanNumber, wsSFPTransceiver=wsSFPTransceiver, wsVoltNominal=wsVoltNominal, wsXFPTXPower=wsXFPTXPower, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyInPkts=wsPolicyInPkts, wsXFPCopperLen=wsXFPCopperLen, wsVersion=wsVersion, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsTempEntry=wsTempEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTempStatus=wsSFPTempStatus, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyName=wsPolicyName, ibos=ibos, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighboursEntry=wsNeighboursEntry, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyTable=wsPolicyTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyCookie=wsPolicyCookie, wsNeighbourIfIndex=wsNeighbourIfIndex, wsIbosVoltHigh=wsIbosVoltHigh, wsAccounting=wsAccounting, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsFanTable=wsFanTable, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPEntry=wsXFPEntry, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsTempSensor=wsTempSensor, wsXFPIndex=wsXFPIndex, wsSFPBitrate=wsSFPBitrate, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourState=wsNeighbourState, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPEncoding=wsSFPEncoding, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXPower=wsSFPTXPower, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortName=wsNeighbourPortName, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVoltMeasured=wsVoltMeasured, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltStatus=wsVoltStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsEnvironment=wsEnvironment, wsPolicyOutDrops=wsPolicyOutDrops, wsIbosVoltLow=wsIbosVoltLow, wsPolicyOutBytes=wsPolicyOutBytes, wsTempMeasured=wsTempMeasured, wsPolicyEntry=wsPolicyEntry, wsXFPRXPower=wsXFPRXPower, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsFanRPM=wsFanRPM, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsVoltChannel=wsVoltChannel, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortState=wsNeighbourPortState, wsPolicyInDrops=wsPolicyInDrops, wsFanEntry=wsFanEntry, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsWritedummy=wsWritedummy, wsNeighbourUptime=wsNeighbourUptime, wsSFPSerialNumber=wsSFPSerialNumber, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, PYSNMP_MODULE_ID=ibos, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsVoltTable=wsVoltTable, wsVersionString=wsVersionString, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTable=wsSFPTable, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsTempTHYST=wsTempTHYST, wsSFPVolt=wsSFPVolt, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPIndex=wsSFPIndex, wsXFPTable=wsXFPTable, wsSFPConnector=wsSFPConnector, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsAsrRevision=wsAsrRevision, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsTempStatus=wsTempStatus, wsSFPTemp=wsSFPTemp, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSystem=wsSystem, wsSFPRXPower=wsSFPRXPower, wsVoltEntry=wsVoltEntry, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsReload=wsReload, wsTempTable=wsTempTable, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPPartNumber=wsSFPPartNumber, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyOutPkts=wsPolicyOutPkts)
