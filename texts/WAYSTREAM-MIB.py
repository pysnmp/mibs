...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPEncoding=wsXFPEncoding, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourModel=wsNeighbourModel, wsPolicyCookie=wsPolicyCookie, wsXFPTempStatus=wsXFPTempStatus, wsTempMeasured=wsTempMeasured, wsSFPTable=wsSFPTable, wsFanVoltage=wsFanVoltage, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsIbosTempHigh=wsIbosTempHigh, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsPolicyTable=wsPolicyTable, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPEntry=wsXFPEntry, wsXFPTable=wsXFPTable, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPConnector=wsSFPConnector, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsTempEntry=wsTempEntry, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, ibos=ibos, wsVoltTable=wsVoltTable, wsFanEntry=wsFanEntry, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsVersion=wsVersion, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsTempStatus=wsTempStatus, wsNeighboursTable=wsNeighboursTable, wsReload=wsReload, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPSerialNumber=wsSFPSerialNumber, wsTempTable=wsTempTable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPFDP=wsPFDP, wsSFPTemp=wsSFPTemp, wsPolicyInDrops=wsPolicyInDrops, wsXFPTemp=wsXFPTemp, wsNeighbourUptime=wsNeighbourUptime, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPPartNumber=wsSFPPartNumber, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosVoltHigh=wsIbosVoltHigh, wsTempSensor=wsTempSensor, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsTempTOS=wsTempTOS, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSystem=wsSystem, wsVoltThresholdLow=wsVoltThresholdLow, wsVoltNominal=wsVoltNominal, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPVolt=wsSFPVolt, wsNeighboursEntry=wsNeighboursEntry, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTempStatus=wsSFPTempStatus, wsIbosTempLow=wsIbosTempLow, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsFanNumber=wsFanNumber, wsWritedummy=wsWritedummy, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPEncoding=wsSFPEncoding, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourState=wsNeighbourState, wsFanTable=wsFanTable, wsNeighbourPortState=wsNeighbourPortState, wsEnvironment=wsEnvironment, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPCopperLen=wsSFPCopperLen, wsVoltEntry=wsVoltEntry, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPEntry=wsSFPEntry, wsIbosVoltLow=wsIbosVoltLow, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPTXPower=wsXFPTXPower, wsAccounting=wsAccounting, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyInPkts=wsPolicyInPkts, wsXFPStatus=wsXFPStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyInBytes=wsPolicyInBytes, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsTempTHYST=wsTempTHYST, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyEntry=wsPolicyEntry, wsNeighbourLocalIf=wsNeighbourLocalIf, wsXFPRXPower=wsXFPRXPower, wsPolicyName=wsPolicyName, wsSFPRXPower=wsSFPRXPower, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVoltStatus=wsVoltStatus, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPIndex=wsSFPIndex, wsPolicyIfName=wsPolicyIfName, wsXFPConnector=wsXFPConnector, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPIndex=wsXFPIndex, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, PYSNMP_MODULE_ID=ibos, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsFanRPM=wsFanRPM, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVersionString=wsVersionString, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPStatus=wsSFPStatus, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourHostname=wsNeighbourHostname, wsSFPVoltWarningLow=wsSFPVoltWarningLow)
