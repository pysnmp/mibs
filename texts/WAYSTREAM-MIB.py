...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPVolt=wsSFPVolt, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPEncoding=wsXFPEncoding, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortState=wsNeighbourPortState, wsXFPTemp=wsXFPTemp, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsVoltNominal=wsVoltNominal, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsFanTable=wsFanTable, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempSensor=wsTempSensor, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsPFDP=wsPFDP, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyCookie=wsPolicyCookie, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPEncoding=wsSFPEncoding, wsSFPStatus=wsSFPStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTable=wsXFPTable, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPCopperLen=wsSFPCopperLen, wsWritedummy=wsWritedummy, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPPartNumber=wsSFPPartNumber, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighboursEntry=wsNeighboursEntry, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsFanRPM=wsFanRPM, wsPolicyEntry=wsPolicyEntry, wsXFPStatus=wsXFPStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPTXPower=wsXFPTXPower, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, PYSNMP_MODULE_ID=ibos, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPolicyIfName=wsPolicyIfName, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXPower=wsSFPTXPower, wsTempTHYST=wsTempTHYST, wsXFPTransceiver=wsXFPTransceiver, wsVoltEntry=wsVoltEntry, wsIbosTempLow=wsIbosTempLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsFanEntry=wsFanEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsTempTable=wsTempTable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsVersion=wsVersion, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsAccounting=wsAccounting, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyInBytes=wsPolicyInBytes, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPTempStatus=wsXFPTempStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsVoltThresholdHigh=wsVoltThresholdHigh, wsTempStatus=wsTempStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourUptime=wsNeighbourUptime, wsVersionString=wsVersionString, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPBitrateMax=wsXFPBitrateMax, wsReload=wsReload, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTempWarningLow=wsSFPTempWarningLow, wsFanNumber=wsFanNumber, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsTempThresholdLow=wsTempThresholdLow, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourCreated=wsNeighbourCreated, wsXFPBitrateMin=wsXFPBitrateMin, wsVoltMeasured=wsVoltMeasured, wsXFPIndex=wsXFPIndex, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortName=wsNeighbourPortName, wsSFPIndex=wsSFPIndex, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTransceiver=wsSFPTransceiver, wsPolicyName=wsPolicyName, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourState=wsNeighbourState, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsTempTOS=wsTempTOS, wsSFPRXPower=wsSFPRXPower, wsSystem=wsSystem, wsEnvironment=wsEnvironment, wsFanVoltage=wsFanVoltage, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsTempEntry=wsTempEntry, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTemp=wsSFPTemp, wsPolicyInDrops=wsPolicyInDrops, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsAsrRevision=wsAsrRevision, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsIbosVoltLow=wsIbosVoltLow, wsVoltTable=wsVoltTable, ibos=ibos, wsVoltChannel=wsVoltChannel, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTable=wsSFPTable, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosTempHigh=wsIbosTempHigh, wsSFPBitrate=wsSFPBitrate, wsSFPEntry=wsSFPEntry, wsXFPConnector=wsXFPConnector, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPEntry=wsXFPEntry, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighboursTable=wsNeighboursTable, wsPolicyTable=wsPolicyTable, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh)
