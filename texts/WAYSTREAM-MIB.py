...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsIbosTempHigh=wsIbosTempHigh, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPConnector=wsSFPConnector, wsTempTable=wsTempTable, wsPolicyName=wsPolicyName, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsVoltEntry=wsVoltEntry, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPPartNumber=wsSFPPartNumber, wsVersion=wsVersion, wsAsrRevision=wsAsrRevision, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourLocalIf=wsNeighbourLocalIf, wsVoltStatus=wsVoltStatus, wsFanVoltage=wsFanVoltage, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTable=wsXFPTable, wsEnvironment=wsEnvironment, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPConnector=wsXFPConnector, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPFDP=wsPFDP, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsFanNumber=wsFanNumber, wsPolicyCookie=wsPolicyCookie, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortState=wsNeighbourPortState, wsPolicyEntry=wsPolicyEntry, wsFanTable=wsFanTable, wsSFPSingleModeLen=wsSFPSingleModeLen, wsReload=wsReload, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyTable=wsPolicyTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPEntry=wsSFPEntry, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPEntry=wsXFPEntry, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyInDrops=wsPolicyInDrops, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsVoltMeasured=wsVoltMeasured, wsSFPVoltStatus=wsSFPVoltStatus, wsPolicyIfIndex=wsPolicyIfIndex, PYSNMP_MODULE_ID=ibos, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsIbosTempLow=wsIbosTempLow, wsTempTOS=wsTempTOS, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortName=wsNeighbourPortName, wsXFPStatus=wsXFPStatus, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsWritedummy=wsWritedummy, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourState=wsNeighbourState, ibos=ibos, wsSFPEncoding=wsSFPEncoding, wsVoltThresholdHigh=wsVoltThresholdHigh, wsTempEntry=wsTempEntry, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPStatus=wsSFPStatus, wsXFPIndex=wsXFPIndex, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourModel=wsNeighbourModel, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPIndex=wsSFPIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTemp=wsSFPTemp, wsTempSensor=wsTempSensor, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVoltNominal=wsVoltNominal, wsXFPTXPower=wsXFPTXPower, wsTempTHYST=wsTempTHYST, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTransceiver=wsSFPTransceiver, wsSFPVolt=wsSFPVolt, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsFanEntry=wsFanEntry, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsFanRPM=wsFanRPM, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsAccounting=wsAccounting, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTable=wsSFPTable, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXPower=wsSFPTXPower, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPBitrate=wsSFPBitrate, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourDBCount=wsNeighbourDBCount, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPEncoding=wsXFPEncoding, wsSystem=wsSystem, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPRXPower=wsXFPRXPower, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPTemp=wsXFPTemp, wsVersionString=wsVersionString, wsSFPTempNormalLow=wsSFPTempNormalLow, wsVoltTable=wsVoltTable, wsTempMeasured=wsTempMeasured, wsVoltChannel=wsVoltChannel, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsTempStatus=wsTempStatus)
