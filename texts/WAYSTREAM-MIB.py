...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsFanNumber=wsFanNumber, wsVersion=wsVersion, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPCopperLen=wsXFPCopperLen, wsPolicyInDrops=wsPolicyInDrops, wsXFPTemp=wsXFPTemp, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPBitrate=wsSFPBitrate, wsTempMeasured=wsTempMeasured, wsXFPStatus=wsXFPStatus, wsVoltEntry=wsVoltEntry, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourState=wsNeighbourState, wsSFPEntry=wsSFPEntry, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPSerialNumber=wsSFPSerialNumber, wsFanRPM=wsFanRPM, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPEncoding=wsSFPEncoding, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortsTable=wsNeighbourPortsTable, PYSNMP_MODULE_ID=ibos, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsFanTable=wsFanTable, wsVoltChannel=wsVoltChannel, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPTXPower=wsXFPTXPower, wsSystem=wsSystem, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyInBytes=wsPolicyInBytes, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTempNormalLow=wsSFPTempNormalLow, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourSNPA=wsNeighbourSNPA, wsVoltStatus=wsVoltStatus, wsSFPTempStatus=wsSFPTempStatus, wsEnvironment=wsEnvironment, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, ibos=ibos, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPConnector=wsXFPConnector, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyIfName=wsPolicyIfName, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsReload=wsReload, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTable=wsXFPTable, wsSFPVolt=wsSFPVolt, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourCreated=wsNeighbourCreated, wsSFPVoltStatus=wsSFPVoltStatus, wsPolicyName=wsPolicyName, wsSFPPartNumber=wsSFPPartNumber, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighboursTable=wsNeighboursTable, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPFDP=wsPFDP, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsTempTable=wsTempTable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsFanVoltage=wsFanVoltage, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsAsrRevision=wsAsrRevision, wsVoltNominal=wsVoltNominal, wsPolicyIfIndex=wsPolicyIfIndex, wsTempThresholdLow=wsTempThresholdLow, wsWritedummy=wsWritedummy, wsNeighboursEntry=wsNeighboursEntry, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPStatus=wsSFPStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsVersionString=wsVersionString, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPRXPower=wsSFPRXPower, wsTempTOS=wsTempTOS, wsSFPTable=wsSFPTable, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPEncoding=wsXFPEncoding, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyEntry=wsPolicyEntry, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyTable=wsPolicyTable, wsIbosTempLow=wsIbosTempLow, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempEntry=wsTempEntry, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsTempSensor=wsTempSensor, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPEntry=wsXFPEntry, wsAccounting=wsAccounting, wsPolicyCookie=wsPolicyCookie, wsSFPConnector=wsSFPConnector, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVoltMeasured=wsVoltMeasured, wsTempStatus=wsTempStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPIndex=wsSFPIndex, wsPolicyInPkts=wsPolicyInPkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTransceiver=wsSFPTransceiver, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsFanEntry=wsFanEntry, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPSingleModeLen=wsXFPSingleModeLen, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourHostname=wsNeighbourHostname, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTemp=wsSFPTemp, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsVoltTable=wsVoltTable, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPIndex=wsXFPIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyOutPkts=wsPolicyOutPkts)
