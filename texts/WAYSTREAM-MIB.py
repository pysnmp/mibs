...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPTemp=wsXFPTemp, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPEntry=wsSFPEntry, wsTempEntry=wsTempEntry, wsIbosVoltLow=wsIbosVoltLow, wsTempTHYST=wsTempTHYST, wsIbosTempLow=wsIbosTempLow, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTable=wsSFPTable, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourHostname=wsNeighbourHostname, wsVoltNominal=wsVoltNominal, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPPartNumber=wsSFPPartNumber, wsVersion=wsVersion, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTable=wsXFPTable, wsSFPTransceiverExt=wsSFPTransceiverExt, wsIbosFanRPMLow=wsIbosFanRPMLow, wsFanNumber=wsFanNumber, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourIfIndex=wsNeighbourIfIndex, wsTempTable=wsTempTable, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXPower=wsSFPTXPower, wsVoltEntry=wsVoltEntry, wsPFDP=wsPFDP, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVersionString=wsVersionString, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsTempThresholdLow=wsTempThresholdLow, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPConnector=wsXFPConnector, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTXCurrent=wsXFPTXCurrent, wsPolicyOutPkts=wsPolicyOutPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsAsrRevision=wsAsrRevision, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPVolt=wsSFPVolt, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsVoltChannel=wsVoltChannel, wsXFPTempStatus=wsXFPTempStatus, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPStatus=wsXFPStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortState=wsNeighbourPortState, wsVoltMeasured=wsVoltMeasured, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, PYSNMP_MODULE_ID=ibos, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPIndex=wsSFPIndex, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsFanTable=wsFanTable, wsSFPRXPower=wsSFPRXPower, wsPolicyIfName=wsPolicyIfName, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPTXPower=wsXFPTXPower, wsPolicyUsedCnt=wsPolicyUsedCnt, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPRXPower=wsXFPRXPower, wsTempMeasured=wsTempMeasured, wsNeighbourState=wsNeighbourState, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsVoltStatus=wsVoltStatus, wsSFPTransceiver=wsSFPTransceiver, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPEncoding=wsSFPEncoding, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, ibos=ibos, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsTempTOS=wsTempTOS, wsReload=wsReload, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyName=wsPolicyName, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsTempSensor=wsTempSensor, wsPolicyTable=wsPolicyTable, wsPolicyEntry=wsPolicyEntry, wsSystem=wsSystem, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighboursTable=wsNeighboursTable, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsAccounting=wsAccounting, wsSFPBitrate=wsSFPBitrate, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsFanEntry=wsFanEntry, wsXFPEncoding=wsXFPEncoding, wsFanRPM=wsFanRPM, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTemp=wsSFPTemp, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourCreated=wsNeighbourCreated, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsPolicyInDrops=wsPolicyInDrops, wsSFPStatus=wsSFPStatus, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPCopperLen=wsSFPCopperLen, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsVoltTable=wsVoltTable, wsNeighbourUptime=wsNeighbourUptime, wsXFPEntry=wsXFPEntry, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTempStatus=wsSFPTempStatus, wsWritedummy=wsWritedummy, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsTempStatus=wsTempStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPConnector=wsSFPConnector, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsEnvironment=wsEnvironment, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsFanVoltage=wsFanVoltage, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyOutDrops=wsPolicyOutDrops)
