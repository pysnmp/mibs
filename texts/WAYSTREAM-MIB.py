...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTransceiver=wsSFPTransceiver, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPRXPower=wsXFPRXPower, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsVoltEntry=wsVoltEntry, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourIfIndex=wsNeighbourIfIndex, wsTempTOS=wsTempTOS, wsVersion=wsVersion, wsSFPTXCurrent=wsSFPTXCurrent, wsAsrRevision=wsAsrRevision, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPTransceiver=wsXFPTransceiver, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourState=wsNeighbourState, wsPolicyEntry=wsPolicyEntry, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsFanRPM=wsFanRPM, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourLocalIf=wsNeighbourLocalIf, PYSNMP_MODULE_ID=ibos, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPFDP=wsPFDP, wsSFPTemp=wsSFPTemp, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPCopperLen=wsSFPCopperLen, wsSFPPartNumber=wsSFPPartNumber, wsXFPIndex=wsXFPIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsTempSensor=wsTempSensor, wsSystem=wsSystem, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourDBCount=wsNeighbourDBCount, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPMultiMode50Len=wsXFPMultiMode50Len, ibos=ibos, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighboursTable=wsNeighboursTable, wsSFPBitrate=wsSFPBitrate, wsSFPTXPower=wsSFPTXPower, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPEntry=wsXFPEntry, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTable=wsSFPTable, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPIndex=wsSFPIndex, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVoltChannel=wsVoltChannel, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsFanNumber=wsFanNumber, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPTempStatus=wsXFPTempStatus, wsVoltStatus=wsVoltStatus, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPConnector=wsSFPConnector, wsXFPTable=wsXFPTable, wsXFPTXPower=wsXFPTXPower, wsPolicyTable=wsPolicyTable, wsVoltNominal=wsVoltNominal, wsSFPStatus=wsSFPStatus, wsFanVoltage=wsFanVoltage, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyInDrops=wsPolicyInDrops, wsXFPCopperLen=wsXFPCopperLen, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsFanTable=wsFanTable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTempStatus=wsSFPTempStatus, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPolicyName=wsPolicyName, wsIbosTempHigh=wsIbosTempHigh, wsReload=wsReload, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighboursEntry=wsNeighboursEntry, wsFanEntry=wsFanEntry, wsXFPStatus=wsXFPStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsAccounting=wsAccounting, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempTHYST=wsTempTHYST, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourModel=wsNeighbourModel, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsTempStatus=wsTempStatus, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyUsedCnt=wsPolicyUsedCnt, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVoltTable=wsVoltTable, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPVoltStatus=wsSFPVoltStatus, wsTempTable=wsTempTable, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXPower=wsSFPRXPower, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsTempThresholdLow=wsTempThresholdLow, wsEnvironment=wsEnvironment, wsVersionString=wsVersionString, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsWritedummy=wsWritedummy, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPVolt=wsSFPVolt, wsSFPTempNormalLow=wsSFPTempNormalLow, wsPolicyIfName=wsPolicyIfName, wsXFPTemp=wsXFPTemp, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsTempMeasured=wsTempMeasured, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPEncoding=wsSFPEncoding, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPEntry=wsSFPEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempEntry=wsTempEntry, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourUptime=wsNeighbourUptime)
