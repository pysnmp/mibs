...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortState=wsNeighbourPortState, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPMultiMode50Len=wsSFPMultiMode50Len, PYSNMP_MODULE_ID=ibos, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPEncoding=wsXFPEncoding, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyEntry=wsPolicyEntry, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsEnvironment=wsEnvironment, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPConnector=wsSFPConnector, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPTempStatus=wsXFPTempStatus, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsFanRPM=wsFanRPM, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsVoltTable=wsVoltTable, wsAsrRevision=wsAsrRevision, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsIbosVoltLow=wsIbosVoltLow, wsVoltNominal=wsVoltNominal, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsVersionString=wsVersionString, wsPolicyTable=wsPolicyTable, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPRXPower=wsSFPRXPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPCopperLen=wsXFPCopperLen, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPConnector=wsXFPConnector, wsTempTHYST=wsTempTHYST, wsPolicyInDrops=wsPolicyInDrops, wsSFPTransceiver=wsSFPTransceiver, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsAccounting=wsAccounting, wsVoltChannel=wsVoltChannel, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPTable=wsXFPTable, wsNeighbourPortName=wsNeighbourPortName, ibos=ibos, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTable=wsSFPTable, wsXFPSingleModeLen=wsXFPSingleModeLen, wsIbosVoltHigh=wsIbosVoltHigh, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPCopperLen=wsSFPCopperLen, wsPolicyIfIndex=wsPolicyIfIndex, wsFanEntry=wsFanEntry, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPStatus=wsSFPStatus, wsPolicyCookie=wsPolicyCookie, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyUsedCnt=wsPolicyUsedCnt, wsTempEntry=wsTempEntry, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyName=wsPolicyName, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsFanTable=wsFanTable, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsWritedummy=wsWritedummy, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsTempSensor=wsTempSensor, wsPFDP=wsPFDP, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsFanVoltage=wsFanVoltage, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVoltStatus=wsVoltStatus, wsSFPTemp=wsSFPTemp, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsFanNumber=wsFanNumber, wsTempStatus=wsTempStatus, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourModel=wsNeighbourModel, wsSFPEncoding=wsSFPEncoding, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsReload=wsReload, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyIfName=wsPolicyIfName, wsXFPTXPower=wsXFPTXPower, wsIbosTempLow=wsIbosTempLow, wsSFPBitrate=wsSFPBitrate, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPEntry=wsXFPEntry, wsXFPIndex=wsXFPIndex, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourState=wsNeighbourState, wsSystem=wsSystem, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsTempThresholdLow=wsTempThresholdLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsVersion=wsVersion, wsSFPIndex=wsSFPIndex, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyInBytes=wsPolicyInBytes, wsNeighboursTable=wsNeighboursTable, wsSFPVolt=wsSFPVolt, wsIbosTempHigh=wsIbosTempHigh, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPRXPower=wsXFPRXPower, wsTempTOS=wsTempTOS, wsTempTable=wsTempTable, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsVoltEntry=wsVoltEntry, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPEntry=wsSFPEntry)
