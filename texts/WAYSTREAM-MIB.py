...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPTXCurrent=wsXFPTXCurrent, wsTempEntry=wsTempEntry, wsXFPBitrateMin=wsXFPBitrateMin, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSystem=wsSystem, wsVersion=wsVersion, wsReload=wsReload, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsTempSensor=wsTempSensor, wsTempMeasured=wsTempMeasured, wsPolicyName=wsPolicyName, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsIbosTempHigh=wsIbosTempHigh, wsVersionString=wsVersionString, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsVoltMeasured=wsVoltMeasured, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPCopperLen=wsXFPCopperLen, wsAccounting=wsAccounting, wsTempTHYST=wsTempTHYST, wsSFPPartNumber=wsSFPPartNumber, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsVoltTable=wsVoltTable, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsIbosTempLow=wsIbosTempLow, wsAsrRevision=wsAsrRevision, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighboursEntry=wsNeighboursEntry, wsSFPIndex=wsSFPIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPEntry=wsSFPEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPStatus=wsSFPStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsVoltChannel=wsVoltChannel, wsSFPTempNormalLow=wsSFPTempNormalLow, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPBitrate=wsSFPBitrate, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsEnvironment=wsEnvironment, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyInDrops=wsPolicyInDrops, wsXFPRXPower=wsXFPRXPower, wsTempThresholdLow=wsTempThresholdLow, wsFanEntry=wsFanEntry, wsSFPConnector=wsSFPConnector, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTable=wsSFPTable, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPTable=wsXFPTable, wsFanNumber=wsFanNumber, wsTempTOS=wsTempTOS, wsVoltStatus=wsVoltStatus, wsSFPTemp=wsSFPTemp, wsPolicyInPkts=wsPolicyInPkts, ibos=ibos, wsXFPTransceiver=wsXFPTransceiver, wsTempStatus=wsTempStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyInBytes=wsPolicyInBytes, wsSFPEncoding=wsSFPEncoding, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPEntry=wsXFPEntry, wsNeighbourDBCount=wsNeighbourDBCount, PYSNMP_MODULE_ID=ibos, wsNeighboursTable=wsNeighboursTable, wsNeighbourHostname=wsNeighbourHostname, wsIbosVoltHigh=wsIbosVoltHigh, wsPolicyTable=wsPolicyTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortState=wsNeighbourPortState, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourOSVersion=wsNeighbourOSVersion, wsPolicyCookie=wsPolicyCookie, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsVoltNominal=wsVoltNominal, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPConnector=wsXFPConnector, wsFanVoltage=wsFanVoltage, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPFDP=wsPFDP, wsXFPIndex=wsXFPIndex, wsSFPVolt=wsSFPVolt, wsFanTable=wsFanTable, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourModel=wsNeighbourModel, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsWritedummy=wsWritedummy, wsPolicyEntry=wsPolicyEntry, wsXFPTemp=wsXFPTemp, wsNeighbourState=wsNeighbourState, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPTempStatus=wsXFPTempStatus, wsTempTable=wsTempTable, wsFanRPM=wsFanRPM, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPStatus=wsXFPStatus, wsXFPTXPower=wsXFPTXPower, wsSFPRXPower=wsSFPRXPower, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourUptime=wsNeighbourUptime)
