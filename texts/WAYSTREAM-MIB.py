...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPEntry=wsSFPEntry, wsXFPStatus=wsXFPStatus, wsVoltTable=wsVoltTable, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsVoltEntry=wsVoltEntry, wsXFPTable=wsXFPTable, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsAccounting=wsAccounting, wsTempTHYST=wsTempTHYST, wsTempMeasured=wsTempMeasured, wsNeighbourPortName=wsNeighbourPortName, wsSFPStatus=wsSFPStatus, wsVersion=wsVersion, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPRXPower=wsSFPRXPower, wsFanVoltage=wsFanVoltage, wsNeighbourHostname=wsNeighbourHostname, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyEntry=wsPolicyEntry, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPEntry=wsXFPEntry, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourOSVersion=wsNeighbourOSVersion, wsPolicyName=wsPolicyName, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPTempStatus=wsXFPTempStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsVoltMeasured=wsVoltMeasured, wsFanNumber=wsFanNumber, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsTempTOS=wsTempTOS, wsNeighbourModel=wsNeighbourModel, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTemp=wsSFPTemp, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsIbosTempLow=wsIbosTempLow, PYSNMP_MODULE_ID=ibos, wsTempSensor=wsTempSensor, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTempStatus=wsSFPTempStatus, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPBitrate=wsSFPBitrate, wsSFPIndex=wsSFPIndex, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPConnector=wsXFPConnector, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPBitrateMax=wsXFPBitrateMax, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPIndex=wsXFPIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourState=wsNeighbourState, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPConnector=wsSFPConnector, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsPolicyOutPkts=wsPolicyOutPkts, wsTempStatus=wsTempStatus, wsEnvironment=wsEnvironment, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempEntry=wsTempEntry, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, ibos=ibos, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsReload=wsReload, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyIfIndex=wsPolicyIfIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPEncoding=wsXFPEncoding, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsVersionString=wsVersionString, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyOutBytes=wsPolicyOutBytes, wsFanEntry=wsFanEntry, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsFanRPM=wsFanRPM, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyIfName=wsPolicyIfName, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempThresholdHigh=wsTempThresholdHigh, wsAsrRevision=wsAsrRevision, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXPower=wsSFPTXPower, wsXFPCopperLen=wsXFPCopperLen, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsTempTable=wsTempTable, wsWritedummy=wsWritedummy, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyInPkts=wsPolicyInPkts, wsPolicyInDrops=wsPolicyInDrops, wsXFPTXPower=wsXFPTXPower, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsIbosTempHigh=wsIbosTempHigh, wsPolicyTable=wsPolicyTable, wsSFPTable=wsSFPTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsVoltStatus=wsVoltStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyCookie=wsPolicyCookie, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourUptime=wsNeighbourUptime, wsVoltChannel=wsVoltChannel, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPTemp=wsXFPTemp, wsVoltNominal=wsVoltNominal, wsFanTable=wsFanTable, wsPFDP=wsPFDP, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSystem=wsSystem)
