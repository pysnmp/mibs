...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPFDP=wsPFDP, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsPolicyOutDrops=wsPolicyOutDrops, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortsTable=wsNeighbourPortsTable, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsTempMeasured=wsTempMeasured, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyName=wsPolicyName, wsIbosTempHigh=wsIbosTempHigh, wsTempTable=wsTempTable, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortName=wsNeighbourPortName, wsSFPBitrate=wsSFPBitrate, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsIbosTempLow=wsIbosTempLow, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourModel=wsNeighbourModel, wsXFPRXPower=wsXFPRXPower, wsXFPIndex=wsXFPIndex, wsNeighboursTable=wsNeighboursTable, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPCopperLen=wsSFPCopperLen, wsReload=wsReload, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPEncoding=wsSFPEncoding, wsVoltChannel=wsVoltChannel, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPStatus=wsXFPStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsAccounting=wsAccounting, wsVersionString=wsVersionString, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsFanVoltage=wsFanVoltage, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsVoltStatus=wsVoltStatus, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTransceiver=wsSFPTransceiver, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsTempStatus=wsTempStatus, wsAsrRevision=wsAsrRevision, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVersion=wsVersion, wsFanEntry=wsFanEntry, wsTempSensor=wsTempSensor, wsSFPEntry=wsSFPEntry, wsPolicyTable=wsPolicyTable, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTemp=wsSFPTemp, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTable=wsSFPTable, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourUptime=wsNeighbourUptime, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyEntry=wsPolicyEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsTempEntry=wsTempEntry, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempTHYST=wsTempTHYST, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPEntry=wsXFPEntry, wsPolicyInDrops=wsPolicyInDrops, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPStatus=wsSFPStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortState=wsNeighbourPortState, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSystem=wsSystem, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPTempStatus=wsXFPTempStatus, wsPolicyInBytes=wsPolicyInBytes, wsSFPTXdBmPower=wsSFPTXdBmPower, wsFanTable=wsFanTable, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsEnvironment=wsEnvironment, wsFanNumber=wsFanNumber, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyInPkts=wsPolicyInPkts, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourCreated=wsNeighbourCreated, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPConnector=wsXFPConnector, wsIbosVoltLow=wsIbosVoltLow, wsXFPBitrateMin=wsXFPBitrateMin, wsTempTOS=wsTempTOS, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, ibos=ibos, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourHostname=wsNeighbourHostname, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourState=wsNeighbourState, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPTable=wsXFPTable, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsWritedummy=wsWritedummy, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPVolt=wsSFPVolt, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, PYSNMP_MODULE_ID=ibos, wsVoltNominal=wsVoltNominal, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPConnector=wsSFPConnector, wsSFPRXPower=wsSFPRXPower, wsPolicyIfName=wsPolicyIfName, wsSFPPartNumber=wsSFPPartNumber, wsVoltTable=wsVoltTable, wsNeighbourDBCount=wsNeighbourDBCount, wsFanRPM=wsFanRPM, wsSFPIndex=wsSFPIndex)
