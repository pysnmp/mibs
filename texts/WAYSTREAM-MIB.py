...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyName=wsPolicyName, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPRXPower=wsXFPRXPower, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyEntry=wsPolicyEntry, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsVoltTable=wsVoltTable, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsFanEntry=wsFanEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTemp=wsSFPTemp, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyTable=wsPolicyTable, wsNeighboursEntry=wsNeighboursEntry, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPStatus=wsSFPStatus, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPStatus=wsXFPStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortState=wsNeighbourPortState, wsAccounting=wsAccounting, wsXFPSingleModeLen=wsXFPSingleModeLen, wsFanRPM=wsFanRPM, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsFanTable=wsFanTable, wsTempTable=wsTempTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPRXPower=wsSFPRXPower, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourCreated=wsNeighbourCreated, wsTempSensor=wsTempSensor, wsNeighbourPortName=wsNeighbourPortName, wsSFPConnector=wsSFPConnector, wsSFPBitrate=wsSFPBitrate, wsTempEntry=wsTempEntry, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsVoltChannel=wsVoltChannel, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPTable=wsXFPTable, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSystem=wsSystem, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPPartNumber=wsSFPPartNumber, wsVersionString=wsVersionString, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPIndex=wsXFPIndex, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighboursTable=wsNeighboursTable, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyCookie=wsPolicyCookie, wsSFPSerialNumber=wsSFPSerialNumber, wsEnvironment=wsEnvironment, wsNeighbourPortsTable=wsNeighbourPortsTable, ibos=ibos, wsPolicyInPkts=wsPolicyInPkts, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPTempStatus=wsXFPTempStatus, wsVoltEntry=wsVoltEntry, wsFanVoltage=wsFanVoltage, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTXPower=wsXFPTXPower, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsIbosTempLow=wsIbosTempLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPCopperLen=wsSFPCopperLen, wsPFDP=wsPFDP, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsTempStatus=wsTempStatus, wsIbosTempHigh=wsIbosTempHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPEncoding=wsXFPEncoding, wsVoltMeasured=wsVoltMeasured, wsNeighbourDBCount=wsNeighbourDBCount, wsIbosFanRPMLow=wsIbosFanRPMLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPCopperLen=wsXFPCopperLen, wsVoltStatus=wsVoltStatus, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyInBytes=wsPolicyInBytes, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTable=wsSFPTable, wsNeighbourHostname=wsNeighbourHostname, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPEntry=wsXFPEntry, wsSFPVolt=wsSFPVolt, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsTempMeasured=wsTempMeasured, wsTempTOS=wsTempTOS, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsTempTHYST=wsTempTHYST, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPTemp=wsXFPTemp, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPEncoding=wsSFPEncoding, wsWritedummy=wsWritedummy, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXPower=wsSFPTXPower, wsPolicyOutDrops=wsPolicyOutDrops, wsIbosVoltHigh=wsIbosVoltHigh, wsFanNumber=wsFanNumber, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVersion=wsVersion, PYSNMP_MODULE_ID=ibos, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPEntry=wsSFPEntry, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsVoltNominal=wsVoltNominal, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourState=wsNeighbourState, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPIndex=wsSFPIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsReload=wsReload, wsXFPConnector=wsXFPConnector, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts)
