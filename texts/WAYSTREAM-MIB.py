...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPEncoding=wsXFPEncoding, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPTXCurrent=wsXFPTXCurrent, wsVoltChannel=wsVoltChannel, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPEntry=wsXFPEntry, wsNeighboursEntry=wsNeighboursEntry, wsSFPTempNormalLow=wsSFPTempNormalLow, wsIbosTempLow=wsIbosTempLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPCopperLen=wsXFPCopperLen, wsFanTable=wsFanTable, wsPolicyName=wsPolicyName, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPStatus=wsXFPStatus, wsTempTOS=wsTempTOS, wsSFPPartNumber=wsSFPPartNumber, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourState=wsNeighbourState, wsPolicyCookie=wsPolicyCookie, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVersion=wsVersion, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyInDrops=wsPolicyInDrops, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTable=wsSFPTable, wsTempMeasured=wsTempMeasured, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVoltTable=wsVoltTable, wsSFPTransceiver=wsSFPTransceiver, wsXFPTable=wsXFPTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsPolicyInPkts=wsPolicyInPkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsPolicyTable=wsPolicyTable, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPBitrateMin=wsXFPBitrateMin, wsIbosVoltLow=wsIbosVoltLow, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPIndex=wsXFPIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsTempTable=wsTempTable, wsXFPTempStatus=wsXFPTempStatus, wsPolicyEntry=wsPolicyEntry, wsVoltStatus=wsVoltStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourHostname=wsNeighbourHostname, wsSFPBitrate=wsSFPBitrate, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsVoltEntry=wsVoltEntry, wsIbosTempHigh=wsIbosTempHigh, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsVersionString=wsVersionString, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourDBCount=wsNeighbourDBCount, wsVoltNominal=wsVoltNominal, wsSFPCopperLen=wsSFPCopperLen, wsAccounting=wsAccounting, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPConnector=wsXFPConnector, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsPolicyIfName=wsPolicyIfName, wsTempStatus=wsTempStatus, PYSNMP_MODULE_ID=ibos, wsSFPStatus=wsSFPStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsWritedummy=wsWritedummy, wsSystem=wsSystem, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsTempSensor=wsTempSensor, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourNIndex=wsNeighbourNIndex, wsPFDP=wsPFDP, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsEnvironment=wsEnvironment, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, ibos=ibos, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltMeasured=wsVoltMeasured, wsFanRPM=wsFanRPM, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXPower=wsSFPTXPower, wsXFPBitrateMax=wsXFPBitrateMax, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPTransceiver=wsXFPTransceiver, wsSFPIndex=wsSFPIndex, wsTempEntry=wsTempEntry, wsNeighbourModel=wsNeighbourModel, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPEntry=wsSFPEntry, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsAsrRevision=wsAsrRevision, wsFanEntry=wsFanEntry, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTemp=wsSFPTemp, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPTemp=wsXFPTemp, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsTempTHYST=wsTempTHYST, wsNeighbourPortName=wsNeighbourPortName, wsFanNumber=wsFanNumber, wsReload=wsReload, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPVolt=wsSFPVolt, wsNeighboursTable=wsNeighboursTable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets)
