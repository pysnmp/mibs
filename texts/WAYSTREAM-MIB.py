...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempTOS=wsTempTOS, wsTempEntry=wsTempEntry, wsSFPPartNumber=wsSFPPartNumber, wsXFPTable=wsXFPTable, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPEntry=wsSFPEntry, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsIbosVoltHigh=wsIbosVoltHigh, PYSNMP_MODULE_ID=ibos, wsXFPBitrateMax=wsXFPBitrateMax, wsTempStatus=wsTempStatus, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsEnvironment=wsEnvironment, wsPolicyCookie=wsPolicyCookie, wsNeighbourModel=wsNeighbourModel, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsFanRPM=wsFanRPM, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsVoltEntry=wsVoltEntry, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsFanTable=wsFanTable, wsWritedummy=wsWritedummy, wsXFPIndex=wsXFPIndex, wsFanEntry=wsFanEntry, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsFanNumber=wsFanNumber, wsXFPTXPower=wsXFPTXPower, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourCreated=wsNeighbourCreated, wsSFPStatus=wsSFPStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsReload=wsReload, wsTempMeasured=wsTempMeasured, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempThresholdLow=wsTempThresholdLow, wsVoltStatus=wsVoltStatus, wsTempSensor=wsTempSensor, wsXFPStatus=wsXFPStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXCurrent=wsSFPTXCurrent, wsVersionString=wsVersionString, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourState=wsNeighbourState, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPSingleModeLen=wsSFPSingleModeLen, wsPolicyTable=wsPolicyTable, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTXPower=wsSFPTXPower, wsVersion=wsVersion, wsXFPTemp=wsXFPTemp, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyInPkts=wsPolicyInPkts, wsPolicyOutBytes=wsPolicyOutBytes, wsSystem=wsSystem, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsPolicyName=wsPolicyName, wsVoltChannel=wsVoltChannel, wsNeighbourPortState=wsNeighbourPortState, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPConnector=wsXFPConnector, wsSFPConnector=wsSFPConnector, wsSFPTable=wsSFPTable, wsAccounting=wsAccounting, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsFanVoltage=wsFanVoltage, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsTempTable=wsTempTable, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsPolicyEntry=wsPolicyEntry, wsPolicyInBytes=wsPolicyInBytes, wsSFPBitrate=wsSFPBitrate, wsAsrRevision=wsAsrRevision, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPFDP=wsPFDP, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTemp=wsSFPTemp, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPIndex=wsSFPIndex, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPTransceiver=wsXFPTransceiver, wsXFPEncoding=wsXFPEncoding, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXdBmPower=wsSFPTXdBmPower, wsVoltTable=wsVoltTable, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPolicyIfIndex=wsPolicyIfIndex, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourHostname=wsNeighbourHostname, ibos=ibos, wsIbosTempLow=wsIbosTempLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPEntry=wsXFPEntry, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVoltNominal=wsVoltNominal, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPCopperLen=wsSFPCopperLen, wsNeighboursEntry=wsNeighboursEntry, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighboursTable=wsNeighboursTable, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsTempTHYST=wsTempTHYST, wsPolicyOutDrops=wsPolicyOutDrops, wsPolicyInDrops=wsPolicyInDrops, wsSFPEncoding=wsSFPEncoding)
