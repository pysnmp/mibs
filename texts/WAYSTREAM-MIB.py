...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyName=wsPolicyName, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPTempStatus=wsXFPTempStatus, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyOutDrops=wsPolicyOutDrops, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourUptime=wsNeighbourUptime, wsSFPVolt=wsSFPVolt, wsXFPStatus=wsXFPStatus, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTempWarningLow=wsSFPTempWarningLow, wsWritedummy=wsWritedummy, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPConnector=wsXFPConnector, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsPolicyInPkts=wsPolicyInPkts, wsTempTOS=wsTempTOS, wsReload=wsReload, wsFanTable=wsFanTable, wsTempSensor=wsTempSensor, wsFanVoltage=wsFanVoltage, wsXFPEntry=wsXFPEntry, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPEntry=wsSFPEntry, wsSFPPartNumber=wsSFPPartNumber, wsVersion=wsVersion, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVoltTable=wsVoltTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempTable=wsTempTable, wsSystem=wsSystem, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourHostname=wsNeighbourHostname, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortName=wsNeighbourPortName, wsXFPBitrateMax=wsXFPBitrateMax, wsTempEntry=wsTempEntry, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTransceiver=wsSFPTransceiver, wsIbosVoltLow=wsIbosVoltLow, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPCopperLen=wsSFPCopperLen, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPTemp=wsXFPTemp, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTable=wsSFPTable, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyTable=wsPolicyTable, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsFanNumber=wsFanNumber, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPTXPower=wsXFPTXPower, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPStatus=wsSFPStatus, wsXFPTable=wsXFPTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPRXPower=wsXFPRXPower, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPIndex=wsSFPIndex, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPBitrate=wsSFPBitrate, wsXFPIndex=wsXFPIndex, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXPower=wsSFPRXPower, wsNeighbourModel=wsNeighbourModel, wsTempMeasured=wsTempMeasured, wsXFPCopperLen=wsXFPCopperLen, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVoltEntry=wsVoltEntry, wsVoltStatus=wsVoltStatus, wsEnvironment=wsEnvironment, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, ibos=ibos, wsFanRPM=wsFanRPM, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, PYSNMP_MODULE_ID=ibos, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTempStatus=wsSFPTempStatus, wsIbosTempLow=wsIbosTempLow, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTemp=wsSFPTemp, wsFanEntry=wsFanEntry, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourDBCount=wsNeighbourDBCount, wsAsrRevision=wsAsrRevision, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsVoltChannel=wsVoltChannel, wsSFPEncoding=wsSFPEncoding, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVersionString=wsVersionString, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourState=wsNeighbourState, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXPower=wsSFPTXPower, wsVoltMeasured=wsVoltMeasured, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsPFDP=wsPFDP, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsAccounting=wsAccounting, wsNeighboursTable=wsNeighboursTable, wsPolicyCookie=wsPolicyCookie, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPConnector=wsSFPConnector, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsVoltNominal=wsVoltNominal, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyIfName=wsPolicyIfName, wsTempStatus=wsTempStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex)
