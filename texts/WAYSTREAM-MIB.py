...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSystem=wsSystem, wsXFPStatus=wsXFPStatus, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPCopperLen=wsXFPCopperLen, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourModel=wsNeighbourModel, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourCreated=wsNeighbourCreated, wsPFDP=wsPFDP, wsSFPTXPower=wsSFPTXPower, wsTempSensor=wsTempSensor, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsTempStatus=wsTempStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPIndex=wsXFPIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsTempTable=wsTempTable, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPConnector=wsSFPConnector, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsVoltNominal=wsVoltNominal, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyEntry=wsPolicyEntry, wsFanEntry=wsFanEntry, wsNeighboursTable=wsNeighboursTable, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyIfName=wsPolicyIfName, wsSFPTXdBmPower=wsSFPTXdBmPower, wsFanNumber=wsFanNumber, wsNeighbourState=wsNeighbourState, wsWritedummy=wsWritedummy, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPVoltStatus=wsSFPVoltStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPRXPower=wsXFPRXPower, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPEntry=wsXFPEntry, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVoltStatus=wsVoltStatus, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempTHYST=wsTempTHYST, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPEncoding=wsXFPEncoding, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPConnector=wsXFPConnector, wsVoltChannel=wsVoltChannel, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourLastAct=wsNeighbourLastAct, wsPolicyIfIndex=wsPolicyIfIndex, wsAsrRevision=wsAsrRevision, wsPolicyTable=wsPolicyTable, wsFanRPM=wsFanRPM, wsPolicyName=wsPolicyName, wsVersionString=wsVersionString, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsFanVoltage=wsFanVoltage, wsAccounting=wsAccounting, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsVoltTable=wsVoltTable, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsReload=wsReload, wsSFPTable=wsSFPTable, wsTempEntry=wsTempEntry, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPBitrate=wsSFPBitrate, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyCookie=wsPolicyCookie, wsXFPBitrateMin=wsXFPBitrateMin, PYSNMP_MODULE_ID=ibos, wsPolicyInPkts=wsPolicyInPkts, wsSFPCopperLen=wsSFPCopperLen, wsSFPStatus=wsSFPStatus, wsXFPTable=wsXFPTable, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsIbosTempLow=wsIbosTempLow, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourUptime=wsNeighbourUptime, wsFanTable=wsFanTable, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyInBytes=wsPolicyInBytes, wsXFPTXPower=wsXFPTXPower, wsNeighboursEntry=wsNeighboursEntry, wsSFPTransceiver=wsSFPTransceiver, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsIbosVoltLow=wsIbosVoltLow, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortState=wsNeighbourPortState, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTemp=wsSFPTemp, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPTempStatus=wsXFPTempStatus, wsPolicyInDrops=wsPolicyInDrops, wsSFPEntry=wsSFPEntry, wsXFPTXCurrent=wsXFPTXCurrent, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortName=wsNeighbourPortName, wsSFPIndex=wsSFPIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPSingleModeLen=wsSFPSingleModeLen, wsEnvironment=wsEnvironment, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsTempTOS=wsTempTOS, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, ibos=ibos, wsVersion=wsVersion)
