...
NotificationType, Counter64, ObjectIdentity, Counter32, TimeTicks, Gauge32, iso, Bits, Integer32, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "ObjectIdentity", "Counter32", "TimeTicks", "Gauge32", "iso", "Bits", "Integer32", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPTransceiver=wsXFPTransceiver, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsAccounting=wsAccounting, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsTempEntry=wsTempEntry, wsSFPIndex=wsSFPIndex, wsFanVoltage=wsFanVoltage, wsNeighboursTable=wsNeighboursTable, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsTempThresholdLow=wsTempThresholdLow, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsWritedummy=wsWritedummy, wsNeighbourState=wsNeighbourState, wsIbosTempHigh=wsIbosTempHigh, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsVoltEntry=wsVoltEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPIndex=wsXFPIndex, wsXFPRXPower=wsXFPRXPower, wsTempMeasured=wsTempMeasured, wsPolicyInPkts=wsPolicyInPkts, wsEnvironment=wsEnvironment, wsVersion=wsVersion, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsTempTOS=wsTempTOS, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPConnector=wsSFPConnector, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPVolt=wsSFPVolt, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyTable=wsPolicyTable, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourCreated=wsNeighbourCreated, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTempStatus=wsXFPTempStatus, wsSFPBitrate=wsSFPBitrate, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSystem=wsSystem, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsFanEntry=wsFanEntry, wsSFPTemp=wsSFPTemp, wsIbosVoltHigh=wsIbosVoltHigh, wsFanRPM=wsFanRPM, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPEncoding=wsSFPEncoding, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPConnector=wsXFPConnector, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsFanNumber=wsFanNumber, wsNeighbourSNPA=wsNeighbourSNPA, ibos=ibos, wsTempStatus=wsTempStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyEntry=wsPolicyEntry, wsXFPTXPower=wsXFPTXPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXPower=wsSFPRXPower, wsFanTable=wsFanTable, wsSFPTransceiver=wsSFPTransceiver, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPStatus=wsSFPStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPEntry=wsSFPEntry, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsVersionString=wsVersionString, wsPolicyOutPkts=wsPolicyOutPkts, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyName=wsPolicyName, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsTempTHYST=wsTempTHYST, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyUsedCnt=wsPolicyUsedCnt, wsVoltMeasured=wsVoltMeasured, wsPolicyCookie=wsPolicyCookie, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsTempSensor=wsTempSensor, wsTempTable=wsTempTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPCopperLen=wsSFPCopperLen, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPEntry=wsXFPEntry, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsXFPTXCurrent=wsXFPTXCurrent, wsVoltChannel=wsVoltChannel, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPCopperLen=wsXFPCopperLen, wsIbosVoltLow=wsIbosVoltLow, PYSNMP_MODULE_ID=ibos, wsSFPTable=wsSFPTable, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourLocalIf=wsNeighbourLocalIf, wsIbosTempLow=wsIbosTempLow, wsAsrRevision=wsAsrRevision, wsNeighbourModel=wsNeighbourModel, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourUptime=wsNeighbourUptime, wsReload=wsReload, wsVoltTable=wsVoltTable, wsNeighbourHostname=wsNeighbourHostname, wsVoltNominal=wsVoltNominal, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsVoltThresholdHigh=wsVoltThresholdHigh, wsVoltStatus=wsVoltStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPFDP=wsPFDP, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPTable=wsXFPTable, wsXFPTemp=wsXFPTemp, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsTempThresholdHigh=wsTempThresholdHigh)
