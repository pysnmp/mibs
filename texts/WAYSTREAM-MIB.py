...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortName=wsNeighbourPortName, wsSFPTransceiver=wsSFPTransceiver, wsVoltChannel=wsVoltChannel, wsTempTHYST=wsTempTHYST, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPBitrate=wsSFPBitrate, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPPartNumber=wsSFPPartNumber, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPTempStatus=wsXFPTempStatus, wsSFPEncoding=wsSFPEncoding, wsNeighboursEntry=wsNeighboursEntry, wsReload=wsReload, wsPolicyTable=wsPolicyTable, wsNeighbourPortState=wsNeighbourPortState, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsFanTable=wsFanTable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsTempTable=wsTempTable, wsAsrRevision=wsAsrRevision, wsTempStatus=wsTempStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPIndex=wsSFPIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPTransceiver=wsXFPTransceiver, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourLastAct=wsNeighbourLastAct, wsFanVoltage=wsFanVoltage, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXPower=wsSFPRXPower, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsVoltTable=wsVoltTable, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPolicyCookie=wsPolicyCookie, wsIbosFanRPMLow=wsIbosFanRPMLow, wsTempSensor=wsTempSensor, wsFanEntry=wsFanEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyInPkts=wsPolicyInPkts, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPolicyOutDrops=wsPolicyOutDrops, wsTempThresholdLow=wsTempThresholdLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPEntry=wsSFPEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourModel=wsNeighbourModel, wsIbosTempLow=wsIbosTempLow, wsEnvironment=wsEnvironment, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPStatus=wsSFPStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsTempMeasured=wsTempMeasured, wsFanNumber=wsFanNumber, wsNeighbourDBCount=wsNeighbourDBCount, PYSNMP_MODULE_ID=ibos, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsIbosVoltLow=wsIbosVoltLow, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSystem=wsSystem, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPTable=wsXFPTable, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsTempEntry=wsTempEntry, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsVoltEntry=wsVoltEntry, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPEntry=wsXFPEntry, wsXFPTXPower=wsXFPTXPower, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPConnector=wsXFPConnector, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTemp=wsSFPTemp, wsNeighboursTable=wsNeighboursTable, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPRXPower=wsXFPRXPower, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsAccounting=wsAccounting, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXPower=wsSFPTXPower, wsSFPVolt=wsSFPVolt, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsVoltStatus=wsVoltStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPTemp=wsXFPTemp, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVersion=wsVersion, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsVoltMeasured=wsVoltMeasured, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsWritedummy=wsWritedummy, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPEncoding=wsXFPEncoding, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPCopperLen=wsXFPCopperLen, wsFanRPM=wsFanRPM, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVersionString=wsVersionString, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourState=wsNeighbourState, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsVoltNominal=wsVoltNominal, ibos=ibos, wsPolicyInBytes=wsPolicyInBytes, wsXFPStatus=wsXFPStatus, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsIbosVoltHigh=wsIbosVoltHigh, wsPFDP=wsPFDP, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempTOS=wsTempTOS, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyName=wsPolicyName, wsSFPTable=wsSFPTable, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyIfName=wsPolicyIfName, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPConnector=wsSFPConnector, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXdBmPower=wsSFPRXdBmPower)
