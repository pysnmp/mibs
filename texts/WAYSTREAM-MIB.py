...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPolicyInPkts=wsPolicyInPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempTOS=wsTempTOS, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourUptime=wsNeighbourUptime, wsXFPEntry=wsXFPEntry, wsSFPTXPower=wsSFPTXPower, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsTempTHYST=wsTempTHYST, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPTable=wsXFPTable, wsXFPTempStatus=wsXFPTempStatus, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsTempThresholdLow=wsTempThresholdLow, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsReload=wsReload, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempStatus=wsTempStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPTransceiver=wsXFPTransceiver, wsEnvironment=wsEnvironment, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXdBmPower=wsSFPTXdBmPower, wsPFDP=wsPFDP, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsFanTable=wsFanTable, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPStatus=wsSFPStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTable=wsSFPTable, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPConnector=wsXFPConnector, wsNeighbourModel=wsNeighbourModel, wsSFPTempNormalLow=wsSFPTempNormalLow, wsVoltEntry=wsVoltEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsIbosVoltLow=wsIbosVoltLow, wsPolicyName=wsPolicyName, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsFanRPM=wsFanRPM, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsVoltMeasured=wsVoltMeasured, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPCopperLen=wsXFPCopperLen, wsWritedummy=wsWritedummy, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortState=wsNeighbourPortState, wsTempMeasured=wsTempMeasured, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTransceiver=wsSFPTransceiver, wsSFPBitrate=wsSFPBitrate, wsPolicyOutDrops=wsPolicyOutDrops, wsAsrRevision=wsAsrRevision, PYSNMP_MODULE_ID=ibos, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsFanNumber=wsFanNumber, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyEntry=wsPolicyEntry, wsVersionString=wsVersionString, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPEncoding=wsXFPEncoding, wsSFPPartNumber=wsSFPPartNumber, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsFanEntry=wsFanEntry, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPTXPower=wsXFPTXPower, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsVoltTable=wsVoltTable, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsIbosFanRPMLow=wsIbosFanRPMLow, ibos=ibos, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsFanVoltage=wsFanVoltage, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPIndex=wsXFPIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsVersion=wsVersion, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPEntry=wsSFPEntry, wsSFPRXPower=wsSFPRXPower, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsPolicyOutPkts=wsPolicyOutPkts, wsIbosTempLow=wsIbosTempLow, wsIbosTempHigh=wsIbosTempHigh, wsPolicyIfName=wsPolicyIfName, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPStatus=wsXFPStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourHostname=wsNeighbourHostname, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPIndex=wsSFPIndex, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyCookie=wsPolicyCookie, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPVolt=wsSFPVolt, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPTemp=wsXFPTemp, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSystem=wsSystem, wsSFPEncoding=wsSFPEncoding, wsVoltChannel=wsVoltChannel, wsTempSensor=wsTempSensor, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortName=wsNeighbourPortName, wsTempTable=wsTempTable, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsPolicyTable=wsPolicyTable, wsVoltNominal=wsVoltNominal, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsAccounting=wsAccounting, wsVoltStatus=wsVoltStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsTempEntry=wsTempEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTemp=wsSFPTemp, wsXFPRXPower=wsXFPRXPower, wsSFPConnector=wsSFPConnector, wsNeighboursTable=wsNeighboursTable, wsPolicyInBytes=wsPolicyInBytes, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVoltThresholdHigh=wsVoltThresholdHigh)
