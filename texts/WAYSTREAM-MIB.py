...
mibBuilder.exportSymbols("WAYSTREAM-MIB", ibos=ibos, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsTempThresholdLow=wsTempThresholdLow, wsSFPTemp=wsSFPTemp, wsXFPEncoding=wsXFPEncoding, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPTemp=wsXFPTemp, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsIbosFanRPMLow=wsIbosFanRPMLow, wsFanEntry=wsFanEntry, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsWritedummy=wsWritedummy, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPEntry=wsXFPEntry, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsVersionString=wsVersionString, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPPartNumber=wsSFPPartNumber, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsIbosTempLow=wsIbosTempLow, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsPFDP=wsPFDP, wsSFPTable=wsSFPTable, wsNeighboursTable=wsNeighboursTable, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPConnector=wsXFPConnector, wsTempEntry=wsTempEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsTempTOS=wsTempTOS, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPConnector=wsSFPConnector, wsPolicyEntry=wsPolicyEntry, wsSFPTempStatus=wsSFPTempStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, PYSNMP_MODULE_ID=ibos, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourState=wsNeighbourState, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPVolt=wsSFPVolt, wsSFPEncoding=wsSFPEncoding, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourUptime=wsNeighbourUptime, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPBitrateMax=wsXFPBitrateMax, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPBitrate=wsSFPBitrate, wsTempTable=wsTempTable, wsSystem=wsSystem, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsVoltChannel=wsVoltChannel, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyName=wsPolicyName, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTransceiver=wsSFPTransceiver, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPBitrateMin=wsXFPBitrateMin, wsFanRPM=wsFanRPM, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsFanNumber=wsFanNumber, wsFanTable=wsFanTable, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPEntry=wsSFPEntry, wsSFPTXPower=wsSFPTXPower, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsPolicyInBytes=wsPolicyInBytes, wsPolicyUsedCnt=wsPolicyUsedCnt, wsReload=wsReload, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourLocalIf=wsNeighbourLocalIf, wsVoltEntry=wsVoltEntry, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVoltTable=wsVoltTable, wsPolicyInPkts=wsPolicyInPkts, wsSFPIndex=wsSFPIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsTempStatus=wsTempStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsEnvironment=wsEnvironment, wsSFPRXdBmPower=wsSFPRXdBmPower, wsTempSensor=wsTempSensor, wsPolicyInDrops=wsPolicyInDrops, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyIfName=wsPolicyIfName, wsPolicyTable=wsPolicyTable, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPCopperLen=wsSFPCopperLen, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourHostname=wsNeighbourHostname, wsXFPTXPower=wsXFPTXPower, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourCreated=wsNeighbourCreated, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVersion=wsVersion, wsPolicyCookie=wsPolicyCookie, wsAsrRevision=wsAsrRevision, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsFanVoltage=wsFanVoltage, wsAccounting=wsAccounting, wsXFPRXPower=wsXFPRXPower, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsTempMeasured=wsTempMeasured, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPRXPower=wsSFPRXPower, wsXFPTable=wsXFPTable, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsVoltStatus=wsVoltStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPStatus=wsXFPStatus, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPStatus=wsSFPStatus, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPTransceiver=wsXFPTransceiver)
