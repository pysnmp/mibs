...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPStatus=wsSFPStatus, wsNeighbourHostname=wsNeighbourHostname, wsFanTable=wsFanTable, wsVoltNominal=wsVoltNominal, wsTempStatus=wsTempStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPTempStatus=wsXFPTempStatus, wsVersion=wsVersion, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPConnector=wsSFPConnector, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighboursEntry=wsNeighboursEntry, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyEntry=wsPolicyEntry, wsXFPRXPower=wsXFPRXPower, wsXFPTXPower=wsXFPTXPower, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPEntry=wsXFPEntry, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSystem=wsSystem, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPPartNumber=wsSFPPartNumber, wsVoltMeasured=wsVoltMeasured, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourCreated=wsNeighbourCreated, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPConnector=wsXFPConnector, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTable=wsSFPTable, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPBitrate=wsSFPBitrate, wsTempTOS=wsTempTOS, wsVoltChannel=wsVoltChannel, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsReload=wsReload, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsIbosTempLow=wsIbosTempLow, wsPolicyInPkts=wsPolicyInPkts, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourModel=wsNeighbourModel, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyOutDrops=wsPolicyOutDrops, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsTempTHYST=wsTempTHYST, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVoltStatus=wsVoltStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPIndex=wsSFPIndex, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourState=wsNeighbourState, wsSFPVolt=wsSFPVolt, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyTable=wsPolicyTable, wsXFPIndex=wsXFPIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsVoltTable=wsVoltTable, wsSFPTempStatus=wsSFPTempStatus, wsFanNumber=wsFanNumber, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPCopperLen=wsSFPCopperLen, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsVersionString=wsVersionString, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsWritedummy=wsWritedummy, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, PYSNMP_MODULE_ID=ibos, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPRXPower=wsSFPRXPower, wsTempTable=wsTempTable, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPCopperLen=wsXFPCopperLen, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsEnvironment=wsEnvironment, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsFanRPM=wsFanRPM, wsTempEntry=wsTempEntry, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsFanEntry=wsFanEntry, wsXFPTransceiver=wsXFPTransceiver, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPolicyInDrops=wsPolicyInDrops, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsFanVoltage=wsFanVoltage, wsSFPEntry=wsSFPEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsTempThresholdLow=wsTempThresholdLow, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXPower=wsSFPTXPower, wsPolicyName=wsPolicyName, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPFDP=wsPFDP, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPTable=wsXFPTable, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsAccounting=wsAccounting, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsTempSensor=wsTempSensor, wsSFPTransceiver=wsSFPTransceiver, wsPolicyCookie=wsPolicyCookie, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyIfName=wsPolicyIfName, wsTempMeasured=wsTempMeasured, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTemp=wsXFPTemp, wsAsrRevision=wsAsrRevision, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, ibos=ibos, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPEncoding=wsSFPEncoding, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh)
