...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPStatus=wsXFPStatus, wsTempTHYST=wsTempTHYST, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortState=wsNeighbourPortState, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsTempThresholdLow=wsTempThresholdLow, wsAsrRevision=wsAsrRevision, wsXFPIndex=wsXFPIndex, wsSFPTable=wsSFPTable, wsFanVoltage=wsFanVoltage, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsTempMeasured=wsTempMeasured, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPVolt=wsSFPVolt, wsPolicyIfName=wsPolicyIfName, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsFanTable=wsFanTable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsVersion=wsVersion, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXPower=wsSFPTXPower, wsVoltTable=wsVoltTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPVoltWarningLow=wsSFPVoltWarningLow, ibos=ibos, wsVoltEntry=wsVoltEntry, wsVoltStatus=wsVoltStatus, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPStatus=wsSFPStatus, wsXFPTransceiver=wsXFPTransceiver, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTempStatus=wsSFPTempStatus, wsXFPConnector=wsXFPConnector, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsTempTOS=wsTempTOS, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighboursEntry=wsNeighboursEntry, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPEntry=wsXFPEntry, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsPolicyTable=wsPolicyTable, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortName=wsNeighbourPortName, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourUptime=wsNeighbourUptime, wsPolicyCookie=wsPolicyCookie, wsNeighbourState=wsNeighbourState, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTemp=wsSFPTemp, wsTempTable=wsTempTable, wsSFPPartNumber=wsSFPPartNumber, wsVersionString=wsVersionString, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPEncoding=wsSFPEncoding, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPTemp=wsXFPTemp, wsXFPTempStatus=wsXFPTempStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPEntry=wsSFPEntry, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyName=wsPolicyName, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPBitrate=wsSFPBitrate, wsPolicyInPkts=wsPolicyInPkts, PYSNMP_MODULE_ID=ibos, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourModel=wsNeighbourModel, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsAccounting=wsAccounting, wsTempEntry=wsTempEntry, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsPFDP=wsPFDP, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsEnvironment=wsEnvironment, wsVoltNominal=wsVoltNominal, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsTempSensor=wsTempSensor, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsIbosTempHigh=wsIbosTempHigh, wsXFPBitrateMin=wsXFPBitrateMin, wsSystem=wsSystem, wsSFPTXCurrent=wsSFPTXCurrent, wsFanNumber=wsFanNumber, wsNeighboursTable=wsNeighboursTable, wsReload=wsReload, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPIndex=wsSFPIndex, wsXFPTable=wsXFPTable, wsSFPConnector=wsSFPConnector, wsSFPTXdBmPower=wsSFPTXdBmPower, wsVoltChannel=wsVoltChannel, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPolicyIfIndex=wsPolicyIfIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPCopperLen=wsSFPCopperLen, wsWritedummy=wsWritedummy, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourLocalIf=wsNeighbourLocalIf, wsXFPRXPower=wsXFPRXPower, wsFanRPM=wsFanRPM, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPTXPower=wsXFPTXPower, wsSFPSerialNumber=wsSFPSerialNumber, wsTempStatus=wsTempStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsFanEntry=wsFanEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPEncoding=wsXFPEncoding, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh)
