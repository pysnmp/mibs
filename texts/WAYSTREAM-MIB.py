...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPTransceiver=wsXFPTransceiver, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsAsrRevision=wsAsrRevision, wsTempEntry=wsTempEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPConnector=wsSFPConnector, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPEncoding=wsSFPEncoding, wsIbosTempHigh=wsIbosTempHigh, wsVoltChannel=wsVoltChannel, ibos=ibos, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourState=wsNeighbourState, wsAccounting=wsAccounting, wsPolicyIfName=wsPolicyIfName, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSystem=wsSystem, wsPolicyOutBytes=wsPolicyOutBytes, wsIbosTempLow=wsIbosTempLow, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsFanEntry=wsFanEntry, wsXFPTemp=wsXFPTemp, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPBitrateMax=wsXFPBitrateMax, wsTempStatus=wsTempStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsEnvironment=wsEnvironment, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourLastAct=wsNeighbourLastAct, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTable=wsSFPTable, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsVoltTable=wsVoltTable, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVoltStatus=wsVoltStatus, wsSFPTempStatus=wsSFPTempStatus, wsXFPCopperLen=wsXFPCopperLen, wsPolicyName=wsPolicyName, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsPolicyInDrops=wsPolicyInDrops, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPEntry=wsSFPEntry, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsVersion=wsVersion, wsSFPTemp=wsSFPTemp, wsVoltThresholdHigh=wsVoltThresholdHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortName=wsNeighbourPortName, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPConnector=wsXFPConnector, wsTempTHYST=wsTempTHYST, wsNeighbourLocalIf=wsNeighbourLocalIf, wsWritedummy=wsWritedummy, wsNeighbourPortState=wsNeighbourPortState, wsSFPIndex=wsSFPIndex, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsFanNumber=wsFanNumber, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourDBCount=wsNeighbourDBCount, wsTempTable=wsTempTable, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXPower=wsSFPRXPower, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, PYSNMP_MODULE_ID=ibos, wsNeighbourSNPA=wsNeighbourSNPA, wsPolicyTable=wsPolicyTable, wsNeighbourModel=wsNeighbourModel, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsTempSensor=wsTempSensor, wsSFPStatus=wsSFPStatus, wsNeighboursTable=wsNeighboursTable, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsIbosVoltLow=wsIbosVoltLow, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPTXPower=wsXFPTXPower, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsTempMeasured=wsTempMeasured, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsTempTOS=wsTempTOS, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsFanTable=wsFanTable, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsTempThresholdLow=wsTempThresholdLow, wsXFPIndex=wsXFPIndex, wsVoltNominal=wsVoltNominal, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPStatus=wsXFPStatus, wsPFDP=wsPFDP, wsNeighbourUptime=wsNeighbourUptime, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPEntry=wsXFPEntry, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPTable=wsXFPTable, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsFanRPM=wsFanRPM, wsSFPBitrate=wsSFPBitrate, wsSFPRXdBmPower=wsSFPRXdBmPower, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsReload=wsReload, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsVoltEntry=wsVoltEntry, wsSFPVolt=wsSFPVolt, wsPolicyEntry=wsPolicyEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourHostname=wsNeighbourHostname, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsFanVoltage=wsFanVoltage, wsVersionString=wsVersionString)
