...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPEntry=wsSFPEntry, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTemp=wsSFPTemp, wsFanRPM=wsFanRPM, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPRXPower=wsSFPRXPower, wsXFPTempStatus=wsXFPTempStatus, wsSFPConnector=wsSFPConnector, wsFanTable=wsFanTable, wsPolicyIfIndex=wsPolicyIfIndex, wsVersion=wsVersion, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPVoltStatus=wsSFPVoltStatus, wsTempSensor=wsTempSensor, wsXFPTemp=wsXFPTemp, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyTable=wsPolicyTable, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyCookie=wsPolicyCookie, wsIbosTempLow=wsIbosTempLow, wsWritedummy=wsWritedummy, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPRXPower=wsXFPRXPower, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTable=wsSFPTable, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsVoltTable=wsVoltTable, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, ibos=ibos, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTransceiverExt=wsSFPTransceiverExt, wsTempTHYST=wsTempTHYST, wsXFPConnector=wsXFPConnector, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourState=wsNeighbourState, wsSFPSerialNumber=wsSFPSerialNumber, wsVoltEntry=wsVoltEntry, wsAccounting=wsAccounting, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXPower=wsSFPTXPower, wsSystem=wsSystem, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVolt=wsSFPVolt, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsVoltStatus=wsVoltStatus, wsXFPCopperLen=wsXFPCopperLen, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsFanNumber=wsFanNumber, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPBitrate=wsSFPBitrate, wsNeighbourHostname=wsNeighbourHostname, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTXPower=wsXFPTXPower, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPIndex=wsSFPIndex, wsNeighbourModel=wsNeighbourModel, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVersionString=wsVersionString, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsFanEntry=wsFanEntry, wsTempEntry=wsTempEntry, wsPolicyInBytes=wsPolicyInBytes, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyInDrops=wsPolicyInDrops, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPEncoding=wsSFPEncoding, wsTempTOS=wsTempTOS, wsSFPTransceiver=wsSFPTransceiver, wsSFPPartNumber=wsSFPPartNumber, wsSFPStatus=wsSFPStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsVoltMeasured=wsVoltMeasured, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsTempTable=wsTempTable, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsFanVoltage=wsFanVoltage, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsVoltChannel=wsVoltChannel, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPEncoding=wsXFPEncoding, wsVoltNominal=wsVoltNominal, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighboursEntry=wsNeighboursEntry, wsPolicyName=wsPolicyName, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsTempStatus=wsTempStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighboursTable=wsNeighboursTable, wsReload=wsReload, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsVoltThresholdHigh=wsVoltThresholdHigh, wsAsrRevision=wsAsrRevision, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyEntry=wsPolicyEntry, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPEntry=wsXFPEntry, PYSNMP_MODULE_ID=ibos, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsEnvironment=wsEnvironment, wsXFPTable=wsXFPTable, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsTempMeasured=wsTempMeasured, wsNeighbourPortState=wsNeighbourPortState, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPCopperLen=wsSFPCopperLen, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTempStatus=wsSFPTempStatus, wsPFDP=wsPFDP, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc)
