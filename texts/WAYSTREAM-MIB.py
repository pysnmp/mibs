...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTransceiver=wsSFPTransceiver, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsFanNumber=wsFanNumber, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVoltEntry=wsVoltEntry, wsNeighboursTable=wsNeighboursTable, wsEnvironment=wsEnvironment, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortName=wsNeighbourPortName, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourState=wsNeighbourState, wsSFPConnector=wsSFPConnector, wsSFPEntry=wsSFPEntry, wsSystem=wsSystem, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPTempStatus=wsXFPTempStatus, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsFanEntry=wsFanEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPolicyName=wsPolicyName, wsIbosTempLow=wsIbosTempLow, wsTempThresholdLow=wsTempThresholdLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyTable=wsPolicyTable, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTable=wsSFPTable, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPRXPower=wsSFPRXPower, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPRXPower=wsXFPRXPower, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPStatus=wsSFPStatus, wsSFPTXPower=wsSFPTXPower, wsTempTable=wsTempTable, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortPIndex=wsNeighbourPortPIndex, ibos=ibos, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempMeasured=wsTempMeasured, wsXFPStatus=wsXFPStatus, wsXFPTable=wsXFPTable, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsTempTHYST=wsTempTHYST, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPSerialNumber=wsSFPSerialNumber, PYSNMP_MODULE_ID=ibos, wsSFPBitrate=wsSFPBitrate, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPEntry=wsXFPEntry, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPIndex=wsXFPIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsPolicyInPkts=wsPolicyInPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyIfName=wsPolicyIfName, wsTempSensor=wsTempSensor, wsAsrRevision=wsAsrRevision, wsTempEntry=wsTempEntry, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPIndex=wsSFPIndex, wsXFPTemp=wsXFPTemp, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyUsedCnt=wsPolicyUsedCnt, wsFanRPM=wsFanRPM, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsVoltChannel=wsVoltChannel, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourUptime=wsNeighbourUptime, wsWritedummy=wsWritedummy, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourModel=wsNeighbourModel, wsXFPConnector=wsXFPConnector, wsVersion=wsVersion, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortState=wsNeighbourPortState, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsAccounting=wsAccounting, wsTempTOS=wsTempTOS, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVoltNominal=wsVoltNominal, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyEntry=wsPolicyEntry, wsSFPTXdBmPower=wsSFPTXdBmPower, wsPFDP=wsPFDP, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTempNormalLow=wsSFPTempNormalLow, wsFanTable=wsFanTable, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPVolt=wsSFPVolt, wsPolicyOutPkts=wsPolicyOutPkts, wsReload=wsReload, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsVoltTable=wsVoltTable, wsVersionString=wsVersionString, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPTXPower=wsXFPTXPower, wsVoltThresholdHigh=wsVoltThresholdHigh, wsTempStatus=wsTempStatus, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVoltMeasured=wsVoltMeasured, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPEncoding=wsXFPEncoding, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm)
