...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsFanRPM=wsFanRPM, ibos=ibos, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsIbosTempLow=wsIbosTempLow, wsSFPEncoding=wsSFPEncoding, wsXFPRXPower=wsXFPRXPower, wsTempTOS=wsTempTOS, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsPolicyIfName=wsPolicyIfName, wsSFPStatus=wsSFPStatus, wsFanTable=wsFanTable, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsPolicyCookie=wsPolicyCookie, PYSNMP_MODULE_ID=ibos, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortState=wsNeighbourPortState, wsSFPTable=wsSFPTable, wsXFPBitrateMax=wsXFPBitrateMax, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourUptime=wsNeighbourUptime, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsTempTable=wsTempTable, wsFanVoltage=wsFanVoltage, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTemp=wsSFPTemp, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPTable=wsXFPTable, wsXFPIndex=wsXFPIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPFDP=wsPFDP, wsNeighbourDBCount=wsNeighbourDBCount, wsVoltMeasured=wsVoltMeasured, wsSystem=wsSystem, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPEntry=wsSFPEntry, wsIbosFanRPMLow=wsIbosFanRPMLow, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPEntry=wsXFPEntry, wsSFPConnector=wsSFPConnector, wsWritedummy=wsWritedummy, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighboursEntry=wsNeighboursEntry, wsXFPTemp=wsXFPTemp, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPEncoding=wsXFPEncoding, wsXFPTXPower=wsXFPTXPower, wsPolicyTable=wsPolicyTable, wsVersion=wsVersion, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighboursTable=wsNeighboursTable, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVoltTable=wsVoltTable, wsSFPTransceiverExt=wsSFPTransceiverExt, wsIbosVoltHigh=wsIbosVoltHigh, wsTempTHYST=wsTempTHYST, wsTempMeasured=wsTempMeasured, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPStatus=wsXFPStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsEnvironment=wsEnvironment, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsVoltStatus=wsVoltStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTempStatus=wsXFPTempStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyInPkts=wsPolicyInPkts, wsTempSensor=wsTempSensor, wsReload=wsReload, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTransceiver=wsSFPTransceiver, wsVoltEntry=wsVoltEntry, wsFanNumber=wsFanNumber, wsNeighbourCreated=wsNeighbourCreated, wsPolicyEntry=wsPolicyEntry, wsTempEntry=wsTempEntry, wsPolicyName=wsPolicyName, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsVersionString=wsVersionString, wsSFPPartNumber=wsSFPPartNumber, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPConnector=wsXFPConnector, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPCopperLen=wsSFPCopperLen, wsTempStatus=wsTempStatus, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPTransceiver=wsXFPTransceiver, wsPolicyInDrops=wsPolicyInDrops, wsAsrRevision=wsAsrRevision, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsAccounting=wsAccounting, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsIbosVoltLow=wsIbosVoltLow, wsXFPCopperLen=wsXFPCopperLen, wsSFPVolt=wsSFPVolt, wsFanEntry=wsFanEntry, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPIndex=wsSFPIndex, wsIbosTempHigh=wsIbosTempHigh, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus)
