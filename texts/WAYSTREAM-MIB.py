...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPTemp=wsXFPTemp, wsSystem=wsSystem, wsAccounting=wsAccounting, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPIndex=wsSFPIndex, wsPolicyEntry=wsPolicyEntry, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPSingleModeLen=wsXFPSingleModeLen, wsTempTHYST=wsTempTHYST, wsXFPStatus=wsXFPStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPTempStatus=wsXFPTempStatus, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTransceiver=wsSFPTransceiver, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsVoltTable=wsVoltTable, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTempNormalLow=wsSFPTempNormalLow, wsFanTable=wsFanTable, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsVersion=wsVersion, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourState=wsNeighbourState, wsXFPBitrateMax=wsXFPBitrateMax, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTemp=wsSFPTemp, wsReload=wsReload, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVoltNominal=wsVoltNominal, wsXFPTXCurrent=wsXFPTXCurrent, wsIbosTempHigh=wsIbosTempHigh, wsPFDP=wsPFDP, wsXFPConnector=wsXFPConnector, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsVoltEntry=wsVoltEntry, wsSFPTXdBmPower=wsSFPTXdBmPower, wsFanVoltage=wsFanVoltage, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyInPkts=wsPolicyInPkts, wsSFPEncoding=wsSFPEncoding, wsVoltMeasured=wsVoltMeasured, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPVolt=wsSFPVolt, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighboursEntry=wsNeighboursEntry, wsNeighboursTable=wsNeighboursTable, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsTempStatus=wsTempStatus, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPTable=wsXFPTable, wsSFPRXPower=wsSFPRXPower, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortState=wsNeighbourPortState, wsSFPTempStatus=wsSFPTempStatus, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPTransceiver=wsXFPTransceiver, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPRXPower=wsXFPRXPower, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPStatus=wsSFPStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsTempTable=wsTempTable, wsTempTOS=wsTempTOS, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPIndex=wsXFPIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyCookie=wsPolicyCookie, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourOSVersion=wsNeighbourOSVersion, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsTempSensor=wsTempSensor, wsTempEntry=wsTempEntry, wsVersionString=wsVersionString, wsXFPCopperLen=wsXFPCopperLen, wsSFPTable=wsSFPTable, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourModel=wsNeighbourModel, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPPartNumber=wsSFPPartNumber, wsFanEntry=wsFanEntry, wsFanNumber=wsFanNumber, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsWritedummy=wsWritedummy, PYSNMP_MODULE_ID=ibos, wsSFPTXPower=wsSFPTXPower, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyName=wsPolicyName, wsFanRPM=wsFanRPM, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPEntry=wsXFPEntry, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsAsrRevision=wsAsrRevision, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsTempMeasured=wsTempMeasured, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPConnector=wsSFPConnector, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVoltStatus=wsVoltStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, ibos=ibos, wsPolicyIfName=wsPolicyIfName, wsIbosTempLow=wsIbosTempLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPTXPower=wsXFPTXPower, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVoltChannel=wsVoltChannel, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsEnvironment=wsEnvironment, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyTable=wsPolicyTable, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTransceiverExt=wsSFPTransceiverExt)
