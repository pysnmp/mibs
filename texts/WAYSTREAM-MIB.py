...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTable=wsSFPTable, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsTempTHYST=wsTempTHYST, wsFanTable=wsFanTable, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsReload=wsReload, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTXCurrent=wsSFPTXCurrent, wsFanNumber=wsFanNumber, wsPolicyInDrops=wsPolicyInDrops, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourState=wsNeighbourState, wsSFPVolt=wsSFPVolt, wsTempTOS=wsTempTOS, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsEnvironment=wsEnvironment, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPCopperLen=wsSFPCopperLen, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPEntry=wsSFPEntry, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPStatus=wsSFPStatus, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighboursTable=wsNeighboursTable, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, ibos=ibos, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPBitrate=wsSFPBitrate, wsXFPTable=wsXFPTable, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsVersionString=wsVersionString, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXPower=wsSFPTXPower, wsFanRPM=wsFanRPM, wsSFPTransceiver=wsSFPTransceiver, wsXFPTempStatus=wsXFPTempStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsVoltChannel=wsVoltChannel, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsVoltStatus=wsVoltStatus, wsWritedummy=wsWritedummy, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPTXPower=wsXFPTXPower, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsTempSensor=wsTempSensor, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsFanEntry=wsFanEntry, PYSNMP_MODULE_ID=ibos, wsPolicyTable=wsPolicyTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsIbosTempHigh=wsIbosTempHigh, wsTempEntry=wsTempEntry, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsAsrRevision=wsAsrRevision, wsPFDP=wsPFDP, wsTempMeasured=wsTempMeasured, wsVoltEntry=wsVoltEntry, wsTempThresholdLow=wsTempThresholdLow, wsPolicyName=wsPolicyName, wsXFPEncoding=wsXFPEncoding, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSystem=wsSystem, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPConnector=wsXFPConnector, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyEntry=wsPolicyEntry, wsNeighbourModel=wsNeighbourModel, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsTempTable=wsTempTable, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPEncoding=wsSFPEncoding, wsTempStatus=wsTempStatus, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsIbosVoltLow=wsIbosVoltLow, wsIbosTempLow=wsIbosTempLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPPartNumber=wsSFPPartNumber, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVoltTable=wsVoltTable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourUptime=wsNeighbourUptime, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsFanVoltage=wsFanVoltage, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPSerialNumber=wsSFPSerialNumber, wsXFPRXPower=wsXFPRXPower, wsVersion=wsVersion, wsAccounting=wsAccounting, wsXFPTemp=wsXFPTemp, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourHostname=wsNeighbourHostname, wsSFPTempStatus=wsSFPTempStatus, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPConnector=wsSFPConnector, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltNominal=wsVoltNominal, wsXFPEntry=wsXFPEntry, wsXFPIndex=wsXFPIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPIndex=wsSFPIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPStatus=wsXFPStatus, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourNIndex=wsNeighbourNIndex, wsVoltMeasured=wsVoltMeasured)
