...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPEntry=wsSFPEntry, wsXFPRXPower=wsXFPRXPower, wsPolicyOutBytes=wsPolicyOutBytes, wsVoltNominal=wsVoltNominal, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPFDP=wsPFDP, wsNeighbourModel=wsNeighbourModel, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsVoltEntry=wsVoltEntry, wsVoltThresholdHigh=wsVoltThresholdHigh, ibos=ibos, wsSFPStatus=wsSFPStatus, wsPolicyInBytes=wsPolicyInBytes, wsTempMeasured=wsTempMeasured, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPPartNumber=wsSFPPartNumber, wsXFPEntry=wsXFPEntry, wsTempEntry=wsTempEntry, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPBitrate=wsSFPBitrate, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourHostname=wsNeighbourHostname, wsAsrRevision=wsAsrRevision, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourDBCount=wsNeighbourDBCount, wsReload=wsReload, wsTempTHYST=wsTempTHYST, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPTXCurrent=wsXFPTXCurrent, wsIbosTempLow=wsIbosTempLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighboursTable=wsNeighboursTable, wsSFPTransceiver=wsSFPTransceiver, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTransceiver=wsXFPTransceiver, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsVersion=wsVersion, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsVoltTable=wsVoltTable, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsAccounting=wsAccounting, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyInDrops=wsPolicyInDrops, wsFanTable=wsFanTable, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsTempSensor=wsTempSensor, wsSFPConnector=wsSFPConnector, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVoltChannel=wsVoltChannel, wsTempStatus=wsTempStatus, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsPolicyCookie=wsPolicyCookie, wsTempTOS=wsTempTOS, wsPolicyInPkts=wsPolicyInPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVersionString=wsVersionString, wsSFPTXPower=wsSFPTXPower, wsFanNumber=wsFanNumber, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPIndex=wsSFPIndex, wsWritedummy=wsWritedummy, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPIndex=wsXFPIndex, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPConnector=wsXFPConnector, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTable=wsSFPTable, wsXFPTXPower=wsXFPTXPower, wsXFPCopperLen=wsXFPCopperLen, PYSNMP_MODULE_ID=ibos, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsPolicyTable=wsPolicyTable, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortState=wsNeighbourPortState, wsSFPTemp=wsSFPTemp, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsEnvironment=wsEnvironment, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsIbosVoltLow=wsIbosVoltLow, wsPolicyName=wsPolicyName, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsFanRPM=wsFanRPM, wsFanVoltage=wsFanVoltage, wsXFPEncoding=wsXFPEncoding, wsSFPVolt=wsSFPVolt, wsXFPStatus=wsXFPStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPTable=wsXFPTable, wsNeighbourLastAct=wsNeighbourLastAct, wsFanEntry=wsFanEntry, wsVoltStatus=wsVoltStatus, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPTemp=wsXFPTemp, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSystem=wsSystem, wsSFPEncoding=wsSFPEncoding, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourCreated=wsNeighbourCreated, wsTempTable=wsTempTable, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus)
