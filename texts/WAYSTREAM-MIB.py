...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPFDP=wsPFDP, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsVersionString=wsVersionString, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourModel=wsNeighbourModel, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyInBytes=wsPolicyInBytes, wsXFPTXCurrent=wsXFPTXCurrent, wsIbosVoltLow=wsIbosVoltLow, wsPolicyIfIndex=wsPolicyIfIndex, wsTempEntry=wsTempEntry, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPConnector=wsSFPConnector, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPBitrate=wsSFPBitrate, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVersion=wsVersion, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourHostname=wsNeighbourHostname, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsVoltNominal=wsVoltNominal, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPStatus=wsSFPStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourCreated=wsNeighbourCreated, wsSFPEncoding=wsSFPEncoding, wsXFPRXPower=wsXFPRXPower, wsEnvironment=wsEnvironment, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsTempMeasured=wsTempMeasured, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPIndex=wsSFPIndex, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsTempThresholdLow=wsTempThresholdLow, wsSFPVolt=wsSFPVolt, wsFanRPM=wsFanRPM, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighboursTable=wsNeighboursTable, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsAccounting=wsAccounting, wsVoltStatus=wsVoltStatus, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourNIndex=wsNeighbourNIndex, wsTempTOS=wsTempTOS, wsIbosTempHigh=wsIbosTempHigh, wsVoltMeasured=wsVoltMeasured, wsSFPPartNumber=wsSFPPartNumber, wsSFPTable=wsSFPTable, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPStatus=wsXFPStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortsTable=wsNeighbourPortsTable, wsFanNumber=wsFanNumber, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVoltChannel=wsVoltChannel, wsSFPTransceiver=wsSFPTransceiver, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyName=wsPolicyName, wsXFPIndex=wsXFPIndex, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyInDrops=wsPolicyInDrops, wsSFPTemp=wsSFPTemp, wsXFPConnector=wsXFPConnector, PYSNMP_MODULE_ID=ibos, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsVoltTable=wsVoltTable, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortState=wsNeighbourPortState, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyEntry=wsPolicyEntry, wsTempSensor=wsTempSensor, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsTempStatus=wsTempStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPEntry=wsSFPEntry, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPEncoding=wsXFPEncoding, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsPolicyTable=wsPolicyTable, wsNeighbourState=wsNeighbourState, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, ibos=ibos, wsXFPEntry=wsXFPEntry, wsSystem=wsSystem, wsSFPSingleModeLen=wsSFPSingleModeLen, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPTable=wsXFPTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsReload=wsReload, wsTempTable=wsTempTable, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsPolicyIfName=wsPolicyIfName, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsIbosFanRPMLow=wsIbosFanRPMLow, wsFanEntry=wsFanEntry, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPSingleModeLen=wsXFPSingleModeLen, wsFanTable=wsFanTable, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTempStatus=wsSFPTempStatus, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsWritedummy=wsWritedummy, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsFanVoltage=wsFanVoltage, wsSFPRXPower=wsSFPRXPower, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsPolicyOutBytes=wsPolicyOutBytes, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTempStatus=wsXFPTempStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsVoltEntry=wsVoltEntry, wsNeighbourPortPIndex=wsNeighbourPortPIndex)
