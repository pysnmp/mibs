...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyInDrops=wsPolicyInDrops, wsTempEntry=wsTempEntry, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSystem=wsSystem, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsFanVoltage=wsFanVoltage, wsVersion=wsVersion, wsXFPTable=wsXFPTable, wsSFPEncoding=wsSFPEncoding, wsSFPPartNumber=wsSFPPartNumber, wsTempSensor=wsTempSensor, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVoltMeasured=wsVoltMeasured, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTemp=wsSFPTemp, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortName=wsNeighbourPortName, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsEnvironment=wsEnvironment, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsVoltChannel=wsVoltChannel, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPIndex=wsSFPIndex, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsFanEntry=wsFanEntry, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, PYSNMP_MODULE_ID=ibos, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPSingleModeLen=wsXFPSingleModeLen, wsTempThresholdHigh=wsTempThresholdHigh, wsVoltTable=wsVoltTable, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPConnector=wsSFPConnector, wsXFPTXPower=wsXFPTXPower, wsNeighboursTable=wsNeighboursTable, wsSFPCopperLen=wsSFPCopperLen, wsSFPTempNormalLow=wsSFPTempNormalLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourModel=wsNeighbourModel, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPTransceiver=wsXFPTransceiver, wsXFPConnector=wsXFPConnector, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsAccounting=wsAccounting, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsWritedummy=wsWritedummy, wsXFPTemp=wsXFPTemp, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourState=wsNeighbourState, wsPolicyName=wsPolicyName, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPVolt=wsSFPVolt, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsTempStatus=wsTempStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyTable=wsPolicyTable, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPIndex=wsXFPIndex, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltEntry=wsVoltEntry, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsTempMeasured=wsTempMeasured, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsIbosVoltLow=wsIbosVoltLow, wsPolicyInBytes=wsPolicyInBytes, wsReload=wsReload, wsSFPEntry=wsSFPEntry, wsXFPCopperLen=wsXFPCopperLen, wsXFPRXPower=wsXFPRXPower, wsTempTHYST=wsTempTHYST, wsVersionString=wsVersionString, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsIbosTempHigh=wsIbosTempHigh, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsVoltThresholdLow=wsVoltThresholdLow, wsFanNumber=wsFanNumber, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourHostname=wsNeighbourHostname, wsIbosTempLow=wsIbosTempLow, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTransceiver=wsSFPTransceiver, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyEntry=wsPolicyEntry, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsTempTable=wsTempTable, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPFDP=wsPFDP, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPStatus=wsXFPStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsFanTable=wsFanTable, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsFanRPM=wsFanRPM, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, ibos=ibos, wsPolicyInPkts=wsPolicyInPkts, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPEntry=wsXFPEntry, wsSFPRXPower=wsSFPRXPower, wsAsrRevision=wsAsrRevision, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPBitrate=wsSFPBitrate, wsSFPTable=wsSFPTable, wsTempTOS=wsTempTOS, wsNeighbourUptime=wsNeighbourUptime, wsPolicyCookie=wsPolicyCookie, wsSFPStatus=wsSFPStatus)
