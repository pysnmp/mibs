...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTable=wsSFPTable, wsVoltStatus=wsVoltStatus, wsSFPEntry=wsSFPEntry, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSystem=wsSystem, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPSerialNumber=wsSFPSerialNumber, wsTempMeasured=wsTempMeasured, wsPolicyOutDrops=wsPolicyOutDrops, wsPFDP=wsPFDP, wsNeighbourOSVersion=wsNeighbourOSVersion, wsFanEntry=wsFanEntry, wsIbosFanRPMLow=wsIbosFanRPMLow, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPPartNumber=wsSFPPartNumber, wsVoltChannel=wsVoltChannel, wsXFPCopperLen=wsXFPCopperLen, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsAsrRevision=wsAsrRevision, wsPolicyEntry=wsPolicyEntry, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsTempEntry=wsTempEntry, wsPolicyInBytes=wsPolicyInBytes, wsTempSensor=wsTempSensor, wsFanRPM=wsFanRPM, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsFanTable=wsFanTable, wsNeighbourPortState=wsNeighbourPortState, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourLocalIf=wsNeighbourLocalIf, wsXFPConnector=wsXFPConnector, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighboursTable=wsNeighboursTable, wsVersionString=wsVersionString, wsSFPStatus=wsSFPStatus, wsSFPBitrate=wsSFPBitrate, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosTempHigh=wsIbosTempHigh, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPIndex=wsXFPIndex, wsFanVoltage=wsFanVoltage, wsWritedummy=wsWritedummy, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsTempTOS=wsTempTOS, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTransceiver=wsSFPTransceiver, wsXFPTemp=wsXFPTemp, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, ibos=ibos, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourModel=wsNeighbourModel, wsSFPTXPower=wsSFPTXPower, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPEncoding=wsXFPEncoding, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsTempTable=wsTempTable, wsNeighbourUptime=wsNeighbourUptime, PYSNMP_MODULE_ID=ibos, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPRXPower=wsSFPRXPower, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPSingleModeLen=wsSFPSingleModeLen, wsTempThresholdHigh=wsTempThresholdHigh, wsPolicyTable=wsPolicyTable, wsSFPVolt=wsSFPVolt, wsXFPTable=wsXFPTable, wsSFPConnector=wsSFPConnector, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVoltMeasured=wsVoltMeasured, wsPolicyName=wsPolicyName, wsIbosVoltLow=wsIbosVoltLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsTempStatus=wsTempStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsFanNumber=wsFanNumber, wsSFPIndex=wsSFPIndex, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourDBCount=wsNeighbourDBCount, wsTempTHYST=wsTempTHYST, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTemp=wsSFPTemp, wsReload=wsReload, wsNeighbourLastAct=wsNeighbourLastAct, wsAccounting=wsAccounting, wsVoltEntry=wsVoltEntry, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourState=wsNeighbourState, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsVersion=wsVersion, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPEntry=wsXFPEntry, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyCookie=wsPolicyCookie, wsEnvironment=wsEnvironment, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsVoltNominal=wsVoltNominal, wsPolicyOutBytes=wsPolicyOutBytes, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsVoltTable=wsVoltTable, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsPolicyIfName=wsPolicyIfName, wsXFPStatus=wsXFPStatus, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortsEntry=wsNeighbourPortsEntry)
