...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTemp=wsSFPTemp, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourModel=wsNeighbourModel, wsSFPIndex=wsSFPIndex, wsPolicyInPkts=wsPolicyInPkts, wsSFPStatus=wsSFPStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPTable=wsXFPTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourUptime=wsNeighbourUptime, wsSystem=wsSystem, wsVersion=wsVersion, wsIbosTempLow=wsIbosTempLow, wsXFPStatus=wsXFPStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsIbosVoltLow=wsIbosVoltLow, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyTable=wsPolicyTable, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsFanNumber=wsFanNumber, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPTempStatus=wsXFPTempStatus, wsPolicyCookie=wsPolicyCookie, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVoltEntry=wsVoltEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsTempTOS=wsTempTOS, ibos=ibos, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTable=wsSFPTable, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsFanVoltage=wsFanVoltage, wsTempStatus=wsTempStatus, wsNeighbourCreated=wsNeighbourCreated, wsPolicyInDrops=wsPolicyInDrops, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPEncoding=wsXFPEncoding, wsEnvironment=wsEnvironment, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourIfIndex=wsNeighbourIfIndex, wsFanTable=wsFanTable, wsAccounting=wsAccounting, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighboursEntry=wsNeighboursEntry, wsPFDP=wsPFDP, PYSNMP_MODULE_ID=ibos, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsReload=wsReload, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPConnector=wsXFPConnector, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsVoltMeasured=wsVoltMeasured, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsFanRPM=wsFanRPM, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTempWarningLow=wsSFPTempWarningLow, wsTempTHYST=wsTempTHYST, wsSFPSingleModeLen=wsSFPSingleModeLen, wsTempTable=wsTempTable, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPIndex=wsXFPIndex, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPEntry=wsXFPEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPEntry=wsSFPEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsIbosVoltHigh=wsIbosVoltHigh, wsFanEntry=wsFanEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighboursTable=wsNeighboursTable, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyEntry=wsPolicyEntry, wsSFPVolt=wsSFPVolt, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsVoltStatus=wsVoltStatus, wsSFPBitrate=wsSFPBitrate, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsVoltTable=wsVoltTable, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsTempSensor=wsTempSensor, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVersionString=wsVersionString, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPTemp=wsXFPTemp, wsPolicyIfName=wsPolicyIfName, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourHostname=wsNeighbourHostname, wsTempEntry=wsTempEntry, wsXFPCopperLen=wsXFPCopperLen, wsPolicyName=wsPolicyName, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourSNPA=wsNeighbourSNPA, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPTransceiver=wsXFPTransceiver, wsAsrRevision=wsAsrRevision, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortName=wsNeighbourPortName, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsWritedummy=wsWritedummy, wsTempMeasured=wsTempMeasured, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyInBytes=wsPolicyInBytes, wsSFPEncoding=wsSFPEncoding, wsVoltNominal=wsVoltNominal, wsNeighbourLastAct=wsNeighbourLastAct, wsVoltChannel=wsVoltChannel, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPConnector=wsSFPConnector, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourDBCount=wsNeighbourDBCount)
