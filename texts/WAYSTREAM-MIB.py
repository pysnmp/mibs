...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourHostname=wsNeighbourHostname, wsNeighbourLastAct=wsNeighbourLastAct, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsFanVoltage=wsFanVoltage, wsTempMeasured=wsTempMeasured, wsTempSensor=wsTempSensor, wsVersionString=wsVersionString, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPConnector=wsSFPConnector, PYSNMP_MODULE_ID=ibos, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXPower=wsSFPRXPower, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsVoltStatus=wsVoltStatus, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVersion=wsVersion, ibos=ibos, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsVoltEntry=wsVoltEntry, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPStatus=wsSFPStatus, wsTempTable=wsTempTable, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortState=wsNeighbourPortState, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourState=wsNeighbourState, wsXFPRXPower=wsXFPRXPower, wsPolicyOutDrops=wsPolicyOutDrops, wsVoltChannel=wsVoltChannel, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsVoltTable=wsVoltTable, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsFanTable=wsFanTable, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPIndex=wsXFPIndex, wsXFPStatus=wsXFPStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsFanRPM=wsFanRPM, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsXFPTempStatus=wsXFPTempStatus, wsTempTHYST=wsTempTHYST, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyCookie=wsPolicyCookie, wsVoltNominal=wsVoltNominal, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPolicyInPkts=wsPolicyInPkts, wsTempEntry=wsTempEntry, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyName=wsPolicyName, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTransceiver=wsSFPTransceiver, wsXFPEntry=wsXFPEntry, wsIbosVoltHigh=wsIbosVoltHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsAsrRevision=wsAsrRevision, wsNeighboursTable=wsNeighboursTable, wsTempTOS=wsTempTOS, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPConnector=wsXFPConnector, wsSFPCopperLen=wsSFPCopperLen, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPEncoding=wsXFPEncoding, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXPower=wsSFPTXPower, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsEnvironment=wsEnvironment, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsAccounting=wsAccounting, wsXFPTemp=wsXFPTemp, wsSFPBitrate=wsSFPBitrate, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsReload=wsReload, wsXFPCopperLen=wsXFPCopperLen, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPIndex=wsSFPIndex, wsPFDP=wsPFDP, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSystem=wsSystem, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsVoltMeasured=wsVoltMeasured, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyInDrops=wsPolicyInDrops, wsXFPTable=wsXFPTable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsPolicyTable=wsPolicyTable, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsFanNumber=wsFanNumber, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourUptime=wsNeighbourUptime, wsPolicyInBytes=wsPolicyInBytes, wsSFPPartNumber=wsSFPPartNumber, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsTempStatus=wsTempStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPEntry=wsSFPEntry, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsWritedummy=wsWritedummy, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsIbosVoltLow=wsIbosVoltLow, wsSFPVolt=wsSFPVolt, wsIbosTempLow=wsIbosTempLow, wsFanEntry=wsFanEntry, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTemp=wsSFPTemp, wsSFPTable=wsSFPTable)
