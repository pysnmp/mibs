...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsFanTable=wsFanTable, wsPFDP=wsPFDP, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsPolicyUsedCnt=wsPolicyUsedCnt, wsVoltStatus=wsVoltStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsTempStatus=wsTempStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourCreated=wsNeighbourCreated, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPConnector=wsXFPConnector, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsTempTHYST=wsTempTHYST, wsXFPTable=wsXFPTable, wsXFPSingleModeLen=wsXFPSingleModeLen, wsFanRPM=wsFanRPM, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosTempLow=wsIbosTempLow, wsFanVoltage=wsFanVoltage, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPTXPower=wsXFPTXPower, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTempWarningLow=wsSFPTempWarningLow, wsTempThresholdLow=wsTempThresholdLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsVoltMeasured=wsVoltMeasured, wsNeighbourModel=wsNeighbourModel, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyOutDrops=wsPolicyOutDrops, wsTempSensor=wsTempSensor, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourLastAct=wsNeighbourLastAct, wsPolicyOutPkts=wsPolicyOutPkts, wsPolicyEntry=wsPolicyEntry, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPStatus=wsSFPStatus, wsFanEntry=wsFanEntry, wsNeighboursTable=wsNeighboursTable, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTransceiver=wsSFPTransceiver, wsSFPVolt=wsSFPVolt, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPIndex=wsXFPIndex, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsAccounting=wsAccounting, wsTempEntry=wsTempEntry, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourState=wsNeighbourState, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVersion=wsVersion, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPTXCurrent=wsXFPTXCurrent, wsAsrRevision=wsAsrRevision, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSystem=wsSystem, wsPolicyTable=wsPolicyTable, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVersionString=wsVersionString, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPEntry=wsSFPEntry, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTable=wsSFPTable, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPRXPower=wsXFPRXPower, wsVoltNominal=wsVoltNominal, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTempStatus=wsSFPTempStatus, wsNeighboursEntry=wsNeighboursEntry, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsVoltChannel=wsVoltChannel, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyName=wsPolicyName, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourLocalIf=wsNeighbourLocalIf, wsPolicyInPkts=wsPolicyInPkts, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPTemp=wsXFPTemp, wsIbosTempHigh=wsIbosTempHigh, wsPolicyInBytes=wsPolicyInBytes, wsSFPIndex=wsSFPIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, PYSNMP_MODULE_ID=ibos, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTemp=wsSFPTemp, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyIfName=wsPolicyIfName, wsSFPConnector=wsSFPConnector, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsWritedummy=wsWritedummy, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourUptime=wsNeighbourUptime, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourHostname=wsNeighbourHostname, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempTable=wsTempTable, wsEnvironment=wsEnvironment, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPBitrateMax=wsXFPBitrateMax, wsTempTOS=wsTempTOS, wsVoltEntry=wsVoltEntry, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPEntry=wsXFPEntry, wsReload=wsReload, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsVoltTable=wsVoltTable, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, ibos=ibos, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsFanNumber=wsFanNumber, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPEncoding=wsSFPEncoding, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsTempMeasured=wsTempMeasured, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets)
