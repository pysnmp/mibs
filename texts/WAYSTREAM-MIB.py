...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsTempTable=wsTempTable, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsFanTable=wsFanTable, wsNeighbourPortState=wsNeighbourPortState, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXdBmPower=wsSFPTXdBmPower, wsPolicyName=wsPolicyName, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTable=wsSFPTable, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVoltEntry=wsVoltEntry, wsTempMeasured=wsTempMeasured, wsPolicyEntry=wsPolicyEntry, wsTempSensor=wsTempSensor, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTemp=wsSFPTemp, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsVoltNominal=wsVoltNominal, wsIbosVoltHigh=wsIbosVoltHigh, wsVersionString=wsVersionString, wsNeighbourLastAct=wsNeighbourLastAct, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsTempThresholdLow=wsTempThresholdLow, wsSFPVoltStatus=wsSFPVoltStatus, wsVoltTable=wsVoltTable, wsNeighboursTable=wsNeighboursTable, wsNeighbourNIndex=wsNeighbourNIndex, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourLocalIf=wsNeighbourLocalIf, wsTempStatus=wsTempStatus, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsVoltStatus=wsVoltStatus, wsSFPTempStatus=wsSFPTempStatus, wsEnvironment=wsEnvironment, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPVolt=wsSFPVolt, wsFanRPM=wsFanRPM, wsSFPStatus=wsSFPStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPFDP=wsPFDP, wsSFPEntry=wsSFPEntry, wsFanVoltage=wsFanVoltage, wsXFPIndex=wsXFPIndex, wsPolicyInBytes=wsPolicyInBytes, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsFanEntry=wsFanEntry, wsNeighbourModel=wsNeighbourModel, wsNeighbourHostname=wsNeighbourHostname, wsSFPTempNormalLow=wsSFPTempNormalLow, wsIbosVoltLow=wsIbosVoltLow, wsIbosTempHigh=wsIbosTempHigh, PYSNMP_MODULE_ID=ibos, wsAsrRevision=wsAsrRevision, wsNeighbourCreated=wsNeighbourCreated, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPacketsIn=wsNeighbourPacketsIn, ibos=ibos, wsSFPBitrate=wsSFPBitrate, wsXFPTXPower=wsXFPTXPower, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsReload=wsReload, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPCopperLen=wsSFPCopperLen, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPConnector=wsSFPConnector, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyInDrops=wsPolicyInDrops, wsXFPRXPower=wsXFPRXPower, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXdBmPower=wsSFPRXdBmPower, wsVoltMeasured=wsVoltMeasured, wsWritedummy=wsWritedummy, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsTempEntry=wsTempEntry, wsNeighbourState=wsNeighbourState, wsSystem=wsSystem, wsTempTOS=wsTempTOS, wsPolicyTable=wsPolicyTable, wsVersion=wsVersion, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPEncoding=wsSFPEncoding, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTempWarningLow=wsSFPTempWarningLow, wsVoltThresholdLow=wsVoltThresholdLow, wsFanNumber=wsFanNumber, wsSFPPartNumber=wsSFPPartNumber, wsXFPConnector=wsXFPConnector, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsVoltChannel=wsVoltChannel, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighboursEntry=wsNeighboursEntry, wsXFPEntry=wsXFPEntry, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPTempStatus=wsXFPTempStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsPolicyCookie=wsPolicyCookie, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPEncoding=wsXFPEncoding, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsAccounting=wsAccounting, wsXFPTemp=wsXFPTemp, wsPolicyIfName=wsPolicyIfName, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPTable=wsXFPTable, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXPower=wsSFPTXPower, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPIndex=wsSFPIndex, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPStatus=wsXFPStatus)
