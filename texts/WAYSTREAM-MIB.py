...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsFanEntry=wsFanEntry, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPVolt=wsSFPVolt, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosTempLow=wsIbosTempLow, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPEncoding=wsSFPEncoding, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsTempStatus=wsTempStatus, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTable=wsSFPTable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTransceiver=wsSFPTransceiver, wsXFPIndex=wsXFPIndex, wsVoltMeasured=wsVoltMeasured, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsIbosVoltLow=wsIbosVoltLow, wsFanTable=wsFanTable, wsSFPIndex=wsSFPIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPTempStatus=wsXFPTempStatus, wsIbosTempHigh=wsIbosTempHigh, wsVoltNominal=wsVoltNominal, wsVoltTable=wsVoltTable, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsWritedummy=wsWritedummy, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsTempTHYST=wsTempTHYST, ibos=ibos, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPPartNumber=wsSFPPartNumber, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsPolicyName=wsPolicyName, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXPower=wsSFPRXPower, wsFanRPM=wsFanRPM, wsSFPStatus=wsSFPStatus, wsSFPEntry=wsSFPEntry, wsPolicyIfIndex=wsPolicyIfIndex, wsTempThresholdLow=wsTempThresholdLow, wsVersionString=wsVersionString, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsReload=wsReload, PYSNMP_MODULE_ID=ibos, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyInBytes=wsPolicyInBytes, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTempStatus=wsSFPTempStatus, wsXFPRXPower=wsXFPRXPower, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortsTable=wsNeighbourPortsTable, wsPFDP=wsPFDP, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXPower=wsSFPTXPower, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsTempEntry=wsTempEntry, wsVoltEntry=wsVoltEntry, wsXFPEntry=wsXFPEntry, wsAccounting=wsAccounting, wsTempTOS=wsTempTOS, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPCopperLen=wsXFPCopperLen, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPTemp=wsSFPTemp, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPTransceiver=wsXFPTransceiver, wsVoltChannel=wsVoltChannel, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsPolicyTable=wsPolicyTable, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVersion=wsVersion, wsTempTable=wsTempTable, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyEntry=wsPolicyEntry, wsPolicyInDrops=wsPolicyInDrops, wsAsrRevision=wsAsrRevision, wsNeighbourOSVersion=wsNeighbourOSVersion, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsFanVoltage=wsFanVoltage, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPConnector=wsSFPConnector, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsTempMeasured=wsTempMeasured, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsEnvironment=wsEnvironment, wsXFPStatus=wsXFPStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsXFPEncoding=wsXFPEncoding, wsFanNumber=wsFanNumber, wsNeighbourModel=wsNeighbourModel, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPTable=wsXFPTable, wsPolicyInPkts=wsPolicyInPkts, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSystem=wsSystem, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourState=wsNeighbourState, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourUptime=wsNeighbourUptime, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsTempSensor=wsTempSensor, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsIbosVoltHigh=wsIbosVoltHigh)
