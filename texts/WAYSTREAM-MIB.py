...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsTempStatus=wsTempStatus, wsXFPTXCurrent=wsXFPTXCurrent, wsEnvironment=wsEnvironment, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPConnector=wsXFPConnector, wsReload=wsReload, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyEntry=wsPolicyEntry, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTemp=wsSFPTemp, wsXFPRXPower=wsXFPRXPower, wsAccounting=wsAccounting, wsSystem=wsSystem, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPTable=wsXFPTable, wsNeighbourState=wsNeighbourState, wsXFPCopperLen=wsXFPCopperLen, wsXFPEntry=wsXFPEntry, wsVersion=wsVersion, wsNeighboursEntry=wsNeighboursEntry, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPEntry=wsSFPEntry, wsSFPTXPower=wsSFPTXPower, wsXFPSingleModeLen=wsXFPSingleModeLen, wsFanRPM=wsFanRPM, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPTemp=wsXFPTemp, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPEncoding=wsSFPEncoding, ibos=ibos, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXPower=wsSFPRXPower, wsTempSensor=wsTempSensor, wsSFPConnector=wsSFPConnector, wsTempTable=wsTempTable, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsFanNumber=wsFanNumber, wsXFPTempStatus=wsXFPTempStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPIndex=wsSFPIndex, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsPolicyTable=wsPolicyTable, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTempStatus=wsSFPTempStatus, wsSFPVolt=wsSFPVolt, wsTempThresholdLow=wsTempThresholdLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsTempEntry=wsTempEntry, wsNeighbourModel=wsNeighbourModel, wsSFPBitrate=wsSFPBitrate, wsWritedummy=wsWritedummy, wsSFPTransceiver=wsSFPTransceiver, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsVoltStatus=wsVoltStatus, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourSNPA=wsNeighbourSNPA, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsPFDP=wsPFDP, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsFanEntry=wsFanEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsVoltMeasured=wsVoltMeasured, wsVoltChannel=wsVoltChannel, wsVoltTable=wsVoltTable, wsAsrRevision=wsAsrRevision, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsVersionString=wsVersionString, wsIbosTempHigh=wsIbosTempHigh, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPCopperLen=wsSFPCopperLen, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourCreated=wsNeighbourCreated, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPIndex=wsXFPIndex, wsVoltEntry=wsVoltEntry, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsTempMeasured=wsTempMeasured, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsIbosVoltHigh=wsIbosVoltHigh, wsTempTHYST=wsTempTHYST, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyInDrops=wsPolicyInDrops, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyName=wsPolicyName, wsNeighboursTable=wsNeighboursTable, wsPolicyCookie=wsPolicyCookie, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPEncoding=wsXFPEncoding, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsTempTOS=wsTempTOS, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTable=wsSFPTable, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, PYSNMP_MODULE_ID=ibos, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPStatus=wsXFPStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsFanTable=wsFanTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPStatus=wsSFPStatus, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPTransceiver=wsXFPTransceiver, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourHostname=wsNeighbourHostname, wsVoltNominal=wsVoltNominal, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPolicyOutBytes=wsPolicyOutBytes)
