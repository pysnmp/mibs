...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPTXPower=wsXFPTXPower, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsPolicyInDrops=wsPolicyInDrops, wsPolicyIfIndex=wsPolicyIfIndex, wsVersion=wsVersion, wsNeighboursTable=wsNeighboursTable, wsVersionString=wsVersionString, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPRXPower=wsSFPRXPower, wsSFPVoltStatus=wsSFPVoltStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsTempSensor=wsTempSensor, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPTempNormalLow=wsSFPTempNormalLow, wsEnvironment=wsEnvironment, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPFDP=wsPFDP, wsSFPTempStatus=wsSFPTempStatus, wsIbosTempHigh=wsIbosTempHigh, wsSFPBitrate=wsSFPBitrate, wsFanEntry=wsFanEntry, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyCookie=wsPolicyCookie, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsTempTHYST=wsTempTHYST, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPIndex=wsSFPIndex, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPRXPower=wsXFPRXPower, ibos=ibos, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPSerialNumber=wsSFPSerialNumber, wsVoltEntry=wsVoltEntry, wsXFPTransceiver=wsXFPTransceiver, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTransceiver=wsSFPTransceiver, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPIndex=wsXFPIndex, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTemp=wsSFPTemp, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPTemp=wsXFPTemp, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyInPkts=wsPolicyInPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourModel=wsNeighbourModel, wsFanTable=wsFanTable, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPolicyName=wsPolicyName, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVoltTable=wsVoltTable, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPCopperLen=wsSFPCopperLen, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsVoltMeasured=wsVoltMeasured, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourNIndex=wsNeighbourNIndex, wsVoltChannel=wsVoltChannel, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPEntry=wsXFPEntry, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsTempEntry=wsTempEntry, wsTempStatus=wsTempStatus, wsNeighbourState=wsNeighbourState, wsTempMeasured=wsTempMeasured, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsReload=wsReload, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortState=wsNeighbourPortState, wsXFPStatus=wsXFPStatus, wsTempThresholdLow=wsTempThresholdLow, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTable=wsXFPTable, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsIbosVoltLow=wsIbosVoltLow, wsXFPConnector=wsXFPConnector, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsFanNumber=wsFanNumber, wsSFPConnector=wsSFPConnector, wsSystem=wsSystem, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighboursEntry=wsNeighboursEntry, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTable=wsSFPTable, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPStatus=wsSFPStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXPower=wsSFPTXPower, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsFanRPM=wsFanRPM, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsAsrRevision=wsAsrRevision, wsWritedummy=wsWritedummy, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyTable=wsPolicyTable, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsIbosTempLow=wsIbosTempLow, wsVoltNominal=wsVoltNominal, wsNeighbourUptime=wsNeighbourUptime, wsPolicyEntry=wsPolicyEntry, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourSNPA=wsNeighbourSNPA, PYSNMP_MODULE_ID=ibos, wsAccounting=wsAccounting, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourHostname=wsNeighbourHostname, wsSFPSingleModeLen=wsSFPSingleModeLen, wsVoltStatus=wsVoltStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsTempTOS=wsTempTOS, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsTempTable=wsTempTable, wsSFPVolt=wsSFPVolt, wsSFPEntry=wsSFPEntry, wsFanVoltage=wsFanVoltage, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus)
