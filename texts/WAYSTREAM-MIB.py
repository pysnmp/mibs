...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXPower=wsSFPRXPower, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSystem=wsSystem, wsSFPTempStatus=wsSFPTempStatus, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosFanRPMLow=wsIbosFanRPMLow, wsPolicyTable=wsPolicyTable, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempStatus=wsTempStatus, wsTempTable=wsTempTable, wsTempEntry=wsTempEntry, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsIbosTempLow=wsIbosTempLow, wsSFPVolt=wsSFPVolt, wsVoltStatus=wsVoltStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsFanVoltage=wsFanVoltage, wsSFPSingleModeLen=wsSFPSingleModeLen, wsFanEntry=wsFanEntry, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourCreated=wsNeighbourCreated, wsVersion=wsVersion, wsSFPIndex=wsSFPIndex, wsNeighboursEntry=wsNeighboursEntry, wsSFPTempNormalLow=wsSFPTempNormalLow, wsTempThresholdLow=wsTempThresholdLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsTempTOS=wsTempTOS, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPEncoding=wsSFPEncoding, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTable=wsXFPTable, wsXFPRXPower=wsXFPRXPower, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsReload=wsReload, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPCopperLen=wsXFPCopperLen, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPEntry=wsXFPEntry, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPStatus=wsXFPStatus, wsSFPVoltStatus=wsSFPVoltStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXPower=wsSFPTXPower, wsTempMeasured=wsTempMeasured, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsIbosVoltHigh=wsIbosVoltHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsEnvironment=wsEnvironment, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPTransceiver=wsSFPTransceiver, wsVoltTable=wsVoltTable, wsPolicyOutPkts=wsPolicyOutPkts, wsPolicyInDrops=wsPolicyInDrops, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPStatus=wsSFPStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPCopperLen=wsSFPCopperLen, wsSFPSerialNumber=wsSFPSerialNumber, PYSNMP_MODULE_ID=ibos, wsSFPTemp=wsSFPTemp, wsAccounting=wsAccounting, wsVersionString=wsVersionString, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPEncoding=wsXFPEncoding, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsVoltEntry=wsVoltEntry, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsXFPTXPowerStatus=wsXFPTXPowerStatus, ibos=ibos, wsVoltChannel=wsVoltChannel, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsPolicyIfName=wsPolicyIfName, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsIbosTempHigh=wsIbosTempHigh, wsSFPBitrate=wsSFPBitrate, wsXFPIndex=wsXFPIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsTempSensor=wsTempSensor, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortState=wsNeighbourPortState, wsPolicyCookie=wsPolicyCookie, wsSFPConnector=wsSFPConnector, wsFanTable=wsFanTable, wsNeighbourSNPA=wsNeighbourSNPA, wsPFDP=wsPFDP, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTable=wsSFPTable, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighboursTable=wsNeighboursTable, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyName=wsPolicyName, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyInPkts=wsPolicyInPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPEntry=wsSFPEntry, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsAsrRevision=wsAsrRevision, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPTemp=wsXFPTemp, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPConnector=wsXFPConnector, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsWritedummy=wsWritedummy, wsVoltNominal=wsVoltNominal, wsIbosVoltLow=wsIbosVoltLow, wsFanRPM=wsFanRPM, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTempWarningLow=wsSFPTempWarningLow, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsFanNumber=wsFanNumber)
