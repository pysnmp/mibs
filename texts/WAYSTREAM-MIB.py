...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, ibos=ibos, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsVoltEntry=wsVoltEntry, wsFanTable=wsFanTable, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsXFPTable=wsXFPTable, wsTempTHYST=wsTempTHYST, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsEnvironment=wsEnvironment, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPEntry=wsSFPEntry, wsSFPBitrate=wsSFPBitrate, wsPolicyTable=wsPolicyTable, wsFanVoltage=wsFanVoltage, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsTempSensor=wsTempSensor, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsTempStatus=wsTempStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPolicyCookie=wsPolicyCookie, wsVoltNominal=wsVoltNominal, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPCopperLen=wsSFPCopperLen, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsVersion=wsVersion, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsVersionString=wsVersionString, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourCreated=wsNeighbourCreated, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsVoltTable=wsVoltTable, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsFanEntry=wsFanEntry, wsWritedummy=wsWritedummy, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPIndex=wsSFPIndex, wsPolicyEntry=wsPolicyEntry, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPTempStatus=wsXFPTempStatus, wsAccounting=wsAccounting, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSystem=wsSystem, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPFDP=wsPFDP, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPEntry=wsXFPEntry, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsTempTOS=wsTempTOS, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPConnector=wsSFPConnector, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTempStatus=wsSFPTempStatus, wsPolicyIfName=wsPolicyIfName, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosVoltLow=wsIbosVoltLow, wsTempMeasured=wsTempMeasured, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTable=wsSFPTable, wsXFPConnector=wsXFPConnector, wsSFPTemp=wsSFPTemp, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsTempEntry=wsTempEntry, wsXFPCopperLen=wsXFPCopperLen, wsAsrRevision=wsAsrRevision, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyInDrops=wsPolicyInDrops, wsXFPEncoding=wsXFPEncoding, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVoltStatus=wsVoltStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsFanRPM=wsFanRPM, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourUptime=wsNeighbourUptime, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsIbosTempLow=wsIbosTempLow, wsPolicyName=wsPolicyName, wsSFPVolt=wsSFPVolt, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPStatus=wsXFPStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPPartNumber=wsSFPPartNumber, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourState=wsNeighbourState, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPTemp=wsXFPTemp, wsVoltChannel=wsVoltChannel, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPIndex=wsXFPIndex, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsReload=wsReload, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPStatus=wsSFPStatus, wsFanNumber=wsFanNumber, wsNeighbourPortState=wsNeighbourPortState, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPRXPower=wsSFPRXPower, wsSFPTXPower=wsSFPTXPower, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyInBytes=wsPolicyInBytes, wsSFPEncoding=wsSFPEncoding, wsTempTable=wsTempTable)
