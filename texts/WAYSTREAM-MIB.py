...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourLastAct=wsNeighbourLastAct, wsXFPStatus=wsXFPStatus, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsTempEntry=wsTempEntry, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyIfName=wsPolicyIfName, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsWritedummy=wsWritedummy, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsTempSensor=wsTempSensor, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsEnvironment=wsEnvironment, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTempStatus=wsSFPTempStatus, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPVolt=wsSFPVolt, wsPolicyName=wsPolicyName, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsPolicyOutDrops=wsPolicyOutDrops, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXCurrent=wsSFPTXCurrent, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyTable=wsPolicyTable, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPFDP=wsPFDP, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosVoltHigh=wsIbosVoltHigh, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsPolicyOutPkts=wsPolicyOutPkts, wsSystem=wsSystem, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPTransceiver=wsXFPTransceiver, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsAsrRevision=wsAsrRevision, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPEntry=wsSFPEntry, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourUptime=wsNeighbourUptime, wsSFPEncoding=wsSFPEncoding, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVoltEntry=wsVoltEntry, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsFanVoltage=wsFanVoltage, wsFanNumber=wsFanNumber, wsTempThresholdHigh=wsTempThresholdHigh, wsVoltTable=wsVoltTable, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsTempStatus=wsTempStatus, wsPolicyEntry=wsPolicyEntry, wsNeighbourCreated=wsNeighbourCreated, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPPartNumber=wsSFPPartNumber, wsXFPTXPower=wsXFPTXPower, wsVoltChannel=wsVoltChannel, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPTemp=wsXFPTemp, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsVersionString=wsVersionString, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPTXPower=wsSFPTXPower, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempTHYST=wsTempTHYST, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVoltThresholdLow=wsVoltThresholdLow, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPStatus=wsSFPStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighboursEntry=wsNeighboursEntry, wsSFPTemp=wsSFPTemp, wsTempTable=wsTempTable, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPConnector=wsSFPConnector, wsSFPCopperLen=wsSFPCopperLen, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPTXPowerStatus=wsXFPTXPowerStatus, PYSNMP_MODULE_ID=ibos, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPEntry=wsXFPEntry, wsXFPTable=wsXFPTable, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsFanEntry=wsFanEntry, wsPolicyInBytes=wsPolicyInBytes, wsTempTOS=wsTempTOS, wsVersion=wsVersion, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourState=wsNeighbourState, wsXFPBitrateMin=wsXFPBitrateMin, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPConnector=wsXFPConnector, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighboursTable=wsNeighboursTable, wsNeighbourSNPA=wsNeighbourSNPA, wsReload=wsReload, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsVoltStatus=wsVoltStatus, wsVoltNominal=wsVoltNominal, ibos=ibos, wsSFPTable=wsSFPTable, wsIbosTempHigh=wsIbosTempHigh, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPEncoding=wsXFPEncoding, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPIndex=wsSFPIndex, wsTempMeasured=wsTempMeasured, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourOSVersion=wsNeighbourOSVersion, wsAccounting=wsAccounting, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPRXPower=wsSFPRXPower, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsFanTable=wsFanTable, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPBitrate=wsSFPBitrate, wsFanRPM=wsFanRPM, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyInDrops=wsPolicyInDrops)
