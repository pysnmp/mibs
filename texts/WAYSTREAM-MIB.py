...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPConnector=wsSFPConnector, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsEnvironment=wsEnvironment, wsXFPStatus=wsXFPStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsVersion=wsVersion, wsVoltStatus=wsVoltStatus, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltThresholdLow=wsVoltThresholdLow, wsAccounting=wsAccounting, wsNeighbourOSVersion=wsNeighbourOSVersion, wsTempStatus=wsTempStatus, wsXFPTXPower=wsXFPTXPower, wsIbosVoltHigh=wsIbosVoltHigh, wsPolicyEntry=wsPolicyEntry, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPBitrate=wsSFPBitrate, wsTempEntry=wsTempEntry, wsReload=wsReload, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsVoltChannel=wsVoltChannel, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPEntry=wsSFPEntry, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPCopperLen=wsXFPCopperLen, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsFanRPM=wsFanRPM, wsPFDP=wsPFDP, wsSFPEncoding=wsSFPEncoding, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyInDrops=wsPolicyInDrops, wsIbosVoltLow=wsIbosVoltLow, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighboursEntry=wsNeighboursEntry, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourCreated=wsNeighbourCreated, wsPolicyIfName=wsPolicyIfName, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsXFPEntry=wsXFPEntry, wsSFPIndex=wsSFPIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPRXPower=wsSFPRXPower, wsXFPBitrateMin=wsXFPBitrateMin, wsTempTHYST=wsTempTHYST, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsVoltEntry=wsVoltEntry, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsVoltMeasured=wsVoltMeasured, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourIfIndex=wsNeighbourIfIndex, wsFanNumber=wsFanNumber, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTemp=wsSFPTemp, wsVoltNominal=wsVoltNominal, wsPolicyTable=wsPolicyTable, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourHostname=wsNeighbourHostname, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPTable=wsXFPTable, ibos=ibos, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourLastAct=wsNeighbourLastAct, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsTempTOS=wsTempTOS, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPCopperLen=wsSFPCopperLen, wsPolicyName=wsPolicyName, wsSFPVolt=wsSFPVolt, wsXFPIndex=wsXFPIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsTempSensor=wsTempSensor, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPStatus=wsSFPStatus, wsIbosTempLow=wsIbosTempLow, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTransceiver=wsSFPTransceiver, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsFanTable=wsFanTable, wsSFPTable=wsSFPTable, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsXFPTemp=wsXFPTemp, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsTempMeasured=wsTempMeasured, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsWritedummy=wsWritedummy, wsTempTable=wsTempTable, wsXFPEncoding=wsXFPEncoding, wsVersionString=wsVersionString, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighboursTable=wsNeighboursTable, wsNeighbourModel=wsNeighbourModel, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPolicyInBytes=wsPolicyInBytes, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsVoltTable=wsVoltTable, wsFanEntry=wsFanEntry, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTempStatus=wsSFPTempStatus, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPPartNumber=wsSFPPartNumber, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXPower=wsSFPTXPower, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, PYSNMP_MODULE_ID=ibos, wsFanVoltage=wsFanVoltage, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourNIndex=wsNeighbourNIndex, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPConnector=wsXFPConnector, wsSystem=wsSystem, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsAsrRevision=wsAsrRevision)
