...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsXFPEncoding=wsXFPEncoding, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPTable=wsXFPTable, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPEntry=wsSFPEntry, wsTempMeasured=wsTempMeasured, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsXFPTempStatus=wsXFPTempStatus, wsEnvironment=wsEnvironment, wsVoltMeasured=wsVoltMeasured, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyInDrops=wsPolicyInDrops, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortState=wsNeighbourPortState, wsTempStatus=wsTempStatus, wsIbosVoltLow=wsIbosVoltLow, wsXFPConnector=wsXFPConnector, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighboursEntry=wsNeighboursEntry, wsSystem=wsSystem, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPCopperLen=wsXFPCopperLen, wsSFPPartNumber=wsSFPPartNumber, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyTable=wsPolicyTable, wsSFPEncoding=wsSFPEncoding, wsReload=wsReload, wsSFPBitrate=wsSFPBitrate, wsNeighbourSNPA=wsNeighbourSNPA, wsFanTable=wsFanTable, wsTempEntry=wsTempEntry, wsAccounting=wsAccounting, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPVolt=wsSFPVolt, wsIbosTempLow=wsIbosTempLow, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourNIndex=wsNeighbourNIndex, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPSingleModeLen=wsXFPSingleModeLen, wsIbosFanRPMLow=wsIbosFanRPMLow, wsWritedummy=wsWritedummy, wsPFDP=wsPFDP, wsSFPIndex=wsSFPIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTempWarningLow=wsSFPTempWarningLow, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPConnector=wsSFPConnector, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPTXCurrent=wsXFPTXCurrent, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsFanVoltage=wsFanVoltage, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourCreated=wsNeighbourCreated, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsPolicyIfName=wsPolicyIfName, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPTemp=wsXFPTemp, wsTempSensor=wsTempSensor, wsNeighbourState=wsNeighbourState, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsVersion=wsVersion, wsPolicyName=wsPolicyName, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTable=wsSFPTable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPCopperLen=wsSFPCopperLen, wsXFPBitrateMax=wsXFPBitrateMax, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsVersionString=wsVersionString, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourUptime=wsNeighbourUptime, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsFanRPM=wsFanRPM, wsVoltEntry=wsVoltEntry, wsSFPTransceiver=wsSFPTransceiver, wsVoltChannel=wsVoltChannel, ibos=ibos, wsVoltNominal=wsVoltNominal, wsFanNumber=wsFanNumber, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPEntry=wsXFPEntry, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPIndex=wsXFPIndex, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsTempTHYST=wsTempTHYST, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighboursTable=wsNeighboursTable, wsSFPTXPower=wsSFPTXPower, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourModel=wsNeighbourModel, wsTempThresholdLow=wsTempThresholdLow, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyEntry=wsPolicyEntry, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPTXPower=wsXFPTXPower, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTemp=wsSFPTemp, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPStatus=wsXFPStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsFanEntry=wsFanEntry, wsVoltTable=wsVoltTable, wsTempTOS=wsTempTOS, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTempStatus=wsSFPTempStatus, wsVoltStatus=wsVoltStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsTempThresholdHigh=wsTempThresholdHigh, wsTempTable=wsTempTable, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPStatus=wsSFPStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsAsrRevision=wsAsrRevision)
