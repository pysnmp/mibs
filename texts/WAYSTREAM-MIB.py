...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTemp=wsXFPTemp, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPTable=wsXFPTable, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsFanVoltage=wsFanVoltage, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsWritedummy=wsWritedummy, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsFanTable=wsFanTable, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsPolicyIfName=wsPolicyIfName, wsXFPIndex=wsXFPIndex, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourState=wsNeighbourState, wsXFPConnector=wsXFPConnector, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPCopperLen=wsSFPCopperLen, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsFanNumber=wsFanNumber, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsPolicyInPkts=wsPolicyInPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourModel=wsNeighbourModel, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPEncoding=wsSFPEncoding, wsEnvironment=wsEnvironment, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosTempLow=wsIbosTempLow, wsSystem=wsSystem, wsNeighbourPortName=wsNeighbourPortName, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsFanEntry=wsFanEntry, wsPFDP=wsPFDP, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsTempTable=wsTempTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsTempStatus=wsTempStatus, wsFanRPM=wsFanRPM, wsTempTOS=wsTempTOS, wsAccounting=wsAccounting, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTemp=wsSFPTemp, wsTempTHYST=wsTempTHYST, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPIndex=wsSFPIndex, wsSFPRXPower=wsSFPRXPower, wsReload=wsReload, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXPower=wsSFPTXPower, wsNeighboursTable=wsNeighboursTable, wsSFPStatus=wsSFPStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTable=wsSFPTable, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsAsrRevision=wsAsrRevision, wsIbosVoltLow=wsIbosVoltLow, wsXFPEncoding=wsXFPEncoding, wsSFPVolt=wsSFPVolt, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTempStatus=wsSFPTempStatus, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighboursEntry=wsNeighboursEntry, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVoltChannel=wsVoltChannel, wsNeighbourCreated=wsNeighbourCreated, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsVersionString=wsVersionString, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsVoltNominal=wsVoltNominal, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsVoltEntry=wsVoltEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyInDrops=wsPolicyInDrops, wsPolicyIfIndex=wsPolicyIfIndex, wsPolicyTable=wsPolicyTable, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsVoltStatus=wsVoltStatus, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPTempStatus=wsXFPTempStatus, wsTempMeasured=wsTempMeasured, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPConnector=wsSFPConnector, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPBitrateMax=wsXFPBitrateMax, wsTempEntry=wsTempEntry, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPTXCurrent=wsXFPTXCurrent, wsTempThresholdLow=wsTempThresholdLow, ibos=ibos, wsPolicyUsedCnt=wsPolicyUsedCnt, wsVoltTable=wsVoltTable, PYSNMP_MODULE_ID=ibos, wsXFPEntry=wsXFPEntry, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsTempSensor=wsTempSensor, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsVersion=wsVersion, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTransceiver=wsSFPTransceiver, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyEntry=wsPolicyEntry, wsVoltMeasured=wsVoltMeasured, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPEntry=wsSFPEntry, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyName=wsPolicyName, wsNeighbourLocalIf=wsNeighbourLocalIf, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPBitrate=wsSFPBitrate, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPSingleModeLen=wsXFPSingleModeLen)
