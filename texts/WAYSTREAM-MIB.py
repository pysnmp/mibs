...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPRXPower=wsXFPRXPower, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPTempStatus=wsSFPTempStatus, wsFanNumber=wsFanNumber, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsPolicyUsedCnt=wsPolicyUsedCnt, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsPolicyInPkts=wsPolicyInPkts, wsVoltEntry=wsVoltEntry, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsIbosTempLow=wsIbosTempLow, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourSNPA=wsNeighbourSNPA, wsTempTable=wsTempTable, wsSFPConnector=wsSFPConnector, wsSFPTXPower=wsSFPTXPower, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsVoltTable=wsVoltTable, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPEncoding=wsSFPEncoding, wsNeighbourUptime=wsNeighbourUptime, wsVersionString=wsVersionString, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsIbosVoltLow=wsIbosVoltLow, wsTempTOS=wsTempTOS, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPStatus=wsSFPStatus, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPIndex=wsSFPIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPPartNumber=wsSFPPartNumber, wsTempMeasured=wsTempMeasured, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyEntry=wsPolicyEntry, wsXFPIndex=wsXFPIndex, wsPolicyTable=wsPolicyTable, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourHostname=wsNeighbourHostname, wsXFPTXCurrent=wsXFPTXCurrent, wsTempThresholdHigh=wsTempThresholdHigh, wsFanRPM=wsFanRPM, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, PYSNMP_MODULE_ID=ibos, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsWritedummy=wsWritedummy, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPVolt=wsSFPVolt, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPEntry=wsXFPEntry, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsVoltNominal=wsVoltNominal, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPRXPower=wsSFPRXPower, wsFanVoltage=wsFanVoltage, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPolicyIfName=wsPolicyIfName, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsXFPTemp=wsXFPTemp, wsPolicyInDrops=wsPolicyInDrops, wsIbosTempHigh=wsIbosTempHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortName=wsNeighbourPortName, wsXFPConnector=wsXFPConnector, wsXFPTable=wsXFPTable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPCopperLen=wsXFPCopperLen, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsFanEntry=wsFanEntry, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsVoltMeasured=wsVoltMeasured, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSystem=wsSystem, wsSFPTemp=wsSFPTemp, wsSFPTransceiver=wsSFPTransceiver, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsAsrRevision=wsAsrRevision, wsReload=wsReload, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyCookie=wsPolicyCookie, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsVoltChannel=wsVoltChannel, wsEnvironment=wsEnvironment, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourLastAct=wsNeighbourLastAct, wsPolicyIfIndex=wsPolicyIfIndex, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsVersion=wsVersion, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsAccounting=wsAccounting, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourModel=wsNeighbourModel, ibos=ibos, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsTempStatus=wsTempStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPTable=wsSFPTable, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyName=wsPolicyName, wsSFPEntry=wsSFPEntry, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortState=wsNeighbourPortState, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourState=wsNeighbourState, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVoltStatus=wsVoltStatus, wsXFPStatus=wsXFPStatus, wsSFPBitrate=wsSFPBitrate, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsTempEntry=wsTempEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPFDP=wsPFDP, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTempStatus=wsXFPTempStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsXFPBitrateMin=wsXFPBitrateMin, wsFanTable=wsFanTable, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPVoltStatus=wsSFPVoltStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTempNormalLow=wsSFPTempNormalLow, wsTempSensor=wsTempSensor, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast)
