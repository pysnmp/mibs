...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsTempTHYST=wsTempTHYST, wsIbosVoltHigh=wsIbosVoltHigh, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsWritedummy=wsWritedummy, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsTempMeasured=wsTempMeasured, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsVoltStatus=wsVoltStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPConnector=wsXFPConnector, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPStatus=wsSFPStatus, PYSNMP_MODULE_ID=ibos, wsFanRPM=wsFanRPM, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTempStatus=wsSFPTempStatus, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPTable=wsXFPTable, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsReload=wsReload, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighboursEntry=wsNeighboursEntry, wsAsrRevision=wsAsrRevision, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPTXCurrent=wsSFPTXCurrent, wsVoltEntry=wsVoltEntry, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPStatus=wsXFPStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsVoltThresholdHigh=wsVoltThresholdHigh, wsVersionString=wsVersionString, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsFanNumber=wsFanNumber, wsTempEntry=wsTempEntry, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighboursTable=wsNeighboursTable, wsNeighbourModel=wsNeighbourModel, wsFanEntry=wsFanEntry, wsPolicyName=wsPolicyName, wsSFPRXPower=wsSFPRXPower, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPTemp=wsXFPTemp, wsVoltTable=wsVoltTable, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPEncoding=wsSFPEncoding, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPEntry=wsXFPEntry, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsPolicyEntry=wsPolicyEntry, wsSFPTXPower=wsSFPTXPower, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPTXPower=wsXFPTXPower, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPBitrate=wsSFPBitrate, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTemp=wsSFPTemp, wsIbosTempLow=wsIbosTempLow, wsSystem=wsSystem, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosTempHigh=wsIbosTempHigh, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTable=wsSFPTable, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPConnector=wsSFPConnector, wsSFPIndex=wsSFPIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourHostname=wsNeighbourHostname, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourIfIndex=wsNeighbourIfIndex, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPTempStatus=wsXFPTempStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsVoltChannel=wsVoltChannel, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsVersion=wsVersion, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTransceiver=wsSFPTransceiver, wsSFPCopperLen=wsSFPCopperLen, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPIndex=wsXFPIndex, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsAccounting=wsAccounting, wsPFDP=wsPFDP, wsSFPVolt=wsSFPVolt, wsNeighbourSNPA=wsNeighbourSNPA, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPEntry=wsSFPEntry, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourCreated=wsNeighbourCreated, wsPolicyTable=wsPolicyTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsTempTable=wsTempTable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsFanTable=wsFanTable, wsTempStatus=wsTempStatus, wsEnvironment=wsEnvironment, wsNeighbourState=wsNeighbourState, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPRXPower=wsXFPRXPower, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsFanVoltage=wsFanVoltage, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyIfName=wsPolicyIfName, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempSensor=wsTempSensor, wsVoltNominal=wsVoltNominal, ibos=ibos, wsTempTOS=wsTempTOS, wsIbosVoltLow=wsIbosVoltLow, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts)
