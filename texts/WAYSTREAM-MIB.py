...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyIfName=wsPolicyIfName, wsIbosTempHigh=wsIbosTempHigh, wsXFPTable=wsXFPTable, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSystem=wsSystem, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsXFPCopperLen=wsXFPCopperLen, wsSFPIndex=wsSFPIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPPartNumber=wsSFPPartNumber, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourHostname=wsNeighbourHostname, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourUptime=wsNeighbourUptime, wsVoltMeasured=wsVoltMeasured, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPRXPower=wsXFPRXPower, wsSFPStatus=wsSFPStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPEncoding=wsXFPEncoding, wsVersion=wsVersion, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourOSVersion=wsNeighbourOSVersion, wsXFPTransceiver=wsXFPTransceiver, wsNeighboursEntry=wsNeighboursEntry, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsAccounting=wsAccounting, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsTempStatus=wsTempStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourDBCount=wsNeighbourDBCount, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsPolicyTable=wsPolicyTable, wsAsrRevision=wsAsrRevision, wsTempTable=wsTempTable, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortName=wsNeighbourPortName, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsTempSensor=wsTempSensor, ibos=ibos, wsSFPEntry=wsSFPEntry, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsPolicyName=wsPolicyName, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourSNPA=wsNeighbourSNPA, wsFanTable=wsFanTable, wsSFPEncoding=wsSFPEncoding, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourNIndex=wsNeighbourNIndex, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsVoltNominal=wsVoltNominal, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPFDP=wsPFDP, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPBitrate=wsSFPBitrate, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPIndex=wsXFPIndex, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsFanVoltage=wsFanVoltage, wsNeighboursTable=wsNeighboursTable, wsTempTOS=wsTempTOS, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsReload=wsReload, wsFanRPM=wsFanRPM, wsSFPConnector=wsSFPConnector, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPTemp=wsXFPTemp, wsVoltStatus=wsVoltStatus, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsXFPStatus=wsXFPStatus, wsSFPVolt=wsSFPVolt, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsTempMeasured=wsTempMeasured, wsVersionString=wsVersionString, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortState=wsNeighbourPortState, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXPower=wsSFPRXPower, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourState=wsNeighbourState, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPTempStatus=wsXFPTempStatus, wsEnvironment=wsEnvironment, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTransceiver=wsSFPTransceiver, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, PYSNMP_MODULE_ID=ibos, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTable=wsSFPTable, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPEntry=wsXFPEntry, wsSFPCopperLen=wsSFPCopperLen, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsIbosFanRPMLow=wsIbosFanRPMLow, wsWritedummy=wsWritedummy, wsFanNumber=wsFanNumber, wsXFPConnector=wsXFPConnector, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsTempEntry=wsTempEntry, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXCurrent=wsSFPTXCurrent, wsPolicyIfIndex=wsPolicyIfIndex, wsVoltTable=wsVoltTable, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsIbosTempLow=wsIbosTempLow, wsVoltEntry=wsVoltEntry, wsVoltThresholdLow=wsVoltThresholdLow, wsFanEntry=wsFanEntry, wsSFPTemp=wsSFPTemp, wsPolicyEntry=wsPolicyEntry, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex)
