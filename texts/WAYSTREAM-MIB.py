...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPStatus=wsXFPStatus, wsFanNumber=wsFanNumber, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, PYSNMP_MODULE_ID=ibos, wsIbosVoltLow=wsIbosVoltLow, wsPolicyInPkts=wsPolicyInPkts, wsTempStatus=wsTempStatus, wsSFPEncoding=wsSFPEncoding, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempTable=wsTempTable, wsNeighbourOSVersion=wsNeighbourOSVersion, wsWritedummy=wsWritedummy, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPRXPower=wsXFPRXPower, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourModel=wsNeighbourModel, wsTempMeasured=wsTempMeasured, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPTemp=wsSFPTemp, wsFanTable=wsFanTable, wsXFPEncoding=wsXFPEncoding, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPVolt=wsSFPVolt, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPTransceiver=wsXFPTransceiver, wsSFPTable=wsSFPTable, ibos=ibos, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVoltChannel=wsVoltChannel, wsPolicyOutBytes=wsPolicyOutBytes, wsVersion=wsVersion, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsVoltThresholdLow=wsVoltThresholdLow, wsTempSensor=wsTempSensor, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsAccounting=wsAccounting, wsIbosVoltHigh=wsIbosVoltHigh, wsFanEntry=wsFanEntry, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPConnector=wsXFPConnector, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPCopperLen=wsSFPCopperLen, wsVoltEntry=wsVoltEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsVoltMeasured=wsVoltMeasured, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPEntry=wsSFPEntry, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyTable=wsPolicyTable, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTempNormalLow=wsSFPTempNormalLow, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTransceiver=wsSFPTransceiver, wsVoltStatus=wsVoltStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsVoltTable=wsVoltTable, wsXFPTXCurrent=wsXFPTXCurrent, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPBitrate=wsSFPBitrate, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPTable=wsXFPTable, wsAsrRevision=wsAsrRevision, wsFanRPM=wsFanRPM, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourHostname=wsNeighbourHostname, wsSystem=wsSystem, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortName=wsNeighbourPortName, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsTempTOS=wsTempTOS, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPolicyName=wsPolicyName, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPIndex=wsXFPIndex, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPPartNumber=wsSFPPartNumber, wsXFPCopperLen=wsXFPCopperLen, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsReload=wsReload, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortsTable=wsNeighbourPortsTable, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPEntry=wsXFPEntry, wsNeighboursTable=wsNeighboursTable, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsEnvironment=wsEnvironment, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsVoltNominal=wsVoltNominal, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPStatus=wsSFPStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsTempEntry=wsTempEntry, wsTempThresholdLow=wsTempThresholdLow, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPIndex=wsSFPIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPTemp=wsXFPTemp, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsVersionString=wsVersionString, wsSFPConnector=wsSFPConnector, wsPFDP=wsPFDP, wsSFPTXPower=wsSFPTXPower, wsXFPTXPower=wsXFPTXPower, wsPolicyCookie=wsPolicyCookie, wsPolicyInBytes=wsPolicyInBytes, wsTempTHYST=wsTempTHYST, wsSFPRXdBmPower=wsSFPRXdBmPower, wsPolicyEntry=wsPolicyEntry, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourState=wsNeighbourState, wsSFPRXPower=wsSFPRXPower, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsTempThresholdHigh=wsTempThresholdHigh)
