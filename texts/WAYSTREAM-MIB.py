...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsVoltEntry=wsVoltEntry, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsXFPEncoding=wsXFPEncoding, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPSingleModeLen=wsSFPSingleModeLen, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsVoltMeasured=wsVoltMeasured, wsXFPIndex=wsXFPIndex, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyInBytes=wsPolicyInBytes, ibos=ibos, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsNeighbourLastAct=wsNeighbourLastAct, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsPolicyInDrops=wsPolicyInDrops, wsXFPBitrateMin=wsXFPBitrateMin, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsFanTable=wsFanTable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsIbosTempLow=wsIbosTempLow, wsSFPTXPower=wsSFPTXPower, wsXFPStatus=wsXFPStatus, wsTempTOS=wsTempTOS, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighboursEntry=wsNeighboursEntry, wsIbosTempHigh=wsIbosTempHigh, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPEntry=wsSFPEntry, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsXFPConnector=wsXFPConnector, wsSFPTable=wsSFPTable, wsSFPConnector=wsSFPConnector, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsXFPRXPower=wsXFPRXPower, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTempStatus=wsSFPTempStatus, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsTempTHYST=wsTempTHYST, wsSFPTempNormalLow=wsSFPTempNormalLow, PYSNMP_MODULE_ID=ibos, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPBitrate=wsSFPBitrate, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempSensor=wsTempSensor, wsXFPTXPower=wsXFPTXPower, wsSFPStatus=wsSFPStatus, wsVoltTable=wsVoltTable, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPEncoding=wsSFPEncoding, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsEnvironment=wsEnvironment, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyCookie=wsPolicyCookie, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsWritedummy=wsWritedummy, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPPartNumber=wsSFPPartNumber, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyTable=wsPolicyTable, wsSFPVolt=wsSFPVolt, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsTempMeasured=wsTempMeasured, wsVoltThresholdLow=wsVoltThresholdLow, wsSystem=wsSystem, wsVersion=wsVersion, wsPolicyEntry=wsPolicyEntry, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPFDP=wsPFDP, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPTable=wsXFPTable, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsFanRPM=wsFanRPM, wsFanVoltage=wsFanVoltage, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsPolicyName=wsPolicyName, wsVoltNominal=wsVoltNominal, wsPolicyOutBytes=wsPolicyOutBytes, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltChannel=wsVoltChannel, wsSFPVoltStatus=wsSFPVoltStatus, wsPolicyIfName=wsPolicyIfName, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsReload=wsReload, wsNeighbourPortState=wsNeighbourPortState, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsFanEntry=wsFanEntry, wsTempStatus=wsTempStatus, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsAccounting=wsAccounting, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVersionString=wsVersionString, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourUptime=wsNeighbourUptime, wsXFPCopperLen=wsXFPCopperLen, wsNeighboursTable=wsNeighboursTable, wsAsrRevision=wsAsrRevision, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsVoltStatus=wsVoltStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsTempTable=wsTempTable, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPIndex=wsSFPIndex, wsSFPRXPower=wsSFPRXPower, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourNIndex=wsNeighbourNIndex, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTemp=wsSFPTemp, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsXFPEntry=wsXFPEntry, wsSFPTempWarningLow=wsSFPTempWarningLow, wsTempEntry=wsTempEntry, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsFanNumber=wsFanNumber, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourModel=wsNeighbourModel, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm)
