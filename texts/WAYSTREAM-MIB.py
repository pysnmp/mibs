...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsFanTable=wsFanTable, wsVoltStatus=wsVoltStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsVoltNominal=wsVoltNominal, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsTempTHYST=wsTempTHYST, wsVoltMeasured=wsVoltMeasured, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsVersionString=wsVersionString, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourState=wsNeighbourState, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSystem=wsSystem, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPTemp=wsSFPTemp, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXdBmPower=wsSFPTXdBmPower, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPEncoding=wsXFPEncoding, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPPartNumber=wsSFPPartNumber, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsVoltTable=wsVoltTable, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsVoltThresholdHigh=wsVoltThresholdHigh, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsFanEntry=wsFanEntry, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourDBCount=wsNeighbourDBCount, wsWritedummy=wsWritedummy, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsPolicyName=wsPolicyName, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsXFPSingleModeLen=wsXFPSingleModeLen, wsFanNumber=wsFanNumber, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsPolicyTable=wsPolicyTable, ibos=ibos, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPConnector=wsSFPConnector, wsPolicyInDrops=wsPolicyInDrops, wsPFDP=wsPFDP, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortState=wsNeighbourPortState, wsXFPConnector=wsXFPConnector, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPolicyIfName=wsPolicyIfName, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPTransceiver=wsXFPTransceiver, wsTempTOS=wsTempTOS, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsVoltEntry=wsVoltEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourModel=wsNeighbourModel, wsAsrRevision=wsAsrRevision, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPTable=wsSFPTable, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTempStatus=wsSFPTempStatus, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsXFPTemp=wsXFPTemp, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPStatus=wsXFPStatus, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPEncoding=wsSFPEncoding, wsSFPCopperLen=wsSFPCopperLen, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourCreated=wsNeighbourCreated, wsTempEntry=wsTempEntry, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsTempMeasured=wsTempMeasured, wsEnvironment=wsEnvironment, wsReload=wsReload, wsVoltChannel=wsVoltChannel, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsAccounting=wsAccounting, wsNeighbourSNPA=wsNeighbourSNPA, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPIndex=wsXFPIndex, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsVersion=wsVersion, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPRXPower=wsSFPRXPower, wsXFPTable=wsXFPTable, wsPolicyInPkts=wsPolicyInPkts, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsTempThresholdLow=wsTempThresholdLow, wsSFPStatus=wsSFPStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPCopperLen=wsXFPCopperLen, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsIbosTempLow=wsIbosTempLow, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsTempSensor=wsTempSensor, wsXFPEntry=wsXFPEntry, wsSFPVolt=wsSFPVolt, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourHostname=wsNeighbourHostname, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsXFPRXPower=wsXFPRXPower, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsFanRPM=wsFanRPM, wsFanVoltage=wsFanVoltage, wsNeighboursTable=wsNeighboursTable, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyIfIndex=wsPolicyIfIndex, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosVoltLow=wsIbosVoltLow, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortName=wsNeighbourPortName, wsSFPEntry=wsSFPEntry, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXPower=wsSFPTXPower, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPIndex=wsSFPIndex, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsTempTable=wsTempTable, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, PYSNMP_MODULE_ID=ibos, wsXFPTXPower=wsXFPTXPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsTempStatus=wsTempStatus)
