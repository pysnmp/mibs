...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTable=wsXFPTable, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsVoltStatus=wsVoltStatus, wsTempTHYST=wsTempTHYST, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsReload=wsReload, wsTempEntry=wsTempEntry, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsXFPCopperLen=wsXFPCopperLen, wsNeighboursEntry=wsNeighboursEntry, wsVoltThresholdHigh=wsVoltThresholdHigh, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, ibos=ibos, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPConnector=wsSFPConnector, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVersionString=wsVersionString, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsFanNumber=wsFanNumber, wsVersion=wsVersion, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsTempTable=wsTempTable, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortState=wsNeighbourPortState, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPEntry=wsXFPEntry, wsPolicyCookie=wsPolicyCookie, wsSFPEncoding=wsSFPEncoding, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPVolt=wsSFPVolt, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsVoltTable=wsVoltTable, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsFanTable=wsFanTable, wsNeighboursTable=wsNeighboursTable, wsTempThresholdLow=wsTempThresholdLow, wsPolicyTable=wsPolicyTable, wsSFPTXdBmPower=wsSFPTXdBmPower, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourCreated=wsNeighbourCreated, wsSFPVoltStatus=wsSFPVoltStatus, wsNeighbourPortName=wsNeighbourPortName, wsVoltThresholdLow=wsVoltThresholdLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPBitrate=wsSFPBitrate, wsWritedummy=wsWritedummy, wsXFPTempStatus=wsXFPTempStatus, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsXFPBitrateMin=wsXFPBitrateMin, wsVoltChannel=wsVoltChannel, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPPartNumber=wsSFPPartNumber, wsXFPConnector=wsXFPConnector, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsFanVoltage=wsFanVoltage, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsTempTOS=wsTempTOS, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsFanEntry=wsFanEntry, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPEntry=wsSFPEntry, wsPFDP=wsPFDP, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsPolicyInPkts=wsPolicyInPkts, wsTempSensor=wsTempSensor, wsFanRPM=wsFanRPM, wsNeighbourState=wsNeighbourState, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPTemp=wsXFPTemp, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsNeighbourPortsTable=wsNeighbourPortsTable, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSystem=wsSystem, wsTempStatus=wsTempStatus, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyUsedCnt=wsPolicyUsedCnt, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPBitrateMax=wsXFPBitrateMax, wsAsrRevision=wsAsrRevision, wsPolicyInBytes=wsPolicyInBytes, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPIndex=wsSFPIndex, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTable=wsSFPTable, wsXFPRXPower=wsXFPRXPower, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsPolicyName=wsPolicyName, wsPolicyEntry=wsPolicyEntry, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourSNPA=wsNeighbourSNPA, wsIbosVoltLow=wsIbosVoltLow, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyInDrops=wsPolicyInDrops, wsVoltNominal=wsVoltNominal, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsNeighbourHostname=wsNeighbourHostname, wsVoltMeasured=wsVoltMeasured, wsXFPStatus=wsXFPStatus, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPIndex=wsXFPIndex, wsXFPEncoding=wsXFPEncoding, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPStatus=wsSFPStatus, wsXFPTXPower=wsXFPTXPower, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsTempThresholdHigh=wsTempThresholdHigh, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsVoltEntry=wsVoltEntry, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyOutPkts=wsPolicyOutPkts, wsEnvironment=wsEnvironment, wsPolicyOutDrops=wsPolicyOutDrops, wsTempMeasured=wsTempMeasured, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTransceiver=wsSFPTransceiver, PYSNMP_MODULE_ID=ibos, wsSFPRXPower=wsSFPRXPower, wsPolicyIfIndex=wsPolicyIfIndex, wsAccounting=wsAccounting, wsSFPTemp=wsSFPTemp, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit)
