...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsTempTOS=wsTempTOS, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsIbosVoltLow=wsIbosVoltLow, wsTempSensor=wsTempSensor, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighboursTable=wsNeighboursTable, wsXFPEncoding=wsXFPEncoding, wsXFPEntry=wsXFPEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPTable=wsXFPTable, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourState=wsNeighbourState, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyInDrops=wsPolicyInDrops, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsAsrRevision=wsAsrRevision, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsSFPCopperLen=wsSFPCopperLen, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsPolicyOutPkts=wsPolicyOutPkts, wsFanVoltage=wsFanVoltage, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPFDP=wsPFDP, wsVersionString=wsVersionString, wsTempTable=wsTempTable, wsSFPTempStatus=wsSFPTempStatus, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsTempEntry=wsTempEntry, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsTempTHYST=wsTempTHYST, wsPolicyIfName=wsPolicyIfName, wsIbosTempHigh=wsIbosTempHigh, wsXFPConnector=wsXFPConnector, wsVoltEntry=wsVoltEntry, wsPolicyInPkts=wsPolicyInPkts, wsEnvironment=wsEnvironment, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsXFPTXPower=wsXFPTXPower, wsXFPCopperLen=wsXFPCopperLen, PYSNMP_MODULE_ID=ibos, wsReload=wsReload, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsXFPBitrateMax=wsXFPBitrateMax, wsIbosTempLow=wsIbosTempLow, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTempNormalLow=wsSFPTempNormalLow, wsWritedummy=wsWritedummy, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsPolicyInBytes=wsPolicyInBytes, wsSFPVolt=wsSFPVolt, wsFanNumber=wsFanNumber, wsPolicyEntry=wsPolicyEntry, wsSFPRXPower=wsSFPRXPower, wsXFPIndex=wsXFPIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTable=wsSFPTable, wsXFPTemp=wsXFPTemp, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighbourModel=wsNeighbourModel, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPRXdBmPower=wsSFPRXdBmPower, wsSFPTransceiver=wsSFPTransceiver, wsXFPTempStatus=wsXFPTempStatus, wsTempStatus=wsTempStatus, wsPolicyOutDrops=wsPolicyOutDrops, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsVoltChannel=wsVoltChannel, wsPolicyTable=wsPolicyTable, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourUptime=wsNeighbourUptime, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsVoltNominal=wsVoltNominal, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPTXCurrent=wsXFPTXCurrent, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsFanTable=wsFanTable, wsSFPConnector=wsSFPConnector, wsNeighboursEntry=wsNeighboursEntry, wsSFPStatus=wsSFPStatus, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPRXPower=wsXFPRXPower, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPIndex=wsSFPIndex, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPPartNumber=wsSFPPartNumber, wsSFPEntry=wsSFPEntry, ibos=ibos, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsAccounting=wsAccounting, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsFanEntry=wsFanEntry, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourIfIndex=wsNeighbourIfIndex, wsVoltTable=wsVoltTable, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsTempThresholdLow=wsTempThresholdLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPStatus=wsXFPStatus, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortState=wsNeighbourPortState, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsVoltStatus=wsVoltStatus, wsSFPTXPower=wsSFPTXPower, wsSFPVoltStatus=wsSFPVoltStatus, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSystem=wsSystem, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsTempMeasured=wsTempMeasured, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsFanRPM=wsFanRPM, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPolicyName=wsPolicyName, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPTransceiver=wsXFPTransceiver, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourOSVersion=wsNeighbourOSVersion, wsVersion=wsVersion, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTemp=wsSFPTemp, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments)
