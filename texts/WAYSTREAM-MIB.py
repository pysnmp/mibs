...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsIbosVoltLow=wsIbosVoltLow, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsReload=wsReload, wsSFPTemp=wsSFPTemp, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsFanTable=wsFanTable, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPEncoding=wsSFPEncoding, wsXFPTransceiver=wsXFPTransceiver, wsTempTable=wsTempTable, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsPolicyInDrops=wsPolicyInDrops, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPCopperLen=wsSFPCopperLen, wsSFPTempStatus=wsSFPTempStatus, wsSFPStatus=wsSFPStatus, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsEnvironment=wsEnvironment, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsIbosVoltHigh=wsIbosVoltHigh, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourUptime=wsNeighbourUptime, wsTempThresholdLow=wsTempThresholdLow, wsSFPIndex=wsSFPIndex, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsSFPTXPower=wsSFPTXPower, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPSingleModeLen=wsXFPSingleModeLen, wsNeighbourModel=wsNeighbourModel, wsSFPVoltStatus=wsSFPVoltStatus, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPEntry=wsXFPEntry, wsFanRPM=wsFanRPM, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsTempTOS=wsTempTOS, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsAccounting=wsAccounting, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPIndex=wsXFPIndex, wsVoltStatus=wsVoltStatus, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPTXPower=wsXFPTXPower, wsVoltThresholdLow=wsVoltThresholdLow, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsTempSensor=wsTempSensor, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsFanEntry=wsFanEntry, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPEncoding=wsXFPEncoding, wsTempMeasured=wsTempMeasured, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPConnector=wsSFPConnector, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPConnector=wsXFPConnector, wsXFPTemp=wsXFPTemp, wsXFPRXPower=wsXFPRXPower, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsTempStatus=wsTempStatus, wsPolicyEntry=wsPolicyEntry, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPSerialNumber=wsSFPSerialNumber, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsPolicyIfName=wsPolicyIfName, wsXFPBitrateMax=wsXFPBitrateMax, wsSFPEntry=wsSFPEntry, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortName=wsNeighbourPortName, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourState=wsNeighbourState, wsXFPTempStatus=wsXFPTempStatus, wsVoltMeasured=wsVoltMeasured, wsTempEntry=wsTempEntry, wsVoltTable=wsVoltTable, wsNeighboursEntry=wsNeighboursEntry, wsXFPTable=wsXFPTable, wsSystem=wsSystem, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighboursTable=wsNeighboursTable, wsTempTHYST=wsTempTHYST, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPCopperLen=wsXFPCopperLen, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPTXCurrent=wsXFPTXCurrent, wsAsrRevision=wsAsrRevision, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsPolicyIfIndex=wsPolicyIfIndex, wsVersionString=wsVersionString, wsVoltNominal=wsVoltNominal, PYSNMP_MODULE_ID=ibos, wsFanVoltage=wsFanVoltage, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsVoltEntry=wsVoltEntry, wsVoltChannel=wsVoltChannel, wsPolicyInBytes=wsPolicyInBytes, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPStatus=wsXFPStatus, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsIbosFanRPMLow=wsIbosFanRPMLow, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, ibos=ibos, wsSFPVolt=wsSFPVolt, wsPolicyName=wsPolicyName, wsVersion=wsVersion, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTable=wsSFPTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPFDP=wsPFDP, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsFanNumber=wsFanNumber, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsWritedummy=wsWritedummy, wsSFPRXPower=wsSFPRXPower, wsSFPTransceiver=wsSFPTransceiver, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts)
