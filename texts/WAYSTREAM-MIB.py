...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPTXPower=wsSFPTXPower, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsXFPTable=wsXFPTable, wsWritedummy=wsWritedummy, wsNeighbourState=wsNeighbourState, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsSFPStatus=wsSFPStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourUptime=wsNeighbourUptime, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyIfIndex=wsPolicyIfIndex, wsAsrRevision=wsAsrRevision, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourIfIndex=wsNeighbourIfIndex, wsXFPEntry=wsXFPEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPTransceiver=wsXFPTransceiver, wsSFPTransceiver=wsSFPTransceiver, wsXFPTXPower=wsXFPTXPower, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsVoltTable=wsVoltTable, wsVoltStatus=wsVoltStatus, wsTempSensor=wsTempSensor, wsPolicyOutBytes=wsPolicyOutBytes, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsXFPEncoding=wsXFPEncoding, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPPartNumber=wsSFPPartNumber, wsEnvironment=wsEnvironment, wsTempEntry=wsTempEntry, wsSFPTemp=wsSFPTemp, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsTempThresholdHigh=wsTempThresholdHigh, wsFanTable=wsFanTable, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPSingleModeLen=wsSFPSingleModeLen, wsPolicyInDrops=wsPolicyInDrops, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsIbosTempLow=wsIbosTempLow, wsVoltNominal=wsVoltNominal, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsXFPBitrateMax=wsXFPBitrateMax, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsPolicyUsedCnt=wsPolicyUsedCnt, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyName=wsPolicyName, wsNeighbourModel=wsNeighbourModel, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPTempStatus=wsSFPTempStatus, wsFanVoltage=wsFanVoltage, wsPFDP=wsPFDP, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsAccounting=wsAccounting, wsPolicyTable=wsPolicyTable, wsXFPConnector=wsXFPConnector, wsXFPStatus=wsXFPStatus, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsReload=wsReload, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPVolt=wsSFPVolt, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPCopperLen=wsSFPCopperLen, wsPolicyEntry=wsPolicyEntry, wsPolicyInBytes=wsPolicyInBytes, wsFanEntry=wsFanEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsPolicyCookie=wsPolicyCookie, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempMeasured=wsTempMeasured, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsVoltEntry=wsVoltEntry, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPEntry=wsSFPEntry, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsSFPVoltStatus=wsSFPVoltStatus, wsTempTOS=wsTempTOS, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortState=wsNeighbourPortState, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsVersionString=wsVersionString, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsVoltThresholdLow=wsVoltThresholdLow, wsTempTable=wsTempTable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTable=wsSFPTable, ibos=ibos, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsFanNumber=wsFanNumber, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPRXPower=wsXFPRXPower, wsXFPTemp=wsXFPTemp, PYSNMP_MODULE_ID=ibos, wsVoltChannel=wsVoltChannel, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPSingleModeLen=wsXFPSingleModeLen, wsPolicyIfName=wsPolicyIfName, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighboursTable=wsNeighboursTable, wsXFPIndex=wsXFPIndex, wsTempStatus=wsTempStatus, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPEncoding=wsSFPEncoding, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsXFPBitrateMin=wsXFPBitrateMin, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsSFPConnector=wsSFPConnector, wsNeighbourCreated=wsNeighbourCreated, wsSFPTXdBmPower=wsSFPTXdBmPower, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsIbosVoltLow=wsIbosVoltLow, wsSystem=wsSystem, wsTempTHYST=wsTempTHYST, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPIndex=wsSFPIndex, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPRXPower=wsSFPRXPower, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVersion=wsVersion, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsFanRPM=wsFanRPM, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPBitrate=wsSFPBitrate, wsNeighboursEntry=wsNeighboursEntry, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex)
