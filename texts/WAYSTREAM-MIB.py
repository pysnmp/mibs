...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsTempEntry=wsTempEntry, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsPolicyOutDrops=wsPolicyOutDrops, wsVoltTable=wsVoltTable, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourModel=wsNeighbourModel, wsSFPSingleModeLen=wsSFPSingleModeLen, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPIndex=wsSFPIndex, wsSFPTXPower=wsSFPTXPower, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSystem=wsSystem, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsXFPTable=wsXFPTable, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortName=wsNeighbourPortName, wsSFPConnector=wsSFPConnector, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsTempTable=wsTempTable, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsSFPTable=wsSFPTable, wsSFPCopperLen=wsSFPCopperLen, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsFanNumber=wsFanNumber, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPConnector=wsXFPConnector, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsSFPEntry=wsSFPEntry, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsPolicyName=wsPolicyName, wsXFPSingleModeLen=wsXFPSingleModeLen, ibos=ibos, wsXFPTempStatus=wsXFPTempStatus, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsTempSensor=wsTempSensor, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourUptime=wsNeighbourUptime, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsVoltChannel=wsVoltChannel, wsFanEntry=wsFanEntry, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsPolicyCookie=wsPolicyCookie, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourLocalIf=wsNeighbourLocalIf, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsTempTOS=wsTempTOS, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsIbosFanRPMLow=wsIbosFanRPMLow, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsWritedummy=wsWritedummy, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourHostname=wsNeighbourHostname, wsVoltStatus=wsVoltStatus, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsAccounting=wsAccounting, wsNeighbourState=wsNeighbourState, wsXFPTXPower=wsXFPTXPower, wsSFPBitrate=wsSFPBitrate, wsEnvironment=wsEnvironment, wsNeighboursTable=wsNeighboursTable, wsReload=wsReload, wsSFPTransceiver=wsSFPTransceiver, wsSFPRXdBmPower=wsSFPRXdBmPower, wsVersionString=wsVersionString, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortState=wsNeighbourPortState, wsTempTHYST=wsTempTHYST, wsTempStatus=wsTempStatus, wsXFPStatus=wsXFPStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsPolicyInPkts=wsPolicyInPkts, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsVersion=wsVersion, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPolicyIfIndex=wsPolicyIfIndex, wsXFPEncoding=wsXFPEncoding, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyInDrops=wsPolicyInDrops, wsNeighboursEntry=wsNeighboursEntry, wsPolicyEntry=wsPolicyEntry, wsFanTable=wsFanTable, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, PYSNMP_MODULE_ID=ibos, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTempStatus=wsSFPTempStatus, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsVoltNominal=wsVoltNominal, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPTXCurrent=wsXFPTXCurrent, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTemp=wsSFPTemp, wsSFPTransceiverExt=wsSFPTransceiverExt, wsPolicyOutBytes=wsPolicyOutBytes, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsVoltEntry=wsVoltEntry, wsFanVoltage=wsFanVoltage, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsXFPCopperLen=wsXFPCopperLen, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsNeighbourSNPA=wsNeighbourSNPA, wsSFPVolt=wsSFPVolt, wsXFPRXPower=wsXFPRXPower, wsNeighbourCreated=wsNeighbourCreated, wsPolicyTable=wsPolicyTable, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsXFPIndex=wsXFPIndex, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsTempThresholdHigh=wsTempThresholdHigh, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPStatus=wsSFPStatus, wsAsrRevision=wsAsrRevision, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsIbosVoltLow=wsIbosVoltLow, wsXFPEntry=wsXFPEntry, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsFanRPM=wsFanRPM, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPBitrateMax=wsXFPBitrateMax, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPEncoding=wsSFPEncoding, wsTempMeasured=wsTempMeasured, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsPolicyIfName=wsPolicyIfName, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsPFDP=wsPFDP, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsPolicyInBytes=wsPolicyInBytes)
