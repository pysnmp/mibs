...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsNeighbourOSVersion=wsNeighbourOSVersion, wsVoltNominal=wsVoltNominal, wsPolicyCookie=wsPolicyCookie, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsFanEntry=wsFanEntry, wsTempMeasured=wsTempMeasured, wsSystem=wsSystem, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsPolicyInPkts=wsPolicyInPkts, ibos=ibos, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsPolicyInBytes=wsPolicyInBytes, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsXFPConnector=wsXFPConnector, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsEnvironment=wsEnvironment, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsNeighbourHostname=wsNeighbourHostname, wsTempEntry=wsTempEntry, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTemp=wsSFPTemp, wsFanNumber=wsFanNumber, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsVersionString=wsVersionString, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXPower=wsSFPTXPower, wsXFPEntry=wsXFPEntry, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsFanVoltage=wsFanVoltage, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsTempStatus=wsTempStatus, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsXFPTXCurrent=wsXFPTXCurrent, wsXFPTXPower=wsXFPTXPower, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPCopperLen=wsSFPCopperLen, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPTempNormalLow=wsSFPTempNormalLow, wsSFPTable=wsSFPTable, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPVolt=wsSFPVolt, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPEncoding=wsXFPEncoding, wsNeighbourNIndex=wsNeighbourNIndex, wsTempTable=wsTempTable, wsNeighbourPortName=wsNeighbourPortName, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPStatus=wsSFPStatus, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsVoltThresholdHigh=wsVoltThresholdHigh, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsXFPIndex=wsXFPIndex, wsSFPEncoding=wsSFPEncoding, wsXFPRXPower=wsXFPRXPower, wsVoltMeasured=wsVoltMeasured, wsTempThresholdHigh=wsTempThresholdHigh, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsFanRPM=wsFanRPM, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsNeighbourModel=wsNeighbourModel, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyEntry=wsPolicyEntry, wsPolicyName=wsPolicyName, wsXFPTemp=wsXFPTemp, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPTempWarningLow=wsSFPTempWarningLow, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPTransceiver=wsXFPTransceiver, wsSFPRXPower=wsSFPRXPower, wsAsrRevision=wsAsrRevision, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsPolicyIfIndex=wsPolicyIfIndex, wsVoltStatus=wsVoltStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsPolicyTable=wsPolicyTable, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsIbosTempLow=wsIbosTempLow, wsSFPConnector=wsSFPConnector, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortsTable=wsNeighbourPortsTable, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourState=wsNeighbourState, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsIbosVoltLow=wsIbosVoltLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsReload=wsReload, wsAccounting=wsAccounting, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsVoltEntry=wsVoltEntry, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsPolicyUsedCnt=wsPolicyUsedCnt, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsTempSensor=wsTempSensor, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPTransceiverExt=wsSFPTransceiverExt, wsXFPStatus=wsXFPStatus, wsSFPTempStatus=wsSFPTempStatus, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsPolicyIfName=wsPolicyIfName, wsSFPIndex=wsSFPIndex, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsPolicyOutPkts=wsPolicyOutPkts, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsVoltChannel=wsVoltChannel, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsWritedummy=wsWritedummy, wsVoltTable=wsVoltTable, wsNeighbourUptime=wsNeighbourUptime, wsTempTHYST=wsTempTHYST, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPBitrate=wsSFPBitrate, wsXFPTable=wsXFPTable, wsSFPEntry=wsSFPEntry, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsFanTable=wsFanTable, wsNeighbourDBCount=wsNeighbourDBCount, wsIbosTempHigh=wsIbosTempHigh, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPPartNumber=wsSFPPartNumber, PYSNMP_MODULE_ID=ibos, wsVersion=wsVersion, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsXFPBitrateMin=wsXFPBitrateMin, wsPFDP=wsPFDP, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighboursTable=wsNeighboursTable, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsSFPSerialNumber=wsSFPSerialNumber, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourLocalIf=wsNeighbourLocalIf, wsNeighboursEntry=wsNeighboursEntry, wsTempTOS=wsTempTOS, wsXFPTempStatus=wsXFPTempStatus, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow)
