...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, PYSNMP_MODULE_ID=ibos, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsEnvironment=wsEnvironment, wsTempTHYST=wsTempTHYST, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsSFPVolt=wsSFPVolt, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsIbosVoltLow=wsIbosVoltLow, wsXFPSingleModeLen=wsXFPSingleModeLen, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsXFPEntry=wsXFPEntry, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsVoltThresholdHigh=wsVoltThresholdHigh, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsTempEntry=wsTempEntry, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsPolicyTable=wsPolicyTable, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsVersionString=wsVersionString, ibos=ibos, wsSFPTempNormalLow=wsSFPTempNormalLow, wsIbosTempLow=wsIbosTempLow, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsAccounting=wsAccounting, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsFanNumber=wsFanNumber, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsVoltNominal=wsVoltNominal, wsNeighboursTable=wsNeighboursTable, wsSFPIndex=wsSFPIndex, wsPolicyOutDrops=wsPolicyOutDrops, wsXFPTemp=wsXFPTemp, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsReload=wsReload, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsXFPStatus=wsXFPStatus, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsVoltChannel=wsVoltChannel, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsPolicyInDrops=wsPolicyInDrops, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPEntry=wsSFPEntry, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsPolicyCookie=wsPolicyCookie, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsPolicyUsedCnt=wsPolicyUsedCnt, wsFanRPM=wsFanRPM, wsSFPBitrate=wsSFPBitrate, wsNeighbourCreated=wsNeighbourCreated, wsPolicyEntry=wsPolicyEntry, wsXFPRXPower=wsXFPRXPower, wsPolicyInPkts=wsPolicyInPkts, wsXFPEncoding=wsXFPEncoding, wsPFDP=wsPFDP, wsVersion=wsVersion, wsNeighbourSNPA=wsNeighbourSNPA, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourIfIndex=wsNeighbourIfIndex, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsTempTable=wsTempTable, wsNeighbourState=wsNeighbourState, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPEncoding=wsSFPEncoding, wsPolicyIfIndex=wsPolicyIfIndex, wsTempStatus=wsTempStatus, wsNeighbourLocalIf=wsNeighbourLocalIf, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyInBytes=wsPolicyInBytes, wsVoltTable=wsVoltTable, wsPolicyOutPkts=wsPolicyOutPkts, wsVoltEntry=wsVoltEntry, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPPartNumber=wsSFPPartNumber, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsNeighbourUptime=wsNeighbourUptime, wsTempTOS=wsTempTOS, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTXPower=wsSFPTXPower, wsXFPConnector=wsXFPConnector, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsFanVoltage=wsFanVoltage, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPolicyIfName=wsPolicyIfName, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighboursEntry=wsNeighboursEntry, wsNeighbourNIndex=wsNeighbourNIndex, wsSFPTransceiver=wsSFPTransceiver, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXPower=wsSFPRXPower, wsSFPTemp=wsSFPTemp, wsXFPTXCurrent=wsXFPTXCurrent, wsTempThresholdLow=wsTempThresholdLow, wsAsrRevision=wsAsrRevision, wsWritedummy=wsWritedummy, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPTable=wsXFPTable, wsXFPTXPower=wsXFPTXPower, wsSFPSerialNumber=wsSFPSerialNumber, wsIbosVoltHigh=wsIbosVoltHigh, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsSFPTable=wsSFPTable, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPTXdBmPower=wsSFPTXdBmPower, wsTempMeasured=wsTempMeasured, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSystem=wsSystem, wsFanEntry=wsFanEntry, wsSFPCopperLen=wsSFPCopperLen, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsPolicyName=wsPolicyName, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsVoltStatus=wsVoltStatus, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPSingleModeLen=wsSFPSingleModeLen, wsXFPIndex=wsXFPIndex, wsXFPTransceiver=wsXFPTransceiver, wsSFPTempStatus=wsSFPTempStatus, wsPolicyOutBytes=wsPolicyOutBytes, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsNeighbourModel=wsNeighbourModel, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPStatus=wsSFPStatus, wsSFPConnector=wsSFPConnector, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortName=wsNeighbourPortName, wsSFPTXCurrent=wsSFPTXCurrent, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsFanTable=wsFanTable, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsIbosTempHigh=wsIbosTempHigh, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsTempSensor=wsTempSensor)
