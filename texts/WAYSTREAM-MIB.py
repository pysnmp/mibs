...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsTempThresholdLow=wsTempThresholdLow, wsNeighbourHostname=wsNeighbourHostname, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPCopperLen=wsSFPCopperLen, wsXFPEncoding=wsXFPEncoding, wsEnvironment=wsEnvironment, wsSFPSerialNumber=wsSFPSerialNumber, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsPolicyName=wsPolicyName, ibos=ibos, wsPolicyInBytes=wsPolicyInBytes, wsPolicyOutPkts=wsPolicyOutPkts, wsXFPTransceiver=wsXFPTransceiver, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsPolicyEntry=wsPolicyEntry, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsSFPTXCurrent=wsSFPTXCurrent, wsNeighbourUptime=wsNeighbourUptime, wsXFPTXPower=wsXFPTXPower, wsTempTable=wsTempTable, wsSFPIndex=wsSFPIndex, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsSFPTempNormalLow=wsSFPTempNormalLow, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsPolicyInPkts=wsPolicyInPkts, wsFanNumber=wsFanNumber, wsSFPPartNumber=wsSFPPartNumber, wsXFPEntry=wsXFPEntry, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsXFPCopperLen=wsXFPCopperLen, wsReload=wsReload, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsSFPTemp=wsSFPTemp, wsSFPTXdBmPower=wsSFPTXdBmPower, wsNeighboursTable=wsNeighboursTable, wsSystem=wsSystem, wsIbosVoltHigh=wsIbosVoltHigh, wsSFPStatus=wsSFPStatus, wsSFPTransceiverExt=wsSFPTransceiverExt, wsIbosTempLow=wsIbosTempLow, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsNeighbourLocalIf=wsNeighbourLocalIf, wsFanRPM=wsFanRPM, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsSFPRXPower=wsSFPRXPower, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsWritedummy=wsWritedummy, wsPolicyCookie=wsPolicyCookie, wsTempTHYST=wsTempTHYST, wsTempMeasured=wsTempMeasured, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourNIndex=wsNeighbourNIndex, wsNeighbourDBCount=wsNeighbourDBCount, wsXFPBitrateMin=wsXFPBitrateMin, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsSFPTempWarningLow=wsSFPTempWarningLow, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsNeighbourModel=wsNeighbourModel, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsTempSensor=wsTempSensor, wsPolicyIfIndex=wsPolicyIfIndex, wsTempStatus=wsTempStatus, wsFanEntry=wsFanEntry, wsPFDP=wsPFDP, wsNeighbourCreated=wsNeighbourCreated, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, PYSNMP_MODULE_ID=ibos, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsSFPRXdBmPower=wsSFPRXdBmPower, wsXFPRXPower=wsXFPRXPower, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsAccounting=wsAccounting, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsVersionString=wsVersionString, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPBitrate=wsSFPBitrate, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsSFPEntry=wsSFPEntry, wsPolicyOutDrops=wsPolicyOutDrops, wsSFPTable=wsSFPTable, wsPolicyTable=wsPolicyTable, wsVoltTable=wsVoltTable, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsFanTable=wsFanTable, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsVoltEntry=wsVoltEntry, wsSFPVolt=wsSFPVolt, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsSFPEncoding=wsSFPEncoding, wsXFPTable=wsXFPTable, wsPolicyInDrops=wsPolicyInDrops, wsVersion=wsVersion, wsNeighbourLastAct=wsNeighbourLastAct, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPStatus=wsXFPStatus, wsVoltNominal=wsVoltNominal, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsSFPTXPower=wsSFPTXPower, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsXFPTXCurrent=wsXFPTXCurrent, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsNeighbourPortState=wsNeighbourPortState, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsFanVoltage=wsFanVoltage, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourPortsTable=wsNeighbourPortsTable, wsXFPSingleModeLen=wsXFPSingleModeLen, wsVoltThresholdLow=wsVoltThresholdLow, wsAsrRevision=wsAsrRevision, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsXFPConnector=wsXFPConnector, wsTempEntry=wsTempEntry, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsXFPTemp=wsXFPTemp, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsPolicyUsedCnt=wsPolicyUsedCnt, wsPolicyIfName=wsPolicyIfName, wsSFPConnector=wsSFPConnector, wsVoltChannel=wsVoltChannel, wsTempTOS=wsTempTOS, wsVoltThresholdHigh=wsVoltThresholdHigh, wsXFPIndex=wsXFPIndex, wsNeighbourState=wsNeighbourState, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsXFPTempStatus=wsXFPTempStatus, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsIbosTempHigh=wsIbosTempHigh, wsIbosVoltLow=wsIbosVoltLow, wsSFPTempStatus=wsSFPTempStatus, wsVoltStatus=wsVoltStatus, wsXFPBitrateMax=wsXFPBitrateMax, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsNeighbourOSVersion=wsNeighbourOSVersion, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsIbosFanRPMLow=wsIbosFanRPMLow, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsSFPVoltWarningLow=wsSFPVoltWarningLow)
