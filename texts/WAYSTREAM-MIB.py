...
mibBuilder.exportSymbols("WAYSTREAM-MIB", wsSFPRXInputPowNormalHighdBm=wsSFPRXInputPowNormalHighdBm, wsXFPSingleModeLen=wsXFPSingleModeLen, ibos=ibos, wsXFPTXPowerStatus=wsXFPTXPowerStatus, wsNeighbourPortsTable=wsNeighbourPortsTable, wsNeighbourPacketsIn=wsNeighbourPacketsIn, wsNeighbourPortSNPANIndex=wsNeighbourPortSNPANIndex, wsNeighbourPortPkts256to511Octets=wsNeighbourPortPkts256to511Octets, wsXFPConnector=wsXFPConnector, wsPolicyUsedCnt=wsPolicyUsedCnt, wsFanNumber=wsFanNumber, wsVoltChannel=wsVoltChannel, wsSFPVoltNormalLow=wsSFPVoltNormalLow, wsNeighbourPortRxUnicastPkts=wsNeighbourPortRxUnicastPkts, wsSFPTemp=wsSFPTemp, wsPolicyInBytes=wsPolicyInBytes, wsNeighbourPortName=wsNeighbourPortName, wsNeighbourIfIndex=wsNeighbourIfIndex, wsNeighbourPortRxUndersizePkts=wsNeighbourPortRxUndersizePkts, wsAccounting=wsAccounting, wsNeighbourPortSNPAPIndex=wsNeighbourPortSNPAPIndex, wsXFPTXCurrentStatus=wsXFPTXCurrentStatus, wsSFPPartNumber=wsSFPPartNumber, wsTempSensor=wsTempSensor, wsNeighbourPacketErrorsrIn=wsNeighbourPacketErrorsrIn, wsSFPTXOutputPowWarningHighuW=wsSFPTXOutputPowWarningHighuW, wsXFPEncoding=wsXFPEncoding, wsNeighbourPortPkts1024to1522Octets=wsNeighbourPortPkts1024to1522Octets, wsSFPTXCurrentNormalHigh=wsSFPTXCurrentNormalHigh, wsPolicyTable=wsPolicyTable, wsReload=wsReload, wsXFPIndex=wsXFPIndex, wsSFPTXOutputPowWarningLowuW=wsSFPTXOutputPowWarningLowuW, wsSFPRXInputPowWarningHighuW=wsSFPRXInputPowWarningHighuW, wsNeighboursEntry=wsNeighboursEntry, wsSFPRXInputPowNormalLowuW=wsSFPRXInputPowNormalLowuW, wsVoltEntry=wsVoltEntry, wsSFPTransceiver=wsSFPTransceiver, wsNeighbourPortSNPASIndex=wsNeighbourPortSNPASIndex, wsXFPTXCurrent=wsXFPTXCurrent, wsPolicyCookie=wsPolicyCookie, wsIbosTempHigh=wsIbosTempHigh, wsNeighbourNIndex=wsNeighbourNIndex, wsAsrRevision=wsAsrRevision, wsPolicyOutDrops=wsPolicyOutDrops, wsIbosFanRPMLow=wsIbosFanRPMLow, wsSFPStatus=wsSFPStatus, wsNeighbourPortPIndex=wsNeighbourPortPIndex, wsVoltTable=wsVoltTable, wsSFPTXOutputPowNormalLowuW=wsSFPTXOutputPowNormalLowuW, wsNeighbourLocalIf=wsNeighbourLocalIf, wsIbosEnvironmentTrapEnable=wsIbosEnvironmentTrapEnable, wsXFPCopperLen=wsXFPCopperLen, wsNeighbourPortRxJabbers=wsNeighbourPortRxJabbers, wsXFPBitrateMax=wsXFPBitrateMax, wsTempTHYST=wsTempTHYST, wsNeighbourPortRxExcessSizeDisc=wsNeighbourPortRxExcessSizeDisc, wsVoltThresholdLow=wsVoltThresholdLow, wsSFPVoltWarningLow=wsSFPVoltWarningLow, wsSFPVoltWarningHigh=wsSFPVoltWarningHigh, wsSFPRXInputPowWarningLowdBm=wsSFPRXInputPowWarningLowdBm, wsPolicyEntry=wsPolicyEntry, wsTempTOS=wsTempTOS, wsWritedummy=wsWritedummy, wsSFPTXPower=wsSFPTXPower, wsSFPTXCurrentWarningLow=wsSFPTXCurrentWarningLow, wsNeighbourModel=wsNeighbourModel, wsSFPTXOutputPowWarningLowdBm=wsSFPTXOutputPowWarningLowdBm, wsSFPMultiMode50Len=wsSFPMultiMode50Len, wsNeighbourHostname=wsNeighbourHostname, wsSFPTXCurrentStatus=wsSFPTXCurrentStatus, wsSystem=wsSystem, wsIbosEnvironmentNotifications=wsIbosEnvironmentNotifications, wsXFPEntry=wsXFPEntry, wsEnvironment=wsEnvironment, wsIbosVoltHigh=wsIbosVoltHigh, wsXFPRXPower=wsXFPRXPower, wsSFPSingleModeLen=wsSFPSingleModeLen, wsNeighbourLastAct=wsNeighbourLastAct, wsNeighbourPortSNPAEntry=wsNeighbourPortSNPAEntry, wsPFDP=wsPFDP, wsSFPTransceiverExt=wsSFPTransceiverExt, wsSFPIndex=wsSFPIndex, wsVoltNominal=wsVoltNominal, wsSFPVolt=wsSFPVolt, wsNeighbourPortTxFrameInDisc=wsNeighbourPortTxFrameInDisc, wsSFPTXOutputPowNormalLowdBm=wsSFPTXOutputPowNormalLowdBm, wsTempThresholdLow=wsTempThresholdLow, wsNeighbourPortsEntry=wsNeighbourPortsEntry, wsNeighboursTable=wsNeighboursTable, wsNeighbourPortRxGoodOctets=wsNeighbourPortRxGoodOctets, wsNeighbourPortTxMulticastPkts=wsNeighbourPortTxMulticastPkts, wsSFPTempWarningLow=wsSFPTempWarningLow, wsSFPTXCurrent=wsSFPTXCurrent, wsIbosFanOutVoltLow=wsIbosFanOutVoltLow, wsXFPRXPowerStatus=wsXFPRXPowerStatus, wsNeighbourPortRxOversizePkts=wsNeighbourPortRxOversizePkts, wsSFPRXInputPowWarningHighdBm=wsSFPRXInputPowWarningHighdBm, wsTempMeasured=wsTempMeasured, wsNeighbourSNPA=wsNeighbourSNPA, wsNeighbourState=wsNeighbourState, wsNeighbourDBCount=wsNeighbourDBCount, wsNeighbourPortTxOctets=wsNeighbourPortTxOctets, wsNeighbourPortRxAlignmentErrors=wsNeighbourPortRxAlignmentErrors, wsSFPRXPowerStatus=wsSFPRXPowerStatus, wsXFPTemp=wsXFPTemp, wsIbosTempLow=wsIbosTempLow, wsNeighbourPortSNPAIfIndex=wsNeighbourPortSNPAIfIndex, wsVoltThresholdHigh=wsVoltThresholdHigh, wsFanTable=wsFanTable, wsXFPBitrateMin=wsXFPBitrateMin, wsPolicyIfName=wsPolicyIfName, wsNeighbourUptime=wsNeighbourUptime, wsSFPEntry=wsSFPEntry, wsSFPTempNormalLow=wsSFPTempNormalLow, wsNeighbourPortPkts512to1023Octets=wsNeighbourPortPkts512to1023Octets, wsNeighbourPortRxDropPkts=wsNeighbourPortRxDropPkts, wsPolicyName=wsPolicyName, wsSFPTXCurrentNormalLow=wsSFPTXCurrentNormalLow, wsSFPTXCurrentWarningHigh=wsSFPTXCurrentWarningHigh, wsSFPRXInputPowNormalHighuW=wsSFPRXInputPowNormalHighuW, wsPolicyInPkts=wsPolicyInPkts, wsNeighbourPortRxBroadcastPkts=wsNeighbourPortRxBroadcastPkts, wsSFPCopperLen=wsSFPCopperLen, wsSFPTempWarningHigh=wsSFPTempWarningHigh, wsNeighbourPortRxFragments=wsNeighbourPortRxFragments, wsSFPRXInputPowWarningLowuW=wsSFPRXInputPowWarningLowuW, wsXFPTransceiver=wsXFPTransceiver, wsNeighbourPortSNPA=wsNeighbourPortSNPA, wsSFPTempNormalHigh=wsSFPTempNormalHigh, wsPolicyOutPkts=wsPolicyOutPkts, wsSFPVoltStatus=wsSFPVoltStatus, wsSFPTempStatus=wsSFPTempStatus, wsNeighbourPortPkts65to127Octets=wsNeighbourPortPkts65to127Octets, wsXFPTempStatus=wsXFPTempStatus, wsFanVoltage=wsFanVoltage, wsSFPTXOutputPowNormalHighdBm=wsSFPTXOutputPowNormalHighdBm, wsNeighbourPortRxOctets=wsNeighbourPortRxOctets, wsXFPStatus=wsXFPStatus, wsNeighbourPortPkts64Octets=wsNeighbourPortPkts64Octets, wsSFPVoltNormalHigh=wsSFPVoltNormalHigh, wsSFPMultiMode625Len=wsSFPMultiMode625Len, wsTempEntry=wsTempEntry, wsSFPTable=wsSFPTable, wsFanRPM=wsFanRPM, wsNeighbourCreated=wsNeighbourCreated, PYSNMP_MODULE_ID=ibos, wsSFPBitrate=wsSFPBitrate, wsFanEntry=wsFanEntry, wsNeighbourPortState=wsNeighbourPortState, wsTempThresholdHigh=wsTempThresholdHigh, wsNeighbourOSVersion=wsNeighbourOSVersion, wsNeighbourPortTxBroadcastPkts=wsNeighbourPortTxBroadcastPkts, wsNeighbourPortPkts128to255Octets=wsNeighbourPortPkts128to255Octets, wsSFPRXPower=wsSFPRXPower, wsVoltStatus=wsVoltStatus, wsNeighbourPortTxDropPkts=wsNeighbourPortTxDropPkts, wsNeighbourPortTxCollisions=wsNeighbourPortTxCollisions, wsSFPConnector=wsSFPConnector, wsNeighbourRemoteIf=wsNeighbourRemoteIf, wsIbosVoltLow=wsIbosVoltLow, wsXFPTXPower=wsXFPTXPower, wsSFPRXdBmPower=wsSFPRXdBmPower, wsNeighbourPortNIndex=wsNeighbourPortNIndex, wsNeighbourPortTxDeferredTransmit=wsNeighbourPortTxDeferredTransmit, wsSFPEncoding=wsSFPEncoding, wsVersion=wsVersion, wsNeighbourPortRxFCSErrors=wsNeighbourPortRxFCSErrors, wsXFPTable=wsXFPTable, wsXFPMultiMode625Len=wsXFPMultiMode625Len, wsNeighbourPortSNPASMCast=wsNeighbourPortSNPASMCast, wsNeighbourPortRxSymbolError=wsNeighbourPortRxSymbolError, wsSFPTXdBmPower=wsSFPTXdBmPower, wsVersionString=wsVersionString, wsNeighbourPortSNPATable=wsNeighbourPortSNPATable, wsVoltMeasured=wsVoltMeasured, wsNeighbourPortIfIndex=wsNeighbourPortIfIndex, wsXFPMultiMode50Len=wsXFPMultiMode50Len, wsPolicyIfIndex=wsPolicyIfIndex, wsSFPRXInputPowNormalLowdBm=wsSFPRXInputPowNormalLowdBm, wsPolicyInDrops=wsPolicyInDrops, wsPolicyOutBytes=wsPolicyOutBytes, wsSFPTXOutputPowNormalHighuW=wsSFPTXOutputPowNormalHighuW, wsNeighbourPortTxUnicastPkts=wsNeighbourPortTxUnicastPkts, wsNeighbourPortRxMulticastPkts=wsNeighbourPortRxMulticastPkts, wsTempTable=wsTempTable, wsSFPTXPowerStatus=wsSFPTXPowerStatus, wsSFPTXOutputPowWarningHighdBm=wsSFPTXOutputPowWarningHighdBm, wsTempStatus=wsTempStatus, wsSFPSerialNumber=wsSFPSerialNumber)
