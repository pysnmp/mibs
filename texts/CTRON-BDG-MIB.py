...
NotificationType, MibIdentifier, Counter32, Gauge32, IpAddress, iso, Integer32, Bits, TimeTicks, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Counter32", "Gauge32", "IpAddress", "iso", "Integer32", "Bits", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("CTRON-BDG-MIB", bdgPortFrRx=bdgPortFrRx, pcMcastRec=pcMcastRec, bdgdeviceRootCost=bdgdeviceRootCost, bdgPortOversizePackets=bdgPortOversizePackets, bdgPortCRCErr=bdgPortCRCErr, acqCreate20=acqCreate20, pcFramesXmit=pcFramesXmit, bdgdeviceBdgMaxAge=bdgdeviceBdgMaxAge, pcLateColls=pcLateColls, bdgdeviceMaxAge=bdgdeviceMaxAge, pcBcastRec=pcBcastRec, bdgdeviceRestoreSettings=bdgdeviceRestoreSettings, acqOptions=acqOptions, pcComment=pcComment, bdgPortDesigCost=bdgPortDesigCost, bdgdeviceBdgName=bdgdeviceBdgName, bdgdeviceRestartBdg=bdgdeviceRestartBdg, mAC=mAC, specNumEntries=specNumEntries, pcCarrErr=pcCarrErr, acqDB=acqDB, bdgPortDisErr=bdgPortDisErr, pcBoardType=pcBoardType, bdgdeviceStatus=bdgdeviceStatus, bdgPortNetName=bdgPortNetName, bdgPortDisInb=bdgPortDisInb, bdgdeviceUptime=bdgdeviceUptime, specType=specType, bdgPortDisLOB=bdgPortDisLOB, bdgPortFwdOutb=bdgPortFwdOutb, bdgPortDesigBrdg=bdgPortDesigBrdg, permCreate00=permCreate00, trapTypes=trapTypes, bdgdeviceDisableBdg=bdgdeviceDisableBdg, bdgdeviceErr=bdgdeviceErr, pcOnboardMemory=pcOnboardMemory, pcTotRecErrs=pcTotRecErrs, bdgPortDesigPort=bdgPortDesigPort, lmcommon=lmcommon, pcOwnerName=pcOwnerName, bridgeRev1=bridgeRev1, bdgdeviceTopChg=bdgdeviceTopChg, bdgdeviceLocation=bdgdeviceLocation, bdgdeviceBdgHello=bdgdeviceBdgHello, acqSrcAddress=acqSrcAddress, bdgPortName=bdgPortName, bdgdeviceTopChgCnt=bdgdeviceTopChgCnt, specDestAddress=specDestAddress, permCreate21=permCreate21, bdgPortColl=bdgPortColl, acqCreate21=acqCreate21, bdgPortTxAbrt=bdgPortTxAbrt, acqDispOutp1=acqDispOutp1, pcMultiColl=pcMultiColl, pcCRCErrs=pcCRCErrs, pcSqeErr=pcSqeErr, acqMaxEntries=acqMaxEntries, ieee8023=ieee8023, pcApplication=pcApplication, pcMMACPort=pcMMACPort, specMaxEntries=specMaxEntries, specPort1=specPort1, bdgPortOowColl=bdgPortOowColl, permSrcAddress=permSrcAddress, bdgPortPathCost=bdgPortPathCost, specDeleteFilter=specDeleteFilter, permCurrEntries=permCurrEntries, filterDB=filterDB, bdgdeviceDesigRoot=bdgdeviceDesigRoot, pcTotXmitErrs=pcTotXmitErrs, pcBytesXmit=pcBytesXmit, acqStats=acqStats, acqDynEntries=acqDynEntries, pcIfRev=pcIfRev, pcLenErrs=pcLenErrs, bdgdeviceHoldTime=bdgdeviceHoldTime, bdgdevice=bdgdevice, bdgPortRuntPackets=bdgPortRuntPackets, bdgdeviceTimeTopChg=bdgdeviceTimeTopChg, bdgPortState=bdgPortState, acqStaticEntries=acqStaticEntries, acqStaticAgeTime=acqStaticAgeTime, bdgPortFrAlErr=bdgPortFrAlErr, permMaxEntries=permMaxEntries, pcMcastXmit=pcMcastXmit, acqDynAgeTime=acqDynAgeTime, acqDispOutp2=acqDispOutp2, bdgdeviceFrRx=bdgdeviceFrRx, bdgdeviceVersion=bdgdeviceVersion, pcDriverRev=pcDriverRev, bdgdeviceFrFwd=bdgdeviceFrFwd, bdgdeviceTrapType=bdgdeviceTrapType, permDispOutp2=permDispOutp2, bdgPortType=bdgPortType, specDataField=specDataField, acqCreate00=acqCreate00, bdgdeviceBridgeID=bdgdeviceBridgeID, permDispType=permDispType, permStats=permStats, bdgPortFrFilt=bdgPortFrFilt, pcMMACBoard=pcMMACBoard, bdgdeviceFrFlt=bdgdeviceFrFlt, pcMMACAddr=pcMMACAddr, bdgTables=bdgTables, bdgdeviceNumPorts=bdgdeviceNumPorts, pcDeferXmit=pcDeferXmit, specEnable=specEnable, pcTooLong=pcTooLong, specStats=specStats, acqCreate01=acqCreate01, pcFramesRec=pcFramesRec, bdgdeviceTypeFiltering=bdgdeviceTypeFiltering, bdgPortDesigRoot=bdgPortDesigRoot, permDelete=permDelete, pcTooShort=pcTooShort, bdgPortTopChgAck=bdgPortTopChgAck, bdgdeviceBdgPriority=bdgdeviceBdgPriority, permDispOutp1=permDispOutp1, pcBytesRec=pcBytesRec, bdgdeviceFwdDly=bdgdeviceFwdDly, pcMACAddr=pcMACAddr, permDB=permDB, pcBcastXmit=pcBcastXmit, bdgPortPriority=bdgPortPriority, pcAlignErrs=pcAlignErrs, bdgdeviceResetCounts=bdgdeviceResetCounts, bdgPortStatus=bdgPortStatus, acqTotalEntries=acqTotalEntries, specSrcAddress=specSrcAddress, permOptions=permOptions, bdgdeviceRootPort=bdgdeviceRootPort, pcIF=pcIF, pcIntRecErr=pcIntRecErr, acqDelete=acqDelete, bdgPort=bdgPort, bdgPortDisTDE=bdgPortDisTDE, permCreate01=permCreate01, bdgdeviceBdgFwdDly=bdgdeviceBdgFwdDly, permCreate20=permCreate20, bdgdeviceType=bdgdeviceType, specNextFilterNum=specNextFilterNum, specPort2=specPort2, pcSglColl=pcSglColl, bdgdeviceSwitchSetting=bdgdeviceSwitchSetting, permEraseDatabase=permEraseDatabase, acqDispType=acqDispType, bdgdeviceHelloTime=bdgdeviceHelloTime, specialDB=specialDB, acqEraseDatabase=acqEraseDatabase, specFilters=specFilters, bdgPortAddress=bdgPortAddress, pcLocation=pcLocation, pcXcessColls=pcXcessColls, bdgdeviceSTAProtocol=bdgdeviceSTAProtocol, bdgdeviceNumRestarts=bdgdeviceNumRestarts, pcDeviceName=pcDeviceName)
