...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgAddVlan=pmNewCfgAddVlan, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, lacpInfoPortReadyN=lacpInfoPortReadyN, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, fdbClear=fdbClear, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, mstCistDefaultCfg=mstCistDefaultCfg, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, stpInfoHelloTime=stpInfoHelloTime, stgNewCfgAddVlan=stgNewCfgAddVlan, layer2=layer2, mstCurCfgRegionVersion=mstCurCfgRegionVersion, vlanNewCfgLearn=vlanNewCfgLearn, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portTeamInfoPortsState=portTeamInfoPortsState, lacpCurSystemPriority=lacpCurSystemPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, vlanNewCfgJumbo=vlanNewCfgJumbo, cistRegionalPathCost=cistRegionalPathCost, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, layer2Stats=layer2Stats, layer2Oper=layer2Oper, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgAgingTime=stgCurCfgAgingTime, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, stgNewCfgPortEdge=stgNewCfgPortEdge, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanInfo=vlanInfo, cistInfoPortState=cistInfoPortState, vlanCurCfgStg=vlanCurCfgStg, stgNewCfgState=stgNewCfgState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, vlanNewCfgVlanId=vlanNewCfgVlanId, vlan=vlan, stpInfoPortIndex=stpInfoPortIndex, stgCurCfgTable=stgCurCfgTable, stgCurCfgPortEdge=stgCurCfgPortEdge, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, fdbStatsCurrent=fdbStatsCurrent, cistInfo=cistInfo, lacpNewPortCfgTable=lacpNewPortCfgTable, lacpCurPortState=lacpCurPortState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, fdbLearnedPort=fdbLearnedPort, vlanCurCfgLearn=vlanCurCfgLearn, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoLearn=vlanInfoLearn, mirrPortMirr=mirrPortMirr, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, fdbStatsFindFails=fdbStatsFindFails, stpInfoRootPort=stpInfoRootPort, stpInfoIndex=stpInfoIndex, stpStats=stpStats, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStats=fdbStats, cistBridgeHelloTime=cistBridgeHelloTime, stpInfoPortTableEntry=stpInfoPortTableEntry, stgNewCfgPriority=stgNewCfgPriority, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamInfoTrunksState=portTeamInfoTrunksState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, cistInfoPortTable=cistInfoPortTable, fdbStatsCreates=fdbStatsCreates, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortIndex=lacpInfoPortIndex, stpInfoPortTable=stpInfoPortTable, vlanMaxEnt=vlanMaxEnt, cistRootPathCost=cistRootPathCost, portTeamNewCfgTable=portTeamNewCfgTable, portTeamTableMaxSize=portTeamTableMaxSize, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, cistGeneralInfo=cistGeneralInfo, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgPortTable=mstCistNewCfgPortTable, PYSNMP_MODULE_ID=layer2, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stgNewCfgStgIndex=stgNewCfgStgIndex, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portTeamCurCfgState=portTeamCurCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portTeamInfoState=portTeamInfoState, fdbTable=fdbTable, stpInfoForwardDelay=stpInfoForwardDelay, lacpNewPortState=lacpNewPortState, vlanCurCfgState=vlanCurCfgState, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stgStatsPortTable=stgStatsPortTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, cistRootPort=cistRootPort, mstNewCfgStpMode=mstNewCfgStpMode, fdbStatsOverflows=fdbStatsOverflows, stpInfoMaxAge=stpInfoMaxAge, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgTable=stgNewCfgTable, portTeamNewCfgPorts=portTeamNewCfgPorts, lacpInfoPortMoved=lacpInfoPortMoved, stpInfoHoldTime=stpInfoHoldTime, vlanInfoStatus=vlanInfoStatus, fdbState=fdbState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, lacpNewSystemPriority=lacpNewSystemPriority, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, portTeamInfoTable=portTeamInfoTable, fdbStatsLookupFails=fdbStatsLookupFails, stgCurCfgVlanBmap=stgCurCfgVlanBmap, fdbSrcTrunk=fdbSrcTrunk, cistBridgeForwardDelay=cistBridgeForwardDelay, vlanMaxVlanID=vlanMaxVlanID, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, stgStatsStpIndex=stgStatsStpIndex, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, fdbInfo=fdbInfo, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgStatsPortTableEntry=stgStatsPortTableEntry, mstCurCfgState=mstCurCfgState, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoTable=stpInfoTable, portTeamNewCfgState=portTeamNewCfgState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgDelete=vlanNewCfgDelete, stgCurCfgPortPriority=stgCurCfgPortPriority, mstGeneralCfg=mstGeneralCfg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stpInfoPortRole=stpInfoPortRole, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgPortLink=stgNewCfgPortLink, mstNewCfgState=mstNewCfgState, fdbStatsFinds=fdbStatsFinds, stpInfoPortPathCost=stpInfoPortPathCost, fdbStatsHiwat=fdbStatsHiwat, cistInfoPortPriority=cistInfoPortPriority, vlanInfoBwmContract=vlanInfoBwmContract, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, portTeamCurCfgTable=portTeamCurCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stpInfoPortStpIndex=stpInfoPortStpIndex, BridgeId=BridgeId, mirroring=mirroring, portTeamCurCfgPorts=portTeamCurCfgPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, cistInfoPortRole=cistInfoPortRole, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, portTeamInfoTableEntry=portTeamInfoTableEntry, cistRoot=cistRoot, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stgCfg=stgCfg, portTeamInfo=portTeamInfo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portTeamNewCfgDelete=portTeamNewCfgDelete, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, portTeamInfoPorts=portTeamInfoPorts, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mstCfg=mstCfg, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, fdbMacAddr=fdbMacAddr, stpInfoTableEntry=stpInfoTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, stgStatsPortIndex=stgStatsPortIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstCurCfgStpMode=mstCurCfgStpMode, lacpInfoPortNtt=lacpInfoPortNtt, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanInfoTableEntry=vlanInfoTableEntry, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanInfoName=vlanInfoName, stgNewCfgPortPathCost=stgNewCfgPortPathCost, vlanInfoPorts=vlanInfoPorts, portTeamNewCfgAddPort=portTeamNewCfgAddPort, portTeamInfoIndex=portTeamInfoIndex, mstCistCfg=mstCistCfg, fdbRefSps=fdbRefSps, trunkgroup=trunkgroup, lacpNewPortCfgTableId=lacpNewPortCfgTableId, vlanCurCfgTable=vlanCurCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, stpInfoPortState=stpInfoPortState, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgPortIndex=stgNewCfgPortIndex, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, stpInfo=stpInfo, stgCurCfgStgIndex=stgCurCfgStgIndex, portTeamInfoTrunks=portTeamInfoTrunks, trunkGroupCurCfgTable=trunkGroupCurCfgTable, cistInfoPortIndex=cistInfoPortIndex, stpInfoPortLinkType=stpInfoPortLinkType, vlanNewCfgTable=vlanNewCfgTable, vlanInfoId=vlanInfoId, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgCurCfgIndex=stgCurCfgIndex, cistInfoPortLinkType=cistInfoPortLinkType, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, fdbStatsDeletes=fdbStatsDeletes, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistBridgeMaxAge=cistBridgeMaxAge, vlanNewCfgState=vlanNewCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgCurCfgPortIndex=stgCurCfgPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, stgCurCfgPortTable=stgCurCfgPortTable, fdbEntry=fdbEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoRootCost=stpInfoRootCost, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, vlanCurCfgVlanId=vlanCurCfgVlanId, lacpCurPortCfgTable=lacpCurPortCfgTable, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, lacp=lacp, lacpInfoPortTableEntry=lacpInfoPortTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamCfg=portTeamCfg, layer2Configs=layer2Configs, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stpInfoTopChanges=stpInfoTopChanges, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stpInfoPortEdge=stpInfoPortEdge, stgCurCfgState=stgCurCfgState, stgCurCfgPriority=stgCurCfgPriority, fdbStatsLookups=fdbStatsLookups, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, fdbVlan=fdbVlan, lacpInfoPortSelected=lacpInfoPortSelected, vlanInfoJumbo=vlanInfoJumbo, lacpInfo=lacpInfo, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortPathCost=cistInfoPortPathCost, vlanCurCfgBwmContract=vlanCurCfgBwmContract, fdbSrcPort=fdbSrcPort, vlanInfoTable=vlanInfoTable, cistRegionalRoot=cistRegionalRoot, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, layer2Info=layer2Info)
