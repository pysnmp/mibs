...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanNewCfgBwmContract=vlanNewCfgBwmContract, lacpInfoPortNtt=lacpInfoPortNtt, cistInfoPortRole=cistInfoPortRole, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, cistRootPathCost=cistRootPathCost, mirrPortMirr=mirrPortMirr, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, portTeamCurCfgPorts=portTeamCurCfgPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgAddVlan=pmNewCfgAddVlan, portTeamTableMaxSize=portTeamTableMaxSize, mstCistDefaultCfg=mstCistDefaultCfg, fdbRefSps=fdbRefSps, mstNewCfgState=mstNewCfgState, vlanMaxVlanID=vlanMaxVlanID, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgAgingTime=stgCurCfgAgingTime, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgCurCfgPortState=stgCurCfgPortState, layer2Oper=layer2Oper, layer2Configs=layer2Configs, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsLookupFails=fdbStatsLookupFails, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortTable=stpInfoPortTable, layer2Stats=layer2Stats, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, portTeamInfo=portTeamInfo, cistGeneralInfo=cistGeneralInfo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgNewCfgPortLink=stgNewCfgPortLink, vlanNewCfgRemovePort=vlanNewCfgRemovePort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, lacpInfoPortSelected=lacpInfoPortSelected, vlanNewCfgState=vlanNewCfgState, portTeamCurCfgIndex=portTeamCurCfgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, lacpNewPortCfgTableId=lacpNewPortCfgTableId, portTeamCfg=portTeamCfg, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, vlanCurCfgLearn=vlanCurCfgLearn, portTeamNewCfgTable=portTeamNewCfgTable, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, lacpInfoPortMoved=lacpInfoPortMoved, mstCistNewCfgPortTable=mstCistNewCfgPortTable, vlanInfoTable=vlanInfoTable, cistInfoPortIndex=cistInfoPortIndex, mirroring=mirroring, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, vlanInfoTableEntry=vlanInfoTableEntry, stgCfg=stgCfg, vlanCurCfgTable=vlanCurCfgTable, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, lacpCurPortCfgTable=lacpCurPortCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, fdbStatsFindFails=fdbStatsFindFails, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, stgNewCfgPriority=stgNewCfgPriority, cistInfoPortTable=cistInfoPortTable, fdbStatsLookups=fdbStatsLookups, portTeamInfoPorts=portTeamInfoPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgState=vlanCurCfgState, stgCurCfgPortPriority=stgCurCfgPortPriority, stpInfoPortPathCost=stpInfoPortPathCost, cistInfoPortLinkType=cistInfoPortLinkType, stpInfoPortRole=stpInfoPortRole, stgCurCfgPriority=stgCurCfgPriority, PYSNMP_MODULE_ID=layer2, portTeamNewCfgDelete=portTeamNewCfgDelete, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamInfoTableEntry=portTeamInfoTableEntry, fdbStatsFinds=fdbStatsFinds, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamInfoTrunks=portTeamInfoTrunks, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgNewCfgAgingTime=stgNewCfgAgingTime, fdbEntry=fdbEntry, portTeamNewCfgAddPort=portTeamNewCfgAddPort, fdbLearnedPort=fdbLearnedPort, cistInfoPortTableEntry=cistInfoPortTableEntry, vlanInfoStatus=vlanInfoStatus, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCurCfgRegionVersion=mstCurCfgRegionVersion, portTeamNewCfgIndex=portTeamNewCfgIndex, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, cistBridgeMaxAge=cistBridgeMaxAge, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanNewCfgVlanName=vlanNewCfgVlanName, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stpStats=stpStats, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stgStatsPortIndex=stgStatsPortIndex, stgStatsPortTableEntry=stgStatsPortTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgVlanBmap=stgNewCfgVlanBmap, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgCurCfgTable=stgCurCfgTable, cistRootPort=cistRootPort, mstNewCfgRegionVersion=mstNewCfgRegionVersion, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpCurPortState=lacpCurPortState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mstCistBridgeCfg=mstCistBridgeCfg, portTeamInfoTable=portTeamInfoTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portTeamInfoTrunksState=portTeamInfoTrunksState, mstCistCfg=mstCistCfg, stpInfoTopChanges=stpInfoTopChanges, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgCurCfgVlanBmap=stgCurCfgVlanBmap, lacpInfoPortIndex=lacpInfoPortIndex, lacpInfo=lacpInfo, fdbStatsCurrent=fdbStatsCurrent, lacp=lacp, stpInfoPortState=stpInfoPortState, portTeamInfoState=portTeamInfoState, stpInfoIndex=stpInfoIndex, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCurCfgState=mstCurCfgState, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mstNewCfgRegionName=mstNewCfgRegionName, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgCurCfgPortIndex=stgCurCfgPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistInfoPortState=cistInfoPortState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, stpInfoRootPort=stpInfoRootPort, cistBridgeForwardDelay=cistBridgeForwardDelay, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpInfoPortTable=lacpInfoPortTable, stgNewCfgPortTable=stgNewCfgPortTable, stgCurCfgTableEntry=stgCurCfgTableEntry, layer2Info=layer2Info, stgNewCfgPortState=stgNewCfgPortState, vlanInfoLearn=vlanInfoLearn, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstGeneralCfg=mstGeneralCfg, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgState=stgCurCfgState, stgCurCfgPortEdge=stgCurCfgPortEdge, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, layer2=layer2, vlanInfo=vlanInfo, stgNewCfgPortIndex=stgNewCfgPortIndex, stgStatsStpIndex=stgStatsStpIndex, stgNewCfgTable=stgNewCfgTable, vlanInfoName=vlanInfoName, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamNewCfgPorts=portTeamNewCfgPorts, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, lacpNewSystemPriority=lacpNewSystemPriority, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, cistInfoPortPathCost=cistInfoPortPathCost, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgState=stgNewCfgState, stpInfoForwardDelay=stpInfoForwardDelay, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, fdbTable=fdbTable, fdbSrcPort=fdbSrcPort, stpInfo=stpInfo, trunkgroup=trunkgroup, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, fdbInfo=fdbInfo, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, fdbVlan=fdbVlan, fdbClear=fdbClear, stpInfoMaxAge=stpInfoMaxAge, stpInfoHelloTime=stpInfoHelloTime, vlanCurCfgJumbo=vlanCurCfgJumbo, fdbMacAddr=fdbMacAddr, cistInfo=cistInfo, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanMaxEnt=vlanMaxEnt, lacpCurSystemPriority=lacpCurSystemPriority, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortIndex=stpInfoPortIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanInfoId=vlanInfoId, mstCurCfgRegionName=mstCurCfgRegionName, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, fdbStats=fdbStats, fdbStatsOverflows=fdbStatsOverflows, fdbSrcTrunk=fdbSrcTrunk, stpInfoTable=stpInfoTable, portTeamCurCfgTable=portTeamCurCfgTable, fdbState=fdbState, vlanInfoBwmContract=vlanInfoBwmContract, fdbStatsDeletes=fdbStatsDeletes, vlanInfoJumbo=vlanInfoJumbo, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbStatsCreates=fdbStatsCreates, BridgeId=BridgeId, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, cistBridgeHelloTime=cistBridgeHelloTime, cistInfoPortPriority=cistInfoPortPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoRootCost=stpInfoRootCost, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgStatsPortTable=stgStatsPortTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, portTeamInfoIndex=portTeamInfoIndex, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, portTeamInfoPortsState=portTeamInfoPortsState, vlanInfoPorts=vlanInfoPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stpInfoPortEdge=stpInfoPortEdge, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbStatsHiwat=fdbStatsHiwat, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgPortPriority=stgNewCfgPortPriority, vlan=vlan, cistRegionalRoot=cistRegionalRoot, vlanNewCfgTable=vlanNewCfgTable, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, mstNewCfgStpMode=mstNewCfgStpMode, mstCfg=mstCfg, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, stpInfoTableEntry=stpInfoTableEntry, lacpNewPortCfgTable=lacpNewPortCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, cistRoot=cistRoot, cistRegionalPathCost=cistRegionalPathCost, stpInfoPortLinkType=stpInfoPortLinkType, lacpNewPortState=lacpNewPortState, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId)
