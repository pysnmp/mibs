...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, stpInfoTopChanges=stpInfoTopChanges, lacp=lacp, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portTeamInfoPorts=portTeamInfoPorts, stgNewCfgTableEntry=stgNewCfgTableEntry, layer2Oper=layer2Oper, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stpInfo=stpInfo, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, vlanNewCfgState=vlanNewCfgState, mstCfg=mstCfg, lacpNewSystemPriority=lacpNewSystemPriority, portTeamNewCfgIndex=portTeamNewCfgIndex, fdbEntry=fdbEntry, fdbMacAddr=fdbMacAddr, cistInfoPortIndex=cistInfoPortIndex, fdbStats=fdbStats, lacpCurPortState=lacpCurPortState, vlanInfoStatus=vlanInfoStatus, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgPortPathCost=stgNewCfgPortPathCost, fdbStatsCurrent=fdbStatsCurrent, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, mirroring=mirroring, stgNewCfgPortLink=stgNewCfgPortLink, portTeamNewCfgState=portTeamNewCfgState, stpInfoPortIndex=stpInfoPortIndex, portTeamNewCfgTrunks=portTeamNewCfgTrunks, cistRegionalRoot=cistRegionalRoot, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stpInfoRootCost=stpInfoRootCost, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, stpInfoPortTableEntry=stpInfoPortTableEntry, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanCurCfgStg=vlanCurCfgStg, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgPorts=vlanNewCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbStatsOverflows=fdbStatsOverflows, vlanInfoLearn=vlanInfoLearn, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgIndex=stgNewCfgIndex, vlanInfo=vlanInfo, cistBridgeMaxAge=cistBridgeMaxAge, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStatsFindFails=fdbStatsFindFails, stpInfoRootPort=stpInfoRootPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, trunkGroupNewCfgState=trunkGroupNewCfgState, stpInfoPortEdge=stpInfoPortEdge, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, stpInfoHoldTime=stpInfoHoldTime, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, layer2Info=layer2Info, portTeamCurCfgTrunks=portTeamCurCfgTrunks, mstNewCfgStpMode=mstNewCfgStpMode, stpInfoDesignatedRoot=stpInfoDesignatedRoot, lacpNewPortState=lacpNewPortState, stgNewCfgPortPriority=stgNewCfgPortPriority, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, lacpCurPortCfgTable=lacpCurPortCfgTable, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, vlanInfoName=vlanInfoName, layer2Configs=layer2Configs, stgNewCfgPriority=stgNewCfgPriority, portTeamCfg=portTeamCfg, stpInfoPortPathCost=stpInfoPortPathCost, vlanNewCfgTable=vlanNewCfgTable, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, lacpInfoPortIndex=lacpInfoPortIndex, mstCistBridgeCfg=mstCistBridgeCfg, stgNewCfgPortIndex=stgNewCfgPortIndex, fdbStatsFinds=fdbStatsFinds, fdbLearnedPort=fdbLearnedPort, cistInfoPortLinkType=cistInfoPortLinkType, lacpInfo=lacpInfo, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgRemovePort=vlanNewCfgRemovePort, cistBridgeForwardDelay=cistBridgeForwardDelay, stgCurCfgTable=stgCurCfgTable, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, vlanNewCfgVlanName=vlanNewCfgVlanName, cistInfoPortRole=cistInfoPortRole, mstCistCfg=mstCistCfg, portTeamInfoPortsState=portTeamInfoPortsState, portTeamInfoTable=portTeamInfoTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanInfoBwmContract=vlanInfoBwmContract, vlanMaxVlanID=vlanMaxVlanID, vlan=vlan, vlanInfoId=vlanInfoId, portTeamCurCfgState=portTeamCurCfgState, BridgeId=BridgeId, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgAgingTime=stgNewCfgAgingTime, stpInfoForwardDelay=stpInfoForwardDelay, stgCurCfgPortEdge=stgCurCfgPortEdge, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortState=stgNewCfgPortState, portTeamInfoState=portTeamInfoState, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, fdbState=fdbState, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, cistInfoPortTable=cistInfoPortTable, trunkgroup=trunkgroup, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, stpInfoIndex=stpInfoIndex, lacpInfoPortTableEntry=lacpInfoPortTableEntry, portTeamInfoTrunks=portTeamInfoTrunks, stgCurCfgTableEntry=stgCurCfgTableEntry, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistRegionalPathCost=cistRegionalPathCost, cistBridgeHelloTime=cistBridgeHelloTime, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, fdbSrcTrunk=fdbSrcTrunk, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacpInfoPortNtt=lacpInfoPortNtt, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, cistInfo=cistInfo, mirrPortMirr=mirrPortMirr, vlanNewCfgAddPort=vlanNewCfgAddPort, mstCurCfgRegionName=mstCurCfgRegionName, stgCurCfgVlanBmap=stgCurCfgVlanBmap, mstCurCfgStpMode=mstCurCfgStpMode, stgCurCfgPortIndex=stgCurCfgPortIndex, mstNewCfgRegionVersion=mstNewCfgRegionVersion, lacpInfoPortTable=lacpInfoPortTable, stpInfoTable=stpInfoTable, stgStatsPortTableEntry=stgStatsPortTableEntry, stgStatsPortIndex=stgStatsPortIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, cistInfoPortTableEntry=cistInfoPortTableEntry, stgCfg=stgCfg, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgCurCfgPortPathCost=stgCurCfgPortPathCost, fdbVlan=fdbVlan, vlanInfoPorts=vlanInfoPorts, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, stgCurCfgPortLink=stgCurCfgPortLink, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, fdbStatsHiwat=fdbStatsHiwat, portTeamInfoIndex=portTeamInfoIndex, fdbClear=fdbClear, mstNewCfgRegionName=mstNewCfgRegionName, fdbTable=fdbTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, cistGeneralInfo=cistGeneralInfo, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgLearn=vlanNewCfgLearn, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, lacpInfoPortReadyN=lacpInfoPortReadyN, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, fdbRefSps=fdbRefSps, stgStatsPortTable=stgStatsPortTable, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, vlanCurCfgLearn=vlanCurCfgLearn, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portTeamInfo=portTeamInfo, pmNewCfgAddVlan=pmNewCfgAddVlan, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, fdbSrcPort=fdbSrcPort, stpInfoPortState=stpInfoPortState, fdbStatsLookups=fdbStatsLookups, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanInfoTableEntry=vlanInfoTableEntry, cistRoot=cistRoot, portTeamInfoTrunksState=portTeamInfoTrunksState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, lacpNewPortCfgTableId=lacpNewPortCfgTableId, cistInfoPortPriority=cistInfoPortPriority, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, lacpInfoPortSelected=lacpInfoPortSelected, portTeamCurCfgTable=portTeamCurCfgTable, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgVlanBmap=stgNewCfgVlanBmap, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanMaxEnt=vlanMaxEnt, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoTable=vlanInfoTable, cistInfoPortPathCost=cistInfoPortPathCost, portTeamTableMaxSize=portTeamTableMaxSize, portTeamNewCfgPorts=portTeamNewCfgPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgIndex=stgCurCfgIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, fdbStatsDeletes=fdbStatsDeletes, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgNewCfgState=stgNewCfgState, mstCurCfgState=mstCurCfgState, stpInfoMaxAge=stpInfoMaxAge, lacpInfoPortMoved=lacpInfoPortMoved, fdbInfo=fdbInfo, layer2Stats=layer2Stats, lacpCurPortCfgTableId=lacpCurPortCfgTableId, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgState=vlanCurCfgState, stgCurCfgAgingTime=stgCurCfgAgingTime, stgStatsStpIndex=stgStatsStpIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, cistRootPort=cistRootPort, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, stgNewCfgPortEdge=stgNewCfgPortEdge, PYSNMP_MODULE_ID=layer2, vlanNewCfgDelete=vlanNewCfgDelete, layer2=layer2, fdbStatsCreates=fdbStatsCreates, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgStgIndex=stgCurCfgStgIndex, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, mstNewCfgState=mstNewCfgState, stpStats=stpStats)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", portTeamCurCfgIndex=portTeamCurCfgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stpInfoPortRole=stpInfoPortRole, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, stgCurCfgPriority=stgCurCfgPriority, mstCurCfgRegionVersion=mstCurCfgRegionVersion, mstCistDefaultCfg=mstCistDefaultCfg, stpInfoPortTable=stpInfoPortTable, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgState=stgCurCfgState, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistInfoPortState=cistInfoPortState, stgCurCfgPortState=stgCurCfgPortState, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgTable=stgNewCfgTable, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, lacpCurSystemPriority=lacpCurSystemPriority, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, vlanInfoJumbo=vlanInfoJumbo, mstGeneralCfg=mstGeneralCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, stpInfoPortLinkType=stpInfoPortLinkType, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, cistRootPathCost=cistRootPathCost, portTeamNewCfgTable=portTeamNewCfgTable, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, stgNewCfgStgIndex=stgNewCfgStgIndex)
