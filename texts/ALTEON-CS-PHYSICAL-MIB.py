...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", vlanInfoTable=vlanInfoTable, vlanInfoJumbo=vlanInfoJumbo, stpInfoHoldTime=stpInfoHoldTime, stpInfoPortEdge=stpInfoPortEdge, layer2Configs=layer2Configs, portTeamNewCfgState=portTeamNewCfgState, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, stpInfoPortTableEntry=stpInfoPortTableEntry, lacpInfoPortTable=lacpInfoPortTable, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanInfoStatus=vlanInfoStatus, portTeamNewCfgTable=portTeamNewCfgTable, fdbInfo=fdbInfo, portTeamInfo=portTeamInfo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanInfoPorts=vlanInfoPorts, portTeamInfoState=portTeamInfoState, stgCurCfgTable=stgCurCfgTable, stpInfoTopChanges=stpInfoTopChanges, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, fdbStatsOverflows=fdbStatsOverflows, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, cistInfoPortLinkType=cistInfoPortLinkType, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, mstNewCfgRegionVersion=mstNewCfgRegionVersion, vlanMaxVlanID=vlanMaxVlanID, mstCistCurCfgPortTable=mstCistCurCfgPortTable, stpInfoPortLinkType=stpInfoPortLinkType, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, stpInfoPortStpIndex=stpInfoPortStpIndex, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, layer2Info=layer2Info, cistInfo=cistInfo, mstCurCfgStpMode=mstCurCfgStpMode, trunkGroupNewCfgState=trunkGroupNewCfgState, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortState=stgCurCfgPortState, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, lacpCurSystemPriority=lacpCurSystemPriority, trunkGroupCurCfgState=trunkGroupCurCfgState, portTeamInfoIndex=portTeamInfoIndex, vlanCurCfgStg=vlanCurCfgStg, lacpInfoPortSelected=lacpInfoPortSelected, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, layer2=layer2, lacpNewPortState=lacpNewPortState, fdbStatsCurrent=fdbStatsCurrent, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortState=stgNewCfgPortState, cistGeneralInfo=cistGeneralInfo, fdbTable=fdbTable, lacpNewPortCfgTable=lacpNewPortCfgTable, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, fdbStatsFindFails=fdbStatsFindFails, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoPortRole=stpInfoPortRole, lacpCurPortCfgTable=lacpCurPortCfgTable, cistInfoPortRole=cistInfoPortRole, cistBridgeHelloTime=cistBridgeHelloTime, vlanInfoName=vlanInfoName, cistInfoPortTableEntry=cistInfoPortTableEntry, mstCistDefaultCfg=mstCistDefaultCfg, PYSNMP_MODULE_ID=layer2, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, cistBridgeMaxAge=cistBridgeMaxAge, cistInfoPortPriority=cistInfoPortPriority, mirroring=mirroring, fdbStatsFindOrCreates=fdbStatsFindOrCreates, stgNewCfgPriority=stgNewCfgPriority, cistInfoPortState=cistInfoPortState, stgCurCfgPortPathCost=stgCurCfgPortPathCost, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgTableEntry=vlanNewCfgTableEntry, mstCurCfgRegionName=mstCurCfgRegionName, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stpInfoMaxAge=stpInfoMaxAge, stpInfoIndex=stpInfoIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stpInfoDesignatedRoot=stpInfoDesignatedRoot, stpInfoPortState=stpInfoPortState, portTeamCfg=portTeamCfg, mstNewCfgStpMode=mstNewCfgStpMode, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, vlanInfoLearn=vlanInfoLearn, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbEntry=fdbEntry, vlanNewCfgAddPort=vlanNewCfgAddPort, stpInfoHelloTime=stpInfoHelloTime, fdbMacAddr=fdbMacAddr, vlanMaxEnt=vlanMaxEnt, stgCfg=stgCfg, stgStatsPortIndex=stgStatsPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, layer2Oper=layer2Oper, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, mstNewCfgState=mstNewCfgState, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanNewCfgDelete=vlanNewCfgDelete, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgPortPriority=stgNewCfgPortPriority, fdbStatsLookupFails=fdbStatsLookupFails, stgNewCfgAddVlan=stgNewCfgAddVlan, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, lacp=lacp, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, vlanInfoId=vlanInfoId, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portTeamCurCfgPorts=portTeamCurCfgPorts, cistRegionalRoot=cistRegionalRoot, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, portTeamTableMaxSize=portTeamTableMaxSize, fdbStatsFinds=fdbStatsFinds, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, fdbSrcPort=fdbSrcPort, lacpInfoPortMoved=lacpInfoPortMoved, vlanCurCfgPorts=vlanCurCfgPorts, portTeamInfoTableEntry=portTeamInfoTableEntry, stgCurCfgPortLink=stgCurCfgPortLink, stgCurCfgPortEdge=stgCurCfgPortEdge, portTeamCurCfgTrunks=portTeamCurCfgTrunks, vlanNewCfgVlanId=vlanNewCfgVlanId, stpInfoForwardDelay=stpInfoForwardDelay, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamNewCfgTrunks=portTeamNewCfgTrunks, portTeamNewCfgDelete=portTeamNewCfgDelete, vlanNewCfgTable=vlanNewCfgTable, fdbVlan=fdbVlan, cistInfoPortTable=cistInfoPortTable, stpInfoPortIndex=stpInfoPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, cistInfoPortIndex=cistInfoPortIndex, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, portTeamCurCfgTable=portTeamCurCfgTable, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, lacpInfoPortIndex=lacpInfoPortIndex, mstCfg=mstCfg, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, portTeamInfoPorts=portTeamInfoPorts, fdbStats=fdbStats, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, stpInfoPortPathCost=stpInfoPortPathCost, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk, fdbStatsLookups=fdbStatsLookups, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgTable=stgNewCfgTable, mstNewCfgRegionName=mstNewCfgRegionName, vlanInfo=vlanInfo, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, fdbClear=fdbClear, stgNewCfgPortEdge=stgNewCfgPortEdge, lacpInfoPortNtt=lacpInfoPortNtt, cistRoot=cistRoot, mirrPortMirr=mirrPortMirr, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, portTeamInfoTable=portTeamInfoTable, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, portTeamInfoPortsState=portTeamInfoPortsState, portTeamNewCfgAddPort=portTeamNewCfgAddPort, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, vlan=vlan, vlanCurCfgVlanId=vlanCurCfgVlanId, cistRootPort=cistRootPort, fdbSrcTrunk=fdbSrcTrunk, stpInfo=stpInfo, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, mstGeneralCfg=mstGeneralCfg, stgCurCfgIndex=stgCurCfgIndex, fdbStatsHiwat=fdbStatsHiwat, vlanNewCfgState=vlanNewCfgState, stgStatsStpIndex=stgStatsStpIndex, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgLearn=vlanNewCfgLearn, stgNewCfgState=stgNewCfgState, stgNewCfgVlanBmap=stgNewCfgVlanBmap, lacpCurPortCfgTableId=lacpCurPortCfgTableId, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgIndex=stgNewCfgIndex, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, stgNewCfgPortLink=stgNewCfgPortLink, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stpInfoRootCost=stpInfoRootCost, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpInfo=lacpInfo, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stpInfoTable=stpInfoTable, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, portTeamInfoTrunks=portTeamInfoTrunks, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, portTeamCurCfgState=portTeamCurCfgState, fdbState=fdbState, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, stgCurCfgVlanBmap=stgCurCfgVlanBmap, stgCurCfgState=stgCurCfgState, mstCurCfgRegionVersion=mstCurCfgRegionVersion, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, lacpNewSystemPriority=lacpNewSystemPriority, BridgeId=BridgeId, portTeamNewCfgPorts=portTeamNewCfgPorts, stgStatsPortTable=stgStatsPortTable, vlanCurCfgTable=vlanCurCfgTable, fdbLearnedPort=fdbLearnedPort, layer2Stats=layer2Stats, stpInfoTableEntry=stpInfoTableEntry, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, cistBridgeForwardDelay=cistBridgeForwardDelay, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, cistRegionalPathCost=cistRegionalPathCost, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, stpInfoRootPort=stpInfoRootPort, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgPriority=stgCurCfgPriority, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stpInfoPortTable=stpInfoPortTable, cistRootPathCost=cistRootPathCost, vlanCurCfgLearn=vlanCurCfgLearn, mstCurCfgState=mstCurCfgState, stgNewCfgPortTable=stgNewCfgPortTable, stpStats=stpStats, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, cistInfoPortPathCost=cistInfoPortPathCost, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgPortTable=stgCurCfgPortTable, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, portTeamCurCfgIndex=portTeamCurCfgIndex, vlanInfoTableEntry=vlanInfoTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgStatsPortTableEntry=stgStatsPortTableEntry, lacpCurPortState=lacpCurPortState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, fdbStatsDeletes=fdbStatsDeletes, mstCistCfg=mstCistCfg, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgPortPathCost=stgNewCfgPortPathCost, mstCistNewCfgPortTable=mstCistNewCfgPortTable, fdbStatsCreates=fdbStatsCreates, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, trunkgroup=trunkgroup, vlanInfoBwmContract=vlanInfoBwmContract, stgCurCfgStgIndex=stgCurCfgStgIndex, fdbRefSps=fdbRefSps)
